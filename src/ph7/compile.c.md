...
|       - |   160 | ` */` |
|  989814 |   161 | `static void GenStateInitBlock(` |
...
|  989819 |   170 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  989819 |   171 | `	pBlock->pUserData   = pUserData;` |
|  989819 |   172 | `	pBlock->pGen        = pGen;` |
|  989819 |   173 | `	pBlock->iFlags      = iType;` |
|  989819 |   174 | `	pBlock->pParent     = 0;` |
|  989819 |   175 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  989819 |   176 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  989819 |   177 | `}` |
|       - |   178 | `/*` |
...
|       - |   183 | ` */` |
|  985970 |   184 | `static sxi32 GenStateEnterBlock(` |
...
|  985975 |   194 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  985975 |   195 | `	if( pBlock == 0 ){` |
...
|  985975 |   204 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  985975 |   205 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   206 | `	/* Link to the parent block */` |
|  985975 |   207 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   208 | `	/* Mark as the current block */` |
|  985975 |   209 | `	pGen->pCurrent = pBlock;` |
|  985975 |   210 | `	if( ppBlock ){` |
|       - |   211 | `		/* Write a pointer to the new instance */` |
|  474339 |   212 | `		*ppBlock = pBlock;` |
|  237167 |   213 | `	}` |
|  985975 |   214 | `	return SXRET_OK;` |
|  492990 |   215 | `}` |
|       - |   216 | `/*` |
|       - |   217 | ` * Release block fields without freeing the whole instance.` |
|       - |   218 | ` */` |
|  985962 |   219 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   220 | `{` |
|  985967 |   221 | `	SySetRelease(&pBlock->aPostContFix);` |
|  985967 |   222 | `	SySetRelease(&pBlock->aJumpFix);` |
|  985967 |   223 | `}` |
|       - |   224 | `/*` |
|       - |   225 | ` * Release a block.` |
|       - |   226 | ` */` |
|  985962 |   227 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   228 | `{` |
|  985967 |   229 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  985967 |   230 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   231 | `	/* Free the instance */` |
|  985967 |   232 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  985967 |   233 | `}` |
|       - |   234 | `/*` |
|       - |   235 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   236 | ` */` |
|  985962 |   237 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   238 | `{` |
|  985967 |   239 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  985967 |   240 | `	if( pBlock == 0 ){` |
|       - |   241 | `		/* No more block to pop */` |
|     ! 0 |   242 | `		return SXERR_EMPTY;` |
|       - |   243 | `	}` |
|       - |   244 | `	/* Point to the upper block */` |
|  985967 |   245 | `	pGen->pCurrent = pBlock->pParent;` |
|  985967 |   246 | `	if( ppBlock ){` |
|       - |   247 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   248 | `		*ppBlock = pBlock;` |
|     ! 0 |   249 | `	}else{` |
|       - |   250 | `		/* Safely release the block */` |
|  985967 |   251 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   252 | `	}` |
|  985967 |   253 | `	return SXRET_OK;` |
|  492986 |   254 | `}` |
|       - |   255 | `/*` |
...
|       - |   264 | ` */` |
|  336710 |   265 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   266 | `{` |
|       - |   267 | `	JumpFixup sJumpFix;` |
|       - |   268 | `	sxi32 rc;` |
|       - |   269 | `	/* Init the JumpFixup structure */` |
|  336715 |   270 | `	sJumpFix.nJumpType = nJumpType;` |
|  336715 |   271 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   272 | `	/* Insert in the jump fixup table */` |
|  336715 |   273 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  336715 |   274 | `	return rc;` |
|       5 |   275 | `}` |
|       - |   276 | `/*` |
...
|       - |   286 | ` */` |
|  706590 |   287 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   288 | `{` |
|       - |   289 | `	JumpFixup *aFix;` |
|       - |   290 | `	VmInstr *pInstr;` |
|       - |   291 | `	sxu32 nFixed;` |
...
|  706595 |   294 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   295 | `	/* Fix the desired jumps */` |
| 1351879 |   296 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  645289 |   297 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   298 | `			/* Already fixed */` |
|  246219 |   299 | `			continue;` |
|       - |   300 | `		}` |
|  399075 |   301 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   302 | `			/* Not of our interest */` |
|   62367 |   303 | `			continue;` |
|       - |   304 | `		}` |
|       - |   305 | `		/* Point to the instruction to fix */` |
|  336713 |   306 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  336713 |   307 | `		if( pInstr ){` |
|  336713 |   308 | `			pInstr->iP2 = nJumpDest;` |
|  336713 |   309 | `			nFixed++;` |
|       - |   310 | `			/* Mark as fixed */` |
|  336713 |   311 | `			aFix[n].nJumpType = -1;` |
|  168354 |   312 | `		}` |
|  168359 |   313 | `	}` |
|       - |   314 | `	/* Total number of fixed jumps */` |
|  706595 |   315 | `	return nFixed;` |
|       5 |   316 | `}` |
|       - |   317 | `/*` |
...
|       - |   323 | ` */` |
|  263080 |   324 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   325 | `{` |
...
|  263085 |   332 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   333 | `	/* Fix */` |
|  263231 |   334 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   357 | `		}` |
|      51 |   358 | `	}` |
|  263083 |   359 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  263215 |   360 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   365 | `		}` |
|      71 |   366 | `	}` |
|  263083 |   367 | `	return SXRET_OK;` |
|  131545 |   368 | `}` |
|       - |   369 | `/*` |
|       - |   370 | ` * Check if a given token value is installed in the literal table.` |
|       - |   371 | ` */` |
|  926242 |   372 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   373 | `{` |
|       - |   374 | `	SyHashEntry *pEntry;` |
|  926247 |   375 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  926247 |   376 | `	if( pEntry == 0 ){` |
|  445467 |   377 | `		return SXERR_NOTFOUND;` |
|       - |   378 | `	}` |
|  480785 |   379 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  480785 |   380 | `	return SXRET_OK;` |
|  463126 |   381 | `}` |
|       - |   382 | `/*` |
...
|       - |   391 | ` */` |
|  445462 |   392 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   393 | `{` |
|  445467 |   394 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  445467 |   395 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  222731 |   396 | `	}` |
|  445467 |   397 | `	return SXRET_OK;` |
|       5 |   398 | `}` |
|       - |   399 | `/*` |
|       - |   400 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   401 | ` * in the constant table.` |
|       - |   402 | ` */` |
|  135434 |   403 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   404 | `{` |
|       - |   405 | `	ph7_value *pObj;` |
|  135439 |   406 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   407 | `	/* Reserve a new constant */` |
|  135439 |   408 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  135439 |   409 | `	if( pObj == 0 ){` |
|     ! 0 |   410 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   411 | `		return 0;` |
|       - |   412 | `	}` |
|  135439 |   413 | `	*pIdx = nIdx;` |
|       - |   414 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   415 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   416 | `	 */` |
|  135439 |   417 | `	return pObj;` |
|   67722 |   418 | `}` |
|       - |   419 | `/*` |
...
|       - |   432 | ` */` |
|  574224 |   433 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   434 | `{` |
|       - |   435 | `	VmCallArgMap *pMap;` |
|  574229 |   436 | `	if( !pGen->bStrictTypes ) return p3;` |
|      39 |   437 | `	if( p3 == 0 ){` |
...
|       - |   503 | ` */` |
|  136376 |   504 | `static int GenStateFindBadNumericSeparator(` |
|       - |   505 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   506 | `{` |
|  136381 |   507 | `	const char *z = pRaw->zString;` |
|  136381 |   508 | `	sxu32 n = pRaw->nByte;` |
|  136381 |   509 | `	int base = 10;` |
|       - |   510 | `	sxu32 i, start;` |
|  136381 |   511 | `	if( n < 2 ) return 0;` |
|   11495 |   512 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   513 | `		base = 16;` |
|   11460 |   514 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   515 | `		base = 2;` |
|     139 |   516 | `	}` |
|   42127 |   517 | `	for( i = 0; i < n; ++i ){` |
|   30651 |   518 | `		if( z[i] != '_' ) continue;` |
...
|       - |   544 | ` */` |
|  136376 |   545 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   546 | `{` |
|  136381 |   547 | `	const char *zBad = 0;` |
|  136381 |   548 | `	sxu32 nBad = 0;` |
|       - |   549 | `	SyString sBad;` |
|       - |   550 | `	sxi32 rc;` |
|  136381 |   551 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  136367 |   552 | `		return SXRET_OK;` |
|       - |   553 | `	}` |
...
|       - |   577 | ` */` |
|  136362 |   578 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   583 | `{` |
|       - |   584 | `	sxu32 i, j;` |
|  136367 |   585 | `	int hasUnderscore = 0;` |
|       - |   586 | `	char *zBuf;` |
|  136367 |   587 | `	*pzAlloc = 0;` |
|  289819 |   588 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  153709 |   589 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   76731 |   590 | `	}` |
|  136367 |   591 | `	if( !hasUnderscore ){` |
|  136115 |   592 | `		SyStringDupPtr(pOut, pToken);` |
|  136115 |   593 | `		return SXRET_OK;` |
|       - |   594 | `	}` |
...
|       - |   625 | ` *  documentation.` |
|       - |   626 | ` */` |
|  136348 |   627 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   628 | `{` |
|  136353 |   629 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  136353 |   630 | `	sxu32 nIdx = 0;` |
|       - |   631 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  136353 |   632 | `	char *zAlloc = 0;` |
|       - |   633 | `	SyString sNum;` |
|       - |   634 | `	sxi32 rc;` |
|   68174 |   635 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  136353 |   636 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  136353 |   637 | `	if( rc != SXRET_OK ){` |
|      14 |   638 | `		return rc;` |
|       - |   639 | `	}` |
|  204512 |   640 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   68169 |   641 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  136343 |   642 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   643 | `		return SXERR_ABORT;` |
|       - |   644 | `	}` |
|  136343 |   645 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   646 | `		ph7_value *pObj;` |
|       - |   647 | `		sxi64 iValue;` |
|  135439 |   648 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  135439 |   649 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  135439 |   650 | `		if( pObj == 0 ){` |
|     ! 0 |   651 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   652 | `			return SXERR_ABORT;` |
|       - |   653 | `		}` |
|  135439 |   654 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   67722 |   655 | `	}else{` |
|       - |   656 | `		/* Real number */` |
|       - |   657 | `		ph7_value *pObj;` |
|       - |   658 | `		/* Reserve a new constant */` |
|     909 |   659 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     909 |   660 | `		if( pObj == 0 ){` |
...
|       - |   664 | `		}` |
|     909 |   665 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     909 |   666 | `		PH7_MemObjToReal(pObj);` |
|       - |   667 | `	}` |
|  136343 |   668 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   669 | `	/* Emit the load constant instruction */` |
|  136343 |   670 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   671 | `	/* Node successfully compiled */` |
|  136343 |   672 | `	return SXRET_OK;` |
|   68179 |   673 | `}` |
|       - |   674 | `/*` |
...
|       - |   683 | ` *` |
|       - |   684 | ` */` |
|  172444 |   685 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   686 | `{` |
|  172449 |   687 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   688 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   689 | `	ph7_value *pObj;` |
|       - |   690 | `	sxu32 nIdx;` |
|  172449 |   691 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   692 | `	/* Delimit the string */` |
|  172449 |   693 | `	zIn  = pStr->zString;` |
|  172449 |   694 | `	zEnd = &zIn[pStr->nByte];` |
|  172449 |   695 | `	if( zIn >= zEnd ){` |
...
|       - |   700 | `	}` |
|  164581 |   701 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   702 | `		/* Already processed,emit the load constant instruction` |
|       - |   703 | `		 * and return.` |
|       - |   704 | `		 */` |
|   45415 |   705 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   45415 |   706 | `		return SXRET_OK;` |
|       - |   707 | `	}` |
|       - |   708 | `	/* Reserve a new constant */` |
|  119171 |   709 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  119171 |   710 | `	if( pObj == 0 ){` |
...
|       - |   714 | `	}` |
|  119171 |   715 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   716 | `	/* Compile the node */` |
|  119225 |   717 | `	for(;;){` |
|  238455 |   718 | `		if( zIn >= zEnd ){` |
|       - |   719 | `			/* End of input */` |
|  119171 |   720 | `			break;` |
|       - |   721 | `		}` |
|  119289 |   722 | `		zCur = zIn;` |
| 2467861 |   723 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 2348577 |   724 | `			zIn++;` |
|       5 |   725 | `		}` |
|  119289 |   726 | `		if( zIn > zCur ){` |
|       - |   727 | `			/* Append raw contents*/` |
|  119265 |   728 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   59630 |   729 | `		}` |
|  119289 |   730 | `		zIn++;` |
|  119289 |   731 | `		if( zIn < zEnd ){` |
|     141 |   732 | `			if( zIn[0] == '\\' ){` |
...
|  119171 |   749 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  119171 |   750 | `	if( pStr->nByte < 1024 ){` |
|       - |   751 | `		/* Install in the literal table */` |
|  119171 |   752 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   59583 |   753 | `	}` |
|       - |   754 | `	/* Node successfully compiled */` |
|  119171 |   755 | `	return SXRET_OK;` |
|   86227 |   756 | `}` |
|       - |   757 | `/*` |
...
|       - |   955 | ` */` |
|   27462 |   956 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   957 | `{` |
|       - |   958 | `	ph7_value *pConstObj;` |
|   27467 |   959 | `	sxu32 nIdx = 0;` |
|       - |   960 | `	/* Reserve a new constant */` |
|   27467 |   961 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   27467 |   962 | `	if( pConstObj == 0 ){` |
|     ! 0 |   963 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   964 | `		return 0;` |
|       - |   965 | `	}` |
|   27467 |   966 | `	(*pCount)++;` |
|   27467 |   967 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   968 | `	/* Emit the load constant instruction */` |
|   27467 |   969 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   27467 |   970 | `	return pConstObj;` |
|   13736 |   971 | `}` |
|       - |   972 | `/*` |
...
|   25896 |  1034 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|       5 |  1035 | `{` |
|   25901 |  1036 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1037 | `	const char *zIn,*zCur,*zEnd;` |
|   25901 |  1038 | `	ph7_value *pObj = 0;` |
|       - |  1039 | `	sxi32 iCons;` |
|       - |  1040 | `	sxi32 rc;` |
|       - |  1041 | `	/* Delimit the string */` |
|   25901 |  1042 | `	zIn  = pStr->zString;` |
|   25901 |  1043 | `	zEnd = &zIn[pStr->nByte];` |
|   25901 |  1044 | `	if( zIn >= zEnd ){` |
...
|       - |  1048 | `		 */` |
|     311 |  1049 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     311 |  1050 | `		return SXRET_OK;` |
|       - |  1051 | `	}` |
|   25595 |  1052 | `	zCur = 0;` |
...
|   13986 |  1055 | `	for(;;){` |
|   42239 |  1056 | `		zCur = zIn;` |
|  187931 |  1057 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  148079 |  1058 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      69 |  1059 | `				break;` |
|  147951 |  1060 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    2258 |  1061 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|    1130 |  1062 | `					break;` |
|       - |  1063 | `			}` |
|  145697 |  1064 | `			zIn++;` |
|       5 |  1065 | `		}` |
|   42239 |  1066 | `		if( zIn > zCur ){` |
|   18811 |  1067 | `			if( pObj == 0 ){` |
|   18291 |  1068 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   18291 |  1069 | `				if( pObj == 0 ){` |
|     ! 0 |  1070 | `					return SXERR_ABORT;` |
|       - |  1071 | `				}` |
|    9143 |  1072 | `			}` |
|   18811 |  1073 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    9403 |  1074 | `		}` |
|   42239 |  1075 | `		if( zIn >= zEnd ){` |
|   25593 |  1076 | `			break;` |
|       - |  1077 | `		}` |
|   16651 |  1078 | `		if( zIn[0] == '\\' ){` |
|   14269 |  1079 | `			const char *zPtr = 0;` |
|       - |  1080 | `			sxu32 n;` |
|   14269 |  1081 | `			zIn++;` |
|   14269 |  1082 | `			if( pObj == 0 ){` |
|    9181 |  1083 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    9181 |  1084 | `				if( pObj == 0 ){` |
|     ! 0 |  1085 | `					return SXERR_ABORT;` |
|       - |  1086 | `				}` |
|    4588 |  1087 | `			}` |
|   14269 |  1088 | `			if( zIn >= zEnd ){` |
|       - |  1089 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|       3 |  1090 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|       3 |  1091 | `				break;` |
|       - |  1092 | `			}` |
|   14267 |  1093 | `			n = sizeof(char); /* size of conversion */` |
|   14267 |  1094 | `			switch( zIn[0] ){` |
|      11 |  1095 | `			case '$':` |
|       - |  1096 | `				/* Dollar sign */` |
...
|   13173 |  1113 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   13173 |  1114 | `				break;` |
|      19 |  1115 | `			case 'r':` |
...
|      57 |  1121 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|      57 |  1122 | `				break;` |
|       3 |  1123 | `			case 'v':` |
...
|   25595 |  1361 | `	return SXRET_OK;` |
|   12953 |  1362 | `}` |
|       - |  1363 | `/*` |
|       - |  1364 | ` * Compile a double quoted string.` |
|       - |  1365 | ` *  See the block-comment above for more information.` |
|       - |  1366 | ` */` |
|   25834 |  1367 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1368 | `{` |
|       - |  1369 | `	sxi32 rc;` |
|   25839 |  1370 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|   12917 |  1371 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1372 | `	/* Compilation result */` |
|   25839 |  1373 | `	return rc;` |
|       5 |  1374 | `}` |
|       - |  1375 | `/*` |
...
|       - |  1416 | ` */` |
|   23902 |  1417 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   23907 |  1428 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1429 | `	/* Compile the expression*/` |
|   23907 |  1430 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1431 | `	/* Restore token stream */` |
|   23907 |  1432 | `	RE_SWAP_DELIMITER(pGen);` |
|   23907 |  1433 | `	return rc;` |
|       5 |  1434 | `}` |
|       - |  1435 | `/*` |
...
|       - |  1473 | ` */` |
|   34142 |  1474 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|       5 |  1475 | `{` |
|   34147 |  1476 | `	SyToken *pCur = pStart;` |
|   34147 |  1477 | `	sxi32 iNest = 0;` |
|   98033 |  1478 | `	while( pCur < pEnd ){` |
|   69793 |  1479 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
...
|       - |  1485 | `		 */` |
|   63895 |  1486 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1545 | `			}` |
|      43 |  1546 | `		}` |
|   63889 |  1547 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     421 |  1548 | `			iNest++;` |
|   63680 |  1549 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|       - |  1562 | ` */` |
|   33954 |  1563 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1564 | `{` |
|       - |  1565 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1566 | `	SyToken *pKey,*pCur;` |
|   33959 |  1567 | `	sxi32 iEmitRef = 0;` |
|   33959 |  1568 | `	sxi32 iSpread = 0;` |
|   33959 |  1569 | `	sxi32 nPair = 0;` |
|       - |  1570 | `	sxi32 rc;` |
|   33959 |  1571 | `	xValidator = 0;` |
|   27915 |  1572 | `	for(;;){` |
|       - |  1573 | `		/* Jump leading commas */` |
|   63481 |  1574 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    7651 |  1575 | `			pGen->pIn++;` |
|       5 |  1576 | `		}` |
|   55835 |  1577 | `		pCur = pGen->pIn;` |
|   55835 |  1578 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1579 | `			/* No more entry to process */` |
|   33943 |  1580 | `			break;` |
|       - |  1581 | `		}` |
|   21897 |  1582 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1583 | `			continue;` |
|       - |  1584 | `		}` |
|       - |  1585 | `		/* Compile the key if available */` |
|   21897 |  1586 | `		pKey = pCur;` |
|   21897 |  1587 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   21897 |  1588 | `		rc = SXERR_EMPTY;` |
|   21897 |  1589 | `		if( pCur < pGen->pIn ){` |
...
|   20131 |  1611 | `			pCur = pKey;` |
|       - |  1612 | `		}` |
|   21887 |  1613 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1614 | `			/* No available key,load NULL */` |
|   20133 |  1615 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|   10064 |  1616 | `		}` |
|   21887 |  1617 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   21885 |  1636 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   21885 |  1637 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   21881 |  1650 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   21881 |  1651 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1652 | `			return SXERR_ABORT;` |
|       - |  1653 | `		}` |
|   21881 |  1654 | `		if( iSpread ){` |
...
|   21850 |  1657 | `		}else if( iEmitRef ){` |
|       - |  1658 | `			/* Emit the load reference instruction */` |
|      41 |  1659 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1660 | `		}` |
|   21881 |  1661 | `		xValidator = 0;` |
|   21881 |  1662 | `		iEmitRef = 0;` |
|   21881 |  1663 | `		iSpread = 0;` |
|   21881 |  1664 | `		nPair++;` |
|       5 |  1665 | `	}` |
|       - |  1666 | `	/* Emit the load map instruction */` |
|   33943 |  1667 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1668 | `	/* Node successfully compiled */` |
|   33943 |  1669 | `	return SXRET_OK;` |
|   16982 |  1670 | `}` |
|       - |  1671 | `/*` |
...
|       - |  1784 | ` */` |
|    1376 |  1785 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1786 | `{` |
|       - |  1787 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|    1381 |  1788 | `	pGen->pIn++;` |
|    1381 |  1789 | `	pGen->pEnd--;` |
|     688 |  1790 | `	SXUNUSED(iCompileFlag);` |
|    1381 |  1791 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1792 | `}` |
|       - |  1793 | `/*` |
...
|       - |  2280 | ` */` |
|     250 |  2281 | `static sxi32 GenStateArrowCaptureScan(` |
...
|       - |  2287 | `	sxu32 nShadow)` |
|       4 |  2288 | `{` |
|     254 |  2289 | `	SyToken *pScan = pStart;` |
|       - |  2290 | `	sxi32 rc;` |
|    1274 |  2291 | `	while( pScan < pEnd ){` |
|    1024 |  2292 | `		if( pScan->nType & (PH7_TK_DSTR\|PH7_TK_HEREDOC) ){` |
...
|      48 |  2301 | `			continue;` |
|       - |  2302 | `		}` |
|     978 |  2303 | `		if( pScan->nType & PH7_TK_KEYWORD ){` |
...
|       - |  2453 | `			}` |
|       2 |  2454 | `		}` |
|     960 |  2455 | `		if( (pScan->nType & PH7_TK_DOLLAR) == 0 ){` |
|     794 |  2456 | `			pScan++;` |
|     794 |  2457 | `			continue;` |
|       - |  2458 | `		}` |
|       - |  2459 | `		{` |
...
|       - |  2490 | ` */` |
|     232 |  2491 | `PH7_PRIVATE sxi32 PH7_CompileArrowFunc(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2492 | `{` |
...
|       - |  2505 | `	sxu32 nLen;` |
|       - |  2506 | `	sxu32 nLine;` |
|     237 |  2507 | `	sxi32 iFlags = 0;` |
|     237 |  2508 | `	int bStatic = 0;` |
|       - |  2509 | `	sxi32 rc;` |
|       - |  2510 | `	sxu32 n;` |
|     116 |  2511 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  2512 |  |
|     237 |  2513 | `	nLine = pGen->pIn->nLine;` |
|       - |  2514 | `	/* Optional 'static' prefix */` |
|     232 |  2515 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD)` |
|     237 |  2516 | `		&& SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_STATIC ){` |
|       3 |  2517 | `		bStatic = 1;` |
|       3 |  2518 | `		pGen->pIn++;` |
|       1 |  2519 | `	}` |
|       - |  2520 | `	/* 'fn' keyword (guaranteed by ExprExtractNode's dispatch) */` |
|     232 |  2521 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     237 |  2522 | `		\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FN ){` |
|     ! 0 |  2523 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2524 | `			"Arrow function: expected 'fn' keyword");` |
|     ! 0 |  2525 | `		return SXERR_SYNTAX;` |
|       - |  2526 | `	}` |
|     237 |  2527 | `	pGen->pIn++; /* Jump 'fn' */` |
|       - |  2528 | `	/* Optional '&' — return by reference */` |
|     237 |  2529 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|     ! 0 |  2530 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|     ! 0 |  2531 | `		pGen->pIn++;` |
|     ! 0 |  2532 | `	}` |
|       - |  2533 | `	/* Expect '(' */` |
|     237 |  2534 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
...
|       - |  2544 | `	}` |
|     235 |  2545 | `	pGen->pIn++; /* Jump '(' */` |
|       - |  2546 | `	/* Delimit the parameter list */` |
|     235 |  2547 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN,PH7_TK_RPAREN,&pSigEnd);` |
|     235 |  2548 | `	if( pSigEnd >= pGen->pEnd ){` |
...
|     233 |  2554 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|     233 |  2555 | `	if( pFunc == 0 ){` |
...
|     233 |  2561 | `	nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|     289 |  2562 | `	while( SyHashGet(&pGen->pVm->hFunction,zName,nLen) != 0 && nLen < sizeof(zName) - 2 ){` |
|      58 |  2563 | `		nLen = SyBufferFormat(zName,sizeof(zName),"[lambda_%d]",iCnt++);` |
|       2 |  2564 | `	}` |
|     233 |  2565 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,zName,nLen);` |
|     233 |  2566 | `	if( zDup == 0 ){` |
|     ! 0 |  2567 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2568 | `			"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2569 | `		return SXERR_ABORT;` |
|       - |  2570 | `	}` |
|     233 |  2571 | `	PH7_VmInitFuncState(pGen->pVm,pFunc,zDup,nLen,iFlags,0);` |
|       - |  2572 | `	/* Collect function arguments */` |
|     233 |  2573 | `	if( pGen->pIn < pSigEnd ){` |
...
|     233 |  2580 | `	pGen->pIn = &pSigEnd[1];` |
|     233 |  2581 | `	rc = GenStateParseReturnType(pGen,pFunc);` |
|     233 |  2582 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  2583 | `		return SXERR_ABORT;` |
|     233 |  2584 | `	}else if( rc == SXERR_SYNTAX ){` |
|     ! 0 |  2585 | `		return SXERR_SYNTAX;` |
|       - |  2586 | `	}` |
|       - |  2587 | `	/* Expect '=>' */` |
|     233 |  2588 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ARRAY_OP) == 0 ){` |
...
|       - |  2598 | `	}` |
|     230 |  2599 | `	pGen->pIn++; /* Jump '=>' */` |
|     230 |  2600 | `	pBodyStart = pGen->pIn;` |
|     230 |  2601 | `	pBodyEnd = pGen->pEnd;` |
...
|     230 |  2606 | `	aArgs = (ph7_vm_func_arg *)SySetBasePtr(&pFunc->aArgs);` |
|       - |  2607 | `	{` |
|     230 |  2608 | `		SyString *aShadow = 0;` |
|     230 |  2609 | `		sxu32 nShadow = SySetUsed(&pFunc->aArgs);` |
|     230 |  2610 | `		if( nShadow > 0 ){` |
...
|      66 |  2620 | `			}` |
|      50 |  2621 | `		}` |
|     343 |  2622 | `		rc = GenStateArrowCaptureScan(pGen,pFunc,pBodyStart,pBodyEnd,` |
|     113 |  2623 | `			aShadow,nShadow);` |
|     230 |  2624 | `		if( rc == SXERR_ABORT ){` |
...
|     230 |  2632 | `	if( !bStatic ){` |
|       - |  2633 | `		char *zThisDup;` |
|     228 |  2634 | `		zThisDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,"this",sizeof("this")-1);` |
|     228 |  2635 | `		if( zThisDup == 0 ){` |
|     ! 0 |  2636 | `			PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2637 | `				"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2638 | `			return SXERR_ABORT;` |
|       - |  2639 | `		}` |
|     228 |  2640 | `		SyZero(&sEnv,sizeof(ph7_vm_func_closure_env));` |
|     228 |  2641 | `		sEnv.iFlags = VM_FUNC_ARG_IGNORE;` |
|     228 |  2642 | `		PH7_MemObjInit(pGen->pVm,&sEnv.sValue);` |
|     228 |  2643 | `		SyStringInitFromBuf(&sEnv.sName,zThisDup,sizeof("this")-1);` |
|     228 |  2644 | `		SySetPut(&pFunc->aClosureEnv,(const void *)&sEnv);` |
|     112 |  2645 | `	}` |
|       - |  2646 | `	/* Arrow functions are always closures */` |
|     230 |  2647 | `	pFunc->iFlags \|= VM_FUNC_CLOSURE;` |
|       - |  2648 | `	/* Compile the body expression as an implicit return */` |
|     343 |  2649 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,` |
|     113 |  2650 | `		PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|     230 |  2651 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  2652 | `		PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - |  2653 | `			"PH7 engine is running out-of-memory");` |
|     ! 0 |  2654 | `		return SXERR_ABORT;` |
|       - |  2655 | `	}` |
|     230 |  2656 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     230 |  2657 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
|     230 |  2658 | `	pSavedEnd = pGen->pEnd;` |
|     230 |  2659 | `	pGen->pIn = pBodyStart;` |
|     230 |  2660 | `	pGen->pEnd = pBodyEnd;` |
|     230 |  2661 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|     230 |  2662 | `	if( rc == SXERR_ABORT ){` |
...
|     230 |  2669 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|     230 |  2670 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|     230 |  2671 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|     230 |  2672 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|     230 |  2673 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - |  2674 | `	/* Restore cursors; caller will re-synchronize via the node's pEnd */` |
|     230 |  2675 | `	pGen->pIn = pBodyEnd;` |
|     230 |  2676 | `	pGen->pEnd = pSavedEnd;` |
|       - |  2677 | `	/* Emit the load-closure instruction */` |
|     230 |  2678 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_CLOSURE,0,0,pFunc,0);` |
|     230 |  2679 | `	return SXRET_OK;` |
|     121 |  2680 | `}` |
|       - |  2681 | `/*` |
...
|       - |  3035 | ` */` |
| 1275414 |  3036 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  3037 | `{` |
| 1275419 |  3038 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  3039 | `	sxi32 iVv;` |
|       - |  3040 | `	sxi32 iP1;` |
|       - |  3041 | `	void *p3;` |
|       - |  3042 | `	sxi32 rc;` |
| 1275419 |  3043 | `	iVv = -1; /* Variable variable counter */` |
| 2550845 |  3044 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1275431 |  3045 | `		pGen->pIn++;` |
| 1275431 |  3046 | `		iVv++;` |
|       5 |  3047 | `	}` |
| 1275419 |  3048 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  3056 | `	}` |
| 1275419 |  3057 | `	p3  = 0;` |
| 1275419 |  3058 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  3077 | `		SyString *pName;` |
| 1275401 |  3078 | `		char *zName = 0;` |
|       - |  3079 | `		/* Extract variable name */` |
| 1275401 |  3080 | `		pName = &pGen->pIn->sData;` |
|       - |  3081 | `		/* Advance the stream cursor */` |
| 1275401 |  3082 | `		pGen->pIn++;` |
| 1275401 |  3083 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1275401 |  3084 | `		if( pEntry == 0 ){` |
|       - |  3085 | `			/* Duplicate name */` |
|  184649 |  3086 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  184649 |  3087 | `			if( zName == 0 ){` |
...
|  184649 |  3092 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   92327 |  3093 | `		}else{` |
|       - |  3094 | `			/* Name already available */` |
| 1090757 |  3095 | `			zName = (char *)pEntry->pUserData;` |
|       - |  3096 | `		}` |
| 1275401 |  3097 | `		p3 = (void *)zName;` |
|       - |  3098 | `	}` |
| 1275415 |  3099 | `	iP1 = 0;` |
| 1275415 |  3100 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  490601 |  3101 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  3102 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  490583 |  3103 | `			iP1 = 1;` |
|  245289 |  3104 | `		}` |
|  245298 |  3105 | `	}` |
|       - |  3106 | `	/* Emit the load instruction */` |
| 1275415 |  3107 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1275427 |  3108 | `	while( iVv > 0 ){` |
|      13 |  3109 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  3110 | `		iVv--;` |
|       1 |  3111 | `	}` |
|       - |  3112 | `	/* Node successfully compiled */` |
| 1275415 |  3113 | `	return SXRET_OK;` |
|  637712 |  3114 | `}` |
|       - |  3115 | `/*` |
|       - |  3116 | ` * Load a literal.` |
|       - |  3117 | ` */` |
|  883844 |  3118 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  3119 | `{` |
|  883849 |  3120 | `	SyToken *pToken = pGen->pIn;` |
|       - |  3121 | `	ph7_value *pObj;` |
|       - |  3122 | `	SyString *pStr;` |
|       - |  3123 | `	sxu32 nIdx;` |
|       - |  3124 | `	/* Extract token value */` |
|  883849 |  3125 | `	pStr = &pToken->sData;` |
|       - |  3126 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  883849 |  3127 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  172231 |  3128 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  3129 | `			/* NULL constant are always indexed at 0 */` |
|   58407 |  3130 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   58407 |  3131 | `			return SXRET_OK;` |
|  113829 |  3132 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  3133 | `			/* TRUE constant are always indexed at 1 */` |
|    8629 |  3134 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|    8629 |  3135 | `			return SXRET_OK;` |
|       5 |  3136 | `		}` |
|  817815 |  3137 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  107184 |  3138 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  3139 | `			/* FALSE constant are always indexed at 2 */` |
|   50573 |  3140 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   50573 |  3141 | `			return SXRET_OK;` |
|  725166 |  3142 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  128222 |  3143 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
...
|  668966 |  3154 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   38898 |  3155 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  657646 |  3171 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   27063 |  3172 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  660277 |  3173 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   21556 |  3174 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  754701 |  3204 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  3205 | `		ph7_value *pLitObj;` |
|       - |  3206 | `		/* Unknown literal,install it in the literal table */` |
|  321973 |  3207 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  321973 |  3208 | `		if( pLitObj == 0 ){` |
|     ! 0 |  3209 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  3210 | `			return SXERR_ABORT;` |
|       - |  3211 | `		}` |
|  321973 |  3212 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  321973 |  3213 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  160984 |  3214 | `	}` |
|       - |  3215 | `	/* Emit the load constant instruction */` |
|  754701 |  3216 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  754701 |  3217 | `	return SXRET_OK;` |
|  441927 |  3218 | `}` |
|       - |  3219 | `/*` |
...
|       - |  3224 | ` */` |
|  887736 |  3225 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  3226 | `{` |
|       - |  3227 | `	sxi32 rc;` |
|  887741 |  3228 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  3229 | `		return SXRET_OK;` |
|       - |  3230 | `	}` |
|       - |  3231 | `	/* Check if this is a multi-token namespace path */` |
|  887741 |  3232 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  883849 |  3285 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  883849 |  3286 | `	return rc;` |
|  443873 |  3287 | `}` |
|       - |  3288 | `/*` |
...
|     ! 0 |  3303 | `}` |
|  887736 |  3304 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  3305 | `{` |
|       - |  3306 | `	sxi32 rc;` |
|  887741 |  3307 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  887741 |  3308 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3309 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3310 | `		return rc;` |
|       - |  3311 | `	}` |
|       - |  3312 | `	/* Node successfully compiled */` |
|  887741 |  3313 | `	return SXRET_OK;` |
|  443873 |  3314 | `}` |
|       - |  3315 | `/*` |
...
|       - |  3855 | ` * message.` |
|       - |  3856 | ` */` |
|  513080 |  3857 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3862 | `	sxi32 rc;` |
|       - |  3863 | `	sxu32 nLine;` |
|  513085 |  3864 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  511641 |  3865 | `		nLine = pGen->pIn->nLine;` |
|  511641 |  3866 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  511641 |  3867 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3868 | `			return SXERR_ABORT;` |
|       - |  3869 | `		}` |
|  511641 |  3870 | `		pGen->pIn++;` |
|       - |  3871 | `		/* Compile until we hit the closing braces '}' */` |
|  698999 |  3872 | `		for(;;){` |
| 1398003 |  3873 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3882 | `				}` |
|     ! 0 |  3883 | `			}` |
| 1397983 |  3884 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3885 | `				/* Closing braces found,break immediately*/` |
|  511621 |  3886 | `				pGen->pIn++;` |
|  511621 |  3887 | `				break;` |
|       - |  3888 | `			}` |
|       - |  3889 | `			/* Compile a single statement */` |
|  886367 |  3890 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  886367 |  3891 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3892 | `				return SXERR_ABORT;` |
|       - |  3893 | `			}` |
|       5 |  3894 | `		}` |
|  511641 |  3895 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  257267 |  3896 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3897 | `		pGen->pIn++;` |
...
|    1449 |  3940 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|    1449 |  3941 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  3942 | `			return SXERR_ABORT;` |
|       - |  3943 | `		}` |
|       - |  3944 | `	}` |
|       - |  3945 | `	/* Jump trailing semi-colons ';' */` |
|  513085 |  3946 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3947 | `		pGen->pIn++;` |
|     ! 0 |  3948 | `	}` |
|  513085 |  3949 | `	return SXRET_OK;` |
|  256545 |  3950 | `}` |
|       - |  3951 | `/*` |
...
|       - |  3968 | ` *   endwhile;` |
|       - |  3969 | ` */` |
|    7820 |  3970 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3971 | `{` |
|    7825 |  3972 | `	GenBlock *pWhileBlock = 0;` |
|    7825 |  3973 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3974 | `	sxu32 nFalseJump;` |
|       - |  3975 | `	sxu32 nLine;` |
|       - |  3976 | `	sxi32 rc;` |
|    7825 |  3977 | `	nLine = pGen->pIn->nLine;` |
|       - |  3978 | `	/* Jump the 'while' keyword */` |
|    7825 |  3979 | `	pGen->pIn++;` |
|    7825 |  3980 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3981 | `		/* Syntax error */` |
...
|    7825 |  3992 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|    7825 |  3993 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3994 | `		return SXERR_ABORT;` |
|       - |  3995 | `	}` |
|       - |  3996 | `	/* Delimit the condition */` |
|    7825 |  3997 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    7825 |  3998 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    7825 |  4024 | `	pGen->pIn  = &pEnd[1];` |
|    7825 |  4025 | `	pGen->pEnd = pTmp;` |
|       - |  4026 | `	/* Emit the false jump */` |
|    7825 |  4027 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  4028 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    7825 |  4029 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  4030 | `	/* Compile the loop body */` |
|    7825 |  4031 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|    7825 |  4032 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  4033 | `		return SXERR_ABORT;` |
|       - |  4034 | `	}` |
|       - |  4035 | `	/* Emit the unconditional jump to the start of the loop */` |
|    7825 |  4036 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  4037 | `	/* Fix all jumps now the destination is resolved */` |
|    7825 |  4038 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4039 | `	/* Release the loop block */` |
|    7825 |  4040 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4041 | `	/* Statement successfully compiled */` |
|    7825 |  4042 | `	return SXRET_OK;` |
|     ! 0 |  4043 | `Synchronize:` |
...
|       - |  4198 | ` */` |
|   15510 |  4199 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  4200 | `{` |
|   15515 |  4201 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   15515 |  4202 | `	GenBlock *pForBlock = 0;` |
|       - |  4203 | `	sxu32 nFalseJump;` |
|       - |  4204 | `	sxu32 nLine;` |
|       - |  4205 | `	sxi32 rc;` |
|   15515 |  4206 | `	nLine = pGen->pIn->nLine;` |
|       - |  4207 | `	/* Jump the 'for' keyword */` |
|   15515 |  4208 | `	pGen->pIn++;` |
|   15515 |  4209 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4210 | `		/* Syntax error */` |
...
|   15515 |  4221 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   15515 |  4222 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   15515 |  4237 | `	pTmp = pGen->pEnd;` |
|   15515 |  4238 | `	pGen->pEnd = pEnd;` |
|       - |  4239 | `	/* Compile initialization expressions if available */` |
|   15515 |  4240 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4241 | `	/* Pop operand lvalues */` |
|   15515 |  4242 | `	if( rc == SXERR_ABORT ){` |
|       - |  4243 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4244 | `		return SXERR_ABORT;` |
|   15515 |  4245 | `	}else if( rc != SXERR_EMPTY ){` |
|   15513 |  4246 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7754 |  4247 | `	}` |
|   15515 |  4248 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4249 | `		/* Syntax error */` |
...
|   15515 |  4261 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   15515 |  4262 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4263 | `		return SXERR_ABORT;` |
|       - |  4264 | `	}` |
|       - |  4265 | `	/* Deffer continue jumps */` |
|   15515 |  4266 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  4267 | `	/* Compile the condition */` |
|   15515 |  4268 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   15515 |  4269 | `	if( rc == SXERR_ABORT ){` |
|       - |  4270 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4271 | `		return SXERR_ABORT;` |
|   15515 |  4272 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  4273 | `		/* Emit the false jump */` |
|   15513 |  4274 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  4275 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   15513 |  4276 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    7754 |  4277 | `	}` |
|   15515 |  4278 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4279 | `		/* Syntax error */` |
...
|   15511 |  4291 | `	pPostStart = pGen->pIn;` |
|       - |  4292 | `	/* Compile the loop body */` |
|   15511 |  4293 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   15511 |  4294 | `	pGen->pEnd = pTmp;` |
|   15511 |  4295 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   15511 |  4296 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  4297 | `		return SXERR_ABORT;` |
|       - |  4298 | `	}` |
|       - |  4299 | `	/* Fix post-continue jumps */` |
|   15511 |  4300 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   15511 |  4316 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  4317 | `		pPostStart++;` |
|     ! 0 |  4318 | `	}` |
|   15511 |  4319 | `	if( pPostStart < pEnd ){` |
|       - |  4320 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   15511 |  4321 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   15511 |  4322 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   15511 |  4323 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4324 | `			/* Syntax error */` |
...
|       - |  4331 | `		}` |
|   15511 |  4332 | `		RE_SWAP_DELIMITER(pGen);` |
|   15511 |  4333 | `		if( rc == SXERR_ABORT ){` |
|       - |  4334 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4335 | `			return SXERR_ABORT;` |
|   15511 |  4336 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4337 | `			/* Pop operand lvalue */` |
|   15511 |  4338 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7753 |  4339 | `		}` |
|    7753 |  4340 | `	}` |
|       - |  4341 | `	/* Emit the unconditional jump to the start of the loop */` |
|   15511 |  4342 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4343 | `	/* Fix all jumps now the destination is resolved */` |
|   15511 |  4344 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4345 | `	/* Release the loop block */` |
|   15511 |  4346 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4347 | `	/* Statement successfully compiled */` |
|   15511 |  4348 | `	return SXRET_OK;` |
|    7760 |  4349 | `}` |
...
|       - |  4352 | ` * are allowed.` |
|       - |  4353 | ` */` |
|   16046 |  4354 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4355 | `{` |
|   16051 |  4356 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|   16051 |  4357 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4392 | ` */` |
|   12006 |  4393 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4394 | `{` |
|   12011 |  4395 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|   12011 |  4396 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|   12011 |  4397 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4398 | `	ph7_foreach_info *pInfo;` |
|       - |  4399 | `	sxu32 nFalseJump;` |
|       - |  4400 | `	VmInstr *pInstr;` |
|       - |  4401 | `	sxu32 nLine;` |
|       - |  4402 | `	sxi32 rc;` |
|   12011 |  4403 | `	nLine = pGen->pIn->nLine;` |
|       - |  4404 | `	/* Jump the 'foreach' keyword */` |
|   12011 |  4405 | `	pGen->pIn++;` |
|   12011 |  4406 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4407 | `		/* Syntax error */` |
...
|   12011 |  4418 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|   12011 |  4419 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4420 | `		return SXERR_ABORT;` |
|       - |  4421 | `	}` |
|       - |  4422 | `	/* Delimit the expression */` |
|   12011 |  4423 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   12011 |  4424 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   12011 |  4439 | `	pCur = pGen->pIn;` |
|   75871 |  4440 | `	while( pCur < pEnd ){` |
|   75871 |  4441 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|   12025 |  4442 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|   12025 |  4443 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|   12011 |  4461 | `	pTmp = pGen->pEnd;` |
|   12011 |  4462 | `	pGen->pEnd = pCur;` |
|   12011 |  4463 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   12011 |  4464 | `	if( rc == SXERR_ABORT ){` |
|       - |  4465 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4466 | `		return SXERR_ABORT;` |
|       - |  4467 | `	}` |
|       - |  4468 | `	/* Update token stream */` |
|   12011 |  4469 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4475 | `		pGen->pIn++;` |
|     ! 0 |  4476 | `	}` |
|   12011 |  4477 | `	pCur++; /* Jump the 'as' keyword */` |
|   12011 |  4478 | `	pGen->pIn = pCur;` |
|   12011 |  4479 | `	if( pGen->pIn >= pEnd ){` |
...
|   12011 |  4486 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|   12011 |  4487 | `	if( pInfo == 0 ){` |
...
|   12011 |  4492 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4493 | `	/* Initialize structure fields */` |
|   12011 |  4494 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|       - |  4497 | `	 * '=>'. */` |
|   12011 |  4498 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|   12011 |  4499 | `	if( pCur < pEnd ){` |
...
|    2030 |  4522 | `	}` |
|   12011 |  4523 | `	pGen->pEnd = pEnd;` |
|   12011 |  4524 | `	if( pGen->pIn >= pEnd ){` |
...
|   12006 |  4579 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|   11991 |  4612 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|   11991 |  4613 | `		if( rc == SXERR_ABORT ){` |
|       - |  4614 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4615 | `			return SXERR_ABORT;` |
|       - |  4616 | `		}` |
|   11991 |  4617 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|   11991 |  4618 | `		if( pInstr->p3 ){` |
|       - |  4619 | `			/* Record value name */` |
|   11991 |  4620 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    5993 |  4621 | `		}` |
|       - |  4622 | `	}` |
|       - |  4623 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|   12009 |  4624 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4625 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   12009 |  4626 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4627 | `	/* Record the first instruction to execute */` |
|   12009 |  4628 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4629 | `	/* Emit the FOREACH_STEP instruction */` |
|   12009 |  4630 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4631 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   12009 |  4632 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4633 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|   12009 |  4634 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|   12009 |  4662 | `	pGen->pIn = &pEnd[1];` |
|   12009 |  4663 | `	pGen->pEnd = pTmp;` |
|   12009 |  4664 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|   12009 |  4665 | `	if( rc == SXERR_ABORT ){` |
...
|   12009 |  4670 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4671 | `	/* Fix all jumps now the destination is resolved */` |
|   12009 |  4672 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4673 | `	/* Release the loop block */` |
|   12009 |  4674 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4675 | `	/* Statement successfully compiled */` |
|   12009 |  4676 | `	return SXRET_OK;` |
|       1 |  4677 | `Synchronize:` |
...
|       - |  4716 | ` *    ?>` |
|       - |  4717 | ` */` |
|  190940 |  4718 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4719 | `{` |
|  190945 |  4720 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  190945 |  4721 | `	GenBlock *pCondBlock = 0;` |
|       - |  4722 | `	sxu32 nJumpIdx;` |
|       - |  4723 | `	sxu32 nKeyID;` |
|       - |  4724 | `	sxi32 rc;` |
|       - |  4725 | `	/* Jump the 'if' keyword */` |
|  190945 |  4726 | `	pGen->pIn++;` |
|  190945 |  4727 | `	pToken = pGen->pIn;` |
|       - |  4728 | `	/* Create the conditional block */` |
|  190945 |  4729 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  190945 |  4730 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4731 | `		return SXERR_ABORT;` |
|       - |  4732 | `	}` |
|       - |  4733 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|  107061 |  4734 | `	for(;;){` |
|  214127 |  4735 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4736 | `			/* Syntax error */` |
...
|  214127 |  4750 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  214127 |  4751 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4752 | `			/* Syntax error */` |
...
|  214127 |  4764 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4765 | `		/* Compile the condition */` |
|  214127 |  4766 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4767 | `		/* Update token stream */` |
|  214127 |  4768 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4769 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4770 | `			pGen->pIn++;` |
|     ! 0 |  4771 | `		}` |
|  214127 |  4772 | `		pGen->pIn  = &pEnd[1];` |
|  214127 |  4773 | `		pGen->pEnd = pTmp;` |
|  214127 |  4774 | `		if( rc == SXERR_ABORT ){` |
|       - |  4775 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4776 | `			return SXERR_ABORT;` |
|       - |  4777 | `		}` |
|       - |  4778 | `		/* Emit the false jump */` |
|  214127 |  4779 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4780 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  214127 |  4781 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4782 | `		/* Compile the body */` |
|  214127 |  4783 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  214127 |  4784 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4785 | `			return SXERR_ABORT;` |
|       - |  4786 | `		}` |
|  214127 |  4787 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   48938 |  4788 | `			break;` |
|       - |  4789 | `		}` |
|       - |  4790 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|  116261 |  4791 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  116261 |  4792 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   81071 |  4793 | `			break;` |
|       - |  4794 | `		}` |
|       - |  4795 | `		/* Emit the unconditional jump */` |
|   35195 |  4796 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4797 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   35195 |  4798 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   35195 |  4799 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   27389 |  4800 | `			pToken = &pGen->pIn[1];` |
|   27389 |  4801 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|   15414 |  4802 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    6009 |  4803 | `					break;` |
|       - |  4804 | `			}` |
|   15381 |  4805 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    7688 |  4806 | `		}` |
|   23187 |  4807 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4808 | `		/* Synchronize cursors */` |
|   23187 |  4809 | `		pToken = pGen->pIn;` |
|       - |  4810 | `		/* Fix the false jump */` |
|   23187 |  4811 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4812 | `	} /* For(;;) */` |
|       - |  4813 | `	/* Fix the false jump */` |
|  190945 |  4814 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  190945 |  4815 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   93074 |  4816 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4817 | `			/* Compile the else block */` |
|   12013 |  4818 | `			pGen->pIn++;` |
|   12013 |  4819 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   12013 |  4820 | `			if( rc == SXERR_ABORT ){` |
|       - |  4821 |  |
|     ! 0 |  4822 | `				return SXERR_ABORT;` |
|       - |  4823 | `			}` |
|    6004 |  4824 | `	}` |
|  190945 |  4825 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4826 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  190945 |  4827 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4828 | `	/* Release the conditional block */` |
|  190945 |  4829 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4830 | `	/* Statement successfully compiled */` |
|  190945 |  4831 | `	return SXRET_OK;` |
|     ! 0 |  4832 | `Synchronize:` |
...
|       - |  4932 | ` */` |
|  266866 |  4933 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4934 | `{` |
|  266871 |  4935 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4936 | `	sxi32 rc;` |
|  266871 |  4937 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  266871 |  4938 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|  665231 |  4944 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|  398365 |  4945 | `		pFuncBlock = pFuncBlock->pParent;` |
|       5 |  4946 | `	}` |
|  266866 |  4947 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|  266839 |  4948 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|  266871 |  4956 | `	pGen->pIn++;` |
|  266871 |  4957 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4958 | `		/* Compile the expression */` |
|  266841 |  4959 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  266841 |  4960 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4961 | `			return SXERR_ABORT;` |
|  266841 |  4962 | `		}else if(rc != SXERR_EMPTY ){` |
|  266841 |  4963 | `			nRet = 1;` |
|  133418 |  4964 | `		}` |
|  133418 |  4965 | `	}` |
...
|  266871 |  4970 | `	if( pGen->bInGenerator ){` |
...
|  266845 |  4979 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  266845 |  4980 | `	return SXRET_OK;` |
|  133438 |  4981 | `}` |
|       - |  4982 | `/*` |
...
|       - |  5093 | ` */` |
|   15194 |  5094 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  5095 | `{` |
|   15199 |  5096 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  5097 | `	sxi32 rc;` |
|       - |  5098 | `	/* Jump the 'echo' keyword */` |
|   15199 |  5099 | `	pGen->pIn++;` |
|       - |  5100 | `	/* Compile arguments one after one */` |
|   15199 |  5101 | `	pTmp = pGen->pEnd;` |
|   35409 |  5102 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   20215 |  5103 | `		if( pGen->pIn < pNext ){` |
|   20215 |  5104 | `			pGen->pEnd = pNext;` |
|   20215 |  5105 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   20215 |  5106 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5107 | `				return SXERR_ABORT;` |
|   20215 |  5108 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  5109 | `				/* Emit the consume instruction */` |
|   20191 |  5110 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|   10093 |  5111 | `			}` |
|   10105 |  5112 | `		}` |
|       - |  5113 | `		/* Jump trailing commas */` |
|   25231 |  5114 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    5021 |  5115 | `			pNext++;` |
|       5 |  5116 | `		}` |
|   20215 |  5117 | `		pGen->pIn = pNext;` |
|       5 |  5118 | `	}` |
|       - |  5119 | `	/* Restore token stream */` |
|   15199 |  5120 | `	pGen->pEnd = pTmp;` |
|   15199 |  5121 | `	return SXRET_OK;` |
|    7602 |  5122 | `}` |
|       - |  5123 | `/*` |
...
|       - |  5288 | ` */` |
|  553870 |  5289 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  5290 | `{` |
|       - |  5291 | `	ph7_value *pLit;` |
...
|       - |  5299 | `	ph7_value *pNew;` |
|  553875 |  5300 | `	if( pFromImport ){` |
|  509433 |  5301 | `		*pFromImport = 0;` |
|  254714 |  5302 | `	}` |
|  553875 |  5303 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  553875 |  5304 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  5305 | `		return nOrigIdx;` |
|       - |  5306 | `	}` |
|  553875 |  5307 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  553875 |  5308 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  5309 | `	/* Skip if already qualified (contains backslash) */` |
|  553875 |  5310 | `	hasNsSep = 0;` |
| 6292759 |  5311 | `	for( k = 0; k < nLit; k++ ){` |
| 5738897 |  5312 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2869447 |  5313 | `	}` |
|  553875 |  5314 | `	if( hasNsSep ){` |
|      10 |  5315 | `		return nOrigIdx;` |
|       - |  5316 | `	}` |
|       - |  5317 | `	/* Check use imports first (works even outside namespaces) */` |
|  553867 |  5318 | `	SyBlobReset(&pGen->sWorker);` |
|  553867 |  5319 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  553867 |  5320 | `	if( pImport ){` |
...
|       8 |  5325 | `		}` |
|      23 |  5326 | `	}else{` |
|  553831 |  5327 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  553741 |  5328 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  5329 | `		}` |
...
|       - |  5935 | ` */` |
|  116862 |  5936 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5937 | `{` |
...
|       - |  5942 | `	sxi32 rc;` |
|       - |  5943 |  |
|  116867 |  5944 | `	pIn = pGen->pIn;` |
|  116867 |  5945 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5946 | `	/* Process arguments one after one */` |
|  149927 |  5947 | `	for(;;){` |
|  299859 |  5948 | `		if( pIn >= pEnd ){` |
|       - |  5949 | `			/* No more arguments to process */` |
|  116851 |  5950 | `			break;` |
|       - |  5951 | `		}` |
|  183013 |  5952 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  183013 |  5953 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  183013 |  5954 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  183013 |  5955 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5961 | `		{` |
|  183013 |  5962 | `			int bReadonly = 0, bVisSeen = 0;` |
|  183013 |  5963 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  183013 |  5964 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5965 | `				bReadonly = 1;` |
|       3 |  5966 | `				pIn++;` |
|       1 |  5967 | `			}` |
|  183013 |  5968 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   69507 |  5969 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   69507 |  5970 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      79 |  5971 | `					bVisSeen = 1;` |
...
|      37 |  5980 | `				}` |
|   34751 |  5981 | `			}` |
|  183013 |  5982 | `			if( bVisSeen \|\| bReadonly ){` |
|      81 |  5983 | `				if( !bCtorCtx ){` |
...
|  183004 |  6004 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  137862 |  6005 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   90789 |  6006 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   84977 |  6007 | `			sxu32 nLineLocal = pIn->nLine;` |
|   84977 |  6008 | `			sxi32 iTFlags = 0;` |
|   84977 |  6009 | `			pGen->pIn = pIn;` |
|   84977 |  6010 | `			rc = GenStateParseUnionTypeDecl(` |
|   42486 |  6011 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   42486 |  6012 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  6013 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  6014 | `				/* bAllowVoid */ 0,` |
|   42486 |  6015 | `						nLineLocal);` |
|   84977 |  6016 | `			pIn = pGen->pIn;` |
|   84977 |  6017 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  6018 | `				return SXERR_ABORT;` |
|   84977 |  6019 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  6020 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  6021 | `				return SXERR_SYNTAX;` |
|   84975 |  6022 | `			}else if( rc == SXERR_SYNTAX ){` |
|      11 |  6023 | `				if( pIn < pEnd ){` |
...
|       - |  6032 | `			}` |
|   84967 |  6033 | `			sArg.iFlags \|= iTFlags;` |
|   42481 |  6034 | `		}` |
|  182999 |  6035 | `		if( pIn >= pEnd ){` |
|     ! 0 |  6036 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  6037 | `			return rc;` |
|       - |  6038 | `		}` |
|  182999 |  6039 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  6040 | `			/* Pass by reference,record that */` |
|    3881 |  6041 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3881 |  6042 | `			pIn++;` |
|    1938 |  6043 | `		}` |
|  182999 |  6044 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  6045 | `			/* Variadic parameter: ...$args */` |
|    3901 |  6046 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|    3901 |  6047 | `			pIn++;` |
|    1948 |  6048 | `		}` |
|  182999 |  6049 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  6050 | `			/* Invalid argument */` |
|     ! 0 |  6051 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  6052 | `			return rc;` |
|       - |  6053 | `		}` |
|  182999 |  6054 | `		pIn++; /* Jump the dollar sign */` |
|       - |  6055 | `		/* Copy argument name */` |
|  182999 |  6056 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  182999 |  6057 | `		if( zDup == 0 ){` |
|     ! 0 |  6058 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  6059 | `			return SXERR_ABORT;` |
|       - |  6060 | `		}` |
|  182999 |  6061 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  182999 |  6062 | `		pIn++;` |
|  182999 |  6063 | `		if( pIn < pEnd ){` |
|  108501 |  6064 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
...
|   80798 |  6097 | `				if( (sArg.nType > 0 \|\| (sArg.iFlags & VM_FUNC_ARG_UNION))` |
...
|   40399 |  6107 | `			}` |
|  108499 |  6108 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  6109 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  6110 | `				return rc;` |
|       - |  6111 | `			}` |
|  108499 |  6112 | `			pIn++; /* Jump the trailing comma */` |
|   54247 |  6113 | `		}` |
|       - |  6114 | `		/* Append argument signature */` |
|  182997 |  6115 | `		if( sArg.nType > 0 ){` |
|   84911 |  6116 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
...
|    7727 |  6121 | `			}else{` |
|       - |  6122 | `				int c;` |
|   69467 |  6123 | `				c = 'n'; /* cc warning */` |
|       - |  6124 | `				/* Type leading character */` |
|   69467 |  6125 | `				switch(sArg.nType){` |
|       4 |  6126 | `				case MEMOBJ_HASHMAP:` |
|       - |  6127 | `					/* Hashmap aka 'array' */` |
|       9 |  6128 | `					c = 'h';` |
|       9 |  6129 | `					break;` |
|    9700 |  6130 | `				case MEMOBJ_INT:` |
|       - |  6131 | `					/* Integer */` |
|   19405 |  6132 | `					c = 'i';` |
|   19405 |  6133 | `					break;` |
...
|       2 |  6151 | `					break;` |
|       - |  6152 | `				}` |
|   69467 |  6153 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  6154 | `			}` |
|   42458 |  6155 | `		}else{` |
|       - |  6156 | `			/* No type is associated with this parameter which mean` |
|       - |  6157 | `			 * that this function is not condidate for overloading.` |
|       - |  6158 | `			 */` |
|   98091 |  6159 | `			SyBlobRelease(&sSig);` |
|       - |  6160 | `		}` |
|       - |  6161 | `		/* Save in the argument set */` |
|  182997 |  6162 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  6163 | `	}` |
|  116851 |  6164 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  6165 | `		/* Save function signature */` |
|   54105 |  6166 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   27050 |  6167 | `	}` |
|  116851 |  6168 | `	return SXRET_OK;` |
|   58436 |  6169 | `}` |
|       - |  6170 | `/*` |
...
|     111 |  6337 | `}` |
|  244938 |  6338 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|       5 |  6339 | `{` |
|  244943 |  6340 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|  244943 |  6341 | `	SyToken *pEnd = pGen->pEnd;` |
|  244943 |  6342 | `	sxi32 iDepth = 0;` |
|  244943 |  6343 | `	int bStarted = 0;` |
| 8589793 |  6344 | `	while( pIn < pEnd ){` |
| 8589793 |  6345 | `		sxu32 t = pIn->nType;` |
| 8589793 |  6346 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 8086383 |  6347 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 7583289 |  6348 | `		if( t & PH7_TK_KEYWORD ){` |
|  650319 |  6349 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  650319 |  6350 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  650107 |  6351 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|       - |  6352 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|  325041 |  6353 | `		}` |
| 7583057 |  6354 | `		pIn++;` |
|       5 |  6355 | `	}` |
|  244731 |  6356 | `	return FALSE;` |
|  122474 |  6357 | `}` |
|       - |  6358 | `/*` |
...
|       - |  6362 | ` */` |
|  244938 |  6363 | `static sxi32 GenStateCompileFuncBody(` |
...
|  244943 |  6373 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  244943 |  6374 | `	if( rc != SXRET_OK ){` |
...
|       - |  6378 | `	}` |
|  244943 |  6379 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  6380 | `	/* Swap bytecode containers */` |
|  244943 |  6381 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  244943 |  6382 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  6387 | `	{` |
|  244943 |  6388 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  6389 | `		sxu32 i;` |
|  397033 |  6390 | `		for( i = 0; i < nArg; i++ ){` |
|  152095 |  6391 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  6392 | `			char *zSrc;` |
|       - |  6393 | `			sxu32 nSrc,nName;` |
|       - |  6394 | `			SySet sToken;` |
|       - |  6395 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  6396 | `			sxi32 rcPromote;` |
|  152095 |  6397 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  152033 |  6398 | `				continue;` |
|       - |  6399 | `			}` |
...
|       - |  6449 | `	{` |
|  244943 |  6450 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|  244943 |  6451 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|       - |  6452 | `		/* Compile the body */` |
|  244943 |  6453 | `		PH7_CompileBlock(&(*pGen),0);` |
|  244943 |  6454 | `		pGen->bInGenerator = bSavedGen;` |
|       - |  6455 | `	}` |
|       - |  6456 | `	/* Fix exception jumps now the destination is resolved */` |
|  244943 |  6457 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  6458 | `	/* Emit the final return if not yet done */` |
|  244943 |  6459 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  6460 | `	/* Fix gotos jumps now the destination is resolved */` |
|  244943 |  6461 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  6462 | `		rc = SXERR_ABORT;` |
|     ! 0 |  6463 | `	}` |
|  244943 |  6464 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  6465 | `	/* Restore the default container */` |
|  244943 |  6466 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  6467 | `	/* Leave function block */` |
|  244943 |  6468 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  244943 |  6469 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  6474 | `	{` |
|  244943 |  6475 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  6476 | `		sxu32 i;` |
| 5026101 |  6477 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 4781375 |  6478 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
|     217 |  6479 | `				pFunc->iFlags \|= VM_FUNC_GENERATOR;` |
|     217 |  6480 | `				break;` |
|       - |  6481 | `			}` |
| 2390584 |  6482 | `		}` |
|       - |  6483 | `	}` |
|  244943 |  6484 | `	if( pFunc->iFlags & VM_FUNC_GENERATOR ){` |
...
|       - |  6554 | ` */` |
|   85940 |  6555 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  6556 | `{` |
|   85945 |  6557 | `	SyToken *pIn = pGen->pIn;` |
|   85945 |  6558 | `	SyZero(pOut, sizeof(*pOut));` |
|   85945 |  6559 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   85945 |  6560 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6561 | `		return SXERR_SYNTAX;` |
|       - |  6562 | `	}` |
|       - |  6563 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   85945 |  6564 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  6565 | `		pIn++;` |
|       8 |  6566 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6567 | `			return SXERR_SYNTAX;` |
|       - |  6568 | `		}` |
|       3 |  6569 | `	}` |
|   85945 |  6570 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6571 | `		return SXERR_SYNTAX;` |
|       - |  6572 | `	}` |
|   85945 |  6573 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   70075 |  6574 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   70075 |  6575 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      34 |  6576 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   70060 |  6577 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      77 |  6578 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   70009 |  6579 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   19691 |  6580 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   60130 |  6581 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   50209 |  6582 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   25185 |  6583 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|       - |  6626 | `		}` |
|       - |  6627 | `	}` |
|   85943 |  6628 | `	pGen->pIn = pIn;` |
|   85943 |  6629 | `	return SXRET_OK;` |
|   42975 |  6630 | `}` |
|       - |  6631 |  |
|       - |  6632 | `/*` |
...
|       - |  6638 | ` */` |
|   85774 |  6639 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6640 | `{` |
|       - |  6641 | `	int i;` |
|   85779 |  6642 | `	int nNonNull = 0;` |
|   85779 |  6643 | `	int bAnyIntersection = 0;` |
|       - |  6644 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|   85779 |  6645 | `	sxu32 nMaxGroup = 0;` |
| 2830547 |  6646 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  171693 |  6647 | `	for( i = 0; i < nAtoms; i++ ){` |
|   85919 |  6648 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   85891 |  6649 | `			nNonNull++;` |
|   85891 |  6650 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|   85891 |  6651 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|   85891 |  6652 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|   42943 |  6653 | `			}` |
|   42943 |  6654 | `		}` |
|   42962 |  6655 | `	}` |
|  171651 |  6656 | `	for( i = 0; i < nAtoms; i++ ){` |
|   85897 |  6657 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|      24 |  6658 | `			bAnyIntersection = 1;` |
|      24 |  6659 | `			break;` |
|       - |  6660 | `		}` |
|   42941 |  6661 | `	}` |
|   85779 |  6662 | `	if( bAnyIntersection ){` |
...
|      64 |  6697 | `		return;` |
|       - |  6698 | `	}` |
|   85759 |  6699 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6700 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6711 | `	}` |
|       - |  6712 | `	{` |
|   85679 |  6713 | `		int bFirst = 1;` |
|       - |  6714 | `		/* 1) Classes in declaration order */` |
|  171457 |  6715 | `		for( i = 0; i < nAtoms; i++ ){` |
|   85783 |  6716 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
...
|       - |  6726 | `			int k;` |
|  599723 |  6727 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  958639 |  6728 | `				for( i = 0; i < nAtoms; i++ ){` |
|  514565 |  6729 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   69975 |  6730 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   69975 |  6731 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   69975 |  6732 | `						bFirst = 0;` |
|   69975 |  6733 | `						break;` |
|       - |  6734 | `					}` |
|  222300 |  6735 | `				}` |
...
|       - |  6759 | ` */` |
|   85918 |  6760 | `static sxi32 GenStateParsePart(` |
|       - |  6761 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|       - |  6762 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|       5 |  6763 | `{` |
|       - |  6764 | `	sxi32 rc;` |
|   85923 |  6765 | `	int nMembers = 0;` |
|   85923 |  6766 | `	int bParen = 0;` |
|   85923 |  6767 | `	*pnMembers = 0;` |
|   85923 |  6768 | `	*pbParen = 0;` |
|   85923 |  6769 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       6 |  6770 | `		bParen = 1;` |
|       6 |  6771 | `		pGen->pIn++; /* skip '(' */` |
|       2 |  6772 | `	}` |
|   42959 |  6773 | `	for(;;){` |
|   85945 |  6774 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|       - |  6778 | `		}` |
|   85945 |  6779 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|   85945 |  6780 | `		if( rc != SXRET_OK ){` |
|       3 |  6781 | `			return rc;` |
|       - |  6782 | `		}` |
|   85943 |  6783 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|   85943 |  6784 | `		(*pnAtoms)++;` |
|   85943 |  6785 | `		nMembers++;` |
|       - |  6786 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|   85943 |  6787 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|       - |  6808 | `		}` |
|       2 |  6809 | `	}` |
|   85921 |  6810 | `	*pnMembers = nMembers;` |
|   85921 |  6811 | `	*pbParen = bParen;` |
|   85921 |  6812 | `	return SXRET_OK;` |
|   42964 |  6813 | `}` |
|       - |  6814 |  |
|       - |  6815 | `/*` |
...
|       - |  6832 | ` */` |
|   85790 |  6833 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   85795 |  6846 | `	int nAtoms = 0;` |
|   85795 |  6847 | `	int bShortNullable = 0;` |
|   85795 |  6848 | `	int bExplicitNull = 0;` |
|       - |  6849 | `	sxi32 rc;` |
|   85795 |  6850 | `	*pnType = 0;` |
|   85795 |  6851 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   85795 |  6852 | `	*piTypeFlags = 0;` |
|   85795 |  6853 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6854 |  |
|   85795 |  6855 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6856 | `		return SXRET_OK;` |
|       - |  6857 | `	}` |
|       - |  6858 | ``	/* Optional `?` shorthand prefix */`` |
|   85790 |  6859 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   85795 |  6872 | `		sxu32 iGroup = 0;` |
|   85795 |  6873 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|   85795 |  6874 | `		if( rc != SXRET_OK ){` |
|       4 |  6875 | `			return rc;` |
|       - |  6876 | `		}` |
...
|  128877 |  6882 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   85988 |  6883 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6901 | `			}` |
|       5 |  6902 | `		}` |
|   85791 |  6903 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|       - |  6915 | `	{` |
|       - |  6916 | `		int i, j;` |
|   85791 |  6917 | `		int bHasNonNull = 0;` |
|   85791 |  6918 | `		int bAnyIntersection = 0;` |
...
| 2830943 |  6922 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  171727 |  6923 | `		for( i = 0; i < nAtoms; i++ ){` |
|   85941 |  6924 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|   42973 |  6925 | `		}` |
|  171681 |  6926 | `		for( i = 0; i < nAtoms; i++ ){` |
|   85917 |  6927 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|   42950 |  6928 | `		}` |
...
|   85791 |  6931 | `		if( bShortNullable && bAnyIntersection ){` |
...
|       - |  6935 | `		}` |
|  171713 |  6936 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|   85939 |  6940 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|       - |  6962 | `				}` |
|      20 |  6963 | `			}` |
|   85937 |  6964 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6979 | `				}` |
|      79 |  6980 | `			}` |
|   85935 |  6981 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6998 | `				}` |
|       7 |  6999 | `			}` |
|   85929 |  7000 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      32 |  7001 | `				bExplicitNull = 1;` |
|      18 |  7002 | `			}else{` |
|   85901 |  7003 | `				bHasNonNull = 1;` |
|       - |  7004 | `			}` |
...
|      94 |  7042 | `			}` |
|   42966 |  7043 | `		}` |
|   85779 |  7044 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   85779 |  7059 | `	if( bShortNullable \|\| bExplicitNull ){` |
|     100 |  7060 | `		*piTypeFlags \|= iNullableFlag;` |
|      48 |  7061 | `	}` |
|       - |  7062 | `	/* Build canonical type text */` |
|   85779 |  7063 | `	if( pTypeText ){` |
|       - |  7064 | `		SyBlob sBlob;` |
|   85779 |  7065 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  128632 |  7066 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   42887 |  7067 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   85779 |  7068 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  128408 |  7069 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   85602 |  7070 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   85607 |  7071 | `			if( zDup ){` |
|   85607 |  7072 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   42801 |  7073 | `			}` |
|   42801 |  7074 | `		}` |
|   85779 |  7075 | `		SyBlobRelease(&sBlob);` |
|   42887 |  7076 | `	}` |
...
|       - |  7080 | `	{` |
|   85779 |  7081 | `		int nNonNull = 0;` |
|   85779 |  7082 | `		int iNonNullIdx = -1;` |
|       - |  7083 | `		int i;` |
|  171693 |  7084 | `		for( i = 0; i < nAtoms; i++ ){` |
|   85919 |  7085 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   85891 |  7086 | `				nNonNull++;` |
|   85891 |  7087 | `				iNonNullIdx = i;` |
|   42943 |  7088 | `			}` |
|   42962 |  7089 | `		}` |
|   85779 |  7090 | `		if( nNonNull <= 1 ){` |
|       - |  7091 | `			/* Fast path: store as single type. */` |
|   85681 |  7092 | `			if( iNonNullIdx >= 0 ){` |
|   85675 |  7093 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   85675 |  7094 | `				if( pA->nType == SXU32_HIGH ){` |
...
|   77878 |  7100 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|     163 |  7101 | `					*pnType = MEMOBJ_VOID;` |
|   70002 |  7102 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|      16 |  7103 | `					*pnType = MEMOBJ_NEVER;` |
|       9 |  7104 | `				}else{` |
|   69909 |  7105 | `					*pnType = pA->nType;` |
|       - |  7106 | `				}` |
|   42835 |  7107 | `			}` |
|   42843 |  7108 | `		}else{` |
...
|       - |  7140 | ` */` |
|  345190 |  7141 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  7142 | `{` |
|  345195 |  7143 | `	sxi32 iFlags = 0;` |
|       - |  7144 | `	sxi32 rc;` |
|       - |  7145 | `	sxu32 nLine;` |
|  345195 |  7146 | `	pFunc->nReturnType = 0;` |
|  345195 |  7147 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  345195 |  7148 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
...
|  345195 |  7154 | `	SySetReset(&pFunc->aReturnUnion);` |
|  345195 |  7155 | `	pFunc->iFlags &= ~VM_FUNC_RETURN_NULLABLE;` |
|  345195 |  7156 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  344601 |  7157 | `		return SXRET_OK;` |
|       - |  7158 | `	}` |
|     599 |  7159 | `	pGen->pIn++; /* Skip ':' */` |
|     599 |  7160 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  7161 | `		return SXRET_OK;` |
|       - |  7162 | `	}` |
|     599 |  7163 | `	nLine = pGen->pIn->nLine;` |
|     599 |  7164 | `	rc = GenStateParseUnionTypeDecl(` |
|     297 |  7165 | `		pGen,` |
|     297 |  7166 | `		&pFunc->nReturnType,` |
|     297 |  7167 | `		&pFunc->sReturnClass,` |
|     297 |  7168 | `		&pFunc->aReturnUnion,` |
|       - |  7169 | `		&iFlags,` |
|     297 |  7170 | `		&pFunc->sReturnTypeName,` |
...
|       - |  7174 | `		/* bAllowVoid */ 1,` |
|     297 |  7175 | `		nLine);` |
|     599 |  7176 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  7177 | `		return SXERR_ABORT;` |
|       - |  7178 | `	}` |
|     599 |  7179 | `	if( rc == SXERR_CORRUPT ){` |
|       - |  7180 | `		/* Error already reported */` |
|     ! 0 |  7181 | `		return SXERR_SYNTAX;` |
|       - |  7182 | `	}` |
|     599 |  7183 | `	if( rc == SXERR_SYNTAX ){` |
...
|       - |  7193 | `	}` |
|     593 |  7194 | `	pFunc->iFlags \|= (iFlags & VM_FUNC_RETURN_NULLABLE);` |
|     593 |  7195 | `	return SXRET_OK;` |
|  172600 |  7196 | `}` |
|       - |  7197 |  |
|   55452 |  7198 | `static sxi32 GenStateCompileFunc(` |
...
|   55457 |  7212 | `	nLine = pGen->pIn->nLine;` |
|       - |  7213 | `	/* Jump the left parenthesis '(' */` |
|   55457 |  7214 | `	pGen->pIn++;` |
|       - |  7215 | `	/* Delimit the function signature */` |
|   55457 |  7216 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   55457 |  7217 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  7218 | `		/* Syntax error */` |
...
|   55451 |  7228 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   55451 |  7229 | `	if( pFunc == 0 ){` |
|     ! 0 |  7230 | `		goto OutOfMem;` |
|       - |  7231 | `	}` |
|       - |  7232 | `	/* Build the function name, prepending namespace if active */` |
|   55458 |  7233 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  7234 | `		SyBlob sFQN;` |
|       - |  7235 | `		sxu32 nLen;` |
...
|       9 |  7247 | `	}else{` |
|   55437 |  7248 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   55437 |  7249 | `		if( zName == 0 ){` |
|     ! 0 |  7250 | `			goto OutOfMem;` |
|       - |  7251 | `		}` |
|   55437 |  7252 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  7253 | `	}` |
|   55451 |  7254 | `	if( pGen->pIn < pEnd ){` |
|       - |  7255 | `		/* Collect function arguments */` |
|   39379 |  7256 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   39379 |  7257 | `		if( rc == SXERR_ABORT ){` |
...
|   55451 |  7263 | `	pGen->pIn = &pEnd[1];` |
|       - |  7264 | `	{` |
|   55451 |  7265 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   55451 |  7266 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  7267 | `			return SXERR_ABORT;` |
|   55451 |  7268 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       8 |  7269 | `			return SXERR_SYNTAX;` |
|       - |  7270 | `		}` |
|       - |  7271 | `	}` |
|   55445 |  7272 | `	if( bHandleClosure ){` |
...
|   55445 |  7378 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   55445 |  7379 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  7380 | `		return SXERR_ABORT;` |
|       - |  7381 | `	}` |
|   55445 |  7382 | `	if( ppFunc ){` |
|     329 |  7383 | `		*ppFunc = pFunc;` |
|     162 |  7384 | `	}` |
|   55445 |  7385 | `	rc = SXRET_OK;` |
|   55445 |  7386 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  7387 | `		/* Finally register the function */` |
|   55421 |  7388 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   27708 |  7389 | `	}` |
|   55445 |  7390 | `	if( rc == SXRET_OK ){` |
|   55445 |  7391 | `		return SXRET_OK;` |
|       - |  7392 | `	}` |
...
|       - |  7404 | ` */` |
|   55136 |  7405 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  7406 | `{` |
|       - |  7407 | `	SyString *pName;` |
|       - |  7408 | `	sxi32 iFlags;` |
|       - |  7409 | `	sxu32 nLine;` |
|       - |  7410 | `	sxi32 rc;` |
|       - |  7411 |  |
|   55141 |  7412 | `	nLine = pGen->pIn->nLine;` |
|   55141 |  7413 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   55141 |  7414 | `	iFlags = 0;` |
|   55141 |  7415 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7416 | `		/* Return by reference,remember that */` |
|      10 |  7417 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7418 | `		/* Jump the '&' token */` |
|      10 |  7419 | `		pGen->pIn++;` |
|       4 |  7420 | `	}` |
|   55141 |  7421 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  7432 | `	}` |
|   55135 |  7433 | `	pName = &pGen->pIn->sData;` |
|   55135 |  7434 | `	nLine = pGen->pIn->nLine;` |
|       - |  7435 | `	/* Jump the function name */` |
|   55135 |  7436 | `	pGen->pIn++;` |
|   55135 |  7437 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7438 | `		/* Syntax error */` |
...
|   55133 |  7451 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   55133 |  7452 | `	return rc;` |
|   27573 |  7453 | `}` |
|       - |  7454 | `/*` |
...
|       - |  7595 | `		}` |
|   47554 |  7596 | `		if( (p->nType & PH7_TK_KEYWORD)` |
...
|  201032 |  7939 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
...
|       - |  8121 | ` */` |
| 1867756 |  8122 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  8123 | `{` |
| 1900595 |  8124 | `	return (pTok->nType & PH7_TK_ID)` |
|  966712 |  8125 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1900590 |  8126 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  8127 | `}` |
...
|  289510 |  8418 | `		if( (pName->nByte == sizeof("__construct") - 1` |
...
|       - |  9096 | ` */` |
|  109162 |  9097 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  9098 | `{` |
|  109167 |  9099 | `	int isAbsolute = 0;` |
|  109167 |  9100 | `	SyToken *pStart = pGen->pIn;` |
|       - |  9101 | `	SyBlob sName;` |
|  109167 |  9102 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|    4369 |  9103 | `		isAbsolute = 1;` |
|    4369 |  9104 | `		pGen->pIn++;` |
|    2182 |  9105 | `	}` |
|  109167 |  9106 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       8 |  9107 | `		pGen->pIn = pStart;` |
|       8 |  9108 | `		return SXERR_INVALID;` |
|       - |  9109 | `	}` |
|  109161 |  9110 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|  109161 |  9111 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|  109161 |  9112 | `	pGen->pIn++;` |
|  163755 |  9113 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   54604 |  9114 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      16 |  9115 | `		SyBlobAppend(&sName,"\\",1);` |
|      16 |  9116 | `		pGen->pIn++;` |
|      16 |  9117 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      16 |  9118 | `		pGen->pIn++;` |
|       2 |  9119 | `	}` |
|  109161 |  9120 | `	if( isAbsolute ){` |
|    4367 |  9121 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|    2186 |  9122 | `	}else{` |
|       - |  9123 | `		SyString sRaw;` |
...
|       - |  9126 | `	}` |
|  109161 |  9127 | `	SyBlobRelease(&sName);` |
|  109161 |  9128 | `	return SXRET_OK;` |
|   54586 |  9129 | `}` |
|       - |  9130 | `/*` |
...
|   15561 |  9357 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
...
|       - | 10136 | ` */` |
| 1139190 | 10137 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 | 10138 | `{` |
| 1139195 | 10139 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  782151 | 10140 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  782151 | 10141 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  774441 | 10142 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  387187 | 10143 | `	}` |
| 1131423 | 10144 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 1131363 | 10145 | `	return FALSE;` |
|  569600 | 10146 | `}` |
|       - | 10147 | `/*` |
...
|       - | 10152 | ` */` |
| 1131358 | 10153 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 | 10154 | `{` |
| 1131363 | 10155 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 1131363 | 10156 | `	sxi32 iFlags = 0,iFlag;` |
| 1139195 | 10157 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
...
|    7837 | 10162 | `		pIn++;` |
|       5 | 10163 | `	}` |
| 1131363 | 10164 | `	*ppIn = pIn;` |
| 1131363 | 10165 | `	if( ppDup ){ *ppDup = pDup; }` |
| 1131363 | 10166 | `	return iFlags;` |
|       5 | 10167 | `}` |
|       - | 10168 | `/*` |
...
|       - | 10174 | ` */` |
| 1127452 | 10175 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 | 10176 | `{` |
| 1127457 | 10177 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  567639 | 10178 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 1129407 | 10179 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 | 10180 | `}` |
|       - | 10181 | `/*` |
...
|       - | 10198 | `		}` |
|       1 | 10199 | `	}` |
|    3906 | 10200 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
...
|       - | 10537 | ` */` |
|   38814 | 10538 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 | 10539 | `{` |
|   38819 | 10540 | `	sxi32 rc = SXRET_OK;` |
|   38819 | 10541 | `	if( pRoot->pOp ){` |
|   38807 | 10542 | `		switch( pRoot->pOp->iOp ){` |
|   19401 | 10543 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 | 10559 | `			break;` |
|       - | 10560 | `		}` |
|   19418 | 10561 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - | 10575 | ` */` |
|   38778 | 10576 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 | 10577 | `{` |
|   38783 | 10578 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 10579 | `	GenBlock *pBlock;` |
|       - | 10580 | `	sxu32 nIdx;` |
|       - | 10581 | `	sxi32 rc;` |
|   38783 | 10582 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - | 10583 | `	/* Compile the expression */` |
|   38783 | 10584 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   38783 | 10585 | `	if( rc == SXERR_EMPTY ){` |
...
|       - | 10591 | `	}` |
|   38783 | 10592 | `	pBlock = pGen->pCurrent;` |
|       - | 10593 | `	/* Point to the top most function or try block and emit the forward jump */` |
|  185209 | 10594 | `	while(pBlock->pParent){` |
|  185205 | 10595 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   38779 | 10596 | `			break;` |
|       - | 10597 | `		}` |
|       - | 10598 | `		/* Point to the parent block */` |
|  146431 | 10599 | `		pBlock = pBlock->pParent;` |
|       5 | 10600 | `	}` |
|       - | 10601 | `	/* Emit the throw instruction */` |
|   38783 | 10602 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - | 10603 | `	/* Emit the jump */` |
|   38783 | 10604 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   38783 | 10605 | `	return SXRET_OK;` |
|   19394 | 10606 | `}` |
|       - | 10607 | `/*` |
...
|       - | 10845 | ` */` |
|    1078 | 10846 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       5 | 10847 | `{` |
|    1083 | 10848 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - | 10855 | `	char *zDup;` |
|       - | 10856 | `	sxi32 rc;` |
|    1083 | 10857 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - | 10858 | `	/* Zero the structure */` |
|    1083 | 10859 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - | 10860 | `	/* Initialize fields */` |
|    1083 | 10861 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|    1083 | 10862 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|    1083 | 10863 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|    1083 | 10878 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     553 | 10879 | `	for(;;){` |
|       - | 10880 | `		SyBlob sResolved;` |
|    1111 | 10881 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|    1111 | 10882 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|    1658 | 10898 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    1102 | 10899 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|    1107 | 10900 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|    1107 | 10901 | `		SyBlobRelease(&sResolved);` |
|    1107 | 10902 | `		if( zDup == 0 ){` |
|     ! 0 | 10903 | `			goto Mem;` |
|       - | 10904 | `		}` |
|    1107 | 10905 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|    1107 | 10906 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10907 | `			goto Mem;` |
|       - | 10908 | `		}` |
|       - | 10909 | `		/* Check for '\|' (multi-catch separator) */` |
|    1102 | 10910 | `		if( pGen->pIn < pGen->pEnd &&` |
|    1102 | 10911 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|    1079 | 10917 | `		break;` |
|     ! 0 | 10918 | `	}` |
|    1074 | 10919 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|    1079 | 10920 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - | 10933 | `	}` |
|    1079 | 10934 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - | 10935 | `	/* Duplicate instance name */` |
|    1079 | 10936 | `	pName = &pGen->pIn->sData;` |
|    1079 | 10937 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|    1079 | 10938 | `	if( zDup == 0 ){` |
|     ! 0 | 10939 | `		goto Mem;` |
|       - | 10940 | `	}` |
|    1079 | 10941 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|    1079 | 10942 | `	pGen->pIn++;` |
|    1079 | 10943 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|    1079 | 10958 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - | 10959 | `	/* Create the catch block */` |
|    1079 | 10960 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|    1079 | 10961 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10962 | `		return SXERR_ABORT;` |
|       - | 10963 | `	}` |
|       - | 10964 | `	/* Swap bytecode container */` |
|    1079 | 10965 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|    1079 | 10966 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - | 10967 | `	/* Compile the block */` |
|    1079 | 10968 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - | 10969 | `	/* Fix forward jumps now the destination is resolved  */` |
|    1079 | 10970 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10971 | `	/* Emit the DONE instruction */` |
|    1079 | 10972 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - | 10973 | `	/* Leave the block */` |
|    1079 | 10974 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10975 | `	/* Restore the default container */` |
|    1079 | 10976 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - | 10977 | `	/* Install the catch block */` |
|    1079 | 10978 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|    1079 | 10979 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10980 | `		goto Mem;` |
|       - | 10981 | `	}` |
|    1079 | 10982 | `	return SXRET_OK;` |
|     ! 0 | 10983 | `Mem:` |
...
|       - | 10992 | ` * is "thrown".` |
|       - | 10993 | ` */` |
|    1226 | 10994 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       5 | 10995 | `{` |
|       - | 10996 | `	ph7_exception *pException;` |
|    1231 | 10997 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 10998 | `	GenBlock *pTry;` |
|       - | 10999 | `	sxu32 nJmpIdx;` |
|       - | 11000 | `	sxi32 rc;` |
|       - | 11001 | `	/* Create the exception container */` |
|    1231 | 11002 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|    1231 | 11003 | `	if( pException == 0 ){` |
...
|    1231 | 11009 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - | 11010 | `	/* Initialize fields */` |
|    1231 | 11011 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|    1231 | 11012 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|    1231 | 11013 | `	pException->iHasFinally = 0;` |
|    1231 | 11014 | `	pException->iFinallyDone = 0;` |
|    1231 | 11015 | `	pException->pVm = pGen->pVm;` |
...
|    1231 | 11022 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|      94 | 11023 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|       - | 11024 | `	}` |
|       - | 11025 | `	/* Create the try block */` |
|    1141 | 11026 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|    1141 | 11027 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 11028 | `		return SXERR_ABORT;` |
|       - | 11029 | `	}` |
|       - | 11030 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|    1141 | 11031 | `	pTry->pUserData = pException;` |
|       - | 11032 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|    1141 | 11033 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - | 11034 | `	/* Fix the jump later when the destination is resolved */` |
|    1141 | 11035 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|    1141 | 11036 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - | 11037 | `	/* Compile the block */` |
|    1141 | 11038 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|    1141 | 11039 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 | 11040 | `		return SXERR_ABORT;` |
|       - | 11041 | `	}` |
|       - | 11042 | `	/* Fix forward jumps now the destination is resolved */` |
|    1141 | 11043 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 11044 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|    1141 | 11045 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - | 11046 | `	/* Leave the block */` |
|    1141 | 11047 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 11048 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|    1141 | 11049 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|    1134 | 11050 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - | 11051 | `		/* Compile one or more catch blocks */` |
|    1074 | 11052 | `		for(;;){` |
|    2148 | 11053 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|    1569 | 11054 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     540 | 11055 | `					break;` |
|       - | 11056 | `			}` |
|    1083 | 11057 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|    1083 | 11058 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 11059 | `				return SXERR_ABORT;` |
|       - | 11060 | `			}` |
|       5 | 11061 | `		}` |
|     535 | 11062 | `	}` |
|       - | 11063 | `	/* Compile optional finally block */` |
|    1141 | 11064 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     466 | 11065 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
...
|    1141 | 11094 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
...
|       - | 11457 | ` */` |
| 3043628 | 11458 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 11459 | `{` |
| 3043633 | 11460 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 11461 | `	sxu32 nTarget;` |
|       - | 11462 | `	sxu32 *aIdx;` |
|       - | 11463 | `	sxu32 i;` |
| 3043633 | 11464 | `	if( nCur <= nBaseline ){` |
| 3043537 | 11465 | `		return;` |
|       - | 11466 | `	}` |
...
|       - | 11494 | ` */` |
|  515564 | 11495 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 11496 | `{` |
...
|       - | 11506 | `	};` |
|       - | 11507 | `	sxu32 i;` |
|  515569 | 11508 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    2423 | 11509 | `		return 0;` |
|       - | 11510 | `	}` |
| 2565463 | 11511 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 2052406 | 11512 | `		if( pName->nByte == aByRef[i].nByte` |
| 1054266 | 11513 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      99 | 11514 | `			return aByRef[i].mask;` |
|       - | 11515 | `		}` |
| 1026161 | 11516 | `	}` |
|  513057 | 11517 | `	return 0;` |
|  257787 | 11518 | `}` |
|       - | 11519 | `/*` |
...
|       - | 11528 | ` */` |
|  515564 | 11529 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 11530 | `{` |
|       - | 11531 | `	SyToken *p, *pEnd;` |
|  515569 | 11532 | `	pOut->zString = 0;` |
|  515569 | 11533 | `	pOut->nByte = 0;` |
|  515569 | 11534 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 11535 | `		return;` |
|       - | 11536 | `	}` |
|  515569 | 11537 | `	p = pLeft->pStart;` |
|  515569 | 11538 | `	pEnd = pLeft->pEnd;` |
|       - | 11539 | `	/* Optional single leading namespace separator (absolute path). */` |
|  515569 | 11540 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|    3877 | 11541 | `		p++;` |
|    1936 | 11542 | `	}` |
|  515569 | 11543 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    2387 | 11544 | `		return;` |
|       - | 11545 | `	}` |
|       - | 11546 | `	/* Must be a single component: nothing follows the name token. */` |
|  513187 | 11547 | `	if( p + 1 != pEnd ){` |
|      41 | 11548 | `		return;` |
|       - | 11549 | `	}` |
|  513151 | 11550 | `	*pOut = p->sData;` |
|  257787 | 11551 | `}` |
|       - | 11552 | `/*` |
...
|       - | 11557 | ` * error message.` |
|       - | 11558 | ` */` |
| 4046554 | 11559 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 11566 | `	sxu32 nJmpIdx;` |
| 4046559 | 11567 | `	sxi32 iP1 = 0;` |
| 4046559 | 11568 | `	sxu32 iP2 = 0;` |
| 4046559 | 11569 | `	void *p3  = 0;` |
|       - | 11570 | `	sxi32 iVmOp;` |
|       - | 11571 | `	sxi32 rc;` |
| 4046559 | 11572 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 4046559 | 11573 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
| 4046559 | 11574 | `	sxu32 nRhsNsBase = 0;` |
| 4046559 | 11575 | `	if( pNode->xCode ){` |
|       - | 11576 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 11577 | `		/* Compile node */` |
| 2533053 | 11578 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2533053 | 11579 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2533053 | 11580 | `		RE_SWAP_DELIMITER(pGen);` |
| 2533053 | 11581 | `		return rc;` |
|       - | 11582 | `	}` |
| 1513511 | 11583 | `	if( pNode->pOp == 0 ){` |
...
|       - | 11587 | `	}` |
| 1513511 | 11588 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1513511 | 11589 | `	if( iVmOp == PH7_OP_CVT_NULL ){` |
...
|       - | 11597 | `		}` |
|       1 | 11598 | `	}` |
| 1513511 | 11599 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 11648 | `	}` |
| 1513449 | 11649 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|    6555 | 11654 | `		nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    6555 | 11655 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pCond,iFlags);` |
|    6555 | 11656 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 11657 | `			return rc;` |
|       - | 11658 | `		}` |
...
|    6555 | 11662 | `		GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    6555 | 11663 | `		nJz = nJmp = 0; /* cc -O6 warning */` |
|    6555 | 11664 | `		if( pNode->pLeft ){` |
|       - | 11665 | `			/* Standard ternary: (expr) ? (then) : (else) */` |
|       - | 11666 | `			/* Phase#2: Emit the false jump (pops condition) */` |
|    6487 | 11667 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJz);` |
|       - | 11668 | `			/* Phase#3: Compile the 'then' expression  */` |
|    6487 | 11669 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    6487 | 11670 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iFlags);` |
|    6487 | 11671 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 11672 | `				return rc;` |
|       - | 11673 | `			}` |
|    6487 | 11674 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    3246 | 11675 | `		}else{` |
...
|    6555 | 11683 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJmp);` |
|       - | 11684 | `		/* Phase#5: Fix the false jump now the jump destination is resolved. */` |
|    6555 | 11685 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJz);` |
|    6555 | 11686 | `		if( pInstr ){` |
|    6555 | 11687 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    3275 | 11688 | `		}` |
|    6555 | 11689 | `		if( !pNode->pLeft ){` |
...
|    6555 | 11694 | `		if( pNode->pRight ){` |
|    6555 | 11695 | `			nTernaryNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|    6555 | 11696 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|    6555 | 11697 | `			if( rc != SXRET_OK ){` |
|     ! 0 | 11698 | `				return rc;` |
|       - | 11699 | `			}` |
|    6555 | 11700 | `			GenStatePatchNullsafeJumps(pGen, nTernaryNsBase);` |
|    3275 | 11701 | `		}` |
|    6555 | 11702 | `		if( nJmp > 0 ){` |
|       - | 11703 | `			/* Phase#7: Fix the unconditional jump */` |
|    6555 | 11704 | `			pInstr = PH7_VmGetInstr(pGen->pVm,nJmp);` |
|    6555 | 11705 | `			if( pInstr ){` |
|    6555 | 11706 | `				pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    3275 | 11707 | `			}` |
|    3275 | 11708 | `		}` |
|       - | 11709 | `		/* All done */` |
|    6555 | 11710 | `		return SXRET_OK;` |
|       - | 11711 | `	}` |
| 1506899 | 11712 | `	if( pNode->pOp->iOp == EXPR_OP_PIPE ){` |
...
|       - | 11744 | `	}` |
| 1506873 | 11745 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 11746 | `	/* Generate code for the left tree */` |
| 1506873 | 11747 | `	if( pNode->pLeft ){` |
| 1506841 | 11748 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1506841 | 11749 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 11750 | `			ph7_expr_node **apNode;` |
|  519581 | 11751 | `			int hasSpread = 0;` |
|  519581 | 11752 | `			int hasNamed = 0;` |
|  519581 | 11753 | `			int bAnySpread = 0;` |
|  519581 | 11754 | `			sxu32 byRefMask = 0;` |
|       - | 11755 | `			sxi32 nArgs;` |
|       - | 11756 | `			sxi32 n;` |
|       - | 11757 | `			/* Recurse and generate bytecodes for function arguments */` |
|  519581 | 11758 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  519581 | 11759 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|  519581 | 11763 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|      77 | 11764 | `				bFcc = 1;` |
|      77 | 11765 | `				nArgs = 0;` |
|      38 | 11766 | `			}` |
|       - | 11767 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 11768 | `			{` |
|  519581 | 11769 | `				int seenNamed = 0;` |
| 1053333 | 11770 | `				for( n = 0; n < nArgs; ++n ){` |
|  533759 | 11771 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     253 | 11772 | `						seenNamed = 1;` |
|     253 | 11773 | `						hasNamed = 1;` |
|  533635 | 11774 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|    3877 | 11775 | `						bAnySpread = 1;` |
|  531575 | 11776 | `					}else if( seenNamed ){` |
...
|  519579 | 11784 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  519579 | 11789 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  519579 | 11790 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  519574 | 11791 | `				if( pCallName->nByte == 5` |
|  278215 | 11792 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   23403 | 11793 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  507880 | 11794 | `				}else if( pCallName->nByte == 5` |
|  254817 | 11795 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  519579 | 11804 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 11805 | `					SyString sBuiltin;` |
|  515569 | 11806 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  515569 | 11807 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  257782 | 11808 | `				}` |
|  259787 | 11809 | `			}` |
| 1053329 | 11810 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  533755 | 11811 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  533755 | 11812 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|  533755 | 11819 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      55 | 11820 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      55 | 11821 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|      25 | 11822 | `				}` |
|  533755 | 11823 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  533755 | 11824 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 11825 | `					return rc;` |
|       - | 11826 | `				}` |
|       - | 11827 | `				/* Each argument is an independent nullsafe scope. */` |
|  533755 | 11828 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  533755 | 11829 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  519579 | 11872 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  259787 | 11873 | `		}` |
|       - | 11874 | `		{` |
...
| 1506839 | 11883 | `			sxi32 iLeftFlags = iFlags;` |
| 1506834 | 11884 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
| 1138735 | 11885 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|  385344 | 11886 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  376535 | 11887 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   17841 | 11888 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|    8918 | 11889 | `			}` |
...
| 1506834 | 11897 | `			if( pNode->pOp` |
| 2164318 | 11898 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
| 1410948 | 11899 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
| 1315010 | 11900 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|  192259 | 11901 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   96127 | 11902 | `			}` |
| 1506839 | 11903 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|       - | 11904 | `		}` |
| 1506839 | 11905 | `		if( rc != SXRET_OK ){` |
|      34 | 11906 | `			return rc;` |
|       - | 11907 | `		}` |
| 1506809 | 11908 | `		if( !bIsChainOp ){` |
...
|  696155 | 11911 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  348075 | 11912 | `		}` |
| 1506809 | 11913 | `		if( iVmOp == PH7_OP_CALL ){` |
|  519579 | 11914 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  519579 | 11915 | `			if( pInstr ){` |
|  519579 | 11916 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  513305 | 11917 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 11918 | `					sxu32 nQual;` |
|  513305 | 11919 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 11920 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 11921 | `					 * so the later NEW handler (if any) can see it. */` |
|  513305 | 11922 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  513305 | 11930 | `					if( bAbsolute ){` |
|    3877 | 11931 | `						pInstr->iP2 = (sxi32)nOrig;` |
|    1941 | 11932 | `					}else{` |
|  509433 | 11933 | `						int fromImport = 0;` |
|  509433 | 11934 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  509433 | 11935 | `						pInstr->iP2 = (sxi32)nQual;` |
|  509433 | 11936 | `						if( nQual != nOrig ){` |
...
|      36 | 11954 | `						}` |
|       5 | 11955 | `					}` |
|  262929 | 11956 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 11957 | `					/* Method call,flag that */` |
|    1971 | 11958 | `					pInstr->iP2 = 1;` |
|     983 | 11959 | `				}` |
|  259792 | 11960 | `			}` |
| 1247022 | 11961 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 11962 | `			ph7_expr_node **apNode;` |
|       - | 11963 | `			sxi32 n;` |
|   98831 | 11964 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   98831 | 11968 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  178325 | 11969 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   79499 | 11970 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   79499 | 11971 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   79499 | 11972 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 11973 | `					return rc;` |
|       - | 11974 | `				}` |
|       - | 11975 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   79499 | 11976 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   39752 | 11977 | `			}` |
|   98831 | 11978 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   79499 | 11979 | `				iP1 = 1; /* Node have an index associated with it */` |
|   39747 | 11980 | `			}` |
|   98831 | 11981 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 11982 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     245 | 11983 | `				iP2 = 4;` |
|   98711 | 11984 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 11985 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 11986 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      64 | 11987 | `				iP2 = 5;` |
|   98561 | 11988 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|      29 | 11992 | `				iP2 = 6;` |
|   98519 | 11993 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 11994 | `				/* Create an empty entry when the desired index is not found */` |
|   38991 | 11995 | `				iP2 = 1;` |
|   19498 | 11996 | `			}` |
|  937822 | 11997 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 11998 | `			/* POP the left node */` |
|      32 | 11999 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 12000 | `		}` |
|  753402 | 12001 | `	}` |
| 1506841 | 12002 | `	rc = SXRET_OK;` |
| 1506841 | 12003 | `	nJmpIdx = 0;` |
...
| 1506841 | 12007 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
| 1506765 | 12037 | `	if( pNode->pRight ){` |
|  788285 | 12038 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 12039 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   12063 | 12040 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  782256 | 12041 | `		}else if (iVmOp == PH7_OP_LOR ){` |
...
|  774215 | 12044 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  772190 | 12048 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  772021 | 12058 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|  329175 | 12062 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|  164585 | 12063 | `		}` |
|  788285 | 12064 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  788285 | 12065 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  788285 | 12066 | `		if( !bIsChainOp ){` |
|       - | 12067 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 12068 | `			 * operator instruction is emitted. */` |
|  596075 | 12069 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  298035 | 12070 | `		}` |
|  788285 | 12071 | `		if( iVmOp == PH7_OP_STORE ){` |
|  325049 | 12072 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  325014 | 12073 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 12079 | `				 */` |
|      85 | 12080 | `				iVmOp = 0;` |
|  325009 | 12081 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  324969 | 12082 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 12083 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   85083 | 12084 | `					iP2 = 1;` |
|   42544 | 12085 | `				}else{` |
|  239891 | 12086 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
...
|   19457 | 12090 | `					}else{` |
|  200987 | 12091 | `						p3 = pInstr->p3;` |
|       - | 12092 | `					}` |
|       - | 12093 | `					/* POP the last dynamic load instruction */` |
|  239891 | 12094 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 12095 | `				}` |
|  162487 | 12096 | `			}` |
|  625763 | 12097 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      29 | 12112 | `		}` |
|  394140 | 12113 | `	}` |
| 1506760 | 12114 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|   24078 | 12115 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|      30 | 12118 | `		iVmOp = 0;` |
|      13 | 12119 | `	}` |
| 1506765 | 12120 | `	if( iVmOp > 0 ){` |
| 1506499 | 12121 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   15795 | 12122 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 12123 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|   11557 | 12124 | `				iP1 = 1;` |
|    5781 | 12125 | `			}` |
| 1498604 | 12126 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 12127 | `			/* Namespace-qualify the class name for NEW */ {` |
|   47883 | 12128 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   47883 | 12129 | `				VmInstr *pCallInstr = 0;` |
|   47883 | 12130 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   47667 | 12131 | `					pCallInstr = pPeek;` |
|   47667 | 12132 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|   23831 | 12133 | `				}` |
|   47883 | 12134 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   47879 | 12135 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   47879 | 12140 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 12141 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 12142 | `					}else{` |
|   47847 | 12143 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 12144 | `					}` |
|   47879 | 12145 | `					pPeek->iP1 = 0;` |
|   47879 | 12146 | `					if( !bAbsolute ){` |
|   44011 | 12147 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|   22008 | 12148 | `					}else{` |
|    3873 | 12149 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 12150 | `					}` |
|   23937 | 12151 | `				}` |
|       - | 12152 | `			}` |
|   47883 | 12153 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   47883 | 12154 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 12155 | `				VmInstr *pPrev;` |
|   47667 | 12156 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   47667 | 12157 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 12158 | `					/* Pop the call instruction, preserve named-arg map */` |
|   47667 | 12159 | `					iP1 = pInstr->iP1;` |
|   47667 | 12160 | `					if( pInstr->p3 ){` |
|      43 | 12161 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 12162 | `					}` |
|   47667 | 12163 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|   23831 | 12164 | `				}` |
|   23836 | 12165 | `			}` |
| 1466770 | 12166 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|      89 | 12186 | `				}` |
|     104 | 12187 | `			}` |
| 1442732 | 12188 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  192215 | 12192 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  192215 | 12193 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  192165 | 12194 | `				pInstr->iP1 = 0;` |
|   96080 | 12195 | `			}` |
|  192215 | 12196 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
|  192215 | 12209 | `			if( iP2 == PH7_MEMBER_READ ){` |
|  192215 | 12210 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|      30 | 12211 | `					iP2 = PH7_MEMBER_UNSET;` |
|  192201 | 12212 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|      77 | 12213 | `					iP2 = PH7_MEMBER_ISSET;` |
|  192151 | 12214 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|      13 | 12215 | `					iP2 = PH7_MEMBER_EMPTY;` |
|  192109 | 12216 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
...
| 1506499 | 12249 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  567381 | 12250 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  283688 | 12251 | `		}` |
|       - | 12252 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1506499 | 12253 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  753247 | 12254 | `	}` |
| 1506765 | 12255 | `	if( nJmpIdx > 0 ){` |
|       - | 12256 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   16217 | 12257 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   16217 | 12258 | `		if( pInstr ){` |
|   16217 | 12259 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    8106 | 12260 | `		}` |
|    8106 | 12261 | `	}` |
| 1506765 | 12262 | `	return rc;` |
| 2023266 | 12263 | `}` |
|       - | 12264 | `/*` |
...
|       - | 12273 | ` * message.` |
|       - | 12274 | ` */` |
| 1118598 | 12275 | `static sxi32 PH7_CompileExpr(` |
...
| 1118603 | 12289 | `	nExpr = 0;` |
| 1118603 | 12290 | `	pRoot = 0;` |
...
| 1118603 | 12293 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1118603 | 12294 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
| 1118603 | 12295 | `	SySetAlloc(&sExprNode,0x10);` |
| 1118603 | 12296 | `	rc = SXRET_OK;` |
|       - | 12297 | `	/* Delimit the expression */` |
| 1118603 | 12298 | `	pEnd = pGen->pIn;` |
| 1118603 | 12299 | `	iNest = 0;` |
| 7330795 | 12300 | `	while( pEnd < pGen->pEnd ){` |
| 6929917 | 12301 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 12302 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     563 | 12303 | `			iNest++;` |
| 6929638 | 12304 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     571 | 12305 | `			iNest--;` |
| 6929076 | 12306 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  718161 | 12307 | `			if( iNest <= 0 ){` |
|  717725 | 12308 | `				break;` |
|       - | 12309 | `			}` |
|     218 | 12310 | `		}` |
| 6212197 | 12311 | `		pEnd++;` |
|       5 | 12312 | `	}` |
| 1118603 | 12313 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
...
|       3 | 12331 | `		}` |
|   11832 | 12332 | `	}` |
| 1118603 | 12333 | `	if( pEnd > pGen->pIn ){` |
| 1118593 | 12334 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 12335 | `		/* Swap delimiter */` |
| 1118593 | 12336 | `		pGen->pEnd = pEnd;` |
|       - | 12337 | `		/* Try to get an expression tree */` |
| 1118593 | 12338 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
| 1118593 | 12339 | `		if( rc == SXRET_OK && pRoot ){` |
| 1118411 | 12340 | `			rc = SXRET_OK;` |
| 1118411 | 12341 | `			if( xTreeValidator ){` |
|       - | 12342 | `				/* Call the upper layer validator callback */` |
|   61813 | 12343 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   30904 | 12344 | `			}` |
| 1118411 | 12345 | `			if( rc != SXERR_ABORT ){` |
|       - | 12346 | `				/* Generate code for the given tree */` |
| 1118411 | 12347 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 12348 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 12349 | `				 * expression so they short-circuit to its end. */` |
| 1118411 | 12350 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  559203 | 12351 | `			}` |
| 1118411 | 12352 | `			nExpr = 1;` |
|  559203 | 12353 | `		}` |
|       - | 12354 | `		/* Release the whole tree */` |
| 1118593 | 12355 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 12356 | `		/* Synchronize token stream */` |
| 1118593 | 12357 | `		pGen->pEnd = pTmp;` |
| 1118593 | 12358 | `		pGen->pIn  = pEnd;` |
| 1118593 | 12359 | `		if( rc == SXERR_ABORT ){` |
|      13 | 12360 | `			SySetRelease(&sExprNode);` |
|      13 | 12361 | `			return SXERR_ABORT;` |
|       - | 12362 | `		}` |
|  559289 | 12363 | `	}` |
| 1118593 | 12364 | `	SySetRelease(&sExprNode);` |
| 1118593 | 12365 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  559304 | 12366 | `}` |
|       - | 12367 | `/*` |
|       - | 12368 | ` * Return a pointer to the node construct handler associated` |
|       - | 12369 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 12370 | ` */` |
|  334842 | 12371 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 12372 | `{` |
|  334847 | 12373 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 12374 | `		/* Numeric literal: Either real or integer */` |
|  136443 | 12375 | `		return PH7_CompileNumLiteral;` |
|  198409 | 12376 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 12377 | `		/* Double quoted string */` |
|   25845 | 12378 | `		return PH7_CompileString;` |
|  172569 | 12379 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 12380 | `		/* Single quoted string */` |
|  172449 | 12381 | `		return PH7_CompileSimpleString;` |
...
|       - | 12398 | ` */` |
|    6722 | 12399 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|       5 | 12400 | `{` |
|       - | 12401 | `	sxi32 rc;` |
|    6727 | 12402 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|    6725 | 12403 | `		return SXRET_OK;` |
|       - | 12404 | `	}` |
...
|       - | 12416 | ` */` |
|    2878 | 12417 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|       5 | 12418 | `{` |
|    2883 | 12419 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|    2883 | 12420 | `	sxu32 nIdx = 0;` |
|       - | 12421 | `	SyString sName;` |
|       - | 12422 | `	sxi32 rc;` |
|       - | 12423 | `	/* Jump the 'unset' keyword */` |
|    2883 | 12424 | `	pGen->pIn++;` |
|       - | 12425 | `	/* Save delimiter */` |
|    2883 | 12426 | `	pTmp = pGen->pEnd;` |
|       - | 12427 | `	/* Skip optional opening parenthesis and find the matching close */` |
|    2883 | 12428 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|    2883 | 12429 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       - | 12430 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|       - | 12431 | `		SyToken *pClose;` |
|    2883 | 12432 | `		pGen->pIn++;   /* Skip '(' */` |
|    2883 | 12433 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|    2883 | 12434 | `		pEnd = pClose; /* Stop at ')' */` |
|    1439 | 12435 | `	}` |
|    2883 | 12436 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|       - | 12437 | `	/* Resolve the 'unset' builtin name once */` |
|    2883 | 12438 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
...
|    9607 | 12447 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|    6729 | 12448 | `		if( pGen->pIn < pNext ){` |
|    6729 | 12449 | `			pGen->pEnd = pNext;` |
|    6729 | 12450 | `			rc = PH7_CompileExpr(&(*pGen),` |
|       - | 12451 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|       - | 12452 | `				GenStateUnsetValidator);` |
|    6729 | 12453 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 12454 | `				return SXERR_ABORT;` |
|       - | 12455 | `			}` |
|    6729 | 12456 | `			if( rc != SXERR_EMPTY ){` |
|       - | 12457 | `				/* Emit call for this single argument */` |
|    6727 | 12458 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    6727 | 12459 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|    6727 | 12460 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    3361 | 12461 | `			}` |
|    3362 | 12462 | `		}` |
|       - | 12463 | `		/* Jump trailing commas */` |
|   10577 | 12464 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|    3853 | 12465 | `			pNext++;` |
|       5 | 12466 | `		}` |
|    6729 | 12467 | `		pGen->pIn = pNext;` |
|       5 | 12468 | `	}` |
|       - | 12469 | `	/* Skip past the closing ')' if present */` |
|    2883 | 12470 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|    2883 | 12471 | `		pGen->pIn++;` |
|    1439 | 12472 | `	}` |
|       - | 12473 | `	/* Restore token stream */` |
|    2883 | 12474 | `	pGen->pEnd = pTmp;` |
|    2883 | 12475 | `	return SXRET_OK;` |
|    1444 | 12476 | `}` |
|       - | 12477 | `/*` |
...
|       - | 12509 | ` */` |
|  766566 | 12510 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 12511 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 12512 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 12513 | `	)` |
|       5 | 12514 | `{` |
|  766571 | 12515 | `	sxu32 n = 0;` |
| 3964444 | 12516 | `	for(;;){` |
| 7928893 | 12517 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  151747 | 12518 | `			break;` |
|       - | 12519 | `		}` |
| 7777151 | 12520 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  614829 | 12521 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 12526 | `				}` |
|     ! 0 | 12527 | `			}` |
|  614824 | 12528 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 12535 | `			*/` |
|  614829 | 12536 | `			return aLangConstruct[n].xConstruct;` |
|       - | 12537 | `		}` |
| 7162327 | 12538 | `		n++;` |
|       5 | 12539 | `	}` |
...
|       - | 12582 | ` */` |
|  905948 | 12583 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 12589 | `	sxi32 rc;` |
|  905953 | 12590 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  696472 | 12591 | `	for(;;){` |
| 1149451 | 12592 | `		int bStmtIsDeclare = 0;` |
| 1149451 | 12593 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
| 1131319 | 12599 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  770451 | 12600 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  770451 | 12601 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      47 | 12602 | `				bStmtIsDeclare = 1;` |
|      21 | 12603 | `			}` |
|  385223 | 12604 | `		}` |
| 1131319 | 12605 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  243471 | 12608 | `			pGen->bStrictTypesLocked = 1;` |
|  121733 | 12609 | `		}` |
| 1131319 | 12610 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 12611 | `			/* Compile block */` |
...
|       - | 12615 | `			}` |
|    1936 | 12616 | `		}else{` |
| 1127457 | 12617 | `			xCons = 0;` |
| 1127457 | 12618 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
| 1125504 | 12623 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  766571 | 12624 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 12625 | `				/* Try to extract a language construct handler */` |
|  766571 | 12626 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  766571 | 12627 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 12638 | `				}` |
|  740268 | 12639 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   50109 | 12640 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 12641 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 12642 | `				xCons = PH7_CompileLabel;` |
|      56 | 12643 | `			}` |
| 1127457 | 12644 | `			if( xCons == 0 ){` |
|       - | 12645 | `				/* Assume an expression an try to compile it */` |
|  357291 | 12646 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  357291 | 12647 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 12648 | `					/* Pop l-value */` |
|  357141 | 12649 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  178568 | 12650 | `				}` |
|  178648 | 12651 | `			}else{` |
|       - | 12652 | `				/* Go compile the sucker */` |
|  770171 | 12653 | `				rc = xCons(&(*pGen));` |
|       - | 12654 | `			}` |
| 1127457 | 12655 | `			if( rc == SXERR_ABORT ){` |
|       - | 12656 | `				/* Request to abort compilation */` |
|      13 | 12657 | `				break;` |
|       - | 12658 | `			}` |
|       - | 12659 | `		}` |
|       - | 12660 | `		/* Ignore trailing semi-colons ';' */` |
| 1816865 | 12661 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  685561 | 12662 | `			pGen->pIn++;` |
|       5 | 12663 | `		}` |
| 1131309 | 12664 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 12680 | ` */` |
|   18144 | 12681 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 12685 | `	)` |
|       5 | 12686 | `{` |
|   18149 | 12687 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 12688 | `	sxi32 rc;` |
|       - | 12689 | `	/* Reset the token set */` |
|   18149 | 12690 | `	SySetReset(&(*pTokenSet));` |
|       - | 12691 | `	/* Mark as the default token set */` |
|   18149 | 12692 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 12693 | `	/* Advance the stream cursor */` |
|   18149 | 12694 | `	pGen->pRawIn++;` |
|       - | 12695 | `	/* Tokenize the PHP chunk first */` |
|   18149 | 12696 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 12697 | `	/* Point to the head and tail of the token stream. */` |
|   18149 | 12698 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   18149 | 12699 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   18149 | 12700 | `	if( is_expr ){` |
...
|       - | 12709 | `	}` |
|   18149 | 12710 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   18147 | 12735 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 12736 | `	/* Fix exceptions jumps */` |
|   18147 | 12737 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 12738 | `	/* Fix gotos now, the jump destination is resolved */` |
|   18147 | 12739 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 12740 | `		rc = SXERR_ABORT;` |
|       1 | 12741 | `	}` |
|       - | 12742 | `	/* Reset container */` |
|   18147 | 12743 | `	SySetReset(&pGen->aGoto);` |
|   18147 | 12744 | `	SySetReset(&pGen->aLabel);` |
|   18147 | 12745 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 12746 | `	/* Compilation result */` |
|   18147 | 12747 | `	return rc;` |
|    9077 | 12748 | `}` |
|       - | 12749 | `/*` |
...
|       - | 12753 | ` */` |
|   21154 | 12754 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 12768 | `	sxi32 rc;` |
|   21159 | 12769 | `	if( pScript->nByte < 1 ){` |
...
|   21159 | 12775 | `	pCodeGen = &pVm->sCodeGen;` |
|   21159 | 12776 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   21159 | 12777 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   21159 | 12778 | `	pCodeGen->bStrictTypes = 0;` |
|   21159 | 12779 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 12780 | `	/* Initialize the tokens containers */` |
|   21159 | 12781 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   21159 | 12782 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   21159 | 12783 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   21159 | 12784 | `	is_expr = 0;` |
|   21159 | 12785 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 12786 | `		SyToken sTmp;` |
|       - | 12787 | `		/* PHP only: -*/` |
...
|   13373 | 12799 | `		SySetAlloc(&aRawToken,32);` |
|   13373 | 12800 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 12801 | `	}` |
|       - | 12802 | `	/* Process high-level tokens */` |
|   21159 | 12803 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   21159 | 12804 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   21159 | 12805 | `	rc = PH7_OK;` |
|   21159 | 12806 | `	if( is_expr ){` |
|       - | 12807 | `		/* Compile the expression */` |
|     ! 0 | 12808 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 12809 | `		goto cleanup;` |
|       - | 12810 | `	}` |
|   21159 | 12811 | `	nObjIdx = 0;` |
...
|   21159 | 12815 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 12816 | `	/* Start the compilation process */` |
|   17267 | 12817 | `	for(;;){` |
|   52671 | 12818 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   21147 | 12819 | `			break; /* No more tokens to process */` |
|       - | 12820 | `		}` |
|   31529 | 12821 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 12822 | `			/* Compile the PHP chunk */` |
|   18149 | 12823 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   18149 | 12824 | `			if( rc == SXERR_ABORT ){` |
|      15 | 12825 | `				break;` |
|       - | 12826 | `			}` |
|   18137 | 12827 | `			continue;` |
|       - | 12828 | `		}` |
|       - | 12829 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13385 | 12830 | `		nRawObj = 0;` |
|   26807 | 12831 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 12832 | `			/* Consume the raw chunk without any processing */` |
|   13427 | 12833 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13427 | 12834 | `			if( pRawObj == 0 ){` |
|     ! 0 | 12835 | `				rc = SXERR_MEM;` |
|     ! 0 | 12836 | `				break;` |
|       - | 12837 | `			}` |
|       - | 12838 | `			/* Mark as constant and emit the load constant instruction */` |
|   13427 | 12839 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13427 | 12840 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13427 | 12841 | `			++nRawObj;` |
|   13427 | 12842 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 12843 | `		}` |
|   13385 | 12844 | `		if( nRawObj > 0 ){` |
|       - | 12845 | `			/* Emit the consume instruction */` |
|   13385 | 12846 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6690 | 12847 | `		}` |
|   10582 | 12848 | `	}` |
|   10577 | 12849 | `cleanup:` |
|   21159 | 12850 | `	SySetRelease(&aRawToken);` |
|   21159 | 12851 | `	SySetRelease(&aPhpToken);` |
|       - | 12852 | `	/* Restore outer file's strict_types scope */` |
|   21159 | 12853 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   21159 | 12854 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   21159 | 12855 | `	return rc;` |
|   10582 | 12856 | `}` |
|       - | 12857 | `/*` |
...
|       - | 12895 | ` */` |
|   24626 | 12896 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 12897 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 12898 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 12899 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 12900 | `	)` |
|       5 | 12901 | `{` |
|   24631 | 12902 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 12903 | `	GenBlock *pBlock,*pParent;` |
|       - | 12904 | `	/* Reset state */` |
|   24631 | 12905 | `	SySetReset(&pGen->aLabel);` |
|   24631 | 12906 | `	SySetReset(&pGen->aGoto);` |
|   24631 | 12907 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   24631 | 12908 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   24631 | 12909 | `	SyBlobRelease(&pGen->sWorker);` |
|   24631 | 12910 | `	SyBlobRelease(&pGen->sNamespace);` |
|   24631 | 12911 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   24631 | 12912 | `	SyHashRelease(&pGen->hUseImports);` |
|   24631 | 12913 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   24631 | 12914 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   24631 | 12915 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   24631 | 12916 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   24631 | 12917 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   24631 | 12925 | `	pBlock = pGen->pCurrent;` |
|   24631 | 12926 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 12927 | `		pParent = pBlock->pParent;` |
|     ! 0 | 12928 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 12929 | `		pBlock = pParent;` |
|     ! 0 | 12930 | `	}` |
|   24631 | 12931 | `	pGen->xErr = xErr;` |
|   24631 | 12932 | `	pGen->pErrData = pErrData;` |
|   24631 | 12933 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   24631 | 12934 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   24631 | 12935 | `	pGen->pIn = pGen->pEnd = 0;` |
|   24631 | 12936 | `	pGen->nErr = 0;` |
|   24631 | 12937 | `	return SXRET_OK;` |
|       5 | 12938 | `}` |
|       - | 12939 | `/*` |
