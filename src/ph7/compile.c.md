...
|       - |   136 | ` */` |
|    3954 |   137 | `static GenBlock * GenStateFetchBlock(GenBlock *pCurrent,sxi32 iBlockType,sxi32 iCount)` |
|       5 |   138 | `{` |
|    3959 |   139 | `	GenBlock *pBlock = pCurrent;` |
|   11278 |   140 | `	for(;;){` |
|   22561 |   141 | `		if( pBlock->iFlags & iBlockType ){` |
|    3851 |   142 | `			iCount--; /* Decrement nesting level */` |
|    3851 |   143 | `			if( iCount < 1 ){` |
|       - |   144 | `				/* Block meet with the desired criteria */` |
|    3825 |   145 | `				return pBlock;` |
|       - |   146 | `			}` |
|      13 |   147 | `		}` |
|       - |   148 | `		/* Point to the upper block */` |
|   18741 |   149 | `		pBlock = pBlock->pParent;` |
|   18741 |   150 | `		if( pBlock == 0 \|\| (pBlock->iFlags & (GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC)) ){` |
|       - |   151 | `			/* Forbidden */` |
|      72 |   152 | `			break;` |
|       - |   153 | `		}` |
|       5 |   154 | `	}` |
...
|       - |   160 | ` */` |
|  871894 |   161 | `static void GenStateInitBlock(` |
...
|  871899 |   170 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  871899 |   171 | `	pBlock->pUserData   = pUserData;` |
|  871899 |   172 | `	pBlock->pGen        = pGen;` |
|  871899 |   173 | `	pBlock->iFlags      = iType;` |
|  871899 |   174 | `	pBlock->pParent     = 0;` |
|  871899 |   175 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  871899 |   176 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  871899 |   177 | `}` |
|       - |   178 | `/*` |
...
|       - |   183 | ` */` |
|  868220 |   184 | `static sxi32 GenStateEnterBlock(` |
...
|  868225 |   194 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  868225 |   195 | `	if( pBlock == 0 ){` |
...
|  868225 |   204 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  868225 |   205 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   206 | `	/* Link to the parent block */` |
|  868225 |   207 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   208 | `	/* Mark as the current block */` |
|  868225 |   209 | `	pGen->pCurrent = pBlock;` |
|  868225 |   210 | `	if( ppBlock ){` |
|       - |   211 | `		/* Write a pointer to the new instance */` |
|  419925 |   212 | `		*ppBlock = pBlock;` |
|  209960 |   213 | `	}` |
|  868225 |   214 | `	return SXRET_OK;` |
|  434115 |   215 | `}` |
|       - |   216 | `/*` |
|       - |   217 | ` * Release block fields without freeing the whole instance.` |
|       - |   218 | ` */` |
|  868212 |   219 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   220 | `{` |
|  868217 |   221 | `	SySetRelease(&pBlock->aPostContFix);` |
|  868217 |   222 | `	SySetRelease(&pBlock->aJumpFix);` |
|  868217 |   223 | `}` |
|       - |   224 | `/*` |
|       - |   225 | ` * Release a block.` |
|       - |   226 | ` */` |
|  868212 |   227 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   228 | `{` |
|  868217 |   229 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  868217 |   230 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   231 | `	/* Free the instance */` |
|  868217 |   232 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  868217 |   233 | `}` |
|       - |   234 | `/*` |
|       - |   235 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   236 | ` */` |
|  868212 |   237 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   238 | `{` |
|  868217 |   239 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  868217 |   240 | `	if( pBlock == 0 ){` |
|       - |   241 | `		/* No more block to pop */` |
|     ! 0 |   242 | `		return SXERR_EMPTY;` |
|       - |   243 | `	}` |
|       - |   244 | `	/* Point to the upper block */` |
|  868217 |   245 | `	pGen->pCurrent = pBlock->pParent;` |
|  868217 |   246 | `	if( ppBlock ){` |
|       - |   247 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   248 | `		*ppBlock = pBlock;` |
|     ! 0 |   249 | `	}else{` |
|       - |   250 | `		/* Safely release the block */` |
|  868217 |   251 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   252 | `	}` |
|  868217 |   253 | `	return SXRET_OK;` |
|  434111 |   254 | `}` |
|       - |   255 | `/*` |
...
|       - |   264 | ` */` |
|  248912 |   265 | `static sxi32 GenStateNewJumpFixup(GenBlock *pBlock,sxi32 nJumpType,sxu32 nInstrIdx)` |
|       5 |   266 | `{` |
|       - |   267 | `	JumpFixup sJumpFix;` |
|       - |   268 | `	sxi32 rc;` |
|       - |   269 | `	/* Init the JumpFixup structure */` |
|  248917 |   270 | `	sJumpFix.nJumpType = nJumpType;` |
|  248917 |   271 | `	sJumpFix.nInstrIdx = nInstrIdx;` |
|       - |   272 | `	/* Insert in the jump fixup table */` |
|  248917 |   273 | `	rc = SySetPut(&pBlock->aJumpFix,(const void *)&sJumpFix);` |
|  248917 |   274 | `	return rc;` |
|       5 |   275 | `}` |
|       - |   276 | `/*` |
...
|       - |   286 | ` */` |
|  606754 |   287 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   288 | `{` |
|       - |   289 | `	JumpFixup *aFix;` |
|       - |   290 | `	VmInstr *pInstr;` |
|       - |   291 | `	sxu32 nFixed;` |
...
|  606759 |   294 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   295 | `	/* Fix the desired jumps */` |
| 1093161 |   296 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  486407 |   297 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   298 | `			/* Already fixed */` |
|  192271 |   299 | `			continue;` |
|       - |   300 | `		}` |
|  294141 |   301 | `		if( nJumpType > 0 && aFix[n].nJumpType != nJumpType ){` |
|       - |   302 | `			/* Not of our interest */` |
|   45231 |   303 | `			continue;` |
|       - |   304 | `		}` |
|       - |   305 | `		/* Point to the instruction to fix */` |
|  248915 |   306 | `		pInstr = PH7_VmGetInstr(pBlock->pGen->pVm,aFix[n].nInstrIdx);` |
|  248915 |   307 | `		if( pInstr ){` |
|  248915 |   308 | `			pInstr->iP2 = nJumpDest;` |
|  248915 |   309 | `			nFixed++;` |
|       - |   310 | `			/* Mark as fixed */` |
|  248915 |   311 | `			aFix[n].nJumpType = -1;` |
|  124455 |   312 | `		}` |
|  124460 |   313 | `	}` |
|       - |   314 | `	/* Total number of fixed jumps */` |
|  606759 |   315 | `	return nFixed;` |
|       5 |   316 | `}` |
|       - |   317 | `/*` |
...
|       - |   323 | ` */` |
|  248410 |   324 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   325 | `{` |
...
|  248415 |   332 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   333 | `	/* Fix */` |
|  248561 |   334 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   357 | `		}` |
|      51 |   358 | `	}` |
|  248413 |   359 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  248545 |   360 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   365 | `		}` |
|      71 |   366 | `	}` |
|  248413 |   367 | `	return SXRET_OK;` |
|  124210 |   368 | `}` |
|       - |   369 | `/*` |
|       - |   370 | ` * Check if a given token value is installed in the literal table.` |
|       - |   371 | ` */` |
|  790246 |   372 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   373 | `{` |
|       - |   374 | `	SyHashEntry *pEntry;` |
|  790251 |   375 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  790251 |   376 | `	if( pEntry == 0 ){` |
|  355881 |   377 | `		return SXERR_NOTFOUND;` |
|       - |   378 | `	}` |
|  434375 |   379 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  434375 |   380 | `	return SXRET_OK;` |
|  395128 |   381 | `}` |
|       - |   382 | `/*` |
...
|       - |   391 | ` */` |
|  355876 |   392 | `static sxi32 GenStateInstallLiteral(ph7_gen_state *pGen,ph7_value *pObj,sxu32 nIdx)` |
|       5 |   393 | `{` |
|  355881 |   394 | `	if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|  355881 |   395 | `		SyHashInsert(&pGen->hLiteral,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),SX_INT_TO_PTR(nIdx));` |
|  177938 |   396 | `	}` |
|  355881 |   397 | `	return SXRET_OK;` |
|       5 |   398 | `}` |
|       - |   399 | `/*` |
|       - |   400 | ` * Reserve a room for a numeric constant [i.e: 64-bit integer or real number]` |
|       - |   401 | ` * in the constant table.` |
|       - |   402 | ` */` |
|  128846 |   403 | `static ph7_value * GenStateInstallNumLiteral(ph7_gen_state *pGen,sxu32 *pIdx)` |
|       5 |   404 | `{` |
|       - |   405 | `	ph7_value *pObj;` |
|  128851 |   406 | `	sxu32 nIdx = 0; /* cc warning */` |
|       - |   407 | `	/* Reserve a new constant */` |
|  128851 |   408 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  128851 |   409 | `	if( pObj == 0 ){` |
|     ! 0 |   410 | `		PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |   411 | `		return 0;` |
|       - |   412 | `	}` |
|  128851 |   413 | `	*pIdx = nIdx;` |
|       - |   414 | `	/* TODO(chems): Create a numeric table (64bit int keys) same as` |
|       - |   415 | `	 * the constant string iterals table [optimization purposes].` |
|       - |   416 | `	 */` |
|  128851 |   417 | `	return pObj;` |
|   64428 |   418 | `}` |
|       - |   419 | `/*` |
...
|       - |   432 | ` */` |
|  493410 |   433 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   434 | `{` |
|       - |   435 | `	VmCallArgMap *pMap;` |
|  493415 |   436 | `	if( !pGen->bStrictTypes ) return p3;` |
|      33 |   437 | `	if( p3 == 0 ){` |
...
|       - |   503 | ` */` |
|  129604 |   504 | `static int GenStateFindBadNumericSeparator(` |
|       - |   505 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|       5 |   506 | `{` |
|  129609 |   507 | `	const char *z = pRaw->zString;` |
|  129609 |   508 | `	sxu32 n = pRaw->nByte;` |
|  129609 |   509 | `	int base = 10;` |
|       - |   510 | `	sxu32 i, start;` |
|  129609 |   511 | `	if( n < 2 ) return 0;` |
|   10775 |   512 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|      72 |   513 | `		base = 16;` |
|   10740 |   514 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|     280 |   515 | `		base = 2;` |
|     139 |   516 | `	}` |
|   38947 |   517 | `	for( i = 0; i < n; ++i ){` |
|   28191 |   518 | `		if( z[i] != '_' ) continue;` |
...
|       - |   544 | ` */` |
|  129604 |   545 | `static sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|       5 |   546 | `{` |
|  129609 |   547 | `	const char *zBad = 0;` |
|  129609 |   548 | `	sxu32 nBad = 0;` |
|       - |   549 | `	SyString sBad;` |
|       - |   550 | `	sxi32 rc;` |
|  129609 |   551 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  129595 |   552 | `		return SXRET_OK;` |
|       - |   553 | `	}` |
...
|       - |   577 | ` */` |
|  129590 |   578 | `static sxi32 GenStateStripNumericSeparators(` |
...
|       5 |   583 | `{` |
|       - |   584 | `	sxu32 i, j;` |
|  129595 |   585 | `	int hasUnderscore = 0;` |
|       - |   586 | `	char *zBuf;` |
|  129595 |   587 | `	*pzAlloc = 0;` |
|  274535 |   588 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  145197 |   589 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|   72475 |   590 | `	}` |
|  129595 |   591 | `	if( !hasUnderscore ){` |
|  129343 |   592 | `		SyStringDupPtr(pOut, pToken);` |
|  129343 |   593 | `		return SXRET_OK;` |
|       - |   594 | `	}` |
...
|       - |   625 | ` *  documentation.` |
|       - |   626 | ` */` |
|  129576 |   627 | `static sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   628 | `{` |
|  129581 |   629 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  129581 |   630 | `	sxu32 nIdx = 0;` |
|       - |   631 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  129581 |   632 | `	char *zAlloc = 0;` |
|       - |   633 | `	SyString sNum;` |
|       - |   634 | `	sxi32 rc;` |
|   64788 |   635 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  129581 |   636 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  129581 |   637 | `	if( rc != SXRET_OK ){` |
|      14 |   638 | `		return rc;` |
|       - |   639 | `	}` |
|  194354 |   640 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|   64783 |   641 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  129571 |   642 | `	if( rc != SXRET_OK ){` |
|     ! 0 |   643 | `		return SXERR_ABORT;` |
|       - |   644 | `	}` |
|  129571 |   645 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|       - |   646 | `		ph7_value *pObj;` |
|       - |   647 | `		sxi64 iValue;` |
|  128851 |   648 | `		iValue = PH7_TokenValueToInt64(&sNum);` |
|  128851 |   649 | `		pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  128851 |   650 | `		if( pObj == 0 ){` |
|     ! 0 |   651 | `			if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|     ! 0 |   652 | `			return SXERR_ABORT;` |
|       - |   653 | `		}` |
|  128851 |   654 | `		PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|   64428 |   655 | `	}else{` |
|       - |   656 | `		/* Real number */` |
|       - |   657 | `		ph7_value *pObj;` |
...
|       - |   667 | `	}` |
|  129571 |   668 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|       - |   669 | `	/* Emit the load constant instruction */` |
|  129571 |   670 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|       - |   671 | `	/* Node successfully compiled */` |
|  129571 |   672 | `	return SXRET_OK;` |
|   64793 |   673 | `}` |
|       - |   674 | `/*` |
...
|       - |   683 | ` *` |
|       - |   684 | ` */` |
|  103334 |   685 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   686 | `{` |
|  103339 |   687 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   688 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   689 | `	ph7_value *pObj;` |
|       - |   690 | `	sxu32 nIdx;` |
|  103339 |   691 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   692 | `	/* Delimit the string */` |
|  103339 |   693 | `	zIn  = pStr->zString;` |
|  103339 |   694 | `	zEnd = &zIn[pStr->nByte];` |
|  103339 |   695 | `	if( zIn >= zEnd ){` |
|       - |   696 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|       - |   697 | `		 * rather than reserving a new object each time. */` |
|    7519 |   698 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|    7519 |   699 | `		return SXRET_OK;` |
|       - |   700 | `	}` |
|   95825 |   701 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   702 | `		/* Already processed,emit the load constant instruction` |
|       - |   703 | `		 * and return.` |
|       - |   704 | `		 */` |
|   36939 |   705 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   36939 |   706 | `		return SXRET_OK;` |
|       - |   707 | `	}` |
|       - |   708 | `	/* Reserve a new constant */` |
|   58891 |   709 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   58891 |   710 | `	if( pObj == 0 ){` |
...
|       - |   714 | `	}` |
|   58891 |   715 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|       - |   716 | `	/* Compile the node */` |
|   58945 |   717 | `	for(;;){` |
|  117895 |   718 | `		if( zIn >= zEnd ){` |
|       - |   719 | `			/* End of input */` |
|   58891 |   720 | `			break;` |
|       - |   721 | `		}` |
|   59009 |   722 | `		zCur = zIn;` |
| 1008169 |   723 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
|  949165 |   724 | `			zIn++;` |
|       5 |   725 | `		}` |
|   59009 |   726 | `		if( zIn > zCur ){` |
|       - |   727 | `			/* Append raw contents*/` |
|   58985 |   728 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|   29490 |   729 | `		}` |
|   59009 |   730 | `		zIn++;` |
|   59009 |   731 | `		if( zIn < zEnd ){` |
|     141 |   732 | `			if( zIn[0] == '\\' ){` |
...
|   58891 |   749 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   58891 |   750 | `	if( pStr->nByte < 1024 ){` |
|       - |   751 | `		/* Install in the literal table */` |
|   58891 |   752 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|   29443 |   753 | `	}` |
|       - |   754 | `	/* Node successfully compiled */` |
|   58891 |   755 | `	return SXRET_OK;` |
|   51672 |   756 | `}` |
|       - |   757 | `/*` |
...
|       - |   955 | ` */` |
|   26052 |   956 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   957 | `{` |
|       - |   958 | `	ph7_value *pConstObj;` |
|   26057 |   959 | `	sxu32 nIdx = 0;` |
|       - |   960 | `	/* Reserve a new constant */` |
|   26057 |   961 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   26057 |   962 | `	if( pConstObj == 0 ){` |
|     ! 0 |   963 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   964 | `		return 0;` |
|       - |   965 | `	}` |
|   26057 |   966 | `	(*pCount)++;` |
|   26057 |   967 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   968 | `	/* Emit the load constant instruction */` |
|   26057 |   969 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   26057 |   970 | `	return pConstObj;` |
|   13031 |   971 | `}` |
|       - |   972 | `/*` |
...
|       - |  1009 | ` */` |
|   24560 |  1010 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen)` |
|       5 |  1011 | `{` |
|   24565 |  1012 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1013 | `	const char *zIn,*zCur,*zEnd;` |
|   24565 |  1014 | `	ph7_value *pObj = 0;` |
|       - |  1015 | `	sxi32 iCons;` |
|       - |  1016 | `	sxi32 rc;` |
|       - |  1017 | `	/* Delimit the string */` |
|   24565 |  1018 | `	zIn  = pStr->zString;` |
|   24565 |  1019 | `	zEnd = &zIn[pStr->nByte];` |
|   24565 |  1020 | `	if( zIn >= zEnd ){` |
...
|       - |  1024 | `		 */` |
|     321 |  1025 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     321 |  1026 | `		return SXRET_OK;` |
|       - |  1027 | `	}` |
|   24249 |  1028 | `	zCur = 0;` |
...
|   13264 |  1031 | `	for(;;){` |
|   39669 |  1032 | `		zCur = zIn;` |
|  184425 |  1033 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  147045 |  1034 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      67 |  1035 | `				break;` |
|  146921 |  1036 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    2164 |  1037 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|    1083 |  1038 | `					break;` |
|       - |  1039 | `			}` |
|  144761 |  1040 | `			zIn++;` |
|       5 |  1041 | `		}` |
|   39669 |  1042 | `		if( zIn > zCur ){` |
|   18459 |  1043 | `			if( pObj == 0 ){` |
|   17939 |  1044 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   17939 |  1045 | `				if( pObj == 0 ){` |
|     ! 0 |  1046 | `					return SXERR_ABORT;` |
|       - |  1047 | `				}` |
|    8967 |  1048 | `			}` |
|   18459 |  1049 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    9227 |  1050 | `		}` |
|   39669 |  1051 | `		if( zIn >= zEnd ){` |
|   24249 |  1052 | `			break;` |
|       - |  1053 | `		}` |
|   15425 |  1054 | `		if( zIn[0] == '\\' ){` |
|   13141 |  1055 | `			const char *zPtr = 0;` |
|       - |  1056 | `			sxu32 n;` |
|   13141 |  1057 | `			zIn++;` |
|   13141 |  1058 | `			if( zIn >= zEnd ){` |
|     ! 0 |  1059 | `				break;` |
|       - |  1060 | `			}` |
|   13141 |  1061 | `			if( pObj == 0 ){` |
|    8123 |  1062 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    8123 |  1063 | `				if( pObj == 0 ){` |
|     ! 0 |  1064 | `					return SXERR_ABORT;` |
|       - |  1065 | `				}` |
|    4059 |  1066 | `			}` |
|   13141 |  1067 | `			n = sizeof(char); /* size of conversion */` |
|   13141 |  1068 | `			switch( zIn[0] ){` |
|       8 |  1069 | `			case '$':` |
|       - |  1070 | `				/* Dollar sign */` |
|      18 |  1071 | `				PH7_MemObjStringAppend(pObj,"$",sizeof(char));` |
|      18 |  1072 | `				break;` |
|      57 |  1073 | `			case '\\':` |
|       - |  1074 | `				/* A literal backslash */` |
|     119 |  1075 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|     119 |  1076 | `				break;` |
|       2 |  1077 | `			case 'a':` |
...
|   12061 |  1091 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|   12061 |  1092 | `				break;` |
|      19 |  1093 | `			case 'r':` |
...
|     110 |  1109 | `			case '"':` |
|       - |  1110 | `				/* Double quote */` |
|     225 |  1111 | `				PH7_MemObjStringAppend(pObj,"\"",sizeof(char));` |
|     225 |  1112 | `				break;` |
|      10 |  1113 | `			case '0':` |
|       - |  1114 | `				/* NUL byte */` |
...
|      21 |  1116 | `				break;` |
|     274 |  1117 | `			case 'x':` |
|     549 |  1118 | `				if((unsigned char)zIn[1] < 0xc0 && SyisHex(zIn[1]) ){` |
|       - |  1119 | `					int c;` |
|       - |  1120 | `					/* Hex digit */` |
|     535 |  1121 | `					c = SyHexToint(zIn[1]) << 4;` |
|     535 |  1122 | `					if( &zIn[2] < zEnd ){` |
|     535 |  1123 | `						c +=  SyHexToint(zIn[2]);` |
|     267 |  1124 | `					}` |
|       - |  1125 | `					/* Output char */` |
|     535 |  1126 | `					PH7_MemObjStringAppend(pObj,(const char *)&c,sizeof(char));` |
|     535 |  1127 | `					n += sizeof(char) * 2;` |
|     268 |  1128 | `				}else{` |
...
|   24249 |  1284 | `	return SXRET_OK;` |
|   12285 |  1285 | `}` |
|       - |  1286 | `/*` |
|       - |  1287 | ` * Compile a double quoted string.` |
|       - |  1288 | ` *  See the block-comment above for more information.` |
|       - |  1289 | ` */` |
|   24500 |  1290 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1291 | `{` |
|       - |  1292 | `	sxi32 rc;` |
|   24505 |  1293 | `	rc = GenStateCompileString(&(*pGen));` |
|   12250 |  1294 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1295 | `	/* Compilation result */` |
|   24505 |  1296 | `	return rc;` |
|       5 |  1297 | `}` |
|       - |  1298 | `/*` |
...
|       - |  1339 | ` */` |
|   22654 |  1340 | `static sxi32 GenStateCompileArrayEntry(` |
...
|   22659 |  1351 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|       - |  1352 | `	/* Compile the expression*/` |
|   22659 |  1353 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|       - |  1354 | `	/* Restore token stream */` |
|   22659 |  1355 | `	RE_SWAP_DELIMITER(pGen);` |
|   22659 |  1356 | `	return rc;` |
|       5 |  1357 | `}` |
|       - |  1358 | `/*` |
...
|       - |  1396 | ` */` |
|   25084 |  1397 | `static SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|       5 |  1398 | `{` |
|   25089 |  1399 | `	SyToken *pCur = pStart;` |
|   25089 |  1400 | `	sxi32 iNest = 0;` |
|   71199 |  1401 | `	while( pCur < pEnd ){` |
|   51765 |  1402 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|    5651 |  1403 | `			return pCur;` |
|       - |  1404 | `		}` |
...
|       - |  1408 | `		 */` |
|   46119 |  1409 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|       - |  1468 | `			}` |
|      43 |  1469 | `		}` |
|   46113 |  1470 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|     402 |  1471 | `			iNest++;` |
|   45914 |  1472 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|       - |  1485 | ` */` |
|   32358 |  1486 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|       5 |  1487 | `{` |
|       - |  1488 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|       - |  1489 | `	SyToken *pKey,*pCur;` |
|   32363 |  1490 | `	sxi32 iEmitRef = 0;` |
|   32363 |  1491 | `	sxi32 iSpread = 0;` |
|   32363 |  1492 | `	sxi32 nPair = 0;` |
|       - |  1493 | `	sxi32 rc;` |
|   32363 |  1494 | `	xValidator = 0;` |
|   26555 |  1495 | `	for(;;){` |
|       - |  1496 | `		/* Jump leading commas */` |
|   60335 |  1497 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|    7225 |  1498 | `			pGen->pIn++;` |
|       5 |  1499 | `		}` |
|   53115 |  1500 | `		pCur = pGen->pIn;` |
|   53115 |  1501 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|       - |  1502 | `			/* No more entry to process */` |
|   32347 |  1503 | `			break;` |
|       - |  1504 | `		}` |
|   20773 |  1505 | `		if( pCur >= pGen->pIn ){` |
|     ! 0 |  1506 | `			continue;` |
|       - |  1507 | `		}` |
|       - |  1508 | `		/* Compile the key if available */` |
|   20773 |  1509 | `		pKey = pCur;` |
|   20773 |  1510 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|   20773 |  1511 | `		rc = SXERR_EMPTY;` |
|   20773 |  1512 | `		if( pCur < pGen->pIn ){` |
|    1697 |  1513 | `			if( &pCur[1] >= pGen->pIn ){` |
|       - |  1514 | `				/* Missing value */` |
...
|    1687 |  1522 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|       - |  1523 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|    1687 |  1524 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  1525 | `				return SXERR_ABORT;` |
|       - |  1526 | `			}` |
|    1687 |  1527 | `			pCur++; /* Jump the '=>' operator */` |
|   19922 |  1528 | `		}else if( pKey == pCur ){` |
...
|   19081 |  1534 | `			pCur = pKey;` |
|       - |  1535 | `		}` |
|   20763 |  1536 | `		if( rc == SXERR_EMPTY ){` |
|       - |  1537 | `			/* No available key,load NULL */` |
|   19083 |  1538 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0 /* nil index */,0,0);` |
|    9539 |  1539 | `		}` |
|   20763 |  1540 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|   20761 |  1559 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|   20761 |  1560 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|   20757 |  1573 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,xValidator);` |
|   20757 |  1574 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  1575 | `			return SXERR_ABORT;` |
|       - |  1576 | `		}` |
|   20757 |  1577 | `		if( iSpread ){` |
...
|   20726 |  1580 | `		}else if( iEmitRef ){` |
|       - |  1581 | `			/* Emit the load reference instruction */` |
|      40 |  1582 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|      18 |  1583 | `		}` |
|   20757 |  1584 | `		xValidator = 0;` |
|   20757 |  1585 | `		iEmitRef = 0;` |
|   20757 |  1586 | `		iSpread = 0;` |
|   20757 |  1587 | `		nPair++;` |
|       5 |  1588 | `	}` |
|       - |  1589 | `	/* Emit the load map instruction */` |
|   32347 |  1590 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|       - |  1591 | `	/* Node successfully compiled */` |
|   32347 |  1592 | `	return SXRET_OK;` |
|   16184 |  1593 | `}` |
|       - |  1594 | `/*` |
...
|       - |  1602 | ` */` |
|   31200 |  1603 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1604 | `{` |
|       - |  1605 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   31205 |  1606 | `	pGen->pIn += 2;` |
|   31205 |  1607 | `	pGen->pEnd--;` |
|   15600 |  1608 | `	SXUNUSED(iCompileFlag);` |
|   31205 |  1609 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1610 | `}` |
|       - |  1611 | `/*` |
...
|       - |  1615 | ` */` |
|    1158 |  1616 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1617 | `{` |
|       - |  1618 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|    1163 |  1619 | `	pGen->pIn++;` |
|    1163 |  1620 | `	pGen->pEnd--;` |
|     579 |  1621 | `	SXUNUSED(iCompileFlag);` |
|    1163 |  1622 | `	return GenStateCompileArrayBody(pGen);` |
|       5 |  1623 | `}` |
|       - |  1624 | `/*` |
...
|       - |  2866 | ` */` |
| 1175384 |  2867 | `PH7_PRIVATE sxi32 PH7_CompileVariable(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  2868 | `{` |
| 1175389 |  2869 | `	sxu32 nLineLocal = pGen->pIn->nLine;` |
|       - |  2870 | `	sxi32 iVv;` |
|       - |  2871 | `	sxi32 iP1;` |
|       - |  2872 | `	void *p3;` |
|       - |  2873 | `	sxi32 rc;` |
| 1175389 |  2874 | `	iVv = -1; /* Variable variable counter */` |
| 2350785 |  2875 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) ){` |
| 1175401 |  2876 | `		pGen->pIn++;` |
| 1175401 |  2877 | `		iVv++;` |
|       5 |  2878 | `	}` |
| 1175389 |  2879 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD\|PH7_TK_OCB/*'{'*/)) == 0 ){` |
...
|       - |  2887 | `	}` |
| 1175389 |  2888 | `	p3  = 0;` |
| 1175389 |  2889 | `	if( pGen->pIn->nType & PH7_TK_OCB/*'{'*/ ){` |
...
|       - |  2908 | `		SyString *pName;` |
| 1175373 |  2909 | `		char *zName = 0;` |
|       - |  2910 | `		/* Extract variable name */` |
| 1175373 |  2911 | `		pName = &pGen->pIn->sData;` |
|       - |  2912 | `		/* Advance the stream cursor */` |
| 1175373 |  2913 | `		pGen->pIn++;` |
| 1175373 |  2914 | `		pEntry = SyHashGet(&pGen->hVar,(const void *)pName->zString,pName->nByte);` |
| 1175373 |  2915 | `		if( pEntry == 0 ){` |
|       - |  2916 | `			/* Duplicate name */` |
|  169203 |  2917 | `			zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|  169203 |  2918 | `			if( zName == 0 ){` |
...
|  169203 |  2923 | `			SyHashInsert(&pGen->hVar,zName,pName->nByte,zName);` |
|   84604 |  2924 | `		}else{` |
|       - |  2925 | `			/* Name already available */` |
| 1006175 |  2926 | `			zName = (char *)pEntry->pUserData;` |
|       - |  2927 | `		}` |
| 1175373 |  2928 | `		p3 = (void *)zName;` |
|       - |  2929 | `	}` |
| 1175385 |  2930 | `	iP1 = 0;` |
| 1175385 |  2931 | `	if( iCompileFlag & EXPR_FLAG_RDONLY_LOAD ){` |
|  458521 |  2932 | `		if( (iCompileFlag & EXPR_FLAG_LOAD_IDX_STORE) == 0 ){` |
|       - |  2933 | `			/* Read-only load.In other words do not create the variable if inexistant */` |
|  458503 |  2934 | `			iP1 = 1;` |
|  229249 |  2935 | `		}` |
|  229258 |  2936 | `	}` |
|       - |  2937 | `	/* Emit the load instruction */` |
| 1175385 |  2938 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,p3,0);` |
| 1175397 |  2939 | `	while( iVv > 0 ){` |
|      13 |  2940 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD,iP1,0,0,0);` |
|      13 |  2941 | `		iVv--;` |
|       1 |  2942 | `	}` |
|       - |  2943 | `	/* Node successfully compiled */` |
| 1175385 |  2944 | `	return SXRET_OK;` |
|  587697 |  2945 | `}` |
|       - |  2946 | `/*` |
|       - |  2947 | ` * Load a literal.` |
|       - |  2948 | ` */` |
|  811062 |  2949 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  2950 | `{` |
|  811067 |  2951 | `	SyToken *pToken = pGen->pIn;` |
|       - |  2952 | `	ph7_value *pObj;` |
|       - |  2953 | `	SyString *pStr;` |
|       - |  2954 | `	sxu32 nIdx;` |
|       - |  2955 | `	/* Extract token value */` |
|  811067 |  2956 | `	pStr = &pToken->sData;` |
|       - |  2957 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  811067 |  2958 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
|  171849 |  2959 | `		if( SyStrnicmp(pStr->zString,"null",sizeof("NULL")-1) == 0 ){` |
|       - |  2960 | `			/* NULL constant are always indexed at 0 */` |
|   63211 |  2961 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,0,0,0);` |
|   63211 |  2962 | `			return SXRET_OK;` |
|  108643 |  2963 | `		}else if( SyStrnicmp(pStr->zString,"true",sizeof("TRUE")-1) == 0 ){` |
|       - |  2964 | `			/* TRUE constant are always indexed at 1 */` |
|     833 |  2965 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,1,0,0);` |
|     833 |  2966 | `			return SXRET_OK;` |
|       5 |  2967 | `		}` |
|  748036 |  2968 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
|  109816 |  2969 | `		SyStrnicmp(pStr->zString,"false",sizeof("FALSE")-1) == 0 ){` |
|       - |  2970 | `			/* FALSE constant are always indexed at 2 */` |
|   48461 |  2971 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,2,0,0);` |
|   48461 |  2972 | `			return SXRET_OK;` |
|  648310 |  2973 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  115086 |  2974 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
|       - |  2975 | `			/* TICKET 1433-004: __LINE__ constant must be resolved at compile time,not run time */` |
|   11033 |  2976 | `			pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   11033 |  2977 | `			if( pObj == 0 ){` |
|     ! 0 |  2978 | `				PH7_GenCompileError(pGen,E_ERROR,pToken->nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  2979 | `				return SXERR_ABORT;` |
|       - |  2980 | `			}` |
|   11033 |  2981 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,pToken->nLine);` |
|       - |  2982 | `			/* Emit the load constant instruction */` |
|   11033 |  2983 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   11033 |  2984 | `			return SXRET_OK;` |
|  598328 |  2985 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
|   37178 |  2986 | `		SyMemcmp(pStr->zString,"__NAMESPACE__",sizeof("__NAMESPACE__")-1) == 0 ){` |
...
|  587520 |  3002 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   25633 |  3003 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  589765 |  3004 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
|   20088 |  3005 | `		SyMemcmp(pStr->zString,"__METHOD__",sizeof("__METHOD__")-1) == 0) ){` |
...
|  687533 |  3035 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
|       - |  3036 | `		ph7_value *pLitObj;` |
|       - |  3037 | `		/* Unknown literal,install it in the literal table */` |
|  292841 |  3038 | `		pLitObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  292841 |  3039 | `		if( pLitObj == 0 ){` |
|     ! 0 |  3040 | `			PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  3041 | `			return SXERR_ABORT;` |
|       - |  3042 | `		}` |
|  292841 |  3043 | `		PH7_MemObjInitFromString(pGen->pVm,pLitObj,&pToken->sData);` |
|  292841 |  3044 | `		GenStateInstallLiteral(&(*pGen),pLitObj,nIdx);` |
|  146418 |  3045 | `	}` |
|       - |  3046 | `	/* Emit the load constant instruction */` |
|  687533 |  3047 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  687533 |  3048 | `	return SXRET_OK;` |
|  405536 |  3049 | `}` |
|       - |  3050 | `/*` |
...
|       - |  3055 | ` */` |
|  814784 |  3056 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  3057 | `{` |
|       - |  3058 | `	sxi32 rc;` |
|  814789 |  3059 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  3060 | `		return SXRET_OK;` |
|       - |  3061 | `	}` |
|       - |  3062 | `	/* Check if this is a multi-token namespace path */` |
|  814789 |  3063 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
|       - |  3064 | `		/* Multiple tokens: assemble the full path into sWorker */` |
|    3727 |  3065 | `		SyBlob *pWorker = &pGen->sWorker;` |
|    3727 |  3066 | `		int isAbsolute = 0;` |
|    3727 |  3067 | `		SyBlobReset(pWorker);` |
|       - |  3068 | `		/* Check for leading backslash (absolute path) */` |
|    3727 |  3069 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|    3725 |  3070 | `			isAbsolute = 1;` |
|    3725 |  3071 | `			pGen->pIn++; /* Skip leading backslash */` |
|    1860 |  3072 | `		}` |
|       - |  3073 | `		/* For relative qualified names in a namespace, prepend the NS */` |
|    3727 |  3074 | `		if( !isAbsolute && SyBlobLength(&pGen->sNamespace) > 0 ){` |
...
|    3835 |  3079 | `		while( pGen->pIn <= &pGen->pEnd[-1] ){` |
|    3835 |  3080 | `			if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
|      59 |  3081 | `				SyBlobAppend(pWorker,"\\",1);` |
|      32 |  3082 | `			}else{` |
|    3781 |  3083 | `				SyBlobAppend(pWorker,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       - |  3084 | `			}` |
|    3835 |  3085 | `			if( pGen->pIn == &pGen->pEnd[-1] ){` |
|    3727 |  3086 | `				pGen->pIn++;` |
|    3727 |  3087 | `				break;` |
|       - |  3088 | `			}` |
|     113 |  3089 | `			pGen->pIn++;` |
|       5 |  3090 | `		}` |
|    3727 |  3091 | `		if( SyBlobLength(pWorker) > 0 ){` |
|       - |  3092 | `			ph7_value *pObj;` |
|       - |  3093 | `			SyString sPath;` |
|       - |  3094 | `			sxu32 nIdx;` |
|    3727 |  3095 | `			SyStringInitFromBuf(&sPath,(const char *)SyBlobData(pWorker),SyBlobLength(pWorker));` |
|       - |  3096 | `			/* Install in the literal table */` |
|    3727 |  3097 | `			if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sPath,&nIdx) ){` |
|    3699 |  3098 | `				pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|    3699 |  3099 | `				if( pObj == 0 ){` |
|     ! 0 |  3100 | `					PH7_GenCompileError(&(*pGen),E_ERROR,1,"PH7 engine is running out of memory");` |
|     ! 0 |  3101 | `					return SXERR_ABORT;` |
|       - |  3102 | `				}` |
|    3699 |  3103 | `				PH7_MemObjInitFromString(pGen->pVm,pObj,&sPath);` |
|    3699 |  3104 | `				GenStateInstallLiteral(&(*pGen),pObj,nIdx);` |
|    1847 |  3105 | `			}` |
...
|    5588 |  3109 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,` |
|    1861 |  3110 | `				isAbsolute ? (PH7_LOADC_EXPAND\|PH7_LOADC_ABSOLUTE) : PH7_LOADC_EXPAND,` |
|    1861 |  3111 | `				nIdx,0,0);` |
|    3727 |  3112 | `			return SXRET_OK;` |
|       - |  3113 | `		}` |
|     ! 0 |  3114 | `	}` |
|       - |  3115 | `	/* Single-token literal: load directly */` |
|  811067 |  3116 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  811067 |  3117 | `	return rc;` |
|  407397 |  3118 | `}` |
|       - |  3119 | `/*` |
...
|     ! 0 |  3134 | `}` |
|  814784 |  3135 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  3136 | `{` |
|       - |  3137 | `	sxi32 rc;` |
|  814789 |  3138 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  814789 |  3139 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3140 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3141 | `		return rc;` |
|       - |  3142 | `	}` |
|       - |  3143 | `	/* Node successfully compiled */` |
|  814789 |  3144 | `	return SXRET_OK;` |
|  407397 |  3145 | `}` |
|       - |  3146 | `/*` |
...
|       - |  3304 | ` */` |
|    3816 |  3305 | `static int GenStateEmitExceptionPopForBreak(ph7_gen_state *pGen,GenBlock *pTarget)` |
|       5 |  3306 | `{` |
|    3821 |  3307 | `	GenBlock *pBlock = pGen->pCurrent;` |
|    3821 |  3308 | `	int nInlineTry = 0;` |
|   22407 |  3309 | `	while( pBlock && pBlock != pTarget ){` |
|   18591 |  3310 | `		if( pBlock->iFlags & GEN_BLOCK_EXCEPTION ){` |
...
|       - |  3325 | `			}` |
|       2 |  3326 | `		}` |
|   18591 |  3327 | `		pBlock = pBlock->pParent;` |
|       5 |  3328 | `	}` |
|    3821 |  3329 | `	return nInlineTry;` |
|       5 |  3330 | `}` |
|    3718 |  3331 | `static sxi32 PH7_CompileContinue(ph7_gen_state *pGen)` |
|       5 |  3332 | `{` |
|       - |  3333 | `	GenBlock *pLoop; /* Target loop */` |
|       - |  3334 | `	sxi32 iLevel;    /* How many nesting loop to skip */` |
|       - |  3335 | `	sxu32 nLineLocal;` |
|       - |  3336 | `	sxi32 rc;` |
|    3723 |  3337 | `	nLineLocal = pGen->pIn->nLine;` |
|    3723 |  3338 | `	iLevel = 0;` |
|       - |  3339 | `	/* Jump the 'continue' keyword */` |
|    3723 |  3340 | `	pGen->pIn++;` |
|    3723 |  3341 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NUM) ){` |
...
|    3723 |  3367 | `	pLoop = GenStateFetchBlock(pGen->pCurrent,GEN_BLOCK_LOOP,iLevel);` |
|    3723 |  3368 | `	if( pLoop == 0 ){` |
|       - |  3369 | `		/* Illegal continue */` |
|      13 |  3370 | `		rc = PH7_GenCompileError(pGen,E_ERROR,nLineLocal,"A 'continue' statement may only be used within a loop or switch");` |
|      13 |  3371 | `		if( rc == SXERR_ABORT ){` |
|       - |  3372 | `			/* Error count limit reached,abort immediately */` |
|     ! 0 |  3373 | `			return SXERR_ABORT;` |
|       - |  3374 | `		}` |
|       8 |  3375 | `	}else{` |
|    3713 |  3376 | `		sxu32 nInstrIdx = 0;` |
|       - |  3377 | `		/* Emit POP_EXCEPTION (legacy) for crossed try blocks, or count them (generator). */` |
|    3713 |  3378 | `		int nCross = GenStateEmitExceptionPopForBreak(&(*pGen),pLoop);` |
...
|    3713 |  3381 | `		sxi32 iJmpOp = nCross > 0 ? PH7_OP_SET_FINALLY_JMP : PH7_OP_JMP;` |
|    3713 |  3382 | `		if( pLoop->iFlags & GEN_BLOCK_SWITCH ){` |
...
|    3709 |  3394 | `			PH7_VmEmitInstr(pGen->pVm,iJmpOp,nCross,pLoop->nFirstInstr,0,&nInstrIdx);` |
|    3709 |  3395 | `			if( pLoop->bPostContinue == TRUE ){` |
...
|       - |  3402 | `		}` |
|       - |  3403 | `	}` |
|    3723 |  3404 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
...
|     129 |  3454 | `	if( pLoop == 0 ){` |
|       - |  3455 | `		/* Illegal break */` |
|      19 |  3456 | `		rc = PH7_GenCompileError(pGen,E_ERROR,pGen->pIn->nLine,"A 'break' statement may only be used within a loop or switch");` |
|      19 |  3457 | `		if( rc == SXERR_ABORT ){` |
...
|       5 |  3522 | `		}` |
|     113 |  3523 | `		if( pBlock ){` |
|      24 |  3524 | `			sLabel.pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|      14 |  3525 | `		}else{` |
...
|       6 |  3563 | `		rc = PH7_GenCompileError(pGen,E_ERROR,pGen->pIn->nLine,"goto: Invalid label name: '%z'",&pGen->pIn->sData);` |
|       6 |  3564 | `		if( rc == SXERR_ABORT ){` |
...
|       8 |  3591 | `			rc = PH7_GenCompileError(pGen,E_ERROR,pGen->pIn->nLine,"goto inside try/catch block is disallowed");` |
|       8 |  3592 | `			if( rc == SXERR_ABORT ){` |
|       - |  3593 | `				/* Error count limit reached,abort immediately */` |
|     ! 0 |  3594 | `				return SXERR_ABORT;` |
|       - |  3595 | `			}` |
|       3 |  3596 | `		}` |
|     153 |  3597 | `		if( pBlock && (pBlock->iFlags & GEN_BLOCK_FUNC)){` |
|      31 |  3598 | `			sJump.pFunc = (ph7_vm_func *)pBlock->pUserData;` |
|      18 |  3599 | `		}else{` |
...
|       - |  3686 | ` * message.` |
|       - |  3687 | ` */` |
|  449960 |  3688 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3693 | `	sxi32 rc;` |
|       - |  3694 | `	sxu32 nLine;` |
|  449965 |  3695 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|  448305 |  3696 | `		nLine = pGen->pIn->nLine;` |
|  448305 |  3697 | `		rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_STD,PH7_VmInstrLength(pGen->pVm),0,0);` |
|  448305 |  3698 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  3699 | `			return SXERR_ABORT;` |
|       - |  3700 | `		}` |
|  448305 |  3701 | `		pGen->pIn++;` |
|       - |  3702 | `		/* Compile until we hit the closing braces '}' */` |
|  612594 |  3703 | `		for(;;){` |
| 1225193 |  3704 | `			if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  3713 | `				}` |
|     ! 0 |  3714 | `			}` |
| 1225173 |  3715 | `			if( pGen->pIn->nType & PH7_TK_CCB/*'}'*/ ){` |
|       - |  3716 | `				/* Closing braces found,break immediately*/` |
|  448285 |  3717 | `				pGen->pIn++;` |
|  448285 |  3718 | `				break;` |
|       - |  3719 | `			}` |
|       - |  3720 | `			/* Compile a single statement */` |
|  776893 |  3721 | `			rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|  776893 |  3722 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  3723 | `				return SXERR_ABORT;` |
|       - |  3724 | `			}` |
|       5 |  3725 | `		}` |
|  448305 |  3726 | `		GenStateLeaveBlock(&(*pGen),0);` |
|  225815 |  3727 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3728 | `		pGen->pIn++;` |
...
|    1665 |  3771 | `		rc = GenStateCompileChunk(&(*pGen),PH7_COMPILE_SINGLE_STMT);` |
|    1665 |  3772 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  3773 | `			return SXERR_ABORT;` |
|       - |  3774 | `		}` |
|       - |  3775 | `	}` |
|       - |  3776 | `	/* Jump trailing semi-colons ';' */` |
|  449965 |  3777 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3778 | `		pGen->pIn++;` |
|     ! 0 |  3779 | `	}` |
|  449965 |  3780 | `	return SXRET_OK;` |
|  224985 |  3781 | `}` |
|       - |  3782 | `/*` |
...
|       - |  3799 | ` *   endwhile;` |
|       - |  3800 | ` */` |
|   14820 |  3801 | `static sxi32 PH7_CompileWhile(ph7_gen_state *pGen)` |
|       5 |  3802 | `{` |
|   14825 |  3803 | `	GenBlock *pWhileBlock = 0;` |
|   14825 |  3804 | `	SyToken *pTmp,*pEnd = 0;` |
|       - |  3805 | `	sxu32 nFalseJump;` |
|       - |  3806 | `	sxu32 nLine;` |
|       - |  3807 | `	sxi32 rc;` |
|   14825 |  3808 | `	nLine = pGen->pIn->nLine;` |
|       - |  3809 | `	/* Jump the 'while' keyword */` |
|   14825 |  3810 | `	pGen->pIn++;` |
|   14825 |  3811 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  3812 | `		/* Syntax error */` |
...
|   14825 |  3823 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pWhileBlock);` |
|   14825 |  3824 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3825 | `		return SXERR_ABORT;` |
|       - |  3826 | `	}` |
|       - |  3827 | `	/* Delimit the condition */` |
|   14825 |  3828 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   14825 |  3829 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   14825 |  3838 | `	pTmp = pGen->pEnd;` |
|   14825 |  3839 | `	pGen->pEnd = pEnd;` |
|       - |  3840 | `	/* Compile the expression */` |
|   14825 |  3841 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14825 |  3842 | `	if( rc == SXERR_ABORT ){` |
|       - |  3843 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  3844 | `		return SXERR_ABORT;` |
|       - |  3845 | `	}` |
|       - |  3846 | `	/* Update token stream */` |
|   14825 |  3847 | `	while(pGen->pIn < pEnd ){` |
...
|   14825 |  3855 | `	pGen->pIn  = &pEnd[1];` |
|   14825 |  3856 | `	pGen->pEnd = pTmp;` |
|       - |  3857 | `	/* Emit the false jump */` |
|   14825 |  3858 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  3859 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   14825 |  3860 | `	GenStateNewJumpFixup(pWhileBlock,PH7_OP_JZ,nFalseJump);` |
|       - |  3861 | `	/* Compile the loop body */` |
|   14825 |  3862 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDWHILE);` |
|   14825 |  3863 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  3864 | `		return SXERR_ABORT;` |
|       - |  3865 | `	}` |
|       - |  3866 | `	/* Emit the unconditional jump to the start of the loop */` |
|   14825 |  3867 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pWhileBlock->nFirstInstr,0,0);` |
|       - |  3868 | `	/* Fix all jumps now the destination is resolved */` |
|   14825 |  3869 | `	GenStateFixJumps(pWhileBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  3870 | `	/* Release the loop block */` |
|   14825 |  3871 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  3872 | `	/* Statement successfully compiled */` |
|   14825 |  3873 | `	return SXRET_OK;` |
|     ! 0 |  3874 | `Synchronize:` |
...
|       - |  4029 | ` */` |
|   14820 |  4030 | `static sxi32 PH7_CompileFor(ph7_gen_state *pGen)` |
|       5 |  4031 | `{` |
|   14825 |  4032 | `	SyToken *pTmp,*pPostStart,*pEnd = 0;` |
|   14825 |  4033 | `	GenBlock *pForBlock = 0;` |
|       - |  4034 | `	sxu32 nFalseJump;` |
|       - |  4035 | `	sxu32 nLine;` |
|       - |  4036 | `	sxi32 rc;` |
|   14825 |  4037 | `	nLine = pGen->pIn->nLine;` |
|       - |  4038 | `	/* Jump the 'for' keyword */` |
|   14825 |  4039 | `	pGen->pIn++;` |
|   14825 |  4040 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4041 | `		/* Syntax error */` |
...
|   14825 |  4052 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   14825 |  4053 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|   14825 |  4068 | `	pTmp = pGen->pEnd;` |
|   14825 |  4069 | `	pGen->pEnd = pEnd;` |
|       - |  4070 | `	/* Compile initialization expressions if available */` |
|   14825 |  4071 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4072 | `	/* Pop operand lvalues */` |
|   14825 |  4073 | `	if( rc == SXERR_ABORT ){` |
|       - |  4074 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4075 | `		return SXERR_ABORT;` |
|   14825 |  4076 | `	}else if( rc != SXERR_EMPTY ){` |
|   14823 |  4077 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7409 |  4078 | `	}` |
|   14825 |  4079 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4080 | `		/* Syntax error */` |
...
|   14825 |  4092 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForBlock);` |
|   14825 |  4093 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4094 | `		return SXERR_ABORT;` |
|       - |  4095 | `	}` |
|       - |  4096 | `	/* Deffer continue jumps */` |
|   14825 |  4097 | `	pForBlock->bPostContinue = TRUE;` |
|       - |  4098 | `	/* Compile the condition */` |
|   14825 |  4099 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14825 |  4100 | `	if( rc == SXERR_ABORT ){` |
|       - |  4101 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4102 | `		return SXERR_ABORT;` |
|   14825 |  4103 | `	}else if( rc != SXERR_EMPTY ){` |
|       - |  4104 | `		/* Emit the false jump */` |
|   14823 |  4105 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nFalseJump);` |
|       - |  4106 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   14823 |  4107 | `		GenStateNewJumpFixup(pForBlock,PH7_OP_JZ,nFalseJump);` |
|    7409 |  4108 | `	}` |
|   14825 |  4109 | `	if( (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4110 | `		/* Syntax error */` |
...
|   14821 |  4122 | `	pPostStart = pGen->pIn;` |
|       - |  4123 | `	/* Compile the loop body */` |
|   14821 |  4124 | `	pGen->pIn  = &pEnd[1]; /* Jump the trailing parenthesis ')' */` |
|   14821 |  4125 | `	pGen->pEnd = pTmp;` |
|   14821 |  4126 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDFOR);` |
|   14821 |  4127 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  4128 | `		return SXERR_ABORT;` |
|       - |  4129 | `	}` |
|       - |  4130 | `	/* Fix post-continue jumps */` |
|   14821 |  4131 | `	if( SySetUsed(&pForBlock->aPostContFix) > 0 ){` |
...
|   14821 |  4147 | `	while( pPostStart < pEnd && (pPostStart->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  4148 | `		pPostStart++;` |
|     ! 0 |  4149 | `	}` |
|   14821 |  4150 | `	if( pPostStart < pEnd ){` |
|       - |  4151 | `		SyToken *pTmpIn,*pTmpEnd;` |
|   14821 |  4152 | `		SWAP_DELIMITER(pGen,pPostStart,pEnd);` |
|   14821 |  4153 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|   14821 |  4154 | `		if( pGen->pIn < pGen->pEnd ){` |
|       - |  4155 | `			/* Syntax error */` |
...
|       - |  4162 | `		}` |
|   14821 |  4163 | `		RE_SWAP_DELIMITER(pGen);` |
|   14821 |  4164 | `		if( rc == SXERR_ABORT ){` |
|       - |  4165 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4166 | `			return SXERR_ABORT;` |
|   14821 |  4167 | `		}else if( rc != SXERR_EMPTY){` |
|       - |  4168 | `			/* Pop operand lvalue */` |
|   14821 |  4169 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    7408 |  4170 | `		}` |
|    7408 |  4171 | `	}` |
|       - |  4172 | `	/* Emit the unconditional jump to the start of the loop */` |
|   14821 |  4173 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForBlock->nFirstInstr,0,0);` |
|       - |  4174 | `	/* Fix all jumps now the destination is resolved */` |
|   14821 |  4175 | `	GenStateFixJumps(pForBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4176 | `	/* Release the loop block */` |
|   14821 |  4177 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4178 | `	/* Statement successfully compiled */` |
|   14821 |  4179 | `	return SXRET_OK;` |
|    7415 |  4180 | `}` |
...
|       - |  4183 | ` * are allowed.` |
|       - |  4184 | ` */` |
|    7948 |  4185 | `static sxi32 GenStateForEachNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 |  4186 | `{` |
|    7953 |  4187 | `	sxi32 rc = SXRET_OK; /* Assume a valid expression tree */` |
|    7953 |  4188 | `	if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - |  4223 | ` */` |
|    4084 |  4224 | `static sxi32 PH7_CompileForeach(ph7_gen_state *pGen)` |
|       5 |  4225 | `{` |
|    4089 |  4226 | `	SyToken *pCur,*pTmp,*pEnd = 0;` |
|    4089 |  4227 | `	SyToken *pListStart = 0,*pListEnd = 0;` |
|    4089 |  4228 | `	GenBlock *pForeachBlock = 0;` |
|       - |  4229 | `	ph7_foreach_info *pInfo;` |
|       - |  4230 | `	sxu32 nFalseJump;` |
|       - |  4231 | `	VmInstr *pInstr;` |
|       - |  4232 | `	sxu32 nLine;` |
|       - |  4233 | `	sxi32 rc;` |
|    4089 |  4234 | `	nLine = pGen->pIn->nLine;` |
|       - |  4235 | `	/* Jump the 'foreach' keyword */` |
|    4089 |  4236 | `	pGen->pIn++;` |
|    4089 |  4237 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4238 | `		/* Syntax error */` |
...
|    4089 |  4249 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_LOOP,PH7_VmInstrLength(pGen->pVm),0,&pForeachBlock);` |
|    4089 |  4250 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4251 | `		return SXERR_ABORT;` |
|       - |  4252 | `	}` |
|       - |  4253 | `	/* Delimit the expression */` |
|    4089 |  4254 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|    4089 |  4255 | `	if( pGen->pIn == pEnd \|\| pEnd >= pGen->pEnd ){` |
...
|    4089 |  4270 | `	pCur = pGen->pIn;` |
|   28035 |  4271 | `	while( pCur < pEnd ){` |
|   28035 |  4272 | `		if( pCur->nType & PH7_TK_KEYWORD ){` |
|    4103 |  4273 | `			sxi32 nKeywrd = SX_PTR_TO_INT(pCur->pUserData);` |
|    4103 |  4274 | `			if( nKeywrd == PH7_TKWRD_AS ){` |
...
|    4089 |  4292 | `	pTmp = pGen->pEnd;` |
|    4089 |  4293 | `	pGen->pEnd = pCur;` |
|    4089 |  4294 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|    4089 |  4295 | `	if( rc == SXERR_ABORT ){` |
|       - |  4296 | `		/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4297 | `		return SXERR_ABORT;` |
|       - |  4298 | `	}` |
|       - |  4299 | `	/* Update token stream */` |
|    4089 |  4300 | `	while(pGen->pIn < pCur ){` |
...
|     ! 0 |  4306 | `		pGen->pIn++;` |
|     ! 0 |  4307 | `	}` |
|    4089 |  4308 | `	pCur++; /* Jump the 'as' keyword */` |
|    4089 |  4309 | `	pGen->pIn = pCur;` |
|    4089 |  4310 | `	if( pGen->pIn >= pEnd ){` |
...
|    4089 |  4317 | `	pInfo = (ph7_foreach_info *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_foreach_info));` |
|    4089 |  4318 | `	if( pInfo == 0 ){` |
...
|    4089 |  4323 | `	SyZero(pInfo,sizeof(ph7_foreach_info));` |
|       - |  4324 | `	/* Initialize structure fields */` |
|    4089 |  4325 | `	SySetInit(&pInfo->aStep,&pGen->pVm->sAllocator,sizeof(ph7_foreach_step *));` |
...
|       - |  4328 | `	 * '=>'. */` |
|    4089 |  4329 | `	pCur = GenStateFindTopLevelArrow(pCur,pEnd);` |
|    4089 |  4330 | `	if( pCur < pEnd ){` |
|       - |  4331 | `		/* Compile the expression holding the key name */` |
|    3887 |  4332 | `		if( pGen->pIn >= pCur ){` |
...
|       - |  4337 | `			}` |
|     ! 0 |  4338 | `		}else{` |
|    3887 |  4339 | `			pGen->pEnd = pCur;` |
|    3887 |  4340 | `			rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    3887 |  4341 | `			if( rc == SXERR_ABORT ){` |
|       - |  4342 | `				/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4343 | `				return SXERR_ABORT;` |
|       - |  4344 | `			}` |
|    3887 |  4345 | `			pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    3887 |  4346 | `			if( pInstr->p3 ){` |
|       - |  4347 | `				/* Record key name */` |
|    3887 |  4348 | `				SyStringInitFromBuf(&pInfo->sKey,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    1941 |  4349 | `			}` |
|    3887 |  4350 | `			pInfo->iFlags \|= PH7_4EACH_STEP_KEY;` |
|       - |  4351 | `		}` |
|    3887 |  4352 | `		pGen->pIn = &pCur[1]; /* Jump the arrow */` |
|    1941 |  4353 | `	}` |
|    4089 |  4354 | `	pGen->pEnd = pEnd;` |
|    4089 |  4355 | `	if( pGen->pIn >= pEnd ){` |
...
|    4084 |  4410 | `	}else if( pGen->pIn->nType & PH7_TK_OSB ){` |
...
|    4071 |  4443 | `		rc = PH7_CompileExpr(&(*pGen),0,GenStateForEachNodeValidator);` |
|    4071 |  4444 | `		if( rc == SXERR_ABORT ){` |
|       - |  4445 | `			/* Don't worry about freeing memory, everything will be released shortly */` |
|     ! 0 |  4446 | `			return SXERR_ABORT;` |
|       - |  4447 | `		}` |
|    4071 |  4448 | `		pInstr = PH7_VmPopInstr(pGen->pVm);` |
|    4071 |  4449 | `		if( pInstr->p3 ){` |
|       - |  4450 | `			/* Record value name */` |
|    4071 |  4451 | `			SyStringInitFromBuf(&pInfo->sValue,pInstr->p3,SyStrlen((const char *)pInstr->p3));` |
|    2033 |  4452 | `		}` |
|       - |  4453 | `	}` |
|       - |  4454 | `	/* Emit the 'FOREACH_INIT' instruction */` |
|    4087 |  4455 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_INIT,0,0,pInfo,&nFalseJump);` |
|       - |  4456 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    4087 |  4457 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_INIT,nFalseJump);` |
|       - |  4458 | `	/* Record the first instruction to execute */` |
|    4087 |  4459 | `	pForeachBlock->nFirstInstr = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4460 | `	/* Emit the FOREACH_STEP instruction */` |
|    4087 |  4461 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_FOREACH_STEP,0,0,pInfo,&nFalseJump);` |
|       - |  4462 | `	/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|    4087 |  4463 | `	GenStateNewJumpFixup(pForeachBlock,PH7_OP_FOREACH_STEP,nFalseJump);` |
|       - |  4464 | `	/* If list() unpacking, emit bytecode to destructure the temp variable */` |
|    4087 |  4465 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_LIST) && pListStart && pListEnd ){` |
...
|    4087 |  4493 | `	pGen->pIn = &pEnd[1];` |
|    4087 |  4494 | `	pGen->pEnd = pTmp;` |
|    4087 |  4495 | `	rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_END4EACH);` |
|    4087 |  4496 | `	if( rc == SXERR_ABORT ){` |
...
|    4087 |  4501 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,pForeachBlock->nFirstInstr,0,0);` |
|       - |  4502 | `	/* Fix all jumps now the destination is resolved */` |
|    4087 |  4503 | `	GenStateFixJumps(pForeachBlock,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - |  4504 | `	/* Release the loop block */` |
|    4087 |  4505 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4506 | `	/* Statement successfully compiled */` |
|    4087 |  4507 | `	return SXRET_OK;` |
|       1 |  4508 | `Synchronize:` |
...
|       - |  4547 | ` *    ?>` |
|       - |  4548 | ` */` |
|  153890 |  4549 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4550 | `{` |
|  153895 |  4551 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  153895 |  4552 | `	GenBlock *pCondBlock = 0;` |
|       - |  4553 | `	sxu32 nJumpIdx;` |
|       - |  4554 | `	sxu32 nKeyID;` |
|       - |  4555 | `	sxi32 rc;` |
|       - |  4556 | `	/* Jump the 'if' keyword */` |
|  153895 |  4557 | `	pGen->pIn++;` |
|  153895 |  4558 | `	pToken = pGen->pIn;` |
|       - |  4559 | `	/* Create the conditional block */` |
|  153895 |  4560 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  153895 |  4561 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4562 | `		return SXERR_ABORT;` |
|       - |  4563 | `	}` |
|       - |  4564 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   84350 |  4565 | `	for(;;){` |
|  168705 |  4566 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4567 | `			/* Syntax error */` |
...
|  168705 |  4581 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  168705 |  4582 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4583 | `			/* Syntax error */` |
...
|  168705 |  4595 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4596 | `		/* Compile the condition */` |
|  168705 |  4597 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4598 | `		/* Update token stream */` |
|  168705 |  4599 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4600 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4601 | `			pGen->pIn++;` |
|     ! 0 |  4602 | `		}` |
|  168705 |  4603 | `		pGen->pIn  = &pEnd[1];` |
|  168705 |  4604 | `		pGen->pEnd = pTmp;` |
|  168705 |  4605 | `		if( rc == SXERR_ABORT ){` |
|       - |  4606 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4607 | `			return SXERR_ABORT;` |
|       - |  4608 | `		}` |
|       - |  4609 | `		/* Emit the false jump */` |
|  168705 |  4610 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4611 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  168705 |  4612 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4613 | `		/* Compile the body */` |
|  168705 |  4614 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  168705 |  4615 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4616 | `			return SXERR_ABORT;` |
|       - |  4617 | `		}` |
|  168705 |  4618 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   47015 |  4619 | `			break;` |
|       - |  4620 | `		}` |
|       - |  4621 | `		/* Ensure that the keyword ID is 'else if' or 'else' */` |
|   74685 |  4622 | `		nKeyID = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   74685 |  4623 | `		if( (nKeyID & (PH7_TKWRD_ELSE\|PH7_TKWRD_ELIF)) == 0 ){` |
|   48089 |  4624 | `			break;` |
|       - |  4625 | `		}` |
|       - |  4626 | `		/* Emit the unconditional jump */` |
|   26601 |  4627 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JMP,0,0,0,&nJumpIdx);` |
|       - |  4628 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|   26601 |  4629 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|   26601 |  4630 | `		if( nKeyID & PH7_TKWRD_ELSE ){` |
|   19139 |  4631 | `			pToken = &pGen->pIn[1];` |
|   19139 |  4632 | `			if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_KEYWORD) == 0 \|\|` |
|    7400 |  4633 | `				SX_PTR_TO_INT(pToken->pUserData) != PH7_TKWRD_IF ){` |
|    5898 |  4634 | `					break;` |
|       - |  4635 | `			}` |
|    7353 |  4636 | `			pGen->pIn++; /* Jump the 'else' keyword */` |
|    3674 |  4637 | `		}` |
|   14815 |  4638 | `		pGen->pIn++; /* Jump the 'elseif/if' keyword */` |
|       - |  4639 | `		/* Synchronize cursors */` |
|   14815 |  4640 | `		pToken = pGen->pIn;` |
|       - |  4641 | `		/* Fix the false jump */` |
|   14815 |  4642 | `		GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|       5 |  4643 | `	} /* For(;;) */` |
|       - |  4644 | `	/* Fix the false jump */` |
|  153895 |  4645 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  153895 |  4646 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|   59870 |  4647 | `		(SX_PTR_TO_INT(pGen->pIn->pUserData) & PH7_TKWRD_ELSE) ){` |
|       - |  4648 | `			/* Compile the else block */` |
|   11791 |  4649 | `			pGen->pIn++;` |
|   11791 |  4650 | `			rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|   11791 |  4651 | `			if( rc == SXERR_ABORT ){` |
|       - |  4652 |  |
|     ! 0 |  4653 | `				return SXERR_ABORT;` |
|       - |  4654 | `			}` |
|    5893 |  4655 | `	}` |
|  153895 |  4656 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4657 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  153895 |  4658 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4659 | `	/* Release the conditional block */` |
|  153895 |  4660 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4661 | `	/* Statement successfully compiled */` |
|  153895 |  4662 | `	return SXRET_OK;` |
|     ! 0 |  4663 | `Synchronize:` |
...
|       - |  4763 | ` */` |
|  243944 |  4764 | `static sxi32 PH7_CompileReturn(ph7_gen_state *pGen)` |
|       5 |  4765 | `{` |
|  243949 |  4766 | `	sxi32 nRet = 0; /* TRUE if there is a return value */` |
|       - |  4767 | `	sxi32 rc;` |
|  243949 |  4768 | `	sxu32 nLine = pGen->pIn->nLine;` |
|  243949 |  4769 | `	GenBlock *pFuncBlock = pGen->pCurrent;` |
...
|  628215 |  4775 | `	while( pFuncBlock && (pFuncBlock->iFlags & GEN_BLOCK_FUNC) == 0 ){` |
|  384271 |  4776 | `		pFuncBlock = pFuncBlock->pParent;` |
|       5 |  4777 | `	}` |
|  243944 |  4778 | `	if( pFuncBlock && pFuncBlock->pUserData` |
|  243917 |  4779 | `	 && ((ph7_vm_func *)pFuncBlock->pUserData)->nReturnType == MEMOBJ_NEVER ){` |
...
|  243949 |  4787 | `	pGen->pIn++;` |
|  243949 |  4788 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) == 0 ){` |
|       - |  4789 | `		/* Compile the expression */` |
|  243919 |  4790 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  243919 |  4791 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4792 | `			return SXERR_ABORT;` |
|  243919 |  4793 | `		}else if(rc != SXERR_EMPTY ){` |
|  243919 |  4794 | `			nRet = 1;` |
|  121957 |  4795 | `		}` |
|  121957 |  4796 | `	}` |
...
|  243949 |  4801 | `	if( pGen->bInGenerator ){` |
...
|  243929 |  4810 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,nRet,1,0,0);` |
|  243929 |  4811 | `	return SXRET_OK;` |
|  121977 |  4812 | `}` |
|       - |  4813 | `/*` |
...
|     232 |  4833 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_ID)` |
...
|       - |  4924 | ` */` |
|   15004 |  4925 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  4926 | `{` |
|   15009 |  4927 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  4928 | `	sxi32 rc;` |
|       - |  4929 | `	/* Jump the 'echo' keyword */` |
|   15009 |  4930 | `	pGen->pIn++;` |
|       - |  4931 | `	/* Compile arguments one after one */` |
|   15009 |  4932 | `	pTmp = pGen->pEnd;` |
|   33539 |  4933 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   18535 |  4934 | `		if( pGen->pIn < pNext ){` |
|   18535 |  4935 | `			pGen->pEnd = pNext;` |
|   18535 |  4936 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   18535 |  4937 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  4938 | `				return SXERR_ABORT;` |
|   18535 |  4939 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  4940 | `				/* Emit the consume instruction */` |
|   18511 |  4941 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    9253 |  4942 | `			}` |
|    9265 |  4943 | `		}` |
|       - |  4944 | `		/* Jump trailing commas */` |
|   22061 |  4945 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    3531 |  4946 | `			pNext++;` |
|       5 |  4947 | `		}` |
|   18535 |  4948 | `		pGen->pIn = pNext;` |
|       5 |  4949 | `	}` |
|       - |  4950 | `	/* Restore token stream */` |
|   15009 |  4951 | `	pGen->pEnd = pTmp;` |
|   15009 |  4952 | `	return SXRET_OK;` |
|    7507 |  4953 | `}` |
|       - |  4954 | `/*` |
...
|       - |  5119 | ` */` |
|  474066 |  5120 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  5121 | `{` |
|       - |  5122 | `	ph7_value *pLit;` |
...
|       - |  5130 | `	ph7_value *pNew;` |
|  474071 |  5131 | `	if( pFromImport ){` |
|  453693 |  5132 | `		*pFromImport = 0;` |
|  226844 |  5133 | `	}` |
|  474071 |  5134 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  474071 |  5135 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  5136 | `		return nOrigIdx;` |
|       - |  5137 | `	}` |
|  474071 |  5138 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  474071 |  5139 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  5140 | `	/* Skip if already qualified (contains backslash) */` |
|  474071 |  5141 | `	hasNsSep = 0;` |
| 5235041 |  5142 | `	for( k = 0; k < nLit; k++ ){` |
| 4760983 |  5143 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2380490 |  5144 | `	}` |
|  474071 |  5145 | `	if( hasNsSep ){` |
|      10 |  5146 | `		return nOrigIdx;` |
|       - |  5147 | `	}` |
|       - |  5148 | `	/* Check use imports first (works even outside namespaces) */` |
|  474063 |  5149 | `	SyBlobReset(&pGen->sWorker);` |
|  474063 |  5150 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  474063 |  5151 | `	if( pImport ){` |
...
|       8 |  5156 | `		}` |
|      23 |  5157 | `	}else{` |
|  474027 |  5158 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  473937 |  5159 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  5160 | `		}` |
...
|       - |  5182 | ` */` |
|  100200 |  5183 | `static void GenStateResolveName(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5184 | `{` |
|       - |  5185 | `	SyHashEntry *pImport;` |
|       - |  5186 | `	/* Check use imports first */` |
|  100205 |  5187 | `	pImport = SyHashGet(&pGen->hUseImports,(const void *)pName->zString,pName->nByte);` |
|  100205 |  5188 | `	if( pImport ){` |
...
|       - |  5204 | ` */` |
|  148398 |  5205 | `static void GenStateBuildFQN(ph7_gen_state *pGen,const SyString *pName,SyBlob *pOut)` |
|       5 |  5206 | `{` |
|  148403 |  5207 | `	if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|    3737 |  5208 | `		SyBlobAppend(pOut,SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|    3737 |  5209 | `		SyBlobAppend(pOut,"\\",1);` |
|    1866 |  5210 | `	}` |
|  148403 |  5211 | `	SyBlobAppend(pOut,pName->zString,pName->nByte);` |
|  148403 |  5212 | `}` |
|       - |  5213 | `/*` |
...
|       3 |  5257 | `	return "token";` |
|      10 |  5258 | `}` |
|    3780 |  5259 | `static sxi32 PH7_CompileNamespace(ph7_gen_state *pGen)` |
|       5 |  5260 | `{` |
|       - |  5261 | `	sxu32 nLine;` |
|       - |  5262 | `	sxi32 rc;` |
|    3785 |  5263 | `	nLine = pGen->pIn->nLine;` |
|    3785 |  5264 | `	pGen->pIn++; /* Jump the 'namespace' keyword */` |
|       - |  5265 | `	/* Reset namespace and clear previous use imports */` |
|    3785 |  5266 | `	SyBlobReset(&pGen->sNamespace);` |
|    3785 |  5267 | `	SyHashRelease(&pGen->hUseImports);` |
|    3785 |  5268 | `	SyHashInit(&pGen->hUseImports,&pGen->pVm->sAllocator,0,0);` |
|    3785 |  5269 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|    3785 |  5270 | `	SyHashInit(&pGen->hUseFuncImports,&pGen->pVm->sAllocator,0,0);` |
|    3785 |  5271 | `	SyHashRelease(&pGen->hUseConstImports);` |
|    3785 |  5272 | `	SyHashInit(&pGen->hUseConstImports,&pGen->pVm->sAllocator,0,0);` |
|    3785 |  5273 | `	if( pGen->pIn >= pGen->pEnd ){` |
|       - |  5274 | `		/* Global namespace (bare "namespace;") */` |
|     ! 0 |  5275 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|     ! 0 |  5276 | `		return SXRET_OK;` |
|       - |  5277 | `	}` |
|    3785 |  5278 | `	if( pGen->pIn->nType & PH7_TK_SEMI ){` |
|       - |  5279 | `		/* namespace; — switch to global namespace */` |
|     ! 0 |  5280 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|     ! 0 |  5281 | `		return SXRET_OK;` |
|       - |  5282 | `	}` |
|    3785 |  5283 | `	if( pGen->pIn->nType & PH7_TK_OCB ){` |
...
|    7607 |  5289 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_NSSEP\|PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|    3827 |  5290 | `		if( pGen->pIn->nType & PH7_TK_NSSEP ){` |
...
|    3805 |  5297 | `			SyBlobAppend(&pGen->sNamespace,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|       - |  5298 | `		}` |
|    3827 |  5299 | `		pGen->pIn++;` |
|       5 |  5300 | `	}` |
...
|       - |  5303 | `	{` |
|    3785 |  5304 | `		char *zNsDup = 0;` |
|    3785 |  5305 | `		if( SyBlobLength(&pGen->sNamespace) > 0 ){` |
|    5672 |  5306 | `			zNsDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    3778 |  5307 | `				(const char *)SyBlobData(&pGen->sNamespace),SyBlobLength(&pGen->sNamespace));` |
|    1889 |  5308 | `		}` |
|    3785 |  5309 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_NSSWITCH,0,0,zNsDup,0);` |
|       - |  5310 | `	}` |
|    3785 |  5311 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & (PH7_TK_SEMI\|PH7_TK_OCB)) == 0 ){` |
...
|       - |  5709 | ` */` |
|   77196 |  5710 | `static sxi32 GenStateProcessArgValue(ph7_gen_state *pGen,ph7_vm_func_arg *pArg,SyToken *pIn,SyToken *pEnd)` |
|       5 |  5711 | `{` |
|       - |  5712 | `	SyToken *pTmpIn,*pTmpEnd;` |
|       - |  5713 | `	SySet *pInstrContainer;` |
|       - |  5714 | `	sxi32 rc;` |
|       - |  5715 | `	/* Swap token stream */` |
|   77201 |  5716 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|   77201 |  5717 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   77201 |  5718 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pArg->aByteCode);` |
|       - |  5719 | `	/* Compile the expression holding the argument value */` |
|   77201 |  5720 | `	rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  5721 | `	/* Emit the done instruction */` |
|   77201 |  5722 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,(rc != SXERR_EMPTY ? 1 : 0),0,0,0);` |
|   77201 |  5723 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   77201 |  5724 | `	RE_SWAP_DELIMITER(pGen);` |
|   77201 |  5725 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  5726 | `		return SXERR_ABORT;` |
|       - |  5727 | `	}` |
|   77201 |  5728 | `	return SXRET_OK;` |
|   38603 |  5729 | `}` |
|       - |  5730 | `/*` |
...
|       - |  5766 | ` */` |
|  107950 |  5767 | `static sxi32 GenStateCollectFuncArgs(ph7_vm_func *pFunc,ph7_gen_state *pGen,SyToken *pEnd,int bCtorCtx,int bAbstractCtx)` |
|       5 |  5768 | `{` |
...
|       - |  5773 | `	sxi32 rc;` |
|       - |  5774 |  |
|  107955 |  5775 | `	pIn = pGen->pIn;` |
|  107955 |  5776 | `	SyBlobInit(&sSig,&pGen->pVm->sAllocator);` |
|       - |  5777 | `	/* Process arguments one after one */` |
|  139549 |  5778 | `	for(;;){` |
|  279103 |  5779 | `		if( pIn >= pEnd ){` |
|       - |  5780 | `			/* No more arguments to process */` |
|  107939 |  5781 | `			break;` |
|       - |  5782 | `		}` |
|  171169 |  5783 | `		SyZero(&sArg,sizeof(ph7_vm_func_arg));` |
|  171169 |  5784 | `		SySetInit(&sArg.aByteCode,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|  171169 |  5785 | `		SySetInit(&sArg.aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
|  171169 |  5786 | `		SyStringInitFromBuf(&sArg.sTypeName,0,0);` |
...
|       - |  5792 | `		{` |
|  171169 |  5793 | `			int bReadonly = 0, bVisSeen = 0;` |
|  171169 |  5794 | `			sxi32 iVis = PH7_CLASS_PROT_PUBLIC;` |
|  171169 |  5795 | `			if( pIn < pEnd && GenStateIsReadonly(pIn) ){` |
|       3 |  5796 | `				bReadonly = 1;` |
|       3 |  5797 | `				pIn++;` |
|       1 |  5798 | `			}` |
|  171169 |  5799 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD) ){` |
|   66371 |  5800 | `				sxu32 nKw = (sxu32)SX_PTR_TO_INT(pIn->pUserData);` |
|   66371 |  5801 | `				if( nKw == PH7_TKWRD_PUBLIC \|\| nKw == PH7_TKWRD_PROTECTED \|\| nKw == PH7_TKWRD_PRIVATE ){` |
|      71 |  5802 | `					bVisSeen = 1;` |
...
|      33 |  5811 | `				}` |
|   33183 |  5812 | `			}` |
|  171169 |  5813 | `			if( bVisSeen \|\| bReadonly ){` |
|      73 |  5814 | `				if( !bCtorCtx ){` |
...
|  171160 |  5835 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_DOLLAR) == 0` |
|  129849 |  5836 | `			&& (pIn->nType & PH7_TK_AMPER) == 0` |
|   86693 |  5837 | `			&& (pIn->nType & PH7_TK_ELLIPSIS) == 0 ){` |
|   81145 |  5838 | `			sxu32 nLineLocal = pIn->nLine;` |
|   81145 |  5839 | `			sxi32 iTFlags = 0;` |
|   81145 |  5840 | `			pGen->pIn = pIn;` |
|   81145 |  5841 | `			rc = GenStateParseUnionTypeDecl(` |
|   40570 |  5842 | `				pGen, &sArg.nType, &sArg.sClass, &sArg.aUnionAlts,` |
|   40570 |  5843 | `				&iTFlags, &sArg.sTypeName,` |
|       - |  5844 | `				VM_FUNC_ARG_NULLABLE, VM_FUNC_ARG_UNION,` |
|       - |  5845 | `				/* bAllowVoid */ 0,` |
|   40570 |  5846 | `						nLineLocal);` |
|   81145 |  5847 | `			pIn = pGen->pIn;` |
|   81145 |  5848 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5849 | `				return SXERR_ABORT;` |
|   81145 |  5850 | `			}else if( rc == SXERR_CORRUPT ){` |
|       - |  5851 | `				/* Error already reported by GenStateParseUnionTypeDecl */` |
|       3 |  5852 | `				return SXERR_SYNTAX;` |
|   81143 |  5853 | `			}else if( rc == SXERR_SYNTAX ){` |
|      11 |  5854 | `				if( pIn < pEnd ){` |
|      15 |  5855 | `					PH7_GenCompileError(pGen,E_PARSE,pIn->nLine,` |
...
|       - |  5861 | `				}` |
|      11 |  5862 | `				return SXERR_SYNTAX;` |
|       - |  5863 | `			}` |
|   81135 |  5864 | `			sArg.iFlags \|= iTFlags;` |
|   40565 |  5865 | `		}` |
|  171155 |  5866 | `		if( pIn >= pEnd ){` |
|     ! 0 |  5867 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Missing argument name");` |
|     ! 0 |  5868 | `			return rc;` |
|       - |  5869 | `		}` |
|  171155 |  5870 | `		if( pIn->nType & PH7_TK_AMPER ){` |
|       - |  5871 | `			/* Pass by reference,record that */` |
|    3707 |  5872 | `			sArg.iFlags \|= VM_FUNC_ARG_BY_REF;` |
|    3707 |  5873 | `			pIn++;` |
|    1851 |  5874 | `		}` |
|  171155 |  5875 | `		if( pIn < pEnd && (pIn->nType & PH7_TK_ELLIPSIS) ){` |
|       - |  5876 | `			/* Variadic parameter: ...$args */` |
|    3723 |  5877 | `			sArg.iFlags \|= VM_FUNC_ARG_VARIADIC;` |
|    3723 |  5878 | `			pIn++;` |
|    1859 |  5879 | `		}` |
|  171155 |  5880 | `		if( pIn >= pEnd \|\| (pIn->nType & PH7_TK_DOLLAR) == 0 \|\| &pIn[1] >= pEnd \|\| (pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       - |  5881 | `			/* Invalid argument */` |
|     ! 0 |  5882 | `			rc = PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Invalid argument name");` |
|     ! 0 |  5883 | `			return rc;` |
|       - |  5884 | `		}` |
|  171155 |  5885 | `		pIn++; /* Jump the dollar sign */` |
|       - |  5886 | `		/* Copy argument name */` |
|  171155 |  5887 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,SyStringData(&pIn->sData),SyStringLength(&pIn->sData));` |
|  171155 |  5888 | `		if( zDup == 0 ){` |
|     ! 0 |  5889 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |  5890 | `			return SXERR_ABORT;` |
|       - |  5891 | `		}` |
|  171155 |  5892 | `		SyStringInitFromBuf(&sArg.sName,zDup,SyStringLength(&pIn->sData));` |
|  171155 |  5893 | `		pIn++;` |
|  171155 |  5894 | `		if( pIn < pEnd ){` |
|  103673 |  5895 | `			if( pIn->nType & PH7_TK_EQUAL ){` |
|       - |  5896 | `				SyToken *pDefend;` |
|   77203 |  5897 | `				sxi32 iNest = 0;` |
|   77203 |  5898 | `				pIn++; /* Jump the equal sign */` |
|   77203 |  5899 | `				pDefend = pIn;` |
|       - |  5900 | `				/* Process the default value associated with this argument */` |
|  161753 |  5901 | `				while( pDefend < pEnd ){` |
|  121305 |  5902 | `					if( (pDefend->nType & PH7_TK_COMMA) && iNest <= 0 ){` |
|   36755 |  5903 | `						break;` |
|       - |  5904 | `					}` |
|   84555 |  5905 | `					if( pDefend->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*[*/) ){` |
|       - |  5906 | `						/* Increment nesting level */` |
|    3681 |  5907 | `						iNest++;` |
|   82717 |  5908 | `					}else if( pDefend->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*]*/) ){` |
|       - |  5909 | `						/* Decrement nesting level */` |
|    3681 |  5910 | `						iNest--;` |
|    1838 |  5911 | `					}` |
|   84555 |  5912 | `					pDefend++;` |
|       5 |  5913 | `				}` |
|   77203 |  5914 | `				if( pIn >= pDefend ){` |
|       3 |  5915 | `					rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Missing argument default value");` |
|       3 |  5916 | `					return rc;` |
|       - |  5917 | `				}` |
|       - |  5918 | `				/* Process default value */` |
|   77201 |  5919 | `				rc = GenStateProcessArgValue(&(*pGen),&sArg,pIn,pDefend);` |
|   77201 |  5920 | `				if( rc != SXRET_OK ){` |
|     ! 0 |  5921 | `					return rc;` |
|       - |  5922 | `				}` |
|       - |  5923 | `				/* Point beyond the default value */` |
|   77201 |  5924 | `				pIn = pDefend;` |
|   38598 |  5925 | `			}` |
|  103671 |  5926 | `			if( pIn < pEnd && (pIn->nType & PH7_TK_COMMA) == 0 ){` |
|     ! 0 |  5927 | `				rc = PH7_GenCompileError(&(*pGen),E_ERROR,pIn->nLine,"Unexpected token '%z'",&pIn->sData);` |
|     ! 0 |  5928 | `				return rc;` |
|       - |  5929 | `			}` |
|  103671 |  5930 | `			pIn++; /* Jump the trailing comma */` |
|   51833 |  5931 | `		}` |
|       - |  5932 | `		/* Append argument signature */` |
|  171153 |  5933 | `		if( sArg.nType > 0 ){` |
|   81081 |  5934 | `			if( SyStringLength(&sArg.sClass) > 0 ){` |
|       - |  5935 | `				/* Class name — prefix with 'o' so generic object hint is a prefix match */` |
|   14757 |  5936 | `				int marker = 'o';` |
|   14757 |  5937 | `				SyBlobAppend(&sSig,(const void *)&marker,sizeof(char));` |
|   14757 |  5938 | `				SyBlobAppend(&sSig,SyStringData(&sArg.sClass),SyStringLength(&sArg.sClass));` |
|    7381 |  5939 | `			}else{` |
|       - |  5940 | `				int c;` |
|   66329 |  5941 | `				c = 'n'; /* cc warning */` |
|       - |  5942 | `				/* Type leading character */` |
|   66329 |  5943 | `				switch(sArg.nType){` |
|       3 |  5944 | `				case MEMOBJ_HASHMAP:` |
|       - |  5945 | `					/* Hashmap aka 'array' */` |
|       7 |  5946 | `					c = 'h';` |
|       7 |  5947 | `					break;` |
|    9241 |  5948 | `				case MEMOBJ_INT:` |
|       - |  5949 | `					/* Integer */` |
|   18487 |  5950 | `					c = 'i';` |
|   18487 |  5951 | `					break;` |
...
|       2 |  5969 | `					break;` |
|       - |  5970 | `				}` |
|   66329 |  5971 | `				SyBlobAppend(&sSig,(const void *)&c,sizeof(char));` |
|       - |  5972 | `			}` |
|   40543 |  5973 | `		}else{` |
|       - |  5974 | `			/* No type is associated with this parameter which mean` |
|       - |  5975 | `			 * that this function is not condidate for overloading.` |
|       - |  5976 | `			 */` |
|   90077 |  5977 | `			SyBlobRelease(&sSig);` |
|       - |  5978 | `		}` |
|       - |  5979 | `		/* Save in the argument set */` |
|  171153 |  5980 | `		SySetPut(&pFunc->aArgs,(const void *)&sArg);` |
|       5 |  5981 | `	}` |
|  107939 |  5982 | `	if( SyBlobLength(&sSig) > 0 ){` |
|       - |  5983 | `		/* Save function signature */` |
|   51655 |  5984 | `		SyStringInitFromBuf(&pFunc->sSignature,SyBlobData(&sSig),SyBlobLength(&sSig));` |
|   25825 |  5985 | `	}` |
|  107939 |  5986 | `	return SXRET_OK;` |
|   53980 |  5987 | `}` |
|       - |  5988 | `/*` |
...
|       - |  6028 | ` */` |
|  230268 |  6029 | `static int GenStateFuncBodyHasYield(ph7_gen_state *pGen)` |
|       5 |  6030 | `{` |
|  230273 |  6031 | `	SyToken *pIn = pGen->pIn;   /* expected at the body's opening '{' */` |
|  230273 |  6032 | `	SyToken *pEnd = pGen->pEnd;` |
|  230273 |  6033 | `	sxi32 iDepth = 0;` |
|  230273 |  6034 | `	int bStarted = 0;` |
| 7648447 |  6035 | `	while( pIn < pEnd ){` |
| 7648447 |  6036 | `		sxu32 t = pIn->nType;` |
| 7648447 |  6037 | `		if( t & PH7_TK_OCB ){ iDepth++; bStarted = 1; pIn++; continue; }` |
| 7207977 |  6038 | `		if( t & PH7_TK_CCB ){ iDepth--; pIn++; if( bStarted && iDepth <= 0 ){ break; } continue; }` |
| 6767723 |  6039 | `		if( t & PH7_TK_KEYWORD ){` |
|  536733 |  6040 | `			int kw = SX_PTR_TO_INT(pIn->pUserData);` |
|  536733 |  6041 | `			if( kw == PH7_TKWRD_YIELD ){ return TRUE; }` |
|  536589 |  6042 | `			if( kw == PH7_TKWRD_FUNCTION ){ pIn = GenStateSkipNestedFunc(pIn,pEnd); continue; }` |
|       - |  6043 | ``			/* `fn` arrow bodies are single expressions and cannot contain a valid yield. */`` |
|  268285 |  6044 | `		}` |
| 6767565 |  6045 | `		pIn++;` |
|       5 |  6046 | `	}` |
|  230129 |  6047 | `	return FALSE;` |
|  115139 |  6048 | `}` |
|       - |  6049 | `/*` |
...
|       - |  6053 | ` */` |
|  230268 |  6054 | `static sxi32 GenStateCompileFuncBody(` |
...
|  230273 |  6064 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_PROTECTED\|GEN_BLOCK_FUNC,PH7_VmInstrLength(pGen->pVm),pFunc,&pBlock);` |
|  230273 |  6065 | `	if( rc != SXRET_OK ){` |
...
|       - |  6069 | `	}` |
|  230273 |  6070 | `	nGotoOfft = SySetUsed(&pGen->aGoto);` |
|       - |  6071 | `	/* Swap bytecode containers */` |
|  230273 |  6072 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|  230273 |  6073 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&pFunc->aByteCode);` |
...
|       - |  6078 | `	{` |
|  230273 |  6079 | `		sxu32 nArg = SySetUsed(&pFunc->aArgs);` |
|       - |  6080 | `		sxu32 i;` |
|  371881 |  6081 | `		for( i = 0; i < nArg; i++ ){` |
|  141613 |  6082 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pFunc->aArgs,i);` |
|       - |  6083 | `			char *zSrc;` |
|       - |  6084 | `			sxu32 nSrc,nName;` |
|       - |  6085 | `			SySet sToken;` |
|       - |  6086 | `			SyToken *pTmpIn,*pTmpEnd;` |
|       - |  6087 | `			sxi32 rcPromote;` |
|  141613 |  6088 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  141559 |  6089 | `				continue;` |
|       - |  6090 | `			}` |
...
|       - |  6140 | `	{` |
|  230273 |  6141 | `		sxi8 bSavedGen = pGen->bInGenerator;` |
|  230273 |  6142 | `		pGen->bInGenerator = (sxi8)GenStateFuncBodyHasYield(&(*pGen));` |
|       - |  6143 | `		/* Compile the body */` |
|  230273 |  6144 | `		PH7_CompileBlock(&(*pGen),0);` |
|  230273 |  6145 | `		pGen->bInGenerator = bSavedGen;` |
|       - |  6146 | `	}` |
|       - |  6147 | `	/* Fix exception jumps now the destination is resolved */` |
|  230273 |  6148 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - |  6149 | `	/* Emit the final return if not yet done */` |
|  230273 |  6150 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - |  6151 | `	/* Fix gotos jumps now the destination is resolved */` |
|  230273 |  6152 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),nGotoOfft) ){` |
|     ! 0 |  6153 | `		rc = SXERR_ABORT;` |
|     ! 0 |  6154 | `	}` |
|  230273 |  6155 | `	SySetTruncate(&pGen->aGoto,nGotoOfft);` |
|       - |  6156 | `	/* Restore the default container */` |
|  230273 |  6157 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - |  6158 | `	/* Leave function block */` |
|  230273 |  6159 | `	GenStateLeaveBlock(&(*pGen),0);` |
|  230273 |  6160 | `	if( rc == SXERR_ABORT ){` |
...
|       - |  6165 | `	{` |
|  230273 |  6166 | `		VmInstr *aInstr = (VmInstr *)SySetBasePtr(&pFunc->aByteCode);` |
|       - |  6167 | `		sxu32 i;` |
| 4522743 |  6168 | `		for( i = 0; i < SySetUsed(&pFunc->aByteCode); i++ ){` |
| 4292619 |  6169 | `			if( aInstr[i].iOp == PH7_OP_YIELD \|\| aInstr[i].iOp == PH7_OP_YIELD_FROM ){` |
...
|       - |  6239 | ` */` |
|   82006 |  6240 | `static sxi32 GenStateParseOneTypeAtom(ph7_gen_state *pGen, PhlTypeAtom *pOut)` |
|       5 |  6241 | `{` |
|   82011 |  6242 | `	SyToken *pIn = pGen->pIn;` |
|   82011 |  6243 | `	SyZero(pOut, sizeof(*pOut));` |
|   82011 |  6244 | `	SyStringInitFromBuf(&pOut->sClass, 0, 0);` |
|   82011 |  6245 | `	if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6246 | `		return SXERR_SYNTAX;` |
|       - |  6247 | `	}` |
|       - |  6248 | `	/* Optional leading namespace separator '\' on FQN class types */` |
|   82011 |  6249 | `	if( pIn->nType & PH7_TK_NSSEP ){` |
|       8 |  6250 | `		pIn++;` |
|       8 |  6251 | `		if( pIn >= pGen->pEnd ){` |
|     ! 0 |  6252 | `			return SXERR_SYNTAX;` |
|       - |  6253 | `		}` |
|       3 |  6254 | `	}` |
|   82011 |  6255 | `	if( (pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  6256 | `		return SXERR_SYNTAX;` |
|       - |  6257 | `	}` |
|   82011 |  6258 | `	if( pIn->nType & PH7_TK_KEYWORD ){` |
|   66883 |  6259 | `		sxu32 nKey = (sxu32)(SX_PTR_TO_INT(pIn->pUserData));` |
|   66883 |  6260 | `		if( nKey & PH7_TKWRD_ARRAY ){` |
|      32 |  6261 | `			pOut->nType = MEMOBJ_HASHMAP; pOut->zCanon = "array"; pOut->nCanon = 5;` |
|   66869 |  6262 | `		}else if( nKey & PH7_TKWRD_BOOL ){` |
|      71 |  6263 | `			pOut->nType = MEMOBJ_BOOL; pOut->zCanon = "bool"; pOut->nCanon = 4;` |
|   66822 |  6264 | `		}else if( nKey & PH7_TKWRD_INT ){` |
|   18747 |  6265 | `			pOut->nType = MEMOBJ_INT; pOut->zCanon = "int"; pOut->nCanon = 3;` |
|   57418 |  6266 | `		}else if( nKey & PH7_TKWRD_STRING ){` |
|   47977 |  6267 | `			pOut->nType = MEMOBJ_STRING; pOut->zCanon = "string"; pOut->nCanon = 6;` |
|   24061 |  6268 | `		}else if( nKey & PH7_TKWRD_FLOAT ){` |
...
|   15133 |  6283 | `		SyString *pT = &pIn->sData;` |
|   15133 |  6284 | `		if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "null", 4) == 0 ){` |
|      32 |  6285 | `			pOut->nType = UTA_NULL_FLAG; pOut->zCanon = "null"; pOut->nCanon = 4;` |
|      32 |  6286 | `			pIn++;` |
|   15119 |  6287 | `		}else if( pT->nByte == 4 && SyMemcmpNoCase(pT->zString, "void", 4) == 0 ){` |
|     157 |  6288 | `			pOut->nType = UTA_VOID_FLAG; pOut->zCanon = "void"; pOut->nCanon = 4;` |
|     157 |  6289 | `			pIn++;` |
|   15029 |  6290 | `		}else if( pT->nByte == 5 && SyMemcmpNoCase(pT->zString, "never", 5) == 0 ){` |
|      24 |  6291 | `			pOut->nType = UTA_NEVER_FLAG; pOut->zCanon = "never"; pOut->nCanon = 5;` |
|      24 |  6292 | `			pIn++;` |
|      14 |  6293 | `		}else{` |
|       - |  6294 | `			/* Class / interface name; consume namespace path a\b\c */` |
|   14933 |  6295 | `			SyToken *pFirst = pIn;` |
|   14933 |  6296 | `			SyToken *pLast = pIn;` |
|   14933 |  6297 | `			pOut->nType = SXU32_HIGH;` |
|   14933 |  6298 | `			pOut->sClass = pIn->sData;` |
|   14933 |  6299 | `			pIn++;` |
|   22395 |  6300 | `			while( pIn + 1 < pGen->pEnd && (pIn->nType & PH7_TK_NSSEP)` |
|   14936 |  6301 | `				&& (pIn[1].nType & PH7_TK_ID) ){` |
|       3 |  6302 | `				pLast = &pIn[1];` |
|       3 |  6303 | `				pIn += 2;` |
|       1 |  6304 | `			}` |
|   14933 |  6305 | `			if( pLast != pFirst ){` |
...
|       - |  6311 | `		}` |
|       - |  6312 | `	}` |
|   82009 |  6313 | `	pGen->pIn = pIn;` |
|   82009 |  6314 | `	return SXRET_OK;` |
|   41008 |  6315 | `}` |
|       - |  6316 |  |
|       - |  6317 | `/*` |
...
|       - |  6323 | ` */` |
|   81846 |  6324 | `static void GenBuildUnionTypeText(SyBlob *pBlob, PhlTypeAtom *aAtoms, int nAtoms, int bNullable)` |
|       5 |  6325 | `{` |
|       - |  6326 | `	int i;` |
|   81851 |  6327 | `	int nNonNull = 0;` |
|   81851 |  6328 | `	int bAnyIntersection = 0;` |
|       - |  6329 | `	sxu32 aGroupCount[PHL_UNION_MAX_ALTS];` |
|   81851 |  6330 | `	sxu32 nMaxGroup = 0;` |
| 2700923 |  6331 | `	for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  163831 |  6332 | `	for( i = 0; i < nAtoms; i++ ){` |
|   81985 |  6333 | `		if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   81957 |  6334 | `			nNonNull++;` |
|   81957 |  6335 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ){` |
|   81957 |  6336 | `				aGroupCount[aAtoms[i].nGroup]++;` |
|   81957 |  6337 | `				if( aAtoms[i].nGroup > nMaxGroup ) nMaxGroup = aAtoms[i].nGroup;` |
|   40976 |  6338 | `			}` |
|   40976 |  6339 | `		}` |
|   40995 |  6340 | `	}` |
|  163797 |  6341 | `	for( i = 0; i < nAtoms; i++ ){` |
|   81967 |  6342 | `		if( aAtoms[i].nType != UTA_NULL_FLAG && aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
|      20 |  6343 | `			bAnyIntersection = 1;` |
|      20 |  6344 | `			break;` |
|       - |  6345 | `		}` |
|   40978 |  6346 | `	}` |
|   81851 |  6347 | `	if( bAnyIntersection ){` |
...
|      58 |  6382 | `		return;` |
|       - |  6383 | `	}` |
|   81835 |  6384 | `	if( nNonNull == 1 && bNullable ){` |
|       - |  6385 | `		/* Shorthand: ?T */` |
...
|     ! 0 |  6396 | `	}` |
|       - |  6397 | `	{` |
|   81759 |  6398 | `		int bFirst = 1;` |
|       - |  6399 | `		/* 1) Classes in declaration order */` |
|  163615 |  6400 | `		for( i = 0; i < nAtoms; i++ ){` |
|   81861 |  6401 | `			if( aAtoms[i].nType == SXU32_HIGH ){` |
|   14897 |  6402 | `				if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   14897 |  6403 | `				SyBlobAppend(pBlob, aAtoms[i].sClass.zString, aAtoms[i].sClass.nByte);` |
|   14897 |  6404 | `				bFirst = 0;` |
|    7446 |  6405 | `			}` |
|   40933 |  6406 | `		}` |
...
|       - |  6411 | `			int k;` |
|  572283 |  6412 | `			for( k = 0; k < (int)(sizeof(aOrder)/sizeof(aOrder[0])); k++ ){` |
|  914773 |  6413 | `				for( i = 0; i < nAtoms; i++ ){` |
|  491033 |  6414 | `					if( aAtoms[i].nType == aOrder[k] ){` |
|   66789 |  6415 | `						if( !bFirst ) SyBlobAppend(pBlob, "\|", 1);` |
|   66789 |  6416 | `						SyBlobAppend(pBlob, aAtoms[i].zCanon, aAtoms[i].nCanon);` |
|   66789 |  6417 | `						bFirst = 0;` |
|   66789 |  6418 | `						break;` |
|       - |  6419 | `					}` |
|  212127 |  6420 | `				}` |
...
|       - |  6444 | ` */` |
|   81988 |  6445 | `static sxi32 GenStateParsePart(` |
|       - |  6446 | `	ph7_gen_state *pGen, PhlTypeAtom *aAtoms, int *pnAtoms, sxu32 iGroup,` |
|       - |  6447 | `	int *pnMembers, int *pbParen, sxu32 nLine)` |
|       5 |  6448 | `{` |
|       - |  6449 | `	sxi32 rc;` |
|   81993 |  6450 | `	int nMembers = 0;` |
|   81993 |  6451 | `	int bParen = 0;` |
|   81993 |  6452 | `	*pnMembers = 0;` |
|   81993 |  6453 | `	*pbParen = 0;` |
|   81993 |  6454 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       6 |  6455 | `		bParen = 1;` |
|       6 |  6456 | `		pGen->pIn++; /* skip '(' */` |
|       2 |  6457 | `	}` |
|   40994 |  6458 | `	for(;;){` |
|   82011 |  6459 | `		if( *pnAtoms >= PHL_UNION_MAX_ALTS ){` |
...
|       - |  6463 | `		}` |
|   82011 |  6464 | `		rc = GenStateParseOneTypeAtom(pGen, &aAtoms[*pnAtoms]);` |
|   82011 |  6465 | `		if( rc != SXRET_OK ){` |
|       3 |  6466 | `			return rc;` |
|       - |  6467 | `		}` |
|   82009 |  6468 | `		aAtoms[*pnAtoms].nGroup = iGroup;` |
|   82009 |  6469 | `		(*pnAtoms)++;` |
|   82009 |  6470 | `		nMembers++;` |
|       - |  6471 | ``		/* Continue the intersection while `&` is followed by another type atom. */`` |
|   82009 |  6472 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
...
|       - |  6493 | `		}` |
|       2 |  6494 | `	}` |
|   81991 |  6495 | `	*pnMembers = nMembers;` |
|   81991 |  6496 | `	*pbParen = bParen;` |
|   81991 |  6497 | `	return SXRET_OK;` |
|   40999 |  6498 | `}` |
|       - |  6499 |  |
|       - |  6500 | `/*` |
...
|       - |  6517 | ` */` |
|   81862 |  6518 | `static sxi32 GenStateParseUnionTypeDecl(` |
...
|   81867 |  6531 | `	int nAtoms = 0;` |
|   81867 |  6532 | `	int bShortNullable = 0;` |
|   81867 |  6533 | `	int bExplicitNull = 0;` |
|       - |  6534 | `	sxi32 rc;` |
|   81867 |  6535 | `	*pnType = 0;` |
|   81867 |  6536 | `	if( pClass ) SyStringInitFromBuf(pClass, 0, 0);` |
|   81867 |  6537 | `	*piTypeFlags = 0;` |
|   81867 |  6538 | `	if( pTypeText ) SyStringInitFromBuf(pTypeText, 0, 0);` |
|       - |  6539 |  |
|   81867 |  6540 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  6541 | `		return SXRET_OK;` |
|       - |  6542 | `	}` |
|       - |  6543 | ``	/* Optional `?` shorthand prefix */`` |
|   81862 |  6544 | `	if( (pGen->pIn->nType & PH7_TK_OP) && pGen->pIn->sData.nByte == 1` |
...
|   81867 |  6557 | `		sxu32 iGroup = 0;` |
|   81867 |  6558 | `		rc = GenStateParsePart(pGen, aAtoms, &nAtoms, iGroup, &nMembers, &bParen, nLine);` |
|   81867 |  6559 | `		if( rc != SXRET_OK ){` |
|       4 |  6560 | `			return rc;` |
|       - |  6561 | `		}` |
...
|  122981 |  6567 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_OP)` |
|   82056 |  6568 | `			&& pGen->pIn->sData.nByte == 1 && pGen->pIn->sData.zString[0] == '\|' ){` |
...
|       - |  6586 | `			}` |
|       5 |  6587 | `		}` |
|   81863 |  6588 | `		if( iGroup > 0 && nMembers >= 2 && !bParen ){` |
...
|       - |  6600 | `	{` |
|       - |  6601 | `		int i, j;` |
|   81863 |  6602 | `		int bHasNonNull = 0;` |
|   81863 |  6603 | `		int bAnyIntersection = 0;` |
...
| 2701319 |  6607 | `		for( i = 0; i < PHL_UNION_MAX_ALTS; i++ ) aGroupCount[i] = 0;` |
|  163865 |  6608 | `		for( i = 0; i < nAtoms; i++ ){` |
|   82007 |  6609 | `			if( aAtoms[i].nGroup < PHL_UNION_MAX_ALTS ) aGroupCount[aAtoms[i].nGroup]++;` |
|   41006 |  6610 | `		}` |
|  163827 |  6611 | `		for( i = 0; i < nAtoms; i++ ){` |
|   81987 |  6612 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){ bAnyIntersection = 1; break; }` |
|   40987 |  6613 | `		}` |
...
|   81863 |  6616 | `		if( bShortNullable && bAnyIntersection ){` |
...
|       - |  6620 | `		}` |
|  163851 |  6621 | `		for( i = 0; i < nAtoms; i++ ){` |
...
|   82005 |  6625 | `			if( aGroupCount[aAtoms[i].nGroup] >= 2 ){` |
...
|       - |  6647 | `				}` |
|      16 |  6648 | `			}` |
|   82003 |  6649 | `			if( aAtoms[i].nType == UTA_VOID_FLAG ){` |
...
|       - |  6664 | `				}` |
|      75 |  6665 | `			}` |
|   82001 |  6666 | `			if( aAtoms[i].nType == UTA_NEVER_FLAG ){` |
...
|       - |  6683 | `				}` |
|       7 |  6684 | `			}` |
|   81995 |  6685 | `			if( aAtoms[i].nType == UTA_NULL_FLAG ){` |
|      32 |  6686 | `				bExplicitNull = 1;` |
|      18 |  6687 | `			}else{` |
|   81967 |  6688 | `				bHasNonNull = 1;` |
|       - |  6689 | `			}` |
...
|      91 |  6727 | `			}` |
|   40999 |  6728 | `		}` |
|   81851 |  6729 | `		if( !bHasNonNull && bExplicitNull ){` |
...
|   81851 |  6744 | `	if( bShortNullable \|\| bExplicitNull ){` |
|      97 |  6745 | `		*piTypeFlags \|= iNullableFlag;` |
|      46 |  6746 | `	}` |
|       - |  6747 | `	/* Build canonical type text */` |
|   81851 |  6748 | `	if( pTypeText ){` |
|       - |  6749 | `		SyBlob sBlob;` |
|   81851 |  6750 | `		SyBlobInit(&sBlob, &pGen->pVm->sAllocator);` |
|  122742 |  6751 | `		GenBuildUnionTypeText(&sBlob, aAtoms, nAtoms,` |
|   40923 |  6752 | `			(bShortNullable \|\| bExplicitNull) ? 1 : 0);` |
|   81851 |  6753 | `		if( SyBlobLength(&sBlob) > 0 ){` |
|  122528 |  6754 | `			char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|   81682 |  6755 | `				(const char *)SyBlobData(&sBlob), SyBlobLength(&sBlob));` |
|   81687 |  6756 | `			if( zDup ){` |
|   81687 |  6757 | `				SyStringInitFromBuf(pTypeText, zDup, SyBlobLength(&sBlob));` |
|   40841 |  6758 | `			}` |
|   40841 |  6759 | `		}` |
|   81851 |  6760 | `		SyBlobRelease(&sBlob);` |
|   40923 |  6761 | `	}` |
...
|       - |  6765 | `	{` |
|   81851 |  6766 | `		int nNonNull = 0;` |
|   81851 |  6767 | `		int iNonNullIdx = -1;` |
|       - |  6768 | `		int i;` |
|  163831 |  6769 | `		for( i = 0; i < nAtoms; i++ ){` |
|   81985 |  6770 | `			if( aAtoms[i].nType != UTA_NULL_FLAG ){` |
|   81957 |  6771 | `				nNonNull++;` |
|   81957 |  6772 | `				iNonNullIdx = i;` |
|   40976 |  6773 | `			}` |
|   40995 |  6774 | `		}` |
|   81851 |  6775 | `		if( nNonNull <= 1 ){` |
|       - |  6776 | `			/* Fast path: store as single type. */` |
|   81759 |  6777 | `			if( iNonNullIdx >= 0 ){` |
|   81753 |  6778 | `				PhlTypeAtom *pA = &aAtoms[iNonNullIdx];` |
|   81753 |  6779 | `				if( pA->nType == SXU32_HIGH ){` |
|   22310 |  6780 | `					char *zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|    7435 |  6781 | `						pA->sClass.zString, pA->sClass.nByte);` |
|   14875 |  6782 | `					if( zDup == 0 ) return SXERR_ABORT;` |
|   14875 |  6783 | `					*pnType = SXU32_HIGH;` |
|   14875 |  6784 | `					if( pClass ) SyStringInitFromBuf(pClass, zDup, pA->sClass.nByte);` |
|   74318 |  6785 | `				}else if( pA->nType == UTA_VOID_FLAG ){` |
|     155 |  6786 | `					*pnType = MEMOBJ_VOID;` |
|   66808 |  6787 | `				}else if( pA->nType == UTA_NEVER_FLAG ){` |
|      16 |  6788 | `					*pnType = MEMOBJ_NEVER;` |
|       9 |  6789 | `				}else{` |
|   66719 |  6790 | `					*pnType = pA->nType;` |
|       - |  6791 | `				}` |
|   40874 |  6792 | `			}` |
|   40882 |  6793 | `		}else{` |
...
|       - |  6825 | ` */` |
|  326036 |  6826 | `static sxi32 GenStateParseReturnType(ph7_gen_state *pGen, ph7_vm_func *pFunc)` |
|       5 |  6827 | `{` |
|  326041 |  6828 | `	sxi32 iFlags = 0;` |
|       - |  6829 | `	sxi32 rc;` |
|       - |  6830 | `	sxu32 nLine;` |
|  326041 |  6831 | `	pFunc->nReturnType = 0;` |
|  326041 |  6832 | `	SyStringInitFromBuf(&pFunc->sReturnClass, 0, 0);` |
|  326041 |  6833 | `	SyStringInitFromBuf(&pFunc->sReturnTypeName, 0, 0);` |
|  326041 |  6834 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COLON) == 0 ){` |
|  325541 |  6835 | `		return SXRET_OK;` |
|       - |  6836 | `	}` |
...
|  163023 |  6874 | `}` |
|       - |  6875 |  |
|   49182 |  6876 | `static sxi32 GenStateCompileFunc(` |
...
|   49187 |  6890 | `	nLine = pGen->pIn->nLine;` |
|       - |  6891 | `	/* Jump the left parenthesis '(' */` |
|   49187 |  6892 | `	pGen->pIn++;` |
|       - |  6893 | `	/* Delimit the function signature */` |
|   49187 |  6894 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|   49187 |  6895 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  6896 | `		/* Syntax error */` |
...
|   49181 |  6906 | `	pFunc = (ph7_vm_func *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(ph7_vm_func));` |
|   49181 |  6907 | `	if( pFunc == 0 ){` |
|     ! 0 |  6908 | `		goto OutOfMem;` |
|       - |  6909 | `	}` |
|       - |  6910 | `	/* Build the function name, prepending namespace if active */` |
|   49188 |  6911 | `	if( SyBlobLength(&pGen->sNamespace) > 0 && !bHandleClosure ){` |
|       - |  6912 | `		SyBlob sFQN;` |
|       - |  6913 | `		sxu32 nLen;` |
...
|       9 |  6925 | `	}else{` |
|   49167 |  6926 | `		zName = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|   49167 |  6927 | `		if( zName == 0 ){` |
|     ! 0 |  6928 | `			goto OutOfMem;` |
|       - |  6929 | `		}` |
|   49167 |  6930 | `		PH7_VmInitFuncState(pGen->pVm,pFunc,zName,pName->nByte,iFlags,0);` |
|       - |  6931 | `	}` |
|   49181 |  6932 | `	if( pGen->pIn < pEnd ){` |
|       - |  6933 | `		/* Collect function arguments */` |
|   33905 |  6934 | `		rc = GenStateCollectFuncArgs(pFunc,&(*pGen),pEnd,0,0);` |
|   33905 |  6935 | `		if( rc == SXERR_ABORT ){` |
...
|   49181 |  6941 | `	pGen->pIn = &pEnd[1];` |
|       - |  6942 | `	{` |
|   49181 |  6943 | `		sxi32 rcRt = GenStateParseReturnType(pGen, pFunc);` |
|   49181 |  6944 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  6945 | `			return SXERR_ABORT;` |
|   49181 |  6946 | `		}else if( rcRt == SXERR_SYNTAX ){` |
|       8 |  6947 | `			return SXERR_SYNTAX;` |
|       - |  6948 | `		}` |
|       - |  6949 | `	}` |
|   49175 |  6950 | `	if( bHandleClosure ){` |
...
|   49175 |  7043 | `	rc = GenStateCompileFuncBody(&(*pGen),pFunc);` |
|   49175 |  7044 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 |  7045 | `		return SXERR_ABORT;` |
|       - |  7046 | `	}` |
|   49175 |  7047 | `	if( ppFunc ){` |
|     299 |  7048 | `		*ppFunc = pFunc;` |
|     147 |  7049 | `	}` |
|   49175 |  7050 | `	rc = SXRET_OK;` |
|   49175 |  7051 | `	if( (pFunc->iFlags & VM_FUNC_CLOSURE) == 0 ){` |
|       - |  7052 | `		/* Finally register the function */` |
|   49157 |  7053 | `		rc = PH7_VmInstallUserFunction(pGen->pVm,pFunc,0);` |
|   24576 |  7054 | `	}` |
|   49175 |  7055 | `	if( rc == SXRET_OK ){` |
|   49175 |  7056 | `		return SXRET_OK;` |
|       - |  7057 | `	}` |
...
|       - |  7069 | ` */` |
|   48896 |  7070 | `static sxi32 PH7_CompileFunction(ph7_gen_state *pGen)` |
|       5 |  7071 | `{` |
|       - |  7072 | `	SyString *pName;` |
|       - |  7073 | `	sxi32 iFlags;` |
|       - |  7074 | `	sxu32 nLine;` |
|       - |  7075 | `	sxi32 rc;` |
|       - |  7076 |  |
|   48901 |  7077 | `	nLine = pGen->pIn->nLine;` |
|   48901 |  7078 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|   48901 |  7079 | `	iFlags = 0;` |
|   48901 |  7080 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  7081 | `		/* Return by reference,remember that */` |
|       7 |  7082 | `		iFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  7083 | `		/* Jump the '&' token */` |
|       7 |  7084 | `		pGen->pIn++;` |
|       3 |  7085 | `	}` |
|   48901 |  7086 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - |  7097 | `	}` |
|   48895 |  7098 | `	pName = &pGen->pIn->sData;` |
|   48895 |  7099 | `	nLine = pGen->pIn->nLine;` |
|       - |  7100 | `	/* Jump the function name */` |
|   48895 |  7101 | `	pGen->pIn++;` |
|   48895 |  7102 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  7103 | `		/* Syntax error */` |
...
|   48893 |  7116 | `	rc = GenStateCompileFunc(&(*pGen),pName,iFlags,FALSE,0);` |
|   48893 |  7117 | `	return rc;` |
|   24453 |  7118 | `}` |
|       - |  7119 | `/*` |
...
|       - |  7129 | ` */` |
|  354636 |  7130 | `static sxi32 GetProtectionLevel(sxi32 nKeyword)` |
|       5 |  7131 | `{` |
|  354641 |  7132 | `	if( nKeyword == PH7_TKWRD_PRIVATE ){` |
|   22159 |  7133 | `		return PH7_CLASS_PROT_PRIVATE;` |
|  332487 |  7134 | `	}else if( nKeyword == PH7_TKWRD_PROTECTED ){` |
|   47821 |  7135 | `		return PH7_CLASS_PROT_PROTECTED;` |
|       - |  7136 | `	}` |
|       - |  7137 | `	/* Assume public by default */` |
|  284671 |  7138 | `	return PH7_CLASS_PROT_PUBLIC;` |
|  177323 |  7139 | `}` |
|       - |  7140 | `/*` |
...
|       - |  7252 | ` */` |
|   22632 |  7253 | `static int GenStateInitHasNewExpr(ph7_gen_state *pGen)` |
|       5 |  7254 | `{` |
|   22637 |  7255 | `	SyToken *p = pGen->pIn;` |
|   22637 |  7256 | `	int iDepth = 0;` |
|   68111 |  7257 | `	while( p < pGen->pEnd ){` |
|   68111 |  7258 | `		if( iDepth == 0 && (p->nType & (PH7_TK_SEMI\|PH7_TK_COMMA)) ){` |
|   22629 |  7259 | `			break; /* end of this initializer */` |
|       - |  7260 | `		}` |
|   45482 |  7261 | `		if( (p->nType & PH7_TK_KEYWORD)` |
|   22751 |  7262 | `			&& ( SX_PTR_TO_INT(p->pUserData) == PH7_TKWRD_FUNCTION` |
...
|       3 |  7321 | `			continue;` |
|       - |  7322 | `		}` |
|   45485 |  7323 | `		if( p->nType & (PH7_TK_LPAREN\|PH7_TK_OSB\|PH7_TK_OCB) ){` |
|      69 |  7324 | `			iDepth++;` |
|   45453 |  7325 | `		}else if( p->nType & (PH7_TK_RPAREN\|PH7_TK_CSB\|PH7_TK_CCB) ){` |
|      67 |  7326 | `			if( iDepth > 0 ){` |
|      67 |  7327 | `				iDepth--;` |
|      31 |  7328 | `			}` |
|   45390 |  7329 | `		}else if( (p->nType & PH7_TK_OP) && p->pUserData` |
|   22615 |  7330 | `			&& ((const ph7_expr_op *)p->pUserData)->iOp == EXPR_OP_NEW ){` |
...
|      92 |  7457 | `	if( (iTypeFlags & PH7_CLASS_ATTR_TYPED) && !(iTypeFlags & PH7_CLASS_ATTR_UNION)` |
...
|       - |  7570 | ` */` |
|  192170 |  7571 | `static int GenStateLooksLikeTypedProperty(SyToken *pStart,SyToken *pEnd)` |
|       5 |  7572 | `{` |
|  192175 |  7573 | `	SyToken *p = pStart;` |
|  192175 |  7574 | `	int bFirst = 1;` |
|  192175 |  7575 | `	if( p >= pEnd ) return 0;` |
|       - |  7576 | ``	/* Optional nullable `?` shorthand. */`` |
|  192175 |  7577 | `	if( (p->nType & PH7_TK_OP) && p->sData.nByte == 1 && p->sData.zString[0] == '?' ){` |
|      19 |  7578 | `		p++;` |
...
|   96085 |  7585 | `	for(;;){` |
|  192193 |  7586 | `		if( p < pEnd && (p->nType & PH7_TK_LPAREN) ){` |
...
|  192191 |  7595 | `			if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){ p++; }` |
|  192191 |  7596 | `			if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|     ! 0 |  7597 | `				return 0;` |
|       - |  7598 | `			}` |
...
|  192191 |  7602 | `			if( bFirst && (p->nType & PH7_TK_KEYWORD) ){` |
|  192145 |  7603 | `				sxu32 k = (sxu32)(SX_PTR_TO_INT(p->pUserData));` |
|  192140 |  7604 | `				if( k == PH7_TKWRD_FUNCTION \|\| k == PH7_TKWRD_VAR \|\| k == PH7_TKWRD_CONST` |
|   11244 |  7605 | `				 \|\| k == PH7_TKWRD_STATIC \|\| k == PH7_TKWRD_FINAL \|\| k == PH7_TKWRD_ABSTRACT ){` |
|  191991 |  7606 | `					return 0;` |
|       - |  7607 | `				}` |
|      77 |  7608 | `			}` |
|     205 |  7609 | `			p++;` |
...
|       - |  7786 | ` */` |
| 1708420 |  7787 | `static int GenStateIsReadonly(SyToken *pTok)` |
|       5 |  7788 | `{` |
| 1743216 |  7789 | `	return (pTok->nType & PH7_TK_ID)` |
|  889001 |  7790 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1743211 |  7791 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  7792 | `}` |
|   77852 |  7793 | `static sxi32 GenStateCompileClassAttr(ph7_gen_state *pGen,sxi32 iProtection,sxi32 iFlags,ph7_class *pClass)` |
|       5 |  7794 | `{` |
|   77857 |  7795 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - |  7796 | `	ph7_class_attr *pAttr;` |
|       - |  7797 | `	SyString *pName;` |
|       - |  7798 | `	sxi32 rc;` |
|   77857 |  7799 | `	sxu32 nType = 0;` |
|       - |  7800 | `	SyString sTypeClass;` |
|       - |  7801 | `	SyString sTypeText;` |
|       - |  7802 | `	SySet aUnionAlts;` |
|   77857 |  7803 | `	sxi32 iTypeFlags = 0;` |
|   77857 |  7804 | `	SyStringInitFromBuf(&sTypeClass,0,0);` |
|   77857 |  7805 | `	SyStringInitFromBuf(&sTypeText,0,0);` |
|   77857 |  7806 | `	SySetInit(&aUnionAlts,&pGen->pVm->sAllocator,sizeof(ph7_type_alt));` |
...
|   77857 |  7810 | `	if( pClass->iFlags & PH7_CLASS_READONLY ){` |
|      21 |  7811 | `		iFlags \|= PH7_CLASS_ATTR_READONLY;` |
|       9 |  7812 | `	}` |
|       - |  7813 | `	/* Extract visibility level */` |
|   77857 |  7814 | `	iProtection = GetProtectionLevel(iProtection);` |
|       - |  7815 | `	/* Parse optional type hint (typed properties, PHP 7.4+) */` |
|   77949 |  7816 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|      92 |  7832 | `	}` |
|     ! 0 |  7833 | `loop:` |
|   77861 |  7834 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 ){` |
...
|       - |  7840 | `	}` |
|   77861 |  7841 | `	pGen->pIn++; /* Jump the dollar sign */` |
|   77861 |  7842 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_ID)) == 0 ){` |
...
|   77861 |  7852 | `	pName = &pGen->pIn->sData;` |
|       - |  7853 | `	/* Advance the stream cursor */` |
|   77861 |  7854 | `	pGen->pIn++;` |
|   77861 |  7855 | `	if(pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_EQUAL/*'='*/\|PH7_TK_SEMI/*';'*/\|PH7_TK_COMMA/*','*/)) == 0 ){` |
...
|   77859 |  7866 | `	if( iFlags & PH7_CLASS_ATTR_READONLY ){` |
...
|   77849 |  7886 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
...
|   77849 |  7898 | `	if( PH7_ClassExtractAttribute(pClass,pName->zString,pName->nByte) != 0 ){` |
...
|   77847 |  7912 | `	if( (pGen->pIn->nType & PH7_TK_EQUAL /*'='*/) && GenStateInitHasNewExpr(pGen) ){` |
...
|   77843 |  7921 | `	pAttr = PH7_NewClassAttr(pGen->pVm,pName,nLine,iProtection,iFlags\|iTypeFlags);` |
|   77843 |  7922 | `	if( pAttr == 0 ){` |
|     ! 0 |  7923 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 engine is running out of memory");` |
|     ! 0 |  7924 | `		return SXERR_ABORT;` |
|       - |  7925 | `	}` |
|   77843 |  7926 | `	if( iTypeFlags & PH7_CLASS_ATTR_TYPED ){` |
|     185 |  7927 | `		GenStateCopyTypeToAttr(pAttr,nType,&sTypeClass,&sTypeText,iTypeFlags,&aUnionAlts);` |
|      90 |  7928 | `	}` |
|   77843 |  7929 | `	if( pGen->pIn->nType & PH7_TK_EQUAL /*'='*/ ){` |
|       - |  7930 | `		SySet *pInstrContainer;` |
|   22545 |  7931 | `		pGen->pIn++; /*Jump the equal sign */` |
|       - |  7932 | `		/* Swap bytecode container */` |
|   22545 |  7933 | `		pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|   22545 |  7934 | `		PH7_VmSetByteCodeContainer(pGen->pVm,&pAttr->aByteCode);` |
|       - |  7935 | `		/* Compile attribute value.` |
|       - |  7936 | `		 */` |
|   22545 |  7937 | `		rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_COMMA_STATEMENT,0);` |
|   22545 |  7938 | `		if( rc == SXERR_EMPTY ){` |
...
|   22545 |  7945 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,1,0,0,0);` |
|   22545 |  7946 | `		PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|   11270 |  7947 | `	}` |
|       - |  7948 | `	/* All done,install the attribute */` |
|   77843 |  7949 | `	rc = PH7_ClassInstallAttr(pClass,pAttr);` |
|   77843 |  7950 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  7951 | `		PH7_GenCompileError(pGen,E_ERROR,nLine,"Fatal, PH7 is running out of memory");` |
|     ! 0 |  7952 | `		return SXERR_ABORT;` |
|       - |  7953 | `	}` |
|   77843 |  7954 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA /*','*/) ){` |
...
|       - |  7972 | `		}` |
|     ! 0 |  7973 | `	}` |
|   77839 |  7974 | `	SySetRelease(&aUnionAlts);` |
|   77839 |  7975 | `	return SXRET_OK;` |
|       9 |  7976 | `Synchronize:` |
...
|       - |  7991 | ` */` |
|  276692 |  7992 | `static sxi32 GenStateCompileClassMethod(` |
...
|       - |  7998 | `	)` |
|       5 |  7999 | `{` |
|  276697 |  8000 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  276697 |  8007 | `	iProtection = GetProtectionLevel(iProtection);` |
|  276697 |  8008 | `	pGen->pIn++; /* Jump the 'function' keyword */` |
|  276697 |  8009 | `	iFuncFlags = 0;` |
|  276697 |  8010 | `	if( pGen->pIn >= pGen->pEnd ){` |
...
|       - |  8018 | `	}` |
|  276697 |  8019 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_AMPER) ){` |
|       - |  8020 | `		/* Return by reference,remember that */` |
|     ! 0 |  8021 | `		iFuncFlags \|= VM_FUNC_REF_RETURN;` |
|       - |  8022 | `		/* Jump the '&' token */` |
|     ! 0 |  8023 | `		pGen->pIn++;` |
|     ! 0 |  8024 | `	}` |
|  276697 |  8025 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|  276697 |  8034 | `	pName = &pGen->pIn->sData;` |
|  276697 |  8035 | `	nLine = pGen->pIn->nLine;` |
|       - |  8036 | `	/* Jump the method name */` |
|  276697 |  8037 | `	pGen->pIn++;` |
|  276697 |  8038 | `	if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       - |  8039 | `		/* Abstract method */` |
|   95587 |  8040 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   95587 |  8049 | `		doBody = FALSE;` |
|   47791 |  8050 | `	}` |
|  276697 |  8051 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  8052 | `		/* Syntax error */` |
...
|  276697 |  8061 | `	pMeth = PH7_NewClassMethod(pGen->pVm,pClass,pName,nLine,iProtection,iFlags,iFuncFlags);` |
|  276697 |  8062 | `	if( pMeth == 0 ){` |
...
|  276697 |  8067 | `	pGen->pIn++;` |
|  276697 |  8068 | `	pEnd = 0; /* cc warning */` |
|       - |  8069 | `	/* Delimit the method signature */` |
|  276697 |  8070 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  276697 |  8071 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8072 | `		/* Syntax error */` |
...
|       - |  8079 | `	}` |
|       - |  8080 | `	{` |
|  276695 |  8081 | `		int bIsCtor = 0;` |
|  276695 |  8082 | `		int bAbstractCtor = 0;` |
|  276690 |  8083 | `		if( (pName->nByte == sizeof("__construct") - 1` |
|  164189 |  8084 | `				&& SyMemcmp(pName->zString,"__construct",sizeof("__construct") - 1) == 0)` |
|  265591 |  8085 | `		 \|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
|   22213 |  8086 | `			if( iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|       3 |  8087 | `				bAbstractCtor = 1;` |
|       2 |  8088 | `			}else{` |
|   22211 |  8089 | `				bIsCtor = 1;` |
|       - |  8090 | `			}` |
|   11104 |  8091 | `		}` |
|  276695 |  8092 | `		if( pGen->pIn < pEnd ){` |
|       - |  8093 | `			/* Collect method arguments */` |
|   73955 |  8094 | `			rc = GenStateCollectFuncArgs(&pMeth->sFunc,&(*pGen),pEnd,bIsCtor,bAbstractCtor);` |
|   73955 |  8095 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  8096 | `				return SXERR_ABORT;` |
|       - |  8097 | `			}` |
|   36975 |  8098 | `		}` |
|       - |  8099 | `	}` |
|       - |  8100 | `	/* Point past ')' and parse optional return type ': type' */` |
|  276695 |  8101 | `	pGen->pIn = &pEnd[1];` |
|       - |  8102 | `	{` |
|  276695 |  8103 | `		sxi32 rcRt = GenStateParseReturnType(pGen, &pMeth->sFunc);` |
|  276695 |  8104 | `		if( rcRt == SXERR_ABORT ){` |
|     ! 0 |  8105 | `			return SXERR_ABORT;` |
|  276695 |  8106 | `		}else if( rcRt == SXERR_SYNTAX ){` |
...
|       - |  8113 | `	{` |
|  276695 |  8114 | `		sxu32 nArg = SySetUsed(&pMeth->sFunc.aArgs);` |
|       - |  8115 | `		sxu32 i;` |
|  402191 |  8116 | `		for( i = 0; i < nArg; i++ ){` |
|  125511 |  8117 | `			ph7_vm_func_arg *pArg = (ph7_vm_func_arg *)SySetAt(&pMeth->sFunc.aArgs,i);` |
|       - |  8118 | `			ph7_class_attr *pAttr;` |
|  125511 |  8119 | `			sxi32 iAttrFlags = 0;` |
|       - |  8120 | `			int bArgTyped;` |
|  125511 |  8121 | `			if( (pArg->iFlags & VM_FUNC_ARG_PROMOTED) == 0 ){` |
|  125447 |  8122 | `				continue;` |
|       - |  8123 | `			}` |
...
|      32 |  8204 | `		}` |
|       - |  8205 | `	}` |
|  276685 |  8206 | `	if( doBody ){` |
|       - |  8207 | `		/* Compile method body */` |
|  181103 |  8208 | `		rc = GenStateCompileFuncBody(&(*pGen),&pMeth->sFunc);` |
|  181103 |  8209 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  8210 | `			return SXERR_ABORT;` |
|       - |  8211 | `		}` |
|   90554 |  8212 | `	}else{` |
|       - |  8213 | `		/* Only method signature is allowed */` |
|   95587 |  8214 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI /* ';'*/) == 0 ){` |
...
|       - |  8247 | ` */` |
|   40498 |  8248 | `static sxi32 PH7_CompileClassInterface(ph7_gen_state *pGen)` |
|       5 |  8249 | `{` |
|   40503 |  8250 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|   40503 |  8259 | `	pName = &pGen->pIn->sData;` |
|       - |  8260 | `	/* Advance the stream cursor */` |
|   40503 |  8261 | `	pGen->pIn++;` |
|       - |  8262 | `	/* Build FQN and obtain a raw class */ {` |
|       - |  8263 | `		SyBlob sFQN;` |
|       - |  8264 | `		SyString sFQNStr;` |
|   40503 |  8265 | `		SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|   40503 |  8266 | `		GenStateBuildFQN(pGen,pName,&sFQN);` |
|   40503 |  8267 | `		SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|   40503 |  8268 | `		pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|   40503 |  8269 | `		SyBlobRelease(&sFQN);` |
|       - |  8270 | `	}` |
|   40503 |  8271 | `	if( pClass == 0 ){` |
...
|   40503 |  8276 | `	pClass->iFlags = PH7_CLASS_INTERFACE;` |
|       - |  8277 | `	/* Assume no base class is given */` |
|   40503 |  8278 | `	pBase = 0;` |
|   40503 |  8279 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   11035 |  8280 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   11035 |  8281 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* interface b extends a */ ){` |
|       - |  8282 | `			SyBlob sResolved;` |
|       - |  8283 | `			SyString sBaseName;` |
|       - |  8284 | `			sxu32 nRefLine;` |
|       - |  8285 | `			/* Extract base interface */` |
|   11035 |  8286 | `			pGen->pIn++;` |
|   11035 |  8287 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   11035 |  8288 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   11035 |  8289 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8299 | `			}` |
|   16550 |  8300 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   11030 |  8301 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   11035 |  8302 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8303 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8304 | `			/* Only interfaces is allowed */` |
|   11035 |  8305 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  8306 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8307 | `			}` |
|   11035 |  8308 | `			if( pBase == 0 ){` |
...
|       - |  8314 | `				}` |
|     ! 0 |  8315 | `			}` |
|   11035 |  8316 | `			SyBlobRelease(&sResolved);` |
|    5515 |  8317 | `		}` |
|    5515 |  8318 | `	}` |
|   40503 |  8319 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  8320 | `		/* Syntax error */` |
...
|       - |  8328 | `	}` |
|   40503 |  8329 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|   40503 |  8330 | `	pEnd = 0; /* cc warning */` |
|       - |  8331 | `	/* Delimit the interface body */` |
|   40503 |  8332 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|   40503 |  8333 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  8334 | `		/* Syntax error */` |
...
|   40503 |  8344 | `	pTmp = pGen->pEnd;` |
|   40503 |  8345 | `	pGen->pEnd = pEnd;` |
...
|  231647 |  8353 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   95577 |  8354 | `			pGen->pIn++;` |
|       5 |  8355 | `		}` |
|  136075 |  8356 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  8357 | `			/* End of interface body */` |
|   40499 |  8358 | `			break;` |
|       - |  8359 | `		}` |
|   95581 |  8360 | `		if( (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|   95581 |  8371 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   95581 |  8372 | `		if( nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|       3 |  8401 | `			goto done;` |
|       - |  8402 | `		}` |
|   95579 |  8403 | `		if( nKwrd != PH7_TKWRD_PUBLIC && nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|     ! 0 |  8410 | `			goto done;` |
|       - |  8411 | `		}` |
|   95579 |  8412 | `		if( nKwrd == PH7_TKWRD_PUBLIC ){` |
|       - |  8413 | `			/* Advance the stream cursor */` |
|   95567 |  8414 | `			pGen->pIn++;` |
|   95567 |  8415 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
...
|     ! 0 |  8422 | `				goto done;` |
|       - |  8423 | `			}` |
|   95567 |  8424 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   95567 |  8425 | `			if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_CONST && nKwrd != PH7_TKWRD_STATIC ){` |
...
|       - |  8433 | `			}` |
|   47781 |  8434 | `		}` |
|   95579 |  8435 | `		if( nKwrd == PH7_TKWRD_CONST ){` |
|       - |  8436 | `			/* Parse constant */` |
...
|       - |  8443 | `			}` |
|       4 |  8444 | `		}else{` |
|   95571 |  8445 | `			sxi32 iFlags = PH7_CLASS_ATTR_ABSTRACT; /* Interface methods are implicitly abstract */` |
|   95571 |  8446 | `			if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  8447 | `				/* Static method,record that */` |
|   11027 |  8448 | `				iFlags \|= PH7_CLASS_ATTR_STATIC;` |
|       - |  8449 | `				/* Advance the stream cursor */` |
|   11027 |  8450 | `				pGen->pIn++;` |
|   11022 |  8451 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|   11027 |  8452 | `					\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_FUNCTION ){` |
...
|   95571 |  8463 | `			rc = GenStateCompileClassMethod(&(*pGen),0,iFlags,FALSE,pClass);` |
|   95571 |  8464 | `			if( rc != SXRET_OK ){` |
...
|   40499 |  8473 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|   40499 |  8474 | `	if( rc == SXRET_OK && pBase ){` |
|       - |  8475 | `		/* Inherit from the base interface */` |
|   11035 |  8476 | `		rc = PH7_ClassInterfaceInherit(pClass,pBase);` |
|    5515 |  8477 | `	}` |
|   40499 |  8478 | `	if( rc != SXRET_OK ){` |
...
|   40503 |  8484 | `	pGen->pIn  = &pEnd[1];` |
|   40503 |  8485 | `	pGen->pEnd = pTmp;` |
|   40503 |  8486 | `	return PH7_OK;` |
|   20254 |  8487 | `}` |
|       - |  8488 | `/*` |
...
|       - |  8512 | ` */` |
|  107806 |  8513 | `static sxi32 GenStateCheckInterfaceSignatures(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8514 | `{` |
|       - |  8515 | `	ph7_class **apIface;` |
|       - |  8516 | `	sxu32 nIface,i;` |
|       - |  8517 | `	sxi32 rc;` |
|  107811 |  8518 | `	if( pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|     ! 0 |  8519 | `		return SXRET_OK;` |
|       - |  8520 | `	}` |
|  107811 |  8521 | `	apIface = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|  107811 |  8522 | `	nIface = SySetUsed(&pClass->aInterface);` |
|  207263 |  8523 | `	for(i = 0; i < nIface; i++){` |
|   99457 |  8524 | `		ph7_class *pIface = apIface[i];` |
|       - |  8525 | `		SyHashEntry *pEntry;` |
|   99457 |  8526 | `		SyHashResetLoopCursor(&pIface->hMethod);` |
|  265241 |  8527 | `		while((pEntry = SyHashGetNextEntry(&pIface->hMethod)) != 0 ){` |
|  165789 |  8528 | `			ph7_class_method *pIfaceMeth = (ph7_class_method *)pEntry->pUserData;` |
|       - |  8529 | `			ph7_class_method *pImplMeth;` |
|  165789 |  8530 | `			SyString *pMName = &pIfaceMeth->sFunc.sName;` |
|       - |  8531 | `			/* Find the implementing method in the class */` |
|  165789 |  8532 | `			pImplMeth = PH7_ClassExtractMethod(pClass,pMName->zString,pMName->nByte);` |
|  165789 |  8533 | `			if( pImplMeth == 0 \|\| (pImplMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
...
|  165775 |  8537 | `			if( pImplMeth->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|       - |  8547 | `			 */` |
|       - |  8548 | `			{` |
|  165775 |  8549 | `				sxu32 nIfaceArgs = SySetUsed(&pIfaceMeth->sFunc.aArgs);` |
|  165775 |  8550 | `				sxu32 nImplArgs = SySetUsed(&pImplMeth->sFunc.aArgs);` |
|  165775 |  8551 | `				int sigError = 0;` |
|  165775 |  8552 | `				if( nImplArgs < nIfaceArgs ){` |
|       3 |  8553 | `					sigError = 1;` |
|  165774 |  8554 | `				}else if( nImplArgs > nIfaceArgs ){` |
...
|       - |  8605 | ` */` |
|  107806 |  8606 | `static sxi32 GenStateCheckAbstractMethods(ph7_gen_state *pGen,ph7_class *pClass)` |
|       5 |  8607 | `{` |
...
|  107811 |  8614 | `	if( pClass->iFlags & (PH7_CLASS_ABSTRACT\|PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT) ){` |
|      37 |  8615 | `		return SXRET_OK;` |
|       - |  8616 | `	}` |
|       - |  8617 | `	/* Count abstract methods */` |
|  107779 |  8618 | `	nAbstract = 0;` |
|  107779 |  8619 | `	SyHashResetLoopCursor(&pClass->hMethod);` |
| 1013315 |  8620 | `	while((pEntry = SyHashGetNextEntry(&pClass->hMethod)) != 0 ){` |
|  905541 |  8621 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  905541 |  8622 | `		if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
|      20 |  8623 | `			nAbstract++;` |
|       8 |  8624 | `		}` |
|       5 |  8625 | `	}` |
|  107779 |  8626 | `	if( nAbstract == 0 ){` |
|  107765 |  8627 | `		return SXRET_OK;` |
|       - |  8628 | `	}` |
...
|       - |  8761 | ` */` |
|  103920 |  8762 | `static sxi32 GenStateParseClassReference(ph7_gen_state *pGen,SyBlob *pFqn)` |
|       5 |  8763 | `{` |
|  103925 |  8764 | `	int isAbsolute = 0;` |
|  103925 |  8765 | `	SyToken *pStart = pGen->pIn;` |
|       - |  8766 | `	SyBlob sName;` |
|  103925 |  8767 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) ){` |
|    3785 |  8768 | `		isAbsolute = 1;` |
|    3785 |  8769 | `		pGen->pIn++;` |
|    1890 |  8770 | `	}` |
|  103925 |  8771 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|       9 |  8772 | `		pGen->pIn = pStart;` |
|       9 |  8773 | `		return SXERR_INVALID;` |
|       - |  8774 | `	}` |
|  103919 |  8775 | `	SyBlobInit(&sName,&pGen->pVm->sAllocator);` |
|  103919 |  8776 | `	SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|  103919 |  8777 | `	pGen->pIn++;` |
|  155892 |  8778 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_NSSEP) &&` |
|   51983 |  8779 | `		&pGen->pIn[1] < pGen->pEnd && (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) ){` |
|      16 |  8780 | `		SyBlobAppend(&sName,"\\",1);` |
|      16 |  8781 | `		pGen->pIn++;` |
|      16 |  8782 | `		SyBlobAppend(&sName,pGen->pIn->sData.zString,pGen->pIn->sData.nByte);` |
|      16 |  8783 | `		pGen->pIn++;` |
|       2 |  8784 | `	}` |
|  103919 |  8785 | `	if( isAbsolute ){` |
|    3783 |  8786 | `		SyBlobAppend(pFqn,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|    1894 |  8787 | `	}else{` |
|       - |  8788 | `		SyString sRaw;` |
|  100141 |  8789 | `		SyStringInitFromBuf(&sRaw,(const char *)SyBlobData(&sName),SyBlobLength(&sName));` |
|  100141 |  8790 | `		GenStateResolveName(pGen,&sRaw,pFqn);` |
|       - |  8791 | `	}` |
|  103919 |  8792 | `	SyBlobRelease(&sName);` |
|  103919 |  8793 | `	return SXRET_OK;` |
|   51965 |  8794 | `}` |
|       - |  8795 | `/*` |
...
|   11194 |  8803 | `static int GenStateInterfaceIsThrowableAt(ph7_class *pInterface,int iDepth)` |
|       5 |  8804 | `{` |
|       - |  8805 | `	ph7_class **apParent;` |
|       - |  8806 | `	sxu32 n;` |
|   18751 |  8807 | `	while( pInterface ){` |
|   14915 |  8808 | `		if( iDepth > PH7_THROWABLE_WALK_MAX_DEPTH ){` |
|     ! 0 |  8809 | `			return FALSE;` |
|       - |  8810 | `		}` |
|   18603 |  8811 | `		if( pInterface->sName.nByte == sizeof("Throwable")-1 &&` |
|    7376 |  8812 | `			SyMemcmp(pInterface->sName.zString,"Throwable",sizeof("Throwable")-1) == 0 ){` |
|    7363 |  8813 | `			return TRUE;` |
|       - |  8814 | `		}` |
|    7557 |  8815 | `		apParent = (ph7_class **)SySetBasePtr(&pInterface->aInterface);` |
|    7557 |  8816 | `		for( n = 0 ; n < SySetUsed(&pInterface->aInterface) ; ++n ){` |
|     ! 0 |  8817 | `			if( GenStateInterfaceIsThrowableAt(apParent[n],iDepth+1) ){` |
|     ! 0 |  8818 | `				return TRUE;` |
|       - |  8819 | `			}` |
|     ! 0 |  8820 | `		}` |
|    7557 |  8821 | `		pInterface = pInterface->pBase;` |
|    7557 |  8822 | `		iDepth++;` |
|       5 |  8823 | `	}` |
|    3841 |  8824 | `	return FALSE;` |
|    5602 |  8825 | `}` |
|   11194 |  8826 | `static int GenStateInterfaceIsThrowable(ph7_class *pInterface)` |
|       5 |  8827 | `{` |
|   11199 |  8828 | `	return GenStateInterfaceIsThrowableAt(pInterface,0);` |
|       5 |  8829 | `}` |
|       - |  8830 | `/*` |
...
|       - |  8834 | ` */` |
|    7358 |  8835 | `static int GenStateClassIsExceptionOrError(ph7_class *pBase)` |
|       5 |  8836 | `{` |
|    7367 |  8837 | `	while( pBase ){` |
...
|       - |  8859 | ` */` |
|  107846 |  8860 | `static sxi32 GenStateCompileClassEx(ph7_gen_state *pGen,sxi32 iFlags,` |
|       - |  8861 | `	SyString *pAnonName,SyToken **ppArgStart,SyToken **ppArgEnd)` |
|       5 |  8862 | `{` |
|  107851 |  8863 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|  107851 |  8874 | `	pGen->pIn++;` |
|  107851 |  8875 | `	if( pAnonName ){` |
...
|      17 |  8890 | `	}else{` |
|  107825 |  8891 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_ID) == 0 ){` |
|       - |  8892 | `			/* Syntax error */` |
...
|  107825 |  8905 | `		pName = &pGen->pIn->sData;` |
|       - |  8906 | `		/* Advance the stream cursor */` |
|  107825 |  8907 | `		pGen->pIn++;` |
|       - |  8908 | `		/* Build FQN and obtain a raw class */ {` |
|       - |  8909 | `			SyBlob sFQN;` |
|       - |  8910 | `			SyString sFQNStr;` |
|  107825 |  8911 | `			SyBlobInit(&sFQN,&pGen->pVm->sAllocator);` |
|  107825 |  8912 | `			GenStateBuildFQN(pGen,pName,&sFQN);` |
|  107825 |  8913 | `			SyStringInitFromBuf(&sFQNStr,(const char *)SyBlobData(&sFQN),SyBlobLength(&sFQN));` |
|  107825 |  8914 | `			pClass = PH7_NewRawClass(pGen->pVm,&sFQNStr,nLine);` |
|  107825 |  8915 | `			SyBlobRelease(&sFQN);` |
|       - |  8916 | `		}` |
|       - |  8917 | `	}` |
|  107851 |  8918 | `	if( pClass == 0 ){` |
...
|  107851 |  8923 | `	SySetInit(&aInterfaces,&pGen->pVm->sAllocator,sizeof(ph7_class *));` |
|  107851 |  8924 | `	SySetInit(&aUseEntries,&pGen->pVm->sAllocator,sizeof(TraitUseEntry));` |
|       - |  8925 | `	/* Assume a standalone class */` |
|  107851 |  8926 | `	pBase = 0;` |
|  107851 |  8927 | `	if( pGen->pIn < pGen->pEnd  && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|   92199 |  8928 | `		nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   92199 |  8929 | `		if( nKwrd == PH7_TKWRD_EXTENDS /* class b extends a */ ){` |
|       - |  8930 | `			SyBlob sResolved;` |
|       - |  8931 | `			SyString sBaseName;` |
|       - |  8932 | `			sxu32 nRefLine;` |
|   81023 |  8933 | `			pGen->pIn++; /* Advance past 'extends' */` |
|   81023 |  8934 | `			nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   81023 |  8935 | `			SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   81023 |  8936 | `			if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|       - |  8946 | `			}` |
|  121529 |  8947 | `			pBase = PH7_VmExtractClass(pGen->pVm,` |
|   81016 |  8948 | `				(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   81021 |  8949 | `			SyStringInitFromBuf(&sBaseName,` |
|       - |  8950 | `				(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8951 | `			/* Interfaces are not allowed */` |
|   81021 |  8952 | `			while( pBase && (pBase->iFlags & PH7_CLASS_INTERFACE) ){` |
|     ! 0 |  8953 | `				pBase = pBase->pNextName;` |
|     ! 0 |  8954 | `			}` |
|   81021 |  8955 | `			if( pBase == 0 ){` |
...
|       - |  8961 | `				}` |
|     ! 0 |  8962 | `			}else{` |
|   81021 |  8963 | `				if( pBase->iFlags & PH7_CLASS_FINAL ){` |
...
|     ! 0 |  8970 | `				}` |
|       - |  8971 | `			}` |
|   81021 |  8972 | `			SyBlobRelease(&sResolved);` |
|   40508 |  8973 | `		}` |
|   92197 |  8974 | `		if (pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) && SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_IMPLEMENTS ){` |
|       - |  8975 | `			ph7_class *pInterface;` |
|       - |  8976 | `			/* Interface implementation */` |
|   11189 |  8977 | `			pGen->pIn++; /* Advance the stream cursor */` |
|    5602 |  8978 | `			for(;;){` |
|       - |  8979 | `				SyBlob sResolved;` |
|       - |  8980 | `				SyString sIntName;` |
|       - |  8981 | `				sxu32 nRefLine;` |
|   11199 |  8982 | `				nRefLine = (pGen->pIn < pGen->pEnd) ? pGen->pIn->nLine : nLine;` |
|   11199 |  8983 | `				SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|   11199 |  8984 | `				if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     ! 0 |  8992 | `					break;` |
|       - |  8993 | `				}` |
|   22393 |  8994 | `				pInterface = PH7_VmExtractClass(pGen->pVm,` |
|   11194 |  8995 | `					(const char *)SyBlobData(&sResolved),(sxu32)SyBlobLength(&sResolved),FALSE,0);` |
|   11199 |  8996 | `				SyStringInitFromBuf(&sIntName,` |
|       - |  8997 | `					(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|       - |  8998 | `				/* Only interfaces are allowed */` |
|   11199 |  8999 | `				while( pInterface && (pInterface->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|     ! 0 |  9000 | `					pInterface = pInterface->pNextName;` |
|     ! 0 |  9001 | `				}` |
|   11199 |  9002 | `				if( pInterface == 0 ){` |
...
|   11199 |  9016 | `					SyString *pFqn = &pClass->sName;` |
|   11199 |  9017 | `					int bIsExceptionOrError =` |
|    9275 |  9018 | `						(pFqn->nByte == sizeof("Exception")-1 &&` |
|   18632 |  9019 | `						 SyMemcmp(pFqn->zString,"Exception",sizeof("Exception")-1) == 0) \|\|` |
|    9364 |  9020 | `						(pFqn->nByte == sizeof("Error")-1 &&` |
|    3688 |  9021 | `						 SyMemcmp(pFqn->zString,"Error",sizeof("Error")-1) == 0);` |
|   14873 |  9022 | `					if( GenStateInterfaceIsThrowable(pInterface) &&` |
|   11040 |  9023 | `						!GenStateClassIsExceptionOrError(pBase) &&` |
|    3677 |  9024 | `						!bIsExceptionOrError ){` |
...
|       6 |  9034 | `					}else{` |
|   11193 |  9035 | `						SySetPut(&aInterfaces,(const void *)&pInterface);` |
|       - |  9036 | `					}` |
|       - |  9037 | `				}` |
|   11199 |  9038 | `				SyBlobRelease(&sResolved);` |
|   11199 |  9039 | `				if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_COMMA) == 0 ){` |
|    5597 |  9040 | `					break;` |
|       - |  9041 | `				}` |
...
|    5592 |  9044 | `		}` |
|   46096 |  9045 | `	}` |
|  107849 |  9046 | `	if( pGen->pIn >= pGen->pEnd  \|\| (pGen->pIn->nType & PH7_TK_OCB /*'{'*/) == 0 ){` |
|       - |  9047 | `		/* Syntax error */` |
...
|       - |  9055 | `	}` |
|  107849 |  9056 | `	pGen->pIn++; /* Jump the leading curly brace */` |
|  107849 |  9057 | `	pEnd = 0; /* cc warning */` |
|       - |  9058 | `	/* Delimit the class body */` |
|  107849 |  9059 | `	PH7_DelimitNestedTokens(pGen->pIn,pGen->pEnd,PH7_TK_OCB/*'{'*/,PH7_TK_CCB/*'}'*/,&pEnd);` |
|  107849 |  9060 | `	if( pEnd >= pGen->pEnd ){` |
|       - |  9061 | `		/* Syntax error */` |
...
|  107849 |  9071 | `	pTmp = pGen->pEnd;` |
|  107849 |  9072 | `	pGen->pEnd = pEnd;` |
|       - |  9073 | `	/* Set the inherited flags */` |
|  107849 |  9074 | `	pClass->iFlags = iFlags;` |
|       - |  9075 | `	/* Start the parse process */` |
|  144483 |  9076 | `	for(;;){` |
|       - |  9077 | `		/* Jump leading/trailing semi-colons */` |
|  444793 |  9078 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI/*';'*/) ){` |
|   77953 |  9079 | `			pGen->pIn++;` |
|       5 |  9080 | `		}` |
|  366845 |  9081 | `		if( pGen->pIn >= pGen->pEnd ){` |
|       - |  9082 | `			/* End of class body */` |
|  107811 |  9083 | `			break;` |
|       - |  9084 | `		}` |
|  259034 |  9085 | `		if( (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR)) == 0` |
|  129522 |  9086 | ``			&& !GenStateIsReadonly(pGen->pIn) /* allow a leading `readonly` modifier */ ){`` |
...
|  259039 |  9097 | `		iProtection = PH7_TKWRD_PUBLIC;` |
|  259039 |  9098 | `		iAttrflags = 0;` |
...
|  259039 |  9103 | `		if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  9104 | `			int bMod = 0;` |
...
|       - |  9125 | `			}` |
|     ! 0 |  9126 | `		}` |
|  259039 |  9127 | `		if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  9128 | `			/* Extract the current keyword */` |
|  259039 |  9129 | `			nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  259039 |  9130 | `			if( nKwrd == PH7_TKWRD_USE ){` |
...
|      57 |  9190 | `				continue;` |
|       - |  9191 | `			}` |
|  258987 |  9192 | `			if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|  258681 |  9193 | `				iProtection = nKwrd;` |
|  258681 |  9194 | `				pGen->pIn++; /* Jump the visibility token */` |
|       - |  9195 | ``				/* Optional `readonly` after the visibility: `public readonly int $x`. */`` |
|  258681 |  9196 | `				if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|      20 |  9197 | `					iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|      20 |  9198 | `					pGen->pIn++; /* Jump the 'readonly' modifier */` |
|       8 |  9199 | `				}` |
|  258676 |  9200 | `				if( pGen->pIn >= pGen->pEnd` |
|  258681 |  9201 | `					\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|     ! 0 |  9209 | `					goto done;` |
|       - |  9210 | `				}` |
|  258681 |  9211 | `				if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
|       - |  9212 | `					/* Attribute declaration (untyped) */` |
|   77647 |  9213 | `					rc = GenStateCompileClassAttr(&(*pGen),iProtection,iAttrflags,pClass);` |
|   77647 |  9214 | `					if( rc != SXRET_OK ){` |
...
|   77639 |  9220 | `					continue;` |
|       - |  9221 | `				}` |
|  181039 |  9222 | `				if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|  180871 |  9234 | `				nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   90433 |  9235 | `			}` |
|  181177 |  9236 | `			if( nKwrd == PH7_TKWRD_CONST ){` |
...
|       - |  9244 | `				}` |
|      38 |  9245 | `			}else{` |
|  181103 |  9246 | `				if( nKwrd == PH7_TKWRD_STATIC ){` |
|       - |  9247 | `					/* Static method or attribute,record that */` |
|   11089 |  9248 | `					iAttrflags \|= PH7_CLASS_ATTR_STATIC;` |
|   11089 |  9249 | `					pGen->pIn++; /* Jump the static keyword */` |
|   11089 |  9250 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  9251 | `						/* Extract the keyword */` |
|   11079 |  9252 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|   11079 |  9253 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
...
|   11089 |  9261 | `					if( pGen->pIn < pGen->pEnd && GenStateIsReadonly(pGen->pIn) ){` |
|     ! 0 |  9262 | `						iAttrflags \|= PH7_CLASS_ATTR_READONLY;` |
|     ! 0 |  9263 | `						pGen->pIn++; /* Jump the 'readonly' modifier */` |
|     ! 0 |  9264 | `					}` |
|   11084 |  9265 | `					if( pGen->pIn >= pGen->pEnd` |
|   11089 |  9266 | `						\|\| (pGen->pIn->nType & (PH7_TK_KEYWORD\|PH7_TK_DOLLAR\|PH7_TK_ID\|PH7_TK_OP\|PH7_TK_NSSEP\|PH7_TK_LPAREN)) == 0 ){` |
...
|     ! 0 |  9274 | `						goto done;` |
|       - |  9275 | `					}` |
|   11089 |  9276 | `					if( pGen->pIn->nType & PH7_TK_DOLLAR ){` |
...
|       8 |  9285 | `						continue;` |
|       - |  9286 | `					}` |
|   11081 |  9287 | `					if( GenStateLooksLikeTypedProperty(pGen->pIn,pGen->pEnd) ){` |
...
|   11069 |  9299 | `					nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  175551 |  9300 | `				}else if( nKwrd == PH7_TKWRD_ABSTRACT ){` |
...
|  170013 |  9332 | `				}else if( nKwrd == PH7_TKWRD_FINAL ){` |
|       - |  9333 | `					/* final method ,record that */` |
|      17 |  9334 | `					iAttrflags \|= PH7_CLASS_ATTR_FINAL;` |
|      17 |  9335 | `					pGen->pIn++; /* Jump the final keyword */` |
|      17 |  9336 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) ){` |
|       - |  9337 | `						/* Extract the keyword */` |
|      17 |  9338 | `						nKwrd = SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|      17 |  9339 | `						if( nKwrd == PH7_TKWRD_PUBLIC \|\| nKwrd == PH7_TKWRD_PRIVATE \|\| nKwrd == PH7_TKWRD_PROTECTED ){` |
|       9 |  9340 | `							iProtection = nKwrd;` |
|       9 |  9341 | `							pGen->pIn++; /* Jump the visibility token */` |
|       3 |  9342 | `						}` |
|       7 |  9343 | `					}` |
|      17 |  9344 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|      12 |  9356 | `							continue;` |
|       - |  9357 | `					}` |
|       6 |  9358 | `					if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|     ! 0 |  9363 | `					}` |
|       6 |  9364 | `					if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 \|\|` |
...
|     ! 0 |  9373 | `							goto done;` |
|       - |  9374 | `					}` |
|       6 |  9375 | `					nKwrd = PH7_TKWRD_FUNCTION;` |
|       2 |  9376 | `				}` |
|  181073 |  9377 | `				if( nKwrd != PH7_TKWRD_FUNCTION && nKwrd != PH7_TKWRD_VAR ){` |
...
|     ! 0 |  9385 | `						goto done;` |
|       - |  9386 | `				}` |
|  181073 |  9387 | `				if( nKwrd == PH7_TKWRD_VAR ){` |
...
|  181067 |  9402 | `					rc = GenStateCompileClassMethod(&(*pGen),iProtection,iAttrflags,TRUE,pClass);` |
|       - |  9403 | `				}` |
|  181073 |  9404 | `				if( rc != SXRET_OK ){` |
...
|       - |  9427 | `		sxu32 nU;` |
|  107811 |  9428 | `		apUse = (TraitUseEntry *)SySetBasePtr(&aUseEntries);` |
|  107863 |  9429 | `		for( nU = 0 ; nU < SySetUsed(&aUseEntries) ; nU++ ){` |
...
|  107811 |  9637 | `	rc = PH7_VmInstallClass(pGen->pVm,pClass);` |
|  107811 |  9638 | `	if( rc == SXRET_OK ){` |
|       - |  9639 | `		ph7_class **apInterface;` |
|       - |  9640 | `		sxu32 n;` |
|  107811 |  9641 | `		if( pBase ){` |
|       - |  9642 | `			/* Inherit from base class and mark as a subclass */` |
|   81021 |  9643 | `			rc = PH7_ClassInherit(&(*pGen),pClass,pBase);` |
|   40508 |  9644 | `		}` |
|  107811 |  9645 | `		apInterface = (ph7_class **)SySetBasePtr(&aInterfaces);` |
|  118999 |  9646 | `		for( n = 0 ; n < SySetUsed(&aInterfaces) ; n++ ){` |
|       - |  9647 | `			/* Implements one or more interface */` |
|   11193 |  9648 | `			rc = PH7_ClassImplement(pClass,apInterface[n]);` |
|   11193 |  9649 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  9650 | `				break;` |
|       - |  9651 | `			}` |
|    5599 |  9652 | `		}` |
...
|  107806 |  9655 | `		if( rc == SXRET_OK` |
|  107806 |  9656 | `		 && (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0` |
|  107811 |  9657 | `		 && SyHashGet(&pClass->hMethod,"__toString",sizeof("__toString")-1) != 0 ){` |
|   88271 |  9658 | `			ph7_class *pStringable = PH7_VmExtractClass(pGen->pVm,` |
|       - |  9659 | `				"Stringable",sizeof("Stringable")-1,FALSE,0);` |
|   88271 |  9660 | `			if( pStringable ){` |
|   88271 |  9661 | `				ph7_class **apImpl = (ph7_class **)SySetBasePtr(&pClass->aInterface);` |
|   88271 |  9662 | `				sxu32 nImpl = SySetUsed(&pClass->aInterface);` |
|       - |  9663 | `				sxu32 i;` |
|   88271 |  9664 | `				int bAlready = 0;` |
|   95623 |  9665 | `				for( i = 0 ; i < nImpl ; i++ ){` |
|    7359 |  9666 | `					if( apImpl[i] == pStringable ){` |
|       3 |  9667 | `						bAlready = 1;` |
|       3 |  9668 | `						break;` |
|       - |  9669 | `					}` |
|    3681 |  9670 | `				}` |
|   88271 |  9671 | `				if( !bAlready ){` |
|   88269 |  9672 | `					PH7_ClassImplement(pClass,pStringable);` |
|   44132 |  9673 | `				}` |
|   44133 |  9674 | `			}` |
|   44133 |  9675 | `		}` |
|       - |  9676 | `		/* Validate interface method signatures (visibility and parameter count) */` |
|  107811 |  9677 | `		if( rc == SXRET_OK ){` |
|  107811 |  9678 | `			sxi32 rcCheck = GenStateCheckInterfaceSignatures(&(*pGen),pClass);` |
|  107811 |  9679 | `			if( rcCheck == SXERR_ABORT ){` |
...
|  107811 |  9686 | `		if( rc == SXRET_OK ){` |
|  107811 |  9687 | `			sxi32 rcCheck = GenStateCheckAbstractMethods(&(*pGen),pClass);` |
|  107811 |  9688 | `			if( rcCheck == SXERR_ABORT ){` |
...
|   53903 |  9693 | `		}` |
|   53903 |  9694 | `	}` |
|  107811 |  9695 | `	SySetRelease(&aUseEntries);` |
|  107811 |  9696 | `	SySetRelease(&aInterfaces);` |
|  107811 |  9697 | `	if( rc != SXRET_OK ){` |
...
|  107849 |  9703 | `	pGen->pIn = &pEnd[1];` |
|  107849 |  9704 | `	pGen->pEnd = pTmp;` |
|  107849 |  9705 | `	return PH7_OK;` |
|   53928 |  9706 | `}` |
|       - |  9707 | `/* Compile a named class declaration (the common case). */` |
|  107820 |  9708 | `static sxi32 GenStateCompileClass(ph7_gen_state *pGen,sxi32 iFlags)` |
|       5 |  9709 | `{` |
|  107825 |  9710 | `	return GenStateCompileClassEx(pGen,iFlags,0,0,0);` |
|       5 |  9711 | `}` |
|       - |  9712 | `/*` |
...
|       - |  9801 | ` */` |
| 1015824 |  9802 | `static int GenStateTokenIsClassModifier(SyToken *pTok,sxi32 *piFlag)` |
|       5 |  9803 | `{` |
| 1015829 |  9804 | `	if( pTok->nType & PH7_TK_KEYWORD ){` |
|  682155 |  9805 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  682155 |  9806 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  674789 |  9807 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  337361 |  9808 | `	}` |
| 1008401 |  9809 | `	if( GenStateIsReadonly(pTok) ){ *piFlag = PH7_CLASS_READONLY; return TRUE; }` |
| 1008341 |  9810 | `	return FALSE;` |
|  507917 |  9811 | `}` |
|       - |  9812 | `/*` |
...
|       - |  9817 | ` */` |
| 1008336 |  9818 | `static sxi32 GenStateScanClassModifiers(SyToken **ppIn,SyToken *pEnd,SyToken **ppDup)` |
|       5 |  9819 | `{` |
| 1008341 |  9820 | `	SyToken *pIn = *ppIn,*pDup = 0;` |
| 1008341 |  9821 | `	sxi32 iFlags = 0,iFlag;` |
| 1015829 |  9822 | `	while( pIn < pEnd && GenStateTokenIsClassModifier(pIn,&iFlag) ){` |
|    7493 |  9823 | `		if( (iFlags & iFlag) && pDup == 0 ){` |
|       5 |  9824 | `			pDup = pIn;` |
|       2 |  9825 | `		}` |
|    7493 |  9826 | `		iFlags \|= iFlag;` |
|    7493 |  9827 | `		pIn++;` |
|       5 |  9828 | `	}` |
| 1008341 |  9829 | `	*ppIn = pIn;` |
| 1008341 |  9830 | `	if( ppDup ){ *ppDup = pDup; }` |
| 1008341 |  9831 | `	return iFlags;` |
|       5 |  9832 | `}` |
|       - |  9833 | `/*` |
...
|       - |  9839 | ` */` |
| 1004602 |  9840 | `static int GenStateStartsModifiedClass(SyToken *pIn,SyToken *pEnd)` |
|       5 |  9841 | `{` |
| 1004607 |  9842 | `	sxi32 iFlags = GenStateScanClassModifiers(&pIn,pEnd,0);` |
|  506042 |  9843 | `	return iFlags != 0 && pIn < pEnd && (pIn->nType & PH7_TK_KEYWORD)` |
| 1006471 |  9844 | `		&& (sxu32)SX_PTR_TO_INT(pIn->pUserData) == PH7_TKWRD_CLASS;` |
|       5 |  9845 | `}` |
|       - |  9846 | `/*` |
...
|       - |  9852 | ` */` |
|    3734 |  9853 | `static sxi32 PH7_CompileClassModifiers(ph7_gen_state *pGen)` |
|       5 |  9854 | `{` |
|       - |  9855 | `	SyToken *pDup;` |
|    3739 |  9856 | `	sxi32 iFlags = GenStateScanClassModifiers(&pGen->pIn,pGen->pEnd,&pDup);` |
|       - |  9857 | `	sxi32 rc;` |
|    3739 |  9858 | `	if( pDup ){` |
...
|       - |  9863 | `		}` |
|       1 |  9864 | `	}` |
|    3734 |  9865 | `	if( (iFlags & (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT))` |
|    1872 |  9866 | `		== (PH7_CLASS_FINAL\|PH7_CLASS_ABSTRACT) ){` |
...
|       - |  9871 | `		}` |
|       1 |  9872 | `	}` |
|    3739 |  9873 | `	return GenStateCompileClass(&(*pGen),iFlags);` |
|    1872 |  9874 | `}` |
|       - |  9875 | `/*` |
...
|       - | 10174 | ` */` |
|  104086 | 10175 | `static sxi32 PH7_CompileClass(ph7_gen_state *pGen)` |
|       5 | 10176 | `{` |
|       - | 10177 | `	sxi32 rc;` |
|  104091 | 10178 | `	rc = GenStateCompileClass(&(*pGen),0);` |
|  104091 | 10179 | `	return rc;` |
|       5 | 10180 | `}` |
|       - | 10181 | `/*` |
...
|       - | 10202 | ` */` |
|   15048 | 10203 | `static sxi32 GenStateThrowNodeValidator(ph7_gen_state *pGen,ph7_expr_node *pRoot)` |
|       5 | 10204 | `{` |
|   15053 | 10205 | `	sxi32 rc = SXRET_OK;` |
|   15053 | 10206 | `	if( pRoot->pOp ){` |
|   15043 | 10207 | `		switch( pRoot->pOp->iOp ){` |
|    7519 | 10208 | `		case EXPR_OP_NEW:            /* new Exception() */` |
...
|     ! 0 | 10224 | `			break;` |
|       - | 10225 | `		}` |
|    7534 | 10226 | `	}else if( pRoot->xCode != PH7_CompileVariable ){` |
...
|       - | 10240 | ` */` |
|   15012 | 10241 | `static sxi32 PH7_CompileThrow(ph7_gen_state *pGen)` |
|       5 | 10242 | `{` |
|   15017 | 10243 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 10244 | `	GenBlock *pBlock;` |
|       - | 10245 | `	sxu32 nIdx;` |
|       - | 10246 | `	sxi32 rc;` |
|   15017 | 10247 | `	pGen->pIn++; /* Jump the 'throw' keyword */` |
|       - | 10248 | `	/* Compile the expression */` |
|   15017 | 10249 | `	rc = PH7_CompileExpr(&(*pGen),0,GenStateThrowNodeValidator);` |
|   15017 | 10250 | `	if( rc == SXERR_EMPTY ){` |
...
|       - | 10256 | `	}` |
|   15017 | 10257 | `	pBlock = pGen->pCurrent;` |
|       - | 10258 | `	/* Point to the top most function or try block and emit the forward jump */` |
|   59421 | 10259 | `	while(pBlock->pParent){` |
|   59417 | 10260 | `		if( pBlock->iFlags & (GEN_BLOCK_EXCEPTION\|GEN_BLOCK_FUNC) ){` |
|   15013 | 10261 | `			break;` |
|       - | 10262 | `		}` |
|       - | 10263 | `		/* Point to the parent block */` |
|   44409 | 10264 | `		pBlock = pBlock->pParent;` |
|       5 | 10265 | `	}` |
|       - | 10266 | `	/* Emit the throw instruction */` |
|   15017 | 10267 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_THROW,0,0,0,&nIdx);` |
|       - | 10268 | `	/* Emit the jump */` |
|   15017 | 10269 | `	GenStateNewJumpFixup(pBlock,PH7_OP_THROW,nIdx);` |
|   15017 | 10270 | `	return SXRET_OK;` |
|    7511 | 10271 | `}` |
|       - | 10272 | `/*` |
...
|      44 | 10365 | `		break;` |
|     ! 0 | 10366 | `	}` |
|      40 | 10367 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 \|\|` |
...
|       - | 10510 | ` */` |
|     610 | 10511 | `static sxi32 PH7_CompileCatch(ph7_gen_state *pGen,ph7_exception *pException)` |
|       5 | 10512 | `{` |
|     615 | 10513 | `	sxu32 nLine = pGen->pIn->nLine;` |
...
|       - | 10520 | `	char *zDup;` |
|       - | 10521 | `	sxi32 rc;` |
|     615 | 10522 | `	pGen->pIn++; /* Jump the 'catch' keyword */` |
|       - | 10523 | `	/* Zero the structure */` |
|     615 | 10524 | `	SyZero(&sCatch,sizeof(ph7_exception_block));` |
|       - | 10525 | `	/* Initialize fields */` |
|     615 | 10526 | `	SySetInit(&sCatch.aClasses,&pException->pVm->sAllocator,sizeof(SyString));` |
|     615 | 10527 | `	SySetInit(&sCatch.sByteCode,&pException->pVm->sAllocator,sizeof(VmInstr));` |
|     615 | 10528 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_LPAREN) == 0 /*(*/ ){` |
...
|     615 | 10543 | `	pGen->pIn++; /* Jump the left parenthesis '(' */` |
|     319 | 10544 | `	for(;;){` |
|       - | 10545 | `		SyBlob sResolved;` |
|     643 | 10546 | `		SyBlobInit(&sResolved,&pGen->pVm->sAllocator);` |
|     643 | 10547 | `		if( GenStateParseClassReference(pGen,&sResolved) != SXRET_OK ){` |
...
|     956 | 10563 | `		zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,` |
|     634 | 10564 | `			(const char *)SyBlobData(&sResolved),SyBlobLength(&sResolved));` |
|     639 | 10565 | `		SyStringInitFromBuf(&sClassName,zDup,SyBlobLength(&sResolved));` |
|     639 | 10566 | `		SyBlobRelease(&sResolved);` |
|     639 | 10567 | `		if( zDup == 0 ){` |
|     ! 0 | 10568 | `			goto Mem;` |
|       - | 10569 | `		}` |
|     639 | 10570 | `		rc = SySetPut(&sCatch.aClasses,(const void *)&sClassName);` |
|     639 | 10571 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 10572 | `			goto Mem;` |
|       - | 10573 | `		}` |
|       - | 10574 | `		/* Check for '\|' (multi-catch separator) */` |
|     634 | 10575 | `		if( pGen->pIn < pGen->pEnd &&` |
|     634 | 10576 | `			(pGen->pIn->nType & PH7_TK_OP) &&` |
...
|     611 | 10582 | `		break;` |
|     ! 0 | 10583 | `	}` |
|     606 | 10584 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_DOLLAR) == 0 /*$*/ \|\|` |
|     611 | 10585 | `		&pGen->pIn[1] >= pGen->pEnd \|\| (pGen->pIn[1].nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
...
|       - | 10598 | `	}` |
|     611 | 10599 | `	pGen->pIn++; /* Jump the dollar sign */` |
|       - | 10600 | `	/* Duplicate instance name */` |
|     611 | 10601 | `	pName = &pGen->pIn->sData;` |
|     611 | 10602 | `	zDup = SyMemBackendStrDup(&pGen->pVm->sAllocator,pName->zString,pName->nByte);` |
|     611 | 10603 | `	if( zDup == 0 ){` |
|     ! 0 | 10604 | `		goto Mem;` |
|       - | 10605 | `	}` |
|     611 | 10606 | `	SyStringInitFromBuf(&sCatch.sThis,zDup,pName->nByte);` |
|     611 | 10607 | `	pGen->pIn++;` |
|     611 | 10608 | `	if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_RPAREN) == 0 /*)*/ ){` |
...
|     611 | 10623 | `	pGen->pIn++; /* Jump the right parenthesis */` |
|       - | 10624 | `	/* Create the catch block */` |
|     611 | 10625 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pCatch);` |
|     611 | 10626 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10627 | `		return SXERR_ABORT;` |
|       - | 10628 | `	}` |
|       - | 10629 | `	/* Swap bytecode container */` |
|     611 | 10630 | `	pInstrContainer = PH7_VmGetByteCodeContainer(pGen->pVm);` |
|     611 | 10631 | `	PH7_VmSetByteCodeContainer(pGen->pVm,&sCatch.sByteCode);` |
|       - | 10632 | `	/* Compile the block */` |
|     611 | 10633 | `	PH7_CompileBlock(&(*pGen),0);` |
|       - | 10634 | `	/* Fix forward jumps now the destination is resolved  */` |
|     611 | 10635 | `	GenStateFixJumps(pCatch,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10636 | `	/* Emit the DONE instruction */` |
|     611 | 10637 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_DONE,0,0,0,0);` |
|       - | 10638 | `	/* Leave the block */` |
|     611 | 10639 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10640 | `	/* Restore the default container */` |
|     611 | 10641 | `	PH7_VmSetByteCodeContainer(pGen->pVm,pInstrContainer);` |
|       - | 10642 | `	/* Install the catch block */` |
|     611 | 10643 | `	rc = SySetPut(&pException->sEntry,(const void *)&sCatch);` |
|     611 | 10644 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10645 | `		goto Mem;` |
|       - | 10646 | `	}` |
|     611 | 10647 | `	return SXRET_OK;` |
|     ! 0 | 10648 | `Mem:` |
...
|       - | 10657 | ` * is "thrown".` |
|       - | 10658 | ` */` |
|     716 | 10659 | `static sxi32 PH7_CompileTry(ph7_gen_state *pGen)` |
|       5 | 10660 | `{` |
|       - | 10661 | `	ph7_exception *pException;` |
|     721 | 10662 | `	sxu32 nLine = pGen->pIn->nLine;` |
|       - | 10663 | `	GenBlock *pTry;` |
|       - | 10664 | `	sxu32 nJmpIdx;` |
|       - | 10665 | `	sxi32 rc;` |
|       - | 10666 | `	/* Create the exception container */` |
|     721 | 10667 | `	pException = (ph7_exception *)SyMemBackendAlloc(&pGen->pVm->sAllocator,sizeof(ph7_exception));` |
|     721 | 10668 | `	if( pException == 0 ){` |
...
|     721 | 10674 | `	SyZero(pException,sizeof(ph7_exception));` |
|       - | 10675 | `	/* Initialize fields */` |
|     721 | 10676 | `	SySetInit(&pException->sEntry,&pGen->pVm->sAllocator,sizeof(ph7_exception_block));` |
|     721 | 10677 | `	SySetInit(&pException->sFinally,&pGen->pVm->sAllocator,sizeof(VmInstr));` |
|     721 | 10678 | `	pException->iHasFinally = 0;` |
|     721 | 10679 | `	pException->iFinallyDone = 0;` |
|     721 | 10680 | `	pException->pVm = pGen->pVm;` |
...
|     721 | 10687 | `	if( pGen->bInGenerator && pGen->pVm->bInlineTryCatch ){` |
|      66 | 10688 | `		return PH7_CompileTryInline(&(*pGen),pException);` |
|       - | 10689 | `	}` |
|       - | 10690 | `	/* Create the try block */` |
|     659 | 10691 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_EXCEPTION,PH7_VmInstrLength(pGen->pVm),0,&pTry);` |
|     659 | 10692 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 10693 | `		return SXERR_ABORT;` |
|       - | 10694 | `	}` |
|       - | 10695 | `	/* Store exception pointer so break/continue can emit POP_EXCEPTION */` |
|     659 | 10696 | `	pTry->pUserData = pException;` |
|       - | 10697 | `	/* Emit the 'LOAD_EXCEPTION' instruction */` |
|     659 | 10698 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_EXCEPTION,0,0,pException,&nJmpIdx);` |
|       - | 10699 | `	/* Fix the jump later when the destination is resolved */` |
|     659 | 10700 | `	GenStateNewJumpFixup(pTry,PH7_OP_LOAD_EXCEPTION,nJmpIdx);` |
|     659 | 10701 | `	pGen->pIn++; /* Jump the 'try' keyword */` |
|       - | 10702 | `	/* Compile the block */` |
|     659 | 10703 | `	rc = PH7_CompileBlock(&(*pGen),0);` |
|     659 | 10704 | `	if( rc == SXERR_ABORT ){` |
|     ! 0 | 10705 | `		return SXERR_ABORT;` |
|       - | 10706 | `	}` |
|       - | 10707 | `	/* Fix forward jumps now the destination is resolved */` |
|     659 | 10708 | `	GenStateFixJumps(pTry,-1,PH7_VmInstrLength(pGen->pVm));` |
|       - | 10709 | `	/* Emit the 'POP_EXCEPTION' instruction */` |
|     659 | 10710 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP_EXCEPTION,0,0,pException,0);` |
|       - | 10711 | `	/* Leave the block */` |
|     659 | 10712 | `	GenStateLeaveBlock(&(*pGen),0);` |
|       - | 10713 | `	/* Compile catch block(s) — at least one catch or finally is required */` |
|     659 | 10714 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     652 | 10715 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_CATCH ){` |
|       - | 10716 | `		/* Compile one or more catch blocks */` |
|     606 | 10717 | `		for(;;){` |
|    1212 | 10718 | `			if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0` |
|     985 | 10719 | `				\|\| SX_PTR_TO_INT(pGen->pIn->pUserData) != PH7_TKWRD_CATCH ){` |
|     306 | 10720 | `					break;` |
|       - | 10721 | `			}` |
|     615 | 10722 | `			rc = PH7_CompileCatch(&(*pGen),pException);` |
|     615 | 10723 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 10724 | `				return SXERR_ABORT;` |
|       - | 10725 | `			}` |
|       5 | 10726 | `		}` |
|     301 | 10727 | `	}` |
|       - | 10728 | `	/* Compile optional finally block */` |
|     659 | 10729 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
|     366 | 10730 | `		SX_PTR_TO_INT(pGen->pIn->pUserData) == PH7_TKWRD_FINALLY ){` |
...
|     659 | 10759 | `	if( SySetUsed(&pException->sEntry) == 0 && !pException->iHasFinally ){` |
|       9 | 10760 | `		rc = PH7_GenCompileError(&(*pGen),E_ERROR,nLine,` |
|       - | 10761 | `			"Cannot use try without catch or finally");` |
|       9 | 10762 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 | 10763 | `			return SXERR_ABORT;` |
|       - | 10764 | `		}` |
|       3 | 10765 | `	}` |
|     659 | 10766 | `	return SXRET_OK;` |
|     363 | 10767 | `}` |
|       - | 10768 | `/*` |
...
|       - | 11122 | ` */` |
| 2730228 | 11123 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 11124 | `{` |
| 2730233 | 11125 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 11126 | `	sxu32 nTarget;` |
|       - | 11127 | `	sxu32 *aIdx;` |
|       - | 11128 | `	sxu32 i;` |
| 2730233 | 11129 | `	if( nCur <= nBaseline ){` |
| 2730139 | 11130 | `		return;` |
|       - | 11131 | `	}` |
...
|       - | 11159 | ` */` |
|  459024 | 11160 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 11161 | `{` |
...
|       - | 11171 | `	};` |
|       - | 11172 | `	sxu32 i;` |
|  459029 | 11173 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    1767 | 11174 | `		return 0;` |
|       - | 11175 | `	}` |
| 2286043 | 11176 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1828870 | 11177 | `		if( pName->nByte == aByRef[i].nByte` |
|  937540 | 11178 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      99 | 11179 | `			return aByRef[i].mask;` |
|       - | 11180 | `		}` |
|  914393 | 11181 | `	}` |
|  457173 | 11182 | `	return 0;` |
|  229517 | 11183 | `}` |
|       - | 11184 | `/*` |
...
|       - | 11193 | ` */` |
|  459024 | 11194 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 11195 | `{` |
|       - | 11196 | `	SyToken *p, *pEnd;` |
|  459029 | 11197 | `	pOut->zString = 0;` |
|  459029 | 11198 | `	pOut->nByte = 0;` |
|  459029 | 11199 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 11200 | `		return;` |
|       - | 11201 | `	}` |
|  459029 | 11202 | `	p = pLeft->pStart;` |
|  459029 | 11203 | `	pEnd = pLeft->pEnd;` |
|       - | 11204 | `	/* Optional single leading namespace separator (absolute path). */` |
|  459029 | 11205 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|    3707 | 11206 | `		p++;` |
|    1851 | 11207 | `	}` |
|  459029 | 11208 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    1733 | 11209 | `		return;` |
|       - | 11210 | `	}` |
|       - | 11211 | `	/* Must be a single component: nothing follows the name token. */` |
|  457301 | 11212 | `	if( p + 1 != pEnd ){` |
|      39 | 11213 | `		return;` |
|       - | 11214 | `	}` |
|  457267 | 11215 | `	*pOut = p->sData;` |
|  229517 | 11216 | `}` |
|       - | 11217 | `/*` |
...
|       - | 11222 | ` * error message.` |
|       - | 11223 | ` */` |
| 3654014 | 11224 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 11231 | `	sxu32 nJmpIdx;` |
| 3654019 | 11232 | `	sxi32 iP1 = 0;` |
| 3654019 | 11233 | `	sxu32 iP2 = 0;` |
| 3654019 | 11234 | `	void *p3  = 0;` |
|       - | 11235 | `	sxi32 iVmOp;` |
|       - | 11236 | `	sxi32 rc;` |
| 3654019 | 11237 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3654019 | 11238 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
| 3654019 | 11239 | `	sxu32 nRhsNsBase = 0;` |
| 3654019 | 11240 | `	if( pNode->xCode ){` |
|       - | 11241 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 11242 | `		/* Compile node */` |
| 2281045 | 11243 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2281045 | 11244 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2281045 | 11245 | `		RE_SWAP_DELIMITER(pGen);` |
| 2281045 | 11246 | `		return rc;` |
|       - | 11247 | `	}` |
| 1372979 | 11248 | `	if( pNode->pOp == 0 ){` |
...
|       - | 11252 | `	}` |
| 1372979 | 11253 | `	iVmOp = pNode->pOp->iVmOp;` |
| 1372979 | 11254 | `	if( pNode->pOp->iOp == EXPR_OP_NULLC_ASSIGN ){` |
...
|       - | 11303 | `	}` |
| 1372917 | 11304 | `	if( pNode->pOp->iOp == EXPR_OP_QUESTY ){` |
...
|       - | 11366 | `	}` |
| 1370247 | 11367 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 11368 | `	/* Generate code for the left tree */` |
| 1370247 | 11369 | `	if( pNode->pLeft ){` |
| 1370207 | 11370 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1370207 | 11371 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 11372 | `			ph7_expr_node **apNode;` |
|  462845 | 11373 | `			int hasSpread = 0;` |
|  462845 | 11374 | `			int hasNamed = 0;` |
|  462845 | 11375 | `			int bAnySpread = 0;` |
|  462845 | 11376 | `			sxu32 byRefMask = 0;` |
|       - | 11377 | `			sxi32 nArgs;` |
|       - | 11378 | `			sxi32 n;` |
|       - | 11379 | `			/* Recurse and generate bytecodes for function arguments */` |
|  462845 | 11380 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  462845 | 11381 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|  462845 | 11385 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|      65 | 11386 | `				bFcc = 1;` |
|      65 | 11387 | `				nArgs = 0;` |
|      32 | 11388 | `			}` |
|       - | 11389 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 11390 | `			{` |
|  462845 | 11391 | `				int seenNamed = 0;` |
|  939215 | 11392 | `				for( n = 0; n < nArgs; ++n ){` |
|  476377 | 11393 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     216 | 11394 | `						seenNamed = 1;` |
|     216 | 11395 | `						hasNamed = 1;` |
|  476271 | 11396 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|    3703 | 11397 | `						bAnySpread = 1;` |
|  474316 | 11398 | `					}else if( seenNamed ){` |
...
|  462843 | 11406 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  462843 | 11411 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  462843 | 11412 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  462838 | 11413 | `				if( pCallName->nByte == 5` |
|  252671 | 11414 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   22375 | 11415 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  451658 | 11416 | `				}else if( pCallName->nByte == 5` |
|  230301 | 11417 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  462843 | 11426 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 11427 | `					SyString sBuiltin;` |
|  459029 | 11428 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  459029 | 11429 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  229512 | 11430 | `				}` |
|  231419 | 11431 | `			}` |
|  939211 | 11432 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  476373 | 11433 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  476373 | 11434 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|  476373 | 11441 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      55 | 11442 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      55 | 11443 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|      25 | 11444 | `				}` |
|  476373 | 11445 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  476373 | 11446 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 11447 | `					return rc;` |
|       - | 11448 | `				}` |
|       - | 11449 | `				/* Each argument is an independent nullsafe scope. */` |
|  476373 | 11450 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  476373 | 11451 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|       - | 11452 | `					/* Emit spread opcode to unpack this array argument */` |
|    3703 | 11453 | `					PH7_VmEmitInstr(pGen->pVm, PH7_OP_SPREAD, 0, 0, 0, 0);` |
|    3703 | 11454 | `					hasSpread = 1;` |
|    1849 | 11455 | `				}` |
|  238189 | 11456 | `			}` |
|       - | 11457 | `			/* Total number of given arguments */` |
|  462843 | 11458 | `			iP1 = nArgs;` |
|  462843 | 11459 | `			iP2 = hasSpread;` |
|       - | 11460 | `			/* Build VmCallArgMap if named arguments are present.` |
|       - | 11461 | `			 * Deep-copy name strings so they survive token stream cleanup. */` |
|  462843 | 11462 | `			if( hasNamed ){` |
...
|  462843 | 11494 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  231419 | 11495 | `		}` |
|       - | 11496 | `		{` |
...
| 1370205 | 11505 | `			sxi32 iLeftFlags = iFlags;` |
| 1370200 | 11506 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
| 1046432 | 11507 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|  361357 | 11508 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  353190 | 11509 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
|   16529 | 11510 | `				iLeftFlags &= ~EXPR_FLAG_LOAD_IDX_UNSET;` |
|    8262 | 11511 | `			}` |
...
| 1370200 | 11519 | `			if( pNode->pOp` |
| 1963862 | 11520 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
| 1278808 | 11521 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
| 1187365 | 11522 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|  183225 | 11523 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   91610 | 11524 | `			}` |
| 1370205 | 11525 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|       - | 11526 | `		}` |
| 1370205 | 11527 | `		if( rc != SXRET_OK ){` |
|      34 | 11528 | `			return rc;` |
|       - | 11529 | `		}` |
| 1370175 | 11530 | `		if( !bIsChainOp ){` |
...
|  629635 | 11533 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  314815 | 11534 | `		}` |
| 1370175 | 11535 | `		if( iVmOp == PH7_OP_CALL ){` |
|  462843 | 11536 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  462843 | 11537 | `			if( pInstr ){` |
|  462843 | 11538 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  457395 | 11539 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 11540 | `					sxu32 nQual;` |
|  457395 | 11541 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 11542 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 11543 | `					 * so the later NEW handler (if any) can see it. */` |
|  457395 | 11544 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  457395 | 11552 | `					if( bAbsolute ){` |
|    3707 | 11553 | `						pInstr->iP2 = (sxi32)nOrig;` |
|    1856 | 11554 | `					}else{` |
|  453693 | 11555 | `						int fromImport = 0;` |
|  453693 | 11556 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  453693 | 11557 | `						pInstr->iP2 = (sxi32)nQual;` |
|  453693 | 11558 | `						if( nQual != nOrig ){` |
...
|      36 | 11576 | `						}` |
|       5 | 11577 | `					}` |
|  234148 | 11578 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 11579 | `					/* Method call,flag that */` |
|    1341 | 11580 | `					pInstr->iP2 = 1;` |
|     668 | 11581 | `				}` |
|  231424 | 11582 | `			}` |
| 1138756 | 11583 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
|       - | 11584 | `			ph7_expr_node **apNode;` |
|       - | 11585 | `			sxi32 n;` |
|   94487 | 11586 | `			sxi32 iChildMask = ~(EXPR_FLAG_LOAD_IDX_STORE` |
...
|   94487 | 11590 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  170499 | 11591 | `			for( n = 0 ; n < (sxi32)SySetUsed(&pNode->aNodeArgs) ; ++n ){` |
|   76017 | 11592 | `				sxu32 nIdxNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|   76017 | 11593 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iFlags&iChildMask);` |
|   76017 | 11594 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 11595 | `					return rc;` |
|       - | 11596 | `				}` |
|       - | 11597 | `				/* Each subscript index is an independent nullsafe scope. */` |
|   76017 | 11598 | `				GenStatePatchNullsafeJumps(pGen, nIdxNsBase);` |
|   38011 | 11599 | `			}` |
|   94487 | 11600 | `			if( SySetUsed(&pNode->aNodeArgs) > 0 ){` |
|   76017 | 11601 | `				iP1 = 1; /* Node have an index associated with it */` |
|   38006 | 11602 | `			}` |
|   94487 | 11603 | `			if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|       - | 11604 | `				/* offsetExists for ArrayAccess; peek-only for arrays */` |
|     241 | 11605 | `				iP2 = 4;` |
|   94369 | 11606 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|       - | 11607 | `				/* offsetUnset for ArrayAccess; auto-vivify+load for arrays` |
|       - | 11608 | `				 * so the trailing unset() builtin can drop the slot. */` |
|      56 | 11609 | `				iP2 = 5;` |
|   94225 | 11610 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
...
|      29 | 11614 | `				iP2 = 6;` |
|   94187 | 11615 | `			}else if( iFlags & EXPR_FLAG_LOAD_IDX_STORE ){` |
|       - | 11616 | `				/* Create an empty entry when the desired index is not found */` |
|   37247 | 11617 | `				iP2 = 1;` |
|   18626 | 11618 | `			}` |
|  860096 | 11619 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 11620 | `			/* POP the left node */` |
|      32 | 11621 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 11622 | `		}` |
|  685085 | 11623 | `	}` |
| 1370215 | 11624 | `	rc = SXRET_OK;` |
| 1370215 | 11625 | `	nJmpIdx = 0;` |
...
| 1370215 | 11629 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
|     276 | 11637 | `				if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     276 | 11638 | `					(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
...
| 1370133 | 11659 | `	if( pNode->pRight ){` |
|  739285 | 11660 | `		if( iVmOp == PH7_OP_LAND ){` |
|       - | 11661 | `			/* Emit the false jump so we can short-circuit the logical and */` |
|   11535 | 11662 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  733520 | 11663 | `		}else if (iVmOp == PH7_OP_LOR ){` |
|       - | 11664 | `			/* Emit the true jump so we can short-circuit the logical or*/` |
|    3855 | 11665 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_JNZ,1/* Keep the value on the stack */,0,0,&nJmpIdx);` |
|  725830 | 11666 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLC ){` |
...
|  723894 | 11670 | `		}else if( pNode->pOp && pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW ){` |
...
|  723730 | 11680 | `		}else if( pNode->pOp->iPrec == 18 /* Combined binary operators [i.e: =,'.=','+=',*=' ...] precedence */ ){` |
...
|  307565 | 11684 | `			iFlags \|= EXPR_FLAG_LOAD_IDX_STORE \| EXPR_FLAG_MEMBER_WRITE;` |
|  153780 | 11685 | `		}` |
|  739285 | 11686 | `		nRhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  739285 | 11687 | `		rc = GenStateEmitExprCode(&(*pGen),pNode->pRight,iFlags);` |
|  739285 | 11688 | `		if( !bIsChainOp ){` |
|       - | 11689 | `			/* Non-chain parent: RHS nullsafe chain ends here, before the` |
|       - | 11690 | `			 * operator instruction is emitted. */` |
|  556109 | 11691 | `			GenStatePatchNullsafeJumps(pGen, nRhsNsBase);` |
|  278052 | 11692 | `		}` |
|  739285 | 11693 | `		if( iVmOp == PH7_OP_STORE ){` |
|  303629 | 11694 | `			if( pNode->pRight && (pNode->pRight->xCode == PH7_CompileList \|\|` |
|  303598 | 11695 | `				pNode->pRight->xCode == PH7_CompileShortList) ){` |
...
|       - | 11701 | `				 */` |
|      80 | 11702 | `				iVmOp = 0;` |
|  303591 | 11703 | `			}else if( (pInstr = PH7_VmPeekInstr(pGen->pVm)) != 0 ){` |
|  303553 | 11704 | `				if(pInstr->iOp == PH7_OP_MEMBER ){` |
|       - | 11705 | `					/* Perform a member store operation [i.e: $this->x = 50] */` |
|   81335 | 11706 | `					iP2 = 1;` |
|   40670 | 11707 | `				}else{` |
|  222223 | 11708 | `					if( pInstr->iOp == PH7_OP_LOAD_IDX ){` |
|       - | 11709 | `						/* Transform the STORE instruction to STORE_IDX instruction */` |
|   37171 | 11710 | `						iVmOp = PH7_OP_STORE_IDX;` |
|   37171 | 11711 | `						iP1 = pInstr->iP1;` |
|   18588 | 11712 | `					}else{` |
|  185057 | 11713 | `						p3 = pInstr->p3;` |
|       - | 11714 | `					}` |
|       - | 11715 | `					/* POP the last dynamic load instruction */` |
|  222223 | 11716 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|       - | 11717 | `				}` |
|  151779 | 11718 | `			}` |
|  587473 | 11719 | `		}else if( iVmOp == PH7_OP_STORE_REF ){` |
...
|      26 | 11734 | `		}` |
|  369640 | 11735 | `	}` |
| 1370128 | 11736 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
|   11963 | 11737 | `		&& pNode->pLeft->xCode == PH7_CompileAnnonClass ){` |
...
|      30 | 11740 | `		iVmOp = 0;` |
|      13 | 11741 | `	}` |
| 1370133 | 11742 | `	if( iVmOp > 0 ){` |
| 1369877 | 11743 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   15097 | 11744 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 11745 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|   11047 | 11746 | `				iP1 = 1;` |
|    5526 | 11747 | `			}` |
| 1362331 | 11748 | `		}else if( iVmOp == PH7_OP_NEW ){` |
|       - | 11749 | `			/* Namespace-qualify the class name for NEW */ {` |
|   23677 | 11750 | `				VmInstr *pPeek = PH7_VmPeekInstr(pGen->pVm);` |
|   23677 | 11751 | `				VmInstr *pCallInstr = 0;` |
|   23677 | 11752 | `				if( pPeek && pPeek->iOp == PH7_OP_CALL ){` |
|   23485 | 11753 | `					pCallInstr = pPeek;` |
|   23485 | 11754 | `					pPeek = PH7_VmPeekNextInstr(pGen->pVm);` |
|   11740 | 11755 | `				}` |
|   23677 | 11756 | `				if( pPeek && pPeek->iOp == PH7_OP_LOADC ){` |
|   23675 | 11757 | `					int bAbsolute = (pPeek->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
...
|   23675 | 11762 | `					if( pCallInstr && pCallInstr->iP2 > 0 ){` |
|      37 | 11763 | `						nLitForClass = (sxu32)(pCallInstr->iP2 - 1); /* undo +1 encoding */` |
|      21 | 11764 | `					}else{` |
|   23643 | 11765 | `						nLitForClass = (sxu32)pPeek->iP2;` |
|       - | 11766 | `					}` |
|   23675 | 11767 | `					pPeek->iP1 = 0;` |
|   23675 | 11768 | `					if( !bAbsolute ){` |
|   19977 | 11769 | `						pPeek->iP2 = (sxi32)GenStateNsQualifyName(pGen,nLitForClass,&pGen->hUseImports,0);` |
|    9991 | 11770 | `					}else{` |
|    3703 | 11771 | `						pPeek->iP2 = (sxi32)nLitForClass;` |
|       - | 11772 | `					}` |
|   11835 | 11773 | `				}` |
|       - | 11774 | `			}` |
|   23677 | 11775 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|   23677 | 11776 | `			if( pInstr && pInstr->iOp == PH7_OP_CALL ){` |
|       - | 11777 | `				VmInstr *pPrev;` |
|   23485 | 11778 | `				pPrev = PH7_VmPeekNextInstr(pGen->pVm);` |
|   23485 | 11779 | `				if( pPrev == 0 \|\| pPrev->iOp != PH7_OP_MEMBER ){` |
|       - | 11780 | `					/* Pop the call instruction, preserve named-arg map */` |
|   23485 | 11781 | `					iP1 = pInstr->iP1;` |
|   23485 | 11782 | `					if( pInstr->p3 ){` |
|      43 | 11783 | `						p3 = pInstr->p3; /* Transfer VmCallArgMap to NEW */` |
|      19 | 11784 | `					}` |
|   23485 | 11785 | `					(void)PH7_VmPopInstr(pGen->pVm);` |
|   11740 | 11786 | `				}` |
|   11745 | 11787 | `			}` |
| 1342949 | 11788 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|     203 | 11791 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|     203 | 11792 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|     203 | 11793 | `				ph7_value *pLitChk = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,(sxu32)pInstr->iP2);` |
|     203 | 11794 | `				int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|     203 | 11795 | `				int isSpecialIs = 0;` |
|     203 | 11796 | `				if( pLitChk && (pLitChk->iFlags & MEMOBJ_STRING) ){` |
|     199 | 11797 | `					const char *z = (const char *)SyBlobData(&pLitChk->sBlob);` |
|     199 | 11798 | `					sxu32 n = (sxu32)SyBlobLength(&pLitChk->sBlob);` |
|     194 | 11799 | `					if( (n == 4 && SyMemcmp(z,"self",4) == 0) \|\|` |
|     199 | 11800 | `						(n == 6 && SyMemcmp(z,"static",6) == 0) \|\|` |
|      98 | 11801 | `						(n == 6 && SyMemcmp(z,"parent",6) == 0) ){` |
|      12 | 11802 | `						isSpecialIs = 1;` |
|       5 | 11803 | `					}` |
|      98 | 11804 | `				}` |
|     205 | 11805 | `				pInstr->iP1 = 0;` |
|     205 | 11806 | `				if( !isSpecialIs && !bAbsolute ){` |
|     181 | 11807 | `					pInstr->iP2 = (sxi32)GenStateNsQualifyName(pGen,(sxu32)pInstr->iP2,&pGen->hUseImports,0);` |
|      88 | 11808 | `				}` |
|     103 | 11809 | `			}` |
| 1331017 | 11810 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
|  183181 | 11814 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  183181 | 11815 | `			if( pInstr && pInstr->iOp == PH7_OP_LOADC ){` |
|  183133 | 11816 | `				pInstr->iP1 = 0;` |
|   91564 | 11817 | `			}` |
|  183181 | 11818 | `			if( pNode->pOp->iOp == EXPR_OP_DC /* '::' */){` |
...
|  183181 | 11831 | `			if( iP2 == PH7_MEMBER_READ ){` |
|  183181 | 11832 | `				if( iFlags & EXPR_FLAG_LOAD_IDX_UNSET ){` |
|      30 | 11833 | `					iP2 = PH7_MEMBER_UNSET;` |
|  183167 | 11834 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_ISSET ){` |
|      77 | 11835 | `					iP2 = PH7_MEMBER_ISSET;` |
|  183117 | 11836 | `				}else if( iFlags & EXPR_FLAG_LOAD_IDX_EMPTY ){` |
|      13 | 11837 | `					iP2 = PH7_MEMBER_EMPTY;` |
|  183075 | 11838 | `				}else if( iFlags & EXPR_FLAG_MEMBER_WRITE ){` |
|       - | 11839 | `					/* Write-lvalue base ($o->arr[$k]=v, $o->p ??= v): auto-create a missing prop. */` |
|   81415 | 11840 | `					iP2 = PH7_MEMBER_WRITE;` |
|   40705 | 11841 | `				}` |
|   91588 | 11842 | `			}` |
|   91588 | 11843 | `		}` |
...
| 1369875 | 11871 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  486451 | 11872 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  243223 | 11873 | `		}` |
|       - | 11874 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1369875 | 11875 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  684935 | 11876 | `	}` |
| 1370131 | 11877 | `	if( nJmpIdx > 0 ){` |
|       - | 11878 | `		/* Fix short-circuited jumps now the destination is resolved */` |
|   15509 | 11879 | `		pInstr = PH7_VmGetInstr(pGen->pVm,nJmpIdx);` |
|   15509 | 11880 | `		if( pInstr ){` |
|   15509 | 11881 | `			pInstr->iP2 = PH7_VmInstrLength(pGen->pVm);` |
|    7752 | 11882 | `		}` |
|    7752 | 11883 | `	}` |
| 1370131 | 11884 | `	return rc;` |
| 1826992 | 11885 | `}` |
|       - | 11886 | `/*` |
...
|       - | 11895 | ` * message.` |
|       - | 11896 | ` */` |
|  984240 | 11897 | `static sxi32 PH7_CompileExpr(` |
...
|  984245 | 11911 | `	nExpr = 0;` |
|  984245 | 11912 | `	pRoot = 0;` |
...
|  984245 | 11915 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  984245 | 11916 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
|  984245 | 11917 | `	SySetAlloc(&sExprNode,0x10);` |
|  984245 | 11918 | `	rc = SXRET_OK;` |
|       - | 11919 | `	/* Delimit the expression */` |
|  984245 | 11920 | `	pEnd = pGen->pIn;` |
|  984245 | 11921 | `	iNest = 0;` |
| 6639989 | 11922 | `	while( pEnd < pGen->pEnd ){` |
| 6300893 | 11923 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 11924 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     517 | 11925 | `			iNest++;` |
| 6300637 | 11926 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     525 | 11927 | `			iNest--;` |
| 6300121 | 11928 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  645521 | 11929 | `			if( iNest <= 0 ){` |
|  645149 | 11930 | `				break;` |
|       - | 11931 | `			}` |
|     186 | 11932 | `		}` |
| 5655749 | 11933 | `		pEnd++;` |
|       5 | 11934 | `	}` |
|  984245 | 11935 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
|   22629 | 11936 | `		SyToken *pEnd2 = pGen->pIn;` |
|   22629 | 11937 | `		iNest = 0;` |
|       - | 11938 | `		/* Stop at the first comma */` |
|   45571 | 11939 | `		while( pEnd2 < pEnd ){` |
|   22953 | 11940 | `			if( pEnd2->nType & (PH7_TK_OCB/*'{'*/\|PH7_TK_OSB/*'['*/\|PH7_TK_LPAREN/*'('*/) ){` |
|      71 | 11941 | `				iNest++;` |
|   22920 | 11942 | `			}else if(pEnd2->nType & (PH7_TK_CCB/*'}'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_RPAREN/*')'*/)){` |
|      71 | 11943 | `				iNest--;` |
|   22854 | 11944 | `			}else if( pEnd2->nType & PH7_TK_COMMA /*','*/ ){` |
|      57 | 11945 | `				if( iNest <= 0 ){` |
|       7 | 11946 | `					break;` |
|       - | 11947 | `				}` |
|      23 | 11948 | `			}` |
|   22947 | 11949 | `			pEnd2++;` |
|       5 | 11950 | `		}` |
|   22629 | 11951 | `		if( pEnd2 <pEnd ){` |
|       7 | 11952 | `			pEnd = pEnd2;` |
|       3 | 11953 | `		}` |
|   11312 | 11954 | `	}` |
|  984245 | 11955 | `	if( pEnd > pGen->pIn ){` |
|  984235 | 11956 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 11957 | `		/* Swap delimiter */` |
|  984235 | 11958 | `		pGen->pEnd = pEnd;` |
|       - | 11959 | `		/* Try to get an expression tree */` |
|  984235 | 11960 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
|  984235 | 11961 | `		if( rc == SXRET_OK && pRoot ){` |
|  984053 | 11962 | `			rc = SXRET_OK;` |
|  984053 | 11963 | `			if( xTreeValidator ){` |
|       - | 11964 | `				/* Call the upper layer validator callback */` |
|   30079 | 11965 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   15037 | 11966 | `			}` |
|  984053 | 11967 | `			if( rc != SXERR_ABORT ){` |
|       - | 11968 | `				/* Generate code for the given tree */` |
|  984053 | 11969 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 11970 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 11971 | `				 * expression so they short-circuit to its end. */` |
|  984053 | 11972 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  492024 | 11973 | `			}` |
|  984053 | 11974 | `			nExpr = 1;` |
|  492024 | 11975 | `		}` |
|       - | 11976 | `		/* Release the whole tree */` |
|  984235 | 11977 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 11978 | `		/* Synchronize token stream */` |
|  984235 | 11979 | `		pGen->pEnd = pTmp;` |
|  984235 | 11980 | `		pGen->pIn  = pEnd;` |
|  984235 | 11981 | `		if( rc == SXERR_ABORT ){` |
|      13 | 11982 | `			SySetRelease(&sExprNode);` |
|      13 | 11983 | `			return SXERR_ABORT;` |
|       - | 11984 | `		}` |
|  492110 | 11985 | `	}` |
|  984235 | 11986 | `	SySetRelease(&sExprNode);` |
|  984235 | 11987 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  492125 | 11988 | `}` |
|       - | 11989 | `/*` |
|       - | 11990 | ` * Return a pointer to the node construct handler associated` |
|       - | 11991 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 11992 | ` */` |
|  257622 | 11993 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 11994 | `{` |
|  257627 | 11995 | `	if( nNodeType & PH7_TK_NUM ){` |
|       - | 11996 | `		/* Numeric literal: Either real or integer */` |
|  129671 | 11997 | `		return PH7_CompileNumLiteral;` |
|  127961 | 11998 | `	}else if( nNodeType & PH7_TK_DSTR ){` |
|       - | 11999 | `		/* Double quoted string */` |
|   24511 | 12000 | `		return PH7_CompileString;` |
|  103455 | 12001 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 12002 | `		/* Single quoted string */` |
|  103339 | 12003 | `		return PH7_CompileSimpleString;` |
...
|       - | 12020 | ` */` |
|    6864 | 12021 | `static sxi32 GenStateUnsetValidator(ph7_gen_state *pGen, ph7_expr_node *pNode)` |
|       5 | 12022 | `{` |
|       - | 12023 | `	sxi32 rc;` |
|    6869 | 12024 | `	if( !PH7_ExprContainsNullsafe(pNode) ){` |
|    6867 | 12025 | `		return SXRET_OK;` |
|       - | 12026 | `	}` |
...
|       - | 12038 | ` */` |
|    2976 | 12039 | `static sxi32 PH7_CompileUnset(ph7_gen_state *pGen)` |
|       5 | 12040 | `{` |
|    2981 | 12041 | `	SyToken *pTmp,*pEnd,*pNext = 0;` |
|    2981 | 12042 | `	sxu32 nIdx = 0;` |
|       - | 12043 | `	SyString sName;` |
|       - | 12044 | `	sxi32 rc;` |
|       - | 12045 | `	/* Jump the 'unset' keyword */` |
|    2981 | 12046 | `	pGen->pIn++;` |
|       - | 12047 | `	/* Save delimiter */` |
|    2981 | 12048 | `	pTmp = pGen->pEnd;` |
|       - | 12049 | `	/* Skip optional opening parenthesis and find the matching close */` |
|    2981 | 12050 | `	pEnd = pTmp; /* Default: scan to statement end */` |
|    2981 | 12051 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_LPAREN) ){` |
|       - | 12052 | `		/* Find matching ')' — start scanning AFTER the '(' */` |
|       - | 12053 | `		SyToken *pClose;` |
|    2981 | 12054 | `		pGen->pIn++;   /* Skip '(' */` |
|    2981 | 12055 | `		PH7_DelimitNestedTokens(pGen->pIn,pTmp,PH7_TK_LPAREN,PH7_TK_RPAREN,&pClose);` |
|    2981 | 12056 | `		pEnd = pClose; /* Stop at ')' */` |
|    1488 | 12057 | `	}` |
|    2981 | 12058 | `	SyStringInitFromBuf(&sName,"unset",sizeof("unset")-1);` |
|       - | 12059 | `	/* Resolve the 'unset' builtin name once */` |
|    2981 | 12060 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&sName,&nIdx) ){` |
...
|    9847 | 12069 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pEnd,&pNext) ){` |
|    6871 | 12070 | `		if( pGen->pIn < pNext ){` |
|    6871 | 12071 | `			pGen->pEnd = pNext;` |
|    6871 | 12072 | `			rc = PH7_CompileExpr(&(*pGen),` |
|       - | 12073 | `				EXPR_FLAG_RDONLY_LOAD\|EXPR_FLAG_LOAD_IDX_UNSET,` |
|       - | 12074 | `				GenStateUnsetValidator);` |
|    6871 | 12075 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 12076 | `				return SXERR_ABORT;` |
|       - | 12077 | `			}` |
|    6871 | 12078 | `			if( rc != SXERR_EMPTY ){` |
|       - | 12079 | `				/* Emit call for this single argument */` |
|    6869 | 12080 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|    6869 | 12081 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CALL,1,0,GenStateAttachStrictFlag(pGen,0),0);` |
|    6869 | 12082 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|    3432 | 12083 | `			}` |
|    3433 | 12084 | `		}` |
|       - | 12085 | `		/* Jump trailing commas */` |
|   10763 | 12086 | `		while( pNext < pEnd && (pNext->nType & PH7_TK_COMMA) ){` |
|    3897 | 12087 | `			pNext++;` |
|       5 | 12088 | `		}` |
|    6871 | 12089 | `		pGen->pIn = pNext;` |
|       5 | 12090 | `	}` |
|       - | 12091 | `	/* Skip past the closing ')' if present */` |
|    2981 | 12092 | `	if( pGen->pIn < pTmp && (pGen->pIn->nType & PH7_TK_RPAREN) ){` |
|    2981 | 12093 | `		pGen->pIn++;` |
|    1488 | 12094 | `	}` |
|       - | 12095 | `	/* Restore token stream */` |
|    2981 | 12096 | `	pGen->pEnd = pTmp;` |
|    2981 | 12097 | `	return SXRET_OK;` |
|    1493 | 12098 | `}` |
|       - | 12099 | `/*` |
...
|       - | 12131 | ` */` |
|  667258 | 12132 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 12133 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 12134 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 12135 | `	)` |
|       5 | 12136 | `{` |
|  667263 | 12137 | `	sxu32 n = 0;` |
| 3506661 | 12138 | `	for(;;){` |
| 7013327 | 12139 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  144987 | 12140 | `			break;` |
|       - | 12141 | `		}` |
| 6868345 | 12142 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  522281 | 12143 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 12148 | `				}` |
|     ! 0 | 12149 | `			}` |
|  522276 | 12150 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 12157 | `			*/` |
|  522281 | 12158 | `			return aLangConstruct[n].xConstruct;` |
|       - | 12159 | `		}` |
| 6346069 | 12160 | `		n++;` |
|       5 | 12161 | `	}` |
|  144987 | 12162 | `	if( pLookahed ){` |
|  144987 | 12163 | `		if(nKeywordID == PH7_TKWRD_INTERFACE && (pLookahed->nType & PH7_TK_ID) ){` |
|   40503 | 12164 | `			return PH7_CompileClassInterface;` |
|  104489 | 12165 | `		}else if(nKeywordID == PH7_TKWRD_CLASS && (pLookahed->nType & PH7_TK_ID) ){` |
|  104091 | 12166 | `			return PH7_CompileClass;` |
...
|       - | 12204 | ` */` |
|  796690 | 12205 | `static sxi32 GenStateCompileChunk(` |
...
|       - | 12211 | `	sxi32 rc;` |
|  796695 | 12212 | `	rc = SXRET_OK; /* Prevent compiler warning */` |
|  628081 | 12213 | `	for(;;){` |
| 1026431 | 12214 | `		int bStmtIsDeclare = 0;` |
| 1026431 | 12215 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
| 1008299 | 12221 | `		if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  670971 | 12222 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  670971 | 12223 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
|      45 | 12224 | `				bStmtIsDeclare = 1;` |
|      20 | 12225 | `			}` |
|  335483 | 12226 | `		}` |
| 1008299 | 12227 | `		if( !bStmtIsDeclare && pGen->pCurrent == &pGen->sGlobal ){` |
...
|  229711 | 12230 | `			pGen->bStrictTypesLocked = 1;` |
|  114853 | 12231 | `		}` |
| 1008299 | 12232 | `		if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 12233 | `			/* Compile block */` |
|    3697 | 12234 | `			rc = PH7_CompileBlock(&(*pGen),0);` |
|    3697 | 12235 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 | 12236 | `				break;` |
|       - | 12237 | `			}` |
|    1851 | 12238 | `		}else{` |
| 1004607 | 12239 | `			xCons = 0;` |
| 1004607 | 12240 | `			if( GenStateStartsModifiedClass(pGen->pIn,pGen->pEnd) ){` |
...
|    3739 | 12244 | `				xCons = PH7_CompileClassModifiers;` |
| 1002740 | 12245 | `			}else if( pGen->pIn->nType & PH7_TK_KEYWORD ){` |
|  667263 | 12246 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 12247 | `				/* Try to extract a language construct handler */` |
|  667263 | 12248 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  667263 | 12249 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|       4 | 12260 | `				}` |
|  667244 | 12261 | `			}else if( (pGen->pIn->nType & PH7_TK_ID) && (&pGen->pIn[1] < pGen->pEnd)` |
|   54719 | 12262 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
|       - | 12263 | `				/* Label found [i.e: Out: ],point to the routine responsible of compiling it */` |
|     117 | 12264 | `				xCons = PH7_CompileLabel;` |
|      56 | 12265 | `			}` |
| 1004607 | 12266 | `			if( xCons == 0 ){` |
|       - | 12267 | `				/* Assume an expression an try to compile it */` |
|  333829 | 12268 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  333829 | 12269 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 12270 | `					/* Pop l-value */` |
|  333679 | 12271 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  166837 | 12272 | `				}` |
|  166917 | 12273 | `			}else{` |
|       - | 12274 | `				/* Go compile the sucker */` |
|  670783 | 12275 | `				rc = xCons(&(*pGen));` |
|       - | 12276 | `			}` |
| 1004607 | 12277 | `			if( rc == SXERR_ABORT ){` |
|       - | 12278 | `				/* Request to abort compilation */` |
|      13 | 12279 | `				break;` |
|       - | 12280 | `			}` |
|       - | 12281 | `		}` |
|       - | 12282 | `		/* Ignore trailing semi-colons ';' */` |
| 1623417 | 12283 | `		while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|  615133 | 12284 | `			pGen->pIn++;` |
|       5 | 12285 | `		}` |
| 1008289 | 12286 | `		if( iFlags & PH7_COMPILE_SINGLE_STMT ){` |
...
|       - | 12302 | ` */` |
|   18144 | 12303 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 12307 | `	)` |
|       5 | 12308 | `{` |
|   18149 | 12309 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 12310 | `	sxi32 rc;` |
|       - | 12311 | `	/* Reset the token set */` |
|   18149 | 12312 | `	SySetReset(&(*pTokenSet));` |
|       - | 12313 | `	/* Mark as the default token set */` |
|   18149 | 12314 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 12315 | `	/* Advance the stream cursor */` |
|   18149 | 12316 | `	pGen->pRawIn++;` |
|       - | 12317 | `	/* Tokenize the PHP chunk first */` |
|   18149 | 12318 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 12319 | `	/* Point to the head and tail of the token stream. */` |
|   18149 | 12320 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   18149 | 12321 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   18149 | 12322 | `	if( is_expr ){` |
...
|       - | 12331 | `	}` |
|   18149 | 12332 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   18147 | 12357 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 12358 | `	/* Fix exceptions jumps */` |
|   18147 | 12359 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 12360 | `	/* Fix gotos now, the jump destination is resolved */` |
|   18147 | 12361 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 12362 | `		rc = SXERR_ABORT;` |
|       1 | 12363 | `	}` |
|       - | 12364 | `	/* Reset container */` |
|   18147 | 12365 | `	SySetReset(&pGen->aGoto);` |
|   18147 | 12366 | `	SySetReset(&pGen->aLabel);` |
|   18147 | 12367 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 12368 | `	/* Compilation result */` |
|   18147 | 12369 | `	return rc;` |
|    9077 | 12370 | `}` |
|       - | 12371 | `/*` |
...
|       - | 12375 | ` */` |
|   21180 | 12376 | `PH7_PRIVATE sxi32 PH7_CompileScript(` |
...
|       - | 12390 | `	sxi32 rc;` |
|   21185 | 12391 | `	if( pScript->nByte < 1 ){` |
...
|   21185 | 12397 | `	pCodeGen = &pVm->sCodeGen;` |
|   21185 | 12398 | `	bSavedStrict = pCodeGen->bStrictTypes;` |
|   21185 | 12399 | `	bSavedStrictLocked = pCodeGen->bStrictTypesLocked;` |
|   21185 | 12400 | `	pCodeGen->bStrictTypes = 0;` |
|   21185 | 12401 | `	pCodeGen->bStrictTypesLocked = 0;` |
|       - | 12402 | `	/* Initialize the tokens containers */` |
|   21185 | 12403 | `	SySetInit(&aRawToken,&pVm->sAllocator,sizeof(SyToken));` |
|   21185 | 12404 | `	SySetInit(&aPhpToken,&pVm->sAllocator,sizeof(SyToken));` |
|   21185 | 12405 | `	SySetAlloc(&aPhpToken,0xc0);` |
|   21185 | 12406 | `	is_expr = 0;` |
|   21185 | 12407 | `	if( iFlags & PH7_PHP_ONLY ){` |
|       - | 12408 | `		SyToken sTmp;` |
|       - | 12409 | `		/* PHP only: -*/` |
|    7421 | 12410 | `		sTmp.nLine = 1;` |
|    7421 | 12411 | `		sTmp.nType = PH7_TOKEN_PHP;` |
|    7421 | 12412 | `		sTmp.pUserData = 0;` |
|    7421 | 12413 | `		SyStringDupPtr(&sTmp.sData,pScript);` |
|    7421 | 12414 | `		SySetPut(&aRawToken,(const void *)&sTmp);` |
|    7421 | 12415 | `		if( iFlags & PH7_PHP_EXPR ){` |
|       - | 12416 | `			/* A simple PHP expression */` |
|     ! 0 | 12417 | `			is_expr = 1;` |
|     ! 0 | 12418 | `		}` |
|    3713 | 12419 | `	}else{` |
|       - | 12420 | `		/* Tokenize raw text */` |
|   13769 | 12421 | `		SySetAlloc(&aRawToken,32);` |
|   13769 | 12422 | `		PH7_TokenizeRawText(pScript->zString,pScript->nByte,&aRawToken);` |
|       - | 12423 | `	}` |
|       - | 12424 | `	/* Process high-level tokens */` |
|   21185 | 12425 | `	pCodeGen->pRawIn = (SyToken *)SySetBasePtr(&aRawToken);` |
|   21185 | 12426 | `	pCodeGen->pRawEnd = &pCodeGen->pRawIn[SySetUsed(&aRawToken)];` |
|   21185 | 12427 | `	rc = PH7_OK;` |
|   21185 | 12428 | `	if( is_expr ){` |
|       - | 12429 | `		/* Compile the expression */` |
|     ! 0 | 12430 | `		rc = PH7_CompilePHP(pCodeGen,&aPhpToken,TRUE);` |
|     ! 0 | 12431 | `		goto cleanup;` |
|       - | 12432 | `	}` |
|   21185 | 12433 | `	nObjIdx = 0;` |
...
|   21185 | 12437 | `	PH7_VmEmitInstr(pVm,PH7_OP_NSSWITCH,0,0,0,0);` |
|       - | 12438 | `	/* Start the compilation process */` |
|   17478 | 12439 | `	for(;;){` |
|   53093 | 12440 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   21173 | 12441 | `			break; /* No more tokens to process */` |
|       - | 12442 | `		}` |
|   31925 | 12443 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 12444 | `			/* Compile the PHP chunk */` |
|   18149 | 12445 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   18149 | 12446 | `			if( rc == SXERR_ABORT ){` |
|      15 | 12447 | `				break;` |
|       - | 12448 | `			}` |
|   18137 | 12449 | `			continue;` |
|       - | 12450 | `		}` |
|       - | 12451 | `		/* Raw chunk: [i.e: HTML, XML, etc.] */` |
|   13781 | 12452 | `		nRawObj = 0;` |
|   27599 | 12453 | `		while( (pCodeGen->pRawIn < pCodeGen->pRawEnd) && (pCodeGen->pRawIn->nType != PH7_TOKEN_PHP) ){` |
|       - | 12454 | `			/* Consume the raw chunk without any processing */` |
|   13823 | 12455 | `			pRawObj = PH7_ReserveConstObj(&(*pVm),&nObjIdx);` |
|   13823 | 12456 | `			if( pRawObj == 0 ){` |
|     ! 0 | 12457 | `				rc = SXERR_MEM;` |
|     ! 0 | 12458 | `				break;` |
|       - | 12459 | `			}` |
|       - | 12460 | `			/* Mark as constant and emit the load constant instruction */` |
|   13823 | 12461 | `			PH7_MemObjInitFromString(pVm,pRawObj,&pCodeGen->pRawIn->sData);` |
|   13823 | 12462 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_LOADC,0,nObjIdx,0,0);` |
|   13823 | 12463 | `			++nRawObj;` |
|   13823 | 12464 | `			pCodeGen->pRawIn++; /* Next chunk */` |
|       5 | 12465 | `		}` |
|   13781 | 12466 | `		if( nRawObj > 0 ){` |
|       - | 12467 | `			/* Emit the consume instruction */` |
|   13781 | 12468 | `			PH7_VmEmitInstr(&(*pVm),PH7_OP_CONSUME,nRawObj,0,0,0);` |
|    6888 | 12469 | `		}` |
|   10595 | 12470 | `	}` |
|   10590 | 12471 | `cleanup:` |
|   21185 | 12472 | `	SySetRelease(&aRawToken);` |
|   21185 | 12473 | `	SySetRelease(&aPhpToken);` |
|       - | 12474 | `	/* Restore outer file's strict_types scope */` |
|   21185 | 12475 | `	pCodeGen->bStrictTypes = bSavedStrict;` |
|   21185 | 12476 | `	pCodeGen->bStrictTypesLocked = bSavedStrictLocked;` |
|   21185 | 12477 | `	return rc;` |
|   10595 | 12478 | `}` |
|       - | 12479 | `/*` |
|       - | 12480 | ` * Utility routines.Initialize the code generator.` |
|       - | 12481 | ` */` |
|    3674 | 12482 | `PH7_PRIVATE sxi32 PH7_InitCodeGenerator(` |
|       - | 12483 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 12484 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 12485 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 12486 | `	)` |
|       5 | 12487 | `{` |
|    3679 | 12488 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 12489 | `	/* Zero the structure */` |
|    3679 | 12490 | `	SyZero(pGen,sizeof(ph7_gen_state));` |
|       - | 12491 | `	/* Initial state */` |
|    3679 | 12492 | `	pGen->pVm  = &(*pVm);` |
|    3679 | 12493 | `	pGen->xErr = xErr;` |
|    3679 | 12494 | `	pGen->pErrData = pErrData;` |
|    3679 | 12495 | `	SySetInit(&pGen->aLabel,&pVm->sAllocator,sizeof(Label));` |
|    3679 | 12496 | `	SySetInit(&pGen->aGoto,&pVm->sAllocator,sizeof(JumpFixup));` |
|    3679 | 12497 | `	SySetInit(&pGen->aNullsafeJmp,&pVm->sAllocator,sizeof(sxu32));` |
|    3679 | 12498 | `	SyHashInit(&pGen->hLiteral,&pVm->sAllocator,0,0);` |
|    3679 | 12499 | `	SyHashInit(&pGen->hVar,&pVm->sAllocator,0,0);` |
|       - | 12500 | `	/* Error log buffer */` |
|    3679 | 12501 | `	SyBlobInit(&pGen->sErrBuf,&pVm->sAllocator);` |
|       - | 12502 | `	/* General purpose working buffer */` |
|    3679 | 12503 | `	SyBlobInit(&pGen->sWorker,&pVm->sAllocator);` |
|       - | 12504 | `	/* Namespace state */` |
|    3679 | 12505 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|    3679 | 12506 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|    3679 | 12507 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|    3679 | 12508 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
|       - | 12509 | `	/* Create the global scope */` |
|    3679 | 12510 | `	GenStateInitBlock(pGen,&pGen->sGlobal,GEN_BLOCK_GLOBAL,PH7_VmInstrLength(&(*pVm)),0);` |
|       - | 12511 | `	/* Point to the global scope */` |
|    3679 | 12512 | `	pGen->pCurrent = &pGen->sGlobal;` |
|    3679 | 12513 | `	return SXRET_OK;` |
|       5 | 12514 | `}` |
|       - | 12515 | `/*` |
|       - | 12516 | ` * Utility routines. Reset the code generator to it's initial state.` |
|       - | 12517 | ` */` |
|   24490 | 12518 | `PH7_PRIVATE sxi32 PH7_ResetCodeGenerator(` |
|       - | 12519 | `	ph7_vm *pVm,       /* Target VM */` |
|       - | 12520 | `	ProcConsumer xErr, /* Error log consumer callabck  */` |
|       - | 12521 | `	void *pErrData     /* Last argument to xErr() */` |
|       - | 12522 | `	)` |
|       5 | 12523 | `{` |
|   24495 | 12524 | `	ph7_gen_state *pGen = &pVm->sCodeGen;` |
|       - | 12525 | `	GenBlock *pBlock,*pParent;` |
|       - | 12526 | `	/* Reset state */` |
|   24495 | 12527 | `	SySetReset(&pGen->aLabel);` |
|   24495 | 12528 | `	SySetReset(&pGen->aGoto);` |
|   24495 | 12529 | `	SySetReset(&pGen->aNullsafeJmp);` |
|   24495 | 12530 | `	SyBlobRelease(&pGen->sErrBuf);` |
|   24495 | 12531 | `	SyBlobRelease(&pGen->sWorker);` |
|   24495 | 12532 | `	SyBlobRelease(&pGen->sNamespace);` |
|   24495 | 12533 | `	SyBlobInit(&pGen->sNamespace,&pVm->sAllocator);` |
|   24495 | 12534 | `	SyHashRelease(&pGen->hUseImports);` |
|   24495 | 12535 | `	SyHashInit(&pGen->hUseImports,&pVm->sAllocator,0,0);` |
|   24495 | 12536 | `	SyHashRelease(&pGen->hUseFuncImports);` |
|   24495 | 12537 | `	SyHashInit(&pGen->hUseFuncImports,&pVm->sAllocator,0,0);` |
|   24495 | 12538 | `	SyHashRelease(&pGen->hUseConstImports);` |
|   24495 | 12539 | `	SyHashInit(&pGen->hUseConstImports,&pVm->sAllocator,0,0);` |
...
|   24495 | 12547 | `	pBlock = pGen->pCurrent;` |
|   24495 | 12548 | `	while( pBlock->pParent != 0 ){` |
|     ! 0 | 12549 | `		pParent = pBlock->pParent;` |
|     ! 0 | 12550 | `		GenStateFreeBlock(pBlock);` |
|     ! 0 | 12551 | `		pBlock = pParent;` |
|     ! 0 | 12552 | `	}` |
|   24495 | 12553 | `	pGen->xErr = xErr;` |
|   24495 | 12554 | `	pGen->pErrData = pErrData;` |
|   24495 | 12555 | `	pGen->pCurrent = &pGen->sGlobal;` |
|   24495 | 12556 | `	pGen->pRawIn = pGen->pRawEnd = 0;` |
|   24495 | 12557 | `	pGen->pIn = pGen->pEnd = 0;` |
|   24495 | 12558 | `	pGen->nErr = 0;` |
|   24495 | 12559 | `	return SXRET_OK;` |
|       5 | 12560 | `}` |
|       - | 12561 | `/*` |
