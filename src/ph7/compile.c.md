...
|       - |   160 | ` */` |
|  909090 |   161 | `static void GenStateInitBlock(` |
...
|  909095 |   170 | `	pBlock->nFirstInstr = nFirstInstr;` |
|  909095 |   171 | `	pBlock->pUserData   = pUserData;` |
|  909095 |   172 | `	pBlock->pGen        = pGen;` |
|  909095 |   173 | `	pBlock->iFlags      = iType;` |
|  909095 |   174 | `	pBlock->pParent     = 0;` |
|  909095 |   175 | `	SySetInit(&pBlock->aJumpFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  909095 |   176 | `	SySetInit(&pBlock->aPostContFix,&pGen->pVm->sAllocator,sizeof(JumpFixup));` |
|  909095 |   177 | `}` |
|       - |   178 | `/*` |
...
|       - |   183 | ` */` |
|  905260 |   184 | `static sxi32 GenStateEnterBlock(` |
...
|  905265 |   194 | `	pBlock = (GenBlock *)SyMemBackendPoolAlloc(&pGen->pVm->sAllocator,sizeof(GenBlock));` |
|  905265 |   195 | `	if( pBlock == 0 ){` |
...
|  905265 |   204 | `	SyZero(pBlock,sizeof(GenBlock));` |
|  905265 |   205 | `	GenStateInitBlock(&(*pGen),pBlock,iType,nFirstInstr,pUserData);` |
|       - |   206 | `	/* Link to the parent block */` |
|  905265 |   207 | `	pBlock->pParent = pGen->pCurrent;` |
|       - |   208 | `	/* Mark as the current block */` |
|  905265 |   209 | `	pGen->pCurrent = pBlock;` |
|  905265 |   210 | `	if( ppBlock ){` |
|       - |   211 | `		/* Write a pointer to the new instance */` |
|  437867 |   212 | `		*ppBlock = pBlock;` |
|  218931 |   213 | `	}` |
|  905265 |   214 | `	return SXRET_OK;` |
|  452635 |   215 | `}` |
|       - |   216 | `/*` |
|       - |   217 | ` * Release block fields without freeing the whole instance.` |
|       - |   218 | ` */` |
|  905252 |   219 | `static void GenStateReleaseBlock(GenBlock *pBlock)` |
|       5 |   220 | `{` |
|  905257 |   221 | `	SySetRelease(&pBlock->aPostContFix);` |
|  905257 |   222 | `	SySetRelease(&pBlock->aJumpFix);` |
|  905257 |   223 | `}` |
|       - |   224 | `/*` |
|       - |   225 | ` * Release a block.` |
|       - |   226 | ` */` |
|  905252 |   227 | `static void GenStateFreeBlock(GenBlock *pBlock)` |
|       5 |   228 | `{` |
|  905257 |   229 | `	ph7_gen_state *pGen = pBlock->pGen;` |
|  905257 |   230 | `	GenStateReleaseBlock(&(*pBlock));` |
|       - |   231 | `	/* Free the instance */` |
|  905257 |   232 | `	SyMemBackendPoolFree(&pGen->pVm->sAllocator,pBlock);` |
|  905257 |   233 | `}` |
|       - |   234 | `/*` |
|       - |   235 | ` * POP and release a block from the stack of compiled blocks.` |
|       - |   236 | ` */` |
|  905252 |   237 | `static sxi32 GenStateLeaveBlock(ph7_gen_state *pGen,GenBlock **ppBlock)` |
|       5 |   238 | `{` |
|  905257 |   239 | `	GenBlock *pBlock = pGen->pCurrent;` |
|  905257 |   240 | `	if( pBlock == 0 ){` |
|       - |   241 | `		/* No more block to pop */` |
|     ! 0 |   242 | `		return SXERR_EMPTY;` |
|       - |   243 | `	}` |
|       - |   244 | `	/* Point to the upper block */` |
|  905257 |   245 | `	pGen->pCurrent = pBlock->pParent;` |
|  905257 |   246 | `	if( ppBlock ){` |
|       - |   247 | `		/* Write a pointer to the popped block */` |
|     ! 0 |   248 | `		*ppBlock = pBlock;` |
|     ! 0 |   249 | `	}else{` |
|       - |   250 | `		/* Safely release the block */` |
|  905257 |   251 | `		GenStateFreeBlock(&(*pBlock));` |
|       - |   252 | `	}` |
|  905257 |   253 | `	return SXRET_OK;` |
|  452631 |   254 | `}` |
|       - |   255 | `/*` |
...
|       - |   286 | ` */` |
|  631048 |   287 | `static sxu32 GenStateFixJumps(GenBlock *pBlock,sxi32 nJumpType,sxu32 nJumpDest)` |
|       5 |   288 | `{` |
|       - |   289 | `	JumpFixup *aFix;` |
|       - |   290 | `	VmInstr *pInstr;` |
|       - |   291 | `	sxu32 nFixed;` |
...
|  631053 |   294 | `	aFix = (JumpFixup *)SySetBasePtr(&pBlock->aJumpFix);` |
|       - |   295 | `	/* Fix the desired jumps */` |
| 1136087 |   296 | `	for( nFixed = n = 0 ; n < SySetUsed(&pBlock->aJumpFix) ; ++n ){` |
|  505039 |   297 | `		if( aFix[n].nJumpType < 0 ){` |
|       - |   298 | `			/* Already fixed */` |
|  199421 |   299 | `			continue;` |
|       - |   300 | `		}` |
...
|       - |   323 | ` */` |
|  258258 |   324 | `static sxi32 GenStateFixGoto(ph7_gen_state *pGen,sxu32 nOfft)` |
|       5 |   325 | `{` |
...
|  258263 |   332 | `	aJumps = (JumpFixup *)SySetBasePtr(&pGen->aGoto);` |
|       - |   333 | `	/* Fix */` |
|  258409 |   334 | `	for( n = nOfft ; n < SySetUsed(&pGen->aGoto) ; ++n ){` |
...
|      46 |   357 | `		}` |
|      50 |   358 | `	}` |
|  258261 |   359 | `	aLabel = (Label *)SySetBasePtr(&pGen->aLabel);` |
|  258393 |   360 | `	for( n = 0 ; n < SySetUsed(&pGen->aLabel) ; ++n ){` |
...
|      12 |   365 | `		}` |
|      71 |   366 | `	}` |
|  258261 |   367 | `	return SXRET_OK;` |
|  129134 |   368 | `}` |
|       - |   369 | `/*` |
|       - |   370 | ` * Check if a given token value is installed in the literal table.` |
|       - |   371 | ` */` |
|  822234 |   372 | `static sxi32 GenStateFindLiteral(ph7_gen_state *pGen,const SyString *pValue,sxu32 *pIdx)` |
|       5 |   373 | `{` |
|       - |   374 | `	SyHashEntry *pEntry;` |
|  822239 |   375 | `	pEntry = SyHashGet(&pGen->hLiteral,(const void *)pValue->zString,pValue->nByte);` |
|  822239 |   376 | `	if( pEntry == 0 ){` |
|  371009 |   377 | `		return SXERR_NOTFOUND;` |
|       - |   378 | `	}` |
|  451235 |   379 | `	*pIdx = (sxu32)SX_PTR_TO_INT(pEntry->pUserData);` |
|  451235 |   380 | `	return SXRET_OK;` |
|  411122 |   381 | `}` |
|       - |   382 | `/*` |
...
|       - |   432 | ` */` |
|  513754 |   433 | `static void *GenStateAttachStrictFlag(ph7_gen_state *pGen, void *p3)` |
|       5 |   434 | `{` |
|       - |   435 | `	VmCallArgMap *pMap;` |
|  513759 |   436 | `	if( !pGen->bStrictTypes ) return p3;` |
|      39 |   437 | `	if( p3 == 0 ){` |
...
|       - |   683 | ` *` |
|       - |   684 | ` */` |
|  106676 |   685 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |   686 | `{` |
|  106681 |   687 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|       - |   688 | `	const char *zIn,*zCur,*zEnd;` |
|       - |   689 | `	ph7_value *pObj;` |
|       - |   690 | `	sxu32 nIdx;` |
|  106681 |   691 | `	nIdx = 0; /* Prevent compiler warning */` |
|       - |   692 | `	/* Delimit the string */` |
|  106681 |   693 | `	zIn  = pStr->zString;` |
|  106681 |   694 | `	zEnd = &zIn[pStr->nByte];` |
|  106681 |   695 | `	if( zIn >= zEnd ){` |
...
|       - |   700 | `	}` |
|   98847 |   701 | `	if( SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|       - |   702 | `		/* Already processed,emit the load constant instruction` |
|       - |   703 | `		 * and return.` |
|       - |   704 | `		 */` |
|   37543 |   705 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   37543 |   706 | `		return SXRET_OK;` |
|       - |   707 | `	}` |
...
|       - |   955 | ` */` |
|   26368 |   956 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|       5 |   957 | `{` |
|       - |   958 | `	ph7_value *pConstObj;` |
|   26373 |   959 | `	sxu32 nIdx = 0;` |
|       - |   960 | `	/* Reserve a new constant */` |
|   26373 |   961 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   26373 |   962 | `	if( pConstObj == 0 ){` |
|     ! 0 |   963 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|     ! 0 |   964 | `		return 0;` |
|       - |   965 | `	}` |
|   26373 |   966 | `	(*pCount)++;` |
|   26373 |   967 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|       - |   968 | `	/* Emit the load constant instruction */` |
|   26373 |   969 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   26373 |   970 | `	return pConstObj;` |
|   13189 |   971 | `}` |
|       - |   972 | `/*` |
...
|   24816 |  1034 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|       5 |  1035 | `{` |
|   24821 |  1036 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|       - |  1037 | `	const char *zIn,*zCur,*zEnd;` |
|   24821 |  1038 | `	ph7_value *pObj = 0;` |
|       - |  1039 | `	sxi32 iCons;` |
|       - |  1040 | `	sxi32 rc;` |
|       - |  1041 | `	/* Delimit the string */` |
|   24821 |  1042 | `	zIn  = pStr->zString;` |
|   24821 |  1043 | `	zEnd = &zIn[pStr->nByte];` |
|   24821 |  1044 | `	if( zIn >= zEnd ){` |
...
|       - |  1048 | `		 */` |
|     297 |  1049 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|     297 |  1050 | `		return SXRET_OK;` |
|       - |  1051 | `	}` |
|   24529 |  1052 | `	zCur = 0;` |
...
|   13430 |  1055 | `	for(;;){` |
|   40523 |  1056 | `		zCur = zIn;` |
|  183765 |  1057 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  145583 |  1058 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|      68 |  1059 | `				break;` |
|  145457 |  1060 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|    2214 |  1061 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|    1108 |  1062 | `					break;` |
|       - |  1063 | `			}` |
|  143247 |  1064 | `			zIn++;` |
|       5 |  1065 | `		}` |
|   40523 |  1066 | `		if( zIn > zCur ){` |
|   18275 |  1067 | `			if( pObj == 0 ){` |
|   17757 |  1068 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|   17757 |  1069 | `				if( pObj == 0 ){` |
|     ! 0 |  1070 | `					return SXERR_ABORT;` |
|       - |  1071 | `				}` |
|    8876 |  1072 | `			}` |
|   18275 |  1073 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    9135 |  1074 | `		}` |
|   40523 |  1075 | `		if( zIn >= zEnd ){` |
|   24527 |  1076 | `			break;` |
|       - |  1077 | `		}` |
|   16001 |  1078 | `		if( zIn[0] == '\\' ){` |
...
|    8621 |  1083 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    8621 |  1084 | `				if( pObj == 0 ){` |
...
|   24529 |  1361 | `	return SXRET_OK;` |
|   12413 |  1362 | `}` |
|       - |  1363 | `/*` |
|       - |  1364 | ` * Compile a double quoted string.` |
|       - |  1365 | ` *  See the block-comment above for more information.` |
|       - |  1366 | ` */` |
|   24754 |  1367 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  1368 | `{` |
|       - |  1369 | `	sxi32 rc;` |
|   24759 |  1370 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|   12377 |  1371 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|       - |  1372 | `	/* Compilation result */` |
|   24759 |  1373 | `	return rc;` |
|       5 |  1374 | `}` |
|       - |  1375 | `/*` |
...
|       - |  3024 | ` * Load a literal.` |
|       - |  3025 | ` */` |
|  844980 |  3026 | `static sxi32 GenStateLoadLiteral(ph7_gen_state *pGen)` |
|       5 |  3027 | `{` |
|  844985 |  3028 | `	SyToken *pToken = pGen->pIn;` |
|       - |  3029 | `	ph7_value *pObj;` |
|       - |  3030 | `	SyString *pStr;` |
|       - |  3031 | `	sxu32 nIdx;` |
|       - |  3032 | `	/* Extract token value */` |
|  844985 |  3033 | `	pStr = &pToken->sData;` |
|       - |  3034 | `	/* Deal with the reserved literals [i.e: null,false,true,...] first */` |
|  844985 |  3035 | `	if( pStr->nByte == sizeof("NULL") - 1 ){` |
...
|       5 |  3044 | `		}` |
|  779279 |  3045 | `	}else if (pStr->nByte == sizeof("FALSE") - 1 &&` |
...
|  675475 |  3050 | `	}else if(pStr->nByte == sizeof("__LINE__") - 1 &&` |
|  119928 |  3051 | `		SyMemcmp(pStr->zString,"__LINE__",sizeof("__LINE__")-1) == 0 ){` |
...
|  623385 |  3062 | `	}else if( pStr->nByte == sizeof("__NAMESPACE__") - 1 &&` |
...
|  612116 |  3079 | `	}else if( (pStr->nByte == sizeof("__FUNCTION__") - 1 &&` |
|   26846 |  3080 | `		SyMemcmp(pStr->zString,"__FUNCTION__",sizeof("__FUNCTION__")-1) == 0) \|\|` |
|  614614 |  3081 | `		(pStr->nByte == sizeof("__METHOD__") - 1 &&` |
...
|  716431 |  3112 | `	if( SXRET_OK != GenStateFindLiteral(&(*pGen),&pToken->sData,&nIdx) ){` |
...
|  716431 |  3124 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,1,nIdx,0,0);` |
|  716431 |  3125 | `	return SXRET_OK;` |
|  422495 |  3126 | `}` |
|       - |  3127 | `/*` |
...
|       - |  3132 | ` */` |
|  848858 |  3133 | `static sxi32 GenStateResolveNamespaceLiteral(ph7_gen_state *pGen)` |
|       5 |  3134 | `{` |
|       - |  3135 | `	sxi32 rc;` |
|  848863 |  3136 | `	if( pGen->pIn >= pGen->pEnd ){` |
|     ! 0 |  3137 | `		return SXRET_OK;` |
|       - |  3138 | `	}` |
|       - |  3139 | `	/* Check if this is a multi-token namespace path */` |
|  848863 |  3140 | `	if( pGen->pIn < &pGen->pEnd[-1] ){` |
...
|  844985 |  3193 | `	rc = GenStateLoadLiteral(&(*pGen));` |
|  844985 |  3194 | `	return rc;` |
|  424434 |  3195 | `}` |
|       - |  3196 | `/*` |
...
|     ! 0 |  3211 | `}` |
|  848858 |  3212 | `PH7_PRIVATE sxi32 PH7_CompileLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|       5 |  3213 | `{` |
|       - |  3214 | `	sxi32 rc;` |
|  848863 |  3215 | `	rc = GenStateResolveNamespaceLiteral(&(*pGen));` |
|  848863 |  3216 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  3217 | `		SXUNUSED(iCompileFlag); /* cc warning */` |
|     ! 0 |  3218 | `		return rc;` |
|       - |  3219 | `	}` |
|       - |  3220 | `	/* Node successfully compiled */` |
|  848863 |  3221 | `	return SXRET_OK;` |
|  424434 |  3222 | `}` |
|       - |  3223 | `/*` |
...
|       - |  3763 | ` * message.` |
|       - |  3764 | ` */` |
|  468872 |  3765 | `static sxi32 PH7_CompileBlock(` |
...
|       - |  3770 | `	sxi32 rc;` |
|       - |  3771 | `	sxu32 nLine;` |
|  468877 |  3772 | `	if( pGen->pIn->nType & PH7_TK_OCB /* '{' */ ){` |
...
|  235178 |  3804 | `	}else if( (pGen->pIn->nType & PH7_TK_COLON /* ':' */) && nKeywordEnd > 0 ){` |
|     ! 0 |  3805 | `		pGen->pIn++;` |
...
|  468877 |  3854 | `	while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_SEMI) ){` |
|     ! 0 |  3855 | `		pGen->pIn++;` |
|     ! 0 |  3856 | `	}` |
|  468877 |  3857 | `	return SXRET_OK;` |
|  234441 |  3858 | `}` |
|       - |  3859 | `/*` |
...
|       - |  4624 | ` *    ?>` |
|       - |  4625 | ` */` |
|  159668 |  4626 | `static sxi32 PH7_CompileIf(ph7_gen_state *pGen)` |
|       5 |  4627 | `{` |
|  159673 |  4628 | `	SyToken *pToken,*pTmp,*pEnd = 0;` |
|  159673 |  4629 | `	GenBlock *pCondBlock = 0;` |
|       - |  4630 | `	sxu32 nJumpIdx;` |
|       - |  4631 | `	sxu32 nKeyID;` |
|       - |  4632 | `	sxi32 rc;` |
|       - |  4633 | `	/* Jump the 'if' keyword */` |
|  159673 |  4634 | `	pGen->pIn++;` |
|  159673 |  4635 | `	pToken = pGen->pIn;` |
|       - |  4636 | `	/* Create the conditional block */` |
|  159673 |  4637 | `	rc = GenStateEnterBlock(&(*pGen),GEN_BLOCK_COND,PH7_VmInstrLength(pGen->pVm),0,&pCondBlock);` |
|  159673 |  4638 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  4639 | `		return SXERR_ABORT;` |
|       - |  4640 | `	}` |
|       - |  4641 | `	/* Process as many [if/else if/elseif/else] blocks as we can */` |
|   87553 |  4642 | `	for(;;){` |
|  175111 |  4643 | `		if( pToken >= pGen->pEnd \|\| (pToken->nType & PH7_TK_LPAREN) == 0 ){` |
|       - |  4644 | `			/* Syntax error */` |
...
|  175111 |  4658 | `		PH7_DelimitNestedTokens(pToken,pGen->pEnd,PH7_TK_LPAREN /* '(' */,PH7_TK_RPAREN /* ')' */,&pEnd);` |
|  175111 |  4659 | `		if( pToken >= pEnd \|\| (pEnd->nType & PH7_TK_RPAREN) == 0 ){` |
|       - |  4660 | `			/* Syntax error */` |
...
|  175111 |  4672 | `		SWAP_TOKEN_STREAM(pGen,pToken,pEnd);` |
|       - |  4673 | `		/* Compile the condition */` |
|  175111 |  4674 | `		rc = PH7_CompileExpr(&(*pGen),0,0);` |
|       - |  4675 | `		/* Update token stream */` |
|  175111 |  4676 | `		while(pGen->pIn < pEnd ){` |
|     ! 0 |  4677 | `			PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"Unexpected token '%z'",&pGen->pIn->sData);` |
|     ! 0 |  4678 | `			pGen->pIn++;` |
|     ! 0 |  4679 | `		}` |
|  175111 |  4680 | `		pGen->pIn  = &pEnd[1];` |
|  175111 |  4681 | `		pGen->pEnd = pTmp;` |
|  175111 |  4682 | `		if( rc == SXERR_ABORT ){` |
|       - |  4683 | `			/* Expression handler request an operation abort [i.e: Out-of-memory] */` |
|     ! 0 |  4684 | `			return SXERR_ABORT;` |
|       - |  4685 | `		}` |
|       - |  4686 | `		/* Emit the false jump */` |
|  175111 |  4687 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_JZ,0,0,0,&nJumpIdx);` |
|       - |  4688 | `		/* Save the instruction index so we can fix it later when the jump destination is resolved */` |
|  175111 |  4689 | `		GenStateNewJumpFixup(pCondBlock,PH7_OP_JZ,nJumpIdx);` |
|       - |  4690 | `		/* Compile the body */` |
|  175111 |  4691 | `		rc = PH7_CompileBlock(&(*pGen),PH7_TKWRD_ENDIF);` |
|  175111 |  4692 | `		if( rc == SXERR_ABORT ){` |
|     ! 0 |  4693 | `			return SXERR_ABORT;` |
|       - |  4694 | `		}` |
|  175111 |  4695 | `		if( pGen->pIn >= pGen->pEnd \|\| (pGen->pIn->nType & PH7_TK_KEYWORD) == 0 ){` |
|   48784 |  4696 | `			break;` |
|       - |  4697 | `		}` |
...
|  159673 |  4722 | `	GenStateFixJumps(pCondBlock,PH7_OP_JZ,PH7_VmInstrLength(pGen->pVm));` |
|  159673 |  4723 | `	if( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_KEYWORD) &&` |
...
|       - |  4731 | `			}` |
|    5989 |  4732 | `	}` |
|  159673 |  4733 | `	nJumpIdx = PH7_VmInstrLength(pGen->pVm);` |
|       - |  4734 | `	/* Fix all unconditional jumps now the destination is resolved */` |
|  159673 |  4735 | `	GenStateFixJumps(pCondBlock,PH7_OP_JMP,nJumpIdx);` |
|       - |  4736 | `	/* Release the conditional block */` |
|  159673 |  4737 | `	GenStateLeaveBlock(pGen,0);` |
|       - |  4738 | `	/* Statement successfully compiled */` |
|  159673 |  4739 | `	return SXRET_OK;` |
|     ! 0 |  4740 | `Synchronize:` |
...
|       - |  5001 | ` */` |
|   14686 |  5002 | `static sxi32 PH7_CompileEcho(ph7_gen_state *pGen)` |
|       5 |  5003 | `{` |
|   14691 |  5004 | `	SyToken *pTmp,*pNext = 0;` |
|       - |  5005 | `	sxi32 rc;` |
|       - |  5006 | `	/* Jump the 'echo' keyword */` |
|   14691 |  5007 | `	pGen->pIn++;` |
|       - |  5008 | `	/* Compile arguments one after one */` |
|   14691 |  5009 | `	pTmp = pGen->pEnd;` |
|   33745 |  5010 | `	while( SXRET_OK == PH7_GetNextExpr(pGen->pIn,pTmp,&pNext) ){` |
|   19059 |  5011 | `		if( pGen->pIn < pNext ){` |
|   19059 |  5012 | `			pGen->pEnd = pNext;` |
|   19059 |  5013 | `			rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD/* Do not create variable if inexistant */,0);` |
|   19059 |  5014 | `			if( rc == SXERR_ABORT ){` |
|     ! 0 |  5015 | `				return SXERR_ABORT;` |
|   19059 |  5016 | `			}else if( rc != SXERR_EMPTY ){` |
|       - |  5017 | `				/* Emit the consume instruction */` |
|   19035 |  5018 | `				PH7_VmEmitInstr(pGen->pVm,PH7_OP_CONSUME,1,0,0,0);` |
|    9515 |  5019 | `			}` |
|    9527 |  5020 | `		}` |
|       - |  5021 | `		/* Jump trailing commas */` |
|   23427 |  5022 | `		while( pNext < pTmp && (pNext->nType & PH7_TK_COMMA) ){` |
|    4373 |  5023 | `			pNext++;` |
|       5 |  5024 | `		}` |
|   19059 |  5025 | `		pGen->pIn = pNext;` |
|       5 |  5026 | `	}` |
|       - |  5027 | `	/* Restore token stream */` |
|   14691 |  5028 | `	pGen->pEnd = pTmp;` |
|   14691 |  5029 | `	return SXRET_OK;` |
|    7348 |  5030 | `}` |
|       - |  5031 | `/*` |
...
|       - |  5196 | ` */` |
|  493602 |  5197 | `static sxu32 GenStateNsQualifyName(ph7_gen_state *pGen,sxu32 nOrigIdx,SyHash *pImports,int *pFromImport)` |
|       5 |  5198 | `{` |
|       - |  5199 | `	ph7_value *pLit;` |
...
|       - |  5207 | `	ph7_value *pNew;` |
|  493607 |  5208 | `	if( pFromImport ){` |
|  472353 |  5209 | `		*pFromImport = 0;` |
|  236174 |  5210 | `	}` |
|  493607 |  5211 | `	pLit = (ph7_value *)SySetAt(&pGen->pVm->aLitObj,nOrigIdx);` |
|  493607 |  5212 | `	if( !pLit \|\| !(pLit->iFlags & MEMOBJ_STRING) \|\| SyBlobLength(&pLit->sBlob) == 0 ){` |
|     ! 0 |  5213 | `		return nOrigIdx;` |
|       - |  5214 | `	}` |
|  493607 |  5215 | `	zLit = (const char *)SyBlobData(&pLit->sBlob);` |
|  493607 |  5216 | `	nLit = (sxu32)SyBlobLength(&pLit->sBlob);` |
|       - |  5217 | `	/* Skip if already qualified (contains backslash) */` |
|  493607 |  5218 | `	hasNsSep = 0;` |
| 5447685 |  5219 | `	for( k = 0; k < nLit; k++ ){` |
| 4954091 |  5220 | `		if( zLit[k] == '\\' ){ hasNsSep = 1; break; }` |
| 2477044 |  5221 | `	}` |
|  493607 |  5222 | `	if( hasNsSep ){` |
|      10 |  5223 | `		return nOrigIdx;` |
|       - |  5224 | `	}` |
|       - |  5225 | `	/* Check use imports first (works even outside namespaces) */` |
|  493599 |  5226 | `	SyBlobReset(&pGen->sWorker);` |
|  493599 |  5227 | `	pImport = SyHashGet(pImports,(const void *)zLit,nLit);` |
|  493599 |  5228 | `	if( pImport ){` |
...
|       8 |  5233 | `		}` |
|      23 |  5234 | `	}else{` |
|  493563 |  5235 | `		if( SyBlobLength(&pGen->sNamespace) == 0 ){` |
|  493473 |  5236 | `			return nOrigIdx; /* Not in a namespace and no import match */` |
|       - |  5237 | `		}` |
...
|       5 |  8031 | `{` |
| 1816019 |  8032 | `	return (pTok->nType & PH7_TK_ID)` |
|  926223 |  8033 | `		&& pTok->sData.nByte == sizeof("readonly")-1` |
| 1816014 |  8034 | `		&& SyStrnicmp(pTok->sData.zString,"readonly",sizeof("readonly")-1) == 0;` |
|       5 |  8035 | `}` |
...
|  709801 | 10048 | `		sxu32 nKw = (sxu32)SX_PTR_TO_INT(pTok->pUserData);` |
|  709801 | 10049 | `		if( nKw == PH7_TKWRD_FINAL ){ *piFlag = PH7_CLASS_FINAL; return TRUE; }` |
|  702123 | 10050 | `		if( nKw == PH7_TKWRD_ABSTRACT ){ *piFlag = PH7_CLASS_ABSTRACT; return TRUE; }` |
|  351028 | 10051 | `	}` |
...
|       - | 11365 | ` */` |
| 2840790 | 11366 | `static void GenStatePatchNullsafeJumps(ph7_gen_state *pGen, sxu32 nBaseline)` |
|       5 | 11367 | `{` |
| 2840795 | 11368 | `	sxu32 nCur = SySetUsed(&pGen->aNullsafeJmp);` |
|       - | 11369 | `	sxu32 nTarget;` |
|       - | 11370 | `	sxu32 *aIdx;` |
|       - | 11371 | `	sxu32 i;` |
| 2840795 | 11372 | `	if( nCur <= nBaseline ){` |
| 2840701 | 11373 | `		return;` |
|       - | 11374 | `	}` |
...
|       - | 11402 | ` */` |
|  478332 | 11403 | `static sxu32 GenStateByRefBuiltinMask(SyString *pName)` |
|       5 | 11404 | `{` |
...
|       - | 11414 | `	};` |
|       - | 11415 | `	sxu32 i;` |
|  478337 | 11416 | `	if( pName == 0 \|\| pName->zString == 0 \|\| pName->nByte == 0 ){` |
|    2283 | 11417 | `		return 0;` |
|       - | 11418 | `	}` |
| 2380003 | 11419 | `	for( i = 0 ; i < SX_ARRAYSIZE(aByRef) ; ++i ){` |
| 1904038 | 11420 | `		if( pName->nByte == aByRef[i].nByte` |
|  976082 | 11421 | `		 && SyStrnicmp(pName->zString, aByRef[i].zName, pName->nByte) == 0 ){` |
|      99 | 11422 | `			return aByRef[i].mask;` |
|       - | 11423 | `		}` |
|  951977 | 11424 | `	}` |
|  475965 | 11425 | `	return 0;` |
|  239171 | 11426 | `}` |
|       - | 11427 | `/*` |
...
|       - | 11436 | ` */` |
|  478332 | 11437 | `static void GenStateCallBuiltinName(ph7_expr_node *pLeft, SyString *pOut)` |
|       5 | 11438 | `{` |
|       - | 11439 | `	SyToken *p, *pEnd;` |
|  478337 | 11440 | `	pOut->zString = 0;` |
|  478337 | 11441 | `	pOut->nByte = 0;` |
|  478337 | 11442 | `	if( pLeft == 0 \|\| pLeft->pStart == 0 \|\| pLeft->pEnd == 0 ){` |
|     ! 0 | 11443 | `		return;` |
|       - | 11444 | `	}` |
|  478337 | 11445 | `	p = pLeft->pStart;` |
|  478337 | 11446 | `	pEnd = pLeft->pEnd;` |
|       - | 11447 | `	/* Optional single leading namespace separator (absolute path). */` |
|  478337 | 11448 | `	if( p < pEnd && (p->nType & PH7_TK_NSSEP) ){` |
|    3863 | 11449 | `		p++;` |
|    1929 | 11450 | `	}` |
|  478337 | 11451 | `	if( p >= pEnd \|\| (p->nType & (PH7_TK_ID\|PH7_TK_KEYWORD)) == 0 ){` |
|    2247 | 11452 | `		return;` |
|       - | 11453 | `	}` |
|       - | 11454 | `	/* Must be a single component: nothing follows the name token. */` |
|  476095 | 11455 | `	if( p + 1 != pEnd ){` |
|      41 | 11456 | `		return;` |
|       - | 11457 | `	}` |
|  476059 | 11458 | `	*pOut = p->sData;` |
|  239171 | 11459 | `}` |
|       - | 11460 | `/*` |
...
|       - | 11465 | ` * error message.` |
|       - | 11466 | ` */` |
| 3804324 | 11467 | `static sxi32 GenStateEmitExprCode(` |
...
|       - | 11474 | `	sxu32 nJmpIdx;` |
| 3804329 | 11475 | `	sxi32 iP1 = 0;` |
| 3804329 | 11476 | `	sxu32 iP2 = 0;` |
| 3804329 | 11477 | `	void *p3  = 0;` |
|       - | 11478 | `	sxi32 iVmOp;` |
|       - | 11479 | `	sxi32 rc;` |
| 3804329 | 11480 | `	int bIsChainOp = 0; /* Set below once we know pNode->pOp */` |
| 3804329 | 11481 | ``	int bFcc = 0;       /* First-class callable `f(...)`: emit OP_LOAD_FCC, not OP_CALL */`` |
| 3804329 | 11482 | `	sxu32 nRhsNsBase = 0;` |
| 3804329 | 11483 | `	if( pNode->xCode ){` |
|       - | 11484 | `		SyToken *pTmpIn,*pTmpEnd;` |
|       - | 11485 | `		/* Compile node */` |
| 2374433 | 11486 | `		SWAP_DELIMITER(pGen,pNode->pStart,pNode->pEnd);` |
| 2374433 | 11487 | `		rc = pNode->xCode(&(*pGen),iFlags);` |
| 2374433 | 11488 | `		RE_SWAP_DELIMITER(pGen);` |
| 2374433 | 11489 | `		return rc;` |
|       - | 11490 | `	}` |
...
|       - | 11619 | `	}` |
| 1427195 | 11620 | `	bIsChainOp = GEN_IS_CHAIN_OP(pNode->pOp->iOp);` |
|       - | 11621 | `	/* Generate code for the left tree */` |
| 1427195 | 11622 | `	if( pNode->pLeft ){` |
| 1427155 | 11623 | `		sxu32 nLhsNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1427155 | 11624 | `		if( iVmOp == PH7_OP_CALL ){` |
|       - | 11625 | `			ph7_expr_node **apNode;` |
|  482333 | 11626 | `			int hasSpread = 0;` |
|  482333 | 11627 | `			int hasNamed = 0;` |
|  482333 | 11628 | `			int bAnySpread = 0;` |
|  482333 | 11629 | `			sxu32 byRefMask = 0;` |
|       - | 11630 | `			sxi32 nArgs;` |
|       - | 11631 | `			sxi32 n;` |
|       - | 11632 | `			/* Recurse and generate bytecodes for function arguments */` |
|  482333 | 11633 | `			apNode = (ph7_expr_node **)SySetBasePtr(&pNode->aNodeArgs);` |
|  482333 | 11634 | `			nArgs = (sxi32)SySetUsed(&pNode->aNodeArgs);` |
...
|  482333 | 11638 | `			if( nArgs == 1 && apNode[0] && (apNode[0]->iFlags & EXPR_NODE_FCC) ){` |
|      65 | 11639 | `				bFcc = 1;` |
|      65 | 11640 | `				nArgs = 0;` |
|      32 | 11641 | `			}` |
|       - | 11642 | `			/* Validate: no positional arguments after named arguments */` |
|       - | 11643 | `			{` |
|  482333 | 11644 | `				int seenNamed = 0;` |
|  978243 | 11645 | `				for( n = 0; n < nArgs; ++n ){` |
|  495917 | 11646 | `					if( apNode[n]->iFlags & EXPR_NODE_NAMED_ARG ){` |
|     253 | 11647 | `						seenNamed = 1;` |
|     253 | 11648 | `						hasNamed = 1;` |
|  495793 | 11649 | `					}else if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
|    3861 | 11650 | `						bAnySpread = 1;` |
|  493741 | 11651 | `					}else if( seenNamed ){` |
...
|  482331 | 11659 | `			iFlags \|= EXPR_FLAG_RDONLY_LOAD;` |
...
|  482331 | 11664 | `			if( pNode->pLeft && pNode->pLeft->pStart ){` |
|  482331 | 11665 | `				SyString *pCallName = &pNode->pLeft->pStart->sData;` |
|  482326 | 11666 | `				if( pCallName->nByte == 5` |
|  263309 | 11667 | `				 && SyStrnicmp(pCallName->zString,"isset",5) == 0 ){` |
|   23317 | 11668 | `					iFlags \|= EXPR_FLAG_LOAD_IDX_ISSET;` |
|  470675 | 11669 | `				}else if( pCallName->nByte == 5` |
|  239997 | 11670 | `				 && SyStrnicmp(pCallName->zString,"empty",5) == 0 ){` |
...
|  482331 | 11679 | `				if( !bAnySpread && !hasNamed ){` |
|       - | 11680 | `					SyString sBuiltin;` |
|  478337 | 11681 | `					GenStateCallBuiltinName(pNode->pLeft, &sBuiltin);` |
|  478337 | 11682 | `					byRefMask = GenStateByRefBuiltinMask(&sBuiltin);` |
|  239166 | 11683 | `				}` |
|  241163 | 11684 | `			}` |
|  978239 | 11685 | `			for( n = 0 ; n < nArgs ; ++n ){` |
|  495913 | 11686 | `				sxu32 nArgNsBase = SySetUsed(&pGen->aNullsafeJmp);` |
|  495913 | 11687 | `				sxi32 iArgFlags = iFlags & ~(EXPR_FLAG_LOAD_IDX_STORE\|EXPR_FLAG_MEMBER_WRITE);` |
...
|  495913 | 11694 | `				if( n < 31 && (byRefMask & (1u<<n)) ){` |
|      55 | 11695 | `					iArgFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|      55 | 11696 | `					iArgFlags \|= EXPR_FLAG_LOAD_IDX_STORE;` |
|      25 | 11697 | `				}` |
|  495913 | 11698 | `				rc = GenStateEmitExprCode(&(*pGen),apNode[n],iArgFlags);` |
|  495913 | 11699 | `				if( rc != SXRET_OK ){` |
|     ! 0 | 11700 | `					return rc;` |
|       - | 11701 | `				}` |
|       - | 11702 | `				/* Each argument is an independent nullsafe scope. */` |
|  495913 | 11703 | `				GenStatePatchNullsafeJumps(pGen, nArgNsBase);` |
|  495913 | 11704 | `				if( apNode[n]->iFlags & EXPR_NODE_SPREAD ){` |
...
|  482331 | 11747 | `			iFlags &= ~EXPR_FLAG_RDONLY_LOAD;` |
|  241163 | 11748 | `		}` |
|       - | 11749 | `		{` |
...
| 1427153 | 11758 | `			sxi32 iLeftFlags = iFlags;` |
| 1427148 | 11759 | `			if( pNode->pLeft && pNode->pLeft->pOp` |
| 1089674 | 11760 | `				&& (pNode->pLeft->pOp->iOp == EXPR_OP_ARROW` |
|  376125 | 11761 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
|  367408 | 11762 | `					\|\| pNode->pLeft->pOp->iOp == EXPR_OP_DC) ){` |
...
| 1427148 | 11772 | `			if( pNode->pOp` |
| 2045220 | 11773 | `				&& (pNode->pOp->iOp == EXPR_OP_ARROW` |
| 1331692 | 11774 | `					\|\| pNode->pOp->iOp == EXPR_OP_NULLSAFE_ARROW` |
| 1236185 | 11775 | `					\|\| pNode->pOp->iOp == EXPR_OP_DC) ){` |
|  191389 | 11776 | `				iLeftFlags &= ~EXPR_FLAG_MEMBER_WRITE;` |
|   95692 | 11777 | `			}` |
| 1427153 | 11778 | `			rc = GenStateEmitExprCode(&(*pGen),pNode->pLeft,iLeftFlags);` |
|       - | 11779 | `		}` |
| 1427153 | 11780 | `		if( rc != SXRET_OK ){` |
|      34 | 11781 | `			return rc;` |
|       - | 11782 | `		}` |
| 1427123 | 11783 | `		if( !bIsChainOp ){` |
...
|  654999 | 11786 | `			GenStatePatchNullsafeJumps(pGen, nLhsNsBase);` |
|  327497 | 11787 | `		}` |
| 1427123 | 11788 | `		if( iVmOp == PH7_OP_CALL ){` |
|  482331 | 11789 | `			pInstr = PH7_VmPeekInstr(pGen->pVm);` |
|  482331 | 11790 | `			if( pInstr ){` |
|  482331 | 11791 | `				if ( pInstr->iOp == PH7_OP_LOADC ){` |
|  476211 | 11792 | `					sxu32 nOrig = (sxu32)pInstr->iP2;` |
|       - | 11793 | `					sxu32 nQual;` |
|  476211 | 11794 | `					int bAbsolute = (pInstr->iP1 & PH7_LOADC_ABSOLUTE) != 0;` |
|       - | 11795 | `					/* Prevent constant expansion but preserve the absolute flag` |
|       - | 11796 | `					 * so the later NEW handler (if any) can see it. */` |
|  476211 | 11797 | `					pInstr->iP1 &= ~PH7_LOADC_EXPAND;` |
...
|  476211 | 11805 | `					if( bAbsolute ){` |
|    3863 | 11806 | `						pInstr->iP2 = (sxi32)nOrig;` |
|    1934 | 11807 | `					}else{` |
|  472353 | 11808 | `						int fromImport = 0;` |
|  472353 | 11809 | `						nQual = GenStateNsQualifyName(pGen,nOrig,&pGen->hUseFuncImports,&fromImport);` |
|  472353 | 11810 | `						pInstr->iP2 = (sxi32)nQual;` |
|  472353 | 11811 | `						if( nQual != nOrig ){` |
...
|      36 | 11829 | `						}` |
|       5 | 11830 | `					}` |
|  244228 | 11831 | `				}else if( pInstr->iOp == PH7_OP_MEMBER /* $a->b(1,2,3) */ \|\| pInstr->iOp == PH7_OP_NEW ){` |
|       - | 11832 | `					/* Method call,flag that */` |
|    1839 | 11833 | `					pInstr->iP2 = 1;` |
|     917 | 11834 | `				}` |
|  241168 | 11835 | `			}` |
| 1185960 | 11836 | `		}else if( iVmOp == PH7_OP_LOAD_IDX ){` |
...
|   38825 | 11870 | `				iP2 = 1;` |
|   19415 | 11871 | `			}` |
|  895590 | 11872 | `		}else if( pNode->pOp->iOp == EXPR_OP_COMMA ){` |
|       - | 11873 | `			/* POP the left node */` |
|      32 | 11874 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|      15 | 11875 | `		}` |
|  713559 | 11876 | `	}` |
| 1427163 | 11877 | `	rc = SXRET_OK;` |
| 1427163 | 11878 | `	nJmpIdx = 0;` |
...
| 1427163 | 11882 | `	if( iVmOp == PH7_OP_MEMBER && pNode->pOp->iOp == EXPR_OP_DC ){` |
...
|      27 | 11987 | `		}` |
|  384879 | 11988 | `	}` |
| 1427076 | 11989 | `	if( iVmOp == PH7_OP_NEW && pNode->pLeft && pNode->pLeft->pOp == 0` |
...
|      30 | 11993 | `		iVmOp = 0;` |
|      13 | 11994 | `	}` |
| 1427081 | 11995 | `	if( iVmOp > 0 ){` |
| 1426821 | 11996 | `		if( iVmOp == PH7_OP_INCR \|\| iVmOp == PH7_OP_DECR ){` |
|   15733 | 11997 | `			if( pNode->iFlags & EXPR_NODE_PRE_INCR ){` |
|       - | 11998 | `				/* Pre-increment/decrement operator [i.e: ++$i,--$j ] */` |
|   11515 | 11999 | `				iP1 = 1;` |
|    5760 | 12000 | `			}` |
| 1418957 | 12001 | `		}else if( iVmOp == PH7_OP_NEW ){` |
...
|   12244 | 12039 | `				}` |
|   12249 | 12040 | `			}` |
| 1398753 | 12041 | `		}else if( iVmOp == PH7_OP_IS_A ){` |
...
|      88 | 12061 | `				}` |
|     103 | 12062 | `			}` |
| 1386317 | 12063 | `		}else if( iVmOp == PH7_OP_MEMBER){` |
...
| 1426819 | 12124 | `		if( iVmOp == PH7_OP_CALL \|\| iVmOp == PH7_OP_NEW ){` |
|  506947 | 12125 | `			p3 = GenStateAttachStrictFlag(pGen,p3);` |
|  253471 | 12126 | `		}` |
|       - | 12127 | `		/* Finally,emit the VM instruction associated with this operator */` |
| 1426819 | 12128 | `		PH7_VmEmitInstr(pGen->pVm,iVmOp,iP1,iP2,p3,0);` |
|  713407 | 12129 | `	}` |
| 1427079 | 12130 | `	if( nJmpIdx > 0 ){` |
...
|       - | 12148 | ` * message.` |
|       - | 12149 | ` */` |
| 1024520 | 12150 | `static sxi32 PH7_CompileExpr(` |
...
| 1024525 | 12164 | `	nExpr = 0;` |
| 1024525 | 12165 | `	pRoot = 0;` |
...
| 1024525 | 12168 | `	nNullsafeBase = SySetUsed(&pGen->aNullsafeJmp);` |
| 1024525 | 12169 | `	SySetInit(&sExprNode,&pGen->pVm->sAllocator,sizeof(ph7_expr_node *));` |
| 1024525 | 12170 | `	SySetAlloc(&sExprNode,0x10);` |
| 1024525 | 12171 | `	rc = SXRET_OK;` |
|       - | 12172 | `	/* Delimit the expression */` |
| 1024525 | 12173 | `	pEnd = pGen->pIn;` |
| 1024525 | 12174 | `	iNest = 0;` |
| 6913921 | 12175 | `	while( pEnd < pGen->pEnd ){` |
| 6562027 | 12176 | `		if( pEnd->nType & PH7_TK_OCB /* '{' */ ){` |
|       - | 12177 | `			/* Ticket 1433-30: Annonymous/Closure functions body */` |
|     557 | 12178 | `			iNest++;` |
| 6561751 | 12179 | `		}else if(pEnd->nType & PH7_TK_CCB /* '}' */ ){` |
|     565 | 12180 | `			iNest--;` |
| 6561195 | 12181 | `		}else if( pEnd->nType & PH7_TK_SEMI /* ';' */ ){` |
|  673059 | 12182 | `			if( iNest <= 0 ){` |
|  672631 | 12183 | `				break;` |
|       - | 12184 | `			}` |
|     214 | 12185 | `		}` |
| 5889401 | 12186 | `		pEnd++;` |
|       5 | 12187 | `	}` |
| 1024525 | 12188 | `	if( iFlags & EXPR_FLAG_COMMA_STATEMENT ){` |
...
|       3 | 12206 | `		}` |
|   11785 | 12207 | `	}` |
| 1024525 | 12208 | `	if( pEnd > pGen->pIn ){` |
| 1024515 | 12209 | `		SyToken *pTmp = pGen->pEnd;` |
|       - | 12210 | `		/* Swap delimiter */` |
| 1024515 | 12211 | `		pGen->pEnd = pEnd;` |
|       - | 12212 | `		/* Try to get an expression tree */` |
| 1024515 | 12213 | `		rc = PH7_ExprMakeTree(&(*pGen),&sExprNode,&pRoot);` |
| 1024515 | 12214 | `		if( rc == SXRET_OK && pRoot ){` |
| 1024333 | 12215 | `			rc = SXRET_OK;` |
| 1024333 | 12216 | `			if( xTreeValidator ){` |
|       - | 12217 | `				/* Call the upper layer validator callback */` |
|   30927 | 12218 | `				rc = xTreeValidator(&(*pGen),pRoot);` |
|   15461 | 12219 | `			}` |
| 1024333 | 12220 | `			if( rc != SXERR_ABORT ){` |
|       - | 12221 | `				/* Generate code for the given tree */` |
| 1024333 | 12222 | `				rc = GenStateEmitExprCode(&(*pGen),pRoot,iFlags);` |
|       - | 12223 | `				/* Patch any unresolved nullsafe jumps emitted by this` |
|       - | 12224 | `				 * expression so they short-circuit to its end. */` |
| 1024333 | 12225 | `				GenStatePatchNullsafeJumps(pGen, nNullsafeBase);` |
|  512164 | 12226 | `			}` |
| 1024333 | 12227 | `			nExpr = 1;` |
|  512164 | 12228 | `		}` |
|       - | 12229 | `		/* Release the whole tree */` |
| 1024515 | 12230 | `		PH7_ExprFreeTree(&(*pGen),&sExprNode);` |
|       - | 12231 | `		/* Synchronize token stream */` |
| 1024515 | 12232 | `		pGen->pEnd = pTmp;` |
| 1024515 | 12233 | `		pGen->pIn  = pEnd;` |
| 1024515 | 12234 | `		if( rc == SXERR_ABORT ){` |
|      13 | 12235 | `			SySetRelease(&sExprNode);` |
|      13 | 12236 | `			return SXERR_ABORT;` |
|       - | 12237 | `		}` |
|  512250 | 12238 | `	}` |
| 1024515 | 12239 | `	SySetRelease(&sExprNode);` |
| 1024515 | 12240 | `	return nExpr > 0 ? SXRET_OK : SXERR_EMPTY;` |
|  512265 | 12241 | `}` |
|       - | 12242 | `/*` |
|       - | 12243 | ` * Return a pointer to the node construct handler associated` |
|       - | 12244 | ` * with a given node type [i.e: string,integer,float,...].` |
|       - | 12245 | ` */` |
|  266512 | 12246 | `PH7_PRIVATE ProcNodeConstruct PH7_GetNodeHandler(sxu32 nNodeType)` |
|       5 | 12247 | `{` |
|  266517 | 12248 | `	if( nNodeType & PH7_TK_NUM ){` |
...
|   24765 | 12253 | `		return PH7_CompileString;` |
|  106801 | 12254 | `	}else if( nNodeType & PH7_TK_SSTR ){` |
|       - | 12255 | `		/* Single quoted string */` |
|  106681 | 12256 | `		return PH7_CompileSimpleString;` |
...
|       - | 12384 | ` */` |
|  694280 | 12385 | `static ProcLangConstruct GenStateGetStatementHandler(` |
|       - | 12386 | `	sxu32 nKeywordID,   /* Keyword  ID*/` |
|       - | 12387 | `	SyToken *pLookahed  /* Look-ahead token */` |
|       - | 12388 | `	)` |
|       5 | 12389 | `{` |
|  694285 | 12390 | `	sxu32 n = 0;` |
| 3655957 | 12391 | `	for(;;){` |
| 7311919 | 12392 | `		if( n >= SX_ARRAYSIZE(aLangConstruct) ){` |
|  151189 | 12393 | `			break;` |
|       - | 12394 | `		}` |
| 7160735 | 12395 | `		if( aLangConstruct[n].nID == nKeywordID ){` |
|  543101 | 12396 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed && (pLookahed->nType & PH7_TK_OP)){` |
...
|       - | 12401 | `				}` |
|     ! 0 | 12402 | `			}` |
|  543096 | 12403 | `			if( nKeywordID == PH7_TKWRD_STATIC && pLookahed` |
...
|       - | 12410 | `			*/` |
|  543101 | 12411 | `			return aLangConstruct[n].xConstruct;` |
|       - | 12412 | `		}` |
| 6617639 | 12413 | `		n++;` |
|       5 | 12414 | `	}` |
...
|  652973 | 12466 | `	for(;;){` |
| 1067813 | 12467 | `		int bStmtIsDeclare = 0;` |
| 1067813 | 12468 | `		if( pGen->pIn >= pGen->pEnd ){` |
...
|  698149 | 12475 | `			sxu32 nPeek = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|  698149 | 12476 | `			if( nPeek == PH7_TKWRD_DECLARE ){` |
...
|  694285 | 12499 | `				sxu32 nKeyword = (sxu32)SX_PTR_TO_INT(pGen->pIn->pUserData);` |
|       - | 12500 | `				/* Try to extract a language construct handler */` |
|  694285 | 12501 | `				xCons = GenStateGetStatementHandler(nKeyword,(&pGen->pIn[1] < pGen->pEnd) ? &pGen->pIn[1] : 0);` |
|  694285 | 12502 | `				if( xCons == 0 && GenStateisLangConstruct(nKeyword) == FALSE ){` |
...
|   57365 | 12515 | `				&& (pGen->pIn[1].nType & PH7_TK_COLON /*':'*/) ){` |
...
|  348023 | 12521 | `				rc = PH7_CompileExpr(&(*pGen),0,0);` |
|  348023 | 12522 | `				if(  rc != SXERR_EMPTY ){` |
|       - | 12523 | `					/* Pop l-value */` |
|  347873 | 12524 | `					PH7_VmEmitInstr(pGen->pVm,PH7_OP_POP,1,0,0,0);` |
|  173934 | 12525 | `				}` |
|  174014 | 12526 | `			}else{` |
|       - | 12527 | `				/* Go compile the sucker */` |
|  697869 | 12528 | `				rc = xCons(&(*pGen));` |
|       - | 12529 | `			}` |
...
|       - | 12555 | ` */` |
|   18090 | 12556 | `static sxi32 PH7_CompilePHP(` |
...
|       - | 12560 | `	)` |
|       5 | 12561 | `{` |
|   18095 | 12562 | `	SyToken *pScript = pGen->pRawIn; /* Script to compile */` |
|       - | 12563 | `	sxi32 rc;` |
|       - | 12564 | `	/* Reset the token set */` |
|   18095 | 12565 | `	SySetReset(&(*pTokenSet));` |
|       - | 12566 | `	/* Mark as the default token set */` |
|   18095 | 12567 | `	pGen->pTokenSet = &(*pTokenSet);` |
|       - | 12568 | `	/* Advance the stream cursor */` |
|   18095 | 12569 | `	pGen->pRawIn++;` |
|       - | 12570 | `	/* Tokenize the PHP chunk first */` |
|   18095 | 12571 | `	PH7_TokenizePHP(SyStringData(&pScript->sData),SyStringLength(&pScript->sData),pScript->nLine,&(*pTokenSet));` |
|       - | 12572 | `	/* Point to the head and tail of the token stream. */` |
|   18095 | 12573 | `	pGen->pIn  = (SyToken *)SySetBasePtr(pTokenSet);` |
|   18095 | 12574 | `	pGen->pEnd = &pGen->pIn[SySetUsed(pTokenSet)];` |
|   18095 | 12575 | `	if( is_expr ){` |
...
|       - | 12584 | `	}` |
|   18095 | 12585 | `	if( pGen->pIn < pGen->pEnd && ( pGen->pIn->nType & PH7_TK_EQUAL ) ){` |
...
|   18093 | 12610 | `	rc = GenStateCompileChunk(pGen,0);` |
|       - | 12611 | `	/* Fix exceptions jumps */` |
|   18093 | 12612 | `	GenStateFixJumps(pGen->pCurrent,PH7_OP_THROW,PH7_VmInstrLength(pGen->pVm));` |
|       - | 12613 | `	/* Fix gotos now, the jump destination is resolved */` |
|   18093 | 12614 | `	if( SXERR_ABORT == GenStateFixGoto(&(*pGen),0) ){` |
|       3 | 12615 | `		rc = SXERR_ABORT;` |
|       1 | 12616 | `	}` |
|       - | 12617 | `	/* Reset container */` |
|   18093 | 12618 | `	SySetReset(&pGen->aGoto);` |
|   18093 | 12619 | `	SySetReset(&pGen->aLabel);` |
|   18093 | 12620 | `	SySetReset(&pGen->aNullsafeJmp);` |
|       - | 12621 | `	/* Compilation result */` |
|   18093 | 12622 | `	return rc;` |
|    9050 | 12623 | `}` |
|       - | 12624 | `/*` |
...
|   17121 | 12692 | `	for(;;){` |
|   52325 | 12693 | `		if( pCodeGen->pRawIn >= pCodeGen->pRawEnd ){` |
|   20987 | 12694 | `			break; /* No more tokens to process */` |
|       - | 12695 | `		}` |
|   31343 | 12696 | `		if( pCodeGen->pRawIn->nType & PH7_TOKEN_PHP ){` |
|       - | 12697 | `			/* Compile the PHP chunk */` |
|   18095 | 12698 | `			rc = PH7_CompilePHP(pCodeGen,&aPhpToken,FALSE);` |
|   18095 | 12699 | `			if( rc == SXERR_ABORT ){` |
|      15 | 12700 | `				break;` |
|       - | 12701 | `			}` |
|   18083 | 12702 | `			continue;` |
|       - | 12703 | `		}` |
