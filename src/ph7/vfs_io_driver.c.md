...
|    - |  633 | ` */` |
| 3960 |  634 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|    5 |  635 | `{` |
|    - |  636 | `	pipe_private *pPipe;` |
|    - |  637 | `	FILE *pFile;` |
| 3965 |  638 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|  ! 0 |  639 | `		return 0;` |
|    - |  640 | `	}` |
|    - |  641 | `	/* Validate mode - only 'r' or 'w' allowed */` |
| 3965 |  642 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|  ! 0 |  643 | `		return 0;` |
|    - |  644 | `	}` |
...
| 3960 |  706 | `	pFile = popen(zCommand, zMode);` |
| 3960 |  707 | `	if( pFile == 0 ){` |
|  ! 0 |  708 | `		return 0;` |
|    - |  709 | `	}` |
|    - |  710 | `	/* Allocate pipe private structure */` |
| 3960 |  711 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
| 3960 |  712 | `	if( pPipe == 0 ){` |
...
| 3960 |  718 | `	pPipe->pFile = pFile;` |
| 3960 |  719 | `	pPipe->pVm = pVm;` |
| 3960 |  720 | `	pPipe->iMode = zMode[0];` |
|    - |  721 | `#else /* OS_OTHER: no process pipes on this platform */` |
|    - |  722 | `	(void)pFile;` |
|    - |  723 | `	return 0;` |
|    - |  724 | `#endif` |
| 3965 |  725 | `	return pPipe;` |
| 1985 |  726 | `}` |
|    - |  727 | `/*` |
|    - |  728 | ` * Close a pipe and return the exit status of the process.` |
|    - |  729 | ` * Returns the exit status, or -1 on error.` |
|    - |  730 | ` */` |
| 3934 |  731 | `static int PipeClose(pipe_private *pPipe)` |
|    5 |  732 | `{` |
|    - |  733 | `	int status;` |
|    - |  734 | `	ph7_vm *pVm;` |
| 3939 |  735 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|  ! 0 |  736 | `		return -1;` |
|    - |  737 | `	}` |
| 3939 |  738 | `	pVm = pPipe->pVm;` |
...
| 3934 |  744 | `	status = pclose(pPipe->pFile);` |
|    - |  745 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
| 3934 |  746 | `	if( status != -1 ){` |
| 3934 |  747 | `		if( WIFEXITED(status) ){` |
| 3934 |  748 | `			status = WEXITSTATUS(status);` |
| 1967 |  749 | `		}else if( WIFSIGNALED(status) ){` |
...
| 3939 |  761 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
| 3939 |  762 | `	return status;` |
| 1972 |  763 | `}` |
|    - |  764 | `/*` |
...
|    - |  796 | `	}` |
| 1990 |  797 | `	return (ph7_int64)nRead;` |
| 2980 |  798 | `}` |
|    - |  799 | `/*` |
...
|    - |  840 | ` * FALSE otherwise.` |
|    - |  841 | ` */` |
| 3832 |  842 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|    5 |  843 | `{` |
| 3837 |  844 | `	return pStream == &sPipe_Stream;` |
|    5 |  845 | `}` |
|    - |  846 | `/*` |
...
|  ! 0 |  903 | `	return PH7_OK;` |
|  ! 0 |  904 | `}` |
| 3960 |  905 | `PH7_PRIVATE int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    5 |  906 | `{` |
|    - |  907 | `	const char *zCommand, *zMode;` |
|    - |  908 | `	pipe_private *pPipe;` |
|    - |  909 | `	io_private *pDev;` |
|    - |  910 | `	int nCmdLen, nModeLen;` |
| 3965 |  911 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
| 3965 |  918 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
| 3965 |  919 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
| 3965 |  920 | `	if( nCmdLen < 1 ){` |
|  ! 0 |  921 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|  ! 0 |  922 | `		ph7_result_bool(pCtx, 0);` |
|  ! 0 |  923 | `		return PH7_OK;` |
|    - |  924 | `	}` |
| 3965 |  925 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
|  ! 0 |  926 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Invalid mode, expected 'r' or 'w'");` |
|  ! 0 |  927 | `		ph7_result_bool(pCtx, 0);` |
|  ! 0 |  928 | `		return PH7_OK;` |
|    - |  929 | `	}` |
|    - |  930 | `	/* Open the pipe */` |
| 3965 |  931 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
| 3965 |  932 | `	if( pPipe == 0 ){` |
...
| 3965 |  938 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
| 3965 |  939 | `	if( pDev == 0 ){` |
...
| 3965 |  946 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
| 3965 |  947 | `	pDev->pHandle = pPipe;` |
|    - |  948 | `	/* Return the io_private instance as a resource */` |
| 3965 |  949 | `	ph7_result_resource(pCtx, pDev);` |
| 3965 |  950 | `	return PH7_OK;` |
| 1985 |  951 | `}` |
|    - |  952 | `/*` |
...
|    - |  960 | ` */` |
| 3832 |  961 | `PH7_PRIVATE int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    5 |  962 | `{` |
|    - |  963 | `	const ph7_io_stream *pStream;` |
|    - |  964 | `	pipe_private *pPipe;` |
|    - |  965 | `	io_private *pDev;` |
|    - |  966 | `	int status;` |
| 3837 |  967 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
| 3837 |  974 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|    - |  975 | `	/* Make sure we are dealing with a valid io_private instance */` |
| 3837 |  976 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
| 3837 |  982 | `	pStream = pDev->pStream;` |
| 3837 |  983 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
| 3837 |  989 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|    - |  990 | `	/* Close the pipe and get exit status */` |
| 3837 |  991 | `	status = PipeClose(pPipe);` |
|    - |  992 | `	/* Keep the handle alive but flag it closed so shared copies see it */` |
| 3837 |  993 | `	MarkIOPrivateClosed(pDev);` |
|    - |  994 | `	/* Return the exit status */` |
| 3837 |  995 | `	ph7_result_int(pCtx, status);` |
| 3837 |  996 | `	return PH7_OK;` |
| 1921 |  997 | `}` |
|    - |  998 | `/*` |
