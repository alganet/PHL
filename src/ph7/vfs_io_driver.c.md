...
|    - |   76 | ` */` |
|  104 |   77 | `static ph7_stream_data * PHPStreamDataInit(ph7_vm *pVm,int iType)` |
|    4 |   78 | `{` |
...
|  108 |   84 | `	pData = (ph7_stream_data *)SyMemBackendAlloc(&pVm->sAllocator,sizeof(ph7_stream_data));` |
|  108 |   85 | `	if( pData == 0 ){` |
|  ! 0 |   86 | `		return 0;` |
|    - |   87 | `	}` |
|    - |   88 | `	/* Zero the structure */` |
|  108 |   89 | `	SyZero(pData,sizeof(ph7_stream_data));` |
|    - |   90 | `	/* Initialize fields */` |
|  108 |   91 | `	pData->iType = iType;` |
|  108 |   92 | `	SyBlobInit(&pData->sMem,&pVm->sAllocator);` |
|  108 |   93 | `	pData->nCur = 0;` |
|  108 |   94 | `	pData->bReadOnly = 0;` |
|  108 |   95 | `	if( iType == PH7_IO_STREAM_MEMORY ){` |
|    - |   96 | `		/* Nothing else to set up: the buffer is the stream */` |
|   62 |   97 | `	}else if( iType == PH7_IO_STREAM_OUTPUT ){` |
...
|    - |  121 | `#endif` |
|    - |  122 | `	}` |
|  108 |  123 | `	pData->pVm = pVm;` |
|  108 |  124 | `	return pData;` |
|   56 |  125 | `}` |
|    - |  126 | `/*` |
...
|   78 |  132 | `static int PHPStreamData_Open(const char *zName,int iMode,ph7_value *pResource,void ** ppHandle)` |
|    4 |  133 | `{` |
|    - |  134 | `	ph7_stream_data *pData;` |
|    - |  135 | `	SyString sStream;` |
|   82 |  136 | `	SyStringInitFromBuf(&sStream,zName,SyStrlen(zName));` |
|    - |  137 | `	/* Trim leading and trailing white spaces */` |
|   82 |  138 | `	SyStringFullTrim(&sStream);` |
|    - |  139 | `	/* Stream to open */` |
|   82 |  140 | `	if( SyStrnicmp(sStream.zString,"stdin",sizeof("stdin")-1) == 0 ){` |
|  ! 0 |  141 | `		iMode = PH7_IO_STREAM_STDIN;` |
|   82 |  142 | `	}else if( SyStrnicmp(sStream.zString,"output",sizeof("output")-1) == 0 ){` |
|    3 |  143 | `		iMode = PH7_IO_STREAM_OUTPUT;` |
|   81 |  144 | `	}else if( SyStrnicmp(sStream.zString,"stdout",sizeof("stdout")-1) == 0 ){` |
|  ! 0 |  145 | `		iMode = PH7_IO_STREAM_STDOUT;` |
|   80 |  146 | `	}else if( SyStrnicmp(sStream.zString,"stderr",sizeof("stderr")-1) == 0 ){` |
|  ! 0 |  147 | `		iMode = PH7_IO_STREAM_STDERR;` |
|   76 |  148 | `	}else if( SyStrnicmp(sStream.zString,"memory",sizeof("memory")-1) == 0` |
|   43 |  149 | `	       \|\| SyStrnicmp(sStream.zString,"temp",sizeof("temp")-1) == 0 ){` |
|    - |  150 | `		/* php://memory and php://temp (PHL keeps temp fully in memory —` |
|    - |  151 | `		 * php's 2MB disk spill is a memory-pressure detail, recorded) */` |
|   80 |  152 | `		iMode = PH7_IO_STREAM_MEMORY;` |
|   42 |  153 | `	}else{` |
|    - |  154 | `		/* unknown stream name */` |
|  ! 0 |  155 | `		return -1;` |
|    - |  156 | `	}` |
|    - |  157 | `	/* Create our handle */` |
|   82 |  158 | `	pData = PHPStreamDataInit(pResource?pResource->pVm:0,iMode);` |
|   82 |  159 | `	if( pData == 0 ){` |
|  ! 0 |  160 | `		return -1;` |
|    - |  161 | `	}` |
|    - |  162 | `	/* Make the handle public */` |
|   82 |  163 | `	*ppHandle = (void *)pData;` |
|   82 |  164 | `	return PH7_OK;` |
|   43 |  165 | `}` |
|    - |  166 | `/* ph7_int64 (*xRead)(void *,void *,ph7_int64) */` |
|   72 |  167 | `static ph7_int64 PHPStreamData_Read(void *pHandle,void *pBuffer,ph7_int64 nDatatoRead)` |
|    1 |  168 | `{` |
|   73 |  169 | `	ph7_stream_data *pData = (ph7_stream_data *)pHandle;` |
|   73 |  170 | `	if( pData == 0 ){` |
|  ! 0 |  171 | `		return -1;` |
|    - |  172 | `	}` |
|   73 |  173 | `	if( pData->iType == PH7_IO_STREAM_MEMORY ){` |
|   73 |  174 | `		sxu32 nAvail = SyBlobLength(&pData->sMem);` |
|    - |  175 | `		sxu32 nRead;` |
|   73 |  176 | `		if( pData->nCur >= nAvail ){` |
|   27 |  177 | `			return 0; /* EOF */` |
|    - |  178 | `		}` |
|   47 |  179 | `		nRead = nAvail - pData->nCur;` |
|   47 |  180 | `		if( (ph7_int64)nRead > nDatatoRead ){` |
|    7 |  181 | `			nRead = (sxu32)nDatatoRead;` |
|    3 |  182 | `		}` |
|   47 |  183 | `		SyMemcpy((const char *)SyBlobData(&pData->sMem) + pData->nCur,pBuffer,nRead);` |
|   47 |  184 | `		pData->nCur += nRead;` |
|   47 |  185 | `		return (ph7_int64)nRead;` |
|    - |  186 | `	}` |
...
|   62 |  218 | `static ph7_int64 PHPStreamData_Write(void *pHandle,const void *pBuf,ph7_int64 nWrite)` |
|    2 |  219 | `{` |
|   64 |  220 | `	ph7_stream_data *pData = (ph7_stream_data *)pHandle;` |
|   64 |  221 | `	if( pData == 0 ){` |
|  ! 0 |  222 | `		return -1;` |
|    - |  223 | `	}` |
|   64 |  224 | `	if( pData->iType == PH7_IO_STREAM_STDIN ){` |
|    - |  225 | `		/* Forbidden */` |
|  ! 0 |  226 | `		return -1;` |
|   64 |  227 | `	}else if( pData->iType == PH7_IO_STREAM_MEMORY ){` |
|    - |  228 | `		sxu32 nLen,nEnd;` |
|   52 |  229 | `		if( pData->bReadOnly ){` |
|  ! 0 |  230 | `			return -1;` |
|    - |  231 | `		}` |
|   52 |  232 | `		nLen = SyBlobLength(&pData->sMem);` |
|   52 |  233 | `		if( pData->nCur > nLen ){` |
...
|  ! 0 |  244 | `		}` |
|   52 |  245 | `		nEnd = pData->nCur + (sxu32)nWrite;` |
|   52 |  246 | `		if( pData->nCur < nLen ){` |
...
|  ! 0 |  255 | `			}` |
|    2 |  256 | `		}else{` |
|   50 |  257 | `			if( SyBlobAppend(&pData->sMem,pBuf,(sxu32)nWrite) != SXRET_OK ){` |
|  ! 0 |  258 | `				return -1;` |
|    - |  259 | `			}` |
|    - |  260 | `		}` |
|   52 |  261 | `		pData->nCur = nEnd;` |
|   52 |  262 | `		return nWrite;` |
...
|   52 |  300 | `static void PHPStreamData_Close(void *pHandle)` |
|    4 |  301 | `{` |
|   56 |  302 | `	ph7_stream_data *pData = (ph7_stream_data *)pHandle;` |
|    - |  303 | `	ph7_vm *pVm;` |
|   56 |  304 | `	if( pData == 0 ){` |
|  ! 0 |  305 | `		return;` |
|    - |  306 | `	}` |
|   56 |  307 | `	pVm = pData->pVm;` |
|   56 |  308 | `	SyBlobRelease(&pData->sMem);` |
|    - |  309 | `	/* Free the instance */` |
|   56 |  310 | `	SyMemBackendFree(&pVm->sAllocator,pData);` |
|   30 |  311 | `}` |
|    - |  312 | `/* int (*xSeek)(void *,ph7_int64,int); MEMORY type only */` |
|   70 |  313 | `static int PHPStreamData_Seek(void *pHandle,ph7_int64 iOfft,int whence)` |
|    1 |  314 | `{` |
|   71 |  315 | `	ph7_stream_data *pData = (ph7_stream_data *)pHandle;` |
|    - |  316 | `	ph7_int64 iNew;` |
|   71 |  317 | `	if( pData == 0 \|\| pData->iType != PH7_IO_STREAM_MEMORY ){` |
|  ! 0 |  318 | `		return -1;` |
|    - |  319 | `	}` |
|   71 |  320 | `	switch(whence){` |
|    5 |  321 | `	case 1/*SEEK_CUR*/: iNew = (ph7_int64)pData->nCur + iOfft; break;` |
|    5 |  322 | `	case 2/*SEEK_END*/: iNew = (ph7_int64)SyBlobLength(&pData->sMem) + iOfft; break;` |
|   63 |  323 | `	default:            iNew = iOfft; break;` |
|    - |  324 | `	}` |
|   71 |  325 | `	if( iNew < 0 ){` |
|  ! 0 |  326 | `		return -1;` |
|    - |  327 | `	}` |
|   71 |  328 | `	pData->nCur = (sxu32)iNew;` |
|   71 |  329 | `	return PH7_OK;` |
|   36 |  330 | `}` |
|    - |  331 | `/* ph7_int64 (*xTell)(void *); MEMORY type only */` |
|   24 |  332 | `static ph7_int64 PHPStreamData_Tell(void *pHandle)` |
|    1 |  333 | `{` |
|   25 |  334 | `	ph7_stream_data *pData = (ph7_stream_data *)pHandle;` |
|   25 |  335 | `	if( pData == 0 \|\| pData->iType != PH7_IO_STREAM_MEMORY ){` |
|  ! 0 |  336 | `		return -1;` |
|    - |  337 | `	}` |
|   25 |  338 | `	return (ph7_int64)pData->nCur;` |
|   13 |  339 | `}` |
...
|    - |  633 | ` */` |
| 4618 |  634 | `static pipe_private * PipeOpen(ph7_vm *pVm, const char *zCommand, const char *zMode)` |
|    5 |  635 | `{` |
|    - |  636 | `	pipe_private *pPipe;` |
|    - |  637 | `	FILE *pFile;` |
| 4623 |  638 | `	if( pVm == 0 \|\| zCommand == 0 \|\| zMode == 0 ){` |
|  ! 0 |  639 | `		return 0;` |
|    - |  640 | `	}` |
|    - |  641 | `	/* Validate mode - only 'r' or 'w' allowed */` |
| 4623 |  642 | `	if( zMode[0] != 'r' && zMode[0] != 'w' ){` |
|  ! 0 |  643 | `		return 0;` |
|    - |  644 | `	}` |
...
| 4618 |  706 | `	pFile = popen(zCommand, zMode);` |
| 4618 |  707 | `	if( pFile == 0 ){` |
|  ! 0 |  708 | `		return 0;` |
|    - |  709 | `	}` |
|    - |  710 | `	/* Allocate pipe private structure */` |
| 4618 |  711 | `	pPipe = (pipe_private *)SyMemBackendAlloc(&pVm->sAllocator, sizeof(pipe_private));` |
| 4618 |  712 | `	if( pPipe == 0 ){` |
...
| 4618 |  718 | `	pPipe->pFile = pFile;` |
| 4618 |  719 | `	pPipe->pVm = pVm;` |
| 4618 |  720 | `	pPipe->iMode = zMode[0];` |
|    - |  721 | `#else /* OS_OTHER: no process pipes on this platform */` |
|    - |  722 | `	(void)pFile;` |
|    - |  723 | `	return 0;` |
|    - |  724 | `#endif` |
| 4623 |  725 | `	return pPipe;` |
| 2314 |  726 | `}` |
|    - |  727 | `/*` |
|    - |  728 | ` * Close a pipe and return the exit status of the process.` |
|    - |  729 | ` * Returns the exit status, or -1 on error.` |
|    - |  730 | ` */` |
| 4592 |  731 | `static int PipeClose(pipe_private *pPipe)` |
|    5 |  732 | `{` |
|    - |  733 | `	int status;` |
|    - |  734 | `	ph7_vm *pVm;` |
| 4597 |  735 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|  ! 0 |  736 | `		return -1;` |
|    - |  737 | `	}` |
| 4597 |  738 | `	pVm = pPipe->pVm;` |
...
| 4592 |  744 | `	status = pclose(pPipe->pFile);` |
|    - |  745 | `	/* On Unix, pclose returns the status from waitpid, need to extract exit code */` |
| 4592 |  746 | `	if( status != -1 ){` |
| 4592 |  747 | `		if( WIFEXITED(status) ){` |
| 4592 |  748 | `			status = WEXITSTATUS(status);` |
| 2296 |  749 | `		}else if( WIFSIGNALED(status) ){` |
...
| 4597 |  761 | `	SyMemBackendFree(&pVm->sAllocator, pPipe);` |
| 4597 |  762 | `	return status;` |
| 2301 |  763 | `}` |
|    - |  764 | `/*` |
...
|    - |  778 | ` */` |
| 7026 |  779 | `static ph7_int64 PipeStream_Read(void *pHandle, void *pBuffer, ph7_int64 nDatatoRead)` |
|    4 |  780 | `{` |
| 7030 |  781 | `	pipe_private *pPipe = (pipe_private *)pHandle;` |
|    - |  782 | `	size_t nRead;` |
| 7030 |  783 | `	if( pPipe == 0 \|\| pPipe->pFile == 0 ){` |
|  ! 0 |  784 | `		return -1;` |
|    - |  785 | `	}` |
| 7030 |  786 | `	if( pPipe->iMode != 'r' ){` |
|    - |  787 | `		/* Cannot read from a write-only pipe */` |
|  ! 0 |  788 | `		return -1;` |
|    - |  789 | `	}` |
| 7030 |  790 | `	nRead = fread(pBuffer, 1, (size_t)nDatatoRead, pPipe->pFile);` |
| 7030 |  791 | `	if( nRead == 0 ){` |
| 4650 |  792 | `		if( feof(pPipe->pFile) ){` |
| 4650 |  793 | `			return 0; /* EOF */` |
|    - |  794 | `		}` |
|  ! 0 |  795 | `		return -1; /* Error */` |
|    - |  796 | `	}` |
| 2384 |  797 | `	return (ph7_int64)nRead;` |
| 3517 |  798 | `}` |
|    - |  799 | `/*` |
...
|    - |  840 | ` * FALSE otherwise.` |
|    - |  841 | ` */` |
| 4490 |  842 | `static int is_pipe_stream(const ph7_io_stream *pStream)` |
|    5 |  843 | `{` |
| 4495 |  844 | `	return pStream == &sPipe_Stream;` |
|    5 |  845 | `}` |
|    - |  846 | `/*` |
...
|  ! 0 |  903 | `	return PH7_OK;` |
|  ! 0 |  904 | `}` |
| 4618 |  905 | `PH7_PRIVATE int PH7_builtin_popen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    5 |  906 | `{` |
|    - |  907 | `	const char *zCommand, *zMode;` |
|    - |  908 | `	pipe_private *pPipe;` |
|    - |  909 | `	io_private *pDev;` |
|    - |  910 | `	int nCmdLen, nModeLen;` |
| 4623 |  911 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) \|\| !ph7_value_is_string(apArg[1]) ){` |
...
| 4623 |  918 | `	zCommand = ph7_value_to_string(apArg[0], &nCmdLen);` |
| 4623 |  919 | `	zMode = ph7_value_to_string(apArg[1], &nModeLen);` |
| 4623 |  920 | `	if( nCmdLen < 1 ){` |
|  ! 0 |  921 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Empty command");` |
|  ! 0 |  922 | `		ph7_result_bool(pCtx, 0);` |
|  ! 0 |  923 | `		return PH7_OK;` |
|    - |  924 | `	}` |
| 4623 |  925 | `	if( nModeLen < 1 \|\| (zMode[0] != 'r' && zMode[0] != 'w') ){` |
|  ! 0 |  926 | `		ph7_context_throw_error(pCtx, PH7_CTX_WARNING, "Invalid mode, expected 'r' or 'w'");` |
|  ! 0 |  927 | `		ph7_result_bool(pCtx, 0);` |
|  ! 0 |  928 | `		return PH7_OK;` |
|    - |  929 | `	}` |
|    - |  930 | `	/* Open the pipe */` |
| 4623 |  931 | `	pPipe = PipeOpen(pCtx->pVm, zCommand, zMode);` |
| 4623 |  932 | `	if( pPipe == 0 ){` |
...
| 4623 |  938 | `	pDev = (io_private *)ph7_context_alloc_chunk(pCtx, sizeof(io_private), TRUE, FALSE);` |
| 4623 |  939 | `	if( pDev == 0 ){` |
...
| 4623 |  946 | `	InitIOPrivate(pCtx->pVm, &sPipe_Stream, pDev);` |
| 4623 |  947 | `	pDev->pHandle = pPipe;` |
|    - |  948 | `	/* Return the io_private instance as a resource */` |
| 4623 |  949 | `	ph7_result_resource(pCtx, pDev);` |
| 4623 |  950 | `	return PH7_OK;` |
| 2314 |  951 | `}` |
|    - |  952 | `/*` |
...
|    - |  960 | ` */` |
| 4490 |  961 | `PH7_PRIVATE int PH7_builtin_pclose(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    5 |  962 | `{` |
|    - |  963 | `	const ph7_io_stream *pStream;` |
|    - |  964 | `	pipe_private *pPipe;` |
|    - |  965 | `	io_private *pDev;` |
|    - |  966 | `	int status;` |
| 4495 |  967 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
| 4495 |  974 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|    - |  975 | `	/* Make sure we are dealing with a valid io_private instance */` |
| 4495 |  976 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
| 4495 |  982 | `	pStream = pDev->pStream;` |
| 4495 |  983 | `	if( pStream == 0 \|\| !is_pipe_stream(pStream) ){` |
...
| 4495 |  989 | `	pPipe = (pipe_private *)pDev->pHandle;` |
|    - |  990 | `	/* Close the pipe and get exit status */` |
| 4495 |  991 | `	status = PipeClose(pPipe);` |
|    - |  992 | `	/* Keep the handle alive but flag it closed so shared copies see it */` |
| 4495 |  993 | `	MarkIOPrivateClosed(pDev);` |
|    - |  994 | `	/* Return the exit status */` |
| 4495 |  995 | `	ph7_result_int(pCtx, status);` |
| 4495 |  996 | `	return PH7_OK;` |
| 2250 |  997 | `}` |
|    - |  998 | `/*` |
...
|   10 | 1175 | `	pid = fork();` |
|   15 | 1176 | `	if( pid < 0 ){` |
|  ! 0 | 1177 | `		ph7_context_throw_error(pCtx,PH7_CTX_WARNING,"fork() failed");` |
...
|    - | 1369 | ` */` |
|  310 | 1370 | `PH7_PRIVATE int is_php_stream(const ph7_io_stream *pStream)` |
|    5 | 1371 | `{` |
|    - | 1372 | `#ifndef PH7_DISABLE_DISK_IO` |
|  315 | 1373 | `	return pStream == &sPHP_Stream;` |
|    - | 1374 | `#else` |
...
|    - | 1381 | ` */` |
|  226 | 1382 | `PH7_PRIVATE int is_data_stream(const ph7_io_stream *pStream)` |
|    4 | 1383 | `{` |
|    - | 1384 | `#ifndef PH7_DISABLE_DISK_IO` |
|  230 | 1385 | `	return pStream == &sDATA_Stream;` |
|    - | 1386 | `#else` |
