...
|     - |    5 | ` */` |
|     - |    6 | `#include "ph7int.h"` |
|   758 |    7 | `PH7_PRIVATE int vm_builtin_get_class(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |    8 | `{` |
|     - |    9 | `	ph7_class *pClass;` |
|     - |   10 | `	SyString *pName;` |
|   763 |   11 | `	if( nArg < 1 ){` |
...
|   763 |   24 | `		pClass = PH7_VmExtractClassFromValue(pCtx->pVm,apArg[0]);` |
|   763 |   25 | `		if( pClass ){` |
|   761 |   26 | `			pName = &pClass->sName;` |
|     - |   27 | `			/* Return the class name */` |
|   761 |   28 | `			ph7_result_string(pCtx,pName->zString,(int)pName->nByte);` |
|   383 |   29 | `		}else{` |
|     - |   30 | `			/* Not a class instance,return FALSE */` |
|     3 |   31 | `			ph7_result_bool(pCtx,0);` |
|     - |   32 | `		}` |
|     - |   33 | `	}` |
|   763 |   34 | `	return PH7_OK;` |
|     5 |   35 | `}` |
|     - |   36 | `/*` |
...
|     - |  112 | ` */` |
|  1812 |  113 | `PH7_PRIVATE ph7_class * PH7_VmExtractClassFromValue(ph7_vm *pVm,ph7_value *pArg)` |
|     5 |  114 | `{` |
|  1817 |  115 | `	ph7_class *pClass = 0;` |
|  1817 |  116 | `	if( ph7_value_is_object(pArg) ){` |
|     - |  117 | `		/* Class instance already loaded,no need to perform a lookup */` |
|   929 |  118 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|  1354 |  119 | `	}else if( ph7_value_is_string(pArg) ){` |
...
|     - |  227 | ` */` |
|    84 |  228 | `PH7_PRIVATE int vm_builtin_class_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  229 | `{` |
|    89 |  230 | `	int res = 0; /* Assume class does not exist */` |
|    89 |  231 | `	if( nArg > 0 ){` |
|    89 |  232 | `		SyHashEntry *pEntry = 0;` |
|     - |  233 | `		const char *zName;` |
|     - |  234 | `		int nLen;` |
|    89 |  235 | `		int iAutoload = 1; /* Default: autoload enabled */` |
|     - |  236 | `		/* Extract given name */` |
|    89 |  237 | `		zName = ph7_value_to_string(apArg[0],&nLen);` |
|    89 |  238 | `		if( nArg >= 2 ){` |
|     6 |  239 | `			iAutoload = ph7_value_to_bool(apArg[1]);` |
|     2 |  240 | `		}` |
|    89 |  241 | `		if( nLen > 0 ){` |
|     - |  242 | `			/* Perform a hash lookup first */` |
|    89 |  243 | `			pEntry = SyHashGet(&pCtx->pVm->hClass,(const void *)zName,(sxu32)nLen);` |
|    42 |  244 | `		}` |
|    89 |  245 | `		if( pEntry == 0 && nLen > 0 && iAutoload ){` |
...
|    73 |  255 | `			ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|    75 |  256 | `			while( pClass ){` |
|    73 |  257 | `				if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
|    71 |  258 | `					res = 1;` |
|    71 |  259 | `					break;` |
|     - |  260 | `				}` |
...
|    34 |  263 | `		}` |
|    42 |  264 | `	}` |
|    89 |  265 | `	ph7_result_bool(pCtx,res);` |
|    89 |  266 | `	return PH7_OK;` |
|     5 |  267 | `}` |
|     - |  268 | `/*` |
...
|   372 |  455 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   369 |  456 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|     - |  457 | `		/* Do not register classes defined as interfaces */` |
|   369 |  458 | `		if( (pClass->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|   331 |  459 | `			ph7_value_string(pName,SyStringData(&pClass->sName),(int)SyStringLength(&pClass->sName));` |
|     - |  460 | `			/* insert class name */` |
|   331 |  461 | `			ph7_array_add_elem(pArray,0/*Automatic index assign*/,pName); /* Will make it's own copy */` |
|     - |  462 | `			/* Reset the cursor */` |
|   331 |  463 | `			ph7_value_reset_string_cursor(pName);` |
|   165 |  464 | `		}` |
|     1 |  465 | `	}` |
...
|   374 |  497 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   371 |  498 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|     - |  499 | `		/* Register classes defined as interfaces only */` |
|   371 |  500 | `		if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
...
|     - |  631 | ` */` |
| 35116 |  632 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|     - |  638 | `	)` |
|     5 |  639 | `{` |
| 35121 |  640 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
| 25155 |  641 | `		VmFrame *pFrame = pVm->pFrame;` |
|     - |  642 | `		ph7_vm_func *pVmFunc;` |
|     - |  643 | `		ph7_class *pCallerScope;` |
| 25169 |  644 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|     - |  645 | `			/* Safely ignore the exception frame */` |
|    16 |  646 | `			pFrame = pFrame->pParent;` |
|     2 |  647 | `		}` |
| 25155 |  648 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
...
| 25155 |  651 | `		if( pFrame->pBoundScope ){` |
|    15 |  652 | `			pCallerScope = pFrame->pBoundScope;` |
| 25148 |  653 | `		}else if( pVmFunc && (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) ){` |
| 25045 |  654 | `			pCallerScope = (ph7_class *)pVmFunc->pUserData;` |
| 12619 |  655 | `		}else if( pVmFunc && (pVmFunc->iFlags & VM_FUNC_CLOSURE) && pVmFunc->pUserData ){` |
...
|     - |  671 | `		}` |
| 25099 |  672 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
| 11265 |  682 | `			ph7_class *pCaller = pCallerScope;` |
| 16895 |  683 | `			SyHashEntry *pOwnE = SyHashGet(&pCaller->hAttr,` |
| 11260 |  684 | `				(const void *)pAttrName->zString,pAttrName->nByte);` |
| 11265 |  685 | `			ph7_class_attr *pOwn = pOwnE ? (ph7_class_attr *)pOwnE->pUserData : 0;` |
| 11265 |  686 | `			int bGranted = 0;` |
| 11265 |  687 | `			if( pOwn && pOwn->iProtection == PH7_CLASS_PROT_PRIVATE ){` |
|  9418 |  688 | `				if( pOwn->pDeclClass == 0` |
|  9418 |  689 | `				 \|\| pOwn->pDeclClass == pCaller` |
|  5664 |  690 | `				 \|\| (pOwn->pDeclClass->iFlags & PH7_CLASS_TRAIT) != 0 ){` |
|  9401 |  691 | `					bGranted = 1;` |
|  4703 |  692 | `				}` |
|  6554 |  693 | `			}else if( pOwn == 0 && pCaller == pClass ){` |
|   963 |  694 | `				bGranted = 1;` |
|   481 |  695 | `			}` |
| 11265 |  696 | `			if( !bGranted ){` |
...
|   ! 0 |  707 | `				}` |
|   451 |  708 | `			}` |
| 11265 |  709 | `			if( !bGranted && (pClass->iFlags & PH7_CLASS_TRAIT) != 0 ){` |
...
|   ! 0 |  725 | `				}` |
|   438 |  726 | `			}` |
| 11265 |  727 | `			if( !bGranted ){` |
|    29 |  728 | `				goto dis; /* Access is forbidden */` |
|     - |  729 | `			}` |
|  5622 |  730 | `		}else{` |
|     - |  731 | `			/* Protected */` |
| 13839 |  732 | `			ph7_class *pBase = pCallerScope;` |
...
| 13839 |  743 | `			ph7_class *pIntro = pClass;` |
|     - |  744 | `			ph7_class *pAnc;` |
| 37743 |  745 | `			for( pAnc = pClass ; pAnc ; pAnc = pAnc->pBase ){` |
| 23909 |  746 | `				ph7_class_method *pAncMeth = PH7_ClassExtractMethod(pAnc,pAttrName->zString,pAttrName->nByte);` |
| 23909 |  747 | `				SyHashEntry *pAncAttrE = SyHashGet(&pAnc->hAttr,(const void *)pAttrName->zString,pAttrName->nByte);` |
| 23909 |  748 | `				ph7_class_attr *pAncAttr = pAncAttrE ? (ph7_class_attr *)pAncAttrE->pUserData : 0;` |
| 23909 |  749 | `				int bHere = 0;` |
| 23909 |  750 | `				if( pAncMeth && (ph7_class *)pAncMeth->sFunc.pUserData == pAnc ){` |
|  3814 |  751 | `					bHere = 1;` |
|  1905 |  752 | `				}` |
| 23909 |  753 | `				if( pAncAttr && (pAncAttr->pDeclClass == pAnc \|\| pAncAttr->pDeclClass == 0) ){` |
| 10573 |  754 | `					bHere = 1;` |
|  5284 |  755 | `				}` |
| 23909 |  756 | `				if( bHere ){` |
| 14383 |  757 | `					pIntro = pAnc; /* keep climbing: the LAST (highest) match wins */` |
|  7189 |  758 | `				}` |
| 11957 |  759 | `			}` |
|     - |  760 | `			/* Must be in the same class hierarchy as the introducing class */` |
| 13839 |  761 | `			if( !PH7_VmInstanceOf(pIntro,pBase) && !PH7_VmInstanceOf(pBase,pIntro) ){` |
...
|     - |  780 | `		}` |
| 12531 |  781 | `	}` |
| 35033 |  782 | `	return 1; /* Access is granted */` |
|    44 |  783 | `dis:` |
|    91 |  784 | `	if( bLog ){` |
...
|     - | 1005 | ` */` |
| 14278 | 1006 | `static int VmInterfaceReaches(ph7_class *pIface,ph7_class *pTarget,int iDepth)` |
|     5 | 1007 | `{` |
| 26381 | 1008 | `	while( pIface && iDepth <= PH7_INTERFACE_WALK_MAX_DEPTH ){` |
|     - | 1009 | `		ph7_class **apParent;` |
|     - | 1010 | `		sxu32 n;` |
| 16901 | 1011 | `		if( pIface == pTarget ){` |
|  4801 | 1012 | `			return TRUE;` |
|     - | 1013 | `		}` |
...
| 12105 | 1016 | `		apParent = (ph7_class **)SySetBasePtr(&pIface->aInterface);` |
| 12109 | 1017 | `		for( n = 0 ; n < SySetUsed(&pIface->aInterface) ; n++ ){` |
|     7 | 1018 | `			if( VmInterfaceReaches(apParent[n],pTarget,iDepth+1) ){` |
|     3 | 1019 | `				return TRUE;` |
|     - | 1020 | `			}` |
|     3 | 1021 | `		}` |
| 12103 | 1022 | `		pIface = pIface->pBase;` |
| 12103 | 1023 | `		iDepth++;` |
|     5 | 1024 | `	}` |
|  9485 | 1025 | `	return FALSE;` |
|  7144 | 1026 | `}` |
|     - | 1027 | `/*` |
|     - | 1028 | ` * This function returns TRUE if the given class is an implemented` |
|     - | 1029 | ` * interface.Otherwise FALSE is returned.` |
|     - | 1030 | ` */` |
| 17300 | 1031 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|     5 | 1032 | `{` |
|     - | 1033 | `	ph7_class **apInterface;` |
|     - | 1034 | `	sxu32 n;` |
| 17305 | 1035 | `	if( SySetUsed(pSet) < 1 ){` |
|     - | 1036 | `		/* Empty interface container */` |
|  5027 | 1037 | `		return FALSE;` |
|     - | 1038 | `	}` |
|     - | 1039 | `	/* Point to the set of implemented interfaces */` |
| 12283 | 1040 | `	apInterface = (ph7_class **)SySetBasePtr(pSet);` |
...
| 21759 | 1043 | `	for( n = 0 ; n < SySetUsed(pSet) ; n++ ){` |
| 14277 | 1044 | `		if( VmInterfaceReaches(apInterface[n],pClass,0) ){` |
|  4801 | 1045 | `			return TRUE;` |
|     - | 1046 | `		}` |
|  4743 | 1047 | `	}` |
|  7487 | 1048 | `	return FALSE;` |
|  8655 | 1049 | `}` |
|     - | 1050 | `/*` |
...
|     - | 1054 | ` */` |
| 27730 | 1055 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|     5 | 1056 | `{` |
|     - | 1057 | `	ph7_class *pParent;` |
|     - | 1058 | `	sxi32 rc;` |
| 27735 | 1059 | `	if( pThis == pClass ){` |
|     - | 1060 | `		/* Instance of the same class */` |
| 15039 | 1061 | `		return TRUE;` |
|     - | 1062 | `	}` |
|     - | 1063 | `	/* Check implemented interfaces */` |
| 12701 | 1064 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
| 12701 | 1065 | `	if( rc ){` |
|  2043 | 1066 | `		return TRUE;` |
|     - | 1067 | `	}` |
|     - | 1068 | `	/* Check parent classes */` |
| 10663 | 1069 | `	pParent = pThis->pBase;` |
| 12499 | 1070 | `	while( pParent ){` |
|  5617 | 1071 | `		if( pParent == pClass ){` |
|     - | 1072 | `			/* Same instance */` |
|  1023 | 1073 | `			return TRUE;` |
|     - | 1074 | `		}` |
|     - | 1075 | `		/* Check the implemented interfaces */` |
|  4599 | 1076 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
|  4599 | 1077 | `		if( rc ){` |
|  2763 | 1078 | `			return TRUE;` |
|     - | 1079 | `		}` |
|     - | 1080 | `		/* Point to the parent class */` |
|  1841 | 1081 | `		pParent = pParent->pBase;` |
|     5 | 1082 | `	}` |
|     - | 1083 | `	/* Not an instance of the the given class */` |
|  6887 | 1084 | `	return FALSE;` |
| 13870 | 1085 | `}` |
|     - | 1086 | `/*` |
