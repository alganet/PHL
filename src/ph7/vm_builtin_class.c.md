...
|    - |    5 | ` */` |
|    - |    6 | `#include "ph7int.h"` |
|   64 |    7 | `PH7_PRIVATE int vm_builtin_get_class(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    2 |    8 |  |
|    - |    9 | `	ph7_class *pClass;` |
|    - |   10 | `	SyString *pName;` |
|   66 |   11 | `	if( nArg < 1 ){` |
...
|   66 |   24 | `		pClass = PH7_VmExtractClassFromValue(pCtx->pVm,apArg[0]);` |
|   66 |   25 | `		if( pClass ){` |
|   64 |   26 | `			pName = &pClass->sName;` |
|    - |   27 | `			/* Return the class name */` |
|   64 |   28 | `			ph7_result_string(pCtx,pName->zString,(int)pName->nByte);` |
|   33 |   29 | `		}else{` |
...
|    - |  112 | ` */` |
|  132 |  113 | `PH7_PRIVATE ph7_class * PH7_VmExtractClassFromValue(ph7_vm *pVm,ph7_value *pArg)` |
|    2 |  114 |  |
|  134 |  115 | `	ph7_class *pClass = 0;` |
|  134 |  116 | `	if( ph7_value_is_object(pArg) ){` |
|    - |  117 | `		/* Class instance already loaded,no need to perform a lookup */` |
|   94 |  118 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|   88 |  119 | `	}else if( ph7_value_is_string(pArg) ){` |
...
|    - |  216 | ` */` |
|   36 |  217 | `PH7_PRIVATE int vm_builtin_class_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    2 |  218 |  |
|   38 |  219 | `	int res = 0; /* Assume class does not exist */` |
|   38 |  220 | `	if( nArg > 0 ){` |
|   38 |  221 | `		SyHashEntry *pEntry = 0;` |
|    - |  222 | `		const char *zName;` |
|    - |  223 | `		int nLen;` |
|   38 |  224 | `		int iAutoload = 1; /* Default: autoload enabled */` |
|    - |  225 | `		/* Extract given name */` |
|   38 |  226 | `		zName = ph7_value_to_string(apArg[0],&nLen);` |
|   38 |  227 | `		if( nArg >= 2 ){` |
|    5 |  228 | `			iAutoload = ph7_value_to_bool(apArg[1]);` |
|    2 |  229 | `		}` |
|   38 |  230 | `		if( nLen > 0 ){` |
|    - |  231 | `			/* Perform a hash lookup first */` |
|   38 |  232 | `			pEntry = SyHashGet(&pCtx->pVm->hClass,(const void *)zName,(sxu32)nLen);` |
|   18 |  233 | `		}` |
|   38 |  234 | `		if( pEntry == 0 && nLen > 0 && iAutoload ){` |
...
|   24 |  244 | `			ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|   24 |  245 | `			while( pClass ){` |
|   24 |  246 | `				if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
|   24 |  247 | `					res = 1;` |
|   24 |  248 | `					break;` |
|    - |  249 | `				}` |
...
|   11 |  252 | `		}` |
|   18 |  253 | `	}` |
|   38 |  254 | `	ph7_result_bool(pCtx,res);` |
|   38 |  255 | `	return PH7_OK;` |
|    2 |  256 |  |
|    - |  257 | `/*` |
...
|   66 |  393 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   63 |  394 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|    - |  395 | `		/* Do not register classes defined as interfaces */` |
|   63 |  396 | `		if( (pClass->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
...
|   68 |  435 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   65 |  436 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|    - |  437 | `		/* Register classes defined as interfaces only */` |
|   65 |  438 | `		if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
|   11 |  439 | `			ph7_value_string(pName,SyStringData(&pClass->sName),(int)SyStringLength(&pClass->sName));` |
|    - |  440 | `			/* insert interface name */` |
|   11 |  441 | `			ph7_array_add_elem(pArray,0/*Automatic index assign*/,pName); /* Will make it's own copy */` |
|    - |  442 | `			/* Reset the cursor */` |
|   11 |  443 | `			ph7_value_reset_string_cursor(pName);` |
|    5 |  444 | `		}` |
|    1 |  445 | `	}` |
...
|    - |  507 | ` */` |
| 6436 |  508 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|    - |  514 | `	)` |
|    2 |  515 |  |
| 6438 |  516 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
| 5214 |  517 | `		VmFrame *pFrame = pVm->pFrame;` |
|    - |  518 | `		ph7_vm_func *pVmFunc;` |
| 5214 |  519 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|    - |  520 | `			/* Safely ignore the exception frame */` |
|  ! 0 |  521 | `			pFrame = pFrame->pParent;` |
|  ! 0 |  522 | `		}` |
| 5214 |  523 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
| 5214 |  524 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|   12 |  525 | `			goto dis; /* Access is forbidden */` |
|    - |  526 | `		}` |
| 5204 |  527 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
|    - |  528 | `			/* Must be the same instance or a trait used by the class */` |
|  262 |  529 | `			ph7_class *pCaller = (ph7_class *)pVmFunc->pUserData;` |
|  262 |  530 | `			if( pCaller != pClass ){` |
...
|  131 |  547 | `		}else{` |
|    - |  548 | `			/* Protected */` |
| 4944 |  549 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|    - |  550 | `			/* Must be in the same class hierarchy */` |
| 4944 |  551 | `			if( !PH7_VmInstanceOf(pClass,pBase) && !PH7_VmInstanceOf(pBase,pClass) ){` |
|  ! 0 |  552 | `				goto dis; /* Access is forbidden */` |
|    - |  553 | `			}` |
|    - |  554 | `		}` |
| 2600 |  555 | `	}` |
| 6426 |  556 | `	return 1; /* Access is granted */` |
|    6 |  557 | `dis:` |
|   14 |  558 | `	if( bLog ){` |
...
|    - |  707 | ` */` |
| 6006 |  708 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|    2 |  709 |  |
|    - |  710 | `	ph7_class **apInterface;` |
|    - |  711 | `	sxu32 n;` |
| 6008 |  712 | `	if( SySetUsed(pSet) < 1 ){` |
|    - |  713 | `		/* Empty interface container */` |
| 5732 |  714 | `		return FALSE;` |
|    - |  715 | `	}` |
|    - |  716 | `	/* Point to the set of implemented interfaces */` |
|  278 |  717 | `	apInterface = (ph7_class **)SySetBasePtr(pSet);` |
|    - |  718 | `	/* Perform the lookup */` |
|  364 |  719 | `	for( n = 0 ; n < SySetUsed(pSet) ; n++ ){` |
|  278 |  720 | `		if( apInterface[n] == pClass ){` |
|  192 |  721 | `			return TRUE;` |
|    - |  722 | `		}` |
|   45 |  723 | `	}` |
|   88 |  724 | `	return FALSE;` |
...
|    - |  730 | ` */` |
| 5552 |  731 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|    2 |  732 |  |
|    - |  733 | `	ph7_class *pParent;` |
|    - |  734 | `	sxi32 rc;` |
| 5554 |  735 | `	if( pThis == pClass ){` |
|    - |  736 | `		/* Instance of the same class */` |
| 1102 |  737 | `		return TRUE;` |
|    - |  738 | `	}` |
|    - |  739 | `	/* Check implemented interfaces */` |
| 4454 |  740 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
| 4454 |  741 | `	if( rc ){` |
|  130 |  742 | `		return TRUE;` |
|    - |  743 | `	}` |
|    - |  744 | `	/* Check parent classes */` |
| 4326 |  745 | `	pParent = pThis->pBase;` |
| 5818 |  746 | `	while( pParent ){` |
| 5744 |  747 | `		if( pParent == pClass ){` |
|    - |  748 | `			/* Same instance */` |
| 4190 |  749 | `			return TRUE;` |
|    - |  750 | `		}` |
|    - |  751 | `		/* Check the implemented interfaces */` |
| 1556 |  752 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
| 1556 |  753 | `		if( rc ){` |
|   64 |  754 | `			return TRUE;` |
|    - |  755 | `		}` |
|    - |  756 | `		/* Point to the parent class */` |
| 1494 |  757 | `		pParent = pParent->pBase;` |
|    2 |  758 | `	}` |
...
|    7 |  845 | `	return PH7_OK;` |
|    1 |  846 |  |
|   16 |  847 | `PH7_PRIVATE int vm_builtin_call_user_func(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    1 |  848 |  |
...
|  ! 0 |  854 | `		return PH7_OK;` |
|    - |  855 | `	}` |
|   17 |  856 | `	PH7_MemObjInit(pCtx->pVm,&sResult);` |
|   17 |  857 | `	sResult.nIdx = SXU32_HIGH; /* Mark as constant */` |
|    - |  858 | `	/* Try to invoke the callback */` |
|   17 |  859 | `	rc = PH7_VmCallUserFunction(pCtx->pVm,apArg[0],nArg - 1,&apArg[1],&sResult);` |
|   17 |  860 | `	if( rc != SXRET_OK ){` |
|    - |  861 | `		/* An error occured while invoking the given callback [i.e: not defined] */` |
|  ! 0 |  862 | `		ph7_result_bool(pCtx,0); /* return false */` |
|  ! 0 |  863 | `	}else{` |
|    - |  864 | `		/* Callback result */` |
|   17 |  865 | `		ph7_result_value(pCtx,&sResult); /* Will make it's own copy */` |
|    - |  866 | `	}` |
|   17 |  867 | `	PH7_MemObjRelease(&sResult);` |
|   17 |  868 | `	return PH7_OK;` |
|    9 |  869 |  |
|    - |  870 | `/*` |
...
|    - |  880 | ` */` |
|   12 |  881 | `PH7_PRIVATE int vm_builtin_call_user_func_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    1 |  882 |  |
...
|    - |  887 | `	sxi32 rc;` |
|    - |  888 | `	sxu32 n;` |
|   13 |  889 | `	if( nArg < 2 \|\| !ph7_value_is_array(apArg[1]) ){` |
|    - |  890 | `		/* Missing/Invalid arguments,return FALSE */` |
|  ! 0 |  891 | `		ph7_result_bool(pCtx,0);` |
|  ! 0 |  892 | `		return PH7_OK;` |
|    - |  893 | `	}` |
|   13 |  894 | `	PH7_MemObjInit(pCtx->pVm,&sResult);` |
|   13 |  895 | `	sResult.nIdx = SXU32_HIGH; /* Mark as constant */` |
|    - |  896 | `	/* Initialize the arguments container */` |
|   13 |  897 | `	SySetInit(&aArg,&pCtx->pVm->sAllocator,sizeof(ph7_value *));` |
|    - |  898 | `	/* Turn hashmap entries into callback arguments */` |
|   13 |  899 | `	pMap = (ph7_hashmap *)apArg[1]->x.pOther;` |
|   13 |  900 | `	pEntry = pMap->pFirst; /* First inserted entry */` |
|   31 |  901 | `	for( n = 0 ; n < pMap->nEntry ; n++ ){` |
|    - |  902 | `		/* Extract node value */` |
|   19 |  903 | `		if( (pValue = (ph7_value *)SySetAt(&pCtx->pVm->aMemObj,pEntry->nValIdx)) != 0 ){` |
|   19 |  904 | `			SySetPut(&aArg,(const void *)&pValue);` |
|    9 |  905 | `		}` |
|    - |  906 | `		/* Point to the next entry */` |
|   19 |  907 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   10 |  908 | `	}` |
|    - |  909 | `	/* Try to invoke the callback */` |
|   13 |  910 | `	rc = PH7_VmCallUserFunction(pCtx->pVm,apArg[0],(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg),&sResult);` |
|   13 |  911 | `	if( rc != SXRET_OK ){` |
|    - |  912 | `		/* An error occured while invoking the given callback [i.e: not defined] */` |
|  ! 0 |  913 | `		ph7_result_bool(pCtx,0); /* return false */` |
|  ! 0 |  914 | `	}else{` |
|    - |  915 | `		/* Callback result */` |
|   13 |  916 | `		ph7_result_value(pCtx,&sResult); /* Will make it's own copy */` |
|    - |  917 | `	}` |
|    - |  918 | `	/* Cleanup the mess left behind */` |
|   13 |  919 | `	PH7_MemObjRelease(&sResult);` |
|   13 |  920 | `	SySetRelease(&aArg);` |
|   13 |  921 | `	return PH7_OK;` |
|    7 |  922 |  |
|    - |  923 |  |
