...
|    - |  473 | ` */` |
| 3104 |  474 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|    - |  480 | `	)` |
|    2 |  481 |  |
| 3106 |  482 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
| 2542 |  483 | `		VmFrame *pFrame = pVm->pFrame;` |
|    - |  484 | `		ph7_vm_func *pVmFunc;` |
| 2546 |  485 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|    - |  486 | `			/* Safely ignore the exception frame */` |
|    5 |  487 | `			pFrame = pFrame->pParent;` |
|    1 |  488 | `		}` |
| 2542 |  489 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
| 2542 |  490 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|    9 |  491 | `			goto dis; /* Access is forbidden */` |
|    - |  492 | `		}` |
| 2534 |  493 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|    4 |  498 | `		}else{` |
|    - |  499 | `			/* Protected */` |
| 2528 |  500 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|    - |  501 | `			/* Must be a derived class */` |
| 2528 |  502 | `			if( !PH7_VmInstanceOf(pClass,pBase) ){` |
|  ! 0 |  503 | `				goto dis; /* Access is forbidden */` |
|    - |  504 | `			}` |
|    - |  505 | `		}` |
| 1266 |  506 | `	}` |
| 3098 |  507 | `	return 1; /* Access is granted */` |
|    4 |  508 | `dis:` |
|    9 |  509 | `	if( bLog ){` |
...
|    - |  658 | ` */` |
| 5728 |  659 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|    2 |  660 |  |
|    - |  661 | `	ph7_class **apInterface;` |
|    - |  662 | `	sxu32 n;` |
| 5730 |  663 | `	if( SySetUsed(pSet) < 1 ){` |
|    - |  664 | `		/* Empty interface container */` |
| 5728 |  665 | `		return FALSE;` |
|    - |  666 | `	}` |
...
|    - |  681 | ` */` |
| 2584 |  682 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|    2 |  683 |  |
|    - |  684 | `	ph7_class *pParent;` |
|    - |  685 | `	sxi32 rc;` |
| 2586 |  686 | `	if( pThis == pClass ){` |
|    - |  687 | `		/* Instance of the same class */` |
|  140 |  688 | `		return TRUE;` |
|    - |  689 | `	}` |
|    - |  690 | `	/* Check implemented interfaces */` |
| 2448 |  691 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
| 2448 |  692 | `	if( rc ){` |
|    3 |  693 | `		return TRUE;` |
|    - |  694 | `	}` |
|    - |  695 | `	/* Check parent classes */` |
| 2446 |  696 | `	pParent = pThis->pBase;` |
| 5728 |  697 | `	while( pParent ){` |
| 5726 |  698 | `		if( pParent == pClass ){` |
|    - |  699 | `			/* Same instance */` |
| 2444 |  700 | `			return TRUE;` |
|    - |  701 | `		}` |
|    - |  702 | `		/* Check the implemented interfaces */` |
| 3284 |  703 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
| 3284 |  704 | `		if( rc ){` |
|  ! 0 |  705 | `			return TRUE;` |
|    - |  706 | `		}` |
|    - |  707 | `		/* Point to the parent class */` |
| 3284 |  708 | `		pParent = pParent->pBase;` |
|    2 |  709 | `	}` |
