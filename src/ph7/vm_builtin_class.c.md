...
|     - |  507 | ` */` |
|  8730 |  508 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|     - |  514 | `	)` |
|     5 |  515 |  |
|  8735 |  516 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  7021 |  517 | `		VmFrame *pFrame = pVm->pFrame;` |
|     - |  518 | `		ph7_vm_func *pVmFunc;` |
|  7021 |  519 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|     - |  520 | `			/* Safely ignore the exception frame */` |
|   ! 0 |  521 | `			pFrame = pFrame->pParent;` |
|   ! 0 |  522 | `		}` |
|  7021 |  523 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|  7021 |  524 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|    12 |  525 | `			goto dis; /* Access is forbidden */` |
|     - |  526 | `		}` |
|  7011 |  527 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   240 |  547 | `		}else{` |
|     - |  548 | `			/* Protected */` |
|  6539 |  549 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|     - |  550 | `			/* Must be in the same class hierarchy */` |
|  6539 |  551 | `			if( !PH7_VmInstanceOf(pClass,pBase) && !PH7_VmInstanceOf(pBase,pClass) ){` |
|   ! 0 |  552 | `				goto dis; /* Access is forbidden */` |
|     - |  553 | `			}` |
|     - |  554 | `		}` |
|  3502 |  555 | `	}` |
|  8723 |  556 | `	return 1; /* Access is granted */` |
|     6 |  557 | `dis:` |
|    14 |  558 | `	if( bLog ){` |
...
|     - |  711 | ` */` |
|  7450 |  712 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|     5 |  713 |  |
|     - |  714 | `	ph7_class **apInterface;` |
|     - |  715 | `	sxu32 n;` |
|  7455 |  716 | `	if( SySetUsed(pSet) < 1 ){` |
|     - |  717 | `		/* Empty interface container */` |
|   155 |  718 | `		return FALSE;` |
|     - |  719 | `	}` |
|     - |  720 | `	/* Point to the set of implemented interfaces */` |
|  7305 |  721 | `	apInterface = (ph7_class **)SySetBasePtr(pSet);` |
...
| 13997 |  724 | `	for( n = 0 ; n < SySetUsed(pSet) ; n++ ){` |
|  7405 |  725 | `		ph7_class *pIface = apInterface[n];` |
|  7405 |  726 | `		int iDepth = 0;` |
| 14169 |  727 | `		while( pIface && iDepth <= PH7_INTERFACE_WALK_MAX_DEPTH ){` |
|  7477 |  728 | `			if( pIface == pClass ){` |
|   713 |  729 | `				return TRUE;` |
|     - |  730 | `			}` |
...
|     - |  741 | ` */` |
|  8016 |  742 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|     5 |  743 |  |
|     - |  744 | `	ph7_class *pParent;` |
|     - |  745 | `	sxi32 rc;` |
|  8021 |  746 | `	if( pThis == pClass ){` |
|     - |  747 | `		/* Instance of the same class */` |
|  2311 |  748 | `		return TRUE;` |
|     - |  749 | `	}` |
|     - |  750 | `	/* Check implemented interfaces */` |
|  5715 |  751 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
|  5715 |  752 | `	if( rc ){` |
|   609 |  753 | `		return TRUE;` |
|     - |  754 | `	}` |
