...
|    - |  112 | ` */` |
|   78 |  113 | `PH7_PRIVATE ph7_class * PH7_VmExtractClassFromValue(ph7_vm *pVm,ph7_value *pArg)` |
|    2 |  114 |  |
|   80 |  115 | `	ph7_class *pClass = 0;` |
|   80 |  116 | `	if( ph7_value_is_object(pArg) ){` |
|    - |  117 | `		/* Class instance already loaded,no need to perform a lookup */` |
|   44 |  118 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|   59 |  119 | `	}else if( ph7_value_is_string(pArg) ){` |
|    - |  120 | `		const char *zClass;` |
|    - |  121 | `		int nLen;` |
|    - |  122 | `		/* Extract class name */` |
|   35 |  123 | `		zClass = ph7_value_to_string(pArg,&nLen);` |
|   35 |  124 | `		if( nLen > 0 ){` |
|    - |  125 | `			SyHashEntry *pEntry;` |
|    - |  126 | `			/* Perform a lookup */` |
|   35 |  127 | `			pEntry = SyHashGet(&pVm->hClass,(const void *)zClass,(sxu32)nLen);` |
|   35 |  128 | `			if( pEntry ){` |
...
|   52 |  359 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   49 |  360 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|    - |  361 | `		/* Do not register classes defined as interfaces */` |
|   49 |  362 | `		if( (pClass->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|   43 |  363 | `			ph7_value_string(pName,SyStringData(&pClass->sName),(int)SyStringLength(&pClass->sName));` |
|    - |  364 | `			/* insert class name */` |
|   43 |  365 | `			ph7_array_add_elem(pArray,0/*Automatic index assign*/,pName); /* Will make it's own copy */` |
|    - |  366 | `			/* Reset the cursor */` |
|   43 |  367 | `			ph7_value_reset_string_cursor(pName);` |
|   21 |  368 | `		}` |
|    1 |  369 | `	}` |
...
|   54 |  401 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   51 |  402 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|    - |  403 | `		/* Register classes defined as interfaces only */` |
|   51 |  404 | `		if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
...
|    - |  473 | ` */` |
| 2840 |  474 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|    - |  480 | `	)` |
|    2 |  481 |  |
| 2842 |  482 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
| 2278 |  483 | `		VmFrame *pFrame = pVm->pFrame;` |
|    - |  484 | `		ph7_vm_func *pVmFunc;` |
| 2282 |  485 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|    - |  486 | `			/* Safely ignore the exception frame */` |
|    5 |  487 | `			pFrame = pFrame->pParent;` |
|    1 |  488 | `		}` |
| 2278 |  489 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
| 2278 |  490 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|    9 |  491 | `			goto dis; /* Access is forbidden */` |
|    - |  492 | `		}` |
| 2270 |  493 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|    4 |  498 | `		}else{` |
|    - |  499 | `			/* Protected */` |
| 2264 |  500 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|    - |  501 | `			/* Must be a derived class */` |
| 2264 |  502 | `			if( !PH7_VmInstanceOf(pClass,pBase) ){` |
|  ! 0 |  503 | `				goto dis; /* Access is forbidden */` |
|    - |  504 | `			}` |
|    - |  505 | `		}` |
| 1134 |  506 | `	}` |
| 2834 |  507 | `	return 1; /* Access is granted */` |
|    4 |  508 | `dis:` |
|    9 |  509 | `	if( bLog ){` |
...
|    - |  658 | ` */` |
| 5148 |  659 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|    2 |  660 |  |
|    - |  661 | `	ph7_class **apInterface;` |
|    - |  662 | `	sxu32 n;` |
| 5150 |  663 | `	if( SySetUsed(pSet) < 1 ){` |
|    - |  664 | `		/* Empty interface container */` |
| 5148 |  665 | `		return FALSE;` |
|    - |  666 | `	}` |
...
|    - |  681 | ` */` |
| 2318 |  682 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|    2 |  683 |  |
|    - |  684 | `	ph7_class *pParent;` |
|    - |  685 | `	sxi32 rc;` |
| 2320 |  686 | `	if( pThis == pClass ){` |
|    - |  687 | `		/* Instance of the same class */` |
|  140 |  688 | `		return TRUE;` |
|    - |  689 | `	}` |
|    - |  690 | `	/* Check implemented interfaces */` |
| 2182 |  691 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
| 2182 |  692 | `	if( rc ){` |
|    3 |  693 | `		return TRUE;` |
|    - |  694 | `	}` |
|    - |  695 | `	/* Check parent classes */` |
| 2180 |  696 | `	pParent = pThis->pBase;` |
| 5148 |  697 | `	while( pParent ){` |
| 5146 |  698 | `		if( pParent == pClass ){` |
|    - |  699 | `			/* Same instance */` |
| 2178 |  700 | `			return TRUE;` |
|    - |  701 | `		}` |
|    - |  702 | `		/* Check the implemented interfaces */` |
| 2970 |  703 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
| 2970 |  704 | `		if( rc ){` |
|  ! 0 |  705 | `			return TRUE;` |
|    - |  706 | `		}` |
|    - |  707 | `		/* Point to the parent class */` |
| 2970 |  708 | `		pParent = pParent->pBase;` |
|    2 |  709 | `	}` |
