...
|     - |    5 | ` */` |
|     - |    6 | `#include "ph7int.h"` |
|   834 |    7 | `PH7_PRIVATE int vm_builtin_get_class(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |    8 | `{` |
|     - |    9 | `	ph7_class *pClass;` |
|     - |   10 | `	SyString *pName;` |
|   839 |   11 | `	if( nArg < 1 ){` |
...
|   839 |   24 | `		pClass = PH7_VmExtractClassFromValue(pCtx->pVm,apArg[0]);` |
|   839 |   25 | `		if( pClass ){` |
|   837 |   26 | `			pName = &pClass->sName;` |
|     - |   27 | `			/* Return the class name */` |
|   837 |   28 | `			ph7_result_string(pCtx,pName->zString,(int)pName->nByte);` |
|   421 |   29 | `		}else{` |
|     - |   30 | `			/* Not a class instance,return FALSE */` |
|     3 |   31 | `			ph7_result_bool(pCtx,0);` |
|     - |   32 | `		}` |
|     - |   33 | `	}` |
|   839 |   34 | `	return PH7_OK;` |
|     5 |   35 | `}` |
|     - |   36 | `/*` |
...
|     - |   47 | ` */` |
|    42 |   48 | `PH7_PRIVATE int vm_builtin_get_parent_class(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     2 |   49 | `{` |
|     - |   50 | `	ph7_class *pClass;` |
|     - |   51 | `	SyString *pName;` |
|    44 |   52 | `	if( nArg < 1 ){` |
...
|    42 |   65 | `		pClass = PH7_VmExtractClassFromValue(pCtx->pVm,apArg[0]);` |
|    42 |   66 | `		if( pClass ){` |
|    42 |   67 | `			if( pClass->pBase ){` |
|    40 |   68 | `				pName = &pClass->pBase->sName;` |
|     - |   69 | `				/* Return the parent class name */` |
|    40 |   70 | `				ph7_result_string(pCtx,pName->zString,(int)pName->nByte);` |
|    21 |   71 | `			}else{` |
...
|     - |  112 | ` */` |
|  1888 |  113 | `PH7_PRIVATE ph7_class * PH7_VmExtractClassFromValue(ph7_vm *pVm,ph7_value *pArg)` |
|     5 |  114 | `{` |
|  1893 |  115 | `	ph7_class *pClass = 0;` |
|  1893 |  116 | `	if( ph7_value_is_object(pArg) ){` |
|     - |  117 | `		/* Class instance already loaded,no need to perform a lookup */` |
|  1005 |  118 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|  1393 |  119 | `	}else if( ph7_value_is_string(pArg) ){` |
...
|     - |  227 | ` */` |
|    86 |  228 | `PH7_PRIVATE int vm_builtin_class_exists(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     5 |  229 | `{` |
|    91 |  230 | `	int res = 0; /* Assume class does not exist */` |
|    91 |  231 | `	if( nArg > 0 ){` |
|    91 |  232 | `		SyHashEntry *pEntry = 0;` |
|     - |  233 | `		const char *zName;` |
|     - |  234 | `		int nLen;` |
|    91 |  235 | `		int iAutoload = 1; /* Default: autoload enabled */` |
|     - |  236 | `		/* Extract given name */` |
|    91 |  237 | `		zName = ph7_value_to_string(apArg[0],&nLen);` |
|    91 |  238 | `		if( nArg >= 2 ){` |
|     6 |  239 | `			iAutoload = ph7_value_to_bool(apArg[1]);` |
|     2 |  240 | `		}` |
|    91 |  241 | `		if( nLen > 0 ){` |
|     - |  242 | `			/* Perform a hash lookup first */` |
|    91 |  243 | `			pEntry = SyHashGet(&pCtx->pVm->hClass,(const void *)zName,(sxu32)nLen);` |
|    43 |  244 | `		}` |
|    91 |  245 | `		if( pEntry == 0 && nLen > 0 && iAutoload ){` |
...
|    75 |  255 | `			ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|    77 |  256 | `			while( pClass ){` |
|    75 |  257 | `				if( (pClass->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_TRAIT)) == 0 ){` |
|    73 |  258 | `					res = 1;` |
|    73 |  259 | `					break;` |
|     - |  260 | `				}` |
...
|    35 |  263 | `		}` |
|    43 |  264 | `	}` |
|    91 |  265 | `	ph7_result_bool(pCtx,res);` |
|    91 |  266 | `	return PH7_OK;` |
|     5 |  267 | `}` |
|     - |  268 | `/*` |
...
|   380 |  455 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   377 |  456 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|     - |  457 | `		/* Do not register classes defined as interfaces */` |
|   377 |  458 | `		if( (pClass->iFlags & PH7_CLASS_INTERFACE) == 0 ){` |
|   339 |  459 | `			ph7_value_string(pName,SyStringData(&pClass->sName),(int)SyStringLength(&pClass->sName));` |
|     - |  460 | `			/* insert class name */` |
|   339 |  461 | `			ph7_array_add_elem(pArray,0/*Automatic index assign*/,pName); /* Will make it's own copy */` |
|     - |  462 | `			/* Reset the cursor */` |
|   339 |  463 | `			ph7_value_reset_string_cursor(pName);` |
|   169 |  464 | `		}` |
|     1 |  465 | `	}` |
...
|   382 |  497 | `	while((pEntry = SyHashGetNextEntry(&pCtx->pVm->hClass)) != 0 ){` |
|   379 |  498 | `		ph7_class *pClass = (ph7_class *)pEntry->pUserData;` |
|     - |  499 | `		/* Register classes defined as interfaces only */` |
|   379 |  500 | `		if( pClass->iFlags & PH7_CLASS_INTERFACE ){` |
...
|     - |  631 | ` */` |
| 37588 |  632 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|     - |  638 | `	)` |
|     5 |  639 | `{` |
| 37593 |  640 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
| 26723 |  641 | `		VmFrame *pFrame = pVm->pFrame;` |
|     - |  642 | `		ph7_vm_func *pVmFunc;` |
|     - |  643 | `		ph7_class *pCallerScope;` |
| 26737 |  644 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|     - |  645 | `			/* Safely ignore the exception frame */` |
|    16 |  646 | `			pFrame = pFrame->pParent;` |
|     2 |  647 | `		}` |
| 26723 |  648 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
...
| 26723 |  651 | `		if( pFrame->pBoundScope ){` |
|    15 |  652 | `			pCallerScope = pFrame->pBoundScope;` |
| 26716 |  653 | `		}else if( pVmFunc && (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) ){` |
| 26605 |  654 | `			pCallerScope = (ph7_class *)pVmFunc->pUserData;` |
| 13407 |  655 | `		}else if( pVmFunc && (pVmFunc->iFlags & VM_FUNC_CLOSURE) && pVmFunc->pUserData ){` |
...
|     - |  671 | `		}` |
| 26659 |  672 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
| 12469 |  682 | `			ph7_class *pCaller = pCallerScope;` |
| 18701 |  683 | `			SyHashEntry *pOwnE = SyHashGet(&pCaller->hAttr,` |
| 12464 |  684 | `				(const void *)pAttrName->zString,pAttrName->nByte);` |
| 12469 |  685 | `			ph7_class_attr *pOwn = pOwnE ? (ph7_class_attr *)pOwnE->pUserData : 0;` |
| 12469 |  686 | `			int bGranted = 0;` |
| 12469 |  687 | `			if( pOwn && pOwn->iProtection == PH7_CLASS_PROT_PRIVATE ){` |
| 10618 |  688 | `				if( pOwn->pDeclClass == 0` |
| 10618 |  689 | `				 \|\| pOwn->pDeclClass == pCaller` |
|  6264 |  690 | `				 \|\| (pOwn->pDeclClass->iFlags & PH7_CLASS_TRAIT) != 0 ){` |
| 10601 |  691 | `					bGranted = 1;` |
|  5303 |  692 | `				}` |
|  7159 |  693 | `			}else if( pOwn == 0 && pCaller == pClass ){` |
|   963 |  694 | `				bGranted = 1;` |
|   481 |  695 | `			}` |
| 12469 |  696 | `			if( !bGranted ){` |
...
|   ! 0 |  707 | `				}` |
|   453 |  708 | `			}` |
| 12469 |  709 | `			if( !bGranted && (pClass->iFlags & PH7_CLASS_TRAIT) != 0 ){` |
...
|   ! 0 |  725 | `				}` |
|   440 |  726 | `			}` |
| 12469 |  727 | `			if( !bGranted ){` |
|    29 |  728 | `				goto dis; /* Access is forbidden */` |
|     - |  729 | `			}` |
|  6224 |  730 | `		}else{` |
|     - |  731 | `			/* Protected */` |
| 14195 |  732 | `			ph7_class *pBase = pCallerScope;` |
...
| 14195 |  743 | `			ph7_class *pIntro = pClass;` |
|     - |  744 | `			ph7_class *pAnc;` |
| 38633 |  745 | `			for( pAnc = pClass ; pAnc ; pAnc = pAnc->pBase ){` |
| 24443 |  746 | `				ph7_class_method *pAncMeth = PH7_ClassExtractMethod(pAnc,pAttrName->zString,pAttrName->nByte);` |
| 24443 |  747 | `				SyHashEntry *pAncAttrE = SyHashGet(&pAnc->hAttr,(const void *)pAttrName->zString,pAttrName->nByte);` |
| 24443 |  748 | `				ph7_class_attr *pAncAttr = pAncAttrE ? (ph7_class_attr *)pAncAttrE->pUserData : 0;` |
| 24443 |  749 | `				int bHere = 0;` |
| 24443 |  750 | `				if( pAncMeth && (ph7_class *)pAncMeth->sFunc.pUserData == pAnc ){` |
|  3819 |  751 | `					bHere = 1;` |
|  1907 |  752 | `				}` |
| 24443 |  753 | `				if( pAncAttr && (pAncAttr->pDeclClass == pAnc \|\| pAncAttr->pDeclClass == 0) ){` |
| 10925 |  754 | `					bHere = 1;` |
|  5460 |  755 | `				}` |
| 24443 |  756 | `				if( bHere ){` |
| 14739 |  757 | `					pIntro = pAnc; /* keep climbing: the LAST (highest) match wins */` |
|  7367 |  758 | `				}` |
| 12224 |  759 | `			}` |
|     - |  760 | `			/* Must be in the same class hierarchy as the introducing class */` |
| 14195 |  761 | `			if( !PH7_VmInstanceOf(pIntro,pBase) && !PH7_VmInstanceOf(pBase,pIntro) ){` |
...
|     - |  780 | `		}` |
| 13311 |  781 | `	}` |
| 37497 |  782 | `	return 1; /* Access is granted */` |
|    48 |  783 | `dis:` |
|   100 |  784 | `	if( bLog ){` |
...
|     3 |  897 | `{` |
|    51 |  898 | `	ph7_class_instance *pThis = 0;` |
|     - |  899 | `	ph7_value *pName,*pArray;` |
|     - |  900 | `	SyHashEntry *pEntry;` |
|    51 |  901 | `	if( nArg > 0 && (apArg[0]->iFlags & MEMOBJ_OBJ) ){` |
|     - |  902 | `		/* Extract the target instance */` |
|    51 |  903 | `		pThis = (ph7_class_instance *)apArg[0]->x.pOther;` |
|    24 |  904 | `	}` |
|    51 |  905 | `	if( pThis == 0 ){` |
...
|    51 |  911 | `	pArray = ph7_context_new_array(pCtx);` |
|    51 |  912 | `	pName = ph7_context_new_scalar(pCtx);` |
|    51 |  913 | `	if( pArray == 0 \|\| pName == 0){` |
...
|    51 |  929 | `		SySetInit(&sNames,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|    51 |  930 | `		SyHashResetLoopCursor(&pThis->hAttr);` |
|   227 |  931 | `		while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   179 |  932 | `			VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|   179 |  933 | `			if( pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
...
|    86 |  938 | `			 == PH7_CLASS_ATTR_HOOK_VIRTUAL ){` |
|     3 |  939 | `				continue; /* virtual set-only property: no value to expose (php) */` |
|     - |  940 | `			}` |
|   167 |  941 | `			SySetPut(&sNames,(const void *)&pVmAttr->pAttr->sName);` |
|     3 |  942 | `		}` |
|    51 |  943 | `		aName = (SyString *)SySetBasePtr(&sNames);` |
|    51 |  944 | `		nName = SySetUsed(&sNames);` |
|   215 |  945 | `		for( iName = 0 ; iName < nName ; ++iName ){` |
|   167 |  946 | `			SyString *pAttrName = &aName[iName];` |
|     - |  947 | `			VmClassAttr *pVmAttr;` |
|   167 |  948 | `			pEntry = SyHashGet(&pThis->hAttr,(const void *)pAttrName->zString,pAttrName->nByte);` |
|   167 |  949 | `			if( pEntry == 0 ){` |
|   ! 0 |  950 | `				continue; /* unset by an earlier hook */` |
|     - |  951 | `			}` |
|   167 |  952 | `			pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|     - |  953 | `			/* Check if the access is allowed */` |
|   167 |  954 | `			if( PH7_VmClassMemberAccess(pCtx->pVm,pThis->pClass,pAttrName,pVmAttr->pAttr->iProtection,FALSE) ){` |
|   133 |  955 | `				ph7_value *pValue = 0;` |
...
|   133 |  960 | `				PH7_MemObjInit(pCtx->pVm,&sHookVal);` |
|   133 |  961 | `				rcHk = PH7_VmHookGetAttrValue(pThis,pVmAttr,&sHookVal);` |
|   133 |  962 | `				if( rcHk == SXRET_OK ){` |
|    15 |  963 | `					pValue = &sHookVal;` |
|   126 |  964 | `				}else if( rcHk == SXERR_NOTFOUND ){` |
|     - |  965 | `					/* Extract attribute */` |
|   119 |  966 | `					pValue = PH7_ClassInstanceExtractAttrValue(pThis,pVmAttr);` |
|    61 |  967 | `				}else{` |
...
|   133 |  977 | `					ph7_value_string(pName,pAttrName->zString,pAttrName->nByte);` |
|   133 |  978 | `					ph7_array_add_elem(pArray,pName,pValue); /* Will make it's own copy */` |
|    65 |  979 | `				}` |
|   133 |  980 | `				PH7_MemObjRelease(&sHookVal);` |
|     - |  981 | `				/* Reset the cursor */` |
|   133 |  982 | `				ph7_value_reset_string_cursor(pName);` |
|    65 |  983 | `			}` |
|    85 |  984 | `		}` |
|    51 |  985 | `		SySetRelease(&sNames);` |
|     - |  986 | `	}` |
|     - |  987 | `	/* Return the created array */` |
|    51 |  988 | `	ph7_result_value(pCtx,pArray);` |
|     - |  989 | `	/*` |
...
|     - | 1005 | ` */` |
| 14668 | 1006 | `static int VmInterfaceReaches(ph7_class *pIface,ph7_class *pTarget,int iDepth)` |
|     5 | 1007 | `{` |
| 27023 | 1008 | `	while( pIface && iDepth <= PH7_INTERFACE_WALK_MAX_DEPTH ){` |
|     - | 1009 | `		ph7_class **apParent;` |
|     - | 1010 | `		sxu32 n;` |
| 17339 | 1011 | `		if( pIface == pTarget ){` |
|  4987 | 1012 | `			return TRUE;` |
|     - | 1013 | `		}` |
...
| 12357 | 1016 | `		apParent = (ph7_class **)SySetBasePtr(&pIface->aInterface);` |
| 12361 | 1017 | `		for( n = 0 ; n < SySetUsed(&pIface->aInterface) ; n++ ){` |
|     7 | 1018 | `			if( VmInterfaceReaches(apParent[n],pTarget,iDepth+1) ){` |
|     3 | 1019 | `				return TRUE;` |
|     - | 1020 | `			}` |
|     3 | 1021 | `		}` |
| 12355 | 1022 | `		pIface = pIface->pBase;` |
| 12355 | 1023 | `		iDepth++;` |
|     5 | 1024 | `	}` |
|  9689 | 1025 | `	return FALSE;` |
|  7339 | 1026 | `}` |
|     - | 1027 | `/*` |
|     - | 1028 | ` * This function returns TRUE if the given class is an implemented` |
|     - | 1029 | ` * interface.Otherwise FALSE is returned.` |
|     - | 1030 | ` */` |
| 17814 | 1031 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|     5 | 1032 | `{` |
|     - | 1033 | `	ph7_class **apInterface;` |
|     - | 1034 | `	sxu32 n;` |
| 17819 | 1035 | `	if( SySetUsed(pSet) < 1 ){` |
|     - | 1036 | `		/* Empty interface container */` |
|  5199 | 1037 | `		return FALSE;` |
|     - | 1038 | `	}` |
|     - | 1039 | `	/* Point to the set of implemented interfaces */` |
| 12625 | 1040 | `	apInterface = (ph7_class **)SySetBasePtr(pSet);` |
...
| 22305 | 1043 | `	for( n = 0 ; n < SySetUsed(pSet) ; n++ ){` |
| 14667 | 1044 | `		if( VmInterfaceReaches(apInterface[n],pClass,0) ){` |
|  4987 | 1045 | `			return TRUE;` |
|     - | 1046 | `		}` |
|  4845 | 1047 | `	}` |
|  7643 | 1048 | `	return FALSE;` |
|  8912 | 1049 | `}` |
|     - | 1050 | `/*` |
...
|     - | 1054 | ` */` |
| 28472 | 1055 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|     5 | 1056 | `{` |
|     - | 1057 | `	ph7_class *pParent;` |
|     - | 1058 | `	sxi32 rc;` |
| 28477 | 1059 | `	if( pThis == pClass ){` |
|     - | 1060 | `		/* Instance of the same class */` |
| 15437 | 1061 | `		return TRUE;` |
|     - | 1062 | `	}` |
|     - | 1063 | `	/* Check implemented interfaces */` |
| 13045 | 1064 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
| 13045 | 1065 | `	if( rc ){` |
|  2111 | 1066 | `		return TRUE;` |
|     - | 1067 | `	}` |
|     - | 1068 | `	/* Check parent classes */` |
| 10939 | 1069 | `	pParent = pThis->pBase;` |
| 12827 | 1070 | `	while( pParent ){` |
|  5793 | 1071 | `		if( pParent == pClass ){` |
|     - | 1072 | `			/* Same instance */` |
|  1029 | 1073 | `			return TRUE;` |
|     - | 1074 | `		}` |
|     - | 1075 | `		/* Check the implemented interfaces */` |
|  4769 | 1076 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
|  4769 | 1077 | `		if( rc ){` |
|  2881 | 1078 | `			return TRUE;` |
|     - | 1079 | `		}` |
|     - | 1080 | `		/* Point to the parent class */` |
|  1893 | 1081 | `		pParent = pParent->pBase;` |
|     5 | 1082 | `	}` |
|     - | 1083 | `	/* Not an instance of the the given class */` |
|  7039 | 1084 | `	return FALSE;` |
| 14241 | 1085 | `}` |
|     - | 1086 | `/*` |
