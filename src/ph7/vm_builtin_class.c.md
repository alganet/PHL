...
|    - |  507 | ` */` |
| 5846 |  508 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|    - |  514 | `	)` |
|    2 |  515 |  |
| 5848 |  516 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
| 4630 |  517 | `		VmFrame *pFrame = pVm->pFrame;` |
|    - |  518 | `		ph7_vm_func *pVmFunc;` |
| 4630 |  519 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|    - |  520 | `			/* Safely ignore the exception frame */` |
|  ! 0 |  521 | `			pFrame = pFrame->pParent;` |
|  ! 0 |  522 | `		}` |
| 4630 |  523 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
| 4630 |  524 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|   12 |  525 | `			goto dis; /* Access is forbidden */` |
|    - |  526 | `		}` |
| 4620 |  527 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|  120 |  547 | `		}else{` |
|    - |  548 | `			/* Protected */` |
| 4382 |  549 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|    - |  550 | `			/* Must be in the same class hierarchy */` |
| 4382 |  551 | `			if( !PH7_VmInstanceOf(pClass,pBase) && !PH7_VmInstanceOf(pBase,pClass) ){` |
|  ! 0 |  552 | `				goto dis; /* Access is forbidden */` |
|    - |  553 | `			}` |
|    - |  554 | `		}` |
| 2308 |  555 | `	}` |
| 5836 |  556 | `	return 1; /* Access is granted */` |
|    6 |  557 | `dis:` |
|   14 |  558 | `	if( bLog ){` |
...
|    - |  707 | ` */` |
| 5286 |  708 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|    2 |  709 |  |
|    - |  710 | `	ph7_class **apInterface;` |
|    - |  711 | `	sxu32 n;` |
| 5288 |  712 | `	if( SySetUsed(pSet) < 1 ){` |
|    - |  713 | `		/* Empty interface container */` |
| 5012 |  714 | `		return FALSE;` |
|    - |  715 | `	}` |
...
|    - |  730 | ` */` |
| 4910 |  731 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|    2 |  732 |  |
|    - |  733 | `	ph7_class *pParent;` |
|    - |  734 | `	sxi32 rc;` |
| 4912 |  735 | `	if( pThis == pClass ){` |
|    - |  736 | `		/* Instance of the same class */` |
|  950 |  737 | `		return TRUE;` |
|    - |  738 | `	}` |
|    - |  739 | `	/* Check implemented interfaces */` |
| 3964 |  740 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
| 3964 |  741 | `	if( rc ){` |
|  130 |  742 | `		return TRUE;` |
|    - |  743 | `	}` |
|    - |  744 | `	/* Check parent classes */` |
| 3836 |  745 | `	pParent = pThis->pBase;` |
| 5098 |  746 | `	while( pParent ){` |
| 5024 |  747 | `		if( pParent == pClass ){` |
|    - |  748 | `			/* Same instance */` |
| 3700 |  749 | `			return TRUE;` |
|    - |  750 | `		}` |
