...
|    - |    5 | ` */` |
|    - |    6 | `#include "ph7int.h"` |
|   38 |    7 | `PH7_PRIVATE int vm_builtin_get_class(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    2 |    8 |  |
|    - |    9 | `	ph7_class *pClass;` |
|    - |   10 | `	SyString *pName;` |
|   40 |   11 | `	if( nArg < 1 ){` |
...
|   40 |   24 | `		pClass = PH7_VmExtractClassFromValue(pCtx->pVm,apArg[0]);` |
|   40 |   25 | `		if( pClass ){` |
|   38 |   26 | `			pName = &pClass->sName;` |
|    - |   27 | `			/* Return the class name */` |
|   38 |   28 | `			ph7_result_string(pCtx,pName->zString,(int)pName->nByte);` |
|   20 |   29 | `		}else{` |
...
|    - |  112 | ` */` |
|  106 |  113 | `PH7_PRIVATE ph7_class * PH7_VmExtractClassFromValue(ph7_vm *pVm,ph7_value *pArg)` |
|    2 |  114 |  |
|  108 |  115 | `	ph7_class *pClass = 0;` |
|  108 |  116 | `	if( ph7_value_is_object(pArg) ){` |
|    - |  117 | `		/* Class instance already loaded,no need to perform a lookup */` |
|   68 |  118 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|   75 |  119 | `	}else if( ph7_value_is_string(pArg) ){` |
...
|    - |  507 | ` */` |
| 4974 |  508 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|    - |  514 | `	)` |
|    2 |  515 |  |
| 4976 |  516 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
| 3952 |  517 | `		VmFrame *pFrame = pVm->pFrame;` |
|    - |  518 | `		ph7_vm_func *pVmFunc;` |
| 3952 |  519 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|    - |  520 | `			/* Safely ignore the exception frame */` |
|  ! 0 |  521 | `			pFrame = pFrame->pParent;` |
|  ! 0 |  522 | `		}` |
| 3952 |  523 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
| 3952 |  524 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|   12 |  525 | `			goto dis; /* Access is forbidden */` |
|    - |  526 | `		}` |
| 3942 |  527 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
|    - |  528 | `			/* Must be the same instance or a trait used by the class */` |
|  236 |  529 | `			ph7_class *pCaller = (ph7_class *)pVmFunc->pUserData;` |
|  236 |  530 | `			if( pCaller != pClass ){` |
...
|  118 |  547 | `		}else{` |
|    - |  548 | `			/* Protected */` |
| 3708 |  549 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|    - |  550 | `			/* Must be in the same class hierarchy */` |
| 3708 |  551 | `			if( !PH7_VmInstanceOf(pClass,pBase) && !PH7_VmInstanceOf(pBase,pClass) ){` |
|  ! 0 |  552 | `				goto dis; /* Access is forbidden */` |
|    - |  553 | `			}` |
|    - |  554 | `		}` |
| 1969 |  555 | `	}` |
| 4964 |  556 | `	return 1; /* Access is granted */` |
|    6 |  557 | `dis:` |
|   14 |  558 | `	if( bLog ){` |
...
|    - |  707 | ` */` |
| 8024 |  708 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|    2 |  709 |  |
|    - |  710 | `	ph7_class **apInterface;` |
|    - |  711 | `	sxu32 n;` |
| 8026 |  712 | `	if( SySetUsed(pSet) < 1 ){` |
|    - |  713 | `		/* Empty interface container */` |
| 7992 |  714 | `		return FALSE;` |
|    - |  715 | `	}` |
|    - |  716 | `	/* Point to the set of implemented interfaces */` |
|   36 |  717 | `	apInterface = (ph7_class **)SySetBasePtr(pSet);` |
|    - |  718 | `	/* Perform the lookup */` |
|   40 |  719 | `	for( n = 0 ; n < SySetUsed(pSet) ; n++ ){` |
|   36 |  720 | `		if( apInterface[n] == pClass ){` |
|   32 |  721 | `			return TRUE;` |
|    - |  722 | `		}` |
|    3 |  723 | `	}` |
|    5 |  724 | `	return FALSE;` |
...
|    - |  730 | ` */` |
| 4060 |  731 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|    2 |  732 |  |
|    - |  733 | `	ph7_class *pParent;` |
|    - |  734 | `	sxi32 rc;` |
| 4062 |  735 | `	if( pThis == pClass ){` |
|    - |  736 | `		/* Instance of the same class */` |
|  414 |  737 | `		return TRUE;` |
|    - |  738 | `	}` |
|    - |  739 | `	/* Check implemented interfaces */` |
| 3650 |  740 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
| 3650 |  741 | `	if( rc ){` |
|   32 |  742 | `		return TRUE;` |
|    - |  743 | `	}` |
|    - |  744 | `	/* Check parent classes */` |
| 3620 |  745 | `	pParent = pThis->pBase;` |
| 7996 |  746 | `	while( pParent ){` |
| 7938 |  747 | `		if( pParent == pClass ){` |
|    - |  748 | `			/* Same instance */` |
| 3562 |  749 | `			return TRUE;` |
|    - |  750 | `		}` |
|    - |  751 | `		/* Check the implemented interfaces */` |
| 4378 |  752 | `		rc = VmQueryInterfaceSet(pClass,&pParent->aInterface);` |
| 4378 |  753 | `		if( rc ){` |
|  ! 0 |  754 | `			return TRUE;` |
|    - |  755 | `		}` |
|    - |  756 | `		/* Point to the parent class */` |
| 4378 |  757 | `		pParent = pParent->pBase;` |
|    2 |  758 | `	}` |
