...
|     - |    5 | ` */` |
|     - |    6 | `#include "ph7int.h"` |
|    88 |    7 | `PH7_PRIVATE int vm_builtin_get_class(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     4 |    8 |  |
|     - |    9 | `	ph7_class *pClass;` |
|     - |   10 | `	SyString *pName;` |
|    92 |   11 | `	if( nArg < 1 ){` |
...
|    92 |   24 | `		pClass = PH7_VmExtractClassFromValue(pCtx->pVm,apArg[0]);` |
|    92 |   25 | `		if( pClass ){` |
|    89 |   26 | `			pName = &pClass->sName;` |
|     - |   27 | `			/* Return the class name */` |
|    89 |   28 | `			ph7_result_string(pCtx,pName->zString,(int)pName->nByte);` |
|    46 |   29 | `		}else{` |
...
|     - |  112 | ` */` |
|   186 |  113 | `PH7_PRIVATE ph7_class * PH7_VmExtractClassFromValue(ph7_vm *pVm,ph7_value *pArg)` |
|     4 |  114 |  |
|   190 |  115 | `	ph7_class *pClass = 0;` |
|   190 |  116 | `	if( ph7_value_is_object(pArg) ){` |
|     - |  117 | `		/* Class instance already loaded,no need to perform a lookup */` |
|   124 |  118 | `		pClass = ((ph7_class_instance *)pArg->x.pOther)->pClass;` |
|   129 |  119 | `	}else if( ph7_value_is_string(pArg) ){` |
...
|     - |  507 | ` */` |
|  8038 |  508 | `PH7_PRIVATE int PH7_VmClassMemberAccess(` |
...
|     - |  514 | `	)` |
|     5 |  515 |  |
|  8043 |  516 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  6437 |  517 | `		VmFrame *pFrame = pVm->pFrame;` |
|     - |  518 | `		ph7_vm_func *pVmFunc;` |
|  6437 |  519 | `		while( pFrame->pParent && (pFrame->iFlags & (VM_FRAME_EXCEPTION\|VM_FRAME_CATCH) ) ){` |
|     - |  520 | `			/* Safely ignore the exception frame */` |
|   ! 0 |  521 | `			pFrame = pFrame->pParent;` |
|   ! 0 |  522 | `		}` |
|  6437 |  523 | `		pVmFunc = (ph7_vm_func *)pFrame->pUserData;` |
|  6437 |  524 | `		if( pVmFunc == 0 \|\| (pVmFunc->iFlags & VM_FUNC_CLASS_METHOD) == 0 ){` |
|    12 |  525 | `			goto dis; /* Access is forbidden */` |
|     - |  526 | `		}` |
|  6427 |  527 | `		if( iProtection == PH7_CLASS_PROT_PRIVATE ){` |
...
|   189 |  547 | `		}else{` |
|     - |  548 | `			/* Protected */` |
|  6057 |  549 | `			ph7_class *pBase = (ph7_class *)pVmFunc->pUserData;` |
|     - |  550 | `			/* Must be in the same class hierarchy */` |
|  6057 |  551 | `			if( !PH7_VmInstanceOf(pClass,pBase) && !PH7_VmInstanceOf(pBase,pClass) ){` |
|   ! 0 |  552 | `				goto dis; /* Access is forbidden */` |
|     - |  553 | `			}` |
|     - |  554 | `		}` |
|  3210 |  555 | `	}` |
|  8031 |  556 | `	return 1; /* Access is granted */` |
|     6 |  557 | `dis:` |
|    14 |  558 | `	if( bLog ){` |
...
|     - |  711 | ` */` |
|  7044 |  712 | `static int VmQueryInterfaceSet(ph7_class *pClass,SySet *pSet)` |
|     5 |  713 |  |
|     - |  714 | `	ph7_class **apInterface;` |
|     - |  715 | `	sxu32 n;` |
|  7049 |  716 | `	if( SySetUsed(pSet) < 1 ){` |
|     - |  717 | `		/* Empty interface container */` |
|   133 |  718 | `		return FALSE;` |
|     - |  719 | `	}` |
|     - |  720 | `	/* Point to the set of implemented interfaces */` |
|  6921 |  721 | `	apInterface = (ph7_class **)SySetBasePtr(pSet);` |
...
| 13355 |  724 | `	for( n = 0 ; n < SySetUsed(pSet) ; n++ ){` |
|  7005 |  725 | `		ph7_class *pIface = apInterface[n];` |
|  7005 |  726 | `		int iDepth = 0;` |
| 13501 |  727 | `		while( pIface && iDepth <= PH7_INTERFACE_WALK_MAX_DEPTH ){` |
|  7067 |  728 | `			if( pIface == pClass ){` |
|   571 |  729 | `				return TRUE;` |
|     - |  730 | `			}` |
|  6501 |  731 | `			pIface = pIface->pBase;` |
|  6501 |  732 | `			iDepth++;` |
|     5 |  733 | `		}` |
|  3222 |  734 | `	}` |
|  6355 |  735 | `	return FALSE;` |
|  3527 |  736 |  |
|     - |  737 | `/*` |
...
|     - |  741 | ` */` |
|  7250 |  742 | `PH7_PRIVATE int PH7_VmInstanceOf(ph7_class *pThis,ph7_class *pClass)` |
|     5 |  743 |  |
|     - |  744 | `	ph7_class *pParent;` |
|     - |  745 | `	sxi32 rc;` |
|  7255 |  746 | `	if( pThis == pClass ){` |
|     - |  747 | `		/* Instance of the same class */` |
|  1939 |  748 | `		return TRUE;` |
|     - |  749 | `	}` |
|     - |  750 | `	/* Check implemented interfaces */` |
|  5321 |  751 | `	rc = VmQueryInterfaceSet(pClass,&pThis->aInterface);` |
|  5321 |  752 | `	if( rc ){` |
|   479 |  753 | `		return TRUE;` |
|     - |  754 | `	}` |
|     - |  755 | `	/* Check parent classes */` |
|  4847 |  756 | `	pParent = pThis->pBase;` |
|  6483 |  757 | `	while( pParent ){` |
|  6381 |  758 | `		if( pParent == pClass ){` |
|     - |  759 | `			/* Same instance */` |
|  4653 |  760 | `			return TRUE;` |
|     - |  761 | `		}` |
