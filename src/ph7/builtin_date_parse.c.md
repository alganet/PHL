...
|     - | 1937 | ` */` |
|  3890 | 1938 | `PH7_PRIVATE sxi32 PH7_VmInstallDateTime(ph7_vm *pVm)` |
|     5 | 1939 | `{` |
...
|  3895 | 1956 | `	SyMemcpy("UTC",pVm->zDefTz,sizeof("UTC"));` |
|  3895 | 1957 | `	pVm->nDefTz = sizeof("UTC") - 1;` |
| 38905 | 1958 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 35015 | 1959 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
| 17510 | 1960 | `	}` |
|  3895 | 1961 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zDateTimeLib,sizeof(zDateTimeLib)-1);` |
|     5 | 1962 | `}` |
|     - | 1963 |  |
