...
|      - |   28 | ` * VM_EXIT_BREAK.` |
|      - |   29 | ` */` |
| 243610 |   30 | `PH7_PRIVATE VmOpRc VmExecOpForeachStep(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   31 | `{` |
| 243615 |   32 | `	ph7_value *pTos = pState->pTos;` |
| 243615 |   33 | `	ph7_value *pStack = pState->pStack;` |
| 243615 |   34 | `	VmInstr *aInstr = pState->aInstr;` |
| 243615 |   35 | `	sxi32 pc = pState->pc;` |
|      - |   36 | `	sxi32 rc;` |
| 243615 |   37 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |   38 | `	ph7_foreach_step **apStep,*pStep;` |
|      - |   39 | `	ph7_value *pValue;` |
|      - |   40 | `	VmFrame *pFrameLocal;` |
|      - |   41 | `	sxu32 nStep;` |
| 243615 |   42 | `	pFrameLocal = pVm->pFrame;` |
| 243615 |   43 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
...
| 243615 |   50 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
| 243615 |   51 | `	nStep = SySetUsed(&pInfo->aStep);` |
| 243615 |   52 | `	if( nStep < 1 ){` |
...
|    ! 0 |   57 | `		VM_EXIT_BREAK;` |
|      - |   58 | `	}` |
| 243615 |   59 | `	pStep = apStep[nStep - 1];` |
| 243641 |   60 | `	while( nStep > 0 ){` |
| 243641 |   61 | `		if( apStep[nStep - 1]->pFrame == pFrameLocal ){` |
| 243615 |   62 | `			pStep = apStep[nStep - 1];` |
| 243615 |   63 | `			break;` |
|      - |   64 | `		}` |
|     27 |   65 | `		nStep--;` |
|      1 |   66 | `	}` |
| 243615 |   67 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
...
| 242229 |   71 | `		pNode = pStep->pCursor;` |
| 242229 |   72 | `		if( pNode == 0 ){` |
...
| 218543 |   83 | `			pStep->pCursor = pNode->pPrev; /* Reverse link */` |
| 218543 |   84 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|   6953 |   85 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|   6953 |   86 | `				if( pKey ){` |
|   6953 |   87 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|   3474 |   88 | `				}` |
|   3474 |   89 | `			}` |
| 218543 |   90 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
| 218473 |  102 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
| 218473 |  103 | `				if( pValue ){` |
| 218473 |  104 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
| 109234 |  105 | `				}` |
|      - |  106 | `			}` |
|      5 |  107 | `		}` |
| 122503 |  108 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
