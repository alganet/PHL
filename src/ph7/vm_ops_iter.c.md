...
|      - |   28 | ` * VM_EXIT_BREAK.` |
|      - |   29 | ` */` |
| 259202 |   30 | `PH7_PRIVATE VmOpRc VmExecOpForeachStep(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   31 | `{` |
| 259207 |   32 | `	ph7_value *pTos = pState->pTos;` |
| 259207 |   33 | `	ph7_value *pStack = pState->pStack;` |
| 259207 |   34 | `	VmInstr *aInstr = pState->aInstr;` |
| 259207 |   35 | `	sxi32 pc = pState->pc;` |
|      - |   36 | `	sxi32 rc;` |
| 259207 |   37 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |   38 | `	ph7_foreach_step **apStep,*pStep;` |
|      - |   39 | `	ph7_value *pValue;` |
|      - |   40 | `	VmFrame *pFrameLocal;` |
|      - |   41 | `	sxu32 nStep;` |
| 259207 |   42 | `	pFrameLocal = pVm->pFrame;` |
| 259207 |   43 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
...
| 259207 |   50 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
| 259207 |   51 | `	nStep = SySetUsed(&pInfo->aStep);` |
| 259207 |   52 | `	if( nStep < 1 ){` |
...
|    ! 0 |   57 | `		VM_EXIT_BREAK;` |
|      - |   58 | `	}` |
| 259207 |   59 | `	pStep = apStep[nStep - 1];` |
| 259233 |   60 | `	while( nStep > 0 ){` |
| 259233 |   61 | `		if( apStep[nStep - 1]->pFrame == pFrameLocal ){` |
| 259207 |   62 | `			pStep = apStep[nStep - 1];` |
| 259207 |   63 | `			break;` |
|      - |   64 | `		}` |
|     27 |   65 | `		nStep--;` |
|      1 |   66 | `	}` |
| 259207 |   67 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
...
| 257833 |   71 | `		pNode = pStep->pCursor;` |
| 257833 |   72 | `		if( pNode == 0 ){` |
|      - |   73 | `			/* No more entry to process */` |
|  22979 |   74 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|  22979 |   75 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|  22979 |   80 | `			VmForeachHashmapStepRelease(&(*pVm),pInfo,pStep,TRUE);` |
|  11492 |   81 | `		}else{` |
...
|      - |  106 | `			}` |
|      5 |  107 | `		}` |
| 130293 |  108 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
...
|      - |  311 | ` */` |
|  23402 |  312 | `PH7_PRIVATE VmOpRc VmExecOpForeachInit(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  313 | `{` |
|  23407 |  314 | `	ph7_value *pTos = pState->pTos;` |
|  23407 |  315 | `	ph7_value *pStack = pState->pStack;` |
|  23407 |  316 | `	VmInstr *aInstr = pState->aInstr;` |
|  23407 |  317 | `	sxi32 pc = pState->pc;` |
|      - |  318 | `	sxi32 rc;` |
|  23407 |  319 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |  320 | `	void *pName;` |
|      - |  321 | `#ifdef UNTRUST` |
|      - |  322 | `	if( pTos < pStack ){` |
|      - |  323 | `		VM_EXIT_ABORT;` |
|      - |  324 | `	}` |
|      - |  325 | `#endif` |
|  23407 |  326 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|    ! 0 |  338 | `	}` |
|  23407 |  339 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|  23407 |  352 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|  23403 |  363 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|  23403 |  364 | `		if( pStep == 0 ){` |
...
|  23403 |  370 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|      - |  371 | `			/* Prepare the step */` |
|  23403 |  372 | `			pStep->iFlags = pInfo->iFlags;` |
...
|  23403 |  377 | `			pStep->pFrame = VmSkipExceptionFrames(pVm->pFrame);` |
|  23403 |  378 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
|  23155 |  382 | `				if( (pStep->iFlags & PH7_4EACH_STEP_REF) && pTos->nIdx != SXU32_HIGH ){` |
...
|     13 |  397 | `					}` |
|     13 |  398 | `				}` |
|  23155 |  399 | `				pMap = (ph7_hashmap *)pTos->x.pOther;` |
|  23155 |  400 | `				pIterMap = pMap;` |
|  23155 |  401 | `				if( pMap == pVm->pGlobal && (pStep->iFlags & PH7_4EACH_STEP_REF) == 0 ){` |
...
|    ! 0 |  413 | `					}` |
|      2 |  414 | `				}` |
|  23155 |  415 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|  23155 |  416 | `				pStep->xIter.pMap = pIterMap;` |
|  23155 |  417 | `				if( pIterMap == pMap ){` |
|  23151 |  418 | `					pMap->iRef++;` |
|  11573 |  419 | `				}` |
...
|  23155 |  423 | `				PH7_HashmapRegisterForeachStep(pIterMap,pStep);` |
|  11580 |  424 | `			}else{` |
...
|      - |  517 | `		}` |
|  23397 |  518 | `		if( pStep ){` |
|  23397 |  519 | `			if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|  11696 |  529 | `		}` |
|      - |  530 | `	}` |
|  23401 |  531 | `	VmPopOperand(&pTos,1);` |
|  23401 |  532 | `	VM_EXIT_BREAK;` |
|    ! 0 |  533 | `	VM_EXIT_BREAK;` |
|  11706 |  534 | `}` |
|      - |  535 |  |
