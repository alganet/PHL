...
|      - |   28 | ` * VM_EXIT_BREAK.` |
|      - |   29 | ` */` |
| 260424 |   30 | `PH7_PRIVATE VmOpRc VmExecOpForeachStep(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   31 | `{` |
| 260429 |   32 | `	ph7_value *pTos = pState->pTos;` |
| 260429 |   33 | `	ph7_value *pStack = pState->pStack;` |
| 260429 |   34 | `	VmInstr *aInstr = pState->aInstr;` |
| 260429 |   35 | `	sxi32 pc = pState->pc;` |
|      - |   36 | `	sxi32 rc;` |
| 260429 |   37 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |   38 | `	ph7_foreach_step **apStep,*pStep;` |
|      - |   39 | `	ph7_value *pValue;` |
|      - |   40 | `	VmFrame *pFrameLocal;` |
|      - |   41 | `	sxu32 nStep;` |
| 260429 |   42 | `	pFrameLocal = pVm->pFrame;` |
| 260429 |   43 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
...
| 260429 |   50 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
| 260429 |   51 | `	nStep = SySetUsed(&pInfo->aStep);` |
| 260429 |   52 | `	if( nStep < 1 ){` |
...
|    ! 0 |   57 | `		VM_EXIT_BREAK;` |
|      - |   58 | `	}` |
| 260429 |   59 | `	pStep = apStep[nStep - 1];` |
| 260455 |   60 | `	while( nStep > 0 ){` |
| 260455 |   61 | `		if( apStep[nStep - 1]->pFrame == pFrameLocal ){` |
| 260429 |   62 | `			pStep = apStep[nStep - 1];` |
| 260429 |   63 | `			break;` |
|      - |   64 | `		}` |
|     27 |   65 | `		nStep--;` |
|      1 |   66 | `	}` |
| 260429 |   67 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
...
| 259043 |   71 | `		pNode = pStep->pCursor;` |
| 259043 |   72 | `		if( pNode == 0 ){` |
...
| 235487 |   83 | `			pStep->pCursor = pNode->pPrev; /* Reverse link */` |
| 235487 |   84 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|   6863 |   85 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|   6863 |   86 | `				if( pKey ){` |
|   6863 |   87 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|   3429 |   88 | `				}` |
|   3429 |   89 | `			}` |
| 235487 |   90 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
| 235417 |  102 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
| 235417 |  103 | `				if( pValue ){` |
| 235417 |  104 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
| 117706 |  105 | `				}` |
|      - |  106 | `			}` |
|      5 |  107 | `		}` |
| 130910 |  108 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
