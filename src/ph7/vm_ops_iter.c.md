...
|      - |   28 | ` * VM_EXIT_BREAK.` |
|      - |   29 | ` */` |
| 260386 |   30 | `PH7_PRIVATE VmOpRc VmExecOpForeachStep(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   31 | `{` |
| 260391 |   32 | `	ph7_value *pTos = pState->pTos;` |
| 260391 |   33 | `	ph7_value *pStack = pState->pStack;` |
| 260391 |   34 | `	VmInstr *aInstr = pState->aInstr;` |
| 260391 |   35 | `	sxi32 pc = pState->pc;` |
|      - |   36 | `	sxi32 rc;` |
| 260391 |   37 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |   38 | `	ph7_foreach_step **apStep,*pStep;` |
|      - |   39 | `	ph7_value *pValue;` |
|      - |   40 | `	VmFrame *pFrameLocal;` |
|      - |   41 | `	sxu32 nStep;` |
| 260391 |   42 | `	pFrameLocal = pVm->pFrame;` |
| 260391 |   43 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
...
| 260391 |   50 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
| 260391 |   51 | `	nStep = SySetUsed(&pInfo->aStep);` |
| 260391 |   52 | `	if( nStep < 1 ){` |
...
|    ! 0 |   57 | `		VM_EXIT_BREAK;` |
|      - |   58 | `	}` |
| 260391 |   59 | `	pStep = apStep[nStep - 1];` |
| 260417 |   60 | `	while( nStep > 0 ){` |
| 260417 |   61 | `		if( apStep[nStep - 1]->pFrame == pFrameLocal ){` |
| 260391 |   62 | `			pStep = apStep[nStep - 1];` |
| 260391 |   63 | `			break;` |
|      - |   64 | `		}` |
|     27 |   65 | `		nStep--;` |
|      1 |   66 | `	}` |
| 260391 |   67 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
...
| 259005 |   71 | `		pNode = pStep->pCursor;` |
| 259005 |   72 | `		if( pNode == 0 ){` |
...
| 235449 |   83 | `			pStep->pCursor = pNode->pPrev; /* Reverse link */` |
| 235449 |   84 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|   6863 |   85 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|   6863 |   86 | `				if( pKey ){` |
|   6863 |   87 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|   3429 |   88 | `				}` |
|   3429 |   89 | `			}` |
| 235449 |   90 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
| 235379 |  102 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
| 235379 |  103 | `				if( pValue ){` |
| 235379 |  104 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
| 117687 |  105 | `				}` |
|      - |  106 | `			}` |
|      5 |  107 | `		}` |
| 130891 |  108 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
