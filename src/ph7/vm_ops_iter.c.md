...
|      - |   28 | ` * VM_EXIT_BREAK.` |
|      - |   29 | ` */` |
| 242834 |   30 | `PH7_PRIVATE VmOpRc VmExecOpForeachStep(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   31 | `{` |
| 242839 |   32 | `	ph7_value *pTos = pState->pTos;` |
| 242839 |   33 | `	ph7_value *pStack = pState->pStack;` |
| 242839 |   34 | `	VmInstr *aInstr = pState->aInstr;` |
| 242839 |   35 | `	sxi32 pc = pState->pc;` |
|      - |   36 | `	sxi32 rc;` |
| 242839 |   37 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |   38 | `	ph7_foreach_step **apStep,*pStep;` |
|      - |   39 | `	ph7_value *pValue;` |
|      - |   40 | `	VmFrame *pFrameLocal;` |
|      - |   41 | `	sxu32 nStep;` |
| 242839 |   42 | `	pFrameLocal = pVm->pFrame;` |
| 242839 |   43 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
...
| 242839 |   50 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
| 242839 |   51 | `	nStep = SySetUsed(&pInfo->aStep);` |
| 242839 |   52 | `	if( nStep < 1 ){` |
...
|    ! 0 |   57 | `		VM_EXIT_BREAK;` |
|      - |   58 | `	}` |
| 242839 |   59 | `	pStep = apStep[nStep - 1];` |
| 242865 |   60 | `	while( nStep > 0 ){` |
| 242865 |   61 | `		if( apStep[nStep - 1]->pFrame == pFrameLocal ){` |
| 242839 |   62 | `			pStep = apStep[nStep - 1];` |
| 242839 |   63 | `			break;` |
|      - |   64 | `		}` |
|     27 |   65 | `		nStep--;` |
|      1 |   66 | `	}` |
| 242839 |   67 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
...
| 241453 |   71 | `		pNode = pStep->pCursor;` |
| 241453 |   72 | `		if( pNode == 0 ){` |
...
| 217775 |   83 | `			pStep->pCursor = pNode->pPrev; /* Reverse link */` |
| 217775 |   84 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|   6965 |   85 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|   6965 |   86 | `				if( pKey ){` |
|   6965 |   87 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|   3480 |   88 | `				}` |
|   3480 |   89 | `			}` |
| 217775 |   90 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
| 217705 |  102 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
| 217705 |  103 | `				if( pValue ){` |
| 217705 |  104 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
| 108850 |  105 | `				}` |
|      - |  106 | `			}` |
|      5 |  107 | `		}` |
| 122115 |  108 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
