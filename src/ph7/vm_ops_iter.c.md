...
|      - |   28 | ` * VM_EXIT_BREAK.` |
|      - |   29 | ` */` |
| 242178 |   30 | `PH7_PRIVATE VmOpRc VmExecOpForeachStep(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   31 | `{` |
| 242183 |   32 | `	ph7_value *pTos = pState->pTos;` |
| 242183 |   33 | `	ph7_value *pStack = pState->pStack;` |
| 242183 |   34 | `	VmInstr *aInstr = pState->aInstr;` |
| 242183 |   35 | `	sxi32 pc = pState->pc;` |
|      - |   36 | `	sxi32 rc;` |
| 242183 |   37 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |   38 | `	ph7_foreach_step **apStep,*pStep;` |
|      - |   39 | `	ph7_value *pValue;` |
|      - |   40 | `	VmFrame *pFrameLocal;` |
|      - |   41 | `	sxu32 nStep;` |
| 242183 |   42 | `	pFrameLocal = pVm->pFrame;` |
| 242183 |   43 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
...
| 242183 |   50 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
| 242183 |   51 | `	nStep = SySetUsed(&pInfo->aStep);` |
| 242183 |   52 | `	if( nStep < 1 ){` |
...
|    ! 0 |   57 | `		VM_EXIT_BREAK;` |
|      - |   58 | `	}` |
| 242183 |   59 | `	pStep = apStep[nStep - 1];` |
| 242209 |   60 | `	while( nStep > 0 ){` |
| 242209 |   61 | `		if( apStep[nStep - 1]->pFrame == pFrameLocal ){` |
| 242183 |   62 | `			pStep = apStep[nStep - 1];` |
| 242183 |   63 | `			break;` |
|      - |   64 | `		}` |
|     27 |   65 | `		nStep--;` |
|      1 |   66 | `	}` |
| 242183 |   67 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
...
| 240797 |   71 | `		pNode = pStep->pCursor;` |
| 240797 |   72 | `		if( pNode == 0 ){` |
...
| 217109 |   83 | `			pStep->pCursor = pNode->pPrev; /* Reverse link */` |
| 217109 |   84 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|   6987 |   85 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|   6987 |   86 | `				if( pKey ){` |
|   6987 |   87 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|   3491 |   88 | `				}` |
|   3491 |   89 | `			}` |
| 217109 |   90 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
| 217039 |  102 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
| 217039 |  103 | `				if( pValue ){` |
| 217039 |  104 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
| 108517 |  105 | `				}` |
|      - |  106 | `			}` |
|      5 |  107 | `		}` |
| 121787 |  108 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
