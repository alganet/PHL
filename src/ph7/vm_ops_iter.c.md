...
|      - |   28 | ` * VM_EXIT_BREAK.` |
|      - |   29 | ` */` |
| 259946 |   30 | `PH7_PRIVATE VmOpRc VmExecOpForeachStep(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   31 | `{` |
| 259951 |   32 | `	ph7_value *pTos = pState->pTos;` |
| 259951 |   33 | `	ph7_value *pStack = pState->pStack;` |
| 259951 |   34 | `	VmInstr *aInstr = pState->aInstr;` |
| 259951 |   35 | `	sxi32 pc = pState->pc;` |
|      - |   36 | `	sxi32 rc;` |
| 259951 |   37 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |   38 | `	ph7_foreach_step **apStep,*pStep;` |
|      - |   39 | `	ph7_value *pValue;` |
|      - |   40 | `	VmFrame *pFrameLocal;` |
|      - |   41 | `	sxu32 nStep;` |
| 259951 |   42 | `	pFrameLocal = pVm->pFrame;` |
| 259951 |   43 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
...
| 259951 |   50 | `	apStep = (ph7_foreach_step **)SySetBasePtr(&pInfo->aStep);` |
| 259951 |   51 | `	nStep = SySetUsed(&pInfo->aStep);` |
| 259951 |   52 | `	if( nStep < 1 ){` |
...
|    ! 0 |   57 | `		VM_EXIT_BREAK;` |
|      - |   58 | `	}` |
| 259951 |   59 | `	pStep = apStep[nStep - 1];` |
| 259977 |   60 | `	while( nStep > 0 ){` |
| 259977 |   61 | `		if( apStep[nStep - 1]->pFrame == pFrameLocal ){` |
| 259951 |   62 | `			pStep = apStep[nStep - 1];` |
| 259951 |   63 | `			break;` |
|      - |   64 | `		}` |
|     27 |   65 | `		nStep--;` |
|      1 |   66 | `	}` |
| 259951 |   67 | `	if( pStep->iFlags & PH7_4EACH_STEP_HASHMAP ){` |
...
| 258577 |   71 | `		pNode = pStep->pCursor;` |
| 258577 |   72 | `		if( pNode == 0 ){` |
|      - |   73 | `			/* No more entry to process */` |
|  23561 |   74 | `			pc = pInstr->iP2 - 1; /* Jump to this destination */` |
|  23561 |   75 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
|  23561 |   80 | `			VmForeachHashmapStepRelease(&(*pVm),pInfo,pStep,TRUE);` |
|  11783 |   81 | `		}else{` |
|      - |   82 | `			/* Advance the private cursor */` |
| 235021 |   83 | `			pStep->pCursor = pNode->pPrev; /* Reverse link */` |
| 235021 |   84 | `			if( (pStep->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) > 0 ){` |
|   6867 |   85 | `				ph7_value *pKey = VmExtractMemObj(&(*pVm),&pInfo->sKey,FALSE,TRUE);` |
|   6867 |   86 | `				if( pKey ){` |
|   6867 |   87 | `					PH7_HashmapExtractNodeKey(pNode,pKey);` |
|   3431 |   88 | `				}` |
|   3431 |   89 | `			}` |
| 235021 |   90 | `			if( pStep->iFlags & PH7_4EACH_STEP_REF ){` |
...
| 234951 |  102 | `				pValue = VmExtractMemObj(&(*pVm),&pInfo->sValue,FALSE,TRUE);` |
| 234951 |  103 | `				if( pValue ){` |
| 234951 |  104 | `					PH7_HashmapExtractNodeValue(pNode,pValue,TRUE);` |
| 117473 |  105 | `				}` |
|      - |  106 | `			}` |
|      5 |  107 | `		}` |
| 130665 |  108 | `	}else if( pStep->iFlags & PH7_4EACH_STEP_ITERATOR ){` |
...
|      - |  311 | ` */` |
|  23984 |  312 | `PH7_PRIVATE VmOpRc VmExecOpForeachInit(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  313 | `{` |
|  23989 |  314 | `	ph7_value *pTos = pState->pTos;` |
|  23989 |  315 | `	ph7_value *pStack = pState->pStack;` |
|  23989 |  316 | `	VmInstr *aInstr = pState->aInstr;` |
|  23989 |  317 | `	sxi32 pc = pState->pc;` |
|      - |  318 | `	sxi32 rc;` |
|  23989 |  319 | `	ph7_foreach_info *pInfo = (ph7_foreach_info *)pInstr->p3;` |
|      - |  320 | `	void *pName;` |
|      - |  321 | `#ifdef UNTRUST` |
|      - |  322 | `	if( pTos < pStack ){` |
|      - |  323 | `		VM_EXIT_ABORT;` |
|      - |  324 | `	}` |
|      - |  325 | `#endif` |
|  23989 |  326 | `	if( SyStringLength(&pInfo->sValue) < 1 ){` |
...
|    ! 0 |  338 | `	}` |
|  23989 |  339 | `	if( (pInfo->iFlags & PH7_4EACH_STEP_KEY) && SyStringLength(&pInfo->sKey) < 1 ){` |
...
|  23989 |  352 | `	if( (pTos->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 \|\| SyStringLength(&pInfo->sValue) < 1 ){` |
...
|  23985 |  363 | `		pStep = (ph7_foreach_step *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_foreach_step));` |
|  23985 |  364 | `		if( pStep == 0 ){` |
...
|  23985 |  370 | `			SyZero(pStep,sizeof(ph7_foreach_step));` |
|      - |  371 | `			/* Prepare the step */` |
|  23985 |  372 | `			pStep->iFlags = pInfo->iFlags;` |
...
|  23985 |  377 | `			pStep->pFrame = VmSkipExceptionFrames(pVm->pFrame);` |
|  23985 |  378 | `			if( pTos->iFlags & MEMOBJ_HASHMAP ){` |
...
|  23737 |  382 | `				if( (pStep->iFlags & PH7_4EACH_STEP_REF) && pTos->nIdx != SXU32_HIGH ){` |
...
|     13 |  397 | `					}` |
|     13 |  398 | `				}` |
|  23737 |  399 | `				pMap = (ph7_hashmap *)pTos->x.pOther;` |
|  23737 |  400 | `				pIterMap = pMap;` |
|  23737 |  401 | `				if( pMap == pVm->pGlobal && (pStep->iFlags & PH7_4EACH_STEP_REF) == 0 ){` |
...
|    ! 0 |  413 | `					}` |
|      2 |  414 | `				}` |
|  23737 |  415 | `				pStep->iFlags \|= PH7_4EACH_STEP_HASHMAP;` |
|  23737 |  416 | `				pStep->xIter.pMap = pIterMap;` |
|  23737 |  417 | `				if( pIterMap == pMap ){` |
|  23733 |  418 | `					pMap->iRef++;` |
|  11864 |  419 | `				}` |
...
|  23737 |  423 | `				PH7_HashmapRegisterForeachStep(pIterMap,pStep);` |
|  11871 |  424 | `			}else{` |
...
|      - |  517 | `		}` |
|  23979 |  518 | `		if( pStep ){` |
|  23979 |  519 | `			if( SXRET_OK != SySetPut(&pInfo->aStep,(const void *)&pStep) ){` |
...
|  11987 |  529 | `		}` |
|      - |  530 | `	}` |
|  23983 |  531 | `	VmPopOperand(&pTos,1);` |
|  23983 |  532 | `	VM_EXIT_BREAK;` |
|    ! 0 |  533 | `	VM_EXIT_BREAK;` |
|  11997 |  534 | `}` |
|      - |  535 |  |
