...
|     - |  396 | ` */` |
|  3320 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     5 |  398 | `{` |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 26565 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 23245 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 11625 |  411 | `	}` |
|  3325 |  412 | `}` |
|     - |  413 |  |
