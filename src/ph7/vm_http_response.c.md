...
|     - |  396 | ` */` |
|  2476 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     2 |  398 |  |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 19810 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 17334 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
|  8668 |  411 | `	}` |
|  2478 |  412 |  |
|     - |  413 |  |
