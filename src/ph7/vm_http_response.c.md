...
|     - |  396 | ` */` |
|  2604 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     2 |  398 |  |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 20834 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 18230 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
|  9116 |  411 | `	}` |
|  2606 |  412 |  |
|     - |  413 |  |
