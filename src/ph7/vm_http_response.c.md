...
|     - |  396 | ` */` |
|  3408 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     5 |  398 | `{` |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 27269 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 23861 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 11933 |  411 | `	}` |
|  3413 |  412 | `}` |
|     - |  413 |  |
