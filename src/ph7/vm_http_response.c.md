...
|     - |  396 | ` */` |
|  2516 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     2 |  398 |  |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 20130 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 17614 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
|  8808 |  411 | `	}` |
|  2518 |  412 |  |
|     - |  413 |  |
