...
|     - |  396 | ` */` |
|  3378 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     5 |  398 | `{` |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 27029 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 23651 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 11828 |  411 | `	}` |
|  3383 |  412 | `}` |
|     - |  413 |  |
