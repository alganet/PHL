...
|     - |  396 | ` */` |
|  2884 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     5 |  398 |  |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 23077 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 20193 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 10099 |  411 | `	}` |
|  2889 |  412 |  |
|     - |  413 |  |
