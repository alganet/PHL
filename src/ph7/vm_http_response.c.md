...
|     - |  396 | ` */` |
|  2474 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     2 |  398 |  |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 19794 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 17320 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
|  8661 |  411 | `	}` |
|  2476 |  412 |  |
|     - |  413 |  |
