...
|     - |  396 | ` */` |
|  3414 |  397 | `PH7_PRIVATE void PH7_RegisterHttpResponseFunctions(ph7_vm *pVm)` |
|     5 |  398 | `{` |
...
|     - |  407 | `	};` |
|     - |  408 | `	sxu32 n;` |
| 27317 |  409 | `	for( n = 0; n < SX_ARRAYSIZE(aFunc); n++ ){` |
| 23903 |  410 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 11954 |  411 | `	}` |
|  3419 |  412 | `}` |
|     - |  413 |  |
