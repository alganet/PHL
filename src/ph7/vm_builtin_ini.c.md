...
|    - |  184 | `;` |
|    - |  185 |  |
| 3872 |  186 | `PH7_PRIVATE sxi32 PH7_VmInstallIni(ph7_vm *pVm)` |
|    5 |  187 | `{` |
| 3877 |  188 | `	ph7_create_function(&(*pVm),"__ini_cli",vm_builtin_ini_cli,0);` |
| 3877 |  189 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zIniLib,sizeof(zIniLib)-1);` |
|    5 |  190 | `}` |
|    - |  191 |  |
