...
|    8 |   22 | `	SXUNUSED(nArg);` |
|    8 |   23 | `	SXUNUSED(apArg);` |
|   19 |   24 | `	pArr = ph7_context_new_array(pCtx);` |
|   19 |   25 | `	pV = ph7_context_new_scalar(pCtx);` |
|   19 |   26 | `	if( pArr == 0 \|\| pV == 0 ){` |
|  ! 0 |   27 | `		return PH7_ContextMemoryError(pCtx);` |
|    - |   28 | `	}` |
|   19 |   29 | `	aEntry = (VmIniEntry *)SySetBasePtr(&pCtx->pVm->aIniCli);` |
|   35 |   30 | `	for( n = 0 ; n < SySetUsed(&pCtx->pVm->aIniCli) ; n++ ){` |
...
|    9 |   34 | `	}` |
|   19 |   35 | `	ph7_result_value(pCtx,pArr);` |
|   19 |   36 | `	return PH7_OK;` |
|   11 |   37 | `}` |
|    - |   38 |  |
...
|    - |  184 | `;` |
|    - |  185 |  |
| 3886 |  186 | `PH7_PRIVATE sxi32 PH7_VmInstallIni(ph7_vm *pVm)` |
|    5 |  187 | `{` |
| 3891 |  188 | `	ph7_create_function(&(*pVm),"__ini_cli",vm_builtin_ini_cli,0);` |
| 3891 |  189 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zIniLib,sizeof(zIniLib)-1);` |
|    5 |  190 | `}` |
|    - |  191 |  |
