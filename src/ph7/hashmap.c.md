...
|         - |   22 | ` */` |
|   7524354 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7524359 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7524359 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    636422 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    636427 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    636427 |   35 | `	sxu32 nH = 5381;` |
|    636427 |   36 | `	zEnd = &zIn[nLen];` |
|    718962 |   37 | `	for(;;){` |
|   1437929 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1230819 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1102137 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    959477 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    636427 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3219358 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3219363 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3219363 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3219363 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3219363 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3219363 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3219363 |  112 | `	pNode->nHash = nHash;` |
|   3219363 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3219363 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3219363 |  115 | `	return pNode;` |
|   1609684 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    263714 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    263719 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    263719 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    263719 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    263719 |  133 | `	pNode->pMap  = &(*pMap);` |
|    263719 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    263719 |  135 | `	pNode->nHash = nHash;` |
|    263719 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    263719 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    263719 |  138 | `	pNode->nValIdx = nValIdx;` |
|    263719 |  139 | `	return pNode;` |
|    131862 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3483072 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3483077 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3002971 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3002971 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1501483 |  150 | `	}` |
|   3483077 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3483077 |  153 | `	if( pMap->pFirst == 0 ){` |
|     91101 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     91101 |  156 | `		pMap->pCur = pNode;` |
|     45553 |  157 | `	}else{` |
|   3391981 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3483077 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3483072 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3483077 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     96491 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     96491 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     96491 |  245 | `		if( nNew < 1 ){` |
|     91101 |  246 | `			nNew = 16;` |
...
|     96491 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     96491 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     96491 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     96491 |  260 | `		pMap->apBucket = apNew;` |
|     96491 |  261 | `		pMap->nSize = nNew;` |
|     96491 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     91101 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|   3630275 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3630275 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1815135 |  280 | `			}` |
...
|      2695 |  288 | `	}` |
|   3391981 |  289 | `	return SXRET_OK;` |
|   1741541 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3219358 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3219363 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3219321 |  310 | `		if( pValue ){` |
|   3219315 |  311 | `			sSafeVal = *pValue;` |
|   3219315 |  312 | `			pValue = &sSafeVal;` |
|   1609655 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3219321 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3219321 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3219321 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3219315 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1609655 |  322 | `		}` |
|   3219321 |  323 | `		nIdx = pObj->nIdx;` |
|   1609663 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3219363 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3219363 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3219363 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3219363 |  334 | `	if( isForeign ){` |
...
|   3219363 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3219363 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3219363 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3219363 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3219363 |  349 | `	return SXRET_OK;` |
|   1609684 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    263714 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    263719 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    217719 |  370 | `		if( pValue ){` |
|    217409 |  371 | `			sSafeVal = *pValue;` |
|    217409 |  372 | `			pValue = &sSafeVal;` |
|    108702 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    217719 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    217719 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    217719 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    217409 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    108702 |  382 | `		}` |
|    217719 |  383 | `		nIdx = pObj->nIdx;` |
|    108862 |  384 | `	}else{` |
|     46005 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    263719 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    263719 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    263719 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    263719 |  394 | `	if( isForeign ){` |
...
|    263719 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    263719 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    263719 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    263719 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    263719 |  409 | `	return SXRET_OK;` |
|    131862 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4291568 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4291573 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       775 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4290803 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4290803 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110567383 |  433 | `	for(;;){` |
| 221134771 |  434 | `		if( pNode == 0 ){` |
|   4284435 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216850336 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216847324 |  438 | `			&& pNode->nHash == nHash` |
| 108425345 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      6373 |  441 | `				if( ppNode ){` |
|      6351 |  442 | `					*ppNode = pNode;` |
|      3173 |  443 | `				}` |
|      6373 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
...
|         - |  456 | ` */` |
|    407428 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    407433 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     34725 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    372713 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    372713 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    306546 |  475 | `	for(;;){` |
|    613097 |  476 | `		if( pNode == 0 ){` |
|    307823 |  477 | `			break;` |
|         - |  478 | `		}` |
|    305274 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    303763 |  480 | `			&& pNode->nHash == nHash` |
|    183621 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     64995 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     64895 |  484 | `				if( ppNode ){` |
|     64867 |  485 | `					*ppNode = pNode;` |
|     32431 |  486 | `				}` |
|     64895 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    240389 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    307823 |  493 | `	return SXERR_NOTFOUND;` |
|    203719 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    407560 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    407565 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    407565 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    407565 |  504 | `	int isNeg = FALSE, nDigit;` |
|    407565 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    407543 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    407539 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    407539 |  516 | `	zDigit = zIn;` |
|    204201 |  517 | `	for(;;){` |
|    408407 |  518 | `		if( zIn >= zEnd ){` |
|       251 |  519 | `			break;` |
|         - |  520 | `		}` |
|    408157 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    407289 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       869 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    150086 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    150091 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    150091 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    143837 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    143837 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    143823 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    143823 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         7 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      6273 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        27 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        13 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      6273 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     75043 |  575 | `result:` |
|    150091 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     70381 |  578 | `		if( ppNode ){` |
|     70329 |  579 | `			*ppNode = pNode;` |
|     35162 |  580 | `		}` |
|     70381 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79715 |  584 | `	return SXERR_NOTFOUND;` |
|     75048 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1076360 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1076365 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1076359 |  623 | `	return FALSE;` |
|    538185 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3436604 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3436609 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3436609 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3436609 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    217721 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    217721 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    326237 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    108744 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    217007 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    216877 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    216877 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1609444 |  683 | `IntKey:` |
|   3219121 |  684 | `	if( pKey ){` |
...
|   1071297 |  714 | `		}` |
|   1071302 |  715 | `	}else{` |
|   1076331 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1076329 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1076323 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1076323 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1076321 |  726 | `			++pMap->iNextIdx;` |
|    538158 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3218917 |  730 | `	return rc;` |
|   1718307 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1510905 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1510910 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1510910 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     72655 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     72660 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     72660 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     72660 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     72660 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     72660 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     72660 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     72660 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     72660 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     72660 |  921 | `	return rc;` |
|     36309 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14198 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14203 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14203 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11434 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5723 |  934 | `	}else{` |
|      2774 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14203 |  937 | `	if( pEntry->pNextCollide ){` |
|       998 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       522 |  939 | `	}` |
|     14203 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14203 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14203 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14203 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14203 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14203 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11766 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5894 |  949 | `	}` |
|     14203 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14203 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14203 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14203 |  956 | `		pMap->iNextIdx++;` |
|      7099 |  957 | `	}` |
|     14203 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33266 |  966 | `static int HashmapFindValue(` |
...
|     33271 |  979 | `	pEntry = pMap->pFirst;` |
|     33271 |  980 | `	n = pMap->nEntry;` |
|     33271 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33271 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     79409 |  983 | `	for(;;){` |
|    158822 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    158744 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    158744 |  989 | `		if( pVal ){` |
...
|    158744 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    158744 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    158744 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    158744 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    158744 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    158744 | 1001 | `			if( rc == 0 ){` |
|     33193 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33193 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     62776 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    125556 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    125556 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    714602 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    714602 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    714604 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    714599 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    714599 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      1998 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    710613 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    710367 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    355431 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    713311 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    710427 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    710427 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    710427 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    355216 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    710427 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    710427 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    355216 | 1305 | `	}` |
...
|         - | 1462 | ` */` |
|    238360 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    238365 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    238365 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    238365 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    235599 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|         - | 1648 | ` */` |
|    145460 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    145465 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    145465 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    145465 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    145465 | 1664 | `	pMap->pVm = &(*pVm);` |
|    145465 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    145465 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    145465 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    145465 | 1669 | `	return pMap;` |
|     72735 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|    103382 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|    103387 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|    103387 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|    103387 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|    103387 | 1785 | `	n = 0;` |
|    103387 | 1786 | `	pEntry = pMap->pFirst;` |
|   1750417 | 1787 | `	for(;;){` |
|   3500839 | 1788 | `		if( n >= pMap->nEntry ){` |
|    103387 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3397457 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3397457 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3397457 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3397397 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1698696 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3397457 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    189549 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     94772 | 1801 | `		}` |
|   3397457 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3397457 | 1804 | `		pEntry = pNext;` |
|   3397457 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|    103387 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     76047 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     38021 | 1810 | `	}` |
|    103387 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|    103361 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     51683 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    850936 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    850941 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    850941 | 1833 | `	pMap->iRef--;` |
|    850941 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|    103341 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     51668 | 1836 | `	}` |
|    850941 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    150274 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   2725908 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2725913 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2725913 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     19306 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     19311 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     19311 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     19311 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     19311 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     19138 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     19143 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     19143 | 1955 | `	while( *ppLink ){` |
|     19143 | 1956 | `		if( *ppLink == pStep ){` |
|     19143 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     19143 | 1958 | `			pStep->pNextActive = 0;` |
|     19143 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    602982 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    602987 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    602987 | 1987 | `	if( pEntry ){` |
|    602987 | 1988 | `		if( bStore ){` |
|    239921 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    119963 | 1990 | `		}else{` |
|    363071 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    301449 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    160650 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    160655 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    155051 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    155051 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    155051 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     77528 | 2009 | `	}else{` |
...
|         - | 2063 | `**   changed.` |
|         - | 2064 | `*/` |
|     36992 | 2065 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2066 | `{` |
|         - | 2067 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2068 | `    /* Prevent compiler warning */` |
|     36997 | 2069 | `	result.pNext = result.pPrev = 0;` |
|     36997 | 2070 | `	pTail = &result;` |
|    109900 | 2071 | `	while( pA && pB ){` |
|     72908 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48089 | 2073 | `			pTail->pPrev = pA;` |
|     48089 | 2074 | `			pA->pNext = pTail;` |
|     48089 | 2075 | `			pTail = pA;` |
|     48089 | 2076 | `			pA = pA->pPrev;` |
|     24027 | 2077 | `		}else{` |
|     24824 | 2078 | `			pTail->pPrev = pB;` |
|     24824 | 2079 | `			pB->pNext = pTail;` |
|     24824 | 2080 | `			pTail = pB;` |
|     24824 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     36997 | 2084 | `	if( pA ){` |
|     26269 | 2085 | `		pTail->pPrev = pA;` |
|     26269 | 2086 | `		pA->pNext = pTail;` |
|     23881 | 2087 | `	}else if( pB ){` |
|     10497 | 2088 | `		pTail->pPrev = pB;` |
|     10497 | 2089 | `		pB->pNext = pTail;` |
|      5235 | 2090 | `	}else{` |
|       241 | 2091 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2092 | `	}` |
|     36997 | 2093 | `	return result.pPrev;` |
|         5 | 2094 | `}` |
|         - | 2095 | `/*` |
|         - | 2096 | `** Inputs:` |
...
|     15025 | 2114 | `	while( pIn ){` |
|     14247 | 2115 | `		p = pIn;` |
|     14247 | 2116 | `		pIn = p->pPrev;` |
|     14247 | 2117 | `		p->pPrev = 0;` |
|     27121 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27121 | 2119 | `			if( a[i]==0 ){` |
|     14247 | 2120 | `				a[i] = p;` |
|     14247 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
|     12879 | 2123 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12879 | 2124 | `				a[i] = 0;` |
|         - | 2125 | `			}` |
|      6442 | 2126 | `		}` |
|     14247 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     72589 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     72594 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     72506 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     13979 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     13979 | 2532 | `		i++;` |
|     13979 | 2533 | `		pLast = p;` |
|     13979 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       703 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         - | 4937 | ` */` |
|     33138 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33143 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33143 | 4948 | `	pNeedle = apArg[0];` |
|     33143 | 4949 | `	bStrict = 0;` |
|     33143 | 4950 | `	if( nArg > 2 ){` |
|        53 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4952 | `	}` |
|     33143 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33143 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33143 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33143 | 4964 | `	return PH7_OK;` |
|     16574 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         - | 8934 | ` */` |
|     34302 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34307 | 8946 | `	rc = SXRET_OK;` |
|     34307 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34307 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34307 | 8949 | `	n = pMap->nEntry;` |
|     34307 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    153777 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    153777 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    153777 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    153777 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    153777 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    153777 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    153777 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    153777 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34307 | 8973 | `	return SXRET_OK;` |
|     17156 | 8974 | `}` |
|         - | 8975 |  |
