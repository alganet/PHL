...
|         - |   22 | ` */` |
|   7954378 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7954383 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7954383 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    512362 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    512367 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    512367 |   35 | `	sxu32 nH = 5381;` |
|    512367 |   36 | `	zEnd = &zIn[nLen];` |
|    588049 |   37 | `	for(;;){` |
|   1176103 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1005767 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    906265 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    782865 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    512367 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3646204 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3646209 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3646209 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3646209 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3646209 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3646209 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3646209 |  112 | `	pNode->nHash = nHash;` |
|   3646209 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3646209 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3646209 |  115 | `	return pNode;` |
|   1823107 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    196092 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    196097 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    196097 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    196097 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    196097 |  133 | `	pNode->pMap  = &(*pMap);` |
|    196097 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    196097 |  135 | `	pNode->nHash = nHash;` |
|    196097 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    196097 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    196097 |  138 | `	pNode->nValIdx = nValIdx;` |
|    196097 |  139 | `	return pNode;` |
|     98051 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3842296 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3842301 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3387941 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3387941 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1693968 |  150 | `	}` |
|   3842301 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3842301 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87691 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87691 |  156 | `		pMap->pCur = pNode;` |
|     43848 |  157 | `	}else{` |
|   3754615 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3842301 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3842296 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3842301 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93165 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93165 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93165 |  245 | `		if( nNew < 1 ){` |
|     87691 |  246 | `			nNew = 16;` |
...
|     93165 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93165 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93165 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93165 |  260 | `		pMap->apBucket = apNew;` |
|     93165 |  261 | `		pMap->nSize = nNew;` |
|     93165 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87691 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2737 |  288 | `	}` |
|   3754615 |  289 | `	return SXRET_OK;` |
|   1921153 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3646204 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3646209 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3646167 |  310 | `		if( pValue ){` |
|   3646161 |  311 | `			sSafeVal = *pValue;` |
|   3646161 |  312 | `			pValue = &sSafeVal;` |
|   1823078 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3646167 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3646167 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3646167 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3646161 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1823078 |  322 | `		}` |
|   3646167 |  323 | `		nIdx = pObj->nIdx;` |
|   1823086 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3646209 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3646209 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3646209 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3646209 |  334 | `	if( isForeign ){` |
...
|   3646209 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3646209 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3646209 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3646209 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3646209 |  349 | `	return SXRET_OK;` |
|   1823107 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    196092 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    196097 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    149501 |  370 | `		if( pValue ){` |
|    149191 |  371 | `			sSafeVal = *pValue;` |
|    149191 |  372 | `			pValue = &sSafeVal;` |
|     74593 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    149501 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    149501 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    149501 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    149191 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     74593 |  382 | `		}` |
|    149501 |  383 | `		nIdx = pObj->nIdx;` |
|     74753 |  384 | `	}else{` |
|     46601 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    196097 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    196097 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    196097 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    196097 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46601 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23298 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    196097 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    196097 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    196097 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    196097 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    196097 |  409 | `	return SXRET_OK;` |
|     98051 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    343840 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    343845 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     27575 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    316275 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    316275 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256733 |  475 | `	for(;;){` |
|    513471 |  476 | `		if( pNode == 0 ){` |
|    248805 |  477 | `			break;` |
|         - |  478 | `		}` |
|    264666 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    263151 |  480 | `			&& pNode->nHash == nHash` |
|    164604 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     67577 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67475 |  484 | `				if( ppNode ){` |
|     67447 |  485 | `					*ppNode = pNode;` |
|     33721 |  486 | `				}` |
|     67475 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    197201 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    248805 |  493 | `	return SXERR_NOTFOUND;` |
|    171925 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    344036 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    344041 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    344041 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    344041 |  504 | `	int isNeg = FALSE, nDigit;` |
|    344041 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    344019 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    344015 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    344015 |  516 | `	zDigit = zIn;` |
|    172472 |  517 | `	for(;;){` |
|    344949 |  518 | `		if( zIn >= zEnd ){` |
|       315 |  519 | `			break;` |
|         - |  520 | `		}` |
|    344635 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    343701 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       935 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    154428 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    154433 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    154433 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    147953 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    147953 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    147877 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    147877 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        38 |  567 | `	}` |
...
|     77214 |  575 | `result:` |
|    154433 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     73245 |  578 | `		if( ppNode ){` |
|     73193 |  579 | `			*ppNode = pNode;` |
|     36594 |  580 | `		}` |
|     73245 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     81193 |  584 | `	return SXERR_NOTFOUND;` |
|     77219 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1499664 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1499669 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1499663 |  623 | `	return FALSE;` |
|    749837 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3791800 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3791805 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3791805 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3791805 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    149485 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    149485 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       231 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    223880 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     74625 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    148769 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    148635 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    148635 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1821160 |  683 | `IntKey:` |
|   3642555 |  684 | `	if( pKey ){` |
...
|   1071361 |  714 | `		}` |
|   1071366 |  715 | `	}else{` |
|   1499635 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1499633 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1499627 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1499627 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1499625 |  726 | `			++pMap->iNextIdx;` |
|    749810 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3642349 |  730 | `	return rc;` |
|   1895905 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46648 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46653 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46653 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46653 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46613 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46613 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69914 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23303 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46601 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46601 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1547930 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1547935 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1547935 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     78865 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     78870 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     78870 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     78870 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     78870 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     78870 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     78870 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     78870 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     78870 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     78870 |  921 | `	return rc;` |
|     39329 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16960 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16965 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16965 |  932 | `	if( pEntry->pPrevCollide ){` |
|     12019 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5910 |  934 | `	}else{` |
|      4951 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16965 |  937 | `	if( pEntry->pNextCollide ){` |
|      1034 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       526 |  939 | `	}` |
|     16965 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16965 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16965 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16965 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16965 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16965 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12342 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      6071 |  949 | `	}` |
|     16965 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16965 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16965 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16965 |  956 | `		pMap->iNextIdx++;` |
|      8480 |  957 | `	}` |
|     16965 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33750 |  966 | `static int HashmapFindValue(` |
...
|     33755 |  979 | `	pEntry = pMap->pFirst;` |
|     33755 |  980 | `	n = pMap->nEntry;` |
|     33755 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33755 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80524 |  983 | `	for(;;){` |
|    161055 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    160977 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    160977 |  989 | `		if( pVal ){` |
...
|    160977 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    160977 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    160977 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    160977 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    160977 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    160977 | 1001 | `			if( rc == 0 ){` |
|     33677 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33677 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63649 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    127305 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    127305 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    724272 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    724272 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    724274 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    724269 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    724269 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1277 | `		/* Blob key insertion */` |
|      4025 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4025 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4025 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4025 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2015 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    720249 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    716589 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    361957 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    719547 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    716649 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    716649 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    716649 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    358327 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    716649 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    716649 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    358327 | 1341 | `	}` |
...
|         - | 1392 | ` */` |
|      7300 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7305 | 1399 | `	if( pSrc == pDest ){` |
...
|      7305 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14889 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7589 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7589 | 1411 | `		if( pVal ){` |
|      7589 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3797 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7589 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7589 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3797 | 1421 | `	}` |
|      7305 | 1422 | `	return SXRET_OK;` |
|      3655 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    246652 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    246657 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    246657 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    246657 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    243863 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1630 | ` */` |
|      3798 | 1631 | `PH7_PRIVATE sxi32 PH7_HashmapUnion(ph7_hashmap *pLeft,ph7_hashmap *pRight)` |
|         5 | 1632 | `{` |
|         - | 1633 | `	ph7_hashmap_node *pEntry;` |
|      3803 | 1634 | `	sxi32 rc = SXRET_OK;` |
|         - | 1635 | `	ph7_value *pObj;` |
|         - | 1636 | `	sxu32 n;` |
|      3803 | 1637 | `	if( pLeft == pRight ){` |
...
|      3803 | 1644 | `	pEntry = pRight->pFirst;` |
|      3843 | 1645 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
...
|    142535 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142535 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    142535 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    142535 | 1700 | `	pMap->pVm = &(*pVm);` |
|    142535 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    142535 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142535 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142535 | 1705 | `	return pMap;` |
|     71270 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     94988 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94993 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94993 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94993 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94993 | 1821 | `	n = 0;` |
|     94993 | 1822 | `	pEntry = pMap->pFirst;` |
|   1914602 | 1823 | `	for(;;){` |
|   3829209 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94993 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3734221 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3734221 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3734221 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3734161 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1867078 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3734221 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    107257 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     53626 | 1837 | `		}` |
|   3734221 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3734221 | 1840 | `		pEntry = pNext;` |
|   3734221 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94993 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68393 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34194 | 1846 | `	}` |
|     94993 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94967 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47486 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    880070 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    880075 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    880075 | 1869 | `	pMap->iRef--;` |
|    880075 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94947 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47471 | 1872 | `	}` |
|    880075 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    154622 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3074882 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3074887 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3074887 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46638 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46643 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46643 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46643 | 1966 | `	return rc;` |
|     23324 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23360 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23365 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23365 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23365 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23365 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23192 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23197 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23197 | 1991 | `	while( *ppLink ){` |
|     23197 | 1992 | `		if( *ppLink == pStep ){` |
|     23197 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23197 | 1994 | `			pStep->pNextActive = 0;` |
|     23197 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    623896 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    623901 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    623901 | 2023 | `	if( pEntry ){` |
|    623901 | 2024 | `		if( bStore ){` |
|    240229 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    120117 | 2026 | `		}else{` |
|    383677 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    311736 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    166162 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    166167 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    160463 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    160463 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    160463 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     80234 | 2045 | `	}else{` |
|      5709 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      5709 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5709 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    166167 | 2050 | `}` |
...
|    131096 | 2107 | `	while( pA && pB ){` |
|     79108 | 2108 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     51764 | 2109 | `			pTail->pPrev = pA;` |
|     51764 | 2110 | `			pA->pNext = pTail;` |
|     51764 | 2111 | `			pTail = pA;` |
|     51764 | 2112 | `			pA = pA->pPrev;` |
|     25992 | 2113 | `		}else{` |
|     27349 | 2114 | `			pTail->pPrev = pB;` |
|     27349 | 2115 | `			pB->pNext = pTail;` |
|     27349 | 2116 | `			pTail = pB;` |
|     27349 | 2117 | `			pB = pB->pPrev;` |
|         - | 2118 | `		}` |
|         5 | 2119 | `	}` |
|     51993 | 2120 | `	if( pA ){` |
|     39364 | 2121 | `		pTail->pPrev = pA;` |
|     39364 | 2122 | `		pA->pNext = pTail;` |
|     32232 | 2123 | `	}else if( pB ){` |
|     12330 | 2124 | `		pTail->pPrev = pB;` |
|     12330 | 2125 | `		pB->pNext = pTail;` |
|      6249 | 2126 | `	}else{` |
...
|     18221 | 2150 | `	while( pIn ){` |
|     17017 | 2151 | `		p = pIn;` |
|     17017 | 2152 | `		pIn = p->pPrev;` |
|     17017 | 2153 | `		p->pPrev = 0;` |
|     31681 | 2154 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     31681 | 2155 | `			if( a[i]==0 ){` |
|     17017 | 2156 | `				a[i] = p;` |
|     17017 | 2157 | `				break;` |
|       ! 0 | 2158 | `			}else{` |
...
|         - | 2161 | `			}` |
|      7337 | 2162 | `		}` |
|     17017 | 2163 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2275 | `	return rc;` |
|        64 | 2276 | `}` |
|     78781 | 2277 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2278 | `{` |
|     78786 | 2279 | `	if( pCmpData == 0 ){` |
|         - | 2280 | `		/* SORT_REGULAR fast path */` |
|     78698 | 2281 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2282 | `	}` |
...
|         - | 2529 | ` */` |
|        20 | 2530 | `static sxi32 HashmapCmpCallback7(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         1 | 2531 | `{` |
|         - | 2532 | `	sxu32 n;` |
|         8 | 2533 | `	SXUNUSED(pB); /* cc warning */` |
|         8 | 2534 | `	SXUNUSED(pCmpData);` |
|         - | 2535 | `	/* Grab a random number */` |
|        21 | 2536 | `	n = PH7_VmRandomNum(pA->pMap->pVm);` |
...
|         2 | 2565 | `		}` |
|     16741 | 2566 | `		HashmapRehashIntNode(p);` |
|         - | 2567 | `		/* Point to the next entry */` |
|     16741 | 2568 | `		i++;` |
|     16741 | 2569 | `		pLast = p;` |
|     16741 | 2570 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2571 | `	}` |
|      1127 | 2572 | `}` |
|         - | 2573 | `/*` |
...
|         - | 4973 | ` */` |
|     33622 | 4974 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4975 | `{` |
|         - | 4976 | `	ph7_value *pNeedle;` |
|         - | 4977 | `	int bStrict;` |
|         - | 4978 | `	int rc;` |
|     33627 | 4979 | `	if( nArg < 2 ){` |
|         - | 4980 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4981 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4982 | `		return PH7_OK;` |
|         - | 4983 | `	}` |
|     33627 | 4984 | `	pNeedle = apArg[0];` |
|     33627 | 4985 | `	bStrict = 0;` |
|     33627 | 4986 | `	if( nArg > 2 ){` |
|        58 | 4987 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        28 | 4988 | `	}` |
|     33627 | 4989 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33627 | 4997 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4998 | `	/* Lookup result */` |
|     33627 | 4999 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33627 | 5000 | `	return PH7_OK;` |
|     16816 | 5001 | `}` |
|         - | 5002 | `/*` |
...
|         - | 8835 | ` */` |
|      3402 | 8836 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 8837 | `{` |
|         - | 8838 | `	sxu32 n;` |
|    255155 | 8839 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    251753 | 8840 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    125879 | 8841 | `	}` |
|      3407 | 8842 | `}` |
|         - | 8843 | `/*` |
...
|         - | 8970 | ` */` |
|     34842 | 8971 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34847 | 8982 | `	rc = SXRET_OK;` |
|     34847 | 8983 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34847 | 8984 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34847 | 8985 | `	n = pMap->nEntry;` |
|     34847 | 8986 | `	pEntry = pMap->pFirst;` |
...
|    159127 | 8993 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    159127 | 8994 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8995 | `		/* Invoke the user callback */` |
|    159127 | 8996 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8997 | `		/* Release the copy of the key and the value */` |
|    159127 | 8998 | `		PH7_MemObjRelease(&sKey);` |
|    159127 | 8999 | `		PH7_MemObjRelease(&sValue);` |
|    159127 | 9000 | `		if( rc != PH7_OK ){` |
|         - | 9001 | `			/* Callback request an operation abort */` |
|         3 | 9002 | `			return SXERR_ABORT;` |
|         - | 9003 | `		}` |
|         - | 9004 | `		/* Point to the next entry */` |
|    159125 | 9005 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    159125 | 9006 | `		n--;` |
|         5 | 9007 | `	}` |
|         - | 9008 | `	/* All done */` |
|     34845 | 9009 | `	return SXRET_OK;` |
|     17426 | 9010 | `}` |
|         - | 9011 |  |
