...
|         - |   22 | ` */` |
|   7435256 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7435261 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7435261 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    606818 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    606823 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    606823 |   35 | `	sxu32 nH = 5381;` |
|    606823 |   36 | `	zEnd = &zIn[nLen];` |
|    691030 |   37 | `	for(;;){` |
|   1382065 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1170951 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1046593 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    906309 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    606823 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3137756 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3137761 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3137761 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3137761 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3137761 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3137761 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3137761 |  112 | `	pNode->nHash = nHash;` |
|   3137761 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3137761 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3137761 |  115 | `	return pNode;` |
|   1568883 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    254006 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    254011 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    254011 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    254011 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    254011 |  133 | `	pNode->pMap  = &(*pMap);` |
|    254011 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    254011 |  135 | `	pNode->nHash = nHash;` |
|    254011 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    254011 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    254011 |  138 | `	pNode->nValIdx = nValIdx;` |
|    254011 |  139 | `	return pNode;` |
|    127008 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3391762 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3391767 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2922567 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2922567 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1461281 |  150 | `	}` |
|   3391767 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3391767 |  153 | `	if( pMap->pFirst == 0 ){` |
|     90239 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     90239 |  156 | `		pMap->pCur = pNode;` |
|     45122 |  157 | `	}else{` |
|   3301533 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3391767 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3391762 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3391767 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     95193 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     95193 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     95193 |  245 | `		if( nNew < 1 ){` |
|     90239 |  246 | `			nNew = 16;` |
...
|     95193 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     95193 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     95193 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     95193 |  260 | `		pMap->apBucket = apNew;` |
|     95193 |  261 | `		pMap->nSize = nNew;` |
|     95193 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     90239 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2477 |  288 | `	}` |
|   3301533 |  289 | `	return SXRET_OK;` |
|   1695886 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3137756 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3137761 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3137723 |  310 | `		if( pValue ){` |
|   3137719 |  311 | `			sSafeVal = *pValue;` |
|   3137719 |  312 | `			pValue = &sSafeVal;` |
|   1568857 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3137723 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3137723 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3137723 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3137719 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1568857 |  322 | `		}` |
|   3137723 |  323 | `		nIdx = pObj->nIdx;` |
|   1568864 |  324 | `	}else{` |
|        39 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3137761 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3137761 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3137761 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3137761 |  334 | `	if( isForeign ){` |
...
|   3137761 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3137761 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3137761 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3137761 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3137761 |  349 | `	return SXRET_OK;` |
|   1568883 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    254006 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    254011 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    206945 |  370 | `		if( pValue ){` |
|    206655 |  371 | `			sSafeVal = *pValue;` |
|    206655 |  372 | `			pValue = &sSafeVal;` |
|    103325 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    206945 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    206945 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    206945 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    206655 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    103325 |  382 | `		}` |
|    206945 |  383 | `		nIdx = pObj->nIdx;` |
|    103475 |  384 | `	}else{` |
|     47071 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    254011 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    254011 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    254011 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    254011 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     47071 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23533 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    254011 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    254011 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    254011 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    254011 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    254011 |  409 | `	return SXRET_OK;` |
|    127008 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4284420 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4284425 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       593 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4283837 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4283837 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110562447 |  433 | `	for(;;){` |
| 221124899 |  434 | `		if( pNode == 0 ){` |
|   4281193 |  435 | `			break;` |
|         - |  436 | `		}` |
...
|         1 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4281193 |  450 | `	return SXERR_NOTFOUND;` |
|   2142215 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    387992 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    387997 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     35185 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    352817 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    352817 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    291883 |  475 | `	for(;;){` |
|    583771 |  476 | `		if( pNode == 0 ){` |
|    294649 |  477 | `			break;` |
|         - |  478 | `		}` |
|    289122 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    287612 |  480 | `			&& pNode->nHash == nHash` |
|    172183 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     58269 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     58173 |  484 | `				if( ppNode ){` |
|     58145 |  485 | `					*ppNode = pNode;` |
|     29070 |  486 | `				}` |
|     58173 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    230959 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    294649 |  493 | `	return SXERR_NOTFOUND;` |
|    194001 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    388122 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    388127 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    388127 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    388127 |  504 | `	int isNeg = FALSE, nDigit;` |
|    388127 |  505 | `	if( zIn >= zEnd ){` |
|       ! 0 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    388127 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    388123 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    388123 |  516 | `	zDigit = zIn;` |
|    194491 |  517 | `	for(;;){` |
|    388987 |  518 | `		if( zIn >= zEnd ){` |
|       249 |  519 | `			break;` |
|         - |  520 | `		}` |
|    388739 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    387875 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       865 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    136630 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    136635 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    136635 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    134215 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    134215 |  560 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|         - |  561 | `			/* Perform a blob lookup */` |
|    134195 |  562 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    134195 |  563 | `			goto result;` |
|         - |  564 | `		}` |
|        10 |  565 | `	}` |
...
|     68315 |  573 | `result:` |
|    136635 |  574 | `	if( rc == SXRET_OK ){` |
|         - |  575 | `		/* Node found */` |
|     60167 |  576 | `		if( ppNode ){` |
|     60121 |  577 | `			*ppNode = pNode;` |
|     30058 |  578 | `		}` |
|     60167 |  579 | `		return SXRET_OK;` |
|         - |  580 | `	}` |
|         - |  581 | `	/* No such entry */` |
|     76473 |  582 | `	return SXERR_NOTFOUND;` |
|     68320 |  583 | `}` |
|         - |  584 | `/*` |
...
|         - |  589 | ` */` |
|   2141004 |  590 | `static void HashmapAdvanceAutoIndex(ph7_hashmap *pMap,sxi64 iKey)` |
|         5 |  591 | `{` |
|   2141009 |  592 | `	if( iKey >= pMap->iNextIdx ){` |
|   2140745 |  593 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  594 | `		/* Make sure the automatic index is not reserved */` |
|   2140745 |  595 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  596 | `			pMap->iNextIdx++;` |
|       ! 0 |  597 | `		}` |
|   1070370 |  598 | `	}` |
|   2141009 |  599 | `}` |
...
|         - |  605 | ` */` |
|    996394 |  606 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  607 | `{` |
|    996399 |  608 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  609 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  610 | `		return TRUE;` |
|         - |  611 | `	}` |
|    996393 |  612 | `	return FALSE;` |
|    498202 |  613 | `}` |
|         - |  614 | `/*` |
...
|         - |  619 | ` */` |
|   3344066 |  620 | `static sxi32 HashmapInsert(` |
|         - |  621 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  622 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  623 | `	ph7_value *pVal    /* Node value */` |
|         - |  624 | `	)` |
|         5 |  625 | `{` |
|   3344071 |  626 | `	ph7_hashmap_node *pNode = 0;` |
|   3344071 |  627 | `	sxi32 rc = SXRET_OK;` |
|   3344071 |  628 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    210367 |  629 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  630 | `			/* Force a string cast */` |
|         3 |  631 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  632 | `		}` |
|    210367 |  633 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         - |  639 | `		}` |
|    309929 |  640 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    103308 |  641 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  654 | `		}` |
|    206253 |  655 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    206127 |  668 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    206127 |  669 | `		return rc;` |
|         - |  670 | `	}` |
|   1566852 |  671 | `IntKey:` |
|   3137455 |  672 | `	if( pKey ){` |
|   2141091 |  673 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  674 | `			/* Force an integer cast */` |
|       259 |  675 | `			PH7_MemObjToInteger(pKey);` |
|       129 |  676 | `		}` |
|   2141091 |  677 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
...
|         - |  690 | `		}` |
|   2141005 |  691 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|   2141003 |  699 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   2141003 |  700 | `		if( rc == SXRET_OK ){` |
|   2141003 |  701 | `			HashmapAdvanceAutoIndex(&(*pMap),pKey->x.iVal);` |
|   1070499 |  702 | `		}` |
|   1070504 |  703 | `	}else{` |
|    996369 |  704 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  705 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  706 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  707 | `		}` |
|    996367 |  708 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  709 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  710 | `		}` |
|         - |  711 | `		/* Assign an automatic index */` |
|    996361 |  712 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|    996361 |  713 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|    996359 |  714 | `			++pMap->iNextIdx;` |
|    498177 |  715 | `		}` |
|         - |  716 | `	}` |
|         - |  717 | `	/* Insertion result */` |
|   3137359 |  718 | `	return rc;` |
|   1672038 |  719 | `}` |
|         - |  720 | `/*` |
...
|         - |  746 | ` */` |
|     47112 |  747 | `static sxi32 HashmapInsertByRef(` |
|         - |  748 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  749 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  750 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  751 | `	)` |
|         5 |  752 | `{` |
|     47117 |  753 | `	ph7_hashmap_node *pNode = 0;` |
|     47117 |  754 | `	sxi32 rc = SXRET_OK;` |
|     47117 |  755 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     47081 |  756 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  757 | `			/* Force a string cast */` |
|       ! 0 |  758 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  759 | `		}` |
|     47081 |  760 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  765 | `			goto IntKey;` |
|         - |  766 | `		}` |
|     70616 |  767 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23537 |  768 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  769 | `				/* Overwrite */` |
...
|     47071 |  777 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     47071 |  778 | `		return rc;` |
|         - |  779 | `	}` |
|        18 |  780 | `IntKey:` |
|        39 |  781 | `	if( pKey ){` |
...
|         - |  814 | ` */` |
|   1417440 |  815 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  816 | `{` |
|         - |  817 | `	/* Point to the desired object */` |
|         - |  818 | `	ph7_value *pObj;` |
|   1417445 |  819 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1417445 |  820 | `	return pObj;` |
|         5 |  821 | `}` |
|         - |  822 | `/*` |
...
|         - |  864 | ` * documenation.` |
|         - |  865 | ` */` |
|     71108 |  866 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  867 | `{` |
|         - |  868 | `	ph7_value sObj1,sObj2;` |
|         - |  869 | `	sxi32 rc;` |
|     71113 |  870 | `	if( pLeft == pRight ){` |
|         - |  871 | `		/*` |
...
|     71113 |  878 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     71113 |  879 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     71113 |  880 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     71113 |  881 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     71113 |  882 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     71113 |  883 | `	PH7_MemObjRelease(&sObj1);` |
|     71113 |  884 | `	PH7_MemObjRelease(&sObj2);` |
|     71113 |  885 | `	return rc;` |
|     35545 |  886 | `}` |
|         - |  887 | `/*` |
...
|         - |  890 | ` */` |
|     13668 |  891 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  892 | `{` |
|     13673 |  893 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  894 | `	sxu32 nBucket;` |
|         - |  895 | `	/* Remove old collision links */` |
|     13673 |  896 | `	if( pEntry->pPrevCollide ){` |
|     11199 |  897 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5614 |  898 | `	}else{` |
|      2479 |  899 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  900 | `	}` |
|     13673 |  901 | `	if( pEntry->pNextCollide ){` |
|      1140 |  902 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       572 |  903 | `	}` |
|     13673 |  904 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  905 | `	/* Compute the new hash */` |
|     13673 |  906 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     13673 |  907 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     13673 |  908 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  909 | `	/* Link to the new bucket */` |
|     13673 |  910 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13673 |  911 | `	if( pMap->apBucket[nBucket] ){` |
|     11535 |  912 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5774 |  913 | `	}` |
|     13673 |  914 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13673 |  915 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     13673 |  919 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     13673 |  920 | `		pMap->iNextIdx++;` |
|      6834 |  921 | `	}` |
|     13673 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  929 | ` */` |
|     33182 |  930 | `static int HashmapFindValue(` |
...
|     33187 |  943 | `	pEntry = pMap->pFirst;` |
|     33187 |  944 | `	n = pMap->nEntry;` |
|     33187 |  945 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33187 |  946 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78741 |  947 | `	for(;;){` |
|    157487 |  948 | `		if( n < 1 ){` |
|       115 |  949 | `			break;` |
|         - |  950 | `		}` |
|         - |  951 | `		/* Extract node value */` |
|    157373 |  952 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    157373 |  953 | `		if( pVal ){` |
...
|    157373 |  960 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    157373 |  961 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    157373 |  962 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    157373 |  963 | `			PH7_MemObjRelease(&sVal);` |
|    157373 |  964 | `			PH7_MemObjRelease(&sNeedle);` |
|    157373 |  965 | `			if( rc == 0 ){` |
|     33073 |  966 | `				if( ppNode ){` |
|        23 |  967 | `					*ppNode = pEntry;` |
|        11 |  968 | `				}` |
|         - |  969 | `				/* Match found*/` |
|     33073 |  970 | `				return SXRET_OK;` |
|         - |  971 | `			}` |
|     62150 |  972 | `		}` |
|         - |  973 | `		/* Point to the next entry */` |
|    124305 |  974 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    124305 |  975 | `		n--;` |
|         5 |  976 | `	}` |
|         - |  977 | `	/* No such entry */` |
...
|         - | 1164 | ` */` |
|    650762 | 1165 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1174 | `	sxi32 rc;` |
|         - | 1175 |  |
|    650767 | 1176 | `	if( pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ ){` |
...
|         7 | 1199 | `		return rc;` |
|         - | 1200 | `	}` |
|    650761 | 1201 | `	sSafeVal = *pVal;` |
|         - | 1202 |  |
|    650761 | 1203 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2037 | 1209 | `	}else{` |
|         - | 1210 | `		/* Int key */` |
|    646697 | 1211 | `		if( iAction == 0 ){ /* Merge */` |
|    646465 | 1212 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    323465 | 1213 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    649267 | 1250 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1251 | `		/* Extract the node value */` |
|    646523 | 1252 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    646523 | 1253 | `		if( pVal ){` |
...
|         - | 1258 | `			 */` |
|    646523 | 1259 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    323264 | 1260 | `		}else{` |
|       ! 0 | 1261 | `			rc = SXRET_OK;` |
|         - | 1262 | `		}` |
|    646523 | 1263 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1264 | `			return rc;` |
|         - | 1265 | `		}` |
|         - | 1266 | `		/* Point to the next entry */` |
|    646523 | 1267 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    323264 | 1268 | `	}` |
...
|         - | 1425 | ` */` |
|    227842 | 1426 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1427 | `{` |
|    227847 | 1428 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1429 | `	ph7_hashmap *pNew;` |
|         - | 1430 | `	ph7_value *pBacking;` |
|         - | 1431 | `	sxu32 nValIdx;` |
|         - | 1432 | `	int bValueInPool;` |
|    227847 | 1433 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    227847 | 1434 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1435 | `		/* Sole owner, no separation needed */` |
|    225487 | 1436 | `		return pMap;` |
|         - | 1437 | `	}` |
|      2365 | 1438 | `	if( pMap == pVm->pGlobal ){` |
...
|      2243 | 1447 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2243 | 1448 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2238 | 1449 | `		if( pBacking && pBacking != pValue` |
|      2215 | 1450 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2197 | 1451 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1452 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2197 | 1453 | `			pMap->iRef--;` |
|      2197 | 1454 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1455 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2155 | 1456 | `				pMap->iRef++;` |
|      2155 | 1457 | `				return pMap;` |
|         - | 1458 | `			}` |
...
|         - | 1611 | ` */` |
|    142198 | 1612 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    142203 | 1620 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142203 | 1621 | `	if( pMap == 0 ){` |
|       ! 0 | 1622 | `		return 0;` |
|         - | 1623 | `	}` |
|         - | 1624 | `	/* Zero the structure */` |
|    142203 | 1625 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1626 | `	/* Fill in the structure */` |
|    142203 | 1627 | `	pMap->pVm = &(*pVm);` |
|    142203 | 1628 | `	pMap->iRef = 1;` |
|         - | 1629 | `	/* Default hash functions */` |
|    142203 | 1630 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142203 | 1631 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142203 | 1632 | `	return pMap;` |
|     71104 | 1633 | `}` |
|         - | 1634 | `/*` |
...
|         - | 1724 | ` */` |
|     98848 | 1725 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1726 | `{` |
|         - | 1727 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     98853 | 1728 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1729 | `	sxu32 n;` |
|     98853 | 1730 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1734 | `	}` |
|     98853 | 1735 | `	if( pMap->pActiveSteps ){` |
...
|     98853 | 1748 | `	n = 0;` |
|     98853 | 1749 | `	pEntry = pMap->pFirst;` |
|   1701899 | 1750 | `	for(;;){` |
|   3403803 | 1751 | `		if( n >= pMap->nEntry ){` |
|     98853 | 1752 | `			break;` |
|         - | 1753 | `		}` |
|   3304955 | 1754 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1755 | `		/* Remove the reference from the foreign table */` |
|   3304955 | 1756 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3304955 | 1757 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1758 | `			/* Restore the ph7_value to the free list */` |
|   3304945 | 1759 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1652470 | 1760 | `		}` |
|         - | 1761 | `		/* Release the node */` |
|   3304955 | 1762 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    178803 | 1763 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     89399 | 1764 | `		}` |
|   3304955 | 1765 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1766 | `		/* Point to the next entry */` |
|   3304955 | 1767 | `		pEntry = pNext;` |
|   3304955 | 1768 | `		n++;` |
|         5 | 1769 | `	}` |
|     98853 | 1770 | `	if( pMap->nEntry > 0 ){` |
|         - | 1771 | `		/* Release the hash bucket */` |
|     74863 | 1772 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     37429 | 1773 | `	}` |
|     98853 | 1774 | `	if( FreeDS ){` |
|         - | 1775 | `		/* Free the whole instance */` |
|     98829 | 1776 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     49417 | 1777 | `	}else{` |
...
|         - | 1790 | ` */` |
|    819560 | 1791 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1792 | `{` |
|    819565 | 1793 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1794 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    819565 | 1795 | `	pMap->iRef--;` |
|    819565 | 1796 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     98809 | 1797 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     49402 | 1798 | `	}` |
|    819565 | 1799 | `}` |
|         - | 1800 | `/*` |
...
|         - | 1804 | ` */` |
|    136746 | 1805 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1825 | ` */` |
|   2697374 | 1826 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2697379 | 1837 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2697379 | 1838 | `	return rc;` |
|         5 | 1839 | `}` |
|         - | 1840 | `/*` |
...
|         - | 1876 | ` */` |
|     47106 | 1877 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1882 | `{` |
|         - | 1883 | `	sxi32 rc;` |
|     47111 | 1884 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1890 | `	}` |
|     47111 | 1891 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     47111 | 1892 | `	return rc;` |
|     23558 | 1893 | `}` |
|         - | 1894 | `/*` |
...
|         - | 1901 | ` */` |
|     18664 | 1902 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1903 | `{` |
|     18669 | 1904 | `	pStep->pCursor = pMap->pFirst;` |
|     18669 | 1905 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     18669 | 1906 | `	pMap->pActiveSteps = pStep;` |
|     18669 | 1907 | `}` |
|         - | 1908 | `/*` |
...
|         - | 1913 | ` */` |
|     18574 | 1914 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1915 | `{` |
|     18579 | 1916 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     18579 | 1917 | `	while( *ppLink ){` |
|     18579 | 1918 | `		if( *ppLink == pStep ){` |
|     18579 | 1919 | `			*ppLink = pStep->pNextActive;` |
|     18579 | 1920 | `			pStep->pNextActive = 0;` |
|     18579 | 1921 | `			return;` |
|         - | 1922 | `		}` |
...
|         - | 1945 | ` */` |
|    576412 | 1946 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1947 | `{` |
|    576417 | 1948 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    576417 | 1949 | `	if( pEntry ){` |
|    576417 | 1950 | `		if( bStore ){` |
|    228749 | 1951 | `			PH7_MemObjStore(pEntry,pValue);` |
|    114377 | 1952 | `		}else{` |
|    347673 | 1953 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1954 | `		}` |
|    288183 | 1955 | `	}else{` |
...
|         - | 1961 | ` */` |
|    150670 | 1962 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 1963 | `{` |
|         - | 1964 | `	/* Fill with the current key */` |
|    150675 | 1965 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    145733 | 1966 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 1967 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 1968 | `		}` |
|    145733 | 1969 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    145733 | 1970 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     72869 | 1971 | `	}else{` |
...
|         - | 2025 | `**   changed.` |
|         - | 2026 | `*/` |
|     34944 | 2027 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2028 | `{` |
|         - | 2029 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2030 | `    /* Prevent compiler warning */` |
|     34949 | 2031 | `	result.pNext = result.pPrev = 0;` |
|     34949 | 2032 | `	pTail = &result;` |
|    106150 | 2033 | `	while( pA && pB ){` |
|     71206 | 2034 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47099 | 2035 | `			pTail->pPrev = pA;` |
|     47099 | 2036 | `			pA->pNext = pTail;` |
|     47099 | 2037 | `			pTail = pA;` |
|     47099 | 2038 | `			pA = pA->pPrev;` |
|     23526 | 2039 | `		}else{` |
|     24112 | 2040 | `			pTail->pPrev = pB;` |
|     24112 | 2041 | `			pB->pNext = pTail;` |
|     24112 | 2042 | `			pTail = pB;` |
|     24112 | 2043 | `			pB = pB->pPrev;` |
|         - | 2044 | `		}` |
|         5 | 2045 | `	}` |
|     34949 | 2046 | `	if( pA ){` |
|     24573 | 2047 | `		pTail->pPrev = pA;` |
|     24573 | 2048 | `		pA->pNext = pTail;` |
|     22694 | 2049 | `	}else if( pB ){` |
|     10157 | 2050 | `		pTail->pPrev = pB;` |
|     10157 | 2051 | `		pB->pNext = pTail;` |
|      5052 | 2052 | `	}else{` |
|       229 | 2053 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2054 | `	}` |
|     34949 | 2055 | `	return result.pPrev;` |
|         5 | 2056 | `}` |
|         - | 2057 | `/*` |
|         - | 2058 | `** Inputs:` |
...
|     14517 | 2076 | `	while( pIn ){` |
|     13793 | 2077 | `		p = pIn;` |
|     13793 | 2078 | `		pIn = p->pPrev;` |
|     13793 | 2079 | `		p->pPrev = 0;` |
|     26293 | 2080 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     26293 | 2081 | `			if( a[i]==0 ){` |
|     13793 | 2082 | `				a[i] = p;` |
|     13793 | 2083 | `				break;` |
|       ! 0 | 2084 | `			}else{` |
|     12505 | 2085 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12505 | 2086 | `				a[i] = 0;` |
|         - | 2087 | `			}` |
|      6255 | 2088 | `		}` |
|     13793 | 2089 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|         - | 2111 | ` */` |
|     70978 | 2112 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2113 | `{` |
|         - | 2114 | `	ph7_value sA,sB;` |
|         - | 2115 | `	sxi32 iFlags;` |
|         - | 2116 | `	int rc;` |
|     70983 | 2117 | `	if( pCmpData == 0 ){` |
|         - | 2118 | `		/* Perform a standard comparison */` |
|     70959 | 2119 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|     70959 | 2120 | `		return rc;` |
|         - | 2121 | `	}` |
...
|         2 | 2430 | `		}` |
|     13619 | 2431 | `		HashmapRehashIntNode(p);` |
|         - | 2432 | `		/* Point to the next entry */` |
|     13619 | 2433 | `		i++;` |
|     13619 | 2434 | `		pLast = p;` |
|     13619 | 2435 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2436 | `	}` |
|       679 | 2437 | `}` |
|         - | 2438 | `/*` |
...
|         - | 4805 | ` */` |
|     32990 | 4806 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4807 | `{` |
|         - | 4808 | `	ph7_value *pNeedle;` |
|         - | 4809 | `	int bStrict;` |
|         - | 4810 | `	int rc;` |
|     32995 | 4811 | `	if( nArg < 2 ){` |
|         - | 4812 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4813 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4814 | `		return PH7_OK;` |
|         - | 4815 | `	}` |
|     32995 | 4816 | `	pNeedle = apArg[0];` |
|     32995 | 4817 | `	bStrict = 0;` |
|     32995 | 4818 | `	if( nArg > 2 ){` |
|        53 | 4819 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4820 | `	}` |
|     32995 | 4821 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     32995 | 4829 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4830 | `	/* Lookup result */` |
|     32995 | 4831 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     32995 | 4832 | `	return PH7_OK;` |
|     16500 | 4833 | `}` |
|         - | 4834 | `/*` |
...
|         6 | 6944 | `			pNode = pMap->pLast;` |
|         6 | 6945 | `			nEntry = pMap->nEntry - nEntry;` |
|         6 | 6946 | `			if( nEntry > 1 ){` |
|       ! 0 | 6947 | `				for(;;){` |
|       ! 0 | 6948 | `					if( nEntry == 0 ){` |
|       ! 0 | 6949 | `						break;` |
...
|         - | 8744 | ` */` |
|     33820 | 8745 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33825 | 8756 | `	rc = SXRET_OK;` |
|     33825 | 8757 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33825 | 8758 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33825 | 8759 | `	n = pMap->nEntry;` |
|     33825 | 8760 | `	pEntry = pMap->pFirst;` |
...
|    145459 | 8767 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    145459 | 8768 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8769 | `		/* Invoke the user callback */` |
|    145459 | 8770 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8771 | `		/* Release the copy of the key and the value */` |
|    145459 | 8772 | `		PH7_MemObjRelease(&sKey);` |
|    145459 | 8773 | `		PH7_MemObjRelease(&sValue);` |
|    145459 | 8774 | `		if( rc != PH7_OK ){` |
|         - | 8775 | `			/* Callback request an operation abort */` |
|       ! 0 | 8776 | `			return SXERR_ABORT;` |
|         - | 8777 | `		}` |
|         - | 8778 | `		/* Point to the next entry */` |
|    145459 | 8779 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    145459 | 8780 | `		n--;` |
|         5 | 8781 | `	}` |
|         - | 8782 | `	/* All done */` |
|     33825 | 8783 | `	return SXRET_OK;` |
|     16915 | 8784 | `}` |
|         - | 8785 |  |
