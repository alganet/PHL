...
|         - |   22 | ` */` |
|   7943130 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7943135 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7943135 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    509754 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    509759 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    509759 |   35 | `	sxu32 nH = 5381;` |
|    509759 |   36 | `	zEnd = &zIn[nLen];` |
|    585149 |   37 | `	for(;;){` |
|   1170303 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1001039 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    901983 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    779045 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    509759 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3637818 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3637823 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3637823 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3637823 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3637823 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3637823 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3637823 |  112 | `	pNode->nHash = nHash;` |
|   3637823 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3637823 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3637823 |  115 | `	return pNode;` |
|   1818914 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    195072 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    195077 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    195077 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    195077 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    195077 |  133 | `	pNode->pMap  = &(*pMap);` |
|    195077 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    195077 |  135 | `	pNode->nHash = nHash;` |
|    195077 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    195077 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    195077 |  138 | `	pNode->nValIdx = nValIdx;` |
|    195077 |  139 | `	return pNode;` |
|     97541 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3832890 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3832895 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3383397 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3383397 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1691696 |  150 | `	}` |
|   3832895 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3832895 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87075 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87075 |  156 | `		pMap->pCur = pNode;` |
|     43540 |  157 | `	}else{` |
|   3745825 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3832895 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3832890 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3832895 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92545 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92545 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92545 |  245 | `		if( nNew < 1 ){` |
|     87075 |  246 | `			nNew = 16;` |
...
|     92545 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92545 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92545 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92545 |  260 | `		pMap->apBucket = apNew;` |
|     92545 |  261 | `		pMap->nSize = nNew;` |
|     92545 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87075 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2735 |  288 | `	}` |
|   3745825 |  289 | `	return SXRET_OK;` |
|   1916450 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3637818 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3637823 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3637781 |  310 | `		if( pValue ){` |
|   3637775 |  311 | `			sSafeVal = *pValue;` |
|   3637775 |  312 | `			pValue = &sSafeVal;` |
|   1818885 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3637781 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3637781 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3637781 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3637775 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1818885 |  322 | `		}` |
|   3637781 |  323 | `		nIdx = pObj->nIdx;` |
|   1818893 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3637823 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3637823 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3637823 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3637823 |  334 | `	if( isForeign ){` |
...
|   3637823 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3637823 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3637823 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3637823 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3637823 |  349 | `	return SXRET_OK;` |
|   1818914 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    195072 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    195077 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    148947 |  370 | `		if( pValue ){` |
|    148637 |  371 | `			sSafeVal = *pValue;` |
|    148637 |  372 | `			pValue = &sSafeVal;` |
|     74316 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    148947 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    148947 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    148947 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    148637 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     74316 |  382 | `		}` |
|    148947 |  383 | `		nIdx = pObj->nIdx;` |
|     74476 |  384 | `	}else{` |
|     46135 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    195077 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    195077 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    195077 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    195077 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46135 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23065 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    195077 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    195077 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    195077 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    195077 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    195077 |  409 | `	return SXRET_OK;` |
|     97541 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4291754 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4291759 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       783 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4290981 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4290981 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110567479 |  433 | `	for(;;){` |
| 221134963 |  434 | `		if( pNode == 0 ){` |
|   4284465 |  435 | `			break;` |
|         - |  436 | `		}` |
...
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284465 |  450 | `	return SXERR_NOTFOUND;` |
|   2145882 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    342074 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    342079 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     27397 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    314687 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    314687 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255367 |  475 | `	for(;;){` |
|    510739 |  476 | `		if( pNode == 0 ){` |
|    247469 |  477 | `			break;` |
|         - |  478 | `		}` |
|    263270 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261759 |  480 | `			&& pNode->nHash == nHash` |
|    163784 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     67325 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67223 |  484 | `				if( ppNode ){` |
|     67195 |  485 | `					*ppNode = pNode;` |
|     33595 |  486 | `				}` |
|     67223 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196057 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    247469 |  493 | `	return SXERR_NOTFOUND;` |
|    171042 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    342208 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    342213 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    342213 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    342213 |  504 | `	int isNeg = FALSE, nDigit;` |
|    342213 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    342191 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    342187 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    342187 |  516 | `	zDigit = zIn;` |
|    171527 |  517 | `	for(;;){` |
|    343059 |  518 | `		if( zIn >= zEnd ){` |
|       253 |  519 | `			break;` |
|         - |  520 | `		}` |
|    342807 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    341935 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       873 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    153544 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    153549 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    153549 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    147147 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    147147 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    147131 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    147131 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         8 |  567 | `	}` |
...
|     76772 |  575 | `result:` |
|    153549 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72857 |  578 | `		if( ppNode ){` |
|     72805 |  579 | `			*ppNode = pNode;` |
|     36400 |  580 | `		}` |
|     72857 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80697 |  584 | `	return SXERR_NOTFOUND;` |
|     76777 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  591 | ` */` |
|   2142618 |  592 | `static void HashmapAdvanceAutoIndex(ph7_hashmap *pMap,sxi64 iKey)` |
|         5 |  593 | `{` |
|   2142623 |  594 | `	if( !pMap->bIntKeySeen ){` |
|         - |  595 | `		/* php 8.3: the first integer key sets the auto-index even if it is negative */` |
|       827 |  596 | `		pMap->bIntKeySeen = 1;` |
|       827 |  597 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|       827 |  598 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  599 | `			pMap->iNextIdx++;` |
|       ! 0 |  600 | `		}` |
|       827 |  601 | `		return;` |
|         - |  602 | `	}` |
|   2141801 |  603 | `	if( iKey >= pMap->iNextIdx ){` |
|   2141551 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141551 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070773 |  609 | `	}` |
|   1071314 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1491426 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1491431 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1491425 |  623 | `	return FALSE;` |
|    745718 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3782896 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3782901 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3782901 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3782901 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    148929 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    148929 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    223049 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     74348 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    148215 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    148081 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    148081 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1816986 |  683 | `IntKey:` |
|   3634205 |  684 | `	if( pKey ){` |
|   2142813 |  685 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  686 | `			/* Force an integer cast */` |
|       259 |  687 | `			PH7_MemObjToInteger(pKey);` |
|       129 |  688 | `		}` |
|   2142813 |  689 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
...
|         - |  702 | `		}` |
|   2142619 |  703 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|   2142617 |  711 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   2142617 |  712 | `		if( rc == SXRET_OK ){` |
|   2142617 |  713 | `			HashmapAdvanceAutoIndex(&(*pMap),pKey->x.iVal);` |
|   1071306 |  714 | `		}` |
|   1071311 |  715 | `	}else{` |
|   1491397 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1491395 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1491389 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1491389 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1491387 |  726 | `			++pMap->iNextIdx;` |
|    745691 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3634001 |  730 | `	return rc;` |
|   1891453 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46182 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46187 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46187 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46187 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46147 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46147 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69215 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23070 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46135 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46135 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1527159 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1527164 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1527164 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     73284 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     73289 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     73289 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     73289 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     73289 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     73289 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     73289 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     73289 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     73289 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     73289 |  921 | `	return rc;` |
|     36652 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14336 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14341 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14341 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11573 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5798 |  934 | `	}else{` |
|      2773 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14341 |  937 | `	if( pEntry->pNextCollide ){` |
|      1029 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       535 |  939 | `	}` |
|     14341 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14341 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14341 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14341 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14341 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14341 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11904 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5967 |  949 | `	}` |
|     14341 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14341 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14341 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14341 |  956 | `		pMap->iNextIdx++;` |
|      7168 |  957 | `	}` |
|     14341 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33572 |  966 | `static int HashmapFindValue(` |
...
|     33577 |  979 | `	pEntry = pMap->pFirst;` |
|     33577 |  980 | `	n = pMap->nEntry;` |
|     33577 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33577 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80132 |  983 | `	for(;;){` |
|    160268 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    160190 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    160190 |  989 | `		if( pVal ){` |
...
|    160190 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    160190 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    160190 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    160190 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    160190 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    160190 | 1001 | `			if( rc == 0 ){` |
|     33499 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33499 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63346 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    126696 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    126696 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    721332 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    721332 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    721334 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    721329 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    721329 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2004 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    717331 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    713709 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    360479 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    716667 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    713769 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    713769 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    713769 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    356887 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    713769 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    713769 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    356887 | 1305 | `	}` |
...
|         - | 1462 | ` */` |
|    242918 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    242923 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    242923 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    242923 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    240147 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|         - | 1648 | ` */` |
|    141488 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141493 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141493 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    141493 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    141493 | 1664 | `	pMap->pVm = &(*pVm);` |
|    141493 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    141493 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141493 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141493 | 1669 | `	return pMap;` |
|     70749 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|     94428 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94433 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|     94433 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|     94433 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|     94433 | 1785 | `	n = 0;` |
|     94433 | 1786 | `	pEntry = pMap->pFirst;` |
|   1910146 | 1787 | `	for(;;){` |
|   3820297 | 1788 | `		if( n >= pMap->nEntry ){` |
|     94433 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3725869 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3725869 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3725869 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3725809 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1862902 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3725869 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    107011 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     53503 | 1801 | `		}` |
|   3725869 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3725869 | 1804 | `		pEntry = pNext;` |
|   3725869 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|     94433 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     67981 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33988 | 1810 | `	}` |
|     94433 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|     94407 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47206 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    872318 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    872323 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    872323 | 1833 | `	pMap->iRef--;` |
|    872323 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94387 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47191 | 1836 | `	}` |
|    872323 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    153738 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   3068858 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3068863 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3068863 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1914 | ` */` |
|     46172 | 1915 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1920 | `{` |
|         - | 1921 | `	sxi32 rc;` |
|     46177 | 1922 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1928 | `	}` |
|     46177 | 1929 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46177 | 1930 | `	return rc;` |
|     23091 | 1931 | `}` |
|         - | 1932 | `/*` |
...
|         - | 1939 | ` */` |
|     23232 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     23237 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     23237 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23237 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     23237 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     23064 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     23069 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23069 | 1955 | `	while( *ppLink ){` |
|     23069 | 1956 | `		if( *ppLink == pStep ){` |
|     23069 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     23069 | 1958 | `			pStep->pNextActive = 0;` |
|     23069 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    607004 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    607009 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    607009 | 1987 | `	if( pEntry ){` |
|    607009 | 1988 | `		if( bStore ){` |
|    236291 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    118148 | 1990 | `		}else{` |
|    370723 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    303517 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    164672 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    164677 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    158995 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    158995 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    158995 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79500 | 2009 | `	}else{` |
...
|    110863 | 2071 | `	while( pA && pB ){` |
|     73547 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48511 | 2073 | `			pTail->pPrev = pA;` |
|     48511 | 2074 | `			pA->pNext = pTail;` |
|     48511 | 2075 | `			pTail = pA;` |
|     48511 | 2076 | `			pA = pA->pPrev;` |
|     24236 | 2077 | `		}else{` |
|     25041 | 2078 | `			pTail->pPrev = pB;` |
|     25041 | 2079 | `			pB->pNext = pTail;` |
|     25041 | 2080 | `			pTail = pB;` |
|     25041 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     37321 | 2084 | `	if( pA ){` |
|     26503 | 2085 | `		pTail->pPrev = pA;` |
|     26503 | 2086 | `		pA->pNext = pTail;` |
|     24090 | 2087 | `	}else if( pB ){` |
|     10583 | 2088 | `		pTail->pPrev = pB;` |
|     10583 | 2089 | `		pB->pNext = pTail;` |
|      5276 | 2090 | `	}else{` |
...
|     15177 | 2114 | `	while( pIn ){` |
|     14393 | 2115 | `		p = pIn;` |
|     14393 | 2116 | `		pIn = p->pPrev;` |
|     14393 | 2117 | `		p->pPrev = 0;` |
|     27405 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27405 | 2119 | `			if( a[i]==0 ){` |
|     14393 | 2120 | `				a[i] = p;` |
|     14393 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
...
|         - | 2125 | `			}` |
|      6511 | 2126 | `		}` |
|     14393 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     73218 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     73223 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     73135 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         - | 2493 | ` */` |
|        22 | 2494 | `static sxi32 HashmapCmpCallback7(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         1 | 2495 | `{` |
|         - | 2496 | `	sxu32 n;` |
|        10 | 2497 | `	SXUNUSED(pB); /* cc warning */` |
|        10 | 2498 | `	SXUNUSED(pCmpData);` |
|         - | 2499 | `	/* Grab a random number */` |
|        23 | 2500 | `	n = PH7_VmRandomNum(pA->pMap->pVm);` |
...
|         2 | 2529 | `		}` |
|     14117 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     14117 | 2532 | `		i++;` |
|     14117 | 2533 | `		pLast = p;` |
|     14117 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       707 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         5 | 3037 | `			pMap->pLast = pMap->pLast->pPrev;` |
|       ! 0 | 3038 | `		}` |
|         1 | 3039 | `	}` |
...
|         - | 4937 | ` */` |
|     33444 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33449 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33449 | 4948 | `	pNeedle = apArg[0];` |
|     33449 | 4949 | `	bStrict = 0;` |
|     33449 | 4950 | `	if( nArg > 2 ){` |
|        56 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        27 | 4952 | `	}` |
|     33449 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33449 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33449 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33449 | 4964 | `	return PH7_OK;` |
|     16727 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         - | 8934 | ` */` |
|     34620 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34625 | 8946 | `	rc = SXRET_OK;` |
|     34625 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34625 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34625 | 8949 | `	n = pMap->nEntry;` |
|     34625 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    157703 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157703 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    157703 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    157703 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    157703 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    157703 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    157703 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157703 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34625 | 8973 | `	return SXRET_OK;` |
|     17315 | 8974 | `}` |
|         - | 8975 |  |
