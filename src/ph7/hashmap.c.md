...
Coverage: 3804/4260 lines (89.30%)
...
|         - |   22 | ` */` |
|   7384578 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7384583 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7384583 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    411208 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    411213 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    411213 |   35 | `	sxu32 nH = 5381;` |
|    411213 |   36 | `	zEnd = &zIn[nLen];` |
|    480646 |   37 | `	for(;;){` |
|    961297 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    831239 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    752161 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    643077 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    411213 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3088340 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3088345 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3088345 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3088345 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3088345 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3088345 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3088345 |  112 | `	pNode->nHash = nHash;` |
|   3088345 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3088345 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3088345 |  115 | `	return pNode;` |
|   1544175 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    155220 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    155225 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    155225 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    155225 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    155225 |  133 | `	pNode->pMap  = &(*pMap);` |
|    155225 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    155225 |  135 | `	pNode->nHash = nHash;` |
|    155225 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    155225 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    155225 |  138 | `	pNode->nValIdx = nValIdx;` |
|    155225 |  139 | `	return pNode;` |
|     77615 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3243560 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3243565 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2861719 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2861719 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1430857 |  150 | `	}` |
|   3243565 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3243565 |  153 | `	if( pMap->pFirst == 0 ){` |
|     75243 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     75243 |  156 | `		pMap->pCur = pNode;` |
|     37624 |  157 | `	}else{` |
|   3168327 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3243565 |  160 | `	++pMap->nEntry;` |
|   3243565 |  161 | `}` |
|         - |  162 | `/*` |
|         - |  163 | ` * Unlink a node from the hashmap.` |
|         - |  164 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  165 | ` */` |
|      7414 |  166 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  167 | `{` |
|      7419 |  168 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7419 |  169 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  170 | `	/* Unlink from the corresponding bucket */` |
|      7419 |  171 | `	if( pNode->pPrevCollide == 0 ){` |
...
|        51 |  194 | `		}` |
|        51 |  195 | `	}` |
|      7419 |  196 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7282 |  197 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3639 |  198 | `	}` |
|      7419 |  199 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7419 |  200 | `	pMap->nEntry--;` |
|      7419 |  201 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|         - |  212 | ` */` |
|   3243560 |  213 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  214 | `{` |
|   3243565 |  215 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     79967 |  216 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  217 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     79967 |  218 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  219 | `		sxu32 nBucket;` |
|         - |  220 | `		sxu32 n;` |
|     79967 |  221 | `		if( nNew < 1 ){` |
|     75243 |  222 | `			nNew = 16;` |
...
|     79967 |  225 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     79967 |  226 | `		if( apNew == 0 ){` |
...
|         - |  232 | `		}` |
|         - |  233 | `		/* Zero the table */` |
|     79967 |  234 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  235 | `		/* Reflect the change */` |
|     79967 |  236 | `		pMap->apBucket = apNew;` |
|     79967 |  237 | `		pMap->nSize = nNew;` |
|     79967 |  238 | `		if( apOld == 0 ){` |
|         - |  239 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     75243 |  240 | `			return SXRET_OK;` |
|         - |  241 | `		}` |
...
|      2362 |  264 | `	}` |
|   3168327 |  265 | `	return SXRET_OK;` |
|   1621785 |  266 | `}` |
|         - |  267 | `/*` |
|         - |  268 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  269 | ` * hashmap.` |
|         - |  270 | ` */` |
|   3088340 |  271 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  272 | `{` |
|         - |  273 | `	ph7_hashmap_node *pNode;` |
|         - |  274 | `	sxu32 nIdx;` |
|         - |  275 | `	sxu32 nHash;` |
|         - |  276 | `	sxi32 rc;` |
|   3088345 |  277 | `	if( !isForeign ){` |
|         - |  278 | `		ph7_value *pObj;` |
...
|   3088307 |  286 | `		if( pValue ){` |
|   3088305 |  287 | `			sSafeVal = *pValue;` |
|   3088305 |  288 | `			pValue = &sSafeVal;` |
|   1544150 |  289 | `		}` |
|         - |  290 | `		/* Reserve a ph7_value for the value */` |
|   3088307 |  291 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3088307 |  292 | `		if( pObj == 0 ){` |
|       ! 0 |  293 | `			return SXERR_MEM;` |
|         - |  294 | `		}` |
|   3088307 |  295 | `		if( pValue ){` |
|         - |  296 | `			/* Duplicate the value */` |
|   3088305 |  297 | `			PH7_MemObjStore(pValue,pObj);` |
|   1544150 |  298 | `		}` |
|   3088307 |  299 | `		nIdx = pObj->nIdx;` |
|   1544156 |  300 | `	}else{` |
|        39 |  301 | `		nIdx = nRefIdx;` |
|         - |  302 | `	}` |
|         - |  303 | `	/* Hash the key */` |
|   3088345 |  304 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  305 | `	/* Allocate a new int node */` |
|   3088345 |  306 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3088345 |  307 | `	if( pNode == 0 ){` |
|       ! 0 |  308 | `		return SXERR_MEM;` |
|         - |  309 | `	}` |
|   3088345 |  310 | `	if( isForeign ){` |
...
|   3088345 |  315 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3088345 |  316 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  317 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  318 | `		return rc;` |
|         - |  319 | `	}` |
|         - |  320 | `	/* Perform the insertion */` |
|   3088345 |  321 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  322 | `	/* Install in the reference table */` |
|   3088345 |  323 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  324 | `	/* All done */` |
|   3088345 |  325 | `	return SXRET_OK;` |
|   1544175 |  326 | `}` |
|         - |  327 | `/*` |
|         - |  328 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  329 | ` * hashmap.` |
|         - |  330 | ` */` |
|    155220 |  331 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  332 | `{` |
|         - |  333 | `	ph7_hashmap_node *pNode;` |
|         - |  334 | `	sxu32 nHash;` |
|         - |  335 | `	sxu32 nIdx;` |
|         - |  336 | `	sxi32 rc;` |
|    155225 |  337 | `	if( !isForeign ){` |
|         - |  338 | `		ph7_value *pObj;` |
...
|    108985 |  346 | `		if( pValue ){` |
|    108695 |  347 | `			sSafeVal = *pValue;` |
|    108695 |  348 | `			pValue = &sSafeVal;` |
|     54345 |  349 | `		}` |
|         - |  350 | `		/* Reserve a ph7_value for the value */` |
|    108985 |  351 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    108985 |  352 | `		if( pObj == 0 ){` |
|       ! 0 |  353 | `			return SXERR_MEM;` |
|         - |  354 | `		}` |
|    108985 |  355 | `		if( pValue ){` |
|         - |  356 | `			/* Duplicate the value */` |
|    108695 |  357 | `			PH7_MemObjStore(pValue,pObj);` |
|     54345 |  358 | `		}` |
|    108985 |  359 | `		nIdx = pObj->nIdx;` |
|     54495 |  360 | `	}else{` |
|     46245 |  361 | `		nIdx = nRefIdx;` |
|         - |  362 | `	}` |
|         - |  363 | `	/* Hash the key */` |
|    155225 |  364 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  365 | `	/* Allocate a new blob node */` |
|    155225 |  366 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    155225 |  367 | `	if( pNode == 0 ){` |
|       ! 0 |  368 | `		return SXERR_MEM;` |
|         - |  369 | `	}` |
|    155225 |  370 | `	if( isForeign ){` |
|         - |  371 | `		/* Mark as a foregin entry */` |
|     46245 |  372 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23120 |  373 | `	}` |
|         - |  374 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    155225 |  375 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    155225 |  376 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  377 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  378 | `		return rc;` |
|         - |  379 | `	}` |
|         - |  380 | `	/* Perform the insertion */` |
|    155225 |  381 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  382 | `	/* Install in the reference table */` |
|    155225 |  383 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  384 | `	/* All done */` |
|    155225 |  385 | `	return SXRET_OK;` |
|     77615 |  386 | `}` |
|         - |  387 | `/*` |
...
|         - |  432 | ` */` |
|    280556 |  433 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  441 | `	sxu32 nHash;` |
|    280561 |  442 | `	if( pMap->nEntry < 1 ){` |
|         - |  443 | `		/* Don't bother hashing,there is no entry anyway */` |
|     24573 |  444 | `		return SXERR_NOTFOUND;` |
|         - |  445 | `	}` |
|         - |  446 | `	/* Hash the key first */` |
|    255993 |  447 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  448 | `	/* Point to the appropriate bucket */` |
|    255993 |  449 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  450 | `	/* Perform the lookup */` |
|    216682 |  451 | `	for(;;){` |
|    433369 |  452 | `		if( pNode == 0 ){` |
|    203761 |  453 | `			break;` |
|         - |  454 | `		}` |
|    229608 |  455 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    228103 |  456 | `			&& pNode->nHash == nHash` |
|    139461 |  457 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     52329 |  458 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  459 | `				/* Node found */` |
|     52237 |  460 | `				if( ppNode ){` |
|     52209 |  461 | `					*ppNode = pNode;` |
|     26102 |  462 | `				}` |
|     52237 |  463 | `				return SXRET_OK;` |
|         - |  464 | `		}` |
|         - |  465 | `		/* Follow the collision link */` |
|    177381 |  466 | `		pNode = pNode->pNextCollide;` |
|         5 |  467 | `	}` |
|         - |  468 | `	/* No such entry */` |
|    203761 |  469 | `	return SXERR_NOTFOUND;` |
|    140283 |  470 | `}` |
|         - |  471 | `/*` |
|         - |  472 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  473 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  474 | ` */` |
|    280686 |  475 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  476 | `{` |
|    280691 |  477 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    280691 |  478 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|    280691 |  479 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  480 | `		/* Octal not decimal number */` |
|         5 |  481 | `		return FALSE;` |
|         - |  482 | `	}` |
|    280687 |  483 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|       ! 0 |  484 | `		zIn++;` |
|       ! 0 |  485 | `	}` |
|    140677 |  486 | `	for(;;){` |
|    281359 |  487 | `		if( zIn >= zEnd ){` |
|       239 |  488 | `			return TRUE;` |
|         - |  489 | `		}` |
|    281121 |  490 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|    140227 |  491 | `			break;` |
|         - |  492 | `		}` |
|       673 |  493 | `		zIn++;` |
|         1 |  494 | `	}` |
|         - |  495 | `	/* Key does not look like a decimal number */` |
|    280449 |  496 | `	return FALSE;` |
|    140348 |  497 | `}` |
|         - |  498 | `/*` |
...
|         - |  502 | ` */` |
|    127470 |  503 | `static sxi32 HashmapLookup(` |
|         - |  504 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  505 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  506 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  507 | `	)` |
|         5 |  508 | `{` |
|    127475 |  509 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  510 | `	sxi32 rc;` |
|    127475 |  511 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    125845 |  512 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  513 | `			/* Force a string cast */` |
|       ! 0 |  514 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  515 | `		}` |
|    125845 |  516 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|         - |  517 | `			/* Perform a blob lookup */` |
|    125825 |  518 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    125825 |  519 | `			goto result;` |
|         - |  520 | `		}` |
|        10 |  521 | `	}` |
...
|     63735 |  529 | `result:` |
|    127475 |  530 | `	if( rc == SXRET_OK ){` |
|         - |  531 | `		/* Node found */` |
|     53735 |  532 | `		if( ppNode ){` |
|     53689 |  533 | `			*ppNode = pNode;` |
|     26842 |  534 | `		}` |
|     53735 |  535 | `		return SXRET_OK;` |
|         - |  536 | `	}` |
|         - |  537 | `	/* No such entry */` |
|     73745 |  538 | `	return SXERR_NOTFOUND;` |
|     63740 |  539 | `}` |
|         - |  540 | `/*` |
...
|         - |  561 | ` */` |
|    947074 |  562 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  563 | `{` |
|    947079 |  564 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  565 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  566 | `		return TRUE;` |
|         - |  567 | `	}` |
|    947073 |  568 | `	return FALSE;` |
|    473542 |  569 | `}` |
|         - |  570 | `/*` |
...
|         - |  575 | ` */` |
|   3196434 |  576 | `static sxi32 HashmapInsert(` |
|         - |  577 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  578 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  579 | `	ph7_value *pVal    /* Node value */` |
|         - |  580 | `	)` |
|         5 |  581 | `{` |
|   3196439 |  582 | `	ph7_hashmap_node *pNode = 0;` |
|   3196439 |  583 | `	sxi32 rc = SXRET_OK;` |
|   3196439 |  584 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    112097 |  585 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  586 | `			/* Force a string cast */` |
|         3 |  587 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  588 | `		}` |
|    112097 |  589 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         - |  595 | `		}` |
|    162578 |  596 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     54191 |  597 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  610 | `		}` |
|    108305 |  611 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    108183 |  624 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    108183 |  625 | `		return rc;` |
|         - |  626 | `	}` |
|   1542171 |  627 | `IntKey:` |
|   3088057 |  628 | `	if( pKey ){` |
...
|   1070460 |  658 | `		}` |
|   1070465 |  659 | `	}else{` |
|    947049 |  660 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  661 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  662 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  663 | `		}` |
|    947047 |  664 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  665 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  666 | `		}` |
|         - |  667 | `		/* Assign an automatic index */` |
|    947041 |  668 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|    947041 |  669 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|    947039 |  670 | `			++pMap->iNextIdx;` |
|    473517 |  671 | `		}` |
|         - |  672 | `	}` |
|         - |  673 | `	/* Insertion result */` |
|   3087961 |  674 | `	return rc;` |
|   1598222 |  675 | `}` |
|         - |  676 | `/*` |
...
|         - |  702 | ` */` |
|     46284 |  703 | `static sxi32 HashmapInsertByRef(` |
|         - |  704 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  705 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  706 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  707 | `	)` |
|         5 |  708 | `{` |
|     46289 |  709 | `	ph7_hashmap_node *pNode = 0;` |
|     46289 |  710 | `	sxi32 rc = SXRET_OK;` |
|     46289 |  711 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46253 |  712 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  713 | `			/* Force a string cast */` |
|       ! 0 |  714 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  715 | `		}` |
|     46253 |  716 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  721 | `			goto IntKey;` |
|         - |  722 | `		}` |
|     69374 |  723 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23123 |  724 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  725 | `				/* Overwrite */` |
...
|     46245 |  733 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46245 |  734 | `		return rc;` |
|         - |  735 | `	}` |
|        18 |  736 | `IntKey:` |
|        39 |  737 | `	if( pKey ){` |
...
|         - |  770 | ` */` |
|   1355945 |  771 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  772 | `{` |
|         - |  773 | `	/* Point to the desired object */` |
|         - |  774 | `	ph7_value *pObj;` |
|   1355950 |  775 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1355950 |  776 | `	return pObj;` |
|         5 |  777 | `}` |
|         - |  778 | `/*` |
...
|         - |  820 | ` * documenation.` |
|         - |  821 | ` */` |
|     69256 |  822 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  823 | `{` |
|         - |  824 | `	ph7_value sObj1,sObj2;` |
|         - |  825 | `	sxi32 rc;` |
|     69261 |  826 | `	if( pLeft == pRight ){` |
|         - |  827 | `		/*` |
...
|     69261 |  834 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     69261 |  835 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     69261 |  836 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     69261 |  837 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     69261 |  838 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     69261 |  839 | `	PH7_MemObjRelease(&sObj1);` |
|     69261 |  840 | `	PH7_MemObjRelease(&sObj2);` |
|     69261 |  841 | `	return rc;` |
|     34648 |  842 | `}` |
|         - |  843 | `/*` |
...
|         - |  846 | ` */` |
|     13318 |  847 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  848 | `{` |
|     13323 |  849 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  850 | `	sxu32 nBucket;` |
|         - |  851 | `	/* Remove old collision links */` |
|     13323 |  852 | `	if( pEntry->pPrevCollide ){` |
|     10905 |  853 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5456 |  854 | `	}else{` |
|      2423 |  855 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  856 | `	}` |
|     13323 |  857 | `	if( pEntry->pNextCollide ){` |
|      1081 |  858 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       552 |  859 | `	}` |
|     13323 |  860 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  861 | `	/* Compute the new hash */` |
|     13323 |  862 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     13323 |  863 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     13323 |  864 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  865 | `	/* Link to the new bucket */` |
|     13323 |  866 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13323 |  867 | `	if( pMap->apBucket[nBucket] ){` |
|     11217 |  868 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5607 |  869 | `	}` |
|     13323 |  870 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13323 |  871 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     13323 |  875 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     13323 |  876 | `		pMap->iNextIdx++;` |
|      6659 |  877 | `	}` |
|     13323 |  878 | `}` |
|         - |  879 | `/*` |
...
|         - |  885 | ` */` |
|     32438 |  886 | `static int HashmapFindValue(` |
...
|     32443 |  899 | `	pEntry = pMap->pFirst;` |
|     32443 |  900 | `	n = pMap->nEntry;` |
|     32443 |  901 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32443 |  902 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     77097 |  903 | `	for(;;){` |
|    154196 |  904 | `		if( n < 1 ){` |
|        99 |  905 | `			break;` |
|         - |  906 | `		}` |
|         - |  907 | `		/* Extract node value */` |
|    154098 |  908 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    154098 |  909 | `		if( pVal ){` |
|    154098 |  910 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|       ! 0 |  920 | `			}else{` |
|         - |  921 | `				/* Duplicate value */` |
|    154098 |  922 | `				PH7_MemObjLoad(pVal,&sVal);` |
|    154098 |  923 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    154098 |  924 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    154098 |  925 | `				PH7_MemObjRelease(&sVal);` |
|    154098 |  926 | `				PH7_MemObjRelease(&sNeedle);` |
|    154098 |  927 | `				if( rc == 0 ){` |
|     32345 |  928 | `					if( ppNode ){` |
|        23 |  929 | `						*ppNode = pEntry;` |
|        11 |  930 | `					}` |
|         - |  931 | `					/* Match found*/` |
|     32345 |  932 | `					return SXRET_OK;` |
|         - |  933 | `				}` |
|         - |  934 | `			}` |
|     60878 |  935 | `		}` |
|         - |  936 | `		/* Point to the next entry */` |
|    121758 |  937 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    121758 |  938 | `		n--;` |
|         5 |  939 | `	}` |
|         - |  940 | `	/* No such entry */` |
...
|         - | 1127 | ` */` |
|    631088 | 1128 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1137 | `	sxi32 rc;` |
|         - | 1138 |  |
|    631093 | 1139 | `	if( pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ ){` |
...
|         7 | 1162 | `		return rc;` |
|         - | 1163 | `	}` |
|    631087 | 1164 | `	sSafeVal = *pVal;` |
|         - | 1165 |  |
|    631087 | 1166 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2016 | 1172 | `	}else{` |
|         - | 1173 | `		/* Int key */` |
|    627065 | 1174 | `		if( iAction == 0 ){ /* Merge */` |
|    626851 | 1175 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    313640 | 1176 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    629025 | 1213 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1214 | `		/* Extract the node value */` |
|    626909 | 1215 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    626909 | 1216 | `		if( pVal ){` |
...
|         - | 1221 | `			 */` |
|    626909 | 1222 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    313457 | 1223 | `		}else{` |
|       ! 0 | 1224 | `			rc = SXRET_OK;` |
|         - | 1225 | `		}` |
|    626909 | 1226 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1227 | `			return rc;` |
|         - | 1228 | `		}` |
|         - | 1229 | `		/* Point to the next entry */` |
|    626909 | 1230 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    313457 | 1231 | `	}` |
...
|         - | 1365 | ` */` |
|    217322 | 1366 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1367 | `{` |
|    217327 | 1368 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1369 | `	ph7_hashmap *pNew;` |
|         - | 1370 | `	ph7_value *pBacking;` |
|         - | 1371 | `	sxu32 nValIdx;` |
|         - | 1372 | `	int bValueInPool;` |
|    217327 | 1373 | `	if( pMap->iRef < 2 ){` |
|         - | 1374 | `		/* Sole owner, no separation needed */` |
|    215023 | 1375 | `		return pMap;` |
|         - | 1376 | `	}` |
...
|         - | 1550 | ` */` |
|    116444 | 1551 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    116449 | 1559 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    116449 | 1560 | `	if( pMap == 0 ){` |
|       ! 0 | 1561 | `		return 0;` |
|         - | 1562 | `	}` |
|         - | 1563 | `	/* Zero the structure */` |
|    116449 | 1564 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1565 | `	/* Fill in the structure */` |
|    116449 | 1566 | `	pMap->pVm = &(*pVm);` |
|    116449 | 1567 | `	pMap->iRef = 1;` |
|         - | 1568 | `	/* Default hash functions */` |
|    116449 | 1569 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    116449 | 1570 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    116449 | 1571 | `	return pMap;` |
|     58227 | 1572 | `}` |
|         - | 1573 | `/*` |
...
|         - | 1663 | ` */` |
|     73718 | 1664 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1665 | `{` |
|         - | 1666 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     73723 | 1667 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1668 | `	sxu32 n;` |
|     73723 | 1669 | `	if( pMap == pVm->pGlobal ){` |
...
|     73723 | 1675 | `	n = 0;` |
|     73723 | 1676 | `	pEntry = pMap->pFirst;` |
|   1616280 | 1677 | `	for(;;){` |
|   3232565 | 1678 | `		if( n >= pMap->nEntry ){` |
|     73723 | 1679 | `			break;` |
|         - | 1680 | `		}` |
|   3158847 | 1681 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1682 | `		/* Remove the reference from the foreign table */` |
|   3158847 | 1683 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3158847 | 1684 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1685 | `			/* Restore the ph7_value to the free list */` |
|   3158837 | 1686 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1579416 | 1687 | `		}` |
|         - | 1688 | `		/* Release the node */` |
|   3158847 | 1689 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|     81693 | 1690 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     40844 | 1691 | `		}` |
|   3158847 | 1692 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1693 | `		/* Point to the next entry */` |
|   3158847 | 1694 | `		pEntry = pNext;` |
|   3158847 | 1695 | `		n++;` |
|         5 | 1696 | `	}` |
|     73723 | 1697 | `	if( pMap->nEntry > 0 ){` |
|         - | 1698 | `		/* Release the hash bucket */` |
|     60231 | 1699 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     30113 | 1700 | `	}` |
|     73723 | 1701 | `	if( FreeDS ){` |
|         - | 1702 | `		/* Free the whole instance */` |
|     73707 | 1703 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     36856 | 1704 | `	}else{` |
...
|         - | 1717 | ` */` |
|    734472 | 1718 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1719 | `{` |
|    734477 | 1720 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1721 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    734477 | 1722 | `	pMap->iRef--;` |
|    734477 | 1723 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     73687 | 1724 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     36841 | 1725 | `	}` |
|    734477 | 1726 | `}` |
|         - | 1727 | `/*` |
...
|         - | 1731 | ` */` |
|    127530 | 1732 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1752 | ` */` |
|   2569356 | 1753 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2569361 | 1764 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2569361 | 1765 | `	return rc;` |
|         5 | 1766 | `}` |
|         - | 1767 | `/*` |
...
|         - | 1803 | ` */` |
|     46278 | 1804 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1809 | `{` |
|         - | 1810 | `	sxi32 rc;` |
|     46283 | 1811 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1817 | `	}` |
|     46283 | 1818 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46283 | 1819 | `	return rc;` |
|     23144 | 1820 | `}` |
|         - | 1821 | `/*` |
|         - | 1822 | ` * Reset the node cursor of a given hashmap.` |
|         - | 1823 | ` */` |
|     35418 | 1824 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|         5 | 1825 | `{` |
|         - | 1826 | `	/* Reset the loop cursor */` |
|     35423 | 1827 | `	pMap->pCur = pMap->pFirst;` |
|     35423 | 1828 | `}` |
|         - | 1829 | `/*` |
...
|         - | 1834 | ` */` |
|    234226 | 1835 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|         5 | 1836 | `{` |
|    234231 | 1837 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|    234231 | 1838 | `	if( pCur == 0 ){` |
|         - | 1839 | `		/* End of the list,return null */` |
|     17733 | 1840 | `		return 0;` |
|         - | 1841 | `	}` |
|         - | 1842 | `	/* Advance the node cursor */` |
|    216503 | 1843 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|    216503 | 1844 | `	return pCur;` |
|    117118 | 1845 | `}` |
|         - | 1846 | `/*` |
|         - | 1847 | ` * Extract a node value.` |
|         - | 1848 | ` */` |
|    545756 | 1849 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1850 | `{` |
|    545761 | 1851 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    545761 | 1852 | `	if( pEntry ){` |
|    545761 | 1853 | `		if( bStore ){` |
|    216881 | 1854 | `			PH7_MemObjStore(pEntry,pValue);` |
|    108443 | 1855 | `		}else{` |
|    328885 | 1856 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1857 | `		}` |
|    272913 | 1858 | `	}else{` |
...
|         - | 1864 | ` */` |
|    141622 | 1865 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 1866 | `{` |
|         - | 1867 | `	/* Fill with the current key */` |
|    141627 | 1868 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    137081 | 1869 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        27 | 1870 | `			SyBlobRelease(&pKey->sBlob);` |
|        13 | 1871 | `		}` |
|    137081 | 1872 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    137081 | 1873 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     68543 | 1874 | `	}else{` |
...
|         - | 1928 | `**   changed.` |
|         - | 1929 | `*/` |
|     33956 | 1930 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 1931 | `{` |
|         - | 1932 | `	ph7_hashmap_node result,*pTail;` |
|         - | 1933 | `    /* Prevent compiler warning */` |
|     33961 | 1934 | `	result.pNext = result.pPrev = 0;` |
|     33961 | 1935 | `	pTail = &result;` |
|    103294 | 1936 | `	while( pA && pB ){` |
|     69338 | 1937 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     45916 | 1938 | `			pTail->pPrev = pA;` |
|     45916 | 1939 | `			pA->pNext = pTail;` |
|     45916 | 1940 | `			pTail = pA;` |
|     45916 | 1941 | `			pA = pA->pPrev;` |
|     22945 | 1942 | `		}else{` |
|     23427 | 1943 | `			pTail->pPrev = pB;` |
|     23427 | 1944 | `			pB->pNext = pTail;` |
|     23427 | 1945 | `			pTail = pB;` |
|     23427 | 1946 | `			pB = pB->pPrev;` |
|         - | 1947 | `		}` |
|         5 | 1948 | `	}` |
|     33961 | 1949 | `	if( pA ){` |
|     23782 | 1950 | `		pTail->pPrev = pA;` |
|     23782 | 1951 | `		pA->pNext = pTail;` |
|     22093 | 1952 | `	}else if( pB ){` |
|      9958 | 1953 | `		pTail->pPrev = pB;` |
|      9958 | 1954 | `		pB->pNext = pTail;` |
|      4961 | 1955 | `	}else{` |
|       231 | 1956 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 1957 | `	}` |
|     33961 | 1958 | `	return result.pPrev;` |
|         5 | 1959 | `}` |
|         - | 1960 | `/*` |
|         - | 1961 | `** Inputs:` |
...
|     14141 | 1979 | `	while( pIn ){` |
|     13439 | 1980 | `		p = pIn;` |
|     13439 | 1981 | `		pIn = p->pPrev;` |
|     13439 | 1982 | `		p->pPrev = 0;` |
|     25633 | 1983 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     25633 | 1984 | `			if( a[i]==0 ){` |
|     13439 | 1985 | `				a[i] = p;` |
|     13439 | 1986 | `				break;` |
|       ! 0 | 1987 | `			}else{` |
|     12199 | 1988 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12199 | 1989 | `				a[i] = 0;` |
|         - | 1990 | `			}` |
|      6102 | 1991 | `		}` |
|     13439 | 1992 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|         - | 2014 | ` */` |
|     69126 | 2015 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2016 | `{` |
|         - | 2017 | `	ph7_value sA,sB;` |
|         - | 2018 | `	sxi32 iFlags;` |
|         - | 2019 | `	int rc;` |
|     69131 | 2020 | `	if( pCmpData == 0 ){` |
|         - | 2021 | `		/* Perform a standard comparison */` |
|     69107 | 2022 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|     69107 | 2023 | `		return rc;` |
|         - | 2024 | `	}` |
...
|         - | 2298 | ` */` |
|        17 | 2299 | `static sxi32 HashmapCmpCallback7(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         1 | 2300 | `{` |
|         - | 2301 | `	sxu32 n;` |
|         8 | 2302 | `	SXUNUSED(pB); /* cc warning */` |
|         8 | 2303 | `	SXUNUSED(pCmpData);` |
|         - | 2304 | `	/* Grab a random number */` |
|        18 | 2305 | `	n = PH7_VmRandomNum(pA->pMap->pVm);` |
...
|         2 | 2333 | `		}` |
|     13269 | 2334 | `		HashmapRehashIntNode(p);` |
|         - | 2335 | `		/* Point to the next entry */` |
|     13269 | 2336 | `		i++;` |
|     13269 | 2337 | `		pLast = p;` |
|     13269 | 2338 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2339 | `	}` |
|       659 | 2340 | `}` |
|         - | 2341 | `/*` |
...
|         - | 4693 | ` */` |
|     32246 | 4694 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4695 | `{` |
|         - | 4696 | `	ph7_value *pNeedle;` |
|         - | 4697 | `	int bStrict;` |
|         - | 4698 | `	int rc;` |
|     32251 | 4699 | `	if( nArg < 2 ){` |
|         - | 4700 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4701 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4702 | `		return PH7_OK;` |
|         - | 4703 | `	}` |
|     32251 | 4704 | `	pNeedle = apArg[0];` |
|     32251 | 4705 | `	bStrict = 0;` |
|     32251 | 4706 | `	if( nArg > 2 ){` |
|        19 | 4707 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|         9 | 4708 | `	}` |
|     32251 | 4709 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     32251 | 4717 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4718 | `	/* Lookup result */` |
|     32251 | 4719 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     32251 | 4720 | `	return PH7_OK;` |
|     16128 | 4721 | `}` |
|         - | 4722 | `/*` |
...
|         - | 8499 | ` */` |
|     32924 | 8500 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     32929 | 8511 | `	rc = SXRET_OK;` |
|     32929 | 8512 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     32929 | 8513 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     32929 | 8514 | `	n = pMap->nEntry;` |
|     32929 | 8515 | `	pEntry = pMap->pFirst;` |
...
|    136751 | 8522 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    136751 | 8523 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8524 | `		/* Invoke the user callback */` |
|    136751 | 8525 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8526 | `		/* Release the copy of the key and the value */` |
|    136751 | 8527 | `		PH7_MemObjRelease(&sKey);` |
|    136751 | 8528 | `		PH7_MemObjRelease(&sValue);` |
|    136751 | 8529 | `		if( rc != PH7_OK ){` |
|         - | 8530 | `			/* Callback request an operation abort */` |
|       ! 0 | 8531 | `			return SXERR_ABORT;` |
|         - | 8532 | `		}` |
|         - | 8533 | `		/* Point to the next entry */` |
|    136751 | 8534 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    136751 | 8535 | `		n--;` |
|         5 | 8536 | `	}` |
|         - | 8537 | `	/* All done */` |
|     32929 | 8538 | `	return SXRET_OK;` |
|     16467 | 8539 | `}` |
|         - | 8540 |  |
