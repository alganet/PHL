...
|         - |   22 | ` */` |
|   7933407 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7933412 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7933412 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    515597 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    515602 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    515602 |   35 | `	sxu32 nH = 5381;` |
|    515602 |   36 | `	zEnd = &zIn[nLen];` |
|    592802 |   37 | `	for(;;){` |
|   1185610 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1012180 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    910799 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    788211 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    515602 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3624426 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3624431 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3624431 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3624431 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3624431 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3624431 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3624431 |  112 | `	pNode->nHash = nHash;` |
|   3624431 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3624431 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3624431 |  115 | `	return pNode;` |
|   1812218 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199629 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199634 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199634 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199634 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199634 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199634 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199634 |  135 | `	pNode->nHash = nHash;` |
|    199634 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199634 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199634 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199634 |  139 | `	return pNode;` |
|     99819 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3824055 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3824060 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3369516 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3369516 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684757 |  150 | `	}` |
|   3824060 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3824060 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87942 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87942 |  156 | `		pMap->pCur = pNode;` |
|     43973 |  157 | `	}else{` |
|   3736123 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3824060 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3824055 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3824060 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93368 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93368 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93368 |  245 | `		if( nNew < 1 ){` |
|     87942 |  246 | `			nNew = 16;` |
...
|     93368 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93368 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93368 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93368 |  260 | `		pMap->apBucket = apNew;` |
|     93368 |  261 | `		pMap->nSize = nNew;` |
|     93368 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87942 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2713 |  288 | `	}` |
|   3736123 |  289 | `	return SXRET_OK;` |
|   1912032 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3624426 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3624431 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3624389 |  310 | `		if( pValue ){` |
|   3624379 |  311 | `			sSafeVal = *pValue;` |
|   3624379 |  312 | `			pValue = &sSafeVal;` |
|   1812187 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3624389 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3624389 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3624389 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3624379 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1812187 |  322 | `		}` |
|   3624389 |  323 | `		nIdx = pObj->nIdx;` |
|   1812197 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3624431 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3624431 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3624431 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3624431 |  334 | `	if( isForeign ){` |
...
|   3624431 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3624431 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3624431 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3624431 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3624431 |  349 | `	return SXRET_OK;` |
|   1812218 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199629 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199634 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    153264 |  370 | `		if( pValue ){` |
|    152954 |  371 | `			sSafeVal = *pValue;` |
|    152954 |  372 | `			pValue = &sSafeVal;` |
|     76474 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    153264 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    153264 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    153264 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152954 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76474 |  382 | `		}` |
|    153264 |  383 | `		nIdx = pObj->nIdx;` |
|     76634 |  384 | `	}else{` |
|     46375 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199634 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199634 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199634 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199634 |  394 | `	if( isForeign ){` |
...
|    199634 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199634 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199634 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199634 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199634 |  409 | `	return SXRET_OK;` |
|     99819 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293085 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293090 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       857 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292238 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292238 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110568144 |  433 | `	for(;;){` |
| 221136266 |  434 | `		if( pNode == 0 ){` |
|   4284864 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851402 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848386 |  438 | `			&& pNode->nHash == nHash` |
| 108426386 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7379 |  441 | `				if( ppNode ){` |
...
| 216844030 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284864 |  450 | `	return SXERR_NOTFOUND;` |
|   2146552 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    344587 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    344592 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28624 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315973 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315973 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256450 |  475 | `	for(;;){` |
|    512905 |  476 | `		if( pNode == 0 ){` |
|    250339 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262566 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261053 |  480 | `			&& pNode->nHash == nHash` |
|    162639 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65743 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65639 |  484 | `				if( ppNode ){` |
|     65611 |  485 | `					*ppNode = pNode;` |
|     32803 |  486 | `				}` |
|     65639 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196937 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250339 |  493 | `	return SXERR_NOTFOUND;` |
|    172298 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    344967 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    344972 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    344972 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    344972 |  504 | `	int isNeg = FALSE, nDigit;` |
|    344972 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    344962 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    344958 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    344958 |  516 | `	zDigit = zIn;` |
|    173115 |  517 | `	for(;;){` |
|    346236 |  518 | `		if( zIn >= zEnd ){` |
|       499 |  519 | `			break;` |
|         - |  520 | `		}` |
|    345738 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    344460 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|      1279 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    152560 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    152565 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    152565 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    145205 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    145205 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    145133 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    145133 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|     76280 |  575 | `result:` |
|    152565 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72217 |  578 | `		if( ppNode ){` |
|     72163 |  579 | `			*ppNode = pNode;` |
|     36079 |  580 | `		}` |
|     72217 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80353 |  584 | `	return SXERR_NOTFOUND;` |
|     76285 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1477770 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1477775 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1477769 |  623 | `	return FALSE;` |
|    738890 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3773719 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3773724 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3773724 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3773724 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153390 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    153390 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       419 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229455 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76483 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152484 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152338 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152338 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1810167 |  683 | `IntKey:` |
|   3620757 |  684 | `	if( pKey ){` |
...
|   1071416 |  714 | `		}` |
|   1071421 |  715 | `	}else{` |
|   1477741 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1477739 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1477733 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1477733 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1477731 |  726 | `			++pMap->iNextIdx;` |
|    738863 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3620565 |  730 | `	return rc;` |
|   1886864 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1500845 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1500850 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1500850 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77583 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77588 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77588 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77588 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77588 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77588 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77588 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77588 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77588 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77588 |  921 | `	return rc;` |
|     38685 |  922 | `}` |
|         - |  923 | `/*` |
...
|    156200 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156200 |  989 | `		if( pVal ){` |
...
|    156200 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156200 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156200 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156200 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156200 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156200 | 1001 | `			if( rc == 0 ){` |
...
|    123464 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123464 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|      4061 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4061 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4061 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4061 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2033 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    704887 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    701221 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    354279 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|     14963 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
...
|         - | 1498 | ` */` |
|    244152 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    244157 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    244157 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    244157 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    241319 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    142106 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    142111 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142111 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    142111 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    142111 | 1700 | `	pMap->pVm = &(*pVm);` |
|    142111 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    142111 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142111 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142111 | 1705 | `	return pMap;` |
|     71058 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     94114 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94119 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94119 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94119 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94119 | 1821 | `	n = 0;` |
|     94119 | 1822 | `	pEntry = pMap->pFirst;` |
|   1904460 | 1823 | `	for(;;){` |
|   3808926 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94119 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3714812 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3714812 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3714812 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3714752 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1857373 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3714812 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109686 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54840 | 1837 | `		}` |
|   3714812 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3714812 | 1840 | `		pEntry = pNext;` |
|   3714812 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94119 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68248 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34121 | 1846 | `	}` |
|     94119 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94093 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47049 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    875110 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    875115 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    875115 | 1869 | `	pMap->iRef--;` |
|    875115 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94073 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47034 | 1872 | `	}` |
|    875115 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152810 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3072173 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3072178 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3072178 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 2019 | ` */` |
|    596722 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    596727 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    596727 | 2023 | `	if( pEntry ){` |
|    596727 | 2024 | `		if( bStore ){` |
|    217723 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    108864 | 2026 | `		}else{` |
|    379009 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    298143 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    165024 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    165029 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    158951 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    158951 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    158951 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79478 | 2045 | `	}else{` |
...
|    157617 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157617 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    157617 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    157617 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    157617 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    157617 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    157615 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157615 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
