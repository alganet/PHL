...
|         - |  706 | `			}` |
|       256 |  707 | `			return PH7_VmInstallGlobalVar(pMap->pVm,` |
|       168 |  708 | `				(const char *)SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),` |
...
|       939 | 1554 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1555 | `		/* Extract the node value (resolves foreign references) */` |
|       927 | 1556 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|       926 | 1557 | `		if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP)` |
|       597 | 1558 | `		 && (ph7_hashmap *)pVal->x.pOther == pSrc->pVm->pGlobal ){` |
...
|         2 | 1565 | `		}` |
|       927 | 1566 | `		if( pVal ){` |
|       923 | 1567 | `			if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|      1378 | 1568 | `				rc = HashmapInsertBlobKey(&(*pDest),SyBlobData(&pEntry->xKey.sKey),` |
|       459 | 1569 | `					SyBlobLength(&pEntry->xKey.sKey),pVal,0,FALSE);` |
|       460 | 1570 | `			}else{` |
|         5 | 1571 | `				rc = HashmapInsertIntKey(&(*pDest),pEntry->xKey.iKey,pVal,0,FALSE);` |
|         - | 1572 | `			}` |
|       923 | 1573 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1574 | `				return rc;` |
|         - | 1575 | `			}` |
|       461 | 1576 | `		}` |
|         - | 1577 | `		/* Point to the next entry */` |
|       927 | 1578 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|       464 | 1579 | `	}` |
...
|        19 | 1763 | `					pObj = HashmapExtractNodeValue(pEntry);` |
|        19 | 1764 | `					if( pObj ){` |
|        19 | 1765 | `						ph7_value sSafeVal = *pObj;` |
|         - | 1766 | `						/* Perform the insertion */` |
|        19 | 1767 | `						rc = HashmapInsertBlobKey(&(*pLeft),SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey),` |
|         - | 1768 | `							&sSafeVal,0,FALSE);` |
|        19 | 1769 | `						if( rc != SXRET_OK ){` |
|       ! 0 | 1770 | `							return rc;` |
|         - | 1771 | `						}` |
|         8 | 1772 | `					}` |
|         8 | 1773 | `			}` |
...
|         - | 2027 | ` * as opposed to the zend_symtable_update() every array subscript goes through, so` |
|         - | 2028 | ` * a numeric-looking NAME is kept as a string key instead of folding to the integer` |
|         - | 2029 | ` * one. php reaches for this where a name comes from OUTSIDE the language — the` |
...
|         - | 2057 | ` *   - Integer keys are renumbered with the destination's auto-index.` |
|         - | 2058 | ` * This is the same routine that backs array_merge().` |
|         - | 2059 | ` */` |
|       662 | 2060 | `PH7_PRIVATE sxi32 PH7_HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         2 | 2061 | `{` |
|       664 | 2062 | `	return HashmapMerge(&(*pSrc),&(*pDest));` |
|         2 | 2063 | `}` |
|         - | 2064 | `/*` |
|         - | 2065 | ` * Insert a given key and it's associated value (foreign index) in the given` |
|         - | 2066 | ` * hashmap.` |
|         - | 2067 | ` * This is insertion by reference so be careful to mark the node` |
|         - | 2068 | ` * with the HASHMAP_NODE_FOREIGN_OBJ flag being set.` |
|         - | 2069 | ` * The insertion by reference is triggered when the following` |
|         - | 2070 | ` * expression is encountered.` |
|         - | 2071 | ` * $var = 10;` |
|         - | 2072 | ` *  $a = array(&var);` |
|         - | 2073 | ` * OR` |
|         - | 2074 | ` *  $a[] =& $var;` |
|         - | 2075 | ` * That is,$var is a foreign ph7_value and the $a array have no control` |
|         - | 2076 | ` * over it's contents.` |
|         - | 2077 | ` * Note that the node that hold the foreign ph7_value is automatically` |
|         - | 2078 | ` * removed when the foreign ph7_value is unset.` |
|         - | 2079 | ` * Example:` |
|         - | 2080 | ` *  $var = 10;` |
|         - | 2081 | ` *  $a[] =& $var;` |
|         - | 2082 | ` *  echo count($a).PHP_EOL; //1` |
|         - | 2083 | ` *  //Unset the foreign ph7_value now` |
|         - | 2084 | ` *  unset($var);` |
|         - | 2085 | ` *  echo count($a); //0` |
|         - | 2086 | ` * Note that this is a PH7 eXtension.` |
|         - | 2087 | ` * Refer to the official documentation for more information.` |
...
|         - | 2111 | ` * nested loops over the same array never disturb each other. The map keeps` |
|         - | 2112 | ` * the list of active steps so PH7_HashmapUnlinkNode can advance any cursor` |
...
|         - | 2194 | ` * Refer to the [vfprintf(),vprintf(),vsprintf()] implementations` |
|         - | 2195 | ` * defined in 'builtin.c' for more information.` |
|         - | 2196 | ` */` |
|        26 | 2197 | `PH7_PRIVATE int PH7_HashmapValuesToSet(ph7_hashmap *pMap,SySet *pOut)` |
|         2 | 2198 | `{` |
|        28 | 2199 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 2200 | `	ph7_value *pValue;` |
|         - | 2201 | `	sxu32 n;` |
|         - | 2202 | `	/* Initialize the container */` |
|        28 | 2203 | `	SySetInit(pOut,&pMap->pVm->sAllocator,sizeof(ph7_value *));` |
|        78 | 2204 | `	for(n = 0 ; n < pMap->nEntry ; n++ ){` |
|         - | 2205 | `		/* Extract node value */` |
|        52 | 2206 | `		pValue = HashmapExtractNodeValue(pEntry);` |
|        52 | 2207 | `		if( pValue ){` |
|        52 | 2208 | `			SySetPut(pOut,(const void *)&pValue);` |
|        25 | 2209 | `		}` |
|         - | 2210 | `		/* Point to the next entry */` |
|        52 | 2211 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|        27 | 2212 | `	}` |
|         - | 2213 | `	/* Total inserted entries */` |
|        28 | 2214 | `	return (int)SySetUsed(pOut);` |
|         2 | 2215 | `}` |
|         - | 2216 | `#endif /* PH7_DISABLE_BUILTIN_FUNC \|\| PH7_DISABLE_DISK_IO */` |
|         - | 2217 | `/*` |
|         - | 2218 | ` * Table of hashmap functions.` |
|         - | 2219 | ` */` |
|         - | 2220 | `static const ph7_builtin_func aHashmapFunc[] = {` |
|         - | 2221 | `	{"iterator_to_array",  ph7_iterator_to_array },` |
|         - | 2222 | `	{"iterator_count",     ph7_iterator_count },` |
|         - | 2223 | `	{"iterator_apply",     ph7_iterator_apply },` |
|         - | 2224 | `	{"count",             ph7_hashmap_count },` |
|         - | 2225 | `	{"sizeof",            ph7_hashmap_count },` |
|         - | 2226 | `	{"array_key_exists",  ph7_hashmap_key_exists },` |
|         - | 2227 | `	{"key_exists",        ph7_hashmap_key_exists },` |
|         - | 2228 | `	{"array_pop",         ph7_hashmap_pop     },` |
|         - | 2229 | `	{"array_push",        ph7_hashmap_push    },` |
|         - | 2230 | `	{"array_shift",       ph7_hashmap_shift   },` |
|         - | 2231 | `	{"array_unshift",     ph7_hashmap_unshift },` |
|         - | 2232 | `	{"array_product",     ph7_hashmap_product },` |
|         - | 2233 | `	{"array_sum",         ph7_hashmap_sum     },` |
|         - | 2234 | `	{"max",               ph7_hashmap_max     },` |
|         - | 2235 | `	{"min",               ph7_hashmap_min     },` |
|         - | 2236 | `	{"array_keys",        ph7_hashmap_keys    },` |
|         - | 2237 | `	{"array_values",      ph7_hashmap_values  },` |
|         - | 2238 | `	{"array_same",        ph7_hashmap_same    },  /* Symisc eXtension */` |
|         - | 2239 | `	{"array_merge",       ph7_hashmap_merge   },` |
|         - | 2240 | `	{"array_merge_recursive", ph7_hashmap_merge_recursive },` |
|         - | 2241 | `	{"array_slice",       ph7_hashmap_slice   },` |
|         - | 2242 | `	{"array_splice",      ph7_hashmap_splice  },` |
|         - | 2243 | `	{"array_search",      ph7_hashmap_search  },` |
|         - | 2244 | `	{"array_diff",        ph7_hashmap_diff    },` |
|         - | 2245 | `	{"array_udiff",       ph7_hashmap_udiff   },` |
|         - | 2246 | `	{"array_udiff_assoc", ph7_hashmap_udiff_assoc },` |
|         - | 2247 | `	{"array_udiff_uassoc",ph7_hashmap_udiff_uassoc },` |
|         - | 2248 | `	{"array_diff_assoc",  ph7_hashmap_diff_assoc },` |
|         - | 2249 | `	{"array_diff_uassoc", ph7_hashmap_diff_uassoc },` |
|         - | 2250 | `	{"array_diff_key",    ph7_hashmap_diff_key },` |
|         - | 2251 | `	{"array_diff_ukey",   ph7_hashmap_diff_ukey },` |
|         - | 2252 | `	{"array_intersect",   ph7_hashmap_intersect},` |
|         - | 2253 | `	{"array_intersect_assoc", ph7_hashmap_intersect_assoc},` |
|         - | 2254 | `	{"array_intersect_uassoc", ph7_hashmap_intersect_uassoc},` |
|         - | 2255 | `	{"array_uintersect",  ph7_hashmap_uintersect},` |
|         - | 2256 | `	{"array_uintersect_assoc", ph7_hashmap_uintersect_assoc},` |
|         - | 2257 | `	{"array_uintersect_uassoc", ph7_hashmap_uintersect_uassoc},` |
|         - | 2258 | `	{"array_intersect_key",   ph7_hashmap_intersect_key},` |
|         - | 2259 | `	{"array_multisort",   ph7_hashmap_multisort },` |
|         - | 2260 | `	{"array_intersect_ukey",  ph7_hashmap_intersect_ukey},` |
|         - | 2261 | `	{"array_copy",        ph7_hashmap_copy    },` |
|         - | 2262 | `	{"array_erase",       ph7_hashmap_erase   },` |
|         - | 2263 | `	{"array_fill",        ph7_hashmap_fill    },` |
|         - | 2264 | `	{"array_fill_keys",   ph7_hashmap_fill_keys},` |
|         - | 2265 | `	{"array_combine",     ph7_hashmap_combine },` |
|         - | 2266 | `	{"array_reverse",     ph7_hashmap_reverse },` |
|         - | 2267 | `	{"array_unique",      ph7_hashmap_unique  },` |
|         - | 2268 | `	{"array_flip",        ph7_hashmap_flip    },` |
|         - | 2269 | `	{"array_rand",        ph7_hashmap_rand    },` |
|         - | 2270 | `	{"array_chunk",       ph7_hashmap_chunk   },` |
|         - | 2271 | `	{"array_pad",         ph7_hashmap_pad     },` |
|         - | 2272 | `	{"array_replace",     ph7_hashmap_replace },` |
|         - | 2273 | `	{"array_filter",      ph7_hashmap_filter  },` |
|         - | 2274 | `	{"array_map",         ph7_hashmap_map     },` |
|         - | 2275 | `	{"array_column",      ph7_hashmap_column  },` |
|         - | 2276 | `	{"array_is_list",     ph7_hashmap_is_list },` |
|         - | 2277 | `	{"array_first",       ph7_hashmap_first   },` |
|         - | 2278 | `	{"array_last",        ph7_hashmap_last    },` |
|         - | 2279 | `	{"array_key_first",   ph7_hashmap_key_first },` |
|         - | 2280 | `	{"array_key_last",    ph7_hashmap_key_last  },` |
|         - | 2281 | `	{"array_find",        ph7_hashmap_find    },` |
|         - | 2282 | `	{"array_find_key",    ph7_hashmap_find_key},` |
|         - | 2283 | `	{"array_any",         ph7_hashmap_any     },` |
|         - | 2284 | `	{"array_all",         ph7_hashmap_all     },` |
|         - | 2285 | `	{"array_reduce",      ph7_hashmap_reduce  },` |
|         - | 2286 | `	{"array_walk",        ph7_hashmap_walk    },` |
|         - | 2287 | `	{"array_walk_recursive", ph7_hashmap_walk_recursive },` |
|         - | 2288 | `	{"in_array",          ph7_hashmap_in_array},` |
|         - | 2289 | `	{"sort",              ph7_hashmap_sort    },` |
|         - | 2290 | `	{"asort",             ph7_hashmap_asort   },` |
|         - | 2291 | `	{"natsort",           ph7_hashmap_natsort },` |
|         - | 2292 | `	{"natcasesort",       ph7_hashmap_natsort },` |
|         - | 2293 | `	{"arsort",            ph7_hashmap_arsort  },` |
|         - | 2294 | `	{"ksort",             ph7_hashmap_ksort   },` |
|         - | 2295 | `	{"krsort",            ph7_hashmap_krsort  },` |
|         - | 2296 | `	{"rsort",             ph7_hashmap_rsort   },` |
|         - | 2297 | `	{"usort",             ph7_hashmap_usort   },` |
|         - | 2298 | `	{"uasort",            ph7_hashmap_uasort  },` |
|         - | 2299 | `	{"uksort",            ph7_hashmap_uksort  },` |
|         - | 2300 | `	{"shuffle",           ph7_hashmap_shuffle },` |
|         - | 2301 | `	{"range",             ph7_hashmap_range   },` |
|         - | 2302 | `	{"current",           ph7_hashmap_current },` |
|         - | 2303 | `	{"each",              ph7_hashmap_each    },` |
|         - | 2304 | `	{"pos",               ph7_hashmap_current },` |
|         - | 2305 | `	{"next",              ph7_hashmap_next    },` |
|         - | 2306 | `	{"prev",              ph7_hashmap_prev    },` |
|         - | 2307 | `	{"end",               ph7_hashmap_end     },` |
|         - | 2308 | `	{"reset",             ph7_hashmap_reset   },` |
|         - | 2309 | `	{"key",               ph7_hashmap_simple_key }` |
|         - | 2310 | `};` |
|         - | 2311 | `/*` |
...
|         - | 2324 | ` * This function is typically invoked when the user issue a call to` |
|         - | 2325 | ` * [var_dump(),var_export(),print_r(),...]` |
|         - | 2326 | ` * This function SXRET_OK on success. Any other return value including` |
|         - | 2327 | ` * SXERR_LIMIT(infinite recursion) indicates failure.` |
|         - | 2328 | ` */` |
|         - | 2329 | `/*` |
|         - | 2330 | ` * Dump the entries of a hashmap [i.e: the key/value lines between the opening` |
|         - | 2331 | ` * '{' and the closing '}'] in the var_dump/print_r style. Factored out of` |
|         - | 2332 | ` * PH7_HashmapDump so the var_dump object renderer can reuse it for a` |
|         - | 2333 | ` * __debugInfo() array body (which carries an object header, not "array(N)").` |
|         - | 2334 | ` * Returns SXERR_LIMIT if a nested value hit the depth cap.` |
|         - | 2335 | ` *` |
|         - | 2336 | ` * bProp says the entries are an object's PROPERTIES: php then reads each key` |
|         - | 2337 | ``  * through zend_unmangle_property_name, so "\0C\0p" prints as `["p":"C":private]` `` |
|         - | 2338 | `` * and "\0*\0p" as `["p":protected]`. That is how a get_debug_info handler (and a`` |
...
|        23 | 2372 | `						if( sCls.zString[0] == '*' ){` |
|         3 | 2373 | `							SyBlobAppend(&(*pOut),":protected",sizeof(":protected")-1);` |
|         2 | 2374 | `						}else{` |
|        21 | 2375 | `							SyBlobFormat(&(*pOut),":\"%z\":private",&sCls);` |
|         - | 2376 | `						}` |
|        11 | 2377 | `					}` |
...
|        11 | 2406 | `						if( sCls.zString[0] == '*' ){` |
|         3 | 2407 | `							SyBlobAppend(&(*pOut),":protected",sizeof(":protected")-1);` |
|         2 | 2408 | `						}else{` |
|         9 | 2409 | `							SyBlobFormat(&(*pOut),":%z:private",&sCls);` |
|         - | 2410 | `						}` |
|         5 | 2411 | `					}` |
...
|         - | 2476 | ` * Note that argument are passed to the callback by copy. That is,any modification to` |
|         - | 2477 | ` * the entry value in the callback body will not alter the real value.` |
|         - | 2478 | ` * If the callback wishes to abort processing [i.e: it's invocation] it must return` |
...
|         - | 2486 | `	)` |
|         5 | 2487 | `{` |
|         - | 2488 | `	ph7_hashmap_node *pEntry;` |
|         - | 2489 | `	ph7_value sKey,sValue;` |
|         - | 2490 | `	sxi32 rc;` |
|         - | 2491 | `	sxu32 n;` |
