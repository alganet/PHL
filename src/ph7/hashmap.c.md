...
|         - |   22 | ` */` |
|   7930543 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7930548 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7930548 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    514421 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    514426 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    514426 |   35 | `	sxu32 nH = 5381;` |
|    514426 |   36 | `	zEnd = &zIn[nLen];` |
|    591468 |   37 | `	for(;;){` |
|   1182942 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1010192 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    909179 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    786661 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    514426 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3621684 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3621689 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3621689 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3621689 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3621689 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3621689 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3621689 |  112 | `	pNode->nHash = nHash;` |
|   3621689 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3621689 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3621689 |  115 | `	return pNode;` |
|   1810847 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199287 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199292 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199292 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199292 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199292 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199292 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199292 |  135 | `	pNode->nHash = nHash;` |
|    199292 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199292 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199292 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199292 |  139 | `	return pNode;` |
|     99648 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3820971 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3820976 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3368575 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3368575 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684287 |  150 | `	}` |
|   3820976 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3820976 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87564 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87564 |  156 | `		pMap->pCur = pNode;` |
|     43784 |  157 | `	}else{` |
|   3733417 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3820976 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3820971 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3820976 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93000 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93000 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93000 |  245 | `		if( nNew < 1 ){` |
|     87564 |  246 | `			nNew = 16;` |
...
|     93000 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93000 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93000 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93000 |  260 | `		pMap->apBucket = apNew;` |
|     93000 |  261 | `		pMap->nSize = nNew;` |
|     93000 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87564 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2718 |  288 | `	}` |
|   3733417 |  289 | `	return SXRET_OK;` |
|   1910490 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3621684 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3621689 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3621647 |  310 | `		if( pValue ){` |
|   3621637 |  311 | `			sSafeVal = *pValue;` |
|   3621637 |  312 | `			pValue = &sSafeVal;` |
|   1810816 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3621647 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3621647 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3621647 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3621637 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1810816 |  322 | `		}` |
|   3621647 |  323 | `		nIdx = pObj->nIdx;` |
|   1810826 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3621689 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3621689 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3621689 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3621689 |  334 | `	if( isForeign ){` |
...
|   3621689 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3621689 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3621689 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3621689 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3621689 |  349 | `	return SXRET_OK;` |
|   1810847 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199287 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199292 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    152896 |  370 | `		if( pValue ){` |
|    152586 |  371 | `			sSafeVal = *pValue;` |
|    152586 |  372 | `			pValue = &sSafeVal;` |
|     76290 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    152896 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    152896 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    152896 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152586 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76290 |  382 | `		}` |
|    152896 |  383 | `		nIdx = pObj->nIdx;` |
|     76450 |  384 | `	}else{` |
|     46401 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199292 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199292 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199292 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199292 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46401 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23198 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199292 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199292 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199292 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199292 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199292 |  409 | `	return SXRET_OK;` |
|     99648 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293011 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284830 |  450 | `	return SXERR_NOTFOUND;` |
|   2146512 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    343615 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    343620 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28486 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315139 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315139 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255760 |  475 | `	for(;;){` |
|    511525 |  476 | `		if( pNode == 0 ){` |
|    249415 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262110 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260597 |  480 | `			&& pNode->nHash == nHash` |
|    162455 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65831 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65729 |  484 | `				if( ppNode ){` |
|     65701 |  485 | `					*ppNode = pNode;` |
|     32848 |  486 | `				}` |
|     65729 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196391 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    249415 |  493 | `	return SXERR_NOTFOUND;` |
|    171812 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    343795 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    343800 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    343800 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    343800 |  504 | `	int isNeg = FALSE, nDigit;` |
|    343800 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    343790 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    343786 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    343786 |  516 | `	zDigit = zIn;` |
|    172339 |  517 | `	for(;;){` |
|    344684 |  518 | `		if( zIn >= zEnd ){` |
|       299 |  519 | `			break;` |
|         - |  520 | `		}` |
|    344386 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    343488 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       899 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    151846 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    151851 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    151851 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    144525 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    144525 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    144453 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    144453 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|     75923 |  575 | `result:` |
|    151851 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72273 |  578 | `		if( ppNode ){` |
|     72225 |  579 | `			*ppNode = pNode;` |
|     36110 |  580 | `		}` |
|     72273 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79583 |  584 | `	return SXERR_NOTFOUND;` |
|     75928 |  585 | `}` |
|         - |  586 | `/*` |
...
|   2141646 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141646 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070822 |  609 | `	}` |
|   1071416 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1475038 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1475043 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1475037 |  623 | `	return FALSE;` |
|    737524 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3770653 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3770658 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3770658 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3770658 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    152872 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    152872 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       219 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    228978 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76324 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152166 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152030 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152030 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1808893 |  683 | `IntKey:` |
|   3618009 |  684 | `	if( pKey ){` |
...
|   1071408 |  714 | `		}` |
|   1071413 |  715 | `	}else{` |
|   1475009 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1475007 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1475001 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1475001 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1474999 |  726 | `			++pMap->iNextIdx;` |
|    737497 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3617817 |  730 | `	return rc;` |
|   1885331 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46448 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46453 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46453 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46453 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46413 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46413 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69614 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23203 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46401 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46401 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1516683 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1516688 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1516688 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77345 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77350 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77350 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77350 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77350 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77350 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77350 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77350 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77350 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77350 |  921 | `	return rc;` |
|     38567 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16694 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16699 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16699 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11753 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5770 |  934 | `	}else{` |
|      4951 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16699 |  937 | `	if( pEntry->pNextCollide ){` |
|      1091 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       554 |  939 | `	}` |
|     16699 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16699 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16699 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16699 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16699 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16699 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12073 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5933 |  949 | `	}` |
|     16699 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16699 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16699 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16699 |  956 | `		pMap->iNextIdx++;` |
|      8347 |  957 | `	}` |
|     16699 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     32768 |  966 | `PH7_PRIVATE int HashmapFindValue(` |
...
|     32773 |  979 | `	pEntry = pMap->pFirst;` |
|     32773 |  980 | `	n = pMap->nEntry;` |
|     32773 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32773 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78073 |  983 | `	for(;;){` |
|    156148 |  984 | `		if( n < 1 ){` |
|        83 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    156066 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156066 |  989 | `		if( pVal ){` |
...
|    156066 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156066 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156066 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156066 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156066 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156066 | 1001 | `			if( rc == 0 ){` |
|     32691 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     32691 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     61689 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    123380 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123380 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    708946 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    708946 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    708948 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    708943 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    708943 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2026 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    704901 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    701229 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    354289 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    704195 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    701289 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    701289 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    701289 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    350647 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    701289 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    701289 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    350647 | 1341 | `	}` |
...
|         - | 1392 | ` */` |
|      7334 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7339 | 1399 | `	if( pSrc == pDest ){` |
...
|      7339 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14957 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7623 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7623 | 1411 | `		if( pVal ){` |
|      7623 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3814 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7623 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7623 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3814 | 1421 | `	}` |
|      7339 | 1422 | `	return SXRET_OK;` |
|      3672 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    242928 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    242933 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    242933 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    242933 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    240105 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    141578 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141583 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141583 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    141583 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    141583 | 1700 | `	pMap->pVm = &(*pVm);` |
|    141583 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    141583 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141583 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141583 | 1705 | `	return pMap;` |
|     70794 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     93532 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     93537 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     93537 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     93537 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     93537 | 1821 | `	n = 0;` |
|     93537 | 1822 | `	pEntry = pMap->pFirst;` |
|   1902600 | 1823 | `	for(;;){` |
|   3805206 | 1824 | `		if( n >= pMap->nEntry ){` |
|     93537 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3711674 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3711674 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3711674 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3711614 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1855804 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3711674 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109314 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54654 | 1837 | `		}` |
|   3711674 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3711674 | 1840 | `		pEntry = pNext;` |
|   3711674 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     93537 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     67862 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33928 | 1846 | `	}` |
|     93537 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     93511 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     46758 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    869328 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    869333 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    869333 | 1869 | `	pMap->iRef--;` |
|    869333 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     93491 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     46743 | 1872 | `	}` |
|    869333 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152096 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3069099 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3069104 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3069104 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46438 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46443 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46443 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46443 | 1966 | `	return rc;` |
|     23224 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23150 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23155 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23155 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23155 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23155 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     22974 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     22979 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     22979 | 1991 | `	while( *ppLink ){` |
|     22979 | 1992 | `		if( *ppLink == pStep ){` |
|     22979 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     22979 | 1994 | `			pStep->pNextActive = 0;` |
|     22979 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    612760 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    612765 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    612765 | 2023 | `	if( pEntry ){` |
|    612765 | 2024 | `		if( bStore ){` |
|    235443 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    117724 | 2026 | `		}else{` |
|    377327 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    306164 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    163680 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    163685 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    157727 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    157727 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    157727 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     78866 | 2045 | `	}else{` |
...
|         - | 2158 | ` */` |
|      3414 | 2159 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 2160 | `{` |
|         - | 2161 | `	sxu32 n;` |
|    256055 | 2162 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    252641 | 2163 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    126323 | 2164 | `	}` |
|      3419 | 2165 | `}` |
|         - | 2166 | `/*` |
...
|         - | 2188 | `	int i;` |
|       213 | 2189 | `	for(;;){` |
|       428 | 2190 | `		if( n >= pMap->nEntry ){` |
|       136 | 2191 | `			break;` |
|         - | 2192 | `		}` |
|       294 | 2193 | `		pObj = HashmapExtractNodeValue(pEntry);` |
...
|       584 | 2196 | `		isRef = ((pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0)` |
|       292 | 2197 | `			\|\| PH7_VmSlotIsReferenced(pMap->pVm,pEntry->nValIdx);` |
|       294 | 2198 | `		if( ShowType ){` |
|         - | 2199 | ``			/* var_dump entry: `[key]=>` on its own line at nTab+2, the value`` |
|         - | 2200 | `			 * on the next line at the same indent (php). */` |
|       194 | 2201 | `			for( i = 0 ; i < nTab + 2 ; i++ ){` |
|       130 | 2202 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        66 | 2203 | `			}` |
|        66 | 2204 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|        53 | 2205 | `				SyBlobFormat(&(*pOut),"[%qd]=>",pEntry->xKey.iKey);` |
|        27 | 2206 | `			}else{` |
|        20 | 2207 | `				SyBlobFormat(&(*pOut),"[\"%.*s\"]=>",` |
|         6 | 2208 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 2209 | `			}` |
|        66 | 2210 | `			SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        66 | 2211 | `			if( pObj ){` |
|        66 | 2212 | `				rc = PH7_MemObjDump(&(*pOut),pObj,TRUE,nTab+2,nDepth,isRef);` |
|        66 | 2213 | `				if( rc == SXERR_LIMIT ){` |
|       ! 0 | 2214 | `					break;` |
|         - | 2215 | `				}` |
|        32 | 2216 | `			}` |
|        34 | 2217 | `		}else{` |
...
|       294 | 2245 | `		n++;` |
|       294 | 2246 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         2 | 2247 | `	}` |
|       136 | 2248 | `	return rc;` |
|         2 | 2249 | `}` |
...
|         - | 2293 | ` */` |
|     33888 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33893 | 2305 | `	rc = SXRET_OK;` |
|     33893 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33893 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33893 | 2308 | `	n = pMap->nEntry;` |
|     33893 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    156401 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    156401 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    156401 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    156401 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    156401 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    156401 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    156399 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    156399 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     33891 | 2332 | `	return SXRET_OK;` |
|     16949 | 2333 | `}` |
|         - | 2334 |  |
