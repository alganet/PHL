...
|         - |   22 | ` */` |
|   7944032 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7944037 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7944037 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    509966 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    509971 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    509971 |   35 | `	sxu32 nH = 5381;` |
|    509971 |   36 | `	zEnd = &zIn[nLen];` |
|    585344 |   37 | `	for(;;){` |
|   1170693 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1001367 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    902243 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    779263 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    509971 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3638660 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3638665 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3638665 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3638665 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3638665 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3638665 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3638665 |  112 | `	pNode->nHash = nHash;` |
|   3638665 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3638665 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3638665 |  115 | `	return pNode;` |
|   1819335 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    195116 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    195121 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    195121 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    195121 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    195121 |  133 | `	pNode->pMap  = &(*pMap);` |
|    195121 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    195121 |  135 | `	pNode->nHash = nHash;` |
|    195121 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    195121 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    195121 |  138 | `	pNode->nValIdx = nValIdx;` |
|    195121 |  139 | `	return pNode;` |
|     97563 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3833776 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3833781 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3383923 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3383923 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1691959 |  150 | `	}` |
|   3833781 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3833781 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87137 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87137 |  156 | `		pMap->pCur = pNode;` |
|     43571 |  157 | `	}else{` |
|   3746649 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3833781 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3833776 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3833781 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92609 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92609 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92609 |  245 | `		if( nNew < 1 ){` |
|     87137 |  246 | `			nNew = 16;` |
...
|     92609 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92609 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92609 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92609 |  260 | `		pMap->apBucket = apNew;` |
|     92609 |  261 | `		pMap->nSize = nNew;` |
|     92609 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87137 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2736 |  288 | `	}` |
|   3746649 |  289 | `	return SXRET_OK;` |
|   1916893 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3638660 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3638665 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3638623 |  310 | `		if( pValue ){` |
|   3638617 |  311 | `			sSafeVal = *pValue;` |
|   3638617 |  312 | `			pValue = &sSafeVal;` |
|   1819306 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3638623 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3638623 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3638623 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3638617 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1819306 |  322 | `		}` |
|   3638623 |  323 | `		nIdx = pObj->nIdx;` |
|   1819314 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3638665 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3638665 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3638665 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3638665 |  334 | `	if( isForeign ){` |
...
|   3638665 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3638665 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3638665 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3638665 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3638665 |  349 | `	return SXRET_OK;` |
|   1819335 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    195116 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    195121 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    148989 |  370 | `		if( pValue ){` |
|    148679 |  371 | `			sSafeVal = *pValue;` |
|    148679 |  372 | `			pValue = &sSafeVal;` |
|     74337 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    148989 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    148989 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    148989 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    148679 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     74337 |  382 | `		}` |
|    148989 |  383 | `		nIdx = pObj->nIdx;` |
|     74497 |  384 | `	}else{` |
|     46137 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    195121 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    195121 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    195121 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    195121 |  394 | `	if( isForeign ){` |
...
|    195121 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    195121 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    195121 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    195121 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    195121 |  409 | `	return SXRET_OK;` |
|     97563 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    342248 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    342253 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     27403 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    314855 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    314855 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255465 |  475 | `	for(;;){` |
|    510935 |  476 | `		if( pNode == 0 ){` |
|    247579 |  477 | `			break;` |
|         - |  478 | `		}` |
|    263356 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261841 |  480 | `			&& pNode->nHash == nHash` |
|    163852 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     67383 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67281 |  484 | `				if( ppNode ){` |
|     67253 |  485 | `					*ppNode = pNode;` |
|     33624 |  486 | `				}` |
|     67281 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196085 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    247579 |  493 | `	return SXERR_NOTFOUND;` |
|    171129 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    342382 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    342387 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    342387 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    342387 |  504 | `	int isNeg = FALSE, nDigit;` |
|    342387 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    342365 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    342361 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    342361 |  516 | `	zDigit = zIn;` |
|    171614 |  517 | `	for(;;){` |
|    343233 |  518 | `		if( zIn >= zEnd ){` |
|       253 |  519 | `			break;` |
|         - |  520 | `		}` |
|    342981 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    342109 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       873 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    153686 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    153691 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    153691 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    147277 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    147277 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    147261 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    147261 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         8 |  567 | `	}` |
...
|     76843 |  575 | `result:` |
|    153691 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72927 |  578 | `		if( ppNode ){` |
|     72875 |  579 | `			*ppNode = pNode;` |
|     36435 |  580 | `		}` |
|     72927 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80769 |  584 | `	return SXERR_NOTFOUND;` |
|     76848 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1492246 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1492251 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1492245 |  623 | `	return FALSE;` |
|    746128 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3783780 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3783785 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3783785 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3783785 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    148971 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    148971 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    223112 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     74369 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    148257 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    148123 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    148123 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1817407 |  683 | `IntKey:` |
|   3635047 |  684 | `	if( pKey ){` |
...
|   1071317 |  714 | `		}` |
|   1071322 |  715 | `	}else{` |
|   1492217 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1492215 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1492209 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1492209 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1492207 |  726 | `			++pMap->iNextIdx;` |
|    746101 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3634843 |  730 | `	return rc;` |
|   1891895 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1528354 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1528359 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1528359 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     73352 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     73357 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     73357 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     73357 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     73357 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     73357 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     73357 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     73357 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     73357 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     73357 |  921 | `	return rc;` |
|     36682 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14348 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14353 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14353 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11585 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5802 |  934 | `	}else{` |
|      2773 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14353 |  937 | `	if( pEntry->pNextCollide ){` |
|      1034 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       535 |  939 | `	}` |
|     14353 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14353 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14353 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14353 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14353 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14353 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11916 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5971 |  949 | `	}` |
|     14353 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14353 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14353 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14353 |  956 | `		pMap->iNextIdx++;` |
|      7174 |  957 | `	}` |
|     14353 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33602 |  966 | `static int HashmapFindValue(` |
...
|     33607 |  979 | `	pEntry = pMap->pFirst;` |
|     33607 |  980 | `	n = pMap->nEntry;` |
|     33607 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33607 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80201 |  983 | `	for(;;){` |
|    160407 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    160329 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    160329 |  989 | `		if( pVal ){` |
...
|    160329 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    160329 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    160329 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    160329 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    160329 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    160329 | 1001 | `			if( rc == 0 ){` |
|     33529 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33529 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63400 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    126805 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    126805 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    721618 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    721618 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    721620 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    721615 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    721615 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2004 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    717617 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    713995 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    360622 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    716953 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    714055 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    714055 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    714055 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    357030 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    714055 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    714055 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    357030 | 1305 | `	}` |
...
|         - | 1462 | ` */` |
|    243186 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    243191 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    243191 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    243191 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    240415 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|         - | 1648 | ` */` |
|    141568 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141573 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141573 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    141573 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    141573 | 1664 | `	pMap->pVm = &(*pVm);` |
|    141573 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    141573 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141573 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141573 | 1669 | `	return pMap;` |
|     70789 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|     94508 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94513 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|     94513 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|     94513 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|     94513 | 1785 | `	n = 0;` |
|     94513 | 1786 | `	pEntry = pMap->pFirst;` |
|   1910625 | 1787 | `	for(;;){` |
|   3821255 | 1788 | `		if( n >= pMap->nEntry ){` |
|     94513 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3726747 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3726747 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3726747 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3726687 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1863341 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3726747 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    107053 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     53524 | 1801 | `		}` |
|   3726747 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3726747 | 1804 | `		pEntry = pNext;` |
|   3726747 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|     94513 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     68043 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34019 | 1810 | `	}` |
|     94513 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|     94487 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47246 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    873054 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    873059 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    873059 | 1833 | `	pMap->iRef--;` |
|    873059 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94467 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47231 | 1836 | `	}` |
|    873059 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    153880 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   3069456 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3069461 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3069461 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     23246 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     23251 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     23251 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23251 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     23251 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     23078 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     23083 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23083 | 1955 | `	while( *ppLink ){` |
|     23083 | 1956 | `		if( *ppLink == pStep ){` |
|     23083 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     23083 | 1958 | `			pStep->pNextActive = 0;` |
|     23083 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    607774 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    607779 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    607779 | 1987 | `	if( pEntry ){` |
|    607779 | 1988 | `		if( bStore ){` |
|    236607 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    118306 | 1990 | `		}else{` |
|    371177 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    303894 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    164920 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    164925 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    159243 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    159243 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    159243 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79624 | 2009 | `	}else{` |
...
|         - | 2063 | `**   changed.` |
|         - | 2064 | `*/` |
|     37320 | 2065 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2066 | `{` |
|         - | 2067 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2068 | `    /* Prevent compiler warning */` |
|     37325 | 2069 | `	result.pNext = result.pPrev = 0;` |
|     37325 | 2070 | `	pTail = &result;` |
|    110932 | 2071 | `	while( pA && pB ){` |
|     73612 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48539 | 2073 | `			pTail->pPrev = pA;` |
|     48539 | 2074 | `			pA->pNext = pTail;` |
|     48539 | 2075 | `			pTail = pA;` |
|     48539 | 2076 | `			pA = pA->pPrev;` |
|     24261 | 2077 | `		}else{` |
|     25078 | 2078 | `			pTail->pPrev = pB;` |
|     25078 | 2079 | `			pB->pNext = pTail;` |
|     25078 | 2080 | `			pTail = pB;` |
|     25078 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     37325 | 2084 | `	if( pA ){` |
|     26507 | 2085 | `		pTail->pPrev = pA;` |
|     26507 | 2086 | `		pA->pNext = pTail;` |
|     24087 | 2087 | `	}else if( pB ){` |
|     10595 | 2088 | `		pTail->pPrev = pB;` |
|     10595 | 2089 | `		pB->pNext = pTail;` |
|      5287 | 2090 | `	}else{` |
|       233 | 2091 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2092 | `	}` |
|     37325 | 2093 | `	return result.pPrev;` |
|         5 | 2094 | `}` |
|         - | 2095 | `/*` |
|         - | 2096 | `** Inputs:` |
...
|     15189 | 2114 | `	while( pIn ){` |
|     14405 | 2115 | `		p = pIn;` |
|     14405 | 2116 | `		pIn = p->pPrev;` |
|     14405 | 2117 | `		p->pPrev = 0;` |
|     27421 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27421 | 2119 | `			if( a[i]==0 ){` |
|     14405 | 2120 | `				a[i] = p;` |
|     14405 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
|     13021 | 2123 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     13021 | 2124 | `				a[i] = 0;` |
|         - | 2125 | `			}` |
|      6513 | 2126 | `		}` |
|     14405 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     73286 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     73291 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     73203 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         - | 2493 | ` */` |
|        19 | 2494 | `static sxi32 HashmapCmpCallback7(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         1 | 2495 | `{` |
|         - | 2496 | `	sxu32 n;` |
|        11 | 2497 | `	SXUNUSED(pB); /* cc warning */` |
|        11 | 2498 | `	SXUNUSED(pCmpData);` |
|         - | 2499 | `	/* Grab a random number */` |
|        20 | 2500 | `	n = PH7_VmRandomNum(pA->pMap->pVm);` |
...
|         2 | 2529 | `		}` |
|     14129 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     14129 | 2532 | `		i++;` |
|     14129 | 2533 | `		pLast = p;` |
|     14129 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       707 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|        10 | 3036 | `		while(pMap->pLast->pPrev){` |
|         8 | 3037 | `			pMap->pLast = pMap->pLast->pPrev;` |
|         1 | 3038 | `		}` |
|         1 | 3039 | `	}` |
...
|         - | 4937 | ` */` |
|     33474 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33479 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33479 | 4948 | `	pNeedle = apArg[0];` |
|     33479 | 4949 | `	bStrict = 0;` |
|     33479 | 4950 | `	if( nArg > 2 ){` |
|        56 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        27 | 4952 | `	}` |
|     33479 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33479 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33479 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33479 | 4964 | `	return PH7_OK;` |
|     16742 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         1 | 7125 | `				pNode = pNode->pPrev; /* Reverse link */` |
|         1 | 7126 | `				nEntry--;` |
|       ! 0 | 7127 | `			}` |
|         - | 7128 | `		}` |
...
|         - | 8934 | ` */` |
|     34656 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34661 | 8946 | `	rc = SXRET_OK;` |
|     34661 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34661 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34661 | 8949 | `	n = pMap->nEntry;` |
|     34661 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    157951 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157951 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    157951 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    157951 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    157951 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    157951 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    157951 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157951 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34661 | 8973 | `	return SXRET_OK;` |
|     17333 | 8974 | `}` |
|         - | 8975 |  |
