...
|         - |   22 | ` */` |
|   7931613 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7931618 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7931618 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    514611 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    514616 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    514616 |   35 | `	sxu32 nH = 5381;` |
|    514616 |   36 | `	zEnd = &zIn[nLen];` |
|    591589 |   37 | `	for(;;){` |
|   1183184 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1010254 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    909125 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    786677 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    514616 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3622702 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3622707 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3622707 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3622707 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3622707 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3622707 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3622707 |  112 | `	pNode->nHash = nHash;` |
|   3622707 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3622707 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3622707 |  115 | `	return pNode;` |
|   1811356 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199241 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199246 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199246 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199246 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199246 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199246 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199246 |  135 | `	pNode->nHash = nHash;` |
|    199246 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199246 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199246 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199246 |  139 | `	return pNode;` |
|     99625 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3821943 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3821948 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3368738 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3368738 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684366 |  150 | `	}` |
|   3821948 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3821948 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87656 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87656 |  156 | `		pMap->pCur = pNode;` |
|     43830 |  157 | `	}else{` |
|   3734297 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3821948 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3821943 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3821948 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93088 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93088 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93088 |  245 | `		if( nNew < 1 ){` |
|     87656 |  246 | `			nNew = 16;` |
...
|     93088 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93088 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93088 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93088 |  260 | `		pMap->apBucket = apNew;` |
|     93088 |  261 | `		pMap->nSize = nNew;` |
|     93088 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87656 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2716 |  288 | `	}` |
|   3734297 |  289 | `	return SXRET_OK;` |
|   1910976 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3622702 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3622707 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3622665 |  310 | `		if( pValue ){` |
|   3622655 |  311 | `			sSafeVal = *pValue;` |
|   3622655 |  312 | `			pValue = &sSafeVal;` |
|   1811325 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3622665 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3622665 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3622665 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3622655 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1811325 |  322 | `		}` |
|   3622665 |  323 | `		nIdx = pObj->nIdx;` |
|   1811335 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3622707 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3622707 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3622707 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3622707 |  334 | `	if( isForeign ){` |
...
|   3622707 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3622707 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3622707 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3622707 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3622707 |  349 | `	return SXRET_OK;` |
|   1811356 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199241 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199246 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    152938 |  370 | `		if( pValue ){` |
|    152628 |  371 | `			sSafeVal = *pValue;` |
|    152628 |  372 | `			pValue = &sSafeVal;` |
|     76311 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    152938 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    152938 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    152938 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152628 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76311 |  382 | `		}` |
|    152938 |  383 | `		nIdx = pObj->nIdx;` |
|     76471 |  384 | `	}else{` |
|     46313 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199246 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199246 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199246 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199246 |  394 | `	if( isForeign ){` |
...
|    199246 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199246 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199246 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199246 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199246 |  409 | `	return SXRET_OK;` |
|     99625 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293043 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293048 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       855 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292198 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292198 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110568110 |  433 | `	for(;;){` |
| 221136215 |  434 | `		if( pNode == 0 ){` |
|   4284856 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851359 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848343 |  438 | `			&& pNode->nHash == nHash` |
| 108426340 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7347 |  441 | `				if( ppNode ){` |
...
| 216844019 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284856 |  450 | `	return SXERR_NOTFOUND;` |
|   2146531 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    343873 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    343878 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28508 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315375 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315375 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255885 |  475 | `	for(;;){` |
|    511775 |  476 | `		if( pNode == 0 ){` |
|    249717 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262058 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260545 |  480 | `			&& pNode->nHash == nHash` |
|    162397 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65767 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65663 |  484 | `				if( ppNode ){` |
|     65635 |  485 | `					*ppNode = pNode;` |
|     32815 |  486 | `				}` |
|     65663 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196405 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    249717 |  493 | `	return SXERR_NOTFOUND;` |
|    171941 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    344053 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    344058 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    344058 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    344058 |  504 | `	int isNeg = FALSE, nDigit;` |
|    344058 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    344048 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    344044 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    344044 |  516 | `	zDigit = zIn;` |
|    172468 |  517 | `	for(;;){` |
|    344942 |  518 | `		if( zIn >= zEnd ){` |
|       299 |  519 | `			break;` |
|         - |  520 | `		}` |
|    344644 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    343746 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       899 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  577 | `		/* Node found */` |
|     72209 |  578 | `		if( ppNode ){` |
|     72155 |  579 | `			*ppNode = pNode;` |
|     36075 |  580 | `		}` |
|     72209 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79953 |  584 | `	return SXERR_NOTFOUND;` |
|     76081 |  585 | `}` |
|         - |  586 | `/*` |
...
|   2141658 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141658 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070831 |  609 | `	}` |
|   1071423 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1476048 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1476053 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1476047 |  623 | `	return FALSE;` |
|    738029 |  624 | `}` |
|         - |  625 | `/*` |
...
|    152914 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    152914 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       219 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229041 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76345 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152208 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152072 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152072 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1809405 |  683 | `IntKey:` |
|   3619033 |  684 | `	if( pKey ){` |
...
|   1071415 |  714 | `		}` |
|   1071420 |  715 | `	}else{` |
|   1476019 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1476017 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1476011 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1476011 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1476009 |  726 | `			++pMap->iNextIdx;` |
|    738002 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3618841 |  730 | `	return rc;` |
|   1885864 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1517930 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1517935 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1517935 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  965 | ` */` |
|     32782 |  966 | `PH7_PRIVATE int HashmapFindValue(` |
...
|     32787 |  979 | `	pEntry = pMap->pFirst;` |
|     32787 |  980 | `	n = pMap->nEntry;` |
|     32787 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32787 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78032 |  983 | `	for(;;){` |
|    156067 |  984 | `		if( n < 1 ){` |
|        83 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    155985 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    155985 |  989 | `		if( pVal ){` |
...
|    155985 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    155985 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    155985 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    155985 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    155985 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    155985 | 1001 | `			if( rc == 0 ){` |
|     32705 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     32705 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     61641 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    123285 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123285 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1498 | ` */` |
|    243282 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    243287 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    243287 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    243287 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    240459 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    141728 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141733 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141733 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    141733 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    141733 | 1700 | `	pMap->pVm = &(*pVm);` |
|    141733 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    141733 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141733 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141733 | 1705 | `	return pMap;` |
|     70869 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     93738 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     93743 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     93743 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     93743 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     93743 | 1821 | `	n = 0;` |
|     93743 | 1822 | `	pEntry = pMap->pFirst;` |
|   1903241 | 1823 | `	for(;;){` |
|   3806488 | 1824 | `		if( n >= pMap->nEntry ){` |
|     93743 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3712750 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3712750 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3712750 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3712690 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1856342 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3712750 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109388 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54691 | 1837 | `		}` |
|   3712750 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3712750 | 1840 | `		pEntry = pNext;` |
|   3712750 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     93743 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     67962 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33978 | 1846 | `	}` |
|     93743 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     93717 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     46861 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    872384 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    872389 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    872389 | 1869 | `	pMap->iRef--;` |
|    872389 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     93697 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     46846 | 1872 | `	}` |
|    872389 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1899 | ` */` |
|   3070099 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3070104 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3070104 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 2019 | ` */` |
|    614026 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    614031 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    614031 | 2023 | `	if( pEntry ){` |
|    614031 | 2024 | `		if( bStore ){` |
|    236111 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    118058 | 2026 | `		}else{` |
|    377925 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    306795 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    164088 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    164093 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    158129 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    158129 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    158129 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79067 | 2045 | `	}else{` |
...
|         - | 2293 | ` */` |
|     33972 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33977 | 2305 | `	rc = SXRET_OK;` |
|     33977 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33977 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33977 | 2308 | `	n = pMap->nEntry;` |
|     33977 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    156795 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    156795 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    156795 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    156795 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    156795 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    156795 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    156793 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    156793 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     33975 | 2332 | `	return SXRET_OK;` |
|     16991 | 2333 | `}` |
|         - | 2334 |  |
