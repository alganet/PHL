...
|         - |   22 | ` */` |
|   7933339 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7933344 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7933344 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    515589 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    515594 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    515594 |   35 | `	sxu32 nH = 5381;` |
|    515594 |   36 | `	zEnd = &zIn[nLen];` |
|    592790 |   37 | `	for(;;){` |
|   1185586 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1012160 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    910785 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    788191 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    515594 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3624360 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3624365 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3624365 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3624365 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3624365 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3624365 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3624365 |  112 | `	pNode->nHash = nHash;` |
|   3624365 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3624365 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3624365 |  115 | `	return pNode;` |
|   1812185 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199625 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199630 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199630 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199630 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199630 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199630 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199630 |  135 | `	pNode->nHash = nHash;` |
|    199630 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199630 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199630 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199630 |  139 | `	return pNode;` |
|     99817 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3823985 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3823990 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3369480 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3369480 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684741 |  150 | `	}` |
|   3823990 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3823990 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87940 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87940 |  156 | `		pMap->pCur = pNode;` |
|     43972 |  157 | `	}else{` |
|   3736055 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3823990 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3823985 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3823990 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
...
|      2713 |  288 | `	}` |
|   3736055 |  289 | `	return SXRET_OK;` |
|   1911997 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3624360 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3624365 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3624323 |  310 | `		if( pValue ){` |
|   3624313 |  311 | `			sSafeVal = *pValue;` |
|   3624313 |  312 | `			pValue = &sSafeVal;` |
|   1812154 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3624323 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3624323 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3624323 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3624313 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1812154 |  322 | `		}` |
|   3624323 |  323 | `		nIdx = pObj->nIdx;` |
|   1812164 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3624365 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3624365 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3624365 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3624365 |  334 | `	if( isForeign ){` |
...
|   3624365 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3624365 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3624365 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3624365 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3624365 |  349 | `	return SXRET_OK;` |
|   1812185 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199625 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199630 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    153262 |  370 | `		if( pValue ){` |
|    152952 |  371 | `			sSafeVal = *pValue;` |
|    152952 |  372 | `			pValue = &sSafeVal;` |
|     76473 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    153262 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    153262 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    153262 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152952 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76473 |  382 | `		}` |
|    153262 |  383 | `		nIdx = pObj->nIdx;` |
|     76633 |  384 | `	}else{` |
|     46373 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199630 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199630 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199630 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199630 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46373 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23184 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199630 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199630 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199630 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199630 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199630 |  409 | `	return SXRET_OK;` |
|     99817 |  410 | `}` |
|         - |  411 | `/*` |
...
| 110568143 |  433 | `	for(;;){` |
| 221136259 |  434 | `		if( pNode == 0 ){` |
|   4284862 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851397 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848381 |  438 | `			&& pNode->nHash == nHash` |
| 108426388 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7379 |  441 | `				if( ppNode ){` |
...
| 216844025 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
...
|         - |  456 | ` */` |
|    344583 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    344588 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28624 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315969 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315969 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256447 |  475 | `	for(;;){` |
|    512899 |  476 | `		if( pNode == 0 ){` |
|    250335 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262564 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261051 |  480 | `			&& pNode->nHash == nHash` |
...
|    196935 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250335 |  493 | `	return SXERR_NOTFOUND;` |
|    172296 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    344963 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    344968 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    344968 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    344968 |  504 | `	int isNeg = FALSE, nDigit;` |
|    344968 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    344958 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    344954 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    344954 |  516 | `	zDigit = zIn;` |
|    173113 |  517 | `	for(;;){` |
|    346232 |  518 | `		if( zIn >= zEnd ){` |
|       499 |  519 | `			break;` |
|         - |  520 | `		}` |
|    345734 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    344456 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|      1279 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  616 | ` */` |
|   1477704 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1477709 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1477703 |  623 | `	return FALSE;` |
|    738857 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3773651 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3773656 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3773656 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3773656 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153388 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    153388 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       419 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|   1071416 |  714 | `		}` |
|   1071421 |  715 | `	}else{` |
|   1477675 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1477673 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1477667 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1477667 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1477665 |  726 | `			++pMap->iNextIdx;` |
|    738830 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3620499 |  730 | `	return rc;` |
|   1886830 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46420 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46425 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46425 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46425 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46385 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46385 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69572 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23189 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46373 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46373 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1500759 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1500764 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1500764 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|    156184 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156184 |  989 | `		if( pVal ){` |
...
|    156184 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156184 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156184 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156184 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156184 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156184 | 1001 | `			if( rc == 0 ){` |
|     32739 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     32739 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     61722 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    123450 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123450 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1498 | ` */` |
|    244118 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    244123 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    244123 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    244123 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    241285 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|   1904425 | 1823 | `	for(;;){` |
|   3808856 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94117 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3714744 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3714744 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3714744 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3714684 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1857339 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3714744 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109684 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54839 | 1837 | `		}` |
|   3714744 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3714744 | 1840 | `		pEntry = pNext;` |
|   3714744 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
...
|         - | 1864 | ` */` |
|    875068 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    875073 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    875073 | 1869 | `	pMap->iRef--;` |
|    875073 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
...
|         - | 1899 | ` */` |
|   3072105 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3072110 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3072110 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46410 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46415 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46415 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46415 | 1966 | `	return rc;` |
|     23210 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 2019 | ` */` |
|    596652 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    596657 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    596657 | 2023 | `	if( pEntry ){` |
|    596657 | 2024 | `		if( bStore ){` |
|    217689 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    108847 | 2026 | `		}else{` |
|    378973 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    298110 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    164992 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    164997 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
...
|         - | 2293 | ` */` |
|     34070 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34075 | 2305 | `	rc = SXRET_OK;` |
|     34075 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34075 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34075 | 2308 | `	n = pMap->nEntry;` |
|     34075 | 2309 | `	pEntry = pMap->pFirst;` |
