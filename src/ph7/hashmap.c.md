...
|         - |   22 | ` */` |
|   7931637 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7931642 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7931642 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    514351 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    514356 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    514356 |   35 | `	sxu32 nH = 5381;` |
|    514356 |   36 | `	zEnd = &zIn[nLen];` |
|    591383 |   37 | `	for(;;){` |
|   1182772 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1010078 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    909077 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    786553 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    514356 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3622770 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3622775 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3622775 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3622775 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3622775 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3622775 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3622775 |  112 | `	pNode->nHash = nHash;` |
|   3622775 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3622775 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3622775 |  115 | `	return pNode;` |
|   1811390 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199229 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199234 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199234 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199234 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199234 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199234 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199234 |  135 | `	pNode->nHash = nHash;` |
|    199234 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199234 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199234 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199234 |  139 | `	return pNode;` |
|     99619 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3821999 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3822004 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3369653 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3369653 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684827 |  150 | `	}` |
|   3822004 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3822004 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87554 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87554 |  156 | `		pMap->pCur = pNode;` |
|     43779 |  157 | `	}else{` |
|   3734455 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3822004 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3821999 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3822004 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92992 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92992 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92992 |  245 | `		if( nNew < 1 ){` |
|     87554 |  246 | `			nNew = 16;` |
...
|     92992 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92992 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92992 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92992 |  260 | `		pMap->apBucket = apNew;` |
|     92992 |  261 | `		pMap->nSize = nNew;` |
|     92992 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87554 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2719 |  288 | `	}` |
|   3734455 |  289 | `	return SXRET_OK;` |
|   1911004 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3622770 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3622775 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3622733 |  310 | `		if( pValue ){` |
|   3622723 |  311 | `			sSafeVal = *pValue;` |
|   3622723 |  312 | `			pValue = &sSafeVal;` |
|   1811359 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3622733 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3622733 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3622733 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3622723 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1811359 |  322 | `		}` |
|   3622733 |  323 | `		nIdx = pObj->nIdx;` |
|   1811369 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3622775 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3622775 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3622775 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3622775 |  334 | `	if( isForeign ){` |
...
|   3622775 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3622775 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3622775 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3622775 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3622775 |  349 | `	return SXRET_OK;` |
|   1811390 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199229 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199234 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|     76436 |  384 | `	}else{` |
|     46371 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199234 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199234 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199234 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199234 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46371 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23183 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199234 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199234 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199234 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199234 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199234 |  409 | `	return SXRET_OK;` |
|     99619 |  410 | `}` |
|         - |  411 | `/*` |
...
| 110568123 |  433 | `	for(;;){` |
| 221136205 |  434 | `		if( pNode == 0 ){` |
|   4284834 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851371 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848355 |  438 | `			&& pNode->nHash == nHash` |
| 108426364 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7345 |  441 | `				if( ppNode ){` |
...
|         - |  456 | ` */` |
|    343595 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    343600 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28478 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315127 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315127 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255752 |  475 | `	for(;;){` |
|    511509 |  476 | `		if( pNode == 0 ){` |
|    249389 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262120 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260607 |  480 | `			&& pNode->nHash == nHash` |
|    162467 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65845 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65743 |  484 | `				if( ppNode ){` |
|     65715 |  485 | `					*ppNode = pNode;` |
|     32855 |  486 | `				}` |
|     65743 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196387 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    249389 |  493 | `	return SXERR_NOTFOUND;` |
|    171802 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    343775 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    343780 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    343780 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    343780 |  504 | `	int isNeg = FALSE, nDigit;` |
|    343780 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    343770 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    343766 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    343766 |  516 | `	zDigit = zIn;` |
|    172329 |  517 | `	for(;;){` |
|    344664 |  518 | `		if( zIn >= zEnd ){` |
|       299 |  519 | `			break;` |
|         - |  520 | `		}` |
|    344366 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    343468 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       899 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    151884 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    151889 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    151889 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    144563 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    144563 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    144491 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    144491 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|     75942 |  575 | `result:` |
|    151889 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72287 |  578 | `		if( ppNode ){` |
|     72239 |  579 | `			*ppNode = pNode;` |
|     36117 |  580 | `		}` |
|     72287 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79607 |  584 | `	return SXERR_NOTFOUND;` |
|     75947 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1476126 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1476131 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1476125 |  623 | `	return FALSE;` |
|    738068 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3771713 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3771718 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3771718 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3771718 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
...
|   1071408 |  714 | `		}` |
|   1071413 |  715 | `	}else{` |
|   1476097 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1476095 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1476089 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1476089 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1476087 |  726 | `			++pMap->iNextIdx;` |
|    738041 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3618905 |  730 | `	return rc;` |
|   1885861 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46418 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46423 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46423 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46423 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46383 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46383 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69569 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23188 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46371 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46371 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1517908 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1517913 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1517913 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77370 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77375 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77375 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77375 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77375 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77375 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77375 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77375 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77375 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77375 |  921 | `	return rc;` |
|     38592 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16698 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16703 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16703 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11758 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5773 |  934 | `	}else{` |
|      4950 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16703 |  937 | `	if( pEntry->pNextCollide ){` |
|      1083 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       553 |  939 | `	}` |
|     16703 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16703 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16703 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16703 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16703 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16703 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12074 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5935 |  949 | `	}` |
|     16703 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16703 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16703 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16703 |  956 | `		pMap->iNextIdx++;` |
|      8349 |  957 | `	}` |
|     16703 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     32778 |  966 | `PH7_PRIVATE int HashmapFindValue(` |
...
|     32783 |  979 | `	pEntry = pMap->pFirst;` |
|     32783 |  980 | `	n = pMap->nEntry;` |
|     32783 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32783 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78096 |  983 | `	for(;;){` |
|    156197 |  984 | `		if( n < 1 ){` |
|        83 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    156115 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156115 |  989 | `		if( pVal ){` |
...
|    156115 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156115 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156115 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156115 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156115 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156115 | 1001 | `			if( rc == 0 ){` |
|     32701 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     32701 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     61707 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    123419 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123419 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    710074 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    710074 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    710076 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    710071 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    710071 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1277 | `		/* Blob key insertion */` |
|      4047 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4047 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4047 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4047 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2026 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    706029 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    702359 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    354852 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    705325 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    702419 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    702419 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    702419 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    351212 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    702419 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    702419 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    351212 | 1341 | `	}` |
...
|         - | 1392 | ` */` |
|      7332 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7337 | 1399 | `	if( pSrc == pDest ){` |
...
|      7337 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14953 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7621 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7621 | 1411 | `		if( pVal ){` |
|      7621 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3813 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7621 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7621 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3813 | 1421 | `	}` |
|      7337 | 1422 | `	return SXRET_OK;` |
|      3671 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    242926 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    242931 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    242931 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    242931 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    240103 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    141540 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141545 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141545 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    141545 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    141545 | 1700 | `	pMap->pVm = &(*pVm);` |
|    141545 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    141545 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141545 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141545 | 1705 | `	return pMap;` |
|     70775 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     93522 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     93527 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     93527 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     93527 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     93527 | 1821 | `	n = 0;` |
|     93527 | 1822 | `	pEntry = pMap->pFirst;` |
|   1903133 | 1823 | `	for(;;){` |
|   3806272 | 1824 | `		if( n >= pMap->nEntry ){` |
|     93527 | 1825 | `			break;` |
|         - | 1826 | `		}` |
...
|    109302 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54648 | 1837 | `		}` |
...
|   3712750 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     93527 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     67860 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33927 | 1846 | `	}` |
|     93527 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     93501 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     46753 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    869362 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    869367 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    869367 | 1869 | `	pMap->iRef--;` |
|    869367 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     93481 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     46738 | 1872 | `	}` |
|    869367 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152134 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3069029 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3069034 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3069034 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46408 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46413 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46413 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46413 | 1966 | `	return rc;` |
|     23209 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23152 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23157 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23157 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23157 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23157 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     22976 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     22981 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     22981 | 1991 | `	while( *ppLink ){` |
|     22981 | 1992 | `		if( *ppLink == pStep ){` |
|     22981 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     22981 | 1994 | `			pStep->pNextActive = 0;` |
|     22981 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    612808 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    612813 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    612813 | 2023 | `	if( pEntry ){` |
|    612813 | 2024 | `		if( bStore ){` |
|    235443 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    117724 | 2026 | `		}else{` |
|    377375 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    306213 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    163664 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    163669 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    157711 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    157711 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    157711 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     78858 | 2045 | `	}else{` |
|      5963 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      5963 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5963 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    163669 | 2050 | `}` |
...
|         - | 2293 | ` */` |
|     33898 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33903 | 2305 | `	rc = SXRET_OK;` |
|     33903 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33903 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33903 | 2308 | `	n = pMap->nEntry;` |
|     33903 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    156385 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    156385 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    156385 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    156385 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    156385 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    156385 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    156383 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    156383 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     33901 | 2332 | `	return SXRET_OK;` |
|     16954 | 2333 | `}` |
|         - | 2334 |  |
