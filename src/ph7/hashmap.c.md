...
|         - |   22 | ` */` |
|   7930745 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7930750 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7930750 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    514911 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    514916 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    514916 |   35 | `	sxu32 nH = 5381;` |
|    514916 |   36 | `	zEnd = &zIn[nLen];` |
|    592031 |   37 | `	for(;;){` |
|   1184068 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1011020 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    909931 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    787381 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    514916 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3621876 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3621881 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3621881 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3621881 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3621881 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3621881 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3621881 |  112 | `	pNode->nHash = nHash;` |
|   3621881 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3621881 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3621881 |  115 | `	return pNode;` |
|   1810943 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199403 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199408 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199408 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199408 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199408 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199408 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199408 |  135 | `	pNode->nHash = nHash;` |
|    199408 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199408 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199408 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199408 |  139 | `	return pNode;` |
|     99706 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3821279 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3821284 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3368631 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3368631 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684314 |  150 | `	}` |
|   3821284 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3821284 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87622 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87622 |  156 | `		pMap->pCur = pNode;` |
|     43813 |  157 | `	}else{` |
|   3733667 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3821284 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3821279 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3821284 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93058 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93058 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93058 |  245 | `		if( nNew < 1 ){` |
|     87622 |  246 | `			nNew = 16;` |
...
|     93058 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93058 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93058 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93058 |  260 | `		pMap->apBucket = apNew;` |
|     93058 |  261 | `		pMap->nSize = nNew;` |
|     93058 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87622 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2718 |  288 | `	}` |
|   3733667 |  289 | `	return SXRET_OK;` |
|   1910644 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3621876 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3621881 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3621839 |  310 | `		if( pValue ){` |
|   3621829 |  311 | `			sSafeVal = *pValue;` |
|   3621829 |  312 | `			pValue = &sSafeVal;` |
|   1810912 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3621839 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3621839 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3621839 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3621829 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1810912 |  322 | `		}` |
|   3621839 |  323 | `		nIdx = pObj->nIdx;` |
|   1810922 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3621881 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3621881 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3621881 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3621881 |  334 | `	if( isForeign ){` |
...
|   3621881 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3621881 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3621881 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3621881 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3621881 |  349 | `	return SXRET_OK;` |
|   1810943 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199403 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199408 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    152968 |  370 | `		if( pValue ){` |
|    152658 |  371 | `			sSafeVal = *pValue;` |
|    152658 |  372 | `			pValue = &sSafeVal;` |
|     76326 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    152968 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    152968 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    152968 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152658 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76326 |  382 | `		}` |
|    152968 |  383 | `		nIdx = pObj->nIdx;` |
|     76486 |  384 | `	}else{` |
|     46445 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199408 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199408 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199408 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199408 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46445 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23220 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199408 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199408 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199408 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199408 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199408 |  409 | `	return SXRET_OK;` |
|     99706 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293013 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293018 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       851 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292172 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292172 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110568108 |  433 | `	for(;;){` |
| 221136192 |  434 | `		if( pNode == 0 ){` |
|   4284832 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851360 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848344 |  438 | `			&& pNode->nHash == nHash` |
...
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284832 |  450 | `	return SXERR_NOTFOUND;` |
|   2146515 |  451 | `}` |
|         - |  452 | `/*` |
...
|     28510 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
...
|    255988 |  475 | `	for(;;){` |
|    511981 |  476 | `		if( pNode == 0 ){` |
|    249629 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262352 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260839 |  480 | `			&& pNode->nHash == nHash` |
|    162656 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65991 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65889 |  484 | `				if( ppNode ){` |
|     65861 |  485 | `					*ppNode = pNode;` |
|     32928 |  486 | `				}` |
|     65889 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196473 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    249629 |  493 | `	return SXERR_NOTFOUND;` |
|    172011 |  494 | `}` |
|         - |  495 | `/*` |
...
|         - |  546 | ` */` |
|    152128 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    152133 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    152133 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    144807 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    144807 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    144735 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    144735 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|     76064 |  575 | `result:` |
|    152133 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72433 |  578 | `		if( ppNode ){` |
|     72385 |  579 | `			*ppNode = pNode;` |
|     36190 |  580 | `		}` |
|     72433 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79705 |  584 | `	return SXERR_NOTFOUND;` |
|     76069 |  585 | `}` |
|         - |  586 | `/*` |
...
|   2141648 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141648 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070825 |  609 | `	}` |
|   1071416 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1475226 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1475231 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1475225 |  623 | `	return FALSE;` |
|    737618 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3770913 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3770918 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3770918 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3770918 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    152944 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    152944 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       219 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229086 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76360 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152238 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152102 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152102 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1808987 |  683 | `IntKey:` |
|   3618197 |  684 | `	if( pKey ){` |
...
|   1071408 |  714 | `		}` |
|   1071413 |  715 | `	}else{` |
|   1475197 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1475195 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1475189 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1475189 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1475187 |  726 | `			++pMap->iNextIdx;` |
|    737591 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3618005 |  730 | `	return rc;` |
|   1885461 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46492 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46497 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46497 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46497 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46457 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46457 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69680 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23225 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46445 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46445 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1517209 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1517214 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1517214 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77361 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77366 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77366 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77366 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77366 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77366 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77366 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77366 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77366 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77366 |  921 | `	return rc;` |
|     38573 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16702 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16707 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16707 |  932 | `	if( pEntry->pPrevCollide ){` |
...
|         - |  936 | `	}` |
|     16707 |  937 | `	if( pEntry->pNextCollide ){` |
|      1091 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       554 |  939 | `	}` |
|     16707 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16707 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16707 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16707 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16707 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16707 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12079 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5936 |  949 | `	}` |
|     16707 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16707 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16707 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16707 |  956 | `		pMap->iNextIdx++;` |
|      8351 |  957 | `	}` |
|     16707 |  958 | `}` |
|         - |  959 | `/*` |
...
|    156142 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156142 |  989 | `		if( pVal ){` |
...
|    156142 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156142 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156142 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156142 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156142 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156142 | 1001 | `			if( rc == 0 ){` |
...
|    123436 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123436 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    708978 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    708978 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    708980 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    708975 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    708975 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2028 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    704929 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    701253 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    354305 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|        17 | 1290 | `		}else{ /* Dup */` |
|      3651 | 1291 | `			rc = HashmapInsertIntKey(pDest,pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|         - | 1292 | `		}` |
|         - | 1293 | `	}` |
|    708975 | 1294 | `	return rc;` |
|    354494 | 1295 | `}` |
|         - | 1296 | `/*` |
...
|    704219 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    701313 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    701313 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    701313 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    350659 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    701313 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    701313 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    350659 | 1341 | `	}` |
...
|         - | 1498 | ` */` |
|    243020 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    243025 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    243025 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    243025 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    240197 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1630 | ` */` |
|      3824 | 1631 | `PH7_PRIVATE sxi32 PH7_HashmapUnion(ph7_hashmap *pLeft,ph7_hashmap *pRight)` |
|         5 | 1632 | `{` |
|         - | 1633 | `	ph7_hashmap_node *pEntry;` |
|      3829 | 1634 | `	sxi32 rc = SXRET_OK;` |
|         - | 1635 | `	ph7_value *pObj;` |
|         - | 1636 | `	sxu32 n;` |
|      3829 | 1637 | `	if( pLeft == pRight ){` |
...
|      3829 | 1644 | `	pEntry = pRight->pFirst;` |
|      3869 | 1645 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
...
|         - | 1725 | `*    $_ENV` |
|         - | 1726 | `*/` |
|      3426 | 1727 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|         5 | 1728 | `{` |
...
|      3431 | 1747 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|      3431 | 1748 | `	if( pMap == 0 ){` |
|       ! 0 | 1749 | `		return SXERR_MEM;` |
|         - | 1750 | `	}` |
|      3431 | 1751 | `	pVm->pGlobal = pMap;` |
|         - | 1752 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|      3431 | 1753 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|      3431 | 1754 | `	if( pObj == 0 ){` |
|       ! 0 | 1755 | `		return SXERR_MEM;` |
|         - | 1756 | `	}` |
|      3431 | 1757 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|         - | 1758 | `	/* Record object index */` |
|      3431 | 1759 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|         - | 1760 | `	/* Install the special $GLOBALS array */` |
|      3431 | 1761 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|      3431 | 1762 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1763 | `		return rc;` |
|         - | 1764 | `	}` |
|         - | 1765 | `	/* Install superglobals now */` |
|     37691 | 1766 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|         - | 1767 | `		ph7_value *pSuper;` |
|         - | 1768 | `		/* Request an empty array */` |
|     34265 | 1769 | `		pSuper = ph7_new_array(&(*pVm));` |
|     34265 | 1770 | `		if( pSuper == 0 ){` |
|       ! 0 | 1771 | `			return SXERR_MEM;` |
|         - | 1772 | `		}` |
|         - | 1773 | `		/* Install */` |
|     34265 | 1774 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|     34265 | 1775 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1776 | `			return rc;` |
|         - | 1777 | `		}` |
|         - | 1778 | `		/* Release the value now it have been installed */` |
|     34265 | 1779 | `		ph7_release_value(&(*pVm),pSuper);` |
|     17135 | 1780 | `	}` |
|         - | 1781 | `	/* Set some $_SERVER entries */` |
|      3431 | 1782 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|         - | 1783 | `	/*` |
|         - | 1784 | `	 * 'SCRIPT_FILENAME'` |
|         - | 1785 | `	 * The absolute pathname of the currently executing script.` |
|         - | 1786 | `	 */` |
|      6857 | 1787 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|         - | 1788 | `		"SCRIPT_FILENAME",` |
|      1713 | 1789 | `		pFile ? pFile->zString : ":Memory:",` |
|      3426 | 1790 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|         - | 1791 | `		);` |
|         - | 1792 | `	/* All done,all super-global are installed now */` |
|      3431 | 1793 | `	return SXRET_OK;` |
|      1718 | 1794 | `}` |
|         - | 1795 | `/*` |
|         - | 1796 | ` * Release a hashmap.` |
|         - | 1797 | ` */` |
|     93622 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     93627 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     93627 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     93627 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     93627 | 1821 | `	n = 0;` |
|     93627 | 1822 | `	pEntry = pMap->pFirst;` |
|   1902753 | 1823 | `	for(;;){` |
|   3805512 | 1824 | `		if( n >= pMap->nEntry ){` |
|     93627 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3711890 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3711890 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3711890 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3711830 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1855912 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3711890 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109350 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54672 | 1837 | `		}` |
|   3711890 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3711890 | 1840 | `		pEntry = pNext;` |
|   3711890 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     93627 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     67900 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33947 | 1846 | `	}` |
|     93627 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     93601 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     46803 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    871836 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    871841 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    871841 | 1869 | `	pMap->iRef--;` |
|    871841 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     93581 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     46788 | 1872 | `	}` |
|    871841 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152378 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3069335 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3069340 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3069340 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46482 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46487 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46487 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46487 | 1966 | `	return rc;` |
|     23246 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 2019 | ` */` |
|    613178 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    613183 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    613183 | 2023 | `	if( pEntry ){` |
|    613183 | 2024 | `		if( bStore ){` |
|    235605 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    117805 | 2026 | `		}else{` |
|    377583 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    306369 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    163748 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    163753 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    157791 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    157791 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    157791 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     78898 | 2045 | `	}else{` |
|      5967 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      5967 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5967 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    163753 | 2050 | `}` |
...
|         - | 2158 | ` */` |
|      3418 | 2159 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 2160 | `{` |
|         - | 2161 | `	sxu32 n;` |
|    256355 | 2162 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    252937 | 2163 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    126471 | 2164 | `	}` |
|      3423 | 2165 | `}` |
|         - | 2166 | `/*` |
...
|         - | 2293 | ` */` |
|     33946 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33951 | 2305 | `	rc = SXRET_OK;` |
|     33951 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33951 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33951 | 2308 | `	n = pMap->nEntry;` |
|     33951 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    156465 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    156465 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    156465 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    156465 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    156465 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    156465 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    156463 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    156463 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     33949 | 2332 | `	return SXRET_OK;` |
|     16978 | 2333 | `}` |
|         - | 2334 |  |
