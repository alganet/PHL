...
|         - |   22 | ` */` |
|   7933419 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7933424 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7933424 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    514743 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    514748 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    514748 |   35 | `	sxu32 nH = 5381;` |
|    514748 |   36 | `	zEnd = &zIn[nLen];` |
|    591286 |   37 | `	for(;;){` |
|   1182578 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1009522 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    908091 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    785933 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    514748 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3623992 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3623997 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3623997 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3623997 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3623997 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3623997 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3623997 |  112 | `	pNode->nHash = nHash;` |
|   3623997 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3623997 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3623997 |  115 | `	return pNode;` |
|   1812001 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199079 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199084 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199084 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199084 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199084 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199084 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199084 |  135 | `	pNode->nHash = nHash;` |
|    199084 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199084 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199084 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199084 |  139 | `	return pNode;` |
|     99544 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3823071 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3823076 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3368004 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3368004 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684004 |  150 | `	}` |
|   3823076 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3823076 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87794 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87794 |  156 | `		pMap->pCur = pNode;` |
|     43899 |  157 | `	}else{` |
|   3735287 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3823076 |  160 | `	if( pMap->pActiveSteps ){` |
...
|        11 |  172 | `		}` |
|         9 |  173 | `	}` |
|   3823076 |  174 | `	++pMap->nEntry;` |
|   3823076 |  175 | `}` |
|         - |  176 | `/*` |
|         - |  177 | ` * Unlink a node from the hashmap.` |
|         - |  178 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  179 | ` */` |
|      7402 |  180 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  181 | `{` |
|      7407 |  182 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7407 |  183 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  184 | `	/* Unlink from the corresponding bucket */` |
|      7407 |  185 | `	if( pNode->pPrevCollide == 0 ){` |
|      6917 |  186 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|      3461 |  187 | `	}else{` |
|       492 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7407 |  190 | `	if( pNode->pNextCollide ){` |
|      4837 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2417 |  192 | `	}` |
|      7407 |  193 | `	if( pMap->pFirst == pNode ){` |
|       173 |  194 | `		pMap->pFirst = pNode->pPrev;` |
|        84 |  195 | `	}` |
|      7407 |  196 | `	if( pMap->pCur == pNode ){` |
|         - |  197 | `		/* Advance the node cursor */` |
|       209 |  198 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|       102 |  199 | `	}` |
|      7407 |  200 | `	if( pMap->pActiveSteps ){` |
...
|      7407 |  211 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|      7407 |  212 | `	if( bRestore ){` |
...
|       105 |  218 | `		}` |
|       105 |  219 | `	}` |
|      7407 |  220 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7162 |  221 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3579 |  222 | `	}` |
|      7407 |  223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7407 |  224 | `	pMap->nEntry--;` |
|      7407 |  225 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|         - |  236 | ` */` |
|   3823071 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3823076 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93228 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93228 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93228 |  245 | `		if( nNew < 1 ){` |
|     87794 |  246 | `			nNew = 16;` |
...
|     93228 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93228 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93228 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93228 |  260 | `		pMap->apBucket = apNew;` |
|     93228 |  261 | `		pMap->nSize = nNew;` |
|     93228 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87794 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5439 |  267 | `		pEntry = pMap->pFirst;` |
|      5439 |  268 | `		n = 0;` |
|   2535533 |  269 | `		for( ;; ){` |
|   5071071 |  270 | `			if( n >= pMap->nEntry ){` |
|      5439 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5065637 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5065637 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5065637 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4403103 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4403103 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2201549 |  280 | `			}` |
|   5065637 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5065637 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5065637 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5439 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2717 |  288 | `	}` |
|   3735287 |  289 | `	return SXRET_OK;` |
|   1911540 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3623992 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3623997 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3623955 |  310 | `		if( pValue ){` |
|   3623945 |  311 | `			sSafeVal = *pValue;` |
|   3623945 |  312 | `			pValue = &sSafeVal;` |
|   1811970 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3623955 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3623955 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3623955 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3623945 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1811970 |  322 | `		}` |
|   3623955 |  323 | `		nIdx = pObj->nIdx;` |
|   1811980 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3623997 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3623997 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3623997 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3623997 |  334 | `	if( isForeign ){` |
...
|   3623997 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3623997 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3623997 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3623997 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3623997 |  349 | `	return SXRET_OK;` |
|   1812001 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199079 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199084 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|     76474 |  384 | `	}else{` |
|     46145 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199084 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199084 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199084 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199084 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46145 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23070 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199084 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199084 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199084 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199084 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199084 |  409 | `	return SXRET_OK;` |
|     99544 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293517 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293522 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       865 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292662 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292662 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110568685 |  433 | `	for(;;){` |
| 221137340 |  434 | `		if( pNode == 0 ){` |
|   4285280 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216852060 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216849044 |  438 | `			&& pNode->nHash == nHash` |
| 108426728 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7387 |  441 | `				if( ppNode ){` |
...
| 216844680 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4285280 |  450 | `	return SXERR_NOTFOUND;` |
|   2146763 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    344217 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    344222 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28558 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315669 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315669 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256229 |  475 | `	for(;;){` |
|    512463 |  476 | `		if( pNode == 0 ){` |
|    250383 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262080 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260567 |  480 | `			&& pNode->nHash == nHash` |
|    162222 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65395 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65291 |  484 | `				if( ppNode ){` |
|     65263 |  485 | `					*ppNode = pNode;` |
|     32629 |  486 | `				}` |
|     65291 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196799 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250383 |  493 | `	return SXERR_NOTFOUND;` |
|    172113 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    344597 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    344602 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    344602 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    344602 |  504 | `	int isNeg = FALSE, nDigit;` |
|    344602 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    344592 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    344588 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    344588 |  516 | `	zDigit = zIn;` |
|    172930 |  517 | `	for(;;){` |
|    345866 |  518 | `		if( zIn >= zEnd ){` |
|       499 |  519 | `			break;` |
|         - |  520 | `		}` |
|    345368 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    344090 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|      1279 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    152726 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    152731 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    152731 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    145365 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    145365 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    145293 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    145293 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|     76363 |  575 | `result:` |
|    152731 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     71875 |  578 | `		if( ppNode ){` |
|     71821 |  579 | `			*ppNode = pNode;` |
|     35908 |  580 | `		}` |
|     71875 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80861 |  584 | `	return SXERR_NOTFOUND;` |
|     76368 |  585 | `}` |
|         - |  586 | `/*` |
...
|   2141868 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141868 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070931 |  609 | `	}` |
|   1071530 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1477146 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1477151 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1477145 |  623 | `	return FALSE;` |
|    738578 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3773009 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3773014 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3773014 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3773014 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153090 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    153090 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       419 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229005 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76333 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152184 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152042 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152042 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1809962 |  683 | `IntKey:` |
|   3620347 |  684 | `	if( pKey ){` |
...
|   1071522 |  714 | `		}` |
|   1071527 |  715 | `	}else{` |
|   1477117 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1477115 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1477109 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1477109 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1477107 |  726 | `			++pMap->iNextIdx;` |
|    738551 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3620153 |  730 | `	return rc;` |
|   1886509 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46192 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46197 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46197 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46197 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46157 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46157 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69230 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23075 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46145 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46145 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1499813 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1499818 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1499818 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77694 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77699 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77699 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77699 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77699 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77699 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77699 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77699 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77699 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77699 |  921 | `	return rc;` |
|     38723 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16770 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16775 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16775 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11800 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5789 |  934 | `	}else{` |
|      4980 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16775 |  937 | `	if( pEntry->pNextCollide ){` |
|      1084 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       557 |  939 | `	}` |
|     16775 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16775 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16775 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16775 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16775 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16775 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12121 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5957 |  949 | `	}` |
|     16775 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16775 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16775 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16775 |  956 | `		pMap->iNextIdx++;` |
|      8385 |  957 | `	}` |
|     16775 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     32746 |  966 | `PH7_PRIVATE int HashmapFindValue(` |
...
|     32751 |  979 | `	pEntry = pMap->pFirst;` |
|     32751 |  980 | `	n = pMap->nEntry;` |
|     32751 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32751 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78004 |  983 | `	for(;;){` |
|    156012 |  984 | `		if( n < 1 ){` |
|        85 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    155928 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    155928 |  989 | `		if( pVal ){` |
...
|    155928 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    155928 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    155928 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    155928 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    155928 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    155928 | 1001 | `			if( rc == 0 ){` |
|     32667 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     32667 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     61631 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    123266 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123266 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    706382 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    706382 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    706384 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    706379 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    706379 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1277 | `		/* Blob key insertion */` |
|      4033 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4033 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4033 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4033 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2019 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    702351 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    698709 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    352999 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|        17 | 1290 | `		}else{ /* Dup */` |
|      3617 | 1291 | `			rc = HashmapInsertIntKey(pDest,pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|         - | 1292 | `		}` |
|         - | 1293 | `	}` |
|    706379 | 1294 | `	return rc;` |
|    353196 | 1295 | `}` |
|         - | 1296 | `/*` |
...
|         - | 1307 | ` */` |
|      2898 | 1308 | `PH7_PRIVATE sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1309 | `{` |
...
|    701667 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    698769 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    698769 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    698769 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    349387 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    698769 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    698769 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    349387 | 1341 | `	}` |
...
|         - | 1392 | ` */` |
|      7286 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7291 | 1399 | `	if( pSrc == pDest ){` |
...
|      7291 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14865 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7579 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7579 | 1411 | `		if( pVal ){` |
|      7579 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3792 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7579 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7579 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3792 | 1421 | `	}` |
|      7291 | 1422 | `	return SXRET_OK;` |
|      3648 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    245254 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    245259 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    245259 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    245259 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    242431 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|      2697 | 1520 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2697 | 1521 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2692 | 1522 | `		if( pBacking && pBacking != pValue` |
|      2667 | 1523 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2647 | 1524 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1525 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2647 | 1526 | `			pMap->iRef--;` |
|      2647 | 1527 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1528 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2597 | 1529 | `				pMap->iRef++;` |
|      2597 | 1530 | `				return pMap;` |
|         - | 1531 | `			}` |
...
|         - | 1630 | ` */` |
|      3802 | 1631 | `PH7_PRIVATE sxi32 PH7_HashmapUnion(ph7_hashmap *pLeft,ph7_hashmap *pRight)` |
|         5 | 1632 | `{` |
|         - | 1633 | `	ph7_hashmap_node *pEntry;` |
|      3807 | 1634 | `	sxi32 rc = SXRET_OK;` |
|         - | 1635 | `	ph7_value *pObj;` |
|         - | 1636 | `	sxu32 n;` |
|      3807 | 1637 | `	if( pLeft == pRight ){` |
...
|      3807 | 1644 | `	pEntry = pRight->pFirst;` |
|      3847 | 1645 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
...
|         - | 1725 | `*    $_ENV` |
|         - | 1726 | `*/` |
|      3392 | 1727 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|         5 | 1728 | `{` |
...
|      3397 | 1747 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|      3397 | 1748 | `	if( pMap == 0 ){` |
|       ! 0 | 1749 | `		return SXERR_MEM;` |
|         - | 1750 | `	}` |
|      3397 | 1751 | `	pVm->pGlobal = pMap;` |
|         - | 1752 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|      3397 | 1753 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|      3397 | 1754 | `	if( pObj == 0 ){` |
|       ! 0 | 1755 | `		return SXERR_MEM;` |
|         - | 1756 | `	}` |
|      3397 | 1757 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|         - | 1758 | `	/* Record object index */` |
|      3397 | 1759 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|         - | 1760 | `	/* Install the special $GLOBALS array */` |
|      3397 | 1761 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|      3397 | 1762 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1763 | `		return rc;` |
|         - | 1764 | `	}` |
|         - | 1765 | `	/* Install superglobals now */` |
|     37317 | 1766 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|         - | 1767 | `		ph7_value *pSuper;` |
|         - | 1768 | `		/* Request an empty array */` |
|     33925 | 1769 | `		pSuper = ph7_new_array(&(*pVm));` |
|     33925 | 1770 | `		if( pSuper == 0 ){` |
|       ! 0 | 1771 | `			return SXERR_MEM;` |
|         - | 1772 | `		}` |
|         - | 1773 | `		/* Install */` |
|     33925 | 1774 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|     33925 | 1775 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1776 | `			return rc;` |
|         - | 1777 | `		}` |
|         - | 1778 | `		/* Release the value now it have been installed */` |
|     33925 | 1779 | `		ph7_release_value(&(*pVm),pSuper);` |
|     16965 | 1780 | `	}` |
|         - | 1781 | `	/* Set some $_SERVER entries */` |
|      3397 | 1782 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|         - | 1783 | `	/*` |
|         - | 1784 | `	 * 'SCRIPT_FILENAME'` |
|         - | 1785 | `	 * The absolute pathname of the currently executing script.` |
|         - | 1786 | `	 */` |
|      6789 | 1787 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|         - | 1788 | `		"SCRIPT_FILENAME",` |
|      1696 | 1789 | `		pFile ? pFile->zString : ":Memory:",` |
|      3392 | 1790 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|         - | 1791 | `		);` |
|         - | 1792 | `	/* All done,all super-global are installed now */` |
|      3397 | 1793 | `	return SXRET_OK;` |
|      1701 | 1794 | `}` |
|         - | 1795 | `/*` |
|         - | 1796 | ` * Release a hashmap.` |
|         - | 1797 | ` */` |
|     94136 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94141 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94141 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94141 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94141 | 1821 | `	n = 0;` |
|     94141 | 1822 | `	pEntry = pMap->pFirst;` |
|   1904225 | 1823 | `	for(;;){` |
|   3808456 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94141 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3714320 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3714320 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3714320 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3714260 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1857127 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3714320 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109594 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54794 | 1837 | `		}` |
|   3714320 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3714320 | 1840 | `		pEntry = pNext;` |
|   3714320 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94141 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68220 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34107 | 1846 | `	}` |
|     94141 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94115 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47060 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    875968 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    875973 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    875973 | 1869 | `	pMap->iRef--;` |
|    875973 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94095 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47045 | 1872 | `	}` |
|    875973 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152976 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3073975 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3073980 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3073980 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46182 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46187 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46187 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46187 | 1966 | `	return rc;` |
|     23096 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23834 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23839 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23839 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23839 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23839 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23658 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23663 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23663 | 1991 | `	while( *ppLink ){` |
|     23663 | 1992 | `		if( *ppLink == pStep ){` |
|     23663 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23663 | 1994 | `			pStep->pNextActive = 0;` |
|     23663 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    598482 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    598487 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    598487 | 2023 | `	if( pEntry ){` |
|    598487 | 2024 | `		if( bStore ){` |
|    218663 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    109334 | 2026 | `		}else{` |
|    379829 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    298988 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    165962 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    165967 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    159905 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    159905 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    159905 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79955 | 2045 | `	}else{` |
|      6067 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      6067 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      6067 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    165967 | 2050 | `}` |
...
|         - | 2158 | ` */` |
|      3384 | 2159 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 2160 | `{` |
|         - | 2161 | `	sxu32 n;` |
|    253805 | 2162 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    250421 | 2163 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    125213 | 2164 | `	}` |
|      3389 | 2165 | `}` |
|         - | 2166 | `/*` |
...
|         - | 2180 | ` */` |
|       138 | 2181 | `PH7_PRIVATE sxi32 PH7_HashmapDumpEntries(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         3 | 2182 | `{` |
|       141 | 2183 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 2184 | `	ph7_value *pObj;` |
|       141 | 2185 | `	sxu32 n = 0;` |
|         - | 2186 | `	int isRef;` |
|       141 | 2187 | `	sxi32 rc = SXRET_OK;` |
|         - | 2188 | `	int i;` |
|       219 | 2189 | `	for(;;){` |
|       441 | 2190 | `		if( n >= pMap->nEntry ){` |
|       141 | 2191 | `			break;` |
|         - | 2192 | `		}` |
|       303 | 2193 | `		pObj = HashmapExtractNodeValue(pEntry);` |
...
|       601 | 2196 | `		isRef = ((pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0)` |
|       300 | 2197 | `			\|\| PH7_VmSlotIsReferenced(pMap->pVm,pEntry->nValIdx);` |
|       303 | 2198 | `		if( ShowType ){` |
|         - | 2199 | ``			/* var_dump entry: `[key]=>` on its own line at nTab+2, the value`` |
|         - | 2200 | `			 * on the next line at the same indent (php). */` |
|       201 | 2201 | `			for( i = 0 ; i < nTab + 2 ; i++ ){` |
|       135 | 2202 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        69 | 2203 | `			}` |
|        69 | 2204 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|        64 | 2205 | `				SyBlobFormat(&(*pOut),"[%qd]=>",pEntry->xKey.iKey);` |
|        33 | 2206 | `			}else{` |
|         7 | 2207 | `				SyBlobFormat(&(*pOut),"[\"%.*s\"]=>",` |
|         2 | 2208 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 2209 | `			}` |
|        69 | 2210 | `			SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        69 | 2211 | `			if( pObj ){` |
|        69 | 2212 | `				rc = PH7_MemObjDump(&(*pOut),pObj,TRUE,nTab+2,nDepth,isRef);` |
|        69 | 2213 | `				if( rc == SXERR_LIMIT ){` |
|       ! 0 | 2214 | `					break;` |
|         - | 2215 | `				}` |
|        33 | 2216 | `			}` |
|        36 | 2217 | `		}else{` |
...
|       303 | 2245 | `		n++;` |
|       303 | 2246 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         3 | 2247 | `	}` |
|       141 | 2248 | `	return rc;` |
|         3 | 2249 | `}` |
|       134 | 2250 | `PH7_PRIVATE sxi32 PH7_HashmapDump(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         2 | 2251 | `{` |
|         - | 2252 | `	sxi32 rc;` |
|         - | 2253 | `	int i;` |
|       136 | 2254 | `	if( nDepth > 31 ){` |
...
|    158573 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    158573 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    158573 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    158573 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    158573 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    158573 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    158571 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    158571 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
