...
|         - |   22 | ` */` |
|   7536822 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7536827 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7536827 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    650116 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    650121 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    650121 |   35 | `	sxu32 nH = 5381;` |
|    650121 |   36 | `	zEnd = &zIn[nLen];` |
|    732648 |   37 | `	for(;;){` |
|   1465301 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1244737 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1115979 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    973235 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    650121 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3231792 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3231797 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3231797 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3231797 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3231797 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3231797 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3231797 |  112 | `	pNode->nHash = nHash;` |
|   3231797 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3231797 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3231797 |  115 | `	return pNode;` |
|   1615901 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    270454 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    270459 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    270459 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    270459 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    270459 |  133 | `	pNode->pMap  = &(*pMap);` |
|    270459 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    270459 |  135 | `	pNode->nHash = nHash;` |
|    270459 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    270459 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    270459 |  138 | `	pNode->nValIdx = nValIdx;` |
|    270459 |  139 | `	return pNode;` |
|    135232 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3502246 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3502251 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3011423 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3011423 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1505709 |  150 | `	}` |
|   3502251 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3502251 |  153 | `	if( pMap->pFirst == 0 ){` |
|     94533 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     94533 |  156 | `		pMap->pCur = pNode;` |
|     47269 |  157 | `	}else{` |
|   3407723 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3502251 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3502246 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3502251 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     99965 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     99965 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     99965 |  245 | `		if( nNew < 1 ){` |
|     94533 |  246 | `			nNew = 16;` |
...
|     99965 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     99965 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     99965 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     99965 |  260 | `		pMap->apBucket = apNew;` |
|     99965 |  261 | `		pMap->nSize = nNew;` |
|     99965 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     94533 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2716 |  288 | `	}` |
|   3407723 |  289 | `	return SXRET_OK;` |
|   1751128 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3231792 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3231797 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3231755 |  310 | `		if( pValue ){` |
|   3231749 |  311 | `			sSafeVal = *pValue;` |
|   3231749 |  312 | `			pValue = &sSafeVal;` |
|   1615872 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3231755 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3231755 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3231755 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3231749 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1615872 |  322 | `		}` |
|   3231755 |  323 | `		nIdx = pObj->nIdx;` |
|   1615880 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3231797 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3231797 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3231797 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3231797 |  334 | `	if( isForeign ){` |
...
|   3231797 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3231797 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3231797 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3231797 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3231797 |  349 | `	return SXRET_OK;` |
|   1615901 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    270454 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    270459 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    224455 |  370 | `		if( pValue ){` |
|    224145 |  371 | `			sSafeVal = *pValue;` |
|    224145 |  372 | `			pValue = &sSafeVal;` |
|    112070 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    224455 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    224455 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    224455 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    224145 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    112070 |  382 | `		}` |
|    224455 |  383 | `		nIdx = pObj->nIdx;` |
|    112230 |  384 | `	}else{` |
|     46009 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    270459 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    270459 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    270459 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    270459 |  394 | `	if( isForeign ){` |
...
|    270459 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    270459 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    270459 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    270459 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    270459 |  409 | `	return SXRET_OK;` |
|    135232 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    414396 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    414401 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     34739 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    379667 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    379667 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    310072 |  475 | `	for(;;){` |
|    620149 |  476 | `		if( pNode == 0 ){` |
|    314693 |  477 | `			break;` |
|         - |  478 | `		}` |
|    305456 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    303945 |  480 | `			&& pNode->nHash == nHash` |
|    183754 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65079 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     64979 |  484 | `				if( ppNode ){` |
|     64951 |  485 | `					*ppNode = pNode;` |
|     32473 |  486 | `				}` |
|     64979 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    240487 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    314693 |  493 | `	return SXERR_NOTFOUND;` |
|    207203 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    414528 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    414533 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    414533 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    414533 |  504 | `	int isNeg = FALSE, nDigit;` |
|    414533 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    414511 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    414507 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    414507 |  516 | `	zDigit = zIn;` |
|    207685 |  517 | `	for(;;){` |
|    415375 |  518 | `		if( zIn >= zEnd ){` |
|       251 |  519 | `			break;` |
|         - |  520 | `		}` |
|    415125 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    414257 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       869 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    150324 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    150329 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    150329 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    144065 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    144065 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    144051 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    144051 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         7 |  567 | `	}` |
...
|     75162 |  575 | `result:` |
|    150329 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     70475 |  578 | `		if( ppNode ){` |
|     70423 |  579 | `			*ppNode = pNode;` |
|     35209 |  580 | `		}` |
|     70475 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79859 |  584 | `	return SXERR_NOTFOUND;` |
|     75167 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1085434 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1085439 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1085433 |  623 | `	return FALSE;` |
|    542722 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3452414 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3452419 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3452419 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3452419 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    224457 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    224457 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    336341 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    112112 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    223743 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    223613 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    223613 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1613981 |  683 | `IntKey:` |
|   3228195 |  684 | `	if( pKey ){` |
...
|   1071297 |  714 | `		}` |
|   1071302 |  715 | `	}else{` |
|   1085405 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1085403 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1085397 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1085397 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1085395 |  726 | `			++pMap->iNextIdx;` |
|    542695 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3227991 |  730 | `	return rc;` |
|   1726212 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1522061 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1522066 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1522066 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     72799 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     72804 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     72804 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     72804 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     72804 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     72804 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     72804 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     72804 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     72804 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     72804 |  921 | `	return rc;` |
|     36390 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14222 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14227 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14227 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11453 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5734 |  934 | `	}else{` |
|      2779 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14227 |  937 | `	if( pEntry->pNextCollide ){` |
|      1003 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       525 |  939 | `	}` |
|     14227 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14227 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14227 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14227 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14227 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14227 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11784 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5899 |  949 | `	}` |
|     14227 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14227 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14227 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14227 |  956 | `		pMap->iNextIdx++;` |
|      7111 |  957 | `	}` |
|     14227 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33326 |  966 | `static int HashmapFindValue(` |
...
|     33331 |  979 | `	pEntry = pMap->pFirst;` |
|     33331 |  980 | `	n = pMap->nEntry;` |
|     33331 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33331 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     79555 |  983 | `	for(;;){` |
|    159116 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    159038 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    159038 |  989 | `		if( pVal ){` |
...
|    159038 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    159038 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    159038 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    159038 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    159038 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    159038 | 1001 | `			if( rc == 0 ){` |
|     33253 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33253 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     62892 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    125790 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    125790 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    718038 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    718038 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    718040 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    718035 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    718035 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      1998 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    714049 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    710443 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    358830 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    713387 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    710503 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    710503 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    710503 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    355254 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    710503 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    710503 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    355254 | 1305 | `	}` |
...
|         - | 1462 | ` */` |
|    240876 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    240881 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    240881 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    240881 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    238115 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|         - | 1648 | ` */` |
|    148924 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    148929 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    148929 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    148929 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    148929 | 1664 | `	pMap->pVm = &(*pVm);` |
|    148929 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    148929 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    148929 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    148929 | 1669 | `	return pMap;` |
|     74467 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|    103508 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|    103513 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|    103513 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|    103513 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|    103513 | 1785 | `	n = 0;` |
|    103513 | 1786 | `	pEntry = pMap->pFirst;` |
|   1753044 | 1787 | `	for(;;){` |
|   3506093 | 1788 | `		if( n >= pMap->nEntry ){` |
|    103513 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3402585 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3402585 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3402585 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3402525 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1701260 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3402585 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    189621 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     94808 | 1801 | `		}` |
|   3402585 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3402585 | 1804 | `		pEntry = pNext;` |
|   3402585 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|    103513 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     76141 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     38068 | 1810 | `	}` |
|    103513 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|    103487 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     51746 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    857876 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    857881 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    857881 | 1833 | `	pMap->iRef--;` |
|    857881 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|    103467 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     51731 | 1836 | `	}` |
|    857881 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    150512 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   2741642 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2741647 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2741647 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     19330 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     19335 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     19335 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     19335 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     19335 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     19162 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     19167 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     19167 | 1955 | `	while( *ppLink ){` |
|     19167 | 1956 | `		if( *ppLink == pStep ){` |
|     19167 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     19167 | 1958 | `			pStep->pNextActive = 0;` |
|     19167 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    606408 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    606413 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    606413 | 1987 | `	if( pEntry ){` |
|    606413 | 1988 | `		if( bStore ){` |
|    240533 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    120269 | 1990 | `		}else{` |
|    365885 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    303180 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    163082 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    163087 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    157483 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    157483 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    157483 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     78744 | 2009 | `	}else{` |
...
|    110070 | 2071 | `	while( pA && pB ){` |
|     73052 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48223 | 2073 | `			pTail->pPrev = pA;` |
|     48223 | 2074 | `			pA->pNext = pTail;` |
|     48223 | 2075 | `			pTail = pA;` |
|     48223 | 2076 | `			pA = pA->pPrev;` |
|     24098 | 2077 | `		}else{` |
...
|         5 | 2083 | `	}` |
|     37023 | 2084 | `	if( pA ){` |
|     26248 | 2085 | `		pTail->pPrev = pA;` |
|     26248 | 2086 | `		pA->pNext = pTail;` |
|     23915 | 2087 | `	}else if( pB ){` |
|     10550 | 2088 | `		pTail->pPrev = pB;` |
|     10550 | 2089 | `		pB->pNext = pTail;` |
|      5264 | 2090 | `	}else{` |
...
|     15049 | 2114 | `	while( pIn ){` |
|     14271 | 2115 | `		p = pIn;` |
|     14271 | 2116 | `		pIn = p->pPrev;` |
|     14271 | 2117 | `		p->pPrev = 0;` |
|     27171 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27171 | 2119 | `			if( a[i]==0 ){` |
|     14271 | 2120 | `				a[i] = p;` |
|     14271 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
...
|         - | 2125 | `			}` |
|      6455 | 2126 | `		}` |
|     14271 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     72733 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     72738 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     72650 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     14003 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     14003 | 2532 | `		i++;` |
|     14003 | 2533 | `		pLast = p;` |
|     14003 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       703 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         - | 4937 | ` */` |
|     33198 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33203 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33203 | 4948 | `	pNeedle = apArg[0];` |
|     33203 | 4949 | `	bStrict = 0;` |
|     33203 | 4950 | `	if( nArg > 2 ){` |
|        53 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4952 | `	}` |
|     33203 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33203 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33203 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33203 | 4964 | `	return PH7_OK;` |
|     16604 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         - | 8934 | ` */` |
|     34364 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34369 | 8946 | `	rc = SXRET_OK;` |
|     34369 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34369 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34369 | 8949 | `	n = pMap->nEntry;` |
|     34369 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    156209 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    156209 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    156209 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    156209 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    156209 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    156209 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    156209 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    156209 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34369 | 8973 | `	return SXRET_OK;` |
|     17187 | 8974 | `}` |
|         - | 8975 |  |
