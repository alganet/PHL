...
|       - |  712 | ` */` |
|  911548 |  713 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       2 |  714 |  |
|       - |  715 | `	/* Point to the desired object */` |
|       - |  716 | `	ph7_value *pObj;` |
|  911550 |  717 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|  911550 |  718 | `	return pObj;` |
|       2 |  719 |  |
|       - |  720 | `/*` |
...
|       - |  762 | ` * documenation.` |
|       - |  763 | ` */` |
|   38462 |  764 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       2 |  765 |  |
|       - |  766 | `	ph7_value sObj1,sObj2;` |
|       - |  767 | `	sxi32 rc;` |
|   38464 |  768 | `	if( pLeft == pRight ){` |
|       - |  769 | `		/*` |
...
|   38464 |  776 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   38464 |  777 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   38464 |  778 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   38464 |  779 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   38464 |  780 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   38464 |  781 | `	PH7_MemObjRelease(&sObj1);` |
|   38464 |  782 | `	PH7_MemObjRelease(&sObj2);` |
|   38464 |  783 | `	return rc;` |
|   19275 |  784 |  |
|       - |  785 | `/*` |
...
|       - | 1594 | ` */` |
|  336458 | 1595 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       2 | 1596 |  |
|  336460 | 1597 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  336460 | 1598 | `	if( pEntry ){` |
|  336460 | 1599 | `		if( bStore ){` |
|  133222 | 1600 | `			PH7_MemObjStore(pEntry,pValue);` |
|   66612 | 1601 | `		}else{` |
|  203240 | 1602 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1603 | `		}` |
|  168315 | 1604 | `	}else{` |
...
|   25380 | 1681 | `			pTail->pPrev = pA;` |
|   25380 | 1682 | `			pA->pNext = pTail;` |
|   25380 | 1683 | `			pTail = pA;` |
|   25380 | 1684 | `			pA = pA->pPrev;` |
|   12693 | 1685 | `		}else{` |
...
|       2 | 1691 | `	}` |
|   24618 | 1692 | `	if( pA ){` |
|   18210 | 1693 | `		pTail->pPrev = pA;` |
|   18210 | 1694 | `		pA->pNext = pTail;` |
|   15526 | 1695 | `	}else if( pB ){` |
|    6246 | 1696 | `		pTail->pPrev = pB;` |
|    6246 | 1697 | `		pB->pNext = pTail;` |
|    3112 | 1698 | `	}else{` |
...
|       - | 1756 | ` */` |
|   38444 | 1757 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       2 | 1758 |  |
|       - | 1759 | `	ph7_value sA,sB;` |
|       - | 1760 | `	sxi32 iFlags;` |
|       - | 1761 | `	int rc;` |
|   38446 | 1762 | `	if( pCmpData == 0 ){` |
|       - | 1763 | `		/* Perform a standard comparison */` |
|   38442 | 1764 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   38442 | 1765 | `		return rc;` |
|       - | 1766 | `	}` |
