...
|         - |   22 | ` */` |
|   7946316 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7946321 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7946321 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    510464 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    510469 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    510469 |   35 | `	sxu32 nH = 5381;` |
|    510469 |   36 | `	zEnd = &zIn[nLen];` |
|    585802 |   37 | `	for(;;){` |
|   1171609 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1002145 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    902887 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    779789 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    510469 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3640976 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3640981 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3640981 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3640981 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3640981 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3640981 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3640981 |  112 | `	pNode->nHash = nHash;` |
|   3640981 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3640981 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3640981 |  115 | `	return pNode;` |
|   1820493 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    195258 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    195263 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    195263 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    195263 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    195263 |  133 | `	pNode->pMap  = &(*pMap);` |
|    195263 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    195263 |  135 | `	pNode->nHash = nHash;` |
|    195263 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    195263 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    195263 |  138 | `	pNode->nValIdx = nValIdx;` |
|    195263 |  139 | `	return pNode;` |
|     97634 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3836234 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3836239 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3385627 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3385627 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1692811 |  150 | `	}` |
|   3836239 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3836239 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87281 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87281 |  156 | `		pMap->pCur = pNode;` |
|     43643 |  157 | `	}else{` |
|   3748963 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3836239 |  160 | `	if( pMap->pActiveSteps ){` |
...
|      3716 |  187 | `	}else{` |
|       484 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7909 |  190 | `	if( pNode->pNextCollide ){` |
|      5251 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2624 |  192 | `	}` |
...
|         - |  236 | ` */` |
|   3836234 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3836239 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92753 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92753 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92753 |  245 | `		if( nNew < 1 ){` |
|     87281 |  246 | `			nNew = 16;` |
...
|     92753 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92753 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92753 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92753 |  260 | `		pMap->apBucket = apNew;` |
|     92753 |  261 | `		pMap->nSize = nNew;` |
|     92753 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87281 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|   4415351 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4415351 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2207673 |  280 | `			}` |
...
|      2736 |  288 | `	}` |
|   3748963 |  289 | `	return SXRET_OK;` |
|   1918122 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3640976 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3640981 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3640939 |  310 | `		if( pValue ){` |
|   3640933 |  311 | `			sSafeVal = *pValue;` |
|   3640933 |  312 | `			pValue = &sSafeVal;` |
|   1820464 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3640939 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3640939 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3640939 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3640933 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1820464 |  322 | `		}` |
|   3640939 |  323 | `		nIdx = pObj->nIdx;` |
|   1820472 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3640981 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3640981 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3640981 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3640981 |  334 | `	if( isForeign ){` |
...
|   3640981 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3640981 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3640981 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3640981 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3640981 |  349 | `	return SXRET_OK;` |
|   1820493 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    195258 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    195263 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    149091 |  370 | `		if( pValue ){` |
|    148781 |  371 | `			sSafeVal = *pValue;` |
|    148781 |  372 | `			pValue = &sSafeVal;` |
|     74388 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    149091 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    149091 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    149091 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    148781 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     74388 |  382 | `		}` |
|    149091 |  383 | `		nIdx = pObj->nIdx;` |
|     74548 |  384 | `	}else{` |
|     46177 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    195263 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    195263 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    195263 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    195263 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46177 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23086 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    195263 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    195263 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    195263 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    195263 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    195263 |  409 | `	return SXRET_OK;` |
|     97634 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4291756 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4291761 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       799 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4290967 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4290967 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110567457 |  433 | `	for(;;){` |
| 221134919 |  434 | `		if( pNode == 0 ){` |
|   4284515 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216850404 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216847388 |  438 | `			&& pNode->nHash == nHash` |
| 108425417 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      6457 |  441 | `				if( ppNode ){` |
|      6435 |  442 | `					*ppNode = pNode;` |
|      3215 |  443 | `				}` |
|      6457 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
|         - |  446 | `		/* Follow the collision link */` |
| 216843954 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284515 |  450 | `	return SXERR_NOTFOUND;` |
|   2145883 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    342644 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    342649 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     27443 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315211 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315211 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255874 |  475 | `	for(;;){` |
|    511753 |  476 | `		if( pNode == 0 ){` |
|    247873 |  477 | `			break;` |
|         - |  478 | `		}` |
|    263880 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    262365 |  480 | `			&& pNode->nHash == nHash` |
|    164145 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     67445 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67343 |  484 | `				if( ppNode ){` |
|     67315 |  485 | `					*ppNode = pNode;` |
|     33655 |  486 | `				}` |
|     67343 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196547 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    247873 |  493 | `	return SXERR_NOTFOUND;` |
|    171327 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    342780 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    342785 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    342785 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    342785 |  504 | `	int isNeg = FALSE, nDigit;` |
|    342785 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    342763 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    342759 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    342759 |  516 | `	zDigit = zIn;` |
|    171814 |  517 | `	for(;;){` |
|    343633 |  518 | `		if( zIn >= zEnd ){` |
|       255 |  519 | `			break;` |
|         - |  520 | `		}` |
|    343379 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    342505 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       875 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|       255 |  531 | `	nDigit = (int)(zEnd - zDigit);` |
|       255 |  532 | `	if( nDigit < 1 ){` |
|         - |  533 | `		/* A lone sign ("-"/"+") */` |
|       ! 0 |  534 | `		return FALSE;` |
|         - |  535 | `	}` |
|       259 |  536 | `	if( nDigit > 19 \|\|` |
|       130 |  537 | `		(nDigit == 19 && SyMemcmp(zDigit, isNeg ? "9223372036854775808" : "9223372036854775807", 19) > 0) ){` |
|         7 |  538 | `		return FALSE;` |
|         - |  539 | `	}` |
|       249 |  540 | `	return TRUE;` |
|    171395 |  541 | `}` |
...
|         - |  546 | ` */` |
|    153940 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    153945 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    153945 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    147531 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    147531 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    147515 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    147515 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         8 |  567 | `	}` |
...
|     76970 |  575 | `result:` |
|    153945 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72989 |  578 | `		if( ppNode ){` |
|     72937 |  579 | `			*ppNode = pNode;` |
|     36466 |  580 | `		}` |
|     72989 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80961 |  584 | `	return SXERR_NOTFOUND;` |
|     76975 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  591 | ` */` |
|   2142652 |  592 | `static void HashmapAdvanceAutoIndex(ph7_hashmap *pMap,sxi64 iKey)` |
|         5 |  593 | `{` |
|   2142657 |  594 | `	if( !pMap->bIntKeySeen ){` |
|         - |  595 | `		/* php 8.3: the first integer key sets the auto-index even if it is negative */` |
|       843 |  596 | `		pMap->bIntKeySeen = 1;` |
|       843 |  597 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|       843 |  598 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  599 | `			pMap->iNextIdx++;` |
|       ! 0 |  600 | `		}` |
|       843 |  601 | `		return;` |
|         - |  602 | `	}` |
|   2141819 |  603 | `	if( iKey >= pMap->iNextIdx ){` |
|   2141567 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141567 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070781 |  609 | `	}` |
|   1071331 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1494550 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1494555 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1494549 |  623 | `	return FALSE;` |
|    747280 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3786198 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3786203 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3786203 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3786203 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    149075 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    149075 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       231 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    223265 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     74420 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    148359 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    148225 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    148225 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1818564 |  683 | `IntKey:` |
|   3637363 |  684 | `	if( pKey ){` |
|   2142847 |  685 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  686 | `			/* Force an integer cast */` |
|       261 |  687 | `			PH7_MemObjToInteger(pKey);` |
|       130 |  688 | `		}` |
|   2142847 |  689 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
...
|         - |  702 | `		}` |
|   2142653 |  703 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|   2142651 |  711 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   2142651 |  712 | `		if( rc == SXRET_OK ){` |
|   2142651 |  713 | `			HashmapAdvanceAutoIndex(&(*pMap),pKey->x.iVal);` |
|   1071323 |  714 | `		}` |
|   1071328 |  715 | `	}else{` |
|   1494521 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1494519 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1494513 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1494513 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1494511 |  726 | `			++pMap->iNextIdx;` |
|    747253 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3637159 |  730 | `	return rc;` |
|   1893104 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46224 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46229 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46229 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46229 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46189 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46189 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69278 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23091 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46177 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46177 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1531821 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1531826 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1531826 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     73741 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     73746 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     73746 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     73746 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     73746 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     73746 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     73746 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     73746 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     73746 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     73746 |  921 | `	return rc;` |
|     36866 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14378 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14383 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14383 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11615 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5814 |  934 | `	}else{` |
|      2773 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14383 |  937 | `	if( pEntry->pNextCollide ){` |
|      1027 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       530 |  939 | `	}` |
|     14383 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14383 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14383 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14383 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14383 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14383 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11945 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5981 |  949 | `	}` |
|     14383 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14383 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14383 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14383 |  956 | `		pMap->iNextIdx++;` |
|      7189 |  957 | `	}` |
|     14383 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33662 |  966 | `static int HashmapFindValue(` |
...
|     33667 |  979 | `	pEntry = pMap->pFirst;` |
|     33667 |  980 | `	n = pMap->nEntry;` |
|     33667 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33667 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80321 |  983 | `	for(;;){` |
|    160646 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    160568 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    160568 |  989 | `		if( pVal ){` |
...
|    160568 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    160568 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    160568 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    160568 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    160568 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    160568 | 1001 | `			if( rc == 0 ){` |
|     33589 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33589 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63490 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    126984 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    126984 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    722790 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    722790 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    722792 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    722787 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    722787 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1277 | `		/* Blob key insertion */` |
|      4003 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4003 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4003 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4003 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2004 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    718789 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    715167 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    361208 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|        17 | 1290 | `		}else{ /* Dup */` |
|      3597 | 1291 | `			rc = HashmapInsertIntKey(pDest,pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|         - | 1292 | `		}` |
|         - | 1293 | `	}` |
|    722787 | 1294 | `	return rc;` |
|    361400 | 1295 | `}` |
|         - | 1296 | `/*` |
...
|         - | 1307 | ` */` |
|      2898 | 1308 | `static sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1309 | `{` |
|         - | 1310 | `	ph7_hashmap_node *pEntry;` |
|         - | 1311 | `	ph7_value *pVal;` |
|         - | 1312 | `	sxi32 rc;` |
|         - | 1313 | `	sxu32 n;` |
|      2903 | 1314 | `	if( pSrc == pDest ){` |
...
|      2903 | 1321 | `	pEntry = pSrc->pFirst;` |
|         - | 1322 | `	/* Perform the merge */` |
|    718125 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    715227 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    715227 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    715227 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    357616 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    715227 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    715227 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    357616 | 1341 | `	}` |
|      2903 | 1342 | `	return SXRET_OK;` |
|      1454 | 1343 | `}` |
|         - | 1344 | `/*` |
...
|         - | 1392 | ` */` |
|      7244 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7249 | 1399 | `	if( pSrc == pDest ){` |
...
|      7249 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14773 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7529 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7529 | 1411 | `		if( pVal ){` |
|      7529 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3767 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7529 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7529 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3767 | 1421 | `	}` |
|      7249 | 1422 | `	return SXRET_OK;` |
|      3627 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    243778 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    243783 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    243783 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    243783 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    241007 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
|      2781 | 1511 | `	if( pMap == pVm->pGlobal ){` |
...
|      2651 | 1520 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2651 | 1521 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2646 | 1522 | `		if( pBacking && pBacking != pValue` |
|      2621 | 1523 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2601 | 1524 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1525 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2601 | 1526 | `			pMap->iRef--;` |
|      2601 | 1527 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1528 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2551 | 1529 | `				pMap->iRef++;` |
|      2551 | 1530 | `				return pMap;` |
|         - | 1531 | `			}` |
...
|         - | 1630 | ` */` |
|      3776 | 1631 | `PH7_PRIVATE sxi32 PH7_HashmapUnion(ph7_hashmap *pLeft,ph7_hashmap *pRight)` |
|         5 | 1632 | `{` |
|         - | 1633 | `	ph7_hashmap_node *pEntry;` |
|      3781 | 1634 | `	sxi32 rc = SXRET_OK;` |
|         - | 1635 | `	ph7_value *pObj;` |
|         - | 1636 | `	sxu32 n;` |
|      3781 | 1637 | `	if( pLeft == pRight ){` |
...
|      3781 | 1644 | `	pEntry = pRight->pFirst;` |
|      3821 | 1645 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
...
|    141775 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141775 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    141775 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    141775 | 1700 | `	pMap->pVm = &(*pVm);` |
|    141775 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    141775 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141775 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141775 | 1705 | `	return pMap;` |
|     70890 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1725 | `*    $_ENV` |
|         - | 1726 | `*/` |
|      3376 | 1727 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|         5 | 1728 | `{` |
...
|      3381 | 1747 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|      3381 | 1748 | `	if( pMap == 0 ){` |
|       ! 0 | 1749 | `		return SXERR_MEM;` |
|         - | 1750 | `	}` |
|      3381 | 1751 | `	pVm->pGlobal = pMap;` |
|         - | 1752 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|      3381 | 1753 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|      3381 | 1754 | `	if( pObj == 0 ){` |
|       ! 0 | 1755 | `		return SXERR_MEM;` |
|         - | 1756 | `	}` |
|      3381 | 1757 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|         - | 1758 | `	/* Record object index */` |
|      3381 | 1759 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|         - | 1760 | `	/* Install the special $GLOBALS array */` |
|      3381 | 1761 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|      3381 | 1762 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1763 | `		return rc;` |
|         - | 1764 | `	}` |
|         - | 1765 | `	/* Install superglobals now */` |
|     37141 | 1766 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|         - | 1767 | `		ph7_value *pSuper;` |
|         - | 1768 | `		/* Request an empty array */` |
|     33765 | 1769 | `		pSuper = ph7_new_array(&(*pVm));` |
|     33765 | 1770 | `		if( pSuper == 0 ){` |
|       ! 0 | 1771 | `			return SXERR_MEM;` |
|         - | 1772 | `		}` |
|         - | 1773 | `		/* Install */` |
|     33765 | 1774 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|     33765 | 1775 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1776 | `			return rc;` |
|         - | 1777 | `		}` |
|         - | 1778 | `		/* Release the value now it have been installed */` |
|     33765 | 1779 | `		ph7_release_value(&(*pVm),pSuper);` |
|     16885 | 1780 | `	}` |
|         - | 1781 | `	/* Set some $_SERVER entries */` |
|      3381 | 1782 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|         - | 1783 | `	/*` |
|         - | 1784 | `	 * 'SCRIPT_FILENAME'` |
|         - | 1785 | `	 * The absolute pathname of the currently executing script.` |
|         - | 1786 | `	 */` |
|      6757 | 1787 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|         - | 1788 | `		"SCRIPT_FILENAME",` |
|      1688 | 1789 | `		pFile ? pFile->zString : ":Memory:",` |
|      3376 | 1790 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|         - | 1791 | `		);` |
|         - | 1792 | `	/* All done,all super-global are installed now */` |
|      3381 | 1793 | `	return SXRET_OK;` |
|      1693 | 1794 | `}` |
|         - | 1795 | `/*` |
|         - | 1796 | ` * Release a hashmap.` |
|         - | 1797 | ` */` |
|     94686 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94691 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94691 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94691 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94691 | 1821 | `	n = 0;` |
|     94691 | 1822 | `	pEntry = pMap->pFirst;` |
|   1911869 | 1823 | `	for(;;){` |
|   3823743 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94691 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3729057 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3729057 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3729057 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3728997 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1864496 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3729057 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    107143 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     53569 | 1837 | `		}` |
|   3729057 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3729057 | 1840 | `		pEntry = pNext;` |
|   3729057 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94691 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68171 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34083 | 1846 | `	}` |
|     94691 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94665 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47335 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    874590 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    874595 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    874595 | 1869 | `	pMap->iRef--;` |
|    874595 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94645 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47320 | 1872 | `	}` |
|    874595 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    154134 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         5 | 1884 | `{` |
|         - | 1885 | `	sxi32 rc;` |
|    154139 | 1886 | `	if( pMap->nEntry < 1 ){` |
|         - | 1887 | `		/* TICKET 1433-25: Don't bother hashing,the hashmap is empty anyway.` |
|         - | 1888 | `		 */` |
|       199 | 1889 | `		return SXERR_NOTFOUND;` |
|         - | 1890 | `	}` |
|    153945 | 1891 | `	rc = HashmapLookup(&(*pMap),&(*pKey),ppNode);` |
|    153945 | 1892 | `	return rc;` |
|     77072 | 1893 | `}` |
|         - | 1894 | `/*` |
...
|         - | 1899 | ` */` |
|   3070702 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3070707 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3070707 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46214 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46219 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46219 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46219 | 1966 | `	return rc;` |
|     23112 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23278 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23283 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23283 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23283 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23283 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23110 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23115 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23115 | 1991 | `	while( *ppLink ){` |
|     23115 | 1992 | `		if( *ppLink == pStep ){` |
|     23115 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23115 | 1994 | `			pStep->pNextActive = 0;` |
|     23115 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    609828 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    609833 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    609833 | 2023 | `	if( pEntry ){` |
|    609833 | 2024 | `		if( bStore ){` |
|    237285 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    118645 | 2026 | `		}else{` |
|    372553 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    304900 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    165456 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    165461 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    159779 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    159779 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    159779 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79892 | 2045 | `	}else{` |
|      5687 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      5687 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5687 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    165461 | 2050 | `}` |
...
|         - | 2099 | `**   changed.` |
|         - | 2100 | `*/` |
|     37416 | 2101 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2102 | `{` |
|         - | 2103 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2104 | `    /* Prevent compiler warning */` |
|     37421 | 2105 | `	result.pNext = result.pPrev = 0;` |
|     37421 | 2106 | `	pTail = &result;` |
|    111402 | 2107 | `	while( pA && pB ){` |
|     73986 | 2108 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48876 | 2109 | `			pTail->pPrev = pA;` |
|     48876 | 2110 | `			pA->pNext = pTail;` |
|     48876 | 2111 | `			pTail = pA;` |
|     48876 | 2112 | `			pA = pA->pPrev;` |
|     24426 | 2113 | `		}else{` |
|     25115 | 2114 | `			pTail->pPrev = pB;` |
|     25115 | 2115 | `			pB->pNext = pTail;` |
|     25115 | 2116 | `			pTail = pB;` |
|     25115 | 2117 | `			pB = pB->pPrev;` |
|         - | 2118 | `		}` |
|         5 | 2119 | `	}` |
|     37421 | 2120 | `	if( pA ){` |
|     26552 | 2121 | `		pTail->pPrev = pA;` |
|     26552 | 2122 | `		pA->pNext = pTail;` |
|     24163 | 2123 | `	}else if( pB ){` |
|     10642 | 2124 | `		pTail->pPrev = pB;` |
|     10642 | 2125 | `		pB->pNext = pTail;` |
|      5308 | 2126 | `	}else{` |
|       237 | 2127 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2128 | `	}` |
|     37421 | 2129 | `	return result.pPrev;` |
|         5 | 2130 | `}` |
|         - | 2131 | `/*` |
|         - | 2132 | `** Inputs:` |
...
|       786 | 2143 | `static sxi32 HashmapMergeSort(ph7_hashmap *pMap,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2144 | `{` |
|         - | 2145 | `	ph7_hashmap_node *a[N_SORT_BUCKET], *p,*pIn;` |
|         - | 2146 | `	sxu32 i;` |
|       791 | 2147 | `	SyZero(a,sizeof(a));` |
|         - | 2148 | `	/* Point to the first inserted entry */` |
|       791 | 2149 | `	pIn = pMap->pFirst;` |
|     15221 | 2150 | `	while( pIn ){` |
|     14435 | 2151 | `		p = pIn;` |
|     14435 | 2152 | `		pIn = p->pPrev;` |
|     14435 | 2153 | `		p->pPrev = 0;` |
|     27485 | 2154 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27485 | 2155 | `			if( a[i]==0 ){` |
|     14435 | 2156 | `				a[i] = p;` |
|     14435 | 2157 | `				break;` |
|       ! 0 | 2158 | `			}else{` |
|     13055 | 2159 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     13055 | 2160 | `				a[i] = 0;` |
|         - | 2161 | `			}` |
|      6530 | 2162 | `		}` |
|     14435 | 2163 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|         5 | 2169 | `	}` |
|       791 | 2170 | `	p = a[0];` |
|     25157 | 2171 | `	for(i=1; i<N_SORT_BUCKET; i++){` |
|     24371 | 2172 | `		p = HashmapNodeMerge(p,a[i],xCmp,pCmpData);` |
|     12188 | 2173 | `	}` |
|       791 | 2174 | `	p->pNext = 0;` |
|         - | 2175 | `	/* Reflect the change */` |
|       791 | 2176 | `	pMap->pFirst = p;` |
|         - | 2177 | `	/* Reset the loop cursor */` |
|       791 | 2178 | `	pMap->pCur = pMap->pFirst;` |
|       791 | 2179 | `	return SXRET_OK;` |
|         5 | 2180 | `}` |
...
|       127 | 2275 | `	return rc;` |
|        64 | 2276 | `}` |
|     73657 | 2277 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2278 | `{` |
|     73662 | 2279 | `	if( pCmpData == 0 ){` |
|         - | 2280 | `		/* SORT_REGULAR fast path */` |
|     73574 | 2281 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2282 | `	}` |
...
|         - | 2529 | ` */` |
|        22 | 2530 | `static sxi32 HashmapCmpCallback7(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         1 | 2531 | `{` |
|         - | 2532 | `	sxu32 n;` |
|        10 | 2533 | `	SXUNUSED(pB); /* cc warning */` |
|        10 | 2534 | `	SXUNUSED(pCmpData);` |
|         - | 2535 | `	/* Grab a random number */` |
|        23 | 2536 | `	n = PH7_VmRandomNum(pA->pMap->pVm);` |
...
|         - | 2539 | `	 */` |
|        23 | 2540 | `	return n&1 ? 1 : -1;` |
|         1 | 2541 | `}` |
|         - | 2542 | `/*` |
|         - | 2543 | ` * Rehash all nodes keys after a merge-sort have been applied.` |
|         - | 2544 | ` * Used by [sort(),usort() and rsort()].` |
|         - | 2545 | ` */` |
|       704 | 2546 | `static void HashmapSortRehash(ph7_hashmap *pMap)` |
|         5 | 2547 | `{` |
|         - | 2548 | `	ph7_hashmap_node *p,*pLast;` |
|         - | 2549 | `	sxu32 i;` |
|         - | 2550 | `	/* Rehash all entries */` |
|       709 | 2551 | `	pLast = p = pMap->pFirst;` |
|       709 | 2552 | `	pMap->iNextIdx = 0;` |
|       709 | 2553 | `	pMap->bIntKeySeen = 0; /* Reset the automatic index */` |
|       709 | 2554 | `	i = 0;` |
|      7429 | 2555 | `	for( ;; ){` |
|     14863 | 2556 | `		if( i >= pMap->nEntry ){` |
|       709 | 2557 | `			pMap->pLast = pLast; /* Fix the last link broken by the merge-sort */` |
|       709 | 2558 | `			break;` |
|         - | 2559 | `		}` |
|     14159 | 2560 | `		if( p->iType == HASHMAP_BLOB_NODE ){` |
...
|         2 | 2565 | `		}` |
|     14159 | 2566 | `		HashmapRehashIntNode(p);` |
|         - | 2567 | `		/* Point to the next entry */` |
|     14159 | 2568 | `		i++;` |
|     14159 | 2569 | `		pLast = p;` |
|     14159 | 2570 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2571 | `	}` |
|       709 | 2572 | `}` |
|         - | 2573 | `/*` |
...
|         - | 2592 | ` *` |
|         - | 2593 | ` */` |
|      1084 | 2594 | `static int ph7_hashmap_sort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 2595 | `{` |
|         - | 2596 | `	ph7_hashmap *pMap;` |
|         - | 2597 | `	/* Make sure we are dealing with a valid hashmap */` |
|      1089 | 2598 | `	if( nArg < 1 \|\| !ph7_value_is_array(apArg[0]) ){` |
...
|      1089 | 2604 | `	PH7_HashmapCowSeparate(pCtx->pVm, apArg[0]);` |
|      1089 | 2605 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|      1089 | 2606 | `	if( pMap->nEntry > 1 ){` |
|       679 | 2607 | `		sxi32 iCmpFlags = 0;` |
|       679 | 2608 | `		if( nArg > 1 ){` |
|         - | 2609 | `			/* Extract comparison flags */` |
|        15 | 2610 | `			iCmpFlags = ph7_value_to_int(apArg[1]);` |
|         7 | 2611 | `		}` |
|         - | 2612 | `		/* Do the merge sort */` |
|       679 | 2613 | `		HashmapMergeSort(pMap,HashmapCmpCallback1,SX_INT_TO_PTR(iCmpFlags));` |
|         - | 2614 | `		/* Rehash [Do not maintain index association as requested by the PHP specification] */` |
|       679 | 2615 | `		HashmapSortRehash(pMap);` |
|       337 | 2616 | `	}` |
|         - | 2617 | `	/* All done,return TRUE */` |
|      1089 | 2618 | `	ph7_result_bool(pCtx,1);` |
|      1089 | 2619 | `	return PH7_OK;` |
|       547 | 2620 | `}` |
|         - | 2621 | `/*` |
...
|         8 | 3072 | `		while(pMap->pLast->pPrev){` |
|         6 | 3073 | `			pMap->pLast = pMap->pLast->pPrev;` |
|         1 | 3074 | `		}` |
|         1 | 3075 | `	}` |
...
|         - | 3092 | ` */` |
|      2180 | 3093 | `static int ph7_hashmap_count(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 3094 | `{` |
|      2185 | 3095 | `	int bRecursive = FALSE;` |
|      2185 | 3096 | `	int bCycleDetected = FALSE;` |
|         - | 3097 | `	sxi64 iCount;` |
|      2185 | 3098 | `	if( nArg < 1 ){` |
...
|      2183 | 3114 | `	if( nArg > 1 ){` |
|        44 | 3115 | `		sxi32 iMode = ph7_value_to_int(apArg[1]);` |
|        44 | 3116 | `		if( iMode != 0 /* COUNT_NORMAL */ && iMode != 1 /* COUNT_RECURSIVE */ ){` |
|        10 | 3117 | `			return PH7_VmThrowException(pCtx,` |
|         - | 3118 | `				"ValueError",` |
...
|        16 | 3123 | `	}` |
|      2175 | 3124 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|         - | 3147 | `	}` |
|         - | 3148 | `	/* Count */` |
|      2105 | 3149 | `	iCount = HashmapCount((ph7_hashmap *)apArg[0]->x.pOther,bRecursive,&bCycleDetected);` |
|      2105 | 3150 | `	if( bCycleDetected ){` |
|         3 | 3151 | `		PH7_VmThrowError(pCtx->pVm,0,PH7_CTX_WARNING,"count(): Recursion detected");` |
|         1 | 3152 | `	}` |
|      2105 | 3153 | `	ph7_result_int64(pCtx,iCount);` |
|      2105 | 3154 | `	return PH7_OK;` |
|      1095 | 3155 | `}` |
|         - | 3156 | `/*` |
...
|         - | 3217 | ` */` |
|       102 | 3218 | `static int ph7_hashmap_pop(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         4 | 3219 | `{` |
...
|       104 | 3231 | `	if( apArg[0]->nIdx == SXU32_HIGH ){` |
...
|        98 | 3238 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|         - | 3243 | `			);` |
|         - | 3244 | `	}` |
|        95 | 3245 | `	PH7_HashmapCowSeparate(pCtx->pVm, apArg[0]);` |
|        95 | 3246 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|        95 | 3247 | `	if( pMap->nEntry < 1 ){` |
|         - | 3248 | `		/* Nothing to pop,return NULL */` |
|         3 | 3249 | `		ph7_result_null(pCtx);` |
|         2 | 3250 | `	}else{` |
|        93 | 3251 | `		ph7_hashmap_node *pLast = pMap->pLast;` |
|         - | 3252 | `		ph7_value *pObj;` |
|        93 | 3253 | `		pObj = HashmapExtractNodeValue(pLast);` |
|        93 | 3254 | `		if( pObj ){` |
|         - | 3255 | `			/* Node value */` |
|        93 | 3256 | `			ph7_result_value(pCtx,pObj);` |
|         - | 3257 | `			/* Unlink the node */` |
|        93 | 3258 | `			PH7_HashmapUnlinkNode(pLast,TRUE);` |
|        47 | 3259 | `		}else{` |
|       ! 0 | 3260 | `			ph7_result_null(pCtx);` |
|         - | 3261 | `		}` |
|         - | 3262 | `		/* Reset the cursor */` |
|        93 | 3263 | `		pMap->pCur = pMap->pFirst;` |
|         - | 3264 | `	}` |
|        95 | 3265 | `	return PH7_OK;` |
|        55 | 3266 | `}` |
|         - | 3267 | `/*` |
...
|        26 | 3292 | `	if( apArg[0]->nIdx == SXU32_HIGH ){` |
...
|        20 | 3299 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|         - | 3400 | ` */` |
|      1094 | 3401 | `static sxi32 HashmapCurrentValue(ph7_context *pCtx,ph7_hashmap *pMap,int iDirection)` |
|         1 | 3402 | `{` |
|      1095 | 3403 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|         - | 3404 | `	ph7_value *pVal;` |
|      1095 | 3405 | `	if( pCur == 0 ){` |
...
|         - | 3409 | `	}` |
|      1057 | 3410 | `	if( iDirection != 0 ){` |
|       201 | 3411 | `		if( iDirection > 0 ){` |
|         - | 3412 | `			/* Point to the next entry */` |
|       199 | 3413 | `			pMap->pCur = pCur->pPrev; /* Reverse link */` |
|       199 | 3414 | `			pCur = pMap->pCur;` |
|       100 | 3415 | `		}else{` |
...
|        83 | 3422 | `			ph7_result_bool(pCtx,0);` |
|        83 | 3423 | `			return PH7_OK;` |
|         - | 3424 | `		}` |
|        59 | 3425 | `	}` |
|         - | 3426 | `	/* Point to the desired element */` |
|       975 | 3427 | `	pVal = HashmapExtractNodeValue(pCur);` |
|       975 | 3428 | `	if( pVal ){` |
|       975 | 3429 | `		ph7_result_value(pCtx,pVal);` |
|       488 | 3430 | `	}else{` |
|       ! 0 | 3431 | `		ph7_result_bool(pCtx,0);` |
|         - | 3432 | `	}` |
|       975 | 3433 | `	return PH7_OK;` |
|       548 | 3434 | `}` |
|         - | 3435 | `/*` |
...
|         - | 3445 | ` */` |
|       302 | 3446 | `static int ph7_hashmap_current(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         1 | 3447 | `{` |
|       303 | 3448 | `	if( nArg < 1 ){` |
...
|       303 | 3454 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|         - | 3455 | `		/* Invalid argument,return FALSE */` |
|       ! 0 | 3456 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 3457 | `		return PH7_OK;` |
|         - | 3458 | `	}` |
|       303 | 3459 | `	HashmapCurrentValue(&(*pCtx),(ph7_hashmap *)apArg[0]->x.pOther,0);` |
|       303 | 3460 | `	return PH7_OK;` |
|       152 | 3461 | `}` |
|         - | 3462 | `/*` |
...
|         - | 3471 | ` */` |
|       198 | 3472 | `static int ph7_hashmap_next(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         1 | 3473 | `{` |
|       199 | 3474 | `	if( nArg < 1 ){` |
...
|       199 | 3480 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|         - | 3481 | `		/* Invalid argument,return FALSE */` |
|       ! 0 | 3482 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 3483 | `		return PH7_OK;` |
|         - | 3484 | `	}` |
|       199 | 3485 | `	HashmapCurrentValue(&(*pCtx),(ph7_hashmap *)apArg[0]->x.pOther,1);` |
|       199 | 3486 | `	return PH7_OK;` |
|       100 | 3487 | `}` |
|         - | 3488 | `/*` |
...
|         - | 3521 | ` */` |
|       348 | 3522 | `static int ph7_hashmap_end(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         1 | 3523 | `{` |
...
|       349 | 3531 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|       349 | 3537 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|         - | 3538 | `	/* Point to the last node */` |
|       349 | 3539 | `	pMap->pCur = pMap->pLast;` |
|         - | 3540 | `	/* Return the last node value */` |
|       349 | 3541 | `	HashmapCurrentValue(&(*pCtx),pMap,0);` |
|       349 | 3542 | `	return PH7_OK;` |
|       175 | 3543 | `}` |
|         - | 3544 | `/*` |
...
|         - | 3551 | ` */` |
|       244 | 3552 | `static int ph7_hashmap_reset(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         1 | 3553 | `{` |
...
|       245 | 3561 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|       245 | 3567 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|         - | 3568 | `	/* Point to the first node */` |
|       245 | 3569 | `	pMap->pCur = pMap->pFirst;` |
|         - | 3570 | `	/* Return the last node value if available */` |
|       245 | 3571 | `	HashmapCurrentValue(&(*pCtx),pMap,0);` |
|       245 | 3572 | `	return PH7_OK;` |
|       123 | 3573 | `}` |
|         - | 3574 | `/*` |
|         - | 3575 | ` * Emit a node's key (integer or blob) as the call result — shared by key(),` |
|         - | 3576 | ` * array_key_first() and array_key_last().` |
|         - | 3577 | ` */` |
|       672 | 3578 | `static void HashmapResultNodeKey(ph7_context *pCtx,ph7_hashmap_node *pNode)` |
|         1 | 3579 | `{` |
|       673 | 3580 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|         - | 3581 | `		/* Key is integer */` |
|       283 | 3582 | `		ph7_result_int64(pCtx,pNode->xKey.iKey);` |
|       142 | 3583 | `	}else{` |
|         - | 3584 | `		/* Key is blob */` |
...
|         - | 3600 | ` */` |
|       776 | 3601 | `static int ph7_hashmap_simple_key(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         1 | 3602 | `{` |
...
|       777 | 3611 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|         - | 3612 | `		/* Invalid argument,return NULL */` |
|       ! 0 | 3613 | `		ph7_result_null(pCtx);` |
|       ! 0 | 3614 | `		return PH7_OK;` |
|         - | 3615 | `	}` |
|       777 | 3616 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|       777 | 3617 | `	pCur = pMap->pCur;` |
|       777 | 3618 | `	if( pCur == 0 ){` |
|         - | 3619 | `		/* Cursor does not point to anything,return NULL */` |
|       121 | 3620 | `		ph7_result_null(pCtx);` |
|       121 | 3621 | `		return PH7_OK;` |
|         - | 3622 | `	}` |
|       657 | 3623 | `	HashmapResultNodeKey(pCtx,pCur);` |
|       657 | 3624 | `	return PH7_OK;` |
|       389 | 3625 | `}` |
|         - | 3626 | `/*` |
...
|        49 | 4308 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|       174 | 4380 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|         - | 4381 | `	/* Create a new array */` |
|       174 | 4382 | `	pArray = ph7_context_new_array(pCtx);` |
|       174 | 4383 | `	if( pArray == 0 ){` |
|       ! 0 | 4384 | `		ph7_result_null(pCtx);` |
|       ! 0 | 4385 | `		return PH7_OK;` |
|         - | 4386 | `	}` |
|       174 | 4387 | `	bStrict = FALSE;` |
|       174 | 4388 | `	if( nArg > 2 ){` |
...
|       174 | 4400 | `	pNode = pMap->pFirst;` |
|       174 | 4401 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|      1524 | 4402 | `	for( n = 0 ; n < pMap->nEntry ; ++n ){` |
|      1354 | 4403 | `		if( pNode->iType == HASHMAP_INT_NODE ){` |
...
|      1322 | 4428 | `			ph7_array_add_elem(pArray,0,&sObj);` |
|       659 | 4429 | `		}` |
|      1354 | 4430 | `		PH7_MemObjRelease(&sObj);` |
|         - | 4431 | `		/* Point to the next entry */` |
|      1354 | 4432 | `		pNode = pNode->pPrev; /* Reverse link */` |
|       679 | 4433 | `	}` |
|         - | 4434 | `	/* return the new array */` |
|       174 | 4435 | `	ph7_result_value(pCtx,pArray);` |
|       174 | 4436 | `	return PH7_OK;` |
|        90 | 4437 | `}` |
|         - | 4438 | `/*` |
...
|         - | 4480 | ` */` |
|      1120 | 4481 | `static int ph7_hashmap_merge(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4482 | `{` |
|         - | 4483 | `	ph7_hashmap *pMap,*pSrc;` |
|         - | 4484 | `	ph7_value *pArray;` |
|         - | 4485 | `	int i;` |
|         - | 4486 | `	/* Create a new array */` |
|      1125 | 4487 | `	pArray = ph7_context_new_array(pCtx);` |
|      1125 | 4488 | `	if( pArray == 0 ){` |
|       ! 0 | 4489 | `		ph7_result_null(pCtx);` |
|       ! 0 | 4490 | `		return PH7_OK;` |
|         - | 4491 | `	}` |
|         - | 4492 | `	/* Point to the internal representation of the hashmap */` |
|      1125 | 4493 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|         - | 4494 | `	/* Start merging */` |
|      3341 | 4495 | `	for( i = 0 ; i < nArg ; i++ ){` |
|         - | 4496 | `		/* Make sure we are dealing with a valid hashmap */` |
|      2225 | 4497 | `		if( !ph7_value_is_array(apArg[i]) ){` |
...
|         - | 4504 | `				);` |
|       ! 0 | 4505 | `		}else{` |
|      2221 | 4506 | `			pSrc = (ph7_hashmap *)apArg[i]->x.pOther;` |
|         - | 4507 | `			/* Merge the two hashmaps */` |
|      2221 | 4508 | `			HashmapMerge(pSrc,pMap);` |
|         - | 4509 | `		}` |
|      1113 | 4510 | `	}` |
|         - | 4511 | `	/* Return the freshly created array */` |
|      1121 | 4512 | `	ph7_result_value(pCtx,pArray);` |
|      1121 | 4513 | `	return PH7_OK;` |
|       565 | 4514 | `}` |
|         - | 4515 | `/*` |
...
|         - | 4973 | ` */` |
|     33534 | 4974 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4975 | `{` |
|         - | 4976 | `	ph7_value *pNeedle;` |
|         - | 4977 | `	int bStrict;` |
|         - | 4978 | `	int rc;` |
|     33539 | 4979 | `	if( nArg < 2 ){` |
|         - | 4980 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4981 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4982 | `		return PH7_OK;` |
|         - | 4983 | `	}` |
|     33539 | 4984 | `	pNeedle = apArg[0];` |
|     33539 | 4985 | `	bStrict = 0;` |
|     33539 | 4986 | `	if( nArg > 2 ){` |
|        58 | 4987 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        28 | 4988 | `	}` |
|     33539 | 4989 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33539 | 4997 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4998 | `	/* Lookup result */` |
|     33539 | 4999 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33539 | 5000 | `	return PH7_OK;` |
|     16772 | 5001 | `}` |
|         - | 5002 | `/*` |
...
|       727 | 6887 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|         6 | 7142 | `			pNode = pMap->pLast;` |
|         6 | 7143 | `			nEntry = pMap->nEntry - nEntry;` |
|         6 | 7144 | `			if( nEntry > 1 ){` |
|       ! 0 | 7145 | `				for(;;){` |
|       ! 0 | 7146 | `					if( nEntry == 0 ){` |
|       ! 0 | 7147 | `						break;` |
...
|       ! 0 | 7153 | `			}` |
|         4 | 7154 | `		}else{` |
|         4 | 7155 | `			pNode = pMap->pFirst;` |
|         2 | 7156 | `			for(;;){` |
|         5 | 7157 | `				if( nEntry == 0 ){` |
|         4 | 7158 | `					break;` |
|         - | 7159 | `				}` |
|         - | 7160 | `				/* Point to the next entry */` |
|         2 | 7161 | `				pNode = pNode->pPrev; /* Reverse link */` |
|         2 | 7162 | `				nEntry--;` |
|         1 | 7163 | `			}` |
|         - | 7164 | `		}` |
...
|         - | 7730 | ` */` |
|        72 | 7731 | `static int ph7_hashmap_map(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 7732 | `{` |
...
|         - | 7746 | `			);` |
|         - | 7747 | `	}` |
|        77 | 7748 | `	bNullCallback = ph7_value_is_null(apArg[0]);` |
|        77 | 7749 | `	if( !bNullCallback && !ph7_value_is_callable(apArg[0]) ){` |
...
|       146 | 7766 | `	for( i = 1 ; i < nArg ; i++ ){` |
|        82 | 7767 | `		if( !ph7_value_is_array(apArg[i]) ){` |
|         3 | 7768 | `			if( i == 1 ){` |
...
|         - | 7780 | `		}` |
|        41 | 7781 | `	}` |
|        67 | 7782 | `	pVm = pCtx->pVm;` |
|         - | 7783 | `	/* Create a new array */` |
|        67 | 7784 | `	pArray = ph7_context_new_array(pCtx);` |
|        67 | 7785 | `	if( pArray == 0 ){` |
|       ! 0 | 7786 | `		ph7_result_null(pCtx);` |
|       ! 0 | 7787 | `		return PH7_OK;` |
|         - | 7788 | `	}` |
|        67 | 7789 | `	PH7_MemObjInit(pVm,&sResult);` |
|        67 | 7790 | `	PH7_MemObjInit(pVm,&sKey);` |
|        67 | 7791 | `	sResult.nIdx = SXU32_HIGH; /* Mark as constant */` |
|        67 | 7792 | `	sKey.nIdx    = SXU32_HIGH; /* Mark as constant */` |
|        67 | 7793 | `	if( nArg == 2 ){` |
|         - | 7794 | `		/* Single-array mode: keys are preserved (PHP semantics). */` |
|        57 | 7795 | `		pMap = (ph7_hashmap *)apArg[1]->x.pOther;` |
|        57 | 7796 | `		pEntry = pMap->pFirst;` |
|       187 | 7797 | `		for( n = 0 ; n < pMap->nEntry ; n++ ){` |
|         - | 7798 | `			/* Extract the node value */` |
|       137 | 7799 | `			pValue = HashmapExtractNodeValue(pEntry);` |
|       137 | 7800 | `			if( pValue ){` |
|         - | 7801 | `				/* Extract the node key */` |
|       137 | 7802 | `				PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|       137 | 7803 | `				if( bNullCallback ){` |
...
|       127 | 7808 | `					rc = PH7_VmCallUserFunction(pVm,apArg[0],1,&pValue,&sResult);` |
|       127 | 7809 | `					if( rc == PH7_EXCEPTION ){` |
...
|       123 | 7817 | `					ph7_array_add_elem(pArray,&sKey,&sResult);` |
|         - | 7818 | `				}` |
|       133 | 7819 | `				PH7_MemObjRelease(&sKey);` |
|       133 | 7820 | `				PH7_MemObjRelease(&sResult);` |
|        65 | 7821 | `			}` |
|         - | 7822 | `			/* Point to the next entry */` |
|       133 | 7823 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|        68 | 7824 | `		}` |
|        28 | 7825 | `	}else{` |
...
|         - | 7896 | `	}` |
|        63 | 7897 | `	PH7_MemObjRelease(&sKey);` |
|        63 | 7898 | `	PH7_MemObjRelease(&sResult);` |
|        63 | 7899 | `	ph7_result_value(pCtx,pArray);` |
|        63 | 7900 | `	return PH7_OK;` |
|        41 | 7901 | `}` |
|         - | 7902 | `/*` |
...
|         - | 8235 | ` */` |
|       320 | 8236 | `PH7_PRIVATE int PH7_HashmapIsList(ph7_hashmap *pMap)` |
|         1 | 8237 | `{` |
|       321 | 8238 | `	ph7_hashmap_node *pNode = pMap->pFirst;` |
|       321 | 8239 | `	sxi64 iExpect = 0;` |
|         - | 8240 | `	sxu32 n;` |
|       745 | 8241 | `	for( n = 0 ; n < pMap->nEntry ; ++n ){` |
|       559 | 8242 | `		if( pNode->iType != HASHMAP_INT_NODE \|\| pNode->xKey.iKey != iExpect ){` |
|         - | 8243 | `			/* A non-integer key or a gap in the sequence: not a list */` |
|       135 | 8244 | `			return 0;` |
|         - | 8245 | `		}` |
|       425 | 8246 | `		++iExpect;` |
|       425 | 8247 | `		pNode = pNode->pPrev; /* Reverse link */` |
|       213 | 8248 | `	}` |
|       187 | 8249 | `	return 1;` |
|       161 | 8250 | `}` |
...
|         - | 8835 | ` */` |
|      3368 | 8836 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 8837 | `{` |
|         - | 8838 | `	sxu32 n;` |
|    252605 | 8839 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    249237 | 8840 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    124621 | 8841 | `	}` |
|      3373 | 8842 | `}` |
|         - | 8843 | `/*` |
...
|         2 | 8859 | `{` |
|       132 | 8860 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 8861 | `	ph7_value *pObj;` |
|       132 | 8862 | `	sxu32 n = 0;` |
|         - | 8863 | `	int isRef;` |
|       132 | 8864 | `	sxi32 rc = SXRET_OK;` |
|         - | 8865 | `	int i;` |
|       207 | 8866 | `	for(;;){` |
|       416 | 8867 | `		if( n >= pMap->nEntry ){` |
|       132 | 8868 | `			break;` |
|         - | 8869 | `		}` |
|       286 | 8870 | `		pObj = HashmapExtractNodeValue(pEntry);` |
...
|       568 | 8873 | `		isRef = ((pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0)` |
|       284 | 8874 | `			\|\| PH7_VmSlotIsReferenced(pMap->pVm,pEntry->nValIdx);` |
|       286 | 8875 | `		if( ShowType ){` |
|         - | 8876 | ``			/* var_dump entry: `[key]=>` on its own line at nTab+2, the value`` |
|         - | 8877 | `			 * on the next line at the same indent (php). */` |
|       146 | 8878 | `			for( i = 0 ; i < nTab + 2 ; i++ ){` |
|        98 | 8879 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        50 | 8880 | `			}` |
|        50 | 8881 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|        37 | 8882 | `				SyBlobFormat(&(*pOut),"[%qd]=>",pEntry->xKey.iKey);` |
|        19 | 8883 | `			}else{` |
|        20 | 8884 | `				SyBlobFormat(&(*pOut),"[\"%.*s\"]=>",` |
|         6 | 8885 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 8886 | `			}` |
|        50 | 8887 | `			SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        50 | 8888 | `			if( pObj ){` |
|        50 | 8889 | `				rc = PH7_MemObjDump(&(*pOut),pObj,TRUE,nTab+2,nDepth,isRef);` |
|        50 | 8890 | `				if( rc == SXERR_LIMIT ){` |
|       ! 0 | 8891 | `					break;` |
|         - | 8892 | `				}` |
|        24 | 8893 | `			}` |
|        26 | 8894 | `		}else{` |
...
|       286 | 8922 | `		n++;` |
|       286 | 8923 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         2 | 8924 | `	}` |
|       132 | 8925 | `	return rc;` |
|         2 | 8926 | `}` |
...
|         - | 8970 | ` */` |
|     34732 | 8971 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34737 | 8982 | `	rc = SXRET_OK;` |
|     34737 | 8983 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34737 | 8984 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34737 | 8985 | `	n = pMap->nEntry;` |
|     34737 | 8986 | `	pEntry = pMap->pFirst;` |
...
|    158487 | 8993 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    158487 | 8994 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8995 | `		/* Invoke the user callback */` |
|    158487 | 8996 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8997 | `		/* Release the copy of the key and the value */` |
|    158487 | 8998 | `		PH7_MemObjRelease(&sKey);` |
|    158487 | 8999 | `		PH7_MemObjRelease(&sValue);` |
|    158487 | 9000 | `		if( rc != PH7_OK ){` |
|         - | 9001 | `			/* Callback request an operation abort */` |
|         3 | 9002 | `			return SXERR_ABORT;` |
|         - | 9003 | `		}` |
|         - | 9004 | `		/* Point to the next entry */` |
|    158485 | 9005 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    158485 | 9006 | `		n--;` |
|         5 | 9007 | `	}` |
|         - | 9008 | `	/* All done */` |
|     34735 | 9009 | `	return SXRET_OK;` |
|     17371 | 9010 | `}` |
|         - | 9011 |  |
