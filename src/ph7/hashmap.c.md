...
|         - |   22 | ` */` |
|   7943644 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7943649 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7943649 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    509854 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    509859 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    509859 |   35 | `	sxu32 nH = 5381;` |
|    509859 |   36 | `	zEnd = &zIn[nLen];` |
|    585234 |   37 | `	for(;;){` |
|   1170473 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1001183 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    902083 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    779131 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    509859 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3638280 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3638285 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3638285 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3638285 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3638285 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3638285 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3638285 |  112 | `	pNode->nHash = nHash;` |
|   3638285 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3638285 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3638285 |  115 | `	return pNode;` |
|   1819145 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    195096 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    195101 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    195101 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    195101 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    195101 |  133 | `	pNode->pMap  = &(*pMap);` |
|    195101 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    195101 |  135 | `	pNode->nHash = nHash;` |
|    195101 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    195101 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    195101 |  138 | `	pNode->nValIdx = nValIdx;` |
|    195101 |  139 | `	return pNode;` |
|     97553 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3833376 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3833381 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3383721 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3383721 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1691858 |  150 | `	}` |
|   3833381 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3833381 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87105 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87105 |  156 | `		pMap->pCur = pNode;` |
|     43555 |  157 | `	}else{` |
|   3746281 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3833381 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3833376 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3833381 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92575 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92575 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92575 |  245 | `		if( nNew < 1 ){` |
|     87105 |  246 | `			nNew = 16;` |
...
|     92575 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92575 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92575 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92575 |  260 | `		pMap->apBucket = apNew;` |
|     92575 |  261 | `		pMap->nSize = nNew;` |
|     92575 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87105 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5475 |  267 | `		pEntry = pMap->pFirst;` |
|      5475 |  268 | `		n = 0;` |
|   2546303 |  269 | `		for( ;; ){` |
|   5092611 |  270 | `			if( n >= pMap->nEntry ){` |
|      5475 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5087141 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5087141 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5087141 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4415317 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4415317 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2207656 |  280 | `			}` |
|   5087141 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5087141 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5087141 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5475 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2735 |  288 | `	}` |
|   3746281 |  289 | `	return SXRET_OK;` |
|   1916693 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3638280 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3638285 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3638243 |  310 | `		if( pValue ){` |
|   3638237 |  311 | `			sSafeVal = *pValue;` |
|   3638237 |  312 | `			pValue = &sSafeVal;` |
|   1819116 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3638243 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3638243 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3638243 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3638237 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1819116 |  322 | `		}` |
|   3638243 |  323 | `		nIdx = pObj->nIdx;` |
|   1819124 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3638285 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3638285 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3638285 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3638285 |  334 | `	if( isForeign ){` |
...
|   3638285 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3638285 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3638285 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3638285 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3638285 |  349 | `	return SXRET_OK;` |
|   1819145 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    195096 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    195101 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    148969 |  370 | `		if( pValue ){` |
|    148659 |  371 | `			sSafeVal = *pValue;` |
|    148659 |  372 | `			pValue = &sSafeVal;` |
|     74327 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    148969 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    148969 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    148969 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    148659 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     74327 |  382 | `		}` |
|    148969 |  383 | `		nIdx = pObj->nIdx;` |
|     74487 |  384 | `	}else{` |
|     46137 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    195101 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    195101 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    195101 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    195101 |  394 | `	if( isForeign ){` |
...
|    195101 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    195101 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    195101 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    195101 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    195101 |  409 | `	return SXRET_OK;` |
|     97553 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    342152 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    342157 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     27399 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    314763 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    314763 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255407 |  475 | `	for(;;){` |
|    510819 |  476 | `		if( pNode == 0 ){` |
|    247515 |  477 | `			break;` |
|         - |  478 | `		}` |
|    263304 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261789 |  480 | `			&& pNode->nHash == nHash` |
|    163812 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     67355 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67253 |  484 | `				if( ppNode ){` |
|     67225 |  485 | `					*ppNode = pNode;` |
|     33610 |  486 | `				}` |
|     67253 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196061 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    247515 |  493 | `	return SXERR_NOTFOUND;` |
|    171081 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    342286 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    342291 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    342291 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    342291 |  504 | `	int isNeg = FALSE, nDigit;` |
|    342291 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    342269 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    342265 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    342265 |  516 | `	zDigit = zIn;` |
|    171566 |  517 | `	for(;;){` |
|    343137 |  518 | `		if( zIn >= zEnd ){` |
|       253 |  519 | `			break;` |
|         - |  520 | `		}` |
|    342885 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    342013 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       873 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    153610 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    153615 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    153615 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    147201 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    147201 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    147185 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    147185 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         8 |  567 | `	}` |
...
|     76805 |  575 | `result:` |
|    153615 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72899 |  578 | `		if( ppNode ){` |
|     72847 |  579 | `			*ppNode = pNode;` |
|     36421 |  580 | `		}` |
|     72899 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80721 |  584 | `	return SXERR_NOTFOUND;` |
|     76810 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1491866 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1491871 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1491865 |  623 | `	return FALSE;` |
|    745938 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3783380 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3783385 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3783385 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3783385 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    148951 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    148951 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    223082 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     74359 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    148237 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    148103 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    148103 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1817217 |  683 | `IntKey:` |
|   3634667 |  684 | `	if( pKey ){` |
...
|   1071317 |  714 | `		}` |
|   1071322 |  715 | `	}else{` |
|   1491837 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1491835 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1491829 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1491829 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1491827 |  726 | `			++pMap->iNextIdx;` |
|    745911 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3634463 |  730 | `	return rc;` |
|   1891695 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1527717 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1527722 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1527722 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     73295 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     73300 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     73300 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     73300 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     73300 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     73300 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     73300 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     73300 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     73300 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     73300 |  921 | `	return rc;` |
|     36656 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14340 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14345 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14345 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11576 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5798 |  934 | `	}else{` |
|      2774 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14345 |  937 | `	if( pEntry->pNextCollide ){` |
|      1029 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       535 |  939 | `	}` |
|     14345 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14345 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14345 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14345 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14345 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14345 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11907 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5967 |  949 | `	}` |
|     14345 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14345 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14345 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14345 |  956 | `		pMap->iNextIdx++;` |
|      7170 |  957 | `	}` |
|     14345 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33582 |  966 | `static int HashmapFindValue(` |
...
|     33587 |  979 | `	pEntry = pMap->pFirst;` |
|     33587 |  980 | `	n = pMap->nEntry;` |
|     33587 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33587 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80154 |  983 | `	for(;;){` |
|    160314 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    160236 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    160236 |  989 | `		if( pVal ){` |
...
|    160236 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    160236 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    160236 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    160236 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    160236 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    160236 | 1001 | `			if( rc == 0 ){` |
|     33509 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33509 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63363 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    126732 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    126732 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    721598 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    721598 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    721600 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    721595 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    721595 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2004 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    717597 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    713975 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    360612 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    716933 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    714035 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    714035 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    714035 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    357020 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    714035 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    714035 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    357020 | 1305 | `	}` |
...
|         - | 1462 | ` */` |
|    242998 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    243003 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    243003 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    243003 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    240227 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|         - | 1648 | ` */` |
|    141524 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141529 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141529 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    141529 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    141529 | 1664 | `	pMap->pVm = &(*pVm);` |
|    141529 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    141529 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141529 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141529 | 1669 | `	return pMap;` |
|     70767 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|     94464 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94469 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|     94469 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|     94469 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|     94469 | 1785 | `	n = 0;` |
|     94469 | 1786 | `	pEntry = pMap->pFirst;` |
|   1910405 | 1787 | `	for(;;){` |
|   3820815 | 1788 | `		if( n >= pMap->nEntry ){` |
|     94469 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3726351 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3726351 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3726351 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3726291 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1863143 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3726351 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    107033 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     53514 | 1801 | `		}` |
|   3726351 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3726351 | 1804 | `		pEntry = pNext;` |
|   3726351 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|     94469 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     68011 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34003 | 1810 | `	}` |
|     94469 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|     94443 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47224 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    872608 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    872613 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    872613 | 1833 | `	pMap->iRef--;` |
|    872613 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94423 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47209 | 1836 | `	}` |
|    872613 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    153804 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   3069076 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3069081 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3069081 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     23236 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     23241 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     23241 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23241 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     23241 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     23068 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     23073 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23073 | 1955 | `	while( *ppLink ){` |
|     23073 | 1956 | `		if( *ppLink == pStep ){` |
|     23073 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     23073 | 1958 | `			pStep->pNextActive = 0;` |
|     23073 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    607250 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    607255 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    607255 | 1987 | `	if( pEntry ){` |
|    607255 | 1988 | `		if( bStore ){` |
|    236385 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    118195 | 1990 | `		}else{` |
|    370875 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    303637 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    164760 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    164765 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    159083 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    159083 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    159083 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79544 | 2009 | `	}else{` |
...
|         - | 2063 | `**   changed.` |
|         - | 2064 | `*/` |
|     37316 | 2065 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2066 | `{` |
|         - | 2067 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2068 | `    /* Prevent compiler warning */` |
|     37321 | 2069 | `	result.pNext = result.pPrev = 0;` |
|     37321 | 2070 | `	pTail = &result;` |
|    110870 | 2071 | `	while( pA && pB ){` |
|     73554 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48514 | 2073 | `			pTail->pPrev = pA;` |
|     48514 | 2074 | `			pA->pNext = pTail;` |
|     48514 | 2075 | `			pTail = pA;` |
|     48514 | 2076 | `			pA = pA->pPrev;` |
|     24238 | 2077 | `		}else{` |
|     25045 | 2078 | `			pTail->pPrev = pB;` |
|     25045 | 2079 | `			pB->pNext = pTail;` |
|     25045 | 2080 | `			pTail = pB;` |
|     25045 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     37321 | 2084 | `	if( pA ){` |
|     26506 | 2085 | `		pTail->pPrev = pA;` |
|     26506 | 2086 | `		pA->pNext = pTail;` |
|     24088 | 2087 | `	}else if( pB ){` |
|     10584 | 2088 | `		pTail->pPrev = pB;` |
|     10584 | 2089 | `		pB->pNext = pTail;` |
|      5277 | 2090 | `	}else{` |
|       241 | 2091 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2092 | `	}` |
|     37321 | 2093 | `	return result.pPrev;` |
|         5 | 2094 | `}` |
|         - | 2095 | `/*` |
|         - | 2096 | `** Inputs:` |
...
|     15181 | 2114 | `	while( pIn ){` |
|     14397 | 2115 | `		p = pIn;` |
|     14397 | 2116 | `		pIn = p->pPrev;` |
|     14397 | 2117 | `		p->pPrev = 0;` |
|     27409 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27409 | 2119 | `			if( a[i]==0 ){` |
|     14397 | 2120 | `				a[i] = p;` |
|     14397 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
|     13017 | 2123 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     13017 | 2124 | `				a[i] = 0;` |
|         - | 2125 | `			}` |
|      6511 | 2126 | `		}` |
|     14397 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     73229 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     73234 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     73146 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     14121 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     14121 | 2532 | `		i++;` |
|     14121 | 2533 | `		pLast = p;` |
|     14121 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       707 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         - | 4937 | ` */` |
|     33454 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33459 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33459 | 4948 | `	pNeedle = apArg[0];` |
|     33459 | 4949 | `	bStrict = 0;` |
|     33459 | 4950 | `	if( nArg > 2 ){` |
|        56 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        27 | 4952 | `	}` |
|     33459 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33459 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33459 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33459 | 4964 | `	return PH7_OK;` |
|     16732 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         5 | 7125 | `				pNode = pNode->pPrev; /* Reverse link */` |
|         5 | 7126 | `				nEntry--;` |
|         1 | 7127 | `			}` |
|         - | 7128 | `		}` |
...
|         - | 8934 | ` */` |
|     34636 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34641 | 8946 | `	rc = SXRET_OK;` |
|     34641 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34641 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34641 | 8949 | `	n = pMap->nEntry;` |
|     34641 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    157791 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157791 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    157791 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    157791 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    157791 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    157791 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    157791 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157791 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34641 | 8973 | `	return SXRET_OK;` |
|     17323 | 8974 | `}` |
|         - | 8975 |  |
