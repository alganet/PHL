...
|         - |   22 | ` */` |
|   7422076 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7422081 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7422081 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    581100 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    581105 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    581105 |   35 | `	sxu32 nH = 5381;` |
|    581105 |   36 | `	zEnd = &zIn[nLen];` |
|    662732 |   37 | `	for(;;){` |
|   1325469 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1125079 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1006829 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    869235 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    581105 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   51 | ` */` |
|      1294 |   52 | `static sxi64 HashmapCount(ph7_hashmap *pMap,int bRecursive,int *pCycleDetected)` |
|         5 |   53 | `{` |
|      1299 |   54 | `	sxi64 iCount = 0;` |
|      1299 |   55 | `	if( !bRecursive ){` |
|      1125 |   56 | `		iCount = pMap->nEntry;` |
|       565 |   57 | `	}else{` |
...
|         - |   98 | ` */` |
|   3124698 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3124703 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3124703 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3124703 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3124703 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3124703 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3124703 |  112 | `	pNode->nHash = nHash;` |
|   3124703 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3124703 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3124703 |  115 | `	return pNode;` |
|   1562354 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    240992 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    240997 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    240997 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    240997 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    240997 |  133 | `	pNode->pMap  = &(*pMap);` |
|    240997 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    240997 |  135 | `	pNode->nHash = nHash;` |
|    240997 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    240997 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    240997 |  138 | `	pNode->nValIdx = nValIdx;` |
|    240997 |  139 | `	return pNode;` |
|    120501 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3365690 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3365695 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2912629 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2912629 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1456312 |  150 | `	}` |
|   3365695 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3365695 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87329 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87329 |  156 | `		pMap->pCur = pNode;` |
|     43667 |  157 | `	}else{` |
|   3278371 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3365695 |  160 | `	if( pMap->pActiveSteps ){` |
...
|        11 |  172 | `		}` |
|         9 |  173 | `	}` |
|   3365695 |  174 | `	++pMap->nEntry;` |
|   3365695 |  175 | `}` |
|         - |  176 | `/*` |
|         - |  177 | ` * Unlink a node from the hashmap.` |
|         - |  178 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  179 | ` */` |
|      7506 |  180 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  181 | `{` |
|      7511 |  182 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7511 |  183 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  184 | `	/* Unlink from the corresponding bucket */` |
|      7511 |  185 | `	if( pNode->pPrevCollide == 0 ){` |
|      7037 |  186 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|      3521 |  187 | `	}else{` |
|       476 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7511 |  190 | `	if( pNode->pNextCollide ){` |
|      4535 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2266 |  192 | `	}` |
|      7511 |  193 | `	if( pMap->pFirst == pNode ){` |
|       139 |  194 | `		pMap->pFirst = pNode->pPrev;` |
|        67 |  195 | `	}` |
|      7511 |  196 | `	if( pMap->pCur == pNode ){` |
|         - |  197 | `		/* Advance the node cursor */` |
|       141 |  198 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|        68 |  199 | `	}` |
|      7511 |  200 | `	if( pMap->pActiveSteps ){` |
...
|      7511 |  211 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|      7511 |  212 | `	if( bRestore ){` |
...
|        51 |  218 | `		}` |
|        51 |  219 | `	}` |
|      7511 |  220 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7358 |  221 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3677 |  222 | `	}` |
|      7511 |  223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7511 |  224 | `	pMap->nEntry--;` |
|      7511 |  225 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|         - |  236 | ` */` |
|   3365690 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3365695 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92223 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92223 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92223 |  245 | `		if( nNew < 1 ){` |
|     87329 |  246 | `			nNew = 16;` |
...
|     92223 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92223 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92223 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92223 |  260 | `		pMap->apBucket = apNew;` |
|     92223 |  261 | `		pMap->nSize = nNew;` |
|     92223 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87329 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      4899 |  267 | `		pEntry = pMap->pFirst;` |
|      4899 |  268 | `		n = 0;` |
|   2098367 |  269 | `		for( ;; ){` |
|   4196739 |  270 | `			if( n >= pMap->nEntry ){` |
|      4899 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   4191845 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   4191845 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   4191845 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   3585243 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3585243 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1792619 |  280 | `			}` |
|   4191845 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   4191845 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   4191845 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      4899 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2447 |  288 | `	}` |
|   3278371 |  289 | `	return SXRET_OK;` |
|   1682850 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3124698 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3124703 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3124665 |  310 | `		if( pValue ){` |
|   3124661 |  311 | `			sSafeVal = *pValue;` |
|   3124661 |  312 | `			pValue = &sSafeVal;` |
|   1562328 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3124665 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3124665 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3124665 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3124661 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1562328 |  322 | `		}` |
|   3124665 |  323 | `		nIdx = pObj->nIdx;` |
|   1562335 |  324 | `	}else{` |
|        39 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3124703 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3124703 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3124703 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3124703 |  334 | `	if( isForeign ){` |
...
|   3124703 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3124703 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3124703 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3124703 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3124703 |  349 | `	return SXRET_OK;` |
|   1562354 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    240992 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    240997 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    194199 |  370 | `		if( pValue ){` |
|    193909 |  371 | `			sSafeVal = *pValue;` |
|    193909 |  372 | `			pValue = &sSafeVal;` |
|     96952 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    194199 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    194199 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    194199 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    193909 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     96952 |  382 | `		}` |
|    194199 |  383 | `		nIdx = pObj->nIdx;` |
|     97102 |  384 | `	}else{` |
|     46803 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    240997 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    240997 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    240997 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    240997 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46803 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23399 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    240997 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    240997 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    240997 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    240997 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    240997 |  409 | `	return SXRET_OK;` |
|    120501 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4284358 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4284363 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       587 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4283781 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4283781 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110562419 |  433 | `	for(;;){` |
| 221124843 |  434 | `		if( pNode == 0 ){` |
|   4281167 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216843676 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216840666 |  438 | `			&& pNode->nHash == nHash` |
| 108420140 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      2619 |  441 | `				if( ppNode ){` |
|      2601 |  442 | `					*ppNode = pNode;` |
|      1298 |  443 | `				}` |
|      2619 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
...
|         - |  456 | ` */` |
|    374150 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    374155 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     34047 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    340113 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    340113 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    279043 |  475 | `	for(;;){` |
|    558091 |  476 | `		if( pNode == 0 ){` |
|    282361 |  477 | `			break;` |
|         - |  478 | `		}` |
|    275730 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    274225 |  480 | `			&& pNode->nHash == nHash` |
|    165284 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     57853 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     57757 |  484 | `				if( ppNode ){` |
|     57729 |  485 | `					*ppNode = pNode;` |
|     28862 |  486 | `				}` |
|     57757 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    217983 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    282361 |  493 | `	return SXERR_NOTFOUND;` |
|    187080 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    374280 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    374285 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    374285 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    374285 |  504 | `	int isNeg = FALSE, nDigit;` |
|    374285 |  505 | `	if( zIn >= zEnd ){` |
|       ! 0 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    374285 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    374281 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    374281 |  516 | `	zDigit = zIn;` |
|    187570 |  517 | `	for(;;){` |
|    375145 |  518 | `		if( zIn >= zEnd ){` |
|       249 |  519 | `			break;` |
|         - |  520 | `		}` |
|    374897 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    374033 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       865 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    135772 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    135777 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    135777 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    133387 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    133387 |  560 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|         - |  561 | `			/* Perform a blob lookup */` |
|    133367 |  562 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    133367 |  563 | `			goto result;` |
|         - |  564 | `		}` |
|        10 |  565 | `	}` |
|         - |  566 | `	/* Perform an int lookup */` |
|      2415 |  567 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  568 | `		/* Force an integer cast */` |
|        35 |  569 | `		PH7_MemObjToInteger(pKey);` |
|        17 |  570 | `	}` |
|         - |  571 | `	/* Perform an int lookup */` |
|      2415 |  572 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     67886 |  573 | `result:` |
|    135777 |  574 | `	if( rc == SXRET_OK ){` |
|         - |  575 | `		/* Node found */` |
|     59721 |  576 | `		if( ppNode ){` |
|     59675 |  577 | `			*ppNode = pNode;` |
|     29835 |  578 | `		}` |
|     59721 |  579 | `		return SXRET_OK;` |
|         - |  580 | `	}` |
|         - |  581 | `	/* No such entry */` |
|     76061 |  582 | `	return SXERR_NOTFOUND;` |
|     67891 |  583 | `}` |
|         - |  584 | `/*` |
...
|         - |  605 | ` */` |
|    983352 |  606 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  607 | `{` |
|    983357 |  608 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  609 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  610 | `		return TRUE;` |
|         - |  611 | `	}` |
|    983351 |  612 | `	return FALSE;` |
|    491681 |  613 | `}` |
|         - |  614 | `/*` |
...
|         - |  619 | ` */` |
|   3318262 |  620 | `static sxi32 HashmapInsert(` |
|         - |  621 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  622 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  623 | `	ph7_value *pVal    /* Node value */` |
|         - |  624 | `	)` |
|         5 |  625 | `{` |
|   3318267 |  626 | `	ph7_hashmap_node *pNode = 0;` |
|   3318267 |  627 | `	sxi32 rc = SXRET_OK;` |
|   3318267 |  628 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    197613 |  629 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  630 | `			/* Force a string cast */` |
|         3 |  631 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  632 | `		}` |
|    197613 |  633 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         - |  639 | `		}` |
|    290810 |  640 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     96935 |  641 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  654 | `		}` |
|    193507 |  655 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    193381 |  668 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    193381 |  669 | `		return rc;` |
|         - |  670 | `	}` |
|   1560327 |  671 | `IntKey:` |
|   3124397 |  672 | `	if( pKey ){` |
...
|   1070491 |  702 | `		}` |
|   1070496 |  703 | `	}else{` |
|    983327 |  704 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  705 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  706 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  707 | `		}` |
|    983325 |  708 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  709 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  710 | `		}` |
|         - |  711 | `		/* Assign an automatic index */` |
|    983319 |  712 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|    983319 |  713 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|    983317 |  714 | `			++pMap->iNextIdx;` |
|    491656 |  715 | `		}` |
|         - |  716 | `	}` |
|         - |  717 | `	/* Insertion result */` |
|   3124301 |  718 | `	return rc;` |
|   1659136 |  719 | `}` |
|         - |  720 | `/*` |
...
|         - |  746 | ` */` |
|     46844 |  747 | `static sxi32 HashmapInsertByRef(` |
|         - |  748 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  749 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  750 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  751 | `	)` |
|         5 |  752 | `{` |
|     46849 |  753 | `	ph7_hashmap_node *pNode = 0;` |
|     46849 |  754 | `	sxi32 rc = SXRET_OK;` |
|     46849 |  755 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46813 |  756 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  757 | `			/* Force a string cast */` |
|       ! 0 |  758 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  759 | `		}` |
|     46813 |  760 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  765 | `			goto IntKey;` |
|         - |  766 | `		}` |
|     70214 |  767 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23403 |  768 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  769 | `				/* Overwrite */` |
...
|     46803 |  777 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46803 |  778 | `		return rc;` |
|         - |  779 | `	}` |
|        18 |  780 | `IntKey:` |
|        39 |  781 | `	if( pKey ){` |
...
|         - |  814 | ` */` |
|   1401134 |  815 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  816 | `{` |
|         - |  817 | `	/* Point to the desired object */` |
|         - |  818 | `	ph7_value *pObj;` |
|   1401139 |  819 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1401139 |  820 | `	return pObj;` |
|         5 |  821 | `}` |
|         - |  822 | `/*` |
...
|         - |  864 | ` * documenation.` |
|         - |  865 | ` */` |
|     70859 |  866 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  867 | `{` |
|         - |  868 | `	ph7_value sObj1,sObj2;` |
|         - |  869 | `	sxi32 rc;` |
|     70864 |  870 | `	if( pLeft == pRight ){` |
|         - |  871 | `		/*` |
...
|     70864 |  878 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     70864 |  879 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     70864 |  880 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     70864 |  881 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     70864 |  882 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     70864 |  883 | `	PH7_MemObjRelease(&sObj1);` |
|     70864 |  884 | `	PH7_MemObjRelease(&sObj2);` |
|     70864 |  885 | `	return rc;` |
|     35426 |  886 | `}` |
|         - |  887 | `/*` |
...
|         - |  890 | ` */` |
|     13602 |  891 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  892 | `{` |
|     13607 |  893 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  894 | `	sxu32 nBucket;` |
|         - |  895 | `	/* Remove old collision links */` |
|     13607 |  896 | `	if( pEntry->pPrevCollide ){` |
|     11152 |  897 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5588 |  898 | `	}else{` |
|      2460 |  899 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  900 | `	}` |
|     13607 |  901 | `	if( pEntry->pNextCollide ){` |
|      1125 |  902 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       565 |  903 | `	}` |
|     13607 |  904 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  905 | `	/* Compute the new hash */` |
|     13607 |  906 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     13607 |  907 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     13607 |  908 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  909 | `	/* Link to the new bucket */` |
|     13607 |  910 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13607 |  911 | `	if( pMap->apBucket[nBucket] ){` |
|     11480 |  912 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5746 |  913 | `	}` |
|     13607 |  914 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13607 |  915 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     13607 |  919 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     13607 |  920 | `		pMap->iNextIdx++;` |
|      6801 |  921 | `	}` |
|     13607 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  929 | ` */` |
|     33042 |  930 | `static int HashmapFindValue(` |
...
|     33047 |  943 | `	pEntry = pMap->pFirst;` |
|     33047 |  944 | `	n = pMap->nEntry;` |
|     33047 |  945 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33047 |  946 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78418 |  947 | `	for(;;){` |
|    156841 |  948 | `		if( n < 1 ){` |
|       111 |  949 | `			break;` |
|         - |  950 | `		}` |
|         - |  951 | `		/* Extract node value */` |
|    156731 |  952 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156731 |  953 | `		if( pVal ){` |
...
|    156731 |  960 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156731 |  961 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156731 |  962 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156731 |  963 | `			PH7_MemObjRelease(&sVal);` |
|    156731 |  964 | `			PH7_MemObjRelease(&sNeedle);` |
|    156731 |  965 | `			if( rc == 0 ){` |
|     32937 |  966 | `				if( ppNode ){` |
|        23 |  967 | `					*ppNode = pEntry;` |
|        11 |  968 | `				}` |
|         - |  969 | `				/* Match found*/` |
|     32937 |  970 | `				return SXRET_OK;` |
|         - |  971 | `			}` |
|     61897 |  972 | `		}` |
|         - |  973 | `		/* Point to the next entry */` |
|    123799 |  974 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123799 |  975 | `		n--;` |
|         5 |  976 | `	}` |
|         - |  977 | `	/* No such entry */` |
...
|         - | 1164 | ` */` |
|    647586 | 1165 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1174 | `	sxi32 rc;` |
|         - | 1175 |  |
|    647591 | 1176 | `	if( pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ ){` |
...
|         7 | 1199 | `		return rc;` |
|         - | 1200 | `	}` |
|    647585 | 1201 | `	sSafeVal = *pVal;` |
|         - | 1202 |  |
|    647585 | 1203 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2029 | 1209 | `	}else{` |
|         - | 1210 | `		/* Int key */` |
|    643537 | 1211 | `		if( iAction == 0 ){ /* Merge */` |
|    643305 | 1212 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    321885 | 1213 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|         - | 1234 | ` */` |
|      2144 | 1235 | `static sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1236 | `{` |
|         - | 1237 | `	ph7_hashmap_node *pEntry;` |
|         - | 1238 | `	ph7_value *pVal;` |
|         - | 1239 | `	sxi32 rc;` |
|         - | 1240 | `	sxu32 n;` |
|      2149 | 1241 | `	if( pSrc == pDest ){` |
...
|      2149 | 1248 | `	pEntry = pSrc->pFirst;` |
|         - | 1249 | `	/* Perform the merge */` |
|    645507 | 1250 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1251 | `		/* Extract the node value */` |
|    643363 | 1252 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    643363 | 1253 | `		if( pVal ){` |
...
|         - | 1258 | `			 */` |
|    643363 | 1259 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    321684 | 1260 | `		}else{` |
|       ! 0 | 1261 | `			rc = SXRET_OK;` |
|         - | 1262 | `		}` |
|    643363 | 1263 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1264 | `			return rc;` |
|         - | 1265 | `		}` |
|         - | 1266 | `		/* Point to the next entry */` |
|    643363 | 1267 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    321684 | 1268 | `	}` |
|      2149 | 1269 | `	return SXRET_OK;` |
|      1077 | 1270 | `}` |
|         - | 1271 | `/*` |
...
|         - | 1425 | ` */` |
|    225992 | 1426 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1427 | `{` |
|    225997 | 1428 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1429 | `	ph7_hashmap *pNew;` |
|         - | 1430 | `	ph7_value *pBacking;` |
|         - | 1431 | `	sxu32 nValIdx;` |
|         - | 1432 | `	int bValueInPool;` |
|    225997 | 1433 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    225997 | 1434 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1435 | `		/* Sole owner, no separation needed */` |
|    223639 | 1436 | `		return pMap;` |
|         - | 1437 | `	}` |
...
|         - | 1611 | ` */` |
|    137632 | 1612 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    137637 | 1620 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    137637 | 1621 | `	if( pMap == 0 ){` |
|       ! 0 | 1622 | `		return 0;` |
|         - | 1623 | `	}` |
|         - | 1624 | `	/* Zero the structure */` |
|    137637 | 1625 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1626 | `	/* Fill in the structure */` |
|    137637 | 1627 | `	pMap->pVm = &(*pVm);` |
|    137637 | 1628 | `	pMap->iRef = 1;` |
|         - | 1629 | `	/* Default hash functions */` |
|    137637 | 1630 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    137637 | 1631 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    137637 | 1632 | `	return pMap;` |
|     68821 | 1633 | `}` |
|         - | 1634 | `/*` |
...
|         - | 1724 | ` */` |
|     94396 | 1725 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1726 | `{` |
|         - | 1727 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94401 | 1728 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1729 | `	sxu32 n;` |
|     94401 | 1730 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1734 | `	}` |
|     94401 | 1735 | `	if( pMap->pActiveSteps ){` |
...
|     94401 | 1748 | `	n = 0;` |
|     94401 | 1749 | `	pEntry = pMap->pFirst;` |
|   1686853 | 1750 | `	for(;;){` |
|   3373711 | 1751 | `		if( n >= pMap->nEntry ){` |
|     94401 | 1752 | `			break;` |
|         - | 1753 | `		}` |
|   3279315 | 1754 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1755 | `		/* Remove the reference from the foreign table */` |
|   3279315 | 1756 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3279315 | 1757 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1758 | `			/* Restore the ph7_value to the free list */` |
|   3279305 | 1759 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1639650 | 1760 | `		}` |
|         - | 1761 | `		/* Release the node */` |
|   3279315 | 1762 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    166163 | 1763 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     83079 | 1764 | `		}` |
|   3279315 | 1765 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1766 | `		/* Point to the next entry */` |
|   3279315 | 1767 | `		pEntry = pNext;` |
|   3279315 | 1768 | `		n++;` |
|         5 | 1769 | `	}` |
|     94401 | 1770 | `	if( pMap->nEntry > 0 ){` |
|         - | 1771 | `		/* Release the hash bucket */` |
|     72003 | 1772 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     35999 | 1773 | `	}` |
|     94401 | 1774 | `	if( FreeDS ){` |
|         - | 1775 | `		/* Free the whole instance */` |
|     94377 | 1776 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47191 | 1777 | `	}else{` |
...
|         - | 1790 | ` */` |
|    807684 | 1791 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1792 | `{` |
|    807689 | 1793 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1794 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    807689 | 1795 | `	pMap->iRef--;` |
|    807689 | 1796 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94357 | 1797 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47176 | 1798 | `	}` |
|    807689 | 1799 | `}` |
|         - | 1800 | `/*` |
...
|         - | 1804 | ` */` |
|    135888 | 1805 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1825 | ` */` |
|   2674730 | 1826 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2674735 | 1837 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2674735 | 1838 | `	return rc;` |
|         5 | 1839 | `}` |
|         - | 1840 | `/*` |
...
|         - | 1845 | ` */` |
|        54 | 1846 | `PH7_PRIVATE sxi32 PH7_HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         1 | 1847 | `{` |
|        55 | 1848 | `	return HashmapMerge(&(*pSrc),&(*pDest));` |
|         1 | 1849 | `}` |
|         - | 1850 | `/*` |
...
|         - | 1876 | ` */` |
|     46838 | 1877 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1882 | `{` |
|         - | 1883 | `	sxi32 rc;` |
|     46843 | 1884 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1890 | `	}` |
|     46843 | 1891 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46843 | 1892 | `	return rc;` |
|     23424 | 1893 | `}` |
|         - | 1894 | `/*` |
...
|         - | 1901 | ` */` |
|     18580 | 1902 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1903 | `{` |
|     18585 | 1904 | `	pStep->pCursor = pMap->pFirst;` |
|     18585 | 1905 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     18585 | 1906 | `	pMap->pActiveSteps = pStep;` |
|     18585 | 1907 | `}` |
|         - | 1908 | `/*` |
...
|         - | 1913 | ` */` |
|     18490 | 1914 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1915 | `{` |
|     18495 | 1916 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     18495 | 1917 | `	while( *ppLink ){` |
|     18495 | 1918 | `		if( *ppLink == pStep ){` |
|     18495 | 1919 | `			*ppLink = pStep->pNextActive;` |
|     18495 | 1920 | `			pStep->pNextActive = 0;` |
|     18495 | 1921 | `			return;` |
|         - | 1922 | `		}` |
...
|         - | 1945 | ` */` |
|    571716 | 1946 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1947 | `{` |
|    571721 | 1948 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    571721 | 1949 | `	if( pEntry ){` |
|    571721 | 1950 | `		if( bStore ){` |
|    226681 | 1951 | `			PH7_MemObjStore(pEntry,pValue);` |
|    113343 | 1952 | `		}else{` |
|    345045 | 1953 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1954 | `		}` |
|    285846 | 1955 | `	}else{` |
...
|         - | 1961 | ` */` |
|    148936 | 1962 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 1963 | `{` |
|         - | 1964 | `	/* Fill with the current key */` |
|    148941 | 1965 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    144057 | 1966 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 1967 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 1968 | `		}` |
|    144057 | 1969 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    144057 | 1970 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     72031 | 1971 | `	}else{` |
|      4889 | 1972 | `		SyBlobReset(&pKey->sBlob);` |
|      4889 | 1973 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      4889 | 1974 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 1975 | `	}` |
|    148941 | 1976 | `}` |
...
|         - | 2025 | `**   changed.` |
|         - | 2026 | `*/` |
|     34832 | 2027 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2028 | `{` |
|         - | 2029 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2030 | `    /* Prevent compiler warning */` |
|     34837 | 2031 | `	result.pNext = result.pPrev = 0;` |
|     34837 | 2032 | `	pTail = &result;` |
|    105783 | 2033 | `	while( pA && pB ){` |
|     70951 | 2034 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47017 | 2035 | `			pTail->pPrev = pA;` |
|     47017 | 2036 | `			pA->pNext = pTail;` |
|     47017 | 2037 | `			pTail = pA;` |
|     47017 | 2038 | `			pA = pA->pPrev;` |
|     23466 | 2039 | `		}else{` |
|     23939 | 2040 | `			pTail->pPrev = pB;` |
|     23939 | 2041 | `			pB->pNext = pTail;` |
|     23939 | 2042 | `			pTail = pB;` |
|     23939 | 2043 | `			pB = pB->pPrev;` |
|         - | 2044 | `		}` |
|         5 | 2045 | `	}` |
|     34837 | 2046 | `	if( pA ){` |
|     24472 | 2047 | `		pTail->pPrev = pA;` |
|     24472 | 2048 | `		pA->pNext = pTail;` |
|     22641 | 2049 | `	}else if( pB ){` |
|     10148 | 2050 | `		pTail->pPrev = pB;` |
|     10148 | 2051 | `		pB->pNext = pTail;` |
|      5039 | 2052 | `	}else{` |
|       227 | 2053 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2054 | `	}` |
|     34837 | 2055 | `	return result.pPrev;` |
|         5 | 2056 | `}` |
|         - | 2057 | `/*` |
|         - | 2058 | `** Inputs:` |
...
|     14449 | 2076 | `	while( pIn ){` |
|     13727 | 2077 | `		p = pIn;` |
|     13727 | 2078 | `		pIn = p->pPrev;` |
|     13727 | 2079 | `		p->pPrev = 0;` |
|     26177 | 2080 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     26177 | 2081 | `			if( a[i]==0 ){` |
|     13727 | 2082 | `				a[i] = p;` |
|     13727 | 2083 | `				break;` |
|       ! 0 | 2084 | `			}else{` |
|     12455 | 2085 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12455 | 2086 | `				a[i] = 0;` |
|         - | 2087 | `			}` |
|      6230 | 2088 | `		}` |
|     13727 | 2089 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|         - | 2111 | ` */` |
|     70729 | 2112 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2113 | `{` |
|         - | 2114 | `	ph7_value sA,sB;` |
|         - | 2115 | `	sxi32 iFlags;` |
|         - | 2116 | `	int rc;` |
|     70734 | 2117 | `	if( pCmpData == 0 ){` |
|         - | 2118 | `		/* Perform a standard comparison */` |
|     70710 | 2119 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|     70710 | 2120 | `		return rc;` |
|         - | 2121 | `	}` |
...
|         2 | 2430 | `		}` |
|     13553 | 2431 | `		HashmapRehashIntNode(p);` |
|         - | 2432 | `		/* Point to the next entry */` |
|     13553 | 2433 | `		i++;` |
|     13553 | 2434 | `		pLast = p;` |
|     13553 | 2435 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2436 | `	}` |
|       677 | 2437 | `}` |
|         - | 2438 | `/*` |
...
|        10 | 2928 | `		while(pMap->pLast->pPrev){` |
|         8 | 2929 | `			pMap->pLast = pMap->pLast->pPrev;` |
|         1 | 2930 | `		}` |
|         1 | 2931 | `	}` |
...
|         - | 2948 | ` */` |
|      1190 | 2949 | `static int ph7_hashmap_count(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 2950 | `{` |
|      1195 | 2951 | `	int bRecursive = FALSE;` |
|      1195 | 2952 | `	int bCycleDetected = FALSE;` |
|         - | 2953 | `	sxi64 iCount;` |
|      1195 | 2954 | `	if( nArg < 1 ){` |
...
|        16 | 2979 | `	}` |
|      1183 | 2980 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|         - | 3003 | `	}` |
|         - | 3004 | `	/* Count */` |
|      1151 | 3005 | `	iCount = HashmapCount((ph7_hashmap *)apArg[0]->x.pOther,bRecursive,&bCycleDetected);` |
|      1151 | 3006 | `	if( bCycleDetected ){` |
|         3 | 3007 | `		PH7_VmThrowError(pCtx->pVm,0,PH7_CTX_WARNING,"count(): Recursion detected");` |
|         1 | 3008 | `	}` |
|      1151 | 3009 | `	ph7_result_int64(pCtx,iCount);` |
|      1151 | 3010 | `	return PH7_OK;` |
|       600 | 3011 | `}` |
|         - | 3012 | `/*` |
...
|         - | 4805 | ` */` |
|     32850 | 4806 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4807 | `{` |
|         - | 4808 | `	ph7_value *pNeedle;` |
|         - | 4809 | `	int bStrict;` |
|         - | 4810 | `	int rc;` |
|     32855 | 4811 | `	if( nArg < 2 ){` |
|         - | 4812 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4813 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4814 | `		return PH7_OK;` |
|         - | 4815 | `	}` |
|     32855 | 4816 | `	pNeedle = apArg[0];` |
|     32855 | 4817 | `	bStrict = 0;` |
|     32855 | 4818 | `	if( nArg > 2 ){` |
|        43 | 4819 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        21 | 4820 | `	}` |
|     32855 | 4821 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     32855 | 4829 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4830 | `	/* Lookup result */` |
|     32855 | 4831 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     32855 | 4832 | `	return PH7_OK;` |
|     16430 | 4833 | `}` |
|         - | 4834 | `/*` |
...
|         4 | 6963 | `				pNode = pNode->pPrev; /* Reverse link */` |
|         4 | 6964 | `				nEntry--;` |
|         1 | 6965 | `			}` |
|         - | 6966 | `		}` |
...
|         - | 8037 | ` */` |
|       220 | 8038 | `PH7_PRIVATE int PH7_HashmapIsList(ph7_hashmap *pMap)` |
|         1 | 8039 | `{` |
|       221 | 8040 | `	ph7_hashmap_node *pNode = pMap->pFirst;` |
|       221 | 8041 | `	sxi64 iExpect = 0;` |
|         - | 8042 | `	sxu32 n;` |
|       477 | 8043 | `	for( n = 0 ; n < pMap->nEntry ; ++n ){` |
|       343 | 8044 | `		if( pNode->iType != HASHMAP_INT_NODE \|\| pNode->xKey.iKey != iExpect ){` |
...
|         - | 8744 | ` */` |
|     33674 | 8745 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33679 | 8756 | `	rc = SXRET_OK;` |
|     33679 | 8757 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33679 | 8758 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33679 | 8759 | `	n = pMap->nEntry;` |
|     33679 | 8760 | `	pEntry = pMap->pFirst;` |
...
|    143757 | 8767 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    143757 | 8768 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8769 | `		/* Invoke the user callback */` |
|    143757 | 8770 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8771 | `		/* Release the copy of the key and the value */` |
|    143757 | 8772 | `		PH7_MemObjRelease(&sKey);` |
|    143757 | 8773 | `		PH7_MemObjRelease(&sValue);` |
|    143757 | 8774 | `		if( rc != PH7_OK ){` |
|         - | 8775 | `			/* Callback request an operation abort */` |
|       ! 0 | 8776 | `			return SXERR_ABORT;` |
|         - | 8777 | `		}` |
|         - | 8778 | `		/* Point to the next entry */` |
|    143757 | 8779 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    143757 | 8780 | `		n--;` |
|         5 | 8781 | `	}` |
|         - | 8782 | `	/* All done */` |
|     33679 | 8783 | `	return SXRET_OK;` |
|     16842 | 8784 | `}` |
|         - | 8785 |  |
