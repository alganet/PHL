...
|       - |   17 | ` */` |
| 2946416 |   18 | `static sxu32 IntHash(sxi64 iKey)` |
|       2 |   19 |  |
| 2946418 |   20 | `	return (sxu32)(iKey ^ (iKey << 8) ^ (iKey >> 8));` |
|       2 |   21 |  |
|       - |   22 | `/*` |
|       - |   23 | ` * Default hash function for string/BLOB keys.` |
|       - |   24 | ` */` |
|  276078 |   25 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|       2 |   26 |  |
|  276080 |   27 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|       - |   28 | `	unsigned char *zEnd;` |
|  276080 |   29 | `	sxu32 nH = 5381;` |
|  276080 |   30 | `	zEnd = &zIn[nLen];` |
|  310523 |   31 | `	for(;;){` |
|  621048 |   32 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  548690 |   33 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  493816 |   34 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  405784 |   35 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|       2 |   36 | `	}` |
|  276080 |   37 | `	return nH;` |
|       2 |   38 |  |
|       - |   39 | `/*` |
...
|       - |   92 | ` */` |
| 2889384 |   93 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|       2 |   94 |  |
|       - |   95 | `	ph7_hashmap_node *pNode;` |
|       - |   96 | `	/* Allocate a new node */` |
| 2889386 |   97 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
| 2889386 |   98 | `	if( pNode == 0 ){` |
|     ! 0 |   99 | `		return 0;` |
|       - |  100 | `	}` |
|       - |  101 | `	/* Zero the stucture */` |
| 2889386 |  102 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  103 | `	/* Fill in the structure */` |
| 2889386 |  104 | `	pNode->pMap  = &(*pMap);` |
| 2889386 |  105 | `	pNode->iType = HASHMAP_INT_NODE;` |
| 2889386 |  106 | `	pNode->nHash = nHash;` |
| 2889386 |  107 | `	pNode->xKey.iKey = iKey;` |
| 2889386 |  108 | `	pNode->nValIdx  = nValIdx;` |
| 2889386 |  109 | `	return pNode;` |
| 1444694 |  110 |  |
|       - |  111 | `/*` |
...
|       - |  115 | ` */` |
|   96420 |  116 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|       2 |  117 |  |
|       - |  118 | `	ph7_hashmap_node *pNode;` |
|       - |  119 | `	/* Allocate a new node */` |
|   96422 |  120 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   96422 |  121 | `	if( pNode == 0 ){` |
|     ! 0 |  122 | `		return 0;` |
|       - |  123 | `	}` |
|       - |  124 | `	/* Zero the stucture */` |
|   96422 |  125 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  126 | `	/* Fill in the structure */` |
|   96422 |  127 | `	pNode->pMap  = &(*pMap);` |
|   96422 |  128 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|   96422 |  129 | `	pNode->nHash = nHash;` |
|   96422 |  130 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|   96422 |  131 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|   96422 |  132 | `	pNode->nValIdx = nValIdx;` |
|   96422 |  133 | `	return pNode;` |
|   48212 |  134 |  |
|       - |  135 | `/*` |
|       - |  136 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|       - |  137 | ` */` |
| 2985804 |  138 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|       2 |  139 |  |
|       - |  140 | `	/* Link */` |
| 2985806 |  141 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
| 2724026 |  142 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
| 2724026 |  143 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
| 1362012 |  144 | `	}` |
| 2985806 |  145 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|       - |  146 | `	/* Link to the map list */` |
| 2985806 |  147 | `	if( pMap->pFirst == 0 ){` |
|   45924 |  148 | `		pMap->pFirst = pMap->pLast = pNode;` |
|       - |  149 | `		/* Point to the first inserted node */` |
|   45924 |  150 | `		pMap->pCur = pNode;` |
|   22963 |  151 | `	}else{` |
| 2939884 |  152 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|       - |  153 | `	}` |
| 2985806 |  154 | `	++pMap->nEntry;` |
| 2985806 |  155 |  |
|       - |  156 | `/*` |
...
|       - |  206 | ` */` |
| 2985804 |  207 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|       2 |  208 |  |
| 2985806 |  209 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|   50074 |  210 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|       - |  211 | `		ph7_hashmap_node *pEntry,**apNew;` |
|   50074 |  212 | `		sxu32 nNew = pMap->nSize << 1;` |
|       - |  213 | `		sxu32 nBucket;` |
|       - |  214 | `		sxu32 n;` |
|   50074 |  215 | `		if( nNew < 1 ){` |
|   45924 |  216 | `			nNew = 16;` |
...
|   50074 |  219 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|   50074 |  220 | `		if( apNew == 0 ){` |
...
|       - |  226 | `		}` |
|       - |  227 | `		/* Zero the table */` |
|   50074 |  228 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|       - |  229 | `		/* Reflect the change */` |
|   50074 |  230 | `		pMap->apBucket = apNew;` |
|   50074 |  231 | `		pMap->nSize = nNew;` |
|   50074 |  232 | `		if( apOld == 0 ){` |
|       - |  233 | `			/* First allocated table [i.e: no entry],return immediately */` |
|   45924 |  234 | `			return SXRET_OK;` |
|       - |  235 | `		}` |
...
|    2075 |  258 | `	}` |
| 2939884 |  259 | `	return SXRET_OK;` |
| 1492904 |  260 |  |
|       - |  261 | `/*` |
|       - |  262 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|       - |  263 | ` * hashmap.` |
|       - |  264 | ` */` |
| 2889384 |  265 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  266 |  |
|       - |  267 | `	ph7_hashmap_node *pNode;` |
|       - |  268 | `	sxu32 nIdx;` |
|       - |  269 | `	sxu32 nHash;` |
|       - |  270 | `	sxi32 rc;` |
| 2889386 |  271 | `	if( !isForeign ){` |
|       - |  272 | `		ph7_value *pObj;` |
|       - |  273 | `		/* Reserve a ph7_value for the value */` |
| 2889360 |  274 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
| 2889360 |  275 | `		if( pObj == 0 ){` |
|     ! 0 |  276 | `			return SXERR_MEM;` |
|       - |  277 | `		}` |
| 2889360 |  278 | `		if( pValue ){` |
|       - |  279 | `			/* Duplicate the value */` |
| 2889360 |  280 | `			PH7_MemObjStore(pValue,pObj);` |
| 1444679 |  281 | `		}` |
| 2889360 |  282 | `		nIdx = pObj->nIdx;` |
| 1444681 |  283 | `	}else{` |
|      27 |  284 | `		nIdx = nRefIdx;` |
|       - |  285 | `	}` |
|       - |  286 | `	/* Hash the key */` |
| 2889386 |  287 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  288 | `	/* Allocate a new int node */` |
| 2889386 |  289 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
| 2889386 |  290 | `	if( pNode == 0 ){` |
|     ! 0 |  291 | `		return SXERR_MEM;` |
|       - |  292 | `	}` |
| 2889386 |  293 | `	if( isForeign ){` |
...
| 2889386 |  298 | `	rc = HashmapGrowBucket(&(*pMap));` |
| 2889386 |  299 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  300 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  301 | `		return rc;` |
|       - |  302 | `	}` |
|       - |  303 | `	/* Perform the insertion */` |
| 2889386 |  304 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  305 | `	/* Install in the reference table */` |
| 2889386 |  306 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  307 | `	/* All done */` |
| 2889386 |  308 | `	return SXRET_OK;` |
| 1444694 |  309 |  |
|       - |  310 | `/*` |
|       - |  311 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|       - |  312 | ` * hashmap.` |
|       - |  313 | ` */` |
|   96420 |  314 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  315 |  |
|       - |  316 | `	ph7_hashmap_node *pNode;` |
|       - |  317 | `	sxu32 nHash;` |
|       - |  318 | `	sxu32 nIdx;` |
|       - |  319 | `	sxi32 rc;` |
|   96422 |  320 | `	if( !isForeign ){` |
|       - |  321 | `		ph7_value *pObj;` |
|       - |  322 | `		/* Reserve a ph7_value for the value */` |
|   65870 |  323 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   65870 |  324 | `		if( pObj == 0 ){` |
|     ! 0 |  325 | `			return SXERR_MEM;` |
|       - |  326 | `		}` |
|   65870 |  327 | `		if( pValue ){` |
|       - |  328 | `			/* Duplicate the value */` |
|   65606 |  329 | `			PH7_MemObjStore(pValue,pObj);` |
|   32802 |  330 | `		}` |
|   65870 |  331 | `		nIdx = pObj->nIdx;` |
|   32936 |  332 | `	}else{` |
|   30554 |  333 | `		nIdx = nRefIdx;` |
|       - |  334 | `	}` |
|       - |  335 | `	/* Hash the key */` |
|   96422 |  336 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  337 | `	/* Allocate a new blob node */` |
|   96422 |  338 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|   96422 |  339 | `	if( pNode == 0 ){` |
|     ! 0 |  340 | `		return SXERR_MEM;` |
|       - |  341 | `	}` |
|   96422 |  342 | `	if( isForeign ){` |
|       - |  343 | `		/* Mark as a foregin entry */` |
|   30554 |  344 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|   15276 |  345 | `	}` |
|       - |  346 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|   96422 |  347 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   96422 |  348 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  349 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  350 | `		return rc;` |
|       - |  351 | `	}` |
|       - |  352 | `	/* Perform the insertion */` |
|   96422 |  353 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  354 | `	/* Install in the reference table */` |
|   96422 |  355 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  356 | `	/* All done */` |
|   96422 |  357 | `	return SXRET_OK;` |
|   48212 |  358 |  |
|       - |  359 | `/*` |
...
|       - |  404 | ` */` |
|  190754 |  405 | `static sxi32 HashmapLookupBlobKey(` |
...
|       - |  413 | `	sxu32 nHash;` |
|  190756 |  414 | `	if( pMap->nEntry < 1 ){` |
|       - |  415 | `		/* Don't bother hashing,there is no entry anyway */` |
|   11098 |  416 | `		return SXERR_NOTFOUND;` |
|       - |  417 | `	}` |
|       - |  418 | `	/* Hash the key first */` |
|  179660 |  419 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  420 | `	/* Point to the appropriate bucket */` |
|  179660 |  421 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  422 | `	/* Perform the lookup */` |
|  168832 |  423 | `	for(;;){` |
|  337666 |  424 | `		if( pNode == 0 ){` |
|  137402 |  425 | `			break;` |
|       - |  426 | `		}` |
|  221393 |  427 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|  198765 |  428 | `			&& pNode->nHash == nHash` |
|  119762 |  429 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|   42260 |  430 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|       - |  431 | `				/* Node found */` |
|   42260 |  432 | `				if( ppNode ){` |
|   42232 |  433 | `					*ppNode = pNode;` |
|   21115 |  434 | `				}` |
|   42260 |  435 | `				return SXRET_OK;` |
|       - |  436 | `		}` |
|       - |  437 | `		/* Follow the collision link */` |
|  158008 |  438 | `		pNode = pNode->pNextCollide;` |
|       2 |  439 | `	}` |
|       - |  440 | `	/* No such entry */` |
|  137402 |  441 | `	return SXERR_NOTFOUND;` |
|   95379 |  442 |  |
|       - |  443 | `/*` |
|       - |  444 | ` * Check if the given BLOB key looks like a decimal number.` |
|       - |  445 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|       - |  446 | ` */` |
|  190896 |  447 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|       2 |  448 |  |
|  190898 |  449 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|  190898 |  450 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|  190898 |  451 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|       - |  452 | `		/* Octal not decimal number */` |
|       5 |  453 | `		return FALSE;` |
|       - |  454 | `	}` |
|  190894 |  455 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|     ! 0 |  456 | `		zIn++;` |
|     ! 0 |  457 | `	}` |
|   95779 |  458 | `	for(;;){` |
|  191560 |  459 | `		if( zIn >= zEnd ){` |
|     233 |  460 | `			return TRUE;` |
|       - |  461 | `		}` |
|  191328 |  462 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|   95332 |  463 | `			break;` |
|       - |  464 | `		}` |
|     667 |  465 | `		zIn++;` |
|       1 |  466 | `	}` |
|       - |  467 | `	/* Key does not look like a decimal number */` |
|  190662 |  468 | `	return FALSE;` |
|   95450 |  469 |  |
|       - |  470 | `/*` |
...
|       - |  474 | ` */` |
|   95388 |  475 | `static sxi32 HashmapLookup(` |
|       - |  476 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|       - |  477 | `	ph7_value *pKey,            /* Lookup key */` |
|       - |  478 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|       - |  479 | `	)` |
|       2 |  480 |  |
|   95390 |  481 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|       - |  482 | `	sxi32 rc;` |
|   95390 |  483 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   94296 |  484 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  485 | `			/* Force a string cast */` |
|     ! 0 |  486 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  487 | `		}` |
|   94296 |  488 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|       - |  489 | `			/* Perform a blob lookup */` |
|   94280 |  490 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|   94280 |  491 | `			goto result;` |
|       - |  492 | `		}` |
|       8 |  493 | `	}` |
...
|   47694 |  501 | `result:` |
|   95390 |  502 | `	if( rc == SXRET_OK ){` |
|       - |  503 | `		/* Node found */` |
|   43244 |  504 | `		if( ppNode ){` |
|   43210 |  505 | `			*ppNode = pNode;` |
|   21604 |  506 | `		}` |
|   43244 |  507 | `		return SXRET_OK;` |
|       - |  508 | `	}` |
|       - |  509 | `	/* No such entry */` |
|   52148 |  510 | `	return SXERR_NOTFOUND;` |
|   47696 |  511 |  |
|       - |  512 | `/*` |
...
|       - |  517 | ` */` |
| 2954926 |  518 | `static sxi32 HashmapInsert(` |
|       - |  519 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|       - |  520 | `	ph7_value *pKey,   /* Lookup key  */` |
|       - |  521 | `	ph7_value *pVal    /* Node value */` |
|       - |  522 | `	)` |
|       2 |  523 |  |
| 2954928 |  524 | `	ph7_hashmap_node *pNode = 0;` |
| 2954928 |  525 | `	sxi32 rc = SXRET_OK;` |
| 2954928 |  526 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   66082 |  527 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  528 | `			/* Force a string cast */` |
|       3 |  529 | `			PH7_MemObjToString(&(*pKey));` |
|       1 |  530 | `		}` |
|   66082 |  531 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     256 |  536 | `			goto IntKey;` |
|       - |  537 | `		}` |
|   98741 |  538 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   32913 |  539 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|       - |  552 | `		}` |
|   65774 |  553 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  554 | `			/* Forbidden */` |
...
|   65772 |  559 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|   65772 |  560 | `		return rc;` |
|       - |  561 | `	}` |
| 1444423 |  562 | `IntKey:` |
| 2889102 |  563 | `	if( pKey ){` |
...
|   11635 |  598 | `		}` |
|   11637 |  599 | `	}else{` |
| 2865750 |  600 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  601 | `			/* Forbidden */` |
...
| 2865748 |  606 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
| 2865748 |  607 | `		if( rc == SXRET_OK ){` |
| 2865748 |  608 | `			++pMap->iNextIdx;` |
| 1432873 |  609 | `		}` |
|       - |  610 | `	}` |
|       - |  611 | `	/* Insertion result */` |
| 2889018 |  612 | `	return rc;` |
| 1477465 |  613 |  |
|       - |  614 | `/*` |
...
|       - |  640 | ` */` |
|   30586 |  641 | `static sxi32 HashmapInsertByRef(` |
|       - |  642 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|       - |  643 | `	ph7_value *pKey,     /* Lookup key */` |
|       - |  644 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|       - |  645 | `	)` |
|       2 |  646 |  |
|   30588 |  647 | `	ph7_hashmap_node *pNode = 0;` |
|   30588 |  648 | `	sxi32 rc = SXRET_OK;` |
|   30588 |  649 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   30562 |  650 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  651 | `			/* Force a string cast */` |
|     ! 0 |  652 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  653 | `		}` |
|   30562 |  654 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     ! 0 |  659 | `			goto IntKey;` |
|       - |  660 | `		}` |
|   45842 |  661 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   15280 |  662 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|       - |  663 | `				/* Overwrite */` |
...
|   30554 |  671 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|   30554 |  672 | `		return rc;` |
|       - |  673 | `	}` |
|      13 |  674 | `IntKey:` |
|      27 |  675 | `	if( pKey ){` |
...
|       - |  712 | ` */` |
| 1058207 |  713 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       2 |  714 |  |
|       - |  715 | `	/* Point to the desired object */` |
|       - |  716 | `	ph7_value *pObj;` |
| 1058209 |  717 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
| 1058209 |  718 | `	return pObj;` |
|       2 |  719 |  |
|       - |  720 | `/*` |
...
|       - |  762 | ` * documenation.` |
|       - |  763 | ` */` |
|   46057 |  764 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       2 |  765 |  |
|       - |  766 | `	ph7_value sObj1,sObj2;` |
|       - |  767 | `	sxi32 rc;` |
|   46059 |  768 | `	if( pLeft == pRight ){` |
|       - |  769 | `		/*` |
...
|   46059 |  776 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   46059 |  777 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   46059 |  778 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   46059 |  779 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   46059 |  780 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   46059 |  781 | `	PH7_MemObjRelease(&sObj1);` |
|   46059 |  782 | `	PH7_MemObjRelease(&sObj2);` |
|   46059 |  783 | `	return rc;` |
|   23035 |  784 |  |
|       - |  785 | `/*` |
...
|       - |  788 | ` */` |
|    9888 |  789 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|       2 |  790 |  |
|    9890 |  791 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|       - |  792 | `	sxu32 nBucket;` |
|       - |  793 | `	/* Remove old collision links */` |
|    9890 |  794 | `	if( pEntry->pPrevCollide ){` |
|    7865 |  795 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|    3941 |  796 | `	}else{` |
|    2027 |  797 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|       - |  798 | `	}` |
|    9890 |  799 | `	if( pEntry->pNextCollide ){` |
|     741 |  800 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|     372 |  801 | `	}` |
|    9890 |  802 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  803 | `	/* Compute the new hash */` |
|    9890 |  804 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|    9890 |  805 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|    9890 |  806 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|       - |  807 | `	/* Link to the new bucket */` |
|    9890 |  808 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|    9890 |  809 | `	if( pMap->apBucket[nBucket] ){` |
|    8080 |  810 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|    4056 |  811 | `	}` |
|    9890 |  812 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|    9890 |  813 | `	pMap->apBucket[nBucket] = pEntry;` |
|       - |  814 | `	/* Increment the automatic index */` |
|    9890 |  815 | `	pMap->iNextIdx++;` |
|    9890 |  816 |  |
|       - |  817 | `/*` |
...
|       - |  823 | ` */` |
|   24866 |  824 | `static int HashmapFindValue(` |
...
|   24868 |  837 | `	pEntry = pMap->pFirst;` |
|   24868 |  838 | `	n = pMap->nEntry;` |
|   24868 |  839 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|   24868 |  840 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|   59624 |  841 | `	for(;;){` |
|  119251 |  842 | `		if( n < 1 ){` |
|      99 |  843 | `			break;` |
|       - |  844 | `		}` |
|       - |  845 | `		/* Extract node value */` |
|  119153 |  846 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  119153 |  847 | `		if( pVal ){` |
|  119153 |  848 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  858 | `			}else{` |
|       - |  859 | `				/* Duplicate value */` |
|  119153 |  860 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  119153 |  861 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  119153 |  862 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  119153 |  863 | `				PH7_MemObjRelease(&sVal);` |
|  119153 |  864 | `				PH7_MemObjRelease(&sNeedle);` |
|  119153 |  865 | `				if( rc == 0 ){` |
|   24770 |  866 | `					if( ppNode ){` |
|      23 |  867 | `						*ppNode = pEntry;` |
|      11 |  868 | `					}` |
|       - |  869 | `					/* Match found*/` |
|   24770 |  870 | `					return SXRET_OK;` |
|       - |  871 | `				}` |
|       - |  872 | `			}` |
|   47191 |  873 | `		}` |
|       - |  874 | `		/* Point to the next entry */` |
|   94385 |  875 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   94385 |  876 | `		n--;` |
|       2 |  877 | `	}` |
|       - |  878 | `	/* No such entry */` |
...
|       - | 1053 | ` */` |
|  520970 | 1054 | `static sxi32 HashmapDuplicateNode(` |
...
|       - | 1059 | `	)` |
|       2 | 1060 |  |
|  520972 | 1061 | `	ph7_value sSafeVal = *pVal;` |
|       - | 1062 | `	ph7_value sKey;` |
|       - | 1063 | `	sxi32 rc;` |
|       - | 1064 |  |
|  520972 | 1065 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      26 | 1071 | `	}else{` |
|       - | 1072 | `		/* Int key */` |
|  520922 | 1073 | `		if( iAction == 0 ){ /* Merge */` |
|  520704 | 1074 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|  260571 | 1075 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|  522584 | 1112 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|       - | 1113 | `		/* Extract the node value */` |
|  520720 | 1114 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  520720 | 1115 | `		if( pVal ){` |
...
|       - | 1120 | `			 */` |
|  520720 | 1121 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|  260361 | 1122 | `		}else{` |
|     ! 0 | 1123 | `			rc = SXRET_OK;` |
|       - | 1124 | `		}` |
|  520720 | 1125 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1126 | `			return rc;` |
|       - | 1127 | `		}` |
|       - | 1128 | `		/* Point to the next entry */` |
|  520720 | 1129 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  260361 | 1130 | `	}` |
...
|       - | 1218 | ` */` |
|  171510 | 1219 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|       2 | 1220 |  |
|  171512 | 1221 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - | 1222 | `	ph7_hashmap *pNew;` |
|       - | 1223 | `	ph7_value *pBacking;` |
|  171512 | 1224 | `	if( pMap->iRef < 2 ){` |
|       - | 1225 | `		/* Sole owner, no separation needed */` |
|  169494 | 1226 | `		return pMap;` |
|       - | 1227 | `	}` |
...
|       - | 1372 | ` */` |
|   72158 | 1373 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|   72160 | 1381 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|   72160 | 1382 | `	if( pMap == 0 ){` |
|     ! 0 | 1383 | `		return 0;` |
|       - | 1384 | `	}` |
|       - | 1385 | `	/* Zero the structure */` |
|   72160 | 1386 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|       - | 1387 | `	/* Fill in the structure */` |
|   72160 | 1388 | `	pMap->pVm = &(*pVm);` |
|   72160 | 1389 | `	pMap->iRef = 1;` |
|       - | 1390 | `	/* Default hash functions */` |
|   72160 | 1391 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|   72160 | 1392 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|   72160 | 1393 | `	return pMap;` |
|   36081 | 1394 |  |
|       - | 1395 | `/*` |
...
|       - | 1413 | `*    $_ENV` |
|       - | 1414 | `*/` |
|    2354 | 1415 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|       2 | 1416 |  |
...
|    2356 | 1435 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    2356 | 1436 | `	if( pMap == 0 ){` |
|     ! 0 | 1437 | `		return SXERR_MEM;` |
|       - | 1438 | `	}` |
|    2356 | 1439 | `	pVm->pGlobal = pMap;` |
|       - | 1440 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|    2356 | 1441 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|    2356 | 1442 | `	if( pObj == 0 ){` |
|     ! 0 | 1443 | `		return SXERR_MEM;` |
|       - | 1444 | `	}` |
|    2356 | 1445 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|       - | 1446 | `	/* Record object index */` |
|    2356 | 1447 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|       - | 1448 | `	/* Install the special $GLOBALS array */` |
|    2356 | 1449 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|    2356 | 1450 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 1451 | `		return rc;` |
|       - | 1452 | `	}` |
|       - | 1453 | `	/* Install superglobals now */` |
|   25896 | 1454 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|       - | 1455 | `		ph7_value *pSuper;` |
|       - | 1456 | `		/* Request an empty array */` |
|   23542 | 1457 | `		pSuper = ph7_new_array(&(*pVm));` |
|   23542 | 1458 | `		if( pSuper == 0 ){` |
|     ! 0 | 1459 | `			return SXERR_MEM;` |
|       - | 1460 | `		}` |
|       - | 1461 | `		/* Install */` |
|   23542 | 1462 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|   23542 | 1463 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1464 | `			return rc;` |
|       - | 1465 | `		}` |
|       - | 1466 | `		/* Release the value now it have been installed */` |
|   23542 | 1467 | `		ph7_release_value(&(*pVm),pSuper);` |
|   11772 | 1468 | `	}` |
|       - | 1469 | `	/* Set some $_SERVER entries */` |
|    2356 | 1470 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       - | 1471 | `	/*` |
|       - | 1472 | `	 * 'SCRIPT_FILENAME'` |
|       - | 1473 | `	 * The absolute pathname of the currently executing script.` |
|       - | 1474 | `	 */` |
|    4706 | 1475 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|       - | 1476 | `		"SCRIPT_FILENAME",` |
|    1177 | 1477 | `		pFile ? pFile->zString : ":Memory:",` |
|    2350 | 1478 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|       - | 1479 | `		);` |
|       - | 1480 | `	/* All done,all super-global are installed now */` |
|    2356 | 1481 | `	return SXRET_OK;` |
|    1179 | 1482 |  |
|       - | 1483 | `/*` |
|       - | 1484 | ` * Release a hashmap.` |
|       - | 1485 | ` */` |
|   46124 | 1486 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|       2 | 1487 |  |
|       - | 1488 | `	ph7_hashmap_node *pEntry,*pNext;` |
|   46126 | 1489 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1490 | `	sxu32 n;` |
|   46126 | 1491 | `	if( pMap == pVm->pGlobal ){` |
...
|   46126 | 1497 | `	n = 0;` |
|   46126 | 1498 | `	pEntry = pMap->pFirst;` |
| 1496336 | 1499 | `	for(;;){` |
| 2992674 | 1500 | `		if( n >= pMap->nEntry ){` |
|   46126 | 1501 | `			break;` |
|       - | 1502 | `		}` |
| 2946550 | 1503 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|       - | 1504 | `		/* Remove the reference from the foreign table */` |
| 2946550 | 1505 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
| 2946550 | 1506 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|       - | 1507 | `			/* Restore the ph7_value to the free list */` |
| 2946542 | 1508 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
| 1473270 | 1509 | `		}` |
|       - | 1510 | `		/* Release the node */` |
| 2946550 | 1511 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|   62284 | 1512 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|   31141 | 1513 | `		}` |
| 2946550 | 1514 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|       - | 1515 | `		/* Point to the next entry */` |
| 2946550 | 1516 | `		pEntry = pNext;` |
| 2946550 | 1517 | `		n++;` |
|       2 | 1518 | `	}` |
|   46126 | 1519 | `	if( pMap->nEntry > 0 ){` |
|       - | 1520 | `		/* Release the hash bucket */` |
|   41012 | 1521 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|   20505 | 1522 | `	}` |
|   46126 | 1523 | `	if( FreeDS ){` |
|       - | 1524 | `		/* Free the whole instance */` |
|   46110 | 1525 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|   23056 | 1526 | `	}else{` |
...
|       - | 1539 | ` */` |
|  518312 | 1540 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|       2 | 1541 |  |
|  518314 | 1542 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1543 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|  518314 | 1544 | `	pMap->iRef--;` |
|  518314 | 1545 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|   46110 | 1546 | `		PH7_HashmapRelease(pMap,TRUE);` |
|   23054 | 1547 | `	}` |
|  518314 | 1548 |  |
|       - | 1549 | `/*` |
...
|       - | 1553 | ` */` |
|   95406 | 1554 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|       - | 1574 | ` */` |
| 2434012 | 1575 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|       2 | 1580 |  |
|       - | 1581 | `	sxi32 rc;` |
| 2434014 | 1582 | `	if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP) && (ph7_hashmap *)pVal->x.pOther == pMap->pVm->pGlobal ){` |
|       - | 1583 | `		/*` |
...
|       - | 1588 | `	}` |
| 2434014 | 1589 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
| 2434014 | 1590 | `	return rc;` |
| 1217008 | 1591 |  |
|       - | 1592 | `/*` |
...
|       - | 1618 | ` */` |
|   30586 | 1619 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|       2 | 1624 |  |
|       - | 1625 | `	sxi32 rc;` |
|   30588 | 1626 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
|       - | 1627 | `		/*` |
...
|       - | 1632 | `	}` |
|   30588 | 1633 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|   30588 | 1634 | `	return rc;` |
|   15295 | 1635 |  |
|       - | 1636 | `/*` |
|       - | 1637 | ` * Reset the node cursor of a given hashmap.` |
|       - | 1638 | ` */` |
|   20630 | 1639 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|       2 | 1640 |  |
|       - | 1641 | `	/* Reset the loop cursor */` |
|   20632 | 1642 | `	pMap->pCur = pMap->pFirst;` |
|   20632 | 1643 |  |
|       - | 1644 | `/*` |
...
|       - | 1649 | ` */` |
|  167608 | 1650 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|       2 | 1651 |  |
|  167610 | 1652 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|  167610 | 1653 | `	if( pCur == 0 ){` |
|       - | 1654 | `		/* End of the list,return null */` |
|   10336 | 1655 | `		return 0;` |
|       - | 1656 | `	}` |
|       - | 1657 | `	/* Advance the node cursor */` |
|  157276 | 1658 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|  157276 | 1659 | `	return pCur;` |
|   83806 | 1660 |  |
|       - | 1661 | `/*` |
|       - | 1662 | ` * Extract a node value.` |
|       - | 1663 | ` */` |
|  394268 | 1664 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       2 | 1665 |  |
|  394270 | 1666 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  394270 | 1667 | `	if( pEntry ){` |
|  394270 | 1668 | `		if( bStore ){` |
|  157410 | 1669 | `			PH7_MemObjStore(pEntry,pValue);` |
|   78706 | 1670 | `		}else{` |
|  236862 | 1671 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1672 | `		}` |
|  197145 | 1673 | `	}else{` |
...
|       - | 1679 | ` */` |
|  101902 | 1680 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|       2 | 1681 |  |
|       - | 1682 | `	/* Fill with the current key */` |
|  101904 | 1683 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|  101624 | 1684 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|      17 | 1685 | `			SyBlobRelease(&pKey->sBlob);` |
|       8 | 1686 | `		}` |
|  101624 | 1687 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|  101624 | 1688 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|   50813 | 1689 | `	}else{` |
...
|       - | 1740 | `**   changed.` |
|       - | 1741 | `*/` |
|   28570 | 1742 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|       2 | 1743 |  |
|       - | 1744 | `	ph7_hashmap_node result,*pTail;` |
|       - | 1745 | `    /* Prevent compiler warning */` |
|   28572 | 1746 | `	result.pNext = result.pPrev = 0;` |
|   28572 | 1747 | `	pTail = &result;` |
|   74709 | 1748 | `	while( pA && pB ){` |
|   46139 | 1749 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|   30468 | 1750 | `			pTail->pPrev = pA;` |
|   30468 | 1751 | `			pA->pNext = pTail;` |
|   30468 | 1752 | `			pTail = pA;` |
|   30468 | 1753 | `			pA = pA->pPrev;` |
|   15215 | 1754 | `		}else{` |
|   15673 | 1755 | `			pTail->pPrev = pB;` |
|   15673 | 1756 | `			pB->pNext = pTail;` |
|   15673 | 1757 | `			pTail = pB;` |
|   15673 | 1758 | `			pB = pB->pPrev;` |
|       - | 1759 | `		}` |
|       2 | 1760 | `	}` |
|   28572 | 1761 | `	if( pA ){` |
|   21025 | 1762 | `		pTail->pPrev = pA;` |
|   21025 | 1763 | `		pA->pNext = pTail;` |
|   18074 | 1764 | `	}else if( pB ){` |
|    7331 | 1765 | `		pTail->pPrev = pB;` |
|    7331 | 1766 | `		pB->pNext = pTail;` |
|    3653 | 1767 | `	}else{` |
|     220 | 1768 | `		pTail->pPrev = pTail->pNext = 0;` |
|       - | 1769 | `	}` |
|   28572 | 1770 | `	return result.pPrev;` |
|       2 | 1771 |  |
|       - | 1772 | `/*` |
|       - | 1773 | `** Inputs:` |
...
|   10640 | 1791 | `	while( pIn ){` |
|   10006 | 1792 | `		p = pIn;` |
|   10006 | 1793 | `		pIn = p->pPrev;` |
|   10006 | 1794 | `		p->pPrev = 0;` |
|   18922 | 1795 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|   18922 | 1796 | `			if( a[i]==0 ){` |
|   10006 | 1797 | `				a[i] = p;` |
|   10006 | 1798 | `				break;` |
|     ! 0 | 1799 | `			}else{` |
|    8918 | 1800 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|    8918 | 1801 | `				a[i] = 0;` |
|       - | 1802 | `			}` |
|    4460 | 1803 | `		}` |
|   10006 | 1804 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       - | 1825 | ` */` |
|   46009 | 1826 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       2 | 1827 |  |
|       - | 1828 | `	ph7_value sA,sB;` |
|       - | 1829 | `	sxi32 iFlags;` |
|       - | 1830 | `	int rc;` |
|   46011 | 1831 | `	if( pCmpData == 0 ){` |
|       - | 1832 | `		/* Perform a standard comparison */` |
|   45987 | 1833 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   45987 | 1834 | `		return rc;` |
|       - | 1835 | `	}` |
...
|       2 | 2124 | `		}` |
|    9836 | 2125 | `		HashmapRehashIntNode(p);` |
|       - | 2126 | `		/* Point to the next entry */` |
|    9836 | 2127 | `		i++;` |
|    9836 | 2128 | `		pLast = p;` |
|    9836 | 2129 | `		p = p->pPrev; /* Reverse link */` |
|       2 | 2130 | `	}` |
|     588 | 2131 |  |
|       - | 2132 | `/*` |
...
|       - | 3913 | ` */` |
|   24674 | 3914 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 3915 |  |
|       - | 3916 | `	ph7_value *pNeedle;` |
|       - | 3917 | `	int bStrict;` |
|       - | 3918 | `	int rc;` |
|   24676 | 3919 | `	if( nArg < 2 ){` |
|       - | 3920 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 3921 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 3922 | `		return PH7_OK;` |
|       - | 3923 | `	}` |
|   24676 | 3924 | `	pNeedle = apArg[0];` |
|   24676 | 3925 | `	bStrict = 0;` |
|   24676 | 3926 | `	if( nArg > 2 ){` |
|       5 | 3927 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|       2 | 3928 | `	}` |
|   24676 | 3929 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   24676 | 3937 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 3938 | `	/* Lookup result */` |
|   24676 | 3939 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   24676 | 3940 | `	return PH7_OK;` |
|   12339 | 3941 |  |
|       - | 3942 | `/*` |
...
|       - | 6865 | ` */` |
|    2354 | 6866 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|       2 | 6867 |  |
|       - | 6868 | `	sxu32 n;` |
|  145950 | 6869 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|  143596 | 6870 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|   71799 | 6871 | `	}` |
|    2356 | 6872 |  |
|       - | 6873 | `/*` |
...
|       - | 6961 | ` */` |
|   24964 | 6962 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|   24966 | 6973 | `	rc = SXRET_OK;` |
|   24966 | 6974 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|   24966 | 6975 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|   24966 | 6976 | `	n = pMap->nEntry;` |
|   24966 | 6977 | `	pEntry = pMap->pFirst;` |
...
|  101374 | 6984 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|  101374 | 6985 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|       - | 6986 | `		/* Invoke the user callback */` |
|  101374 | 6987 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|       - | 6988 | `		/* Release the copy of the key and the value */` |
|  101374 | 6989 | `		PH7_MemObjRelease(&sKey);` |
|  101374 | 6990 | `		PH7_MemObjRelease(&sValue);` |
|  101374 | 6991 | `		if( rc != PH7_OK ){` |
|       - | 6992 | `			/* Callback request an operation abort */` |
|     ! 0 | 6993 | `			return SXERR_ABORT;` |
|       - | 6994 | `		}` |
|       - | 6995 | `		/* Point to the next entry */` |
|  101374 | 6996 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  101374 | 6997 | `		n--;` |
|       2 | 6998 | `	}` |
|       - | 6999 | `	/* All done */` |
|   24966 | 7000 | `	return SXRET_OK;` |
|   12484 | 7001 |  |
|       - | 7002 |  |
