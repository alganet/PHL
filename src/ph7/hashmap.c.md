...
|         - |   22 | ` */` |
|   7943862 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7943867 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7943867 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    509910 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    509915 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    509915 |   35 | `	sxu32 nH = 5381;` |
|    509915 |   36 | `	zEnd = &zIn[nLen];` |
|    585289 |   37 | `	for(;;){` |
|   1170583 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1001275 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    902163 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    779197 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    509915 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3638494 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3638499 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3638499 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3638499 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3638499 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3638499 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3638499 |  112 | `	pNode->nHash = nHash;` |
|   3638499 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3638499 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3638499 |  115 | `	return pNode;` |
|   1819252 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    195106 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    195111 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    195111 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    195111 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    195111 |  133 | `	pNode->pMap  = &(*pMap);` |
|    195111 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    195111 |  135 | `	pNode->nHash = nHash;` |
|    195111 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    195111 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    195111 |  138 | `	pNode->nValIdx = nValIdx;` |
|    195111 |  139 | `	return pNode;` |
|     97558 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3833600 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3833605 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3383841 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3383841 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1691918 |  150 | `	}` |
|   3833605 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3833605 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87121 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87121 |  156 | `		pMap->pCur = pNode;` |
|     43563 |  157 | `	}else{` |
|   3746489 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3833605 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3833600 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3833605 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92593 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92593 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92593 |  245 | `		if( nNew < 1 ){` |
|     87121 |  246 | `			nNew = 16;` |
...
|     92593 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92593 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92593 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92593 |  260 | `		pMap->apBucket = apNew;` |
|     92593 |  261 | `		pMap->nSize = nNew;` |
|     92593 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87121 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2736 |  288 | `	}` |
|   3746489 |  289 | `	return SXRET_OK;` |
|   1916805 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3638494 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3638499 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3638457 |  310 | `		if( pValue ){` |
|   3638451 |  311 | `			sSafeVal = *pValue;` |
|   3638451 |  312 | `			pValue = &sSafeVal;` |
|   1819223 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3638457 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3638457 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3638457 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3638451 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1819223 |  322 | `		}` |
|   3638457 |  323 | `		nIdx = pObj->nIdx;` |
|   1819231 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3638499 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3638499 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3638499 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3638499 |  334 | `	if( isForeign ){` |
...
|   3638499 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3638499 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3638499 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3638499 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3638499 |  349 | `	return SXRET_OK;` |
|   1819252 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    195106 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    195111 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    148979 |  370 | `		if( pValue ){` |
|    148669 |  371 | `			sSafeVal = *pValue;` |
|    148669 |  372 | `			pValue = &sSafeVal;` |
|     74332 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    148979 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    148979 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    148979 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    148669 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     74332 |  382 | `		}` |
|    148979 |  383 | `		nIdx = pObj->nIdx;` |
|     74492 |  384 | `	}else{` |
|     46137 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    195111 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    195111 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    195111 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    195111 |  394 | `	if( isForeign ){` |
...
|    195111 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    195111 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    195111 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    195111 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    195111 |  409 | `	return SXRET_OK;` |
|     97558 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    342200 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    342205 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     27401 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    314809 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    314809 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255436 |  475 | `	for(;;){` |
|    510877 |  476 | `		if( pNode == 0 ){` |
|    247547 |  477 | `			break;` |
|         - |  478 | `		}` |
|    263330 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261815 |  480 | `			&& pNode->nHash == nHash` |
|    163832 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     67369 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67267 |  484 | `				if( ppNode ){` |
|     67239 |  485 | `					*ppNode = pNode;` |
|     33617 |  486 | `				}` |
|     67267 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196073 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    247547 |  493 | `	return SXERR_NOTFOUND;` |
|    171105 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    342334 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    342339 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    342339 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    342339 |  504 | `	int isNeg = FALSE, nDigit;` |
|    342339 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    342317 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    342313 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    342313 |  516 | `	zDigit = zIn;` |
|    171590 |  517 | `	for(;;){` |
|    343185 |  518 | `		if( zIn >= zEnd ){` |
|       253 |  519 | `			break;` |
|         - |  520 | `		}` |
|    342933 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    342061 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       873 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    153648 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    153653 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    153653 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    147239 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    147239 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    147223 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    147223 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         8 |  567 | `	}` |
...
|     76824 |  575 | `result:` |
|    153653 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72913 |  578 | `		if( ppNode ){` |
|     72861 |  579 | `			*ppNode = pNode;` |
|     36428 |  580 | `		}` |
|     72913 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80745 |  584 | `	return SXERR_NOTFOUND;` |
|     76829 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1492080 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1492085 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1492079 |  623 | `	return FALSE;` |
|    746045 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3783604 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3783609 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3783609 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3783609 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    148961 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    148961 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    223097 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     74364 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    148247 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    148113 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    148113 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1817324 |  683 | `IntKey:` |
|   3634881 |  684 | `	if( pKey ){` |
...
|   1071317 |  714 | `		}` |
|   1071322 |  715 | `	}else{` |
|   1492051 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1492049 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1492043 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1492043 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1492041 |  726 | `			++pMap->iNextIdx;` |
|    746018 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3634677 |  730 | `	return rc;` |
|   1891807 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1528071 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1528076 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1528076 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     73331 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     73336 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     73336 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     73336 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     73336 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     73336 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     73336 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     73336 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     73336 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     73336 |  921 | `	return rc;` |
|     36666 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14344 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14349 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14349 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11579 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5800 |  934 | `	}else{` |
|      2775 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14349 |  937 | `	if( pEntry->pNextCollide ){` |
|      1025 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       536 |  939 | `	}` |
|     14349 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14349 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14349 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14349 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14349 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14349 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11910 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5969 |  949 | `	}` |
|     14349 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14349 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14349 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14349 |  956 | `		pMap->iNextIdx++;` |
|      7172 |  957 | `	}` |
|     14349 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33592 |  966 | `static int HashmapFindValue(` |
...
|     33597 |  979 | `	pEntry = pMap->pFirst;` |
|     33597 |  980 | `	n = pMap->nEntry;` |
|     33597 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33597 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80178 |  983 | `	for(;;){` |
|    160360 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    160282 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    160282 |  989 | `		if( pVal ){` |
...
|    160282 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    160282 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    160282 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    160282 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    160282 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    160282 | 1001 | `			if( rc == 0 ){` |
|     33519 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33519 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63382 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    126768 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    126768 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    721608 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    721608 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    721610 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    721605 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    721605 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2004 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    717607 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    713985 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    360617 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    716943 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    714045 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    714045 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    714045 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    357025 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    714045 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    714045 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    357025 | 1305 | `	}` |
...
|         - | 1462 | ` */` |
|    243104 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    243109 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    243109 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    243109 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    240333 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|         - | 1648 | ` */` |
|    141546 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141551 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141551 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    141551 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    141551 | 1664 | `	pMap->pVm = &(*pVm);` |
|    141551 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    141551 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141551 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141551 | 1669 | `	return pMap;` |
|     70778 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|     94486 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94491 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|     94491 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|     94491 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|     94491 | 1785 | `	n = 0;` |
|     94491 | 1786 | `	pEntry = pMap->pFirst;` |
|   1910527 | 1787 | `	for(;;){` |
|   3821059 | 1788 | `		if( n >= pMap->nEntry ){` |
|     94491 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3726573 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3726573 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3726573 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3726513 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1863254 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3726573 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    107043 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     53519 | 1801 | `		}` |
|   3726573 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3726573 | 1804 | `		pEntry = pNext;` |
|   3726573 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|     94491 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     68027 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34011 | 1810 | `	}` |
|     94491 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|     94465 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47235 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    872844 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    872849 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    872849 | 1833 | `	pMap->iRef--;` |
|    872849 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94445 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47220 | 1836 | `	}` |
|    872849 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    153842 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   3069290 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3069295 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3069295 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     23240 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     23245 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     23245 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23245 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     23245 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     23072 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     23077 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23077 | 1955 | `	while( *ppLink ){` |
|     23077 | 1956 | `		if( *ppLink == pStep ){` |
|     23077 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     23077 | 1958 | `			pStep->pNextActive = 0;` |
|     23077 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    607548 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    607553 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    607553 | 1987 | `	if( pEntry ){` |
|    607553 | 1988 | `		if( bStore ){` |
|    236505 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    118255 | 1990 | `		}else{` |
|    371053 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    303770 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    164852 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    164857 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    159175 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    159175 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    159175 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79590 | 2009 | `	}else{` |
...
|         - | 2063 | `**   changed.` |
|         - | 2064 | `*/` |
|     37318 | 2065 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2066 | `{` |
|         - | 2067 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2068 | `    /* Prevent compiler warning */` |
|     37323 | 2069 | `	result.pNext = result.pPrev = 0;` |
|     37323 | 2070 | `	pTail = &result;` |
|    110908 | 2071 | `	while( pA && pB ){` |
|     73590 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48526 | 2073 | `			pTail->pPrev = pA;` |
|     48526 | 2074 | `			pA->pNext = pTail;` |
|     48526 | 2075 | `			pTail = pA;` |
|     48526 | 2076 | `			pA = pA->pPrev;` |
|     24258 | 2077 | `		}else{` |
|     25069 | 2078 | `			pTail->pPrev = pB;` |
|     25069 | 2079 | `			pB->pNext = pTail;` |
|     25069 | 2080 | `			pTail = pB;` |
|     25069 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     37323 | 2084 | `	if( pA ){` |
|     26511 | 2085 | `		pTail->pPrev = pA;` |
|     26511 | 2086 | `		pA->pNext = pTail;` |
|     24078 | 2087 | `	}else if( pB ){` |
|     10589 | 2088 | `		pTail->pPrev = pB;` |
|     10589 | 2089 | `		pB->pNext = pTail;` |
|      5289 | 2090 | `	}else{` |
|       233 | 2091 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2092 | `	}` |
|     37323 | 2093 | `	return result.pPrev;` |
|         5 | 2094 | `}` |
|         - | 2095 | `/*` |
|         - | 2096 | `** Inputs:` |
...
|     15185 | 2114 | `	while( pIn ){` |
|     14401 | 2115 | `		p = pIn;` |
|     14401 | 2116 | `		pIn = p->pPrev;` |
|     14401 | 2117 | `		p->pPrev = 0;` |
|     27415 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27415 | 2119 | `			if( a[i]==0 ){` |
|     14401 | 2120 | `				a[i] = p;` |
|     14401 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
|     13019 | 2123 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     13019 | 2124 | `				a[i] = 0;` |
|         - | 2125 | `			}` |
|      6512 | 2126 | `		}` |
|     14401 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     73265 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     73270 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     73182 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     14125 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     14125 | 2532 | `		i++;` |
|     14125 | 2533 | `		pLast = p;` |
|     14125 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       707 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         - | 4937 | ` */` |
|     33464 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33469 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33469 | 4948 | `	pNeedle = apArg[0];` |
|     33469 | 4949 | `	bStrict = 0;` |
|     33469 | 4950 | `	if( nArg > 2 ){` |
|        56 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        27 | 4952 | `	}` |
|     33469 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33469 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33469 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33469 | 4964 | `	return PH7_OK;` |
|     16737 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         1 | 7106 | `			pNode = pMap->pLast;` |
|         1 | 7107 | `			nEntry = pMap->nEntry - nEntry;` |
|         1 | 7108 | `			if( nEntry > 1 ){` |
|       ! 0 | 7109 | `				for(;;){` |
|       ! 0 | 7110 | `					if( nEntry == 0 ){` |
|       ! 0 | 7111 | `						break;` |
...
|         - | 8934 | ` */` |
|     34646 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34651 | 8946 | `	rc = SXRET_OK;` |
|     34651 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34651 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34651 | 8949 | `	n = pMap->nEntry;` |
|     34651 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    157883 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157883 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    157883 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    157883 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    157883 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    157883 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    157883 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157883 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34651 | 8973 | `	return SXRET_OK;` |
|     17328 | 8974 | `}` |
|         - | 8975 |  |
