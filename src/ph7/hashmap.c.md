...
|         - |   22 | ` */` |
|   7961601 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7961606 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7961606 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    517237 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    517242 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    517242 |   35 | `	sxu32 nH = 5381;` |
|    517242 |   36 | `	zEnd = &zIn[nLen];` |
|    594047 |   37 | `	for(;;){` |
|   1188100 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1014616 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    913595 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    790335 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    517242 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   51 | ` */` |
|      2312 |   52 | `static sxi64 HashmapCount(ph7_hashmap *pMap,int bRecursive,int *pCycleDetected)` |
|         5 |   53 | `{` |
|      2317 |   54 | `	sxi64 iCount = 0;` |
|      2317 |   55 | `	if( !bRecursive ){` |
|      2143 |   56 | `		iCount = pMap->nEntry;` |
|      1074 |   57 | `	}else{` |
...
|         - |   98 | ` */` |
|   3652800 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3652805 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3652805 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3652805 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3652805 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3652805 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3652805 |  112 | `	pNode->nHash = nHash;` |
|   3652805 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3652805 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3652805 |  115 | `	return pNode;` |
|   1826405 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199457 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199462 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199462 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199462 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199462 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199462 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199462 |  135 | `	pNode->nHash = nHash;` |
|    199462 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199462 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199462 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199462 |  139 | `	return pNode;` |
|     99733 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3852257 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3852262 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3395839 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3395839 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1697918 |  150 | `	}` |
|   3852262 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3852262 |  153 | `	if( pMap->pFirst == 0 ){` |
|     88112 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     88112 |  156 | `		pMap->pCur = pNode;` |
|     44058 |  157 | `	}else{` |
|   3764155 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3852262 |  160 | `	if( pMap->pActiveSteps ){` |
...
|      7175 |  186 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|      3590 |  187 | `	}else{` |
|       488 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7661 |  190 | `	if( pNode->pNextCollide ){` |
|      5137 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2567 |  192 | `	}` |
...
|         - |  236 | ` */` |
|   3852257 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3852262 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93632 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93632 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93632 |  245 | `		if( nNew < 1 ){` |
|     88112 |  246 | `			nNew = 16;` |
...
|     93632 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93632 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93632 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93632 |  260 | `		pMap->apBucket = apNew;` |
|     93632 |  261 | `		pMap->nSize = nNew;` |
|     93632 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     88112 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|   4416937 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4416937 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2208466 |  280 | `			}` |
...
|      2760 |  288 | `	}` |
|   3764155 |  289 | `	return SXRET_OK;` |
|   1926133 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3652800 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3652805 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3652763 |  310 | `		if( pValue ){` |
|   3652753 |  311 | `			sSafeVal = *pValue;` |
|   3652753 |  312 | `			pValue = &sSafeVal;` |
|   1826374 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3652763 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3652763 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3652763 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3652753 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1826374 |  322 | `		}` |
|   3652763 |  323 | `		nIdx = pObj->nIdx;` |
|   1826384 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3652805 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3652805 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3652805 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3652805 |  334 | `	if( isForeign ){` |
...
|   3652805 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3652805 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3652805 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3652805 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3652805 |  349 | `	return SXRET_OK;` |
|   1826405 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199457 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199462 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    152708 |  370 | `		if( pValue ){` |
|    152398 |  371 | `			sSafeVal = *pValue;` |
|    152398 |  372 | `			pValue = &sSafeVal;` |
|     76196 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    152708 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    152708 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    152708 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152398 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76196 |  382 | `		}` |
|    152708 |  383 | `		nIdx = pObj->nIdx;` |
|     76356 |  384 | `	}else{` |
|     46759 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199462 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199462 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199462 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199462 |  394 | `	if( isForeign ){` |
...
|    199462 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199462 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199462 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199462 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199462 |  409 | `	return SXRET_OK;` |
|     99733 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4292707 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4292712 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       861 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4291856 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4291856 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110567938 |  433 | `	for(;;){` |
| 221135863 |  434 | `		if( pNode == 0 ){` |
|   4284870 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216850993 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216847977 |  438 | `			&& pNode->nHash == nHash` |
| 108425985 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      6991 |  441 | `				if( ppNode ){` |
|      6969 |  442 | `					*ppNode = pNode;` |
|      3482 |  443 | `				}` |
|      6991 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
|         - |  446 | `		/* Follow the collision link */` |
| 216844009 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284870 |  450 | `	return SXERR_NOTFOUND;` |
|   2146361 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    346179 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    346184 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28404 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    317785 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    317785 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    257863 |  475 | `	for(;;){` |
|    515731 |  476 | `		if( pNode == 0 ){` |
|    250929 |  477 | `			break;` |
|         - |  478 | `		}` |
|    264802 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    263288 |  480 | `			&& pNode->nHash == nHash` |
|    164366 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     66963 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     66861 |  484 | `				if( ppNode ){` |
|     66833 |  485 | `					*ppNode = pNode;` |
|     33414 |  486 | `				}` |
|     66861 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    197951 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250929 |  493 | `	return SXERR_NOTFOUND;` |
|    173094 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    346375 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    346380 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    346380 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    346380 |  504 | `	int isNeg = FALSE, nDigit;` |
|    346380 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    346358 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    346354 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    346354 |  516 | `	zDigit = zIn;` |
|    173641 |  517 | `	for(;;){` |
|    347288 |  518 | `		if( zIn >= zEnd ){` |
|       315 |  519 | `			break;` |
|         - |  520 | `		}` |
|    346974 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    346040 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       935 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    153870 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    153875 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    153875 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    146923 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    146923 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    146847 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    146847 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        38 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      7033 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        89 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        44 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      7033 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     76935 |  575 | `result:` |
|    153875 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     73037 |  578 | `		if( ppNode ){` |
|     72985 |  579 | `			*ppNode = pNode;` |
|     36490 |  580 | `		}` |
|     73037 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80843 |  584 | `	return SXERR_NOTFOUND;` |
|     76940 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  591 | ` */` |
|   2142844 |  592 | `static void HashmapAdvanceAutoIndex(ph7_hashmap *pMap,sxi64 iKey)` |
|         5 |  593 | `{` |
|   2142849 |  594 | `	if( !pMap->bIntKeySeen ){` |
...
|         - |  616 | ` */` |
|   1506118 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1506123 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1506117 |  623 | `	return FALSE;` |
|    753064 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3801581 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3801586 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3801586 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3801586 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    152696 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    152696 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       231 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    228696 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76230 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    151978 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    151842 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    151842 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1824445 |  683 | `IntKey:` |
|   3649125 |  684 | `	if( pKey ){` |
|   2143041 |  685 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  686 | `			/* Force an integer cast */` |
|       261 |  687 | `			PH7_MemObjToInteger(pKey);` |
|       130 |  688 | `		}` |
|   2143041 |  689 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
...
|         - |  702 | `		}` |
|   2142845 |  703 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|   2142843 |  711 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   2142843 |  712 | `		if( rc == SXRET_OK ){` |
|   2142843 |  713 | `			HashmapAdvanceAutoIndex(&(*pMap),pKey->x.iVal);` |
|   1071419 |  714 | `		}` |
|   1071424 |  715 | `	}else{` |
|   1506089 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1506087 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1506081 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1506081 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1506079 |  726 | `			++pMap->iNextIdx;` |
|    753037 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3648919 |  730 | `	return rc;` |
|   1900795 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1554525 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1554530 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1554530 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     78395 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     78400 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     78400 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     78400 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     78400 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     78400 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     78400 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     78400 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     78400 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     78400 |  921 | `	return rc;` |
|     39068 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16950 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16955 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16955 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11963 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5872 |  934 | `	}else{` |
|      4997 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16955 |  937 | `	if( pEntry->pNextCollide ){` |
|      1103 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       568 |  939 | `	}` |
|     16955 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16955 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16955 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16955 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16955 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16955 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12277 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      6039 |  949 | `	}` |
|     16955 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16955 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16955 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16955 |  956 | `		pMap->iNextIdx++;` |
|      8475 |  957 | `	}` |
|     16955 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33400 |  966 | `static int HashmapFindValue(` |
...
|     33405 |  979 | `	pEntry = pMap->pFirst;` |
|     33405 |  980 | `	n = pMap->nEntry;` |
|     33405 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33405 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     79675 |  983 | `	for(;;){` |
|    159356 |  984 | `		if( n < 1 ){` |
|        83 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    159274 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    159274 |  989 | `		if( pVal ){` |
...
|    159274 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    159274 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    159274 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    159274 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    159274 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    159274 | 1001 | `			if( rc == 0 ){` |
|     33323 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33323 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     62975 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    125956 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    125956 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    733222 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    733222 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    733224 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    733219 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    733219 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2027 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    729175 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    725489 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    366433 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    728471 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    725549 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    725549 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    725549 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    362777 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    725549 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    725549 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    362777 | 1341 | `	}` |
...
|         - | 1498 | ` */` |
|    246754 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    246759 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    246759 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    246759 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    243921 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    142546 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    142551 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142551 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    142551 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    142551 | 1700 | `	pMap->pVm = &(*pVm);` |
|    142551 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    142551 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142551 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142551 | 1705 | `	return pMap;` |
|     71278 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     94468 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94473 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94473 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94473 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94473 | 1821 | `	n = 0;` |
|     94473 | 1822 | `	pEntry = pMap->pFirst;` |
|   1918641 | 1823 | `	for(;;){` |
|   3837288 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94473 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3742820 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3742820 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3742820 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3742760 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1871377 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3742820 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109474 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54734 | 1837 | `		}` |
|   3742820 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3742820 | 1840 | `		pEntry = pNext;` |
|   3742820 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94473 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68478 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34236 | 1846 | `	}` |
|     94473 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94447 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47226 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    879436 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    879441 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    879441 | 1869 | `	pMap->iRef--;` |
|    879441 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94427 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47211 | 1872 | `	}` |
|    879441 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    154118 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         5 | 1884 | `{` |
|         - | 1885 | `	sxi32 rc;` |
|    154123 | 1886 | `	if( pMap->nEntry < 1 ){` |
|         - | 1887 | `		/* TICKET 1433-25: Don't bother hashing,the hashmap is empty anyway.` |
|         - | 1888 | `		 */` |
|       253 | 1889 | `		return SXERR_NOTFOUND;` |
|         - | 1890 | `	}` |
|    153875 | 1891 | `	rc = HashmapLookup(&(*pMap),&(*pKey),ppNode);` |
|    153875 | 1892 | `	return rc;` |
|     77064 | 1893 | `}` |
|         - | 1894 | `/*` |
...
|         - | 1899 | ` */` |
|   3075763 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3075768 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3075768 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1975 | ` */` |
|     23382 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23387 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23387 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23387 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23387 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23206 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23211 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23211 | 1991 | `	while( *ppLink ){` |
|     23211 | 1992 | `		if( *ppLink == pStep ){` |
|     23211 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23211 | 1994 | `			pStep->pNextActive = 0;` |
|     23211 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    623102 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    623107 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    623107 | 2023 | `	if( pEntry ){` |
|    623107 | 2024 | `		if( bStore ){` |
|    239985 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    119995 | 2026 | `		}else{` |
|    383127 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    311287 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    166704 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    166709 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    160877 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    160877 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    160877 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     80441 | 2045 | `	}else{` |
...
|         - | 2099 | `**   changed.` |
|         - | 2100 | `*/` |
|     52616 | 2101 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2102 | `{` |
|         - | 2103 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2104 | `    /* Prevent compiler warning */` |
|     52621 | 2105 | `	result.pNext = result.pPrev = 0;` |
|     52621 | 2106 | `	pTail = &result;` |
|    131308 | 2107 | `	while( pA && pB ){` |
|     78692 | 2108 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     61662 | 2109 | `			pTail->pPrev = pA;` |
|     61662 | 2110 | `			pA->pNext = pTail;` |
|     61662 | 2111 | `			pTail = pA;` |
|     61662 | 2112 | `			pA = pA->pPrev;` |
|     31010 | 2113 | `		}else{` |
|     17035 | 2114 | `			pTail->pPrev = pB;` |
|     17035 | 2115 | `			pB->pNext = pTail;` |
|     17035 | 2116 | `			pTail = pB;` |
|     17035 | 2117 | `			pB = pB->pPrev;` |
|         - | 2118 | `		}` |
|         5 | 2119 | `	}` |
|     52621 | 2120 | `	if( pA ){` |
|      4408 | 2121 | `		pTail->pPrev = pA;` |
|      4408 | 2122 | `		pA->pNext = pTail;` |
|     50258 | 2123 | `	}else if( pB ){` |
|     47908 | 2124 | `		pTail->pPrev = pB;` |
|     47908 | 2125 | `		pB->pNext = pTail;` |
|     24118 | 2126 | `	}else{` |
|       315 | 2127 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2128 | `	}` |
|     52621 | 2129 | `	return result.pPrev;` |
|         5 | 2130 | `}` |
|         - | 2131 | `/*` |
|         - | 2132 | `** Inputs:` |
...
|     17007 | 2151 | `		p = pIn;` |
|     17007 | 2152 | `		pIn = p->pPrev;` |
|     17007 | 2153 | `		p->pPrev = 0;` |
|     31617 | 2154 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     31617 | 2155 | `			if( a[i]==0 ){` |
|     17007 | 2156 | `				a[i] = p;` |
|     17007 | 2157 | `				break;` |
|       ! 0 | 2158 | `			}else{` |
|     14615 | 2159 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     14615 | 2160 | `				a[i] = 0;` |
|         - | 2161 | `			}` |
|      7310 | 2162 | `		}` |
|     17007 | 2163 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2281 | `	return rc;` |
|        64 | 2282 | `}` |
|     78311 | 2283 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2284 | `{` |
|     78316 | 2285 | `	if( pCmpData == 0 ){` |
|         - | 2286 | `		/* SORT_REGULAR fast path */` |
|     78228 | 2287 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2288 | `	}` |
...
|         5 | 2571 | `		}` |
|     16731 | 2572 | `		HashmapRehashIntNode(p);` |
|         - | 2573 | `		/* Point to the next entry */` |
|     16731 | 2574 | `		i++;` |
|     16731 | 2575 | `		pLast = p;` |
|     16731 | 2576 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2577 | `	}` |
|      1155 | 2578 | `}` |
|         - | 2579 | `/*` |
...
|         - | 3107 | ` */` |
|      2246 | 3108 | `static int ph7_hashmap_count(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 3109 | `{` |
|      2251 | 3110 | `	int bRecursive = FALSE;` |
|      2251 | 3111 | `	int bCycleDetected = FALSE;` |
|         - | 3112 | `	sxi64 iCount;` |
|      2251 | 3113 | `	if( nArg < 1 ){` |
...
|        16 | 3138 | `	}` |
|      2241 | 3139 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|         - | 3162 | `	}` |
|         - | 3163 | `	/* Count */` |
|      2169 | 3164 | `	iCount = HashmapCount((ph7_hashmap *)apArg[0]->x.pOther,bRecursive,&bCycleDetected);` |
|      2169 | 3165 | `	if( bCycleDetected ){` |
|         3 | 3166 | `		PH7_VmThrowError(pCtx->pVm,0,PH7_CTX_WARNING,"count(): Recursion detected");` |
|         1 | 3167 | `	}` |
|      2169 | 3168 | `	ph7_result_int64(pCtx,iCount);` |
|      2169 | 3169 | `	return PH7_OK;` |
|      1128 | 3170 | `}` |
|         - | 3171 | `/*` |
...
|         - | 4988 | ` */` |
|     33272 | 4989 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4990 | `{` |
|         - | 4991 | `	ph7_value *pNeedle;` |
|         - | 4992 | `	int bStrict;` |
|         - | 4993 | `	int rc;` |
|     33277 | 4994 | `	if( nArg < 2 ){` |
|         - | 4995 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4996 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4997 | `		return PH7_OK;` |
|         - | 4998 | `	}` |
|     33277 | 4999 | `	pNeedle = apArg[0];` |
|     33277 | 5000 | `	bStrict = 0;` |
|     33277 | 5001 | `	if( nArg > 2 ){` |
|        62 | 5002 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        30 | 5003 | `	}` |
|     33277 | 5004 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33277 | 5012 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 5013 | `	/* Lookup result */` |
|     33277 | 5014 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33277 | 5015 | `	return PH7_OK;` |
|     16641 | 5016 | `}` |
|         - | 5017 | `/*` |
...
|         1 | 7157 | `			pNode = pMap->pLast;` |
|         1 | 7158 | `			nEntry = pMap->nEntry - nEntry;` |
|         1 | 7159 | `			if( nEntry > 1 ){` |
|       ! 0 | 7160 | `				for(;;){` |
|       ! 0 | 7161 | `					if( nEntry == 0 ){` |
|       ! 0 | 7162 | `						break;` |
...
|         - | 8985 | ` */` |
|     34550 | 8986 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34555 | 8997 | `	rc = SXRET_OK;` |
|     34555 | 8998 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34555 | 8999 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34555 | 9000 | `	n = pMap->nEntry;` |
|     34555 | 9001 | `	pEntry = pMap->pFirst;` |
...
|    159551 | 9008 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    159551 | 9009 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 9010 | `		/* Invoke the user callback */` |
|    159551 | 9011 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 9012 | `		/* Release the copy of the key and the value */` |
|    159551 | 9013 | `		PH7_MemObjRelease(&sKey);` |
|    159551 | 9014 | `		PH7_MemObjRelease(&sValue);` |
|    159551 | 9015 | `		if( rc != PH7_OK ){` |
|         - | 9016 | `			/* Callback request an operation abort */` |
|         3 | 9017 | `			return SXERR_ABORT;` |
|         - | 9018 | `		}` |
|         - | 9019 | `		/* Point to the next entry */` |
|    159549 | 9020 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    159549 | 9021 | `		n--;` |
|         5 | 9022 | `	}` |
|         - | 9023 | `	/* All done */` |
|     34553 | 9024 | `	return SXRET_OK;` |
|     17280 | 9025 | `}` |
|         - | 9026 |  |
