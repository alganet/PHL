...
|         - |   22 | ` */` |
|   7502922 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7502927 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7502927 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    634390 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    634395 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    634395 |   35 | `	sxu32 nH = 5381;` |
|    634395 |   36 | `	zEnd = &zIn[nLen];` |
|    717345 |   37 | `	for(;;){` |
|   1434695 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1228013 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1100033 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    958015 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    634395 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3199036 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3199041 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3199041 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3199041 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3199041 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3199041 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3199041 |  112 | `	pNode->nHash = nHash;` |
|   3199041 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3199041 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3199041 |  115 | `	return pNode;` |
|   1599523 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    262884 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    262889 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    262889 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    262889 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    262889 |  133 | `	pNode->pMap  = &(*pMap);` |
|    262889 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    262889 |  135 | `	pNode->nHash = nHash;` |
|    262889 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    262889 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    262889 |  138 | `	pNode->nValIdx = nValIdx;` |
|    262889 |  139 | `	return pNode;` |
|    131447 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3461920 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3461925 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2985653 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2985653 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1492824 |  150 | `	}` |
|   3461925 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3461925 |  153 | `	if( pMap->pFirst == 0 ){` |
|     90395 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     90395 |  156 | `		pMap->pCur = pNode;` |
|     45200 |  157 | `	}else{` |
|   3371535 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3461925 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3461920 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3461925 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     95705 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     95705 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     95705 |  245 | `		if( nNew < 1 ){` |
|     90395 |  246 | `			nNew = 16;` |
...
|     95705 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     95705 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     95705 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     95705 |  260 | `		pMap->apBucket = apNew;` |
|     95705 |  261 | `		pMap->nSize = nNew;` |
|     95705 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     90395 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5315 |  267 | `		pEntry = pMap->pFirst;` |
|      5315 |  268 | `		n = 0;` |
|   2134335 |  269 | `		for( ;; ){` |
|   4268675 |  270 | `			if( n >= pMap->nEntry ){` |
|      5315 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   4263365 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   4263365 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   4263365 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   3618465 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3618465 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1809230 |  280 | `			}` |
|   4263365 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   4263365 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   4263365 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5315 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2655 |  288 | `	}` |
|   3371535 |  289 | `	return SXRET_OK;` |
|   1730965 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3199036 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3199041 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3198999 |  310 | `		if( pValue ){` |
|   3198993 |  311 | `			sSafeVal = *pValue;` |
|   3198993 |  312 | `			pValue = &sSafeVal;` |
|   1599494 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3198999 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3198999 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3198999 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3198993 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1599494 |  322 | `		}` |
|   3198999 |  323 | `		nIdx = pObj->nIdx;` |
|   1599502 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3199041 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3199041 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3199041 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3199041 |  334 | `	if( isForeign ){` |
...
|   3199041 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3199041 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3199041 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3199041 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3199041 |  349 | `	return SXRET_OK;` |
|   1599523 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    262884 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    262889 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    216945 |  370 | `		if( pValue ){` |
|    216635 |  371 | `			sSafeVal = *pValue;` |
|    216635 |  372 | `			pValue = &sSafeVal;` |
|    108315 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    216945 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    216945 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    216945 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    216635 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    108315 |  382 | `		}` |
|    216945 |  383 | `		nIdx = pObj->nIdx;` |
|    108475 |  384 | `	}else{` |
|     45949 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    262889 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    262889 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    262889 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    262889 |  394 | `	if( isForeign ){` |
...
|    262889 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    262889 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    262889 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    262889 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    262889 |  409 | `	return SXRET_OK;` |
|    131447 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4290496 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4290501 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       769 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4289737 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4289737 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110566850 |  433 | `	for(;;){` |
| 221133705 |  434 | `		if( pNode == 0 ){` |
|   4284373 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216849332 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216846320 |  438 | `			&& pNode->nHash == nHash` |
| 108424341 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      5369 |  441 | `				if( ppNode ){` |
|      5347 |  442 | `					*ppNode = pNode;` |
|      2671 |  443 | `				}` |
|      5369 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
...
|         - |  456 | ` */` |
|    406118 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    406123 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     34617 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    371511 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    371511 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    305760 |  475 | `	for(;;){` |
|    611525 |  476 | `		if( pNode == 0 ){` |
|    306789 |  477 | `			break;` |
|         - |  478 | `		}` |
|    304736 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    303225 |  480 | `			&& pNode->nHash == nHash` |
|    183268 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     64827 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     64727 |  484 | `				if( ppNode ){` |
|     64699 |  485 | `					*ppNode = pNode;` |
|     32347 |  486 | `				}` |
|     64727 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    240019 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    306789 |  493 | `	return SXERR_NOTFOUND;` |
|    203064 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    406250 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    406255 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    406255 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    406255 |  504 | `	int isNeg = FALSE, nDigit;` |
|    406255 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    406233 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    406229 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    406229 |  516 | `	zDigit = zIn;` |
|    203546 |  517 | `	for(;;){` |
|    407097 |  518 | `		if( zIn >= zEnd ){` |
|       251 |  519 | `			break;` |
|         - |  520 | `		}` |
|    406847 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    405979 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       869 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    148590 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    148595 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    148595 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    143357 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    143357 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    143343 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    143343 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         7 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      5257 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        27 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        13 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      5257 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     74295 |  575 | `result:` |
|    148595 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     69209 |  578 | `		if( ppNode ){` |
|     69157 |  579 | `			*ppNode = pNode;` |
|     34576 |  580 | `		}` |
|     69209 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79391 |  584 | `	return SXERR_NOTFOUND;` |
|     74300 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1056066 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1056071 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1056065 |  623 | `	return FALSE;` |
|    528038 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3415508 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3415513 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3415513 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3415513 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    216947 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    216947 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    325076 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    108357 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    216233 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    216103 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    216103 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1599283 |  683 | `IntKey:` |
|   3198799 |  684 | `	if( pKey ){` |
...
|   1071283 |  714 | `		}` |
|   1071288 |  715 | `	}else{` |
|   1056037 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1056035 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1056029 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1056029 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1056027 |  726 | `			++pMap->iNextIdx;` |
|    528011 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3198595 |  730 | `	return rc;` |
|   1707759 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1489586 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1489591 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1489591 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     72458 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     72463 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     72463 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     72463 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     72463 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     72463 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     72463 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     72463 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     72463 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     72463 |  921 | `	return rc;` |
|     36206 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14154 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14159 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14159 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11387 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5699 |  934 | `	}else{` |
|      2777 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14159 |  937 | `	if( pEntry->pNextCollide ){` |
|       987 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       513 |  939 | `	}` |
|     14159 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14159 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14159 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14159 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14159 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14159 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11705 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5858 |  949 | `	}` |
|     14159 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14159 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14159 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14159 |  956 | `		pMap->iNextIdx++;` |
|      7077 |  957 | `	}` |
|     14159 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33156 |  966 | `static int HashmapFindValue(` |
...
|     33161 |  979 | `	pEntry = pMap->pFirst;` |
|     33161 |  980 | `	n = pMap->nEntry;` |
|     33161 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33161 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     79144 |  983 | `	for(;;){` |
|    158295 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    158217 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    158217 |  989 | `		if( pVal ){` |
...
|    158217 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    158217 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    158217 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    158217 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    158217 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    158217 | 1001 | `			if( rc == 0 ){` |
|     33083 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33083 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     62566 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    125139 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    125139 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    697930 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    697930 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    697932 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    697927 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    697927 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      1996 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    693945 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    693699 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    347097 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|         - | 1271 | ` */` |
|      2844 | 1272 | `static sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1273 | `{` |
|         - | 1274 | `	ph7_hashmap_node *pEntry;` |
|         - | 1275 | `	ph7_value *pVal;` |
|         - | 1276 | `	sxi32 rc;` |
|         - | 1277 | `	sxu32 n;` |
|      2849 | 1278 | `	if( pSrc == pDest ){` |
...
|      2849 | 1285 | `	pEntry = pSrc->pFirst;` |
|         - | 1286 | `	/* Perform the merge */` |
|    696603 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    693759 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    693759 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    693759 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    346882 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    693759 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    693759 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    346882 | 1305 | `	}` |
|      2849 | 1306 | `	return SXRET_OK;` |
|      1427 | 1307 | `}` |
|         - | 1308 | `/*` |
...
|         - | 1462 | ` */` |
|    237220 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    237225 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    237225 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    237225 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    234479 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
|      2751 | 1475 | `	if( pMap == pVm->pGlobal ){` |
...
|      2625 | 1484 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2625 | 1485 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2620 | 1486 | `		if( pBacking && pBacking != pValue` |
|      2595 | 1487 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2575 | 1488 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1489 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2575 | 1490 | `			pMap->iRef--;` |
|      2575 | 1491 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1492 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2529 | 1493 | `				pMap->iRef++;` |
|      2529 | 1494 | `				return pMap;` |
|         - | 1495 | `			}` |
...
|         - | 1648 | ` */` |
|    144674 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    144679 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    144679 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    144679 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    144679 | 1664 | `	pMap->pVm = &(*pVm);` |
|    144679 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    144679 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    144679 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    144679 | 1669 | `	return pMap;` |
|     72342 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|    102746 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|    102751 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|    102751 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|    102751 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|    102751 | 1785 | `	n = 0;` |
|    102751 | 1786 | `	pEntry = pMap->pFirst;` |
|   1739942 | 1787 | `	for(;;){` |
|   3479889 | 1788 | `		if( n >= pMap->nEntry ){` |
|    102751 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3377143 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3377143 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3377143 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3377083 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1688539 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3377143 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    189425 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     94710 | 1801 | `		}` |
|   3377143 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3377143 | 1804 | `		pEntry = pNext;` |
|   3377143 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|    102751 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     75459 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     37727 | 1810 | `	}` |
|    102751 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|    102725 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     51365 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    844770 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    844775 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    844775 | 1833 | `	pMap->iRef--;` |
|    844775 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|    102705 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     51350 | 1836 | `	}` |
|    844775 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    148778 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   2721480 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2721485 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2721485 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     19162 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     19167 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     19167 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     19167 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     19167 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     19060 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     19065 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     19065 | 1955 | `	while( *ppLink ){` |
|     19065 | 1956 | `		if( *ppLink == pStep ){` |
|     19065 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     19065 | 1958 | `			pStep->pNextActive = 0;` |
|     19065 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    598878 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    598883 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    598883 | 1987 | `	if( pEntry ){` |
|    598883 | 1988 | `		if( bStore ){` |
|    238259 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    119132 | 1990 | `		}else{` |
|    360629 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    299388 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    159388 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    159393 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    154093 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    154093 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    154093 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     77049 | 2009 | `	}else{` |
...
|         - | 2063 | `**   changed.` |
|         - | 2064 | `*/` |
|     36946 | 2065 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2066 | `{` |
|         - | 2067 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2068 | `    /* Prevent compiler warning */` |
|     36951 | 2069 | `	result.pNext = result.pPrev = 0;` |
|     36951 | 2070 | `	pTail = &result;` |
|    109659 | 2071 | `	while( pA && pB ){` |
|     72713 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47916 | 2073 | `			pTail->pPrev = pA;` |
|     47916 | 2074 | `			pA->pNext = pTail;` |
|     47916 | 2075 | `			pTail = pA;` |
|     47916 | 2076 | `			pA = pA->pPrev;` |
|     23885 | 2077 | `		}else{` |
|     24802 | 2078 | `			pTail->pPrev = pB;` |
|     24802 | 2079 | `			pB->pNext = pTail;` |
|     24802 | 2080 | `			pTail = pB;` |
|     24802 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     36951 | 2084 | `	if( pA ){` |
|     26323 | 2085 | `		pTail->pPrev = pA;` |
|     26323 | 2086 | `		pA->pNext = pTail;` |
|     23847 | 2087 | `	}else if( pB ){` |
|     10405 | 2088 | `		pTail->pPrev = pB;` |
|     10405 | 2089 | `		pB->pNext = pTail;` |
|      5150 | 2090 | `	}else{` |
|       233 | 2091 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2092 | `	}` |
|     36951 | 2093 | `	return result.pPrev;` |
|         5 | 2094 | `}` |
|         - | 2095 | `/*` |
|         - | 2096 | `** Inputs:` |
...
|     14981 | 2114 | `	while( pIn ){` |
|     14203 | 2115 | `		p = pIn;` |
|     14203 | 2116 | `		pIn = p->pPrev;` |
|     14203 | 2117 | `		p->pPrev = 0;` |
|     27031 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27031 | 2119 | `			if( a[i]==0 ){` |
|     14203 | 2120 | `				a[i] = p;` |
|     14203 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
|     12833 | 2123 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12833 | 2124 | `				a[i] = 0;` |
|         - | 2125 | `			}` |
|      6419 | 2126 | `		}` |
|     14203 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     72392 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     72397 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     72309 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     13935 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     13935 | 2532 | `		i++;` |
|     13935 | 2533 | `		pLast = p;` |
|     13935 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       703 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         - | 2556 | ` *` |
|         - | 2557 | ` */` |
|      1060 | 2558 | `static int ph7_hashmap_sort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 2559 | `{` |
|         - | 2560 | `	ph7_hashmap *pMap;` |
|         - | 2561 | `	/* Make sure we are dealing with a valid hashmap */` |
|      1065 | 2562 | `	if( nArg < 1 \|\| !ph7_value_is_array(apArg[0]) ){` |
...
|      1065 | 2568 | `	PH7_HashmapCowSeparate(pCtx->pVm, apArg[0]);` |
|      1065 | 2569 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|      1065 | 2570 | `	if( pMap->nEntry > 1 ){` |
...
|      1065 | 2582 | `	ph7_result_bool(pCtx,1);` |
|      1065 | 2583 | `	return PH7_OK;` |
|       535 | 2584 | `}` |
|         - | 2585 | `/*` |
...
|         - | 4444 | ` */` |
|      1088 | 4445 | `static int ph7_hashmap_merge(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4446 | `{` |
|         - | 4447 | `	ph7_hashmap *pMap,*pSrc;` |
|         - | 4448 | `	ph7_value *pArray;` |
|         - | 4449 | `	int i;` |
|         - | 4450 | `	/* Create a new array */` |
|      1093 | 4451 | `	pArray = ph7_context_new_array(pCtx);` |
|      1093 | 4452 | `	if( pArray == 0 ){` |
|       ! 0 | 4453 | `		ph7_result_null(pCtx);` |
|       ! 0 | 4454 | `		return PH7_OK;` |
|         - | 4455 | `	}` |
|         - | 4456 | `	/* Point to the internal representation of the hashmap */` |
|      1093 | 4457 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|         - | 4458 | `	/* Start merging */` |
|      3259 | 4459 | `	for( i = 0 ; i < nArg ; i++ ){` |
|         - | 4460 | `		/* Make sure we are dealing with a valid hashmap */` |
|      2175 | 4461 | `		if( !ph7_value_is_array(apArg[i]) ){` |
...
|         - | 4468 | `				);` |
|       ! 0 | 4469 | `		}else{` |
|      2171 | 4470 | `			pSrc = (ph7_hashmap *)apArg[i]->x.pOther;` |
|         - | 4471 | `			/* Merge the two hashmaps */` |
|      2171 | 4472 | `			HashmapMerge(pSrc,pMap);` |
|         - | 4473 | `		}` |
|      1088 | 4474 | `	}` |
|         - | 4475 | `	/* Return the freshly created array */` |
|      1089 | 4476 | `	ph7_result_value(pCtx,pArray);` |
|      1089 | 4477 | `	return PH7_OK;` |
|       549 | 4478 | `}` |
|         - | 4479 | `/*` |
...
|         - | 4937 | ` */` |
|     33028 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33033 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33033 | 4948 | `	pNeedle = apArg[0];` |
|     33033 | 4949 | `	bStrict = 0;` |
|     33033 | 4950 | `	if( nArg > 2 ){` |
|        53 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4952 | `	}` |
|     33033 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33033 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33033 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33033 | 4964 | `	return PH7_OK;` |
|     16519 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         - | 8934 | ` */` |
|     34174 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34179 | 8946 | `	rc = SXRET_OK;` |
|     34179 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34179 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34179 | 8949 | `	n = pMap->nEntry;` |
|     34179 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    152835 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    152835 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    152835 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    152835 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    152835 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    152835 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    152835 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    152835 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34179 | 8973 | `	return SXRET_OK;` |
|     17092 | 8974 | `}` |
|         - | 8975 |  |
