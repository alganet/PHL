...
|       - |   17 | ` */` |
| 2864492 |   18 | `static sxu32 IntHash(sxi64 iKey)` |
|       2 |   19 |  |
| 2864494 |   20 | `	return (sxu32)(iKey ^ (iKey << 8) ^ (iKey >> 8));` |
|       2 |   21 |  |
|       - |   22 | `/*` |
|       - |   23 | ` * Default hash function for string/BLOB keys.` |
|       - |   24 | ` */` |
|  247934 |   25 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|       2 |   26 |  |
|  247936 |   27 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|       - |   28 | `	unsigned char *zEnd;` |
|  247936 |   29 | `	sxu32 nH = 5381;` |
|  247936 |   30 | `	zEnd = &zIn[nLen];` |
|  281795 |   31 | `	for(;;){` |
|  563592 |   32 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  501130 |   33 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  451902 |   34 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  369200 |   35 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|       2 |   36 | `	}` |
|  247936 |   37 | `	return nH;` |
|       2 |   38 |  |
|       - |   39 | `/*` |
...
|       - |   92 | ` */` |
| 2809106 |   93 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|       2 |   94 |  |
|       - |   95 | `	ph7_hashmap_node *pNode;` |
|       - |   96 | `	/* Allocate a new node */` |
| 2809108 |   97 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
| 2809108 |   98 | `	if( pNode == 0 ){` |
|     ! 0 |   99 | `		return 0;` |
|       - |  100 | `	}` |
|       - |  101 | `	/* Zero the stucture */` |
| 2809108 |  102 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  103 | `	/* Fill in the structure */` |
| 2809108 |  104 | `	pNode->pMap  = &(*pMap);` |
| 2809108 |  105 | `	pNode->iType = HASHMAP_INT_NODE;` |
| 2809108 |  106 | `	pNode->nHash = nHash;` |
| 2809108 |  107 | `	pNode->xKey.iKey = iKey;` |
| 2809108 |  108 | `	pNode->nValIdx  = nValIdx;` |
| 2809108 |  109 | `	return pNode;` |
| 1404555 |  110 |  |
|       - |  111 | `/*` |
...
|       - |  115 | ` */` |
|   86706 |  116 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|       2 |  117 |  |
|       - |  118 | `	ph7_hashmap_node *pNode;` |
|       - |  119 | `	/* Allocate a new node */` |
|   86708 |  120 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   86708 |  121 | `	if( pNode == 0 ){` |
|     ! 0 |  122 | `		return 0;` |
|       - |  123 | `	}` |
|       - |  124 | `	/* Zero the stucture */` |
|   86708 |  125 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  126 | `	/* Fill in the structure */` |
|   86708 |  127 | `	pNode->pMap  = &(*pMap);` |
|   86708 |  128 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|   86708 |  129 | `	pNode->nHash = nHash;` |
|   86708 |  130 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|   86708 |  131 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|   86708 |  132 | `	pNode->nValIdx = nValIdx;` |
|   86708 |  133 | `	return pNode;` |
|   43355 |  134 |  |
|       - |  135 | `/*` |
|       - |  136 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|       - |  137 | ` */` |
| 2895812 |  138 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|       2 |  139 |  |
|       - |  140 | `	/* Link */` |
| 2895814 |  141 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
| 2661316 |  142 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
| 2661316 |  143 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
| 1330657 |  144 | `	}` |
| 2895814 |  145 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|       - |  146 | `	/* Link to the map list */` |
| 2895814 |  147 | `	if( pMap->pFirst == 0 ){` |
|   40628 |  148 | `		pMap->pFirst = pMap->pLast = pNode;` |
|       - |  149 | `		/* Point to the first inserted node */` |
|   40628 |  150 | `		pMap->pCur = pNode;` |
|   20315 |  151 | `	}else{` |
| 2855188 |  152 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|       - |  153 | `	}` |
| 2895814 |  154 | `	++pMap->nEntry;` |
| 2895814 |  155 |  |
|       - |  156 | `/*` |
...
|       - |  206 | ` */` |
| 2895812 |  207 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|       2 |  208 |  |
| 2895814 |  209 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|   44516 |  210 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|       - |  211 | `		ph7_hashmap_node *pEntry,**apNew;` |
|   44516 |  212 | `		sxu32 nNew = pMap->nSize << 1;` |
|       - |  213 | `		sxu32 nBucket;` |
|       - |  214 | `		sxu32 n;` |
|   44516 |  215 | `		if( nNew < 1 ){` |
|   40628 |  216 | `			nNew = 16;` |
...
|   44516 |  219 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|   44516 |  220 | `		if( apNew == 0 ){` |
...
|       - |  226 | `		}` |
|       - |  227 | `		/* Zero the table */` |
|   44516 |  228 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|       - |  229 | `		/* Reflect the change */` |
|   44516 |  230 | `		pMap->apBucket = apNew;` |
|   44516 |  231 | `		pMap->nSize = nNew;` |
|   44516 |  232 | `		if( apOld == 0 ){` |
|       - |  233 | `			/* First allocated table [i.e: no entry],return immediately */` |
|   40628 |  234 | `			return SXRET_OK;` |
|       - |  235 | `		}` |
|       - |  236 | `		/* Rehash old entries */` |
|    3890 |  237 | `		pEntry = pMap->pFirst;` |
|    3890 |  238 | `		n = 0;` |
| 1973784 |  239 | `		for( ;; ){` |
| 3947570 |  240 | `			if( n >= pMap->nEntry ){` |
|    3890 |  241 | `				break;` |
|       - |  242 | `			}` |
|       - |  243 | `			/* Clear the old collision link */` |
| 3943682 |  244 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  245 | `			/* Link to the new bucket */` |
| 3943682 |  246 | `			nBucket = pEntry->nHash & (nNew - 1);` |
| 3943682 |  247 | `			if( pMap->apBucket[nBucket] != 0 ){` |
| 3452070 |  248 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
| 3452070 |  249 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
| 1726034 |  250 | `			}` |
| 3943682 |  251 | `			pMap->apBucket[nBucket] = pEntry;` |
|       - |  252 | `			/* Point to the next entry */` |
| 3943682 |  253 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
| 3943682 |  254 | `			n++;` |
|       2 |  255 | `		}` |
|       - |  256 | `		/* Free the old table */` |
|    3890 |  257 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|    1944 |  258 | `	}` |
| 2855188 |  259 | `	return SXRET_OK;` |
| 1447908 |  260 |  |
|       - |  261 | `/*` |
|       - |  262 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|       - |  263 | ` * hashmap.` |
|       - |  264 | ` */` |
| 2809106 |  265 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  266 |  |
|       - |  267 | `	ph7_hashmap_node *pNode;` |
|       - |  268 | `	sxu32 nIdx;` |
|       - |  269 | `	sxu32 nHash;` |
|       - |  270 | `	sxi32 rc;` |
| 2809108 |  271 | `	if( !isForeign ){` |
|       - |  272 | `		ph7_value *pObj;` |
|       - |  273 | `		/* Reserve a ph7_value for the value */` |
| 2809082 |  274 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
| 2809082 |  275 | `		if( pObj == 0 ){` |
|     ! 0 |  276 | `			return SXERR_MEM;` |
|       - |  277 | `		}` |
| 2809082 |  278 | `		if( pValue ){` |
|       - |  279 | `			/* Duplicate the value */` |
| 2809082 |  280 | `			PH7_MemObjStore(pValue,pObj);` |
| 1404540 |  281 | `		}` |
| 2809082 |  282 | `		nIdx = pObj->nIdx;` |
| 1404542 |  283 | `	}else{` |
|      27 |  284 | `		nIdx = nRefIdx;` |
|       - |  285 | `	}` |
|       - |  286 | `	/* Hash the key */` |
| 2809108 |  287 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  288 | `	/* Allocate a new int node */` |
| 2809108 |  289 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
| 2809108 |  290 | `	if( pNode == 0 ){` |
|     ! 0 |  291 | `		return SXERR_MEM;` |
|       - |  292 | `	}` |
| 2809108 |  293 | `	if( isForeign ){` |
...
| 2809108 |  298 | `	rc = HashmapGrowBucket(&(*pMap));` |
| 2809108 |  299 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  300 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  301 | `		return rc;` |
|       - |  302 | `	}` |
|       - |  303 | `	/* Perform the insertion */` |
| 2809108 |  304 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  305 | `	/* Install in the reference table */` |
| 2809108 |  306 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  307 | `	/* All done */` |
| 2809108 |  308 | `	return SXRET_OK;` |
| 1404555 |  309 |  |
|       - |  310 | `/*` |
|       - |  311 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|       - |  312 | ` * hashmap.` |
|       - |  313 | ` */` |
|   86706 |  314 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  315 |  |
|       - |  316 | `	ph7_hashmap_node *pNode;` |
|       - |  317 | `	sxu32 nHash;` |
|       - |  318 | `	sxu32 nIdx;` |
|       - |  319 | `	sxi32 rc;` |
|   86708 |  320 | `	if( !isForeign ){` |
|       - |  321 | `		ph7_value *pObj;` |
|       - |  322 | `		/* Reserve a ph7_value for the value */` |
|   61736 |  323 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   61736 |  324 | `		if( pObj == 0 ){` |
|     ! 0 |  325 | `			return SXERR_MEM;` |
|       - |  326 | `		}` |
|   61736 |  327 | `		if( pValue ){` |
|       - |  328 | `			/* Duplicate the value */` |
|   61736 |  329 | `			PH7_MemObjStore(pValue,pObj);` |
|   30867 |  330 | `		}` |
|   61736 |  331 | `		nIdx = pObj->nIdx;` |
|   30869 |  332 | `	}else{` |
|   24974 |  333 | `		nIdx = nRefIdx;` |
|       - |  334 | `	}` |
|       - |  335 | `	/* Hash the key */` |
|   86708 |  336 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  337 | `	/* Allocate a new blob node */` |
|   86708 |  338 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|   86708 |  339 | `	if( pNode == 0 ){` |
|     ! 0 |  340 | `		return SXERR_MEM;` |
|       - |  341 | `	}` |
|   86708 |  342 | `	if( isForeign ){` |
|       - |  343 | `		/* Mark as a foregin entry */` |
|   24974 |  344 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|   12486 |  345 | `	}` |
|       - |  346 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|   86708 |  347 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   86708 |  348 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  349 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  350 | `		return rc;` |
|       - |  351 | `	}` |
|       - |  352 | `	/* Perform the insertion */` |
|   86708 |  353 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  354 | `	/* Install in the reference table */` |
|   86708 |  355 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  356 | `	/* All done */` |
|   86708 |  357 | `	return SXRET_OK;` |
|   43355 |  358 |  |
|       - |  359 | `/*` |
...
|       - |  404 | ` */` |
|  170822 |  405 | `static sxi32 HashmapLookupBlobKey(` |
...
|       - |  413 | `	sxu32 nHash;` |
|  170824 |  414 | `	if( pMap->nEntry < 1 ){` |
|       - |  415 | `		/* Don't bother hashing,there is no entry anyway */` |
|    9596 |  416 | `		return SXERR_NOTFOUND;` |
|       - |  417 | `	}` |
|       - |  418 | `	/* Hash the key first */` |
|  161230 |  419 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  420 | `	/* Point to the appropriate bucket */` |
|  161230 |  421 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  422 | `	/* Perform the lookup */` |
|  155988 |  423 | `	for(;;){` |
|  311978 |  424 | `		if( pNode == 0 ){` |
|  122812 |  425 | `			break;` |
|       - |  426 | `		}` |
|  208375 |  427 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|  187668 |  428 | `			&& pNode->nHash == nHash` |
|  112294 |  429 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|   38420 |  430 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|       - |  431 | `				/* Node found */` |
|   38420 |  432 | `				if( ppNode ){` |
|   38392 |  433 | `					*ppNode = pNode;` |
|   19195 |  434 | `				}` |
|   38420 |  435 | `				return SXRET_OK;` |
|       - |  436 | `		}` |
|       - |  437 | `		/* Follow the collision link */` |
|  150750 |  438 | `		pNode = pNode->pNextCollide;` |
|       2 |  439 | `	}` |
|       - |  440 | `	/* No such entry */` |
|  122812 |  441 | `	return SXERR_NOTFOUND;` |
|   85413 |  442 |  |
|       - |  443 | `/*` |
|       - |  444 | ` * Check if the given BLOB key looks like a decimal number.` |
|       - |  445 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|       - |  446 | ` */` |
|  170964 |  447 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|       2 |  448 |  |
|  170966 |  449 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|  170966 |  450 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|  170966 |  451 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|       - |  452 | `		/* Octal not decimal number */` |
|       5 |  453 | `		return FALSE;` |
|       - |  454 | `	}` |
|  170962 |  455 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|     ! 0 |  456 | `		zIn++;` |
|     ! 0 |  457 | `	}` |
|   85813 |  458 | `	for(;;){` |
|  171628 |  459 | `		if( zIn >= zEnd ){` |
|     233 |  460 | `			return TRUE;` |
|       - |  461 | `		}` |
|  171396 |  462 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|   85366 |  463 | `			break;` |
|       - |  464 | `		}` |
|     667 |  465 | `		zIn++;` |
|       1 |  466 | `	}` |
|       - |  467 | `	/* Key does not look like a decimal number */` |
|  170730 |  468 | `	return FALSE;` |
|   85484 |  469 |  |
|       - |  470 | `/*` |
...
|       - |  474 | ` */` |
|   84786 |  475 | `static sxi32 HashmapLookup(` |
|       - |  476 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|       - |  477 | `	ph7_value *pKey,            /* Lookup key */` |
|       - |  478 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|       - |  479 | `	)` |
|       2 |  480 |  |
|   84788 |  481 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|       - |  482 | `	sxi32 rc;` |
|   84788 |  483 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   84098 |  484 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  485 | `			/* Force a string cast */` |
|     ! 0 |  486 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  487 | `		}` |
|   84098 |  488 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|       - |  489 | `			/* Perform a blob lookup */` |
|   84082 |  490 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|   84082 |  491 | `			goto result;` |
|       - |  492 | `		}` |
|       8 |  493 | `	}` |
...
|   42393 |  501 | `result:` |
|   84788 |  502 | `	if( rc == SXRET_OK ){` |
|       - |  503 | `		/* Node found */` |
|   39020 |  504 | `		if( ppNode ){` |
|   38986 |  505 | `			*ppNode = pNode;` |
|   19492 |  506 | `		}` |
|   39020 |  507 | `		return SXRET_OK;` |
|       - |  508 | `	}` |
|       - |  509 | `	/* No such entry */` |
|   45770 |  510 | `	return SXERR_NOTFOUND;` |
|   42395 |  511 |  |
|       - |  512 | `/*` |
...
|       - |  517 | ` */` |
| 2870618 |  518 | `static sxi32 HashmapInsert(` |
|       - |  519 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|       - |  520 | `	ph7_value *pKey,   /* Lookup key  */` |
|       - |  521 | `	ph7_value *pVal    /* Node value */` |
|       - |  522 | `	)` |
|       2 |  523 |  |
| 2870620 |  524 | `	ph7_hashmap_node *pNode = 0;` |
| 2870620 |  525 | `	sxi32 rc = SXRET_OK;` |
| 2870620 |  526 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   61930 |  527 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  528 | `			/* Force a string cast */` |
|       3 |  529 | `			PH7_MemObjToString(&(*pKey));` |
|       1 |  530 | `		}` |
|   61930 |  531 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     256 |  536 | `			goto IntKey;` |
|       - |  537 | `		}` |
|   92513 |  538 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   30837 |  539 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|       - |  552 | `		}` |
|   61640 |  553 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  554 | `			/* Forbidden */` |
...
|   61638 |  559 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|   61638 |  560 | `		return rc;` |
|       - |  561 | `	}` |
| 1404345 |  562 | `IntKey:` |
| 2808946 |  563 | `	if( pKey ){` |
...
|   11607 |  598 | `		}` |
|   11609 |  599 | `	}else{` |
| 2785684 |  600 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  601 | `			/* Forbidden */` |
...
| 2785682 |  606 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
| 2785682 |  607 | `		if( rc == SXRET_OK ){` |
| 2785682 |  608 | `			++pMap->iNextIdx;` |
| 1392840 |  609 | `		}` |
|       - |  610 | `	}` |
|       - |  611 | `	/* Insertion result */` |
| 2808896 |  612 | `	return rc;` |
| 1435311 |  613 |  |
|       - |  614 | `/*` |
...
|       - |  640 | ` */` |
|   25004 |  641 | `static sxi32 HashmapInsertByRef(` |
|       - |  642 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|       - |  643 | `	ph7_value *pKey,     /* Lookup key */` |
|       - |  644 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|       - |  645 | `	)` |
|       2 |  646 |  |
|   25006 |  647 | `	ph7_hashmap_node *pNode = 0;` |
|   25006 |  648 | `	sxi32 rc = SXRET_OK;` |
|   25006 |  649 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   24980 |  650 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  651 | `			/* Force a string cast */` |
|     ! 0 |  652 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  653 | `		}` |
|   24980 |  654 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     ! 0 |  659 | `			goto IntKey;` |
|       - |  660 | `		}` |
|   37469 |  661 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   12489 |  662 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|       - |  663 | `				/* Overwrite */` |
...
|   24974 |  671 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|   24974 |  672 | `		return rc;` |
|       - |  673 | `	}` |
|      13 |  674 | `IntKey:` |
|      27 |  675 | `	if( pKey ){` |
...
|       - |  712 | ` */` |
|  944246 |  713 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       2 |  714 |  |
|       - |  715 | `	/* Point to the desired object */` |
|       - |  716 | `	ph7_value *pObj;` |
|  944248 |  717 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|  944248 |  718 | `	return pObj;` |
|       2 |  719 |  |
|       - |  720 | `/*` |
...
|       - |  762 | ` * documenation.` |
|       - |  763 | ` */` |
|   39776 |  764 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       2 |  765 |  |
|       - |  766 | `	ph7_value sObj1,sObj2;` |
|       - |  767 | `	sxi32 rc;` |
|   39778 |  768 | `	if( pLeft == pRight ){` |
|       - |  769 | `		/*` |
...
|   39778 |  776 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   39778 |  777 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   39778 |  778 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   39778 |  779 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   39778 |  780 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   39778 |  781 | `	PH7_MemObjRelease(&sObj1);` |
|   39778 |  782 | `	PH7_MemObjRelease(&sObj2);` |
|   39778 |  783 | `	return rc;` |
|   19905 |  784 |  |
|       - |  785 | `/*` |
...
|       - |  788 | ` */` |
|    8780 |  789 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|       2 |  790 |  |
|    8782 |  791 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|       - |  792 | `	sxu32 nBucket;` |
|       - |  793 | `	/* Remove old collision links */` |
|    8782 |  794 | `	if( pEntry->pPrevCollide ){` |
|    6836 |  795 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|    3414 |  796 | `	}else{` |
|    1948 |  797 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|       - |  798 | `	}` |
|    8782 |  799 | `	if( pEntry->pNextCollide ){` |
|     667 |  800 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|     332 |  801 | `	}` |
|    8782 |  802 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  803 | `	/* Compute the new hash */` |
|    8782 |  804 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|    8782 |  805 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|    8782 |  806 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|       - |  807 | `	/* Link to the new bucket */` |
|    8782 |  808 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|    8782 |  809 | `	if( pMap->apBucket[nBucket] ){` |
|    7006 |  810 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|    3500 |  811 | `	}` |
|    8782 |  812 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|    8782 |  813 | `	pMap->apBucket[nBucket] = pEntry;` |
|       - |  814 | `	/* Increment the automatic index */` |
|    8782 |  815 | `	pMap->iNextIdx++;` |
|    8782 |  816 |  |
|       - |  817 | `/*` |
...
|       - |  823 | ` */` |
|   22180 |  824 | `static int HashmapFindValue(` |
...
|   22182 |  837 | `	pEntry = pMap->pFirst;` |
|   22182 |  838 | `	n = pMap->nEntry;` |
|   22182 |  839 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|   22182 |  840 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|   53152 |  841 | `	for(;;){` |
|  106304 |  842 | `		if( n < 1 ){` |
|      99 |  843 | `			break;` |
|       - |  844 | `		}` |
|       - |  845 | `		/* Extract node value */` |
|  106206 |  846 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  106206 |  847 | `		if( pVal ){` |
|  106206 |  848 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  858 | `			}else{` |
|       - |  859 | `				/* Duplicate value */` |
|  106206 |  860 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  106206 |  861 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  106206 |  862 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  106206 |  863 | `				PH7_MemObjRelease(&sVal);` |
|  106206 |  864 | `				PH7_MemObjRelease(&sNeedle);` |
|  106206 |  865 | `				if( rc == 0 ){` |
|   22084 |  866 | `					if( ppNode ){` |
|      23 |  867 | `						*ppNode = pEntry;` |
|      11 |  868 | `					}` |
|       - |  869 | `					/* Match found*/` |
|   22084 |  870 | `					return SXRET_OK;` |
|       - |  871 | `				}` |
|       - |  872 | `			}` |
|   42062 |  873 | `		}` |
|       - |  874 | `		/* Point to the next entry */` |
|   84124 |  875 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   84124 |  876 | `		n--;` |
|       2 |  877 | `	}` |
|       - |  878 | `	/* No such entry */` |
...
|       - | 1053 | ` */` |
|  467478 | 1054 | `static sxi32 HashmapDuplicateNode(` |
...
|       - | 1059 | `	)` |
|       2 | 1060 |  |
|  467480 | 1061 | `	ph7_value sSafeVal = *pVal;` |
|       - | 1062 | `	ph7_value sKey;` |
|       - | 1063 | `	sxi32 rc;` |
|       - | 1064 |  |
|  467480 | 1065 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      21 | 1071 | `	}else{` |
|       - | 1072 | `		/* Int key */` |
|  467440 | 1073 | `		if( iAction == 0 ){ /* Merge */` |
|  467368 | 1074 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|  233757 | 1075 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|       - | 1096 | ` */` |
|    1776 | 1097 | `static sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|       2 | 1098 |  |
|       - | 1099 | `	ph7_hashmap_node *pEntry;` |
|       - | 1100 | `	ph7_value *pVal;` |
|       - | 1101 | `	sxi32 rc;` |
|       - | 1102 | `	sxu32 n;` |
|    1778 | 1103 | `	if( pSrc == pDest ){` |
...
|    1778 | 1110 | `	pEntry = pSrc->pFirst;` |
|       - | 1111 | `	/* Perform the merge */` |
|  469160 | 1112 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|       - | 1113 | `		/* Extract the node value */` |
|  467384 | 1114 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  467384 | 1115 | `		if( pVal ){` |
...
|       - | 1120 | `			 */` |
|  467384 | 1121 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|  233693 | 1122 | `		}else{` |
|     ! 0 | 1123 | `			rc = SXRET_OK;` |
|       - | 1124 | `		}` |
|  467384 | 1125 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1126 | `			return rc;` |
|       - | 1127 | `		}` |
|       - | 1128 | `		/* Point to the next entry */` |
|  467384 | 1129 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  233693 | 1130 | `	}` |
|    1778 | 1131 | `	return SXRET_OK;` |
|     890 | 1132 |  |
|       - | 1133 | `/*` |
...
|       - | 1303 | ` */` |
|   62516 | 1304 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|   62518 | 1312 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|   62518 | 1313 | `	if( pMap == 0 ){` |
|     ! 0 | 1314 | `		return 0;` |
|       - | 1315 | `	}` |
|       - | 1316 | `	/* Zero the structure */` |
|   62518 | 1317 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|       - | 1318 | `	/* Fill in the structure */` |
|   62518 | 1319 | `	pMap->pVm = &(*pVm);` |
|   62518 | 1320 | `	pMap->iRef = 1;` |
|       - | 1321 | `	/* Default hash functions */` |
|   62518 | 1322 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|   62518 | 1323 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|   62518 | 1324 | `	return pMap;` |
|   31260 | 1325 |  |
|       - | 1326 | `/*` |
...
|       - | 1344 | `*    $_ENV` |
|       - | 1345 | `*/` |
|    1934 | 1346 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|       2 | 1347 |  |
...
|    1936 | 1366 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    1936 | 1367 | `	if( pMap == 0 ){` |
|     ! 0 | 1368 | `		return SXERR_MEM;` |
|       - | 1369 | `	}` |
|    1936 | 1370 | `	pVm->pGlobal = pMap;` |
|       - | 1371 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|    1936 | 1372 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|    1936 | 1373 | `	if( pObj == 0 ){` |
|     ! 0 | 1374 | `		return SXERR_MEM;` |
|       - | 1375 | `	}` |
|    1936 | 1376 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|       - | 1377 | `	/* Record object index */` |
|    1936 | 1378 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|       - | 1379 | `	/* Install the special $GLOBALS array */` |
|    1936 | 1380 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|    1936 | 1381 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 1382 | `		return rc;` |
|       - | 1383 | `	}` |
|       - | 1384 | `	/* Install superglobals now */` |
|   21276 | 1385 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|       - | 1386 | `		ph7_value *pSuper;` |
|       - | 1387 | `		/* Request an empty array */` |
|   19342 | 1388 | `		pSuper = ph7_new_array(&(*pVm));` |
|   19342 | 1389 | `		if( pSuper == 0 ){` |
|     ! 0 | 1390 | `			return SXERR_MEM;` |
|       - | 1391 | `		}` |
|       - | 1392 | `		/* Install */` |
|   19342 | 1393 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|   19342 | 1394 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1395 | `			return rc;` |
|       - | 1396 | `		}` |
|       - | 1397 | `		/* Release the value now it have been installed */` |
|   19342 | 1398 | `		ph7_release_value(&(*pVm),pSuper);` |
|    9672 | 1399 | `	}` |
|       - | 1400 | `	/* Set some $_SERVER entries */` |
|    1936 | 1401 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       - | 1402 | `	/*` |
|       - | 1403 | `	 * 'SCRIPT_FILENAME'` |
|       - | 1404 | `	 * The absolute pathname of the currently executing script.` |
|       - | 1405 | `	 */` |
|    3866 | 1406 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|       - | 1407 | `		"SCRIPT_FILENAME",` |
|     967 | 1408 | `		pFile ? pFile->zString : ":Memory:",` |
|    1930 | 1409 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|       - | 1410 | `		);` |
|       - | 1411 | `	/* All done,all super-global are installed now */` |
|    1936 | 1412 | `	return SXRET_OK;` |
|     969 | 1413 |  |
|       - | 1414 | `/*` |
|       - | 1415 | ` * Release a hashmap.` |
|       - | 1416 | ` */` |
|   41128 | 1417 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|       2 | 1418 |  |
|       - | 1419 | `	ph7_hashmap_node *pEntry,*pNext;` |
|   41130 | 1420 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1421 | `	sxu32 n;` |
|   41130 | 1422 | `	if( pMap == pVm->pGlobal ){` |
...
|   41130 | 1428 | `	n = 0;` |
|   41130 | 1429 | `	pEntry = pMap->pFirst;` |
| 1452419 | 1430 | `	for(;;){` |
| 2904840 | 1431 | `		if( n >= pMap->nEntry ){` |
|   41130 | 1432 | `			break;` |
|       - | 1433 | `		}` |
| 2863712 | 1434 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|       - | 1435 | `		/* Remove the reference from the foreign table */` |
| 2863712 | 1436 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
| 2863712 | 1437 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|       - | 1438 | `			/* Restore the ph7_value to the free list */` |
| 2863704 | 1439 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
| 1431851 | 1440 | `		}` |
|       - | 1441 | `		/* Release the node */` |
| 2863712 | 1442 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|   59068 | 1443 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|   29533 | 1444 | `		}` |
| 2863712 | 1445 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|       - | 1446 | `		/* Point to the next entry */` |
| 2863712 | 1447 | `		pEntry = pNext;` |
| 2863712 | 1448 | `		n++;` |
|       2 | 1449 | `	}` |
|   41130 | 1450 | `	if( pMap->nEntry > 0 ){` |
|       - | 1451 | `		/* Release the hash bucket */` |
|   36600 | 1452 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|   18299 | 1453 | `	}` |
|   41130 | 1454 | `	if( FreeDS ){` |
|       - | 1455 | `		/* Free the whole instance */` |
|   41114 | 1456 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|   20558 | 1457 | `	}else{` |
...
|       - | 1470 | ` */` |
|  466530 | 1471 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|       2 | 1472 |  |
|  466532 | 1473 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1474 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|  466532 | 1475 | `	pMap->iRef--;` |
|  466532 | 1476 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|   41114 | 1477 | `		PH7_HashmapRelease(pMap,TRUE);` |
|   20556 | 1478 | `	}` |
|  466532 | 1479 |  |
|       - | 1480 | `/*` |
...
|       - | 1484 | ` */` |
|   84804 | 1485 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|       - | 1505 | ` */` |
| 2403040 | 1506 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|       2 | 1511 |  |
|       - | 1512 | `	sxi32 rc;` |
| 2403042 | 1513 | `	if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP) && (ph7_hashmap *)pVal->x.pOther == pMap->pVm->pGlobal ){` |
|       - | 1514 | `		/*` |
...
|       - | 1519 | `	}` |
| 2403042 | 1520 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
| 2403042 | 1521 | `	return rc;` |
| 1201522 | 1522 |  |
|       - | 1523 | `/*` |
...
|       - | 1549 | ` */` |
|   25004 | 1550 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|       2 | 1555 |  |
|       - | 1556 | `	sxi32 rc;` |
|   25006 | 1557 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
|       - | 1558 | `		/*` |
...
|       - | 1563 | `	}` |
|   25006 | 1564 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|   25006 | 1565 | `	return rc;` |
|   12504 | 1566 |  |
|       - | 1567 | `/*` |
|       - | 1568 | ` * Reset the node cursor of a given hashmap.` |
|       - | 1569 | ` */` |
|   18328 | 1570 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|       2 | 1571 |  |
|       - | 1572 | `	/* Reset the loop cursor */` |
|   18330 | 1573 | `	pMap->pCur = pMap->pFirst;` |
|   18330 | 1574 |  |
|       - | 1575 | `/*` |
...
|       - | 1580 | ` */` |
|  146916 | 1581 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|       2 | 1582 |  |
|  146918 | 1583 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|  146918 | 1584 | `	if( pCur == 0 ){` |
|       - | 1585 | `		/* End of the list,return null */` |
|    9186 | 1586 | `		return 0;` |
|       - | 1587 | `	}` |
|       - | 1588 | `	/* Advance the node cursor */` |
|  137734 | 1589 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|  137734 | 1590 | `	return pCur;` |
|   73460 | 1591 |  |
|       - | 1592 | `/*` |
|       - | 1593 | ` * Extract a node value.` |
|       - | 1594 | ` */` |
|  346772 | 1595 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       2 | 1596 |  |
|  346774 | 1597 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  346774 | 1598 | `	if( pEntry ){` |
|  346774 | 1599 | `		if( bStore ){` |
|  137762 | 1600 | `			PH7_MemObjStore(pEntry,pValue);` |
|   68882 | 1601 | `		}else{` |
|  209014 | 1602 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1603 | `		}` |
|  173418 | 1604 | `	}else{` |
...
|       - | 1610 | ` */` |
|   90980 | 1611 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|       2 | 1612 |  |
|       - | 1613 | `	/* Fill with the current key */` |
|   90982 | 1614 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|   90710 | 1615 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|      13 | 1616 | `			SyBlobRelease(&pKey->sBlob);` |
|       6 | 1617 | `		}` |
|   90710 | 1618 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|   90710 | 1619 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|   45356 | 1620 | `	}else{` |
...
|       - | 1671 | `**   changed.` |
|       - | 1672 | `*/` |
|   26590 | 1673 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|       2 | 1674 |  |
|       - | 1675 | `	ph7_hashmap_node result,*pTail;` |
|       - | 1676 | `    /* Prevent compiler warning */` |
|   26592 | 1677 | `	result.pNext = result.pPrev = 0;` |
|   26592 | 1678 | `	pTail = &result;` |
|   66451 | 1679 | `	while( pA && pB ){` |
|   39861 | 1680 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|   26222 | 1681 | `			pTail->pPrev = pA;` |
|   26222 | 1682 | `			pA->pNext = pTail;` |
|   26222 | 1683 | `			pTail = pA;` |
|   26222 | 1684 | `			pA = pA->pPrev;` |
|   13108 | 1685 | `		}else{` |
|   13641 | 1686 | `			pTail->pPrev = pB;` |
|   13641 | 1687 | `			pB->pNext = pTail;` |
|   13641 | 1688 | `			pTail = pB;` |
|   13641 | 1689 | `			pB = pB->pPrev;` |
|       - | 1690 | `		}` |
|       2 | 1691 | `	}` |
|   26592 | 1692 | `	if( pA ){` |
|   19847 | 1693 | `		pTail->pPrev = pA;` |
|   19847 | 1694 | `		pA->pNext = pTail;` |
|   16681 | 1695 | `	}else if( pB ){` |
|    6553 | 1696 | `		pTail->pPrev = pB;` |
|    6553 | 1697 | `		pB->pNext = pTail;` |
|    3266 | 1698 | `	}else{` |
|     196 | 1699 | `		pTail->pPrev = pTail->pNext = 0;` |
|       - | 1700 | `	}` |
|   26592 | 1701 | `	return result.pPrev;` |
|       2 | 1702 |  |
|       - | 1703 | `/*` |
|       - | 1704 | `** Inputs:` |
...
|     604 | 1715 | `static sxi32 HashmapMergeSort(ph7_hashmap *pMap,ProcNodeCmp xCmp,void *pCmpData)` |
|       2 | 1716 |  |
|       - | 1717 | `	ph7_hashmap_node *a[N_SORT_BUCKET], *p,*pIn;` |
|       - | 1718 | `	sxu32 i;` |
|     606 | 1719 | `	SyZero(a,sizeof(a));` |
|       - | 1720 | `	/* Point to the first inserted entry */` |
|     606 | 1721 | `	pIn = pMap->pFirst;` |
|    9506 | 1722 | `	while( pIn ){` |
|    8902 | 1723 | `		p = pIn;` |
|    8902 | 1724 | `		pIn = p->pPrev;` |
|    8902 | 1725 | `		p->pPrev = 0;` |
|   16768 | 1726 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|   16768 | 1727 | `			if( a[i]==0 ){` |
|    8902 | 1728 | `				a[i] = p;` |
|    8902 | 1729 | `				break;` |
|     ! 0 | 1730 | `			}else{` |
|    7868 | 1731 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|    7868 | 1732 | `				a[i] = 0;` |
|       - | 1733 | `			}` |
|    3935 | 1734 | `		}` |
|    8902 | 1735 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       2 | 1741 | `	}` |
|     606 | 1742 | `	p = a[0];` |
|   19330 | 1743 | `	for(i=1; i<N_SORT_BUCKET; i++){` |
|   18726 | 1744 | `		p = HashmapNodeMerge(p,a[i],xCmp,pCmpData);` |
|    9364 | 1745 | `	}` |
|     606 | 1746 | `	p->pNext = 0;` |
|       - | 1747 | `	/* Reflect the change */` |
|     606 | 1748 | `	pMap->pFirst = p;` |
|       - | 1749 | `	/* Reset the loop cursor */` |
|     606 | 1750 | `	pMap->pCur = pMap->pFirst;` |
|     606 | 1751 | `	return SXRET_OK;` |
|       2 | 1752 |  |
|       - | 1753 | `/*` |
|       - | 1754 | ` * Node comparison callback.` |
|       - | 1755 | ` * used-by: [sort(),asort(),...]` |
|       - | 1756 | ` */` |
|   39732 | 1757 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       2 | 1758 |  |
|       - | 1759 | `	ph7_value sA,sB;` |
|       - | 1760 | `	sxi32 iFlags;` |
|       - | 1761 | `	int rc;` |
|   39734 | 1762 | `	if( pCmpData == 0 ){` |
|       - | 1763 | `		/* Perform a standard comparison */` |
|   39710 | 1764 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   39710 | 1765 | `		return rc;` |
|       - | 1766 | `	}` |
...
|       - | 2036 | ` */` |
|     556 | 2037 | `static void HashmapSortRehash(ph7_hashmap *pMap)` |
|       2 | 2038 |  |
|       - | 2039 | `	ph7_hashmap_node *p,*pLast;` |
|       - | 2040 | `	sxu32 i;` |
|       - | 2041 | `	/* Rehash all entries */` |
|     558 | 2042 | `	pLast = p = pMap->pFirst;` |
|     558 | 2043 | `	pMap->iNextIdx = 0; /* Reset the automatic index */` |
|     558 | 2044 | `	i = 0;` |
|    4643 | 2045 | `	for( ;; ){` |
|    9288 | 2046 | `		if( i >= pMap->nEntry ){` |
|     558 | 2047 | `			pMap->pLast = pLast; /* Fix the last link broken by the merge-sort */` |
|     558 | 2048 | `			break;` |
|       - | 2049 | `		}` |
|    8732 | 2050 | `		if( p->iType == HASHMAP_BLOB_NODE ){` |
...
|       2 | 2055 | `		}` |
|    8732 | 2056 | `		HashmapRehashIntNode(p);` |
|       - | 2057 | `		/* Point to the next entry */` |
|    8732 | 2058 | `		i++;` |
|    8732 | 2059 | `		pLast = p;` |
|    8732 | 2060 | `		p = p->pPrev; /* Reverse link */` |
|       2 | 2061 | `	}` |
|     558 | 2062 |  |
|       - | 2063 | `/*` |
...
|       - | 2082 | ` *` |
|       - | 2083 | ` */` |
|     860 | 2084 | `static int ph7_hashmap_sort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 2085 |  |
|       - | 2086 | `	ph7_hashmap *pMap;` |
|       - | 2087 | `	/* Make sure we are dealing with a valid hashmap */` |
|     862 | 2088 | `	if( nArg < 1 \|\| !ph7_value_is_array(apArg[0]) ){` |
...
|     862 | 2094 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|     862 | 2095 | `	if( pMap->nEntry > 1 ){` |
|     552 | 2096 | `		sxi32 iCmpFlags = 0;` |
|     552 | 2097 | `		if( nArg > 1 ){` |
...
|     552 | 2105 | `		HashmapMergeSort(pMap,HashmapCmpCallback1,SX_INT_TO_PTR(iCmpFlags));` |
|       - | 2106 | `		/* Rehash [Do not maintain index association as requested by the PHP specification] */` |
|     552 | 2107 | `		HashmapSortRehash(pMap);` |
|     275 | 2108 | `	}` |
|       - | 2109 | `	/* All done,return TRUE */` |
|     862 | 2110 | `	ph7_result_bool(pCtx,1);` |
|     862 | 2111 | `	return PH7_OK;` |
|     432 | 2112 |  |
|       - | 2113 | `/*` |
...
|       - | 3359 | ` */` |
|     888 | 3360 | `static int ph7_hashmap_merge(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 3361 |  |
|       - | 3362 | `	ph7_hashmap *pMap,*pSrc;` |
|       - | 3363 | `	ph7_value *pArray;` |
|       - | 3364 | `	int i;` |
|       - | 3365 | `	/* Create a new array */` |
|     890 | 3366 | `	pArray = ph7_context_new_array(pCtx);` |
|     890 | 3367 | `	if( pArray == 0 ){` |
|     ! 0 | 3368 | `		ph7_result_null(pCtx);` |
|     ! 0 | 3369 | `		return PH7_OK;` |
|       - | 3370 | `	}` |
|       - | 3371 | `	/* Point to the internal representation of the hashmap */` |
|     890 | 3372 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|       - | 3373 | `	/* Start merging */` |
|    2656 | 3374 | `	for( i = 0 ; i < nArg ; i++ ){` |
|       - | 3375 | `		/* Make sure we are dealing with a valid hashmap */` |
|    1772 | 3376 | `		if( !ph7_value_is_array(apArg[i]) ){` |
...
|       - | 3383 | `				);` |
|     ! 0 | 3384 | `		}else{` |
|    1768 | 3385 | `			pSrc = (ph7_hashmap *)apArg[i]->x.pOther;` |
|       - | 3386 | `			/* Merge the two hashmaps */` |
|    1768 | 3387 | `			HashmapMerge(pSrc,pMap);` |
|       - | 3388 | `		}` |
|     885 | 3389 | `	}` |
|       - | 3390 | `	/* Return the freshly created array */` |
|     886 | 3391 | `	ph7_result_value(pCtx,pArray);` |
|     886 | 3392 | `	return PH7_OK;` |
|     446 | 3393 |  |
|       - | 3394 | `/*` |
...
|       - | 3829 | ` */` |
|   21988 | 3830 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 3831 |  |
|       - | 3832 | `	ph7_value *pNeedle;` |
|       - | 3833 | `	int bStrict;` |
|       - | 3834 | `	int rc;` |
|   21990 | 3835 | `	if( nArg < 2 ){` |
|       - | 3836 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 3837 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 3838 | `		return PH7_OK;` |
|       - | 3839 | `	}` |
|   21990 | 3840 | `	pNeedle = apArg[0];` |
|   21990 | 3841 | `	bStrict = 0;` |
|   21990 | 3842 | `	if( nArg > 2 ){` |
|       5 | 3843 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|       2 | 3844 | `	}` |
|   21990 | 3845 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   21990 | 3853 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 3854 | `	/* Lookup result */` |
|   21990 | 3855 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   21990 | 3856 | `	return PH7_OK;` |
|   10996 | 3857 |  |
|       - | 3858 | `/*` |
...
|       - | 6779 | ` */` |
|    1934 | 6780 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|       2 | 6781 |  |
|       - | 6782 | `	sxu32 n;` |
|  119910 | 6783 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|  117976 | 6784 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|   58989 | 6785 | `	}` |
|    1936 | 6786 |  |
|       - | 6787 | `/*` |
...
|       - | 6875 | ` */` |
|   22254 | 6876 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|   22256 | 6887 | `	rc = SXRET_OK;` |
|   22256 | 6888 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|   22256 | 6889 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|   22256 | 6890 | `	n = pMap->nEntry;` |
|   22256 | 6891 | `	pEntry = pMap->pFirst;` |
...
|   90460 | 6898 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|   90460 | 6899 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|       - | 6900 | `		/* Invoke the user callback */` |
|   90460 | 6901 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|       - | 6902 | `		/* Release the copy of the key and the value */` |
|   90460 | 6903 | `		PH7_MemObjRelease(&sKey);` |
|   90460 | 6904 | `		PH7_MemObjRelease(&sValue);` |
|   90460 | 6905 | `		if( rc != PH7_OK ){` |
|       - | 6906 | `			/* Callback request an operation abort */` |
|     ! 0 | 6907 | `			return SXERR_ABORT;` |
|       - | 6908 | `		}` |
|       - | 6909 | `		/* Point to the next entry */` |
|   90460 | 6910 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   90460 | 6911 | `		n--;` |
|       2 | 6912 | `	}` |
|       - | 6913 | `	/* All done */` |
|   22256 | 6914 | `	return SXRET_OK;` |
|   11129 | 6915 |  |
|       - | 6916 |  |
