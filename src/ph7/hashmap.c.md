...
Coverage: 3337/3831 lines (87.11%)
...
|       - |   17 | ` */` |
| 3108586 |   18 | `static sxu32 IntHash(sxi64 iKey)` |
|       5 |   19 |  |
| 3108591 |   20 | `	return (sxu32)(iKey ^ (iKey << 8) ^ (iKey >> 8));` |
|       5 |   21 |  |
|       - |   22 | `/*` |
|       - |   23 | ` * Default hash function for string/BLOB keys.` |
|       - |   24 | ` */` |
|  380274 |   25 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|       5 |   26 |  |
|  380279 |   27 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|       - |   28 | `	unsigned char *zEnd;` |
|  380279 |   29 | `	sxu32 nH = 5381;` |
|  380279 |   30 | `	zEnd = &zIn[nLen];` |
|  432339 |   31 | `	for(;;){` |
|  864683 |   32 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  746759 |   33 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  672001 |   34 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  572511 |   35 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|       5 |   36 | `	}` |
|  380279 |   37 | `	return nH;` |
|       5 |   38 |  |
|       - |   39 | `/*` |
...
|       - |   92 | ` */` |
| 3048006 |   93 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|       5 |   94 |  |
|       - |   95 | `	ph7_hashmap_node *pNode;` |
|       - |   96 | `	/* Allocate a new node */` |
| 3048011 |   97 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
| 3048011 |   98 | `	if( pNode == 0 ){` |
|     ! 0 |   99 | `		return 0;` |
|       - |  100 | `	}` |
|       - |  101 | `	/* Zero the stucture */` |
| 3048011 |  102 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  103 | `	/* Fill in the structure */` |
| 3048011 |  104 | `	pNode->pMap  = &(*pMap);` |
| 3048011 |  105 | `	pNode->iType = HASHMAP_INT_NODE;` |
| 3048011 |  106 | `	pNode->nHash = nHash;` |
| 3048011 |  107 | `	pNode->xKey.iKey = iKey;` |
| 3048011 |  108 | `	pNode->nValIdx  = nValIdx;` |
| 3048011 |  109 | `	return pNode;` |
| 1524008 |  110 |  |
|       - |  111 | `/*` |
...
|       - |  115 | ` */` |
|  136990 |  116 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|       5 |  117 |  |
|       - |  118 | `	ph7_hashmap_node *pNode;` |
|       - |  119 | `	/* Allocate a new node */` |
|  136995 |  120 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|  136995 |  121 | `	if( pNode == 0 ){` |
|     ! 0 |  122 | `		return 0;` |
|       - |  123 | `	}` |
|       - |  124 | `	/* Zero the stucture */` |
|  136995 |  125 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  126 | `	/* Fill in the structure */` |
|  136995 |  127 | `	pNode->pMap  = &(*pMap);` |
|  136995 |  128 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|  136995 |  129 | `	pNode->nHash = nHash;` |
|  136995 |  130 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|  136995 |  131 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|  136995 |  132 | `	pNode->nValIdx = nValIdx;` |
|  136995 |  133 | `	return pNode;` |
|   68500 |  134 |  |
|       - |  135 | `/*` |
|       - |  136 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|       - |  137 | ` */` |
| 3184996 |  138 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|       5 |  139 |  |
|       - |  140 | `	/* Link */` |
| 3185001 |  141 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
| 2833545 |  142 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
| 2833545 |  143 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
| 1416770 |  144 | `	}` |
| 3185001 |  145 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|       - |  146 | `	/* Link to the map list */` |
| 3185001 |  147 | `	if( pMap->pFirst == 0 ){` |
|   63501 |  148 | `		pMap->pFirst = pMap->pLast = pNode;` |
|       - |  149 | `		/* Point to the first inserted node */` |
|   63501 |  150 | `		pMap->pCur = pNode;` |
|   31753 |  151 | `	}else{` |
| 3121505 |  152 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|       - |  153 | `	}` |
| 3185001 |  154 | `	++pMap->nEntry;` |
| 3185001 |  155 |  |
|       - |  156 | `/*` |
...
|       - |  206 | ` */` |
| 3184996 |  207 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|       5 |  208 |  |
| 3185001 |  209 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|   68089 |  210 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|       - |  211 | `		ph7_hashmap_node *pEntry,**apNew;` |
|   68089 |  212 | `		sxu32 nNew = pMap->nSize << 1;` |
|       - |  213 | `		sxu32 nBucket;` |
|       - |  214 | `		sxu32 n;` |
|   68089 |  215 | `		if( nNew < 1 ){` |
|   63501 |  216 | `			nNew = 16;` |
...
|   68089 |  219 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|   68089 |  220 | `		if( apNew == 0 ){` |
...
|       - |  226 | `		}` |
|       - |  227 | `		/* Zero the table */` |
|   68089 |  228 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|       - |  229 | `		/* Reflect the change */` |
|   68089 |  230 | `		pMap->apBucket = apNew;` |
|   68089 |  231 | `		pMap->nSize = nNew;` |
|   68089 |  232 | `		if( apOld == 0 ){` |
|       - |  233 | `			/* First allocated table [i.e: no entry],return immediately */` |
|   63501 |  234 | `			return SXRET_OK;` |
|       - |  235 | `		}` |
|       - |  236 | `		/* Rehash old entries */` |
|    4593 |  237 | `		pEntry = pMap->pFirst;` |
|    4593 |  238 | `		n = 0;` |
| 2068454 |  239 | `		for( ;; ){` |
| 4136913 |  240 | `			if( n >= pMap->nEntry ){` |
|    4593 |  241 | `				break;` |
|       - |  242 | `			}` |
|       - |  243 | `			/* Clear the old collision link */` |
| 4132325 |  244 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  245 | `			/* Link to the new bucket */` |
| 4132325 |  246 | `			nBucket = pEntry->nHash & (nNew - 1);` |
| 4132325 |  247 | `			if( pMap->apBucket[nBucket] != 0 ){` |
| 3551839 |  248 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
| 3551839 |  249 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
| 1775917 |  250 | `			}` |
| 4132325 |  251 | `			pMap->apBucket[nBucket] = pEntry;` |
|       - |  252 | `			/* Point to the next entry */` |
| 4132325 |  253 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
| 4132325 |  254 | `			n++;` |
|       5 |  255 | `		}` |
|       - |  256 | `		/* Free the old table */` |
|    4593 |  257 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|    2294 |  258 | `	}` |
| 3121505 |  259 | `	return SXRET_OK;` |
| 1592503 |  260 |  |
|       - |  261 | `/*` |
|       - |  262 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|       - |  263 | ` * hashmap.` |
|       - |  264 | ` */` |
| 3048006 |  265 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       5 |  266 |  |
|       - |  267 | `	ph7_hashmap_node *pNode;` |
|       - |  268 | `	sxu32 nIdx;` |
|       - |  269 | `	sxu32 nHash;` |
|       - |  270 | `	sxi32 rc;` |
| 3048011 |  271 | `	if( !isForeign ){` |
|       - |  272 | `		ph7_value *pObj;` |
...
| 3047975 |  280 | `		if( pValue ){` |
| 3047973 |  281 | `			sSafeVal = *pValue;` |
| 3047973 |  282 | `			pValue = &sSafeVal;` |
| 1523984 |  283 | `		}` |
|       - |  284 | `		/* Reserve a ph7_value for the value */` |
| 3047975 |  285 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
| 3047975 |  286 | `		if( pObj == 0 ){` |
|     ! 0 |  287 | `			return SXERR_MEM;` |
|       - |  288 | `		}` |
| 3047975 |  289 | `		if( pValue ){` |
|       - |  290 | `			/* Duplicate the value */` |
| 3047973 |  291 | `			PH7_MemObjStore(pValue,pObj);` |
| 1523984 |  292 | `		}` |
| 3047975 |  293 | `		nIdx = pObj->nIdx;` |
| 1523990 |  294 | `	}else{` |
|      37 |  295 | `		nIdx = nRefIdx;` |
|       - |  296 | `	}` |
|       - |  297 | `	/* Hash the key */` |
| 3048011 |  298 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  299 | `	/* Allocate a new int node */` |
| 3048011 |  300 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
| 3048011 |  301 | `	if( pNode == 0 ){` |
|     ! 0 |  302 | `		return SXERR_MEM;` |
|       - |  303 | `	}` |
| 3048011 |  304 | `	if( isForeign ){` |
...
| 3048011 |  309 | `	rc = HashmapGrowBucket(&(*pMap));` |
| 3048011 |  310 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  311 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  312 | `		return rc;` |
|       - |  313 | `	}` |
|       - |  314 | `	/* Perform the insertion */` |
| 3048011 |  315 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  316 | `	/* Install in the reference table */` |
| 3048011 |  317 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  318 | `	/* All done */` |
| 3048011 |  319 | `	return SXRET_OK;` |
| 1524008 |  320 |  |
|       - |  321 | `/*` |
|       - |  322 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|       - |  323 | ` * hashmap.` |
|       - |  324 | ` */` |
|  136990 |  325 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       5 |  326 |  |
|       - |  327 | `	ph7_hashmap_node *pNode;` |
|       - |  328 | `	sxu32 nHash;` |
|       - |  329 | `	sxu32 nIdx;` |
|       - |  330 | `	sxi32 rc;` |
|  136995 |  331 | `	if( !isForeign ){` |
|       - |  332 | `		ph7_value *pObj;` |
...
|   94033 |  340 | `		if( pValue ){` |
|   93743 |  341 | `			sSafeVal = *pValue;` |
|   93743 |  342 | `			pValue = &sSafeVal;` |
|   46869 |  343 | `		}` |
|       - |  344 | `		/* Reserve a ph7_value for the value */` |
|   94033 |  345 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   94033 |  346 | `		if( pObj == 0 ){` |
|     ! 0 |  347 | `			return SXERR_MEM;` |
|       - |  348 | `		}` |
|   94033 |  349 | `		if( pValue ){` |
|       - |  350 | `			/* Duplicate the value */` |
|   93743 |  351 | `			PH7_MemObjStore(pValue,pObj);` |
|   46869 |  352 | `		}` |
|   94033 |  353 | `		nIdx = pObj->nIdx;` |
|   47019 |  354 | `	}else{` |
|   42967 |  355 | `		nIdx = nRefIdx;` |
|       - |  356 | `	}` |
|       - |  357 | `	/* Hash the key */` |
|  136995 |  358 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  359 | `	/* Allocate a new blob node */` |
|  136995 |  360 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|  136995 |  361 | `	if( pNode == 0 ){` |
|     ! 0 |  362 | `		return SXERR_MEM;` |
|       - |  363 | `	}` |
|  136995 |  364 | `	if( isForeign ){` |
|       - |  365 | `		/* Mark as a foregin entry */` |
|   42967 |  366 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|   21481 |  367 | `	}` |
|       - |  368 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|  136995 |  369 | `	rc = HashmapGrowBucket(&(*pMap));` |
|  136995 |  370 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  371 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  372 | `		return rc;` |
|       - |  373 | `	}` |
|       - |  374 | `	/* Perform the insertion */` |
|  136995 |  375 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  376 | `	/* Install in the reference table */` |
|  136995 |  377 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  378 | `	/* All done */` |
|  136995 |  379 | `	return SXRET_OK;` |
|   68500 |  380 |  |
|       - |  381 | `/*` |
...
|       - |  426 | ` */` |
|  258610 |  427 | `static sxi32 HashmapLookupBlobKey(` |
...
|       - |  435 | `	sxu32 nHash;` |
|  258615 |  436 | `	if( pMap->nEntry < 1 ){` |
|       - |  437 | `		/* Don't bother hashing,there is no entry anyway */` |
|   15331 |  438 | `		return SXERR_NOTFOUND;` |
|       - |  439 | `	}` |
|       - |  440 | `	/* Hash the key first */` |
|  243289 |  441 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  442 | `	/* Point to the appropriate bucket */` |
|  243289 |  443 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  444 | `	/* Perform the lookup */` |
|  209741 |  445 | `	for(;;){` |
|  419487 |  446 | `		if( pNode == 0 ){` |
|  190707 |  447 | `			break;` |
|       - |  448 | `		}` |
|  228780 |  449 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|  227277 |  450 | `			&& pNode->nHash == nHash` |
|  139178 |  451 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|   52587 |  452 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|       - |  453 | `				/* Node found */` |
|   52587 |  454 | `				if( ppNode ){` |
|   52559 |  455 | `					*ppNode = pNode;` |
|   26277 |  456 | `				}` |
|   52587 |  457 | `				return SXRET_OK;` |
|       - |  458 | `		}` |
|       - |  459 | `		/* Follow the collision link */` |
|  176203 |  460 | `		pNode = pNode->pNextCollide;` |
|       5 |  461 | `	}` |
|       - |  462 | `	/* No such entry */` |
|  190707 |  463 | `	return SXERR_NOTFOUND;` |
|  129310 |  464 |  |
|       - |  465 | `/*` |
|       - |  466 | ` * Check if the given BLOB key looks like a decimal number.` |
|       - |  467 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|       - |  468 | ` */` |
|  258748 |  469 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|       5 |  470 |  |
|  258753 |  471 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|  258753 |  472 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|  258753 |  473 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|       - |  474 | `		/* Octal not decimal number */` |
|       5 |  475 | `		return FALSE;` |
|       - |  476 | `	}` |
|  258749 |  477 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|     ! 0 |  478 | `		zIn++;` |
|     ! 0 |  479 | `	}` |
|  129705 |  480 | `	for(;;){` |
|  259415 |  481 | `		if( zIn >= zEnd ){` |
|     233 |  482 | `			return TRUE;` |
|       - |  483 | `		}` |
|  259183 |  484 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|  129261 |  485 | `			break;` |
|       - |  486 | `		}` |
|     667 |  487 | `		zIn++;` |
|       1 |  488 | `	}` |
|       - |  489 | `	/* Key does not look like a decimal number */` |
|  258517 |  490 | `	return FALSE;` |
|  129379 |  491 |  |
|       - |  492 | `/*` |
...
|       - |  496 | ` */` |
|  122928 |  497 | `static sxi32 HashmapLookup(` |
|       - |  498 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|       - |  499 | `	ph7_value *pKey,            /* Lookup key */` |
|       - |  500 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|       - |  501 | `	)` |
|       5 |  502 |  |
|  122933 |  503 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|       - |  504 | `	sxi32 rc;` |
|  122933 |  505 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|  121559 |  506 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  507 | `			/* Force a string cast */` |
|     ! 0 |  508 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  509 | `		}` |
|  121559 |  510 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|       - |  511 | `			/* Perform a blob lookup */` |
|  121543 |  512 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|  121543 |  513 | `			goto result;` |
|       - |  514 | `		}` |
|       8 |  515 | `	}` |
...
|   61464 |  523 | `result:` |
|  122933 |  524 | `	if( rc == SXRET_OK ){` |
|       - |  525 | `		/* Node found */` |
|   53825 |  526 | `		if( ppNode ){` |
|   53781 |  527 | `			*ppNode = pNode;` |
|   26888 |  528 | `		}` |
|   53825 |  529 | `		return SXRET_OK;` |
|       - |  530 | `	}` |
|       - |  531 | `	/* No such entry */` |
|   69113 |  532 | `	return SXERR_NOTFOUND;` |
|   61469 |  533 |  |
|       - |  534 | `/*` |
...
|       - |  539 | ` */` |
| 3141736 |  540 | `static sxi32 HashmapInsert(` |
|       - |  541 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|       - |  542 | `	ph7_value *pKey,   /* Lookup key  */` |
|       - |  543 | `	ph7_value *pVal    /* Node value */` |
|       - |  544 | `	)` |
|       5 |  545 |  |
| 3141741 |  546 | `	ph7_hashmap_node *pNode = 0;` |
| 3141741 |  547 | `	sxi32 rc = SXRET_OK;` |
| 3141741 |  548 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   97463 |  549 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  550 | `			/* Force a string cast */` |
|       3 |  551 | `			PH7_MemObjToString(&(*pKey));` |
|       1 |  552 | `		}` |
|   97463 |  553 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
|    3453 |  554 | `			if(SyBlobLength(&pKey->sBlob) < 1){` |
|       - |  555 | `				/* Automatic index assign */` |
|    3231 |  556 | `				pKey = 0;` |
|    1613 |  557 | `			}` |
|    3453 |  558 | `			goto IntKey;` |
|       - |  559 | `		}` |
|  141020 |  560 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   47005 |  561 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|       - |  574 | `		}` |
|   93937 |  575 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  576 | `			/* Forbidden */` |
...
|   93935 |  581 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|   93935 |  582 | `		return rc;` |
|       - |  583 | `	}` |
| 1522139 |  584 | `IntKey:` |
| 3047731 |  585 | `	if( pKey ){` |
...
|   11746 |  620 | `		}` |
|   11751 |  621 | `	}else{` |
| 3024151 |  622 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  623 | `			/* Forbidden */` |
...
| 3024149 |  628 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
| 3024149 |  629 | `		if( rc == SXRET_OK ){` |
| 3024149 |  630 | `			++pMap->iNextIdx;` |
| 1512072 |  631 | `		}` |
|       - |  632 | `	}` |
|       - |  633 | `	/* Insertion result */` |
| 3047641 |  634 | `	return rc;` |
| 1570873 |  635 |  |
|       - |  636 | `/*` |
...
|       - |  662 | ` */` |
|   43004 |  663 | `static sxi32 HashmapInsertByRef(` |
|       - |  664 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|       - |  665 | `	ph7_value *pKey,     /* Lookup key */` |
|       - |  666 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|       - |  667 | `	)` |
|       5 |  668 |  |
|   43009 |  669 | `	ph7_hashmap_node *pNode = 0;` |
|   43009 |  670 | `	sxi32 rc = SXRET_OK;` |
|   43009 |  671 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   42973 |  672 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  673 | `			/* Force a string cast */` |
|     ! 0 |  674 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  675 | `		}` |
|   42973 |  676 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     ! 0 |  681 | `			goto IntKey;` |
|       - |  682 | `		}` |
|   64457 |  683 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   21484 |  684 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|       - |  685 | `				/* Overwrite */` |
...
|   42967 |  693 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|   42967 |  694 | `		return rc;` |
|       - |  695 | `	}` |
|      18 |  696 | `IntKey:` |
|      37 |  697 | `	if( pKey ){` |
...
|       - |  734 | ` */` |
| 1308901 |  735 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       5 |  736 |  |
|       - |  737 | `	/* Point to the desired object */` |
|       - |  738 | `	ph7_value *pObj;` |
| 1308906 |  739 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
| 1308906 |  740 | `	return pObj;` |
|       5 |  741 |  |
|       - |  742 | `/*` |
...
|       - |  784 | ` * documenation.` |
|       - |  785 | ` */` |
|   66545 |  786 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       5 |  787 |  |
|       - |  788 | `	ph7_value sObj1,sObj2;` |
|       - |  789 | `	sxi32 rc;` |
|   66550 |  790 | `	if( pLeft == pRight ){` |
|       - |  791 | `		/*` |
...
|   66550 |  798 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   66550 |  799 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   66550 |  800 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   66550 |  801 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   66550 |  802 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   66550 |  803 | `	PH7_MemObjRelease(&sObj1);` |
|   66550 |  804 | `	PH7_MemObjRelease(&sObj2);` |
|   66550 |  805 | `	return rc;` |
|   33299 |  806 |  |
|       - |  807 | `/*` |
...
|       - |  810 | ` */` |
|   12796 |  811 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|       5 |  812 |  |
|   12801 |  813 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|       - |  814 | `	sxu32 nBucket;` |
|       - |  815 | `	/* Remove old collision links */` |
|   12801 |  816 | `	if( pEntry->pPrevCollide ){` |
|   10424 |  817 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|    5200 |  818 | `	}else{` |
|    2382 |  819 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|       - |  820 | `	}` |
|   12801 |  821 | `	if( pEntry->pNextCollide ){` |
|    1004 |  822 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|     498 |  823 | `	}` |
|   12801 |  824 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  825 | `	/* Compute the new hash */` |
|   12801 |  826 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|   12801 |  827 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|   12801 |  828 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|       - |  829 | `	/* Link to the new bucket */` |
|   12801 |  830 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   12801 |  831 | `	if( pMap->apBucket[nBucket] ){` |
|   10731 |  832 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|    5351 |  833 | `	}` |
|   12801 |  834 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   12801 |  835 | `	pMap->apBucket[nBucket] = pEntry;` |
|       - |  836 | `	/* Increment the automatic index */` |
|   12801 |  837 | `	pMap->iNextIdx++;` |
|   12801 |  838 |  |
|       - |  839 | `/*` |
...
|       - |  845 | ` */` |
|   31972 |  846 | `static int HashmapFindValue(` |
...
|   31977 |  859 | `	pEntry = pMap->pFirst;` |
|   31977 |  860 | `	n = pMap->nEntry;` |
|   31977 |  861 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|   31977 |  862 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|   76470 |  863 | `	for(;;){` |
|  152944 |  864 | `		if( n < 1 ){` |
|      99 |  865 | `			break;` |
|       - |  866 | `		}` |
|       - |  867 | `		/* Extract node value */` |
|  152846 |  868 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  152846 |  869 | `		if( pVal ){` |
|  152846 |  870 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  880 | `			}else{` |
|       - |  881 | `				/* Duplicate value */` |
|  152846 |  882 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  152846 |  883 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  152846 |  884 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  152846 |  885 | `				PH7_MemObjRelease(&sVal);` |
|  152846 |  886 | `				PH7_MemObjRelease(&sNeedle);` |
|  152846 |  887 | `				if( rc == 0 ){` |
|   31879 |  888 | `					if( ppNode ){` |
|      23 |  889 | `						*ppNode = pEntry;` |
|      11 |  890 | `					}` |
|       - |  891 | `					/* Match found*/` |
|   31879 |  892 | `					return SXRET_OK;` |
|       - |  893 | `				}` |
|       - |  894 | `			}` |
|   60484 |  895 | `		}` |
|       - |  896 | `		/* Point to the next entry */` |
|  120972 |  897 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  120972 |  898 | `		n--;` |
|       5 |  899 | `	}` |
|       - |  900 | `	/* No such entry */` |
...
|       - | 1087 | ` */` |
|  606040 | 1088 | `static sxi32 HashmapDuplicateNode(` |
...
|       - | 1097 | `	sxi32 rc;` |
|       - | 1098 |  |
|  606045 | 1099 | `	if( pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ ){` |
...
|       7 | 1122 | `		return rc;` |
|       - | 1123 | `	}` |
|  606039 | 1124 | `	sSafeVal = *pVal;` |
|       - | 1125 |  |
|  606039 | 1126 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      51 | 1132 | `	}else{` |
|       - | 1133 | `		/* Int key */` |
|  605939 | 1134 | `		if( iAction == 0 ){ /* Merge */` |
|  605733 | 1135 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|  303073 | 1136 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|  607887 | 1173 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|       - | 1174 | `		/* Extract the node value */` |
|  605791 | 1175 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  605791 | 1176 | `		if( pVal ){` |
...
|       - | 1181 | `			 */` |
|  605791 | 1182 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|  302898 | 1183 | `		}else{` |
|     ! 0 | 1184 | `			rc = SXRET_OK;` |
|       - | 1185 | `		}` |
|  605791 | 1186 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1187 | `			return rc;` |
|       - | 1188 | `		}` |
|       - | 1189 | `		/* Point to the next entry */` |
|  605791 | 1190 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  302898 | 1191 | `	}` |
...
|       - | 1279 | ` */` |
|  209778 | 1280 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|       5 | 1281 |  |
|  209783 | 1282 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - | 1283 | `	ph7_hashmap *pNew;` |
|       - | 1284 | `	ph7_value *pBacking;` |
|       - | 1285 | `	sxu32 nValIdx;` |
|       - | 1286 | `	int bValueInPool;` |
|  209783 | 1287 | `	if( pMap->iRef < 2 ){` |
|       - | 1288 | `		/* Sole owner, no separation needed */` |
|  207619 | 1289 | `		return pMap;` |
|       - | 1290 | `	}` |
...
|       - | 1462 | ` */` |
|   95812 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|   95817 | 1471 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|   95817 | 1472 | `	if( pMap == 0 ){` |
|     ! 0 | 1473 | `		return 0;` |
|       - | 1474 | `	}` |
|       - | 1475 | `	/* Zero the structure */` |
|   95817 | 1476 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|       - | 1477 | `	/* Fill in the structure */` |
|   95817 | 1478 | `	pMap->pVm = &(*pVm);` |
|   95817 | 1479 | `	pMap->iRef = 1;` |
|       - | 1480 | `	/* Default hash functions */` |
|   95817 | 1481 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|   95817 | 1482 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|   95817 | 1483 | `	return pMap;` |
|   47911 | 1484 |  |
|       - | 1485 | `/*` |
...
|       - | 1503 | `*    $_ENV` |
|       - | 1504 | `*/` |
|    3216 | 1505 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|       5 | 1506 |  |
...
|    3221 | 1525 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    3221 | 1526 | `	if( pMap == 0 ){` |
|     ! 0 | 1527 | `		return SXERR_MEM;` |
|       - | 1528 | `	}` |
|    3221 | 1529 | `	pVm->pGlobal = pMap;` |
|       - | 1530 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|    3221 | 1531 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|    3221 | 1532 | `	if( pObj == 0 ){` |
|     ! 0 | 1533 | `		return SXERR_MEM;` |
|       - | 1534 | `	}` |
|    3221 | 1535 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|       - | 1536 | `	/* Record object index */` |
|    3221 | 1537 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|       - | 1538 | `	/* Install the special $GLOBALS array */` |
|    3221 | 1539 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|    3221 | 1540 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 1541 | `		return rc;` |
|       - | 1542 | `	}` |
|       - | 1543 | `	/* Install superglobals now */` |
|   35381 | 1544 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|       - | 1545 | `		ph7_value *pSuper;` |
|       - | 1546 | `		/* Request an empty array */` |
|   32165 | 1547 | `		pSuper = ph7_new_array(&(*pVm));` |
|   32165 | 1548 | `		if( pSuper == 0 ){` |
|     ! 0 | 1549 | `			return SXERR_MEM;` |
|       - | 1550 | `		}` |
|       - | 1551 | `		/* Install */` |
|   32165 | 1552 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|   32165 | 1553 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1554 | `			return rc;` |
|       - | 1555 | `		}` |
|       - | 1556 | `		/* Release the value now it have been installed */` |
|   32165 | 1557 | `		ph7_release_value(&(*pVm),pSuper);` |
|   16085 | 1558 | `	}` |
|       - | 1559 | `	/* Set some $_SERVER entries */` |
|    3221 | 1560 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       - | 1561 | `	/*` |
|       - | 1562 | `	 * 'SCRIPT_FILENAME'` |
|       - | 1563 | `	 * The absolute pathname of the currently executing script.` |
|       - | 1564 | `	 */` |
|    6433 | 1565 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|       - | 1566 | `		"SCRIPT_FILENAME",` |
|    1608 | 1567 | `		pFile ? pFile->zString : ":Memory:",` |
|    3212 | 1568 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|       - | 1569 | `		);` |
|       - | 1570 | `	/* All done,all super-global are installed now */` |
|    3221 | 1571 | `	return SXRET_OK;` |
|    1613 | 1572 |  |
|       - | 1573 | `/*` |
|       - | 1574 | ` * Release a hashmap.` |
|       - | 1575 | ` */` |
|   59990 | 1576 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|       5 | 1577 |  |
|       - | 1578 | `	ph7_hashmap_node *pEntry,*pNext;` |
|   59995 | 1579 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1580 | `	sxu32 n;` |
|   59995 | 1581 | `	if( pMap == pVm->pGlobal ){` |
...
|   59995 | 1587 | `	n = 0;` |
|   59995 | 1588 | `	pEntry = pMap->pFirst;` |
| 1585201 | 1589 | `	for(;;){` |
| 3170407 | 1590 | `		if( n >= pMap->nEntry ){` |
|   59995 | 1591 | `			break;` |
|       - | 1592 | `		}` |
| 3110417 | 1593 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|       - | 1594 | `		/* Remove the reference from the foreign table */` |
| 3110417 | 1595 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
| 3110417 | 1596 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|       - | 1597 | `			/* Restore the ph7_value to the free list */` |
| 3110407 | 1598 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
| 1555201 | 1599 | `		}` |
|       - | 1600 | `		/* Release the node */` |
| 3110417 | 1601 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|   72711 | 1602 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|   36353 | 1603 | `		}` |
| 3110417 | 1604 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|       - | 1605 | `		/* Point to the next entry */` |
| 3110417 | 1606 | `		pEntry = pNext;` |
| 3110417 | 1607 | `		n++;` |
|       5 | 1608 | `	}` |
|   59995 | 1609 | `	if( pMap->nEntry > 0 ){` |
|       - | 1610 | `		/* Release the hash bucket */` |
|   53289 | 1611 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|   26642 | 1612 | `	}` |
|   59995 | 1613 | `	if( FreeDS ){` |
|       - | 1614 | `		/* Free the whole instance */` |
|   59979 | 1615 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|   29992 | 1616 | `	}else{` |
...
|       - | 1629 | ` */` |
|  653246 | 1630 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|       5 | 1631 |  |
|  653251 | 1632 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1633 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|  653251 | 1634 | `	pMap->iRef--;` |
|  653251 | 1635 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|   59959 | 1636 | `		PH7_HashmapRelease(pMap,TRUE);` |
|   29977 | 1637 | `	}` |
|  653251 | 1638 |  |
|       - | 1639 | `/*` |
...
|       - | 1643 | ` */` |
|  122984 | 1644 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|       - | 1664 | ` */` |
| 2535776 | 1665 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|       5 | 1670 |  |
|       - | 1671 | `	sxi32 rc;` |
| 2535781 | 1672 | `	if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP) && (ph7_hashmap *)pVal->x.pOther == pMap->pVm->pGlobal ){` |
|       - | 1673 | `		/*` |
...
|       - | 1678 | `	}` |
| 2535781 | 1679 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
| 2535781 | 1680 | `	return rc;` |
| 1267893 | 1681 |  |
|       - | 1682 | `/*` |
...
|       - | 1718 | ` */` |
|   42998 | 1719 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|       5 | 1724 |  |
|       - | 1725 | `	sxi32 rc;` |
|   43003 | 1726 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
|       - | 1727 | `		/*` |
...
|       - | 1732 | `	}` |
|   43003 | 1733 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|   43003 | 1734 | `	return rc;` |
|   21504 | 1735 |  |
|       - | 1736 | `/*` |
|       - | 1737 | ` * Reset the node cursor of a given hashmap.` |
|       - | 1738 | ` */` |
|   26658 | 1739 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|       5 | 1740 |  |
|       - | 1741 | `	/* Reset the loop cursor */` |
|   26663 | 1742 | `	pMap->pCur = pMap->pFirst;` |
|   26663 | 1743 |  |
|       - | 1744 | `/*` |
...
|       - | 1749 | ` */` |
|  221952 | 1750 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|       5 | 1751 |  |
|  221957 | 1752 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|  221957 | 1753 | `	if( pCur == 0 ){` |
|       - | 1754 | `		/* End of the list,return null */` |
|   13353 | 1755 | `		return 0;` |
|       - | 1756 | `	}` |
|       - | 1757 | `	/* Advance the node cursor */` |
|  208609 | 1758 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|  208609 | 1759 | `	return pCur;` |
|  110981 | 1760 |  |
|       - | 1761 | `/*` |
|       - | 1762 | ` * Extract a node value.` |
|       - | 1763 | ` */` |
|  525734 | 1764 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       5 | 1765 |  |
|  525739 | 1766 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  525739 | 1767 | `	if( pEntry ){` |
|  525739 | 1768 | `		if( bStore ){` |
|  208793 | 1769 | `			PH7_MemObjStore(pEntry,pValue);` |
|  104399 | 1770 | `		}else{` |
|  316951 | 1771 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1772 | `		}` |
|  262915 | 1773 | `	}else{` |
...
|       - | 1779 | ` */` |
|  130754 | 1780 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|       5 | 1781 |  |
|       - | 1782 | `	/* Fill with the current key */` |
|  130759 | 1783 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|  130297 | 1784 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|      27 | 1785 | `			SyBlobRelease(&pKey->sBlob);` |
|      13 | 1786 | `		}` |
|  130297 | 1787 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|  130297 | 1788 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|   65151 | 1789 | `	}else{` |
...
|       - | 1843 | `**   changed.` |
|       - | 1844 | `*/` |
|   32790 | 1845 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|       5 | 1846 |  |
|       - | 1847 | `	ph7_hashmap_node result,*pTail;` |
|       - | 1848 | `    /* Prevent compiler warning */` |
|   32795 | 1849 | `	result.pNext = result.pPrev = 0;` |
|   32795 | 1850 | `	pTail = &result;` |
|   99470 | 1851 | `	while( pA && pB ){` |
|   66680 | 1852 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|   44608 | 1853 | `			pTail->pPrev = pA;` |
|   44608 | 1854 | `			pA->pNext = pTail;` |
|   44608 | 1855 | `			pTail = pA;` |
|   44608 | 1856 | `			pA = pA->pPrev;` |
|   22304 | 1857 | `		}else{` |
|   22077 | 1858 | `			pTail->pPrev = pB;` |
|   22077 | 1859 | `			pB->pNext = pTail;` |
|   22077 | 1860 | `			pTail = pB;` |
|   22077 | 1861 | `			pB = pB->pPrev;` |
|       - | 1862 | `		}` |
|       5 | 1863 | `	}` |
|   32795 | 1864 | `	if( pA ){` |
|   23010 | 1865 | `		pTail->pPrev = pA;` |
|   23010 | 1866 | `		pA->pNext = pTail;` |
|   21288 | 1867 | `	}else if( pB ){` |
|    9570 | 1868 | `		pTail->pPrev = pB;` |
|    9570 | 1869 | `		pB->pNext = pTail;` |
|    4792 | 1870 | `	}else{` |
|     225 | 1871 | `		pTail->pPrev = pTail->pNext = 0;` |
|       - | 1872 | `	}` |
|   32795 | 1873 | `	return result.pPrev;` |
|       5 | 1874 |  |
|       - | 1875 | `/*` |
|       - | 1876 | `** Inputs:` |
...
|   13597 | 1894 | `	while( pIn ){` |
|   12917 | 1895 | `		p = pIn;` |
|   12917 | 1896 | `		pIn = p->pPrev;` |
|   12917 | 1897 | `		p->pPrev = 0;` |
|   24627 | 1898 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|   24627 | 1899 | `			if( a[i]==0 ){` |
|   12917 | 1900 | `				a[i] = p;` |
|   12917 | 1901 | `				break;` |
|     ! 0 | 1902 | `			}else{` |
|   11715 | 1903 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|   11715 | 1904 | `				a[i] = 0;` |
|       - | 1905 | `			}` |
|    5860 | 1906 | `		}` |
|   12917 | 1907 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       - | 1929 | ` */` |
|   66477 | 1930 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       5 | 1931 |  |
|       - | 1932 | `	ph7_value sA,sB;` |
|       - | 1933 | `	sxi32 iFlags;` |
|       - | 1934 | `	int rc;` |
|   66482 | 1935 | `	if( pCmpData == 0 ){` |
|       - | 1936 | `		/* Perform a standard comparison */` |
|   66458 | 1937 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   66458 | 1938 | `		return rc;` |
|       - | 1939 | `	}` |
...
|       2 | 2248 | `		}` |
|   12747 | 2249 | `		HashmapRehashIntNode(p);` |
|       - | 2250 | `		/* Point to the next entry */` |
|   12747 | 2251 | `		i++;` |
|   12747 | 2252 | `		pLast = p;` |
|   12747 | 2253 | `		p = p->pPrev; /* Reverse link */` |
|       5 | 2254 | `	}` |
|     637 | 2255 |  |
|       - | 2256 | `/*` |
...
|       - | 4077 | ` */` |
|   31780 | 4078 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       5 | 4079 |  |
|       - | 4080 | `	ph7_value *pNeedle;` |
|       - | 4081 | `	int bStrict;` |
|       - | 4082 | `	int rc;` |
|   31785 | 4083 | `	if( nArg < 2 ){` |
|       - | 4084 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 4085 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 4086 | `		return PH7_OK;` |
|       - | 4087 | `	}` |
|   31785 | 4088 | `	pNeedle = apArg[0];` |
|   31785 | 4089 | `	bStrict = 0;` |
|   31785 | 4090 | `	if( nArg > 2 ){` |
|      17 | 4091 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|       8 | 4092 | `	}` |
|   31785 | 4093 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   31785 | 4101 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 4102 | `	/* Lookup result */` |
|   31785 | 4103 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   31785 | 4104 | `	return PH7_OK;` |
|   15895 | 4105 |  |
|       - | 4106 | `/*` |
...
|       - | 7632 | ` */` |
|    3210 | 7633 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|       5 | 7634 |  |
|       - | 7635 | `	sxu32 n;` |
|  227915 | 7636 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|  224705 | 7637 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|  112355 | 7638 | `	}` |
|    3215 | 7639 |  |
|       - | 7640 | `/*` |
...
|       - | 7739 | ` */` |
|   32320 | 7740 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|   32325 | 7751 | `	rc = SXRET_OK;` |
|   32325 | 7752 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|   32325 | 7753 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|   32325 | 7754 | `	n = pMap->nEntry;` |
|   32325 | 7755 | `	pEntry = pMap->pFirst;` |
...
|  129977 | 7762 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|  129977 | 7763 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|       - | 7764 | `		/* Invoke the user callback */` |
|  129977 | 7765 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|       - | 7766 | `		/* Release the copy of the key and the value */` |
|  129977 | 7767 | `		PH7_MemObjRelease(&sKey);` |
|  129977 | 7768 | `		PH7_MemObjRelease(&sValue);` |
|  129977 | 7769 | `		if( rc != PH7_OK ){` |
|       - | 7770 | `			/* Callback request an operation abort */` |
|     ! 0 | 7771 | `			return SXERR_ABORT;` |
|       - | 7772 | `		}` |
|       - | 7773 | `		/* Point to the next entry */` |
|  129977 | 7774 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  129977 | 7775 | `		n--;` |
|       5 | 7776 | `	}` |
|       - | 7777 | `	/* All done */` |
|   32325 | 7778 | `	return SXRET_OK;` |
|   16165 | 7779 |  |
|       - | 7780 |  |
