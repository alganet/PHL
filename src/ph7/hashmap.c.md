...
|       - |   17 | ` */` |
| 2909166 |   18 | `static sxu32 IntHash(sxi64 iKey)` |
|       2 |   19 |  |
| 2909168 |   20 | `	return (sxu32)(iKey ^ (iKey << 8) ^ (iKey >> 8));` |
|       2 |   21 |  |
|       - |   22 | `/*` |
|       - |   23 | ` * Default hash function for string/BLOB keys.` |
|       - |   24 | ` */` |
|  277696 |   25 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|       2 |   26 |  |
|  277698 |   27 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|       - |   28 | `	unsigned char *zEnd;` |
|  277698 |   29 | `	sxu32 nH = 5381;` |
|  277698 |   30 | `	zEnd = &zIn[nLen];` |
|  312828 |   31 | `	for(;;){` |
|  625658 |   32 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  552074 |   33 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  497282 |   34 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  409502 |   35 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|       2 |   36 | `	}` |
|  277698 |   37 | `	return nH;` |
|       2 |   38 |  |
|       - |   39 | `/*` |
...
|       - |   45 | ` */` |
|     860 |   46 | `static sxi64 HashmapCount(ph7_hashmap *pMap,int bRecursive,int *pCycleDetected)` |
|       2 |   47 |  |
|     862 |   48 | `	sxi64 iCount = 0;` |
|     862 |   49 | `	if( !bRecursive ){` |
|     688 |   50 | `		iCount = pMap->nEntry;` |
|     345 |   51 | `	}else{` |
...
|       - |   92 | ` */` |
| 2852460 |   93 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|       2 |   94 |  |
|       - |   95 | `	ph7_hashmap_node *pNode;` |
|       - |   96 | `	/* Allocate a new node */` |
| 2852462 |   97 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
| 2852462 |   98 | `	if( pNode == 0 ){` |
|     ! 0 |   99 | `		return 0;` |
|       - |  100 | `	}` |
|       - |  101 | `	/* Zero the stucture */` |
| 2852462 |  102 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  103 | `	/* Fill in the structure */` |
| 2852462 |  104 | `	pNode->pMap  = &(*pMap);` |
| 2852462 |  105 | `	pNode->iType = HASHMAP_INT_NODE;` |
| 2852462 |  106 | `	pNode->nHash = nHash;` |
| 2852462 |  107 | `	pNode->xKey.iKey = iKey;` |
| 2852462 |  108 | `	pNode->nValIdx  = nValIdx;` |
| 2852462 |  109 | `	return pNode;` |
| 1426232 |  110 |  |
|       - |  111 | `/*` |
...
|       - |  115 | ` */` |
|   98506 |  116 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|       2 |  117 |  |
|       - |  118 | `	ph7_hashmap_node *pNode;` |
|       - |  119 | `	/* Allocate a new node */` |
|   98508 |  120 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   98508 |  121 | `	if( pNode == 0 ){` |
|     ! 0 |  122 | `		return 0;` |
|       - |  123 | `	}` |
|       - |  124 | `	/* Zero the stucture */` |
|   98508 |  125 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  126 | `	/* Fill in the structure */` |
|   98508 |  127 | `	pNode->pMap  = &(*pMap);` |
|   98508 |  128 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|   98508 |  129 | `	pNode->nHash = nHash;` |
|   98508 |  130 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|   98508 |  131 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|   98508 |  132 | `	pNode->nValIdx = nValIdx;` |
|   98508 |  133 | `	return pNode;` |
|   49255 |  134 |  |
|       - |  135 | `/*` |
|       - |  136 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|       - |  137 | ` */` |
| 2950966 |  138 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|       2 |  139 |  |
|       - |  140 | `	/* Link */` |
| 2950968 |  141 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
| 2691494 |  142 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
| 2691494 |  143 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
| 1345746 |  144 | `	}` |
| 2950968 |  145 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|       - |  146 | `	/* Link to the map list */` |
| 2950968 |  147 | `	if( pMap->pFirst == 0 ){` |
|   45466 |  148 | `		pMap->pFirst = pMap->pLast = pNode;` |
|       - |  149 | `		/* Point to the first inserted node */` |
|   45466 |  150 | `		pMap->pCur = pNode;` |
|   22734 |  151 | `	}else{` |
| 2905504 |  152 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|       - |  153 | `	}` |
| 2950968 |  154 | `	++pMap->nEntry;` |
| 2950968 |  155 |  |
|       - |  156 | `/*` |
|       - |  157 | ` * Unlink a node from the hashmap.` |
|       - |  158 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|       - |  159 | ` */` |
|    6926 |  160 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|       2 |  161 |  |
|    6928 |  162 | `	ph7_hashmap *pMap = pNode->pMap;` |
|    6928 |  163 | `	ph7_vm *pVm = pMap->pVm;` |
|       - |  164 | `	/* Unlink from the corresponding bucket */` |
|    6928 |  165 | `	if( pNode->pPrevCollide == 0 ){` |
|    6512 |  166 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|    3257 |  167 | `	}else{` |
|     417 |  168 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|       - |  169 | `	}` |
|    6928 |  170 | `	if( pNode->pNextCollide ){` |
|    5296 |  171 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|    2647 |  172 | `	}` |
|    6928 |  173 | `	if( pMap->pFirst == pNode ){` |
|      82 |  174 | `		pMap->pFirst = pNode->pPrev;` |
|      40 |  175 | `	}` |
|    6928 |  176 | `	if( pMap->pCur == pNode ){` |
|       - |  177 | `		/* Advance the node cursor */` |
|      84 |  178 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|      41 |  179 | `	}` |
|       - |  180 | `	/* Unlink from the map list */` |
|    6928 |  181 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|    6928 |  182 | `	if( bRestore ){` |
...
|      51 |  188 | `		}` |
|      51 |  189 | `	}` |
|    6928 |  190 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|    6802 |  191 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|    3400 |  192 | `	}` |
|    6928 |  193 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|    6928 |  194 | `	pMap->nEntry--;` |
|    6928 |  195 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|       - |  206 | ` */` |
| 2950966 |  207 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|       2 |  208 |  |
| 2950968 |  209 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|   49518 |  210 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|       - |  211 | `		ph7_hashmap_node *pEntry,**apNew;` |
|   49518 |  212 | `		sxu32 nNew = pMap->nSize << 1;` |
|       - |  213 | `		sxu32 nBucket;` |
|       - |  214 | `		sxu32 n;` |
|   49518 |  215 | `		if( nNew < 1 ){` |
|   45466 |  216 | `			nNew = 16;` |
...
|   49518 |  219 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|   49518 |  220 | `		if( apNew == 0 ){` |
...
|       - |  226 | `		}` |
|       - |  227 | `		/* Zero the table */` |
|   49518 |  228 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|       - |  229 | `		/* Reflect the change */` |
|   49518 |  230 | `		pMap->apBucket = apNew;` |
|   49518 |  231 | `		pMap->nSize = nNew;` |
|   49518 |  232 | `		if( apOld == 0 ){` |
|       - |  233 | `			/* First allocated table [i.e: no entry],return immediately */` |
|   45466 |  234 | `			return SXRET_OK;` |
|       - |  235 | `		}` |
|       - |  236 | `		/* Rehash old entries */` |
|    4054 |  237 | `		pEntry = pMap->pFirst;` |
|    4054 |  238 | `		n = 0;` |
| 1989178 |  239 | `		for( ;; ){` |
| 3978358 |  240 | `			if( n >= pMap->nEntry ){` |
|    4054 |  241 | `				break;` |
|       - |  242 | `			}` |
|       - |  243 | `			/* Clear the old collision link */` |
| 3974306 |  244 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  245 | `			/* Link to the new bucket */` |
| 3974306 |  246 | `			nBucket = pEntry->nHash & (nNew - 1);` |
| 3974306 |  247 | `			if( pMap->apBucket[nBucket] != 0 ){` |
| 3466888 |  248 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
| 3466888 |  249 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
| 1733443 |  250 | `			}` |
| 3974306 |  251 | `			pMap->apBucket[nBucket] = pEntry;` |
|       - |  252 | `			/* Point to the next entry */` |
| 3974306 |  253 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
| 3974306 |  254 | `			n++;` |
|       2 |  255 | `		}` |
|       - |  256 | `		/* Free the old table */` |
|    4054 |  257 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|    2026 |  258 | `	}` |
| 2905504 |  259 | `	return SXRET_OK;` |
| 1475485 |  260 |  |
|       - |  261 | `/*` |
|       - |  262 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|       - |  263 | ` * hashmap.` |
|       - |  264 | ` */` |
| 2852460 |  265 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  266 |  |
|       - |  267 | `	ph7_hashmap_node *pNode;` |
|       - |  268 | `	sxu32 nIdx;` |
|       - |  269 | `	sxu32 nHash;` |
|       - |  270 | `	sxi32 rc;` |
| 2852462 |  271 | `	if( !isForeign ){` |
|       - |  272 | `		ph7_value *pObj;` |
|       - |  273 | `		/* Reserve a ph7_value for the value */` |
| 2852436 |  274 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
| 2852436 |  275 | `		if( pObj == 0 ){` |
|     ! 0 |  276 | `			return SXERR_MEM;` |
|       - |  277 | `		}` |
| 2852436 |  278 | `		if( pValue ){` |
|       - |  279 | `			/* Duplicate the value */` |
| 2852436 |  280 | `			PH7_MemObjStore(pValue,pObj);` |
| 1426217 |  281 | `		}` |
| 2852436 |  282 | `		nIdx = pObj->nIdx;` |
| 1426219 |  283 | `	}else{` |
|      27 |  284 | `		nIdx = nRefIdx;` |
|       - |  285 | `	}` |
|       - |  286 | `	/* Hash the key */` |
| 2852462 |  287 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  288 | `	/* Allocate a new int node */` |
| 2852462 |  289 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
| 2852462 |  290 | `	if( pNode == 0 ){` |
|     ! 0 |  291 | `		return SXERR_MEM;` |
|       - |  292 | `	}` |
| 2852462 |  293 | `	if( isForeign ){` |
...
| 2852462 |  298 | `	rc = HashmapGrowBucket(&(*pMap));` |
| 2852462 |  299 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  300 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  301 | `		return rc;` |
|       - |  302 | `	}` |
|       - |  303 | `	/* Perform the insertion */` |
| 2852462 |  304 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  305 | `	/* Install in the reference table */` |
| 2852462 |  306 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  307 | `	/* All done */` |
| 2852462 |  308 | `	return SXRET_OK;` |
| 1426232 |  309 |  |
|       - |  310 | `/*` |
|       - |  311 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|       - |  312 | ` * hashmap.` |
|       - |  313 | ` */` |
|   98506 |  314 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  315 |  |
|       - |  316 | `	ph7_hashmap_node *pNode;` |
|       - |  317 | `	sxu32 nHash;` |
|       - |  318 | `	sxu32 nIdx;` |
|       - |  319 | `	sxi32 rc;` |
|   98508 |  320 | `	if( !isForeign ){` |
|       - |  321 | `		ph7_value *pObj;` |
|       - |  322 | `		/* Reserve a ph7_value for the value */` |
|   65386 |  323 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   65386 |  324 | `		if( pObj == 0 ){` |
|     ! 0 |  325 | `			return SXERR_MEM;` |
|       - |  326 | `		}` |
|   65386 |  327 | `		if( pValue ){` |
|       - |  328 | `			/* Duplicate the value */` |
|   65122 |  329 | `			PH7_MemObjStore(pValue,pObj);` |
|   32560 |  330 | `		}` |
|   65386 |  331 | `		nIdx = pObj->nIdx;` |
|   32694 |  332 | `	}else{` |
|   33124 |  333 | `		nIdx = nRefIdx;` |
|       - |  334 | `	}` |
|       - |  335 | `	/* Hash the key */` |
|   98508 |  336 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  337 | `	/* Allocate a new blob node */` |
|   98508 |  338 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|   98508 |  339 | `	if( pNode == 0 ){` |
|     ! 0 |  340 | `		return SXERR_MEM;` |
|       - |  341 | `	}` |
|   98508 |  342 | `	if( isForeign ){` |
...
|   98508 |  347 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   98508 |  348 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  349 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  350 | `		return rc;` |
|       - |  351 | `	}` |
|       - |  352 | `	/* Perform the insertion */` |
|   98508 |  353 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  354 | `	/* Install in the reference table */` |
|   98508 |  355 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  356 | `	/* All done */` |
|   98508 |  357 | `	return SXRET_OK;` |
|   49255 |  358 |  |
|       - |  359 | `/*` |
...
|       - |  363 | ` */` |
|   47484 |  364 | `static sxi32 HashmapLookupIntKey(` |
...
|       - |  371 | `	sxu32 nHash;` |
|   47486 |  372 | `	if( pMap->nEntry < 1 ){` |
|       - |  373 | `		/* Don't bother hashing,there is no entry anyway */` |
|     426 |  374 | `		return SXERR_NOTFOUND;` |
|       - |  375 | `	}` |
|       - |  376 | `	/* Hash the key first */` |
|   47062 |  377 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  378 | `	/* Point to the appropriate bucket */` |
|   47062 |  379 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  380 | `	/* Perform the lookup */` |
|  411884 |  381 | `	for(;;){` |
|  823770 |  382 | `		if( pNode == 0 ){` |
|   45922 |  383 | `			break;` |
|       - |  384 | `		}` |
|  778418 |  385 | `		if( pNode->iType == HASHMAP_INT_NODE` |
|  774833 |  386 | `			&& pNode->nHash == nHash` |
|  386481 |  387 | `			&& pNode->xKey.iKey == iKey ){` |
|       - |  388 | `				/* Node found */` |
|    1142 |  389 | `				if( ppNode ){` |
|    1130 |  390 | `					*ppNode = pNode;` |
|     564 |  391 | `				}` |
|    1142 |  392 | `				return SXRET_OK;` |
|       - |  393 | `		}` |
|       - |  394 | `		/* Follow the collision link */` |
|  776710 |  395 | `		pNode = pNode->pNextCollide;` |
|       2 |  396 | `	}` |
|       - |  397 | `	/* No such entry */` |
|   45922 |  398 | `	return SXERR_NOTFOUND;` |
|   23744 |  399 |  |
|       - |  400 | `/*` |
...
|       - |  404 | ` */` |
|  190634 |  405 | `static sxi32 HashmapLookupBlobKey(` |
...
|       - |  413 | `	sxu32 nHash;` |
|  190636 |  414 | `	if( pMap->nEntry < 1 ){` |
|       - |  415 | `		/* Don't bother hashing,there is no entry anyway */` |
|   11446 |  416 | `		return SXERR_NOTFOUND;` |
|       - |  417 | `	}` |
|       - |  418 | `	/* Hash the key first */` |
|  179192 |  419 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  420 | `	/* Point to the appropriate bucket */` |
|  179192 |  421 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  422 | `	/* Perform the lookup */` |
|  168446 |  423 | `	for(;;){` |
|  336894 |  424 | `		if( pNode == 0 ){` |
|  137748 |  425 | `			break;` |
|       - |  426 | `		}` |
|  219868 |  427 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|  197647 |  428 | `			&& pNode->nHash == nHash` |
|  118796 |  429 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|   41446 |  430 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|       - |  431 | `				/* Node found */` |
|   41446 |  432 | `				if( ppNode ){` |
|   41418 |  433 | `					*ppNode = pNode;` |
|   20708 |  434 | `				}` |
|   41446 |  435 | `				return SXRET_OK;` |
|       - |  436 | `		}` |
|       - |  437 | `		/* Follow the collision link */` |
|  157704 |  438 | `		pNode = pNode->pNextCollide;` |
|       2 |  439 | `	}` |
|       - |  440 | `	/* No such entry */` |
|  137748 |  441 | `	return SXERR_NOTFOUND;` |
|   95319 |  442 |  |
|       - |  443 | `/*` |
|       - |  444 | ` * Check if the given BLOB key looks like a decimal number.` |
|       - |  445 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|       - |  446 | ` */` |
|  190776 |  447 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|       2 |  448 |  |
|  190778 |  449 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|  190778 |  450 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|  190778 |  451 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|       - |  452 | `		/* Octal not decimal number */` |
|       5 |  453 | `		return FALSE;` |
|       - |  454 | `	}` |
|  190774 |  455 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|     ! 0 |  456 | `		zIn++;` |
|     ! 0 |  457 | `	}` |
|   95719 |  458 | `	for(;;){` |
|  191440 |  459 | `		if( zIn >= zEnd ){` |
|     233 |  460 | `			return TRUE;` |
|       - |  461 | `		}` |
|  191208 |  462 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|   95272 |  463 | `			break;` |
|       - |  464 | `		}` |
|     667 |  465 | `		zIn++;` |
|       1 |  466 | `	}` |
|       - |  467 | `	/* Key does not look like a decimal number */` |
|  190542 |  468 | `	return FALSE;` |
|   95390 |  469 |  |
|       - |  470 | `/*` |
...
|       - |  474 | ` */` |
|   93102 |  475 | `static sxi32 HashmapLookup(` |
|       - |  476 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|       - |  477 | `	ph7_value *pKey,            /* Lookup key */` |
|       - |  478 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|       - |  479 | `	)` |
|       2 |  480 |  |
|   93104 |  481 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|       - |  482 | `	sxi32 rc;` |
|   93104 |  483 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   92090 |  484 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  485 | `			/* Force a string cast */` |
|     ! 0 |  486 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  487 | `		}` |
|   92090 |  488 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|       - |  489 | `			/* Perform a blob lookup */` |
|   92074 |  490 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|   92074 |  491 | `			goto result;` |
|       - |  492 | `		}` |
|       8 |  493 | `	}` |
|       - |  494 | `	/* Perform an int lookup */` |
|    1032 |  495 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|       - |  496 | `		/* Force an integer cast */` |
|      27 |  497 | `		PH7_MemObjToInteger(pKey);` |
|      13 |  498 | `	}` |
|       - |  499 | `	/* Perform an int lookup */` |
|    1032 |  500 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|   46551 |  501 | `result:` |
|   93104 |  502 | `	if( rc == SXRET_OK ){` |
|       - |  503 | `		/* Node found */` |
|   42350 |  504 | `		if( ppNode ){` |
|   42316 |  505 | `			*ppNode = pNode;` |
|   21157 |  506 | `		}` |
|   42350 |  507 | `		return SXRET_OK;` |
|       - |  508 | `	}` |
|       - |  509 | `	/* No such entry */` |
|   50756 |  510 | `	return SXERR_NOTFOUND;` |
|   46553 |  511 |  |
|       - |  512 | `/*` |
...
|       - |  517 | ` */` |
| 2917518 |  518 | `static sxi32 HashmapInsert(` |
|       - |  519 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|       - |  520 | `	ph7_value *pKey,   /* Lookup key  */` |
|       - |  521 | `	ph7_value *pVal    /* Node value */` |
|       - |  522 | `	)` |
|       2 |  523 |  |
| 2917520 |  524 | `	ph7_hashmap_node *pNode = 0;` |
| 2917520 |  525 | `	sxi32 rc = SXRET_OK;` |
| 2917520 |  526 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   65598 |  527 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  528 | `			/* Force a string cast */` |
|       3 |  529 | `			PH7_MemObjToString(&(*pKey));` |
|       1 |  530 | `		}` |
|   65598 |  531 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     256 |  536 | `			goto IntKey;` |
|       - |  537 | `		}` |
|   98015 |  538 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   32671 |  539 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|       - |  552 | `		}` |
|   65290 |  553 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  554 | `			/* Forbidden */` |
...
|   65288 |  559 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|   65288 |  560 | `		return rc;` |
|       - |  561 | `	}` |
| 1425961 |  562 | `IntKey:` |
| 2852178 |  563 | `	if( pKey ){` |
|   23354 |  564 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|       - |  565 | `			/* Force an integer cast */` |
|     251 |  566 | `			PH7_MemObjToInteger(pKey);` |
|     125 |  567 | `		}` |
|   23354 |  568 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
...
|       - |  581 | `		}` |
|   23274 |  582 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  583 | `			/* Forbidden */` |
...
|   23272 |  588 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   23272 |  589 | `		if( rc == SXRET_OK ){` |
|   23272 |  590 | `			if( pKey->x.iVal >= pMap->iNextIdx ){` |
|       - |  591 | `				/* Increment the automatic index */` |
|   23036 |  592 | `				pMap->iNextIdx = pKey->x.iVal + 1;` |
|       - |  593 | `				/* Make sure the automatic index is not reserved */` |
|   23036 |  594 | `				while( SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|     ! 0 |  595 | `					pMap->iNextIdx++;` |
|     ! 0 |  596 | `				}` |
|   11517 |  597 | `			}` |
|   11635 |  598 | `		}` |
|   11637 |  599 | `	}else{` |
| 2828826 |  600 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  601 | `			/* Forbidden */` |
...
| 2828824 |  606 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
| 2828824 |  607 | `		if( rc == SXRET_OK ){` |
| 2828824 |  608 | `			++pMap->iNextIdx;` |
| 1414411 |  609 | `		}` |
|       - |  610 | `	}` |
|       - |  611 | `	/* Insertion result */` |
| 2852094 |  612 | `	return rc;` |
| 1458761 |  613 |  |
|       - |  614 | `/*` |
...
|       - |  712 | ` */` |
| 1014564 |  713 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       2 |  714 |  |
|       - |  715 | `	/* Point to the desired object */` |
|       - |  716 | `	ph7_value *pObj;` |
| 1014566 |  717 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
| 1014566 |  718 | `	return pObj;` |
|       2 |  719 |  |
|       - |  720 | `/*` |
...
|       - |  762 | ` * documenation.` |
|       - |  763 | ` */` |
|   44879 |  764 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       2 |  765 |  |
|       - |  766 | `	ph7_value sObj1,sObj2;` |
|       - |  767 | `	sxi32 rc;` |
|   44881 |  768 | `	if( pLeft == pRight ){` |
|       - |  769 | `		/*` |
...
|   44881 |  776 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   44881 |  777 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   44881 |  778 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   44881 |  779 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   44881 |  780 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   44881 |  781 | `	PH7_MemObjRelease(&sObj1);` |
|   44881 |  782 | `	PH7_MemObjRelease(&sObj2);` |
|   44881 |  783 | `	return rc;` |
|   22474 |  784 |  |
|       - |  785 | `/*` |
...
|       - |  788 | ` */` |
|    9646 |  789 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|       2 |  790 |  |
|    9648 |  791 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|       - |  792 | `	sxu32 nBucket;` |
|       - |  793 | `	/* Remove old collision links */` |
|    9648 |  794 | `	if( pEntry->pPrevCollide ){` |
|    7689 |  795 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|    3842 |  796 | `	}else{` |
|    1961 |  797 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|       - |  798 | `	}` |
|    9648 |  799 | `	if( pEntry->pNextCollide ){` |
|     709 |  800 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|     354 |  801 | `	}` |
|    9648 |  802 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  803 | `	/* Compute the new hash */` |
|    9648 |  804 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|    9648 |  805 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|    9648 |  806 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|       - |  807 | `	/* Link to the new bucket */` |
|    9648 |  808 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|    9648 |  809 | `	if( pMap->apBucket[nBucket] ){` |
|    7874 |  810 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|    3937 |  811 | `	}` |
|    9648 |  812 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|    9648 |  813 | `	pMap->apBucket[nBucket] = pEntry;` |
|       - |  814 | `	/* Increment the automatic index */` |
|    9648 |  815 | `	pMap->iNextIdx++;` |
|    9648 |  816 |  |
|       - |  817 | `/*` |
...
|       - |  823 | ` */` |
|   24286 |  824 | `static int HashmapFindValue(` |
...
|   24288 |  837 | `	pEntry = pMap->pFirst;` |
|   24288 |  838 | `	n = pMap->nEntry;` |
|   24288 |  839 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|   24288 |  840 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|   58227 |  841 | `	for(;;){` |
|  116456 |  842 | `		if( n < 1 ){` |
|      99 |  843 | `			break;` |
|       - |  844 | `		}` |
|       - |  845 | `		/* Extract node value */` |
|  116358 |  846 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  116358 |  847 | `		if( pVal ){` |
|  116358 |  848 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  858 | `			}else{` |
|       - |  859 | `				/* Duplicate value */` |
|  116358 |  860 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  116358 |  861 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  116358 |  862 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  116358 |  863 | `				PH7_MemObjRelease(&sVal);` |
|  116358 |  864 | `				PH7_MemObjRelease(&sNeedle);` |
|  116358 |  865 | `				if( rc == 0 ){` |
|   24190 |  866 | `					if( ppNode ){` |
|      23 |  867 | `						*ppNode = pEntry;` |
|      11 |  868 | `					}` |
|       - |  869 | `					/* Match found*/` |
|   24190 |  870 | `					return SXRET_OK;` |
|       - |  871 | `				}` |
|       - |  872 | `			}` |
|   46084 |  873 | `		}` |
|       - |  874 | `		/* Point to the next entry */` |
|   92170 |  875 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   92170 |  876 | `		n--;` |
|       2 |  877 | `	}` |
|       - |  878 | `	/* No such entry */` |
...
|       - | 1053 | ` */` |
|  489366 | 1054 | `static sxi32 HashmapDuplicateNode(` |
...
|       - | 1059 | `	)` |
|       2 | 1060 |  |
|  489368 | 1061 | `	ph7_value sSafeVal = *pVal;` |
|       - | 1062 | `	ph7_value sKey;` |
|       - | 1063 | `	sxi32 rc;` |
|       - | 1064 |  |
|  489368 | 1065 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      26 | 1071 | `	}else{` |
|       - | 1072 | `		/* Int key */` |
|  489318 | 1073 | `		if( iAction == 0 ){ /* Merge */` |
|  489100 | 1074 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|  244769 | 1075 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|  490964 | 1112 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|       - | 1113 | `		/* Extract the node value */` |
|  489116 | 1114 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  489116 | 1115 | `		if( pVal ){` |
...
|       - | 1120 | `			 */` |
|  489116 | 1121 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|  244559 | 1122 | `		}else{` |
|     ! 0 | 1123 | `			rc = SXRET_OK;` |
|       - | 1124 | `		}` |
|  489116 | 1125 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1126 | `			return rc;` |
|       - | 1127 | `		}` |
|       - | 1128 | `		/* Point to the next entry */` |
|  489116 | 1129 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  244559 | 1130 | `	}` |
...
|       - | 1218 | ` */` |
|  168620 | 1219 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|       2 | 1220 |  |
|  168622 | 1221 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - | 1222 | `	ph7_hashmap *pNew;` |
|       - | 1223 | `	ph7_value *pBacking;` |
|  168622 | 1224 | `	if( pMap->iRef < 2 ){` |
|       - | 1225 | `		/* Sole owner, no separation needed */` |
|  166612 | 1226 | `		return pMap;` |
|       - | 1227 | `	}` |
...
|       - | 1372 | ` */` |
|   73816 | 1373 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|   73818 | 1381 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|   73818 | 1382 | `	if( pMap == 0 ){` |
|     ! 0 | 1383 | `		return 0;` |
|       - | 1384 | `	}` |
|       - | 1385 | `	/* Zero the structure */` |
|   73818 | 1386 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|       - | 1387 | `	/* Fill in the structure */` |
|   73818 | 1388 | `	pMap->pVm = &(*pVm);` |
|   73818 | 1389 | `	pMap->iRef = 1;` |
|       - | 1390 | `	/* Default hash functions */` |
|   73818 | 1391 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|   73818 | 1392 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|   73818 | 1393 | `	return pMap;` |
|   36910 | 1394 |  |
|       - | 1395 | `/*` |
...
|       - | 1485 | ` */` |
|   44950 | 1486 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|       2 | 1487 |  |
|       - | 1488 | `	ph7_hashmap_node *pEntry,*pNext;` |
|   44952 | 1489 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1490 | `	sxu32 n;` |
|   44952 | 1491 | `	if( pMap == pVm->pGlobal ){` |
...
|   44952 | 1497 | `	n = 0;` |
|   44952 | 1498 | `	pEntry = pMap->pFirst;` |
| 1476850 | 1499 | `	for(;;){` |
| 2953702 | 1500 | `		if( n >= pMap->nEntry ){` |
|   44952 | 1501 | `			break;` |
|       - | 1502 | `		}` |
| 2908752 | 1503 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|       - | 1504 | `		/* Remove the reference from the foreign table */` |
| 2908752 | 1505 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
| 2908752 | 1506 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|       - | 1507 | `			/* Restore the ph7_value to the free list */` |
| 2908744 | 1508 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
| 1454371 | 1509 | `		}` |
|       - | 1510 | `		/* Release the node */` |
| 2908752 | 1511 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|   61450 | 1512 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|   30724 | 1513 | `		}` |
| 2908752 | 1514 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|       - | 1515 | `		/* Point to the next entry */` |
| 2908752 | 1516 | `		pEntry = pNext;` |
| 2908752 | 1517 | `		n++;` |
|       2 | 1518 | `	}` |
|   44952 | 1519 | `	if( pMap->nEntry > 0 ){` |
|       - | 1520 | `		/* Release the hash bucket */` |
|   39962 | 1521 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|   19980 | 1522 | `	}` |
|   44952 | 1523 | `	if( FreeDS ){` |
|       - | 1524 | `		/* Free the whole instance */` |
|   44936 | 1525 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|   22469 | 1526 | `	}else{` |
...
|       - | 1539 | ` */` |
|  510788 | 1540 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|       2 | 1541 |  |
|  510790 | 1542 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1543 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|  510790 | 1544 | `	pMap->iRef--;` |
|  510790 | 1545 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|   44936 | 1546 | `		PH7_HashmapRelease(pMap,TRUE);` |
|   22467 | 1547 | `	}` |
|  510790 | 1548 |  |
|       - | 1549 | `/*` |
...
|       - | 1553 | ` */` |
|   93120 | 1554 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|       - | 1574 | ` */` |
| 2428208 | 1575 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|       2 | 1580 |  |
|       - | 1581 | `	sxi32 rc;` |
| 2428210 | 1582 | `	if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP) && (ph7_hashmap *)pVal->x.pOther == pMap->pVm->pGlobal ){` |
|       - | 1583 | `		/*` |
...
|       - | 1588 | `	}` |
| 2428210 | 1589 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
| 2428210 | 1590 | `	return rc;` |
| 1214106 | 1591 |  |
|       - | 1592 | `/*` |
...
|       - | 1638 | ` */` |
|   20146 | 1639 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|       2 | 1640 |  |
|       - | 1641 | `	/* Reset the loop cursor */` |
|   20148 | 1642 | `	pMap->pCur = pMap->pFirst;` |
|   20148 | 1643 |  |
|       - | 1644 | `/*` |
...
|       - | 1649 | ` */` |
|  163434 | 1650 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|       2 | 1651 |  |
|  163436 | 1652 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|  163436 | 1653 | `	if( pCur == 0 ){` |
|       - | 1654 | `		/* End of the list,return null */` |
|   10094 | 1655 | `		return 0;` |
|       - | 1656 | `	}` |
|       - | 1657 | `	/* Advance the node cursor */` |
|  153344 | 1658 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|  153344 | 1659 | `	return pCur;` |
|   81719 | 1660 |  |
|       - | 1661 | `/*` |
|       - | 1662 | ` * Extract a node value.` |
|       - | 1663 | ` */` |
|  385024 | 1664 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       2 | 1665 |  |
|  385026 | 1666 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  385026 | 1667 | `	if( pEntry ){` |
|  385026 | 1668 | `		if( bStore ){` |
|  153410 | 1669 | `			PH7_MemObjStore(pEntry,pValue);` |
|   76706 | 1670 | `		}else{` |
|  231618 | 1671 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1672 | `		}` |
|  192579 | 1673 | `	}else{` |
...
|       - | 1679 | ` */` |
|   99840 | 1680 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|       2 | 1681 |  |
|       - | 1682 | `	/* Fill with the current key */` |
|   99842 | 1683 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|   99562 | 1684 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|      13 | 1685 | `			SyBlobRelease(&pKey->sBlob);` |
|       6 | 1686 | `		}` |
|   99562 | 1687 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|   99562 | 1688 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|   49782 | 1689 | `	}else{` |
...
|       - | 1740 | `**   changed.` |
|       - | 1741 | `*/` |
|   28040 | 1742 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|       2 | 1743 |  |
|       - | 1744 | `	ph7_hashmap_node result,*pTail;` |
|       - | 1745 | `    /* Prevent compiler warning */` |
|   28042 | 1746 | `	result.pNext = result.pPrev = 0;` |
|   28042 | 1747 | `	pTail = &result;` |
|   73005 | 1748 | `	while( pA && pB ){` |
|   44965 | 1749 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|   29552 | 1750 | `			pTail->pPrev = pA;` |
|   29552 | 1751 | `			pA->pNext = pTail;` |
|   29552 | 1752 | `			pTail = pA;` |
|   29552 | 1753 | `			pA = pA->pPrev;` |
|   14783 | 1754 | `		}else{` |
|   15415 | 1755 | `			pTail->pPrev = pB;` |
|   15415 | 1756 | `			pB->pNext = pTail;` |
|   15415 | 1757 | `			pTail = pB;` |
|   15415 | 1758 | `			pB = pB->pPrev;` |
|       - | 1759 | `		}` |
|       2 | 1760 | `	}` |
|   28042 | 1761 | `	if( pA ){` |
|   20661 | 1762 | `		pTail->pPrev = pA;` |
|   20661 | 1763 | `		pA->pNext = pTail;` |
|   17709 | 1764 | `	}else if( pB ){` |
|    7177 | 1765 | `		pTail->pPrev = pB;` |
|    7177 | 1766 | `		pB->pNext = pTail;` |
|    3593 | 1767 | `	}else{` |
|     208 | 1768 | `		pTail->pPrev = pTail->pNext = 0;` |
|       - | 1769 | `	}` |
|   28042 | 1770 | `	return result.pPrev;` |
|       2 | 1771 |  |
|       - | 1772 | `/*` |
|       - | 1773 | `** Inputs:` |
...
|   10388 | 1791 | `	while( pIn ){` |
|    9764 | 1792 | `		p = pIn;` |
|    9764 | 1793 | `		pIn = p->pPrev;` |
|    9764 | 1794 | `		p->pPrev = 0;` |
|   18460 | 1795 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|   18460 | 1796 | `			if( a[i]==0 ){` |
|    9764 | 1797 | `				a[i] = p;` |
|    9764 | 1798 | `				break;` |
|     ! 0 | 1799 | `			}else{` |
|    8698 | 1800 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|    8698 | 1801 | `				a[i] = 0;` |
|       - | 1802 | `			}` |
|    4350 | 1803 | `		}` |
|    9764 | 1804 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       - | 1825 | ` */` |
|   44835 | 1826 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       2 | 1827 |  |
|       - | 1828 | `	ph7_value sA,sB;` |
|       - | 1829 | `	sxi32 iFlags;` |
|       - | 1830 | `	int rc;` |
|   44837 | 1831 | `	if( pCmpData == 0 ){` |
|       - | 1832 | `		/* Perform a standard comparison */` |
|   44813 | 1833 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   44813 | 1834 | `		return rc;` |
|       - | 1835 | `	}` |
...
|       2 | 2124 | `		}` |
|    9594 | 2125 | `		HashmapRehashIntNode(p);` |
|       - | 2126 | `		/* Point to the next entry */` |
|    9594 | 2127 | `		i++;` |
|    9594 | 2128 | `		pLast = p;` |
|    9594 | 2129 | `		p = p->pPrev; /* Reverse link */` |
|       2 | 2130 | `	}` |
|     578 | 2131 |  |
|       - | 2132 | `/*` |
...
|       - | 2624 | ` */` |
|     730 | 2625 | `static int ph7_hashmap_count(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 2626 |  |
|     732 | 2627 | `	int bRecursive = FALSE;` |
|     732 | 2628 | `	int bCycleDetected = FALSE;` |
|       - | 2629 | `	sxi64 iCount;` |
|     732 | 2630 | `	if( nArg < 1 ){` |
...
|       - | 2641 | `			);` |
|       - | 2642 | `	}` |
|     728 | 2643 | `	if( !ph7_value_is_array(apArg[0]) ){` |
...
|      14 | 2659 | `	}` |
|       - | 2660 | `	/* Count */` |
|     714 | 2661 | `	iCount = HashmapCount((ph7_hashmap *)apArg[0]->x.pOther,bRecursive,&bCycleDetected);` |
|     714 | 2662 | `	if( bCycleDetected ){` |
|       3 | 2663 | `		PH7_VmThrowError(pCtx->pVm,0,PH7_CTX_WARNING,"count(): Recursion detected");` |
|       1 | 2664 | `	}` |
|     714 | 2665 | `	ph7_result_int64(pCtx,iCount);` |
|     714 | 2666 | `	return PH7_OK;` |
|     367 | 2667 |  |
|       - | 2668 | `/*` |
...
|       - | 3913 | ` */` |
|   24094 | 3914 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 3915 |  |
|       - | 3916 | `	ph7_value *pNeedle;` |
|       - | 3917 | `	int bStrict;` |
|       - | 3918 | `	int rc;` |
|   24096 | 3919 | `	if( nArg < 2 ){` |
|       - | 3920 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 3921 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 3922 | `		return PH7_OK;` |
|       - | 3923 | `	}` |
|   24096 | 3924 | `	pNeedle = apArg[0];` |
|   24096 | 3925 | `	bStrict = 0;` |
|   24096 | 3926 | `	if( nArg > 2 ){` |
|       5 | 3927 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|       2 | 3928 | `	}` |
|   24096 | 3929 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   24096 | 3937 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 3938 | `	/* Lookup result */` |
|   24096 | 3939 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   24096 | 3940 | `	return PH7_OK;` |
|   12049 | 3941 |  |
|       - | 3942 | `/*` |
...
|       4 | 5946 | `			pNode = pMap->pLast;` |
|       4 | 5947 | `			nEntry = pMap->nEntry - nEntry;` |
|       4 | 5948 | `			if( nEntry > 1 ){` |
|     ! 0 | 5949 | `				for(;;){` |
|     ! 0 | 5950 | `					if( nEntry == 0 ){` |
|     ! 0 | 5951 | `						break;` |
...
|       - | 6961 | ` */` |
|   24384 | 6962 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|   24386 | 6973 | `	rc = SXRET_OK;` |
|   24386 | 6974 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|   24386 | 6975 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|   24386 | 6976 | `	n = pMap->nEntry;` |
|   24386 | 6977 | `	pEntry = pMap->pFirst;` |
...
|   99312 | 6984 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|   99312 | 6985 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|       - | 6986 | `		/* Invoke the user callback */` |
|   99312 | 6987 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|       - | 6988 | `		/* Release the copy of the key and the value */` |
|   99312 | 6989 | `		PH7_MemObjRelease(&sKey);` |
|   99312 | 6990 | `		PH7_MemObjRelease(&sValue);` |
|   99312 | 6991 | `		if( rc != PH7_OK ){` |
|       - | 6992 | `			/* Callback request an operation abort */` |
|     ! 0 | 6993 | `			return SXERR_ABORT;` |
|       - | 6994 | `		}` |
|       - | 6995 | `		/* Point to the next entry */` |
|   99312 | 6996 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   99312 | 6997 | `		n--;` |
|       2 | 6998 | `	}` |
|       - | 6999 | `	/* All done */` |
|   24386 | 7000 | `	return SXRET_OK;` |
|   12194 | 7001 |  |
|       - | 7002 |  |
