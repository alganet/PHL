...
Coverage: 3941/4451 lines (88.54%)
...
|         - |   22 | ` */` |
|   7464320 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7464325 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7464325 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    646814 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    646819 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    646819 |   35 | `	sxu32 nH = 5381;` |
|    646819 |   36 | `	zEnd = &zIn[nLen];` |
|    729986 |   37 | `	for(;;){` |
|   1459977 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1243771 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1111687 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    970123 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    646819 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3163156 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3163161 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3163161 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3163161 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3163161 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3163161 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3163161 |  112 | `	pNode->nHash = nHash;` |
|   3163161 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3163161 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3163161 |  115 | `	return pNode;` |
|   1581583 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  143 | ` */` |
|   3433448 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3433453 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2951275 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2951275 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1475635 |  150 | `	}` |
|   3433453 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3433453 |  153 | `	if( pMap->pFirst == 0 ){` |
|     91825 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     91825 |  156 | `		pMap->pCur = pNode;` |
|     45915 |  157 | `	}else{` |
|   3341633 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3433453 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3433448 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3433453 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     96947 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     96947 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     96947 |  245 | `		if( nNew < 1 ){` |
|     91825 |  246 | `			nNew = 16;` |
...
|     96947 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     96947 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     96947 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     96947 |  260 | `		pMap->apBucket = apNew;` |
|     96947 |  261 | `		pMap->nSize = nNew;` |
|     96947 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     91825 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5127 |  267 | `		pEntry = pMap->pFirst;` |
|      5127 |  268 | `		n = 0;` |
|   2112545 |  269 | `		for( ;; ){` |
|   4225095 |  270 | `			if( n >= pMap->nEntry ){` |
|      5127 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   4219973 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   4219973 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   4219973 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   3597839 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3597839 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1798917 |  280 | `			}` |
|   4219973 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   4219973 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   4219973 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5127 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2561 |  288 | `	}` |
|   3341633 |  289 | `	return SXRET_OK;` |
|   1716729 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3163156 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3163161 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3163119 |  310 | `		if( pValue ){` |
|   3163113 |  311 | `			sSafeVal = *pValue;` |
|   3163113 |  312 | `			pValue = &sSafeVal;` |
|   1581554 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3163119 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3163119 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3163119 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3163113 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1581554 |  322 | `		}` |
|   3163119 |  323 | `		nIdx = pObj->nIdx;` |
|   1581562 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3163161 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3163161 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3163161 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3163161 |  334 | `	if( isForeign ){` |
...
|   3163161 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3163161 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3163161 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3163161 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3163161 |  349 | `	return SXRET_OK;` |
|   1581583 |  350 | `}` |
|         - |  351 | `/*` |
...
|     45787 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     22891 |  397 | `	}` |
...
|         - |  456 | ` */` |
|    412424 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    412429 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     35907 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    376527 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    376527 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    309495 |  475 | `	for(;;){` |
|    618995 |  476 | `		if( pNode == 0 ){` |
|    312223 |  477 | `			break;` |
|         - |  478 | `		}` |
|    306772 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    305261 |  480 | `			&& pNode->nHash == nHash` |
|    184077 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     64409 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     64309 |  484 | `				if( ppNode ){` |
|     64281 |  485 | `					*ppNode = pNode;` |
|     32138 |  486 | `				}` |
|     64309 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    242473 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    312223 |  493 | `	return SXERR_NOTFOUND;` |
|    206217 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    412556 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    412561 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    412561 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    412561 |  504 | `	int isNeg = FALSE, nDigit;` |
|    412561 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    412539 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    412535 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    412535 |  516 | `	zDigit = zIn;` |
|    206699 |  517 | `	for(;;){` |
|    413403 |  518 | `		if( zIn >= zEnd ){` |
|       251 |  519 | `			break;` |
|         - |  520 | `		}` |
|    413153 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    412285 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       869 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    147118 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    147123 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    147123 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    142263 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    142263 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    142249 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    142249 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         7 |  567 | `	}` |
...
|     73559 |  575 | `result:` |
|    147123 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     68423 |  578 | `		if( ppNode ){` |
|     68373 |  579 | `			*ppNode = pNode;` |
|     34184 |  580 | `		}` |
|     68423 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     78705 |  584 | `	return SXERR_NOTFOUND;` |
|     73564 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1021320 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1021325 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1021319 |  623 | `	return FALSE;` |
|    510665 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3387204 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3387209 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3387209 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3387209 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    224509 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    224509 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    336419 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    112138 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    223803 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    223673 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    223673 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1581350 |  683 | `IntKey:` |
|   3162933 |  684 | `	if( pKey ){` |
...
|   1070731 |  714 | `		}` |
|   1070736 |  715 | `	}else{` |
|   1021291 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1021289 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1021283 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1021283 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1021281 |  726 | `			++pMap->iNextIdx;` |
|    510638 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3162745 |  730 | `	return rc;` |
|   1693607 |  731 | `}` |
|         - |  732 | `/*` |
...
|     45799 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     45799 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     68693 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     22896 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     45787 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     45787 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1444726 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1444731 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1444731 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     71775 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     71780 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     71780 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     71780 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     71780 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     71780 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     71780 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     71780 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     71780 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     71780 |  921 | `	return rc;` |
|     35865 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     13992 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     13997 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     13997 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11392 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5705 |  934 | `	}else{` |
|      2610 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     13997 |  937 | `	if( pEntry->pNextCollide ){` |
|      1137 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       581 |  939 | `	}` |
|     13997 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     13997 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     13997 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     13997 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     13997 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13997 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11717 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5869 |  949 | `	}` |
|     13997 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13997 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     13997 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     13997 |  956 | `		pMap->iNextIdx++;` |
|      6996 |  957 | `	}` |
|     13997 |  958 | `}` |
|         - |  959 | `/*` |
...
|    157171 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    157171 |  989 | `		if( pVal ){` |
...
|    157171 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    157171 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    157171 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    157171 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    157171 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    157171 | 1001 | `			if( rc == 0 ){` |
...
|    124293 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    124293 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    664144 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    664144 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    664146 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    664141 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    664141 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1241 | `		/* Blob key insertion */` |
|      3967 | 1242 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      3967 | 1243 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      3967 | 1244 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      3967 | 1245 | `		PH7_MemObjRelease(&sKey);` |
|      1986 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    660179 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    659937 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    330211 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|        17 | 1254 | `		}else{ /* Dup */` |
|       215 | 1255 | `			rc = HashmapInsertIntKey(pDest,pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|         - | 1256 | `		}` |
|         - | 1257 | `	}` |
|    664141 | 1258 | `	return rc;` |
|    332077 | 1259 | `}` |
|         - | 1260 | `/*` |
...
|    662777 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    659997 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    659997 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    659997 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    330001 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    659997 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    659997 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    330001 | 1305 | `	}` |
...
|      7981 | 1372 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1373 | `		/* Extract the node value */` |
|      4113 | 1374 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      4113 | 1375 | `		if( pVal ){` |
|      4113 | 1376 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      2059 | 1377 | `		}else{` |
|       ! 0 | 1378 | `			rc = SXRET_OK;` |
|         - | 1379 | `		}` |
|      4113 | 1380 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1381 | `			return rc;` |
|         - | 1382 | `		}` |
|         - | 1383 | `		/* Point to the next entry */` |
|      4113 | 1384 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      2059 | 1385 | `	}` |
...
|         - | 1462 | ` */` |
|    233076 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    233081 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    233081 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    233081 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    230399 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|      3785 | 1609 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
|         - | 1610 | `		/* Make sure the given key does not exists in the left array */` |
|        38 | 1611 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1612 | `			/* BLOB key */` |
|        24 | 1613 | `			if( SXRET_OK !=` |
...
|        14 | 1626 | `		}else{` |
|         - | 1627 | `			/* INT key */` |
|        16 | 1628 | `			if( SXRET_OK != HashmapLookupIntKey(&(*pLeft),pEntry->xKey.iKey,0) ){` |
|        11 | 1629 | `				pObj = HashmapExtractNodeValue(pEntry);` |
|        11 | 1630 | `				if( pObj ){` |
|        11 | 1631 | `					ph7_value sSafeVal = *pObj;` |
|         - | 1632 | `					/* Perform the insertion */` |
|        11 | 1633 | `					rc = HashmapInsertIntKey(&(*pLeft),pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|        11 | 1634 | `					if( rc != SXRET_OK ){` |
|       ! 0 | 1635 | `						return rc;` |
|         - | 1636 | `					}` |
|         5 | 1637 | `				}` |
|         5 | 1638 | `			}` |
...
|        38 | 1641 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|        21 | 1642 | `	}` |
...
|         - | 1648 | ` */` |
|    143528 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    143533 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    143533 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    143533 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    143533 | 1664 | `	pMap->pVm = &(*pVm);` |
|    143533 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    143533 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    143533 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    143533 | 1669 | `	return pMap;` |
|     71769 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|    101748 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|    101753 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|    101753 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|    101753 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|    101753 | 1785 | `	n = 0;` |
|    101753 | 1786 | `	pEntry = pMap->pFirst;` |
|   1724761 | 1787 | `	for(;;){` |
|   3449527 | 1788 | `		if( n >= pMap->nEntry ){` |
|    101753 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3347779 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3347779 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3347779 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3347719 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1673857 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3347779 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    196383 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     98189 | 1801 | `		}` |
|   3347779 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3347779 | 1804 | `		pEntry = pNext;` |
|   3347779 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|    101753 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     76709 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     38352 | 1810 | `	}` |
|    101753 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|    101727 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     50866 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    838618 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    838623 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    838623 | 1833 | `	pMap->iRef--;` |
|    838623 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|    101707 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     50851 | 1836 | `	}` |
|    838623 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    147290 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   2727022 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2727027 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2727027 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1914 | ` */` |
|     45824 | 1915 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1920 | `{` |
|         - | 1921 | `	sxi32 rc;` |
|     45829 | 1922 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1928 | `	}` |
|     45829 | 1929 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     45829 | 1930 | `	return rc;` |
|     22917 | 1931 | `}` |
|         - | 1932 | `/*` |
...
|         - | 1939 | ` */` |
|     18862 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     18867 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     18867 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     18867 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     18867 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     18762 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     18767 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     18767 | 1955 | `	while( *ppLink ){` |
|     18767 | 1956 | `		if( *ppLink == pStep ){` |
|     18767 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     18767 | 1958 | `			pStep->pNextActive = 0;` |
|     18767 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    589148 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    589153 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    589153 | 1987 | `	if( pEntry ){` |
|    589153 | 1988 | `		if( bStore ){` |
|    233813 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    116909 | 1990 | `		}else{` |
|    355345 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    294524 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    155308 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    155313 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    150153 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    150153 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    150153 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     75079 | 2009 | `	}else{` |
|      5165 | 2010 | `		SyBlobReset(&pKey->sBlob);` |
|      5165 | 2011 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5165 | 2012 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2013 | `	}` |
|    155313 | 2014 | `}` |
...
|         - | 2063 | `**   changed.` |
|         - | 2064 | `*/` |
|     35930 | 2065 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2066 | `{` |
|         - | 2067 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2068 | `    /* Prevent compiler warning */` |
|     35935 | 2069 | `	result.pNext = result.pPrev = 0;` |
|     35935 | 2070 | `	pTail = &result;` |
|    107854 | 2071 | `	while( pA && pB ){` |
|     71924 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47610 | 2073 | `			pTail->pPrev = pA;` |
|     47610 | 2074 | `			pA->pNext = pTail;` |
|     47610 | 2075 | `			pTail = pA;` |
|     47610 | 2076 | `			pA = pA->pPrev;` |
|     23777 | 2077 | `		}else{` |
|     24319 | 2078 | `			pTail->pPrev = pB;` |
|     24319 | 2079 | `			pB->pNext = pTail;` |
|     24319 | 2080 | `			pTail = pB;` |
|     24319 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     35935 | 2084 | `	if( pA ){` |
|     25381 | 2085 | `		pTail->pPrev = pA;` |
|     25381 | 2086 | `		pA->pNext = pTail;` |
|     23268 | 2087 | `	}else if( pB ){` |
|     10333 | 2088 | `		pTail->pPrev = pB;` |
|     10333 | 2089 | `		pB->pNext = pTail;` |
|      5148 | 2090 | `	}else{` |
|       231 | 2091 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2092 | `	}` |
|     35935 | 2093 | `	return result.pPrev;` |
|         5 | 2094 | `}` |
|         - | 2095 | `/*` |
|         - | 2096 | `** Inputs:` |
...
|     14759 | 2114 | `	while( pIn ){` |
|     14009 | 2115 | `		p = pIn;` |
|     14009 | 2116 | `		pIn = p->pPrev;` |
|     14009 | 2117 | `		p->pPrev = 0;` |
|     26689 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     26689 | 2119 | `			if( a[i]==0 ){` |
|     14009 | 2120 | `				a[i] = p;` |
|     14009 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
|     12685 | 2123 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12685 | 2124 | `				a[i] = 0;` |
|         - | 2125 | `			}` |
|      6345 | 2126 | `		}` |
|     14009 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|         - | 2149 | ` */` |
|     71645 | 2150 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2151 | `{` |
|         - | 2152 | `	ph7_value sA,sB;` |
|         - | 2153 | `	sxi32 iFlags;` |
|         - | 2154 | `	int rc;` |
|     71650 | 2155 | `	if( pCmpData == 0 ){` |
|         - | 2156 | `		/* Perform a standard comparison */` |
|     71626 | 2157 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|     71626 | 2158 | `		return rc;` |
|         - | 2159 | `	}` |
...
|         2 | 2477 | `		}` |
|     13773 | 2478 | `		HashmapRehashIntNode(p);` |
|         - | 2479 | `		/* Point to the next entry */` |
|     13773 | 2480 | `		i++;` |
|     13773 | 2481 | `		pLast = p;` |
|     13773 | 2482 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2483 | `	}` |
|       685 | 2484 | `}` |
|         - | 2485 | `/*` |
...
|         6 | 2975 | `		while(pMap->pLast->pPrev){` |
|         4 | 2976 | `			pMap->pLast = pMap->pLast->pPrev;` |
|         1 | 2977 | `		}` |
|         1 | 2978 | `	}` |
...
|         2 | 7030 | `			pNode = pMap->pLast;` |
|         2 | 7031 | `			nEntry = pMap->nEntry - nEntry;` |
|         2 | 7032 | `			if( nEntry > 1 ){` |
|       ! 0 | 7033 | `				for(;;){` |
|       ! 0 | 7034 | `					if( nEntry == 0 ){` |
|       ! 0 | 7035 | `						break;` |
...
|         - | 8858 | ` */` |
|     33712 | 8859 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33717 | 8870 | `	rc = SXRET_OK;` |
|     33717 | 8871 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33717 | 8872 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33717 | 8873 | `	n = pMap->nEntry;` |
|     33717 | 8874 | `	pEntry = pMap->pFirst;` |
...
|    149889 | 8881 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    149889 | 8882 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8883 | `		/* Invoke the user callback */` |
|    149889 | 8884 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8885 | `		/* Release the copy of the key and the value */` |
|    149889 | 8886 | `		PH7_MemObjRelease(&sKey);` |
|    149889 | 8887 | `		PH7_MemObjRelease(&sValue);` |
|    149889 | 8888 | `		if( rc != PH7_OK ){` |
|         - | 8889 | `			/* Callback request an operation abort */` |
|       ! 0 | 8890 | `			return SXERR_ABORT;` |
|         - | 8891 | `		}` |
|         - | 8892 | `		/* Point to the next entry */` |
|    149889 | 8893 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    149889 | 8894 | `		n--;` |
|         5 | 8895 | `	}` |
|         - | 8896 | `	/* All done */` |
|     33717 | 8897 | `	return SXRET_OK;` |
|     16861 | 8898 | `}` |
|         - | 8899 |  |
