...
|         - |   22 | ` */` |
|   7933361 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7933366 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7933366 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    515913 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    515918 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    515918 |   35 | `	sxu32 nH = 5381;` |
|    515918 |   36 | `	zEnd = &zIn[nLen];` |
|    593208 |   37 | `	for(;;){` |
|   1186422 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1012836 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    911429 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    788779 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    515918 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3624382 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3624387 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3624387 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3624387 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3624387 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3624387 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3624387 |  112 | `	pNode->nHash = nHash;` |
|   3624387 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3624387 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3624387 |  115 | `	return pNode;` |
|   1812196 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199799 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199804 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199804 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199804 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199804 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199804 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199804 |  135 | `	pNode->nHash = nHash;` |
|    199804 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199804 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199804 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199804 |  139 | `	return pNode;` |
|     99904 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3824181 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3824186 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3369505 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3369505 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684752 |  150 | `	}` |
|   3824186 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3824186 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87994 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87994 |  156 | `		pMap->pCur = pNode;` |
|     43999 |  157 | `	}else{` |
|   3736197 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3824186 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3824181 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3824186 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
...
|     87994 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5431 |  267 | `		pEntry = pMap->pFirst;` |
|      5431 |  268 | `		n = 0;` |
|   2536537 |  269 | `		for( ;; ){` |
|   5073079 |  270 | `			if( n >= pMap->nEntry ){` |
|      5431 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5067653 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5067653 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5067653 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4404287 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4404287 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2202141 |  280 | `			}` |
|   5067653 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5067653 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5067653 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5431 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2713 |  288 | `	}` |
|   3736197 |  289 | `	return SXRET_OK;` |
|   1912095 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3624382 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3624387 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3624345 |  310 | `		if( pValue ){` |
|   3624335 |  311 | `			sSafeVal = *pValue;` |
|   3624335 |  312 | `			pValue = &sSafeVal;` |
|   1812165 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3624345 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3624345 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3624345 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3624335 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1812165 |  322 | `		}` |
|   3624345 |  323 | `		nIdx = pObj->nIdx;` |
|   1812175 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3624387 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3624387 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3624387 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3624387 |  334 | `	if( isForeign ){` |
...
|   3624387 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3624387 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3624387 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3624387 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3624387 |  349 | `	return SXRET_OK;` |
|   1812196 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199799 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199804 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    153348 |  370 | `		if( pValue ){` |
|    153038 |  371 | `			sSafeVal = *pValue;` |
|    153038 |  372 | `			pValue = &sSafeVal;` |
|     76516 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    153348 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    153348 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    153348 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    153038 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76516 |  382 | `		}` |
|    153348 |  383 | `		nIdx = pObj->nIdx;` |
|     76676 |  384 | `	}else{` |
|     46461 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199804 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199804 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199804 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199804 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46461 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23228 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199804 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199804 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199804 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199804 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199804 |  409 | `	return SXRET_OK;` |
|     99904 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293083 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293088 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       857 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292236 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292236 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110568150 |  433 | `	for(;;){` |
| 221136265 |  434 | `		if( pNode == 0 ){` |
|   4284862 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851403 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848387 |  438 | `			&& pNode->nHash == nHash` |
| 108426396 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7379 |  441 | `				if( ppNode ){` |
|      7357 |  442 | `					*ppNode = pNode;` |
|      3676 |  443 | `				}` |
|      7379 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
...
|         - |  456 | ` */` |
|    344765 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    344770 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28656 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    316119 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    316119 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256541 |  475 | `	for(;;){` |
|    513087 |  476 | `		if( pNode == 0 ){` |
|    250461 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262626 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261113 |  480 | `			&& pNode->nHash == nHash` |
|    162681 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
...
|    196973 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250461 |  493 | `	return SXERR_NOTFOUND;` |
|    172387 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    345145 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    345150 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    345150 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    345150 |  504 | `	int isNeg = FALSE, nDigit;` |
|    345150 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    345140 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    345136 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    345136 |  516 | `	zDigit = zIn;` |
|    173204 |  517 | `	for(;;){` |
|    346414 |  518 | `		if( zIn >= zEnd ){` |
|       499 |  519 | `			break;` |
|         - |  520 | `		}` |
|    345916 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    344638 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|      1279 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    152568 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    152573 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    152573 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    145213 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    145213 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    145141 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    145141 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      7437 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        84 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        41 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      7437 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     76284 |  575 | `result:` |
|    152573 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72241 |  578 | `		if( ppNode ){` |
|     72187 |  579 | `			*ppNode = pNode;` |
|     36091 |  580 | `		}` |
|     72241 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80337 |  584 | `	return SXERR_NOTFOUND;` |
|     76289 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1477718 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1477723 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1477717 |  623 | `	return FALSE;` |
|    738864 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3773751 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3773756 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3773756 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3773756 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153474 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    153474 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       419 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229581 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76525 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152568 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152422 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152422 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1810141 |  683 | `IntKey:` |
|   3620705 |  684 | `	if( pKey ){` |
...
|   1071416 |  714 | `		}` |
|   1071421 |  715 | `	}else{` |
|   1477689 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1477687 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1477681 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1477681 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1477679 |  726 | `			++pMap->iNextIdx;` |
|    738837 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3620513 |  730 | `	return rc;` |
|   1886880 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46508 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46513 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46513 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46513 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46473 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46473 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69704 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23233 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46461 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46461 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1500847 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1500852 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1500852 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77585 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77590 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77590 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77590 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77590 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77590 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77590 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77590 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77590 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77590 |  921 | `	return rc;` |
|     38687 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16748 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16753 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16753 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11781 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5786 |  934 | `	}else{` |
|      4977 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16753 |  937 | `	if( pEntry->pNextCollide ){` |
|      1076 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       550 |  939 | `	}` |
|     16753 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16753 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16753 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16753 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16753 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16753 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12105 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5954 |  949 | `	}` |
|     16753 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16753 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16753 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16753 |  956 | `		pMap->iNextIdx++;` |
|      8374 |  957 | `	}` |
|     16753 |  958 | `}` |
|         - |  959 | `/*` |
...
|    156210 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156210 |  989 | `		if( pVal ){` |
...
|    156210 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156210 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156210 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156210 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156210 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156210 | 1001 | `			if( rc == 0 ){` |
...
|    123470 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123470 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    708962 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    708962 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    708964 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    708959 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    708959 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1277 | `		/* Blob key insertion */` |
|      4069 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4069 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4069 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4069 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2037 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    704895 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    701221 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    354287 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|        17 | 1290 | `		}else{ /* Dup */` |
|      3649 | 1291 | `			rc = HashmapInsertIntKey(pDest,pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|         - | 1292 | `		}` |
|         - | 1293 | `	}` |
|    708959 | 1294 | `	return rc;` |
|    354486 | 1295 | `}` |
|         - | 1296 | `/*` |
...
|    704183 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
...
|         - | 1392 | ` */` |
|      7348 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7353 | 1399 | `	if( pSrc == pDest ){` |
...
|      7353 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14995 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
...
|         - | 1498 | ` */` |
|    244124 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    244129 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    244129 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    244129 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    241291 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    142222 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    142227 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142227 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    142227 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    142227 | 1700 | `	pMap->pVm = &(*pVm);` |
|    142227 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    142227 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142227 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142227 | 1705 | `	return pMap;` |
|     71116 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1725 | `*    $_ENV` |
|         - | 1726 | `*/` |
|      3424 | 1727 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|         5 | 1728 | `{` |
...
|      3429 | 1747 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|      3429 | 1748 | `	if( pMap == 0 ){` |
|       ! 0 | 1749 | `		return SXERR_MEM;` |
|         - | 1750 | `	}` |
|      3429 | 1751 | `	pVm->pGlobal = pMap;` |
|         - | 1752 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|      3429 | 1753 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|      3429 | 1754 | `	if( pObj == 0 ){` |
|       ! 0 | 1755 | `		return SXERR_MEM;` |
|         - | 1756 | `	}` |
|      3429 | 1757 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|         - | 1758 | `	/* Record object index */` |
|      3429 | 1759 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|         - | 1760 | `	/* Install the special $GLOBALS array */` |
|      3429 | 1761 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|      3429 | 1762 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1763 | `		return rc;` |
|         - | 1764 | `	}` |
|         - | 1765 | `	/* Install superglobals now */` |
|     37669 | 1766 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|         - | 1767 | `		ph7_value *pSuper;` |
|         - | 1768 | `		/* Request an empty array */` |
|     34245 | 1769 | `		pSuper = ph7_new_array(&(*pVm));` |
|     34245 | 1770 | `		if( pSuper == 0 ){` |
|       ! 0 | 1771 | `			return SXERR_MEM;` |
|         - | 1772 | `		}` |
|         - | 1773 | `		/* Install */` |
|     34245 | 1774 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|     34245 | 1775 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1776 | `			return rc;` |
|         - | 1777 | `		}` |
|         - | 1778 | `		/* Release the value now it have been installed */` |
|     34245 | 1779 | `		ph7_release_value(&(*pVm),pSuper);` |
|     17125 | 1780 | `	}` |
|         - | 1781 | `	/* Set some $_SERVER entries */` |
|      3429 | 1782 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|         - | 1783 | `	/*` |
|         - | 1784 | `	 * 'SCRIPT_FILENAME'` |
|         - | 1785 | `	 * The absolute pathname of the currently executing script.` |
|         - | 1786 | `	 */` |
|      6853 | 1787 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|         - | 1788 | `		"SCRIPT_FILENAME",` |
|      1712 | 1789 | `		pFile ? pFile->zString : ":Memory:",` |
|      3424 | 1790 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|         - | 1791 | `		);` |
|         - | 1792 | `	/* All done,all super-global are installed now */` |
|      3429 | 1793 | `	return SXRET_OK;` |
|      1717 | 1794 | `}` |
|         - | 1795 | `/*` |
|         - | 1796 | ` * Release a hashmap.` |
|         - | 1797 | ` */` |
|     94126 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94131 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94131 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94131 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94131 | 1821 | `	n = 0;` |
|     94131 | 1822 | `	pEntry = pMap->pFirst;` |
|   1904442 | 1823 | `	for(;;){` |
|   3808890 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94131 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3714764 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3714764 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3714764 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3714704 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1857349 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3714764 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109698 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54846 | 1837 | `		}` |
|   3714764 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3714764 | 1840 | `		pEntry = pNext;` |
|   3714764 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94131 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68260 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34127 | 1846 | `	}` |
|     94131 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94105 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47055 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    875298 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    875303 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    875303 | 1869 | `	pMap->iRef--;` |
|    875303 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94085 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47040 | 1872 | `	}` |
|    875303 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152818 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3072205 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3072210 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3072210 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46498 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46503 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46503 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46503 | 1966 | `	return rc;` |
|     23254 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23860 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23865 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23865 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23865 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23865 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23684 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23689 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23689 | 1991 | `	while( *ppLink ){` |
|     23689 | 1992 | `		if( *ppLink == pStep ){` |
|     23689 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23689 | 1994 | `			pStep->pNextActive = 0;` |
|     23689 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    596698 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    596703 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    596703 | 2023 | `	if( pEntry ){` |
|    596703 | 2024 | `		if( bStore ){` |
|    217703 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    108854 | 2026 | `		}else{` |
|    379005 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    298133 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    165000 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    165005 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    158919 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    158919 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    158919 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79462 | 2045 | `	}else{` |
|      6091 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      6091 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      6091 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    165005 | 2050 | `}` |
...
|         - | 2158 | ` */` |
|      3416 | 2159 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 2160 | `{` |
|         - | 2161 | `	sxu32 n;` |
|    256205 | 2162 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    252789 | 2163 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    126397 | 2164 | `	}` |
|      3421 | 2165 | `}` |
|         - | 2166 | `/*` |
...
|         - | 2293 | ` */` |
|     34076 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34081 | 2305 | `	rc = SXRET_OK;` |
|     34081 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34081 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34081 | 2308 | `	n = pMap->nEntry;` |
|     34081 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    157585 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157585 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    157585 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    157585 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    157585 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    157585 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    157583 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157583 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     34079 | 2332 | `	return SXRET_OK;` |
|     17043 | 2333 | `}` |
|         - | 2334 |  |
