...
|  102278 |  846 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  102278 |  847 | `		if( pVal ){` |
|  102278 |  848 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  858 | `			}else{` |
|       - |  859 | `				/* Duplicate value */` |
|  102278 |  860 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  102278 |  861 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  102278 |  862 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  102278 |  863 | `				PH7_MemObjRelease(&sVal);` |
|  102278 |  864 | `				PH7_MemObjRelease(&sNeedle);` |
|  102278 |  865 | `				if( rc == 0 ){` |
|   21282 |  866 | `					if( ppNode ){` |
...
|   80998 |  875 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   80998 |  876 | `		n--;` |
|       2 |  877 | `	}` |
|       - |  878 | `	/* No such entry */` |
...
|   63131 | 1679 | `	while( pA && pB ){` |
|   38515 | 1680 | `		if( xCmp(pA,pB,pCmpData) < 0 ){` |
|   25388 | 1681 | `			pTail->pPrev = pA;` |
|   25388 | 1682 | `			pA->pNext = pTail;` |
|   25388 | 1683 | `			pTail = pA;` |
|   25388 | 1684 | `			pA = pA->pPrev;` |
|   12696 | 1685 | `		}else{` |
...
|       2 | 1691 | `	}` |
|   24618 | 1692 | `	if( pA ){` |
|   18203 | 1693 | `		pTail->pPrev = pA;` |
|   18203 | 1694 | `		pA->pNext = pTail;` |
|   15530 | 1695 | `	}else if( pB ){` |
|    6253 | 1696 | `		pTail->pPrev = pB;` |
|    6253 | 1697 | `		pB->pNext = pTail;` |
|    3115 | 1698 | `	}else{` |
