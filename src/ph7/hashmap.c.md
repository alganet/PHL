...
|       - |   17 | ` */` |
| 2964960 |   18 | `static sxu32 IntHash(sxi64 iKey)` |
|       2 |   19 |  |
| 2964962 |   20 | `	return (sxu32)(iKey ^ (iKey << 8) ^ (iKey >> 8));` |
|       2 |   21 |  |
|       - |   22 | `/*` |
|       - |   23 | ` * Default hash function for string/BLOB keys.` |
|       - |   24 | ` */` |
|  291676 |   25 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|       2 |   26 |  |
|  291678 |   27 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|       - |   28 | `	unsigned char *zEnd;` |
|  291678 |   29 | `	sxu32 nH = 5381;` |
|  291678 |   30 | `	zEnd = &zIn[nLen];` |
|  326268 |   31 | `	for(;;){` |
|  652538 |   32 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  574348 |   33 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  516078 |   34 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  425316 |   35 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|       2 |   36 | `	}` |
|  291678 |   37 | `	return nH;` |
|       2 |   38 |  |
|       - |   39 | `/*` |
...
|       - |   92 | ` */` |
| 2907148 |   93 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|       2 |   94 |  |
|       - |   95 | `	ph7_hashmap_node *pNode;` |
|       - |   96 | `	/* Allocate a new node */` |
| 2907150 |   97 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
| 2907150 |   98 | `	if( pNode == 0 ){` |
|     ! 0 |   99 | `		return 0;` |
|       - |  100 | `	}` |
|       - |  101 | `	/* Zero the stucture */` |
| 2907150 |  102 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  103 | `	/* Fill in the structure */` |
| 2907150 |  104 | `	pNode->pMap  = &(*pMap);` |
| 2907150 |  105 | `	pNode->iType = HASHMAP_INT_NODE;` |
| 2907150 |  106 | `	pNode->nHash = nHash;` |
| 2907150 |  107 | `	pNode->xKey.iKey = iKey;` |
| 2907150 |  108 | `	pNode->nValIdx  = nValIdx;` |
| 2907150 |  109 | `	return pNode;` |
| 1453576 |  110 |  |
|       - |  111 | `/*` |
...
|       - |  115 | ` */` |
|  101188 |  116 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|       2 |  117 |  |
|       - |  118 | `	ph7_hashmap_node *pNode;` |
|       - |  119 | `	/* Allocate a new node */` |
|  101190 |  120 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|  101190 |  121 | `	if( pNode == 0 ){` |
|     ! 0 |  122 | `		return 0;` |
|       - |  123 | `	}` |
|       - |  124 | `	/* Zero the stucture */` |
|  101190 |  125 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  126 | `	/* Fill in the structure */` |
|  101190 |  127 | `	pNode->pMap  = &(*pMap);` |
|  101190 |  128 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|  101190 |  129 | `	pNode->nHash = nHash;` |
|  101190 |  130 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|  101190 |  131 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|  101190 |  132 | `	pNode->nValIdx = nValIdx;` |
|  101190 |  133 | `	return pNode;` |
|   50596 |  134 |  |
|       - |  135 | `/*` |
|       - |  136 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|       - |  137 | ` */` |
| 3008336 |  138 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|       2 |  139 |  |
|       - |  140 | `	/* Link */` |
| 3008338 |  141 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
| 2730354 |  142 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
| 2730354 |  143 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
| 1365176 |  144 | `	}` |
| 3008338 |  145 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|       - |  146 | `	/* Link to the map list */` |
| 3008338 |  147 | `	if( pMap->pFirst == 0 ){` |
|   49094 |  148 | `		pMap->pFirst = pMap->pLast = pNode;` |
|       - |  149 | `		/* Point to the first inserted node */` |
|   49094 |  150 | `		pMap->pCur = pNode;` |
|   24548 |  151 | `	}else{` |
| 2959246 |  152 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|       - |  153 | `	}` |
| 3008338 |  154 | `	++pMap->nEntry;` |
| 3008338 |  155 |  |
|       - |  156 | `/*` |
|       - |  157 | ` * Unlink a node from the hashmap.` |
|       - |  158 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|       - |  159 | ` */` |
|    7372 |  160 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|       2 |  161 |  |
|    7374 |  162 | `	ph7_hashmap *pMap = pNode->pMap;` |
|    7374 |  163 | `	ph7_vm *pVm = pMap->pVm;` |
|       - |  164 | `	/* Unlink from the corresponding bucket */` |
|    7374 |  165 | `	if( pNode->pPrevCollide == 0 ){` |
|    6932 |  166 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|    3467 |  167 | `	}else{` |
|     443 |  168 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|       - |  169 | `	}` |
|    7374 |  170 | `	if( pNode->pNextCollide ){` |
|    5432 |  171 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|    2715 |  172 | `	}` |
|    7374 |  173 | `	if( pMap->pFirst == pNode ){` |
|      82 |  174 | `		pMap->pFirst = pNode->pPrev;` |
|      40 |  175 | `	}` |
|    7374 |  176 | `	if( pMap->pCur == pNode ){` |
|       - |  177 | `		/* Advance the node cursor */` |
|      84 |  178 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|      41 |  179 | `	}` |
|       - |  180 | `	/* Unlink from the map list */` |
|    7374 |  181 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|    7374 |  182 | `	if( bRestore ){` |
...
|      51 |  188 | `		}` |
|      51 |  189 | `	}` |
|    7374 |  190 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|    7248 |  191 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|    3623 |  192 | `	}` |
|    7374 |  193 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|    7374 |  194 | `	pMap->nEntry--;` |
|    7374 |  195 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|       - |  206 | ` */` |
| 3008336 |  207 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|       2 |  208 |  |
| 3008338 |  209 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|   53254 |  210 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|       - |  211 | `		ph7_hashmap_node *pEntry,**apNew;` |
|   53254 |  212 | `		sxu32 nNew = pMap->nSize << 1;` |
|       - |  213 | `		sxu32 nBucket;` |
|       - |  214 | `		sxu32 n;` |
|   53254 |  215 | `		if( nNew < 1 ){` |
|   49094 |  216 | `			nNew = 16;` |
...
|   53254 |  219 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|   53254 |  220 | `		if( apNew == 0 ){` |
...
|       - |  226 | `		}` |
|       - |  227 | `		/* Zero the table */` |
|   53254 |  228 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|       - |  229 | `		/* Reflect the change */` |
|   53254 |  230 | `		pMap->apBucket = apNew;` |
|   53254 |  231 | `		pMap->nSize = nNew;` |
|   53254 |  232 | `		if( apOld == 0 ){` |
|       - |  233 | `			/* First allocated table [i.e: no entry],return immediately */` |
|   49094 |  234 | `			return SXRET_OK;` |
|       - |  235 | `		}` |
...
| 3496492 |  248 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
| 3496492 |  249 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
| 1748245 |  250 | `			}` |
...
|    2080 |  258 | `	}` |
| 2959246 |  259 | `	return SXRET_OK;` |
| 1504170 |  260 |  |
|       - |  261 | `/*` |
|       - |  262 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|       - |  263 | ` * hashmap.` |
|       - |  264 | ` */` |
| 2907148 |  265 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  266 |  |
|       - |  267 | `	ph7_hashmap_node *pNode;` |
|       - |  268 | `	sxu32 nIdx;` |
|       - |  269 | `	sxu32 nHash;` |
|       - |  270 | `	sxi32 rc;` |
| 2907150 |  271 | `	if( !isForeign ){` |
|       - |  272 | `		ph7_value *pObj;` |
|       - |  273 | `		/* Reserve a ph7_value for the value */` |
| 2907124 |  274 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
| 2907124 |  275 | `		if( pObj == 0 ){` |
|     ! 0 |  276 | `			return SXERR_MEM;` |
|       - |  277 | `		}` |
| 2907124 |  278 | `		if( pValue ){` |
|       - |  279 | `			/* Duplicate the value */` |
| 2907124 |  280 | `			PH7_MemObjStore(pValue,pObj);` |
| 1453561 |  281 | `		}` |
| 2907124 |  282 | `		nIdx = pObj->nIdx;` |
| 1453563 |  283 | `	}else{` |
|      27 |  284 | `		nIdx = nRefIdx;` |
|       - |  285 | `	}` |
|       - |  286 | `	/* Hash the key */` |
| 2907150 |  287 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  288 | `	/* Allocate a new int node */` |
| 2907150 |  289 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
| 2907150 |  290 | `	if( pNode == 0 ){` |
|     ! 0 |  291 | `		return SXERR_MEM;` |
|       - |  292 | `	}` |
| 2907150 |  293 | `	if( isForeign ){` |
...
| 2907150 |  298 | `	rc = HashmapGrowBucket(&(*pMap));` |
| 2907150 |  299 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  300 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  301 | `		return rc;` |
|       - |  302 | `	}` |
|       - |  303 | `	/* Perform the insertion */` |
| 2907150 |  304 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  305 | `	/* Install in the reference table */` |
| 2907150 |  306 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  307 | `	/* All done */` |
| 2907150 |  308 | `	return SXRET_OK;` |
| 1453576 |  309 |  |
|       - |  310 | `/*` |
|       - |  311 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|       - |  312 | ` * hashmap.` |
|       - |  313 | ` */` |
|  101188 |  314 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  315 |  |
|       - |  316 | `	ph7_hashmap_node *pNode;` |
|       - |  317 | `	sxu32 nHash;` |
|       - |  318 | `	sxu32 nIdx;` |
|       - |  319 | `	sxi32 rc;` |
|  101190 |  320 | `	if( !isForeign ){` |
|       - |  321 | `		ph7_value *pObj;` |
|       - |  322 | `		/* Reserve a ph7_value for the value */` |
|   68272 |  323 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   68272 |  324 | `		if( pObj == 0 ){` |
|     ! 0 |  325 | `			return SXERR_MEM;` |
|       - |  326 | `		}` |
|   68272 |  327 | `		if( pValue ){` |
|       - |  328 | `			/* Duplicate the value */` |
|   68000 |  329 | `			PH7_MemObjStore(pValue,pObj);` |
|   33999 |  330 | `		}` |
|   68272 |  331 | `		nIdx = pObj->nIdx;` |
|   34137 |  332 | `	}else{` |
|   32920 |  333 | `		nIdx = nRefIdx;` |
|       - |  334 | `	}` |
|       - |  335 | `	/* Hash the key */` |
|  101190 |  336 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  337 | `	/* Allocate a new blob node */` |
|  101190 |  338 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|  101190 |  339 | `	if( pNode == 0 ){` |
|     ! 0 |  340 | `		return SXERR_MEM;` |
|       - |  341 | `	}` |
|  101190 |  342 | `	if( isForeign ){` |
|       - |  343 | `		/* Mark as a foregin entry */` |
|   32920 |  344 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|   16459 |  345 | `	}` |
|       - |  346 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|  101190 |  347 | `	rc = HashmapGrowBucket(&(*pMap));` |
|  101190 |  348 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  349 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  350 | `		return rc;` |
|       - |  351 | `	}` |
|       - |  352 | `	/* Perform the insertion */` |
|  101190 |  353 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  354 | `	/* Install in the reference table */` |
|  101190 |  355 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  356 | `	/* All done */` |
|  101190 |  357 | `	return SXRET_OK;` |
|   50596 |  358 |  |
|       - |  359 | `/*` |
...
|       - |  363 | ` */` |
|   47630 |  364 | `static sxi32 HashmapLookupIntKey(` |
...
|       - |  371 | `	sxu32 nHash;` |
|   47632 |  372 | `	if( pMap->nEntry < 1 ){` |
|       - |  373 | `		/* Don't bother hashing,there is no entry anyway */` |
|     432 |  374 | `		return SXERR_NOTFOUND;` |
|       - |  375 | `	}` |
|       - |  376 | `	/* Hash the key first */` |
|   47202 |  377 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  378 | `	/* Point to the appropriate bucket */` |
|   47202 |  379 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  380 | `	/* Perform the lookup */` |
|  411955 |  381 | `	for(;;){` |
|  823912 |  382 | `		if( pNode == 0 ){` |
|   45952 |  383 | `			break;` |
|       - |  384 | `		}` |
|  778585 |  385 | `		if( pNode->iType == HASHMAP_INT_NODE` |
|  774945 |  386 | `			&& pNode->nHash == nHash` |
|  386592 |  387 | `			&& pNode->xKey.iKey == iKey ){` |
|       - |  388 | `				/* Node found */` |
|    1252 |  389 | `				if( ppNode ){` |
|    1240 |  390 | `					*ppNode = pNode;` |
|     619 |  391 | `				}` |
|    1252 |  392 | `				return SXRET_OK;` |
|       - |  393 | `		}` |
...
|       - |  404 | ` */` |
|  202452 |  405 | `static sxi32 HashmapLookupBlobKey(` |
...
|       - |  413 | `	sxu32 nHash;` |
|  202454 |  414 | `	if( pMap->nEntry < 1 ){` |
|       - |  415 | `		/* Don't bother hashing,there is no entry anyway */` |
|   11966 |  416 | `		return SXERR_NOTFOUND;` |
|       - |  417 | `	}` |
|       - |  418 | `	/* Hash the key first */` |
|  190490 |  419 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  420 | `	/* Point to the appropriate bucket */` |
|  190490 |  421 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  422 | `	/* Perform the lookup */` |
|  175704 |  423 | `	for(;;){` |
|  351410 |  424 | `		if( pNode == 0 ){` |
|  145654 |  425 | `			break;` |
|       - |  426 | `		}` |
|  228174 |  427 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|  204257 |  428 | `			&& pNode->nHash == nHash` |
|  123797 |  429 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|   44838 |  430 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|       - |  431 | `				/* Node found */` |
|   44838 |  432 | `				if( ppNode ){` |
|   44810 |  433 | `					*ppNode = pNode;` |
|   22404 |  434 | `				}` |
|   44838 |  435 | `				return SXRET_OK;` |
|       - |  436 | `		}` |
|       - |  437 | `		/* Follow the collision link */` |
|  160922 |  438 | `		pNode = pNode->pNextCollide;` |
|       2 |  439 | `	}` |
|       - |  440 | `	/* No such entry */` |
|  145654 |  441 | `	return SXERR_NOTFOUND;` |
|  101228 |  442 |  |
|       - |  443 | `/*` |
|       - |  444 | ` * Check if the given BLOB key looks like a decimal number.` |
|       - |  445 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|       - |  446 | ` */` |
|  202594 |  447 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|       2 |  448 |  |
|  202596 |  449 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|  202596 |  450 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|  202596 |  451 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|       - |  452 | `		/* Octal not decimal number */` |
|       5 |  453 | `		return FALSE;` |
|       - |  454 | `	}` |
|  202592 |  455 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|     ! 0 |  456 | `		zIn++;` |
|     ! 0 |  457 | `	}` |
|  101628 |  458 | `	for(;;){` |
|  203258 |  459 | `		if( zIn >= zEnd ){` |
|     233 |  460 | `			return TRUE;` |
|       - |  461 | `		}` |
|  203026 |  462 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|  101181 |  463 | `			break;` |
|       - |  464 | `		}` |
|     667 |  465 | `		zIn++;` |
|       1 |  466 | `	}` |
|       - |  467 | `	/* Key does not look like a decimal number */` |
|  202360 |  468 | `	return FALSE;` |
|  101299 |  469 |  |
|       - |  470 | `/*` |
...
|       - |  474 | ` */` |
|  102346 |  475 | `static sxi32 HashmapLookup(` |
|       - |  476 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|       - |  477 | `	ph7_value *pKey,            /* Lookup key */` |
|       - |  478 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|       - |  479 | `	)` |
|       2 |  480 |  |
|  102348 |  481 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|       - |  482 | `	sxi32 rc;` |
|  102348 |  483 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|  101228 |  484 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  485 | `			/* Force a string cast */` |
|     ! 0 |  486 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  487 | `		}` |
|  101228 |  488 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|       - |  489 | `			/* Perform a blob lookup */` |
|  101212 |  490 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|  101212 |  491 | `			goto result;` |
|       - |  492 | `		}` |
|       8 |  493 | `	}` |
|       - |  494 | `	/* Perform an int lookup */` |
|    1138 |  495 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|       - |  496 | `		/* Force an integer cast */` |
|      27 |  497 | `		PH7_MemObjToInteger(pKey);` |
|      13 |  498 | `	}` |
|       - |  499 | `	/* Perform an int lookup */` |
|    1138 |  500 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|   51173 |  501 | `result:` |
|  102348 |  502 | `	if( rc == SXRET_OK ){` |
|       - |  503 | `		/* Node found */` |
|   45850 |  504 | `		if( ppNode ){` |
|   45816 |  505 | `			*ppNode = pNode;` |
|   22907 |  506 | `		}` |
|   45850 |  507 | `		return SXRET_OK;` |
|       - |  508 | `	}` |
|       - |  509 | `	/* No such entry */` |
|   56500 |  510 | `	return SXERR_NOTFOUND;` |
|   51175 |  511 |  |
|       - |  512 | `/*` |
...
|       - |  517 | ` */` |
| 2975092 |  518 | `static sxi32 HashmapInsert(` |
|       - |  519 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|       - |  520 | `	ph7_value *pKey,   /* Lookup key  */` |
|       - |  521 | `	ph7_value *pVal    /* Node value */` |
|       - |  522 | `	)` |
|       2 |  523 |  |
| 2975094 |  524 | `	ph7_hashmap_node *pNode = 0;` |
| 2975094 |  525 | `	sxi32 rc = SXRET_OK;` |
| 2975094 |  526 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   68484 |  527 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  528 | `			/* Force a string cast */` |
|       3 |  529 | `			PH7_MemObjToString(&(*pKey));` |
|       1 |  530 | `		}` |
|   68484 |  531 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     256 |  536 | `			goto IntKey;` |
|       - |  537 | `		}` |
|  102344 |  538 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   34114 |  539 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|       - |  552 | `		}` |
|   68176 |  553 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  554 | `			/* Forbidden */` |
...
|   68174 |  559 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|   68174 |  560 | `		return rc;` |
|       - |  561 | `	}` |
| 1453305 |  562 | `IntKey:` |
| 2906866 |  563 | `	if( pKey ){` |
...
|   11644 |  598 | `		}` |
|   11646 |  599 | `	}else{` |
| 2883496 |  600 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  601 | `			/* Forbidden */` |
...
| 2883494 |  606 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
| 2883494 |  607 | `		if( rc == SXRET_OK ){` |
| 2883494 |  608 | `			++pMap->iNextIdx;` |
| 1441746 |  609 | `		}` |
|       - |  610 | `	}` |
|       - |  611 | `	/* Insertion result */` |
| 2906782 |  612 | `	return rc;` |
| 1487548 |  613 |  |
|       - |  614 | `/*` |
...
|       - |  640 | ` */` |
|   32950 |  641 | `static sxi32 HashmapInsertByRef(` |
|       - |  642 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|       - |  643 | `	ph7_value *pKey,     /* Lookup key */` |
|       - |  644 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|       - |  645 | `	)` |
|       2 |  646 |  |
|   32952 |  647 | `	ph7_hashmap_node *pNode = 0;` |
|   32952 |  648 | `	sxi32 rc = SXRET_OK;` |
|   32952 |  649 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   32926 |  650 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  651 | `			/* Force a string cast */` |
|     ! 0 |  652 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  653 | `		}` |
|   32926 |  654 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     ! 0 |  659 | `			goto IntKey;` |
|       - |  660 | `		}` |
|   49388 |  661 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   16462 |  662 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|       - |  663 | `				/* Overwrite */` |
...
|   32920 |  671 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|   32920 |  672 | `		return rc;` |
|       - |  673 | `	}` |
|      13 |  674 | `IntKey:` |
|      27 |  675 | `	if( pKey ){` |
...
|       - |  712 | ` */` |
| 1100231 |  713 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       2 |  714 |  |
|       - |  715 | `	/* Point to the desired object */` |
|       - |  716 | `	ph7_value *pObj;` |
| 1100233 |  717 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
| 1100233 |  718 | `	return pObj;` |
|       2 |  719 |  |
|       - |  720 | `/*` |
...
|       - |  762 | ` * documenation.` |
|       - |  763 | ` */` |
|   51007 |  764 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       2 |  765 |  |
|       - |  766 | `	ph7_value sObj1,sObj2;` |
|       - |  767 | `	sxi32 rc;` |
|   51009 |  768 | `	if( pLeft == pRight ){` |
|       - |  769 | `		/*` |
...
|   51009 |  776 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   51009 |  777 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   51009 |  778 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   51009 |  779 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   51009 |  780 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   51009 |  781 | `	PH7_MemObjRelease(&sObj1);` |
|   51009 |  782 | `	PH7_MemObjRelease(&sObj2);` |
|   51009 |  783 | `	return rc;` |
|   25515 |  784 |  |
|       - |  785 | `/*` |
...
|       - |  788 | ` */` |
|   10612 |  789 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|       2 |  790 |  |
|   10614 |  791 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|       - |  792 | `	sxu32 nBucket;` |
|       - |  793 | `	/* Remove old collision links */` |
|   10614 |  794 | `	if( pEntry->pPrevCollide ){` |
|    8629 |  795 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|    4329 |  796 | `	}else{` |
|    1987 |  797 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|       - |  798 | `	}` |
|   10614 |  799 | `	if( pEntry->pNextCollide ){` |
|     991 |  800 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|     493 |  801 | `	}` |
|   10614 |  802 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  803 | `	/* Compute the new hash */` |
|   10614 |  804 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|   10614 |  805 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|   10614 |  806 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|       - |  807 | `	/* Link to the new bucket */` |
|   10614 |  808 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   10614 |  809 | `	if( pMap->apBucket[nBucket] ){` |
|    8856 |  810 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|    4445 |  811 | `	}` |
|   10614 |  812 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   10614 |  813 | `	pMap->apBucket[nBucket] = pEntry;` |
|       - |  814 | `	/* Increment the automatic index */` |
|   10614 |  815 | `	pMap->iNextIdx++;` |
|   10614 |  816 |  |
|       - |  817 | `/*` |
...
|       - |  823 | ` */` |
|   26674 |  824 | `static int HashmapFindValue(` |
...
|   26676 |  837 | `	pEntry = pMap->pFirst;` |
|   26676 |  838 | `	n = pMap->nEntry;` |
|   26676 |  839 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|   26676 |  840 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|   64000 |  841 | `	for(;;){` |
|  128003 |  842 | `		if( n < 1 ){` |
|      99 |  843 | `			break;` |
|       - |  844 | `		}` |
|       - |  845 | `		/* Extract node value */` |
|  127905 |  846 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  127905 |  847 | `		if( pVal ){` |
|  127905 |  848 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  858 | `			}else{` |
|       - |  859 | `				/* Duplicate value */` |
|  127905 |  860 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  127905 |  861 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  127905 |  862 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  127905 |  863 | `				PH7_MemObjRelease(&sVal);` |
|  127905 |  864 | `				PH7_MemObjRelease(&sNeedle);` |
|  127905 |  865 | `				if( rc == 0 ){` |
|   26578 |  866 | `					if( ppNode ){` |
|      23 |  867 | `						*ppNode = pEntry;` |
|      11 |  868 | `					}` |
|       - |  869 | `					/* Match found*/` |
|   26578 |  870 | `					return SXRET_OK;` |
|       - |  871 | `				}` |
|       - |  872 | `			}` |
|   50663 |  873 | `		}` |
|       - |  874 | `		/* Point to the next entry */` |
|  101329 |  875 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  101329 |  876 | `		n--;` |
|       2 |  877 | `	}` |
|       - |  878 | `	/* No such entry */` |
...
|       - | 1053 | ` */` |
|  522676 | 1054 | `static sxi32 HashmapDuplicateNode(` |
...
|       - | 1059 | `	)` |
|       2 | 1060 |  |
|  522678 | 1061 | `	ph7_value sSafeVal = *pVal;` |
|       - | 1062 | `	ph7_value sKey;` |
|       - | 1063 | `	sxi32 rc;` |
|       - | 1064 |  |
|  522678 | 1065 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      30 | 1071 | `	}else{` |
|       - | 1072 | `		/* Int key */` |
|  522620 | 1073 | `		if( iAction == 0 ){ /* Merge */` |
|  522402 | 1074 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|  261420 | 1075 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|  524282 | 1112 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|       - | 1113 | `		/* Extract the node value */` |
|  522418 | 1114 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  522418 | 1115 | `		if( pVal ){` |
...
|       - | 1120 | `			 */` |
|  522418 | 1121 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|  261210 | 1122 | `		}else{` |
|     ! 0 | 1123 | `			rc = SXRET_OK;` |
|       - | 1124 | `		}` |
|  522418 | 1125 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1126 | `			return rc;` |
|       - | 1127 | `		}` |
|       - | 1128 | `		/* Point to the next entry */` |
|  522418 | 1129 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  261210 | 1130 | `	}` |
...
|       - | 1218 | ` */` |
|  180674 | 1219 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|       2 | 1220 |  |
|  180676 | 1221 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - | 1222 | `	ph7_hashmap *pNew;` |
|       - | 1223 | `	ph7_value *pBacking;` |
|  180676 | 1224 | `	if( pMap->iRef < 2 ){` |
|       - | 1225 | `		/* Sole owner, no separation needed */` |
|  178640 | 1226 | `		return pMap;` |
|       - | 1227 | `	}` |
...
|       - | 1372 | ` */` |
|   77496 | 1373 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|   77498 | 1381 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|   77498 | 1382 | `	if( pMap == 0 ){` |
|     ! 0 | 1383 | `		return 0;` |
|       - | 1384 | `	}` |
|       - | 1385 | `	/* Zero the structure */` |
|   77498 | 1386 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|       - | 1387 | `	/* Fill in the structure */` |
|   77498 | 1388 | `	pMap->pVm = &(*pVm);` |
|   77498 | 1389 | `	pMap->iRef = 1;` |
|       - | 1390 | `	/* Default hash functions */` |
|   77498 | 1391 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|   77498 | 1392 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|   77498 | 1393 | `	return pMap;` |
|   38750 | 1394 |  |
|       - | 1395 | `/*` |
...
|       - | 1413 | `*    $_ENV` |
|       - | 1414 | `*/` |
|    2554 | 1415 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|       2 | 1416 |  |
...
|    2556 | 1435 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    2556 | 1436 | `	if( pMap == 0 ){` |
|     ! 0 | 1437 | `		return SXERR_MEM;` |
|       - | 1438 | `	}` |
|    2556 | 1439 | `	pVm->pGlobal = pMap;` |
|       - | 1440 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|    2556 | 1441 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|    2556 | 1442 | `	if( pObj == 0 ){` |
|     ! 0 | 1443 | `		return SXERR_MEM;` |
|       - | 1444 | `	}` |
|    2556 | 1445 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|       - | 1446 | `	/* Record object index */` |
|    2556 | 1447 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|       - | 1448 | `	/* Install the special $GLOBALS array */` |
|    2556 | 1449 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|    2556 | 1450 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 1451 | `		return rc;` |
|       - | 1452 | `	}` |
|       - | 1453 | `	/* Install superglobals now */` |
|   28096 | 1454 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|       - | 1455 | `		ph7_value *pSuper;` |
|       - | 1456 | `		/* Request an empty array */` |
|   25542 | 1457 | `		pSuper = ph7_new_array(&(*pVm));` |
|   25542 | 1458 | `		if( pSuper == 0 ){` |
|     ! 0 | 1459 | `			return SXERR_MEM;` |
|       - | 1460 | `		}` |
|       - | 1461 | `		/* Install */` |
|   25542 | 1462 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|   25542 | 1463 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1464 | `			return rc;` |
|       - | 1465 | `		}` |
|       - | 1466 | `		/* Release the value now it have been installed */` |
|   25542 | 1467 | `		ph7_release_value(&(*pVm),pSuper);` |
|   12772 | 1468 | `	}` |
|       - | 1469 | `	/* Set some $_SERVER entries */` |
|    2556 | 1470 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       - | 1471 | `	/*` |
|       - | 1472 | `	 * 'SCRIPT_FILENAME'` |
|       - | 1473 | `	 * The absolute pathname of the currently executing script.` |
|       - | 1474 | `	 */` |
|    5106 | 1475 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|       - | 1476 | `		"SCRIPT_FILENAME",` |
|    1277 | 1477 | `		pFile ? pFile->zString : ":Memory:",` |
|    2550 | 1478 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|       - | 1479 | `		);` |
|       - | 1480 | `	/* All done,all super-global are installed now */` |
|    2556 | 1481 | `	return SXRET_OK;` |
|    1279 | 1482 |  |
|       - | 1483 | `/*` |
|       - | 1484 | ` * Release a hashmap.` |
|       - | 1485 | ` */` |
|   49242 | 1486 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|       2 | 1487 |  |
|       - | 1488 | `	ph7_hashmap_node *pEntry,*pNext;` |
|   49244 | 1489 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1490 | `	sxu32 n;` |
|   49244 | 1491 | `	if( pMap == pVm->pGlobal ){` |
...
|   49244 | 1497 | `	n = 0;` |
|   49244 | 1498 | `	pEntry = pMap->pFirst;` |
| 1507682 | 1499 | `	for(;;){` |
| 3015366 | 1500 | `		if( n >= pMap->nEntry ){` |
|   49244 | 1501 | `			break;` |
|       - | 1502 | `		}` |
| 2966124 | 1503 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|       - | 1504 | `		/* Remove the reference from the foreign table */` |
| 2966124 | 1505 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
| 2966124 | 1506 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|       - | 1507 | `			/* Restore the ph7_value to the free list */` |
| 2966116 | 1508 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
| 1483057 | 1509 | `		}` |
|       - | 1510 | `		/* Release the node */` |
| 2966124 | 1511 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|   64480 | 1512 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|   32239 | 1513 | `		}` |
| 2966124 | 1514 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|       - | 1515 | `		/* Point to the next entry */` |
| 2966124 | 1516 | `		pEntry = pNext;` |
| 2966124 | 1517 | `		n++;` |
|       2 | 1518 | `	}` |
|   49244 | 1519 | `	if( pMap->nEntry > 0 ){` |
|       - | 1520 | `		/* Release the hash bucket */` |
|   43768 | 1521 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|   21883 | 1522 | `	}` |
|   49244 | 1523 | `	if( FreeDS ){` |
|       - | 1524 | `		/* Free the whole instance */` |
|   49228 | 1525 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|   24615 | 1526 | `	}else{` |
...
|       - | 1539 | ` */` |
|  550486 | 1540 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|       2 | 1541 |  |
|  550488 | 1542 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1543 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|  550488 | 1544 | `	pMap->iRef--;` |
|  550488 | 1545 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|   49228 | 1546 | `		PH7_HashmapRelease(pMap,TRUE);` |
|   24613 | 1547 | `	}` |
|  550488 | 1548 |  |
|       - | 1549 | `/*` |
...
|       - | 1553 | ` */` |
|  102376 | 1554 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|       - | 1574 | ` */` |
| 2452480 | 1575 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|       2 | 1580 |  |
|       - | 1581 | `	sxi32 rc;` |
| 2452482 | 1582 | `	if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP) && (ph7_hashmap *)pVal->x.pOther == pMap->pVm->pGlobal ){` |
|       - | 1583 | `		/*` |
...
|       - | 1588 | `	}` |
| 2452482 | 1589 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
| 2452482 | 1590 | `	return rc;` |
| 1226242 | 1591 |  |
|       - | 1592 | `/*` |
...
|       - | 1618 | ` */` |
|   32950 | 1619 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|       2 | 1624 |  |
|       - | 1625 | `	sxi32 rc;` |
|   32952 | 1626 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
|       - | 1627 | `		/*` |
...
|       - | 1632 | `	}` |
|   32952 | 1633 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|   32952 | 1634 | `	return rc;` |
|   16477 | 1635 |  |
|       - | 1636 | `/*` |
|       - | 1637 | ` * Reset the node cursor of a given hashmap.` |
|       - | 1638 | ` */` |
|   22110 | 1639 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|       2 | 1640 |  |
|       - | 1641 | `	/* Reset the loop cursor */` |
|   22112 | 1642 | `	pMap->pCur = pMap->pFirst;` |
|   22112 | 1643 |  |
|       - | 1644 | `/*` |
...
|       - | 1649 | ` */` |
|  180768 | 1650 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|       2 | 1651 |  |
|  180770 | 1652 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|  180770 | 1653 | `	if( pCur == 0 ){` |
|       - | 1654 | `		/* End of the list,return null */` |
|   11076 | 1655 | `		return 0;` |
|       - | 1656 | `	}` |
|       - | 1657 | `	/* Advance the node cursor */` |
|  169696 | 1658 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|  169696 | 1659 | `	return pCur;` |
|   90386 | 1660 |  |
|       - | 1661 | `/*` |
|       - | 1662 | ` * Extract a node value.` |
|       - | 1663 | ` */` |
|  425812 | 1664 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       2 | 1665 |  |
|  425814 | 1666 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  425814 | 1667 | `	if( pEntry ){` |
|  425814 | 1668 | `		if( bStore ){` |
|  169830 | 1669 | `			PH7_MemObjStore(pEntry,pValue);` |
|   84916 | 1670 | `		}else{` |
|  255986 | 1671 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1672 | `		}` |
|  212927 | 1673 | `	}else{` |
...
|       - | 1679 | ` */` |
|  108532 | 1680 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|       2 | 1681 |  |
|       - | 1682 | `	/* Fill with the current key */` |
|  108534 | 1683 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|  108244 | 1684 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|      17 | 1685 | `			SyBlobRelease(&pKey->sBlob);` |
|       8 | 1686 | `		}` |
|  108244 | 1687 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|  108244 | 1688 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|   54123 | 1689 | `	}else{` |
...
|       - | 1740 | `**   changed.` |
|       - | 1741 | `*/` |
|   29288 | 1742 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|       2 | 1743 |  |
|       - | 1744 | `	ph7_hashmap_node result,*pTail;` |
|       - | 1745 | `    /* Prevent compiler warning */` |
|   29290 | 1746 | `	result.pNext = result.pPrev = 0;` |
|   29290 | 1747 | `	pTail = &result;` |
|   80376 | 1748 | `	while( pA && pB ){` |
|   51088 | 1749 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|   33165 | 1750 | `			pTail->pPrev = pA;` |
|   33165 | 1751 | `			pA->pNext = pTail;` |
|   33165 | 1752 | `			pTail = pA;` |
|   33165 | 1753 | `			pA = pA->pPrev;` |
|   16561 | 1754 | `		}else{` |
|   17925 | 1755 | `			pTail->pPrev = pB;` |
|   17925 | 1756 | `			pB->pNext = pTail;` |
|   17925 | 1757 | `			pTail = pB;` |
|   17925 | 1758 | `			pB = pB->pPrev;` |
|       - | 1759 | `		}` |
|       2 | 1760 | `	}` |
|   29290 | 1761 | `	if( pA ){` |
|   21171 | 1762 | `		pTail->pPrev = pA;` |
|   21171 | 1763 | `		pA->pNext = pTail;` |
|   18717 | 1764 | `	}else if( pB ){` |
|    7919 | 1765 | `		pTail->pPrev = pB;` |
|    7919 | 1766 | `		pB->pNext = pTail;` |
|    3949 | 1767 | `	}else{` |
|     204 | 1768 | `		pTail->pPrev = pTail->pNext = 0;` |
|       - | 1769 | `	}` |
|   29290 | 1770 | `	return result.pPrev;` |
|       2 | 1771 |  |
|       - | 1772 | `/*` |
|       - | 1773 | `** Inputs:` |
...
|   11364 | 1791 | `	while( pIn ){` |
|   10730 | 1792 | `		p = pIn;` |
|   10730 | 1793 | `		pIn = p->pPrev;` |
|   10730 | 1794 | `		p->pPrev = 0;` |
|   20364 | 1795 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|   20364 | 1796 | `			if( a[i]==0 ){` |
|   10730 | 1797 | `				a[i] = p;` |
|   10730 | 1798 | `				break;` |
|     ! 0 | 1799 | `			}else{` |
|    9636 | 1800 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|    9636 | 1801 | `				a[i] = 0;` |
|       - | 1802 | `			}` |
|    4819 | 1803 | `		}` |
|   10730 | 1804 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       - | 1825 | ` */` |
|   50959 | 1826 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       2 | 1827 |  |
|       - | 1828 | `	ph7_value sA,sB;` |
|       - | 1829 | `	sxi32 iFlags;` |
|       - | 1830 | `	int rc;` |
|   50961 | 1831 | `	if( pCmpData == 0 ){` |
|       - | 1832 | `		/* Perform a standard comparison */` |
|   50937 | 1833 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   50937 | 1834 | `		return rc;` |
|       - | 1835 | `	}` |
...
|       2 | 2124 | `		}` |
|   10560 | 2125 | `		HashmapRehashIntNode(p);` |
|       - | 2126 | `		/* Point to the next entry */` |
|   10560 | 2127 | `		i++;` |
|   10560 | 2128 | `		pLast = p;` |
|   10560 | 2129 | `		p = p->pPrev; /* Reverse link */` |
|       2 | 2130 | `	}` |
|     588 | 2131 |  |
|       - | 2132 | `/*` |
...
|       - | 3913 | ` */` |
|   26482 | 3914 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 3915 |  |
|       - | 3916 | `	ph7_value *pNeedle;` |
|       - | 3917 | `	int bStrict;` |
|       - | 3918 | `	int rc;` |
|   26484 | 3919 | `	if( nArg < 2 ){` |
|       - | 3920 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 3921 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 3922 | `		return PH7_OK;` |
|       - | 3923 | `	}` |
|   26484 | 3924 | `	pNeedle = apArg[0];` |
|   26484 | 3925 | `	bStrict = 0;` |
|   26484 | 3926 | `	if( nArg > 2 ){` |
|       5 | 3927 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|       2 | 3928 | `	}` |
|   26484 | 3929 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   26484 | 3937 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 3938 | `	/* Lookup result */` |
|   26484 | 3939 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   26484 | 3940 | `	return PH7_OK;` |
|   13243 | 3941 |  |
|       - | 3942 | `/*` |
...
|       - | 6865 | ` */` |
|    2554 | 6866 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|       2 | 6867 |  |
|       - | 6868 | `	sxu32 n;` |
|  158350 | 6869 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|  155796 | 6870 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|   77899 | 6871 | `	}` |
|    2556 | 6872 |  |
|       - | 6873 | `/*` |
...
|       - | 6961 | ` */` |
|   26784 | 6962 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|   26786 | 6973 | `	rc = SXRET_OK;` |
|   26786 | 6974 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|   26786 | 6975 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|   26786 | 6976 | `	n = pMap->nEntry;` |
|   26786 | 6977 | `	pEntry = pMap->pFirst;` |
...
|  107988 | 6984 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|  107988 | 6985 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|       - | 6986 | `		/* Invoke the user callback */` |
|  107988 | 6987 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|       - | 6988 | `		/* Release the copy of the key and the value */` |
|  107988 | 6989 | `		PH7_MemObjRelease(&sKey);` |
|  107988 | 6990 | `		PH7_MemObjRelease(&sValue);` |
|  107988 | 6991 | `		if( rc != PH7_OK ){` |
|       - | 6992 | `			/* Callback request an operation abort */` |
|     ! 0 | 6993 | `			return SXERR_ABORT;` |
|       - | 6994 | `		}` |
|       - | 6995 | `		/* Point to the next entry */` |
|  107988 | 6996 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  107988 | 6997 | `		n--;` |
|       2 | 6998 | `	}` |
|       - | 6999 | `	/* All done */` |
|   26786 | 7000 | `	return SXRET_OK;` |
|   13394 | 7001 |  |
|       - | 7002 |  |
