...
|         - |   22 | ` */` |
|   7934212 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7934217 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7934217 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    515121 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    515126 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    515126 |   35 | `	sxu32 nH = 5381;` |
|    515126 |   36 | `	zEnd = &zIn[nLen];` |
|    592243 |   37 | `	for(;;){` |
|   1184492 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1011376 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    910059 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    787465 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    515126 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   51 | ` */` |
|      2310 |   52 | `PH7_PRIVATE sxi64 HashmapCount(ph7_hashmap *pMap,int bRecursive,int *pCycleDetected)` |
|         5 |   53 | `{` |
|      2315 |   54 | `	sxi64 iCount = 0;` |
|      2315 |   55 | `	if( !bRecursive ){` |
|      2151 |   56 | `		iCount = pMap->nEntry;` |
|      1078 |   57 | `	}else{` |
|         - |   58 | `		/* Recursive hashmap walk */` |
|       165 |   59 | `		ph7_hashmap_node *pEntry = pMap->pLast;` |
|         - |   60 | `		ph7_value *pElem;` |
|       165 |   61 | `		sxu32 n = 0;` |
|         - |   62 | `		/* Mark this map as being counted */` |
|       165 |   63 | `		pMap->iFlags \|= HASHMAP_COUNTING;` |
|       198 |   64 | `		for(;;){` |
|       397 |   65 | `			if( n >= pMap->nEntry ){` |
|       165 |   66 | `				break;` |
|         - |   67 | `			}` |
|         - |   68 | `			/* Point to the element value */` |
|       233 |   69 | `			pElem = (ph7_value *)SySetAt(&pMap->pVm->aMemObj,pEntry->nValIdx);` |
|       233 |   70 | `			if( pElem ){` |
|       233 |   71 | `				if( pElem->iFlags & MEMOBJ_HASHMAP ){` |
|       143 |   72 | `					ph7_hashmap *pSub = (ph7_hashmap *)pElem->x.pOther;` |
|       143 |   73 | `					if( pSub->iFlags & HASHMAP_COUNTING ){` |
|         - |   74 | `						/* Cycle detected — skip this entry */` |
|         3 |   75 | `						if( pCycleDetected ){` |
|         3 |   76 | `							*pCycleDetected = TRUE;` |
|         1 |   77 | `						}` |
|         2 |   78 | `					}else{` |
|       141 |   79 | `						iCount += HashmapCount(pSub,TRUE,pCycleDetected);` |
|         - |   80 | `					}` |
|        71 |   81 | `				}` |
|       116 |   82 | `			}` |
|         - |   83 | `			/* Point to the next entry */` |
|       233 |   84 | `			pEntry = pEntry->pNext;` |
|       233 |   85 | `			++n;` |
|         1 |   86 | `		}` |
|         - |   87 | `		/* Clear the counting flag */` |
|       165 |   88 | `		pMap->iFlags &= ~HASHMAP_COUNTING;` |
|         - |   89 | `		/* Update count */` |
|       165 |   90 | `		iCount += pMap->nEntry;` |
|         - |   91 | `	}` |
|      2315 |   92 | `	return iCount;` |
|         5 |   93 | `}` |
|         - |   94 | `/*` |
...
|         - |   98 | ` */` |
|   3625282 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3625287 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3625287 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3625287 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3625287 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3625287 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3625287 |  112 | `	pNode->nHash = nHash;` |
|   3625287 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3625287 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3625287 |  115 | `	return pNode;` |
|   1812646 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199417 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199422 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199422 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199422 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199422 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199422 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199422 |  135 | `	pNode->nHash = nHash;` |
|    199422 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199422 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199422 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199422 |  139 | `	return pNode;` |
|     99713 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3824699 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3824704 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3370818 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3370818 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1685412 |  150 | `	}` |
|   3824704 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3824704 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87786 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87786 |  156 | `		pMap->pCur = pNode;` |
|     43895 |  157 | `	}else{` |
|   3736923 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3824704 |  160 | `	if( pMap->pActiveSteps ){` |
...
|        11 |  172 | `		}` |
|         9 |  173 | `	}` |
|   3824704 |  174 | `	++pMap->nEntry;` |
|   3824704 |  175 | `}` |
|         - |  176 | `/*` |
|         - |  177 | ` * Unlink a node from the hashmap.` |
|         - |  178 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  179 | ` */` |
|      7392 |  180 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  181 | `{` |
|      7397 |  182 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7397 |  183 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  184 | `	/* Unlink from the corresponding bucket */` |
|      7397 |  185 | `	if( pNode->pPrevCollide == 0 ){` |
|      6909 |  186 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|      3457 |  187 | `	}else{` |
|       490 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7397 |  190 | `	if( pNode->pNextCollide ){` |
|      4845 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2421 |  192 | `	}` |
|      7397 |  193 | `	if( pMap->pFirst == pNode ){` |
|       173 |  194 | `		pMap->pFirst = pNode->pPrev;` |
|        84 |  195 | `	}` |
|      7397 |  196 | `	if( pMap->pCur == pNode ){` |
|         - |  197 | `		/* Advance the node cursor */` |
|       209 |  198 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|       102 |  199 | `	}` |
|      7397 |  200 | `	if( pMap->pActiveSteps ){` |
...
|      7397 |  211 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|      7397 |  212 | `	if( bRestore ){` |
...
|       105 |  218 | `		}` |
|       105 |  219 | `	}` |
|      7397 |  220 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7152 |  221 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3574 |  222 | `	}` |
|      7397 |  223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7397 |  224 | `	pMap->nEntry--;` |
|      7397 |  225 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|         - |  236 | ` */` |
|   3824699 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3824704 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93220 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93220 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93220 |  245 | `		if( nNew < 1 ){` |
|     87786 |  246 | `			nNew = 16;` |
...
|     93220 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93220 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93220 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93220 |  260 | `		pMap->apBucket = apNew;` |
|     93220 |  261 | `		pMap->nSize = nNew;` |
|     93220 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87786 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5439 |  267 | `		pEntry = pMap->pFirst;` |
|      5439 |  268 | `		n = 0;` |
|   2537981 |  269 | `		for( ;; ){` |
|   5075967 |  270 | `			if( n >= pMap->nEntry ){` |
|      5439 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5070533 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5070533 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5070533 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4405757 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4405757 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2202876 |  280 | `			}` |
|   5070533 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5070533 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5070533 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5439 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2717 |  288 | `	}` |
|   3736923 |  289 | `	return SXRET_OK;` |
|   1912354 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3625282 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3625287 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3625245 |  310 | `		if( pValue ){` |
|   3625235 |  311 | `			sSafeVal = *pValue;` |
|   3625235 |  312 | `			pValue = &sSafeVal;` |
|   1812615 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3625245 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3625245 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3625245 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3625235 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1812615 |  322 | `		}` |
|   3625245 |  323 | `		nIdx = pObj->nIdx;` |
|   1812625 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3625287 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3625287 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3625287 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3625287 |  334 | `	if( isForeign ){` |
...
|   3625287 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3625287 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3625287 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3625287 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3625287 |  349 | `	return SXRET_OK;` |
|   1812646 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199417 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199422 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    153084 |  370 | `		if( pValue ){` |
|    152774 |  371 | `			sSafeVal = *pValue;` |
|    152774 |  372 | `			pValue = &sSafeVal;` |
|     76384 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    153084 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    153084 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    153084 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152774 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76384 |  382 | `		}` |
|    153084 |  383 | `		nIdx = pObj->nIdx;` |
|     76544 |  384 | `	}else{` |
|     46343 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199422 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199422 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199422 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199422 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46343 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23169 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199422 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199422 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199422 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199422 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199422 |  409 | `	return SXRET_OK;` |
|     99713 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293042 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293047 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       855 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292197 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292197 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110568152 |  433 | `	for(;;){` |
| 221136232 |  434 | `		if( pNode == 0 ){` |
|   4284855 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851377 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848361 |  438 | `			&& pNode->nHash == nHash` |
| 108426381 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7347 |  441 | `				if( ppNode ){` |
|      7325 |  442 | `					*ppNode = pNode;` |
|      3660 |  443 | `				}` |
|      7347 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
|         - |  446 | `		/* Follow the collision link */` |
| 216844037 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284855 |  450 | `	return SXERR_NOTFOUND;` |
|   2146532 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    344249 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    344254 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28550 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315709 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315709 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256295 |  475 | `	for(;;){` |
|    512595 |  476 | `		if( pNode == 0 ){` |
|    250057 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262538 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261025 |  480 | `			&& pNode->nHash == nHash` |
|    162634 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65761 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65657 |  484 | `				if( ppNode ){` |
|     65629 |  485 | `					*ppNode = pNode;` |
|     32812 |  486 | `				}` |
|     65657 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196891 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250057 |  493 | `	return SXERR_NOTFOUND;` |
|    172129 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    344429 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    344434 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    344434 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    344434 |  504 | `	int isNeg = FALSE, nDigit;` |
|    344434 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    344424 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    344420 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    344420 |  516 | `	zDigit = zIn;` |
|    172656 |  517 | `	for(;;){` |
|    345318 |  518 | `		if( zIn >= zEnd ){` |
|       299 |  519 | `			break;` |
|         - |  520 | `		}` |
|    345020 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    344122 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       899 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|       299 |  531 | `	nDigit = (int)(zEnd - zDigit);` |
|       299 |  532 | `	if( nDigit < 1 ){` |
|         - |  533 | `		/* A lone sign ("-"/"+") */` |
|       ! 0 |  534 | `		return FALSE;` |
|         - |  535 | `	}` |
|       303 |  536 | `	if( nDigit > 19 \|\|` |
|       152 |  537 | `		(nDigit == 19 && SyMemcmp(zDigit, isNeg ? "9223372036854775808" : "9223372036854775807", 19) > 0) ){` |
|         7 |  538 | `		return FALSE;` |
|         - |  539 | `	}` |
|       293 |  540 | `	return TRUE;` |
|    172219 |  541 | `}` |
...
|         - |  546 | ` */` |
|    152402 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    152407 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    152407 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    145079 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    145079 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    145007 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    145007 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      7405 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        84 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        41 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      7405 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     76201 |  575 | `result:` |
|    152407 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72203 |  578 | `		if( ppNode ){` |
|     72149 |  579 | `			*ppNode = pNode;` |
|     36072 |  580 | `		}` |
|     72203 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80209 |  584 | `	return SXERR_NOTFOUND;` |
|     76206 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  591 | ` */` |
|   2142836 |  592 | `static void HashmapAdvanceAutoIndex(ph7_hashmap *pMap,sxi64 iKey)` |
|         5 |  593 | `{` |
|   2142841 |  594 | `	if( !pMap->bIntKeySeen ){` |
|         - |  595 | `		/* php 8.3: the first integer key sets the auto-index even if it is negative */` |
|       897 |  596 | `		pMap->bIntKeySeen = 1;` |
|       897 |  597 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|       897 |  598 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  599 | `			pMap->iNextIdx++;` |
|       ! 0 |  600 | `		}` |
|       897 |  601 | `		return;` |
|         - |  602 | `	}` |
|   2141949 |  603 | `	if( iKey >= pMap->iNextIdx ){` |
|   2141657 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141657 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070832 |  609 | `	}` |
|   1071423 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1478630 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1478635 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1478629 |  623 | `	return FALSE;` |
|    739320 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3774397 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3774402 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3774402 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3774402 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153010 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    153010 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       219 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229185 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76393 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152304 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|       148 |  670 | `			if( SyBlobLength(&pKey->sBlob) < 1 ){` |
...
|         - |  674 | `			}` |
|       221 |  675 | `			return PH7_VmInstallGlobalVar(pMap->pVm,` |
|       146 |  676 | `				(const char *)SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),` |
|        73 |  677 | `				pVal,SXU32_HIGH);` |
|         - |  678 | `		}` |
|         - |  679 | `		/* Perform a blob-key insertion */` |
|    152158 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152158 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1810696 |  683 | `IntKey:` |
|   3621615 |  684 | `	if( pKey ){` |
|   2143019 |  685 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  686 | `			/* Force an integer cast */` |
|       238 |  687 | `			PH7_MemObjToInteger(pKey);` |
|       118 |  688 | `		}` |
|   2143019 |  689 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
|         - |  690 | `			/* Overwrite the old value */` |
|         - |  691 | `			ph7_value *pElem;` |
|       184 |  692 | `			pElem = (ph7_value *)SySetAt(&pMap->pVm->aMemObj,pNode->nValIdx);` |
|       184 |  693 | `			if( pElem ){` |
|       184 |  694 | `				if( pVal ){` |
|       184 |  695 | `					PH7_MemObjStore(pVal,pElem);` |
|        93 |  696 | `				}else{` |
|         - |  697 | `					/* Nullify the entry */` |
|       ! 0 |  698 | `					PH7_MemObjToNull(pElem);` |
|         - |  699 | `				}` |
|        91 |  700 | `			}` |
|       184 |  701 | `			return SXRET_OK;` |
|         - |  702 | `		}` |
|   2142837 |  703 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|   2142835 |  711 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   2142835 |  712 | `		if( rc == SXRET_OK ){` |
|   2142835 |  713 | `			HashmapAdvanceAutoIndex(&(*pMap),pKey->x.iVal);` |
|   1071415 |  714 | `		}` |
|   1071420 |  715 | `	}else{` |
|   1478601 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1478599 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1478593 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1478593 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1478591 |  726 | `			++pMap->iNextIdx;` |
|    739293 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3621423 |  730 | `	return rc;` |
|   1887203 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46390 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46395 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46395 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46395 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46355 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46355 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69527 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23174 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46343 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46343 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1501460 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1501465 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1501465 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77504 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77509 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77509 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77509 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77509 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77509 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77509 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77509 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77509 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77509 |  921 | `	return rc;` |
|     38648 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16738 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16743 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16743 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11782 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5785 |  934 | `	}else{` |
|      4966 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16743 |  937 | `	if( pEntry->pNextCollide ){` |
|      1098 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       561 |  939 | `	}` |
|     16743 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16743 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16743 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16743 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16743 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16743 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12105 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5953 |  949 | `	}` |
|     16743 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16743 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16743 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16743 |  956 | `		pMap->iNextIdx++;` |
|      8369 |  957 | `	}` |
|     16743 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     32796 |  966 | `PH7_PRIVATE int HashmapFindValue(` |
...
|     32801 |  979 | `	pEntry = pMap->pFirst;` |
|     32801 |  980 | `	n = pMap->nEntry;` |
|     32801 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32801 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78075 |  983 | `	for(;;){` |
|    156153 |  984 | `		if( n < 1 ){` |
|        83 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    156071 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156071 |  989 | `		if( pVal ){` |
...
|    156071 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156071 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156071 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156071 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156071 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156071 | 1001 | `			if( rc == 0 ){` |
|     32719 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     32719 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     61677 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    123357 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123357 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1135 | ` */` |
|        52 | 1136 | `PH7_PRIVATE sxi32 PH7_HashmapCmp(` |
...
|        31 | 1162 | `		ph7_hashmap_node *pLs = pLeft->pFirst;` |
|        31 | 1163 | `		ph7_hashmap_node *pRs = pRight->pFirst;` |
|        57 | 1164 | `		for( n = pLeft->nEntry ; n > 0 ; n-- ){` |
|         - | 1165 | `			/* Keys must match in type and value at this position */` |
|        41 | 1166 | `			if( pLs->iType != pRs->iType ){` |
|       ! 0 | 1167 | `				return 1;` |
|         - | 1168 | `			}` |
|        41 | 1169 | `			if( pLs->iType == HASHMAP_INT_NODE ){` |
|        19 | 1170 | `				if( pLs->xKey.iKey != pRs->xKey.iKey ){` |
|         3 | 1171 | `					return 1;` |
|         - | 1172 | `				}` |
|         9 | 1173 | `			}else{` |
...
|        33 | 1183 | `			if( HashmapNodeCmp(pLs,pRs,TRUE) != 0 ){` |
|         7 | 1184 | `				return 1;` |
|         - | 1185 | `			}` |
|        27 | 1186 | `			pLs = pLs->pPrev; /* Reverse link = insertion order */` |
|        27 | 1187 | `			pRs = pRs->pPrev;` |
|        14 | 1188 | `		}` |
|        17 | 1189 | `		return 0; /* Same pairs, same order */` |
|         - | 1190 | `	}` |
...
|         - | 1236 | ` */` |
|    710636 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    710636 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    710638 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    710633 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    710633 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2027 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    706589 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    702925 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    355129 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|        17 | 1290 | `		}else{ /* Dup */` |
|      3639 | 1291 | `			rc = HashmapInsertIntKey(pDest,pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|         - | 1292 | `		}` |
|         - | 1293 | `	}` |
|    710633 | 1294 | `	return rc;` |
|    355323 | 1295 | `}` |
|         - | 1296 | `/*` |
...
|         - | 1307 | ` */` |
|      2906 | 1308 | `PH7_PRIVATE sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1309 | `{` |
|         - | 1310 | `	ph7_hashmap_node *pEntry;` |
|         - | 1311 | `	ph7_value *pVal;` |
|         - | 1312 | `	sxi32 rc;` |
|         - | 1313 | `	sxu32 n;` |
|      2911 | 1314 | `	if( pSrc == pDest ){` |
...
|      2911 | 1321 | `	pEntry = pSrc->pFirst;` |
|         - | 1322 | `	/* Perform the merge */` |
|    705891 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    702985 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    702985 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    702985 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    351495 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    702985 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    702985 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    351495 | 1341 | `	}` |
|      2911 | 1342 | `	return SXRET_OK;` |
|      1458 | 1343 | `}` |
|         - | 1344 | `/*` |
...
|         - | 1392 | ` */` |
|      7318 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7323 | 1399 | `	if( pSrc == pDest ){` |
...
|      7323 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14935 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7617 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7617 | 1411 | `		if( pVal ){` |
|      7617 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3811 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7617 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7617 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3811 | 1421 | `	}` |
|      7323 | 1422 | `	return SXRET_OK;` |
|      3664 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|       833 | 1442 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1443 | `		/* Extract the node value (resolves foreign references) */` |
|       821 | 1444 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|       820 | 1445 | `		if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP)` |
|       544 | 1446 | `		 && (ph7_hashmap *)pVal->x.pOther == pSrc->pVm->pGlobal ){` |
...
|         2 | 1453 | `		}` |
|       821 | 1454 | `		if( pVal ){` |
|       817 | 1455 | `			if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|      1219 | 1456 | `				rc = HashmapInsertBlobKey(&(*pDest),SyBlobData(&pEntry->xKey.sKey),` |
|       406 | 1457 | `					SyBlobLength(&pEntry->xKey.sKey),pVal,0,FALSE);` |
|       407 | 1458 | `			}else{` |
|         5 | 1459 | `				rc = HashmapInsertIntKey(&(*pDest),pEntry->xKey.iKey,pVal,0,FALSE);` |
|         - | 1460 | `			}` |
|       817 | 1461 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1462 | `				return rc;` |
|         - | 1463 | `			}` |
|       408 | 1464 | `		}` |
|         - | 1465 | `		/* Point to the next entry */` |
|       821 | 1466 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|       411 | 1467 | `	}` |
...
|         - | 1498 | ` */` |
|    243772 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    243777 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    243777 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    243777 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    240937 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
|      2845 | 1511 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1630 | ` */` |
|      3812 | 1631 | `PH7_PRIVATE sxi32 PH7_HashmapUnion(ph7_hashmap *pLeft,ph7_hashmap *pRight)` |
|         5 | 1632 | `{` |
|         - | 1633 | `	ph7_hashmap_node *pEntry;` |
|      3817 | 1634 | `	sxi32 rc = SXRET_OK;` |
|         - | 1635 | `	ph7_value *pObj;` |
|         - | 1636 | `	sxu32 n;` |
|      3817 | 1637 | `	if( pLeft == pRight ){` |
...
|      3817 | 1644 | `	pEntry = pRight->pFirst;` |
|      3857 | 1645 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
...
|    141915 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141915 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    141915 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    141915 | 1700 | `	pMap->pVm = &(*pVm);` |
|    141915 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    141915 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141915 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141915 | 1705 | `	return pMap;` |
|     70960 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1725 | `*    $_ENV` |
|         - | 1726 | `*/` |
|      3414 | 1727 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|         5 | 1728 | `{` |
...
|      3419 | 1747 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|      3419 | 1748 | `	if( pMap == 0 ){` |
|       ! 0 | 1749 | `		return SXERR_MEM;` |
|         - | 1750 | `	}` |
|      3419 | 1751 | `	pVm->pGlobal = pMap;` |
|         - | 1752 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|      3419 | 1753 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|      3419 | 1754 | `	if( pObj == 0 ){` |
|       ! 0 | 1755 | `		return SXERR_MEM;` |
|         - | 1756 | `	}` |
|      3419 | 1757 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|         - | 1758 | `	/* Record object index */` |
|      3419 | 1759 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|         - | 1760 | `	/* Install the special $GLOBALS array */` |
|      3419 | 1761 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|      3419 | 1762 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1763 | `		return rc;` |
|         - | 1764 | `	}` |
|         - | 1765 | `	/* Install superglobals now */` |
|     37559 | 1766 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|         - | 1767 | `		ph7_value *pSuper;` |
|         - | 1768 | `		/* Request an empty array */` |
|     34145 | 1769 | `		pSuper = ph7_new_array(&(*pVm));` |
|     34145 | 1770 | `		if( pSuper == 0 ){` |
|       ! 0 | 1771 | `			return SXERR_MEM;` |
|         - | 1772 | `		}` |
|         - | 1773 | `		/* Install */` |
|     34145 | 1774 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|     34145 | 1775 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1776 | `			return rc;` |
|         - | 1777 | `		}` |
|         - | 1778 | `		/* Release the value now it have been installed */` |
|     34145 | 1779 | `		ph7_release_value(&(*pVm),pSuper);` |
|     17075 | 1780 | `	}` |
|         - | 1781 | `	/* Set some $_SERVER entries */` |
|      3419 | 1782 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|         - | 1783 | `	/*` |
|         - | 1784 | `	 * 'SCRIPT_FILENAME'` |
|         - | 1785 | `	 * The absolute pathname of the currently executing script.` |
|         - | 1786 | `	 */` |
|      6833 | 1787 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|         - | 1788 | `		"SCRIPT_FILENAME",` |
|      1707 | 1789 | `		pFile ? pFile->zString : ":Memory:",` |
|      3414 | 1790 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|         - | 1791 | `		);` |
|         - | 1792 | `	/* All done,all super-global are installed now */` |
|      3419 | 1793 | `	return SXRET_OK;` |
|      1712 | 1794 | `}` |
|         - | 1795 | `/*` |
|         - | 1796 | ` * Release a hashmap.` |
|         - | 1797 | ` */` |
|     93966 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     93971 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     93971 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     93971 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     93971 | 1821 | `	n = 0;` |
|     93971 | 1822 | `	pEntry = pMap->pFirst;` |
|   1904756 | 1823 | `	for(;;){` |
|   3809518 | 1824 | `		if( n >= pMap->nEntry ){` |
|     93971 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3715552 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3715552 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3715552 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3715492 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1857743 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3715552 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109532 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54763 | 1837 | `		}` |
|   3715552 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3715552 | 1840 | `		pEntry = pNext;` |
|   3715552 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     93971 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68124 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34059 | 1846 | `	}` |
|     93971 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     93945 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     46975 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    873968 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    873973 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    873973 | 1869 | `	pMap->iRef--;` |
|    873973 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     93925 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     46960 | 1872 | `	}` |
|    873973 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152652 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3071147 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3071152 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3071152 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46380 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46385 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46385 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46385 | 1966 | `	return rc;` |
|     23195 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23804 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23809 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23809 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23809 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23809 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23628 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23633 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23633 | 1991 | `	while( *ppLink ){` |
|     23633 | 1992 | `		if( *ppLink == pStep ){` |
|     23633 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23633 | 1994 | `			pStep->pNextActive = 0;` |
|     23633 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    595774 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    595779 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    595779 | 2023 | `	if( pEntry ){` |
|    595779 | 2024 | `		if( bStore ){` |
|    217279 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    108642 | 2026 | `		}else{` |
|    378505 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    297674 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    164658 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    164663 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    158607 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    158607 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    158607 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79306 | 2045 | `	}else{` |
|      6061 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      6061 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      6061 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    164663 | 2050 | `}` |
...
|         - | 2158 | ` */` |
|      3406 | 2159 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 2160 | `{` |
|         - | 2161 | `	sxu32 n;` |
|    255455 | 2162 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    252049 | 2163 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    126027 | 2164 | `	}` |
|      3411 | 2165 | `}` |
|         - | 2166 | `/*` |
...
|         - | 2180 | ` */` |
|       132 | 2181 | `PH7_PRIVATE sxi32 PH7_HashmapDumpEntries(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         3 | 2182 | `{` |
|       135 | 2183 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 2184 | `	ph7_value *pObj;` |
|       135 | 2185 | `	sxu32 n = 0;` |
|         - | 2186 | `	int isRef;` |
|       135 | 2187 | `	sxi32 rc = SXRET_OK;` |
|         - | 2188 | `	int i;` |
|       209 | 2189 | `	for(;;){` |
|       421 | 2190 | `		if( n >= pMap->nEntry ){` |
|       135 | 2191 | `			break;` |
|         - | 2192 | `		}` |
|       289 | 2193 | `		pObj = HashmapExtractNodeValue(pEntry);` |
...
|       573 | 2196 | `		isRef = ((pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0)` |
|       286 | 2197 | `			\|\| PH7_VmSlotIsReferenced(pMap->pVm,pEntry->nValIdx);` |
|       289 | 2198 | `		if( ShowType ){` |
|         - | 2199 | ``			/* var_dump entry: `[key]=>` on its own line at nTab+2, the value`` |
|         - | 2200 | `			 * on the next line at the same indent (php). */` |
|       177 | 2201 | `			for( i = 0 ; i < nTab + 2 ; i++ ){` |
|       119 | 2202 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        61 | 2203 | `			}` |
|        61 | 2204 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|        53 | 2205 | `				SyBlobFormat(&(*pOut),"[%qd]=>",pEntry->xKey.iKey);` |
|        27 | 2206 | `			}else{` |
|        11 | 2207 | `				SyBlobFormat(&(*pOut),"[\"%.*s\"]=>",` |
|         3 | 2208 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 2209 | `			}` |
|        61 | 2210 | `			SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        61 | 2211 | `			if( pObj ){` |
|        61 | 2212 | `				rc = PH7_MemObjDump(&(*pOut),pObj,TRUE,nTab+2,nDepth,isRef);` |
|        61 | 2213 | `				if( rc == SXERR_LIMIT ){` |
|       ! 0 | 2214 | `					break;` |
|         - | 2215 | `				}` |
|        29 | 2216 | `			}` |
|        32 | 2217 | `		}else{` |
...
|      1254 | 2221 | `			for( i = 0 ; i < nTab + 4 ; i++ ){` |
|      1026 | 2222 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|       514 | 2223 | `			}` |
|       230 | 2224 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|       119 | 2225 | `				SyBlobFormat(&(*pOut),"[%qd] => ",pEntry->xKey.iKey);` |
|        60 | 2226 | `			}else{` |
|       167 | 2227 | `				SyBlobFormat(&(*pOut),"[%.*s] => ",` |
|        55 | 2228 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 2229 | `			}` |
|       228 | 2230 | `			if( pObj && (pObj->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ))` |
|       128 | 2231 | `			 && (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
...
|        13 | 2237 | `			}else{` |
|       206 | 2238 | `				if( pObj ){` |
|       206 | 2239 | `					PH7_MemObjPrintRInline(&(*pOut),pObj);` |
|       102 | 2240 | `				}` |
|       206 | 2241 | `				SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|         - | 2242 | `			}` |
|         - | 2243 | `		}` |
|         - | 2244 | `		/* Point to the next entry */` |
|       289 | 2245 | `		n++;` |
|       289 | 2246 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         3 | 2247 | `	}` |
|       135 | 2248 | `	return rc;` |
|         3 | 2249 | `}` |
|       128 | 2250 | `PH7_PRIVATE sxi32 PH7_HashmapDump(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         2 | 2251 | `{` |
|         - | 2252 | `	sxi32 rc;` |
|         - | 2253 | `	int i;` |
|       130 | 2254 | `	if( nDepth > 31 ){` |
...
|         - | 2259 | `	}` |
|       130 | 2260 | `	if( ShowType ){` |
|         - | 2261 | ``		/* var_dump: `array(N) {\n … \n<nTab>}` — the caller adds the final`` |
|         - | 2262 | `		 * newline (a nested array is itself an entry value line). */` |
|        28 | 2263 | `		SyBlobFormat(&(*pOut),"array(%u) {",pMap->nEntry);` |
|        28 | 2264 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        28 | 2265 | `		rc = PH7_HashmapDumpEntries(&(*pOut),pMap,TRUE,nTab,nDepth);` |
|        28 | 2266 | `		for( i = 0 ; i < nTab ; i++ ){` |
|       ! 0 | 2267 | `			SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|       ! 0 | 2268 | `		}` |
|        28 | 2269 | `		SyBlobAppend(&(*pOut),"}",sizeof(char));` |
|        28 | 2270 | `		return rc;` |
|         - | 2271 | `	}` |
|         - | 2272 | ``	/* print_r: `Array\n<nTab>(\n … <nTab>)\n` */`` |
|       103 | 2273 | `	SyBlobAppend(&(*pOut),"Array\n",sizeof("Array\n")-1);` |
|       295 | 2274 | `	for( i = 0 ; i < nTab ; i++ ){` |
|       193 | 2275 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        97 | 2276 | `	}` |
|       103 | 2277 | `	SyBlobAppend(&(*pOut),"(\n",sizeof("(\n")-1);` |
|       103 | 2278 | `	rc = PH7_HashmapDumpEntries(&(*pOut),pMap,FALSE,nTab,nDepth);` |
|       295 | 2279 | `	for( i = 0 ; i < nTab ; i++ ){` |
|       193 | 2280 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        97 | 2281 | `	}` |
|       103 | 2282 | `	SyBlobAppend(&(*pOut),")\n",sizeof(")\n")-1);` |
|       103 | 2283 | `	return rc;` |
|        66 | 2284 | `}` |
|         - | 2285 | `/*` |
...
|         - | 2293 | ` */` |
|     34050 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34055 | 2305 | `	rc = SXRET_OK;` |
|     34055 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34055 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34055 | 2308 | `	n = pMap->nEntry;` |
|     34055 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    157273 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157273 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    157273 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    157273 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    157273 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    157273 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    157271 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157271 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     34053 | 2332 | `	return SXRET_OK;` |
|     17030 | 2333 | `}` |
|         - | 2334 |  |
