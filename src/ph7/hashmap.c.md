...
|         - |   22 | ` */` |
|   7505946 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7505951 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7505951 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    634446 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    634451 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    634451 |   35 | `	sxu32 nH = 5381;` |
|    634451 |   36 | `	zEnd = &zIn[nLen];` |
|    717400 |   37 | `	for(;;){` |
|   1434805 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1228105 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1100113 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    958081 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    634451 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3202012 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3202017 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3202017 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3202017 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3202017 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3202017 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3202017 |  112 | `	pNode->nHash = nHash;` |
|   3202017 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3202017 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3202017 |  115 | `	return pNode;` |
|   1601011 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    262894 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    262899 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    262899 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    262899 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    262899 |  133 | `	pNode->pMap  = &(*pMap);` |
|    262899 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    262899 |  135 | `	pNode->nHash = nHash;` |
|    262899 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    262899 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    262899 |  138 | `	pNode->nValIdx = nValIdx;` |
|    262899 |  139 | `	return pNode;` |
|    131452 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3464906 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3464911 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2988293 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2988293 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1494144 |  150 | `	}` |
|   3464911 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3464911 |  153 | `	if( pMap->pFirst == 0 ){` |
|     90463 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     90463 |  156 | `		pMap->pCur = pNode;` |
|     45234 |  157 | `	}else{` |
|   3374453 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3464911 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3464906 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3464911 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     95783 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     95783 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     95783 |  245 | `		if( nNew < 1 ){` |
|     90463 |  246 | `			nNew = 16;` |
...
|     95783 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     95783 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     95783 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     95783 |  260 | `		pMap->apBucket = apNew;` |
|     95783 |  261 | `		pMap->nSize = nNew;` |
|     95783 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     90463 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5325 |  267 | `		pEntry = pMap->pFirst;` |
|      5325 |  268 | `		n = 0;` |
|   2135828 |  269 | `		for( ;; ){` |
|   4271661 |  270 | `			if( n >= pMap->nEntry ){` |
|      5325 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   4266341 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   4266341 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   4266341 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   3619969 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3619969 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1809982 |  280 | `			}` |
|   4266341 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   4266341 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   4266341 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5325 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2660 |  288 | `	}` |
|   3374453 |  289 | `	return SXRET_OK;` |
|   1732458 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3202012 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3202017 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3201975 |  310 | `		if( pValue ){` |
|   3201969 |  311 | `			sSafeVal = *pValue;` |
|   3201969 |  312 | `			pValue = &sSafeVal;` |
|   1600982 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3201975 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3201975 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3201975 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3201969 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1600982 |  322 | `		}` |
|   3201975 |  323 | `		nIdx = pObj->nIdx;` |
|   1600990 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3202017 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3202017 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3202017 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3202017 |  334 | `	if( isForeign ){` |
...
|   3202017 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3202017 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3202017 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3202017 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3202017 |  349 | `	return SXRET_OK;` |
|   1601011 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    262894 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    262899 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    216955 |  370 | `		if( pValue ){` |
|    216645 |  371 | `			sSafeVal = *pValue;` |
|    216645 |  372 | `			pValue = &sSafeVal;` |
|    108320 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    216955 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    216955 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    216955 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    216645 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    108320 |  382 | `		}` |
|    216955 |  383 | `		nIdx = pObj->nIdx;` |
|    108480 |  384 | `	}else{` |
|     45949 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    262899 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    262899 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    262899 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    262899 |  394 | `	if( isForeign ){` |
...
|    262899 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    262899 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    262899 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    262899 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    262899 |  409 | `	return SXRET_OK;` |
|    131452 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4290540 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4290545 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       769 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4289781 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4289781 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110566872 |  433 | `	for(;;){` |
| 221133749 |  434 | `		if( pNode == 0 ){` |
|   4284373 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216849376 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216846364 |  438 | `			&& pNode->nHash == nHash` |
| 108424385 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      5413 |  441 | `				if( ppNode ){` |
|      5391 |  442 | `					*ppNode = pNode;` |
|      2693 |  443 | `				}` |
|      5413 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
...
|         - |  456 | ` */` |
|    406166 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    406171 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     34619 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    371557 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    371557 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    305789 |  475 | `	for(;;){` |
|    611583 |  476 | `		if( pNode == 0 ){` |
|    306821 |  477 | `			break;` |
|         - |  478 | `		}` |
|    304762 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    303251 |  480 | `			&& pNode->nHash == nHash` |
|    183288 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     64841 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     64741 |  484 | `				if( ppNode ){` |
|     64713 |  485 | `					*ppNode = pNode;` |
|     32354 |  486 | `				}` |
|     64741 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    240031 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    306821 |  493 | `	return SXERR_NOTFOUND;` |
|    203088 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    406298 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    406303 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    406303 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    406303 |  504 | `	int isNeg = FALSE, nDigit;` |
|    406303 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    406281 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    406277 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    406277 |  516 | `	zDigit = zIn;` |
|    203570 |  517 | `	for(;;){` |
|    407145 |  518 | `		if( zIn >= zEnd ){` |
|       251 |  519 | `			break;` |
|         - |  520 | `		}` |
|    406895 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    406027 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       869 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    148672 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    148677 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    148677 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    143395 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    143395 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    143381 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    143381 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         7 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      5301 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        27 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        13 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      5301 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     74336 |  575 | `result:` |
|    148677 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     69267 |  578 | `		if( ppNode ){` |
|     69215 |  579 | `			*ppNode = pNode;` |
|     34605 |  580 | `		}` |
|     69267 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79415 |  584 | `	return SXERR_NOTFOUND;` |
|     74341 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1059042 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1059047 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1059041 |  623 | `	return FALSE;` |
|    529526 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3418494 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3418499 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3418499 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3418499 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    216957 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    216957 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    325091 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    108362 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    216243 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    216113 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    216113 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1600771 |  683 | `IntKey:` |
|   3201775 |  684 | `	if( pKey ){` |
...
|   1071283 |  714 | `		}` |
|   1071288 |  715 | `	}else{` |
|   1059013 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1059011 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1059005 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1059005 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1059003 |  726 | `			++pMap->iNextIdx;` |
|    529499 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3201571 |  730 | `	return rc;` |
|   1709252 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1492563 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1492568 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1492568 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     72462 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     72467 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     72467 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     72467 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     72467 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     72467 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     72467 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     72467 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     72467 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     72467 |  921 | `	return rc;` |
|     36206 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14158 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14163 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14163 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11389 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5702 |  934 | `	}else{` |
|      2779 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14163 |  937 | `	if( pEntry->pNextCollide ){` |
|       991 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       512 |  939 | `	}` |
|     14163 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14163 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14163 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14163 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14163 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14163 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11708 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5861 |  949 | `	}` |
|     14163 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14163 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14163 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14163 |  956 | `		pMap->iNextIdx++;` |
|      7079 |  957 | `	}` |
|     14163 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33166 |  966 | `static int HashmapFindValue(` |
...
|     33171 |  979 | `	pEntry = pMap->pFirst;` |
|     33171 |  980 | `	n = pMap->nEntry;` |
|     33171 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33171 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     79170 |  983 | `	for(;;){` |
|    158346 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    158268 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    158268 |  989 | `		if( pVal ){` |
...
|    158268 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    158268 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    158268 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    158268 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    158268 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    158268 | 1001 | `			if( rc == 0 ){` |
|     33093 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33093 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     62587 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    125180 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    125180 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    700498 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    700498 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    700500 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    700495 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    700495 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      1996 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    696513 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    696267 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    348381 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|         - | 1271 | ` */` |
|      2848 | 1272 | `static sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1273 | `{` |
|         - | 1274 | `	ph7_hashmap_node *pEntry;` |
|         - | 1275 | `	ph7_value *pVal;` |
|         - | 1276 | `	sxi32 rc;` |
|         - | 1277 | `	sxu32 n;` |
|      2853 | 1278 | `	if( pSrc == pDest ){` |
...
|      2853 | 1285 | `	pEntry = pSrc->pFirst;` |
|         - | 1286 | `	/* Perform the merge */` |
|    699175 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    696327 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    696327 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    696327 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    348166 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    696327 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    696327 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    348166 | 1305 | `	}` |
|      2853 | 1306 | `	return SXRET_OK;` |
|      1429 | 1307 | `}` |
|         - | 1308 | `/*` |
...
|         - | 1462 | ` */` |
|    237368 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    237373 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    237373 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    237373 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    234625 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
|      2753 | 1475 | `	if( pMap == pVm->pGlobal ){` |
...
|      2627 | 1484 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2627 | 1485 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2622 | 1486 | `		if( pBacking && pBacking != pValue` |
|      2597 | 1487 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2577 | 1488 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1489 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2577 | 1490 | `			pMap->iRef--;` |
|      2577 | 1491 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1492 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2531 | 1493 | `				pMap->iRef++;` |
|      2531 | 1494 | `				return pMap;` |
|         - | 1495 | `			}` |
...
|         - | 1648 | ` */` |
|    144746 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    144751 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    144751 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    144751 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    144751 | 1664 | `	pMap->pVm = &(*pVm);` |
|    144751 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    144751 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    144751 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    144751 | 1669 | `	return pMap;` |
|     72378 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|    102818 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|    102823 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|    102823 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|    102823 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|    102823 | 1785 | `	n = 0;` |
|    102823 | 1786 | `	pEntry = pMap->pFirst;` |
|   1741470 | 1787 | `	for(;;){` |
|   3482945 | 1788 | `		if( n >= pMap->nEntry ){` |
|    102823 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3380127 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3380127 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3380127 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3380067 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1690031 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3380127 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    189435 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     94715 | 1801 | `		}` |
|   3380127 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3380127 | 1804 | `		pEntry = pNext;` |
|   3380127 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|    102823 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     75527 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     37761 | 1810 | `	}` |
|    102823 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|    102797 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     51401 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    845350 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    845355 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    845355 | 1833 | `	pMap->iRef--;` |
|    845355 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|    102777 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     51386 | 1836 | `	}` |
|    845355 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    148860 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   2721898 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2721903 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2721903 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     19170 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     19175 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     19175 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     19175 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     19175 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     19068 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     19073 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     19073 | 1955 | `	while( *ppLink ){` |
|     19073 | 1956 | `		if( *ppLink == pStep ){` |
|     19073 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     19073 | 1958 | `			pStep->pNextActive = 0;` |
|     19073 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    599236 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    599241 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    599241 | 1987 | `	if( pEntry ){` |
|    599241 | 1988 | `		if( bStore ){` |
|    238421 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    119213 | 1990 | `		}else{` |
|    360825 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    299563 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    159518 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    159523 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    154223 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    154223 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    154223 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     77114 | 2009 | `	}else{` |
...
|    109666 | 2071 | `	while( pA && pB ){` |
|     72716 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47898 | 2073 | `			pTail->pPrev = pA;` |
|     47898 | 2074 | `			pA->pNext = pTail;` |
|     47898 | 2075 | `			pTail = pA;` |
|     47898 | 2076 | `			pA = pA->pPrev;` |
|     23888 | 2077 | `		}else{` |
|     24823 | 2078 | `			pTail->pPrev = pB;` |
|     24823 | 2079 | `			pB->pNext = pTail;` |
|     24823 | 2080 | `			pTail = pB;` |
|     24823 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     36955 | 2084 | `	if( pA ){` |
|     26340 | 2085 | `		pTail->pPrev = pA;` |
|     26340 | 2086 | `		pA->pNext = pTail;` |
|     23831 | 2087 | `	}else if( pB ){` |
...
|     14985 | 2114 | `	while( pIn ){` |
|     14207 | 2115 | `		p = pIn;` |
|     14207 | 2116 | `		pIn = p->pPrev;` |
|     14207 | 2117 | `		p->pPrev = 0;` |
|     27039 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27039 | 2119 | `			if( a[i]==0 ){` |
|     14207 | 2120 | `				a[i] = p;` |
|     14207 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
...
|         - | 2125 | `			}` |
|      6421 | 2126 | `		}` |
|     14207 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     72396 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     72401 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     72313 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     13939 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     13939 | 2532 | `		i++;` |
|     13939 | 2533 | `		pLast = p;` |
|     13939 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       703 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         - | 2556 | ` *` |
|         - | 2557 | ` */` |
|      1062 | 2558 | `static int ph7_hashmap_sort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 2559 | `{` |
|         - | 2560 | `	ph7_hashmap *pMap;` |
|         - | 2561 | `	/* Make sure we are dealing with a valid hashmap */` |
|      1067 | 2562 | `	if( nArg < 1 \|\| !ph7_value_is_array(apArg[0]) ){` |
...
|      1067 | 2568 | `	PH7_HashmapCowSeparate(pCtx->pVm, apArg[0]);` |
|      1067 | 2569 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|      1067 | 2570 | `	if( pMap->nEntry > 1 ){` |
...
|      1067 | 2582 | `	ph7_result_bool(pCtx,1);` |
|      1067 | 2583 | `	return PH7_OK;` |
|       536 | 2584 | `}` |
|         - | 2585 | `/*` |
...
|         - | 4444 | ` */` |
|      1090 | 4445 | `static int ph7_hashmap_merge(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4446 | `{` |
|         - | 4447 | `	ph7_hashmap *pMap,*pSrc;` |
|         - | 4448 | `	ph7_value *pArray;` |
|         - | 4449 | `	int i;` |
|         - | 4450 | `	/* Create a new array */` |
|      1095 | 4451 | `	pArray = ph7_context_new_array(pCtx);` |
|      1095 | 4452 | `	if( pArray == 0 ){` |
|       ! 0 | 4453 | `		ph7_result_null(pCtx);` |
|       ! 0 | 4454 | `		return PH7_OK;` |
|         - | 4455 | `	}` |
|         - | 4456 | `	/* Point to the internal representation of the hashmap */` |
|      1095 | 4457 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|         - | 4458 | `	/* Start merging */` |
|      3265 | 4459 | `	for( i = 0 ; i < nArg ; i++ ){` |
|         - | 4460 | `		/* Make sure we are dealing with a valid hashmap */` |
|      2179 | 4461 | `		if( !ph7_value_is_array(apArg[i]) ){` |
...
|         - | 4468 | `				);` |
|       ! 0 | 4469 | `		}else{` |
|      2175 | 4470 | `			pSrc = (ph7_hashmap *)apArg[i]->x.pOther;` |
|         - | 4471 | `			/* Merge the two hashmaps */` |
|      2175 | 4472 | `			HashmapMerge(pSrc,pMap);` |
|         - | 4473 | `		}` |
|      1090 | 4474 | `	}` |
|         - | 4475 | `	/* Return the freshly created array */` |
|      1091 | 4476 | `	ph7_result_value(pCtx,pArray);` |
|      1091 | 4477 | `	return PH7_OK;` |
|       550 | 4478 | `}` |
|         - | 4479 | `/*` |
...
|         - | 4937 | ` */` |
|     33038 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33043 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33043 | 4948 | `	pNeedle = apArg[0];` |
|     33043 | 4949 | `	bStrict = 0;` |
|     33043 | 4950 | `	if( nArg > 2 ){` |
|        53 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4952 | `	}` |
|     33043 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33043 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33043 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33043 | 4964 | `	return PH7_OK;` |
|     16524 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         - | 8934 | ` */` |
|     34186 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34191 | 8946 | `	rc = SXRET_OK;` |
|     34191 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34191 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34191 | 8949 | `	n = pMap->nEntry;` |
|     34191 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    152965 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    152965 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    152965 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    152965 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    152965 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    152965 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    152965 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    152965 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34191 | 8973 | `	return SXRET_OK;` |
|     17098 | 8974 | `}` |
|         - | 8975 |  |
