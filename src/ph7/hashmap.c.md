...
|       - |   17 | ` */` |
| 2954950 |   18 | `static sxu32 IntHash(sxi64 iKey)` |
|       2 |   19 |  |
| 2954952 |   20 | `	return (sxu32)(iKey ^ (iKey << 8) ^ (iKey >> 8));` |
|       2 |   21 |  |
|       - |   22 | `/*` |
|       - |   23 | ` * Default hash function for string/BLOB keys.` |
|       - |   24 | ` */` |
|  282644 |   25 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|       2 |   26 |  |
|  282646 |   27 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|       - |   28 | `	unsigned char *zEnd;` |
|  282646 |   29 | `	sxu32 nH = 5381;` |
|  282646 |   30 | `	zEnd = &zIn[nLen];` |
|  317025 |   31 | `	for(;;){` |
|  634052 |   32 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  559404 |   33 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  502964 |   34 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  413760 |   35 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|       2 |   36 | `	}` |
|  282646 |   37 | `	return nH;` |
|       2 |   38 |  |
|       - |   39 | `/*` |
...
|       - |   92 | ` */` |
| 2897538 |   93 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|       2 |   94 |  |
|       - |   95 | `	ph7_hashmap_node *pNode;` |
|       - |   96 | `	/* Allocate a new node */` |
| 2897540 |   97 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
| 2897540 |   98 | `	if( pNode == 0 ){` |
|     ! 0 |   99 | `		return 0;` |
|       - |  100 | `	}` |
|       - |  101 | `	/* Zero the stucture */` |
| 2897540 |  102 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  103 | `	/* Fill in the structure */` |
| 2897540 |  104 | `	pNode->pMap  = &(*pMap);` |
| 2897540 |  105 | `	pNode->iType = HASHMAP_INT_NODE;` |
| 2897540 |  106 | `	pNode->nHash = nHash;` |
| 2897540 |  107 | `	pNode->xKey.iKey = iKey;` |
| 2897540 |  108 | `	pNode->nValIdx  = nValIdx;` |
| 2897540 |  109 | `	return pNode;` |
| 1448771 |  110 |  |
|       - |  111 | `/*` |
...
|       - |  115 | ` */` |
|   98288 |  116 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|       2 |  117 |  |
|       - |  118 | `	ph7_hashmap_node *pNode;` |
|       - |  119 | `	/* Allocate a new node */` |
|   98290 |  120 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   98290 |  121 | `	if( pNode == 0 ){` |
|     ! 0 |  122 | `		return 0;` |
|       - |  123 | `	}` |
|       - |  124 | `	/* Zero the stucture */` |
|   98290 |  125 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  126 | `	/* Fill in the structure */` |
|   98290 |  127 | `	pNode->pMap  = &(*pMap);` |
|   98290 |  128 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|   98290 |  129 | `	pNode->nHash = nHash;` |
|   98290 |  130 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|   98290 |  131 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|   98290 |  132 | `	pNode->nValIdx = nValIdx;` |
|   98290 |  133 | `	return pNode;` |
|   49146 |  134 |  |
|       - |  135 | `/*` |
|       - |  136 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|       - |  137 | ` */` |
| 2995826 |  138 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|       2 |  139 |  |
|       - |  140 | `	/* Link */` |
| 2995828 |  141 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
| 2727224 |  142 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
| 2727224 |  143 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
| 1363611 |  144 | `	}` |
| 2995828 |  145 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|       - |  146 | `	/* Link to the map list */` |
| 2995828 |  147 | `	if( pMap->pFirst == 0 ){` |
|   47288 |  148 | `		pMap->pFirst = pMap->pLast = pNode;` |
|       - |  149 | `		/* Point to the first inserted node */` |
|   47288 |  150 | `		pMap->pCur = pNode;` |
|   23645 |  151 | `	}else{` |
| 2948542 |  152 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|       - |  153 | `	}` |
| 2995828 |  154 | `	++pMap->nEntry;` |
| 2995828 |  155 |  |
|       - |  156 | `/*` |
|       - |  157 | ` * Unlink a node from the hashmap.` |
|       - |  158 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|       - |  159 | ` */` |
|    7264 |  160 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|       2 |  161 |  |
|    7266 |  162 | `	ph7_hashmap *pMap = pNode->pMap;` |
|    7266 |  163 | `	ph7_vm *pVm = pMap->pVm;` |
|       - |  164 | `	/* Unlink from the corresponding bucket */` |
|    7266 |  165 | `	if( pNode->pPrevCollide == 0 ){` |
|    6818 |  166 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|    3410 |  167 | `	}else{` |
|     449 |  168 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|       - |  169 | `	}` |
|    7266 |  170 | `	if( pNode->pNextCollide ){` |
|    5600 |  171 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|    2799 |  172 | `	}` |
|    7266 |  173 | `	if( pMap->pFirst == pNode ){` |
|      82 |  174 | `		pMap->pFirst = pNode->pPrev;` |
|      40 |  175 | `	}` |
|    7266 |  176 | `	if( pMap->pCur == pNode ){` |
|       - |  177 | `		/* Advance the node cursor */` |
|      84 |  178 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|      41 |  179 | `	}` |
|       - |  180 | `	/* Unlink from the map list */` |
|    7266 |  181 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|    7266 |  182 | `	if( bRestore ){` |
...
|      51 |  188 | `		}` |
|      51 |  189 | `	}` |
|    7266 |  190 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|    7140 |  191 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|    3569 |  192 | `	}` |
|    7266 |  193 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|    7266 |  194 | `	pMap->nEntry--;` |
|    7266 |  195 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|       - |  206 | ` */` |
| 2995826 |  207 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|       2 |  208 |  |
| 2995828 |  209 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|   51448 |  210 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|       - |  211 | `		ph7_hashmap_node *pEntry,**apNew;` |
|   51448 |  212 | `		sxu32 nNew = pMap->nSize << 1;` |
|       - |  213 | `		sxu32 nBucket;` |
|       - |  214 | `		sxu32 n;` |
|   51448 |  215 | `		if( nNew < 1 ){` |
|   47288 |  216 | `			nNew = 16;` |
...
|   51448 |  219 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|   51448 |  220 | `		if( apNew == 0 ){` |
...
|       - |  226 | `		}` |
|       - |  227 | `		/* Zero the table */` |
|   51448 |  228 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|       - |  229 | `		/* Reflect the change */` |
|   51448 |  230 | `		pMap->apBucket = apNew;` |
|   51448 |  231 | `		pMap->nSize = nNew;` |
|   51448 |  232 | `		if( apOld == 0 ){` |
|       - |  233 | `			/* First allocated table [i.e: no entry],return immediately */` |
|   47288 |  234 | `			return SXRET_OK;` |
|       - |  235 | `		}` |
...
|    2080 |  258 | `	}` |
| 2948542 |  259 | `	return SXRET_OK;` |
| 1497915 |  260 |  |
|       - |  261 | `/*` |
|       - |  262 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|       - |  263 | ` * hashmap.` |
|       - |  264 | ` */` |
| 2897538 |  265 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  266 |  |
|       - |  267 | `	ph7_hashmap_node *pNode;` |
|       - |  268 | `	sxu32 nIdx;` |
|       - |  269 | `	sxu32 nHash;` |
|       - |  270 | `	sxi32 rc;` |
| 2897540 |  271 | `	if( !isForeign ){` |
|       - |  272 | `		ph7_value *pObj;` |
|       - |  273 | `		/* Reserve a ph7_value for the value */` |
| 2897514 |  274 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
| 2897514 |  275 | `		if( pObj == 0 ){` |
|     ! 0 |  276 | `			return SXERR_MEM;` |
|       - |  277 | `		}` |
| 2897514 |  278 | `		if( pValue ){` |
|       - |  279 | `			/* Duplicate the value */` |
| 2897514 |  280 | `			PH7_MemObjStore(pValue,pObj);` |
| 1448756 |  281 | `		}` |
| 2897514 |  282 | `		nIdx = pObj->nIdx;` |
| 1448758 |  283 | `	}else{` |
|      27 |  284 | `		nIdx = nRefIdx;` |
|       - |  285 | `	}` |
|       - |  286 | `	/* Hash the key */` |
| 2897540 |  287 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  288 | `	/* Allocate a new int node */` |
| 2897540 |  289 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
| 2897540 |  290 | `	if( pNode == 0 ){` |
|     ! 0 |  291 | `		return SXERR_MEM;` |
|       - |  292 | `	}` |
| 2897540 |  293 | `	if( isForeign ){` |
...
| 2897540 |  298 | `	rc = HashmapGrowBucket(&(*pMap));` |
| 2897540 |  299 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  300 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  301 | `		return rc;` |
|       - |  302 | `	}` |
|       - |  303 | `	/* Perform the insertion */` |
| 2897540 |  304 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  305 | `	/* Install in the reference table */` |
| 2897540 |  306 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  307 | `	/* All done */` |
| 2897540 |  308 | `	return SXRET_OK;` |
| 1448771 |  309 |  |
|       - |  310 | `/*` |
|       - |  311 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|       - |  312 | ` * hashmap.` |
|       - |  313 | ` */` |
|   98288 |  314 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  315 |  |
|       - |  316 | `	ph7_hashmap_node *pNode;` |
|       - |  317 | `	sxu32 nHash;` |
|       - |  318 | `	sxu32 nIdx;` |
|       - |  319 | `	sxi32 rc;` |
|   98290 |  320 | `	if( !isForeign ){` |
|       - |  321 | `		ph7_value *pObj;` |
|       - |  322 | `		/* Reserve a ph7_value for the value */` |
|   66842 |  323 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   66842 |  324 | `		if( pObj == 0 ){` |
|     ! 0 |  325 | `			return SXERR_MEM;` |
|       - |  326 | `		}` |
|   66842 |  327 | `		if( pValue ){` |
|       - |  328 | `			/* Duplicate the value */` |
|   66570 |  329 | `			PH7_MemObjStore(pValue,pObj);` |
|   33284 |  330 | `		}` |
|   66842 |  331 | `		nIdx = pObj->nIdx;` |
|   33422 |  332 | `	}else{` |
|   31450 |  333 | `		nIdx = nRefIdx;` |
|       - |  334 | `	}` |
|       - |  335 | `	/* Hash the key */` |
|   98290 |  336 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  337 | `	/* Allocate a new blob node */` |
|   98290 |  338 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|   98290 |  339 | `	if( pNode == 0 ){` |
|     ! 0 |  340 | `		return SXERR_MEM;` |
|       - |  341 | `	}` |
|   98290 |  342 | `	if( isForeign ){` |
|       - |  343 | `		/* Mark as a foregin entry */` |
|   31450 |  344 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|   15724 |  345 | `	}` |
|       - |  346 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|   98290 |  347 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   98290 |  348 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  349 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  350 | `		return rc;` |
|       - |  351 | `	}` |
|       - |  352 | `	/* Perform the insertion */` |
|   98290 |  353 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  354 | `	/* Install in the reference table */` |
|   98290 |  355 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  356 | `	/* All done */` |
|   98290 |  357 | `	return SXRET_OK;` |
|   49146 |  358 |  |
|       - |  359 | `/*` |
...
|       - |  363 | ` */` |
|   47626 |  364 | `static sxi32 HashmapLookupIntKey(` |
...
|       - |  371 | `	sxu32 nHash;` |
|   47628 |  372 | `	if( pMap->nEntry < 1 ){` |
|       - |  373 | `		/* Don't bother hashing,there is no entry anyway */` |
|     432 |  374 | `		return SXERR_NOTFOUND;` |
|       - |  375 | `	}` |
|       - |  376 | `	/* Hash the key first */` |
|   47198 |  377 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  378 | `	/* Point to the appropriate bucket */` |
|   47198 |  379 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  380 | `	/* Perform the lookup */` |
|  411953 |  381 | `	for(;;){` |
|  823908 |  382 | `		if( pNode == 0 ){` |
|   45952 |  383 | `			break;` |
|       - |  384 | `		}` |
|  778579 |  385 | `		if( pNode->iType == HASHMAP_INT_NODE` |
|  774941 |  386 | `			&& pNode->nHash == nHash` |
|  386588 |  387 | `			&& pNode->xKey.iKey == iKey ){` |
|       - |  388 | `				/* Node found */` |
|    1248 |  389 | `				if( ppNode ){` |
|    1236 |  390 | `					*ppNode = pNode;` |
|     617 |  391 | `				}` |
|    1248 |  392 | `				return SXRET_OK;` |
|       - |  393 | `		}` |
...
|       - |  404 | ` */` |
|  195792 |  405 | `static sxi32 HashmapLookupBlobKey(` |
...
|       - |  413 | `	sxu32 nHash;` |
|  195794 |  414 | `	if( pMap->nEntry < 1 ){` |
|       - |  415 | `		/* Don't bother hashing,there is no entry anyway */` |
|   11438 |  416 | `		return SXERR_NOTFOUND;` |
|       - |  417 | `	}` |
|       - |  418 | `	/* Hash the key first */` |
|  184358 |  419 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  420 | `	/* Point to the appropriate bucket */` |
|  184358 |  421 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  422 | `	/* Perform the lookup */` |
|  171988 |  423 | `	for(;;){` |
|  343978 |  424 | `		if( pNode == 0 ){` |
|  140902 |  425 | `			break;` |
|       - |  426 | `		}` |
|  224804 |  427 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|  201577 |  428 | `			&& pNode->nHash == nHash` |
|  121767 |  429 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|   43458 |  430 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|       - |  431 | `				/* Node found */` |
|   43458 |  432 | `				if( ppNode ){` |
|   43430 |  433 | `					*ppNode = pNode;` |
|   21714 |  434 | `				}` |
|   43458 |  435 | `				return SXRET_OK;` |
|       - |  436 | `		}` |
|       - |  437 | `		/* Follow the collision link */` |
|  159622 |  438 | `		pNode = pNode->pNextCollide;` |
|       2 |  439 | `	}` |
|       - |  440 | `	/* No such entry */` |
|  140902 |  441 | `	return SXERR_NOTFOUND;` |
|   97898 |  442 |  |
|       - |  443 | `/*` |
|       - |  444 | ` * Check if the given BLOB key looks like a decimal number.` |
|       - |  445 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|       - |  446 | ` */` |
|  195934 |  447 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|       2 |  448 |  |
|  195936 |  449 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|  195936 |  450 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|  195936 |  451 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|       - |  452 | `		/* Octal not decimal number */` |
|       5 |  453 | `		return FALSE;` |
|       - |  454 | `	}` |
|  195932 |  455 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|     ! 0 |  456 | `		zIn++;` |
|     ! 0 |  457 | `	}` |
|   98298 |  458 | `	for(;;){` |
|  196598 |  459 | `		if( zIn >= zEnd ){` |
|     233 |  460 | `			return TRUE;` |
|       - |  461 | `		}` |
|  196366 |  462 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|   97851 |  463 | `			break;` |
|       - |  464 | `		}` |
|     667 |  465 | `		zIn++;` |
|       1 |  466 | `	}` |
|       - |  467 | `	/* Key does not look like a decimal number */` |
|  195700 |  468 | `	return FALSE;` |
|   97969 |  469 |  |
|       - |  470 | `/*` |
...
|       - |  474 | ` */` |
|   98582 |  475 | `static sxi32 HashmapLookup(` |
|       - |  476 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|       - |  477 | `	ph7_value *pKey,            /* Lookup key */` |
|       - |  478 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|       - |  479 | `	)` |
|       2 |  480 |  |
|   98584 |  481 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|       - |  482 | `	sxi32 rc;` |
|   98584 |  483 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   97468 |  484 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  485 | `			/* Force a string cast */` |
|     ! 0 |  486 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  487 | `		}` |
|   97468 |  488 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|       - |  489 | `			/* Perform a blob lookup */` |
|   97452 |  490 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|   97452 |  491 | `			goto result;` |
|       - |  492 | `		}` |
|       8 |  493 | `	}` |
|       - |  494 | `	/* Perform an int lookup */` |
|    1134 |  495 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|       - |  496 | `		/* Force an integer cast */` |
|      27 |  497 | `		PH7_MemObjToInteger(pKey);` |
|      13 |  498 | `	}` |
|       - |  499 | `	/* Perform an int lookup */` |
|    1134 |  500 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|   49291 |  501 | `result:` |
|   98584 |  502 | `	if( rc == SXRET_OK ){` |
|       - |  503 | `		/* Node found */` |
|   44466 |  504 | `		if( ppNode ){` |
|   44432 |  505 | `			*ppNode = pNode;` |
|   22215 |  506 | `		}` |
|   44466 |  507 | `		return SXRET_OK;` |
|       - |  508 | `	}` |
|       - |  509 | `	/* No such entry */` |
|   54120 |  510 | `	return SXERR_NOTFOUND;` |
|   49293 |  511 |  |
|       - |  512 | `/*` |
...
|       - |  517 | ` */` |
| 2964052 |  518 | `static sxi32 HashmapInsert(` |
|       - |  519 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|       - |  520 | `	ph7_value *pKey,   /* Lookup key  */` |
|       - |  521 | `	ph7_value *pVal    /* Node value */` |
|       - |  522 | `	)` |
|       2 |  523 |  |
| 2964054 |  524 | `	ph7_hashmap_node *pNode = 0;` |
| 2964054 |  525 | `	sxi32 rc = SXRET_OK;` |
| 2964054 |  526 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   67054 |  527 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  528 | `			/* Force a string cast */` |
|       3 |  529 | `			PH7_MemObjToString(&(*pKey));` |
|       1 |  530 | `		}` |
|   67054 |  531 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     256 |  536 | `			goto IntKey;` |
|       - |  537 | `		}` |
|  100199 |  538 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   33399 |  539 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|       - |  552 | `		}` |
|   66746 |  553 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  554 | `			/* Forbidden */` |
...
|   66744 |  559 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|   66744 |  560 | `		return rc;` |
|       - |  561 | `	}` |
| 1448500 |  562 | `IntKey:` |
| 2897256 |  563 | `	if( pKey ){` |
...
|   11644 |  598 | `		}` |
|   11646 |  599 | `	}else{` |
| 2873886 |  600 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  601 | `			/* Forbidden */` |
...
| 2873884 |  606 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
| 2873884 |  607 | `		if( rc == SXRET_OK ){` |
| 2873884 |  608 | `			++pMap->iNextIdx;` |
| 1436941 |  609 | `		}` |
|       - |  610 | `	}` |
|       - |  611 | `	/* Insertion result */` |
| 2897172 |  612 | `	return rc;` |
| 1482028 |  613 |  |
|       - |  614 | `/*` |
...
|       - |  640 | ` */` |
|   31480 |  641 | `static sxi32 HashmapInsertByRef(` |
|       - |  642 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|       - |  643 | `	ph7_value *pKey,     /* Lookup key */` |
|       - |  644 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|       - |  645 | `	)` |
|       2 |  646 |  |
|   31482 |  647 | `	ph7_hashmap_node *pNode = 0;` |
|   31482 |  648 | `	sxi32 rc = SXRET_OK;` |
|   31482 |  649 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   31456 |  650 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  651 | `			/* Force a string cast */` |
|     ! 0 |  652 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  653 | `		}` |
|   31456 |  654 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     ! 0 |  659 | `			goto IntKey;` |
|       - |  660 | `		}` |
|   47183 |  661 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   15727 |  662 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|       - |  663 | `				/* Overwrite */` |
...
|   31450 |  671 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|   31450 |  672 | `		return rc;` |
|       - |  673 | `	}` |
|      13 |  674 | `IntKey:` |
|      27 |  675 | `	if( pKey ){` |
...
|       - |  712 | ` */` |
| 1077991 |  713 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       2 |  714 |  |
|       - |  715 | `	/* Point to the desired object */` |
|       - |  716 | `	ph7_value *pObj;` |
| 1077993 |  717 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
| 1077993 |  718 | `	return pObj;` |
|       2 |  719 |  |
|       - |  720 | `/*` |
...
|       - |  762 | ` * documenation.` |
|       - |  763 | ` */` |
|   48560 |  764 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       2 |  765 |  |
|       - |  766 | `	ph7_value sObj1,sObj2;` |
|       - |  767 | `	sxi32 rc;` |
|   48562 |  768 | `	if( pLeft == pRight ){` |
|       - |  769 | `		/*` |
...
|   48562 |  776 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   48562 |  777 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   48562 |  778 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   48562 |  779 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   48562 |  780 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   48562 |  781 | `	PH7_MemObjRelease(&sObj1);` |
|   48562 |  782 | `	PH7_MemObjRelease(&sObj2);` |
|   48562 |  783 | `	return rc;` |
|   24297 |  784 |  |
|       - |  785 | `/*` |
...
|       - |  788 | ` */` |
|   10216 |  789 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|       2 |  790 |  |
|   10218 |  791 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|       - |  792 | `	sxu32 nBucket;` |
|       - |  793 | `	/* Remove old collision links */` |
|   10218 |  794 | `	if( pEntry->pPrevCollide ){` |
|    8207 |  795 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|    4109 |  796 | `	}else{` |
|    2013 |  797 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|       - |  798 | `	}` |
|   10218 |  799 | `	if( pEntry->pNextCollide ){` |
|     841 |  800 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|     421 |  801 | `	}` |
|   10218 |  802 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  803 | `	/* Compute the new hash */` |
|   10218 |  804 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|   10218 |  805 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|   10218 |  806 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|       - |  807 | `	/* Link to the new bucket */` |
|   10218 |  808 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   10218 |  809 | `	if( pMap->apBucket[nBucket] ){` |
|    8429 |  810 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|    4226 |  811 | `	}` |
|   10218 |  812 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   10218 |  813 | `	pMap->apBucket[nBucket] = pEntry;` |
|       - |  814 | `	/* Increment the automatic index */` |
|   10218 |  815 | `	pMap->iNextIdx++;` |
|   10218 |  816 |  |
|       - |  817 | `/*` |
...
|       - |  823 | ` */` |
|   25686 |  824 | `static int HashmapFindValue(` |
...
|   25688 |  837 | `	pEntry = pMap->pFirst;` |
|   25688 |  838 | `	n = pMap->nEntry;` |
|   25688 |  839 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|   25688 |  840 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|   61608 |  841 | `	for(;;){` |
|  123219 |  842 | `		if( n < 1 ){` |
|      99 |  843 | `			break;` |
|       - |  844 | `		}` |
|       - |  845 | `		/* Extract node value */` |
|  123121 |  846 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  123121 |  847 | `		if( pVal ){` |
|  123121 |  848 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  858 | `			}else{` |
|       - |  859 | `				/* Duplicate value */` |
|  123121 |  860 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  123121 |  861 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  123121 |  862 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  123121 |  863 | `				PH7_MemObjRelease(&sVal);` |
|  123121 |  864 | `				PH7_MemObjRelease(&sNeedle);` |
|  123121 |  865 | `				if( rc == 0 ){` |
|   25590 |  866 | `					if( ppNode ){` |
|      23 |  867 | `						*ppNode = pEntry;` |
|      11 |  868 | `					}` |
|       - |  869 | `					/* Match found*/` |
|   25590 |  870 | `					return SXRET_OK;` |
|       - |  871 | `				}` |
|       - |  872 | `			}` |
|   48765 |  873 | `		}` |
|       - |  874 | `		/* Point to the next entry */` |
|   97533 |  875 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|   97533 |  876 | `		n--;` |
|       2 |  877 | `	}` |
|       - |  878 | `	/* No such entry */` |
...
|       - | 1053 | ` */` |
|  521758 | 1054 | `static sxi32 HashmapDuplicateNode(` |
...
|       - | 1059 | `	)` |
|       2 | 1060 |  |
|  521760 | 1061 | `	ph7_value sSafeVal = *pVal;` |
|       - | 1062 | `	ph7_value sKey;` |
|       - | 1063 | `	sxi32 rc;` |
|       - | 1064 |  |
|  521760 | 1065 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      30 | 1071 | `	}else{` |
|       - | 1072 | `		/* Int key */` |
|  521702 | 1073 | `		if( iAction == 0 ){ /* Merge */` |
|  521484 | 1074 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|  260961 | 1075 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|  523364 | 1112 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|       - | 1113 | `		/* Extract the node value */` |
|  521500 | 1114 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  521500 | 1115 | `		if( pVal ){` |
...
|       - | 1120 | `			 */` |
|  521500 | 1121 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|  260751 | 1122 | `		}else{` |
|     ! 0 | 1123 | `			rc = SXRET_OK;` |
|       - | 1124 | `		}` |
|  521500 | 1125 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1126 | `			return rc;` |
|       - | 1127 | `		}` |
|       - | 1128 | `		/* Point to the next entry */` |
|  521500 | 1129 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  260751 | 1130 | `	}` |
...
|       - | 1218 | ` */` |
|  175752 | 1219 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|       2 | 1220 |  |
|  175754 | 1221 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - | 1222 | `	ph7_hashmap *pNew;` |
|       - | 1223 | `	ph7_value *pBacking;` |
|  175754 | 1224 | `	if( pMap->iRef < 2 ){` |
|       - | 1225 | `		/* Sole owner, no separation needed */` |
|  173718 | 1226 | `		return pMap;` |
|       - | 1227 | `	}` |
...
|       - | 1372 | ` */` |
|   74298 | 1373 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|   74300 | 1381 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|   74300 | 1382 | `	if( pMap == 0 ){` |
|     ! 0 | 1383 | `		return 0;` |
|       - | 1384 | `	}` |
|       - | 1385 | `	/* Zero the structure */` |
|   74300 | 1386 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|       - | 1387 | `	/* Fill in the structure */` |
|   74300 | 1388 | `	pMap->pVm = &(*pVm);` |
|   74300 | 1389 | `	pMap->iRef = 1;` |
|       - | 1390 | `	/* Default hash functions */` |
|   74300 | 1391 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|   74300 | 1392 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|   74300 | 1393 | `	return pMap;` |
|   37151 | 1394 |  |
|       - | 1395 | `/*` |
...
|       - | 1413 | `*    $_ENV` |
|       - | 1414 | `*/` |
|    2422 | 1415 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|       2 | 1416 |  |
...
|    2424 | 1435 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    2424 | 1436 | `	if( pMap == 0 ){` |
|     ! 0 | 1437 | `		return SXERR_MEM;` |
|       - | 1438 | `	}` |
|    2424 | 1439 | `	pVm->pGlobal = pMap;` |
|       - | 1440 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|    2424 | 1441 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|    2424 | 1442 | `	if( pObj == 0 ){` |
|     ! 0 | 1443 | `		return SXERR_MEM;` |
|       - | 1444 | `	}` |
|    2424 | 1445 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|       - | 1446 | `	/* Record object index */` |
|    2424 | 1447 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|       - | 1448 | `	/* Install the special $GLOBALS array */` |
|    2424 | 1449 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|    2424 | 1450 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 1451 | `		return rc;` |
|       - | 1452 | `	}` |
|       - | 1453 | `	/* Install superglobals now */` |
|   26644 | 1454 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|       - | 1455 | `		ph7_value *pSuper;` |
|       - | 1456 | `		/* Request an empty array */` |
|   24222 | 1457 | `		pSuper = ph7_new_array(&(*pVm));` |
|   24222 | 1458 | `		if( pSuper == 0 ){` |
|     ! 0 | 1459 | `			return SXERR_MEM;` |
|       - | 1460 | `		}` |
|       - | 1461 | `		/* Install */` |
|   24222 | 1462 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|   24222 | 1463 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1464 | `			return rc;` |
|       - | 1465 | `		}` |
|       - | 1466 | `		/* Release the value now it have been installed */` |
|   24222 | 1467 | `		ph7_release_value(&(*pVm),pSuper);` |
|   12112 | 1468 | `	}` |
|       - | 1469 | `	/* Set some $_SERVER entries */` |
|    2424 | 1470 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       - | 1471 | `	/*` |
|       - | 1472 | `	 * 'SCRIPT_FILENAME'` |
|       - | 1473 | `	 * The absolute pathname of the currently executing script.` |
|       - | 1474 | `	 */` |
|    4842 | 1475 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|       - | 1476 | `		"SCRIPT_FILENAME",` |
|    1211 | 1477 | `		pFile ? pFile->zString : ":Memory:",` |
|    2418 | 1478 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|       - | 1479 | `		);` |
|       - | 1480 | `	/* All done,all super-global are installed now */` |
|    2424 | 1481 | `	return SXRET_OK;` |
|    1213 | 1482 |  |
|       - | 1483 | `/*` |
|       - | 1484 | ` * Release a hashmap.` |
|       - | 1485 | ` */` |
|   47510 | 1486 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|       2 | 1487 |  |
|       - | 1488 | `	ph7_hashmap_node *pEntry,*pNext;` |
|   47512 | 1489 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1490 | `	sxu32 n;` |
|   47512 | 1491 | `	if( pMap == pVm->pGlobal ){` |
...
|   47512 | 1497 | `	n = 0;` |
|   47512 | 1498 | `	pEntry = pMap->pFirst;` |
| 1501469 | 1499 | `	for(;;){` |
| 3002940 | 1500 | `		if( n >= pMap->nEntry ){` |
|   47512 | 1501 | `			break;` |
|       - | 1502 | `		}` |
| 2955430 | 1503 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|       - | 1504 | `		/* Remove the reference from the foreign table */` |
| 2955430 | 1505 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
| 2955430 | 1506 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|       - | 1507 | `			/* Restore the ph7_value to the free list */` |
| 2955422 | 1508 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
| 1477710 | 1509 | `		}` |
|       - | 1510 | `		/* Release the node */` |
| 2955430 | 1511 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|   63186 | 1512 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|   31592 | 1513 | `		}` |
| 2955430 | 1514 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|       - | 1515 | `		/* Point to the next entry */` |
| 2955430 | 1516 | `		pEntry = pNext;` |
| 2955430 | 1517 | `		n++;` |
|       2 | 1518 | `	}` |
|   47512 | 1519 | `	if( pMap->nEntry > 0 ){` |
|       - | 1520 | `		/* Release the hash bucket */` |
|   42234 | 1521 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|   21116 | 1522 | `	}` |
|   47512 | 1523 | `	if( FreeDS ){` |
|       - | 1524 | `		/* Free the whole instance */` |
|   47496 | 1525 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|   23749 | 1526 | `	}else{` |
...
|       - | 1539 | ` */` |
|  532706 | 1540 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|       2 | 1541 |  |
|  532708 | 1542 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1543 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|  532708 | 1544 | `	pMap->iRef--;` |
|  532708 | 1545 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|   47496 | 1546 | `		PH7_HashmapRelease(pMap,TRUE);` |
|   23747 | 1547 | `	}` |
|  532708 | 1548 |  |
|       - | 1549 | `/*` |
...
|       - | 1553 | ` */` |
|   98612 | 1554 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|       - | 1574 | ` */` |
| 2442358 | 1575 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|       2 | 1580 |  |
|       - | 1581 | `	sxi32 rc;` |
| 2442360 | 1582 | `	if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP) && (ph7_hashmap *)pVal->x.pOther == pMap->pVm->pGlobal ){` |
|       - | 1583 | `		/*` |
...
|       - | 1588 | `	}` |
| 2442360 | 1589 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
| 2442360 | 1590 | `	return rc;` |
| 1221181 | 1591 |  |
|       - | 1592 | `/*` |
...
|       - | 1618 | ` */` |
|   31480 | 1619 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|       2 | 1624 |  |
|       - | 1625 | `	sxi32 rc;` |
|   31482 | 1626 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
|       - | 1627 | `		/*` |
...
|       - | 1632 | `	}` |
|   31482 | 1633 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|   31482 | 1634 | `	return rc;` |
|   15742 | 1635 |  |
|       - | 1636 | `/*` |
|       - | 1637 | ` * Reset the node cursor of a given hashmap.` |
|       - | 1638 | ` */` |
|   21298 | 1639 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|       2 | 1640 |  |
|       - | 1641 | `	/* Reset the loop cursor */` |
|   21300 | 1642 | `	pMap->pCur = pMap->pFirst;` |
|   21300 | 1643 |  |
|       - | 1644 | `/*` |
...
|       - | 1649 | ` */` |
|  173644 | 1650 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|       2 | 1651 |  |
|  173646 | 1652 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|  173646 | 1653 | `	if( pCur == 0 ){` |
|       - | 1654 | `		/* End of the list,return null */` |
|   10670 | 1655 | `		return 0;` |
|       - | 1656 | `	}` |
|       - | 1657 | `	/* Advance the node cursor */` |
|  162978 | 1658 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|  162978 | 1659 | `	return pCur;` |
|   86824 | 1660 |  |
|       - | 1661 | `/*` |
|       - | 1662 | ` * Extract a node value.` |
|       - | 1663 | ` */` |
|  409274 | 1664 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       2 | 1665 |  |
|  409276 | 1666 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  409276 | 1667 | `	if( pEntry ){` |
|  409276 | 1668 | `		if( bStore ){` |
|  163112 | 1669 | `			PH7_MemObjStore(pEntry,pValue);` |
|   81557 | 1670 | `		}else{` |
|  246166 | 1671 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1672 | `		}` |
|  204669 | 1673 | `	}else{` |
...
|       - | 1679 | ` */` |
|  104980 | 1680 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|       2 | 1681 |  |
|       - | 1682 | `	/* Fill with the current key */` |
|  104982 | 1683 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|  104702 | 1684 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|      17 | 1685 | `			SyBlobRelease(&pKey->sBlob);` |
|       8 | 1686 | `		}` |
|  104702 | 1687 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|  104702 | 1688 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|   52352 | 1689 | `	}else{` |
...
|       - | 1740 | `**   changed.` |
|       - | 1741 | `*/` |
|   28882 | 1742 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|       2 | 1743 |  |
|       - | 1744 | `	ph7_hashmap_node result,*pTail;` |
|       - | 1745 | `    /* Prevent compiler warning */` |
|   28884 | 1746 | `	result.pNext = result.pPrev = 0;` |
|   28884 | 1747 | `	pTail = &result;` |
|   77526 | 1748 | `	while( pA && pB ){` |
|   48644 | 1749 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|   31882 | 1750 | `			pTail->pPrev = pA;` |
|   31882 | 1751 | `			pA->pNext = pTail;` |
|   31882 | 1752 | `			pTail = pA;` |
|   31882 | 1753 | `			pA = pA->pPrev;` |
|   15943 | 1754 | `		}else{` |
|   16764 | 1755 | `			pTail->pPrev = pB;` |
|   16764 | 1756 | `			pB->pNext = pTail;` |
|   16764 | 1757 | `			pTail = pB;` |
|   16764 | 1758 | `			pB = pB->pPrev;` |
|       - | 1759 | `		}` |
|       2 | 1760 | `	}` |
|   28884 | 1761 | `	if( pA ){` |
|   21092 | 1762 | `		pTail->pPrev = pA;` |
|   21092 | 1763 | `		pA->pNext = pTail;` |
|   18343 | 1764 | `	}else if( pB ){` |
|    7596 | 1765 | `		pTail->pPrev = pB;` |
|    7596 | 1766 | `		pB->pNext = pTail;` |
|    3795 | 1767 | `	}else{` |
|     200 | 1768 | `		pTail->pPrev = pTail->pNext = 0;` |
|       - | 1769 | `	}` |
|   28884 | 1770 | `	return result.pPrev;` |
|       2 | 1771 |  |
|       - | 1772 | `/*` |
|       - | 1773 | `** Inputs:` |
...
|   10968 | 1791 | `	while( pIn ){` |
|   10334 | 1792 | `		p = pIn;` |
|   10334 | 1793 | `		pIn = p->pPrev;` |
|   10334 | 1794 | `		p->pPrev = 0;` |
|   19562 | 1795 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|   19562 | 1796 | `			if( a[i]==0 ){` |
|   10334 | 1797 | `				a[i] = p;` |
|   10334 | 1798 | `				break;` |
|     ! 0 | 1799 | `			}else{` |
|    9230 | 1800 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|    9230 | 1801 | `				a[i] = 0;` |
|       - | 1802 | `			}` |
|    4616 | 1803 | `		}` |
|   10334 | 1804 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       - | 1825 | ` */` |
|   48512 | 1826 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       2 | 1827 |  |
|       - | 1828 | `	ph7_value sA,sB;` |
|       - | 1829 | `	sxi32 iFlags;` |
|       - | 1830 | `	int rc;` |
|   48514 | 1831 | `	if( pCmpData == 0 ){` |
|       - | 1832 | `		/* Perform a standard comparison */` |
|   48490 | 1833 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   48490 | 1834 | `		return rc;` |
|       - | 1835 | `	}` |
...
|       2 | 2124 | `		}` |
|   10164 | 2125 | `		HashmapRehashIntNode(p);` |
|       - | 2126 | `		/* Point to the next entry */` |
|   10164 | 2127 | `		i++;` |
|   10164 | 2128 | `		pLast = p;` |
|   10164 | 2129 | `		p = p->pPrev; /* Reverse link */` |
|       2 | 2130 | `	}` |
|     588 | 2131 |  |
|       - | 2132 | `/*` |
...
|       - | 3913 | ` */` |
|   25494 | 3914 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 3915 |  |
|       - | 3916 | `	ph7_value *pNeedle;` |
|       - | 3917 | `	int bStrict;` |
|       - | 3918 | `	int rc;` |
|   25496 | 3919 | `	if( nArg < 2 ){` |
|       - | 3920 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 3921 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 3922 | `		return PH7_OK;` |
|       - | 3923 | `	}` |
|   25496 | 3924 | `	pNeedle = apArg[0];` |
|   25496 | 3925 | `	bStrict = 0;` |
|   25496 | 3926 | `	if( nArg > 2 ){` |
|       5 | 3927 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|       2 | 3928 | `	}` |
|   25496 | 3929 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   25496 | 3937 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 3938 | `	/* Lookup result */` |
|   25496 | 3939 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   25496 | 3940 | `	return PH7_OK;` |
|   12749 | 3941 |  |
|       - | 3942 | `/*` |
...
|       - | 6865 | ` */` |
|    2422 | 6866 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|       2 | 6867 |  |
|       - | 6868 | `	sxu32 n;` |
|  150166 | 6869 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|  147744 | 6870 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|   73873 | 6871 | `	}` |
|    2424 | 6872 |  |
|       - | 6873 | `/*` |
...
|       - | 6961 | ` */` |
|   25788 | 6962 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|   25790 | 6973 | `	rc = SXRET_OK;` |
|   25790 | 6974 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|   25790 | 6975 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|   25790 | 6976 | `	n = pMap->nEntry;` |
|   25790 | 6977 | `	pEntry = pMap->pFirst;` |
...
|  104446 | 6984 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|  104446 | 6985 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|       - | 6986 | `		/* Invoke the user callback */` |
|  104446 | 6987 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|       - | 6988 | `		/* Release the copy of the key and the value */` |
|  104446 | 6989 | `		PH7_MemObjRelease(&sKey);` |
|  104446 | 6990 | `		PH7_MemObjRelease(&sValue);` |
|  104446 | 6991 | `		if( rc != PH7_OK ){` |
|       - | 6992 | `			/* Callback request an operation abort */` |
|     ! 0 | 6993 | `			return SXERR_ABORT;` |
|       - | 6994 | `		}` |
|       - | 6995 | `		/* Point to the next entry */` |
|  104446 | 6996 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  104446 | 6997 | `		n--;` |
|       2 | 6998 | `	}` |
|       - | 6999 | `	/* All done */` |
|   25790 | 7000 | `	return SXRET_OK;` |
|   12896 | 7001 |  |
|       - | 7002 |  |
