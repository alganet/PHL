...
Coverage: 1046/1148 lines (91.11%)
...
|         - |   22 | ` */` |
|   7936696 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7936701 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7936701 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    515803 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    515808 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    515808 |   35 | `	sxu32 nH = 5381;` |
|    515808 |   36 | `	zEnd = &zIn[nLen];` |
|    592435 |   37 | `	for(;;){` |
|   1184876 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1011422 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    909815 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
...
|         - |   98 | ` */` |
|   3627236 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3627241 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3627241 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3627241 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3627241 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3627241 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3627241 |  112 | `	pNode->nHash = nHash;` |
|   3627241 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3627241 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3627241 |  115 | `	return pNode;` |
|   1813623 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199511 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199516 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199516 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199516 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199516 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199516 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199516 |  135 | `	pNode->nHash = nHash;` |
|    199516 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199516 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199516 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199516 |  139 | `	return pNode;` |
|     99760 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3826747 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3826752 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3370597 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3370597 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1685298 |  150 | `	}` |
|   3826752 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3826752 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87960 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87960 |  156 | `		pMap->pCur = pNode;` |
|     43982 |  157 | `	}else{` |
|   3738797 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3826752 |  160 | `	if( pMap->pActiveSteps ){` |
...
|        11 |  172 | `		}` |
|         9 |  173 | `	}` |
|   3826752 |  174 | `	++pMap->nEntry;` |
|   3826752 |  175 | `}` |
|         - |  176 | `/*` |
|         - |  177 | ` * Unlink a node from the hashmap.` |
|         - |  178 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  179 | ` */` |
|      7404 |  180 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  181 | `{` |
|      7409 |  182 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7409 |  183 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  184 | `	/* Unlink from the corresponding bucket */` |
|      7409 |  185 | `	if( pNode->pPrevCollide == 0 ){` |
...
|         - |  189 | `	}` |
|      7409 |  190 | `	if( pNode->pNextCollide ){` |
|      4837 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2417 |  192 | `	}` |
|      7409 |  193 | `	if( pMap->pFirst == pNode ){` |
|       175 |  194 | `		pMap->pFirst = pNode->pPrev;` |
|        85 |  195 | `	}` |
|      7409 |  196 | `	if( pMap->pCur == pNode ){` |
|         - |  197 | `		/* Advance the node cursor */` |
|       211 |  198 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|       103 |  199 | `	}` |
|      7409 |  200 | `	if( pMap->pActiveSteps ){` |
...
|      7409 |  211 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|      7409 |  212 | `	if( bRestore ){` |
...
|       105 |  218 | `		}` |
|       105 |  219 | `	}` |
|      7409 |  220 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7164 |  221 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3580 |  222 | `	}` |
|      7409 |  223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7409 |  224 | `	pMap->nEntry--;` |
|      7409 |  225 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|         - |  236 | ` */` |
|   3826747 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3826752 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93420 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93420 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93420 |  245 | `		if( nNew < 1 ){` |
|     87960 |  246 | `			nNew = 16;` |
...
|     93420 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93420 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93420 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93420 |  260 | `		pMap->apBucket = apNew;` |
|     93420 |  261 | `		pMap->nSize = nNew;` |
|     93420 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87960 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5465 |  267 | `		pEntry = pMap->pFirst;` |
|      5465 |  268 | `		n = 0;` |
|   2536602 |  269 | `		for( ;; ){` |
|   5073209 |  270 | `			if( n >= pMap->nEntry ){` |
|      5465 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5067749 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5067749 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5067749 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4403807 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4403807 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2201901 |  280 | `			}` |
|   5067749 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5067749 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5067749 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5465 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2730 |  288 | `	}` |
|   3738797 |  289 | `	return SXRET_OK;` |
|   1913378 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3627236 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3627241 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3627199 |  310 | `		if( pValue ){` |
|   3627189 |  311 | `			sSafeVal = *pValue;` |
|   3627189 |  312 | `			pValue = &sSafeVal;` |
|   1813592 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3627199 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3627199 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3627199 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3627189 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1813592 |  322 | `		}` |
|   3627199 |  323 | `		nIdx = pObj->nIdx;` |
|   1813602 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3627241 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3627241 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3627241 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3627241 |  334 | `	if( isForeign ){` |
...
|   3627241 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3627241 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3627241 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3627241 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3627241 |  349 | `	return SXRET_OK;` |
|   1813623 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199511 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199516 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|     76595 |  384 | `	}else{` |
|     46335 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199516 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199516 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199516 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199516 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46335 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23165 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199516 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199516 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199516 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199516 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199516 |  409 | `	return SXRET_OK;` |
|     99760 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293514 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293519 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       865 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
...
| 110568683 |  433 | `	for(;;){` |
| 221137341 |  434 | `		if( pNode == 0 ){` |
|   4285277 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216852064 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216849048 |  438 | `			&& pNode->nHash == nHash` |
| 108426724 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7387 |  441 | `				if( ppNode ){` |
...
| 216844684 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
...
|         - |  456 | ` */` |
|    344905 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    344910 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28618 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    316297 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    316297 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256663 |  475 | `	for(;;){` |
|    513331 |  476 | `		if( pNode == 0 ){` |
|    250933 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262398 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260885 |  480 | `			&& pNode->nHash == nHash` |
|    162420 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65473 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65369 |  484 | `				if( ppNode ){` |
|     65341 |  485 | `					*ppNode = pNode;` |
|     32668 |  486 | `				}` |
|     65369 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    197039 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250933 |  493 | `	return SXERR_NOTFOUND;` |
|    172457 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    345285 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    345290 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    345290 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    345290 |  504 | `	int isNeg = FALSE, nDigit;` |
|    345290 |  505 | `	if( zIn >= zEnd ){` |
|        42 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    345250 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    345246 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    345246 |  516 | `	zDigit = zIn;` |
|    173259 |  517 | `	for(;;){` |
|    346524 |  518 | `		if( zIn >= zEnd ){` |
|       499 |  519 | `			break;` |
|         - |  520 | `		}` |
|    346026 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    344748 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|      1279 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    152980 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    152985 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    152985 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    145619 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|        17 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         8 |  559 | `		}` |
|    145619 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    145547 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    145547 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|     76490 |  575 | `result:` |
|    152985 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     71951 |  578 | `		if( ppNode ){` |
|     71897 |  579 | `			*ppNode = pNode;` |
|     35946 |  580 | `		}` |
|     71951 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     81039 |  584 | `	return SXERR_NOTFOUND;` |
|     76495 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  591 | ` */` |
|   2143050 |  592 | `static void HashmapAdvanceAutoIndex(ph7_hashmap *pMap,sxi64 iKey)` |
|         5 |  593 | `{` |
|   2143055 |  594 | `	if( !pMap->bIntKeySeen ){` |
...
|   2141865 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141865 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070933 |  609 | `	}` |
|   1071530 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1480378 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1480383 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1480377 |  623 | `	return FALSE;` |
|    740194 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3776485 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3776490 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3776490 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3776490 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153334 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    153334 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       419 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229371 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76455 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  654 | `				/* Overwrite the old value */` |
|         - |  655 | `				ph7_value *pElem;` |
|       494 |  656 | `				pElem = (ph7_value *)SySetAt(&pMap->pVm->aMemObj,pNode->nValIdx);` |
|       494 |  657 | `				if( pElem ){` |
|       494 |  658 | `					if( pVal ){` |
|       494 |  659 | `						PH7_MemObjStore(pVal,pElem);` |
|       249 |  660 | `					}else{` |
|         - |  661 | `						/* Nullify the entry */` |
|       ! 0 |  662 | `						PH7_MemObjToNull(pElem);` |
|         - |  663 | `					}` |
|       245 |  664 | `				}` |
|       494 |  665 | `				return SXRET_OK;` |
|         - |  666 | `		}` |
...
|   1811578 |  683 | `IntKey:` |
|   3623579 |  684 | `	if( pKey ){` |
|   2143235 |  685 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  686 | `			/* Force an integer cast */` |
|       438 |  687 | `			PH7_MemObjToInteger(pKey);` |
|       218 |  688 | `		}` |
|   2143235 |  689 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
...
|         - |  702 | `		}` |
|   2143051 |  703 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|   2143049 |  711 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   2143049 |  712 | `		if( rc == SXRET_OK ){` |
|   2143049 |  713 | `			HashmapAdvanceAutoIndex(&(*pMap),pKey->x.iVal);` |
|   1071522 |  714 | `		}` |
|   1071527 |  715 | `	}else{` |
|   1480349 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1480347 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1480341 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1480341 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1480339 |  726 | `			++pMap->iNextIdx;` |
|    740167 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3623385 |  730 | `	return rc;` |
|   1888247 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46382 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46387 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46387 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46387 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46347 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46347 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69515 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23170 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46335 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46335 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1503843 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1503848 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1503848 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  838 | ` */` |
|       566 |  839 | `PH7_PRIVATE sxi32 HashmapInsertNode(ph7_hashmap *pMap,ph7_hashmap_node *pNode,int bPreserve)` |
|         5 |  840 | `{` |
|         - |  841 | `	ph7_value *pObj;` |
|         - |  842 | `	sxi32 rc;` |
|         - |  843 | `	/* Extract the node value */` |
|       571 |  844 | `	pObj = HashmapExtractNodeValue(&(*pNode));` |
|       571 |  845 | `	if( pObj == 0 ){` |
|       ! 0 |  846 | `		return SXERR_EMPTY;` |
|         - |  847 | `	}` |
|       566 |  848 | `	if( (pNode->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|       570 |  849 | `	 \|\| PH7_VmSlotIsReferenced(pMap->pVm,pNode->nValIdx) ){` |
...
|         - |  871 | `	}` |
|         - |  872 | `	/* Preserve key */` |
|       569 |  873 | `	if( pNode->iType == HASHMAP_INT_NODE){` |
|         - |  874 | `		/* Int64 key */` |
|       437 |  875 | `		if( !bPreserve ){` |
|         - |  876 | `			/* Assign an automatic index */` |
|       263 |  877 | `			rc = HashmapInsert(&(*pMap),0,pObj);` |
|       134 |  878 | `		}else{` |
|       176 |  879 | `			rc = HashmapInsertIntKey(&(*pMap),pNode->xKey.iKey,pObj,0,FALSE);` |
|         - |  880 | `		}` |
|       221 |  881 | `	}else{` |
|         - |  882 | `		/* Blob key */` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77894 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77899 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77899 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77899 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77899 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77899 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77899 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77899 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77899 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77899 |  921 | `	return rc;` |
|     38823 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16806 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16811 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16811 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11830 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5801 |  934 | `	}else{` |
|      4986 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16811 |  937 | `	if( pEntry->pNextCollide ){` |
|      1091 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       566 |  939 | `	}` |
|     16811 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16811 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16811 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16811 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16811 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16811 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12150 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5970 |  949 | `	}` |
|     16811 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16811 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16811 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16811 |  956 | `		pMap->iNextIdx++;` |
|      8403 |  957 | `	}` |
|     16811 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     32806 |  966 | `PH7_PRIVATE int HashmapFindValue(` |
...
|     32811 |  979 | `	pEntry = pMap->pFirst;` |
|     32811 |  980 | `	n = pMap->nEntry;` |
|     32811 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32811 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78112 |  983 | `	for(;;){` |
|    156230 |  984 | `		if( n < 1 ){` |
|        85 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    156146 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156146 |  989 | `		if( pVal ){` |
...
|    156146 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156146 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156146 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156146 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156146 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156146 | 1001 | `			if( rc == 0 ){` |
...
|    123424 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123424 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1023 | ` */` |
|        28 | 1024 | `PH7_PRIVATE int HashmapFindValueByCallback(` |
...
|         - | 1034 | `	sxi32 rc;` |
|         - | 1035 | `	sxu32 n;` |
|        30 | 1036 | `	if( pMap->pVm->iCmpCallbackExc ){` |
...
|        30 | 1042 | `	pEntry = pMap->pFirst;` |
|        30 | 1043 | `	n = pMap->nEntry;` |
|         - | 1044 | `	/* Store callback result here */` |
|        30 | 1045 | `	PH7_MemObjInit(pMap->pVm,&sResult);` |
|         - | 1046 | `	/* First argument to the callback */` |
|        30 | 1047 | `	apArg[0] = pNeedle;` |
|        31 | 1048 | `	for(;;){` |
|        64 | 1049 | `		if( n < 1 ){` |
|        12 | 1050 | `			break;` |
|         - | 1051 | `		}` |
|         - | 1052 | `		/* Extract node value */` |
|        54 | 1053 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|        54 | 1054 | `		if( pVal ){` |
|         - | 1055 | `			/* Invoke the user callback */` |
|        54 | 1056 | `			apArg[1] = pVal; /* Second argument to the callback */` |
|        54 | 1057 | `			rc = PH7_VmCallUserFunction(pMap->pVm,pCallback,2,apArg,&sResult);` |
|        54 | 1058 | `			if( rc == PH7_EXCEPTION ){` |
...
|         - | 1064 | `			}` |
|        50 | 1065 | `			if( rc == SXRET_OK ){` |
|         - | 1066 | `				/* Extract callback result */` |
|        50 | 1067 | `				if( (sResult.iFlags & MEMOBJ_INT) == 0 ){` |
|         - | 1068 | `					/* Perform an int cast */` |
|       ! 0 | 1069 | `					PH7_MemObjToInteger(&sResult);` |
|       ! 0 | 1070 | `				}` |
|        50 | 1071 | `				rc = (sxi32)sResult.x.iVal;` |
|        50 | 1072 | `				PH7_MemObjRelease(&sResult);` |
|        50 | 1073 | `				if( rc == 0 ){` |
|         - | 1074 | `					/* Match found*/` |
|        16 | 1075 | `					if( ppNode ){` |
|       ! 0 | 1076 | `						*ppNode = pEntry;` |
|       ! 0 | 1077 | `					}` |
|        16 | 1078 | `					return SXRET_OK;` |
|         - | 1079 | `				}` |
|        17 | 1080 | `			}` |
|        17 | 1081 | `		}` |
|         - | 1082 | `		/* Point to the next entry */` |
|        36 | 1083 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|        36 | 1084 | `		n--;` |
|         2 | 1085 | `	}` |
|         - | 1086 | `	/* No such entry */` |
|        12 | 1087 | `	return SXERR_NOTFOUND;` |
|        16 | 1088 | `}` |
|         - | 1089 | `/*` |
...
|         - | 1135 | ` */` |
|        56 | 1136 | `PH7_PRIVATE sxi32 PH7_HashmapCmp(` |
...
|        36 | 1162 | `		ph7_hashmap_node *pLs = pLeft->pFirst;` |
|        36 | 1163 | `		ph7_hashmap_node *pRs = pRight->pFirst;` |
|        76 | 1164 | `		for( n = pLeft->nEntry ; n > 0 ; n-- ){` |
|         - | 1165 | `			/* Keys must match in type and value at this position */` |
|        56 | 1166 | `			if( pLs->iType != pRs->iType ){` |
|       ! 0 | 1167 | `				return 1;` |
|         - | 1168 | `			}` |
|        56 | 1169 | `			if( pLs->iType == HASHMAP_INT_NODE ){` |
|        34 | 1170 | `				if( pLs->xKey.iKey != pRs->xKey.iKey ){` |
|         3 | 1171 | `					return 1;` |
|         - | 1172 | `				}` |
|        17 | 1173 | `			}else{` |
...
|        48 | 1183 | `			if( HashmapNodeCmp(pLs,pRs,TRUE) != 0 ){` |
|         7 | 1184 | `				return 1;` |
|         - | 1185 | `			}` |
|        42 | 1186 | `			pLs = pLs->pPrev; /* Reverse link = insertion order */` |
|        42 | 1187 | `			pRs = pRs->pPrev;` |
|        22 | 1188 | `		}` |
|        22 | 1189 | `		return 0; /* Same pairs, same order */` |
|         - | 1190 | `	}` |
...
|         - | 1236 | ` */` |
|    707924 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    707924 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    707926 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    707921 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    707921 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2025 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    703881 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    700227 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    353770 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|        17 | 1290 | `		}else{ /* Dup */` |
|      3629 | 1291 | `			rc = HashmapInsertIntKey(pDest,pEntry->xKey.iKey,&sSafeVal,0,FALSE);` |
|         - | 1292 | `		}` |
|         - | 1293 | `	}` |
|    707921 | 1294 | `	return rc;` |
|    353967 | 1295 | `}` |
|         - | 1296 | `/*` |
...
|    703193 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    700287 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    700287 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    700287 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    350146 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    700287 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    700287 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    350146 | 1341 | `	}` |
...
|         - | 1392 | ` */` |
|      7310 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7315 | 1399 | `	if( pSrc == pDest ){` |
...
|      7315 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14913 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7603 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7603 | 1411 | `		if( pVal ){` |
|      7603 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3804 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7603 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7603 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3804 | 1421 | `	}` |
|      7315 | 1422 | `	return SXRET_OK;` |
|      3660 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    246166 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    246171 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    246171 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    246171 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    243337 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|        45 | 1647 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1648 | `			/* BLOB key */` |
|        24 | 1649 | `			if( SXRET_OK !=` |
...
|        45 | 1677 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|        25 | 1678 | `	}` |
...
|         - | 1684 | ` */` |
|    142136 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    142141 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142141 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    142141 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    142141 | 1700 | `	pMap->pVm = &(*pVm);` |
|    142141 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    142141 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142141 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142141 | 1705 | `	return pMap;` |
|     71073 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1725 | `*    $_ENV` |
|         - | 1726 | `*/` |
|      3404 | 1727 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|         5 | 1728 | `{` |
...
|      3409 | 1747 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|      3409 | 1748 | `	if( pMap == 0 ){` |
|       ! 0 | 1749 | `		return SXERR_MEM;` |
|         - | 1750 | `	}` |
|      3409 | 1751 | `	pVm->pGlobal = pMap;` |
|         - | 1752 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|      3409 | 1753 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|      3409 | 1754 | `	if( pObj == 0 ){` |
|       ! 0 | 1755 | `		return SXERR_MEM;` |
|         - | 1756 | `	}` |
|      3409 | 1757 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|         - | 1758 | `	/* Record object index */` |
|      3409 | 1759 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|         - | 1760 | `	/* Install the special $GLOBALS array */` |
|      3409 | 1761 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|      3409 | 1762 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1763 | `		return rc;` |
|         - | 1764 | `	}` |
|         - | 1765 | `	/* Install superglobals now */` |
|     37449 | 1766 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|         - | 1767 | `		ph7_value *pSuper;` |
|         - | 1768 | `		/* Request an empty array */` |
|     34045 | 1769 | `		pSuper = ph7_new_array(&(*pVm));` |
|     34045 | 1770 | `		if( pSuper == 0 ){` |
|       ! 0 | 1771 | `			return SXERR_MEM;` |
|         - | 1772 | `		}` |
|         - | 1773 | `		/* Install */` |
|     34045 | 1774 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|     34045 | 1775 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1776 | `			return rc;` |
|         - | 1777 | `		}` |
|         - | 1778 | `		/* Release the value now it have been installed */` |
|     34045 | 1779 | `		ph7_release_value(&(*pVm),pSuper);` |
|     17025 | 1780 | `	}` |
|         - | 1781 | `	/* Set some $_SERVER entries */` |
|      3409 | 1782 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|         - | 1783 | `	/*` |
|         - | 1784 | `	 * 'SCRIPT_FILENAME'` |
|         - | 1785 | `	 * The absolute pathname of the currently executing script.` |
|         - | 1786 | `	 */` |
|      6813 | 1787 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|         - | 1788 | `		"SCRIPT_FILENAME",` |
|      1702 | 1789 | `		pFile ? pFile->zString : ":Memory:",` |
|      3404 | 1790 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|         - | 1791 | `		);` |
|         - | 1792 | `	/* All done,all super-global are installed now */` |
|      3409 | 1793 | `	return SXRET_OK;` |
|      1707 | 1794 | `}` |
|         - | 1795 | `/*` |
|         - | 1796 | ` * Release a hashmap.` |
|         - | 1797 | ` */` |
|     94284 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94289 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94289 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94289 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94289 | 1821 | `	n = 0;` |
|     94289 | 1822 | `	pEntry = pMap->pFirst;` |
|   1905964 | 1823 | `	for(;;){` |
|   3811934 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94289 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3717650 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3717650 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3717650 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3717590 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1858792 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3717650 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109720 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54857 | 1837 | `		}` |
|   3717650 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3717650 | 1840 | `		pEntry = pNext;` |
|   3717650 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94289 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68318 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34156 | 1846 | `	}` |
|     94289 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94263 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47134 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    878060 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    878065 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    878065 | 1869 | `	pMap->iRef--;` |
|    878065 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94243 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47119 | 1872 | `	}` |
|    878065 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    153230 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3075933 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3075938 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3075938 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46372 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46377 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46377 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46377 | 1966 | `	return rc;` |
|     23191 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23886 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23891 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23891 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23891 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23891 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23710 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23715 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23715 | 1991 | `	while( *ppLink ){` |
|     23715 | 1992 | `		if( *ppLink == pStep ){` |
|     23715 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23715 | 1994 | `			pStep->pNextActive = 0;` |
|     23715 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    600730 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    600735 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    600735 | 2023 | `	if( pEntry ){` |
|    600735 | 2024 | `		if( bStore ){` |
|    219625 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    109815 | 2026 | `		}else{` |
|    381115 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    300112 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    166784 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    166789 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    160711 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    160711 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    160711 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     80358 | 2045 | `	}else{` |
|      6083 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      6083 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      6083 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    166789 | 2050 | `}` |
...
|         - | 2158 | ` */` |
|      3396 | 2159 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 2160 | `{` |
|         - | 2161 | `	sxu32 n;` |
|    254705 | 2162 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    251309 | 2163 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    125657 | 2164 | `	}` |
|      3401 | 2165 | `}` |
|         - | 2166 | `/*` |
...
|         - | 2180 | ` */` |
|       156 | 2181 | `PH7_PRIVATE sxi32 PH7_HashmapDumpEntries(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         3 | 2182 | `{` |
|       159 | 2183 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 2184 | `	ph7_value *pObj;` |
|       159 | 2185 | `	sxu32 n = 0;` |
|         - | 2186 | `	int isRef;` |
|       159 | 2187 | `	sxi32 rc = SXRET_OK;` |
|         - | 2188 | `	int i;` |
|       239 | 2189 | `	for(;;){` |
|       481 | 2190 | `		if( n >= pMap->nEntry ){` |
|       159 | 2191 | `			break;` |
|         - | 2192 | `		}` |
|       325 | 2193 | `		pObj = HashmapExtractNodeValue(pEntry);` |
...
|       645 | 2196 | `		isRef = ((pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0)` |
|       322 | 2197 | `			\|\| PH7_VmSlotIsReferenced(pMap->pVm,pEntry->nValIdx);` |
|       325 | 2198 | `		if( ShowType ){` |
|         - | 2199 | ``			/* var_dump entry: `[key]=>` on its own line at nTab+2, the value`` |
|         - | 2200 | `			 * on the next line at the same indent (php). */` |
|       259 | 2201 | `			for( i = 0 ; i < nTab + 2 ; i++ ){` |
|       175 | 2202 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        89 | 2203 | `			}` |
|        87 | 2204 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|        67 | 2205 | `				SyBlobFormat(&(*pOut),"[%qd]=>",pEntry->xKey.iKey);` |
|        35 | 2206 | `			}else{` |
|        32 | 2207 | `				SyBlobFormat(&(*pOut),"[\"%.*s\"]=>",` |
|        10 | 2208 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 2209 | `			}` |
|        87 | 2210 | `			SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        87 | 2211 | `			if( pObj ){` |
|        87 | 2212 | `				rc = PH7_MemObjDump(&(*pOut),pObj,TRUE,nTab+2,nDepth,isRef);` |
|        87 | 2213 | `				if( rc == SXERR_LIMIT ){` |
|       ! 0 | 2214 | `					break;` |
|         - | 2215 | `				}` |
|        42 | 2216 | `			}` |
|        45 | 2217 | `		}else{` |
...
|      1304 | 2221 | `			for( i = 0 ; i < nTab + 4 ; i++ ){` |
|      1066 | 2222 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|       534 | 2223 | `			}` |
|       240 | 2224 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|       123 | 2225 | `				SyBlobFormat(&(*pOut),"[%qd] => ",pEntry->xKey.iKey);` |
|        62 | 2226 | `			}else{` |
|       176 | 2227 | `				SyBlobFormat(&(*pOut),"[%.*s] => ",` |
|        58 | 2228 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 2229 | `			}` |
|       238 | 2230 | `			if( pObj && (pObj->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ))` |
|       133 | 2231 | `			 && (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
...
|        13 | 2237 | `			}else{` |
|       216 | 2238 | `				if( pObj ){` |
|       216 | 2239 | `					PH7_MemObjPrintRInline(&(*pOut),pObj);` |
|       107 | 2240 | `				}` |
|       216 | 2241 | `				SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|         - | 2242 | `			}` |
|         - | 2243 | `		}` |
|         - | 2244 | `		/* Point to the next entry */` |
|       325 | 2245 | `		n++;` |
|       325 | 2246 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         3 | 2247 | `	}` |
|       159 | 2248 | `	return rc;` |
|         3 | 2249 | `}` |
|       152 | 2250 | `PH7_PRIVATE sxi32 PH7_HashmapDump(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         3 | 2251 | `{` |
|         - | 2252 | `	sxi32 rc;` |
|         - | 2253 | `	int i;` |
|       155 | 2254 | `	if( nDepth > 31 ){` |
...
|         - | 2259 | `	}` |
|       155 | 2260 | `	if( ShowType ){` |
|         - | 2261 | ``		/* var_dump: `array(N) {\n … \n<nTab>}` — the caller adds the final`` |
|         - | 2262 | `		 * newline (a nested array is itself an entry value line). */` |
|        47 | 2263 | `		SyBlobFormat(&(*pOut),"array(%u) {",pMap->nEntry);` |
|        47 | 2264 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        47 | 2265 | `		rc = PH7_HashmapDumpEntries(&(*pOut),pMap,TRUE,nTab,nDepth);` |
|        51 | 2266 | `		for( i = 0 ; i < nTab ; i++ ){` |
|         5 | 2267 | `			SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|         3 | 2268 | `		}` |
|        47 | 2269 | `		SyBlobAppend(&(*pOut),"}",sizeof(char));` |
|        47 | 2270 | `		return rc;` |
|         - | 2271 | `	}` |
|         - | 2272 | ``	/* print_r: `Array\n<nTab>(\n … <nTab>)\n` */`` |
|       109 | 2273 | `	SyBlobAppend(&(*pOut),"Array\n",sizeof("Array\n")-1);` |
|       301 | 2274 | `	for( i = 0 ; i < nTab ; i++ ){` |
|       193 | 2275 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        97 | 2276 | `	}` |
|       109 | 2277 | `	SyBlobAppend(&(*pOut),"(\n",sizeof("(\n")-1);` |
|       109 | 2278 | `	rc = PH7_HashmapDumpEntries(&(*pOut),pMap,FALSE,nTab,nDepth);` |
|       301 | 2279 | `	for( i = 0 ; i < nTab ; i++ ){` |
|       193 | 2280 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        97 | 2281 | `	}` |
|       109 | 2282 | `	SyBlobAppend(&(*pOut),")\n",sizeof(")\n")-1);` |
|       109 | 2283 | `	return rc;` |
|        79 | 2284 | `}` |
|         - | 2285 | `/*` |
...
|         - | 2293 | ` */` |
|     34054 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34059 | 2305 | `	rc = SXRET_OK;` |
|     34059 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34059 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34059 | 2308 | `	n = pMap->nEntry;` |
|     34059 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    159383 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    159383 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    159383 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    159383 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    159383 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    159383 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    159381 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    159381 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     34057 | 2332 | `	return SXRET_OK;` |
|     17032 | 2333 | `}` |
|         - | 2334 |  |
