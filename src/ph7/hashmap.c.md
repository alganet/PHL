...
|         - |   22 | ` */` |
|   7499820 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7499825 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7499825 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    634334 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    634339 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    634339 |   35 | `	sxu32 nH = 5381;` |
|    634339 |   36 | `	zEnd = &zIn[nLen];` |
|    717290 |   37 | `	for(;;){` |
|   1434585 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1227921 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1099953 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    957949 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    634339 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3195988 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3195993 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3195993 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3195993 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3195993 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3195993 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3195993 |  112 | `	pNode->nHash = nHash;` |
|   3195993 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3195993 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3195993 |  115 | `	return pNode;` |
|   1597999 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    262874 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    262879 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    262879 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    262879 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    262879 |  133 | `	pNode->pMap  = &(*pMap);` |
|    262879 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    262879 |  135 | `	pNode->nHash = nHash;` |
|    262879 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    262879 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    262879 |  138 | `	pNode->nValIdx = nValIdx;` |
|    262879 |  139 | `	return pNode;` |
|    131442 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3458862 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3458867 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2982959 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2982959 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1491477 |  150 | `	}` |
|   3458867 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3458867 |  153 | `	if( pMap->pFirst == 0 ){` |
|     90321 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     90321 |  156 | `		pMap->pCur = pNode;` |
|     45163 |  157 | `	}else{` |
|   3368551 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3458867 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3458862 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3458867 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     95619 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     95619 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     95619 |  245 | `		if( nNew < 1 ){` |
|     90321 |  246 | `			nNew = 16;` |
...
|     95619 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     95619 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     95619 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     95619 |  260 | `		pMap->apBucket = apNew;` |
|     95619 |  261 | `		pMap->nSize = nNew;` |
|     95619 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     90321 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5303 |  267 | `		pEntry = pMap->pFirst;` |
|      5303 |  268 | `		n = 0;` |
|   2132793 |  269 | `		for( ;; ){` |
|   4265591 |  270 | `			if( n >= pMap->nEntry ){` |
|      5303 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   4260293 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   4260293 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   4260293 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   3616929 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3616929 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1808462 |  280 | `			}` |
|   4260293 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   4260293 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   4260293 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5303 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2649 |  288 | `	}` |
|   3368551 |  289 | `	return SXRET_OK;` |
|   1729436 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3195988 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3195993 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3195951 |  310 | `		if( pValue ){` |
|   3195945 |  311 | `			sSafeVal = *pValue;` |
|   3195945 |  312 | `			pValue = &sSafeVal;` |
|   1597970 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3195951 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3195951 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3195951 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3195945 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1597970 |  322 | `		}` |
|   3195951 |  323 | `		nIdx = pObj->nIdx;` |
|   1597978 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3195993 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3195993 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3195993 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3195993 |  334 | `	if( isForeign ){` |
...
|   3195993 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3195993 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3195993 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3195993 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3195993 |  349 | `	return SXRET_OK;` |
|   1597999 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    262874 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    262879 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    216935 |  370 | `		if( pValue ){` |
|    216625 |  371 | `			sSafeVal = *pValue;` |
|    216625 |  372 | `			pValue = &sSafeVal;` |
|    108310 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    216935 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    216935 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    216935 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    216625 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    108310 |  382 | `		}` |
|    216935 |  383 | `		nIdx = pObj->nIdx;` |
|    108470 |  384 | `	}else{` |
|     45949 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    262879 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    262879 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    262879 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    262879 |  394 | `	if( isForeign ){` |
...
|    262879 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    262879 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    262879 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    262879 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    262879 |  409 | `	return SXRET_OK;` |
|    131442 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4290446 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4290451 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       769 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4289687 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4289687 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110566825 |  433 | `	for(;;){` |
| 221133655 |  434 | `		if( pNode == 0 ){` |
|   4284373 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216849282 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216846270 |  438 | `			&& pNode->nHash == nHash` |
| 108424291 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      5319 |  441 | `				if( ppNode ){` |
|      5297 |  442 | `					*ppNode = pNode;` |
|      2646 |  443 | `				}` |
|      5319 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
...
|         - |  456 | ` */` |
|    406070 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    406075 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     34615 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    371465 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    371465 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    305731 |  475 | `	for(;;){` |
|    611467 |  476 | `		if( pNode == 0 ){` |
|    306757 |  477 | `			break;` |
|         - |  478 | `		}` |
|    304710 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    303199 |  480 | `			&& pNode->nHash == nHash` |
|    183248 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     64813 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     64713 |  484 | `				if( ppNode ){` |
|     64685 |  485 | `					*ppNode = pNode;` |
|     32340 |  486 | `				}` |
|     64713 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    240007 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    306757 |  493 | `	return SXERR_NOTFOUND;` |
|    203040 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    406202 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    406207 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    406207 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    406207 |  504 | `	int isNeg = FALSE, nDigit;` |
|    406207 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    406185 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    406181 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    406181 |  516 | `	zDigit = zIn;` |
|    203522 |  517 | `	for(;;){` |
|    407049 |  518 | `		if( zIn >= zEnd ){` |
|       251 |  519 | `			break;` |
|         - |  520 | `		}` |
|    406799 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    405931 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       869 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    148502 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    148507 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    148507 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    143319 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    143319 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    143305 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    143305 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         7 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      5207 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        27 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        13 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      5207 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     74251 |  575 | `result:` |
|    148507 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     69145 |  578 | `		if( ppNode ){` |
|     69093 |  579 | `			*ppNode = pNode;` |
|     34544 |  580 | `		}` |
|     69145 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79367 |  584 | `	return SXERR_NOTFOUND;` |
|     74256 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1053018 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1053023 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1053017 |  623 | `	return FALSE;` |
|    526514 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3412450 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3412455 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3412455 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3412455 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    216937 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    216937 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    325061 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    108352 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    216223 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    216093 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    216093 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1597759 |  683 | `IntKey:` |
|   3195751 |  684 | `	if( pKey ){` |
...
|   1071283 |  714 | `		}` |
|   1071288 |  715 | `	}else{` |
|   1052989 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1052987 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1052981 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1052981 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1052979 |  726 | `			++pMap->iNextIdx;` |
|    526487 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3195547 |  730 | `	return rc;` |
|   1706230 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1486465 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1486470 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1486470 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     72410 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     72415 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     72415 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     72415 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     72415 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     72415 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     72415 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     72415 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     72415 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     72415 |  921 | `	return rc;` |
|     36186 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14150 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14155 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14155 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11388 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5702 |  934 | `	}else{` |
|      2772 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14155 |  937 | `	if( pEntry->pNextCollide ){` |
|       982 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       508 |  939 | `	}` |
|     14155 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14155 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14155 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14155 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14155 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14155 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11702 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5858 |  949 | `	}` |
|     14155 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14155 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14155 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14155 |  956 | `		pMap->iNextIdx++;` |
|      7075 |  957 | `	}` |
|     14155 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33146 |  966 | `static int HashmapFindValue(` |
...
|     33151 |  979 | `	pEntry = pMap->pFirst;` |
|     33151 |  980 | `	n = pMap->nEntry;` |
|     33151 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33151 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     79122 |  983 | `	for(;;){` |
|    158248 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    158170 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    158170 |  989 | `		if( pVal ){` |
...
|    158170 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    158170 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    158170 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    158170 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    158170 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    158170 | 1001 | `			if( rc == 0 ){` |
...
|    125102 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    125102 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    695364 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    695364 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    695366 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    695361 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    695361 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      1996 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    691379 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    691133 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    345814 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|         - | 1271 | ` */` |
|      2840 | 1272 | `static sxi32 HashmapMerge(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1273 | `{` |
|         - | 1274 | `	ph7_hashmap_node *pEntry;` |
|         - | 1275 | `	ph7_value *pVal;` |
|         - | 1276 | `	sxi32 rc;` |
|         - | 1277 | `	sxu32 n;` |
|      2845 | 1278 | `	if( pSrc == pDest ){` |
...
|      2845 | 1285 | `	pEntry = pSrc->pFirst;` |
|         - | 1286 | `	/* Perform the merge */` |
|    694033 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    691193 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    691193 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    691193 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    345599 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    691193 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    691193 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    345599 | 1305 | `	}` |
|      2845 | 1306 | `	return SXRET_OK;` |
|      1425 | 1307 | `}` |
|         - | 1308 | `/*` |
...
|         - | 1462 | ` */` |
|    237044 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    237049 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    237049 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    237049 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    234305 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
|      2749 | 1475 | `	if( pMap == pVm->pGlobal ){` |
...
|      2623 | 1484 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2623 | 1485 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2618 | 1486 | `		if( pBacking && pBacking != pValue` |
|      2593 | 1487 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2573 | 1488 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1489 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2573 | 1490 | `			pMap->iRef--;` |
|      2573 | 1491 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1492 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2527 | 1493 | `				pMap->iRef++;` |
|      2527 | 1494 | `				return pMap;` |
|         - | 1495 | `			}` |
...
|         - | 1648 | ` */` |
|    144596 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    144601 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    144601 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    144601 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    144601 | 1664 | `	pMap->pVm = &(*pVm);` |
|    144601 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    144601 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    144601 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    144601 | 1669 | `	return pMap;` |
|     72303 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|    102668 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|    102673 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|    102673 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|    102673 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|    102673 | 1785 | `	n = 0;` |
|    102673 | 1786 | `	pEntry = pMap->pFirst;` |
|   1738375 | 1787 | `	for(;;){` |
|   3476755 | 1788 | `		if( n >= pMap->nEntry ){` |
|    102673 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3374087 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3374087 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3374087 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3374027 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1687011 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3374087 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    189415 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     94705 | 1801 | `		}` |
|   3374087 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3374087 | 1804 | `		pEntry = pNext;` |
|   3374087 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|    102673 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     75385 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     37690 | 1810 | `	}` |
|    102673 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|    102647 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     51326 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    844126 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    844131 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    844131 | 1833 | `	pMap->iRef--;` |
|    844131 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|    102627 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     51311 | 1836 | `	}` |
|    844131 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    148690 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   2720988 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2720993 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2720993 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     19154 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     19159 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     19159 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     19159 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     19159 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     19052 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     19057 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     19057 | 1955 | `	while( *ppLink ){` |
|     19057 | 1956 | `		if( *ppLink == pStep ){` |
|     19057 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     19057 | 1958 | `			pStep->pNextActive = 0;` |
|     19057 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    598370 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    598375 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    598375 | 1987 | `	if( pEntry ){` |
|    598375 | 1988 | `		if( bStore ){` |
|    238069 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    119037 | 1990 | `		}else{` |
|    360311 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    299142 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    159230 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    159235 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    153935 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    153935 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    153935 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     76970 | 2009 | `	}else{` |
...
|    109609 | 2071 | `	while( pA && pB ){` |
|     72663 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47927 | 2073 | `			pTail->pPrev = pA;` |
|     47927 | 2074 | `			pA->pNext = pTail;` |
|     47927 | 2075 | `			pTail = pA;` |
|     47927 | 2076 | `			pA = pA->pPrev;` |
|     23897 | 2077 | `		}else{` |
|     24741 | 2078 | `			pTail->pPrev = pB;` |
|     24741 | 2079 | `			pB->pNext = pTail;` |
|     24741 | 2080 | `			pTail = pB;` |
|     24741 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     36951 | 2084 | `	if( pA ){` |
|     26311 | 2085 | `		pTail->pPrev = pA;` |
|     26311 | 2086 | `		pA->pNext = pTail;` |
|     23847 | 2087 | `	}else if( pB ){` |
|     10413 | 2088 | `		pTail->pPrev = pB;` |
|     10413 | 2089 | `		pB->pNext = pTail;` |
|      5160 | 2090 | `	}else{` |
...
|     14977 | 2114 | `	while( pIn ){` |
|     14199 | 2115 | `		p = pIn;` |
|     14199 | 2116 | `		pIn = p->pPrev;` |
|     14199 | 2117 | `		p->pPrev = 0;` |
|     27027 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27027 | 2119 | `			if( a[i]==0 ){` |
|     14199 | 2120 | `				a[i] = p;` |
|     14199 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
...
|         - | 2125 | `			}` |
|      6419 | 2126 | `		}` |
|     14199 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     72344 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     72349 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     72261 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     13931 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     13931 | 2532 | `		i++;` |
|     13931 | 2533 | `		pLast = p;` |
|     13931 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       703 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         - | 2556 | ` *` |
|         - | 2557 | ` */` |
|      1058 | 2558 | `static int ph7_hashmap_sort(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 2559 | `{` |
|         - | 2560 | `	ph7_hashmap *pMap;` |
|         - | 2561 | `	/* Make sure we are dealing with a valid hashmap */` |
|      1063 | 2562 | `	if( nArg < 1 \|\| !ph7_value_is_array(apArg[0]) ){` |
...
|      1063 | 2568 | `	PH7_HashmapCowSeparate(pCtx->pVm, apArg[0]);` |
|      1063 | 2569 | `	pMap = (ph7_hashmap *)apArg[0]->x.pOther;` |
|      1063 | 2570 | `	if( pMap->nEntry > 1 ){` |
...
|      1063 | 2582 | `	ph7_result_bool(pCtx,1);` |
|      1063 | 2583 | `	return PH7_OK;` |
|       534 | 2584 | `}` |
|         - | 2585 | `/*` |
...
|         - | 4444 | ` */` |
|      1086 | 4445 | `static int ph7_hashmap_merge(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4446 | `{` |
|         - | 4447 | `	ph7_hashmap *pMap,*pSrc;` |
|         - | 4448 | `	ph7_value *pArray;` |
|         - | 4449 | `	int i;` |
|         - | 4450 | `	/* Create a new array */` |
|      1091 | 4451 | `	pArray = ph7_context_new_array(pCtx);` |
|      1091 | 4452 | `	if( pArray == 0 ){` |
|       ! 0 | 4453 | `		ph7_result_null(pCtx);` |
|       ! 0 | 4454 | `		return PH7_OK;` |
|         - | 4455 | `	}` |
|         - | 4456 | `	/* Point to the internal representation of the hashmap */` |
|      1091 | 4457 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|         - | 4458 | `	/* Start merging */` |
|      3253 | 4459 | `	for( i = 0 ; i < nArg ; i++ ){` |
|         - | 4460 | `		/* Make sure we are dealing with a valid hashmap */` |
|      2171 | 4461 | `		if( !ph7_value_is_array(apArg[i]) ){` |
...
|         - | 4468 | `				);` |
|       ! 0 | 4469 | `		}else{` |
|      2167 | 4470 | `			pSrc = (ph7_hashmap *)apArg[i]->x.pOther;` |
|         - | 4471 | `			/* Merge the two hashmaps */` |
|      2167 | 4472 | `			HashmapMerge(pSrc,pMap);` |
|         - | 4473 | `		}` |
|      1086 | 4474 | `	}` |
|         - | 4475 | `	/* Return the freshly created array */` |
|      1087 | 4476 | `	ph7_result_value(pCtx,pArray);` |
|      1087 | 4477 | `	return PH7_OK;` |
|       548 | 4478 | `}` |
|         - | 4479 | `/*` |
...
|         - | 4937 | ` */` |
|     33018 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33023 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33023 | 4948 | `	pNeedle = apArg[0];` |
|     33023 | 4949 | `	bStrict = 0;` |
|     33023 | 4950 | `	if( nArg > 2 ){` |
|        53 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4952 | `	}` |
|     33023 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33023 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33023 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33023 | 4964 | `	return PH7_OK;` |
|     16514 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         - | 8934 | ` */` |
|     34162 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34167 | 8946 | `	rc = SXRET_OK;` |
|     34167 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34167 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34167 | 8949 | `	n = pMap->nEntry;` |
|     34167 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    152677 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    152677 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    152677 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    152677 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    152677 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    152677 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    152677 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    152677 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34167 | 8973 | `	return SXRET_OK;` |
|     17086 | 8974 | `}` |
|         - | 8975 |  |
