...
|         - |   22 | ` */` |
|   7933154 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7933159 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7933159 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    515715 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    515720 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    515720 |   35 | `	sxu32 nH = 5381;` |
|    515720 |   36 | `	zEnd = &zIn[nLen];` |
|    592957 |   37 | `	for(;;){` |
|   1185920 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1012432 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    911057 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
...
|         - |   51 | ` */` |
|      2312 |   52 | `PH7_PRIVATE sxi64 HashmapCount(ph7_hashmap *pMap,int bRecursive,int *pCycleDetected)` |
|         5 |   53 | `{` |
|      2317 |   54 | `	sxi64 iCount = 0;` |
|      2317 |   55 | `	if( !bRecursive ){` |
|      2153 |   56 | `		iCount = pMap->nEntry;` |
|      1079 |   57 | `	}else{` |
...
|         - |   98 | ` */` |
|   3624192 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3624197 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3624197 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3624197 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3624197 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3624197 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3624197 |  112 | `	pNode->nHash = nHash;` |
|   3624197 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3624197 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3624197 |  115 | `	return pNode;` |
|   1812101 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199705 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199710 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199710 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199710 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199710 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199710 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199710 |  135 | `	pNode->nHash = nHash;` |
|    199710 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199710 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199710 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199710 |  139 | `	return pNode;` |
|     99857 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3823897 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3823902 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3369413 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3369413 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684707 |  150 | `	}` |
|   3823902 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3823902 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87950 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87950 |  156 | `		pMap->pCur = pNode;` |
|     43977 |  157 | `	}else{` |
|   3735957 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3823902 |  160 | `	if( pMap->pActiveSteps ){` |
...
|        11 |  172 | `		}` |
|         9 |  173 | `	}` |
|   3823902 |  174 | `	++pMap->nEntry;` |
|   3823902 |  175 | `}` |
|         - |  176 | `/*` |
|         - |  177 | ` * Unlink a node from the hashmap.` |
|         - |  178 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  179 | ` */` |
|      7390 |  180 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  181 | `{` |
|      7395 |  182 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7395 |  183 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  184 | `	/* Unlink from the corresponding bucket */` |
|      7395 |  185 | `	if( pNode->pPrevCollide == 0 ){` |
|      6903 |  186 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|      3454 |  187 | `	}else{` |
|       494 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7395 |  190 | `	if( pNode->pNextCollide ){` |
|      4843 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2420 |  192 | `	}` |
|      7395 |  193 | `	if( pMap->pFirst == pNode ){` |
|       173 |  194 | `		pMap->pFirst = pNode->pPrev;` |
|        84 |  195 | `	}` |
|      7395 |  196 | `	if( pMap->pCur == pNode ){` |
|         - |  197 | `		/* Advance the node cursor */` |
|       209 |  198 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|       102 |  199 | `	}` |
|      7395 |  200 | `	if( pMap->pActiveSteps ){` |
...
|      7395 |  211 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|      7395 |  212 | `	if( bRestore ){` |
...
|       105 |  218 | `		}` |
|       105 |  219 | `	}` |
|      7395 |  220 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7150 |  221 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3573 |  222 | `	}` |
|      7395 |  223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7395 |  224 | `	pMap->nEntry--;` |
|      7395 |  225 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|         - |  236 | ` */` |
|   3823897 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3823902 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     93374 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     93374 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     93374 |  245 | `		if( nNew < 1 ){` |
|     87950 |  246 | `			nNew = 16;` |
...
|     93374 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     93374 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     93374 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     93374 |  260 | `		pMap->apBucket = apNew;` |
|     93374 |  261 | `		pMap->nSize = nNew;` |
|     93374 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87950 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5429 |  267 | `		pEntry = pMap->pFirst;` |
|      5429 |  268 | `		n = 0;` |
|   2536488 |  269 | `		for( ;; ){` |
|   5072981 |  270 | `			if( n >= pMap->nEntry ){` |
|      5429 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5067557 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5067557 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5067557 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4404255 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4404255 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2202125 |  280 | `			}` |
|   5067557 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5067557 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5067557 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5429 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2712 |  288 | `	}` |
|   3735957 |  289 | `	return SXRET_OK;` |
|   1911953 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3624192 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3624197 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3624155 |  310 | `		if( pValue ){` |
|   3624145 |  311 | `			sSafeVal = *pValue;` |
|   3624145 |  312 | `			pValue = &sSafeVal;` |
|   1812070 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3624155 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3624155 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3624155 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3624145 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1812070 |  322 | `		}` |
|   3624155 |  323 | `		nIdx = pObj->nIdx;` |
|   1812080 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3624197 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3624197 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3624197 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3624197 |  334 | `	if( isForeign ){` |
...
|   3624197 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3624197 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3624197 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3624197 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3624197 |  349 | `	return SXRET_OK;` |
|   1812101 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199705 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199710 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    153300 |  370 | `		if( pValue ){` |
|    152990 |  371 | `			sSafeVal = *pValue;` |
|    152990 |  372 | `			pValue = &sSafeVal;` |
|     76492 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    153300 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    153300 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    153300 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152990 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76492 |  382 | `		}` |
|    153300 |  383 | `		nIdx = pObj->nIdx;` |
|     76652 |  384 | `	}else{` |
|     46415 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199710 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199710 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199710 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199710 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46415 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23205 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199710 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199710 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199710 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199710 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199710 |  409 | `	return SXRET_OK;` |
|     99857 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293070 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293075 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       857 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292223 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292223 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
...
| 108426376 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7371 |  441 | `				if( ppNode ){` |
|      7349 |  442 | `					*ppNode = pNode;` |
|      3672 |  443 | `				}` |
|      7371 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
|         - |  446 | `		/* Follow the collision link */` |
| 216844013 |  447 | `		pNode = pNode->pNextCollide;` |
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
...
|         - |  456 | ` */` |
|    344639 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    344644 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28634 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    316015 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    316015 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    256478 |  475 | `	for(;;){` |
|    512961 |  476 | `		if( pNode == 0 ){` |
|    250353 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262608 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261095 |  480 | `			&& pNode->nHash == nHash` |
|    162674 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65771 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65667 |  484 | `				if( ppNode ){` |
|     65639 |  485 | `					*ppNode = pNode;` |
|     32817 |  486 | `				}` |
|     65667 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196951 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    250353 |  493 | `	return SXERR_NOTFOUND;` |
|    172324 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    345019 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    345024 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    345024 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    345024 |  504 | `	int isNeg = FALSE, nDigit;` |
|    345024 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    345014 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    345010 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    345010 |  516 | `	zDigit = zIn;` |
|    173141 |  517 | `	for(;;){` |
|    346288 |  518 | `		if( zIn >= zEnd ){` |
|       499 |  519 | `			break;` |
|         - |  520 | `		}` |
|    345790 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    344512 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|      1279 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    152528 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    152533 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    152533 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    145181 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    145181 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    145109 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    145109 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      7429 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        84 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        41 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      7429 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     76264 |  575 | `result:` |
|    152533 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72237 |  578 | `		if( ppNode ){` |
|     72183 |  579 | `			*ppNode = pNode;` |
|     36089 |  580 | `		}` |
|     72237 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80301 |  584 | `	return SXERR_NOTFOUND;` |
|     76269 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  591 | ` */` |
|   2142838 |  592 | `static void HashmapAdvanceAutoIndex(ph7_hashmap *pMap,sxi64 iKey)` |
|         5 |  593 | `{` |
|   2142843 |  594 | `	if( !pMap->bIntKeySeen ){` |
...
|         - |  616 | ` */` |
|   1477532 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1477537 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1477531 |  623 | `	return FALSE;` |
|    738771 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3773517 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3773522 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3773522 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3773522 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153426 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    153426 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       419 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229509 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76501 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152520 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152374 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152374 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1810048 |  683 | `IntKey:` |
|   3620519 |  684 | `	if( pKey ){` |
|   2143021 |  685 | `		if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  686 | `			/* Force an integer cast */` |
|       438 |  687 | `			PH7_MemObjToInteger(pKey);` |
|       218 |  688 | `		}` |
|   2143021 |  689 | `		if( SXRET_OK == HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode) ){` |
...
|         - |  702 | `		}` |
|   2142839 |  703 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|   2142837 |  711 | `		rc = HashmapInsertIntKey(&(*pMap),pKey->x.iVal,&(*pVal),0,FALSE);` |
|   2142837 |  712 | `		if( rc == SXRET_OK ){` |
|   2142837 |  713 | `			HashmapAdvanceAutoIndex(&(*pMap),pKey->x.iVal);` |
|   1071416 |  714 | `		}` |
|   1071421 |  715 | `	}else{` |
|   1477503 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1477501 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1477495 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1477495 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1477493 |  726 | `			++pMap->iNextIdx;` |
|    738744 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3620327 |  730 | `	return rc;` |
|   1886763 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46462 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46467 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46467 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46467 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46427 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46427 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69635 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23210 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46415 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46415 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1500592 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1500597 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1500597 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77565 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77570 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77570 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77570 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77570 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77570 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77570 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77570 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77570 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77570 |  921 | `	return rc;` |
|     38677 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16744 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16749 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16749 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11803 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5795 |  934 | `	}else{` |
|      4951 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16749 |  937 | `	if( pEntry->pNextCollide ){` |
|      1096 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       557 |  939 | `	}` |
|     16749 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16749 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16749 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16749 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16749 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16749 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12120 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5962 |  949 | `	}` |
|     16749 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16749 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16749 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16749 |  956 | `		pMap->iNextIdx++;` |
|      8372 |  957 | `	}` |
|     16749 |  958 | `}` |
|         - |  959 | `/*` |
...
|    156183 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156183 |  989 | `		if( pVal ){` |
...
|    156183 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156183 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156183 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156183 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156183 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156183 | 1001 | `			if( rc == 0 ){` |
...
|    123447 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123447 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    708956 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    708956 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    708958 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    708953 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    708953 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1277 | `		/* Blob key insertion */` |
|      4063 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4063 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4063 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4063 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2034 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    704895 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    701225 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
...
|    701285 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    701285 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    701285 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    350645 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    701285 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    701285 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    350645 | 1341 | `	}` |
...
|         - | 1392 | ` */` |
|      7338 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7343 | 1399 | `	if( pSrc == pDest ){` |
...
|      7343 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14975 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7637 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7637 | 1411 | `		if( pVal ){` |
|      7637 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3821 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7637 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7637 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3821 | 1421 | `	}` |
|      7343 | 1422 | `	return SXRET_OK;` |
|      3674 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    244038 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    244043 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    244043 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    244043 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    241205 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    142140 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    142145 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142145 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    142145 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    142145 | 1700 | `	pMap->pVm = &(*pVm);` |
|    142145 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    142145 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142145 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142145 | 1705 | `	return pMap;` |
|     71075 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     94102 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94107 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     94107 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     94107 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     94107 | 1821 | `	n = 0;` |
|     94107 | 1822 | `	pEntry = pMap->pFirst;` |
|   1904339 | 1823 | `	for(;;){` |
|   3808684 | 1824 | `		if( n >= pMap->nEntry ){` |
|     94107 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3714582 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3714582 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3714582 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3714522 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1857258 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3714582 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109688 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54841 | 1837 | `		}` |
|   3714582 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3714582 | 1840 | `		pEntry = pNext;` |
|   3714582 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     94107 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     68242 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34118 | 1846 | `	}` |
|     94107 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     94081 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47043 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    874974 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    874979 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    874979 | 1869 | `	pMap->iRef--;` |
|    874979 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94061 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47028 | 1872 | `	}` |
|    874979 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152778 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3071967 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3071972 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3071972 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46452 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46457 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46457 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46457 | 1966 | `	return rc;` |
|     23231 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23844 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23849 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23849 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23849 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23849 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23668 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23673 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23673 | 1991 | `	while( *ppLink ){` |
|     23673 | 1992 | `		if( *ppLink == pStep ){` |
|     23673 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23673 | 1994 | `			pStep->pNextActive = 0;` |
|     23673 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    596476 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    596481 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    596481 | 2023 | `	if( pEntry ){` |
|    596481 | 2024 | `		if( bStore ){` |
|    217601 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    108803 | 2026 | `		}else{` |
|    378885 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    298022 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    164916 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    164921 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    158841 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    158841 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    158841 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79423 | 2045 | `	}else{` |
|      6085 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      6085 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      6085 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    164921 | 2050 | `}` |
...
|         - | 2180 | ` */` |
|       130 | 2181 | `PH7_PRIVATE sxi32 PH7_HashmapDumpEntries(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         2 | 2182 | `{` |
|       132 | 2183 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 2184 | `	ph7_value *pObj;` |
|       132 | 2185 | `	sxu32 n = 0;` |
|         - | 2186 | `	int isRef;` |
|       132 | 2187 | `	sxi32 rc = SXRET_OK;` |
|         - | 2188 | `	int i;` |
|       207 | 2189 | `	for(;;){` |
|       416 | 2190 | `		if( n >= pMap->nEntry ){` |
|       132 | 2191 | `			break;` |
|         - | 2192 | `		}` |
|       286 | 2193 | `		pObj = HashmapExtractNodeValue(pEntry);` |
...
|       568 | 2196 | `		isRef = ((pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0)` |
|       284 | 2197 | `			\|\| PH7_VmSlotIsReferenced(pMap->pVm,pEntry->nValIdx);` |
|       286 | 2198 | `		if( ShowType ){` |
...
|       286 | 2245 | `		n++;` |
|       286 | 2246 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         2 | 2247 | `	}` |
|       132 | 2248 | `	return rc;` |
|         2 | 2249 | `}` |
|       126 | 2250 | `PH7_PRIVATE sxi32 PH7_HashmapDump(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         1 | 2251 | `{` |
|         - | 2252 | `	sxi32 rc;` |
|         - | 2253 | `	int i;` |
|       127 | 2254 | `	if( nDepth > 31 ){` |
...
|         - | 2293 | ` */` |
|     34072 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34077 | 2305 | `	rc = SXRET_OK;` |
|     34077 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34077 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34077 | 2308 | `	n = pMap->nEntry;` |
|     34077 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    157507 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157507 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    157507 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    157507 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    157507 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    157507 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    157505 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157505 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     34075 | 2332 | `	return SXRET_OK;` |
|     17041 | 2333 | `}` |
|         - | 2334 |  |
