...
|         - |   22 | ` */` |
|   7930415 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7930420 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7930420 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    514287 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    514292 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    514292 |   35 | `	sxu32 nH = 5381;` |
|    514292 |   36 | `	zEnd = &zIn[nLen];` |
|    591315 |   37 | `	for(;;){` |
|   1182636 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1009944 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    908953 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    786457 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    514292 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3621552 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3621557 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3621557 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3621557 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3621557 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3621557 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3621557 |  112 | `	pNode->nHash = nHash;` |
|   3621557 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3621557 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3621557 |  115 | `	return pNode;` |
|   1810781 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199233 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199238 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199238 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199238 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199238 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199238 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199238 |  135 | `	pNode->nHash = nHash;` |
|    199238 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199238 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199238 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199238 |  139 | `	return pNode;` |
|     99621 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3820785 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3820790 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3368522 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3368522 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684259 |  150 | `	}` |
|   3820790 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3820790 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87536 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87536 |  156 | `		pMap->pCur = pNode;` |
|     43770 |  157 | `	}else{` |
|   3733259 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3820790 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3820785 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3820790 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92972 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92972 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92972 |  245 | `		if( nNew < 1 ){` |
|     87536 |  246 | `			nNew = 16;` |
...
|     92972 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92972 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92972 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92972 |  260 | `		pMap->apBucket = apNew;` |
|     92972 |  261 | `		pMap->nSize = nNew;` |
|     92972 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87536 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2718 |  288 | `	}` |
|   3733259 |  289 | `	return SXRET_OK;` |
|   1910397 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3621552 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3621557 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3621515 |  310 | `		if( pValue ){` |
|   3621505 |  311 | `			sSafeVal = *pValue;` |
|   3621505 |  312 | `			pValue = &sSafeVal;` |
|   1810750 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3621515 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3621515 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3621515 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3621505 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1810750 |  322 | `		}` |
|   3621515 |  323 | `		nIdx = pObj->nIdx;` |
|   1810760 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3621557 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3621557 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3621557 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3621557 |  334 | `	if( isForeign ){` |
...
|   3621557 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3621557 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3621557 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3621557 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3621557 |  349 | `	return SXRET_OK;` |
|   1810781 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199233 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199238 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    152868 |  370 | `		if( pValue ){` |
|    152558 |  371 | `			sSafeVal = *pValue;` |
|    152558 |  372 | `			pValue = &sSafeVal;` |
|     76276 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    152868 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    152868 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    152868 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152558 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76276 |  382 | `		}` |
|    152868 |  383 | `		nIdx = pObj->nIdx;` |
|     76436 |  384 | `	}else{` |
|     46375 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199238 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199238 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199238 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199238 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46375 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23185 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199238 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199238 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199238 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199238 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199238 |  409 | `	return SXRET_OK;` |
|     99621 |  410 | `}` |
|         - |  411 | `/*` |
...
| 108426333 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      7345 |  441 | `				if( ppNode ){` |
...
|         - |  456 | ` */` |
|    343525 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    343530 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28476 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    315059 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    315059 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255708 |  475 | `	for(;;){` |
|    511421 |  476 | `		if( pNode == 0 ){` |
|    249343 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262078 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260565 |  480 | `			&& pNode->nHash == nHash` |
|    162435 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     65823 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     65721 |  484 | `				if( ppNode ){` |
|     65693 |  485 | `					*ppNode = pNode;` |
|     32844 |  486 | `				}` |
|     65721 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196367 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    249343 |  493 | `	return SXERR_NOTFOUND;` |
|    171767 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    343705 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    343710 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    343710 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    343710 |  504 | `	int isNeg = FALSE, nDigit;` |
|    343710 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    343700 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    343696 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    343696 |  516 | `	zDigit = zIn;` |
|    172294 |  517 | `	for(;;){` |
|    344594 |  518 | `		if( zIn >= zEnd ){` |
|       299 |  519 | `			break;` |
|         - |  520 | `		}` |
|    344296 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    343398 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       899 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    151810 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    151815 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    151815 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    144489 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    144489 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    144417 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    144417 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|     75905 |  575 | `result:` |
|    151815 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72265 |  578 | `		if( ppNode ){` |
|     72217 |  579 | `			*ppNode = pNode;` |
|     36106 |  580 | `		}` |
|     72265 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79555 |  584 | `	return SXERR_NOTFOUND;` |
|     75910 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1474908 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1474913 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1474907 |  623 | `	return FALSE;` |
|    737459 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3770495 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3770500 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3770500 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3770500 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    152844 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    152844 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       219 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    228936 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76310 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152138 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152002 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152002 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1808828 |  683 | `IntKey:` |
|   3617879 |  684 | `	if( pKey ){` |
...
|   1071408 |  714 | `		}` |
|   1071413 |  715 | `	}else{` |
|   1474879 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1474877 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1474871 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1474871 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1474869 |  726 | `			++pMap->iNextIdx;` |
|    737432 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3617687 |  730 | `	return rc;` |
|   1885252 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46422 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46427 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46427 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46427 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46387 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46387 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69575 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23190 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46375 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46375 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1516510 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1516515 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1516515 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77348 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77353 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77353 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77353 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77353 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77353 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77353 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77353 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77353 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77353 |  921 | `	return rc;` |
|     38579 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     16690 |  927 | `PH7_PRIVATE void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     16695 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     16695 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11752 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5769 |  934 | `	}else{` |
|      4948 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16695 |  937 | `	if( pEntry->pNextCollide ){` |
|      1088 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       553 |  939 | `	}` |
|     16695 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     16695 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     16695 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     16695 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     16695 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16695 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12068 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5931 |  949 | `	}` |
|     16695 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     16695 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     16695 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     16695 |  956 | `		pMap->iNextIdx++;` |
|      8345 |  957 | `	}` |
|     16695 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     32760 |  966 | `PH7_PRIVATE int HashmapFindValue(` |
...
|     32765 |  979 | `	pEntry = pMap->pFirst;` |
|     32765 |  980 | `	n = pMap->nEntry;` |
|     32765 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     32765 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78059 |  983 | `	for(;;){` |
|    156121 |  984 | `		if( n < 1 ){` |
|        83 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    156039 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156039 |  989 | `		if( pVal ){` |
...
|    156039 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156039 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156039 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156039 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156039 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156039 | 1001 | `			if( rc == 0 ){` |
|     32683 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     32683 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     61679 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    123361 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123361 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    708934 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    708934 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    708936 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    708931 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    708931 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2025 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    704891 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    701221 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    354283 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    704187 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    701281 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    701281 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    701281 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    350643 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    701281 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    701281 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    350643 | 1341 | `	}` |
...
|         - | 1498 | ` */` |
|    242870 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    242875 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    242875 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    242875 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    240047 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
...
|         - | 1684 | ` */` |
|    141510 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141515 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141515 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    141515 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    141515 | 1700 | `	pMap->pVm = &(*pVm);` |
|    141515 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    141515 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141515 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141515 | 1705 | `	return pMap;` |
|     70760 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     93492 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     93497 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     93497 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     93497 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     93497 | 1821 | `	n = 0;` |
|     93497 | 1822 | `	pEntry = pMap->pFirst;` |
|   1902512 | 1823 | `	for(;;){` |
|   3805030 | 1824 | `		if( n >= pMap->nEntry ){` |
|     93497 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3711538 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3711538 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3711538 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3711478 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1855736 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3711538 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109304 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54649 | 1837 | `		}` |
|   3711538 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3711538 | 1840 | `		pEntry = pNext;` |
|   3711538 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     93497 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     67844 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33919 | 1846 | `	}` |
|     93497 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     93471 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     46738 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    869062 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    869067 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    869067 | 1869 | `	pMap->iRef--;` |
|    869067 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     93451 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     46723 | 1872 | `	}` |
|    869067 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152060 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3068949 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3068954 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3068954 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46412 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46417 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46417 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46417 | 1966 | `	return rc;` |
|     23211 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23140 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23145 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23145 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23145 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23145 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     22964 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     22969 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     22969 | 1991 | `	while( *ppLink ){` |
|     22969 | 1992 | `		if( *ppLink == pStep ){` |
|     22969 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     22969 | 1994 | `			pStep->pNextActive = 0;` |
|     22969 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    612626 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    612631 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    612631 | 2023 | `	if( pEntry ){` |
|    612631 | 2024 | `		if( bStore ){` |
|    235357 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    117681 | 2026 | `		}else{` |
|    377279 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    306118 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    163632 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    163637 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    157681 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    157681 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    157681 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     78843 | 2045 | `	}else{` |
|      5961 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      5961 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5961 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    163637 | 2050 | `}` |
...
|         - | 2293 | ` */` |
|     33880 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33885 | 2305 | `	rc = SXRET_OK;` |
|     33885 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33885 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33885 | 2308 | `	n = pMap->nEntry;` |
|     33885 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    156355 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    156355 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    156355 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    156355 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    156355 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    156355 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    156353 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    156353 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     33883 | 2332 | `	return SXRET_OK;` |
|     16945 | 2333 | `}` |
|         - | 2334 |  |
