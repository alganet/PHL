...
|         - |   22 | ` */` |
|   7460084 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7460089 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7460089 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    647236 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    647241 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    647241 |   35 | `	sxu32 nH = 5381;` |
|    647241 |   36 | `	zEnd = &zIn[nLen];` |
|    733863 |   37 | `	for(;;){` |
|   1467731 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1249517 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1119981 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    976955 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    647241 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3158962 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3158967 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3158967 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3158967 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3158967 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3158967 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3158967 |  112 | `	pNode->nHash = nHash;` |
|   3158967 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3158967 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3158967 |  115 | `	return pNode;` |
|   1579486 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    273792 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    273797 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    273797 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    273797 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    273797 |  133 | `	pNode->pMap  = &(*pMap);` |
|    273797 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    273797 |  135 | `	pNode->nHash = nHash;` |
|    273797 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    273797 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    273797 |  138 | `	pNode->nValIdx = nValIdx;` |
|    273797 |  139 | `	return pNode;` |
|    136901 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3432754 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3432759 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2947285 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2947285 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1473640 |  150 | `	}` |
|   3432759 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3432759 |  153 | `	if( pMap->pFirst == 0 ){` |
|     92941 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     92941 |  156 | `		pMap->pCur = pNode;` |
|     46473 |  157 | `	}else{` |
|   3339823 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3432759 |  160 | `	if( pMap->pActiveSteps ){` |
...
|        11 |  172 | `		}` |
|         9 |  173 | `	}` |
|   3432759 |  174 | `	++pMap->nEntry;` |
|   3432759 |  175 | `}` |
|         - |  176 | `/*` |
|         - |  177 | ` * Unlink a node from the hashmap.` |
|         - |  178 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  179 | ` */` |
|      7916 |  180 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  181 | `{` |
|      7921 |  182 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7921 |  183 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  184 | `	/* Unlink from the corresponding bucket */` |
|      7921 |  185 | `	if( pNode->pPrevCollide == 0 ){` |
|      7451 |  186 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|      3728 |  187 | `	}else{` |
|       472 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7921 |  190 | `	if( pNode->pNextCollide ){` |
|      5169 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2583 |  192 | `	}` |
|      7921 |  193 | `	if( pMap->pFirst == pNode ){` |
|       193 |  194 | `		pMap->pFirst = pNode->pPrev;` |
|        94 |  195 | `	}` |
|      7921 |  196 | `	if( pMap->pCur == pNode ){` |
|         - |  197 | `		/* Advance the node cursor */` |
|       225 |  198 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|       110 |  199 | `	}` |
|      7921 |  200 | `	if( pMap->pActiveSteps ){` |
...
|      7921 |  211 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|      7921 |  212 | `	if( bRestore ){` |
...
|       102 |  218 | `		}` |
|       102 |  219 | `	}` |
|      7921 |  220 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7659 |  221 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3827 |  222 | `	}` |
|      7921 |  223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7921 |  224 | `	pMap->nEntry--;` |
|      7921 |  225 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
|         - |  226 | `		/* Free the hash-bucket */` |
|       117 |  227 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|       117 |  228 | `		pMap->apBucket = 0;` |
|       117 |  229 | `		pMap->nSize = 0;` |
|       117 |  230 | `		pMap->pFirst = pMap->pLast = pMap->pCur = 0;` |
|        56 |  231 | `	}` |
|      7921 |  232 | `}` |
...
|         - |  236 | ` */` |
|   3432754 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3432759 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     98015 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     98015 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     98015 |  245 | `		if( nNew < 1 ){` |
|     92941 |  246 | `			nNew = 16;` |
...
|     98015 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     98015 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     98015 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     98015 |  260 | `		pMap->apBucket = apNew;` |
|     98015 |  261 | `		pMap->nSize = nNew;` |
|     98015 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     92941 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5079 |  267 | `		pEntry = pMap->pFirst;` |
|      5079 |  268 | `		n = 0;` |
|   2107961 |  269 | `		for( ;; ){` |
|   4215927 |  270 | `			if( n >= pMap->nEntry ){` |
|      5079 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   4210853 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   4210853 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   4210853 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   3593763 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3593763 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1796879 |  280 | `			}` |
|   4210853 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   4210853 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   4210853 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5079 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2537 |  288 | `	}` |
|   3339823 |  289 | `	return SXRET_OK;` |
|   1716382 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3158962 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3158967 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3158929 |  310 | `		if( pValue ){` |
|   3158923 |  311 | `			sSafeVal = *pValue;` |
|   3158923 |  312 | `			pValue = &sSafeVal;` |
|   1579459 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3158929 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3158929 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3158929 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3158923 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1579459 |  322 | `		}` |
|   3158929 |  323 | `		nIdx = pObj->nIdx;` |
|   1579467 |  324 | `	}else{` |
|        39 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3158967 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3158967 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3158967 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3158967 |  334 | `	if( isForeign ){` |
...
|   3158967 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3158967 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3158967 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3158967 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3158967 |  349 | `	return SXRET_OK;` |
|   1579486 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    273792 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    273797 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    226025 |  370 | `		if( pValue ){` |
|    225735 |  371 | `			sSafeVal = *pValue;` |
|    225735 |  372 | `			pValue = &sSafeVal;` |
|    112865 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    226025 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    226025 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    226025 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    225735 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    112865 |  382 | `		}` |
|    226025 |  383 | `		nIdx = pObj->nIdx;` |
|    113015 |  384 | `	}else{` |
|     47777 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    273797 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    273797 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    273797 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    273797 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     47777 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23886 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    273797 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    273797 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    273797 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    273797 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    273797 |  409 | `	return SXRET_OK;` |
|    136901 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    409892 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    409897 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     36453 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    373449 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    373449 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    308358 |  475 | `	for(;;){` |
|    616721 |  476 | `		if( pNode == 0 ){` |
|    314059 |  477 | `			break;` |
|         - |  478 | `		}` |
|    302662 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    301151 |  480 | `			&& pNode->nHash == nHash` |
|    179565 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     59495 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     59395 |  484 | `				if( ppNode ){` |
|     59367 |  485 | `					*ppNode = pNode;` |
|     29681 |  486 | `				}` |
|     59395 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    243277 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    314059 |  493 | `	return SXERR_NOTFOUND;` |
|    204951 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    410024 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    410029 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    410029 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    410029 |  504 | `	int isNeg = FALSE, nDigit;` |
|    410029 |  505 | `	if( zIn >= zEnd ){` |
|       ! 0 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    410029 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    410025 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    410025 |  516 | `	zDigit = zIn;` |
|    205444 |  517 | `	for(;;){` |
|    410893 |  518 | `		if( zIn >= zEnd ){` |
|       251 |  519 | `			break;` |
|         - |  520 | `		}` |
|    410643 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    409775 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       869 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    141116 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    141121 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    141121 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    136267 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    136267 |  560 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|         - |  561 | `			/* Perform a blob lookup */` |
|    136247 |  562 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    136247 |  563 | `			goto result;` |
|         - |  564 | `		}` |
|        10 |  565 | `	}` |
...
|     70558 |  573 | `result:` |
|    141121 |  574 | `	if( rc == SXRET_OK ){` |
|         - |  575 | `		/* Node found */` |
|     63539 |  576 | `		if( ppNode ){` |
|     63489 |  577 | `			*ppNode = pNode;` |
|     31742 |  578 | `		}` |
|     63539 |  579 | `		return SXRET_OK;` |
|         - |  580 | `	}` |
|         - |  581 | `	/* No such entry */` |
|     77587 |  582 | `	return SXERR_NOTFOUND;` |
|     70563 |  583 | `}` |
|         - |  584 | `/*` |
...
|         - |  605 | ` */` |
|   1017128 |  606 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  607 | `{` |
|   1017133 |  608 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  609 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  610 | `		return TRUE;` |
|         - |  611 | `	}` |
|   1017127 |  612 | `	return FALSE;` |
|    508569 |  613 | `}` |
|         - |  614 | `/*` |
...
|         - |  619 | ` */` |
|   3384496 |  620 | `static sxi32 HashmapInsert(` |
|         - |  621 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  622 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  623 | `	ph7_value *pVal    /* Node value */` |
|         - |  624 | `	)` |
|         5 |  625 | `{` |
|   3384501 |  626 | `	ph7_hashmap_node *pNode = 0;` |
|   3384501 |  627 | `	sxi32 rc = SXRET_OK;` |
|   3384501 |  628 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    229533 |  629 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  630 | `			/* Force a string cast */` |
|         3 |  631 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  632 | `		}` |
|    229533 |  633 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
|      3777 |  634 | `			if(SyBlobLength(&pKey->sBlob) < 1){` |
|         - |  635 | `				/* Automatic index assign */` |
|      3549 |  636 | `				pKey = 0;` |
|      1772 |  637 | `			}` |
|      3777 |  638 | `			goto IntKey;` |
|         - |  639 | `		}` |
|    338639 |  640 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    112878 |  641 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  654 | `		}` |
|    225313 |  655 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    225183 |  668 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    225183 |  669 | `		return rc;` |
|         - |  670 | `	}` |
|   1577484 |  671 | `IntKey:` |
|   3158745 |  672 | `	if( pKey ){` |
...
|   1070730 |  702 | `		}` |
|   1070735 |  703 | `	}else{` |
|   1017103 |  704 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  705 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  706 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  707 | `		}` |
|   1017101 |  708 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  709 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  710 | `		}` |
|         - |  711 | `		/* Assign an automatic index */` |
|   1017095 |  712 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1017095 |  713 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1017093 |  714 | `			++pMap->iNextIdx;` |
|    508544 |  715 | `		}` |
|         - |  716 | `	}` |
|         - |  717 | `	/* Insertion result */` |
|   3158555 |  718 | `	return rc;` |
|   1692253 |  719 | `}` |
|         - |  720 | `/*` |
...
|         - |  746 | ` */` |
|     47820 |  747 | `static sxi32 HashmapInsertByRef(` |
|         - |  748 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  749 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  750 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  751 | `	)` |
|         5 |  752 | `{` |
|     47825 |  753 | `	ph7_hashmap_node *pNode = 0;` |
|     47825 |  754 | `	sxi32 rc = SXRET_OK;` |
|     47825 |  755 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     47789 |  756 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  757 | `			/* Force a string cast */` |
|       ! 0 |  758 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  759 | `		}` |
|     47789 |  760 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  765 | `			goto IntKey;` |
|         - |  766 | `		}` |
|     71678 |  767 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23891 |  768 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  769 | `				/* Overwrite */` |
...
|     47777 |  777 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     47777 |  778 | `		return rc;` |
|         - |  779 | `	}` |
|        18 |  780 | `IntKey:` |
|        39 |  781 | `	if( pKey ){` |
...
|         - |  814 | ` */` |
|   1443407 |  815 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  816 | `{` |
|         - |  817 | `	/* Point to the desired object */` |
|         - |  818 | `	ph7_value *pObj;` |
|   1443412 |  819 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1443412 |  820 | `	return pObj;` |
|         5 |  821 | `}` |
|         - |  822 | `/*` |
...
|         - |  864 | ` * documenation.` |
|         - |  865 | ` */` |
|     71680 |  866 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  867 | `{` |
|         - |  868 | `	ph7_value sObj1,sObj2;` |
|         - |  869 | `	sxi32 rc;` |
|     71685 |  870 | `	if( pLeft == pRight ){` |
|         - |  871 | `		/*` |
...
|     71685 |  878 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     71685 |  879 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     71685 |  880 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     71685 |  881 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     71685 |  882 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     71685 |  883 | `	PH7_MemObjRelease(&sObj1);` |
|     71685 |  884 | `	PH7_MemObjRelease(&sObj2);` |
|     71685 |  885 | `	return rc;` |
|     35852 |  886 | `}` |
|         - |  887 | `/*` |
...
|         - |  890 | ` */` |
|     13976 |  891 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  892 | `{` |
|     13981 |  893 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  894 | `	sxu32 nBucket;` |
|         - |  895 | `	/* Remove old collision links */` |
|     13981 |  896 | `	if( pEntry->pPrevCollide ){` |
|     11352 |  897 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5690 |  898 | `	}else{` |
|      2634 |  899 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  900 | `	}` |
|     13981 |  901 | `	if( pEntry->pNextCollide ){` |
|      1139 |  902 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       589 |  903 | `	}` |
|     13981 |  904 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  905 | `	/* Compute the new hash */` |
|     13981 |  906 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     13981 |  907 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     13981 |  908 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  909 | `	/* Link to the new bucket */` |
|     13981 |  910 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13981 |  911 | `	if( pMap->apBucket[nBucket] ){` |
|     11682 |  912 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5852 |  913 | `	}` |
|     13981 |  914 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13981 |  915 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     13981 |  919 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     13981 |  920 | `		pMap->iNextIdx++;` |
|      6988 |  921 | `	}` |
|     13981 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  929 | ` */` |
|     33456 |  930 | `static int HashmapFindValue(` |
...
|     33461 |  943 | `	pEntry = pMap->pFirst;` |
|     33461 |  944 | `	n = pMap->nEntry;` |
|     33461 |  945 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33461 |  946 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     79443 |  947 | `	for(;;){` |
|    158892 |  948 | `		if( n < 1 ){` |
|       115 |  949 | `			break;` |
|         - |  950 | `		}` |
|         - |  951 | `		/* Extract node value */` |
|    158778 |  952 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    158778 |  953 | `		if( pVal ){` |
...
|    158778 |  960 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    158778 |  961 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    158778 |  962 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    158778 |  963 | `			PH7_MemObjRelease(&sVal);` |
|    158778 |  964 | `			PH7_MemObjRelease(&sNeedle);` |
|    158778 |  965 | `			if( rc == 0 ){` |
|     33347 |  966 | `				if( ppNode ){` |
|        23 |  967 | `					*ppNode = pEntry;` |
|        11 |  968 | `				}` |
|         - |  969 | `				/* Match found*/` |
|     33347 |  970 | `				return SXRET_OK;` |
|         - |  971 | `			}` |
|     62715 |  972 | `		}` |
|         - |  973 | `		/* Point to the next entry */` |
|    125436 |  974 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    125436 |  975 | `		n--;` |
|         5 |  976 | `	}` |
|         - |  977 | `	/* No such entry */` |
...
|         - | 1164 | ` */` |
|    659302 | 1165 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1174 | `	sxi32 rc;` |
|         - | 1175 |  |
|    659307 | 1176 | `	if( pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ ){` |
...
|         7 | 1199 | `		return rc;` |
|         - | 1200 | `	}` |
|    659301 | 1201 | `	sSafeVal = *pVal;` |
|         - | 1202 |  |
|    659301 | 1203 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1204 | `		/* Blob key insertion */` |
|      4093 | 1205 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4093 | 1206 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4093 | 1207 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4093 | 1208 | `		PH7_MemObjRelease(&sKey);` |
|      2049 | 1209 | `	}else{` |
|         - | 1210 | `		/* Int key */` |
|    655213 | 1211 | `		if( iAction == 0 ){ /* Merge */` |
|    654971 | 1212 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    327728 | 1213 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    657789 | 1250 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1251 | `		/* Extract the node value */` |
|    655029 | 1252 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    655029 | 1253 | `		if( pVal ){` |
...
|         - | 1258 | `			 */` |
|    655029 | 1259 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    327517 | 1260 | `		}else{` |
|       ! 0 | 1261 | `			rc = SXRET_OK;` |
|         - | 1262 | `		}` |
|    655029 | 1263 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1264 | `			return rc;` |
|         - | 1265 | `		}` |
|         - | 1266 | `		/* Point to the next entry */` |
|    655029 | 1267 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    327517 | 1268 | `	}` |
...
|         - | 1319 | ` */` |
|      3994 | 1320 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1321 | `{` |
|         - | 1322 | `	ph7_hashmap_node *pEntry;` |
|         - | 1323 | `	ph7_value *pVal;` |
|         - | 1324 | `	sxi32 rc;` |
|         - | 1325 | `	sxu32 n;` |
|      3999 | 1326 | `	if( pSrc == pDest ){` |
...
|      3999 | 1333 | `	pEntry = pSrc->pFirst;` |
|         - | 1334 | `	/* Perform the duplication */` |
|      8233 | 1335 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1336 | `		/* Extract the node value */` |
|      4239 | 1337 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      4239 | 1338 | `		if( pVal ){` |
|      4239 | 1339 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      2122 | 1340 | `		}else{` |
|       ! 0 | 1341 | `			rc = SXRET_OK;` |
|         - | 1342 | `		}` |
|      4239 | 1343 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1344 | `			return rc;` |
|         - | 1345 | `		}` |
|         - | 1346 | `		/* Point to the next entry */` |
|      4239 | 1347 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      2122 | 1348 | `	}` |
|      3999 | 1349 | `	return SXRET_OK;` |
|      2002 | 1350 | `}` |
|         - | 1351 | `/*` |
...
|         - | 1425 | ` */` |
|    233524 | 1426 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1427 | `{` |
|    233529 | 1428 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1429 | `	ph7_hashmap *pNew;` |
|         - | 1430 | `	ph7_value *pBacking;` |
|         - | 1431 | `	sxu32 nValIdx;` |
|         - | 1432 | `	int bValueInPool;` |
|    233529 | 1433 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    233529 | 1434 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1435 | `		/* Sole owner, no separation needed */` |
|    230953 | 1436 | `		return pMap;` |
|         - | 1437 | `	}` |
|      2581 | 1438 | `	if( pMap == pVm->pGlobal ){` |
...
|      2455 | 1447 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2455 | 1448 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2450 | 1449 | `		if( pBacking && pBacking != pValue` |
|      2426 | 1450 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2407 | 1451 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1452 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2407 | 1453 | `			pMap->iRef--;` |
|      2407 | 1454 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1455 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2361 | 1456 | `				pMap->iRef++;` |
|      2361 | 1457 | `				return pMap;` |
|         - | 1458 | `			}` |
...
|         - | 1557 | ` */` |
|      3872 | 1558 | `PH7_PRIVATE sxi32 PH7_HashmapUnion(ph7_hashmap *pLeft,ph7_hashmap *pRight)` |
|         5 | 1559 | `{` |
|         - | 1560 | `	ph7_hashmap_node *pEntry;` |
|      3877 | 1561 | `	sxi32 rc = SXRET_OK;` |
|         - | 1562 | `	ph7_value *pObj;` |
|         - | 1563 | `	sxu32 n;` |
|      3877 | 1564 | `	if( pLeft == pRight ){` |
...
|      3877 | 1571 | `	pEntry = pRight->pFirst;` |
|      3911 | 1572 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
...
|    146117 | 1620 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    146117 | 1621 | `	if( pMap == 0 ){` |
|       ! 0 | 1622 | `		return 0;` |
|         - | 1623 | `	}` |
|         - | 1624 | `	/* Zero the structure */` |
|    146117 | 1625 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1626 | `	/* Fill in the structure */` |
|    146117 | 1627 | `	pMap->pVm = &(*pVm);` |
|    146117 | 1628 | `	pMap->iRef = 1;` |
|         - | 1629 | `	/* Default hash functions */` |
|    146117 | 1630 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    146117 | 1631 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    146117 | 1632 | `	return pMap;` |
|     73061 | 1633 | `}` |
|         - | 1634 | `/*` |
...
|         - | 1652 | `*    $_ENV` |
|         - | 1653 | `*/` |
|      3534 | 1654 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|         5 | 1655 | `{` |
...
|      3539 | 1674 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|      3539 | 1675 | `	if( pMap == 0 ){` |
|       ! 0 | 1676 | `		return SXERR_MEM;` |
|         - | 1677 | `	}` |
|      3539 | 1678 | `	pVm->pGlobal = pMap;` |
|         - | 1679 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|      3539 | 1680 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|      3539 | 1681 | `	if( pObj == 0 ){` |
|       ! 0 | 1682 | `		return SXERR_MEM;` |
|         - | 1683 | `	}` |
|      3539 | 1684 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|         - | 1685 | `	/* Record object index */` |
|      3539 | 1686 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|         - | 1687 | `	/* Install the special $GLOBALS array */` |
|      3539 | 1688 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|      3539 | 1689 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1690 | `		return rc;` |
|         - | 1691 | `	}` |
|         - | 1692 | `	/* Install superglobals now */` |
|     38879 | 1693 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|         - | 1694 | `		ph7_value *pSuper;` |
|         - | 1695 | `		/* Request an empty array */` |
|     35345 | 1696 | `		pSuper = ph7_new_array(&(*pVm));` |
|     35345 | 1697 | `		if( pSuper == 0 ){` |
|       ! 0 | 1698 | `			return SXERR_MEM;` |
|         - | 1699 | `		}` |
|         - | 1700 | `		/* Install */` |
|     35345 | 1701 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|     35345 | 1702 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1703 | `			return rc;` |
|         - | 1704 | `		}` |
|         - | 1705 | `		/* Release the value now it have been installed */` |
|     35345 | 1706 | `		ph7_release_value(&(*pVm),pSuper);` |
|     17675 | 1707 | `	}` |
|         - | 1708 | `	/* Set some $_SERVER entries */` |
|      3539 | 1709 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|         - | 1710 | `	/*` |
|         - | 1711 | `	 * 'SCRIPT_FILENAME'` |
|         - | 1712 | `	 * The absolute pathname of the currently executing script.` |
|         - | 1713 | `	 */` |
|      7073 | 1714 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|         - | 1715 | `		"SCRIPT_FILENAME",` |
|      1767 | 1716 | `		pFile ? pFile->zString : ":Memory:",` |
|      3534 | 1717 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|         - | 1718 | `		);` |
|         - | 1719 | `	/* All done,all super-global are installed now */` |
|      3539 | 1720 | `	return SXRET_OK;` |
|      1772 | 1721 | `}` |
|         - | 1722 | `/*` |
|         - | 1723 | ` * Release a hashmap.` |
|         - | 1724 | ` */` |
|    102174 | 1725 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1726 | `{` |
|         - | 1727 | `	ph7_hashmap_node *pEntry,*pNext;` |
|    102179 | 1728 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1729 | `	sxu32 n;` |
|    102179 | 1730 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1734 | `	}` |
|    102179 | 1735 | `	if( pMap->pActiveSteps ){` |
...
|    102179 | 1748 | `	n = 0;` |
|    102179 | 1749 | `	pEntry = pMap->pFirst;` |
|   1722969 | 1750 | `	for(;;){` |
|   3445943 | 1751 | `		if( n >= pMap->nEntry ){` |
|    102179 | 1752 | `			break;` |
|         - | 1753 | `		}` |
|   3343769 | 1754 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1755 | `		/* Remove the reference from the foreign table */` |
|   3343769 | 1756 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3343769 | 1757 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1758 | `			/* Restore the ph7_value to the free list */` |
|   3343759 | 1759 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1671877 | 1760 | `		}` |
|         - | 1761 | `		/* Release the node */` |
|   3343769 | 1762 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    196755 | 1763 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     98375 | 1764 | `		}` |
|   3343769 | 1765 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1766 | `		/* Point to the next entry */` |
|   3343769 | 1767 | `		pEntry = pNext;` |
|   3343769 | 1768 | `		n++;` |
|         5 | 1769 | `	}` |
|    102179 | 1770 | `	if( pMap->nEntry > 0 ){` |
|         - | 1771 | `		/* Release the hash bucket */` |
|     77135 | 1772 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     38565 | 1773 | `	}` |
|    102179 | 1774 | `	if( FreeDS ){` |
|         - | 1775 | `		/* Free the whole instance */` |
|    102153 | 1776 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     51079 | 1777 | `	}else{` |
...
|         - | 1790 | ` */` |
|    845632 | 1791 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1792 | `{` |
|    845637 | 1793 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1794 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    845637 | 1795 | `	pMap->iRef--;` |
|    845637 | 1796 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|    102133 | 1797 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     51064 | 1798 | `	}` |
|    845637 | 1799 | `}` |
|         - | 1800 | `/*` |
...
|         - | 1804 | ` */` |
|    141286 | 1805 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1825 | ` */` |
|   2729278 | 1826 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2729283 | 1837 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2729283 | 1838 | `	return rc;` |
|         5 | 1839 | `}` |
|         - | 1840 | `/*` |
...
|         - | 1876 | ` */` |
|     47814 | 1877 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1882 | `{` |
|         - | 1883 | `	sxi32 rc;` |
|     47819 | 1884 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1890 | `	}` |
|     47819 | 1891 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     47819 | 1892 | `	return rc;` |
|     23912 | 1893 | `}` |
|         - | 1894 | `/*` |
...
|         - | 1901 | ` */` |
|     18962 | 1902 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1903 | `{` |
|     18967 | 1904 | `	pStep->pCursor = pMap->pFirst;` |
|     18967 | 1905 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     18967 | 1906 | `	pMap->pActiveSteps = pStep;` |
|     18967 | 1907 | `}` |
|         - | 1908 | `/*` |
...
|         - | 1913 | ` */` |
|     18862 | 1914 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1915 | `{` |
|     18867 | 1916 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     18867 | 1917 | `	while( *ppLink ){` |
|     18867 | 1918 | `		if( *ppLink == pStep ){` |
|     18867 | 1919 | `			*ppLink = pStep->pNextActive;` |
|     18867 | 1920 | `			pStep->pNextActive = 0;` |
|     18867 | 1921 | `			return;` |
|         - | 1922 | `		}` |
...
|         - | 1945 | ` */` |
|    591128 | 1946 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1947 | `{` |
|    591133 | 1948 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    591133 | 1949 | `	if( pEntry ){` |
|    591133 | 1950 | `		if( bStore ){` |
|    234423 | 1951 | `			PH7_MemObjStore(pEntry,pValue);` |
|    117214 | 1952 | `		}else{` |
...
|         - | 1961 | ` */` |
|    155554 | 1962 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 1963 | `{` |
|         - | 1964 | `	/* Fill with the current key */` |
|    155559 | 1965 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    150275 | 1966 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 1967 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 1968 | `		}` |
|    150275 | 1969 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    150275 | 1970 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     75140 | 1971 | `	}else{` |
|      5289 | 1972 | `		SyBlobReset(&pKey->sBlob);` |
|      5289 | 1973 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5289 | 1974 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 1975 | `	}` |
|    155559 | 1976 | `}` |
...
|         - | 2025 | `**   changed.` |
|         - | 2026 | `*/` |
|     35802 | 2027 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2028 | `{` |
|         - | 2029 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2030 | `    /* Prevent compiler warning */` |
|     35807 | 2031 | `	result.pNext = result.pPrev = 0;` |
|     35807 | 2032 | `	pTail = &result;` |
|    107631 | 2033 | `	while( pA && pB ){` |
|     71829 | 2034 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47484 | 2035 | `			pTail->pPrev = pA;` |
|     47484 | 2036 | `			pA->pNext = pTail;` |
|     47484 | 2037 | `			pTail = pA;` |
|     47484 | 2038 | `			pA = pA->pPrev;` |
|     23739 | 2039 | `		}else{` |
|     24350 | 2040 | `			pTail->pPrev = pB;` |
|     24350 | 2041 | `			pB->pNext = pTail;` |
|     24350 | 2042 | `			pTail = pB;` |
|     24350 | 2043 | `			pB = pB->pPrev;` |
|         - | 2044 | `		}` |
|         5 | 2045 | `	}` |
|     35807 | 2046 | `	if( pA ){` |
|     25283 | 2047 | `		pTail->pPrev = pA;` |
|     25283 | 2048 | `		pA->pNext = pTail;` |
|     23199 | 2049 | `	}else if( pB ){` |
|     10305 | 2050 | `		pTail->pPrev = pB;` |
|     10305 | 2051 | `		pB->pNext = pTail;` |
|      5124 | 2052 | `	}else{` |
|       229 | 2053 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2054 | `	}` |
|     35807 | 2055 | `	return result.pPrev;` |
|         5 | 2056 | `}` |
|         - | 2057 | `/*` |
|         - | 2058 | `** Inputs:` |
...
|     14739 | 2076 | `	while( pIn ){` |
|     13993 | 2077 | `		p = pIn;` |
|     13993 | 2078 | `		pIn = p->pPrev;` |
|     13993 | 2079 | `		p->pPrev = 0;` |
|     26669 | 2080 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     26669 | 2081 | `			if( a[i]==0 ){` |
|     13993 | 2082 | `				a[i] = p;` |
|     13993 | 2083 | `				break;` |
|       ! 0 | 2084 | `			}else{` |
|     12681 | 2085 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12681 | 2086 | `				a[i] = 0;` |
|         - | 2087 | `			}` |
|      6343 | 2088 | `		}` |
|     13993 | 2089 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|         - | 2111 | ` */` |
|     71550 | 2112 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2113 | `{` |
|         - | 2114 | `	ph7_value sA,sB;` |
|         - | 2115 | `	sxi32 iFlags;` |
|         - | 2116 | `	int rc;` |
|     71555 | 2117 | `	if( pCmpData == 0 ){` |
|         - | 2118 | `		/* Perform a standard comparison */` |
|     71531 | 2119 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|     71531 | 2120 | `		return rc;` |
|         - | 2121 | `	}` |
...
|         - | 2403 | ` */` |
|        22 | 2404 | `static sxi32 HashmapCmpCallback7(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         1 | 2405 | `{` |
|         - | 2406 | `	sxu32 n;` |
|        13 | 2407 | `	SXUNUSED(pB); /* cc warning */` |
|        13 | 2408 | `	SXUNUSED(pCmpData);` |
|         - | 2409 | `	/* Grab a random number */` |
|        23 | 2410 | `	n = PH7_VmRandomNum(pA->pMap->pVm);` |
...
|         2 | 2438 | `		}` |
|     13757 | 2439 | `		HashmapRehashIntNode(p);` |
|         - | 2440 | `		/* Point to the next entry */` |
|     13757 | 2441 | `		i++;` |
|     13757 | 2442 | `		pLast = p;` |
|     13757 | 2443 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2444 | `	}` |
|       681 | 2445 | `}` |
|         - | 2446 | `/*` |
...
|        10 | 2981 | `			return PH7_VmThrowException(pCtx,` |
|         - | 2982 | `				"ValueError",` |
...
|        92 | 3043 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|         - | 4827 | ` */` |
|     33264 | 4828 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4829 | `{` |
|         - | 4830 | `	ph7_value *pNeedle;` |
|         - | 4831 | `	int bStrict;` |
|         - | 4832 | `	int rc;` |
|     33269 | 4833 | `	if( nArg < 2 ){` |
|         - | 4834 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4835 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4836 | `		return PH7_OK;` |
|         - | 4837 | `	}` |
|     33269 | 4838 | `	pNeedle = apArg[0];` |
|     33269 | 4839 | `	bStrict = 0;` |
|     33269 | 4840 | `	if( nArg > 2 ){` |
|        53 | 4841 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4842 | `	}` |
|     33269 | 4843 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33269 | 4851 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4852 | `	/* Lookup result */` |
|     33269 | 4853 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33269 | 4854 | `	return PH7_OK;` |
|     16637 | 4855 | `}` |
|         - | 4856 | `/*` |
...
|         5 | 6985 | `				pNode = pNode->pPrev; /* Reverse link */` |
|         5 | 6986 | `				nEntry--;` |
|       ! 0 | 6987 | `			}` |
|         - | 6988 | `		}` |
...
|         - | 8659 | ` */` |
|      3528 | 8660 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 8661 | `{` |
|         - | 8662 | `	sxu32 n;` |
|    264605 | 8663 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    261077 | 8664 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    130541 | 8665 | `	}` |
|      3533 | 8666 | `}` |
|         - | 8667 | `/*` |
...
|         - | 8681 | ` */` |
|       114 | 8682 | `PH7_PRIVATE sxi32 PH7_HashmapDumpEntries(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         3 | 8683 | `{` |
|       117 | 8684 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 8685 | `	ph7_value *pObj;` |
|       117 | 8686 | `	sxu32 n = 0;` |
|         - | 8687 | `	int isRef;` |
|       117 | 8688 | `	sxi32 rc = SXRET_OK;` |
|         - | 8689 | `	int i;` |
|       182 | 8690 | `	for(;;){` |
|       367 | 8691 | `		if( n >= pMap->nEntry ){` |
|       117 | 8692 | `			break;` |
|         - | 8693 | `		}` |
|       253 | 8694 | `		pObj = HashmapExtractNodeValue(pEntry);` |
|       253 | 8695 | `		isRef = (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0;` |
|       253 | 8696 | `		if( ShowType ){` |
...
|      1194 | 8719 | `			for( i = 0 ; i < nTab + 4 ; i++ ){` |
|       978 | 8720 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|       490 | 8721 | `			}` |
|       218 | 8722 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|       105 | 8723 | `				SyBlobFormat(&(*pOut),"[%qd] => ",pEntry->xKey.iKey);` |
|        53 | 8724 | `			}else{` |
|       170 | 8725 | `				SyBlobFormat(&(*pOut),"[%.*s] => ",` |
|        56 | 8726 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 8727 | `			}` |
|       216 | 8728 | `			if( pObj && (pObj->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ))` |
|       122 | 8729 | `			 && (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
...
|        13 | 8735 | `			}else{` |
|       194 | 8736 | `				if( pObj ){` |
|       194 | 8737 | `					PH7_MemObjPrintRInline(&(*pOut),pObj);` |
|        96 | 8738 | `				}` |
|       194 | 8739 | `				SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|         - | 8740 | `			}` |
|         - | 8741 | `		}` |
|         - | 8742 | `		/* Point to the next entry */` |
|       253 | 8743 | `		n++;` |
|       253 | 8744 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         3 | 8745 | `	}` |
|       117 | 8746 | `	return rc;` |
|         3 | 8747 | `}` |
|       110 | 8748 | `PH7_PRIVATE sxi32 PH7_HashmapDump(SyBlob *pOut,ph7_hashmap *pMap,int ShowType,int nTab,int nDepth)` |
|         2 | 8749 | `{` |
|         - | 8750 | `	sxi32 rc;` |
|         - | 8751 | `	int i;` |
|       112 | 8752 | `	if( nDepth > 31 ){` |
...
|         - | 8769 | `	}` |
|         - | 8770 | ``	/* print_r: `Array\n<nTab>(\n … <nTab>)\n` */`` |
|        99 | 8771 | `	SyBlobAppend(&(*pOut),"Array\n",sizeof("Array\n")-1);` |
|       291 | 8772 | `	for( i = 0 ; i < nTab ; i++ ){` |
|       193 | 8773 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        97 | 8774 | `	}` |
|        99 | 8775 | `	SyBlobAppend(&(*pOut),"(\n",sizeof("(\n")-1);` |
|        99 | 8776 | `	rc = PH7_HashmapDumpEntries(&(*pOut),pMap,FALSE,nTab,nDepth);` |
|       291 | 8777 | `	for( i = 0 ; i < nTab ; i++ ){` |
|       193 | 8778 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        97 | 8779 | `	}` |
|        99 | 8780 | `	SyBlobAppend(&(*pOut),")\n",sizeof(")\n")-1);` |
|        99 | 8781 | `	return rc;` |
|        57 | 8782 | `}` |
|         - | 8783 | `/*` |
...
|         - | 8791 | ` */` |
|     34186 | 8792 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34191 | 8803 | `	rc = SXRET_OK;` |
|     34191 | 8804 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34191 | 8805 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34191 | 8806 | `	n = pMap->nEntry;` |
|     34191 | 8807 | `	pEntry = pMap->pFirst;` |
...
|    150009 | 8814 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    150009 | 8815 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8816 | `		/* Invoke the user callback */` |
|    150009 | 8817 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8818 | `		/* Release the copy of the key and the value */` |
|    150009 | 8819 | `		PH7_MemObjRelease(&sKey);` |
|    150009 | 8820 | `		PH7_MemObjRelease(&sValue);` |
|    150009 | 8821 | `		if( rc != PH7_OK ){` |
|         - | 8822 | `			/* Callback request an operation abort */` |
|       ! 0 | 8823 | `			return SXERR_ABORT;` |
|         - | 8824 | `		}` |
|         - | 8825 | `		/* Point to the next entry */` |
|    150009 | 8826 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    150009 | 8827 | `		n--;` |
|         5 | 8828 | `	}` |
|         - | 8829 | `	/* All done */` |
|     34191 | 8830 | `	return SXRET_OK;` |
|     17098 | 8831 | `}` |
|         - | 8832 |  |
