...
|       - |   17 | ` */` |
| 2967770 |   18 | `static sxu32 IntHash(sxi64 iKey)` |
|       2 |   19 |  |
| 2967772 |   20 | `	return (sxu32)(iKey ^ (iKey << 8) ^ (iKey >> 8));` |
|       2 |   21 |  |
|       - |   22 | `/*` |
|       - |   23 | ` * Default hash function for string/BLOB keys.` |
|       - |   24 | ` */` |
|  294242 |   25 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|       2 |   26 |  |
|  294244 |   27 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|       - |   28 | `	unsigned char *zEnd;` |
|  294244 |   29 | `	sxu32 nH = 5381;` |
|  294244 |   30 | `	zEnd = &zIn[nLen];` |
|  329092 |   31 | `	for(;;){` |
|  658186 |   32 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  579092 |   33 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  520326 |   34 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|  429046 |   35 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|       2 |   36 | `	}` |
|  294244 |   37 | `	return nH;` |
|       2 |   38 |  |
|       - |   39 | `/*` |
...
|       - |   92 | ` */` |
| 2909826 |   93 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|       2 |   94 |  |
|       - |   95 | `	ph7_hashmap_node *pNode;` |
|       - |   96 | `	/* Allocate a new node */` |
| 2909828 |   97 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
| 2909828 |   98 | `	if( pNode == 0 ){` |
|     ! 0 |   99 | `		return 0;` |
|       - |  100 | `	}` |
|       - |  101 | `	/* Zero the stucture */` |
| 2909828 |  102 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  103 | `	/* Fill in the structure */` |
| 2909828 |  104 | `	pNode->pMap  = &(*pMap);` |
| 2909828 |  105 | `	pNode->iType = HASHMAP_INT_NODE;` |
| 2909828 |  106 | `	pNode->nHash = nHash;` |
| 2909828 |  107 | `	pNode->xKey.iKey = iKey;` |
| 2909828 |  108 | `	pNode->nValIdx  = nValIdx;` |
| 2909828 |  109 | `	return pNode;` |
| 1454915 |  110 |  |
|       - |  111 | `/*` |
...
|       - |  115 | ` */` |
|  101942 |  116 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|       2 |  117 |  |
|       - |  118 | `	ph7_hashmap_node *pNode;` |
|       - |  119 | `	/* Allocate a new node */` |
|  101944 |  120 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|  101944 |  121 | `	if( pNode == 0 ){` |
|     ! 0 |  122 | `		return 0;` |
|       - |  123 | `	}` |
|       - |  124 | `	/* Zero the stucture */` |
|  101944 |  125 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|       - |  126 | `	/* Fill in the structure */` |
|  101944 |  127 | `	pNode->pMap  = &(*pMap);` |
|  101944 |  128 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|  101944 |  129 | `	pNode->nHash = nHash;` |
|  101944 |  130 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|  101944 |  131 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|  101944 |  132 | `	pNode->nValIdx = nValIdx;` |
|  101944 |  133 | `	return pNode;` |
|   50973 |  134 |  |
|       - |  135 | `/*` |
|       - |  136 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|       - |  137 | ` */` |
| 3011768 |  138 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|       2 |  139 |  |
|       - |  140 | `	/* Link */` |
| 3011770 |  141 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
| 2731234 |  142 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
| 2731234 |  143 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
| 1365616 |  144 | `	}` |
| 3011770 |  145 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|       - |  146 | `	/* Link to the map list */` |
| 3011770 |  147 | `	if( pMap->pFirst == 0 ){` |
|   49596 |  148 | `		pMap->pFirst = pMap->pLast = pNode;` |
|       - |  149 | `		/* Point to the first inserted node */` |
|   49596 |  150 | `		pMap->pCur = pNode;` |
|   24799 |  151 | `	}else{` |
| 2962176 |  152 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|       - |  153 | `	}` |
| 3011770 |  154 | `	++pMap->nEntry;` |
| 3011770 |  155 |  |
|       - |  156 | `/*` |
|       - |  157 | ` * Unlink a node from the hashmap.` |
|       - |  158 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|       - |  159 | ` */` |
|    7480 |  160 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|       2 |  161 |  |
|    7482 |  162 | `	ph7_hashmap *pMap = pNode->pMap;` |
|    7482 |  163 | `	ph7_vm *pVm = pMap->pVm;` |
|       - |  164 | `	/* Unlink from the corresponding bucket */` |
|    7482 |  165 | `	if( pNode->pPrevCollide == 0 ){` |
|    7040 |  166 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|    3521 |  167 | `	}else{` |
|     443 |  168 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|       - |  169 | `	}` |
|    7482 |  170 | `	if( pNode->pNextCollide ){` |
|    5502 |  171 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|    2750 |  172 | `	}` |
|    7482 |  173 | `	if( pMap->pFirst == pNode ){` |
|      82 |  174 | `		pMap->pFirst = pNode->pPrev;` |
|      40 |  175 | `	}` |
|    7482 |  176 | `	if( pMap->pCur == pNode ){` |
|       - |  177 | `		/* Advance the node cursor */` |
|      84 |  178 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|      41 |  179 | `	}` |
|       - |  180 | `	/* Unlink from the map list */` |
|    7482 |  181 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|    7482 |  182 | `	if( bRestore ){` |
...
|      51 |  188 | `		}` |
|      51 |  189 | `	}` |
|    7482 |  190 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|    7356 |  191 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|    3677 |  192 | `	}` |
|    7482 |  193 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|    7482 |  194 | `	pMap->nEntry--;` |
|    7482 |  195 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|       - |  206 | ` */` |
| 3011768 |  207 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|       2 |  208 |  |
| 3011770 |  209 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|   53758 |  210 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|       - |  211 | `		ph7_hashmap_node *pEntry,**apNew;` |
|   53758 |  212 | `		sxu32 nNew = pMap->nSize << 1;` |
|       - |  213 | `		sxu32 nBucket;` |
|       - |  214 | `		sxu32 n;` |
|   53758 |  215 | `		if( nNew < 1 ){` |
|   49596 |  216 | `			nNew = 16;` |
...
|   53758 |  219 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|   53758 |  220 | `		if( apNew == 0 ){` |
...
|       - |  226 | `		}` |
|       - |  227 | `		/* Zero the table */` |
|   53758 |  228 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|       - |  229 | `		/* Reflect the change */` |
|   53758 |  230 | `		pMap->apBucket = apNew;` |
|   53758 |  231 | `		pMap->nSize = nNew;` |
|   53758 |  232 | `		if( apOld == 0 ){` |
|       - |  233 | `			/* First allocated table [i.e: no entry],return immediately */` |
|   49596 |  234 | `			return SXRET_OK;` |
|       - |  235 | `		}` |
|       - |  236 | `		/* Rehash old entries */` |
|    4164 |  237 | `		pEntry = pMap->pFirst;` |
|    4164 |  238 | `		n = 0;` |
| 2014529 |  239 | `		for( ;; ){` |
| 4029060 |  240 | `			if( n >= pMap->nEntry ){` |
|    4164 |  241 | `				break;` |
|       - |  242 | `			}` |
|       - |  243 | `			/* Clear the old collision link */` |
| 4024898 |  244 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  245 | `			/* Link to the new bucket */` |
| 4024898 |  246 | `			nBucket = pEntry->nHash & (nNew - 1);` |
| 4024898 |  247 | `			if( pMap->apBucket[nBucket] != 0 ){` |
| 3496556 |  248 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
| 3496556 |  249 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
| 1748277 |  250 | `			}` |
| 4024898 |  251 | `			pMap->apBucket[nBucket] = pEntry;` |
|       - |  252 | `			/* Point to the next entry */` |
| 4024898 |  253 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
| 4024898 |  254 | `			n++;` |
|       2 |  255 | `		}` |
|       - |  256 | `		/* Free the old table */` |
|    4164 |  257 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|    2081 |  258 | `	}` |
| 2962176 |  259 | `	return SXRET_OK;` |
| 1505886 |  260 |  |
|       - |  261 | `/*` |
|       - |  262 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|       - |  263 | ` * hashmap.` |
|       - |  264 | ` */` |
| 2909826 |  265 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  266 |  |
|       - |  267 | `	ph7_hashmap_node *pNode;` |
|       - |  268 | `	sxu32 nIdx;` |
|       - |  269 | `	sxu32 nHash;` |
|       - |  270 | `	sxi32 rc;` |
| 2909828 |  271 | `	if( !isForeign ){` |
|       - |  272 | `		ph7_value *pObj;` |
|       - |  273 | `		/* Reserve a ph7_value for the value */` |
| 2909802 |  274 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
| 2909802 |  275 | `		if( pObj == 0 ){` |
|     ! 0 |  276 | `			return SXERR_MEM;` |
|       - |  277 | `		}` |
| 2909802 |  278 | `		if( pValue ){` |
|       - |  279 | `			/* Duplicate the value */` |
| 2909802 |  280 | `			PH7_MemObjStore(pValue,pObj);` |
| 1454900 |  281 | `		}` |
| 2909802 |  282 | `		nIdx = pObj->nIdx;` |
| 1454902 |  283 | `	}else{` |
|      27 |  284 | `		nIdx = nRefIdx;` |
|       - |  285 | `	}` |
|       - |  286 | `	/* Hash the key */` |
| 2909828 |  287 | `	nHash = pMap->xIntHash(iKey);` |
|       - |  288 | `	/* Allocate a new int node */` |
| 2909828 |  289 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
| 2909828 |  290 | `	if( pNode == 0 ){` |
|     ! 0 |  291 | `		return SXERR_MEM;` |
|       - |  292 | `	}` |
| 2909828 |  293 | `	if( isForeign ){` |
...
| 2909828 |  298 | `	rc = HashmapGrowBucket(&(*pMap));` |
| 2909828 |  299 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  300 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  301 | `		return rc;` |
|       - |  302 | `	}` |
|       - |  303 | `	/* Perform the insertion */` |
| 2909828 |  304 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  305 | `	/* Install in the reference table */` |
| 2909828 |  306 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  307 | `	/* All done */` |
| 2909828 |  308 | `	return SXRET_OK;` |
| 1454915 |  309 |  |
|       - |  310 | `/*` |
|       - |  311 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|       - |  312 | ` * hashmap.` |
|       - |  313 | ` */` |
|  101942 |  314 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|       2 |  315 |  |
|       - |  316 | `	ph7_hashmap_node *pNode;` |
|       - |  317 | `	sxu32 nHash;` |
|       - |  318 | `	sxu32 nIdx;` |
|       - |  319 | `	sxi32 rc;` |
|  101944 |  320 | `	if( !isForeign ){` |
|       - |  321 | `		ph7_value *pObj;` |
|       - |  322 | `		/* Reserve a ph7_value for the value */` |
|   68620 |  323 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   68620 |  324 | `		if( pObj == 0 ){` |
|     ! 0 |  325 | `			return SXERR_MEM;` |
|       - |  326 | `		}` |
|   68620 |  327 | `		if( pValue ){` |
|       - |  328 | `			/* Duplicate the value */` |
|   68348 |  329 | `			PH7_MemObjStore(pValue,pObj);` |
|   34173 |  330 | `		}` |
|   68620 |  331 | `		nIdx = pObj->nIdx;` |
|   34311 |  332 | `	}else{` |
|   33326 |  333 | `		nIdx = nRefIdx;` |
|       - |  334 | `	}` |
|       - |  335 | `	/* Hash the key */` |
|  101944 |  336 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  337 | `	/* Allocate a new blob node */` |
|  101944 |  338 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|  101944 |  339 | `	if( pNode == 0 ){` |
|     ! 0 |  340 | `		return SXERR_MEM;` |
|       - |  341 | `	}` |
|  101944 |  342 | `	if( isForeign ){` |
|       - |  343 | `		/* Mark as a foregin entry */` |
|   33326 |  344 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|   16662 |  345 | `	}` |
|       - |  346 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|  101944 |  347 | `	rc = HashmapGrowBucket(&(*pMap));` |
|  101944 |  348 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  349 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|     ! 0 |  350 | `		return rc;` |
|       - |  351 | `	}` |
|       - |  352 | `	/* Perform the insertion */` |
|  101944 |  353 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|       - |  354 | `	/* Install in the reference table */` |
|  101944 |  355 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|       - |  356 | `	/* All done */` |
|  101944 |  357 | `	return SXRET_OK;` |
|   50973 |  358 |  |
|       - |  359 | `/*` |
...
|       - |  404 | ` */` |
|  204384 |  405 | `static sxi32 HashmapLookupBlobKey(` |
...
|       - |  413 | `	sxu32 nHash;` |
|  204386 |  414 | `	if( pMap->nEntry < 1 ){` |
|       - |  415 | `		/* Don't bother hashing,there is no entry anyway */` |
|   12086 |  416 | `		return SXERR_NOTFOUND;` |
|       - |  417 | `	}` |
|       - |  418 | `	/* Hash the key first */` |
|  192302 |  419 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|       - |  420 | `	/* Point to the appropriate bucket */` |
|  192302 |  421 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|       - |  422 | `	/* Perform the lookup */` |
|  176907 |  423 | `	for(;;){` |
|  353816 |  424 | `		if( pNode == 0 ){` |
|  147032 |  425 | `			break;` |
|       - |  426 | `		}` |
|  229419 |  427 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|  205285 |  428 | `			&& pNode->nHash == nHash` |
|  124528 |  429 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|   45272 |  430 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|       - |  431 | `				/* Node found */` |
|   45272 |  432 | `				if( ppNode ){` |
|   45244 |  433 | `					*ppNode = pNode;` |
|   22621 |  434 | `				}` |
|   45272 |  435 | `				return SXRET_OK;` |
|       - |  436 | `		}` |
|       - |  437 | `		/* Follow the collision link */` |
|  161516 |  438 | `		pNode = pNode->pNextCollide;` |
|       2 |  439 | `	}` |
|       - |  440 | `	/* No such entry */` |
|  147032 |  441 | `	return SXERR_NOTFOUND;` |
|  102194 |  442 |  |
|       - |  443 | `/*` |
|       - |  444 | ` * Check if the given BLOB key looks like a decimal number.` |
|       - |  445 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|       - |  446 | ` */` |
|  204526 |  447 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|       2 |  448 |  |
|  204528 |  449 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|  204528 |  450 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|  204528 |  451 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|       - |  452 | `		/* Octal not decimal number */` |
|       5 |  453 | `		return FALSE;` |
|       - |  454 | `	}` |
|  204524 |  455 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|     ! 0 |  456 | `		zIn++;` |
|     ! 0 |  457 | `	}` |
|  102594 |  458 | `	for(;;){` |
|  205190 |  459 | `		if( zIn >= zEnd ){` |
|     233 |  460 | `			return TRUE;` |
|       - |  461 | `		}` |
|  204958 |  462 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|  102147 |  463 | `			break;` |
|       - |  464 | `		}` |
|     667 |  465 | `		zIn++;` |
|       1 |  466 | `	}` |
|       - |  467 | `	/* Key does not look like a decimal number */` |
|  204292 |  468 | `	return FALSE;` |
|  102265 |  469 |  |
|       - |  470 | `/*` |
...
|       - |  474 | ` */` |
|  103532 |  475 | `static sxi32 HashmapLookup(` |
|       - |  476 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|       - |  477 | `	ph7_value *pKey,            /* Lookup key */` |
|       - |  478 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|       - |  479 | `	)` |
|       2 |  480 |  |
|  103534 |  481 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|       - |  482 | `	sxi32 rc;` |
|  103534 |  483 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|  102406 |  484 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  485 | `			/* Force a string cast */` |
|     ! 0 |  486 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  487 | `		}` |
|  102406 |  488 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|       - |  489 | `			/* Perform a blob lookup */` |
|  102390 |  490 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|  102390 |  491 | `			goto result;` |
|       - |  492 | `		}` |
|       8 |  493 | `	}` |
...
|   51766 |  501 | `result:` |
|  103534 |  502 | `	if( rc == SXRET_OK ){` |
|       - |  503 | `		/* Node found */` |
|   46292 |  504 | `		if( ppNode ){` |
|   46258 |  505 | `			*ppNode = pNode;` |
|   23128 |  506 | `		}` |
|   46292 |  507 | `		return SXRET_OK;` |
|       - |  508 | `	}` |
|       - |  509 | `	/* No such entry */` |
|   57244 |  510 | `	return SXERR_NOTFOUND;` |
|   51768 |  511 |  |
|       - |  512 | `/*` |
...
|       - |  517 | ` */` |
| 2978118 |  518 | `static sxi32 HashmapInsert(` |
|       - |  519 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|       - |  520 | `	ph7_value *pKey,   /* Lookup key  */` |
|       - |  521 | `	ph7_value *pVal    /* Node value */` |
|       - |  522 | `	)` |
|       2 |  523 |  |
| 2978120 |  524 | `	ph7_hashmap_node *pNode = 0;` |
| 2978120 |  525 | `	sxi32 rc = SXRET_OK;` |
| 2978120 |  526 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   68832 |  527 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  528 | `			/* Force a string cast */` |
|       3 |  529 | `			PH7_MemObjToString(&(*pKey));` |
|       1 |  530 | `		}` |
|   68832 |  531 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     256 |  536 | `			goto IntKey;` |
|       - |  537 | `		}` |
|  102866 |  538 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   34288 |  539 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|       - |  552 | `		}` |
|   68524 |  553 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  554 | `			/* Forbidden */` |
...
|   68522 |  559 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|   68522 |  560 | `		return rc;` |
|       - |  561 | `	}` |
| 1454644 |  562 | `IntKey:` |
| 2909544 |  563 | `	if( pKey ){` |
...
|   11644 |  598 | `		}` |
|   11646 |  599 | `	}else{` |
| 2886174 |  600 | `		if( pMap == pMap->pVm->pGlobal ){` |
|       - |  601 | `			/* Forbidden */` |
...
| 2886172 |  606 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
| 2886172 |  607 | `		if( rc == SXRET_OK ){` |
| 2886172 |  608 | `			++pMap->iNextIdx;` |
| 1443085 |  609 | `		}` |
|       - |  610 | `	}` |
|       - |  611 | `	/* Insertion result */` |
| 2909460 |  612 | `	return rc;` |
| 1489061 |  613 |  |
|       - |  614 | `/*` |
...
|       - |  640 | ` */` |
|   33356 |  641 | `static sxi32 HashmapInsertByRef(` |
|       - |  642 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|       - |  643 | `	ph7_value *pKey,     /* Lookup key */` |
|       - |  644 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|       - |  645 | `	)` |
|       2 |  646 |  |
|   33358 |  647 | `	ph7_hashmap_node *pNode = 0;` |
|   33358 |  648 | `	sxi32 rc = SXRET_OK;` |
|   33358 |  649 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|   33332 |  650 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - |  651 | `			/* Force a string cast */` |
|     ! 0 |  652 | `			PH7_MemObjToString(&(*pKey));` |
|     ! 0 |  653 | `		}` |
|   33332 |  654 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|     ! 0 |  659 | `			goto IntKey;` |
|       - |  660 | `		}` |
|   49997 |  661 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|   16665 |  662 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|       - |  663 | `				/* Overwrite */` |
...
|   33326 |  671 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|   33326 |  672 | `		return rc;` |
|       - |  673 | `	}` |
|      13 |  674 | `IntKey:` |
|      27 |  675 | `	if( pKey ){` |
...
|       - |  712 | ` */` |
| 1106596 |  713 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|       2 |  714 |  |
|       - |  715 | `	/* Point to the desired object */` |
|       - |  716 | `	ph7_value *pObj;` |
| 1106598 |  717 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
| 1106598 |  718 | `	return pObj;` |
|       2 |  719 |  |
|       - |  720 | `/*` |
...
|       - |  762 | ` * documenation.` |
|       - |  763 | ` */` |
|   51612 |  764 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|       2 |  765 |  |
|       - |  766 | `	ph7_value sObj1,sObj2;` |
|       - |  767 | `	sxi32 rc;` |
|   51614 |  768 | `	if( pLeft == pRight ){` |
|       - |  769 | `		/*` |
...
|   51614 |  776 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|   51614 |  777 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|   51614 |  778 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|   51614 |  779 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|   51614 |  780 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|   51614 |  781 | `	PH7_MemObjRelease(&sObj1);` |
|   51614 |  782 | `	PH7_MemObjRelease(&sObj2);` |
|   51614 |  783 | `	return rc;` |
|   25817 |  784 |  |
|       - |  785 | `/*` |
...
|       - |  788 | ` */` |
|   10736 |  789 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|       2 |  790 |  |
|   10738 |  791 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|       - |  792 | `	sxu32 nBucket;` |
|       - |  793 | `	/* Remove old collision links */` |
|   10738 |  794 | `	if( pEntry->pPrevCollide ){` |
|    8753 |  795 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|    4394 |  796 | `	}else{` |
|    1987 |  797 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|       - |  798 | `	}` |
|   10738 |  799 | `	if( pEntry->pNextCollide ){` |
|    1052 |  800 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|     528 |  801 | `	}` |
|   10738 |  802 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|       - |  803 | `	/* Compute the new hash */` |
|   10738 |  804 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|   10738 |  805 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|   10738 |  806 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|       - |  807 | `	/* Link to the new bucket */` |
|   10738 |  808 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   10738 |  809 | `	if( pMap->apBucket[nBucket] ){` |
|    8984 |  810 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|    4509 |  811 | `	}` |
|   10738 |  812 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   10738 |  813 | `	pMap->apBucket[nBucket] = pEntry;` |
|       - |  814 | `	/* Increment the automatic index */` |
|   10738 |  815 | `	pMap->iNextIdx++;` |
|   10738 |  816 |  |
|       - |  817 | `/*` |
...
|       - |  823 | ` */` |
|   26984 |  824 | `static int HashmapFindValue(` |
...
|   26986 |  837 | `	pEntry = pMap->pFirst;` |
|   26986 |  838 | `	n = pMap->nEntry;` |
|   26986 |  839 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|   26986 |  840 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|   64749 |  841 | `	for(;;){` |
|  129500 |  842 | `		if( n < 1 ){` |
|      99 |  843 | `			break;` |
|       - |  844 | `		}` |
|       - |  845 | `		/* Extract node value */` |
|  129402 |  846 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  129402 |  847 | `		if( pVal ){` |
|  129402 |  848 | `			if( (pVal->iFlags\|pNeedle->iFlags) & MEMOBJ_NULL ){` |
...
|     ! 0 |  858 | `			}else{` |
|       - |  859 | `				/* Duplicate value */` |
|  129402 |  860 | `				PH7_MemObjLoad(pVal,&sVal);` |
|  129402 |  861 | `				PH7_MemObjLoad(pNeedle,&sNeedle);` |
|  129402 |  862 | `				rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|  129402 |  863 | `				PH7_MemObjRelease(&sVal);` |
|  129402 |  864 | `				PH7_MemObjRelease(&sNeedle);` |
|  129402 |  865 | `				if( rc == 0 ){` |
|   26888 |  866 | `					if( ppNode ){` |
|      23 |  867 | `						*ppNode = pEntry;` |
|      11 |  868 | `					}` |
|       - |  869 | `					/* Match found*/` |
|   26888 |  870 | `					return SXRET_OK;` |
|       - |  871 | `				}` |
|       - |  872 | `			}` |
|   51257 |  873 | `		}` |
|       - |  874 | `		/* Point to the next entry */` |
|  102516 |  875 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  102516 |  876 | `		n--;` |
|       2 |  877 | `	}` |
|       - |  878 | `	/* No such entry */` |
...
|       - | 1053 | ` */` |
|  522938 | 1054 | `static sxi32 HashmapDuplicateNode(` |
...
|       - | 1059 | `	)` |
|       2 | 1060 |  |
|  522940 | 1061 | `	ph7_value sSafeVal = *pVal;` |
|       - | 1062 | `	ph7_value sKey;` |
|       - | 1063 | `	sxi32 rc;` |
|       - | 1064 |  |
|  522940 | 1065 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      30 | 1071 | `	}else{` |
|       - | 1072 | `		/* Int key */` |
|  522882 | 1073 | `		if( iAction == 0 ){ /* Merge */` |
|  522664 | 1074 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|  261551 | 1075 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|  524544 | 1112 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|       - | 1113 | `		/* Extract the node value */` |
|  522680 | 1114 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|  522680 | 1115 | `		if( pVal ){` |
...
|       - | 1120 | `			 */` |
|  522680 | 1121 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|  261341 | 1122 | `		}else{` |
|     ! 0 | 1123 | `			rc = SXRET_OK;` |
|       - | 1124 | `		}` |
|  522680 | 1125 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1126 | `			return rc;` |
|       - | 1127 | `		}` |
|       - | 1128 | `		/* Point to the next entry */` |
|  522680 | 1129 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  261341 | 1130 | `	}` |
...
|       - | 1218 | ` */` |
|  182084 | 1219 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|       2 | 1220 |  |
|  182086 | 1221 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|       - | 1222 | `	ph7_hashmap *pNew;` |
|       - | 1223 | `	ph7_value *pBacking;` |
|  182086 | 1224 | `	if( pMap->iRef < 2 ){` |
|       - | 1225 | `		/* Sole owner, no separation needed */` |
|  180050 | 1226 | `		return pMap;` |
|       - | 1227 | `	}` |
...
|       - | 1372 | ` */` |
|   78312 | 1373 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|   78314 | 1381 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|   78314 | 1382 | `	if( pMap == 0 ){` |
|     ! 0 | 1383 | `		return 0;` |
|       - | 1384 | `	}` |
|       - | 1385 | `	/* Zero the structure */` |
|   78314 | 1386 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|       - | 1387 | `	/* Fill in the structure */` |
|   78314 | 1388 | `	pMap->pVm = &(*pVm);` |
|   78314 | 1389 | `	pMap->iRef = 1;` |
|       - | 1390 | `	/* Default hash functions */` |
|   78314 | 1391 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|   78314 | 1392 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|   78314 | 1393 | `	return pMap;` |
|   39158 | 1394 |  |
|       - | 1395 | `/*` |
...
|       - | 1413 | `*    $_ENV` |
|       - | 1414 | `*/` |
|    2582 | 1415 | `PH7_PRIVATE sxi32 PH7_HashmapCreateSuper(ph7_vm *pVm)` |
|       2 | 1416 |  |
...
|    2584 | 1435 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|    2584 | 1436 | `	if( pMap == 0 ){` |
|     ! 0 | 1437 | `		return SXERR_MEM;` |
|       - | 1438 | `	}` |
|    2584 | 1439 | `	pVm->pGlobal = pMap;` |
|       - | 1440 | `	/* Reserve a ph7_value for the $GLOBALS array*/` |
|    2584 | 1441 | `	pObj = PH7_ReserveMemObj(&(*pVm));` |
|    2584 | 1442 | `	if( pObj == 0 ){` |
|     ! 0 | 1443 | `		return SXERR_MEM;` |
|       - | 1444 | `	}` |
|    2584 | 1445 | `	PH7_MemObjInitFromArray(&(*pVm),pObj,pMap);` |
|       - | 1446 | `	/* Record object index */` |
|    2584 | 1447 | `	pVm->nGlobalIdx = pObj->nIdx;` |
|       - | 1448 | `	/* Install the special $GLOBALS array */` |
|    2584 | 1449 | `	rc = SyHashInsert(&pVm->hSuper,(const void *)"GLOBALS",sizeof("GLOBALS")-1,SX_INT_TO_PTR(pVm->nGlobalIdx));` |
|    2584 | 1450 | `	if( rc != SXRET_OK ){` |
|     ! 0 | 1451 | `		return rc;` |
|       - | 1452 | `	}` |
|       - | 1453 | `	/* Install superglobals now */` |
|   28404 | 1454 | `	for( n =  0 ; n < SX_ARRAYSIZE(azSuper)  ; n++ ){` |
|       - | 1455 | `		ph7_value *pSuper;` |
|       - | 1456 | `		/* Request an empty array */` |
|   25822 | 1457 | `		pSuper = ph7_new_array(&(*pVm));` |
|   25822 | 1458 | `		if( pSuper == 0 ){` |
|     ! 0 | 1459 | `			return SXERR_MEM;` |
|       - | 1460 | `		}` |
|       - | 1461 | `		/* Install */` |
|   25822 | 1462 | `		rc = ph7_vm_config(&(*pVm),PH7_VM_CONFIG_CREATE_SUPER,azSuper[n]/* Super-global name*/,pSuper/* Super-global value */);` |
|   25822 | 1463 | `		if( rc != SXRET_OK ){` |
|     ! 0 | 1464 | `			return rc;` |
|       - | 1465 | `		}` |
|       - | 1466 | `		/* Release the value now it have been installed */` |
|   25822 | 1467 | `		ph7_release_value(&(*pVm),pSuper);` |
|   12912 | 1468 | `	}` |
|       - | 1469 | `	/* Set some $_SERVER entries */` |
|    2584 | 1470 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|       - | 1471 | `	/*` |
|       - | 1472 | `	 * 'SCRIPT_FILENAME'` |
|       - | 1473 | `	 * The absolute pathname of the currently executing script.` |
|       - | 1474 | `	 */` |
|    5162 | 1475 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_SERVER_ATTR,` |
|       - | 1476 | `		"SCRIPT_FILENAME",` |
|    1291 | 1477 | `		pFile ? pFile->zString : ":Memory:",` |
|    2578 | 1478 | `		pFile ? pFile->nByte : sizeof(":Memory:") - 1` |
|       - | 1479 | `		);` |
|       - | 1480 | `	/* All done,all super-global are installed now */` |
|    2584 | 1481 | `	return SXRET_OK;` |
|    1293 | 1482 |  |
|       - | 1483 | `/*` |
|       - | 1484 | ` * Release a hashmap.` |
|       - | 1485 | ` */` |
|   49748 | 1486 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|       2 | 1487 |  |
|       - | 1488 | `	ph7_hashmap_node *pEntry,*pNext;` |
|   49750 | 1489 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1490 | `	sxu32 n;` |
|   49750 | 1491 | `	if( pMap == pVm->pGlobal ){` |
...
|   49750 | 1497 | `	n = 0;` |
|   49750 | 1498 | `	pEntry = pMap->pFirst;` |
| 1509402 | 1499 | `	for(;;){` |
| 3018806 | 1500 | `		if( n >= pMap->nEntry ){` |
|   49750 | 1501 | `			break;` |
|       - | 1502 | `		}` |
| 2969058 | 1503 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|       - | 1504 | `		/* Remove the reference from the foreign table */` |
| 2969058 | 1505 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
| 2969058 | 1506 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|       - | 1507 | `			/* Restore the ph7_value to the free list */` |
| 2969050 | 1508 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
| 1484524 | 1509 | `		}` |
|       - | 1510 | `		/* Release the node */` |
| 2969058 | 1511 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|   64800 | 1512 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|   32399 | 1513 | `		}` |
| 2969058 | 1514 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|       - | 1515 | `		/* Point to the next entry */` |
| 2969058 | 1516 | `		pEntry = pNext;` |
| 2969058 | 1517 | `		n++;` |
|       2 | 1518 | `	}` |
|   49750 | 1519 | `	if( pMap->nEntry > 0 ){` |
|       - | 1520 | `		/* Release the hash bucket */` |
|   44212 | 1521 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|   22105 | 1522 | `	}` |
|   49750 | 1523 | `	if( FreeDS ){` |
|       - | 1524 | `		/* Free the whole instance */` |
|   49734 | 1525 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|   24868 | 1526 | `	}else{` |
...
|       - | 1539 | ` */` |
|  555690 | 1540 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|       2 | 1541 |  |
|  555692 | 1542 | `	ph7_vm *pVm = pMap->pVm;` |
|       - | 1543 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|  555692 | 1544 | `	pMap->iRef--;` |
|  555692 | 1545 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|   49734 | 1546 | `		PH7_HashmapRelease(pMap,TRUE);` |
|   24866 | 1547 | `	}` |
|  555692 | 1548 |  |
|       - | 1549 | `/*` |
...
|       - | 1553 | ` */` |
|  103562 | 1554 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|       - | 1574 | ` */` |
| 2455244 | 1575 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|       2 | 1580 |  |
|       - | 1581 | `	sxi32 rc;` |
| 2455246 | 1582 | `	if( pVal && (pVal->iFlags & MEMOBJ_HASHMAP) && (ph7_hashmap *)pVal->x.pOther == pMap->pVm->pGlobal ){` |
|       - | 1583 | `		/*` |
...
|       - | 1588 | `	}` |
| 2455246 | 1589 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
| 2455246 | 1590 | `	return rc;` |
| 1227624 | 1591 |  |
|       - | 1592 | `/*` |
...
|       - | 1618 | ` */` |
|   33356 | 1619 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|       2 | 1624 |  |
|       - | 1625 | `	sxi32 rc;` |
|   33358 | 1626 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
|       - | 1627 | `		/*` |
...
|       - | 1632 | `	}` |
|   33358 | 1633 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|   33358 | 1634 | `	return rc;` |
|   16680 | 1635 |  |
|       - | 1636 | `/*` |
|       - | 1637 | ` * Reset the node cursor of a given hashmap.` |
|       - | 1638 | ` */` |
|   22362 | 1639 | `PH7_PRIVATE void PH7_HashmapResetLoopCursor(ph7_hashmap *pMap)` |
|       2 | 1640 |  |
|       - | 1641 | `	/* Reset the loop cursor */` |
|   22364 | 1642 | `	pMap->pCur = pMap->pFirst;` |
|   22364 | 1643 |  |
|       - | 1644 | `/*` |
...
|       - | 1649 | ` */` |
|  182872 | 1650 | `PH7_PRIVATE ph7_hashmap_node * PH7_HashmapGetNextEntry(ph7_hashmap *pMap)` |
|       2 | 1651 |  |
|  182874 | 1652 | `	ph7_hashmap_node *pCur = pMap->pCur;` |
|  182874 | 1653 | `	if( pCur == 0 ){` |
|       - | 1654 | `		/* End of the list,return null */` |
|   11202 | 1655 | `		return 0;` |
|       - | 1656 | `	}` |
|       - | 1657 | `	/* Advance the node cursor */` |
|  171674 | 1658 | `	pMap->pCur = pCur->pPrev; /* Reverse link */` |
|  171674 | 1659 | `	return pCur;` |
|   91438 | 1660 |  |
|       - | 1661 | `/*` |
|       - | 1662 | ` * Extract a node value.` |
|       - | 1663 | ` */` |
|  430418 | 1664 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|       2 | 1665 |  |
|  430420 | 1666 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|  430420 | 1667 | `	if( pEntry ){` |
|  430420 | 1668 | `		if( bStore ){` |
|  171808 | 1669 | `			PH7_MemObjStore(pEntry,pValue);` |
|   85905 | 1670 | `		}else{` |
|  258614 | 1671 | `			PH7_MemObjLoad(pEntry,pValue);` |
|       - | 1672 | `		}` |
|  215229 | 1673 | `	}else{` |
...
|       - | 1679 | ` */` |
|  109508 | 1680 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|       2 | 1681 |  |
|       - | 1682 | `	/* Fill with the current key */` |
|  109510 | 1683 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|  109220 | 1684 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|      17 | 1685 | `			SyBlobRelease(&pKey->sBlob);` |
|       8 | 1686 | `		}` |
|  109220 | 1687 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|  109220 | 1688 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|   54611 | 1689 | `	}else{` |
...
|       - | 1740 | `**   changed.` |
|       - | 1741 | `*/` |
|   29416 | 1742 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|       2 | 1743 |  |
|       - | 1744 | `	ph7_hashmap_node result,*pTail;` |
|       - | 1745 | `    /* Prevent compiler warning */` |
|   29418 | 1746 | `	result.pNext = result.pPrev = 0;` |
|   29418 | 1747 | `	pTail = &result;` |
|   81112 | 1748 | `	while( pA && pB ){` |
|   51696 | 1749 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|   33553 | 1750 | `			pTail->pPrev = pA;` |
|   33553 | 1751 | `			pA->pNext = pTail;` |
|   33553 | 1752 | `			pTail = pA;` |
|   33553 | 1753 | `			pA = pA->pPrev;` |
|   16747 | 1754 | `		}else{` |
|   18145 | 1755 | `			pTail->pPrev = pB;` |
|   18145 | 1756 | `			pB->pNext = pTail;` |
|   18145 | 1757 | `			pTail = pB;` |
|   18145 | 1758 | `			pB = pB->pPrev;` |
|       - | 1759 | `		}` |
|       2 | 1760 | `	}` |
|   29418 | 1761 | `	if( pA ){` |
|   21195 | 1762 | `		pTail->pPrev = pA;` |
|   21195 | 1763 | `		pA->pNext = pTail;` |
|   18835 | 1764 | `	}else if( pB ){` |
|    8017 | 1765 | `		pTail->pPrev = pB;` |
|    8017 | 1766 | `		pB->pNext = pTail;` |
|    3996 | 1767 | `	}else{` |
|     210 | 1768 | `		pTail->pPrev = pTail->pNext = 0;` |
|       - | 1769 | `	}` |
|   29418 | 1770 | `	return result.pPrev;` |
|       2 | 1771 |  |
|       - | 1772 | `/*` |
|       - | 1773 | `** Inputs:` |
...
|   11488 | 1791 | `	while( pIn ){` |
|   10854 | 1792 | `		p = pIn;` |
|   10854 | 1793 | `		pIn = p->pPrev;` |
|   10854 | 1794 | `		p->pPrev = 0;` |
|   20616 | 1795 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|   20616 | 1796 | `			if( a[i]==0 ){` |
|   10854 | 1797 | `				a[i] = p;` |
|   10854 | 1798 | `				break;` |
|     ! 0 | 1799 | `			}else{` |
|    9764 | 1800 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|    9764 | 1801 | `				a[i] = 0;` |
|       - | 1802 | `			}` |
|    4883 | 1803 | `		}` |
|   10854 | 1804 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       - | 1825 | ` */` |
|   51564 | 1826 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|       2 | 1827 |  |
|       - | 1828 | `	ph7_value sA,sB;` |
|       - | 1829 | `	sxi32 iFlags;` |
|       - | 1830 | `	int rc;` |
|   51566 | 1831 | `	if( pCmpData == 0 ){` |
|       - | 1832 | `		/* Perform a standard comparison */` |
|   51542 | 1833 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|   51542 | 1834 | `		return rc;` |
|       - | 1835 | `	}` |
...
|       2 | 2124 | `		}` |
|   10684 | 2125 | `		HashmapRehashIntNode(p);` |
|       - | 2126 | `		/* Point to the next entry */` |
|   10684 | 2127 | `		i++;` |
|   10684 | 2128 | `		pLast = p;` |
|   10684 | 2129 | `		p = p->pPrev; /* Reverse link */` |
|       2 | 2130 | `	}` |
|     588 | 2131 |  |
|       - | 2132 | `/*` |
...
|       - | 3913 | ` */` |
|   26792 | 3914 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|       2 | 3915 |  |
|       - | 3916 | `	ph7_value *pNeedle;` |
|       - | 3917 | `	int bStrict;` |
|       - | 3918 | `	int rc;` |
|   26794 | 3919 | `	if( nArg < 2 ){` |
|       - | 3920 | `		/* Missing argument,return FALSE */` |
|     ! 0 | 3921 | `		ph7_result_bool(pCtx,0);` |
|     ! 0 | 3922 | `		return PH7_OK;` |
|       - | 3923 | `	}` |
|   26794 | 3924 | `	pNeedle = apArg[0];` |
|   26794 | 3925 | `	bStrict = 0;` |
|   26794 | 3926 | `	if( nArg > 2 ){` |
|       5 | 3927 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|       2 | 3928 | `	}` |
|   26794 | 3929 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|   26794 | 3937 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|       - | 3938 | `	/* Lookup result */` |
|   26794 | 3939 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|   26794 | 3940 | `	return PH7_OK;` |
|   13398 | 3941 |  |
|       - | 3942 | `/*` |
...
|       - | 6865 | ` */` |
|    2582 | 6866 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|       2 | 6867 |  |
|       - | 6868 | `	sxu32 n;` |
|  160086 | 6869 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|  157504 | 6870 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|   78753 | 6871 | `	}` |
|    2584 | 6872 |  |
|       - | 6873 | `/*` |
...
|       - | 6961 | ` */` |
|   27094 | 6962 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|   27096 | 6973 | `	rc = SXRET_OK;` |
|   27096 | 6974 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|   27096 | 6975 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|   27096 | 6976 | `	n = pMap->nEntry;` |
|   27096 | 6977 | `	pEntry = pMap->pFirst;` |
...
|  108964 | 6984 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|  108964 | 6985 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|       - | 6986 | `		/* Invoke the user callback */` |
|  108964 | 6987 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|       - | 6988 | `		/* Release the copy of the key and the value */` |
|  108964 | 6989 | `		PH7_MemObjRelease(&sKey);` |
|  108964 | 6990 | `		PH7_MemObjRelease(&sValue);` |
|  108964 | 6991 | `		if( rc != PH7_OK ){` |
|       - | 6992 | `			/* Callback request an operation abort */` |
|     ! 0 | 6993 | `			return SXERR_ABORT;` |
|       - | 6994 | `		}` |
|       - | 6995 | `		/* Point to the next entry */` |
|  108964 | 6996 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|  108964 | 6997 | `		n--;` |
|       2 | 6998 | `	}` |
|       - | 6999 | `	/* All done */` |
|   27096 | 7000 | `	return SXRET_OK;` |
|   13549 | 7001 |  |
|       - | 7002 |  |
