...
|         - |   22 | ` */` |
|   7931371 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7931376 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7931376 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    514051 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    514056 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    514056 |   35 | `	sxu32 nH = 5381;` |
|    514056 |   36 | `	zEnd = &zIn[nLen];` |
|    591032 |   37 | `	for(;;){` |
|   1182070 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1009536 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    908573 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    786093 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    514056 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3622512 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3622517 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3622517 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3622517 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3622517 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3622517 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3622517 |  112 | `	pNode->nHash = nHash;` |
|   3622517 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3622517 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3622517 |  115 | `	return pNode;` |
|   1811261 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    199093 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    199098 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    199098 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    199098 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    199098 |  133 | `	pNode->pMap  = &(*pMap);` |
|    199098 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    199098 |  135 | `	pNode->nHash = nHash;` |
|    199098 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    199098 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    199098 |  138 | `	pNode->nValIdx = nValIdx;` |
|    199098 |  139 | `	return pNode;` |
|     99551 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3821605 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3821610 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3369550 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3369550 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1684775 |  150 | `	}` |
|   3821610 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3821610 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87482 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87482 |  156 | `		pMap->pCur = pNode;` |
|     43743 |  157 | `	}else{` |
|   3734133 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3821610 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3821605 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3821610 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92920 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92920 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92920 |  245 | `		if( nNew < 1 ){` |
|     87482 |  246 | `			nNew = 16;` |
...
|     92920 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92920 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92920 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92920 |  260 | `		pMap->apBucket = apNew;` |
|     92920 |  261 | `		pMap->nSize = nNew;` |
|     92920 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87482 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5443 |  267 | `		pEntry = pMap->pFirst;` |
|      5443 |  268 | `		n = 0;` |
|   2538079 |  269 | `		for( ;; ){` |
|   5076163 |  270 | `			if( n >= pMap->nEntry ){` |
|      5443 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5070725 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5070725 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5070725 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4405801 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4405801 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2202898 |  280 | `			}` |
|   5070725 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5070725 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5070725 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5443 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2719 |  288 | `	}` |
|   3734133 |  289 | `	return SXRET_OK;` |
|   1910807 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3622512 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3622517 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3622475 |  310 | `		if( pValue ){` |
|   3622465 |  311 | `			sSafeVal = *pValue;` |
|   3622465 |  312 | `			pValue = &sSafeVal;` |
|   1811230 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3622475 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3622475 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3622475 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3622465 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1811230 |  322 | `		}` |
|   3622475 |  323 | `		nIdx = pObj->nIdx;` |
|   1811240 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3622517 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3622517 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3622517 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3622517 |  334 | `	if( isForeign ){` |
...
|   3622517 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3622517 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3622517 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3622517 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3622517 |  349 | `	return SXRET_OK;` |
|   1811261 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    199093 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    199098 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    152780 |  370 | `		if( pValue ){` |
|    152470 |  371 | `			sSafeVal = *pValue;` |
|    152470 |  372 | `			pValue = &sSafeVal;` |
|     76232 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    152780 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    152780 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    152780 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152470 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76232 |  382 | `		}` |
|    152780 |  383 | `		nIdx = pObj->nIdx;` |
|     76392 |  384 | `	}else{` |
|     46323 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    199098 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    199098 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    199098 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    199098 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     46323 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23159 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    199098 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    199098 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    199098 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    199098 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    199098 |  409 | `	return SXRET_OK;` |
|     99551 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4293015 |  416 | `PH7_PRIVATE sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4293020 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       851 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4292174 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4292174 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110568109 |  433 | `	for(;;){` |
| 221136187 |  434 | `		if( pNode == 0 ){` |
|   4284834 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216851353 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216848337 |  438 | `			&& pNode->nHash == nHash` |
...
|         2 |  448 | `	}` |
|         - |  449 | `	/* No such entry */` |
|   4284834 |  450 | `	return SXERR_NOTFOUND;` |
|   2146516 |  451 | `}` |
|         - |  452 | `/*` |
...
|         - |  456 | ` */` |
|    343401 |  457 | `PH7_PRIVATE sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    343406 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28448 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    314963 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    314963 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255650 |  475 | `	for(;;){` |
|    511305 |  476 | `		if( pNode == 0 ){` |
|    249247 |  477 | `			break;` |
|         - |  478 | `		}` |
|    262058 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    260545 |  480 | `			&& pNode->nHash == nHash` |
|    162425 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
...
|    196347 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    249247 |  493 | `	return SXERR_NOTFOUND;` |
|    171705 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    343581 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    343586 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    343586 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    343586 |  504 | `	int isNeg = FALSE, nDigit;` |
|    343586 |  505 | `	if( zIn >= zEnd ){` |
|        12 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    343576 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    343572 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    343572 |  516 | `	zDigit = zIn;` |
|    172232 |  517 | `	for(;;){` |
|    344470 |  518 | `		if( zIn >= zEnd ){` |
|       299 |  519 | `			break;` |
|         - |  520 | `		}` |
|    344172 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    343274 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       899 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    151826 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    151831 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    151831 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    144505 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    144505 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    144433 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    144433 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        36 |  567 | `	}` |
...
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     79571 |  584 | `	return SXERR_NOTFOUND;` |
|     75918 |  585 | `}` |
|         - |  586 | `/*` |
...
|   2141650 |  604 | `		pMap->iNextIdx = iKey < SXI64_HIGH ? iKey + 1 : SXI64_HIGH;` |
|         - |  605 | `		/* Make sure the automatic index is not reserved */` |
|   2141650 |  606 | `		while( pMap->iNextIdx < SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|       ! 0 |  607 | `			pMap->iNextIdx++;` |
|       ! 0 |  608 | `		}` |
|   1070826 |  609 | `	}` |
|   1071416 |  610 | `}` |
...
|         - |  616 | ` */` |
|   1475872 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1475877 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1475871 |  623 | `	return FALSE;` |
|    737941 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3771371 |  631 | `PH7_PRIVATE sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3771376 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3771376 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3771376 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    152756 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         2 |  645 | `		}` |
|    152756 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       219 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    228804 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76266 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152050 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    151914 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    151914 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1809310 |  683 | `IntKey:` |
|   3618843 |  684 | `	if( pKey ){` |
...
|   1071408 |  714 | `		}` |
|   1071413 |  715 | `	}else{` |
|   1475843 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1475841 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1475835 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1475835 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1475833 |  726 | `			++pMap->iNextIdx;` |
|    737914 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3618651 |  730 | `	return rc;` |
|   1885690 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     46370 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     46375 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     46375 |  766 | `	sxi32 rc = SXRET_OK;` |
|     46375 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     46335 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     46335 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     69497 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23164 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     46323 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     46323 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1517489 |  827 | `PH7_PRIVATE ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1517494 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1517494 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     77338 |  902 | `PH7_PRIVATE sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     77343 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     77343 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     77343 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     77343 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     77343 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     77343 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     77343 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     77343 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     77343 |  921 | `	return rc;` |
|     38576 |  922 | `}` |
|         - |  923 | `/*` |
...
|     11751 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5767 |  934 | `	}else{` |
|      4949 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     16695 |  937 | `	if( pEntry->pNextCollide ){` |
|      1068 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       546 |  939 | `	}` |
...
|     12066 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5928 |  949 | `	}` |
...
|    156046 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    156046 |  989 | `		if( pVal ){` |
...
|    156046 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    156046 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    156046 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    156046 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    156046 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    156046 | 1001 | `			if( rc == 0 ){` |
...
|    123368 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    123368 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    710046 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    710046 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    710048 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    710043 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    710043 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|         - | 1277 | `		/* Blob key insertion */` |
|      4043 | 1278 | `		PH7_MemObjInitFromString(pDest->pVm,&sKey,0);` |
|      4043 | 1279 | `		PH7_MemObjStringAppend(&sKey,(const char *)SyBlobData(&pEntry->xKey.sKey),SyBlobLength(&pEntry->xKey.sKey));` |
|      4043 | 1280 | `		rc = PH7_HashmapInsert(pDest,&sKey,&sSafeVal);` |
|      4043 | 1281 | `		PH7_MemObjRelease(&sKey);` |
|      2024 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    706005 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    702339 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    354838 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    705305 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    702399 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    702399 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    702399 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    351202 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    702399 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    702399 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    351202 | 1341 | `	}` |
...
|         - | 1392 | ` */` |
|      7324 | 1393 | `PH7_PRIVATE sxi32 PH7_HashmapDup(ph7_hashmap *pSrc,ph7_hashmap *pDest)` |
|         5 | 1394 | `{` |
|         - | 1395 | `	ph7_hashmap_node *pEntry;` |
|         - | 1396 | `	ph7_value *pVal;` |
|         - | 1397 | `	sxi32 rc;` |
|         - | 1398 | `	sxu32 n;` |
|      7329 | 1399 | `	if( pSrc == pDest ){` |
...
|      7329 | 1406 | `	pEntry = pSrc->pFirst;` |
|         - | 1407 | `	/* Perform the duplication */` |
|     14937 | 1408 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1409 | `		/* Extract the node value */` |
|      7613 | 1410 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|      7613 | 1411 | `		if( pVal ){` |
|      7613 | 1412 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,2);` |
|      3809 | 1413 | `		}else{` |
|       ! 0 | 1414 | `			rc = SXRET_OK;` |
|         - | 1415 | `		}` |
|      7613 | 1416 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1417 | `			return rc;` |
|         - | 1418 | `		}` |
|         - | 1419 | `		/* Point to the next entry */` |
|      7613 | 1420 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|      3809 | 1421 | `	}` |
|      7329 | 1422 | `	return SXRET_OK;` |
|      3667 | 1423 | `}` |
|         - | 1424 | `/*` |
...
|         - | 1498 | ` */` |
|    242804 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    242809 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    242809 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    242809 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    239983 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
|      2831 | 1511 | `	if( pMap == pVm->pGlobal ){` |
...
|      2701 | 1520 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2701 | 1521 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2696 | 1522 | `		if( pBacking && pBacking != pValue` |
|      2671 | 1523 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2651 | 1524 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1525 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2651 | 1526 | `			pMap->iRef--;` |
|      2651 | 1527 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1528 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2601 | 1529 | `				pMap->iRef++;` |
|      2601 | 1530 | `				return pMap;` |
|         - | 1531 | `			}` |
...
|         - | 1630 | ` */` |
|      3816 | 1631 | `PH7_PRIVATE sxi32 PH7_HashmapUnion(ph7_hashmap *pLeft,ph7_hashmap *pRight)` |
|         5 | 1632 | `{` |
|         - | 1633 | `	ph7_hashmap_node *pEntry;` |
|      3821 | 1634 | `	sxi32 rc = SXRET_OK;` |
|         - | 1635 | `	ph7_value *pObj;` |
|         - | 1636 | `	sxu32 n;` |
|      3821 | 1637 | `	if( pLeft == pRight ){` |
...
|      3821 | 1644 | `	pEntry = pRight->pFirst;` |
|      3861 | 1645 | `	for(n = 0 ; n < pRight->nEntry ; ++n ){` |
...
|    141423 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141423 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    141423 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    141423 | 1700 | `	pMap->pVm = &(*pVm);` |
|    141423 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    141423 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141423 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141423 | 1705 | `	return pMap;` |
|     70714 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     93454 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     93459 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     93459 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     93459 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     93459 | 1821 | `	n = 0;` |
|     93459 | 1822 | `	pEntry = pMap->pFirst;` |
|   1902950 | 1823 | `	for(;;){` |
|   3805906 | 1824 | `		if( n >= pMap->nEntry ){` |
|     93459 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3712452 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3712452 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3712452 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3712392 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1856193 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3712452 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109250 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54622 | 1837 | `		}` |
|   3712452 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3712452 | 1840 | `		pEntry = pNext;` |
|   3712452 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     93459 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     67808 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33901 | 1846 | `	}` |
|     93459 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     93433 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     46719 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    868876 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    868881 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    868881 | 1869 | `	pMap->iRef--;` |
|    868881 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     93413 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     46704 | 1872 | `	}` |
|    868881 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    152076 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3068707 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3068712 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3068712 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     46360 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     46365 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     46365 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     46365 | 1966 | `	return rc;` |
|     23185 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23138 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23143 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23143 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23143 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23143 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     22962 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     22967 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     22967 | 1991 | `	while( *ppLink ){` |
|     22967 | 1992 | `		if( *ppLink == pStep ){` |
|     22967 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     22967 | 1994 | `			pStep->pNextActive = 0;` |
|     22967 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    612486 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    612491 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    612491 | 2023 | `	if( pEntry ){` |
|    612491 | 2024 | `		if( bStore ){` |
|    235305 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    117655 | 2026 | `		}else{` |
|    377191 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    306052 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    163562 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    163567 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    157613 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    157613 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    157613 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     78809 | 2045 | `	}else{` |
|      5959 | 2046 | `		SyBlobReset(&pKey->sBlob);` |
|      5959 | 2047 | `		SyBlobAppend(&pKey->sBlob,SyBlobData(&pNode->xKey.sKey),SyBlobLength(&pNode->xKey.sKey));` |
|      5959 | 2048 | `		MemObjSetType(pKey,MEMOBJ_STRING);` |
|         - | 2049 | `	}` |
|    163567 | 2050 | `}` |
...
|         - | 2293 | ` */` |
|     33878 | 2294 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33883 | 2305 | `	rc = SXRET_OK;` |
|     33883 | 2306 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33883 | 2307 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33883 | 2308 | `	n = pMap->nEntry;` |
|     33883 | 2309 | `	pEntry = pMap->pFirst;` |
...
|    156287 | 2316 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    156287 | 2317 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 2318 | `		/* Invoke the user callback */` |
|    156287 | 2319 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 2320 | `		/* Release the copy of the key and the value */` |
|    156287 | 2321 | `		PH7_MemObjRelease(&sKey);` |
|    156287 | 2322 | `		PH7_MemObjRelease(&sValue);` |
|    156287 | 2323 | `		if( rc != PH7_OK ){` |
|         - | 2324 | `			/* Callback request an operation abort */` |
|         3 | 2325 | `			return SXERR_ABORT;` |
|         - | 2326 | `		}` |
|         - | 2327 | `		/* Point to the next entry */` |
|    156285 | 2328 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    156285 | 2329 | `		n--;` |
|         5 | 2330 | `	}` |
|         - | 2331 | `	/* All done */` |
|     33881 | 2332 | `	return SXRET_OK;` |
|     16944 | 2333 | `}` |
|         - | 2334 |  |
