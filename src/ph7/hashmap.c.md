...
|         - |   22 | ` */` |
|   7435076 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7435081 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7435081 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    606764 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    606769 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    606769 |   35 | `	sxu32 nH = 5381;` |
|    606769 |   36 | `	zEnd = &zIn[nLen];` |
|    690977 |   37 | `	for(;;){` |
|   1381959 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1170865 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1046513 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    906247 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    606769 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3137592 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3137597 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3137597 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3137597 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3137597 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3137597 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3137597 |  112 | `	pNode->nHash = nHash;` |
|   3137597 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3137597 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3137597 |  115 | `	return pNode;` |
|   1568801 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    253996 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    254001 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    254001 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    254001 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    254001 |  133 | `	pNode->pMap  = &(*pMap);` |
|    254001 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    254001 |  135 | `	pNode->nHash = nHash;` |
|    254001 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    254001 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    254001 |  138 | `	pNode->nValIdx = nValIdx;` |
|    254001 |  139 | `	return pNode;` |
|    127003 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3391588 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3391593 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   2922521 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   2922521 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1461258 |  150 | `	}` |
|   3391593 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3391593 |  153 | `	if( pMap->pFirst == 0 ){` |
|     90209 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     90209 |  156 | `		pMap->pCur = pNode;` |
|     45107 |  157 | `	}else{` |
|   3301389 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3391593 |  160 | `	if( pMap->pActiveSteps ){` |
...
|      4745 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2371 |  192 | `	}` |
...
|         - |  236 | ` */` |
|   3391588 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3391593 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     95163 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     95163 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     95163 |  245 | `		if( nNew < 1 ){` |
|     90209 |  246 | `			nNew = 16;` |
...
|     95163 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     95163 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     95163 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     95163 |  260 | `		pMap->apBucket = apNew;` |
|     95163 |  261 | `		pMap->nSize = nNew;` |
|     95163 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     90209 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      4959 |  267 | `		pEntry = pMap->pFirst;` |
|      4959 |  268 | `		n = 0;` |
|   2100461 |  269 | `		for( ;; ){` |
|   4200927 |  270 | `			if( n >= pMap->nEntry ){` |
|      4959 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   4195973 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   4195973 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   4195973 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   3586633 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   3586633 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   1793314 |  280 | `			}` |
|   4195973 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   4195973 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   4195973 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      4959 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2477 |  288 | `	}` |
|   3301389 |  289 | `	return SXRET_OK;` |
|   1695799 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3137592 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3137597 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3137559 |  310 | `		if( pValue ){` |
|   3137555 |  311 | `			sSafeVal = *pValue;` |
|   3137555 |  312 | `			pValue = &sSafeVal;` |
|   1568775 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3137559 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3137559 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3137559 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3137555 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1568775 |  322 | `		}` |
|   3137559 |  323 | `		nIdx = pObj->nIdx;` |
|   1568782 |  324 | `	}else{` |
|        39 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3137597 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3137597 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3137597 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3137597 |  334 | `	if( isForeign ){` |
...
|   3137597 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3137597 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3137597 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3137597 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3137597 |  349 | `	return SXRET_OK;` |
|   1568801 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    253996 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    254001 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    206939 |  370 | `		if( pValue ){` |
|    206649 |  371 | `			sSafeVal = *pValue;` |
|    206649 |  372 | `			pValue = &sSafeVal;` |
|    103322 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    206939 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    206939 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    206939 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    206649 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|    103322 |  382 | `		}` |
|    206939 |  383 | `		nIdx = pObj->nIdx;` |
|    103472 |  384 | `	}else{` |
|     47067 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    254001 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    254001 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    254001 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    254001 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     47067 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23531 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    254001 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    254001 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    254001 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    254001 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    254001 |  409 | `	return SXRET_OK;` |
|    127003 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    387946 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    387951 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     35183 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    352773 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    352773 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    291849 |  475 | `	for(;;){` |
|    583703 |  476 | `		if( pNode == 0 ){` |
|    294613 |  477 | `			break;` |
|         - |  478 | `		}` |
|    289090 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    287580 |  480 | `			&& pNode->nHash == nHash` |
|    172163 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     58261 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     58165 |  484 | `				if( ppNode ){` |
|     58137 |  485 | `					*ppNode = pNode;` |
|     29066 |  486 | `				}` |
|     58165 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    230935 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    294613 |  493 | `	return SXERR_NOTFOUND;` |
|    193978 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    388076 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    388081 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    388081 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    388081 |  504 | `	int isNeg = FALSE, nDigit;` |
|    388081 |  505 | `	if( zIn >= zEnd ){` |
|       ! 0 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    388081 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    388077 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    388077 |  516 | `	zDigit = zIn;` |
|    194468 |  517 | `	for(;;){` |
|    388941 |  518 | `		if( zIn >= zEnd ){` |
|       249 |  519 | `			break;` |
|         - |  520 | `		}` |
|    388693 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    387829 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       865 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    136594 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    136599 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    136599 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    134179 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast */` |
|       ! 0 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  559 | `		}` |
|    134179 |  560 | `		if( SyBlobLength(&pKey->sBlob) > 0 && !HashmapIsIntKey(&pKey->sBlob) ){` |
|         - |  561 | `			/* Perform a blob lookup */` |
|    134159 |  562 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    134159 |  563 | `			goto result;` |
|         - |  564 | `		}` |
|        10 |  565 | `	}` |
...
|     68297 |  573 | `result:` |
|    136599 |  574 | `	if( rc == SXRET_OK ){` |
|         - |  575 | `		/* Node found */` |
|     60159 |  576 | `		if( ppNode ){` |
|     60113 |  577 | `			*ppNode = pNode;` |
|     30054 |  578 | `		}` |
|     60159 |  579 | `		return SXRET_OK;` |
|         - |  580 | `	}` |
|         - |  581 | `	/* No such entry */` |
|     76445 |  582 | `	return SXERR_NOTFOUND;` |
|     68302 |  583 | `}` |
|         - |  584 | `/*` |
...
|         - |  605 | ` */` |
|    996234 |  606 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  607 | `{` |
|    996239 |  608 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  609 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  610 | `		return TRUE;` |
|         - |  611 | `	}` |
|    996233 |  612 | `	return FALSE;` |
|    498122 |  613 | `}` |
|         - |  614 | `/*` |
...
|         - |  619 | ` */` |
|   3343896 |  620 | `static sxi32 HashmapInsert(` |
|         - |  621 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  622 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  623 | `	ph7_value *pVal    /* Node value */` |
|         - |  624 | `	)` |
|         5 |  625 | `{` |
|   3343901 |  626 | `	ph7_hashmap_node *pNode = 0;` |
|   3343901 |  627 | `	sxi32 rc = SXRET_OK;` |
|   3343901 |  628 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|    210361 |  629 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  630 | `			/* Force a string cast */` |
|         3 |  631 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  632 | `		}` |
|    210361 |  633 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         - |  639 | `		}` |
|    309920 |  640 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|    103305 |  641 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  654 | `		}` |
|    206247 |  655 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    206121 |  668 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    206121 |  669 | `		return rc;` |
|         - |  670 | `	}` |
|   1566770 |  671 | `IntKey:` |
|   3137291 |  672 | `	if( pKey ){` |
...
|   1070497 |  702 | `		}` |
|   1070502 |  703 | `	}else{` |
|    996209 |  704 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  705 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  706 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  707 | `		}` |
|    996207 |  708 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  709 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  710 | `		}` |
|         - |  711 | `		/* Assign an automatic index */` |
|    996201 |  712 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|    996201 |  713 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|    996199 |  714 | `			++pMap->iNextIdx;` |
|    498097 |  715 | `		}` |
|         - |  716 | `	}` |
|         - |  717 | `	/* Insertion result */` |
|   3137195 |  718 | `	return rc;` |
|   1671953 |  719 | `}` |
|         - |  720 | `/*` |
...
|         - |  746 | ` */` |
|     47108 |  747 | `static sxi32 HashmapInsertByRef(` |
|         - |  748 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  749 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  750 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  751 | `	)` |
|         5 |  752 | `{` |
|     47113 |  753 | `	ph7_hashmap_node *pNode = 0;` |
|     47113 |  754 | `	sxi32 rc = SXRET_OK;` |
|     47113 |  755 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     47077 |  756 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  757 | `			/* Force a string cast */` |
|       ! 0 |  758 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  759 | `		}` |
|     47077 |  760 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  765 | `			goto IntKey;` |
|         - |  766 | `		}` |
|     70610 |  767 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23535 |  768 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  769 | `				/* Overwrite */` |
...
|     47067 |  777 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     47067 |  778 | `		return rc;` |
|         - |  779 | `	}` |
|        18 |  780 | `IntKey:` |
|        39 |  781 | `	if( pKey ){` |
...
|         - |  814 | ` */` |
|   1417087 |  815 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  816 | `{` |
|         - |  817 | `	/* Point to the desired object */` |
|         - |  818 | `	ph7_value *pObj;` |
|   1417092 |  819 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1417092 |  820 | `	return pObj;` |
|         5 |  821 | `}` |
|         - |  822 | `/*` |
...
|         - |  864 | ` * documenation.` |
|         - |  865 | ` */` |
|     71030 |  866 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  867 | `{` |
|         - |  868 | `	ph7_value sObj1,sObj2;` |
|         - |  869 | `	sxi32 rc;` |
|     71035 |  870 | `	if( pLeft == pRight ){` |
|         - |  871 | `		/*` |
...
|     71035 |  878 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     71035 |  879 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     71035 |  880 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     71035 |  881 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     71035 |  882 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     71035 |  883 | `	PH7_MemObjRelease(&sObj1);` |
|     71035 |  884 | `	PH7_MemObjRelease(&sObj2);` |
|     71035 |  885 | `	return rc;` |
|     35540 |  886 | `}` |
|         - |  887 | `/*` |
...
|         - |  890 | ` */` |
|     13658 |  891 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  892 | `{` |
|     13663 |  893 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  894 | `	sxu32 nBucket;` |
|         - |  895 | `	/* Remove old collision links */` |
|     13663 |  896 | `	if( pEntry->pPrevCollide ){` |
|     11196 |  897 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5612 |  898 | `	}else{` |
|      2472 |  899 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  900 | `	}` |
|     13663 |  901 | `	if( pEntry->pNextCollide ){` |
|      1106 |  902 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       572 |  903 | `	}` |
|     13663 |  904 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  905 | `	/* Compute the new hash */` |
|     13663 |  906 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     13663 |  907 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     13663 |  908 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  909 | `	/* Link to the new bucket */` |
|     13663 |  910 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13663 |  911 | `	if( pMap->apBucket[nBucket] ){` |
|     11521 |  912 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5772 |  913 | `	}` |
|     13663 |  914 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     13663 |  915 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     13663 |  919 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     13663 |  920 | `		pMap->iNextIdx++;` |
|      6829 |  921 | `	}` |
|     13663 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  929 | ` */` |
|     33176 |  930 | `static int HashmapFindValue(` |
...
|     33181 |  943 | `	pEntry = pMap->pFirst;` |
|     33181 |  944 | `	n = pMap->nEntry;` |
|     33181 |  945 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33181 |  946 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     78728 |  947 | `	for(;;){` |
|    157462 |  948 | `		if( n < 1 ){` |
|       115 |  949 | `			break;` |
|         - |  950 | `		}` |
|         - |  951 | `		/* Extract node value */` |
|    157348 |  952 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    157348 |  953 | `		if( pVal ){` |
...
|    157348 |  960 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    157348 |  961 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    157348 |  962 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    157348 |  963 | `			PH7_MemObjRelease(&sVal);` |
|    157348 |  964 | `			PH7_MemObjRelease(&sNeedle);` |
|    157348 |  965 | `			if( rc == 0 ){` |
|     33067 |  966 | `				if( ppNode ){` |
|        23 |  967 | `					*ppNode = pEntry;` |
|        11 |  968 | `				}` |
|         - |  969 | `				/* Match found*/` |
|     33067 |  970 | `				return SXRET_OK;` |
|         - |  971 | `			}` |
|     62140 |  972 | `		}` |
|         - |  973 | `		/* Point to the next entry */` |
|    124286 |  974 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    124286 |  975 | `		n--;` |
|         5 |  976 | `	}` |
|         - |  977 | `	/* No such entry */` |
...
|         - | 1164 | ` */` |
|    650758 | 1165 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1174 | `	sxi32 rc;` |
|         - | 1175 |  |
|    650763 | 1176 | `	if( pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ ){` |
...
|         7 | 1199 | `		return rc;` |
|         - | 1200 | `	}` |
|    650757 | 1201 | `	sSafeVal = *pVal;` |
|         - | 1202 |  |
|    650757 | 1203 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2037 | 1209 | `	}else{` |
|         - | 1210 | `		/* Int key */` |
|    646693 | 1211 | `		if( iAction == 0 ){ /* Merge */` |
|    646461 | 1212 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    323463 | 1213 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    649263 | 1250 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1251 | `		/* Extract the node value */` |
|    646519 | 1252 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    646519 | 1253 | `		if( pVal ){` |
...
|         - | 1258 | `			 */` |
|    646519 | 1259 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    323262 | 1260 | `		}else{` |
|       ! 0 | 1261 | `			rc = SXRET_OK;` |
|         - | 1262 | `		}` |
|    646519 | 1263 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1264 | `			return rc;` |
|         - | 1265 | `		}` |
|         - | 1266 | `		/* Point to the next entry */` |
|    646519 | 1267 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    323262 | 1268 | `	}` |
...
|         - | 1425 | ` */` |
|    227776 | 1426 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1427 | `{` |
|    227781 | 1428 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1429 | `	ph7_hashmap *pNew;` |
|         - | 1430 | `	ph7_value *pBacking;` |
|         - | 1431 | `	sxu32 nValIdx;` |
|         - | 1432 | `	int bValueInPool;` |
|    227781 | 1433 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    227781 | 1434 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1435 | `		/* Sole owner, no separation needed */` |
|    225423 | 1436 | `		return pMap;` |
|         - | 1437 | `	}` |
...
|         - | 1611 | ` */` |
|    142164 | 1612 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    142169 | 1620 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    142169 | 1621 | `	if( pMap == 0 ){` |
|       ! 0 | 1622 | `		return 0;` |
|         - | 1623 | `	}` |
|         - | 1624 | `	/* Zero the structure */` |
|    142169 | 1625 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1626 | `	/* Fill in the structure */` |
|    142169 | 1627 | `	pMap->pVm = &(*pVm);` |
|    142169 | 1628 | `	pMap->iRef = 1;` |
|         - | 1629 | `	/* Default hash functions */` |
|    142169 | 1630 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    142169 | 1631 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    142169 | 1632 | `	return pMap;` |
|     71087 | 1633 | `}` |
|         - | 1634 | `/*` |
...
|         - | 1724 | ` */` |
|     98816 | 1725 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1726 | `{` |
|         - | 1727 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     98821 | 1728 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1729 | `	sxu32 n;` |
|     98821 | 1730 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1734 | `	}` |
|     98821 | 1735 | `	if( pMap->pActiveSteps ){` |
...
|     98821 | 1748 | `	n = 0;` |
|     98821 | 1749 | `	pEntry = pMap->pFirst;` |
|   1701802 | 1750 | `	for(;;){` |
|   3403609 | 1751 | `		if( n >= pMap->nEntry ){` |
|     98821 | 1752 | `			break;` |
|         - | 1753 | `		}` |
|   3304793 | 1754 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1755 | `		/* Remove the reference from the foreign table */` |
|   3304793 | 1756 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3304793 | 1757 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1758 | `			/* Restore the ph7_value to the free list */` |
|   3304783 | 1759 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1652389 | 1760 | `		}` |
|         - | 1761 | `		/* Release the node */` |
|   3304793 | 1762 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    178797 | 1763 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     89396 | 1764 | `		}` |
|   3304793 | 1765 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1766 | `		/* Point to the next entry */` |
|   3304793 | 1767 | `		pEntry = pNext;` |
|   3304793 | 1768 | `		n++;` |
|         5 | 1769 | `	}` |
|     98821 | 1770 | `	if( pMap->nEntry > 0 ){` |
|         - | 1771 | `		/* Release the hash bucket */` |
|     74835 | 1772 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     37415 | 1773 | `	}` |
|     98821 | 1774 | `	if( FreeDS ){` |
|         - | 1775 | `		/* Free the whole instance */` |
|     98797 | 1776 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     49401 | 1777 | `	}else{` |
...
|         - | 1790 | ` */` |
|    819368 | 1791 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1792 | `{` |
|    819373 | 1793 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1794 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    819373 | 1795 | `	pMap->iRef--;` |
|    819373 | 1796 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     98777 | 1797 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     49386 | 1798 | `	}` |
|    819373 | 1799 | `}` |
|         - | 1800 | `/*` |
...
|         - | 1804 | ` */` |
|    136710 | 1805 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1825 | ` */` |
|   2697208 | 1826 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   2697213 | 1837 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   2697213 | 1838 | `	return rc;` |
|         5 | 1839 | `}` |
|         - | 1840 | `/*` |
...
|         - | 1876 | ` */` |
|     47102 | 1877 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1882 | `{` |
|         - | 1883 | `	sxi32 rc;` |
|     47107 | 1884 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1890 | `	}` |
|     47107 | 1891 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     47107 | 1892 | `	return rc;` |
|     23556 | 1893 | `}` |
|         - | 1894 | `/*` |
...
|         - | 1901 | ` */` |
|     18660 | 1902 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1903 | `{` |
|     18665 | 1904 | `	pStep->pCursor = pMap->pFirst;` |
|     18665 | 1905 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     18665 | 1906 | `	pMap->pActiveSteps = pStep;` |
|     18665 | 1907 | `}` |
|         - | 1908 | `/*` |
...
|         - | 1913 | ` */` |
|     18570 | 1914 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1915 | `{` |
|     18575 | 1916 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     18575 | 1917 | `	while( *ppLink ){` |
|     18575 | 1918 | `		if( *ppLink == pStep ){` |
|     18575 | 1919 | `			*ppLink = pStep->pNextActive;` |
|     18575 | 1920 | `			pStep->pNextActive = 0;` |
|     18575 | 1921 | `			return;` |
|         - | 1922 | `		}` |
...
|         - | 1945 | ` */` |
|    576104 | 1946 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1947 | `{` |
|    576109 | 1948 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    576109 | 1949 | `	if( pEntry ){` |
|    576109 | 1950 | `		if( bStore ){` |
|    228669 | 1951 | `			PH7_MemObjStore(pEntry,pValue);` |
|    114337 | 1952 | `		}else{` |
|    347445 | 1953 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1954 | `		}` |
|    288097 | 1955 | `	}else{` |
...
|         - | 1961 | ` */` |
|    150602 | 1962 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 1963 | `{` |
|         - | 1964 | `	/* Fill with the current key */` |
|    150607 | 1965 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    145665 | 1966 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 1967 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 1968 | `		}` |
|    145665 | 1969 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    145665 | 1970 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     72835 | 1971 | `	}else{` |
...
|         - | 2025 | `**   changed.` |
|         - | 2026 | `*/` |
|     34878 | 2027 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2028 | `{` |
|         - | 2029 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2030 | `    /* Prevent compiler warning */` |
|     34883 | 2031 | `	result.pNext = result.pPrev = 0;` |
|     34883 | 2032 | `	pTail = &result;` |
|    106001 | 2033 | `	while( pA && pB ){` |
|     71123 | 2034 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     47012 | 2035 | `			pTail->pPrev = pA;` |
|     47012 | 2036 | `			pA->pNext = pTail;` |
|     47012 | 2037 | `			pTail = pA;` |
|     47012 | 2038 | `			pA = pA->pPrev;` |
|     23520 | 2039 | `		}else{` |
|     24116 | 2040 | `			pTail->pPrev = pB;` |
|     24116 | 2041 | `			pB->pNext = pTail;` |
|     24116 | 2042 | `			pTail = pB;` |
|     24116 | 2043 | `			pB = pB->pPrev;` |
|         - | 2044 | `		}` |
|         5 | 2045 | `	}` |
|     34883 | 2046 | `	if( pA ){` |
|     24536 | 2047 | `		pTail->pPrev = pA;` |
|     24536 | 2048 | `		pA->pNext = pTail;` |
|     22635 | 2049 | `	}else if( pB ){` |
|     10128 | 2050 | `		pTail->pPrev = pB;` |
|     10128 | 2051 | `		pB->pNext = pTail;` |
|      5049 | 2052 | `	}else{` |
|       229 | 2053 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2054 | `	}` |
|     34883 | 2055 | `	return result.pPrev;` |
|         5 | 2056 | `}` |
|         - | 2057 | `/*` |
|         - | 2058 | `** Inputs:` |
...
|     14505 | 2076 | `	while( pIn ){` |
|     13783 | 2077 | `		p = pIn;` |
|     13783 | 2078 | `		pIn = p->pPrev;` |
|     13783 | 2079 | `		p->pPrev = 0;` |
|     26279 | 2080 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     26279 | 2081 | `			if( a[i]==0 ){` |
|     13783 | 2082 | `				a[i] = p;` |
|     13783 | 2083 | `				break;` |
|       ! 0 | 2084 | `			}else{` |
|     12501 | 2085 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     12501 | 2086 | `				a[i] = 0;` |
|         - | 2087 | `			}` |
|      6253 | 2088 | `		}` |
|     13783 | 2089 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|         - | 2111 | ` */` |
|     70900 | 2112 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2113 | `{` |
|         - | 2114 | `	ph7_value sA,sB;` |
|         - | 2115 | `	sxi32 iFlags;` |
|         - | 2116 | `	int rc;` |
|     70905 | 2117 | `	if( pCmpData == 0 ){` |
|         - | 2118 | `		/* Perform a standard comparison */` |
|     70881 | 2119 | `		rc = HashmapNodeCmp(pA,pB,FALSE);` |
|     70881 | 2120 | `		return rc;` |
|         - | 2121 | `	}` |
...
|         2 | 2430 | `		}` |
|     13609 | 2431 | `		HashmapRehashIntNode(p);` |
|         - | 2432 | `		/* Point to the next entry */` |
|     13609 | 2433 | `		i++;` |
|     13609 | 2434 | `		pLast = p;` |
|     13609 | 2435 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2436 | `	}` |
|       677 | 2437 | `}` |
|         - | 2438 | `/*` |
...
|         - | 4805 | ` */` |
|     32984 | 4806 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4807 | `{` |
|         - | 4808 | `	ph7_value *pNeedle;` |
|         - | 4809 | `	int bStrict;` |
|         - | 4810 | `	int rc;` |
|     32989 | 4811 | `	if( nArg < 2 ){` |
|         - | 4812 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4813 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4814 | `		return PH7_OK;` |
|         - | 4815 | `	}` |
|     32989 | 4816 | `	pNeedle = apArg[0];` |
|     32989 | 4817 | `	bStrict = 0;` |
|     32989 | 4818 | `	if( nArg > 2 ){` |
|        53 | 4819 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        26 | 4820 | `	}` |
|     32989 | 4821 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     32989 | 4829 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4830 | `	/* Lookup result */` |
|     32989 | 4831 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     32989 | 4832 | `	return PH7_OK;` |
|     16497 | 4833 | `}` |
|         - | 4834 | `/*` |
...
|         - | 8744 | ` */` |
|     33810 | 8745 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     33815 | 8756 | `	rc = SXRET_OK;` |
|     33815 | 8757 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     33815 | 8758 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     33815 | 8759 | `	n = pMap->nEntry;` |
|     33815 | 8760 | `	pEntry = pMap->pFirst;` |
...
|    145395 | 8767 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    145395 | 8768 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8769 | `		/* Invoke the user callback */` |
|    145395 | 8770 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8771 | `		/* Release the copy of the key and the value */` |
|    145395 | 8772 | `		PH7_MemObjRelease(&sKey);` |
|    145395 | 8773 | `		PH7_MemObjRelease(&sValue);` |
|    145395 | 8774 | `		if( rc != PH7_OK ){` |
|         - | 8775 | `			/* Callback request an operation abort */` |
|       ! 0 | 8776 | `			return SXERR_ABORT;` |
|         - | 8777 | `		}` |
|         - | 8778 | `		/* Point to the next entry */` |
|    145395 | 8779 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    145395 | 8780 | `		n--;` |
|         5 | 8781 | `	}` |
|         - | 8782 | `	/* All done */` |
|     33815 | 8783 | `	return SXRET_OK;` |
|     16910 | 8784 | `}` |
|         - | 8785 |  |
