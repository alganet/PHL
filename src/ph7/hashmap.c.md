...
|         - |   22 | ` */` |
|   7958132 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7958137 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7958137 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    520369 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    520374 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    520374 |   35 | `	sxu32 nH = 5381;` |
|    520374 |   36 | `	zEnd = &zIn[nLen];` |
|    597250 |   37 | `	for(;;){` |
|   1194506 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1020250 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    918827 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    794585 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    520374 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3649676 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3649681 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3649681 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3649681 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3649681 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3649681 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3649681 |  112 | `	pNode->nHash = nHash;` |
|   3649681 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3649681 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3649681 |  115 | `	return pNode;` |
|   1824843 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    200019 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    200024 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    200024 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    200024 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    200024 |  133 | `	pNode->pMap  = &(*pMap);` |
|    200024 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    200024 |  135 | `	pNode->nHash = nHash;` |
|    200024 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    200024 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    200024 |  138 | `	pNode->nValIdx = nValIdx;` |
|    200024 |  139 | `	return pNode;` |
|    100014 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3849695 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3849700 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3390317 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3390317 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1695156 |  150 | `	}` |
|   3849700 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3849700 |  153 | `	if( pMap->pFirst == 0 ){` |
|     88640 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     88640 |  156 | `		pMap->pCur = pNode;` |
|     44322 |  157 | `	}else{` |
|   3761065 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3849700 |  160 | `	if( pMap->pActiveSteps ){` |
...
|        11 |  172 | `		}` |
|         9 |  173 | `	}` |
|   3849700 |  174 | `	++pMap->nEntry;` |
|   3849700 |  175 | `}` |
|         - |  176 | `/*` |
|         - |  177 | ` * Unlink a node from the hashmap.` |
|         - |  178 | ` * If the node count reaches zero then release the whole hash-bucket.` |
|         - |  179 | ` */` |
|      7928 |  180 | `PH7_PRIVATE void PH7_HashmapUnlinkNode(ph7_hashmap_node *pNode,int bRestore)` |
|         5 |  181 | `{` |
|      7933 |  182 | `	ph7_hashmap *pMap = pNode->pMap;` |
|      7933 |  183 | `	ph7_vm *pVm = pMap->pVm;` |
|         - |  184 | `	/* Unlink from the corresponding bucket */` |
|      7933 |  185 | `	if( pNode->pPrevCollide == 0 ){` |
|      7445 |  186 | `		pMap->apBucket[pNode->nHash & (pMap->nSize - 1)] = pNode->pNextCollide;` |
|      3725 |  187 | `	}else{` |
|       490 |  188 | `		pNode->pPrevCollide->pNextCollide = pNode->pNextCollide;` |
|         - |  189 | `	}` |
|      7933 |  190 | `	if( pNode->pNextCollide ){` |
|      5345 |  191 | `		pNode->pNextCollide->pPrevCollide = pNode->pPrevCollide;` |
|      2671 |  192 | `	}` |
|      7933 |  193 | `	if( pMap->pFirst == pNode ){` |
|       173 |  194 | `		pMap->pFirst = pNode->pPrev;` |
|        84 |  195 | `	}` |
|      7933 |  196 | `	if( pMap->pCur == pNode ){` |
|         - |  197 | `		/* Advance the node cursor */` |
|       209 |  198 | `		pMap->pCur = pMap->pCur->pPrev; /* Reverse link */` |
|       102 |  199 | `	}` |
|      7933 |  200 | `	if( pMap->pActiveSteps ){` |
...
|      7933 |  211 | `	MACRO_LD_REMOVE(pMap->pLast,pNode);` |
|      7933 |  212 | `	if( bRestore ){` |
...
|       105 |  218 | `		}` |
|       105 |  219 | `	}` |
|      7933 |  220 | `	if( pNode->iType == HASHMAP_BLOB_NODE ){` |
|      7688 |  221 | `		SyBlobRelease(&pNode->xKey.sKey);` |
|      3842 |  222 | `	}` |
|      7933 |  223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pNode);` |
|      7933 |  224 | `	pMap->nEntry--;` |
|      7933 |  225 | `	if( pMap->nEntry < 1 && pMap != pVm->pGlobal ){` |
...
|         - |  236 | ` */` |
|   3849695 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3849700 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     94138 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     94138 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     94138 |  245 | `		if( nNew < 1 ){` |
|     88640 |  246 | `			nNew = 16;` |
...
|     94138 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     94138 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     94138 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     94138 |  260 | `		pMap->apBucket = apNew;` |
|     94138 |  261 | `		pMap->nSize = nNew;` |
|     94138 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     88640 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
|         - |  266 | `		/* Rehash old entries */` |
|      5503 |  267 | `		pEntry = pMap->pFirst;` |
|      5503 |  268 | `		n = 0;` |
|   2545357 |  269 | `		for( ;; ){` |
|   5090719 |  270 | `			if( n >= pMap->nEntry ){` |
|      5503 |  271 | `				break;` |
|         - |  272 | `			}` |
|         - |  273 | `			/* Clear the old collision link */` |
|   5085221 |  274 | `			pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  275 | `			/* Link to the new bucket */` |
|   5085221 |  276 | `			nBucket = pEntry->nHash & (nNew - 1);` |
|   5085221 |  277 | `			if( pMap->apBucket[nBucket] != 0 ){` |
|   4412635 |  278 | `				pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|   4412635 |  279 | `				pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|   2206315 |  280 | `			}` |
|   5085221 |  281 | `			pMap->apBucket[nBucket] = pEntry;` |
|         - |  282 | `			/* Point to the next entry */` |
|   5085221 |  283 | `			pEntry = pEntry->pPrev; /* Reverse link */` |
|   5085221 |  284 | `			n++;` |
|         5 |  285 | `		}` |
|         - |  286 | `		/* Free the old table */` |
|      5503 |  287 | `		SyMemBackendFree(&pMap->pVm->sAllocator,(void *)apOld);` |
|      2749 |  288 | `	}` |
|   3761065 |  289 | `	return SXRET_OK;` |
|   1924852 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3649676 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3649681 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3649639 |  310 | `		if( pValue ){` |
|   3649633 |  311 | `			sSafeVal = *pValue;` |
|   3649633 |  312 | `			pValue = &sSafeVal;` |
|   1824814 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3649639 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3649639 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3649639 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3649633 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1824814 |  322 | `		}` |
|   3649639 |  323 | `		nIdx = pObj->nIdx;` |
|   1824822 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3649681 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3649681 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3649681 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3649681 |  334 | `	if( isForeign ){` |
...
|   3649681 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3649681 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3649681 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3649681 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3649681 |  349 | `	return SXRET_OK;` |
|   1824843 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    200019 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    200024 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    153020 |  370 | `		if( pValue ){` |
|    152710 |  371 | `			sSafeVal = *pValue;` |
|    152710 |  372 | `			pValue = &sSafeVal;` |
|     76352 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    153020 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    153020 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    153020 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    152710 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     76352 |  382 | `		}` |
|    153020 |  383 | `		nIdx = pObj->nIdx;` |
|     76512 |  384 | `	}else{` |
|     47009 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    200024 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    200024 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    200024 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    200024 |  394 | `	if( isForeign ){` |
|         - |  395 | `		/* Mark as a foregin entry */` |
|     47009 |  396 | `		pNode->iFlags \|= HASHMAP_NODE_FOREIGN_OBJ;` |
|     23502 |  397 | `	}` |
|         - |  398 | `	/* Make sure the bucket is big enough to hold the new entry */` |
|    200024 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    200024 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    200024 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    200024 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    200024 |  409 | `	return SXRET_OK;` |
|    100014 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  415 | ` */` |
|   4292200 |  416 | `static sxi32 HashmapLookupIntKey(` |
...
|         - |  423 | `	sxu32 nHash;` |
|   4292205 |  424 | `	if( pMap->nEntry < 1 ){` |
|         - |  425 | `		/* Don't bother hashing,there is no entry anyway */` |
|       833 |  426 | `		return SXERR_NOTFOUND;` |
|         - |  427 | `	}` |
|         - |  428 | `	/* Hash the key first */` |
|   4291377 |  429 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  430 | `	/* Point to the appropriate bucket */` |
|   4291377 |  431 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  432 | `	/* Perform the lookup */` |
| 110567662 |  433 | `	for(;;){` |
| 221135329 |  434 | `		if( pNode == 0 ){` |
|   4284687 |  435 | `			break;` |
|         - |  436 | `		}` |
| 216850642 |  437 | `		if( pNode->iType == HASHMAP_INT_NODE` |
| 216847626 |  438 | `			&& pNode->nHash == nHash` |
| 108425655 |  439 | `			&& pNode->xKey.iKey == iKey ){` |
|         - |  440 | `				/* Node found */` |
|      6695 |  441 | `				if( ppNode ){` |
|      6673 |  442 | `					*ppNode = pNode;` |
|      3334 |  443 | `				}` |
|      6695 |  444 | `				return SXRET_OK;` |
|         - |  445 | `		}` |
...
|         - |  456 | ` */` |
|    348799 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    348804 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     28454 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    320355 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    320355 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    259619 |  475 | `	for(;;){` |
|    519243 |  476 | `		if( pNode == 0 ){` |
|    252405 |  477 | `			break;` |
|         - |  478 | `		}` |
|    266838 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    265324 |  480 | `			&& pNode->nHash == nHash` |
|    165931 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     68057 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67955 |  484 | `				if( ppNode ){` |
|     67927 |  485 | `					*ppNode = pNode;` |
|     33961 |  486 | `				}` |
|     67955 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    198893 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    252405 |  493 | `	return SXERR_NOTFOUND;` |
|    174404 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    348995 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    349000 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    349000 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    349000 |  504 | `	int isNeg = FALSE, nDigit;` |
|    349000 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    348978 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    348974 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    348974 |  516 | `	zDigit = zIn;` |
|    174951 |  517 | `	for(;;){` |
|    349908 |  518 | `		if( zIn >= zEnd ){` |
|       315 |  519 | `			break;` |
|         - |  520 | `		}` |
|    349594 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    348660 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       935 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    155568 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    155573 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    155573 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    148981 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    148981 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    148905 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    148905 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|        38 |  567 | `	}` |
|         - |  568 | `	/* Perform an int lookup */` |
|      6673 |  569 | `	if((pKey->iFlags & MEMOBJ_INT) == 0 ){` |
|         - |  570 | `		/* Force an integer cast */` |
|        89 |  571 | `		PH7_MemObjToInteger(pKey);` |
|        44 |  572 | `	}` |
|         - |  573 | `	/* Perform an int lookup */` |
|      6673 |  574 | `	rc = HashmapLookupIntKey(&(*pMap),pKey->x.iVal,&pNode);` |
|     77784 |  575 | `result:` |
|    155573 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     73835 |  578 | `		if( ppNode ){` |
|     73783 |  579 | `			*ppNode = pNode;` |
|     36889 |  580 | `		}` |
|     73835 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     81743 |  584 | `	return SXERR_NOTFOUND;` |
|     77789 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1503080 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1503085 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1503079 |  623 | `	return FALSE;` |
|    751545 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3798765 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3798770 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3798770 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3798770 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    153008 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    153008 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       231 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    229164 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     76386 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    152290 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    152154 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    152154 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1822881 |  683 | `IntKey:` |
|   3645997 |  684 | `	if( pKey ){` |
...
|   1071374 |  714 | `		}` |
|   1071379 |  715 | `	}else{` |
|   1503051 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1503049 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1503043 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1503043 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1503041 |  726 | `			++pMap->iNextIdx;` |
|    751518 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3645791 |  730 | `	return rc;` |
|   1899387 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  758 | ` */` |
|     47056 |  759 | `static sxi32 HashmapInsertByRef(` |
|         - |  760 | `	ph7_hashmap *pMap,   /* Target hashmap */` |
|         - |  761 | `	ph7_value *pKey,     /* Lookup key */` |
|         - |  762 | `	sxu32 nRefIdx        /* Foreign ph7_value index */` |
|         - |  763 | `	)` |
|         5 |  764 | `{` |
|     47061 |  765 | `	ph7_hashmap_node *pNode = 0;` |
|     47061 |  766 | `	sxi32 rc = SXRET_OK;` |
|     47061 |  767 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|     47021 |  768 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  769 | `			/* Force a string cast */` |
|       ! 0 |  770 | `			PH7_MemObjToString(&(*pKey));` |
|       ! 0 |  771 | `		}` |
|     47021 |  772 | `		if( SyBlobLength(&pKey->sBlob) < 1 \|\| HashmapIsIntKey(&pKey->sBlob) ){` |
...
|         3 |  777 | `			goto IntKey;` |
|         - |  778 | `		}` |
|     70526 |  779 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     23507 |  780 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
|         - |  781 | `				/* Overwrite */` |
...
|     47009 |  789 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),0,nRefIdx,TRUE);` |
|     47009 |  790 | `		return rc;` |
|         - |  791 | `	}` |
|        20 |  792 | `IntKey:` |
|        43 |  793 | `	if( pKey ){` |
...
|         - |  826 | ` */` |
|   1557737 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1557742 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1557742 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     79470 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     79475 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     79475 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     79475 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     79475 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     79475 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     79475 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     79475 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     79475 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     79475 |  921 | `	return rc;` |
|     39613 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     17084 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     17089 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     17089 |  932 | `	if( pEntry->pPrevCollide ){` |
|     12088 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5936 |  934 | `	}else{` |
|      5006 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     17089 |  937 | `	if( pEntry->pNextCollide ){` |
|      1070 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       556 |  939 | `	}` |
|     17089 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     17089 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     17089 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     17089 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     17089 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     17089 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     12422 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      6108 |  949 | `	}` |
|     17089 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     17089 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     17089 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     17089 |  956 | `		pMap->iNextIdx++;` |
|      8542 |  957 | `	}` |
|     17089 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33952 |  966 | `static int HashmapFindValue(` |
...
|     33957 |  979 | `	pEntry = pMap->pFirst;` |
|     33957 |  980 | `	n = pMap->nEntry;` |
|     33957 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33957 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80953 |  983 | `	for(;;){` |
|    161912 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    161834 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    161834 |  989 | `		if( pVal ){` |
...
|    161834 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    161834 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    161834 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    161834 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    161834 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    161834 | 1001 | `			if( rc == 0 ){` |
|     33879 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33879 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63977 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    127960 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    127960 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1236 | ` */` |
|    726866 | 1237 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1246 | `	sxi32 rc;` |
|         - | 1247 |  |
|    726866 | 1248 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    726868 | 1249 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1272 | `		return rc;` |
|         - | 1273 | `	}` |
|    726863 | 1274 | `	sSafeVal = *pVal;` |
|         - | 1275 |  |
|    726863 | 1276 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2029 | 1282 | `	}else{` |
|         - | 1283 | `		/* Int key */` |
|    722815 | 1284 | `		if( iAction == 0 ){ /* Merge */` |
|    719125 | 1285 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    363255 | 1286 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    722095 | 1323 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1324 | `		/* Extract the node value */` |
|    719185 | 1325 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    719185 | 1326 | `		if( pVal ){` |
...
|         - | 1331 | `			 */` |
|    719185 | 1332 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    359595 | 1333 | `		}else{` |
|       ! 0 | 1334 | `			rc = SXRET_OK;` |
|         - | 1335 | `		}` |
|    719185 | 1336 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1337 | `			return rc;` |
|         - | 1338 | `		}` |
|         - | 1339 | `		/* Point to the next entry */` |
|    719185 | 1340 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    359595 | 1341 | `	}` |
...
|         - | 1498 | ` */` |
|    248874 | 1499 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1500 | `{` |
|    248879 | 1501 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1502 | `	ph7_hashmap *pNew;` |
|         - | 1503 | `	ph7_value *pBacking;` |
|         - | 1504 | `	sxu32 nValIdx;` |
|         - | 1505 | `	int bValueInPool;` |
|    248879 | 1506 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    248879 | 1507 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1508 | `		/* Sole owner, no separation needed */` |
|    246069 | 1509 | `		return pMap;` |
|         - | 1510 | `	}` |
|      2815 | 1511 | `	if( pMap == pVm->pGlobal ){` |
...
|      2685 | 1520 | `	if( pValue->nIdx != SXU32_HIGH ){` |
|      2685 | 1521 | `		pBacking = (ph7_value *)SySetAt(&pVm->aMemObj,pValue->nIdx);` |
|      2680 | 1522 | `		if( pBacking && pBacking != pValue` |
|      2655 | 1523 | `			&& (pBacking->iFlags & MEMOBJ_HASHMAP)` |
|      2635 | 1524 | `			&& (ph7_hashmap *)pBacking->x.pOther == pMap ){` |
|         - | 1525 | `			/* Undo the stack ref to reveal true sharing count */` |
|      2635 | 1526 | `			pMap->iRef--;` |
|      2635 | 1527 | `			if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1528 | `				/* After undoing stack ref, sole owner — no separation */` |
|      2585 | 1529 | `				pMap->iRef++;` |
|      2585 | 1530 | `				return pMap;` |
|         - | 1531 | `			}` |
...
|         - | 1684 | ` */` |
|    143380 | 1685 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    143385 | 1693 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    143385 | 1694 | `	if( pMap == 0 ){` |
|       ! 0 | 1695 | `		return 0;` |
|         - | 1696 | `	}` |
|         - | 1697 | `	/* Zero the structure */` |
|    143385 | 1698 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1699 | `	/* Fill in the structure */` |
|    143385 | 1700 | `	pMap->pVm = &(*pVm);` |
|    143385 | 1701 | `	pMap->iRef = 1;` |
|         - | 1702 | `	/* Default hash functions */` |
|    143385 | 1703 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    143385 | 1704 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    143385 | 1705 | `	return pMap;` |
|     71695 | 1706 | `}` |
|         - | 1707 | `/*` |
...
|         - | 1797 | ` */` |
|     95314 | 1798 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1799 | `{` |
|         - | 1800 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     95319 | 1801 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1802 | `	sxu32 n;` |
|     95319 | 1803 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1807 | `	}` |
|     95319 | 1808 | `	if( pMap->pActiveSteps ){` |
...
|     95319 | 1821 | `	n = 0;` |
|     95319 | 1822 | `	pEntry = pMap->pFirst;` |
|   1917650 | 1823 | `	for(;;){` |
|   3835306 | 1824 | `		if( n >= pMap->nEntry ){` |
|     95319 | 1825 | `			break;` |
|         - | 1826 | `		}` |
|   3739992 | 1827 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1828 | `		/* Remove the reference from the foreign table */` |
|   3739992 | 1829 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3739992 | 1830 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1831 | `			/* Restore the ph7_value to the free list */` |
|   3739932 | 1832 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1869963 | 1833 | `		}` |
|         - | 1834 | `		/* Release the node */` |
|   3739992 | 1835 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    109790 | 1836 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     54892 | 1837 | `		}` |
|   3739992 | 1838 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1839 | `		/* Point to the next entry */` |
|   3739992 | 1840 | `		pEntry = pNext;` |
|   3739992 | 1841 | `		n++;` |
|         5 | 1842 | `	}` |
|     95319 | 1843 | `	if( pMap->nEntry > 0 ){` |
|         - | 1844 | `		/* Release the hash bucket */` |
|     69030 | 1845 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     34512 | 1846 | `	}` |
|     95319 | 1847 | `	if( FreeDS ){` |
|         - | 1848 | `		/* Free the whole instance */` |
|     95293 | 1849 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47649 | 1850 | `	}else{` |
...
|         - | 1864 | ` */` |
|    886474 | 1865 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1866 | `{` |
|    886479 | 1867 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1868 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    886479 | 1869 | `	pMap->iRef--;` |
|    886479 | 1870 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     95273 | 1871 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47634 | 1872 | `	}` |
|    886479 | 1873 | `}` |
|         - | 1874 | `/*` |
...
|         - | 1878 | ` */` |
|    155788 | 1879 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1899 | ` */` |
|   3079311 | 1900 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3079316 | 1911 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3079316 | 1912 | `	return rc;` |
|         5 | 1913 | `}` |
|         - | 1914 | `/*` |
...
|         - | 1950 | ` */` |
|     47046 | 1951 | `PH7_PRIVATE sxi32 PH7_HashmapInsertByRef(` |
...
|         5 | 1956 | `{` |
|         - | 1957 | `	sxi32 rc;` |
|     47051 | 1958 | `	if( nRefIdx == pMap->pVm->nGlobalIdx ){` |
...
|         - | 1964 | `	}` |
|     47051 | 1965 | `	rc = HashmapInsertByRef(&(*pMap),&(*pKey),nRefIdx);` |
|     47051 | 1966 | `	return rc;` |
|     23528 | 1967 | `}` |
|         - | 1968 | `/*` |
...
|         - | 1975 | ` */` |
|     23532 | 1976 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1977 | `{` |
|     23537 | 1978 | `	pStep->pCursor = pMap->pFirst;` |
|     23537 | 1979 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23537 | 1980 | `	pMap->pActiveSteps = pStep;` |
|     23537 | 1981 | `}` |
|         - | 1982 | `/*` |
...
|         - | 1987 | ` */` |
|     23356 | 1988 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1989 | `{` |
|     23361 | 1990 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23361 | 1991 | `	while( *ppLink ){` |
|     23361 | 1992 | `		if( *ppLink == pStep ){` |
|     23361 | 1993 | `			*ppLink = pStep->pNextActive;` |
|     23361 | 1994 | `			pStep->pNextActive = 0;` |
|     23361 | 1995 | `			return;` |
|         - | 1996 | `		}` |
...
|         - | 2019 | ` */` |
|    630130 | 2020 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 2021 | `{` |
|    630135 | 2022 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    630135 | 2023 | `	if( pEntry ){` |
|    630135 | 2024 | `		if( bStore ){` |
|    242751 | 2025 | `			PH7_MemObjStore(pEntry,pValue);` |
|    121378 | 2026 | `		}else{` |
|    387389 | 2027 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 2028 | `		}` |
|    314816 | 2029 | `	}else{` |
...
|         - | 2035 | ` */` |
|    168170 | 2036 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2037 | `{` |
|         - | 2038 | `	/* Fill with the current key */` |
|    168175 | 2039 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    162405 | 2040 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2041 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2042 | `		}` |
|    162405 | 2043 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    162405 | 2044 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     81205 | 2045 | `	}else{` |
...
|         - | 2099 | `**   changed.` |
|         - | 2100 | `*/` |
|     52462 | 2101 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2102 | `{` |
|         - | 2103 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2104 | `    /* Prevent compiler warning */` |
|     52467 | 2105 | `	result.pNext = result.pPrev = 0;` |
|     52467 | 2106 | `	pTail = &result;` |
|    132228 | 2107 | `	while( pA && pB ){` |
|     79766 | 2108 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     62576 | 2109 | `			pTail->pPrev = pA;` |
|     62576 | 2110 | `			pA->pNext = pTail;` |
|     62576 | 2111 | `			pTail = pA;` |
|     62576 | 2112 | `			pA = pA->pPrev;` |
|     31466 | 2113 | `		}else{` |
|     17195 | 2114 | `			pTail->pPrev = pB;` |
|     17195 | 2115 | `			pB->pNext = pTail;` |
|     17195 | 2116 | `			pTail = pB;` |
|     17195 | 2117 | `			pB = pB->pPrev;` |
|         - | 2118 | `		}` |
|         5 | 2119 | `	}` |
|     52467 | 2120 | `	if( pA ){` |
|      4377 | 2121 | `		pTail->pPrev = pA;` |
|      4377 | 2122 | `		pA->pNext = pTail;` |
|     50120 | 2123 | `	}else if( pB ){` |
|     47793 | 2124 | `		pTail->pPrev = pB;` |
|     47793 | 2125 | `		pB->pNext = pTail;` |
|     24060 | 2126 | `	}else{` |
|       307 | 2127 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2128 | `	}` |
|     52467 | 2129 | `	return result.pPrev;` |
|         5 | 2130 | `}` |
|         - | 2131 | `/*` |
|         - | 2132 | `** Inputs:` |
...
|     18365 | 2150 | `	while( pIn ){` |
|     17149 | 2151 | `		p = pIn;` |
|     17149 | 2152 | `		pIn = p->pPrev;` |
|     17149 | 2153 | `		p->pPrev = 0;` |
|     31915 | 2154 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     31915 | 2155 | `			if( a[i]==0 ){` |
|     17149 | 2156 | `				a[i] = p;` |
|     17149 | 2157 | `				break;` |
|       ! 0 | 2158 | `			}else{` |
|     14771 | 2159 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     14771 | 2160 | `				a[i] = 0;` |
|         - | 2161 | `			}` |
|      7388 | 2162 | `		}` |
|     17149 | 2163 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2281 | `	return rc;` |
|        64 | 2282 | `}` |
|     79386 | 2283 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2284 | `{` |
|     79391 | 2285 | `	if( pCmpData == 0 ){` |
|         - | 2286 | `		/* SORT_REGULAR fast path */` |
|     79303 | 2287 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2288 | `	}` |
...
|         2 | 2571 | `		}` |
|     16865 | 2572 | `		HashmapRehashIntNode(p);` |
|         - | 2573 | `		/* Point to the next entry */` |
|     16865 | 2574 | `		i++;` |
|     16865 | 2575 | `		pLast = p;` |
|     16865 | 2576 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2577 | `	}` |
|      1137 | 2578 | `}` |
|         - | 2579 | `/*` |
...
|        11 | 3078 | `		while(pMap->pLast->pPrev){` |
|         9 | 3079 | `			pMap->pLast = pMap->pLast->pPrev;` |
|         1 | 3080 | `		}` |
|         1 | 3081 | `	}` |
...
|        10 | 3123 | `			return PH7_VmThrowException(pCtx,` |
|         - | 3124 | `				"ValueError",` |
...
|        96 | 3185 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|        27 | 3298 | `	if( apArg[0]->nIdx == SXU32_HIGH ){` |
...
|         - | 4979 | ` */` |
|     33824 | 4980 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4981 | `{` |
|         - | 4982 | `	ph7_value *pNeedle;` |
|         - | 4983 | `	int bStrict;` |
|         - | 4984 | `	int rc;` |
|     33829 | 4985 | `	if( nArg < 2 ){` |
|         - | 4986 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4987 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4988 | `		return PH7_OK;` |
|         - | 4989 | `	}` |
|     33829 | 4990 | `	pNeedle = apArg[0];` |
|     33829 | 4991 | `	bStrict = 0;` |
|     33829 | 4992 | `	if( nArg > 2 ){` |
|        58 | 4993 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        28 | 4994 | `	}` |
|     33829 | 4995 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33829 | 5003 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 5004 | `	/* Lookup result */` |
|     33829 | 5005 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33829 | 5006 | `	return PH7_OK;` |
|     16917 | 5007 | `}` |
|         - | 5008 | `/*` |
...
|         3 | 7148 | `			pNode = pMap->pLast;` |
|         3 | 7149 | `			nEntry = pMap->nEntry - nEntry;` |
|         3 | 7150 | `			if( nEntry > 1 ){` |
|       ! 0 | 7151 | `				for(;;){` |
|       ! 0 | 7152 | `					if( nEntry == 0 ){` |
|       ! 0 | 7153 | `						break;` |
...
|       ! 0 | 7159 | `			}` |
|         1 | 7160 | `		}else{` |
|         7 | 7161 | `			pNode = pMap->pFirst;` |
|         8 | 7162 | `			for(;;){` |
|        12 | 7163 | `				if( nEntry == 0 ){` |
|         7 | 7164 | `					break;` |
|         - | 7165 | `				}` |
|         - | 7166 | `				/* Point to the next entry */` |
|         6 | 7167 | `				pNode = pNode->pPrev; /* Reverse link */` |
|         6 | 7168 | `				nEntry--;` |
|         1 | 7169 | `			}` |
|         - | 7170 | `		}` |
...
|       171 | 7772 | `	for( i = 1 ; i < nArg ; i++ ){` |
|        95 | 7773 | `		if( !ph7_value_is_array(apArg[i]) ){` |
|         3 | 7774 | `			if( i == 1 ){` |
...
|         - | 8841 | ` */` |
|      3432 | 8842 | `PH7_PRIVATE void PH7_RegisterHashmapFunctions(ph7_vm *pVm)` |
|         5 | 8843 | `{` |
|         - | 8844 | `	sxu32 n;` |
|    257405 | 8845 | `	for( n = 0 ; n < SX_ARRAYSIZE(aHashmapFunc) ; n++ ){` |
|    253973 | 8846 | `		ph7_create_function(&(*pVm),aHashmapFunc[n].zName,aHashmapFunc[n].xFunc,0);` |
|    126989 | 8847 | `	}` |
|      3437 | 8848 | `}` |
|         - | 8849 | `/*` |
...
|         3 | 8865 | `{` |
|       133 | 8866 | `	ph7_hashmap_node *pEntry = pMap->pFirst;` |
|         - | 8867 | `	ph7_value *pObj;` |
|       133 | 8868 | `	sxu32 n = 0;` |
|         - | 8869 | `	int isRef;` |
|       133 | 8870 | `	sxi32 rc = SXRET_OK;` |
|         - | 8871 | `	int i;` |
|       207 | 8872 | `	for(;;){` |
|       417 | 8873 | `		if( n >= pMap->nEntry ){` |
|       133 | 8874 | `			break;` |
|         - | 8875 | `		}` |
|       287 | 8876 | `		pObj = HashmapExtractNodeValue(pEntry);` |
...
|       569 | 8879 | `		isRef = ((pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) != 0)` |
|       284 | 8880 | `			\|\| PH7_VmSlotIsReferenced(pMap->pVm,pEntry->nValIdx);` |
|       287 | 8881 | `		if( ShowType ){` |
|         - | 8882 | ``			/* var_dump entry: `[key]=>` on its own line at nTab+2, the value`` |
|         - | 8883 | `			 * on the next line at the same indent (php). */` |
|       147 | 8884 | `			for( i = 0 ; i < nTab + 2 ; i++ ){` |
|        99 | 8885 | `				SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|        51 | 8886 | `			}` |
|        51 | 8887 | `			if( pEntry->iType == HASHMAP_INT_NODE){` |
|        37 | 8888 | `				SyBlobFormat(&(*pOut),"[%qd]=>",pEntry->xKey.iKey);` |
|        19 | 8889 | `			}else{` |
|        21 | 8890 | `				SyBlobFormat(&(*pOut),"[\"%.*s\"]=>",` |
|         6 | 8891 | `					SyBlobLength(&pEntry->xKey.sKey),SyBlobData(&pEntry->xKey.sKey));` |
|         - | 8892 | `			}` |
|        51 | 8893 | `			SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|        51 | 8894 | `			if( pObj ){` |
|        51 | 8895 | `				rc = PH7_MemObjDump(&(*pOut),pObj,TRUE,nTab+2,nDepth,isRef);` |
|        51 | 8896 | `				if( rc == SXERR_LIMIT ){` |
|       ! 0 | 8897 | `					break;` |
|         - | 8898 | `				}` |
|        24 | 8899 | `			}` |
|        27 | 8900 | `		}else{` |
...
|       287 | 8928 | `		n++;` |
|       287 | 8929 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|         3 | 8930 | `	}` |
|       133 | 8931 | `	return rc;` |
|         3 | 8932 | `}` |
...
|         - | 8976 | ` */` |
|     35082 | 8977 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     35087 | 8988 | `	rc = SXRET_OK;` |
|     35087 | 8989 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     35087 | 8990 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     35087 | 8991 | `	n = pMap->nEntry;` |
|     35087 | 8992 | `	pEntry = pMap->pFirst;` |
...
|    161069 | 8999 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    161069 | 9000 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 9001 | `		/* Invoke the user callback */` |
|    161069 | 9002 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 9003 | `		/* Release the copy of the key and the value */` |
|    161069 | 9004 | `		PH7_MemObjRelease(&sKey);` |
|    161069 | 9005 | `		PH7_MemObjRelease(&sValue);` |
|    161069 | 9006 | `		if( rc != PH7_OK ){` |
|         - | 9007 | `			/* Callback request an operation abort */` |
|         3 | 9008 | `			return SXERR_ABORT;` |
|         - | 9009 | `		}` |
|         - | 9010 | `		/* Point to the next entry */` |
|    161067 | 9011 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    161067 | 9012 | `		n--;` |
|         5 | 9013 | `	}` |
|         - | 9014 | `	/* All done */` |
|     35085 | 9015 | `	return SXRET_OK;` |
|     17546 | 9016 | `}` |
|         - | 9017 |  |
