...
|         - |   22 | ` */` |
|   7942932 |   23 | `static sxu32 IntHash(sxi64 iKey)` |
|         5 |   24 | `{` |
|   7942937 |   25 | `	sxu64 uKey = (sxu64)iKey; /* unsigned mixing: shifting a negative key is UB */` |
|   7942937 |   26 | `	return (sxu32)(uKey ^ (uKey << 8) ^ (uKey >> 8));` |
|         5 |   27 | `}` |
|         - |   28 | `/*` |
|         - |   29 | ` * Default hash function for string/BLOB keys.` |
|         - |   30 | ` */` |
|    509684 |   31 | `static sxu32 BinHash(const void *pSrc,sxu32 nLen)` |
|         5 |   32 | `{` |
|    509689 |   33 | `	register unsigned char *zIn = (unsigned char *)pSrc;` |
|         - |   34 | `	unsigned char *zEnd;` |
|    509689 |   35 | `	sxu32 nH = 5381;` |
|    509689 |   36 | `	zEnd = &zIn[nLen];` |
|    585078 |   37 | `	for(;;){` |
|   1170161 |   38 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|   1000929 |   39 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    901885 |   40 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|    778961 |   41 | `		if( zIn >= zEnd ){ break; } nH = nH * 33 + zIn[0] ; zIn++;` |
|         5 |   42 | `	}` |
|    509689 |   43 | `	return nH;` |
|         5 |   44 | `}` |
|         - |   45 | `/*` |
...
|         - |   98 | ` */` |
|   3637624 |   99 | `static ph7_hashmap_node * HashmapNewIntNode(ph7_hashmap *pMap,sxi64 iKey,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  100 | `{` |
|         - |  101 | `	ph7_hashmap_node *pNode;` |
|         - |  102 | `	/* Allocate a new node */` |
|   3637629 |  103 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|   3637629 |  104 | `	if( pNode == 0 ){` |
|       ! 0 |  105 | `		return 0;` |
|         - |  106 | `	}` |
|         - |  107 | `	/* Zero the stucture */` |
|   3637629 |  108 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  109 | `	/* Fill in the structure */` |
|   3637629 |  110 | `	pNode->pMap  = &(*pMap);` |
|   3637629 |  111 | `	pNode->iType = HASHMAP_INT_NODE;` |
|   3637629 |  112 | `	pNode->nHash = nHash;` |
|   3637629 |  113 | `	pNode->xKey.iKey = iKey;` |
|   3637629 |  114 | `	pNode->nValIdx  = nValIdx;` |
|   3637629 |  115 | `	return pNode;` |
|   1818817 |  116 | `}` |
|         - |  117 | `/*` |
...
|         - |  121 | ` */` |
|    195054 |  122 | `static ph7_hashmap_node * HashmapNewBlobNode(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,sxu32 nHash,sxu32 nValIdx)` |
|         5 |  123 | `{` |
|         - |  124 | `	ph7_hashmap_node *pNode;` |
|         - |  125 | `	/* Allocate a new node */` |
|    195059 |  126 | `	pNode = (ph7_hashmap_node *)SyMemBackendPoolAlloc(&pMap->pVm->sAllocator,sizeof(ph7_hashmap_node));` |
|    195059 |  127 | `	if( pNode == 0 ){` |
|       ! 0 |  128 | `		return 0;` |
|         - |  129 | `	}` |
|         - |  130 | `	/* Zero the stucture */` |
|    195059 |  131 | `	SyZero(pNode,sizeof(ph7_hashmap_node));` |
|         - |  132 | `	/* Fill in the structure */` |
|    195059 |  133 | `	pNode->pMap  = &(*pMap);` |
|    195059 |  134 | `	pNode->iType = HASHMAP_BLOB_NODE;` |
|    195059 |  135 | `	pNode->nHash = nHash;` |
|    195059 |  136 | `	SyBlobInit(&pNode->xKey.sKey,&pMap->pVm->sAllocator);` |
|    195059 |  137 | `	SyBlobAppend(&pNode->xKey.sKey,pKey,nKeyLen);` |
|    195059 |  138 | `	pNode->nValIdx = nValIdx;` |
|    195059 |  139 | `	return pNode;` |
|     97532 |  140 | `}` |
|         - |  141 | `/*` |
|         - |  142 | ` * link a hashmap node to the given bucket index (last argument to this function).` |
|         - |  143 | ` */` |
|   3832678 |  144 | `static void HashmapNodeLink(ph7_hashmap *pMap,ph7_hashmap_node *pNode,sxu32 nBucketIdx)` |
|         5 |  145 | `{` |
|         - |  146 | `	/* Link */` |
|   3832683 |  147 | `	if( pMap->apBucket[nBucketIdx] != 0 ){` |
|   3383283 |  148 | `		pNode->pNextCollide = pMap->apBucket[nBucketIdx];` |
|   3383283 |  149 | `		pMap->apBucket[nBucketIdx]->pPrevCollide = pNode;` |
|   1691639 |  150 | `	}` |
|   3832683 |  151 | `	pMap->apBucket[nBucketIdx] = pNode;` |
|         - |  152 | `	/* Link to the map list */` |
|   3832683 |  153 | `	if( pMap->pFirst == 0 ){` |
|     87057 |  154 | `		pMap->pFirst = pMap->pLast = pNode;` |
|         - |  155 | `		/* Point to the first inserted node */` |
|     87057 |  156 | `		pMap->pCur = pNode;` |
|     43531 |  157 | `	}else{` |
|   3745631 |  158 | `		MACRO_LD_PUSH(pMap->pLast,pNode);` |
|         - |  159 | `	}` |
|   3832683 |  160 | `	if( pMap->pActiveSteps ){` |
...
|         - |  236 | ` */` |
|   3832678 |  237 | `static sxi32 HashmapGrowBucket(ph7_hashmap *pMap)` |
|         5 |  238 | `{` |
|   3832683 |  239 | `	if( pMap->nEntry >= pMap->nSize * HASHMAP_FILL_FACTOR ){` |
|     92527 |  240 | `		ph7_hashmap_node **apOld = pMap->apBucket;` |
|         - |  241 | `		ph7_hashmap_node *pEntry,**apNew;` |
|     92527 |  242 | `		sxu32 nNew = pMap->nSize << 1;` |
|         - |  243 | `		sxu32 nBucket;` |
|         - |  244 | `		sxu32 n;` |
|     92527 |  245 | `		if( nNew < 1 ){` |
|     87057 |  246 | `			nNew = 16;` |
...
|     92527 |  249 | `		apNew = (ph7_hashmap_node **)SyMemBackendAlloc(&pMap->pVm->sAllocator,nNew * sizeof(ph7_hashmap_node *));` |
|     92527 |  250 | `		if( apNew == 0 ){` |
...
|         - |  256 | `		}` |
|         - |  257 | `		/* Zero the table */` |
|     92527 |  258 | `		SyZero((void *)apNew,nNew * sizeof(ph7_hashmap_node *));` |
|         - |  259 | `		/* Reflect the change */` |
|     92527 |  260 | `		pMap->apBucket = apNew;` |
|     92527 |  261 | `		pMap->nSize = nNew;` |
|     92527 |  262 | `		if( apOld == 0 ){` |
|         - |  263 | `			/* First allocated table [i.e: no entry],return immediately */` |
|     87057 |  264 | `			return SXRET_OK;` |
|         - |  265 | `		}` |
...
|      2735 |  288 | `	}` |
|   3745631 |  289 | `	return SXRET_OK;` |
|   1916344 |  290 | `}` |
|         - |  291 | `/*` |
|         - |  292 | ` * Insert a 64-bit integer key and it's associated value (if any) in the given` |
|         - |  293 | ` * hashmap.` |
|         - |  294 | ` */` |
|   3637624 |  295 | `static sxi32 HashmapInsertIntKey(ph7_hashmap *pMap,sxi64 iKey,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  296 | `{` |
|         - |  297 | `	ph7_hashmap_node *pNode;` |
|         - |  298 | `	sxu32 nIdx;` |
|         - |  299 | `	sxu32 nHash;` |
|         - |  300 | `	sxi32 rc;` |
|   3637629 |  301 | `	if( !isForeign ){` |
|         - |  302 | `		ph7_value *pObj;` |
...
|   3637587 |  310 | `		if( pValue ){` |
|   3637581 |  311 | `			sSafeVal = *pValue;` |
|   3637581 |  312 | `			pValue = &sSafeVal;` |
|   1818788 |  313 | `		}` |
|         - |  314 | `		/* Reserve a ph7_value for the value */` |
|   3637587 |  315 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|   3637587 |  316 | `		if( pObj == 0 ){` |
|       ! 0 |  317 | `			return SXERR_MEM;` |
|         - |  318 | `		}` |
|   3637587 |  319 | `		if( pValue ){` |
|         - |  320 | `			/* Duplicate the value */` |
|   3637581 |  321 | `			PH7_MemObjStore(pValue,pObj);` |
|   1818788 |  322 | `		}` |
|   3637587 |  323 | `		nIdx = pObj->nIdx;` |
|   1818796 |  324 | `	}else{` |
|        43 |  325 | `		nIdx = nRefIdx;` |
|         - |  326 | `	}` |
|         - |  327 | `	/* Hash the key */` |
|   3637629 |  328 | `	nHash = pMap->xIntHash(iKey);` |
|         - |  329 | `	/* Allocate a new int node */` |
|   3637629 |  330 | `	pNode = HashmapNewIntNode(&(*pMap),iKey,nHash,nIdx);` |
|   3637629 |  331 | `	if( pNode == 0 ){` |
|       ! 0 |  332 | `		return SXERR_MEM;` |
|         - |  333 | `	}` |
|   3637629 |  334 | `	if( isForeign ){` |
...
|   3637629 |  339 | `	rc = HashmapGrowBucket(&(*pMap));` |
|   3637629 |  340 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  341 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  342 | `		return rc;` |
|         - |  343 | `	}` |
|         - |  344 | `	/* Perform the insertion */` |
|   3637629 |  345 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  346 | `	/* Install in the reference table */` |
|   3637629 |  347 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  348 | `	/* All done */` |
|   3637629 |  349 | `	return SXRET_OK;` |
|   1818817 |  350 | `}` |
|         - |  351 | `/*` |
|         - |  352 | ` * Insert a BLOB key and it's associated value (if any) in the given` |
|         - |  353 | ` * hashmap.` |
|         - |  354 | ` */` |
|    195054 |  355 | `static sxi32 HashmapInsertBlobKey(ph7_hashmap *pMap,const void *pKey,sxu32 nKeyLen,ph7_value *pValue,sxu32 nRefIdx,int isForeign)` |
|         5 |  356 | `{` |
|         - |  357 | `	ph7_hashmap_node *pNode;` |
|         - |  358 | `	sxu32 nHash;` |
|         - |  359 | `	sxu32 nIdx;` |
|         - |  360 | `	sxi32 rc;` |
|    195059 |  361 | `	if( !isForeign ){` |
|         - |  362 | `		ph7_value *pObj;` |
...
|    148929 |  370 | `		if( pValue ){` |
|    148619 |  371 | `			sSafeVal = *pValue;` |
|    148619 |  372 | `			pValue = &sSafeVal;` |
|     74307 |  373 | `		}` |
|         - |  374 | `		/* Reserve a ph7_value for the value */` |
|    148929 |  375 | `		pObj = PH7_ReserveMemObj(pMap->pVm);` |
|    148929 |  376 | `		if( pObj == 0 ){` |
|       ! 0 |  377 | `			return SXERR_MEM;` |
|         - |  378 | `		}` |
|    148929 |  379 | `		if( pValue ){` |
|         - |  380 | `			/* Duplicate the value */` |
|    148619 |  381 | `			PH7_MemObjStore(pValue,pObj);` |
|     74307 |  382 | `		}` |
|    148929 |  383 | `		nIdx = pObj->nIdx;` |
|     74467 |  384 | `	}else{` |
|     46135 |  385 | `		nIdx = nRefIdx;` |
|         - |  386 | `	}` |
|         - |  387 | `	/* Hash the key */` |
|    195059 |  388 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  389 | `	/* Allocate a new blob node */` |
|    195059 |  390 | `	pNode = HashmapNewBlobNode(&(*pMap),pKey,nKeyLen,nHash,nIdx);` |
|    195059 |  391 | `	if( pNode == 0 ){` |
|       ! 0 |  392 | `		return SXERR_MEM;` |
|         - |  393 | `	}` |
|    195059 |  394 | `	if( isForeign ){` |
...
|    195059 |  399 | `	rc = HashmapGrowBucket(&(*pMap));` |
|    195059 |  400 | `	if( rc != SXRET_OK ){` |
|       ! 0 |  401 | `		SyMemBackendPoolFree(&pMap->pVm->sAllocator,pNode);` |
|       ! 0 |  402 | `		return rc;` |
|         - |  403 | `	}` |
|         - |  404 | `	/* Perform the insertion */` |
|    195059 |  405 | `	HashmapNodeLink(&(*pMap),pNode,nHash & (pMap->nSize - 1));` |
|         - |  406 | `	/* Install in the reference table */` |
|    195059 |  407 | `	PH7_VmRefObjInstall(pMap->pVm,nIdx,0,pNode,0);` |
|         - |  408 | `	/* All done */` |
|    195059 |  409 | `	return SXRET_OK;` |
|     97532 |  410 | `}` |
|         - |  411 | `/*` |
...
|         - |  456 | ` */` |
|    342018 |  457 | `static sxi32 HashmapLookupBlobKey(` |
...
|         - |  465 | `	sxu32 nHash;` |
|    342023 |  466 | `	if( pMap->nEntry < 1 ){` |
|         - |  467 | `		/* Don't bother hashing,there is no entry anyway */` |
|     27393 |  468 | `		return SXERR_NOTFOUND;` |
|         - |  469 | `	}` |
|         - |  470 | `	/* Hash the key first */` |
|    314635 |  471 | `	nHash = pMap->xBlobHash(pKey,nKeyLen);` |
|         - |  472 | `	/* Point to the appropriate bucket */` |
|    314635 |  473 | `	pNode = pMap->apBucket[nHash & (pMap->nSize - 1)];` |
|         - |  474 | `	/* Perform the lookup */` |
|    255335 |  475 | `	for(;;){` |
|    510675 |  476 | `		if( pNode == 0 ){` |
|    247431 |  477 | `			break;` |
|         - |  478 | `		}` |
|    263244 |  479 | `		if( pNode->iType == HASHMAP_BLOB_NODE` |
|    261733 |  480 | `			&& pNode->nHash == nHash` |
|    163764 |  481 | `			&& SyBlobLength(&pNode->xKey.sKey) == nKeyLen` |
|     67311 |  482 | `			&& SyMemcmp(SyBlobData(&pNode->xKey.sKey),pKey,nKeyLen) == 0 ){` |
|         - |  483 | `				/* Node found */` |
|     67209 |  484 | `				if( ppNode ){` |
|     67181 |  485 | `					*ppNode = pNode;` |
|     33588 |  486 | `				}` |
|     67209 |  487 | `				return SXRET_OK;` |
|         - |  488 | `		}` |
|         - |  489 | `		/* Follow the collision link */` |
|    196045 |  490 | `		pNode = pNode->pNextCollide;` |
|         5 |  491 | `	}` |
|         - |  492 | `	/* No such entry */` |
|    247431 |  493 | `	return SXERR_NOTFOUND;` |
|    171014 |  494 | `}` |
|         - |  495 | `/*` |
|         - |  496 | ` * Check if the given BLOB key looks like a decimal number.` |
|         - |  497 | ` * Retrurn TRUE on success.FALSE otherwise.` |
|         - |  498 | ` */` |
|    342152 |  499 | `static int HashmapIsIntKey(SyBlob *pKey)` |
|         5 |  500 | `{` |
|    342157 |  501 | `	const char *zIn  = (const char *)SyBlobData(pKey);` |
|    342157 |  502 | `	const char *zEnd = &zIn[SyBlobLength(pKey)];` |
|         - |  503 | `	const char *zDigit;` |
|    342157 |  504 | `	int isNeg = FALSE, nDigit;` |
|    342157 |  505 | `	if( zIn >= zEnd ){` |
|        23 |  506 | `		return FALSE;` |
|         - |  507 | `	}` |
|    342135 |  508 | `	if( (int)(zEnd-zIn) > 1 && zIn[0] == '0' ){` |
|         - |  509 | `		/* Octal not decimal number */` |
|         5 |  510 | `		return FALSE;` |
|         - |  511 | `	}` |
|    342131 |  512 | `	if( (zIn[0] == '-' \|\| zIn[0] == '+') && &zIn[1] < zEnd ){` |
|         5 |  513 | `		isNeg = (zIn[0] == '-');` |
|         5 |  514 | `		zIn++;` |
|         2 |  515 | `	}` |
|    342131 |  516 | `	zDigit = zIn;` |
|    171499 |  517 | `	for(;;){` |
|    343003 |  518 | `		if( zIn >= zEnd ){` |
|       253 |  519 | `			break;` |
|         - |  520 | `		}` |
|    342751 |  521 | `		if( (unsigned char)zIn[0] >= 0xc0 /* UTF-8 stream */  \|\| !SyisDigit(zIn[0]) ){` |
|         - |  522 | `			/* Key does not look like a decimal number */` |
|    341879 |  523 | `			return FALSE;` |
|         - |  524 | `		}` |
|       873 |  525 | `		zIn++;` |
|         1 |  526 | `	}` |
...
|         - |  546 | ` */` |
|    153506 |  547 | `static sxi32 HashmapLookup(` |
|         - |  548 | `	ph7_hashmap *pMap,          /* Target hashmap */` |
|         - |  549 | `	ph7_value *pKey,            /* Lookup key */` |
|         - |  550 | `	ph7_hashmap_node **ppNode   /* OUT: target node on success */` |
|         - |  551 | `	)` |
|         5 |  552 | `{` |
|    153511 |  553 | `	ph7_hashmap_node *pNode = 0; /* cc -O6 warning */` |
|         - |  554 | `	sxi32 rc;` |
|    153511 |  555 | `	if( pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    147109 |  556 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
|         - |  557 | `			/* Force a string cast (NULL becomes "", php's empty-string key) */` |
|         3 |  558 | `			PH7_MemObjToString(&(*pKey));` |
|         1 |  559 | `		}` |
|    147109 |  560 | `		if( !HashmapIsIntKey(&pKey->sBlob) ){` |
...
|    147093 |  564 | `			rc = HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&pNode);` |
|    147093 |  565 | `			goto result;` |
|         - |  566 | `		}` |
|         8 |  567 | `	}` |
...
|     76753 |  575 | `result:` |
|    153511 |  576 | `	if( rc == SXRET_OK ){` |
|         - |  577 | `		/* Node found */` |
|     72843 |  578 | `		if( ppNode ){` |
|     72791 |  579 | `			*ppNode = pNode;` |
|     36393 |  580 | `		}` |
|     72843 |  581 | `		return SXRET_OK;` |
|         - |  582 | `	}` |
|         - |  583 | `	/* No such entry */` |
|     80673 |  584 | `	return SXERR_NOTFOUND;` |
|     76758 |  585 | `}` |
|         - |  586 | `/*` |
...
|         - |  616 | ` */` |
|   1491232 |  617 | `static sxi32 HashmapAppendIndexBusy(ph7_hashmap *pMap,sxi32 *pRc)` |
|         5 |  618 | `{` |
|   1491237 |  619 | `	if( pMap->iNextIdx == SXI64_HIGH && SXRET_OK == HashmapLookupIntKey(&(*pMap),pMap->iNextIdx,0) ){` |
|         7 |  620 | `		*pRc = PH7_VmThrowArrayNextIndexError(pMap->pVm);` |
|         7 |  621 | `		return TRUE;` |
|         - |  622 | `	}` |
|   1491231 |  623 | `	return FALSE;` |
|    745621 |  624 | `}` |
|         - |  625 | `/*` |
...
|         - |  630 | ` */` |
|   3782684 |  631 | `static sxi32 HashmapInsert(` |
|         - |  632 | `	ph7_hashmap *pMap, /* Target hashmap */` |
|         - |  633 | `	ph7_value *pKey,   /* Lookup key  */` |
|         - |  634 | `	ph7_value *pVal    /* Node value */` |
|         - |  635 | `	)` |
|         5 |  636 | `{` |
|   3782689 |  637 | `	ph7_hashmap_node *pNode = 0;` |
|   3782689 |  638 | `	sxi32 rc = SXRET_OK;` |
|   3782689 |  639 | `	if( pKey && pKey->iFlags & (MEMOBJ_STRING\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES\|MEMOBJ_NULL) ){` |
|    148911 |  640 | `		if( (pKey->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|         3 |  645 | `		}` |
|    148911 |  646 | `		if( HashmapIsIntKey(&pKey->sBlob) ){` |
|       229 |  647 | `			goto IntKey;` |
|         - |  648 | `		}` |
...
|    223022 |  652 | `		if( SXRET_OK == HashmapLookupBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),` |
|     74339 |  653 | `			SyBlobLength(&pKey->sBlob),&pNode) ){` |
...
|         - |  666 | `		}` |
|    148197 |  667 | `		if( pMap == pMap->pVm->pGlobal ){` |
...
|    148063 |  680 | `		rc = HashmapInsertBlobKey(&(*pMap),SyBlobData(&pKey->sBlob),SyBlobLength(&pKey->sBlob),&(*pVal),0,FALSE);` |
|    148063 |  681 | `		return rc;` |
|         - |  682 | `	}` |
|   1816889 |  683 | `IntKey:` |
|   3634011 |  684 | `	if( pKey ){` |
...
|   1071306 |  714 | `		}` |
|   1071311 |  715 | `	}else{` |
|   1491203 |  716 | `		if( pMap == pMap->pVm->pGlobal ){` |
|         - |  717 | `			/* php's catchable Error: Cannot append to $GLOBALS */` |
|         3 |  718 | `			return PH7_VmThrowGlobalsAppendError(pMap->pVm);` |
|         - |  719 | `		}` |
|   1491201 |  720 | `		if( HashmapAppendIndexBusy(&(*pMap),&rc) ){` |
|         7 |  721 | `			return rc; /* PH7_EXCEPTION/PH7_ABORT: php's catchable Error was thrown */` |
|         - |  722 | `		}` |
|         - |  723 | `		/* Assign an automatic index */` |
|   1491195 |  724 | `		rc = HashmapInsertIntKey(&(*pMap),pMap->iNextIdx,&(*pVal),0,FALSE);` |
|   1491195 |  725 | `		if( rc == SXRET_OK && pMap->iNextIdx < SXI64_HIGH ){` |
|   1491193 |  726 | `			++pMap->iNextIdx;` |
|    745594 |  727 | `		}` |
|         - |  728 | `	}` |
|         - |  729 | `	/* Insertion result */` |
|   3633807 |  730 | `	return rc;` |
|   1891347 |  731 | `}` |
|         - |  732 | `/*` |
...
|         - |  826 | ` */` |
|   1526864 |  827 | `static ph7_value * HashmapExtractNodeValue(ph7_hashmap_node *pNode)` |
|         5 |  828 | `{` |
|         - |  829 | `	/* Point to the desired object */` |
|         - |  830 | `	ph7_value *pObj;` |
|   1526869 |  831 | `	pObj = (ph7_value *)SySetAt(&pNode->pMap->pVm->aMemObj,pNode->nValIdx);` |
|   1526869 |  832 | `	return pObj;` |
|         5 |  833 | `}` |
|         - |  834 | `/*` |
...
|         - |  900 | ` * documenation.` |
|         - |  901 | ` */` |
|     73271 |  902 | `static sxi32 HashmapNodeCmp(ph7_hashmap_node *pLeft,ph7_hashmap_node *pRight,int bStrict)` |
|         5 |  903 | `{` |
|         - |  904 | `	ph7_value sObj1,sObj2;` |
|         - |  905 | `	sxi32 rc;` |
|     73276 |  906 | `	if( pLeft == pRight ){` |
|         - |  907 | `		/*` |
...
|     73276 |  914 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj1);` |
|     73276 |  915 | `	PH7_MemObjInit(pLeft->pMap->pVm,&sObj2);` |
|     73276 |  916 | `	PH7_HashmapExtractNodeValue(pLeft,&sObj1,FALSE);` |
|     73276 |  917 | `	PH7_HashmapExtractNodeValue(pRight,&sObj2,FALSE);` |
|     73276 |  918 | `	rc = PH7_MemObjCmp(&sObj1,&sObj2,bStrict,0);` |
|     73276 |  919 | `	PH7_MemObjRelease(&sObj1);` |
|     73276 |  920 | `	PH7_MemObjRelease(&sObj2);` |
|     73276 |  921 | `	return rc;` |
|     36643 |  922 | `}` |
|         - |  923 | `/*` |
...
|         - |  926 | ` */` |
|     14332 |  927 | `static void HashmapRehashIntNode(ph7_hashmap_node *pEntry)` |
|         5 |  928 | `{` |
|     14337 |  929 | `	ph7_hashmap *pMap = pEntry->pMap;` |
|         - |  930 | `	sxu32 nBucket;` |
|         - |  931 | `	/* Remove old collision links */` |
|     14337 |  932 | `	if( pEntry->pPrevCollide ){` |
|     11571 |  933 | `		pEntry->pPrevCollide->pNextCollide = pEntry->pNextCollide;` |
|      5797 |  934 | `	}else{` |
|      2771 |  935 | `		pMap->apBucket[pEntry->nHash & (pMap->nSize - 1)] = pEntry->pNextCollide;` |
|         - |  936 | `	}` |
|     14337 |  937 | `	if( pEntry->pNextCollide ){` |
|      1019 |  938 | `		pEntry->pNextCollide->pPrevCollide = pEntry->pPrevCollide;` |
|       530 |  939 | `	}` |
|     14337 |  940 | `	pEntry->pNextCollide = pEntry->pPrevCollide = 0;` |
|         - |  941 | `	/* Compute the new hash */` |
|     14337 |  942 | `	pEntry->nHash = pMap->xIntHash(pMap->iNextIdx);` |
|     14337 |  943 | `	pEntry->xKey.iKey = pMap->iNextIdx;` |
|     14337 |  944 | `	nBucket = pEntry->nHash & (pMap->nSize - 1);` |
|         - |  945 | `	/* Link to the new bucket */` |
|     14337 |  946 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14337 |  947 | `	if( pMap->apBucket[nBucket] ){` |
|     11898 |  948 | `		pMap->apBucket[nBucket]->pPrevCollide = pEntry;` |
|      5964 |  949 | `	}` |
|     14337 |  950 | `	pEntry->pNextCollide = pMap->apBucket[nBucket];` |
|     14337 |  951 | `	pMap->apBucket[nBucket] = pEntry;` |
...
|     14337 |  955 | `	if( pMap->iNextIdx < SXI64_HIGH ){` |
|     14337 |  956 | `		pMap->iNextIdx++;` |
|      7166 |  957 | `	}` |
|     14337 |  958 | `}` |
|         - |  959 | `/*` |
...
|         - |  965 | ` */` |
|     33562 |  966 | `static int HashmapFindValue(` |
...
|     33567 |  979 | `	pEntry = pMap->pFirst;` |
|     33567 |  980 | `	n = pMap->nEntry;` |
|     33567 |  981 | `	PH7_MemObjInit(pMap->pVm,&sVal);` |
|     33567 |  982 | `	PH7_MemObjInit(pMap->pVm,&sNeedle);` |
|     80106 |  983 | `	for(;;){` |
|    160219 |  984 | `		if( n < 1 ){` |
|        79 |  985 | `			break;` |
|         - |  986 | `		}` |
|         - |  987 | `		/* Extract node value */` |
|    160141 |  988 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    160141 |  989 | `		if( pVal ){` |
...
|    160141 |  996 | `			PH7_MemObjLoad(pVal,&sVal);` |
|    160141 |  997 | `			PH7_MemObjLoad(pNeedle,&sNeedle);` |
|    160141 |  998 | `			rc = PH7_MemObjCmp(&sNeedle,&sVal,bStrict,0);` |
|    160141 |  999 | `			PH7_MemObjRelease(&sVal);` |
|    160141 | 1000 | `			PH7_MemObjRelease(&sNeedle);` |
|    160141 | 1001 | `			if( rc == 0 ){` |
|     33489 | 1002 | `				if( ppNode ){` |
|        23 | 1003 | `					*ppNode = pEntry;` |
|        11 | 1004 | `				}` |
|         - | 1005 | `				/* Match found*/` |
|     33489 | 1006 | `				return SXRET_OK;` |
|         - | 1007 | `			}` |
|     63325 | 1008 | `		}` |
|         - | 1009 | `		/* Point to the next entry */` |
|    126657 | 1010 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    126657 | 1011 | `		n--;` |
|         5 | 1012 | `	}` |
|         - | 1013 | `	/* No such entry */` |
...
|         - | 1200 | ` */` |
|    721322 | 1201 | `static sxi32 HashmapDuplicateNode(` |
...
|         - | 1210 | `	sxi32 rc;` |
|         - | 1211 |  |
|    721322 | 1212 | `	if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ)` |
|    721324 | 1213 | `	 \|\| PH7_VmSlotIsReferenced(pDest->pVm,pEntry->nValIdx) ){` |
...
|         9 | 1236 | `		return rc;` |
|         - | 1237 | `	}` |
|    721319 | 1238 | `	sSafeVal = *pVal;` |
|         - | 1239 |  |
|    721319 | 1240 | `	if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
...
|      2004 | 1246 | `	}else{` |
|         - | 1247 | `		/* Int key */` |
|    717321 | 1248 | `		if( iAction == 0 ){ /* Merge */` |
|    713699 | 1249 | `			rc = HashmapInsert(pDest,0/* Automatic index assign */,&sSafeVal);` |
|    360474 | 1250 | `		}else if( iAction == 1 ){ /* Overwrite */` |
...
|    716657 | 1287 | `	for( n = 0 ; n < pSrc->nEntry ; ++n ){` |
|         - | 1288 | `		/* Extract the node value */` |
|    713759 | 1289 | `		pVal = HashmapExtractNodeValue(pEntry);` |
|    713759 | 1290 | `		if( pVal ){` |
...
|         - | 1295 | `			 */` |
|    713759 | 1296 | `			rc = HashmapDuplicateNode(pDest,pEntry,pVal,0);` |
|    356882 | 1297 | `		}else{` |
|       ! 0 | 1298 | `			rc = SXRET_OK;` |
|         - | 1299 | `		}` |
|    713759 | 1300 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1301 | `			return rc;` |
|         - | 1302 | `		}` |
|         - | 1303 | `		/* Point to the next entry */` |
|    713759 | 1304 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    356882 | 1305 | `	}` |
...
|         - | 1462 | ` */` |
|    242820 | 1463 | `PH7_PRIVATE ph7_hashmap * PH7_HashmapCowSeparate(ph7_vm *pVm,ph7_value *pValue)` |
|         5 | 1464 | `{` |
|    242825 | 1465 | `	ph7_hashmap *pMap = (ph7_hashmap *)pValue->x.pOther;` |
|         - | 1466 | `	ph7_hashmap *pNew;` |
|         - | 1467 | `	ph7_value *pBacking;` |
|         - | 1468 | `	sxu32 nValIdx;` |
|         - | 1469 | `	int bValueInPool;` |
|    242825 | 1470 | `	sxi32 nByRefSteps = pMap->pActiveSteps ? HashmapByRefStepRefs(pMap) : 0;` |
|    242825 | 1471 | `	if( pMap->iRef - nByRefSteps < 2 ){` |
|         - | 1472 | `		/* Sole owner, no separation needed */` |
|    240049 | 1473 | `		return pMap;` |
|         - | 1474 | `	}` |
...
|         - | 1648 | ` */` |
|    141462 | 1649 | `PH7_PRIVATE ph7_hashmap * PH7_NewHashmap(` |
...
|    141467 | 1657 | `	pMap = (ph7_hashmap *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_hashmap));` |
|    141467 | 1658 | `	if( pMap == 0 ){` |
|       ! 0 | 1659 | `		return 0;` |
|         - | 1660 | `	}` |
|         - | 1661 | `	/* Zero the structure */` |
|    141467 | 1662 | `	SyZero(pMap,sizeof(ph7_hashmap));` |
|         - | 1663 | `	/* Fill in the structure */` |
|    141467 | 1664 | `	pMap->pVm = &(*pVm);` |
|    141467 | 1665 | `	pMap->iRef = 1;` |
|         - | 1666 | `	/* Default hash functions */` |
|    141467 | 1667 | `	pMap->xIntHash  = xIntHash ? xIntHash : IntHash;` |
|    141467 | 1668 | `	pMap->xBlobHash = xBlobHash ? xBlobHash : BinHash;` |
|    141467 | 1669 | `	return pMap;` |
|     70736 | 1670 | `}` |
|         - | 1671 | `/*` |
...
|         - | 1761 | ` */` |
|     94402 | 1762 | `PH7_PRIVATE sxi32 PH7_HashmapRelease(ph7_hashmap *pMap,int FreeDS)` |
|         5 | 1763 | `{` |
|         - | 1764 | `	ph7_hashmap_node *pEntry,*pNext;` |
|     94407 | 1765 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1766 | `	sxu32 n;` |
|     94407 | 1767 | `	if( pMap == pVm->pGlobal ){` |
...
|         - | 1771 | `	}` |
|     94407 | 1772 | `	if( pMap->pActiveSteps ){` |
...
|     94407 | 1785 | `	n = 0;` |
|     94407 | 1786 | `	pEntry = pMap->pFirst;` |
|   1910028 | 1787 | `	for(;;){` |
|   3820061 | 1788 | `		if( n >= pMap->nEntry ){` |
|     94407 | 1789 | `			break;` |
|         - | 1790 | `		}` |
|   3725659 | 1791 | `		pNext = pEntry->pPrev; /* Reverse link */` |
|         - | 1792 | `		/* Remove the reference from the foreign table */` |
|   3725659 | 1793 | `		PH7_VmRefObjRemove(pVm,pEntry->nValIdx,0,pEntry);` |
|   3725659 | 1794 | `		if( (pEntry->iFlags & HASHMAP_NODE_FOREIGN_OBJ) == 0 ){` |
|         - | 1795 | `			/* Restore the ph7_value to the free list */` |
|   3725599 | 1796 | `			PH7_VmUnsetMemObj(pVm,pEntry->nValIdx,FALSE);` |
|   1862797 | 1797 | `		}` |
|         - | 1798 | `		/* Release the node */` |
|   3725659 | 1799 | `		if( pEntry->iType == HASHMAP_BLOB_NODE ){` |
|    106993 | 1800 | `			SyBlobRelease(&pEntry->xKey.sKey);` |
|     53494 | 1801 | `		}` |
|   3725659 | 1802 | `		SyMemBackendPoolFree(&pVm->sAllocator,pEntry);` |
|         - | 1803 | `		/* Point to the next entry */` |
|   3725659 | 1804 | `		pEntry = pNext;` |
|   3725659 | 1805 | `		n++;` |
|         5 | 1806 | `	}` |
|     94407 | 1807 | `	if( pMap->nEntry > 0 ){` |
|         - | 1808 | `		/* Release the hash bucket */` |
|     67963 | 1809 | `		SyMemBackendFree(&pVm->sAllocator,pMap->apBucket);` |
|     33979 | 1810 | `	}` |
|     94407 | 1811 | `	if( FreeDS ){` |
|         - | 1812 | `		/* Free the whole instance */` |
|     94381 | 1813 | `		SyMemBackendPoolFree(&pVm->sAllocator,pMap);` |
|     47193 | 1814 | `	}else{` |
...
|         - | 1828 | ` */` |
|    872084 | 1829 | `PH7_PRIVATE void  PH7_HashmapUnref(ph7_hashmap *pMap)` |
|         5 | 1830 | `{` |
|    872089 | 1831 | `	ph7_vm *pVm = pMap->pVm;` |
|         - | 1832 | `	/* TICKET 1432-49: $GLOBALS is not subject to garbage collection */` |
|    872089 | 1833 | `	pMap->iRef--;` |
|    872089 | 1834 | `	if( pMap->iRef < 1 && pMap != pVm->pGlobal){` |
|     94361 | 1835 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     47178 | 1836 | `	}` |
|    872089 | 1837 | `}` |
|         - | 1838 | `/*` |
...
|         - | 1842 | ` */` |
|    153700 | 1843 | `PH7_PRIVATE sxi32 PH7_HashmapLookup(` |
...
|         - | 1863 | ` */` |
|   3068656 | 1864 | `PH7_PRIVATE sxi32 PH7_HashmapInsert(` |
...
|   3068661 | 1875 | `	rc = HashmapInsert(&(*pMap),&(*pKey),&(*pVal));` |
|   3068661 | 1876 | `	return rc;` |
|         5 | 1877 | `}` |
|         - | 1878 | `/*` |
...
|         - | 1939 | ` */` |
|     23228 | 1940 | `PH7_PRIVATE void PH7_HashmapRegisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1941 | `{` |
|     23233 | 1942 | `	pStep->pCursor = pMap->pFirst;` |
|     23233 | 1943 | `	pStep->pNextActive = pMap->pActiveSteps;` |
|     23233 | 1944 | `	pMap->pActiveSteps = pStep;` |
|     23233 | 1945 | `}` |
|         - | 1946 | `/*` |
...
|         - | 1951 | ` */` |
|     23060 | 1952 | `PH7_PRIVATE void PH7_HashmapUnregisterForeachStep(ph7_hashmap *pMap,ph7_foreach_step *pStep)` |
|         5 | 1953 | `{` |
|     23065 | 1954 | `	ph7_foreach_step **ppLink = &pMap->pActiveSteps;` |
|     23065 | 1955 | `	while( *ppLink ){` |
|     23065 | 1956 | `		if( *ppLink == pStep ){` |
|     23065 | 1957 | `			*ppLink = pStep->pNextActive;` |
|     23065 | 1958 | `			pStep->pNextActive = 0;` |
|     23065 | 1959 | `			return;` |
|         - | 1960 | `		}` |
...
|         - | 1983 | ` */` |
|    606768 | 1984 | `PH7_PRIVATE void PH7_HashmapExtractNodeValue(ph7_hashmap_node *pNode,ph7_value *pValue,int bStore)` |
|         5 | 1985 | `{` |
|    606773 | 1986 | `	ph7_value *pEntry = HashmapExtractNodeValue(pNode);` |
|    606773 | 1987 | `	if( pEntry ){` |
|    606773 | 1988 | `		if( bStore ){` |
|    236179 | 1989 | `			PH7_MemObjStore(pEntry,pValue);` |
|    118092 | 1990 | `		}else{` |
|    370599 | 1991 | `			PH7_MemObjLoad(pEntry,pValue);` |
|         - | 1992 | `		}` |
|    303394 | 1993 | `	}else{` |
...
|         - | 1999 | ` */` |
|    164588 | 2000 | `PH7_PRIVATE void PH7_HashmapExtractNodeKey(ph7_hashmap_node *pNode,ph7_value *pKey)` |
|         5 | 2001 | `{` |
|         - | 2002 | `	/* Fill with the current key */` |
|    164593 | 2003 | `	if( pNode->iType == HASHMAP_INT_NODE ){` |
|    158911 | 2004 | `		if( SyBlobLength(&pKey->sBlob) > 0 ){` |
|        33 | 2005 | `			SyBlobRelease(&pKey->sBlob);` |
|        16 | 2006 | `		}` |
|    158911 | 2007 | `		pKey->x.iVal = pNode->xKey.iKey;` |
|    158911 | 2008 | `		MemObjSetType(pKey,MEMOBJ_INT);` |
|     79458 | 2009 | `	}else{` |
...
|         - | 2063 | `**   changed.` |
|         - | 2064 | `*/` |
|     37302 | 2065 | `static ph7_hashmap_node * HashmapNodeMerge(ph7_hashmap_node *pA,ph7_hashmap_node *pB,ProcNodeCmp xCmp,void *pCmpData)` |
|         5 | 2066 | `{` |
|         - | 2067 | `	ph7_hashmap_node result,*pTail;` |
|         - | 2068 | `    /* Prevent compiler warning */` |
|     37307 | 2069 | `	result.pNext = result.pPrev = 0;` |
|     37307 | 2070 | `	pTail = &result;` |
|    110836 | 2071 | `	while( pA && pB ){` |
|     73534 | 2072 | `		if( xCmp(pA,pB,pCmpData) <= 0 ){` |
|     48503 | 2073 | `			pTail->pPrev = pA;` |
|     48503 | 2074 | `			pA->pNext = pTail;` |
|     48503 | 2075 | `			pTail = pA;` |
|     48503 | 2076 | `			pA = pA->pPrev;` |
|     24239 | 2077 | `		}else{` |
|     25036 | 2078 | `			pTail->pPrev = pB;` |
|     25036 | 2079 | `			pB->pNext = pTail;` |
|     25036 | 2080 | `			pTail = pB;` |
|     25036 | 2081 | `			pB = pB->pPrev;` |
|         - | 2082 | `		}` |
|         5 | 2083 | `	}` |
|     37307 | 2084 | `	if( pA ){` |
|     26501 | 2085 | `		pTail->pPrev = pA;` |
|     26501 | 2086 | `		pA->pNext = pTail;` |
|     24071 | 2087 | `	}else if( pB ){` |
|     10581 | 2088 | `		pTail->pPrev = pB;` |
|     10581 | 2089 | `		pB->pNext = pTail;` |
|      5281 | 2090 | `	}else{` |
|       235 | 2091 | `		pTail->pPrev = pTail->pNext = 0;` |
|         - | 2092 | `	}` |
|     37307 | 2093 | `	return result.pPrev;` |
|         5 | 2094 | `}` |
|         - | 2095 | `/*` |
|         - | 2096 | `** Inputs:` |
...
|     15173 | 2114 | `	while( pIn ){` |
|     14389 | 2115 | `		p = pIn;` |
|     14389 | 2116 | `		pIn = p->pPrev;` |
|     14389 | 2117 | `		p->pPrev = 0;` |
|     27387 | 2118 | `		for(i=0; i<N_SORT_BUCKET-1; i++){` |
|     27387 | 2119 | `			if( a[i]==0 ){` |
|     14389 | 2120 | `				a[i] = p;` |
|     14389 | 2121 | `				break;` |
|       ! 0 | 2122 | `			}else{` |
|     13003 | 2123 | `				p = HashmapNodeMerge(a[i],p,xCmp,pCmpData);` |
|     13003 | 2124 | `				a[i] = 0;` |
|         - | 2125 | `			}` |
|      6504 | 2126 | `		}` |
|     14389 | 2127 | `		if( i==N_SORT_BUCKET-1 ){` |
...
|       127 | 2239 | `	return rc;` |
|        64 | 2240 | `}` |
|     73205 | 2241 | `static sxi32 HashmapCmpCallback1(ph7_hashmap_node *pA,ph7_hashmap_node *pB,void *pCmpData)` |
|         5 | 2242 | `{` |
|     73210 | 2243 | `	if( pCmpData == 0 ){` |
|         - | 2244 | `		/* SORT_REGULAR fast path */` |
|     73122 | 2245 | `		return HashmapNodeCmp(pA,pB,FALSE);` |
|         - | 2246 | `	}` |
...
|         2 | 2529 | `		}` |
|     14113 | 2530 | `		HashmapRehashIntNode(p);` |
|         - | 2531 | `		/* Point to the next entry */` |
|     14113 | 2532 | `		i++;` |
|     14113 | 2533 | `		pLast = p;` |
|     14113 | 2534 | `		p = p->pPrev; /* Reverse link */` |
|         5 | 2535 | `	}` |
|       707 | 2536 | `}` |
|         - | 2537 | `/*` |
...
|         4 | 3037 | `			pMap->pLast = pMap->pLast->pPrev;` |
|       ! 0 | 3038 | `		}` |
|         1 | 3039 | `	}` |
...
|         - | 4937 | ` */` |
|     33434 | 4938 | `static int ph7_hashmap_in_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|         5 | 4939 | `{` |
|         - | 4940 | `	ph7_value *pNeedle;` |
|         - | 4941 | `	int bStrict;` |
|         - | 4942 | `	int rc;` |
|     33439 | 4943 | `	if( nArg < 2 ){` |
|         - | 4944 | `		/* Missing argument,return FALSE */` |
|       ! 0 | 4945 | `		ph7_result_bool(pCtx,0);` |
|       ! 0 | 4946 | `		return PH7_OK;` |
|         - | 4947 | `	}` |
|     33439 | 4948 | `	pNeedle = apArg[0];` |
|     33439 | 4949 | `	bStrict = 0;` |
|     33439 | 4950 | `	if( nArg > 2 ){` |
|        56 | 4951 | `		bStrict = ph7_value_to_bool(apArg[2]);` |
|        27 | 4952 | `	}` |
|     33439 | 4953 | `	if( !ph7_value_is_array(apArg[1]) ){` |
...
|     33439 | 4961 | `	rc = HashmapFindValue((ph7_hashmap *)apArg[1]->x.pOther,pNeedle,0,bStrict);` |
|         - | 4962 | `	/* Lookup result */` |
|     33439 | 4963 | `	ph7_result_bool(pCtx,rc == SXRET_OK);` |
|     33439 | 4964 | `	return PH7_OK;` |
|     16722 | 4965 | `}` |
|         - | 4966 | `/*` |
...
|         - | 8934 | ` */` |
|     34610 | 8935 | `PH7_PRIVATE sxi32 PH7_HashmapWalk(` |
...
|     34615 | 8946 | `	rc = SXRET_OK;` |
|     34615 | 8947 | `	PH7_MemObjInit(pMap->pVm,&sKey);` |
|     34615 | 8948 | `	PH7_MemObjInit(pMap->pVm,&sValue);` |
|     34615 | 8949 | `	n = pMap->nEntry;` |
|     34615 | 8950 | `	pEntry = pMap->pFirst;` |
...
|    157619 | 8957 | `		PH7_HashmapExtractNodeKey(pEntry,&sKey);` |
|    157619 | 8958 | `		PH7_HashmapExtractNodeValue(pEntry,&sValue,FALSE);` |
|         - | 8959 | `		/* Invoke the user callback */` |
|    157619 | 8960 | `		rc = xWalk(&sKey,&sValue,pUserData);` |
|         - | 8961 | `		/* Release the copy of the key and the value */` |
|    157619 | 8962 | `		PH7_MemObjRelease(&sKey);` |
|    157619 | 8963 | `		PH7_MemObjRelease(&sValue);` |
|    157619 | 8964 | `		if( rc != PH7_OK ){` |
|         - | 8965 | `			/* Callback request an operation abort */` |
|       ! 0 | 8966 | `			return SXERR_ABORT;` |
|         - | 8967 | `		}` |
|         - | 8968 | `		/* Point to the next entry */` |
|    157619 | 8969 | `		pEntry = pEntry->pPrev; /* Reverse link */` |
|    157619 | 8970 | `		n--;` |
|         5 | 8971 | `	}` |
|         - | 8972 | `	/* All done */` |
|     34615 | 8973 | `	return SXRET_OK;` |
|     17310 | 8974 | `}` |
|         - | 8975 |  |
