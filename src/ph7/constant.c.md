...
|      - |   61 | ` */` |
|   3888 |   62 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      5 |   63 | `{` |
...
|      - |   95 | ` */` |
|     18 |   96 | `static void PH7_INTMAX_Const(ph7_value *pVal,void *pUnused)` |
|      3 |   97 | `{` |
|      9 |   98 | `	SXUNUSED(pUnused);` |
|     21 |   99 | `	ph7_value_int64(pVal,SXI64_HIGH);` |
|     21 |  100 | `}` |
|      - |  101 | `/*` |
|      - |  102 | ` * PHP_INT_SIZE` |
...
|      - |  208 | ` */` |
|   1742 |  209 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|      5 |  210 | `{` |
|   1747 |  211 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  212 | `	SyString *pFile;` |
|      - |  213 | `	/* Peek the top entry */` |
|   1747 |  214 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|   1747 |  215 | `	if( pFile == 0 ){` |
|      - |  216 | `		/* Expand the magic word: ":MEMORY:" */` |
|      3 |  217 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|      2 |  218 | `	}else{` |
|   1745 |  219 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  220 | `	}` |
|   1747 |  221 | `}` |
|      - |  222 | `/*` |
|      - |  223 | ` * __DIR__` |
...
|      - |  225 | ` */` |
|     40 |  226 | `static void PH7_DIR_Const(ph7_value *pVal,void *pUserData)` |
|      4 |  227 | `{` |
|     44 |  228 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  229 | `	SyString *pFile;` |
|      - |  230 | `	/* Peek the top entry */` |
|     44 |  231 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     44 |  232 | `	if( pFile == 0 ){` |
|      - |  233 | `		/* Expand the magic word: ":MEMORY:" */` |
|      3 |  234 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|      2 |  235 | `	}else{` |
|     42 |  236 | `		if( pFile->nByte > 0 ){` |
|      - |  237 | `			const char *zDir;` |
|      - |  238 | `			int nLen;` |
|     42 |  239 | `			zDir = PH7_ExtractDirName(pFile->zString,(int)pFile->nByte,&nLen);` |
|     42 |  240 | `			ph7_value_string(pVal,zDir,nLen);` |
|     23 |  241 | `		}else{` |
...
|      - | 1095 | ` *  Expand 3.` |
|      - | 1096 | ` */` |
|   6194 | 1097 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1098 | `{` |
|   3097 | 1099 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6199 | 1100 | `	ph7_value_int(pVal,3);` |
|   6199 | 1101 | `}` |
|      - | 1102 | `/*` |
|      - | 1103 | ` * PATHINFO_FILENAME` |
|      - | 1104 | ` *  Expand 4.` |
|      - | 1105 | ` */` |
|   6186 | 1106 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1107 | `{` |
|   3093 | 1108 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6191 | 1109 | `	ph7_value_int(pVal,4);` |
|   6191 | 1110 | `}` |
|      - | 1111 | `/*` |
|      - | 1112 | ` * ASSERT_ACTIVE.` |
...
|      - | 2249 | ` */` |
|   3458 | 2250 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2251 | `{` |
|      - | 2252 | `	sxu32 n;` |
|      - | 2253 | `	/*` |
...
|      - | 2256 | `	 */` |
| 867963 | 2257 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 864505 | 2258 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 432255 | 2259 | `	}` |
|   3463 | 2260 | `}` |
