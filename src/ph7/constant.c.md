...
|      - |   26 | ` */` |
|   1666 |   27 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      2 |   28 |  |
...
|   1666 |   33 | `	if( uname(&sInfo) != 0 ){` |
|    ! 0 |   34 | `		ph7_value_string(pVal,"Unix",(int)sizeof("Unix")-1);` |
|    ! 0 |   35 | `	}else{` |
|   1666 |   36 | `		ph7_value_string(pVal,sInfo.sysname,-1);` |
|      - |   37 | `	}` |
|      - |   38 | `#else` |
|      - |   39 | `	ph7_value_string(pVal,"Host OS",(int)sizeof("Host OS")-1);` |
|      - |   40 | `#endif` |
|    833 |   41 | `	SXUNUSED(pUnused);` |
|   1668 |   42 |  |
|      - |   43 | `/*` |
|      - |   44 | ` * PHP_EOL` |
|      - |   45 | ` *  Expand the correct 'End Of Line' symbol for this platform.` |
|      - |   46 | ` */` |
|    612 |   47 | `static void PH7_EOL_Const(ph7_value *pVal,void *pUnused)` |
|      2 |   48 |  |
|    306 |   49 | `	SXUNUSED(pUnused);` |
|      - |   50 | `#ifdef __WINNT__` |
|      2 |   51 | `	ph7_value_string(pVal,"\r\n",(int)sizeof("\r\n")-1);` |
|      - |   52 | `#else` |
|    612 |   53 | `	ph7_value_string(pVal,"\n",(int)sizeof(char));` |
|      - |   54 | `#endif` |
|    614 |   55 |  |
|      - |   56 | `/*` |
|      - |   57 | ` * PHP_INT_MAX` |
...
|      - |  173 | ` */` |
|    240 |  174 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|      2 |  175 |  |
|    242 |  176 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  177 | `	SyString *pFile;` |
|      - |  178 | `	/* Peek the top entry */` |
|    242 |  179 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    242 |  180 | `	if( pFile == 0 ){` |
|      - |  181 | `		/* Expand the magic word: ":MEMORY:" */` |
|      3 |  182 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|      2 |  183 | `	}else{` |
|    240 |  184 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  185 | `	}` |
|    242 |  186 |  |
|      - |  187 | `/*` |
|      - |  188 | ` * __DIR__` |
...
|      - | 1054 | ` *  Expand 3.` |
|      - | 1055 | ` */` |
|   3506 | 1056 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1057 |  |
|   1753 | 1058 | `	SXUNUSED(pUserData); /* cc warning */` |
|   3508 | 1059 | `	ph7_value_int(pVal,3);` |
|   3508 | 1060 |  |
|      - | 1061 | `/*` |
|      - | 1062 | ` * PATHINFO_FILENAME` |
|      - | 1063 | ` *  Expand 4.` |
|      - | 1064 | ` */` |
|   3502 | 1065 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1066 |  |
|   1751 | 1067 | `	SXUNUSED(pUserData); /* cc warning */` |
|   3504 | 1068 | `	ph7_value_int(pVal,4);` |
|   3504 | 1069 |  |
|      - | 1070 | `/*` |
|      - | 1071 | ` * ASSERT_ACTIVE.` |
...
|      - | 1216 | ` *  Expand 0` |
|      - | 1217 | ` */` |
|   1594 | 1218 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1219 |  |
|    797 | 1220 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1596 | 1221 | `	ph7_value_int(pVal,0);` |
|   1596 | 1222 |  |
|      - | 1223 | `/*` |
|      - | 1224 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1225 | ` *  Expand 1` |
|      - | 1226 | ` */` |
|    798 | 1227 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1228 |  |
|    399 | 1229 | `	SXUNUSED(pUserData); /* cc warning */` |
|    800 | 1230 | `	ph7_value_int(pVal,1);` |
|    800 | 1231 |  |
|      - | 1232 | `/*` |
...
|      - | 2085 | ` */` |
|   1348 | 2086 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      2 | 2087 |  |
|      - | 2088 | `	sxu32 n;` |
|      - | 2089 | `	/*` |
...
|      - | 2092 | `	 */` |
| 273646 | 2093 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 272298 | 2094 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 136150 | 2095 | `	}` |
|   1350 | 2096 |  |
