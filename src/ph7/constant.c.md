...
|      - |   62 | ` */` |
|   3818 |   63 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      5 |   64 | `{` |
...
|      - |  148 | ` */` |
|    292 |  149 | `static void PH7_DIRSEP_Const(ph7_value *pVal,void *pUnused)` |
|      4 |  150 | `{` |
|    146 |  151 | `	SXUNUSED(pUnused);` |
|      - |  152 | `#ifdef __WINNT__` |
|      4 |  153 | `	ph7_value_string(pVal,"\\",(int)sizeof(char));` |
|      - |  154 | `#else` |
|    292 |  155 | `	ph7_value_string(pVal,"/",(int)sizeof(char));` |
|      - |  156 | `#endif` |
|    296 |  157 | `}` |
|      - |  158 | `/*` |
|      - |  159 | ` * PATH_SEPARATOR.` |
...
|      - |  243 | ` */` |
|     44 |  244 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|      5 |  245 | `{` |
|     49 |  246 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  247 | `	SyString *pFile;` |
|      - |  248 | `	/* Peek the top entry */` |
|     49 |  249 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     49 |  250 | `	if( pFile == 0 ){` |
|      - |  251 | `		/* Expand the magic word: ":MEMORY:" */` |
|    ! 0 |  252 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|    ! 0 |  253 | `	}else{` |
|     49 |  254 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  255 | `	}` |
|     49 |  256 | `}` |
|      - |  257 | `/*` |
|      - |  258 | ` * __DIR__` |
...
|      - |  378 | ` * Expands 512` |
|      - |  379 | ` */` |
|     14 |  380 | `static void PH7_E_USER_WARNING_Const(ph7_value *pVal,void *pUserData)` |
|      4 |  381 | `{` |
|     18 |  382 | `	ph7_value_int(pVal,512);` |
|      7 |  383 | `	SXUNUSED(pUserData);` |
|     18 |  384 | `}` |
|      - |  385 | `/*` |
|      - |  386 | ` * E_USER_NOTICE` |
|      - |  387 | ` * Expands 1024` |
...
|      - |  531 | ` *  Expands 4.` |
|      - |  532 | ` */` |
|      8 |  533 | `static void PH7_SORT_NUMERIC_Const(ph7_value *pVal,void *pUserData)` |
|      1 |  534 | `{` |
|      9 |  535 | `	ph7_value_int(pVal,4);` |
|      4 |  536 | `	SXUNUSED(pUserData);` |
|      9 |  537 | `}` |
|      - |  538 | `/*` |
|      - |  539 | ` * SORT_STRING` |
|      - |  540 | ` *  Expands 5.` |
|      - |  541 | ` */` |
|     12 |  542 | `static void PH7_SORT_STRING_Const(ph7_value *pVal,void *pUserData)` |
|      1 |  543 | `{` |
|     13 |  544 | `	ph7_value_int(pVal,5);` |
|      6 |  545 | `	SXUNUSED(pUserData);` |
|     13 |  546 | `}` |
|      - |  547 | `/*` |
...
|      - | 1194 | ` *  Expand 3.` |
|      - | 1195 | ` */` |
|   6520 | 1196 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1197 | `{` |
|   3260 | 1198 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6525 | 1199 | `	ph7_value_int(pVal,3);` |
|   6525 | 1200 | `}` |
|      - | 1201 | `/*` |
|      - | 1202 | ` * PATHINFO_FILENAME` |
|      - | 1203 | ` *  Expand 4.` |
|      - | 1204 | ` */` |
|   6512 | 1205 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1206 | `{` |
|   3256 | 1207 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6517 | 1208 | `	ph7_value_int(pVal,4);` |
|   6517 | 1209 | `}` |
|      - | 1210 | `/*` |
|      - | 1211 | ` * ASSERT_ACTIVE.` |
...
|      - | 1357 | ` *  Expand 0` |
|      - | 1358 | ` */` |
|   1990 | 1359 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1360 | `{` |
|    995 | 1361 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1995 | 1362 | `	ph7_value_int(pVal,0);` |
|   1995 | 1363 | `}` |
|      - | 1364 | `/*` |
|      - | 1365 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1366 | ` *  Expand 1` |
|      - | 1367 | ` */` |
|    996 | 1368 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1369 | `{` |
|    498 | 1370 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1001 | 1371 | `	ph7_value_int(pVal,1);` |
|   1001 | 1372 | `}` |
|      - | 1373 | `/*` |
...
|      - | 2324 | ` */` |
|   3344 | 2325 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2326 | `{` |
|      - | 2327 | `	sxu32 n;` |
|      - | 2328 | `	/*` |
...
|      - | 2331 | `	 */` |
| 879477 | 2332 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 876133 | 2333 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 438069 | 2334 | `	}` |
|   3349 | 2335 | `}` |
