...
|      - |   62 | ` */` |
|   3958 |   63 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      5 |   64 | `{` |
...
|      - |  243 | ` */` |
|   2480 |  244 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|      5 |  245 | `{` |
|   2485 |  246 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  247 | `	SyString *pFile;` |
|      - |  248 | `	/* Peek the top entry */` |
|   2485 |  249 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|   2485 |  250 | `	if( pFile == 0 ){` |
|      - |  251 | `		/* Expand the magic word: ":MEMORY:" */` |
|    ! 0 |  252 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|    ! 0 |  253 | `	}else{` |
|   2485 |  254 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  255 | `	}` |
|   2485 |  256 | `}` |
|      - |  257 | `/*` |
|      - |  258 | ` * __DIR__` |
...
|      - | 1173 | ` *  Expand 3.` |
|      - | 1174 | ` */` |
|   6508 | 1175 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1176 | `{` |
|   3254 | 1177 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6513 | 1178 | `	ph7_value_int(pVal,3);` |
|   6513 | 1179 | `}` |
|      - | 1180 | `/*` |
|      - | 1181 | ` * PATHINFO_FILENAME` |
|      - | 1182 | ` *  Expand 4.` |
|      - | 1183 | ` */` |
|   6500 | 1184 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1185 | `{` |
|   3250 | 1186 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6505 | 1187 | `	ph7_value_int(pVal,4);` |
|   6505 | 1188 | `}` |
|      - | 1189 | `/*` |
|      - | 1190 | ` * ASSERT_ACTIVE.` |
...
|      - | 1263 | ` *  Expand 2` |
|      - | 1264 | ` */` |
|      4 | 1265 | `static void PH7_SEEK_END_Const(ph7_value *pVal,void *pUserData)` |
|      1 | 1266 | `{` |
|      2 | 1267 | `	SXUNUSED(pUserData); /* cc warning */` |
|      5 | 1268 | `	ph7_value_int(pVal,2);` |
|      5 | 1269 | `}` |
|      - | 1270 | `/*` |
|      - | 1271 | ` * LOCK_SH.` |
|      - | 1272 | ` *  Expand 2` |
...
|      - | 1344 | ` *  Expand 0` |
|      - | 1345 | ` */` |
|   1978 | 1346 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1347 | `{` |
|    989 | 1348 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1983 | 1349 | `	ph7_value_int(pVal,0);` |
|   1983 | 1350 | `}` |
|      - | 1351 | `/*` |
|      - | 1352 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1353 | ` *  Expand 1` |
|      - | 1354 | ` */` |
|    990 | 1355 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1356 | `{` |
|    495 | 1357 | `	SXUNUSED(pUserData); /* cc warning */` |
|    995 | 1358 | `	ph7_value_int(pVal,1);` |
|    995 | 1359 | `}` |
|      - | 1360 | `/*` |
...
|      - | 2349 | ` */` |
|   3528 | 2350 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2351 | `{` |
|      - | 2352 | `	sxu32 n;` |
|      - | 2353 | `	/*` |
...
|      - | 2356 | `	 */` |
| 931397 | 2357 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 927869 | 2358 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 463937 | 2359 | `	}` |
|   3533 | 2360 | `}` |
