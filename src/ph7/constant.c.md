...
|      - | 1253 | ` *  Expand 3.` |
|      - | 1254 | ` */` |
|   6666 | 1255 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1256 | `{` |
|   3333 | 1257 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6671 | 1258 | `	ph7_value_int(pVal,3);` |
|   6671 | 1259 | `}` |
|      - | 1260 | `/*` |
|      - | 1261 | ` * PATHINFO_FILENAME` |
|      - | 1262 | ` *  Expand 4.` |
|      - | 1263 | ` */` |
|   6658 | 1264 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1265 | `{` |
|   3329 | 1266 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6663 | 1267 | `	ph7_value_int(pVal,4);` |
|   6663 | 1268 | `}` |
|      - | 1269 | `/*` |
|      - | 1270 | ` * ASSERT_ACTIVE.` |
...
|      - | 2409 | ` */` |
|   3368 | 2410 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2411 | `{` |
|      - | 2412 | `	sxu32 n;` |
|      - | 2413 | `	/*` |
...
|      - | 2416 | `	 */` |
| 912733 | 2417 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 909365 | 2418 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 454685 | 2419 | `	}` |
|   3373 | 2420 | `}` |
