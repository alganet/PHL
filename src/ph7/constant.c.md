...
|      - |   62 | ` */` |
|   3902 |   63 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      5 |   64 | `{` |
...
|   3902 |   69 | `	if( uname(&sInfo) != 0 ){` |
|    ! 0 |   70 | `		ph7_value_string(pVal,"Unix",(int)sizeof("Unix")-1);` |
|    ! 0 |   71 | `	}else{` |
|   3902 |   72 | `		ph7_value_string(pVal,sInfo.sysname,-1);` |
|      - |   73 | `	}` |
|      - |   74 | `#else` |
|      - |   75 | `	ph7_value_string(pVal,"Host OS",(int)sizeof("Host OS")-1);` |
|      - |   76 | `#endif` |
|   1951 |   77 | `	SXUNUSED(pUnused);` |
|   3907 |   78 | `}` |
|      - |   79 | `/*` |
|      - |   80 | ` * PHP_EOL` |
|      - |   81 | ` *  Expand the correct 'End Of Line' symbol for this platform.` |
|      - |   82 | ` */` |
|    834 |   83 | `static void PH7_EOL_Const(ph7_value *pVal,void *pUnused)` |
|      4 |   84 | `{` |
|    417 |   85 | `	SXUNUSED(pUnused);` |
|      - |   86 | `#ifdef __WINNT__` |
|      4 |   87 | `	ph7_value_string(pVal,"\r\n",(int)sizeof("\r\n")-1);` |
|      - |   88 | `#else` |
|    834 |   89 | `	ph7_value_string(pVal,"\n",(int)sizeof(char));` |
|      - |   90 | `#endif` |
|    838 |   91 | `}` |
|      - |   92 | `/*` |
|      - |   93 | ` * PHP_INT_MAX` |
...
|      - |   96 | ` */` |
|     34 |   97 | `static void PH7_INTMAX_Const(ph7_value *pVal,void *pUnused)` |
|      3 |   98 | `{` |
|     17 |   99 | `	SXUNUSED(pUnused);` |
|     37 |  100 | `	ph7_value_int64(pVal,SXI64_HIGH);` |
|     37 |  101 | `}` |
|      - |  102 | `/*` |
|      - |  103 | ` * PHP_INT_MIN (php 7.0)` |
|      - |  104 | ` * Expand the smallest integer supported.` |
|      - |  105 | ` */` |
|     10 |  106 | `static void PH7_INTMIN_Const(ph7_value *pVal,void *pUnused)` |
|      1 |  107 | `{` |
|      5 |  108 | `	SXUNUSED(pUnused);` |
|     11 |  109 | `	ph7_value_int64(pVal,SMALLEST_INT64);` |
|     11 |  110 | `}` |
|      - |  111 | `/*` |
|      - |  112 | ` * PHP_INT_SIZE` |
...
|      - |  243 | ` */` |
|   1832 |  244 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|      5 |  245 | `{` |
|   1837 |  246 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  247 | `	SyString *pFile;` |
|      - |  248 | `	/* Peek the top entry */` |
|   1837 |  249 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|   1837 |  250 | `	if( pFile == 0 ){` |
|      - |  251 | `		/* Expand the magic word: ":MEMORY:" */` |
|      3 |  252 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|      2 |  253 | `	}else{` |
|   1835 |  254 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  255 | `	}` |
|   1837 |  256 | `}` |
|      - |  257 | `/*` |
|      - |  258 | ` * __DIR__` |
...
|      - |  378 | ` * Expands 512` |
|      - |  379 | ` */` |
|      4 |  380 | `static void PH7_E_USER_WARNING_Const(ph7_value *pVal,void *pUserData)` |
|      2 |  381 | `{` |
|      6 |  382 | `	ph7_value_int(pVal,512);` |
|      2 |  383 | `	SXUNUSED(pUserData);` |
|      6 |  384 | `}` |
|      - |  385 | `/*` |
|      - |  386 | ` * E_USER_NOTICE` |
|      - |  387 | ` * Expands 1024` |
...
|      - |  432 | ` *  Expands 32767` |
|      - |  433 | ` */` |
|     22 |  434 | `static void PH7_E_ALL_Const(ph7_value *pVal,void *pUserData)` |
|      5 |  435 | `{` |
|     27 |  436 | `	ph7_value_int(pVal,32767);` |
|     11 |  437 | `	SXUNUSED(pUserData);` |
|     27 |  438 | `}` |
|      - |  439 | `/*` |
|      - |  440 | ` * CASE_LOWER` |
|      - |  441 | ` *  Expands 0.` |
...
|      - | 1130 | ` *  Expand 3.` |
|      - | 1131 | ` */` |
|   6228 | 1132 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1133 | `{` |
|   3114 | 1134 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6233 | 1135 | `	ph7_value_int(pVal,3);` |
|   6233 | 1136 | `}` |
|      - | 1137 | `/*` |
|      - | 1138 | ` * PATHINFO_FILENAME` |
|      - | 1139 | ` *  Expand 4.` |
|      - | 1140 | ` */` |
|   6220 | 1141 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1142 | `{` |
|   3110 | 1143 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6225 | 1144 | `	ph7_value_int(pVal,4);` |
|   6225 | 1145 | `}` |
|      - | 1146 | `/*` |
|      - | 1147 | ` * ASSERT_ACTIVE.` |
...
|      - | 1301 | ` *  Expand 0` |
|      - | 1302 | ` */` |
|   1938 | 1303 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1304 | `{` |
|    969 | 1305 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1943 | 1306 | `	ph7_value_int(pVal,0);` |
|   1943 | 1307 | `}` |
|      - | 1308 | `/*` |
|      - | 1309 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1310 | ` *  Expand 1` |
|      - | 1311 | ` */` |
|    970 | 1312 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1313 | `{` |
|    485 | 1314 | `	SXUNUSED(pUserData); /* cc warning */` |
|    975 | 1315 | `	ph7_value_int(pVal,1);` |
|    975 | 1316 | `}` |
|      - | 1317 | `/*` |
...
|      - | 2289 | ` */` |
|   3472 | 2290 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2291 | `{` |
|      - | 2292 | `	sxu32 n;` |
|      - | 2293 | `	/*` |
...
|      - | 2296 | `	 */` |
| 888837 | 2297 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 885365 | 2298 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 442685 | 2299 | `	}` |
|   3477 | 2300 | `}` |
