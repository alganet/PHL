...
|      - | 1244 | ` *  Expand 3.` |
|      - | 1245 | ` */` |
|   6532 | 1246 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1247 | `{` |
|   3266 | 1248 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6537 | 1249 | `	ph7_value_int(pVal,3);` |
|   6537 | 1250 | `}` |
|      - | 1251 | `/*` |
|      - | 1252 | ` * PATHINFO_FILENAME` |
|      - | 1253 | ` *  Expand 4.` |
|      - | 1254 | ` */` |
|   6524 | 1255 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1256 | `{` |
|   3262 | 1257 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6529 | 1258 | `	ph7_value_int(pVal,4);` |
|   6529 | 1259 | `}` |
|      - | 1260 | `/*` |
|      - | 1261 | ` * SEEK_SET.` |
|      - | 1262 | ` *  Expand 0` |
