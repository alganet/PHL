...
|      - | 1253 | ` *  Expand 3.` |
|      - | 1254 | ` */` |
|   6732 | 1255 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1256 | `{` |
|   3366 | 1257 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6737 | 1258 | `	ph7_value_int(pVal,3);` |
|   6737 | 1259 | `}` |
|      - | 1260 | `/*` |
|      - | 1261 | ` * PATHINFO_FILENAME` |
|      - | 1262 | ` *  Expand 4.` |
|      - | 1263 | ` */` |
|   6724 | 1264 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1265 | `{` |
|   3362 | 1266 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6729 | 1267 | `	ph7_value_int(pVal,4);` |
|   6729 | 1268 | `}` |
|      - | 1269 | `/*` |
|      - | 1270 | ` * ASSERT_ACTIVE.` |
