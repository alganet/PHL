...
|      - |   62 | ` */` |
|   3850 |   63 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      5 |   64 | `{` |
...
|      - |  489 | ` */` |
|     32 |  490 | `static void PH7_E_ALL_Const(ph7_value *pVal,void *pUserData)` |
|      5 |  491 | `{` |
|     37 |  492 | `	ph7_value_int(pVal,30719);` |
|     16 |  493 | `	SXUNUSED(pUserData);` |
|     37 |  494 | `}` |
|      - |  495 | `/*` |
|      - |  496 | ` * CASE_LOWER` |
|      - |  497 | ` *  Expands 0.` |
...
|      - | 1253 | ` *  Expand 3.` |
|      - | 1254 | ` */` |
|   6670 | 1255 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1256 | `{` |
|   3335 | 1257 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6675 | 1258 | `	ph7_value_int(pVal,3);` |
|   6675 | 1259 | `}` |
|      - | 1260 | `/*` |
|      - | 1261 | ` * PATHINFO_FILENAME` |
|      - | 1262 | ` *  Expand 4.` |
|      - | 1263 | ` */` |
|   6662 | 1264 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1265 | `{` |
|   3331 | 1266 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6667 | 1267 | `	ph7_value_int(pVal,4);` |
|   6667 | 1268 | `}` |
|      - | 1269 | `/*` |
|      - | 1270 | ` * ASSERT_ACTIVE.` |
...
|      - | 2409 | ` */` |
|   3370 | 2410 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2411 | `{` |
|      - | 2412 | `	sxu32 n;` |
|      - | 2413 | `	/*` |
...
|      - | 2416 | `	 */` |
| 913275 | 2417 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 909905 | 2418 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 454955 | 2419 | `	}` |
|   3375 | 2420 | `}` |
