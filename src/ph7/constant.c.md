...
|      - |   26 | ` */` |
|   1834 |   27 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      2 |   28 |  |
...
|   1834 |   33 | `	if( uname(&sInfo) != 0 ){` |
|    ! 0 |   34 | `		ph7_value_string(pVal,"Unix",(int)sizeof("Unix")-1);` |
|    ! 0 |   35 | `	}else{` |
|   1834 |   36 | `		ph7_value_string(pVal,sInfo.sysname,-1);` |
|      - |   37 | `	}` |
|      - |   38 | `#else` |
|      - |   39 | `	ph7_value_string(pVal,"Host OS",(int)sizeof("Host OS")-1);` |
|      - |   40 | `#endif` |
|    917 |   41 | `	SXUNUSED(pUnused);` |
|   1836 |   42 |  |
|      - |   43 | `/*` |
|      - |   44 | ` * PHP_EOL` |
|      - |   45 | ` *  Expand the correct 'End Of Line' symbol for this platform.` |
|      - |   46 | ` */` |
|    812 |   47 | `static void PH7_EOL_Const(ph7_value *pVal,void *pUnused)` |
|      2 |   48 |  |
|    406 |   49 | `	SXUNUSED(pUnused);` |
|      - |   50 | `#ifdef __WINNT__` |
|      2 |   51 | `	ph7_value_string(pVal,"\r\n",(int)sizeof("\r\n")-1);` |
|      - |   52 | `#else` |
|    812 |   53 | `	ph7_value_string(pVal,"\n",(int)sizeof(char));` |
|      - |   54 | `#endif` |
|    814 |   55 |  |
|      - |   56 | `/*` |
|      - |   57 | ` * PHP_INT_MAX` |
...
|      - |  173 | ` */` |
|    324 |  174 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|      2 |  175 |  |
|    326 |  176 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  177 | `	SyString *pFile;` |
|      - |  178 | `	/* Peek the top entry */` |
|    326 |  179 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    326 |  180 | `	if( pFile == 0 ){` |
|      - |  181 | `		/* Expand the magic word: ":MEMORY:" */` |
|      3 |  182 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|      2 |  183 | `	}else{` |
|    324 |  184 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  185 | `	}` |
|    326 |  186 |  |
|      - |  187 | `/*` |
|      - |  188 | ` * __DIR__` |
...
|      - | 1054 | ` *  Expand 3.` |
|      - | 1055 | ` */` |
|   3756 | 1056 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1057 |  |
|   1878 | 1058 | `	SXUNUSED(pUserData); /* cc warning */` |
|   3758 | 1059 | `	ph7_value_int(pVal,3);` |
|   3758 | 1060 |  |
|      - | 1061 | `/*` |
|      - | 1062 | ` * PATHINFO_FILENAME` |
|      - | 1063 | ` *  Expand 4.` |
|      - | 1064 | ` */` |
|   3752 | 1065 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1066 |  |
|   1876 | 1067 | `	SXUNUSED(pUserData); /* cc warning */` |
|   3754 | 1068 | `	ph7_value_int(pVal,4);` |
|   3754 | 1069 |  |
|      - | 1070 | `/*` |
|      - | 1071 | ` * ASSERT_ACTIVE.` |
...
|      - | 1216 | ` *  Expand 0` |
|      - | 1217 | ` */` |
|   1642 | 1218 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1219 |  |
|    821 | 1220 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1644 | 1221 | `	ph7_value_int(pVal,0);` |
|   1644 | 1222 |  |
|      - | 1223 | `/*` |
|      - | 1224 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1225 | ` *  Expand 1` |
|      - | 1226 | ` */` |
|    822 | 1227 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      2 | 1228 |  |
|    411 | 1229 | `	SXUNUSED(pUserData); /* cc warning */` |
|    824 | 1230 | `	ph7_value_int(pVal,1);` |
|    824 | 1231 |  |
|      - | 1232 | `/*` |
...
|      - | 2085 | ` */` |
|   1516 | 2086 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      2 | 2087 |  |
|      - | 2088 | `	sxu32 n;` |
|      - | 2089 | `	/*` |
...
|      - | 2092 | `	 */` |
| 307750 | 2093 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 306234 | 2094 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 153118 | 2095 | `	}` |
|   1518 | 2096 |  |
