...
|      - | 1191 | ` *  Expand 3.` |
|      - | 1192 | ` */` |
|   6510 | 1193 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1194 | `{` |
|   3255 | 1195 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6515 | 1196 | `	ph7_value_int(pVal,3);` |
|   6515 | 1197 | `}` |
|      - | 1198 | `/*` |
|      - | 1199 | ` * PATHINFO_FILENAME` |
|      - | 1200 | ` *  Expand 4.` |
|      - | 1201 | ` */` |
|   6502 | 1202 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1203 | `{` |
|   3251 | 1204 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6507 | 1205 | `	ph7_value_int(pVal,4);` |
|   6507 | 1206 | `}` |
|      - | 1207 | `/*` |
|      - | 1208 | ` * ASSERT_ACTIVE.` |
...
|      - | 1362 | ` *  Expand 0` |
|      - | 1363 | ` */` |
|   1982 | 1364 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1365 | `{` |
|    991 | 1366 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1987 | 1367 | `	ph7_value_int(pVal,0);` |
|   1987 | 1368 | `}` |
|      - | 1369 | `/*` |
|      - | 1370 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1371 | ` *  Expand 1` |
|      - | 1372 | ` */` |
|    992 | 1373 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1374 | `{` |
|    496 | 1375 | `	SXUNUSED(pUserData); /* cc warning */` |
|    997 | 1376 | `	ph7_value_int(pVal,1);` |
|    997 | 1377 | `}` |
|      - | 1378 | `/*` |
...
|      - | 2370 | ` */` |
|   3528 | 2371 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2372 | `{` |
|      - | 2373 | `	sxu32 n;` |
|      - | 2374 | `	/*` |
...
|      - | 2377 | `	 */` |
| 941981 | 2378 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 938453 | 2379 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 469229 | 2380 | `	}` |
|   3533 | 2381 | `}` |
