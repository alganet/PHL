...
|      - |  151 | ` */` |
|     32 |  152 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|      2 |  153 |  |
|     34 |  154 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  155 | `	SyString *pFile;` |
|      - |  156 | `	/* Peek the top entry */` |
|     34 |  157 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|     34 |  158 | `	if( pFile == 0 ){` |
|      - |  159 | `		/* Expand the magic word: ":MEMORY:" */` |
|      3 |  160 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|      2 |  161 | `	}else{` |
|     32 |  162 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  163 | `	}` |
|     34 |  164 |  |
|      - |  165 | `/*` |
|      - |  166 | ` * __DIR__` |
...
|      - | 1032 | ` *  Expand 3.` |
|      - | 1033 | ` */` |
|   2624 | 1034 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      1 | 1035 |  |
|   1312 | 1036 | `	SXUNUSED(pUserData); /* cc warning */` |
|   2625 | 1037 | `	ph7_value_int(pVal,3);` |
|   2625 | 1038 |  |
|      - | 1039 | `/*` |
|      - | 1040 | ` * PATHINFO_FILENAME` |
|      - | 1041 | ` *  Expand 4.` |
|      - | 1042 | ` */` |
|   2620 | 1043 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      1 | 1044 |  |
|   1310 | 1045 | `	SXUNUSED(pUserData); /* cc warning */` |
|   2621 | 1046 | `	ph7_value_int(pVal,4);` |
|   2621 | 1047 |  |
|      - | 1048 | `/*` |
|      - | 1049 | ` * ASSERT_ACTIVE.` |
...
|      - | 1194 | ` *  Expand 0` |
|      - | 1195 | ` */` |
|   1322 | 1196 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      1 | 1197 |  |
|    661 | 1198 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1323 | 1199 | `	ph7_value_int(pVal,0);` |
|   1323 | 1200 |  |
|      - | 1201 | `/*` |
|      - | 1202 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1203 | ` *  Expand 1` |
|      - | 1204 | ` */` |
|    662 | 1205 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      1 | 1206 |  |
|    331 | 1207 | `	SXUNUSED(pUserData); /* cc warning */` |
|    663 | 1208 | `	ph7_value_int(pVal,1);` |
|    663 | 1209 |  |
|      - | 1210 | `/*` |
...
|      - | 2061 | ` */` |
|    924 | 2062 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      2 | 2063 |  |
|      - | 2064 | `	sxu32 n;` |
|      - | 2065 | `	/*` |
...
|      - | 2068 | `	 */` |
| 185726 | 2069 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 184802 | 2070 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
|  92402 | 2071 | `	}` |
|    926 | 2072 |  |
