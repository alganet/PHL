...
|      - | 1125 | ` * Expand 1` |
|      - | 1126 | ` */` |
|     22 | 1127 | `static void PH7_PHP_QUERY_RFC1738_Const(ph7_value *pVal,void *pUserData)` |
|      1 | 1128 | `{` |
|     11 | 1129 | `	SXUNUSED(pUserData); /* cc warning */` |
|     23 | 1130 | `	ph7_value_int(pVal,1);` |
|     23 | 1131 | `}` |
|      - | 1132 | `/*` |
|      - | 1133 | ` * PHP_QUERY_RFC3986` |
|      - | 1134 | ` * Expand 1` |
|      - | 1135 | ` */` |
|     96 | 1136 | `static void PH7_PHP_QUERY_RFC3986_Const(ph7_value *pVal,void *pUserData)` |
|      1 | 1137 | `{` |
|     48 | 1138 | `	SXUNUSED(pUserData); /* cc warning */` |
|     97 | 1139 | `	ph7_value_int(pVal,2);` |
|     97 | 1140 | `}` |
...
|      - | 1200 | ` *  Expand 3.` |
|      - | 1201 | ` */` |
|   6548 | 1202 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1203 | `{` |
|   3274 | 1204 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6553 | 1205 | `	ph7_value_int(pVal,3);` |
|   6553 | 1206 | `}` |
|      - | 1207 | `/*` |
|      - | 1208 | ` * PATHINFO_FILENAME` |
|      - | 1209 | ` *  Expand 4.` |
|      - | 1210 | ` */` |
|   6540 | 1211 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1212 | `{` |
|   3270 | 1213 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6545 | 1214 | `	ph7_value_int(pVal,4);` |
|   6545 | 1215 | `}` |
|      - | 1216 | `/*` |
|      - | 1217 | ` * ASSERT_ACTIVE.` |
...
|      - | 1363 | ` *  Expand 0` |
|      - | 1364 | ` */` |
|   2034 | 1365 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1366 | `{` |
|   1017 | 1367 | `	SXUNUSED(pUserData); /* cc warning */` |
|   2039 | 1368 | `	ph7_value_int(pVal,0);` |
|   2039 | 1369 | `}` |
|      - | 1370 | `/*` |
|      - | 1371 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1372 | ` *  Expand 1` |
|      - | 1373 | ` */` |
|   1018 | 1374 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1375 | `{` |
|    509 | 1376 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1023 | 1377 | `	ph7_value_int(pVal,1);` |
|   1023 | 1378 | `}` |
|      - | 1379 | `/*` |
...
|      - | 2331 | ` */` |
|   3356 | 2332 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2333 | `{` |
|      - | 2334 | `	sxu32 n;` |
|      - | 2335 | `	/*` |
...
|      - | 2338 | `	 */` |
| 885989 | 2339 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 882633 | 2340 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 441319 | 2341 | `	}` |
|   3361 | 2342 | `}` |
