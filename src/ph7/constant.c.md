...
|      - | 1244 | ` *  Expand 3.` |
|      - | 1245 | ` */` |
|   6524 | 1246 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1247 | `{` |
|   3262 | 1248 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6529 | 1249 | `	ph7_value_int(pVal,3);` |
|   6529 | 1250 | `}` |
|      - | 1251 | `/*` |
|      - | 1252 | ` * PATHINFO_FILENAME` |
|      - | 1253 | ` *  Expand 4.` |
|      - | 1254 | ` */` |
|   6516 | 1255 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1256 | `{` |
|   3258 | 1257 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6521 | 1258 | `	ph7_value_int(pVal,4);` |
|   6521 | 1259 | `}` |
|      - | 1260 | `/*` |
|      - | 1261 | ` * SEEK_SET.` |
|      - | 1262 | ` *  Expand 0` |
