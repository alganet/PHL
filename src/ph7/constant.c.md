...
Coverage: 1125/1169 lines (96.24%)
...
|      - |  154 | ` */` |
|    304 |  155 | `static void PH7_DIRSEP_Const(ph7_value *pVal,void *pUnused)` |
|      4 |  156 | `{` |
|    152 |  157 | `	SXUNUSED(pUnused);` |
|      - |  158 | `#ifdef __WINNT__` |
|      4 |  159 | `	ph7_value_string(pVal,"\\",(int)sizeof(char));` |
|      - |  160 | `#else` |
|    304 |  161 | `	ph7_value_string(pVal,"/",(int)sizeof(char));` |
|      - |  162 | `#endif` |
|    308 |  163 | `}` |
|      - |  164 | `/*` |
|      - |  165 | ` * PATH_SEPARATOR.` |
...
|      - |  249 | ` */` |
|    ! 0 |  250 | `static void PH7_FILE_Const(ph7_value *pVal,void *pUserData)` |
|    ! 0 |  251 | `{` |
|    ! 0 |  252 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  253 | `	SyString *pFile;` |
|      - |  254 | `	/* Peek the top entry */` |
|    ! 0 |  255 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    ! 0 |  256 | `	if( pFile == 0 ){` |
|      - |  257 | `		/* Expand the magic word: ":MEMORY:" */` |
|    ! 0 |  258 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|    ! 0 |  259 | `	}else{` |
|    ! 0 |  260 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|      - |  261 | `	}` |
|    ! 0 |  262 | `}` |
|      - |  263 | `/*` |
|      - |  264 | ` * __DIR__` |
...
|      - |  266 | ` */` |
|    ! 0 |  267 | `static void PH7_DIR_Const(ph7_value *pVal,void *pUserData)` |
|    ! 0 |  268 | `{` |
|    ! 0 |  269 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|      - |  270 | `	SyString *pFile;` |
|      - |  271 | `	/* Peek the top entry */` |
|    ! 0 |  272 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    ! 0 |  273 | `	if( pFile == 0 ){` |
|      - |  274 | `		/* Expand the magic word: ":MEMORY:" */` |
|    ! 0 |  275 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|    ! 0 |  276 | `	}else{` |
|    ! 0 |  277 | `		if( pFile->nByte > 0 ){` |
|      - |  278 | `			const char *zDir;` |
|      - |  279 | `			int nLen;` |
|    ! 0 |  280 | `			zDir = PH7_ExtractDirName(pFile->zString,(int)pFile->nByte,&nLen);` |
|    ! 0 |  281 | `			ph7_value_string(pVal,zDir,nLen);` |
|    ! 0 |  282 | `		}else{` |
...
|      - |  833 | ` */` |
|      4 |  834 | `static void PH7_DATE_ATOM_Const(ph7_value *pVal,void *pUserData)` |
|      1 |  835 | `{` |
|      2 |  836 | `	SXUNUSED(pUserData); /* cc warning */` |
|      5 |  837 | `	ph7_value_string(pVal,"Y-m-d\\TH:i:sP",-1/*Compute length automatically*/);` |
|      5 |  838 | `}` |
|      - |  839 | `/*` |
|      - |  840 | ` * DATE_COOKIE` |
...
|      - | 1203 | ` *  Expand 3.` |
|      - | 1204 | ` */` |
|   6586 | 1205 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1206 | `{` |
|   3293 | 1207 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6591 | 1208 | `	ph7_value_int(pVal,3);` |
|   6591 | 1209 | `}` |
|      - | 1210 | `/*` |
|      - | 1211 | ` * PATHINFO_FILENAME` |
|      - | 1212 | ` *  Expand 4.` |
|      - | 1213 | ` */` |
|   6578 | 1214 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1215 | `{` |
|   3289 | 1216 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6583 | 1217 | `	ph7_value_int(pVal,4);` |
|   6583 | 1218 | `}` |
|      - | 1219 | `/*` |
|      - | 1220 | ` * ASSERT_ACTIVE.` |
...
|      - | 1366 | ` *  Expand 0` |
|      - | 1367 | ` */` |
|   2098 | 1368 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1369 | `{` |
|   1049 | 1370 | `	SXUNUSED(pUserData); /* cc warning */` |
|   2103 | 1371 | `	ph7_value_int(pVal,0);` |
|   2103 | 1372 | `}` |
|      - | 1373 | `/*` |
|      - | 1374 | ` * SCANDIR_SORT_DESCENDING` |
|      - | 1375 | ` *  Expand 1` |
|      - | 1376 | ` */` |
|   1050 | 1377 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1378 | `{` |
|    525 | 1379 | `	SXUNUSED(pUserData); /* cc warning */` |
|   1055 | 1380 | `	ph7_value_int(pVal,1);` |
|   1055 | 1381 | `}` |
|      - | 1382 | `/*` |
...
|      - | 2337 | ` */` |
|   3360 | 2338 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2339 | `{` |
|      - | 2340 | `	sxu32 n;` |
|      - | 2341 | `	/*` |
...
|      - | 2344 | `	 */` |
| 897125 | 2345 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 893765 | 2346 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 446885 | 2347 | `	}` |
|   3365 | 2348 | `}` |
