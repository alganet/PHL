...
|      - |   62 | ` */` |
|   3848 |   63 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      5 |   64 | `{` |
...
|      - | 1253 | ` *  Expand 3.` |
|      - | 1254 | ` */` |
|   6660 | 1255 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1256 | `{` |
|   3330 | 1257 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6665 | 1258 | `	ph7_value_int(pVal,3);` |
|   6665 | 1259 | `}` |
|      - | 1260 | `/*` |
|      - | 1261 | ` * PATHINFO_FILENAME` |
|      - | 1262 | ` *  Expand 4.` |
|      - | 1263 | ` */` |
|   6652 | 1264 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1265 | `{` |
|   3326 | 1266 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6657 | 1267 | `	ph7_value_int(pVal,4);` |
|   6657 | 1268 | `}` |
|      - | 1269 | `/*` |
|      - | 1270 | ` * ASSERT_ACTIVE.` |
...
|      - | 2389 | ` */` |
|   3368 | 2390 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2391 | `{` |
|      - | 2392 | `	sxu32 n;` |
|      - | 2393 | `	/*` |
...
|      - | 2396 | `	 */` |
| 905997 | 2397 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 902629 | 2398 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 451317 | 2399 | `	}` |
|   3373 | 2400 | `}` |
