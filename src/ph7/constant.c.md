...
|       - |   26 | ` */` |
|      74 |   27 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|       1 |   28 |  |
|       - |   29 | `#if defined(__WINNT__)` |
|       1 |   30 | `	ph7_value_string(pVal,"WINNT",(int)sizeof("WINNT")-1);` |
|       - |   31 | `#elif defined(__UNIXES__)` |
|       - |   32 | `	struct utsname sInfo;` |
|      74 |   33 | `	if( uname(&sInfo) != 0 ){` |
|     ! 0 |   34 | `		ph7_value_string(pVal,"Unix",(int)sizeof("Unix")-1);` |
|     ! 0 |   35 | `	}else{` |
|      74 |   36 | `		ph7_value_string(pVal,sInfo.sysname,-1);` |
|       - |   37 | `	}` |
|       - |   38 | `#else` |
|       - |   39 | `	ph7_value_string(pVal,"Host OS",(int)sizeof("Host OS")-1);` |
|       - |   40 | `#endif` |
|      37 |   41 | `	SXUNUSED(pUnused);` |
|      75 |   42 |  |
|       - |   43 | `/*` |
|       - |   44 | ` * PHP_EOL` |
...
|       - |   82 | `#ifdef __WINNT__` |
|       1 |   83 | `	ph7_value_string(pVal,"\\",(int)sizeof(char));` |
|       - |   84 | `#else` |
...
|       1 |  153 |  |
|      35 |  154 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|       - |  155 | `	SyString *pFile;` |
|       - |  156 | `	/* Peek the top entry */` |
|      35 |  157 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      35 |  158 | `	if( pFile == 0 ){` |
|       - |  159 | `		/* Expand the magic word: ":MEMORY:" */` |
|       3 |  160 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|       2 |  161 | `	}else{` |
|      33 |  162 | `		ph7_value_string(pVal,pFile->zString,pFile->nByte);` |
|       - |  163 | `	}` |
|      35 |  164 |  |
|       - |  165 | `/*` |
|       - |  166 | ` * __DIR__` |
...
|       - |  168 | ` */` |
|      22 |  169 | `static void PH7_DIR_Const(ph7_value *pVal,void *pUserData)` |
|       1 |  170 |  |
|      23 |  171 | `	ph7_vm *pVm = (ph7_vm *)pUserData;` |
|       - |  172 | `	SyString *pFile;` |
|       - |  173 | `	/* Peek the top entry */` |
|      23 |  174 | `	pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|      23 |  175 | `	if( pFile == 0 ){` |
|       - |  176 | `		/* Expand the magic word: ":MEMORY:" */` |
|       3 |  177 | `		ph7_value_string(pVal,":MEMORY:",(int)sizeof(":MEMORY:")-1);` |
|       2 |  178 | `	}else{` |
|      21 |  179 | `		if( pFile->nByte > 0 ){` |
|       - |  180 | `			const char *zDir;` |
|       - |  181 | `			int nLen;` |
|      21 |  182 | `			zDir = PH7_ExtractDirName(pFile->zString,(int)pFile->nByte,&nLen);` |
|      21 |  183 | `			ph7_value_string(pVal,zDir,nLen);` |
|      11 |  184 | `		}else{` |
...
|       - | 1032 | ` *  Expand 3.` |
|       - | 1033 | ` */` |
|       4 | 1034 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|       1 | 1035 |  |
|       2 | 1036 | `	SXUNUSED(pUserData); /* cc warning */` |
|       5 | 1037 | `	ph7_value_int(pVal,3);` |
|       5 | 1038 |  |
|       - | 1039 | `/*` |
|       - | 1040 | ` * PATHINFO_FILENAME` |
|       - | 1041 | ` *  Expand 4.` |
|       - | 1042 | ` */` |
|       4 | 1043 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|       1 | 1044 |  |
|       2 | 1045 | `	SXUNUSED(pUserData); /* cc warning */` |
|       5 | 1046 | `	ph7_value_int(pVal,4);` |
|       5 | 1047 |  |
|       - | 1048 | `/*` |
|       - | 1049 | ` * ASSERT_ACTIVE.` |
...
|       - | 1194 | ` *  Expand 0` |
|       - | 1195 | ` */` |
|       2 | 1196 | `static void PH7_SCANDIR_SORT_ASCENDING_Const(ph7_value *pVal,void *pUserData)` |
|       1 | 1197 |  |
|       1 | 1198 | `	SXUNUSED(pUserData); /* cc warning */` |
|       3 | 1199 | `	ph7_value_int(pVal,0);` |
|       3 | 1200 |  |
|       - | 1201 | `/*` |
|       - | 1202 | ` * SCANDIR_SORT_DESCENDING` |
|       - | 1203 | ` *  Expand 1` |
|       - | 1204 | ` */` |
|       2 | 1205 | `static void PH7_SCANDIR_SORT_DESCENDING_Const(ph7_value *pVal,void *pUserData)` |
|       1 | 1206 |  |
|       1 | 1207 | `	SXUNUSED(pUserData); /* cc warning */` |
|       3 | 1208 | `	ph7_value_int(pVal,1);` |
|       3 | 1209 |  |
|       - | 1210 | `/*` |
...
|       - | 2061 | ` */` |
|    5092 | 2062 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|       1 | 2063 |  |
|       - | 2064 | `	sxu32 n;` |
|       - | 2065 | `	/*` |
...
|       - | 2068 | `	 */` |
| 1023493 | 2069 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 1018401 | 2070 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
|  509201 | 2071 | `	}` |
|    5093 | 2072 |  |
