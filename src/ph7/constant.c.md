...
|      - |   61 | ` */` |
|   3656 |   62 | `static void PH7_OS_Const(ph7_value *pVal,void *pUnused)` |
|      5 |   63 | `{` |
...
|      - | 1089 | ` *  Expand 3.` |
|      - | 1090 | ` */` |
|   6074 | 1091 | `static void PH7_PATHINFO_EXTENSION_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1092 | `{` |
|   3037 | 1093 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6079 | 1094 | `	ph7_value_int(pVal,3);` |
|   6079 | 1095 | `}` |
|      - | 1096 | `/*` |
|      - | 1097 | ` * PATHINFO_FILENAME` |
|      - | 1098 | ` *  Expand 4.` |
|      - | 1099 | ` */` |
|   6066 | 1100 | `static void PH7_PATHINFO_FILENAME_Const(ph7_value *pVal,void *pUserData)` |
|      5 | 1101 | `{` |
|   3033 | 1102 | `	SXUNUSED(pUserData); /* cc warning */` |
|   6071 | 1103 | `	ph7_value_int(pVal,4);` |
|   6071 | 1104 | `}` |
|      - | 1105 | `/*` |
|      - | 1106 | ` * ASSERT_ACTIVE.` |
...
|      - | 2218 | ` */` |
|   3248 | 2219 | `PH7_PRIVATE void PH7_RegisterBuiltInConstant(ph7_vm *pVm)` |
|      5 | 2220 | `{` |
|      - | 2221 | `	sxu32 n;` |
|      - | 2222 | `	/*` |
...
|      - | 2225 | `	 */` |
| 776277 | 2226 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltIn) ; ++n ){` |
| 773029 | 2227 | `		ph7_create_constant(&(*pVm),aBuiltIn[n].zName,aBuiltIn[n].xExpand,&(*pVm));` |
| 386517 | 2228 | `	}` |
|   3253 | 2229 | `}` |
