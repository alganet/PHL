...
|       - |  935 | ` */` |
| 9369172 |  936 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|       2 |  937 |  |
| 9369174 |  938 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 8710076 |  939 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|  373840 |  940 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 8523157 |  941 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    7146 |  942 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    3572 |  943 | `		}` |
|       - |  944 | `		/* Release the internal buffer */` |
| 8710076 |  945 | `		SyBlobRelease(&pObj->sBlob);` |
|       - |  946 | `		/* Invalidate any prior representation */` |
| 8710076 |  947 | `		pObj->iFlags = MEMOBJ_NULL;` |
| 4355296 |  948 | `	}` |
| 9369174 |  949 | `	return SXRET_OK;` |
|       2 |  950 |  |
|       - |  951 | `/*` |
