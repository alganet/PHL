...
|        - |   64 | ` */` |
|      362 |   65 | `PH7_PRIVATE const char *ph7_type_name(ph7_value *pVal)` |
|        5 |   66 | `{` |
|      367 |   67 | `	if( ph7_value_is_null(pVal) ) return "null";` |
|      323 |   68 | `	if( ph7_value_is_bool(pVal) ) return "bool";` |
|      315 |   69 | `	if( ph7_value_is_int(pVal) ) return "int";` |
...
|        - |  128 | ` */` |
|  2739666 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  2739671 |  131 | `	sxi64 iVal = 0;` |
|  2739671 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  2739671 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
...
|  1695829 |  153 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  154 | `	}` |
|  1700035 |  155 | `	return iVal;` |
|  1369838 |  156 | `}` |
|        - |  157 | `/*` |
...
|        - |  462 | ` */` |
|    17682 |  463 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  464 | `{` |
|        - |  465 | `	sxi32 iFlags;` |
|    17687 |  466 | `	iFlags = pObj->iFlags;` |
|    17687 |  467 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  468 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  469 | `		return pObj->rVal ? 1 : 0;` |
|        - |  470 | `#else` |
|       14 |  471 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  472 | `#endif` |
|    17675 |  473 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      801 |  474 | `		return pObj->x.iVal ? 1 : 0;` |
|    16879 |  475 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  484 | `		}` |
|       88 |  485 | `		return 1;` |
|    16771 |  486 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    15539 |  487 | `		return 0;` |
...
|        - |  540 | ` */` |
|   509879 |  541 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  542 | `{` |
|   509884 |  543 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  571 | ` */` |
|    20604 |  572 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  573 | `{` |
|    20609 |  574 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  575 | `		/* Preform the conversion */` |
|    17687 |  576 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  577 | `		/* Invalidate any prior representations */` |
|    17687 |  578 | `		SyBlobRelease(&pObj->sBlob);` |
|    17687 |  579 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     8841 |  580 | `	}` |
|    20609 |  581 | `	return SXRET_OK;` |
|        5 |  582 | `}` |
|        - |  583 | `/*` |
|        - |  584 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  585 | ` */` |
|   963547 |  586 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  587 | `{` |
|   963552 |  588 | `	sxi32 rc = SXRET_OK;` |
|   963552 |  589 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - |  775 | ` */` |
|   235889 |  776 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  777 | `{` |
|        - |  778 | `	const char *z, *zEnd;` |
|        - |  779 | `	sxu32 n;` |
|   235894 |  780 | `	int bDigit = 0;` |
|   235894 |  781 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  782 | `		return 0;` |
|        - |  783 | `	}` |
|   235894 |  784 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   235894 |  785 | `	n = SyBlobLength(&pValue->sBlob);` |
|   235894 |  786 | `	if( n == 0 ){` |
|       74 |  787 | `		return 0;` |
|        - |  788 | `	}` |
|   235822 |  789 | `	zEnd = z + n;` |
|   235848 |  790 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       28 |  791 | `		z++;` |
|        2 |  792 | `	}` |
|   235822 |  793 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|       59 |  794 | `		z++;` |
|       27 |  795 | `	}` |
|   236296 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|      478 |  797 | `		z++; bDigit = 1;` |
|        4 |  798 | `	}` |
|   235822 |  799 | `	if( z < zEnd && z[0] == '.' ){` |
|       71 |  800 | `		z++;` |
...
|        - |  833 | ` */` |
|   235661 |  834 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  835 | `{` |
|   235666 |  836 | `	const char *zTail = 0, *zEnd;` |
|   235666 |  837 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   235502 |  838 | `		return 0;` |
|        - |  839 | `	}` |
...
|        - |  850 | ` */` |
|   236391 |  851 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  852 | `{` |
|   236396 |  853 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      547 |  854 | `		return TRUE;` |
|   235854 |  855 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      306 |  856 | `		return FALSE;` |
|   235550 |  857 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  858 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   235550 |  859 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  860 | `	}` |
|        - |  861 | `	/* NOT REACHED */` |
|      ! 0 |  862 | `	return FALSE;` |
|   118162 |  863 | `}` |
...
|        - |  875 | ` */` |
|    33446 |  876 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  877 | `{` |
|    33451 |  878 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  879 | `		return TRUE;` |
|    33435 |  880 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  881 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    33415 |  882 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  883 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    33415 |  884 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  885 | `		return !pObj->x.iVal;` |
|    33411 |  886 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    26869 |  887 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
...
|      ! 0 |  900 | `		}` |
|     6547 |  901 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     6547 |  902 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     6547 |  903 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  917 | ` */` |
|   582393 |  918 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  919 | `{` |
|   582398 |  920 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   582218 |  921 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1074 | ` */` |
| 23619695 | 1075 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1076 | `{` |
|        - | 1077 | `	/* Zero the structure */` |
| 23619700 | 1078 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1079 | `	/* Initialize fields */` |
| 23619700 | 1080 | `	pObj->pVm = pVm;` |
| 23619700 | 1081 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1082 | `	/* Set the NULL type */` |
| 23619700 | 1083 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 23619700 | 1084 | `	return SXRET_OK;` |
|        5 | 1085 | `}` |
|        - | 1086 | `/*` |
|        - | 1087 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1088 | ` */` |
|  4885546 | 1089 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1090 | `{` |
|        - | 1091 | `	/* Zero the structure */` |
|  4885551 | 1092 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1093 | `	/* Initialize fields */` |
|  4885551 | 1094 | `	pObj->pVm = pVm;` |
|  4885551 | 1095 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1096 | `	/* Set the desired type */` |
|  4885551 | 1097 | `	pObj->x.iVal = iVal;` |
|  4885551 | 1098 | `	pObj->iFlags = MEMOBJ_INT;` |
|  4885551 | 1099 | `	return SXRET_OK;` |
|        5 | 1100 | `}` |
|        - | 1101 | `/*` |
|        - | 1102 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1103 | ` */` |
|    17006 | 1104 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1105 | `{` |
|        - | 1106 | `	/* Zero the structure */` |
|    17011 | 1107 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1108 | `	/* Initialize fields */` |
|    17011 | 1109 | `	pObj->pVm = pVm;` |
|    17011 | 1110 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1111 | `	/* Set the desired type */` |
|    17011 | 1112 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17011 | 1113 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17011 | 1114 | `	return SXRET_OK;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|        - | 1133 | ` */` |
|    73102 | 1134 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1135 | `{` |
|        - | 1136 | `	/* Zero the structure */` |
|    73107 | 1137 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1138 | `	/* Initialize fields */` |
|    73107 | 1139 | `	pObj->pVm = pVm;` |
|    73107 | 1140 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1141 | `	/* Set the desired type */` |
|    73107 | 1142 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    73107 | 1143 | `	pObj->x.pOther = pArray;` |
|    73107 | 1144 | `	return SXRET_OK;` |
|        5 | 1145 | `}` |
|        - | 1146 | `/*` |
|        - | 1147 | ` * Initialize a ph7_value to the string type.` |
|        - | 1148 | ` */` |
|  3820334 | 1149 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1150 | `{` |
|        - | 1151 | `	/* Zero the structure */` |
|  3820339 | 1152 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1153 | `	/* Initialize fields */` |
|  3820339 | 1154 | `	pObj->pVm = pVm;` |
|  3820339 | 1155 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  3820339 | 1156 | `	if( pVal ){` |
|        - | 1157 | `		/* Append contents */` |
|  1768973 | 1158 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   884484 | 1159 | `	}` |
|        - | 1160 | `	/* Set the desired type */` |
|  3820339 | 1161 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  3820339 | 1162 | `	return SXRET_OK;` |
|        5 | 1163 | `}` |
|        - | 1164 | `/*` |
...
|        - | 1169 | ` */` |
|  2417525 | 1170 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1171 | `{` |
|        - | 1172 | `	sxi32 rc;` |
|  2417530 | 1173 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1174 | `		/* Invalidate any prior representation */` |
|     2903 | 1175 | `		PH7_MemObjRelease(pObj);` |
|     2903 | 1176 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|     1449 | 1177 | `	}` |
|        - | 1178 | `	/* Append contents */` |
|  2417530 | 1179 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2417530 | 1180 | `	return rc;` |
|        5 | 1181 | `}` |
|        - | 1182 | `#if 0` |
|        - | 1183 | `/*` |
...
|        - | 1204 | ` */` |
|  5430791 | 1205 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1206 | `{` |
|  5430796 | 1207 | `	ph7_class_instance *pObj = 0;` |
|  5430796 | 1208 | `	ph7_hashmap *pMap = 0;` |
|        - | 1209 | `	sxi32 rc;` |
|  5430796 | 1210 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1211 | `		/* Increment reference count */` |
|   211507 | 1212 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5325045 | 1213 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1214 | `		/* Increment reference count */` |
|     9249 | 1215 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4622 | 1216 | `	}` |
|  5430796 | 1217 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    64091 | 1218 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5398753 | 1219 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8141 | 1220 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4068 | 1221 | `	}` |
|  5430796 | 1222 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5430796 | 1223 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5430796 | 1224 | `	rc = SXRET_OK;` |
|  5430796 | 1225 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4161424 | 1226 | `		SyBlobReset(&pDest->sBlob);` |
|  4161424 | 1227 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2080714 | 1228 | `	}else{` |
|  1269377 | 1229 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   350364 | 1230 | `			SyBlobRelease(&pDest->sBlob);` |
|   175203 | 1231 | `		}` |
|        - | 1232 | `	}` |
|  5430796 | 1233 | `	if( pMap ){` |
|    64091 | 1234 | `		PH7_HashmapUnref(pMap);` |
|  5398753 | 1235 | `	}else if( pObj ){` |
|     8141 | 1236 | `		PH7_ClassInstanceUnref(pObj);` |
|     4068 | 1237 | `	}` |
|  5430791 | 1238 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2821169 | 1239 | `	 && pDest->pVm` |
|   211502 | 1240 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   105760 | 1244 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1257 | `		}` |
|        4 | 1258 | `	}` |
|  5430796 | 1259 | `	return rc;` |
|        5 | 1260 | `}` |
|        - | 1261 | `/*` |
|        - | 1262 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1263 | ` * buffer contents,simply point to it.` |
|        - | 1264 | ` */` |
|  8356932 | 1265 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1266 | `{` |
|  8356937 | 1267 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1268 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8356937 | 1269 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1270 | `		/* Increment reference count */` |
|   502293 | 1271 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8105793 | 1272 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1273 | `		/* Increment reference count */` |
|    45739 | 1274 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    22867 | 1275 | `	}` |
|  8356937 | 1276 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1277 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1278 | `	}` |
|  8356937 | 1279 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4333376 | 1280 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2166654 | 1281 | `	}` |
|  8356937 | 1282 | `	return SXRET_OK;` |
|        5 | 1283 | `}` |
|        - | 1284 | `/*` |
|        - | 1285 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1286 | ` */` |
| 19914231 | 1287 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1288 | `{` |
| 19914236 | 1289 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 16983167 | 1290 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   689107 | 1291 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 16638616 | 1292 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    86179 | 1293 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    43087 | 1294 | `		}` |
|        - | 1295 | `		/* Release the internal buffer */` |
| 16983167 | 1296 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1297 | `		/* Invalidate any prior representation */` |
| 16983167 | 1298 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  8491688 | 1299 | `	}` |
| 19914236 | 1300 | `	return SXRET_OK;` |
|        5 | 1301 | `}` |
|        - | 1302 | `/*` |
...
|        - | 1354 | ` */` |
|  1624990 | 1355 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1356 | `{` |
|        - | 1357 | `	sxi32 iComb;` |
|        - | 1358 | `	sxi32 rc;` |
|  1624995 | 1359 | `	if( bStrict ){` |
|        - | 1360 | `		sxi32 iF1,iF2;` |
|        - | 1361 | `		/* Strict comparisons with === */` |
|   832903 | 1362 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   832903 | 1363 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   832903 | 1364 | `		if( iF1 != iF2 ){` |
|        - | 1365 | `			/* Not of the same type */` |
|   187387 | 1366 | `			return 1;` |
|        - | 1367 | `		}` |
|   322759 | 1368 | `	}` |
|        - | 1369 | `	/* Combine flag together */` |
|  1437613 | 1370 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1437608 | 1371 | `	if( !bStrict` |
|  1114851 | 1372 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   396069 | 1373 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1389 | `	}` |
|  1437613 | 1390 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1391 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    23507 | 1392 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8775 | 1393 | `			PH7_MemObjToBool(pObj1);` |
|     4385 | 1394 | `		}` |
|    23507 | 1395 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7779 | 1396 | `			PH7_MemObjToBool(pObj2);` |
|     3887 | 1397 | `		}` |
|    23507 | 1398 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1414111 | 1399 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1411 | `		return rc;` |
|  1414081 | 1412 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1424 | `		return rc;` |
|  1413809 | 1425 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1426 | `		SyString s1,s2;` |
|   855180 | 1427 | `		if( !bStrict ){` |
|        - | 1428 | `			/*` |
...
|        - | 1439 | `			 */` |
|   235222 | 1440 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1441 | `				/* Perform a numeric comparison */` |
|       29 | 1442 | `				goto Numeric;` |
|        - | 1443 | `			}` |
|   117556 | 1444 | `		}` |
|        - | 1445 | `		/* Perform a strict string comparison.*/` |
|   855152 | 1446 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1447 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1448 | `		}` |
|   855152 | 1449 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1450 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1451 | `		}` |
|   855152 | 1452 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   855152 | 1453 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1454 | `		/*` |
...
|        - | 1457 | `		 */` |
|   855152 | 1458 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   855152 | 1459 | `		if( rc == 0 ){` |
|   284109 | 1460 | `			if( s1.nByte != s2.nByte ){` |
|    15139 | 1461 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     7569 | 1462 | `			}` |
|   142054 | 1463 | `		}` |
|   855152 | 1464 | `		return rc;` |
|   558634 | 1465 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   279291 | 1466 | `Numeric:` |
|        - | 1467 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   558662 | 1468 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1469 | `			PH7_MemObjToNumeric(pObj1);` |
|        5 | 1470 | `		}` |
|   558662 | 1471 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       19 | 1472 | `			PH7_MemObjToNumeric(pObj2);` |
|        9 | 1473 | `		}` |
|   558662 | 1474 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1475 | `			/*` |
...
|   558390 | 1508 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     6751 | 1509 | `				return 1;` |
|   551644 | 1510 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   542988 | 1511 | `				return -1;` |
|        - | 1512 | `			}` |
|     8661 | 1513 | `			return 0;` |
|        - | 1514 | `		}` |
|        - | 1515 | `	}` |
