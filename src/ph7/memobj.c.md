...
|        - |   93 | ` */` |
|    10676 |   94 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|        5 |   95 | `{` |
...
|    10681 |  111 | `  ph7_real r = pObj->rVal;` |
|    10681 |  112 | `  if( r<(ph7_real)minInt ){` |
|        3 |  113 | `    return minInt;` |
|    10679 |  114 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  128 | ` */` |
|  3547464 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3547469 |  131 | `	sxi64 iVal = 0;` |
|  3547469 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3547469 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1380307 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1273033 |  138 | `			return 0;` |
|        - |  139 | `		}` |
|   107279 |  140 | `		c = pVal->zString[1];` |
|   107279 |  141 | `		if( c  == 'x' \|\| c == 'X' ){` |
|        - |  142 | `			/* Hex digit stream */` |
|   103119 |  143 | `			SyHexStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|    55722 |  144 | `		}else if( c == 'b' \|\| c == 'B' ){` |
|        - |  145 | `			/* Binary digit stream */` |
|      279 |  146 | `			SyBinaryStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|      140 |  147 | `		}else{` |
|        - |  148 | `			/* Octal digit stream */` |
|     3887 |  149 | `			SyOctalStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  150 | `		}` |
|    53642 |  151 | `	}else{` |
|        - |  152 | `		/* Decimal digit stream */` |
|  2167167 |  153 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  154 | `	}` |
|  2274441 |  155 | `	return iVal;` |
|  1773737 |  156 | `}` |
|        - |  157 | `/*` |
...
|        - |  160 | ` * representation.` |
|        - |  161 | ` */` |
|     3426 |  162 | `static sxi64 MemObjStringToInt(ph7_value *pObj)` |
|        5 |  163 | `{` |
|     3431 |  164 | `	sxi64 iVal = 0;` |
...
|     3431 |  168 | `	SyStrToInt64((const char *)SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),(void *)&iVal,0);` |
|     3431 |  169 | `	return iVal;` |
|        5 |  170 | `}` |
|        - |  171 | `/*` |
...
|        - |  204 | ` */` |
|     1336 |  205 | `static sxi64 MemObjIntValue(ph7_value *pObj)` |
|        5 |  206 | `{` |
|        - |  207 | `	sxi32 iFlags;` |
|     1341 |  208 | `	iFlags = pObj->iFlags;` |
|     1341 |  209 | `	if (iFlags & MEMOBJ_REAL ){` |
|       41 |  210 | `		return MemObjRealToInt(&(*pObj));` |
|     1301 |  211 | `	}else if( iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      170 |  212 | `		return pObj->x.iVal;` |
|     1133 |  213 | `	}else if (iFlags & MEMOBJ_STRING) {` |
|     1115 |  214 | `		return MemObjStringToInt(&(*pObj));` |
...
|        - |  253 | ` */` |
|     9464 |  254 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|        5 |  255 | `{` |
|        - |  256 | `	sxi32 iFlags;` |
|     9469 |  257 | `	iFlags = pObj->iFlags;` |
|     9469 |  258 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  259 | `		return pObj->rVal;` |
|     9469 |  260 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      771 |  261 | `		return (ph7_real)pObj->x.iVal;` |
|     8701 |  262 | `	}else if (iFlags & MEMOBJ_STRING){` |
|        - |  263 | `		SyString sString;` |
|        - |  264 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  265 | `		ph7_real rVal = 0;` |
|        - |  266 | `#else` |
|     8695 |  267 | `		ph7_real rVal = 0.0;` |
|        - |  268 | `#endif` |
|     8695 |  269 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|     8695 |  270 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|        - |  271 | `			/* Convert as much as we can */` |
|        - |  272 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  273 | `			rVal = MemObjStringToInt(&(*pObj));` |
|        - |  274 | `#else` |
|     8695 |  275 | `			SyStrToReal(sString.zString,sString.nByte,(void *)&rVal,0);` |
|        - |  276 | `#endif` |
|     4345 |  277 | `		}` |
|     8695 |  278 | `		return rVal;` |
...
|        - |  327 | `	sxi32 iExp,i;` |
|      518 |  328 | `	iExp = nLen - 1;` |
|     4416 |  329 | `	while( iExp > 0 && zBuf[iExp] != 'e' && zBuf[iExp] != 'E' ){` |
|     3902 |  330 | `		iExp--;` |
|        4 |  331 | `	}` |
|      518 |  332 | `	if( iExp <= 0 ){` |
|      472 |  333 | `		return nLen; /* No exponent part (fixed notation) */` |
|        - |  334 | `	}` |
|        - |  335 | `	{` |
...
|        - |  374 | ` */` |
|    61400 |  375 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  376 | `{` |
|    61405 |  377 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|        - |  378 | `		/* Handle special floating-point values first */` |
|      373 |  379 | `		if( PH7_IS_NAN(pObj->rVal) ){` |
|      ! 0 |  380 | `			SyBlobAppend(&(*pOut),"NAN",3);` |
|      373 |  381 | `		}else if( PH7_IS_INF(pObj->rVal) ){` |
...
|      369 |  396 | `			sxi32 n = (sxi32)snprintf(zNum,sizeof(zNum),"%.14G",pObj->rVal);` |
|      369 |  397 | `			if( n < 0 \|\| n >= (sxi32)sizeof(zNum) ){` |
|      ! 0 |  398 | `				n = (sxi32)SyStrlen(zNum);` |
|      ! 0 |  399 | `			}` |
|      369 |  400 | `			n = PH7_PhpFloatShape(zNum,n,TRUE);` |
|      369 |  401 | `			SyBlobAppend(&(*pOut),zNum,(sxu32)n);` |
|        - |  402 | `#else` |
|        - |  403 | `			SyBlobFormat(&(*pOut),"%.15g",pObj->rVal);` |
|        - |  404 | `#endif` |
|        3 |  405 | `		}` |
|    61220 |  406 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    60729 |  407 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  408 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30673 |  409 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  462 | ` */` |
|    18284 |  463 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  464 | `{` |
|        - |  465 | `	sxi32 iFlags;` |
|    18289 |  466 | `	iFlags = pObj->iFlags;` |
|    18289 |  467 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  468 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  469 | `		return pObj->rVal ? 1 : 0;` |
|        - |  470 | `#else` |
|       14 |  471 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  472 | `#endif` |
|    18277 |  473 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      875 |  474 | `		return pObj->x.iVal ? 1 : 0;` |
|    17407 |  475 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  484 | `		}` |
|       88 |  485 | `		return 1;` |
|    17299 |  486 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16011 |  487 | `		return 0;` |
|     1293 |  488 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|     1273 |  493 | `	}else if( iFlags & MEMOBJ_OBJ ){` |
...
|      176 |  507 | `		return iVal;` |
|     1099 |  508 | `	}else if(iFlags & MEMOBJ_RES ){` |
|     1099 |  509 | `		return pObj->x.pOther != 0;` |
|        - |  510 | `	}` |
|        - |  511 | `	/* NOT REACHED */` |
|      ! 0 |  512 | `	return 0;` |
|     9147 |  513 | `}` |
...
|        - |  516 | ` */` |
|    10636 |  517 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|        5 |  518 | `{` |
|    10641 |  519 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|        - |  531 | `  */` |
|    10636 |  532 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|     9193 |  533 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     9177 |  534 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|     4588 |  535 | `	}` |
|    10641 |  536 | `	return SXRET_OK;` |
|        5 |  537 | `}` |
|        - |  538 | `/*` |
|        - |  539 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  540 | ` */` |
|   520212 |  541 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  542 | `{` |
|   520217 |  543 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  544 | `		/* Preform the conversion */` |
|     1341 |  545 | `		pObj->x.iVal = MemObjIntValue(&(*pObj));` |
|        - |  546 | `		/* Invalidate any prior representations */` |
|     1341 |  547 | `		SyBlobRelease(&pObj->sBlob);` |
|     1341 |  548 | `		MemObjSetType(pObj,MEMOBJ_INT);` |
|      668 |  549 | `	}` |
|   520217 |  550 | `	return SXRET_OK;` |
|        5 |  551 | `}` |
|        - |  552 | `/*` |
|        - |  553 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  554 | ` * Invalidate any prior representations` |
|        - |  555 | ` */` |
|    10458 |  556 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        5 |  557 | `{` |
|    10463 |  558 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  559 | `		/* Preform the conversion */` |
|     9469 |  560 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  561 | `		/* Invalidate any prior representations */` |
|     9469 |  562 | `		SyBlobRelease(&pObj->sBlob);` |
|     9469 |  563 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  564 | `		/* Try to get an integer representation */` |
|     9469 |  565 | `		MemObjTryIntger(&(*pObj));` |
|     4732 |  566 | `	}` |
|    10463 |  567 | `	return SXRET_OK;` |
|        5 |  568 | `}` |
|        - |  569 | `/*` |
|        - |  570 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  571 | ` */` |
|    21792 |  572 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  573 | `{` |
|    21797 |  574 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  575 | `		/* Preform the conversion */` |
|    18289 |  576 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  577 | `		/* Invalidate any prior representations */` |
|    18289 |  578 | `		SyBlobRelease(&pObj->sBlob);` |
|    18289 |  579 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9142 |  580 | `	}` |
|    21797 |  581 | `	return SXRET_OK;` |
|        5 |  582 | `}` |
|        - |  583 | `/*` |
|        - |  584 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  585 | ` */` |
|   983245 |  586 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  587 | `{` |
|   983250 |  588 | `	sxi32 rc = SXRET_OK;` |
|   983250 |  589 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  590 | `		/* Perform the conversion */` |
|    61311 |  591 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61311 |  592 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61311 |  593 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30653 |  594 | `	}` |
|   983250 |  595 | `	return rc;` |
|        5 |  596 | `}` |
|        - |  597 | `/*` |
...
|        5 |  613 | `{` |
|      555 |  614 | `	if( (pObj->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  615 | `		ph7_hashmap *pMap;` |
|        - |  616 | `		/* Allocate a new hashmap instance */` |
|      359 |  617 | `		pMap = PH7_NewHashmap(pObj->pVm,0,0);` |
|      359 |  618 | `		if( pMap == 0 ){` |
|      ! 0 |  619 | `			return SXERR_MEM;` |
|        - |  620 | `		}` |
|      359 |  621 | `		if( (pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_RES)) == 0 ){` |
|        - |  622 | `			/*` |
...
|      359 |  638 | `		PH7_MemObjRelease(pObj);` |
|      359 |  639 | `		MemObjSetType(pObj,MEMOBJ_HASHMAP);` |
|      359 |  640 | `		pObj->x.pOther = pMap;` |
|      177 |  641 | `	}` |
|      555 |  642 | `	return SXRET_OK;` |
|      280 |  643 | `}` |
...
|        - |  775 | ` */` |
|   246966 |  776 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  777 | `{` |
|        - |  778 | `	const char *z, *zEnd;` |
|        - |  779 | `	sxu32 n;` |
|   246971 |  780 | `	int bDigit = 0;` |
|   246971 |  781 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  782 | `		return 0;` |
|        - |  783 | `	}` |
|   246971 |  784 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   246971 |  785 | `	n = SyBlobLength(&pValue->sBlob);` |
|   246971 |  786 | `	if( n == 0 ){` |
|      603 |  787 | `		return 0;` |
|        - |  788 | `	}` |
|   246371 |  789 | `	zEnd = z + n;` |
|   246397 |  790 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       28 |  791 | `		z++;` |
|        2 |  792 | `	}` |
|   246371 |  793 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      203 |  794 | `		z++;` |
|       99 |  795 | `	}` |
|   251181 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4814 |  797 | `		z++; bDigit = 1;` |
|        4 |  798 | `	}` |
|   246371 |  799 | `	if( z < zEnd && z[0] == '.' ){` |
|     1733 |  800 | `		z++;` |
|     1803 |  801 | `		while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|       73 |  802 | `			z++; bDigit = 1;` |
|        3 |  803 | `		}` |
|      864 |  804 | `	}` |
|        - |  805 | `	/* At least one mantissa digit required (rejects "", ".", "+", "e5"). */` |
|   246371 |  806 | `	if( !bDigit ){` |
|   241663 |  807 | `		return 0;` |
|        - |  808 | `	}` |
...
|     4712 |  811 | `	if( z < zEnd && (z[0] == 'e' \|\| z[0] == 'E') ){` |
...
|        - |  833 | ` */` |
|   244580 |  834 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  835 | `{` |
|   244585 |  836 | `	const char *zTail = 0, *zEnd;` |
|   244585 |  837 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   242253 |  838 | `		return 0;` |
|        - |  839 | `	}` |
|     2336 |  840 | `	zEnd = (const char *)SyBlobData(&pValue->sBlob) + SyBlobLength(&pValue->sBlob);` |
|     2342 |  841 | `	while( zTail < zEnd && (unsigned char)zTail[0] < 0xc0 && SyisSpace(zTail[0]) ){` |
|        8 |  842 | `		zTail++;` |
|        2 |  843 | `	}` |
|     2336 |  844 | `	return zTail == zEnd ? 1 : 0;` |
|   122288 |  845 | `}` |
|        - |  846 | `/*` |
...
|        - |  850 | ` */` |
|   245428 |  851 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  852 | `{` |
|   245433 |  853 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      597 |  854 | `		return TRUE;` |
|   244841 |  855 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      374 |  856 | `		return FALSE;` |
|   244469 |  857 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  858 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   244469 |  859 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  860 | `	}` |
|        - |  861 | `	/* NOT REACHED */` |
|      ! 0 |  862 | `	return FALSE;` |
|   122712 |  863 | `}` |
...
|        - |  875 | ` */` |
|    33804 |  876 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  877 | `{` |
|    33809 |  878 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       21 |  879 | `		return TRUE;` |
|    33791 |  880 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  881 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    33771 |  882 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  883 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    33771 |  884 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  885 | `		return !pObj->x.iVal;` |
|    33767 |  886 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27153 |  887 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21631 |  888 | `			return TRUE;` |
|      ! 0 |  889 | `		}else{` |
|        - |  890 | `			const char *zIn,*zEnd;` |
|     5527 |  891 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5527 |  892 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5533 |  893 | `			while( zIn < zEnd ){` |
|     5533 |  894 | `				if( zIn[0] != '0' ){` |
|     5527 |  895 | `					break;` |
|        - |  896 | `				}` |
|        7 |  897 | `				zIn++;` |
|        1 |  898 | `			}` |
|     5527 |  899 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  900 | `		}` |
|     6619 |  901 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     6619 |  902 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     6619 |  903 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  917 | ` */` |
|   594535 |  918 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  919 | `{` |
|   594540 |  920 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   592202 |  921 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        2 |  926 | `		}` |
|        - |  927 | `		/* Already numeric */` |
|   592202 |  928 | `		return  SXRET_OK;` |
|        - |  929 | `	}` |
|     2341 |  930 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
|     2341 |  931 | `		const char *zTail = 0;` |
|     2341 |  932 | `		int bNum, bReal = 0;` |
...
|     2341 |  937 | `		bNum = PH7_MemObjStringNumericPrefix(pObj,&zTail);` |
|     2341 |  938 | `		if( bNum ){` |
|     2341 |  939 | `			const char *z = (const char *)SyBlobData(&pObj->sBlob);` |
|     4757 |  940 | `			while( z < zTail ){` |
|     2441 |  941 | `				if( z[0] == '.' \|\| z[0] == 'e' \|\| z[0] == 'E' ){` |
|       23 |  942 | `					bReal = 1;` |
|       23 |  943 | `					break;` |
|        - |  944 | `				}` |
|     2419 |  945 | `				z++;` |
...
|     2319 |  956 | `				pObj->x.iVal = MemObjStringToInt(&(*pObj));` |
|        - |  957 | `			}` |
|     2319 |  958 | `			MemObjSetType(pObj,MEMOBJ_INT);` |
|     2319 |  959 | `			SyBlobRelease(&pObj->sBlob);` |
|        3 |  960 | `		}` |
|     1169 |  961 | `	}else if(pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_HASHMAP\|MEMOBJ_RES)){` |
|      ! 0 |  962 | `		PH7_MemObjToInteger(pObj);` |
|      ! 0 |  963 | `	}else{` |
|        - |  964 | `		/* Perform a blind cast */` |
|      ! 0 |  965 | `		PH7_MemObjToReal(&(*pObj));` |
|        - |  966 | `	}` |
|     2341 |  967 | `	return SXRET_OK;` |
|   297296 |  968 | `}` |
|        - |  969 | `/*` |
...
|        - | 1074 | ` */` |
| 24269831 | 1075 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1076 | `{` |
|        - | 1077 | `	/* Zero the structure */` |
| 24269836 | 1078 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1079 | `	/* Initialize fields */` |
| 24269836 | 1080 | `	pObj->pVm = pVm;` |
| 24269836 | 1081 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1082 | `	/* Set the NULL type */` |
| 24269836 | 1083 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 24269836 | 1084 | `	return SXRET_OK;` |
|        5 | 1085 | `}` |
|        - | 1086 | `/*` |
|        - | 1087 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1088 | ` */` |
|  5696892 | 1089 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1090 | `{` |
|        - | 1091 | `	/* Zero the structure */` |
|  5696897 | 1092 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1093 | `	/* Initialize fields */` |
|  5696897 | 1094 | `	pObj->pVm = pVm;` |
|  5696897 | 1095 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1096 | `	/* Set the desired type */` |
|  5696897 | 1097 | `	pObj->x.iVal = iVal;` |
|  5696897 | 1098 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5696897 | 1099 | `	return SXRET_OK;` |
|        5 | 1100 | `}` |
|        - | 1101 | `/*` |
|        - | 1102 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1103 | ` */` |
|    17172 | 1104 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1105 | `{` |
|        - | 1106 | `	/* Zero the structure */` |
|    17177 | 1107 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1108 | `	/* Initialize fields */` |
|    17177 | 1109 | `	pObj->pVm = pVm;` |
|    17177 | 1110 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1111 | `	/* Set the desired type */` |
|    17177 | 1112 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17177 | 1113 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17177 | 1114 | `	return SXRET_OK;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|        - | 1133 | ` */` |
|    77626 | 1134 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1135 | `{` |
|        - | 1136 | `	/* Zero the structure */` |
|    77631 | 1137 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1138 | `	/* Initialize fields */` |
|    77631 | 1139 | `	pObj->pVm = pVm;` |
|    77631 | 1140 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1141 | `	/* Set the desired type */` |
|    77631 | 1142 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    77631 | 1143 | `	pObj->x.pOther = pArray;` |
|    77631 | 1144 | `	return SXRET_OK;` |
|        5 | 1145 | `}` |
|        - | 1146 | `/*` |
|        - | 1147 | ` * Initialize a ph7_value to the string type.` |
|        - | 1148 | ` */` |
|  4203622 | 1149 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1150 | `{` |
|        - | 1151 | `	/* Zero the structure */` |
|  4203627 | 1152 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1153 | `	/* Initialize fields */` |
|  4203627 | 1154 | `	pObj->pVm = pVm;` |
|  4203627 | 1155 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4203627 | 1156 | `	if( pVal ){` |
|        - | 1157 | `		/* Append contents */` |
|  1925557 | 1158 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   962776 | 1159 | `	}` |
|        - | 1160 | `	/* Set the desired type */` |
|  4203627 | 1161 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4203627 | 1162 | `	return SXRET_OK;` |
|        5 | 1163 | `}` |
|        - | 1164 | `/*` |
...
|        - | 1169 | ` */` |
|  2672560 | 1170 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1171 | `{` |
|        - | 1172 | `	sxi32 rc;` |
|  2672565 | 1173 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1174 | `		/* Invalidate any prior representation */` |
|     3469 | 1175 | `		PH7_MemObjRelease(pObj);` |
|     3469 | 1176 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|     1732 | 1177 | `	}` |
|        - | 1178 | `	/* Append contents */` |
|  2672565 | 1179 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2672565 | 1180 | `	return rc;` |
|        5 | 1181 | `}` |
|        - | 1182 | `#if 0` |
|        - | 1183 | `/*` |
...
|        - | 1204 | ` */` |
|  5591785 | 1205 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1206 | `{` |
|  5591790 | 1207 | `	ph7_class_instance *pObj = 0;` |
|  5591790 | 1208 | `	ph7_hashmap *pMap = 0;` |
|        - | 1209 | `	sxi32 rc;` |
|  5591790 | 1210 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1211 | `		/* Increment reference count */` |
|   219771 | 1212 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5481907 | 1213 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1214 | `		/* Increment reference count */` |
|     9603 | 1215 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4799 | 1216 | `	}` |
|  5591790 | 1217 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    65871 | 1218 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5558857 | 1219 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8233 | 1220 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4114 | 1221 | `	}` |
|  5591790 | 1222 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5591790 | 1223 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5591790 | 1224 | `	rc = SXRET_OK;` |
|  5591790 | 1225 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4251971 | 1226 | `		SyBlobReset(&pDest->sBlob);` |
|  4251971 | 1227 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2125988 | 1228 | `	}else{` |
|  1339824 | 1229 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   355602 | 1230 | `			SyBlobRelease(&pDest->sBlob);` |
|   177822 | 1231 | `		}` |
|        - | 1232 | `	}` |
|  5591790 | 1233 | `	if( pMap ){` |
|    65871 | 1234 | `		PH7_HashmapUnref(pMap);` |
|  5558857 | 1235 | `	}else if( pObj ){` |
|     8233 | 1236 | `		PH7_ClassInstanceUnref(pObj);` |
|     4114 | 1237 | `	}` |
|  5591785 | 1238 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2905799 | 1239 | `	 && pDest->pVm` |
|   219766 | 1240 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109892 | 1244 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1257 | `		}` |
|        4 | 1258 | `	}` |
|  5591790 | 1259 | `	return rc;` |
|        5 | 1260 | `}` |
|        - | 1261 | `/*` |
|        - | 1262 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1263 | ` * buffer contents,simply point to it.` |
|        - | 1264 | ` */` |
|  8519188 | 1265 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1266 | `{` |
|  8519193 | 1267 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1268 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8519193 | 1269 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1270 | `		/* Increment reference count */` |
|   515121 | 1271 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8261635 | 1272 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1273 | `		/* Increment reference count */` |
|    47273 | 1274 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    23634 | 1275 | `	}` |
|  8519193 | 1276 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1277 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1278 | `	}` |
|  8519193 | 1279 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4413705 | 1280 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2206883 | 1281 | `	}` |
|  8519193 | 1282 | `	return SXRET_OK;` |
|        5 | 1283 | `}` |
|        - | 1284 | `/*` |
|        - | 1285 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1286 | ` */` |
| 20018395 | 1287 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1288 | `{` |
| 20018400 | 1289 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 17312925 | 1290 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   708625 | 1291 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 16958615 | 1292 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    88815 | 1293 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    44405 | 1294 | `		}` |
|        - | 1295 | `		/* Release the internal buffer */` |
| 17312925 | 1296 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1297 | `		/* Invalidate any prior representation */` |
| 17312925 | 1298 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  8656632 | 1299 | `	}` |
| 20018400 | 1300 | `	return SXRET_OK;` |
|        5 | 1301 | `}` |
|        - | 1302 | `/*` |
...
|        - | 1354 | ` */` |
|  1652903 | 1355 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1356 | `{` |
|        - | 1357 | `	sxi32 iComb;` |
|        - | 1358 | `	sxi32 rc;` |
|  1652908 | 1359 | `	if( bStrict ){` |
|        - | 1360 | `		sxi32 iF1,iF2;` |
|        - | 1361 | `		/* Strict comparisons with === */` |
|   844850 | 1362 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   844850 | 1363 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   844850 | 1364 | `		if( iF1 != iF2 ){` |
|        - | 1365 | `			/* Not of the same type */` |
|   191859 | 1366 | `			return 1;` |
|        - | 1367 | `		}` |
|   326496 | 1368 | `	}` |
|        - | 1369 | `	/* Combine flag together */` |
|  1461054 | 1370 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1461049 | 1371 | `	if( !bStrict` |
|  1134554 | 1372 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   404083 | 1373 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1389 | `	}` |
|  1461054 | 1390 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1391 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24229 | 1392 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9065 | 1393 | `			PH7_MemObjToBool(pObj1);` |
|     4530 | 1394 | `		}` |
|    24229 | 1395 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8017 | 1396 | `			PH7_MemObjToBool(pObj2);` |
|     4006 | 1397 | `		}` |
|    24229 | 1398 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1436830 | 1399 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1411 | `		return rc;` |
|  1436800 | 1412 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1424 | `		return rc;` |
|  1436528 | 1425 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1426 | `		SyString s1,s2;` |
|   868953 | 1427 | `		if( !bStrict ){` |
|        - | 1428 | `			/*` |
...
|        - | 1439 | `			 */` |
|   242981 | 1440 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1441 | `				/* Perform a numeric comparison */` |
|     1099 | 1442 | `				goto Numeric;` |
|        - | 1443 | `			}` |
|   120932 | 1444 | `		}` |
|        - | 1445 | `		/* Perform a strict string comparison.*/` |
|   867855 | 1446 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1447 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1448 | `		}` |
|   867855 | 1449 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1450 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1451 | `		}` |
|   867855 | 1452 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   867855 | 1453 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1454 | `		/*` |
...
|        - | 1457 | `		 */` |
|   867855 | 1458 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   867855 | 1459 | `		if( rc == 0 ){` |
|   287888 | 1460 | `			if( s1.nByte != s2.nByte ){` |
|    17246 | 1461 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     8622 | 1462 | `			}` |
|   143943 | 1463 | `		}` |
|   867855 | 1464 | `		return rc;` |
|   567580 | 1465 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   283765 | 1466 | `Numeric:` |
|        - | 1467 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   568678 | 1468 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1469 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1470 | `		}` |
|   568678 | 1471 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1472 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1473 | `		}` |
|   568678 | 1474 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1475 | `			/*` |
...
|   568366 | 1508 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7515 | 1509 | `				return 1;` |
|   560856 | 1510 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   549696 | 1511 | `				return -1;` |
|        - | 1512 | `			}` |
|    11165 | 1513 | `			return 0;` |
|        - | 1514 | `		}` |
|        - | 1515 | `	}` |
...
|        - | 1530 | ` */` |
|    12918 | 1531 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1532 | `{` |
|    12923 | 1533 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1534 | `			/* Arithemtic operation */` |
|     9155 | 1535 | `			PH7_MemObjToNumeric(pObj1);` |
|     9155 | 1536 | `			PH7_MemObjToNumeric(pObj2);` |
|     9155 | 1537 | `			if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_REAL ){` |
...
|        - | 1556 | `				sxi64 a,b,r;` |
|     9087 | 1557 | `				a = pObj1->x.iVal;` |
|     9087 | 1558 | `				b = pObj2->x.iVal;` |
|     9087 | 1559 | `				if( PH7_ADD_OVERFLOW64(a,b,&r) ){` |
...
|        - | 1566 | `#endif` |
|        5 | 1567 | `				}else{` |
|     9079 | 1568 | `					pObj1->x.iVal = r;` |
|     9079 | 1569 | `					MemObjSetType(pObj1,MEMOBJ_INT);` |
|        - | 1570 | `				}` |
|        - | 1571 | `			}` |
|     4580 | 1572 | `	}else{` |
|     3773 | 1573 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
|        - | 1574 | `			ph7_hashmap *pMap;` |
|        - | 1575 | `			sxi32 rc;` |
|     3773 | 1576 | `			if( bAddStore ){` |
...
|     3771 | 1591 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|     3771 | 1592 | `				if( pMap == 0){` |
|      ! 0 | 1593 | `					PH7_VmThrowError(pObj1->pVm,0,PH7_CTX_ERR,"PH7 is running out of memory while creating array");` |
|      ! 0 | 1594 | `					return SXERR_MEM;` |
|        - | 1595 | `				}` |
|        - | 1596 | `			}` |
|     3773 | 1597 | `			if( !bAddStore ){` |
|     3771 | 1598 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1599 | `					/* Perform a hashmap duplication */` |
|     3771 | 1600 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|     1888 | 1601 | `				}else{` |
...
|     3773 | 1609 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|     3773 | 1610 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|     1889 | 1611 | `			}else{` |
...
|     3773 | 1618 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|      ! 0 | 1619 | `				SyBlobRelease(&pObj1->sBlob);` |
|      ! 0 | 1620 | `			}` |
|     3773 | 1621 | `			pObj1->x.pOther = pMap;` |
|     3773 | 1622 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|     1884 | 1623 | `		}` |
|        - | 1624 | `	}` |
|    12923 | 1625 | `	return SXRET_OK;` |
|     6464 | 1626 | `}` |
|        - | 1627 | `/*` |
