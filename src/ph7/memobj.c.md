...
|        - |  128 | ` */` |
|  2780430 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  2780435 |  131 | `	sxi64 iVal = 0;` |
|  2780435 |  132 | `	if( pVal->nByte <= 0 ){` |
|      137 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  2780299 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1052187 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1051731 |  138 | `			return 0;` |
|        - |  139 | `		}` |
...
|  1728117 |  153 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  154 | `	}` |
|  1728573 |  155 | `	return iVal;` |
|  1390220 |  156 | `}` |
|        - |  157 | `/*` |
...
|        - |  371 | ` */` |
|    58710 |  372 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  373 | `{` |
|    58715 |  374 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  401 | `#endif` |
|        3 |  402 | `		}` |
|    58525 |  403 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    57781 |  404 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  405 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    29447 |  406 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  459 | ` */` |
|    17672 |  460 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  461 | `{` |
|        - |  462 | `	sxi32 iFlags;` |
|    17677 |  463 | `	iFlags = pObj->iFlags;` |
|    17677 |  464 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  465 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  466 | `		return pObj->rVal ? 1 : 0;` |
|        - |  467 | `#else` |
|       14 |  468 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  469 | `#endif` |
|    17665 |  470 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      803 |  471 | `		return pObj->x.iVal ? 1 : 0;` |
|    16867 |  472 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  481 | `		}` |
|       88 |  482 | `		return 1;` |
|    16759 |  483 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    15531 |  484 | `		return 0;` |
...
|        - |  537 | ` */` |
|   454470 |  538 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  539 | `{` |
|   454475 |  540 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  568 | ` */` |
|    20500 |  569 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  570 | `{` |
|    20505 |  571 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  572 | `		/* Preform the conversion */` |
|    17677 |  573 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  574 | `		/* Invalidate any prior representations */` |
|    17677 |  575 | `		SyBlobRelease(&pObj->sBlob);` |
|    17677 |  576 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     8836 |  577 | `	}` |
|    20505 |  578 | `	return SXRET_OK;` |
|        5 |  579 | `}` |
|        - |  580 | `/*` |
|        - |  581 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  582 | ` */` |
|   872895 |  583 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  584 | `{` |
|   872900 |  585 | `	sxi32 rc = SXRET_OK;` |
|   872900 |  586 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  587 | `		/* Perform the conversion */` |
|    58621 |  588 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    58621 |  589 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    58621 |  590 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    29308 |  591 | `	}` |
|   872900 |  592 | `	return rc;` |
|        5 |  593 | `}` |
|        - |  594 | `/*` |
...
|        - |  764 | ` */` |
|   237135 |  765 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  766 | `{` |
|        - |  767 | `	const char *z, *zEnd;` |
|        - |  768 | `	sxu32 n;` |
|   237140 |  769 | `	int bDigit = 0;` |
|   237140 |  770 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  771 | `		return 0;` |
|        - |  772 | `	}` |
|   237140 |  773 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   237140 |  774 | `	n = SyBlobLength(&pValue->sBlob);` |
|   237140 |  775 | `	if( n == 0 ){` |
|       68 |  776 | `		return 0;` |
|        - |  777 | `	}` |
|   237074 |  778 | `	zEnd = z + n;` |
|   237080 |  779 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|        8 |  780 | `		z++;` |
|        2 |  781 | `	}` |
|   237074 |  782 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|       53 |  783 | `		z++;` |
|       24 |  784 | `	}` |
|   237254 |  785 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|      183 |  786 | `		z++; bDigit = 1;` |
|        3 |  787 | `	}` |
|   237074 |  788 | `	if( z < zEnd && z[0] == '.' ){` |
|       43 |  789 | `		z++;` |
...
|        - |  821 | ` */` |
|   237895 |  822 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  823 | `{` |
|   237900 |  824 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      541 |  825 | `		return TRUE;` |
|   237364 |  826 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      321 |  827 | `		return FALSE;` |
|   237048 |  828 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  829 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   237048 |  830 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  831 | `	}` |
|        - |  832 | `	/* NOT REACHED */` |
|      ! 0 |  833 | `	return FALSE;` |
|   118961 |  834 | `}` |
...
|        - |  846 | ` */` |
|    34438 |  847 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  848 | `{` |
|    34443 |  849 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  850 | `		return TRUE;` |
|    34427 |  851 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  852 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    34407 |  853 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  854 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    34407 |  855 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  856 | `		return !pObj->x.iVal;` |
|    34403 |  857 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27871 |  858 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22439 |  859 | `			return TRUE;` |
|      ! 0 |  860 | `		}else{` |
|        - |  861 | `			const char *zIn,*zEnd;` |
|     5437 |  862 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5437 |  863 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5443 |  864 | `			while( zIn < zEnd ){` |
|     5443 |  865 | `				if( zIn[0] != '0' ){` |
|     5437 |  866 | `					break;` |
|        - |  867 | `				}` |
|        7 |  868 | `				zIn++;` |
|        1 |  869 | `			}` |
|     5437 |  870 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  871 | `		}` |
...
|        - |  888 | ` */` |
|   473599 |  889 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  890 | `{` |
|   473604 |  891 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   473448 |  892 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1050 | ` */` |
| 12393977 | 1051 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1052 | `{` |
|        - | 1053 | `	/* Zero the structure */` |
| 12393982 | 1054 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1055 | `	/* Initialize fields */` |
| 12393982 | 1056 | `	pObj->pVm = pVm;` |
| 12393982 | 1057 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1058 | `	/* Set the NULL type */` |
| 12393982 | 1059 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 12393982 | 1060 | `	return SXRET_OK;` |
|        5 | 1061 | `}` |
|        - | 1062 | `/*` |
|        - | 1063 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1064 | ` */` |
|  4930276 | 1065 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1066 | `{` |
|        - | 1067 | `	/* Zero the structure */` |
|  4930281 | 1068 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1069 | `	/* Initialize fields */` |
|  4930281 | 1070 | `	pObj->pVm = pVm;` |
|  4930281 | 1071 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1072 | `	/* Set the desired type */` |
|  4930281 | 1073 | `	pObj->x.iVal = iVal;` |
|  4930281 | 1074 | `	pObj->iFlags = MEMOBJ_INT;` |
|  4930281 | 1075 | `	return SXRET_OK;` |
|        5 | 1076 | `}` |
|        - | 1077 | `/*` |
|        - | 1078 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1079 | ` */` |
|    17616 | 1080 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1081 | `{` |
|        - | 1082 | `	/* Zero the structure */` |
|    17621 | 1083 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1084 | `	/* Initialize fields */` |
|    17621 | 1085 | `	pObj->pVm = pVm;` |
|    17621 | 1086 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1087 | `	/* Set the desired type */` |
|    17621 | 1088 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17621 | 1089 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17621 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
...
|        - | 1109 | ` */` |
|    75532 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    75537 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    75537 | 1115 | `	pObj->pVm = pVm;` |
|    75537 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    75537 | 1118 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    75537 | 1119 | `	pObj->x.pOther = pArray;` |
|    75537 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
|        - | 1123 | ` * Initialize a ph7_value to the string type.` |
|        - | 1124 | ` */` |
|  3873438 | 1125 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1126 | `{` |
|        - | 1127 | `	/* Zero the structure */` |
|  3873443 | 1128 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1129 | `	/* Initialize fields */` |
|  3873443 | 1130 | `	pObj->pVm = pVm;` |
|  3873443 | 1131 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  3873443 | 1132 | `	if( pVal ){` |
|        - | 1133 | `		/* Append contents */` |
|  1808739 | 1134 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   904367 | 1135 | `	}` |
|        - | 1136 | `	/* Set the desired type */` |
|  3873443 | 1137 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  3873443 | 1138 | `	return SXRET_OK;` |
|        5 | 1139 | `}` |
|        - | 1140 | `/*` |
...
|        - | 1145 | ` */` |
|  2428444 | 1146 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1147 | `{` |
|        - | 1148 | `	sxi32 rc;` |
|  2428449 | 1149 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2428449 | 1155 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2428449 | 1156 | `	return rc;` |
|        5 | 1157 | `}` |
|        - | 1158 | `#if 0` |
|        - | 1159 | `/*` |
...
|        - | 1180 | ` */` |
|  5165747 | 1181 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1182 | `{` |
|  5165752 | 1183 | `	ph7_class_instance *pObj = 0;` |
|  5165752 | 1184 | `	ph7_hashmap *pMap = 0;` |
|        - | 1185 | `	sxi32 rc;` |
|  5165752 | 1186 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1187 | `		/* Increment reference count */` |
|   219197 | 1188 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5056156 | 1189 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1190 | `		/* Increment reference count */` |
|     9027 | 1191 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4511 | 1192 | `	}` |
|  5165752 | 1193 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    66421 | 1194 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5132544 | 1195 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8989 | 1196 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4492 | 1197 | `	}` |
|  5165752 | 1198 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5165752 | 1199 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5165752 | 1200 | `	rc = SXRET_OK;` |
|  5165752 | 1201 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4085957 | 1202 | `		SyBlobReset(&pDest->sBlob);` |
|  4085957 | 1203 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2042981 | 1204 | `	}else{` |
|  1079800 | 1205 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   294884 | 1206 | `			SyBlobRelease(&pDest->sBlob);` |
|   147482 | 1207 | `		}` |
|        - | 1208 | `	}` |
|  5165752 | 1209 | `	if( pMap ){` |
|    66421 | 1210 | `		PH7_HashmapUnref(pMap);` |
|  5132544 | 1211 | `	}else if( pObj ){` |
|     8989 | 1212 | `		PH7_ClassInstanceUnref(pObj);` |
|     4492 | 1213 | `	}` |
|  5165747 | 1214 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2692512 | 1215 | `	 && pDest->pVm` |
|   219192 | 1216 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109605 | 1220 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1233 | `		}` |
|        4 | 1234 | `	}` |
|  5165752 | 1235 | `	return rc;` |
|        5 | 1236 | `}` |
|        - | 1237 | `/*` |
|        - | 1238 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1239 | ` * buffer contents,simply point to it.` |
|        - | 1240 | ` */` |
|  7238880 | 1241 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1242 | `{` |
|  7238885 | 1243 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1244 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  7238885 | 1245 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1246 | `		/* Increment reference count */` |
|   506081 | 1247 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6985847 | 1248 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1249 | `		/* Increment reference count */` |
|    52747 | 1250 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    26371 | 1251 | `	}` |
|  7238885 | 1252 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       48 | 1253 | `		SyBlobRelease(&pDest->sBlob);` |
|       22 | 1254 | `	}` |
|  7238885 | 1255 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3882045 | 1256 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1941122 | 1257 | `	}` |
|  7238885 | 1258 | `	return SXRET_OK;` |
|        5 | 1259 | `}` |
|        - | 1260 | `/*` |
|        - | 1261 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1262 | ` */` |
| 17729037 | 1263 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1264 | `{` |
| 17729042 | 1265 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 15286275 | 1266 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   697675 | 1267 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 14937440 | 1268 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    90363 | 1269 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    45179 | 1270 | `		}` |
|        - | 1271 | `		/* Release the internal buffer */` |
| 15286275 | 1272 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1273 | `		/* Invalidate any prior representation */` |
| 15286275 | 1274 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  7643494 | 1275 | `	}` |
| 17729042 | 1276 | `	return SXRET_OK;` |
|        5 | 1277 | `}` |
|        - | 1278 | `/*` |
...
|        - | 1330 | ` */` |
|  1356274 | 1331 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1332 | `{` |
|        - | 1333 | `	sxi32 iComb;` |
|        - | 1334 | `	sxi32 rc;` |
|  1356279 | 1335 | `	if( bStrict ){` |
|        - | 1336 | `		sxi32 iF1,iF2;` |
|        - | 1337 | `		/* Strict comparisons with === */` |
|   715228 | 1338 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   715228 | 1339 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   715228 | 1340 | `		if( iF1 != iF2 ){` |
|        - | 1341 | `			/* Not of the same type */` |
|   200485 | 1342 | `			return 1;` |
|        - | 1343 | `		}` |
|   257372 | 1344 | `	}` |
|        - | 1345 | `	/* Combine flag together */` |
|  1155799 | 1346 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1155794 | 1347 | `	if( !bStrict` |
|   898423 | 1348 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   320615 | 1349 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1365 | `	}` |
|  1155799 | 1366 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1367 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    23499 | 1368 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8767 | 1369 | `			PH7_MemObjToBool(pObj1);` |
|     4381 | 1370 | `		}` |
|    23499 | 1371 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7777 | 1372 | `			PH7_MemObjToBool(pObj2);` |
|     3886 | 1373 | `		}` |
|    23499 | 1374 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1132305 | 1375 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1387 | `		return rc;` |
|  1132275 | 1388 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      265 | 1400 | `		return rc;` |
|  1132015 | 1401 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1402 | `		SyString s1,s2;` |
|   725906 | 1403 | `		if( !bStrict ){` |
|        - | 1404 | `			/*` |
...
|        - | 1415 | `			 */` |
|   236720 | 1416 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1417 | `				/* Perform a numeric comparison */` |
|       29 | 1418 | `				goto Numeric;` |
|        - | 1419 | `			}` |
|   118352 | 1420 | `		}` |
|        - | 1421 | `		/* Perform a strict string comparison.*/` |
|   725878 | 1422 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1423 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1424 | `		}` |
|   725878 | 1425 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1426 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1427 | `		}` |
|   725878 | 1428 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   725878 | 1429 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1430 | `		/*` |
...
|        - | 1433 | `		 */` |
|   725878 | 1434 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   725878 | 1435 | `		if( rc == 0 ){` |
|   240600 | 1436 | `			if( s1.nByte != s2.nByte ){` |
|     2322 | 1437 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     1159 | 1438 | `			}` |
|   120298 | 1439 | `		}` |
|   725878 | 1440 | `		return rc;` |
|   406114 | 1441 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   203011 | 1442 | `Numeric:` |
|        - | 1443 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   406142 | 1444 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1445 | `			PH7_MemObjToNumeric(pObj1);` |
|        5 | 1446 | `		}` |
|   406142 | 1447 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       19 | 1448 | `			PH7_MemObjToNumeric(pObj2);` |
|        9 | 1449 | `		}` |
|   406142 | 1450 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1451 | `			/*` |
...
|   405870 | 1484 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     6711 | 1485 | `				return 1;` |
|   399164 | 1486 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   390821 | 1487 | `				return -1;` |
|        - | 1488 | `			}` |
|     8348 | 1489 | `			return 0;` |
|        - | 1490 | `		}` |
|        - | 1491 | `	}` |
...
|        - | 1506 | ` */` |
|    11112 | 1507 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1508 | `{` |
|    11117 | 1509 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
...
|        - | 1547 | `			}` |
|     3625 | 1548 | `	}else{` |
|     3877 | 1549 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
|        - | 1550 | `			ph7_hashmap *pMap;` |
|        - | 1551 | `			sxi32 rc;` |
|     3877 | 1552 | `			if( bAddStore ){` |
...
|     3875 | 1567 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|     3875 | 1568 | `				if( pMap == 0){` |
|      ! 0 | 1569 | `					PH7_VmThrowError(pObj1->pVm,0,PH7_CTX_ERR,"PH7 is running out of memory while creating array");` |
|      ! 0 | 1570 | `					return SXERR_MEM;` |
|        - | 1571 | `				}` |
|        - | 1572 | `			}` |
|     3877 | 1573 | `			if( !bAddStore ){` |
|     3875 | 1574 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1575 | `					/* Perform a hashmap duplication */` |
|     3875 | 1576 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|     1940 | 1577 | `				}else{` |
...
|     3877 | 1585 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|     3877 | 1586 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|     1941 | 1587 | `			}else{` |
...
|     3877 | 1594 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|      ! 0 | 1595 | `				SyBlobRelease(&pObj1->sBlob);` |
|      ! 0 | 1596 | `			}` |
|     3877 | 1597 | `			pObj1->x.pOther = pMap;` |
|     3877 | 1598 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|     1936 | 1599 | `		}` |
|        - | 1600 | `	}` |
|    11117 | 1601 | `	return SXRET_OK;` |
|     5561 | 1602 | `}` |
|        - | 1603 | `/*` |
