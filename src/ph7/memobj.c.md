...
|        - |  128 | ` */` |
|  3766066 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3766071 |  131 | `	sxi64 iVal = 0;` |
|  3766071 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3766071 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
...
|  2295109 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2404309 |  161 | `	return iVal;` |
|  1883038 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  380 | ` */` |
|    61626 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61631 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  410 | `#endif` |
|        5 |  411 | `		}` |
|    61444 |  412 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    60953 |  413 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  414 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30783 |  415 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  468 | ` */` |
|    18796 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18801 |  472 | `	iFlags = pObj->iFlags;` |
|    18801 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18789 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      907 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    17887 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  490 | `		}` |
|       84 |  491 | `		return 1;` |
|    17783 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16467 |  493 | `		return 0;` |
...
|        - |  546 | ` */` |
|   543220 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   543225 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  577 | ` */` |
|    22614 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22619 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18801 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18801 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18801 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9398 |  586 | `	}` |
|    22619 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|  1047669 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|  1047674 |  594 | `	sxi32 rc = SXRET_OK;` |
|  1047674 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61533 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61533 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61533 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30764 |  600 | `	}` |
|  1047674 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  781 | ` */` |
|   257707 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   257712 |  786 | `	int bDigit = 0;` |
|   257712 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   257712 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   257712 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   257712 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   257112 |  795 | `	zEnd = z + n;` |
|   257140 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   257112 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      215 |  800 | `		z++;` |
|      105 |  801 | `	}` |
|   261967 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4860 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   257112 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     6089 |  806 | `		z++;` |
|     6165 |  807 | `		while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|       80 |  808 | `			z++; bDigit = 1;` |
|        4 |  809 | `		}` |
|     3248 |  810 | `	}` |
|        - |  811 | `	/* At least one mantissa digit required (rejects "", ".", "+", "e5"). */` |
|   257112 |  812 | `	if( !bDigit ){` |
|   252361 |  813 | `		return 0;` |
|        - |  814 | `	}` |
...
|        - |  839 | ` */` |
|   255290 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   255295 |  842 | `	const char *zTail = 0, *zEnd;` |
|   255295 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   252951 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   256222 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   256227 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      649 |  860 | `		return TRUE;` |
|   255583 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      408 |  862 | `		return FALSE;` |
|   255179 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   255179 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   127988 |  869 | `}` |
...
|        - |  881 | ` */` |
|    41288 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    41293 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       20 |  885 | `		return TRUE;` |
|    41275 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    41255 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    41255 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    41251 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27737 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22139 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
...
|      ! 0 |  906 | `		}` |
|    13519 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13519 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13519 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   623628 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   623633 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   621264 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1080 | ` */` |
| 28181423 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 28181428 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 28181428 | 1086 | `	pObj->pVm = pVm;` |
| 28181428 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 28181428 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 28181428 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5915764 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5915769 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5915769 | 1100 | `	pObj->pVm = pVm;` |
|  5915769 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5915769 | 1103 | `	pObj->x.iVal = iVal;` |
|  5915769 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5915769 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17510 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17515 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17515 | 1115 | `	pObj->pVm = pVm;` |
|    17515 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17515 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17515 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17515 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    63848 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    63853 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    63853 | 1145 | `	pObj->pVm = pVm;` |
|    63853 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    63853 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    63853 | 1149 | `	pObj->x.pOther = pArray;` |
|    63853 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4438934 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4438939 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4438939 | 1160 | `	pObj->pVm = pVm;` |
|  4438939 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4438939 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2154295 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1077145 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4438939 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4438939 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2705376 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2705381 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2705381 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2705381 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  6117080 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  6117085 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  6117085 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  6117085 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   220303 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6006936 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    10349 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     5172 | 1222 | `	}` |
|  6117085 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    82203 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  6075986 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8423 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4209 | 1227 | `	}` |
|  6117085 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6117085 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  6117085 | 1230 | `	rc = SXRET_OK;` |
|  6117085 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4324129 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4324129 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2162292 | 1234 | `	}else{` |
|  1792961 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   396194 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   198456 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  6117085 | 1239 | `	if( pMap ){` |
|    82203 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  6075986 | 1241 | `	}else if( pObj ){` |
|     8423 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4209 | 1243 | `	}` |
|  6117080 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3169650 | 1245 | `	 && pDest->pVm` |
|   220298 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   110158 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  6117085 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  9049455 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  9049460 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  9049460 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   549891 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8774517 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    49389 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    24692 | 1281 | `	}` |
|  9049460 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  9049460 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4677525 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2339825 | 1287 | `	}` |
|  9049460 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 21459537 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 21459542 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18674476 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   716237 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 18316360 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    92829 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    46412 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18674476 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18674476 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9341741 | 1305 | `	}` |
| 21459542 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1742802 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1742807 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   880913 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   880913 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   880913 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   201007 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   340102 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1541805 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1541800 | 1377 | `	if( !bStrict` |
|  1201996 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   431295 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1541805 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24749 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9309 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4652 | 1400 | `		}` |
|    24749 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8245 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4120 | 1403 | `		}` |
|    24749 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1517061 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       55 | 1417 | `		return rc;` |
|  1517007 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1430 | `		return rc;` |
|  1516735 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   905899 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   253671 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   126156 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   904801 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   904801 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   904801 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   904801 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   904801 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   904801 | 1465 | `		if( rc == 0 ){` |
|   294746 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19663 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9831 | 1468 | `			}` |
|   147372 | 1469 | `		}` |
|   904801 | 1470 | `		return rc;` |
|   610841 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   304981 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   611939 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   611939 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   611939 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   611627 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7599 | 1515 | `				return 1;` |
|   604033 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   592701 | 1517 | `				return -1;` |
|        - | 1518 | `			}` |
|    11337 | 1519 | `			return 0;` |
|        - | 1520 | `		}` |
|        - | 1521 | `	}` |
...
|      113 | 1728 | `}` |
|      660 | 1729 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|        - | 1737 | `	)` |
|        5 | 1738 | `{` |
|      665 | 1739 | `	sxi32 rc = SXRET_OK;` |
|        - | 1740 | `	int i;` |
|      665 | 1741 | `	if( !ShowType ){` |
...
|     4657 | 1757 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4107 | 1758 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2055 | 1759 | `	}` |
|      553 | 1760 | `	if( isRef ){` |
|        7 | 1761 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|        3 | 1762 | `	}` |
|      553 | 1763 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
...
|      139 | 1777 | `		return rc;` |
|        - | 1778 | `	}` |
|      417 | 1779 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|        7 | 1780 | `		SyBlobAppend(&(*pOut),"NULL\n",sizeof("NULL\n")-1);` |
|        7 | 1781 | `		return SXRET_OK;` |
|        - | 1782 | `	}` |
|      411 | 1783 | `	if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|       28 | 1784 | `		rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,TRUE,nTab,nDepth+1);` |
|       28 | 1785 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|       28 | 1786 | `		return rc;` |
|        - | 1787 | `	}` |
|      385 | 1788 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      178 | 1789 | `		if( pObj->x.iVal != 0 ){` |
|      120 | 1790 | `			SyBlobAppend(&(*pOut),"bool(true)\n",sizeof("bool(true)\n")-1);` |
|       62 | 1791 | `		}else{` |
|       61 | 1792 | `			SyBlobAppend(&(*pOut),"bool(false)\n",sizeof("bool(false)\n")-1);` |
|        - | 1793 | `		}` |
|      178 | 1794 | `		return SXRET_OK;` |
|        - | 1795 | `	}` |
