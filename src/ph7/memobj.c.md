...
|        - |  128 | ` */` |
|  3801032 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3801037 |  131 | `	sxi64 iVal = 0;` |
|  3801037 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3801037 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
...
|  2298979 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2408179 |  161 | `	return iVal;` |
|  1900521 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  468 | ` */` |
|    18750 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18755 |  472 | `	iFlags = pObj->iFlags;` |
|    18755 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18743 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      901 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    17847 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  490 | `		}` |
|       66 |  491 | `		return 1;` |
|    17761 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16443 |  493 | `		return 0;` |
...
|        - |  546 | ` */` |
|   535322 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   535327 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  577 | ` */` |
|    22734 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22739 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18755 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18755 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18755 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9375 |  586 | `	}` |
|    22739 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|  1027734 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|  1027739 |  594 | `	sxi32 rc = SXRET_OK;` |
|  1027739 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - |  781 | ` */` |
|   253573 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   253578 |  786 | `	int bDigit = 0;` |
|   253578 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   253578 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   253578 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   253578 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   252978 |  795 | `	zEnd = z + n;` |
|   253006 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   252978 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      215 |  800 | `		z++;` |
|      105 |  801 | `	}` |
|   257833 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4860 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   252978 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     6087 |  806 | `		z++;` |
|     6163 |  807 | `		while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|       80 |  808 | `			z++; bDigit = 1;` |
|        4 |  809 | `		}` |
|     3247 |  810 | `	}` |
|        - |  811 | `	/* At least one mantissa digit required (rejects "", ".", "+", "e5"). */` |
|   252978 |  812 | `	if( !bDigit ){` |
|   248227 |  813 | `		return 0;` |
|        - |  814 | `	}` |
...
|        - |  839 | ` */` |
|   251156 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   251161 |  842 | `	const char *zTail = 0, *zEnd;` |
|   251161 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   248817 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   252088 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   252093 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      649 |  860 | `		return TRUE;` |
|   251449 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      408 |  862 | `		return FALSE;` |
|   251045 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   251045 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   125917 |  869 | `}` |
...
|        - |  881 | ` */` |
|    40438 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    40443 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       20 |  885 | `		return TRUE;` |
|    40425 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    40405 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    40405 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    40401 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27115 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21653 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
...
|      ! 0 |  906 | `		}` |
|    13291 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13291 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13291 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   585909 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   585914 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   583545 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1080 | ` */` |
| 28484190 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 28484195 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 28484195 | 1086 | `	pObj->pVm = pVm;` |
| 28484195 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 28484195 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 28484195 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5950562 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5950567 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5950567 | 1100 | `	pObj->pVm = pVm;` |
|  5950567 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5950567 | 1103 | `	pObj->x.iVal = iVal;` |
|  5950567 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5950567 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17192 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17197 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17197 | 1115 | `	pObj->pVm = pVm;` |
|    17197 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17197 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17197 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17197 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    63742 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    63747 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    63747 | 1145 | `	pObj->pVm = pVm;` |
|    63747 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    63747 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    63747 | 1149 | `	pObj->x.pOther = pArray;` |
|    63747 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4872734 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4872739 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4872739 | 1160 | `	pObj->pVm = pVm;` |
|  4872739 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4872739 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2480055 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1240025 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4872739 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4872739 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2810702 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2810707 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2810707 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2810707 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  6085167 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  6085172 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  6085172 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  6085172 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   218879 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5975735 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    12217 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     6106 | 1222 | `	}` |
|  6085172 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    81055 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  6044647 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8633 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4314 | 1227 | `	}` |
|  6085172 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6085172 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  6085172 | 1230 | `	rc = SXRET_OK;` |
|  6085172 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4306463 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4306463 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2153459 | 1234 | `	}else{` |
|  1778714 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   384459 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   192569 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  6085172 | 1239 | `	if( pMap ){` |
|    81055 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  6044647 | 1241 | `	}else if( pObj ){` |
|     8633 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4314 | 1243 | `	}` |
|  6085167 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3152962 | 1245 | `	 && pDest->pVm` |
|   218874 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109446 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  6085172 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  8757481 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  8757486 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8757486 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   543225 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8485876 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    54077 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    27036 | 1281 | `	}` |
|  8757486 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  8757486 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4559491 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2280761 | 1287 | `	}` |
|  8757486 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 21089368 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 21089373 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18290424 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   708889 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 17935982 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|   100997 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    50496 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18290424 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18290424 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9149547 | 1305 | `	}` |
| 21089373 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1666595 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1666600 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   845325 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   845325 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   845325 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   198589 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   323517 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1468016 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1468011 | 1377 | `	if( !bStrict` |
|  1144792 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   410960 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1468016 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24507 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9299 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4647 | 1400 | `		}` |
|    24507 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8233 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4114 | 1403 | `		}` |
|    24507 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1443514 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       55 | 1417 | `		return rc;` |
|  1443460 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      295 | 1430 | `		return rc;` |
|  1443170 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   868807 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   249537 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   124085 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   867709 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   867709 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   867709 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   867709 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   867709 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   867709 | 1465 | `		if( rc == 0 ){` |
|   277596 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19225 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9612 | 1468 | `			}` |
|   138797 | 1469 | `		}` |
|   867709 | 1470 | `		return rc;` |
|   574368 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   286766 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   575466 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   575466 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   575466 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   575154 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7678 | 1515 | `				return 1;` |
|   567481 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
...
|      113 | 1728 | `}` |
|      842 | 1729 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|        - | 1737 | `	)` |
|        5 | 1738 | `{` |
|      847 | 1739 | `	sxi32 rc = SXRET_OK;` |
|        - | 1740 | `	int i;` |
|      847 | 1741 | `	if( !ShowType ){` |
...
|     4851 | 1757 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4119 | 1758 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2061 | 1759 | `	}` |
|      735 | 1760 | `	if( isRef ){` |
|        7 | 1761 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|        3 | 1762 | `	}` |
|      735 | 1763 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
...
|      139 | 1777 | `		return rc;` |
|        - | 1778 | `	}` |
|      599 | 1779 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       17 | 1780 | `		SyBlobAppend(&(*pOut),"NULL\n",sizeof("NULL\n")-1);` |
|       17 | 1781 | `		return SXRET_OK;` |
|        - | 1782 | `	}` |
|      583 | 1783 | `	if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|       30 | 1784 | `		rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,TRUE,nTab,nDepth+1);` |
|       30 | 1785 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|       30 | 1786 | `		return rc;` |
|        - | 1787 | `	}` |
|      555 | 1788 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      244 | 1789 | `		if( pObj->x.iVal != 0 ){` |
|      174 | 1790 | `			SyBlobAppend(&(*pOut),"bool(true)\n",sizeof("bool(true)\n")-1);` |
|       89 | 1791 | `		}else{` |
|       73 | 1792 | `			SyBlobAppend(&(*pOut),"bool(false)\n",sizeof("bool(false)\n")-1);` |
|        - | 1793 | `		}` |
|      244 | 1794 | `		return SXRET_OK;` |
|        - | 1795 | `	}` |
