...
|        - |   93 | ` */` |
|    10818 |   94 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|        5 |   95 | `{` |
...
|    10823 |  111 | `  ph7_real r = pObj->rVal;` |
|    10823 |  112 | `  if( r<(ph7_real)minInt ){` |
|        3 |  113 | `    return minInt;` |
|    10821 |  114 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  128 | ` */` |
|  3754360 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3754365 |  131 | `	sxi64 iVal = 0;` |
|  3754365 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3754365 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1467925 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1358949 |  138 | `			return 0;` |
|        - |  139 | `		}` |
...
|  2286445 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2395421 |  161 | `	return iVal;` |
|  1877185 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  166 | ` * representation.` |
|        - |  167 | ` */` |
|     3500 |  168 | `static sxi64 MemObjStringToInt(ph7_value *pObj)` |
|        5 |  169 | `{` |
|     3505 |  170 | `	sxi64 iVal = 0;` |
...
|     3505 |  174 | `	SyStrToInt64((const char *)SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),(void *)&iVal,0);` |
|     3505 |  175 | `	return iVal;` |
|        5 |  176 | `}` |
|        - |  177 | `/*` |
...
|        - |  259 | ` */` |
|     9598 |  260 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|        5 |  261 | `{` |
|        - |  262 | `	sxi32 iFlags;` |
|     9603 |  263 | `	iFlags = pObj->iFlags;` |
|     9603 |  264 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  265 | `		return pObj->rVal;` |
|     9603 |  266 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
...
|        - |  330 | ` */` |
|      516 |  331 | `PH7_PRIVATE sxi32 PH7_PhpFloatShape(char *zBuf,sxi32 nLen,int bGeneric)` |
|        5 |  332 | `{` |
|        - |  333 | `	sxi32 iExp,i;` |
|      521 |  334 | `	iExp = nLen - 1;` |
|     4423 |  335 | `	while( iExp > 0 && zBuf[iExp] != 'e' && zBuf[iExp] != 'E' ){` |
|     3907 |  336 | `		iExp--;` |
|        5 |  337 | `	}` |
|      521 |  338 | `	if( iExp <= 0 ){` |
|      475 |  339 | `		return nLen; /* No exponent part (fixed notation) */` |
|        - |  340 | `	}` |
|        - |  341 | `	{` |
...
|        - |  380 | ` */` |
|    61562 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61567 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|        - |  384 | `		/* Handle special floating-point values first */` |
|      376 |  385 | `		if( PH7_IS_NAN(pObj->rVal) ){` |
|      ! 0 |  386 | `			SyBlobAppend(&(*pOut),"NAN",3);` |
|      376 |  387 | `		}else if( PH7_IS_INF(pObj->rVal) ){` |
...
|      372 |  402 | `			sxi32 n = (sxi32)snprintf(zNum,sizeof(zNum),"%.14G",pObj->rVal);` |
|      372 |  403 | `			if( n < 0 \|\| n >= (sxi32)sizeof(zNum) ){` |
|      ! 0 |  404 | `				n = (sxi32)SyStrlen(zNum);` |
|      ! 0 |  405 | `			}` |
|      372 |  406 | `			n = PH7_PhpFloatShape(zNum,n,TRUE);` |
|      372 |  407 | `			SyBlobAppend(&(*pOut),zNum,(sxu32)n);` |
|        - |  408 | `#else` |
|        - |  409 | `			SyBlobFormat(&(*pOut),"%.15g",pObj->rVal);` |
|        - |  410 | `#endif` |
|        4 |  411 | `		}` |
|    61381 |  412 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    60891 |  413 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  414 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30752 |  415 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  468 | ` */` |
|    18688 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18693 |  472 | `	iFlags = pObj->iFlags;` |
|    18693 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18681 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      909 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    17777 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  490 | `		}` |
|       88 |  491 | `		return 1;` |
|    17669 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16359 |  493 | `		return 0;` |
|     1315 |  494 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|     1295 |  499 | `	}else if( iFlags & MEMOBJ_OBJ ){` |
...
|      190 |  513 | `		return iVal;` |
|     1107 |  514 | `	}else if(iFlags & MEMOBJ_RES ){` |
|     1107 |  515 | `		return pObj->x.pOther != 0;` |
|        - |  516 | `	}` |
|        - |  517 | `	/* NOT REACHED */` |
|      ! 0 |  518 | `	return 0;` |
|     9349 |  519 | `}` |
...
|        - |  522 | ` */` |
|    10778 |  523 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|        5 |  524 | `{` |
|    10783 |  525 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|        - |  537 | `  */` |
|    10778 |  538 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|     9319 |  539 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     9303 |  540 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|     4651 |  541 | `	}` |
|    10783 |  542 | `	return SXRET_OK;` |
|        5 |  543 | `}` |
|        - |  544 | `/*` |
|        - |  545 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  546 | ` */` |
|   539114 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   539119 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|      702 |  555 | `	}` |
|   539119 |  556 | `	return SXRET_OK;` |
|        5 |  557 | `}` |
|        - |  558 | `/*` |
|        - |  559 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  560 | ` * Invalidate any prior representations` |
|        - |  561 | ` */` |
|    10608 |  562 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        5 |  563 | `{` |
|    10613 |  564 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  565 | `		/* Preform the conversion */` |
|     9603 |  566 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  567 | `		/* Invalidate any prior representations */` |
|     9603 |  568 | `		SyBlobRelease(&pObj->sBlob);` |
|     9603 |  569 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  570 | `		/* Try to get an integer representation */` |
|     9603 |  571 | `		MemObjTryIntger(&(*pObj));` |
|     4799 |  572 | `	}` |
|    10613 |  573 | `	return SXRET_OK;` |
|        5 |  574 | `}` |
|        - |  575 | `/*` |
|        - |  576 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  577 | ` */` |
|    22432 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22437 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18693 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18693 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18693 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9344 |  586 | `	}` |
|    22437 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|  1041880 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|  1041885 |  594 | `	sxi32 rc = SXRET_OK;` |
|  1041885 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61473 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61473 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61473 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30734 |  600 | `	}` |
|  1041885 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  781 | ` */` |
|   255887 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   255892 |  786 | `	int bDigit = 0;` |
|   255892 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   255892 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   255892 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   255892 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   255292 |  795 | `	zEnd = z + n;` |
|   255320 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   255292 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      203 |  800 | `		z++;` |
|       99 |  801 | `	}` |
|   260122 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4835 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   255292 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     4635 |  806 | `		z++;` |
|     4709 |  807 | `		while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|       77 |  808 | `			z++; bDigit = 1;` |
|        3 |  809 | `		}` |
|     2365 |  810 | `	}` |
|        - |  811 | `	/* At least one mantissa digit required (rejects "", ".", "+", "e5"). */` |
|   255292 |  812 | `	if( !bDigit ){` |
|   250566 |  813 | `		return 0;` |
|        - |  814 | `	}` |
...
|     4731 |  817 | `	if( z < zEnd && (z[0] == 'e' \|\| z[0] == 'E') ){` |
...
|        - |  839 | ` */` |
|   253495 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   253500 |  842 | `	const char *zTail = 0, *zEnd;` |
|   253500 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   251156 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   254385 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   254390 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      629 |  860 | `		return TRUE;` |
|   253766 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      384 |  862 | `		return FALSE;` |
|   253384 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   253384 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   127083 |  869 | `}` |
...
|        - |  881 | ` */` |
|    41034 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    41039 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       20 |  885 | `		return TRUE;` |
|    41021 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    41001 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    41001 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    40997 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27571 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21999 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
|        - |  896 | `			const char *zIn,*zEnd;` |
|     5577 |  897 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5577 |  898 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5583 |  899 | `			while( zIn < zEnd ){` |
|     5583 |  900 | `				if( zIn[0] != '0' ){` |
|     5577 |  901 | `					break;` |
|        - |  902 | `				}` |
|        7 |  903 | `				zIn++;` |
|        1 |  904 | `			}` |
|     5577 |  905 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  906 | `		}` |
|    13431 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13431 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13431 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   623776 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   623781 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   621437 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        2 |  932 | `		}` |
|        - |  933 | `		/* Already numeric */` |
|   621437 |  934 | `		return  SXRET_OK;` |
|        - |  935 | `	}` |
|     2348 |  936 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
|     2348 |  937 | `		const char *zTail = 0;` |
|     2348 |  938 | `		int bNum, bReal = 0;` |
...
|     2348 |  943 | `		bNum = PH7_MemObjStringNumericPrefix(pObj,&zTail);` |
|     2348 |  944 | `		if( bNum ){` |
|     2348 |  945 | `			const char *z = (const char *)SyBlobData(&pObj->sBlob);` |
|     4770 |  946 | `			while( z < zTail ){` |
|     2448 |  947 | `				if( z[0] == '.' \|\| z[0] == 'e' \|\| z[0] == 'E' ){` |
|       23 |  948 | `					bReal = 1;` |
|       23 |  949 | `					break;` |
|        - |  950 | `				}` |
|     2426 |  951 | `				z++;` |
...
|     2326 |  962 | `				pObj->x.iVal = MemObjStringToInt(&(*pObj));` |
|        - |  963 | `			}` |
|     2326 |  964 | `			MemObjSetType(pObj,MEMOBJ_INT);` |
|     2326 |  965 | `			SyBlobRelease(&pObj->sBlob);` |
|        4 |  966 | `		}` |
|     1172 |  967 | `	}else if(pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_HASHMAP\|MEMOBJ_RES)){` |
|      ! 0 |  968 | `		PH7_MemObjToInteger(pObj);` |
|      ! 0 |  969 | `	}else{` |
|        - |  970 | `		/* Perform a blind cast */` |
|      ! 0 |  971 | `		PH7_MemObjToReal(&(*pObj));` |
|        - |  972 | `	}` |
|     2348 |  973 | `	return SXRET_OK;` |
|   312179 |  974 | `}` |
|        - |  975 | `/*` |
...
|        - | 1080 | ` */` |
| 28064564 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 28064569 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 28064569 | 1086 | `	pObj->pVm = pVm;` |
| 28064569 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 28064569 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 28064569 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5904002 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5904007 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5904007 | 1100 | `	pObj->pVm = pVm;` |
|  5904007 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5904007 | 1103 | `	pObj->x.iVal = iVal;` |
|  5904007 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5904007 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17426 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17431 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17431 | 1115 | `	pObj->pVm = pVm;` |
|    17431 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17431 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17431 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17431 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    64038 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    64043 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    64043 | 1145 | `	pObj->pVm = pVm;` |
|    64043 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    64043 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    64043 | 1149 | `	pObj->x.pOther = pArray;` |
|    64043 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4389030 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4389035 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4389035 | 1160 | `	pObj->pVm = pVm;` |
|  4389035 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4389035 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2122549 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1061272 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4389035 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4389035 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2685686 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2685691 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2685691 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2685691 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  6095102 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  6095107 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  6095107 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  6095107 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   219537 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5985341 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    10317 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     5156 | 1222 | `	}` |
|  6095107 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    81573 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  6054323 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8383 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4189 | 1227 | `	}` |
|  6095107 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6095107 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  6095107 | 1230 | `	rc = SXRET_OK;` |
|  6095107 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4306807 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4306807 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2153631 | 1234 | `	}else{` |
|  1788305 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   394993 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   197856 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  6095107 | 1239 | `	if( pMap ){` |
|    81573 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  6054323 | 1241 | `	}else if( pObj ){` |
|     8383 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4189 | 1243 | `	}` |
|  6095102 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3158279 | 1245 | `	 && pDest->pVm` |
|   219532 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109775 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  6095107 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  9017779 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  9017784 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  9017784 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   546105 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8744734 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    49249 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    24622 | 1281 | `	}` |
|  9017784 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  9017784 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4654619 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2328400 | 1287 | `	}` |
|  9017784 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 21383547 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 21383552 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18620478 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   712529 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 18264216 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    92569 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    46282 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18620478 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18620478 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9314772 | 1305 | `	}` |
| 21383552 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1738170 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1738175 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   877363 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   877363 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   877363 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   199215 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   339224 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1538965 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1538960 | 1377 | `	if( !bStrict` |
|  1200036 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   430766 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1538965 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24597 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9247 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4621 | 1400 | `		}` |
|    24597 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8191 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4093 | 1403 | `		}` |
|    24597 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1514373 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       55 | 1417 | `		return rc;` |
|  1514319 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1430 | `		return rc;` |
|  1514047 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   902518 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   251882 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   125275 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   901420 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   901420 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   901420 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   901420 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   901420 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   901420 | 1465 | `		if( rc == 0 ){` |
|   294081 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19554 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9776 | 1468 | `			}` |
|   147039 | 1469 | `		}` |
|   901420 | 1470 | `		return rc;` |
|   611534 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   305328 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   612632 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   612632 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   612632 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   612320 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7573 | 1515 | `				return 1;` |
|   604752 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   593486 | 1517 | `				return -1;` |
|        - | 1518 | `			}` |
|    11271 | 1519 | `			return 0;` |
|        - | 1520 | `		}` |
|        - | 1521 | `	}` |
...
|        - | 1536 | ` */` |
|    13004 | 1537 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1538 | `{` |
|    13009 | 1539 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1540 | `			/* Arithemtic operation */` |
|     9195 | 1541 | `			PH7_MemObjToNumeric(pObj1);` |
|     9195 | 1542 | `			PH7_MemObjToNumeric(pObj2);` |
|     9195 | 1543 | `			if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_REAL ){` |
...
|        - | 1562 | `				sxi64 a,b,r;` |
|     9127 | 1563 | `				a = pObj1->x.iVal;` |
|     9127 | 1564 | `				b = pObj2->x.iVal;` |
|     9127 | 1565 | `				if( PH7_ADD_OVERFLOW64(a,b,&r) ){` |
...
|        - | 1572 | `#endif` |
|        5 | 1573 | `				}else{` |
|     9119 | 1574 | `					pObj1->x.iVal = r;` |
|     9119 | 1575 | `					MemObjSetType(pObj1,MEMOBJ_INT);` |
|        - | 1576 | `				}` |
|        - | 1577 | `			}` |
|     4600 | 1578 | `	}else{` |
