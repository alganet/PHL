...
|        - |   91 | ` */` |
|     3010 |   92 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|        4 |   93 | `{` |
...
|     3014 |  109 | `  ph7_real r = pObj->rVal;` |
|     3014 |  110 | `  if( r<(ph7_real)minInt ){` |
|        3 |  111 | `    return minInt;` |
|     3012 |  112 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  126 | ` */` |
|  1296564 |  127 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  128 | `{` |
|  1296569 |  129 | `	sxi64 iVal = 0;` |
|  1296569 |  130 | `	if( pVal->nByte <= 0 ){` |
|        7 |  131 | `		return 0;` |
|        - |  132 | `	}` |
|  1296563 |  133 | `	if( pVal->zString[0] == '0' ){` |
|        - |  134 | `		sxi32 c;` |
|   359867 |  135 | `		if( pVal->nByte == sizeof(char) ){` |
|   359453 |  136 | `			return 0;` |
|        - |  137 | `		}` |
|      415 |  138 | `		c = pVal->zString[1];` |
|      415 |  139 | `		if( c  == 'x' \|\| c == 'X' ){` |
|        - |  140 | `			/* Hex digit stream */` |
|       71 |  141 | `			SyHexStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|      380 |  142 | `		}else if( c == 'b' \|\| c == 'B' ){` |
|        - |  143 | `			/* Binary digit stream */` |
|      279 |  144 | `			SyBinaryStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|      140 |  145 | `		}else{` |
|        - |  146 | `			/* Octal digit stream */` |
|       67 |  147 | `			SyOctalStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  148 | `		}` |
|      208 |  149 | `	}else{` |
|        - |  150 | `		/* Decimal digit stream */` |
|   936701 |  151 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  152 | `	}` |
|   937115 |  153 | `	return iVal;` |
|   648287 |  154 | `}` |
|        - |  155 | `/*` |
...
|        - |  170 | ` */` |
|      182 |  171 | `static sxi32 MemObjCallClassCastMethod(` |
...
|      187 |  181 | `	pMethod = PH7_ClassExtractMethod(pThis->pClass,zMethod,nLen);` |
|      187 |  182 | `	if( pMethod == 0 ){` |
|        - |  183 | `		/* No such method */` |
|        6 |  184 | `		return SXERR_NOTFOUND;` |
|        - |  185 | `	}` |
|        - |  186 | `	/* Invoke the desired method */` |
|      183 |  187 | `	PH7_VmCallClassMethod(&(*pVm),&(*pThis),pMethod,&(*pResult),0,0);` |
|        - |  188 | `	/* Method successfully called,pResult should hold the return value */` |
|      183 |  189 | `	return SXRET_OK;` |
|       96 |  190 | `}` |
|        - |  191 | `/*` |
...
|        - |  199 | ` */` |
|      606 |  200 | `static sxi64 MemObjIntValue(ph7_value *pObj)` |
|        5 |  201 | `{` |
|        - |  202 | `	sxi32 iFlags;` |
|      611 |  203 | `	iFlags = pObj->iFlags;` |
|      611 |  204 | `	if (iFlags & MEMOBJ_REAL ){` |
|       39 |  205 | `		return MemObjRealToInt(&(*pObj));` |
|      573 |  206 | `	}else if( iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      160 |  207 | `		return pObj->x.iVal;` |
...
|        - |  248 | ` */` |
|     1786 |  249 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|        4 |  250 | `{` |
|        - |  251 | `	sxi32 iFlags;` |
|     1790 |  252 | `	iFlags = pObj->iFlags;` |
|     1790 |  253 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  254 | `		return pObj->rVal;` |
|     1790 |  255 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      772 |  256 | `		return (ph7_real)pObj->x.iVal;` |
|     1020 |  257 | `	}else if (iFlags & MEMOBJ_STRING){` |
|        - |  258 | `		SyString sString;` |
|        - |  259 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  260 | `		ph7_real rVal = 0;` |
|        - |  261 | `#else` |
|     1014 |  262 | `		ph7_real rVal = 0.0;` |
|        - |  263 | `#endif` |
|     1014 |  264 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|     1014 |  265 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|        - |  266 | `			/* Convert as much as we can */` |
|        - |  267 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  268 | `			rVal = MemObjStringToInt(&(*pObj));` |
|        - |  269 | `#else` |
|     1014 |  270 | `			SyStrToReal(sString.zString,sString.nByte,(void *)&rVal,0);` |
|        - |  271 | `#endif` |
|      505 |  272 | `		}` |
|     1014 |  273 | `		return rVal;` |
...
|        - |  369 | ` */` |
|    58214 |  370 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  371 | `{` |
|    58219 |  372 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  399 | `#endif` |
|        4 |  400 | `		}` |
|    58028 |  401 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    57219 |  402 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  403 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    29230 |  404 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  417 | `			}` |
|        5 |  418 | `		}` |
|      441 |  419 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|      ! 0 |  420 | `		SyBlobAppend(&(*pOut),"Array",sizeof("Array")-1);` |
|      ! 0 |  421 | `		PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
|      259 |  422 | `	}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|        - |  423 | `		ph7_value sResult;` |
|        - |  424 | `		sxi32 rc;` |
|        - |  425 | `		/* Invoke the __toString() method if available */` |
|      173 |  426 | `		PH7_MemObjInit(pObj->pVm,&sResult);` |
|      173 |  427 | `		rc = MemObjCallClassCastMethod(pObj->pVm,(ph7_class_instance *)pObj->x.pOther,` |
|        - |  428 | `			"__toString",sizeof("__toString")-1,&sResult);` |
|      173 |  429 | `		if( rc == SXRET_OK && (sResult.iFlags & MEMOBJ_STRING) && SyBlobLength(&sResult.sBlob) > 0){` |
...
|       80 |  434 | `			SyBlobAppend(&(*pOut),"Object",sizeof("Object")-1);` |
|        - |  435 | `		}` |
|      173 |  436 | `		PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|      173 |  437 | `		PH7_MemObjRelease(&sResult);` |
|      173 |  438 | `	}else if(pObj->iFlags & MEMOBJ_RES ){` |
|        3 |  439 | `		SyBlobFormat(&(*pOut),"ResourceID_%#x",pObj->x.pOther);` |
|        1 |  440 | `	}` |
|    58219 |  441 | `	return SXRET_OK;` |
|        5 |  442 | `}` |
|        - |  443 | `/*` |
...
|        - |  457 | ` */` |
|    16268 |  458 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  459 | `{` |
|        - |  460 | `	sxi32 iFlags;` |
|    16273 |  461 | `	iFlags = pObj->iFlags;` |
|    16273 |  462 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  463 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  464 | `		return pObj->rVal ? 1 : 0;` |
|        - |  465 | `#else` |
|       14 |  466 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  467 | `#endif` |
|    16261 |  468 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      287 |  469 | `		return pObj->x.iVal ? 1 : 0;` |
|    15979 |  470 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  479 | `		}` |
|       88 |  480 | `		return 1;` |
|    15871 |  481 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    14819 |  482 | `		return 0;` |
...
|        - |  511 | ` */` |
|     2972 |  512 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|        4 |  513 | `{` |
|     2976 |  514 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|        - |  526 | `  */` |
|     2972 |  527 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|     1554 |  528 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     1537 |  529 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|      769 |  530 | `	}` |
|     2976 |  531 | `	return SXRET_OK;` |
|        4 |  532 | `}` |
|        - |  533 | `/*` |
|        - |  534 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  535 | ` */` |
|   442278 |  536 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  537 | `{` |
|   442283 |  538 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  539 | `		/* Preform the conversion */` |
|      611 |  540 | `		pObj->x.iVal = MemObjIntValue(&(*pObj));` |
|        - |  541 | `		/* Invalidate any prior representations */` |
|      611 |  542 | `		SyBlobRelease(&pObj->sBlob);` |
|      611 |  543 | `		MemObjSetType(pObj,MEMOBJ_INT);` |
|      303 |  544 | `	}` |
|   442283 |  545 | `	return SXRET_OK;` |
|        5 |  546 | `}` |
|        - |  547 | `/*` |
|        - |  548 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  549 | ` * Invalidate any prior representations` |
|        - |  550 | ` */` |
|     2700 |  551 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        4 |  552 | `{` |
|     2704 |  553 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  554 | `		/* Preform the conversion */` |
|     1790 |  555 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  556 | `		/* Invalidate any prior representations */` |
|     1790 |  557 | `		SyBlobRelease(&pObj->sBlob);` |
|     1790 |  558 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  559 | `		/* Try to get an integer representation */` |
|     1790 |  560 | `		MemObjTryIntger(&(*pObj));` |
|      893 |  561 | `	}` |
|     2704 |  562 | `	return SXRET_OK;` |
|        4 |  563 | `}` |
|        - |  564 | `/*` |
|        - |  565 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  566 | ` */` |
|    18560 |  567 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  568 | `{` |
|    18565 |  569 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  570 | `		/* Preform the conversion */` |
|    16273 |  571 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  572 | `		/* Invalidate any prior representations */` |
|    16273 |  573 | `		SyBlobRelease(&pObj->sBlob);` |
|    16273 |  574 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     8134 |  575 | `	}` |
|    18565 |  576 | `	return SXRET_OK;` |
|        5 |  577 | `}` |
|        - |  578 | `/*` |
|        - |  579 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  580 | ` */` |
|   856641 |  581 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  582 | `{` |
|   856646 |  583 | `	sxi32 rc = SXRET_OK;` |
|   856646 |  584 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  585 | `		/* Perform the conversion */` |
|    57971 |  586 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    57971 |  587 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    57971 |  588 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    28983 |  589 | `	}` |
|   856646 |  590 | `	return rc;` |
|        5 |  591 | `}` |
|        - |  592 | `/*` |
...
|        - |  606 | `  */` |
|      538 |  607 | `PH7_PRIVATE sxi32 PH7_MemObjToHashmap(ph7_value *pObj)` |
|        5 |  608 | `{` |
|      543 |  609 | `	if( (pObj->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  610 | `		ph7_hashmap *pMap;` |
|        - |  611 | `		/* Allocate a new hashmap instance */` |
|      351 |  612 | `		pMap = PH7_NewHashmap(pObj->pVm,0,0);` |
|      351 |  613 | `		if( pMap == 0 ){` |
|      ! 0 |  614 | `			return SXERR_MEM;` |
|        - |  615 | `		}` |
|      351 |  616 | `		if( (pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_RES)) == 0 ){` |
|        - |  617 | `			/*` |
...
|        - |  624 | `				/* Object cast */` |
|       15 |  625 | `				PH7_ClassInstanceToHashmap((ph7_class_instance *)pObj->x.pOther,pMap);` |
|        8 |  626 | `			}else{` |
|        - |  627 | `				/* Insert a single element */` |
|       13 |  628 | `				PH7_HashmapInsert(pMap,0/* Automatic index assign */,&(*pObj));` |
|        - |  629 | `			}` |
|       27 |  630 | `			SyBlobRelease(&pObj->sBlob);` |
|       13 |  631 | `		}` |
|        - |  632 | `		/* Invalidate any prior representation */` |
|      351 |  633 | `		PH7_MemObjRelease(pObj);` |
|      351 |  634 | `		MemObjSetType(pObj,MEMOBJ_HASHMAP);` |
|      351 |  635 | `		pObj->x.pOther = pMap;` |
|      173 |  636 | `	}` |
|      543 |  637 | `	return SXRET_OK;` |
|      274 |  638 | `}` |
...
|        - |  762 | ` */` |
|   235099 |  763 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  764 | `{` |
|        - |  765 | `	const char *z, *zEnd;` |
|        - |  766 | `	sxu32 n;` |
|   235104 |  767 | `	int bDigit = 0;` |
|   235104 |  768 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  769 | `		return 0;` |
|        - |  770 | `	}` |
|   235104 |  771 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   235104 |  772 | `	n = SyBlobLength(&pValue->sBlob);` |
|   235104 |  773 | `	if( n == 0 ){` |
|       68 |  774 | `		return 0;` |
|        - |  775 | `	}` |
|   235038 |  776 | `	zEnd = z + n;` |
|   235044 |  777 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|        8 |  778 | `		z++;` |
|        2 |  779 | `	}` |
|   235038 |  780 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|       53 |  781 | `		z++;` |
|       24 |  782 | `	}` |
|   235218 |  783 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|      183 |  784 | `		z++; bDigit = 1;` |
|        3 |  785 | `	}` |
|   235038 |  786 | `	if( z < zEnd && z[0] == '.' ){` |
|       43 |  787 | `		z++;` |
...
|        - |  819 | ` */` |
|   235847 |  820 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  821 | `{` |
|   235852 |  822 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      535 |  823 | `		return TRUE;` |
|   235322 |  824 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      315 |  825 | `		return FALSE;` |
|   235012 |  826 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  827 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   235012 |  828 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  829 | `	}` |
|        - |  830 | `	/* NOT REACHED */` |
|      ! 0 |  831 | `	return FALSE;` |
|   117949 |  832 | `}` |
...
|        - |  844 | ` */` |
|    34230 |  845 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  846 | `{` |
|    34235 |  847 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  848 | `		return TRUE;` |
|    34219 |  849 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  850 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    34199 |  851 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  852 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    34199 |  853 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  854 | `		return !pObj->x.iVal;` |
|    34195 |  855 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27723 |  856 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22323 |  857 | `			return TRUE;` |
|      ! 0 |  858 | `		}else{` |
|        - |  859 | `			const char *zIn,*zEnd;` |
|     5405 |  860 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5405 |  861 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5411 |  862 | `			while( zIn < zEnd ){` |
|     5411 |  863 | `				if( zIn[0] != '0' ){` |
|     5405 |  864 | `					break;` |
|        - |  865 | `				}` |
|        7 |  866 | `				zIn++;` |
|        1 |  867 | `			}` |
|     5405 |  868 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  869 | `		}` |
|     6477 |  870 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     6477 |  871 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     6477 |  872 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  886 | ` */` |
|   465447 |  887 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  888 | `{` |
|   465452 |  889 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   465324 |  890 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1048 | ` */` |
| 10745345 | 1049 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1050 | `{` |
|        - | 1051 | `	/* Zero the structure */` |
| 10745350 | 1052 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1053 | `	/* Initialize fields */` |
| 10745350 | 1054 | `	pObj->pVm = pVm;` |
| 10745350 | 1055 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1056 | `	/* Set the NULL type */` |
| 10745350 | 1057 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 10745350 | 1058 | `	return SXRET_OK;` |
|        5 | 1059 | `}` |
|        - | 1060 | `/*` |
|        - | 1061 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1062 | ` */` |
|  3446146 | 1063 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1064 | `{` |
|        - | 1065 | `	/* Zero the structure */` |
|  3446151 | 1066 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1067 | `	/* Initialize fields */` |
|  3446151 | 1068 | `	pObj->pVm = pVm;` |
|  3446151 | 1069 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1070 | `	/* Set the desired type */` |
|  3446151 | 1071 | `	pObj->x.iVal = iVal;` |
|  3446151 | 1072 | `	pObj->iFlags = MEMOBJ_INT;` |
|  3446151 | 1073 | `	return SXRET_OK;` |
|        5 | 1074 | `}` |
|        - | 1075 | `/*` |
|        - | 1076 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1077 | ` */` |
|    17502 | 1078 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1079 | `{` |
|        - | 1080 | `	/* Zero the structure */` |
|    17507 | 1081 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1082 | `	/* Initialize fields */` |
|    17507 | 1083 | `	pObj->pVm = pVm;` |
|    17507 | 1084 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1085 | `	/* Set the desired type */` |
|    17507 | 1086 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17507 | 1087 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17507 | 1088 | `	return SXRET_OK;` |
|        5 | 1089 | `}` |
|        - | 1090 | `/*` |
...
|        - | 1107 | ` */` |
|    74554 | 1108 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1109 | `{` |
|        - | 1110 | `	/* Zero the structure */` |
|    74559 | 1111 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1112 | `	/* Initialize fields */` |
|    74559 | 1113 | `	pObj->pVm = pVm;` |
|    74559 | 1114 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1115 | `	/* Set the desired type */` |
|    74559 | 1116 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    74559 | 1117 | `	pObj->x.pOther = pArray;` |
|    74559 | 1118 | `	return SXRET_OK;` |
|        5 | 1119 | `}` |
|        - | 1120 | `/*` |
|        - | 1121 | ` * Initialize a ph7_value to the string type.` |
|        - | 1122 | ` */` |
|  2268254 | 1123 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1124 | `{` |
|        - | 1125 | `	/* Zero the structure */` |
|  2268259 | 1126 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1127 | `	/* Initialize fields */` |
|  2268259 | 1128 | `	pObj->pVm = pVm;` |
|  2268259 | 1129 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  2268259 | 1130 | `	if( pVal ){` |
|        - | 1131 | `		/* Append contents */` |
|   952567 | 1132 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   476281 | 1133 | `	}` |
|        - | 1134 | `	/* Set the desired type */` |
|  2268259 | 1135 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  2268259 | 1136 | `	return SXRET_OK;` |
|        5 | 1137 | `}` |
|        - | 1138 | `/*` |
...
|        - | 1143 | ` */` |
|  1508402 | 1144 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1145 | `{` |
|        - | 1146 | `	sxi32 rc;` |
|  1508407 | 1147 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1148 | `		/* Invalidate any prior representation */` |
|     2551 | 1149 | `		PH7_MemObjRelease(pObj);` |
|     2551 | 1150 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|     1273 | 1151 | `	}` |
|        - | 1152 | `	/* Append contents */` |
|  1508407 | 1153 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  1508407 | 1154 | `	return rc;` |
|        5 | 1155 | `}` |
|        - | 1156 | `#if 0` |
|        - | 1157 | `/*` |
...
|        - | 1178 | ` */` |
|  5051245 | 1179 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1180 | `{` |
|  5051250 | 1181 | `	ph7_class_instance *pObj = 0;` |
|  5051250 | 1182 | `	ph7_hashmap *pMap = 0;` |
|        - | 1183 | `	sxi32 rc;` |
|  5051250 | 1184 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1185 | `		/* Increment reference count */` |
|   213923 | 1186 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  4944291 | 1187 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1188 | `		/* Increment reference count */` |
|     5609 | 1189 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     2802 | 1190 | `	}` |
|  5051250 | 1191 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    62283 | 1192 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5020111 | 1193 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8091 | 1194 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4043 | 1195 | `	}` |
|  5051250 | 1196 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5051250 | 1197 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5051250 | 1198 | `	rc = SXRET_OK;` |
|  5051250 | 1199 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4036665 | 1200 | `		SyBlobReset(&pDest->sBlob);` |
|  4036665 | 1201 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2018335 | 1202 | `	}else{` |
|  1014590 | 1203 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   289828 | 1204 | `			SyBlobRelease(&pDest->sBlob);` |
|   144954 | 1205 | `		}` |
|        - | 1206 | `	}` |
|  5051250 | 1207 | `	if( pMap ){` |
|    62283 | 1208 | `		PH7_HashmapUnref(pMap);` |
|  5020111 | 1209 | `	}else if( pObj ){` |
|     8091 | 1210 | `		PH7_ClassInstanceUnref(pObj);` |
|     4043 | 1211 | `	}` |
|  5051245 | 1212 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2632624 | 1213 | `	 && pDest->pVm` |
|   213918 | 1214 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   106968 | 1218 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1231 | `		}` |
|        4 | 1232 | `	}` |
|  5051250 | 1233 | `	return rc;` |
|        5 | 1234 | `}` |
|        - | 1235 | `/*` |
|        - | 1236 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1237 | ` * buffer contents,simply point to it.` |
|        - | 1238 | ` */` |
|  7001582 | 1239 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1240 | `{` |
|  7001587 | 1241 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1242 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  7001587 | 1243 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1244 | `		/* Increment reference count */` |
|   492563 | 1245 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6755308 | 1246 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1247 | `		/* Increment reference count */` |
|    37801 | 1248 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    18898 | 1249 | `	}` |
|  7001587 | 1250 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       48 | 1251 | `		SyBlobRelease(&pDest->sBlob);` |
|       22 | 1252 | `	}` |
|  7001587 | 1253 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3777977 | 1254 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1889112 | 1255 | `	}` |
|  7001587 | 1256 | `	return SXRET_OK;` |
|        5 | 1257 | `}` |
|        - | 1258 | `/*` |
|        - | 1259 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1260 | ` */` |
| 17231901 | 1261 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1262 | `{` |
| 17231906 | 1263 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 14942827 | 1264 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   683869 | 1265 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 14600895 | 1266 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    64701 | 1267 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    32348 | 1268 | `		}` |
|        - | 1269 | `		/* Release the internal buffer */` |
| 14942827 | 1270 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1271 | `		/* Invalidate any prior representation */` |
| 14942827 | 1272 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  7471789 | 1273 | `	}` |
| 17231906 | 1274 | `	return SXRET_OK;` |
|        5 | 1275 | `}` |
|        - | 1276 | `/*` |
...
|        - | 1328 | ` */` |
|  1324537 | 1329 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1330 | `{` |
|        - | 1331 | `	sxi32 iComb;` |
|        - | 1332 | `	sxi32 rc;` |
|  1324542 | 1333 | `	if( bStrict ){` |
|        - | 1334 | `		sxi32 iF1,iF2;` |
|        - | 1335 | `		/* Strict comparisons with === */` |
|   694991 | 1336 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   694991 | 1337 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   694991 | 1338 | `		if( iF1 != iF2 ){` |
|        - | 1339 | `			/* Not of the same type */` |
|   195465 | 1340 | `			return 1;` |
|        - | 1341 | `		}` |
|   249763 | 1342 | `	}` |
|        - | 1343 | `	/* Combine flag together */` |
|  1129082 | 1344 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1129077 | 1345 | `	if( !bStrict` |
|   879314 | 1346 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   314875 | 1347 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1363 | `	}` |
|  1129082 | 1364 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1365 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    22903 | 1366 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8401 | 1367 | `			PH7_MemObjToBool(pObj1);` |
|     4198 | 1368 | `		}` |
|    22903 | 1369 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7421 | 1370 | `			PH7_MemObjToBool(pObj2);` |
|     3708 | 1371 | `		}` |
|    22903 | 1372 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1106184 | 1373 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1385 | `		return rc;` |
|  1106154 | 1386 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      257 | 1398 | `		return rc;` |
|  1105902 | 1399 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1400 | `		SyString s1,s2;` |
|   710254 | 1401 | `		if( !bStrict ){` |
|        - | 1402 | `			/*` |
...
|        - | 1413 | `			 */` |
|   234686 | 1414 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1415 | `				/* Perform a numeric comparison */` |
|       29 | 1416 | `				goto Numeric;` |
|        - | 1417 | `			}` |
|   117347 | 1418 | `		}` |
|        - | 1419 | `		/* Perform a strict string comparison.*/` |
|   710226 | 1420 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       19 | 1421 | `			PH7_MemObjToString(pObj1);` |
|        9 | 1422 | `		}` |
|   710226 | 1423 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        5 | 1424 | `			PH7_MemObjToString(pObj2);` |
|        2 | 1425 | `		}` |
|   710226 | 1426 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   710226 | 1427 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1428 | `		/*` |
...
|        - | 1431 | `		 */` |
|   710226 | 1432 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   710226 | 1433 | `		if( rc == 0 ){` |
|   237042 | 1434 | `			if( s1.nByte != s2.nByte ){` |
|     2202 | 1435 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     1098 | 1436 | `			}` |
|   118518 | 1437 | `		}` |
|   710226 | 1438 | `		return rc;` |
|   395653 | 1439 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   197783 | 1440 | `Numeric:` |
|        - | 1441 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   395681 | 1442 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1443 | `			PH7_MemObjToNumeric(pObj1);` |
|        5 | 1444 | `		}` |
|   395681 | 1445 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       19 | 1446 | `			PH7_MemObjToNumeric(pObj2);` |
|        9 | 1447 | `		}` |
|   395681 | 1448 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1449 | `			/*` |
...
|   395409 | 1482 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     5954 | 1483 | `				return 1;` |
|   389460 | 1484 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   381942 | 1485 | `				return -1;` |
|        - | 1486 | `			}` |
|     7523 | 1487 | `			return 0;` |
|        - | 1488 | `		}` |
|        - | 1489 | `	}` |
...
|        - | 1504 | ` */` |
|    10752 | 1505 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1506 | `{` |
|    10757 | 1507 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1508 | `			/* Arithemtic operation */` |
|     6903 | 1509 | `			PH7_MemObjToNumeric(pObj1);` |
|     6903 | 1510 | `			PH7_MemObjToNumeric(pObj2);` |
|     6903 | 1511 | `			if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_REAL ){` |
...
|        - | 1530 | `				sxi64 a,b,r;` |
|     6837 | 1531 | `				a = pObj1->x.iVal;` |
|     6837 | 1532 | `				b = pObj2->x.iVal;` |
|     6837 | 1533 | `				if( PH7_ADD_OVERFLOW64(a,b,&r) ){` |
...
|        - | 1540 | `#endif` |
|        5 | 1541 | `				}else{` |
|     6829 | 1542 | `					pObj1->x.iVal = r;` |
|     6829 | 1543 | `					MemObjSetType(pObj1,MEMOBJ_INT);` |
|        - | 1544 | `				}` |
|        - | 1545 | `			}` |
|     3454 | 1546 | `	}else{` |
