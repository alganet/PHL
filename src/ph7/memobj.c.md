...
|       - |   82 | `		sxi32 c;` |
|   23908 |   83 | `		if( pVal->nByte == sizeof(char) ){` |
|   23844 |   84 | `			return 0;` |
|       - |   85 | `		}` |
...
|   39552 |   99 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|       - |  100 | `	}` |
...
|       - |  756 | ` */` |
|   87520 |  757 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|       2 |  758 |  |
|       - |  759 | `	/* Zero the structure */` |
|   87522 |  760 | `	SyZero(pObj,sizeof(ph7_value));` |
|       - |  761 | `	/* Initialize fields */` |
|   87522 |  762 | `	pObj->pVm = pVm;` |
|   87522 |  763 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|       - |  764 | `	/* Set the desired type */` |
|   87522 |  765 | `	pObj->x.iVal = iVal;` |
|   87522 |  766 | `	pObj->iFlags = MEMOBJ_INT;` |
|   87522 |  767 | `	return SXRET_OK;` |
|       2 |  768 |  |
|       - |  769 | `/*` |
...
|       - |  874 | ` */` |
| 3800342 |  875 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|       2 |  876 |  |
| 3800344 |  877 | `	ph7_class_instance *pObj = 0;` |
| 3800344 |  878 | `	ph7_hashmap *pMap = 0;` |
|       - |  879 | `	sxi32 rc;` |
| 3800344 |  880 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|       - |  881 | `		/* Increment reference count */` |
|  102112 |  882 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
| 3749289 |  883 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|       - |  884 | `		/* Increment reference count */` |
|    1120 |  885 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     559 |  886 | `	}` |
| 3800344 |  887 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|   30034 |  888 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
| 3785328 |  889 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     738 |  890 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     368 |  891 | `	}` |
| 3800344 |  892 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
| 3800344 |  893 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
| 3800344 |  894 | `	rc = SXRET_OK;` |
| 3800344 |  895 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
| 3286062 |  896 | `		SyBlobReset(&pDest->sBlob);` |
| 3286062 |  897 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
| 1643032 |  898 | `	}else{` |
|  514284 |  899 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|  212642 |  900 | `			SyBlobRelease(&pDest->sBlob);` |
|  106342 |  901 | `		}` |
|       - |  902 | `	}` |
| 3800344 |  903 | `	if( pMap ){` |
|   30034 |  904 | `		PH7_HashmapUnref(pMap);` |
| 3785328 |  905 | `	}else if( pObj ){` |
|     738 |  906 | `		PH7_ClassInstanceUnref(pObj);` |
|     368 |  907 | `	}` |
| 3800344 |  908 | `	return rc;` |
|       2 |  909 |  |
|       - |  910 | `/*` |
|       - |  911 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|       - |  912 | ` * buffer contents,simply point to it.` |
|       - |  913 | ` */` |
| 4513884 |  914 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|       2 |  915 |  |
| 4513886 |  916 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|       - |  917 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
| 4513886 |  918 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|       - |  919 | `		/* Increment reference count */` |
|  299988 |  920 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
| 4363893 |  921 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|       - |  922 | `		/* Increment reference count */` |
|    4238 |  923 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    2118 |  924 | `	}` |
| 4513886 |  925 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|      19 |  926 | `		SyBlobRelease(&pDest->sBlob);` |
|       9 |  927 | `	}` |
| 4513886 |  928 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
| 2318266 |  929 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
| 1159260 |  930 | `	}` |
| 4513886 |  931 | `	return SXRET_OK;` |
|       2 |  932 |  |
|       - |  933 | `/*` |
|       - |  934 | ` * Invalidate any prior representation of a given ph7_value.` |
|       - |  935 | ` */` |
| 9369164 |  936 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|       2 |  937 |  |
| 9369166 |  938 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 8710068 |  939 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|  373840 |  940 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 8523149 |  941 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    7146 |  942 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    3572 |  943 | `		}` |
|       - |  944 | `		/* Release the internal buffer */` |
| 8710068 |  945 | `		SyBlobRelease(&pObj->sBlob);` |
|       - |  946 | `		/* Invalidate any prior representation */` |
| 8710068 |  947 | `		pObj->iFlags = MEMOBJ_NULL;` |
| 4355292 |  948 | `	}` |
| 9369166 |  949 | `	return SXRET_OK;` |
|       2 |  950 |  |
|       - |  951 | `/*` |
...
|       - | 1003 | ` */` |
|  889111 | 1004 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|       2 | 1005 |  |
|       - | 1006 | `	sxi32 iComb;` |
|       - | 1007 | `	sxi32 rc;` |
|  889113 | 1008 | `	if( bStrict ){` |
|       - | 1009 | `		sxi32 iF1,iF2;` |
...
|  779557 | 1019 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  779557 | 1020 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
...
|  765805 | 1029 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       9 | 1041 | `		return rc;` |
|  765797 | 1042 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|     162 | 1054 | `		return rc;` |
|  765637 | 1055 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|       - | 1056 | `		SyString s1,s2;` |
...
|  314425 | 1094 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|  157190 | 1095 | `Numeric:` |
|       - | 1096 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|  314435 | 1097 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       7 | 1098 | `			PH7_MemObjToNumeric(pObj1);` |
|       3 | 1099 | `		}` |
|  314435 | 1100 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       9 | 1101 | `			PH7_MemObjToNumeric(pObj2);` |
|       4 | 1102 | `		}` |
|  314435 | 1103 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|       - | 1104 | `			/*` |
...
|  314287 | 1137 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|    1811 | 1138 | `				return 1;` |
|  312478 | 1139 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|  309344 | 1140 | `				return -1;` |
|       - | 1141 | `			}` |
|    3136 | 1142 | `			return 0;` |
|       - | 1143 | `		}` |
|       - | 1144 | `	}` |
