...
|        - |  128 | ` */` |
|  3671728 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3671733 |  131 | `	sxi64 iVal = 0;` |
|  3671733 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3671733 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1437537 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1329961 |  138 | `			return 0;` |
|        - |  139 | `		}` |
...
|  2234201 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2341777 |  161 | `	return iVal;` |
|  1835869 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  468 | ` */` |
|    18598 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18603 |  472 | `	iFlags = pObj->iFlags;` |
|    18603 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18591 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      909 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    17687 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  490 | `		}` |
|       88 |  491 | `		return 1;` |
|    17579 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16271 |  493 | `		return 0;` |
...
|        - |  546 | ` */` |
|   527488 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   527493 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  577 | ` */` |
|    22326 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22331 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18603 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18603 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18603 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9299 |  586 | `	}` |
|    22331 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|   993013 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|   993018 |  594 | `	sxi32 rc = SXRET_OK;` |
|   993018 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - |  781 | ` */` |
|   254784 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   254789 |  786 | `	int bDigit = 0;` |
|   254789 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   254789 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   254789 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   254789 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   254189 |  795 | `	zEnd = z + n;` |
|   254217 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   254189 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      203 |  800 | `		z++;` |
|       99 |  801 | `	}` |
|   259019 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4835 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   254189 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     4632 |  806 | `		z++;` |
...
|        - |  839 | ` */` |
|   252392 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   252397 |  842 | `	const char *zTail = 0, *zEnd;` |
|   252397 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   250053 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   253282 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   253287 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      629 |  860 | `		return TRUE;` |
|   252663 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      384 |  862 | `		return FALSE;` |
|   252281 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   252281 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   126543 |  869 | `}` |
...
|        - |  881 | ` */` |
|    40852 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    40857 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       21 |  885 | `		return TRUE;` |
|    40839 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    40819 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    40819 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    40815 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27453 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21919 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
|        - |  896 | `			const char *zIn,*zEnd;` |
|     5539 |  897 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5539 |  898 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5545 |  899 | `			while( zIn < zEnd ){` |
|     5545 |  900 | `				if( zIn[0] != '0' ){` |
|     5539 |  901 | `					break;` |
|        - |  902 | `				}` |
|        7 |  903 | `				zIn++;` |
|        1 |  904 | `			}` |
|     5539 |  905 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  906 | `		}` |
|    13367 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13367 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13367 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   595271 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   595276 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   592932 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1080 | ` */` |
| 24900243 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 24900248 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 24900248 | 1086 | `	pObj->pVm = pVm;` |
| 24900248 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 24900248 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 24900248 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5821238 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5821243 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5821243 | 1100 | `	pObj->pVm = pVm;` |
|  5821243 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5821243 | 1103 | `	pObj->x.iVal = iVal;` |
|  5821243 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5821243 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17312 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17317 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17317 | 1115 | `	pObj->pVm = pVm;` |
|    17317 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17317 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17317 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17317 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    63090 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    63095 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    63095 | 1145 | `	pObj->pVm = pVm;` |
|    63095 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    63095 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    63095 | 1149 | `	pObj->x.pOther = pArray;` |
|    63095 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4289668 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4289673 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4289673 | 1160 | `	pObj->pVm = pVm;` |
|  4289673 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4289673 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2061009 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1030502 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4289673 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4289673 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2644090 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2644095 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2644095 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2644095 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  5978623 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  5978628 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  5978628 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  5978628 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   217687 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5869787 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    10121 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     5058 | 1222 | `	}` |
|  5978628 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    81203 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5938029 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8339 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4167 | 1227 | `	}` |
|  5978628 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5978628 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5978628 | 1230 | `	rc = SXRET_OK;` |
|  5978628 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4272429 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4272429 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2136217 | 1234 | `	}else{` |
|  1706204 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   358234 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   179138 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  5978628 | 1239 | `	if( pMap ){` |
|    81203 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  5938029 | 1241 | `	}else if( pObj ){` |
|     8339 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4167 | 1243 | `	}` |
|  5978623 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3098176 | 1245 | `	 && pDest->pVm` |
|   217682 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   108850 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  5978628 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  8657462 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  8657467 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8657467 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   542601 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8386169 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    48761 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    24378 | 1281 | `	}` |
|  8657467 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  8657467 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4498359 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2249018 | 1287 | `	}` |
|  8657467 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 20727219 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 20727224 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18080005 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   707361 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 17726327 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    91707 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    45851 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18080005 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18080005 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9039981 | 1305 | `	}` |
| 20727224 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1673126 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1673131 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   857489 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   857489 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   857489 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   197409 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   330040 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1475727 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1475722 | 1377 | `	if( !bStrict` |
|  1145682 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   407780 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1475727 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24511 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9203 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4599 | 1400 | `		}` |
|    24511 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8147 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4071 | 1403 | `		}` |
|    24511 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1451221 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       55 | 1417 | `		return rc;` |
|  1451167 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1430 | `		return rc;` |
|  1450895 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   883447 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   250779 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   124735 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   882349 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   882349 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   882349 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   882349 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   882349 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   882349 | 1465 | `		if( rc == 0 ){` |
|   293458 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19516 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9757 | 1468 | `			}` |
|   146728 | 1469 | `		}` |
|   882349 | 1470 | `		return rc;` |
...
|     7574 | 1515 | `				return 1;` |
|   560670 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   549393 | 1517 | `				return -1;` |
|        - | 1518 | `			}` |
|    11282 | 1519 | `			return 0;` |
|        - | 1520 | `		}` |
|        - | 1521 | `	}` |
