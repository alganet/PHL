...
|        - |   76 | ` */` |
|   135596 |   77 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |   78 | `{` |
|   135601 |   79 | `	sxi64 iVal = 0;` |
|   135601 |   80 | `	if( pVal->nByte <= 0 ){` |
|        7 |   81 | `		return 0;` |
|        - |   82 | `	}` |
|   135595 |   83 | `	if( pVal->zString[0] == '0' ){` |
|        - |   84 | `		sxi32 c;` |
|    56063 |   85 | `		if( pVal->nByte == sizeof(char) ){` |
|    55661 |   86 | `			return 0;` |
|        - |   87 | `		}` |
...
|    79537 |  101 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  102 | `	}` |
|    79939 |  103 | `	return iVal;` |
|    67803 |  104 | `}` |
|        - |  105 | `/*` |
...
|        - |  404 | ` */` |
|    14040 |  405 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  406 | `{` |
|        - |  407 | `	sxi32 iFlags;` |
|    14045 |  408 | `	iFlags = pObj->iFlags;` |
|    14045 |  409 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  410 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  411 | `		return pObj->rVal ? 1 : 0;` |
|        - |  412 | `#else` |
|       12 |  413 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  414 | `#endif` |
|    14035 |  415 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      125 |  416 | `		return pObj->x.iVal ? 1 : 0;` |
|    13915 |  417 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|      ! 0 |  437 | `		}` |
|    13853 |  438 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    12815 |  439 | `		return 0;` |
...
|        - |  492 | ` */` |
|   409134 |  493 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  494 | `{` |
|   409139 |  495 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  523 | ` */` |
|    15462 |  524 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  525 | `{` |
|    15467 |  526 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  527 | `		/* Preform the conversion */` |
|    14045 |  528 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  529 | `		/* Invalidate any prior representations */` |
|    14045 |  530 | `		SyBlobRelease(&pObj->sBlob);` |
|    14045 |  531 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     7020 |  532 | `	}` |
|    15467 |  533 | `	return SXRET_OK;` |
|        5 |  534 | `}` |
|        - |  535 | `/*` |
|        - |  536 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  537 | ` */` |
|   813033 |  538 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  539 | `{` |
|   813038 |  540 | `	sxi32 rc = SXRET_OK;` |
|   813038 |  541 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - |  710 | ` */` |
|   456378 |  711 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  712 | `{` |
|   456383 |  713 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      309 |  714 | `		return TRUE;` |
|   456079 |  715 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      179 |  716 | `		return FALSE;` |
|   455905 |  717 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  718 | `		SyString sStr;` |
|        - |  719 | `		sxi32 rc;` |
|   455905 |  720 | `		SyStringInitFromBuf(&sStr,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|   455905 |  721 | `		if( sStr.nByte <= 0 ){` |
|        - |  722 | `			/* Empty string */` |
|       25 |  723 | `			return FALSE;` |
|        - |  724 | `		}` |
|        - |  725 | `		/* Check if the string representation looks like a numeric number */` |
|   455881 |  726 | `		rc = SyStrIsNumeric(sStr.zString,sStr.nByte,0,0);` |
|   455881 |  727 | `		return rc == SXRET_OK ? TRUE : FALSE;` |
|        - |  728 | `	}` |
|        - |  729 | `	/* NOT REACHED */` |
|      ! 0 |  730 | `	return FALSE;` |
|   228223 |  731 | `}` |
...
|        - |  743 | ` */` |
|    33278 |  744 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  745 | `{` |
|    33283 |  746 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  747 | `		return TRUE;` |
|    33267 |  748 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       20 |  749 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    33249 |  750 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  751 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    33249 |  752 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  753 | `		return !pObj->x.iVal;` |
|    33245 |  754 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    26991 |  755 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21647 |  756 | `			return TRUE;` |
|      ! 0 |  757 | `		}else{` |
...
|      ! 0 |  768 | `		}` |
|     6259 |  769 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     6259 |  770 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     6259 |  771 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  785 | ` */` |
|   446885 |  786 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  787 | `{` |
|   446890 |  788 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   446778 |  789 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - |  933 | ` */` |
|  8571553 |  934 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 |  935 | `{` |
|        - |  936 | `	/* Zero the structure */` |
|  8571558 |  937 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  938 | `	/* Initialize fields */` |
|  8571558 |  939 | `	pObj->pVm = pVm;` |
|  8571558 |  940 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  941 | `	/* Set the NULL type */` |
|  8571558 |  942 | `	pObj->iFlags = MEMOBJ_NULL;` |
|  8571558 |  943 | `	return SXRET_OK;` |
|        5 |  944 | `}` |
|        - |  945 | `/*` |
|        - |  946 | ` * Initialize a ph7_value to the integer type.` |
|        - |  947 | ` */` |
|   167608 |  948 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 |  949 | `{` |
|        - |  950 | `	/* Zero the structure */` |
|   167613 |  951 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  952 | `	/* Initialize fields */` |
|   167613 |  953 | `	pObj->pVm = pVm;` |
|   167613 |  954 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  955 | `	/* Set the desired type */` |
|   167613 |  956 | `	pObj->x.iVal = iVal;` |
|   167613 |  957 | `	pObj->iFlags = MEMOBJ_INT;` |
|   167613 |  958 | `	return SXRET_OK;` |
|        5 |  959 | `}` |
|        - |  960 | `/*` |
|        - |  961 | ` * Initialize a ph7_value to the boolean type.` |
|        - |  962 | ` */` |
|    17150 |  963 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 |  964 | `{` |
|        - |  965 | `	/* Zero the structure */` |
|    17155 |  966 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  967 | `	/* Initialize fields */` |
|    17155 |  968 | `	pObj->pVm = pVm;` |
|    17155 |  969 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  970 | `	/* Set the desired type */` |
|    17155 |  971 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17155 |  972 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17155 |  973 | `	return SXRET_OK;` |
|        5 |  974 | `}` |
|        - |  975 | `#if 0` |
|        - |  976 | `/*` |
...
|        - |  994 | ` */` |
|    50998 |  995 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 |  996 | `{` |
|        - |  997 | `	/* Zero the structure */` |
|    51003 |  998 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  999 | `	/* Initialize fields */` |
|    51003 | 1000 | `	pObj->pVm = pVm;` |
|    51003 | 1001 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1002 | `	/* Set the desired type */` |
|    51003 | 1003 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    51003 | 1004 | `	pObj->x.pOther = pArray;` |
|    51003 | 1005 | `	return SXRET_OK;` |
|        5 | 1006 | `}` |
|        - | 1007 | `/*` |
|        - | 1008 | ` * Initialize a ph7_value to the string type.` |
|        - | 1009 | ` */` |
|   534374 | 1010 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1011 | `{` |
|        - | 1012 | `	/* Zero the structure */` |
|   534379 | 1013 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1014 | `	/* Initialize fields */` |
|   534379 | 1015 | `	pObj->pVm = pVm;` |
|   534379 | 1016 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|   534379 | 1017 | `	if( pVal ){` |
|        - | 1018 | `		/* Append contents */` |
|   330229 | 1019 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   165112 | 1020 | `	}` |
|        - | 1021 | `	/* Set the desired type */` |
|   534379 | 1022 | `	pObj->iFlags = MEMOBJ_STRING;` |
|   534379 | 1023 | `	return SXRET_OK;` |
|        5 | 1024 | `}` |
|        - | 1025 | `/*` |
...
|        - | 1030 | ` */` |
|   388172 | 1031 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1032 | `{` |
|        - | 1033 | `	sxi32 rc;` |
|   388177 | 1034 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1035 | `		/* Invalidate any prior representation */` |
|     1931 | 1036 | `		PH7_MemObjRelease(pObj);` |
|     1931 | 1037 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|      963 | 1038 | `	}` |
|        - | 1039 | `	/* Append contents */` |
|   388177 | 1040 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|   388177 | 1041 | `	return rc;` |
|        5 | 1042 | `}` |
|        - | 1043 | `#if 0` |
|        - | 1044 | `/*` |
...
|        - | 1065 | ` */` |
|  4753575 | 1066 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1067 | `{` |
|  4753580 | 1068 | `	ph7_class_instance *pObj = 0;` |
|  4753580 | 1069 | `	ph7_hashmap *pMap = 0;` |
|        - | 1070 | `	sxi32 rc;` |
|  4753580 | 1071 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1072 | `		/* Increment reference count */` |
|   177447 | 1073 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  4664859 | 1074 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1075 | `		/* Increment reference count */` |
|     3423 | 1076 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     1709 | 1077 | `	}` |
|  4753580 | 1078 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    58149 | 1079 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  4724508 | 1080 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     5005 | 1081 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     2500 | 1082 | `	}` |
|  4753580 | 1083 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  4753580 | 1084 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  4753580 | 1085 | `	rc = SXRET_OK;` |
|  4753580 | 1086 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3910981 | 1087 | `		SyBlobReset(&pDest->sBlob);` |
|  3910981 | 1088 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  1955493 | 1089 | `	}else{` |
|   842604 | 1090 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   276836 | 1091 | `			SyBlobRelease(&pDest->sBlob);` |
|   138459 | 1092 | `		}` |
|        - | 1093 | `	}` |
|  4753580 | 1094 | `	if( pMap ){` |
|    58149 | 1095 | `		PH7_HashmapUnref(pMap);` |
|  4724508 | 1096 | `	}else if( pObj ){` |
|     5005 | 1097 | `		PH7_ClassInstanceUnref(pObj);` |
|     2500 | 1098 | `	}` |
|  4753575 | 1099 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2465552 | 1100 | `	 && pDest->pVm` |
|   177442 | 1101 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|    88730 | 1105 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1118 | `		}` |
|        4 | 1119 | `	}` |
|  4753580 | 1120 | `	return rc;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
|        - | 1123 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1124 | ` * buffer contents,simply point to it.` |
|        - | 1125 | ` */` |
|  6563524 | 1126 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1127 | `{` |
|  6563529 | 1128 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1129 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6563529 | 1130 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1131 | `		/* Increment reference count */` |
|   461147 | 1132 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6332958 | 1133 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1134 | `		/* Increment reference count */` |
|    22071 | 1135 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    11033 | 1136 | `	}` |
|  6563529 | 1137 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       40 | 1138 | `		SyBlobRelease(&pDest->sBlob);` |
|       18 | 1139 | `	}` |
|  6563529 | 1140 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3540247 | 1141 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1770237 | 1142 | `	}` |
|  6563529 | 1143 | `	return SXRET_OK;` |
|        5 | 1144 | `}` |
|        - | 1145 | `/*` |
|        - | 1146 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1147 | ` */` |
| 14344637 | 1148 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1149 | `{` |
| 14344642 | 1150 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 11846075 | 1151 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   599917 | 1152 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 11546119 | 1153 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    37629 | 1154 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    18812 | 1155 | `		}` |
|        - | 1156 | `		/* Release the internal buffer */` |
| 11846075 | 1157 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1158 | `		/* Invalidate any prior representation */` |
| 11846075 | 1159 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  5923415 | 1160 | `	}` |
| 14344642 | 1161 | `	return SXRET_OK;` |
|        5 | 1162 | `}` |
|        - | 1163 | `/*` |
...
|        - | 1215 | ` */` |
|  1252347 | 1216 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1217 | `{` |
|        - | 1218 | `	sxi32 iComb;` |
|        - | 1219 | `	sxi32 rc;` |
|  1252352 | 1220 | `	if( bStrict ){` |
|        - | 1221 | `		sxi32 iF1,iF2;` |
|        - | 1222 | `		/* Strict comparisons with === */` |
|   644628 | 1223 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   644628 | 1224 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   644628 | 1225 | `		if( iF1 != iF2 ){` |
|        - | 1226 | `			/* Not of the same type */` |
|   180507 | 1227 | `			return 1;` |
|        - | 1228 | `		}` |
|   232061 | 1229 | `	}` |
|        - | 1230 | `	/* Combine flag together */` |
|  1071850 | 1231 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1071850 | 1232 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1233 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    20765 | 1234 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7373 | 1235 | `			PH7_MemObjToBool(pObj1);` |
|     3684 | 1236 | `		}` |
|    20765 | 1237 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     6407 | 1238 | `			PH7_MemObjToBool(pObj2);` |
|     3201 | 1239 | `		}` |
|    20765 | 1240 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1051090 | 1241 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       29 | 1253 | `		return rc;` |
|  1051062 | 1254 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      229 | 1266 | `		return rc;` |
|  1050838 | 1267 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1268 | `		SyString s1,s2;` |
|   670484 | 1269 | `		if( !bStrict ){` |
|        - | 1270 | `			/*` |
...
|        - | 1276 | `			 */` |
|   227898 | 1277 | `			if( PH7_MemObjIsNumeric(pObj1) ){` |
|        - | 1278 | `				/* Perform a numeric comparison */` |
|       17 | 1279 | `				goto Numeric;` |
|        - | 1280 | `			}` |
|   227882 | 1281 | `			if( PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1282 | `				/* Perform a numeric comparison */` |
|      ! 0 | 1283 | `				goto Numeric;` |
|        - | 1284 | `			}` |
|   113953 | 1285 | `		}` |
|        - | 1286 | `		/* Perform a strict string comparison.*/` |
|   670468 | 1287 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1288 | `			PH7_MemObjToString(pObj1);` |
|      ! 0 | 1289 | `		}` |
|   670468 | 1290 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1291 | `			PH7_MemObjToString(pObj2);` |
|      ! 0 | 1292 | `		}` |
|   670468 | 1293 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   670468 | 1294 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1295 | `		/*` |
...
|        - | 1298 | `		 */` |
|   670468 | 1299 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   670468 | 1300 | `		if( rc == 0 ){` |
|   230316 | 1301 | `			if( s1.nByte != s2.nByte ){` |
|     1662 | 1302 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|      831 | 1303 | `			}` |
|   115158 | 1304 | `		}` |
|   670468 | 1305 | `		return rc;` |
|   380359 | 1306 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   190132 | 1307 | `Numeric:` |
|        - | 1308 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   380375 | 1309 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|        5 | 1310 | `			PH7_MemObjToNumeric(pObj1);` |
|        2 | 1311 | `		}` |
|   380375 | 1312 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       15 | 1313 | `			PH7_MemObjToNumeric(pObj2);` |
|        7 | 1314 | `		}` |
|   380375 | 1315 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1316 | `			/*` |
...
|   380143 | 1349 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     6677 | 1350 | `				return 1;` |
|   373471 | 1351 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   367596 | 1352 | `				return -1;` |
|        - | 1353 | `			}` |
|     5880 | 1354 | `			return 0;` |
|        - | 1355 | `		}` |
|        - | 1356 | `	}` |
