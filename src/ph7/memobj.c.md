...
|    78805 |   99 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  100 | `	}` |
...
|        - |  415 | ` */` |
|   400552 |  416 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  417 | `{` |
|   400557 |  418 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  446 | ` */` |
|    15316 |  447 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  448 | `{` |
|    15321 |  449 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
...
|     6984 |  455 | `	}` |
|    15321 |  456 | `	return SXRET_OK;` |
|        5 |  457 | `}` |
|        - |  458 | `/*` |
|        - |  459 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  460 | ` */` |
|   804773 |  461 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  462 | `{` |
|   804778 |  463 | `	sxi32 rc = SXRET_OK;` |
|   804778 |  464 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - |  633 | ` */` |
|   453940 |  634 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  635 | `{` |
|   453945 |  636 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      293 |  637 | `		return TRUE;` |
|   453657 |  638 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      175 |  639 | `		return FALSE;` |
|   453487 |  640 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  641 | `		SyString sStr;` |
|        - |  642 | `		sxi32 rc;` |
|   453487 |  643 | `		SyStringInitFromBuf(&sStr,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|   453487 |  644 | `		if( sStr.nByte <= 0 ){` |
|        - |  645 | `			/* Empty string */` |
|       25 |  646 | `			return FALSE;` |
|        - |  647 | `		}` |
|        - |  648 | `		/* Check if the string representation looks like a numeric number */` |
|   453463 |  649 | `		rc = SyStrIsNumeric(sStr.zString,sStr.nByte,0,0);` |
|   453463 |  650 | `		return rc == SXRET_OK ? TRUE : FALSE;` |
|        - |  651 | `	}` |
|        - |  652 | `	/* NOT REACHED */` |
|      ! 0 |  653 | `	return FALSE;` |
|   227043 |  654 | `}` |
...
|        - |  666 | ` */` |
|    33106 |  667 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  668 | `{` |
|    33111 |  669 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  670 | `		return TRUE;` |
|    33095 |  671 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       20 |  672 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    33077 |  673 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  674 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    33077 |  675 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  676 | `		return !pObj->x.iVal;` |
|    33073 |  677 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    26859 |  678 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21529 |  679 | `			return TRUE;` |
|      ! 0 |  680 | `		}else{` |
...
|        - |  708 | ` */` |
|   441585 |  709 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  710 | `{` |
|   441590 |  711 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   441478 |  712 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - |  856 | ` */` |
|  8170301 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 |  858 | `{` |
|        - |  859 | `	/* Zero the structure */` |
|  8170306 |  860 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  861 | `	/* Initialize fields */` |
|  8170306 |  862 | `	pObj->pVm = pVm;` |
|  8170306 |  863 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  864 | `	/* Set the NULL type */` |
|  8170306 |  865 | `	pObj->iFlags = MEMOBJ_NULL;` |
|  8170306 |  866 | `	return SXRET_OK;` |
|        5 |  867 | `}` |
|        - |  868 | `/*` |
...
|        - |  885 | ` */` |
|    17068 |  886 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 |  887 | `{` |
|        - |  888 | `	/* Zero the structure */` |
|    17073 |  889 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  890 | `	/* Initialize fields */` |
|    17073 |  891 | `	pObj->pVm = pVm;` |
|    17073 |  892 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  893 | `	/* Set the desired type */` |
|    17073 |  894 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17073 |  895 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17073 |  896 | `	return SXRET_OK;` |
|        5 |  897 | `}` |
|        - |  898 | `#if 0` |
|        - |  899 | `/*` |
...
|        - |  932 | ` */` |
|   530314 |  933 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 |  934 | `{` |
|        - |  935 | `	/* Zero the structure */` |
|   530319 |  936 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  937 | `	/* Initialize fields */` |
|   530319 |  938 | `	pObj->pVm = pVm;` |
|   530319 |  939 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|   530319 |  940 | `	if( pVal ){` |
|        - |  941 | `		/* Append contents */` |
|   328421 |  942 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   164208 |  943 | `	}` |
|        - |  944 | `	/* Set the desired type */` |
|   530319 |  945 | `	pObj->iFlags = MEMOBJ_STRING;` |
|   530319 |  946 | `	return SXRET_OK;` |
|        5 |  947 | `}` |
|        - |  948 | `/*` |
...
|        - |  953 | ` */` |
|   384764 |  954 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 |  955 | `{` |
|        - |  956 | `	sxi32 rc;` |
|   384769 |  957 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  958 | `		/* Invalidate any prior representation */` |
|     1765 |  959 | `		PH7_MemObjRelease(pObj);` |
|     1765 |  960 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|      880 |  961 | `	}` |
|        - |  962 | `	/* Append contents */` |
|   384769 |  963 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|   384769 |  964 | `	return rc;` |
|        5 |  965 | `}` |
|        - |  966 | `#if 0` |
|        - |  967 | `/*` |
...
|        - |  988 | ` */` |
|  4716307 |  989 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 |  990 | `{` |
|  4716312 |  991 | `	ph7_class_instance *pObj = 0;` |
|  4716312 |  992 | `	ph7_hashmap *pMap = 0;` |
|        - |  993 | `	sxi32 rc;` |
|  4716312 |  994 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  995 | `		/* Increment reference count */` |
|   175683 |  996 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  4628473 |  997 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - |  998 | `		/* Increment reference count */` |
|     3321 |  999 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     1658 | 1000 | `	}` |
|  4716312 | 1001 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    57667 | 1002 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  4687481 | 1003 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     4863 | 1004 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     2429 | 1005 | `	}` |
|  4716312 | 1006 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  4716312 | 1007 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  4716312 | 1008 | `	rc = SXRET_OK;` |
|  4716312 | 1009 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3894385 | 1010 | `		SyBlobReset(&pDest->sBlob);` |
|  3894385 | 1011 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  1947195 | 1012 | `	}else{` |
|   821932 | 1013 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   274284 | 1014 | `			SyBlobRelease(&pDest->sBlob);` |
|   137183 | 1015 | `		}` |
|        - | 1016 | `	}` |
|  4716312 | 1017 | `	if( pMap ){` |
|    57667 | 1018 | `		PH7_HashmapUnref(pMap);` |
|  4687481 | 1019 | `	}else if( pObj ){` |
|     4863 | 1020 | `		PH7_ClassInstanceUnref(pObj);` |
|     2429 | 1021 | `	}` |
|  4716312 | 1022 | `	return rc;` |
|        5 | 1023 | `}` |
|        - | 1024 | `/*` |
|        - | 1025 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1026 | ` * buffer contents,simply point to it.` |
|        - | 1027 | ` */` |
|  6488568 | 1028 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1029 | `{` |
|  6488573 | 1030 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1031 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6488573 | 1032 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1033 | `		/* Increment reference count */` |
|   457519 | 1034 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6259816 | 1035 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1036 | `		/* Increment reference count */` |
|    20905 | 1037 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    10450 | 1038 | `	}` |
|  6488573 | 1039 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       36 | 1040 | `		SyBlobRelease(&pDest->sBlob);` |
|       16 | 1041 | `	}` |
|  6488573 | 1042 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3503807 | 1043 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1752056 | 1044 | `	}` |
|  6488573 | 1045 | `	return SXRET_OK;` |
|        5 | 1046 | `}` |
|        - | 1047 | `/*` |
|        - | 1048 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1049 | ` */` |
| 14202483 | 1050 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1051 | `{` |
| 14202488 | 1052 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 11726529 | 1053 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   594615 | 1054 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 11429224 | 1055 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    35825 | 1056 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    17910 | 1057 | `		}` |
|        - | 1058 | `		/* Release the internal buffer */` |
| 11726529 | 1059 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1060 | `		/* Invalidate any prior representation */` |
| 11726529 | 1061 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  5863672 | 1062 | `	}` |
| 14202488 | 1063 | `	return SXRET_OK;` |
|        5 | 1064 | `}` |
|        - | 1065 | `/*` |
...
|        - | 1117 | ` */` |
|  1239931 | 1118 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1119 | `{` |
|        - | 1120 | `	sxi32 iComb;` |
|        - | 1121 | `	sxi32 rc;` |
|  1239936 | 1122 | `	if( bStrict ){` |
|        - | 1123 | `		sxi32 iF1,iF2;` |
|        - | 1124 | `		/* Strict comparisons with === */` |
|   638737 | 1125 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   638737 | 1126 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   638737 | 1127 | `		if( iF1 != iF2 ){` |
|        - | 1128 | `			/* Not of the same type */` |
|   178555 | 1129 | `			return 1;` |
|        - | 1130 | `		}` |
|   230091 | 1131 | `	}` |
|        - | 1132 | `	/* Combine flag together */` |
|  1061386 | 1133 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1061386 | 1134 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1135 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    20645 | 1136 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7337 | 1137 | `			PH7_MemObjToBool(pObj1);` |
|     3666 | 1138 | `		}` |
|    20645 | 1139 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     6371 | 1140 | `			PH7_MemObjToBool(pObj2);` |
|     3183 | 1141 | `		}` |
|    20645 | 1142 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1040746 | 1143 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       27 | 1155 | `		return rc;` |
|  1040720 | 1156 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      229 | 1168 | `		return rc;` |
|  1040496 | 1169 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1170 | `		SyString s1,s2;` |
|   665649 | 1171 | `		if( !bStrict ){` |
|        - | 1172 | `			/*` |
...
|        - | 1178 | `			 */` |
|   226693 | 1179 | `			if( PH7_MemObjIsNumeric(pObj1) ){` |
|        - | 1180 | `				/* Perform a numeric comparison */` |
|       17 | 1181 | `				goto Numeric;` |
|        - | 1182 | `			}` |
|   226677 | 1183 | `			if( PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1184 | `				/* Perform a numeric comparison */` |
|      ! 0 | 1185 | `				goto Numeric;` |
|        - | 1186 | `			}` |
|   113370 | 1187 | `		}` |
|        - | 1188 | `		/* Perform a strict string comparison.*/` |
|   665633 | 1189 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1190 | `			PH7_MemObjToString(pObj1);` |
|      ! 0 | 1191 | `		}` |
|   665633 | 1192 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1193 | `			PH7_MemObjToString(pObj2);` |
|      ! 0 | 1194 | `		}` |
|   665633 | 1195 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   665633 | 1196 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1197 | `		/*` |
...
|        - | 1200 | `		 */` |
|   665633 | 1201 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   665633 | 1202 | `		if( rc == 0 ){` |
|   229682 | 1203 | `			if( s1.nByte != s2.nByte ){` |
|     1658 | 1204 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|      829 | 1205 | `			}` |
|   114841 | 1206 | `		}` |
|   665633 | 1207 | `		return rc;` |
|   374852 | 1208 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   187383 | 1209 | `Numeric:` |
|        - | 1210 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   374868 | 1211 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|        5 | 1212 | `			PH7_MemObjToNumeric(pObj1);` |
|        2 | 1213 | `		}` |
|   374868 | 1214 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       15 | 1215 | `			PH7_MemObjToNumeric(pObj2);` |
|        7 | 1216 | `		}` |
|   374868 | 1217 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1218 | `			/*` |
...
|   374644 | 1251 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     5265 | 1252 | `				return 1;` |
