...
|        - |  128 | ` */` |
|  2780404 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  2780409 |  131 | `	sxi64 iVal = 0;` |
|  2780409 |  132 | `	if( pVal->nByte <= 0 ){` |
|      137 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  2780273 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1052183 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1051727 |  138 | `			return 0;` |
|        - |  139 | `		}` |
...
|  1728095 |  153 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  154 | `	}` |
|  1728551 |  155 | `	return iVal;` |
|  1390207 |  156 | `}` |
|        - |  157 | `/*` |
...
|        - |  371 | ` */` |
|    58686 |  372 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  373 | `{` |
|    58691 |  374 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  401 | `#endif` |
|        3 |  402 | `		}` |
|    58501 |  403 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    57757 |  404 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  405 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    29435 |  406 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  459 | ` */` |
|    17666 |  460 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  461 | `{` |
|        - |  462 | `	sxi32 iFlags;` |
|    17671 |  463 | `	iFlags = pObj->iFlags;` |
|    17671 |  464 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  465 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  466 | `		return pObj->rVal ? 1 : 0;` |
|        - |  467 | `#else` |
|       14 |  468 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  469 | `#endif` |
|    17659 |  470 | `	}else if( iFlags & MEMOBJ_INT ){` |
...
|    15527 |  484 | `		return 0;` |
|     1231 |  485 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|     1211 |  490 | `	}else if( iFlags & MEMOBJ_OBJ ){` |
...
|      173 |  504 | `		return iVal;` |
|     1039 |  505 | `	}else if(iFlags & MEMOBJ_RES ){` |
|     1039 |  506 | `		return pObj->x.pOther != 0;` |
|        - |  507 | `	}` |
|        - |  508 | `	/* NOT REACHED */` |
|      ! 0 |  509 | `	return 0;` |
|     8838 |  510 | `}` |
...
|        - |  537 | ` */` |
|   454128 |  538 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  539 | `{` |
|   454133 |  540 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  568 | ` */` |
|    20482 |  569 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  570 | `{` |
|    20487 |  571 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  572 | `		/* Preform the conversion */` |
|    17671 |  573 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  574 | `		/* Invalidate any prior representations */` |
|    17671 |  575 | `		SyBlobRelease(&pObj->sBlob);` |
|    17671 |  576 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     8833 |  577 | `	}` |
|    20487 |  578 | `	return SXRET_OK;` |
|        5 |  579 | `}` |
|        - |  580 | `/*` |
|        - |  581 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  582 | ` */` |
|   872403 |  583 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  584 | `{` |
|   872408 |  585 | `	sxi32 rc = SXRET_OK;` |
|   872408 |  586 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  587 | `		/* Perform the conversion */` |
|    58597 |  588 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    58597 |  589 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    58597 |  590 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    29296 |  591 | `	}` |
|   872408 |  592 | `	return rc;` |
|        5 |  593 | `}` |
|        - |  594 | `/*` |
...
|        - |  764 | ` */` |
|   237042 |  765 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  766 | `{` |
|        - |  767 | `	const char *z, *zEnd;` |
|        - |  768 | `	sxu32 n;` |
|   237047 |  769 | `	int bDigit = 0;` |
|   237047 |  770 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  771 | `		return 0;` |
|        - |  772 | `	}` |
|   237047 |  773 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   237047 |  774 | `	n = SyBlobLength(&pValue->sBlob);` |
|   237047 |  775 | `	if( n == 0 ){` |
|       68 |  776 | `		return 0;` |
|        - |  777 | `	}` |
|   236981 |  778 | `	zEnd = z + n;` |
|   236987 |  779 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|        8 |  780 | `		z++;` |
|        2 |  781 | `	}` |
|   236981 |  782 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|       53 |  783 | `		z++;` |
|       24 |  784 | `	}` |
|   237161 |  785 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|      183 |  786 | `		z++; bDigit = 1;` |
|        3 |  787 | `	}` |
|   236981 |  788 | `	if( z < zEnd && z[0] == '.' ){` |
|       43 |  789 | `		z++;` |
...
|        - |  821 | ` */` |
|   237802 |  822 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  823 | `{` |
|   237807 |  824 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      541 |  825 | `		return TRUE;` |
|   237271 |  826 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      321 |  827 | `		return FALSE;` |
|   236955 |  828 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  829 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   236955 |  830 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  831 | `	}` |
|        - |  832 | `	/* NOT REACHED */` |
|      ! 0 |  833 | `	return FALSE;` |
|   118914 |  834 | `}` |
...
|        - |  846 | ` */` |
|    34428 |  847 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  848 | `{` |
|    34433 |  849 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  850 | `		return TRUE;` |
|    34417 |  851 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  852 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    34397 |  853 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  854 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    34397 |  855 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  856 | `		return !pObj->x.iVal;` |
|    34393 |  857 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27863 |  858 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22431 |  859 | `			return TRUE;` |
|      ! 0 |  860 | `		}else{` |
...
|      ! 0 |  871 | `		}` |
|     6535 |  872 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     6535 |  873 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     6535 |  874 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  888 | ` */` |
|   473573 |  889 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  890 | `{` |
|   473578 |  891 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   473422 |  892 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1050 | ` */` |
| 12389405 | 1051 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1052 | `{` |
|        - | 1053 | `	/* Zero the structure */` |
| 12389410 | 1054 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1055 | `	/* Initialize fields */` |
| 12389410 | 1056 | `	pObj->pVm = pVm;` |
| 12389410 | 1057 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1058 | `	/* Set the NULL type */` |
| 12389410 | 1059 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 12389410 | 1060 | `	return SXRET_OK;` |
|        5 | 1061 | `}` |
|        - | 1062 | `/*` |
|        - | 1063 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1064 | ` */` |
|  4930250 | 1065 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1066 | `{` |
|        - | 1067 | `	/* Zero the structure */` |
|  4930255 | 1068 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1069 | `	/* Initialize fields */` |
|  4930255 | 1070 | `	pObj->pVm = pVm;` |
|  4930255 | 1071 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1072 | `	/* Set the desired type */` |
|  4930255 | 1073 | `	pObj->x.iVal = iVal;` |
|  4930255 | 1074 | `	pObj->iFlags = MEMOBJ_INT;` |
|  4930255 | 1075 | `	return SXRET_OK;` |
|        5 | 1076 | `}` |
|        - | 1077 | `/*` |
|        - | 1078 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1079 | ` */` |
|    17612 | 1080 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1081 | `{` |
|        - | 1082 | `	/* Zero the structure */` |
|    17617 | 1083 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1084 | `	/* Initialize fields */` |
|    17617 | 1085 | `	pObj->pVm = pVm;` |
|    17617 | 1086 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1087 | `	/* Set the desired type */` |
|    17617 | 1088 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17617 | 1089 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17617 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
...
|        - | 1109 | ` */` |
|    75514 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    75519 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    75519 | 1115 | `	pObj->pVm = pVm;` |
|    75519 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    75519 | 1118 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    75519 | 1119 | `	pObj->x.pOther = pArray;` |
|    75519 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
|        - | 1123 | ` * Initialize a ph7_value to the string type.` |
|        - | 1124 | ` */` |
|  3873220 | 1125 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1126 | `{` |
|        - | 1127 | `	/* Zero the structure */` |
|  3873225 | 1128 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1129 | `	/* Initialize fields */` |
|  3873225 | 1130 | `	pObj->pVm = pVm;` |
|  3873225 | 1131 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  3873225 | 1132 | `	if( pVal ){` |
|        - | 1133 | `		/* Append contents */` |
|  1808701 | 1134 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   904348 | 1135 | `	}` |
|        - | 1136 | `	/* Set the desired type */` |
|  3873225 | 1137 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  3873225 | 1138 | `	return SXRET_OK;` |
|        5 | 1139 | `}` |
|        - | 1140 | `/*` |
...
|        - | 1145 | ` */` |
|  2428236 | 1146 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1147 | `{` |
|        - | 1148 | `	sxi32 rc;` |
|  2428241 | 1149 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2428241 | 1155 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2428241 | 1156 | `	return rc;` |
|        5 | 1157 | `}` |
|        - | 1158 | `#if 0` |
|        - | 1159 | `/*` |
...
|        - | 1180 | ` */` |
|  5162607 | 1181 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1182 | `{` |
|  5162612 | 1183 | `	ph7_class_instance *pObj = 0;` |
|  5162612 | 1184 | `	ph7_hashmap *pMap = 0;` |
|        - | 1185 | `	sxi32 rc;` |
|  5162612 | 1186 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1187 | `		/* Increment reference count */` |
|   219125 | 1188 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5053052 | 1189 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1190 | `		/* Increment reference count */` |
|     9027 | 1191 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4511 | 1192 | `	}` |
|  5162612 | 1193 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    66393 | 1194 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5129418 | 1195 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8989 | 1196 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4492 | 1197 | `	}` |
|  5162612 | 1198 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5162612 | 1199 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5162612 | 1200 | `	rc = SXRET_OK;` |
|  5162612 | 1201 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4083117 | 1202 | `		SyBlobReset(&pDest->sBlob);` |
|  4083117 | 1203 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2041561 | 1204 | `	}else{` |
|  1079500 | 1205 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   294774 | 1206 | `			SyBlobRelease(&pDest->sBlob);` |
|   147428 | 1207 | `		}` |
|        - | 1208 | `	}` |
|  5162612 | 1209 | `	if( pMap ){` |
|    66393 | 1210 | `		PH7_HashmapUnref(pMap);` |
|  5129418 | 1211 | `	}else if( pObj ){` |
|     8989 | 1212 | `		PH7_ClassInstanceUnref(pObj);` |
|     4492 | 1213 | `	}` |
|  5162607 | 1214 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2690907 | 1215 | `	 && pDest->pVm` |
|   219120 | 1216 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109569 | 1220 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1233 | `		}` |
|        4 | 1234 | `	}` |
|  5162612 | 1235 | `	return rc;` |
|        5 | 1236 | `}` |
|        - | 1237 | `/*` |
|        - | 1238 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1239 | ` * buffer contents,simply point to it.` |
|        - | 1240 | ` */` |
|  7236280 | 1241 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1242 | `{` |
|  7236285 | 1243 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1244 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  7236285 | 1245 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1246 | `		/* Increment reference count */` |
|   505855 | 1247 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6983360 | 1248 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1249 | `		/* Increment reference count */` |
|    52719 | 1250 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    26357 | 1251 | `	}` |
|  7236285 | 1252 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       48 | 1253 | `		SyBlobRelease(&pDest->sBlob);` |
|       22 | 1254 | `	}` |
|  7236285 | 1255 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3880307 | 1256 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1940254 | 1257 | `	}` |
|  7236285 | 1258 | `	return SXRET_OK;` |
|        5 | 1259 | `}` |
|        - | 1260 | `/*` |
|        - | 1261 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1262 | ` */` |
| 17721857 | 1263 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1264 | `{` |
| 17721862 | 1265 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 15280523 | 1266 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   697381 | 1267 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 14931835 | 1268 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    90319 | 1269 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    45157 | 1270 | `		}` |
|        - | 1271 | `		/* Release the internal buffer */` |
| 15280523 | 1272 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1273 | `		/* Invalidate any prior representation */` |
| 15280523 | 1274 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  7640618 | 1275 | `	}` |
| 17721862 | 1276 | `	return SXRET_OK;` |
|        5 | 1277 | `}` |
|        - | 1278 | `/*` |
...
|        - | 1330 | ` */` |
|  1355858 | 1331 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1332 | `{` |
|        - | 1333 | `	sxi32 iComb;` |
|        - | 1334 | `	sxi32 rc;` |
|  1355863 | 1335 | `	if( bStrict ){` |
|        - | 1336 | `		sxi32 iF1,iF2;` |
|        - | 1337 | `		/* Strict comparisons with === */` |
|   714912 | 1338 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   714912 | 1339 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   714912 | 1340 | `		if( iF1 != iF2 ){` |
|        - | 1341 | `			/* Not of the same type */` |
|   200337 | 1342 | `			return 1;` |
|        - | 1343 | `		}` |
|   257287 | 1344 | `	}` |
|        - | 1345 | `	/* Combine flag together */` |
|  1155531 | 1346 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1155526 | 1347 | `	if( !bStrict` |
|   898238 | 1348 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   320563 | 1349 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1365 | `	}` |
|  1155531 | 1366 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1367 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    23489 | 1368 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8763 | 1369 | `			PH7_MemObjToBool(pObj1);` |
|     4379 | 1370 | `		}` |
|    23489 | 1371 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7775 | 1372 | `			PH7_MemObjToBool(pObj2);` |
|     3885 | 1373 | `		}` |
|    23489 | 1374 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1132047 | 1375 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1387 | `		return rc;` |
|  1132017 | 1388 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      265 | 1400 | `		return rc;` |
|  1131757 | 1401 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1402 | `		SyString s1,s2;` |
|   725653 | 1403 | `		if( !bStrict ){` |
|        - | 1404 | `			/*` |
...
|        - | 1415 | `			 */` |
|   236627 | 1416 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1417 | `				/* Perform a numeric comparison */` |
|       29 | 1418 | `				goto Numeric;` |
|        - | 1419 | `			}` |
|   118305 | 1420 | `		}` |
|        - | 1421 | `		/* Perform a strict string comparison.*/` |
|   725625 | 1422 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1423 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1424 | `		}` |
|   725625 | 1425 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1426 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1427 | `		}` |
|   725625 | 1428 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   725625 | 1429 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1430 | `		/*` |
...
|        - | 1433 | `		 */` |
|   725625 | 1434 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   725625 | 1435 | `		if( rc == 0 ){` |
|   240566 | 1436 | `			if( s1.nByte != s2.nByte ){` |
|     2322 | 1437 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     1159 | 1438 | `			}` |
|   120281 | 1439 | `		}` |
|   725625 | 1440 | `		return rc;` |
|   406109 | 1441 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   203011 | 1442 | `Numeric:` |
|        - | 1443 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   406137 | 1444 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1445 | `			PH7_MemObjToNumeric(pObj1);` |
|        5 | 1446 | `		}` |
|   406137 | 1447 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       19 | 1448 | `			PH7_MemObjToNumeric(pObj2);` |
|        9 | 1449 | `		}` |
|   406137 | 1450 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1451 | `			/*` |
...
|   405865 | 1484 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     6718 | 1485 | `				return 1;` |
|   399152 | 1486 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   390807 | 1487 | `				return -1;` |
|        - | 1488 | `			}` |
|     8350 | 1489 | `			return 0;` |
|        - | 1490 | `		}` |
|        - | 1491 | `	}` |
...
|        - | 1677 | ` */` |
|      198 | 1678 | `PH7_PRIVATE void PH7_MemObjPrintRInline(SyBlob *pOut,ph7_value *pObj)` |
|        2 | 1679 | `{` |
|      200 | 1680 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|        7 | 1681 | `		return;` |
|        - | 1682 | `	}` |
|      194 | 1683 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      ! 0 | 1684 | `		if( pObj->x.iVal != 0 ){` |
|      ! 0 | 1685 | `			SyBlobAppend(&(*pOut),"1",sizeof(char));` |
|      ! 0 | 1686 | `		}` |
|      ! 0 | 1687 | `		return;` |
|        - | 1688 | `	}` |
|      194 | 1689 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
...
|      101 | 1698 | `}` |
|      538 | 1699 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|        - | 1707 | `	)` |
|        4 | 1708 | `{` |
|      542 | 1709 | `	sxi32 rc = SXRET_OK;` |
|        - | 1710 | `	int i;` |
|      542 | 1711 | `	if( !ShowType ){` |
...
|      106 | 1715 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|       99 | 1716 | `			return PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,FALSE,nTab,nDepth+1);` |
|        - | 1717 | `		}` |
