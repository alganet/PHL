...
|        - |  128 | ` */` |
|  3766060 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3766065 |  131 | `	sxi64 iVal = 0;` |
|  3766065 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3766065 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1470967 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1361767 |  138 | `			return 0;` |
|        - |  139 | `		}` |
...
|  2295103 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2404303 |  161 | `	return iVal;` |
|  1883035 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  380 | ` */` |
|    61618 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61623 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  410 | `#endif` |
|        5 |  411 | `		}` |
|    61436 |  412 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    60945 |  413 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  414 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30779 |  415 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  468 | ` */` |
|    18786 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18791 |  472 | `	iFlags = pObj->iFlags;` |
|    18791 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18779 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      907 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    17877 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  490 | `		}` |
|       84 |  491 | `		return 1;` |
|    17773 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16459 |  493 | `		return 0;` |
|     1319 |  494 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|     1301 |  499 | `	}else if( iFlags & MEMOBJ_OBJ ){` |
...
|      190 |  513 | `		return iVal;` |
|     1113 |  514 | `	}else if(iFlags & MEMOBJ_RES ){` |
|     1113 |  515 | `		return pObj->x.pOther != 0;` |
|        - |  516 | `	}` |
|        - |  517 | `	/* NOT REACHED */` |
|      ! 0 |  518 | `	return 0;` |
|     9398 |  519 | `}` |
...
|        - |  546 | ` */` |
|   542913 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   542918 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  577 | ` */` |
|    22598 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22603 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18791 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18791 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18791 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9393 |  586 | `	}` |
|    22603 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|  1047211 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|  1047216 |  594 | `	sxi32 rc = SXRET_OK;` |
|  1047216 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61525 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61525 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61525 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30760 |  600 | `	}` |
|  1047216 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  781 | ` */` |
|   257515 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   257520 |  786 | `	int bDigit = 0;` |
|   257520 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   257520 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   257520 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   257520 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   256920 |  795 | `	zEnd = z + n;` |
|   256948 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   256920 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      215 |  800 | `		z++;` |
|      105 |  801 | `	}` |
|   261775 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4860 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   256920 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     6083 |  806 | `		z++;` |
|     6159 |  807 | `		while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|       80 |  808 | `			z++; bDigit = 1;` |
|        4 |  809 | `		}` |
|     3245 |  810 | `	}` |
|        - |  811 | `	/* At least one mantissa digit required (rejects "", ".", "+", "e5"). */` |
|   256920 |  812 | `	if( !bDigit ){` |
|   252169 |  813 | `		return 0;` |
|        - |  814 | `	}` |
...
|        - |  839 | ` */` |
|   255098 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   255103 |  842 | `	const char *zTail = 0, *zEnd;` |
|   255103 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   252759 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   256030 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   256035 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      649 |  860 | `		return TRUE;` |
|   255391 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      408 |  862 | `		return FALSE;` |
|   254987 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   254987 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   127891 |  869 | `}` |
...
|        - |  881 | ` */` |
|    41264 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    41269 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       20 |  885 | `		return TRUE;` |
|    41251 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    41231 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    41231 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    41227 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27721 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22123 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
...
|      ! 0 |  906 | `		}` |
|    13511 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13511 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13511 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   623580 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   623585 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   621216 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1080 | ` */` |
| 28100541 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 28100546 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 28100546 | 1086 | `	pObj->pVm = pVm;` |
| 28100546 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 28100546 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 28100546 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5915758 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5915763 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5915763 | 1100 | `	pObj->pVm = pVm;` |
|  5915763 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5915763 | 1103 | `	pObj->x.iVal = iVal;` |
|  5915763 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5915763 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17502 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17507 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17507 | 1115 | `	pObj->pVm = pVm;` |
|    17507 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17507 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17507 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17507 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    63840 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    63845 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    63845 | 1145 | `	pObj->pVm = pVm;` |
|    63845 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    63845 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    63845 | 1149 | `	pObj->x.pOther = pArray;` |
|    63845 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4407744 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4407749 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4407749 | 1160 | `	pObj->pVm = pVm;` |
|  4407749 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4407749 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2130971 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1065483 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4407749 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4407749 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2697461 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2697466 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2697466 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2697466 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  6111442 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  6111447 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  6111447 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  6111447 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   220219 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6001340 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    10347 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     5171 | 1222 | `	}` |
|  6111447 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    82155 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  6070372 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8421 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4208 | 1227 | `	}` |
|  6111447 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6111447 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  6111447 | 1230 | `	rc = SXRET_OK;` |
|  6111447 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4318926 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4318926 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2159690 | 1234 | `	}else{` |
|  1792526 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   396062 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   198390 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  6111447 | 1239 | `	if( pMap ){` |
|    82155 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  6070372 | 1241 | `	}else if( pObj ){` |
|     8421 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4208 | 1243 | `	}` |
|  6111442 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3166788 | 1245 | `	 && pDest->pVm` |
|   220214 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   110116 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  6111447 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  9046483 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  9046488 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  9046488 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   549603 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8771689 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    49363 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    24679 | 1281 | `	}` |
|  9046488 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  9046488 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4675500 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2338809 | 1287 | `	}` |
|  9046488 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 21442035 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 21442040 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18665882 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   715891 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 18307939 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    92801 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    46398 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18665882 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18665882 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9337434 | 1305 | `	}` |
| 21442040 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1742290 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1742295 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   880602 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   880602 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   880602 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   200875 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   340012 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1541425 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1541420 | 1377 | `	if( !bStrict` |
|  1201705 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   431192 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1541425 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24731 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9303 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4649 | 1400 | `		}` |
|    24731 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8241 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4118 | 1403 | `		}` |
|    24731 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1516699 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       55 | 1417 | `		return rc;` |
|  1516645 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1430 | `		return rc;` |
|  1516373 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   905541 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   253479 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   126059 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   904443 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   904443 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   904443 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   904443 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   904443 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   904443 | 1465 | `		if( rc == 0 ){` |
|   294666 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19655 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9827 | 1468 | `			}` |
|   147332 | 1469 | `		}` |
|   904443 | 1470 | `		return rc;` |
|   610837 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   304981 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   611935 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   611935 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   611935 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   611623 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7603 | 1515 | `				return 1;` |
|   604025 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   592697 | 1517 | `				return -1;` |
|        - | 1518 | `			}` |
|    11333 | 1519 | `			return 0;` |
|        - | 1520 | `		}` |
|        - | 1521 | `	}` |
...
|      113 | 1728 | `}` |
|      642 | 1729 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|        - | 1737 | `	)` |
|        5 | 1738 | `{` |
|      647 | 1739 | `	sxi32 rc = SXRET_OK;` |
|        - | 1740 | `	int i;` |
|      647 | 1741 | `	if( !ShowType ){` |
...
|     4639 | 1757 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4107 | 1758 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2055 | 1759 | `	}` |
|      535 | 1760 | `	if( isRef ){` |
|        7 | 1761 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|        3 | 1762 | `	}` |
|      535 | 1763 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
...
|      139 | 1777 | `		return rc;` |
|        - | 1778 | `	}` |
|      399 | 1779 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|        5 | 1780 | `		SyBlobAppend(&(*pOut),"NULL\n",sizeof("NULL\n")-1);` |
|        5 | 1781 | `		return SXRET_OK;` |
|        - | 1782 | `	}` |
|      395 | 1783 | `	if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|       26 | 1784 | `		rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,TRUE,nTab,nDepth+1);` |
|       26 | 1785 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|       26 | 1786 | `		return rc;` |
|        - | 1787 | `	}` |
|      371 | 1788 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      164 | 1789 | `		if( pObj->x.iVal != 0 ){` |
|      112 | 1790 | `			SyBlobAppend(&(*pOut),"bool(true)\n",sizeof("bool(true)\n")-1);` |
|       58 | 1791 | `		}else{` |
|       55 | 1792 | `			SyBlobAppend(&(*pOut),"bool(false)\n",sizeof("bool(false)\n")-1);` |
|        - | 1793 | `		}` |
|      164 | 1794 | `		return SXRET_OK;` |
|        - | 1795 | `	}` |
|      209 | 1796 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - | 1803 | `	}` |
|      205 | 1804 | `	if( pObj->iFlags & MEMOBJ_INT ){` |
|      135 | 1805 | `		SyBlobFormat(&(*pOut),"int(%qd)",pObj->x.iVal);` |
|      135 | 1806 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|      135 | 1807 | `		return SXRET_OK;` |
|        - | 1808 | `	}` |
|       73 | 1809 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
|       73 | 1810 | `		SyBlobFormat(&(*pOut),"string(%u) \"",SyBlobLength(&pObj->sBlob));` |
|       73 | 1811 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|       67 | 1812 | `			SyBlobAppend(&(*pOut),SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|       32 | 1813 | `		}` |
|       73 | 1814 | `		SyBlobAppend(&(*pOut),"\"\n",sizeof("\"\n")-1);` |
|       73 | 1815 | `		return SXRET_OK;` |
|        - | 1816 | `	}` |
