...
|        - |   74 | ` */` |
|   124584 |   75 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |   76 |  |
|   124589 |   77 | `	sxi64 iVal = 0;` |
|   124589 |   78 | `	if( pVal->nByte <= 0 ){` |
|        7 |   79 | `		return 0;` |
|        - |   80 | `	}` |
|   124583 |   81 | `	if( pVal->zString[0] == '0' ){` |
|        - |   82 | `		sxi32 c;` |
|    51658 |   83 | `		if( pVal->nByte == sizeof(char) ){` |
|    51255 |   84 | `			return 0;` |
|        - |   85 | `		}` |
...
|    72930 |   99 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  100 | `	}` |
|    73333 |  101 | `	return iVal;` |
|    62297 |  102 |  |
|        - |  103 | `/*` |
...
|        - |  258 | ` */` |
|    55516 |  259 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  260 |  |
|    55521 |  261 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        3 |  273 | `		}` |
|    55373 |  274 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    54789 |  275 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  276 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    27833 |  277 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  327 | ` */` |
|    13676 |  328 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  329 |  |
|        - |  330 | `	sxi32 iFlags;` |
|    13681 |  331 | `	iFlags = pObj->iFlags;` |
|    13681 |  332 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  333 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  334 | `		return pObj->rVal ? 1 : 0;` |
|        - |  335 | `#else` |
|       12 |  336 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  337 | `#endif` |
|    13671 |  338 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      115 |  339 | `		return pObj->x.iVal ? 1 : 0;` |
|    13561 |  340 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|      ! 0 |  360 | `		}` |
|    13497 |  361 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    12463 |  362 | `		return 0;` |
...
|        - |  415 | ` */` |
|   387102 |  416 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  417 |  |
|   387107 |  418 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  446 | ` */` |
|    14458 |  447 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  448 |  |
|    14463 |  449 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  450 | `		/* Preform the conversion */` |
|    13681 |  451 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  452 | `		/* Invalidate any prior representations */` |
|    13681 |  453 | `		SyBlobRelease(&pObj->sBlob);` |
|    13681 |  454 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     6838 |  455 | `	}` |
|    14463 |  456 | `	return SXRET_OK;` |
|        5 |  457 |  |
|        - |  458 | `/*` |
|        - |  459 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  460 | ` */` |
|   769889 |  461 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  462 |  |
|   769894 |  463 | `	sxi32 rc = SXRET_OK;` |
|   769894 |  464 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  465 | `		/* Perform the conversion */` |
|    55299 |  466 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    55299 |  467 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    55299 |  468 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    27647 |  469 | `	}` |
|   769894 |  470 | `	return rc;` |
|        5 |  471 |  |
|        - |  472 | `/*` |
...
|        - |  633 | ` */` |
|   447738 |  634 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  635 |  |
|   447743 |  636 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      253 |  637 | `		return TRUE;` |
|   447495 |  638 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|       91 |  639 | `		return FALSE;` |
|   447409 |  640 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  641 | `		SyString sStr;` |
|        - |  642 | `		sxi32 rc;` |
|   447409 |  643 | `		SyStringInitFromBuf(&sStr,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|   447409 |  644 | `		if( sStr.nByte <= 0 ){` |
|        - |  645 | `			/* Empty string */` |
|       73 |  646 | `			return FALSE;` |
|        - |  647 | `		}` |
|        - |  648 | `		/* Check if the string representation looks like a numeric number */` |
|   447337 |  649 | `		rc = SyStrIsNumeric(sStr.zString,sStr.nByte,0,0);` |
|   447337 |  650 | `		return rc == SXRET_OK ? TRUE : FALSE;` |
|        - |  651 | `	}` |
|        - |  652 | `	/* NOT REACHED */` |
|      ! 0 |  653 | `	return FALSE;` |
|   223896 |  654 |  |
...
|        - |  666 | ` */` |
|    27254 |  667 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  668 |  |
|    27259 |  669 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       13 |  670 | `		return TRUE;` |
|    27249 |  671 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       18 |  672 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    27233 |  673 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  674 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    27233 |  675 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  676 | `		return !pObj->x.iVal;` |
|    27229 |  677 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27195 |  678 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22187 |  679 | `			return TRUE;` |
|      ! 0 |  680 | `		}else{` |
|        - |  681 | `			const char *zIn,*zEnd;` |
|     5013 |  682 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5013 |  683 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5019 |  684 | `			while( zIn < zEnd ){` |
|     5019 |  685 | `				if( zIn[0] != '0' ){` |
|     5013 |  686 | `					break;` |
|        - |  687 | `				}` |
|        7 |  688 | `				zIn++;` |
|        1 |  689 | `			}` |
|     5013 |  690 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  691 | `		}` |
...
|        - |  708 | ` */` |
|   420893 |  709 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  710 |  |
|   420898 |  711 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   420792 |  712 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - |  856 | ` */` |
|  7902165 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 |  858 |  |
|        - |  859 | `	/* Zero the structure */` |
|  7902170 |  860 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  861 | `	/* Initialize fields */` |
|  7902170 |  862 | `	pObj->pVm = pVm;` |
|  7902170 |  863 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  864 | `	/* Set the NULL type */` |
|  7902170 |  865 | `	pObj->iFlags = MEMOBJ_NULL;` |
|  7902170 |  866 | `	return SXRET_OK;` |
|        5 |  867 |  |
|        - |  868 | `/*` |
|        - |  869 | ` * Initialize a ph7_value to the integer type.` |
|        - |  870 | ` */` |
|   155542 |  871 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 |  872 |  |
|        - |  873 | `	/* Zero the structure */` |
|   155547 |  874 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  875 | `	/* Initialize fields */` |
|   155547 |  876 | `	pObj->pVm = pVm;` |
|   155547 |  877 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  878 | `	/* Set the desired type */` |
|   155547 |  879 | `	pObj->x.iVal = iVal;` |
|   155547 |  880 | `	pObj->iFlags = MEMOBJ_INT;` |
|   155547 |  881 | `	return SXRET_OK;` |
|        5 |  882 |  |
|        - |  883 | `/*` |
|        - |  884 | ` * Initialize a ph7_value to the boolean type.` |
|        - |  885 | ` */` |
|    17112 |  886 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 |  887 |  |
|        - |  888 | `	/* Zero the structure */` |
|    17117 |  889 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  890 | `	/* Initialize fields */` |
|    17117 |  891 | `	pObj->pVm = pVm;` |
|    17117 |  892 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  893 | `	/* Set the desired type */` |
|    17117 |  894 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17117 |  895 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17117 |  896 | `	return SXRET_OK;` |
|        5 |  897 |  |
|        - |  898 | `#if 0` |
|        - |  899 | `/*` |
...
|        - |  917 | ` */` |
|    45992 |  918 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 |  919 |  |
|        - |  920 | `	/* Zero the structure */` |
|    45997 |  921 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  922 | `	/* Initialize fields */` |
|    45997 |  923 | `	pObj->pVm = pVm;` |
|    45997 |  924 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  925 | `	/* Set the desired type */` |
|    45997 |  926 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    45997 |  927 | `	pObj->x.pOther = pArray;` |
|    45997 |  928 | `	return SXRET_OK;` |
|        5 |  929 |  |
|        - |  930 | `/*` |
|        - |  931 | ` * Initialize a ph7_value to the string type.` |
|        - |  932 | ` */` |
|   471204 |  933 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 |  934 |  |
|        - |  935 | `	/* Zero the structure */` |
|   471209 |  936 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  937 | `	/* Initialize fields */` |
|   471209 |  938 | `	pObj->pVm = pVm;` |
|   471209 |  939 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|   471209 |  940 | `	if( pVal ){` |
|        - |  941 | `		/* Append contents */` |
|   293301 |  942 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   146648 |  943 | `	}` |
|        - |  944 | `	/* Set the desired type */` |
|   471209 |  945 | `	pObj->iFlags = MEMOBJ_STRING;` |
|   471209 |  946 | `	return SXRET_OK;` |
|        5 |  947 |  |
|        - |  948 | `/*` |
...
|        - |  953 | ` */` |
|   341566 |  954 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 |  955 |  |
|        - |  956 | `	sxi32 rc;` |
|   341571 |  957 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  958 | `		/* Invalidate any prior representation */` |
|     1287 |  959 | `		PH7_MemObjRelease(pObj);` |
|     1287 |  960 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|      641 |  961 | `	}` |
|        - |  962 | `	/* Append contents */` |
|   341571 |  963 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|   341571 |  964 | `	return rc;` |
|        5 |  965 |  |
|        - |  966 | `#if 0` |
|        - |  967 | `/*` |
...
|        - |  988 | ` */` |
|  4557745 |  989 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 |  990 |  |
|  4557750 |  991 | `	ph7_class_instance *pObj = 0;` |
|  4557750 |  992 | `	ph7_hashmap *pMap = 0;` |
|        - |  993 | `	sxi32 rc;` |
|  4557750 |  994 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  995 | `		/* Increment reference count */` |
|   150579 |  996 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  4482463 |  997 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - |  998 | `		/* Increment reference count */` |
|     2395 |  999 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     1195 | 1000 | `	}` |
|  4557750 | 1001 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    44735 | 1002 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  4535385 | 1003 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     2833 | 1004 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     1414 | 1005 | `	}` |
|  4557750 | 1006 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  4557750 | 1007 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  4557750 | 1008 | `	rc = SXRET_OK;` |
|  4557750 | 1009 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3821415 | 1010 | `		SyBlobReset(&pDest->sBlob);` |
|  3821415 | 1011 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  1910710 | 1012 | `	}else{` |
|   736340 | 1013 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   268092 | 1014 | `			SyBlobRelease(&pDest->sBlob);` |
|   134086 | 1015 | `		}` |
|        - | 1016 | `	}` |
|  4557750 | 1017 | `	if( pMap ){` |
|    44735 | 1018 | `		PH7_HashmapUnref(pMap);` |
|  4535385 | 1019 | `	}else if( pObj ){` |
|     2833 | 1020 | `		PH7_ClassInstanceUnref(pObj);` |
|     1414 | 1021 | `	}` |
|  4557750 | 1022 | `	return rc;` |
|        5 | 1023 |  |
|        - | 1024 | `/*` |
|        - | 1025 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1026 | ` * buffer contents,simply point to it.` |
|        - | 1027 | ` */` |
|  6130440 | 1028 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1029 |  |
|  6130445 | 1030 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1031 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6130445 | 1032 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1033 | `		/* Increment reference count */` |
|   426309 | 1034 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5917293 | 1035 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1036 | `		/* Increment reference count */` |
|    13867 | 1037 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     6931 | 1038 | `	}` |
|  6130445 | 1039 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       32 | 1040 | `		SyBlobRelease(&pDest->sBlob);` |
|       14 | 1041 | `	}` |
|  6130445 | 1042 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3332251 | 1043 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1666230 | 1044 | `	}` |
|  6130445 | 1045 | `	return SXRET_OK;` |
|        5 | 1046 |  |
|        - | 1047 | `/*` |
|        - | 1048 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1049 | ` */` |
| 12214705 | 1050 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1051 |  |
| 12214710 | 1052 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 11162995 | 1053 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   538051 | 1054 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 10893972 | 1055 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    24389 | 1056 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    12192 | 1057 | `		}` |
|        - | 1058 | `		/* Release the internal buffer */` |
| 11162995 | 1059 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1060 | `		/* Invalidate any prior representation */` |
| 11162995 | 1061 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  5581853 | 1062 | `	}` |
| 12214710 | 1063 | `	return SXRET_OK;` |
|        5 | 1064 |  |
|        - | 1065 | `/*` |
...
|        - | 1117 | ` */` |
|  1190415 | 1118 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1119 |  |
|        - | 1120 | `	sxi32 iComb;` |
|        - | 1121 | `	sxi32 rc;` |
|  1190420 | 1122 | `	if( bStrict ){` |
|        - | 1123 | `		sxi32 iF1,iF2;` |
|        - | 1124 | `		/* Strict comparisons with === */` |
|   614425 | 1125 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   614425 | 1126 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   614425 | 1127 | `		if( iF1 != iF2 ){` |
|        - | 1128 | `			/* Not of the same type */` |
|   171895 | 1129 | `			return 1;` |
|        - | 1130 | `		}` |
|   221265 | 1131 | `	}` |
|        - | 1132 | `	/* Combine flag together */` |
|  1018530 | 1133 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1018530 | 1134 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1135 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    20557 | 1136 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7195 | 1137 | `			PH7_MemObjToBool(pObj1);` |
|     3595 | 1138 | `		}` |
|    20557 | 1139 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     6231 | 1140 | `			PH7_MemObjToBool(pObj2);` |
|     3113 | 1141 | `		}` |
|    20557 | 1142 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|   997978 | 1143 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       27 | 1155 | `		return rc;` |
|   997952 | 1156 | `	}else if(iComb & MEMOBJ_OBJ ){` |
|        - | 1157 | `		/* Object comparison */` |
|      227 | 1158 | `		if( (pObj1->iFlags & MEMOBJ_OBJ) == 0 ){` |
|        - | 1159 | `			/* Object is always greater */` |
|      ! 0 | 1160 | `			return -1;` |
|        - | 1161 | `		}` |
|      227 | 1162 | `		if( (pObj2->iFlags & MEMOBJ_OBJ) == 0 ){` |
|        - | 1163 | `			/* Object is always greater */` |
|      ! 0 | 1164 | `			return 1;` |
|        - | 1165 | `		}` |
|        - | 1166 | `		/* Perform the comparison */` |
|      227 | 1167 | `		rc = PH7_ClassInstanceCmp((ph7_class_instance *)pObj1->x.pOther,(ph7_class_instance *)pObj2->x.pOther,bStrict,iNest);` |
|      227 | 1168 | `		return rc;` |
|   997730 | 1169 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1170 | `		SyString s1,s2;` |
|   645733 | 1171 | `		if( !bStrict ){` |
|        - | 1172 | `			/*` |
...
|        - | 1178 | `			 */` |
|   223683 | 1179 | `			if( PH7_MemObjIsNumeric(pObj1) ){` |
|        - | 1180 | `				/* Perform a numeric comparison */` |
|       13 | 1181 | `				goto Numeric;` |
|        - | 1182 | `			}` |
|   223671 | 1183 | `			if( PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1184 | `				/* Perform a numeric comparison */` |
|      ! 0 | 1185 | `				goto Numeric;` |
|        - | 1186 | `			}` |
|   111844 | 1187 | `		}` |
|        - | 1188 | `		/* Perform a strict string comparison.*/` |
|   645721 | 1189 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1190 | `			PH7_MemObjToString(pObj1);` |
|      ! 0 | 1191 | `		}` |
|   645721 | 1192 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1193 | `			PH7_MemObjToString(pObj2);` |
|      ! 0 | 1194 | `		}` |
|   645721 | 1195 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   645721 | 1196 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1197 | `		/*` |
...
|        - | 1200 | `		 */` |
|   645721 | 1201 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   645721 | 1202 | `		if( rc == 0 ){` |
|   224840 | 1203 | `			if( s1.nByte != s2.nByte ){` |
|     1620 | 1204 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|      810 | 1205 | `			}` |
|   112420 | 1206 | `		}` |
|   645721 | 1207 | `		return rc;` |
|   352002 | 1208 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   175958 | 1209 | `Numeric:` |
|        - | 1210 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   352014 | 1211 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|        3 | 1212 | `			PH7_MemObjToNumeric(pObj1);` |
|        1 | 1213 | `		}` |
|   352014 | 1214 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1215 | `			PH7_MemObjToNumeric(pObj2);` |
|        5 | 1216 | `		}` |
|   352014 | 1217 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1218 | `			/*` |
...
|   351814 | 1251 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     2426 | 1252 | `				return 1;` |
|   349393 | 1253 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   345325 | 1254 | `				return -1;` |
|        - | 1255 | `			}` |
|     4073 | 1256 | `			return 0;` |
|        - | 1257 | `		}` |
|        - | 1258 | `	}` |
