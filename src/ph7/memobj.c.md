...
|      - |   23 | ` */` |
|   1092 |   24 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|      1 |   25 |  |
...
|   1093 |   41 | `  ph7_real r = pObj->rVal;` |
|   1093 |   42 | `  if( r<(ph7_real)minInt ){` |
|    ! 0 |   43 | `    return minInt;` |
|   1093 |   44 | `  }else if( r>(ph7_real)maxInt ){` |
...
|      - |   58 | ` */` |
| 169826 |   59 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|      1 |   60 |  |
| 169827 |   61 | `	sxi64 iVal = 0;` |
| 169827 |   62 | `	if( pVal->nByte <= 0 ){` |
|    ! 0 |   63 | `		return 0;` |
|      - |   64 | `	}` |
| 169827 |   65 | `	if( pVal->zString[0] == '0' ){` |
|      - |   66 | `		sxi32 c;` |
|  70080 |   67 | `		if( pVal->nByte == sizeof(char) ){` |
|  70015 |   68 | `			return 0;` |
|      - |   69 | `		}` |
|     66 |   70 | `		c = pVal->zString[1];` |
|     66 |   71 | `		if( c  == 'x' \|\| c == 'X' ){` |
|      - |   72 | `			/* Hex digit stream */` |
|     13 |   73 | `			SyHexStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|     60 |   74 | `		}else if( c == 'b' \|\| c == 'B' ){` |
|      - |   75 | `			/* Binary digit stream */` |
|     31 |   76 | `			SyBinaryStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|     16 |   77 | `		}else{` |
|      - |   78 | `			/* Octal digit stream */` |
|     24 |   79 | `			SyOctalStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|      - |   80 | `		}` |
|     34 |   81 | `	}else{` |
|      - |   82 | `		/* Decimal digit stream */` |
|  99748 |   83 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|      - |   84 | `	}` |
|  99813 |   85 | `	return iVal;` |
|  84914 |   86 |  |
|      - |   87 | `/*` |
...
|      - |   90 | ` * representation.` |
|      - |   91 | ` */` |
|    282 |   92 | `static sxi64 MemObjStringToInt(ph7_value *pObj)` |
|      1 |   93 |  |
|      - |   94 | `	SyString sVal;` |
|    283 |   95 | `	SyStringInitFromBuf(&sVal,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    283 |   96 | `	return PH7_TokenValueToInt64(&sVal);` |
|      1 |   97 |  |
|      - |   98 | `/*` |
...
|     87 |  113 | `	pMethod = PH7_ClassExtractMethod(pThis->pClass,zMethod,nLen);` |
|     87 |  114 | `	if( pMethod == 0 ){` |
|      - |  115 | `		/* No such method */` |
|      3 |  116 | `		return SXERR_NOTFOUND;` |
|      - |  117 | `	}` |
|      - |  118 | `	/* Invoke the desired method */` |
|     85 |  119 | `	PH7_VmCallClassMethod(&(*pVm),&(*pThis),pMethod,&(*pResult),0,0);` |
|      - |  120 | `	/* Method successfully called,pResult should hold the return value */` |
|     85 |  121 | `	return SXRET_OK;` |
|     44 |  122 |  |
|      - |  123 | `/*` |
...
|      - |  131 | ` */` |
|    322 |  132 | `static sxi64 MemObjIntValue(ph7_value *pObj)` |
|      1 |  133 |  |
|      - |  134 | `	sxi32 iFlags;` |
|    323 |  135 | `	iFlags = pObj->iFlags;` |
|    323 |  136 | `	if (iFlags & MEMOBJ_REAL ){` |
|     21 |  137 | `		return MemObjRealToInt(&(*pObj));` |
|    303 |  138 | `	}else if( iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|     17 |  139 | `		return pObj->x.iVal;` |
|    287 |  140 | `	}else if (iFlags & MEMOBJ_STRING) {` |
|    253 |  141 | `		return MemObjStringToInt(&(*pObj));` |
|     35 |  142 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|     23 |  143 | `		return 0;` |
...
|      - |  180 | ` */` |
|    576 |  181 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|      1 |  182 |  |
|      - |  183 | `	sxi32 iFlags;` |
|    577 |  184 | `	iFlags = pObj->iFlags;` |
|    577 |  185 | `	if( iFlags & MEMOBJ_REAL ){` |
|    ! 0 |  186 | `		return pObj->rVal;` |
|    577 |  187 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|    249 |  188 | `		return (ph7_real)pObj->x.iVal;` |
|    329 |  189 | `	}else if (iFlags & MEMOBJ_STRING){` |
|      - |  190 | `		SyString sString;` |
|      - |  191 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|      - |  192 | `		ph7_real rVal = 0;` |
|      - |  193 | `#else` |
|    321 |  194 | `		ph7_real rVal = 0.0;` |
|      - |  195 | `#endif` |
|    321 |  196 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|    321 |  197 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|      - |  198 | `			/* Convert as much as we can */` |
|      - |  199 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|      - |  200 | `			rVal = MemObjStringToInt(&(*pObj));` |
|      - |  201 | `#else` |
|    321 |  202 | `			SyStrToReal(sString.zString,sString.nByte,(void *)&rVal,0);` |
|      - |  203 | `#endif` |
|    160 |  204 | `		}` |
|    321 |  205 | `		return rVal;` |
...
|      - |  242 | ` */` |
|  51696 |  243 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|      1 |  244 |  |
|  51697 |  245 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|     99 |  246 | `		SyBlobFormat(&(*pOut),"%.15g",pObj->rVal);` |
|  51648 |  247 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|  51183 |  248 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|      - |  249 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|  26008 |  250 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|    133 |  251 | `		if( pObj->x.iVal ){` |
|     69 |  252 | `			SyBlobAppend(&(*pOut),"TRUE",sizeof("TRUE")-1);` |
|     35 |  253 | `		}else{` |
|     65 |  254 | `			if( !bStrictBool ){` |
|     57 |  255 | `				SyBlobAppend(&(*pOut),"FALSE",sizeof("FALSE")-1);` |
|     28 |  256 | `			}` |
|      1 |  257 | `		}` |
|    351 |  258 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|      5 |  259 | `		SyBlobAppend(&(*pOut),"Array",sizeof("Array")-1);` |
|      5 |  260 | `		PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
|    283 |  261 | `	}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|      - |  262 | `		ph7_value sResult;` |
|      - |  263 | `		sxi32 rc;` |
|      - |  264 | `		/* Invoke the __toString() method if available */` |
|     75 |  265 | `		PH7_MemObjInit(pObj->pVm,&sResult);` |
|     75 |  266 | `		rc = MemObjCallClassCastMethod(pObj->pVm,(ph7_class_instance *)pObj->x.pOther,` |
|      - |  267 | `			"__toString",sizeof("__toString")-1,&sResult);` |
|     75 |  268 | `		if( rc == SXRET_OK && (sResult.iFlags & MEMOBJ_STRING) && SyBlobLength(&sResult.sBlob) > 0){` |
|      - |  269 | `			/* Expand method return value */` |
|     69 |  270 | `			SyBlobDup(&sResult.sBlob,pOut);` |
|     35 |  271 | `		}else{` |
|      - |  272 | `			/* Expand "Object" as requested by the PHP language reference manual */` |
|      7 |  273 | `			SyBlobAppend(&(*pOut),"Object",sizeof("Object")-1);` |
|      - |  274 | `		}` |
|     75 |  275 | `		PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|     75 |  276 | `		PH7_MemObjRelease(&sResult);` |
|    244 |  277 | `	}else if(pObj->iFlags & MEMOBJ_RES ){` |
|      3 |  278 | `		SyBlobFormat(&(*pOut),"ResourceID_%#x",pObj->x.pOther);` |
|      1 |  279 | `	}` |
|  51697 |  280 | `	return SXRET_OK;` |
|      1 |  281 |  |
|      - |  282 | `/*` |
...
|      - |  293 | ` */` |
|    474 |  294 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|      1 |  295 |  |
|      - |  296 | `	sxi32 iFlags;` |
|    475 |  297 | `	iFlags = pObj->iFlags;` |
|    475 |  298 | `	if (iFlags & MEMOBJ_REAL ){` |
|      - |  299 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|      - |  300 | `		return pObj->rVal ? 1 : 0;` |
|      - |  301 | `#else` |
|    ! 0 |  302 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|      - |  303 | `#endif` |
|    475 |  304 | `	}else if( iFlags & MEMOBJ_INT ){` |
|     21 |  305 | `		return pObj->x.iVal ? 1 : 0;` |
|    455 |  306 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|    ! 0 |  326 | `		}` |
|    393 |  327 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    329 |  328 | `		return 0;` |
|     65 |  329 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|     51 |  334 | `	}else if( iFlags & MEMOBJ_OBJ ){` |
...
|      5 |  348 | `		return iVal;` |
|     47 |  349 | `	}else if(iFlags & MEMOBJ_RES ){` |
|     47 |  350 | `		return pObj->x.pOther != 0;` |
|      - |  351 | `	}` |
|      - |  352 | `	/* NOT REACHED */` |
|    ! 0 |  353 | `	return 0;` |
|    238 |  354 |  |
...
|      - |  357 | ` */` |
|   1072 |  358 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|      1 |  359 |  |
|   1073 |  360 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|      - |  372 | `  */` |
|   1072 |  373 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|    569 |  374 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|    569 |  375 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|    286 |  376 | `	}` |
|   1073 |  377 | `	return SXRET_OK;` |
|      1 |  378 |  |
|      - |  379 | `/*` |
|      - |  380 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|      - |  381 | ` */` |
|  21864 |  382 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|      1 |  383 |  |
|  21865 |  384 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
|      - |  385 | `		/* Preform the conversion */` |
|    323 |  386 | `		pObj->x.iVal = MemObjIntValue(&(*pObj));` |
|      - |  387 | `		/* Invalidate any prior representations */` |
|    323 |  388 | `		SyBlobRelease(&pObj->sBlob);` |
|    323 |  389 | `		MemObjSetType(pObj,MEMOBJ_INT);` |
|    161 |  390 | `	}` |
|  21865 |  391 | `	return SXRET_OK;` |
|      1 |  392 |  |
|      - |  393 | `/*` |
|      - |  394 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|      - |  395 | ` * Invalidate any prior representations` |
|      - |  396 | ` */` |
|    758 |  397 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|      1 |  398 |  |
|    759 |  399 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|      - |  400 | `		/* Preform the conversion */` |
|    577 |  401 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|      - |  402 | `		/* Invalidate any prior representations */` |
|    577 |  403 | `		SyBlobRelease(&pObj->sBlob);` |
|    577 |  404 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|      - |  405 | `		/* Try to get an integer representation */` |
|    577 |  406 | `		MemObjTryIntger(&(*pObj));` |
|    288 |  407 | `	}` |
|    759 |  408 | `	return SXRET_OK;` |
|      1 |  409 |  |
|      - |  410 | `/*` |
|      - |  411 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|      - |  412 | ` */` |
|    594 |  413 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|      1 |  414 |  |
|    595 |  415 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|      - |  416 | `		/* Preform the conversion */` |
|    475 |  417 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|      - |  418 | `		/* Invalidate any prior representations */` |
|    475 |  419 | `		SyBlobRelease(&pObj->sBlob);` |
|    475 |  420 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|    237 |  421 | `	}` |
|    595 |  422 | `	return SXRET_OK;` |
|      1 |  423 |  |
|      - |  424 | `/*` |
|      - |  425 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|      - |  426 | ` */` |
|  96970 |  427 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|      1 |  428 |  |
|  96971 |  429 | `	sxi32 rc = SXRET_OK;` |
|  96971 |  430 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|      - |  431 | `		/* Perform the conversion */` |
|  51445 |  432 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|  51445 |  433 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|  51445 |  434 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|  25722 |  435 | `	}` |
|  96971 |  436 | `	return rc;` |
|      1 |  437 |  |
|      - |  438 | `/*` |
...
|      - |  576 | ` */` |
|   1306 |  577 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|      1 |  578 |  |
|   1307 |  579 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|     25 |  580 | `		return TRUE;` |
|   1283 |  581 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      3 |  582 | `		return FALSE;` |
|   1281 |  583 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|      - |  584 | `		SyString sStr;` |
|      - |  585 | `		sxi32 rc;` |
|   1281 |  586 | `		SyStringInitFromBuf(&sStr,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|   1281 |  587 | `		if( sStr.nByte <= 0 ){` |
|      - |  588 | `			/* Empty string */` |
|    ! 0 |  589 | `			return FALSE;` |
|      - |  590 | `		}` |
|      - |  591 | `		/* Check if the string representation looks like a numeric number */` |
|   1281 |  592 | `		rc = SyStrIsNumeric(sStr.zString,sStr.nByte,0,0);` |
|   1281 |  593 | `		return rc == SXRET_OK ? TRUE : FALSE;` |
|      - |  594 | `	}` |
|      - |  595 | `	/* NOT REACHED */` |
|    ! 0 |  596 | `	return FALSE;` |
|    654 |  597 |  |
...
|      - |  609 | ` */` |
|     20 |  610 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|      1 |  611 |  |
|     21 |  612 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|      7 |  613 | `		return TRUE;` |
|     15 |  614 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    ! 0 |  615 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|     15 |  616 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|    ! 0 |  617 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|     15 |  618 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|    ! 0 |  619 | `		return !pObj->x.iVal;` |
|     15 |  620 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|      5 |  621 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    ! 0 |  622 | `			return TRUE;` |
|    ! 0 |  623 | `		}else{` |
|      - |  624 | `			const char *zIn,*zEnd;` |
|      5 |  625 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|      5 |  626 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|      5 |  627 | `			while( zIn < zEnd ){` |
|      5 |  628 | `				if( zIn[0] != '0' ){` |
|      5 |  629 | `					break;` |
|      - |  630 | `				}` |
|    ! 0 |  631 | `				zIn++;` |
|    ! 0 |  632 | `			}` |
|      5 |  633 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|    ! 0 |  634 | `		}` |
|     11 |  635 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     11 |  636 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     11 |  637 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|      - |  651 | ` */` |
|  60816 |  652 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|      1 |  653 |  |
|  60817 |  654 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|  60785 |  655 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|      - |  697 | ` */` |
|    472 |  698 | `PH7_PRIVATE sxi32 PH7_MemObjTryInteger(ph7_value *pObj)` |
|      1 |  699 |  |
|    473 |  700 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|      - |  701 | `		/* Work only with reals */` |
|    473 |  702 | `		MemObjTryIntger(&(*pObj));` |
|    236 |  703 | `	}` |
|    473 |  704 | `	return SXRET_OK;` |
|      1 |  705 |  |
|      - |  706 | `/*` |
|      - |  707 | ` * Initialize a ph7_value to the null type.` |
|      - |  708 | ` */` |
| 606358 |  709 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|      1 |  710 |  |
|      - |  711 | `	/* Zero the structure */` |
| 606359 |  712 | `	SyZero(pObj,sizeof(ph7_value));` |
|      - |  713 | `	/* Initialize fields */` |
| 606359 |  714 | `	pObj->pVm = pVm;` |
| 606359 |  715 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|      - |  716 | `	/* Set the NULL type */` |
| 606359 |  717 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 606359 |  718 | `	return SXRET_OK;` |
|      1 |  719 |  |
|      - |  720 | `/*` |
|      - |  721 | ` * Initialize a ph7_value to the integer type.` |
|      - |  722 | ` */` |
| 200534 |  723 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|      1 |  724 |  |
|      - |  725 | `	/* Zero the structure */` |
| 200535 |  726 | `	SyZero(pObj,sizeof(ph7_value));` |
|      - |  727 | `	/* Initialize fields */` |
| 200535 |  728 | `	pObj->pVm = pVm;` |
| 200535 |  729 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|      - |  730 | `	/* Set the desired type */` |
| 200535 |  731 | `	pObj->x.iVal = iVal;` |
| 200535 |  732 | `	pObj->iFlags = MEMOBJ_INT;` |
| 200535 |  733 | `	return SXRET_OK;` |
|      1 |  734 |  |
|      - |  735 | `/*` |
|      - |  736 | ` * Initialize a ph7_value to the boolean type.` |
|      - |  737 | ` */` |
|  10682 |  738 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|      1 |  739 |  |
|      - |  740 | `	/* Zero the structure */` |
|  10683 |  741 | `	SyZero(pObj,sizeof(ph7_value));` |
|      - |  742 | `	/* Initialize fields */` |
|  10683 |  743 | `	pObj->pVm = pVm;` |
|  10683 |  744 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|      - |  745 | `	/* Set the desired type */` |
|  10683 |  746 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|  10683 |  747 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|  10683 |  748 | `	return SXRET_OK;` |
|      1 |  749 |  |
|      - |  750 | `#if 0` |
|      - |  751 | `/*` |
...
|      - |  769 | ` */` |
|  56726 |  770 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|      1 |  771 |  |
|      - |  772 | `	/* Zero the structure */` |
|  56727 |  773 | `	SyZero(pObj,sizeof(ph7_value));` |
|      - |  774 | `	/* Initialize fields */` |
|  56727 |  775 | `	pObj->pVm = pVm;` |
|  56727 |  776 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|      - |  777 | `	/* Set the desired type */` |
|  56727 |  778 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|  56727 |  779 | `	pObj->x.pOther = pArray;` |
|  56727 |  780 | `	return SXRET_OK;` |
|      1 |  781 |  |
|      - |  782 | `/*` |
|      - |  783 | ` * Initialize a ph7_value to the string type.` |
|      - |  784 | ` */` |
| 433632 |  785 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|      1 |  786 |  |
|      - |  787 | `	/* Zero the structure */` |
| 433633 |  788 | `	SyZero(pObj,sizeof(ph7_value));` |
|      - |  789 | `	/* Initialize fields */` |
| 433633 |  790 | `	pObj->pVm = pVm;` |
| 433633 |  791 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
| 433633 |  792 | `	if( pVal ){` |
|      - |  793 | `		/* Append contents */` |
| 298723 |  794 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
| 149361 |  795 | `	}` |
|      - |  796 | `	/* Set the desired type */` |
| 433633 |  797 | `	pObj->iFlags = MEMOBJ_STRING;` |
| 433633 |  798 | `	return SXRET_OK;` |
|      1 |  799 |  |
|      - |  800 | `/*` |
...
|      - |  805 | ` */` |
| 194586 |  806 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|      1 |  807 |  |
|      - |  808 | `	sxi32 rc;` |
| 194587 |  809 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|      - |  810 | `		/* Invalidate any prior representation */` |
|      7 |  811 | `		PH7_MemObjRelease(pObj);` |
|      7 |  812 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|      3 |  813 | `	}` |
|      - |  814 | `	/* Append contents */` |
| 194587 |  815 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
| 194587 |  816 | `	return rc;` |
|      1 |  817 |  |
|      - |  818 | `#if 0` |
|      - |  819 | `/*` |
...
|      - |  840 | ` */` |
| 223666 |  841 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|      1 |  842 |  |
| 223667 |  843 | `	ph7_class_instance *pObj = 0;` |
| 223667 |  844 | `	ph7_hashmap *pMap = 0;` |
|      - |  845 | `	sxi32 rc;` |
| 223667 |  846 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|      - |  847 | `		/* Increment reference count */` |
|  74241 |  848 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
| 186547 |  849 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|      - |  850 | `		/* Increment reference count */` |
|   1117 |  851 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    558 |  852 | `	}` |
| 223667 |  853 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|   1135 |  854 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
| 223100 |  855 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|    623 |  856 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|    311 |  857 | `	}` |
| 223667 |  858 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
| 223667 |  859 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
| 223667 |  860 | `	rc = SXRET_OK;` |
| 223667 |  861 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
| 106843 |  862 | `		SyBlobReset(&pDest->sBlob);` |
| 106843 |  863 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  53422 |  864 | `	}else{` |
| 116825 |  865 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   6751 |  866 | `			SyBlobRelease(&pDest->sBlob);` |
|   3375 |  867 | `		}` |
|      - |  868 | `	}` |
| 223667 |  869 | `	if( pMap ){` |
|   1135 |  870 | `		PH7_HashmapUnref(pMap);` |
| 223100 |  871 | `	}else if( pObj ){` |
|    623 |  872 | `		PH7_ClassInstanceUnref(pObj);` |
|    311 |  873 | `	}` |
| 223667 |  874 | `	return rc;` |
|      1 |  875 |  |
|      - |  876 | `/*` |
|      - |  877 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|      - |  878 | ` * buffer contents,simply point to it.` |
|      - |  879 | ` */` |
| 492466 |  880 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|      1 |  881 |  |
| 492467 |  882 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|      - |  883 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
| 492467 |  884 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|      - |  885 | `		/* Increment reference count */` |
|  61079 |  886 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
| 461928 |  887 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|      - |  888 | `		/* Increment reference count */` |
|   1925 |  889 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    962 |  890 | `	}` |
| 492467 |  891 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|     17 |  892 | `		SyBlobRelease(&pDest->sBlob);` |
|      8 |  893 | `	}` |
| 492467 |  894 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
| 150247 |  895 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  75123 |  896 | `	}` |
| 492467 |  897 | `	return SXRET_OK;` |
|      1 |  898 |  |
|      - |  899 | `/*` |
|      - |  900 | ` * Invalidate any prior representation of a given ph7_value.` |
|      - |  901 | ` */` |
| 722268 |  902 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|      1 |  903 |  |
| 722269 |  904 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 677905 |  905 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
| 109473 |  906 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 623169 |  907 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|   2893 |  908 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|   1446 |  909 | `		}` |
|      - |  910 | `		/* Release the internal buffer */` |
| 677905 |  911 | `		SyBlobRelease(&pObj->sBlob);` |
|      - |  912 | `		/* Invalidate any prior representation */` |
| 677905 |  913 | `		pObj->iFlags = MEMOBJ_NULL;` |
| 338953 |  914 | `	}` |
| 722269 |  915 | `	return SXRET_OK;` |
|      1 |  916 |  |
|      - |  917 | `/*` |
...
|      - |  969 | ` */` |
|  58661 |  970 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|      1 |  971 |  |
|      - |  972 | `	sxi32 iComb;` |
|      - |  973 | `	sxi32 rc;` |
|  58662 |  974 | `	if( bStrict ){` |
|      - |  975 | `		sxi32 iF1,iF2;` |
|      - |  976 | `		/* Strict comparisons with === */` |
|   3193 |  977 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   3193 |  978 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   3193 |  979 | `		if( iF1 != iF2 ){` |
...
|  58502 |  985 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  58502 |  986 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|      - |  987 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    431 |  988 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|    183 |  989 | `			PH7_MemObjToBool(pObj1);` |
|     91 |  990 | `		}` |
|    431 |  991 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|    183 |  992 | `			PH7_MemObjToBool(pObj2);` |
|     91 |  993 | `		}` |
|    431 |  994 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  58072 |  995 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|      7 | 1007 | `		return rc;` |
|  58066 | 1008 | `	}else if(iComb & MEMOBJ_OBJ ){` |
|      - | 1009 | `		/* Object comparison */` |
|    161 | 1010 | `		if( (pObj1->iFlags & MEMOBJ_OBJ) == 0 ){` |
|      - | 1011 | `			/* Object is always greater */` |
|    ! 0 | 1012 | `			return -1;` |
|      - | 1013 | `		}` |
|    161 | 1014 | `		if( (pObj2->iFlags & MEMOBJ_OBJ) == 0 ){` |
|      - | 1015 | `			/* Object is always greater */` |
|    ! 0 | 1016 | `			return 1;` |
|      - | 1017 | `		}` |
|      - | 1018 | `		/* Perform the comparison */` |
|    161 | 1019 | `		rc = PH7_ClassInstanceCmp((ph7_class_instance *)pObj1->x.pOther,(ph7_class_instance *)pObj2->x.pOther,bStrict,iNest);` |
|    161 | 1020 | `		return rc;` |
|  57906 | 1021 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|      - | 1022 | `		SyString s1,s2;` |
|   2915 | 1023 | `		if( !bStrict ){` |
|      - | 1024 | `			/*` |
...
|      - | 1030 | `			 */` |
|    641 | 1031 | `			if( PH7_MemObjIsNumeric(pObj1) ){` |
|      - | 1032 | `				/* Perform a numeric comparison */` |
|      9 | 1033 | `				goto Numeric;` |
|      - | 1034 | `			}` |
|    633 | 1035 | `			if( PH7_MemObjIsNumeric(pObj2) ){` |
|      - | 1036 | `				/* Perform a numeric comparison */` |
|    ! 0 | 1037 | `				goto Numeric;` |
|      - | 1038 | `			}` |
|    316 | 1039 | `		}` |
|      - | 1040 | `		/* Perform a strict string comparison.*/` |
|   2907 | 1041 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|    ! 0 | 1042 | `			PH7_MemObjToString(pObj1);` |
|    ! 0 | 1043 | `		}` |
|   2907 | 1044 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|    ! 0 | 1045 | `			PH7_MemObjToString(pObj2);` |
|    ! 0 | 1046 | `		}` |
|   2907 | 1047 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   2907 | 1048 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|      - | 1049 | `		/*` |
...
|      - | 1052 | `		 */` |
|   2907 | 1053 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   2907 | 1054 | `		if( rc == 0 ){` |
|   2297 | 1055 | `			if( s1.nByte != s2.nByte ){` |
|    ! 0 | 1056 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|    ! 0 | 1057 | `			}` |
|   1148 | 1058 | `		}` |
|   2907 | 1059 | `		return rc;` |
|  54992 | 1060 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|  27495 | 1061 | `Numeric:` |
|      - | 1062 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|  55000 | 1063 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|      7 | 1064 | `			PH7_MemObjToNumeric(pObj1);` |
|      3 | 1065 | `		}` |
|  55000 | 1066 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|      7 | 1067 | `			PH7_MemObjToNumeric(pObj2);` |
|      3 | 1068 | `		}` |
|  55000 | 1069 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|      - | 1070 | `			/*` |
...
|  54904 | 1092 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|    933 | 1093 | `				return 1;` |
|  53972 | 1094 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|  53126 | 1095 | `				return -1;` |
|      - | 1096 | `			}` |
|    847 | 1097 | `			return 0;` |
|      - | 1098 | `		}` |
...
|      - | 1114 | ` */` |
|   1812 | 1115 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|      1 | 1116 |  |
|   1813 | 1117 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
|      - | 1118 | `			/* Arithemtic operation */` |
|   1809 | 1119 | `			PH7_MemObjToNumeric(pObj1);` |
|   1809 | 1120 | `			PH7_MemObjToNumeric(pObj2);` |
|   1809 | 1121 | `			if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_REAL ){` |
...
|      - | 1138 | `				sxi64 a,b;` |
|   1785 | 1139 | `				a = pObj1->x.iVal;` |
|   1785 | 1140 | `				b = pObj2->x.iVal;` |
|   1785 | 1141 | `				pObj1->x.iVal = a+b;` |
|   1785 | 1142 | `				MemObjSetType(pObj1,MEMOBJ_INT);` |
|      - | 1143 | `			}` |
|    905 | 1144 | `	}else{` |
|      5 | 1145 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
...
|      5 | 1163 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|      5 | 1164 | `				if( pMap == 0){` |
...
|      - | 1168 | `			}` |
|      5 | 1169 | `			if( !bAddStore ){` |
|      5 | 1170 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|      - | 1171 | `					/* Perform a hashmap duplication */` |
|      5 | 1172 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|      3 | 1173 | `				}else{` |
...
|      5 | 1181 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|      5 | 1182 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|      3 | 1183 | `			}else{` |
...
|      5 | 1190 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|    ! 0 | 1191 | `				SyBlobRelease(&pObj1->sBlob);` |
|    ! 0 | 1192 | `			}` |
|      5 | 1193 | `			pObj1->x.pOther = pMap;` |
|      5 | 1194 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|      2 | 1195 | `		}` |
|      - | 1196 | `	}` |
|   1813 | 1197 | `	return SXRET_OK;` |
|    907 | 1198 |  |
|      - | 1199 | `/*` |
|      - | 1200 | ` * Return a printable representation of the type of a given` |
|      - | 1201 | ` * ph7_value.` |
|      - | 1202 | ` */` |
|    450 | 1203 | `PH7_PRIVATE const char * PH7_MemObjTypeDump(ph7_value *pVal)` |
|      1 | 1204 |  |
|    451 | 1205 | `	const char *zType = "";` |
|    451 | 1206 | `	if( pVal->iFlags & MEMOBJ_NULL ){` |
|     15 | 1207 | `		zType = "null";` |
|    444 | 1208 | `	}else if( pVal->iFlags & MEMOBJ_INT ){` |
|    107 | 1209 | `		zType = "int";` |
|    384 | 1210 | `	}else if( pVal->iFlags & MEMOBJ_REAL ){` |
|      3 | 1211 | `		zType = "float";` |
|    330 | 1212 | `	}else if( pVal->iFlags & MEMOBJ_STRING ){` |
|     53 | 1213 | `		zType = "string";` |
|    303 | 1214 | `	}else if( pVal->iFlags & MEMOBJ_BOOL ){` |
|    125 | 1215 | `		zType = "bool";` |
|    215 | 1216 | `	}else if( pVal->iFlags & MEMOBJ_HASHMAP ){` |
|     23 | 1217 | `		zType = "array";` |
|    142 | 1218 | `	}else if( pVal->iFlags & MEMOBJ_OBJ ){` |
|    131 | 1219 | `		zType = "object";` |
|     65 | 1220 | `	}else if( pVal->iFlags & MEMOBJ_RES ){` |
|    ! 0 | 1221 | `		zType = "resource";` |
|    ! 0 | 1222 | `	}` |
|    451 | 1223 | `	return zType;` |
|      1 | 1224 |  |
|      - | 1225 | `/*` |
|      - | 1226 | ` * Dump a ph7_value [i.e: get a printable representation of it's type and contents.].` |
|      - | 1227 | ` * Store the dump in the given blob.` |
|      - | 1228 | ` */` |
|    522 | 1229 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|      - | 1236 | `	)` |
|      1 | 1237 |  |
|    523 | 1238 | `	sxi32 rc = SXRET_OK;` |
|      - | 1239 | `	const char *zType;` |
|      - | 1240 | `	int i;` |
|   4735 | 1241 | `	for( i = 0 ; i < nTab ; i++ ){` |
|   4213 | 1242 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|   2107 | 1243 | `	}` |
|    523 | 1244 | `	if( ShowType ){` |
|    425 | 1245 | `		if( isRef ){` |
|    ! 0 | 1246 | `			SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|    ! 0 | 1247 | `		}` |
|      - | 1248 | `		/* Get value type first */` |
|    425 | 1249 | `		zType = PH7_MemObjTypeDump(pObj);` |
|    425 | 1250 | `		SyBlobAppend(&(*pOut),zType,SyStrlen(zType));` |
|    212 | 1251 | `	}` |
|    523 | 1252 | `	if((pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|    513 | 1253 | `		if ( ShowType ){` |
|    415 | 1254 | `			SyBlobAppend(&(*pOut),"(",sizeof(char));` |
|    207 | 1255 | `		}` |
|    513 | 1256 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|      - | 1257 | `			/* Dump hashmap entries */` |
|     33 | 1258 | `			rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,ShowType,nTab+1,nDepth+1);` |
|    497 | 1259 | `		}else if(pObj->iFlags & MEMOBJ_OBJ ){` |
...
|     67 | 1262 | `		}else{` |
|    349 | 1263 | `			SyBlob *pContents = &pObj->sBlob;` |
|      - | 1264 | `			/* Get a printable representation of the contents */` |
|    349 | 1265 | `			if((pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|    253 | 1266 | `				MemObjStringValue(&(*pOut),&(*pObj),FALSE);` |
|    127 | 1267 | `			}else{` |
|      - | 1268 | `				/* Append length first */` |
|     97 | 1269 | `				if( ShowType ){` |
|     39 | 1270 | `					SyBlobFormat(&(*pOut),"%u '",SyBlobLength(&pObj->sBlob));` |
|     19 | 1271 | `				}` |
|     97 | 1272 | `				if( SyBlobLength(pContents) > 0 ){` |
|     85 | 1273 | `					SyBlobAppend(&(*pOut),SyBlobData(pContents),SyBlobLength(pContents));` |
|     42 | 1274 | `				}` |
|     97 | 1275 | `				if( ShowType ){` |
|     39 | 1276 | `					SyBlobAppend(&(*pOut),"'",sizeof(char));` |
|     19 | 1277 | `				}` |
|      - | 1278 | `			}` |
|      - | 1279 | `		}` |
|    513 | 1280 | `		if( ShowType ){` |
|    415 | 1281 | `			if( (pObj->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ)) == 0 ){` |
|    269 | 1282 | `				SyBlobAppend(&(*pOut),")",sizeof(char));` |
|    134 | 1283 | `			}` |
|    207 | 1284 | `		}` |
|    256 | 1285 | `	}` |
|      - | 1286 | `#ifdef __WINNT__` |
|      1 | 1287 | `	SyBlobAppend(&(*pOut),"\r\n",sizeof("\r\n")-1);` |
|      - | 1288 | `#else` |
|    522 | 1289 | `	SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|      - | 1290 | `#endif` |
|    523 | 1291 | `	return rc;` |
|      1 | 1292 |  |
|      - | 1293 |  |
