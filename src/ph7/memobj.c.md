...
|       43 |   73 | `	if( ph7_value_is_object(pVal) ) return "object";` |
...
|     3042 |  111 | `  ph7_real r = pObj->rVal;` |
|     3042 |  112 | `  if( r<(ph7_real)minInt ){` |
|        3 |  113 | `    return minInt;` |
|     3040 |  114 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  128 | ` */` |
|  2801634 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  2801639 |  131 | `	sxi64 iVal = 0;` |
|  2801639 |  132 | `	if( pVal->nByte <= 0 ){` |
|      137 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  2801503 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1060248 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1059791 |  138 | `			return 0;` |
|        - |  139 | `		}` |
...
|  1741260 |  153 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  154 | `	}` |
|  1741717 |  155 | `	return iVal;` |
|  1400822 |  156 | `}` |
|        - |  157 | `/*` |
...
|        4 |  252 | `{` |
|        - |  253 | `	sxi32 iFlags;` |
|     1806 |  254 | `	iFlags = pObj->iFlags;` |
|     1806 |  255 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  256 | `		return pObj->rVal;` |
|     1806 |  257 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
...
|        - |  371 | ` */` |
|    58754 |  372 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  373 | `{` |
|    58759 |  374 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  401 | `#endif` |
|        3 |  402 | `		}` |
|    58569 |  403 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    57813 |  404 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  405 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    29475 |  406 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  459 | ` */` |
|    17680 |  460 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  461 | `{` |
|        - |  462 | `	sxi32 iFlags;` |
|    17685 |  463 | `	iFlags = pObj->iFlags;` |
|    17685 |  464 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  465 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  466 | `		return pObj->rVal ? 1 : 0;` |
|        - |  467 | `#else` |
|       14 |  468 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  469 | `#endif` |
|    17673 |  470 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      801 |  471 | `		return pObj->x.iVal ? 1 : 0;` |
|    16877 |  472 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  481 | `		}` |
|       88 |  482 | `		return 1;` |
|    16769 |  483 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    15539 |  484 | `		return 0;` |
|     1235 |  485 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|     1215 |  490 | `	}else if( iFlags & MEMOBJ_OBJ ){` |
...
|      173 |  504 | `		return iVal;` |
|     1043 |  505 | `	}else if(iFlags & MEMOBJ_RES ){` |
|     1043 |  506 | `		return pObj->x.pOther != 0;` |
|        - |  507 | `	}` |
|        - |  508 | `	/* NOT REACHED */` |
|      ! 0 |  509 | `	return 0;` |
|     8845 |  510 | `}` |
...
|        4 |  515 | `{` |
|     3002 |  516 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|     1570 |  530 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     1554 |  531 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|      777 |  532 | `	}` |
|     3002 |  533 | `	return SXRET_OK;` |
|        4 |  534 | `}` |
|        - |  535 | `/*` |
|        - |  536 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  537 | ` */` |
|   453988 |  538 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  539 | `{` |
|   453993 |  540 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|      445 |  546 | `	}` |
|   453993 |  547 | `	return SXRET_OK;` |
|        5 |  548 | `}` |
|        - |  549 | `/*` |
|        - |  550 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  551 | ` * Invalidate any prior representations` |
|        - |  552 | ` */` |
|     2716 |  553 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        4 |  554 | `{` |
|     2720 |  555 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  556 | `		/* Preform the conversion */` |
|     1806 |  557 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  558 | `		/* Invalidate any prior representations */` |
|     1806 |  559 | `		SyBlobRelease(&pObj->sBlob);` |
|     1806 |  560 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  561 | `		/* Try to get an integer representation */` |
|     1806 |  562 | `		MemObjTryIntger(&(*pObj));` |
|      901 |  563 | `	}` |
|     2720 |  564 | `	return SXRET_OK;` |
|        4 |  565 | `}` |
|        - |  566 | `/*` |
|        - |  567 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  568 | ` */` |
|    20532 |  569 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  570 | `{` |
|    20537 |  571 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  572 | `		/* Preform the conversion */` |
|    17685 |  573 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  574 | `		/* Invalidate any prior representations */` |
|    17685 |  575 | `		SyBlobRelease(&pObj->sBlob);` |
|    17685 |  576 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     8840 |  577 | `	}` |
|    20537 |  578 | `	return SXRET_OK;` |
|        5 |  579 | `}` |
|        - |  580 | `/*` |
|        - |  581 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  582 | ` */` |
|   872849 |  583 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  584 | `{` |
|   872854 |  585 | `	sxi32 rc = SXRET_OK;` |
|   872854 |  586 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  587 | `		/* Perform the conversion */` |
|    58665 |  588 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    58665 |  589 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    58665 |  590 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    29330 |  591 | `	}` |
|   872854 |  592 | `	return rc;` |
|        5 |  593 | `}` |
|        - |  594 | `/*` |
...
|        - |  764 | ` */` |
|   236736 |  765 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  766 | `{` |
|        - |  767 | `	const char *z, *zEnd;` |
|        - |  768 | `	sxu32 n;` |
|   236741 |  769 | `	int bDigit = 0;` |
|   236741 |  770 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  771 | `		return 0;` |
|        - |  772 | `	}` |
|   236741 |  773 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   236741 |  774 | `	n = SyBlobLength(&pValue->sBlob);` |
|   236741 |  775 | `	if( n == 0 ){` |
|       68 |  776 | `		return 0;` |
|        - |  777 | `	}` |
|   236675 |  778 | `	zEnd = z + n;` |
|   236681 |  779 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|        8 |  780 | `		z++;` |
|        2 |  781 | `	}` |
|   236675 |  782 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|       53 |  783 | `		z++;` |
|       24 |  784 | `	}` |
|   236855 |  785 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|      183 |  786 | `		z++; bDigit = 1;` |
|        3 |  787 | `	}` |
|   236675 |  788 | `	if( z < zEnd && z[0] == '.' ){` |
|       43 |  789 | `		z++;` |
...
|        - |  821 | ` */` |
|   237502 |  822 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  823 | `{` |
|   237507 |  824 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      547 |  825 | `		return TRUE;` |
|   236965 |  826 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      321 |  827 | `		return FALSE;` |
|   236649 |  828 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  829 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   236649 |  830 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  831 | `	}` |
|        - |  832 | `	/* NOT REACHED */` |
|      ! 0 |  833 | `	return FALSE;` |
|   118717 |  834 | `}` |
...
|        - |  846 | ` */` |
|    34124 |  847 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  848 | `{` |
|    34129 |  849 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  850 | `		return TRUE;` |
|    34113 |  851 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  852 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    34093 |  853 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  854 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    34093 |  855 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  856 | `		return !pObj->x.iVal;` |
|    34089 |  857 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27553 |  858 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22089 |  859 | `			return TRUE;` |
|      ! 0 |  860 | `		}else{` |
...
|        - |  888 | ` */` |
|   475719 |  889 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  890 | `{` |
|   475724 |  891 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   475568 |  892 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1050 | ` */` |
| 12566467 | 1051 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1052 | `{` |
|        - | 1053 | `	/* Zero the structure */` |
| 12566472 | 1054 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1055 | `	/* Initialize fields */` |
| 12566472 | 1056 | `	pObj->pVm = pVm;` |
| 12566472 | 1057 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1058 | `	/* Set the NULL type */` |
| 12566472 | 1059 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 12566472 | 1060 | `	return SXRET_OK;` |
|        5 | 1061 | `}` |
|        - | 1062 | `/*` |
|        - | 1063 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1064 | ` */` |
|  4951584 | 1065 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1066 | `{` |
|        - | 1067 | `	/* Zero the structure */` |
|  4951589 | 1068 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1069 | `	/* Initialize fields */` |
|  4951589 | 1070 | `	pObj->pVm = pVm;` |
|  4951589 | 1071 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1072 | `	/* Set the desired type */` |
|  4951589 | 1073 | `	pObj->x.iVal = iVal;` |
|  4951589 | 1074 | `	pObj->iFlags = MEMOBJ_INT;` |
|  4951589 | 1075 | `	return SXRET_OK;` |
|        5 | 1076 | `}` |
|        - | 1077 | `/*` |
|        - | 1078 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1079 | ` */` |
|    17492 | 1080 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1081 | `{` |
|        - | 1082 | `	/* Zero the structure */` |
|    17497 | 1083 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1084 | `	/* Initialize fields */` |
|    17497 | 1085 | `	pObj->pVm = pVm;` |
|    17497 | 1086 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1087 | `	/* Set the desired type */` |
|    17497 | 1088 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17497 | 1089 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17497 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
...
|        - | 1109 | ` */` |
|    75894 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    75899 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    75899 | 1115 | `	pObj->pVm = pVm;` |
|    75899 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    75899 | 1118 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    75899 | 1119 | `	pObj->x.pOther = pArray;` |
|    75899 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
|        - | 1123 | ` * Initialize a ph7_value to the string type.` |
|        - | 1124 | ` */` |
|  3902020 | 1125 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1126 | `{` |
|        - | 1127 | `	/* Zero the structure */` |
|  3902025 | 1128 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1129 | `	/* Initialize fields */` |
|  3902025 | 1130 | `	pObj->pVm = pVm;` |
|  3902025 | 1131 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  3902025 | 1132 | `	if( pVal ){` |
|        - | 1133 | `		/* Append contents */` |
|  1822345 | 1134 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   911170 | 1135 | `	}` |
|        - | 1136 | `	/* Set the desired type */` |
|  3902025 | 1137 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  3902025 | 1138 | `	return SXRET_OK;` |
|        5 | 1139 | `}` |
|        - | 1140 | `/*` |
...
|        - | 1145 | ` */` |
|  2444798 | 1146 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1147 | `{` |
|        - | 1148 | `	sxi32 rc;` |
|  2444803 | 1149 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2444803 | 1155 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2444803 | 1156 | `	return rc;` |
|        5 | 1157 | `}` |
|        - | 1158 | `#if 0` |
|        - | 1159 | `/*` |
...
|        - | 1180 | ` */` |
|  5167367 | 1181 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1182 | `{` |
|  5167372 | 1183 | `	ph7_class_instance *pObj = 0;` |
|  5167372 | 1184 | `	ph7_hashmap *pMap = 0;` |
|        - | 1185 | `	sxi32 rc;` |
|  5167372 | 1186 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1187 | `		/* Increment reference count */` |
|   219511 | 1188 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5057619 | 1189 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1190 | `		/* Increment reference count */` |
|     9027 | 1191 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4511 | 1192 | `	}` |
|  5167372 | 1193 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    66311 | 1194 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5134219 | 1195 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8989 | 1196 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4492 | 1197 | `	}` |
|  5167372 | 1198 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5167372 | 1199 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5167372 | 1200 | `	rc = SXRET_OK;` |
|  5167372 | 1201 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4086261 | 1202 | `		SyBlobReset(&pDest->sBlob);` |
|  4086261 | 1203 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2043133 | 1204 | `	}else{` |
|  1081116 | 1205 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   294452 | 1206 | `			SyBlobRelease(&pDest->sBlob);` |
|   147266 | 1207 | `		}` |
|        - | 1208 | `	}` |
|  5167372 | 1209 | `	if( pMap ){` |
|    66311 | 1210 | `		PH7_HashmapUnref(pMap);` |
|  5134219 | 1211 | `	}else if( pObj ){` |
|     8989 | 1212 | `		PH7_ClassInstanceUnref(pObj);` |
|     4492 | 1213 | `	}` |
|  5167367 | 1214 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2693479 | 1215 | `	 && pDest->pVm` |
|   219506 | 1216 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109762 | 1220 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1233 | `		}` |
|        4 | 1234 | `	}` |
|  5167372 | 1235 | `	return rc;` |
|        5 | 1236 | `}` |
|        - | 1237 | `/*` |
|        - | 1238 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1239 | ` * buffer contents,simply point to it.` |
|        - | 1240 | ` */` |
|  7255806 | 1241 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1242 | `{` |
|  7255811 | 1243 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1244 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  7255811 | 1245 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1246 | `		/* Increment reference count */` |
|   505811 | 1247 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  7002908 | 1248 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1249 | `		/* Increment reference count */` |
|    52807 | 1250 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    26401 | 1251 | `	}` |
|  7255811 | 1252 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       48 | 1253 | `		SyBlobRelease(&pDest->sBlob);` |
|       22 | 1254 | `	}` |
|  7255811 | 1255 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3885247 | 1256 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1942628 | 1257 | `	}` |
|  7255811 | 1258 | `	return SXRET_OK;` |
|        5 | 1259 | `}` |
|        - | 1260 | `/*` |
|        - | 1261 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1262 | ` */` |
| 17757691 | 1263 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1264 | `{` |
| 17757696 | 1265 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 15313805 | 1266 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   698203 | 1267 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 14964706 | 1268 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    90475 | 1269 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    45235 | 1270 | `		}` |
|        - | 1271 | `		/* Release the internal buffer */` |
| 15313805 | 1272 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1273 | `		/* Invalidate any prior representation */` |
| 15313805 | 1274 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  7657160 | 1275 | `	}` |
| 17757696 | 1276 | `	return SXRET_OK;` |
|        5 | 1277 | `}` |
|        - | 1278 | `/*` |
...
|        - | 1330 | ` */` |
|  1361461 | 1331 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1332 | `{` |
|        - | 1333 | `	sxi32 iComb;` |
|        - | 1334 | `	sxi32 rc;` |
|  1361466 | 1335 | `	if( bStrict ){` |
|        - | 1336 | `		sxi32 iF1,iF2;` |
|        - | 1337 | `		/* Strict comparisons with === */` |
|   717694 | 1338 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   717694 | 1339 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   717694 | 1340 | `		if( iF1 != iF2 ){` |
|        - | 1341 | `			/* Not of the same type */` |
|   200709 | 1342 | `			return 1;` |
|        - | 1343 | `		}` |
|   258493 | 1344 | `	}` |
|        - | 1345 | `	/* Combine flag together */` |
|  1160762 | 1346 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1160757 | 1347 | `	if( !bStrict` |
|   902265 | 1348 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   321926 | 1349 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1365 | `	}` |
|  1160762 | 1366 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1367 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    23511 | 1368 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8773 | 1369 | `			PH7_MemObjToBool(pObj1);` |
|     4384 | 1370 | `		}` |
|    23511 | 1371 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7779 | 1372 | `			PH7_MemObjToBool(pObj2);` |
|     3887 | 1373 | `		}` |
|    23511 | 1374 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1137256 | 1375 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1387 | `		return rc;` |
|  1137226 | 1388 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      265 | 1400 | `		return rc;` |
|  1136966 | 1401 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1402 | `		SyString s1,s2;` |
|   727733 | 1403 | `		if( !bStrict ){` |
|        - | 1404 | `			/*` |
...
|        - | 1415 | `			 */` |
|   236321 | 1416 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1417 | `				/* Perform a numeric comparison */` |
|       29 | 1418 | `				goto Numeric;` |
|        - | 1419 | `			}` |
|   118105 | 1420 | `		}` |
|        - | 1421 | `		/* Perform a strict string comparison.*/` |
|   727705 | 1422 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1423 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1424 | `		}` |
|   727705 | 1425 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1426 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1427 | `		}` |
|   727705 | 1428 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   727705 | 1429 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1430 | `		/*` |
...
|        - | 1433 | `		 */` |
|   727705 | 1434 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   727705 | 1435 | `		if( rc == 0 ){` |
|   241145 | 1436 | `			if( s1.nByte != s2.nByte ){` |
|     2329 | 1437 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     1164 | 1438 | `			}` |
|   120572 | 1439 | `		}` |
|   727705 | 1440 | `		return rc;` |
|   409238 | 1441 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   204575 | 1442 | `Numeric:` |
|        - | 1443 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   409266 | 1444 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1445 | `			PH7_MemObjToNumeric(pObj1);` |
|        5 | 1446 | `		}` |
|   409266 | 1447 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       19 | 1448 | `			PH7_MemObjToNumeric(pObj2);` |
|        9 | 1449 | `		}` |
|   409266 | 1450 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1451 | `			/*` |
...
|   408992 | 1484 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     6736 | 1485 | `				return 1;` |
|   402261 | 1486 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   393915 | 1487 | `				return -1;` |
|        - | 1488 | `			}` |
|     8351 | 1489 | `			return 0;` |
|        - | 1490 | `		}` |
|        - | 1491 | `	}` |
...
|        - | 1506 | ` */` |
|    11132 | 1507 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1508 | `{` |
|    11137 | 1509 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
...
|        - | 1547 | `			}` |
|     3623 | 1548 | `	}else{` |
|     3901 | 1549 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
|        - | 1550 | `			ph7_hashmap *pMap;` |
|        - | 1551 | `			sxi32 rc;` |
|     3901 | 1552 | `			if( bAddStore ){` |
...
|     3899 | 1567 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|     3899 | 1568 | `				if( pMap == 0){` |
|      ! 0 | 1569 | `					PH7_VmThrowError(pObj1->pVm,0,PH7_CTX_ERR,"PH7 is running out of memory while creating array");` |
|      ! 0 | 1570 | `					return SXERR_MEM;` |
|        - | 1571 | `				}` |
|        - | 1572 | `			}` |
|     3901 | 1573 | `			if( !bAddStore ){` |
|     3899 | 1574 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1575 | `					/* Perform a hashmap duplication */` |
|     3899 | 1576 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|     1952 | 1577 | `				}else{` |
...
|     3901 | 1585 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|     3901 | 1586 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|     1953 | 1587 | `			}else{` |
...
|     3901 | 1594 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|      ! 0 | 1595 | `				SyBlobRelease(&pObj1->sBlob);` |
|      ! 0 | 1596 | `			}` |
|     3901 | 1597 | `			pObj1->x.pOther = pMap;` |
|     3901 | 1598 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|     1948 | 1599 | `		}` |
|        - | 1600 | `	}` |
|    11137 | 1601 | `	return SXRET_OK;` |
|     5571 | 1602 | `}` |
|        - | 1603 | `/*` |
...
|        - | 1707 | `	)` |
|        5 | 1708 | `{` |
|      535 | 1709 | `	sxi32 rc = SXRET_OK;` |
|        - | 1710 | `	int i;` |
|      535 | 1711 | `	if( !ShowType ){` |
...
|     4481 | 1727 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4060 | 1728 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2032 | 1729 | `	}` |
|      425 | 1730 | `	if( isRef ){` |
|      ! 0 | 1731 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|      ! 0 | 1732 | `	}` |
|      425 | 1733 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
...
|        - | 1765 | `	}` |
|      168 | 1766 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - | 1773 | `	}` |
|      164 | 1774 | `	if( pObj->iFlags & MEMOBJ_INT ){` |
