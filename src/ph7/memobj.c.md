...
|        - |   74 | ` */` |
|   134108 |   75 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |   76 | `{` |
|   134113 |   77 | `	sxi64 iVal = 0;` |
|   134113 |   78 | `	if( pVal->nByte <= 0 ){` |
|        7 |   79 | `		return 0;` |
|        - |   80 | `	}` |
|   134107 |   81 | `	if( pVal->zString[0] == '0' ){` |
|        - |   82 | `		sxi32 c;` |
...
|    78425 |   99 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  100 | `	}` |
|    78831 |  101 | `	return iVal;` |
|    67059 |  102 | `}` |
|        - |  103 | `/*` |
...
|        - |  258 | ` */` |
|    55886 |  259 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  260 | `{` |
|    55891 |  261 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  415 | ` */` |
|   402768 |  416 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  417 | `{` |
|   402773 |  418 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  460 | ` */` |
|   798531 |  461 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  462 | `{` |
|   798536 |  463 | `	sxi32 rc = SXRET_OK;` |
|   798536 |  464 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  465 | `		/* Perform the conversion */` |
|    55669 |  466 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    55669 |  467 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    55669 |  468 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    27832 |  469 | `	}` |
|   798536 |  470 | `	return rc;` |
|        5 |  471 | `}` |
|        - |  472 | `/*` |
...
|        - |  633 | ` */` |
|   460186 |  634 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  635 | `{` |
|   460191 |  636 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      293 |  637 | `		return TRUE;` |
|   459903 |  638 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      175 |  639 | `		return FALSE;` |
|   459733 |  640 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  641 | `		SyString sStr;` |
|        - |  642 | `		sxi32 rc;` |
|   459733 |  643 | `		SyStringInitFromBuf(&sStr,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|   459733 |  644 | `		if( sStr.nByte <= 0 ){` |
|        - |  645 | `			/* Empty string */` |
|       77 |  646 | `			return FALSE;` |
|        - |  647 | `		}` |
|        - |  648 | `		/* Check if the string representation looks like a numeric number */` |
|   459657 |  649 | `		rc = SyStrIsNumeric(sStr.zString,sStr.nByte,0,0);` |
|   459657 |  650 | `		return rc == SXRET_OK ? TRUE : FALSE;` |
|        - |  651 | `	}` |
|        - |  652 | `	/* NOT REACHED */` |
|      ! 0 |  653 | `	return FALSE;` |
|   230150 |  654 | `}` |
...
|        - |  666 | ` */` |
|    27754 |  667 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  668 | `{` |
|    27759 |  669 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  670 | `		return TRUE;` |
|    27743 |  671 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       20 |  672 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    27725 |  673 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  674 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    27725 |  675 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  676 | `		return !pObj->x.iVal;` |
|    27721 |  677 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27687 |  678 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22365 |  679 | `			return TRUE;` |
|      ! 0 |  680 | `		}else{` |
|        - |  681 | `			const char *zIn,*zEnd;` |
|     5327 |  682 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5327 |  683 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5333 |  684 | `			while( zIn < zEnd ){` |
|     5333 |  685 | `				if( zIn[0] != '0' ){` |
|     5327 |  686 | `					break;` |
|        - |  687 | `				}` |
|        7 |  688 | `				zIn++;` |
|        1 |  689 | `			}` |
|     5327 |  690 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  691 | `		}` |
...
|        - |  708 | ` */` |
|   442579 |  709 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  710 | `{` |
|   442584 |  711 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   442476 |  712 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - |  856 | ` */` |
|  9145165 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 |  858 | `{` |
|        - |  859 | `	/* Zero the structure */` |
|  9145170 |  860 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  861 | `	/* Initialize fields */` |
|  9145170 |  862 | `	pObj->pVm = pVm;` |
|  9145170 |  863 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  864 | `	/* Set the NULL type */` |
|  9145170 |  865 | `	pObj->iFlags = MEMOBJ_NULL;` |
|  9145170 |  866 | `	return SXRET_OK;` |
|        5 |  867 | `}` |
|        - |  868 | `/*` |
|        - |  869 | ` * Initialize a ph7_value to the integer type.` |
|        - |  870 | ` */` |
|   165986 |  871 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 |  872 | `{` |
|        - |  873 | `	/* Zero the structure */` |
|   165991 |  874 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  875 | `	/* Initialize fields */` |
|   165991 |  876 | `	pObj->pVm = pVm;` |
|   165991 |  877 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  878 | `	/* Set the desired type */` |
|   165991 |  879 | `	pObj->x.iVal = iVal;` |
|   165991 |  880 | `	pObj->iFlags = MEMOBJ_INT;` |
|   165991 |  881 | `	return SXRET_OK;` |
|        5 |  882 | `}` |
|        - |  883 | `/*` |
...
|        - |  917 | ` */` |
|    49572 |  918 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 |  919 | `{` |
|        - |  920 | `	/* Zero the structure */` |
|    49577 |  921 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  922 | `	/* Initialize fields */` |
|    49577 |  923 | `	pObj->pVm = pVm;` |
|    49577 |  924 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  925 | `	/* Set the desired type */` |
|    49577 |  926 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    49577 |  927 | `	pObj->x.pOther = pArray;` |
|    49577 |  928 | `	return SXRET_OK;` |
|        5 |  929 | `}` |
|        - |  930 | `/*` |
|        - |  931 | ` * Initialize a ph7_value to the string type.` |
|        - |  932 | ` */` |
|   523334 |  933 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 |  934 | `{` |
|        - |  935 | `	/* Zero the structure */` |
|   523339 |  936 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  937 | `	/* Initialize fields */` |
|   523339 |  938 | `	pObj->pVm = pVm;` |
|   523339 |  939 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|   523339 |  940 | `	if( pVal ){` |
|        - |  941 | `		/* Append contents */` |
|   327565 |  942 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   163780 |  943 | `	}` |
|        - |  944 | `	/* Set the desired type */` |
|   523339 |  945 | `	pObj->iFlags = MEMOBJ_STRING;` |
|   523339 |  946 | `	return SXRET_OK;` |
|        5 |  947 | `}` |
|        - |  948 | `/*` |
...
|        - |  953 | ` */` |
|   364070 |  954 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 |  955 | `{` |
|        - |  956 | `	sxi32 rc;` |
|   364075 |  957 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  958 | `		/* Invalidate any prior representation */` |
|     1737 |  959 | `		PH7_MemObjRelease(pObj);` |
|     1737 |  960 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|      866 |  961 | `	}` |
|        - |  962 | `	/* Append contents */` |
|   364075 |  963 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|   364075 |  964 | `	return rc;` |
|        5 |  965 | `}` |
|        - |  966 | `#if 0` |
|        - |  967 | `/*` |
...
|        - |  988 | ` */` |
|  4667013 |  989 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 |  990 | `{` |
|  4667018 |  991 | `	ph7_class_instance *pObj = 0;` |
|  4667018 |  992 | `	ph7_hashmap *pMap = 0;` |
|        - |  993 | `	sxi32 rc;` |
|  4667018 |  994 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  995 | `		/* Increment reference count */` |
|   156903 |  996 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  4588569 |  997 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - |  998 | `		/* Increment reference count */` |
|     3243 |  999 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     1619 | 1000 | `	}` |
|  4667018 | 1001 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    45791 | 1002 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  4644125 | 1003 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     4595 | 1004 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     2295 | 1005 | `	}` |
|  4667018 | 1006 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  4667018 | 1007 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  4667018 | 1008 | `	rc = SXRET_OK;` |
|  4667018 | 1009 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3877009 | 1010 | `		SyBlobReset(&pDest->sBlob);` |
|  3877009 | 1011 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  1938507 | 1012 | `	}else{` |
|   790014 | 1013 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   278920 | 1014 | `			SyBlobRelease(&pDest->sBlob);` |
|   139500 | 1015 | `		}` |
|        - | 1016 | `	}` |
|  4667018 | 1017 | `	if( pMap ){` |
|    45791 | 1018 | `		PH7_HashmapUnref(pMap);` |
|  4644125 | 1019 | `	}else if( pObj ){` |
|     4595 | 1020 | `		PH7_ClassInstanceUnref(pObj);` |
|     2295 | 1021 | `	}` |
|  4667018 | 1022 | `	return rc;` |
|        5 | 1023 | `}` |
|        - | 1024 | `/*` |
|        - | 1025 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1026 | ` * buffer contents,simply point to it.` |
|        - | 1027 | ` */` |
|  6422190 | 1028 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1029 | `{` |
|  6422195 | 1030 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1031 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6422195 | 1032 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1033 | `		/* Increment reference count */` |
|   437711 | 1034 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6203342 | 1035 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1036 | `		/* Increment reference count */` |
|    18157 | 1037 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     9076 | 1038 | `	}` |
|  6422195 | 1039 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       36 | 1040 | `		SyBlobRelease(&pDest->sBlob);` |
|       16 | 1041 | `	}` |
|  6422195 | 1042 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3472621 | 1043 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1736445 | 1044 | `	}` |
|  6422195 | 1045 | `	return SXRET_OK;` |
|        5 | 1046 | `}` |
|        - | 1047 | `/*` |
|        - | 1048 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1049 | ` */` |
| 12702573 | 1050 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1051 | `{` |
| 12702578 | 1052 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 11603061 | 1053 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   555945 | 1054 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 11325091 | 1055 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    31385 | 1056 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    15690 | 1057 | `		}` |
|        - | 1058 | `		/* Release the internal buffer */` |
| 11603061 | 1059 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1060 | `		/* Invalidate any prior representation */` |
| 11603061 | 1061 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  5801919 | 1062 | `	}` |
| 12702578 | 1063 | `	return SXRET_OK;` |
|        5 | 1064 | `}` |
|        - | 1065 | `/*` |
...
|        - | 1117 | ` */` |
|  1244748 | 1118 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1119 | `{` |
|        - | 1120 | `	sxi32 iComb;` |
|        - | 1121 | `	sxi32 rc;` |
|  1244753 | 1122 | `	if( bStrict ){` |
|        - | 1123 | `		sxi32 iF1,iF2;` |
|        - | 1124 | `		/* Strict comparisons with === */` |
|   640403 | 1125 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   640403 | 1126 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   640403 | 1127 | `		if( iF1 != iF2 ){` |
|        - | 1128 | `			/* Not of the same type */` |
|   179073 | 1129 | `			return 1;` |
|        - | 1130 | `		}` |
|   230665 | 1131 | `	}` |
|        - | 1132 | `	/* Combine flag together */` |
|  1065685 | 1133 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1065685 | 1134 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
...
|  1044661 | 1143 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       27 | 1155 | `		return rc;` |
|  1044635 | 1156 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      229 | 1168 | `		return rc;` |
|  1044411 | 1169 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1170 | `		SyString s1,s2;` |
|   669457 | 1171 | `		if( !bStrict ){` |
|        - | 1172 | `			/*` |
...
|        - | 1178 | `			 */` |
|   229815 | 1179 | `			if( PH7_MemObjIsNumeric(pObj1) ){` |
|        - | 1180 | `				/* Perform a numeric comparison */` |
|       15 | 1181 | `				goto Numeric;` |
|        - | 1182 | `			}` |
|   229801 | 1183 | `			if( PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1184 | `				/* Perform a numeric comparison */` |
|      ! 0 | 1185 | `				goto Numeric;` |
|        - | 1186 | `			}` |
|   114924 | 1187 | `		}` |
|        - | 1188 | `		/* Perform a strict string comparison.*/` |
|   669443 | 1189 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1190 | `			PH7_MemObjToString(pObj1);` |
|      ! 0 | 1191 | `		}` |
|   669443 | 1192 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1193 | `			PH7_MemObjToString(pObj2);` |
|      ! 0 | 1194 | `		}` |
|   669443 | 1195 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   669443 | 1196 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1197 | `		/*` |
...
|        - | 1200 | `		 */` |
|   669443 | 1201 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   669443 | 1202 | `		if( rc == 0 ){` |
|   231142 | 1203 | `			if( s1.nByte != s2.nByte ){` |
|     1650 | 1204 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|      825 | 1205 | `			}` |
|   115571 | 1206 | `		}` |
|   669443 | 1207 | `		return rc;` |
|   374959 | 1208 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   187435 | 1209 | `Numeric:` |
|        - | 1210 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   374973 | 1211 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|        3 | 1212 | `			PH7_MemObjToNumeric(pObj1);` |
|        1 | 1213 | `		}` |
|   374973 | 1214 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       13 | 1215 | `			PH7_MemObjToNumeric(pObj2);` |
|        6 | 1216 | `		}` |
|   374973 | 1217 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1218 | `			/*` |
...
|   374749 | 1251 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     5261 | 1252 | `				return 1;` |
|   369493 | 1253 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   364085 | 1254 | `				return -1;` |
|        - | 1255 | `			}` |
|     5413 | 1256 | `			return 0;` |
|        - | 1257 | `		}` |
|        - | 1258 | `	}` |
...
|        - | 1273 | ` */` |
|     5880 | 1274 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1275 | `{` |
|     5885 | 1276 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
