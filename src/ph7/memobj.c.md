...
|        - |   10 | ` */` |
|      292 |   11 | `PH7_PRIVATE const char *ph7_type_name(ph7_value *pVal)` |
|        5 |   12 |  |
|      297 |   13 | `	if( ph7_value_is_null(pVal) ) return "null";` |
|      285 |   14 | `	if( ph7_value_is_bool(pVal) ) return "bool";` |
|      277 |   15 | `	if( ph7_value_is_int(pVal) ) return "int";` |
|      233 |   16 | `	if( ph7_value_is_float(pVal) ) return "float";` |
|      229 |   17 | `	if( ph7_value_is_string(pVal) ) return "string";` |
...
|        - |   74 | ` */` |
|   122666 |   75 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |   76 |  |
|   122671 |   77 | `	sxi64 iVal = 0;` |
|   122671 |   78 | `	if( pVal->nByte <= 0 ){` |
|        7 |   79 | `		return 0;` |
|        - |   80 | `	}` |
|   122665 |   81 | `	if( pVal->zString[0] == '0' ){` |
|        - |   82 | `		sxi32 c;` |
|    50895 |   83 | `		if( pVal->nByte == sizeof(char) ){` |
|    50491 |   84 | `			return 0;` |
|        - |   85 | `		}` |
...
|    71775 |   99 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  100 | `	}` |
|    72179 |  101 | `	return iVal;` |
|    61338 |  102 |  |
|        - |  103 | `/*` |
...
|        - |  258 | ` */` |
|    55382 |  259 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  260 |  |
|    55387 |  261 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        4 |  273 | `		}` |
|    55239 |  274 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    54657 |  275 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  276 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    27765 |  277 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      311 |  278 | `		if( bStrictBool ){` |
|        - |  279 | `			/* Actual string cast: true -> "1", false -> "" (like PHP) */` |
|      203 |  280 | `			if( pObj->x.iVal ){` |
...
|        - |  327 | ` */` |
|    13532 |  328 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  329 |  |
|        - |  330 | `	sxi32 iFlags;` |
|    13537 |  331 | `	iFlags = pObj->iFlags;` |
|    13537 |  332 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  333 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  334 | `		return pObj->rVal ? 1 : 0;` |
|        - |  335 | `#else` |
|       12 |  336 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  337 | `#endif` |
|    13527 |  338 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      115 |  339 | `		return pObj->x.iVal ? 1 : 0;` |
|    13417 |  340 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|      ! 0 |  360 | `		}` |
|    13353 |  361 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    12319 |  362 | `		return 0;` |
...
|        - |  415 | ` */` |
|   381488 |  416 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  417 |  |
|   381493 |  418 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  446 | ` */` |
|    14212 |  447 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  448 |  |
|    14217 |  449 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  450 | `		/* Preform the conversion */` |
|    13537 |  451 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  452 | `		/* Invalidate any prior representations */` |
|    13537 |  453 | `		SyBlobRelease(&pObj->sBlob);` |
|    13537 |  454 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     6766 |  455 | `	}` |
|    14217 |  456 | `	return SXRET_OK;` |
|        5 |  457 |  |
|        - |  458 | `/*` |
|        - |  459 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  460 | ` */` |
|   761993 |  461 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  462 |  |
|   761998 |  463 | `	sxi32 rc = SXRET_OK;` |
|   761998 |  464 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  465 | `		/* Perform the conversion */` |
|    55165 |  466 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    55165 |  467 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    55165 |  468 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    27580 |  469 | `	}` |
|   761998 |  470 | `	return rc;` |
|        5 |  471 |  |
|        - |  472 | `/*` |
...
|        - |  617 | ` */` |
|   442350 |  618 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  619 |  |
|   442355 |  620 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      241 |  621 | `		return TRUE;` |
|   442119 |  622 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|       83 |  623 | `		return FALSE;` |
|   442041 |  624 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  625 | `		SyString sStr;` |
|        - |  626 | `		sxi32 rc;` |
|   442041 |  627 | `		SyStringInitFromBuf(&sStr,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|   442041 |  628 | `		if( sStr.nByte <= 0 ){` |
|        - |  629 | `			/* Empty string */` |
|       73 |  630 | `			return FALSE;` |
|        - |  631 | `		}` |
|        - |  632 | `		/* Check if the string representation looks like a numeric number */` |
|   441969 |  633 | `		rc = SyStrIsNumeric(sStr.zString,sStr.nByte,0,0);` |
|   441969 |  634 | `		return rc == SXRET_OK ? TRUE : FALSE;` |
|        - |  635 | `	}` |
|        - |  636 | `	/* NOT REACHED */` |
|      ! 0 |  637 | `	return FALSE;` |
|   221221 |  638 |  |
...
|        - |  650 | ` */` |
|    26970 |  651 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  652 |  |
|    26975 |  653 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       13 |  654 | `		return TRUE;` |
|    26965 |  655 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       18 |  656 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    26949 |  657 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  658 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    26949 |  659 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  660 | `		return !pObj->x.iVal;` |
|    26945 |  661 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    26911 |  662 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21959 |  663 | `			return TRUE;` |
|      ! 0 |  664 | `		}else{` |
|        - |  665 | `			const char *zIn,*zEnd;` |
|     4957 |  666 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     4957 |  667 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     4963 |  668 | `			while( zIn < zEnd ){` |
|     4963 |  669 | `				if( zIn[0] != '0' ){` |
|     4957 |  670 | `					break;` |
|        - |  671 | `				}` |
|        7 |  672 | `				zIn++;` |
|        1 |  673 | `			}` |
|     4957 |  674 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  675 | `		}` |
...
|        - |  692 | ` */` |
|   421121 |  693 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  694 |  |
|   421126 |  695 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   421020 |  696 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - |  840 | ` */` |
|  7774279 |  841 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 |  842 |  |
|        - |  843 | `	/* Zero the structure */` |
|  7774284 |  844 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  845 | `	/* Initialize fields */` |
|  7774284 |  846 | `	pObj->pVm = pVm;` |
|  7774284 |  847 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  848 | `	/* Set the NULL type */` |
|  7774284 |  849 | `	pObj->iFlags = MEMOBJ_NULL;` |
|  7774284 |  850 | `	return SXRET_OK;` |
|        5 |  851 |  |
|        - |  852 | `/*` |
|        - |  853 | ` * Initialize a ph7_value to the integer type.` |
|        - |  854 | ` */` |
|   153462 |  855 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 |  856 |  |
|        - |  857 | `	/* Zero the structure */` |
|   153467 |  858 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  859 | `	/* Initialize fields */` |
|   153467 |  860 | `	pObj->pVm = pVm;` |
|   153467 |  861 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  862 | `	/* Set the desired type */` |
|   153467 |  863 | `	pObj->x.iVal = iVal;` |
|   153467 |  864 | `	pObj->iFlags = MEMOBJ_INT;` |
|   153467 |  865 | `	return SXRET_OK;` |
|        5 |  866 |  |
|        - |  867 | `/*` |
|        - |  868 | ` * Initialize a ph7_value to the boolean type.` |
|        - |  869 | ` */` |
|    16918 |  870 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 |  871 |  |
|        - |  872 | `	/* Zero the structure */` |
|    16923 |  873 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  874 | `	/* Initialize fields */` |
|    16923 |  875 | `	pObj->pVm = pVm;` |
|    16923 |  876 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  877 | `	/* Set the desired type */` |
|    16923 |  878 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    16923 |  879 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    16923 |  880 | `	return SXRET_OK;` |
|        5 |  881 |  |
|        - |  882 | `#if 0` |
|        - |  883 | `/*` |
...
|        - |  901 | ` */` |
|    45138 |  902 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 |  903 |  |
|        - |  904 | `	/* Zero the structure */` |
|    45143 |  905 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  906 | `	/* Initialize fields */` |
|    45143 |  907 | `	pObj->pVm = pVm;` |
|    45143 |  908 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  909 | `	/* Set the desired type */` |
|    45143 |  910 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    45143 |  911 | `	pObj->x.pOther = pArray;` |
|    45143 |  912 | `	return SXRET_OK;` |
|        5 |  913 |  |
|        - |  914 | `/*` |
|        - |  915 | ` * Initialize a ph7_value to the string type.` |
|        - |  916 | ` */` |
|   460152 |  917 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 |  918 |  |
|        - |  919 | `	/* Zero the structure */` |
|   460157 |  920 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  921 | `	/* Initialize fields */` |
|   460157 |  922 | `	pObj->pVm = pVm;` |
|   460157 |  923 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|   460157 |  924 | `	if( pVal ){` |
|        - |  925 | `		/* Append contents */` |
|   289033 |  926 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   144514 |  927 | `	}` |
|        - |  928 | `	/* Set the desired type */` |
|   460157 |  929 | `	pObj->iFlags = MEMOBJ_STRING;` |
|   460157 |  930 | `	return SXRET_OK;` |
|        5 |  931 |  |
|        - |  932 | `/*` |
...
|        - |  937 | ` */` |
|   332400 |  938 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 |  939 |  |
|        - |  940 | `	sxi32 rc;` |
|   332405 |  941 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  942 | `		/* Invalidate any prior representation */` |
|      199 |  943 | `		PH7_MemObjRelease(pObj);` |
|      199 |  944 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|       97 |  945 | `	}` |
|        - |  946 | `	/* Append contents */` |
|   332405 |  947 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|   332405 |  948 | `	return rc;` |
|        5 |  949 |  |
|        - |  950 | `#if 0` |
|        - |  951 | `/*` |
...
|        - |  972 | ` */` |
|  4532723 |  973 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 |  974 |  |
|  4532728 |  975 | `	ph7_class_instance *pObj = 0;` |
|  4532728 |  976 | `	ph7_hashmap *pMap = 0;` |
|        - |  977 | `	sxi32 rc;` |
|  4532728 |  978 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  979 | `		/* Increment reference count */` |
|   148673 |  980 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  4458394 |  981 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - |  982 | `		/* Increment reference count */` |
|     1993 |  983 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|      994 |  984 | `	}` |
|  4532728 |  985 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    44275 |  986 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  4510593 |  987 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     2447 |  988 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     1221 |  989 | `	}` |
|  4532728 |  990 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  4532728 |  991 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  4532728 |  992 | `	rc = SXRET_OK;` |
|  4532728 |  993 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3805179 |  994 | `		SyBlobReset(&pDest->sBlob);` |
|  3805179 |  995 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  1902592 |  996 | `	}else{` |
|   727554 |  997 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   266408 |  998 | `			SyBlobRelease(&pDest->sBlob);` |
|   133244 |  999 | `		}` |
|        - | 1000 | `	}` |
|  4532728 | 1001 | `	if( pMap ){` |
|    44275 | 1002 | `		PH7_HashmapUnref(pMap);` |
|  4510593 | 1003 | `	}else if( pObj ){` |
|     2447 | 1004 | `		PH7_ClassInstanceUnref(pObj);` |
|     1221 | 1005 | `	}` |
|  4532728 | 1006 | `	return rc;` |
|        5 | 1007 |  |
|        - | 1008 | `/*` |
|        - | 1009 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1010 | ` * buffer contents,simply point to it.` |
|        - | 1011 | ` */` |
|  6081896 | 1012 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1013 |  |
|  6081901 | 1014 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1015 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6081901 | 1016 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1017 | `		/* Increment reference count */` |
|   421491 | 1018 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5871158 | 1019 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1020 | `		/* Increment reference count */` |
|    12559 | 1021 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     6277 | 1022 | `	}` |
|  6081901 | 1023 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       32 | 1024 | `		SyBlobRelease(&pDest->sBlob);` |
|       14 | 1025 | `	}` |
|  6081901 | 1026 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3298365 | 1027 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1649306 | 1028 | `	}` |
|  6081901 | 1029 | `	return SXRET_OK;` |
|        5 | 1030 |  |
|        - | 1031 | `/*` |
|        - | 1032 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1033 | ` */` |
| 12050973 | 1034 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1035 |  |
| 12050978 | 1036 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 11090083 | 1037 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   531523 | 1038 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 10824324 | 1039 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    22127 | 1040 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    11061 | 1041 | `		}` |
|        - | 1042 | `		/* Release the internal buffer */` |
| 11090083 | 1043 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1044 | `		/* Invalidate any prior representation */` |
| 11090083 | 1045 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  5545419 | 1046 | `	}` |
| 12050978 | 1047 | `	return SXRET_OK;` |
|        5 | 1048 |  |
|        - | 1049 | `/*` |
...
|        - | 1101 | ` */` |
|  1183505 | 1102 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1103 |  |
|        - | 1104 | `	sxi32 iComb;` |
|        - | 1105 | `	sxi32 rc;` |
|  1183510 | 1106 | `	if( bStrict ){` |
|        - | 1107 | `		sxi32 iF1,iF2;` |
|        - | 1108 | `		/* Strict comparisons with === */` |
|   609187 | 1109 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   609187 | 1110 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   609187 | 1111 | `		if( iF1 != iF2 ){` |
|        - | 1112 | `			/* Not of the same type */` |
|   169153 | 1113 | `			return 1;` |
|        - | 1114 | `		}` |
|   220017 | 1115 | `	}` |
|        - | 1116 | `	/* Combine flag together */` |
|  1014362 | 1117 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1014362 | 1118 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1119 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    20345 | 1120 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7123 | 1121 | `			PH7_MemObjToBool(pObj1);` |
|     3559 | 1122 | `		}` |
|    20345 | 1123 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     6159 | 1124 | `			PH7_MemObjToBool(pObj2);` |
|     3077 | 1125 | `		}` |
|    20345 | 1126 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|   994022 | 1127 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       27 | 1139 | `		return rc;` |
|   993996 | 1140 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      177 | 1152 | `		return rc;` |
|   993822 | 1153 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1154 | `		SyString s1,s2;` |
|   640816 | 1155 | `		if( !bStrict ){` |
|        - | 1156 | `			/*` |
...
|        - | 1162 | `			 */` |
|   221002 | 1163 | `			if( PH7_MemObjIsNumeric(pObj1) ){` |
|        - | 1164 | `				/* Perform a numeric comparison */` |
|       13 | 1165 | `				goto Numeric;` |
|        - | 1166 | `			}` |
|   220990 | 1167 | `			if( PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1168 | `				/* Perform a numeric comparison */` |
|      ! 0 | 1169 | `				goto Numeric;` |
|        - | 1170 | `			}` |
|   110513 | 1171 | `		}` |
|        - | 1172 | `		/* Perform a strict string comparison.*/` |
|   640804 | 1173 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1174 | `			PH7_MemObjToString(pObj1);` |
|      ! 0 | 1175 | `		}` |
|   640804 | 1176 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1177 | `			PH7_MemObjToString(pObj2);` |
|      ! 0 | 1178 | `		}` |
|   640804 | 1179 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   640804 | 1180 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1181 | `		/*` |
...
|        - | 1184 | `		 */` |
|   640804 | 1185 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   640804 | 1186 | `		if( rc == 0 ){` |
|   224000 | 1187 | `			if( s1.nByte != s2.nByte ){` |
|     1618 | 1188 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|      809 | 1189 | `			}` |
|   112000 | 1190 | `		}` |
|   640804 | 1191 | `		return rc;` |
|   353011 | 1192 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   176461 | 1193 | `Numeric:` |
|        - | 1194 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   353023 | 1195 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|        3 | 1196 | `			PH7_MemObjToNumeric(pObj1);` |
|        1 | 1197 | `		}` |
|   353023 | 1198 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1199 | `			PH7_MemObjToNumeric(pObj2);` |
|        5 | 1200 | `		}` |
|   353023 | 1201 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1202 | `			/*` |
...
|   352823 | 1235 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     2423 | 1236 | `				return 1;` |
|   350405 | 1237 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   346350 | 1238 | `				return -1;` |
|        - | 1239 | `			}` |
|     4060 | 1240 | `			return 0;` |
|        - | 1241 | `		}` |
|        - | 1242 | `	}` |
...
|        4 | 1347 |  |
|      430 | 1348 | `	const char *zType = "";` |
|      430 | 1349 | `	if( pVal->iFlags & MEMOBJ_NULL ){` |
|        7 | 1350 | `		zType = "null";` |
|      427 | 1351 | `	}else if( pVal->iFlags & MEMOBJ_REAL ){` |
...
|        7 | 1354 | `		zType = "double";` |
|      421 | 1355 | `	}else if( pVal->iFlags & MEMOBJ_INT ){` |
|      101 | 1356 | `		zType = "int";` |
|      369 | 1357 | `	}else if( pVal->iFlags & MEMOBJ_STRING ){` |
|       64 | 1358 | `		zType = "string";` |
|      290 | 1359 | `	}else if( pVal->iFlags & MEMOBJ_BOOL ){` |
|      111 | 1360 | `		zType = "bool";` |
...
|        - | 1381 | `	)` |
|        4 | 1382 |  |
|      488 | 1383 | `	sxi32 rc = SXRET_OK;` |
|        - | 1384 | `	const char *zType;` |
|        - | 1385 | `	int i;` |
|     4684 | 1386 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4200 | 1387 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2102 | 1388 | `	}` |
|      488 | 1389 | `	if( ShowType ){` |
|      398 | 1390 | `		if( isRef ){` |
...
|      398 | 1395 | `		if( (pObj->iFlags & MEMOBJ_REAL) && (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        3 | 1396 | `			zType = "float";` |
|        2 | 1397 | `		}else{` |
|      396 | 1398 | `			zType = PH7_MemObjTypeDump(pObj);` |
|        - | 1399 | `		}` |
|      398 | 1400 | `		SyBlobAppend(&(*pOut),zType,SyStrlen(zType));` |
|      197 | 1401 | `	}` |
|      488 | 1402 | `	if((pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|      484 | 1403 | `		if ( ShowType ){` |
|      394 | 1404 | `			SyBlobAppend(&(*pOut),"(",sizeof(char));` |
|      195 | 1405 | `		}` |
|      484 | 1406 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1407 | `			/* Dump hashmap entries */` |
|       26 | 1408 | `			rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,ShowType,nTab+1,nDepth+1);` |
|      472 | 1409 | `		}else if(pObj->iFlags & MEMOBJ_OBJ ){` |
...
|       72 | 1412 | `		}else{` |
|      322 | 1413 | `			SyBlob *pContents = &pObj->sBlob;` |
|        - | 1414 | `			/* Get a printable representation of the contents */` |
|      322 | 1415 | `			if((pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - | 1428 | `			}` |
|        - | 1429 | `		}` |
|      484 | 1430 | `		if( ShowType ){` |
|        - | 1431 | `			/* Strings already emitted their own ')' as part of the` |
|        - | 1432 | `			 * "N) \"content\"" format above. */` |
|      394 | 1433 | `			if( (pObj->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_STRING)) == 0 ){` |
