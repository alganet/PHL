...
|        - |  128 | ` */` |
|  3554976 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3554981 |  131 | `	sxi64 iVal = 0;` |
|  3554981 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3554981 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
...
|  2171749 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2279269 |  161 | `	return iVal;` |
|  1777493 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  380 | ` */` |
|    61450 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61455 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  410 | `#endif` |
|        3 |  411 | `		}` |
|    61270 |  412 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    60779 |  413 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  414 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30698 |  415 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  468 | ` */` |
|    18444 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18449 |  472 | `	iFlags = pObj->iFlags;` |
|    18449 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18437 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
...
|        - |  490 | `		}` |
|       88 |  491 | `		return 1;` |
|    17459 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16171 |  493 | `		return 0;` |
...
|        - |  546 | ` */` |
|   524482 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   524487 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  577 | ` */` |
|    21956 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    21961 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18449 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18449 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18449 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9222 |  586 | `	}` |
|    21961 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|   988569 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|   988574 |  594 | `	sxi32 rc = SXRET_OK;` |
|   988574 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61361 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61361 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61361 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30678 |  600 | `	}` |
|   988574 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  781 | ` */` |
|   248621 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   248626 |  786 | `	int bDigit = 0;` |
|   248626 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   248626 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   248626 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   248626 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   248026 |  795 | `	zEnd = z + n;` |
|   248052 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       28 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   248026 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      203 |  800 | `		z++;` |
|       99 |  801 | `	}` |
|   252836 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4815 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   248026 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     1733 |  806 | `		z++;` |
...
|        - |  839 | ` */` |
|   246235 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   246240 |  842 | `	const char *zTail = 0, *zEnd;` |
|   246240 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   243908 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   247083 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   247088 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      597 |  860 | `		return TRUE;` |
|   246496 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      374 |  862 | `		return FALSE;` |
|   246124 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   246124 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   123549 |  869 | `}` |
...
|        - |  881 | ` */` |
|    40680 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    40685 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       21 |  885 | `		return TRUE;` |
|    40667 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    40647 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    40647 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    40643 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27345 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21815 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
...
|      ! 0 |  906 | `		}` |
|    13303 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13303 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13303 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   594873 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   594878 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   592540 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1080 | ` */` |
| 24839773 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 24839778 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 24839778 | 1086 | `	pObj->pVm = pVm;` |
| 24839778 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 24839778 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 24839778 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5704428 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5704433 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5704433 | 1100 | `	pObj->pVm = pVm;` |
|  5704433 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5704433 | 1103 | `	pObj->x.iVal = iVal;` |
|  5704433 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5704433 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17266 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17271 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17271 | 1115 | `	pObj->pVm = pVm;` |
|    17271 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17271 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17271 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17271 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    62986 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    62991 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    62991 | 1145 | `	pObj->pVm = pVm;` |
|    62991 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    62991 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    62991 | 1149 | `	pObj->x.pOther = pArray;` |
|    62991 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4156664 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4156669 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4156669 | 1160 | `	pObj->pVm = pVm;` |
|  4156669 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4156669 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  1941267 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   970631 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4156669 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4156669 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2615004 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2615009 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2615009 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2615009 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  5955325 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  5955330 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  5955330 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  5955330 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   216971 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5846847 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|     9777 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4886 | 1222 | `	}` |
|  5955330 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    80547 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5915059 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8295 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4145 | 1227 | `	}` |
|  5955330 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5955330 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5955330 | 1230 | `	rc = SXRET_OK;` |
|  5955330 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4253529 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4253529 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2126767 | 1234 | `	}else{` |
|  1701806 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   357246 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   178644 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  5955330 | 1239 | `	if( pMap ){` |
|    80547 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  5915059 | 1241 | `	}else if( pObj ){` |
|     8295 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4145 | 1243 | `	}` |
|  5955325 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3086169 | 1245 | `	 && pDest->pVm` |
|   216966 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   108492 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  5955330 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  8601448 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  8601453 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8601453 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   537591 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8332660 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    47575 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    23785 | 1281 | `	}` |
|  8601453 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  8601453 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4459387 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2229743 | 1287 | `	}` |
|  8601453 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 20638053 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 20638058 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18001555 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   702089 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 17650513 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    89545 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    44770 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18001555 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18001555 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9000966 | 1305 | `	}` |
| 20638058 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1658400 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1658405 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   848987 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   848987 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   848987 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   193855 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   327565 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1464555 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1464550 | 1377 | `	if( !bStrict` |
|  1136983 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   404774 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1464555 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24395 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9145 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4570 | 1400 | `		}` |
|    24395 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8097 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4046 | 1403 | `		}` |
|    24395 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1440165 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1417 | `		return rc;` |
|  1440135 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1430 | `		return rc;` |
|  1439863 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   872576 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   244636 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   121769 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   871478 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   871478 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   871478 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   871478 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   871478 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   871478 | 1465 | `		if( rc == 0 ){` |
|   288688 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    17354 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     8676 | 1468 | `			}` |
|   144343 | 1469 | `		}` |
|   871478 | 1470 | `		return rc;` |
|   567292 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   283621 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   568390 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   568390 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   568390 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   568078 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7464 | 1515 | `				return 1;` |
