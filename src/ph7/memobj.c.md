...
|        - |   93 | ` */` |
|    10836 |   94 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|        5 |   95 | `{` |
...
|    10841 |  111 | `  ph7_real r = pObj->rVal;` |
|    10841 |  112 | `  if( r<(ph7_real)minInt ){` |
|        3 |  113 | `    return minInt;` |
|    10839 |  114 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  128 | ` */` |
|  3793282 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3793287 |  131 | `	sxi64 iVal = 0;` |
|  3793287 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3793287 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1498173 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1388973 |  138 | `			return 0;` |
|        - |  139 | `		}` |
|   109205 |  140 | `		c = pVal->zString[1];` |
|   109205 |  141 | `		if( c  == 'x' \|\| c == 'X' ){` |
|        - |  142 | `			/* Hex digit stream */` |
|   104957 |  143 | `			SyHexStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|    56729 |  144 | `		}else if( c == 'b' \|\| c == 'B' ){` |
|        - |  145 | `			/* Binary digit stream */` |
|      281 |  146 | `			SyBinaryStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|     4113 |  147 | `		}else if( c == 'o' \|\| c == 'O' ){` |
...
|     3957 |  155 | `			SyOctalStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  156 | `		}` |
|    54605 |  157 | `	}else{` |
|        - |  158 | `		/* Decimal digit stream */` |
|  2295119 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2404319 |  161 | `	return iVal;` |
|  1896646 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  166 | ` * representation.` |
|        - |  167 | ` */` |
|     3523 |  168 | `static sxi64 MemObjStringToInt(ph7_value *pObj)` |
|        5 |  169 | `{` |
|     3528 |  170 | `	sxi64 iVal = 0;` |
...
|     3528 |  174 | `	SyStrToInt64((const char *)SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),(void *)&iVal,0);` |
|     3528 |  175 | `	return iVal;` |
|        5 |  176 | `}` |
|        - |  177 | `/*` |
...
|        - |  210 | ` */` |
|     1404 |  211 | `static sxi64 MemObjIntValue(ph7_value *pObj)` |
|        5 |  212 | `{` |
|        - |  213 | `	sxi32 iFlags;` |
|     1409 |  214 | `	iFlags = pObj->iFlags;` |
|     1409 |  215 | `	if (iFlags & MEMOBJ_REAL ){` |
|       41 |  216 | `		return MemObjRealToInt(&(*pObj));` |
|     1369 |  217 | `	}else if( iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      170 |  218 | `		return pObj->x.iVal;` |
|     1201 |  219 | `	}else if (iFlags & MEMOBJ_STRING) {` |
|     1183 |  220 | `		return MemObjStringToInt(&(*pObj));` |
...
|        - |  259 | ` */` |
|     9616 |  260 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|        5 |  261 | `{` |
|        - |  262 | `	sxi32 iFlags;` |
|     9621 |  263 | `	iFlags = pObj->iFlags;` |
|     9621 |  264 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  265 | `		return pObj->rVal;` |
|     9621 |  266 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      771 |  267 | `		return (ph7_real)pObj->x.iVal;` |
|     8853 |  268 | `	}else if (iFlags & MEMOBJ_STRING){` |
|        - |  269 | `		SyString sString;` |
|        - |  270 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  271 | `		ph7_real rVal = 0;` |
|        - |  272 | `#else` |
|     8847 |  273 | `		ph7_real rVal = 0.0;` |
|        - |  274 | `#endif` |
|     8847 |  275 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|     8847 |  276 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|        - |  277 | `			/* Convert as much as we can */` |
|        - |  278 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  279 | `			rVal = MemObjStringToInt(&(*pObj));` |
|        - |  280 | `#else` |
|     8847 |  281 | `			SyStrToReal(sString.zString,sString.nByte,(void *)&rVal,0);` |
|        - |  282 | `#endif` |
|     4421 |  283 | `		}` |
|     8847 |  284 | `		return rVal;` |
...
|        - |  330 | ` */` |
|      518 |  331 | `PH7_PRIVATE sxi32 PH7_PhpFloatShape(char *zBuf,sxi32 nLen,int bGeneric)` |
|        5 |  332 | `{` |
|        - |  333 | `	sxi32 iExp,i;` |
|      523 |  334 | `	iExp = nLen - 1;` |
|     4431 |  335 | `	while( iExp > 0 && zBuf[iExp] != 'e' && zBuf[iExp] != 'E' ){` |
|     3913 |  336 | `		iExp--;` |
|        5 |  337 | `	}` |
|      523 |  338 | `	if( iExp <= 0 ){` |
|      477 |  339 | `		return nLen; /* No exponent part (fixed notation) */` |
|        - |  340 | `	}` |
|        - |  341 | `	{` |
...
|        - |  380 | ` */` |
|    61648 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61653 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|        - |  384 | `		/* Handle special floating-point values first */` |
|      379 |  385 | `		if( PH7_IS_NAN(pObj->rVal) ){` |
|      ! 0 |  386 | `			SyBlobAppend(&(*pOut),"NAN",3);` |
|      379 |  387 | `		}else if( PH7_IS_INF(pObj->rVal) ){` |
...
|      375 |  402 | `			sxi32 n = (sxi32)snprintf(zNum,sizeof(zNum),"%.14G",pObj->rVal);` |
|      375 |  403 | `			if( n < 0 \|\| n >= (sxi32)sizeof(zNum) ){` |
|      ! 0 |  404 | `				n = (sxi32)SyStrlen(zNum);` |
|      ! 0 |  405 | `			}` |
|      375 |  406 | `			n = PH7_PhpFloatShape(zNum,n,TRUE);` |
|      375 |  407 | `			SyBlobAppend(&(*pOut),zNum,(sxu32)n);` |
|        - |  408 | `#else` |
|        - |  409 | `			SyBlobFormat(&(*pOut),"%.15g",pObj->rVal);` |
|        - |  410 | `#endif` |
|        5 |  411 | `		}` |
|    61466 |  412 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    60975 |  413 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  414 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30794 |  415 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  428 | `			}` |
|        5 |  429 | `		}` |
|      290 |  430 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
...
|        - |  468 | ` */` |
|    18952 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18957 |  472 | `	iFlags = pObj->iFlags;` |
|    18957 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18945 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      909 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    18041 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
|        - |  482 | `		SyString sString;` |
|      106 |  483 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|        - |  484 | `		/* php: a string is FALSE iff it is empty or exactly "0" */` |
|      106 |  485 | `		if( sString.nByte == 0 ){` |
|       18 |  486 | `			return 0;` |
|        - |  487 | `		}` |
|       90 |  488 | `		if( sString.nByte == 1 && sString.zString[0] == '0' ){` |
|        7 |  489 | `			return 0;` |
|        - |  490 | `		}` |
|       84 |  491 | `		return 1;` |
|    17937 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16619 |  493 | `		return 0;` |
|     1323 |  494 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|     1305 |  499 | `	}else if( iFlags & MEMOBJ_OBJ ){` |
...
|      190 |  513 | `		return iVal;` |
|     1117 |  514 | `	}else if(iFlags & MEMOBJ_RES ){` |
|     1117 |  515 | `		return pObj->x.pOther != 0;` |
|        - |  516 | `	}` |
|        - |  517 | `	/* NOT REACHED */` |
|      ! 0 |  518 | `	return 0;` |
|     9481 |  519 | `}` |
...
|        - |  522 | ` */` |
|    10796 |  523 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|        5 |  524 | `{` |
|    10801 |  525 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|        - |  537 | `  */` |
|    10796 |  538 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|     9335 |  539 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     9319 |  540 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|     4659 |  541 | `	}` |
|    10801 |  542 | `	return SXRET_OK;` |
|        5 |  543 | `}` |
|        - |  544 | `/*` |
|        - |  545 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  546 | ` */` |
|   545024 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   545029 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  550 | `		/* Preform the conversion */` |
|     1409 |  551 | `		pObj->x.iVal = MemObjIntValue(&(*pObj));` |
|        - |  552 | `		/* Invalidate any prior representations */` |
|     1409 |  553 | `		SyBlobRelease(&pObj->sBlob);` |
|     1409 |  554 | `		MemObjSetType(pObj,MEMOBJ_INT);` |
|      702 |  555 | `	}` |
|   545029 |  556 | `	return SXRET_OK;` |
|        5 |  557 | `}` |
|        - |  558 | `/*` |
|        - |  559 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  560 | ` * Invalidate any prior representations` |
|        - |  561 | ` */` |
|    10626 |  562 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        5 |  563 | `{` |
|    10631 |  564 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  565 | `		/* Preform the conversion */` |
|     9621 |  566 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  567 | `		/* Invalidate any prior representations */` |
|     9621 |  568 | `		SyBlobRelease(&pObj->sBlob);` |
|     9621 |  569 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  570 | `		/* Try to get an integer representation */` |
|     9621 |  571 | `		MemObjTryIntger(&(*pObj));` |
|     4808 |  572 | `	}` |
|    10631 |  573 | `	return SXRET_OK;` |
|        5 |  574 | `}` |
|        - |  575 | `/*` |
|        - |  576 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  577 | ` */` |
|    22884 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22889 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18957 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18957 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18957 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9476 |  586 | `	}` |
|    22889 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|  1050135 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|  1050140 |  594 | `	sxi32 rc = SXRET_OK;` |
|  1050140 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61555 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61555 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61555 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30775 |  600 | `	}` |
|  1050140 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  617 | `  */` |
|      558 |  618 | `PH7_PRIVATE sxi32 PH7_MemObjToHashmap(ph7_value *pObj)` |
|        4 |  619 | `{` |
|      562 |  620 | `	if( (pObj->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  621 | `		ph7_hashmap *pMap;` |
|        - |  622 | `		/* Allocate a new hashmap instance */` |
|      364 |  623 | `		pMap = PH7_NewHashmap(pObj->pVm,0,0);` |
|      364 |  624 | `		if( pMap == 0 ){` |
|      ! 0 |  625 | `			return SXERR_MEM;` |
|        - |  626 | `		}` |
|      364 |  627 | `		if( (pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_RES)) == 0 ){` |
|        - |  628 | `			/*` |
...
|      364 |  644 | `		PH7_MemObjRelease(pObj);` |
|      364 |  645 | `		MemObjSetType(pObj,MEMOBJ_HASHMAP);` |
|      364 |  646 | `		pObj->x.pOther = pMap;` |
|      180 |  647 | `	}` |
|      562 |  648 | `	return SXRET_OK;` |
|      283 |  649 | `}` |
...
|        - |  781 | ` */` |
|   258768 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   258773 |  786 | `	int bDigit = 0;` |
|   258773 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   258773 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   258773 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   258773 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   258173 |  795 | `	zEnd = z + n;` |
|   258201 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   258173 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      215 |  800 | `		z++;` |
|      105 |  801 | `	}` |
|   263028 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4860 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   258173 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     6103 |  806 | `		z++;` |
|     6179 |  807 | `		while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|       80 |  808 | `			z++; bDigit = 1;` |
|        4 |  809 | `		}` |
|     3255 |  810 | `	}` |
|        - |  811 | `	/* At least one mantissa digit required (rejects "", ".", "+", "e5"). */` |
|   258173 |  812 | `	if( !bDigit ){` |
|   253422 |  813 | `		return 0;` |
|        - |  814 | `	}` |
...
|     4756 |  817 | `	if( z < zEnd && (z[0] == 'e' \|\| z[0] == 'E') ){` |
...
|        - |  839 | ` */` |
|   256351 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   256356 |  842 | `	const char *zTail = 0, *zEnd;` |
|   256356 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   254012 |  844 | `		return 0;` |
|        - |  845 | `	}` |
|     2349 |  846 | `	zEnd = (const char *)SyBlobData(&pValue->sBlob) + SyBlobLength(&pValue->sBlob);` |
|     2355 |  847 | `	while( zTail < zEnd && (unsigned char)zTail[0] < 0xc0 && SyisSpace(zTail[0]) ){` |
|        8 |  848 | `		zTail++;` |
|        2 |  849 | `	}` |
|     2349 |  850 | `	return zTail == zEnd ? 1 : 0;` |
|   128054 |  851 | `}` |
|        - |  852 | `/*` |
...
|        - |  856 | ` */` |
|   257283 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   257288 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      649 |  860 | `		return TRUE;` |
|   256644 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      408 |  862 | `		return FALSE;` |
|   256240 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   256240 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   128520 |  869 | `}` |
...
|        - |  881 | ` */` |
|    41374 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    41379 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       20 |  885 | `		return TRUE;` |
|    41361 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    41341 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    41341 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    41337 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27791 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22193 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
|        - |  896 | `			const char *zIn,*zEnd;` |
|     5603 |  897 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5603 |  898 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5609 |  899 | `			while( zIn < zEnd ){` |
|     5609 |  900 | `				if( zIn[0] != '0' ){` |
|     5603 |  901 | `					break;` |
|        - |  902 | `				}` |
|        7 |  903 | `				zIn++;` |
|        1 |  904 | `			}` |
|     5603 |  905 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  906 | `		}` |
|    13551 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13551 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13551 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   623824 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   623829 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   621460 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        2 |  932 | `		}` |
|        - |  933 | `		/* Already numeric */` |
|   621460 |  934 | `		return  SXRET_OK;` |
|        - |  935 | `	}` |
|     2373 |  936 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
|     2373 |  937 | `		const char *zTail = 0;` |
|     2373 |  938 | `		int bNum, bReal = 0;` |
...
|     2373 |  943 | `		bNum = PH7_MemObjStringNumericPrefix(pObj,&zTail);` |
|     2373 |  944 | `		if( bNum ){` |
|     2373 |  945 | `			const char *z = (const char *)SyBlobData(&pObj->sBlob);` |
|     4832 |  946 | `			while( z < zTail ){` |
|     2487 |  947 | `				if( z[0] == '.' \|\| z[0] == 'e' \|\| z[0] == 'E' ){` |
|       26 |  948 | `					bReal = 1;` |
|       26 |  949 | `					break;` |
|        - |  950 | `				}` |
|     2463 |  951 | `				z++;` |
...
|     2349 |  962 | `				pObj->x.iVal = MemObjStringToInt(&(*pObj));` |
|        - |  963 | `			}` |
|     2349 |  964 | `			MemObjSetType(pObj,MEMOBJ_INT);` |
|     2349 |  965 | `			SyBlobRelease(&pObj->sBlob);` |
|        4 |  966 | `		}` |
|     1184 |  967 | `	}else if(pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_HASHMAP\|MEMOBJ_RES)){` |
|      ! 0 |  968 | `		PH7_MemObjToInteger(pObj);` |
|      ! 0 |  969 | `	}else{` |
|        - |  970 | `		/* Perform a blind cast */` |
|      ! 0 |  971 | `		PH7_MemObjToReal(&(*pObj));` |
|        - |  972 | `	}` |
|     2373 |  973 | `	return SXRET_OK;` |
|   312202 |  974 | `}` |
|        - |  975 | `/*` |
...
|        - | 1069 | ` */` |
|     1112 | 1070 | `PH7_PRIVATE sxi32 PH7_MemObjTryInteger(ph7_value *pObj)` |
|        4 | 1071 | `{` |
|     1116 | 1072 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|        - | 1073 | `		/* Work only with reals */` |
|     1116 | 1074 | `		MemObjTryIntger(&(*pObj));` |
|      556 | 1075 | `	}` |
|     1116 | 1076 | `	return SXRET_OK;` |
|        4 | 1077 | `}` |
|        - | 1078 | `/*` |
|        - | 1079 | ` * Initialize a ph7_value to the null type.` |
|        - | 1080 | ` */` |
| 28512851 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 28512856 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 28512856 | 1086 | `	pObj->pVm = pVm;` |
| 28512856 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 28512856 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 28512856 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5942984 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5942989 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5942989 | 1100 | `	pObj->pVm = pVm;` |
|  5942989 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5942989 | 1103 | `	pObj->x.iVal = iVal;` |
|  5942989 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5942989 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17532 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17537 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17537 | 1115 | `	pObj->pVm = pVm;` |
|    17537 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17537 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17537 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17537 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    63888 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    63893 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    63893 | 1145 | `	pObj->pVm = pVm;` |
|    63893 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    63893 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    63893 | 1149 | `	pObj->x.pOther = pArray;` |
|    63893 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4796936 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4796941 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4796941 | 1160 | `	pObj->pVm = pVm;` |
|  4796941 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4796941 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2407067 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1203531 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4796941 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4796941 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2810834 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2810839 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1180 | `		/* Invalidate any prior representation */` |
|     3685 | 1181 | `		PH7_MemObjRelease(pObj);` |
|     3685 | 1182 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|     1840 | 1183 | `	}` |
|        - | 1184 | `	/* Append contents */` |
|  2810839 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2810839 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  6129198 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  6129203 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  6129203 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  6129203 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   220727 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6018842 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    11803 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     5899 | 1222 | `	}` |
|  6129203 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    82393 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  6088009 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8593 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4294 | 1227 | `	}` |
|  6129203 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6129203 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  6129203 | 1230 | `	rc = SXRET_OK;` |
|  6129203 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4330613 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4330613 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2165534 | 1234 | `	}else{` |
|  1798595 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   396696 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   198707 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  6129203 | 1239 | `	if( pMap ){` |
|    82393 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  6088009 | 1241 | `	}else if( pObj ){` |
|     8593 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4294 | 1243 | `	}` |
|  6129198 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3175921 | 1245 | `	 && pDest->pVm` |
|   220722 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   110370 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  6129203 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  9076393 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  9076398 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  9076398 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   551593 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8800604 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    52673 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    26334 | 1281 | `	}` |
|  9076398 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  9076398 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4692659 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2347395 | 1287 | `	}` |
|  9076398 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 21533619 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 21533624 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18715682 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   718123 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 18356623 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    98679 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    49337 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18715682 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18715682 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9362342 | 1305 | `	}` |
| 21533624 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1746718 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1746723 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   883555 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   883555 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   883555 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   202161 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   340846 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1544567 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1544562 | 1377 | `	if( !bStrict` |
|  1204014 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   431931 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1544567 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24859 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9387 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4691 | 1400 | `		}` |
|    24859 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8321 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4158 | 1403 | `		}` |
|    24859 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1519713 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
|        - | 1406 | `		/* Hashmap aka 'array' comparison */` |
|       55 | 1407 | `		if( (pObj1->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1408 | `			/* Array is always greater */` |
|      ! 0 | 1409 | `			return -1;` |
|        - | 1410 | `		}` |
|       55 | 1411 | `		if( (pObj2->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1412 | `			/* Array is always greater */` |
|      ! 0 | 1413 | `			return 1;` |
|        - | 1414 | `		}` |
|        - | 1415 | `		/* Perform the comparison */` |
|       55 | 1416 | `		rc = PH7_HashmapCmp((ph7_hashmap *)pObj1->x.pOther,(ph7_hashmap *)pObj2->x.pOther,bStrict);` |
|       55 | 1417 | `		return rc;` |
|  1519659 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      295 | 1430 | `		return rc;` |
|  1519369 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   908306 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   254732 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   126688 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   907208 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   907208 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   907208 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   907208 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   907208 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   907208 | 1465 | `		if( rc == 0 ){` |
|   295288 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19723 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9861 | 1468 | `			}` |
|   147643 | 1469 | `		}` |
|   907208 | 1470 | `		return rc;` |
|   611068 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   305097 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   612166 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   612166 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   612166 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   611854 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7687 | 1515 | `				return 1;` |
|   604172 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   592764 | 1517 | `				return -1;` |
|        - | 1518 | `			}` |
|    11413 | 1519 | `			return 0;` |
|        - | 1520 | `		}` |
|        - | 1521 | `	}` |
...
|        - | 1536 | ` */` |
|    13016 | 1537 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1538 | `{` |
|    13021 | 1539 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1540 | `			/* Arithemtic operation */` |
|     9199 | 1541 | `			PH7_MemObjToNumeric(pObj1);` |
|     9199 | 1542 | `			PH7_MemObjToNumeric(pObj2);` |
|     9199 | 1543 | `			if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_REAL ){` |
...
|        - | 1562 | `				sxi64 a,b,r;` |
|     9131 | 1563 | `				a = pObj1->x.iVal;` |
|     9131 | 1564 | `				b = pObj2->x.iVal;` |
|     9131 | 1565 | `				if( PH7_ADD_OVERFLOW64(a,b,&r) ){` |
...
|        - | 1572 | `#endif` |
|        5 | 1573 | `				}else{` |
|     9123 | 1574 | `					pObj1->x.iVal = r;` |
|     9123 | 1575 | `					MemObjSetType(pObj1,MEMOBJ_INT);` |
|        - | 1576 | `				}` |
|        - | 1577 | `			}` |
|     4602 | 1578 | `	}else{` |
|     3827 | 1579 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
|        - | 1580 | `			ph7_hashmap *pMap;` |
|        - | 1581 | `			sxi32 rc;` |
|     3827 | 1582 | `			if( bAddStore ){` |
...
|     3825 | 1597 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|     3825 | 1598 | `				if( pMap == 0){` |
|      ! 0 | 1599 | `					PH7_VmThrowError(pObj1->pVm,0,PH7_CTX_ERR,"PH7 is running out of memory while creating array");` |
|      ! 0 | 1600 | `					return SXERR_MEM;` |
|        - | 1601 | `				}` |
|        - | 1602 | `			}` |
|     3827 | 1603 | `			if( !bAddStore ){` |
|     3825 | 1604 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1605 | `					/* Perform a hashmap duplication */` |
|     3825 | 1606 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|     1915 | 1607 | `				}else{` |
...
|     3827 | 1615 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|     3827 | 1616 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|     1916 | 1617 | `			}else{` |
...
|     3827 | 1624 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|      ! 0 | 1625 | `				SyBlobRelease(&pObj1->sBlob);` |
|      ! 0 | 1626 | `			}` |
|     3827 | 1627 | `			pObj1->x.pOther = pMap;` |
|     3827 | 1628 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|     1911 | 1629 | `		}` |
|        - | 1630 | `	}` |
|    13021 | 1631 | `	return SXRET_OK;` |
|     6513 | 1632 | `}` |
|        - | 1633 | `/*` |
...
|        - | 1707 | ` */` |
|      222 | 1708 | `PH7_PRIVATE void PH7_MemObjPrintRInline(SyBlob *pOut,ph7_value *pObj)` |
|        2 | 1709 | `{` |
|      224 | 1710 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|        7 | 1711 | `		return;` |
|        - | 1712 | `	}` |
|      218 | 1713 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      ! 0 | 1714 | `		if( pObj->x.iVal != 0 ){` |
|      ! 0 | 1715 | `			SyBlobAppend(&(*pOut),"1",sizeof(char));` |
|      ! 0 | 1716 | `		}` |
|      ! 0 | 1717 | `		return;` |
|        - | 1718 | `	}` |
|      218 | 1719 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
...
|      113 | 1728 | `}` |
|      806 | 1729 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|        - | 1737 | `	)` |
|        5 | 1738 | `{` |
|      811 | 1739 | `	sxi32 rc = SXRET_OK;` |
|        - | 1740 | `	int i;` |
|      811 | 1741 | `	if( !ShowType ){` |
...
|      114 | 1745 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|      107 | 1746 | `			return PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,FALSE,nTab,nDepth+1);` |
|        - | 1747 | `		}` |
...
|     4815 | 1757 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4119 | 1758 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2061 | 1759 | `	}` |
|      699 | 1760 | `	if( isRef ){` |
|        7 | 1761 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|        3 | 1762 | `	}` |
|      699 | 1763 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
...
|      139 | 1777 | `		return rc;` |
|        - | 1778 | `	}` |
|      563 | 1779 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       17 | 1780 | `		SyBlobAppend(&(*pOut),"NULL\n",sizeof("NULL\n")-1);` |
|       17 | 1781 | `		return SXRET_OK;` |
|        - | 1782 | `	}` |
|      547 | 1783 | `	if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|       30 | 1784 | `		rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,TRUE,nTab,nDepth+1);` |
|       30 | 1785 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|       30 | 1786 | `		return rc;` |
|        - | 1787 | `	}` |
|      519 | 1788 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      240 | 1789 | `		if( pObj->x.iVal != 0 ){` |
|      172 | 1790 | `			SyBlobAppend(&(*pOut),"bool(true)\n",sizeof("bool(true)\n")-1);` |
|       88 | 1791 | `		}else{` |
|       71 | 1792 | `			SyBlobAppend(&(*pOut),"bool(false)\n",sizeof("bool(false)\n")-1);` |
|        - | 1793 | `		}` |
|      240 | 1794 | `		return SXRET_OK;` |
|        - | 1795 | `	}` |
|      281 | 1796 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - | 1803 | `	}` |
|      277 | 1804 | `	if( pObj->iFlags & MEMOBJ_INT ){` |
|      163 | 1805 | `		SyBlobFormat(&(*pOut),"int(%qd)",pObj->x.iVal);` |
|      163 | 1806 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|      163 | 1807 | `		return SXRET_OK;` |
|        - | 1808 | `	}` |
|      117 | 1809 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
|      117 | 1810 | `		SyBlobFormat(&(*pOut),"string(%u) \"",SyBlobLength(&pObj->sBlob));` |
|      117 | 1811 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|      105 | 1812 | `			SyBlobAppend(&(*pOut),SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|       51 | 1813 | `		}` |
|      117 | 1814 | `		SyBlobAppend(&(*pOut),"\"\n",sizeof("\"\n")-1);` |
|      117 | 1815 | `		return SXRET_OK;` |
|        - | 1816 | `	}` |
