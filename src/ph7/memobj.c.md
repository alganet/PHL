...
|        - |  128 | ` */` |
|  3765986 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3765991 |  131 | `	sxi64 iVal = 0;` |
|  3765991 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3765991 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
...
|  2293517 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2402829 |  161 | `	return iVal;` |
|  1882998 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  380 | ` */` |
|    61610 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61615 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  410 | `#endif` |
|        5 |  411 | `		}` |
|    61428 |  412 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    60937 |  413 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  414 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30775 |  415 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  468 | ` */` |
|    18758 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18763 |  472 | `	iFlags = pObj->iFlags;` |
|    18763 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18751 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
...
|        - |  490 | `		}` |
|       88 |  491 | `		return 1;` |
|    17739 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16423 |  493 | `		return 0;` |
...
|        - |  546 | ` */` |
|   541298 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   541303 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|    18763 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18763 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18763 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9379 |  586 | `	}` |
...
|        - |  591 | ` */` |
|  1044801 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|  1044806 |  594 | `	sxi32 rc = SXRET_OK;` |
|  1044806 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61521 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61521 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61521 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30758 |  600 | `	}` |
|  1044806 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  781 | ` */` |
|   256693 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   256698 |  786 | `	int bDigit = 0;` |
|   256698 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   256698 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   256698 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   256698 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   256098 |  795 | `	zEnd = z + n;` |
|   256126 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   256098 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      215 |  800 | `		z++;` |
|      105 |  801 | `	}` |
|   260953 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4860 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   256098 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     6076 |  806 | `		z++;` |
...
|        - |  839 | ` */` |
|   254276 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   254281 |  842 | `	const char *zTail = 0, *zEnd;` |
|   254281 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   251937 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   255208 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   255213 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      649 |  860 | `		return TRUE;` |
|   254569 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      408 |  862 | `		return FALSE;` |
|   254165 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   254165 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   127473 |  869 | `}` |
...
|        - |  881 | ` */` |
|    41160 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    41165 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       20 |  885 | `		return TRUE;` |
|    41147 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    41127 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    41127 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    41123 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27653 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22069 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
...
|      ! 0 |  906 | `		}` |
|    13475 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13475 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13475 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   623336 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   623341 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   620972 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1080 | ` */` |
| 28088731 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 28088736 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 28088736 | 1086 | `	pObj->pVm = pVm;` |
| 28088736 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 28088736 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 28088736 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5915654 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5915659 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5915659 | 1100 | `	pObj->pVm = pVm;` |
|  5915659 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5915659 | 1103 | `	pObj->x.iVal = iVal;` |
|  5915659 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5915659 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17482 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17487 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17487 | 1115 | `	pObj->pVm = pVm;` |
|    17487 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17487 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17487 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17487 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1154 | ` */` |
|  4408136 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4408141 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4408141 | 1160 | `	pObj->pVm = pVm;` |
|  4408141 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4408141 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2129159 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1064577 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4408141 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4408141 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2699462 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2699467 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1180 | `		/* Invalidate any prior representation */` |
|     3679 | 1181 | `		PH7_MemObjRelease(pObj);` |
|     3679 | 1182 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|     1837 | 1183 | `	}` |
|        - | 1184 | `	/* Append contents */` |
|  2699467 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2699467 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  6103628 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  6103633 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  6103633 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  6103633 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   219747 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5993762 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    10319 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     5157 | 1222 | `	}` |
|  6103633 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    81849 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  6062711 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8403 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4199 | 1227 | `	}` |
|  6103633 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6103633 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  6103633 | 1230 | `	rc = SXRET_OK;` |
|  6103633 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4312863 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4312863 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2156659 | 1234 | `	}else{` |
|  1790775 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   395470 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   198094 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  6103633 | 1239 | `	if( pMap ){` |
|    81849 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  6062711 | 1241 | `	}else if( pObj ){` |
|     8403 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4199 | 1243 | `	}` |
|  6103628 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3162646 | 1245 | `	 && pDest->pVm` |
|   219742 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109880 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  6103633 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  9032141 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  9032146 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  9032146 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   548185 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8758056 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    49315 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    24655 | 1281 | `	}` |
|  9032146 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  9032146 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4665595 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2333844 | 1287 | `	}` |
|  9032146 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 21415793 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 21415798 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18644018 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   714173 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 18286934 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    92673 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    46334 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18644018 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18644018 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9326493 | 1305 | `	}` |
| 21415798 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1739903 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1739908 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   879043 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   879043 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   879043 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   200233 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   339554 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1539680 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1539675 | 1377 | `	if( !bStrict` |
|  1200419 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   430771 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1539680 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24683 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9285 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4640 | 1400 | `		}` |
|    24683 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8223 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4109 | 1403 | `		}` |
|    24683 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1515002 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       55 | 1417 | `		return rc;` |
|  1514948 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1430 | `		return rc;` |
|  1514676 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   903855 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   252657 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   125641 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   902757 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   902757 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   902757 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   902757 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   902757 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   902757 | 1465 | `		if( rc == 0 ){` |
|   294290 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19611 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9805 | 1468 | `			}` |
|   147144 | 1469 | `		}` |
|   902757 | 1470 | `		return rc;` |
|   610826 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   304975 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   611924 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   611924 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   611924 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   611612 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7591 | 1515 | `				return 1;` |
|   604026 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
