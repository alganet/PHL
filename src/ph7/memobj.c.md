...
|        - |  462 | ` */` |
|    18288 |  463 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  464 | `{` |
|        - |  465 | `	sxi32 iFlags;` |
|    18293 |  466 | `	iFlags = pObj->iFlags;` |
|    18293 |  467 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  468 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  469 | `		return pObj->rVal ? 1 : 0;` |
|        - |  470 | `#else` |
|       14 |  471 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  472 | `#endif` |
|    18281 |  473 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      875 |  474 | `		return pObj->x.iVal ? 1 : 0;` |
|    17411 |  475 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  484 | `		}` |
|       88 |  485 | `		return 1;` |
|    17303 |  486 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16015 |  487 | `		return 0;` |
...
|        - |  540 | ` */` |
|   520422 |  541 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  542 | `{` |
|   520427 |  543 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  571 | ` */` |
|    21796 |  572 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  573 | `{` |
|    21801 |  574 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  575 | `		/* Preform the conversion */` |
|    18293 |  576 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  577 | `		/* Invalidate any prior representations */` |
|    18293 |  578 | `		SyBlobRelease(&pObj->sBlob);` |
|    18293 |  579 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9144 |  580 | `	}` |
|    21801 |  581 | `	return SXRET_OK;` |
|        5 |  582 | `}` |
|        - |  583 | `/*` |
|        - |  584 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  585 | ` */` |
|   983521 |  586 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  587 | `{` |
|   983526 |  588 | `	sxi32 rc = SXRET_OK;` |
|   983526 |  589 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - |  775 | ` */` |
|   247027 |  776 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  777 | `{` |
|        - |  778 | `	const char *z, *zEnd;` |
|        - |  779 | `	sxu32 n;` |
|   247032 |  780 | `	int bDigit = 0;` |
|   247032 |  781 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  782 | `		return 0;` |
|        - |  783 | `	}` |
|   247032 |  784 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   247032 |  785 | `	n = SyBlobLength(&pValue->sBlob);` |
|   247032 |  786 | `	if( n == 0 ){` |
|      603 |  787 | `		return 0;` |
|        - |  788 | `	}` |
|   246432 |  789 | `	zEnd = z + n;` |
|   246458 |  790 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       28 |  791 | `		z++;` |
|        2 |  792 | `	}` |
|   246432 |  793 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      203 |  794 | `		z++;` |
|       99 |  795 | `	}` |
|   251242 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4814 |  797 | `		z++; bDigit = 1;` |
|        4 |  798 | `	}` |
|   246432 |  799 | `	if( z < zEnd && z[0] == '.' ){` |
|     1733 |  800 | `		z++;` |
...
|        - |  833 | ` */` |
|   244641 |  834 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  835 | `{` |
|   244646 |  836 | `	const char *zTail = 0, *zEnd;` |
|   244646 |  837 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   242314 |  838 | `		return 0;` |
|        - |  839 | `	}` |
...
|        - |  850 | ` */` |
|   245489 |  851 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  852 | `{` |
|   245494 |  853 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      597 |  854 | `		return TRUE;` |
|   244902 |  855 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      374 |  856 | `		return FALSE;` |
|   244530 |  857 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  858 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   244530 |  859 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  860 | `	}` |
|        - |  861 | `	/* NOT REACHED */` |
|      ! 0 |  862 | `	return FALSE;` |
|   122735 |  863 | `}` |
...
|        - |  875 | ` */` |
|    33814 |  876 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  877 | `{` |
|    33819 |  878 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       21 |  879 | `		return TRUE;` |
|    33801 |  880 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  881 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    33781 |  882 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  883 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    33781 |  884 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  885 | `		return !pObj->x.iVal;` |
|    33777 |  886 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27161 |  887 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21639 |  888 | `			return TRUE;` |
|      ! 0 |  889 | `		}else{` |
...
|      ! 0 |  900 | `		}` |
|     6621 |  901 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     6621 |  902 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     6621 |  903 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  917 | ` */` |
|   594559 |  918 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  919 | `{` |
|   594564 |  920 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   592226 |  921 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1074 | ` */` |
| 24271157 | 1075 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1076 | `{` |
|        - | 1077 | `	/* Zero the structure */` |
| 24271162 | 1078 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1079 | `	/* Initialize fields */` |
| 24271162 | 1080 | `	pObj->pVm = pVm;` |
| 24271162 | 1081 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1082 | `	/* Set the NULL type */` |
| 24271162 | 1083 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 24271162 | 1084 | `	return SXRET_OK;` |
|        5 | 1085 | `}` |
|        - | 1086 | `/*` |
...
|        - | 1103 | ` */` |
|    17176 | 1104 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1105 | `{` |
|        - | 1106 | `	/* Zero the structure */` |
|    17181 | 1107 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1108 | `	/* Initialize fields */` |
|    17181 | 1109 | `	pObj->pVm = pVm;` |
|    17181 | 1110 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1111 | `	/* Set the desired type */` |
|    17181 | 1112 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17181 | 1113 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17181 | 1114 | `	return SXRET_OK;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|        - | 1133 | ` */` |
|    77628 | 1134 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1135 | `{` |
|        - | 1136 | `	/* Zero the structure */` |
|    77633 | 1137 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1138 | `	/* Initialize fields */` |
|    77633 | 1139 | `	pObj->pVm = pVm;` |
|    77633 | 1140 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1141 | `	/* Set the desired type */` |
|    77633 | 1142 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    77633 | 1143 | `	pObj->x.pOther = pArray;` |
|    77633 | 1144 | `	return SXRET_OK;` |
|        5 | 1145 | `}` |
|        - | 1146 | `/*` |
|        - | 1147 | ` * Initialize a ph7_value to the string type.` |
|        - | 1148 | ` */` |
|  4203654 | 1149 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1150 | `{` |
|        - | 1151 | `	/* Zero the structure */` |
|  4203659 | 1152 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1153 | `	/* Initialize fields */` |
|  4203659 | 1154 | `	pObj->pVm = pVm;` |
|  4203659 | 1155 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4203659 | 1156 | `	if( pVal ){` |
|        - | 1157 | `		/* Append contents */` |
|  1925575 | 1158 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   962785 | 1159 | `	}` |
|        - | 1160 | `	/* Set the desired type */` |
|  4203659 | 1161 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4203659 | 1162 | `	return SXRET_OK;` |
|        5 | 1163 | `}` |
|        - | 1164 | `/*` |
...
|        - | 1169 | ` */` |
|  2672596 | 1170 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1171 | `{` |
|        - | 1172 | `	sxi32 rc;` |
|  2672601 | 1173 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2672601 | 1179 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2672601 | 1180 | `	return rc;` |
|        5 | 1181 | `}` |
|        - | 1182 | `#if 0` |
|        - | 1183 | `/*` |
...
|        - | 1204 | ` */` |
|  5592467 | 1205 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1206 | `{` |
|  5592472 | 1207 | `	ph7_class_instance *pObj = 0;` |
|  5592472 | 1208 | `	ph7_hashmap *pMap = 0;` |
|        - | 1209 | `	sxi32 rc;` |
|  5592472 | 1210 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1211 | `		/* Increment reference count */` |
|   219799 | 1212 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5482575 | 1213 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1214 | `		/* Increment reference count */` |
|     9613 | 1215 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4804 | 1216 | `	}` |
|  5592472 | 1217 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    65887 | 1218 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5559531 | 1219 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8237 | 1220 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4116 | 1221 | `	}` |
|  5592472 | 1222 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5592472 | 1223 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5592472 | 1224 | `	rc = SXRET_OK;` |
|  5592472 | 1225 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4252469 | 1226 | `		SyBlobReset(&pDest->sBlob);` |
|  4252469 | 1227 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2126237 | 1228 | `	}else{` |
|  1340008 | 1229 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   355664 | 1230 | `			SyBlobRelease(&pDest->sBlob);` |
|   177853 | 1231 | `		}` |
|        - | 1232 | `	}` |
|  5592472 | 1233 | `	if( pMap ){` |
|    65887 | 1234 | `		PH7_HashmapUnref(pMap);` |
|  5559531 | 1235 | `	}else if( pObj ){` |
|     8237 | 1236 | `		PH7_ClassInstanceUnref(pObj);` |
|     4116 | 1237 | `	}` |
|  5592467 | 1238 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2906154 | 1239 | `	 && pDest->pVm` |
|   219794 | 1240 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   109906 | 1244 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1257 | `		}` |
|        4 | 1258 | `	}` |
|  5592472 | 1259 | `	return rc;` |
|        5 | 1260 | `}` |
|        - | 1261 | `/*` |
|        - | 1262 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1263 | ` * buffer contents,simply point to it.` |
|        - | 1264 | ` */` |
|  8520792 | 1265 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1266 | `{` |
|  8520797 | 1267 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1268 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8520797 | 1269 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1270 | `		/* Increment reference count */` |
|   515281 | 1271 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8263159 | 1272 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1273 | `		/* Increment reference count */` |
|    47287 | 1274 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    23641 | 1275 | `	}` |
|  8520797 | 1276 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1277 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1278 | `	}` |
|  8520797 | 1279 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4414755 | 1280 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2207393 | 1281 | `	}` |
|  8520797 | 1282 | `	return SXRET_OK;` |
|        5 | 1283 | `}` |
|        - | 1284 | `/*` |
|        - | 1285 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1286 | ` */` |
| 20021075 | 1287 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1288 | `{` |
| 20021080 | 1289 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 17315221 | 1290 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   708801 | 1291 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 16960823 | 1292 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    88853 | 1293 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    44424 | 1294 | `		}` |
|        - | 1295 | `		/* Release the internal buffer */` |
| 17315221 | 1296 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1297 | `		/* Invalidate any prior representation */` |
| 17315221 | 1298 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  8657766 | 1299 | `	}` |
| 20021080 | 1300 | `	return SXRET_OK;` |
|        5 | 1301 | `}` |
|        - | 1302 | `/*` |
...
|        - | 1354 | ` */` |
|  1653169 | 1355 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1356 | `{` |
|        - | 1357 | `	sxi32 iComb;` |
|        - | 1358 | `	sxi32 rc;` |
|  1653174 | 1359 | `	if( bStrict ){` |
|        - | 1360 | `		sxi32 iF1,iF2;` |
|        - | 1361 | `		/* Strict comparisons with === */` |
|   845052 | 1362 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   845052 | 1363 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   845052 | 1364 | `		if( iF1 != iF2 ){` |
|        - | 1365 | `			/* Not of the same type */` |
|   191949 | 1366 | `			return 1;` |
|        - | 1367 | `		}` |
|   326551 | 1368 | `	}` |
|        - | 1369 | `	/* Combine flag together */` |
|  1461230 | 1370 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1461225 | 1371 | `	if( !bStrict` |
|  1134673 | 1372 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   404109 | 1373 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1389 | `	}` |
|  1461230 | 1390 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1391 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24235 | 1392 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9067 | 1393 | `			PH7_MemObjToBool(pObj1);` |
|     4531 | 1394 | `		}` |
|    24235 | 1395 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8019 | 1396 | `			PH7_MemObjToBool(pObj2);` |
|     4007 | 1397 | `		}` |
|    24235 | 1398 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1437000 | 1399 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1411 | `		return rc;` |
|  1436970 | 1412 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1424 | `		return rc;` |
|  1436698 | 1425 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1426 | `		SyString s1,s2;` |
|   869120 | 1427 | `		if( !bStrict ){` |
|        - | 1428 | `			/*` |
...
|        - | 1439 | `			 */` |
|   243042 | 1440 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1441 | `				/* Perform a numeric comparison */` |
|     1099 | 1442 | `				goto Numeric;` |
|        - | 1443 | `			}` |
|   120955 | 1444 | `		}` |
|        - | 1445 | `		/* Perform a strict string comparison.*/` |
|   868022 | 1446 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1447 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1448 | `		}` |
|   868022 | 1449 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1450 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1451 | `		}` |
|   868022 | 1452 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   868022 | 1453 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1454 | `		/*` |
...
|        - | 1457 | `		 */` |
|   868022 | 1458 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   868022 | 1459 | `		if( rc == 0 ){` |
|   287930 | 1460 | `			if( s1.nByte != s2.nByte ){` |
|    17254 | 1461 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     8626 | 1462 | `			}` |
|   143964 | 1463 | `		}` |
|   868022 | 1464 | `		return rc;` |
|   567583 | 1465 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   283766 | 1466 | `Numeric:` |
|        - | 1467 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   568681 | 1468 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1469 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1470 | `		}` |
|   568681 | 1471 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1472 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1473 | `		}` |
|   568681 | 1474 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1475 | `			/*` |
...
|   568369 | 1508 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7493 | 1509 | `				return 1;` |
|   560881 | 1510 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   549682 | 1511 | `				return -1;` |
|        - | 1512 | `			}` |
|    11204 | 1513 | `			return 0;` |
|        - | 1514 | `		}` |
|        - | 1515 | `	}` |
