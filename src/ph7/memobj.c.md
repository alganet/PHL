...
|        - |   93 | ` */` |
|    10594 |   94 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|        5 |   95 | `{` |
...
|    10599 |  111 | `  ph7_real r = pObj->rVal;` |
|    10599 |  112 | `  if( r<(ph7_real)minInt ){` |
|        3 |  113 | `    return minInt;` |
|    10597 |  114 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  128 | ` */` |
|  3016534 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3016539 |  131 | `	sxi64 iVal = 0;` |
|  3016539 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3016539 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1121043 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1116833 |  138 | `			return 0;` |
|        - |  139 | `		}` |
|     4215 |  140 | `		c = pVal->zString[1];` |
|     4215 |  141 | `		if( c  == 'x' \|\| c == 'X' ){` |
|        - |  142 | `			/* Hex digit stream */` |
|       71 |  143 | `			SyHexStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|     4180 |  144 | `		}else if( c == 'b' \|\| c == 'B' ){` |
|        - |  145 | `			/* Binary digit stream */` |
|      279 |  146 | `			SyBinaryStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|      140 |  147 | `		}else{` |
|        - |  148 | `			/* Octal digit stream */` |
|     3867 |  149 | `			SyOctalStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  150 | `		}` |
|     2110 |  151 | `	}else{` |
|        - |  152 | `		/* Decimal digit stream */` |
|  1895501 |  153 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  154 | `	}` |
|  1899711 |  155 | `	return iVal;` |
|  1508272 |  156 | `}` |
|        - |  157 | `/*` |
...
|        - |  253 | ` */` |
|     9408 |  254 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|        5 |  255 | `{` |
|        - |  256 | `	sxi32 iFlags;` |
|     9413 |  257 | `	iFlags = pObj->iFlags;` |
|     9413 |  258 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  259 | `		return pObj->rVal;` |
|     9413 |  260 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      764 |  261 | `		return (ph7_real)pObj->x.iVal;` |
|     8651 |  262 | `	}else if (iFlags & MEMOBJ_STRING){` |
|        - |  263 | `		SyString sString;` |
|        - |  264 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  265 | `		ph7_real rVal = 0;` |
|        - |  266 | `#else` |
|     8645 |  267 | `		ph7_real rVal = 0.0;` |
|        - |  268 | `#endif` |
|     8645 |  269 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|     8645 |  270 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|        - |  271 | `			/* Convert as much as we can */` |
|        - |  272 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  273 | `			rVal = MemObjStringToInt(&(*pObj));` |
|        - |  274 | `#else` |
|     8645 |  275 | `			SyStrToReal(sString.zString,sString.nByte,(void *)&rVal,0);` |
|        - |  276 | `#endif` |
|     4320 |  277 | `		}` |
|     8645 |  278 | `		return rVal;` |
...
|        - |  324 | ` */` |
|      498 |  325 | `PH7_PRIVATE sxi32 PH7_PhpFloatShape(char *zBuf,sxi32 nLen,int bGeneric)` |
|        5 |  326 | `{` |
|        - |  327 | `	sxi32 iExp,i;` |
|      503 |  328 | `	iExp = nLen - 1;` |
|     4245 |  329 | `	while( iExp > 0 && zBuf[iExp] != 'e' && zBuf[iExp] != 'E' ){` |
|     3747 |  330 | `		iExp--;` |
|        5 |  331 | `	}` |
|      503 |  332 | `	if( iExp <= 0 ){` |
|      457 |  333 | `		return nLen; /* No exponent part (fixed notation) */` |
|        - |  334 | `	}` |
|        - |  335 | `	{` |
...
|        - |  374 | ` */` |
|    58968 |  375 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  376 | `{` |
|    58973 |  377 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  404 | `#endif` |
|        4 |  405 | `		}` |
|    58790 |  406 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    58301 |  407 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  408 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    29459 |  409 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|        - |  462 | ` */` |
|    17716 |  463 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  464 | `{` |
|        - |  465 | `	sxi32 iFlags;` |
|    17721 |  466 | `	iFlags = pObj->iFlags;` |
|    17721 |  467 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  468 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  469 | `		return pObj->rVal ? 1 : 0;` |
|        - |  470 | `#else` |
|       14 |  471 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  472 | `#endif` |
|    17709 |  473 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      821 |  474 | `		return pObj->x.iVal ? 1 : 0;` |
|    16893 |  475 | `	}else if (iFlags & MEMOBJ_STRING) {` |
|        - |  476 | `		SyString sString;` |
|      110 |  477 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|        - |  478 | `		/* php: a string is FALSE iff it is empty or exactly "0" */` |
|      110 |  479 | `		if( sString.nByte == 0 ){` |
|       18 |  480 | `			return 0;` |
|        - |  481 | `		}` |
...
|        - |  484 | `		}` |
|       88 |  485 | `		return 1;` |
|    16785 |  486 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    15551 |  487 | `		return 0;` |
...
|        - |  516 | ` */` |
|    10554 |  517 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|        5 |  518 | `{` |
|    10559 |  519 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|        - |  531 | `  */` |
|    10554 |  532 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|     9145 |  533 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     9129 |  534 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|     4564 |  535 | `	}` |
|    10559 |  536 | `	return SXRET_OK;` |
|        5 |  537 | `}` |
|        - |  538 | `/*` |
|        - |  539 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  540 | ` */` |
|   510750 |  541 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  542 | `{` |
|   510755 |  543 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|      440 |  549 | `	}` |
|   510755 |  550 | `	return SXRET_OK;` |
|        5 |  551 | `}` |
|        - |  552 | `/*` |
|        - |  553 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  554 | ` * Invalidate any prior representations` |
|        - |  555 | ` */` |
|    10362 |  556 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        5 |  557 | `{` |
|    10367 |  558 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  559 | `		/* Preform the conversion */` |
|     9413 |  560 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  561 | `		/* Invalidate any prior representations */` |
|     9413 |  562 | `		SyBlobRelease(&pObj->sBlob);` |
|     9413 |  563 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  564 | `		/* Try to get an integer representation */` |
|     9413 |  565 | `		MemObjTryIntger(&(*pObj));` |
|     4704 |  566 | `	}` |
|    10367 |  567 | `	return SXRET_OK;` |
|        5 |  568 | `}` |
|        - |  569 | `/*` |
|        - |  570 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  571 | ` */` |
|    20744 |  572 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  573 | `{` |
|    20749 |  574 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  575 | `		/* Preform the conversion */` |
|    17721 |  576 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  577 | `		/* Invalidate any prior representations */` |
|    17721 |  578 | `		SyBlobRelease(&pObj->sBlob);` |
|    17721 |  579 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     8858 |  580 | `	}` |
|    20749 |  581 | `	return SXRET_OK;` |
|        5 |  582 | `}` |
|        - |  583 | `/*` |
|        - |  584 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  585 | ` */` |
|   964729 |  586 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  587 | `{` |
|   964734 |  588 | `	sxi32 rc = SXRET_OK;` |
|   964734 |  589 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  590 | `		/* Perform the conversion */` |
|    58879 |  591 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    58879 |  592 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    58879 |  593 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    29437 |  594 | `	}` |
|   964734 |  595 | `	return rc;` |
|        5 |  596 | `}` |
|        - |  597 | `/*` |
...
|        - |  611 | `  */` |
|      542 |  612 | `PH7_PRIVATE sxi32 PH7_MemObjToHashmap(ph7_value *pObj)` |
|        4 |  613 | `{` |
|      546 |  614 | `	if( (pObj->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|        - |  615 | `		ph7_hashmap *pMap;` |
|        - |  616 | `		/* Allocate a new hashmap instance */` |
|      354 |  617 | `		pMap = PH7_NewHashmap(pObj->pVm,0,0);` |
|      354 |  618 | `		if( pMap == 0 ){` |
|      ! 0 |  619 | `			return SXERR_MEM;` |
|        - |  620 | `		}` |
|      354 |  621 | `		if( (pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_RES)) == 0 ){` |
|        - |  622 | `			/*` |
...
|      354 |  638 | `		PH7_MemObjRelease(pObj);` |
|      354 |  639 | `		MemObjSetType(pObj,MEMOBJ_HASHMAP);` |
|      354 |  640 | `		pObj->x.pOther = pMap;` |
|      175 |  641 | `	}` |
|      546 |  642 | `	return SXRET_OK;` |
|      275 |  643 | `}` |
...
|        - |  775 | ` */` |
|   236043 |  776 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  777 | `{` |
|        - |  778 | `	const char *z, *zEnd;` |
|        - |  779 | `	sxu32 n;` |
|   236048 |  780 | `	int bDigit = 0;` |
|   236048 |  781 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  782 | `		return 0;` |
|        - |  783 | `	}` |
|   236048 |  784 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   236048 |  785 | `	n = SyBlobLength(&pValue->sBlob);` |
|   236048 |  786 | `	if( n == 0 ){` |
|       75 |  787 | `		return 0;` |
|        - |  788 | `	}` |
|   235976 |  789 | `	zEnd = z + n;` |
|   236002 |  790 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       28 |  791 | `		z++;` |
|        2 |  792 | `	}` |
|   235976 |  793 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|       59 |  794 | `		z++;` |
|       27 |  795 | `	}` |
|   236450 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|      478 |  797 | `		z++; bDigit = 1;` |
|        4 |  798 | `	}` |
|   235976 |  799 | `	if( z < zEnd && z[0] == '.' ){` |
|       71 |  800 | `		z++;` |
...
|        - |  833 | ` */` |
|   235815 |  834 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  835 | `{` |
|   235820 |  836 | `	const char *zTail = 0, *zEnd;` |
|   235820 |  837 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   235656 |  838 | `		return 0;` |
|        - |  839 | `	}` |
...
|        - |  850 | ` */` |
|   236545 |  851 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  852 | `{` |
|   236550 |  853 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      547 |  854 | `		return TRUE;` |
|   236008 |  855 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      306 |  856 | `		return FALSE;` |
|   235704 |  857 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  858 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   235704 |  859 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  860 | `	}` |
|        - |  861 | `	/* NOT REACHED */` |
|      ! 0 |  862 | `	return FALSE;` |
|   118239 |  863 | `}` |
...
|        - |  875 | ` */` |
|    33468 |  876 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  877 | `{` |
|    33473 |  878 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       21 |  879 | `		return TRUE;` |
|    33455 |  880 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  881 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    33435 |  882 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  883 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    33435 |  884 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  885 | `		return !pObj->x.iVal;` |
|    33431 |  886 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    26885 |  887 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21375 |  888 | `			return TRUE;` |
|      ! 0 |  889 | `		}else{` |
|        - |  890 | `			const char *zIn,*zEnd;` |
|     5515 |  891 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5515 |  892 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5521 |  893 | `			while( zIn < zEnd ){` |
|     5521 |  894 | `				if( zIn[0] != '0' ){` |
|     5515 |  895 | `					break;` |
|        - |  896 | `				}` |
|        7 |  897 | `				zIn++;` |
|        1 |  898 | `			}` |
|     5515 |  899 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  900 | `		}` |
|     6551 |  901 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|     6551 |  902 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|     6551 |  903 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  917 | ` */` |
|   582643 |  918 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  919 | `{` |
|   582648 |  920 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   582468 |  921 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1063 | ` */` |
|     1078 | 1064 | `PH7_PRIVATE sxi32 PH7_MemObjTryInteger(ph7_value *pObj)` |
|        2 | 1065 | `{` |
|     1080 | 1066 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|        - | 1067 | `		/* Work only with reals */` |
|     1080 | 1068 | `		MemObjTryIntger(&(*pObj));` |
|      539 | 1069 | `	}` |
|     1080 | 1070 | `	return SXRET_OK;` |
|        2 | 1071 | `}` |
|        - | 1072 | `/*` |
|        - | 1073 | ` * Initialize a ph7_value to the null type.` |
|        - | 1074 | ` */` |
| 23637959 | 1075 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1076 | `{` |
|        - | 1077 | `	/* Zero the structure */` |
| 23637964 | 1078 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1079 | `	/* Initialize fields */` |
| 23637964 | 1080 | `	pObj->pVm = pVm;` |
| 23637964 | 1081 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1082 | `	/* Set the NULL type */` |
| 23637964 | 1083 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 23637964 | 1084 | `	return SXRET_OK;` |
|        5 | 1085 | `}` |
|        - | 1086 | `/*` |
|        - | 1087 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1088 | ` */` |
|  5162456 | 1089 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1090 | `{` |
|        - | 1091 | `	/* Zero the structure */` |
|  5162461 | 1092 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1093 | `	/* Initialize fields */` |
|  5162461 | 1094 | `	pObj->pVm = pVm;` |
|  5162461 | 1095 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1096 | `	/* Set the desired type */` |
|  5162461 | 1097 | `	pObj->x.iVal = iVal;` |
|  5162461 | 1098 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5162461 | 1099 | `	return SXRET_OK;` |
|        5 | 1100 | `}` |
|        - | 1101 | `/*` |
|        - | 1102 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1103 | ` */` |
|    17018 | 1104 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1105 | `{` |
|        - | 1106 | `	/* Zero the structure */` |
|    17023 | 1107 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1108 | `	/* Initialize fields */` |
|    17023 | 1109 | `	pObj->pVm = pVm;` |
|    17023 | 1110 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1111 | `	/* Set the desired type */` |
|    17023 | 1112 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17023 | 1113 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17023 | 1114 | `	return SXRET_OK;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|        - | 1133 | ` */` |
|    73276 | 1134 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1135 | `{` |
|        - | 1136 | `	/* Zero the structure */` |
|    73281 | 1137 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1138 | `	/* Initialize fields */` |
|    73281 | 1139 | `	pObj->pVm = pVm;` |
|    73281 | 1140 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1141 | `	/* Set the desired type */` |
|    73281 | 1142 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    73281 | 1143 | `	pObj->x.pOther = pArray;` |
|    73281 | 1144 | `	return SXRET_OK;` |
|        5 | 1145 | `}` |
|        - | 1146 | `/*` |
|        - | 1147 | ` * Initialize a ph7_value to the string type.` |
|        - | 1148 | ` */` |
|  3877946 | 1149 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1150 | `{` |
|        - | 1151 | `	/* Zero the structure */` |
|  3877951 | 1152 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1153 | `	/* Initialize fields */` |
|  3877951 | 1154 | `	pObj->pVm = pVm;` |
|  3877951 | 1155 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  3877951 | 1156 | `	if( pVal ){` |
|        - | 1157 | `		/* Append contents */` |
|  1805107 | 1158 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   902551 | 1159 | `	}` |
|        - | 1160 | `	/* Set the desired type */` |
|  3877951 | 1161 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  3877951 | 1162 | `	return SXRET_OK;` |
|        5 | 1163 | `}` |
|        - | 1164 | `/*` |
...
|        - | 1169 | ` */` |
|  2439714 | 1170 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1171 | `{` |
|        - | 1172 | `	sxi32 rc;` |
|  2439719 | 1173 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1174 | `		/* Invalidate any prior representation */` |
|     3089 | 1175 | `		PH7_MemObjRelease(pObj);` |
|     3089 | 1176 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|     1542 | 1177 | `	}` |
|        - | 1178 | `	/* Append contents */` |
|  2439719 | 1179 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2439719 | 1180 | `	return rc;` |
|        5 | 1181 | `}` |
|        - | 1182 | `#if 0` |
|        - | 1183 | `/*` |
...
|        - | 1204 | ` */` |
|  5435401 | 1205 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1206 | `{` |
|  5435406 | 1207 | `	ph7_class_instance *pObj = 0;` |
|  5435406 | 1208 | `	ph7_hashmap *pMap = 0;` |
|        - | 1209 | `	sxi32 rc;` |
|  5435406 | 1210 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1211 | `		/* Increment reference count */` |
|   211853 | 1212 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5329482 | 1213 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1214 | `		/* Increment reference count */` |
|     9347 | 1215 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     4671 | 1216 | `	}` |
|  5435406 | 1217 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    64157 | 1218 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5403330 | 1219 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8159 | 1220 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4077 | 1221 | `	}` |
|  5435406 | 1222 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5435406 | 1223 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5435406 | 1224 | `	rc = SXRET_OK;` |
|  5435406 | 1225 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4164179 | 1226 | `		SyBlobReset(&pDest->sBlob);` |
|  4164179 | 1227 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2082092 | 1228 | `	}else{` |
|  1271232 | 1229 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   350606 | 1230 | `			SyBlobRelease(&pDest->sBlob);` |
|   175324 | 1231 | `		}` |
|        - | 1232 | `	}` |
|  5435406 | 1233 | `	if( pMap ){` |
|    64157 | 1234 | `		PH7_HashmapUnref(pMap);` |
|  5403330 | 1235 | `	}else if( pObj ){` |
|     8159 | 1236 | `		PH7_ClassInstanceUnref(pObj);` |
|     4077 | 1237 | `	}` |
|  5435401 | 1238 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  2823648 | 1239 | `	 && pDest->pVm` |
|   211848 | 1240 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   105933 | 1244 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1257 | `		}` |
|        4 | 1258 | `	}` |
|  5435406 | 1259 | `	return rc;` |
|        5 | 1260 | `}` |
|        - | 1261 | `/*` |
|        - | 1262 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1263 | ` * buffer contents,simply point to it.` |
|        - | 1264 | ` */` |
|  8366396 | 1265 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1266 | `{` |
|  8366401 | 1267 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1268 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8366401 | 1269 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1270 | `		/* Increment reference count */` |
|   502903 | 1271 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8114952 | 1272 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1273 | `		/* Increment reference count */` |
|    45887 | 1274 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    22941 | 1275 | `	}` |
|  8366401 | 1276 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1277 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1278 | `	}` |
|  8366401 | 1279 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4338681 | 1280 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2169308 | 1281 | `	}` |
|  8366401 | 1282 | `	return SXRET_OK;` |
|        5 | 1283 | `}` |
|        - | 1284 | `/*` |
|        - | 1285 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1286 | ` */` |
| 19941631 | 1287 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1288 | `{` |
| 19941636 | 1289 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 16998049 | 1290 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   690131 | 1291 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 16652986 | 1292 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    86549 | 1293 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    43272 | 1294 | `		}` |
|        - | 1295 | `		/* Release the internal buffer */` |
| 16998049 | 1296 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1297 | `		/* Invalidate any prior representation */` |
| 16998049 | 1298 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  8499138 | 1299 | `	}` |
| 19941636 | 1300 | `	return SXRET_OK;` |
|        5 | 1301 | `}` |
|        - | 1302 | `/*` |
...
|        - | 1354 | ` */` |
|  1626361 | 1355 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1356 | `{` |
|        - | 1357 | `	sxi32 iComb;` |
|        - | 1358 | `	sxi32 rc;` |
|  1626366 | 1359 | `	if( bStrict ){` |
|        - | 1360 | `		sxi32 iF1,iF2;` |
|        - | 1361 | `		/* Strict comparisons with === */` |
|   833900 | 1362 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   833900 | 1363 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   833900 | 1364 | `		if( iF1 != iF2 ){` |
|        - | 1365 | `			/* Not of the same type */` |
|   187873 | 1366 | `			return 1;` |
|        - | 1367 | `		}` |
|   323014 | 1368 | `	}` |
|        - | 1369 | `	/* Combine flag together */` |
|  1438498 | 1370 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1438493 | 1371 | `	if( !bStrict` |
|  1115480 | 1372 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   396259 | 1373 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1389 | `	}` |
|  1438498 | 1390 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1391 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    23521 | 1392 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8781 | 1393 | `			PH7_MemObjToBool(pObj1);` |
|     4388 | 1394 | `		}` |
|    23521 | 1395 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7785 | 1396 | `			PH7_MemObjToBool(pObj2);` |
|     3890 | 1397 | `		}` |
|    23521 | 1398 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1414982 | 1399 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       31 | 1411 | `		return rc;` |
|  1414952 | 1412 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1424 | `		return rc;` |
|  1414680 | 1425 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1426 | `		SyString s1,s2;` |
|   855746 | 1427 | `		if( !bStrict ){` |
|        - | 1428 | `			/*` |
...
|        - | 1439 | `			 */` |
|   235376 | 1440 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1441 | `				/* Perform a numeric comparison */` |
|       29 | 1442 | `				goto Numeric;` |
|        - | 1443 | `			}` |
|   117633 | 1444 | `		}` |
|        - | 1445 | `		/* Perform a strict string comparison.*/` |
|   855718 | 1446 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1447 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1448 | `		}` |
|   855718 | 1449 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1450 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1451 | `		}` |
|   855718 | 1452 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   855718 | 1453 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1454 | `		/*` |
...
|        - | 1457 | `		 */` |
|   855718 | 1458 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   855718 | 1459 | `		if( rc == 0 ){` |
|   284195 | 1460 | `			if( s1.nByte != s2.nByte ){` |
|    15153 | 1461 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     7576 | 1462 | `			}` |
|   142097 | 1463 | `		}` |
|   855718 | 1464 | `		return rc;` |
|   558939 | 1465 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   279441 | 1466 | `Numeric:` |
|        - | 1467 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   558967 | 1468 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       11 | 1469 | `			PH7_MemObjToNumeric(pObj1);` |
|        5 | 1470 | `		}` |
|   558967 | 1471 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       19 | 1472 | `			PH7_MemObjToNumeric(pObj2);` |
|        9 | 1473 | `		}` |
|   558967 | 1474 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1475 | `			/*` |
...
|   558655 | 1508 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     6920 | 1509 | `				return 1;` |
|   551740 | 1510 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   543012 | 1511 | `				return -1;` |
|        - | 1512 | `			}` |
|     8733 | 1513 | `			return 0;` |
|        - | 1514 | `		}` |
|        - | 1515 | `	}` |
...
|        - | 1530 | ` */` |
|    11026 | 1531 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1532 | `{` |
|    11031 | 1533 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1534 | `			/* Arithemtic operation */` |
|     7275 | 1535 | `			PH7_MemObjToNumeric(pObj1);` |
|     7275 | 1536 | `			PH7_MemObjToNumeric(pObj2);` |
|     7275 | 1537 | `			if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_REAL ){` |
...
|        - | 1556 | `				sxi64 a,b,r;` |
|     7207 | 1557 | `				a = pObj1->x.iVal;` |
|     7207 | 1558 | `				b = pObj2->x.iVal;` |
|     7207 | 1559 | `				if( PH7_ADD_OVERFLOW64(a,b,&r) ){` |
...
|        - | 1566 | `#endif` |
|        5 | 1567 | `				}else{` |
|     7199 | 1568 | `					pObj1->x.iVal = r;` |
|     7199 | 1569 | `					MemObjSetType(pObj1,MEMOBJ_INT);` |
|        - | 1570 | `				}` |
|        - | 1571 | `			}` |
|     3640 | 1572 | `	}else{` |
|     3761 | 1573 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
|        - | 1574 | `			ph7_hashmap *pMap;` |
|        - | 1575 | `			sxi32 rc;` |
|     3761 | 1576 | `			if( bAddStore ){` |
...
|     3759 | 1591 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|     3759 | 1592 | `				if( pMap == 0){` |
|      ! 0 | 1593 | `					PH7_VmThrowError(pObj1->pVm,0,PH7_CTX_ERR,"PH7 is running out of memory while creating array");` |
|      ! 0 | 1594 | `					return SXERR_MEM;` |
|        - | 1595 | `				}` |
|        - | 1596 | `			}` |
|     3761 | 1597 | `			if( !bAddStore ){` |
|     3759 | 1598 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1599 | `					/* Perform a hashmap duplication */` |
|     3759 | 1600 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|     1882 | 1601 | `				}else{` |
...
|     3761 | 1609 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|     3761 | 1610 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|     1883 | 1611 | `			}else{` |
...
|     3761 | 1618 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|      ! 0 | 1619 | `				SyBlobRelease(&pObj1->sBlob);` |
|      ! 0 | 1620 | `			}` |
|     3761 | 1621 | `			pObj1->x.pOther = pMap;` |
|     3761 | 1622 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|     1878 | 1623 | `		}` |
|        - | 1624 | `	}` |
|    11031 | 1625 | `	return SXRET_OK;` |
|     5518 | 1626 | `}` |
|        - | 1627 | `/*` |
...
|        - | 1731 | `	)` |
|        5 | 1732 | `{` |
|      531 | 1733 | `	sxi32 rc = SXRET_OK;` |
|        - | 1734 | `	int i;` |
|      531 | 1735 | `	if( !ShowType ){` |
...
|     4477 | 1751 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4060 | 1752 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2032 | 1753 | `	}` |
|      421 | 1754 | `	if( isRef ){` |
|        7 | 1755 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|        3 | 1756 | `	}` |
|      421 | 1757 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
