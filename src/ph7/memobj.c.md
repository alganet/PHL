...
|        - |   93 | ` */` |
|    10754 |   94 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|        5 |   95 | `{` |
...
|    10759 |  111 | `  ph7_real r = pObj->rVal;` |
|    10759 |  112 | `  if( r<(ph7_real)minInt ){` |
|        3 |  113 | `    return minInt;` |
|    10757 |  114 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  128 | ` */` |
|  3812616 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3812621 |  131 | `	sxi64 iVal = 0;` |
|  3812621 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3812621 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1498955 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1389979 |  138 | `			return 0;` |
|        - |  139 | `		}` |
|   108981 |  140 | `		c = pVal->zString[1];` |
|   108981 |  141 | `		if( c  == 'x' \|\| c == 'X' ){` |
|        - |  142 | `			/* Hex digit stream */` |
|   104741 |  143 | `			SyHexStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|    56613 |  144 | `		}else if( c == 'b' \|\| c == 'B' ){` |
...
|     3949 |  155 | `			SyOctalStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  156 | `		}` |
|    54493 |  157 | `	}else{` |
|        - |  158 | `		/* Decimal digit stream */` |
|  2313671 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2422647 |  161 | `	return iVal;` |
|  1906313 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  259 | ` */` |
|     9580 |  260 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|        5 |  261 | `{` |
|        - |  262 | `	sxi32 iFlags;` |
|     9585 |  263 | `	iFlags = pObj->iFlags;` |
|     9585 |  264 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  265 | `		return pObj->rVal;` |
|     9585 |  266 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      765 |  267 | `		return (ph7_real)pObj->x.iVal;` |
|     8823 |  268 | `	}else if (iFlags & MEMOBJ_STRING){` |
|        - |  269 | `		SyString sString;` |
|        - |  270 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  271 | `		ph7_real rVal = 0;` |
|        - |  272 | `#else` |
|     8817 |  273 | `		ph7_real rVal = 0.0;` |
|        - |  274 | `#endif` |
|     8817 |  275 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|     8817 |  276 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|        - |  277 | `			/* Convert as much as we can */` |
|        - |  278 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  279 | `			rVal = MemObjStringToInt(&(*pObj));` |
|        - |  280 | `#else` |
|     8817 |  281 | `			SyStrToReal(sString.zString,sString.nByte,(void *)&rVal,0);` |
|        - |  282 | `#endif` |
|     4406 |  283 | `		}` |
|     8817 |  284 | `		return rVal;` |
...
|        - |  380 | ` */` |
|    61664 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61669 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  410 | `#endif` |
|        4 |  411 | `		}` |
|    61484 |  412 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    61005 |  413 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
|        - |  414 | `		/* %qd (BSD quad) is equivalent to %lld in the libc printf */` |
|    30799 |  415 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
...
|      172 |  449 | `	}else if(pObj->iFlags & MEMOBJ_RES ){` |
|        3 |  450 | `		SyBlobFormat(&(*pOut),"ResourceID_%#x",pObj->x.pOther);` |
|        1 |  451 | `	}` |
|    61669 |  452 | `	return SXRET_OK;` |
|        5 |  453 | `}` |
|        - |  454 | `/*` |
...
|        - |  468 | ` */` |
|    18506 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18511 |  472 | `	iFlags = pObj->iFlags;` |
|    18511 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18499 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      925 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    17579 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  490 | `		}` |
|       66 |  491 | `		return 1;` |
|    17493 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16187 |  493 | `		return 0;` |
...
|        - |  522 | ` */` |
|    10734 |  523 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|        5 |  524 | `{` |
|    10739 |  525 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|        - |  537 | `  */` |
|    10734 |  538 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|     9307 |  539 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     9291 |  540 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|     4645 |  541 | `	}` |
|    10739 |  542 | `	return SXRET_OK;` |
|        5 |  543 | `}` |
|        - |  544 | `/*` |
|        - |  545 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  546 | ` */` |
|   529146 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   529151 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|      681 |  555 | `	}` |
|   529151 |  556 | `	return SXRET_OK;` |
|        5 |  557 | `}` |
|        - |  558 | `/*` |
|        - |  559 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  560 | ` * Invalidate any prior representations` |
|        - |  561 | ` */` |
|    10572 |  562 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        5 |  563 | `{` |
|    10577 |  564 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  565 | `		/* Preform the conversion */` |
|     9585 |  566 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  567 | `		/* Invalidate any prior representations */` |
|     9585 |  568 | `		SyBlobRelease(&pObj->sBlob);` |
|     9585 |  569 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  570 | `		/* Try to get an integer representation */` |
|     9585 |  571 | `		MemObjTryIntger(&(*pObj));` |
|     4790 |  572 | `	}` |
|    10577 |  573 | `	return SXRET_OK;` |
|        5 |  574 | `}` |
|        - |  575 | `/*` |
|        - |  576 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  577 | ` */` |
|    22626 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22631 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18511 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18511 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18511 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9253 |  586 | `	}` |
|    22631 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|   958761 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|   958766 |  594 | `	sxi32 rc = SXRET_OK;` |
|   958766 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61571 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61571 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61571 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30783 |  600 | `	}` |
|   958766 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  781 | ` */` |
|   249214 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   249219 |  786 | `	int bDigit = 0;` |
|   249219 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   249219 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   249219 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   249219 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   248619 |  795 | `	zEnd = z + n;` |
|   248643 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       26 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   248619 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      215 |  800 | `		z++;` |
|      105 |  801 | `	}` |
|   253468 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4854 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   248619 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     6037 |  806 | `		z++;` |
...
|        - |  839 | ` */` |
|   246805 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   246810 |  842 | `	const char *zTail = 0, *zEnd;` |
|   246810 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   244464 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   247749 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   247754 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      659 |  860 | `		return TRUE;` |
|   247100 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      412 |  862 | `		return FALSE;` |
|   246692 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   246692 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   123767 |  869 | `}` |
...
|        - |  881 | ` */` |
|    39606 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    39611 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       21 |  885 | `		return TRUE;` |
|    39593 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    39573 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    39573 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    39569 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    26495 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21147 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
|        - |  896 | `			const char *zIn,*zEnd;` |
|     5353 |  897 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5353 |  898 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5359 |  899 | `			while( zIn < zEnd ){` |
|     5359 |  900 | `				if( zIn[0] != '0' ){` |
|     5353 |  901 | `					break;` |
|        - |  902 | `				}` |
|        7 |  903 | `				zIn++;` |
|        1 |  904 | `			}` |
|     5353 |  905 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  906 | `		}` |
...
|        - |  923 | ` */` |
|   516717 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   516722 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   514361 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1069 | ` */` |
|     1086 | 1070 | `PH7_PRIVATE sxi32 PH7_MemObjTryInteger(ph7_value *pObj)` |
|        4 | 1071 | `{` |
|     1090 | 1072 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|        - | 1073 | `		/* Work only with reals */` |
|     1090 | 1074 | `		MemObjTryIntger(&(*pObj));` |
|      543 | 1075 | `	}` |
|     1090 | 1076 | `	return SXRET_OK;` |
|        4 | 1077 | `}` |
|        - | 1078 | `/*` |
|        - | 1079 | ` * Initialize a ph7_value to the null type.` |
|        - | 1080 | ` */` |
| 28994260 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 28994265 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 28994265 | 1086 | `	pObj->pVm = pVm;` |
| 28994265 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 28994265 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 28994265 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5961698 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5961703 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5961703 | 1100 | `	pObj->pVm = pVm;` |
|  5961703 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5961703 | 1103 | `	pObj->x.iVal = iVal;` |
|  5961703 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5961703 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    16854 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    16859 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    16859 | 1115 | `	pObj->pVm = pVm;` |
|    16859 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    16859 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    16859 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    16859 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    63698 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    63703 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    63703 | 1145 | `	pObj->pVm = pVm;` |
|    63703 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    63703 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    63703 | 1149 | `	pObj->x.pOther = pArray;` |
|    63703 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4899770 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4899775 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4899775 | 1160 | `	pObj->pVm = pVm;` |
|  4899775 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4899775 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2474147 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1237071 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4899775 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4899775 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2841588 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2841593 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|  2841593 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2841593 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  5984812 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  5984817 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  5984817 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  5984817 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   217747 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5875946 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    12243 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     6119 | 1222 | `	}` |
|  5984817 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    80635 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5944502 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8713 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4354 | 1227 | `	}` |
|  5984817 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5984817 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5984817 | 1230 | `	rc = SXRET_OK;` |
|  5984817 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4267441 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4267441 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2134035 | 1234 | `	}else{` |
|  1717381 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   320506 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   160515 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  5984817 | 1239 | `	if( pMap ){` |
|    80635 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  5944502 | 1241 | `	}else if( pObj ){` |
|     8713 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4354 | 1243 | `	}` |
|  5984812 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3102373 | 1245 | `	 && pDest->pVm` |
|   217742 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   108880 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  5984817 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  8117684 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  8117689 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8117689 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   537767 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  7848808 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    55903 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    27949 | 1281 | `	}` |
|  8117689 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  8117689 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4336747 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2169507 | 1287 | `	}` |
|  8117689 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 20728128 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 20728133 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 17415533 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   702601 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 17064235 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|   104555 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    52275 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 17415533 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 17415533 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  8712081 | 1305 | `	}` |
| 20728133 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1516443 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1516448 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   806653 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   806653 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   806653 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   194895 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   306087 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1321558 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1321553 | 1377 | `	if( !bStrict` |
|  1015882 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   355134 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       22 | 1395 | `	}` |
|  1321558 | 1396 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1397 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    24067 | 1398 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     9163 | 1399 | `			PH7_MemObjToBool(pObj1);` |
|     4579 | 1400 | `		}` |
|    24067 | 1401 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     8105 | 1402 | `			PH7_MemObjToBool(pObj2);` |
|     4050 | 1403 | `		}` |
|    24067 | 1404 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1297496 | 1405 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       53 | 1417 | `		return rc;` |
|  1297444 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      295 | 1430 | `		return rc;` |
|  1297154 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   829996 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   245184 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   121928 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   828898 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   828898 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   828898 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   828898 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   828898 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   828898 | 1465 | `		if( rc == 0 ){` |
|   260128 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    18714 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9356 | 1468 | `			}` |
|   130063 | 1469 | `		}` |
|   828898 | 1470 | `		return rc;` |
|   467163 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   233269 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   468261 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   468261 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   468261 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   467953 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7683 | 1515 | `				return 1;` |
|   460275 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   449303 | 1517 | `				return -1;` |
|        - | 1518 | `			}` |
|    10977 | 1519 | `			return 0;` |
|        - | 1520 | `		}` |
|        - | 1521 | `	}` |
...
|        - | 1536 | ` */` |
|    14668 | 1537 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1538 | `{` |
|    14673 | 1539 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
|        - | 1540 | `			/* Arithemtic operation */` |
|    10859 | 1541 | `			PH7_MemObjToNumeric(pObj1);` |
|    10859 | 1542 | `			PH7_MemObjToNumeric(pObj2);` |
|    10859 | 1543 | `			if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_REAL ){` |
...
|        - | 1562 | `				sxi64 a,b,r;` |
|    10791 | 1563 | `				a = pObj1->x.iVal;` |
|    10791 | 1564 | `				b = pObj2->x.iVal;` |
|    10791 | 1565 | `				if( PH7_ADD_OVERFLOW64(a,b,&r) ){` |
...
|        - | 1572 | `#endif` |
|        5 | 1573 | `				}else{` |
|    10783 | 1574 | `					pObj1->x.iVal = r;` |
|    10783 | 1575 | `					MemObjSetType(pObj1,MEMOBJ_INT);` |
|        - | 1576 | `				}` |
|        - | 1577 | `			}` |
|     5432 | 1578 | `	}else{` |
|     3819 | 1579 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
|        - | 1580 | `			ph7_hashmap *pMap;` |
|        - | 1581 | `			sxi32 rc;` |
|     3819 | 1582 | `			if( bAddStore ){` |
...
|     3817 | 1597 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|     3817 | 1598 | `				if( pMap == 0){` |
|      ! 0 | 1599 | `					PH7_VmThrowError(pObj1->pVm,0,PH7_CTX_ERR,"PH7 is running out of memory while creating array");` |
|      ! 0 | 1600 | `					return SXERR_MEM;` |
|        - | 1601 | `				}` |
|        - | 1602 | `			}` |
|     3819 | 1603 | `			if( !bAddStore ){` |
|     3817 | 1604 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1605 | `					/* Perform a hashmap duplication */` |
|     3817 | 1606 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|     1911 | 1607 | `				}else{` |
...
|     3819 | 1615 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|     3819 | 1616 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|     1912 | 1617 | `			}else{` |
...
|     3819 | 1624 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|      ! 0 | 1625 | `				SyBlobRelease(&pObj1->sBlob);` |
|      ! 0 | 1626 | `			}` |
|     3819 | 1627 | `			pObj1->x.pOther = pMap;` |
|     3819 | 1628 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|     1907 | 1629 | `		}` |
|        - | 1630 | `	}` |
|    14673 | 1631 | `	return SXRET_OK;` |
|     7339 | 1632 | `}` |
|        - | 1633 | `/*` |
...
|      107 | 1728 | `}` |
|     1008 | 1729 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|        - | 1737 | `	)` |
|        4 | 1738 | `{` |
|     1012 | 1739 | `	sxi32 rc = SXRET_OK;` |
|        - | 1740 | `	int i;` |
|     1012 | 1741 | `	if( !ShowType ){` |
...
|     5008 | 1757 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4108 | 1758 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2056 | 1759 | `	}` |
|      904 | 1760 | `	if( isRef ){` |
|        7 | 1761 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|        3 | 1762 | `	}` |
|      904 | 1763 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
...
|      139 | 1777 | `		return rc;` |
|        - | 1778 | `	}` |
|      768 | 1779 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       23 | 1780 | `		SyBlobAppend(&(*pOut),"NULL\n",sizeof("NULL\n")-1);` |
|       23 | 1781 | `		return SXRET_OK;` |
|        - | 1782 | `	}` |
|      746 | 1783 | `	if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|       28 | 1784 | `		rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,TRUE,nTab,nDepth+1);` |
|       28 | 1785 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|       28 | 1786 | `		return rc;` |
|        - | 1787 | `	}` |
|      720 | 1788 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      276 | 1789 | `		if( pObj->x.iVal != 0 ){` |
|      180 | 1790 | `			SyBlobAppend(&(*pOut),"bool(true)\n",sizeof("bool(true)\n")-1);` |
|       92 | 1791 | `		}else{` |
|       98 | 1792 | `			SyBlobAppend(&(*pOut),"bool(false)\n",sizeof("bool(false)\n")-1);` |
|        - | 1793 | `		}` |
|      276 | 1794 | `		return SXRET_OK;` |
|        - | 1795 | `	}` |
|      448 | 1796 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - | 1803 | `	}` |
|      444 | 1804 | `	if( pObj->iFlags & MEMOBJ_INT ){` |
|      269 | 1805 | `		SyBlobFormat(&(*pOut),"int(%qd)",pObj->x.iVal);` |
|      269 | 1806 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|      269 | 1807 | `		return SXRET_OK;` |
|        - | 1808 | `	}` |
|      178 | 1809 | `	if( pObj->iFlags & MEMOBJ_STRING ){` |
|      178 | 1810 | `		SyBlobFormat(&(*pOut),"string(%u) \"",SyBlobLength(&pObj->sBlob));` |
|      178 | 1811 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|      156 | 1812 | `			SyBlobAppend(&(*pOut),SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|       76 | 1813 | `		}` |
|      178 | 1814 | `		SyBlobAppend(&(*pOut),"\"\n",sizeof("\"\n")-1);` |
|      178 | 1815 | `		return SXRET_OK;` |
|        - | 1816 | `	}` |
