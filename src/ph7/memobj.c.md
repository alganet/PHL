...
|        - |   74 | ` */` |
|   132910 |   75 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |   76 | `{` |
|   132915 |   77 | `	sxi64 iVal = 0;` |
|   132915 |   78 | `	if( pVal->nByte <= 0 ){` |
|        7 |   79 | `		return 0;` |
|        - |   80 | `	}` |
|   132909 |   81 | `	if( pVal->zString[0] == '0' ){` |
|        - |   82 | `		sxi32 c;` |
|    55173 |   83 | `		if( pVal->nByte == sizeof(char) ){` |
|    54765 |   84 | `			return 0;` |
|        - |   85 | `		}` |
...
|    77741 |   99 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  100 | `	}` |
|    78149 |  101 | `	return iVal;` |
|    66460 |  102 | `}` |
|        - |  103 | `/*` |
...
|        - |  258 | ` */` |
|    55928 |  259 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  260 | `{` |
|    55933 |  261 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        4 |  273 | `		}` |
|    55783 |  274 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|    55181 |  275 | `		SyBlobFormat(&(*pOut),"%qd",pObj->x.iVal);` |
...
|        - |  290 | `			}` |
|        5 |  291 | `		}` |
|      294 |  292 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
...
|        - |  327 | ` */` |
|    13964 |  328 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  329 | `{` |
|        - |  330 | `	sxi32 iFlags;` |
|    13969 |  331 | `	iFlags = pObj->iFlags;` |
|    13969 |  332 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  333 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  334 | `		return pObj->rVal ? 1 : 0;` |
|        - |  335 | `#else` |
|       12 |  336 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  337 | `#endif` |
|    13959 |  338 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      115 |  339 | `		return pObj->x.iVal ? 1 : 0;` |
|    13849 |  340 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|      ! 0 |  360 | `		}` |
|    13785 |  361 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    12747 |  362 | `		return 0;` |
...
|        - |  415 | ` */` |
|   401422 |  416 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  417 | `{` |
|   401427 |  418 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
...
|        - |  446 | ` */` |
|    15268 |  447 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  448 | `{` |
|    15273 |  449 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  450 | `		/* Preform the conversion */` |
|    13969 |  451 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  452 | `		/* Invalidate any prior representations */` |
|    13969 |  453 | `		SyBlobRelease(&pObj->sBlob);` |
|    13969 |  454 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     6982 |  455 | `	}` |
|    15273 |  456 | `	return SXRET_OK;` |
|        5 |  457 | `}` |
|        - |  458 | `/*` |
|        - |  459 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  460 | ` */` |
|   796597 |  461 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  462 | `{` |
|   796602 |  463 | `	sxi32 rc = SXRET_OK;` |
|   796602 |  464 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  465 | `		/* Perform the conversion */` |
|    55711 |  466 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    55711 |  467 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    55711 |  468 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    27853 |  469 | `	}` |
|   796602 |  470 | `	return rc;` |
|        5 |  471 | `}` |
|        - |  472 | `/*` |
...
|        - |  633 | ` */` |
|   458088 |  634 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  635 | `{` |
|   458093 |  636 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      293 |  637 | `		return TRUE;` |
|   457805 |  638 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      175 |  639 | `		return FALSE;` |
|   457635 |  640 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  641 | `		SyString sStr;` |
|        - |  642 | `		sxi32 rc;` |
|   457635 |  643 | `		SyStringInitFromBuf(&sStr,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|   457635 |  644 | `		if( sStr.nByte <= 0 ){` |
|        - |  645 | `			/* Empty string */` |
|       77 |  646 | `			return FALSE;` |
|        - |  647 | `		}` |
|        - |  648 | `		/* Check if the string representation looks like a numeric number */` |
|   457559 |  649 | `		rc = SyStrIsNumeric(sStr.zString,sStr.nByte,0,0);` |
|   457559 |  650 | `		return rc == SXRET_OK ? TRUE : FALSE;` |
|        - |  651 | `	}` |
|        - |  652 | `	/* NOT REACHED */` |
|      ! 0 |  653 | `	return FALSE;` |
|   229116 |  654 | `}` |
...
|        - |  666 | ` */` |
|    27684 |  667 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  668 | `{` |
|    27689 |  669 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       19 |  670 | `		return TRUE;` |
|    27673 |  671 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       20 |  672 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    27655 |  673 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  674 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    27655 |  675 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  676 | `		return !pObj->x.iVal;` |
|    27651 |  677 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27617 |  678 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    22329 |  679 | `			return TRUE;` |
|      ! 0 |  680 | `		}else{` |
|        - |  681 | `			const char *zIn,*zEnd;` |
|     5293 |  682 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5293 |  683 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5299 |  684 | `			while( zIn < zEnd ){` |
|     5299 |  685 | `				if( zIn[0] != '0' ){` |
|     5293 |  686 | `					break;` |
|        - |  687 | `				}` |
|        7 |  688 | `				zIn++;` |
|        1 |  689 | `			}` |
|     5293 |  690 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  691 | `		}` |
...
|        - |  708 | ` */` |
|   441821 |  709 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  710 | `{` |
|   441826 |  711 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   441718 |  712 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - |  856 | ` */` |
|  9070511 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 |  858 | `{` |
|        - |  859 | `	/* Zero the structure */` |
|  9070516 |  860 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  861 | `	/* Initialize fields */` |
|  9070516 |  862 | `	pObj->pVm = pVm;` |
|  9070516 |  863 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  864 | `	/* Set the NULL type */` |
|  9070516 |  865 | `	pObj->iFlags = MEMOBJ_NULL;` |
|  9070516 |  866 | `	return SXRET_OK;` |
|        5 |  867 | `}` |
|        - |  868 | `/*` |
|        - |  869 | ` * Initialize a ph7_value to the integer type.` |
|        - |  870 | ` */` |
|   164670 |  871 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 |  872 | `{` |
|        - |  873 | `	/* Zero the structure */` |
|   164675 |  874 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  875 | `	/* Initialize fields */` |
|   164675 |  876 | `	pObj->pVm = pVm;` |
|   164675 |  877 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  878 | `	/* Set the desired type */` |
|   164675 |  879 | `	pObj->x.iVal = iVal;` |
|   164675 |  880 | `	pObj->iFlags = MEMOBJ_INT;` |
|   164675 |  881 | `	return SXRET_OK;` |
|        5 |  882 | `}` |
|        - |  883 | `/*` |
|        - |  884 | ` * Initialize a ph7_value to the boolean type.` |
|        - |  885 | ` */` |
|    17542 |  886 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 |  887 | `{` |
|        - |  888 | `	/* Zero the structure */` |
|    17547 |  889 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  890 | `	/* Initialize fields */` |
|    17547 |  891 | `	pObj->pVm = pVm;` |
|    17547 |  892 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  893 | `	/* Set the desired type */` |
|    17547 |  894 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17547 |  895 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17547 |  896 | `	return SXRET_OK;` |
|        5 |  897 | `}` |
|        - |  898 | `#if 0` |
|        - |  899 | `/*` |
...
|        - |  917 | ` */` |
|    48898 |  918 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 |  919 | `{` |
|        - |  920 | `	/* Zero the structure */` |
|    48903 |  921 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  922 | `	/* Initialize fields */` |
|    48903 |  923 | `	pObj->pVm = pVm;` |
|    48903 |  924 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - |  925 | `	/* Set the desired type */` |
|    48903 |  926 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    48903 |  927 | `	pObj->x.pOther = pArray;` |
|    48903 |  928 | `	return SXRET_OK;` |
|        5 |  929 | `}` |
|        - |  930 | `/*` |
|        - |  931 | ` * Initialize a ph7_value to the string type.` |
|        - |  932 | ` */` |
|   518324 |  933 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 |  934 | `{` |
|        - |  935 | `	/* Zero the structure */` |
|   518329 |  936 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - |  937 | `	/* Initialize fields */` |
|   518329 |  938 | `	pObj->pVm = pVm;` |
|   518329 |  939 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|   518329 |  940 | `	if( pVal ){` |
|        - |  941 | `		/* Append contents */` |
|   324545 |  942 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|   162270 |  943 | `	}` |
|        - |  944 | `	/* Set the desired type */` |
|   518329 |  945 | `	pObj->iFlags = MEMOBJ_STRING;` |
|   518329 |  946 | `	return SXRET_OK;` |
|        5 |  947 | `}` |
|        - |  948 | `/*` |
...
|        - |  953 | ` */` |
|   361614 |  954 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 |  955 | `{` |
|        - |  956 | `	sxi32 rc;` |
|   361619 |  957 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  958 | `		/* Invalidate any prior representation */` |
|     1727 |  959 | `		PH7_MemObjRelease(pObj);` |
|     1727 |  960 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|      861 |  961 | `	}` |
|        - |  962 | `	/* Append contents */` |
|   361619 |  963 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|   361619 |  964 | `	return rc;` |
|        5 |  965 | `}` |
|        - |  966 | `#if 0` |
|        - |  967 | `/*` |
...
|        - |  988 | ` */` |
|  4655599 |  989 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 |  990 | `{` |
|  4655604 |  991 | `	ph7_class_instance *pObj = 0;` |
|  4655604 |  992 | `	ph7_hashmap *pMap = 0;` |
|        - |  993 | `	sxi32 rc;` |
|  4655604 |  994 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - |  995 | `		/* Increment reference count */` |
|   155589 |  996 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  4577812 |  997 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - |  998 | `		/* Increment reference count */` |
|     3017 |  999 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     1506 | 1000 | `	}` |
|  4655604 | 1001 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    45681 | 1002 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  4632766 | 1003 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     3565 | 1004 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     1780 | 1005 | `	}` |
|  4655604 | 1006 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  4655604 | 1007 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  4655604 | 1008 | `	rc = SXRET_OK;` |
|  4655604 | 1009 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3871075 | 1010 | `		SyBlobReset(&pDest->sBlob);` |
|  3871075 | 1011 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  1935540 | 1012 | `	}else{` |
|   784534 | 1013 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   278172 | 1014 | `			SyBlobRelease(&pDest->sBlob);` |
|   139126 | 1015 | `		}` |
|        - | 1016 | `	}` |
|  4655604 | 1017 | `	if( pMap ){` |
|    45681 | 1018 | `		PH7_HashmapUnref(pMap);` |
|  4632766 | 1019 | `	}else if( pObj ){` |
|     3565 | 1020 | `		PH7_ClassInstanceUnref(pObj);` |
|     1780 | 1021 | `	}` |
|  4655604 | 1022 | `	return rc;` |
|        5 | 1023 | `}` |
|        - | 1024 | `/*` |
|        - | 1025 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1026 | ` * buffer contents,simply point to it.` |
|        - | 1027 | ` */` |
|  6400604 | 1028 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1029 | `{` |
|  6400609 | 1030 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1031 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  6400609 | 1032 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1033 | `		/* Increment reference count */` |
|   436615 | 1034 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  6182304 | 1035 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1036 | `		/* Increment reference count */` |
|    16535 | 1037 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     8265 | 1038 | `	}` |
|  6400609 | 1039 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       36 | 1040 | `		SyBlobRelease(&pDest->sBlob);` |
|       16 | 1041 | `	}` |
|  6400609 | 1042 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  3459243 | 1043 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  1729771 | 1044 | `	}` |
|  6400609 | 1045 | `	return SXRET_OK;` |
|        5 | 1046 | `}` |
|        - | 1047 | `/*` |
|        - | 1048 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1049 | ` */` |
| 12689805 | 1050 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1051 | `{` |
| 12689810 | 1052 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 11568965 | 1053 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   553183 | 1054 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 11292376 | 1055 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    29039 | 1056 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    14517 | 1057 | `		}` |
|        - | 1058 | `		/* Release the internal buffer */` |
| 11568965 | 1059 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1060 | `		/* Invalidate any prior representation */` |
| 11568965 | 1061 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  5784884 | 1062 | `	}` |
| 12689810 | 1063 | `	return SXRET_OK;` |
|        5 | 1064 | `}` |
|        - | 1065 | `/*` |
...
|        - | 1117 | ` */` |
|  1242151 | 1118 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1119 | `{` |
|        - | 1120 | `	sxi32 iComb;` |
|        - | 1121 | `	sxi32 rc;` |
|  1242156 | 1122 | `	if( bStrict ){` |
|        - | 1123 | `		sxi32 iF1,iF2;` |
|        - | 1124 | `		/* Strict comparisons with === */` |
|   639163 | 1125 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   639163 | 1126 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   639163 | 1127 | `		if( iF1 != iF2 ){` |
|        - | 1128 | `			/* Not of the same type */` |
|   178533 | 1129 | `			return 1;` |
|        - | 1130 | `		}` |
|   230315 | 1131 | `	}` |
|        - | 1132 | `	/* Combine flag together */` |
|  1063628 | 1133 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1063628 | 1134 | `	if( iComb & (MEMOBJ_NULL\|MEMOBJ_RES\|MEMOBJ_BOOL) ){` |
|        - | 1135 | `		/* Convert to boolean: Keep in mind FALSE < TRUE */` |
|    20971 | 1136 | `		if( (pObj1->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     7341 | 1137 | `			PH7_MemObjToBool(pObj1);` |
|     3668 | 1138 | `		}` |
|    20971 | 1139 | `		if( (pObj2->iFlags & MEMOBJ_BOOL) == 0 ){` |
|     6373 | 1140 | `			PH7_MemObjToBool(pObj2);` |
|     3184 | 1141 | `		}` |
|    20971 | 1142 | `		return (sxi32)((pObj1->x.iVal != 0) - (pObj2->x.iVal != 0));` |
|  1042662 | 1143 | `	}else if ( iComb & MEMOBJ_HASHMAP ){` |
...
|       27 | 1155 | `		return rc;` |
|  1042636 | 1156 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      229 | 1168 | `		return rc;` |
|  1042412 | 1169 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1170 | `		SyString s1,s2;` |
|   667796 | 1171 | `		if( !bStrict ){` |
|        - | 1172 | `			/*` |
...
|        - | 1178 | `			 */` |
|   228766 | 1179 | `			if( PH7_MemObjIsNumeric(pObj1) ){` |
|        - | 1180 | `				/* Perform a numeric comparison */` |
|       15 | 1181 | `				goto Numeric;` |
|        - | 1182 | `			}` |
|   228752 | 1183 | `			if( PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1184 | `				/* Perform a numeric comparison */` |
|      ! 0 | 1185 | `				goto Numeric;` |
|        - | 1186 | `			}` |
|   114407 | 1187 | `		}` |
|        - | 1188 | `		/* Perform a strict string comparison.*/` |
|   667782 | 1189 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1190 | `			PH7_MemObjToString(pObj1);` |
|      ! 0 | 1191 | `		}` |
|   667782 | 1192 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|      ! 0 | 1193 | `			PH7_MemObjToString(pObj2);` |
|      ! 0 | 1194 | `		}` |
|   667782 | 1195 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   667782 | 1196 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1197 | `		/*` |
...
|        - | 1200 | `		 */` |
|   667782 | 1201 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   667782 | 1202 | `		if( rc == 0 ){` |
|   230846 | 1203 | `			if( s1.nByte != s2.nByte ){` |
|     1650 | 1204 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|      825 | 1205 | `			}` |
|   115423 | 1206 | `		}` |
|   667782 | 1207 | `		return rc;` |
|   374621 | 1208 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   187267 | 1209 | `Numeric:` |
|        - | 1210 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   374635 | 1211 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|        3 | 1212 | `			PH7_MemObjToNumeric(pObj1);` |
|        1 | 1213 | `		}` |
|   374635 | 1214 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|       13 | 1215 | `			PH7_MemObjToNumeric(pObj2);` |
|        6 | 1216 | `		}` |
|   374635 | 1217 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1218 | `			/*` |
...
|   374411 | 1251 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     5144 | 1252 | `				return 1;` |
|   369272 | 1253 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   363806 | 1254 | `				return -1;` |
|        - | 1255 | `			}` |
|     5471 | 1256 | `			return 0;` |
|        - | 1257 | `		}` |
|        - | 1258 | `	}` |
...
|      295 | 1375 | `	}else if( pVal->iFlags & MEMOBJ_BOOL ){` |
|      111 | 1376 | `		zType = "bool";` |
...
|        - | 1397 | `	)` |
|        5 | 1398 | `{` |
|      447 | 1399 | `	sxi32 rc = SXRET_OK;` |
|        - | 1400 | `	const char *zType;` |
|        - | 1401 | `	int i;` |
|     4563 | 1402 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4120 | 1403 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2062 | 1404 | `	}` |
|      447 | 1405 | `	if( ShowType ){` |
|      399 | 1406 | `		if( isRef ){` |
...
|      399 | 1411 | `		if( (pObj->iFlags & MEMOBJ_REAL) && (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|        3 | 1412 | `			zType = "float";` |
|        2 | 1413 | `		}else{` |
|      397 | 1414 | `			zType = PH7_MemObjTypeDump(pObj);` |
|        - | 1415 | `		}` |
|      399 | 1416 | `		SyBlobAppend(&(*pOut),zType,SyStrlen(zType));` |
|      197 | 1417 | `	}` |
|      447 | 1418 | `	if((pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
|      443 | 1419 | `		if ( ShowType ){` |
|      395 | 1420 | `			SyBlobAppend(&(*pOut),"(",sizeof(char));` |
|      195 | 1421 | `		}` |
|      443 | 1422 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1423 | `			/* Dump hashmap entries */` |
|       24 | 1424 | `			rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,ShowType,nTab+1,nDepth+1);` |
|      432 | 1425 | `		}else if(pObj->iFlags & MEMOBJ_OBJ ){` |
...
|       72 | 1428 | `		}else{` |
|      283 | 1429 | `			SyBlob *pContents = &pObj->sBlob;` |
|        - | 1430 | `			/* Get a printable representation of the contents */` |
|      283 | 1431 | `			if((pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
...
|        - | 1444 | `			}` |
|        - | 1445 | `		}` |
|      443 | 1446 | `		if( ShowType ){` |
|        - | 1447 | `			/* Strings already emitted their own ')' as part of the` |
|        - | 1448 | `			 * "N) \"content\"" format above. */` |
|      395 | 1449 | `			if( (pObj->iFlags & (MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_STRING)) == 0 ){` |
