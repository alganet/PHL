...
|        - |   93 | ` */` |
|    10730 |   94 | `static sxi64 MemObjRealToInt(ph7_value *pObj)` |
|        5 |   95 | `{` |
...
|    10735 |  111 | `  ph7_real r = pObj->rVal;` |
|    10735 |  112 | `  if( r<(ph7_real)minInt ){` |
|        3 |  113 | `    return minInt;` |
|    10733 |  114 | `  }else if( r>(ph7_real)maxInt ){` |
...
|        - |  128 | ` */` |
|  3679360 |  129 | `PH7_PRIVATE sxi64 PH7_TokenValueToInt64(SyString *pVal)` |
|        5 |  130 | `{` |
|  3679365 |  131 | `	sxi64 iVal = 0;` |
|  3679365 |  132 | `	if( pVal->nByte <= 0 ){` |
|      ! 0 |  133 | `		return 0;` |
|        - |  134 | `	}` |
|  3679365 |  135 | `	if( pVal->zString[0] == '0' ){` |
|        - |  136 | `		sxi32 c;` |
|  1440537 |  137 | `		if( pVal->nByte == sizeof(char) ){` |
|  1332737 |  138 | `			return 0;` |
|        - |  139 | `		}` |
|   107805 |  140 | `		c = pVal->zString[1];` |
|   107805 |  141 | `		if( c  == 'x' \|\| c == 'X' ){` |
|        - |  142 | `			/* Hex digit stream */` |
|   103607 |  143 | `			SyHexStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|    56004 |  144 | `		}else if( c == 'b' \|\| c == 'B' ){` |
|        - |  145 | `			/* Binary digit stream */` |
|      281 |  146 | `			SyBinaryStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|     4063 |  147 | `		}else if( c == 'o' \|\| c == 'O' ){` |
...
|     3907 |  155 | `			SyOctalStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  156 | `		}` |
|    53905 |  157 | `	}else{` |
|        - |  158 | `		/* Decimal digit stream */` |
|  2238833 |  159 | `		SyStrToInt64(pVal->zString,pVal->nByte,(void *)&iVal,0);` |
|        - |  160 | `	}` |
|  2346633 |  161 | `	return iVal;` |
|  1839685 |  162 | `}` |
|        - |  163 | `/*` |
...
|        - |  166 | ` * representation.` |
|        - |  167 | ` */` |
|     3440 |  168 | `static sxi64 MemObjStringToInt(ph7_value *pObj)` |
|        5 |  169 | `{` |
|     3445 |  170 | `	sxi64 iVal = 0;` |
...
|     3445 |  174 | `	SyStrToInt64((const char *)SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob),(void *)&iVal,0);` |
|     3445 |  175 | `	return iVal;` |
|        5 |  176 | `}` |
|        - |  177 | `/*` |
...
|        - |  181 | ` */` |
|      368 |  182 | `static sxi32 MemObjCallClassCastMethod(` |
...
|      373 |  192 | `	pMethod = PH7_ClassExtractMethod(pThis->pClass,zMethod,nLen);` |
|      373 |  193 | `	if( pMethod == 0 ){` |
|        - |  194 | `		/* No such method */` |
|      187 |  195 | `		return SXERR_NOTFOUND;` |
|        - |  196 | `	}` |
...
|        - |  210 | ` */` |
|     1344 |  211 | `static sxi64 MemObjIntValue(ph7_value *pObj)` |
|        5 |  212 | `{` |
|        - |  213 | `	sxi32 iFlags;` |
|     1349 |  214 | `	iFlags = pObj->iFlags;` |
|     1349 |  215 | `	if (iFlags & MEMOBJ_REAL ){` |
|       41 |  216 | `		return MemObjRealToInt(&(*pObj));` |
|     1309 |  217 | `	}else if( iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      170 |  218 | `		return pObj->x.iVal;` |
|     1141 |  219 | `	}else if (iFlags & MEMOBJ_STRING) {` |
|     1123 |  220 | `		return MemObjStringToInt(&(*pObj));` |
...
|        - |  259 | ` */` |
|     9512 |  260 | `static ph7_real MemObjRealValue(ph7_value *pObj)` |
|        5 |  261 | `{` |
|        - |  262 | `	sxi32 iFlags;` |
|     9517 |  263 | `	iFlags = pObj->iFlags;` |
|     9517 |  264 | `	if( iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  265 | `		return pObj->rVal;` |
|     9517 |  266 | `	}else if (iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL) ){` |
|      771 |  267 | `		return (ph7_real)pObj->x.iVal;` |
|     8749 |  268 | `	}else if (iFlags & MEMOBJ_STRING){` |
|        - |  269 | `		SyString sString;` |
|        - |  270 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  271 | `		ph7_real rVal = 0;` |
|        - |  272 | `#else` |
|     8743 |  273 | `		ph7_real rVal = 0.0;` |
|        - |  274 | `#endif` |
|     8743 |  275 | `		SyStringInitFromBuf(&sString,SyBlobData(&pObj->sBlob),SyBlobLength(&pObj->sBlob));` |
|     8743 |  276 | `		if( SyBlobLength(&pObj->sBlob) > 0 ){` |
|        - |  277 | `			/* Convert as much as we can */` |
|        - |  278 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  279 | `			rVal = MemObjStringToInt(&(*pObj));` |
|        - |  280 | `#else` |
|     8743 |  281 | `			SyStrToReal(sString.zString,sString.nByte,(void *)&rVal,0);` |
|        - |  282 | `#endif` |
|     4369 |  283 | `		}` |
|     8743 |  284 | `		return rVal;` |
...
|        - |  380 | ` */` |
|    61522 |  381 | `static sxi32 MemObjStringValue(SyBlob *pOut,ph7_value *pObj,sxu8 bStrictBool)` |
|        5 |  382 | `{` |
|    61527 |  383 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
...
|        - |  468 | ` */` |
|    18602 |  469 | `static sxi32 MemObjBooleanValue(ph7_value *pObj)` |
|        5 |  470 | `{` |
|        - |  471 | `	sxi32 iFlags;` |
|    18607 |  472 | `	iFlags = pObj->iFlags;` |
|    18607 |  473 | `	if (iFlags & MEMOBJ_REAL ){` |
|        - |  474 | `#ifdef PH7_OMIT_FLOATING_POINT` |
|        - |  475 | `		return pObj->rVal ? 1 : 0;` |
|        - |  476 | `#else` |
|       14 |  477 | `		return pObj->rVal != 0.0 ? 1 : 0;` |
|        - |  478 | `#endif` |
|    18595 |  479 | `	}else if( iFlags & MEMOBJ_INT ){` |
|      909 |  480 | `		return pObj->x.iVal ? 1 : 0;` |
|    17691 |  481 | `	}else if (iFlags & MEMOBJ_STRING) {` |
...
|        - |  490 | `		}` |
|       88 |  491 | `		return 1;` |
|    17583 |  492 | `	}else if( iFlags & MEMOBJ_NULL ){` |
|    16275 |  493 | `		return 0;` |
|     1313 |  494 | `	}else if( iFlags & MEMOBJ_HASHMAP ){` |
...
|      188 |  501 | `		sxi32 iVal = 1;` |
|        - |  502 | `		sxi32 rc;` |
|        - |  503 | `		/* Invoke the __toBool() method if available [note that this is a symisc extension]  */` |
|      188 |  504 | `		PH7_MemObjInit(pObj->pVm,&sResult);` |
|      188 |  505 | `		rc = MemObjCallClassCastMethod(pObj->pVm,(ph7_class_instance *)pObj->x.pOther,` |
|        - |  506 | `			"__toBool",sizeof("__toBool")-1,&sResult);` |
|      188 |  507 | `		if( rc == SXRET_OK && (sResult.iFlags & (MEMOBJ_INT\|MEMOBJ_BOOL)) ){` |
|        - |  508 | `			/* Extract method return value */` |
|        5 |  509 | `			iVal = (sxi32)(sResult.x.iVal != 0); /* Stupid cc warning -W -Wall -O6 */` |
|        2 |  510 | `		}` |
|      188 |  511 | `		PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|      188 |  512 | `		PH7_MemObjRelease(&sResult);` |
|      188 |  513 | `		return iVal;` |
...
|        - |  522 | ` */` |
|    10690 |  523 | `static sxi32 MemObjTryIntger(ph7_value *pObj)` |
|        5 |  524 | `{` |
|    10695 |  525 | `	pObj->x.iVal = MemObjRealToInt(&(*pObj));` |
...
|        - |  537 | `  */` |
|    10690 |  538 | `	if( pObj->rVal ==(ph7_real)pObj->x.iVal && pObj->x.iVal>SMALLEST_INT64` |
|     9235 |  539 | `      && pObj->x.iVal<LARGEST_INT64 ){` |
|     9219 |  540 | `		  pObj->iFlags \|= MEMOBJ_INT;` |
|     4609 |  541 | `	}` |
|    10695 |  542 | `	return SXRET_OK;` |
|        5 |  543 | `}` |
|        - |  544 | `/*` |
|        - |  545 | ` * Convert a ph7_value to type integer.Invalidate any prior representations.` |
|        - |  546 | ` */` |
|   527628 |  547 | `PH7_PRIVATE sxi32 PH7_MemObjToInteger(ph7_value *pObj)` |
|        5 |  548 | `{` |
|   527633 |  549 | `	if( (pObj->iFlags & MEMOBJ_INT) == 0 ){` |
|        - |  550 | `		/* Preform the conversion */` |
|     1349 |  551 | `		pObj->x.iVal = MemObjIntValue(&(*pObj));` |
|        - |  552 | `		/* Invalidate any prior representations */` |
|     1349 |  553 | `		SyBlobRelease(&pObj->sBlob);` |
|     1349 |  554 | `		MemObjSetType(pObj,MEMOBJ_INT);` |
|      672 |  555 | `	}` |
|   527633 |  556 | `	return SXRET_OK;` |
|        5 |  557 | `}` |
|        - |  558 | `/*` |
|        - |  559 | ` * Convert a ph7_value to type real (Try to get an integer representation also).` |
|        - |  560 | ` * Invalidate any prior representations` |
|        - |  561 | ` */` |
|    10520 |  562 | `PH7_PRIVATE sxi32 PH7_MemObjToReal(ph7_value *pObj)` |
|        5 |  563 | `{` |
|    10525 |  564 | `	if((pObj->iFlags & MEMOBJ_REAL) == 0 ){` |
|        - |  565 | `		/* Preform the conversion */` |
|     9517 |  566 | `		pObj->rVal = MemObjRealValue(&(*pObj));` |
|        - |  567 | `		/* Invalidate any prior representations */` |
|     9517 |  568 | `		SyBlobRelease(&pObj->sBlob);` |
|     9517 |  569 | `		MemObjSetType(pObj,MEMOBJ_REAL);` |
|        - |  570 | `		/* Try to get an integer representation */` |
|     9517 |  571 | `		MemObjTryIntger(&(*pObj));` |
|     4756 |  572 | `	}` |
|    10525 |  573 | `	return SXRET_OK;` |
|        5 |  574 | `}` |
|        - |  575 | `/*` |
|        - |  576 | ` * Convert a ph7_value to type boolean.Invalidate any prior representations.` |
|        - |  577 | ` */` |
|    22330 |  578 | `PH7_PRIVATE sxi32 PH7_MemObjToBool(ph7_value *pObj)` |
|        5 |  579 | `{` |
|    22335 |  580 | `	if( (pObj->iFlags & MEMOBJ_BOOL) == 0 ){` |
|        - |  581 | `		/* Preform the conversion */` |
|    18607 |  582 | `		pObj->x.iVal = MemObjBooleanValue(&(*pObj));` |
|        - |  583 | `		/* Invalidate any prior representations */` |
|    18607 |  584 | `		SyBlobRelease(&pObj->sBlob);` |
|    18607 |  585 | `		MemObjSetType(pObj,MEMOBJ_BOOL);` |
|     9301 |  586 | `	}` |
|    22335 |  587 | `	return SXRET_OK;` |
|        5 |  588 | `}` |
|        - |  589 | `/*` |
|        - |  590 | ` * Convert a ph7_value to type string.Prior representations are NOT invalidated.` |
|        - |  591 | ` */` |
|   993279 |  592 | `PH7_PRIVATE sxi32 PH7_MemObjToString(ph7_value *pObj)` |
|        5 |  593 | `{` |
|   993284 |  594 | `	sxi32 rc = SXRET_OK;` |
|   993284 |  595 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - |  596 | `		/* Perform the conversion */` |
|    61433 |  597 | `		SyBlobReset(&pObj->sBlob); /* Reset the internal buffer */` |
|    61433 |  598 | `		rc = MemObjStringValue(&pObj->sBlob,&(*pObj),TRUE);` |
|    61433 |  599 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|    30714 |  600 | `	}` |
|   993284 |  601 | `	return rc;` |
|        5 |  602 | `}` |
|        - |  603 | `/*` |
...
|        - |  781 | ` */` |
|   254856 |  782 | `PH7_PRIVATE int PH7_MemObjStringNumericPrefix(ph7_value *pValue,const char **pzTail)` |
|        5 |  783 | `{` |
|        - |  784 | `	const char *z, *zEnd;` |
|        - |  785 | `	sxu32 n;` |
|   254861 |  786 | `	int bDigit = 0;` |
|   254861 |  787 | `	if( (pValue->iFlags & MEMOBJ_STRING) == 0 ){` |
|      ! 0 |  788 | `		return 0;` |
|        - |  789 | `	}` |
|   254861 |  790 | `	z = (const char *)SyBlobData(&pValue->sBlob);` |
|   254861 |  791 | `	n = SyBlobLength(&pValue->sBlob);` |
|   254861 |  792 | `	if( n == 0 ){` |
|      603 |  793 | `		return 0;` |
|        - |  794 | `	}` |
|   254261 |  795 | `	zEnd = z + n;` |
|   254289 |  796 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisSpace(z[0]) ){` |
|       30 |  797 | `		z++;` |
|        2 |  798 | `	}` |
|   254261 |  799 | `	if( z < zEnd && (z[0] == '+' \|\| z[0] == '-') ){` |
|      203 |  800 | `		z++;` |
|       99 |  801 | `	}` |
|   259091 |  802 | `	while( z < zEnd && (unsigned char)z[0] < 0xc0 && SyisDigit(z[0]) ){` |
|     4835 |  803 | `		z++; bDigit = 1;` |
|        5 |  804 | `	}` |
|   254261 |  805 | `	if( z < zEnd && z[0] == '.' ){` |
|     4632 |  806 | `		z++;` |
...
|        - |  839 | ` */` |
|   252464 |  840 | `PH7_PRIVATE int PH7_MemObjStringIsNumeric(ph7_value *pValue)` |
|        5 |  841 | `{` |
|   252469 |  842 | `	const char *zTail = 0, *zEnd;` |
|   252469 |  843 | `	if( !PH7_MemObjStringNumericPrefix(pValue,&zTail) ){` |
|   250125 |  844 | `		return 0;` |
|        - |  845 | `	}` |
...
|        - |  856 | ` */` |
|   253354 |  857 | `PH7_PRIVATE sxi32 PH7_MemObjIsNumeric(ph7_value *pObj)` |
|        5 |  858 | `{` |
|   253359 |  859 | `	if( pObj->iFlags & ( MEMOBJ_BOOL\|MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|      629 |  860 | `		return TRUE;` |
|   252735 |  861 | `	}else if( pObj->iFlags & (MEMOBJ_NULL\|MEMOBJ_HASHMAP\|MEMOBJ_OBJ\|MEMOBJ_RES) ){` |
|      384 |  862 | `		return FALSE;` |
|   252353 |  863 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|        - |  864 | `		/* TRUE only if the whole string is a well-formed PHP numeric string. */` |
|   252353 |  865 | `		return PH7_MemObjStringIsNumeric(pObj) ? TRUE : FALSE;` |
|        - |  866 | `	}` |
|        - |  867 | `	/* NOT REACHED */` |
|      ! 0 |  868 | `	return FALSE;` |
|   126576 |  869 | `}` |
...
|        - |  881 | ` */` |
|    40868 |  882 | `PH7_PRIVATE sxi32 PH7_MemObjIsEmpty(ph7_value *pObj)` |
|        5 |  883 | `{` |
|    40873 |  884 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|       21 |  885 | `		return TRUE;` |
|    40855 |  886 | `	}else if( pObj->iFlags & MEMOBJ_INT ){` |
|       22 |  887 | `		return pObj->x.iVal == 0 ? TRUE : FALSE;` |
|    40835 |  888 | `	}else if( pObj->iFlags & MEMOBJ_REAL ){` |
|      ! 0 |  889 | `		return pObj->rVal == (ph7_real)0 ? TRUE : FALSE;` |
|    40835 |  890 | `	}else if( pObj->iFlags & MEMOBJ_BOOL ){` |
|        5 |  891 | `		return !pObj->x.iVal;` |
|    40831 |  892 | `	}else if( pObj->iFlags & MEMOBJ_STRING ){` |
|    27465 |  893 | `		if( SyBlobLength(&pObj->sBlob) <= 0 ){` |
|    21925 |  894 | `			return TRUE;` |
|      ! 0 |  895 | `		}else{` |
|        - |  896 | `			const char *zIn,*zEnd;` |
|     5545 |  897 | `			zIn = (const char *)SyBlobData(&pObj->sBlob);` |
|     5545 |  898 | `			zEnd = &zIn[SyBlobLength(&pObj->sBlob)];` |
|     5551 |  899 | `			while( zIn < zEnd ){` |
|     5551 |  900 | `				if( zIn[0] != '0' ){` |
|     5545 |  901 | `					break;` |
|        - |  902 | `				}` |
|        7 |  903 | `				zIn++;` |
|        1 |  904 | `			}` |
|     5545 |  905 | `			return zIn >= zEnd ? TRUE : FALSE;` |
|      ! 0 |  906 | `		}` |
|    13371 |  907 | `	}else if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|    13371 |  908 | `		ph7_hashmap *pMap = (ph7_hashmap *)pObj->x.pOther;` |
|    13371 |  909 | `		return pMap->nEntry == 0 ? TRUE : FALSE;` |
...
|        - |  923 | ` */` |
|   595299 |  924 | `PH7_PRIVATE sxi32 PH7_MemObjToNumeric(ph7_value *pObj)` |
|        5 |  925 | `{` |
|   595304 |  926 | `	if( pObj->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL\|MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
|   592960 |  927 | `		if( pObj->iFlags & (MEMOBJ_BOOL\|MEMOBJ_NULL) ){` |
...
|        - | 1069 | ` */` |
|     1110 | 1070 | `PH7_PRIVATE sxi32 PH7_MemObjTryInteger(ph7_value *pObj)` |
|        4 | 1071 | `{` |
|     1114 | 1072 | `	if( pObj->iFlags & MEMOBJ_REAL ){` |
|        - | 1073 | `		/* Work only with reals */` |
|     1114 | 1074 | `		MemObjTryIntger(&(*pObj));` |
|      555 | 1075 | `	}` |
|     1114 | 1076 | `	return SXRET_OK;` |
|        4 | 1077 | `}` |
|        - | 1078 | `/*` |
|        - | 1079 | ` * Initialize a ph7_value to the null type.` |
|        - | 1080 | ` */` |
| 24906113 | 1081 | `PH7_PRIVATE sxi32 PH7_MemObjInit(ph7_vm *pVm,ph7_value *pObj)` |
|        5 | 1082 | `{` |
|        - | 1083 | `	/* Zero the structure */` |
| 24906118 | 1084 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1085 | `	/* Initialize fields */` |
| 24906118 | 1086 | `	pObj->pVm = pVm;` |
| 24906118 | 1087 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1088 | `	/* Set the NULL type */` |
| 24906118 | 1089 | `	pObj->iFlags = MEMOBJ_NULL;` |
| 24906118 | 1090 | `	return SXRET_OK;` |
|        5 | 1091 | `}` |
|        - | 1092 | `/*` |
|        - | 1093 | ` * Initialize a ph7_value to the integer type.` |
|        - | 1094 | ` */` |
|  5828886 | 1095 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromInt(ph7_vm *pVm,ph7_value *pObj,sxi64 iVal)` |
|        5 | 1096 | `{` |
|        - | 1097 | `	/* Zero the structure */` |
|  5828891 | 1098 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1099 | `	/* Initialize fields */` |
|  5828891 | 1100 | `	pObj->pVm = pVm;` |
|  5828891 | 1101 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1102 | `	/* Set the desired type */` |
|  5828891 | 1103 | `	pObj->x.iVal = iVal;` |
|  5828891 | 1104 | `	pObj->iFlags = MEMOBJ_INT;` |
|  5828891 | 1105 | `	return SXRET_OK;` |
|        5 | 1106 | `}` |
|        - | 1107 | `/*` |
|        - | 1108 | ` * Initialize a ph7_value to the boolean type.` |
|        - | 1109 | ` */` |
|    17328 | 1110 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromBool(ph7_vm *pVm,ph7_value *pObj,sxi32 iVal)` |
|        5 | 1111 | `{` |
|        - | 1112 | `	/* Zero the structure */` |
|    17333 | 1113 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1114 | `	/* Initialize fields */` |
|    17333 | 1115 | `	pObj->pVm = pVm;` |
|    17333 | 1116 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1117 | `	/* Set the desired type */` |
|    17333 | 1118 | `	pObj->x.iVal = iVal ? 1 : 0;` |
|    17333 | 1119 | `	pObj->iFlags = MEMOBJ_BOOL;` |
|    17333 | 1120 | `	return SXRET_OK;` |
|        5 | 1121 | `}` |
|        - | 1122 | `/*` |
...
|        - | 1139 | ` */` |
|    63188 | 1140 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromArray(ph7_vm *pVm,ph7_value *pObj,ph7_hashmap *pArray)` |
|        5 | 1141 | `{` |
|        - | 1142 | `	/* Zero the structure */` |
|    63193 | 1143 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1144 | `	/* Initialize fields */` |
|    63193 | 1145 | `	pObj->pVm = pVm;` |
|    63193 | 1146 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|        - | 1147 | `	/* Set the desired type */` |
|    63193 | 1148 | `	pObj->iFlags = MEMOBJ_HASHMAP;` |
|    63193 | 1149 | `	pObj->x.pOther = pArray;` |
|    63193 | 1150 | `	return SXRET_OK;` |
|        5 | 1151 | `}` |
|        - | 1152 | `/*` |
|        - | 1153 | ` * Initialize a ph7_value to the string type.` |
|        - | 1154 | ` */` |
|  4298448 | 1155 | `PH7_PRIVATE sxi32 PH7_MemObjInitFromString(ph7_vm *pVm,ph7_value *pObj,const SyString *pVal)` |
|        5 | 1156 | `{` |
|        - | 1157 | `	/* Zero the structure */` |
|  4298453 | 1158 | `	SyZero(pObj,sizeof(ph7_value));` |
|        - | 1159 | `	/* Initialize fields */` |
|  4298453 | 1160 | `	pObj->pVm = pVm;` |
|  4298453 | 1161 | `	SyBlobInit(&pObj->sBlob,&pVm->sAllocator);` |
|  4298453 | 1162 | `	if( pVal ){` |
|        - | 1163 | `		/* Append contents */` |
|  2065261 | 1164 | `		SyBlobAppend(&pObj->sBlob,(const void *)pVal->zString,pVal->nByte);` |
|  1032628 | 1165 | `	}` |
|        - | 1166 | `	/* Set the desired type */` |
|  4298453 | 1167 | `	pObj->iFlags = MEMOBJ_STRING;` |
|  4298453 | 1168 | `	return SXRET_OK;` |
|        5 | 1169 | `}` |
|        - | 1170 | `/*` |
...
|        - | 1175 | ` */` |
|  2649152 | 1176 | `PH7_PRIVATE sxi32 PH7_MemObjStringAppend(ph7_value *pObj,const char *zData,sxu32 nLen)` |
|        5 | 1177 | `{` |
|        - | 1178 | `	sxi32 rc;` |
|  2649157 | 1179 | `	if( (pObj->iFlags & MEMOBJ_STRING) == 0 ){` |
|        - | 1180 | `		/* Invalidate any prior representation */` |
|     3487 | 1181 | `		PH7_MemObjRelease(pObj);` |
|     3487 | 1182 | `		MemObjSetType(pObj,MEMOBJ_STRING);` |
|     1741 | 1183 | `	}` |
|        - | 1184 | `	/* Append contents */` |
|  2649157 | 1185 | `	rc = SyBlobAppend(&pObj->sBlob,zData,nLen);` |
|  2649157 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `#if 0` |
|        - | 1189 | `/*` |
...
|        - | 1210 | ` */` |
|  5979593 | 1211 | `PH7_PRIVATE sxi32 PH7_MemObjStore(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1212 | `{` |
|  5979598 | 1213 | `	ph7_class_instance *pObj = 0;` |
|  5979598 | 1214 | `	ph7_hashmap *pMap = 0;` |
|        - | 1215 | `	sxi32 rc;` |
|  5979598 | 1216 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1217 | `		/* Increment reference count */` |
|   217831 | 1218 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  5870685 | 1219 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1220 | `		/* Increment reference count */` |
|    10121 | 1221 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|     5058 | 1222 | `	}` |
|  5979598 | 1223 | `	if( pDest->iFlags & MEMOBJ_HASHMAP ){` |
|    81225 | 1224 | `		pMap = (ph7_hashmap *)pDest->x.pOther;` |
|  5938988 | 1225 | `	}else if( pDest->iFlags & MEMOBJ_OBJ ){` |
|     8339 | 1226 | `		pObj = (ph7_class_instance *)pDest->x.pOther;` |
|     4167 | 1227 | `	}` |
|  5979598 | 1228 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  5979598 | 1229 | `	pDest->iFlags &= ~MEMOBJ_AUX;` |
|  5979598 | 1230 | `	rc = SXRET_OK;` |
|  5979598 | 1231 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4272951 | 1232 | `		SyBlobReset(&pDest->sBlob);` |
|  4272951 | 1233 | `		rc = SyBlobDup(&pSrc->sBlob,&pDest->sBlob);` |
|  2136478 | 1234 | `	}else{` |
|  1706652 | 1235 | `		if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|   358310 | 1236 | `			SyBlobRelease(&pDest->sBlob);` |
|   179176 | 1237 | `		}` |
|        - | 1238 | `	}` |
|  5979598 | 1239 | `	if( pMap ){` |
|    81225 | 1240 | `		PH7_HashmapUnref(pMap);` |
|  5938988 | 1241 | `	}else if( pObj ){` |
|     8339 | 1242 | `		PH7_ClassInstanceUnref(pObj);` |
|     4167 | 1243 | `	}` |
|  5979593 | 1244 | `	if( rc == SXRET_OK && (pDest->iFlags & MEMOBJ_HASHMAP)` |
|  3098733 | 1245 | `	 && pDest->pVm` |
|   217826 | 1246 | `	 && (ph7_hashmap *)pDest->x.pOther == pDest->pVm->pGlobal` |
...
|   108922 | 1250 | `	 && pDest != (ph7_value *)SySetAt(&pDest->pVm->aMemObj,pDest->pVm->nGlobalIdx) ){` |
...
|      ! 0 | 1263 | `		}` |
|        4 | 1264 | `	}` |
|  5979598 | 1265 | `	return rc;` |
|        5 | 1266 | `}` |
|        - | 1267 | `/*` |
|        - | 1268 | ` * Duplicate the contents of a ph7_value but do not copy internal` |
|        - | 1269 | ` * buffer contents,simply point to it.` |
|        - | 1270 | ` */` |
|  8659124 | 1271 | `PH7_PRIVATE sxi32 PH7_MemObjLoad(ph7_value *pSrc,ph7_value *pDest)` |
|        5 | 1272 | `{` |
|  8659129 | 1273 | `	SyMemcpy((const void *)&(*pSrc),&(*pDest),` |
|        - | 1274 | `		sizeof(ph7_value)-(sizeof(ph7_vm *)+sizeof(SyBlob)+sizeof(sxu32)));` |
|  8659129 | 1275 | `	if( pSrc->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1276 | `		/* Increment reference count */` |
|   542767 | 1277 | `		((ph7_hashmap *)pSrc->x.pOther)->iRef++;` |
|  8387748 | 1278 | `	}else if( pSrc->iFlags & MEMOBJ_OBJ ){` |
|        - | 1279 | `		/* Increment reference count */` |
|    48761 | 1280 | `		((ph7_class_instance *)pSrc->x.pOther)->iRef++;` |
|    24378 | 1281 | `	}` |
|  8659129 | 1282 | `	if( SyBlobLength(&pDest->sBlob) > 0 ){` |
|       46 | 1283 | `		SyBlobRelease(&pDest->sBlob);` |
|       21 | 1284 | `	}` |
|  8659129 | 1285 | `	if( SyBlobLength(&pSrc->sBlob) > 0 ){` |
|  4499479 | 1286 | `		SyBlobReadOnly(&pDest->sBlob,SyBlobData(&pSrc->sBlob),SyBlobLength(&pSrc->sBlob));` |
|  2249572 | 1287 | `	}` |
|  8659129 | 1288 | `	return SXRET_OK;` |
|        5 | 1289 | `}` |
|        - | 1290 | `/*` |
|        - | 1291 | ` * Invalidate any prior representation of a given ph7_value.` |
|        - | 1292 | ` */` |
| 20730945 | 1293 | `PH7_PRIVATE sxi32 PH7_MemObjRelease(ph7_value *pObj)` |
|        5 | 1294 | `{` |
| 20730950 | 1295 | `	if( (pObj->iFlags & MEMOBJ_NULL) == 0 ){` |
| 18082639 | 1296 | `		if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|   707657 | 1297 | `			PH7_HashmapUnref((ph7_hashmap *)pObj->x.pOther);` |
| 17728813 | 1298 | `		}else if( pObj->iFlags & MEMOBJ_OBJ ){` |
|    91707 | 1299 | `			PH7_ClassInstanceUnref((ph7_class_instance *)pObj->x.pOther);` |
|    45851 | 1300 | `		}` |
|        - | 1301 | `		/* Release the internal buffer */` |
| 18082639 | 1302 | `		SyBlobRelease(&pObj->sBlob);` |
|        - | 1303 | `		/* Invalidate any prior representation */` |
| 18082639 | 1304 | `		pObj->iFlags = MEMOBJ_NULL;` |
|  9041297 | 1305 | `	}` |
| 20730950 | 1306 | `	return SXRET_OK;` |
|        5 | 1307 | `}` |
|        - | 1308 | `/*` |
...
|        - | 1360 | ` */` |
|  1673345 | 1361 | `PH7_PRIVATE sxi32 PH7_MemObjCmp(ph7_value *pObj1,ph7_value *pObj2,int bStrict,int iNest)` |
|        5 | 1362 | `{` |
|        - | 1363 | `	sxi32 iComb;` |
|        - | 1364 | `	sxi32 rc;` |
|  1673350 | 1365 | `	if( bStrict ){` |
|        - | 1366 | `		sxi32 iF1,iF2;` |
|        - | 1367 | `		/* Strict comparisons with === */` |
|   857638 | 1368 | `		iF1 = pObj1->iFlags&~MEMOBJ_AUX;` |
|   857638 | 1369 | `		iF2 = pObj2->iFlags&~MEMOBJ_AUX;` |
|   857638 | 1370 | `		if( iF1 != iF2 ){` |
|        - | 1371 | `			/* Not of the same type */` |
|   197475 | 1372 | `			return 1;` |
|        - | 1373 | `		}` |
|   330082 | 1374 | `	}` |
|        - | 1375 | `	/* Combine flag together */` |
|  1475880 | 1376 | `	iComb = pObj1->iFlags\|pObj2->iFlags;` |
|  1475875 | 1377 | `	if( !bStrict` |
|  1145794 | 1378 | `	 && (iComb & MEMOBJ_NULL) != 0` |
|   407814 | 1379 | `	 && (iComb & MEMOBJ_STRING) != 0` |
...
|       55 | 1417 | `		return rc;` |
|  1451314 | 1418 | `	}else if(iComb & MEMOBJ_OBJ ){` |
...
|      277 | 1430 | `		return rc;` |
|  1451042 | 1431 | `	}else if ( iComb & MEMOBJ_STRING ){` |
|        - | 1432 | `		SyString s1,s2;` |
|   883593 | 1433 | `		if( !bStrict ){` |
|        - | 1434 | `			/*` |
...
|        - | 1445 | `			 */` |
|   250851 | 1446 | `			if( PH7_MemObjIsNumeric(pObj1) && PH7_MemObjIsNumeric(pObj2) ){` |
|        - | 1447 | `				/* Perform a numeric comparison */` |
|     1099 | 1448 | `				goto Numeric;` |
|        - | 1449 | `			}` |
|   124768 | 1450 | `		}` |
|        - | 1451 | `		/* Perform a strict string comparison.*/` |
|   882495 | 1452 | `		if( (pObj1->iFlags&MEMOBJ_STRING) == 0 ){` |
|       23 | 1453 | `			PH7_MemObjToString(pObj1);` |
|       11 | 1454 | `		}` |
|   882495 | 1455 | `		if( (pObj2->iFlags&MEMOBJ_STRING) == 0 ){` |
|        7 | 1456 | `			PH7_MemObjToString(pObj2);` |
|        3 | 1457 | `		}` |
|   882495 | 1458 | `		SyStringInitFromBuf(&s1,SyBlobData(&pObj1->sBlob),SyBlobLength(&pObj1->sBlob));` |
|   882495 | 1459 | `		SyStringInitFromBuf(&s2,SyBlobData(&pObj2->sBlob),SyBlobLength(&pObj2->sBlob));` |
|        - | 1460 | `		/*` |
...
|        - | 1463 | `		 */` |
|   882495 | 1464 | `		rc = SyMemcmp((const void *)s1.zString,(const void *)s2.zString,SXMIN(s1.nByte,s2.nByte));` |
|   882495 | 1465 | `		if( rc == 0 ){` |
|   293500 | 1466 | `			if( s1.nByte != s2.nByte ){` |
|    19518 | 1467 | `				rc = s1.nByte < s2.nByte ? -1 : 1;` |
|     9758 | 1468 | `			}` |
|   146749 | 1469 | `		}` |
|   882495 | 1470 | `		return rc;` |
|   567454 | 1471 | `	}else if( iComb & (MEMOBJ_INT\|MEMOBJ_REAL) ){` |
|   283699 | 1472 | `Numeric:` |
|        - | 1473 | `		/* Perform a numeric comparison if one of the operand is numeric(integer or real) */` |
|   568552 | 1474 | `		if( (pObj1->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1081 | 1475 | `			PH7_MemObjToNumeric(pObj1);` |
|      540 | 1476 | `		}` |
|   568552 | 1477 | `		if( (pObj2->iFlags & (MEMOBJ_INT\|MEMOBJ_REAL)) == 0 ){` |
|     1087 | 1478 | `			PH7_MemObjToNumeric(pObj2);` |
|      543 | 1479 | `		}` |
|   568552 | 1480 | `		if( (pObj1->iFlags & pObj2->iFlags & MEMOBJ_INT) == 0) {` |
|        - | 1481 | `			/*` |
...
|   568240 | 1514 | `			if( pObj1->x.iVal > pObj2->x.iVal ){` |
|     7573 | 1515 | `				return 1;` |
|   560672 | 1516 | `			}else if( pObj1->x.iVal < pObj2->x.iVal ){` |
|   549409 | 1517 | `				return -1;` |
|        - | 1518 | `			}` |
|    11268 | 1519 | `			return 0;` |
|        - | 1520 | `		}` |
|        - | 1521 | `	}` |
...
|        - | 1536 | ` */` |
|    12972 | 1537 | `PH7_PRIVATE sxi32 PH7_MemObjAdd(ph7_value *pObj1,ph7_value *pObj2,int bAddStore)` |
|        5 | 1538 | `{` |
|    12977 | 1539 | `	if( ((pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP) == 0 ){` |
...
|        - | 1577 | `			}` |
|     4599 | 1578 | `	}else{` |
|     3789 | 1579 | `		if( (pObj1->iFlags\|pObj2->iFlags) & MEMOBJ_HASHMAP ){` |
|        - | 1580 | `			ph7_hashmap *pMap;` |
|        - | 1581 | `			sxi32 rc;` |
|     3789 | 1582 | `			if( bAddStore ){` |
...
|     3787 | 1597 | `				pMap = PH7_NewHashmap(pObj1->pVm,0,0);` |
|     3787 | 1598 | `				if( pMap == 0){` |
|      ! 0 | 1599 | `					PH7_VmThrowError(pObj1->pVm,0,PH7_CTX_ERR,"PH7 is running out of memory while creating array");` |
|      ! 0 | 1600 | `					return SXERR_MEM;` |
|        - | 1601 | `				}` |
|        - | 1602 | `			}` |
|     3789 | 1603 | `			if( !bAddStore ){` |
|     3787 | 1604 | `				if(pObj1->iFlags & MEMOBJ_HASHMAP ){` |
|        - | 1605 | `					/* Perform a hashmap duplication */` |
|     3787 | 1606 | `					PH7_HashmapDup((ph7_hashmap *)pObj1->x.pOther,pMap);` |
|     1896 | 1607 | `				}else{` |
...
|     3789 | 1615 | `			if(pObj2->iFlags & MEMOBJ_HASHMAP ){` |
|     3789 | 1616 | `				PH7_HashmapUnion(pMap,(ph7_hashmap *)pObj2->x.pOther);` |
|     1897 | 1617 | `			}else{` |
...
|     3789 | 1624 | `			if( pObj1->iFlags & MEMOBJ_STRING ){` |
|      ! 0 | 1625 | `				SyBlobRelease(&pObj1->sBlob);` |
|      ! 0 | 1626 | `			}` |
|     3789 | 1627 | `			pObj1->x.pOther = pMap;` |
|     3789 | 1628 | `			MemObjSetType(pObj1,MEMOBJ_HASHMAP);` |
|     1892 | 1629 | `		}` |
|        - | 1630 | `	}` |
|    12977 | 1631 | `	return SXRET_OK;` |
|     6491 | 1632 | `}` |
|        - | 1633 | `/*` |
...
|      111 | 1728 | `}` |
|      598 | 1729 | `PH7_PRIVATE sxi32 PH7_MemObjDump(` |
...
|        - | 1737 | `	)` |
|        5 | 1738 | `{` |
|      603 | 1739 | `	sxi32 rc = SXRET_OK;` |
|        - | 1740 | `	int i;` |
|      603 | 1741 | `	if( !ShowType ){` |
...
|     4577 | 1757 | `	for( i = 0 ; i < nTab ; i++ ){` |
|     4088 | 1758 | `		SyBlobAppend(&(*pOut)," ",sizeof(char));` |
|     2046 | 1759 | `	}` |
|      493 | 1760 | `	if( isRef ){` |
|        7 | 1761 | `		SyBlobAppend(&(*pOut),"&",sizeof(char));` |
|        3 | 1762 | `	}` |
|      493 | 1763 | `	if( (pObj->iFlags & (MEMOBJ_OBJ\|MEMOBJ_NULL)) == MEMOBJ_OBJ ){` |
...
|      139 | 1777 | `		return rc;` |
|        - | 1778 | `	}` |
|      357 | 1779 | `	if( pObj->iFlags & MEMOBJ_NULL ){` |
|        3 | 1780 | `		SyBlobAppend(&(*pOut),"NULL\n",sizeof("NULL\n")-1);` |
|        3 | 1781 | `		return SXRET_OK;` |
|        - | 1782 | `	}` |
|      355 | 1783 | `	if( pObj->iFlags & MEMOBJ_HASHMAP ){` |
|       24 | 1784 | `		rc = PH7_HashmapDump(&(*pOut),(ph7_hashmap *)pObj->x.pOther,TRUE,nTab,nDepth+1);` |
|       24 | 1785 | `		SyBlobAppend(&(*pOut),"\n",sizeof(char));` |
|       24 | 1786 | `		return rc;` |
|        - | 1787 | `	}` |
|      333 | 1788 | `	if( pObj->iFlags & MEMOBJ_BOOL ){` |
|      140 | 1789 | `		if( pObj->x.iVal != 0 ){` |
|       94 | 1790 | `			SyBlobAppend(&(*pOut),"bool(true)\n",sizeof("bool(true)\n")-1);` |
|       49 | 1791 | `		}else{` |
|       49 | 1792 | `			SyBlobAppend(&(*pOut),"bool(false)\n",sizeof("bool(false)\n")-1);` |
|        - | 1793 | `		}` |
|      140 | 1794 | `		return SXRET_OK;` |
|        - | 1795 | `	}` |
