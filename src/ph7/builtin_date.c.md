...
|     - | 3069 | ` */` |
|  3954 | 3070 | `PH7_PRIVATE sxi32 PH7_VmInstallDateTime(ph7_vm *pVm)` |
|     5 | 3071 | `{` |
...
|  3959 | 3088 | `	SyMemcpy("UTC",pVm->zDefTz,sizeof("UTC"));` |
|  3959 | 3089 | `	pVm->nDefTz = sizeof("UTC") - 1;` |
| 39545 | 3090 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 35591 | 3091 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
| 17798 | 3092 | `	}` |
|  3959 | 3093 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zDateTimeLib,sizeof(zDateTimeLib)-1);` |
|     5 | 3094 | `}` |
|     - | 3095 |  |
