...
|     - | 3069 | ` */` |
|  3884 | 3070 | `PH7_PRIVATE sxi32 PH7_VmInstallDateTime(ph7_vm *pVm)` |
|     5 | 3071 | `{` |
...
|  3889 | 3088 | `	SyMemcpy("UTC",pVm->zDefTz,sizeof("UTC"));` |
|  3889 | 3089 | `	pVm->nDefTz = sizeof("UTC") - 1;` |
| 38845 | 3090 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 34961 | 3091 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
| 17483 | 3092 | `	}` |
|  3889 | 3093 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zDateTimeLib,sizeof(zDateTimeLib)-1);` |
|     5 | 3094 | `}` |
|     - | 3095 |  |
