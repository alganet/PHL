...
|     - |  362 | ` * c         ISO 8601 date` |
|     - |  363 | ` */` |
|   110 |  364 | `static sxi32 DateFormat(ph7_context *pCtx,const char *zIn,int nLen,Sytm *pTm)` |
|     1 |  365 | `{` |
|   111 |  366 | `	const char *zEnd = &zIn[nLen];` |
|     - |  367 | `	const char *zCur;` |
...
|   111 |  372 | `			break;` |
|     - |  373 | `		}` |
|   555 |  374 | `		switch(zIn[0]){` |
|    30 |  375 | `		case 'd':` |
|     - |  376 | `			/* Day of the month, 2 digits with leading zeros */` |
|    61 |  377 | `			ph7_result_string_format(pCtx,"%02d",pTm->tm_mday);` |
|    61 |  378 | `			break;` |
|   ! 0 |  379 | `		case 'D':` |
...
|    61 |  413 | `			ph7_result_string_format(pCtx,"%02d",pTm->tm_mon + 1);` |
|    61 |  414 | `			break;` |
|   ! 0 |  415 | `		case 'M':` |
...
|    67 |  460 | `			ph7_result_string_format(pCtx,"%04d",pTm->tm_year);` |
|    67 |  461 | `			break;` |
|   ! 0 |  462 | `		case 'X':` |
...
|    37 |  516 | `			ph7_result_string_format(pCtx,"%02d",pTm->tm_hour);` |
|    37 |  517 | `			break;` |
|    19 |  518 | `		case 'i':` |
|     - |  519 | `			/* 	Minutes with leading zeros */` |
|    39 |  520 | `			ph7_result_string_format(pCtx,"%02d",pTm->tm_min);` |
|    39 |  521 | `			break;` |
|    19 |  522 | `		case 's':` |
|     - |  523 | `			/* 	second with leading zeros */` |
|    39 |  524 | `			ph7_result_string_format(pCtx,"%02d",pTm->tm_sec);` |
|    39 |  525 | `			break;` |
|   ! 0 |  526 | `		case 'u':` |
...
|     4 |  603 | `			ph7_result_string_format(pCtx,"%qd",` |
|     2 |  604 | `				DtDaysFromCivil((sxi64)pTm->tm_year,pTm->tm_mon+1,pTm->tm_mday) * 86400` |
|     2 |  605 | `				+ (sxi64)pTm->tm_hour*3600 + (sxi64)pTm->tm_min*60 + (sxi64)pTm->tm_sec` |
|     2 |  606 | `				- (sxi64)pTm->tm_gmtoff);` |
|     3 |  607 | `			break;` |
|     1 |  608 | `		case 'O':{` |
...
|     3 |  617 | `			long a = pTm->tm_gmtoff < 0 ? -pTm->tm_gmtoff : pTm->tm_gmtoff;` |
|     3 |  618 | `			ph7_result_string_format(pCtx,"%c%02d:%02d",` |
|     2 |  619 | `				pTm->tm_gmtoff < 0 ? '-' : '+',(int)(a / 3600),(int)((a % 3600) / 60));` |
|     3 |  620 | `			break;` |
|     - |  621 | `				 }` |
|   ! 0 |  622 | `		case 'p':{` |
...
|     3 |  640 | `			long a = pTm->tm_gmtoff < 0 ? -pTm->tm_gmtoff : pTm->tm_gmtoff;` |
|     3 |  641 | `			ph7_result_string_format(pCtx,"%4d-%02d-%02dT%02d:%02d:%02d%c%02d:%02d",` |
|     1 |  642 | `				pTm->tm_year,` |
|     2 |  643 | `				pTm->tm_mon+1,` |
|     1 |  644 | `				pTm->tm_mday,` |
|     1 |  645 | `				pTm->tm_hour,` |
|     1 |  646 | `				pTm->tm_min,` |
|     1 |  647 | `				pTm->tm_sec,` |
|     2 |  648 | `				pTm->tm_gmtoff < 0 ? '-' : '+',(int)(a / 3600),(int)((a % 3600) / 60)` |
|     - |  649 | `				);` |
|     3 |  650 | `			break;` |
|     - |  651 | `				 }` |
|     1 |  652 | `		case '\\':` |
...
|   225 |  661 | `			ph7_result_string(pCtx,zIn,(int)sizeof(char));` |
|   224 |  662 | `			break;` |
|     - |  663 | `		}` |
|     - |  664 | `		/* Point to the next character */` |
|   555 |  665 | `		zIn++;` |
|     1 |  666 | `	}` |
|   111 |  667 | `	return SXRET_OK;` |
|     1 |  668 | `}` |
|     - |  669 | `/*` |
...
|     - | 1638 | ` */` |
|   238 | 1639 | `static sxi64 DtDaysFromCivil(sxi64 y,int m,int d)` |
|     1 | 1640 | `{` |
|     - | 1641 | `	sxi64 era;` |
|     - | 1642 | `	unsigned yoe,doy,doe;` |
|   239 | 1643 | `	y -= (m <= 2);` |
|   239 | 1644 | `	era = (y >= 0 ? y : y - 399) / 400;` |
|   239 | 1645 | `	yoe = (unsigned)(y - era * 400);` |
|   239 | 1646 | `	doy = (unsigned)((153 * (m + (m > 2 ? -3 : 9)) + 2) / 5 + d - 1);` |
|   239 | 1647 | `	doe = yoe * 365 + yoe / 4 - yoe / 100 + doy;` |
|   239 | 1648 | `	return era * 146097 + (sxi64)doe - 719468;` |
|     1 | 1649 | `}` |
|    38 | 1650 | `static void DtCivilFromDays(sxi64 z,sxi64 *py,int *pm,int *pd)` |
|     1 | 1651 | `{` |
|     - | 1652 | `	sxi64 era;` |
|     - | 1653 | `	unsigned doe,yoe,doy,mp;` |
|    39 | 1654 | `	z += 719468;` |
|    39 | 1655 | `	era = (z >= 0 ? z : z - 146096) / 146097;` |
|    39 | 1656 | `	doe = (unsigned)(z - era * 146097);` |
|    39 | 1657 | `	yoe = (doe - doe/1460 + doe/36524 - doe/146096) / 365;` |
|    39 | 1658 | `	*py = (sxi64)yoe + era * 400;` |
|    39 | 1659 | `	doy = doe - (365 * yoe + yoe/4 - yoe/100);` |
|    39 | 1660 | `	mp = (5 * doy + 2) / 153;` |
|    39 | 1661 | `	*pd = (int)(doy - (153 * mp + 2) / 5 + 1);` |
|    39 | 1662 | `	*pm = (int)(mp < 10 ? mp + 3 : mp - 9);` |
|    39 | 1663 | `	if( *pm <= 2 ){` |
|    19 | 1664 | `		*py += 1;` |
|     9 | 1665 | `	}` |
|    39 | 1666 | `}` |
|   108 | 1667 | `static sxi64 DtFloorDiv(sxi64 a,sxi64 b)` |
|     1 | 1668 | `{` |
|   109 | 1669 | `	sxi64 q = a / b;` |
|   109 | 1670 | `	if( (a % b) != 0 && ((a < 0) != (b < 0)) ){` |
|   ! 0 | 1671 | `		q--;` |
|   ! 0 | 1672 | `	}` |
|   109 | 1673 | `	return q;` |
|     1 | 1674 | `}` |
|     - | 1675 | `/* Timestamp + offset -> Sytm (with zone metadata for DateFormat's T/e/O/P/Z) */` |
|    34 | 1676 | `static void DtFillSytm(sxi64 iTs,sxi32 iOff,char *zZone,Sytm *pTm)` |
|     1 | 1677 | `{` |
|    35 | 1678 | `	sxi64 t = iTs + iOff;` |
|    35 | 1679 | `	sxi64 days = DtFloorDiv(t,86400);` |
|    35 | 1680 | `	sxi64 secs = t - days * 86400;` |
|     - | 1681 | `	sxi64 y;` |
|     - | 1682 | `	int mo,d;` |
|    35 | 1683 | `	DtCivilFromDays(days,&y,&mo,&d);` |
|    35 | 1684 | `	pTm->tm_sec  = (int)(secs % 60);` |
|    35 | 1685 | `	pTm->tm_min  = (int)((secs / 60) % 60);` |
|    35 | 1686 | `	pTm->tm_hour = (int)(secs / 3600);` |
|    35 | 1687 | `	pTm->tm_mday = d;` |
|    35 | 1688 | `	pTm->tm_mon  = mo - 1;` |
|    35 | 1689 | `	pTm->tm_year = (int)y;` |
|    35 | 1690 | `	pTm->tm_wday = (int)(((days % 7) + 11) % 7); /* day 0 = Thursday(4) */` |
|    35 | 1691 | `	pTm->tm_yday = (int)(days - DtDaysFromCivil(y,1,1));` |
|    35 | 1692 | `	pTm->tm_isdst = 0;` |
|    35 | 1693 | `	pTm->tm_zone = zZone;` |
|    35 | 1694 | `	pTm->tm_gmtoff = (long)iOff;` |
|    35 | 1695 | `}` |
|    20 | 1696 | `static sxi64 DtMakeTs(sxi64 y,int mo,int d,int h,int mi,int s,sxi32 iOff)` |
|     1 | 1697 | `{` |
|    21 | 1698 | `	return DtDaysFromCivil(y,mo,d) * 86400 + (sxi64)h*3600 + (sxi64)mi*60 + s - iOff;` |
|     1 | 1699 | `}` |
...
|     - | 1724 | ` */` |
|    58 | 1725 | `static int DtParse(const char *zIn,int nLen,sxi64 iBaseTs,sxi32 iBaseOff,` |
|     - | 1726 | `	sxi64 *pTs,sxi32 *pOff,int *pbOffSet)` |
|     1 | 1727 | `{` |
|    59 | 1728 | `	const char *z = zIn, *zEnd = &zIn[nLen];` |
|    59 | 1729 | `	sxi64 iTs = iBaseTs;` |
|    59 | 1730 | `	sxi32 iOff = iBaseOff;` |
|    59 | 1731 | `	int bOffSet = 0;` |
|    59 | 1732 | `	int bAny = 0;` |
...
|    11 | 1746 | `		int neg = 0;` |
|    11 | 1747 | `		sxi64 v = 0;` |
|    11 | 1748 | `		const char *zAt = z;` |
|    11 | 1749 | `		z++;` |
|    11 | 1750 | `		if( z < zEnd && (z[0]=='-'\|\|z[0]=='+') ){ neg = (z[0]=='-'); z++; }` |
|     - | 1751 | `		/* php's lexer rejects the whole token: the error points at the '@' */` |
|    11 | 1752 | `		if( z >= zEnd \|\| !SyisDigit(z[0]) ){ return (int)(zAt - zIn) + 1; }` |
|    45 | 1753 | `		while( z < zEnd && SyisDigit(z[0]) ){ v = v*10 + (z[0]-'0'); z++; }` |
|     9 | 1754 | `		*pTs = neg ? -v : v;` |
|     9 | 1755 | `		*pOff = 0;` |
|     9 | 1756 | `		*pbOffSet = 1;` |
|     9 | 1757 | `		DT_SKIP_WS();` |
|     9 | 1758 | `		return (z < zEnd) ? (int)(z - zIn) + 1 : 0;` |
|     - | 1759 | `	}` |
|     - | 1760 | `	/* Absolute date: YYYY-MM-DD[...] */` |
|    48 | 1761 | `	if( zEnd-z >= 10 && SyisDigit(z[0]) && SyisDigit(z[1]) && SyisDigit(z[2])` |
|    29 | 1762 | `	 && SyisDigit(z[3]) && z[4]=='-' ){` |
|    29 | 1763 | `		sxi64 y = (z[0]-'0')*1000 + (z[1]-'0')*100 + (z[2]-'0')*10 + (z[3]-'0');` |
|    29 | 1764 | `		int mo,d,h=0,mi=0,s=0;` |
|    29 | 1765 | `		if( !SyisDigit(z[5])\|\|!SyisDigit(z[6])\|\|z[7] != '-'\|\|!SyisDigit(z[8])\|\|!SyisDigit(z[9]) ){` |
|   ! 0 | 1766 | `			return (int)(z - zIn) + 1;` |
|     - | 1767 | `		}` |
|    29 | 1768 | `		mo = (z[5]-'0')*10 + (z[6]-'0');` |
|    29 | 1769 | `		d  = (z[8]-'0')*10 + (z[9]-'0');` |
...
|    29 | 1774 | `		if( mo > 12 ){ return (int)(&z[6] - zIn) + 1; }` |
|    25 | 1775 | `		if( d > 31 ){ return (int)(&z[9] - zIn) + 1; }` |
|    23 | 1776 | `		if( mo == 0 ){ mo = 12; y--; }` |
|    23 | 1777 | `		z += 10;` |
|    22 | 1778 | `		if( z < zEnd && (z[0]=='T' \|\| z[0]==' ') && zEnd-z >= 6` |
|    17 | 1779 | `		 && SyisDigit(z[1]) && SyisDigit(z[2]) && z[3]==':' ){` |
|    17 | 1780 | `			z++;` |
|    17 | 1781 | `			h  = (z[0]-'0')*10 + (z[1]-'0');` |
|    17 | 1782 | `			mi = (z[3]-'0')*10 + (z[4]-'0');` |
|     - | 1783 | `			/* a 25+ hour kills php's whole time token: error at its start */` |
|    17 | 1784 | `			if( h > 24 ){ return (int)(z - zIn) + 1; }` |
...
|    15 | 1787 | `			if( mi > 59 ){ return -((int)(&z[4] - zIn) + 1); }` |
|    13 | 1788 | `			z += 5;` |
|    12 | 1789 | `			if( z+2 < zEnd+1 && z < zEnd && z[0]==':' && zEnd-z >= 3` |
|    13 | 1790 | `			 && SyisDigit(z[1]) && SyisDigit(z[2]) ){` |
|    13 | 1791 | `				s = (z[1]-'0')*10 + (z[2]-'0');` |
|    13 | 1792 | `				if( s > 59 ){ return (int)(&z[2] - zIn) + 1; }` |
|    11 | 1793 | `				z += 3;` |
|     5 | 1794 | `			}` |
|    11 | 1795 | `			if( z < zEnd && z[0]=='.' ){ /* fractional seconds: consume */` |
|   ! 0 | 1796 | `				z++;` |
|   ! 0 | 1797 | `				while( z < zEnd && SyisDigit(z[0]) ){ z++; }` |
|   ! 0 | 1798 | `			}` |
|    11 | 1799 | `			if( z < zEnd && (z[0]=='Z' \|\| z[0]=='z') ){` |
|     - | 1800 | `				/* 2 = explicit "Z" zone: php names it "Z", not "+00:00" */` |
|   ! 0 | 1801 | `				iOff = 0; bOffSet = 2; z++;` |
|    11 | 1802 | `			}else if( z < zEnd && (z[0]=='+' \|\| z[0]=='-') ){` |
...
|     1 | 1816 | `			}` |
|     5 | 1817 | `		}` |
|    17 | 1818 | `		iTs = DtMakeTs(y,mo,d,h,mi,s,iOff);` |
|    17 | 1819 | `		bAny = 1;` |
|    29 | 1820 | `	}else if( zEnd-z >= 5 && SyisDigit(z[0]) && SyisDigit(z[1]) && z[2]==':'` |
...
|    23 | 1918 | `	*pTs = iTs;` |
|    23 | 1919 | `	*pOff = iOff;` |
|    23 | 1920 | `	*pbOffSet = bOffSet;` |
|    23 | 1921 | `	return 0;` |
|     - | 1922 | `#undef DT_SKIP_WS` |
|     - | 1923 | `#undef DT_LOWEQ` |
|    30 | 1924 | `}` |
|     - | 1925 | `/* int __dt_now() */` |
|    50 | 1926 | `static int vm_builtin_dt_now(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     1 | 1927 | `{` |
|    25 | 1928 | `	SXUNUSED(nArg);` |
|    25 | 1929 | `	SXUNUSED(apArg);` |
|    51 | 1930 | `	ph7_result_int64(pCtx,(ph7_int64)time(0));` |
|    51 | 1931 | `	return PH7_OK;` |
|     1 | 1932 | `}` |
...
|    58 | 1936 | `static int vm_builtin_dt_parse(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     1 | 1937 | `{` |
|     - | 1938 | `	const char *zIn;` |
|     - | 1939 | `	int nLen;` |
|     - | 1940 | `	sxi64 iBaseTs;` |
|     - | 1941 | `	sxi32 iBaseOff;` |
|    59 | 1942 | `	sxi64 iTs = 0;` |
|    59 | 1943 | `	sxi32 iOff = 0;` |
|    59 | 1944 | `	int bOffSet = 0;` |
|     - | 1945 | `	int iErrPos;` |
|    59 | 1946 | `	if( nArg < 3 ){` |
|   ! 0 | 1947 | `		ph7_result_bool(pCtx,0);` |
|   ! 0 | 1948 | `		return PH7_OK;` |
|     - | 1949 | `	}` |
|    59 | 1950 | `	zIn = ph7_value_to_string(apArg[0],&nLen);` |
|    59 | 1951 | `	iBaseTs  = ph7_value_to_int64(apArg[1]);` |
|    59 | 1952 | `	iBaseOff = (sxi32)ph7_value_to_int64(apArg[2]);` |
|    59 | 1953 | `	iErrPos = DtParse(zIn,nLen,iBaseTs,iBaseOff,&iTs,&iOff,&bOffSet);` |
|    59 | 1954 | `	if( iErrPos != 0 ){` |
...
|     - | 1969 | `	}` |
|     - | 1970 | `	{` |
|    31 | 1971 | `		ph7_value *pArr = ph7_context_new_array(pCtx);` |
|    31 | 1972 | `		ph7_value *pV = ph7_context_new_scalar(pCtx);` |
|    31 | 1973 | `		if( pArr == 0 \|\| pV == 0 ){` |
|   ! 0 | 1974 | `			return PH7_ContextMemoryError(pCtx);` |
|     - | 1975 | `		}` |
|    31 | 1976 | `		ph7_value_int64(pV,iTs);` |
|    31 | 1977 | `		ph7_array_add_elem(pArr,0,pV);` |
|    31 | 1978 | `		ph7_value_int64(pV,iOff);` |
|    31 | 1979 | `		ph7_array_add_elem(pArr,0,pV);` |
|     - | 1980 | `		/* int, not bool: 0 = no explicit offset, 1 = numeric offset/@epoch,` |
|     - | 1981 | `		 * 2 = literal "Z" (php keeps the distinction in the zone name) */` |
|    31 | 1982 | `		ph7_value_int64(pV,bOffSet);` |
|    31 | 1983 | `		ph7_array_add_elem(pArr,0,pV);` |
|    31 | 1984 | `		ph7_result_value(pCtx,pArr);` |
|     - | 1985 | `	}` |
|    31 | 1986 | `	return PH7_OK;` |
|    30 | 1987 | `}` |
|     - | 1988 | `/* string __dt_default_tz(void) — the date_default_timezone_set() identifier */` |
|    50 | 1989 | `static int vm_builtin_dt_default_tz(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     1 | 1990 | `{` |
|    25 | 1991 | `	SXUNUSED(nArg);` |
|    25 | 1992 | `	SXUNUSED(apArg);` |
|    51 | 1993 | `	ph7_result_string(pCtx,pCtx->pVm->zDefTz,(int)pCtx->pVm->nDefTz);` |
|    51 | 1994 | `	return PH7_OK;` |
|     1 | 1995 | `}` |
|     - | 1996 | `/* string __dt_format(int $ts, int $off, string $tzname, string $format) */` |
|    34 | 1997 | `static int vm_builtin_dt_format(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|     1 | 1998 | `{` |
|     - | 1999 | `	Sytm sTm;` |
|     - | 2000 | `	sxi64 iTs;` |
|     - | 2001 | `	sxi32 iOff;` |
...
|     - | 2008 | `	}` |
|    35 | 2009 | `	iTs  = ph7_value_to_int64(apArg[0]);` |
|    35 | 2010 | `	iOff = (sxi32)ph7_value_to_int64(apArg[1]);` |
|    35 | 2011 | `	zName = ph7_value_to_string(apArg[2],&nName);` |
|    35 | 2012 | `	zFmt  = ph7_value_to_string(apArg[3],&nFmt);` |
|    35 | 2013 | `	if( nName >= (int)sizeof(zZone) ){ nName = (int)sizeof(zZone) - 1; }` |
|    35 | 2014 | `	SyMemcpy(zName,zZone,(sxu32)nName);` |
|    35 | 2015 | `	zZone[nName] = 0;` |
|    35 | 2016 | `	DtFillSytm(iTs,iOff,zZone,&sTm);` |
|    35 | 2017 | `	DateFormat(pCtx,zFmt,nFmt,&sTm);` |
|    35 | 2018 | `	return PH7_OK;` |
|    18 | 2019 | `}` |
...
|     3 | 2039 | `}` |
|     - | 2040 | `/*` |
|     - | 2041 | ` * The embedded DateTime library. Timezone scope: UTC + fixed offsets.` |
|     - | 2042 | ` */` |
|     - | 2043 | `static const char zDateTimeLib[] =` |
|     - | 2044 | `"class DateMalformedStringException extends Exception {}"` |
|     - | 2045 | `"class DateInvalidTimeZoneException extends Exception {}"` |
|     - | 2046 | `"interface DateTimeInterface {"` |
|     - | 2047 | `" const ATOM = 'Y-m-d\\TH:i:sP';"` |
|     - | 2048 | `" const COOKIE = 'l, d-M-Y H:i:s T';"` |
|     - | 2049 | `" const ISO8601 = 'Y-m-d\\TH:i:sO';"` |
|     - | 2050 | `" const ISO8601_EXPANDED = 'X-m-d\\TH:i:sP';"` |
|     - | 2051 | `" const RFC822 = 'D, d M y H:i:s O';"` |
|     - | 2052 | `" const RFC850 = 'l, d-M-y H:i:s T';"` |
|     - | 2053 | `" const RFC1036 = 'D, d M y H:i:s O';"` |
|     - | 2054 | `" const RFC1123 = 'D, d M Y H:i:s O';"` |
|     - | 2055 | `" const RFC7231 = 'D, d M Y H:i:s \\G\\M\\T';"` |
|     - | 2056 | `" const RFC2822 = 'D, d M Y H:i:s O';"` |
|     - | 2057 | `" const RFC3339 = 'Y-m-d\\TH:i:sP';"` |
|     - | 2058 | `" const RFC3339_EXTENDED = 'Y-m-d\\TH:i:s.vP';"` |
|     - | 2059 | `" const RSS = 'D, d M Y H:i:s O';"` |
|     - | 2060 | `" const W3C = 'Y-m-d\\TH:i:sP';"` |
|     - | 2061 | `"}"` |
|     - | 2062 | `"class DateTimeZone {"` |
|     - | 2063 | `" private $__dtzOff = 0;"` |
|     - | 2064 | `" private $__dtzName = 'UTC';"` |
|     - | 2065 | `" public function __construct($timezone = 'UTC'){"` |
|     - | 2066 | `"  $tz = (string)$timezone;"` |
|     - | 2067 | `"  if( strcasecmp($tz, 'UTC') === 0 ){"` |
|     - | 2068 | `"   $this->__dtzOff = 0; $this->__dtzName = 'UTC';"` |
|     - | 2069 | `"   return;"` |
|     - | 2070 | `"  }"` |
|     - | 2071 | `"  if( $tz === 'Z' ){"` |
|     - | 2072 | `"   $this->__dtzOff = 0; $this->__dtzName = 'Z';"` |
|     - | 2073 | `"   return;"` |
|     - | 2074 | `"  }"` |
|     - | 2075 | `"  if( strcasecmp($tz, 'GMT') === 0 ){"` |
|     - | 2076 | `"   $this->__dtzOff = 0; $this->__dtzName = 'GMT';"` |
|     - | 2077 | `"   return;"` |
|     - | 2078 | `"  }"` |
|     - | 2079 | `"  $m = null;"` |
|     - | 2080 | `"  if( preg_match('/^([+-])(\\d{2}):?(\\d{2})$/', $tz, $m) ){"` |
|     - | 2081 | `"   $off = ((int)$m[2]) * 3600 + ((int)$m[3]) * 60;"` |
|     - | 2082 | `"   if( $m[1] === '-' ){ $off = -$off; }"` |
|     - | 2083 | `"   $this->__dtzOff = $off;"` |
|     - | 2084 | `"   $this->__dtzName = $m[1] . $m[2] . ':' . $m[3];"` |
|     - | 2085 | `"   return;"` |
|     - | 2086 | `"  }"` |
|     - | 2087 | `"  throw new DateInvalidTimeZoneException("` |
|     - | 2088 | `"   'DateTimeZone::__construct(): Unknown or bad timezone (' . $tz . ')');"` |
|     - | 2089 | `" }"` |
|     - | 2090 | `" public function getName(){ return $this->__dtzName; }"` |
|     - | 2091 | `" public function getOffset($datetime = null){ return $this->__dtzOff; }"` |
|     - | 2092 | `"}"` |
|     - | 2093 | `"trait __DtCoreT {"` |
|     - | 2094 | `" private $__dtTs = 0;"` |
|     - | 2095 | `" private $__dtOff = 0;"` |
|     - | 2096 | `" private $__dtName = 'UTC';"` |
|     - | 2097 | `" private function __dtInit($datetime, $timezone){"` |
|     - | 2098 | `"  $off = 0; $name = __dt_default_tz();"` |
|     - | 2099 | `"  if( $timezone !== null ){"` |
|     - | 2100 | `"   $off = $timezone->getOffset($this);"` |
|     - | 2101 | `"   $name = $timezone->getName();"` |
|     - | 2102 | `"  }"` |
|     - | 2103 | `"  $r = __dt_parse((string)$datetime, __dt_now(), $off);"` |
|     - | 2104 | `"  if( is_string($r) ){ throw new DateMalformedStringException($r); }"` |
|     - | 2105 | `"  $this->__dtTs = $r[0];"` |
|     - | 2106 | `"  if( $r[2] ){"` |
|     - | 2107 | `"   $this->__dtOff = $r[1];"` |
|     - | 2108 | `"   $this->__dtName = $r[2] === 2 ? 'Z' : $this->__dtOffName($r[1]);"` |
|     - | 2109 | `"  }else{"` |
|     - | 2110 | `"   $this->__dtOff = $off;"` |
|     - | 2111 | `"   $this->__dtName = $name;"` |
|     - | 2112 | `"  }"` |
|     - | 2113 | `" }"` |
|     - | 2114 | `" private function __dtOffName($off){"` |
|     - | 2115 | `"  $s = $off < 0 ? '-' : '+';"` |
|     - | 2116 | `"  $a = $off < 0 ? -$off : $off;"` |
|     - | 2117 | `"  return $s . sprintf('%02d:%02d', intdiv($a, 3600), intdiv($a % 3600, 60));"` |
|     - | 2118 | `" }"` |
|     - | 2119 | `" public function format($format){ return __dt_format($this->__dtTs, $this->__dtOff, $this->__dtName, (string)$format); }"` |
|     - | 2120 | `" public function getTimestamp(){ return $this->__dtTs; }"` |
|     - | 2121 | `" public function getOffset(){ return $this->__dtOff; }"` |
|     - | 2122 | `" public function getTimezone(){ return new DateTimeZone($this->__dtName); }"` |
|     - | 2123 | `"}"` |
|     - | 2124 | `"class DateTime implements DateTimeInterface {"` |
|     - | 2125 | `" use __DtCoreT;"` |
|     - | 2126 | `" public function __construct($datetime = 'now', $timezone = null){"` |
|     - | 2127 | `"  $this->__dtInit($datetime, $timezone);"` |
|     - | 2128 | `" }"` |
|     - | 2129 | `" public function modify($modifier){"` |
|     - | 2130 | `"  $r = __dt_parse((string)$modifier, $this->__dtTs, $this->__dtOff);"` |
|     - | 2131 | `"  if( is_string($r) ){ throw new DateMalformedStringException('DateTime::modify(): ' . $r); }"` |
|     - | 2132 | `"  $this->__dtTs = $r[0];"` |
|     - | 2133 | `"  return $this;"` |
|     - | 2134 | `" }"` |
|     - | 2135 | `" public function setTimestamp($timestamp){ $this->__dtTs = (int)$timestamp; return $this; }"` |
|     - | 2136 | `" public function setTimezone($timezone){"` |
|     - | 2137 | `"  $this->__dtOff = $timezone->getOffset($this);"` |
|     - | 2138 | `"  $this->__dtName = $timezone->getName();"` |
|     - | 2139 | `"  return $this;"` |
|     - | 2140 | `" }"` |
|     - | 2141 | `" public function setDate($year, $month, $day){"` |
|     - | 2142 | `"  $this->__dtTs = __dt_make($year, $month, $day, (int)$this->format('G'), (int)$this->format('i'), (int)$this->format('s'), $this->__dtOff);"` |
|     - | 2143 | `"  return $this;"` |
|     - | 2144 | `" }"` |
|     - | 2145 | `" public function setTime($hour, $minute, $second = 0, $microsecond = 0){"` |
|     - | 2146 | `"  $this->__dtTs = __dt_make((int)$this->format('Y'), (int)$this->format('n'), (int)$this->format('j'), $hour, $minute, $second, $this->__dtOff);"` |
|     - | 2147 | `"  return $this;"` |
|     - | 2148 | `" }"` |
|     - | 2149 | `"}"` |
|     - | 2150 | `"class DateTimeImmutable implements DateTimeInterface {"` |
|     - | 2151 | `" use __DtCoreT;"` |
|     - | 2152 | `" public function __construct($datetime = 'now', $timezone = null){"` |
|     - | 2153 | `"  $this->__dtInit($datetime, $timezone);"` |
|     - | 2154 | `" }"` |
|     - | 2155 | `" public function modify($modifier){"` |
|     - | 2156 | `"  $r = __dt_parse((string)$modifier, $this->__dtTs, $this->__dtOff);"` |
|     - | 2157 | `"  if( is_string($r) ){ throw new DateMalformedStringException('DateTimeImmutable::modify(): ' . $r); }"` |
|     - | 2158 | `"  $c = clone $this;"` |
|     - | 2159 | `"  $c->__dtTs = $r[0];"` |
|     - | 2160 | `"  return $c;"` |
|     - | 2161 | `" }"` |
|     - | 2162 | `" public function setTimestamp($timestamp){ $c = clone $this; $c->__dtTs = (int)$timestamp; return $c; }"` |
|     - | 2163 | `" public function setTimezone($timezone){"` |
|     - | 2164 | `"  $c = clone $this;"` |
|     - | 2165 | `"  $c->__dtOff = $timezone->getOffset($this);"` |
|     - | 2166 | `"  $c->__dtName = $timezone->getName();"` |
|     - | 2167 | `"  return $c;"` |
|     - | 2168 | `" }"` |
|     - | 2169 | `" public function setDate($year, $month, $day){"` |
|     - | 2170 | `"  $c = clone $this;"` |
|     - | 2171 | `"  $c->__dtTs = __dt_make($year, $month, $day, (int)$this->format('G'), (int)$this->format('i'), (int)$this->format('s'), $this->__dtOff);"` |
|     - | 2172 | `"  return $c;"` |
|     - | 2173 | `" }"` |
|     - | 2174 | `" public function setTime($hour, $minute, $second = 0, $microsecond = 0){"` |
|     - | 2175 | `"  $c = clone $this;"` |
|     - | 2176 | `"  $c->__dtTs = __dt_make((int)$this->format('Y'), (int)$this->format('n'), (int)$this->format('j'), $hour, $minute, $second, $this->__dtOff);"` |
|     - | 2177 | `"  return $c;"` |
|     - | 2178 | `" }"` |
|     - | 2179 | `"}"` |
|     - | 2180 | `"function date_create($datetime = 'now', $timezone = null){"` |
|     - | 2181 | `" try { return new DateTime($datetime, $timezone); } catch (Exception $e) { return false; }"` |
|     - | 2182 | `"}"` |
|     - | 2183 | `"function date_create_immutable($datetime = 'now', $timezone = null){"` |
|     - | 2184 | `" try { return new DateTimeImmutable($datetime, $timezone); } catch (Exception $e) { return false; }"` |
|     - | 2185 | `"}"` |
|     - | 2186 | `;` |
|     - | 2187 | `/*` |
|     - | 2188 | ` * Install the DateTime family: thunks first, then the chunk. Called from` |
|     - | 2189 | ` * PH7_VmInit inside the bCompilingBuiltin window, after the Reflection` |
|     - | 2190 | ` * install (Exception must exist).` |
|     - | 2191 | ` */` |
|  3872 | 2192 | `PH7_PRIVATE sxi32 PH7_VmInstallDateTime(ph7_vm *pVm)` |
|     5 | 2193 | `{` |
|     - | 2194 | `	static const struct {` |
|     - | 2195 | `		const char *zName;` |
|     - | 2196 | `		ProchHostFunction xFunc;` |
|     - | 2197 | `	} aFunc[] = {` |
|     - | 2198 | `		{ "__dt_now",    vm_builtin_dt_now },` |
|     - | 2199 | `		{ "__dt_default_tz", vm_builtin_dt_default_tz },` |
|     - | 2200 | `		{ "__dt_parse",  vm_builtin_dt_parse },` |
|     - | 2201 | `		{ "__dt_format", vm_builtin_dt_format },` |
|     - | 2202 | `		{ "__dt_make",   vm_builtin_dt_make },` |
|     - | 2203 | `	};` |
|     - | 2204 | `	sxu32 n;` |
|     - | 2205 | `	/* php's date.timezone default */` |
|  3877 | 2206 | `	SyMemcpy("UTC",pVm->zDefTz,sizeof("UTC"));` |
|  3877 | 2207 | `	pVm->nDefTz = sizeof("UTC") - 1;` |
| 23237 | 2208 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 19365 | 2209 | `		ph7_create_function(&(*pVm),aFunc[n].zName,aFunc[n].xFunc,0);` |
|  9685 | 2210 | `	}` |
|  3877 | 2211 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zDateTimeLib,sizeof(zDateTimeLib)-1);` |
|     5 | 2212 | `}` |
|     - | 2213 |  |
|     - | 2214 | `#endif /* PH7_DISABLE_BUILTIN_FUNC */` |
|     - | 2215 |  |
|     - | 2216 | `#ifdef PH7_DISABLE_BUILTIN_FUNC` |
|     - | 2217 | `/* Tiny build: no DateTime family (builtin layer disabled) */` |
|     - | 2218 | `PH7_PRIVATE sxi32 PH7_VmInstallDateTime(ph7_vm *pVm){` |
|     - | 2219 | `	SyMemcpy("UTC",pVm->zDefTz,sizeof("UTC"));` |
|     - | 2220 | `	pVm->nDefTz = sizeof("UTC") - 1;` |
