...
|      - |   27 | ` */` |
|  51712 |   28 | `PH7_PRIVATE VmOpRc VmExecOpConsume(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |   29 | `{` |
|  51717 |   30 | `	ph7_value *pTos = pState->pTos;` |
|  51717 |   31 | `	ph7_value *pStack = pState->pStack;` |
|  51717 |   32 | `	VmInstr *aInstr = pState->aInstr;` |
|  51717 |   33 | `	sxi32 pc = pState->pc;` |
|      - |   34 | `	sxi32 rc;` |
|  25856 |   35 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
|  51717 |   36 | `	ph7_output_consumer *pCons = &pVm->sVmConsumer;` |
|  51717 |   37 | `	ph7_value *pCur,*pOut = pTos;` |
|      - |   38 |  |
|  51717 |   39 | `	pOut = &pTos[-pInstr->iP1 + 1];` |
|  51717 |   40 | `	pCur = pOut;` |
|      - |   41 | `	/* Start the consume process  */` |
| 103429 |   42 | `	while( pOut <= pTos ){` |
|      - |   43 | `		/* Force a string cast */` |
|  51717 |   44 | `		if( (pOut->iFlags & MEMOBJ_STRING) == 0 ){` |
|   3189 |   45 | `			PH7_MemObjToString(pOut);` |
|   1592 |   46 | `		}` |
|  51717 |   47 | `		if( SyBlobLength(&pOut->sBlob) > 0 ){` |
|      - |   48 | `			/*SyBlobNullAppend(&pOut->sBlob);*/` |
|      - |   49 | `			/* Invoke the output consumer callback */` |
|  39193 |   50 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|  39193 |   51 | `			VmTrackOutput(pVm, SyBlobLength(&pOut->sBlob));` |
|  39193 |   52 | `			SyBlobRelease(&pOut->sBlob);` |
|  39193 |   53 | `			if( rc == SXERR_ABORT ){` |
...
|  51717 |   58 | `		pOut++;` |
|      5 |   59 | `	}` |
|  51717 |   60 | `	pTos = &pCur[-1];` |
|  51717 |   61 | `	VM_EXIT_BREAK;` |
|    ! 0 |   62 | `	VM_EXIT_BREAK;` |
|  25861 |   63 | `}` |
|      - |   64 |  |
|      - |   65 | `/*` |
...
|      - |  407 | ` */` |
|   2724 |  408 | `PH7_PRIVATE VmOpRc VmExecOpLoadException(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  409 | `{` |
|   2729 |  410 | `	ph7_value *pTos = pState->pTos;` |
|   2729 |  411 | `	ph7_value *pStack = pState->pStack;` |
|   2729 |  412 | `	VmInstr *aInstr = pState->aInstr;` |
|   2729 |  413 | `	sxi32 pc = pState->pc;` |
|      - |  414 | `	sxi32 rc;` |
|   1362 |  415 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
...
|      - |  418 | `	 * compiled object. */` |
|   2729 |  419 | `	ph7_exception *pException = VmExcActivate(&(*pVm),(ph7_exception *)pInstr->p3);` |
|      - |  420 | `	VmFrame *pFrameLocal;` |
|   2729 |  421 | `	if( pException == 0 ){` |
...
|   2729 |  427 | `	rc = VmEnterFrame(&(*pVm),0,0,&pFrameLocal);` |
|   2729 |  428 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  429 | `		VmExcRelease(&(*pVm),pException);` |
|    ! 0 |  430 | `		VmErrorFormat(&(*pVm),PH7_CTX_ERR,"Fatal PH7 engine is runnig out of memory");` |
|    ! 0 |  431 | `		VM_EXIT_ABORT;` |
|      - |  432 | `	}` |
|   2729 |  433 | `	if( SXRET_OK != SySetPut(&pVm->aException,(const void *)&pException) ){` |
...
|   2729 |  440 | `	pFrameLocal->iFlags \|= VM_FRAME_EXCEPTION;` |
|   2729 |  441 | `	pFrameLocal->iExceptionJump = pInstr->iP2;` |
...
|   2729 |  448 | `	pException->iLandingPc = pFrameLocal->iExceptionJump;` |
|   2729 |  449 | `	pException->pOwnerInstr = (void *)aInstr;` |
...
|   2729 |  454 | `	pException->iStackDepth = (sxi32)(pTos - pStack);` |
|      - |  455 | `	/* '@' depth at try entry — see ph7_exception.iErrSuppress */` |
|   2729 |  456 | `	pException->iErrSuppress = pVm->nErrSuppress;` |
|      - |  457 | `	/* Point to the frame that trigger the exception */` |
|   2729 |  458 | `	pFrameLocal = pFrameLocal->pParent;` |
|   2729 |  459 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
|   2729 |  460 | `	pException->pFrame = pFrameLocal;` |
|   2729 |  461 | `	VM_EXIT_BREAK;` |
|    ! 0 |  462 | `	VM_EXIT_BREAK;` |
|   1367 |  463 | `}` |
|      - |  464 |  |
