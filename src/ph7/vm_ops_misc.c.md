...
|  39681 |   50 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|  39681 |   51 | `			VmTrackOutput(pVm, SyBlobLength(&pOut->sBlob));` |
|  39681 |   52 | `			SyBlobRelease(&pOut->sBlob);` |
|  39681 |   53 | `			if( rc == SXERR_ABORT ){` |
