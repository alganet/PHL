...
|  38601 |   50 | `			rc = pCons->xConsumer(SyBlobData(&pOut->sBlob),SyBlobLength(&pOut->sBlob),pCons->pUserData);` |
|  38601 |   51 | `			VmTrackOutput(pVm, SyBlobLength(&pOut->sBlob));` |
|  38601 |   52 | `			SyBlobRelease(&pOut->sBlob);` |
|  38601 |   53 | `			if( rc == SXERR_ABORT ){` |
...
|      - |  407 | ` */` |
|   2710 |  408 | `PH7_PRIVATE VmOpRc VmExecOpLoadException(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|      5 |  409 | `{` |
|   2715 |  410 | `	ph7_value *pTos = pState->pTos;` |
|   2715 |  411 | `	ph7_value *pStack = pState->pStack;` |
|   2715 |  412 | `	VmInstr *aInstr = pState->aInstr;` |
|   2715 |  413 | `	sxi32 pc = pState->pc;` |
|      - |  414 | `	sxi32 rc;` |
|   1355 |  415 | `	SXUNUSED(pInstr); SXUNUSED(pStack); SXUNUSED(aInstr); SXUNUSED(rc);` |
...
|      - |  418 | `	 * compiled object. */` |
|   2715 |  419 | `	ph7_exception *pException = VmExcActivate(&(*pVm),(ph7_exception *)pInstr->p3);` |
|      - |  420 | `	VmFrame *pFrameLocal;` |
|   2715 |  421 | `	if( pException == 0 ){` |
...
|   2715 |  427 | `	rc = VmEnterFrame(&(*pVm),0,0,&pFrameLocal);` |
|   2715 |  428 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  429 | `		VmExcRelease(&(*pVm),pException);` |
|    ! 0 |  430 | `		VmErrorFormat(&(*pVm),PH7_CTX_ERR,"Fatal PH7 engine is runnig out of memory");` |
|    ! 0 |  431 | `		VM_EXIT_ABORT;` |
|      - |  432 | `	}` |
|   2715 |  433 | `	if( SXRET_OK != SySetPut(&pVm->aException,(const void *)&pException) ){` |
...
|   2715 |  440 | `	pFrameLocal->iFlags \|= VM_FRAME_EXCEPTION;` |
|   2715 |  441 | `	pFrameLocal->iExceptionJump = pInstr->iP2;` |
...
|   2715 |  448 | `	pException->iLandingPc = pFrameLocal->iExceptionJump;` |
|   2715 |  449 | `	pException->pOwnerInstr = (void *)aInstr;` |
...
|   2715 |  454 | `	pException->iStackDepth = (sxi32)(pTos - pStack);` |
|      - |  455 | `	/* '@' depth at try entry — see ph7_exception.iErrSuppress */` |
|   2715 |  456 | `	pException->iErrSuppress = pVm->nErrSuppress;` |
|      - |  457 | `	/* Point to the frame that trigger the exception */` |
|   2715 |  458 | `	pFrameLocal = pFrameLocal->pParent;` |
|   2715 |  459 | `	pFrameLocal = VmSkipExceptionFrames(pFrameLocal);` |
|   2715 |  460 | `	pException->pFrame = pFrameLocal;` |
|   2715 |  461 | `	VM_EXIT_BREAK;` |
|    ! 0 |  462 | `	VM_EXIT_BREAK;` |
|   1360 |  463 | `}` |
|      - |  464 |  |
