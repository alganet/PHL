...
|    35 | 1741 | `}` |
|  3878 | 1742 | `PH7_PRIVATE sxi32 PH7_VmInstallReflection(ph7_vm *pVm)` |
|     5 | 1743 | `{` |
...
|     - | 1769 | `	};` |
|     - | 1770 | `	sxu32 n;` |
| 85321 | 1771 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 81443 | 1772 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 40724 | 1773 | `	}` |
|  3883 | 1774 | `	return PH7_VmInstallReflectionLib(&(*pVm));` |
|     5 | 1775 | `}` |
|     - | 1776 |  |
