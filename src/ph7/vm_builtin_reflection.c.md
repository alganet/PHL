...
|     - | 3374 | ` */` |
|  3824 | 3375 | `PH7_PRIVATE sxi32 PH7_VmInstallReflection(ph7_vm *pVm)` |
|     5 | 3376 | `{` |
...
|     - | 3403 | `	sxu32 n;` |
|     - | 3404 | `	sxi32 rc;` |
| 84133 | 3405 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 80309 | 3406 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 40157 | 3407 | `	}` |
|  3829 | 3408 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib1, sizeof(zReflectLib1)-1);` |
|  3829 | 3409 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3410 | `		return rc;` |
|     - | 3411 | `	}` |
|  3829 | 3412 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib2, sizeof(zReflectLib2)-1);` |
|  3829 | 3413 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3414 | `		return rc;` |
|     - | 3415 | `	}` |
|  3829 | 3416 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib3, sizeof(zReflectLib3)-1);` |
|  3829 | 3417 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3418 | `		return rc;` |
|     - | 3419 | `	}` |
|  3829 | 3420 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib4, sizeof(zReflectLib4)-1);` |
|  3829 | 3421 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3422 | `		return rc;` |
|     - | 3423 | `	}` |
|  3829 | 3424 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib5, sizeof(zReflectLib5)-1);` |
|  3829 | 3425 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3426 | `		return rc;` |
|     - | 3427 | `	}` |
|  3829 | 3428 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib6, sizeof(zReflectLib6)-1);` |
|  3829 | 3429 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3430 | `		return rc;` |
|     - | 3431 | `	}` |
|  3829 | 3432 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib7, sizeof(zReflectLib7)-1);` |
|  3829 | 3433 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3434 | `		return rc;` |
|     - | 3435 | `	}` |
|  3829 | 3436 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib8, sizeof(zReflectLib8)-1);` |
|  3829 | 3437 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3438 | `		return rc;` |
|     - | 3439 | `	}` |
|  3829 | 3440 | `	return PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib9, sizeof(zReflectLib9)-1);` |
|  1917 | 3441 | `}` |
|     - | 3442 |  |
