...
|     - | 3346 | ` */` |
|  3946 | 3347 | `PH7_PRIVATE sxi32 PH7_VmInstallReflection(ph7_vm *pVm)` |
|     5 | 3348 | `{` |
...
|     - | 3375 | `	sxu32 n;` |
|     - | 3376 | `	sxi32 rc;` |
| 86817 | 3377 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 82871 | 3378 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 41438 | 3379 | `	}` |
|  3951 | 3380 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib1, sizeof(zReflectLib1)-1);` |
|  3951 | 3381 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3382 | `		return rc;` |
|     - | 3383 | `	}` |
|  3951 | 3384 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib2, sizeof(zReflectLib2)-1);` |
|  3951 | 3385 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3386 | `		return rc;` |
|     - | 3387 | `	}` |
|  3951 | 3388 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib3, sizeof(zReflectLib3)-1);` |
|  3951 | 3389 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3390 | `		return rc;` |
|     - | 3391 | `	}` |
|  3951 | 3392 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib4, sizeof(zReflectLib4)-1);` |
|  3951 | 3393 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3394 | `		return rc;` |
|     - | 3395 | `	}` |
|  3951 | 3396 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib5, sizeof(zReflectLib5)-1);` |
|  3951 | 3397 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3398 | `		return rc;` |
|     - | 3399 | `	}` |
|  3951 | 3400 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib6, sizeof(zReflectLib6)-1);` |
|  3951 | 3401 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3402 | `		return rc;` |
|     - | 3403 | `	}` |
|  3951 | 3404 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib7, sizeof(zReflectLib7)-1);` |
|  3951 | 3405 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3406 | `		return rc;` |
|     - | 3407 | `	}` |
|  3951 | 3408 | `	rc = PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib8, sizeof(zReflectLib8)-1);` |
|  3951 | 3409 | `	if( rc != SXRET_OK ){` |
|   ! 0 | 3410 | `		return rc;` |
|     - | 3411 | `	}` |
|  3951 | 3412 | `	return PH7_VmEvalBuiltinChunk(&(*pVm), zReflectLib9, sizeof(zReflectLib9)-1);` |
|  1978 | 3413 | `}` |
|     - | 3414 |  |
