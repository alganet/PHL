...
|    35 | 1747 | `}` |
|  3884 | 1748 | `PH7_PRIVATE sxi32 PH7_VmInstallReflection(ph7_vm *pVm)` |
|     5 | 1749 | `{` |
...
|     - | 1775 | `	};` |
|     - | 1776 | `	sxu32 n;` |
| 85453 | 1777 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 81569 | 1778 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 40787 | 1779 | `	}` |
|  3889 | 1780 | `	return PH7_VmInstallReflectionLib(&(*pVm));` |
|     5 | 1781 | `}` |
|     - | 1782 |  |
