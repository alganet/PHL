...
|    35 | 1747 | `}` |
|  3894 | 1748 | `PH7_PRIVATE sxi32 PH7_VmInstallReflection(ph7_vm *pVm)` |
|     5 | 1749 | `{` |
...
|     - | 1775 | `	};` |
|     - | 1776 | `	sxu32 n;` |
| 85673 | 1777 | `	for( n = 0 ; n < sizeof(aFunc)/sizeof(aFunc[0]) ; n++ ){` |
| 81779 | 1778 | `		ph7_create_function(&(*pVm), aFunc[n].zName, aFunc[n].xFunc, 0);` |
| 40892 | 1779 | `	}` |
|  3899 | 1780 | `	return PH7_VmInstallReflectionLib(&(*pVm));` |
|     5 | 1781 | `}` |
|     - | 1782 |  |
