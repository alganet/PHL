...
|        - |   44 | ` */` |
|  3829464 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3829469 |   48 | `	const char *z = pRaw->zString;` |
|  3829469 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3829469 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3829469 |   52 | `	if( n < 2 ) return 0;` |
|   806669 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104969 |   54 | `		base = 16;` |
|   754187 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      287 |   56 | `		base = 2;` |
|      143 |   57 | `	}` |
|  3071837 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2265183 |   59 | `		if( z[i] != '_' ) continue;` |
|      550 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3829464 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3829469 |   88 | `	const char *zBad = 0;` |
|  3829469 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3829469 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3829459 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3829454 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3829459 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3829459 |  128 | `	*pzAlloc = 0;` |
|  9115343 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5286149 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2642947 |  131 | `	}` |
|  3829459 |  132 | `	if( !hasUnderscore ){` |
|  3829199 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3829199 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3820698 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3820703 |  189 | `	const char *z = pNum->zString;` |
|  3820703 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3820703 |  193 | `	*pbDecimal = FALSE;` |
|  3820703 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3820703 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|        - |  198 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|   104969 |  199 | `		p = z + 2;` |
|   132165 |  200 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   427825 |  201 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|   104969 |  202 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|   104963 |  203 | `			return FALSE;` |
|        - |  204 | `		}` |
|        7 |  205 | `		{ ph7_real dv = 0;` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3715739 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3715453 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1396841 |  246 | `		p = z;` |
|  2793683 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1408755 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1396841 |  249 | `		if( n <= 21 ){` |
|  1396839 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2318597 |  263 | `	p = z;` |
|  2318597 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5606443 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2318597 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2318573 |  270 | `	return FALSE;` |
|  1910354 |  271 | `}` |
|  3829436 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3829441 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3829441 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3829441 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1914718 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3829441 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3829441 |  282 | `	if( rc != SXRET_OK ){` |
|        9 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5744150 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1914715 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3829435 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3829435 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3820703 |  293 | `		ph7_real rOverflow = 0;` |
|  3820703 |  294 | `		int bDecimalOverflow = 0;` |
|  3820703 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3820669 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3820669 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3820669 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3820669 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1910354 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
...
|        - |  332 | `	}` |
|  3829435 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3829435 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3829435 |  337 | `	return SXRET_OK;` |
|  1914723 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5567342 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5567347 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5567347 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5567347 |  359 | `	zIn  = pStr->zString;` |
|  5567347 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5567347 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   408079 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   408079 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|  5159273 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61655317 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56577801 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28248027 |  379 | `		}` |
|        - |  380 | `	}` |
|  5159273 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3010669 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3010669 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2148609 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2148609 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2148609 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2201150 |  397 | `	for(;;){` |
|  4402305 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2148609 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2253701 |  402 | `		zCur = zIn;` |
| 43553103 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41299407 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2253701 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2210897 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1105446 |  409 | `		}` |
|  2253701 |  410 | `		zIn++;` |
|  2253701 |  411 | `		if( zIn < zEnd ){` |
|   143983 |  412 | `			if( zIn[0] == '\\' ){` |
|        - |  413 | `				/* A literal backslash */` |
|    35035 |  414 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|   126468 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
|       15 |  417 | `				PH7_MemObjStringAppend(pObj,"'",sizeof(char));` |
|        8 |  418 | `			}else{` |
|        - |  419 | `				/* verbatim copy */` |
|   108939 |  420 | `				zIn--;` |
|   108939 |  421 | `				PH7_MemObjStringAppend(pObj,zIn,sizeof(char)*2);` |
|   108939 |  422 | `				zIn++;` |
|        - |  423 | `			}` |
|    71989 |  424 | `		}` |
...
|  2148609 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2148609 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2066857 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1033426 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2148609 |  435 | `	return SXRET_OK;` |
|  2783676 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  638 | ` */` |
|   126564 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126569 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126569 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126569 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126569 |  649 | `	(*pCount)++;` |
|   126569 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126569 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126569 |  653 | `	return pConstObj;` |
|    63287 |  654 | `}` |
|        - |  655 | `/*` |
...
|   125372 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   125377 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   125377 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 nInterp;   /* how many of iCons came from an interpolated EXPRESSION */` |
|        - |  724 | `	sxi32 rc;` |
|        - |  725 | `	/* Delimit the string */` |
|   125377 |  726 | `	zIn  = pStr->zString;` |
|   125377 |  727 | `	zEnd = &zIn[pStr->nByte];` |
|   125377 |  728 | `	if( zIn >= zEnd ){` |
...
|   124937 |  738 | `	iCons = 0;` |
|   124937 |  739 | `	nInterp = 0;` |
|    63630 |  740 | `	for(;;){` |
|   171755 |  741 | `		zCur = zIn;` |
|  1680819 |  742 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1511401 |  743 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       85 |  744 | `				break;` |
|  1511240 |  745 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2176 |  746 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1088 |  747 | `					break;` |
|        - |  748 | `			}` |
|  1509069 |  749 | `			zIn++;` |
|        5 |  750 | `		}` |
|   171755 |  751 | `		if( zIn > zCur ){` |
|    95875 |  752 | `			if( pObj == 0 ){` |
|    95191 |  753 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    95191 |  754 | `				if( pObj == 0 ){` |
|      ! 0 |  755 | `					return SXERR_ABORT;` |
|        - |  756 | `				}` |
|    47593 |  757 | `			}` |
|    95875 |  758 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47935 |  759 | `		}` |
|   171755 |  760 | `		if( zIn >= zEnd ){` |
|   124933 |  761 | `			break;` |
|        - |  762 | `		}` |
|    46827 |  763 | `		if( zIn[0] == '\\' ){` |
|    44495 |  764 | `			const char *zPtr = 0;` |
|        - |  765 | `			sxu32 n;` |
|    44495 |  766 | `			zIn++;` |
|    44495 |  767 | `			if( pObj == 0 ){` |
|    31383 |  768 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31383 |  769 | `				if( pObj == 0 ){` |
|      ! 0 |  770 | `					return SXERR_ABORT;` |
|        - |  771 | `				}` |
|    15689 |  772 | `			}` |
|    44495 |  773 | `			if( zIn >= zEnd ){` |
|        - |  774 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  775 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  776 | `				break;` |
|        - |  777 | `			}` |
|    44493 |  778 | `			n = sizeof(char); /* size of conversion */` |
|    44493 |  779 | `			switch( zIn[0] ){` |
|       27 |  780 | `			case '$':` |
|        - |  781 | `				/* Dollar sign */` |
...
|    39435 |  798 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39435 |  799 | `				break;` |
|       27 |  800 | `			case 'r':` |
...
|     3953 |  806 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3953 |  807 | `				break;` |
|        3 |  808 | `			case 'v':` |
...
|   124935 | 1114 | `	return SXRET_OK;` |
|    62691 | 1115 | `}` |
|        - | 1116 | `/*` |
|        - | 1117 | ` * Compile a double quoted string.` |
|        - | 1118 | ` *  See the block-comment above for more information.` |
|        - | 1119 | ` */` |
|   125308 | 1120 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1121 | `{` |
|        - | 1122 | `	sxi32 rc;` |
|   125313 | 1123 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62654 | 1124 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1125 | `	/* Compilation result */` |
|   125313 | 1126 | `	return rc;` |
|        5 | 1127 | `}` |
|        - | 1128 | `/*` |
...
|        - | 1169 | ` */` |
|  1567526 | 1170 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1567531 | 1181 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1182 | `	/* Compile the expression*/` |
|  1567531 | 1183 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1184 | `	/* Restore token stream */` |
|  1567531 | 1185 | `	RE_SWAP_DELIMITER(pGen);` |
|  1567531 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `/*` |
...
|        - | 1224 | ` */` |
|  1492410 | 1225 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1226 | `{` |
|  1492415 | 1227 | `	SyToken *pCur = pStart;` |
|  1492415 | 1228 | `	sxi32 iNest = 0;` |
|  3812549 | 1229 | `	while( pCur < pEnd ){` |
|  2858703 | 1230 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   538563 | 1231 | `			return pCur;` |
|        - | 1232 | `		}` |
...
|        - | 1236 | `		 */` |
|  2320145 | 1237 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23417 | 1238 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23417 | 1239 | `			SyToken *pFn = pCur;` |
|    23412 | 1240 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1241 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1242 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1243 | `				pFn = &pCur[1];` |
|      ! 0 | 1244 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1245 | `			}` |
|    23417 | 1246 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23411 | 1277 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1296 | `			}` |
|    11702 | 1297 | `		}` |
|  2320137 | 1298 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    55033 | 1299 | `			iNest++;` |
|  2292623 | 1300 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1313 | ` */` |
|   672460 | 1314 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1315 | `{` |
|        - | 1316 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1317 | `	SyToken *pKey,*pCur;` |
|   672465 | 1318 | `	sxi32 iEmitRef = 0;` |
|   672465 | 1319 | `	sxi32 iSpread = 0;` |
|   672465 | 1320 | `	sxi32 nPair = 0;` |
|        - | 1321 | `	sxi32 rc;` |
|   672465 | 1322 | `	xValidator = 0;` |
|   918735 | 1323 | `	for(;;){` |
...
|   582505 | 1328 | `		{` |
|  1837475 | 1329 | `			int nSkip = 0;` |
|  2726967 | 1330 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   889497 | 1331 | `				nSkip++;` |
|   889497 | 1332 | `				pGen->pIn++;` |
|        5 | 1333 | `			}` |
|  1837475 | 1334 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1341 | `			}` |
|        - | 1342 | `		}` |
|  1837475 | 1343 | `		pCur = pGen->pIn;` |
|  1837475 | 1344 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1345 | `			/* No more entry to process */` |
|   672447 | 1346 | `			break;` |
|        - | 1347 | `		}` |
|  1165033 | 1348 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1349 | `			continue;` |
|        - | 1350 | `		}` |
|        - | 1351 | `		/* Compile the key if available */` |
|  1165033 | 1352 | `		pKey = pCur;` |
|  1165033 | 1353 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1165033 | 1354 | `		rc = SXERR_EMPTY;` |
|  1165033 | 1355 | `		if( pCur < pGen->pIn ){` |
|   402227 | 1356 | `			if( pKey == pCur ){` |
...
|        - | 1369 | `			}` |
|   402225 | 1370 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   402215 | 1381 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1382 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   402215 | 1383 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1384 | `				return SXERR_ABORT;` |
|        - | 1385 | `			}` |
|   402215 | 1386 | `			pCur++; /* Jump the '=>' operator */` |
|   201110 | 1387 | `		}else{` |
|        - | 1388 | `			/* Reset back the cursor and point to the entry value */` |
|   762811 | 1389 | `			pCur = pKey;` |
|        - | 1390 | `		}` |
|  1165021 | 1391 | `		if( rc == SXERR_EMPTY ){` |
...
|   762811 | 1394 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   381403 | 1395 | `		}` |
|  1165021 | 1396 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1165019 | 1417 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1165019 | 1418 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1747520 | 1435 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   582505 | 1436 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1437 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   582505 | 1438 | `			xValidator);` |
|  1165015 | 1439 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1440 | `			return SXERR_ABORT;` |
|        - | 1441 | `		}` |
|  1165015 | 1442 | `		if( iSpread ){` |
...
|  1164980 | 1445 | `		}else if( iEmitRef ){` |
|        - | 1446 | `			/* Emit the load reference instruction */` |
|       40 | 1447 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1448 | `		}` |
|  1165015 | 1449 | `		xValidator = 0;` |
|  1165015 | 1450 | `		iEmitRef = 0;` |
|  1165015 | 1451 | `		iSpread = 0;` |
|  1165015 | 1452 | `		nPair++;` |
|        5 | 1453 | `	}` |
|        - | 1454 | `	/* Emit the load map instruction */` |
|   672447 | 1455 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1456 | `	/* Node successfully compiled */` |
|   672447 | 1457 | `	return SXRET_OK;` |
|   336235 | 1458 | `}` |
|        - | 1459 | `/*` |
...
|        - | 1467 | ` */` |
|   429078 | 1468 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1469 | `{` |
|        - | 1470 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   429083 | 1471 | `	pGen->pIn += 2;` |
|   429083 | 1472 | `	pGen->pEnd--;` |
|   214539 | 1473 | `	SXUNUSED(iCompileFlag);` |
|   429083 | 1474 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1475 | `}` |
|        - | 1476 | `/*` |
...
|        - | 1572 | ` */` |
|   243382 | 1573 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1574 | `{` |
|        - | 1575 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   243387 | 1576 | `	pGen->pIn++;` |
|   243387 | 1577 | `	pGen->pEnd--;` |
|   121691 | 1578 | `	SXUNUSED(iCompileFlag);` |
|   243387 | 1579 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1580 | `}` |
|        - | 1581 | `/*` |
