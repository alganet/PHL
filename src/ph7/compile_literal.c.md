...
|        - |   44 | ` */` |
|  3821754 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3821759 |   48 | `	const char *z = pRaw->zString;` |
|  3821759 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3821759 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3821759 |   52 | `	if( n < 2 ) return 0;` |
|   805085 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104753 |   54 | `		base = 16;` |
|   752711 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      287 |   56 | `		base = 2;` |
|      143 |   57 | `	}` |
|  3065939 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2260869 |   59 | `		if( z[i] != '_' ) continue;` |
|      550 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3821754 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3821759 |   88 | `	const char *zBad = 0;` |
|  3821759 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3821759 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3821749 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3821744 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3821749 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3821749 |  128 | `	*pzAlloc = 0;` |
|  9097193 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5275709 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2637727 |  131 | `	}` |
|  3821749 |  132 | `	if( !hasUnderscore ){` |
|  3821489 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3821489 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3812968 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3812973 |  189 | `	const char *z = pNum->zString;` |
|  3812973 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3812973 |  193 | `	*pbDecimal = FALSE;` |
|  3812973 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3812973 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|        - |  198 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|   104753 |  199 | `		p = z + 2;` |
|   131893 |  200 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   426945 |  201 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|   104753 |  202 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|   104747 |  203 | `			return FALSE;` |
|        - |  204 | `		}` |
|        7 |  205 | `		{ ph7_real dv = 0;` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3708225 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3707939 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1393983 |  246 | `		p = z;` |
|  2787967 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1405873 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1393983 |  249 | `		if( n <= 21 ){` |
|  1393981 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2313941 |  263 | `	p = z;` |
|  2313941 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5595235 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2313941 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2313917 |  270 | `	return FALSE;` |
|  1906489 |  271 | `}` |
|  3821726 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3821731 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3821731 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3821731 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1910863 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3821731 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3821731 |  282 | `	if( rc != SXRET_OK ){` |
|        9 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5732585 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1910860 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3821725 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3821725 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3812973 |  293 | `		ph7_real rOverflow = 0;` |
|  3812973 |  294 | `		int bDecimalOverflow = 0;` |
|  3812973 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3812939 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3812939 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3812939 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3812939 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1906489 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
|        - |  323 | `		/* Reserve a new constant */` |
|     8757 |  324 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     8757 |  325 | `		if( pObj == 0 ){` |
...
|        - |  329 | `		}` |
|     8757 |  330 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     8757 |  331 | `		PH7_MemObjToReal(pObj);` |
|        - |  332 | `	}` |
|  3821725 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3821725 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3821725 |  337 | `	return SXRET_OK;` |
|  1910868 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5555860 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5555865 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5555865 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5555865 |  359 | `	zIn  = pStr->zString;` |
|  5555865 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5555865 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   407253 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   407253 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|  5148617 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61523963 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56456981 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28187678 |  379 | `		}` |
|        - |  380 | `	}` |
|  5148617 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3004465 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3004465 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2144157 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2144157 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2144157 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2196613 |  397 | `	for(;;){` |
|  4393231 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2144157 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2249079 |  402 | `		zCur = zIn;` |
| 43461195 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41212121 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2249079 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2206313 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1103154 |  409 | `		}` |
|  2249079 |  410 | `		zIn++;` |
|  2249079 |  411 | `		if( zIn < zEnd ){` |
|   143737 |  412 | `			if( zIn[0] == '\\' ){` |
|        - |  413 | `				/* A literal backslash */` |
|    35013 |  414 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|   126233 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
...
|  2144157 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2144157 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2062527 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1031261 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2144157 |  435 | `	return SXRET_OK;` |
|  2777935 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  602 | ` */` |
|     2348 |  603 | `static sxi32 GenStateProcessStringExpression(` |
...
|     2353 |  614 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|        - |  615 | `	/* Preallocate some slots */` |
|     2353 |  616 | `	SySetAlloc(&sToken,0x08);` |
|        - |  617 | `	/* Tokenize the text */` |
|     2353 |  618 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken,0);` |
|        - |  619 | `	/* Swap delimiter */` |
|     2353 |  620 | `	pTmpIn  = pGen->pIn;` |
|     2353 |  621 | `	pTmpEnd = pGen->pEnd;` |
|     2353 |  622 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     2353 |  623 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
...
|     2353 |  627 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD,0);` |
|        - |  628 | `	/* Restore token stream */` |
|     2353 |  629 | `	pGen->pIn  = pTmpIn;` |
|     2353 |  630 | `	pGen->pEnd = pTmpEnd;` |
|        - |  631 | `	/* Release the token set */` |
|     2353 |  632 | `	SySetRelease(&sToken);` |
...
|        - |  638 | ` */` |
|   126612 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126617 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126617 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126617 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126617 |  649 | `	(*pCount)++;` |
|   126617 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126617 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126617 |  653 | `	return pConstObj;` |
|    63311 |  654 | `}` |
|        - |  655 | `/*` |
...
|   125402 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   125407 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   125407 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 nInterp;   /* how many of iCons came from an interpolated EXPRESSION */` |
|        - |  724 | `	sxi32 rc;` |
|        - |  725 | `	/* Delimit the string */` |
|   125407 |  726 | `	zIn  = pStr->zString;` |
|   125407 |  727 | `	zEnd = &zIn[pStr->nByte];` |
|   125407 |  728 | `	if( zIn >= zEnd ){` |
...
|   124967 |  738 | `	iCons = 0;` |
|   124967 |  739 | `	nInterp = 0;` |
|    63654 |  740 | `	for(;;){` |
|   171907 |  741 | `		zCur = zIn;` |
|  1680877 |  742 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1511325 |  743 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       85 |  744 | `				break;` |
|  1511164 |  745 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2194 |  746 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1097 |  747 | `					break;` |
|        - |  748 | `			}` |
|  1508975 |  749 | `			zIn++;` |
|        5 |  750 | `		}` |
|   171907 |  751 | `		if( zIn > zCur ){` |
|    95907 |  752 | `			if( pObj == 0 ){` |
|    95213 |  753 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    95213 |  754 | `				if( pObj == 0 ){` |
|      ! 0 |  755 | `					return SXERR_ABORT;` |
|        - |  756 | `				}` |
|    47604 |  757 | `			}` |
|    95907 |  758 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47951 |  759 | `		}` |
|   171907 |  760 | `		if( zIn >= zEnd ){` |
|   124963 |  761 | `			break;` |
|        - |  762 | `		}` |
|    46949 |  763 | `		if( zIn[0] == '\\' ){` |
|    44599 |  764 | `			const char *zPtr = 0;` |
|        - |  765 | `			sxu32 n;` |
|    44599 |  766 | `			zIn++;` |
|    44599 |  767 | `			if( pObj == 0 ){` |
...
|    39507 |  798 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39507 |  799 | `				break;` |
|       27 |  800 | `			case 'r':` |
...
|     3945 |  806 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3945 |  807 | `				break;` |
|        3 |  808 | `			case 'v':` |
...
|        3 |  816 | `				}else{` |
|        - |  817 | `					/* Double quote */` |
|      307 |  818 | `					PH7_MemObjStringAppend(pObj,"\"",sizeof(char));` |
|        - |  819 | `				}` |
|      311 |  820 | `				break;` |
...
|       85 |  958 | `		}else{` |
|        - |  959 | `			/* Simple syntax */` |
|     2189 |  960 | `			const char *zExpr = zIn;` |
|        - |  961 | `			/* Assemble variable name */` |
|     1117 |  962 | `			for(;;){` |
|        - |  963 | `				/* Jump leading dollars */` |
|     4423 |  964 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|     2189 |  965 | `					zIn++;` |
|        5 |  966 | `				}` |
|     1117 |  967 | `				for(;;){` |
|    10564 |  968 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|     7213 |  969 | `						zIn++;` |
|        5 |  970 | `					}` |
|     2239 |  971 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|        - |  972 | `						/* UTF-8 stream */` |
|      ! 0 |  973 | `						zIn++;` |
...
|        1 | 1018 | `					}` |
|        3 | 1019 | `					break;` |
|     1939 | 1020 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|        - | 1021 | `					/* Member access operator '->' */` |
|       53 | 1022 | `					zIn += 2;` |
|     1914 | 1023 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|        - | 1037 | `			 */` |
|        - | 1038 | `			{` |
|     2189 | 1039 | `				const char *zBr = zExpr;` |
|    11693 | 1040 | `				while( zBr < zIn && zBr[0] != '[' ){` |
|     9509 | 1041 | `					zBr++;` |
|        5 | 1042 | `				}` |
|     2189 | 1043 | `				if( zBr < zIn && zIn[-1] == ']' ){` |
...
|        - | 1083 | `			 */` |
|     2187 | 1084 | `			if( &zExpr[1] < zIn && zExpr[0] == '$' && zExpr[1] == '{' ){` |
...
|     2185 | 1090 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|     2185 | 1091 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1092 | `				return SXERR_ABORT;` |
|        - | 1093 | `			}` |
|     2185 | 1094 | `			if( rc != SXERR_EMPTY ){` |
|     2185 | 1095 | `				++iCons;` |
|     2185 | 1096 | `				++nInterp;` |
|     1090 | 1097 | `			}` |
|        - | 1098 | `		}` |
...
|     2351 | 1100 | `		pObj = 0;` |
|        5 | 1101 | `	}/*for(;;)*/` |
|   124965 | 1102 | `	if( iCons > 1 ){` |
|        - | 1103 | `		/* Concatenate all compiled constants */` |
|     1607 | 1104 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|   124164 | 1105 | `	}else if( iCons == 1 && nInterp == 1 ){` |
...
|   124965 | 1114 | `	return SXRET_OK;` |
|    62706 | 1115 | `}` |
|        - | 1116 | `/*` |
|        - | 1117 | ` * Compile a double quoted string.` |
|        - | 1118 | ` *  See the block-comment above for more information.` |
|        - | 1119 | ` */` |
|   125338 | 1120 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1121 | `{` |
|        - | 1122 | `	sxi32 rc;` |
|   125343 | 1123 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62669 | 1124 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1125 | `	/* Compilation result */` |
|   125343 | 1126 | `	return rc;` |
|        5 | 1127 | `}` |
|        - | 1128 | `/*` |
...
|        - | 1169 | ` */` |
|  1564382 | 1170 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1564387 | 1181 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1182 | `	/* Compile the expression*/` |
|  1564387 | 1183 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1184 | `	/* Restore token stream */` |
|  1564387 | 1185 | `	RE_SWAP_DELIMITER(pGen);` |
|  1564387 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `/*` |
...
|        - | 1224 | ` */` |
|  1489402 | 1225 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1226 | `{` |
|  1489407 | 1227 | `	SyToken *pCur = pStart;` |
|  1489407 | 1228 | `	sxi32 iNest = 0;` |
|  3804837 | 1229 | `	while( pCur < pEnd ){` |
|  2852911 | 1230 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   537475 | 1231 | `			return pCur;` |
|        - | 1232 | `		}` |
...
|        - | 1236 | `		 */` |
|  2315441 | 1237 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23369 | 1238 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23369 | 1239 | `			SyToken *pFn = pCur;` |
|    23364 | 1240 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1241 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1242 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1243 | `				pFn = &pCur[1];` |
|      ! 0 | 1244 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1245 | `			}` |
|    23369 | 1246 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23363 | 1277 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1296 | `			}` |
|    11678 | 1297 | `		}` |
|  2315433 | 1298 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    54921 | 1299 | `			iNest++;` |
|  2287975 | 1300 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1313 | ` */` |
|   671104 | 1314 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1315 | `{` |
|        - | 1316 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1317 | `	SyToken *pKey,*pCur;` |
|   671109 | 1318 | `	sxi32 iEmitRef = 0;` |
|   671109 | 1319 | `	sxi32 iSpread = 0;` |
|   671109 | 1320 | `	sxi32 nPair = 0;` |
|        - | 1321 | `	sxi32 rc;` |
|   671109 | 1322 | `	xValidator = 0;` |
|   916889 | 1323 | `	for(;;){` |
...
|   581337 | 1328 | `		{` |
|  1833783 | 1329 | `			int nSkip = 0;` |
|  2721483 | 1330 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   887705 | 1331 | `				nSkip++;` |
|   887705 | 1332 | `				pGen->pIn++;` |
|        5 | 1333 | `			}` |
|  1833783 | 1334 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1341 | `			}` |
|        - | 1342 | `		}` |
|  1833783 | 1343 | `		pCur = pGen->pIn;` |
|  1833783 | 1344 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1345 | `			/* No more entry to process */` |
|   671091 | 1346 | `			break;` |
|        - | 1347 | `		}` |
|  1162697 | 1348 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1349 | `			continue;` |
|        - | 1350 | `		}` |
|        - | 1351 | `		/* Compile the key if available */` |
|  1162697 | 1352 | `		pKey = pCur;` |
|  1162697 | 1353 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1162697 | 1354 | `		rc = SXERR_EMPTY;` |
|  1162697 | 1355 | `		if( pCur < pGen->pIn ){` |
|   401419 | 1356 | `			if( pKey == pCur ){` |
...
|        - | 1369 | `			}` |
|   401417 | 1370 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   401407 | 1381 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1382 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   401407 | 1383 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1384 | `				return SXERR_ABORT;` |
|        - | 1385 | `			}` |
|   401407 | 1386 | `			pCur++; /* Jump the '=>' operator */` |
|   200706 | 1387 | `		}else{` |
|        - | 1388 | `			/* Reset back the cursor and point to the entry value */` |
|   761283 | 1389 | `			pCur = pKey;` |
|        - | 1390 | `		}` |
|  1162685 | 1391 | `		if( rc == SXERR_EMPTY ){` |
...
|   761283 | 1394 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   380639 | 1395 | `		}` |
|  1162685 | 1396 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1162683 | 1417 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1162683 | 1418 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1744016 | 1435 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   581337 | 1436 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1437 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   581337 | 1438 | `			xValidator);` |
|  1162679 | 1439 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1440 | `			return SXERR_ABORT;` |
|        - | 1441 | `		}` |
|  1162679 | 1442 | `		if( iSpread ){` |
...
|  1162644 | 1445 | `		}else if( iEmitRef ){` |
|        - | 1446 | `			/* Emit the load reference instruction */` |
|       41 | 1447 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1448 | `		}` |
|  1162679 | 1449 | `		xValidator = 0;` |
|  1162679 | 1450 | `		iEmitRef = 0;` |
|  1162679 | 1451 | `		iSpread = 0;` |
|  1162679 | 1452 | `		nPair++;` |
|        5 | 1453 | `	}` |
|        - | 1454 | `	/* Emit the load map instruction */` |
|   671091 | 1455 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1456 | `	/* Node successfully compiled */` |
|   671091 | 1457 | `	return SXRET_OK;` |
|   335557 | 1458 | `}` |
|        - | 1459 | `/*` |
...
|        - | 1467 | ` */` |
|   428198 | 1468 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1469 | `{` |
|        - | 1470 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   428203 | 1471 | `	pGen->pIn += 2;` |
|   428203 | 1472 | `	pGen->pEnd--;` |
|   214099 | 1473 | `	SXUNUSED(iCompileFlag);` |
|        - | 1474 | ``	/* php: a stray token in an `array( ... )` element is `... expecting ")"`. */`` |
|        - | 1475 | `	{` |
|   428203 | 1476 | `		const char *zSave = pGen->zClauseCloser;` |
|        - | 1477 | `		sxi32 rc;` |
|   428203 | 1478 | `		pGen->zClauseCloser = "\")\"";` |
|   428203 | 1479 | `		rc = GenStateCompileArrayBody(pGen);` |
|   428203 | 1480 | `		pGen->zClauseCloser = zSave;` |
|   428203 | 1481 | `		return rc;` |
|        - | 1482 | `	}` |
|        5 | 1483 | `}` |
|        - | 1484 | `/*` |
...
|        - | 1580 | ` */` |
|   242906 | 1581 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1582 | `{` |
|        - | 1583 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   242911 | 1584 | `	pGen->pIn++;` |
|   242911 | 1585 | `	pGen->pEnd--;` |
|   121453 | 1586 | `	SXUNUSED(iCompileFlag);` |
|        - | 1587 | ``	/* php: a stray token in a `[ ... ]` element is `... expecting "]"`. */`` |
|        - | 1588 | `	{` |
|   242911 | 1589 | `		const char *zSave = pGen->zClauseCloser;` |
|        - | 1590 | `		sxi32 rc;` |
|   242911 | 1591 | `		pGen->zClauseCloser = "\"]\"";` |
|   242911 | 1592 | `		rc = GenStateCompileArrayBody(pGen);` |
|   242911 | 1593 | `		pGen->zClauseCloser = zSave;` |
|   242911 | 1594 | `		return rc;` |
|        - | 1595 | `	}` |
|        5 | 1596 | `}` |
|        - | 1597 | `/*` |
