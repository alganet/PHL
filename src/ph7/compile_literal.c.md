...
|        - |   44 | ` */` |
|  3817500 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3817505 |   48 | `	const char *z = pRaw->zString;` |
|  3817505 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3817505 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3817505 |   52 | `	if( n < 2 ) return 0;` |
|   804171 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104641 |   54 | `		base = 16;` |
|   751853 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3062303 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2258151 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3817500 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3817505 |   88 | `	const char *zBad = 0;` |
|  3817505 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3817505 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3817491 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3817486 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3817491 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3817491 |  128 | `	*pzAlloc = 0;` |
|  9086881 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5269649 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2634700 |  131 | `	}` |
|  3817491 |  132 | `	if( !hasUnderscore ){` |
|  3817237 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3817237 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3808760 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3808765 |  189 | `	const char *z = pNum->zString;` |
|  3808765 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3808765 |  193 | `	*pbDecimal = FALSE;` |
|  3808765 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3808765 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|        - |  198 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|   104639 |  199 | `		p = z + 2;` |
|   131751 |  200 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   426489 |  201 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|   104639 |  202 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|   104633 |  203 | `			return FALSE;` |
|        - |  204 | `		}` |
|        7 |  205 | `		{ ph7_real dv = 0;` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3704131 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3703849 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1392485 |  246 | `		p = z;` |
|  2784967 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1404357 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1392485 |  249 | `		if( n <= 21 ){` |
|  1392483 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2311353 |  263 | `	p = z;` |
|  2311353 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5588979 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2311353 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2311329 |  270 | `	return FALSE;` |
|  1904385 |  271 | `}` |
|  3817472 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3817477 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3817477 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3817477 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1908736 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3817477 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3817477 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5726198 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1908731 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3817467 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3817467 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3808765 |  293 | `		ph7_real rOverflow = 0;` |
|  3808765 |  294 | `		int bDecimalOverflow = 0;` |
|  3808765 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3808731 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3808731 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3808731 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3808731 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1904385 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
|        - |  323 | `		/* Reserve a new constant */` |
|     8707 |  324 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     8707 |  325 | `		if( pObj == 0 ){` |
...
|        - |  329 | `		}` |
|     8707 |  330 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     8707 |  331 | `		PH7_MemObjToReal(pObj);` |
|        - |  332 | `	}` |
|  3817467 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3817467 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3817467 |  337 | `	return SXRET_OK;` |
|  1908741 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5550192 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5550197 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5550197 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5550197 |  359 | `	zIn  = pStr->zString;` |
|  5550197 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5550197 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   406819 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   406819 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|   126078 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
|       15 |  417 | `				PH7_MemObjStringAppend(pObj,"'",sizeof(char));` |
|        8 |  418 | `			}else{` |
|        - |  419 | `				/* verbatim copy */` |
|   108603 |  420 | `				zIn--;` |
|   108603 |  421 | `				PH7_MemObjStringAppend(pObj,zIn,sizeof(char)*2);` |
|   108603 |  422 | `				zIn++;` |
|        - |  423 | `			}` |
|    71767 |  424 | `		}` |
...
|        - |  638 | ` */` |
|   126144 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126149 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126149 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126149 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126149 |  649 | `	(*pCount)++;` |
|   126149 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126149 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126149 |  653 | `	return pConstObj;` |
|    63077 |  654 | `}` |
|        - |  655 | `/*` |
...
|   124956 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   124961 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   124961 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 nInterp;   /* how many of iCons came from an interpolated EXPRESSION */` |
|        - |  724 | `	sxi32 rc;` |
|        - |  725 | `	/* Delimit the string */` |
|   124961 |  726 | `	zIn  = pStr->zString;` |
|   124961 |  727 | `	zEnd = &zIn[pStr->nByte];` |
|   124961 |  728 | `	if( zIn >= zEnd ){` |
...
|   124521 |  738 | `	iCons = 0;` |
|   124521 |  739 | `	nInterp = 0;` |
|    63419 |  740 | `	for(;;){` |
|   171159 |  741 | `		zCur = zIn;` |
|  1675057 |  742 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1506229 |  743 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       86 |  744 | `				break;` |
|  1506068 |  745 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2170 |  746 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1085 |  747 | `					break;` |
|        - |  748 | `			}` |
|  1503903 |  749 | `			zIn++;` |
|        5 |  750 | `		}` |
|   171159 |  751 | `		if( zIn > zCur ){` |
|    95541 |  752 | `			if( pObj == 0 ){` |
|    94887 |  753 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    94887 |  754 | `				if( pObj == 0 ){` |
|      ! 0 |  755 | `					return SXERR_ABORT;` |
|        - |  756 | `				}` |
|    47441 |  757 | `			}` |
|    95541 |  758 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47768 |  759 | `		}` |
|   171159 |  760 | `		if( zIn >= zEnd ){` |
|   124517 |  761 | `			break;` |
|        - |  762 | `		}` |
|    46647 |  763 | `		if( zIn[0] == '\\' ){` |
|    44321 |  764 | `			const char *zPtr = 0;` |
|        - |  765 | `			sxu32 n;` |
|    44321 |  766 | `			zIn++;` |
|    44321 |  767 | `			if( pObj == 0 ){` |
|    31267 |  768 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31267 |  769 | `				if( pObj == 0 ){` |
|      ! 0 |  770 | `					return SXERR_ABORT;` |
|        - |  771 | `				}` |
|    15631 |  772 | `			}` |
|    44321 |  773 | `			if( zIn >= zEnd ){` |
|        - |  774 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  775 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  776 | `				break;` |
|        - |  777 | `			}` |
|    44319 |  778 | `			n = sizeof(char); /* size of conversion */` |
|    44319 |  779 | `			switch( zIn[0] ){` |
|       17 |  780 | `			case '$':` |
|        - |  781 | `				/* Dollar sign */` |
...
|     3941 |  806 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3941 |  807 | `				break;` |
|        3 |  808 | `			case 'v':` |
...
|   124519 | 1114 | `	return SXRET_OK;` |
|    62483 | 1115 | `}` |
|        - | 1116 | `/*` |
|        - | 1117 | ` * Compile a double quoted string.` |
|        - | 1118 | ` *  See the block-comment above for more information.` |
|        - | 1119 | ` */` |
|   124892 | 1120 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1121 | `{` |
|        - | 1122 | `	sxi32 rc;` |
|   124897 | 1123 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62446 | 1124 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1125 | `	/* Compilation result */` |
|   124897 | 1126 | `	return rc;` |
|        5 | 1127 | `}` |
|        - | 1128 | `/*` |
...
|        - | 1169 | ` */` |
|  1562576 | 1170 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1562581 | 1181 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1182 | `	/* Compile the expression*/` |
|  1562581 | 1183 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1184 | `	/* Restore token stream */` |
|  1562581 | 1185 | `	RE_SWAP_DELIMITER(pGen);` |
|  1562581 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `/*` |
...
|        - | 1224 | ` */` |
|  1487712 | 1225 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1226 | `{` |
|  1487717 | 1227 | `	SyToken *pCur = pStart;` |
|  1487717 | 1228 | `	sxi32 iNest = 0;` |
|  3800597 | 1229 | `	while( pCur < pEnd ){` |
|  2849753 | 1230 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   536869 | 1231 | `			return pCur;` |
|        - | 1232 | `		}` |
...
|        - | 1236 | `		 */` |
|  2312889 | 1237 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23343 | 1238 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23343 | 1239 | `			SyToken *pFn = pCur;` |
|    23338 | 1240 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1241 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1242 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1243 | `				pFn = &pCur[1];` |
|      ! 0 | 1244 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1245 | `			}` |
|    23343 | 1246 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23339 | 1277 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1296 | `			}` |
|    11666 | 1297 | `		}` |
|  2312883 | 1298 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    54863 | 1299 | `			iNest++;` |
|  2285454 | 1300 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1313 | ` */` |
|   670340 | 1314 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1315 | `{` |
|        - | 1316 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1317 | `	SyToken *pKey,*pCur;` |
|   670345 | 1318 | `	sxi32 iEmitRef = 0;` |
|   670345 | 1319 | `	sxi32 iSpread = 0;` |
|   670345 | 1320 | `	sxi32 nPair = 0;` |
|        - | 1321 | `	sxi32 rc;` |
|   670345 | 1322 | `	xValidator = 0;` |
|   915838 | 1323 | `	for(;;){` |
...
|   580668 | 1328 | `		{` |
|  1831681 | 1329 | `			int nSkip = 0;` |
|  2718389 | 1330 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   886713 | 1331 | `				nSkip++;` |
|   886713 | 1332 | `				pGen->pIn++;` |
|        5 | 1333 | `			}` |
|  1831681 | 1334 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1341 | `			}` |
|        - | 1342 | `		}` |
|  1831681 | 1343 | `		pCur = pGen->pIn;` |
|  1831681 | 1344 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1345 | `			/* No more entry to process */` |
|   670327 | 1346 | `			break;` |
|        - | 1347 | `		}` |
|  1161359 | 1348 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1349 | `			continue;` |
|        - | 1350 | `		}` |
|        - | 1351 | `		/* Compile the key if available */` |
|  1161359 | 1352 | `		pKey = pCur;` |
|  1161359 | 1353 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1161359 | 1354 | `		rc = SXERR_EMPTY;` |
|  1161359 | 1355 | `		if( pCur < pGen->pIn ){` |
|   400965 | 1356 | `			if( pKey == pCur ){` |
...
|        - | 1369 | `			}` |
|   400963 | 1370 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   400953 | 1381 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1382 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   400953 | 1383 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1384 | `				return SXERR_ABORT;` |
|        - | 1385 | `			}` |
|   400953 | 1386 | `			pCur++; /* Jump the '=>' operator */` |
|   200479 | 1387 | `		}else{` |
|        - | 1388 | `			/* Reset back the cursor and point to the entry value */` |
|   760399 | 1389 | `			pCur = pKey;` |
|        - | 1390 | `		}` |
|  1161347 | 1391 | `		if( rc == SXERR_EMPTY ){` |
...
|   760399 | 1394 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   380197 | 1395 | `		}` |
|  1161347 | 1396 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1161345 | 1415 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1161345 | 1416 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1742009 | 1433 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   580668 | 1434 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1435 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   580668 | 1436 | `			xValidator);` |
|  1161341 | 1437 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1438 | `			return SXERR_ABORT;` |
|        - | 1439 | `		}` |
|  1161341 | 1440 | `		if( iSpread ){` |
...
|  1161306 | 1443 | `		}else if( iEmitRef ){` |
|        - | 1444 | `			/* Emit the load reference instruction */` |
|       40 | 1445 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1446 | `		}` |
|  1161341 | 1447 | `		xValidator = 0;` |
|  1161341 | 1448 | `		iEmitRef = 0;` |
|  1161341 | 1449 | `		iSpread = 0;` |
|  1161341 | 1450 | `		nPair++;` |
|        5 | 1451 | `	}` |
|        - | 1452 | `	/* Emit the load map instruction */` |
|   670327 | 1453 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1454 | `	/* Node successfully compiled */` |
|   670327 | 1455 | `	return SXRET_OK;` |
|   335175 | 1456 | `}` |
|        - | 1457 | `/*` |
...
|        - | 1465 | ` */` |
|   427738 | 1466 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1467 | `{` |
|        - | 1468 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   427743 | 1469 | `	pGen->pIn += 2;` |
|   427743 | 1470 | `	pGen->pEnd--;` |
|   213869 | 1471 | `	SXUNUSED(iCompileFlag);` |
|   427743 | 1472 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1473 | `}` |
|        - | 1474 | `/*` |
...
|        - | 1570 | ` */` |
|   242602 | 1571 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1572 | `{` |
|        - | 1573 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   242607 | 1574 | `	pGen->pIn++;` |
|   242607 | 1575 | `	pGen->pEnd--;` |
|   121301 | 1576 | `	SXUNUSED(iCompileFlag);` |
|   242607 | 1577 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1578 | `}` |
|        - | 1579 | `/*` |
