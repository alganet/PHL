...
|        - |   44 | ` */` |
|  3833228 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3833233 |   48 | `	const char *z = pRaw->zString;` |
|  3833233 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3833233 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3833233 |   52 | `	if( n < 2 ) return 0;` |
|   807453 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   105073 |   54 | `		base = 16;` |
|   754919 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3074773 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2267339 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3833228 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3833233 |   88 | `	const char *zBad = 0;` |
|  3833233 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3833233 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3833219 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3833214 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3833219 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3833219 |  128 | `	*pzAlloc = 0;` |
|  9124243 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5291283 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2645517 |  131 | `	}` |
|  3833219 |  132 | `	if( !hasUnderscore ){` |
|  3832965 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3832965 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3824456 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3824461 |  189 | `	const char *z = pNum->zString;` |
|  3824461 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3824461 |  193 | `	*pbDecimal = FALSE;` |
|  3824461 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3824461 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|        - |  198 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|   105071 |  199 | `		p = z + 2;` |
|   132295 |  200 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   428249 |  201 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|   105071 |  202 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|   105065 |  203 | `			return FALSE;` |
|        - |  204 | `		}` |
|        7 |  205 | `		{ ph7_real dv = 0;` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3719395 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3719113 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1398237 |  246 | `		p = z;` |
|  2796471 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1410157 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1398237 |  249 | `		if( n <= 21 ){` |
|  1398235 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2320865 |  263 | `	p = z;` |
|  2320865 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5611925 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2320865 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2320841 |  270 | `	return FALSE;` |
|  1912233 |  271 | `}` |
|  3833200 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3833205 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3833205 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3833205 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1916600 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3833205 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3833205 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5749790 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1916595 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3833195 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3833195 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3824461 |  293 | `		ph7_real rOverflow = 0;` |
|  3824461 |  294 | `		int bDecimalOverflow = 0;` |
|  3824461 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3824427 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3824427 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3824427 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3824427 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1912233 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
|        - |  323 | `		/* Reserve a new constant */` |
|     8739 |  324 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     8739 |  325 | `		if( pObj == 0 ){` |
...
|        - |  329 | `		}` |
|     8739 |  330 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     8739 |  331 | `		PH7_MemObjToReal(pObj);` |
|        - |  332 | `	}` |
|  3833195 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3833195 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3833195 |  337 | `	return SXRET_OK;` |
|  1916605 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5573082 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5573087 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5573087 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5573087 |  359 | `	zIn  = pStr->zString;` |
|  5573087 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5573087 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   408499 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   408499 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|  5164593 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61714471 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56631719 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28274944 |  379 | `		}` |
|        - |  380 | `	}` |
|  5164593 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3013755 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3013755 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2150843 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2150843 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2150843 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2203438 |  397 | `	for(;;){` |
|  4406881 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2150843 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2256043 |  402 | `		zCur = zIn;` |
| 43593493 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41337455 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2256043 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2213195 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1106595 |  409 | `		}` |
|  2256043 |  410 | `		zIn++;` |
|  2256043 |  411 | `		if( zIn < zEnd ){` |
|   144131 |  412 | `			if( zIn[0] == '\\' ){` |
|        - |  413 | `				/* A literal backslash */` |
|    35071 |  414 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|   126598 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
|       15 |  417 | `				PH7_MemObjStringAppend(pObj,"'",sizeof(char));` |
|        8 |  418 | `			}else{` |
|        - |  419 | `				/* verbatim copy */` |
|   109051 |  420 | `				zIn--;` |
|   109051 |  421 | `				PH7_MemObjStringAppend(pObj,zIn,sizeof(char)*2);` |
|   109051 |  422 | `				zIn++;` |
|        - |  423 | `			}` |
|    72063 |  424 | `		}` |
...
|  2150843 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2150843 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2069007 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1034501 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2150843 |  435 | `	return SXRET_OK;` |
|  2786546 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  638 | ` */` |
|   126530 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126535 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126535 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126535 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126535 |  649 | `	(*pCount)++;` |
|   126535 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126535 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126535 |  653 | `	return pConstObj;` |
|    63270 |  654 | `}` |
|        - |  655 | `/*` |
...
|   125342 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   125347 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   125347 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 nInterp;   /* how many of iCons came from an interpolated EXPRESSION */` |
|        - |  724 | `	sxi32 rc;` |
|        - |  725 | `	/* Delimit the string */` |
|   125347 |  726 | `	zIn  = pStr->zString;` |
|   125347 |  727 | `	zEnd = &zIn[pStr->nByte];` |
|   125347 |  728 | `	if( zIn >= zEnd ){` |
...
|   124907 |  738 | `	iCons = 0;` |
|   124907 |  739 | `	nInterp = 0;` |
|    63612 |  740 | `	for(;;){` |
|   171663 |  741 | `		zCur = zIn;` |
|  1681005 |  742 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1511673 |  743 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       86 |  744 | `				break;` |
|  1511512 |  745 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2170 |  746 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1085 |  747 | `					break;` |
|        - |  748 | `			}` |
|  1509347 |  749 | `			zIn++;` |
|        5 |  750 | `		}` |
|   171663 |  751 | `		if( zIn > zCur ){` |
|    95833 |  752 | `			if( pObj == 0 ){` |
|    95179 |  753 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    95179 |  754 | `				if( pObj == 0 ){` |
|      ! 0 |  755 | `					return SXERR_ABORT;` |
|        - |  756 | `				}` |
|    47587 |  757 | `			}` |
|    95833 |  758 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47914 |  759 | `		}` |
|   171663 |  760 | `		if( zIn >= zEnd ){` |
|   124903 |  761 | `			break;` |
|        - |  762 | `		}` |
|    46765 |  763 | `		if( zIn[0] == '\\' ){` |
|    44439 |  764 | `			const char *zPtr = 0;` |
|        - |  765 | `			sxu32 n;` |
|    44439 |  766 | `			zIn++;` |
|    44439 |  767 | `			if( pObj == 0 ){` |
|    31361 |  768 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31361 |  769 | `				if( pObj == 0 ){` |
|      ! 0 |  770 | `					return SXERR_ABORT;` |
|        - |  771 | `				}` |
|    15678 |  772 | `			}` |
|    44439 |  773 | `			if( zIn >= zEnd ){` |
|        - |  774 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  775 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  776 | `				break;` |
|        - |  777 | `			}` |
|    44437 |  778 | `			n = sizeof(char); /* size of conversion */` |
|    44437 |  779 | `			switch( zIn[0] ){` |
|       17 |  780 | `			case '$':` |
|        - |  781 | `				/* Dollar sign */` |
...
|    39395 |  798 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39395 |  799 | `				break;` |
|       27 |  800 | `			case 'r':` |
...
|     3957 |  806 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3957 |  807 | `				break;` |
|        3 |  808 | `			case 'v':` |
...
|   124905 | 1114 | `	return SXRET_OK;` |
|    62676 | 1115 | `}` |
|        - | 1116 | `/*` |
|        - | 1117 | ` * Compile a double quoted string.` |
|        - | 1118 | ` *  See the block-comment above for more information.` |
|        - | 1119 | ` */` |
|   125278 | 1120 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1121 | `{` |
|        - | 1122 | `	sxi32 rc;` |
|   125283 | 1123 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62639 | 1124 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1125 | `	/* Compilation result */` |
|   125283 | 1126 | `	return rc;` |
|        5 | 1127 | `}` |
|        - | 1128 | `/*` |
...
|        - | 1169 | ` */` |
|  1568990 | 1170 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1568995 | 1181 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1182 | `	/* Compile the expression*/` |
|  1568995 | 1183 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1184 | `	/* Restore token stream */` |
|  1568995 | 1185 | `	RE_SWAP_DELIMITER(pGen);` |
|  1568995 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `/*` |
...
|        - | 1224 | ` */` |
|  1493822 | 1225 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1226 | `{` |
|  1493827 | 1227 | `	SyToken *pCur = pStart;` |
|  1493827 | 1228 | `	sxi32 iNest = 0;` |
|  3816217 | 1229 | `	while( pCur < pEnd ){` |
|  2861471 | 1230 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   539077 | 1231 | `			return pCur;` |
|        - | 1232 | `		}` |
...
|        - | 1236 | `		 */` |
|  2322399 | 1237 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23439 | 1238 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23439 | 1239 | `			SyToken *pFn = pCur;` |
|    23434 | 1240 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1241 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1242 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1243 | `				pFn = &pCur[1];` |
|      ! 0 | 1244 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1245 | `			}` |
|    23439 | 1246 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23435 | 1277 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1296 | `			}` |
|    11714 | 1297 | `		}` |
|  2322393 | 1298 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    55089 | 1299 | `			iNest++;` |
|  2294851 | 1300 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1313 | ` */` |
|   673106 | 1314 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1315 | `{` |
|        - | 1316 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1317 | `	SyToken *pKey,*pCur;` |
|   673111 | 1318 | `	sxi32 iEmitRef = 0;` |
|   673111 | 1319 | `	sxi32 iSpread = 0;` |
|   673111 | 1320 | `	sxi32 nPair = 0;` |
|        - | 1321 | `	sxi32 rc;` |
|   673111 | 1322 | `	xValidator = 0;` |
|   919604 | 1323 | `	for(;;){` |
...
|   583051 | 1328 | `		{` |
|  1839213 | 1329 | `			int nSkip = 0;` |
|  2729553 | 1330 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   890345 | 1331 | `				nSkip++;` |
|   890345 | 1332 | `				pGen->pIn++;` |
|        5 | 1333 | `			}` |
|  1839213 | 1334 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1341 | `			}` |
|        - | 1342 | `		}` |
|  1839213 | 1343 | `		pCur = pGen->pIn;` |
|  1839213 | 1344 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1345 | `			/* No more entry to process */` |
|   673093 | 1346 | `			break;` |
|        - | 1347 | `		}` |
|  1166125 | 1348 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1349 | `			continue;` |
|        - | 1350 | `		}` |
|        - | 1351 | `		/* Compile the key if available */` |
|  1166125 | 1352 | `		pKey = pCur;` |
|  1166125 | 1353 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1166125 | 1354 | `		rc = SXERR_EMPTY;` |
|  1166125 | 1355 | `		if( pCur < pGen->pIn ){` |
|   402613 | 1356 | `			if( pKey == pCur ){` |
...
|        - | 1369 | `			}` |
|   402611 | 1370 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   402601 | 1381 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1382 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   402601 | 1383 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1384 | `				return SXERR_ABORT;` |
|        - | 1385 | `			}` |
|   402601 | 1386 | `			pCur++; /* Jump the '=>' operator */` |
|   201303 | 1387 | `		}else{` |
|        - | 1388 | `			/* Reset back the cursor and point to the entry value */` |
|   763517 | 1389 | `			pCur = pKey;` |
|        - | 1390 | `		}` |
|  1166113 | 1391 | `		if( rc == SXERR_EMPTY ){` |
...
|   763517 | 1394 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   381756 | 1395 | `		}` |
|  1166113 | 1396 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1166111 | 1415 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1166111 | 1416 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1749158 | 1433 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   583051 | 1434 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1435 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   583051 | 1436 | `			xValidator);` |
|  1166107 | 1437 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1438 | `			return SXERR_ABORT;` |
|        - | 1439 | `		}` |
|  1166107 | 1440 | `		if( iSpread ){` |
...
|  1166072 | 1443 | `		}else if( iEmitRef ){` |
|        - | 1444 | `			/* Emit the load reference instruction */` |
|       40 | 1445 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1446 | `		}` |
|  1166107 | 1447 | `		xValidator = 0;` |
|  1166107 | 1448 | `		iEmitRef = 0;` |
|  1166107 | 1449 | `		iSpread = 0;` |
|  1166107 | 1450 | `		nPair++;` |
|        5 | 1451 | `	}` |
|        - | 1452 | `	/* Emit the load map instruction */` |
|   673093 | 1453 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1454 | `	/* Node successfully compiled */` |
|   673093 | 1455 | `	return SXRET_OK;` |
|   336558 | 1456 | `}` |
|        - | 1457 | `/*` |
...
|        - | 1465 | ` */` |
|   429498 | 1466 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1467 | `{` |
|        - | 1468 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   429503 | 1469 | `	pGen->pIn += 2;` |
|   429503 | 1470 | `	pGen->pEnd--;` |
|   214749 | 1471 | `	SXUNUSED(iCompileFlag);` |
|   429503 | 1472 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1473 | `}` |
|        - | 1474 | `/*` |
...
|        - | 1570 | ` */` |
|   243608 | 1571 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1572 | `{` |
|        - | 1573 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   243613 | 1574 | `	pGen->pIn++;` |
|   243613 | 1575 | `	pGen->pEnd--;` |
|   121804 | 1576 | `	SXUNUSED(iCompileFlag);` |
|   243613 | 1577 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1578 | `}` |
|        - | 1579 | `/*` |
