...
|        - |   44 | ` */` |
|  3835060 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3835065 |   48 | `	const char *z = pRaw->zString;` |
|  3835065 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3835065 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3835065 |   52 | `	if( n < 2 ) return 0;` |
|   807841 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   105127 |   54 | `		base = 16;` |
|   755280 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3076247 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2268425 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3835060 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3835065 |   88 | `	const char *zBad = 0;` |
|  3835065 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3835065 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3835051 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3835046 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3835051 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3835051 |  128 | `	*pzAlloc = 0;` |
|  9128605 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5293813 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2646782 |  131 | `	}` |
|  3835051 |  132 | `	if( !hasUnderscore ){` |
|  3834797 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3834797 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3826284 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3826289 |  189 | `	const char *z = pNum->zString;` |
|  3826289 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3826289 |  193 | `	*pbDecimal = FALSE;` |
|  3826289 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3826289 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3721169 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3720887 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1398947 |  246 | `		p = z;` |
|  2797891 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1410873 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1398947 |  249 | `		if( n <= 21 ){` |
|  1398945 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2321929 |  263 | `	p = z;` |
|  2321929 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5614503 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2321929 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2321905 |  270 | `	return FALSE;` |
|  1913147 |  271 | `}` |
|  3835032 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3835037 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3835037 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3835037 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1917516 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3835037 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3835037 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5752538 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1917511 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3835027 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3835027 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3826289 |  293 | `		ph7_real rOverflow = 0;` |
|  3826289 |  294 | `		int bDecimalOverflow = 0;` |
|  3826289 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3826255 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3826255 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3826255 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3826255 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1913147 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
|        - |  323 | `		/* Reserve a new constant */` |
|     8743 |  324 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     8743 |  325 | `		if( pObj == 0 ){` |
...
|        - |  329 | `		}` |
|     8743 |  330 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     8743 |  331 | `		PH7_MemObjToReal(pObj);` |
|        - |  332 | `	}` |
|  3835027 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3835027 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3835027 |  337 | `	return SXRET_OK;` |
|  1917521 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5575746 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5575751 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5575751 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5575751 |  359 | `	zIn  = pStr->zString;` |
|  5575751 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5575751 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   408675 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   408675 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|  5167081 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61744521 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56659317 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28288725 |  379 | `		}` |
|        - |  380 | `	}` |
|  5167081 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3015255 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3015255 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2151831 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2151831 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2151831 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2204451 |  397 | `	for(;;){` |
|  4408907 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2151831 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2257081 |  402 | `		zCur = zIn;` |
| 43613949 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41356873 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2257081 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2214217 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1107106 |  409 | `		}` |
|  2257081 |  410 | `		zIn++;` |
|  2257081 |  411 | `		if( zIn < zEnd ){` |
|   144199 |  412 | `			if( zIn[0] == '\\' ){` |
|        - |  413 | `				/* A literal backslash */` |
|    35083 |  414 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|   126660 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
...
|  2151831 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2151831 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2069959 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1034977 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2151831 |  435 | `	return SXRET_OK;` |
|  2787878 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  602 | ` */` |
|     2360 |  603 | `static sxi32 GenStateProcessStringExpression(` |
...
|     2365 |  614 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|        - |  615 | `	/* Preallocate some slots */` |
|     2365 |  616 | `	SySetAlloc(&sToken,0x08);` |
|        - |  617 | `	/* Tokenize the text */` |
|     2365 |  618 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken,0);` |
|        - |  619 | `	/* Swap delimiter */` |
|     2365 |  620 | `	pTmpIn  = pGen->pIn;` |
|     2365 |  621 | `	pTmpEnd = pGen->pEnd;` |
|     2365 |  622 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     2365 |  623 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
...
|     2365 |  627 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD,0);` |
|        - |  628 | `	/* Restore token stream */` |
|     2365 |  629 | `	pGen->pIn  = pTmpIn;` |
|     2365 |  630 | `	pGen->pEnd = pTmpEnd;` |
|        - |  631 | `	/* Release the token set */` |
|     2365 |  632 | `	SySetRelease(&sToken);` |
...
|        - |  638 | ` */` |
|   126556 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126561 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126561 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126561 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126561 |  649 | `	(*pCount)++;` |
|   126561 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126561 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126561 |  653 | `	return pConstObj;` |
|    63283 |  654 | `}` |
|        - |  655 | `/*` |
...
|   125268 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   125273 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   125273 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 rc;` |
|        - |  724 | `	/* Delimit the string */` |
|   125273 |  725 | `	zIn  = pStr->zString;` |
|   125273 |  726 | `	zEnd = &zIn[pStr->nByte];` |
|   125273 |  727 | `	if( zIn >= zEnd ){` |
...
|    63612 |  738 | `	for(;;){` |
|   171679 |  739 | `		zCur = zIn;` |
|  1682847 |  740 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1513535 |  741 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       84 |  742 | `				break;` |
|  1513378 |  743 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2210 |  744 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1105 |  745 | `					break;` |
|        - |  746 | `			}` |
|  1511173 |  747 | `			zIn++;` |
|        5 |  748 | `		}` |
|   171679 |  749 | `		if( zIn > zCur ){` |
|    95901 |  750 | `			if( pObj == 0 ){` |
|    95249 |  751 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    95249 |  752 | `				if( pObj == 0 ){` |
|      ! 0 |  753 | `					return SXERR_ABORT;` |
|        - |  754 | `				}` |
|    47622 |  755 | `			}` |
|    95901 |  756 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47948 |  757 | `		}` |
|   171679 |  758 | `		if( zIn >= zEnd ){` |
|   124867 |  759 | `			break;` |
|        - |  760 | `		}` |
|    46817 |  761 | `		if( zIn[0] == '\\' ){` |
|    44455 |  762 | `			const char *zPtr = 0;` |
|        - |  763 | `			sxu32 n;` |
|    44455 |  764 | `			zIn++;` |
|    44455 |  765 | `			if( pObj == 0 ){` |
|    31317 |  766 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31317 |  767 | `				if( pObj == 0 ){` |
|      ! 0 |  768 | `					return SXERR_ABORT;` |
|        - |  769 | `				}` |
|    15656 |  770 | `			}` |
|    44455 |  771 | `			if( zIn >= zEnd ){` |
|        - |  772 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  773 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  774 | `				break;` |
|        - |  775 | `			}` |
|    44453 |  776 | `			n = sizeof(char); /* size of conversion */` |
|    44453 |  777 | `			switch( zIn[0] ){` |
|       17 |  778 | `			case '$':` |
|        - |  779 | `				/* Dollar sign */` |
...
|    39427 |  796 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39427 |  797 | `				break;` |
|       27 |  798 | `			case 'r':` |
...
|     3957 |  804 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3957 |  805 | `				break;` |
|        3 |  806 | `			case 'v':` |
...
|        - |  817 | `				}` |
|      299 |  818 | `				break;` |
|       24 |  819 | `			case '0': case '1': case '2': case '3':` |
...
|       50 |  823 | `				int c = 0;` |
|        - |  824 | `				char cOut;` |
|      144 |  825 | `				for( zPtr = zIn ; zPtr < &zIn[3*sizeof(char)] ; zPtr++ ){` |
|      122 |  826 | `					if( zPtr >= zEnd \|\| zPtr[0] < '0' \|\| zPtr[0] > '7' ){` |
|       14 |  827 | `						break;` |
|        - |  828 | `					}` |
|       96 |  829 | `					c = c * 8 + (zPtr[0] - '0');` |
|       49 |  830 | `				}` |
|       50 |  831 | `				if( c > 0xFF ){` |
|        - |  832 | `					SyString sSeq;` |
...
|        3 |  836 | `					c &= 0xFF;` |
|        1 |  837 | `				}` |
|       50 |  838 | `				cOut = (char)c; /* value byte, independent of host endianness */` |
|       50 |  839 | `				PH7_MemObjStringAppend(pObj,&cOut,sizeof(char));` |
|       50 |  840 | `				n = (sxu32)(zPtr-zIn);` |
|       50 |  841 | `				break;` |
|        - |  842 | `			}` |
|      228 |  843 | `			case 'x':` |
...
|       84 |  955 | `		}else{` |
|        - |  956 | `			/* Simple syntax */` |
|     2205 |  957 | `			const char *zExpr = zIn;` |
|        - |  958 | `			/* Assemble variable name */` |
|     1125 |  959 | `			for(;;){` |
|        - |  960 | `				/* Jump leading dollars */` |
|     4455 |  961 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|     2205 |  962 | `					zIn++;` |
|        5 |  963 | `				}` |
|     1125 |  964 | `				for(;;){` |
|    10774 |  965 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|     7399 |  966 | `						zIn++;` |
|        5 |  967 | `					}` |
|     2255 |  968 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|        - |  969 | `						/* UTF-8 stream */` |
|      ! 0 |  970 | `						zIn++;` |
...
|        1 | 1015 | `					}` |
|        3 | 1016 | `					break;` |
|     1969 | 1017 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|        - | 1018 | `					/* Member access operator '->' */` |
|       53 | 1019 | `					zIn += 2;` |
|     1944 | 1020 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|        - | 1034 | `			 */` |
|        - | 1035 | `			{` |
|     2205 | 1036 | `				const char *zBr = zExpr;` |
|    11911 | 1037 | `				while( zBr < zIn && zBr[0] != '[' ){` |
|     9711 | 1038 | `					zBr++;` |
|        5 | 1039 | `				}` |
|     2205 | 1040 | `				if( zBr < zIn && zIn[-1] == ']' ){` |
...
|        - | 1079 | `			 */` |
|     2203 | 1080 | `			if( &zExpr[1] < zIn && zExpr[0] == '$' && zExpr[1] == '{' ){` |
...
|     2201 | 1086 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|     2201 | 1087 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1088 | `				return SXERR_ABORT;` |
|        - | 1089 | `			}` |
|     2201 | 1090 | `			if( rc != SXERR_EMPTY ){` |
|     2201 | 1091 | `				++iCons;` |
|     1098 | 1092 | `			}` |
|        - | 1093 | `		}` |
...
|     2363 | 1095 | `		pObj = 0;` |
|        5 | 1096 | `	}/*for(;;)*/` |
|   124869 | 1097 | `	if( iCons > 1 ){` |
|        - | 1098 | `		/* Concatenate all compiled constants */` |
|     1641 | 1099 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|      818 | 1100 | `	}` |
|        - | 1101 | `	/* Node successfully compiled */` |
|   124869 | 1102 | `	return SXRET_OK;` |
|    62639 | 1103 | `}` |
|        - | 1104 | `/*` |
|        - | 1105 | ` * Compile a double quoted string.` |
|        - | 1106 | ` *  See the block-comment above for more information.` |
|        - | 1107 | ` */` |
|   125204 | 1108 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1109 | `{` |
|        - | 1110 | `	sxi32 rc;` |
|   125209 | 1111 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62602 | 1112 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1113 | `	/* Compilation result */` |
|   125209 | 1114 | `	return rc;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|       67 | 1132 | `	sOrig = pGen->pIn->sData;` |
|       67 | 1133 | `	pGen->pIn->sData = sStripped;` |
|       67 | 1134 | `	rc = GenStateCompileString(&(*pGen),1/*bHeredoc*/);` |
|       67 | 1135 | `	pGen->pIn->sData = sOrig;` |
...
|        - | 1157 | ` */` |
|  1569514 | 1158 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1569519 | 1169 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1170 | `	/* Compile the expression*/` |
|  1569519 | 1171 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1172 | `	/* Restore token stream */` |
|  1569519 | 1173 | `	RE_SWAP_DELIMITER(pGen);` |
|  1569519 | 1174 | `	return rc;` |
|        5 | 1175 | `}` |
|        - | 1176 | `/*` |
...
|        - | 1212 | ` */` |
|  1494310 | 1213 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1214 | `{` |
|  1494315 | 1215 | `	SyToken *pCur = pStart;` |
|  1494315 | 1216 | `	sxi32 iNest = 0;` |
|  3817485 | 1217 | `	while( pCur < pEnd ){` |
|  2862497 | 1218 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   539323 | 1219 | `			return pCur;` |
|        - | 1220 | `		}` |
...
|        - | 1224 | `		 */` |
|  2323179 | 1225 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23451 | 1226 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23451 | 1227 | `			SyToken *pFn = pCur;` |
|    23446 | 1228 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1229 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1230 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1231 | `				pFn = &pCur[1];` |
|      ! 0 | 1232 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1233 | `			}` |
|    23451 | 1234 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23447 | 1265 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1284 | `			}` |
|    11720 | 1285 | `		}` |
|  2323173 | 1286 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    55087 | 1287 | `			iNest++;` |
|  2295632 | 1288 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1301 | ` */` |
|   673370 | 1302 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1303 | `{` |
|        - | 1304 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1305 | `	SyToken *pKey,*pCur;` |
|   673375 | 1306 | `	sxi32 iEmitRef = 0;` |
|   673375 | 1307 | `	sxi32 iSpread = 0;` |
|   673375 | 1308 | `	sxi32 nPair = 0;` |
|        - | 1309 | `	sxi32 rc;` |
|   673375 | 1310 | `	xValidator = 0;` |
|   919906 | 1311 | `	for(;;){` |
...
|   583221 | 1316 | `		{` |
|  1839817 | 1317 | `			int nSkip = 0;` |
|  2730425 | 1318 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   890613 | 1319 | `				nSkip++;` |
|   890613 | 1320 | `				pGen->pIn++;` |
|        5 | 1321 | `			}` |
|  1839817 | 1322 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1329 | `			}` |
|        - | 1330 | `		}` |
|  1839817 | 1331 | `		pCur = pGen->pIn;` |
|  1839817 | 1332 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1333 | `			/* No more entry to process */` |
|   673357 | 1334 | `			break;` |
|        - | 1335 | `		}` |
|  1166465 | 1336 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1337 | `			continue;` |
|        - | 1338 | `		}` |
|        - | 1339 | `		/* Compile the key if available */` |
|  1166465 | 1340 | `		pKey = pCur;` |
|  1166465 | 1341 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1166465 | 1342 | `		rc = SXERR_EMPTY;` |
|  1166465 | 1343 | `		if( pCur < pGen->pIn ){` |
|   402797 | 1344 | `			if( pKey == pCur ){` |
...
|        - | 1357 | `			}` |
|   402795 | 1358 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|       14 | 1362 | `				rc = PH7_GenSyntaxError(&(*pGen),0,0);` |
|       14 | 1363 | `				if( rc == SXERR_ABORT ){` |
|      ! 0 | 1364 | `					return SXERR_ABORT;` |
|        - | 1365 | `				}` |
|       14 | 1366 | `				return SXRET_OK;` |
|        - | 1367 | `			}` |
|        - | 1368 | `			/* Compile the expression holding the key */` |
|   402785 | 1369 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1370 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   402785 | 1371 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1372 | `				return SXERR_ABORT;` |
|        - | 1373 | `			}` |
|   402785 | 1374 | `			pCur++; /* Jump the '=>' operator */` |
|   201395 | 1375 | `		}else{` |
|        - | 1376 | `			/* Reset back the cursor and point to the entry value */` |
|   763673 | 1377 | `			pCur = pKey;` |
|        - | 1378 | `		}` |
|  1166453 | 1379 | `		if( rc == SXERR_EMPTY ){` |
...
|   763673 | 1382 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   381834 | 1383 | `		}` |
|  1166453 | 1384 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
|        - | 1385 | `			/* Insertion by reference, [i.e: $a = array(&$x);] */` |
|       44 | 1386 | `			xValidator = GenStateArrayNodeValidator; /* Only variable are allowed */` |
|       44 | 1387 | `			iEmitRef = 1;` |
|       44 | 1388 | `			pCur++; /* Jump the '&' token */` |
|       44 | 1389 | `			if( pCur >= pGen->pIn ){` |
|        - | 1390 | `				/* Missing value */` |
...
|  1166451 | 1403 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1166451 | 1404 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1749668 | 1421 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   583221 | 1422 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1423 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   583221 | 1424 | `			xValidator);` |
|  1166447 | 1425 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1426 | `			return SXERR_ABORT;` |
|        - | 1427 | `		}` |
|  1166447 | 1428 | `		if( iSpread ){` |
...
|  1166412 | 1431 | `		}else if( iEmitRef ){` |
|        - | 1432 | `			/* Emit the load reference instruction */` |
|       40 | 1433 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1434 | `		}` |
|  1166447 | 1435 | `		xValidator = 0;` |
|  1166447 | 1436 | `		iEmitRef = 0;` |
|  1166447 | 1437 | `		iSpread = 0;` |
|  1166447 | 1438 | `		nPair++;` |
|        5 | 1439 | `	}` |
|        - | 1440 | `	/* Emit the load map instruction */` |
|   673357 | 1441 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1442 | `	/* Node successfully compiled */` |
|   673357 | 1443 | `	return SXRET_OK;` |
|   336690 | 1444 | `}` |
|        - | 1445 | `/*` |
...
|        - | 1453 | ` */` |
|   429714 | 1454 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1455 | `{` |
|        - | 1456 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   429719 | 1457 | `	pGen->pIn += 2;` |
|   429719 | 1458 | `	pGen->pEnd--;` |
|   214857 | 1459 | `	SXUNUSED(iCompileFlag);` |
|   429719 | 1460 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1461 | `}` |
|        - | 1462 | `/*` |
...
|        - | 1558 | ` */` |
|   243656 | 1559 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1560 | `{` |
|        - | 1561 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   243661 | 1562 | `	pGen->pIn++;` |
|   243661 | 1563 | `	pGen->pEnd--;` |
|   121828 | 1564 | `	SXUNUSED(iCompileFlag);` |
|   243661 | 1565 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1566 | `}` |
|        - | 1567 | `/*` |
