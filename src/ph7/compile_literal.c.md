...
|        - |   44 | ` */` |
|  3825280 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3825285 |   48 | `	const char *z = pRaw->zString;` |
|  3825285 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3825285 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3825285 |   52 | `	if( n < 2 ) return 0;` |
|   805795 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104857 |   54 | `		base = 16;` |
|   753369 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3068469 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2262693 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3825280 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3825285 |   88 | `	const char *zBad = 0;` |
|  3825285 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3825285 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3825271 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3825266 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3825271 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3825271 |  128 | `	*pzAlloc = 0;` |
|  9105359 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5280347 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2640049 |  131 | `	}` |
|  3825271 |  132 | `	if( !hasUnderscore ){` |
|  3825017 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3825017 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3816524 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3816529 |  189 | `	const char *z = pNum->zString;` |
|  3816529 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3816529 |  193 | `	*pbDecimal = FALSE;` |
|  3816529 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3816529 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3711679 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3711397 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1395357 |  246 | `		p = z;` |
|  2790711 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1407253 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1395357 |  249 | `		if( n <= 21 ){` |
|  1395355 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2316029 |  263 | `	p = z;` |
|  2316029 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5600257 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2316029 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2316005 |  270 | `	return FALSE;` |
|  1908267 |  271 | `}` |
|  3825252 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3825257 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3825257 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3825257 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1912626 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3825257 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3825257 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5737868 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1912621 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3825247 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3825247 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3816529 |  293 | `		ph7_real rOverflow = 0;` |
|  3816529 |  294 | `		int bDecimalOverflow = 0;` |
|  3816529 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3816495 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3816495 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3816495 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3816495 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1908267 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
|        - |  323 | `		/* Reserve a new constant */` |
|     8723 |  324 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     8723 |  325 | `		if( pObj == 0 ){` |
...
|        - |  329 | `		}` |
|     8723 |  330 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     8723 |  331 | `		PH7_MemObjToReal(pObj);` |
|        - |  332 | `	}` |
|  3825247 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3825247 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3825247 |  337 | `	return SXRET_OK;` |
|  1912631 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5561502 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5561507 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5561507 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5561507 |  359 | `	zIn  = pStr->zString;` |
|  5561507 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5561507 |  361 | `	if( zIn >= zEnd ){` |
...
|  5153887 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61586071 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56513851 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28216097 |  379 | `		}` |
|        - |  380 | `	}` |
|  5153887 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3007577 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3007577 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2146315 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2146315 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2146315 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2198800 |  397 | `	for(;;){` |
|  4397605 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2146315 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2251295 |  402 | `		zCur = zIn;` |
| 43501963 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41250673 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2251295 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2208541 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1104268 |  409 | `		}` |
|  2251295 |  410 | `		zIn++;` |
|  2251295 |  411 | `		if( zIn < zEnd ){` |
|   143829 |  412 | `			if( zIn[0] == '\\' ){` |
...
|  2146315 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2146315 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2064653 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1032324 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2146315 |  435 | `	return SXRET_OK;` |
|  2780756 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  638 | ` */` |
|   126344 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126349 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126349 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126349 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126349 |  649 | `	(*pCount)++;` |
|   126349 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126349 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126349 |  653 | `	return pConstObj;` |
|    63177 |  654 | `}` |
|        - |  655 | `/*` |
...
|   125052 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   125057 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   125057 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 rc;` |
|        - |  724 | `	/* Delimit the string */` |
|   125057 |  725 | `	zIn  = pStr->zString;` |
|   125057 |  726 | `	zEnd = &zIn[pStr->nByte];` |
|   125057 |  727 | `	if( zIn >= zEnd ){` |
...
|    63506 |  738 | `	for(;;){` |
|   171425 |  739 | `		zCur = zIn;` |
|  1679287 |  740 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1510233 |  741 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       84 |  742 | `				break;` |
|  1510076 |  743 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2214 |  744 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1107 |  745 | `					break;` |
|        - |  746 | `			}` |
|  1507867 |  747 | `			zIn++;` |
|        5 |  748 | `		}` |
|   171425 |  749 | `		if( zIn > zCur ){` |
|    95719 |  750 | `			if( pObj == 0 ){` |
|    95067 |  751 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    95067 |  752 | `				if( pObj == 0 ){` |
|      ! 0 |  753 | `					return SXERR_ABORT;` |
|        - |  754 | `				}` |
|    47531 |  755 | `			}` |
|    95719 |  756 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47857 |  757 | `		}` |
|   171425 |  758 | `		if( zIn >= zEnd ){` |
|   124651 |  759 | `			break;` |
|        - |  760 | `		}` |
|    46779 |  761 | `		if( zIn[0] == '\\' ){` |
|    44413 |  762 | `			const char *zPtr = 0;` |
|        - |  763 | `			sxu32 n;` |
|    44413 |  764 | `			zIn++;` |
|    44413 |  765 | `			if( pObj == 0 ){` |
|    31287 |  766 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31287 |  767 | `				if( pObj == 0 ){` |
|      ! 0 |  768 | `					return SXERR_ABORT;` |
|        - |  769 | `				}` |
|    15641 |  770 | `			}` |
|    44413 |  771 | `			if( zIn >= zEnd ){` |
|        - |  772 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  773 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  774 | `				break;` |
|        - |  775 | `			}` |
|    44411 |  776 | `			n = sizeof(char); /* size of conversion */` |
|    44411 |  777 | `			switch( zIn[0] ){` |
|       17 |  778 | `			case '$':` |
|        - |  779 | `				/* Dollar sign */` |
...
|    39391 |  796 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39391 |  797 | `				break;` |
|       27 |  798 | `			case 'r':` |
...
|     3947 |  804 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3947 |  805 | `				break;` |
|        3 |  806 | `			case 'v':` |
...
|   124653 | 1102 | `	return SXRET_OK;` |
|    62531 | 1103 | `}` |
|        - | 1104 | `/*` |
|        - | 1105 | ` * Compile a double quoted string.` |
|        - | 1106 | ` *  See the block-comment above for more information.` |
|        - | 1107 | ` */` |
|   124988 | 1108 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1109 | `{` |
|        - | 1110 | `	sxi32 rc;` |
|   124993 | 1111 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62494 | 1112 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1113 | `	/* Compilation result */` |
|   124993 | 1114 | `	return rc;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|        - | 1157 | ` */` |
|  1565544 | 1158 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1565549 | 1169 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1170 | `	/* Compile the expression*/` |
|  1565549 | 1171 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1172 | `	/* Restore token stream */` |
|  1565549 | 1173 | `	RE_SWAP_DELIMITER(pGen);` |
|  1565549 | 1174 | `	return rc;` |
|        5 | 1175 | `}` |
|        - | 1176 | `/*` |
...
|        - | 1212 | ` */` |
|  1490526 | 1213 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1214 | `{` |
|  1490531 | 1215 | `	SyToken *pCur = pStart;` |
|  1490531 | 1216 | `	sxi32 iNest = 0;` |
|  3807821 | 1217 | `	while( pCur < pEnd ){` |
|  2855249 | 1218 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   537955 | 1219 | `			return pCur;` |
|        - | 1220 | `		}` |
...
|        - | 1224 | `		 */` |
|  2317299 | 1225 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23391 | 1226 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23391 | 1227 | `			SyToken *pFn = pCur;` |
|    23386 | 1228 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1229 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1230 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1231 | `				pFn = &pCur[1];` |
|      ! 0 | 1232 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1233 | `			}` |
|    23391 | 1234 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23387 | 1265 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1284 | `			}` |
|    11690 | 1285 | `		}` |
|  2317293 | 1286 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    54951 | 1287 | `			iNest++;` |
|  2289820 | 1288 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1301 | ` */` |
|   671662 | 1302 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1303 | `{` |
|        - | 1304 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1305 | `	SyToken *pKey,*pCur;` |
|   671667 | 1306 | `	sxi32 iEmitRef = 0;` |
|   671667 | 1307 | `	sxi32 iSpread = 0;` |
|   671667 | 1308 | `	sxi32 nPair = 0;` |
|        - | 1309 | `	sxi32 rc;` |
|   671667 | 1310 | `	xValidator = 0;` |
|   917578 | 1311 | `	for(;;){` |
...
|   581747 | 1316 | `		{` |
|  1835161 | 1317 | `			int nSkip = 0;` |
|  2723511 | 1318 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   888355 | 1319 | `				nSkip++;` |
|   888355 | 1320 | `				pGen->pIn++;` |
|        5 | 1321 | `			}` |
|  1835161 | 1322 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1329 | `			}` |
|        - | 1330 | `		}` |
|  1835161 | 1331 | `		pCur = pGen->pIn;` |
|  1835161 | 1332 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1333 | `			/* No more entry to process */` |
|   671649 | 1334 | `			break;` |
|        - | 1335 | `		}` |
|  1163517 | 1336 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1337 | `			continue;` |
|        - | 1338 | `		}` |
|        - | 1339 | `		/* Compile the key if available */` |
|  1163517 | 1340 | `		pKey = pCur;` |
|  1163517 | 1341 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1163517 | 1342 | `		rc = SXERR_EMPTY;` |
|  1163517 | 1343 | `		if( pCur < pGen->pIn ){` |
|   401775 | 1344 | `			if( pKey == pCur ){` |
...
|        - | 1357 | `			}` |
|   401773 | 1358 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   401763 | 1369 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1370 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   401763 | 1371 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1372 | `				return SXERR_ABORT;` |
|        - | 1373 | `			}` |
|   401763 | 1374 | `			pCur++; /* Jump the '=>' operator */` |
|   200884 | 1375 | `		}else{` |
|        - | 1376 | `			/* Reset back the cursor and point to the entry value */` |
|   761747 | 1377 | `			pCur = pKey;` |
|        - | 1378 | `		}` |
|  1163505 | 1379 | `		if( rc == SXERR_EMPTY ){` |
...
|   761747 | 1382 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   380871 | 1383 | `		}` |
|  1163505 | 1384 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1163503 | 1403 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1163503 | 1404 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1745246 | 1421 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   581747 | 1422 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1423 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   581747 | 1424 | `			xValidator);` |
|  1163499 | 1425 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1426 | `			return SXERR_ABORT;` |
|        - | 1427 | `		}` |
|  1163499 | 1428 | `		if( iSpread ){` |
...
|  1163464 | 1431 | `		}else if( iEmitRef ){` |
|        - | 1432 | `			/* Emit the load reference instruction */` |
|       40 | 1433 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1434 | `		}` |
|  1163499 | 1435 | `		xValidator = 0;` |
|  1163499 | 1436 | `		iEmitRef = 0;` |
|  1163499 | 1437 | `		iSpread = 0;` |
|  1163499 | 1438 | `		nPair++;` |
|        5 | 1439 | `	}` |
|        - | 1440 | `	/* Emit the load map instruction */` |
|   671649 | 1441 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1442 | `	/* Node successfully compiled */` |
|   671649 | 1443 | `	return SXRET_OK;` |
|   335836 | 1444 | `}` |
|        - | 1445 | `/*` |
...
|        - | 1453 | ` */` |
|   428614 | 1454 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1455 | `{` |
|        - | 1456 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   428619 | 1457 | `	pGen->pIn += 2;` |
|   428619 | 1458 | `	pGen->pEnd--;` |
|   214307 | 1459 | `	SXUNUSED(iCompileFlag);` |
|   428619 | 1460 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1461 | `}` |
|        - | 1462 | `/*` |
...
|        - | 1558 | ` */` |
|   243048 | 1559 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1560 | `{` |
|        - | 1561 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   243053 | 1562 | `	pGen->pIn++;` |
|   243053 | 1563 | `	pGen->pEnd--;` |
|   121524 | 1564 | `	SXUNUSED(iCompileFlag);` |
|   243053 | 1565 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1566 | `}` |
|        - | 1567 | `/*` |
