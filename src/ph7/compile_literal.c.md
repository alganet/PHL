...
|        - |   44 | ` */` |
|  3827182 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3827187 |   48 | `	const char *z = pRaw->zString;` |
|  3827187 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3827187 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3827187 |   52 | `	if( n < 2 ) return 0;` |
|   806199 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104911 |   54 | `		base = 16;` |
|   753746 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3070009 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2263829 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3827182 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3827187 |   88 | `	const char *zBad = 0;` |
|  3827187 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3827187 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3827173 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3827168 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3827173 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3827173 |  128 | `	*pzAlloc = 0;` |
|  9109895 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5282981 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2641366 |  131 | `	}` |
|  3827173 |  132 | `	if( !hasUnderscore ){` |
|  3826919 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3826919 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3818422 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3818427 |  189 | `	const char *z = pNum->zString;` |
|  3818427 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3818427 |  193 | `	*pbDecimal = FALSE;` |
|  3818427 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3818427 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|        - |  198 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|   104909 |  199 | `		p = z + 2;` |
|   132091 |  200 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   427589 |  201 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|   104909 |  202 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|   104903 |  203 | `			return FALSE;` |
|        - |  204 | `		}` |
|        7 |  205 | `		{ ph7_real dv = 0;` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3713523 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3713241 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1396073 |  246 | `		p = z;` |
|  2792143 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1407975 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1396073 |  249 | `		if( n <= 21 ){` |
|  1396071 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2317157 |  263 | `	p = z;` |
|  2317157 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5602997 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2317157 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2317133 |  270 | `	return FALSE;` |
|  1909216 |  271 | `}` |
|  3827154 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3827159 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3827159 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3827159 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1913577 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3827159 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3827159 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5740721 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1913572 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3827149 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3827149 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3818427 |  293 | `		ph7_real rOverflow = 0;` |
|  3818427 |  294 | `		int bDecimalOverflow = 0;` |
|  3818427 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3818393 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3818393 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3818393 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3818393 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1909216 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
|        - |  323 | `		/* Reserve a new constant */` |
|     8727 |  324 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     8727 |  325 | `		if( pObj == 0 ){` |
...
|        - |  329 | `		}` |
|     8727 |  330 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     8727 |  331 | `		PH7_MemObjToReal(pObj);` |
|        - |  332 | `	}` |
|  3827149 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3827149 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3827149 |  337 | `	return SXRET_OK;` |
|  1913582 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5564278 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5564283 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5564283 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5564283 |  359 | `	zIn  = pStr->zString;` |
|  5564283 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5564283 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   407835 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   407835 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|  5156453 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61617623 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56542879 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28230590 |  379 | `		}` |
|        - |  380 | `	}` |
|  5156453 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3009059 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3009059 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2147399 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2147399 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2147399 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2199911 |  397 | `	for(;;){` |
|  4399827 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2147399 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2252433 |  402 | `		zCur = zIn;` |
| 43524283 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41271855 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2252433 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2209657 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1104826 |  409 | `		}` |
|  2252433 |  410 | `		zIn++;` |
|  2252433 |  411 | `		if( zIn < zEnd ){` |
|   143903 |  412 | `			if( zIn[0] == '\\' ){` |
|        - |  413 | `				/* A literal backslash */` |
|    35011 |  414 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|   126400 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
...
|  2147399 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2147399 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2065695 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1032845 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2147399 |  435 | `	return SXRET_OK;` |
|  2782144 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  636 | ` */` |
|   126332 |  637 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  638 | `{` |
|        - |  639 | `	ph7_value *pConstObj;` |
|   126337 |  640 | `	sxu32 nIdx = 0;` |
|        - |  641 | `	/* Reserve a new constant */` |
|   126337 |  642 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126337 |  643 | `	if( pConstObj == 0 ){` |
|      ! 0 |  644 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  645 | `		return 0;` |
|        - |  646 | `	}` |
|   126337 |  647 | `	(*pCount)++;` |
|   126337 |  648 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  649 | `	/* Emit the load constant instruction */` |
|   126337 |  650 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126337 |  651 | `	return pConstObj;` |
|    63171 |  652 | `}` |
|        - |  653 | `/*` |
...
|   125048 |  715 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  716 | `{` |
|   125053 |  717 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  718 | `	const char *zIn,*zCur,*zEnd;` |
|   125053 |  719 | `	ph7_value *pObj = 0;` |
|        - |  720 | `	sxi32 iCons;` |
|        - |  721 | `	sxi32 rc;` |
|        - |  722 | `	/* Delimit the string */` |
|   125053 |  723 | `	zIn  = pStr->zString;` |
|   125053 |  724 | `	zEnd = &zIn[pStr->nByte];` |
|   125053 |  725 | `	if( zIn >= zEnd ){` |
...
|    63499 |  736 | `	for(;;){` |
|   171379 |  737 | `		zCur = zIn;` |
|  1679589 |  738 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1510571 |  739 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       84 |  740 | `				break;` |
|  1510414 |  741 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2204 |  742 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1102 |  743 | `					break;` |
|        - |  744 | `			}` |
|  1508215 |  745 | `			zIn++;` |
|        5 |  746 | `		}` |
|   171379 |  747 | `		if( zIn > zCur ){` |
|    95729 |  748 | `			if( pObj == 0 ){` |
|    95077 |  749 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    95077 |  750 | `				if( pObj == 0 ){` |
|      ! 0 |  751 | `					return SXERR_ABORT;` |
|        - |  752 | `				}` |
|    47536 |  753 | `			}` |
|    95729 |  754 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47862 |  755 | `		}` |
|   171379 |  756 | `		if( zIn >= zEnd ){` |
|   124647 |  757 | `			break;` |
|        - |  758 | `		}` |
|    46737 |  759 | `		if( zIn[0] == '\\' ){` |
|    44381 |  760 | `			const char *zPtr = 0;` |
|        - |  761 | `			sxu32 n;` |
|    44381 |  762 | `			zIn++;` |
|    44381 |  763 | `			if( pObj == 0 ){` |
|    31265 |  764 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31265 |  765 | `				if( pObj == 0 ){` |
|      ! 0 |  766 | `					return SXERR_ABORT;` |
|        - |  767 | `				}` |
|    15630 |  768 | `			}` |
|    44381 |  769 | `			if( zIn >= zEnd ){` |
|        - |  770 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  771 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  772 | `				break;` |
|        - |  773 | `			}` |
|    44379 |  774 | `			n = sizeof(char); /* size of conversion */` |
|    44379 |  775 | `			switch( zIn[0] ){` |
|       17 |  776 | `			case '$':` |
|        - |  777 | `				/* Dollar sign */` |
...
|    39361 |  794 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39361 |  795 | `				break;` |
|       27 |  796 | `			case 'r':` |
...
|     3949 |  802 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3949 |  803 | `				break;` |
|        3 |  804 | `			case 'v':` |
...
|   124649 | 1100 | `	return SXRET_OK;` |
|    62529 | 1101 | `}` |
|        - | 1102 | `/*` |
|        - | 1103 | ` * Compile a double quoted string.` |
|        - | 1104 | ` *  See the block-comment above for more information.` |
|        - | 1105 | ` */` |
|   124984 | 1106 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1107 | `{` |
|        - | 1108 | `	sxi32 rc;` |
|   124989 | 1109 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62492 | 1110 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1111 | `	/* Compilation result */` |
|   124989 | 1112 | `	return rc;` |
|        5 | 1113 | `}` |
|        - | 1114 | `/*` |
...
|        - | 1155 | ` */` |
|  1566312 | 1156 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1566317 | 1167 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1168 | `	/* Compile the expression*/` |
|  1566317 | 1169 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1170 | `	/* Restore token stream */` |
|  1566317 | 1171 | `	RE_SWAP_DELIMITER(pGen);` |
|  1566317 | 1172 | `	return rc;` |
|        5 | 1173 | `}` |
|        - | 1174 | `/*` |
...
|        - | 1210 | ` */` |
|  1491256 | 1211 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1212 | `{` |
|  1491261 | 1213 | `	SyToken *pCur = pStart;` |
|  1491261 | 1214 | `	sxi32 iNest = 0;` |
|  3809677 | 1215 | `	while( pCur < pEnd ){` |
|  2856637 | 1216 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   538217 | 1217 | `			return pCur;` |
|        - | 1218 | `		}` |
...
|        - | 1222 | `		 */` |
|  2318425 | 1223 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23403 | 1224 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23403 | 1225 | `			SyToken *pFn = pCur;` |
|    23398 | 1226 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1227 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1228 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1229 | `				pFn = &pCur[1];` |
|      ! 0 | 1230 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1231 | `			}` |
|    23403 | 1232 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23399 | 1263 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1282 | `			}` |
|    11696 | 1283 | `		}` |
|  2318419 | 1284 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    54975 | 1285 | `			iNest++;` |
|  2290934 | 1286 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1299 | ` */` |
|   671990 | 1300 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1301 | `{` |
|        - | 1302 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1303 | `	SyToken *pKey,*pCur;` |
|   671995 | 1304 | `	sxi32 iEmitRef = 0;` |
|   671995 | 1305 | `	sxi32 iSpread = 0;` |
|   671995 | 1306 | `	sxi32 nPair = 0;` |
|        - | 1307 | `	sxi32 rc;` |
|   671995 | 1308 | `	xValidator = 0;` |
|   918027 | 1309 | `	for(;;){` |
...
|   582032 | 1314 | `		{` |
|  1836059 | 1315 | `			int nSkip = 0;` |
|  2724851 | 1316 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   888797 | 1317 | `				nSkip++;` |
|   888797 | 1318 | `				pGen->pIn++;` |
|        5 | 1319 | `			}` |
|  1836059 | 1320 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1327 | `			}` |
|        - | 1328 | `		}` |
|  1836059 | 1329 | `		pCur = pGen->pIn;` |
|  1836059 | 1330 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1331 | `			/* No more entry to process */` |
|   671977 | 1332 | `			break;` |
|        - | 1333 | `		}` |
|  1164087 | 1334 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1335 | `			continue;` |
|        - | 1336 | `		}` |
|        - | 1337 | `		/* Compile the key if available */` |
|  1164087 | 1338 | `		pKey = pCur;` |
|  1164087 | 1339 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1164087 | 1340 | `		rc = SXERR_EMPTY;` |
|  1164087 | 1341 | `		if( pCur < pGen->pIn ){` |
|   401973 | 1342 | `			if( pKey == pCur ){` |
...
|        - | 1355 | `			}` |
|   401971 | 1356 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   401961 | 1367 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1368 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   401961 | 1369 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1370 | `				return SXERR_ABORT;` |
|        - | 1371 | `			}` |
|   401961 | 1372 | `			pCur++; /* Jump the '=>' operator */` |
|   200983 | 1373 | `		}else{` |
|        - | 1374 | `			/* Reset back the cursor and point to the entry value */` |
|   762119 | 1375 | `			pCur = pKey;` |
|        - | 1376 | `		}` |
|  1164075 | 1377 | `		if( rc == SXERR_EMPTY ){` |
...
|   762119 | 1380 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   381057 | 1381 | `		}` |
|  1164075 | 1382 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1164073 | 1401 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1164073 | 1402 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1746101 | 1419 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   582032 | 1420 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1421 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   582032 | 1422 | `			xValidator);` |
|  1164069 | 1423 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1424 | `			return SXERR_ABORT;` |
|        - | 1425 | `		}` |
|  1164069 | 1426 | `		if( iSpread ){` |
...
|  1164034 | 1429 | `		}else if( iEmitRef ){` |
|        - | 1430 | `			/* Emit the load reference instruction */` |
|       40 | 1431 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1432 | `		}` |
|  1164069 | 1433 | `		xValidator = 0;` |
|  1164069 | 1434 | `		iEmitRef = 0;` |
|  1164069 | 1435 | `		iSpread = 0;` |
|  1164069 | 1436 | `		nPair++;` |
|        5 | 1437 | `	}` |
|        - | 1438 | `	/* Emit the load map instruction */` |
|   671977 | 1439 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1440 | `	/* Node successfully compiled */` |
|   671977 | 1441 | `	return SXRET_OK;` |
|   336000 | 1442 | `}` |
|        - | 1443 | `/*` |
...
|        - | 1451 | ` */` |
|   428834 | 1452 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1453 | `{` |
|        - | 1454 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   428839 | 1455 | `	pGen->pIn += 2;` |
|   428839 | 1456 | `	pGen->pEnd--;` |
|   214417 | 1457 | `	SXUNUSED(iCompileFlag);` |
|   428839 | 1458 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1459 | `}` |
|        - | 1460 | `/*` |
...
|        - | 1556 | ` */` |
|   243156 | 1557 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1558 | `{` |
|        - | 1559 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   243161 | 1560 | `	pGen->pIn++;` |
|   243161 | 1561 | `	pGen->pEnd--;` |
|   121578 | 1562 | `	SXUNUSED(iCompileFlag);` |
|   243161 | 1563 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1564 | `}` |
|        - | 1565 | `/*` |
