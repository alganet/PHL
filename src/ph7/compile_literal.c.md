...
|        - |   44 | ` */` |
|  3819414 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3819419 |   48 | `	const char *z = pRaw->zString;` |
|  3819419 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3819419 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3819419 |   52 | `	if( n < 2 ) return 0;` |
|   804575 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104695 |   54 | `		base = 16;` |
|   752230 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3063855 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2259299 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3819414 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3819419 |   88 | `	const char *zBad = 0;` |
|  3819419 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3819419 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3819405 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3819400 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3819405 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3819405 |  128 | `	*pzAlloc = 0;` |
|  9091453 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5272307 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2636029 |  131 | `	}` |
|  3819405 |  132 | `	if( !hasUnderscore ){` |
|  3819151 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3819151 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3810670 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3810675 |  189 | `	const char *z = pNum->zString;` |
|  3810675 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3810675 |  193 | `	*pbDecimal = FALSE;` |
|  3810675 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3810675 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3705987 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3705705 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  2312491 |  263 | `	p = z;` |
|  2312491 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5591751 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2312491 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2312467 |  270 | `	return FALSE;` |
|  1905340 |  271 | `}` |
|  3819386 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3819391 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3819391 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3819391 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1909693 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3819391 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3819391 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5729069 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1909688 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3819381 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3819381 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3810675 |  293 | `		ph7_real rOverflow = 0;` |
|  3810675 |  294 | `		int bDecimalOverflow = 0;` |
|  3810675 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3810641 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3810641 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3810641 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3810641 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1905340 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
...
|        - |  332 | `	}` |
|  3819381 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3819381 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3819381 |  337 | `	return SXRET_OK;` |
|  1909698 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5552968 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5552973 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5552973 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5552973 |  359 | `	zIn  = pStr->zString;` |
|  5552973 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5552973 |  361 | `	if( zIn >= zEnd ){` |
...
|  5145977 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61491043 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56426609 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28172538 |  379 | `		}` |
|        - |  380 | `	}` |
|  5145977 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3002971 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3002971 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2143011 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2143011 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2143011 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2195415 |  397 | `	for(;;){` |
|  4390835 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2143011 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2247829 |  402 | `		zCur = zIn;` |
| 43434651 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41186827 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2247829 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2205139 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1102567 |  409 | `		}` |
|  2247829 |  410 | `		zIn++;` |
|  2247829 |  411 | `		if( zIn < zEnd ){` |
|   143609 |  412 | `			if( zIn[0] == '\\' ){` |
...
|  2143011 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2143011 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2061473 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1030734 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2143011 |  435 | `	return SXRET_OK;` |
|  2776489 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  638 | ` */` |
|   126106 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126111 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126111 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126111 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126111 |  649 | `	(*pCount)++;` |
|   126111 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126111 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126111 |  653 | `	return pConstObj;` |
|    63058 |  654 | `}` |
|        - |  655 | `/*` |
...
|   124912 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   124917 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   124917 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 rc;` |
|        - |  724 | `	/* Delimit the string */` |
|   124917 |  725 | `	zIn  = pStr->zString;` |
|   124917 |  726 | `	zEnd = &zIn[pStr->nByte];` |
|   124917 |  727 | `	if( zIn >= zEnd ){` |
...
|    63388 |  738 | `	for(;;){` |
|   171041 |  739 | `		zCur = zIn;` |
|  1674701 |  740 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1505973 |  741 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       84 |  742 | `				break;` |
|  1505816 |  743 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2156 |  744 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1078 |  745 | `					break;` |
|        - |  746 | `			}` |
|  1503665 |  747 | `			zIn++;` |
|        5 |  748 | `		}` |
|   171041 |  749 | `		if( zIn > zCur ){` |
|    95541 |  750 | `			if( pObj == 0 ){` |
|    94887 |  751 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    94887 |  752 | `				if( pObj == 0 ){` |
|      ! 0 |  753 | `					return SXERR_ABORT;` |
|        - |  754 | `				}` |
|    47441 |  755 | `			}` |
|    95541 |  756 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47768 |  757 | `		}` |
|   171041 |  758 | `		if( zIn >= zEnd ){` |
|   124473 |  759 | `			break;` |
|        - |  760 | `		}` |
|    46573 |  761 | `		if( zIn[0] == '\\' ){` |
|    44265 |  762 | `			const char *zPtr = 0;` |
|        - |  763 | `			sxu32 n;` |
|    44265 |  764 | `			zIn++;` |
|    44265 |  765 | `			if( pObj == 0 ){` |
|    31229 |  766 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31229 |  767 | `				if( pObj == 0 ){` |
|      ! 0 |  768 | `					return SXERR_ABORT;` |
|        - |  769 | `				}` |
|    15612 |  770 | `			}` |
|    44265 |  771 | `			if( zIn >= zEnd ){` |
|        - |  772 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  773 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  774 | `				break;` |
|        - |  775 | `			}` |
|    44263 |  776 | `			n = sizeof(char); /* size of conversion */` |
|    44263 |  777 | `			switch( zIn[0] ){` |
|       17 |  778 | `			case '$':` |
|        - |  779 | `				/* Dollar sign */` |
...
|    39247 |  796 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39247 |  797 | `				break;` |
|       27 |  798 | `			case 'r':` |
...
|   124475 | 1102 | `	return SXRET_OK;` |
|    62461 | 1103 | `}` |
|        - | 1104 | `/*` |
|        - | 1105 | ` * Compile a double quoted string.` |
|        - | 1106 | ` *  See the block-comment above for more information.` |
|        - | 1107 | ` */` |
|   124848 | 1108 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1109 | `{` |
|        - | 1110 | `	sxi32 rc;` |
|   124853 | 1111 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62424 | 1112 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1113 | `	/* Compilation result */` |
|   124853 | 1114 | `	return rc;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
