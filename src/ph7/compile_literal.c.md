...
|        - |   44 | ` */` |
|  3819444 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3819449 |   48 | `	const char *z = pRaw->zString;` |
|  3819449 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3819449 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3819449 |   52 | `	if( n < 2 ) return 0;` |
|   804579 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104695 |   54 | `		base = 16;` |
|   752234 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3063855 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2259295 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3819444 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3819449 |   88 | `	const char *zBad = 0;` |
|  3819449 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3819449 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3819435 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3819430 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3819435 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3819435 |  128 | `	*pzAlloc = 0;` |
|  9091505 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5272329 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2636040 |  131 | `	}` |
|  3819435 |  132 | `	if( !hasUnderscore ){` |
|  3819181 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3819181 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3810700 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3810705 |  189 | `	const char *z = pNum->zString;` |
|  3810705 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3810705 |  193 | `	*pbDecimal = FALSE;` |
|  3810705 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3810705 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|        - |  198 | `		/* Hexadecimal: INT64_MAX == 0x7FFF...F (16 digits, leading nibble 7). */` |
|   104693 |  199 | `		p = z + 2;` |
|   131819 |  200 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|   426709 |  201 | `		for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisHex(q[0]); q++ ){ n++; }` |
|   104693 |  202 | `		if( n < 16 \|\| (n == 16 && SyHexToint(p[0]) < 8) ){` |
|   104687 |  203 | `			return FALSE;` |
|        - |  204 | `		}` |
|        7 |  205 | `		{ ph7_real dv = 0;` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3706017 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3705735 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1393201 |  246 | `		p = z;` |
|  2786399 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1405079 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1393201 |  249 | `		if( n <= 21 ){` |
|  1393199 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2312523 |  263 | `	p = z;` |
|  2312523 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5591807 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2312523 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2312499 |  270 | `	return FALSE;` |
|  1905355 |  271 | `}` |
|  3819416 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3819421 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3819421 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3819421 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1909708 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3819421 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3819421 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5729114 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1909703 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3819411 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3819411 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3810705 |  293 | `		ph7_real rOverflow = 0;` |
|  3810705 |  294 | `		int bDecimalOverflow = 0;` |
|  3810705 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3810671 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3810671 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3810671 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3810671 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1905355 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
|        - |  323 | `		/* Reserve a new constant */` |
|     8711 |  324 | `		pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|     8711 |  325 | `		if( pObj == 0 ){` |
...
|        - |  329 | `		}` |
|     8711 |  330 | `		PH7_MemObjInitFromString(pGen->pVm,pObj,&sNum);` |
|     8711 |  331 | `		PH7_MemObjToReal(pObj);` |
|        - |  332 | `	}` |
|  3819411 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3819411 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3819411 |  337 | `	return SXRET_OK;` |
|  1909713 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5553012 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5553017 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5553017 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5553017 |  359 | `	zIn  = pStr->zString;` |
|  5553017 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5553017 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   407029 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   407029 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|  5145993 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61491425 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56426979 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28172721 |  379 | `		}` |
|        - |  380 | `	}` |
|  5145993 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3002943 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3002943 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2143055 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2143055 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2143055 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2195461 |  397 | `	for(;;){` |
|  4390927 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2143055 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2247877 |  402 | `		zCur = zIn;` |
| 43435489 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41187617 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2247877 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2205183 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1102589 |  409 | `		}` |
|  2247877 |  410 | `		zIn++;` |
|  2247877 |  411 | `		if( zIn < zEnd ){` |
|   143613 |  412 | `			if( zIn[0] == '\\' ){` |
|        - |  413 | `				/* A literal backslash */` |
|    34945 |  414 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|   126143 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
|       15 |  417 | `				PH7_MemObjStringAppend(pObj,"'",sizeof(char));` |
|        8 |  418 | `			}else{` |
|        - |  419 | `				/* verbatim copy */` |
|   108659 |  420 | `				zIn--;` |
|   108659 |  421 | `				PH7_MemObjStringAppend(pObj,zIn,sizeof(char)*2);` |
|   108659 |  422 | `				zIn++;` |
|        - |  423 | `			}` |
|    71804 |  424 | `		}` |
...
|  2143055 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2143055 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2061513 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1030754 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2143055 |  435 | `	return SXRET_OK;` |
|  2776511 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  638 | ` */` |
|   126180 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126185 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126185 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126185 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126185 |  649 | `	(*pCount)++;` |
|   126185 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126185 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126185 |  653 | `	return pConstObj;` |
|    63095 |  654 | `}` |
|        - |  655 | `/*` |
...
|   124992 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   124997 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   124997 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 nInterp;   /* how many of iCons came from an interpolated EXPRESSION */` |
|        - |  724 | `	sxi32 rc;` |
|        - |  725 | `	/* Delimit the string */` |
|   124997 |  726 | `	zIn  = pStr->zString;` |
|   124997 |  727 | `	zEnd = &zIn[pStr->nByte];` |
|   124997 |  728 | `	if( zIn >= zEnd ){` |
...
|   124557 |  738 | `	iCons = 0;` |
|   124557 |  739 | `	nInterp = 0;` |
|    63437 |  740 | `	for(;;){` |
|   171197 |  741 | `		zCur = zIn;` |
|  1675793 |  742 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1506927 |  743 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       86 |  744 | `				break;` |
|  1506766 |  745 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2170 |  746 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1085 |  747 | `					break;` |
|        - |  748 | `			}` |
|  1504601 |  749 | `			zIn++;` |
|        5 |  750 | `		}` |
|   171197 |  751 | `		if( zIn > zCur ){` |
|    95579 |  752 | `			if( pObj == 0 ){` |
|    94925 |  753 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    94925 |  754 | `				if( pObj == 0 ){` |
|      ! 0 |  755 | `					return SXERR_ABORT;` |
|        - |  756 | `				}` |
|    47460 |  757 | `			}` |
|    95579 |  758 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47787 |  759 | `		}` |
|   171197 |  760 | `		if( zIn >= zEnd ){` |
|   124553 |  761 | `			break;` |
|        - |  762 | `		}` |
|    46649 |  763 | `		if( zIn[0] == '\\' ){` |
|    44323 |  764 | `			const char *zPtr = 0;` |
|        - |  765 | `			sxu32 n;` |
|    44323 |  766 | `			zIn++;` |
|    44323 |  767 | `			if( pObj == 0 ){` |
|    31265 |  768 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31265 |  769 | `				if( pObj == 0 ){` |
|      ! 0 |  770 | `					return SXERR_ABORT;` |
|        - |  771 | `				}` |
|    15630 |  772 | `			}` |
|    44323 |  773 | `			if( zIn >= zEnd ){` |
|        - |  774 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  775 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  776 | `				break;` |
|        - |  777 | `			}` |
|    44321 |  778 | `			n = sizeof(char); /* size of conversion */` |
|    44321 |  779 | `			switch( zIn[0] ){` |
|       17 |  780 | `			case '$':` |
|        - |  781 | `				/* Dollar sign */` |
...
|    39293 |  798 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39293 |  799 | `				break;` |
|       27 |  800 | `			case 'r':` |
...
|     3943 |  806 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3943 |  807 | `				break;` |
|        3 |  808 | `			case 'v':` |
...
|   124555 | 1114 | `	return SXRET_OK;` |
|    62501 | 1115 | `}` |
|        - | 1116 | `/*` |
|        - | 1117 | ` * Compile a double quoted string.` |
|        - | 1118 | ` *  See the block-comment above for more information.` |
|        - | 1119 | ` */` |
|   124928 | 1120 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1121 | `{` |
|        - | 1122 | `	sxi32 rc;` |
|   124933 | 1123 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62464 | 1124 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1125 | `	/* Compilation result */` |
|   124933 | 1126 | `	return rc;` |
|        5 | 1127 | `}` |
|        - | 1128 | `/*` |
...
|        - | 1169 | ` */` |
|  1563368 | 1170 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1563373 | 1181 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1182 | `	/* Compile the expression*/` |
|  1563373 | 1183 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1184 | `	/* Restore token stream */` |
|  1563373 | 1185 | `	RE_SWAP_DELIMITER(pGen);` |
|  1563373 | 1186 | `	return rc;` |
|        5 | 1187 | `}` |
|        - | 1188 | `/*` |
...
|        - | 1224 | ` */` |
|  1488466 | 1225 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1226 | `{` |
|  1488471 | 1227 | `	SyToken *pCur = pStart;` |
|  1488471 | 1228 | `	sxi32 iNest = 0;` |
|  3802527 | 1229 | `	while( pCur < pEnd ){` |
|  2851205 | 1230 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   537145 | 1231 | `			return pCur;` |
|        - | 1232 | `		}` |
...
|        - | 1236 | `		 */` |
|  2314065 | 1237 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23355 | 1238 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23355 | 1239 | `			SyToken *pFn = pCur;` |
|    23350 | 1240 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1241 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1242 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1243 | `				pFn = &pCur[1];` |
|      ! 0 | 1244 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1245 | `			}` |
|    23355 | 1246 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23351 | 1277 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1296 | `			}` |
|    11672 | 1297 | `		}` |
|  2314059 | 1298 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    54891 | 1299 | `			iNest++;` |
|  2286616 | 1300 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1313 | ` */` |
|   670676 | 1314 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1315 | `{` |
|        - | 1316 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1317 | `	SyToken *pKey,*pCur;` |
|   670681 | 1318 | `	sxi32 iEmitRef = 0;` |
|   670681 | 1319 | `	sxi32 iSpread = 0;` |
|   670681 | 1320 | `	sxi32 nPair = 0;` |
|        - | 1321 | `	sxi32 rc;` |
|   670681 | 1322 | `	xValidator = 0;` |
|   916299 | 1323 | `	for(;;){` |
...
|   580961 | 1328 | `		{` |
|  1832603 | 1329 | `			int nSkip = 0;` |
|  2719761 | 1330 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   887163 | 1331 | `				nSkip++;` |
|   887163 | 1332 | `				pGen->pIn++;` |
|        5 | 1333 | `			}` |
|  1832603 | 1334 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1341 | `			}` |
|        - | 1342 | `		}` |
|  1832603 | 1343 | `		pCur = pGen->pIn;` |
|  1832603 | 1344 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1345 | `			/* No more entry to process */` |
|   670663 | 1346 | `			break;` |
|        - | 1347 | `		}` |
|  1161945 | 1348 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1349 | `			continue;` |
|        - | 1350 | `		}` |
|        - | 1351 | `		/* Compile the key if available */` |
|  1161945 | 1352 | `		pKey = pCur;` |
|  1161945 | 1353 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1161945 | 1354 | `		rc = SXERR_EMPTY;` |
|  1161945 | 1355 | `		if( pCur < pGen->pIn ){` |
|   401171 | 1356 | `			if( pKey == pCur ){` |
...
|        - | 1369 | `			}` |
|   401169 | 1370 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   401159 | 1381 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1382 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   401159 | 1383 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1384 | `				return SXERR_ABORT;` |
|        - | 1385 | `			}` |
|   401159 | 1386 | `			pCur++; /* Jump the '=>' operator */` |
|   200582 | 1387 | `		}else{` |
|        - | 1388 | `			/* Reset back the cursor and point to the entry value */` |
|   760779 | 1389 | `			pCur = pKey;` |
|        - | 1390 | `		}` |
|  1161933 | 1391 | `		if( rc == SXERR_EMPTY ){` |
...
|   760779 | 1394 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   380387 | 1395 | `		}` |
|  1161933 | 1396 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1161931 | 1415 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1161931 | 1416 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1742888 | 1433 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   580961 | 1434 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1435 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   580961 | 1436 | `			xValidator);` |
|  1161927 | 1437 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1438 | `			return SXERR_ABORT;` |
|        - | 1439 | `		}` |
|  1161927 | 1440 | `		if( iSpread ){` |
...
|  1161892 | 1443 | `		}else if( iEmitRef ){` |
|        - | 1444 | `			/* Emit the load reference instruction */` |
|       40 | 1445 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1446 | `		}` |
|  1161927 | 1447 | `		xValidator = 0;` |
|  1161927 | 1448 | `		iEmitRef = 0;` |
|  1161927 | 1449 | `		iSpread = 0;` |
|  1161927 | 1450 | `		nPair++;` |
|        5 | 1451 | `	}` |
|        - | 1452 | `	/* Emit the load map instruction */` |
|   670663 | 1453 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1454 | `	/* Node successfully compiled */` |
|   670663 | 1455 | `	return SXRET_OK;` |
|   335343 | 1456 | `}` |
|        - | 1457 | `/*` |
...
|        - | 1465 | ` */` |
|   427960 | 1466 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1467 | `{` |
|        - | 1468 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   427965 | 1469 | `	pGen->pIn += 2;` |
|   427965 | 1470 | `	pGen->pEnd--;` |
|   213980 | 1471 | `	SXUNUSED(iCompileFlag);` |
|   427965 | 1472 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1473 | `}` |
|        - | 1474 | `/*` |
...
|        - | 1570 | ` */` |
|   242716 | 1571 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1572 | `{` |
|        - | 1573 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   242721 | 1574 | `	pGen->pIn++;` |
|   242721 | 1575 | `	pGen->pEnd--;` |
|   121358 | 1576 | `	SXUNUSED(iCompileFlag);` |
|   242721 | 1577 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1578 | `}` |
|        - | 1579 | `/*` |
