...
|        - |   44 | ` */` |
|  3819446 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3819451 |   48 | `	const char *z = pRaw->zString;` |
|  3819451 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3819451 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3819451 |   52 | `	if( n < 2 ) return 0;` |
...
|        - |   85 | ` */` |
|  3819446 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3819451 |   88 | `	const char *zBad = 0;` |
|  3819451 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3819451 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3819437 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3819432 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3819437 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3819437 |  128 | `	*pzAlloc = 0;` |
|  9091507 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5272329 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2636040 |  131 | `	}` |
|  3819437 |  132 | `	if( !hasUnderscore ){` |
|  3819183 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3819183 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3810702 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3810707 |  189 | `	const char *z = pNum->zString;` |
|  3810707 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3810707 |  193 | `	*pbDecimal = FALSE;` |
|  3810707 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3810707 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3706019 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3705737 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  5591805 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
...
|  1905356 |  271 | `}` |
|  3819418 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3819423 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3819423 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3819423 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1909709 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3819423 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3819423 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5729117 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1909704 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3819413 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3819413 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3810707 |  293 | `		ph7_real rOverflow = 0;` |
|  3810707 |  294 | `		int bDecimalOverflow = 0;` |
|  3810707 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3810673 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3810673 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3810673 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3810673 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1905356 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
...
|        - |  332 | `	}` |
|  3819413 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3819413 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3819413 |  337 | `	return SXRET_OK;` |
|  1909714 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5553016 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5553021 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5553021 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5553021 |  359 | `	zIn  = pStr->zString;` |
|  5553021 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5553021 |  361 | `	if( zIn >= zEnd ){` |
...
|  5145997 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61491469 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56427019 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28172741 |  379 | `		}` |
|        - |  380 | `	}` |
|  5145997 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3002951 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3002951 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2143051 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2143051 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2143051 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2195457 |  397 | `	for(;;){` |
|  4390919 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2143051 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2247873 |  402 | `		zCur = zIn;` |
| 43435471 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41187603 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2247873 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2205179 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1102587 |  409 | `		}` |
|  2247873 |  410 | `		zIn++;` |
|  2247873 |  411 | `		if( zIn < zEnd ){` |
|   143613 |  412 | `			if( zIn[0] == '\\' ){` |
...
|  2143051 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2143051 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2061509 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1030752 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2143051 |  435 | `	return SXRET_OK;` |
|  2776513 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  602 | ` */` |
|     2308 |  603 | `static sxi32 GenStateProcessStringExpression(` |
...
|     2313 |  614 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|        - |  615 | `	/* Preallocate some slots */` |
|     2313 |  616 | `	SySetAlloc(&sToken,0x08);` |
|        - |  617 | `	/* Tokenize the text */` |
|     2313 |  618 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken,0);` |
|        - |  619 | `	/* Swap delimiter */` |
|     2313 |  620 | `	pTmpIn  = pGen->pIn;` |
|     2313 |  621 | `	pTmpEnd = pGen->pEnd;` |
|     2313 |  622 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     2313 |  623 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
...
|     2313 |  627 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD,0);` |
|        - |  628 | `	/* Restore token stream */` |
|     2313 |  629 | `	pGen->pIn  = pTmpIn;` |
|     2313 |  630 | `	pGen->pEnd = pTmpEnd;` |
|        - |  631 | `	/* Release the token set */` |
|     2313 |  632 | `	SySetRelease(&sToken);` |
...
|        - |  638 | ` */` |
|   126142 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126147 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126147 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126147 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126147 |  649 | `	(*pCount)++;` |
|   126147 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126147 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126147 |  653 | `	return pConstObj;` |
|    63076 |  654 | `}` |
|        - |  655 | `/*` |
...
|   124946 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   124951 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   124951 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 rc;` |
|        - |  724 | `	/* Delimit the string */` |
|   124951 |  725 | `	zIn  = pStr->zString;` |
|   124951 |  726 | `	zEnd = &zIn[pStr->nByte];` |
|   124951 |  727 | `	if( zIn >= zEnd ){` |
...
|    63406 |  738 | `	for(;;){` |
|   171119 |  739 | `		zCur = zIn;` |
|  1675733 |  740 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1506929 |  741 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       84 |  742 | `				break;` |
|  1506772 |  743 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2158 |  744 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1079 |  745 | `					break;` |
|        - |  746 | `			}` |
|  1504619 |  747 | `			zIn++;` |
|        5 |  748 | `		}` |
|   171119 |  749 | `		if( zIn > zCur ){` |
|    95559 |  750 | `			if( pObj == 0 ){` |
|    94905 |  751 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    94905 |  752 | `				if( pObj == 0 ){` |
|      ! 0 |  753 | `					return SXERR_ABORT;` |
|        - |  754 | `				}` |
|    47450 |  755 | `			}` |
|    95559 |  756 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47777 |  757 | `		}` |
|   171119 |  758 | `		if( zIn >= zEnd ){` |
|   124507 |  759 | `			break;` |
|        - |  760 | `		}` |
|    46617 |  761 | `		if( zIn[0] == '\\' ){` |
|    44307 |  762 | `			const char *zPtr = 0;` |
|        - |  763 | `			sxu32 n;` |
|    44307 |  764 | `			zIn++;` |
|    44307 |  765 | `			if( pObj == 0 ){` |
...
|    39277 |  796 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39277 |  797 | `				break;` |
|       27 |  798 | `			case 'r':` |
...
|       84 |  955 | `		}else{` |
|        - |  956 | `			/* Simple syntax */` |
|     2153 |  957 | `			const char *zExpr = zIn;` |
|        - |  958 | `			/* Assemble variable name */` |
|     1099 |  959 | `			for(;;){` |
|        - |  960 | `				/* Jump leading dollars */` |
|     4351 |  961 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|     2153 |  962 | `					zIn++;` |
|        5 |  963 | `				}` |
|     1099 |  964 | `				for(;;){` |
|    10410 |  965 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|     7113 |  966 | `						zIn++;` |
|        5 |  967 | `					}` |
|     2203 |  968 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|        - |  969 | `						/* UTF-8 stream */` |
|      ! 0 |  970 | `						zIn++;` |
...
|        1 | 1015 | `					}` |
|        3 | 1016 | `					break;` |
|     1917 | 1017 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|        - | 1018 | `					/* Member access operator '->' */` |
|       53 | 1019 | `					zIn += 2;` |
|     1892 | 1020 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|        - | 1034 | `			 */` |
|        - | 1035 | `			{` |
|     2153 | 1036 | `				const char *zBr = zExpr;` |
|    11521 | 1037 | `				while( zBr < zIn && zBr[0] != '[' ){` |
|     9373 | 1038 | `					zBr++;` |
|        5 | 1039 | `				}` |
|     2153 | 1040 | `				if( zBr < zIn && zIn[-1] == ']' ){` |
...
|        - | 1079 | `			 */` |
|     2151 | 1080 | `			if( &zExpr[1] < zIn && zExpr[0] == '$' && zExpr[1] == '{' ){` |
...
|     2149 | 1086 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|     2149 | 1087 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1088 | `				return SXERR_ABORT;` |
|        - | 1089 | `			}` |
|     2149 | 1090 | `			if( rc != SXERR_EMPTY ){` |
|     2149 | 1091 | `				++iCons;` |
|     1072 | 1092 | `			}` |
|        - | 1093 | `		}` |
...
|     2311 | 1095 | `		pObj = 0;` |
|        5 | 1096 | `	}/*for(;;)*/` |
|   124509 | 1097 | `	if( iCons > 1 ){` |
|        - | 1098 | `		/* Concatenate all compiled constants */` |
|     1587 | 1099 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|      791 | 1100 | `	}` |
|        - | 1101 | `	/* Node successfully compiled */` |
|   124509 | 1102 | `	return SXRET_OK;` |
|    62478 | 1103 | `}` |
|        - | 1104 | `/*` |
|        - | 1105 | ` * Compile a double quoted string.` |
|        - | 1106 | ` *  See the block-comment above for more information.` |
|        - | 1107 | ` */` |
|   124882 | 1108 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1109 | `{` |
|        - | 1110 | `	sxi32 rc;` |
|   124887 | 1111 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62441 | 1112 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1113 | `	/* Compilation result */` |
|   124887 | 1114 | `	return rc;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|        - | 1157 | ` */` |
|  1563348 | 1158 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1563353 | 1169 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1170 | `	/* Compile the expression*/` |
|  1563353 | 1171 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1172 | `	/* Restore token stream */` |
|  1563353 | 1173 | `	RE_SWAP_DELIMITER(pGen);` |
|  1563353 | 1174 | `	return rc;` |
|        5 | 1175 | `}` |
|        - | 1176 | `/*` |
...
|        - | 1212 | ` */` |
|  1488454 | 1213 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1214 | `{` |
|  1488459 | 1215 | `	SyToken *pCur = pStart;` |
|  1488459 | 1216 | `	sxi32 iNest = 0;` |
|  3802501 | 1217 | `	while( pCur < pEnd ){` |
|  2851179 | 1218 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   537133 | 1219 | `			return pCur;` |
|        - | 1220 | `		}` |
...
|        - | 1224 | `		 */` |
|  2314051 | 1225 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
...
|        - | 1284 | `			}` |
|    11672 | 1285 | `		}` |
|  2314045 | 1286 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    54891 | 1287 | `			iNest++;` |
|  2286602 | 1288 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|   580956 | 1316 | `		{` |
|  1832591 | 1317 | `			int nSkip = 0;` |
|  2719741 | 1318 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   887155 | 1319 | `				nSkip++;` |
|   887155 | 1320 | `				pGen->pIn++;` |
|        5 | 1321 | `			}` |
|  1832591 | 1322 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1329 | `			}` |
|        - | 1330 | `		}` |
|  1832591 | 1331 | `		pCur = pGen->pIn;` |
|  1832591 | 1332 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1333 | `			/* No more entry to process */` |
|   670661 | 1334 | `			break;` |
|        - | 1335 | `		}` |
|  1161935 | 1336 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1337 | `			continue;` |
|        - | 1338 | `		}` |
|        - | 1339 | `		/* Compile the key if available */` |
|  1161935 | 1340 | `		pKey = pCur;` |
|  1161935 | 1341 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1161935 | 1342 | `		rc = SXERR_EMPTY;` |
|  1161935 | 1343 | `		if( pCur < pGen->pIn ){` |
|   401161 | 1344 | `			if( pKey == pCur ){` |
...
|        - | 1357 | `			}` |
|   401159 | 1358 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   401149 | 1369 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1370 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   401149 | 1371 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1372 | `				return SXERR_ABORT;` |
|        - | 1373 | `			}` |
|   401149 | 1374 | `			pCur++; /* Jump the '=>' operator */` |
|   200577 | 1375 | `		}else{` |
|        - | 1376 | `			/* Reset back the cursor and point to the entry value */` |
|   760779 | 1377 | `			pCur = pKey;` |
|        - | 1378 | `		}` |
|  1161923 | 1379 | `		if( rc == SXERR_EMPTY ){` |
...
|   760779 | 1382 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   380387 | 1383 | `		}` |
|  1161923 | 1384 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1161921 | 1403 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1161921 | 1404 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1742873 | 1421 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   580956 | 1422 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1423 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   580956 | 1424 | `			xValidator);` |
|  1161917 | 1425 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1426 | `			return SXERR_ABORT;` |
|        - | 1427 | `		}` |
|  1161917 | 1428 | `		if( iSpread ){` |
...
|  1161882 | 1431 | `		}else if( iEmitRef ){` |
|        - | 1432 | `			/* Emit the load reference instruction */` |
|       40 | 1433 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1434 | `		}` |
|  1161917 | 1435 | `		xValidator = 0;` |
|  1161917 | 1436 | `		iEmitRef = 0;` |
|  1161917 | 1437 | `		iSpread = 0;` |
|  1161917 | 1438 | `		nPair++;` |
|        5 | 1439 | `	}` |
