...
|        - |   44 | ` */` |
|  3819442 |   45 | `static int GenStateFindBadNumericSeparator(` |
|        - |   46 | `	const SyString *pRaw, const char **pBadStart, sxu32 *pBadLen)` |
|        5 |   47 | `{` |
|  3819447 |   48 | `	const char *z = pRaw->zString;` |
|  3819447 |   49 | `	sxu32 n = pRaw->nByte;` |
|  3819447 |   50 | `	int base = 10;` |
|        - |   51 | `	sxu32 i, start;` |
|  3819447 |   52 | `	if( n < 2 ) return 0;` |
|   804577 |   53 | `	if( z[0] == '0' && (z[1] == 'x' \|\| z[1] == 'X') ){` |
|   104695 |   54 | `		base = 16;` |
|   752232 |   55 | `	}else if( z[0] == '0' && (z[1] == 'b' \|\| z[1] == 'B') ){` |
|      286 |   56 | `		base = 2;` |
|      142 |   57 | `	}` |
|  3063849 |   58 | `	for( i = 0; i < n; ++i ){` |
|  2259291 |   59 | `		if( z[i] != '_' ) continue;` |
|      548 |   60 | `		if( i > 0 && i + 1 < n` |
...
|        - |   85 | ` */` |
|  3819442 |   86 | `PH7_PRIVATE sxi32 GenStateValidateNumericSeparator(ph7_gen_state *pGen, SyToken *pToken)` |
|        5 |   87 | `{` |
|  3819447 |   88 | `	const char *zBad = 0;` |
|  3819447 |   89 | `	sxu32 nBad = 0;` |
|        - |   90 | `	SyString sBad;` |
|        - |   91 | `	sxi32 rc;` |
|  3819447 |   92 | `	if( !GenStateFindBadNumericSeparator(&pToken->sData, &zBad, &nBad) ){` |
|  3819433 |   93 | `		return SXRET_OK;` |
|        - |   94 | `	}` |
...
|        - |  118 | ` */` |
|  3819428 |  119 | `PH7_PRIVATE sxi32 GenStateStripNumericSeparators(` |
...
|        5 |  124 | `{` |
|        - |  125 | `	sxu32 i, j;` |
|  3819433 |  126 | `	int hasUnderscore = 0;` |
|        - |  127 | `	char *zBuf;` |
|  3819433 |  128 | `	*pzAlloc = 0;` |
|  9091499 |  129 | `	for( i = 0; i < pToken->nByte; ++i ){` |
|  5272325 |  130 | `		if( pToken->zString[i] == '_' ){ hasUnderscore = 1; break; }` |
|  2636038 |  131 | `	}` |
|  3819433 |  132 | `	if( !hasUnderscore ){` |
|  3819179 |  133 | `		SyStringDupPtr(pOut, pToken);` |
|  3819179 |  134 | `		return SXRET_OK;` |
|        - |  135 | `	}` |
...
|        - |  186 | ` */` |
|  3810698 |  187 | `static int GenStateIntLiteralOverflows(const SyString *pNum, ph7_real *pReal, int *pbDecimal)` |
|        5 |  188 | `{` |
|  3810703 |  189 | `	const char *z = pNum->zString;` |
|  3810703 |  190 | `	const char *zEnd = z + pNum->nByte;` |
|        - |  191 | `	const char *p, *q;` |
|        - |  192 | `	int n;` |
|  3810703 |  193 | `	*pbDecimal = FALSE;` |
|  3810703 |  194 | `	if( z >= zEnd ){` |
|      ! 0 |  195 | `		return FALSE;` |
|        - |  196 | `	}` |
|  3810703 |  197 | `	if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'x' \|\| z[1] == 'X') ){` |
...
|        - |  210 | `		}` |
|        7 |  211 | `		return TRUE;` |
|  3706015 |  212 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'b' \|\| z[1] == 'B') ){` |
...
|        - |  225 | `		}` |
|        3 |  226 | `		return TRUE;` |
|  3705733 |  227 | `	}else if( z[0] == '0' && (z + 1) < zEnd && (z[1] == 'o' \|\| z[1] == 'O') ){` |
...
|  1393203 |  246 | `		p = z;` |
|  2786403 |  247 | `		while( p < zEnd && p[0] == '0' ){ p++; }` |
|  1405081 |  248 | `		for( q = p, n = 0; q < zEnd && q[0] >= '0' && q[0] <= '7'; q++ ){ n++; }` |
|  1393203 |  249 | `		if( n <= 21 ){` |
|  1393201 |  250 | `			return FALSE;` |
|        - |  251 | `		}` |
|        3 |  252 | `		{ ph7_real dv = 0;` |
...
|  2312519 |  263 | `	p = z;` |
|  2312519 |  264 | `	while( p < zEnd && p[0] == '0' ){ p++; }` |
|  5591797 |  265 | `	for( q = p, n = 0; q < zEnd && (unsigned char)q[0] < 0xc0 && SyisDigit(q[0]); q++ ){ n++; }` |
|  2312519 |  266 | `	if( n > 19 \|\| (n == 19 && SyMemcmp(p, "9223372036854775807", 19) > 0) ){` |
|       25 |  267 | `		*pbDecimal = TRUE;` |
|       25 |  268 | `		return TRUE;` |
|        - |  269 | `	}` |
|  2312495 |  270 | `	return FALSE;` |
|  1905354 |  271 | `}` |
|  3819414 |  272 | `PH7_PRIVATE sxi32 PH7_CompileNumLiteral(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  273 | `{` |
|  3819419 |  274 | `	SyToken *pToken = pGen->pIn; /* Raw token */` |
|  3819419 |  275 | `	sxu32 nIdx = 0;` |
|        - |  276 | `	char zScratch[GEN_NUM_SCRATCH];` |
|  3819419 |  277 | `	char *zAlloc = 0;` |
|        - |  278 | `	SyString sNum;` |
|        - |  279 | `	sxi32 rc;` |
|  1909707 |  280 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|  3819419 |  281 | `	rc = GenStateValidateNumericSeparator(pGen, pToken);` |
|  3819419 |  282 | `	if( rc != SXRET_OK ){` |
|       14 |  283 | `		return rc;` |
|        - |  284 | `	}` |
|  5729111 |  285 | `	rc = GenStateStripNumericSeparators(&pGen->pVm->sAllocator, &pToken->sData,` |
|  1909702 |  286 | `		zScratch, sizeof(zScratch), &sNum, &zAlloc);` |
|  3819409 |  287 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  288 | `		return SXERR_ABORT;` |
|        - |  289 | `	}` |
|  3819409 |  290 | `	if( pToken->nType & PH7_TK_INTEGER ){` |
|        - |  291 | `		ph7_value *pObj;` |
|        - |  292 | `		sxi64 iValue;` |
|  3810703 |  293 | `		ph7_real rOverflow = 0;` |
|  3810703 |  294 | `		int bDecimalOverflow = 0;` |
|  3810703 |  295 | `		if( GenStateIntLiteralOverflows(&sNum,&rOverflow,&bDecimalOverflow) ){` |
...
|        - |  310 | `			}` |
|       18 |  311 | `		}else{` |
|  3810669 |  312 | `			iValue = PH7_TokenValueToInt64(&sNum);` |
|  3810669 |  313 | `			pObj = GenStateInstallNumLiteral(&(*pGen),&nIdx);` |
|  3810669 |  314 | `			if( pObj == 0 ){` |
|      ! 0 |  315 | `				if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|      ! 0 |  316 | `				return SXERR_ABORT;` |
|        - |  317 | `			}` |
|  3810669 |  318 | `			PH7_MemObjInitFromInt(pGen->pVm,pObj,iValue);` |
|        - |  319 | `		}` |
|  1905354 |  320 | `	}else{` |
|        - |  321 | `		/* Real number */` |
|        - |  322 | `		ph7_value *pObj;` |
...
|        - |  332 | `	}` |
|  3819409 |  333 | `	if( zAlloc ){ SyMemBackendFree(&pGen->pVm->sAllocator, zAlloc); }` |
|        - |  334 | `	/* Emit the load constant instruction */` |
|  3819409 |  335 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|        - |  336 | `	/* Node successfully compiled */` |
|  3819409 |  337 | `	return SXRET_OK;` |
|  1909712 |  338 | `}` |
|        - |  339 | `/*` |
...
|        - |  348 | ` *` |
|        - |  349 | ` */` |
|  5552920 |  350 | `PH7_PRIVATE sxi32 PH7_CompileSimpleString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 |  351 | `{` |
|  5552925 |  352 | `	SyString *pStr = &pGen->pIn->sData; /* Constant string literal */` |
|        - |  353 | `	const char *zIn,*zCur,*zEnd;` |
|        - |  354 | `	ph7_value *pObj;` |
|        - |  355 | `	sxu32 nIdx;` |
|        - |  356 | `	sxi32 bHasEsc;` |
|  5552925 |  357 | `	nIdx = 0; /* Prevent compiler warning */` |
|        - |  358 | `	/* Delimit the string */` |
|  5552925 |  359 | `	zIn  = pStr->zString;` |
|  5552925 |  360 | `	zEnd = &zIn[pStr->nByte];` |
|  5552925 |  361 | `	if( zIn >= zEnd ){` |
|        - |  362 | `		/* Empty string constant: just use the pre‑allocated index from the VM` |
|        - |  363 | `		 * rather than reserving a new object each time. */` |
|   407001 |  364 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,pGen->pVm->nEmptyStringIdx,0,0);` |
|   407001 |  365 | `		return SXRET_OK;` |
|        - |  366 | `	}` |
...
|  5145929 |  374 | `	bHasEsc = 0;` |
|        - |  375 | `	{` |
|        - |  376 | `		const char *zScan;` |
| 61490849 |  377 | `		for( zScan = zIn ; zScan < zEnd ; zScan++ ){` |
| 56426463 |  378 | `			if( zScan[0] == '\\' ){ bHasEsc = 1; break; }` |
| 28172465 |  379 | `		}` |
|        - |  380 | `	}` |
|  5145929 |  381 | `	if( !bHasEsc && SXRET_OK == GenStateFindLiteral(&(*pGen),pStr,&nIdx) ){` |
|        - |  382 | `		/* Already processed,emit the load constant instruction` |
|        - |  383 | `		 * and return.` |
|        - |  384 | `		 */` |
|  3002911 |  385 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  3002911 |  386 | `		return SXRET_OK;` |
|        - |  387 | `	}` |
|        - |  388 | `	/* Reserve a new constant */` |
|  2143023 |  389 | `	pObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|  2143023 |  390 | `	if( pObj == 0 ){` |
...
|        - |  394 | `	}` |
|  2143023 |  395 | `	PH7_MemObjInitFromString(pGen->pVm,pObj,0);` |
|        - |  396 | `	/* Compile the node */` |
|  2195427 |  397 | `	for(;;){` |
|  4390859 |  398 | `		if( zIn >= zEnd ){` |
|        - |  399 | `			/* End of input */` |
|  2143023 |  400 | `			break;` |
|        - |  401 | `		}` |
|  2247841 |  402 | `		zCur = zIn;` |
| 43435055 |  403 | `		while( zIn < zEnd && zIn[0] != '\\' ){` |
| 41187219 |  404 | `			zIn++;` |
|        5 |  405 | `		}` |
|  2247841 |  406 | `		if( zIn > zCur ){` |
|        - |  407 | `			/* Append raw contents*/` |
|  2205151 |  408 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|  1102573 |  409 | `		}` |
|  2247841 |  410 | `		zIn++;` |
|  2247841 |  411 | `		if( zIn < zEnd ){` |
|   143609 |  412 | `			if( zIn[0] == '\\' ){` |
|        - |  413 | `				/* A literal backslash */` |
|    34941 |  414 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|   126141 |  415 | `			}else if( zIn[0] == '\'' ){` |
|        - |  416 | `				/* A single quote */` |
...
|  2143023 |  429 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|  2143023 |  430 | `	if( !bHasEsc && pStr->nByte < 1024 ){` |
|        - |  431 | `		/* Install in the literal table (only when value == source; see above) */` |
|  2061485 |  432 | `		GenStateInstallLiteral(pGen,pObj,nIdx);` |
|  1030740 |  433 | `	}` |
|        - |  434 | `	/* Node successfully compiled */` |
|  2143023 |  435 | `	return SXRET_OK;` |
|  2776465 |  436 | `}` |
|        - |  437 | `/*` |
...
|        - |  602 | ` */` |
|     2304 |  603 | `static sxi32 GenStateProcessStringExpression(` |
...
|     2309 |  614 | `	SySetInit(&sToken,&pGen->pVm->sAllocator,sizeof(SyToken));` |
|        - |  615 | `	/* Preallocate some slots */` |
|     2309 |  616 | `	SySetAlloc(&sToken,0x08);` |
|        - |  617 | `	/* Tokenize the text */` |
|     2309 |  618 | `	PH7_TokenizePHP(zIn,(sxu32)(zEnd-zIn),nLine,&sToken,0);` |
|        - |  619 | `	/* Swap delimiter */` |
|     2309 |  620 | `	pTmpIn  = pGen->pIn;` |
|     2309 |  621 | `	pTmpEnd = pGen->pEnd;` |
|     2309 |  622 | `	pGen->pIn = (SyToken *)SySetBasePtr(&sToken);` |
|     2309 |  623 | `	pGen->pEnd = &pGen->pIn[SySetUsed(&sToken)];` |
...
|     2309 |  627 | `	rc = PH7_CompileExpr(&(*pGen),EXPR_FLAG_RDONLY_LOAD,0);` |
|        - |  628 | `	/* Restore token stream */` |
|     2309 |  629 | `	pGen->pIn  = pTmpIn;` |
|     2309 |  630 | `	pGen->pEnd = pTmpEnd;` |
|        - |  631 | `	/* Release the token set */` |
|     2309 |  632 | `	SySetRelease(&sToken);` |
...
|        - |  638 | ` */` |
|   126126 |  639 | `static ph7_value * GenStateNewStrObj(ph7_gen_state *pGen,sxi32 *pCount)` |
|        5 |  640 | `{` |
|        - |  641 | `	ph7_value *pConstObj;` |
|   126131 |  642 | `	sxu32 nIdx = 0;` |
|        - |  643 | `	/* Reserve a new constant */` |
|   126131 |  644 | `	pConstObj = PH7_ReserveConstObj(pGen->pVm,&nIdx);` |
|   126131 |  645 | `	if( pConstObj == 0 ){` |
|      ! 0 |  646 | `		PH7_GenCompileError(&(*pGen),E_ERROR,pGen->pIn->nLine,"PH7 engine is running out of memory");` |
|      ! 0 |  647 | `		return 0;` |
|        - |  648 | `	}` |
|   126131 |  649 | `	(*pCount)++;` |
|   126131 |  650 | `	PH7_MemObjInitFromString(pGen->pVm,pConstObj,0);` |
|        - |  651 | `	/* Emit the load constant instruction */` |
|   126131 |  652 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,0,nIdx,0,0);` |
|   126131 |  653 | `	return pConstObj;` |
|    63068 |  654 | `}` |
|        - |  655 | `/*` |
...
|   124934 |  717 | `static sxi32 GenStateCompileString(ph7_gen_state *pGen,int bHeredoc)` |
|        5 |  718 | `{` |
|   124939 |  719 | `	SyString *pStr = &pGen->pIn->sData; /* Raw token value */` |
|        - |  720 | `	const char *zIn,*zCur,*zEnd;` |
|   124939 |  721 | `	ph7_value *pObj = 0;` |
|        - |  722 | `	sxi32 iCons;` |
|        - |  723 | `	sxi32 rc;` |
|        - |  724 | `	/* Delimit the string */` |
|   124939 |  725 | `	zIn  = pStr->zString;` |
|   124939 |  726 | `	zEnd = &zIn[pStr->nByte];` |
|   124939 |  727 | `	if( zIn >= zEnd ){` |
...
|    63398 |  738 | `	for(;;){` |
|   171095 |  739 | `		zCur = zIn;` |
|  1675549 |  740 | `		while( zIn < zEnd && zIn[0] != '\\'  ){` |
|  1506765 |  741 | `			if( zIn[0] == '{' && &zIn[1] < zEnd && zIn[1] == '$' ){` |
|       84 |  742 | `				break;` |
|  1506608 |  743 | `			}else if(zIn[0] == '$' && &zIn[1] < zEnd &&` |
|     2154 |  744 | `				(((unsigned char)zIn[1] >= 0xc0 \|\| SyisAlpha(zIn[1]) \|\| zIn[1] == '{' \|\| zIn[1] == '_')) ){` |
|     1077 |  745 | `					break;` |
|        - |  746 | `			}` |
|  1504459 |  747 | `			zIn++;` |
|        5 |  748 | `		}` |
|   171095 |  749 | `		if( zIn > zCur ){` |
|    95543 |  750 | `			if( pObj == 0 ){` |
|    94889 |  751 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    94889 |  752 | `				if( pObj == 0 ){` |
|      ! 0 |  753 | `					return SXERR_ABORT;` |
|        - |  754 | `				}` |
|    47442 |  755 | `			}` |
|    95543 |  756 | `			PH7_MemObjStringAppend(pObj,zCur,(sxu32)(zIn-zCur));` |
|    47769 |  757 | `		}` |
|   171095 |  758 | `		if( zIn >= zEnd ){` |
|   124495 |  759 | `			break;` |
|        - |  760 | `		}` |
|    46605 |  761 | `		if( zIn[0] == '\\' ){` |
|    44299 |  762 | `			const char *zPtr = 0;` |
|        - |  763 | `			sxu32 n;` |
|    44299 |  764 | `			zIn++;` |
|    44299 |  765 | `			if( pObj == 0 ){` |
|    31247 |  766 | `				pObj = GenStateNewStrObj(&(*pGen),&iCons);` |
|    31247 |  767 | `				if( pObj == 0 ){` |
|      ! 0 |  768 | `					return SXERR_ABORT;` |
|        - |  769 | `				}` |
|    15621 |  770 | `			}` |
|    44299 |  771 | `			if( zIn >= zEnd ){` |
|        - |  772 | `				/* Lone backslash at the very end of the body: php keeps it */` |
|        3 |  773 | `				PH7_MemObjStringAppend(pObj,"\\",sizeof(char));` |
|        3 |  774 | `				break;` |
|        - |  775 | `			}` |
|    44297 |  776 | `			n = sizeof(char); /* size of conversion */` |
|    44297 |  777 | `			switch( zIn[0] ){` |
|       17 |  778 | `			case '$':` |
|        - |  779 | `				/* Dollar sign */` |
...
|    39269 |  796 | `				PH7_MemObjStringAppend(pObj,"\n",sizeof(char));` |
|    39269 |  797 | `				break;` |
|       27 |  798 | `			case 'r':` |
...
|     3943 |  804 | `				PH7_MemObjStringAppend(pObj,"\t",sizeof(char));` |
|     3943 |  805 | `				break;` |
|        3 |  806 | `			case 'v':` |
...
|        - |  842 | `			}` |
|      234 |  843 | `			case 'x':` |
|      702 |  844 | `				if( &zIn[1] < zEnd && SyisHex((unsigned char)zIn[1]) ){` |
|        - |  845 | `					/* \x[0-9A-Fa-f]{1,2}: a character in hexadecimal notation */` |
|      466 |  846 | `					int c = SyHexToint(zIn[1]);` |
|        - |  847 | `					char cOut;` |
|      466 |  848 | `					n += sizeof(char);` |
|      466 |  849 | `					if( &zIn[2] < zEnd && SyisHex((unsigned char)zIn[2]) ){` |
|      462 |  850 | `						c = (c << 4) + SyHexToint(zIn[2]);` |
|      462 |  851 | `						n += sizeof(char);` |
|      230 |  852 | `					}` |
|      466 |  853 | `					cOut = (char)c; /* value byte, independent of host endianness */` |
|      466 |  854 | `					PH7_MemObjStringAppend(pObj,&cOut,sizeof(char));` |
|      234 |  855 | `				}else{` |
...
|       84 |  955 | `		}else{` |
|        - |  956 | `			/* Simple syntax */` |
|     2149 |  957 | `			const char *zExpr = zIn;` |
|        - |  958 | `			/* Assemble variable name */` |
|     1097 |  959 | `			for(;;){` |
|        - |  960 | `				/* Jump leading dollars */` |
|     4343 |  961 | `				while( zIn < zEnd && zIn[0] == '$' ){` |
|     2149 |  962 | `					zIn++;` |
|        5 |  963 | `				}` |
|     1097 |  964 | `				for(;;){` |
|    10348 |  965 | `					while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_' ) ){` |
|     7057 |  966 | `						zIn++;` |
|        5 |  967 | `					}` |
|     2199 |  968 | `					if((unsigned char)zIn[0] >= 0xc0 ){` |
|        - |  969 | `						/* UTF-8 stream */` |
|      ! 0 |  970 | `						zIn++;` |
...
|        1 | 1015 | `					}` |
|        3 | 1016 | `					break;` |
|     1913 | 1017 | `				}else if( zIn[0] == '-' && &zIn[1] < zEnd && zIn[1] == '>' ){` |
|        - | 1018 | `					/* Member access operator '->' */` |
|       53 | 1019 | `					zIn += 2;` |
|     1888 | 1020 | `				}else if(zIn[0] == ':' && &zIn[1] < zEnd && zIn[1] == ':'){` |
...
|        - | 1034 | `			 */` |
|        - | 1035 | `			{` |
|     2149 | 1036 | `				const char *zBr = zExpr;` |
|    11457 | 1037 | `				while( zBr < zIn && zBr[0] != '[' ){` |
|     9313 | 1038 | `					zBr++;` |
|        5 | 1039 | `				}` |
|     2149 | 1040 | `				if( zBr < zIn && zIn[-1] == ']' ){` |
...
|        - | 1079 | `			 */` |
|     2147 | 1080 | `			if( &zExpr[1] < zIn && zExpr[0] == '$' && zExpr[1] == '{' ){` |
...
|     2145 | 1086 | `			rc = GenStateProcessStringExpression(&(*pGen),pGen->pIn->nLine,zExpr,zIn);` |
|     2145 | 1087 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1088 | `				return SXERR_ABORT;` |
|        - | 1089 | `			}` |
|     2145 | 1090 | `			if( rc != SXERR_EMPTY ){` |
|     2145 | 1091 | `				++iCons;` |
|     1070 | 1092 | `			}` |
|        - | 1093 | `		}` |
...
|     2307 | 1095 | `		pObj = 0;` |
|        5 | 1096 | `	}/*for(;;)*/` |
|   124497 | 1097 | `	if( iCons > 1 ){` |
|        - | 1098 | `		/* Concatenate all compiled constants */` |
|     1583 | 1099 | `		PH7_VmEmitInstr(pGen->pVm,PH7_OP_CAT,iCons,0,0,0);` |
|      789 | 1100 | `	}` |
|        - | 1101 | `	/* Node successfully compiled */` |
|   124497 | 1102 | `	return SXRET_OK;` |
|    62472 | 1103 | `}` |
|        - | 1104 | `/*` |
|        - | 1105 | ` * Compile a double quoted string.` |
|        - | 1106 | ` *  See the block-comment above for more information.` |
|        - | 1107 | ` */` |
|   124870 | 1108 | `PH7_PRIVATE sxi32 PH7_CompileString(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1109 | `{` |
|        - | 1110 | `	sxi32 rc;` |
|   124875 | 1111 | `	rc = GenStateCompileString(&(*pGen),0/*bHeredoc*/);` |
|    62435 | 1112 | `	SXUNUSED(iCompileFlag); /* cc warning */` |
|        - | 1113 | `	/* Compilation result */` |
|   124875 | 1114 | `	return rc;` |
|        5 | 1115 | `}` |
|        - | 1116 | `/*` |
...
|        - | 1157 | ` */` |
|  1563352 | 1158 | `PH7_PRIVATE sxi32 GenStateCompileArrayEntry(` |
...
|  1563357 | 1169 | `	SWAP_DELIMITER(pGen,pIn,pEnd);` |
|        - | 1170 | `	/* Compile the expression*/` |
|  1563357 | 1171 | `	rc = PH7_CompileExpr(&(*pGen),iFlags,xValidator);` |
|        - | 1172 | `	/* Restore token stream */` |
|  1563357 | 1173 | `	RE_SWAP_DELIMITER(pGen);` |
|  1563357 | 1174 | `	return rc;` |
|        5 | 1175 | `}` |
|        - | 1176 | `/*` |
...
|        - | 1212 | ` */` |
|  1488462 | 1213 | `PH7_PRIVATE SyToken * GenStateFindTopLevelArrow(SyToken *pStart,SyToken *pEnd)` |
|        5 | 1214 | `{` |
|  1488467 | 1215 | `	SyToken *pCur = pStart;` |
|  1488467 | 1216 | `	sxi32 iNest = 0;` |
|  3802517 | 1217 | `	while( pCur < pEnd ){` |
|  2851183 | 1218 | `		if( (pCur->nType & PH7_TK_ARRAY_OP) && iNest <= 0 ){` |
|   537129 | 1219 | `			return pCur;` |
|        - | 1220 | `		}` |
...
|        - | 1224 | `		 */` |
|  2314059 | 1225 | `		if( iNest == 0 && (pCur->nType & PH7_TK_KEYWORD) ){` |
|    23355 | 1226 | `			sxu32 nKw = (sxu32)SX_PTR_TO_INT(pCur->pUserData);` |
|    23355 | 1227 | `			SyToken *pFn = pCur;` |
|    23350 | 1228 | `			if( nKw == PH7_TKWRD_STATIC && &pCur[1] < pEnd` |
|      ! 0 | 1229 | `				&& (pCur[1].nType & PH7_TK_KEYWORD)` |
|        5 | 1230 | `				&& SX_PTR_TO_INT(pCur[1].pUserData) == PH7_TKWRD_FN ){` |
|      ! 0 | 1231 | `				pFn = &pCur[1];` |
|      ! 0 | 1232 | `				nKw = PH7_TKWRD_FN;` |
|      ! 0 | 1233 | `			}` |
|    23355 | 1234 | `			if( nKw == PH7_TKWRD_FN ){` |
...
|    23351 | 1265 | `			if( nKw == PH7_TKWRD_MATCH ){` |
...
|        - | 1284 | `			}` |
|    11672 | 1285 | `		}` |
|  2314053 | 1286 | `		if( pCur->nType & (PH7_TK_LPAREN/*'('*/\|PH7_TK_OSB/*'['*/\|PH7_TK_OCB/*'{'*/) ){` |
|    54891 | 1287 | `			iNest++;` |
|  2286610 | 1288 | `		}else if( pCur->nType & (PH7_TK_RPAREN/*')'*/\|PH7_TK_CSB/*']'*/\|PH7_TK_CCB/*'}'*/) ){` |
...
|        - | 1301 | ` */` |
|   670674 | 1302 | `static sxi32 GenStateCompileArrayBody(ph7_gen_state *pGen)` |
|        5 | 1303 | `{` |
|        - | 1304 | `	sxi32 (*xValidator)(ph7_gen_state *,ph7_expr_node *); /* Expression tree validator callback */` |
|        - | 1305 | `	SyToken *pKey,*pCur;` |
|   670679 | 1306 | `	sxi32 iEmitRef = 0;` |
|   670679 | 1307 | `	sxi32 iSpread = 0;` |
|   670679 | 1308 | `	sxi32 nPair = 0;` |
|        - | 1309 | `	sxi32 rc;` |
|   670679 | 1310 | `	xValidator = 0;` |
|   916297 | 1311 | `	for(;;){` |
...
|   580960 | 1316 | `		{` |
|  1832599 | 1317 | `			int nSkip = 0;` |
|  2719757 | 1318 | `			while( pGen->pIn < pGen->pEnd && (pGen->pIn->nType & PH7_TK_COMMA) ){` |
|   887163 | 1319 | `				nSkip++;` |
|   887163 | 1320 | `				pGen->pIn++;` |
|        5 | 1321 | `			}` |
|  1832599 | 1322 | `			if( nSkip > 1 \|\| (nSkip > 0 && nPair < 1) ){` |
...
|        - | 1329 | `			}` |
|        - | 1330 | `		}` |
|  1832599 | 1331 | `		pCur = pGen->pIn;` |
|  1832599 | 1332 | `		if( SXRET_OK != PH7_GetNextExpr(pGen->pIn,pGen->pEnd,&pGen->pIn) ){` |
|        - | 1333 | `			/* No more entry to process */` |
|   670661 | 1334 | `			break;` |
|        - | 1335 | `		}` |
|  1161943 | 1336 | `		if( pCur >= pGen->pIn ){` |
|      ! 0 | 1337 | `			continue;` |
|        - | 1338 | `		}` |
|        - | 1339 | `		/* Compile the key if available */` |
|  1161943 | 1340 | `		pKey = pCur;` |
|  1161943 | 1341 | `		pCur = GenStateFindTopLevelArrow(pCur,pGen->pIn);` |
|  1161943 | 1342 | `		rc = SXERR_EMPTY;` |
|  1161943 | 1343 | `		if( pCur < pGen->pIn ){` |
|   401157 | 1344 | `			if( pKey == pCur ){` |
...
|        - | 1357 | `			}` |
|   401155 | 1358 | `			if( &pCur[1] >= pGen->pIn ){` |
...
|   401145 | 1369 | `			rc = GenStateCompileArrayEntry(&(*pGen),pKey,pCur,` |
|        - | 1370 | `				EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,0);` |
|   401145 | 1371 | `			if( rc == SXERR_ABORT ){` |
|      ! 0 | 1372 | `				return SXERR_ABORT;` |
|        - | 1373 | `			}` |
|   401145 | 1374 | `			pCur++; /* Jump the '=>' operator */` |
|   200575 | 1375 | `		}else{` |
|        - | 1376 | `			/* Reset back the cursor and point to the entry value */` |
|   760791 | 1377 | `			pCur = pKey;` |
|        - | 1378 | `		}` |
|  1161931 | 1379 | `		if( rc == SXERR_EMPTY ){` |
...
|   760791 | 1382 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOADC,PH7_LOADC_NOKEY,0 /* nil index */,0,0);` |
|   380393 | 1383 | `		}` |
|  1161931 | 1384 | `		if( pCur->nType & PH7_TK_AMPER /*'&'*/){` |
...
|  1161929 | 1403 | `		iSpread = (pCur < pGen->pIn && (pCur->nType & PH7_TK_ELLIPSIS)) ? 1 : 0;` |
|  1161929 | 1404 | `		if( iSpread && (rc != SXERR_EMPTY \|\| iEmitRef) ){` |
...
|  1742885 | 1421 | `		rc = GenStateCompileArrayEntry(&(*pGen),pCur,pGen->pIn,` |
|   580960 | 1422 | `			iEmitRef ? EXPR_FLAG_LOAD_IDX_STORE` |
|        - | 1423 | `			         : EXPR_FLAG_RDONLY_LOAD/*Do not create the variable if inexistant*/,` |
|   580960 | 1424 | `			xValidator);` |
|  1161925 | 1425 | `		if( rc == SXERR_ABORT ){` |
|      ! 0 | 1426 | `			return SXERR_ABORT;` |
|        - | 1427 | `		}` |
|  1161925 | 1428 | `		if( iSpread ){` |
...
|  1161890 | 1431 | `		}else if( iEmitRef ){` |
|        - | 1432 | `			/* Emit the load reference instruction */` |
|       40 | 1433 | `			PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_REF,0,0,0,0);` |
|       18 | 1434 | `		}` |
|  1161925 | 1435 | `		xValidator = 0;` |
|  1161925 | 1436 | `		iEmitRef = 0;` |
|  1161925 | 1437 | `		iSpread = 0;` |
|  1161925 | 1438 | `		nPair++;` |
|        5 | 1439 | `	}` |
|        - | 1440 | `	/* Emit the load map instruction */` |
|   670661 | 1441 | `	PH7_VmEmitInstr(pGen->pVm,PH7_OP_LOAD_MAP,nPair * 2,0,0,0);` |
|        - | 1442 | `	/* Node successfully compiled */` |
|   670661 | 1443 | `	return SXRET_OK;` |
|   335342 | 1444 | `}` |
|        - | 1445 | `/*` |
...
|        - | 1453 | ` */` |
|   427960 | 1454 | `PH7_PRIVATE sxi32 PH7_CompileArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1455 | `{` |
|        - | 1456 | `	/* Jump the 'array' keyword and the leading '(', exclude trailing ')'. */` |
|   427965 | 1457 | `	pGen->pIn += 2;` |
|   427965 | 1458 | `	pGen->pEnd--;` |
|   213980 | 1459 | `	SXUNUSED(iCompileFlag);` |
|   427965 | 1460 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1461 | `}` |
|        - | 1462 | `/*` |
...
|        - | 1558 | ` */` |
|   242714 | 1559 | `PH7_PRIVATE sxi32 PH7_CompileShortArray(ph7_gen_state *pGen,sxi32 iCompileFlag)` |
|        5 | 1560 | `{` |
|        - | 1561 | `	/* Jump the leading '[', exclude trailing ']'. */` |
|   242719 | 1562 | `	pGen->pIn++;` |
|   242719 | 1563 | `	pGen->pEnd--;` |
|   121357 | 1564 | `	SXUNUSED(iCompileFlag);` |
|   242719 | 1565 | `	return GenStateCompileArrayBody(pGen);` |
|        5 | 1566 | `}` |
|        - | 1567 | `/*` |
