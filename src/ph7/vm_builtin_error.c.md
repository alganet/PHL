...
|    5 |  178 | `{` |
|  101 |  179 | `	ph7_vm *pVm = pCtx->pVm;` |
|    - |  180 | `	int nOld;` |
|    - |  181 | `	/* Extract the old reporting level */` |
|  101 |  182 | `	nOld = pVm->bErrReport ? (int)pVm->iErrMask : 0;` |
|  101 |  183 | `	if( pVm->nErrSuppress > 0 ){` |
...
|   35 |  194 | `		nNew = ph7_value_to_int(apArg[0]);` |
|   35 |  195 | `		pVm->iErrMask = (sxi32)nNew;` |
|   35 |  196 | `		pVm->bErrReport = nNew != 0;` |
|   15 |  197 | `	}` |
|    - |  198 | `	/* Return the old level */` |
|  101 |  199 | `	ph7_result_int(pCtx,nOld);` |
|  101 |  200 | `	return PH7_OK;` |
|    5 |  201 | `}` |
|    - |  202 | `/*` |
...
|    - |  405 | ` */` |
| 9718 |  406 | `PH7_PRIVATE int vm_builtin_set_error_handler(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    5 |  407 | `{` |
| 9723 |  408 | `	ph7_vm *pVm = pCtx->pVm;` |
|    - |  409 | `	ph7_value *pOld,*pNew;` |
|    - |  410 | `	/* Point to the old and the new handler */` |
| 9723 |  411 | `	pOld = &pVm->aErrCB[0];` |
| 9723 |  412 | `	pNew = &pVm->aErrCB[1];` |
|    - |  413 | `	/* Return the old handler */` |
| 9723 |  414 | `	ph7_result_value(pCtx,pOld); /* Will make it's own copy */` |
| 9723 |  415 | `	if( nArg > 0 ){` |
| 9723 |  416 | `		if( !ph7_value_is_callable(apArg[0])) {` |
...
| 2415 |  420 | `		}else{` |
| 4895 |  421 | `			PH7_MemObjStore(pNew,pOld);` |
|    - |  422 | `			/* Install the new handler */` |
| 4895 |  423 | `			PH7_MemObjStore(apArg[0],pNew);` |
|    - |  424 | `		}` |
| 4859 |  425 | `	}` |
| 9723 |  426 | `	return PH7_OK;` |
|    5 |  427 | `}` |
|    - |  428 | `/*` |
