...
|      - |  322 | ` */` |
|  10404 |  323 | `PH7_PRIVATE int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  324 | `{` |
|      - |  325 | `	const ph7_io_stream *pStream;` |
|      - |  326 | `	io_private *pDev;` |
|      - |  327 | `	int rc;` |
|  10409 |  328 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10409 |  335 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - |  336 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10409 |  337 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10409 |  344 | `	pStream = pDev->pStream;` |
|  10409 |  345 | `	if( pStream == 0 ){` |
...
|    ! 0 |  351 | `		return PH7_OK;` |
|      - |  352 | `	}` |
|  10409 |  353 | `	rc = SXERR_EOF;` |
|      - |  354 | `	/* Perform the requested operation */` |
|  10409 |  355 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5823 |  362 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5823 |  363 | `		if( n > 0 ){` |
...
|      - |  368 | `	}` |
|      - |  369 | `	/* EOF or not */` |
|  10409 |  370 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10409 |  371 | `	return PH7_OK;` |
|   5207 |  372 | `}` |
|      - |  373 | `/*` |
...
|      - |  519 | ` */` |
|  29000 |  520 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - |  521 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 |  522 | `{` |
|  29005 |  523 | `	void *pHandle = 0; /* cc warning */` |
|      - |  524 | `	SyString sFile;` |
|      - |  525 | `	ph7_value sDummy;` |
|      - |  526 | `	int rc;` |
|  29005 |  527 | `	if( pStream == 0 ){` |
|      - |  528 | `		/* No such stream device */` |
|    ! 0 |  529 | `		return 0;` |
|      - |  530 | `	}` |
|  29005 |  531 | `	if( pResource == 0 ){` |
...
|  28981 |  537 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  28981 |  538 | `		pResource = &sDummy;` |
|  14488 |  539 | `	}` |
|  29005 |  540 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29005 |  541 | `	if( use_include ){` |
...
|      - |  592 | `	}` |
|  29005 |  593 | `	if( rc != PH7_OK ){` |
|      - |  594 | `		/* IO error */` |
|     22 |  595 | `		return 0;` |
|      - |  596 | `	}` |
|      - |  597 | `	/* Return the file handle */` |
|  28987 |  598 | `	return pHandle;` |
|  14505 |  599 | `}` |
|      - |  600 | `/*` |
...
|      - |  627 | ` */` |
|  29110 |  628 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 |  629 | `{` |
|  29115 |  630 | `	if( pStream->xClose ){` |
|  29115 |  631 | `		pStream->xClose(pHandle);` |
|  14555 |  632 | `	}` |
|  29115 |  633 | `}` |
|      - |  634 | `/*` |
...
|      - | 2440 | ` */` |
|   5318 | 2441 | `PH7_PRIVATE void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 2442 | `{` |
|   5323 | 2443 | `	pOut->pStream = pStream;` |
|   5323 | 2444 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5323 | 2445 | `	pOut->nOfft = 0;` |
|      - | 2446 | `	/* Set the magic number */` |
|   5323 | 2447 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5323 | 2448 | `}` |
|      - | 2449 | `/*` |
...
|      - | 2467 | ` */` |
|   5260 | 2468 | `PH7_PRIVATE void MarkIOPrivateClosed(io_private *pDev)` |
|      5 | 2469 | `{` |
|   5265 | 2470 | `	SyBlobRelease(&pDev->sBuffer);` |
|   5265 | 2471 | `	pDev->pHandle = 0;` |
|   5265 | 2472 | `	pDev->iMagic = IO_PRIVATE_CLOSED_MAGIC;` |
|   5265 | 2473 | `}` |
|      - | 2474 | `/*` |
