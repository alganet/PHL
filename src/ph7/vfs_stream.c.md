...
|      - |  322 | ` */` |
|  10397 |  323 | `PH7_PRIVATE int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  324 | `{` |
|      - |  325 | `	const ph7_io_stream *pStream;` |
|      - |  326 | `	io_private *pDev;` |
|      - |  327 | `	int rc;` |
|  10402 |  328 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10402 |  335 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - |  336 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10402 |  337 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10402 |  344 | `	pStream = pDev->pStream;` |
|  10402 |  345 | `	if( pStream == 0 ){` |
...
|    ! 0 |  351 | `		return PH7_OK;` |
|      - |  352 | `	}` |
|  10402 |  353 | `	rc = SXERR_EOF;` |
|      - |  354 | `	/* Perform the requested operation */` |
|  10402 |  355 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5816 |  362 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5816 |  363 | `		if( n > 0 ){` |
|      - |  364 | `			/* Copy buffered data */` |
|   1924 |  365 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1924 |  366 | `			rc = PH7_OK;` |
|    960 |  367 | `		}` |
|      - |  368 | `	}` |
|      - |  369 | `	/* EOF or not */` |
|  10402 |  370 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10402 |  371 | `	return PH7_OK;` |
|   5204 |  372 | `}` |
|      - |  373 | `/*` |
...
|      - |  519 | ` */` |
|  28992 |  520 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - |  521 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 |  522 | `{` |
|  28997 |  523 | `	void *pHandle = 0; /* cc warning */` |
|      - |  524 | `	SyString sFile;` |
|      - |  525 | `	ph7_value sDummy;` |
|      - |  526 | `	int rc;` |
|  28997 |  527 | `	if( pStream == 0 ){` |
|      - |  528 | `		/* No such stream device */` |
|    ! 0 |  529 | `		return 0;` |
|      - |  530 | `	}` |
|  28997 |  531 | `	if( pResource == 0 ){` |
...
|  28973 |  537 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  28973 |  538 | `		pResource = &sDummy;` |
|  14484 |  539 | `	}` |
|  28997 |  540 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  28997 |  541 | `	if( use_include ){` |
...
|      - |  592 | `	}` |
|  28997 |  593 | `	if( rc != PH7_OK ){` |
|      - |  594 | `		/* IO error */` |
|     22 |  595 | `		return 0;` |
|      - |  596 | `	}` |
|      - |  597 | `	/* Return the file handle */` |
|  28979 |  598 | `	return pHandle;` |
|  14501 |  599 | `}` |
|      - |  600 | `/*` |
...
|      - |  627 | ` */` |
|  29102 |  628 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 |  629 | `{` |
|  29107 |  630 | `	if( pStream->xClose ){` |
|  29107 |  631 | `		pStream->xClose(pHandle);` |
|  14551 |  632 | `	}` |
|  29107 |  633 | `}` |
|      - |  634 | `/*` |
...
|      - | 1397 | ` */` |
|  13084 | 1398 | `PH7_PRIVATE int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1399 | `{` |
|  13089 | 1400 | `	int use_include  = FALSE;` |
...
|      - | 1407 | `	int nLen;` |
|      - | 1408 |  |
|  13089 | 1409 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13089 | 1416 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 1417 | `	/* Point to the target IO stream device */` |
|  13089 | 1418 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13089 | 1419 | `	if( pStream == 0 ){` |
...
|      - | 1423 | `	}` |
|      - | 1424 | `	/* Data to write */` |
|  13089 | 1425 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 1426 | `	/* Try to open the file in read-write mode */` |
|  13089 | 1427 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 1428 | `	/* Extract the flags */` |
|  13089 | 1429 | `	iFlags = 0;` |
|  13089 | 1430 | `	if( nArg > 2 ){` |
...
|    ! 0 | 1442 | `		}` |
|    ! 0 | 1443 | `	}` |
|  19631 | 1444 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6542 | 1445 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13089 | 1446 | `	if( pHandle == 0 ){` |
|    ! 0 | 1447 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 1448 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1449 | `		return PH7_OK;` |
|      - | 1450 | `	}` |
|  13089 | 1451 | `	if( nLen < 1 ){` |
...
|      - | 1456 | `	}` |
|  13081 | 1457 | `	if( pStream->xWrite ){` |
|      - | 1458 | `		ph7_int64 n;` |
|  13081 | 1459 | `		if( (iFlags & 2/* LOCK_EX, php's value */) && pStream->xLock ){` |
|      - | 1460 | `			/* Try to acquire an exclusive lock */` |
|    ! 0 | 1461 | `			pStream->xLock(pHandle,1/* LOCK_EX */);` |
|    ! 0 | 1462 | `		}` |
|      - | 1463 | `		/* Perform the write operation */` |
|  13081 | 1464 | `		n = pStream->xWrite(pHandle,(const void *)zData,nLen);` |
|  13081 | 1465 | `		if( n < 0 ){` |
...
|  13081 | 1473 | `			ph7_result_int64(pCtx,n);` |
|      - | 1474 | `		}` |
|   6543 | 1475 | `	}else{` |
...
|  13081 | 1484 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13081 | 1485 | `	return PH7_OK;` |
|   6547 | 1486 | `}` |
|      - | 1487 | `/*` |
...
|      1 | 2666 | `		return 0;` |
|      - | 2667 | `	}` |
|     14 | 2668 | `	n = PH7_NetRecv(pSock->sock,pBuffer,(int)nRead,0);` |
|     14 | 2669 | `	if( n <= 0 ){` |
|      4 | 2670 | `		pSock->bEof = 1;` |
|      4 | 2671 | `		return 0;` |
|      - | 2672 | `	}` |
|     10 | 2673 | `	return (ph7_int64)n;` |
|      7 | 2674 | `}` |
