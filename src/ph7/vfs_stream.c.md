...
|      - |  322 | ` */` |
|  10708 |  323 | `PH7_PRIVATE int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  324 | `{` |
|      - |  325 | `	const ph7_io_stream *pStream;` |
|      - |  326 | `	io_private *pDev;` |
|      - |  327 | `	int rc;` |
|  10713 |  328 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10713 |  335 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - |  336 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10713 |  337 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10713 |  344 | `	pStream = pDev->pStream;` |
|  10713 |  345 | `	if( pStream == 0 ){` |
...
|    ! 0 |  351 | `		return PH7_OK;` |
|      - |  352 | `	}` |
|  10713 |  353 | `	rc = SXERR_EOF;` |
|      - |  354 | `	/* Perform the requested operation */` |
|  10713 |  355 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5775 |  362 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5775 |  363 | `		if( n > 0 ){` |
|      - |  364 | `			/* Copy buffered data */` |
|   1891 |  365 | `			SyBlobAppend(&pDev->sBuffer,zBuf,(sxu32)n);` |
|   1891 |  366 | `			rc = PH7_OK;` |
|    943 |  367 | `		}` |
|      - |  368 | `	}` |
|      - |  369 | `	/* EOF or not */` |
|  10713 |  370 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10713 |  371 | `	return PH7_OK;` |
|   5359 |  372 | `}` |
|      - |  373 | `/*` |
...
|      - |  417 | ` */` |
|   6890 |  418 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 |  419 | `{` |
|      - |  420 | `	const char *zIn,*zEnd,*zPtr;` |
|   6895 |  421 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6895 |  422 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6895 |  423 | `	zPtr = zIn;` |
| 460144 |  424 | `	while( zIn < zEnd ){` |
| 460044 |  425 | `		if( zIn[0] == '\n' ){` |
|      - |  426 | `			/* Line found */` |
|   6795 |  427 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6795 |  428 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6795 |  429 | `			*pzLine = zPtr;` |
|   6795 |  430 | `			return SXRET_OK;` |
|      - |  431 | `		}` |
| 453254 |  432 | `		zIn++;` |
|      5 |  433 | `	}` |
|      - |  434 | `	/* No line were found */` |
|    105 |  435 | `	return SXERR_NOTFOUND;` |
|   3450 |  436 | `}` |
|      - |  437 | `/*` |
|      - |  438 | ` * Read a single line from the underlying IO stream device.` |
|      - |  439 | ` */` |
|   6894 |  440 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 |  441 | `{` |
|   6899 |  442 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - |  443 | `	char zBuf[8192];` |
|      - |  444 | `	ph7_int64 n;` |
|      - |  445 | `	sxi32 rc;` |
|   6899 |  446 | `	n = 0;` |
|   6899 |  447 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
|      - |  448 | `		/* Reset the working buffer so that we avoid excessive memory allocation */` |
|     73 |  449 | `		SyBlobReset(&pDev->sBuffer);` |
|     73 |  450 | `		pDev->nOfft = 0;` |
|     34 |  451 | `	}` |
|   6899 |  452 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - |  453 | `		/* Check if there is a line */` |
|   6831 |  454 | `		rc = GetLine(pDev,&n,pzData);` |
|   6831 |  455 | `		if( rc == SXRET_OK ){` |
|      - |  456 | `			/* Got line,update the cursor  */` |
|   6735 |  457 | `			pDev->nOfft += (sxu32)n;` |
|   6735 |  458 | `			return n;` |
|      - |  459 | `		}` |
|     48 |  460 | `	}` |
...
|      - |  463 | `	 */` |
|     84 |  464 | `	for(;;){` |
|    173 |  465 | `		n = pStream->xRead(pDev->pHandle,zBuf, (nMaxLen > 0 && nMaxLen < (ph7_int64)sizeof(zBuf)) ? nMaxLen : (ph7_int64)sizeof(zBuf));` |
|    173 |  466 | `		if( n < 1 ){` |
|      - |  467 | `			/* EOF or IO error */` |
|    109 |  468 | `			break;` |
|      - |  469 | `		}` |
...
|      - |  487 | `		}` |
|      1 |  488 | `	}` |
|    109 |  489 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - |  490 | `		/* Read limit reached,return the available data */` |
|    105 |  491 | `		*pzData = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|    105 |  492 | `		n = SyBlobLength(&pDev->sBuffer) - pDev->nOfft;` |
|      - |  493 | `		/* Reset the working buffer */` |
|    105 |  494 | `		SyBlobReset(&pDev->sBuffer);` |
|    105 |  495 | `		pDev->nOfft = 0;` |
|     50 |  496 | `	}` |
|    109 |  497 | `	return n;` |
|   3452 |  498 | `}` |
|      - |  499 | `/*` |
...
|      - |  519 | ` */` |
|  29114 |  520 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - |  521 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 |  522 | `{` |
|  29119 |  523 | `	void *pHandle = 0; /* cc warning */` |
|      - |  524 | `	SyString sFile;` |
|      - |  525 | `	ph7_value sDummy;` |
|      - |  526 | `	int rc;` |
|  29119 |  527 | `	if( pStream == 0 ){` |
|      - |  528 | `		/* No such stream device */` |
|    ! 0 |  529 | `		return 0;` |
|      - |  530 | `	}` |
|  29119 |  531 | `	if( pResource == 0 ){` |
...
|  29097 |  537 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  29097 |  538 | `		pResource = &sDummy;` |
|  14546 |  539 | `	}` |
|  29119 |  540 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29119 |  541 | `	if( use_include ){` |
|   9170 |  542 | `		if(	sFile.zString[0] == '/' \|\|` |
|      - |  543 | `#ifdef __WINNT__` |
|      - |  544 | `			(sFile.nByte > 2 && sFile.zString[1] == ':' && (sFile.zString[2] == '\\' \|\| sFile.zString[2] == '/') ) \|\|` |
|      - |  545 | `#endif` |
|   9133 |  546 | `			(sFile.nByte > 1 && sFile.zString[0] == '.' && sFile.zString[1] == '/') \|\|` |
|   9128 |  547 | `			(sFile.nByte > 2 && sFile.zString[0] == '.' && sFile.zString[1] == '.' && sFile.zString[2] == '/') ){` |
...
|   9131 |  563 | `			SyBlobInit(&sWorker,&pVm->sAllocator);` |
|      - |  564 | `			/* Build a path from the set of include path */` |
|   9131 |  565 | `			SySetResetCursor(&pVm->aPaths);` |
|   9131 |  566 | `			rc = SXERR_IO;` |
|   9137 |  567 | `			while( SXRET_OK == SySetGetNextEntry(&pVm->aPaths,(void **)&pPath) ){` |
|      - |  568 | `				/* Build full path */` |
|   9131 |  569 | `				SyBlobFormat(&sWorker,"%z%c%z",pPath,c,&sFile);` |
|      - |  570 | `				/* Append null terminator */` |
|   9131 |  571 | `				if( SXRET_OK != SyBlobNullAppend(&sWorker) ){` |
|    ! 0 |  572 | `					continue;` |
|      - |  573 | `				}` |
|      - |  574 | `				/* Try to open the file */` |
|   9131 |  575 | `				rc = pStream->xOpen((const char *)SyBlobData(&sWorker),iFlags,pResource,&pHandle);` |
|   9131 |  576 | `				if( rc == PH7_OK ){` |
|   9124 |  577 | `					if( bPushInclude ){` |
|      - |  578 | `						/* Mark as included */` |
|   9124 |  579 | `						PH7_VmPushFilePath(pVm,(const char *)SyBlobData(&sWorker),SyBlobLength(&sWorker),FALSE,pNew);` |
|   4561 |  580 | `					}` |
|   9124 |  581 | `					break;` |
|      - |  582 | `				}` |
...
|      2 |  586 | `			}` |
|   9131 |  587 | `			SyBlobRelease(&sWorker);` |
|      - |  588 | `		}` |
|   4588 |  589 | `	}else{` |
|      - |  590 | `		/* Open the URI direcly */` |
|  19949 |  591 | `		rc = pStream->xOpen(zFile,iFlags,pResource,&pHandle);` |
|      - |  592 | `	}` |
|  29119 |  593 | `	if( rc != PH7_OK ){` |
|      - |  594 | `		/* IO error */` |
|     22 |  595 | `		return 0;` |
|      - |  596 | `	}` |
|      - |  597 | `	/* Return the file handle */` |
|  29101 |  598 | `	return pHandle;` |
|  14562 |  599 | `}` |
|      - |  600 | `/*` |
...
|      - |  604 | ` */` |
|   9154 |  605 | `PH7_PRIVATE sxi32 PH7_StreamReadWholeFile(void *pHandle,const ph7_io_stream *pStream,SyBlob *pOut)` |
|      3 |  606 | `{` |
|      - |  607 | `	ph7_int64 nRead;` |
...
|   9154 |  611 | `	for(;;){` |
|  18311 |  612 | `		nRead = pStream->xRead(pHandle,zBuf,sizeof(zBuf));` |
|  18311 |  613 | `		if( nRead < 1 ){` |
|      - |  614 | `			/* EOF or IO error */` |
|   9157 |  615 | `			break;` |
|      - |  616 | `		}` |
|      - |  617 | `		/* Append contents */` |
|   9157 |  618 | `		rc = SyBlobAppend(pOut,zBuf,(sxu32)nRead);` |
|   9157 |  619 | `		if( rc != SXRET_OK ){` |
|    ! 0 |  620 | `			break;` |
|      - |  621 | `		}` |
|      3 |  622 | `	}` |
|   9157 |  623 | `	return SyBlobLength(pOut) > 0 ? SXRET_OK : -1;` |
|      3 |  624 | `}` |
|      - |  625 | `/*` |
|      - |  626 | ` * Close an open IO stream handle [i.e local file/URI..].` |
|      - |  627 | ` */` |
|  29224 |  628 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 |  629 | `{` |
|  29229 |  630 | `	if( pStream->xClose ){` |
|  29229 |  631 | `		pStream->xClose(pHandle);` |
|  14612 |  632 | `	}` |
|  29229 |  633 | `}` |
|      - |  634 | `/*` |
...
|      - |  703 | ` */` |
|   6884 |  704 | `PH7_PRIVATE int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  705 | `{` |
|      - |  706 | `	const ph7_io_stream *pStream;` |
|      - |  707 | `	const char *zLine;` |
|      - |  708 | `	io_private *pDev;` |
|      - |  709 | `	ph7_int64 n,nLen;` |
|   6889 |  710 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6889 |  717 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - |  718 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6889 |  719 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6889 |  726 | `	pStream = pDev->pStream;` |
|   6889 |  727 | `	if( pStream == 0  ){` |
...
|   6889 |  741 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6889 |  742 | `	if( n < 1 ){` |
|      - |  743 | `		/* EOF or IO error,return FALSE */` |
|      7 |  744 | `		ph7_result_bool(pCtx,0);` |
|      6 |  745 | `	}else{` |
|      - |  746 | `		/* Return the freshly extracted line */` |
|   6887 |  747 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - |  748 | `	}` |
|   6889 |  749 | `	return PH7_OK;` |
|   3447 |  750 | `}` |
|      - |  751 | `/*` |
...
|      - | 1012 | ` */` |
|  10802 | 1013 | `PH7_PRIVATE int PH7_builtin_readdir(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1014 | `{` |
|      - | 1015 | `	const ph7_io_stream *pStream;` |
|      - | 1016 | `	io_private *pDev;` |
|      - | 1017 | `	int rc;` |
|  10807 | 1018 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10807 | 1025 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - | 1026 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10807 | 1027 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10807 | 1034 | `	pStream = pDev->pStream;` |
|  10807 | 1035 | `	if( pStream == 0  \|\| pStream->xReadDir == 0 ){` |
...
|      - | 1042 | `	}` |
|  10807 | 1043 | `	ph7_result_bool(pCtx,0);` |
|      - | 1044 | `	/* Perform the requested operation */` |
|  10807 | 1045 | `	rc = pStream->xReadDir(pDev->pHandle,pCtx);` |
|  10807 | 1046 | `	if( rc != PH7_OK ){` |
|      - | 1047 | `		/* Return FALSE */` |
|   1067 | 1048 | `		ph7_result_bool(pCtx,0);` |
|    531 | 1049 | `	}` |
|  10807 | 1050 | `	return PH7_OK;` |
|   5406 | 1051 | `}` |
|      - | 1052 | `/*` |
...
|      - | 1300 | ` */` |
|   6556 | 1301 | `PH7_PRIVATE int PH7_builtin_file_get_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1302 | `{` |
|      - | 1303 | `	const ph7_io_stream *pStream;` |
|      - | 1304 | `	ph7_int64 n,nRead,nMaxlen;` |
|   6561 | 1305 | `	int use_include  = FALSE;` |
|      - | 1306 | `	const char *zFile;` |
|      - | 1307 | `	char zBuf[8192];` |
|      - | 1308 | `	void *pHandle;` |
|      - | 1309 | `	int nLen;` |
|      - | 1310 |  |
|   6561 | 1311 | `	if( nArg < 1 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|   6561 | 1318 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 1319 | `	/* Point to the target IO stream device */` |
|   6561 | 1320 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|   6561 | 1321 | `	if( pStream == 0 ){` |
...
|   6561 | 1331 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,PH7_IO_OPEN_RDONLY,use_include,nArg > 2 ? apArg[2] : 0,FALSE,0);` |
|   6561 | 1332 | `	if( pHandle == 0 ){` |
...
|   6559 | 1352 | `	nRead = 0;` |
|   6551 | 1353 | `	for(;;){` |
|  19661 | 1354 | `		n = pStream->xRead(pHandle,zBuf,` |
|   6554 | 1355 | `			(nMaxlen > 0 && (nMaxlen < (ph7_int64)sizeof(zBuf))) ? nMaxlen : (ph7_int64)sizeof(zBuf));` |
|  13107 | 1356 | `		if( n < 1 ){` |
|      - | 1357 | `			/* EOF or IO error,break immediately */` |
|   6557 | 1358 | `			break;` |
|      - | 1359 | `		}` |
|      - | 1360 | `		/* Append data */` |
|   6555 | 1361 | `		ph7_result_string(pCtx,zBuf,(int)n);` |
|      - | 1362 | `		/* Increment read counter */` |
|   6555 | 1363 | `		nRead += n;` |
|   6555 | 1364 | `		if( nMaxlen > 0 && nRead >= nMaxlen ){` |
|      - | 1365 | `			/* Read limit reached */` |
|      3 | 1366 | `			break;` |
|      - | 1367 | `		}` |
|      5 | 1368 | `	}` |
|      - | 1369 | `	/* Close the stream */` |
|   6559 | 1370 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
...
|   6559 | 1374 | `	if( ph7_context_result_buf_length(pCtx) < 1 ){` |
|      6 | 1375 | `		ph7_result_string(pCtx,"",0);` |
|      2 | 1376 | `	}` |
|   6559 | 1377 | `	return PH7_OK;` |
|   3283 | 1378 | `}` |
|      - | 1379 | `/*` |
...
|      - | 1397 | ` */` |
|  13156 | 1398 | `PH7_PRIVATE int PH7_builtin_file_put_contents(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1399 | `{` |
|  13161 | 1400 | `	int use_include  = FALSE;` |
...
|      - | 1407 | `	int nLen;` |
|      - | 1408 |  |
|  13161 | 1409 | `	if( nArg < 2 \|\| !ph7_value_is_string(apArg[0]) ){` |
...
|  13161 | 1416 | `	zFile = ph7_value_to_string(apArg[0],&nLen);` |
|      - | 1417 | `	/* Point to the target IO stream device */` |
|  13161 | 1418 | `	pStream = PH7_VmGetStreamDevice(pCtx->pVm,&zFile,nLen);` |
|  13161 | 1419 | `	if( pStream == 0 ){` |
...
|      - | 1423 | `	}` |
|      - | 1424 | `	/* Data to write */` |
|  13161 | 1425 | `	zData = ph7_value_to_string(apArg[1],&nLen);` |
|      - | 1426 | `	/* Try to open the file in read-write mode */` |
|  13161 | 1427 | `	iOpenFlags = PH7_IO_OPEN_CREATE\|PH7_IO_OPEN_RDWR\|PH7_IO_OPEN_TRUNC;` |
|      - | 1428 | `	/* Extract the flags */` |
|  13161 | 1429 | `	iFlags = 0;` |
|  13161 | 1430 | `	if( nArg > 2 ){` |
...
|    ! 0 | 1442 | `		}` |
|    ! 0 | 1443 | `	}` |
|  19739 | 1444 | `	pHandle = PH7_StreamOpenHandle(pCtx->pVm,pStream,zFile,iOpenFlags,use_include,` |
|   6578 | 1445 | `		nArg > 3 ? apArg[3] : 0,FALSE,FALSE);` |
|  13161 | 1446 | `	if( pHandle == 0 ){` |
|    ! 0 | 1447 | `		VfsThrowOpenWarning(pCtx,zFile);` |
|    ! 0 | 1448 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1449 | `		return PH7_OK;` |
|      - | 1450 | `	}` |
|  13161 | 1451 | `	if( nLen < 1 ){` |
...
|      - | 1456 | `	}` |
|  13153 | 1457 | `	if( pStream->xWrite ){` |
|      - | 1458 | `		ph7_int64 n;` |
|  13153 | 1459 | `		if( (iFlags & 2/* LOCK_EX, php's value */) && pStream->xLock ){` |
|      - | 1460 | `			/* Try to acquire an exclusive lock */` |
|    ! 0 | 1461 | `			pStream->xLock(pHandle,1/* LOCK_EX */);` |
|    ! 0 | 1462 | `		}` |
|      - | 1463 | `		/* Perform the write operation */` |
|  13153 | 1464 | `		n = pStream->xWrite(pHandle,(const void *)zData,nLen);` |
|  13153 | 1465 | `		if( n < 0 ){` |
...
|  13153 | 1473 | `			ph7_result_int64(pCtx,n);` |
|      - | 1474 | `		}` |
|   6579 | 1475 | `	}else{` |
...
|  13153 | 1484 | `	PH7_StreamCloseHandle(pStream,pHandle);` |
|  13153 | 1485 | `	return PH7_OK;` |
|   6583 | 1486 | `}` |
|      - | 1487 | `/*` |
...
|      - | 2395 | `		 */` |
|    128 | 2396 | `		iFlag = PH7_IO_OPEN_WRONLY\|PH7_IO_OPEN_EXCL;` |
|    128 | 2397 | `		zMode++; /* Advance */` |
|    128 | 2398 | `		if( zMode < zEnd ){` |
|    ! 0 | 2399 | `			c = zMode[0];` |
|    ! 0 | 2400 | `			if( c == '+' \|\| c == 'r' \|\| c == 'R' ){` |
...
|      - | 2438 | ` */` |
|   5300 | 2439 | `PH7_PRIVATE void InitIOPrivate(ph7_vm *pVm,const ph7_io_stream *pStream,io_private *pOut)` |
|      5 | 2440 | `{` |
|   5305 | 2441 | `	pOut->pStream = pStream;` |
|   5305 | 2442 | `	SyBlobInit(&pOut->sBuffer,&pVm->sAllocator);` |
|   5305 | 2443 | `	pOut->nOfft = 0;` |
|      - | 2444 | `	/* Set the magic number */` |
|   5305 | 2445 | `	pOut->iMagic = IO_PRIVATE_MAGIC;` |
|   5305 | 2446 | `}` |
|      - | 2447 | `/*` |
...
|      - | 2465 | ` */` |
|   5242 | 2466 | `PH7_PRIVATE void MarkIOPrivateClosed(io_private *pDev)` |
|      5 | 2467 | `{` |
|   5247 | 2468 | `	SyBlobRelease(&pDev->sBuffer);` |
|   5247 | 2469 | `	pDev->pHandle = 0;` |
|   5247 | 2470 | `	pDev->iMagic = IO_PRIVATE_CLOSED_MAGIC;` |
|   5247 | 2471 | `}` |
|      - | 2472 | `/*` |
...
|     51 | 2540 | `	while( nMax != 0 ){` |
|     49 | 2541 | `		ph7_int64 nAsk = (ph7_int64)sizeof(zBuf);` |
|     49 | 2542 | `		if( nMax > 0 && nMax < nAsk ){` |
|      3 | 2543 | `			nAsk = nMax;` |
|      1 | 2544 | `		}` |
|     49 | 2545 | `		nRead = pStream->xRead(pDev->pHandle,zBuf,nAsk);` |
|     49 | 2546 | `		if( nRead < 1 ){` |
|     27 | 2547 | `			break;` |
|      - | 2548 | `		}` |
|     23 | 2549 | `		ph7_result_string(pCtx,zBuf,(int)nRead); /* appends */` |
|     23 | 2550 | `		if( nMax > 0 ){` |
|      3 | 2551 | `			nMax -= nRead;` |
|      1 | 2552 | `		}` |
|      1 | 2553 | `	}` |
...
|      - | 2657 | `	int bEof;` |
|      - | 2658 | `};` |
|     12 | 2659 | `static ph7_int64 SockStreamData_Read(void *pHandle,void *pBuffer,ph7_int64 nRead)` |
|    ! 0 | 2660 | `{` |
|     12 | 2661 | `	sock_private *pSock = (sock_private *)pHandle;` |
|      - | 2662 | `	int n;` |
|     12 | 2663 | `	if( pSock == 0 \|\| pSock->bEof ){` |
|      2 | 2664 | `		return 0;` |
|      - | 2665 | `	}` |
