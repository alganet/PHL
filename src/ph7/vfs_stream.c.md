...
|      - |  322 | ` */` |
|  10728 |  323 | `PH7_PRIVATE int PH7_builtin_feof(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  324 | `{` |
|      - |  325 | `	const ph7_io_stream *pStream;` |
|      - |  326 | `	io_private *pDev;` |
|      - |  327 | `	int rc;` |
|  10733 |  328 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|  10733 |  335 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - |  336 | `	/* Make sure we are dealing with a valid io_private instance */` |
|  10733 |  337 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|  10733 |  344 | `	pStream = pDev->pStream;` |
|  10733 |  345 | `	if( pStream == 0 ){` |
...
|    ! 0 |  351 | `		return PH7_OK;` |
|      - |  352 | `	}` |
|  10733 |  353 | `	rc = SXERR_EOF;` |
|      - |  354 | `	/* Perform the requested operation */` |
|  10733 |  355 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
...
|   5781 |  362 | `		n = pStream->xRead(pDev->pHandle,zBuf,sizeof(zBuf));` |
|   5781 |  363 | `		if( n > 0 ){` |
...
|      - |  368 | `	}` |
|      - |  369 | `	/* EOF or not */` |
|  10733 |  370 | `	ph7_result_bool(pCtx,rc == SXERR_EOF);` |
|  10733 |  371 | `	return PH7_OK;` |
|   5369 |  372 | `}` |
|      - |  373 | `/*` |
...
|      - |  417 | ` */` |
|   6908 |  418 | `static sxi32 GetLine(io_private *pDev,ph7_int64 *pLen,const char **pzLine)` |
|      5 |  419 | `{` |
|      - |  420 | `	const char *zIn,*zEnd,*zPtr;` |
|   6913 |  421 | `	zIn = (const char *)SyBlobDataAt(&pDev->sBuffer,pDev->nOfft);` |
|   6913 |  422 | `	zEnd = &zIn[SyBlobLength(&pDev->sBuffer)-pDev->nOfft];` |
|   6913 |  423 | `	zPtr = zIn;` |
| 463316 |  424 | `	while( zIn < zEnd ){` |
| 463214 |  425 | `		if( zIn[0] == '\n' ){` |
|      - |  426 | `			/* Line found */` |
|   6811 |  427 | `			zIn++; /* Include the line ending as requested by the PHP specification */` |
|   6811 |  428 | `			*pLen = (ph7_int64)(zIn-zPtr);` |
|   6811 |  429 | `			*pzLine = zPtr;` |
|   6811 |  430 | `			return SXRET_OK;` |
|      - |  431 | `		}` |
| 456408 |  432 | `		zIn++;` |
|      5 |  433 | `	}` |
...
|      - |  439 | ` */` |
|   6912 |  440 | `static ph7_int64 StreamReadLine(io_private *pDev,const char **pzData,ph7_int64 nMaxLen)` |
|      5 |  441 | `{` |
|   6917 |  442 | `	const ph7_io_stream *pStream = pDev->pStream;` |
|      - |  443 | `	char zBuf[8192];` |
|      - |  444 | `	ph7_int64 n;` |
|      - |  445 | `	sxi32 rc;` |
|   6917 |  446 | `	n = 0;` |
|   6917 |  447 | `	if( pDev->nOfft >= SyBlobLength(&pDev->sBuffer) ){` |
|      - |  448 | `		/* Reset the working buffer so that we avoid excessive memory allocation */` |
|     73 |  449 | `		SyBlobReset(&pDev->sBuffer);` |
|     73 |  450 | `		pDev->nOfft = 0;` |
|     34 |  451 | `	}` |
|   6917 |  452 | `	if( SyBlobLength(&pDev->sBuffer) > pDev->nOfft ){` |
|      - |  453 | `		/* Check if there is a line */` |
|   6849 |  454 | `		rc = GetLine(pDev,&n,pzData);` |
|   6849 |  455 | `		if( rc == SXRET_OK ){` |
|      - |  456 | `			/* Got line,update the cursor  */` |
|   6751 |  457 | `			pDev->nOfft += (sxu32)n;` |
|   6751 |  458 | `			return n;` |
|      - |  459 | `		}` |
|     49 |  460 | `	}` |
...
|      - |  519 | ` */` |
|  29110 |  520 | `PH7_PRIVATE void * PH7_StreamOpenHandle(ph7_vm *pVm,const ph7_io_stream *pStream,const char *zFile,` |
|      - |  521 | `	int iFlags,int use_include,ph7_value *pResource,int bPushInclude,int *pNew)` |
|      5 |  522 | `{` |
|  29115 |  523 | `	void *pHandle = 0; /* cc warning */` |
|      - |  524 | `	SyString sFile;` |
|      - |  525 | `	ph7_value sDummy;` |
|      - |  526 | `	int rc;` |
|  29115 |  527 | `	if( pStream == 0 ){` |
|      - |  528 | `		/* No such stream device */` |
|    ! 0 |  529 | `		return 0;` |
|      - |  530 | `	}` |
|  29115 |  531 | `	if( pResource == 0 ){` |
...
|  29093 |  537 | `		PH7_MemObjInit(pVm,&sDummy);` |
|  29093 |  538 | `		pResource = &sDummy;` |
|  14544 |  539 | `	}` |
|  29115 |  540 | `	SyStringInitFromBuf(&sFile,zFile,SyStrlen(zFile));` |
|  29115 |  541 | `	if( use_include ){` |
...
|      - |  592 | `	}` |
|  29115 |  593 | `	if( rc != PH7_OK ){` |
|      - |  594 | `		/* IO error */` |
|     22 |  595 | `		return 0;` |
|      - |  596 | `	}` |
|      - |  597 | `	/* Return the file handle */` |
|  29097 |  598 | `	return pHandle;` |
|  14560 |  599 | `}` |
|      - |  600 | `/*` |
...
|      - |  627 | ` */` |
|  29220 |  628 | `PH7_PRIVATE void PH7_StreamCloseHandle(const ph7_io_stream *pStream,void *pHandle)` |
|      5 |  629 | `{` |
|  29225 |  630 | `	if( pStream->xClose ){` |
|  29225 |  631 | `		pStream->xClose(pHandle);` |
|  14610 |  632 | `	}` |
|  29225 |  633 | `}` |
|      - |  634 | `/*` |
...
|      - |  703 | ` */` |
|   6902 |  704 | `PH7_PRIVATE int PH7_builtin_fgets(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  705 | `{` |
|      - |  706 | `	const ph7_io_stream *pStream;` |
|      - |  707 | `	const char *zLine;` |
|      - |  708 | `	io_private *pDev;` |
|      - |  709 | `	ph7_int64 n,nLen;` |
|   6907 |  710 | `	if( nArg < 1 \|\| !ph7_value_is_resource(apArg[0]) ){` |
...
|   6907 |  717 | `	pDev = (io_private *)ph7_value_to_resource(apArg[0]);` |
|      - |  718 | `	/* Make sure we are dealing with a valid io_private instance */` |
|   6907 |  719 | `	if( IO_PRIVATE_INVALID(pDev) ){` |
...
|   6907 |  726 | `	pStream = pDev->pStream;` |
|   6907 |  727 | `	if( pStream == 0  ){` |
...
|   6907 |  741 | `	n = StreamReadLine(pDev,&zLine,nLen);` |
|   6907 |  742 | `	if( n < 1 ){` |
|      - |  743 | `		/* EOF or IO error,return FALSE */` |
|      7 |  744 | `		ph7_result_bool(pCtx,0);` |
|      6 |  745 | `	}else{` |
|      - |  746 | `		/* Return the freshly extracted line */` |
|   6905 |  747 | `		ph7_result_string(pCtx,zLine,(int)n);` |
|      - |  748 | `	}` |
|   6907 |  749 | `	return PH7_OK;` |
|   3456 |  750 | `}` |
|      - |  751 | `/*` |
...
|      1 | 2664 | `		return 0;` |
|      - | 2665 | `	}` |
|      9 | 2666 | `	n = PH7_NetRecv(pSock->sock,pBuffer,(int)nRead,0);` |
|      9 | 2667 | `	if( n <= 0 ){` |
|      4 | 2668 | `		pSock->bEof = 1;` |
|      4 | 2669 | `		return 0;` |
|      - | 2670 | `	}` |
|      5 | 2671 | `	return (ph7_int64)n;` |
|      5 | 2672 | `}` |
