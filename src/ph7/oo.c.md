...
|       - |  154 | ` */` |
|  900882 |  155 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  156 | `{` |
|       - |  157 | `	SyHashEntry *pEntry;` |
|       - |  158 | `	/* Perform a hash lookup */` |
|  900887 |  159 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  900887 |  160 | `	if( pEntry == 0 ){` |
|       - |  161 | `		/* No such entry */` |
|   30447 |  162 | `		return 0;` |
|       - |  163 | `	}` |
|       - |  164 | `	/* Point to the desired method */` |
|  870445 |  165 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  450446 |  166 | `}` |
|       - |  167 | `/*` |
...
|       - |  931 | ` */` |
|    8710 |  932 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  933 | `{` |
|       - |  934 | `	ph7_class_instance *pThis;` |
|       - |  935 | `	/* Allocate a new instance */` |
|    8715 |  936 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    8715 |  937 | `	if( pThis == 0 ){` |
|     ! 0 |  938 | `		return 0;` |
|       - |  939 | `	}` |
|       - |  940 | `	/* Zero the structure */` |
|    8715 |  941 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  942 | `	/* Initialize fields */` |
|    8715 |  943 | `	pThis->iRef = 1;` |
|    8715 |  944 | `	pThis->pVm = pVm;` |
|    8715 |  945 | `	pThis->pClass = pClass;` |
|       - |  946 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    8715 |  947 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    8715 |  948 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    8715 |  949 | `	return pThis;` |
|    4360 |  950 | `}` |
|       - |  951 | `/*` |
|       - |  952 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  953 | ` * See the block comment above for more information.` |
|       - |  954 | ` */` |
|    8464 |  955 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  956 | `{` |
|       - |  957 | `	ph7_class_instance *pNew;` |
|       - |  958 | `	sxi32 rc;` |
|    8469 |  959 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    8469 |  960 | `	if( pNew == 0 ){` |
|     ! 0 |  961 | `		return 0;` |
|       - |  962 | `	}` |
|       - |  963 | `	/* Associate a private VM frame with this class instance */` |
|    8469 |  964 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    8469 |  965 | `	if( rc != SXRET_OK ){` |
...
|    8469 |  972 | `	PH7_VmStampThrowableSite(&(*pVm),pNew);` |
|    8469 |  973 | `	return pNew;` |
|    4237 |  974 | `}` |
|       - |  975 | `/*` |
|       - |  976 | ` * Extract the value of a class instance [i.e: Object in the PHP jargon] attribute.` |
|       - |  977 | ` * This function never fail.` |
|       - |  978 | ` */` |
|   24318 |  979 | `static ph7_value * ExtractClassAttrValue(ph7_vm *pVm,VmClassAttr *pAttr)` |
|       5 |  980 | `{` |
|       - |  981 | `	/* Extract the value */` |
|       - |  982 | `	ph7_value *pValue;` |
|   24323 |  983 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|   24323 |  984 | `	return pValue;` |
|       5 |  985 | `}` |
|       - |  986 | `/*` |
...
|       - | 1202 | ` */` |
|   28992 | 1203 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1204 | `{` |
|   28997 | 1205 | `	if( pVmAttr->iState & VM_CLASS_ATTR_REFBOUND ){` |
...
|   28992 | 1210 | `	}else if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   21691 | 1213 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     309 | 1214 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     152 | 1215 | `		}` |
|   21691 | 1216 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   10843 | 1217 | `	}` |
...
|   28997 | 1220 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     116 | 1221 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      57 | 1222 | `	}` |
|   28997 | 1223 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   28997 | 1224 | `}` |
|       - | 1225 | `/*` |
...
|       - | 1228 | ` * class instance.` |
|       - | 1229 | ` */` |
|    5792 | 1230 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1231 | `{` |
|       - | 1232 | `	ph7_class_method *pDestr;` |
|       - | 1233 | `	SyHashEntry *pEntry;` |
|       - | 1234 | `	ph7_class *pClass;` |
|       - | 1235 | `	ph7_vm *pVm;` |
|    5797 | 1236 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1237 | `		/*` |
...
|    5797 | 1244 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1245 | `	/* Invoke any defined destructor if available */` |
|    5797 | 1246 | `	pVm = pThis->pVm;` |
|    5797 | 1247 | `	pClass = pThis->pClass;` |
|    5797 | 1248 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5797 | 1249 | `	if( pDestr && !pVm->bInReset ){` |
...
|    5797 | 1259 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5797 | 1268 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   34761 | 1269 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   28969 | 1270 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1271 | `	}` |
|       - | 1272 | `	/* Release the whole structure */` |
|    5797 | 1273 | `	SyHashRelease(&pThis->hAttr);` |
|    5797 | 1274 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2901 | 1275 | `}` |
|       - | 1276 | `/*` |
...
|       - | 1279 | ` */` |
|  147146 | 1280 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1281 | `{` |
|  147151 | 1282 | `	pThis->iRef--;` |
|  147151 | 1283 | `	if( pThis->iRef < 1 ){` |
|       - | 1284 | `		/* No more reference to this instance */` |
|    5797 | 1285 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2896 | 1286 | `	}` |
|  147151 | 1287 | `}` |
|       - | 1288 | `/*` |
...
|       - | 1761 | ` */` |
|   11358 | 1762 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceExtractAttrValue(ph7_class_instance *pThis,VmClassAttr *pAttr)` |
|       5 | 1763 | `{` |
|       - | 1764 | `   /* Extract the attribute value */` |
|       - | 1765 | `	ph7_value *pValue;` |
|   11363 | 1766 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|   11363 | 1767 | `	return pValue;` |
|       5 | 1768 | `}` |
|       - | 1769 | `/*` |
