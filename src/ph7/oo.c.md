...
|       - |   13 | ` */` |
|  413654 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  413659 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  413659 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  413659 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  413659 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  413659 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  413659 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  413659 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  413659 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  413659 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  413659 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  413659 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  413659 |   38 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  413659 |   39 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  413659 |   40 | `	pClass->nLine = nLine;` |
|  413659 |   41 | `	if( pVm->bCompilingBuiltin ){` |
...
|  411709 |   44 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  205857 |   45 | `	}else{` |
...
|       - |   51 | `	}` |
|       - |   52 | `	/* All done */` |
|  413659 |   53 | `	return pClass;` |
|  206832 |   54 | `}` |
|       - |   55 | `/*` |
|       - |   56 | ` * Allocate and initialize a new class attribute.` |
|       - |   57 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   58 | ` */` |
|  719814 |   59 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   60 | `{` |
|       - |   61 | `	ph7_class_attr *pAttr;` |
|       - |   62 | `	char *zName;` |
|  719819 |   63 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  719819 |   64 | `	if( pAttr == 0 ){` |
|     ! 0 |   65 | `		return 0;` |
|       - |   66 | `	}` |
|       - |   67 | `	/* Zero the structure */` |
|  719819 |   68 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  719819 |   69 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   70 | `	/* Duplicate attribute name */` |
|  719819 |   71 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  719819 |   72 | `	if( zName == 0 ){` |
|     ! 0 |   73 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   74 | `		return 0;` |
|       - |   75 | `	}` |
|       - |   76 | `	/* Initialize fields */` |
|  719819 |   77 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  719819 |   78 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  719819 |   79 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  719819 |   80 | `	pAttr->iProtection = iProtection;` |
|  719819 |   81 | `	pAttr->nIdx = SXU32_HIGH;` |
|  719819 |   82 | `	pAttr->iFlags = iFlags;` |
|  719819 |   83 | `	pAttr->nLine = nLine;` |
|  719819 |   84 | `	return pAttr;` |
|  359912 |   85 | `}` |
|       - |   86 | `/*` |
...
|       - |   91 | ` */` |
| 2281646 |   92 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2281651 |  102 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2281651 |  103 | `	if( pMeth == 0 ){` |
|     ! 0 |  104 | `		return 0;` |
|       - |  105 | `	}` |
|       - |  106 | `	/* Zero the structure */` |
| 2281651 |  107 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  108 | `	/* Check for an already installed method with the same name */` |
| 2281651 |  109 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2281651 |  110 | `	if( pEntry == 0 ){` |
|       - |  111 | `		/* Associate an unique VM name to this method */` |
| 2281649 |  112 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2281649 |  113 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2281649 |  114 | `		if( zName == 0 ){` |
|     ! 0 |  115 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  116 | `			return 0;` |
|       - |  117 | `		}` |
| 2281649 |  118 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  119 | `		/* Generate a random string */` |
| 2281649 |  120 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2281649 |  121 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2281649 |  122 | `		pNamePtr->zString = zName;` |
| 1140827 |  123 | `	}else{` |
...
|       - |  130 | `	}` |
| 2281651 |  131 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  128230 |  132 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  128235 |  133 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2281651 |  144 | `	pMeth->iProtection = iProtection;` |
| 2281651 |  145 | `	pMeth->iFlags = iFlags;` |
| 2281651 |  146 | `	pMeth->nLine = nLine;` |
| 3422474 |  147 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2281646 |  148 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2281651 |  149 | `	return pMeth;` |
| 1140828 |  150 | `}` |
|       - |  151 | `/*` |
...
|       - |  154 | ` */` |
|  654878 |  155 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  156 | `{` |
|       - |  157 | `	SyHashEntry *pEntry;` |
|       - |  158 | `	/* Perform a hash lookup */` |
|  654883 |  159 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  654883 |  160 | `	if( pEntry == 0 ){` |
|       - |  161 | `		/* No such entry */` |
|    8365 |  162 | `		return 0;` |
|       - |  163 | `	}` |
|       - |  164 | `	/* Point to the desired method */` |
|  646523 |  165 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  327444 |  166 | `}` |
|       - |  167 | `/*` |
...
|       - |  170 | ` */` |
|  429166 |  171 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  172 | `{` |
|       - |  173 | `	SyHashEntry *pEntry;` |
|       - |  174 | `	/* Perform a hash lookup */` |
|  429171 |  175 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  429171 |  176 | `	if( pEntry == 0 ){` |
|       - |  177 | `		/* No such entry */` |
|  428359 |  178 | `		return 0;` |
|       - |  179 | `	}` |
|       - |  180 | `	/* Point to the desierd method */` |
|     817 |  181 | `	return (ph7_class_attr *)pEntry->pUserData;` |
|  214588 |  182 | `}` |
|       - |  183 | `/*` |
...
|       - |  186 | ` */` |
|  719810 |  187 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  188 | `{` |
|  719815 |  189 | `	SyString *pName = &pAttr->sName;` |
|       - |  190 | `	sxi32 rc;` |
...
|  719815 |  194 | `	if( pAttr->pDeclClass == 0 ){` |
|  719815 |  195 | `		pAttr->pDeclClass = pClass;` |
|  359905 |  196 | `	}` |
|  719815 |  197 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  719815 |  198 | `	return rc;` |
|       5 |  199 | `}` |
|       - |  200 | `/*` |
...
|       - |  203 | ` */` |
| 2281634 |  204 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  205 | `{` |
| 2281639 |  206 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  207 | `	sxi32 rc;` |
| 2281639 |  208 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2281639 |  209 | `	return rc;` |
|       5 |  210 | `}` |
|       - |  211 | `/*` |
...
|       - |  233 | ` */` |
|  155560 |  234 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  235 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  236 | `{` |
|  155565 |  237 | `	*ppClass = 0;` |
|  155565 |  238 | `	if( bUnion ){` |
|       3 |  239 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  240 | `	}` |
|  155563 |  241 | `	if( nType == 0 ){` |
|  155477 |  242 | `		return OVT_NONE; /* no declared type */` |
|       - |  243 | `	}` |
...
|       - |  286 | `	int bNullable;` |
|       - |  287 | `};` |
|  124428 |  288 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  289 | `{` |
|       - |  290 | `	OvType t;` |
|  124433 |  291 | `	t.nType = pF->nReturnType;` |
|  124433 |  292 | `	t.pClass = &pF->sReturnClass;` |
|  124433 |  293 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  124433 |  294 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  124433 |  295 | `	return t;` |
|       5 |  296 | `}` |
|   31132 |  297 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  298 | `{` |
|       - |  299 | `	OvType t;` |
|   31137 |  300 | `	t.nType = pA->nType;` |
|   31137 |  301 | `	t.pClass = &pA->sClass;` |
|   31137 |  302 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   31137 |  303 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   31137 |  304 | `	return t;` |
|       5 |  305 | `}` |
|       - |  306 | `/*` |
...
|       - |  311 | ` */` |
|   77780 |  312 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  313 | `{` |
|       - |  314 | `	ph7_class *pParentCls, *pChildCls;` |
|   77785 |  315 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|   77785 |  316 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|   77785 |  317 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|   77769 |  325 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|   77745 |  326 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|   77745 |  327 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|   77745 |  328 | `		return 0;` |
|       - |  329 | `	}` |
...
|       - |  355 | ` */` |
|   89408 |  356 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  357 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  358 | `{` |
|   89413 |  359 | `	ph7_vm *pVm = pGen->pVm;` |
|   89413 |  360 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|   89413 |  361 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|   89413 |  362 | `	SyString *pMName = &pCF->sName;` |
|       - |  363 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  364 | `	sxu32 nPArg, nCArg, k;` |
|   89413 |  365 | `	int bBad = 0;` |
|   89408 |  366 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   58310 |  367 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   27199 |  368 | `		return SXRET_OK;` |
|       - |  369 | `	}` |
|       - |  370 | `	/* Return type — covariant. */` |
|   62219 |  371 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  372 | `	/* Each overlapping parameter — contravariant. */` |
|   62219 |  373 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|   62219 |  374 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|   62219 |  375 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|   62219 |  376 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|   77785 |  377 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   15571 |  378 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|    7788 |  379 | `	}` |
...
|   62219 |  384 | `	if( !bBad ){` |
|   62215 |  385 | `		int bVariadic = 0;` |
|   77779 |  386 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   77781 |  387 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   62215 |  388 | `		if( !bVariadic ){` |
|   62215 |  389 | `			if( nCArg < nPArg ){` |
|     ! 0 |  390 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  391 | `			}else{` |
|   62217 |  392 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  447 | ` * error message.` |
|       - |  448 | ` */` |
|  182798 |  449 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  450 | `{` |
...
|  182803 |  457 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  182803 |  458 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  459 | `		return rc;` |
|       - |  460 | `	}` |
...
|  182803 |  463 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  182803 |  478 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1068841 |  479 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  480 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
|  886043 |  481 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  886043 |  482 | `		pName = &pAttr->sName;` |
|  886043 |  483 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
|  886022 |  513 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  470213 |  514 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|  886023 |  515 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  886023 |  516 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  517 | `				return rc;` |
|       - |  518 | `			}` |
|  443009 |  519 | `		}` |
|       5 |  520 | `	}` |
|  182803 |  521 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 2580131 |  522 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  523 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 2397333 |  524 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 2397333 |  525 | `		pName = &pMeth->sFunc.sName;` |
| 2397333 |  526 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   89417 |  527 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  134117 |  537 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|   89408 |  538 | `					(ph7_class_method *)pEntry->pUserData);` |
|   89413 |  539 | `				if( rc == SXERR_ABORT ){` |
...
| 2307916 |  553 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1165622 |  554 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 2307921 |  555 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2307921 |  556 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  557 | `				return rc;` |
|       - |  558 | `			}` |
| 1153958 |  559 | `		}` |
|       5 |  560 | `	}` |
|       - |  561 | `	/* Mark as subclass */` |
|  182803 |  562 | `	pSub->pBase = pBase;` |
|       - |  563 | `	/* All done */` |
|  182803 |  564 | `	return SXRET_OK;` |
|   91404 |  565 | `}` |
|       - |  566 | `/*` |
...
|       - |  570 | ` */` |
|   15598 |  571 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  572 | `{` |
...
|   15603 |  579 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  586 | `	}` |
|   15603 |  587 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15603 |  588 | `	rc = SXRET_OK;` |
|       - |  589 | `	/* Copy attributes from the trait */` |
|   15603 |  590 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   54461 |  591 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  592 | `		SyHashEntry *pExisting;` |
|   38863 |  593 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   38863 |  594 | `		pName = &pAttr->sName;` |
|   38863 |  595 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   38863 |  596 | `		if( pExisting != 0 ){` |
...
|       6 |  625 | `			continue;` |
|       - |  626 | `		}` |
|   38859 |  627 | `		rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   38859 |  628 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  629 | `			goto cleanup;` |
|       - |  630 | `		}` |
|       5 |  631 | `	}` |
|       - |  632 | `	/* Copy methods from the trait */` |
|   15603 |  633 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  217633 |  634 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|  202035 |  635 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  202035 |  636 | `		pName = &pMeth->sFunc.sName;` |
|  202035 |  637 | `		if( SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|      11 |  661 | `			continue;` |
|       - |  662 | `		}` |
|  202027 |  663 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  202027 |  664 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  665 | `			goto cleanup;` |
|       - |  666 | `		}` |
|       5 |  667 | `	}` |
|       - |  668 | `	/* Record trait in the class */` |
|   15603 |  669 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7799 |  670 | `cleanup:` |
|       - |  671 | `	/* Always clear visiting flag, even on error paths */` |
|   15603 |  672 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7799 |  673 | `	SXUNUSED(pGen);` |
|   15603 |  674 | `	return rc;` |
|    7804 |  675 | `}` |
|       - |  676 | `/*` |
...
|       - |  687 | ` * error message.` |
|       - |  688 | ` */` |
|   23314 |  689 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  690 | `{` |
...
|   23319 |  697 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   23319 |  698 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  699 | `	/* Copy constants */` |
|   34978 |  700 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  710 | `		}` |
|       1 |  711 | `	}` |
|   23319 |  712 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  713 | `	/* Copy methods signature */` |
|   81626 |  714 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  715 | `		/* Make sure the method are not redeclared in the subclass */` |
|   46655 |  716 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   46655 |  717 | `		pName = &pMeth->sFunc.sName;` |
|   46655 |  718 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  719 | `			/* Install the method */` |
|   46655 |  720 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   46655 |  721 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  722 | `				return rc;` |
|       - |  723 | `			}` |
|   23325 |  724 | `		}` |
|       5 |  725 | `	}` |
|       - |  726 | `	/* Mark as subclass */` |
|   23319 |  727 | `	pSub->pBase = pBase;` |
|       - |  728 | `	/* All done */` |
|   23319 |  729 | `	return SXRET_OK;` |
|   11662 |  730 | `}` |
|       - |  731 | `/*` |
...
|       - |  742 | ` * error message.` |
|       - |  743 | ` */` |
|  342124 |  744 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  745 | `{` |
...
|  342129 |  751 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  621957 |  752 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
|       - |  753 | `		/* Point to the constant declaration */` |
|  108771 |  754 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  108771 |  755 | `		pName = &pAttr->sName;` |
|       - |  756 | `		/* Make sure the attribute is not redeclared in the main class */` |
|  108771 |  757 | `		if( SyHashGet(&pMain->hAttr,pName->zString,pName->nByte) == 0 ){` |
|       - |  758 | `			/* Install the attribute */` |
|  108767 |  759 | `			rc = SyHashInsert(&pMain->hAttr,pName->zString,pName->nByte,pAttr);` |
|  108767 |  760 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  761 | `				return rc;` |
|       - |  762 | `			}` |
|   54381 |  763 | `		}` |
|       5 |  764 | `	}` |
|       - |  765 | `	/* Install in the interface container */` |
|  342129 |  766 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  775 | `		SyString *pMName;` |
|  342129 |  776 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1119675 |  777 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  606489 |  778 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  606489 |  779 | `			pMName = &pMeth->sFunc.sName;` |
|  606489 |  780 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|     220 | 1664 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|     220 | 1665 | `	return pValue;` |
|       4 | 1666 | `}` |
|       - | 1667 | `/*` |
