...
|      - |   13 | ` */` |
|  22266 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|      2 |   15 |  |
|      - |   16 | `	ph7_class *pClass;` |
|      - |   17 | `	char *zName;` |
|      - |   18 | `	/* Allocate a new instance */` |
|  22268 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  22268 |   20 | `	if( pClass == 0 ){` |
|    ! 0 |   21 | `		return 0;` |
|      - |   22 | `	}` |
|      - |   23 | `	/* Zero the structure */` |
|  22268 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|      - |   25 | `	/* Duplicate class name */` |
|  22268 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  22268 |   27 | `	if( zName == 0 ){` |
|    ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|    ! 0 |   29 | `		return 0;` |
|      - |   30 | `	}` |
|      - |   31 | `	/* Initialize fields */` |
|  22268 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  22268 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  22268 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  22268 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  22268 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  22268 |   37 | `	pClass->nLine = nLine;` |
|      - |   38 | `	/* All done */` |
|  22268 |   39 | `	return pClass;` |
|  11135 |   40 |  |
|      - |   41 | `/*` |
|      - |   42 | ` * Allocate and initialize a new class attribute.` |
|      - |   43 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|      - |   44 | ` */` |
|  20182 |   45 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|      2 |   46 |  |
|      - |   47 | `	ph7_class_attr *pAttr;` |
|      - |   48 | `	char *zName;` |
|  20184 |   49 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  20184 |   50 | `	if( pAttr == 0 ){` |
|    ! 0 |   51 | `		return 0;` |
|      - |   52 | `	}` |
|      - |   53 | `	/* Zero the structure */` |
|  20184 |   54 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|      - |   55 | `	/* Duplicate attribute name */` |
|  20184 |   56 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  20184 |   57 | `	if( zName == 0 ){` |
|    ! 0 |   58 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|    ! 0 |   59 | `		return 0;` |
|      - |   60 | `	}` |
|      - |   61 | `	/* Initialize fields */` |
|  20184 |   62 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  20184 |   63 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  20184 |   64 | `	pAttr->iProtection = iProtection;` |
|  20184 |   65 | `	pAttr->nIdx = SXU32_HIGH;` |
|  20184 |   66 | `	pAttr->iFlags = iFlags;` |
|  20184 |   67 | `	pAttr->nLine = nLine;` |
|  20184 |   68 | `	return pAttr;` |
|  10093 |   69 |  |
|      - |   70 | `/*` |
...
|      - |   75 | ` */` |
|  58212 |   76 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
|  58214 |   86 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
|  58214 |   87 | `	if( pMeth == 0 ){` |
|    ! 0 |   88 | `		return 0;` |
|      - |   89 | `	}` |
|      - |   90 | `	/* Zero the structure */` |
|  58214 |   91 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|      - |   92 | `	/* Check for an already installed method with the same name */` |
|  58214 |   93 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  58214 |   94 | `	if( pEntry == 0 ){` |
|      - |   95 | `		/* Associate an unique VM name to this method */` |
|  58212 |   96 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
|  58212 |   97 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
|  58212 |   98 | `		if( zName == 0 ){` |
|    ! 0 |   99 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|    ! 0 |  100 | `			return 0;` |
|      - |  101 | `		}` |
|  58212 |  102 | `		pNamePtr = &pMeth->sVmName;` |
|      - |  103 | `		/* Generate a random string */` |
|  58212 |  104 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
|  58212 |  105 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
|  58212 |  106 | `		pNamePtr->zString = zName;` |
|  29107 |  107 | `	}else{` |
...
|      - |  114 | `	}` |
|  58214 |  115 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|  58216 |  124 | `	pMeth->iProtection = iProtection;` |
|  58216 |  125 | `	pMeth->iFlags = iFlags;` |
|  58216 |  126 | `	pMeth->nLine = nLine;` |
|  87324 |  127 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
|  58214 |  128 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
|  58216 |  129 | `	return pMeth;` |
|  29110 |  130 |  |
|      - |  131 | `/*` |
...
|      - |  134 | ` */` |
|   3908 |  135 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|      2 |  136 |  |
|      - |  137 | `	SyHashEntry *pEntry;` |
|      - |  138 | `	/* Perform a hash lookup */` |
|   3910 |  139 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|   3910 |  140 | `	if( pEntry == 0 ){` |
|      - |  141 | `		/* No such entry */` |
|   1608 |  142 | `		return 0;` |
|      - |  143 | `	}` |
|      - |  144 | `	/* Point to the desired method */` |
|   2304 |  145 | `	return (ph7_class_method *)pEntry->pUserData;` |
|   1956 |  146 |  |
|      - |  147 | `/*` |
...
|      - |  166 | ` */` |
|  20182 |  167 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|      2 |  168 |  |
|  20184 |  169 | `	SyString *pName = &pAttr->sName;` |
|      - |  170 | `	sxi32 rc;` |
|  20184 |  171 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  20184 |  172 | `	return rc;` |
|      2 |  173 |  |
|      - |  174 | `/*` |
...
|      - |  177 | ` */` |
|  58210 |  178 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|      2 |  179 |  |
|  58212 |  180 | `	SyString *pName = &pMeth->sFunc.sName;` |
|      - |  181 | `	sxi32 rc;` |
|  58212 |  182 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  58212 |  183 | `	return rc;` |
|      2 |  184 |  |
|      - |  185 | `/*` |
...
|      - |  224 | ` * error message.` |
|      - |  225 | ` */` |
|  10038 |  226 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|      2 |  227 |  |
...
|  10040 |  234 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  10040 |  235 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  236 | `		return rc;` |
|      - |  237 | `	}` |
|      - |  238 | `	/* Copy public/protected attributes from the base class */` |
|  10040 |  239 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|  70064 |  240 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|      - |  241 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
|  60026 |  242 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  60026 |  243 | `		pName = &pAttr->sName;` |
|  60026 |  244 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
|  60024 |  256 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
|  60022 |  257 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  60022 |  258 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  259 | `				return rc;` |
|      - |  260 | `			}` |
|  30010 |  261 | `		}` |
|      2 |  262 | `	}` |
|  10040 |  263 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 100116 |  264 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|      - |  265 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
|  90078 |  266 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  90078 |  267 | `		pName = &pMeth->sFunc.sName;` |
|  90078 |  268 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   2028 |  269 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|   2028 |  278 | `			continue;` |
|    ! 0 |  279 | `		}else{` |
|  88052 |  280 | `			if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|  88050 |  289 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
|  88048 |  290 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  88048 |  291 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  292 | `				return rc;` |
|      - |  293 | `			}` |
|  44023 |  294 | `		}` |
|      2 |  295 | `	}` |
|      - |  296 | `	/* Mark as subclass */` |
|  10040 |  297 | `	pSub->pBase = pBase;` |
|      - |  298 | `	/* All done */` |
|  10040 |  299 | `	return SXRET_OK;` |
|   5021 |  300 |  |
|      - |  301 | `/*` |
...
|      - |  476 | ` */` |
|    964 |  477 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      2 |  478 |  |
|      - |  479 | `	ph7_class_instance *pThis;` |
|      - |  480 | `	/* Allocate a new instance */` |
|    966 |  481 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    966 |  482 | `	if( pThis == 0 ){` |
|    ! 0 |  483 | `		return 0;` |
|      - |  484 | `	}` |
|      - |  485 | `	/* Zero the structure */` |
|    966 |  486 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|      - |  487 | `	/* Initialize fields */` |
|    966 |  488 | `	pThis->iRef = 1;` |
|    966 |  489 | `	pThis->pVm = pVm;` |
|    966 |  490 | `	pThis->pClass = pClass;` |
|    966 |  491 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    966 |  492 | `	return pThis;` |
|    484 |  493 |  |
|      - |  494 | `/*` |
|      - |  495 | ` * Wrapper around the NewClassInstance() function defined above.` |
|      - |  496 | ` * See the block comment above for more information.` |
|      - |  497 | ` */` |
|    922 |  498 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      2 |  499 |  |
|      - |  500 | `	ph7_class_instance *pNew;` |
|      - |  501 | `	sxi32 rc;` |
|    924 |  502 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    924 |  503 | `	if( pNew == 0 ){` |
|    ! 0 |  504 | `		return 0;` |
|      - |  505 | `	}` |
|      - |  506 | `	/* Associate a private VM frame with this class instance */` |
|    924 |  507 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    924 |  508 | `	if( rc != SXRET_OK ){` |
...
|      - |  665 | ` * class instance.` |
|      - |  666 | ` */` |
|    692 |  667 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|      2 |  668 |  |
|      - |  669 | `	ph7_class_method *pDestr;` |
|      - |  670 | `	SyHashEntry *pEntry;` |
|      - |  671 | `	ph7_class *pClass;` |
|      - |  672 | `	ph7_vm *pVm;` |
|    694 |  673 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|      - |  674 | `		/*` |
...
|    694 |  681 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|      - |  682 | `	/* Invoke any defined destructor if available */` |
|    694 |  683 | `	pVm = pThis->pVm;` |
|    694 |  684 | `	pClass = pThis->pClass;` |
|    694 |  685 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    694 |  686 | `	if( pDestr ){` |
...
|    694 |  692 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   3482 |  693 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   2790 |  694 | `		VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|   2790 |  695 | `		if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|   2786 |  696 | `			PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   1392 |  697 | `		}` |
|   2790 |  698 | `		SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      2 |  699 | `	}` |
|      - |  700 | `	/* Release the whole structure */` |
|    694 |  701 | `	SyHashRelease(&pThis->hAttr);` |
|    694 |  702 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    348 |  703 |  |
|      - |  704 | `/*` |
...
|      - |  707 | ` */` |
|  11926 |  708 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|      2 |  709 |  |
|  11928 |  710 | `	pThis->iRef--;` |
|  11928 |  711 | `	if( pThis->iRef < 1 ){` |
|      - |  712 | `		/* No more reference to this instance */` |
|    694 |  713 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    346 |  714 | `	}` |
|  11928 |  715 |  |
|      - |  716 | `/*` |
