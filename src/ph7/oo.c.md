...
|      - |   13 | ` */` |
|  37602 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|      1 |   15 |  |
|      - |   16 | `	ph7_class *pClass;` |
|      - |   17 | `	char *zName;` |
|      - |   18 | `	/* Allocate a new instance */` |
|  37603 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  37603 |   20 | `	if( pClass == 0 ){` |
|    ! 0 |   21 | `		return 0;` |
|      - |   22 | `	}` |
|      - |   23 | `	/* Zero the structure */` |
|  37603 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|      - |   25 | `	/* Duplicate class name */` |
|  37603 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  37603 |   27 | `	if( zName == 0 ){` |
|    ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|    ! 0 |   29 | `		return 0;` |
|      - |   30 | `	}` |
|      - |   31 | `	/* Initialize fields */` |
|  37603 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  37603 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  37603 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  37603 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  37603 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  37603 |   37 | `	pClass->nLine = nLine;` |
|      - |   38 | `	/* All done */` |
|  37603 |   39 | `	return pClass;` |
|  18802 |   40 |  |
|      - |   41 | `/*` |
|      - |   42 | ` * Allocate and initialize a new class attribute.` |
|      - |   43 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|      - |   44 | ` */` |
|  53532 |   45 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|      1 |   46 |  |
|      - |   47 | `	ph7_class_attr *pAttr;` |
|      - |   48 | `	char *zName;` |
|  53533 |   49 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  53533 |   50 | `	if( pAttr == 0 ){` |
|    ! 0 |   51 | `		return 0;` |
|      - |   52 | `	}` |
|      - |   53 | `	/* Zero the structure */` |
|  53533 |   54 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|      - |   55 | `	/* Duplicate attribute name */` |
|  53533 |   56 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  53533 |   57 | `	if( zName == 0 ){` |
|    ! 0 |   58 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|    ! 0 |   59 | `		return 0;` |
|      - |   60 | `	}` |
|      - |   61 | `	/* Initialize fields */` |
|  53533 |   62 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  53533 |   63 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  53533 |   64 | `	pAttr->iProtection = iProtection;` |
|  53533 |   65 | `	pAttr->nIdx = SXU32_HIGH;` |
|  53533 |   66 | `	pAttr->iFlags = iFlags;` |
|  53533 |   67 | `	pAttr->nLine = nLine;` |
|  53533 |   68 | `	return pAttr;` |
|  26767 |   69 |  |
|      - |   70 | `/*` |
...
|      - |   75 | ` */` |
| 154894 |   76 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 154895 |   86 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 154895 |   87 | `	if( pMeth == 0 ){` |
|    ! 0 |   88 | `		return 0;` |
|      - |   89 | `	}` |
|      - |   90 | `	/* Zero the structure */` |
| 154895 |   91 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|      - |   92 | `	/* Check for an already installed method with the same name */` |
| 154895 |   93 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 154895 |   94 | `	if( pEntry == 0 ){` |
|      - |   95 | `		/* Associate an unique VM name to this method */` |
| 154893 |   96 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 154893 |   97 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 154893 |   98 | `		if( zName == 0 ){` |
|    ! 0 |   99 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|    ! 0 |  100 | `			return 0;` |
|      - |  101 | `		}` |
| 154893 |  102 | `		pNamePtr = &pMeth->sVmName;` |
|      - |  103 | `		/* Generate a random string */` |
| 154893 |  104 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 154893 |  105 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 154893 |  106 | `		pNamePtr->zString = zName;` |
|  77447 |  107 | `	}else{` |
...
|      - |  114 | `	}` |
| 154895 |  115 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
| 154897 |  124 | `	pMeth->iProtection = iProtection;` |
| 154897 |  125 | `	pMeth->iFlags = iFlags;` |
| 154897 |  126 | `	pMeth->nLine = nLine;` |
| 232346 |  127 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 154896 |  128 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 154897 |  129 | `	return pMeth;` |
|  77450 |  130 |  |
|      - |  131 | `/*` |
...
|      - |  134 | ` */` |
|   1636 |  135 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|      1 |  136 |  |
|      - |  137 | `	SyHashEntry *pEntry;` |
|      - |  138 | `	/* Perform a hash lookup */` |
|   1637 |  139 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|   1637 |  140 | `	if( pEntry == 0 ){` |
|      - |  141 | `		/* No such entry */` |
|    931 |  142 | `		return 0;` |
|      - |  143 | `	}` |
|      - |  144 | `	/* Point to the desired method */` |
|    707 |  145 | `	return (ph7_class_method *)pEntry->pUserData;` |
|    819 |  146 |  |
|      - |  147 | `/*` |
...
|      - |  166 | ` */` |
|  53532 |  167 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|      1 |  168 |  |
|  53533 |  169 | `	SyString *pName = &pAttr->sName;` |
|      - |  170 | `	sxi32 rc;` |
|  53533 |  171 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  53533 |  172 | `	return rc;` |
|      1 |  173 |  |
|      - |  174 | `/*` |
...
|      - |  177 | ` */` |
| 154892 |  178 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|      1 |  179 |  |
| 154893 |  180 | `	SyString *pName = &pMeth->sFunc.sName;` |
|      - |  181 | `	sxi32 rc;` |
| 154893 |  182 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 154893 |  183 | `	return rc;` |
|      1 |  184 |  |
|      - |  185 | `/*` |
...
|      - |  224 | ` * error message.` |
|      - |  225 | ` */` |
|   5374 |  226 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|      1 |  227 |  |
...
|   5375 |  234 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   5375 |  235 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  236 | `		return rc;` |
|      - |  237 | `	}` |
|      - |  238 | `	/* Copy public/protected attributes from the base class */` |
|   5375 |  239 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|  37405 |  240 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|      - |  241 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
|  32031 |  242 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  32031 |  243 | `		pName = &pAttr->sName;` |
|  32031 |  244 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|      5 |  245 | `			if( pAttr->iProtection == PH7_CLASS_PROT_PRIVATE &&` |
|      4 |  246 | `				((ph7_class_attr *)pEntry->pUserData)->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|      - |  247 | `					/* Cannot redeclare private attribute */` |
|      7 |  248 | `					PH7_GenCompileError(&(*pGen),E_WARNING,((ph7_class_attr *)pEntry->pUserData)->nLine,` |
|      - |  249 | `						"Private attribute '%z::%z' redeclared inside child class '%z'",` |
|      2 |  250 | `						&pBase->sName,pName,&pSub->sName);` |
|      - |  251 |  |
|      2 |  252 | `			}` |
|      5 |  253 | `			continue;` |
|      - |  254 | `		}` |
|      - |  255 | `		/* Install the attribute */` |
|  32027 |  256 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
|  32025 |  257 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  32025 |  258 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  259 | `				return rc;` |
|      - |  260 | `			}` |
|  16012 |  261 | `		}` |
|      1 |  262 | `	}` |
|   5375 |  263 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|  53457 |  264 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|      - |  265 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
|  48083 |  266 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  48083 |  267 | `		pName = &pMeth->sFunc.sName;` |
|  48083 |  268 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   5361 |  269 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|   5361 |  278 | `			continue;` |
|    ! 0 |  279 | `		}else{` |
|  42723 |  280 | `			if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|  42721 |  289 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
|  42719 |  290 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  42719 |  291 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  292 | `				return rc;` |
|      - |  293 | `			}` |
|  21359 |  294 | `		}` |
|      1 |  295 | `	}` |
|      - |  296 | `	/* Mark as subclass */` |
|   5375 |  297 | `	pSub->pBase = pBase;` |
|      - |  298 | `	/* All done */` |
|   5375 |  299 | `	return SXRET_OK;` |
|   2688 |  300 |  |
|      - |  301 | `/*` |
...
|      - |  476 | ` */` |
|    558 |  477 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      1 |  478 |  |
|      - |  479 | `	ph7_class_instance *pThis;` |
|      - |  480 | `	/* Allocate a new instance */` |
|    559 |  481 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    559 |  482 | `	if( pThis == 0 ){` |
|    ! 0 |  483 | `		return 0;` |
|      - |  484 | `	}` |
|      - |  485 | `	/* Zero the structure */` |
|    559 |  486 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|      - |  487 | `	/* Initialize fields */` |
|    559 |  488 | `	pThis->iRef = 1;` |
|    559 |  489 | `	pThis->pVm = pVm;` |
|    559 |  490 | `	pThis->pClass = pClass;` |
|    559 |  491 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    559 |  492 | `	return pThis;` |
|    280 |  493 |  |
|      - |  494 | `/*` |
|      - |  495 | ` * Wrapper around the NewClassInstance() function defined above.` |
|      - |  496 | ` * See the block comment above for more information.` |
|      - |  497 | ` */` |
|    516 |  498 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      1 |  499 |  |
|      - |  500 | `	ph7_class_instance *pNew;` |
|      - |  501 | `	sxi32 rc;` |
|    517 |  502 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    517 |  503 | `	if( pNew == 0 ){` |
|    ! 0 |  504 | `		return 0;` |
|      - |  505 | `	}` |
|      - |  506 | `	/* Associate a private VM frame with this class instance */` |
|    517 |  507 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    517 |  508 | `	if( rc != SXRET_OK ){` |
...
|    541 |  522 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|    541 |  523 | `	return pValue;` |
|      1 |  524 |  |
|      - |  525 | `/*` |
...
|     43 |  618 | `	pVm = pSrc->pVm;` |
|     43 |  619 | `	pClone = NewClassInstance(pVm,pSrc->pClass);` |
|     43 |  620 | `	if( pClone == 0 ){` |
|    ! 0 |  621 | `		return 0;` |
|      - |  622 | `	}` |
|      - |  623 | `	/* Associate a private VM frame with this class instance */` |
|     43 |  624 | `	rc = PH7_VmCreateClassInstanceFrame(pVm,pClone);` |
|     43 |  625 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  626 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClone);` |
|    ! 0 |  627 | `		return 0;` |
|      - |  628 | `	}` |
|      - |  629 | `	/* Duplicate object values */` |
|     43 |  630 | `	SyHashResetLoopCursor(&pSrc->hAttr);` |
|     43 |  631 | `	SyHashResetLoopCursor(&pClone->hAttr);` |
|    110 |  632 | `	while((pEntry = SyHashGetNextEntry(&pSrc->hAttr)) != 0 && (pEntry2 = SyHashGetNextEntry(&pClone->hAttr)) != 0 ){` |
|     47 |  633 | `		VmClassAttr *pSrcAttr = (VmClassAttr *)pEntry->pUserData;` |
|     47 |  634 | `		VmClassAttr *pDestAttr = (VmClassAttr *)pEntry2->pUserData;` |
|      - |  635 | `		/* Duplicate non-static attribute */` |
|     47 |  636 | `		if( (pSrcAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|      - |  637 | `			ph7_value *pvSrc,*pvDest;` |
|     47 |  638 | `			pvSrc = ExtractClassAttrValue(pVm,pSrcAttr);` |
|     47 |  639 | `			pvDest = ExtractClassAttrValue(pVm,pDestAttr);` |
|     47 |  640 | `			if( pvSrc && pvDest ){` |
|     47 |  641 | `				PH7_MemObjStore(pvSrc,pvDest);` |
|     23 |  642 | `			}` |
|     23 |  643 | `		}` |
|      1 |  644 | `	}` |
|      - |  645 | `	/* call the __clone method on the cloned object if available */` |
|     43 |  646 | `	pMethod = PH7_ClassExtractMethod(pClone->pClass,"__clone",sizeof("__clone")-1);` |
|     43 |  647 | `	if( pMethod ){` |
|     37 |  648 | `		if( pMethod->iCloneDepth < 16 ){` |
|     35 |  649 | `			pMethod->iCloneDepth++;` |
|     35 |  650 | `			PH7_VmCallClassMethod(pVm,pClone,pMethod,0,0,0);` |
|     18 |  651 | `		}else{` |
...
|     37 |  656 | `		pMethod->iCloneDepth = 0;` |
|     18 |  657 | `	}` |
|      - |  658 | `	/* Return the cloned object */` |
|     43 |  659 | `	return pClone;` |
|     22 |  660 |  |
...
|      - |  665 | ` * class instance.` |
|      - |  666 | ` */` |
|     34 |  667 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|      1 |  668 |  |
|      - |  669 | `	ph7_class_method *pDestr;` |
|      - |  670 | `	SyHashEntry *pEntry;` |
|      - |  671 | `	ph7_class *pClass;` |
|      - |  672 | `	ph7_vm *pVm;` |
|     35 |  673 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|      - |  674 | `		/*` |
...
|     35 |  681 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|      - |  682 | `	/* Invoke any defined destructor if available */` |
|     35 |  683 | `	pVm = pThis->pVm;` |
|     35 |  684 | `	pClass = pThis->pClass;` |
|     35 |  685 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|     35 |  686 | `	if( pDestr ){` |
...
|     35 |  692 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|    145 |  693 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|    111 |  694 | `		VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|    111 |  695 | `		if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|    111 |  696 | `			PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|     55 |  697 | `		}` |
|    111 |  698 | `		SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      1 |  699 | `	}` |
|      - |  700 | `	/* Release the whole structure */` |
|     35 |  701 | `	SyHashRelease(&pThis->hAttr);` |
|     35 |  702 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|     18 |  703 |  |
|      - |  704 | `/*` |
...
|      - |  707 | ` */` |
|   4282 |  708 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|      1 |  709 |  |
|   4283 |  710 | `	pThis->iRef--;` |
|   4283 |  711 | `	if( pThis->iRef < 1 ){` |
|      - |  712 | `		/* No more reference to this instance */` |
|     35 |  713 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|     17 |  714 | `	}` |
|   4283 |  715 |  |
|      - |  716 | `/*` |
...
|    157 |  804 | `	if( pLeft->pClass != pRight->pClass ){` |
|      7 |  805 | `		return 1;` |
|      - |  806 | `	}` |
|    151 |  807 | `	if( bStrict ){` |
|      - |  808 | `		/*` |
...
|      - |  822 | `	 */` |
|    141 |  823 | `	if( pLeft == pRight ){` |
|      - |  824 | `		/* Same instance,don't bother processing,object are equals */` |
|      3 |  825 | `		return 0;` |
|      - |  826 | `	}` |
|    139 |  827 | `	SyHashResetLoopCursor(&pLeft->hAttr);` |
|    139 |  828 | `	SyHashResetLoopCursor(&pRight->hAttr);` |
|    139 |  829 | `	PH7_MemObjInit(pLeft->pVm,&sV1);` |
|    139 |  830 | `	PH7_MemObjInit(pLeft->pVm,&sV2);` |
|    139 |  831 | `	sV1.nIdx = sV2.nIdx = SXU32_HIGH;` |
|    222 |  832 | `	while((pEntry = SyHashGetNextEntry(&pLeft->hAttr)) != 0 && (pEntry2 = SyHashGetNextEntry(&pRight->hAttr)) != 0 ){` |
|    145 |  833 | `		VmClassAttr *p1 = (VmClassAttr *)pEntry->pUserData;` |
|    145 |  834 | `		VmClassAttr *p2 = (VmClassAttr *)pEntry2->pUserData;` |
|      - |  835 | `		/* Compare only non-static attribute */` |
|    145 |  836 | `		if( (p1->pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC)) == 0 ){` |
|      - |  837 | `			ph7_value *pL,*pR;` |
|    145 |  838 | `			pL = ExtractClassAttrValue(pLeft->pVm,p1);` |
|    145 |  839 | `			pR = ExtractClassAttrValue(pRight->pVm,p2);` |
|    145 |  840 | `			if( pL && pR ){` |
|    145 |  841 | `				PH7_MemObjLoad(pL,&sV1);` |
|    145 |  842 | `				PH7_MemObjLoad(pR,&sV2);` |
|      - |  843 | `				/* Compare the two values now */` |
|    145 |  844 | `				rc = PH7_MemObjCmp(&sV1,&sV2,bStrict,iNest+1);` |
|    145 |  845 | `				PH7_MemObjRelease(&sV1);` |
|    145 |  846 | `				PH7_MemObjRelease(&sV2);` |
|    145 |  847 | `				if( rc != 0 ){` |
|      - |  848 | `					/* Not equals */` |
|    131 |  849 | `					return rc;` |
|      - |  850 | `				}` |
