...
|      - |   13 | ` */` |
| 120120 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|      2 |   15 |  |
|      - |   16 | `	ph7_class *pClass;` |
|      - |   17 | `	char *zName;` |
|      - |   18 | `	/* Allocate a new instance */` |
| 120122 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
| 120122 |   20 | `	if( pClass == 0 ){` |
|    ! 0 |   21 | `		return 0;` |
|      - |   22 | `	}` |
|      - |   23 | `	/* Zero the structure */` |
| 120122 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|      - |   25 | `	/* Duplicate class name */` |
| 120122 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 120122 |   27 | `	if( zName == 0 ){` |
|    ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|    ! 0 |   29 | `		return 0;` |
|      - |   30 | `	}` |
|      - |   31 | `	/* Initialize fields */` |
| 120122 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
| 120122 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
| 120122 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
| 120122 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
| 120122 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
| 120122 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
| 120122 |   38 | `	pClass->nLine = nLine;` |
|      - |   39 | `	/* All done */` |
| 120122 |   40 | `	return pClass;` |
|  60062 |   41 |  |
|      - |   42 | `/*` |
|      - |   43 | ` * Allocate and initialize a new class attribute.` |
|      - |   44 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|      - |   45 | ` */` |
|  60100 |   46 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|      2 |   47 |  |
|      - |   48 | `	ph7_class_attr *pAttr;` |
|      - |   49 | `	char *zName;` |
|  60102 |   50 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  60102 |   51 | `	if( pAttr == 0 ){` |
|    ! 0 |   52 | `		return 0;` |
|      - |   53 | `	}` |
|      - |   54 | `	/* Zero the structure */` |
|  60102 |   55 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|      - |   56 | `	/* Duplicate attribute name */` |
|  60102 |   57 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  60102 |   58 | `	if( zName == 0 ){` |
|    ! 0 |   59 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|    ! 0 |   60 | `		return 0;` |
|      - |   61 | `	}` |
|      - |   62 | `	/* Initialize fields */` |
|  60102 |   63 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  60102 |   64 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  60102 |   65 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  60102 |   66 | `	pAttr->iProtection = iProtection;` |
|  60102 |   67 | `	pAttr->nIdx = SXU32_HIGH;` |
|  60102 |   68 | `	pAttr->iFlags = iFlags;` |
|  60102 |   69 | `	pAttr->nLine = nLine;` |
|  60102 |   70 | `	return pAttr;` |
|  30052 |   71 |  |
|      - |   72 | `/*` |
...
|      - |   77 | ` */` |
| 235892 |   78 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 235894 |   88 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 235894 |   89 | `	if( pMeth == 0 ){` |
|    ! 0 |   90 | `		return 0;` |
|      - |   91 | `	}` |
|      - |   92 | `	/* Zero the structure */` |
| 235894 |   93 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|      - |   94 | `	/* Check for an already installed method with the same name */` |
| 235894 |   95 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 235894 |   96 | `	if( pEntry == 0 ){` |
|      - |   97 | `		/* Associate an unique VM name to this method */` |
| 235892 |   98 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 235892 |   99 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 235892 |  100 | `		if( zName == 0 ){` |
|    ! 0 |  101 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|    ! 0 |  102 | `			return 0;` |
|      - |  103 | `		}` |
| 235892 |  104 | `		pNamePtr = &pMeth->sVmName;` |
|      - |  105 | `		/* Generate a random string */` |
| 235892 |  106 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 235892 |  107 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 235892 |  108 | `		pNamePtr->zString = zName;` |
| 117947 |  109 | `	}else{` |
...
|      - |  116 | `	}` |
| 235894 |  117 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
| 235896 |  126 | `	pMeth->iProtection = iProtection;` |
| 235896 |  127 | `	pMeth->iFlags = iFlags;` |
| 235896 |  128 | `	pMeth->nLine = nLine;` |
| 353844 |  129 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 235894 |  130 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 235896 |  131 | `	return pMeth;` |
| 117950 |  132 |  |
|      - |  133 | `/*` |
...
|      - |  136 | ` */` |
| 151670 |  137 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|      2 |  138 |  |
|      - |  139 | `	SyHashEntry *pEntry;` |
|      - |  140 | `	/* Perform a hash lookup */` |
| 151672 |  141 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
| 151672 |  142 | `	if( pEntry == 0 ){` |
|      - |  143 | `		/* No such entry */` |
|   3462 |  144 | `		return 0;` |
|      - |  145 | `	}` |
|      - |  146 | `	/* Point to the desired method */` |
| 148212 |  147 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  75837 |  148 |  |
|      - |  149 | `/*` |
...
|      - |  152 | ` */` |
|  60160 |  153 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|      2 |  154 |  |
|      - |  155 | `	SyHashEntry *pEntry;` |
|      - |  156 | `	/* Perform a hash lookup */` |
|  60162 |  157 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  60162 |  158 | `	if( pEntry == 0 ){` |
|      - |  159 | `		/* No such entry */` |
|  60070 |  160 | `		return 0;` |
|      - |  161 | `	}` |
|      - |  162 | `	/* Point to the desierd method */` |
|     94 |  163 | `	return (ph7_class_attr *)pEntry->pUserData;` |
|  30082 |  164 |  |
|      - |  165 | `/*` |
...
|      - |  168 | ` */` |
|  60100 |  169 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|      2 |  170 |  |
|  60102 |  171 | `	SyString *pName = &pAttr->sName;` |
|      - |  172 | `	sxi32 rc;` |
...
|  60102 |  176 | `	if( pAttr->pDeclClass == 0 ){` |
|  60102 |  177 | `		pAttr->pDeclClass = pClass;` |
|  30050 |  178 | `	}` |
|  60102 |  179 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  60102 |  180 | `	return rc;` |
|      2 |  181 |  |
|      - |  182 | `/*` |
...
|      - |  185 | ` */` |
| 235882 |  186 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|      2 |  187 |  |
| 235884 |  188 | `	SyString *pName = &pMeth->sFunc.sName;` |
|      - |  189 | `	sxi32 rc;` |
| 235884 |  190 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 235884 |  191 | `	return rc;` |
|      2 |  192 |  |
|      - |  193 | `/*` |
...
|      - |  232 | ` * error message.` |
|      - |  233 | ` */` |
|  65956 |  234 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|      2 |  235 |  |
...
|  65958 |  242 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  65958 |  243 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  244 | `		return rc;` |
|      - |  245 | `	}` |
|      - |  246 | `	/* Copy public/protected attributes from the base class */` |
|  65958 |  247 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 461212 |  248 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|      - |  249 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 395256 |  250 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 395256 |  251 | `		pName = &pAttr->sName;` |
| 395256 |  252 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 395252 |  264 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 395248 |  265 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 395248 |  266 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  267 | `				return rc;` |
|      - |  268 | `			}` |
| 197623 |  269 | `		}` |
|      2 |  270 | `	}` |
|  65958 |  271 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 658908 |  272 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|      - |  273 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 592952 |  274 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 592952 |  275 | `		pName = &pMeth->sFunc.sName;` |
| 592952 |  276 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   3168 |  277 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
| 589786 |  289 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 589784 |  290 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 589784 |  291 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  292 | `				return rc;` |
|      - |  293 | `			}` |
| 294891 |  294 | `		}` |
|      2 |  295 | `	}` |
|      - |  296 | `	/* Mark as subclass */` |
|  65958 |  297 | `	pSub->pBase = pBase;` |
|      - |  298 | `	/* All done */` |
|  65958 |  299 | `	return SXRET_OK;` |
|  32980 |  300 |  |
|      - |  301 | `/*` |
...
|      - |  422 | ` * error message.` |
|      - |  423 | ` */` |
|   9410 |  424 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|      2 |  425 |  |
...
|   9412 |  432 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   9412 |  433 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|      - |  434 | `	/* Copy constants */` |
|  14119 |  435 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|      1 |  445 | `		}` |
|      1 |  446 | `	}` |
|   9412 |  447 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|      - |  448 | `	/* Copy methods signature */` |
|  17293 |  449 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|      - |  450 | `		/* Make sure the method are not redeclared in the subclass */` |
|   3178 |  451 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   3178 |  452 | `		pName = &pMeth->sFunc.sName;` |
|   3178 |  453 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|      - |  454 | `			/* Install the method */` |
|   3178 |  455 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   3178 |  456 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  457 | `				return rc;` |
|      - |  458 | `			}` |
|   1588 |  459 | `		}` |
|      2 |  460 | `	}` |
|      - |  461 | `	/* Mark as subclass */` |
|   9412 |  462 | `	pSub->pBase = pBase;` |
|      - |  463 | `	/* All done */` |
|   9412 |  464 | `	return SXRET_OK;` |
|   4707 |  465 |  |
|      - |  466 | `/*` |
...
|      - |  477 | ` * error message.` |
|      - |  478 | ` */` |
|  84804 |  479 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|      2 |  480 |  |
...
|  84806 |  486 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
| 127210 |  487 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
...
|  84806 |  501 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|      - |  510 | `		SyString *pMName;` |
|  84806 |  511 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 268618 |  512 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
| 141412 |  513 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
| 141412 |  514 | `			pMName = &pMeth->sFunc.sName;` |
| 141412 |  515 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|   1574 |  819 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   7618 |  820 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   6046 |  821 | `		VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|   6046 |  822 | `		if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   6028 |  826 | `			if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|    200 |  827 | `				SyHashDeleteEntry(&pVm->hTypedSlot,` |
|    132 |  828 | `					(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     66 |  829 | `			}` |
|   6028 |  830 | `			PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   3013 |  831 | `		}` |
|   6046 |  832 | `		SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      2 |  833 | `	}` |
|      - |  834 | `	/* Release the whole structure */` |
|   1574 |  835 | `	SyHashRelease(&pThis->hAttr);` |
|   1574 |  836 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    794 |  837 |  |
|      - |  838 | `/*` |
...
|      - |  841 | ` */` |
|  27244 |  842 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|      2 |  843 |  |
|  27246 |  844 | `	pThis->iRef--;` |
|  27246 |  845 | `	if( pThis->iRef < 1 ){` |
|      - |  846 | `		/* No more reference to this instance */` |
|   1586 |  847 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    792 |  848 | `	}` |
|  27246 |  849 |  |
|      - |  850 | `/*` |
...
|      - | 1096 | ` */` |
|      2 | 1097 | `PH7_PRIVATE sxi32 PH7_ClassInstanceCallMagicMethod(` |
...
|    ! 0 | 1126 | `	rc = PH7_VmCallClassMethod(pVm,&(*pThis),pMeth,0,nArg,apArg);` |
|      - | 1127 | `	/* Clean up */` |
|    ! 0 | 1128 | `	if( pAttrName ){` |
...
|      - | 1136 | ` */` |
|     22 | 1137 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceExtractAttrValue(ph7_class_instance *pThis,VmClassAttr *pAttr)` |
|      2 | 1138 |  |
|      - | 1139 | `   /* Extract the attribute value */` |
|      - | 1140 | `	ph7_value *pValue;` |
|     24 | 1141 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|     24 | 1142 | `	return pValue;` |
|      2 | 1143 |  |
|      - | 1144 | `/*` |
...
|      - | 1209 | ` */` |
|      2 | 1210 | `PH7_PRIVATE sxi32 PH7_ClassInstanceWalk(` |
...
|      3 | 1222 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|      3 | 1223 | `	PH7_MemObjInit(pThis->pVm,&sValue);` |
|      - | 1224 | `	/* Start the walk process */` |
|      8 | 1225 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|      - | 1226 | `		/* Point to the current attribute */` |
|      5 | 1227 | `		pAttr = (VmClassAttr *)pEntry->pUserData;` |
|      - | 1228 | `		/* Extract attribute value */` |
|      5 | 1229 | `		pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|      5 | 1230 | `		if( pValue ){` |
|      5 | 1231 | `			PH7_MemObjLoad(pValue,&sValue);` |
|      - | 1232 | `			/* Invoke the supplied callback */` |
|      5 | 1233 | `			rc =  xWalk(SyStringData(&pAttr->pAttr->sName),&sValue,pUserData);` |
|      5 | 1234 | `			PH7_MemObjRelease(&sValue);` |
|      5 | 1235 | `			if( rc != PH7_OK){` |
...
|      - | 1251 | ` */` |
|    432 | 1252 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceFetchAttr(ph7_class_instance *pThis,const SyString *pName)` |
|      2 | 1253 |  |
|      - | 1254 | `	SyHashEntry *pEntry;` |
|      - | 1255 | `	VmClassAttr *pAttr;` |
|      - | 1256 | `	/* Query the attribute hashtable */` |
|    434 | 1257 | `	pEntry = SyHashGet(&pThis->hAttr,(const void *)pName->zString,pName->nByte);` |
|    434 | 1258 | `	if( pEntry == 0 ){` |
|      - | 1259 | `		/* No such attribute */` |
|    ! 0 | 1260 | `		return 0;` |
|      - | 1261 | `	}` |
|      - | 1262 | `	/* Point to the class atrribute */` |
|    434 | 1263 | `	pAttr = (VmClassAttr *)pEntry->pUserData;` |
|      - | 1264 | `	/* Check if we are dealing with a static/constant attribute */` |
|    434 | 1265 | `	if( pAttr->pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|      - | 1266 | `		/* Access is forbidden */` |
|    ! 0 | 1267 | `		return 0;` |
|      - | 1268 | `	}` |
|      - | 1269 | `	/* Return the attribute value */` |
|    434 | 1270 | `	return ExtractClassAttrValue(pThis->pVm,pAttr);` |
|    218 | 1271 |  |
|      - | 1272 |  |
