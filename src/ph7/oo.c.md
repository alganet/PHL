...
|       - |   13 | ` */` |
|  522364 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  522369 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  522369 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  522369 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  522369 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  522369 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  522369 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  522369 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  522369 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  522369 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  522369 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  522369 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  522369 |   38 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  522369 |   39 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  522369 |   40 | `	pClass->nLine = nLine;` |
|  522369 |   41 | `	if( pVm->bCompilingBuiltin ){` |
...
|  520193 |   44 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  260099 |   45 | `	}else{` |
|       - |   46 | `		/* Alias the VM-lifetime path dup on top of the include stack */` |
|    2181 |   47 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    2181 |   48 | `		if( pFile ){` |
|    2181 |   49 | `			SyStringDupPtr(&pClass->sFile,pFile);` |
|    1088 |   50 | `		}` |
|       - |   51 | `	}` |
|       - |   52 | `	/* All done */` |
|  522369 |   53 | `	return pClass;` |
|  261187 |   54 | `}` |
|       - |   55 | `/*` |
|       - |   56 | ` * Allocate and initialize a new class attribute.` |
|       - |   57 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   58 | ` */` |
|  948626 |   59 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   60 | `{` |
|       - |   61 | `	ph7_class_attr *pAttr;` |
|       - |   62 | `	char *zName;` |
|  948631 |   63 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  948631 |   64 | `	if( pAttr == 0 ){` |
|     ! 0 |   65 | `		return 0;` |
|       - |   66 | `	}` |
|       - |   67 | `	/* Zero the structure */` |
|  948631 |   68 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  948631 |   69 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   70 | `	/* Duplicate attribute name */` |
|  948631 |   71 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  948631 |   72 | `	if( zName == 0 ){` |
|     ! 0 |   73 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   74 | `		return 0;` |
|       - |   75 | `	}` |
|       - |   76 | `	/* Initialize fields */` |
|  948631 |   77 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  948631 |   78 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  948631 |   79 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  948631 |   80 | `	pAttr->iProtection = iProtection;` |
|  948631 |   81 | `	pAttr->nIdx = SXU32_HIGH;` |
|  948631 |   82 | `	pAttr->iFlags = iFlags;` |
|  948631 |   83 | `	pAttr->nLine = nLine;` |
|  948631 |   84 | `	return pAttr;` |
|  474318 |   85 | `}` |
|       - |   86 | `/*` |
...
|       - |   91 | ` */` |
| 2897994 |   92 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2897999 |  102 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2897999 |  103 | `	if( pMeth == 0 ){` |
|     ! 0 |  104 | `		return 0;` |
|       - |  105 | `	}` |
|       - |  106 | `	/* Zero the structure */` |
| 2897999 |  107 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  108 | `	/* Check for an already installed method with the same name */` |
| 2897999 |  109 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2897999 |  110 | `	if( pEntry == 0 ){` |
|       - |  111 | `		/* Associate an unique VM name to this method */` |
| 2897997 |  112 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2897997 |  113 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2897997 |  114 | `		if( zName == 0 ){` |
|     ! 0 |  115 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  116 | `			return 0;` |
|       - |  117 | `		}` |
| 2897997 |  118 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  119 | `		/* Generate a random string */` |
| 2897997 |  120 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2897997 |  121 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2897997 |  122 | `		pNamePtr->zString = zName;` |
| 1449001 |  123 | `	}else{` |
...
|       - |  130 | `	}` |
| 2897999 |  131 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  167004 |  132 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  167009 |  133 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2897999 |  144 | `	pMeth->iProtection = iProtection;` |
| 2897999 |  145 | `	pMeth->iFlags = iFlags;` |
| 2897999 |  146 | `	pMeth->nLine = nLine;` |
| 4346996 |  147 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2897994 |  148 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2897999 |  149 | `	return pMeth;` |
| 1449002 |  150 | `}` |
|       - |  151 | `/*` |
...
|       - |  154 | ` */` |
|  900584 |  155 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  156 | `{` |
|       - |  157 | `	SyHashEntry *pEntry;` |
|       - |  158 | `	/* Perform a hash lookup */` |
|  900589 |  159 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  900589 |  160 | `	if( pEntry == 0 ){` |
|       - |  161 | `		/* No such entry */` |
|   30205 |  162 | `		return 0;` |
|       - |  163 | `	}` |
|       - |  164 | `	/* Point to the desired method */` |
|  870389 |  165 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  450297 |  166 | `}` |
|       - |  167 | `/*` |
...
|       - |  170 | ` */` |
|  592734 |  171 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  172 | `{` |
|       - |  173 | `	SyHashEntry *pEntry;` |
|       - |  174 | `	/* Perform a hash lookup */` |
|  592739 |  175 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  592739 |  176 | `	if( pEntry == 0 ){` |
|       - |  177 | `		/* No such entry */` |
|  591287 |  178 | `		return 0;` |
|       - |  179 | `	}` |
...
|       - |  186 | ` */` |
|  948622 |  187 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  188 | `{` |
|  948627 |  189 | `	SyString *pName = &pAttr->sName;` |
|       - |  190 | `	sxi32 rc;` |
...
|  948627 |  194 | `	if( pAttr->pDeclClass == 0 ){` |
|  948627 |  195 | `		pAttr->pDeclClass = pClass;` |
|  474311 |  196 | `	}` |
|  948627 |  197 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  948627 |  198 | `	return rc;` |
|       5 |  199 | `}` |
|       - |  200 | `/*` |
...
|       - |  203 | ` */` |
| 2897982 |  204 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  205 | `{` |
| 2897987 |  206 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  207 | `	sxi32 rc;` |
| 2897987 |  208 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2897987 |  209 | `	return rc;` |
|       5 |  210 | `}` |
|       - |  211 | `/*` |
...
|       - |  233 | ` */` |
|  279736 |  234 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  235 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  236 | `{` |
|  279741 |  237 | `	*ppClass = 0;` |
|  279741 |  238 | `	if( bUnion ){` |
|       3 |  239 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  240 | `	}` |
|  279739 |  241 | `	if( nType == 0 ){` |
|  279635 |  242 | `		return OVT_NONE; /* no declared type */` |
|       - |  243 | `	}` |
...
|       - |  286 | `	int bNullable;` |
|       - |  287 | `};` |
|  209796 |  288 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  289 | `{` |
|       - |  290 | `	OvType t;` |
|  209801 |  291 | `	t.nType = pF->nReturnType;` |
|  209801 |  292 | `	t.pClass = &pF->sReturnClass;` |
|  209801 |  293 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  209801 |  294 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  209801 |  295 | `	return t;` |
|       5 |  296 | `}` |
|   69940 |  297 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  298 | `{` |
|       - |  299 | `	OvType t;` |
|   69945 |  300 | `	t.nType = pA->nType;` |
|   69945 |  301 | `	t.pClass = &pA->sClass;` |
|   69945 |  302 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   69945 |  303 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   69945 |  304 | `	return t;` |
|       5 |  305 | `}` |
|       - |  306 | `/*` |
...
|       - |  311 | ` */` |
|  139868 |  312 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  313 | `{` |
|       - |  314 | `	ph7_class *pParentCls, *pChildCls;` |
|  139873 |  315 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|  139873 |  316 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|  139873 |  317 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|  139855 |  325 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|  139825 |  326 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|  139825 |  327 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|  139825 |  328 | `		return 0;` |
|       - |  329 | `	}` |
...
|       - |  355 | ` */` |
|  147608 |  356 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  357 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  358 | `{` |
|  147613 |  359 | `	ph7_vm *pVm = pGen->pVm;` |
|  147613 |  360 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|  147613 |  361 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|  147613 |  362 | `	SyString *pMName = &pCF->sName;` |
|       - |  363 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  364 | `	sxu32 nPArg, nCArg, k;` |
|  147613 |  365 | `	int bBad = 0;` |
|  147608 |  366 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   97109 |  367 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   42715 |  368 | `		return SXRET_OK;` |
|       - |  369 | `	}` |
|       - |  370 | `	/* Return type — covariant. */` |
|  104903 |  371 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  372 | `	/* Each overlapping parameter — contravariant. */` |
|  104903 |  373 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|  104903 |  374 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|  104903 |  375 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|  104903 |  376 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|  139873 |  377 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   34975 |  378 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|   17490 |  379 | `	}` |
...
|  104903 |  384 | `	if( !bBad ){` |
|  104899 |  385 | `		int bVariadic = 0;` |
|  139867 |  386 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  139869 |  387 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  104899 |  388 | `		if( !bVariadic ){` |
|  104899 |  389 | `			if( nCArg < nPArg ){` |
|     ! 0 |  390 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  391 | `			}else{` |
|  104901 |  392 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  447 | ` * error message.` |
|       - |  448 | ` */` |
|  240976 |  449 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  450 | `{` |
...
|  240981 |  457 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  240981 |  458 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  459 | `		return rc;` |
|       - |  460 | `	}` |
...
|  240981 |  463 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  240981 |  478 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1367297 |  479 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  480 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 1126321 |  481 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 1126321 |  482 | `		pName = &pAttr->sName;` |
| 1126321 |  483 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 1126298 |  509 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  716571 |  510 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
| 1126297 |  511 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 1126297 |  512 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  513 | `				return rc;` |
|       - |  514 | `			}` |
|  563146 |  515 | `		}` |
|       5 |  516 | `	}` |
|  240981 |  517 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 3545579 |  518 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  519 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 3304603 |  520 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 3304603 |  521 | `		pName = &pMeth->sFunc.sName;` |
| 3304603 |  522 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  147617 |  523 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  221417 |  534 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|  147608 |  535 | `					(ph7_class_method *)pEntry->pUserData);` |
|  147613 |  536 | `				if( rc == SXERR_ABORT ){` |
...
| 3156986 |  550 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1594035 |  551 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 3156991 |  552 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 3156991 |  553 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  554 | `				return rc;` |
|       - |  555 | `			}` |
| 1578493 |  556 | `		}` |
|       5 |  557 | `	}` |
|       - |  558 | `	/* Mark as subclass */` |
|  240981 |  559 | `	pSub->pBase = pBase;` |
|       - |  560 | `	/* All done */` |
|  240981 |  561 | `	return SXRET_OK;` |
|  120493 |  562 | `}` |
|       - |  563 | `/*` |
...
|       - |  567 | ` */` |
|   15612 |  568 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  569 | `{` |
...
|   15617 |  576 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  583 | `	}` |
|   15617 |  584 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15617 |  585 | `	rc = SXRET_OK;` |
|       - |  586 | `	/* Copy attributes from the trait */` |
|   15617 |  587 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   62223 |  588 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  589 | `		SyHashEntry *pExisting;` |
|   46611 |  590 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   46611 |  591 | `		pName = &pAttr->sName;` |
|   46611 |  592 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   46611 |  593 | `		if( pExisting != 0 ){` |
...
|       6 |  622 | `			continue;` |
|       - |  623 | `		}` |
|   46607 |  624 | `		rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   46607 |  625 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  626 | `			goto cleanup;` |
|       - |  627 | `		}` |
|       5 |  628 | `	}` |
|       - |  629 | `	/* Copy methods from the trait */` |
|   15617 |  630 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  225339 |  631 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|       - |  632 | `		SyHashEntry *pClassMethEntry;` |
|  209727 |  633 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  209727 |  634 | `		pName = &pMeth->sFunc.sName;` |
|  209727 |  635 | `		pClassMethEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  209727 |  636 | `		if( pClassMethEntry != 0 ){` |
...
|       8 |  678 | `			continue;` |
|       - |  679 | `		}` |
|  209713 |  680 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  209713 |  681 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  682 | `			goto cleanup;` |
|       - |  683 | `		}` |
|       5 |  684 | `	}` |
|       - |  685 | `	/* Record trait in the class */` |
|   15617 |  686 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7806 |  687 | `cleanup:` |
|       - |  688 | `	/* Always clear visiting flag, even on error paths */` |
|   15617 |  689 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7806 |  690 | `	SXUNUSED(pGen);` |
|   15617 |  691 | `	return rc;` |
|    7811 |  692 | `}` |
|       - |  693 | `/*` |
...
|       - |  759 | ` * error message.` |
|       - |  760 | ` */` |
|  415730 |  761 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  762 | `{` |
...
|  415735 |  768 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  732310 |  769 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
...
|  415735 |  783 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  792 | `		SyString *pMName;` |
|  415735 |  793 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1439428 |  794 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  815833 |  795 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  815833 |  796 | `			pMName = &pMeth->sFunc.sName;` |
|  815833 |  797 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  885 | ` */` |
|    8630 |  886 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  887 | `{` |
|       - |  888 | `	ph7_class_instance *pThis;` |
|       - |  889 | `	/* Allocate a new instance */` |
|    8635 |  890 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    8635 |  891 | `	if( pThis == 0 ){` |
|     ! 0 |  892 | `		return 0;` |
|       - |  893 | `	}` |
|       - |  894 | `	/* Zero the structure */` |
|    8635 |  895 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  896 | `	/* Initialize fields */` |
|    8635 |  897 | `	pThis->iRef = 1;` |
|    8635 |  898 | `	pThis->pVm = pVm;` |
|    8635 |  899 | `	pThis->pClass = pClass;` |
|       - |  900 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    8635 |  901 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    8635 |  902 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    8635 |  903 | `	return pThis;` |
|    4320 |  904 | `}` |
|       - |  905 | `/*` |
|       - |  906 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  907 | ` * See the block comment above for more information.` |
|       - |  908 | ` */` |
|    8384 |  909 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  910 | `{` |
|       - |  911 | `	ph7_class_instance *pNew;` |
|       - |  912 | `	sxi32 rc;` |
|    8389 |  913 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    8389 |  914 | `	if( pNew == 0 ){` |
|     ! 0 |  915 | `		return 0;` |
|       - |  916 | `	}` |
|       - |  917 | `	/* Associate a private VM frame with this class instance */` |
|    8389 |  918 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    8389 |  919 | `	if( rc != SXRET_OK ){` |
...
|    8389 |  926 | `	PH7_VmStampThrowableSite(&(*pVm),pNew);` |
|    8389 |  927 | `	return pNew;` |
|    4197 |  928 | `}` |
|       - |  929 | `/*` |
|       - |  930 | ` * Extract the value of a class instance [i.e: Object in the PHP jargon] attribute.` |
|       - |  931 | ` * This function never fail.` |
|       - |  932 | ` */` |
|   24050 |  933 | `static ph7_value * ExtractClassAttrValue(ph7_vm *pVm,VmClassAttr *pAttr)` |
|       5 |  934 | `{` |
|       - |  935 | `	/* Extract the value */` |
|       - |  936 | `	ph7_value *pValue;` |
|   24055 |  937 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|   24055 |  938 | `	return pValue;` |
|       5 |  939 | `}` |
|       - |  940 | `/*` |
...
|       - | 1156 | ` */` |
|   28728 | 1157 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1158 | `{` |
|   28733 | 1159 | `	if( pVmAttr->iState & VM_CLASS_ATTR_REFBOUND ){` |
...
|   28728 | 1164 | `	}else if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   21427 | 1167 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     309 | 1168 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     152 | 1169 | `		}` |
|   21427 | 1170 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   10711 | 1171 | `	}` |
...
|   28733 | 1174 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     116 | 1175 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      57 | 1176 | `	}` |
|   28733 | 1177 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   28733 | 1178 | `}` |
|       - | 1179 | `/*` |
...
|       - | 1182 | ` * class instance.` |
|       - | 1183 | ` */` |
|    5732 | 1184 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1185 | `{` |
|       - | 1186 | `	ph7_class_method *pDestr;` |
|       - | 1187 | `	SyHashEntry *pEntry;` |
|       - | 1188 | `	ph7_class *pClass;` |
|       - | 1189 | `	ph7_vm *pVm;` |
|    5737 | 1190 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1191 | `		/*` |
...
|    5737 | 1198 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1199 | `	/* Invoke any defined destructor if available */` |
|    5737 | 1200 | `	pVm = pThis->pVm;` |
|    5737 | 1201 | `	pClass = pThis->pClass;` |
|    5737 | 1202 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5737 | 1203 | `	if( pDestr && !pVm->bInReset ){` |
...
|     473 | 1206 | `		pThis->iRef = 2; /* Prevent garbage collection */` |
|     473 | 1207 | `		PH7_VmCallClassMethod(pVm,pThis,pDestr,0,0,0);` |
|     234 | 1208 | `	}` |
...
|    5737 | 1213 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5737 | 1222 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   34437 | 1223 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   28705 | 1224 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1225 | `	}` |
|       - | 1226 | `	/* Release the whole structure */` |
|    5737 | 1227 | `	SyHashRelease(&pThis->hAttr);` |
|    5737 | 1228 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2871 | 1229 | `}` |
|       - | 1230 | `/*` |
...
|       - | 1233 | ` */` |
|  143164 | 1234 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1235 | `{` |
|  143169 | 1236 | `	pThis->iRef--;` |
|  143169 | 1237 | `	if( pThis->iRef < 1 ){` |
|       - | 1238 | `		/* No more reference to this instance */` |
|    5737 | 1239 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2866 | 1240 | `	}` |
|  143169 | 1241 | `}` |
|       - | 1242 | `/*` |
...
|       - | 1318 | ` */` |
|     290 | 1319 | `PH7_PRIVATE sxi32 PH7_ClassInstanceCmp(ph7_class_instance *pLeft,ph7_class_instance *pRight,int bStrict,int iNest)` |
|       5 | 1320 | `{` |
|       - | 1321 | `	SyHashEntry *pEntry,*pEntry2;` |
|       - | 1322 | `	ph7_value sV1,sV2;` |
|       - | 1323 | `	sxi32 rc;` |
|     295 | 1324 | `	if( iNest > 31 ){` |
...
|     291 | 1330 | `	if( pLeft->pClass != pRight->pClass ){` |
|       7 | 1331 | `		return 1;` |
|       - | 1332 | `	}` |
|     285 | 1333 | `	if( bStrict ){` |
|       - | 1334 | `		/*` |
...
|       - | 1674 | ` */` |
|     286 | 1675 | `PH7_PRIVATE sxi32 PH7_ClassInstanceCallMagicMethod(` |
...
|     287 | 1696 | `	nArg = 0;` |
|       - | 1697 | `	/* Copy arguments */` |
|     287 | 1698 | `	if( pAttrName ){` |
|     287 | 1699 | `		PH7_MemObjInitFromString(pVm,&sAttr,pAttrName);` |
|     287 | 1700 | `		sAttr.nIdx = SXU32_HIGH; /* Mark as constant */` |
|     287 | 1701 | `		apArg[0] = &sAttr;` |
|     287 | 1702 | `		nArg = 1;` |
|     143 | 1703 | `	}` |
|       - | 1704 | `	/* Call the magic method now */` |
|     287 | 1705 | `	rc = PH7_VmCallClassMethod(pVm,&(*pThis),pMeth,pResult,nArg,apArg);` |
|       - | 1706 | `	/* Clean up */` |
|     287 | 1707 | `	if( pAttrName ){` |
|     287 | 1708 | `		PH7_MemObjRelease(&sAttr);` |
|     143 | 1709 | `	}` |
|     287 | 1710 | `	return rc;` |
|     144 | 1711 | `}` |
|       - | 1712 | `/*` |
...
|       - | 1715 | ` */` |
|   11156 | 1716 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceExtractAttrValue(ph7_class_instance *pThis,VmClassAttr *pAttr)` |
|       5 | 1717 | `{` |
|       - | 1718 | `   /* Extract the attribute value */` |
|       - | 1719 | `	ph7_value *pValue;` |
|   11161 | 1720 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|   11161 | 1721 | `	return pValue;` |
|       5 | 1722 | `}` |
|       - | 1723 | `/*` |
...
|       - | 1835 | ` */` |
|   11012 | 1836 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceFetchAttr(ph7_class_instance *pThis,const SyString *pName)` |
|       5 | 1837 | `{` |
|       - | 1838 | `	SyHashEntry *pEntry;` |
|       - | 1839 | `	VmClassAttr *pAttr;` |
|       - | 1840 | `	/* Query the attribute hashtable */` |
|   11017 | 1841 | `	pEntry = SyHashGet(&pThis->hAttr,(const void *)pName->zString,pName->nByte);` |
|   11017 | 1842 | `	if( pEntry == 0 ){` |
|       - | 1843 | `		/* No such attribute */` |
|     ! 0 | 1844 | `		return 0;` |
|       - | 1845 | `	}` |
|       - | 1846 | `	/* Point to the class atrribute */` |
|   11017 | 1847 | `	pAttr = (VmClassAttr *)pEntry->pUserData;` |
|       - | 1848 | `	/* Check if we are dealing with a static/constant attribute */` |
|   11017 | 1849 | `	if( pAttr->pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|       - | 1850 | `		/* Access is forbidden */` |
|     ! 0 | 1851 | `		return 0;` |
|       - | 1852 | `	}` |
|       - | 1853 | `	/* Return the attribute value */` |
|   11017 | 1854 | `	return ExtractClassAttrValue(pThis->pVm,pAttr);` |
|    5511 | 1855 | `}` |
|       - | 1856 |  |
