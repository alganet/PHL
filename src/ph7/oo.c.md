...
|       - |   13 | ` */` |
|  443232 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  443237 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  443237 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  443237 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  443237 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  443237 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  443237 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  443237 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  443237 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  443237 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  443237 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  443237 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  443237 |   38 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  443237 |   39 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  443237 |   40 | `	pClass->nLine = nLine;` |
|  443237 |   41 | `	if( pVm->bCompilingBuiltin ){` |
...
|  441285 |   44 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  220645 |   45 | `	}else{` |
...
|       - |   51 | `	}` |
|       - |   52 | `	/* All done */` |
|  443237 |   53 | `	return pClass;` |
|  221621 |   54 | `}` |
|       - |   55 | `/*` |
|       - |   56 | ` * Allocate and initialize a new class attribute.` |
|       - |   57 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   58 | ` */` |
|  785344 |   59 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   60 | `{` |
|       - |   61 | `	ph7_class_attr *pAttr;` |
|       - |   62 | `	char *zName;` |
|  785349 |   63 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  785349 |   64 | `	if( pAttr == 0 ){` |
|     ! 0 |   65 | `		return 0;` |
|       - |   66 | `	}` |
|       - |   67 | `	/* Zero the structure */` |
|  785349 |   68 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  785349 |   69 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   70 | `	/* Duplicate attribute name */` |
|  785349 |   71 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  785349 |   72 | `	if( zName == 0 ){` |
|     ! 0 |   73 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   74 | `		return 0;` |
|       - |   75 | `	}` |
|       - |   76 | `	/* Initialize fields */` |
|  785349 |   77 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  785349 |   78 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  785349 |   79 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  785349 |   80 | `	pAttr->iProtection = iProtection;` |
|  785349 |   81 | `	pAttr->nIdx = SXU32_HIGH;` |
|  785349 |   82 | `	pAttr->iFlags = iFlags;` |
|  785349 |   83 | `	pAttr->nLine = nLine;` |
|  785349 |   84 | `	return pAttr;` |
|  392677 |   85 | `}` |
|       - |   86 | `/*` |
...
|       - |   91 | ` */` |
| 2460314 |   92 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2460319 |  102 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2460319 |  103 | `	if( pMeth == 0 ){` |
|     ! 0 |  104 | `		return 0;` |
|       - |  105 | `	}` |
|       - |  106 | `	/* Zero the structure */` |
| 2460319 |  107 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  108 | `	/* Check for an already installed method with the same name */` |
| 2460319 |  109 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2460319 |  110 | `	if( pEntry == 0 ){` |
|       - |  111 | `		/* Associate an unique VM name to this method */` |
| 2460317 |  112 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2460317 |  113 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2460317 |  114 | `		if( zName == 0 ){` |
|     ! 0 |  115 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  116 | `			return 0;` |
|       - |  117 | `		}` |
| 2460317 |  118 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  119 | `		/* Generate a random string */` |
| 2460317 |  120 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2460317 |  121 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2460317 |  122 | `		pNamePtr->zString = zName;` |
| 1230161 |  123 | `	}else{` |
...
|       - |  130 | `	}` |
| 2460319 |  131 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  149778 |  132 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  149783 |  133 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2460319 |  144 | `	pMeth->iProtection = iProtection;` |
| 2460319 |  145 | `	pMeth->iFlags = iFlags;` |
| 2460319 |  146 | `	pMeth->nLine = nLine;` |
| 3690476 |  147 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2460314 |  148 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2460319 |  149 | `	return pMeth;` |
| 1230162 |  150 | `}` |
|       - |  151 | `/*` |
...
|       - |  154 | ` */` |
|  741946 |  155 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  156 | `{` |
|       - |  157 | `	SyHashEntry *pEntry;` |
|       - |  158 | `	/* Perform a hash lookup */` |
|  741951 |  159 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  741951 |  160 | `	if( pEntry == 0 ){` |
|       - |  161 | `		/* No such entry */` |
|    8709 |  162 | `		return 0;` |
|       - |  163 | `	}` |
|       - |  164 | `	/* Point to the desired method */` |
|  733247 |  165 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  370978 |  166 | `}` |
|       - |  167 | `/*` |
...
|       - |  170 | ` */` |
|  471250 |  171 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  172 | `{` |
|       - |  173 | `	SyHashEntry *pEntry;` |
|       - |  174 | `	/* Perform a hash lookup */` |
|  471255 |  175 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  471255 |  176 | `	if( pEntry == 0 ){` |
|       - |  177 | `		/* No such entry */` |
|  469993 |  178 | `		return 0;` |
|       - |  179 | `	}` |
...
|       - |  186 | ` */` |
|  785340 |  187 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  188 | `{` |
|  785345 |  189 | `	SyString *pName = &pAttr->sName;` |
|       - |  190 | `	sxi32 rc;` |
...
|  785345 |  194 | `	if( pAttr->pDeclClass == 0 ){` |
|  785345 |  195 | `		pAttr->pDeclClass = pClass;` |
|  392670 |  196 | `	}` |
|  785345 |  197 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  785345 |  198 | `	return rc;` |
|       5 |  199 | `}` |
|       - |  200 | `/*` |
...
|       - |  203 | ` */` |
| 2460302 |  204 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  205 | `{` |
| 2460307 |  206 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  207 | `	sxi32 rc;` |
| 2460307 |  208 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2460307 |  209 | `	return rc;` |
|       5 |  210 | `}` |
|       - |  211 | `/*` |
...
|       - |  233 | ` */` |
|  157800 |  234 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  235 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  236 | `{` |
|  157805 |  237 | `	*ppClass = 0;` |
|  157805 |  238 | `	if( bUnion ){` |
|       3 |  239 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  240 | `	}` |
|  157803 |  241 | `	if( nType == 0 ){` |
|  157717 |  242 | `		return OVT_NONE; /* no declared type */` |
|       - |  243 | `	}` |
...
|       - |  286 | `	int bNullable;` |
|       - |  287 | `};` |
|  126220 |  288 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  289 | `{` |
|       - |  290 | `	OvType t;` |
|  126225 |  291 | `	t.nType = pF->nReturnType;` |
|  126225 |  292 | `	t.pClass = &pF->sReturnClass;` |
|  126225 |  293 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  126225 |  294 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  126225 |  295 | `	return t;` |
|       5 |  296 | `}` |
|   31580 |  297 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  298 | `{` |
|       - |  299 | `	OvType t;` |
|   31585 |  300 | `	t.nType = pA->nType;` |
|   31585 |  301 | `	t.pClass = &pA->sClass;` |
|   31585 |  302 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   31585 |  303 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   31585 |  304 | `	return t;` |
|       5 |  305 | `}` |
|       - |  306 | `/*` |
...
|       - |  311 | ` */` |
|   78900 |  312 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  313 | `{` |
|       - |  314 | `	ph7_class *pParentCls, *pChildCls;` |
|   78905 |  315 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|   78905 |  316 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|   78905 |  317 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|   78889 |  325 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|   78865 |  326 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|   78865 |  327 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|   78865 |  328 | `		return 0;` |
|       - |  329 | `	}` |
...
|       - |  355 | ` */` |
|   90696 |  356 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  357 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  358 | `{` |
|   90701 |  359 | `	ph7_vm *pVm = pGen->pVm;` |
|   90701 |  360 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|   90701 |  361 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|   90701 |  362 | `	SyString *pMName = &pCF->sName;` |
|       - |  363 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  364 | `	sxu32 nPArg, nCArg, k;` |
|   90701 |  365 | `	int bBad = 0;` |
|   90696 |  366 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   59150 |  367 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   27591 |  368 | `		return SXRET_OK;` |
|       - |  369 | `	}` |
|       - |  370 | `	/* Return type — covariant. */` |
|   63115 |  371 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  372 | `	/* Each overlapping parameter — contravariant. */` |
|   63115 |  373 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|   63115 |  374 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|   63115 |  375 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|   63115 |  376 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|   78905 |  377 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   15795 |  378 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|    7900 |  379 | `	}` |
...
|   63115 |  384 | `	if( !bBad ){` |
|   63111 |  385 | `		int bVariadic = 0;` |
|   78899 |  386 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   78901 |  387 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   63111 |  388 | `		if( !bVariadic ){` |
|   63111 |  389 | `			if( nCArg < nPArg ){` |
|     ! 0 |  390 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  391 | `			}else{` |
|   63113 |  392 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  447 | ` * error message.` |
|       - |  448 | ` */` |
|  189370 |  449 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  450 | `{` |
...
|  189375 |  457 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  189375 |  458 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  459 | `		return rc;` |
|       - |  460 | `	}` |
...
|  189375 |  463 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  189375 |  478 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1103941 |  479 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  480 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
|  914571 |  481 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  914571 |  482 | `		pName = &pAttr->sName;` |
|  914571 |  483 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
|  914550 |  513 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  488809 |  514 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|  914551 |  515 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  914551 |  516 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  517 | `				return rc;` |
|       - |  518 | `			}` |
|  457273 |  519 | `		}` |
|       5 |  520 | `	}` |
|  189375 |  521 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 2711875 |  522 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  523 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 2522505 |  524 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 2522505 |  525 | `		pName = &pMeth->sFunc.sName;` |
| 2522505 |  526 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   90705 |  527 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  136049 |  537 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|   90696 |  538 | `					(ph7_class_method *)pEntry->pUserData);` |
|   90701 |  539 | `				if( rc == SXERR_ABORT ){` |
...
| 2431800 |  553 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1229702 |  554 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 2431805 |  555 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2431805 |  556 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  557 | `				return rc;` |
|       - |  558 | `			}` |
| 1215900 |  559 | `		}` |
|       5 |  560 | `	}` |
|       - |  561 | `	/* Mark as subclass */` |
|  189375 |  562 | `	pSub->pBase = pBase;` |
|       - |  563 | `	/* All done */` |
|  189375 |  564 | `	return SXRET_OK;` |
|   94690 |  565 | `}` |
|       - |  566 | `/*` |
...
|       - |  570 | ` */` |
|   15822 |  571 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  572 | `{` |
...
|   15827 |  579 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  586 | `	}` |
|   15827 |  587 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15827 |  588 | `	rc = SXRET_OK;` |
|       - |  589 | `	/* Copy attributes from the trait */` |
|   15827 |  590 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   55245 |  591 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  592 | `		SyHashEntry *pExisting;` |
|   39423 |  593 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   39423 |  594 | `		pName = &pAttr->sName;` |
|   39423 |  595 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   39423 |  596 | `		if( pExisting != 0 ){` |
...
|       6 |  625 | `			continue;` |
|       - |  626 | `		}` |
|   39419 |  627 | `		rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   39419 |  628 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  629 | `			goto cleanup;` |
|       - |  630 | `		}` |
|       5 |  631 | `	}` |
|       - |  632 | `	/* Copy methods from the trait */` |
|   15827 |  633 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  220769 |  634 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|  204947 |  635 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  204947 |  636 | `		pName = &pMeth->sFunc.sName;` |
|  204947 |  637 | `		if( SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|      11 |  661 | `			continue;` |
|       - |  662 | `		}` |
|  204939 |  663 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  204939 |  664 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  665 | `			goto cleanup;` |
|       - |  666 | `		}` |
|       5 |  667 | `	}` |
|       - |  668 | `	/* Record trait in the class */` |
|   15827 |  669 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7911 |  670 | `cleanup:` |
|       - |  671 | `	/* Always clear visiting flag, even on error paths */` |
|   15827 |  672 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7911 |  673 | `	SXUNUSED(pGen);` |
|   15827 |  674 | `	return rc;` |
|    7916 |  675 | `}` |
|       - |  676 | `/*` |
...
|       - |  687 | ` * error message.` |
|       - |  688 | ` */` |
|   27590 |  689 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  690 | `{` |
...
|   27595 |  697 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   27595 |  698 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  699 | `	/* Copy constants */` |
|   41392 |  700 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  710 | `		}` |
|       1 |  711 | `	}` |
|   27595 |  712 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  713 | `	/* Copy methods signature */` |
|  108412 |  714 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  715 | `		/* Make sure the method are not redeclared in the subclass */` |
|   67027 |  716 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   67027 |  717 | `		pName = &pMeth->sFunc.sName;` |
|   67027 |  718 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  719 | `			/* Install the method */` |
|   67027 |  720 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   67027 |  721 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  722 | `				return rc;` |
|       - |  723 | `			}` |
|   33511 |  724 | `		}` |
|       5 |  725 | `	}` |
|       - |  726 | `	/* Mark as subclass */` |
|   27595 |  727 | `	pSub->pBase = pBase;` |
|       - |  728 | `	/* All done */` |
|   27595 |  729 | `	return SXRET_OK;` |
|   13800 |  730 | `}` |
|       - |  731 | `/*` |
...
|       - |  742 | ` * error message.` |
|       - |  743 | ` */` |
|  366752 |  744 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  745 | `{` |
...
|  366757 |  751 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  660467 |  752 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
|       - |  753 | `		/* Point to the constant declaration */` |
|  110339 |  754 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  110339 |  755 | `		pName = &pAttr->sName;` |
|       - |  756 | `		/* Make sure the attribute is not redeclared in the main class */` |
|  110339 |  757 | `		if( SyHashGet(&pMain->hAttr,pName->zString,pName->nByte) == 0 ){` |
|       - |  758 | `			/* Install the attribute */` |
|  110335 |  759 | `			rc = SyHashInsert(&pMain->hAttr,pName->zString,pName->nByte,pAttr);` |
|  110335 |  760 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  761 | `				return rc;` |
|       - |  762 | `			}` |
|   55165 |  763 | `		}` |
|       5 |  764 | `	}` |
|       - |  765 | `	/* Install in the interface container */` |
|  366757 |  766 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  775 | `		SyString *pMName;` |
|  366757 |  776 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1240213 |  777 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  690085 |  778 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  690085 |  779 | `			pMName = &pMeth->sFunc.sName;` |
|  690085 |  780 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  868 | ` */` |
|    7402 |  869 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  870 | `{` |
|       - |  871 | `	ph7_class_instance *pThis;` |
|       - |  872 | `	/* Allocate a new instance */` |
|    7407 |  873 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    7407 |  874 | `	if( pThis == 0 ){` |
|     ! 0 |  875 | `		return 0;` |
|       - |  876 | `	}` |
|       - |  877 | `	/* Zero the structure */` |
|    7407 |  878 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  879 | `	/* Initialize fields */` |
|    7407 |  880 | `	pThis->iRef = 1;` |
|    7407 |  881 | `	pThis->pVm = pVm;` |
|    7407 |  882 | `	pThis->pClass = pClass;` |
|       - |  883 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    7407 |  884 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    7407 |  885 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    7407 |  886 | `	return pThis;` |
|    3706 |  887 | `}` |
|       - |  888 | `/*` |
|       - |  889 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  890 | ` * See the block comment above for more information.` |
|       - |  891 | ` */` |
|    7170 |  892 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  893 | `{` |
|       - |  894 | `	ph7_class_instance *pNew;` |
|       - |  895 | `	sxi32 rc;` |
|    7175 |  896 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    7175 |  897 | `	if( pNew == 0 ){` |
|     ! 0 |  898 | `		return 0;` |
|       - |  899 | `	}` |
|       - |  900 | `	/* Associate a private VM frame with this class instance */` |
|    7175 |  901 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    7175 |  902 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  903 | `		SyMemBackendPoolFree(&pVm->sAllocator,pNew);` |
|     ! 0 |  904 | `		return 0;` |
|       - |  905 | `	}` |
|    7175 |  906 | `	return pNew;` |
|    3590 |  907 | `}` |
|       - |  908 | `/*` |
|       - |  909 | ` * Extract the value of a class instance [i.e: Object in the PHP jargon] attribute.` |
|       - |  910 | ` * This function never fail.` |
|       - |  911 | ` */` |
|   11706 |  912 | `static ph7_value * ExtractClassAttrValue(ph7_vm *pVm,VmClassAttr *pAttr)` |
|       5 |  913 | `{` |
|       - |  914 | `	/* Extract the value */` |
|       - |  915 | `	ph7_value *pValue;` |
|   11711 |  916 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|   11711 |  917 | `	return pValue;` |
|       5 |  918 | `}` |
|       - |  919 | `/*` |
...
|       - | 1116 | ` */` |
|   25156 | 1117 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1118 | `{` |
|   25161 | 1119 | `	if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   18891 | 1122 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     282 | 1123 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     139 | 1124 | `		}` |
|   18891 | 1125 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|    9443 | 1126 | `	}` |
...
|   25161 | 1129 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     115 | 1130 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      57 | 1131 | `	}` |
|   25161 | 1132 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   25161 | 1133 | `}` |
|       - | 1134 | `/*` |
...
|       - | 1137 | ` * class instance.` |
|       - | 1138 | ` */` |
|    5156 | 1139 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1140 | `{` |
|       - | 1141 | `	ph7_class_method *pDestr;` |
|       - | 1142 | `	SyHashEntry *pEntry;` |
|       - | 1143 | `	ph7_class *pClass;` |
|       - | 1144 | `	ph7_vm *pVm;` |
|    5161 | 1145 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1146 | `		/*` |
...
|    5161 | 1153 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1154 | `	/* Invoke any defined destructor if available */` |
|    5161 | 1155 | `	pVm = pThis->pVm;` |
|    5161 | 1156 | `	pClass = pThis->pClass;` |
|    5161 | 1157 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5161 | 1158 | `	if( pDestr && !pVm->bInReset ){` |
...
|    5161 | 1168 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5161 | 1177 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   30287 | 1178 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   25131 | 1179 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1180 | `	}` |
|       - | 1181 | `	/* Release the whole structure */` |
|    5161 | 1182 | `	SyHashRelease(&pThis->hAttr);` |
|    5161 | 1183 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2583 | 1184 | `}` |
|       - | 1185 | `/*` |
...
|       - | 1188 | ` */` |
|  133610 | 1189 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1190 | `{` |
|  133615 | 1191 | `	pThis->iRef--;` |
|  133615 | 1192 | `	if( pThis->iRef < 1 ){` |
|       - | 1193 | `		/* No more reference to this instance */` |
|    5161 | 1194 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2578 | 1195 | `	}` |
|  133615 | 1196 | `}` |
|       - | 1197 | `/*` |
...
|     219 | 1675 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|     219 | 1676 | `	return pValue;` |
|       3 | 1677 | `}` |
|       - | 1678 | `/*` |
...
|       - | 1790 | ` */` |
|    9920 | 1791 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceFetchAttr(ph7_class_instance *pThis,const SyString *pName)` |
|       5 | 1792 | `{` |
|       - | 1793 | `	SyHashEntry *pEntry;` |
|       - | 1794 | `	VmClassAttr *pAttr;` |
|       - | 1795 | `	/* Query the attribute hashtable */` |
|    9925 | 1796 | `	pEntry = SyHashGet(&pThis->hAttr,(const void *)pName->zString,pName->nByte);` |
|    9925 | 1797 | `	if( pEntry == 0 ){` |
|       - | 1798 | `		/* No such attribute */` |
|     ! 0 | 1799 | `		return 0;` |
|       - | 1800 | `	}` |
|       - | 1801 | `	/* Point to the class atrribute */` |
|    9925 | 1802 | `	pAttr = (VmClassAttr *)pEntry->pUserData;` |
|       - | 1803 | `	/* Check if we are dealing with a static/constant attribute */` |
|    9925 | 1804 | `	if( pAttr->pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|       - | 1805 | `		/* Access is forbidden */` |
|     ! 0 | 1806 | `		return 0;` |
|       - | 1807 | `	}` |
|       - | 1808 | `	/* Return the attribute value */` |
|    9925 | 1809 | `	return ExtractClassAttrValue(pThis->pVm,pAttr);` |
|    4965 | 1810 | `}` |
|       - | 1811 |  |
