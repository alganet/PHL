...
|       - |   13 | ` */` |
|  458778 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  458783 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  458783 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  458783 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  458783 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  458783 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  458783 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  458783 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  458783 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  458783 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  458783 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  458783 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  458783 |   38 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  458783 |   39 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  458783 |   40 | `	pClass->nLine = nLine;` |
|  458783 |   41 | `	if( pVm->bCompilingBuiltin ){` |
...
|  456665 |   44 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  228335 |   45 | `	}else{` |
|       - |   46 | `		/* Alias the VM-lifetime path dup on top of the include stack */` |
|    2123 |   47 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    2123 |   48 | `		if( pFile ){` |
|    2123 |   49 | `			SyStringDupPtr(&pClass->sFile,pFile);` |
|    1059 |   50 | `		}` |
|       - |   51 | `	}` |
|       - |   52 | `	/* All done */` |
|  458783 |   53 | `	return pClass;` |
|  229394 |   54 | `}` |
|       - |   55 | `/*` |
|       - |   56 | ` * Allocate and initialize a new class attribute.` |
|       - |   57 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   58 | ` */` |
|  845048 |   59 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   60 | `{` |
|       - |   61 | `	ph7_class_attr *pAttr;` |
|       - |   62 | `	char *zName;` |
|  845053 |   63 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  845053 |   64 | `	if( pAttr == 0 ){` |
|     ! 0 |   65 | `		return 0;` |
|       - |   66 | `	}` |
|       - |   67 | `	/* Zero the structure */` |
|  845053 |   68 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  845053 |   69 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   70 | `	/* Duplicate attribute name */` |
|  845053 |   71 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  845053 |   72 | `	if( zName == 0 ){` |
|     ! 0 |   73 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   74 | `		return 0;` |
|       - |   75 | `	}` |
|       - |   76 | `	/* Initialize fields */` |
|  845053 |   77 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  845053 |   78 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  845053 |   79 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  845053 |   80 | `	pAttr->iProtection = iProtection;` |
|  845053 |   81 | `	pAttr->nIdx = SXU32_HIGH;` |
|  845053 |   82 | `	pAttr->iFlags = iFlags;` |
|  845053 |   83 | `	pAttr->nLine = nLine;` |
|  845053 |   84 | `	return pAttr;` |
|  422529 |   85 | `}` |
|       - |   86 | `/*` |
...
|       - |   91 | ` */` |
| 2614230 |   92 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2614235 |  102 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2614235 |  103 | `	if( pMeth == 0 ){` |
|     ! 0 |  104 | `		return 0;` |
|       - |  105 | `	}` |
|       - |  106 | `	/* Zero the structure */` |
| 2614235 |  107 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  108 | `	/* Check for an already installed method with the same name */` |
| 2614235 |  109 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2614235 |  110 | `	if( pEntry == 0 ){` |
|       - |  111 | `		/* Associate an unique VM name to this method */` |
| 2614233 |  112 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2614233 |  113 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2614233 |  114 | `		if( zName == 0 ){` |
|     ! 0 |  115 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  116 | `			return 0;` |
|       - |  117 | `		}` |
| 2614233 |  118 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  119 | `		/* Generate a random string */` |
| 2614233 |  120 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2614233 |  121 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2614233 |  122 | `		pNamePtr->zString = zName;` |
| 1307119 |  123 | `	}else{` |
...
|       - |  130 | `	}` |
| 2614235 |  131 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  162618 |  132 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  162623 |  133 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2614235 |  144 | `	pMeth->iProtection = iProtection;` |
| 2614235 |  145 | `	pMeth->iFlags = iFlags;` |
| 2614235 |  146 | `	pMeth->nLine = nLine;` |
| 3921350 |  147 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2614230 |  148 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2614235 |  149 | `	return pMeth;` |
| 1307120 |  150 | `}` |
|       - |  151 | `/*` |
...
|       - |  154 | ` */` |
|  854614 |  155 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  156 | `{` |
|       - |  157 | `	SyHashEntry *pEntry;` |
|       - |  158 | `	/* Perform a hash lookup */` |
|  854619 |  159 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  854619 |  160 | `	if( pEntry == 0 ){` |
|       - |  161 | `		/* No such entry */` |
|   29239 |  162 | `		return 0;` |
|       - |  163 | `	}` |
|       - |  164 | `	/* Point to the desired method */` |
|  825385 |  165 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  427312 |  166 | `}` |
|       - |  167 | `/*` |
...
|       - |  170 | ` */` |
|  490214 |  171 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  172 | `{` |
|       - |  173 | `	SyHashEntry *pEntry;` |
|       - |  174 | `	/* Perform a hash lookup */` |
|  490219 |  175 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  490219 |  176 | `	if( pEntry == 0 ){` |
|       - |  177 | `		/* No such entry */` |
|  488829 |  178 | `		return 0;` |
|       - |  179 | `	}` |
|       - |  180 | `	/* Point to the desierd method */` |
|    1395 |  181 | `	return (ph7_class_attr *)pEntry->pUserData;` |
|  245112 |  182 | `}` |
|       - |  183 | `/*` |
...
|       - |  186 | ` */` |
|  845044 |  187 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  188 | `{` |
|  845049 |  189 | `	SyString *pName = &pAttr->sName;` |
|       - |  190 | `	sxi32 rc;` |
...
|  845049 |  194 | `	if( pAttr->pDeclClass == 0 ){` |
|  845049 |  195 | `		pAttr->pDeclClass = pClass;` |
|  422522 |  196 | `	}` |
|  845049 |  197 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  845049 |  198 | `	return rc;` |
|       5 |  199 | `}` |
|       - |  200 | `/*` |
...
|       - |  203 | ` */` |
| 2614218 |  204 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  205 | `{` |
| 2614223 |  206 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  207 | `	sxi32 rc;` |
| 2614223 |  208 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2614223 |  209 | `	return rc;` |
|       5 |  210 | `}` |
|       - |  211 | `/*` |
...
|       - |  233 | ` */` |
|  201464 |  234 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  235 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  236 | `{` |
|  201469 |  237 | `	*ppClass = 0;` |
|  201469 |  238 | `	if( bUnion ){` |
|       3 |  239 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  240 | `	}` |
|  201467 |  241 | `	if( nType == 0 ){` |
|  201363 |  242 | `		return OVT_NONE; /* no declared type */` |
|       - |  243 | `	}` |
...
|       - |  286 | `	int bNullable;` |
|       - |  287 | `};` |
|  170440 |  288 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  289 | `{` |
|       - |  290 | `	OvType t;` |
|  170445 |  291 | `	t.nType = pF->nReturnType;` |
|  170445 |  292 | `	t.pClass = &pF->sReturnClass;` |
|  170445 |  293 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  170445 |  294 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  170445 |  295 | `	return t;` |
|       5 |  296 | `}` |
|   31024 |  297 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  298 | `{` |
|       - |  299 | `	OvType t;` |
|   31029 |  300 | `	t.nType = pA->nType;` |
|   31029 |  301 | `	t.pClass = &pA->sClass;` |
|   31029 |  302 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   31029 |  303 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   31029 |  304 | `	return t;` |
|       5 |  305 | `}` |
|       - |  306 | `/*` |
...
|       - |  311 | ` */` |
|  100732 |  312 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  313 | `{` |
|       - |  314 | `	ph7_class *pParentCls, *pChildCls;` |
|  100737 |  315 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|  100737 |  316 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|  100737 |  317 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|  100719 |  325 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|  100689 |  326 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|  100689 |  327 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|  100689 |  328 | `		return 0;` |
|       - |  329 | `	}` |
...
|       - |  355 | ` */` |
|  123928 |  356 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  357 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  358 | `{` |
|  123933 |  359 | `	ph7_vm *pVm = pGen->pVm;` |
|  123933 |  360 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|  123933 |  361 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|  123933 |  362 | `	SyString *pMName = &pCF->sName;` |
|       - |  363 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  364 | `	sxu32 nPArg, nCArg, k;` |
|  123933 |  365 | `	int bBad = 0;` |
|  123928 |  366 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   83262 |  367 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   38713 |  368 | `		return SXRET_OK;` |
|       - |  369 | `	}` |
|       - |  370 | `	/* Return type — covariant. */` |
|   85225 |  371 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  372 | `	/* Each overlapping parameter — contravariant. */` |
|   85225 |  373 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|   85225 |  374 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|   85225 |  375 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|   85225 |  376 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|  100737 |  377 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   15517 |  378 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|    7761 |  379 | `	}` |
...
|   85225 |  384 | `	if( !bBad ){` |
|   85221 |  385 | `		int bVariadic = 0;` |
|  100731 |  386 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  100733 |  387 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   85221 |  388 | `		if( !bVariadic ){` |
|   85221 |  389 | `			if( nCArg < nPArg ){` |
|     ! 0 |  390 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  391 | `			}else{` |
|   85223 |  392 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  447 | ` * error message.` |
|       - |  448 | ` */` |
|  205392 |  449 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  450 | `{` |
...
|  205397 |  457 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  205397 |  458 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  459 | `		return rc;` |
|       - |  460 | `	}` |
...
|  205397 |  463 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  205397 |  478 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1227597 |  479 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  480 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 1022205 |  481 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 1022205 |  482 | `		pName = &pAttr->sName;` |
| 1022205 |  483 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 1022182 |  509 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  544003 |  510 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
| 1022181 |  511 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 1022181 |  512 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  513 | `				return rc;` |
|       - |  514 | `			}` |
|  511088 |  515 | `		}` |
|       5 |  516 | `	}` |
|  205397 |  517 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 3077925 |  518 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  519 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 2872533 |  520 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 2872533 |  521 | `		pName = &pMeth->sFunc.sName;` |
| 2872533 |  522 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  123937 |  523 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  185897 |  534 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|  123928 |  535 | `					(ph7_class_method *)pEntry->pUserData);` |
|  123933 |  536 | `				if( rc == SXERR_ABORT ){` |
...
| 2748596 |  550 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1389792 |  551 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 2748601 |  552 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2748601 |  553 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  554 | `				return rc;` |
|       - |  555 | `			}` |
| 1374298 |  556 | `		}` |
|       5 |  557 | `	}` |
|       - |  558 | `	/* Mark as subclass */` |
|  205397 |  559 | `	pSub->pBase = pBase;` |
|       - |  560 | `	/* All done */` |
|  205397 |  561 | `	return SXRET_OK;` |
|  102701 |  562 | `}` |
|       - |  563 | `/*` |
...
|       - |  567 | ` */` |
|   15558 |  568 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  569 | `{` |
...
|   15563 |  576 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  583 | `	}` |
|   15563 |  584 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15563 |  585 | `	rc = SXRET_OK;` |
|       - |  586 | `	/* Copy attributes from the trait */` |
|   15563 |  587 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   62023 |  588 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  589 | `		SyHashEntry *pExisting;` |
|   46465 |  590 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   46465 |  591 | `		pName = &pAttr->sName;` |
|   46465 |  592 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   46465 |  593 | `		if( pExisting != 0 ){` |
...
|       6 |  622 | `			continue;` |
|       - |  623 | `		}` |
|   46461 |  624 | `		rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   46461 |  625 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  626 | `			goto cleanup;` |
|       - |  627 | `		}` |
|       5 |  628 | `	}` |
|       - |  629 | `	/* Copy methods from the trait */` |
|   15563 |  630 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  224627 |  631 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|       - |  632 | `		SyHashEntry *pClassMethEntry;` |
|  209069 |  633 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  209069 |  634 | `		pName = &pMeth->sFunc.sName;` |
|  209069 |  635 | `		pClassMethEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  209069 |  636 | `		if( pClassMethEntry != 0 ){` |
...
|       8 |  678 | `			continue;` |
|       - |  679 | `		}` |
|  209055 |  680 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  209055 |  681 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  682 | `			goto cleanup;` |
|       - |  683 | `		}` |
|       5 |  684 | `	}` |
|       - |  685 | `	/* Record trait in the class */` |
|   15563 |  686 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7779 |  687 | `cleanup:` |
|       - |  688 | `	/* Always clear visiting flag, even on error paths */` |
|   15563 |  689 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7779 |  690 | `	SXUNUSED(pGen);` |
|   15563 |  691 | `	return rc;` |
|    7784 |  692 | `}` |
|       - |  693 | `/*` |
...
|       - |  704 | ` * error message.` |
|       - |  705 | ` */` |
|   27102 |  706 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  707 | `{` |
...
|   27107 |  714 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   27107 |  715 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  716 | `	/* Copy constants */` |
|   40660 |  717 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  727 | `		}` |
|       1 |  728 | `	}` |
|   27107 |  729 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  730 | `	/* Copy methods signature */` |
|  106492 |  731 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  732 | `		/* Make sure the method are not redeclared in the subclass */` |
|   65839 |  733 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   65839 |  734 | `		pName = &pMeth->sFunc.sName;` |
|   65839 |  735 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  736 | `			/* Install the method */` |
|   65839 |  737 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   65839 |  738 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  739 | `				return rc;` |
|       - |  740 | `			}` |
|   32917 |  741 | `		}` |
|       5 |  742 | `	}` |
|       - |  743 | `	/* Mark as subclass */` |
|   27107 |  744 | `	pSub->pBase = pBase;` |
|       - |  745 | `	/* All done */` |
|   27107 |  746 | `	return SXRET_OK;` |
|   13556 |  747 | `}` |
|       - |  748 | `/*` |
...
|       - |  759 | ` * error message.` |
|       - |  760 | ` */` |
|  391220 |  761 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  762 | `{` |
...
|  391225 |  768 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  695209 |  769 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
|       - |  770 | `		/* Point to the constant declaration */` |
|  108379 |  771 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  108379 |  772 | `		pName = &pAttr->sName;` |
|       - |  773 | `		/* Make sure the attribute is not redeclared in the main class */` |
|  108379 |  774 | `		if( SyHashGet(&pMain->hAttr,pName->zString,pName->nByte) == 0 ){` |
|       - |  775 | `			/* Install the attribute */` |
|  108375 |  776 | `			rc = SyHashInsert(&pMain->hAttr,pName->zString,pName->nByte,pAttr);` |
|  108375 |  777 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  778 | `				return rc;` |
|       - |  779 | `			}` |
|   54185 |  780 | `		}` |
|       5 |  781 | `	}` |
|       - |  782 | `	/* Install in the interface container */` |
|  391225 |  783 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  792 | `		SyString *pMName;` |
|  391225 |  793 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1361439 |  794 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  774609 |  795 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  774609 |  796 | `			pMName = &pMeth->sFunc.sName;` |
|  774609 |  797 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  885 | ` */` |
|    8188 |  886 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  887 | `{` |
|       - |  888 | `	ph7_class_instance *pThis;` |
|       - |  889 | `	/* Allocate a new instance */` |
|    8193 |  890 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    8193 |  891 | `	if( pThis == 0 ){` |
|     ! 0 |  892 | `		return 0;` |
|       - |  893 | `	}` |
|       - |  894 | `	/* Zero the structure */` |
|    8193 |  895 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  896 | `	/* Initialize fields */` |
|    8193 |  897 | `	pThis->iRef = 1;` |
|    8193 |  898 | `	pThis->pVm = pVm;` |
|    8193 |  899 | `	pThis->pClass = pClass;` |
|       - |  900 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    8193 |  901 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    8193 |  902 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    8193 |  903 | `	return pThis;` |
|    4099 |  904 | `}` |
|       - |  905 | `/*` |
|       - |  906 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  907 | ` * See the block comment above for more information.` |
|       - |  908 | ` */` |
|    7948 |  909 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  910 | `{` |
|       - |  911 | `	ph7_class_instance *pNew;` |
|       - |  912 | `	sxi32 rc;` |
|    7953 |  913 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    7953 |  914 | `	if( pNew == 0 ){` |
|     ! 0 |  915 | `		return 0;` |
|       - |  916 | `	}` |
|       - |  917 | `	/* Associate a private VM frame with this class instance */` |
|    7953 |  918 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    7953 |  919 | `	if( rc != SXRET_OK ){` |
...
|    7953 |  926 | `	PH7_VmStampThrowableSite(&(*pVm),pNew);` |
|    7953 |  927 | `	return pNew;` |
|    3979 |  928 | `}` |
|       - |  929 | `/*` |
|       - |  930 | ` * Extract the value of a class instance [i.e: Object in the PHP jargon] attribute.` |
|       - |  931 | ` * This function never fail.` |
|       - |  932 | ` */` |
|   20804 |  933 | `static ph7_value * ExtractClassAttrValue(ph7_vm *pVm,VmClassAttr *pAttr)` |
|       5 |  934 | `{` |
|       - |  935 | `	/* Extract the value */` |
|       - |  936 | `	ph7_value *pValue;` |
|   20809 |  937 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|   20809 |  938 | `	return pValue;` |
|       5 |  939 | `}` |
|       - |  940 | `/*` |
...
|       - | 1022 | ` * )` |
|       - | 1023 | ` */` |
|     240 | 1024 | `PH7_PRIVATE ph7_class_instance * PH7_CloneClassInstance(ph7_class_instance *pSrc)` |
|       4 | 1025 | `{` |
...
|     244 | 1033 | `	pVm = pSrc->pVm;` |
|     244 | 1034 | `	pClone = NewClassInstance(pVm,pSrc->pClass);` |
|     244 | 1035 | `	if( pClone == 0 ){` |
|     ! 0 | 1036 | `		return 0;` |
|       - | 1037 | `	}` |
|       - | 1038 | `	/* Associate a private VM frame with this class instance */` |
|     244 | 1039 | `	rc = PH7_VmCreateClassInstanceFrame(pVm,pClone);` |
|     244 | 1040 | `	if( rc != SXRET_OK ){` |
...
|     244 | 1049 | `	SyHashResetLoopCursor(&pSrc->hAttr);` |
|    2630 | 1050 | `	while((pEntry = SyHashGetNextEntry(&pSrc->hAttr)) != 0 ){` |
|    2390 | 1051 | `		VmClassAttr *pSrcAttr = (VmClassAttr *)pEntry->pUserData;` |
|    2390 | 1052 | `		VmClassAttr *pDestAttr = 0;` |
|    2390 | 1053 | `		ph7_value *pvSrc,*pvDest = 0;` |
|       - | 1054 | `		/* Duplicate non-static attribute */` |
|    2390 | 1055 | `		if( pSrcAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
|    1693 | 1056 | `			continue;` |
|       - | 1057 | `		}` |
|     698 | 1058 | `		pEntry2 = SyHashGet(&pClone->hAttr,SyStringData(&pSrcAttr->pAttr->sName),SyStringLength(&pSrcAttr->pAttr->sName));` |
|     698 | 1059 | `		if( pEntry2 ){` |
|     684 | 1060 | `			pDestAttr = (VmClassAttr *)pEntry2->pUserData;` |
|     684 | 1061 | `			pvDest = ExtractClassAttrValue(pVm,pDestAttr);` |
|     355 | 1062 | `		}else if( pSrcAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
...
|     698 | 1071 | `		pvSrc = ExtractClassAttrValue(pVm,pSrcAttr);` |
|     698 | 1072 | `		if( pvSrc && pvDest ){` |
|     698 | 1073 | `			PH7_MemObjStore(pvSrc,pvDest);` |
|     347 | 1074 | `		}` |
...
|     698 | 1080 | `		if( pDestAttr ){` |
|     698 | 1081 | `			pDestAttr->iState = pSrcAttr->iState;` |
|     347 | 1082 | `		}` |
|       4 | 1083 | `	}` |
...
|       - | 1088 | `	{` |
|       - | 1089 | `		SySet sDrop;` |
|     244 | 1090 | `		SySetInit(&sDrop,&pVm->sAllocator,sizeof(VmClassAttr *));` |
|     244 | 1091 | `		SyHashResetLoopCursor(&pClone->hAttr);` |
|    2632 | 1092 | `		while((pEntry = SyHashGetNextEntry(&pClone->hAttr)) != 0 ){` |
|    2392 | 1093 | `			VmClassAttr *pCloneAttr = (VmClassAttr *)pEntry->pUserData;` |
|    2392 | 1094 | `			if( pCloneAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT) ){` |
|    1693 | 1095 | `				continue;` |
|       - | 1096 | `			}` |
|    1044 | 1097 | `			if( SyHashGet(&pSrc->hAttr,SyStringData(&pCloneAttr->pAttr->sName),` |
|    1048 | 1098 | `					SyStringLength(&pCloneAttr->pAttr->sName)) == 0 ){` |
|       3 | 1099 | `				SySetPut(&sDrop,(const void *)&pCloneAttr);` |
|       1 | 1100 | `			}` |
|       4 | 1101 | `		}` |
|     244 | 1102 | `		if( SySetUsed(&sDrop) > 0 ){` |
...
|       2 | 1110 | `			}` |
|       1 | 1111 | `		}` |
|     244 | 1112 | `		SySetRelease(&sDrop);` |
|       - | 1113 | `	}` |
|       - | 1114 | `	/* call the __clone method on the cloned object if available */` |
|     244 | 1115 | `	pMethod = PH7_ClassExtractMethod(pClone->pClass,"__clone",sizeof("__clone")-1);` |
|     244 | 1116 | `	if( pMethod ){` |
...
|       - | 1137 | ` */` |
|   27576 | 1138 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1139 | `{` |
|   27581 | 1140 | `	if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   20345 | 1143 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     305 | 1144 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     150 | 1145 | `		}` |
|   20345 | 1146 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   10170 | 1147 | `	}` |
...
|   27581 | 1150 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     117 | 1151 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      58 | 1152 | `	}` |
|   27581 | 1153 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   27581 | 1154 | `}` |
|       - | 1155 | `/*` |
...
|       - | 1158 | ` * class instance.` |
|       - | 1159 | ` */` |
|    5502 | 1160 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1161 | `{` |
|       - | 1162 | `	ph7_class_method *pDestr;` |
|       - | 1163 | `	SyHashEntry *pEntry;` |
|       - | 1164 | `	ph7_class *pClass;` |
|       - | 1165 | `	ph7_vm *pVm;` |
|    5507 | 1166 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1167 | `		/*` |
...
|    5507 | 1174 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1175 | `	/* Invoke any defined destructor if available */` |
|    5507 | 1176 | `	pVm = pThis->pVm;` |
|    5507 | 1177 | `	pClass = pThis->pClass;` |
|    5507 | 1178 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5507 | 1179 | `	if( pDestr && !pVm->bInReset ){` |
...
|    5507 | 1189 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5507 | 1198 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   33055 | 1199 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   27553 | 1200 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1201 | `	}` |
|       - | 1202 | `	/* Release the whole structure */` |
|    5507 | 1203 | `	SyHashRelease(&pThis->hAttr);` |
|    5507 | 1204 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2756 | 1205 | `}` |
|       - | 1206 | `/*` |
...
|       - | 1209 | ` */` |
|  129546 | 1210 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1211 | `{` |
|  129551 | 1212 | `	pThis->iRef--;` |
|  129551 | 1213 | `	if( pThis->iRef < 1 ){` |
|       - | 1214 | `		/* No more reference to this instance */` |
|    5507 | 1215 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2751 | 1216 | `	}` |
|  129551 | 1217 | `}` |
|       - | 1218 | `/*` |
...
|       - | 1691 | ` */` |
|    8132 | 1692 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceExtractAttrValue(ph7_class_instance *pThis,VmClassAttr *pAttr)` |
|       5 | 1693 | `{` |
|       - | 1694 | `   /* Extract the attribute value */` |
|       - | 1695 | `	ph7_value *pValue;` |
|    8137 | 1696 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|    8137 | 1697 | `	return pValue;` |
|       5 | 1698 | `}` |
|       - | 1699 | `/*` |
...
|       - | 1811 | ` */` |
|   10798 | 1812 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceFetchAttr(ph7_class_instance *pThis,const SyString *pName)` |
|       5 | 1813 | `{` |
|       - | 1814 | `	SyHashEntry *pEntry;` |
|       - | 1815 | `	VmClassAttr *pAttr;` |
|       - | 1816 | `	/* Query the attribute hashtable */` |
|   10803 | 1817 | `	pEntry = SyHashGet(&pThis->hAttr,(const void *)pName->zString,pName->nByte);` |
|   10803 | 1818 | `	if( pEntry == 0 ){` |
|       - | 1819 | `		/* No such attribute */` |
|     ! 0 | 1820 | `		return 0;` |
|       - | 1821 | `	}` |
|       - | 1822 | `	/* Point to the class atrribute */` |
|   10803 | 1823 | `	pAttr = (VmClassAttr *)pEntry->pUserData;` |
|       - | 1824 | `	/* Check if we are dealing with a static/constant attribute */` |
|   10803 | 1825 | `	if( pAttr->pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|       - | 1826 | `		/* Access is forbidden */` |
|     ! 0 | 1827 | `		return 0;` |
|       - | 1828 | `	}` |
|       - | 1829 | `	/* Return the attribute value */` |
|   10803 | 1830 | `	return ExtractClassAttrValue(pThis->pVm,pAttr);` |
|    5404 | 1831 | `}` |
|       - | 1832 |  |
