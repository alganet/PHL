...
|      - |   13 | ` */` |
|  23718 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|      2 |   15 |  |
|      - |   16 | `	ph7_class *pClass;` |
|      - |   17 | `	char *zName;` |
|      - |   18 | `	/* Allocate a new instance */` |
|  23720 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  23720 |   20 | `	if( pClass == 0 ){` |
|    ! 0 |   21 | `		return 0;` |
|      - |   22 | `	}` |
|      - |   23 | `	/* Zero the structure */` |
|  23720 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|      - |   25 | `	/* Duplicate class name */` |
|  23720 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  23720 |   27 | `	if( zName == 0 ){` |
|    ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|    ! 0 |   29 | `		return 0;` |
|      - |   30 | `	}` |
|      - |   31 | `	/* Initialize fields */` |
|  23720 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  23720 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  23720 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  23720 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  23720 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  23720 |   37 | `	pClass->nLine = nLine;` |
|      - |   38 | `	/* All done */` |
|  23720 |   39 | `	return pClass;` |
|  11861 |   40 |  |
|      - |   41 | `/*` |
|      - |   42 | ` * Allocate and initialize a new class attribute.` |
|      - |   43 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|      - |   44 | ` */` |
|  21502 |   45 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|      2 |   46 |  |
|      - |   47 | `	ph7_class_attr *pAttr;` |
|      - |   48 | `	char *zName;` |
|  21504 |   49 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  21504 |   50 | `	if( pAttr == 0 ){` |
|    ! 0 |   51 | `		return 0;` |
|      - |   52 | `	}` |
|      - |   53 | `	/* Zero the structure */` |
|  21504 |   54 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|      - |   55 | `	/* Duplicate attribute name */` |
|  21504 |   56 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  21504 |   57 | `	if( zName == 0 ){` |
|    ! 0 |   58 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|    ! 0 |   59 | `		return 0;` |
|      - |   60 | `	}` |
|      - |   61 | `	/* Initialize fields */` |
|  21504 |   62 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  21504 |   63 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  21504 |   64 | `	pAttr->iProtection = iProtection;` |
|  21504 |   65 | `	pAttr->nIdx = SXU32_HIGH;` |
|  21504 |   66 | `	pAttr->iFlags = iFlags;` |
|  21504 |   67 | `	pAttr->nLine = nLine;` |
|  21504 |   68 | `	return pAttr;` |
|  10753 |   69 |  |
|      - |   70 | `/*` |
...
|      - |   75 | ` */` |
|  62040 |   76 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
|  62042 |   86 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
|  62042 |   87 | `	if( pMeth == 0 ){` |
|    ! 0 |   88 | `		return 0;` |
|      - |   89 | `	}` |
|      - |   90 | `	/* Zero the structure */` |
|  62042 |   91 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|      - |   92 | `	/* Check for an already installed method with the same name */` |
|  62042 |   93 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  62042 |   94 | `	if( pEntry == 0 ){` |
|      - |   95 | `		/* Associate an unique VM name to this method */` |
|  62040 |   96 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
|  62040 |   97 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
|  62040 |   98 | `		if( zName == 0 ){` |
|    ! 0 |   99 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|    ! 0 |  100 | `			return 0;` |
|      - |  101 | `		}` |
|  62040 |  102 | `		pNamePtr = &pMeth->sVmName;` |
|      - |  103 | `		/* Generate a random string */` |
|  62040 |  104 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
|  62040 |  105 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
|  62040 |  106 | `		pNamePtr->zString = zName;` |
|  31021 |  107 | `	}else{` |
...
|      - |  114 | `	}` |
|  62042 |  115 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|  62044 |  124 | `	pMeth->iProtection = iProtection;` |
|  62044 |  125 | `	pMeth->iFlags = iFlags;` |
|  62044 |  126 | `	pMeth->nLine = nLine;` |
|  93066 |  127 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
|  62042 |  128 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
|  62044 |  129 | `	return pMeth;` |
|  31024 |  130 |  |
|      - |  131 | `/*` |
...
|      - |  134 | ` */` |
|   4038 |  135 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|      2 |  136 |  |
|      - |  137 | `	SyHashEntry *pEntry;` |
|      - |  138 | `	/* Perform a hash lookup */` |
|   4040 |  139 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|   4040 |  140 | `	if( pEntry == 0 ){` |
|      - |  141 | `		/* No such entry */` |
|   1634 |  142 | `		return 0;` |
|      - |  143 | `	}` |
|      - |  144 | `	/* Point to the desired method */` |
|   2408 |  145 | `	return (ph7_class_method *)pEntry->pUserData;` |
|   2021 |  146 |  |
|      - |  147 | `/*` |
...
|      - |  166 | ` */` |
|  21502 |  167 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|      2 |  168 |  |
|  21504 |  169 | `	SyString *pName = &pAttr->sName;` |
|      - |  170 | `	sxi32 rc;` |
|  21504 |  171 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  21504 |  172 | `	return rc;` |
|      2 |  173 |  |
|      - |  174 | `/*` |
...
|      - |  177 | ` */` |
|  62038 |  178 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|      2 |  179 |  |
|  62040 |  180 | `	SyString *pName = &pMeth->sFunc.sName;` |
|      - |  181 | `	sxi32 rc;` |
|  62040 |  182 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  62040 |  183 | `	return rc;` |
|      2 |  184 |  |
|      - |  185 | `/*` |
...
|      - |  224 | ` * error message.` |
|      - |  225 | ` */` |
|  10698 |  226 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|      2 |  227 |  |
...
|  10700 |  234 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  10700 |  235 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  236 | `		return rc;` |
|      - |  237 | `	}` |
|      - |  238 | `	/* Copy public/protected attributes from the base class */` |
|  10700 |  239 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|  74684 |  240 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|      - |  241 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
|  63986 |  242 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  63986 |  243 | `		pName = &pAttr->sName;` |
|  63986 |  244 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
|  63984 |  256 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
|  63982 |  257 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  63982 |  258 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  259 | `				return rc;` |
|      - |  260 | `			}` |
|  31990 |  261 | `		}` |
|      2 |  262 | `	}` |
|  10700 |  263 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 106716 |  264 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|      - |  265 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
|  96018 |  266 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  96018 |  267 | `		pName = &pMeth->sFunc.sName;` |
|  96018 |  268 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   2160 |  269 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|   2160 |  278 | `			continue;` |
|    ! 0 |  279 | `		}else{` |
|  93860 |  280 | `			if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
|  93858 |  289 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
|  93856 |  290 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  93856 |  291 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  292 | `				return rc;` |
|      - |  293 | `			}` |
|  46927 |  294 | `		}` |
|      2 |  295 | `	}` |
|      - |  296 | `	/* Mark as subclass */` |
|  10700 |  297 | `	pSub->pBase = pBase;` |
|      - |  298 | `	/* All done */` |
|  10700 |  299 | `	return SXRET_OK;` |
|   5351 |  300 |  |
|      - |  301 | `/*` |
...
|      - |  476 | ` */` |
|    990 |  477 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      2 |  478 |  |
|      - |  479 | `	ph7_class_instance *pThis;` |
|      - |  480 | `	/* Allocate a new instance */` |
|    992 |  481 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    992 |  482 | `	if( pThis == 0 ){` |
|    ! 0 |  483 | `		return 0;` |
|      - |  484 | `	}` |
|      - |  485 | `	/* Zero the structure */` |
|    992 |  486 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|      - |  487 | `	/* Initialize fields */` |
|    992 |  488 | `	pThis->iRef = 1;` |
|    992 |  489 | `	pThis->pVm = pVm;` |
|    992 |  490 | `	pThis->pClass = pClass;` |
|    992 |  491 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    992 |  492 | `	return pThis;` |
|    497 |  493 |  |
|      - |  494 | `/*` |
|      - |  495 | ` * Wrapper around the NewClassInstance() function defined above.` |
|      - |  496 | ` * See the block comment above for more information.` |
|      - |  497 | ` */` |
|    948 |  498 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      2 |  499 |  |
|      - |  500 | `	ph7_class_instance *pNew;` |
|      - |  501 | `	sxi32 rc;` |
|    950 |  502 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    950 |  503 | `	if( pNew == 0 ){` |
|    ! 0 |  504 | `		return 0;` |
|      - |  505 | `	}` |
|      - |  506 | `	/* Associate a private VM frame with this class instance */` |
|    950 |  507 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    950 |  508 | `	if( rc != SXRET_OK ){` |
...
|      - |  665 | ` * class instance.` |
|      - |  666 | ` */` |
|    718 |  667 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|      2 |  668 |  |
|      - |  669 | `	ph7_class_method *pDestr;` |
|      - |  670 | `	SyHashEntry *pEntry;` |
|      - |  671 | `	ph7_class *pClass;` |
|      - |  672 | `	ph7_vm *pVm;` |
|    720 |  673 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|      - |  674 | `		/*` |
...
|    720 |  681 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|      - |  682 | `	/* Invoke any defined destructor if available */` |
|    720 |  683 | `	pVm = pThis->pVm;` |
|    720 |  684 | `	pClass = pThis->pClass;` |
|    720 |  685 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    720 |  686 | `	if( pDestr ){` |
...
|    720 |  692 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   3664 |  693 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   2946 |  694 | `		VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|   2946 |  695 | `		if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|   2942 |  696 | `			PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   1470 |  697 | `		}` |
|   2946 |  698 | `		SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      2 |  699 | `	}` |
|      - |  700 | `	/* Release the whole structure */` |
|    720 |  701 | `	SyHashRelease(&pThis->hAttr);` |
|    720 |  702 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    361 |  703 |  |
|      - |  704 | `/*` |
...
|      - |  707 | ` */` |
|  12394 |  708 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|      2 |  709 |  |
|  12396 |  710 | `	pThis->iRef--;` |
|  12396 |  711 | `	if( pThis->iRef < 1 ){` |
|      - |  712 | `		/* No more reference to this instance */` |
|    720 |  713 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    359 |  714 | `	}` |
|  12396 |  715 |  |
|      - |  716 | `/*` |
