...
|     - |   13 | ` */` |
| 13176 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|     2 |   15 |  |
|     - |   16 | `	ph7_class *pClass;` |
|     - |   17 | `	char *zName;` |
|     - |   18 | `	/* Allocate a new instance */` |
| 13178 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
| 13178 |   20 | `	if( pClass == 0 ){` |
|   ! 0 |   21 | `		return 0;` |
|     - |   22 | `	}` |
|     - |   23 | `	/* Zero the structure */` |
| 13178 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|     - |   25 | `	/* Duplicate class name */` |
| 13178 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 13178 |   27 | `	if( zName == 0 ){` |
|   ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|   ! 0 |   29 | `		return 0;` |
|     - |   30 | `	}` |
|     - |   31 | `	/* Initialize fields */` |
| 13178 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
| 13178 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
| 13178 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
| 13178 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
| 13178 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
| 13178 |   37 | `	pClass->nLine = nLine;` |
|     - |   38 | `	/* All done */` |
| 13178 |   39 | `	return pClass;` |
|  6590 |   40 |  |
|     - |   41 | `/*` |
|     - |   42 | ` * Allocate and initialize a new class attribute.` |
|     - |   43 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|     - |   44 | ` */` |
| 13104 |   45 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|     2 |   46 |  |
|     - |   47 | `	ph7_class_attr *pAttr;` |
|     - |   48 | `	char *zName;` |
| 13106 |   49 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
| 13106 |   50 | `	if( pAttr == 0 ){` |
|   ! 0 |   51 | `		return 0;` |
|     - |   52 | `	}` |
|     - |   53 | `	/* Zero the structure */` |
| 13106 |   54 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|     - |   55 | `	/* Duplicate attribute name */` |
| 13106 |   56 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 13106 |   57 | `	if( zName == 0 ){` |
|   ! 0 |   58 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|   ! 0 |   59 | `		return 0;` |
|     - |   60 | `	}` |
|     - |   61 | `	/* Initialize fields */` |
| 13106 |   62 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
| 13106 |   63 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
| 13106 |   64 | `	pAttr->iProtection = iProtection;` |
| 13106 |   65 | `	pAttr->nIdx = SXU32_HIGH;` |
| 13106 |   66 | `	pAttr->iFlags = iFlags;` |
| 13106 |   67 | `	pAttr->nLine = nLine;` |
| 13106 |   68 | `	return pAttr;` |
|  6554 |   69 |  |
|     - |   70 | `/*` |
...
|     - |   75 | ` */` |
| 37676 |   76 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 37678 |   86 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 37678 |   87 | `	if( pMeth == 0 ){` |
|   ! 0 |   88 | `		return 0;` |
|     - |   89 | `	}` |
|     - |   90 | `	/* Zero the structure */` |
| 37678 |   91 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|     - |   92 | `	/* Check for an already installed method with the same name */` |
| 37678 |   93 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 37678 |   94 | `	if( pEntry == 0 ){` |
|     - |   95 | `		/* Associate an unique VM name to this method */` |
| 37676 |   96 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 37676 |   97 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 37676 |   98 | `		if( zName == 0 ){` |
|   ! 0 |   99 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|   ! 0 |  100 | `			return 0;` |
|     - |  101 | `		}` |
| 37676 |  102 | `		pNamePtr = &pMeth->sVmName;` |
|     - |  103 | `		/* Generate a random string */` |
| 37676 |  104 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 37676 |  105 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 37676 |  106 | `		pNamePtr->zString = zName;` |
| 18839 |  107 | `	}else{` |
...
|     - |  114 | `	}` |
| 37678 |  115 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
| 37680 |  124 | `	pMeth->iProtection = iProtection;` |
| 37680 |  125 | `	pMeth->iFlags = iFlags;` |
| 37680 |  126 | `	pMeth->nLine = nLine;` |
| 56520 |  127 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 37678 |  128 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 37680 |  129 | `	return pMeth;` |
| 18842 |  130 |  |
|     - |  131 | `/*` |
...
|     - |  134 | ` */` |
|  2102 |  135 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|     2 |  136 |  |
|     - |  137 | `	SyHashEntry *pEntry;` |
|     - |  138 | `	/* Perform a hash lookup */` |
|  2104 |  139 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  2104 |  140 | `	if( pEntry == 0 ){` |
|     - |  141 | `		/* No such entry */` |
|  1226 |  142 | `		return 0;` |
|     - |  143 | `	}` |
|     - |  144 | `	/* Point to the desired method */` |
|   880 |  145 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  1053 |  146 |  |
|     - |  147 | `/*` |
...
|     - |  166 | ` */` |
| 13104 |  167 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|     2 |  168 |  |
| 13106 |  169 | `	SyString *pName = &pAttr->sName;` |
|     - |  170 | `	sxi32 rc;` |
| 13106 |  171 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 13106 |  172 | `	return rc;` |
|     2 |  173 |  |
|     - |  174 | `/*` |
...
|     - |  177 | ` */` |
| 37674 |  178 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|     2 |  179 |  |
| 37676 |  180 | `	SyString *pName = &pMeth->sFunc.sName;` |
|     - |  181 | `	sxi32 rc;` |
| 37676 |  182 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 37676 |  183 | `	return rc;` |
|     2 |  184 |  |
|     - |  185 | `/*` |
...
|     - |  224 | ` * error message.` |
|     - |  225 | ` */` |
|  5206 |  226 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|     2 |  227 |  |
...
|  5208 |  234 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  5208 |  235 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  236 | `		return rc;` |
|     - |  237 | `	}` |
|     - |  238 | `	/* Copy public/protected attributes from the base class */` |
|  5208 |  239 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 36240 |  240 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|     - |  241 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 31034 |  242 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 31034 |  243 | `		pName = &pAttr->sName;` |
| 31034 |  244 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 31032 |  256 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 31030 |  257 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 31030 |  258 | `			if( rc != SXRET_OK ){` |
|   ! 0 |  259 | `				return rc;` |
|     - |  260 | `			}` |
| 15514 |  261 | `		}` |
|     2 |  262 | `	}` |
|  5208 |  263 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 51796 |  264 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|     - |  265 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 46590 |  266 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 46590 |  267 | `		pName = &pMeth->sFunc.sName;` |
| 46590 |  268 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  1320 |  269 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  1320 |  278 | `			continue;` |
|   ! 0 |  279 | `		}else{` |
| 45272 |  280 | `			if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
| 45270 |  289 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 45268 |  290 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 45268 |  291 | `			if( rc != SXRET_OK ){` |
|   ! 0 |  292 | `				return rc;` |
|     - |  293 | `			}` |
| 22633 |  294 | `		}` |
|     2 |  295 | `	}` |
|     - |  296 | `	/* Mark as subclass */` |
|  5208 |  297 | `	pSub->pBase = pBase;` |
|     - |  298 | `	/* All done */` |
|  5208 |  299 | `	return SXRET_OK;` |
|  2605 |  300 |  |
|     - |  301 | `/*` |
...
|     - |  476 | ` */` |
|   598 |  477 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|     2 |  478 |  |
|     - |  479 | `	ph7_class_instance *pThis;` |
|     - |  480 | `	/* Allocate a new instance */` |
|   600 |  481 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|   600 |  482 | `	if( pThis == 0 ){` |
|   ! 0 |  483 | `		return 0;` |
|     - |  484 | `	}` |
|     - |  485 | `	/* Zero the structure */` |
|   600 |  486 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|     - |  487 | `	/* Initialize fields */` |
|   600 |  488 | `	pThis->iRef = 1;` |
|   600 |  489 | `	pThis->pVm = pVm;` |
|   600 |  490 | `	pThis->pClass = pClass;` |
|   600 |  491 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|   600 |  492 | `	return pThis;` |
|   301 |  493 |  |
|     - |  494 | `/*` |
|     - |  495 | ` * Wrapper around the NewClassInstance() function defined above.` |
|     - |  496 | ` * See the block comment above for more information.` |
|     - |  497 | ` */` |
|   556 |  498 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|     2 |  499 |  |
|     - |  500 | `	ph7_class_instance *pNew;` |
|     - |  501 | `	sxi32 rc;` |
|   558 |  502 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|   558 |  503 | `	if( pNew == 0 ){` |
|   ! 0 |  504 | `		return 0;` |
|     - |  505 | `	}` |
|     - |  506 | `	/* Associate a private VM frame with this class instance */` |
|   558 |  507 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|   558 |  508 | `	if( rc != SXRET_OK ){` |
...
|     - |  665 | ` * class instance.` |
|     - |  666 | ` */` |
|   332 |  667 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|     2 |  668 |  |
|     - |  669 | `	ph7_class_method *pDestr;` |
|     - |  670 | `	SyHashEntry *pEntry;` |
|     - |  671 | `	ph7_class *pClass;` |
|     - |  672 | `	ph7_vm *pVm;` |
|   334 |  673 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|     - |  674 | `		/*` |
...
|   334 |  681 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|     - |  682 | `	/* Invoke any defined destructor if available */` |
|   334 |  683 | `	pVm = pThis->pVm;` |
|   334 |  684 | `	pClass = pThis->pClass;` |
|   334 |  685 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|   334 |  686 | `	if( pDestr ){` |
...
|   334 |  692 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   988 |  693 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   656 |  694 | `		VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|   656 |  695 | `		if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|   652 |  696 | `			PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   325 |  697 | `		}` |
|   656 |  698 | `		SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|     2 |  699 | `	}` |
|     - |  700 | `	/* Release the whole structure */` |
|   334 |  701 | `	SyHashRelease(&pThis->hAttr);` |
|   334 |  702 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|   168 |  703 |  |
|     - |  704 | `/*` |
...
|     - |  707 | ` */` |
|  5508 |  708 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|     2 |  709 |  |
|  5510 |  710 | `	pThis->iRef--;` |
|  5510 |  711 | `	if( pThis->iRef < 1 ){` |
|     - |  712 | `		/* No more reference to this instance */` |
|   334 |  713 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|   166 |  714 | `	}` |
|  5510 |  715 |  |
|     - |  716 | `/*` |
