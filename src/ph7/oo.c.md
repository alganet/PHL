...
|       - |   13 | ` */` |
|  527452 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  527457 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  527457 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  527457 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  527457 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  527457 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  527457 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
...
|  527457 |   37 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|  527457 |   38 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  527457 |   39 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  527457 |   40 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  527457 |   41 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  527457 |   42 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  527457 |   43 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  527457 |   44 | `	pClass->nLine = nLine;` |
|  527457 |   45 | `	if( pVm->bCompilingBuiltin ){` |
...
|  525237 |   48 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  262621 |   49 | `	}else{` |
|       - |   50 | `		/* Alias the VM-lifetime path dup on top of the include stack */` |
|    2225 |   51 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    2225 |   52 | `		if( pFile ){` |
|    2225 |   53 | `			SyStringDupPtr(&pClass->sFile,pFile);` |
|    1110 |   54 | `		}` |
|       - |   55 | `	}` |
|       - |   56 | `	/* All done */` |
|  527457 |   57 | `	return pClass;` |
|  263731 |   58 | `}` |
|       - |   59 | `/*` |
|       - |   60 | ` * Allocate and initialize a new class attribute.` |
|       - |   61 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   62 | ` */` |
|  943804 |   63 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   64 | `{` |
|       - |   65 | `	ph7_class_attr *pAttr;` |
|       - |   66 | `	char *zName;` |
|  943809 |   67 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  943809 |   68 | `	if( pAttr == 0 ){` |
|     ! 0 |   69 | `		return 0;` |
|       - |   70 | `	}` |
|       - |   71 | `	/* Zero the structure */` |
|  943809 |   72 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  943809 |   73 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   74 | `	/* Duplicate attribute name */` |
|  943809 |   75 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  943809 |   76 | `	if( zName == 0 ){` |
|     ! 0 |   77 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   78 | `		return 0;` |
|       - |   79 | `	}` |
|       - |   80 | `	/* Initialize fields */` |
|  943809 |   81 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  943809 |   82 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  943809 |   83 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  943809 |   84 | `	pAttr->iProtection = iProtection;` |
|  943809 |   85 | `	pAttr->nIdx = SXU32_HIGH;` |
|  943809 |   86 | `	pAttr->iFlags = iFlags;` |
|  943809 |   87 | `	pAttr->nLine = nLine;` |
|  943809 |   88 | `	return pAttr;` |
|  471907 |   89 | `}` |
|       - |   90 | `/*` |
...
|       - |   95 | ` */` |
| 2883086 |   96 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2883091 |  106 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2883091 |  107 | `	if( pMeth == 0 ){` |
|     ! 0 |  108 | `		return 0;` |
|       - |  109 | `	}` |
|       - |  110 | `	/* Zero the structure */` |
| 2883091 |  111 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  112 | `	/* Check for an already installed method with the same name */` |
| 2883091 |  113 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2883091 |  114 | `	if( pEntry == 0 ){` |
|       - |  115 | `		/* Associate an unique VM name to this method */` |
| 2883087 |  116 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2883087 |  117 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2883087 |  118 | `		if( zName == 0 ){` |
|     ! 0 |  119 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  120 | `			return 0;` |
|       - |  121 | `		}` |
| 2883087 |  122 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  123 | `		/* Generate a random string */` |
| 2883087 |  124 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2883087 |  125 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2883087 |  126 | `		pNamePtr->zString = zName;` |
| 1441546 |  127 | `	}else{` |
...
|       - |  134 | `	}` |
| 2883091 |  135 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  166144 |  136 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  166149 |  137 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2883091 |  148 | `	pMeth->iProtection = iProtection;` |
| 2883091 |  149 | `	pMeth->iFlags = iFlags;` |
| 2883091 |  150 | `	pMeth->nLine = nLine;` |
| 4324634 |  151 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2883086 |  152 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2883091 |  153 | `	return pMeth;` |
| 1441548 |  154 | `}` |
|       - |  155 | `/*` |
...
|       - |  158 | ` */` |
| 3789336 |  159 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  160 | `{` |
|       - |  161 | `	SyHashEntry *pEntry;` |
|       - |  162 | `	/* Perform a hash lookup */` |
| 3789341 |  163 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
| 3789341 |  164 | `	if( pEntry == 0 ){` |
|       - |  165 | `		/* No such entry */` |
| 2913799 |  166 | `		return 0;` |
|       - |  167 | `	}` |
|       - |  168 | `	/* Point to the desired method */` |
|  875547 |  169 | `	return (ph7_class_method *)pEntry->pUserData;` |
| 1894673 |  170 | `}` |
|       - |  171 | `/*` |
...
|       - |  174 | ` */` |
| 2786184 |  175 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  176 | `{` |
|       - |  177 | `	SyHashEntry *pEntry;` |
|       - |  178 | `	/* Perform a hash lookup */` |
| 2786189 |  179 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
| 2786189 |  180 | `	if( pEntry == 0 ){` |
|       - |  181 | `		/* No such entry */` |
| 2784715 |  182 | `		return 0;` |
|       - |  183 | `	}` |
...
|       - |  190 | ` */` |
|  943800 |  191 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  192 | `{` |
|  943805 |  193 | `	SyString *pName = &pAttr->sName;` |
|       - |  194 | `	sxi32 rc;` |
...
|  943805 |  198 | `	if( pAttr->pDeclClass == 0 ){` |
|  943805 |  199 | `		pAttr->pDeclClass = pClass;` |
|  471900 |  200 | `	}` |
|  943805 |  201 | `	rc = SyHashInsertTail(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  943805 |  202 | `	return rc;` |
|       5 |  203 | `}` |
|       - |  204 | `/*` |
...
|       - |  207 | ` */` |
| 2883068 |  208 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  209 | `{` |
| 2883073 |  210 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  211 | `	sxi32 rc;` |
| 2883073 |  212 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2883073 |  213 | `	return rc;` |
|       5 |  214 | `}` |
|       - |  215 | `/*` |
...
|       - |  237 | ` */` |
|  278300 |  238 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  239 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  240 | `{` |
|  278305 |  241 | `	*ppClass = 0;` |
|  278305 |  242 | `	if( bUnion ){` |
|       3 |  243 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  244 | `	}` |
|  278303 |  245 | `	if( nType == 0 ){` |
|  278199 |  246 | `		return OVT_NONE; /* no declared type */` |
|       - |  247 | `	}` |
...
|       - |  290 | `	int bNullable;` |
|       - |  291 | `};` |
|  208720 |  292 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  293 | `{` |
|       - |  294 | `	OvType t;` |
|  208725 |  295 | `	t.nType = pF->nReturnType;` |
|  208725 |  296 | `	t.pClass = &pF->sReturnClass;` |
|  208725 |  297 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  208725 |  298 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  208725 |  299 | `	return t;` |
|       5 |  300 | `}` |
|   69580 |  301 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  302 | `{` |
|       - |  303 | `	OvType t;` |
|   69585 |  304 | `	t.nType = pA->nType;` |
|   69585 |  305 | `	t.pClass = &pA->sClass;` |
|   69585 |  306 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   69585 |  307 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   69585 |  308 | `	return t;` |
|       5 |  309 | `}` |
|       - |  310 | `/*` |
...
|       - |  315 | ` */` |
|  139150 |  316 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  317 | `{` |
|       - |  318 | `	ph7_class *pParentCls, *pChildCls;` |
|  139155 |  319 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|  139155 |  320 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|  139155 |  321 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|  139137 |  329 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|  139107 |  330 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|  139107 |  331 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|  139107 |  332 | `		return 0;` |
|       - |  333 | `	}` |
...
|       - |  359 | ` */` |
|  146850 |  360 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  361 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  362 | `{` |
|  146855 |  363 | `	ph7_vm *pVm = pGen->pVm;` |
|  146855 |  364 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|  146855 |  365 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|  146855 |  366 | `	SyString *pMName = &pCF->sName;` |
|       - |  367 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  368 | `	sxu32 nPArg, nCArg, k;` |
|  146855 |  369 | `	int bBad = 0;` |
|  146850 |  370 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   96610 |  371 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   42495 |  372 | `		return SXRET_OK;` |
|       - |  373 | `	}` |
|       - |  374 | `	/* Return type — covariant. */` |
|  104365 |  375 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  376 | `	/* Each overlapping parameter — contravariant. */` |
|  104365 |  377 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|  104365 |  378 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|  104365 |  379 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|  104365 |  380 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|  139155 |  381 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   34795 |  382 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|   17400 |  383 | `	}` |
...
|  104365 |  388 | `	if( !bBad ){` |
|  104361 |  389 | `		int bVariadic = 0;` |
|  139149 |  390 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  139151 |  391 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  104361 |  392 | `		if( !bVariadic ){` |
|  104361 |  393 | `			if( nCArg < nPArg ){` |
|     ! 0 |  394 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  395 | `			}else{` |
|  104363 |  396 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  451 | ` * error message.` |
|       - |  452 | ` */` |
|  247476 |  453 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  454 | `{` |
...
|       - |  460 | `	sxi32 rc;` |
|  247481 |  461 | `	SySetInit(&aInherited,&pGen->pVm->sAllocator,sizeof(ph7_class_attr *));` |
|       - |  462 | `	/* Install in the derived hashtable */` |
|  247481 |  463 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  247481 |  464 | `	if( rc != SXRET_OK ){` |
...
|  247481 |  470 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  247481 |  486 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1414369 |  487 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  488 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 1166893 |  489 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 1166893 |  490 | `		pName = &pAttr->sName;` |
| 1166893 |  491 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 1166868 |  539 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  743791 |  540 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
| 1166867 |  541 | `			rc = SySetPut(&aInherited,(const void *)&pAttr);` |
| 1166867 |  542 | `			if( rc != SXRET_OK ){` |
...
|  247481 |  554 | `	if( SySetUsed(&aInherited) > 0 ){` |
|  247345 |  555 | `		ph7_class_attr **apInherited = (ph7_class_attr **)SySetBasePtr(&aInherited);` |
|  247345 |  556 | `		sxu32 n = SySetUsed(&aInherited);` |
| 1414225 |  557 | `		while( n > 0 ){` |
| 1166885 |  558 | `			ph7_class_attr *pIn = apInherited[--n];` |
| 1166885 |  559 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pIn->sName.zString,pIn->sName.nByte,pIn);` |
| 1166885 |  560 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  561 | `				SySetRelease(&aInherited);` |
|     ! 0 |  562 | `				return rc;` |
|       - |  563 | `			}` |
|       5 |  564 | `		}` |
|  123670 |  565 | `	}` |
|  247481 |  566 | `	SySetRelease(&aInherited);` |
|  247481 |  567 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 3604579 |  568 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  569 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 3357103 |  570 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 3357103 |  571 | `		pName = &pMeth->sFunc.sName;` |
| 3357103 |  572 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  146859 |  573 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  220280 |  584 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|  146850 |  585 | `					(ph7_class_method *)pEntry->pUserData);` |
|  146855 |  586 | `				if( rc == SXERR_ABORT ){` |
...
| 3210244 |  600 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1620584 |  601 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 3210249 |  602 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 3210249 |  603 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  604 | `				return rc;` |
|       - |  605 | `			}` |
| 1605122 |  606 | `		}` |
|       5 |  607 | `	}` |
|       - |  608 | `	/* Mark as subclass */` |
|  247481 |  609 | `	pSub->pBase = pBase;` |
|       - |  610 | `	/* All done */` |
|  247481 |  611 | `	return SXRET_OK;` |
|  123743 |  612 | `}` |
|       - |  613 | `/*` |
...
|       - |  617 | ` */` |
|   15536 |  618 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  619 | `{` |
...
|   15541 |  626 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  633 | `	}` |
|   15541 |  634 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15541 |  635 | `	rc = SXRET_OK;` |
|       - |  636 | `	/* Copy attributes from the trait */` |
|   15541 |  637 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   61911 |  638 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  639 | `		SyHashEntry *pExisting;` |
|   46375 |  640 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   46375 |  641 | `		pName = &pAttr->sName;` |
|   46375 |  642 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   46375 |  643 | `		if( pExisting != 0 ){` |
...
|       6 |  672 | `			continue;` |
|       - |  673 | `		}` |
|   46371 |  674 | `		rc = SyHashInsertTail(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   46371 |  675 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  676 | `			goto cleanup;` |
|       - |  677 | `		}` |
|       5 |  678 | `	}` |
|       - |  679 | `	/* Copy methods from the trait */` |
|   15541 |  680 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  224183 |  681 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|       - |  682 | `		SyHashEntry *pClassMethEntry;` |
|  208647 |  683 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  208647 |  684 | `		pName = &pMeth->sFunc.sName;` |
|  208647 |  685 | `		pClassMethEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  208647 |  686 | `		if( pClassMethEntry != 0 ){` |
...
|       8 |  728 | `			continue;` |
|       - |  729 | `		}` |
|  208633 |  730 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  208633 |  731 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  732 | `			goto cleanup;` |
|       - |  733 | `		}` |
|       5 |  734 | `	}` |
|       - |  735 | `	/* Record trait in the class */` |
|   15541 |  736 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7768 |  737 | `cleanup:` |
|       - |  738 | `	/* Always clear visiting flag, even on error paths */` |
|   15541 |  739 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7768 |  740 | `	SXUNUSED(pGen);` |
|   15541 |  741 | `	return rc;` |
|    7773 |  742 | `}` |
|       - |  743 | `/*` |
...
|       - |  754 | ` * error message.` |
|       - |  755 | ` */` |
|   27046 |  756 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  757 | `{` |
...
|   27051 |  764 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   27051 |  765 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  766 | `	/* Copy constants */` |
|   40576 |  767 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  777 | `		}` |
|       1 |  778 | `	}` |
|   27051 |  779 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  780 | `	/* Copy methods signature */` |
|  106272 |  781 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  782 | `		/* Make sure the method are not redeclared in the subclass */` |
|   65703 |  783 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   65703 |  784 | `		pName = &pMeth->sFunc.sName;` |
|   65703 |  785 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  786 | `			/* Install the method */` |
|   65703 |  787 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   65703 |  788 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  789 | `				return rc;` |
|       - |  790 | `			}` |
|   32849 |  791 | `		}` |
|       5 |  792 | `	}` |
|       - |  793 | `	/* Mark as subclass */` |
|   27051 |  794 | `	pSub->pBase = pBase;` |
|       - |  795 | `	/* All done */` |
|   27051 |  796 | `	return SXRET_OK;` |
|   13528 |  797 | `}` |
|       - |  798 | `/*` |
...
|       - |  809 | ` * error message.` |
|       - |  810 | ` */` |
|  421314 |  811 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  812 | `{` |
...
|  421319 |  818 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  740126 |  819 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
|       - |  820 | `		/* Point to the constant declaration */` |
|  108155 |  821 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  108155 |  822 | `		pName = &pAttr->sName;` |
|       - |  823 | `		/* Make sure the attribute is not redeclared in the main class */` |
|  108155 |  824 | `		if( SyHashGet(&pMain->hAttr,pName->zString,pName->nByte) == 0 ){` |
|       - |  825 | `			/* Install the attribute */` |
|  108151 |  826 | `			rc = SyHashInsertTail(&pMain->hAttr,pName->zString,pName->nByte,pAttr);` |
|  108151 |  827 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  828 | `				return rc;` |
|       - |  829 | `			}` |
|   54073 |  830 | `		}` |
|       5 |  831 | `	}` |
|       - |  832 | `	/* Install in the interface container */` |
|  421319 |  833 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  842 | `		SyString *pMName;` |
|  421319 |  843 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1451328 |  844 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  819357 |  845 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  819357 |  846 | `			pMName = &pMeth->sFunc.sName;` |
|  819357 |  847 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  935 | ` */` |
|    8830 |  936 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  937 | `{` |
|       - |  938 | `	ph7_class_instance *pThis;` |
|       - |  939 | `	/* Allocate a new instance */` |
|    8835 |  940 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    8835 |  941 | `	if( pThis == 0 ){` |
|     ! 0 |  942 | `		return 0;` |
|       - |  943 | `	}` |
|       - |  944 | `	/* Zero the structure */` |
|    8835 |  945 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  946 | `	/* Initialize fields */` |
|    8835 |  947 | `	pThis->iRef = 1;` |
|    8835 |  948 | `	pThis->pVm = pVm;` |
|    8835 |  949 | `	pThis->pClass = pClass;` |
|       - |  950 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    8835 |  951 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    8835 |  952 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    8835 |  953 | `	return pThis;` |
|    4420 |  954 | `}` |
|       - |  955 | `/*` |
|       - |  956 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  957 | ` * See the block comment above for more information.` |
|       - |  958 | ` */` |
|    8584 |  959 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  960 | `{` |
|       - |  961 | `	ph7_class_instance *pNew;` |
|       - |  962 | `	sxi32 rc;` |
|    8589 |  963 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    8589 |  964 | `	if( pNew == 0 ){` |
|     ! 0 |  965 | `		return 0;` |
|       - |  966 | `	}` |
|       - |  967 | `	/* Associate a private VM frame with this class instance */` |
|    8589 |  968 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    8589 |  969 | `	if( rc != SXRET_OK ){` |
...
|    8589 |  976 | `	PH7_VmStampThrowableSite(&(*pVm),pNew);` |
|    8589 |  977 | `	return pNew;` |
|    4297 |  978 | `}` |
|       - |  979 | `/*` |
|       - |  980 | ` * Extract the value of a class instance [i.e: Object in the PHP jargon] attribute.` |
|       - |  981 | ` * This function never fail.` |
|       - |  982 | ` */` |
|   24708 |  983 | `static ph7_value * ExtractClassAttrValue(ph7_vm *pVm,VmClassAttr *pAttr)` |
|       5 |  984 | `{` |
|       - |  985 | `	/* Extract the value */` |
|       - |  986 | `	ph7_value *pValue;` |
|   24713 |  987 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|   24713 |  988 | `	return pValue;` |
|       5 |  989 | `}` |
|       - |  990 | `/*` |
...
|       - | 1206 | ` */` |
|   29452 | 1207 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1208 | `{` |
|   29457 | 1209 | `	if( pVmAttr->iState & VM_CLASS_ATTR_REFBOUND ){` |
...
|   29452 | 1214 | `	}else if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   22149 | 1217 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     308 | 1218 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     152 | 1219 | `		}` |
|   22149 | 1220 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   11072 | 1221 | `	}` |
...
|   29457 | 1224 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     116 | 1225 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      57 | 1226 | `	}` |
|   29457 | 1227 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   29457 | 1228 | `}` |
|       - | 1229 | `/*` |
...
|       - | 1232 | ` * class instance.` |
|       - | 1233 | ` */` |
|    5872 | 1234 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1235 | `{` |
|       - | 1236 | `	ph7_class_method *pDestr;` |
|       - | 1237 | `	SyHashEntry *pEntry;` |
|       - | 1238 | `	ph7_class *pClass;` |
|       - | 1239 | `	ph7_vm *pVm;` |
|    5877 | 1240 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1241 | `		/*` |
...
|    5877 | 1248 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1249 | `	/* Invoke any defined destructor if available */` |
|    5877 | 1250 | `	pVm = pThis->pVm;` |
|    5877 | 1251 | `	pClass = pThis->pClass;` |
|    5877 | 1252 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5877 | 1253 | `	if( pDestr && !pVm->bInReset ){` |
...
|    5877 | 1263 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5877 | 1272 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   35301 | 1273 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   29429 | 1274 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1275 | `	}` |
|       - | 1276 | `	/* Release the whole structure */` |
|    5877 | 1277 | `	SyHashRelease(&pThis->hAttr);` |
|    5877 | 1278 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2941 | 1279 | `}` |
|       - | 1280 | `/*` |
...
|       - | 1283 | ` */` |
|  148268 | 1284 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1285 | `{` |
|  148273 | 1286 | `	pThis->iRef--;` |
|  148273 | 1287 | `	if( pThis->iRef < 1 ){` |
|       - | 1288 | `		/* No more reference to this instance */` |
|    5877 | 1289 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2936 | 1290 | `	}` |
|  148273 | 1291 | `}` |
|       - | 1292 | `/*` |
...
|       - | 1765 | ` */` |
|   11678 | 1766 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceExtractAttrValue(ph7_class_instance *pThis,VmClassAttr *pAttr)` |
|       5 | 1767 | `{` |
|       - | 1768 | `   /* Extract the attribute value */` |
|       - | 1769 | `	ph7_value *pValue;` |
|   11683 | 1770 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|   11683 | 1771 | `	return pValue;` |
|       5 | 1772 | `}` |
|       - | 1773 | `/*` |
...
|       - | 1900 | ` */` |
|   11128 | 1901 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceFetchAttr(ph7_class_instance *pThis,const SyString *pName)` |
|       5 | 1902 | `{` |
|       - | 1903 | `	SyHashEntry *pEntry;` |
|       - | 1904 | `	VmClassAttr *pAttr;` |
|       - | 1905 | `	/* Query the attribute hashtable */` |
|   11133 | 1906 | `	pEntry = SyHashGet(&pThis->hAttr,(const void *)pName->zString,pName->nByte);` |
|   11133 | 1907 | `	if( pEntry == 0 ){` |
|       - | 1908 | `		/* No such attribute */` |
|     ! 0 | 1909 | `		return 0;` |
|       - | 1910 | `	}` |
|       - | 1911 | `	/* Point to the class atrribute */` |
|   11133 | 1912 | `	pAttr = (VmClassAttr *)pEntry->pUserData;` |
|       - | 1913 | `	/* Check if we are dealing with a static/constant attribute */` |
|   11133 | 1914 | `	if( pAttr->pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|       - | 1915 | `		/* Access is forbidden */` |
|     ! 0 | 1916 | `		return 0;` |
|       - | 1917 | `	}` |
|       - | 1918 | `	/* Return the attribute value */` |
|   11133 | 1919 | `	return ExtractClassAttrValue(pThis->pVm,pAttr);` |
|    5569 | 1920 | `}` |
|       - | 1921 |  |
