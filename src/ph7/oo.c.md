...
|       - |   13 | ` */` |
|  532348 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  532353 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  532353 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  532353 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  532353 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  532353 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  532353 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
...
|  532353 |   37 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|  532353 |   38 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  532353 |   39 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  532353 |   40 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  532353 |   41 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  532353 |   42 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  532353 |   43 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  532353 |   44 | `	pClass->nLine = nLine;` |
|  532353 |   45 | `	if( pVm->bCompilingBuiltin ){` |
...
|  530133 |   48 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  265069 |   49 | `	}else{` |
...
|       - |   55 | `	}` |
|       - |   56 | `	/* All done */` |
|  532353 |   57 | `	return pClass;` |
|  266179 |   58 | `}` |
|       - |   59 | `/*` |
|       - |   60 | ` * Allocate and initialize a new class attribute.` |
|       - |   61 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   62 | ` */` |
|  952588 |   63 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   64 | `{` |
|       - |   65 | `	ph7_class_attr *pAttr;` |
|       - |   66 | `	char *zName;` |
|  952593 |   67 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  952593 |   68 | `	if( pAttr == 0 ){` |
|     ! 0 |   69 | `		return 0;` |
|       - |   70 | `	}` |
|       - |   71 | `	/* Zero the structure */` |
|  952593 |   72 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  952593 |   73 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   74 | `	/* Duplicate attribute name */` |
|  952593 |   75 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  952593 |   76 | `	if( zName == 0 ){` |
|     ! 0 |   77 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   78 | `		return 0;` |
|       - |   79 | `	}` |
|       - |   80 | `	/* Initialize fields */` |
|  952593 |   81 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  952593 |   82 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  952593 |   83 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  952593 |   84 | `	pAttr->iProtection = iProtection;` |
|  952593 |   85 | `	pAttr->nIdx = SXU32_HIGH;` |
|  952593 |   86 | `	pAttr->iFlags = iFlags;` |
|  952593 |   87 | `	pAttr->nLine = nLine;` |
|  952593 |   88 | `	return pAttr;` |
|  476299 |   89 | `}` |
|       - |   90 | `/*` |
...
|       - |   95 | ` */` |
| 2909942 |   96 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2909947 |  106 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2909947 |  107 | `	if( pMeth == 0 ){` |
|     ! 0 |  108 | `		return 0;` |
|       - |  109 | `	}` |
|       - |  110 | `	/* Zero the structure */` |
| 2909947 |  111 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  112 | `	/* Check for an already installed method with the same name */` |
| 2909947 |  113 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2909947 |  114 | `	if( pEntry == 0 ){` |
|       - |  115 | `		/* Associate an unique VM name to this method */` |
| 2909943 |  116 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2909943 |  117 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2909943 |  118 | `		if( zName == 0 ){` |
|     ! 0 |  119 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  120 | `			return 0;` |
|       - |  121 | `		}` |
| 2909943 |  122 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  123 | `		/* Generate a random string */` |
| 2909943 |  124 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2909943 |  125 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2909943 |  126 | `		pNamePtr->zString = zName;` |
| 1454974 |  127 | `	}else{` |
...
|       - |  134 | `	}` |
| 2909947 |  135 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  167692 |  136 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  167697 |  137 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2909947 |  148 | `	pMeth->iProtection = iProtection;` |
| 2909947 |  149 | `	pMeth->iFlags = iFlags;` |
| 2909947 |  150 | `	pMeth->nLine = nLine;` |
| 4364918 |  151 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2909942 |  152 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2909947 |  153 | `	return pMeth;` |
| 1454976 |  154 | `}` |
|       - |  155 | `/*` |
...
|       - |  158 | ` */` |
| 3823760 |  159 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  160 | `{` |
|       - |  161 | `	SyHashEntry *pEntry;` |
|       - |  162 | `	/* Perform a hash lookup */` |
| 3823765 |  163 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
| 3823765 |  164 | `	if( pEntry == 0 ){` |
|       - |  165 | `		/* No such entry */` |
| 2940615 |  166 | `		return 0;` |
|       - |  167 | `	}` |
|       - |  168 | `	/* Point to the desired method */` |
|  883155 |  169 | `	return (ph7_class_method *)pEntry->pUserData;` |
| 1911885 |  170 | `}` |
|       - |  171 | `/*` |
...
|       - |  190 | ` */` |
|  952584 |  191 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  192 | `{` |
|  952589 |  193 | `	SyString *pName = &pAttr->sName;` |
|       - |  194 | `	sxi32 rc;` |
...
|  952589 |  198 | `	if( pAttr->pDeclClass == 0 ){` |
|  952589 |  199 | `		pAttr->pDeclClass = pClass;` |
|  476292 |  200 | `	}` |
|  952589 |  201 | `	rc = SyHashInsertTail(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  952589 |  202 | `	return rc;` |
|       5 |  203 | `}` |
|       - |  204 | `/*` |
...
|       - |  207 | ` */` |
| 2909924 |  208 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  209 | `{` |
| 2909929 |  210 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  211 | `	sxi32 rc;` |
| 2909929 |  212 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2909929 |  213 | `	return rc;` |
|       5 |  214 | `}` |
|       - |  215 | `/*` |
...
|       - |  237 | ` */` |
|  280892 |  238 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  239 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  240 | `{` |
|  280897 |  241 | `	*ppClass = 0;` |
|  280897 |  242 | `	if( bUnion ){` |
|       3 |  243 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  244 | `	}` |
|  280895 |  245 | `	if( nType == 0 ){` |
|  280791 |  246 | `		return OVT_NONE; /* no declared type */` |
|       - |  247 | `	}` |
...
|       - |  290 | `	int bNullable;` |
|       - |  291 | `};` |
|  210664 |  292 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  293 | `{` |
|       - |  294 | `	OvType t;` |
|  210669 |  295 | `	t.nType = pF->nReturnType;` |
|  210669 |  296 | `	t.pClass = &pF->sReturnClass;` |
|  210669 |  297 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  210669 |  298 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  210669 |  299 | `	return t;` |
|       5 |  300 | `}` |
|   70228 |  301 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  302 | `{` |
|       - |  303 | `	OvType t;` |
|   70233 |  304 | `	t.nType = pA->nType;` |
|   70233 |  305 | `	t.pClass = &pA->sClass;` |
|   70233 |  306 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   70233 |  307 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   70233 |  308 | `	return t;` |
|       5 |  309 | `}` |
|       - |  310 | `/*` |
...
|       - |  315 | ` */` |
|  140446 |  316 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  317 | `{` |
|       - |  318 | `	ph7_class *pParentCls, *pChildCls;` |
|  140451 |  319 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|  140451 |  320 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|  140451 |  321 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|  140433 |  329 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|  140403 |  330 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|  140403 |  331 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|  140403 |  332 | `		return 0;` |
|       - |  333 | `	}` |
...
|       - |  359 | ` */` |
|  148218 |  360 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  361 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  362 | `{` |
|  148223 |  363 | `	ph7_vm *pVm = pGen->pVm;` |
|  148223 |  364 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|  148223 |  365 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|  148223 |  366 | `	SyString *pMName = &pCF->sName;` |
|       - |  367 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  368 | `	sxu32 nPArg, nCArg, k;` |
|  148223 |  369 | `	int bBad = 0;` |
|  148218 |  370 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   97510 |  371 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   42891 |  372 | `		return SXRET_OK;` |
|       - |  373 | `	}` |
|       - |  374 | `	/* Return type — covariant. */` |
|  105337 |  375 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  376 | `	/* Each overlapping parameter — contravariant. */` |
|  105337 |  377 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|  105337 |  378 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|  105337 |  379 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|  105337 |  380 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|  140451 |  381 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   35119 |  382 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|   17562 |  383 | `	}` |
...
|  105337 |  388 | `	if( !bBad ){` |
|  105333 |  389 | `		int bVariadic = 0;` |
|  140445 |  390 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  140447 |  391 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  105333 |  392 | `		if( !bVariadic ){` |
|  105333 |  393 | `			if( nCArg < nPArg ){` |
|     ! 0 |  394 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  395 | `			}else{` |
|  105335 |  396 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  451 | ` * error message.` |
|       - |  452 | ` */` |
|  249780 |  453 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  454 | `{` |
...
|       - |  460 | `	sxi32 rc;` |
|  249785 |  461 | `	SySetInit(&aInherited,&pGen->pVm->sAllocator,sizeof(ph7_class_attr *));` |
|       - |  462 | `	/* Install in the derived hashtable */` |
|  249785 |  463 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  249785 |  464 | `	if( rc != SXRET_OK ){` |
...
|  249785 |  470 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  249785 |  486 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1427545 |  487 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  488 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 1177765 |  489 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 1177765 |  490 | `		pName = &pAttr->sName;` |
| 1177765 |  491 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 1177740 |  539 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  750721 |  540 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
| 1177739 |  541 | `			rc = SySetPut(&aInherited,(const void *)&pAttr);` |
| 1177739 |  542 | `			if( rc != SXRET_OK ){` |
...
|  249785 |  554 | `	if( SySetUsed(&aInherited) > 0 ){` |
|  249649 |  555 | `		ph7_class_attr **apInherited = (ph7_class_attr **)SySetBasePtr(&aInherited);` |
|  249649 |  556 | `		sxu32 n = SySetUsed(&aInherited);` |
| 1427401 |  557 | `		while( n > 0 ){` |
| 1177757 |  558 | `			ph7_class_attr *pIn = apInherited[--n];` |
| 1177757 |  559 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pIn->sName.zString,pIn->sName.nByte,pIn);` |
| 1177757 |  560 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  561 | `				SySetRelease(&aInherited);` |
|     ! 0 |  562 | `				return rc;` |
|       - |  563 | `			}` |
|       5 |  564 | `		}` |
|  124822 |  565 | `	}` |
|  249785 |  566 | `	SySetRelease(&aInherited);` |
|  249785 |  567 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 3638167 |  568 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  569 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 3388387 |  570 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 3388387 |  571 | `		pName = &pMeth->sFunc.sName;` |
| 3388387 |  572 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  148227 |  573 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  222332 |  584 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|  148218 |  585 | `					(ph7_class_method *)pEntry->pUserData);` |
|  148223 |  586 | `				if( rc == SXERR_ABORT ){` |
...
| 3240160 |  600 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1635686 |  601 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 3240165 |  602 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 3240165 |  603 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  604 | `				return rc;` |
|       - |  605 | `			}` |
| 1620080 |  606 | `		}` |
|       5 |  607 | `	}` |
|       - |  608 | `	/* Mark as subclass */` |
|  249785 |  609 | `	pSub->pBase = pBase;` |
|       - |  610 | `	/* All done */` |
|  249785 |  611 | `	return SXRET_OK;` |
|  124895 |  612 | `}` |
|       - |  613 | `/*` |
...
|       - |  617 | ` */` |
|   15680 |  618 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  619 | `{` |
...
|   15685 |  626 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  633 | `	}` |
|   15685 |  634 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15685 |  635 | `	rc = SXRET_OK;` |
|       - |  636 | `	/* Copy attributes from the trait */` |
|   15685 |  637 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   62487 |  638 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  639 | `		SyHashEntry *pExisting;` |
|   46807 |  640 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   46807 |  641 | `		pName = &pAttr->sName;` |
|   46807 |  642 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   46807 |  643 | `		if( pExisting != 0 ){` |
...
|       6 |  672 | `			continue;` |
|       - |  673 | `		}` |
|   46803 |  674 | `		rc = SyHashInsertTail(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   46803 |  675 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  676 | `			goto cleanup;` |
|       - |  677 | `		}` |
|       5 |  678 | `	}` |
|       - |  679 | `	/* Copy methods from the trait */` |
|   15685 |  680 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  226271 |  681 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|       - |  682 | `		SyHashEntry *pClassMethEntry;` |
|  210591 |  683 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  210591 |  684 | `		pName = &pMeth->sFunc.sName;` |
|  210591 |  685 | `		pClassMethEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  210591 |  686 | `		if( pClassMethEntry != 0 ){` |
...
|       8 |  728 | `			continue;` |
|       - |  729 | `		}` |
|  210577 |  730 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  210577 |  731 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  732 | `			goto cleanup;` |
|       - |  733 | `		}` |
|       5 |  734 | `	}` |
|       - |  735 | `	/* Record trait in the class */` |
|   15685 |  736 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7840 |  737 | `cleanup:` |
|       - |  738 | `	/* Always clear visiting flag, even on error paths */` |
|   15685 |  739 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7840 |  740 | `	SXUNUSED(pGen);` |
|   15685 |  741 | `	return rc;` |
|    7845 |  742 | `}` |
|       - |  743 | `/*` |
...
|       - |  754 | ` * error message.` |
|       - |  755 | ` */` |
|   27298 |  756 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  757 | `{` |
...
|   27303 |  764 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   27303 |  765 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  766 | `	/* Copy constants */` |
|   40954 |  767 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  777 | `		}` |
|       1 |  778 | `	}` |
|   27303 |  779 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  780 | `	/* Copy methods signature */` |
|  107262 |  781 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  782 | `		/* Make sure the method are not redeclared in the subclass */` |
|   66315 |  783 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   66315 |  784 | `		pName = &pMeth->sFunc.sName;` |
|   66315 |  785 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  786 | `			/* Install the method */` |
|   66315 |  787 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   66315 |  788 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  789 | `				return rc;` |
|       - |  790 | `			}` |
|   33155 |  791 | `		}` |
|       5 |  792 | `	}` |
|       - |  793 | `	/* Mark as subclass */` |
|   27303 |  794 | `	pSub->pBase = pBase;` |
|       - |  795 | `	/* All done */` |
|   27303 |  796 | `	return SXRET_OK;` |
|   13654 |  797 | `}` |
|       - |  798 | `/*` |
...
|       - |  809 | ` * error message.` |
|       - |  810 | ` */` |
|  425238 |  811 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  812 | `{` |
...
|  425243 |  818 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  747020 |  819 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
|       - |  820 | `		/* Point to the constant declaration */` |
|  109163 |  821 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  109163 |  822 | `		pName = &pAttr->sName;` |
|       - |  823 | `		/* Make sure the attribute is not redeclared in the main class */` |
|  109163 |  824 | `		if( SyHashGet(&pMain->hAttr,pName->zString,pName->nByte) == 0 ){` |
|       - |  825 | `			/* Install the attribute */` |
|  109159 |  826 | `			rc = SyHashInsertTail(&pMain->hAttr,pName->zString,pName->nByte,pAttr);` |
|  109159 |  827 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  828 | `				return rc;` |
|       - |  829 | `			}` |
|   54577 |  830 | `		}` |
|       5 |  831 | `	}` |
|       - |  832 | `	/* Install in the interface container */` |
|  425243 |  833 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  842 | `		SyString *pMName;` |
|  425243 |  843 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1464846 |  844 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  826989 |  845 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  826989 |  846 | `			pMName = &pMeth->sFunc.sName;` |
|  826989 |  847 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
