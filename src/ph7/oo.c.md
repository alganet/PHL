...
|       - |   13 | ` */` |
|  259340 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  259345 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  259345 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  259345 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  259345 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  259345 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  259345 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  259345 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  259345 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  259345 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  259345 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  259345 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  259345 |   38 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  259345 |   39 | `	pClass->nLine = nLine;` |
|  259345 |   40 | `	if( pVm->bCompilingBuiltin ){` |
...
|    1663 |   46 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    1663 |   47 | `		if( pFile ){` |
|    1663 |   48 | `			SyStringDupPtr(&pClass->sFile,pFile);` |
|     829 |   49 | `		}` |
|       - |   50 | `	}` |
|       - |   51 | `	/* All done */` |
|  259345 |   52 | `	return pClass;` |
|  129675 |   53 | `}` |
|       - |   54 | `/*` |
|       - |   55 | ` * Allocate and initialize a new class attribute.` |
|       - |   56 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   57 | ` */` |
|  350956 |   58 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   59 | `{` |
|       - |   60 | `	ph7_class_attr *pAttr;` |
|       - |   61 | `	char *zName;` |
|  350961 |   62 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  350961 |   63 | `	if( pAttr == 0 ){` |
|     ! 0 |   64 | `		return 0;` |
|       - |   65 | `	}` |
|       - |   66 | `	/* Zero the structure */` |
|  350961 |   67 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  350961 |   68 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   69 | `	/* Duplicate attribute name */` |
|  350961 |   70 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  350961 |   71 | `	if( zName == 0 ){` |
|     ! 0 |   72 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   73 | `		return 0;` |
|       - |   74 | `	}` |
|       - |   75 | `	/* Initialize fields */` |
|  350961 |   76 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  350961 |   77 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  350961 |   78 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  350961 |   79 | `	pAttr->iProtection = iProtection;` |
|  350961 |   80 | `	pAttr->nIdx = SXU32_HIGH;` |
|  350961 |   81 | `	pAttr->iFlags = iFlags;` |
|  350961 |   82 | `	pAttr->nLine = nLine;` |
|  350961 |   83 | `	return pAttr;` |
|  175483 |   84 | `}` |
|       - |   85 | `/*` |
...
|       - |   90 | ` */` |
| 1374402 |   91 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 1374407 |  101 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 1374407 |  102 | `	if( pMeth == 0 ){` |
|     ! 0 |  103 | `		return 0;` |
|       - |  104 | `	}` |
|       - |  105 | `	/* Zero the structure */` |
| 1374407 |  106 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  107 | `	/* Check for an already installed method with the same name */` |
| 1374407 |  108 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 1374407 |  109 | `	if( pEntry == 0 ){` |
|       - |  110 | `		/* Associate an unique VM name to this method */` |
| 1374405 |  111 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 1374405 |  112 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 1374405 |  113 | `		if( zName == 0 ){` |
|     ! 0 |  114 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  115 | `			return 0;` |
|       - |  116 | `		}` |
| 1374405 |  117 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  118 | `		/* Generate a random string */` |
| 1374405 |  119 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 1374405 |  120 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 1374405 |  121 | `		pNamePtr->zString = zName;` |
|  687205 |  122 | `	}else{` |
...
|       - |  129 | `	}` |
| 1374407 |  130 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|   57730 |  131 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|   57735 |  132 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 1374407 |  143 | `	pMeth->iProtection = iProtection;` |
| 1374407 |  144 | `	pMeth->iFlags = iFlags;` |
| 1374407 |  145 | `	pMeth->nLine = nLine;` |
| 2061608 |  146 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 1374402 |  147 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 1374407 |  148 | `	return pMeth;` |
|  687206 |  149 | `}` |
|       - |  150 | `/*` |
...
|       - |  153 | ` */` |
|  313234 |  154 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  155 | `{` |
|       - |  156 | `	SyHashEntry *pEntry;` |
|       - |  157 | `	/* Perform a hash lookup */` |
|  313239 |  158 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  313239 |  159 | `	if( pEntry == 0 ){` |
|       - |  160 | `		/* No such entry */` |
|    6601 |  161 | `		return 0;` |
|       - |  162 | `	}` |
|       - |  163 | `	/* Point to the desired method */` |
|  306643 |  164 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  156622 |  165 | `}` |
|       - |  166 | `/*` |
...
|       - |  169 | ` */` |
|  208834 |  170 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  171 | `{` |
|       - |  172 | `	SyHashEntry *pEntry;` |
|       - |  173 | `	/* Perform a hash lookup */` |
|  208839 |  174 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  208839 |  175 | `	if( pEntry == 0 ){` |
|       - |  176 | `		/* No such entry */` |
|  208613 |  177 | `		return 0;` |
|       - |  178 | `	}` |
...
|       - |  185 | ` */` |
|  350956 |  186 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  187 | `{` |
|  350961 |  188 | `	SyString *pName = &pAttr->sName;` |
|       - |  189 | `	sxi32 rc;` |
...
|  350961 |  193 | `	if( pAttr->pDeclClass == 0 ){` |
|  350961 |  194 | `		pAttr->pDeclClass = pClass;` |
|  175478 |  195 | `	}` |
|  350961 |  196 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  350961 |  197 | `	return rc;` |
|       5 |  198 | `}` |
|       - |  199 | `/*` |
...
|       - |  202 | ` */` |
| 1374390 |  203 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  204 | `{` |
| 1374395 |  205 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  206 | `	sxi32 rc;` |
| 1374395 |  207 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 1374395 |  208 | `	return rc;` |
|       5 |  209 | `}` |
|       - |  210 | `/*` |
...
|       - |  232 | ` */` |
|   30908 |  233 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
...
|       - |  239 | `	}` |
|   30911 |  240 | `	if( nType == 0 ){` |
|   30837 |  241 | `		return OVT_NONE; /* no declared type */` |
|       - |  242 | `	}` |
...
|       - |  285 | `	int bNullable;` |
|       - |  286 | `};` |
|   30872 |  287 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  288 | `{` |
|       - |  289 | `	OvType t;` |
|   30877 |  290 | `	t.nType = pF->nReturnType;` |
|   30877 |  291 | `	t.pClass = &pF->sReturnClass;` |
|   30877 |  292 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|   30877 |  293 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|   30877 |  294 | `	return t;` |
|       5 |  295 | `}` |
...
|       - |  310 | ` */` |
|   15454 |  311 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  312 | `{` |
|       - |  313 | `	ph7_class *pParentCls, *pChildCls;` |
|   15459 |  314 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|   15459 |  315 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|   15459 |  316 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|   15443 |  324 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|   15423 |  325 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|   15423 |  326 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|   15423 |  327 | `		return 0;` |
|       - |  328 | `	}` |
...
|       - |  354 | ` */` |
|   30826 |  355 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  356 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  357 | `{` |
|   30831 |  358 | `	ph7_vm *pVm = pGen->pVm;` |
|   30831 |  359 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|   30831 |  360 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|   30831 |  361 | `	SyString *pMName = &pCF->sName;` |
|       - |  362 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  363 | `	sxu32 nPArg, nCArg, k;` |
|   30831 |  364 | `	int bBad = 0;` |
|   30826 |  365 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   23117 |  366 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   15395 |  367 | `		return SXRET_OK;` |
|       - |  368 | `	}` |
|       - |  369 | `	/* Return type — covariant. */` |
|   15441 |  370 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  371 | `	/* Each overlapping parameter — contravariant. */` |
|   15441 |  372 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|   15441 |  373 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|   15441 |  374 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|   15441 |  375 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|   15459 |  376 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
...
|   15441 |  383 | `	if( !bBad ){` |
|   15437 |  384 | `		int bVariadic = 0;` |
|   15453 |  385 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   15455 |  386 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   15437 |  387 | `		if( !bVariadic ){` |
|   15437 |  388 | `			if( nCArg < nPArg ){` |
|     ! 0 |  389 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  390 | `			}else{` |
|   15439 |  391 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  446 | ` * error message.` |
|       - |  447 | ` */` |
|  123276 |  448 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  449 | `{` |
...
|  123281 |  456 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  123281 |  457 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  458 | `		return rc;` |
|       - |  459 | `	}` |
...
|  123281 |  462 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  123281 |  477 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|  800611 |  478 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  479 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
|  677335 |  480 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  677335 |  481 | `		pName = &pAttr->sName;` |
|  677335 |  482 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
|  677329 |  507 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
|  677325 |  508 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  677325 |  509 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  510 | `				return rc;` |
|       - |  511 | `			}` |
|  338660 |  512 | `		}` |
|       5 |  513 | `	}` |
|  123281 |  514 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 1854731 |  515 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  516 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 1731455 |  517 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 1731455 |  518 | `		pName = &pMeth->sFunc.sName;` |
| 1731455 |  519 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   30835 |  520 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|   46244 |  530 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|   30826 |  531 | `					(ph7_class_method *)pEntry->pUserData);` |
|   30831 |  532 | `				if( rc == SXERR_ABORT ){` |
...
| 1700625 |  539 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 1700621 |  540 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 1700621 |  541 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  542 | `				return rc;` |
|       - |  543 | `			}` |
|  850308 |  544 | `		}` |
|       5 |  545 | `	}` |
|       - |  546 | `	/* Mark as subclass */` |
|  123281 |  547 | `	pSub->pBase = pBase;` |
|       - |  548 | `	/* All done */` |
|  123281 |  549 | `	return SXRET_OK;` |
|   61643 |  550 | `}` |
|       - |  551 | `/*` |
...
|       - |  672 | ` * error message.` |
|       - |  673 | ` */` |
|   15394 |  674 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  675 | `{` |
...
|   15399 |  682 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   15399 |  683 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  684 | `	/* Copy constants */` |
|   23098 |  685 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  695 | `		}` |
|       1 |  696 | `	}` |
|   15399 |  697 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  698 | `	/* Copy methods signature */` |
|   30830 |  699 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  700 | `		/* Make sure the method are not redeclared in the subclass */` |
|    7739 |  701 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|    7739 |  702 | `		pName = &pMeth->sFunc.sName;` |
|    7739 |  703 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  704 | `			/* Install the method */` |
|    7739 |  705 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|    7739 |  706 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  707 | `				return rc;` |
|       - |  708 | `			}` |
|    3867 |  709 | `		}` |
|       5 |  710 | `	}` |
|       - |  711 | `	/* Mark as subclass */` |
|   15399 |  712 | `	pSub->pBase = pBase;` |
|       - |  713 | `	/* All done */` |
|   15399 |  714 | `	return SXRET_OK;` |
|    7702 |  715 | `}` |
|       - |  716 | `/*` |
...
|       - |  727 | ` * error message.` |
|       - |  728 | ` */` |
|  211808 |  729 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  730 | `{` |
...
|  211813 |  736 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  317723 |  737 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
...
|  211813 |  751 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  760 | `		SyString *pMName;` |
|  211813 |  761 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
|  598977 |  762 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  281265 |  763 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  281265 |  764 | `			pMName = &pMeth->sFunc.sName;` |
|  281265 |  765 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  853 | ` */` |
|    5716 |  854 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  855 | `{` |
|       - |  856 | `	ph7_class_instance *pThis;` |
|       - |  857 | `	/* Allocate a new instance */` |
|    5721 |  858 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    5721 |  859 | `	if( pThis == 0 ){` |
|     ! 0 |  860 | `		return 0;` |
|       - |  861 | `	}` |
|       - |  862 | `	/* Zero the structure */` |
|    5721 |  863 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  864 | `	/* Initialize fields */` |
|    5721 |  865 | `	pThis->iRef = 1;` |
|    5721 |  866 | `	pThis->pVm = pVm;` |
|    5721 |  867 | `	pThis->pClass = pClass;` |
|       - |  868 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    5721 |  869 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    5721 |  870 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    5721 |  871 | `	return pThis;` |
|    2863 |  872 | `}` |
|       - |  873 | `/*` |
|       - |  874 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  875 | ` * See the block comment above for more information.` |
|       - |  876 | ` */` |
|    5608 |  877 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  878 | `{` |
|       - |  879 | `	ph7_class_instance *pNew;` |
|       - |  880 | `	sxi32 rc;` |
|    5613 |  881 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    5613 |  882 | `	if( pNew == 0 ){` |
|     ! 0 |  883 | `		return 0;` |
|       - |  884 | `	}` |
|       - |  885 | `	/* Associate a private VM frame with this class instance */` |
|    5613 |  886 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    5613 |  887 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  888 | `		SyMemBackendPoolFree(&pVm->sAllocator,pNew);` |
|     ! 0 |  889 | `		return 0;` |
|       - |  890 | `	}` |
|    5613 |  891 | `	return pNew;` |
|    2809 |  892 | `}` |
|       - |  893 | `/*` |
|       - |  894 | ` * Extract the value of a class instance [i.e: Object in the PHP jargon] attribute.` |
|       - |  895 | ` * This function never fail.` |
|       - |  896 | ` */` |
|    7832 |  897 | `static ph7_value * ExtractClassAttrValue(ph7_vm *pVm,VmClassAttr *pAttr)` |
|       5 |  898 | `{` |
|       - |  899 | `	/* Extract the value */` |
|       - |  900 | `	ph7_value *pValue;` |
|    7837 |  901 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|    7837 |  902 | `	return pValue;` |
|       5 |  903 | `}` |
|       - |  904 | `/*` |
...
|       - | 1101 | ` */` |
|   16102 | 1102 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1103 | `{` |
|   16107 | 1104 | `	if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   14389 | 1107 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     244 | 1108 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     120 | 1109 | `		}` |
|   14389 | 1110 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|    7192 | 1111 | `	}` |
...
|   16107 | 1114 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     111 | 1115 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      55 | 1116 | `	}` |
|   16107 | 1117 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   16107 | 1118 | `}` |
|       - | 1119 | `/*` |
...
|       - | 1122 | ` * class instance.` |
|       - | 1123 | ` */` |
|    3886 | 1124 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1125 | `{` |
|       - | 1126 | `	ph7_class_method *pDestr;` |
|       - | 1127 | `	SyHashEntry *pEntry;` |
|       - | 1128 | `	ph7_class *pClass;` |
|       - | 1129 | `	ph7_vm *pVm;` |
|    3891 | 1130 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1131 | `		/*` |
...
|    3891 | 1138 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1139 | `	/* Invoke any defined destructor if available */` |
|    3891 | 1140 | `	pVm = pThis->pVm;` |
|    3891 | 1141 | `	pClass = pThis->pClass;` |
|    3891 | 1142 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    3891 | 1143 | `	if( pDestr && !pVm->bInReset ){` |
...
|    3891 | 1151 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   19963 | 1152 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   16077 | 1153 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1154 | `	}` |
|       - | 1155 | `	/* Release the whole structure */` |
|    3891 | 1156 | `	SyHashRelease(&pThis->hAttr);` |
|    3891 | 1157 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    1948 | 1158 | `}` |
|       - | 1159 | `/*` |
...
|       - | 1162 | ` */` |
|   82346 | 1163 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1164 | `{` |
|   82351 | 1165 | `	pThis->iRef--;` |
|   82351 | 1166 | `	if( pThis->iRef < 1 ){` |
|       - | 1167 | `		/* No more reference to this instance */` |
|    3891 | 1168 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    1943 | 1169 | `	}` |
|   82351 | 1170 | `}` |
|       - | 1171 | `/*` |
...
|       - | 1649 | ` */` |
|    6822 | 1650 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceFetchAttr(ph7_class_instance *pThis,const SyString *pName)` |
|       5 | 1651 | `{` |
|       - | 1652 | `	SyHashEntry *pEntry;` |
|       - | 1653 | `	VmClassAttr *pAttr;` |
|       - | 1654 | `	/* Query the attribute hashtable */` |
|    6827 | 1655 | `	pEntry = SyHashGet(&pThis->hAttr,(const void *)pName->zString,pName->nByte);` |
|    6827 | 1656 | `	if( pEntry == 0 ){` |
|       - | 1657 | `		/* No such attribute */` |
|     ! 0 | 1658 | `		return 0;` |
|       - | 1659 | `	}` |
|       - | 1660 | `	/* Point to the class atrribute */` |
|    6827 | 1661 | `	pAttr = (VmClassAttr *)pEntry->pUserData;` |
|       - | 1662 | `	/* Check if we are dealing with a static/constant attribute */` |
|    6827 | 1663 | `	if( pAttr->pAttr->iFlags & (PH7_CLASS_ATTR_CONSTANT\|PH7_CLASS_ATTR_STATIC) ){` |
|       - | 1664 | `		/* Access is forbidden */` |
|     ! 0 | 1665 | `		return 0;` |
|       - | 1666 | `	}` |
|       - | 1667 | `	/* Return the attribute value */` |
|    6827 | 1668 | `	return ExtractClassAttrValue(pThis->pVm,pAttr);` |
|    3416 | 1669 | `}` |
|       - | 1670 |  |
