...
|       - |   13 | ` */` |
|  444800 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  444805 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  444805 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  444805 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  444805 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  444805 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  444805 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  444805 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  444805 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  444805 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  444805 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  444805 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  444805 |   38 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  444805 |   39 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  444805 |   40 | `	pClass->nLine = nLine;` |
|  444805 |   41 | `	if( pVm->bCompilingBuiltin ){` |
...
|  442853 |   44 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  221429 |   45 | `	}else{` |
...
|       - |   51 | `	}` |
|       - |   52 | `	/* All done */` |
|  444805 |   53 | `	return pClass;` |
|  222405 |   54 | `}` |
|       - |   55 | `/*` |
|       - |   56 | ` * Allocate and initialize a new class attribute.` |
|       - |   57 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   58 | ` */` |
|  788130 |   59 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   60 | `{` |
|       - |   61 | `	ph7_class_attr *pAttr;` |
|       - |   62 | `	char *zName;` |
|  788135 |   63 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  788135 |   64 | `	if( pAttr == 0 ){` |
|     ! 0 |   65 | `		return 0;` |
|       - |   66 | `	}` |
|       - |   67 | `	/* Zero the structure */` |
|  788135 |   68 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  788135 |   69 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   70 | `	/* Duplicate attribute name */` |
|  788135 |   71 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  788135 |   72 | `	if( zName == 0 ){` |
|     ! 0 |   73 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   74 | `		return 0;` |
|       - |   75 | `	}` |
|       - |   76 | `	/* Initialize fields */` |
|  788135 |   77 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  788135 |   78 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  788135 |   79 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  788135 |   80 | `	pAttr->iProtection = iProtection;` |
|  788135 |   81 | `	pAttr->nIdx = SXU32_HIGH;` |
|  788135 |   82 | `	pAttr->iFlags = iFlags;` |
|  788135 |   83 | `	pAttr->nLine = nLine;` |
|  788135 |   84 | `	return pAttr;` |
|  394070 |   85 | `}` |
|       - |   86 | `/*` |
...
|       - |   91 | ` */` |
| 2469050 |   92 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2469055 |  102 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2469055 |  103 | `	if( pMeth == 0 ){` |
|     ! 0 |  104 | `		return 0;` |
|       - |  105 | `	}` |
|       - |  106 | `	/* Zero the structure */` |
| 2469055 |  107 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  108 | `	/* Check for an already installed method with the same name */` |
| 2469055 |  109 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2469055 |  110 | `	if( pEntry == 0 ){` |
|       - |  111 | `		/* Associate an unique VM name to this method */` |
| 2469053 |  112 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2469053 |  113 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2469053 |  114 | `		if( zName == 0 ){` |
|     ! 0 |  115 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  116 | `			return 0;` |
|       - |  117 | `		}` |
| 2469053 |  118 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  119 | `		/* Generate a random string */` |
| 2469053 |  120 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2469053 |  121 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2469053 |  122 | `		pNamePtr->zString = zName;` |
| 1234529 |  123 | `	}else{` |
...
|       - |  130 | `	}` |
| 2469055 |  131 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  150310 |  132 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  150315 |  133 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2469055 |  144 | `	pMeth->iProtection = iProtection;` |
| 2469055 |  145 | `	pMeth->iFlags = iFlags;` |
| 2469055 |  146 | `	pMeth->nLine = nLine;` |
| 3703580 |  147 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2469050 |  148 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2469055 |  149 | `	return pMeth;` |
| 1234530 |  150 | `}` |
|       - |  151 | `/*` |
...
|       - |  154 | ` */` |
|  744216 |  155 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  156 | `{` |
|       - |  157 | `	SyHashEntry *pEntry;` |
|       - |  158 | `	/* Perform a hash lookup */` |
|  744221 |  159 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  744221 |  160 | `	if( pEntry == 0 ){` |
|       - |  161 | `		/* No such entry */` |
|    8673 |  162 | `		return 0;` |
|       - |  163 | `	}` |
|       - |  164 | `	/* Point to the desired method */` |
|  735553 |  165 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  372113 |  166 | `}` |
|       - |  167 | `/*` |
...
|       - |  170 | ` */` |
|  472916 |  171 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  172 | `{` |
|       - |  173 | `	SyHashEntry *pEntry;` |
|       - |  174 | `	/* Perform a hash lookup */` |
|  472921 |  175 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  472921 |  176 | `	if( pEntry == 0 ){` |
|       - |  177 | `		/* No such entry */` |
|  471659 |  178 | `		return 0;` |
|       - |  179 | `	}` |
...
|       - |  186 | ` */` |
|  788126 |  187 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  188 | `{` |
|  788131 |  189 | `	SyString *pName = &pAttr->sName;` |
|       - |  190 | `	sxi32 rc;` |
...
|  788131 |  194 | `	if( pAttr->pDeclClass == 0 ){` |
|  788131 |  195 | `		pAttr->pDeclClass = pClass;` |
|  394063 |  196 | `	}` |
|  788131 |  197 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  788131 |  198 | `	return rc;` |
|       5 |  199 | `}` |
|       - |  200 | `/*` |
...
|       - |  203 | ` */` |
| 2469038 |  204 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  205 | `{` |
| 2469043 |  206 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  207 | `	sxi32 rc;` |
| 2469043 |  208 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2469043 |  209 | `	return rc;` |
|       5 |  210 | `}` |
|       - |  211 | `/*` |
...
|       - |  233 | ` */` |
|  158360 |  234 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  235 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  236 | `{` |
|  158365 |  237 | `	*ppClass = 0;` |
|  158365 |  238 | `	if( bUnion ){` |
|       3 |  239 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  240 | `	}` |
|  158363 |  241 | `	if( nType == 0 ){` |
|  158277 |  242 | `		return OVT_NONE; /* no declared type */` |
|       - |  243 | `	}` |
...
|       - |  286 | `	int bNullable;` |
|       - |  287 | `};` |
|  126668 |  288 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  289 | `{` |
|       - |  290 | `	OvType t;` |
|  126673 |  291 | `	t.nType = pF->nReturnType;` |
|  126673 |  292 | `	t.pClass = &pF->sReturnClass;` |
|  126673 |  293 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  126673 |  294 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  126673 |  295 | `	return t;` |
|       5 |  296 | `}` |
|   31692 |  297 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  298 | `{` |
|       - |  299 | `	OvType t;` |
|   31697 |  300 | `	t.nType = pA->nType;` |
|   31697 |  301 | `	t.pClass = &pA->sClass;` |
|   31697 |  302 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   31697 |  303 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   31697 |  304 | `	return t;` |
|       5 |  305 | `}` |
|       - |  306 | `/*` |
...
|       - |  311 | ` */` |
|   79180 |  312 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  313 | `{` |
|       - |  314 | `	ph7_class *pParentCls, *pChildCls;` |
|   79185 |  315 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|   79185 |  316 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|   79185 |  317 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|   79169 |  325 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|   79145 |  326 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|   79145 |  327 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|   79145 |  328 | `		return 0;` |
|       - |  329 | `	}` |
...
|       - |  355 | ` */` |
|   91018 |  356 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  357 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  358 | `{` |
|   91023 |  359 | `	ph7_vm *pVm = pGen->pVm;` |
|   91023 |  360 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|   91023 |  361 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|   91023 |  362 | `	SyString *pMName = &pCF->sName;` |
|       - |  363 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  364 | `	sxu32 nPArg, nCArg, k;` |
|   91023 |  365 | `	int bBad = 0;` |
|   91018 |  366 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   59360 |  367 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   27689 |  368 | `		return SXRET_OK;` |
|       - |  369 | `	}` |
|       - |  370 | `	/* Return type — covariant. */` |
|   63339 |  371 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  372 | `	/* Each overlapping parameter — contravariant. */` |
|   63339 |  373 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|   63339 |  374 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|   63339 |  375 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|   63339 |  376 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|   79185 |  377 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   15851 |  378 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|    7928 |  379 | `	}` |
...
|   63339 |  384 | `	if( !bBad ){` |
|   63335 |  385 | `		int bVariadic = 0;` |
|   79179 |  386 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   79181 |  387 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|   63335 |  388 | `		if( !bVariadic ){` |
|   63335 |  389 | `			if( nCArg < nPArg ){` |
|     ! 0 |  390 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  391 | `			}else{` |
|   63337 |  392 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  447 | ` * error message.` |
|       - |  448 | ` */` |
|  190042 |  449 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  450 | `{` |
...
|  190047 |  457 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  190047 |  458 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  459 | `		return rc;` |
|       - |  460 | `	}` |
...
|  190047 |  463 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  190047 |  478 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1107861 |  479 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  480 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
|  917819 |  481 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  917819 |  482 | `		pName = &pAttr->sName;` |
|  917819 |  483 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
|  917798 |  513 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  490545 |  514 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|  917799 |  515 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  917799 |  516 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  517 | `				return rc;` |
|       - |  518 | `			}` |
|  458897 |  519 | `		}` |
|       5 |  520 | `	}` |
|  190047 |  521 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 2721507 |  522 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  523 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 2531465 |  524 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 2531465 |  525 | `		pName = &pMeth->sFunc.sName;` |
| 2531465 |  526 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   91027 |  527 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  136532 |  537 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|   91018 |  538 | `					(ph7_class_method *)pEntry->pUserData);` |
|   91023 |  539 | `				if( rc == SXERR_ABORT ){` |
...
| 2440438 |  553 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1234070 |  554 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 2440443 |  555 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2440443 |  556 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  557 | `				return rc;` |
|       - |  558 | `			}` |
| 1220219 |  559 | `		}` |
|       5 |  560 | `	}` |
|       - |  561 | `	/* Mark as subclass */` |
|  190047 |  562 | `	pSub->pBase = pBase;` |
|       - |  563 | `	/* All done */` |
|  190047 |  564 | `	return SXRET_OK;` |
|   95026 |  565 | `}` |
|       - |  566 | `/*` |
...
|       - |  570 | ` */` |
|   15878 |  571 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  572 | `{` |
...
|   15883 |  579 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  586 | `	}` |
|   15883 |  587 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15883 |  588 | `	rc = SXRET_OK;` |
|       - |  589 | `	/* Copy attributes from the trait */` |
|   15883 |  590 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   55441 |  591 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  592 | `		SyHashEntry *pExisting;` |
|   39563 |  593 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   39563 |  594 | `		pName = &pAttr->sName;` |
|   39563 |  595 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   39563 |  596 | `		if( pExisting != 0 ){` |
...
|       6 |  625 | `			continue;` |
|       - |  626 | `		}` |
|   39559 |  627 | `		rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   39559 |  628 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  629 | `			goto cleanup;` |
|       - |  630 | `		}` |
|       5 |  631 | `	}` |
|       - |  632 | `	/* Copy methods from the trait */` |
|   15883 |  633 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  221553 |  634 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|  205675 |  635 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  205675 |  636 | `		pName = &pMeth->sFunc.sName;` |
|  205675 |  637 | `		if( SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte) != 0 ){` |
...
|      11 |  661 | `			continue;` |
|       - |  662 | `		}` |
|  205667 |  663 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  205667 |  664 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  665 | `			goto cleanup;` |
|       - |  666 | `		}` |
|       5 |  667 | `	}` |
|       - |  668 | `	/* Record trait in the class */` |
|   15883 |  669 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7939 |  670 | `cleanup:` |
|       - |  671 | `	/* Always clear visiting flag, even on error paths */` |
|   15883 |  672 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7939 |  673 | `	SXUNUSED(pGen);` |
|   15883 |  674 | `	return rc;` |
|    7944 |  675 | `}` |
|       - |  676 | `/*` |
...
|       - |  687 | ` * error message.` |
|       - |  688 | ` */` |
|   27688 |  689 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  690 | `{` |
...
|   27693 |  697 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   27693 |  698 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  699 | `	/* Copy constants */` |
|   41539 |  700 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  710 | `		}` |
|       1 |  711 | `	}` |
|   27693 |  712 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  713 | `	/* Copy methods signature */` |
|  108797 |  714 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  715 | `		/* Make sure the method are not redeclared in the subclass */` |
|   67265 |  716 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   67265 |  717 | `		pName = &pMeth->sFunc.sName;` |
|   67265 |  718 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  719 | `			/* Install the method */` |
|   67265 |  720 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   67265 |  721 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  722 | `				return rc;` |
|       - |  723 | `			}` |
|   33630 |  724 | `		}` |
|       5 |  725 | `	}` |
|       - |  726 | `	/* Mark as subclass */` |
|   27693 |  727 | `	pSub->pBase = pBase;` |
|       - |  728 | `	/* All done */` |
|   27693 |  729 | `	return SXRET_OK;` |
|   13849 |  730 | `}` |
|       - |  731 | `/*` |
...
|       - |  742 | ` * error message.` |
|       - |  743 | ` */` |
|  368054 |  744 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  745 | `{` |
...
|  368059 |  751 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  662812 |  752 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
|       - |  753 | `		/* Point to the constant declaration */` |
|  110731 |  754 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  110731 |  755 | `		pName = &pAttr->sName;` |
|       - |  756 | `		/* Make sure the attribute is not redeclared in the main class */` |
|  110731 |  757 | `		if( SyHashGet(&pMain->hAttr,pName->zString,pName->nByte) == 0 ){` |
|       - |  758 | `			/* Install the attribute */` |
|  110727 |  759 | `			rc = SyHashInsert(&pMain->hAttr,pName->zString,pName->nByte,pAttr);` |
|  110727 |  760 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  761 | `				return rc;` |
|       - |  762 | `			}` |
|   55361 |  763 | `		}` |
|       5 |  764 | `	}` |
|       - |  765 | `	/* Install in the interface container */` |
|  368059 |  766 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  775 | `		SyString *pMName;` |
|  368059 |  776 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1244616 |  777 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  692535 |  778 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  692535 |  779 | `			pMName = &pMeth->sFunc.sName;` |
|  692535 |  780 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  868 | ` */` |
|    7378 |  869 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  870 | `{` |
|       - |  871 | `	ph7_class_instance *pThis;` |
|       - |  872 | `	/* Allocate a new instance */` |
|    7383 |  873 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    7383 |  874 | `	if( pThis == 0 ){` |
|     ! 0 |  875 | `		return 0;` |
|       - |  876 | `	}` |
|       - |  877 | `	/* Zero the structure */` |
|    7383 |  878 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  879 | `	/* Initialize fields */` |
|    7383 |  880 | `	pThis->iRef = 1;` |
|    7383 |  881 | `	pThis->pVm = pVm;` |
|    7383 |  882 | `	pThis->pClass = pClass;` |
|       - |  883 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    7383 |  884 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    7383 |  885 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    7383 |  886 | `	return pThis;` |
|    3694 |  887 | `}` |
|       - |  888 | `/*` |
|       - |  889 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  890 | ` * See the block comment above for more information.` |
|       - |  891 | ` */` |
|    7146 |  892 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  893 | `{` |
|       - |  894 | `	ph7_class_instance *pNew;` |
|       - |  895 | `	sxi32 rc;` |
|    7151 |  896 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    7151 |  897 | `	if( pNew == 0 ){` |
|     ! 0 |  898 | `		return 0;` |
|       - |  899 | `	}` |
|       - |  900 | `	/* Associate a private VM frame with this class instance */` |
|    7151 |  901 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    7151 |  902 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  903 | `		SyMemBackendPoolFree(&pVm->sAllocator,pNew);` |
|     ! 0 |  904 | `		return 0;` |
|       - |  905 | `	}` |
|    7151 |  906 | `	return pNew;` |
|    3578 |  907 | `}` |
|       - |  908 | `/*` |
...
|       - | 1116 | ` */` |
|   25036 | 1117 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1118 | `{` |
|   25041 | 1119 | `	if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   18771 | 1122 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     282 | 1123 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     139 | 1124 | `		}` |
|   18771 | 1125 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|    9383 | 1126 | `	}` |
...
|   25041 | 1129 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     115 | 1130 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      57 | 1131 | `	}` |
|   25041 | 1132 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   25041 | 1133 | `}` |
|       - | 1134 | `/*` |
...
|       - | 1137 | ` * class instance.` |
|       - | 1138 | ` */` |
|    5134 | 1139 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1140 | `{` |
|       - | 1141 | `	ph7_class_method *pDestr;` |
|       - | 1142 | `	SyHashEntry *pEntry;` |
|       - | 1143 | `	ph7_class *pClass;` |
|       - | 1144 | `	ph7_vm *pVm;` |
|    5139 | 1145 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1146 | `		/*` |
...
|    5139 | 1153 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1154 | `	/* Invoke any defined destructor if available */` |
|    5139 | 1155 | `	pVm = pThis->pVm;` |
|    5139 | 1156 | `	pClass = pThis->pClass;` |
|    5139 | 1157 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5139 | 1158 | `	if( pDestr && !pVm->bInReset ){` |
...
|    5139 | 1168 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5139 | 1177 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   30145 | 1178 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   25011 | 1179 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1180 | `	}` |
|       - | 1181 | `	/* Release the whole structure */` |
|    5139 | 1182 | `	SyHashRelease(&pThis->hAttr);` |
|    5139 | 1183 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2572 | 1184 | `}` |
|       - | 1185 | `/*` |
...
|       - | 1188 | ` */` |
|  133184 | 1189 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1190 | `{` |
|  133189 | 1191 | `	pThis->iRef--;` |
|  133189 | 1192 | `	if( pThis->iRef < 1 ){` |
|       - | 1193 | `		/* No more reference to this instance */` |
|    5139 | 1194 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2567 | 1195 | `	}` |
|  133189 | 1196 | `}` |
|       - | 1197 | `/*` |
