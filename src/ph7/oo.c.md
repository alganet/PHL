...
|       - |   13 | ` */` |
|  527736 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  527741 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  527741 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  527741 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  527741 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  527741 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  527741 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
...
|  527741 |   37 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,SyStrHash,SyStrnmicmp);` |
|  527741 |   38 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  527741 |   39 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  527741 |   40 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  527741 |   41 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  527741 |   42 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  527741 |   43 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  527741 |   44 | `	pClass->nLine = nLine;` |
|  527741 |   45 | `	if( pVm->bCompilingBuiltin ){` |
...
|  525509 |   48 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  262757 |   49 | `	}else{` |
|       - |   50 | `		/* Alias the VM-lifetime path dup on top of the include stack */` |
|    2237 |   51 | `		SyString *pFile = (SyString *)SySetPeek(&pVm->aFiles);` |
|    2237 |   52 | `		if( pFile ){` |
|    2237 |   53 | `			SyStringDupPtr(&pClass->sFile,pFile);` |
|    1116 |   54 | `		}` |
|       - |   55 | `	}` |
|       - |   56 | `	/* All done */` |
|  527741 |   57 | `	return pClass;` |
|  263873 |   58 | `}` |
|       - |   59 | `/*` |
|       - |   60 | ` * Allocate and initialize a new class attribute.` |
|       - |   61 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   62 | ` */` |
|  944294 |   63 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   64 | `{` |
|       - |   65 | `	ph7_class_attr *pAttr;` |
|       - |   66 | `	char *zName;` |
|  944299 |   67 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  944299 |   68 | `	if( pAttr == 0 ){` |
|     ! 0 |   69 | `		return 0;` |
|       - |   70 | `	}` |
|       - |   71 | `	/* Zero the structure */` |
|  944299 |   72 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  944299 |   73 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   74 | `	/* Duplicate attribute name */` |
|  944299 |   75 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  944299 |   76 | `	if( zName == 0 ){` |
|     ! 0 |   77 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   78 | `		return 0;` |
|       - |   79 | `	}` |
|       - |   80 | `	/* Initialize fields */` |
|  944299 |   81 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  944299 |   82 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  944299 |   83 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  944299 |   84 | `	pAttr->iProtection = iProtection;` |
|  944299 |   85 | `	pAttr->nIdx = SXU32_HIGH;` |
|  944299 |   86 | `	pAttr->iFlags = iFlags;` |
|  944299 |   87 | `	pAttr->nLine = nLine;` |
|  944299 |   88 | `	return pAttr;` |
|  472152 |   89 | `}` |
|       - |   90 | `/*` |
...
|       - |   95 | ` */` |
| 2884580 |   96 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2884585 |  106 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2884585 |  107 | `	if( pMeth == 0 ){` |
|     ! 0 |  108 | `		return 0;` |
|       - |  109 | `	}` |
|       - |  110 | `	/* Zero the structure */` |
| 2884585 |  111 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  112 | `	/* Check for an already installed method with the same name */` |
| 2884585 |  113 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2884585 |  114 | `	if( pEntry == 0 ){` |
|       - |  115 | `		/* Associate an unique VM name to this method */` |
| 2884581 |  116 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2884581 |  117 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2884581 |  118 | `		if( zName == 0 ){` |
|     ! 0 |  119 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  120 | `			return 0;` |
|       - |  121 | `		}` |
| 2884581 |  122 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  123 | `		/* Generate a random string */` |
| 2884581 |  124 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2884581 |  125 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2884581 |  126 | `		pNamePtr->zString = zName;` |
| 1442293 |  127 | `	}else{` |
...
|       - |  134 | `	}` |
| 2884585 |  135 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  166230 |  136 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  166235 |  137 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2884585 |  148 | `	pMeth->iProtection = iProtection;` |
| 2884585 |  149 | `	pMeth->iFlags = iFlags;` |
| 2884585 |  150 | `	pMeth->nLine = nLine;` |
| 4326875 |  151 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2884580 |  152 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2884585 |  153 | `	return pMeth;` |
| 1442295 |  154 | `}` |
|       - |  155 | `/*` |
...
|       - |  158 | ` */` |
| 3791350 |  159 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  160 | `{` |
|       - |  161 | `	SyHashEntry *pEntry;` |
|       - |  162 | `	/* Perform a hash lookup */` |
| 3791355 |  163 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
| 3791355 |  164 | `	if( pEntry == 0 ){` |
|       - |  165 | `		/* No such entry */` |
| 2915355 |  166 | `		return 0;` |
|       - |  167 | `	}` |
|       - |  168 | `	/* Point to the desired method */` |
|  876005 |  169 | `	return (ph7_class_method *)pEntry->pUserData;` |
| 1895680 |  170 | `}` |
|       - |  171 | `/*` |
...
|       - |  174 | ` */` |
| 2787624 |  175 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  176 | `{` |
|       - |  177 | `	SyHashEntry *pEntry;` |
|       - |  178 | `	/* Perform a hash lookup */` |
| 2787629 |  179 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
| 2787629 |  180 | `	if( pEntry == 0 ){` |
|       - |  181 | `		/* No such entry */` |
| 2786155 |  182 | `		return 0;` |
|       - |  183 | `	}` |
...
|       - |  190 | ` */` |
|  944290 |  191 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  192 | `{` |
|  944295 |  193 | `	SyString *pName = &pAttr->sName;` |
|       - |  194 | `	sxi32 rc;` |
...
|  944295 |  198 | `	if( pAttr->pDeclClass == 0 ){` |
|  944295 |  199 | `		pAttr->pDeclClass = pClass;` |
|  472145 |  200 | `	}` |
|  944295 |  201 | `	rc = SyHashInsertTail(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  944295 |  202 | `	return rc;` |
|       5 |  203 | `}` |
|       - |  204 | `/*` |
...
|       - |  207 | ` */` |
| 2884562 |  208 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  209 | `{` |
| 2884567 |  210 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  211 | `	sxi32 rc;` |
| 2884567 |  212 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2884567 |  213 | `	return rc;` |
|       5 |  214 | `}` |
|       - |  215 | `/*` |
...
|       - |  237 | ` */` |
|  278444 |  238 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  239 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  240 | `{` |
|  278449 |  241 | `	*ppClass = 0;` |
|  278449 |  242 | `	if( bUnion ){` |
|       3 |  243 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  244 | `	}` |
|  278447 |  245 | `	if( nType == 0 ){` |
|  278343 |  246 | `		return OVT_NONE; /* no declared type */` |
|       - |  247 | `	}` |
...
|       - |  290 | `	int bNullable;` |
|       - |  291 | `};` |
|  208828 |  292 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  293 | `{` |
|       - |  294 | `	OvType t;` |
|  208833 |  295 | `	t.nType = pF->nReturnType;` |
|  208833 |  296 | `	t.pClass = &pF->sReturnClass;` |
|  208833 |  297 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  208833 |  298 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  208833 |  299 | `	return t;` |
|       5 |  300 | `}` |
|   69616 |  301 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  302 | `{` |
|       - |  303 | `	OvType t;` |
|   69621 |  304 | `	t.nType = pA->nType;` |
|   69621 |  305 | `	t.pClass = &pA->sClass;` |
|   69621 |  306 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   69621 |  307 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   69621 |  308 | `	return t;` |
|       5 |  309 | `}` |
|       - |  310 | `/*` |
...
|       - |  315 | ` */` |
|  139222 |  316 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  317 | `{` |
|       - |  318 | `	ph7_class *pParentCls, *pChildCls;` |
|  139227 |  319 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|  139227 |  320 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|  139227 |  321 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|  139209 |  329 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|  139179 |  330 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|  139179 |  331 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|  139179 |  332 | `		return 0;` |
|       - |  333 | `	}` |
...
|       - |  359 | ` */` |
|  146926 |  360 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  361 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  362 | `{` |
|  146931 |  363 | `	ph7_vm *pVm = pGen->pVm;` |
|  146931 |  364 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|  146931 |  365 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|  146931 |  366 | `	SyString *pMName = &pCF->sName;` |
|       - |  367 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  368 | `	sxu32 nPArg, nCArg, k;` |
|  146931 |  369 | `	int bBad = 0;` |
|  146926 |  370 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   96660 |  371 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   42517 |  372 | `		return SXRET_OK;` |
|       - |  373 | `	}` |
|       - |  374 | `	/* Return type — covariant. */` |
|  104419 |  375 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  376 | `	/* Each overlapping parameter — contravariant. */` |
|  104419 |  377 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|  104419 |  378 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|  104419 |  379 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|  104419 |  380 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|  139227 |  381 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   34813 |  382 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|   17409 |  383 | `	}` |
...
|  104419 |  388 | `	if( !bBad ){` |
|  104415 |  389 | `		int bVariadic = 0;` |
|  139221 |  390 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  139223 |  391 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  104415 |  392 | `		if( !bVariadic ){` |
|  104415 |  393 | `			if( nCArg < nPArg ){` |
|     ! 0 |  394 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  395 | `			}else{` |
|  104417 |  396 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  451 | ` * error message.` |
|       - |  452 | ` */` |
|  247606 |  453 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  454 | `{` |
...
|       - |  460 | `	sxi32 rc;` |
|  247611 |  461 | `	SySetInit(&aInherited,&pGen->pVm->sAllocator,sizeof(ph7_class_attr *));` |
|       - |  462 | `	/* Install in the derived hashtable */` |
|  247611 |  463 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  247611 |  464 | `	if( rc != SXRET_OK ){` |
...
|  247611 |  470 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  247611 |  486 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1415103 |  487 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  488 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 1167497 |  489 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 1167497 |  490 | `		pName = &pAttr->sName;` |
| 1167497 |  491 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 1167472 |  539 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  744176 |  540 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
| 1167471 |  541 | `			rc = SySetPut(&aInherited,(const void *)&pAttr);` |
| 1167471 |  542 | `			if( rc != SXRET_OK ){` |
...
|  247611 |  554 | `	if( SySetUsed(&aInherited) > 0 ){` |
|  247473 |  555 | `		ph7_class_attr **apInherited = (ph7_class_attr **)SySetBasePtr(&aInherited);` |
|  247473 |  556 | `		sxu32 n = SySetUsed(&aInherited);` |
| 1414957 |  557 | `		while( n > 0 ){` |
| 1167489 |  558 | `			ph7_class_attr *pIn = apInherited[--n];` |
| 1167489 |  559 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pIn->sName.zString,pIn->sName.nByte,pIn);` |
| 1167489 |  560 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  561 | `				SySetRelease(&aInherited);` |
|     ! 0 |  562 | `				return rc;` |
|       - |  563 | `			}` |
|       5 |  564 | `		}` |
|  123734 |  565 | `	}` |
|  247611 |  566 | `	SySetRelease(&aInherited);` |
|  247611 |  567 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 3606447 |  568 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  569 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 3358841 |  570 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 3358841 |  571 | `		pName = &pMeth->sFunc.sName;` |
| 3358841 |  572 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  146935 |  573 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  220394 |  584 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|  146926 |  585 | `					(ph7_class_method *)pEntry->pUserData);` |
|  146931 |  586 | `				if( rc == SXERR_ABORT ){` |
...
| 3211906 |  600 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1621423 |  601 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 3211911 |  602 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 3211911 |  603 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  604 | `				return rc;` |
|       - |  605 | `			}` |
| 1605953 |  606 | `		}` |
|       5 |  607 | `	}` |
|       - |  608 | `	/* Mark as subclass */` |
|  247611 |  609 | `	pSub->pBase = pBase;` |
|       - |  610 | `	/* All done */` |
|  247611 |  611 | `	return SXRET_OK;` |
|  123808 |  612 | `}` |
|       - |  613 | `/*` |
...
|       - |  617 | ` */` |
|   15544 |  618 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  619 | `{` |
...
|   15549 |  626 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  633 | `	}` |
|   15549 |  634 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15549 |  635 | `	rc = SXRET_OK;` |
|       - |  636 | `	/* Copy attributes from the trait */` |
|   15549 |  637 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   61943 |  638 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  639 | `		SyHashEntry *pExisting;` |
|   46399 |  640 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   46399 |  641 | `		pName = &pAttr->sName;` |
|   46399 |  642 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   46399 |  643 | `		if( pExisting != 0 ){` |
...
|       6 |  672 | `			continue;` |
|       - |  673 | `		}` |
|   46395 |  674 | `		rc = SyHashInsertTail(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   46395 |  675 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  676 | `			goto cleanup;` |
|       - |  677 | `		}` |
|       5 |  678 | `	}` |
|       - |  679 | `	/* Copy methods from the trait */` |
|   15549 |  680 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  224299 |  681 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|       - |  682 | `		SyHashEntry *pClassMethEntry;` |
|  208755 |  683 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  208755 |  684 | `		pName = &pMeth->sFunc.sName;` |
|  208755 |  685 | `		pClassMethEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  208755 |  686 | `		if( pClassMethEntry != 0 ){` |
...
|       8 |  728 | `			continue;` |
|       - |  729 | `		}` |
|  208741 |  730 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  208741 |  731 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  732 | `			goto cleanup;` |
|       - |  733 | `		}` |
|       5 |  734 | `	}` |
|       - |  735 | `	/* Record trait in the class */` |
|   15549 |  736 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7772 |  737 | `cleanup:` |
|       - |  738 | `	/* Always clear visiting flag, even on error paths */` |
|   15549 |  739 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7772 |  740 | `	SXUNUSED(pGen);` |
|   15549 |  741 | `	return rc;` |
|    7777 |  742 | `}` |
|       - |  743 | `/*` |
...
|       - |  754 | ` * error message.` |
|       - |  755 | ` */` |
|   27060 |  756 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|       5 |  757 | `{` |
...
|   27065 |  764 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|   27065 |  765 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|       - |  766 | `	/* Copy constants */` |
|   40597 |  767 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|       1 |  777 | `		}` |
|       1 |  778 | `	}` |
|   27065 |  779 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|       - |  780 | `	/* Copy methods signature */` |
|  106327 |  781 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  782 | `		/* Make sure the method are not redeclared in the subclass */` |
|   65737 |  783 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   65737 |  784 | `		pName = &pMeth->sFunc.sName;` |
|   65737 |  785 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|       - |  786 | `			/* Install the method */` |
|   65737 |  787 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   65737 |  788 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  789 | `				return rc;` |
|       - |  790 | `			}` |
|   32866 |  791 | `		}` |
|       5 |  792 | `	}` |
|       - |  793 | `	/* Mark as subclass */` |
|   27065 |  794 | `	pSub->pBase = pBase;` |
|       - |  795 | `	/* All done */` |
|   27065 |  796 | `	return SXRET_OK;` |
|   13535 |  797 | `}` |
|       - |  798 | `/*` |
...
|       - |  809 | ` * error message.` |
|       - |  810 | ` */` |
|  421534 |  811 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  812 | `{` |
...
|  421539 |  818 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  740512 |  819 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
|       - |  820 | `		/* Point to the constant declaration */` |
|  108211 |  821 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|  108211 |  822 | `		pName = &pAttr->sName;` |
|       - |  823 | `		/* Make sure the attribute is not redeclared in the main class */` |
|  108211 |  824 | `		if( SyHashGet(&pMain->hAttr,pName->zString,pName->nByte) == 0 ){` |
|       - |  825 | `			/* Install the attribute */` |
|  108207 |  826 | `			rc = SyHashInsertTail(&pMain->hAttr,pName->zString,pName->nByte,pAttr);` |
|  108207 |  827 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  828 | `				return rc;` |
|       - |  829 | `			}` |
|   54101 |  830 | `		}` |
|       5 |  831 | `	}` |
|       - |  832 | `	/* Install in the interface container */` |
|  421539 |  833 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  842 | `		SyString *pMName;` |
|  421539 |  843 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1452084 |  844 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  819783 |  845 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  819783 |  846 | `			pMName = &pMeth->sFunc.sName;` |
|  819783 |  847 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  935 | ` */` |
|    8846 |  936 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  937 | `{` |
|       - |  938 | `	ph7_class_instance *pThis;` |
|       - |  939 | `	/* Allocate a new instance */` |
|    8851 |  940 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    8851 |  941 | `	if( pThis == 0 ){` |
|     ! 0 |  942 | `		return 0;` |
|       - |  943 | `	}` |
|       - |  944 | `	/* Zero the structure */` |
|    8851 |  945 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  946 | `	/* Initialize fields */` |
|    8851 |  947 | `	pThis->iRef = 1;` |
|    8851 |  948 | `	pThis->pVm = pVm;` |
|    8851 |  949 | `	pThis->pClass = pClass;` |
|       - |  950 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    8851 |  951 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    8851 |  952 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    8851 |  953 | `	return pThis;` |
|    4428 |  954 | `}` |
|       - |  955 | `/*` |
|       - |  956 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  957 | ` * See the block comment above for more information.` |
|       - |  958 | ` */` |
|    8600 |  959 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  960 | `{` |
|       - |  961 | `	ph7_class_instance *pNew;` |
|       - |  962 | `	sxi32 rc;` |
|    8605 |  963 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    8605 |  964 | `	if( pNew == 0 ){` |
|     ! 0 |  965 | `		return 0;` |
|       - |  966 | `	}` |
|       - |  967 | `	/* Associate a private VM frame with this class instance */` |
|    8605 |  968 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    8605 |  969 | `	if( rc != SXRET_OK ){` |
...
|    8605 |  976 | `	PH7_VmStampThrowableSite(&(*pVm),pNew);` |
|    8605 |  977 | `	return pNew;` |
|    4305 |  978 | `}` |
|       - |  979 | `/*` |
...
|       - | 1232 | ` * class instance.` |
|       - | 1233 | ` */` |
|    5880 | 1234 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1235 | `{` |
|       - | 1236 | `	ph7_class_method *pDestr;` |
|       - | 1237 | `	SyHashEntry *pEntry;` |
|       - | 1238 | `	ph7_class *pClass;` |
|       - | 1239 | `	ph7_vm *pVm;` |
|    5885 | 1240 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1241 | `		/*` |
...
|    5885 | 1248 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1249 | `	/* Invoke any defined destructor if available */` |
|    5885 | 1250 | `	pVm = pThis->pVm;` |
|    5885 | 1251 | `	pClass = pThis->pClass;` |
|    5885 | 1252 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5885 | 1253 | `	if( pDestr && !pVm->bInReset ){` |
...
|    5885 | 1263 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5885 | 1272 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   35333 | 1273 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   29453 | 1274 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1275 | `	}` |
|       - | 1276 | `	/* Release the whole structure */` |
|    5885 | 1277 | `	SyHashRelease(&pThis->hAttr);` |
|    5885 | 1278 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2945 | 1279 | `}` |
|       - | 1280 | `/*` |
...
|       - | 1283 | ` */` |
|  148370 | 1284 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1285 | `{` |
|  148375 | 1286 | `	pThis->iRef--;` |
|  148375 | 1287 | `	if( pThis->iRef < 1 ){` |
|       - | 1288 | `		/* No more reference to this instance */` |
|    5885 | 1289 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2940 | 1290 | `	}` |
|  148375 | 1291 | `}` |
|       - | 1292 | `/*` |
