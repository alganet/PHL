...
|     - |   13 | ` */` |
| 17792 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|     2 |   15 |  |
|     - |   16 | `	ph7_class *pClass;` |
|     - |   17 | `	char *zName;` |
|     - |   18 | `	/* Allocate a new instance */` |
| 17794 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
| 17794 |   20 | `	if( pClass == 0 ){` |
|   ! 0 |   21 | `		return 0;` |
|     - |   22 | `	}` |
|     - |   23 | `	/* Zero the structure */` |
| 17794 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|     - |   25 | `	/* Duplicate class name */` |
| 17794 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 17794 |   27 | `	if( zName == 0 ){` |
|   ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|   ! 0 |   29 | `		return 0;` |
|     - |   30 | `	}` |
|     - |   31 | `	/* Initialize fields */` |
| 17794 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
| 17794 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
| 17794 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
| 17794 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
| 17794 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
| 17794 |   37 | `	pClass->nLine = nLine;` |
|     - |   38 | `	/* All done */` |
| 17794 |   39 | `	return pClass;` |
|  8898 |   40 |  |
|     - |   41 | `/*` |
|     - |   42 | ` * Allocate and initialize a new class attribute.` |
|     - |   43 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|     - |   44 | ` */` |
| 16122 |   45 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|     2 |   46 |  |
|     - |   47 | `	ph7_class_attr *pAttr;` |
|     - |   48 | `	char *zName;` |
| 16124 |   49 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
| 16124 |   50 | `	if( pAttr == 0 ){` |
|   ! 0 |   51 | `		return 0;` |
|     - |   52 | `	}` |
|     - |   53 | `	/* Zero the structure */` |
| 16124 |   54 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|     - |   55 | `	/* Duplicate attribute name */` |
| 16124 |   56 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 16124 |   57 | `	if( zName == 0 ){` |
|   ! 0 |   58 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|   ! 0 |   59 | `		return 0;` |
|     - |   60 | `	}` |
|     - |   61 | `	/* Initialize fields */` |
| 16124 |   62 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
| 16124 |   63 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
| 16124 |   64 | `	pAttr->iProtection = iProtection;` |
| 16124 |   65 | `	pAttr->nIdx = SXU32_HIGH;` |
| 16124 |   66 | `	pAttr->iFlags = iFlags;` |
| 16124 |   67 | `	pAttr->nLine = nLine;` |
| 16124 |   68 | `	return pAttr;` |
|  8063 |   69 |  |
|     - |   70 | `/*` |
...
|     - |   75 | ` */` |
| 46434 |   76 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 46436 |   86 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 46436 |   87 | `	if( pMeth == 0 ){` |
|   ! 0 |   88 | `		return 0;` |
|     - |   89 | `	}` |
|     - |   90 | `	/* Zero the structure */` |
| 46436 |   91 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|     - |   92 | `	/* Check for an already installed method with the same name */` |
| 46436 |   93 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 46436 |   94 | `	if( pEntry == 0 ){` |
|     - |   95 | `		/* Associate an unique VM name to this method */` |
| 46434 |   96 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 46434 |   97 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 46434 |   98 | `		if( zName == 0 ){` |
|   ! 0 |   99 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|   ! 0 |  100 | `			return 0;` |
|     - |  101 | `		}` |
| 46434 |  102 | `		pNamePtr = &pMeth->sVmName;` |
|     - |  103 | `		/* Generate a random string */` |
| 46434 |  104 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 46434 |  105 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 46434 |  106 | `		pNamePtr->zString = zName;` |
| 23218 |  107 | `	}else{` |
...
|     - |  114 | `	}` |
| 46436 |  115 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
| 46438 |  124 | `	pMeth->iProtection = iProtection;` |
| 46438 |  125 | `	pMeth->iFlags = iFlags;` |
| 46438 |  126 | `	pMeth->nLine = nLine;` |
| 69657 |  127 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 46436 |  128 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 46438 |  129 | `	return pMeth;` |
| 23221 |  130 |  |
|     - |  131 | `/*` |
...
|     - |  134 | ` */` |
|  2876 |  135 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|     2 |  136 |  |
|     - |  137 | `	SyHashEntry *pEntry;` |
|     - |  138 | `	/* Perform a hash lookup */` |
|  2878 |  139 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  2878 |  140 | `	if( pEntry == 0 ){` |
|     - |  141 | `		/* No such entry */` |
|  1384 |  142 | `		return 0;` |
|     - |  143 | `	}` |
|     - |  144 | `	/* Point to the desired method */` |
|  1496 |  145 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  1440 |  146 |  |
|     - |  147 | `/*` |
...
|     - |  166 | ` */` |
| 16122 |  167 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|     2 |  168 |  |
| 16124 |  169 | `	SyString *pName = &pAttr->sName;` |
|     - |  170 | `	sxi32 rc;` |
| 16124 |  171 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 16124 |  172 | `	return rc;` |
|     2 |  173 |  |
|     - |  174 | `/*` |
...
|     - |  177 | ` */` |
| 46432 |  178 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|     2 |  179 |  |
| 46434 |  180 | `	SyString *pName = &pMeth->sFunc.sName;` |
|     - |  181 | `	sxi32 rc;` |
| 46434 |  182 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 46434 |  183 | `	return rc;` |
|     2 |  184 |  |
|     - |  185 | `/*` |
...
|     - |  224 | ` * error message.` |
|     - |  225 | ` */` |
|  8008 |  226 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|     2 |  227 |  |
...
|  8010 |  234 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  8010 |  235 | `	if( rc != SXRET_OK ){` |
|   ! 0 |  236 | `		return rc;` |
|     - |  237 | `	}` |
|     - |  238 | `	/* Copy public/protected attributes from the base class */` |
|  8010 |  239 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 55854 |  240 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|     - |  241 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 47846 |  242 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 47846 |  243 | `		pName = &pAttr->sName;` |
| 47846 |  244 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 47844 |  256 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 47842 |  257 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 47842 |  258 | `			if( rc != SXRET_OK ){` |
|   ! 0 |  259 | `				return rc;` |
|     - |  260 | `			}` |
| 23920 |  261 | `		}` |
|     2 |  262 | `	}` |
|  8010 |  263 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 79816 |  264 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|     - |  265 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 71808 |  266 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 71808 |  267 | `		pName = &pMeth->sFunc.sName;` |
| 71808 |  268 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  1622 |  269 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  1622 |  278 | `			continue;` |
|   ! 0 |  279 | `		}else{` |
| 70188 |  280 | `			if( pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT ){` |
...
| 70186 |  289 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 70184 |  290 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 70184 |  291 | `			if( rc != SXRET_OK ){` |
|   ! 0 |  292 | `				return rc;` |
|     - |  293 | `			}` |
| 35091 |  294 | `		}` |
|     2 |  295 | `	}` |
|     - |  296 | `	/* Mark as subclass */` |
|  8010 |  297 | `	pSub->pBase = pBase;` |
|     - |  298 | `	/* All done */` |
|  8010 |  299 | `	return SXRET_OK;` |
|  4006 |  300 |  |
|     - |  301 | `/*` |
...
|     - |  476 | ` */` |
|   754 |  477 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|     2 |  478 |  |
|     - |  479 | `	ph7_class_instance *pThis;` |
|     - |  480 | `	/* Allocate a new instance */` |
|   756 |  481 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|   756 |  482 | `	if( pThis == 0 ){` |
|   ! 0 |  483 | `		return 0;` |
|     - |  484 | `	}` |
|     - |  485 | `	/* Zero the structure */` |
|   756 |  486 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|     - |  487 | `	/* Initialize fields */` |
|   756 |  488 | `	pThis->iRef = 1;` |
|   756 |  489 | `	pThis->pVm = pVm;` |
|   756 |  490 | `	pThis->pClass = pClass;` |
|   756 |  491 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|   756 |  492 | `	return pThis;` |
|   379 |  493 |  |
|     - |  494 | `/*` |
|     - |  495 | ` * Wrapper around the NewClassInstance() function defined above.` |
|     - |  496 | ` * See the block comment above for more information.` |
|     - |  497 | ` */` |
|   712 |  498 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|     2 |  499 |  |
|     - |  500 | `	ph7_class_instance *pNew;` |
|     - |  501 | `	sxi32 rc;` |
|   714 |  502 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|   714 |  503 | `	if( pNew == 0 ){` |
|   ! 0 |  504 | `		return 0;` |
|     - |  505 | `	}` |
|     - |  506 | `	/* Associate a private VM frame with this class instance */` |
|   714 |  507 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|   714 |  508 | `	if( rc != SXRET_OK ){` |
...
|     - |  665 | ` * class instance.` |
|     - |  666 | ` */` |
|   488 |  667 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|     2 |  668 |  |
|     - |  669 | `	ph7_class_method *pDestr;` |
|     - |  670 | `	SyHashEntry *pEntry;` |
|     - |  671 | `	ph7_class *pClass;` |
|     - |  672 | `	ph7_vm *pVm;` |
|   490 |  673 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|     - |  674 | `		/*` |
...
|   490 |  681 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|     - |  682 | `	/* Invoke any defined destructor if available */` |
|   490 |  683 | `	pVm = pThis->pVm;` |
|   490 |  684 | `	pClass = pThis->pClass;` |
|   490 |  685 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|   490 |  686 | `	if( pDestr ){` |
...
|   490 |  692 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|  2066 |  693 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|  1578 |  694 | `		VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|  1578 |  695 | `		if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
|  1574 |  696 | `			PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   786 |  697 | `		}` |
|  1578 |  698 | `		SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|     2 |  699 | `	}` |
|     - |  700 | `	/* Release the whole structure */` |
|   490 |  701 | `	SyHashRelease(&pThis->hAttr);` |
|   490 |  702 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|   246 |  703 |  |
|     - |  704 | `/*` |
...
|     - |  707 | ` */` |
|  8270 |  708 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|     2 |  709 |  |
|  8272 |  710 | `	pThis->iRef--;` |
|  8272 |  711 | `	if( pThis->iRef < 1 ){` |
|     - |  712 | `		/* No more reference to this instance */` |
|   490 |  713 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|   244 |  714 | `	}` |
|  8272 |  715 |  |
|     - |  716 | `/*` |
