...
|      - |   13 | ` */` |
| 135072 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|      5 |   15 |  |
|      - |   16 | `	ph7_class *pClass;` |
|      - |   17 | `	char *zName;` |
|      - |   18 | `	/* Allocate a new instance */` |
| 135077 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
| 135077 |   20 | `	if( pClass == 0 ){` |
|    ! 0 |   21 | `		return 0;` |
|      - |   22 | `	}` |
|      - |   23 | `	/* Zero the structure */` |
| 135077 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|      - |   25 | `	/* Duplicate class name */` |
| 135077 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
| 135077 |   27 | `	if( zName == 0 ){` |
|    ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|    ! 0 |   29 | `		return 0;` |
|      - |   30 | `	}` |
|      - |   31 | `	/* Initialize fields */` |
| 135077 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
| 135077 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
| 135077 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
| 135077 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
| 135077 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
| 135077 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
| 135077 |   38 | `	pClass->nLine = nLine;` |
|      - |   39 | `	/* All done */` |
| 135077 |   40 | `	return pClass;` |
|  67541 |   41 |  |
|      - |   42 | `/*` |
|      - |   43 | ` * Allocate and initialize a new class attribute.` |
|      - |   44 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|      - |   45 | ` */` |
|  67646 |   46 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|      5 |   47 |  |
|      - |   48 | `	ph7_class_attr *pAttr;` |
|      - |   49 | `	char *zName;` |
|  67651 |   50 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  67651 |   51 | `	if( pAttr == 0 ){` |
|    ! 0 |   52 | `		return 0;` |
|      - |   53 | `	}` |
|      - |   54 | `	/* Zero the structure */` |
|  67651 |   55 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|      - |   56 | `	/* Duplicate attribute name */` |
|  67651 |   57 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  67651 |   58 | `	if( zName == 0 ){` |
|    ! 0 |   59 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|    ! 0 |   60 | `		return 0;` |
|      - |   61 | `	}` |
|      - |   62 | `	/* Initialize fields */` |
|  67651 |   63 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  67651 |   64 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  67651 |   65 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  67651 |   66 | `	pAttr->iProtection = iProtection;` |
|  67651 |   67 | `	pAttr->nIdx = SXU32_HIGH;` |
|  67651 |   68 | `	pAttr->iFlags = iFlags;` |
|  67651 |   69 | `	pAttr->nLine = nLine;` |
|  67651 |   70 | `	return pAttr;` |
|  33828 |   71 |  |
|      - |   72 | `/*` |
...
|      - |   77 | ` */` |
| 265084 |   78 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 265089 |   88 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 265089 |   89 | `	if( pMeth == 0 ){` |
|    ! 0 |   90 | `		return 0;` |
|      - |   91 | `	}` |
|      - |   92 | `	/* Zero the structure */` |
| 265089 |   93 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|      - |   94 | `	/* Check for an already installed method with the same name */` |
| 265089 |   95 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 265089 |   96 | `	if( pEntry == 0 ){` |
|      - |   97 | `		/* Associate an unique VM name to this method */` |
| 265087 |   98 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 265087 |   99 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 265087 |  100 | `		if( zName == 0 ){` |
|    ! 0 |  101 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|    ! 0 |  102 | `			return 0;` |
|      - |  103 | `		}` |
| 265087 |  104 | `		pNamePtr = &pMeth->sVmName;` |
|      - |  105 | `		/* Generate a random string */` |
| 265087 |  106 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 265087 |  107 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 265087 |  108 | `		pNamePtr->zString = zName;` |
| 132546 |  109 | `	}else{` |
...
|      - |  116 | `	}` |
| 265089 |  117 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
| 265091 |  126 | `	pMeth->iProtection = iProtection;` |
| 265091 |  127 | `	pMeth->iFlags = iFlags;` |
| 265091 |  128 | `	pMeth->nLine = nLine;` |
| 397635 |  129 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 265086 |  130 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 265091 |  131 | `	return pMeth;` |
| 132549 |  132 |  |
|      - |  133 | `/*` |
...
|      - |  136 | ` */` |
| 172464 |  137 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|      5 |  138 |  |
|      - |  139 | `	SyHashEntry *pEntry;` |
|      - |  140 | `	/* Perform a hash lookup */` |
| 172469 |  141 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
| 172469 |  142 | `	if( pEntry == 0 ){` |
|      - |  143 | `		/* No such entry */` |
|   4229 |  144 | `		return 0;` |
|      - |  145 | `	}` |
|      - |  146 | `	/* Point to the desired method */` |
| 168245 |  147 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  86237 |  148 |  |
|      - |  149 | `/*` |
...
|      - |  152 | ` */` |
|  67716 |  153 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|      5 |  154 |  |
|      - |  155 | `	SyHashEntry *pEntry;` |
|      - |  156 | `	/* Perform a hash lookup */` |
|  67721 |  157 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  67721 |  158 | `	if( pEntry == 0 ){` |
|      - |  159 | `		/* No such entry */` |
|  67575 |  160 | `		return 0;` |
|      - |  161 | `	}` |
...
|      - |  168 | ` */` |
|  67646 |  169 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|      5 |  170 |  |
|  67651 |  171 | `	SyString *pName = &pAttr->sName;` |
|      - |  172 | `	sxi32 rc;` |
...
|  67651 |  176 | `	if( pAttr->pDeclClass == 0 ){` |
|  67651 |  177 | `		pAttr->pDeclClass = pClass;` |
|  33823 |  178 | `	}` |
|  67651 |  179 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  67651 |  180 | `	return rc;` |
|      5 |  181 |  |
|      - |  182 | `/*` |
...
|      - |  185 | ` */` |
| 265072 |  186 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|      5 |  187 |  |
| 265077 |  188 | `	SyString *pName = &pMeth->sFunc.sName;` |
|      - |  189 | `	sxi32 rc;` |
| 265077 |  190 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 265077 |  191 | `	return rc;` |
|      5 |  192 |  |
|      - |  193 | `/*` |
...
|      - |  337 | ` */` |
|   3574 |  338 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|      - |  339 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|      5 |  340 |  |
|   3579 |  341 | `	ph7_vm *pVm = pGen->pVm;` |
|   3579 |  342 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|   3579 |  343 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|   3579 |  344 | `	SyString *pMName = &pCF->sName;` |
|      - |  345 | `	ph7_vm_func_arg *aP, *aC;` |
|      - |  346 | `	sxu32 nPArg, nCArg, k;` |
|   3579 |  347 | `	int bBad = 0;` |
|   3574 |  348 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   3559 |  349 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   3531 |  350 | `		return SXRET_OK;` |
|      - |  351 | `	}` |
...
|      - |  429 | ` * error message.` |
|      - |  430 | ` */` |
|  74084 |  431 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|      5 |  432 |  |
...
|  74089 |  439 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  74089 |  440 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  441 | `		return rc;` |
|      - |  442 | `	}` |
...
|  74089 |  445 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  74089 |  460 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 517985 |  461 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|      - |  462 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 443901 |  463 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 443901 |  464 | `		pName = &pAttr->sName;` |
| 443901 |  465 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 443895 |  490 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 443891 |  491 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 443891 |  492 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  493 | `				return rc;` |
|      - |  494 | `			}` |
| 221943 |  495 | `		}` |
|      5 |  496 | `	}` |
|  74089 |  497 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 740023 |  498 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|      - |  499 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 665939 |  500 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 665939 |  501 | `		pName = &pMeth->sFunc.sName;` |
| 665939 |  502 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|   3583 |  503 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|   5366 |  513 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|   3574 |  514 | `					(ph7_class_method *)pEntry->pUserData);` |
|   3579 |  515 | `				if( rc == SXERR_ABORT ){` |
...
| 662361 |  522 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE ){` |
| 662359 |  523 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 662359 |  524 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  525 | `				return rc;` |
|      - |  526 | `			}` |
| 331177 |  527 | `		}` |
|      5 |  528 | `	}` |
|      - |  529 | `	/* Mark as subclass */` |
|  74089 |  530 | `	pSub->pBase = pBase;` |
|      - |  531 | `	/* All done */` |
|  74089 |  532 | `	return SXRET_OK;` |
|  37047 |  533 |  |
|      - |  534 | `/*` |
...
|      - |  655 | ` * error message.` |
|      - |  656 | ` */` |
|  10568 |  657 | `PH7_PRIVATE sxi32 PH7_ClassInterfaceInherit(ph7_class *pSub,ph7_class *pBase)` |
|      5 |  658 |  |
...
|  10573 |  665 | `	SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  10573 |  666 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
|      - |  667 | `	/* Copy constants */` |
|  15859 |  668 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
...
|      1 |  678 | `		}` |
|      1 |  679 | `	}` |
|  10573 |  680 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
|      - |  681 | `	/* Copy methods signature */` |
|  19419 |  682 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|      - |  683 | `		/* Make sure the method are not redeclared in the subclass */` |
|   3567 |  684 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|   3567 |  685 | `		pName = &pMeth->sFunc.sName;` |
|   3567 |  686 | `		if( SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte) == 0 ){` |
|      - |  687 | `			/* Install the method */` |
|   3567 |  688 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|   3567 |  689 | `			if( rc != SXRET_OK ){` |
|    ! 0 |  690 | `				return rc;` |
|      - |  691 | `			}` |
|   1781 |  692 | `		}` |
|      5 |  693 | `	}` |
|      - |  694 | `	/* Mark as subclass */` |
|  10573 |  695 | `	pSub->pBase = pBase;` |
|      - |  696 | `	/* All done */` |
|  10573 |  697 | `	return SXRET_OK;` |
|   5289 |  698 |  |
|      - |  699 | `/*` |
...
|      - |  710 | ` * error message.` |
|      - |  711 | ` */` |
|  95278 |  712 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|      5 |  713 |  |
...
|  95283 |  719 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
| 142928 |  720 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
...
|  95283 |  734 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|      - |  743 | `		SyString *pMName;` |
|  95283 |  744 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 301768 |  745 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
| 158851 |  746 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
| 158851 |  747 | `			pMName = &pMeth->sFunc.sName;` |
| 158851 |  748 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|      - |  836 | ` */` |
|   2620 |  837 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      5 |  838 |  |
|      - |  839 | `	ph7_class_instance *pThis;` |
|      - |  840 | `	/* Allocate a new instance */` |
|   2625 |  841 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|   2625 |  842 | `	if( pThis == 0 ){` |
|    ! 0 |  843 | `		return 0;` |
|      - |  844 | `	}` |
|      - |  845 | `	/* Zero the structure */` |
|   2625 |  846 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|      - |  847 | `	/* Initialize fields */` |
|   2625 |  848 | `	pThis->iRef = 1;` |
|   2625 |  849 | `	pThis->pVm = pVm;` |
|   2625 |  850 | `	pThis->pClass = pClass;` |
|      - |  851 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|   2625 |  852 | `	pThis->nObjId = pVm->nNextObjId++;` |
|   2625 |  853 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|   2625 |  854 | `	return pThis;` |
|   1315 |  855 |  |
|      - |  856 | `/*` |
|      - |  857 | ` * Wrapper around the NewClassInstance() function defined above.` |
|      - |  858 | ` * See the block comment above for more information.` |
|      - |  859 | ` */` |
|   2568 |  860 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|      5 |  861 |  |
|      - |  862 | `	ph7_class_instance *pNew;` |
|      - |  863 | `	sxi32 rc;` |
|   2573 |  864 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|   2573 |  865 | `	if( pNew == 0 ){` |
|    ! 0 |  866 | `		return 0;` |
|      - |  867 | `	}` |
|      - |  868 | `	/* Associate a private VM frame with this class instance */` |
|   2573 |  869 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|   2573 |  870 | `	if( rc != SXRET_OK ){` |
|    ! 0 |  871 | `		SyMemBackendPoolFree(&pVm->sAllocator,pNew);` |
|    ! 0 |  872 | `		return 0;` |
|      - |  873 | `	}` |
|   2573 |  874 | `	return pNew;` |
|   1289 |  875 |  |
|      - |  876 | `/*` |
...
|      - | 1033 | ` * class instance.` |
|      - | 1034 | ` */` |
|   1876 | 1035 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|      5 | 1036 |  |
|      - | 1037 | `	ph7_class_method *pDestr;` |
|      - | 1038 | `	SyHashEntry *pEntry;` |
|      - | 1039 | `	ph7_class *pClass;` |
|      - | 1040 | `	ph7_vm *pVm;` |
|   1881 | 1041 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|      - | 1042 | `		/*` |
...
|   1873 | 1049 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|      - | 1050 | `	/* Invoke any defined destructor if available */` |
|   1873 | 1051 | `	pVm = pThis->pVm;` |
|   1873 | 1052 | `	pClass = pThis->pClass;` |
|   1873 | 1053 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|   1873 | 1054 | `	if( pDestr && !pVm->bInReset ){` |
...
|   1873 | 1061 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   8955 | 1062 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   7087 | 1063 | `		VmClassAttr *pVmAttr = (VmClassAttr *)pEntry->pUserData;` |
|   7087 | 1064 | `		if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   7065 | 1068 | `			if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|    274 | 1069 | `				SyHashDeleteEntry(&pVm->hTypedSlot,` |
|    180 | 1070 | `					(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     90 | 1071 | `			}` |
|   7065 | 1072 | `			PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   3530 | 1073 | `		}` |
|   7087 | 1074 | `		SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|      5 | 1075 | `	}` |
|      - | 1076 | `	/* Release the whole structure */` |
|   1873 | 1077 | `	SyHashRelease(&pThis->hAttr);` |
|   1873 | 1078 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    943 | 1079 |  |
|      - | 1080 | `/*` |
...
|      - | 1083 | ` */` |
|  34744 | 1084 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|      5 | 1085 |  |
|  34749 | 1086 | `	pThis->iRef--;` |
|  34749 | 1087 | `	if( pThis->iRef < 1 ){` |
|      - | 1088 | `		/* No more reference to this instance */` |
|   1881 | 1089 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    938 | 1090 | `	}` |
|  34749 | 1091 |  |
|      - | 1092 | `/*` |
