...
|       - |   13 | ` */` |
|  522098 |   14 | `PH7_PRIVATE ph7_class * PH7_NewRawClass(ph7_vm *pVm,const SyString *pName,sxu32 nLine)` |
|       5 |   15 | `{` |
|       - |   16 | `	ph7_class *pClass;` |
|       - |   17 | `	char *zName;` |
|       - |   18 | `	/* Allocate a new instance */` |
|  522103 |   19 | `	pClass = (ph7_class *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class));` |
|  522103 |   20 | `	if( pClass == 0 ){` |
|     ! 0 |   21 | `		return 0;` |
|       - |   22 | `	}` |
|       - |   23 | `	/* Zero the structure */` |
|  522103 |   24 | `	SyZero(pClass,sizeof(ph7_class));` |
|       - |   25 | `	/* Duplicate class name */` |
|  522103 |   26 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  522103 |   27 | `	if( zName == 0 ){` |
|     ! 0 |   28 | `		SyMemBackendPoolFree(&pVm->sAllocator,pClass);` |
|     ! 0 |   29 | `		return 0;` |
|       - |   30 | `	}` |
|       - |   31 | `	/* Initialize fields */` |
|  522103 |   32 | `	SyStringInitFromBuf(&pClass->sName,zName,pName->nByte);` |
|  522103 |   33 | `	SyHashInit(&pClass->hMethod,&pVm->sAllocator,0,0);` |
|  522103 |   34 | `	SyHashInit(&pClass->hAttr,&pVm->sAllocator,0,0);` |
|  522103 |   35 | `	SyHashInit(&pClass->hDerived,&pVm->sAllocator,0,0);` |
|  522103 |   36 | `	SySetInit(&pClass->aInterface,&pVm->sAllocator,sizeof(ph7_class *));` |
|  522103 |   37 | `	SySetInit(&pClass->aTrait,&pVm->sAllocator,sizeof(ph7_class *));` |
|  522103 |   38 | `	SySetInit(&pClass->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|  522103 |   39 | `	SySetInit(&pClass->aEnumCases,&pVm->sAllocator,sizeof(ph7_class_attr *));` |
|  522103 |   40 | `	pClass->nLine = nLine;` |
|  522103 |   41 | `	if( pVm->bCompilingBuiltin ){` |
...
|  519925 |   44 | `		pClass->iFlags \|= PH7_CLASS_INTERNAL;` |
|  259965 |   45 | `	}else{` |
...
|       - |   51 | `	}` |
|       - |   52 | `	/* All done */` |
|  522103 |   53 | `	return pClass;` |
|  261054 |   54 | `}` |
|       - |   55 | `/*` |
|       - |   56 | ` * Allocate and initialize a new class attribute.` |
|       - |   57 | ` * Return a pointer to the class attribute on success. NULL otherwise.` |
|       - |   58 | ` */` |
|  948138 |   59 | `PH7_PRIVATE ph7_class_attr * PH7_NewClassAttr(ph7_vm *pVm,const SyString *pName,sxu32 nLine,sxi32 iProtection,sxi32 iFlags)` |
|       5 |   60 | `{` |
|       - |   61 | `	ph7_class_attr *pAttr;` |
|       - |   62 | `	char *zName;` |
|  948143 |   63 | `	pAttr = (ph7_class_attr *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_attr));` |
|  948143 |   64 | `	if( pAttr == 0 ){` |
|     ! 0 |   65 | `		return 0;` |
|       - |   66 | `	}` |
|       - |   67 | `	/* Zero the structure */` |
|  948143 |   68 | `	SyZero(pAttr,sizeof(ph7_class_attr));` |
|  948143 |   69 | `	SySetInit(&pAttr->aAttrs,&pVm->sAllocator,sizeof(ph7_attribute));` |
|       - |   70 | `	/* Duplicate attribute name */` |
|  948143 |   71 | `	zName = SyMemBackendStrDup(&pVm->sAllocator,pName->zString,pName->nByte);` |
|  948143 |   72 | `	if( zName == 0 ){` |
|     ! 0 |   73 | `		SyMemBackendPoolFree(&pVm->sAllocator,pAttr);` |
|     ! 0 |   74 | `		return 0;` |
|       - |   75 | `	}` |
|       - |   76 | `	/* Initialize fields */` |
|  948143 |   77 | `	SySetInit(&pAttr->aByteCode,&pVm->sAllocator,sizeof(VmInstr));` |
|  948143 |   78 | `	SySetInit(&pAttr->aUnionAlts,&pVm->sAllocator,sizeof(ph7_type_alt));` |
|  948143 |   79 | `	SyStringInitFromBuf(&pAttr->sName,zName,pName->nByte);` |
|  948143 |   80 | `	pAttr->iProtection = iProtection;` |
|  948143 |   81 | `	pAttr->nIdx = SXU32_HIGH;` |
|  948143 |   82 | `	pAttr->iFlags = iFlags;` |
|  948143 |   83 | `	pAttr->nLine = nLine;` |
|  948143 |   84 | `	return pAttr;` |
|  474074 |   85 | `}` |
|       - |   86 | `/*` |
...
|       - |   91 | ` */` |
| 2896504 |   92 | `PH7_PRIVATE ph7_class_method * PH7_NewClassMethod(ph7_vm *pVm,ph7_class *pClass,const SyString *pName,sxu32 nLine,` |
...
| 2896509 |  102 | `	pMeth = (ph7_class_method *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_method));` |
| 2896509 |  103 | `	if( pMeth == 0 ){` |
|     ! 0 |  104 | `		return 0;` |
|       - |  105 | `	}` |
|       - |  106 | `	/* Zero the structure */` |
| 2896509 |  107 | `	SyZero(pMeth,sizeof(ph7_class_method));` |
|       - |  108 | `	/* Check for an already installed method with the same name */` |
| 2896509 |  109 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
| 2896509 |  110 | `	if( pEntry == 0 ){` |
|       - |  111 | `		/* Associate an unique VM name to this method */` |
| 2896507 |  112 | `		nByte = sizeof(zSalt) + pName->nByte + SyStringLength(&pClass->sName)+sizeof(char)*7/*[[__'\0'*/;` |
| 2896507 |  113 | `		zName = (char *)SyMemBackendAlloc(&pVm->sAllocator,nByte);` |
| 2896507 |  114 | `		if( zName == 0 ){` |
|     ! 0 |  115 | `			SyMemBackendPoolFree(&pVm->sAllocator,pMeth);` |
|     ! 0 |  116 | `			return 0;` |
|       - |  117 | `		}` |
| 2896507 |  118 | `		pNamePtr = &pMeth->sVmName;` |
|       - |  119 | `		/* Generate a random string */` |
| 2896507 |  120 | `		PH7_VmRandomString(&(*pVm),zSalt,sizeof(zSalt));` |
| 2896507 |  121 | `		pNamePtr->nByte = SyBufferFormat(zName,nByte,"[__%z@%z_%.*s]",&pClass->sName,pName,sizeof(zSalt),zSalt);` |
| 2896507 |  122 | `		pNamePtr->zString = zName;` |
| 1448256 |  123 | `	}else{` |
...
|       - |  130 | `	}` |
| 2896509 |  131 | `	if( iProtection != PH7_CLASS_PROT_PUBLIC ){` |
|  166918 |  132 | `		if( (pName->nByte == sizeof("__destruct") - 1 && SyMemcmp(pName->zString,"__destruct",sizeof("__destruct") - 1 ) == 0)` |
|  166923 |  133 | `			\|\| SyStringCmp(pName,&pClass->sName,SyMemcmp) == 0 ){` |
...
| 2896509 |  144 | `	pMeth->iProtection = iProtection;` |
| 2896509 |  145 | `	pMeth->iFlags = iFlags;` |
| 2896509 |  146 | `	pMeth->nLine = nLine;` |
| 4344761 |  147 | `	PH7_VmInitFuncState(&(*pVm),&pMeth->sFunc,&zName[sizeof(char)*4/*[__@*/+SyStringLength(&pClass->sName)],` |
| 2896504 |  148 | `		pName->nByte,iFuncFlags\|VM_FUNC_CLASS_METHOD,pClass);` |
| 2896509 |  149 | `	return pMeth;` |
| 1448257 |  150 | `}` |
|       - |  151 | `/*` |
...
|       - |  154 | ` */` |
|  900204 |  155 | `PH7_PRIVATE ph7_class_method * PH7_ClassExtractMethod(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  156 | `{` |
|       - |  157 | `	SyHashEntry *pEntry;` |
|       - |  158 | `	/* Perform a hash lookup */` |
|  900209 |  159 | `	pEntry = SyHashGet(&pClass->hMethod,(const void *)zName,nByte);` |
|  900209 |  160 | `	if( pEntry == 0 ){` |
|       - |  161 | `		/* No such entry */` |
|   30225 |  162 | `		return 0;` |
|       - |  163 | `	}` |
|       - |  164 | `	/* Point to the desired method */` |
|  869989 |  165 | `	return (ph7_class_method *)pEntry->pUserData;` |
|  450107 |  166 | `}` |
|       - |  167 | `/*` |
...
|       - |  170 | ` */` |
|  592430 |  171 | `PH7_PRIVATE ph7_class_attr * PH7_ClassExtractAttribute(ph7_class *pClass,const char *zName,sxu32 nByte)` |
|       5 |  172 | `{` |
|       - |  173 | `	SyHashEntry *pEntry;` |
|       - |  174 | `	/* Perform a hash lookup */` |
|  592435 |  175 | `	pEntry = SyHashGet(&pClass->hAttr,(const void *)zName,nByte);` |
|  592435 |  176 | `	if( pEntry == 0 ){` |
|       - |  177 | `		/* No such entry */` |
|  590983 |  178 | `		return 0;` |
|       - |  179 | `	}` |
...
|       - |  186 | ` */` |
|  948134 |  187 | `PH7_PRIVATE sxi32 PH7_ClassInstallAttr(ph7_class *pClass,ph7_class_attr *pAttr)` |
|       5 |  188 | `{` |
|  948139 |  189 | `	SyString *pName = &pAttr->sName;` |
|       - |  190 | `	sxi32 rc;` |
...
|  948139 |  194 | `	if( pAttr->pDeclClass == 0 ){` |
|  948139 |  195 | `		pAttr->pDeclClass = pClass;` |
|  474067 |  196 | `	}` |
|  948139 |  197 | `	rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|  948139 |  198 | `	return rc;` |
|       5 |  199 | `}` |
|       - |  200 | `/*` |
...
|       - |  203 | ` */` |
| 2896492 |  204 | `PH7_PRIVATE sxi32 PH7_ClassInstallMethod(ph7_class *pClass,ph7_class_method *pMeth)` |
|       5 |  205 | `{` |
| 2896497 |  206 | `	SyString *pName = &pMeth->sFunc.sName;` |
|       - |  207 | `	sxi32 rc;` |
| 2896497 |  208 | `	rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 2896497 |  209 | `	return rc;` |
|       5 |  210 | `}` |
|       - |  211 | `/*` |
...
|       - |  233 | ` */` |
|  279592 |  234 | `static int OoClassifyOverrideType(ph7_vm *pVm, sxu32 nType, const SyString *pClass,` |
|       - |  235 | `	int bUnion, ph7_class **ppClass)` |
|       5 |  236 | `{` |
|  279597 |  237 | `	*ppClass = 0;` |
|  279597 |  238 | `	if( bUnion ){` |
|       3 |  239 | `		return OVT_SKIP; /* union/intersection — full lattice, skip */` |
|       - |  240 | `	}` |
|  279595 |  241 | `	if( nType == 0 ){` |
|  279491 |  242 | `		return OVT_NONE; /* no declared type */` |
|       - |  243 | `	}` |
...
|       - |  286 | `	int bNullable;` |
|       - |  287 | `};` |
|  209688 |  288 | `static OvType OoTypeFromReturn(ph7_vm_func *pF)` |
|       5 |  289 | `{` |
|       - |  290 | `	OvType t;` |
|  209693 |  291 | `	t.nType = pF->nReturnType;` |
|  209693 |  292 | `	t.pClass = &pF->sReturnClass;` |
|  209693 |  293 | `	t.bUnion = SySetUsed(&pF->aReturnUnion) > 0;` |
|  209693 |  294 | `	t.bNullable = (pF->iFlags & VM_FUNC_RETURN_NULLABLE) != 0;` |
|  209693 |  295 | `	return t;` |
|       5 |  296 | `}` |
|   69904 |  297 | `static OvType OoTypeFromArg(ph7_vm_func_arg *pA)` |
|       5 |  298 | `{` |
|       - |  299 | `	OvType t;` |
|   69909 |  300 | `	t.nType = pA->nType;` |
|   69909 |  301 | `	t.pClass = &pA->sClass;` |
|   69909 |  302 | `	t.bUnion = (pA->iFlags & VM_FUNC_ARG_UNION) != 0;` |
|   69909 |  303 | `	t.bNullable = (pA->iFlags & VM_FUNC_ARG_NULLABLE) != 0;` |
|   69909 |  304 | `	return t;` |
|       5 |  305 | `}` |
|       - |  306 | `/*` |
...
|       - |  311 | ` */` |
|  139796 |  312 | `static int OoOverrideTypeBad(ph7_vm *pVm, OvType parent, OvType child, int bCovariant)` |
|       5 |  313 | `{` |
|       - |  314 | `	ph7_class *pParentCls, *pChildCls;` |
|  139801 |  315 | `	int kP = OoClassifyOverrideType(pVm, parent.nType, parent.pClass, parent.bUnion, &pParentCls);` |
|  139801 |  316 | `	int kC = OoClassifyOverrideType(pVm, child.nType, child.pClass, child.bUnion, &pChildCls);` |
|  139801 |  317 | `	if( kP == OVT_SKIP \|\| kC == OVT_SKIP ){` |
...
|  139783 |  325 | `	if( kP == OVT_NONE \|\| kC == OVT_NONE ){` |
|  139753 |  326 | `		if( bCovariant && kC == OVT_NONE && kP != OVT_NONE ) return 1;` |
|  139753 |  327 | `		if( !bCovariant && kP == OVT_NONE && kC != OVT_NONE ) return 1;` |
|  139753 |  328 | `		return 0;` |
|       - |  329 | `	}` |
...
|       - |  355 | ` */` |
|  147532 |  356 | `static sxi32 OoCheckOverrideCompat(ph7_gen_state *pGen, ph7_class *pBase, ph7_class *pSub,` |
|       - |  357 | `	ph7_class_method *pParent, ph7_class_method *pChild)` |
|       5 |  358 | `{` |
|  147537 |  359 | `	ph7_vm *pVm = pGen->pVm;` |
|  147537 |  360 | `	ph7_vm_func *pPF = &pParent->sFunc;` |
|  147537 |  361 | `	ph7_vm_func *pCF = &pChild->sFunc;` |
|  147537 |  362 | `	SyString *pMName = &pCF->sName;` |
|       - |  363 | `	ph7_vm_func_arg *aP, *aC;` |
|       - |  364 | `	sxu32 nPArg, nCArg, k;` |
|  147537 |  365 | `	int bBad = 0;` |
|  147532 |  366 | `	if( pMName->nByte == sizeof("__construct")-1` |
|   97059 |  367 | `	 && SyStrnmicmp(pMName->zString,"__construct",pMName->nByte) == 0 ){` |
|   42693 |  368 | `		return SXRET_OK;` |
|       - |  369 | `	}` |
|       - |  370 | `	/* Return type — covariant. */` |
|  104849 |  371 | `	bBad = OoOverrideTypeBad(pVm, OoTypeFromReturn(pPF), OoTypeFromReturn(pCF), /* bCovariant */ 1);` |
|       - |  372 | `	/* Each overlapping parameter — contravariant. */` |
|  104849 |  373 | `	nPArg = SySetUsed(&pPF->aArgs);` |
|  104849 |  374 | `	nCArg = SySetUsed(&pCF->aArgs);` |
|  104849 |  375 | `	aP = (ph7_vm_func_arg *)SySetBasePtr(&pPF->aArgs);` |
|  104849 |  376 | `	aC = (ph7_vm_func_arg *)SySetBasePtr(&pCF->aArgs);` |
|  139801 |  377 | `	for( k = 0; !bBad && k < nPArg && k < nCArg; k++ ){` |
|   34957 |  378 | `		bBad = OoOverrideTypeBad(pVm, OoTypeFromArg(&aP[k]), OoTypeFromArg(&aC[k]), /* bCovariant */ 0);` |
|   17481 |  379 | `	}` |
...
|  104849 |  384 | `	if( !bBad ){` |
|  104845 |  385 | `		int bVariadic = 0;` |
|  139795 |  386 | `		for( k = 0; k < nPArg; k++ ){ if( aP[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  139797 |  387 | `		for( k = 0; k < nCArg; k++ ){ if( aC[k].iFlags & VM_FUNC_ARG_VARIADIC ) bVariadic = 1; }` |
|  104845 |  388 | `		if( !bVariadic ){` |
|  104845 |  389 | `			if( nCArg < nPArg ){` |
|     ! 0 |  390 | `				bBad = 1; /* dropped a parent parameter */` |
|     ! 0 |  391 | `			}else{` |
|  104847 |  392 | `				for( k = nPArg; k < nCArg; k++ ){` |
...
|       - |  447 | ` * error message.` |
|       - |  448 | ` */` |
|  240852 |  449 | `PH7_PRIVATE sxi32 PH7_ClassInherit(ph7_gen_state *pGen,ph7_class *pSub,ph7_class *pBase)` |
|       5 |  450 | `{` |
...
|  240857 |  457 | `	rc = SyHashInsert(&pBase->hDerived,(const void *)SyStringData(&pSub->sName),SyStringLength(&pSub->sName),pSub);` |
|  240857 |  458 | `	if( rc != SXRET_OK ){` |
|     ! 0 |  459 | `		return rc;` |
|       - |  460 | `	}` |
...
|  240857 |  463 | `	if( (pBase->iFlags & PH7_CLASS_READONLY) != (pSub->iFlags & PH7_CLASS_READONLY) ){` |
...
|  240857 |  478 | `	SyHashResetLoopCursor(&pBase->hAttr);` |
| 1366593 |  479 | `	while((pEntry = SyHashGetNextEntry(&pBase->hAttr)) != 0 ){` |
|       - |  480 | `		/* Make sure the private attributes are not redeclared in the subclass */` |
| 1125741 |  481 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
| 1125741 |  482 | `		pName = &pAttr->sName;` |
| 1125741 |  483 | `		if( (pEntry = SyHashGet(&pSub->hAttr,(const void *)pName->zString,pName->nByte)) != 0 ){` |
...
| 1125718 |  509 | `		if( pAttr->iProtection != PH7_CLASS_PROT_PRIVATE` |
|  716202 |  510 | `		 \|\| (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
| 1125717 |  511 | `			rc = SyHashInsert(&pSub->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
| 1125717 |  512 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  513 | `				return rc;` |
|       - |  514 | `			}` |
|  562856 |  515 | `		}` |
|       5 |  516 | `	}` |
|  240857 |  517 | `	SyHashResetLoopCursor(&pBase->hMethod);` |
| 3543753 |  518 | `	while((pEntry = SyHashGetNextEntry(&pBase->hMethod)) != 0 ){` |
|       - |  519 | `		/* Make sure the private/final methods are not redeclared in the subclass */` |
| 3302901 |  520 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
| 3302901 |  521 | `		pName = &pMeth->sFunc.sName;` |
| 3302901 |  522 | `		if( (pEntry = SyHashGet(&pSub->hMethod,(const void *)pName->zString,pName->nByte)) != 0 ){` |
|  147541 |  523 | `			 if( pMeth->iFlags & PH7_CLASS_ATTR_FINAL ){` |
...
|  221303 |  534 | `				rc = OoCheckOverrideCompat(&(*pGen),pBase,pSub,pMeth,` |
|  147532 |  535 | `					(ph7_class_method *)pEntry->pUserData);` |
|  147537 |  536 | `				if( rc == SXERR_ABORT ){` |
...
| 3155360 |  550 | `		if( pMeth->iProtection != PH7_CLASS_PROT_PRIVATE` |
| 1593214 |  551 | `		 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_STATIC) == 0 ){` |
| 3155365 |  552 | `			rc = SyHashInsert(&pSub->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
| 3155365 |  553 | `			if( rc != SXRET_OK ){` |
|     ! 0 |  554 | `				return rc;` |
|       - |  555 | `			}` |
| 1577680 |  556 | `		}` |
|       5 |  557 | `	}` |
|       - |  558 | `	/* Mark as subclass */` |
|  240857 |  559 | `	pSub->pBase = pBase;` |
|       - |  560 | `	/* All done */` |
|  240857 |  561 | `	return SXRET_OK;` |
|  120431 |  562 | `}` |
|       - |  563 | `/*` |
...
|       - |  567 | ` */` |
|   15604 |  568 | `PH7_PRIVATE sxi32 PH7_ClassUseTrait(ph7_gen_state *pGen,ph7_class *pClass,ph7_class *pTrait)` |
|       5 |  569 | `{` |
...
|   15609 |  576 | `	if( pTrait->iFlags & PH7_CLASS_TRAIT_VISITING ){` |
...
|       - |  583 | `	}` |
|   15609 |  584 | `	pTrait->iFlags \|= PH7_CLASS_TRAIT_VISITING;` |
|   15609 |  585 | `	rc = SXRET_OK;` |
|       - |  586 | `	/* Copy attributes from the trait */` |
|   15609 |  587 | `	SyHashResetLoopCursor(&pTrait->hAttr);` |
|   62191 |  588 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hAttr)) != 0 ){` |
|       - |  589 | `		SyHashEntry *pExisting;` |
|   46587 |  590 | `		pAttr = (ph7_class_attr *)pEntry->pUserData;` |
|   46587 |  591 | `		pName = &pAttr->sName;` |
|   46587 |  592 | `		pExisting = SyHashGet(&pClass->hAttr,(const void *)pName->zString,pName->nByte);` |
|   46587 |  593 | `		if( pExisting != 0 ){` |
...
|       6 |  622 | `			continue;` |
|       - |  623 | `		}` |
|   46583 |  624 | `		rc = SyHashInsert(&pClass->hAttr,(const void *)pName->zString,pName->nByte,pAttr);` |
|   46583 |  625 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  626 | `			goto cleanup;` |
|       - |  627 | `		}` |
|       5 |  628 | `	}` |
|       - |  629 | `	/* Copy methods from the trait */` |
|   15609 |  630 | `	SyHashResetLoopCursor(&pTrait->hMethod);` |
|  225223 |  631 | `	while((pEntry = SyHashGetNextEntry(&pTrait->hMethod)) != 0 ){` |
|       - |  632 | `		SyHashEntry *pClassMethEntry;` |
|  209619 |  633 | `		pMeth = (ph7_class_method *)pEntry->pUserData;` |
|  209619 |  634 | `		pName = &pMeth->sFunc.sName;` |
|  209619 |  635 | `		pClassMethEntry = SyHashGet(&pClass->hMethod,(const void *)pName->zString,pName->nByte);` |
|  209619 |  636 | `		if( pClassMethEntry != 0 ){` |
...
|       8 |  678 | `			continue;` |
|       - |  679 | `		}` |
|  209605 |  680 | `		rc = SyHashInsert(&pClass->hMethod,(const void *)pName->zString,pName->nByte,pMeth);` |
|  209605 |  681 | `		if( rc != SXRET_OK ){` |
|     ! 0 |  682 | `			goto cleanup;` |
|       - |  683 | `		}` |
|       5 |  684 | `	}` |
|       - |  685 | `	/* Record trait in the class */` |
|   15609 |  686 | `	SySetPut(&pClass->aTrait,(const void *)&pTrait);` |
|    7802 |  687 | `cleanup:` |
|       - |  688 | `	/* Always clear visiting flag, even on error paths */` |
|   15609 |  689 | `	pTrait->iFlags &= ~PH7_CLASS_TRAIT_VISITING;` |
|    7802 |  690 | `	SXUNUSED(pGen);` |
|   15609 |  691 | `	return rc;` |
|    7807 |  692 | `}` |
|       - |  693 | `/*` |
...
|       - |  759 | ` * error message.` |
|       - |  760 | ` */` |
|  415516 |  761 | `PH7_PRIVATE sxi32 PH7_ClassImplement(ph7_class *pMain,ph7_class *pInterface)` |
|       5 |  762 | `{` |
...
|  415521 |  768 | `	SyHashResetLoopCursor(&pInterface->hAttr);` |
|  731933 |  769 | `	while((pEntry = SyHashGetNextEntry(&pInterface->hAttr)) != 0 ){` |
...
|  415521 |  783 | `	SySetPut(&pMain->aInterface,(const void *)&pInterface);` |
...
|       - |  792 | `		SyString *pMName;` |
|  415521 |  793 | `		SyHashResetLoopCursor(&pInterface->hMethod);` |
| 1438687 |  794 | `		while((pMEntry = SyHashGetNextEntry(&pInterface->hMethod)) != 0 ){` |
|  815413 |  795 | `			pMeth = (ph7_class_method *)pMEntry->pUserData;` |
|  815413 |  796 | `			pMName = &pMeth->sFunc.sName;` |
|  815413 |  797 | `			if( SyHashGet(&pMain->hMethod,(const void *)pMName->zString,pMName->nByte) == 0 ){` |
...
|       - |  885 | ` */` |
|    8638 |  886 | `static ph7_class_instance * NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  887 | `{` |
|       - |  888 | `	ph7_class_instance *pThis;` |
|       - |  889 | `	/* Allocate a new instance */` |
|    8643 |  890 | `	pThis = (ph7_class_instance *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_class_instance));` |
|    8643 |  891 | `	if( pThis == 0 ){` |
|     ! 0 |  892 | `		return 0;` |
|       - |  893 | `	}` |
|       - |  894 | `	/* Zero the structure */` |
|    8643 |  895 | `	SyZero(pThis,sizeof(ph7_class_instance));` |
|       - |  896 | `	/* Initialize fields */` |
|    8643 |  897 | `	pThis->iRef = 1;` |
|    8643 |  898 | `	pThis->pVm = pVm;` |
|    8643 |  899 | `	pThis->pClass = pClass;` |
|       - |  900 | `	/* Assign a fresh monotonic object handle id (clones get their own, like PHP). */` |
|    8643 |  901 | `	pThis->nObjId = pVm->nNextObjId++;` |
|    8643 |  902 | `	SyHashInit(&pThis->hAttr,&pVm->sAllocator,0,0);` |
|    8643 |  903 | `	return pThis;` |
|    4324 |  904 | `}` |
|       - |  905 | `/*` |
|       - |  906 | ` * Wrapper around the NewClassInstance() function defined above.` |
|       - |  907 | ` * See the block comment above for more information.` |
|       - |  908 | ` */` |
|    8392 |  909 | `PH7_PRIVATE ph7_class_instance * PH7_NewClassInstance(ph7_vm *pVm,ph7_class *pClass)` |
|       5 |  910 | `{` |
|       - |  911 | `	ph7_class_instance *pNew;` |
|       - |  912 | `	sxi32 rc;` |
|    8397 |  913 | `	pNew = NewClassInstance(&(*pVm),&(*pClass));` |
|    8397 |  914 | `	if( pNew == 0 ){` |
|     ! 0 |  915 | `		return 0;` |
|       - |  916 | `	}` |
|       - |  917 | `	/* Associate a private VM frame with this class instance */` |
|    8397 |  918 | `	rc = PH7_VmCreateClassInstanceFrame(&(*pVm),pNew);` |
|    8397 |  919 | `	if( rc != SXRET_OK ){` |
...
|    8397 |  926 | `	PH7_VmStampThrowableSite(&(*pVm),pNew);` |
|    8397 |  927 | `	return pNew;` |
|    4201 |  928 | `}` |
|       - |  929 | `/*` |
|       - |  930 | ` * Extract the value of a class instance [i.e: Object in the PHP jargon] attribute.` |
|       - |  931 | ` * This function never fail.` |
|       - |  932 | ` */` |
|   24070 |  933 | `static ph7_value * ExtractClassAttrValue(ph7_vm *pVm,VmClassAttr *pAttr)` |
|       5 |  934 | `{` |
|       - |  935 | `	/* Extract the value */` |
|       - |  936 | `	ph7_value *pValue;` |
|   24075 |  937 | `	pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|   24075 |  938 | `	return pValue;` |
|       5 |  939 | `}` |
|       - |  940 | `/*` |
...
|       - | 1156 | ` */` |
|   28740 | 1157 | `PH7_PRIVATE void PH7_VmReleaseInstanceAttr(ph7_vm *pVm, VmClassAttr *pVmAttr)` |
|       5 | 1158 | `{` |
|   28745 | 1159 | `	if( pVmAttr->iState & VM_CLASS_ATTR_REFBOUND ){` |
...
|   28740 | 1164 | `	}else if( (pVmAttr->pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|   21439 | 1167 | `		if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED ){` |
|     309 | 1168 | `			SyHashDeleteEntry(&pVm->hTypedSlot,(const void *)&pVmAttr->nIdx,sizeof(sxu32),0);` |
|     152 | 1169 | `		}` |
|   21439 | 1170 | `		PH7_VmUnsetMemObj(pVm,pVmAttr->nIdx,TRUE);` |
|   10717 | 1171 | `	}` |
...
|   28745 | 1174 | `	if( pVmAttr->pAttr->iFlags & PH7_CLASS_ATTR_DYNAMIC ){` |
|     116 | 1175 | `		SyMemBackendFree(&pVm->sAllocator,pVmAttr->pAttr);` |
|      57 | 1176 | `	}` |
|   28745 | 1177 | `	SyMemBackendPoolFree(&pVm->sAllocator,pVmAttr);` |
|   28745 | 1178 | `}` |
|       - | 1179 | `/*` |
...
|       - | 1182 | ` * class instance.` |
|       - | 1183 | ` */` |
|    5736 | 1184 | `static void PH7_ClassInstanceRelease(ph7_class_instance *pThis)` |
|       5 | 1185 | `{` |
|       - | 1186 | `	ph7_class_method *pDestr;` |
|       - | 1187 | `	SyHashEntry *pEntry;` |
|       - | 1188 | `	ph7_class *pClass;` |
|       - | 1189 | `	ph7_vm *pVm;` |
|    5741 | 1190 | `	if( pThis->iFlags & CLASS_INSTANCE_DESTROYED ){` |
|       - | 1191 | `		/*` |
...
|    5741 | 1198 | `	pThis->iFlags \|= CLASS_INSTANCE_DESTROYED;` |
|       - | 1199 | `	/* Invoke any defined destructor if available */` |
|    5741 | 1200 | `	pVm = pThis->pVm;` |
|    5741 | 1201 | `	pClass = pThis->pClass;` |
|    5741 | 1202 | `	pDestr = PH7_ClassExtractMethod(pClass,"__destruct",sizeof("__destruct")-1);` |
|    5741 | 1203 | `	if( pDestr && !pVm->bInReset ){` |
...
|    5741 | 1213 | `	if( SyHashTotalEntry(&pVm->hWeakCell) > 0 ){` |
...
|    5741 | 1222 | `	SyHashResetLoopCursor(&pThis->hAttr);` |
|   34453 | 1223 | `	while((pEntry = SyHashGetNextEntry(&pThis->hAttr)) != 0 ){` |
|   28717 | 1224 | `		PH7_VmReleaseInstanceAttr(pVm,(VmClassAttr *)pEntry->pUserData);` |
|       5 | 1225 | `	}` |
|       - | 1226 | `	/* Release the whole structure */` |
|    5741 | 1227 | `	SyHashRelease(&pThis->hAttr);` |
|    5741 | 1228 | `	SyMemBackendPoolFree(&pVm->sAllocator,pThis);` |
|    2873 | 1229 | `}` |
|       - | 1230 | `/*` |
...
|       - | 1233 | ` */` |
|  143218 | 1234 | `PH7_PRIVATE void PH7_ClassInstanceUnref(ph7_class_instance *pThis)` |
|       5 | 1235 | `{` |
|  143223 | 1236 | `	pThis->iRef--;` |
|  143223 | 1237 | `	if( pThis->iRef < 1 ){` |
|       - | 1238 | `		/* No more reference to this instance */` |
|    5741 | 1239 | `		PH7_ClassInstanceRelease(&(*pThis));` |
|    2868 | 1240 | `	}` |
|  143223 | 1241 | `}` |
|       - | 1242 | `/*` |
...
|       - | 1715 | ` */` |
|   11172 | 1716 | `PH7_PRIVATE ph7_value * PH7_ClassInstanceExtractAttrValue(ph7_class_instance *pThis,VmClassAttr *pAttr)` |
|       5 | 1717 | `{` |
|       - | 1718 | `   /* Extract the attribute value */` |
|       - | 1719 | `	ph7_value *pValue;` |
|   11177 | 1720 | `	pValue = ExtractClassAttrValue(pThis->pVm,pAttr);` |
|   11177 | 1721 | `	return pValue;` |
|       5 | 1722 | `}` |
|       - | 1723 | `/*` |
