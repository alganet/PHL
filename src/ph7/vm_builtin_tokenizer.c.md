...
|    ! 0 |  252 | `}` |
|      - |  253 |  |
|   3404 |  254 | `PH7_PRIVATE void PH7_RegisterTokenizerConstants(ph7_vm *pVm)` |
|      5 |  255 | `{` |
|      - |  256 | `	sxu32 n;` |
| 527625 |  257 | `	for( n = 0 ; n < SX_ARRAYSIZE(aTokConst) ; ++n ){` |
| 786329 |  258 | `		ph7_create_constant(&(*pVm),aTokConst[n].zName,TokConstExpand,` |
| 524216 |  259 | `			SX_INT_TO_PTR(aTokConst[n].iId));` |
| 262113 |  260 | `	}` |
|   3409 |  261 | `}` |
|      - |  262 |  |
