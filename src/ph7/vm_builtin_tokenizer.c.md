...
|    ! 0 |  252 | `}` |
|      - |  253 |  |
|   3412 |  254 | `PH7_PRIVATE void PH7_RegisterTokenizerConstants(ph7_vm *pVm)` |
|      5 |  255 | `{` |
|      - |  256 | `	sxu32 n;` |
| 528865 |  257 | `	for( n = 0 ; n < SX_ARRAYSIZE(aTokConst) ; ++n ){` |
| 788177 |  258 | `		ph7_create_constant(&(*pVm),aTokConst[n].zName,TokConstExpand,` |
| 525448 |  259 | `			SX_INT_TO_PTR(aTokConst[n].iId));` |
| 262729 |  260 | `	}` |
|   3417 |  261 | `}` |
|      - |  262 |  |
