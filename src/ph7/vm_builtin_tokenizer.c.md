...
|    ! 0 |  252 | `}` |
|      - |  253 |  |
|   3424 |  254 | `PH7_PRIVATE void PH7_RegisterTokenizerConstants(ph7_vm *pVm)` |
|      5 |  255 | `{` |
|      - |  256 | `	sxu32 n;` |
| 530725 |  257 | `	for( n = 0 ; n < SX_ARRAYSIZE(aTokConst) ; ++n ){` |
| 790949 |  258 | `		ph7_create_constant(&(*pVm),aTokConst[n].zName,TokConstExpand,` |
| 527296 |  259 | `			SX_INT_TO_PTR(aTokConst[n].iId));` |
| 263653 |  260 | `	}` |
|   3429 |  261 | `}` |
|      - |  262 |  |
...
|      - | 1328 | `};` |
|      - | 1329 |  |
|   3897 | 1330 | `PH7_PRIVATE sxi32 PH7_VmInstallTokenizer(ph7_vm *pVm){` |
|   3897 | 1331 | `	ph7_create_function(&(*pVm),"token_get_all",PH7_builtin_token_get_all,0);` |
|   3897 | 1332 | `	ph7_create_function(&(*pVm),"token_name",PH7_builtin_token_name,0);` |
|   3897 | 1333 | `	return PH7_VmEvalBuiltinChunk(&(*pVm),zPhpTokenClass,sizeof(zPhpTokenClass)-1);` |
|      5 | 1334 | `}` |
|      - | 1335 |  |
