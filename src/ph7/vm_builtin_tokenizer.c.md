...
|    ! 0 |  252 | `}` |
|      - |  253 |  |
|   3392 |  254 | `PH7_PRIVATE void PH7_RegisterTokenizerConstants(ph7_vm *pVm)` |
|      5 |  255 | `{` |
|      - |  256 | `	sxu32 n;` |
| 525765 |  257 | `	for( n = 0 ; n < SX_ARRAYSIZE(aTokConst) ; ++n ){` |
| 783557 |  258 | `		ph7_create_constant(&(*pVm),aTokConst[n].zName,TokConstExpand,` |
| 522368 |  259 | `			SX_INT_TO_PTR(aTokConst[n].iId));` |
| 261189 |  260 | `	}` |
|   3397 |  261 | `}` |
|      - |  262 |  |
