...
|        - |   18 | ` */` |
| 11532906 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|        5 |   20 | `{` |
|        - |   21 | `	SyString *pStr;` |
|        - |   22 | `	sxi32 rc;` |
|        - |   23 | `	/* Ignore leading white spaces */` |
| 17375139 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|        - |   25 | `		/* Advance the stream cursor */` |
|  5842233 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|        - |   27 | `			/* Update line counter */` |
|    41339 |   28 | `			pStream->nLine++;` |
|    20667 |   29 | `		}` |
|  5842233 |   30 | `		pStream->zText++;` |
|        5 |   31 | `	}` |
| 11532911 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|        - |   33 | `		/* End of input reached */` |
|      ! 0 |   34 | `		return SXERR_EOF;` |
|        - |   35 | `	}` |
|        - |   36 | `	/* Record token starting position and line */` |
| 11532911 |   37 | `	pToken->nLine = pStream->nLine;` |
| 11532911 |   38 | `	pToken->pUserData = 0;` |
| 11532911 |   39 | `	pStr = &pToken->sData;` |
| 11532911 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 13733317 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  4400817 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  4400801 |   53 | `			pStream->zText++;` |
|  2200398 |   54 | `		}` |
|  4339689 |   55 | `		for(;;){` |
|  8679383 |   56 | `			zIn = pStream->zText;` |
|  8679383 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|       49 |   58 | `				zIn++;` |
|        - |   59 | `				/* UTF-8 stream */` |
...
| 37454030 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 24434963 |   66 | `				zIn++;` |
|        5 |   67 | `			}` |
|  8679383 |   68 | `			if( zIn == pStream->zText ){` |
|        - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  4400817 |   70 | `				break;` |
|        - |   71 | `			}` |
|        - |   72 | `			/* Synchronize pointers */` |
|  4278571 |   73 | `			pStream->zText = zIn;` |
|        5 |   74 | `		}` |
|        - |   75 | `		/* Record token length */` |
|  4400817 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  4400817 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|        - |   81 | `		 */` |
|  4401394 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  1400937 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|      465 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|      230 |   85 | `		}` |
|  4400817 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  1609249 |   87 | `			if( nKeyword &` |
...
|  1585235 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  1585235 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|        - |   97 | `			}` |
|   804627 |   98 | `		}else{` |
|        - |   99 | `			/* A simple identifier */` |
|  2791573 |  100 | `			pToken->nType = PH7_TK_ID;` |
|        - |  101 | `		}` |
|  2200411 |  102 | `	}else{` |
|        - |  103 | `		sxi32 c;` |
|        - |  104 | `		/* Non-alpha stream */` |
|  7132099 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
|  7178667 |  170 | `		}else if( pStream->zText[0] == '#' \|\|` |
|  7132020 |  171 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
...
|  7126971 |  179 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
|    88143 |  180 | `			pStream->zText += 2;` |
|        - |  181 | `			/* Block comment */` |
|  2725025 |  182 | `			while( pStream->zText < pStream->zEnd ){` |
|  2725025 |  183 | `				if( pStream->zText[0] == '*' ){` |
|    88215 |  184 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    44074 |  185 | `						break;` |
|        - |  186 | `					}` |
|       36 |  187 | `				}` |
|  2636887 |  188 | `				if( pStream->zText[0] == '\n' ){` |
|       73 |  189 | `					pStream->nLine++;` |
|       34 |  190 | `				}` |
|  2636887 |  191 | `				pStream->zText++;` |
|        5 |  192 | `			}` |
|    88143 |  193 | `			pStream->zText += 2;` |
|        - |  194 | `			/* Tell the upper-layer to ignore this token */` |
|    88143 |  195 | `			return SXERR_CONTINUE;` |
|  7038833 |  196 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   129497 |  197 | `			pStream->zText++;` |
...
|   129572 |  201 | `			if( pStream->zText < pStream->zEnd` |
|   129492 |  202 | `				&& pStream->zText[0] == '_'` |
|    64826 |  203 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   141617 |  209 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
...
|   129497 |  220 | `			pToken->nType = PH7_TK_INTEGER;` |
|   129497 |  221 | `			if( pStream->zText < pStream->zEnd ){` |
|   129497 |  222 | `				c = pStream->zText[0];` |
|   129497 |  223 | `				if( c == '.' ){` |
...
|   129497 |  314 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   129497 |  322 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   129497 |  323 | `			return SXRET_OK;` |
|        - |  324 | `		}` |
|  6909341 |  325 | `		c = pStream->zText[0];` |
|  6909341 |  326 | `		pStream->zText++; /* Advance the stream cursor */` |
|        - |  327 | `		/* Assume we are dealing with an operator*/` |
|  6909341 |  328 | `		pToken->nType = PH7_TK_OP;` |
|  6909341 |  329 | `		switch(c){` |
|  1421515 |  330 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   587973 |  331 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   587959 |  332 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  1058577 |  333 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|    95417 |  334 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|        - |  335 | `														 * is a potential operator [i.e: subscripting] */` |
|    95423 |  336 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   529278 |  337 | `		case ')': {` |
|  1058561 |  338 | `			SySet *pTokSet = pStream->pSet;` |
|        - |  339 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  1058561 |  340 | `			if( pTokSet->nUsed >= 2 ){` |
|        - |  341 | `				SyToken *pTmp;` |
|        - |  342 | `				/* Peek the last recongnized token */` |
|  1058559 |  343 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  1058559 |  344 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|      170 |  374 | `				}` |
|   527303 |  375 | `			}` |
|  1054613 |  376 | `			pToken->nType = PH7_TK_RPAREN;` |
|  1054613 |  377 | `			break;` |
|        - |  378 | `				  }` |
|    51562 |  379 | `		case '\'':{` |
...
|    24235 |  413 | `			pStr->zString++;` |
|   204403 |  414 | `			while( pStream->zText < pStream->zEnd ){` |
|   204403 |  415 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|      113 |  416 | `					iNest = 1;` |
...
|        - |  435 | `					}` |
|       55 |  436 | `				}` |
|   204403 |  437 | `				if( pStream->zText[0] == '"' ){` |
|    24451 |  438 | `					if( pStream->zText[-1] != '\\' ){` |
|    24231 |  439 | `						break;` |
|      ! 0 |  440 | `					}else{` |
...
|        - |  450 | `					}` |
|      108 |  451 | `				}` |
|   180173 |  452 | `				if( pStream->zText[0] == '\n' ){` |
|       29 |  453 | `					pStream->nLine++;` |
|       14 |  454 | `				}` |
|   180173 |  455 | `				pStream->zText++;` |
|        5 |  456 | `			}` |
|        - |  457 | `			/* Record token length and type */` |
|    24235 |  458 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    24235 |  459 | `			pToken->nType = PH7_TK_DSTR;` |
|        - |  460 | `			/* Jump the trailing quote */` |
|    24235 |  461 | `			pStream->zText++;` |
|    24235 |  462 | `			return SXRET_OK;` |
|        - |  463 | `				  }` |
|        2 |  464 | ``		case '`':{`` |
...
|        - |  490 | `			}` |
|     3971 |  491 | `			break;` |
|   149875 |  492 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   816173 |  493 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|        - |  494 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   216205 |  495 | `		case '=':` |
|   432415 |  496 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   432415 |  497 | `			if( pStream->zText < pStream->zEnd ){` |
|   432415 |  498 | `				if( pStream->zText[0] == '=' ){` |
|    23795 |  499 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|        - |  500 | `					/* Current operator: == */` |
|    23795 |  501 | `					pStream->zText++;` |
|    23795 |  502 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  503 | `						/* Current operator: === */` |
|     5133 |  504 | `						pStream->zText++;` |
|     2569 |  505 | `					}` |
|   420520 |  506 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  507 | `					/* Array operator: => */` |
|     5935 |  508 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|     5935 |  509 | `					pStream->zText++;` |
|     2970 |  510 | `				}else{` |
|        - |  511 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   402695 |  512 | `					const unsigned char *zCur = pStream->zText;` |
|   402695 |  513 | `					sxu32 nLine = 0;` |
|   805217 |  514 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   402527 |  515 | `						if( zCur[0] == '\n' ){` |
|        5 |  516 | `							nLine++;` |
|        2 |  517 | `						}` |
|   402527 |  518 | `						zCur++;` |
|        5 |  519 | `					}` |
|   402695 |  520 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|    52149 |  540 | `			break;` |
|    14978 |  541 | `		case '&':` |
|    29961 |  542 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    29961 |  543 | `			if( pStream->zText < pStream->zEnd ){` |
|    29961 |  544 | `				if( pStream->zText[0] == '&' ){` |
|    11485 |  545 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|        - |  546 | `					/* Current operator: && */` |
|    11485 |  547 | `					pStream->zText++;` |
|    24221 |  548 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    19293 |  576 | `			break;` |
|    91487 |  577 | `		case '-':` |
|   182979 |  578 | `			if( pStream->zText < pStream->zEnd ){` |
|   182979 |  579 | `				if( pStream->zText[0] == '-' ){` |
|        - |  580 | `					/* Current operator: -- */` |
|       37 |  581 | `					pStream->zText++;` |
|   182962 |  582 | `				}else if( pStream->zText[0] == '=' ){` |
|        - |  583 | `					/* Current operator: -= */` |
|       10 |  584 | `					pStream->zText++;` |
|   182941 |  585 | `				}else if( pStream->zText[0] == '>' ){` |
...
|   107569 |  633 | `			break;` |
|    31442 |  634 | `		case '<':` |
|    62889 |  635 | `			if( pStream->zText < pStream->zEnd ){` |
|    62889 |  636 | `				if( pStream->zText[0] == '<' ){` |
...
|      ! 0 |  652 | `						}` |
|       12 |  653 | `					}` |
|    62764 |  654 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  655 | `					/* Current operator: <> */` |
|        5 |  656 | `					pStream->zText++;` |
|    62751 |  657 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    62775 |  666 | `			break;` |
|     3798 |  667 | `		case '>':` |
|     7601 |  668 | `			if( pStream->zText < pStream->zEnd ){` |
|     7601 |  669 | `				if( pStream->zText[0] == '>' ){` |
...
|        6 |  675 | `					}` |
|     7591 |  676 | `				}else if( pStream->zText[0] == '=' ){` |
...
|      230 |  697 | `			break;` |
|        - |  698 | `		}` |
|  6777921 |  699 | `		if( pStr->nByte <= 0 ){` |
|        - |  700 | `			/* Record token length */` |
|  6777867 |  701 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  3388931 |  702 | `		}` |
|  6777921 |  703 | `		if( pToken->nType & PH7_TK_OP ){` |
|        - |  704 | `			const ph7_expr_op *pOp;` |
|        - |  705 | `			/* Check if the extracted token is an operator */` |
|  1134685 |  706 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  1134685 |  707 | `			if( pOp == 0 ){` |
|        - |  708 | `				/* Not an operator */` |
...
|        - |  739 | `*/` |
|        - |  740 | `/* Hash score: 103 */` |
|  4400817 |  741 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|        - |  829 | `  };` |
|        - |  830 | `  int h, i;` |
|  4400817 |  831 | `  if( n<2 ) return PH7_TK_ID;` |
|  4278549 |  832 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  6425071 |  833 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  3754799 |  834 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|        - |  917 | `       /* PH7_TKWRD_OR */` |
|        - |  918 | `       /* PH7_TKWRD_BREAK */` |
|  1608277 |  919 | `      return aCode[i];` |
|        - |  920 | `    }` |
|  1073264 |  921 | `  }` |
|        - |  922 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  2670277 |  923 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  2670211 |  924 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  2670207 |  925 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  2670075 |  926 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  2669839 |  927 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  2669765 |  928 | `  return PH7_TK_ID;` |
|  2200411 |  929 | `}` |
...
|        - | 1098 | ` */` |
|    16812 | 1099 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut)` |
|        5 | 1100 | `{` |
|        - | 1101 | `	SyLex sLexer;` |
|        - | 1102 | `	sxi32 rc;` |
|        - | 1103 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|    16817 | 1104 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
|      ! 0 | 1105 | `		return SXERR_LIMIT;` |
|        - | 1106 | `	}` |
|        - | 1107 | `	/* Initialize the lexer */` |
|    16817 | 1108 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,0);` |
|    16817 | 1109 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1110 | `		return rc;` |
|        - | 1111 | `	}` |
|    16817 | 1112 | `	sLexer.sStream.nLine = nLineStart;` |
|        - | 1113 | `	/* Tokenize input */` |
|    16817 | 1114 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|        - | 1115 | `	/* Release the lexer */` |
|    16817 | 1116 | `	SyLexRelease(&sLexer);` |
|        - | 1117 | `	/* Tokenization result */` |
|    16817 | 1118 | `	return rc;` |
|     8411 | 1119 | `}` |
|        - | 1120 | `/*` |
...
|        - | 1164 | ` */` |
|    13758 | 1165 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|        5 | 1166 | `{` |
|    13763 | 1167 | `	const char *zEnd = &zInput[nLen];` |
|    13763 | 1168 | `	const char *zIn  = zInput;` |
|        - | 1169 | `	const char *zCur,*zCurEnd;` |
|    13763 | 1170 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|        - | 1171 | `	SyToken sToken;` |
|        - | 1172 | `	SyString sDoc;` |
|        - | 1173 | `	sxu32 nLine;` |
|        - | 1174 | `	sxi32 iNest;` |
...
|    13763 | 1177 | `	nLine = 1;` |
|    13763 | 1178 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|    13763 | 1179 | `	sToken.pUserData = 0;` |
|    13763 | 1180 | `	iNest = 0;` |
|    13763 | 1181 | `	sDoc.nByte = 0;` |
|    13763 | 1182 | `	sDoc.zString = ""; /* cc warning */` |
|    13760 | 1183 | `	for(;;){` |
|    27525 | 1184 | `		if( zIn >= zEnd ){` |
|        - | 1185 | `			/* End of input reached */` |
|    13713 | 1186 | `			break;` |
|        - | 1187 | `		}` |
|    13817 | 1188 | `		sToken.nLine = nLine;` |
|    13817 | 1189 | `		zCur = zIn;` |
|    13817 | 1190 | `		zCurEnd = 0;` |
|    13871 | 1191 | `		while( zIn < zEnd ){` |
|    13821 | 1192 | `			 if( zIn[0] == '<' ){` |
|    13767 | 1193 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|    13767 | 1194 | `				zIn++;` |
|    13767 | 1195 | `				if( zIn < zEnd ){` |
|    13767 | 1196 | `					if( zIn[0] == '?' ){` |
|    13767 | 1197 | `						zIn++;` |
|    13767 | 1198 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|        - | 1199 | `							/* opening tag: <?php */` |
|    13765 | 1200 | `							zIn += sizeof("php")-1;` |
|     6880 | 1201 | `						}` |
|        - | 1202 | `						/* Look for the closing tag '?>' */` |
|    13767 | 1203 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|    13767 | 1204 | `						zCurEnd = zTmp;` |
|    13767 | 1205 | `						break;` |
|        - | 1206 | `					}` |
|      ! 0 | 1207 | `				}` |
|      ! 0 | 1208 | `			}else{` |
...
|    13817 | 1215 | `		if( zCurEnd == 0 ){` |
|       54 | 1216 | `			zCurEnd = zIn;` |
|       25 | 1217 | `		}` |
|        - | 1218 | `		/* Save the raw token */` |
|    13817 | 1219 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|    13817 | 1220 | `		sToken.nType = PH7_TOKEN_RAW;` |
|    13817 | 1221 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    13817 | 1222 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 1223 | `			return rc;` |
|        - | 1224 | `		}` |
|    13817 | 1225 | `		if( zIn >= zEnd ){` |
|       54 | 1226 | `			break;` |
|        - | 1227 | `		}` |
|        - | 1228 | `		/* Ignore leading white space */` |
|    29557 | 1229 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|    15795 | 1230 | `			if( zIn[0] == '\n' ){` |
|    14505 | 1231 | `				nLine++;` |
|     7250 | 1232 | `			}` |
|    15795 | 1233 | `			zIn++;` |
...
|    13767 | 1236 | `		sToken.nLine = nLine;` |
|    13767 | 1237 | `		zCur = zIn;` |
|  1429247 | 1238 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|        - | 1239 | `			const char *zPtr;` |
|  1423237 | 1240 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|     7755 | 1241 | `				break;` |
|        - | 1242 | `			}` |
|   710399 | 1243 | `			for(;;){` |
|  1420803 | 1244 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|   707746 | 1245 | `					break;` |
|        - | 1246 | `				}` |
|     5321 | 1247 | `				zIn += 2;` |
|     5321 | 1248 | `				if( zIn[-1] == '/' ){` |
...
|     2562 | 1256 | `				}else{` |
|        - | 1257 | `					/* Block comment */` |
|    13665 | 1258 | `					while( (sxu32)(zEnd-zIn) >= sizeof("*/") - 1 ){` |
|    13665 | 1259 | `						if( zIn[0] == '*' && zIn[1] == '/' ){` |
|      207 | 1260 | `							zIn += 2;` |
|      207 | 1261 | `							break;` |
|        - | 1262 | `						}` |
|    13463 | 1263 | `						if( zIn[0] == '\n' ){` |
...
|        - | 1268 | `				}` |
|        5 | 1269 | `			}` |
|  1415487 | 1270 | `			if( zIn[0] == '\n' ){` |
|    48263 | 1271 | `				nLine++;` |
|    48263 | 1272 | `				if( iNest > 0 ){` |
|      321 | 1273 | `					zIn++;` |
...
|      321 | 1292 | `					continue;` |
|        5 | 1293 | `				}` |
|  1391200 | 1294 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|  1415057 | 1321 | `			zIn++;` |
|        - | 1322 |  |
|  1415057 | 1323 | `			if ( zIn >= zEnd )` |
|        3 | 1324 | `				break;` |
|        5 | 1325 | `		}` |
|    13767 | 1326 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|     6017 | 1327 | `			zIn = zEnd;` |
|     3006 | 1328 | `		}` |
|    13767 | 1329 | `		if( zCur < zIn ){` |
|        - | 1330 | `			/* Save the PHP chunk for later processing */` |
|    10747 | 1331 | `			sToken.nType = PH7_TOKEN_PHP;` |
|    10747 | 1332 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|    21417 | 1333 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|    10747 | 1334 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    10747 | 1335 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1336 | `				return rc;` |
|        - | 1337 | `			}` |
|     5371 | 1338 | `		}` |
|    13767 | 1339 | `		if( zIn < zEnd ){` |
|        - | 1340 | `			/* Jump the trailing closing tag */` |
|     7755 | 1341 | `			zIn += sCtag.nByte;` |
|     3875 | 1342 | `		}` |
|        5 | 1343 | `	} /* For(;;) */` |
|        - | 1344 |  |
|    13763 | 1345 | ` 	return SXRET_OK;` |
|     6884 | 1346 | `}` |
|        - | 1347 |  |
