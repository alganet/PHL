...
|         - |   18 | ` */` |
| 158322888 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 233627197 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  75304309 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     52745 |   28 | `			pStream->nLine++;` |
|     26370 |   29 | `		}` |
|  75304309 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 158322893 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 158322893 |   37 | `	pToken->nLine = pStream->nLine;` |
| 158322893 |   38 | `	pToken->pUserData = 0;` |
| 158322893 |   39 | `	pStr = &pToken->sData;` |
| 158322893 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 184665492 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  52685203 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  52685187 |   53 | `			pStream->zText++;` |
|  26342591 |   54 | `		}` |
|  49328595 |   55 | `		for(;;){` |
|  98657195 |   56 | `			zIn = pStream->zText;` |
|  98657195 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 393155198 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 245169413 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
|  98657195 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  52685203 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  45971997 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  52685203 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  52685203 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  52685198 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  18122276 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       807 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       401 |   85 | `		}` |
|  52685203 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  17551887 |   87 | `			if( nKeyword &` |
...
|  16671739 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  16671739 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   8775946 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  35133321 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  26342604 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 105637695 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 105730747 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 105629908 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
...
| 105623021 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
| 105432171 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3359701 |  234 | `			pStream->zText++;` |
...
|   3359696 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3359696 |  239 | `				&& pStream->zText[0] == '_'` |
|   1679928 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4193589 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    833893 |  247 | `				pStream->zText++;` |
|    833888 |  248 | `				if( pStream->zText < pStream->zEnd` |
|    833888 |  249 | `					&& pStream->zText[0] == '_'` |
|    417030 |  250 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   3359701 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3359701 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3359701 |  259 | `				c = pStream->zText[0];` |
|   3359701 |  260 | `				if( c == '.' ){` |
...
|   3359701 |  351 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3359701 |  359 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3359701 |  360 | `			return SXRET_OK;` |
|         - |  361 | `		}` |
| 102072475 |  362 | `		c = pStream->zText[0];` |
| 102072475 |  363 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  364 | `		/* Assume we are dealing with an operator*/` |
| 102072475 |  365 | `		pToken->nType = PH7_TK_OP;` |
| 102072475 |  366 | `		switch(c){` |
|  21066395 |  367 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   6290511 |  368 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   6290497 |  369 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  13136921 |  370 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|   3032205 |  371 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|         - |  372 | `														 * is a potential operator [i.e: subscripting] */` |
|   3032211 |  373 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   6568446 |  374 | `		case ')': {` |
|  13136897 |  375 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  376 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  13136897 |  377 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  378 | `				SyToken *pTmp;` |
|         - |  379 | `				/* Peek the last recongnized token */` |
|  13136895 |  380 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  13136895 |  381 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|    213660 |  411 | `				}` |
|   6303314 |  412 | `			}` |
|  12606635 |  413 | `			pToken->nType = PH7_TK_RPAREN;` |
|  12606635 |  414 | `			break;` |
|         - |  415 | `				  }` |
|   2396488 |  416 | `		case '\'':{` |
...
|    119267 |  450 | `			pStr->zString++;` |
|   1699581 |  451 | `			while( pStream->zText < pStream->zEnd ){` |
|   1699581 |  452 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       113 |  453 | `					iNest = 1;` |
...
|         - |  472 | `					}` |
|        55 |  473 | `				}` |
|   1699581 |  474 | `				if( pStream->zText[0] == '"' ){` |
|    119545 |  475 | `					if( pStream->zText[-1] != '\\' ){` |
|    119261 |  476 | `						break;` |
|       ! 0 |  477 | `					}else{` |
...
|         - |  487 | `					}` |
|       139 |  488 | `				}` |
|   1580319 |  489 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  490 | `					pStream->nLine++;` |
|        14 |  491 | `				}` |
|   1580319 |  492 | `				pStream->zText++;` |
|         5 |  493 | `			}` |
|         - |  494 | `			/* Record token length and type */` |
|    119267 |  495 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    119267 |  496 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  497 | `			/* Jump the trailing quote */` |
|    119267 |  498 | `			pStream->zText++;` |
|    119267 |  499 | `			return SXRET_OK;` |
|         - |  500 | `				  }` |
|         2 |  501 | ``		case '`':{`` |
...
|    402980 |  521 | `		case ':':` |
|    805965 |  522 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|         - |  523 | `				/* Current operator: '::' */` |
|    359231 |  524 | `				pStream->zText++;` |
|    179618 |  525 | `			}else{` |
|    446739 |  526 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|         - |  527 | `			}` |
|    805965 |  528 | `			break;` |
|   3494297 |  529 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   9901875 |  530 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  531 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   3514019 |  532 | `		case '=':` |
|   7028043 |  533 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   7028043 |  534 | `			if( pStream->zText < pStream->zEnd ){` |
|   7028043 |  535 | `				if( pStream->zText[0] == '=' ){` |
...
|    587747 |  542 | `					}` |
|   6415345 |  543 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  544 | `					/* Array operator: => */` |
|    426227 |  545 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    426227 |  546 | `					pStream->zText++;` |
|    213116 |  547 | `				}else{` |
|         - |  548 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   5376425 |  549 | `					const unsigned char *zCur = pStream->zText;` |
|   5376425 |  550 | `					sxu32 nLine = 0;` |
|  10752681 |  551 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   5376261 |  552 | `						if( zCur[0] == '\n' ){` |
|         5 |  553 | `							nLine++;` |
|         2 |  554 | `						}` |
|   5376261 |  555 | `						zCur++;` |
|         5 |  556 | `					}` |
|   5376425 |  557 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|        23 |  663 | `			break;` |
|    957460 |  664 | `		case '.':` |
|   1914925 |  665 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|         - |  666 | `				/* Ellipsis: ... */` |
|     27127 |  667 | `				pStream->zText += 2;` |
|     27127 |  668 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|   1901364 |  669 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
...
|     11684 |  737 | `			break;` |
|         - |  738 | `		}` |
|  96629853 |  739 | `		if( pStr->nByte <= 0 ){` |
|         - |  740 | `			/* Record token length */` |
|  96629791 |  741 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  48314893 |  742 | `		}` |
|  96629853 |  743 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  744 | `			const ph7_expr_op *pOp;` |
|         - |  745 | `			/* Check if the extracted token is an operator */` |
|  23396263 |  746 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  23396263 |  747 | `			if( pOp == 0 ){` |
|         - |  748 | `				/* Not an operator */` |
...
|         - |  779 | `*/` |
|         - |  780 | `/* Hash score: 103 */` |
|  52685203 |  781 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  869 | `  };` |
|         - |  870 | `  int h, i;` |
|  52685203 |  871 | `  if( n<2 ) return PH7_TK_ID;` |
|  45971975 |  872 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  71028739 |  873 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  42599555 |  874 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  957 | `       /* PH7_TKWRD_OR */` |
|         - |  958 | `       /* PH7_TKWRD_BREAK */` |
|  17542791 |  959 | `      return aCode[i];` |
|         - |  960 | `    }` |
|  12528385 |  961 | `  }` |
|         - |  962 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  28429189 |  963 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  28421485 |  964 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  28421481 |  965 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  28421309 |  966 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  28405673 |  967 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  28405597 |  968 | `  return PH7_TK_ID;` |
|  26342604 |  969 | `}` |
...
|         - | 1206 | ` */` |
|     13254 | 1207 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|         5 | 1208 | `{` |
|     13259 | 1209 | `	const char *zEnd = &zInput[nLen];` |
|     13259 | 1210 | `	const char *zIn  = zInput;` |
|         - | 1211 | `	const char *zCur,*zCurEnd;` |
|     13259 | 1212 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1213 | `	SyToken sToken;` |
|         - | 1214 | `	SyString sDoc;` |
|         - | 1215 | `	sxu32 nLine;` |
|         - | 1216 | `	sxi32 iNest;` |
...
|     13259 | 1219 | `	nLine = 1;` |
|     13259 | 1220 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13259 | 1221 | `	sToken.pUserData = 0;` |
|     13259 | 1222 | `	iNest = 0;` |
|     13259 | 1223 | `	sDoc.nByte = 0;` |
|     13259 | 1224 | `	sDoc.zString = ""; /* cc warning */` |
|     13254 | 1225 | `	for(;;){` |
|     26513 | 1226 | `		if( zIn >= zEnd ){` |
|         - | 1227 | `			/* End of input reached */` |
|     13249 | 1228 | `			break;` |
|         - | 1229 | `		}` |
|     13269 | 1230 | `		sToken.nLine = nLine;` |
|     13269 | 1231 | `		zCur = zIn;` |
|     13269 | 1232 | `		zCurEnd = 0;` |
|     13461 | 1233 | `		while( zIn < zEnd ){` |
|     13451 | 1234 | `			 if( zIn[0] == '<' ){` |
|     13259 | 1235 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     13259 | 1236 | `				zIn++;` |
|     13259 | 1237 | `				if( zIn < zEnd ){` |
|     13259 | 1238 | `					if( zIn[0] == '?' ){` |
|     13259 | 1239 | `						zIn++;` |
|     13259 | 1240 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1241 | `							/* opening tag: <?php */` |
|     13257 | 1242 | `							zIn += sizeof("php")-1;` |
|      6626 | 1243 | `						}` |
|         - | 1244 | `						/* Look for the closing tag '?>' */` |
|     13259 | 1245 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     13259 | 1246 | `						zCurEnd = zTmp;` |
|     13259 | 1247 | `						break;` |
|         - | 1248 | `					}` |
|       ! 0 | 1249 | `				}` |
|       ! 0 | 1250 | `			}else{` |
...
|     13269 | 1257 | `		if( zCurEnd == 0 ){` |
|        13 | 1258 | `			zCurEnd = zIn;` |
|         5 | 1259 | `		}` |
|         - | 1260 | `		/* Save the raw token */` |
|     13269 | 1261 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13269 | 1262 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13269 | 1263 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13269 | 1264 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1265 | `			return rc;` |
|         - | 1266 | `		}` |
|     13269 | 1267 | `		if( zIn >= zEnd ){` |
|        13 | 1268 | `			break;` |
|         - | 1269 | `		}` |
|         - | 1270 | `		/* Ignore leading white space */` |
|     28251 | 1271 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     14997 | 1272 | `			if( zIn[0] == '\n' ){` |
|     14555 | 1273 | `				nLine++;` |
|      7275 | 1274 | `			}` |
|     14997 | 1275 | `			zIn++;` |
...
|     13259 | 1278 | `		sToken.nLine = nLine;` |
|     13259 | 1279 | `		zCur = zIn;` |
|   1800531 | 1280 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1281 | `			const char *zPtr;` |
|   1794437 | 1282 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7161 | 1283 | `				break;` |
|         - | 1284 | `			}` |
|    897258 | 1285 | `			for(;;){` |
|   1794521 | 1286 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|    893643 | 1287 | `					break;` |
|         - | 1288 | `				}` |
|      7245 | 1289 | `				zIn += 2;` |
|      7245 | 1290 | `				if( zIn[-1] == '/' ){` |
...
|         - | 1310 | `				}` |
|         5 | 1311 | `			}` |
|   1787281 | 1312 | `			if( zIn[0] == '\n' ){` |
|     59917 | 1313 | `				nLine++;` |
|     59917 | 1314 | `				if( iNest > 0 ){` |
|       328 | 1315 | `					zIn++;` |
...
|       328 | 1334 | `					continue;` |
|         5 | 1335 | `				}` |
|   1757163 | 1336 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1786839 | 1363 | `			zIn++;` |
|         - | 1364 |  |
|   1786839 | 1365 | `			if ( zIn >= zEnd )` |
|         5 | 1366 | `				break;` |
|         5 | 1367 | `		}` |
|     13259 | 1368 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6103 | 1369 | `			zIn = zEnd;` |
|      3049 | 1370 | `		}` |
|     13259 | 1371 | `		if( zCur < zIn ){` |
