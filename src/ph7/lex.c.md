...
|         - |   18 | ` */` |
| 174300280 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 257571359 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  83271079 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     55483 |   28 | `			pStream->nLine++;` |
|     27739 |   29 | `		}` |
|  83271079 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 174300285 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 174300285 |   37 | `	pToken->nLine = pStream->nLine;` |
| 174300285 |   38 | `	pToken->pUserData = 0;` |
| 174300285 |   39 | `	pStr = &pToken->sData;` |
| 174300285 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 203335697 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  58070829 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  58070813 |   53 | `			pStream->zText++;` |
|  29035404 |   54 | `		}` |
|  54436858 |   55 | `		for(;;){` |
| 108873721 |   56 | `			zIn = pStream->zText;` |
| 108873721 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 433449903 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 270139329 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
| 108873721 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  58070829 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  50802897 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  58070829 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  58070829 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  58070824 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  20033584 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       847 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       421 |   85 | `		}` |
|  58070829 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  19357417 |   87 | `			if( nKeyword &` |
...
|    924159 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|         - |   91 | `					/* Mark as an operator */` |
|    924159 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|    462082 |   93 | `			}else{` |
|         - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  18433263 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  18433263 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   9678711 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  38713417 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  29035417 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 116229461 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 116336076 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 116221518 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|      7309 |  188 | `				pStream->zText++;` |
|         - |  189 | `				/* Inline comments */` |
|    314333 |  190 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|    307029 |  191 | `					pStream->zText++;` |
|         5 |  192 | `				}` |
|         - |  193 | `				/* Tell the upper-layer to ignore this token */` |
|      7309 |  194 | `				return SXERR_CONTINUE;` |
| 116214225 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
| 115996415 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3775043 |  234 | `			pStream->zText++;` |
...
|   3775038 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3775038 |  239 | `				&& pStream->zText[0] == '_'` |
|   1887599 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4756561 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    981523 |  247 | `				pStream->zText++;` |
|    981518 |  248 | `				if( pStream->zText < pStream->zEnd` |
|    981518 |  249 | `					&& pStream->zText[0] == '_'` |
|    490845 |  250 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   3775043 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3775043 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3775043 |  259 | `				c = pStream->zText[0];` |
|   3775043 |  260 | `				if( c == '.' ){` |
...
|   3775043 |  363 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3775043 |  371 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3775043 |  372 | `			return SXRET_OK;` |
|         - |  373 | `		}` |
| 112221377 |  374 | `		c = pStream->zText[0];` |
| 112221377 |  375 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  376 | `		/* Assume we are dealing with an operator*/` |
| 112221377 |  377 | `		pToken->nType = PH7_TK_OP;` |
| 112221377 |  378 | `		switch(c){` |
|  23155131 |  379 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   6879763 |  380 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   6879749 |  381 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  14411999 |  382 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|   3206447 |  383 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|         - |  384 | `														 * is a potential operator [i.e: subscripting] */` |
|   3206453 |  385 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   7205985 |  386 | `		case ')': {` |
|  14411975 |  387 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  388 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  14411975 |  389 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  390 | `				SyToken *pTmp;` |
|         - |  391 | `				/* Peek the last recongnized token */` |
|  14411973 |  392 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  14411973 |  393 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|   1045607 |  394 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|   1045607 |  395 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|    932667 |  396 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|    932667 |  397 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|         - |  398 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    610209 |  399 | `							const char * zTypeCast = "(int)";` |
|    610209 |  400 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|     31099 |  401 | `								zTypeCast = "(float)";` |
|    594662 |  402 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|      3925 |  403 | `								zTypeCast = "(bool)";` |
|    577155 |  404 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|    256427 |  405 | `								zTypeCast = "(string)";` |
|    446984 |  406 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|        29 |  407 | `								zTypeCast = "(array)";` |
|    318759 |  408 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|        35 |  409 | `								zTypeCast = "(object)";` |
|    318728 |  410 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|         3 |  411 | `								zTypeCast = "(unset)";` |
|         1 |  412 | `							}` |
|         - |  413 | `							/* Reflect the change */` |
|    610209 |  414 | `							pToken->nType = PH7_TK_OP;` |
|    610209 |  415 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|         - |  416 | `							/* Save the instance associated with the type cast operator */` |
|    610209 |  417 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|         - |  418 | `							/* Remove the two previous tokens */` |
|    610209 |  419 | `							pTokSet->nUsed -= 2;` |
|    610209 |  420 | `							return SXRET_OK;` |
|         - |  421 | `						}` |
|    161229 |  422 | `					}` |
|    217699 |  423 | `				}` |
|   6900882 |  424 | `			}` |
|  13801771 |  425 | `			pToken->nType = PH7_TK_RPAREN;` |
|  13801771 |  426 | `			break;` |
|         - |  427 | `				  }` |
|   2661528 |  428 | `		case '\'':{` |
|         - |  429 | `			/* Single quoted string */` |
|   5323061 |  430 | `			pStr->zString++;` |
|  60849547 |  431 | `			while( pStream->zText < pStream->zEnd ){` |
|  60849547 |  432 | `				if( pStream->zText[0] == '\''  ){` |
|   5323075 |  433 | `					if( pStream->zText[-1] != '\\' ){` |
|   5288069 |  434 | `						break;` |
|       ! 0 |  435 | `					}else{` |
...
|         - |  445 | `					}` |
|         7 |  446 | `				}` |
|  55526491 |  447 | `				if( pStream->zText[0] == '\n' ){` |
|        67 |  448 | `					pStream->nLine++;` |
|        33 |  449 | `				}` |
|  55526491 |  450 | `				pStream->zText++;` |
|         5 |  451 | `			}` |
|         - |  452 | `			/* Record token length and type */` |
|   5323061 |  453 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   5323061 |  454 | `			pToken->nType = PH7_TK_SSTR;` |
|         - |  455 | `			/* Jump the trailing single quote */` |
|   5323061 |  456 | `			pStream->zText++;` |
|   5323061 |  457 | `			return SXRET_OK;` |
|         - |  458 | `				  }` |
|     63143 |  459 | `		case '"':{` |
|         - |  460 | `			sxi32 iNest;` |
|         - |  461 | `			/* Double quoted string */` |
|    126291 |  462 | `			pStr->zString++;` |
|   1749979 |  463 | `			while( pStream->zText < pStream->zEnd ){` |
|   1749979 |  464 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       145 |  465 | `					iNest = 1;` |
...
|         - |  484 | `					}` |
|        71 |  485 | `				}` |
|   1749979 |  486 | `				if( pStream->zText[0] == '"' ){` |
|    126585 |  487 | `					if( pStream->zText[-1] != '\\' ){` |
|    126283 |  488 | `						break;` |
|       ! 0 |  489 | `					}else{` |
...
|         - |  499 | `					}` |
|       147 |  500 | `				}` |
|   1623693 |  501 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  502 | `					pStream->nLine++;` |
|        14 |  503 | `				}` |
|   1623693 |  504 | `				pStream->zText++;` |
|         5 |  505 | `			}` |
|         - |  506 | `			/* Record token length and type */` |
|    126291 |  507 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    126291 |  508 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  509 | `			/* Jump the trailing quote */` |
|    126291 |  510 | `			pStream->zText++;` |
|    126291 |  511 | `			return SXRET_OK;` |
|         - |  512 | `				  }` |
|         2 |  513 | ``		case '`':{`` |
...
|    490366 |  533 | `		case ':':` |
|    980737 |  534 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|         - |  535 | `				/* Current operator: '::' */` |
|    412765 |  536 | `				pStream->zText++;` |
|    206385 |  537 | `			}else{` |
|    567977 |  538 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|         - |  539 | `			}` |
|    980737 |  540 | `			break;` |
|   3866695 |  541 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|  10925211 |  542 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  543 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   3914734 |  544 | `		case '=':` |
|   7829473 |  545 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   7829473 |  546 | `			if( pStream->zText < pStream->zEnd ){` |
|   7829473 |  547 | `				if( pStream->zText[0] == '=' ){` |
|   1368987 |  548 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|         - |  549 | `					/* Current operator: == */` |
|   1368987 |  550 | `					pStream->zText++;` |
|   1368987 |  551 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  552 | `						/* Current operator: === */` |
|   1318133 |  553 | `						pStream->zText++;` |
|    659069 |  554 | `					}` |
|   7144982 |  555 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  556 | `					/* Array operator: => */` |
|    531485 |  557 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    531485 |  558 | `					pStream->zText++;` |
|    265745 |  559 | `				}else{` |
|         - |  560 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   5929011 |  561 | `					const unsigned char *zCur = pStream->zText;` |
|   5929011 |  562 | `					sxu32 nLine = 0;` |
|  11857853 |  563 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   5928847 |  564 | `						if( zCur[0] == '\n' ){` |
|         5 |  565 | `							nLine++;` |
|         2 |  566 | `						}` |
|   5928847 |  567 | `						zCur++;` |
|         5 |  568 | `					}` |
|   5929011 |  569 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   7829473 |  579 | `			break;` |
|    437368 |  580 | `		case '!':` |
|    874741 |  581 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  582 | `				/* Current operator: != */` |
|    427467 |  583 | `				pStream->zText++;` |
|    427467 |  584 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  585 | `					/* Current operator: !== */` |
|    411901 |  586 | `					pStream->zText++;` |
|    205948 |  587 | `				}` |
|    213731 |  588 | `			}` |
|    874741 |  589 | `			break;` |
|    338302 |  590 | `		case '&':` |
|    676609 |  591 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    676609 |  592 | `			if( pStream->zText < pStream->zEnd ){` |
|    676609 |  593 | `				if( pStream->zText[0] == '&' ){` |
|    447171 |  594 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|         - |  595 | `					/* Current operator: && */` |
|    447171 |  596 | `					pStream->zText++;` |
|    453026 |  597 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    676609 |  603 | `			break;` |
|    198289 |  604 | `		case '\|':` |
|    396583 |  605 | `			if( pStream->zText < pStream->zEnd ){` |
|    396583 |  606 | `				if( pStream->zText[0] == '\|' ){` |
|         - |  607 | `					/* Current operator: \|\| */` |
|    322527 |  608 | `					pStream->zText++;` |
|    235322 |  609 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    396583 |  617 | `			break;` |
|    223949 |  618 | `		case '+':` |
|    447903 |  619 | `			if( pStream->zText < pStream->zEnd ){` |
|    447901 |  620 | `				if( pStream->zText[0] == '+' ){` |
|         - |  621 | `					/* Current operator: ++ */` |
|    179131 |  622 | `					pStream->zText++;` |
|    358338 |  623 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    447903 |  628 | `			break;` |
|   2642894 |  629 | `		case '-':` |
|   5285793 |  630 | `			if( pStream->zText < pStream->zEnd ){` |
|   5285793 |  631 | `				if( pStream->zText[0] == '-' ){` |
|         - |  632 | `					/* Current operator: -- */` |
|     31119 |  633 | `					pStream->zText++;` |
|   5270236 |  634 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  635 | `					/* Current operator: -= */` |
|        14 |  636 | `					pStream->zText++;` |
|   5254673 |  637 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  638 | `					/* Current operator: -> */` |
|   5012973 |  639 | `					pStream->zText++;` |
|   2506484 |  640 | `				}` |
|   2642894 |  641 | `			}` |
|   5285793 |  642 | `			break;` |
|     19633 |  643 | `		case '*':` |
...
|        23 |  675 | `			break;` |
|    998905 |  676 | `		case '.':` |
|   1997815 |  677 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|         - |  678 | `				/* Ellipsis: ... */` |
|     27655 |  679 | `				pStream->zText += 2;` |
|     27655 |  680 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|   1983990 |  681 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  682 | `				/* Current operator: .= */` |
|    338073 |  683 | `				pStream->zText++;` |
|    169034 |  684 | `			}` |
|   1997815 |  685 | `			break;` |
|    194544 |  686 | `		case '<':` |
|    389093 |  687 | `			if( pStream->zText < pStream->zEnd ){` |
|    389093 |  688 | `				if( pStream->zText[0] == '<' ){` |
...
|       ! 0 |  704 | `						}` |
|        12 |  705 | `					}` |
|    388960 |  706 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  707 | `					/* Current operator: <> */` |
|         5 |  708 | `					pStream->zText++;` |
|    388947 |  709 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  710 | `					/* Current operator: <= or <=> */` |
|     66173 |  711 | `					pStream->zText++;` |
|     66173 |  712 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '>' ){` |
|         - |  713 | `						/* Current operator: <=> */` |
|     27269 |  714 | `						pStream->zText++;` |
|     13632 |  715 | `					}` |
|     33084 |  716 | `				}` |
|    194483 |  717 | `			}` |
|    388971 |  718 | `			break;` |
|    153575 |  719 | `		case '>':` |
|    307155 |  720 | `			if( pStream->zText < pStream->zEnd ){` |
|    307155 |  721 | `				if( pStream->zText[0] == '>' ){` |
...
|        10 |  727 | `					}` |
|    297435 |  728 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    307155 |  733 | `			break;` |
|    269938 |  734 | `		case '?':` |
|    539881 |  735 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '?' ){` |
...
|        48 |  741 | `				}` |
|    510620 |  742 | `			}else if( (pStream->zEnd - pStream->zText) >= 2` |
|    481359 |  743 | `				&& pStream->zText[0] == '-' && pStream->zText[1] == '>' ){` |
...
|     15836 |  749 | `			break;` |
|         - |  750 | `		}` |
| 106161705 |  751 | `		if( pStr->nByte <= 0 ){` |
|         - |  752 | `			/* Record token length */` |
| 106161633 |  753 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  53080814 |  754 | `		}` |
| 106161705 |  755 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  756 | `			const ph7_expr_op *pOp;` |
|         - |  757 | `			/* Check if the extracted token is an operator */` |
|  25765807 |  758 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  25765807 |  759 | `			if( pOp == 0 ){` |
|         - |  760 | `				/* Not an operator */` |
...
|         - |  791 | `*/` |
|         - |  792 | `/* Hash score: 103 */` |
|  58070829 |  793 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  881 | `  };` |
|         - |  882 | `  int h, i;` |
|  58070829 |  883 | `  if( n<2 ) return PH7_TK_ID;` |
|  50802875 |  884 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  78331611 |  885 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  46876853 |  886 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  969 | `       /* PH7_TKWRD_OR */` |
|         - |  970 | `       /* PH7_TKWRD_BREAK */` |
|  19348117 |  971 | `      return aCode[i];` |
|         - |  972 | `    }` |
|  13764371 |  973 | `  }` |
|         - |  974 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  31454763 |  975 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  31446899 |  976 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  31446895 |  977 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  31446723 |  978 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  31430797 |  979 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  31430719 |  980 | `  return PH7_TK_ID;` |
|  29035417 |  981 | `}` |
...
|         - | 1150 | ` */` |
|     87196 | 1151 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut,SySet *pTrivia)` |
|         5 | 1152 | `{` |
|         - | 1153 | `	SyLex sLexer;` |
|         - | 1154 | `	sxi32 rc;` |
|         - | 1155 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|     87201 | 1156 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
...
|     87201 | 1162 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,pTrivia);` |
|     87201 | 1163 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1164 | `		return rc;` |
|         - | 1165 | `	}` |
|     87201 | 1166 | `	sLexer.sStream.nLine = nLineStart;` |
|         - | 1167 | `	/* Tokenize input */` |
|     87201 | 1168 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|         - | 1169 | `	/* Release the lexer */` |
|     87201 | 1170 | `	SyLexRelease(&sLexer);` |
|         - | 1171 | `	/* Tokenization result */` |
|     87201 | 1172 | `	return rc;` |
|     43603 | 1173 | `}` |
|         - | 1174 | `/*` |
...
|         - | 1218 | ` */` |
|     13756 | 1219 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut,sxu32 nBaseLine)` |
|         5 | 1220 | `{` |
|     13761 | 1221 | `	const char *zEnd = &zInput[nLen];` |
|     13761 | 1222 | `	const char *zIn  = zInput;` |
|         - | 1223 | `	const char *zCur,*zCurEnd;` |
|     13761 | 1224 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1225 | `	SyToken sToken;` |
|         - | 1226 | `	SyString sDoc;` |
|         - | 1227 | `	sxu32 nLine;` |
|         - | 1228 | `	sxi32 iNest;` |
...
|     13761 | 1232 | `	nLine = nBaseLine;` |
|     13761 | 1233 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13761 | 1234 | `	sToken.pUserData = 0;` |
|     13761 | 1235 | `	iNest = 0;` |
|     13761 | 1236 | `	sDoc.nByte = 0;` |
|     13761 | 1237 | `	sDoc.zString = ""; /* cc warning */` |
|     13751 | 1238 | `	for(;;){` |
|     27337 | 1239 | `		if( zIn >= zEnd ){` |
|         - | 1240 | `			/* End of input reached */` |
|     13571 | 1241 | `			break;` |
|         - | 1242 | `		}` |
|     13771 | 1243 | `		sToken.nLine = nLine;` |
|     13771 | 1244 | `		zCur = zIn;` |
|     13771 | 1245 | `		zCurEnd = 0;` |
|     14111 | 1246 | `		while( zIn < zEnd ){` |
|     13921 | 1247 | `			 if( zIn[0] == '<' ){` |
|     13581 | 1248 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     13581 | 1249 | `				zIn++;` |
|     13581 | 1250 | `				if( zIn < zEnd ){` |
|     13581 | 1251 | `					if( zIn[0] == '?' ){` |
|     13581 | 1252 | `						zIn++;` |
|     13581 | 1253 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1254 | `							/* opening tag: <?php */` |
|     13579 | 1255 | `							zIn += sizeof("php")-1;` |
|      6787 | 1256 | `						}` |
|         - | 1257 | `						/* Look for the closing tag '?>' */` |
|     13581 | 1258 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     13581 | 1259 | `						zCurEnd = zTmp;` |
|     13581 | 1260 | `						break;` |
|         - | 1261 | `					}` |
|       ! 0 | 1262 | `				}` |
|       ! 0 | 1263 | `			}else{` |
...
|     13771 | 1270 | `		if( zCurEnd == 0 ){` |
|        23 | 1271 | `			zCurEnd = zIn;` |
|        10 | 1272 | `		}` |
|         - | 1273 | `		/* Save the raw token */` |
|     13771 | 1274 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13771 | 1275 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13771 | 1276 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13771 | 1277 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1278 | `			return rc;` |
|         - | 1279 | `		}` |
|     13771 | 1280 | `		if( zIn >= zEnd ){` |
|        23 | 1281 | `			break;` |
|         - | 1282 | `		}` |
|         - | 1283 | `		/* Ignore leading white space */` |
|     29063 | 1284 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     15317 | 1285 | `			if( zIn[0] == '\n' ){` |
|     14853 | 1286 | `				nLine++;` |
|      7424 | 1287 | `			}` |
|     15317 | 1288 | `			zIn++;` |
...
|     13751 | 1291 | `		sToken.nLine = nLine;` |
|     13751 | 1292 | `		zCur = zIn;` |
|   1558901 | 1293 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1294 | `			const char *zPtr;` |
|   1552611 | 1295 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7291 | 1296 | `				break;` |
|         - | 1297 | `			}` |
...
|   1549178 | 1303 | `			if( iNest < 1 &&` |
|   1541348 | 1304 | `				( (zIn[0] == '#' && !(zIn+1 < zEnd && zIn[1] == '[')) \|\|` |
|   1541376 | 1305 | `				  (zIn[0] == '/' && zIn+1 < zEnd && zIn[1] == '/') ) ){` |
|      7711 | 1306 | `				zIn += (zIn[0] == '#') ? 1 : 2;` |
|    307439 | 1307 | `				while( zIn < zEnd && zIn[0] != '\n' ){` |
|    299730 | 1308 | `					if( (sxu32)(zEnd - zIn) >= sCtag.nByte` |
|    299732 | 1309 | `						&& SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 ){` |
...
|   1537851 | 1317 | `			if( iNest < 1 && zIn[0] == '/' && zIn+1 < zEnd && zIn[1] == '*' ){` |
|       311 | 1318 | `				zIn += 2;` |
...
|   1537545 | 1339 | ``			if( iNest < 1 && (zIn[0] == '\'' \|\| zIn[0] == '"' \|\| zIn[0] == '`') ){`` |
|     46521 | 1340 | `				int qch = zIn[0];` |
|     46521 | 1341 | `				zIn++;` |
|    336511 | 1342 | `				while( zIn < zEnd ){` |
|    336511 | 1343 | `					if( zIn[0] == '\\' && zIn + 1 < zEnd ){` |
|     18271 | 1344 | `						if( zIn[1] == '\n' ){ nLine++; }` |
|     18271 | 1345 | `						zIn += 2;` |
|     18271 | 1346 | `						continue;` |
|         - | 1347 | `					}` |
|    318245 | 1348 | `					if( zIn[0] == qch ){ zIn++; break; }` |
|    271729 | 1349 | `					if( zIn[0] == '\n' ){ nLine++; }` |
|    271729 | 1350 | `					zIn++;` |
|         5 | 1351 | `				}` |
|     46521 | 1352 | `				continue;` |
|         - | 1353 | `			}` |
|   1491029 | 1354 | `			if( zIn[0] == '\n' ){` |
|     62701 | 1355 | `				nLine++;` |
|     62701 | 1356 | `				if( iNest > 0 ){` |
|       337 | 1357 | `					zIn++;` |
...
|       337 | 1376 | `					continue;` |
|         5 | 1377 | `				}` |
|   1459515 | 1378 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1490575 | 1405 | `			zIn++;` |
|         - | 1406 |  |
|   1490575 | 1407 | `			if ( zIn >= zEnd )` |
|       ! 0 | 1408 | `				break;` |
|         5 | 1409 | `		}` |
|     13581 | 1410 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6295 | 1411 | `			zIn = zEnd;` |
|      3145 | 1412 | `		}` |
|     13581 | 1413 | `		if( zCur < zIn ){` |
