...
|         - |   18 | ` */` |
| 186050912 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 275945667 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  89894755 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     55325 |   28 | `			pStream->nLine++;` |
|     27660 |   29 | `		}` |
|  89894755 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 186050917 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|         3 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 186050915 |   37 | `	pToken->nLine = pStream->nLine;` |
| 186050915 |   38 | `	pToken->pUserData = 0;` |
| 186050915 |   39 | `	pStr = &pToken->sData;` |
| 186050915 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 217336118 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  62570411 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  62570389 |   53 | `			pStream->zText++;` |
|  31285192 |   54 | `		}` |
|  58852378 |   55 | `		for(;;){` |
| 117704761 |   56 | `			zIn = pStream->zText;` |
| 117704761 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        81 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 472848731 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 296291597 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
| 117704761 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  62570411 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  55134355 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  62570411 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  62570411 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  62570406 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  21610381 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       687 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       341 |   85 | `		}` |
|  62570411 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  20716099 |   87 | `			if( nKeyword &` |
...
|    999921 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|         - |   91 | `					/* Mark as an operator */` |
|    999921 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|    499963 |   93 | `			}else{` |
|         - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  19716183 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  19716183 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|  10358052 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  41854317 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  31285208 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 123480509 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 123587180 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 123472584 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|      7873 |  188 | `				pStream->zText++;` |
|         - |  189 | `				/* Inline comments */` |
|    359679 |  190 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|    351811 |  191 | `					pStream->zText++;` |
|         5 |  192 | `				}` |
|         - |  193 | `				/* Tell the upper-layer to ignore this token */` |
|      7873 |  194 | `				return SXERR_CONTINUE;` |
| 123464727 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
| 123247397 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3821977 |  234 | `			pStream->zText++;` |
...
|   3821972 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3821972 |  239 | `				&& pStream->zText[0] == '_'` |
|   1911067 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4801649 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    979677 |  247 | `				pStream->zText++;` |
|    979672 |  248 | `				if( pStream->zText < pStream->zEnd` |
|    979672 |  249 | `					&& pStream->zText[0] == '_'` |
|    489922 |  250 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   3821977 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3821977 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3821977 |  259 | `				c = pStream->zText[0];` |
|   3821977 |  260 | `				if( c == '.' ){` |
...
|     10113 |  264 | `						pStream->zText++;` |
|     10108 |  265 | `						if( pStream->zText < pStream->zEnd` |
|     10108 |  266 | `							&& pStream->zText[0] == '_'` |
|      5060 |  267 | `							&& pStream->zText + 1 < pStream->zEnd` |
...
|   3813274 |  326 | `				}else if( (c == 'x' \|\| c == 'X')` |
|   1958983 |  327 | `					&& pStream->zText == &((const unsigned char *)pStr->zString)[1] && pStr->zString[0] == 0x30` |
|    104752 |  328 | `					&& &pStream->zText[1] < pStream->zEnd` |
|    104757 |  329 | `					&& pStream->zText[1] < 0xc0 && SyisHex(pStream->zText[1]) ){` |
|         - |  330 | `					/* Hex digit stream (PHP 7.4: underscore separator allowed between two digits) */` |
|    104753 |  331 | `					pStream->zText++;` |
|    454085 |  332 | `					while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisHex(pStream->zText[0]) ){` |
|    349337 |  333 | `						pStream->zText++;` |
|    349332 |  334 | `						if( pStream->zText < pStream->zEnd` |
|    349332 |  335 | `							&& pStream->zText[0] == '_'` |
|    174691 |  336 | `							&& pStream->zText + 1 < pStream->zEnd` |
|        50 |  337 | `							&& pStream->zText[1] < 0xc0` |
|        55 |  338 | `							&& SyisHex(pStream->zText[1]) ){` |
|        51 |  339 | `							pStream->zText++;` |
|        25 |  340 | `						}` |
|         5 |  341 | `					}` |
|   3760845 |  342 | `				}else if( (c == 'b' \|\| c == 'B')` |
|   1854377 |  343 | `					&& pStream->zText == &((const unsigned char *)pStr->zString)[1] && pStr->zString[0] == 0x30` |
...
|        70 |  355 | `						}` |
|         1 |  356 | `					}` |
|   3708324 |  357 | `				}else if( (c == 'o' \|\| c == 'O')` |
|   1854100 |  358 | `					&& pStream->zText == &((const unsigned char *)pStr->zString)[1] && pStr->zString[0] == 0x30` |
...
|   3821977 |  379 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3821977 |  387 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3821977 |  388 | `			return SXRET_OK;` |
|         - |  389 | `		}` |
| 119425425 |  390 | `		c = pStream->zText[0];` |
| 119425425 |  391 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  392 | `		/* Assume we are dealing with an operator*/` |
| 119425425 |  393 | `		pToken->nType = PH7_TK_OP;` |
| 119425425 |  394 | `		switch(c){` |
|  24676079 |  395 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   7334567 |  396 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   7334553 |  397 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  15455727 |  398 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|   3265999 |  399 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|         - |  400 | `														 * is a potential operator [i.e: subscripting] */` |
|   3266005 |  401 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   7727853 |  402 | `		case ')': {` |
|  15455711 |  403 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  404 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  15455711 |  405 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  406 | `				SyToken *pTmp;` |
|         - |  407 | `				/* Peek the last recongnized token */` |
|  15455709 |  408 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  15455709 |  409 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|   1198385 |  410 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|   1198385 |  411 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|   1081925 |  412 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|   1081925 |  413 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|         - |  414 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    760131 |  415 | `							const char * zTypeCast = "(int)";` |
|    760131 |  416 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|     31039 |  417 | `								zTypeCast = "(float)";` |
|    744614 |  418 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|     23299 |  419 | `								zTypeCast = "(bool)";` |
|    717450 |  420 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|    376055 |  421 | `								zTypeCast = "(string)";` |
|    517778 |  422 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|        36 |  423 | `								zTypeCast = "(array)";` |
|    329736 |  424 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|        38 |  425 | `								zTypeCast = "(object)";` |
|    329701 |  426 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|         3 |  427 | `								zTypeCast = "(unset)";` |
|         1 |  428 | `							}` |
|         - |  429 | `							/* Reflect the change */` |
|    760131 |  430 | `							pToken->nType = PH7_TK_OP;` |
|    760131 |  431 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|         - |  432 | `							/* Save the instance associated with the type cast operator */` |
|    760131 |  433 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|         - |  434 | `							/* Remove the two previous tokens */` |
|    760131 |  435 | `							pTokSet->nUsed -= 2;` |
|    760131 |  436 | `							return SXRET_OK;` |
|         - |  437 | `						}` |
|    160897 |  438 | `					}` |
|    219127 |  439 | `				}` |
|   7347789 |  440 | `			}` |
|  14695585 |  441 | `			pToken->nType = PH7_TK_RPAREN;` |
|  14695585 |  442 | `			break;` |
|         - |  443 | `				  }` |
|   2777933 |  444 | `		case '\'':{` |
|         - |  445 | `			/* Single quoted string */` |
|   5555871 |  446 | `			pStr->zString++;` |
|  63298189 |  447 | `			while( pStream->zText < pStream->zEnd ){` |
|  63298189 |  448 | `				if( pStream->zText[0] == '\''  ){` |
|   5555885 |  449 | `					if( pStream->zText[-1] != '\\' ){` |
|   5520945 |  450 | `						break;` |
|       ! 0 |  451 | `					}else{` |
|     34945 |  452 | `						const unsigned char *zPtr = &pStream->zText[-2];` |
|     34945 |  453 | `						sxi32 i = 1;` |
|     69891 |  454 | `						while( zPtr > pStream->zInput && zPtr[0] == '\\' ){` |
|     34951 |  455 | `							zPtr--;` |
|     34951 |  456 | `							i++;` |
|         5 |  457 | `						}` |
|     34945 |  458 | `						if((i&1)==0){` |
...
|         - |  461 | `					}` |
|         7 |  462 | `				}` |
|  57742323 |  463 | `				if( pStream->zText[0] == '\n' ){` |
|        63 |  464 | `					pStream->nLine++;` |
|        31 |  465 | `				}` |
|  57742323 |  466 | `				pStream->zText++;` |
|         5 |  467 | `			}` |
|         - |  468 | `			/* Record token length and type */` |
|   5555871 |  469 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   5555871 |  470 | `			pToken->nType = PH7_TK_SSTR;` |
|         - |  471 | `			/* Jump the trailing single quote */` |
|   5555871 |  472 | `			pStream->zText++;` |
|   5555871 |  473 | `			return SXRET_OK;` |
|         - |  474 | `				  }` |
|     62703 |  475 | `		case '"':{` |
|         - |  476 | `			sxi32 iNest;` |
|         - |  477 | `			/* Double quoted string */` |
|    125411 |  478 | `			pStr->zString++;` |
|   1733181 |  479 | `			while( pStream->zText < pStream->zEnd ){` |
|   1733181 |  480 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       148 |  481 | `					iNest = 1;` |
...
|         - |  500 | `					}` |
|        73 |  501 | `				}` |
|   1733181 |  502 | `				if( pStream->zText[0] == '"' ){` |
|    125713 |  503 | `					if( pStream->zText[-1] != '\\' ){` |
|    125403 |  504 | `						break;` |
|       ! 0 |  505 | `					}else{` |
|       315 |  506 | `						const unsigned char *zPtr = &pStream->zText[-2];` |
|       315 |  507 | `						sxi32 i = 1;` |
|       371 |  508 | `						while( zPtr > pStream->zInput && zPtr[0] == '\\' ){` |
|        59 |  509 | `							zPtr--;` |
|        59 |  510 | `							i++;` |
|         3 |  511 | `						}` |
|       315 |  512 | `						if((i&1)==0){` |
...
|         - |  515 | `					}` |
|       151 |  516 | `				}` |
|   1607775 |  517 | `				if( pStream->zText[0] == '\n' ){` |
|        47 |  518 | `					pStream->nLine++;` |
|        23 |  519 | `				}` |
|   1607775 |  520 | `				pStream->zText++;` |
|         5 |  521 | `			}` |
|         - |  522 | `			/* Record token length and type */` |
|    125411 |  523 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    125411 |  524 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  525 | `			/* Jump the trailing quote */` |
|    125411 |  526 | `			pStream->zText++;` |
|    125411 |  527 | `			return SXRET_OK;` |
|         - |  528 | `				  }` |
|         1 |  529 | ``		case '`':{`` |
...
|         - |  547 | `				  }` |
|      8787 |  548 | `		case '\\': pToken->nType = PH7_TK_NSSEP;  break;` |
|    547459 |  549 | `		case ':':` |
|   1094923 |  550 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|         - |  551 | `				/* Current operator: '::' */` |
|    419699 |  552 | `				pStream->zText++;` |
|    209852 |  553 | `			}else{` |
|    675229 |  554 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|         - |  555 | `			}` |
|   1094923 |  556 | `			break;` |
|   4362895 |  557 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|  11595953 |  558 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  559 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   4117868 |  560 | `		case '=':` |
|   8235741 |  561 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   8235741 |  562 | `			if( pStream->zText < pStream->zEnd ){` |
|   8235741 |  563 | `				if( pStream->zText[0] == '=' ){` |
|   1474637 |  564 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|         - |  565 | `					/* Current operator: == */` |
|   1474637 |  566 | `					pStream->zText++;` |
|   1474637 |  567 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  568 | `						/* Current operator: === */` |
|   1423891 |  569 | `						pStream->zText++;` |
|    711948 |  570 | `					}` |
|   7498425 |  571 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  572 | `					/* Array operator: => */` |
|    553773 |  573 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    553773 |  574 | `					pStream->zText++;` |
|    276889 |  575 | `				}else{` |
|         - |  576 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   6207341 |  577 | `					const unsigned char *zCur = pStream->zText;` |
|   6207341 |  578 | `					sxu32 nLine = 0;` |
|  12414511 |  579 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   6207175 |  580 | `						if( zCur[0] == '\n' ){` |
|         5 |  581 | `							nLine++;` |
|         2 |  582 | `						}` |
|   6207175 |  583 | `						zCur++;` |
|         5 |  584 | `					}` |
|   6207341 |  585 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   8235741 |  595 | `			break;` |
|    451872 |  596 | `		case '!':` |
|    903749 |  597 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  598 | `				/* Current operator: != */` |
|    434367 |  599 | `				pStream->zText++;` |
|    434367 |  600 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  601 | `					/* Current operator: !== */` |
|    418833 |  602 | `					pStream->zText++;` |
|    209414 |  603 | `				}` |
|    217181 |  604 | `			}` |
|    903749 |  605 | `			break;` |
|    339542 |  606 | `		case '&':` |
|    679089 |  607 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    679089 |  608 | `			if( pStream->zText < pStream->zEnd ){` |
|    679089 |  609 | `				if( pStream->zText[0] == '&' ){` |
|    450105 |  610 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|         - |  611 | `					/* Current operator: && */` |
|    450105 |  612 | `					pStream->zText++;` |
|    454039 |  613 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    679089 |  619 | `			break;` |
|    199797 |  620 | `		case '\|':` |
|    399599 |  621 | `			if( pStream->zText < pStream->zEnd ){` |
|    399599 |  622 | `				if( pStream->zText[0] == '\|' ){` |
|         - |  623 | `					/* Current operator: \|\| */` |
|    325697 |  624 | `					pStream->zText++;` |
|    236753 |  625 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  626 | `					/* Current operator: \|= */` |
|     58151 |  627 | `					pStream->zText++;` |
|     44834 |  628 | `				}else if( pStream->zText[0] == '>' ){` |
...
|    399599 |  633 | `			break;` |
|    227354 |  634 | `		case '+':` |
|    454713 |  635 | `			if( pStream->zText < pStream->zEnd ){` |
|    454713 |  636 | `				if( pStream->zText[0] == '+' ){` |
|         - |  637 | `					/* Current operator: ++ */` |
|    186479 |  638 | `					pStream->zText++;` |
|    361476 |  639 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  640 | `					/* Current operator: += */` |
|     54345 |  641 | `					pStream->zText++;` |
|     27170 |  642 | `				}` |
|    227354 |  643 | `			}` |
|    454713 |  644 | `			break;` |
|   2918806 |  645 | `		case '-':` |
|   5837617 |  646 | `			if( pStream->zText < pStream->zEnd ){` |
|   5837617 |  647 | `				if( pStream->zText[0] == '-' ){` |
|         - |  648 | `					/* Current operator: -- */` |
|     31047 |  649 | `					pStream->zText++;` |
|   5822096 |  650 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  651 | `					/* Current operator: -= */` |
|        14 |  652 | `					pStream->zText++;` |
|   5806569 |  653 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  654 | `					/* Current operator: -> */` |
|   5565361 |  655 | `					pStream->zText++;` |
|   2782678 |  656 | `				}` |
|   2918806 |  657 | `			}` |
|   5837617 |  658 | `			break;` |
|     19596 |  659 | `		case '*':` |
|     39197 |  660 | `			if( pStream->zText < pStream->zEnd ){` |
|     39197 |  661 | `				if( pStream->zText[0] == '*' ){` |
...
|        12 |  667 | `					}` |
|     39129 |  668 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     39197 |  673 | `			break;` |
|      1989 |  674 | `		case '/':` |
|      3983 |  675 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  676 | `				/* Current operator: /= */` |
|         9 |  677 | `				pStream->zText++;` |
|         4 |  678 | `			}` |
|      3983 |  679 | `			break;` |
|     17492 |  680 | `		case '%':` |
|     34989 |  681 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
...
|        23 |  691 | `			break;` |
|    996530 |  692 | `		case '.':` |
|   1993065 |  693 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|         - |  694 | `				/* Ellipsis: ... */` |
|     27603 |  695 | `				pStream->zText += 2;` |
|     27603 |  696 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|   1979266 |  697 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  698 | `				/* Current operator: .= */` |
|    337393 |  699 | `				pStream->zText++;` |
|    168694 |  700 | `			}` |
|   1993065 |  701 | `			break;` |
|    199971 |  702 | `		case '<':` |
|    399947 |  703 | `			if( pStream->zText < pStream->zEnd ){` |
|    399947 |  704 | `				if( pStream->zText[0] == '<' ){` |
...
|       ! 0 |  720 | `						}` |
|        12 |  721 | `					}` |
|    399812 |  722 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  723 | `					/* Current operator: <> */` |
|         5 |  724 | `					pStream->zText++;` |
|    399799 |  725 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  726 | `					/* Current operator: <= or <=> */` |
|     66053 |  727 | `					pStream->zText++;` |
|     66053 |  728 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '>' ){` |
|         - |  729 | `						/* Current operator: <=> */` |
|     27225 |  730 | `						pStream->zText++;` |
|     13610 |  731 | `					}` |
|     33024 |  732 | `				}` |
|    199909 |  733 | `			}` |
|    399823 |  734 | `			break;` |
|    157131 |  735 | `		case '>':` |
|    314267 |  736 | `			if( pStream->zText < pStream->zEnd ){` |
|    314267 |  737 | `				if( pStream->zText[0] == '>' ){` |
|         - |  738 | `					/* Current operator: >> */` |
|     19405 |  739 | `					pStream->zText++;` |
|     19405 |  740 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  741 | `						/* Current operator: >>= */` |
|        11 |  742 | `						pStream->zText++;` |
|        10 |  743 | `					}` |
|    304567 |  744 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  745 | `					/* Current operator: >= */` |
|    104749 |  746 | `					pStream->zText++;` |
|     52372 |  747 | `				}` |
|    157131 |  748 | `			}` |
|    314267 |  749 | `			break;` |
|    290653 |  750 | `		case '?':` |
|    581311 |  751 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '?' ){` |
|         - |  752 | `				/* Null coalescing operator: ?? */` |
|     58431 |  753 | `				pStream->zText++;` |
|     58431 |  754 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  755 | `					/* Null coalescing assignment operator (PHP 7.4) */` |
|       101 |  756 | `					pStream->zText++;` |
|        48 |  757 | `				}` |
|    552098 |  758 | `			}else if( (pStream->zEnd - pStream->zText) >= 2` |
|    522885 |  759 | `				&& pStream->zText[0] == '-' && pStream->zText[1] == '>' ){` |
...
|     15778 |  765 | `			break;` |
|         - |  766 | `		}` |
| 112983901 |  767 | `		if( pStr->nByte <= 0 ){` |
|         - |  768 | `			/* Record token length */` |
| 112983829 |  769 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  56491912 |  770 | `		}` |
| 112983901 |  771 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  772 | `			const ph7_expr_op *pOp;` |
|         - |  773 | `			/* Check if the extracted token is an operator */` |
|  27360095 |  774 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  27360095 |  775 | `			if( pOp == 0 ){` |
|         - |  776 | `				/* Not an operator */` |
...
|         - |  807 | `*/` |
|         - |  808 | `/* Hash score: 103 */` |
|  62570411 |  809 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  897 | `  };` |
|         - |  898 | `  int h, i;` |
|  62570411 |  899 | `  if( n<2 ) return PH7_TK_ID;` |
...
|  55134311 |  905 | `  h = (int)(((sxu32)(sxu8)z[0]*4) ^ ((sxu32)(sxu8)z[n-1]*3) ^ (sxu32)n) % 151;` |
|  84951265 |  906 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  50523919 |  907 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  990 | `       /* PH7_TKWRD_OR */` |
|         - |  991 | `       /* PH7_TKWRD_BREAK */` |
|  20706965 |  992 | `      return aCode[i];` |
|         - |  993 | `    }` |
|  14908482 |  994 | `  }` |
|         - |  995 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  34427351 |  996 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  34419495 |  997 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  34419491 |  998 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  34419319 |  999 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  34403423 | 1000 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  34403345 | 1001 | `  return PH7_TK_ID;` |
|  31285208 | 1002 | `}` |
...
|         - | 1171 | ` */` |
|    105430 | 1172 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut,SySet *pTrivia)` |
|         5 | 1173 | `{` |
|         - | 1174 | `	SyLex sLexer;` |
|         - | 1175 | `	sxi32 rc;` |
|         - | 1176 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|    105435 | 1177 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
...
|    105435 | 1183 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,pTrivia);` |
|    105435 | 1184 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1185 | `		return rc;` |
|         - | 1186 | `	}` |
|    105435 | 1187 | `	sLexer.sStream.nLine = nLineStart;` |
|         - | 1188 | `	/* Tokenize input */` |
|    105435 | 1189 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|         - | 1190 | `	/* Release the lexer */` |
|    105435 | 1191 | `	SyLexRelease(&sLexer);` |
|         - | 1192 | `	/* Tokenization result */` |
|    105435 | 1193 | `	return rc;` |
|     52720 | 1194 | `}` |
|         - | 1195 | `/*` |
...
|         - | 1239 | ` */` |
|     12996 | 1240 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut,sxu32 nBaseLine)` |
|         5 | 1241 | `{` |
|     13001 | 1242 | `	const char *zEnd = &zInput[nLen];` |
|     13001 | 1243 | `	const char *zIn  = zInput;` |
|         - | 1244 | `	const char *zCur,*zCurEnd;` |
|     13001 | 1245 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1246 | `	SyToken sToken;` |
|         - | 1247 | `	SyString sDoc;` |
|         - | 1248 | `	sxu32 nLine;` |
|         - | 1249 | `	sxi32 iNest;` |
...
|     13001 | 1253 | `	nLine = nBaseLine;` |
|     13001 | 1254 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13001 | 1255 | `	sToken.pUserData = 0;` |
|     13001 | 1256 | `	iNest = 0;` |
|     13001 | 1257 | `	sDoc.nByte = 0;` |
|     13001 | 1258 | `	sDoc.zString = ""; /* cc warning */` |
|     12990 | 1259 | `	for(;;){` |
|     25817 | 1260 | `		if( zIn >= zEnd ){` |
|         - | 1261 | `			/* End of input reached */` |
|     12813 | 1262 | `			break;` |
|         - | 1263 | `		}` |
|     13009 | 1264 | `		sToken.nLine = nLine;` |
|     13009 | 1265 | `		zCur = zIn;` |
|     13009 | 1266 | `		zCurEnd = 0;` |
|     13349 | 1267 | `		while( zIn < zEnd ){` |
|     13161 | 1268 | `			 if( zIn[0] == '<' ){` |
|     12821 | 1269 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     12821 | 1270 | `				zIn++;` |
|     12821 | 1271 | `				if( zIn < zEnd ){` |
|     12821 | 1272 | `					if( zIn[0] == '?' ){` |
|     12821 | 1273 | `						zIn++;` |
|     12821 | 1274 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1275 | `							/* opening tag: <?php */` |
|     12819 | 1276 | `							zIn += sizeof("php")-1;` |
|      6407 | 1277 | `						}` |
|         - | 1278 | `						/* Look for the closing tag '?>' */` |
|     12821 | 1279 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     12821 | 1280 | `						zCurEnd = zTmp;` |
|     12821 | 1281 | `						break;` |
|         - | 1282 | `					}` |
|       ! 0 | 1283 | `				}` |
|       ! 0 | 1284 | `			}else{` |
...
|     13009 | 1291 | `		if( zCurEnd == 0 ){` |
|        23 | 1292 | `			zCurEnd = zIn;` |
|        10 | 1293 | `		}` |
|         - | 1294 | `		/* Save the raw token */` |
|     13009 | 1295 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13009 | 1296 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13009 | 1297 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13009 | 1298 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1299 | `			return rc;` |
|         - | 1300 | `		}` |
|     13009 | 1301 | `		if( zIn >= zEnd ){` |
|        23 | 1302 | `			break;` |
|         - | 1303 | `		}` |
|         - | 1304 | `		/* Ignore leading white space */` |
|     27365 | 1305 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     14381 | 1306 | `			if( zIn[0] == '\n' ){` |
|     14183 | 1307 | `				nLine++;` |
|      7089 | 1308 | `			}` |
|     14381 | 1309 | `			zIn++;` |
...
|     12989 | 1312 | `		sToken.nLine = nLine;` |
|     12989 | 1313 | `		zCur = zIn;` |
|   1543569 | 1314 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1315 | `			const char *zPtr;` |
|   1537473 | 1316 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      6725 | 1317 | `				break;` |
|         - | 1318 | `			}` |
...
|   1534872 | 1324 | `			if( iNest < 1 &&` |
|   1526058 | 1325 | `				( (zIn[0] == '#' && !(zIn+1 < zEnd && zIn[1] == '[')) \|\|` |
|   1526072 | 1326 | `				  (zIn[0] == '/' && zIn+1 < zEnd && zIn[1] == '/') ) ){` |
|      8243 | 1327 | `				zIn += (zIn[0] == '#') ? 1 : 2;` |
|    352189 | 1328 | `				while( zIn < zEnd && zIn[0] != '\n' ){` |
|    343948 | 1329 | `					if( (sxu32)(zEnd - zIn) >= sCtag.nByte` |
|    343950 | 1330 | `						&& SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 ){` |
...
|   1522717 | 1338 | `			if( iNest < 1 && zIn[0] == '/' && zIn+1 < zEnd && zIn[1] == '*' ){` |
|       279 | 1339 | `				zIn += 2;` |
...
|   1522443 | 1360 | ``			if( iNest < 1 && (zIn[0] == '\'' \|\| zIn[0] == '"' \|\| zIn[0] == '`') ){`` |
|     45385 | 1361 | `				int qch = zIn[0];` |
|     45385 | 1362 | `				zIn++;` |
|    315629 | 1363 | `				while( zIn < zEnd ){` |
|    315629 | 1364 | `					if( zIn[0] == '\\' && zIn + 1 < zEnd ){` |
|     17761 | 1365 | `						if( zIn[1] == '\n' ){ nLine++; }` |
|     17761 | 1366 | `						zIn += 2;` |
|     17761 | 1367 | `						continue;` |
|         - | 1368 | `					}` |
|    297873 | 1369 | `					if( zIn[0] == qch ){ zIn++; break; }` |
|    252493 | 1370 | `					if( zIn[0] == '\n' ){ nLine++; }` |
|    252493 | 1371 | `					zIn++;` |
|         5 | 1372 | `				}` |
|     45385 | 1373 | `				continue;` |
|         - | 1374 | `			}` |
|   1477063 | 1375 | `			if( zIn[0] == '\n' ){` |
|     62255 | 1376 | `				nLine++;` |
|     62255 | 1377 | `				if( iNest > 0 ){` |
|       363 | 1378 | `					zIn++;` |
...
|       363 | 1397 | `					continue;` |
|         5 | 1398 | `				}` |
|   1445759 | 1399 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1476581 | 1426 | `			zIn++;` |
|         - | 1427 |  |
|   1476581 | 1428 | `			if ( zIn >= zEnd )` |
|       ! 0 | 1429 | `				break;` |
|         5 | 1430 | `		}` |
|     12821 | 1431 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6101 | 1432 | `			zIn = zEnd;` |
|      3048 | 1433 | `		}` |
|     12821 | 1434 | `		if( zCur < zIn ){` |
|         - | 1435 | `			/* Save the PHP chunk for later processing */` |
|      9665 | 1436 | `			sToken.nType = PH7_TOKEN_PHP;` |
|      9665 | 1437 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|     19087 | 1438 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|      9665 | 1439 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|      9665 | 1440 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1441 | `				return rc;` |
|         - | 1442 | `			}` |
|      4830 | 1443 | `		}` |
|     12821 | 1444 | `		if( zIn < zEnd ){` |
|         - | 1445 | `			/* Jump the trailing closing tag */` |
|      6725 | 1446 | `			zIn += sCtag.nByte;` |
|         - | 1447 | `			/* php's lexer swallows exactly ONE newline immediately after the` |
|         - | 1448 | `			 * closing tag ("?>\n" emits nothing) */` |
|      6725 | 1449 | `			if( zIn < zEnd && zIn[0] == '\r' && zIn + 1 < zEnd && zIn[1] == '\n' ){` |
|       ! 0 | 1450 | `				zIn += 2;` |
|       ! 0 | 1451 | `				nLine++;` |
|      6725 | 1452 | `			}else if( zIn < zEnd && zIn[0] == '\n' ){` |
|        61 | 1453 | `				zIn++;` |
|        61 | 1454 | `				nLine++;` |
|        28 | 1455 | `			}` |
|      3360 | 1456 | `		}` |
