...
|         - |   18 | ` */` |
| 163874222 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 242105513 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  78231291 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     54253 |   28 | `			pStream->nLine++;` |
|     27124 |   29 | `		}` |
|  78231291 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 163874227 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 163874227 |   37 | `	pToken->nLine = pStream->nLine;` |
| 163874227 |   38 | `	pToken->pUserData = 0;` |
| 163874227 |   39 | `	pStr = &pToken->sData;` |
| 163874227 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 191022431 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  54296413 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  54296397 |   53 | `			pStream->zText++;` |
|  27148196 |   54 | `		}` |
|  50776011 |   55 | `		for(;;){` |
| 101552027 |   56 | `			zIn = pStream->zText;` |
| 101552027 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 403204518 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 250876485 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
| 101552027 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  54296413 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  47255619 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  54296413 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  54296413 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  54296408 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  18761768 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       827 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       411 |   85 | `		}` |
|  54296413 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  18029221 |   87 | `			if( nKeyword &` |
...
|    886899 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|         - |   91 | `					/* Mark as an operator */` |
|    886899 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|    443452 |   93 | `			}else{` |
|         - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  17142327 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  17142327 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   9014613 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  36267197 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  27148209 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 109577819 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 109677011 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 109570008 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
...
| 109562919 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
|         - |  201 | `			 * token stream. */` |
|    202969 |  202 | `			const unsigned char *zDocStart = pStream->zText;` |
|    202981 |  203 | `			int bDoc = ( &pStream->zText[2] < pStream->zEnd && pStream->zText[2] == '*'` |
|    304458 |  204 | `			 && ( &pStream->zText[3] >= pStream->zEnd \|\| pStream->zText[3] != '/' ) );` |
|    202969 |  205 | `			pStream->zText += 2;` |
|         - |  206 | `			/* Block comment */` |
|  14851207 |  207 | `			while( pStream->zText < pStream->zEnd ){` |
|  14851207 |  208 | `				if( pStream->zText[0] == '*' ){` |
|    279701 |  209 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    101487 |  210 | `						break;` |
|         - |  211 | `					}` |
|     38366 |  212 | `				}` |
|  14648243 |  213 | `				if( pStream->zText[0] == '\n' ){` |
|       225 |  214 | `					pStream->nLine++;` |
|       110 |  215 | `				}` |
|  14648243 |  216 | `				pStream->zText++;` |
|         5 |  217 | `			}` |
|    202969 |  218 | `			pStream->zText += 2;` |
|    202969 |  219 | `			if( bDoc && pUserData && pStream->pSet ){` |
...
|    202969 |  232 | `			return SXERR_CONTINUE;` |
| 109359955 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3563863 |  234 | `			pStream->zText++;` |
...
|   3563858 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3563858 |  239 | `				&& pStream->zText[0] == '_'` |
|   1782009 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4411919 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
...
|   3563863 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3563863 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3563863 |  259 | `				c = pStream->zText[0];` |
|   3563863 |  260 | `				if( c == '.' ){` |
...
|   3563863 |  363 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3563863 |  371 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3563863 |  372 | `			return SXRET_OK;` |
|         - |  373 | `		}` |
| 105796097 |  374 | `		c = pStream->zText[0];` |
| 105796097 |  375 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  376 | `		/* Assume we are dealing with an operator*/` |
| 105796097 |  377 | `		pToken->nType = PH7_TK_OP;` |
| 105796097 |  378 | `		switch(c){` |
|  21894641 |  379 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   6452155 |  380 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   6452141 |  381 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  13546481 |  382 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
...
|   6773226 |  386 | `		case ')': {` |
|  13546457 |  387 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  388 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  13546457 |  389 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  390 | `				SyToken *pTmp;` |
|         - |  391 | `				/* Peek the last recongnized token */` |
|  13546455 |  392 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  13546455 |  393 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|    214334 |  423 | `				}` |
|   6486217 |  424 | `			}` |
|  12972441 |  425 | `			pToken->nType = PH7_TK_RPAREN;` |
|  12972441 |  426 | `			break;` |
|         - |  427 | `				  }` |
|   2551383 |  428 | `		case '\'':{` |
|         - |  429 | `			/* Single quoted string */` |
|   5102771 |  430 | `			pStr->zString++;` |
|  59188095 |  431 | `			while( pStream->zText < pStream->zEnd ){` |
|  59188095 |  432 | `				if( pStream->zText[0] == '\''  ){` |
|   5102781 |  433 | `					if( pStream->zText[-1] != '\\' ){` |
|   5072157 |  434 | `						break;` |
|       ! 0 |  435 | `					}else{` |
...
|         - |  445 | `					}` |
|         5 |  446 | `				}` |
|  54085329 |  447 | `				if( pStream->zText[0] == '\n' ){` |
|        67 |  448 | `					pStream->nLine++;` |
|        33 |  449 | `				}` |
|  54085329 |  450 | `				pStream->zText++;` |
|         5 |  451 | `			}` |
|         - |  452 | `			/* Record token length and type */` |
|   5102771 |  453 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   5102771 |  454 | `			pToken->nType = PH7_TK_SSTR;` |
|         - |  455 | `			/* Jump the trailing single quote */` |
|   5102771 |  456 | `			pStream->zText++;` |
|   5102771 |  457 | `			return SXRET_OK;` |
|         - |  458 | `				  }` |
|     60219 |  459 | `		case '"':{` |
|         - |  460 | `			sxi32 iNest;` |
|         - |  461 | `			/* Double quoted string */` |
|    120443 |  462 | `			pStr->zString++;` |
|   1711829 |  463 | `			while( pStream->zText < pStream->zEnd ){` |
|   1711829 |  464 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       115 |  465 | `					iNest = 1;` |
...
|         - |  484 | `					}` |
|        56 |  485 | `				}` |
|   1711829 |  486 | `				if( pStream->zText[0] == '"' ){` |
|    120721 |  487 | `					if( pStream->zText[-1] != '\\' ){` |
|    120435 |  488 | `						break;` |
|       ! 0 |  489 | `					}else{` |
...
|         - |  499 | `					}` |
|       139 |  500 | `				}` |
|   1591391 |  501 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  502 | `					pStream->nLine++;` |
|        14 |  503 | `				}` |
|   1591391 |  504 | `				pStream->zText++;` |
|         5 |  505 | `			}` |
|         - |  506 | `			/* Record token length and type */` |
|    120443 |  507 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    120443 |  508 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  509 | `			/* Jump the trailing quote */` |
|    120443 |  510 | `			pStream->zText++;` |
|    120443 |  511 | `			return SXRET_OK;` |
|         - |  512 | `				  }` |
|         2 |  513 | ``		case '`':{`` |
...
|    448345 |  533 | `		case ':':` |
|    896695 |  534 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|         - |  535 | `				/* Current operator: '::' */` |
|    368089 |  536 | `				pStream->zText++;` |
|    184047 |  537 | `			}else{` |
|    528611 |  538 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|         - |  539 | `			}` |
|    896695 |  540 | `			break;` |
|   3703219 |  541 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|  10239839 |  542 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  543 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   3685887 |  544 | `		case '=':` |
|   7371779 |  545 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   7371779 |  546 | `			if( pStream->zText < pStream->zEnd ){` |
|   7371779 |  547 | `				if( pStream->zText[0] == '=' ){` |
|   1259875 |  548 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|         - |  549 | `					/* Current operator: == */` |
|   1259875 |  550 | `					pStream->zText++;` |
|   1259875 |  551 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  552 | `						/* Current operator: === */` |
|   1209805 |  553 | `						pStream->zText++;` |
|    604905 |  554 | `					}` |
|   6741844 |  555 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  556 | `					/* Array operator: => */` |
|    519367 |  557 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    519367 |  558 | `					pStream->zText++;` |
|    259686 |  559 | `				}else{` |
|         - |  560 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   5592547 |  561 | `					const unsigned char *zCur = pStream->zText;` |
|   5592547 |  562 | `					sxu32 nLine = 0;` |
|  11184925 |  563 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   5592383 |  564 | `						if( zCur[0] == '\n' ){` |
|         5 |  565 | `							nLine++;` |
|         2 |  566 | `						}` |
|   5592383 |  567 | `						zCur++;` |
|         5 |  568 | `					}` |
|   5592547 |  569 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|    414225 |  628 | `			break;` |
|   2416555 |  629 | `		case '-':` |
|   4833115 |  630 | `			if( pStream->zText < pStream->zEnd ){` |
|   4833115 |  631 | `				if( pStream->zText[0] == '-' ){` |
|         - |  632 | `					/* Current operator: -- */` |
|     30639 |  633 | `					pStream->zText++;` |
|   4817798 |  634 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  635 | `					/* Current operator: -= */` |
|        14 |  636 | `					pStream->zText++;` |
|   4802475 |  637 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  638 | `					/* Current operator: -> */` |
|   4583619 |  639 | `					pStream->zText++;` |
|   2291807 |  640 | `				}` |
|   2416555 |  641 | `			}` |
|   4833115 |  642 | `			break;` |
|     19331 |  643 | `		case '*':` |
...
|     11730 |  749 | `			break;` |
|         - |  750 | `		}` |
|  99998755 |  751 | `		if( pStr->nByte <= 0 ){` |
|         - |  752 | `			/* Record token length */` |
|  99998693 |  753 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  49999344 |  754 | `		}` |
|  99998755 |  755 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  756 | `			const ph7_expr_op *pOp;` |
|         - |  757 | `			/* Check if the extracted token is an operator */` |
|  24265537 |  758 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  24265537 |  759 | `			if( pOp == 0 ){` |
|         - |  760 | `				/* Not an operator */` |
...
|         - |  791 | `*/` |
|         - |  792 | `/* Hash score: 103 */` |
|  54296413 |  793 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  881 | `  };` |
|         - |  882 | `  int h, i;` |
|  54296413 |  883 | `  if( n<2 ) return PH7_TK_ID;` |
|  47255597 |  884 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  72939459 |  885 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  43703937 |  886 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  969 | `       /* PH7_TKWRD_OR */` |
|         - |  970 | `       /* PH7_TKWRD_BREAK */` |
|  18020075 |  971 | `      return aCode[i];` |
|         - |  972 | `    }` |
|  12841934 |  973 | `  }` |
|         - |  974 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  29235527 |  975 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  29227795 |  976 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  29227791 |  977 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  29227619 |  978 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  29211933 |  979 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  29211857 |  980 | `  return PH7_TK_ID;` |
|  27148209 |  981 | `}` |
...
|         - | 1150 | ` */` |
|     82052 | 1151 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut,SySet *pTrivia)` |
|         5 | 1152 | `{` |
|         - | 1153 | `	SyLex sLexer;` |
|         - | 1154 | `	sxi32 rc;` |
|         - | 1155 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|     82057 | 1156 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
...
|     82057 | 1162 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,pTrivia);` |
|     82057 | 1163 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1164 | `		return rc;` |
|         - | 1165 | `	}` |
|     82057 | 1166 | `	sLexer.sStream.nLine = nLineStart;` |
|         - | 1167 | `	/* Tokenize input */` |
|     82057 | 1168 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|         - | 1169 | `	/* Release the lexer */` |
|     82057 | 1170 | `	SyLexRelease(&sLexer);` |
|         - | 1171 | `	/* Tokenization result */` |
|     82057 | 1172 | `	return rc;` |
|     41031 | 1173 | `}` |
|         - | 1174 | `/*` |
...
|         - | 1218 | ` */` |
|     13428 | 1219 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut,sxu32 nBaseLine)` |
|         5 | 1220 | `{` |
|     13433 | 1221 | `	const char *zEnd = &zInput[nLen];` |
|     13433 | 1222 | `	const char *zIn  = zInput;` |
|         - | 1223 | `	const char *zCur,*zCurEnd;` |
|     13433 | 1224 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1225 | `	SyToken sToken;` |
|         - | 1226 | `	SyString sDoc;` |
|         - | 1227 | `	sxu32 nLine;` |
|         - | 1228 | `	sxi32 iNest;` |
...
|     13433 | 1232 | `	nLine = nBaseLine;` |
|     13433 | 1233 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13433 | 1234 | `	sToken.pUserData = 0;` |
|     13433 | 1235 | `	iNest = 0;` |
|     13433 | 1236 | `	sDoc.nByte = 0;` |
|     13433 | 1237 | `	sDoc.zString = ""; /* cc warning */` |
|     13428 | 1238 | `	for(;;){` |
|     26861 | 1239 | `		if( zIn >= zEnd ){` |
|         - | 1240 | `			/* End of input reached */` |
|     13423 | 1241 | `			break;` |
|         - | 1242 | `		}` |
|     13443 | 1243 | `		sToken.nLine = nLine;` |
|     13443 | 1244 | `		zCur = zIn;` |
|     13443 | 1245 | `		zCurEnd = 0;` |
|     13635 | 1246 | `		while( zIn < zEnd ){` |
|     13625 | 1247 | `			 if( zIn[0] == '<' ){` |
|     13433 | 1248 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     13433 | 1249 | `				zIn++;` |
|     13433 | 1250 | `				if( zIn < zEnd ){` |
|     13433 | 1251 | `					if( zIn[0] == '?' ){` |
|     13433 | 1252 | `						zIn++;` |
|     13433 | 1253 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1254 | `							/* opening tag: <?php */` |
|     13431 | 1255 | `							zIn += sizeof("php")-1;` |
|      6713 | 1256 | `						}` |
|         - | 1257 | `						/* Look for the closing tag '?>' */` |
|     13433 | 1258 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     13433 | 1259 | `						zCurEnd = zTmp;` |
|     13433 | 1260 | `						break;` |
|         - | 1261 | `					}` |
|       ! 0 | 1262 | `				}` |
|       ! 0 | 1263 | `			}else{` |
...
|     13443 | 1270 | `		if( zCurEnd == 0 ){` |
|        13 | 1271 | `			zCurEnd = zIn;` |
|         5 | 1272 | `		}` |
|         - | 1273 | `		/* Save the raw token */` |
|     13443 | 1274 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13443 | 1275 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13443 | 1276 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13443 | 1277 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1278 | `			return rc;` |
|         - | 1279 | `		}` |
|     13443 | 1280 | `		if( zIn >= zEnd ){` |
|        13 | 1281 | `			break;` |
|         - | 1282 | `		}` |
|         - | 1283 | `		/* Ignore leading white space */` |
|     28597 | 1284 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     15169 | 1285 | `			if( zIn[0] == '\n' ){` |
|     14719 | 1286 | `				nLine++;` |
|      7357 | 1287 | `			}` |
|     15169 | 1288 | `			zIn++;` |
...
|     13433 | 1291 | `		sToken.nLine = nLine;` |
|     13433 | 1292 | `		zCur = zIn;` |
|   1855261 | 1293 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1294 | `			const char *zPtr;` |
|   1849059 | 1295 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7227 | 1296 | `				break;` |
|         - | 1297 | `			}` |
|    924658 | 1298 | `			for(;;){` |
|   1849321 | 1299 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|    920921 | 1300 | `					break;` |
|         - | 1301 | `				}` |
|      7489 | 1302 | `				zIn += 2;` |
|      7489 | 1303 | `				if( zIn[-1] == '/' ){` |
...
|      3601 | 1311 | `				}else{` |
|         - | 1312 | `					/* Block comment */` |
|     29383 | 1313 | `					while( (sxu32)(zEnd-zIn) >= sizeof("*/") - 1 ){` |
|     29383 | 1314 | `						if( zIn[0] == '*' && zIn[1] == '/' ){` |
|       297 | 1315 | `							zIn += 2;` |
|       297 | 1316 | `							break;` |
|         - | 1317 | `						}` |
|     29091 | 1318 | `						if( zIn[0] == '\n' ){` |
...
|         - | 1323 | `				}` |
|         5 | 1324 | `			}` |
|   1841837 | 1325 | `			if( zIn[0] == '\n' ){` |
|     61493 | 1326 | `				nLine++;` |
|     61493 | 1327 | `				if( iNest > 0 ){` |
|       328 | 1328 | `					zIn++;` |
...
|       328 | 1347 | `					continue;` |
|         5 | 1348 | `				}` |
|   1810931 | 1349 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1841395 | 1376 | `			zIn++;` |
|         - | 1377 |  |
|   1841395 | 1378 | `			if ( zIn >= zEnd )` |
|         5 | 1379 | `				break;` |
|         5 | 1380 | `		}` |
|     13433 | 1381 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6211 | 1382 | `			zIn = zEnd;` |
|      3103 | 1383 | `		}` |
|     13433 | 1384 | `		if( zCur < zIn ){` |
|         - | 1385 | `			/* Save the PHP chunk for later processing */` |
|     10215 | 1386 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     10215 | 1387 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|     20269 | 1388 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     10215 | 1389 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     10215 | 1390 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1391 | `				return rc;` |
|         - | 1392 | `			}` |
|      5105 | 1393 | `		}` |
|     13433 | 1394 | `		if( zIn < zEnd ){` |
|         - | 1395 | `			/* Jump the trailing closing tag */` |
|      7227 | 1396 | `			zIn += sCtag.nByte;` |
|         - | 1397 | `			/* php's lexer swallows exactly ONE newline immediately after the` |
|         - | 1398 | `			 * closing tag ("?>\n" emits nothing) */` |
|      7227 | 1399 | `			if( zIn < zEnd && zIn[0] == '\r' && zIn + 1 < zEnd && zIn[1] == '\n' ){` |
|       ! 0 | 1400 | `				zIn += 2;` |
|       ! 0 | 1401 | `				nLine++;` |
|      7227 | 1402 | `			}else if( zIn < zEnd && zIn[0] == '\n' ){` |
|        63 | 1403 | `				zIn++;` |
|        63 | 1404 | `				nLine++;` |
|        29 | 1405 | `			}` |
|      3611 | 1406 | `		}` |
