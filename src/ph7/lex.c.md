...
|        - |   18 | ` */` |
|  4519936 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|        2 |   20 |  |
|        - |   21 | `	SyString *pStr;` |
|        - |   22 | `	sxi32 rc;` |
|        - |   23 | `	/* Ignore leading white spaces */` |
|  6811518 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|        - |   25 | `		/* Advance the stream cursor */` |
|  2291582 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|        - |   27 | `			/* Update line counter */` |
|    23974 |   28 | `			pStream->nLine++;` |
|    11986 |   29 | `		}` |
|  2291582 |   30 | `		pStream->zText++;` |
|        2 |   31 | `	}` |
|  4519938 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|        - |   33 | `		/* End of input reached */` |
|      ! 0 |   34 | `		return SXERR_EOF;` |
|        - |   35 | `	}` |
|        - |   36 | `	/* Record token starting position and line */` |
|  4519938 |   37 | `	pToken->nLine = pStream->nLine;` |
|  4519938 |   38 | `	pToken->pUserData = 0;` |
|  4519938 |   39 | `	pStr = &pToken->sData;` |
|  4519938 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
|  5305766 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  1571658 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  1571642 |   53 | `			pStream->zText++;` |
|   785820 |   54 | `		}` |
|  1537830 |   55 | `		for(;;){` |
|  3075662 |   56 | `			zIn = pStream->zText;` |
|  3075662 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|       49 |   58 | `				zIn++;` |
|        - |   59 | `				/* UTF-8 stream */` |
...
| 12207472 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
|  7593982 |   66 | `				zIn++;` |
|        2 |   67 | `			}` |
|  3075662 |   68 | `			if( zIn == pStream->zText ){` |
|        - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  1571658 |   70 | `				break;` |
|        - |   71 | `			}` |
|        - |   72 | `			/* Synchronize pointers */` |
|  1504006 |   73 | `			pStream->zText = zIn;` |
|        2 |   74 | `		}` |
|        - |   75 | `		/* Record token length */` |
|  1571658 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  1571658 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
|  1571658 |   78 | `		if( nKeyword != PH7_TK_ID ){` |
|   501358 |   79 | `			if( nKeyword &` |
...
|    10424 |   82 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|        - |   83 | `					/* Mark as an operator */` |
|    10424 |   84 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|     5213 |   85 | `			}else{` |
|        - |   86 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|   490936 |   87 | `				pToken->nType = PH7_TK_KEYWORD;` |
|   490936 |   88 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|        - |   89 | `			}` |
|   250680 |   90 | `		}else{` |
|        - |   91 | `			/* A simple identifier */` |
|  1070302 |   92 | `			pToken->nType = PH7_TK_ID;` |
|        - |   93 | `		}` |
|   785830 |   94 | `	}else{` |
|        - |   95 | `		sxi32 c;` |
|        - |   96 | `		/* Non-alpha stream */` |
|  2974152 |   97 | `		if( pStream->zText[0] == '#' \|\|` |
|  2948280 |   98 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
...
|  2944680 |  106 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
|    48082 |  107 | `			pStream->zText += 2;` |
|        - |  108 | `			/* Block comment */` |
|  1364400 |  109 | `			while( pStream->zText < pStream->zEnd ){` |
|  1364400 |  110 | `				if( pStream->zText[0] == '*' ){` |
|    48108 |  111 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    24042 |  112 | `						break;` |
|        - |  113 | `					}` |
|       13 |  114 | `				}` |
|  1316320 |  115 | `				if( pStream->zText[0] == '\n' ){` |
|       28 |  116 | `					pStream->nLine++;` |
|       13 |  117 | `				}` |
|  1316320 |  118 | `				pStream->zText++;` |
|        2 |  119 | `			}` |
|    48082 |  120 | `			pStream->zText += 2;` |
|        - |  121 | `			/* Tell the upper-layer to ignore this token */` |
|    48082 |  122 | `			return SXERR_CONTINUE;` |
|  2896600 |  123 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|    66532 |  124 | `			pStream->zText++;` |
|        - |  125 | `			/* Decimal digit stream */` |
|    72882 |  126 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|     6352 |  127 | `				pStream->zText++;` |
|        2 |  128 | `			}` |
|        - |  129 | `			/* Mark the token as integer until we encounter a real number */` |
|    66532 |  130 | `			pToken->nType = PH7_TK_INTEGER;` |
|    66532 |  131 | `			if( pStream->zText < pStream->zEnd ){` |
|    66528 |  132 | `				c = pStream->zText[0];` |
|    66528 |  133 | `				if( c == '.' ){` |
|        - |  134 | `					/* Real number */` |
...
|    66532 |  186 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    66532 |  187 | `			return SXRET_OK;` |
|        - |  188 | `		}` |
|  2830070 |  189 | `		c = pStream->zText[0];` |
|  2830070 |  190 | `		pStream->zText++; /* Advance the stream cursor */` |
|        - |  191 | `		/* Assume we are dealing with an operator*/` |
|  2830070 |  192 | `		pToken->nType = PH7_TK_OP;` |
|  2830070 |  193 | `		switch(c){` |
|   610738 |  194 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   204084 |  195 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   204070 |  196 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|   429492 |  197 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|    51396 |  198 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|        - |  199 | `														 * is a potential operator [i.e: subscripting] */` |
|    51402 |  200 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   214739 |  201 | `		case ')': {` |
|   429480 |  202 | `			SySet *pTokSet = pStream->pSet;` |
|        - |  203 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|   429480 |  204 | `			if( pTokSet->nUsed >= 2 ){` |
|        - |  205 | `				SyToken *pTmp;` |
|        - |  206 | `				/* Peek the last recongnized token */` |
|   429478 |  207 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|   429478 |  208 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|    10274 |  209 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|    10274 |  210 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|    10218 |  211 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|    10218 |  212 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|        - |  213 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    10134 |  214 | `							const char * zTypeCast = "(int)";` |
|    10134 |  215 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|     2008 |  216 | `								zTypeCast = "(float)";` |
|     9131 |  217 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|     2010 |  218 | `								zTypeCast = "(bool)";` |
|     7124 |  219 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|     4010 |  220 | `								zTypeCast = "(string)";` |
|     4116 |  221 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|       21 |  222 | `								zTypeCast = "(array)";` |
|     2102 |  223 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|       17 |  224 | `								zTypeCast = "(object)";` |
|     2084 |  225 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|        7 |  226 | `								zTypeCast = "(unset)";` |
|        3 |  227 | `							}` |
|        - |  228 | `							/* Reflect the change */` |
|    10134 |  229 | `							pToken->nType = PH7_TK_OP;` |
|    10134 |  230 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|        - |  231 | `							/* Save the instance associated with the type cast operator */` |
|    10134 |  232 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|        - |  233 | `							/* Remove the two previous tokens */` |
|    10134 |  234 | `							pTokSet->nUsed -= 2;` |
|    10134 |  235 | `							return SXRET_OK;` |
|        - |  236 | `						}` |
|       42 |  237 | `					}` |
|       70 |  238 | `				}` |
|   209672 |  239 | `			}` |
|   419348 |  240 | `			pToken->nType = PH7_TK_RPAREN;` |
|   419348 |  241 | `			break;` |
|        - |  242 | `				  }` |
|    22268 |  243 | `		case '\'':{` |
|        - |  244 | `			/* Single quoted string */` |
|    44538 |  245 | `			pStr->zString++;` |
|   552848 |  246 | `			while( pStream->zText < pStream->zEnd ){` |
|   552848 |  247 | `				if( pStream->zText[0] == '\''  ){` |
|    44548 |  248 | `					if( pStream->zText[-1] != '\\' ){` |
|    44524 |  249 | `						break;` |
|      ! 0 |  250 | `					}else{` |
...
|        - |  260 | `					}` |
|        5 |  261 | `				}` |
|   508312 |  262 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  263 | `					pStream->nLine++;` |
|        3 |  264 | `				}` |
|   508312 |  265 | `				pStream->zText++;` |
|        2 |  266 | `			}` |
|        - |  267 | `			/* Record token length and type */` |
|    44538 |  268 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    44538 |  269 | `			pToken->nType = PH7_TK_SSTR;` |
|        - |  270 | `			/* Jump the trailing single quote */` |
|    44538 |  271 | `			pStream->zText++;` |
|    44538 |  272 | `			return SXRET_OK;` |
|        - |  273 | `				  }` |
|     6304 |  274 | `		case '"':{` |
|        - |  275 | `			sxi32 iNest;` |
|        - |  276 | `			/* Double quoted string */` |
|    12610 |  277 | `			pStr->zString++;` |
|   138618 |  278 | `			while( pStream->zText < pStream->zEnd ){` |
|   138618 |  279 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       71 |  280 | `					iNest = 1;` |
...
|        - |  299 | `					}` |
|       35 |  300 | `				}` |
|   138618 |  301 | `				if( pStream->zText[0] == '"' ){` |
|    12710 |  302 | `					if( pStream->zText[-1] != '\\' ){` |
|    12606 |  303 | `						break;` |
|      ! 0 |  304 | `					}else{` |
...
|        - |  314 | `					}` |
|       50 |  315 | `				}` |
|   126010 |  316 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  317 | `					pStream->nLine++;` |
|        3 |  318 | `				}` |
|   126010 |  319 | `				pStream->zText++;` |
|        2 |  320 | `			}` |
|        - |  321 | `			/* Record token length and type */` |
|    12610 |  322 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    12610 |  323 | `			pToken->nType = PH7_TK_DSTR;` |
|        - |  324 | `			/* Jump the trailing quote */` |
|    12610 |  325 | `			pStream->zText++;` |
|    12610 |  326 | `			return SXRET_OK;` |
|        - |  327 | `				  }` |
|        2 |  328 | ``		case '`':{`` |
...
|      934 |  348 | `		case ':':` |
|     1870 |  349 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|        - |  350 | `				/* Current operator: '::' */` |
|       56 |  351 | `				pStream->zText++;` |
|       29 |  352 | `			}else{` |
|     1816 |  353 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|        - |  354 | `			}` |
|     1870 |  355 | `			break;` |
|    45224 |  356 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   321114 |  357 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|        - |  358 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   102608 |  359 | `		case '=':` |
|   205218 |  360 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   205218 |  361 | `			if( pStream->zText < pStream->zEnd ){` |
|   205218 |  362 | `				if( pStream->zText[0] == '=' ){` |
|    13378 |  363 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|        - |  364 | `					/* Current operator: == */` |
|    13378 |  365 | `					pStream->zText++;` |
|    13378 |  366 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  367 | `						/* Current operator: === */` |
|     3092 |  368 | `						pStream->zText++;` |
|     1547 |  369 | `					}` |
|   198530 |  370 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  371 | `					/* Array operator: => */` |
|     3142 |  372 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|     3142 |  373 | `					pStream->zText++;` |
|     1572 |  374 | `				}else{` |
|        - |  375 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   188702 |  376 | `					const unsigned char *zCur = pStream->zText;` |
|   188702 |  377 | `					sxu32 nLine = 0;` |
|   377380 |  378 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   188680 |  379 | `						if( zCur[0] == '\n' ){` |
|        5 |  380 | `							nLine++;` |
|        2 |  381 | `						}` |
|   188680 |  382 | `						zCur++;` |
|        2 |  383 | `					}` |
|   188702 |  384 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   205218 |  394 | `			break;` |
|    14329 |  395 | `		case '!':` |
|    28660 |  396 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  397 | `				/* Current operator: != */` |
|    12162 |  398 | `				pStream->zText++;` |
|    12162 |  399 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  400 | `					/* Current operator: !== */` |
|    10134 |  401 | `					pStream->zText++;` |
|     5066 |  402 | `				}` |
|     6080 |  403 | `			}` |
|    28660 |  404 | `			break;` |
|     8219 |  405 | `		case '&':` |
|    16440 |  406 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    16440 |  407 | `			if( pStream->zText < pStream->zEnd ){` |
|    16440 |  408 | `				if( pStream->zText[0] == '&' ){` |
|     6358 |  409 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|        - |  410 | `					/* Current operator: && */` |
|     6358 |  411 | `					pStream->zText++;` |
|    13262 |  412 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    16440 |  418 | `			break;` |
|     1074 |  419 | `		case '\|':` |
|     2150 |  420 | `			if( pStream->zText < pStream->zEnd ){` |
|     2150 |  421 | `				if( pStream->zText[0] == '\|' ){` |
|        - |  422 | `					/* Current operator: \|\| */` |
|     2134 |  423 | `					pStream->zText++;` |
|     1083 |  424 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     2150 |  429 | `			break;` |
|     5286 |  430 | `		case '+':` |
|    10574 |  431 | `			if( pStream->zText < pStream->zEnd ){` |
|    10572 |  432 | `				if( pStream->zText[0] == '+' ){` |
|        - |  433 | `					/* Current operator: ++ */` |
|     8200 |  434 | `					pStream->zText++;` |
|     6473 |  435 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    10574 |  440 | `			break;` |
|    38394 |  441 | `		case '-':` |
|    76790 |  442 | `			if( pStream->zText < pStream->zEnd ){` |
|    76790 |  443 | `				if( pStream->zText[0] == '-' ){` |
|        - |  444 | `					/* Current operator: -- */` |
|        5 |  445 | `					pStream->zText++;` |
|    76788 |  446 | `				}else if( pStream->zText[0] == '=' ){` |
|        - |  447 | `					/* Current operator: -= */` |
|        3 |  448 | `					pStream->zText++;` |
|    76785 |  449 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  450 | `					/* Current operator: -> */` |
|    76356 |  451 | `					pStream->zText++;` |
|    38177 |  452 | `				}` |
|    38394 |  453 | `			}` |
|    76790 |  454 | `			break;` |
|       70 |  455 | `		case '*':` |
...
|       19 |  478 | `			break;` |
|    21808 |  479 | `		case '.':` |
|    43618 |  480 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  481 | `				/* Current operator: .= */` |
|     2046 |  482 | `				pStream->zText++;` |
|     1022 |  483 | `			}` |
|    43618 |  484 | `			break;` |
|    17185 |  485 | `		case '<':` |
|    34372 |  486 | `			if( pStream->zText < pStream->zEnd ){` |
|    34372 |  487 | `				if( pStream->zText[0] == '<' ){` |
...
|      ! 0 |  503 | `						}` |
|        9 |  504 | `					}` |
|    34308 |  505 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  506 | `					/* Current operator: <> */` |
|        5 |  507 | `					pStream->zText++;` |
|    34298 |  508 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    34316 |  513 | `			break;` |
|     2100 |  514 | `		case '>':` |
|     4202 |  515 | `			if( pStream->zText < pStream->zEnd ){` |
|     4202 |  516 | `				if( pStream->zText[0] == '>' ){` |
...
|        9 |  521 | `						pStream->zText++;` |
|        5 |  522 | `					}` |
|     4194 |  523 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     1792 |  530 | `			break;` |
|        - |  531 | `		}` |
|  2762734 |  532 | `		if( pStr->nByte <= 0 ){` |
|        - |  533 | `			/* Record token length */` |
|  2762692 |  534 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  1381345 |  535 | `		}` |
|  2762734 |  536 | `		if( pToken->nType & PH7_TK_OP ){` |
|        - |  537 | `			const ph7_expr_op *pOp;` |
|        - |  538 | `			/* Check if the extracted token is an operator */` |
|   517518 |  539 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|   517518 |  540 | `			if( pOp == 0 ){` |
|        - |  541 | `				/* Not an operator */` |
...
|        - |  569 | `*/` |
|        - |  570 | `/* Hash score: 103 */` |
|  1571658 |  571 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|        - |  659 | `  };` |
|        - |  660 | `  int h, i;` |
|  1571658 |  661 | `  if( n<2 ) return PH7_TK_ID;` |
|  1503984 |  662 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  2293294 |  663 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  1290668 |  664 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|        - |  747 | `       /* PH7_TKWRD_OR */` |
|        - |  748 | `       /* PH7_TKWRD_BREAK */` |
|   501358 |  749 | `      return aCode[i];` |
|        - |  750 | `    }` |
|   394657 |  751 | `  }` |
|  1002628 |  752 | `  return PH7_TK_ID;` |
|   785830 |  753 |  |
...
|        - |  908 | ` */` |
|    11344 |  909 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut)` |
|        2 |  910 |  |
|        - |  911 | `	SyLex sLexer;` |
|        - |  912 | `	sxi32 rc;` |
|        - |  913 | `	/* Initialize the lexer */` |
|    11346 |  914 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,0);` |
|    11346 |  915 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  916 | `		return rc;` |
|        - |  917 | `	}` |
|    11346 |  918 | `	sLexer.sStream.nLine = nLineStart;` |
|        - |  919 | `	/* Tokenize input */` |
|    11346 |  920 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|        - |  921 | `	/* Release the lexer */` |
|    11346 |  922 | `	SyLexRelease(&sLexer);` |
...
|        - |  970 | ` */` |
|     9492 |  971 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|        2 |  972 |  |
|     9494 |  973 | `	const char *zEnd = &zInput[nLen];` |
|     9494 |  974 | `	const char *zIn  = zInput;` |
|        - |  975 | `	const char *zCur,*zCurEnd;` |
|     9494 |  976 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|        - |  977 | `	SyToken sToken;` |
|        - |  978 | `	SyString sDoc;` |
|        - |  979 | `	sxu32 nLine;` |
|        - |  980 | `	sxi32 iNest;` |
...
|     9494 |  983 | `	nLine = 1;` |
|     9494 |  984 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     9494 |  985 | `	sToken.pUserData = 0;` |
|     9494 |  986 | `	iNest = 0;` |
|     9494 |  987 | `	sDoc.nByte = 0;` |
|     9494 |  988 | `	sDoc.zString = ""; /* cc warning */` |
|     9494 |  989 | `	for(;;){` |
|    18990 |  990 | `		if( zIn >= zEnd ){` |
|        - |  991 | `			/* End of input reached */` |
|     9490 |  992 | `			break;` |
|        - |  993 | `		}` |
|     9502 |  994 | `		sToken.nLine = nLine;` |
|     9502 |  995 | `		zCur = zIn;` |
|     9502 |  996 | `		zCurEnd = 0;` |
|     9510 |  997 | `		while( zIn < zEnd ){` |
|     9506 |  998 | `			 if( zIn[0] == '<' ){` |
|     9498 |  999 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     9498 | 1000 | `				zIn++;` |
|     9498 | 1001 | `				if( zIn < zEnd ){` |
|     9498 | 1002 | `					if( zIn[0] == '?' ){` |
|     9498 | 1003 | `						zIn++;` |
|     9498 | 1004 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|        - | 1005 | `							/* opening tag: <?php */` |
|     9496 | 1006 | `							zIn += sizeof("php")-1;` |
|     4747 | 1007 | `						}` |
|        - | 1008 | `						/* Look for the closing tag '?>' */` |
|     9498 | 1009 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     9498 | 1010 | `						zCurEnd = zTmp;` |
|     9498 | 1011 | `						break;` |
|        - | 1012 | `					}` |
|      ! 0 | 1013 | `				}` |
|      ! 0 | 1014 | `			}else{` |
...
|     9502 | 1021 | `		if( zCurEnd == 0 ){` |
|        5 | 1022 | `			zCurEnd = zIn;` |
|        2 | 1023 | `		}` |
|        - | 1024 | `		/* Save the raw token */` |
|     9502 | 1025 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     9502 | 1026 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     9502 | 1027 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     9502 | 1028 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 1029 | `			return rc;` |
|        - | 1030 | `		}` |
|     9502 | 1031 | `		if( zIn >= zEnd ){` |
|        5 | 1032 | `			break;` |
|        - | 1033 | `		}` |
|        - | 1034 | `		/* Ignore leading white space */` |
|    20650 | 1035 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|    11154 | 1036 | `			if( zIn[0] == '\n' ){` |
|     9992 | 1037 | `				nLine++;` |
|     4995 | 1038 | `			}` |
|    11154 | 1039 | `			zIn++;` |
...
|     9498 | 1042 | `		sToken.nLine = nLine;` |
|     9498 | 1043 | `		zCur = zIn;` |
|   847570 | 1044 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|        - | 1045 | `			const char *zPtr;` |
|   843552 | 1046 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|     5480 | 1047 | `				break;` |
|        - | 1048 | `			}` |
|   420899 | 1049 | `			for(;;){` |
|   841800 | 1050 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|   419038 | 1051 | `					break;` |
|        - | 1052 | `				}` |
|     3728 | 1053 | `				zIn += 2;` |
|     3728 | 1054 | `				if( zIn[-1] == '/' ){` |
...
|        - | 1074 | `				}` |
|        2 | 1075 | `			}` |
|   838074 | 1076 | `			if( zIn[0] == '\n' ){` |
|    28584 | 1077 | `				nLine++;` |
|    28584 | 1078 | `				if( iNest > 0 ){` |
|      156 | 1079 | `					zIn++;` |
...
|      156 | 1098 | `					continue;` |
|        2 | 1099 | `				}` |
|   823706 | 1100 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   837860 | 1127 | `			zIn++;` |
|        - | 1128 |  |
|   837860 | 1129 | `			if ( zIn >= zEnd )` |
|      ! 0 | 1130 | `				break;` |
|        2 | 1131 | `		}` |
|     9498 | 1132 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|     4020 | 1133 | `			zIn = zEnd;` |
|     2009 | 1134 | `		}` |
|     9498 | 1135 | `		if( zCur < zIn ){` |
|        - | 1136 | `			/* Save the PHP chunk for later processing */` |
|     7864 | 1137 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     7864 | 1138 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|    15706 | 1139 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     7864 | 1140 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     7864 | 1141 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1142 | `				return rc;` |
|        - | 1143 | `			}` |
|     3931 | 1144 | `		}` |
|     9498 | 1145 | `		if( zIn < zEnd ){` |
|        - | 1146 | `			/* Jump the trailing closing tag */` |
|     5480 | 1147 | `			zIn += sCtag.nByte;` |
|     2739 | 1148 | `		}` |
|        2 | 1149 | `	} /* For(;;) */` |
|        - | 1150 |  |
|     9494 | 1151 | ` 	return SXRET_OK;` |
|     4748 | 1152 |  |
|        - | 1153 |  |
