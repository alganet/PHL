...
|         - |   18 | ` */` |
| 174300546 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 257571779 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  83271233 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     55493 |   28 | `			pStream->nLine++;` |
|     27744 |   29 | `		}` |
|  83271233 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 174300551 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 174300551 |   37 | `	pToken->nLine = pStream->nLine;` |
| 174300551 |   38 | `	pToken->pUserData = 0;` |
| 174300551 |   39 | `	pStr = &pToken->sData;` |
| 174300551 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 203335998 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  58070899 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  58070883 |   53 | `			pStream->zText++;` |
|  29035439 |   54 | `		}` |
|  54436909 |   55 | `		for(;;){` |
| 108873823 |   56 | `			zIn = pStream->zText;` |
| 108873823 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 433450214 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 270139487 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
| 108873823 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  58070899 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  50802929 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  58070899 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  58070899 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  58070894 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  20033615 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       849 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       422 |   85 | `		}` |
|  58070899 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  19357429 |   87 | `			if( nKeyword &` |
...
|  18433275 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  18433275 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   9678717 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  38713475 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  29035452 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 116229657 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 116336273 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 116221714 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|      7311 |  188 | `				pStream->zText++;` |
|         - |  189 | `				/* Inline comments */` |
|    314415 |  190 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|    307109 |  191 | `					pStream->zText++;` |
|         5 |  192 | `				}` |
|         - |  193 | `				/* Tell the upper-layer to ignore this token */` |
|      7311 |  194 | `				return SXERR_CONTINUE;` |
| 116214419 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
| 115996609 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3775047 |  234 | `			pStream->zText++;` |
...
|   3775042 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3775042 |  239 | `				&& pStream->zText[0] == '_'` |
|   1887601 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4756565 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
...
|   3775047 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3775047 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3775047 |  259 | `				c = pStream->zText[0];` |
|   3775047 |  260 | `				if( c == '.' ){` |
...
|   3775047 |  363 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3775047 |  371 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3775047 |  372 | `			return SXRET_OK;` |
|         - |  373 | `		}` |
| 112221567 |  374 | `		c = pStream->zText[0];` |
| 112221567 |  375 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  376 | `		/* Assume we are dealing with an operator*/` |
| 112221567 |  377 | `		pToken->nType = PH7_TK_OP;` |
| 112221567 |  378 | `		switch(c){` |
|  23155169 |  379 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   6879763 |  380 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   6879749 |  381 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  14412021 |  382 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|   3206457 |  383 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|         - |  384 | `														 * is a potential operator [i.e: subscripting] */` |
|   3206463 |  385 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   7205996 |  386 | `		case ')': {` |
|  14411997 |  387 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  388 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  14411997 |  389 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  390 | `				SyToken *pTmp;` |
|         - |  391 | `				/* Peek the last recongnized token */` |
|  14411995 |  392 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  14411995 |  393 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|    217699 |  423 | `				}` |
|   6900893 |  424 | `			}` |
|  13801793 |  425 | `			pToken->nType = PH7_TK_RPAREN;` |
|  13801793 |  426 | `			break;` |
|         - |  427 | `				  }` |
|   2661534 |  428 | `		case '\'':{` |
...
|    126301 |  462 | `			pStr->zString++;` |
|   1750009 |  463 | `			while( pStream->zText < pStream->zEnd ){` |
|   1750009 |  464 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       145 |  465 | `					iNest = 1;` |
...
|         - |  484 | `					}` |
|        71 |  485 | `				}` |
|   1750009 |  486 | `				if( pStream->zText[0] == '"' ){` |
|    126595 |  487 | `					if( pStream->zText[-1] != '\\' ){` |
|    126293 |  488 | `						break;` |
|       ! 0 |  489 | `					}else{` |
...
|         - |  499 | `					}` |
|       147 |  500 | `				}` |
|   1623713 |  501 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  502 | `					pStream->nLine++;` |
|        14 |  503 | `				}` |
|   1623713 |  504 | `				pStream->zText++;` |
|         5 |  505 | `			}` |
|         - |  506 | `			/* Record token length and type */` |
|    126301 |  507 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    126301 |  508 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  509 | `			/* Jump the trailing quote */` |
|    126301 |  510 | `			pStream->zText++;` |
|    126301 |  511 | `			return SXRET_OK;` |
|         - |  512 | `				  }` |
|         2 |  513 | ``		case '`':{`` |
...
|         - |  539 | `			}` |
|    980737 |  540 | `			break;` |
|   3866699 |  541 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|  10925251 |  542 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
...
|     15836 |  749 | `			break;` |
|         - |  750 | `		}` |
| 106161873 |  751 | `		if( pStr->nByte <= 0 ){` |
|         - |  752 | `			/* Record token length */` |
| 106161801 |  753 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  53080898 |  754 | `		}` |
| 106161873 |  755 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  756 | `			const ph7_expr_op *pOp;` |
|         - |  757 | `			/* Check if the extracted token is an operator */` |
|  25765833 |  758 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  25765833 |  759 | `			if( pOp == 0 ){` |
|         - |  760 | `				/* Not an operator */` |
...
|         - |  791 | `*/` |
|         - |  792 | `/* Hash score: 103 */` |
|  58070899 |  793 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  881 | `  };` |
|         - |  882 | `  int h, i;` |
|  58070899 |  883 | `  if( n<2 ) return PH7_TK_ID;` |
|  50802907 |  884 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  78331657 |  885 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  46876877 |  886 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  969 | `       /* PH7_TKWRD_OR */` |
|         - |  970 | `       /* PH7_TKWRD_BREAK */` |
|  19348127 |  971 | `      return aCode[i];` |
|         - |  972 | `    }` |
|  13764378 |  973 | `  }` |
|         - |  974 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  31454785 |  975 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  31446921 |  976 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  31446917 |  977 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  31446745 |  978 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  31430819 |  979 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  31430741 |  980 | `  return PH7_TK_ID;` |
|  29035452 |  981 | `}` |
...
|         - | 1150 | ` */` |
|     87198 | 1151 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut,SySet *pTrivia)` |
|         5 | 1152 | `{` |
|         - | 1153 | `	SyLex sLexer;` |
|         - | 1154 | `	sxi32 rc;` |
|         - | 1155 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|     87203 | 1156 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
...
|     87203 | 1162 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,pTrivia);` |
|     87203 | 1163 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1164 | `		return rc;` |
|         - | 1165 | `	}` |
|     87203 | 1166 | `	sLexer.sStream.nLine = nLineStart;` |
|         - | 1167 | `	/* Tokenize input */` |
|     87203 | 1168 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|         - | 1169 | `	/* Release the lexer */` |
|     87203 | 1170 | `	SyLexRelease(&sLexer);` |
|         - | 1171 | `	/* Tokenization result */` |
|     87203 | 1172 | `	return rc;` |
|     43604 | 1173 | `}` |
|         - | 1174 | `/*` |
...
|         - | 1218 | ` */` |
|     13760 | 1219 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut,sxu32 nBaseLine)` |
|         5 | 1220 | `{` |
|     13765 | 1221 | `	const char *zEnd = &zInput[nLen];` |
|     13765 | 1222 | `	const char *zIn  = zInput;` |
|         - | 1223 | `	const char *zCur,*zCurEnd;` |
|     13765 | 1224 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1225 | `	SyToken sToken;` |
|         - | 1226 | `	SyString sDoc;` |
|         - | 1227 | `	sxu32 nLine;` |
|         - | 1228 | `	sxi32 iNest;` |
...
|     13765 | 1232 | `	nLine = nBaseLine;` |
|     13765 | 1233 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13765 | 1234 | `	sToken.pUserData = 0;` |
|     13765 | 1235 | `	iNest = 0;` |
|     13765 | 1236 | `	sDoc.nByte = 0;` |
|     13765 | 1237 | `	sDoc.zString = ""; /* cc warning */` |
|     13755 | 1238 | `	for(;;){` |
|     27345 | 1239 | `		if( zIn >= zEnd ){` |
|         - | 1240 | `			/* End of input reached */` |
|     13575 | 1241 | `			break;` |
|         - | 1242 | `		}` |
|     13775 | 1243 | `		sToken.nLine = nLine;` |
|     13775 | 1244 | `		zCur = zIn;` |
|     13775 | 1245 | `		zCurEnd = 0;` |
|     14115 | 1246 | `		while( zIn < zEnd ){` |
|     13925 | 1247 | `			 if( zIn[0] == '<' ){` |
|     13585 | 1248 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     13585 | 1249 | `				zIn++;` |
|     13585 | 1250 | `				if( zIn < zEnd ){` |
|     13585 | 1251 | `					if( zIn[0] == '?' ){` |
|     13585 | 1252 | `						zIn++;` |
|     13585 | 1253 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1254 | `							/* opening tag: <?php */` |
|     13583 | 1255 | `							zIn += sizeof("php")-1;` |
|      6789 | 1256 | `						}` |
|         - | 1257 | `						/* Look for the closing tag '?>' */` |
|     13585 | 1258 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     13585 | 1259 | `						zCurEnd = zTmp;` |
|     13585 | 1260 | `						break;` |
|         - | 1261 | `					}` |
|       ! 0 | 1262 | `				}` |
|       ! 0 | 1263 | `			}else{` |
...
|     13775 | 1270 | `		if( zCurEnd == 0 ){` |
|        23 | 1271 | `			zCurEnd = zIn;` |
|        10 | 1272 | `		}` |
|         - | 1273 | `		/* Save the raw token */` |
|     13775 | 1274 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13775 | 1275 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13775 | 1276 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13775 | 1277 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1278 | `			return rc;` |
|         - | 1279 | `		}` |
|     13775 | 1280 | `		if( zIn >= zEnd ){` |
|        23 | 1281 | `			break;` |
|         - | 1282 | `		}` |
|         - | 1283 | `		/* Ignore leading white space */` |
|     29071 | 1284 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     15321 | 1285 | `			if( zIn[0] == '\n' ){` |
|     14857 | 1286 | `				nLine++;` |
|      7426 | 1287 | `			}` |
|     15321 | 1288 | `			zIn++;` |
...
|     13755 | 1291 | `		sToken.nLine = nLine;` |
|     13755 | 1292 | `		zCur = zIn;` |
|   1559499 | 1293 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1294 | `			const char *zPtr;` |
|   1553207 | 1295 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7293 | 1296 | `				break;` |
|         - | 1297 | `			}` |
...
|   1549773 | 1303 | `			if( iNest < 1 &&` |
|   1541942 | 1304 | `				( (zIn[0] == '#' && !(zIn+1 < zEnd && zIn[1] == '[')) \|\|` |
|   1541970 | 1305 | `				  (zIn[0] == '/' && zIn+1 < zEnd && zIn[1] == '/') ) ){` |
|      7713 | 1306 | `				zIn += (zIn[0] == '#') ? 1 : 2;` |
|    307519 | 1307 | `				while( zIn < zEnd && zIn[0] != '\n' ){` |
|    299808 | 1308 | `					if( (sxu32)(zEnd - zIn) >= sCtag.nByte` |
|    299810 | 1309 | `						&& SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 ){` |
...
|   1538443 | 1317 | `			if( iNest < 1 && zIn[0] == '/' && zIn+1 < zEnd && zIn[1] == '*' ){` |
|       311 | 1318 | `				zIn += 2;` |
...
|   1538137 | 1339 | ``			if( iNest < 1 && (zIn[0] == '\'' \|\| zIn[0] == '"' \|\| zIn[0] == '`') ){`` |
|     46543 | 1340 | `				int qch = zIn[0];` |
|     46543 | 1341 | `				zIn++;` |
|    336571 | 1342 | `				while( zIn < zEnd ){` |
|    336571 | 1343 | `					if( zIn[0] == '\\' && zIn + 1 < zEnd ){` |
|     18281 | 1344 | `						if( zIn[1] == '\n' ){ nLine++; }` |
|     18281 | 1345 | `						zIn += 2;` |
|     18281 | 1346 | `						continue;` |
|         - | 1347 | `					}` |
|    318295 | 1348 | `					if( zIn[0] == qch ){ zIn++; break; }` |
|    271757 | 1349 | `					if( zIn[0] == '\n' ){ nLine++; }` |
|    271757 | 1350 | `					zIn++;` |
|         5 | 1351 | `				}` |
|     46543 | 1352 | `				continue;` |
|         - | 1353 | `			}` |
|   1491599 | 1354 | `			if( zIn[0] == '\n' ){` |
|     62713 | 1355 | `				nLine++;` |
|     62713 | 1356 | `				if( iNest > 0 ){` |
|       337 | 1357 | `					zIn++;` |
...
|       337 | 1376 | `					continue;` |
|         5 | 1377 | `				}` |
|   1460079 | 1378 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1491145 | 1405 | `			zIn++;` |
|         - | 1406 |  |
|   1491145 | 1407 | `			if ( zIn >= zEnd )` |
|       ! 0 | 1408 | `				break;` |
|         5 | 1409 | `		}` |
|     13585 | 1410 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6297 | 1411 | `			zIn = zEnd;` |
|      3146 | 1412 | `		}` |
|     13585 | 1413 | `		if( zCur < zIn ){` |
|         - | 1414 | `			/* Save the PHP chunk for later processing */` |
|     10337 | 1415 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     10337 | 1416 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|     20479 | 1417 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     10337 | 1418 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     10337 | 1419 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1420 | `				return rc;` |
|         - | 1421 | `			}` |
|      5166 | 1422 | `		}` |
|     13585 | 1423 | `		if( zIn < zEnd ){` |
|         - | 1424 | `			/* Jump the trailing closing tag */` |
|      7293 | 1425 | `			zIn += sCtag.nByte;` |
|         - | 1426 | `			/* php's lexer swallows exactly ONE newline immediately after the` |
|         - | 1427 | `			 * closing tag ("?>\n" emits nothing) */` |
|      7293 | 1428 | `			if( zIn < zEnd && zIn[0] == '\r' && zIn + 1 < zEnd && zIn[1] == '\n' ){` |
|       ! 0 | 1429 | `				zIn += 2;` |
|       ! 0 | 1430 | `				nLine++;` |
|      7293 | 1431 | `			}else if( zIn < zEnd && zIn[0] == '\n' ){` |
|        65 | 1432 | `				zIn++;` |
|        65 | 1433 | `				nLine++;` |
|        30 | 1434 | `			}` |
|      3644 | 1435 | `		}` |
