...
|        - |   18 | ` */` |
|  3984194 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|        2 |   20 |  |
|        - |   21 | `	SyString *pStr;` |
|        - |   22 | `	sxi32 rc;` |
|        - |   23 | `	/* Ignore leading white spaces */` |
|  5964266 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|        - |   25 | `		/* Advance the stream cursor */` |
|  1980072 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|        - |   27 | `			/* Update line counter */` |
|    24074 |   28 | `			pStream->nLine++;` |
|    12036 |   29 | `		}` |
|  1980072 |   30 | `		pStream->zText++;` |
|        2 |   31 | `	}` |
|  3984196 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|        - |   33 | `		/* End of input reached */` |
|      ! 0 |   34 | `		return SXERR_EOF;` |
|        - |   35 | `	}` |
|        - |   36 | `	/* Record token starting position and line */` |
|  3984196 |   37 | `	pToken->nLine = pStream->nLine;` |
|  3984196 |   38 | `	pToken->pUserData = 0;` |
|  3984196 |   39 | `	pStr = &pToken->sData;` |
|  3984196 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
|  4681754 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  1395118 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  1395102 |   53 | `			pStream->zText++;` |
|   697550 |   54 | `		}` |
|  1365356 |   55 | `		for(;;){` |
|  2730714 |   56 | `			zIn = pStream->zText;` |
|  2730714 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|       49 |   58 | `				zIn++;` |
|        - |   59 | `				/* UTF-8 stream */` |
...
| 10853140 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
|  6757072 |   66 | `				zIn++;` |
|        2 |   67 | `			}` |
|  2730714 |   68 | `			if( zIn == pStream->zText ){` |
|        - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  1395118 |   70 | `				break;` |
|        - |   71 | `			}` |
|        - |   72 | `			/* Synchronize pointers */` |
|  1335598 |   73 | `			pStream->zText = zIn;` |
|        2 |   74 | `		}` |
|        - |   75 | `		/* Record token length */` |
|  1395118 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  1395118 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
|  1395118 |   78 | `		if( nKeyword != PH7_TK_ID ){` |
|   452238 |   79 | `			if( nKeyword &` |
...
|     7852 |   82 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|        - |   83 | `					/* Mark as an operator */` |
|     7852 |   84 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|     3927 |   85 | `			}else{` |
|        - |   86 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|   444388 |   87 | `				pToken->nType = PH7_TK_KEYWORD;` |
|   444388 |   88 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|        - |   89 | `			}` |
|   226120 |   90 | `		}else{` |
|        - |   91 | `			/* A simple identifier */` |
|   942882 |   92 | `			pToken->nType = PH7_TK_ID;` |
|        - |   93 | `		}` |
|   697560 |   94 | `	}else{` |
|        - |   95 | `		sxi32 c;` |
|        - |   96 | `		/* Non-alpha stream */` |
|  2614187 |   97 | `		if( pStream->zText[0] == '#' \|\|` |
|  2589078 |   98 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|     3628 |   99 | `				pStream->zText++;` |
|        - |  100 | `				/* Inline comments */` |
|   129746 |  101 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|   126120 |  102 | `					pStream->zText++;` |
|        2 |  103 | `				}` |
|        - |  104 | `				/* Tell the upper-layer to ignore this token */` |
|     3628 |  105 | `				return SXERR_CONTINUE;` |
|  2585454 |  106 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
|    46532 |  107 | `			pStream->zText += 2;` |
|        - |  108 | `			/* Block comment */` |
|  1297568 |  109 | `			while( pStream->zText < pStream->zEnd ){` |
|  1297568 |  110 | `				if( pStream->zText[0] == '*' ){` |
|    46558 |  111 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    23267 |  112 | `						break;` |
|        - |  113 | `					}` |
|       13 |  114 | `				}` |
|  1251038 |  115 | `				if( pStream->zText[0] == '\n' ){` |
|       28 |  116 | `					pStream->nLine++;` |
|       13 |  117 | `				}` |
|  1251038 |  118 | `				pStream->zText++;` |
|        2 |  119 | `			}` |
|    46532 |  120 | `			pStream->zText += 2;` |
|        - |  121 | `			/* Tell the upper-layer to ignore this token */` |
|    46532 |  122 | `			return SXERR_CONTINUE;` |
|  2538924 |  123 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|    62126 |  124 | `			pStream->zText++;` |
|        - |  125 | `			/* Decimal digit stream */` |
|    68172 |  126 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|     6048 |  127 | `				pStream->zText++;` |
|        2 |  128 | `			}` |
|        - |  129 | `			/* Mark the token as integer until we encounter a real number */` |
|    62126 |  130 | `			pToken->nType = PH7_TK_INTEGER;` |
|    62126 |  131 | `			if( pStream->zText < pStream->zEnd ){` |
|    62122 |  132 | `				c = pStream->zText[0];` |
|    62122 |  133 | `				if( c == '.' ){` |
|        - |  134 | `					/* Real number */` |
...
|    62126 |  186 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    62126 |  187 | `			return SXRET_OK;` |
|        - |  188 | `		}` |
|  2476800 |  189 | `		c = pStream->zText[0];` |
|  2476800 |  190 | `		pStream->zText++; /* Advance the stream cursor */` |
|        - |  191 | `		/* Assume we are dealing with an operator*/` |
|  2476800 |  192 | `		pToken->nType = PH7_TK_OP;` |
|  2476800 |  193 | `		switch(c){` |
|   531870 |  194 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   182452 |  195 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   182438 |  196 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|   370392 |  197 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|    44070 |  198 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|        - |  199 | `														 * is a potential operator [i.e: subscripting] */` |
|    44076 |  200 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   185189 |  201 | `		case ')': {` |
|   370380 |  202 | `			SySet *pTokSet = pStream->pSet;` |
|        - |  203 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|   370380 |  204 | `			if( pTokSet->nUsed >= 2 ){` |
|        - |  205 | `				SyToken *pTmp;` |
|        - |  206 | `				/* Peek the last recongnized token */` |
|   370378 |  207 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|   370378 |  208 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|    11422 |  209 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|    11422 |  210 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|    11366 |  211 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|    11366 |  212 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|        - |  213 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    11282 |  214 | `							const char * zTypeCast = "(int)";` |
|    11282 |  215 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|     1866 |  216 | `								zTypeCast = "(float)";` |
|    10350 |  217 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|     1868 |  218 | `								zTypeCast = "(bool)";` |
|     8485 |  219 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|     5584 |  220 | `								zTypeCast = "(string)";` |
|     4761 |  221 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|       21 |  222 | `								zTypeCast = "(array)";` |
|     1960 |  223 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|       17 |  224 | `								zTypeCast = "(object)";` |
|     1942 |  225 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|        7 |  226 | `								zTypeCast = "(unset)";` |
|        3 |  227 | `							}` |
|        - |  228 | `							/* Reflect the change */` |
|    11282 |  229 | `							pToken->nType = PH7_TK_OP;` |
|    11282 |  230 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|        - |  231 | `							/* Save the instance associated with the type cast operator */` |
|    11282 |  232 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|        - |  233 | `							/* Remove the two previous tokens */` |
|    11282 |  234 | `							pTokSet->nUsed -= 2;` |
|    11282 |  235 | `							return SXRET_OK;` |
|        - |  236 | `						}` |
|       42 |  237 | `					}` |
|       70 |  238 | `				}` |
|   179548 |  239 | `			}` |
|   359100 |  240 | `			pToken->nType = PH7_TK_RPAREN;` |
|   359100 |  241 | `			break;` |
|        - |  242 | `				  }` |
|    18156 |  243 | `		case '\'':{` |
|        - |  244 | `			/* Single quoted string */` |
|    36314 |  245 | `			pStr->zString++;` |
|   392042 |  246 | `			while( pStream->zText < pStream->zEnd ){` |
|   392042 |  247 | `				if( pStream->zText[0] == '\''  ){` |
|    36324 |  248 | `					if( pStream->zText[-1] != '\\' ){` |
|    36300 |  249 | `						break;` |
|      ! 0 |  250 | `					}else{` |
...
|        - |  260 | `					}` |
|        5 |  261 | `				}` |
|   355730 |  262 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  263 | `					pStream->nLine++;` |
|        3 |  264 | `				}` |
|   355730 |  265 | `				pStream->zText++;` |
|        2 |  266 | `			}` |
|        - |  267 | `			/* Record token length and type */` |
|    36314 |  268 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    36314 |  269 | `			pToken->nType = PH7_TK_SSTR;` |
|        - |  270 | `			/* Jump the trailing single quote */` |
|    36314 |  271 | `			pStream->zText++;` |
|    36314 |  272 | `			return SXRET_OK;` |
|        - |  273 | `				  }` |
|     6290 |  274 | `		case '"':{` |
|        - |  275 | `			sxi32 iNest;` |
|        - |  276 | `			/* Double quoted string */` |
|    12582 |  277 | `			pStr->zString++;` |
|   138758 |  278 | `			while( pStream->zText < pStream->zEnd ){` |
|   138758 |  279 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       71 |  280 | `					iNest = 1;` |
...
|        - |  314 | `					}` |
|       50 |  315 | `				}` |
|   126178 |  316 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  317 | `					pStream->nLine++;` |
|        3 |  318 | `				}` |
|   126178 |  319 | `				pStream->zText++;` |
|        2 |  320 | `			}` |
...
|      929 |  348 | `		case ':':` |
|     1860 |  349 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|        - |  350 | `				/* Current operator: '::' */` |
|       56 |  351 | `				pStream->zText++;` |
|       29 |  352 | `			}else{` |
|     1806 |  353 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|        - |  354 | `			}` |
|     1860 |  355 | `			break;` |
|    38860 |  356 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   290370 |  357 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|        - |  358 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|    91005 |  359 | `		case '=':` |
|   182012 |  360 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   182012 |  361 | `			if( pStream->zText < pStream->zEnd ){` |
|   182012 |  362 | `				if( pStream->zText[0] == '=' ){` |
|    12534 |  363 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|        - |  364 | `					/* Current operator: == */` |
|    12534 |  365 | `					pStream->zText++;` |
|    12534 |  366 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  367 | `						/* Current operator: === */` |
|     2958 |  368 | `						pStream->zText++;` |
|     1480 |  369 | `					}` |
|   175746 |  370 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  371 | `					/* Array operator: => */` |
|     2982 |  372 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|     2982 |  373 | `					pStream->zText++;` |
|     1492 |  374 | `				}else{` |
|        - |  375 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   166500 |  376 | `					const unsigned char *zCur = pStream->zText;` |
|   166500 |  377 | `					sxu32 nLine = 0;` |
|   332978 |  378 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   166480 |  379 | `						if( zCur[0] == '\n' ){` |
|        5 |  380 | `							nLine++;` |
|        2 |  381 | `						}` |
|   166480 |  382 | `						zCur++;` |
|        2 |  383 | `					}` |
|   166500 |  384 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   182012 |  394 | `			break;` |
|    12404 |  395 | `		case '!':` |
|    24810 |  396 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  397 | `				/* Current operator: != */` |
|    11306 |  398 | `				pStream->zText++;` |
|    11306 |  399 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  400 | `					/* Current operator: !== */` |
|     9420 |  401 | `					pStream->zText++;` |
|     4709 |  402 | `				}` |
|     5652 |  403 | `			}` |
|    24810 |  404 | `			break;` |
|     6722 |  405 | `		case '&':` |
|    13446 |  406 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    13446 |  407 | `			if( pStream->zText < pStream->zEnd ){` |
|    13446 |  408 | `				if( pStream->zText[0] == '&' ){` |
|     4074 |  409 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|        - |  410 | `					/* Current operator: && */` |
|     4074 |  411 | `					pStream->zText++;` |
|    11410 |  412 | `				}else if( pStream->zText[0] == '=' ){` |
...
|      146 |  429 | `			break;` |
|     4001 |  430 | `		case '+':` |
|     8004 |  431 | `			if( pStream->zText < pStream->zEnd ){` |
|     8002 |  432 | `				if( pStream->zText[0] == '+' ){` |
|        - |  433 | `					/* Current operator: ++ */` |
|     7630 |  434 | `					pStream->zText++;` |
|     4188 |  435 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     8004 |  440 | `			break;` |
|    35692 |  441 | `		case '-':` |
|    71386 |  442 | `			if( pStream->zText < pStream->zEnd ){` |
|    71386 |  443 | `				if( pStream->zText[0] == '-' ){` |
|        - |  444 | `					/* Current operator: -- */` |
|        5 |  445 | `					pStream->zText++;` |
|    71384 |  446 | `				}else if( pStream->zText[0] == '=' ){` |
|        - |  447 | `					/* Current operator: -= */` |
|        3 |  448 | `					pStream->zText++;` |
|    71381 |  449 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  450 | `					/* Current operator: -> */` |
|    70960 |  451 | `					pStream->zText++;` |
|    35479 |  452 | `				}` |
|    35692 |  453 | `			}` |
|    71386 |  454 | `			break;` |
|       70 |  455 | `		case '*':` |
...
|       19 |  478 | `			break;` |
|    16718 |  479 | `		case '.':` |
|    33438 |  480 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  481 | `				/* Current operator: .= */` |
|     1904 |  482 | `				pStream->zText++;` |
|      951 |  483 | `			}` |
|    33438 |  484 | `			break;` |
|    15979 |  485 | `		case '<':` |
|    31960 |  486 | `			if( pStream->zText < pStream->zEnd ){` |
|    31960 |  487 | `				if( pStream->zText[0] == '<' ){` |
...
|      ! 0 |  503 | `						}` |
|        9 |  504 | `					}` |
|    31896 |  505 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  506 | `					/* Current operator: <> */` |
|        5 |  507 | `					pStream->zText++;` |
|    31886 |  508 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    31904 |  513 | `			break;` |
|     1956 |  514 | `		case '>':` |
|     3914 |  515 | `			if( pStream->zText < pStream->zEnd ){` |
|     3914 |  516 | `				if( pStream->zText[0] == '>' ){` |
...
|        9 |  521 | `						pStream->zText++;` |
|        5 |  522 | `					}` |
|     3906 |  523 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     1784 |  530 | `			break;` |
|        - |  531 | `		}` |
|  2416568 |  532 | `		if( pStr->nByte <= 0 ){` |
|        - |  533 | `			/* Record token length */` |
|  2416528 |  534 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  1208263 |  535 | `		}` |
|  2416568 |  536 | `		if( pToken->nType & PH7_TK_OP ){` |
|        - |  537 | `			const ph7_expr_op *pOp;` |
|        - |  538 | `			/* Check if the extracted token is an operator */` |
|   451072 |  539 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|   451072 |  540 | `			if( pOp == 0 ){` |
|        - |  541 | `				/* Not an operator */` |
...
|        - |  569 | `*/` |
|        - |  570 | `/* Hash score: 103 */` |
|  1395118 |  571 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|        - |  659 | `  };` |
|        - |  660 | `  int h, i;` |
|  1395118 |  661 | `  if( n<2 ) return PH7_TK_ID;` |
|  1335576 |  662 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  2025446 |  663 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  1142108 |  664 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|        - |  747 | `       /* PH7_TKWRD_OR */` |
|        - |  748 | `       /* PH7_TKWRD_BREAK */` |
|   452238 |  749 | `      return aCode[i];` |
|        - |  750 | `    }` |
|   344937 |  751 | `  }` |
|   883340 |  752 | `  return PH7_TK_ID;` |
|   697560 |  753 |  |
...
|        - |  908 | ` */` |
|    11064 |  909 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut)` |
|        2 |  910 |  |
|        - |  911 | `	SyLex sLexer;` |
|        - |  912 | `	sxi32 rc;` |
|        - |  913 | `	/* Initialize the lexer */` |
|    11066 |  914 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,0);` |
|    11066 |  915 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  916 | `		return rc;` |
|        - |  917 | `	}` |
|    11066 |  918 | `	sLexer.sStream.nLine = nLineStart;` |
|        - |  919 | `	/* Tokenize input */` |
|    11066 |  920 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|        - |  921 | `	/* Release the lexer */` |
|    11066 |  922 | `	SyLexRelease(&sLexer);` |
...
|        - |  970 | ` */` |
|     9246 |  971 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|        2 |  972 |  |
|     9248 |  973 | `	const char *zEnd = &zInput[nLen];` |
|     9248 |  974 | `	const char *zIn  = zInput;` |
|        - |  975 | `	const char *zCur,*zCurEnd;` |
|     9248 |  976 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|        - |  977 | `	SyToken sToken;` |
|        - |  978 | `	SyString sDoc;` |
|        - |  979 | `	sxu32 nLine;` |
|        - |  980 | `	sxi32 iNest;` |
...
|     9248 |  983 | `	nLine = 1;` |
|     9248 |  984 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     9248 |  985 | `	sToken.pUserData = 0;` |
|     9248 |  986 | `	iNest = 0;` |
|     9248 |  987 | `	sDoc.nByte = 0;` |
|     9248 |  988 | `	sDoc.zString = ""; /* cc warning */` |
|     9248 |  989 | `	for(;;){` |
|    18498 |  990 | `		if( zIn >= zEnd ){` |
|        - |  991 | `			/* End of input reached */` |
|     9244 |  992 | `			break;` |
|        - |  993 | `		}` |
|     9256 |  994 | `		sToken.nLine = nLine;` |
|     9256 |  995 | `		zCur = zIn;` |
|     9256 |  996 | `		zCurEnd = 0;` |
|     9264 |  997 | `		while( zIn < zEnd ){` |
|     9260 |  998 | `			 if( zIn[0] == '<' ){` |
|     9252 |  999 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     9252 | 1000 | `				zIn++;` |
|     9252 | 1001 | `				if( zIn < zEnd ){` |
|     9252 | 1002 | `					if( zIn[0] == '?' ){` |
|     9252 | 1003 | `						zIn++;` |
|     9252 | 1004 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|        - | 1005 | `							/* opening tag: <?php */` |
|     9250 | 1006 | `							zIn += sizeof("php")-1;` |
|     4624 | 1007 | `						}` |
|        - | 1008 | `						/* Look for the closing tag '?>' */` |
|     9252 | 1009 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     9252 | 1010 | `						zCurEnd = zTmp;` |
|     9252 | 1011 | `						break;` |
|        - | 1012 | `					}` |
|      ! 0 | 1013 | `				}` |
|      ! 0 | 1014 | `			}else{` |
...
|     9256 | 1021 | `		if( zCurEnd == 0 ){` |
|        5 | 1022 | `			zCurEnd = zIn;` |
|        2 | 1023 | `		}` |
|        - | 1024 | `		/* Save the raw token */` |
|     9256 | 1025 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     9256 | 1026 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     9256 | 1027 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     9256 | 1028 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 1029 | `			return rc;` |
|        - | 1030 | `		}` |
|     9256 | 1031 | `		if( zIn >= zEnd ){` |
|        5 | 1032 | `			break;` |
|        - | 1033 | `		}` |
|        - | 1034 | `		/* Ignore leading white space */` |
|    20054 | 1035 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|    10804 | 1036 | `			if( zIn[0] == '\n' ){` |
|     9644 | 1037 | `				nLine++;` |
|     4821 | 1038 | `			}` |
|    10804 | 1039 | `			zIn++;` |
...
|     9252 | 1042 | `		sToken.nLine = nLine;` |
|     9252 | 1043 | `		zCur = zIn;` |
|   843570 | 1044 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|        - | 1045 | `			const char *zPtr;` |
|   839688 | 1046 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|     5370 | 1047 | `				break;` |
|        - | 1048 | `			}` |
|   419034 | 1049 | `			for(;;){` |
|   838070 | 1050 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|   417161 | 1051 | `					break;` |
|        - | 1052 | `				}` |
|     3752 | 1053 | `				zIn += 2;` |
|     3752 | 1054 | `				if( zIn[-1] == '/' ){` |
|        - | 1055 | `					/* Inline comment */` |
|   127756 | 1056 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|   124086 | 1057 | `						zIn++;` |
|        2 | 1058 | `					}` |
|     3672 | 1059 | `					if( zIn >= zEnd ){` |
|      ! 0 | 1060 | `						zIn--;` |
|      ! 0 | 1061 | `					}` |
|     1837 | 1062 | `				}else{` |
|        - | 1063 | `					/* Block comment */` |
...
|        - | 1074 | `				}` |
|        2 | 1075 | `			}` |
|   834320 | 1076 | `			if( zIn[0] == '\n' ){` |
|    28560 | 1077 | `				nLine++;` |
|    28560 | 1078 | `				if( iNest > 0 ){` |
|      156 | 1079 | `					zIn++;` |
...
|      156 | 1098 | `					continue;` |
|        2 | 1099 | `				}` |
|   819964 | 1100 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   834106 | 1127 | `			zIn++;` |
|        - | 1128 |  |
|   834106 | 1129 | `			if ( zIn >= zEnd )` |
|      ! 0 | 1130 | `				break;` |
|        2 | 1131 | `		}` |
|     9252 | 1132 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|     3884 | 1133 | `			zIn = zEnd;` |
|     1941 | 1134 | `		}` |
|     9252 | 1135 | `		if( zCur < zIn ){` |
|        - | 1136 | `			/* Save the PHP chunk for later processing */` |
|     7722 | 1137 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     7722 | 1138 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|    15436 | 1139 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     7722 | 1140 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     7722 | 1141 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1142 | `				return rc;` |
|        - | 1143 | `			}` |
|     3860 | 1144 | `		}` |
|     9252 | 1145 | `		if( zIn < zEnd ){` |
|        - | 1146 | `			/* Jump the trailing closing tag */` |
|     5370 | 1147 | `			zIn += sCtag.nByte;` |
|     2684 | 1148 | `		}` |
|        2 | 1149 | `	} /* For(;;) */` |
|        - | 1150 |  |
|     9248 | 1151 | ` 	return SXRET_OK;` |
|     4625 | 1152 |  |
|        - | 1153 |  |
