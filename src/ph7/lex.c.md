...
|         - |   18 | ` */` |
| 163699314 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 241845885 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  78146571 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     53813 |   28 | `			pStream->nLine++;` |
|     26904 |   29 | `		}` |
|  78146571 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 163699319 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 163699319 |   37 | `	pToken->nLine = pStream->nLine;` |
| 163699319 |   38 | `	pToken->pUserData = 0;` |
| 163699319 |   39 | `	pStr = &pToken->sData;` |
| 163699319 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 190818504 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  54238375 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  54238359 |   53 | `			pStream->zText++;` |
|  27119177 |   54 | `		}` |
|  50721785 |   55 | `		for(;;){` |
| 101443575 |   56 | `			zIn = pStream->zText;` |
| 101443575 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 402774284 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 250608929 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
| 101443575 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  54238375 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  47205205 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  54238375 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  54238375 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  54238370 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  18741771 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       809 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       402 |   85 | `		}` |
|  54238375 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  18009813 |   87 | `			if( nKeyword &` |
...
|    885921 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|         - |   91 | `					/* Mark as an operator */` |
|    885921 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|    442963 |   93 | `			}else{` |
|         - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  17123897 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  17123897 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   9004909 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  36228567 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  27119190 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 109460949 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 109559996 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 109453146 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|      7057 |  188 | `				pStream->zText++;` |
|         - |  189 | `				/* Inline comments */` |
|    302261 |  190 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|    295209 |  191 | `					pStream->zText++;` |
|         5 |  192 | `				}` |
|         - |  193 | `				/* Tell the upper-layer to ignore this token */` |
|      7057 |  194 | `				return SXERR_CONTINUE;` |
| 109446105 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
| 109243395 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3560103 |  234 | `			pStream->zText++;` |
...
|   3560098 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3560098 |  239 | `				&& pStream->zText[0] == '_'` |
|   1780129 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4407273 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    847175 |  247 | `				pStream->zText++;` |
|    847170 |  248 | `				if( pStream->zText < pStream->zEnd` |
|    847170 |  249 | `					&& pStream->zText[0] == '_'` |
|    423671 |  250 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   3560103 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3560103 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3560103 |  259 | `				c = pStream->zText[0];` |
|   3560103 |  260 | `				if( c == '.' ){` |
...
|   3560103 |  363 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3560103 |  371 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3560103 |  372 | `			return SXRET_OK;` |
|         - |  373 | `		}` |
| 105683297 |  374 | `		c = pStream->zText[0];` |
| 105683297 |  375 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  376 | `		/* Assume we are dealing with an operator*/` |
| 105683297 |  377 | `		pToken->nType = PH7_TK_OP;` |
| 105683297 |  378 | `		switch(c){` |
|  21871429 |  379 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   6445255 |  380 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   6445241 |  381 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  13531999 |  382 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
...
|   6765985 |  386 | `		case ')': {` |
|  13531975 |  387 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  388 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  13531975 |  389 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  390 | `				SyToken *pTmp;` |
|         - |  391 | `				/* Peek the last recongnized token */` |
|  13531973 |  392 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  13531973 |  393 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|    214110 |  423 | `				}` |
|   6479276 |  424 | `			}` |
|  12958559 |  425 | `			pToken->nType = PH7_TK_RPAREN;` |
|  12958559 |  426 | `			break;` |
|         - |  427 | `				  }` |
|   2548686 |  428 | `		case '\'':{` |
|         - |  429 | `			/* Single quoted string */` |
|   5097377 |  430 | `			pStr->zString++;` |
|  59125685 |  431 | `			while( pStream->zText < pStream->zEnd ){` |
|  59125685 |  432 | `				if( pStream->zText[0] == '\''  ){` |
|   5097387 |  433 | `					if( pStream->zText[-1] != '\\' ){` |
|   5066795 |  434 | `						break;` |
|       ! 0 |  435 | `					}else{` |
...
|         - |  445 | `					}` |
|         5 |  446 | `				}` |
|  54028313 |  447 | `				if( pStream->zText[0] == '\n' ){` |
|        67 |  448 | `					pStream->nLine++;` |
|        33 |  449 | `				}` |
|  54028313 |  450 | `				pStream->zText++;` |
|         5 |  451 | `			}` |
|         - |  452 | `			/* Record token length and type */` |
|   5097377 |  453 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   5097377 |  454 | `			pToken->nType = PH7_TK_SSTR;` |
|         - |  455 | `			/* Jump the trailing single quote */` |
|   5097377 |  456 | `			pStream->zText++;` |
|   5097377 |  457 | `			return SXRET_OK;` |
|         - |  458 | `				  }` |
|     60099 |  459 | `		case '"':{` |
|         - |  460 | `			sxi32 iNest;` |
|         - |  461 | `			/* Double quoted string */` |
|    120203 |  462 | `			pStr->zString++;` |
|   1709577 |  463 | `			while( pStream->zText < pStream->zEnd ){` |
|   1709577 |  464 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       115 |  465 | `					iNest = 1;` |
...
|         - |  484 | `					}` |
|        56 |  485 | `				}` |
|   1709577 |  486 | `				if( pStream->zText[0] == '"' ){` |
|    120481 |  487 | `					if( pStream->zText[-1] != '\\' ){` |
|    120195 |  488 | `						break;` |
|       ! 0 |  489 | `					}else{` |
...
|         - |  499 | `					}` |
|       139 |  500 | `				}` |
|   1589379 |  501 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  502 | `					pStream->nLine++;` |
|        14 |  503 | `				}` |
|   1589379 |  504 | `				pStream->zText++;` |
|         5 |  505 | `			}` |
|         - |  506 | `			/* Record token length and type */` |
|    120203 |  507 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    120203 |  508 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  509 | `			/* Jump the trailing quote */` |
|    120203 |  510 | `			pStream->zText++;` |
|    120203 |  511 | `			return SXRET_OK;` |
|         - |  512 | `				  }` |
|         2 |  513 | ``		case '`':{`` |
...
|         - |  531 | `				  }` |
|      8591 |  532 | `		case '\\': pToken->nType = PH7_TK_NSSEP;  break;` |
|    447844 |  533 | `		case ':':` |
|    895693 |  534 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|         - |  535 | `				/* Current operator: '::' */` |
|    367699 |  536 | `				pStream->zText++;` |
|    183852 |  537 | `			}else{` |
|    527999 |  538 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|         - |  539 | `			}` |
|    895693 |  540 | `			break;` |
|   3699261 |  541 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|  10228865 |  542 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  543 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   3681981 |  544 | `		case '=':` |
|   7363967 |  545 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   7363967 |  546 | `			if( pStream->zText < pStream->zEnd ){` |
|   7363967 |  547 | `				if( pStream->zText[0] == '=' ){` |
...
|    604270 |  554 | `					}` |
|   6734693 |  555 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  556 | `					/* Array operator: => */` |
|    518807 |  557 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    518807 |  558 | `					pStream->zText++;` |
|    259406 |  559 | `				}else{` |
|         - |  560 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   5586617 |  561 | `					const unsigned char *zCur = pStream->zText;` |
|   5586617 |  562 | `					sxu32 nLine = 0;` |
|  11173065 |  563 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   5586453 |  564 | `						if( zCur[0] == '\n' ){` |
|         5 |  565 | `							nLine++;` |
|         2 |  566 | `						}` |
|   5586453 |  567 | `						zCur++;` |
|         5 |  568 | `					}` |
|   5586617 |  569 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|    359497 |  617 | `			break;` |
|    206891 |  618 | `		case '+':` |
|    413787 |  619 | `			if( pStream->zText < pStream->zEnd ){` |
|    413785 |  620 | `				if( pStream->zText[0] == '+' ){` |
|         - |  621 | `					/* Current operator: ++ */` |
|    164727 |  622 | `					pStream->zText++;` |
|    331424 |  623 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    413787 |  628 | `			break;` |
|   2413984 |  629 | `		case '-':` |
|   4827973 |  630 | `			if( pStream->zText < pStream->zEnd ){` |
|   4827973 |  631 | `				if( pStream->zText[0] == '-' ){` |
|         - |  632 | `					/* Current operator: -- */` |
|     30607 |  633 | `					pStream->zText++;` |
|   4812672 |  634 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  635 | `					/* Current operator: -= */` |
|        14 |  636 | `					pStream->zText++;` |
|   4797365 |  637 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  638 | `					/* Current operator: -> */` |
|   4578737 |  639 | `					pStream->zText++;` |
|   2289366 |  640 | `				}` |
|   2413984 |  641 | `			}` |
|   4827973 |  642 | `			break;` |
|     19309 |  643 | `		case '*':` |
...
|    294459 |  733 | `			break;` |
|    257855 |  734 | `		case '?':` |
|    515715 |  735 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '?' ){` |
|         - |  736 | `				/* Null coalescing operator: ?? */` |
|     57559 |  737 | `				pStream->zText++;` |
|     57559 |  738 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  739 | `					/* Null coalescing assignment operator (PHP 7.4) */` |
|       101 |  740 | `					pStream->zText++;` |
|        48 |  741 | `				}` |
|    486938 |  742 | `			}else if( (pStream->zEnd - pStream->zText) >= 2` |
|    458161 |  743 | `				&& pStream->zText[0] == '-' && pStream->zText[1] == '>' ){` |
...
|     11718 |  749 | `			break;` |
|         - |  750 | `		}` |
|  99892189 |  751 | `		if( pStr->nByte <= 0 ){` |
|         - |  752 | `			/* Record token length */` |
|  99892127 |  753 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  49946061 |  754 | `		}` |
|  99892189 |  755 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  756 | `			const ph7_expr_op *pOp;` |
|         - |  757 | `			/* Check if the extracted token is an operator */` |
|  24239819 |  758 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  24239819 |  759 | `			if( pOp == 0 ){` |
|         - |  760 | `				/* Not an operator */` |
...
|         - |  791 | `*/` |
|         - |  792 | `/* Hash score: 103 */` |
|  54238375 |  793 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  881 | `  };` |
|         - |  882 | `  int h, i;` |
|  54238375 |  883 | `  if( n<2 ) return PH7_TK_ID;` |
|  47205183 |  884 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  72861721 |  885 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  43657235 |  886 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  969 | `       /* PH7_TKWRD_OR */` |
|         - |  970 | `       /* PH7_TKWRD_BREAK */` |
|  18000697 |  971 | `      return aCode[i];` |
|         - |  972 | `    }` |
|  12828272 |  973 | `  }` |
|         - |  974 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  29204491 |  975 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  29196771 |  976 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  29196767 |  977 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  29196595 |  978 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  29180925 |  979 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  29180849 |  980 | `  return PH7_TK_ID;` |
|  27119190 |  981 | `}` |
...
|         - | 1150 | ` */` |
|     81944 | 1151 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut,SySet *pTrivia)` |
|         5 | 1152 | `{` |
|         - | 1153 | `	SyLex sLexer;` |
|         - | 1154 | `	sxi32 rc;` |
|         - | 1155 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|     81949 | 1156 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
...
|     81949 | 1162 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,pTrivia);` |
|     81949 | 1163 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1164 | `		return rc;` |
|         - | 1165 | `	}` |
|     81949 | 1166 | `	sLexer.sStream.nLine = nLineStart;` |
|         - | 1167 | `	/* Tokenize input */` |
|     81949 | 1168 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|         - | 1169 | `	/* Release the lexer */` |
|     81949 | 1170 | `	SyLexRelease(&sLexer);` |
|         - | 1171 | `	/* Tokenization result */` |
|     81949 | 1172 | `	return rc;` |
|     40977 | 1173 | `}` |
|         - | 1174 | `/*` |
...
|         - | 1218 | ` */` |
|     13390 | 1219 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut,sxu32 nBaseLine)` |
|         5 | 1220 | `{` |
|     13395 | 1221 | `	const char *zEnd = &zInput[nLen];` |
|     13395 | 1222 | `	const char *zIn  = zInput;` |
|         - | 1223 | `	const char *zCur,*zCurEnd;` |
|     13395 | 1224 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1225 | `	SyToken sToken;` |
|         - | 1226 | `	SyString sDoc;` |
|         - | 1227 | `	sxu32 nLine;` |
|         - | 1228 | `	sxi32 iNest;` |
...
|     13395 | 1232 | `	nLine = nBaseLine;` |
|     13395 | 1233 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13395 | 1234 | `	sToken.pUserData = 0;` |
|     13395 | 1235 | `	iNest = 0;` |
|     13395 | 1236 | `	sDoc.nByte = 0;` |
|     13395 | 1237 | `	sDoc.zString = ""; /* cc warning */` |
|     13390 | 1238 | `	for(;;){` |
|     26785 | 1239 | `		if( zIn >= zEnd ){` |
|         - | 1240 | `			/* End of input reached */` |
|     13385 | 1241 | `			break;` |
|         - | 1242 | `		}` |
|     13405 | 1243 | `		sToken.nLine = nLine;` |
|     13405 | 1244 | `		zCur = zIn;` |
|     13405 | 1245 | `		zCurEnd = 0;` |
|     13597 | 1246 | `		while( zIn < zEnd ){` |
|     13587 | 1247 | `			 if( zIn[0] == '<' ){` |
|     13395 | 1248 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     13395 | 1249 | `				zIn++;` |
|     13395 | 1250 | `				if( zIn < zEnd ){` |
|     13395 | 1251 | `					if( zIn[0] == '?' ){` |
|     13395 | 1252 | `						zIn++;` |
|     13395 | 1253 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1254 | `							/* opening tag: <?php */` |
|     13393 | 1255 | `							zIn += sizeof("php")-1;` |
|      6694 | 1256 | `						}` |
|         - | 1257 | `						/* Look for the closing tag '?>' */` |
|     13395 | 1258 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     13395 | 1259 | `						zCurEnd = zTmp;` |
|     13395 | 1260 | `						break;` |
|         - | 1261 | `					}` |
|       ! 0 | 1262 | `				}` |
|       ! 0 | 1263 | `			}else{` |
...
|     13405 | 1270 | `		if( zCurEnd == 0 ){` |
|        13 | 1271 | `			zCurEnd = zIn;` |
|         5 | 1272 | `		}` |
|         - | 1273 | `		/* Save the raw token */` |
|     13405 | 1274 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13405 | 1275 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13405 | 1276 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13405 | 1277 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1278 | `			return rc;` |
|         - | 1279 | `		}` |
|     13405 | 1280 | `		if( zIn >= zEnd ){` |
|        13 | 1281 | `			break;` |
|         - | 1282 | `		}` |
|         - | 1283 | `		/* Ignore leading white space */` |
|     28521 | 1284 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     15131 | 1285 | `			if( zIn[0] == '\n' ){` |
|     14681 | 1286 | `				nLine++;` |
|      7338 | 1287 | `			}` |
|     15131 | 1288 | `			zIn++;` |
...
|     13395 | 1291 | `		sToken.nLine = nLine;` |
|     13395 | 1292 | `		zCur = zIn;` |
|   1840911 | 1293 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1294 | `			const char *zPtr;` |
|   1834719 | 1295 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7199 | 1296 | `				break;` |
|         - | 1297 | `			}` |
|    917457 | 1298 | `			for(;;){` |
|   1834919 | 1299 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|    913765 | 1300 | `					break;` |
|         - | 1301 | `				}` |
|      7399 | 1302 | `				zIn += 2;` |
|      7399 | 1303 | `				if( zIn[-1] == '/' ){` |
|         - | 1304 | `					/* Inline comment */` |
|    299207 | 1305 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|    292063 | 1306 | `						zIn++;` |
|         5 | 1307 | `					}` |
|      7149 | 1308 | `					if( zIn >= zEnd ){` |
|         3 | 1309 | `						zIn--;` |
|         1 | 1310 | `					}` |
|      3577 | 1311 | `				}else{` |
|         - | 1312 | `					/* Block comment */` |
...
|         - | 1323 | `				}` |
|         5 | 1324 | `			}` |
|   1827525 | 1325 | `			if( zIn[0] == '\n' ){` |
|     61025 | 1326 | `				nLine++;` |
|     61025 | 1327 | `				if( iNest > 0 ){` |
|       328 | 1328 | `					zIn++;` |
...
|       328 | 1347 | `					continue;` |
|         5 | 1348 | `				}` |
|   1796853 | 1349 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1827083 | 1376 | `			zIn++;` |
|         - | 1377 |  |
|   1827083 | 1378 | `			if ( zIn >= zEnd )` |
|         5 | 1379 | `				break;` |
|         5 | 1380 | `		}` |
|     13395 | 1381 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6201 | 1382 | `			zIn = zEnd;` |
|      3098 | 1383 | `		}` |
|     13395 | 1384 | `		if( zCur < zIn ){` |
|         - | 1385 | `			/* Save the PHP chunk for later processing */` |
|     10187 | 1386 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     10187 | 1387 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|     20213 | 1388 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     10187 | 1389 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     10187 | 1390 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1391 | `				return rc;` |
|         - | 1392 | `			}` |
|      5091 | 1393 | `		}` |
|     13395 | 1394 | `		if( zIn < zEnd ){` |
|         - | 1395 | `			/* Jump the trailing closing tag */` |
|      7199 | 1396 | `			zIn += sCtag.nByte;` |
|         - | 1397 | `			/* php's lexer swallows exactly ONE newline immediately after the` |
|         - | 1398 | `			 * closing tag ("?>\n" emits nothing) */` |
|      7199 | 1399 | `			if( zIn < zEnd && zIn[0] == '\r' && zIn + 1 < zEnd && zIn[1] == '\n' ){` |
|       ! 0 | 1400 | `				zIn += 2;` |
|       ! 0 | 1401 | `				nLine++;` |
|      7199 | 1402 | `			}else if( zIn < zEnd && zIn[0] == '\n' ){` |
|        62 | 1403 | `				zIn++;` |
|        62 | 1404 | `				nLine++;` |
|        29 | 1405 | `			}` |
|      3597 | 1406 | `		}` |
