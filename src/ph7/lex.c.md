...
|        - |   18 | ` */` |
|  9684410 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|        2 |   20 |  |
|        - |   21 | `	SyString *pStr;` |
|        - |   22 | `	sxi32 rc;` |
|        - |   23 | `	/* Ignore leading white spaces */` |
| 14581032 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|        - |   25 | `		/* Advance the stream cursor */` |
|  4896622 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|        - |   27 | `			/* Update line counter */` |
|    35808 |   28 | `			pStream->nLine++;` |
|    17903 |   29 | `		}` |
|  4896622 |   30 | `		pStream->zText++;` |
|        2 |   31 | `	}` |
|  9684412 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|        - |   33 | `		/* End of input reached */` |
|      ! 0 |   34 | `		return SXERR_EOF;` |
|        - |   35 | `	}` |
|        - |   36 | `	/* Record token starting position and line */` |
|  9684412 |   37 | `	pToken->nLine = pStream->nLine;` |
|  9684412 |   38 | `	pToken->pUserData = 0;` |
|  9684412 |   39 | `	pStr = &pToken->sData;` |
|  9684412 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 11531519 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  3694216 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  3694200 |   53 | `			pStream->zText++;` |
|  1847099 |   54 | `		}` |
|  3639384 |   55 | `		for(;;){` |
|  7278770 |   56 | `			zIn = pStream->zText;` |
|  7278770 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|       49 |   58 | `				zIn++;` |
|        - |   59 | `				/* UTF-8 stream */` |
...
| 31256692 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 20338540 |   66 | `				zIn++;` |
|        2 |   67 | `			}` |
|  7278770 |   68 | `			if( zIn == pStream->zText ){` |
|        - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  3694216 |   70 | `				break;` |
|        - |   71 | `			}` |
|        - |   72 | `			/* Synchronize pointers */` |
|  3584556 |   73 | `			pStream->zText = zIn;` |
|        2 |   74 | `		}` |
|        - |   75 | `		/* Record token length */` |
|  3694216 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  3694216 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|        - |   81 | `		 */` |
|  3694720 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  1170189 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|      392 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|      195 |   85 | `		}` |
|  3694216 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  1362418 |   87 | `			if( nKeyword &` |
...
|    17072 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|        - |   91 | `					/* Mark as an operator */` |
|    17072 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|     8537 |   93 | `			}else{` |
|        - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  1345348 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  1345348 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|        - |   97 | `			}` |
|   681210 |   98 | `		}else{` |
|        - |   99 | `			/* A simple identifier */` |
|  2331800 |  100 | `			pToken->nType = PH7_TK_ID;` |
|        - |  101 | `		}` |
|  1847109 |  102 | `	}else{` |
|        - |  103 | `		sxi32 c;` |
|        - |  104 | `		/* Non-alpha stream */` |
|  5990198 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
|  6031583 |  170 | `		}else if( pStream->zText[0] == '#' \|\|` |
|  5990122 |  171 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
...
|  5985874 |  179 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
|  5907288 |  196 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   111234 |  197 | `			pStream->zText++;` |
...
|   111312 |  201 | `			if( pStream->zText < pStream->zEnd` |
|   111232 |  202 | `				&& pStream->zText[0] == '_'` |
|    55696 |  203 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   121978 |  209 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
...
|   111234 |  220 | `			pToken->nType = PH7_TK_INTEGER;` |
|   111234 |  221 | `			if( pStream->zText < pStream->zEnd ){` |
|   111234 |  222 | `				c = pStream->zText[0];` |
|   111234 |  223 | `				if( c == '.' ){` |
...
|   111234 |  314 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   111234 |  322 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   111234 |  323 | `			return SXRET_OK;` |
|        - |  324 | `		}` |
|  5796056 |  325 | `		c = pStream->zText[0];` |
|  5796056 |  326 | `		pStream->zText++; /* Advance the stream cursor */` |
|        - |  327 | `		/* Assume we are dealing with an operator*/` |
|  5796056 |  328 | `		pToken->nType = PH7_TK_OP;` |
|  5796056 |  329 | `		switch(c){` |
|  1169234 |  330 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   499958 |  331 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   499944 |  332 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|   897562 |  333 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|    81640 |  334 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|        - |  335 | `														 * is a potential operator [i.e: subscripting] */` |
|    81646 |  336 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   448773 |  337 | `		case ')': {` |
|   897548 |  338 | `			SySet *pTokSet = pStream->pSet;` |
|        - |  339 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|   897548 |  340 | `			if( pTokSet->nUsed >= 2 ){` |
|        - |  341 | `				SyToken *pTmp;` |
|        - |  342 | `				/* Peek the last recongnized token */` |
|   897546 |  343 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|   897546 |  344 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|      168 |  374 | `				}` |
|   440800 |  375 | `			}` |
|   881604 |  376 | `			pToken->nType = PH7_TK_RPAREN;` |
|   881604 |  377 | `			break;` |
|        - |  378 | `				  }` |
|    39971 |  379 | `		case '\'':{` |
|        - |  380 | `			/* Single quoted string */` |
|    79944 |  381 | `			pStr->zString++;` |
|   817440 |  382 | `			while( pStream->zText < pStream->zEnd ){` |
|   817440 |  383 | `				if( pStream->zText[0] == '\''  ){` |
|    79954 |  384 | `					if( pStream->zText[-1] != '\\' ){` |
|    79930 |  385 | `						break;` |
|      ! 0 |  386 | `					}else{` |
...
|        - |  396 | `					}` |
|        5 |  397 | `				}` |
|   737498 |  398 | `				if( pStream->zText[0] == '\n' ){` |
|       67 |  399 | `					pStream->nLine++;` |
|       33 |  400 | `				}` |
|   737498 |  401 | `				pStream->zText++;` |
|        2 |  402 | `			}` |
|        - |  403 | `			/* Record token length and type */` |
|    79944 |  404 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    79944 |  405 | `			pToken->nType = PH7_TK_SSTR;` |
|        - |  406 | `			/* Jump the trailing single quote */` |
|    79944 |  407 | `			pStream->zText++;` |
|    79944 |  408 | `			return SXRET_OK;` |
|        - |  409 | `				  }` |
|    10148 |  410 | `		case '"':{` |
|        - |  411 | `			sxi32 iNest;` |
|        - |  412 | `			/* Double quoted string */` |
|    20298 |  413 | `			pStr->zString++;` |
|   181842 |  414 | `			while( pStream->zText < pStream->zEnd ){` |
|   181842 |  415 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|      108 |  416 | `					iNest = 1;` |
...
|        - |  435 | `					}` |
|       53 |  436 | `				}` |
|   181842 |  437 | `				if( pStream->zText[0] == '"' ){` |
|    20430 |  438 | `					if( pStream->zText[-1] != '\\' ){` |
|    20294 |  439 | `						break;` |
|      ! 0 |  440 | `					}else{` |
...
|        - |  450 | `					}` |
|       66 |  451 | `				}` |
|   161546 |  452 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  453 | `					pStream->nLine++;` |
|        3 |  454 | `				}` |
|   161546 |  455 | `				pStream->zText++;` |
|        2 |  456 | `			}` |
|        - |  457 | `			/* Record token length and type */` |
|    20298 |  458 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    20298 |  459 | `			pToken->nType = PH7_TK_DSTR;` |
|        - |  460 | `			/* Jump the trailing quote */` |
|    20298 |  461 | `			pStream->zText++;` |
|    20298 |  462 | `			return SXRET_OK;` |
|        - |  463 | `				  }` |
|        2 |  464 | ``		case '`':{`` |
...
|        - |  490 | `			}` |
|     3460 |  491 | `			break;` |
|    96362 |  492 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   690536 |  493 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|        - |  494 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   182357 |  495 | `		case '=':` |
|   364716 |  496 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   364716 |  497 | `			if( pStream->zText < pStream->zEnd ){` |
|   364716 |  498 | `				if( pStream->zText[0] == '=' ){` |
...
|     2224 |  505 | `					}` |
|   354486 |  506 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  507 | `					/* Array operator: => */` |
|     5094 |  508 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|     5094 |  509 | `					pStream->zText++;` |
|     2548 |  510 | `				}else{` |
|        - |  511 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   339164 |  512 | `					const unsigned char *zCur = pStream->zText;` |
|   339164 |  513 | `					sxu32 nLine = 0;` |
|   678238 |  514 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   339076 |  515 | `						if( zCur[0] == '\n' ){` |
|        5 |  516 | `							nLine++;` |
|        2 |  517 | `						}` |
|   339076 |  518 | `						zCur++;` |
|        2 |  519 | `					}` |
|   339164 |  520 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|     3432 |  565 | `			break;` |
|     8293 |  566 | `		case '+':` |
|    16588 |  567 | `			if( pStream->zText < pStream->zEnd ){` |
|    16586 |  568 | `				if( pStream->zText[0] == '+' ){` |
|        - |  569 | `					/* Current operator: ++ */` |
|    12900 |  570 | `					pStream->zText++;` |
|    10137 |  571 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    16588 |  576 | `			break;` |
|    85953 |  577 | `		case '-':` |
|   171908 |  578 | `			if( pStream->zText < pStream->zEnd ){` |
|   171908 |  579 | `				if( pStream->zText[0] == '-' ){` |
|        - |  580 | `					/* Current operator: -- */` |
|       29 |  581 | `					pStream->zText++;` |
|   171894 |  582 | `				}else if( pStream->zText[0] == '=' ){` |
|        - |  583 | `					/* Current operator: -= */` |
|       10 |  584 | `					pStream->zText++;` |
|   171876 |  585 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  586 | `					/* Current operator: -> */` |
|   171324 |  587 | `					pStream->zText++;` |
|    85661 |  588 | `				}` |
|    85953 |  589 | `			}` |
|   171908 |  590 | `			break;` |
|      172 |  591 | `		case '*':` |
...
|       23 |  623 | `			break;` |
|    43316 |  624 | `		case '.':` |
|    86634 |  625 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|        - |  626 | `				/* Ellipsis: ... */` |
|      120 |  627 | `				pStream->zText += 2;` |
|      120 |  628 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|    86575 |  629 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  630 | `				/* Current operator: .= */` |
|     3214 |  631 | `				pStream->zText++;` |
|     1606 |  632 | `			}` |
|    86634 |  633 | `			break;` |
|    26968 |  634 | `		case '<':` |
|    53938 |  635 | `			if( pStream->zText < pStream->zEnd ){` |
|    53938 |  636 | `				if( pStream->zText[0] == '<' ){` |
...
|      ! 0 |  652 | `						}` |
|       12 |  653 | `					}` |
|    53815 |  654 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  655 | `					/* Current operator: <> */` |
|        5 |  656 | `					pStream->zText++;` |
|    53802 |  657 | `				}else if( pStream->zText[0] == '=' ){` |
...
|      220 |  697 | `			break;` |
|        - |  698 | `		}` |
|  5679758 |  699 | `		if( pStr->nByte <= 0 ){` |
|        - |  700 | `			/* Record token length */` |
|  5679710 |  701 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  2839854 |  702 | `		}` |
|  5679758 |  703 | `		if( pToken->nType & PH7_TK_OP ){` |
|        - |  704 | `			const ph7_expr_op *pOp;` |
|        - |  705 | `			/* Check if the extracted token is an operator */` |
|   950644 |  706 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|   950644 |  707 | `			if( pOp == 0 ){` |
|        - |  708 | `				/* Not an operator */` |
...
|        - |  739 | `*/` |
|        - |  740 | `/* Hash score: 103 */` |
|  3694216 |  741 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|        - |  829 | `  };` |
|        - |  830 | `  int h, i;` |
|  3694216 |  831 | `  if( n<2 ) return PH7_TK_ID;` |
|  3584534 |  832 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  5360434 |  833 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  3137732 |  834 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|        - |  917 | `       /* PH7_TKWRD_OR */` |
|        - |  918 | `       /* PH7_TKWRD_BREAK */` |
|  1361832 |  919 | `      return aCode[i];` |
|        - |  920 | `    }` |
|   887950 |  921 | `  }` |
|        - |  922 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  2222704 |  923 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  2222646 |  924 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  2222642 |  925 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  2222612 |  926 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  2222578 |  927 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  2222508 |  928 | `  return PH7_TK_ID;` |
|  1847109 |  929 |  |
...
|        - | 1098 | ` */` |
|    15314 | 1099 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut)` |
|        2 | 1100 |  |
|        - | 1101 | `	SyLex sLexer;` |
|        - | 1102 | `	sxi32 rc;` |
|        - | 1103 | `	/* Initialize the lexer */` |
|    15316 | 1104 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,0);` |
|    15316 | 1105 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1106 | `		return rc;` |
|        - | 1107 | `	}` |
|    15316 | 1108 | `	sLexer.sStream.nLine = nLineStart;` |
|        - | 1109 | `	/* Tokenize input */` |
|    15316 | 1110 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|        - | 1111 | `	/* Release the lexer */` |
|    15316 | 1112 | `	SyLexRelease(&sLexer);` |
|        - | 1113 | `	/* Tokenization result */` |
|    15316 | 1114 | `	return rc;` |
|     7659 | 1115 |  |
|        - | 1116 | `/*` |
...
|        - | 1160 | ` */` |
|    12696 | 1161 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|        2 | 1162 |  |
|    12698 | 1163 | `	const char *zEnd = &zInput[nLen];` |
|    12698 | 1164 | `	const char *zIn  = zInput;` |
|        - | 1165 | `	const char *zCur,*zCurEnd;` |
|    12698 | 1166 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|        - | 1167 | `	SyToken sToken;` |
|        - | 1168 | `	SyString sDoc;` |
|        - | 1169 | `	sxu32 nLine;` |
|        - | 1170 | `	sxi32 iNest;` |
...
|    12698 | 1173 | `	nLine = 1;` |
|    12698 | 1174 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|    12698 | 1175 | `	sToken.pUserData = 0;` |
|    12698 | 1176 | `	iNest = 0;` |
|    12698 | 1177 | `	sDoc.nByte = 0;` |
|    12698 | 1178 | `	sDoc.zString = ""; /* cc warning */` |
|    12698 | 1179 | `	for(;;){` |
|    25398 | 1180 | `		if( zIn >= zEnd ){` |
|        - | 1181 | `			/* End of input reached */` |
|    12648 | 1182 | `			break;` |
|        - | 1183 | `		}` |
|    12752 | 1184 | `		sToken.nLine = nLine;` |
|    12752 | 1185 | `		zCur = zIn;` |
|    12752 | 1186 | `		zCurEnd = 0;` |
|    12806 | 1187 | `		while( zIn < zEnd ){` |
|    12756 | 1188 | `			 if( zIn[0] == '<' ){` |
|    12702 | 1189 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|    12702 | 1190 | `				zIn++;` |
|    12702 | 1191 | `				if( zIn < zEnd ){` |
|    12702 | 1192 | `					if( zIn[0] == '?' ){` |
|    12702 | 1193 | `						zIn++;` |
|    12702 | 1194 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|        - | 1195 | `							/* opening tag: <?php */` |
|    12700 | 1196 | `							zIn += sizeof("php")-1;` |
|     6349 | 1197 | `						}` |
|        - | 1198 | `						/* Look for the closing tag '?>' */` |
|    12702 | 1199 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|    12702 | 1200 | `						zCurEnd = zTmp;` |
|    12702 | 1201 | `						break;` |
|        - | 1202 | `					}` |
|      ! 0 | 1203 | `				}` |
|      ! 0 | 1204 | `			}else{` |
...
|    12752 | 1211 | `		if( zCurEnd == 0 ){` |
|       52 | 1212 | `			zCurEnd = zIn;` |
|       25 | 1213 | `		}` |
|        - | 1214 | `		/* Save the raw token */` |
|    12752 | 1215 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|    12752 | 1216 | `		sToken.nType = PH7_TOKEN_RAW;` |
|    12752 | 1217 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    12752 | 1218 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 1219 | `			return rc;` |
|        - | 1220 | `		}` |
|    12752 | 1221 | `		if( zIn >= zEnd ){` |
|       52 | 1222 | `			break;` |
|        - | 1223 | `		}` |
|        - | 1224 | `		/* Ignore leading white space */` |
|    27404 | 1225 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|    14704 | 1226 | `			if( zIn[0] == '\n' ){` |
|    13480 | 1227 | `				nLine++;` |
|     6739 | 1228 | `			}` |
|    14704 | 1229 | `			zIn++;` |
...
|    12702 | 1232 | `		sToken.nLine = nLine;` |
|    12702 | 1233 | `		zCur = zIn;` |
|  1233826 | 1234 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|        - | 1235 | `			const char *zPtr;` |
|  1228276 | 1236 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|     7150 | 1237 | `				break;` |
|        - | 1238 | `			}` |
|   612759 | 1239 | `			for(;;){` |
|  1225520 | 1240 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|   610565 | 1241 | `					break;` |
|        - | 1242 | `				}` |
|     4394 | 1243 | `				zIn += 2;` |
|     4394 | 1244 | `				if( zIn[-1] == '/' ){` |
|        - | 1245 | `					/* Inline comment */` |
|   156156 | 1246 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|   151850 | 1247 | `						zIn++;` |
|        2 | 1248 | `					}` |
|     4308 | 1249 | `					if( zIn >= zEnd ){` |
|      ! 0 | 1250 | `						zIn--;` |
|      ! 0 | 1251 | `					}` |
|     2155 | 1252 | `				}else{` |
|        - | 1253 | `					/* Block comment */` |
...
|        - | 1264 | `				}` |
|        2 | 1265 | `			}` |
|  1221128 | 1266 | `			if( zIn[0] == '\n' ){` |
|    42166 | 1267 | `				nLine++;` |
|    42166 | 1268 | `				if( iNest > 0 ){` |
|      302 | 1269 | `					zIn++;` |
...
|      302 | 1288 | `					continue;` |
|        2 | 1289 | `				}` |
|  1199896 | 1290 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|  1220716 | 1317 | `			zIn++;` |
|        - | 1318 |  |
|  1220716 | 1319 | `			if ( zIn >= zEnd )` |
|        3 | 1320 | `				break;` |
|        2 | 1321 | `		}` |
|    12702 | 1322 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|     5554 | 1323 | `			zIn = zEnd;` |
|     2776 | 1324 | `		}` |
|    12702 | 1325 | `		if( zCur < zIn ){` |
|        - | 1326 | `			/* Save the PHP chunk for later processing */` |
|    10062 | 1327 | `			sToken.nType = PH7_TOKEN_PHP;` |
|    10062 | 1328 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|    20054 | 1329 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|    10062 | 1330 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    10062 | 1331 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1332 | `				return rc;` |
|        - | 1333 | `			}` |
|     5030 | 1334 | `		}` |
|    12702 | 1335 | `		if( zIn < zEnd ){` |
|        - | 1336 | `			/* Jump the trailing closing tag */` |
|     7150 | 1337 | `			zIn += sCtag.nByte;` |
|     3574 | 1338 | `		}` |
|        2 | 1339 | `	} /* For(;;) */` |
|        - | 1340 |  |
|    12698 | 1341 | ` 	return SXRET_OK;` |
|     6350 | 1342 |  |
|        - | 1343 |  |
