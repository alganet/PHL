...
|         - |   18 | ` */` |
| 163873912 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 242105111 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  78231199 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     54227 |   28 | `			pStream->nLine++;` |
|     27111 |   29 | `		}` |
|  78231199 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 163873917 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 163873917 |   37 | `	pToken->nLine = pStream->nLine;` |
| 163873917 |   38 | `	pToken->pUserData = 0;` |
| 163873917 |   39 | `	pStr = &pToken->sData;` |
| 163873917 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 191022090 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  54296351 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  54296335 |   53 | `			pStream->zText++;` |
|  27148165 |   54 | `		}` |
|  50775964 |   55 | `		for(;;){` |
| 101551933 |   56 | `			zIn = pStream->zText;` |
| 101551933 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 403204179 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 250876287 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
| 101551933 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  54296351 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  47255587 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  54296351 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  54296351 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  54296346 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  18761742 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       827 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       411 |   85 | `		}` |
|  54296351 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  18029211 |   87 | `			if( nKeyword &` |
...
|  17142317 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  17142317 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   9014608 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  36267145 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  27148178 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 109577571 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 109676758 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 109569760 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|      7103 |  188 | `				pStream->zText++;` |
|         - |  189 | `				/* Inline comments */` |
|    303591 |  190 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|    296493 |  191 | `					pStream->zText++;` |
|         5 |  192 | `				}` |
|         - |  193 | `				/* Tell the upper-layer to ignore this token */` |
|      7103 |  194 | `				return SXERR_CONTINUE;` |
| 109562673 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
|         - |  201 | `			 * token stream. */` |
|    202961 |  202 | `			const unsigned char *zDocStart = pStream->zText;` |
|    202973 |  203 | `			int bDoc = ( &pStream->zText[2] < pStream->zEnd && pStream->zText[2] == '*'` |
|    304446 |  204 | `			 && ( &pStream->zText[3] >= pStream->zEnd \|\| pStream->zText[3] != '/' ) );` |
|    202961 |  205 | `			pStream->zText += 2;` |
|         - |  206 | `			/* Block comment */` |
|  14850027 |  207 | `			while( pStream->zText < pStream->zEnd ){` |
|  14850027 |  208 | `				if( pStream->zText[0] == '*' ){` |
|    279683 |  209 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    101483 |  210 | `						break;` |
|         - |  211 | `					}` |
|     38361 |  212 | `				}` |
|  14647071 |  213 | `				if( pStream->zText[0] == '\n' ){` |
|       215 |  214 | `					pStream->nLine++;` |
|       105 |  215 | `				}` |
|  14647071 |  216 | `				pStream->zText++;` |
|         5 |  217 | `			}` |
|    202961 |  218 | `			pStream->zText += 2;` |
|    202961 |  219 | `			if( bDoc && pUserData && pStream->pSet ){` |
...
|    202961 |  232 | `			return SXERR_CONTINUE;` |
| 109359717 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3563851 |  234 | `			pStream->zText++;` |
...
|   3563846 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3563846 |  239 | `				&& pStream->zText[0] == '_'` |
|   1782003 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4411907 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
...
|   3563851 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3563851 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3563851 |  259 | `				c = pStream->zText[0];` |
|   3563851 |  260 | `				if( c == '.' ){` |
...
|   3563851 |  363 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3563851 |  371 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3563851 |  372 | `			return SXRET_OK;` |
|         - |  373 | `		}` |
| 105795871 |  374 | `		c = pStream->zText[0];` |
| 105795871 |  375 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  376 | `		/* Assume we are dealing with an operator*/` |
| 105795871 |  377 | `		pToken->nType = PH7_TK_OP;` |
| 105795871 |  378 | `		switch(c){` |
|  21894607 |  379 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   6452155 |  380 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   6452141 |  381 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  13546465 |  382 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
...
|   6773218 |  386 | `		case ')': {` |
|  13546441 |  387 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  388 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  13546441 |  389 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  390 | `				SyToken *pTmp;` |
|         - |  391 | `				/* Peek the last recongnized token */` |
|  13546439 |  392 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  13546439 |  393 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|    214334 |  423 | `				}` |
|   6486209 |  424 | `			}` |
|  12972425 |  425 | `			pToken->nType = PH7_TK_RPAREN;` |
|  12972425 |  426 | `			break;` |
|         - |  427 | `				  }` |
|   2551372 |  428 | `		case '\'':{` |
...
|    120423 |  462 | `			pStr->zString++;` |
|   1711705 |  463 | `			while( pStream->zText < pStream->zEnd ){` |
|   1711705 |  464 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       115 |  465 | `					iNest = 1;` |
...
|         - |  484 | `					}` |
|        56 |  485 | `				}` |
|   1711705 |  486 | `				if( pStream->zText[0] == '"' ){` |
|    120701 |  487 | `					if( pStream->zText[-1] != '\\' ){` |
|    120415 |  488 | `						break;` |
|       ! 0 |  489 | `					}else{` |
...
|         - |  499 | `					}` |
|       139 |  500 | `				}` |
|   1591287 |  501 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  502 | `					pStream->nLine++;` |
|        14 |  503 | `				}` |
|   1591287 |  504 | `				pStream->zText++;` |
|         5 |  505 | `			}` |
|         - |  506 | `			/* Record token length and type */` |
|    120423 |  507 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    120423 |  508 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  509 | `			/* Jump the trailing quote */` |
|    120423 |  510 | `			pStream->zText++;` |
|    120423 |  511 | `			return SXRET_OK;` |
|         - |  512 | `				  }` |
|         2 |  513 | ``		case '`':{`` |
...
|         - |  539 | `			}` |
|    896695 |  540 | `			break;` |
|   3703185 |  541 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|  10239819 |  542 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  543 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   3685883 |  544 | `		case '=':` |
|   7371771 |  545 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   7371771 |  546 | `			if( pStream->zText < pStream->zEnd ){` |
|   7371771 |  547 | `				if( pStream->zText[0] == '=' ){` |
...
|    604903 |  554 | `					}` |
|   6741838 |  555 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  556 | `					/* Array operator: => */` |
|    519367 |  557 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    519367 |  558 | `					pStream->zText++;` |
|    259686 |  559 | `				}else{` |
|         - |  560 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   5592543 |  561 | `					const unsigned char *zCur = pStream->zText;` |
|   5592543 |  562 | `					sxu32 nLine = 0;` |
|  11184917 |  563 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   5592379 |  564 | `						if( zCur[0] == '\n' ){` |
|         5 |  565 | `							nLine++;` |
|         2 |  566 | `						}` |
|   5592379 |  567 | `						zCur++;` |
|         5 |  568 | `					}` |
|   5592543 |  569 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|     11730 |  749 | `			break;` |
|         - |  750 | `		}` |
|  99998571 |  751 | `		if( pStr->nByte <= 0 ){` |
|         - |  752 | `			/* Record token length */` |
|  99998509 |  753 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  49999252 |  754 | `		}` |
|  99998571 |  755 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  756 | `			const ph7_expr_op *pOp;` |
|         - |  757 | `			/* Check if the extracted token is an operator */` |
|  24265467 |  758 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  24265467 |  759 | `			if( pOp == 0 ){` |
|         - |  760 | `				/* Not an operator */` |
...
|         - |  791 | `*/` |
|         - |  792 | `/* Hash score: 103 */` |
|  54296351 |  793 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  881 | `  };` |
|         - |  882 | `  int h, i;` |
|  54296351 |  883 | `  if( n<2 ) return PH7_TK_ID;` |
|  47255565 |  884 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  72939421 |  885 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  43703921 |  886 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  969 | `       /* PH7_TKWRD_OR */` |
|         - |  970 | `       /* PH7_TKWRD_BREAK */` |
|  18020065 |  971 | `      return aCode[i];` |
|         - |  972 | `    }` |
|  12841931 |  973 | `  }` |
|         - |  974 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  29235505 |  975 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  29227773 |  976 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  29227769 |  977 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  29227597 |  978 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  29211911 |  979 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  29211835 |  980 | `  return PH7_TK_ID;` |
|  27148178 |  981 | `}` |
...
|         - | 1150 | ` */` |
|     82050 | 1151 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut,SySet *pTrivia)` |
|         5 | 1152 | `{` |
|         - | 1153 | `	SyLex sLexer;` |
|         - | 1154 | `	sxi32 rc;` |
|         - | 1155 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|     82055 | 1156 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
...
|     82055 | 1162 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,pTrivia);` |
|     82055 | 1163 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1164 | `		return rc;` |
|         - | 1165 | `	}` |
|     82055 | 1166 | `	sLexer.sStream.nLine = nLineStart;` |
|         - | 1167 | `	/* Tokenize input */` |
|     82055 | 1168 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|         - | 1169 | `	/* Release the lexer */` |
|     82055 | 1170 | `	SyLexRelease(&sLexer);` |
|         - | 1171 | `	/* Tokenization result */` |
|     82055 | 1172 | `	return rc;` |
|     41030 | 1173 | `}` |
|         - | 1174 | `/*` |
...
|         - | 1218 | ` */` |
|     13424 | 1219 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut,sxu32 nBaseLine)` |
|         5 | 1220 | `{` |
|     13429 | 1221 | `	const char *zEnd = &zInput[nLen];` |
|     13429 | 1222 | `	const char *zIn  = zInput;` |
|         - | 1223 | `	const char *zCur,*zCurEnd;` |
|     13429 | 1224 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1225 | `	SyToken sToken;` |
|         - | 1226 | `	SyString sDoc;` |
|         - | 1227 | `	sxu32 nLine;` |
|         - | 1228 | `	sxi32 iNest;` |
...
|     13429 | 1232 | `	nLine = nBaseLine;` |
|     13429 | 1233 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13429 | 1234 | `	sToken.pUserData = 0;` |
|     13429 | 1235 | `	iNest = 0;` |
|     13429 | 1236 | `	sDoc.nByte = 0;` |
|     13429 | 1237 | `	sDoc.zString = ""; /* cc warning */` |
|     13424 | 1238 | `	for(;;){` |
|     26853 | 1239 | `		if( zIn >= zEnd ){` |
|         - | 1240 | `			/* End of input reached */` |
|     13419 | 1241 | `			break;` |
|         - | 1242 | `		}` |
|     13439 | 1243 | `		sToken.nLine = nLine;` |
|     13439 | 1244 | `		zCur = zIn;` |
|     13439 | 1245 | `		zCurEnd = 0;` |
|     13631 | 1246 | `		while( zIn < zEnd ){` |
|     13621 | 1247 | `			 if( zIn[0] == '<' ){` |
|     13429 | 1248 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     13429 | 1249 | `				zIn++;` |
|     13429 | 1250 | `				if( zIn < zEnd ){` |
|     13429 | 1251 | `					if( zIn[0] == '?' ){` |
|     13429 | 1252 | `						zIn++;` |
|     13429 | 1253 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1254 | `							/* opening tag: <?php */` |
|     13427 | 1255 | `							zIn += sizeof("php")-1;` |
|      6711 | 1256 | `						}` |
|         - | 1257 | `						/* Look for the closing tag '?>' */` |
|     13429 | 1258 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     13429 | 1259 | `						zCurEnd = zTmp;` |
|     13429 | 1260 | `						break;` |
|         - | 1261 | `					}` |
|       ! 0 | 1262 | `				}` |
|       ! 0 | 1263 | `			}else{` |
...
|     13439 | 1270 | `		if( zCurEnd == 0 ){` |
|        13 | 1271 | `			zCurEnd = zIn;` |
|         5 | 1272 | `		}` |
|         - | 1273 | `		/* Save the raw token */` |
|     13439 | 1274 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13439 | 1275 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13439 | 1276 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13439 | 1277 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1278 | `			return rc;` |
|         - | 1279 | `		}` |
|     13439 | 1280 | `		if( zIn >= zEnd ){` |
|        13 | 1281 | `			break;` |
|         - | 1282 | `		}` |
|         - | 1283 | `		/* Ignore leading white space */` |
|     28589 | 1284 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     15165 | 1285 | `			if( zIn[0] == '\n' ){` |
|     14715 | 1286 | `				nLine++;` |
|      7355 | 1287 | `			}` |
|     15165 | 1288 | `			zIn++;` |
...
|     13429 | 1291 | `		sToken.nLine = nLine;` |
|     13429 | 1292 | `		zCur = zIn;` |
|   1854299 | 1293 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1294 | `			const char *zPtr;` |
|   1848099 | 1295 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7225 | 1296 | `				break;` |
|         - | 1297 | `			}` |
|    924174 | 1298 | `			for(;;){` |
|   1848353 | 1299 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|    920442 | 1300 | `					break;` |
|         - | 1301 | `				}` |
|      7479 | 1302 | `				zIn += 2;` |
|      7479 | 1303 | `				if( zIn[-1] == '/' ){` |
|         - | 1304 | `					/* Inline comment */` |
|    300491 | 1305 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|    293301 | 1306 | `						zIn++;` |
|         5 | 1307 | `					}` |
|      7195 | 1308 | `					if( zIn >= zEnd ){` |
|         3 | 1309 | `						zIn--;` |
|         1 | 1310 | `					}` |
|      3600 | 1311 | `				}else{` |
|         - | 1312 | `					/* Block comment */` |
|     28203 | 1313 | `					while( (sxu32)(zEnd-zIn) >= sizeof("*/") - 1 ){` |
|     28203 | 1314 | `						if( zIn[0] == '*' && zIn[1] == '/' ){` |
|       289 | 1315 | `							zIn += 2;` |
|       289 | 1316 | `							break;` |
|         - | 1317 | `						}` |
|     27919 | 1318 | `						if( zIn[0] == '\n' ){` |
...
|         - | 1323 | `				}` |
|         5 | 1324 | `			}` |
|   1840879 | 1325 | `			if( zIn[0] == '\n' ){` |
|     61465 | 1326 | `				nLine++;` |
|     61465 | 1327 | `				if( iNest > 0 ){` |
|       328 | 1328 | `					zIn++;` |
...
|       328 | 1347 | `					continue;` |
|         5 | 1348 | `				}` |
|   1809987 | 1349 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1840437 | 1376 | `			zIn++;` |
|         - | 1377 |  |
|   1840437 | 1378 | `			if ( zIn >= zEnd )` |
|         5 | 1379 | `				break;` |
|         5 | 1380 | `		}` |
|     13429 | 1381 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6209 | 1382 | `			zIn = zEnd;` |
|      3102 | 1383 | `		}` |
|     13429 | 1384 | `		if( zCur < zIn ){` |
|         - | 1385 | `			/* Save the PHP chunk for later processing */` |
|     10213 | 1386 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     10213 | 1387 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|     20265 | 1388 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     10213 | 1389 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     10213 | 1390 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1391 | `				return rc;` |
|         - | 1392 | `			}` |
|      5104 | 1393 | `		}` |
|     13429 | 1394 | `		if( zIn < zEnd ){` |
|         - | 1395 | `			/* Jump the trailing closing tag */` |
|      7225 | 1396 | `			zIn += sCtag.nByte;` |
|         - | 1397 | `			/* php's lexer swallows exactly ONE newline immediately after the` |
|         - | 1398 | `			 * closing tag ("?>\n" emits nothing) */` |
|      7225 | 1399 | `			if( zIn < zEnd && zIn[0] == '\r' && zIn + 1 < zEnd && zIn[1] == '\n' ){` |
|       ! 0 | 1400 | `				zIn += 2;` |
|       ! 0 | 1401 | `				nLine++;` |
|      7225 | 1402 | `			}else if( zIn < zEnd && zIn[0] == '\n' ){` |
|        63 | 1403 | `				zIn++;` |
|        63 | 1404 | `				nLine++;` |
|        29 | 1405 | `			}` |
|      3610 | 1406 | `		}` |
