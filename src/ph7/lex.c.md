...
|        - |   18 | ` */` |
| 10114382 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|        5 |   20 |  |
|        - |   21 | `	SyString *pStr;` |
|        - |   22 | `	sxi32 rc;` |
|        - |   23 | `	/* Ignore leading white spaces */` |
| 15230917 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|        - |   25 | `		/* Advance the stream cursor */` |
|  5116535 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|        - |   27 | `			/* Update line counter */` |
|    37253 |   28 | `			pStream->nLine++;` |
|    18624 |   29 | `		}` |
|  5116535 |   30 | `		pStream->zText++;` |
|        5 |   31 | `	}` |
| 10114387 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|        - |   33 | `		/* End of input reached */` |
|      ! 0 |   34 | `		return SXERR_EOF;` |
|        - |   35 | `	}` |
|        - |   36 | `	/* Record token starting position and line */` |
| 10114387 |   37 | `	pToken->nLine = pStream->nLine;` |
| 10114387 |   38 | `	pToken->pUserData = 0;` |
| 10114387 |   39 | `	pStr = &pToken->sData;` |
| 10114387 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 12043901 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  3859033 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  3859017 |   53 | `			pStream->zText++;` |
|  1929506 |   54 | `		}` |
|  3801683 |   55 | `		for(;;){` |
|  7603371 |   56 | `			zIn = pStream->zText;` |
|  7603371 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|       49 |   58 | `				zIn++;` |
|        - |   59 | `				/* UTF-8 stream */` |
...
| 32650534 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 21245485 |   66 | `				zIn++;` |
|        5 |   67 | `			}` |
|  7603371 |   68 | `			if( zIn == pStream->zText ){` |
|        - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  3859033 |   70 | `				break;` |
|        - |   71 | `			}` |
|        - |   72 | `			/* Synchronize pointers */` |
|  3744343 |   73 | `			pStream->zText = zIn;` |
|        5 |   74 | `		}` |
|        - |   75 | `		/* Record token length */` |
|  3859033 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  3859033 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|        - |   81 | `		 */` |
|  3859028 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  1222410 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|      395 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|      195 |   85 | `		}` |
|  3859033 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  1423269 |   87 | `			if( nKeyword &` |
...
|    17899 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|        - |   91 | `					/* Mark as an operator */` |
|    17899 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|     8952 |   93 | `			}else{` |
|        - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  1405375 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  1405375 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|        - |   97 | `			}` |
|   711637 |   98 | `		}else{` |
|        - |   99 | `			/* A simple identifier */` |
|  2435769 |  100 | `			pToken->nType = PH7_TK_ID;` |
|        - |  101 | `		}` |
|  1929519 |  102 | `	}else{` |
|        - |  103 | `		sxi32 c;` |
|        - |  104 | `		/* Non-alpha stream */` |
|  6255359 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
|  6298566 |  170 | `		}else if( pStream->zText[0] == '#' \|\|` |
|  6255280 |  171 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|     4401 |  172 | `				pStream->zText++;` |
|        - |  173 | `				/* Inline comments */` |
|   165415 |  174 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|   161019 |  175 | `					pStream->zText++;` |
|        5 |  176 | `				}` |
|        - |  177 | `				/* Tell the upper-layer to ignore this token */` |
|     4401 |  178 | `				return SXERR_CONTINUE;` |
|  6250895 |  179 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
|    82095 |  180 | `			pStream->zText += 2;` |
|        - |  181 | `			/* Block comment */` |
|  2486445 |  182 | `			while( pStream->zText < pStream->zEnd ){` |
|  2486445 |  183 | `				if( pStream->zText[0] == '*' ){` |
|    82149 |  184 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    41050 |  185 | `						break;` |
|        - |  186 | `					}` |
|       27 |  187 | `				}` |
|  2404355 |  188 | `				if( pStream->zText[0] == '\n' ){` |
|       55 |  189 | `					pStream->nLine++;` |
|       25 |  190 | `				}` |
|  2404355 |  191 | `				pStream->zText++;` |
|        5 |  192 | `			}` |
|    82095 |  193 | `			pStream->zText += 2;` |
|        - |  194 | `			/* Tell the upper-layer to ignore this token */` |
|    82095 |  195 | `			return SXERR_CONTINUE;` |
|  6168805 |  196 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   116041 |  197 | `			pStream->zText++;` |
...
|   116036 |  201 | `			if( pStream->zText < pStream->zEnd` |
|   116036 |  202 | `				&& pStream->zText[0] == '_'` |
|    58098 |  203 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   127155 |  209 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    11119 |  210 | `				pStream->zText++;` |
|    11114 |  211 | `				if( pStream->zText < pStream->zEnd` |
|    11114 |  212 | `					&& pStream->zText[0] == '_'` |
|     5643 |  213 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   116041 |  220 | `			pToken->nType = PH7_TK_INTEGER;` |
|   116041 |  221 | `			if( pStream->zText < pStream->zEnd ){` |
|   116041 |  222 | `				c = pStream->zText[0];` |
|   116041 |  223 | `				if( c == '.' ){` |
...
|     1398 |  228 | `						if( pStream->zText < pStream->zEnd` |
...
|       28 |  242 | `								if( (c =='+' \|\| c=='-') && &pStream->zText[1] < pStream->zEnd  &&` |
...
|       40 |  248 | `									if( pStream->zText < pStream->zEnd` |
...
|       28 |  266 | `						if( (c =='+' \|\| c=='-') && &pStream->zText[1] < pStream->zEnd  &&` |
...
|       38 |  272 | `							if( pStream->zText < pStream->zEnd` |
...
|   116041 |  314 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   116041 |  322 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   116041 |  323 | `			return SXRET_OK;` |
|        - |  324 | `		}` |
|  6052769 |  325 | `		c = pStream->zText[0];` |
|  6052769 |  326 | `		pStream->zText++; /* Advance the stream cursor */` |
|        - |  327 | `		/* Assume we are dealing with an operator*/` |
|  6052769 |  328 | `		pToken->nType = PH7_TK_OP;` |
|  6052769 |  329 | `		switch(c){` |
|  1220963 |  330 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   522467 |  331 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   522453 |  332 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|   937343 |  333 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|    85233 |  334 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|        - |  335 | `														 * is a potential operator [i.e: subscripting] */` |
|    85239 |  336 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   468661 |  337 | `		case ')': {` |
|   937327 |  338 | `			SySet *pTokSet = pStream->pSet;` |
|        - |  339 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|   937327 |  340 | `			if( pTokSet->nUsed >= 2 ){` |
|        - |  341 | `				SyToken *pTmp;` |
|        - |  342 | `				/* Peek the last recongnized token */` |
|   937325 |  343 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|   937325 |  344 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|    16997 |  345 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|    16997 |  346 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|    16745 |  347 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|    16745 |  348 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|        - |  349 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    16661 |  350 | `							const char * zTypeCast = "(int)";` |
|    16661 |  351 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|     3297 |  352 | `								zTypeCast = "(float)";` |
|    15015 |  353 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|     3293 |  354 | `								zTypeCast = "(bool)";` |
|    11725 |  355 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|     6593 |  356 | `								zTypeCast = "(string)";` |
|     6787 |  357 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|       21 |  358 | `								zTypeCast = "(array)";` |
|     3483 |  359 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|       17 |  360 | `								zTypeCast = "(object)";` |
|     3465 |  361 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|        7 |  362 | `								zTypeCast = "(unset)";` |
|        3 |  363 | `							}` |
|        - |  364 | `							/* Reflect the change */` |
|    16661 |  365 | `							pToken->nType = PH7_TK_OP;` |
|    16661 |  366 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|        - |  367 | `							/* Save the instance associated with the type cast operator */` |
|    16661 |  368 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|        - |  369 | `							/* Remove the two previous tokens */` |
|    16661 |  370 | `							pTokSet->nUsed -= 2;` |
|    16661 |  371 | `							return SXRET_OK;` |
|        - |  372 | `						}` |
|       42 |  373 | `					}` |
|      168 |  374 | `				}` |
|   460332 |  375 | `			}` |
|   920671 |  376 | `			pToken->nType = PH7_TK_RPAREN;` |
|   920671 |  377 | `			break;` |
|        - |  378 | `				  }` |
|    41601 |  379 | `		case '\'':{` |
|        - |  380 | `			/* Single quoted string */` |
|    83207 |  381 | `			pStr->zString++;` |
|   851677 |  382 | `			while( pStream->zText < pStream->zEnd ){` |
|   851677 |  383 | `				if( pStream->zText[0] == '\''  ){` |
|    83217 |  384 | `					if( pStream->zText[-1] != '\\' ){` |
|    83193 |  385 | `						break;` |
|      ! 0 |  386 | `					}else{` |
...
|        - |  396 | `					}` |
|        5 |  397 | `				}` |
|   768475 |  398 | `				if( pStream->zText[0] == '\n' ){` |
|       67 |  399 | `					pStream->nLine++;` |
|       33 |  400 | `				}` |
|   768475 |  401 | `				pStream->zText++;` |
|        5 |  402 | `			}` |
|        - |  403 | `			/* Record token length and type */` |
|    83207 |  404 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    83207 |  405 | `			pToken->nType = PH7_TK_SSTR;` |
|        - |  406 | `			/* Jump the trailing single quote */` |
|    83207 |  407 | `			pStream->zText++;` |
|    83207 |  408 | `			return SXRET_OK;` |
|        - |  409 | `				  }` |
|    10506 |  410 | `		case '"':{` |
|        - |  411 | `			sxi32 iNest;` |
|        - |  412 | `			/* Double quoted string */` |
|    21017 |  413 | `			pStr->zString++;` |
|   187627 |  414 | `			while( pStream->zText < pStream->zEnd ){` |
|   187627 |  415 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|      113 |  416 | `					iNest = 1;` |
...
|        - |  435 | `					}` |
|       55 |  436 | `				}` |
|   187627 |  437 | `				if( pStream->zText[0] == '"' ){` |
|    21209 |  438 | `					if( pStream->zText[-1] != '\\' ){` |
|    21013 |  439 | `						break;` |
|      ! 0 |  440 | `					}else{` |
...
|        - |  450 | `					}` |
|       96 |  451 | `				}` |
|   166615 |  452 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  453 | `					pStream->nLine++;` |
|        3 |  454 | `				}` |
|   166615 |  455 | `				pStream->zText++;` |
|        5 |  456 | `			}` |
|        - |  457 | `			/* Record token length and type */` |
|    21017 |  458 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    21017 |  459 | `			pToken->nType = PH7_TK_DSTR;` |
|        - |  460 | `			/* Jump the trailing quote */` |
|    21017 |  461 | `			pStream->zText++;` |
|    21017 |  462 | `			return SXRET_OK;` |
|        - |  463 | `				  }` |
|        2 |  464 | ``		case '`':{`` |
...
|     1815 |  484 | `		case ':':` |
|     3635 |  485 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|        - |  486 | `				/* Current operator: '::' */` |
|      297 |  487 | `				pStream->zText++;` |
|      151 |  488 | `			}else{` |
|     3343 |  489 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|        - |  490 | `			}` |
|     3635 |  491 | `			break;` |
|   100383 |  492 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   721139 |  493 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|        - |  494 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   190423 |  495 | `		case '=':` |
|   380851 |  496 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   380851 |  497 | `			if( pStream->zText < pStream->zEnd ){` |
|   380851 |  498 | `				if( pStream->zText[0] == '=' ){` |
|    21367 |  499 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|        - |  500 | `					/* Current operator: == */` |
|    21367 |  501 | `					pStream->zText++;` |
|    21367 |  502 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  503 | `						/* Current operator: === */` |
|     4639 |  504 | `						pStream->zText++;` |
|     2322 |  505 | `					}` |
|   370170 |  506 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  507 | `					/* Array operator: => */` |
|     5251 |  508 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|     5251 |  509 | `					pStream->zText++;` |
|     2628 |  510 | `				}else{` |
|        - |  511 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   354243 |  512 | `					const unsigned char *zCur = pStream->zText;` |
|   354243 |  513 | `					sxu32 nLine = 0;` |
|   708343 |  514 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   354105 |  515 | `						if( zCur[0] == '\n' ){` |
|        5 |  516 | `							nLine++;` |
|        2 |  517 | `						}` |
|   354105 |  518 | `						zCur++;` |
|        5 |  519 | `					}` |
|   354243 |  520 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   380851 |  530 | `			break;` |
|    23370 |  531 | `		case '!':` |
|    46745 |  532 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  533 | `				/* Current operator: != */` |
|    19879 |  534 | `				pStream->zText++;` |
|    19879 |  535 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  536 | `					/* Current operator: !== */` |
|    16567 |  537 | `					pStream->zText++;` |
|     8281 |  538 | `				}` |
|     9937 |  539 | `			}` |
|    46745 |  540 | `			break;` |
|    13409 |  541 | `		case '&':` |
|    26823 |  542 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    26823 |  543 | `			if( pStream->zText < pStream->zEnd ){` |
|    26823 |  544 | `				if( pStream->zText[0] == '&' ){` |
|    10285 |  545 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|        - |  546 | `					/* Current operator: && */` |
|    10285 |  547 | `					pStream->zText++;` |
|    21683 |  548 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    26823 |  554 | `			break;` |
|     1794 |  555 | `		case '\|':` |
|     3593 |  556 | `			if( pStream->zText < pStream->zEnd ){` |
|     3593 |  557 | `				if( pStream->zText[0] == '\|' ){` |
|        - |  558 | `					/* Current operator: \|\| */` |
|     3451 |  559 | `					pStream->zText++;` |
|     1870 |  560 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     3593 |  565 | `			break;` |
|     8656 |  566 | `		case '+':` |
|    17317 |  567 | `			if( pStream->zText < pStream->zEnd ){` |
|    17315 |  568 | `				if( pStream->zText[0] == '+' ){` |
|        - |  569 | `					/* Current operator: ++ */` |
|    13481 |  570 | `					pStream->zText++;` |
|    10577 |  571 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    17317 |  576 | `			break;` |
|    89842 |  577 | `		case '-':` |
|   179689 |  578 | `			if( pStream->zText < pStream->zEnd ){` |
|   179689 |  579 | `				if( pStream->zText[0] == '-' ){` |
|        - |  580 | `					/* Current operator: -- */` |
|       37 |  581 | `					pStream->zText++;` |
|   179672 |  582 | `				}else if( pStream->zText[0] == '=' ){` |
|        - |  583 | `					/* Current operator: -= */` |
|       10 |  584 | `					pStream->zText++;` |
|   179651 |  585 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  586 | `					/* Current operator: -> */` |
|   179089 |  587 | `					pStream->zText++;` |
|    89542 |  588 | `				}` |
|    89842 |  589 | `			}` |
|   179689 |  590 | `			break;` |
|      174 |  591 | `		case '*':` |
...
|       23 |  623 | `			break;` |
|    45188 |  624 | `		case '.':` |
|    90381 |  625 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|        - |  626 | `				/* Ellipsis: ... */` |
|      133 |  627 | `				pStream->zText += 2;` |
|      133 |  628 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|    90317 |  629 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  630 | `				/* Current operator: .= */` |
|     3407 |  631 | `				pStream->zText++;` |
|     1701 |  632 | `			}` |
|    90381 |  633 | `			break;` |
|    28170 |  634 | `		case '<':` |
|    56345 |  635 | `			if( pStream->zText < pStream->zEnd ){` |
|    56345 |  636 | `				if( pStream->zText[0] == '<' ){` |
...
|      ! 0 |  652 | `						}` |
|       12 |  653 | `					}` |
|    56220 |  654 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  655 | `					/* Current operator: <> */` |
|        5 |  656 | `					pStream->zText++;` |
|    56207 |  657 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    56231 |  666 | `			break;` |
|     3413 |  667 | `		case '>':` |
|     6831 |  668 | `			if( pStream->zText < pStream->zEnd ){` |
|     6831 |  669 | `				if( pStream->zText[0] == '>' ){` |
...
|        6 |  675 | `					}` |
|     6821 |  676 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     6831 |  681 | `			break;` |
|     1461 |  682 | `		case '?':` |
|     2927 |  683 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '?' ){` |
...
|       31 |  689 | `				}` |
|     2834 |  690 | `			}else if( (pStream->zEnd - pStream->zText) >= 2` |
|     2741 |  691 | `				&& pStream->zText[0] == '-' && pStream->zText[1] == '>' ){` |
...
|      228 |  697 | `			break;` |
|        - |  698 | `		}` |
|  5931781 |  699 | `		if( pStr->nByte <= 0 ){` |
|        - |  700 | `			/* Record token length */` |
|  5931729 |  701 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  2965862 |  702 | `		}` |
|  5931781 |  703 | `		if( pToken->nType & PH7_TK_OP ){` |
|        - |  704 | `			const ph7_expr_op *pOp;` |
|        - |  705 | `			/* Check if the extracted token is an operator */` |
|   992595 |  706 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|   992595 |  707 | `			if( pOp == 0 ){` |
|        - |  708 | `				/* Not an operator */` |
...
|        - |  739 | `*/` |
|        - |  740 | `/* Hash score: 103 */` |
|  3859033 |  741 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|        - |  829 | `  };` |
|        - |  830 | `  int h, i;` |
|  3859033 |  831 | `  if( n<2 ) return PH7_TK_ID;` |
|  3744321 |  832 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  5599797 |  833 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  3278103 |  834 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|        - |  917 | `       /* PH7_TKWRD_OR */` |
|        - |  918 | `       /* PH7_TKWRD_BREAK */` |
|  1422627 |  919 | `      return aCode[i];` |
|        - |  920 | `    }` |
|   927741 |  921 | `  }` |
|        - |  922 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  2321699 |  923 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  2321641 |  924 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  2321637 |  925 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  2321589 |  926 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  2321517 |  927 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  2321447 |  928 | `  return PH7_TK_ID;` |
|  1929519 |  929 |  |
...
|        - | 1098 | ` */` |
|    15732 | 1099 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut)` |
|        5 | 1100 |  |
|        - | 1101 | `	SyLex sLexer;` |
|        - | 1102 | `	sxi32 rc;` |
|        - | 1103 | `	/* Initialize the lexer */` |
|    15737 | 1104 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,0);` |
|    15737 | 1105 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1106 | `		return rc;` |
|        - | 1107 | `	}` |
|    15737 | 1108 | `	sLexer.sStream.nLine = nLineStart;` |
|        - | 1109 | `	/* Tokenize input */` |
|    15737 | 1110 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|        - | 1111 | `	/* Release the lexer */` |
|    15737 | 1112 | `	SyLexRelease(&sLexer);` |
|        - | 1113 | `	/* Tokenization result */` |
|    15737 | 1114 | `	return rc;` |
|     7871 | 1115 |  |
|        - | 1116 | `/*` |
...
|        - | 1160 | ` */` |
|    13018 | 1161 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|        5 | 1162 |  |
|    13023 | 1163 | `	const char *zEnd = &zInput[nLen];` |
|    13023 | 1164 | `	const char *zIn  = zInput;` |
|        - | 1165 | `	const char *zCur,*zCurEnd;` |
|    13023 | 1166 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|        - | 1167 | `	SyToken sToken;` |
|        - | 1168 | `	SyString sDoc;` |
|        - | 1169 | `	sxu32 nLine;` |
|        - | 1170 | `	sxi32 iNest;` |
...
|    13023 | 1173 | `	nLine = 1;` |
|    13023 | 1174 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|    13023 | 1175 | `	sToken.pUserData = 0;` |
|    13023 | 1176 | `	iNest = 0;` |
|    13023 | 1177 | `	sDoc.nByte = 0;` |
|    13023 | 1178 | `	sDoc.zString = ""; /* cc warning */` |
|    13020 | 1179 | `	for(;;){` |
|    26045 | 1180 | `		if( zIn >= zEnd ){` |
|        - | 1181 | `			/* End of input reached */` |
|    12973 | 1182 | `			break;` |
|        - | 1183 | `		}` |
|    13077 | 1184 | `		sToken.nLine = nLine;` |
|    13077 | 1185 | `		zCur = zIn;` |
|    13077 | 1186 | `		zCurEnd = 0;` |
|    13131 | 1187 | `		while( zIn < zEnd ){` |
|    13081 | 1188 | `			 if( zIn[0] == '<' ){` |
|    13027 | 1189 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|    13027 | 1190 | `				zIn++;` |
|    13027 | 1191 | `				if( zIn < zEnd ){` |
|    13027 | 1192 | `					if( zIn[0] == '?' ){` |
|    13027 | 1193 | `						zIn++;` |
|    13027 | 1194 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|        - | 1195 | `							/* opening tag: <?php */` |
|    13025 | 1196 | `							zIn += sizeof("php")-1;` |
|     6510 | 1197 | `						}` |
|        - | 1198 | `						/* Look for the closing tag '?>' */` |
|    13027 | 1199 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|    13027 | 1200 | `						zCurEnd = zTmp;` |
|    13027 | 1201 | `						break;` |
|        - | 1202 | `					}` |
|      ! 0 | 1203 | `				}` |
|      ! 0 | 1204 | `			}else{` |
...
|    13077 | 1211 | `		if( zCurEnd == 0 ){` |
|       54 | 1212 | `			zCurEnd = zIn;` |
|       25 | 1213 | `		}` |
|        - | 1214 | `		/* Save the raw token */` |
|    13077 | 1215 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|    13077 | 1216 | `		sToken.nType = PH7_TOKEN_RAW;` |
|    13077 | 1217 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    13077 | 1218 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 1219 | `			return rc;` |
|        - | 1220 | `		}` |
|    13077 | 1221 | `		if( zIn >= zEnd ){` |
|       54 | 1222 | `			break;` |
|        - | 1223 | `		}` |
|        - | 1224 | `		/* Ignore leading white space */` |
|    28051 | 1225 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|    15029 | 1226 | `			if( zIn[0] == '\n' ){` |
|    13785 | 1227 | `				nLine++;` |
|     6890 | 1228 | `			}` |
|    15029 | 1229 | `			zIn++;` |
...
|    13027 | 1232 | `		sToken.nLine = nLine;` |
|    13027 | 1233 | `		zCur = zIn;` |
|  1284049 | 1234 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|        - | 1235 | `			const char *zPtr;` |
|  1278343 | 1236 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|     7319 | 1237 | `				break;` |
|        - | 1238 | `			}` |
|   637781 | 1239 | `			for(;;){` |
|  1275567 | 1240 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|   635517 | 1241 | `					break;` |
|        - | 1242 | `				}` |
|     4543 | 1243 | `				zIn += 2;` |
|     4543 | 1244 | `				if( zIn[-1] == '/' ){` |
|        - | 1245 | `					/* Inline comment */` |
|   163617 | 1246 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|   159169 | 1247 | `						zIn++;` |
|        5 | 1248 | `					}` |
|     4453 | 1249 | `					if( zIn >= zEnd ){` |
|      ! 0 | 1250 | `						zIn--;` |
|      ! 0 | 1251 | `					}` |
|     2229 | 1252 | `				}else{` |
|        - | 1253 | `					/* Block comment */` |
...
|        - | 1264 | `				}` |
|        5 | 1265 | `			}` |
|  1271029 | 1266 | `			if( zIn[0] == '\n' ){` |
|    43781 | 1267 | `				nLine++;` |
|    43781 | 1268 | `				if( iNest > 0 ){` |
|      321 | 1269 | `					zIn++;` |
...
|      321 | 1288 | `					continue;` |
|        5 | 1289 | `				}` |
|  1248983 | 1290 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|  1270599 | 1317 | `			zIn++;` |
|        - | 1318 |  |
|  1270599 | 1319 | `			if ( zIn >= zEnd )` |
|        3 | 1320 | `				break;` |
|        5 | 1321 | `		}` |
|    13027 | 1322 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|     5713 | 1323 | `			zIn = zEnd;` |
|     2854 | 1324 | `		}` |
|    13027 | 1325 | `		if( zCur < zIn ){` |
|        - | 1326 | `			/* Save the PHP chunk for later processing */` |
|    10265 | 1327 | `			sToken.nType = PH7_TOKEN_PHP;` |
|    10265 | 1328 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|    20455 | 1329 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|    10265 | 1330 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    10265 | 1331 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1332 | `				return rc;` |
|        - | 1333 | `			}` |
|     5130 | 1334 | `		}` |
|    13027 | 1335 | `		if( zIn < zEnd ){` |
|        - | 1336 | `			/* Jump the trailing closing tag */` |
|     7319 | 1337 | `			zIn += sCtag.nByte;` |
|     3657 | 1338 | `		}` |
|        5 | 1339 | `	} /* For(;;) */` |
|        - | 1340 |  |
|    13023 | 1341 | ` 	return SXRET_OK;` |
|     6514 | 1342 |  |
|        - | 1343 |  |
