...
|        - |   18 | ` */` |
|  3809260 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|        2 |   20 |  |
|        - |   21 | `	SyString *pStr;` |
|        - |   22 | `	sxi32 rc;` |
|        - |   23 | `	/* Ignore leading white spaces */` |
|  5704330 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|        - |   25 | `		/* Advance the stream cursor */` |
|  1895070 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|        - |   27 | `			/* Update line counter */` |
|    23844 |   28 | `			pStream->nLine++;` |
|    11921 |   29 | `		}` |
|  1895070 |   30 | `		pStream->zText++;` |
|        2 |   31 | `	}` |
|  3809262 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|        - |   33 | `		/* End of input reached */` |
|      ! 0 |   34 | `		return SXERR_EOF;` |
|        - |   35 | `	}` |
|        - |   36 | `	/* Record token starting position and line */` |
|  3809262 |   37 | `	pToken->nLine = pStream->nLine;` |
|  3809262 |   38 | `	pToken->pUserData = 0;` |
|  3809262 |   39 | `	pStr = &pToken->sData;` |
|  3809262 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
|  4476015 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  1333508 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  1333492 |   53 | `			pStream->zText++;` |
|   666745 |   54 | `		}` |
|  1305223 |   55 | `		for(;;){` |
|  2610448 |   56 | `			zIn = pStream->zText;` |
|  2610448 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|       49 |   58 | `				zIn++;` |
|        - |   59 | `				/* UTF-8 stream */` |
...
| 10376221 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
|  6460552 |   66 | `				zIn++;` |
|        2 |   67 | `			}` |
|  2610448 |   68 | `			if( zIn == pStream->zText ){` |
|        - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  1333508 |   70 | `				break;` |
|        - |   71 | `			}` |
|        - |   72 | `			/* Synchronize pointers */` |
|  1276942 |   73 | `			pStream->zText = zIn;` |
|        2 |   74 | `		}` |
|        - |   75 | `		/* Record token length */` |
|  1333508 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  1333508 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
|  1333508 |   78 | `		if( nKeyword != PH7_TK_ID ){` |
|   432390 |   79 | `			if( nKeyword &` |
...
|     7512 |   82 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|        - |   83 | `					/* Mark as an operator */` |
|     7512 |   84 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|     3757 |   85 | `			}else{` |
|        - |   86 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|   424880 |   87 | `				pToken->nType = PH7_TK_KEYWORD;` |
|   424880 |   88 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|        - |   89 | `			}` |
|   216196 |   90 | `		}else{` |
|        - |   91 | `			/* A simple identifier */` |
|   901120 |   92 | `			pToken->nType = PH7_TK_ID;` |
|        - |   93 | `		}` |
|   666755 |   94 | `	}else{` |
|        - |   95 | `		sxi32 c;` |
|        - |   96 | `		/* Non-alpha stream */` |
|  2499824 |   97 | `		if( pStream->zText[0] == '#' \|\|` |
|  2475754 |   98 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|     3650 |   99 | `				pStream->zText++;` |
|        - |  100 | `				/* Inline comments */` |
|   130418 |  101 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|   126770 |  102 | `					pStream->zText++;` |
|        2 |  103 | `				}` |
|        - |  104 | `				/* Tell the upper-layer to ignore this token */` |
|     3650 |  105 | `				return SXERR_CONTINUE;` |
|  2472108 |  106 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
|    44432 |  107 | `			pStream->zText += 2;` |
|        - |  108 | `			/* Block comment */` |
|  1239104 |  109 | `			while( pStream->zText < pStream->zEnd ){` |
|  1239104 |  110 | `				if( pStream->zText[0] == '*' ){` |
|    44458 |  111 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    22217 |  112 | `						break;` |
|        - |  113 | `					}` |
|       13 |  114 | `				}` |
|  1194674 |  115 | `				if( pStream->zText[0] == '\n' ){` |
|       28 |  116 | `					pStream->nLine++;` |
|       13 |  117 | `				}` |
|  1194674 |  118 | `				pStream->zText++;` |
|        2 |  119 | `			}` |
|    44432 |  120 | `			pStream->zText += 2;` |
|        - |  121 | `			/* Tell the upper-layer to ignore this token */` |
|    44432 |  122 | `			return SXERR_CONTINUE;` |
|  2427678 |  123 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|    59228 |  124 | `			pStream->zText++;` |
|        - |  125 | `			/* Decimal digit stream */` |
|    65056 |  126 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|     5830 |  127 | `				pStream->zText++;` |
|        2 |  128 | `			}` |
|        - |  129 | `			/* Mark the token as integer until we encounter a real number */` |
|    59228 |  130 | `			pToken->nType = PH7_TK_INTEGER;` |
|    59228 |  131 | `			if( pStream->zText < pStream->zEnd ){` |
|    59224 |  132 | `				c = pStream->zText[0];` |
|    59224 |  133 | `				if( c == '.' ){` |
|        - |  134 | `					/* Real number */` |
...
|    59228 |  186 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    59228 |  187 | `			return SXRET_OK;` |
|        - |  188 | `		}` |
|  2368452 |  189 | `		c = pStream->zText[0];` |
|  2368452 |  190 | `		pStream->zText++; /* Advance the stream cursor */` |
|        - |  191 | `		/* Assume we are dealing with an operator*/` |
|  2368452 |  192 | `		pToken->nType = PH7_TK_OP;` |
|  2368452 |  193 | `		switch(c){` |
|   508322 |  194 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   174354 |  195 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   174340 |  196 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|   354066 |  197 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|    42122 |  198 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|        - |  199 | `														 * is a potential operator [i.e: subscripting] */` |
|    42128 |  200 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   177026 |  201 | `		case ')': {` |
|   354054 |  202 | `			SySet *pTokSet = pStream->pSet;` |
|        - |  203 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|   354054 |  204 | `			if( pTokSet->nUsed >= 2 ){` |
|        - |  205 | `				SyToken *pTmp;` |
|        - |  206 | `				/* Peek the last recongnized token */` |
|   354052 |  207 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|   354052 |  208 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|    10920 |  209 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|    10920 |  210 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|    10864 |  211 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|    10864 |  212 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|        - |  213 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    10778 |  214 | `							const char * zTypeCast = "(int)";` |
|    10778 |  215 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|     1782 |  216 | `								zTypeCast = "(float)";` |
|     9888 |  217 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|     1784 |  218 | `								zTypeCast = "(bool)";` |
|     8107 |  219 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|     5332 |  220 | `								zTypeCast = "(string)";` |
|     4551 |  221 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|       21 |  222 | `								zTypeCast = "(array)";` |
|     1876 |  223 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|       17 |  224 | `								zTypeCast = "(object)";` |
|     1858 |  225 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|        7 |  226 | `								zTypeCast = "(unset)";` |
|        3 |  227 | `							}` |
|        - |  228 | `							/* Reflect the change */` |
|    10778 |  229 | `							pToken->nType = PH7_TK_OP;` |
|    10778 |  230 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|        - |  231 | `							/* Save the instance associated with the type cast operator */` |
|    10778 |  232 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|        - |  233 | `							/* Remove the two previous tokens */` |
|    10778 |  234 | `							pTokSet->nUsed -= 2;` |
|    10778 |  235 | `							return SXRET_OK;` |
|        - |  236 | `						}` |
|       43 |  237 | `					}` |
|       71 |  238 | `				}` |
|   171637 |  239 | `			}` |
|   343278 |  240 | `			pToken->nType = PH7_TK_RPAREN;` |
|   343278 |  241 | `			break;` |
|        - |  242 | `				  }` |
|    17421 |  243 | `		case '\'':{` |
|        - |  244 | `			/* Single quoted string */` |
|    34844 |  245 | `			pStr->zString++;` |
|   376704 |  246 | `			while( pStream->zText < pStream->zEnd ){` |
|   376704 |  247 | `				if( pStream->zText[0] == '\''  ){` |
|    34854 |  248 | `					if( pStream->zText[-1] != '\\' ){` |
|    34830 |  249 | `						break;` |
|      ! 0 |  250 | `					}else{` |
...
|        - |  260 | `					}` |
|        5 |  261 | `				}` |
|   341862 |  262 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  263 | `					pStream->nLine++;` |
|        3 |  264 | `				}` |
|   341862 |  265 | `				pStream->zText++;` |
|        2 |  266 | `			}` |
|        - |  267 | `			/* Record token length and type */` |
|    34844 |  268 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    34844 |  269 | `			pToken->nType = PH7_TK_SSTR;` |
|        - |  270 | `			/* Jump the trailing single quote */` |
|    34844 |  271 | `			pStream->zText++;` |
|    34844 |  272 | `			return SXRET_OK;` |
|        - |  273 | `				  }` |
|     6294 |  274 | `		case '"':{` |
|        - |  275 | `			sxi32 iNest;` |
|        - |  276 | `			/* Double quoted string */` |
|    12590 |  277 | `			pStr->zString++;` |
|   139244 |  278 | `			while( pStream->zText < pStream->zEnd ){` |
|   139244 |  279 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       71 |  280 | `					iNest = 1;` |
...
|        - |  314 | `					}` |
|       50 |  315 | `				}` |
|   126656 |  316 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  317 | `					pStream->nLine++;` |
|        3 |  318 | `				}` |
|   126656 |  319 | `				pStream->zText++;` |
|        2 |  320 | `			}` |
...
|        - |  354 | `			}` |
|     1860 |  355 | `			break;` |
|    37038 |  356 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   277742 |  357 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|        - |  358 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|    87005 |  359 | `		case '=':` |
|   174012 |  360 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   174012 |  361 | `			if( pStream->zText < pStream->zEnd ){` |
|   174012 |  362 | `				if( pStream->zText[0] == '=' ){` |
|    12030 |  363 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|        - |  364 | `					/* Current operator: == */` |
|    12030 |  365 | `					pStream->zText++;` |
|    12030 |  366 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  367 | `						/* Current operator: === */` |
|     2874 |  368 | `						pStream->zText++;` |
|     1438 |  369 | `					}` |
|   167998 |  370 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  371 | `					/* Array operator: => */` |
|     2872 |  372 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|     2872 |  373 | `					pStream->zText++;` |
|     1437 |  374 | `				}else{` |
|        - |  375 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   159114 |  376 | `					const unsigned char *zCur = pStream->zText;` |
|   159114 |  377 | `					sxu32 nLine = 0;` |
|   318206 |  378 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   159094 |  379 | `						if( zCur[0] == '\n' ){` |
|        5 |  380 | `							nLine++;` |
|        2 |  381 | `						}` |
|   159094 |  382 | `						zCur++;` |
|        2 |  383 | `					}` |
|   159114 |  384 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   174012 |  394 | `			break;` |
|    11858 |  395 | `		case '!':` |
|    23718 |  396 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  397 | `				/* Current operator: != */` |
|    10802 |  398 | `				pStream->zText++;` |
|    10802 |  399 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  400 | `					/* Current operator: !== */` |
|     9000 |  401 | `					pStream->zText++;` |
|     4499 |  402 | `				}` |
|     5400 |  403 | `			}` |
|    23718 |  404 | `			break;` |
|     6427 |  405 | `		case '&':` |
|    12856 |  406 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    12856 |  407 | `			if( pStream->zText < pStream->zEnd ){` |
|    12856 |  408 | `				if( pStream->zText[0] == '&' ){` |
|     3906 |  409 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|        - |  410 | `					/* Current operator: && */` |
|     3906 |  411 | `					pStream->zText++;` |
|    10904 |  412 | `				}else if( pStream->zText[0] == '=' ){` |
...
|      146 |  429 | `			break;` |
|     3831 |  430 | `		case '+':` |
|     7664 |  431 | `			if( pStream->zText < pStream->zEnd ){` |
|     7662 |  432 | `				if( pStream->zText[0] == '+' ){` |
|        - |  433 | `					/* Current operator: ++ */` |
|     7290 |  434 | `					pStream->zText++;` |
|     4018 |  435 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     7664 |  440 | `			break;` |
|    34090 |  441 | `		case '-':` |
|    68182 |  442 | `			if( pStream->zText < pStream->zEnd ){` |
|    68182 |  443 | `				if( pStream->zText[0] == '-' ){` |
|        - |  444 | `					/* Current operator: -- */` |
|        5 |  445 | `					pStream->zText++;` |
|    68180 |  446 | `				}else if( pStream->zText[0] == '=' ){` |
|        - |  447 | `					/* Current operator: -= */` |
|        3 |  448 | `					pStream->zText++;` |
|    68177 |  449 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  450 | `					/* Current operator: -> */` |
|    67768 |  451 | `					pStream->zText++;` |
|    33883 |  452 | `				}` |
|    34090 |  453 | `			}` |
|    68182 |  454 | `			break;` |
|       69 |  455 | `		case '*':` |
...
|       19 |  478 | `			break;` |
|    16058 |  479 | `		case '.':` |
|    32118 |  480 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  481 | `				/* Current operator: .= */` |
|     1814 |  482 | `				pStream->zText++;` |
|      906 |  483 | `			}` |
|    32118 |  484 | `			break;` |
|    15265 |  485 | `		case '<':` |
|    30532 |  486 | `			if( pStream->zText < pStream->zEnd ){` |
|    30532 |  487 | `				if( pStream->zText[0] == '<' ){` |
...
|      ! 0 |  503 | `						}` |
|        9 |  504 | `					}` |
|    30468 |  505 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  506 | `					/* Current operator: <> */` |
|        5 |  507 | `					pStream->zText++;` |
|    30458 |  508 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    30476 |  513 | `			break;` |
|     1872 |  514 | `		case '>':` |
|     3746 |  515 | `			if( pStream->zText < pStream->zEnd ){` |
|     3746 |  516 | `				if( pStream->zText[0] == '>' ){` |
...
|        9 |  521 | `						pStream->zText++;` |
|        5 |  522 | `					}` |
|     3738 |  523 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     1784 |  530 | `			break;` |
|        - |  531 | `		}` |
|  2310186 |  532 | `		if( pStr->nByte <= 0 ){` |
|        - |  533 | `			/* Record token length */` |
|  2310146 |  534 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  1155072 |  535 | `		}` |
|  2310186 |  536 | `		if( pToken->nType & PH7_TK_OP ){` |
|        - |  537 | `			const ph7_expr_op *pOp;` |
|        - |  538 | `			/* Check if the extracted token is an operator */` |
|   431268 |  539 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|   431268 |  540 | `			if( pOp == 0 ){` |
|        - |  541 | `				/* Not an operator */` |
...
|        - |  569 | `*/` |
|        - |  570 | `/* Hash score: 103 */` |
|  1333508 |  571 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|        - |  659 | `  };` |
|        - |  660 | `  int h, i;` |
|  1333508 |  661 | `  if( n<2 ) return PH7_TK_ID;` |
|  1276920 |  662 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  1936084 |  663 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  1091554 |  664 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|        - |  747 | `       /* PH7_TKWRD_OR */` |
|        - |  748 | `       /* PH7_TKWRD_BREAK */` |
|   432390 |  749 | `      return aCode[i];` |
|        - |  750 | `    }` |
|   329584 |  751 | `  }` |
|   844532 |  752 | `  return PH7_TK_ID;` |
|   666755 |  753 |  |
...
|        - |  908 | ` */` |
|    10782 |  909 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut)` |
|        2 |  910 |  |
|        - |  911 | `	SyLex sLexer;` |
|        - |  912 | `	sxi32 rc;` |
|        - |  913 | `	/* Initialize the lexer */` |
|    10784 |  914 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,0);` |
|    10784 |  915 | `	if( rc != SXRET_OK ){` |
|      ! 0 |  916 | `		return rc;` |
|        - |  917 | `	}` |
|    10784 |  918 | `	sLexer.sStream.nLine = nLineStart;` |
|        - |  919 | `	/* Tokenize input */` |
|    10784 |  920 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|        - |  921 | `	/* Release the lexer */` |
|    10784 |  922 | `	SyLexRelease(&sLexer);` |
...
|        - |  970 | ` */` |
|     9030 |  971 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|        2 |  972 |  |
|     9032 |  973 | `	const char *zEnd = &zInput[nLen];` |
|     9032 |  974 | `	const char *zIn  = zInput;` |
|        - |  975 | `	const char *zCur,*zCurEnd;` |
|     9032 |  976 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|        - |  977 | `	SyToken sToken;` |
|        - |  978 | `	SyString sDoc;` |
|        - |  979 | `	sxu32 nLine;` |
|        - |  980 | `	sxi32 iNest;` |
...
|     9032 |  983 | `	nLine = 1;` |
|     9032 |  984 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     9032 |  985 | `	sToken.pUserData = 0;` |
|     9032 |  986 | `	iNest = 0;` |
|     9032 |  987 | `	sDoc.nByte = 0;` |
|     9032 |  988 | `	sDoc.zString = ""; /* cc warning */` |
|     9032 |  989 | `	for(;;){` |
|    18066 |  990 | `		if( zIn >= zEnd ){` |
|        - |  991 | `			/* End of input reached */` |
|     9028 |  992 | `			break;` |
|        - |  993 | `		}` |
|     9040 |  994 | `		sToken.nLine = nLine;` |
|     9040 |  995 | `		zCur = zIn;` |
|     9040 |  996 | `		zCurEnd = 0;` |
|     9048 |  997 | `		while( zIn < zEnd ){` |
|     9044 |  998 | `			 if( zIn[0] == '<' ){` |
|     9036 |  999 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     9036 | 1000 | `				zIn++;` |
|     9036 | 1001 | `				if( zIn < zEnd ){` |
|     9036 | 1002 | `					if( zIn[0] == '?' ){` |
|     9036 | 1003 | `						zIn++;` |
|     9036 | 1004 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|        - | 1005 | `							/* opening tag: <?php */` |
|     9034 | 1006 | `							zIn += sizeof("php")-1;` |
|     4516 | 1007 | `						}` |
|        - | 1008 | `						/* Look for the closing tag '?>' */` |
|     9036 | 1009 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     9036 | 1010 | `						zCurEnd = zTmp;` |
|     9036 | 1011 | `						break;` |
|        - | 1012 | `					}` |
|      ! 0 | 1013 | `				}` |
|      ! 0 | 1014 | `			}else{` |
...
|     9040 | 1021 | `		if( zCurEnd == 0 ){` |
|        5 | 1022 | `			zCurEnd = zIn;` |
|        2 | 1023 | `		}` |
|        - | 1024 | `		/* Save the raw token */` |
|     9040 | 1025 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     9040 | 1026 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     9040 | 1027 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     9040 | 1028 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 1029 | `			return rc;` |
|        - | 1030 | `		}` |
|     9040 | 1031 | `		if( zIn >= zEnd ){` |
|        5 | 1032 | `			break;` |
|        - | 1033 | `		}` |
|        - | 1034 | `		/* Ignore leading white space */` |
|    19616 | 1035 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|    10582 | 1036 | `			if( zIn[0] == '\n' ){` |
|     9422 | 1037 | `				nLine++;` |
|     4710 | 1038 | `			}` |
|    10582 | 1039 | `			zIn++;` |
...
|     9036 | 1042 | `		sToken.nLine = nLine;` |
|     9036 | 1043 | `		zCur = zIn;` |
|   833310 | 1044 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|        - | 1045 | `			const char *zPtr;` |
|   829536 | 1046 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|     5262 | 1047 | `				break;` |
|        - | 1048 | `			}` |
|   414023 | 1049 | `			for(;;){` |
|   828048 | 1050 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|   412139 | 1051 | `					break;` |
|        - | 1052 | `				}` |
|     3774 | 1053 | `				zIn += 2;` |
|     3774 | 1054 | `				if( zIn[-1] == '/' ){` |
|        - | 1055 | `					/* Inline comment */` |
|   128406 | 1056 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|   124714 | 1057 | `						zIn++;` |
|        2 | 1058 | `					}` |
|     3694 | 1059 | `					if( zIn >= zEnd ){` |
|      ! 0 | 1060 | `						zIn--;` |
|      ! 0 | 1061 | `					}` |
|     1848 | 1062 | `				}else{` |
|        - | 1063 | `					/* Block comment */` |
...
|        - | 1074 | `				}` |
|        2 | 1075 | `			}` |
|   824276 | 1076 | `			if( zIn[0] == '\n' ){` |
|    28222 | 1077 | `				nLine++;` |
|    28222 | 1078 | `				if( iNest > 0 ){` |
|      156 | 1079 | `					zIn++;` |
...
|      156 | 1098 | `					continue;` |
|        2 | 1099 | `				}` |
|   810089 | 1100 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   824062 | 1127 | `			zIn++;` |
|        - | 1128 |  |
|   824062 | 1129 | `			if ( zIn >= zEnd )` |
|      ! 0 | 1130 | `				break;` |
|        2 | 1131 | `		}` |
|     9036 | 1132 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|     3776 | 1133 | `			zIn = zEnd;` |
|     1887 | 1134 | `		}` |
|     9036 | 1135 | `		if( zCur < zIn ){` |
|        - | 1136 | `			/* Save the PHP chunk for later processing */` |
|     7512 | 1137 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     7512 | 1138 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|    15016 | 1139 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     7512 | 1140 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     7512 | 1141 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1142 | `				return rc;` |
|        - | 1143 | `			}` |
|     3755 | 1144 | `		}` |
|     9036 | 1145 | `		if( zIn < zEnd ){` |
|        - | 1146 | `			/* Jump the trailing closing tag */` |
|     5262 | 1147 | `			zIn += sCtag.nByte;` |
|     2630 | 1148 | `		}` |
|        2 | 1149 | `	} /* For(;;) */` |
|        - | 1150 |  |
|     9032 | 1151 | ` 	return SXRET_OK;` |
|     4517 | 1152 |  |
|        - | 1153 |  |
