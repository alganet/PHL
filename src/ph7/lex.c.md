...
|         - |   18 | ` */` |
| 158323148 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 233627739 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  75304591 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     52775 |   28 | `			pStream->nLine++;` |
|     26385 |   29 | `		}` |
|  75304591 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 158323153 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 158323153 |   37 | `	pToken->nLine = pStream->nLine;` |
| 158323153 |   38 | `	pToken->pUserData = 0;` |
| 158323153 |   39 | `	pStr = &pToken->sData;` |
| 158323153 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 184665773 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  52685245 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  52685229 |   53 | `			pStream->zText++;` |
|  26342612 |   54 | `		}` |
|  49328637 |   55 | `		for(;;){` |
|  98657279 |   56 | `			zIn = pStream->zText;` |
|  98657279 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 393155574 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 245169663 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
|  98657279 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  52685245 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  45972039 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  52685245 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  52685245 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  52685240 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  18122294 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       807 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       401 |   85 | `		}` |
|  52685245 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  17551899 |   87 | `			if( nKeyword &` |
...
|  16671751 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  16671751 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   8775952 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  35133351 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  26342625 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
| 105637913 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
| 105730965 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
| 105630126 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
...
| 105623239 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
| 105432389 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   3359703 |  234 | `			pStream->zText++;` |
...
|   3359698 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   3359698 |  239 | `				&& pStream->zText[0] == '_'` |
|   1679929 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   4193609 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    833911 |  247 | `				pStream->zText++;` |
|    833906 |  248 | `				if( pStream->zText < pStream->zEnd` |
|    833906 |  249 | `					&& pStream->zText[0] == '_'` |
|    417039 |  250 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   3359703 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   3359703 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   3359703 |  259 | `				c = pStream->zText[0];` |
|   3359703 |  260 | `				if( c == '.' ){` |
...
|   3359703 |  351 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   3359703 |  359 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   3359703 |  360 | `			return SXRET_OK;` |
|         - |  361 | `		}` |
| 102072691 |  362 | `		c = pStream->zText[0];` |
| 102072691 |  363 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  364 | `		/* Assume we are dealing with an operator*/` |
| 102072691 |  365 | `		pToken->nType = PH7_TK_OP;` |
| 102072691 |  366 | `		switch(c){` |
|  21066411 |  367 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   6290515 |  368 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   6290501 |  369 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  13136935 |  370 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|   3032211 |  371 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|         - |  372 | `														 * is a potential operator [i.e: subscripting] */` |
|   3032217 |  373 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   6568453 |  374 | `		case ')': {` |
|  13136911 |  375 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  376 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  13136911 |  377 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  378 | `				SyToken *pTmp;` |
|         - |  379 | `				/* Peek the last recongnized token */` |
|  13136909 |  380 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  13136909 |  381 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
...
|    213660 |  411 | `				}` |
|   6303321 |  412 | `			}` |
|  12606649 |  413 | `			pToken->nType = PH7_TK_RPAREN;` |
|  12606649 |  414 | `			break;` |
|         - |  415 | `				  }` |
|   2396488 |  416 | `		case '\'':{` |
...
|    119331 |  450 | `			pStr->zString++;` |
|   1700281 |  451 | `			while( pStream->zText < pStream->zEnd ){` |
|   1700281 |  452 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       113 |  453 | `					iNest = 1;` |
...
|         - |  472 | `					}` |
|        55 |  473 | `				}` |
|   1700281 |  474 | `				if( pStream->zText[0] == '"' ){` |
|    119609 |  475 | `					if( pStream->zText[-1] != '\\' ){` |
|    119325 |  476 | `						break;` |
|       ! 0 |  477 | `					}else{` |
...
|         - |  487 | `					}` |
|       139 |  488 | `				}` |
|   1580955 |  489 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  490 | `					pStream->nLine++;` |
|        14 |  491 | `				}` |
|   1580955 |  492 | `				pStream->zText++;` |
|         5 |  493 | `			}` |
|         - |  494 | `			/* Record token length and type */` |
|    119331 |  495 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    119331 |  496 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  497 | `			/* Jump the trailing quote */` |
|    119331 |  498 | `			pStream->zText++;` |
|    119331 |  499 | `			return SXRET_OK;` |
|         - |  500 | `				  }` |
|         2 |  501 | ``		case '`':{`` |
...
|    402981 |  521 | `		case ':':` |
|    805967 |  522 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|         - |  523 | `				/* Current operator: '::' */` |
|    359231 |  524 | `				pStream->zText++;` |
|    179618 |  525 | `			}else{` |
|    446741 |  526 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|         - |  527 | `			}` |
|    805967 |  528 | `			break;` |
|   3494361 |  529 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   9901887 |  530 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  531 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   3514022 |  532 | `		case '=':` |
|   7028049 |  533 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   7028049 |  534 | `			if( pStream->zText < pStream->zEnd ){` |
|   7028049 |  535 | `				if( pStream->zText[0] == '=' ){` |
...
|    587747 |  542 | `					}` |
|   6415351 |  543 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  544 | `					/* Array operator: => */` |
|    426227 |  545 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    426227 |  546 | `					pStream->zText++;` |
|    213116 |  547 | `				}else{` |
|         - |  548 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   5376431 |  549 | `					const unsigned char *zCur = pStream->zText;` |
|   5376431 |  550 | `					sxu32 nLine = 0;` |
|  10752693 |  551 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   5376267 |  552 | `						if( zCur[0] == '\n' ){` |
|         5 |  553 | `							nLine++;` |
|         2 |  554 | `						}` |
|   5376267 |  555 | `						zCur++;` |
|         5 |  556 | `					}` |
|   5376431 |  557 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|        23 |  663 | `			break;` |
|    957462 |  664 | `		case '.':` |
|   1914929 |  665 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|         - |  666 | `				/* Ellipsis: ... */` |
|     27127 |  667 | `				pStream->zText += 2;` |
|     27127 |  668 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|   1901368 |  669 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
...
|     11684 |  737 | `			break;` |
|         - |  738 | `		}` |
|  96630005 |  739 | `		if( pStr->nByte <= 0 ){` |
|         - |  740 | `			/* Record token length */` |
|  96629943 |  741 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  48314969 |  742 | `		}` |
|  96630005 |  743 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  744 | `			const ph7_expr_op *pOp;` |
|         - |  745 | `			/* Check if the extracted token is an operator */` |
|  23396343 |  746 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  23396343 |  747 | `			if( pOp == 0 ){` |
|         - |  748 | `				/* Not an operator */` |
...
|         - |  779 | `*/` |
|         - |  780 | `/* Hash score: 103 */` |
|  52685245 |  781 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  869 | `  };` |
|         - |  870 | `  int h, i;` |
|  52685245 |  871 | `  if( n<2 ) return PH7_TK_ID;` |
|  45972017 |  872 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  71028803 |  873 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  42599589 |  874 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  957 | `       /* PH7_TKWRD_OR */` |
|         - |  958 | `       /* PH7_TKWRD_BREAK */` |
|  17542803 |  959 | `      return aCode[i];` |
|         - |  960 | `    }` |
|  12528396 |  961 | `  }` |
|         - |  962 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  28429219 |  963 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  28421515 |  964 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  28421511 |  965 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  28421339 |  966 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  28405703 |  967 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  28405627 |  968 | `  return PH7_TK_ID;` |
|  26342625 |  969 | `}` |
...
|         - | 1206 | ` */` |
|     13258 | 1207 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|         5 | 1208 | `{` |
|     13263 | 1209 | `	const char *zEnd = &zInput[nLen];` |
|     13263 | 1210 | `	const char *zIn  = zInput;` |
|         - | 1211 | `	const char *zCur,*zCurEnd;` |
|     13263 | 1212 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|         - | 1213 | `	SyToken sToken;` |
|         - | 1214 | `	SyString sDoc;` |
|         - | 1215 | `	sxu32 nLine;` |
|         - | 1216 | `	sxi32 iNest;` |
...
|     13263 | 1219 | `	nLine = 1;` |
|     13263 | 1220 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|     13263 | 1221 | `	sToken.pUserData = 0;` |
|     13263 | 1222 | `	iNest = 0;` |
|     13263 | 1223 | `	sDoc.nByte = 0;` |
|     13263 | 1224 | `	sDoc.zString = ""; /* cc warning */` |
|     13258 | 1225 | `	for(;;){` |
|     26521 | 1226 | `		if( zIn >= zEnd ){` |
|         - | 1227 | `			/* End of input reached */` |
|     13253 | 1228 | `			break;` |
|         - | 1229 | `		}` |
|     13273 | 1230 | `		sToken.nLine = nLine;` |
|     13273 | 1231 | `		zCur = zIn;` |
|     13273 | 1232 | `		zCurEnd = 0;` |
|     13465 | 1233 | `		while( zIn < zEnd ){` |
|     13455 | 1234 | `			 if( zIn[0] == '<' ){` |
|     13263 | 1235 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|     13263 | 1236 | `				zIn++;` |
|     13263 | 1237 | `				if( zIn < zEnd ){` |
|     13263 | 1238 | `					if( zIn[0] == '?' ){` |
|     13263 | 1239 | `						zIn++;` |
|     13263 | 1240 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|         - | 1241 | `							/* opening tag: <?php */` |
|     13261 | 1242 | `							zIn += sizeof("php")-1;` |
|      6628 | 1243 | `						}` |
|         - | 1244 | `						/* Look for the closing tag '?>' */` |
|     13263 | 1245 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|     13263 | 1246 | `						zCurEnd = zTmp;` |
|     13263 | 1247 | `						break;` |
|         - | 1248 | `					}` |
|       ! 0 | 1249 | `				}` |
|       ! 0 | 1250 | `			}else{` |
...
|     13273 | 1257 | `		if( zCurEnd == 0 ){` |
|        13 | 1258 | `			zCurEnd = zIn;` |
|         5 | 1259 | `		}` |
|         - | 1260 | `		/* Save the raw token */` |
|     13273 | 1261 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13273 | 1262 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13273 | 1263 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13273 | 1264 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1265 | `			return rc;` |
|         - | 1266 | `		}` |
|     13273 | 1267 | `		if( zIn >= zEnd ){` |
|        13 | 1268 | `			break;` |
|         - | 1269 | `		}` |
|         - | 1270 | `		/* Ignore leading white space */` |
|     28259 | 1271 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     15001 | 1272 | `			if( zIn[0] == '\n' ){` |
|     14559 | 1273 | `				nLine++;` |
|      7277 | 1274 | `			}` |
|     15001 | 1275 | `			zIn++;` |
...
|     13263 | 1278 | `		sToken.nLine = nLine;` |
|     13263 | 1279 | `		zCur = zIn;` |
|   1802043 | 1280 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1281 | `			const char *zPtr;` |
|   1795945 | 1282 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7161 | 1283 | `				break;` |
|         - | 1284 | `			}` |
|    898012 | 1285 | `			for(;;){` |
|   1796029 | 1286 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|    894397 | 1287 | `					break;` |
|         - | 1288 | `				}` |
|      7245 | 1289 | `				zIn += 2;` |
|      7245 | 1290 | `				if( zIn[-1] == '/' ){` |
...
|         - | 1310 | `				}` |
|         5 | 1311 | `			}` |
|   1788789 | 1312 | `			if( zIn[0] == '\n' ){` |
|     59947 | 1313 | `				nLine++;` |
|     59947 | 1314 | `				if( iNest > 0 ){` |
|       328 | 1315 | `					zIn++;` |
...
|       328 | 1334 | `					continue;` |
|         5 | 1335 | `				}` |
|   1758656 | 1336 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|   1788347 | 1363 | `			zIn++;` |
|         - | 1364 |  |
|   1788347 | 1365 | `			if ( zIn >= zEnd )` |
|         5 | 1366 | `				break;` |
|         5 | 1367 | `		}` |
|     13263 | 1368 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|      6107 | 1369 | `			zIn = zEnd;` |
|      3051 | 1370 | `		}` |
|     13263 | 1371 | `		if( zCur < zIn ){` |
...
|     20101 | 1375 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     10115 | 1376 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     10115 | 1377 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1378 | `				return rc;` |
|         - | 1379 | `			}` |
|      5055 | 1380 | `		}` |
|     13263 | 1381 | `		if( zIn < zEnd ){` |
