...
|        - |   18 | ` */` |
|  9885538 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|        5 |   20 |  |
|        - |   21 | `	SyString *pStr;` |
|        - |   22 | `	sxi32 rc;` |
|        - |   23 | `	/* Ignore leading white spaces */` |
| 14886633 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|        - |   25 | `		/* Advance the stream cursor */` |
|  5001095 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|        - |   27 | `			/* Update line counter */` |
|    36943 |   28 | `			pStream->nLine++;` |
|    18469 |   29 | `		}` |
|  5001095 |   30 | `		pStream->zText++;` |
|        5 |   31 | `	}` |
|  9885543 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|        - |   33 | `		/* End of input reached */` |
|      ! 0 |   34 | `		return SXERR_EOF;` |
|        - |   35 | `	}` |
|        - |   36 | `	/* Record token starting position and line */` |
|  9885543 |   37 | `	pToken->nLine = pStream->nLine;` |
|  9885543 |   38 | `	pToken->pUserData = 0;` |
|  9885543 |   39 | `	pStr = &pToken->sData;` |
|  9885543 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 11770951 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  3770821 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  3770805 |   53 | `			pStream->zText++;` |
|  1885400 |   54 | `		}` |
|  3714740 |   55 | `		for(;;){` |
|  7429485 |   56 | `			zIn = pStream->zText;` |
|  7429485 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|       49 |   58 | `				zIn++;` |
|        - |   59 | `				/* UTF-8 stream */` |
...
| 31903075 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 20758855 |   66 | `				zIn++;` |
|        5 |   67 | `			}` |
|  7429485 |   68 | `			if( zIn == pStream->zText ){` |
|        - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  3770821 |   70 | `				break;` |
|        - |   71 | `			}` |
|        - |   72 | `			/* Synchronize pointers */` |
|  3658669 |   73 | `			pStream->zText = zIn;` |
|        5 |   74 | `		}` |
|        - |   75 | `		/* Record token length */` |
|  3770821 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  3770821 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|        - |   81 | `		 */` |
|  3771350 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  1194511 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|      394 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|      195 |   85 | `		}` |
|  3770821 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  1390699 |   87 | `			if( nKeyword &` |
...
|    17477 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|        - |   91 | `					/* Mark as an operator */` |
|    17477 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|     8741 |   93 | `			}else{` |
|        - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  1373227 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  1373227 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|        - |   97 | `			}` |
|   695352 |   98 | `		}else{` |
|        - |   99 | `			/* A simple identifier */` |
|  2380127 |  100 | `			pToken->nType = PH7_TK_ID;` |
|        - |  101 | `		}` |
|  1885413 |  102 | `	}else{` |
|        - |  103 | `		sxi32 c;` |
|        - |  104 | `		/* Non-alpha stream */` |
|  6114727 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
...
|  6156978 |  170 | `		}else if( pStream->zText[0] == '#' \|\|` |
|  6114648 |  171 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|     4389 |  172 | `				pStream->zText++;` |
|        - |  173 | `				/* Inline comments */` |
|   164655 |  174 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|   160271 |  175 | `					pStream->zText++;` |
|        5 |  176 | `				}` |
|        - |  177 | `				/* Tell the upper-layer to ignore this token */` |
|     4389 |  178 | `				return SXERR_CONTINUE;` |
|  6110275 |  179 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
|    80195 |  180 | `			pStream->zText += 2;` |
|        - |  181 | `			/* Block comment */` |
|  2428989 |  182 | `			while( pStream->zText < pStream->zEnd ){` |
|  2428989 |  183 | `				if( pStream->zText[0] == '*' ){` |
|    80249 |  184 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|    40100 |  185 | `						break;` |
|        - |  186 | `					}` |
|       27 |  187 | `				}` |
|  2348799 |  188 | `				if( pStream->zText[0] == '\n' ){` |
|       55 |  189 | `					pStream->nLine++;` |
|       25 |  190 | `				}` |
|  2348799 |  191 | `				pStream->zText++;` |
|        5 |  192 | `			}` |
|    80195 |  193 | `			pStream->zText += 2;` |
|        - |  194 | `			/* Tell the upper-layer to ignore this token */` |
|    80195 |  195 | `			return SXERR_CONTINUE;` |
|  6030085 |  196 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   113561 |  197 | `			pStream->zText++;` |
...
|   113636 |  201 | `			if( pStream->zText < pStream->zEnd` |
|   113556 |  202 | `				&& pStream->zText[0] == '_'` |
|    56858 |  203 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   124513 |  209 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    10957 |  210 | `				pStream->zText++;` |
|    11038 |  211 | `				if( pStream->zText < pStream->zEnd` |
|    10952 |  212 | `					&& pStream->zText[0] == '_'` |
|     5562 |  213 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   113561 |  220 | `			pToken->nType = PH7_TK_INTEGER;` |
|   113561 |  221 | `			if( pStream->zText < pStream->zEnd ){` |
|   113561 |  222 | `				c = pStream->zText[0];` |
|   113561 |  223 | `				if( c == '.' ){` |
...
|   113561 |  314 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   113561 |  322 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   113561 |  323 | `			return SXRET_OK;` |
|        - |  324 | `		}` |
|  5916529 |  325 | `		c = pStream->zText[0];` |
|  5916529 |  326 | `		pStream->zText++; /* Advance the stream cursor */` |
|        - |  327 | `		/* Assume we are dealing with an operator*/` |
|  5916529 |  328 | `		pToken->nType = PH7_TK_OP;` |
|  5916529 |  329 | `		switch(c){` |
|  1193263 |  330 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   510409 |  331 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   510395 |  332 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|   916185 |  333 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|    83333 |  334 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|        - |  335 | `														 * is a potential operator [i.e: subscripting] */` |
|    83339 |  336 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   458082 |  337 | `		case ')': {` |
|   916169 |  338 | `			SySet *pTokSet = pStream->pSet;` |
|        - |  339 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|   916169 |  340 | `			if( pTokSet->nUsed >= 2 ){` |
|        - |  341 | `				SyToken *pTmp;` |
|        - |  342 | `				/* Peek the last recongnized token */` |
|   916167 |  343 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|   916167 |  344 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|    16617 |  345 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|    16617 |  346 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|    16365 |  347 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|    16365 |  348 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|        - |  349 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    16281 |  350 | `							const char * zTypeCast = "(int)";` |
|    16281 |  351 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|     3221 |  352 | `								zTypeCast = "(float)";` |
|    14673 |  353 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|     3217 |  354 | `								zTypeCast = "(bool)";` |
|    11459 |  355 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|     6441 |  356 | `								zTypeCast = "(string)";` |
|     6635 |  357 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|       21 |  358 | `								zTypeCast = "(array)";` |
|     3407 |  359 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|       17 |  360 | `								zTypeCast = "(object)";` |
|     3389 |  361 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|        7 |  362 | `								zTypeCast = "(unset)";` |
|        3 |  363 | `							}` |
|        - |  364 | `							/* Reflect the change */` |
|    16281 |  365 | `							pToken->nType = PH7_TK_OP;` |
|    16281 |  366 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|        - |  367 | `							/* Save the instance associated with the type cast operator */` |
|    16281 |  368 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|        - |  369 | `							/* Remove the two previous tokens */` |
|    16281 |  370 | `							pTokSet->nUsed -= 2;` |
|    16281 |  371 | `							return SXRET_OK;` |
|        - |  372 | `						}` |
|       42 |  373 | `					}` |
|      168 |  374 | `				}` |
|   449943 |  375 | `			}` |
|   899893 |  376 | `			pToken->nType = PH7_TK_RPAREN;` |
|   899893 |  377 | `			break;` |
|        - |  378 | `				  }` |
|    40765 |  379 | `		case '\'':{` |
|        - |  380 | `			/* Single quoted string */` |
|    81535 |  381 | `			pStr->zString++;` |
|   834045 |  382 | `			while( pStream->zText < pStream->zEnd ){` |
|   834045 |  383 | `				if( pStream->zText[0] == '\''  ){` |
|    81545 |  384 | `					if( pStream->zText[-1] != '\\' ){` |
|    81521 |  385 | `						break;` |
|      ! 0 |  386 | `					}else{` |
...
|        - |  396 | `					}` |
|        5 |  397 | `				}` |
|   752515 |  398 | `				if( pStream->zText[0] == '\n' ){` |
|       67 |  399 | `					pStream->nLine++;` |
|       33 |  400 | `				}` |
|   752515 |  401 | `				pStream->zText++;` |
|        5 |  402 | `			}` |
|        - |  403 | `			/* Record token length and type */` |
|    81535 |  404 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    81535 |  405 | `			pToken->nType = PH7_TK_SSTR;` |
|        - |  406 | `			/* Jump the trailing single quote */` |
|    81535 |  407 | `			pStream->zText++;` |
|    81535 |  408 | `			return SXRET_OK;` |
|        - |  409 | `				  }` |
|    10465 |  410 | `		case '"':{` |
|        - |  411 | `			sxi32 iNest;` |
|        - |  412 | `			/* Double quoted string */` |
|    20935 |  413 | `			pStr->zString++;` |
|   187181 |  414 | `			while( pStream->zText < pStream->zEnd ){` |
|   187181 |  415 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|      113 |  416 | `					iNest = 1;` |
...
|        - |  435 | `					}` |
|       55 |  436 | `				}` |
|   187181 |  437 | `				if( pStream->zText[0] == '"' ){` |
|    21127 |  438 | `					if( pStream->zText[-1] != '\\' ){` |
|    20931 |  439 | `						break;` |
|      ! 0 |  440 | `					}else{` |
...
|        - |  450 | `					}` |
|       96 |  451 | `				}` |
|   166251 |  452 | `				if( pStream->zText[0] == '\n' ){` |
|        7 |  453 | `					pStream->nLine++;` |
|        3 |  454 | `				}` |
|   166251 |  455 | `				pStream->zText++;` |
|        5 |  456 | `			}` |
|        - |  457 | `			/* Record token length and type */` |
|    20935 |  458 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|    20935 |  459 | `			pToken->nType = PH7_TK_DSTR;` |
|        - |  460 | `			/* Jump the trailing quote */` |
|    20935 |  461 | `			pStream->zText++;` |
|    20935 |  462 | `			return SXRET_OK;` |
|        - |  463 | `				  }` |
|        2 |  464 | ``		case '`':{`` |
...
|     1811 |  484 | `		case ':':` |
|     3627 |  485 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|        - |  486 | `				/* Current operator: '::' */` |
|      297 |  487 | `				pStream->zText++;` |
|      151 |  488 | `			}else{` |
|     3335 |  489 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|        - |  490 | `			}` |
|     3627 |  491 | `			break;` |
|    98335 |  492 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   704973 |  493 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|        - |  494 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   186121 |  495 | `		case '=':` |
|   372247 |  496 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   372247 |  497 | `			if( pStream->zText < pStream->zEnd ){` |
|   372247 |  498 | `				if( pStream->zText[0] == '=' ){` |
|    20911 |  499 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|        - |  500 | `					/* Current operator: == */` |
|    20911 |  501 | `					pStream->zText++;` |
|    20911 |  502 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  503 | `						/* Current operator: === */` |
|     4563 |  504 | `						pStream->zText++;` |
|     2284 |  505 | `					}` |
|   361794 |  506 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  507 | `					/* Array operator: => */` |
|     5175 |  508 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|     5175 |  509 | `					pStream->zText++;` |
|     2590 |  510 | `				}else{` |
|        - |  511 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   346171 |  512 | `					const unsigned char *zCur = pStream->zText;` |
|   346171 |  513 | `					sxu32 nLine = 0;` |
|   692199 |  514 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   346033 |  515 | `						if( zCur[0] == '\n' ){` |
|        5 |  516 | `							nLine++;` |
|        2 |  517 | `						}` |
|   346033 |  518 | `						zCur++;` |
|        5 |  519 | `					}` |
|   346171 |  520 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   372247 |  530 | `			break;` |
|    22838 |  531 | `		case '!':` |
|    45681 |  532 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  533 | `				/* Current operator: != */` |
|    19423 |  534 | `				pStream->zText++;` |
|    19423 |  535 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  536 | `					/* Current operator: !== */` |
|    16187 |  537 | `					pStream->zText++;` |
|     8091 |  538 | `				}` |
|     9709 |  539 | `			}` |
|    45681 |  540 | `			break;` |
|    13105 |  541 | `		case '&':` |
|    26215 |  542 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    26215 |  543 | `			if( pStream->zText < pStream->zEnd ){` |
|    26215 |  544 | `				if( pStream->zText[0] == '&' ){` |
|    10057 |  545 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|        - |  546 | `					/* Current operator: && */` |
|    10057 |  547 | `					pStream->zText++;` |
|    21189 |  548 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    26215 |  554 | `			break;` |
|     1756 |  555 | `		case '\|':` |
|     3517 |  556 | `			if( pStream->zText < pStream->zEnd ){` |
|     3517 |  557 | `				if( pStream->zText[0] == '\|' ){` |
|        - |  558 | `					/* Current operator: \|\| */` |
|     3375 |  559 | `					pStream->zText++;` |
|     1832 |  560 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     3517 |  565 | `			break;` |
|     8462 |  566 | `		case '+':` |
|    16929 |  567 | `			if( pStream->zText < pStream->zEnd ){` |
|    16927 |  568 | `				if( pStream->zText[0] == '+' ){` |
|        - |  569 | `					/* Current operator: ++ */` |
|    13169 |  570 | `					pStream->zText++;` |
|    10345 |  571 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    16929 |  576 | `			break;` |
|    87724 |  577 | `		case '-':` |
|   175453 |  578 | `			if( pStream->zText < pStream->zEnd ){` |
|   175453 |  579 | `				if( pStream->zText[0] == '-' ){` |
|        - |  580 | `					/* Current operator: -- */` |
|       29 |  581 | `					pStream->zText++;` |
|   175439 |  582 | `				}else if( pStream->zText[0] == '=' ){` |
|        - |  583 | `					/* Current operator: -= */` |
|       10 |  584 | `					pStream->zText++;` |
|   175421 |  585 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  586 | `					/* Current operator: -> */` |
|   174859 |  587 | `					pStream->zText++;` |
|    87427 |  588 | `				}` |
|    87724 |  589 | `			}` |
|   175453 |  590 | `			break;` |
|      174 |  591 | `		case '*':` |
...
|       23 |  623 | `			break;` |
|    44238 |  624 | `		case '.':` |
|    88481 |  625 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|        - |  626 | `				/* Ellipsis: ... */` |
|      133 |  627 | `				pStream->zText += 2;` |
|      133 |  628 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|    88417 |  629 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|        - |  630 | `				/* Current operator: .= */` |
|     3331 |  631 | `				pStream->zText++;` |
|     1663 |  632 | `			}` |
|    88481 |  633 | `			break;` |
|    27524 |  634 | `		case '<':` |
|    55053 |  635 | `			if( pStream->zText < pStream->zEnd ){` |
|    55053 |  636 | `				if( pStream->zText[0] == '<' ){` |
...
|      ! 0 |  652 | `						}` |
|       12 |  653 | `					}` |
|    54928 |  654 | `				}else if( pStream->zText[0] == '>' ){` |
|        - |  655 | `					/* Current operator: <> */` |
|        5 |  656 | `					pStream->zText++;` |
|    54915 |  657 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    54939 |  666 | `			break;` |
|     3337 |  667 | `		case '>':` |
|     6679 |  668 | `			if( pStream->zText < pStream->zEnd ){` |
|     6679 |  669 | `				if( pStream->zText[0] == '>' ){` |
...
|        6 |  675 | `					}` |
|     6669 |  676 | `				}else if( pStream->zText[0] == '=' ){` |
...
|     6679 |  681 | `			break;` |
|     1460 |  682 | `		case '?':` |
|     2925 |  683 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '?' ){` |
...
|       31 |  689 | `				}` |
|     2886 |  690 | `			}else if( (pStream->zEnd - pStream->zText) >= 2` |
|     2739 |  691 | `				&& pStream->zText[0] == '-' && pStream->zText[1] == '>' ){` |
...
|      228 |  697 | `			break;` |
|        - |  698 | `		}` |
|  5797675 |  699 | `		if( pStr->nByte <= 0 ){` |
|        - |  700 | `			/* Record token length */` |
|  5797623 |  701 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  2898809 |  702 | `		}` |
|  5797675 |  703 | `		if( pToken->nType & PH7_TK_OP ){` |
|        - |  704 | `			const ph7_expr_op *pOp;` |
|        - |  705 | `			/* Check if the extracted token is an operator */` |
|   970401 |  706 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|   970401 |  707 | `			if( pOp == 0 ){` |
|        - |  708 | `				/* Not an operator */` |
...
|        - |  739 | `*/` |
|        - |  740 | `/* Hash score: 103 */` |
|  3770821 |  741 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|        - |  829 | `  };` |
|        - |  830 | `  int h, i;` |
|  3770821 |  831 | `  if( n<2 ) return PH7_TK_ID;` |
|  3658647 |  832 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  5471397 |  833 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  3202807 |  834 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|        - |  917 | `       /* PH7_TKWRD_OR */` |
|        - |  918 | `       /* PH7_TKWRD_BREAK */` |
|  1390057 |  919 | `      return aCode[i];` |
|        - |  920 | `    }` |
|   906378 |  921 | `  }` |
|        - |  922 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  2268595 |  923 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  2268537 |  924 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  2268533 |  925 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  2268485 |  926 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  2268413 |  927 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  2268343 |  928 | `  return PH7_TK_ID;` |
|  1885413 |  929 |  |
...
|        - | 1098 | ` */` |
|    15592 | 1099 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut)` |
|        5 | 1100 |  |
|        - | 1101 | `	SyLex sLexer;` |
|        - | 1102 | `	sxi32 rc;` |
|        - | 1103 | `	/* Initialize the lexer */` |
|    15597 | 1104 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,0);` |
|    15597 | 1105 | `	if( rc != SXRET_OK ){` |
|      ! 0 | 1106 | `		return rc;` |
|        - | 1107 | `	}` |
|    15597 | 1108 | `	sLexer.sStream.nLine = nLineStart;` |
|        - | 1109 | `	/* Tokenize input */` |
|    15597 | 1110 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|        - | 1111 | `	/* Release the lexer */` |
|    15597 | 1112 | `	SyLexRelease(&sLexer);` |
|        - | 1113 | `	/* Tokenization result */` |
|    15597 | 1114 | `	return rc;` |
|     7801 | 1115 |  |
|        - | 1116 | `/*` |
...
|        - | 1160 | ` */` |
|    12926 | 1161 | `PH7_PRIVATE sxi32 PH7_TokenizeRawText(const char *zInput,sxu32 nLen,SySet *pOut)` |
|        5 | 1162 |  |
|    12931 | 1163 | `	const char *zEnd = &zInput[nLen];` |
|    12931 | 1164 | `	const char *zIn  = zInput;` |
|        - | 1165 | `	const char *zCur,*zCurEnd;` |
|    12931 | 1166 | `	SyString sCtag = { 0, 0 };     /* Closing tag */` |
|        - | 1167 | `	SyToken sToken;` |
|        - | 1168 | `	SyString sDoc;` |
|        - | 1169 | `	sxu32 nLine;` |
|        - | 1170 | `	sxi32 iNest;` |
...
|    12931 | 1173 | `	nLine = 1;` |
|    12931 | 1174 | `	zCur = zCurEnd   = 0; /* Prevent compiler warning */` |
|    12931 | 1175 | `	sToken.pUserData = 0;` |
|    12931 | 1176 | `	iNest = 0;` |
|    12931 | 1177 | `	sDoc.nByte = 0;` |
|    12931 | 1178 | `	sDoc.zString = ""; /* cc warning */` |
|    12928 | 1179 | `	for(;;){` |
|    25861 | 1180 | `		if( zIn >= zEnd ){` |
|        - | 1181 | `			/* End of input reached */` |
|    12881 | 1182 | `			break;` |
|        - | 1183 | `		}` |
|    12985 | 1184 | `		sToken.nLine = nLine;` |
|    12985 | 1185 | `		zCur = zIn;` |
|    12985 | 1186 | `		zCurEnd = 0;` |
|    13039 | 1187 | `		while( zIn < zEnd ){` |
|    12989 | 1188 | `			 if( zIn[0] == '<' ){` |
|    12935 | 1189 | `				const char *zTmp = zIn; /* End of raw input marker */` |
|    12935 | 1190 | `				zIn++;` |
|    12935 | 1191 | `				if( zIn < zEnd ){` |
|    12935 | 1192 | `					if( zIn[0] == '?' ){` |
|    12935 | 1193 | `						zIn++;` |
|    12935 | 1194 | `						if( (sxu32)(zEnd - zIn) >= sizeof("php")-1 &&  SyStrnicmp(zIn,"php",sizeof("php")-1) == 0 ){` |
|        - | 1195 | `							/* opening tag: <?php */` |
|    12933 | 1196 | `							zIn += sizeof("php")-1;` |
|     6464 | 1197 | `						}` |
|        - | 1198 | `						/* Look for the closing tag '?>' */` |
|    12935 | 1199 | `						SyStringInitFromBuf(&sCtag,"?>",sizeof("?>")-1);` |
|    12935 | 1200 | `						zCurEnd = zTmp;` |
|    12935 | 1201 | `						break;` |
|        - | 1202 | `					}` |
|      ! 0 | 1203 | `				}` |
|      ! 0 | 1204 | `			}else{` |
...
|    12985 | 1211 | `		if( zCurEnd == 0 ){` |
|       54 | 1212 | `			zCurEnd = zIn;` |
|       25 | 1213 | `		}` |
|        - | 1214 | `		/* Save the raw token */` |
|    12985 | 1215 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|    12985 | 1216 | `		sToken.nType = PH7_TOKEN_RAW;` |
|    12985 | 1217 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    12985 | 1218 | `		if( rc != SXRET_OK ){` |
|      ! 0 | 1219 | `			return rc;` |
|        - | 1220 | `		}` |
|    12985 | 1221 | `		if( zIn >= zEnd ){` |
|       54 | 1222 | `			break;` |
|        - | 1223 | `		}` |
|        - | 1224 | `		/* Ignore leading white space */` |
|    27867 | 1225 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|    14937 | 1226 | `			if( zIn[0] == '\n' ){` |
|    13693 | 1227 | `				nLine++;` |
|     6844 | 1228 | `			}` |
|    14937 | 1229 | `			zIn++;` |
...
|    12935 | 1232 | `		sToken.nLine = nLine;` |
|    12935 | 1233 | `		zCur = zIn;` |
|  1275199 | 1234 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|        - | 1235 | `			const char *zPtr;` |
|  1269539 | 1236 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|     7273 | 1237 | `				break;` |
|        - | 1238 | `			}` |
|   633396 | 1239 | `			for(;;){` |
|  1266797 | 1240 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|   631138 | 1241 | `					break;` |
|        - | 1242 | `				}` |
|     4531 | 1243 | `				zIn += 2;` |
|     4531 | 1244 | `				if( zIn[-1] == '/' ){` |
|        - | 1245 | `					/* Inline comment */` |
|   162869 | 1246 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|   158433 | 1247 | `						zIn++;` |
|        5 | 1248 | `					}` |
|     4441 | 1249 | `					if( zIn >= zEnd ){` |
|      ! 0 | 1250 | `						zIn--;` |
|      ! 0 | 1251 | `					}` |
|     2223 | 1252 | `				}else{` |
|        - | 1253 | `					/* Block comment */` |
...
|        - | 1264 | `				}` |
|        5 | 1265 | `			}` |
|  1262271 | 1266 | `			if( zIn[0] == '\n' ){` |
|    43425 | 1267 | `				nLine++;` |
|    43425 | 1268 | `				if( iNest > 0 ){` |
|      321 | 1269 | `					zIn++;` |
...
|      321 | 1288 | `					continue;` |
|        5 | 1289 | `				}` |
|  1240403 | 1290 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|  1261841 | 1317 | `			zIn++;` |
|        - | 1318 |  |
|  1261841 | 1319 | `			if ( zIn >= zEnd )` |
|        3 | 1320 | `				break;` |
|        5 | 1321 | `		}` |
|    12935 | 1322 | `		if( (sxu32)(zEnd - zIn) < sCtag.nByte ){` |
|     5667 | 1323 | `			zIn = zEnd;` |
|     2831 | 1324 | `		}` |
|    12935 | 1325 | `		if( zCur < zIn ){` |
|        - | 1326 | `			/* Save the PHP chunk for later processing */` |
|    10219 | 1327 | `			sToken.nType = PH7_TOKEN_PHP;` |
|    10219 | 1328 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|    20363 | 1329 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|    10219 | 1330 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|    10219 | 1331 | `			if( rc != SXRET_OK ){` |
|      ! 0 | 1332 | `				return rc;` |
|        - | 1333 | `			}` |
|     5107 | 1334 | `		}` |
|    12935 | 1335 | `		if( zIn < zEnd ){` |
|        - | 1336 | `			/* Jump the trailing closing tag */` |
|     7273 | 1337 | `			zIn += sCtag.nByte;` |
|     3634 | 1338 | `		}` |
|        5 | 1339 | `	} /* For(;;) */` |
|        - | 1340 |  |
|    12931 | 1341 | ` 	return SXRET_OK;` |
|     6468 | 1342 |  |
|        - | 1343 |  |
