...
|        - |   81 | `		 */` |
|  4575886 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
...
|   133840 |  201 | `			if( pStream->zText < pStream->zEnd` |
...
|    12472 |  211 | `				if( pStream->zText < pStream->zEnd` |
...
|       34 |  689 | `				}` |
|     3007 |  690 | `			}else if( (pStream->zEnd - pStream->zText) >= 2` |
