...
|         - |   18 | ` */` |
| 144689870 |   19 | `static sxi32 TokenizePHP(SyStream *pStream,SyToken *pToken,void *pUserData,void *pCtxData)` |
|         5 |   20 | `{` |
|         - |   21 | `	SyString *pStr;` |
|         - |   22 | `	sxi32 rc;` |
|         - |   23 | `	/* Ignore leading white spaces */` |
| 211018027 |   24 | `	while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisSpace(pStream->zText[0]) ){` |
|         - |   25 | `		/* Advance the stream cursor */` |
|  66328157 |   26 | `		if( pStream->zText[0] == '\n' ){` |
|         - |   27 | `			/* Update line counter */` |
|     51959 |   28 | `			pStream->nLine++;` |
|     25977 |   29 | `		}` |
|  66328157 |   30 | `		pStream->zText++;` |
|         5 |   31 | `	}` |
| 144689875 |   32 | `	if( pStream->zText >= pStream->zEnd ){` |
|         - |   33 | `		/* End of input reached */` |
|       ! 0 |   34 | `		return SXERR_EOF;` |
|         - |   35 | `	}` |
|         - |   36 | `	/* Record token starting position and line */` |
| 144689875 |   37 | `	pToken->nLine = pStream->nLine;` |
| 144689875 |   38 | `	pToken->pUserData = 0;` |
| 144689875 |   39 | `	pStr = &pToken->sData;` |
| 144689875 |   40 | `	SyStringInitFromBuf(pStr,pStream->zText,0);` |
| 169163554 |   41 | `	if( pStream->zText[0] >= 0xc0 \|\| SyisAlpha(pStream->zText[0]) \|\| pStream->zText[0] == '_' ){` |
...
|  48947363 |   52 | `		if( pStream->zText[0] < 0xc0 ){` |
|  48947347 |   53 | `			pStream->zText++;` |
|  24473671 |   54 | `		}` |
|  46093402 |   55 | `		for(;;){` |
|  92186809 |   56 | `			zIn = pStream->zText;` |
|  92186809 |   57 | `			if( zIn[0] >= 0xc0 ){` |
|        49 |   58 | `				zIn++;` |
|         - |   59 | `				/* UTF-8 stream */` |
...
| 370728397 |   65 | `			while( zIn < pStream->zEnd && zIn[0] < 0xc0 && (SyisAlphaNum(zIn[0]) \|\| zIn[0] == '_') ){` |
| 232448191 |   66 | `				zIn++;` |
|         5 |   67 | `			}` |
|  92186809 |   68 | `			if( zIn == pStream->zText ){` |
|         - |   69 | `				/* Not an UTF-8 or alphanumeric stream */` |
|  48947363 |   70 | `				break;` |
|         - |   71 | `			}` |
|         - |   72 | `			/* Synchronize pointers */` |
|  43239451 |   73 | `			pStream->zText = zIn;` |
|         5 |   74 | `		}` |
|         - |   75 | `		/* Record token length */` |
|  48947363 |   76 | `		pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  48947363 |   77 | `		nKeyword = KeywordCode(pStr->zString,(int)pStr->nByte);` |
...
|         - |   81 | `		 */` |
|  48947358 |   82 | `		if( nKeyword == PH7_TK_ID && pStr->nByte == 2` |
|  16819142 |   83 | `			&& pStr->zString[0] == 'f' && pStr->zString[1] == 'n' ){` |
|       597 |   84 | `			nKeyword = PH7_TKWRD_FN;` |
|       296 |   85 | `		}` |
|  48947363 |   86 | `		if( nKeyword != PH7_TK_ID ){` |
|  16397865 |   87 | `			if( nKeyword &` |
...
|    862275 |   90 | `					pToken->pUserData = (void *)PH7_ExprExtractOperator(pStr,0);` |
|         - |   91 | `					/* Mark as an operator */` |
|    862275 |   92 | `					pToken->nType = PH7_TK_ID\|PH7_TK_OP;` |
|    431140 |   93 | `			}else{` |
|         - |   94 | `				/* We are dealing with a keyword [i.e: while,foreach,class...],save the keyword ID */` |
|  15535595 |   95 | `				pToken->nType = PH7_TK_KEYWORD;` |
|  15535595 |   96 | `				pToken->pUserData = SX_INT_TO_PTR(nKeyword);` |
|         - |   97 | `			}` |
|   8198935 |   98 | `		}else{` |
|         - |   99 | `			/* A simple identifier */` |
|  32549503 |  100 | `			pToken->nType = PH7_TK_ID;` |
|         - |  101 | `		}` |
|  24473684 |  102 | `	}else{` |
|         - |  103 | `		sxi32 c;` |
|         - |  104 | `		/* Non-alpha stream */` |
|  95742517 |  105 | `		if( pStream->zText[0] == '#' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '[' ){` |
|      8037 |  106 | `			sxu32 nDepth = 1;` |
...
|      8037 |  114 | `			pStream->zText += 2;` |
|      8037 |  115 | `			zGroupStart = pStream->zText;` |
|    656913 |  116 | `			while( pStream->zText < pStream->zEnd && nDepth > 0 ){` |
|    648881 |  117 | `				sxi32 d = pStream->zText[0];` |
|    648881 |  118 | `				if( d == '[' ){` |
|        11 |  119 | `					nDepth++;` |
|    648876 |  120 | `				}else if( d == ']' ){` |
|      8047 |  121 | `					nDepth--;` |
|    644850 |  122 | `				}else if( d == '\'' \|\| d == '"' ){` |
...
|    640809 |  145 | `				}else if( d == '#' \|\| (d == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
...
|    640789 |  151 | `				}else if( d == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
|       ! 0 |  163 | `					}` |
|       ! 0 |  164 | `					continue;` |
|    640789 |  165 | `				}else if( d == '\n' ){` |
|         7 |  166 | `					pStream->nLine++;` |
|         3 |  167 | `				}` |
|    648881 |  168 | `				pStream->zText++;` |
|         5 |  169 | `			}` |
|      8037 |  170 | `			if( pUserData && pStream->pSet ){` |
...
|      8037 |  174 | `				const unsigned char *zGroupEnd = pStream->zText;` |
|      8037 |  175 | `				if( nDepth == 0 && zGroupEnd > zGroupStart ){` |
|      8037 |  176 | `					zGroupEnd--; /* Exclude the closing ']' */` |
|      4016 |  177 | `				}` |
|      8037 |  178 | `				sTrivia.nTokIdx = SySetUsed(pStream->pSet);` |
|      8037 |  179 | `				sTrivia.iKind = PH7_TRIVIA_ATTR;` |
|      8037 |  180 | `				SyStringInitFromBuf(&sTrivia.sText,(const char *)zGroupStart,(sxu32)(zGroupEnd - zGroupStart));` |
|      8037 |  181 | `				sTrivia.nLine = pToken->nLine;` |
|      8037 |  182 | `				SySetPut((SySet *)pUserData,(const void *)&sTrivia);` |
|      4016 |  183 | `			}` |
|         - |  184 | `			/* Tell the upper-layer to ignore this token */` |
|      8037 |  185 | `			return SXERR_CONTINUE;` |
|  95809001 |  186 | `		}else if( pStream->zText[0] == '#' \|\|` |
|  95734474 |  187 | `			( pStream->zText[0] == '/' &&  &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '/') ){` |
|      6845 |  188 | `				pStream->zText++;` |
|         - |  189 | `				/* Inline comments */` |
|    289437 |  190 | `				while( pStream->zText < pStream->zEnd && pStream->zText[0] != '\n' ){` |
|    282597 |  191 | `					pStream->zText++;` |
|         5 |  192 | `				}` |
|         - |  193 | `				/* Tell the upper-layer to ignore this token */` |
|      6845 |  194 | `				return SXERR_CONTINUE;` |
|  95727645 |  195 | `		}else if( pStream->zText[0] == '/' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '*' ){` |
...
|         - |  201 | `			 * token stream. */` |
|    142107 |  202 | `			const unsigned char *zDocStart = pStream->zText;` |
|    142119 |  203 | `			int bDoc = ( &pStream->zText[2] < pStream->zEnd && pStream->zText[2] == '*'` |
|    213165 |  204 | `			 && ( &pStream->zText[3] >= pStream->zEnd \|\| pStream->zText[3] != '/' ) );` |
|    142107 |  205 | `			pStream->zText += 2;` |
|         - |  206 | `			/* Block comment */` |
|   7721797 |  207 | `			while( pStream->zText < pStream->zEnd ){` |
|   7721797 |  208 | `				if( pStream->zText[0] == '*' ){` |
|    173819 |  209 | `					if( &pStream->zText[1] >= pStream->zEnd \|\| pStream->zText[1] == '/'  ){` |
|     71056 |  210 | `						break;` |
|         - |  211 | `					}` |
|     15856 |  212 | `				}` |
|   7579695 |  213 | `				if( pStream->zText[0] == '\n' ){` |
|       165 |  214 | `					pStream->nLine++;` |
|        80 |  215 | `				}` |
|   7579695 |  216 | `				pStream->zText++;` |
|         5 |  217 | `			}` |
|    142107 |  218 | `			pStream->zText += 2;` |
|    142107 |  219 | `			if( bDoc && pUserData && pStream->pSet ){` |
...
|    142107 |  232 | `			return SXERR_CONTINUE;` |
|  95585543 |  233 | `		}else if( SyisDigit(pStream->zText[0]) ){` |
|   2797785 |  234 | `			pStream->zText++;` |
...
|   2797780 |  238 | `			if( pStream->zText < pStream->zEnd` |
|   2797780 |  239 | `				&& pStream->zText[0] == '_'` |
|   1398970 |  240 | `				&& pStream->zText + 1 < pStream->zEnd` |
...
|   3407117 |  246 | `			while( pStream->zText < pStream->zEnd && pStream->zText[0] < 0xc0 && SyisDigit(pStream->zText[0]) ){` |
|    609337 |  247 | `				pStream->zText++;` |
|    609332 |  248 | `				if( pStream->zText < pStream->zEnd` |
|    609332 |  249 | `					&& pStream->zText[0] == '_'` |
|    304752 |  250 | `					&& pStream->zText + 1 < pStream->zEnd` |
...
|   2797785 |  257 | `			pToken->nType = PH7_TK_INTEGER;` |
|   2797785 |  258 | `			if( pStream->zText < pStream->zEnd ){` |
|   2797785 |  259 | `				c = pStream->zText[0];` |
|   2797785 |  260 | `				if( c == '.' ){` |
...
|   2797785 |  351 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '_' ){` |
...
|   2797785 |  359 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   2797785 |  360 | `			return SXRET_OK;` |
|         - |  361 | `		}` |
|  92787763 |  362 | `		c = pStream->zText[0];` |
|  92787763 |  363 | `		pStream->zText++; /* Advance the stream cursor */` |
|         - |  364 | `		/* Assume we are dealing with an operator*/` |
|  92787763 |  365 | `		pToken->nType = PH7_TK_OP;` |
|  92787763 |  366 | `		switch(c){` |
|  18705969 |  367 | `		case '$': pToken->nType = PH7_TK_DOLLAR; break;` |
|   5811719 |  368 | `		case '{': pToken->nType = PH7_TK_OCB;    break;` |
|   5811705 |  369 | `		case '}': pToken->nType = PH7_TK_CCB;    break;` |
|  11960553 |  370 | `		case '(': pToken->nType = PH7_TK_LPAREN; break;` |
|   2814339 |  371 | `		case '[': pToken->nType \|= PH7_TK_OSB;   break; /* Bitwise operation here,since the square bracket token '['` |
|         - |  372 | `														 * is a potential operator [i.e: subscripting] */` |
|   2814345 |  373 | `		case ']': pToken->nType = PH7_TK_CSB;    break;` |
|   5980262 |  374 | `		case ')': {` |
|  11960529 |  375 | `			SySet *pTokSet = pStream->pSet;` |
|         - |  376 | `			/* Assemble type cast operators [i.e: (int),(float),(bool)...] */` |
|  11960529 |  377 | `			if( pTokSet->nUsed >= 2 ){` |
|         - |  378 | `				SyToken *pTmp;` |
|         - |  379 | `				/* Peek the last recongnized token */` |
|  11960527 |  380 | `				pTmp = (SyToken *)SySetPeek(pTokSet);` |
|  11960527 |  381 | `				if( pTmp->nType & PH7_TK_KEYWORD ){` |
|    780881 |  382 | `					sxi32 nID = SX_PTR_TO_INT(pTmp->pUserData);` |
|    780881 |  383 | `					if( (sxu32)nID & (PH7_TKWRD_ARRAY\|PH7_TKWRD_INT\|PH7_TKWRD_FLOAT\|PH7_TKWRD_STRING\|PH7_TKWRD_OBJECT\|PH7_TKWRD_BOOL\|PH7_TKWRD_UNSET) ){` |
|    666343 |  384 | `						pTmp = (SyToken *)SySetAt(pTokSet,pTokSet->nUsed - 2);` |
|    666343 |  385 | `						if( pTmp->nType & PH7_TK_LPAREN ){` |
|         - |  386 | `							/* Merge the three tokens '(' 'TYPE' ')' into a single one */` |
|    390459 |  387 | `							const char * zTypeCast = "(int)";` |
|    390459 |  388 | `							if( nID & PH7_TKWRD_FLOAT ){` |
|      3967 |  389 | `								zTypeCast = "(float)";` |
|    388478 |  390 | `							}else if( nID & PH7_TKWRD_BOOL ){` |
|      3981 |  391 | `								zTypeCast = "(bool)";` |
|    384509 |  392 | `							}else if( nID & PH7_TKWRD_STRING ){` |
|    137971 |  393 | `								zTypeCast = "(string)";` |
|    313538 |  394 | `							}else if( nID & PH7_TKWRD_ARRAY ){` |
|        29 |  395 | `								zTypeCast = "(array)";` |
|    244541 |  396 | `							}else if( nID & PH7_TKWRD_OBJECT ){` |
|        35 |  397 | `								zTypeCast = "(object)";` |
|    244510 |  398 | `							}else if( nID & PH7_TKWRD_UNSET ){` |
|         3 |  399 | `								zTypeCast = "(unset)";` |
|         1 |  400 | `							}` |
|         - |  401 | `							/* Reflect the change */` |
|    390459 |  402 | `							pToken->nType = PH7_TK_OP;` |
|    390459 |  403 | `							SyStringInitFromBuf(&pToken->sData,zTypeCast,SyStrlen(zTypeCast));` |
|         - |  404 | `							/* Save the instance associated with the type cast operator */` |
|    390459 |  405 | `							pToken->pUserData = (void *)PH7_ExprExtractOperator(&pToken->sData,0);` |
|         - |  406 | `							/* Remove the two previous tokens */` |
|    390459 |  407 | `							pTokSet->nUsed -= 2;` |
|    390459 |  408 | `							return SXRET_OK;` |
|         - |  409 | `						}` |
|    137942 |  410 | `					}` |
|    195211 |  411 | `				}` |
|   5785034 |  412 | `			}` |
|  11570075 |  413 | `			pToken->nType = PH7_TK_RPAREN;` |
|  11570075 |  414 | `			break;` |
|         - |  415 | `				  }` |
|   2222693 |  416 | `		case '\'':{` |
|         - |  417 | `			/* Single quoted string */` |
|   4445391 |  418 | `			pStr->zString++;` |
|  55310245 |  419 | `			while( pStream->zText < pStream->zEnd ){` |
|  55310245 |  420 | `				if( pStream->zText[0] == '\''  ){` |
|   4445401 |  421 | `					if( pStream->zText[-1] != '\\' ){` |
|   4413851 |  422 | `						break;` |
|       ! 0 |  423 | `					}else{` |
|     31555 |  424 | `						const unsigned char *zPtr = &pStream->zText[-2];` |
|     31555 |  425 | `						sxi32 i = 1;` |
|     63099 |  426 | `						while( zPtr > pStream->zInput && zPtr[0] == '\\' ){` |
|     31549 |  427 | `							zPtr--;` |
|     31549 |  428 | `							i++;` |
|         5 |  429 | `						}` |
|     31555 |  430 | `						if((i&1)==0){` |
...
|         - |  433 | `					}` |
|         5 |  434 | `				}` |
|  50864859 |  435 | `				if( pStream->zText[0] == '\n' ){` |
|        67 |  436 | `					pStream->nLine++;` |
|        33 |  437 | `				}` |
|  50864859 |  438 | `				pStream->zText++;` |
|         5 |  439 | `			}` |
|         - |  440 | `			/* Record token length and type */` |
|   4445391 |  441 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|   4445391 |  442 | `			pToken->nType = PH7_TK_SSTR;` |
|         - |  443 | `			/* Jump the trailing single quote */` |
|   4445391 |  444 | `			pStream->zText++;` |
|   4445391 |  445 | `			return SXRET_OK;` |
|         - |  446 | `				  }` |
|     41055 |  447 | `		case '"':{` |
|         - |  448 | `			sxi32 iNest;` |
|         - |  449 | `			/* Double quoted string */` |
|     82115 |  450 | `			pStr->zString++;` |
|   1627291 |  451 | `			while( pStream->zText < pStream->zEnd ){` |
|   1627291 |  452 | `				if( pStream->zText[0] == '{' && &pStream->zText[1] < pStream->zEnd && pStream->zText[1] == '$'){` |
|       121 |  453 | `					iNest = 1;` |
...
|         - |  472 | `					}` |
|        59 |  473 | `				}` |
|   1627291 |  474 | `				if( pStream->zText[0] == '"' ){` |
|     82393 |  475 | `					if( pStream->zText[-1] != '\\' ){` |
|     82109 |  476 | `						break;` |
|       ! 0 |  477 | `					}else{` |
...
|         - |  487 | `					}` |
|       139 |  488 | `				}` |
|   1545181 |  489 | `				if( pStream->zText[0] == '\n' ){` |
|        29 |  490 | `					pStream->nLine++;` |
|        14 |  491 | `				}` |
|   1545181 |  492 | `				pStream->zText++;` |
|         5 |  493 | `			}` |
|         - |  494 | `			/* Record token length and type */` |
|     82115 |  495 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|     82115 |  496 | `			pToken->nType = PH7_TK_DSTR;` |
|         - |  497 | `			/* Jump the trailing quote */` |
|     82115 |  498 | `			pStream->zText++;` |
|     82115 |  499 | `			return SXRET_OK;` |
|         - |  500 | `				  }` |
|         2 |  501 | ``		case '`':{`` |
...
|         - |  519 | `				  }` |
|      8753 |  520 | `		case '\\': pToken->nType = PH7_TK_NSSEP;  break;` |
|    384882 |  521 | `		case ':':` |
|    769769 |  522 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == ':' ){` |
|         - |  523 | `				/* Current operator: '::' */` |
|    371259 |  524 | `				pStream->zText++;` |
|    185632 |  525 | `			}else{` |
|    398515 |  526 | `				pToken->nType = PH7_TK_COLON; /* Single colon */` |
|         - |  527 | `			}` |
|    769769 |  528 | `			break;` |
|   2833191 |  529 | `		case ',': pToken->nType \|= PH7_TK_COMMA;  break; /* Comma is also an operator */` |
|   9152741 |  530 | `		case ';': pToken->nType = PH7_TK_SEMI;    break;` |
|         - |  531 | `			/* Handle combined operators [i.e: +=,===,!=== ...] */` |
|   3127131 |  532 | `		case '=':` |
|   6254267 |  533 | `			pToken->nType \|= PH7_TK_EQUAL;` |
|   6254267 |  534 | `			if( pStream->zText < pStream->zEnd ){` |
|   6254267 |  535 | `				if( pStream->zText[0] == '=' ){` |
|   1053719 |  536 | `					pToken->nType &= ~PH7_TK_EQUAL;` |
|         - |  537 | `					/* Current operator: == */` |
|   1053719 |  538 | `					pStream->zText++;` |
|   1053719 |  539 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  540 | `						/* Current operator: === */` |
|   1033657 |  541 | `						pStream->zText++;` |
|    516831 |  542 | `					}` |
|   5727410 |  543 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  544 | `					/* Array operator: => */` |
|    408645 |  545 | `					pToken->nType = PH7_TK_ARRAY_OP;` |
|    408645 |  546 | `					pStream->zText++;` |
|    204325 |  547 | `				}else{` |
|         - |  548 | `					/* TICKET 1433-0010: Reference operator '=&' */` |
|   4791913 |  549 | `					const unsigned char *zCur = pStream->zText;` |
|   4791913 |  550 | `					sxu32 nLine = 0;` |
|   9583649 |  551 | `					while( zCur < pStream->zEnd && zCur[0] < 0xc0 && SyisSpace(zCur[0]) ){` |
|   4791741 |  552 | `						if( zCur[0] == '\n' ){` |
|         5 |  553 | `							nLine++;` |
|         2 |  554 | `						}` |
|   4791741 |  555 | `						zCur++;` |
|         5 |  556 | `					}` |
|   4791913 |  557 | `					if( zCur < pStream->zEnd && zCur[0] == '&' ){` |
...
|   6254267 |  567 | `			break;` |
|    376693 |  568 | `		case '!':` |
|    753391 |  569 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  570 | `				/* Current operator: != */` |
|    366645 |  571 | `				pStream->zText++;` |
|    366645 |  572 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  573 | `					/* Current operator: !== */` |
|    354791 |  574 | `					pStream->zText++;` |
|    177393 |  575 | `				}` |
|    183320 |  576 | `			}` |
|    753391 |  577 | `			break;` |
|    256477 |  578 | `		case '&':` |
|    512959 |  579 | `			pToken->nType \|= PH7_TK_AMPER;` |
|    512959 |  580 | `			if( pStream->zText < pStream->zEnd ){` |
|    512959 |  581 | `				if( pStream->zText[0] == '&' ){` |
|    323583 |  582 | `					pToken->nType &= ~PH7_TK_AMPER;` |
|         - |  583 | `					/* Current operator: && */` |
|    323583 |  584 | `					pStream->zText++;` |
|    351170 |  585 | `				}else if( pStream->zText[0] == '=' ){` |
...
|    512959 |  591 | `			break;` |
|    147952 |  592 | `		case '\|':` |
|    295909 |  593 | `			if( pStream->zText < pStream->zEnd ){` |
|    295909 |  594 | `				if( pStream->zText[0] == '\|' ){` |
|         - |  595 | `					/* Current operator: \|\| */` |
|    220803 |  596 | `					pStream->zText++;` |
|    185510 |  597 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  598 | `					/* Current operator: \|= */` |
|     59111 |  599 | `					pStream->zText++;` |
|     45558 |  600 | `				}else if( pStream->zText[0] == '>' ){` |
...
|    295909 |  605 | `			break;` |
|    175922 |  606 | `		case '+':` |
|    351849 |  607 | `			if( pStream->zText < pStream->zEnd ){` |
|    351847 |  608 | `				if( pStream->zText[0] == '+' ){` |
|         - |  609 | `					/* Current operator: ++ */` |
|    134419 |  610 | `					pStream->zText++;` |
|    284640 |  611 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  612 | `					/* Current operator: += */` |
|     43419 |  613 | `					pStream->zText++;` |
|     21707 |  614 | `				}` |
|    175921 |  615 | `			}` |
|    351849 |  616 | `			break;` |
|   2422617 |  617 | `		case '-':` |
|   4845239 |  618 | `			if( pStream->zText < pStream->zEnd ){` |
|   4845239 |  619 | `				if( pStream->zText[0] == '-' ){` |
|         - |  620 | `					/* Current operator: -- */` |
|     15807 |  621 | `					pStream->zText++;` |
|   4837338 |  622 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  623 | `					/* Current operator: -= */` |
|        12 |  624 | `					pStream->zText++;` |
|   4829432 |  625 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  626 | `					/* Current operator: -> */` |
|   4670973 |  627 | `					pStream->zText++;` |
|   2335484 |  628 | `				}` |
|   2422617 |  629 | `			}` |
|   4845239 |  630 | `			break;` |
|     17935 |  631 | `		case '*':` |
|     35875 |  632 | `			if( pStream->zText < pStream->zEnd ){` |
|     35875 |  633 | `				if( pStream->zText[0] == '*' ){` |
...
|        12 |  639 | `					}` |
|     35808 |  640 | `				}else if( pStream->zText[0] == '=' ){` |
...
|        98 |  651 | `			break;` |
|      2017 |  652 | `		case '%':` |
|      4039 |  653 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
...
|        23 |  663 | `			break;` |
|    843689 |  664 | `		case '.':` |
|   1687383 |  665 | `			if( pStream->zText + 1 < pStream->zEnd && pStream->zText[0] == '.' && pStream->zText[1] == '.' ){` |
|         - |  666 | `				/* Ellipsis: ... */` |
|     24083 |  667 | `				pStream->zText += 2;` |
|     24083 |  668 | `				pToken->nType = PH7_TK_ELLIPSIS;` |
|   1675344 |  669 | `			}else if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  670 | `				/* Current operator: .= */` |
|    323231 |  671 | `				pStream->zText++;` |
|    161613 |  672 | `			}` |
|   1687383 |  673 | `			break;` |
|    128385 |  674 | `		case '<':` |
|    256775 |  675 | `			if( pStream->zText < pStream->zEnd ){` |
|    256775 |  676 | `				if( pStream->zText[0] == '<' ){` |
...
|       ! 0 |  692 | `						}` |
|        12 |  693 | `					}` |
|    256646 |  694 | `				}else if( pStream->zText[0] == '>' ){` |
|         - |  695 | `					/* Current operator: <> */` |
|         5 |  696 | `					pStream->zText++;` |
|    256633 |  697 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  698 | `					/* Current operator: <= or <=> */` |
|     19835 |  699 | `					pStream->zText++;` |
|     19835 |  700 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '>' ){` |
|         - |  701 | `						/* Current operator: <=> */` |
|     11893 |  702 | `						pStream->zText++;` |
|      5944 |  703 | `					}` |
|      9915 |  704 | `				}` |
|    128326 |  705 | `			}` |
|    256657 |  706 | `			break;` |
|     90775 |  707 | `		case '>':` |
|    181555 |  708 | `			if( pStream->zText < pStream->zEnd ){` |
|    181555 |  709 | `				if( pStream->zText[0] == '>' ){` |
|         - |  710 | `					/* Current operator: >> */` |
|      7905 |  711 | `					pStream->zText++;` |
|      7905 |  712 | `					if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  713 | `						/* Current operator: >>= */` |
|        11 |  714 | `						pStream->zText++;` |
|        10 |  715 | `					}` |
|    177605 |  716 | `				}else if( pStream->zText[0] == '=' ){` |
|         - |  717 | `					/* Current operator: >= */` |
|     63145 |  718 | `					pStream->zText++;` |
|     31570 |  719 | `				}` |
|     90775 |  720 | `			}` |
|    181555 |  721 | `			break;` |
|    218575 |  722 | `		case '?':` |
|    437155 |  723 | `			if( pStream->zText < pStream->zEnd && pStream->zText[0] == '?' ){` |
|         - |  724 | `				/* Null coalescing operator: ?? */` |
|     55409 |  725 | `				pStream->zText++;` |
|     55409 |  726 | `				if( pStream->zText < pStream->zEnd && pStream->zText[0] == '=' ){` |
|         - |  727 | `					/* Null coalescing assignment operator (PHP 7.4) */` |
|        99 |  728 | `					pStream->zText++;` |
|        47 |  729 | `				}` |
|    409453 |  730 | `			}else if( (pStream->zEnd - pStream->zText) >= 2` |
|    381751 |  731 | `				&& pStream->zText[0] == '-' && pStream->zText[1] == '>' ){` |
...
|       246 |  737 | `			break;` |
|         - |  738 | `		}` |
|  87869691 |  739 | `		if( pStr->nByte <= 0 ){` |
|         - |  740 | `			/* Record token length */` |
|  87869629 |  741 | `			pStr->nByte = (sxu32)((const char *)pStream->zText-pStr->zString);` |
|  43934812 |  742 | `		}` |
|  87869691 |  743 | `		if( pToken->nType & PH7_TK_OP ){` |
|         - |  744 | `			const ph7_expr_op *pOp;` |
|         - |  745 | `			/* Check if the extracted token is an operator */` |
|  21202643 |  746 | `			pOp = PH7_ExprExtractOperator(pStr,(SyToken *)SySetPeek(pStream->pSet));` |
|  21202643 |  747 | `			if( pOp == 0 ){` |
|         - |  748 | `				/* Not an operator */` |
...
|         - |  779 | `*/` |
|         - |  780 | `/* Hash score: 103 */` |
|  48947363 |  781 | `static sxu32 KeywordCode(const char *z, int n){` |
...
|         - |  869 | `  };` |
|         - |  870 | `  int h, i;` |
|  48947363 |  871 | `  if( n<2 ) return PH7_TK_ID;` |
|  43239429 |  872 | `  h = (((int)z[0]*4) ^ ((int)z[n-1]*3) ^ n) % 151;` |
|  67152869 |  873 | `  for(i=((int)aHash[h])-1; i>=0; i=((int)aNext[i])-1){` |
|  40286403 |  874 | `    if( (int)aLen[i]==n && SyMemcmp(&zText[aOffset[i]],z,n)==0 ){` |
...
|         - |  957 | `       /* PH7_TKWRD_OR */` |
|         - |  958 | `       /* PH7_TKWRD_BREAK */` |
|  16372963 |  959 | `      return aCode[i];` |
|         - |  960 | `    }` |
|  11956723 |  961 | `  }` |
|         - |  962 | `  /* Linear fallback for keywords not in the auto-generated hash table */` |
|  26866471 |  963 | `  if( n==5 && SyMemcmp(z,"trait",5)==0 ) return PH7_TKWRD_TRAIT;` |
|  26858511 |  964 | `  if( n==9 && SyMemcmp(z,"insteadof",9)==0 ) return PH7_TKWRD_INSTEADOF;` |
|  26858507 |  965 | `  if( n==7 && SyMemcmp(z,"finally",7)==0 ) return PH7_TKWRD_FINALLY;` |
|  26858335 |  966 | `  if( n==5 && SyMemcmp(z,"yield",5)==0 ) return PH7_TKWRD_YIELD;` |
|  26842187 |  967 | `  if( n==5 && SyMemcmp(z,"match",5)==0 ) return PH7_TKWRD_MATCH;` |
|  26842111 |  968 | `  return PH7_TK_ID;` |
|  24473684 |  969 | `}` |
...
|         - | 1138 | ` */` |
|     84214 | 1139 | `PH7_PRIVATE sxi32 PH7_TokenizePHP(const char *zInput,sxu32 nLen,sxu32 nLineStart,SySet *pOut,SySet *pTrivia)` |
|         5 | 1140 | `{` |
|         - | 1141 | `	SyLex sLexer;` |
|         - | 1142 | `	sxi32 rc;` |
|         - | 1143 | `	/* Defense-in-depth cap for internal tokenizer calls that bypass ph7_compile() */` |
|     84219 | 1144 | `	if( nLen > PH7_MAX_INPUT_SIZE ){` |
...
|     84219 | 1150 | `	rc = SyLexInit(&sLexer,&(*pOut),TokenizePHP,pTrivia);` |
|     84219 | 1151 | `	if( rc != SXRET_OK ){` |
|       ! 0 | 1152 | `		return rc;` |
|         - | 1153 | `	}` |
|     84219 | 1154 | `	sLexer.sStream.nLine = nLineStart;` |
|         - | 1155 | `	/* Tokenize input */` |
|     84219 | 1156 | `	rc = SyLexTokenizeInput(&sLexer,zInput,nLen,0,0,0);` |
|         - | 1157 | `	/* Release the lexer */` |
|     84219 | 1158 | `	SyLexRelease(&sLexer);` |
|         - | 1159 | `	/* Tokenization result */` |
|     84219 | 1160 | `	return rc;` |
|     42112 | 1161 | `}` |
|         - | 1162 | `/*` |
...
|     13443 | 1225 | `	for(;;){` |
|     26891 | 1226 | `		if( zIn >= zEnd ){` |
|         - | 1227 | `			/* End of input reached */` |
|     13439 | 1228 | `			break;` |
|         - | 1229 | `		}` |
|     13457 | 1230 | `		sToken.nLine = nLine;` |
|     13457 | 1231 | `		zCur = zIn;` |
|     13457 | 1232 | `		zCurEnd = 0;` |
|     13573 | 1233 | `		while( zIn < zEnd ){` |
|     13565 | 1234 | `			 if( zIn[0] == '<' ){` |
...
|     13457 | 1257 | `		if( zCurEnd == 0 ){` |
|        10 | 1258 | `			zCurEnd = zIn;` |
|         4 | 1259 | `		}` |
|         - | 1260 | `		/* Save the raw token */` |
|     13457 | 1261 | `		SyStringInitFromBuf(&sToken.sData,zCur,zCurEnd - zCur);` |
|     13457 | 1262 | `		sToken.nType = PH7_TOKEN_RAW;` |
|     13457 | 1263 | `		rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     13457 | 1264 | `		if( rc != SXRET_OK ){` |
|       ! 0 | 1265 | `			return rc;` |
|         - | 1266 | `		}` |
|     13457 | 1267 | `		if( zIn >= zEnd ){` |
|        10 | 1268 | `			break;` |
|         - | 1269 | `		}` |
|         - | 1270 | `		/* Ignore leading white space */` |
|     28641 | 1271 | `		while( zIn < zEnd && (unsigned char)zIn[0] < 0xc0 && SyisSpace(zIn[0]) ){` |
|     15197 | 1272 | `			if( zIn[0] == '\n' ){` |
|     14551 | 1273 | `				nLine++;` |
|      7273 | 1274 | `			}` |
|     15197 | 1275 | `			zIn++;` |
...
|     13449 | 1279 | `		zCur = zIn;` |
|   1778741 | 1280 | `		while( (sxu32)(zEnd - zIn) >= sCtag.nByte ){` |
|         - | 1281 | `			const char *zPtr;` |
|   1772709 | 1282 | `			if( SyMemcmp(zIn,sCtag.zString,sCtag.nByte) == 0 && iNest < 1 ){` |
|      7413 | 1283 | `				break;` |
|         - | 1284 | `			}` |
|    886244 | 1285 | `			for(;;){` |
|   1772493 | 1286 | `				if( zIn[0] != '/' \|\| (zIn[1] != '*' && zIn[1] != '/') /* && sCtag.nByte >= 2 */ ){` |
|    882653 | 1287 | `					break;` |
|         - | 1288 | `				}` |
|      7197 | 1289 | `				zIn += 2;` |
|      7197 | 1290 | `				if( zIn[-1] == '/' ){` |
|         - | 1291 | `					/* Inline comment */` |
|    286563 | 1292 | `					while( zIn < zEnd && zIn[0] != '\n' ){` |
|    279633 | 1293 | `						zIn++;` |
|         5 | 1294 | `					}` |
|      6935 | 1295 | `					if( zIn >= zEnd ){` |
|         3 | 1296 | `						zIn--;` |
|         1 | 1297 | `					}` |
|      3470 | 1298 | `				}else{` |
|         - | 1299 | `					/* Block comment */` |
...
|         - | 1310 | `				}` |
|         5 | 1311 | `			}` |
|   1765301 | 1312 | `			if( zIn[0] == '\n' ){` |
|     59177 | 1313 | `				nLine++;` |
|     59177 | 1314 | `				if( iNest > 0 ){` |
|       329 | 1315 | `					zIn++;` |
...
|       329 | 1334 | `					continue;` |
|         5 | 1335 | `				}` |
|   1735553 | 1336 | `			}else if ( (sxu32)(zEnd - zIn) >= sizeof("<<<") && zIn[0] == '<' && zIn[1] == '<' && zIn[2] == '<' && iNest < 1){` |
...
|     10369 | 1373 | `			sToken.nType = PH7_TOKEN_PHP;` |
|     10369 | 1374 | `			SyStringInitFromBuf(&sToken.sData,zCur,zIn-zCur);` |
|     20623 | 1375 | `			SyStringRightTrim(&sToken.sData); /* Trim trailing white spaces */` |
|     10369 | 1376 | `			rc = SySetPut(&(*pOut),(const void *)&sToken);` |
|     10369 | 1377 | `			if( rc != SXRET_OK ){` |
|       ! 0 | 1378 | `				return rc;` |
|         - | 1379 | `			}` |
|      5182 | 1380 | `		}` |
|     13449 | 1381 | `		if( zIn < zEnd ){` |
|         - | 1382 | `			/* Jump the trailing closing tag */` |
|      7413 | 1383 | `			zIn += sCtag.nByte;` |
|         - | 1384 | `			/* php's lexer swallows exactly ONE newline immediately after the` |
|         - | 1385 | `			 * closing tag ("?>\n" emits nothing) */` |
|      7413 | 1386 | `			if( zIn < zEnd && zIn[0] == '\r' && zIn + 1 < zEnd && zIn[1] == '\n' ){` |
|       ! 0 | 1387 | `				zIn += 2;` |
|       ! 0 | 1388 | `				nLine++;` |
|      7413 | 1389 | `			}else if( zIn < zEnd && zIn[0] == '\n' ){` |
|        65 | 1390 | `				zIn++;` |
|        65 | 1391 | `				nLine++;` |
|        30 | 1392 | `			}` |
|      3704 | 1393 | `		}` |
