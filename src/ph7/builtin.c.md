...
| 482426 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 482431 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|    ! 0 |   33 | `		return PH7_OK;` |
|      - |   34 | `	}` |
| 482431 |   35 | `	if( ph7_value_is_float(pArg) ){` |
...
|      3 |   54 | `		return PH7_OK;` |
|      - |   55 | `	}` |
| 482425 |   56 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   57 | `		const char *zNum;` |
|      - |   58 | `		int nSlen;` |
...
|      5 |   96 | `		return PH7_OK;` |
|      - |   97 | `	}` |
| 482411 |   98 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  111 | `			);` |
|      - |  112 | `	}` |
| 482411 |  113 | `	*pOut = ph7_value_to_int64(pArg);` |
| 482411 |  114 | `	return PH7_OK;` |
| 241218 |  115 | `}` |
|      - |  116 |  |
...
|      - |  410 | ` */` |
|  33582 |  411 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  412 | `{` |
|  33587 |  413 | `	int res = 1; /* Assume empty by default */` |
|  33587 |  414 | `	if( nArg > 0 ){` |
|  33585 |  415 | `		res = ph7_value_is_empty(apArg[0]);` |
|  16790 |  416 | `	}` |
|  33587 |  417 | `	ph7_result_bool(pCtx,res);` |
|  33587 |  418 | `	return PH7_OK;` |
|      - |  419 |  |
|      5 |  420 | `}` |
...
|      - |  460 | ` */` |
| 266078 |  461 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  462 | `{` |
|      - |  463 | `	const char *zSource;` |
|      - |  464 | `	int nSrcLen;` |
|      - |  465 | `	sxi64 iStart,iEnd;` |
| 266083 |  466 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 266083 |  467 | `	if( nArg < 2 ){` |
...
| 266083 |  473 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |  474 | `	/* Extract the offset */` |
|      - |  475 | `	{` |
| 266083 |  476 | `		sxi64 iTmp = 0;` |
| 266083 |  477 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 266083 |  478 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  479 | `			return rcArg;` |
|      - |  480 | `		}` |
| 266083 |  481 | `		iStart = iTmp;` |
|      - |  482 | `	}` |
|      - |  483 | `	/*` |
...
|      - |  492 | `	 */` |
| 266083 |  493 | `	if( iStart < 0 ){` |
|  32987 |  494 | `		iStart += nSrcLen;` |
|  32987 |  495 | `		if( iStart < 0 ){` |
|      5 |  496 | `			iStart = 0;` |
|      7 |  497 | `		}` |
| 249592 |  498 | `	}else if( iStart > nSrcLen ){` |
|      7 |  499 | `		iStart = nSrcLen;` |
|      3 |  500 | `	}` |
| 266083 |  501 | `	iEnd = nSrcLen;` |
| 266083 |  502 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 195389 |  503 | `		sxi64 iLen = 0;` |
| 195389 |  504 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 195389 |  505 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  506 | `			return rcArg;` |
|      - |  507 | `		}` |
| 195389 |  508 | `		if( iLen < 0 ){` |
|  32919 |  509 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 178932 |  510 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  18773 |  511 | `			iEnd = nSrcLen;` |
|   9389 |  512 | `		}else{` |
| 143707 |  513 | `			iEnd = iStart + iLen;` |
|      - |  514 | `		}` |
|  97692 |  515 | `	}` |
| 266083 |  516 | `	if( iEnd < iStart ){` |
|      3 |  517 | `		iEnd = iStart;` |
|      1 |  518 | `	}` |
| 266083 |  519 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 266083 |  520 | `	return PH7_OK;` |
| 133044 |  521 | `}` |
|      - |  522 | `/*` |
...
|      - |  715 | ` */` |
| 392548 |  716 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  717 | `{` |
| 392553 |  718 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 2066 | ` */` |
|     40 | 2067 | `static int StrNatCompareRight(const char **pa,const char *aEnd,const char **pb,const char *bEnd)` |
|      1 | 2068 | `{` |
|     41 | 2069 | `	int bias = 0;` |
|     68 | 2070 | `	for(;;){` |
|     89 | 2071 | `		int da = (*pa < aEnd) && SyisDigit(**pa);` |
|     89 | 2072 | `		int db = (*pb < bEnd) && SyisDigit(**pb);` |
|     89 | 2073 | `		if( !da && !db ){ return bias; }` |
|     71 | 2074 | `		if( !da ){ return -1; }` |
|     57 | 2075 | `		if( !db ){ return 1; }` |
|     49 | 2076 | `		if( **pa < **pb ){ if( !bias ){ bias = -1; } }` |
|     37 | 2077 | `		else if( **pa > **pb ){ if( !bias ){ bias = 1; } }` |
|     49 | 2078 | `		(*pa)++;` |
|     49 | 2079 | `		(*pb)++;` |
|      1 | 2080 | `	}` |
|     21 | 2081 | `}` |
|      2 | 2082 | `static int StrNatCompareLeft(const char **pa,const char *aEnd,const char **pb,const char *bEnd)` |
|      1 | 2083 | `{` |
|      1 | 2084 | `	for(;;){` |
|      3 | 2085 | `		int da = (*pa < aEnd) && SyisDigit(**pa);` |
|      3 | 2086 | `		int db = (*pb < bEnd) && SyisDigit(**pb);` |
|      3 | 2087 | `		if( !da && !db ){ return 0; }` |
|      3 | 2088 | `		if( !da ){ return -1; }` |
|      3 | 2089 | `		if( !db ){ return 1; }` |
|      3 | 2090 | `		if( **pa < **pb ){ return -1; }` |
|    ! 0 | 2091 | `		if( **pa > **pb ){ return 1; }` |
|    ! 0 | 2092 | `		(*pa)++;` |
|    ! 0 | 2093 | `		(*pb)++;` |
|    ! 0 | 2094 | `	}` |
|      2 | 2095 | `}` |
|     44 | 2096 | `PH7_PRIVATE int PH7_StrNatCmp(const char *zA,int nA,const char *zB,int nB,int bFold)` |
|      1 | 2097 | `{` |
|     45 | 2098 | `	const char *a = zA,*aEnd = &zA[nA];` |
|     45 | 2099 | `	const char *b = zB,*bEnd = &zB[nB];` |
|    139 | 2100 | `	for(;;){` |
|      - | 2101 | `		int ca,cb;` |
|    165 | 2102 | `		while( a < aEnd && SyisSpace(a[0]) ){ a++; }` |
|    163 | 2103 | `		while( b < bEnd && SyisSpace(b[0]) ){ b++; }` |
|    163 | 2104 | `		ca = (a < aEnd) ? (unsigned char)a[0] : 0;` |
|    163 | 2105 | `		cb = (b < bEnd) ? (unsigned char)b[0] : 0;` |
|    163 | 2106 | `		if( SyisDigit(ca) && SyisDigit(cb) ){` |
|     42 | 2107 | `			int r = (ca == '0' \|\| cb == '0')` |
|      2 | 2108 | `				? StrNatCompareLeft(&a,aEnd,&b,bEnd)` |
|     61 | 2109 | `				: StrNatCompareRight(&a,aEnd,&b,bEnd);` |
|     43 | 2110 | `			if( r ){ return r; }` |
|      3 | 2111 | `			continue;` |
|      - | 2112 | `		}` |
|    121 | 2113 | `		if( ca == 0 && cb == 0 ){ return 0; }` |
|    117 | 2114 | `		if( bFold ){` |
|     67 | 2115 | `			ca = SyToLower(ca);` |
|     67 | 2116 | `			cb = SyToLower(cb);` |
|     33 | 2117 | `		}` |
|    117 | 2118 | `		if( ca < cb ){ return -1; }` |
|    117 | 2119 | `		if( ca > cb ){ return 1; }` |
|    117 | 2120 | `		a++;` |
|    117 | 2121 | `		b++;` |
|      1 | 2122 | `	}` |
|     23 | 2123 | `}` |
...
|      - | 2155 | ` */` |
|     66 | 2156 | `static int PH7_builtin_strncmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2157 | `{` |
...
|     68 | 2166 | `	n  = ph7_value_to_int(apArg[2]);` |
|     68 | 2167 | `	if( n < 0 ){` |
...
|     66 | 2174 | `	z1 = ph7_value_to_string(apArg[0],0);` |
|     66 | 2175 | `	z2 = ph7_value_to_string(apArg[1],0);` |
|     66 | 2176 | `	res = SyStrncmp(z1,z2,(sxu32)n);` |
|      - | 2177 | `	/* Comparison result */` |
|     66 | 2178 | `	ph7_result_int(pCtx,res);` |
|     66 | 2179 | `	return PH7_OK;` |
|     35 | 2180 | `}` |
|      - | 2181 | `/*` |
...
|      - | 2190 | ` */` |
|    140 | 2191 | `static int PH7_builtin_strcasecmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 | 2192 | `{` |
...
|    141 | 2202 | `	z1 = ph7_value_to_string(apArg[0],&n1);` |
|    141 | 2203 | `	z2 = ph7_value_to_string(apArg[1],&n2);` |
|    141 | 2204 | `	res = SyStrnicmp(z1,z2,(sxu32)(SXMAX(n1,n2)));` |
|      - | 2205 | `	/* Comparison result */` |
|    141 | 2206 | `	ph7_result_int(pCtx,res);` |
|    141 | 2207 | `	return PH7_OK;` |
|     71 | 2208 | `}` |
|      - | 2209 | `/*` |
...
|      - | 2263 | ` */` |
| 150826 | 2264 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2265 | `{` |
|  75413 | 2266 | `	SXUNUSED(pKey);` |
| 150831 | 2267 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2268 | `	const char *zData;` |
|      - | 2269 | `	int nLen;` |
| 150831 | 2270 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 150829 | 2294 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2295 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 150829 | 2296 | `	if( pData->bFirst ){` |
|  33459 | 2297 | `		pData->bFirst = 0;` |
| 134102 | 2298 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2299 | `		/* append the separator first */` |
| 117295 | 2300 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 150829 | 2306 | `	if( nLen > 0 ){` |
| 138169 | 2307 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2308 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2309 | `			return PH7_ABORT;` |
|      - | 2310 | `		}` |
|  69082 | 2311 | `	}` |
| 150829 | 2312 | `	return PH7_OK;` |
|  75418 | 2313 | `}` |
|      - | 2314 | `/*` |
...
|      - | 2326 | ` */` |
|  33482 | 2327 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2328 | `{` |
|      - | 2329 | `	struct implode_data imp_data;` |
|  33487 | 2330 | `	int i = 1;` |
|  33487 | 2331 | `	if( nArg < 1 ){` |
|      - | 2332 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2333 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2334 | `		return PH7_OK;` |
|      - | 2335 | `	}` |
|      - | 2336 | `	/* Prepare the implode context */` |
|  33487 | 2337 | `	imp_data.pCtx = pCtx;` |
|  33487 | 2338 | `	imp_data.bRecursive = 0;` |
|  33487 | 2339 | `	imp_data.bFirst = 1;` |
|  33487 | 2340 | `	imp_data.nRecCount = 0;` |
|  33487 | 2341 | `	imp_data.rc = SXRET_OK;` |
|  33487 | 2342 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33485 | 2343 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  33485 | 2344 | `		if( nArg > 1 && !ph7_value_is_array(apArg[1]) && !ph7_value_is_null(apArg[1]) ){` |
...
|      3 | 2355 | `		i = 0;` |
|      - | 2356 | `	}` |
|  33485 | 2357 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2358 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2359 | `	}` |
|      - | 2360 | `	/* Start the 'join' process */` |
|  66965 | 2361 | `	while( i < nArg ){` |
|  33485 | 2362 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2363 | `			/* Iterate throw array entries */` |
|  33485 | 2364 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2365 | `			/* Surface a callback allocation failure as a fatal */` |
|  33485 | 2366 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2491 | ` */` |
|   6648 | 2492 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2493 | `{` |
...
|   6653 | 2506 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6653 | 2507 | `	if( nDelim < 1 ){` |
...
|   6649 | 2513 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6649 | 2514 | `	if( nStrlen < 1 ){` |
...
|      7 | 2518 | `		ph7_value *pArrayTmp = ph7_context_new_array(pCtx);` |
|      7 | 2519 | `		if( pArrayTmp == 0 ){` |
|      - | 2520 | `			/* Out of memory,return FALSE */` |
|    ! 0 | 2521 | `			ph7_result_bool(pCtx,0);` |
|    ! 0 | 2522 | `			return PH7_OK;` |
|      - | 2523 | `		}` |
|      7 | 2524 | `		if( !(nArg > 2 && ph7_value_to_int(apArg[2]) < 0) ){` |
|      5 | 2525 | `			ph7_value *pValueTmp = ph7_context_new_scalar(pCtx);` |
|      5 | 2526 | `			if( pValueTmp == 0 ){` |
|      - | 2527 | `				/* Out of memory,return FALSE */` |
|    ! 0 | 2528 | `				ph7_result_bool(pCtx,0);` |
|    ! 0 | 2529 | `				return PH7_OK;` |
|      - | 2530 | `			}` |
|      5 | 2531 | `			ph7_value_string(pValueTmp, "", 0);` |
|      5 | 2532 | `			if( ph7_array_add_elem(pArrayTmp, 0 /* Automatic index assign */, pValueTmp) != SXRET_OK ){` |
|    ! 0 | 2533 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2534 | `			}` |
|      2 | 2535 | `		}` |
|      7 | 2536 | `		ph7_result_value(pCtx, pArrayTmp);` |
|      7 | 2537 | `		return PH7_OK;` |
|      - | 2538 | `	}` |
|      - | 2539 | `	/* Point to the end of the string */` |
|   6643 | 2540 | `	zEnd = &zString[nStrlen];` |
|      - | 2541 | `	/* Create the array */` |
|   6643 | 2542 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6643 | 2543 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6643 | 2544 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2545 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2546 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2547 | `		return PH7_OK;` |
|      - | 2548 | `	}` |
|      - | 2549 | `	/* Set a defualt limit */` |
|   6643 | 2550 | `	iLimit = SXI32_HIGH;` |
|   6643 | 2551 | `	if( nArg > 2 ){` |
|     38 | 2552 | `		iLimit = ph7_value_to_int(apArg[2]);` |
|     38 | 2553 | `		if( iLimit < 0 ){` |
...
|  81144 | 2586 | `	for(;;){` |
| 162293 | 2587 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 162293 | 2588 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2589 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6627 | 2590 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6627 | 2591 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2592 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2593 | `			}` |
|   6627 | 2594 | `			break;` |
|      - | 2595 | `		}` |
|      - | 2596 | `		/* Point to the desired offset */` |
| 155671 | 2597 | `		zCur = &zString[nOfft];` |
|      - | 2598 | `		/* Perform the store operation (may be empty) */` |
| 155671 | 2599 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 155671 | 2600 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2601 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2602 | `		}` |
|      - | 2603 | `		/* Point beyond the delimiter */` |
| 155671 | 2604 | `		zString = &zCur[nDelim];` |
|      - | 2605 | `		/* Reset the cursor */` |
| 155671 | 2606 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2607 | `	}` |
|      - | 2608 | `	/* Return the freshly created array */` |
|   6627 | 2609 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2610 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2611 | `	 * released as soon we return from this foregin function.` |
|      - | 2612 | `	 */` |
|   6627 | 2613 | `	return PH7_OK;` |
|   3329 | 2614 | `}` |
|      - | 2615 | `/*` |
...
|      - | 2629 | ` */` |
|  14416 | 2630 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2631 | `{` |
|  14421 | 2632 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - | 2633 | `	const char *zString;` |
|      - | 2634 | `	int nLen;` |
|  14421 | 2635 | `	if( nArg < 1 ){` |
|      - | 2636 | `		/* Missing arguments,return null */` |
|    ! 0 | 2637 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2638 | `		return PH7_OK;` |
|      - | 2639 | `	}` |
|      - | 2640 | `	/* Extract the target string */` |
|  14421 | 2641 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14421 | 2642 | `	if( nLen < 1 ){` |
|      - | 2643 | `		/* Empty string,return */` |
|    755 | 2644 | `		ph7_result_string(pCtx,"",0);` |
|    755 | 2645 | `		return PH7_OK;` |
|      - | 2646 | `	}` |
|      - | 2647 | `	/* Start the trim process */` |
|  13671 | 2648 | `	if( nArg < 2 ){` |
|      - | 2649 | `		SyString sStr;` |
|      - | 2650 | `		/* Remove white spaces and NUL bytes */` |
|  13641 | 2651 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  34211 | 2652 | `		SyStringFullTrimSafe(&sStr);` |
|  13641 | 2653 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6823 | 2654 | `	}else{` |
|      - | 2655 | `		/* Char list */` |
...
|      - | 2699 | ` */` |
|    164 | 2700 | `static int PH7_builtin_rtrim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 | 2701 | `{` |
|    168 | 2702 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"rtrim",1,"$string"); }` |
...
|    168 | 2711 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|    168 | 2712 | `	if( nLen < 1 ){` |
...
|      - | 2727 | `		int nListlen;` |
|    144 | 2728 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|    144 | 2729 | `		if( nListlen < 1 ){` |
|      - | 2730 | `			/* Return the string unchanged */` |
|    ! 0 | 2731 | `			ph7_result_string(pCtx,zString,nLen);` |
|    ! 0 | 2732 | `		}else{` |
|      - | 2733 | `			char aMask[256];` |
|    144 | 2734 | `			const char *zEnd = &zString[nLen];` |
|    144 | 2735 | `			const char *zCur = zString;` |
|    144 | 2736 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - | 2737 | `			/* Right trim */` |
|    162 | 2738 | `			while( zEnd > zCur && aMask[(unsigned char)zEnd[-1]] ){` |
|     21 | 2739 | `				zEnd--;` |
|      3 | 2740 | `			}` |
|    144 | 2741 | `			if( zEnd <= zCur ){` |
|      - | 2742 | `				/* Return the empty string */` |
|    ! 0 | 2743 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 | 2744 | `			}else{` |
|    144 | 2745 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - | 2746 | `			}` |
|      - | 2747 | `		}` |
|      - | 2748 | `	}` |
|    162 | 2749 | `	return PH7_OK;` |
|     86 | 2750 | `}` |
|      - | 2751 | `/*` |
...
|      - | 2825 | ` */` |
|  33384 | 2826 | `static int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2827 | `{` |
|  33389 | 2828 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - | 2829 | `	const char *zString,*zCur,*zEnd;` |
|      - | 2830 | `	int nLen;` |
|  33389 | 2831 | `	if( nArg < 1 ){` |
|      - | 2832 | `		/* Missing arguments,return null */` |
|    ! 0 | 2833 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2834 | `		return PH7_OK;` |
|      - | 2835 | `	}` |
|      - | 2836 | `	/* Extract the target string */` |
|  33389 | 2837 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33389 | 2838 | `	if( nLen < 1 ){` |
|      - | 2839 | `		/* Empty string,return */` |
|      5 | 2840 | `		ph7_result_string(pCtx,"",0);` |
|      5 | 2841 | `		return PH7_OK;` |
|      - | 2842 | `	}` |
|      - | 2843 | `	/* Perform the requested operation */` |
|  33385 | 2844 | `	zEnd = &zString[nLen];` |
| 105271 | 2845 | `	for(;;){` |
| 210547 | 2846 | `		if( zString >= zEnd ){` |
|      - | 2847 | `			/* No more input,break immediately */` |
|  33385 | 2848 | `			break;` |
|      - | 2849 | `		}` |
| 177167 | 2850 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2859 | `		}else{` |
| 177167 | 2860 | `			int c = zString[0];` |
| 177167 | 2861 | `			if( SyisUpper(c) ){` |
| 174611 | 2862 | `				c = SyToLower(zString[0]);` |
|  87303 | 2863 | `			}` |
|      - | 2864 | `			/* Append character */` |
| 177167 | 2865 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2866 | `			/* Advance the cursor */` |
| 177167 | 2867 | `			zString++;` |
|      - | 2868 | `		}` |
|      5 | 2869 | `	}` |
|  33385 | 2870 | `	return PH7_OK;` |
|  16697 | 2871 | `}` |
|      - | 2872 | `/*` |
...
|      5 | 2882 | `{` |
|     79 | 2883 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtoupper",1,"$string"); }` |
...
|     79 | 2892 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     79 | 2893 | `	if( nLen < 1 ){` |
...
|     75 | 2899 | `	zEnd = &zString[nLen];` |
|    145 | 2900 | `	for(;;){` |
|    295 | 2901 | `		if( zString >= zEnd ){` |
|      - | 2902 | `			/* No more input,break immediately */` |
|     75 | 2903 | `			break;` |
|      - | 2904 | `		}` |
|    225 | 2905 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2914 | `		}else{` |
|    225 | 2915 | `			int c = zString[0];` |
|    225 | 2916 | `			if( SyisLower(c) ){` |
|    208 | 2917 | `				c = SyToUpper(zString[0]);` |
|    102 | 2918 | `			}` |
|      - | 2919 | `			/* Append character */` |
|    225 | 2920 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2921 | `			/* Advance the cursor */` |
|    225 | 2922 | `			zString++;` |
|      - | 2923 | `		}` |
|      5 | 2924 | `	}` |
|     75 | 2925 | `	return PH7_OK;` |
|     42 | 2926 | `}` |
|      - | 2927 | `/*` |
...
|      - | 3359 | ` */` |
|   1540 | 3360 | `static int PH7_builtin_strpos(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3361 | `{` |
|   1545 | 3362 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strpos",1,"$haystack"); }` |
|   1545 | 3363 | `	if( nArg > 1 ){ StrNullArgNotice(pCtx,apArg[1],"strpos",2,"$needle"); }` |
|   1545 | 3364 | `	ProcStringMatch xPatternMatch = SyBlobSearch; /* Case-sensitive pattern match */` |
...
|   1545 | 3375 | `	zBlob = ph7_value_to_string(apArg[0],&nLen);` |
|   1545 | 3376 | `	zPattern = ph7_value_to_string(apArg[1],&nPatLen);` |
|   1545 | 3377 | `	nOfft = 0; /* cc warning */` |
|   1545 | 3378 | `	nStart = 0;` |
...
|      - | 3391 | `		}` |
|      7 | 3392 | `	}` |
|   1545 | 3393 | `	if( nLen > 0 && nPatLen > 0 ){` |
|      - | 3394 | `		/* Perform the lookup */` |
|   1543 | 3395 | `		rc = xPatternMatch(zBlob,(sxu32)nLen,zPattern,(sxu32)nPatLen,&nOfft);` |
|   1543 | 3396 | `		if( rc != SXRET_OK ){` |
|      - | 3397 | `			/* Pattern not found,return FALSE */` |
|    799 | 3398 | `			ph7_result_bool(pCtx,0);` |
|    799 | 3399 | `			return PH7_OK;` |
|      - | 3400 | `		}` |
|      - | 3401 | `		/* Return the pattern position */` |
|    748 | 3402 | `		ph7_result_int64(pCtx,(ph7_int64)(nOfft+nStart));` |
|    376 | 3403 | `	}else{` |
|      3 | 3404 | `		ph7_result_bool(pCtx,0);` |
|      - | 3405 | `	}` |
|    750 | 3406 | `	return PH7_OK;` |
|    775 | 3407 | `}` |
|      - | 3408 | `/*` |
...
|      - | 3684 | ` */` |
|     40 | 3685 | `static int PH7_builtin_strrpos(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 | 3686 | `{` |
|      - | 3687 | `	const char *zStart,*zBlob,*zPattern,*zPtr,*zEnd;` |
|     41 | 3688 | `	ProcStringMatch xPatternMatch = SyBlobSearch; /* Case-sensitive pattern match */` |
...
|     41 | 3698 | `	zBlob = ph7_value_to_string(apArg[0],&nLen);` |
|     41 | 3699 | `	zPattern = ph7_value_to_string(apArg[1],&nPatLen);` |
|      - | 3700 | `	/* Point to the end of the pattern */` |
|     41 | 3701 | `	zPtr = &zBlob[nLen - 1];` |
|     41 | 3702 | `	zEnd = &zBlob[nLen];` |
|      - | 3703 | `	/* Save the starting posistion */` |
|     41 | 3704 | `	zStart = zBlob;` |
|     41 | 3705 | `	nOfft = 0; /* cc warning */` |
...
|      - | 3730 | `		}` |
|      7 | 3731 | `	}` |
|     35 | 3732 | `	if( nLen > 0 && nPatLen > 0 ){` |
|      - | 3733 | `		/* Perform the lookup */` |
|    121 | 3734 | `		for(;;){` |
|    243 | 3735 | `			if( zBlob >= zPtr ){` |
|     21 | 3736 | `				break;` |
|      - | 3737 | `			}` |
|    223 | 3738 | `			rc = xPatternMatch((const void *)zPtr,(sxu32)(zEnd-zPtr),(const void *)zPattern,(sxu32)nPatLen,&nOfft);` |
|    223 | 3739 | `			if( rc == SXRET_OK ){` |
|      - | 3740 | `				/* Pattern found,return it's position */` |
|     13 | 3741 | `				ph7_result_int64(pCtx,(ph7_int64)(&zPtr[nOfft] - zStart));` |
|     13 | 3742 | `				return PH7_OK;` |
|      - | 3743 | `			}` |
|    211 | 3744 | `			zPtr--;` |
|      1 | 3745 | `		}` |
...
|      - | 4241 | ` * "all valid".)` |
|      - | 4242 | ` */` |
|    480 | 4243 | `static int FormatUnknownSpec(const char *zIn,int nByte,int *pBad)` |
|      3 | 4244 | `{` |
|    483 | 4245 | `	const char *zEnd = &zIn[nByte];` |
|      - | 4246 | `	int c,idx;` |
|   3793 | 4247 | `	while( zIn < zEnd ){` |
|   3333 | 4248 | `		if( zIn[0] != '%' ){` |
|   2411 | 4249 | `			zIn++;` |
|   2411 | 4250 | `			continue;` |
|      - | 4251 | `		}` |
|    923 | 4252 | `		zIn++; /* jump the percent sign */` |
...
|   1127 | 4256 | `		while( zIn < zEnd ){` |
|   1125 | 4257 | `			c = zIn[0];` |
|   1125 | 4258 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){` |
|    193 | 4259 | `				zIn++;` |
|    193 | 4260 | `				continue;` |
|      - | 4261 | `			}` |
|    933 | 4262 | `			if( c=='\'' ){` |
...
|    ! 0 | 4270 | `		}` |
|      - | 4271 | `		/* field width */` |
|   1201 | 4272 | `		while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|    279 | 4273 | `			zIn++;` |
|      1 | 4274 | `		}` |
...
|    923 | 4306 | `		if( zIn < zEnd && zIn[0]=='l' ){` |
|     11 | 4307 | `			zIn++;` |
|      5 | 4308 | `		}` |
|    923 | 4309 | `		if( zIn >= zEnd ){` |
|      - | 4310 | `			/* A dangling '%' with no specifier: PHL's legacy path silently` |
|      - | 4311 | `			 * truncates here (recorded residual); nothing to validate. */` |
|      3 | 4312 | `			break;` |
|      - | 4313 | `		}` |
|    921 | 4314 | `		c = zIn[0];` |
|    921 | 4315 | `		zIn++; /* jump the conversion specifier */` |
|   3765 | 4316 | `		for( idx = 0 ; idx < (int)SX_ARRAYSIZE(aFmt) ; idx++ ){` |
|   3747 | 4317 | `			if( c == aFmt[idx].fmttype ){` |
|    903 | 4318 | `				break;` |
|      - | 4319 | `			}` |
|   1425 | 4320 | `		}` |
|    921 | 4321 | `		if( idx >= (int)SX_ARRAYSIZE(aFmt) ){` |
|     19 | 4322 | `			*pBad = c; /* unknown specifier */` |
|     19 | 4323 | `			return TRUE;` |
|      - | 4324 | `		}` |
|      3 | 4325 | `	}` |
|    465 | 4326 | `	return FALSE;` |
|    243 | 4327 | `}` |
|      - | 4328 | `/*` |
...
|      - | 4335 | ` */` |
|    480 | 4336 | `PH7_PRIVATE sxi32 PH7_FormatValidate(ph7_context *pCtx,const char *zFormat,int nByte)` |
|      3 | 4337 | `{` |
|    483 | 4338 | `	int badSpec = 0;` |
|    483 | 4339 | `	if( FormatUnknownSpec(zFormat,nByte,&badSpec) ){` |
|     28 | 4340 | `		return PH7_VmThrowException(pCtx,"ValueError",` |
|      9 | 4341 | `			"Unknown format specifier \"%c\"",badSpec);` |
|      - | 4342 | `	}` |
|    465 | 4343 | `	return PH7_OK;` |
|    243 | 4344 | `}` |
|      - | 4345 | `/*` |
...
|      - | 4349 | ` */` |
|    462 | 4350 | `static int FormatRequiredArgs(const char *zIn,int nByte)` |
|      3 | 4351 | `{` |
|    465 | 4352 | `	const char *zEnd = &zIn[nByte];` |
|    465 | 4353 | `	int c,seq = 0,maxpos = 0;` |
|   3761 | 4354 | `	while( zIn < zEnd ){` |
|   3301 | 4355 | `		int numVal = 0,pos = 0;` |
|   3301 | 4356 | `		if( zIn[0] != '%' ){` |
|   2397 | 4357 | `			zIn++;` |
|   2397 | 4358 | `			continue;` |
|      - | 4359 | `		}` |
|    905 | 4360 | `		zIn++; /* jump the percent sign */` |
|      - | 4361 | `		/* leading flags (incl. the "'<pad>'" custom-pad form) */` |
|   1109 | 4362 | `		while( zIn < zEnd ){` |
|   1107 | 4363 | `			c = zIn[0];` |
|   1107 | 4364 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){ zIn++; continue; }` |
|    915 | 4365 | `			if( c=='\'' ){ zIn++; if( zIn < zEnd ){ zIn++; } continue; }` |
|    903 | 4366 | `			break;` |
|    ! 0 | 4367 | `		}` |
|      - | 4368 | `		/* leading number: a positional index when a '$' follows, else the width */` |
|   1183 | 4369 | `		while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|    279 | 4370 | `			numVal = numVal*10 + (zIn[0]-'0');` |
|    279 | 4371 | `			zIn++;` |
|      1 | 4372 | `		}` |
|    905 | 4373 | `		if( zIn < zEnd && zIn[0]=='$' ){` |
|     15 | 4374 | `			pos = numVal;` |
|     15 | 4375 | `			zIn++;` |
...
|      7 | 4384 | `		}` |
|      - | 4385 | `		/* precision */` |
|    905 | 4386 | `		if( zIn < zEnd && zIn[0]=='.' ){` |
|    113 | 4387 | `			zIn++;` |
|    243 | 4388 | `			while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){ zIn++; }` |
|     55 | 4389 | `		}` |
|      - | 4390 | `		/* a single 'l' length modifier (ignored, php compat) */` |
|    905 | 4391 | `		if( zIn < zEnd && zIn[0]=='l' ){ zIn++; }` |
|    905 | 4392 | `		if( zIn >= zEnd ){ break; }` |
|    903 | 4393 | `		c = zIn[0];` |
|    903 | 4394 | `		zIn++; /* jump the conversion specifier */` |
|    903 | 4395 | `		if( c == '%' ){ continue; } /* %% consumes no argument */` |
|    895 | 4396 | `		if( pos > 0 ){` |
...
|      - | 4400 | `		}` |
|      3 | 4401 | `	}` |
|    465 | 4402 | `	return seq > maxpos ? seq : maxpos;` |
|      3 | 4403 | `}` |
|      - | 4404 | `/*` |
...
|      - | 4414 | ` * when enough.` |
|      - | 4415 | ` */` |
|    462 | 4416 | `PH7_PRIVATE sxi32 PH7_FormatCheckArgCount(ph7_context *pCtx,const char *zFormat,int nByte,int nValues,int nFixed,int bVararg)` |
|      3 | 4417 | `{` |
|    465 | 4418 | `	int required = FormatRequiredArgs(zFormat,nByte);` |
|    465 | 4419 | `	if( nValues < required ){` |
|     21 | 4420 | `		if( bVararg ){` |
...
|     13 | 4450 | `}` |
|    492 | 4451 | `PH7_PRIVATE sxi32 PH7_FormatCheckFormatArg(ph7_context *pCtx,ph7_value *pArg,int iArg)` |
|      3 | 4452 | `{` |
|    495 | 4453 | `	if( ph7_value_is_array(pArg) \|\| ph7_value_is_object(pArg) \|\| ph7_value_is_resource(pArg) ){` |
|      - | 4454 | `		char zBuf[64];` |
...
|      - | 4474 | ` */` |
|    442 | 4475 | `PH7_PRIVATE sxi32 PH7_InputFormat(` |
...
|      - | 4484 | `	)` |
|      3 | 4485 | `{` |
|    445 | 4486 | `	char spaces[] = "                                                  ";` |
|      - | 4487 | `#define etSPACESIZE ((int)sizeof(spaces)-1)` |
|    445 | 4488 | `	const char *zCur,*zEnd = &zIn[nByte];` |
...
|    655 | 4512 | `	for(;;){` |
|   1313 | 4513 | `		zCur = zIn;` |
|   3701 | 4514 | `		while( zIn < zEnd && zIn[0] != '%' ){` |
|   2389 | 4515 | `			zIn++;` |
|      1 | 4516 | `		}` |
|   1313 | 4517 | `		if( zCur < zIn ){` |
|      - | 4518 | `			/* Consume chunk verbatim */` |
|    775 | 4519 | `			rc = xConsumer(pCtx,zCur,(int)(zIn-zCur),pUserData);` |
|    775 | 4520 | `			if( rc != SXRET_OK ){` |
|      - | 4521 | `				/* Callback requested an abort (e.g. an allocation failure) */` |
|    ! 0 | 4522 | `				break;` |
|      - | 4523 | `			}` |
|    387 | 4524 | `		}` |
|   1313 | 4525 | `		if( zIn >= zEnd ){` |
|      - | 4526 | `			/* No more input to process,break immediately */` |
|    443 | 4527 | `			break;` |
|      - | 4528 | `		}` |
|      - | 4529 | `		/* Find out what flags are present */` |
|    873 | 4530 | `		flag_leftjustify = flag_plussign = flag_blanksign =` |
|    870 | 4531 | `			flag_alternateform = flag_zeropad = 0;` |
...
|  44373 | 4535 | `		for( idx = 0 ; idx < etSPACESIZE ; ++idx ){ spaces[idx] = ' '; }` |
|    873 | 4536 | `		zIn++; /* Jump the precent sign */` |
|    435 | 4537 | `		do{` |
|   1077 | 4538 | `			c = zIn[0];` |
|   1077 | 4539 | `			switch( c ){` |
...
|    163 | 4543 | `			case '0':   flag_zeropad = 1;         c = 0;   break;` |
|      6 | 4544 | `			case '\'':` |
|     13 | 4545 | `				zIn++;` |
|     13 | 4546 | `				if( zIn < zEnd ){` |
...
|      6 | 4553 | `				}` |
|     12 | 4554 | `				break;` |
|    870 | 4555 | `			default:                                       break;` |
|      - | 4556 | `			}` |
|   1077 | 4557 | `		}while( c==0 && (zIn++ < zEnd) );` |
|      - | 4558 | `		/* Get the field width */` |
|    873 | 4559 | `		width = 0;` |
|   1580 | 4560 | `		while( zIn < zEnd && ( zIn[0] >='0' && zIn[0] <='9') ){` |
|    273 | 4561 | `			width = width*10 + (zIn[0] - '0');` |
|    273 | 4562 | `			zIn++;` |
|      1 | 4563 | `		}` |
|    873 | 4564 | `		if( zIn < zEnd && zIn[0] == '$' ){` |
...
|      1 | 4600 | `			}` |
|      4 | 4601 | `		}` |
|    873 | 4602 | `		if( width > PH7_FMT_BUFSIZ-10 ){` |
|    ! 0 | 4603 | `			width = PH7_FMT_BUFSIZ-10;` |
|    ! 0 | 4604 | `		}` |
|      - | 4605 | `		/* Get the precision */` |
|    873 | 4606 | `		precision = -1;` |
|    873 | 4607 | `		if( zIn < zEnd && zIn[0] == '.' ){` |
...
|    873 | 4618 | `		if( zIn < zEnd && zIn[0] == 'l' ){` |
|      9 | 4619 | `			zIn++;` |
|      4 | 4620 | `		}` |
|    873 | 4621 | `		if( zIn >= zEnd ){` |
|      - | 4622 | `			/* No more input */` |
|      3 | 4623 | `			break;` |
|      - | 4624 | `		}` |
|      - | 4625 | `		/* Fetch the info entry for the field */` |
|    871 | 4626 | `		pInfo = 0;` |
|    871 | 4627 | `		xtype = PH7_FMT_ERROR;` |
|    871 | 4628 | `		c = zIn[0];` |
|    871 | 4629 | `		zIn++; /* Jump the format specifer */` |
|   3395 | 4630 | `		for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
|   3395 | 4631 | `			if( c==aFmt[idx].fmttype ){` |
|    871 | 4632 | `				pInfo = &aFmt[idx];` |
|    871 | 4633 | `				xtype = pInfo->type;` |
|    871 | 4634 | `				break;` |
|      - | 4635 | `			}` |
|   1265 | 4636 | `		}` |
|    871 | 4637 | `		zBuf = zWorker; /* Point to the working buffer */` |
|    871 | 4638 | `		length = 0;` |
...
|      - | 4719 | `#endif` |
|    281 | 4720 | `        if( pInfo->flags & PH7_FMT_FLAG_SIGNED ){` |
|    257 | 4721 | `          if( iVal<0 ){` |
|     25 | 4722 | `            iVal = -iVal;` |
...
|    ! 0 | 4727 | `			}` |
|     25 | 4728 | `            prefix = '-';` |
|    245 | 4729 | `          }else if( flag_plussign )  prefix = '+';` |
|    231 | 4730 | `          else if( flag_blanksign )  prefix = ' ';` |
|    229 | 4731 | `          else                       prefix = 0;` |
|    129 | 4732 | `        }else{` |
|     25 | 4733 | `			if( iVal<0 ){` |
|    ! 0 | 4734 | `				iVal = -iVal;` |
...
|     25 | 4741 | `			prefix = 0;` |
|      - | 4742 | `		}` |
|    281 | 4743 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|    149 | 4744 | `          precision = width-(prefix!=0);` |
|     74 | 4745 | `        }` |
|    281 | 4746 | `        zBuf = &zWorker[PH7_FMT_BUFSIZ-1];` |
|      - | 4747 | `        {` |
|      - | 4748 | `          register char *cset;      /* Use registers for speed */` |
|      - | 4749 | `          register int base;` |
|    281 | 4750 | `          cset = pInfo->charset;` |
|    281 | 4751 | `          base = pInfo->base;` |
|    140 | 4752 | `          do{                                           /* Convert to ascii */` |
|    357 | 4753 | `            *(--zBuf) = cset[iVal%base];` |
|    357 | 4754 | `            iVal = iVal/base;` |
|    357 | 4755 | `          }while( iVal>0 );` |
|      - | 4756 | `        }` |
|    281 | 4757 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
|    447 | 4758 | `        for(idx=precision-length; idx>0; idx--){` |
|    167 | 4759 | `          *(--zBuf) = '0';                             /* Zero pad */` |
|     84 | 4760 | `        }` |
|    281 | 4761 | `        if( prefix ) *(--zBuf) = (char)prefix;               /* Add sign */` |
|    281 | 4762 | `        if( flag_alternateform && pInfo->prefix ){      /* Add "0" or "0x" */` |
|      - | 4763 | `          char *pre, x;` |
...
|    ! 0 | 4767 | `          }` |
|    ! 0 | 4768 | `        }` |
|    281 | 4769 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
|    281 | 4770 | `		break;` |
...
|      - | 4877 | `		 ** the output.` |
|      - | 4878 | `		 */` |
|    871 | 4879 | `    if( !flag_leftjustify ){` |
|      - | 4880 | `      register int nspace;` |
|    853 | 4881 | `      nspace = width-length;` |
|    853 | 4882 | `      if( nspace>0 ){` |
...
|     18 | 4896 | `      }` |
|    425 | 4897 | `    }` |
|    871 | 4898 | `    if( length>0 ){` |
|    863 | 4899 | `		rc = xConsumer(pCtx,zBuf,(unsigned int)length,pUserData);` |
|    863 | 4900 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 4901 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|      - | 4902 | `		}` |
|    430 | 4903 | `    }` |
|    871 | 4904 | `    if( flag_leftjustify ){` |
...
|      9 | 4922 | `    }` |
|      3 | 4923 | ` }/* for(;;) */` |
|    445 | 4924 | `	return SXRET_OK;` |
|    224 | 4925 | `}` |
|      - | 4926 | `/*` |
|      - | 4927 | ` * Callback [i.e: Formatted input consumer] of the sprintf function.` |
|      - | 4928 | ` */` |
|    480 | 4929 | `static int sprintfConsumer(ph7_context *pCtx,const char *zInput,int nLen,void *pUserData)` |
|      3 | 4930 | `{` |
...
|    483 | 4934 | `	sxi32 *pRc = (sxi32 *)pUserData;` |
|    483 | 4935 | `	*pRc = ph7_result_string(pCtx,zInput,nLen);` |
|    483 | 4936 | `	return *pRc;` |
|      3 | 4937 | `}` |
|      - | 4938 | `/*` |
...
|      - | 4946 | ` */` |
|    236 | 4947 | `static int PH7_builtin_sprintf(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 | 4948 | `{` |
|      - | 4949 | `	const char *zFormat;` |
|    239 | 4950 | `	sxi32 rc = SXRET_OK;` |
|      - | 4951 | `	int nLen;` |
|    239 | 4952 | `	if( nArg < 1 ){` |
...
|    239 | 4958 | `	rc = PH7_FormatCheckFormatArg(pCtx,apArg[0],1);` |
|    239 | 4959 | `	if( rc != PH7_OK ){` |
|    ! 0 | 4960 | `		return rc;` |
|      - | 4961 | `	}` |
|      - | 4962 | `	/* Extract the string format (scalars/null coerce). */` |
|    239 | 4963 | `	zFormat = ph7_value_to_string(apArg[0],&nLen);` |
|    239 | 4964 | `	if( nLen < 1 ){` |
|      - | 4965 | `		/* Empty string */` |
...
|    239 | 4971 | `	rc = PH7_FormatValidate(pCtx,zFormat,nLen);` |
|    239 | 4972 | `	if( rc != PH7_OK ){` |
|     17 | 4973 | `		return rc;` |
|      - | 4974 | `	}` |
|      - | 4975 | `	/* PHP 8: too few value arguments is a catchable ArgumentCountError before output. */` |
|    223 | 4976 | `	rc = PH7_FormatCheckArgCount(pCtx,zFormat,nLen,nArg-1,1,FALSE);` |
|    223 | 4977 | `	if( rc != PH7_OK ){` |
|     11 | 4978 | `		return rc;` |
|      - | 4979 | `	}` |
|      - | 4980 | `	/* Format the string; sprintfConsumer reports an allocation failure via &rc. */` |
|    213 | 4981 | `	PH7_InputFormat(sprintfConsumer,pCtx,zFormat,nLen,nArg,apArg,(void *)&rc,FALSE);` |
|    213 | 4982 | `	if( rc != SXRET_OK ){` |
...
|      - | 7268 | ` */` |
|     24 | 7269 | `static int PH7_builtin_str_split(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 | 7270 | `{` |
...
|     36 | 7283 | `	if( ph7_value_is_array(apArg[0]) \|\|` |
|     39 | 7284 | `	    ph7_value_is_object(apArg[0]) \|\|` |
|     24 | 7285 | `	    ph7_value_is_resource(apArg[0]) ){` |
...
|     27 | 7293 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     27 | 7294 | `	split_len = (int)sizeof(char);` |
|     27 | 7295 | `	if( nArg > 1 ){` |
|      - | 7296 | `		/* Split length */` |
...
|     21 | 7309 | `	pArray = ph7_context_new_array(pCtx);` |
|      - | 7310 | `	/*Chunk value */` |
|     21 | 7311 | `	pValue = ph7_context_new_scalar(pCtx);` |
|     21 | 7312 | `	if( pValue == 0 \|\| pArray == 0 ){` |
|      - | 7313 | `		/* Return FALSE */` |
|    ! 0 | 7314 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 7315 | `		return PH7_OK;` |
|      - | 7316 | `	}` |
|      - | 7317 | `	/* Point to the end of the string */` |
|     21 | 7318 | `	zEnd = &zString[nLen];` |
|      - | 7319 | `	/* Perform the requested operation */` |
|     48 | 7320 | `	for(;;){` |
|      - | 7321 | `		int nMax;` |
|     59 | 7322 | `		if( zString >= zEnd ){` |
|      - | 7323 | `			/* No more input to process */` |
|     21 | 7324 | `			break;` |
|      - | 7325 | `		}` |
|     39 | 7326 | `		nMax = (int)(zEnd-zString);` |
|     39 | 7327 | `		if( nMax < split_len ){` |
|      3 | 7328 | `			split_len = nMax;` |
|      1 | 7329 | `		}` |
|      - | 7330 | `		/* Copy the current chunk */` |
|     39 | 7331 | `		ph7_value_string(pValue,zString,split_len);` |
|      - | 7332 | `		/* Insert it */` |
|     39 | 7333 | `		if( ph7_array_add_elem(pArray,0,pValue) != SXRET_OK ){ /* Will make it's own copy */` |
|    ! 0 | 7334 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 7335 | `		}` |
|      - | 7336 | `		/* reset the string cursor */` |
|     39 | 7337 | `		ph7_value_reset_string_cursor(pValue);` |
|      - | 7338 | `		/* Update position */` |
|     39 | 7339 | `		zString += split_len;` |
|      1 | 7340 | `	}` |
|      - | 7341 | `	/*` |
...
|      - | 7345 | `	 */` |
|     21 | 7346 | `	ph7_result_value(pCtx,pArray);` |
|     21 | 7347 | `	return PH7_OK;` |
|     15 | 7348 | `}` |
|      - | 7349 | `/*` |
...
|      - | 8282 | ` */` |
|  29962 | 8283 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8284 | `{` |
...
|      - | 8293 | `	int nByte;` |
|      - | 8294 | `	sxi32 rc;` |
|  29967 | 8295 | `	if( nArg < 3 ){` |
|      - | 8296 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8297 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8298 | `		return PH7_OK;` |
|      - | 8299 | `	}` |
|      - | 8300 | `	/* Initialize fields */` |
|  29967 | 8301 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29967 | 8302 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29967 | 8303 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  29967 | 8304 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  29967 | 8305 | `	sRep.pCtx = pCtx;` |
|  29967 | 8306 | `	sRep.pCollector = &sSearch;` |
|  29967 | 8307 | `	rep_str = 0;` |
|      - | 8308 | `	/* Extract the subject */` |
|  29967 | 8309 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  29967 | 8310 | `	if( nByte < 1 ){` |
...
|  29947 | 8316 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8317 | `	/* Search string */` |
|  29947 | 8318 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8319 | `		/* Collect search string */` |
|     81 | 8320 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     43 | 8321 | `	}else{` |
|      - | 8322 | `		/* Single pattern */` |
|  29871 | 8323 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29871 | 8324 | `		if( nByte < 1 ){` |
...
|      - | 8328 | `		}` |
|  29867 | 8329 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8330 | `		/* Save for later processing */` |
|  29867 | 8331 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8332 | `	}` |
|      - | 8333 | `	/* Replace string */` |
|  29943 | 8334 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8335 | `		/* Collect replace string */` |
|      7 | 8336 | `		sRep.pCollector = &sReplace;` |
|      7 | 8337 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8338 | `	}else{` |
|      - | 8339 | `		/* Single needle */` |
|  29937 | 8340 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  29937 | 8341 | `		rep_str = 1;` |
|  29937 | 8342 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8343 | `		/* Save for later processing */` |
|  29937 | 8344 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8345 | `	}` |
|      - | 8346 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  29943 | 8347 | `	if( sRep.rc != SXRET_OK ){` |
...
|  29943 | 8354 | `	SySetResetCursor(&sSearch);` |
|  29943 | 8355 | `	SySetResetCursor(&sReplace);` |
|  29943 | 8356 | `	pReplace = pSearch = 0; /* cc warning */` |
|  29943 | 8357 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8358 | `	/* Extract function name */` |
|  29943 | 8359 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8360 | `	/* Set the default pattern match routine */` |
|  29943 | 8361 | `	xMatch = SyBlobSearch;` |
|  29943 | 8362 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8363 | `		/* Case insensitive pattern match */` |
|     11 | 8364 | `		xMatch = iPatternMatch;` |
|      5 | 8365 | `	}` |
|      - | 8366 | `	/* Start the replace process */` |
|  59957 | 8367 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8368 | `		sxu32 nCount,nOfft;` |
|  30019 | 8369 | `		if( pSearch->nByte <  1 ){` |
|      - | 8370 | `			/* Empty string,ignore */` |
|      3 | 8371 | `			continue;` |
|      - | 8372 | `		}` |
|      - | 8373 | `		/* Extract the replace string */` |
|  30017 | 8374 | `		if( rep_str ){` |
|  30007 | 8375 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  15006 | 8376 | `		}else{` |
...
|      1 | 8382 | `			}` |
|      - | 8383 | `		}` |
|  30017 | 8384 | `		if( pReplace == 0 ){` |
|      - | 8385 | `			/* Use an empty string instead */` |
|      3 | 8386 | `			pReplace = &sTemp;` |
|      1 | 8387 | `		}` |
|  30017 | 8388 | `		nOfft = nCount = 0;` |
|  15032 | 8389 | `		for(;;){` |
|  30069 | 8390 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8391 | `				break;` |
|      - | 8392 | `			}` |
|      - | 8393 | `			/* Perform a pattern lookup */` |
|  45083 | 8394 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30052 | 8395 | `				pSearch->nByte,&nOfft);` |
|  30057 | 8396 | `			if( rc != SXRET_OK ){` |
...
|  29943 | 8414 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  29943 | 8415 | `	SySetRelease(&sSearch);` |
|  29943 | 8416 | `	SySetRelease(&sReplace);` |
|  29943 | 8417 | `	SyBlobRelease(&sWorker);` |
|  29943 | 8418 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8419 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8420 | `	}` |
|  29943 | 8421 | `	return PH7_OK;` |
|  14986 | 8422 | `}` |
|      - | 8423 | `/*` |
...
|      - | 9009 | ` */` |
|   2098 | 9010 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 9011 | `{` |
...
|   2103 | 9020 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   2103 | 9021 | `	zEnd = &zIn[nLen];` |
|   2103 | 9022 | `	if( nLen < 1 ){` |
|      - | 9023 | `		/* Empty string,return FALSE */` |
|      3 | 9024 | `		ph7_result_bool(pCtx,0);` |
|      3 | 9025 | `		return PH7_OK;` |
|      - | 9026 | `	}` |
|      - | 9027 | `	/* Perform the requested operation */` |
|   1944 | 9028 | `	for(;;){` |
|   3893 | 9029 | `		if( zIn >= zEnd ){` |
|      - | 9030 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1735 | 9031 | `			ph7_result_bool(pCtx,1);` |
|   1735 | 9032 | `			return PH7_OK;` |
|      - | 9033 | `		}` |
|   2163 | 9034 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 9035 | `			/* UTF-8 stream  */` |
|    ! 0 | 9036 | `			break;` |
|      - | 9037 | `		}` |
|   2163 | 9038 | `		if( !SyisDigit(zIn[0]) ){` |
|    371 | 9039 | `			break;` |
|      - | 9040 | `		}` |
...
|    371 | 9045 | `	ph7_result_bool(pCtx,0);` |
|    371 | 9046 | `	return PH7_OK;` |
|   1054 | 9047 | `}` |
|      - | 9048 | `/*` |
...
|      - | 9541 | `static const ph7_builtin_func aBuiltInFunc[] = {` |
|      - | 9542 | `	   /* Variable handling functions */` |
|      - | 9543 | `	{ "is_bool"    , PH7_builtin_is_bool     },` |
|      - | 9544 | `	{ "is_float"   , PH7_builtin_is_float    },` |
|      - | 9545 | `	{ "is_real"    , PH7_builtin_is_float    },` |
|      - | 9546 | `	{ "is_double"  , PH7_builtin_is_float    },` |
|      - | 9547 | `	{ "is_int"     , PH7_builtin_is_int      },` |
|      - | 9548 | `	{ "is_integer" , PH7_builtin_is_int      },` |
|      - | 9549 | `	{ "is_long"    , PH7_builtin_is_int      },` |
|      - | 9550 | `	{ "is_string"  , PH7_builtin_is_string   },` |
|      - | 9551 | `	{ "is_null"    , PH7_builtin_is_null     },` |
|      - | 9552 | `	{ "is_numeric" , PH7_builtin_is_numeric  },` |
|      - | 9553 | `	{ "is_scalar"  , PH7_builtin_is_scalar   },` |
|      - | 9554 | `	{ "is_array"   , PH7_builtin_is_array    },` |
|      - | 9555 | `	{ "is_object"  , PH7_builtin_is_object   },` |
|      - | 9556 | `	{ "is_resource", PH7_builtin_is_resource },` |
|      - | 9557 | `	{ "douleval"   , PH7_builtin_floatval    },` |
|      - | 9558 | `	{ "floatval"   , PH7_builtin_floatval    },` |
|      - | 9559 | `	{ "intval"     , PH7_builtin_intval      },` |
|      - | 9560 | `	{ "strval"     , PH7_builtin_strval      },` |
|      - | 9561 | `	{ "boolval"    , PH7_builtin_boolval     },` |
|      - | 9562 | `	{ "empty"      , PH7_builtin_empty       },` |
|      - | 9563 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9564 | `#ifdef PH7_ENABLE_MATH_FUNC` |
|      - | 9565 | `	   /* Math functions */` |
|      - | 9566 | `	{ "abs"  ,    PH7_builtin_abs          },` |
|      - | 9567 | `	{ "sqrt" ,    PH7_builtin_sqrt         },` |
|      - | 9568 | `	{ "acosh" ,   PH7_builtin_acosh        },` |
|      - | 9569 | `	{ "asinh" ,   PH7_builtin_asinh        },` |
|      - | 9570 | `	{ "atanh" ,   PH7_builtin_atanh        },` |
|      - | 9571 | `	{ "expm1" ,   PH7_builtin_expm1        },` |
|      - | 9572 | `	{ "log1p" ,   PH7_builtin_log1p        },` |
|      - | 9573 | `	{ "deg2rad" , PH7_builtin_deg2rad      },` |
|      - | 9574 | `	{ "rad2deg" , PH7_builtin_rad2deg      },` |
|      - | 9575 | `	{ "fpow" ,    PH7_builtin_fpow         },` |
|      - | 9576 | `	{ "exp"  ,    PH7_builtin_exp          },` |
|      - | 9577 | `	{ "floor",    PH7_builtin_floor        },` |
|      - | 9578 | `	{ "cos"  ,    PH7_builtin_cos          },` |
|      - | 9579 | `	{ "sin"  ,    PH7_builtin_sin          },` |
|      - | 9580 | `	{ "acos" ,    PH7_builtin_acos         },` |
|      - | 9581 | `	{ "asin" ,    PH7_builtin_asin         },` |
|      - | 9582 | `	{ "cosh" ,    PH7_builtin_cosh         },` |
|      - | 9583 | `	{ "sinh" ,    PH7_builtin_sinh         },` |
|      - | 9584 | `	{ "ceil" ,    PH7_builtin_ceil         },` |
|      - | 9585 | `	{ "tan"  ,    PH7_builtin_tan          },` |
|      - | 9586 | `	{ "tanh" ,    PH7_builtin_tanh         },` |
|      - | 9587 | `	{ "atan" ,    PH7_builtin_atan         },` |
|      - | 9588 | `	{ "atan2",    PH7_builtin_atan2        },` |
|      - | 9589 | `	{ "log"  ,    PH7_builtin_log          },` |
|      - | 9590 | `	{ "log10" ,   PH7_builtin_log10        },` |
|      - | 9591 | `	{ "pow"  ,    PH7_builtin_pow          },` |
|      - | 9592 | `	{ "pi",       PH7_builtin_pi           },` |
|      - | 9593 | `	{ "fmod",     PH7_builtin_fmod         },` |
|      - | 9594 | `	{ "hypot",    PH7_builtin_hypot        },` |
|      - | 9595 | `#endif /* PH7_ENABLE_MATH_FUNC */` |
|      - | 9596 | `	{ "round",    PH7_builtin_round        },` |
|      - | 9597 | `	{ "intdiv",   PH7_builtin_intdiv       },` |
|      - | 9598 | `	{ "dechex", PH7_builtin_dechex         },` |
|      - | 9599 | `	{ "decoct", PH7_builtin_decoct         },` |
|      - | 9600 | `	{ "decbin", PH7_builtin_decbin         },` |
|      - | 9601 | `	{ "hexdec", PH7_builtin_hexdec         },` |
|      - | 9602 | `	{ "bindec", PH7_builtin_bindec         },` |
|      - | 9603 | `	{ "octdec", PH7_builtin_octdec         },` |
|      - | 9604 | `	{ "srand",  PH7_builtin_srand          },` |
|      - | 9605 | `	{ "mt_srand",PH7_builtin_srand         },` |
|      - | 9606 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9607 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9608 | `	{ "base_convert", PH7_builtin_base_convert },` |
|      - | 9609 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9610 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9611 | `	   /* String handling functions */` |
|      - | 9612 |  |
|      - | 9613 | `	{ "substr",          PH7_builtin_substr     },` |
|      - | 9614 | `	{ "substr_compare",  PH7_builtin_substr_compare },` |
|      - | 9615 | `	{ "substr_count",    PH7_builtin_substr_count },` |
|      - | 9616 | `	{ "substr_replace",  PH7_builtin_substr_replace },` |
|      - | 9617 | `	{ "levenshtein",     PH7_builtin_levenshtein },` |
|      - | 9618 | `	{ "similar_text",    PH7_builtin_similar_text },` |
|      - | 9619 | `	{ "str_word_count",  PH7_builtin_str_word_count },` |
|      - | 9620 | `	{ "chunk_split",     PH7_builtin_chunk_split},` |
|      - | 9621 | `	{ "addslashes" ,     PH7_builtin_addslashes },` |
|      - | 9622 | `	{ "addcslashes",     PH7_builtin_addcslashes},` |
|      - | 9623 | `	{ "quotemeta",       PH7_builtin_quotemeta  },` |
|      - | 9624 | `	{ "stripslashes",    PH7_builtin_stripslashes },` |
|      - | 9625 | `	{ "htmlspecialchars",PH7_builtin_htmlspecialchars },` |
|      - | 9626 | `	{ "htmlspecialchars_decode", PH7_builtin_htmlspecialchars_decode },` |
|      - | 9627 | `	{ "get_html_translation_table",PH7_builtin_get_html_translation_table },` |
|      - | 9628 | `	{ "htmlentities",PH7_builtin_htmlentities},` |
|      - | 9629 | `	{ "html_entity_decode", PH7_builtin_html_entity_decode},` |
|      - | 9630 | `	{ "strlen"     , PH7_builtin_strlen     },` |
|      - | 9631 | `	{ "strcmp"     , PH7_builtin_strcmp     },` |
|      - | 9632 | `	{ "strcoll"    , PH7_builtin_strcmp     },` |
|      - | 9633 | `	{ "strnatcmp"  , PH7_builtin_strnatcmp  },` |
|      - | 9634 | `	{ "strnatcasecmp", PH7_builtin_strnatcmp },` |
|      - | 9635 | `	{ "strncmp"    , PH7_builtin_strncmp    },` |
|      - | 9636 | `	{ "strcasecmp" , PH7_builtin_strcasecmp },` |
|      - | 9637 | `	{ "strncasecmp", PH7_builtin_strncasecmp},` |
|      - | 9638 | `	{ "implode"    , PH7_builtin_implode    },` |
|      - | 9639 | `	{ "join"       , PH7_builtin_implode    },` |
|      - | 9640 | `	{ "implode_recursive" , PH7_builtin_implode_recursive },` |
|      - | 9641 | `	{ "join_recursive"    , PH7_builtin_implode_recursive },` |
|      - | 9642 | `	{ "explode"     , PH7_builtin_explode    },` |
|      - | 9643 | `	{ "trim"        , PH7_builtin_trim       },` |
|      - | 9644 | `	{ "rtrim"       , PH7_builtin_rtrim      },` |
|      - | 9645 | `	{ "chop"        , PH7_builtin_rtrim      },` |
|      - | 9646 | `	{ "ltrim"       , PH7_builtin_ltrim      },` |
|      - | 9647 | `	{ "strtolower",   PH7_builtin_strtolower },` |
|      - | 9648 | `	{ "mb_strtolower",PH7_builtin_mb_case_f }, /* UTF-8 only (builtin_mb.c) */` |
|      - | 9649 | `	{ "strtoupper",   PH7_builtin_strtoupper },` |
|      - | 9650 | `	{ "mb_strtoupper",PH7_builtin_mb_case_f }, /* UTF-8 only (builtin_mb.c) */` |
|      - | 9651 | `	{ "mb_strlen",    PH7_builtin_mb_strlen_f },` |
|      - | 9652 | `	{ "mb_substr",    PH7_builtin_mb_substr_f },` |
|      - | 9653 | `	{ "mb_convert_case", PH7_builtin_mb_convert_case_f },` |
|      - | 9654 | `	{ "mb_strpos",    PH7_builtin_mb_strpos_f },` |
|      - | 9655 | `	{ "mb_stripos",   PH7_builtin_mb_strpos_f },` |
|      - | 9656 | `	{ "mb_strrpos",   PH7_builtin_mb_strpos_f },` |
|      - | 9657 | `	{ "mb_str_split", PH7_builtin_mb_str_split_f },` |
|      - | 9658 | `	{ "mb_internal_encoding", PH7_builtin_mb_internal_encoding_f },` |
|      - | 9659 | `	{ "mb_check_encoding",    PH7_builtin_mb_check_encoding_f },` |
|      - | 9660 | `	{ "mb_strwidth",  PH7_builtin_mb_strwidth_f },` |
|      - | 9661 | `	{ "mb_chr",       PH7_builtin_mb_chr_f   },` |
|      - | 9662 | `	{ "mb_ord",       PH7_builtin_mb_ord_f   },` |
|      - | 9663 | `	{ "ucfirst",      PH7_builtin_ucfirst    },` |
|      - | 9664 | `	{ "lcfirst",      PH7_builtin_lcfirst    },` |
|      - | 9665 | `	{ "ord",          PH7_builtin_ord        },` |
|      - | 9666 | `	{ "chr",          PH7_builtin_chr        },` |
|      - | 9667 | `	{ "bin2hex",      PH7_builtin_bin2hex    },` |
|      - | 9668 | `	{ "strstr",       PH7_builtin_strstr     },` |
|      - | 9669 | `	{ "stristr",      PH7_builtin_stristr    },` |
|      - | 9670 | `	{ "strchr",       PH7_builtin_strstr     },` |
|      - | 9671 | `	{ "strpos",       PH7_builtin_strpos     },` |
|      - | 9672 | `	{ "stripos",      PH7_builtin_stripos    },` |
|      - | 9673 | `	{ "strrpos",      PH7_builtin_strrpos    },` |
|      - | 9674 | `	{ "strripos",     PH7_builtin_strripos   },` |
|      - | 9675 | `	{ "strrchr",      PH7_builtin_strrchr    },` |
|      - | 9676 | `	{ "strrev",       PH7_builtin_strrev     },` |
|      - | 9677 | `	{ "ucwords",      PH7_builtin_ucwords    },` |
|      - | 9678 | `	{ "str_repeat",   PH7_builtin_str_repeat },` |
|      - | 9679 | `	{ "str_contains", PH7_builtin_str_contains },` |
|      - | 9680 | `	{ "str_starts_with", PH7_builtin_str_starts_with },` |
|      - | 9681 | `	{ "str_ends_with", PH7_builtin_str_ends_with },` |
|      - | 9682 | `	{ "nl2br",        PH7_builtin_nl2br      },` |
|      - | 9683 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9684 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9685 | `	{ "sprintf",      PH7_builtin_sprintf    },` |
|      - | 9686 | `	{ "printf",       PH7_builtin_printf     },` |
|      - | 9687 | `	{ "vprintf",      PH7_builtin_vprintf    },` |
|      - | 9688 | `	{ "vsprintf",     PH7_builtin_vsprintf   },` |
|      - | 9689 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9690 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9691 | `	{ "size_format",  PH7_builtin_size_format},` |
|      - | 9692 |  |
|      - | 9693 |  |
|      - | 9694 | `#ifndef PH7_DISABLE_HASH_FUNC` |
|      - | 9695 | `	{ "md5",          PH7_builtin_md5       },` |
|      - | 9696 | `	{ "sha1",         PH7_builtin_sha1      },` |
|      - | 9697 | `	{ "crc32",        PH7_builtin_crc32     },` |
|      - | 9698 | `	{ "hash",         PH7_builtin_hash      },` |
|      - | 9699 | `	{ "hash_hmac",    PH7_builtin_hash_hmac },` |
|      - | 9700 | `	{ "hash_equals",  PH7_builtin_hash_equals },` |
|      - | 9701 | `	{ "hash_algos",   PH7_builtin_hash_algos },` |
|      - | 9702 | `#endif /* PH7_DISABLE_HASH_FUNC */` |
|      - | 9703 | `	{ "password_hash",         PH7_builtin_password_hash },` |
|      - | 9704 | `	{ "password_verify",       PH7_builtin_password_verify },` |
|      - | 9705 | `	{ "password_get_info",     PH7_builtin_password_get_info },` |
|      - | 9706 | `	{ "password_needs_rehash", PH7_builtin_password_needs_rehash },` |
|      - | 9707 | `	{ "filter_var",            PH7_builtin_filter_var },` |
|      - | 9708 | `	{ "filter_input",          PH7_builtin_filter_input },` |
|      - | 9709 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9710 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9711 | `	{ "str_getcsv",   PH7_builtin_str_getcsv },` |
|      - | 9712 | `	{ "strip_tags",   PH7_builtin_strip_tags },` |
|      - | 9713 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9714 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9715 |  |
|      - | 9716 | `	{ "str_shuffle",  PH7_builtin_str_shuffle},` |
|      - | 9717 | `	{ "str_split",    PH7_builtin_str_split  },` |
|      - | 9718 | `	{ "strspn",       PH7_builtin_strspn     },` |
|      - | 9719 | `	{ "strcspn",      PH7_builtin_strcspn    },` |
|      - | 9720 | `	{ "strpbrk",      PH7_builtin_strpbrk    },` |
|      - | 9721 | `	{ "soundex",      PH7_builtin_soundex    },` |
|      - | 9722 | `	{ "wordwrap",     PH7_builtin_wordwrap   },` |
|      - | 9723 | `	{ "strtok",       PH7_builtin_strtok     },` |
|      - | 9724 | `	{ "str_pad",      PH7_builtin_str_pad    },` |
|      - | 9725 | `	{ "str_replace",  PH7_builtin_str_replace},` |
|      - | 9726 | `	{ "str_ireplace", PH7_builtin_str_replace},` |
|      - | 9727 | `	{ "strtr",        PH7_builtin_strtr      },` |
|      - | 9728 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9729 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9730 | `	{ "parse_ini_string", PH7_builtin_parse_ini_string},` |
|      - | 9731 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9732 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9733 |  |
|      - | 9734 | `	         /* Ctype functions */` |
|      - | 9735 | `	{ "ctype_alnum", PH7_builtin_ctype_alnum },` |
|      - | 9736 | `	{ "ctype_alpha", PH7_builtin_ctype_alpha },` |
|      - | 9737 | `	{ "ctype_cntrl", PH7_builtin_ctype_cntrl },` |
|      - | 9738 | `	{ "ctype_digit", PH7_builtin_ctype_digit },` |
|      - | 9739 | `	{ "ctype_xdigit",PH7_builtin_ctype_xdigit},` |
|      - | 9740 | `	{ "ctype_graph", PH7_builtin_ctype_graph },` |
|      - | 9741 | `	{ "ctype_print", PH7_builtin_ctype_print },` |
|      - | 9742 | `	{ "ctype_punct", PH7_builtin_ctype_punct },` |
|      - | 9743 | `	{ "ctype_space", PH7_builtin_ctype_space },` |
|      - | 9744 | `	{ "ctype_lower", PH7_builtin_ctype_lower },` |
|      - | 9745 | `	{ "ctype_upper", PH7_builtin_ctype_upper },` |
|      - | 9746 | `	         /* Time functions */` |
|      - | 9747 | `	{ "time"    ,    PH7_builtin_time         },` |
|      - | 9748 | `	{ "microtime",   PH7_builtin_microtime    },` |
|      - | 9749 | `	{ "hrtime",      PH7_builtin_hrtime       },` |
|      - | 9750 | `	{ "getdate" ,    PH7_builtin_getdate      },` |
|      - | 9751 | `	{ "gettimeofday",PH7_builtin_gettimeofday },` |
|      - | 9752 | `	{ "date",        PH7_builtin_date         },` |
|      - | 9753 | `	{ "strftime",    PH7_builtin_strftime     },` |
|      - | 9754 | `	{ "idate",       PH7_builtin_idate        },` |
|      - | 9755 | `	{ "gmdate",      PH7_builtin_gmdate       },` |
|      - | 9756 | `	{ "localtime",   PH7_builtin_localtime    },` |
|      - | 9757 | `	{ "mktime",      PH7_builtin_mktime       },` |
|      - | 9758 | `	{ "gmmktime",    PH7_builtin_mktime       },` |
|      - | 9759 | `	{ "date_default_timezone_get", PH7_builtin_date_default_timezone_get },` |
|      - | 9760 | `	{ "date_default_timezone_set", PH7_builtin_date_default_timezone_set },` |
|      - | 9761 | `	        /* URL functions */` |
|      - | 9762 | `	{ "base64_encode",PH7_builtin_base64_encode },` |
|      - | 9763 | `	{ "base64_decode",PH7_builtin_base64_decode },` |
|      - | 9764 | `	{ "convert_uuencode",PH7_builtin_base64_encode },` |
|      - | 9765 | `	{ "convert_uudecode",PH7_builtin_base64_decode },` |
|      - | 9766 | `	{ "urlencode",    PH7_builtin_urlencode },` |
|      - | 9767 | `	{ "urldecode",    PH7_builtin_urldecode },` |
|      - | 9768 | `	{ "rawurlencode", PH7_builtin_rawurlencode },` |
|      - | 9769 | `	{ "rawurldecode", PH7_builtin_urldecode },` |
|      - | 9770 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9771 | `};` |
|      - | 9772 | `/*` |
|      - | 9773 | ` * Register the built-in functions defined above,the array functions` |
|      - | 9774 | ` * defined in hashmap.c and the IO functions defined in vfs.c.` |
|      - | 9775 | ` */` |
|   3356 | 9776 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 9777 | `{` |
|      - | 9778 | `	sxu32 n;` |
| 661137 | 9779 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 657781 | 9780 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 328893 | 9781 | `	}` |
|      - | 9782 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3361 | 9783 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 9784 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3361 | 9785 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3361 | 9786 | `}` |
|      - | 9787 |  |
