...
|      - |  294 | ` */` |
|  25450 |  295 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  296 |  |
|  25452 |  297 | `	int res = 1; /* Assume empty by default */` |
|  25452 |  298 | `	if( nArg > 0 ){` |
|  25450 |  299 | `		res = ph7_value_is_empty(apArg[0]);` |
|  12724 |  300 | `	}` |
|  25452 |  301 | `	ph7_result_bool(pCtx,res);` |
|  25452 |  302 | `	return PH7_OK;` |
|      - |  303 |  |
|      2 |  304 |  |
...
|      - |  344 | ` */` |
| 188066 |  345 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  346 |  |
|      - |  347 | `	const char *zSource,*zOfft;` |
|      - |  348 | `	int nOfft,nLen,nSrcLen;` |
| 188068 |  349 | `	if( nArg < 2 ){` |
|      - |  350 | `		/* return FALSE */` |
|      5 |  351 | `		ph7_result_bool(pCtx,0);` |
|      5 |  352 | `		return PH7_OK;` |
|      - |  353 | `	}` |
|      - |  354 | `	/* Extract the target string */` |
| 188064 |  355 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 188064 |  356 | `	if( nSrcLen < 1 ){` |
|      - |  357 | `		/* Empty string,return FALSE */` |
|  10970 |  358 | `		ph7_result_bool(pCtx,0);` |
|  10970 |  359 | `		return PH7_OK;` |
|      - |  360 | `	}` |
| 177096 |  361 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  362 | `	/* Extract the offset */` |
| 177096 |  363 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 177096 |  364 | `	if( nOfft < 0 ){` |
|  29456 |  365 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  29456 |  366 | `		if( zOfft < zSource ){` |
|      - |  367 | `			/* Invalid offset */` |
|      5 |  368 | `			ph7_result_bool(pCtx,0);` |
|      5 |  369 | `			return PH7_OK;` |
|      - |  370 | `		}` |
|  29452 |  371 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  29452 |  372 | `		nOfft = (int)(zOfft-zSource);` |
| 162367 |  373 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  374 | `		/* Invalid offset */` |
|    116 |  375 | `		ph7_result_bool(pCtx,0);` |
|    116 |  376 | `		return PH7_OK;` |
|    ! 0 |  377 | `	}else{` |
| 147528 |  378 | `		zOfft = &zSource[nOfft];` |
| 147528 |  379 | `		nLen = nSrcLen - nOfft;` |
|      - |  380 | `	}` |
| 176978 |  381 | `	if( nArg > 2 ){` |
|      - |  382 | `		/* Extract the length */` |
| 146346 |  383 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 146346 |  384 | `		if( nLen == 0 ){` |
|      - |  385 | `			/* Invalid length,return an empty string */` |
|      5 |  386 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  387 | `			return PH7_OK;` |
| 146342 |  388 | `		}else if( nLen < 0 ){` |
|  29446 |  389 | `			nLen = nSrcLen + nLen - nOfft;` |
|  29446 |  390 | `			if( nLen < 1 ){` |
|      - |  391 | `				/* Invalid  length */` |
|      3 |  392 | `				nLen = nSrcLen - nOfft;` |
|      1 |  393 | `			}` |
|  14722 |  394 | `		}` |
| 146342 |  395 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  396 | `			/* Invalid length */` |
|   4170 |  397 | `			nLen = nSrcLen - nOfft;` |
|   2084 |  398 | `		}` |
|  73170 |  399 | `	}` |
|      - |  400 | `	/* Return the substring */` |
| 176974 |  401 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 176974 |  402 | `	return PH7_OK;` |
|  94035 |  403 |  |
|      - |  404 | `/*` |
...
|      - | 1371 | ` */` |
|   5246 | 1372 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1373 |  |
|   5248 | 1374 | `	int iLen = 0;` |
|   5248 | 1375 | `	if( nArg > 0 ){` |
|   5246 | 1376 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   2622 | 1377 | `	}` |
|      - | 1378 | `	/* String length */` |
|   5248 | 1379 | `	ph7_result_int(pCtx,iLen);` |
|   5248 | 1380 | `	return PH7_OK;` |
|      2 | 1381 |  |
|      - | 1382 | `/*` |
...
|      - | 1524 | ` */` |
| 119216 | 1525 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      2 | 1526 |  |
|  59608 | 1527 | `	SXUNUSED(pKey);` |
| 119218 | 1528 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1529 | `	const char *zData;` |
|      - | 1530 | `	int nLen;` |
| 119218 | 1531 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 119216 | 1548 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1549 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 119216 | 1550 | `	if( pData->bFirst ){` |
|  29744 | 1551 | `		pData->bFirst = 0;` |
| 104345 | 1552 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1553 | `		/* append the separator first */` |
|  89462 | 1554 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  44730 | 1555 | `	}` |
|      - | 1556 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
| 119216 | 1557 | `	if( nLen > 0 ){` |
| 108248 | 1558 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  54123 | 1559 | `	}` |
| 119216 | 1560 | `	return PH7_OK;` |
|  59610 | 1561 |  |
|      - | 1562 | `/*` |
...
|      - | 1574 | ` */` |
|  29768 | 1575 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1576 |  |
|      - | 1577 | `	struct implode_data imp_data;` |
|  29770 | 1578 | `	int i = 1;` |
|  29770 | 1579 | `	if( nArg < 1 ){` |
|      - | 1580 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1581 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1582 | `		return PH7_OK;` |
|      - | 1583 | `	}` |
|      - | 1584 | `	/* Prepare the implode context */` |
|  29770 | 1585 | `	imp_data.pCtx = pCtx;` |
|  29770 | 1586 | `	imp_data.bRecursive = 0;` |
|  29770 | 1587 | `	imp_data.bFirst = 1;` |
|  29770 | 1588 | `	imp_data.nRecCount = 0;` |
|  29770 | 1589 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  29768 | 1590 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  14885 | 1591 | `	}else{` |
|      3 | 1592 | `		imp_data.zSep = 0;` |
|      3 | 1593 | `		imp_data.nSeplen = 0;` |
|      3 | 1594 | `		i = 0;` |
|      - | 1595 | `	}` |
|  29770 | 1596 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 1597 | `	/* Start the 'join' process */` |
|  59538 | 1598 | `	while( i < nArg ){` |
|  29770 | 1599 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1600 | `			/* Iterate throw array entries */` |
|  29770 | 1601 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|  14886 | 1602 | `		}else{` |
...
|      - | 1709 | ` */` |
|   5592 | 1710 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1711 |  |
...
|   5586 | 1724 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   5586 | 1725 | `	if( nDelim < 1 ){` |
|      - | 1726 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1727 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1728 | `		return PH7_OK;` |
|      - | 1729 | `	}` |
|      - | 1730 | `	/* Extract the string */` |
|   5584 | 1731 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   5584 | 1732 | `	if( nStrlen < 1 ){` |
...
|   5582 | 1747 | `	zEnd = &zString[nStrlen];` |
|      - | 1748 | `	/* Create the array */` |
|   5582 | 1749 | `	pArray =  ph7_context_new_array(pCtx);` |
|   5582 | 1750 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   5582 | 1751 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1752 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1753 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1754 | `		return PH7_OK;` |
|      - | 1755 | `	}` |
|      - | 1756 | `	/* Set a defualt limit */` |
|   5582 | 1757 | `	iLimit = SXI32_HIGH;` |
|   5582 | 1758 | `	if( nArg > 2 ){` |
...
|  63955 | 1769 | `	for(;;){` |
| 127912 | 1770 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 127912 | 1771 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1772 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   5582 | 1773 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   5582 | 1774 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   5582 | 1775 | `			break;` |
|      - | 1776 | `		}` |
|      - | 1777 | `		/* Point to the desired offset */` |
| 122332 | 1778 | `		zCur = &zString[nOfft];` |
|      - | 1779 | `		/* Perform the store operation (may be empty) */` |
| 122332 | 1780 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 122332 | 1781 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 1782 | `		/* Point beyond the delimiter */` |
| 122332 | 1783 | `		zString = &zCur[nDelim];` |
|      - | 1784 | `		/* Reset the cursor */` |
| 122332 | 1785 | `		ph7_value_reset_string_cursor(pValue);` |
|      2 | 1786 | `	}` |
|      - | 1787 | `	/* Return the freshly created array */` |
|   5582 | 1788 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1789 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1790 | `	 * released as soon we return from this foregin function.` |
|      - | 1791 | `	 */` |
|   5582 | 1792 | `	return PH7_OK;` |
|   2798 | 1793 |  |
|      - | 1794 | `/*` |
...
|      - | 1808 | ` */` |
|  12842 | 1809 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1810 |  |
|      - | 1811 | `	const char *zString;` |
|      - | 1812 | `	int nLen;` |
|  12844 | 1813 | `	if( nArg < 1 ){` |
|      - | 1814 | `		/* Missing arguments,return null */` |
|      3 | 1815 | `		ph7_result_null(pCtx);` |
|      3 | 1816 | `		return PH7_OK;` |
|      - | 1817 | `	}` |
|      - | 1818 | `	/* Extract the target string */` |
|  12842 | 1819 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  12842 | 1820 | `	if( nLen < 1 ){` |
|      - | 1821 | `		/* Empty string,return */` |
|   1672 | 1822 | `		ph7_result_string(pCtx,"",0);` |
|   1672 | 1823 | `		return PH7_OK;` |
|      - | 1824 | `	}` |
|      - | 1825 | `	/* Start the trim process */` |
|  11172 | 1826 | `	if( nArg < 2 ){` |
|      - | 1827 | `		SyString sStr;` |
|      - | 1828 | `		/* Remove white spaces and NUL bytes */` |
|  11168 | 1829 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  27222 | 1830 | `		SyStringFullTrimSafe(&sStr);` |
|  11168 | 1831 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   5585 | 1832 | `	}else{` |
|      - | 1833 | `		/* Char list */` |
...
|    ! 0 | 2083 | `		}else{` |
| 156156 | 2084 | `			int c = zString[0];` |
| 156156 | 2085 | `			if( SyisUpper(c) ){` |
| 156154 | 2086 | `				c = SyToLower(zString[0]);` |
|  78076 | 2087 | `			}` |
|      - | 2088 | `			/* Append character */` |
| 156156 | 2089 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2090 | `			/* Advance the cursor */` |
| 156156 | 2091 | `			zString++;` |
|      - | 2092 | `		}` |
|      2 | 2093 | `	}` |
|  29444 | 2094 | `	return PH7_OK;` |
|  14725 | 2095 |  |
|      - | 2096 | `/*` |
...
|      - | 5712 | ` */` |
|  22202 | 5713 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5714 |  |
...
|      - | 5723 | `	int nByte;` |
|      - | 5724 | `	sxi32 rc;` |
|  22204 | 5725 | `	if( nArg < 3 ){` |
|      - | 5726 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 5727 | `		ph7_result_null(pCtx);` |
|      7 | 5728 | `		return PH7_OK;` |
|      - | 5729 | `	}` |
|      - | 5730 | `	/* Initialize fields */` |
|  22198 | 5731 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  22198 | 5732 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  22198 | 5733 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  22198 | 5734 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  22198 | 5735 | `	sRep.pCtx = pCtx;` |
|  22198 | 5736 | `	sRep.pCollector = &sSearch;` |
|  22198 | 5737 | `	rep_str = 0;` |
|      - | 5738 | `	/* Extract the subject */` |
|  22198 | 5739 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  22198 | 5740 | `	if( nByte < 1 ){` |
...
|  22170 | 5746 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 5747 | `	/* Search string */` |
|  22170 | 5748 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 5749 | `		/* Collect search string */` |
|      9 | 5750 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 5751 | `	}else{` |
|      - | 5752 | `		/* Single pattern */` |
|  22162 | 5753 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  22162 | 5754 | `		if( nByte < 1 ){` |
...
|      - | 5758 | `		}` |
|  22158 | 5759 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5760 | `		/* Save for later processing */` |
|  22158 | 5761 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 5762 | `	}` |
|      - | 5763 | `	/* Replace string */` |
|  22166 | 5764 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 5765 | `		/* Collect replace string */` |
|      7 | 5766 | `		sRep.pCollector = &sReplace;` |
|      7 | 5767 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 5768 | `	}else{` |
|      - | 5769 | `		/* Single needle */` |
|  22160 | 5770 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  22160 | 5771 | `		rep_str = 1;` |
|  22160 | 5772 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5773 | `		/* Save for later processing */` |
|  22160 | 5774 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 5775 | `	}` |
|      - | 5776 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  22166 | 5777 | `	if( sRep.rc != SXRET_OK ){` |
...
|  22166 | 5784 | `	SySetResetCursor(&sSearch);` |
|  22166 | 5785 | `	SySetResetCursor(&sReplace);` |
|  22166 | 5786 | `	pReplace = pSearch = 0; /* cc warning */` |
|  22166 | 5787 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5788 | `	/* Extract function name */` |
|  22166 | 5789 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5790 | `	/* Set the default pattern match routine */` |
|  22166 | 5791 | `	xMatch = SyBlobSearch;` |
|  22166 | 5792 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5793 | `		/* Case insensitive pattern match */` |
|     11 | 5794 | `		xMatch = iPatternMatch;` |
|      5 | 5795 | `	}` |
|      - | 5796 | `	/* Start the replace process */` |
|  44338 | 5797 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5798 | `		sxu32 nCount,nOfft;` |
|  22174 | 5799 | `		if( pSearch->nByte <  1 ){` |
|      - | 5800 | `			/* Empty string,ignore */` |
|      3 | 5801 | `			continue;` |
|      - | 5802 | `		}` |
|      - | 5803 | `		/* Extract the replace string */` |
|  22172 | 5804 | `		if( rep_str ){` |
|  22162 | 5805 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  11082 | 5806 | `		}else{` |
...
|      1 | 5812 | `			}` |
|      - | 5813 | `		}` |
|  22172 | 5814 | `		if( pReplace == 0 ){` |
|      - | 5815 | `			/* Use an empty string instead */` |
|      3 | 5816 | `			pReplace = &sTemp;` |
|      1 | 5817 | `		}` |
|  22172 | 5818 | `		nOfft = nCount = 0;` |
|  11101 | 5819 | `		for(;;){` |
|  22204 | 5820 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 5821 | `				break;` |
|      - | 5822 | `			}` |
|      - | 5823 | `			/* Perform a pattern lookup */` |
|  33287 | 5824 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  22190 | 5825 | `				pSearch->nByte,&nOfft);` |
|  22192 | 5826 | `			if( rc != SXRET_OK ){` |
...
|  22166 | 5844 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  22166 | 5845 | `	SySetRelease(&sSearch);` |
|  22166 | 5846 | `	SySetRelease(&sReplace);` |
|  22166 | 5847 | `	SyBlobRelease(&sWorker);` |
|  22166 | 5848 | `	if( rc != PH7_OK ){` |
|    ! 0 | 5849 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 5850 | `	}` |
|  22166 | 5851 | `	return PH7_OK;` |
|  11103 | 5852 |  |
|      - | 5853 | `/*` |
...
|      - | 6323 | ` */` |
|   1546 | 6324 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6325 |  |
...
|   1546 | 6334 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   1546 | 6335 | `	zEnd = &zIn[nLen];` |
|   1546 | 6336 | `	if( nLen < 1 ){` |
...
|   1448 | 6342 | `	for(;;){` |
|   2898 | 6343 | `		if( zIn >= zEnd ){` |
|      - | 6344 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1324 | 6345 | `			ph7_result_bool(pCtx,1);` |
|   1324 | 6346 | `			return PH7_OK;` |
|      - | 6347 | `		}` |
|   1576 | 6348 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 6349 | `			/* UTF-8 stream  */` |
|    ! 0 | 6350 | `			break;` |
|      - | 6351 | `		}` |
|   1576 | 6352 | `		if( !SyisDigit(zIn[0]) ){` |
|    222 | 6353 | `			break;` |
|      - | 6354 | `		}` |
...
|    222 | 6359 | `	ph7_result_bool(pCtx,0);` |
|    222 | 6360 | `	return PH7_OK;` |
|    775 | 6361 |  |
|      - | 6362 | `/*` |
...
|      - | 6565 | ` */` |
|  59528 | 6566 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6567 |  |
|      - | 6568 | `	const unsigned char *zIn,*zEnd;` |
|      - | 6569 | `	int nLen;` |
|  59530 | 6570 | `	if( nArg < 1 ){` |
|      - | 6571 | `		/* Missing arguments,return FALSE */` |
|      3 | 6572 | `		ph7_result_bool(pCtx,0);` |
|      3 | 6573 | `		return PH7_OK;` |
|      - | 6574 | `	}` |
|      - | 6575 | `	/* Extract the target string */` |
|  59528 | 6576 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  59528 | 6577 | `	zEnd = &zIn[nLen];` |
|  59528 | 6578 | `	if( nLen < 1 ){` |
...
|  30792 | 6584 | `	for(;;){` |
|  61542 | 6585 | `		if( zIn >= zEnd ){` |
|      - | 6586 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1994 | 6587 | `			ph7_result_bool(pCtx,1);` |
|   1994 | 6588 | `			return PH7_OK;` |
|      - | 6589 | `		}` |
|  59550 | 6590 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 6591 | `			/* UTF-8 stream  */` |
|    ! 0 | 6592 | `			break;` |
|      - | 6593 | `		}` |
|  59550 | 6594 | `		if( !SyisSpace(zIn[0]) ){` |
|  57534 | 6595 | `			break;` |
|      - | 6596 | `		}` |
...
|  57534 | 6601 | `	ph7_result_bool(pCtx,0);` |
|  57534 | 6602 | `	return PH7_OK;` |
|  29788 | 6603 |  |
|      - | 6604 | `/*` |
...
|      - | 7025 | ` */` |
|   2826 | 7026 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      2 | 7027 |  |
|      - | 7028 | `	sxu32 n;` |
| 446510 | 7029 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 443684 | 7030 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 221843 | 7031 | `	}` |
|      - | 7032 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   2828 | 7033 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 7034 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   2828 | 7035 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   2828 | 7036 |  |
|      - | 7037 |  |
