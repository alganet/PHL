...
| 495179 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 495184 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 495184 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 495170 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 495154 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 495154 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 495154 |  121 | `	return PH7_OK;` |
| 247697 |  122 | `}` |
|      - |  123 |  |
...
|      - |  178 | ` */` |
|    930 |  179 | `static int PH7_builtin_is_int(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |  180 | `{` |
|    934 |  181 | `	int res = 0; /* Assume false by default */` |
|    934 |  182 | `	if( nArg > 0 ){` |
...
|    934 |  186 | `		res = ph7_value_is_int(apArg[0]) && !ph7_value_is_float(apArg[0]);` |
|    465 |  187 | `	}` |
|      - |  188 | `	/* Query result */` |
|    934 |  189 | `	ph7_result_bool(pCtx,res);` |
|    934 |  190 | `	return PH7_OK;` |
|      4 |  191 | `}` |
|      - |  192 | `/*` |
...
|      5 |  201 | `{` |
|   1109 |  202 | `	int res = 0; /* Assume false by default */` |
|   1109 |  203 | `	if( nArg > 0 ){` |
|   1109 |  204 | `		res = ph7_value_is_string(apArg[0]);` |
|    552 |  205 | `	}` |
|      - |  206 | `	/* Query result */` |
|   1109 |  207 | `	ph7_result_bool(pCtx,res);` |
|   1109 |  208 | `	return PH7_OK;` |
|      5 |  209 | `}` |
|      - |  210 | `/*` |
...
|      3 |  219 | `{` |
|     87 |  220 | `	int res = 0; /* Assume false by default */` |
|     87 |  221 | `	if( nArg > 0 ){` |
|     87 |  222 | `		res = ph7_value_is_null(apArg[0]);` |
|     42 |  223 | `	}` |
|      - |  224 | `	/* Query result */` |
|     87 |  225 | `	ph7_result_bool(pCtx,res);` |
|     87 |  226 | `	return PH7_OK;` |
|      3 |  227 | `}` |
|      - |  228 | `/*` |
...
|      - |  278 | ` */` |
|   1386 |  279 | `static int PH7_builtin_is_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  280 | `{` |
|   1391 |  281 | `	int res = 0; /* Assume false by default */` |
|   1391 |  282 | `	if( nArg > 0 ){` |
|   1391 |  283 | `		res = ph7_value_is_array(apArg[0]);` |
|    693 |  284 | `	}` |
|      - |  285 | `	/* Query result */` |
|   1391 |  286 | `	ph7_result_bool(pCtx,res);` |
|   1391 |  287 | `	return PH7_OK;` |
|      5 |  288 | `}` |
|      - |  289 | `/*` |
...
|      - |  397 | ` */` |
|     14 |  398 | `static int PH7_builtin_boolval(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |  399 | `{` |
|      - |  400 | `	int bVal;` |
|     15 |  401 | `	if( nArg != 1 ){` |
...
|     15 |  409 | `	bVal = ph7_value_to_bool(apArg[0]);` |
|     15 |  410 | `	ph7_result_bool(pCtx,bVal);` |
...
|      - |  420 | ` */` |
|  39678 |  421 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  422 | `{` |
|  39683 |  423 | `	int res = 1; /* Assume empty by default */` |
|  39683 |  424 | `	if( nArg > 0 ){` |
|  39681 |  425 | `		res = ph7_value_is_empty(apArg[0]);` |
|  19838 |  426 | `	}` |
|  39683 |  427 | `	ph7_result_bool(pCtx,res);` |
|  39683 |  428 | `	return PH7_OK;` |
|      - |  429 |  |
|      5 |  430 | `}` |
...
|      - |  792 | ` */` |
|   3422 |  793 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 |  794 | `{` |
|      - |  795 | `	sxu32 n;` |
| 704937 |  796 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 701515 |  797 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 350760 |  798 | `	}` |
|      - |  799 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3427 |  800 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - |  801 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3427 |  802 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3427 |  803 | `}` |
|      - |  804 |  |
|      - |  805 | `/*` |
