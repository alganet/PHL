...
|      2 |  153 |  |
|    100 |  154 | `	int res = 0; /* Assume false by default */` |
|    100 |  155 | `	if( nArg > 0 ){` |
|     98 |  156 | `		res = ph7_value_is_array(apArg[0]);` |
|     48 |  157 | `	}` |
|      - |  158 | `	/* Query result */` |
|    100 |  159 | `	ph7_result_bool(pCtx,res);` |
|    100 |  160 | `	return PH7_OK;` |
|      2 |  161 |  |
|      - |  162 | `/*` |
...
|      - |  268 | ` */` |
|  17498 |  269 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  270 |  |
|  17500 |  271 | `	int res = 1; /* Assume empty by default */` |
|  17500 |  272 | `	if( nArg > 0 ){` |
|  17498 |  273 | `		res = ph7_value_is_empty(apArg[0]);` |
|   8748 |  274 | `	}` |
|  17500 |  275 | `	ph7_result_bool(pCtx,res);` |
|  17500 |  276 | `	return PH7_OK;` |
|      - |  277 |  |
|      2 |  278 |  |
...
|      - | 1287 | ` */` |
| 123204 | 1288 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1289 |  |
|      - | 1290 | `	const char *zSource,*zOfft;` |
|      - | 1291 | `	int nOfft,nLen,nSrcLen;` |
| 123206 | 1292 | `	if( nArg < 2 ){` |
|      - | 1293 | `		/* return FALSE */` |
|      5 | 1294 | `		ph7_result_bool(pCtx,0);` |
|      5 | 1295 | `		return PH7_OK;` |
|      - | 1296 | `	}` |
|      - | 1297 | `	/* Extract the target string */` |
| 123202 | 1298 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 123202 | 1299 | `	if( nSrcLen < 1 ){` |
|      - | 1300 | `		/* Empty string,return FALSE */` |
|   7644 | 1301 | `		ph7_result_bool(pCtx,0);` |
|   7644 | 1302 | `		return PH7_OK;` |
|      - | 1303 | `	}` |
| 115560 | 1304 | `	nLen = nSrcLen; /* cc warning */` |
|      - | 1305 | `	/* Extract the offset */` |
| 115560 | 1306 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 115560 | 1307 | `	if( nOfft < 0 ){` |
|  19588 | 1308 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  19588 | 1309 | `		if( zOfft < zSource ){` |
|      - | 1310 | `			/* Invalid offset */` |
|      5 | 1311 | `			ph7_result_bool(pCtx,0);` |
|      5 | 1312 | `			return PH7_OK;` |
|      - | 1313 | `		}` |
|  19584 | 1314 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  19584 | 1315 | `		nOfft = (int)(zOfft-zSource);` |
| 105765 | 1316 | `	}else if( nOfft >= nSrcLen ){` |
|      - | 1317 | `		/* Invalid offset */` |
|      7 | 1318 | `		ph7_result_bool(pCtx,0);` |
|      7 | 1319 | `		return PH7_OK;` |
|    ! 0 | 1320 | `	}else{` |
|  95968 | 1321 | `		zOfft = &zSource[nOfft];` |
|  95968 | 1322 | `		nLen = nSrcLen - nOfft;` |
|      - | 1323 | `	}` |
| 115550 | 1324 | `	if( nArg > 2 ){` |
|      - | 1325 | `		/* Extract the length */` |
|  95966 | 1326 | `		nLen = ph7_value_to_int(apArg[2]);` |
|  95966 | 1327 | `		if( nLen == 0 ){` |
|      - | 1328 | `			/* Invalid length,return an empty string */` |
|      5 | 1329 | `			ph7_result_string(pCtx,"",0);` |
|      5 | 1330 | `			return PH7_OK;` |
|  95962 | 1331 | `		}else if( nLen < 0 ){` |
|  19586 | 1332 | `			nLen = nSrcLen + nLen - nOfft;` |
|  19586 | 1333 | `			if( nLen < 1 ){` |
|      - | 1334 | `				/* Invalid  length */` |
|      3 | 1335 | `				nLen = nSrcLen - nOfft;` |
|      1 | 1336 | `			}` |
|   9792 | 1337 | `		}` |
|  95962 | 1338 | `		if( nLen + nOfft > nSrcLen ){` |
|      - | 1339 | `			/* Invalid length */` |
|   2302 | 1340 | `			nLen = nSrcLen - nOfft;` |
|   1150 | 1341 | `		}` |
|  47980 | 1342 | `	}` |
|      - | 1343 | `	/* Return the substring */` |
| 115546 | 1344 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 115546 | 1345 | `	return PH7_OK;` |
|  61604 | 1346 |  |
|      - | 1347 | `/*` |
...
|      - | 2314 | ` */` |
|   2020 | 2315 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2316 |  |
|   2022 | 2317 | `	int iLen = 0;` |
|   2022 | 2318 | `	if( nArg > 0 ){` |
|   2020 | 2319 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   1009 | 2320 | `	}` |
|      - | 2321 | `	/* String length */` |
|   2022 | 2322 | `	ph7_result_int(pCtx,iLen);` |
|   2022 | 2323 | `	return PH7_OK;` |
|      2 | 2324 |  |
|      - | 2325 | `/*` |
...
|      - | 2467 | ` */` |
|  84872 | 2468 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      2 | 2469 |  |
|  42436 | 2470 | `	SXUNUSED(pKey);` |
|  84874 | 2471 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2472 | `	const char *zData;` |
|      - | 2473 | `	int nLen;` |
|  84874 | 2474 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
|  84872 | 2491 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2492 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
|  84872 | 2493 | `	if( pData->bFirst ){` |
|  19750 | 2494 | `		pData->bFirst = 0;` |
|  74998 | 2495 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2496 | `		/* append the separator first */` |
|  65112 | 2497 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  32555 | 2498 | `	}` |
|      - | 2499 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
|  84872 | 2500 | `	if( nLen > 0 ){` |
|  77230 | 2501 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  38614 | 2502 | `	}` |
|  84872 | 2503 | `	return PH7_OK;` |
|  42438 | 2504 |  |
|      - | 2505 | `/*` |
...
|      - | 2517 | ` */` |
|  19776 | 2518 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2519 |  |
|      - | 2520 | `	struct implode_data imp_data;` |
|  19778 | 2521 | `	int i = 1;` |
|  19778 | 2522 | `	if( nArg < 1 ){` |
|      - | 2523 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2524 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2525 | `		return PH7_OK;` |
|      - | 2526 | `	}` |
|      - | 2527 | `	/* Prepare the implode context */` |
|  19778 | 2528 | `	imp_data.pCtx = pCtx;` |
|  19778 | 2529 | `	imp_data.bRecursive = 0;` |
|  19778 | 2530 | `	imp_data.bFirst = 1;` |
|  19778 | 2531 | `	imp_data.nRecCount = 0;` |
|  19778 | 2532 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  19776 | 2533 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|   9889 | 2534 | `	}else{` |
|      3 | 2535 | `		imp_data.zSep = 0;` |
|      3 | 2536 | `		imp_data.nSeplen = 0;` |
|      3 | 2537 | `		i = 0;` |
|      - | 2538 | `	}` |
|  19778 | 2539 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 2540 | `	/* Start the 'join' process */` |
|  39554 | 2541 | `	while( i < nArg ){` |
|  19778 | 2542 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2543 | `			/* Iterate throw array entries */` |
|  19778 | 2544 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|   9890 | 2545 | `		}else{` |
...
|      - | 2652 | ` */` |
|   3628 | 2653 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2654 |  |
...
|   3622 | 2667 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   3622 | 2668 | `	if( nDelim < 1 ){` |
|      - | 2669 | `		/* Empty delimiter,return FALSE */` |
|      3 | 2670 | `		ph7_result_bool(pCtx,0);` |
|      3 | 2671 | `		return PH7_OK;` |
|      - | 2672 | `	}` |
|      - | 2673 | `	/* Extract the string */` |
|   3620 | 2674 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   3620 | 2675 | `	if( nStrlen < 1 ){` |
...
|   3618 | 2690 | `	zEnd = &zString[nStrlen];` |
|      - | 2691 | `	/* Create the array */` |
|   3618 | 2692 | `	pArray =  ph7_context_new_array(pCtx);` |
|   3618 | 2693 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   3618 | 2694 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2695 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2696 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2697 | `		return PH7_OK;` |
|      - | 2698 | `	}` |
|      - | 2699 | `	/* Set a defualt limit */` |
|   3618 | 2700 | `	iLimit = SXI32_HIGH;` |
|   3618 | 2701 | `	if( nArg > 2 ){` |
...
|  42030 | 2712 | `	for(;;){` |
|  84062 | 2713 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
|  84062 | 2714 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2715 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   3618 | 2716 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   3618 | 2717 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   3618 | 2718 | `			break;` |
|      - | 2719 | `		}` |
|      - | 2720 | `		/* Point to the desired offset */` |
|  80446 | 2721 | `		zCur = &zString[nOfft];` |
|      - | 2722 | `		/* Perform the store operation (may be empty) */` |
|  80446 | 2723 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
|  80446 | 2724 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 2725 | `		/* Point beyond the delimiter */` |
|  80446 | 2726 | `		zString = &zCur[nDelim];` |
|      - | 2727 | `		/* Reset the cursor */` |
|  80446 | 2728 | `		ph7_value_reset_string_cursor(pValue);` |
|      2 | 2729 | `	}` |
|      - | 2730 | `	/* Return the freshly created array */` |
|   3618 | 2731 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2732 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2733 | `	 * released as soon we return from this foregin function.` |
|      - | 2734 | `	 */` |
|   3618 | 2735 | `	return PH7_OK;` |
|   1816 | 2736 |  |
|      - | 2737 | `/*` |
...
|      - | 2751 | ` */` |
|   8796 | 2752 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2753 |  |
...
|   8796 | 2762 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|   8796 | 2763 | `	if( nLen < 1 ){` |
...
|   7196 | 2772 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  17386 | 2773 | `		SyStringFullTrimSafe(&sStr);` |
|   7196 | 2774 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   3599 | 2775 | `	}else{` |
|      - | 2776 | `		/* Char list */` |
...
|    ! 0 | 3026 | `		}else{` |
| 104140 | 3027 | `			int c = zString[0];` |
| 104140 | 3028 | `			if( SyisUpper(c) ){` |
| 104138 | 3029 | `				c = SyToLower(zString[0]);` |
|  52068 | 3030 | `			}` |
|      - | 3031 | `			/* Append character */` |
| 104140 | 3032 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 3033 | `			/* Advance the cursor */` |
| 104140 | 3034 | `			zString++;` |
|      - | 3035 | `		}` |
|      2 | 3036 | `	}` |
|  19584 | 3037 | `	return PH7_OK;` |
|   9795 | 3038 |  |
|      - | 3039 | `/*` |
...
|      - | 6359 | ` */` |
|  14362 | 6360 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6361 |  |
...
|      - | 6370 | `	int nByte;` |
|      - | 6371 | `	sxi32 rc;` |
|  14364 | 6372 | `	if( nArg < 3 ){` |
|      - | 6373 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 6374 | `		ph7_result_null(pCtx);` |
|      7 | 6375 | `		return PH7_OK;` |
|      - | 6376 | `	}` |
|      - | 6377 | `	/* Initialize fields */` |
|  14358 | 6378 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  14358 | 6379 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  14358 | 6380 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  14358 | 6381 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  14358 | 6382 | `	sRep.pCtx = pCtx;` |
|  14358 | 6383 | `	sRep.pCollector = &sSearch;` |
|  14358 | 6384 | `	rep_str = 0;` |
|      - | 6385 | `	/* Extract the subject */` |
|  14358 | 6386 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  14358 | 6387 | `	if( nByte < 1 ){` |
...
|  14322 | 6393 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 6394 | `	/* Search string */` |
|  14322 | 6395 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 6396 | `		/* Collect search string */` |
|      9 | 6397 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 6398 | `	}else{` |
|      - | 6399 | `		/* Single pattern */` |
|  14314 | 6400 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  14314 | 6401 | `		if( nByte < 1 ){` |
...
|      - | 6405 | `		}` |
|  14310 | 6406 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6407 | `		/* Save for later processing */` |
|  14310 | 6408 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 6409 | `	}` |
|      - | 6410 | `	/* Replace string */` |
|  14318 | 6411 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 6412 | `		/* Collect replace string */` |
|      7 | 6413 | `		sRep.pCollector = &sReplace;` |
|      7 | 6414 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 6415 | `	}else{` |
|      - | 6416 | `		/* Single needle */` |
|  14312 | 6417 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  14312 | 6418 | `		rep_str = 1;` |
|  14312 | 6419 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6420 | `		/* Save for later processing */` |
|  14312 | 6421 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 6422 | `	}` |
|      - | 6423 | `	/* Reset loop cursors */` |
|  14318 | 6424 | `	SySetResetCursor(&sSearch);` |
|  14318 | 6425 | `	SySetResetCursor(&sReplace);` |
|  14318 | 6426 | `	pReplace = pSearch = 0; /* cc warning */` |
|  14318 | 6427 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 6428 | `	/* Extract function name */` |
|  14318 | 6429 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 6430 | `	/* Set the default pattern match routine */` |
|  14318 | 6431 | `	xMatch = SyBlobSearch;` |
|  14318 | 6432 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 6433 | `		/* Case insensitive pattern match */` |
|     11 | 6434 | `		xMatch = iPatternMatch;` |
|      5 | 6435 | `	}` |
|      - | 6436 | `	/* Start the replace process */` |
|  28642 | 6437 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 6438 | `		sxu32 nCount,nOfft;` |
|  14326 | 6439 | `		if( pSearch->nByte <  1 ){` |
|      - | 6440 | `			/* Empty string,ignore */` |
|      3 | 6441 | `			continue;` |
|      - | 6442 | `		}` |
|      - | 6443 | `		/* Extract the replace string */` |
|  14324 | 6444 | `		if( rep_str ){` |
|  14314 | 6445 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|   7158 | 6446 | `		}else{` |
...
|      1 | 6452 | `			}` |
|      - | 6453 | `		}` |
|  14324 | 6454 | `		if( pReplace == 0 ){` |
|      - | 6455 | `			/* Use an empty string instead */` |
|      3 | 6456 | `			pReplace = &sTemp;` |
|      1 | 6457 | `		}` |
|  14324 | 6458 | `		nOfft = nCount = 0;` |
|   7177 | 6459 | `		for(;;){` |
|  14356 | 6460 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 6461 | `				break;` |
|      - | 6462 | `			}` |
|      - | 6463 | `			/* Perform a pattern lookup */` |
|  21515 | 6464 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  14342 | 6465 | `				pSearch->nByte,&nOfft);` |
|  14344 | 6466 | `			if( rc != SXRET_OK ){` |
...
|  14318 | 6477 | `	ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  14318 | 6478 | `	SySetRelease(&sSearch);` |
|  14318 | 6479 | `	SySetRelease(&sReplace);` |
|  14318 | 6480 | `	SyBlobRelease(&sWorker);` |
|  14318 | 6481 | `	return PH7_OK;` |
|   7183 | 6482 |  |
|      - | 6483 | `/*` |
...
|      - | 7189 | ` */` |
|  59030 | 7190 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 7191 |  |
|      - | 7192 | `	const unsigned char *zIn,*zEnd;` |
|      - | 7193 | `	int nLen;` |
|  59032 | 7194 | `	if( nArg < 1 ){` |
|      - | 7195 | `		/* Missing arguments,return FALSE */` |
|      3 | 7196 | `		ph7_result_bool(pCtx,0);` |
|      3 | 7197 | `		return PH7_OK;` |
|      - | 7198 | `	}` |
|      - | 7199 | `	/* Extract the target string */` |
|  59030 | 7200 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  59030 | 7201 | `	zEnd = &zIn[nLen];` |
|  59030 | 7202 | `	if( nLen < 1 ){` |
...
|  30071 | 7208 | `	for(;;){` |
|  60100 | 7209 | `		if( zIn >= zEnd ){` |
|      - | 7210 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1050 | 7211 | `			ph7_result_bool(pCtx,1);` |
|   1050 | 7212 | `			return PH7_OK;` |
|      - | 7213 | `		}` |
|  59052 | 7214 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 7215 | `			/* UTF-8 stream  */` |
|    ! 0 | 7216 | `			break;` |
|      - | 7217 | `		}` |
|  59052 | 7218 | `		if( !SyisSpace(zIn[0]) ){` |
|  57980 | 7219 | `			break;` |
|      - | 7220 | `		}` |
...
|  57980 | 7225 | `	ph7_result_bool(pCtx,0);` |
|  57980 | 7226 | `	return PH7_OK;` |
|  29539 | 7227 |  |
|      - | 7228 | `/*` |
...
|      - | 9018 | ` */` |
|   1404 | 9019 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      2 | 9020 |  |
|      - | 9021 | `	sxu32 n;` |
| 214814 | 9022 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 213410 | 9023 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 106706 | 9024 | `	}` |
|      - | 9025 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   1406 | 9026 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 9027 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   1406 | 9028 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   1406 | 9029 |  |
|      - | 9030 |  |
