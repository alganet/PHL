...
| 477232 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 477237 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 477237 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 477223 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 477207 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 477207 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 477207 |  121 | `	return PH7_OK;` |
| 238670 |  122 | `}` |
|      - |  123 |  |
...
|      3 |  180 | `{` |
|    933 |  181 | `	int res = 0; /* Assume false by default */` |
|    933 |  182 | `	if( nArg > 0 ){` |
...
|    933 |  186 | `		res = ph7_value_is_int(apArg[0]) && !ph7_value_is_float(apArg[0]);` |
|    465 |  187 | `	}` |
|      - |  188 | `	/* Query result */` |
|    933 |  189 | `	ph7_result_bool(pCtx,res);` |
|    933 |  190 | `	return PH7_OK;` |
|      3 |  191 | `}` |
|      - |  192 | `/*` |
...
|      4 |  219 | `{` |
|     88 |  220 | `	int res = 0; /* Assume false by default */` |
|     88 |  221 | `	if( nArg > 0 ){` |
|     88 |  222 | `		res = ph7_value_is_null(apArg[0]);` |
|     42 |  223 | `	}` |
|      - |  224 | `	/* Query result */` |
|     88 |  225 | `	ph7_result_bool(pCtx,res);` |
|     88 |  226 | `	return PH7_OK;` |
|      4 |  227 | `}` |
|      - |  228 | `/*` |
...
|      - |  278 | ` */` |
|    818 |  279 | `static int PH7_builtin_is_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  280 | `{` |
|    823 |  281 | `	int res = 0; /* Assume false by default */` |
|    823 |  282 | `	if( nArg > 0 ){` |
|    823 |  283 | `		res = ph7_value_is_array(apArg[0]);` |
|    409 |  284 | `	}` |
|      - |  285 | `	/* Query result */` |
|    823 |  286 | `	ph7_result_bool(pCtx,res);` |
|    823 |  287 | `	return PH7_OK;` |
|      5 |  288 | `}` |
|      - |  289 | `/*` |
...
|      - |  420 | ` */` |
|  39644 |  421 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  422 | `{` |
|  39649 |  423 | `	int res = 1; /* Assume empty by default */` |
|  39649 |  424 | `	if( nArg > 0 ){` |
|  39647 |  425 | `		res = ph7_value_is_empty(apArg[0]);` |
|  19821 |  426 | `	}` |
|  39649 |  427 | `	ph7_result_bool(pCtx,res);` |
|  39649 |  428 | `	return PH7_OK;` |
|      - |  429 |  |
|      5 |  430 | `}` |
