...
| 494785 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 494790 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 494790 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 494776 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 494760 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 494760 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 494760 |  121 | `	return PH7_OK;` |
| 247500 |  122 | `}` |
|      - |  123 |  |
...
|      - |  278 | ` */` |
|   1384 |  279 | `static int PH7_builtin_is_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  280 | `{` |
|   1389 |  281 | `	int res = 0; /* Assume false by default */` |
|   1389 |  282 | `	if( nArg > 0 ){` |
|   1389 |  283 | `		res = ph7_value_is_array(apArg[0]);` |
|    692 |  284 | `	}` |
|      - |  285 | `	/* Query result */` |
|   1389 |  286 | `	ph7_result_bool(pCtx,res);` |
|   1389 |  287 | `	return PH7_OK;` |
|      5 |  288 | `}` |
|      - |  289 | `/*` |
...
|      - |  420 | ` */` |
|  39674 |  421 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  422 | `{` |
|  39679 |  423 | `	int res = 1; /* Assume empty by default */` |
|  39679 |  424 | `	if( nArg > 0 ){` |
|  39677 |  425 | `		res = ph7_value_is_empty(apArg[0]);` |
|  19836 |  426 | `	}` |
|  39679 |  427 | `	ph7_result_bool(pCtx,res);` |
|  39679 |  428 | `	return PH7_OK;` |
|      - |  429 |  |
|      5 |  430 | `}` |
