...
Coverage: 4348/5027 lines (86.49%)
...
|      - |  132 | ` */` |
|     66 |  133 | `static int PH7_builtin_is_numeric(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  134 | `{` |
|     71 |  135 | `	int res = 0; /* Assume false by default */` |
|     71 |  136 | `	if( nArg > 0 ){` |
|     71 |  137 | `		res = ph7_value_is_numeric(apArg[0]);` |
|     33 |  138 | `	}` |
|      - |  139 | `	/* Query result */` |
|     71 |  140 | `	ph7_result_bool(pCtx,res);` |
|     71 |  141 | `	return PH7_OK;` |
|      5 |  142 | `}` |
|      - |  143 | `/*` |
...
|      - |  204 | ` */` |
|     62 |  205 | `static int PH7_builtin_is_resource(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |  206 | `{` |
|     66 |  207 | `	int res = 0; /* Assume false by default */` |
|     66 |  208 | `	if( nArg > 0 ){` |
|     66 |  209 | `		res = ph7_value_is_resource(apArg[0]);` |
|     31 |  210 | `	}` |
|     66 |  211 | `	ph7_result_bool(pCtx,res);` |
|     66 |  212 | `	return PH7_OK;` |
|      4 |  213 | `}` |
|      - |  214 | `/*` |
...
|      - |  308 | ` */` |
|  34042 |  309 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  310 | `{` |
|  34047 |  311 | `	int res = 1; /* Assume empty by default */` |
|  34047 |  312 | `	if( nArg > 0 ){` |
|  34045 |  313 | `		res = ph7_value_is_empty(apArg[0]);` |
|  17020 |  314 | `	}` |
|  34047 |  315 | `	ph7_result_bool(pCtx,res);` |
|  34047 |  316 | `	return PH7_OK;` |
|      - |  317 |  |
|      5 |  318 | `}` |
...
|      - |  358 | ` */` |
| 233670 |  359 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  360 | `{` |
| 233675 |  361 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
|      - |  362 | `	const char *zSource,*zOfft;` |
|      - |  363 | `	int nOfft,nLen,nSrcLen;` |
| 233675 |  364 | `	if( nArg < 2 ){` |
|      - |  365 | `		/* return FALSE */` |
|    ! 0 |  366 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  367 | `		return PH7_OK;` |
|      - |  368 | `	}` |
|      - |  369 | `	/* Extract the target string */` |
| 233675 |  370 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 233675 |  371 | `	if( nSrcLen < 1 ){` |
|      - |  372 | `		/* Empty string,return FALSE */` |
|  12621 |  373 | `		ph7_result_bool(pCtx,0);` |
|  12621 |  374 | `		return PH7_OK;` |
|      - |  375 | `	}` |
| 221059 |  376 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  377 | `	/* Extract the offset */` |
| 221059 |  378 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 221059 |  379 | `	if( nOfft < 0 ){` |
|  33129 |  380 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  33129 |  381 | `		if( zOfft < zSource ){` |
|      - |  382 | `			/* Invalid offset */` |
|      5 |  383 | `			ph7_result_bool(pCtx,0);` |
|      5 |  384 | `			return PH7_OK;` |
|      - |  385 | `		}` |
|  33125 |  386 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  33125 |  387 | `		nOfft = (int)(zOfft-zSource);` |
| 204495 |  388 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  389 | `		/* Invalid offset */` |
|    247 |  390 | `		ph7_result_bool(pCtx,0);` |
|    247 |  391 | `		return PH7_OK;` |
|    ! 0 |  392 | `	}else{` |
| 187693 |  393 | `		zOfft = &zSource[nOfft];` |
| 187693 |  394 | `		nLen = nSrcLen - nOfft;` |
|      - |  395 | `	}` |
| 220813 |  396 | `	if( nArg > 2 ){` |
|      - |  397 | `		/* Extract the length */` |
| 181721 |  398 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 181721 |  399 | `		if( nLen == 0 ){` |
|      - |  400 | `			/* Invalid length,return an empty string */` |
|      5 |  401 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  402 | `			return PH7_OK;` |
| 181717 |  403 | `		}else if( nLen < 0 ){` |
|  33059 |  404 | `			nLen = nSrcLen + nLen - nOfft;` |
|  33059 |  405 | `			if( nLen < 1 ){` |
|      - |  406 | `				/* Invalid  length */` |
|      3 |  407 | `				nLen = nSrcLen - nOfft;` |
|      1 |  408 | `			}` |
|  16527 |  409 | `		}` |
| 181717 |  410 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  411 | `			/* Invalid length */` |
|   6101 |  412 | `			nLen = nSrcLen - nOfft;` |
|   3048 |  413 | `		}` |
|  90856 |  414 | `	}` |
|      - |  415 | `	/* Return the substring */` |
| 220809 |  416 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 220809 |  417 | `	return PH7_OK;` |
| 116840 |  418 | `}` |
|      - |  419 | `/*` |
...
|      - |  439 | ` */` |
|     20 |  440 | `static int PH7_builtin_substr_compare(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |  441 | `{` |
...
|     21 |  452 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|     21 |  453 | `	if( nSrcLen < 1 ){` |
|      - |  454 | `		/* Empty string,return FALSE */` |
|      3 |  455 | `		ph7_result_bool(pCtx,0);` |
|      3 |  456 | `		return PH7_OK;` |
|      - |  457 | `	}` |
|     19 |  458 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  459 | `	/* Extract the substring */` |
|     19 |  460 | `	zSub = ph7_value_to_string(apArg[1],&nSublen);` |
|     19 |  461 | `	if( nSublen < 1 \|\| nSublen > nSrcLen){` |
|      - |  462 | `		/* Empty string,return FALSE */` |
|      3 |  463 | `		ph7_result_bool(pCtx,0);` |
|      3 |  464 | `		return PH7_OK;` |
|      - |  465 | `	}` |
|      - |  466 | `	/* Extract the offset */` |
|     17 |  467 | `	nOfft = ph7_value_to_int(apArg[2]);` |
|     17 |  468 | `	if( nOfft < 0 ){` |
...
|     14 |  477 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  478 | `		/* Invalid offset */` |
|      3 |  479 | `		ph7_result_bool(pCtx,0);` |
|      3 |  480 | `		return PH7_OK;` |
|    ! 0 |  481 | `	}else{` |
|     11 |  482 | `		zOfft = &zSource[nOfft];` |
|     11 |  483 | `		nLen = nSrcLen - nOfft;` |
|      - |  484 | `	}` |
|     13 |  485 | `	if( nArg > 3 ){` |
|      - |  486 | `		/* Extract the length */` |
|     11 |  487 | `		nLen = ph7_value_to_int(apArg[3]);` |
|     11 |  488 | `		if( nLen < 1 ){` |
|      - |  489 | `			/* Invalid  length */` |
|      5 |  490 | `			ph7_result_int(pCtx,1);` |
|      5 |  491 | `			return PH7_OK;` |
|      7 |  492 | `		}else if( nLen + nOfft > nSrcLen ){` |
|      - |  493 | `			/* Invalid length */` |
|    ! 0 |  494 | `			nLen = nSrcLen - nOfft;` |
|    ! 0 |  495 | `		}` |
|      7 |  496 | `		if( nArg > 4 ){` |
...
|      2 |  504 | `	}else{` |
|      7 |  505 | `		rc = SyStrncmp(zOfft,zSub,(sxu32)nLen);` |
|      - |  506 | `	}` |
|      - |  507 | `	/* Comparison result */` |
|      9 |  508 | `	ph7_result_int(pCtx,rc);` |
|      9 |  509 | `	return PH7_OK;` |
|     11 |  510 | `}` |
|      - |  511 | `/*` |
...
|      - |  610 | ` */` |
| 299776 |  611 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  612 | `{` |
| 299781 |  613 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 1570 | ` */` |
|    104 | 1571 | `static void PH7_BuildCharMask(ph7_context *pCtx,const char *zList,int nLen,char aMask[256])` |
|      5 | 1572 | `{` |
|    109 | 1573 | `	const unsigned char *zIn  = (const unsigned char *)zList;` |
|    109 | 1574 | `	const unsigned char *zEnd = zIn + (nLen > 0 ? nLen : 0);` |
|    109 | 1575 | `	SyZero(aMask,256);` |
|    369 | 1576 | `	for( ; zIn < zEnd ; zIn++ ){` |
|    265 | 1577 | `		int c = zIn[0];` |
|    265 | 1578 | `		if( zIn + 3 < zEnd && zIn[1] == '.' && zIn[2] == '.' && zIn[3] >= c ){` |
...
|    264 | 1585 | `		}else if( zIn + 1 < zEnd && zIn[0] == '.' && zIn[1] == '.' ){` |
...
|     39 | 1641 | `	if( ph7_value_is_null(apArg[0]) ){` |
...
|     51 | 1649 | `	          ph7_value_is_object(apArg[0]) \|\|` |
...
|     37 | 1660 | `	if( ph7_value_is_null(apArg[1]) ){` |
...
|     48 | 1667 | `	          ph7_value_is_object(apArg[1]) \|\|` |
...
|      - | 1998 | ` */` |
|  14826 | 1999 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2000 | `{` |
|  14831 | 2001 | `	int iLen = 0;` |
|  14831 | 2002 | `	if( nArg > 0 ){` |
|  14831 | 2003 | `		StrNullArgNotice(pCtx,apArg[0],"strlen",1,"$string");` |
|  14831 | 2004 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   7413 | 2005 | `	}` |
|      - | 2006 | `	/* String length */` |
|  14831 | 2007 | `	ph7_result_int(pCtx,iLen);` |
|  14831 | 2008 | `	return PH7_OK;` |
|      5 | 2009 | `}` |
|      - | 2010 | `/*` |
...
|      - | 2195 | ` */` |
|     44 | 2196 | `static int PH7_builtin_strncasecmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2197 | `{` |
...
|     49 | 2206 | `	n  = ph7_value_to_int(apArg[2]);` |
|     49 | 2207 | `	if( n < 0 ){` |
...
|     47 | 2214 | `	z1 = ph7_value_to_string(apArg[0],0);` |
|     47 | 2215 | `	z2 = ph7_value_to_string(apArg[1],0);` |
|     47 | 2216 | `	res = SyStrnicmp(z1,z2,(sxu32)n);` |
|      - | 2217 | `	/* Comparison result */` |
|     47 | 2218 | `	ph7_result_int(pCtx,res);` |
|     47 | 2219 | `	return PH7_OK;` |
|     27 | 2220 | `}` |
|      - | 2221 | `/*` |
...
|      - | 2239 | ` */` |
| 149256 | 2240 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2241 | `{` |
|  74628 | 2242 | `	SXUNUSED(pKey);` |
| 149261 | 2243 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2244 | `	const char *zData;` |
|      - | 2245 | `	int nLen;` |
| 149261 | 2246 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 149259 | 2270 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2271 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 149259 | 2272 | `	if( pData->bFirst ){` |
|  33535 | 2273 | `		pData->bFirst = 0;` |
| 132494 | 2274 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2275 | `		/* append the separator first */` |
| 115713 | 2276 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 149259 | 2282 | `	if( nLen > 0 ){` |
| 136645 | 2283 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2284 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2285 | `			return PH7_ABORT;` |
|      - | 2286 | `		}` |
|  68320 | 2287 | `	}` |
| 149259 | 2288 | `	return PH7_OK;` |
|  74633 | 2289 | `}` |
|      - | 2290 | `/*` |
...
|      - | 2302 | ` */` |
|  33552 | 2303 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2304 | `{` |
|      - | 2305 | `	struct implode_data imp_data;` |
|  33557 | 2306 | `	int i = 1;` |
|  33557 | 2307 | `	if( nArg < 1 ){` |
|      - | 2308 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2309 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2310 | `		return PH7_OK;` |
|      - | 2311 | `	}` |
|      - | 2312 | `	/* Prepare the implode context */` |
|  33557 | 2313 | `	imp_data.pCtx = pCtx;` |
|  33557 | 2314 | `	imp_data.bRecursive = 0;` |
|  33557 | 2315 | `	imp_data.bFirst = 1;` |
|  33557 | 2316 | `	imp_data.nRecCount = 0;` |
|  33557 | 2317 | `	imp_data.rc = SXRET_OK;` |
|  33557 | 2318 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33555 | 2319 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16780 | 2320 | `	}else{` |
|      3 | 2321 | `		imp_data.zSep = 0;` |
|      3 | 2322 | `		imp_data.nSeplen = 0;` |
|      3 | 2323 | `		i = 0;` |
|      - | 2324 | `	}` |
|  33557 | 2325 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2326 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2327 | `	}` |
|      - | 2328 | `	/* Start the 'join' process */` |
|  67109 | 2329 | `	while( i < nArg ){` |
|  33557 | 2330 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2331 | `			/* Iterate throw array entries */` |
|  33557 | 2332 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2333 | `			/* Surface a callback allocation failure as a fatal */` |
|  33557 | 2334 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2459 | ` */` |
|   6584 | 2460 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2461 | `{` |
...
|   6589 | 2474 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6589 | 2475 | `	if( nDelim < 1 ){` |
...
|   6585 | 2481 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6585 | 2482 | `	if( nStrlen < 1 ){` |
...
|   6579 | 2508 | `	zEnd = &zString[nStrlen];` |
|      - | 2509 | `	/* Create the array */` |
|   6579 | 2510 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6579 | 2511 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6579 | 2512 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2513 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2514 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2515 | `		return PH7_OK;` |
|      - | 2516 | `	}` |
|      - | 2517 | `	/* Set a defualt limit */` |
|   6579 | 2518 | `	iLimit = SXI32_HIGH;` |
|   6579 | 2519 | `	if( nArg > 2 ){` |
...
|  80554 | 2554 | `	for(;;){` |
| 161113 | 2555 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 161113 | 2556 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2557 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6563 | 2558 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6563 | 2559 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2560 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2561 | `			}` |
|   6563 | 2562 | `			break;` |
|      - | 2563 | `		}` |
|      - | 2564 | `		/* Point to the desired offset */` |
| 154555 | 2565 | `		zCur = &zString[nOfft];` |
|      - | 2566 | `		/* Perform the store operation (may be empty) */` |
| 154555 | 2567 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 154555 | 2568 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2569 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2570 | `		}` |
|      - | 2571 | `		/* Point beyond the delimiter */` |
| 154555 | 2572 | `		zString = &zCur[nDelim];` |
|      - | 2573 | `		/* Reset the cursor */` |
| 154555 | 2574 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2575 | `	}` |
|      - | 2576 | `	/* Return the freshly created array */` |
|   6563 | 2577 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2578 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2579 | `	 * released as soon we return from this foregin function.` |
|      - | 2580 | `	 */` |
|   6563 | 2581 | `	return PH7_OK;` |
|   3297 | 2582 | `}` |
|      - | 2583 | `/*` |
...
|      - | 2597 | ` */` |
|  14668 | 2598 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2599 | `{` |
|  14673 | 2600 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - | 2601 | `	const char *zString;` |
|      - | 2602 | `	int nLen;` |
|  14673 | 2603 | `	if( nArg < 1 ){` |
|      - | 2604 | `		/* Missing arguments,return null */` |
|    ! 0 | 2605 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2606 | `		return PH7_OK;` |
|      - | 2607 | `	}` |
|      - | 2608 | `	/* Extract the target string */` |
|  14673 | 2609 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14673 | 2610 | `	if( nLen < 1 ){` |
|      - | 2611 | `		/* Empty string,return */` |
|   1089 | 2612 | `		ph7_result_string(pCtx,"",0);` |
|   1089 | 2613 | `		return PH7_OK;` |
|      - | 2614 | `	}` |
|      - | 2615 | `	/* Start the trim process */` |
|  13589 | 2616 | `	if( nArg < 2 ){` |
|      - | 2617 | `		SyString sStr;` |
|      - | 2618 | `		/* Remove white spaces and NUL bytes */` |
|  13559 | 2619 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  34005 | 2620 | `		SyStringFullTrimSafe(&sStr);` |
|  13559 | 2621 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6782 | 2622 | `	}else{` |
|      - | 2623 | `		/* Char list */` |
...
|      3 | 2669 | `{` |
|     39 | 2670 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"rtrim",1,"$string"); }` |
...
|     39 | 2679 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     39 | 2680 | `	if( nLen < 1 ){` |
...
|      - | 2695 | `		int nListlen;` |
|     17 | 2696 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|     17 | 2697 | `		if( nListlen < 1 ){` |
|      - | 2698 | `			/* Return the string unchanged */` |
|    ! 0 | 2699 | `			ph7_result_string(pCtx,zString,nLen);` |
|    ! 0 | 2700 | `		}else{` |
|      - | 2701 | `			char aMask[256];` |
|     17 | 2702 | `			const char *zEnd = &zString[nLen];` |
|     17 | 2703 | `			const char *zCur = zString;` |
|     17 | 2704 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - | 2705 | `			/* Right trim */` |
|     37 | 2706 | `			while( zEnd > zCur && aMask[(unsigned char)zEnd[-1]] ){` |
|     22 | 2707 | `				zEnd--;` |
|      2 | 2708 | `			}` |
|     17 | 2709 | `			if( zEnd <= zCur ){` |
|      - | 2710 | `				/* Return the empty string */` |
|    ! 0 | 2711 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 | 2712 | `			}else{` |
|     17 | 2713 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - | 2714 | `			}` |
|      - | 2715 | `		}` |
|      - | 2716 | `	}` |
|     33 | 2717 | `	return PH7_OK;` |
|     21 | 2718 | `}` |
|      - | 2719 | `/*` |
...
|      - | 2733 | ` */` |
|     46 | 2734 | `static int PH7_builtin_ltrim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2735 | `{` |
|     51 | 2736 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"ltrim",1,"$string"); }` |
...
|     51 | 2745 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     51 | 2746 | `	if( nLen < 1 ){` |
...
|      - | 2761 | `		int nListlen;` |
|     23 | 2762 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|     23 | 2763 | `		if( nListlen < 1 ){` |
|      - | 2764 | `			/* Return the string unchanged */` |
|      3 | 2765 | `			ph7_result_string(pCtx,zString,nLen);` |
|      2 | 2766 | `		}else{` |
|      - | 2767 | `			char aMask[256];` |
|     21 | 2768 | `			const char *zEnd = &zString[nLen];` |
|     21 | 2769 | `			const char *zCur = zString;` |
|     21 | 2770 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - | 2771 | `			/* Left trim */` |
|     49 | 2772 | `			while( zCur < zEnd && aMask[(unsigned char)zCur[0]] ){` |
|     33 | 2773 | `				zCur++;` |
|      5 | 2774 | `			}` |
|     21 | 2775 | `			if( zCur >= zEnd ){` |
|      - | 2776 | `				/* Return the empty string */` |
|    ! 0 | 2777 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 | 2778 | `			}else{` |
|     21 | 2779 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - | 2780 | `			}` |
|      - | 2781 | `		}` |
|      - | 2782 | `	}` |
|     27 | 2783 | `	return PH7_OK;` |
|     28 | 2784 | `}` |
|      - | 2785 | `/*` |
...
|      - | 2793 | ` */` |
|  33524 | 2794 | `static int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2795 | `{` |
|  33529 | 2796 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - | 2797 | `	const char *zString,*zCur,*zEnd;` |
|      - | 2798 | `	int nLen;` |
|  33529 | 2799 | `	if( nArg < 1 ){` |
|      - | 2800 | `		/* Missing arguments,return null */` |
|    ! 0 | 2801 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2802 | `		return PH7_OK;` |
|      - | 2803 | `	}` |
|      - | 2804 | `	/* Extract the target string */` |
|  33529 | 2805 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33529 | 2806 | `	if( nLen < 1 ){` |
|      - | 2807 | `		/* Empty string,return */` |
|      5 | 2808 | `		ph7_result_string(pCtx,"",0);` |
|      5 | 2809 | `		return PH7_OK;` |
|      - | 2810 | `	}` |
|      - | 2811 | `	/* Perform the requested operation */` |
|  33525 | 2812 | `	zEnd = &zString[nLen];` |
| 105743 | 2813 | `	for(;;){` |
| 211491 | 2814 | `		if( zString >= zEnd ){` |
|      - | 2815 | `			/* No more input,break immediately */` |
|  33525 | 2816 | `			break;` |
|      - | 2817 | `		}` |
| 177971 | 2818 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2827 | `		}else{` |
| 177971 | 2828 | `			int c = zString[0];` |
| 177971 | 2829 | `			if( SyisUpper(c) ){` |
| 175415 | 2830 | `				c = SyToLower(zString[0]);` |
|  87705 | 2831 | `			}` |
|      - | 2832 | `			/* Append character */` |
| 177971 | 2833 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2834 | `			/* Advance the cursor */` |
| 177971 | 2835 | `			zString++;` |
|      - | 2836 | `		}` |
|      5 | 2837 | `	}` |
|  33525 | 2838 | `	return PH7_OK;` |
|  16767 | 2839 | `}` |
|      - | 2840 | `/*` |
...
|      - | 2848 | ` */` |
|     70 | 2849 | `static int PH7_builtin_strtoupper(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2850 | `{` |
|     75 | 2851 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtoupper",1,"$string"); }` |
...
|     75 | 2860 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     75 | 2861 | `	if( nLen < 1 ){` |
...
|     71 | 2867 | `	zEnd = &zString[nLen];` |
|    139 | 2868 | `	for(;;){` |
|    283 | 2869 | `		if( zString >= zEnd ){` |
|      - | 2870 | `			/* No more input,break immediately */` |
|     71 | 2871 | `			break;` |
|      - | 2872 | `		}` |
|    217 | 2873 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2882 | `		}else{` |
|    217 | 2883 | `			int c = zString[0];` |
|    217 | 2884 | `			if( SyisLower(c) ){` |
|    204 | 2885 | `				c = SyToUpper(zString[0]);` |
|    100 | 2886 | `			}` |
|      - | 2887 | `			/* Append character */` |
|    217 | 2888 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2889 | `			/* Advance the cursor */` |
|    217 | 2890 | `			zString++;` |
|      - | 2891 | `		}` |
|      5 | 2892 | `	}` |
|     71 | 2893 | `	return PH7_OK;` |
|     40 | 2894 | `}` |
|      - | 2895 | `/*` |
...
|      - | 3388 | ` */` |
|    744 | 3389 | `static sxi32 StrPredicateResolveArg(` |
...
|      - | 3399 | `	int *pnOut` |
|      4 | 3400 | `){` |
|    748 | 3401 | `	if( ph7_value_is_null(pArg) ){` |
|     13 | 3402 | `		PH7_VmThrowError(pCtx->pVm,0,E_DEPRECATED,zNullMsg);` |
|     13 | 3403 | `		*pzOut = "";` |
|     13 | 3404 | `		*pnOut = 0;` |
|     13 | 3405 | `		return PH7_OK;` |
|      - | 3406 | `	}` |
|   1124 | 3407 | `	if( ph7_value_is_array(pArg) \|\| ph7_value_is_resource(pArg) \|\|` |
|    706 | 3408 | `	    ( ph7_value_is_object(pArg) &&` |
...
|      - | 3425 | `			);` |
|      - | 3426 | `	}` |
|    686 | 3427 | `	if( ph7_value_is_object(pArg) ){` |
...
|      - | 3435 | `	}` |
|    638 | 3436 | `	*pzOut = ph7_value_to_string(pArg,pnOut);` |
|    638 | 3437 | `	return PH7_OK;` |
|    376 | 3438 | `}` |
|      - | 3439 | `/*` |
...
|      - | 3444 | ` */` |
|    108 | 3445 | `static int PH7_builtin_str_contains(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 | 3446 | `{` |
...
|      - | 3456 | `			);` |
|      - | 3457 | `	}` |
|    101 | 3458 | `	PH7_MemObjInit(pCtx->pVm,&sHayTmp);` |
|    101 | 3459 | `	PH7_MemObjInit(pCtx->pVm,&sNeedleTmp);` |
|    101 | 3460 | `	rc = StrPredicateResolveArg(pCtx,apArg[0],"str_contains",1,"$haystack","string",` |
|      - | 3461 | `		"str_contains(): Passing null to parameter #1 ($haystack) "` |
|      - | 3462 | `		"of type string is deprecated",` |
|      - | 3463 | `		&sHayTmp,&zHaystack,&nHayLen);` |
|    101 | 3464 | `	if( rc != PH7_OK ) goto out;` |
|     94 | 3465 | `	rc = StrPredicateResolveArg(pCtx,apArg[1],"str_contains",2,"$needle","string",` |
|      - | 3466 | `		"str_contains(): Passing null to parameter #2 ($needle) "` |
|      - | 3467 | `		"of type string is deprecated",` |
|      - | 3468 | `		&sNeedleTmp,&zNeedle,&nNeedleLen);` |
|     94 | 3469 | `	if( rc != PH7_OK ) goto out;` |
|     90 | 3470 | `	if( nNeedleLen < 1 ){` |
|     13 | 3471 | `		ph7_result_bool(pCtx,1);` |
|     84 | 3472 | `	}else if( nHayLen < nNeedleLen ){` |
|      9 | 3473 | `		ph7_result_bool(pCtx,0);` |
|      5 | 3474 | `	}else{` |
|    104 | 3475 | `		sxi32 srch = SyBlobSearch((const void *)zHaystack,(sxu32)nHayLen,` |
|     34 | 3476 | `		                          (const void *)zNeedle,(sxu32)nNeedleLen,0);` |
|     70 | 3477 | `		ph7_result_bool(pCtx,srch == SXRET_OK ? 1 : 0);` |
|      - | 3478 | `	}` |
|     90 | 3479 | `	rc = PH7_OK;` |
|     49 | 3480 | `out:` |
|    101 | 3481 | `	PH7_MemObjRelease(&sHayTmp);` |
|    101 | 3482 | `	PH7_MemObjRelease(&sNeedleTmp);` |
|    101 | 3483 | `	return rc;` |
|     58 | 3484 | `}` |
|      - | 3485 | `/*` |
...
|      - | 8056 | ` */` |
|     98 | 8057 | `static int StrReplaceWalker(ph7_value *pKey,ph7_value *pData,void *pUserData)` |
|      5 | 8058 | `{` |
|    103 | 8059 | `	str_replace_data *pRep = (str_replace_data *)pUserData;` |
|      - | 8060 | `	SyString sWorker;` |
|      - | 8061 | `	const char *zIn;` |
|      - | 8062 | `	int nByte;` |
|      - | 8063 | `	/* Extract a string representation of the given argument */` |
|    103 | 8064 | `	zIn = ph7_value_to_string(pData,&nByte);` |
|    103 | 8065 | `	SyStringInitFromBuf(&sWorker,0,0);` |
|    103 | 8066 | `	if( nByte > 0 ){` |
|      - | 8067 | `		char *zDup;` |
|      - | 8068 | `		/* Duplicate the chunk */` |
|    101 | 8069 | `		zDup = (char *)ph7_context_alloc_chunk(pRep->pCtx,(unsigned int)nByte,FALSE,` |
...
|      - | 8077 | `		}` |
|    101 | 8078 | `		SyMemcpy(zIn,zDup,(sxu32)nByte);` |
|      - | 8079 | `		/* Save the chunk */` |
|    101 | 8080 | `		SyStringInitFromBuf(&sWorker,zDup,nByte);` |
|     48 | 8081 | `	}` |
|      - | 8082 | `	/* Save for later processing */` |
|    103 | 8083 | `	SySetPut(pRep->pCollector,(const void *)&sWorker);` |
|      - | 8084 | `	/* All done */` |
|     49 | 8085 | `	SXUNUSED(pKey); /* cc warning */` |
|    103 | 8086 | `	return PH7_OK;` |
|     54 | 8087 | `}` |
|      - | 8088 | `/*` |
...
|      - | 8113 | ` */` |
|  29904 | 8114 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8115 | `{` |
...
|      - | 8124 | `	int nByte;` |
|      - | 8125 | `	sxi32 rc;` |
|  29909 | 8126 | `	if( nArg < 3 ){` |
|      - | 8127 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8128 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8129 | `		return PH7_OK;` |
|      - | 8130 | `	}` |
|      - | 8131 | `	/* Initialize fields */` |
|  29909 | 8132 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29909 | 8133 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29909 | 8134 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  29909 | 8135 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  29909 | 8136 | `	sRep.pCtx = pCtx;` |
|  29909 | 8137 | `	sRep.pCollector = &sSearch;` |
|  29909 | 8138 | `	rep_str = 0;` |
|      - | 8139 | `	/* Extract the subject */` |
|  29909 | 8140 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  29909 | 8141 | `	if( nByte < 1 ){` |
|      - | 8142 | `		/* Nothing to replace,return the empty string */` |
|     21 | 8143 | `		ph7_result_string(pCtx,"",0);` |
|     21 | 8144 | `		return PH7_OK;` |
|      - | 8145 | `	}` |
|      - | 8146 | `	/* Copy the subject */` |
|  29889 | 8147 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8148 | `	/* Search string */` |
|  29889 | 8149 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8150 | `		/* Collect search string */` |
|     49 | 8151 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     27 | 8152 | `	}else{` |
|      - | 8153 | `		/* Single pattern */` |
|  29845 | 8154 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29845 | 8155 | `		if( nByte < 1 ){` |
...
|      - | 8159 | `		}` |
|  29841 | 8160 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8161 | `		/* Save for later processing */` |
|  29841 | 8162 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8163 | `	}` |
|      - | 8164 | `	/* Replace string */` |
|  29885 | 8165 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8166 | `		/* Collect replace string */` |
|      7 | 8167 | `		sRep.pCollector = &sReplace;` |
|      7 | 8168 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8169 | `	}else{` |
|      - | 8170 | `		/* Single needle */` |
|  29879 | 8171 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  29879 | 8172 | `		rep_str = 1;` |
|  29879 | 8173 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8174 | `		/* Save for later processing */` |
|  29879 | 8175 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8176 | `	}` |
|      - | 8177 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  29885 | 8178 | `	if( sRep.rc != SXRET_OK ){` |
...
|  29885 | 8185 | `	SySetResetCursor(&sSearch);` |
|  29885 | 8186 | `	SySetResetCursor(&sReplace);` |
|  29885 | 8187 | `	pReplace = pSearch = 0; /* cc warning */` |
|  29885 | 8188 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8189 | `	/* Extract function name */` |
|  29885 | 8190 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8191 | `	/* Set the default pattern match routine */` |
|  29885 | 8192 | `	xMatch = SyBlobSearch;` |
|  29885 | 8193 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8194 | `		/* Case insensitive pattern match */` |
|     11 | 8195 | `		xMatch = iPatternMatch;` |
|      5 | 8196 | `	}` |
|      - | 8197 | `	/* Start the replace process */` |
|  59809 | 8198 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8199 | `		sxu32 nCount,nOfft;` |
|  29929 | 8200 | `		if( pSearch->nByte <  1 ){` |
|      - | 8201 | `			/* Empty string,ignore */` |
|      3 | 8202 | `			continue;` |
|      - | 8203 | `		}` |
|      - | 8204 | `		/* Extract the replace string */` |
|  29927 | 8205 | `		if( rep_str ){` |
|  29917 | 8206 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14961 | 8207 | `		}else{` |
...
|      1 | 8213 | `			}` |
|      - | 8214 | `		}` |
|  29927 | 8215 | `		if( pReplace == 0 ){` |
|      - | 8216 | `			/* Use an empty string instead */` |
|      3 | 8217 | `			pReplace = &sTemp;` |
|      1 | 8218 | `		}` |
|  29927 | 8219 | `		nOfft = nCount = 0;` |
|  14988 | 8220 | `		for(;;){` |
|  29981 | 8221 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8222 | `				break;` |
|      - | 8223 | `			}` |
|      - | 8224 | `			/* Perform a pattern lookup */` |
|  44951 | 8225 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  29964 | 8226 | `				pSearch->nByte,&nOfft);` |
|  29969 | 8227 | `			if( rc != SXRET_OK ){` |
...
|  29885 | 8245 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  29885 | 8246 | `	SySetRelease(&sSearch);` |
|  29885 | 8247 | `	SySetRelease(&sReplace);` |
|  29885 | 8248 | `	SyBlobRelease(&sWorker);` |
|  29885 | 8249 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8250 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8251 | `	}` |
|  29885 | 8252 | `	return PH7_OK;` |
|  14957 | 8253 | `}` |
|      - | 8254 | `/*` |
...
|      - | 8840 | ` */` |
|   1884 | 8841 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8842 | `{` |
...
|   1889 | 8851 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   1889 | 8852 | `	zEnd = &zIn[nLen];` |
|   1889 | 8853 | `	if( nLen < 1 ){` |
...
|   1745 | 8859 | `	for(;;){` |
|   3495 | 8860 | `		if( zIn >= zEnd ){` |
|      - | 8861 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1563 | 8862 | `			ph7_result_bool(pCtx,1);` |
|   1563 | 8863 | `			return PH7_OK;` |
|      - | 8864 | `		}` |
|   1937 | 8865 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 8866 | `			/* UTF-8 stream  */` |
|    ! 0 | 8867 | `			break;` |
|      - | 8868 | `		}` |
|   1937 | 8869 | `		if( !SyisDigit(zIn[0]) ){` |
|    329 | 8870 | `			break;` |
|      - | 8871 | `		}` |
...
|    329 | 8876 | `	ph7_result_bool(pCtx,0);` |
|    329 | 8877 | `	return PH7_OK;` |
|    947 | 8878 | `}` |
|      - | 8879 | `/*` |
...
|      - | 9082 | ` */` |
|  63647 | 9083 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 9084 | `{` |
|      - | 9085 | `	const unsigned char *zIn,*zEnd;` |
|      - | 9086 | `	int nLen;` |
|  63652 | 9087 | `	if( nArg < 1 ){` |
|      - | 9088 | `		/* Missing arguments,return FALSE */` |
|    ! 0 | 9089 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 9090 | `		return PH7_OK;` |
|      - | 9091 | `	}` |
|      - | 9092 | `	/* Extract the target string */` |
|  63652 | 9093 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  63652 | 9094 | `	zEnd = &zIn[nLen];` |
|  63652 | 9095 | `	if( nLen < 1 ){` |
...
|  32948 | 9101 | `	for(;;){` |
|  65816 | 9102 | `		if( zIn >= zEnd ){` |
|      - | 9103 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   2147 | 9104 | `			ph7_result_bool(pCtx,1);` |
|   2147 | 9105 | `			return PH7_OK;` |
|      - | 9106 | `		}` |
|  63674 | 9107 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 9108 | `			/* UTF-8 stream  */` |
|    ! 0 | 9109 | `			break;` |
|      - | 9110 | `		}` |
|  63674 | 9111 | `		if( !SyisSpace(zIn[0]) ){` |
|  61508 | 9112 | `			break;` |
|      - | 9113 | `		}` |
...
|  61508 | 9118 | `	ph7_result_bool(pCtx,0);` |
|  61508 | 9119 | `	return PH7_OK;` |
|  31871 | 9120 | `}` |
|      - | 9121 | `/*` |
...
|      - | 9446 | `	{ "mb_strtolower",PH7_builtin_mb_case_f }, /* UTF-8 only (builtin_mb.c) */` |
|      - | 9447 | `	{ "strtoupper",   PH7_builtin_strtoupper },` |
|      - | 9448 | `	{ "mb_strtoupper",PH7_builtin_mb_case_f }, /* UTF-8 only (builtin_mb.c) */` |
|      - | 9449 | `	{ "mb_strlen",    PH7_builtin_mb_strlen_f },` |
|      - | 9450 | `	{ "mb_substr",    PH7_builtin_mb_substr_f },` |
|      - | 9451 | `	{ "mb_convert_case", PH7_builtin_mb_convert_case_f },` |
|      - | 9452 | `	{ "mb_strpos",    PH7_builtin_mb_strpos_f },` |
|      - | 9453 | `	{ "mb_stripos",   PH7_builtin_mb_strpos_f },` |
|      - | 9454 | `	{ "mb_strrpos",   PH7_builtin_mb_strpos_f },` |
|      - | 9455 | `	{ "mb_str_split", PH7_builtin_mb_str_split_f },` |
|      - | 9456 | `	{ "mb_internal_encoding", PH7_builtin_mb_internal_encoding_f },` |
|      - | 9457 | `	{ "mb_check_encoding",    PH7_builtin_mb_check_encoding_f },` |
|      - | 9458 | `	{ "mb_strwidth",  PH7_builtin_mb_strwidth_f },` |
|      - | 9459 | `	{ "ucfirst",      PH7_builtin_ucfirst    },` |
|      - | 9460 | `	{ "lcfirst",      PH7_builtin_lcfirst    },` |
|      - | 9461 | `	{ "ord",          PH7_builtin_ord        },` |
|      - | 9462 | `	{ "chr",          PH7_builtin_chr        },` |
|      - | 9463 | `	{ "bin2hex",      PH7_builtin_bin2hex    },` |
|      - | 9464 | `	{ "strstr",       PH7_builtin_strstr     },` |
|      - | 9465 | `	{ "stristr",      PH7_builtin_stristr    },` |
|      - | 9466 | `	{ "strchr",       PH7_builtin_strstr     },` |
|      - | 9467 | `	{ "strpos",       PH7_builtin_strpos     },` |
|      - | 9468 | `	{ "stripos",      PH7_builtin_stripos    },` |
|      - | 9469 | `	{ "strrpos",      PH7_builtin_strrpos    },` |
|      - | 9470 | `	{ "strripos",     PH7_builtin_strripos   },` |
|      - | 9471 | `	{ "strrchr",      PH7_builtin_strrchr    },` |
|      - | 9472 | `	{ "strrev",       PH7_builtin_strrev     },` |
|      - | 9473 | `	{ "ucwords",      PH7_builtin_ucwords    },` |
|      - | 9474 | `	{ "str_repeat",   PH7_builtin_str_repeat },` |
|      - | 9475 | `	{ "str_contains", PH7_builtin_str_contains },` |
|      - | 9476 | `	{ "str_starts_with", PH7_builtin_str_starts_with },` |
|      - | 9477 | `	{ "str_ends_with", PH7_builtin_str_ends_with },` |
|      - | 9478 | `	{ "nl2br",        PH7_builtin_nl2br      },` |
|      - | 9479 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9480 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9481 | `	{ "sprintf",      PH7_builtin_sprintf    },` |
|      - | 9482 | `	{ "printf",       PH7_builtin_printf     },` |
|      - | 9483 | `	{ "vprintf",      PH7_builtin_vprintf    },` |
|      - | 9484 | `	{ "vsprintf",     PH7_builtin_vsprintf   },` |
|      - | 9485 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9486 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9487 | `	{ "size_format",  PH7_builtin_size_format},` |
|      - | 9488 |  |
|      - | 9489 |  |
|      - | 9490 | `#ifndef PH7_DISABLE_HASH_FUNC` |
|      - | 9491 | `	{ "md5",          PH7_builtin_md5       },` |
|      - | 9492 | `	{ "sha1",         PH7_builtin_sha1      },` |
|      - | 9493 | `	{ "crc32",        PH7_builtin_crc32     },` |
|      - | 9494 | `	{ "hash",         PH7_builtin_hash      },` |
|      - | 9495 | `	{ "hash_hmac",    PH7_builtin_hash_hmac },` |
|      - | 9496 | `	{ "hash_equals",  PH7_builtin_hash_equals },` |
|      - | 9497 | `	{ "hash_algos",   PH7_builtin_hash_algos },` |
|      - | 9498 | `#endif /* PH7_DISABLE_HASH_FUNC */` |
|      - | 9499 | `	{ "password_hash",         PH7_builtin_password_hash },` |
|      - | 9500 | `	{ "password_verify",       PH7_builtin_password_verify },` |
|      - | 9501 | `	{ "password_get_info",     PH7_builtin_password_get_info },` |
|      - | 9502 | `	{ "password_needs_rehash", PH7_builtin_password_needs_rehash },` |
|      - | 9503 | `	{ "filter_var",            PH7_builtin_filter_var },` |
|      - | 9504 | `	{ "filter_input",          PH7_builtin_filter_input },` |
|      - | 9505 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9506 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9507 | `	{ "str_getcsv",   PH7_builtin_str_getcsv },` |
|      - | 9508 | `	{ "strip_tags",   PH7_builtin_strip_tags },` |
|      - | 9509 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9510 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9511 |  |
|      - | 9512 | `	{ "str_shuffle",  PH7_builtin_str_shuffle},` |
|      - | 9513 | `	{ "str_split",    PH7_builtin_str_split  },` |
|      - | 9514 | `	{ "strspn",       PH7_builtin_strspn     },` |
|      - | 9515 | `	{ "strcspn",      PH7_builtin_strcspn    },` |
|      - | 9516 | `	{ "strpbrk",      PH7_builtin_strpbrk    },` |
|      - | 9517 | `	{ "soundex",      PH7_builtin_soundex    },` |
|      - | 9518 | `	{ "wordwrap",     PH7_builtin_wordwrap   },` |
|      - | 9519 | `	{ "strtok",       PH7_builtin_strtok     },` |
|      - | 9520 | `	{ "str_pad",      PH7_builtin_str_pad    },` |
|      - | 9521 | `	{ "str_replace",  PH7_builtin_str_replace},` |
|      - | 9522 | `	{ "str_ireplace", PH7_builtin_str_replace},` |
|      - | 9523 | `	{ "strtr",        PH7_builtin_strtr      },` |
|      - | 9524 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9525 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9526 | `	{ "parse_ini_string", PH7_builtin_parse_ini_string},` |
|      - | 9527 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9528 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9529 |  |
|      - | 9530 | `	         /* Ctype functions */` |
|      - | 9531 | `	{ "ctype_alnum", PH7_builtin_ctype_alnum },` |
|      - | 9532 | `	{ "ctype_alpha", PH7_builtin_ctype_alpha },` |
|      - | 9533 | `	{ "ctype_cntrl", PH7_builtin_ctype_cntrl },` |
|      - | 9534 | `	{ "ctype_digit", PH7_builtin_ctype_digit },` |
|      - | 9535 | `	{ "ctype_xdigit",PH7_builtin_ctype_xdigit},` |
|      - | 9536 | `	{ "ctype_graph", PH7_builtin_ctype_graph },` |
|      - | 9537 | `	{ "ctype_print", PH7_builtin_ctype_print },` |
|      - | 9538 | `	{ "ctype_punct", PH7_builtin_ctype_punct },` |
|      - | 9539 | `	{ "ctype_space", PH7_builtin_ctype_space },` |
|      - | 9540 | `	{ "ctype_lower", PH7_builtin_ctype_lower },` |
|      - | 9541 | `	{ "ctype_upper", PH7_builtin_ctype_upper },` |
|      - | 9542 | `	         /* Time functions */` |
|      - | 9543 | `	{ "time"    ,    PH7_builtin_time         },` |
|      - | 9544 | `	{ "microtime",   PH7_builtin_microtime    },` |
|      - | 9545 | `	{ "getdate" ,    PH7_builtin_getdate      },` |
|      - | 9546 | `	{ "gettimeofday",PH7_builtin_gettimeofday },` |
|      - | 9547 | `	{ "date",        PH7_builtin_date         },` |
|      - | 9548 | `	{ "strftime",    PH7_builtin_strftime     },` |
|      - | 9549 | `	{ "idate",       PH7_builtin_idate        },` |
|      - | 9550 | `	{ "gmdate",      PH7_builtin_gmdate       },` |
|      - | 9551 | `	{ "localtime",   PH7_builtin_localtime    },` |
|      - | 9552 | `	{ "mktime",      PH7_builtin_mktime       },` |
|      - | 9553 | `	{ "gmmktime",    PH7_builtin_mktime       },` |
|      - | 9554 | `	{ "date_default_timezone_get", PH7_builtin_date_default_timezone_get },` |
|      - | 9555 | `	{ "date_default_timezone_set", PH7_builtin_date_default_timezone_set },` |
|      - | 9556 | `	        /* URL functions */` |
|      - | 9557 | `	{ "base64_encode",PH7_builtin_base64_encode },` |
|      - | 9558 | `	{ "base64_decode",PH7_builtin_base64_decode },` |
|      - | 9559 | `	{ "convert_uuencode",PH7_builtin_base64_encode },` |
|      - | 9560 | `	{ "convert_uudecode",PH7_builtin_base64_decode },` |
|      - | 9561 | `	{ "urlencode",    PH7_builtin_urlencode },` |
|      - | 9562 | `	{ "urldecode",    PH7_builtin_urldecode },` |
|      - | 9563 | `	{ "rawurlencode", PH7_builtin_urlencode },` |
|      - | 9564 | `	{ "rawurldecode", PH7_builtin_urldecode },` |
|      - | 9565 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9566 | `};` |
|      - | 9567 | `/*` |
|      - | 9568 | ` * Register the built-in functions defined above,the array functions` |
|      - | 9569 | ` * defined in hashmap.c and the IO functions defined in vfs.c.` |
|      - | 9570 | ` */` |
|   3558 | 9571 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 9572 | `{` |
|      - | 9573 | `	sxu32 n;` |
| 661793 | 9574 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 658235 | 9575 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 329120 | 9576 | `	}` |
|      - | 9577 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3563 | 9578 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 9579 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3563 | 9580 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3563 | 9581 | `}` |
|      - | 9582 |  |
