...
| 493637 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 493642 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 493642 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 493628 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 493612 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 493612 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 493612 |  121 | `	return PH7_OK;` |
| 246925 |  122 | `}` |
|      - |  123 |  |
...
|      - |  420 | ` */` |
|  39622 |  421 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  422 | `{` |
|  39627 |  423 | `	int res = 1; /* Assume empty by default */` |
|  39627 |  424 | `	if( nArg > 0 ){` |
|  39625 |  425 | `		res = ph7_value_is_empty(apArg[0]);` |
|  19810 |  426 | `	}` |
|  39627 |  427 | `	ph7_result_bool(pCtx,res);` |
|  39627 |  428 | `	return PH7_OK;` |
|      - |  429 |  |
|      5 |  430 | `}` |
