...
| 494999 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 495004 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 495004 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 494990 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 494974 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 494974 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 494974 |  121 | `	return PH7_OK;` |
| 247607 |  122 | `}` |
|      - |  123 |  |
...
|      - |  420 | ` */` |
|  39684 |  421 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  422 | `{` |
|  39689 |  423 | `	int res = 1; /* Assume empty by default */` |
|  39689 |  424 | `	if( nArg > 0 ){` |
|  39687 |  425 | `		res = ph7_value_is_empty(apArg[0]);` |
|  19841 |  426 | `	}` |
|  39689 |  427 | `	ph7_result_bool(pCtx,res);` |
|  39689 |  428 | `	return PH7_OK;` |
|      - |  429 |  |
|      5 |  430 | `}` |
...
|      - |  792 | ` */` |
|   3424 |  793 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 |  794 | `{` |
|      - |  795 | `	sxu32 n;` |
| 705349 |  796 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 701925 |  797 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 350965 |  798 | `	}` |
|      - |  799 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3429 |  800 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - |  801 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3429 |  802 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3429 |  803 | `}` |
|      - |  804 |  |
|      - |  805 | `/*` |
