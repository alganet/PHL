...
| 489752 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 489757 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|    ! 0 |   33 | `		return PH7_OK;` |
|      - |   34 | `	}` |
| 489757 |   35 | `	if( ph7_value_is_float(pArg) ){` |
...
|      3 |   54 | `		return PH7_OK;` |
|      - |   55 | `	}` |
| 489751 |   56 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   57 | `		const char *zNum;` |
|      - |   58 | `		int nSlen;` |
...
|      5 |   96 | `		return PH7_OK;` |
|      - |   97 | `	}` |
| 489737 |   98 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  111 | `			);` |
|      - |  112 | `	}` |
| 489737 |  113 | `	*pOut = ph7_value_to_int64(pArg);` |
| 489737 |  114 | `	return PH7_OK;` |
| 244881 |  115 | `}` |
|      - |  116 |  |
...
|      3 |  179 | `{` |
|    927 |  180 | `	int res = 0; /* Assume false by default */` |
|    927 |  181 | `	if( nArg > 0 ){` |
...
|    927 |  185 | `		res = ph7_value_is_int(apArg[0]) && !ph7_value_is_float(apArg[0]);` |
|    462 |  186 | `	}` |
|      - |  187 | `	/* Query result */` |
|    927 |  188 | `	ph7_result_bool(pCtx,res);` |
|    927 |  189 | `	return PH7_OK;` |
|      3 |  190 | `}` |
|      - |  191 | `/*` |
...
|      3 |  200 | `{` |
|   1117 |  201 | `	int res = 0; /* Assume false by default */` |
|   1117 |  202 | `	if( nArg > 0 ){` |
|   1117 |  203 | `		res = ph7_value_is_string(apArg[0]);` |
|    557 |  204 | `	}` |
|      - |  205 | `	/* Query result */` |
|   1117 |  206 | `	ph7_result_bool(pCtx,res);` |
|   1117 |  207 | `	return PH7_OK;` |
|      3 |  208 | `}` |
|      - |  209 | `/*` |
...
|      - |  410 | ` */` |
|  40588 |  411 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  412 | `{` |
|  40593 |  413 | `	int res = 1; /* Assume empty by default */` |
|  40593 |  414 | `	if( nArg > 0 ){` |
|  40591 |  415 | `		res = ph7_value_is_empty(apArg[0]);` |
|  20293 |  416 | `	}` |
|  40593 |  417 | `	ph7_result_bool(pCtx,res);` |
|  40593 |  418 | `	return PH7_OK;` |
|      - |  419 |  |
|      5 |  420 | `}` |
...
|      - |  460 | ` */` |
| 270052 |  461 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  462 | `{` |
|      - |  463 | `	const char *zSource;` |
|      - |  464 | `	int nSrcLen;` |
|      - |  465 | `	sxi64 iStart,iEnd;` |
| 270057 |  466 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 270057 |  467 | `	if( nArg < 2 ){` |
...
| 270057 |  473 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |  474 | `	/* Extract the offset */` |
|      - |  475 | `	{` |
| 270057 |  476 | `		sxi64 iTmp = 0;` |
| 270057 |  477 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 270057 |  478 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  479 | `			return rcArg;` |
|      - |  480 | `		}` |
| 270057 |  481 | `		iStart = iTmp;` |
|      - |  482 | `	}` |
|      - |  483 | `	/*` |
...
|      - |  492 | `	 */` |
| 270057 |  493 | `	if( iStart < 0 ){` |
|  33675 |  494 | `		iStart += nSrcLen;` |
|  33675 |  495 | `		if( iStart < 0 ){` |
|      5 |  496 | `			iStart = 0;` |
|      7 |  497 | `		}` |
| 253222 |  498 | `	}else if( iStart > nSrcLen ){` |
|      7 |  499 | `		iStart = nSrcLen;` |
|      3 |  500 | `	}` |
| 270057 |  501 | `	iEnd = nSrcLen;` |
| 270057 |  502 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 198665 |  503 | `		sxi64 iLen = 0;` |
| 198665 |  504 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 198665 |  505 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  506 | `			return rcArg;` |
|      - |  507 | `		}` |
| 198665 |  508 | `		if( iLen < 0 ){` |
|  33307 |  509 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 182014 |  510 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  19035 |  511 | `			iEnd = nSrcLen;` |
|   9520 |  512 | `		}else{` |
| 146333 |  513 | `			iEnd = iStart + iLen;` |
|      - |  514 | `		}` |
|  99330 |  515 | `	}` |
| 270057 |  516 | `	if( iEnd < iStart ){` |
|      3 |  517 | `		iEnd = iStart;` |
|      1 |  518 | `	}` |
| 270057 |  519 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 270057 |  520 | `	return PH7_OK;` |
| 135031 |  521 | `}` |
|      - |  522 | `/*` |
...
|      - |  715 | ` */` |
| 397668 |  716 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  717 | `{` |
| 397673 |  718 | `	if( ph7_value_is_null(pArg) ){` |
...
|      5 | 1581 | `{` |
|    241 | 1582 | `	const unsigned char *zIn  = (const unsigned char *)zList;` |
|    241 | 1583 | `	const unsigned char *zEnd = zIn + (nLen > 0 ? nLen : 0);` |
|    241 | 1584 | `	SyZero(aMask,256);` |
|    639 | 1585 | `	for( ; zIn < zEnd ; zIn++ ){` |
|    403 | 1586 | `		int c = zIn[0];` |
|    403 | 1587 | `		if( zIn + 3 < zEnd && zIn[1] == '.' && zIn[2] == '.' && zIn[3] >= c ){` |
...
|    402 | 1594 | `		}else if( zIn + 1 < zEnd && zIn[0] == '.' && zIn[1] == '.' ){` |
...
|      - | 2263 | ` */` |
| 155722 | 2264 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2265 | `{` |
|  77861 | 2266 | `	SXUNUSED(pKey);` |
| 155727 | 2267 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2268 | `	const char *zData;` |
|      - | 2269 | `	int nLen;` |
| 155727 | 2270 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 155725 | 2294 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2295 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 155725 | 2296 | `	if( pData->bFirst ){` |
|  33881 | 2297 | `		pData->bFirst = 0;` |
| 138787 | 2298 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2299 | `		/* append the separator first */` |
| 121769 | 2300 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 155725 | 2306 | `	if( nLen > 0 ){` |
| 142951 | 2307 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2308 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2309 | `			return PH7_ABORT;` |
|      - | 2310 | `		}` |
|  71473 | 2311 | `	}` |
| 155725 | 2312 | `	return PH7_OK;` |
|  77866 | 2313 | `}` |
|      - | 2314 | `/*` |
...
|      - | 2326 | ` */` |
|  33904 | 2327 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2328 | `{` |
|      - | 2329 | `	struct implode_data imp_data;` |
|  33909 | 2330 | `	int i = 1;` |
|  33909 | 2331 | `	if( nArg < 1 ){` |
|      - | 2332 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2333 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2334 | `		return PH7_OK;` |
|      - | 2335 | `	}` |
|      - | 2336 | `	/* Prepare the implode context */` |
|  33909 | 2337 | `	imp_data.pCtx = pCtx;` |
|  33909 | 2338 | `	imp_data.bRecursive = 0;` |
|  33909 | 2339 | `	imp_data.bFirst = 1;` |
|  33909 | 2340 | `	imp_data.nRecCount = 0;` |
|  33909 | 2341 | `	imp_data.rc = SXRET_OK;` |
|  33909 | 2342 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33907 | 2343 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  33907 | 2344 | `		if( nArg > 1 && !ph7_value_is_array(apArg[1]) && !ph7_value_is_null(apArg[1]) ){` |
...
|      3 | 2355 | `		i = 0;` |
|      - | 2356 | `	}` |
|  33907 | 2357 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2358 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2359 | `	}` |
|      - | 2360 | `	/* Start the 'join' process */` |
|  67809 | 2361 | `	while( i < nArg ){` |
|  33907 | 2362 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2363 | `			/* Iterate throw array entries */` |
|  33907 | 2364 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2365 | `			/* Surface a callback allocation failure as a fatal */` |
|  33907 | 2366 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2491 | ` */` |
|   6924 | 2492 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2493 | `{` |
...
|   6929 | 2506 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6929 | 2507 | `	if( nDelim < 1 ){` |
...
|   6925 | 2513 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6925 | 2514 | `	if( nStrlen < 1 ){` |
...
|   6913 | 2540 | `	zEnd = &zString[nStrlen];` |
|      - | 2541 | `	/* Create the array */` |
|   6913 | 2542 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6913 | 2543 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6913 | 2544 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2545 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2546 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2547 | `		return PH7_OK;` |
|      - | 2548 | `	}` |
|      - | 2549 | `	/* Set a defualt limit */` |
|   6913 | 2550 | `	iLimit = SXI32_HIGH;` |
|   6913 | 2551 | `	if( nArg > 2 ){` |
...
|  82878 | 2586 | `	for(;;){` |
| 165761 | 2587 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 165761 | 2588 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2589 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6897 | 2590 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6897 | 2591 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2592 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2593 | `			}` |
|   6897 | 2594 | `			break;` |
|      - | 2595 | `		}` |
|      - | 2596 | `		/* Point to the desired offset */` |
| 158869 | 2597 | `		zCur = &zString[nOfft];` |
|      - | 2598 | `		/* Perform the store operation (may be empty) */` |
| 158869 | 2599 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 158869 | 2600 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2601 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2602 | `		}` |
|      - | 2603 | `		/* Point beyond the delimiter */` |
| 158869 | 2604 | `		zString = &zCur[nDelim];` |
|      - | 2605 | `		/* Reset the cursor */` |
| 158869 | 2606 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2607 | `	}` |
|      - | 2608 | `	/* Return the freshly created array */` |
|   6897 | 2609 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2610 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2611 | `	 * released as soon we return from this foregin function.` |
|      - | 2612 | `	 */` |
|   6897 | 2613 | `	return PH7_OK;` |
|   3467 | 2614 | `}` |
|      - | 2615 | `/*` |
...
|      - | 2629 | ` */` |
|  14604 | 2630 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2631 | `{` |
|  14609 | 2632 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - | 2633 | `	const char *zString;` |
|      - | 2634 | `	int nLen;` |
|  14609 | 2635 | `	if( nArg < 1 ){` |
|      - | 2636 | `		/* Missing arguments,return null */` |
|    ! 0 | 2637 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2638 | `		return PH7_OK;` |
|      - | 2639 | `	}` |
|      - | 2640 | `	/* Extract the target string */` |
|  14609 | 2641 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14609 | 2642 | `	if( nLen < 1 ){` |
|      - | 2643 | `		/* Empty string,return */` |
|    753 | 2644 | `		ph7_result_string(pCtx,"",0);` |
|    753 | 2645 | `		return PH7_OK;` |
|      - | 2646 | `	}` |
|      - | 2647 | `	/* Start the trim process */` |
|  13861 | 2648 | `	if( nArg < 2 ){` |
|      - | 2649 | `		SyString sStr;` |
|      - | 2650 | `		/* Remove white spaces and NUL bytes */` |
|  13831 | 2651 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  34705 | 2652 | `		SyStringFullTrimSafe(&sStr);` |
|  13831 | 2653 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6918 | 2654 | `	}else{` |
|      - | 2655 | `		/* Char list */` |
...
|      4 | 2701 | `{` |
|    172 | 2702 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"rtrim",1,"$string"); }` |
...
|    172 | 2711 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|    172 | 2712 | `	if( nLen < 1 ){` |
...
|      - | 2727 | `		int nListlen;` |
|    148 | 2728 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|    148 | 2729 | `		if( nListlen < 1 ){` |
|      - | 2730 | `			/* Return the string unchanged */` |
|    ! 0 | 2731 | `			ph7_result_string(pCtx,zString,nLen);` |
|    ! 0 | 2732 | `		}else{` |
|      - | 2733 | `			char aMask[256];` |
|    148 | 2734 | `			const char *zEnd = &zString[nLen];` |
|    148 | 2735 | `			const char *zCur = zString;` |
|    148 | 2736 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - | 2737 | `			/* Right trim */` |
|    166 | 2738 | `			while( zEnd > zCur && aMask[(unsigned char)zEnd[-1]] ){` |
|     21 | 2739 | `				zEnd--;` |
|      3 | 2740 | `			}` |
|    148 | 2741 | `			if( zEnd <= zCur ){` |
|      - | 2742 | `				/* Return the empty string */` |
|    ! 0 | 2743 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 | 2744 | `			}else{` |
|    148 | 2745 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - | 2746 | `			}` |
|      - | 2747 | `		}` |
|      - | 2748 | `	}` |
|    166 | 2749 | `	return PH7_OK;` |
|     88 | 2750 | `}` |
|      - | 2751 | `/*` |
...
|      - | 2825 | ` */` |
|  33808 | 2826 | `static int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2827 | `{` |
|  33813 | 2828 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - | 2829 | `	const char *zString,*zCur,*zEnd;` |
|      - | 2830 | `	int nLen;` |
|  33813 | 2831 | `	if( nArg < 1 ){` |
|      - | 2832 | `		/* Missing arguments,return null */` |
|    ! 0 | 2833 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2834 | `		return PH7_OK;` |
|      - | 2835 | `	}` |
|      - | 2836 | `	/* Extract the target string */` |
|  33813 | 2837 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33813 | 2838 | `	if( nLen < 1 ){` |
|      - | 2839 | `		/* Empty string,return */` |
|      5 | 2840 | `		ph7_result_string(pCtx,"",0);` |
|      5 | 2841 | `		return PH7_OK;` |
|      - | 2842 | `	}` |
|      - | 2843 | `	/* Perform the requested operation */` |
|  33809 | 2844 | `	zEnd = &zString[nLen];` |
| 106667 | 2845 | `	for(;;){` |
| 213339 | 2846 | `		if( zString >= zEnd ){` |
|      - | 2847 | `			/* No more input,break immediately */` |
|  33809 | 2848 | `			break;` |
|      - | 2849 | `		}` |
| 179535 | 2850 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2859 | `		}else{` |
| 179535 | 2860 | `			int c = zString[0];` |
| 179535 | 2861 | `			if( SyisUpper(c) ){` |
| 176651 | 2862 | `				c = SyToLower(zString[0]);` |
|  88323 | 2863 | `			}` |
|      - | 2864 | `			/* Append character */` |
| 179535 | 2865 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2866 | `			/* Advance the cursor */` |
| 179535 | 2867 | `			zString++;` |
|      - | 2868 | `		}` |
|      5 | 2869 | `	}` |
|  33809 | 2870 | `	return PH7_OK;` |
|  16909 | 2871 | `}` |
|      - | 2872 | `/*` |
...
|      - | 8282 | ` */` |
|  30296 | 8283 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8284 | `{` |
...
|      - | 8293 | `	int nByte;` |
|      - | 8294 | `	sxi32 rc;` |
|  30301 | 8295 | `	if( nArg < 3 ){` |
|      - | 8296 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8297 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8298 | `		return PH7_OK;` |
|      - | 8299 | `	}` |
|      - | 8300 | `	/* Initialize fields */` |
|  30301 | 8301 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30301 | 8302 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30301 | 8303 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  30301 | 8304 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  30301 | 8305 | `	sRep.pCtx = pCtx;` |
|  30301 | 8306 | `	sRep.pCollector = &sSearch;` |
|  30301 | 8307 | `	rep_str = 0;` |
|      - | 8308 | `	/* Extract the subject */` |
|  30301 | 8309 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  30301 | 8310 | `	if( nByte < 1 ){` |
...
|  30281 | 8316 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8317 | `	/* Search string */` |
|  30281 | 8318 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8319 | `		/* Collect search string */` |
|     81 | 8320 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     43 | 8321 | `	}else{` |
|      - | 8322 | `		/* Single pattern */` |
|  30205 | 8323 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  30205 | 8324 | `		if( nByte < 1 ){` |
...
|      - | 8328 | `		}` |
|  30201 | 8329 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8330 | `		/* Save for later processing */` |
|  30201 | 8331 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8332 | `	}` |
|      - | 8333 | `	/* Replace string */` |
|  30277 | 8334 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8335 | `		/* Collect replace string */` |
|      7 | 8336 | `		sRep.pCollector = &sReplace;` |
|      7 | 8337 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8338 | `	}else{` |
|      - | 8339 | `		/* Single needle */` |
|  30271 | 8340 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  30271 | 8341 | `		rep_str = 1;` |
|  30271 | 8342 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8343 | `		/* Save for later processing */` |
|  30271 | 8344 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8345 | `	}` |
|      - | 8346 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  30277 | 8347 | `	if( sRep.rc != SXRET_OK ){` |
...
|  30277 | 8354 | `	SySetResetCursor(&sSearch);` |
|  30277 | 8355 | `	SySetResetCursor(&sReplace);` |
|  30277 | 8356 | `	pReplace = pSearch = 0; /* cc warning */` |
|  30277 | 8357 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8358 | `	/* Extract function name */` |
|  30277 | 8359 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8360 | `	/* Set the default pattern match routine */` |
|  30277 | 8361 | `	xMatch = SyBlobSearch;` |
|  30277 | 8362 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8363 | `		/* Case insensitive pattern match */` |
|     11 | 8364 | `		xMatch = iPatternMatch;` |
|      5 | 8365 | `	}` |
|      - | 8366 | `	/* Start the replace process */` |
|  60625 | 8367 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8368 | `		sxu32 nCount,nOfft;` |
|  30353 | 8369 | `		if( pSearch->nByte <  1 ){` |
|      - | 8370 | `			/* Empty string,ignore */` |
|      3 | 8371 | `			continue;` |
|      - | 8372 | `		}` |
|      - | 8373 | `		/* Extract the replace string */` |
|  30351 | 8374 | `		if( rep_str ){` |
|  30341 | 8375 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  15173 | 8376 | `		}else{` |
...
|      1 | 8382 | `			}` |
|      - | 8383 | `		}` |
|  30351 | 8384 | `		if( pReplace == 0 ){` |
|      - | 8385 | `			/* Use an empty string instead */` |
|      3 | 8386 | `			pReplace = &sTemp;` |
|      1 | 8387 | `		}` |
|  30351 | 8388 | `		nOfft = nCount = 0;` |
|  15199 | 8389 | `		for(;;){` |
|  30403 | 8390 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8391 | `				break;` |
|      - | 8392 | `			}` |
|      - | 8393 | `			/* Perform a pattern lookup */` |
|  45584 | 8394 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30386 | 8395 | `				pSearch->nByte,&nOfft);` |
|  30391 | 8396 | `			if( rc != SXRET_OK ){` |
...
|  30277 | 8414 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  30277 | 8415 | `	SySetRelease(&sSearch);` |
|  30277 | 8416 | `	SySetRelease(&sReplace);` |
|  30277 | 8417 | `	SyBlobRelease(&sWorker);` |
|  30277 | 8418 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8419 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8420 | `	}` |
|  30277 | 8421 | `	return PH7_OK;` |
|  15153 | 8422 | `}` |
|      - | 8423 | `/*` |
...
|      - | 9892 | ` */` |
|   3364 | 9893 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 9894 | `{` |
|      - | 9895 | `	sxu32 n;` |
| 692989 | 9896 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 689625 | 9897 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 344815 | 9898 | `	}` |
|      - | 9899 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3369 | 9900 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 9901 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3369 | 9902 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3369 | 9903 | `}` |
|      - | 9904 |  |
