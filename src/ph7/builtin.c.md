...
|      - |  294 | ` */` |
|  27024 |  295 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  296 |  |
|  27029 |  297 | `	int res = 1; /* Assume empty by default */` |
|  27029 |  298 | `	if( nArg > 0 ){` |
|  27027 |  299 | `		res = ph7_value_is_empty(apArg[0]);` |
|  13511 |  300 | `	}` |
|  27029 |  301 | `	ph7_result_bool(pCtx,res);` |
|  27029 |  302 | `	return PH7_OK;` |
|      - |  303 |  |
|      5 |  304 |  |
...
|      - |  344 | ` */` |
| 202204 |  345 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  346 |  |
|      - |  347 | `	const char *zSource,*zOfft;` |
|      - |  348 | `	int nOfft,nLen,nSrcLen;` |
| 202209 |  349 | `	if( nArg < 2 ){` |
|      - |  350 | `		/* return FALSE */` |
|      5 |  351 | `		ph7_result_bool(pCtx,0);` |
|      5 |  352 | `		return PH7_OK;` |
|      - |  353 | `	}` |
|      - |  354 | `	/* Extract the target string */` |
| 202205 |  355 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 202205 |  356 | `	if( nSrcLen < 1 ){` |
|      - |  357 | `		/* Empty string,return FALSE */` |
|  11525 |  358 | `		ph7_result_bool(pCtx,0);` |
|  11525 |  359 | `		return PH7_OK;` |
|      - |  360 | `	}` |
| 190685 |  361 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  362 | `	/* Extract the offset */` |
| 190685 |  363 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 190685 |  364 | `	if( nOfft < 0 ){` |
|  31369 |  365 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  31369 |  366 | `		if( zOfft < zSource ){` |
|      - |  367 | `			/* Invalid offset */` |
|      5 |  368 | `			ph7_result_bool(pCtx,0);` |
|      5 |  369 | `			return PH7_OK;` |
|      - |  370 | `		}` |
|  31365 |  371 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  31365 |  372 | `		nOfft = (int)(zOfft-zSource);` |
| 175001 |  373 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  374 | `		/* Invalid offset */` |
|    179 |  375 | `		ph7_result_bool(pCtx,0);` |
|    179 |  376 | `		return PH7_OK;` |
|    ! 0 |  377 | `	}else{` |
| 159147 |  378 | `		zOfft = &zSource[nOfft];` |
| 159147 |  379 | `		nLen = nSrcLen - nOfft;` |
|      - |  380 | `	}` |
| 190507 |  381 | `	if( nArg > 2 ){` |
|      - |  382 | `		/* Extract the length */` |
| 157513 |  383 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 157513 |  384 | `		if( nLen == 0 ){` |
|      - |  385 | `			/* Invalid length,return an empty string */` |
|      5 |  386 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  387 | `			return PH7_OK;` |
| 157509 |  388 | `		}else if( nLen < 0 ){` |
|  31357 |  389 | `			nLen = nSrcLen + nLen - nOfft;` |
|  31357 |  390 | `			if( nLen < 1 ){` |
|      - |  391 | `				/* Invalid  length */` |
|      3 |  392 | `				nLen = nSrcLen - nOfft;` |
|      1 |  393 | `			}` |
|  15676 |  394 | `		}` |
| 157509 |  395 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  396 | `			/* Invalid length */` |
|   4715 |  397 | `			nLen = nSrcLen - nOfft;` |
|   2355 |  398 | `		}` |
|  78752 |  399 | `	}` |
|      - |  400 | `	/* Return the substring */` |
| 190503 |  401 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 190503 |  402 | `	return PH7_OK;` |
| 101107 |  403 |  |
|      - |  404 | `/*` |
...
|      - | 1525 | ` */` |
| 127194 | 1526 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1527 |  |
|  63597 | 1528 | `	SXUNUSED(pKey);` |
| 127199 | 1529 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1530 | `	const char *zData;` |
|      - | 1531 | `	int nLen;` |
| 127199 | 1532 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 127197 | 1556 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1557 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 127197 | 1558 | `	if( pData->bFirst ){` |
|  31681 | 1559 | `		pData->bFirst = 0;` |
| 111359 | 1560 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1561 | `		/* append the separator first */` |
|  95509 | 1562 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 127197 | 1568 | `	if( nLen > 0 ){` |
| 115677 | 1569 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1570 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1571 | `			return PH7_ABORT;` |
|      - | 1572 | `		}` |
|  57836 | 1573 | `	}` |
| 127197 | 1574 | `	return PH7_OK;` |
|  63602 | 1575 |  |
|      - | 1576 | `/*` |
...
|      - | 1588 | ` */` |
|  31702 | 1589 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1590 |  |
|      - | 1591 | `	struct implode_data imp_data;` |
|  31707 | 1592 | `	int i = 1;` |
|  31707 | 1593 | `	if( nArg < 1 ){` |
|      - | 1594 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1595 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1596 | `		return PH7_OK;` |
|      - | 1597 | `	}` |
|      - | 1598 | `	/* Prepare the implode context */` |
|  31707 | 1599 | `	imp_data.pCtx = pCtx;` |
|  31707 | 1600 | `	imp_data.bRecursive = 0;` |
|  31707 | 1601 | `	imp_data.bFirst = 1;` |
|  31707 | 1602 | `	imp_data.nRecCount = 0;` |
|  31707 | 1603 | `	imp_data.rc = SXRET_OK;` |
|  31707 | 1604 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  31705 | 1605 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  15855 | 1606 | `	}else{` |
|      3 | 1607 | `		imp_data.zSep = 0;` |
|      3 | 1608 | `		imp_data.nSeplen = 0;` |
|      3 | 1609 | `		i = 0;` |
|      - | 1610 | `	}` |
|  31707 | 1611 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1612 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1613 | `	}` |
|      - | 1614 | `	/* Start the 'join' process */` |
|  63409 | 1615 | `	while( i < nArg ){` |
|  31707 | 1616 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1617 | `			/* Iterate throw array entries */` |
|  31707 | 1618 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1619 | `			/* Surface a callback allocation failure as a fatal */` |
|  31707 | 1620 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 1745 | ` */` |
|   5974 | 1746 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1747 |  |
...
|   5971 | 1760 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   5971 | 1761 | `	if( nDelim < 1 ){` |
|      - | 1762 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1763 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1764 | `		return PH7_OK;` |
|      - | 1765 | `	}` |
|      - | 1766 | `	/* Extract the string */` |
|   5969 | 1767 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   5969 | 1768 | `	if( nStrlen < 1 ){` |
...
|   5967 | 1785 | `	zEnd = &zString[nStrlen];` |
|      - | 1786 | `	/* Create the array */` |
|   5967 | 1787 | `	pArray =  ph7_context_new_array(pCtx);` |
|   5967 | 1788 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   5967 | 1789 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1790 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1791 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1792 | `		return PH7_OK;` |
|      - | 1793 | `	}` |
|      - | 1794 | `	/* Set a defualt limit */` |
|   5967 | 1795 | `	iLimit = SXI32_HIGH;` |
|   5967 | 1796 | `	if( nArg > 2 ){` |
...
|  68859 | 1807 | `	for(;;){` |
| 137723 | 1808 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 137723 | 1809 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1810 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   5967 | 1811 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   5967 | 1812 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1813 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 1814 | `			}` |
|   5967 | 1815 | `			break;` |
|      - | 1816 | `		}` |
|      - | 1817 | `		/* Point to the desired offset */` |
| 131761 | 1818 | `		zCur = &zString[nOfft];` |
|      - | 1819 | `		/* Perform the store operation (may be empty) */` |
| 131761 | 1820 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 131761 | 1821 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1822 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 1823 | `		}` |
|      - | 1824 | `		/* Point beyond the delimiter */` |
| 131761 | 1825 | `		zString = &zCur[nDelim];` |
|      - | 1826 | `		/* Reset the cursor */` |
| 131761 | 1827 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 1828 | `	}` |
|      - | 1829 | `	/* Return the freshly created array */` |
|   5967 | 1830 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1831 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1832 | `	 * released as soon we return from this foregin function.` |
|      - | 1833 | `	 */` |
|   5967 | 1834 | `	return PH7_OK;` |
|   2992 | 1835 |  |
|      - | 1836 | `/*` |
...
|      - | 1850 | ` */` |
|  13658 | 1851 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1852 |  |
|      - | 1853 | `	const char *zString;` |
|      - | 1854 | `	int nLen;` |
|  13663 | 1855 | `	if( nArg < 1 ){` |
|      - | 1856 | `		/* Missing arguments,return null */` |
|      3 | 1857 | `		ph7_result_null(pCtx);` |
|      3 | 1858 | `		return PH7_OK;` |
|      - | 1859 | `	}` |
|      - | 1860 | `	/* Extract the target string */` |
|  13661 | 1861 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  13661 | 1862 | `	if( nLen < 1 ){` |
|      - | 1863 | `		/* Empty string,return */` |
|   1729 | 1864 | `		ph7_result_string(pCtx,"",0);` |
|   1729 | 1865 | `		return PH7_OK;` |
|      - | 1866 | `	}` |
|      - | 1867 | `	/* Start the trim process */` |
|  11937 | 1868 | `	if( nArg < 2 ){` |
|      - | 1869 | `		SyString sStr;` |
|      - | 1870 | `		/* Remove white spaces and NUL bytes */` |
|  11933 | 1871 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  29185 | 1872 | `		SyStringFullTrimSafe(&sStr);` |
|  11933 | 1873 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   5969 | 1874 | `	}else{` |
|      - | 1875 | `		/* Char list */` |
...
|    ! 0 | 2125 | `		}else{` |
| 166253 | 2126 | `			int c = zString[0];` |
| 166253 | 2127 | `			if( SyisUpper(c) ){` |
| 166251 | 2128 | `				c = SyToLower(zString[0]);` |
|  83123 | 2129 | `			}` |
|      - | 2130 | `			/* Append character */` |
| 166253 | 2131 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2132 | `			/* Advance the cursor */` |
| 166253 | 2133 | `			zString++;` |
|      - | 2134 | `		}` |
|      5 | 2135 | `	}` |
|  31355 | 2136 | `	return PH7_OK;` |
|  15682 | 2137 |  |
|      - | 2138 | `/*` |
...
|      - | 6626 | ` */` |
|  23722 | 6627 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 6628 |  |
...
|      - | 6637 | `	int nByte;` |
|      - | 6638 | `	sxi32 rc;` |
|  23727 | 6639 | `	if( nArg < 3 ){` |
|      - | 6640 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 6641 | `		ph7_result_null(pCtx);` |
|      7 | 6642 | `		return PH7_OK;` |
|      - | 6643 | `	}` |
|      - | 6644 | `	/* Initialize fields */` |
|  23721 | 6645 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  23721 | 6646 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  23721 | 6647 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  23721 | 6648 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  23721 | 6649 | `	sRep.pCtx = pCtx;` |
|  23721 | 6650 | `	sRep.pCollector = &sSearch;` |
|  23721 | 6651 | `	rep_str = 0;` |
|      - | 6652 | `	/* Extract the subject */` |
|  23721 | 6653 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  23721 | 6654 | `	if( nByte < 1 ){` |
...
|  23693 | 6660 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 6661 | `	/* Search string */` |
|  23693 | 6662 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 6663 | `		/* Collect search string */` |
|      9 | 6664 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 6665 | `	}else{` |
|      - | 6666 | `		/* Single pattern */` |
|  23685 | 6667 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  23685 | 6668 | `		if( nByte < 1 ){` |
...
|      - | 6672 | `		}` |
|  23681 | 6673 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6674 | `		/* Save for later processing */` |
|  23681 | 6675 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 6676 | `	}` |
|      - | 6677 | `	/* Replace string */` |
|  23689 | 6678 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 6679 | `		/* Collect replace string */` |
|      7 | 6680 | `		sRep.pCollector = &sReplace;` |
|      7 | 6681 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 6682 | `	}else{` |
|      - | 6683 | `		/* Single needle */` |
|  23683 | 6684 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  23683 | 6685 | `		rep_str = 1;` |
|  23683 | 6686 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6687 | `		/* Save for later processing */` |
|  23683 | 6688 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 6689 | `	}` |
|      - | 6690 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  23689 | 6691 | `	if( sRep.rc != SXRET_OK ){` |
...
|  23689 | 6698 | `	SySetResetCursor(&sSearch);` |
|  23689 | 6699 | `	SySetResetCursor(&sReplace);` |
|  23689 | 6700 | `	pReplace = pSearch = 0; /* cc warning */` |
|  23689 | 6701 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 6702 | `	/* Extract function name */` |
|  23689 | 6703 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 6704 | `	/* Set the default pattern match routine */` |
|  23689 | 6705 | `	xMatch = SyBlobSearch;` |
|  23689 | 6706 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 6707 | `		/* Case insensitive pattern match */` |
|     11 | 6708 | `		xMatch = iPatternMatch;` |
|      5 | 6709 | `	}` |
|      - | 6710 | `	/* Start the replace process */` |
|  47381 | 6711 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 6712 | `		sxu32 nCount,nOfft;` |
|  23697 | 6713 | `		if( pSearch->nByte <  1 ){` |
|      - | 6714 | `			/* Empty string,ignore */` |
|      3 | 6715 | `			continue;` |
|      - | 6716 | `		}` |
|      - | 6717 | `		/* Extract the replace string */` |
|  23695 | 6718 | `		if( rep_str ){` |
|  23685 | 6719 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  11845 | 6720 | `		}else{` |
...
|      1 | 6726 | `			}` |
|      - | 6727 | `		}` |
|  23695 | 6728 | `		if( pReplace == 0 ){` |
|      - | 6729 | `			/* Use an empty string instead */` |
|      3 | 6730 | `			pReplace = &sTemp;` |
|      1 | 6731 | `		}` |
|  23695 | 6732 | `		nOfft = nCount = 0;` |
|  11861 | 6733 | `		for(;;){` |
|  23727 | 6734 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 6735 | `				break;` |
|      - | 6736 | `			}` |
|      - | 6737 | `			/* Perform a pattern lookup */` |
|  35570 | 6738 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  23710 | 6739 | `				pSearch->nByte,&nOfft);` |
|  23715 | 6740 | `			if( rc != SXRET_OK ){` |
...
|  23689 | 6758 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  23689 | 6759 | `	SySetRelease(&sSearch);` |
|  23689 | 6760 | `	SySetRelease(&sReplace);` |
|  23689 | 6761 | `	SyBlobRelease(&sWorker);` |
|  23689 | 6762 | `	if( rc != PH7_OK ){` |
|    ! 0 | 6763 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 6764 | `	}` |
|  23689 | 6765 | `	return PH7_OK;` |
|  11866 | 6766 |  |
|      - | 6767 | `/*` |
...
|      - | 7948 | ` */` |
|   3178 | 7949 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 7950 |  |
|      - | 7951 | `	sxu32 n;` |
| 530731 | 7952 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 527553 | 7953 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 263779 | 7954 | `	}` |
|      - | 7955 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3183 | 7956 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 7957 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3183 | 7958 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3183 | 7959 |  |
|      - | 7960 |  |
