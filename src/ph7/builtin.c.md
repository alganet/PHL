...
| 492244 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 492249 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|    ! 0 |   33 | `		return PH7_OK;` |
|      - |   34 | `	}` |
| 492249 |   35 | `	if( ph7_value_is_float(pArg) ){` |
...
|      3 |   54 | `		return PH7_OK;` |
|      - |   55 | `	}` |
| 492243 |   56 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   57 | `		const char *zNum;` |
|      - |   58 | `		int nSlen;` |
...
|      5 |   96 | `		return PH7_OK;` |
|      - |   97 | `	}` |
| 492229 |   98 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  111 | `			);` |
|      - |  112 | `	}` |
| 492229 |  113 | `	*pOut = ph7_value_to_int64(pArg);` |
| 492229 |  114 | `	return PH7_OK;` |
| 246127 |  115 | `}` |
|      - |  116 |  |
...
|      5 |  272 | `{` |
|    765 |  273 | `	int res = 0; /* Assume false by default */` |
|    765 |  274 | `	if( nArg > 0 ){` |
|    765 |  275 | `		res = ph7_value_is_array(apArg[0]);` |
|    380 |  276 | `	}` |
|      - |  277 | `	/* Query result */` |
|    765 |  278 | `	ph7_result_bool(pCtx,res);` |
|    765 |  279 | `	return PH7_OK;` |
|      5 |  280 | `}` |
|      - |  281 | `/*` |
...
|      - |  288 | ` */` |
|   1560 |  289 | `static int PH7_builtin_is_object(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 |  290 | `{` |
|   1563 |  291 | `	int res = 0; /* Assume false by default */` |
|   1563 |  292 | `	if( nArg > 0 ){` |
|   1563 |  293 | `		res = ph7_value_is_object(apArg[0]);` |
|    780 |  294 | `	}` |
|      - |  295 | `	/* Query result */` |
|   1563 |  296 | `	ph7_result_bool(pCtx,res);` |
|   1563 |  297 | `	return PH7_OK;` |
|      3 |  298 | `}` |
|      - |  299 | `/*` |
...
|      - |  344 | ` */` |
|     50 |  345 | `static int PH7_builtin_intval(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |  346 | `{` |
|     51 |  347 | `	if( nArg < 1 ){` |
|      - |  348 | `		/* return 0 */` |
...
|     51 |  353 | `		iVal = ph7_value_to_int64(apArg[0]);` |
|     51 |  354 | `		ph7_result_int64(pCtx,iVal);` |
|      - |  355 | `	}` |
|     51 |  356 | `	return PH7_OK;` |
|      1 |  357 | `}` |
|      - |  358 | `/*` |
...
|      - |  410 | ` */` |
|  40734 |  411 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  412 | `{` |
|  40739 |  413 | `	int res = 1; /* Assume empty by default */` |
|  40739 |  414 | `	if( nArg > 0 ){` |
|  40737 |  415 | `		res = ph7_value_is_empty(apArg[0]);` |
|  20366 |  416 | `	}` |
|  40739 |  417 | `	ph7_result_bool(pCtx,res);` |
|  40739 |  418 | `	return PH7_OK;` |
|      - |  419 |  |
|      5 |  420 | `}` |
...
|      - |  460 | ` */` |
| 271358 |  461 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  462 | `{` |
|      - |  463 | `	const char *zSource;` |
|      - |  464 | `	int nSrcLen;` |
|      - |  465 | `	sxi64 iStart,iEnd;` |
| 271363 |  466 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 271363 |  467 | `	if( nArg < 2 ){` |
...
| 271363 |  473 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |  474 | `	/* Extract the offset */` |
|      - |  475 | `	{` |
| 271363 |  476 | `		sxi64 iTmp = 0;` |
| 271363 |  477 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 271363 |  478 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  479 | `			return rcArg;` |
|      - |  480 | `		}` |
| 271363 |  481 | `		iStart = iTmp;` |
|      - |  482 | `	}` |
|      - |  483 | `	/*` |
...
|      - |  492 | `	 */` |
| 271363 |  493 | `	if( iStart < 0 ){` |
|  33795 |  494 | `		iStart += nSrcLen;` |
|  33795 |  495 | `		if( iStart < 0 ){` |
|      5 |  496 | `			iStart = 0;` |
|      7 |  497 | `		}` |
| 254468 |  498 | `	}else if( iStart > nSrcLen ){` |
|      7 |  499 | `		iStart = nSrcLen;` |
|      3 |  500 | `	}` |
| 271363 |  501 | `	iEnd = nSrcLen;` |
| 271363 |  502 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 199851 |  503 | `		sxi64 iLen = 0;` |
| 199851 |  504 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 199851 |  505 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  506 | `			return rcArg;` |
|      - |  507 | `		}` |
| 199851 |  508 | `		if( iLen < 0 ){` |
|  33427 |  509 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 183140 |  510 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  19125 |  511 | `			iEnd = nSrcLen;` |
|   9565 |  512 | `		}else{` |
| 147309 |  513 | `			iEnd = iStart + iLen;` |
|      - |  514 | `		}` |
|  99923 |  515 | `	}` |
| 271363 |  516 | `	if( iEnd < iStart ){` |
|      3 |  517 | `		iEnd = iStart;` |
|      1 |  518 | `	}` |
| 271363 |  519 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 271363 |  520 | `	return PH7_OK;` |
| 135684 |  521 | `}` |
|      - |  522 | `/*` |
...
|      - |  715 | ` */` |
| 399158 |  716 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  717 | `{` |
| 399163 |  718 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 1579 | ` */` |
|    236 | 1580 | `static void PH7_BuildCharMask(ph7_context *pCtx,const char *zList,int nLen,char aMask[256])` |
|      4 | 1581 | `{` |
|    240 | 1582 | `	const unsigned char *zIn  = (const unsigned char *)zList;` |
|    240 | 1583 | `	const unsigned char *zEnd = zIn + (nLen > 0 ? nLen : 0);` |
|    240 | 1584 | `	SyZero(aMask,256);` |
|    638 | 1585 | `	for( ; zIn < zEnd ; zIn++ ){` |
|    402 | 1586 | `		int c = zIn[0];` |
|    402 | 1587 | `		if( zIn + 3 < zEnd && zIn[1] == '.' && zIn[2] == '.' && zIn[3] >= c ){` |
...
|    401 | 1594 | `		}else if( zIn + 1 < zEnd && zIn[0] == '.' && zIn[1] == '.' ){` |
...
|      - | 2015 | ` */` |
|  75806 | 2016 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2017 | `{` |
|  75811 | 2018 | `	int iLen = 0;` |
|  75811 | 2019 | `	if( nArg > 0 ){` |
|  75811 | 2020 | `		StrNullArgNotice(pCtx,apArg[0],"strlen",1,"$string");` |
|  75811 | 2021 | `		ph7_value_to_string(apArg[0],&iLen);` |
|  37903 | 2022 | `	}` |
|      - | 2023 | `	/* String length */` |
|  75811 | 2024 | `	ph7_result_int(pCtx,iLen);` |
|  75811 | 2025 | `	return PH7_OK;` |
|      5 | 2026 | `}` |
|      - | 2027 | `/*` |
...
|      - | 2263 | ` */` |
| 156704 | 2264 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2265 | `{` |
|  78352 | 2266 | `	SXUNUSED(pKey);` |
| 156709 | 2267 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2268 | `	const char *zData;` |
|      - | 2269 | `	int nLen;` |
| 156709 | 2270 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 156707 | 2294 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2295 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 156707 | 2296 | `	if( pData->bFirst ){` |
|  34013 | 2297 | `		pData->bFirst = 0;` |
| 139703 | 2298 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2299 | `		/* append the separator first */` |
| 122619 | 2300 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 156707 | 2306 | `	if( nLen > 0 ){` |
| 143895 | 2307 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2308 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2309 | `			return PH7_ABORT;` |
|      - | 2310 | `		}` |
|  71945 | 2311 | `	}` |
| 156707 | 2312 | `	return PH7_OK;` |
|  78357 | 2313 | `}` |
|      - | 2314 | `/*` |
...
|      - | 2326 | ` */` |
|  34036 | 2327 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2328 | `{` |
|      - | 2329 | `	struct implode_data imp_data;` |
|  34041 | 2330 | `	int i = 1;` |
|  34041 | 2331 | `	if( nArg < 1 ){` |
|      - | 2332 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2333 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2334 | `		return PH7_OK;` |
|      - | 2335 | `	}` |
|      - | 2336 | `	/* Prepare the implode context */` |
|  34041 | 2337 | `	imp_data.pCtx = pCtx;` |
|  34041 | 2338 | `	imp_data.bRecursive = 0;` |
|  34041 | 2339 | `	imp_data.bFirst = 1;` |
|  34041 | 2340 | `	imp_data.nRecCount = 0;` |
|  34041 | 2341 | `	imp_data.rc = SXRET_OK;` |
|  34041 | 2342 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  34039 | 2343 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  34039 | 2344 | `		if( nArg > 1 && !ph7_value_is_array(apArg[1]) && !ph7_value_is_null(apArg[1]) ){` |
...
|      3 | 2355 | `		i = 0;` |
|      - | 2356 | `	}` |
|  34039 | 2357 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2358 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2359 | `	}` |
|      - | 2360 | `	/* Start the 'join' process */` |
|  68073 | 2361 | `	while( i < nArg ){` |
|  34039 | 2362 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2363 | `			/* Iterate throw array entries */` |
|  34039 | 2364 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2365 | `			/* Surface a callback allocation failure as a fatal */` |
|  34039 | 2366 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2491 | ` */` |
|   6950 | 2492 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2493 | `{` |
...
|   6955 | 2506 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6955 | 2507 | `	if( nDelim < 1 ){` |
...
|   6951 | 2513 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6951 | 2514 | `	if( nStrlen < 1 ){` |
...
|   6939 | 2540 | `	zEnd = &zString[nStrlen];` |
|      - | 2541 | `	/* Create the array */` |
|   6939 | 2542 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6939 | 2543 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6939 | 2544 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2545 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2546 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2547 | `		return PH7_OK;` |
|      - | 2548 | `	}` |
|      - | 2549 | `	/* Set a defualt limit */` |
|   6939 | 2550 | `	iLimit = SXI32_HIGH;` |
|   6939 | 2551 | `	if( nArg > 2 ){` |
|     40 | 2552 | `		iLimit = ph7_value_to_int(apArg[2]);` |
|     40 | 2553 | `		if( iLimit < 0 ){` |
...
|  83411 | 2586 | `	for(;;){` |
| 166827 | 2587 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 166827 | 2588 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2589 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6923 | 2590 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6923 | 2591 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2592 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2593 | `			}` |
|   6923 | 2594 | `			break;` |
|      - | 2595 | `		}` |
|      - | 2596 | `		/* Point to the desired offset */` |
| 159909 | 2597 | `		zCur = &zString[nOfft];` |
|      - | 2598 | `		/* Perform the store operation (may be empty) */` |
| 159909 | 2599 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 159909 | 2600 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2601 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2602 | `		}` |
|      - | 2603 | `		/* Point beyond the delimiter */` |
| 159909 | 2604 | `		zString = &zCur[nDelim];` |
|      - | 2605 | `		/* Reset the cursor */` |
| 159909 | 2606 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2607 | `	}` |
|      - | 2608 | `	/* Return the freshly created array */` |
|   6923 | 2609 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2610 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2611 | `	 * released as soon we return from this foregin function.` |
|      - | 2612 | `	 */` |
|   6923 | 2613 | `	return PH7_OK;` |
|   3480 | 2614 | `}` |
|      - | 2615 | `/*` |
...
|      - | 2629 | ` */` |
|  14656 | 2630 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2631 | `{` |
|  14661 | 2632 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - | 2633 | `	const char *zString;` |
|      - | 2634 | `	int nLen;` |
|  14661 | 2635 | `	if( nArg < 1 ){` |
|      - | 2636 | `		/* Missing arguments,return null */` |
|    ! 0 | 2637 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2638 | `		return PH7_OK;` |
|      - | 2639 | `	}` |
|      - | 2640 | `	/* Extract the target string */` |
|  14661 | 2641 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14661 | 2642 | `	if( nLen < 1 ){` |
|      - | 2643 | `		/* Empty string,return */` |
|    753 | 2644 | `		ph7_result_string(pCtx,"",0);` |
|    753 | 2645 | `		return PH7_OK;` |
|      - | 2646 | `	}` |
|      - | 2647 | `	/* Start the trim process */` |
|  13913 | 2648 | `	if( nArg < 2 ){` |
|      - | 2649 | `		SyString sStr;` |
|      - | 2650 | `		/* Remove white spaces and NUL bytes */` |
|  13883 | 2651 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  34843 | 2652 | `		SyStringFullTrimSafe(&sStr);` |
|  13883 | 2653 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6944 | 2654 | `	}else{` |
|      - | 2655 | `		/* Char list */` |
...
|      - | 2699 | ` */` |
|    168 | 2700 | `static int PH7_builtin_rtrim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 | 2701 | `{` |
|    171 | 2702 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"rtrim",1,"$string"); }` |
...
|    171 | 2711 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|    171 | 2712 | `	if( nLen < 1 ){` |
...
|      - | 2727 | `		int nListlen;` |
|    147 | 2728 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|    147 | 2729 | `		if( nListlen < 1 ){` |
|      - | 2730 | `			/* Return the string unchanged */` |
|    ! 0 | 2731 | `			ph7_result_string(pCtx,zString,nLen);` |
|    ! 0 | 2732 | `		}else{` |
|      - | 2733 | `			char aMask[256];` |
|    147 | 2734 | `			const char *zEnd = &zString[nLen];` |
|    147 | 2735 | `			const char *zCur = zString;` |
|    147 | 2736 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - | 2737 | `			/* Right trim */` |
|    165 | 2738 | `			while( zEnd > zCur && aMask[(unsigned char)zEnd[-1]] ){` |
|     20 | 2739 | `				zEnd--;` |
|      2 | 2740 | `			}` |
|    147 | 2741 | `			if( zEnd <= zCur ){` |
|      - | 2742 | `				/* Return the empty string */` |
|    ! 0 | 2743 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 | 2744 | `			}else{` |
|    147 | 2745 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - | 2746 | `			}` |
|      - | 2747 | `		}` |
|      - | 2748 | `	}` |
|    165 | 2749 | `	return PH7_OK;` |
|     87 | 2750 | `}` |
|      - | 2751 | `/*` |
...
|      - | 2793 | `		int nListlen;` |
|     24 | 2794 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|     24 | 2795 | `		if( nListlen < 1 ){` |
|      - | 2796 | `			/* Return the string unchanged */` |
|      3 | 2797 | `			ph7_result_string(pCtx,zString,nLen);` |
|      2 | 2798 | `		}else{` |
|      - | 2799 | `			char aMask[256];` |
|     22 | 2800 | `			const char *zEnd = &zString[nLen];` |
|     22 | 2801 | `			const char *zCur = zString;` |
|     22 | 2802 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - | 2803 | `			/* Left trim */` |
|     56 | 2804 | `			while( zCur < zEnd && aMask[(unsigned char)zCur[0]] ){` |
|     38 | 2805 | `				zCur++;` |
|      4 | 2806 | `			}` |
|     22 | 2807 | `			if( zCur >= zEnd ){` |
|      - | 2808 | `				/* Return the empty string */` |
|    ! 0 | 2809 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 | 2810 | `			}else{` |
|     22 | 2811 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - | 2812 | `			}` |
|      - | 2813 | `		}` |
|      - | 2814 | `	}` |
|     28 | 2815 | `	return PH7_OK;` |
|     26 | 2816 | `}` |
|      - | 2817 | `/*` |
...
|      - | 2825 | ` */` |
|  33928 | 2826 | `static int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2827 | `{` |
|  33933 | 2828 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - | 2829 | `	const char *zString,*zCur,*zEnd;` |
|      - | 2830 | `	int nLen;` |
|  33933 | 2831 | `	if( nArg < 1 ){` |
|      - | 2832 | `		/* Missing arguments,return null */` |
|    ! 0 | 2833 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2834 | `		return PH7_OK;` |
|      - | 2835 | `	}` |
|      - | 2836 | `	/* Extract the target string */` |
|  33933 | 2837 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33933 | 2838 | `	if( nLen < 1 ){` |
|      - | 2839 | `		/* Empty string,return */` |
|      5 | 2840 | `		ph7_result_string(pCtx,"",0);` |
|      5 | 2841 | `		return PH7_OK;` |
|      - | 2842 | `	}` |
|      - | 2843 | `	/* Perform the requested operation */` |
|  33929 | 2844 | `	zEnd = &zString[nLen];` |
| 107040 | 2845 | `	for(;;){` |
| 214085 | 2846 | `		if( zString >= zEnd ){` |
|      - | 2847 | `			/* No more input,break immediately */` |
|  33929 | 2848 | `			break;` |
|      - | 2849 | `		}` |
| 180161 | 2850 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2859 | `		}else{` |
| 180161 | 2860 | `			int c = zString[0];` |
| 180161 | 2861 | `			if( SyisUpper(c) ){` |
| 177277 | 2862 | `				c = SyToLower(zString[0]);` |
|  88636 | 2863 | `			}` |
|      - | 2864 | `			/* Append character */` |
| 180161 | 2865 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2866 | `			/* Advance the cursor */` |
| 180161 | 2867 | `			zString++;` |
|      - | 2868 | `		}` |
|      5 | 2869 | `	}` |
|  33929 | 2870 | `	return PH7_OK;` |
|  16969 | 2871 | `}` |
|      - | 2872 | `/*` |
...
|      - | 2880 | ` */` |
|     76 | 2881 | `static int PH7_builtin_strtoupper(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 | 2882 | `{` |
|     80 | 2883 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtoupper",1,"$string"); }` |
...
|     80 | 2892 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     80 | 2893 | `	if( nLen < 1 ){` |
...
|     76 | 2899 | `	zEnd = &zString[nLen];` |
|    148 | 2900 | `	for(;;){` |
|    300 | 2901 | `		if( zString >= zEnd ){` |
|      - | 2902 | `			/* No more input,break immediately */` |
|     76 | 2903 | `			break;` |
|      - | 2904 | `		}` |
|    228 | 2905 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2914 | `		}else{` |
|    228 | 2915 | `			int c = zString[0];` |
|    228 | 2916 | `			if( SyisLower(c) ){` |
|    212 | 2917 | `				c = SyToUpper(zString[0]);` |
|    104 | 2918 | `			}` |
|      - | 2919 | `			/* Append character */` |
|    228 | 2920 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2921 | `			/* Advance the cursor */` |
|    228 | 2922 | `			zString++;` |
|      - | 2923 | `		}` |
|      4 | 2924 | `	}` |
|     76 | 2925 | `	return PH7_OK;` |
|     42 | 2926 | `}` |
|      - | 2927 | `/*` |
...
|    227 | 3033 | `	if( ph7_value_is_null(apArg[0]) ){` |
...
|    227 | 3040 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|    227 | 3041 | `	if( nLen < 1 ){` |
...
|    223 | 3057 | `	c = (unsigned char)zString[0];` |
|      - | 3058 | `	/* Return that value */` |
|    223 | 3059 | `	ph7_result_int(pCtx,c);` |
|    223 | 3060 | `	return PH7_OK;` |
|    117 | 3061 | `}` |
|      - | 3062 | `/*` |
...
|      - | 3123 | ` */` |
|   3170 | 3124 | `static int HashConsumer(const void *pData,unsigned int nLen,void *pUserData)` |
|      2 | 3125 | `{` |
|      - | 3126 | `	/* Append hex chunk verbatim */` |
|   3172 | 3127 | `	ph7_result_string((ph7_context *)pUserData,(const char *)pData,(int)nLen);` |
|   3172 | 3128 | `	return SXRET_OK;` |
|      2 | 3129 | `}` |
|      - | 3130 |  |
|      - | 3131 | `/*` |
...
|      - | 3139 | ` */` |
|    152 | 3140 | `static int PH7_builtin_bin2hex(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 | 3141 | `{` |
...
|      - | 3155 | `	 */` |
|    227 | 3156 | `	if( ph7_value_is_array(apArg[0]) \|\| ph7_value_is_resource(apArg[0]) \|\|` |
|     75 | 3157 | `		( ph7_value_is_object(apArg[0]) &&` |
...
|    152 | 3177 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|    152 | 3178 | `	if( nLen < 1 ){` |
...
|    140 | 3184 | `	SyBinToHexConsumer((const void *)zString,(sxu32)nLen,HashConsumer,pCtx);` |
|    140 | 3185 | `	return PH7_OK;` |
|     79 | 3186 | `}` |
|      - | 3187 |  |
...
|      - | 3359 | ` */` |
|   1562 | 3360 | `static int PH7_builtin_strpos(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3361 | `{` |
|   1567 | 3362 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strpos",1,"$haystack"); }` |
|   1567 | 3363 | `	if( nArg > 1 ){ StrNullArgNotice(pCtx,apArg[1],"strpos",2,"$needle"); }` |
|   1567 | 3364 | `	ProcStringMatch xPatternMatch = SyBlobSearch; /* Case-sensitive pattern match */` |
...
|   1567 | 3375 | `	zBlob = ph7_value_to_string(apArg[0],&nLen);` |
|   1567 | 3376 | `	zPattern = ph7_value_to_string(apArg[1],&nPatLen);` |
|   1567 | 3377 | `	nOfft = 0; /* cc warning */` |
|   1567 | 3378 | `	nStart = 0;` |
...
|      - | 3391 | `		}` |
|      7 | 3392 | `	}` |
|   1567 | 3393 | `	if( nLen > 0 && nPatLen > 0 ){` |
|      - | 3394 | `		/* Perform the lookup */` |
|   1563 | 3395 | `		rc = xPatternMatch(zBlob,(sxu32)nLen,zPattern,(sxu32)nPatLen,&nOfft);` |
|   1563 | 3396 | `		if( rc != SXRET_OK ){` |
|      - | 3397 | `			/* Pattern not found,return FALSE */` |
|    803 | 3398 | `			ph7_result_bool(pCtx,0);` |
|    803 | 3399 | `			return PH7_OK;` |
|      - | 3400 | `		}` |
|      - | 3401 | `		/* Return the pattern position */` |
|    764 | 3402 | `		ph7_result_int64(pCtx,(ph7_int64)(nOfft+nStart));` |
|    384 | 3403 | `	}else{` |
|      5 | 3404 | `		ph7_result_bool(pCtx,0);` |
|      - | 3405 | `	}` |
|    768 | 3406 | `	return PH7_OK;` |
|    786 | 3407 | `}` |
|      - | 3408 | `/*` |
...
|      - | 4010 | ` */` |
|  20438 | 4011 | `static int PH7_builtin_str_repeat(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 4012 | `{` |
|      - | 4013 | `	const char *zIn;` |
|      - | 4014 | `	int nLen;` |
|      - | 4015 | `	ph7_int64 nMul;` |
|      - | 4016 | `	int rc;` |
|  20440 | 4017 | `	if( nArg < 2 ){` |
|      - | 4018 | `		/* Missing arguments,return NULL */` |
|    ! 0 | 4019 | `		ph7_result_null(pCtx);` |
|    ! 0 | 4020 | `		return PH7_OK;` |
|      - | 4021 | `	}` |
|      - | 4022 | `	/* Extract the target string */` |
|  20440 | 4023 | `	zIn = ph7_value_to_string(apArg[0],&nLen);` |
...
|      - | 4027 | `	{` |
|  20440 | 4028 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"str_repeat",2,"$times","int",&nMul);` |
|  20440 | 4029 | `		if( rcArg != PH7_OK ){` |
|    ! 0 | 4030 | `			return rcArg;` |
|      - | 4031 | `		}` |
|      - | 4032 | `	}` |
|  20440 | 4033 | `	if( nMul < 0 ){` |
|      3 | 4034 | `		return PH7_VmThrowException(pCtx,"ValueError",` |
|      - | 4035 | `			"str_repeat(): Argument #2 ($times) must be greater than or equal to 0");` |
|      - | 4036 | `	}` |
|  20438 | 4037 | `	if( nLen < 1 \|\| nMul < 1 ){` |
...
| 427342 | 4048 | `		rc = ph7_result_string(pCtx,zIn,nLen);` |
| 427342 | 4049 | `		if( rc != PH7_OK ){` |
...
|      - | 8282 | ` */` |
|  30404 | 8283 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8284 | `{` |
...
|      - | 8293 | `	int nByte;` |
|      - | 8294 | `	sxi32 rc;` |
|  30409 | 8295 | `	if( nArg < 3 ){` |
|      - | 8296 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8297 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8298 | `		return PH7_OK;` |
|      - | 8299 | `	}` |
|      - | 8300 | `	/* Initialize fields */` |
|  30409 | 8301 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30409 | 8302 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30409 | 8303 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  30409 | 8304 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  30409 | 8305 | `	sRep.pCtx = pCtx;` |
|  30409 | 8306 | `	sRep.pCollector = &sSearch;` |
|  30409 | 8307 | `	rep_str = 0;` |
|      - | 8308 | `	/* Extract the subject */` |
|  30409 | 8309 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  30409 | 8310 | `	if( nByte < 1 ){` |
...
|  30389 | 8316 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8317 | `	/* Search string */` |
|  30389 | 8318 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8319 | `		/* Collect search string */` |
|     81 | 8320 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     43 | 8321 | `	}else{` |
|      - | 8322 | `		/* Single pattern */` |
|  30313 | 8323 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  30313 | 8324 | `		if( nByte < 1 ){` |
...
|      - | 8328 | `		}` |
|  30309 | 8329 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8330 | `		/* Save for later processing */` |
|  30309 | 8331 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8332 | `	}` |
|      - | 8333 | `	/* Replace string */` |
|  30385 | 8334 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8335 | `		/* Collect replace string */` |
|      7 | 8336 | `		sRep.pCollector = &sReplace;` |
|      7 | 8337 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8338 | `	}else{` |
|      - | 8339 | `		/* Single needle */` |
|  30379 | 8340 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  30379 | 8341 | `		rep_str = 1;` |
|  30379 | 8342 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8343 | `		/* Save for later processing */` |
|  30379 | 8344 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8345 | `	}` |
|      - | 8346 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  30385 | 8347 | `	if( sRep.rc != SXRET_OK ){` |
...
|  30385 | 8354 | `	SySetResetCursor(&sSearch);` |
|  30385 | 8355 | `	SySetResetCursor(&sReplace);` |
|  30385 | 8356 | `	pReplace = pSearch = 0; /* cc warning */` |
|  30385 | 8357 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8358 | `	/* Extract function name */` |
|  30385 | 8359 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8360 | `	/* Set the default pattern match routine */` |
|  30385 | 8361 | `	xMatch = SyBlobSearch;` |
|  30385 | 8362 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8363 | `		/* Case insensitive pattern match */` |
|     11 | 8364 | `		xMatch = iPatternMatch;` |
|      5 | 8365 | `	}` |
|      - | 8366 | `	/* Start the replace process */` |
|  60841 | 8367 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8368 | `		sxu32 nCount,nOfft;` |
|  30461 | 8369 | `		if( pSearch->nByte <  1 ){` |
|      - | 8370 | `			/* Empty string,ignore */` |
|      3 | 8371 | `			continue;` |
|      - | 8372 | `		}` |
|      - | 8373 | `		/* Extract the replace string */` |
|  30459 | 8374 | `		if( rep_str ){` |
|  30449 | 8375 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  15227 | 8376 | `		}else{` |
...
|      1 | 8382 | `			}` |
|      - | 8383 | `		}` |
|  30459 | 8384 | `		if( pReplace == 0 ){` |
|      - | 8385 | `			/* Use an empty string instead */` |
|      3 | 8386 | `			pReplace = &sTemp;` |
|      1 | 8387 | `		}` |
|  30459 | 8388 | `		nOfft = nCount = 0;` |
|  15253 | 8389 | `		for(;;){` |
|  30511 | 8390 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8391 | `				break;` |
|      - | 8392 | `			}` |
|      - | 8393 | `			/* Perform a pattern lookup */` |
|  45746 | 8394 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30494 | 8395 | `				pSearch->nByte,&nOfft);` |
|  30499 | 8396 | `			if( rc != SXRET_OK ){` |
...
|  30385 | 8414 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  30385 | 8415 | `	SySetRelease(&sSearch);` |
|  30385 | 8416 | `	SySetRelease(&sReplace);` |
|  30385 | 8417 | `	SyBlobRelease(&sWorker);` |
|  30385 | 8418 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8419 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8420 | `	}` |
|  30385 | 8421 | `	return PH7_OK;` |
|  15207 | 8422 | `}` |
|      - | 8423 | `/*` |
...
|      - | 9009 | ` */` |
|   2633 | 9010 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 9011 | `{` |
...
|   2638 | 9020 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   2638 | 9021 | `	zEnd = &zIn[nLen];` |
|   2638 | 9022 | `	if( nLen < 1 ){` |
...
|   2423 | 9028 | `	for(;;){` |
|   4849 | 9029 | `		if( zIn >= zEnd ){` |
|      - | 9030 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   2156 | 9031 | `			ph7_result_bool(pCtx,1);` |
|   2156 | 9032 | `			return PH7_OK;` |
|      - | 9033 | `		}` |
|   2698 | 9034 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 9035 | `			/* UTF-8 stream  */` |
|    ! 0 | 9036 | `			break;` |
|      - | 9037 | `		}` |
|   2698 | 9038 | `		if( !SyisDigit(zIn[0]) ){` |
|    479 | 9039 | `			break;` |
|      - | 9040 | `		}` |
...
|      - | 9251 | ` */` |
|  64446 | 9252 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 9253 | `{` |
|      - | 9254 | `	const unsigned char *zIn,*zEnd;` |
|      - | 9255 | `	int nLen;` |
|  64451 | 9256 | `	if( nArg < 1 ){` |
|      - | 9257 | `		/* Missing arguments,return FALSE */` |
|    ! 0 | 9258 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 9259 | `		return PH7_OK;` |
|      - | 9260 | `	}` |
|      - | 9261 | `	/* Extract the target string */` |
|  64451 | 9262 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  64451 | 9263 | `	zEnd = &zIn[nLen];` |
|  64451 | 9264 | `	if( nLen < 1 ){` |
...
|  33135 | 9270 | `	for(;;){` |
|  66227 | 9271 | `		if( zIn >= zEnd ){` |
|      - | 9272 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1759 | 9273 | `			ph7_result_bool(pCtx,1);` |
|   1759 | 9274 | `			return PH7_OK;` |
|      - | 9275 | `		}` |
|  64473 | 9276 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 9277 | `			/* UTF-8 stream  */` |
|    ! 0 | 9278 | `			break;` |
|      - | 9279 | `		}` |
|  64473 | 9280 | `		if( !SyisSpace(zIn[0]) ){` |
|  62695 | 9281 | `			break;` |
|      - | 9282 | `		}` |
...
|  62695 | 9287 | `	ph7_result_bool(pCtx,0);` |
|  62695 | 9288 | `	return PH7_OK;` |
|  32252 | 9289 | `}` |
|      - | 9290 | `/*` |
...
|      - | 9558 | ` */` |
|      4 | 9559 | `static int PH7_builtin_memory_get_peak_usage(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 | 9560 | `{` |
|      2 | 9561 | `	SXUNUSED(nArg);` |
|      2 | 9562 | `	SXUNUSED(apArg);` |
|      5 | 9563 | `	ph7_result_int64(pCtx,(ph7_int64)pCtx->pVm->sAllocator.nMemPeak);` |
|      5 | 9564 | `	return PH7_OK;` |
|      1 | 9565 | `}` |
|      - | 9566 | `/*` |
|      - | 9567 | ` * void memory_reset_peak_usage()` |
|      - | 9568 | ` *  Reset the peak memory usage (memory_get_peak_usage) back to the current` |
|      - | 9569 | ` *  live usage — php 8.2. Frameworks call it between tests to measure per-test` |
|      - | 9570 | ` *  peaks.` |
|      - | 9571 | ` */` |
|      4 | 9572 | `static int PH7_builtin_memory_reset_peak_usage(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 | 9573 | `{` |
|      2 | 9574 | `	SXUNUSED(nArg);` |
|      2 | 9575 | `	SXUNUSED(apArg);` |
|      5 | 9576 | `	pCtx->pVm->sAllocator.nMemPeak = pCtx->pVm->sAllocator.nMemUsed;` |
|      5 | 9577 | `	return PH7_OK;` |
|      1 | 9578 | `}` |
|      - | 9579 | `/*` |
|      - | 9580 | ` * PHL frees values by reference count as they go out of scope, so there is no` |
|      - | 9581 | ` * mark-and-sweep cycle collector to drive. The gc_* family is provided for` |
|      - | 9582 | ` * source compatibility (real frameworks call it around test runs): the state is` |
|      - | 9583 | ` * observational and collection is a no-op. Recorded divergence from php, whose` |
|      - | 9584 | ` * collector actually reclaims reference cycles.` |
|      - | 9585 | ` */` |
|    ! 0 | 9586 | `static int PH7_builtin_gc_enable(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 | 9587 | `{` |
|    ! 0 | 9588 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|    ! 0 | 9589 | `	pCtx->pVm->bGcEnabled = 1;` |
|    ! 0 | 9590 | `	return PH7_OK;` |
|    ! 0 | 9591 | `}` |
|    ! 0 | 9592 | `static int PH7_builtin_gc_disable(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 | 9593 | `{` |
|    ! 0 | 9594 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|    ! 0 | 9595 | `	pCtx->pVm->bGcEnabled = 0;` |
|    ! 0 | 9596 | `	return PH7_OK;` |
|    ! 0 | 9597 | `}` |
|    ! 0 | 9598 | `static int PH7_builtin_gc_enabled(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 | 9599 | `{` |
|    ! 0 | 9600 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|    ! 0 | 9601 | `	ph7_result_bool(pCtx,pCtx->pVm->bGcEnabled);` |
|    ! 0 | 9602 | `	return PH7_OK;` |
|    ! 0 | 9603 | `}` |
|    ! 0 | 9604 | `static int PH7_builtin_gc_collect_cycles(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 | 9605 | `{` |
|      - | 9606 | `	/* No cycle collector: nothing to reclaim. Returns the count collected (0). */` |
|    ! 0 | 9607 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|    ! 0 | 9608 | `	ph7_result_int(pCtx,0);` |
|    ! 0 | 9609 | `	return PH7_OK;` |
|    ! 0 | 9610 | `}` |
|    ! 0 | 9611 | `static int PH7_builtin_gc_mem_caches(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 | 9612 | `{` |
|    ! 0 | 9613 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|    ! 0 | 9614 | `	ph7_result_int(pCtx,0);` |
|    ! 0 | 9615 | `	return PH7_OK;` |
|    ! 0 | 9616 | `}` |
|      - | 9617 | `/*` |
|      - | 9618 | ` * array gc_status(void)` |
|      - | 9619 | ` *  php 8.3 shape. PHL never runs a collection, so every counter is zero and the` |
|      - | 9620 | ` *  timing fields are 0.0; 'running' reflects gc_enable()/gc_disable().` |
|      - | 9621 | ` */` |
|    ! 0 | 9622 | `static int PH7_builtin_gc_status(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 | 9623 | `{` |
|      - | 9624 | `	ph7_value *pArray,*pVal;` |
|    ! 0 | 9625 | `	SXUNUSED(nArg); SXUNUSED(apArg);` |
|    ! 0 | 9626 | `	pArray = ph7_context_new_array(pCtx);` |
|    ! 0 | 9627 | `	pVal = ph7_context_new_scalar(pCtx);` |
|    ! 0 | 9628 | `	if( pArray == 0 \|\| pVal == 0 ){` |
|    ! 0 | 9629 | `		ph7_result_null(pCtx);` |
|    ! 0 | 9630 | `		return PH7_OK;` |
|      - | 9631 | `	}` |
|      - | 9632 | `	/* Key order matches php 8.3's gc_status(). */` |
|    ! 0 | 9633 | `	ph7_value_bool(pVal,pCtx->pVm->bGcEnabled); ph7_array_add_strkey_elem(pArray,"running",pVal);` |
|    ! 0 | 9634 | `	ph7_value_bool(pVal,0);      ph7_array_add_strkey_elem(pArray,"protected",pVal);` |
|    ! 0 | 9635 | `	ph7_value_bool(pVal,0);      ph7_array_add_strkey_elem(pArray,"full",pVal);` |
|    ! 0 | 9636 | `	ph7_value_int(pVal,0);       ph7_array_add_strkey_elem(pArray,"runs",pVal);` |
|    ! 0 | 9637 | `	ph7_value_int(pVal,0);       ph7_array_add_strkey_elem(pArray,"collected",pVal);` |
|    ! 0 | 9638 | `	ph7_value_int(pVal,1000);    ph7_array_add_strkey_elem(pArray,"threshold",pVal);` |
|    ! 0 | 9639 | `	ph7_value_int(pVal,0);       ph7_array_add_strkey_elem(pArray,"buffer_size",pVal);` |
|    ! 0 | 9640 | `	ph7_value_int(pVal,0);       ph7_array_add_strkey_elem(pArray,"roots",pVal);` |
|    ! 0 | 9641 | `	ph7_value_double(pVal,0.0);  ph7_array_add_strkey_elem(pArray,"application_time",pVal);` |
|    ! 0 | 9642 | `	ph7_value_double(pVal,0.0);  ph7_array_add_strkey_elem(pArray,"collector_time",pVal);` |
|    ! 0 | 9643 | `	ph7_value_double(pVal,0.0);  ph7_array_add_strkey_elem(pArray,"destructor_time",pVal);` |
|    ! 0 | 9644 | `	ph7_value_double(pVal,0.0);  ph7_array_add_strkey_elem(pArray,"free_time",pVal);` |
|    ! 0 | 9645 | `	ph7_context_release_value(pCtx,pVal);` |
|    ! 0 | 9646 | `	ph7_result_value(pCtx,pArray);` |
|    ! 0 | 9647 | `	return PH7_OK;` |
|    ! 0 | 9648 | `}` |
|      - | 9649 | `static const ph7_builtin_func aBuiltInFunc[] = {` |
|      - | 9650 | `	{ "memory_get_usage"     , PH7_builtin_memory_get_usage      },` |
|      - | 9651 | `	{ "memory_get_peak_usage", PH7_builtin_memory_get_peak_usage },` |
|      - | 9652 | `	{ "memory_reset_peak_usage", PH7_builtin_memory_reset_peak_usage },` |
|      - | 9653 | `	{ "gc_enable"            , PH7_builtin_gc_enable             },` |
|      - | 9654 | `	{ "gc_disable"           , PH7_builtin_gc_disable            },` |
|      - | 9655 | `	{ "gc_enabled"           , PH7_builtin_gc_enabled            },` |
|      - | 9656 | `	{ "gc_collect_cycles"    , PH7_builtin_gc_collect_cycles     },` |
|      - | 9657 | `	{ "gc_mem_caches"        , PH7_builtin_gc_mem_caches         },` |
|      - | 9658 | `	{ "gc_status"            , PH7_builtin_gc_status             },` |
|      - | 9659 | `	   /* Variable handling functions */` |
|      - | 9660 | `	{ "is_bool"    , PH7_builtin_is_bool     },` |
|      - | 9661 | `	{ "is_float"   , PH7_builtin_is_float    },` |
|      - | 9662 | `	{ "is_real"    , PH7_builtin_is_float    },` |
|      - | 9663 | `	{ "is_double"  , PH7_builtin_is_float    },` |
|      - | 9664 | `	{ "is_int"     , PH7_builtin_is_int      },` |
|      - | 9665 | `	{ "is_integer" , PH7_builtin_is_int      },` |
|      - | 9666 | `	{ "is_long"    , PH7_builtin_is_int      },` |
|      - | 9667 | `	{ "is_string"  , PH7_builtin_is_string   },` |
|      - | 9668 | `	{ "is_null"    , PH7_builtin_is_null     },` |
|      - | 9669 | `	{ "is_numeric" , PH7_builtin_is_numeric  },` |
|      - | 9670 | `	{ "is_scalar"  , PH7_builtin_is_scalar   },` |
|      - | 9671 | `	{ "is_array"   , PH7_builtin_is_array    },` |
|      - | 9672 | `	{ "is_object"  , PH7_builtin_is_object   },` |
|      - | 9673 | `	{ "is_resource", PH7_builtin_is_resource },` |
|      - | 9674 | `	{ "douleval"   , PH7_builtin_floatval    },` |
|      - | 9675 | `	{ "floatval"   , PH7_builtin_floatval    },` |
|      - | 9676 | `	{ "intval"     , PH7_builtin_intval      },` |
|      - | 9677 | `	{ "strval"     , PH7_builtin_strval      },` |
|      - | 9678 | `	{ "boolval"    , PH7_builtin_boolval     },` |
|      - | 9679 | `	{ "empty"      , PH7_builtin_empty       },` |
|      - | 9680 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9681 | `#ifdef PH7_ENABLE_MATH_FUNC` |
|      - | 9682 | `	   /* Math functions */` |
|      - | 9683 | `	{ "abs"  ,    PH7_builtin_abs          },` |
|      - | 9684 | `	{ "sqrt" ,    PH7_builtin_sqrt         },` |
|      - | 9685 | `	{ "acosh" ,   PH7_builtin_acosh        },` |
|      - | 9686 | `	{ "asinh" ,   PH7_builtin_asinh        },` |
|      - | 9687 | `	{ "atanh" ,   PH7_builtin_atanh        },` |
|      - | 9688 | `	{ "expm1" ,   PH7_builtin_expm1        },` |
|      - | 9689 | `	{ "log1p" ,   PH7_builtin_log1p        },` |
|      - | 9690 | `	{ "deg2rad" , PH7_builtin_deg2rad      },` |
|      - | 9691 | `	{ "rad2deg" , PH7_builtin_rad2deg      },` |
|      - | 9692 | `	{ "fpow" ,    PH7_builtin_fpow         },` |
|      - | 9693 | `	{ "exp"  ,    PH7_builtin_exp          },` |
|      - | 9694 | `	{ "floor",    PH7_builtin_floor        },` |
|      - | 9695 | `	{ "cos"  ,    PH7_builtin_cos          },` |
|      - | 9696 | `	{ "sin"  ,    PH7_builtin_sin          },` |
|      - | 9697 | `	{ "acos" ,    PH7_builtin_acos         },` |
|      - | 9698 | `	{ "asin" ,    PH7_builtin_asin         },` |
|      - | 9699 | `	{ "cosh" ,    PH7_builtin_cosh         },` |
|      - | 9700 | `	{ "sinh" ,    PH7_builtin_sinh         },` |
|      - | 9701 | `	{ "ceil" ,    PH7_builtin_ceil         },` |
|      - | 9702 | `	{ "tan"  ,    PH7_builtin_tan          },` |
|      - | 9703 | `	{ "tanh" ,    PH7_builtin_tanh         },` |
|      - | 9704 | `	{ "atan" ,    PH7_builtin_atan         },` |
|      - | 9705 | `	{ "atan2",    PH7_builtin_atan2        },` |
|      - | 9706 | `	{ "log"  ,    PH7_builtin_log          },` |
|      - | 9707 | `	{ "log10" ,   PH7_builtin_log10        },` |
|      - | 9708 | `	{ "pow"  ,    PH7_builtin_pow          },` |
|      - | 9709 | `	{ "pi",       PH7_builtin_pi           },` |
|      - | 9710 | `	{ "fmod",     PH7_builtin_fmod         },` |
|      - | 9711 | `	{ "hypot",    PH7_builtin_hypot        },` |
|      - | 9712 | `#endif /* PH7_ENABLE_MATH_FUNC */` |
|      - | 9713 | `	{ "round",    PH7_builtin_round        },` |
|      - | 9714 | `	{ "intdiv",   PH7_builtin_intdiv       },` |
|      - | 9715 | `	{ "dechex", PH7_builtin_dechex         },` |
|      - | 9716 | `	{ "decoct", PH7_builtin_decoct         },` |
|      - | 9717 | `	{ "decbin", PH7_builtin_decbin         },` |
|      - | 9718 | `	{ "hexdec", PH7_builtin_hexdec         },` |
|      - | 9719 | `	{ "bindec", PH7_builtin_bindec         },` |
|      - | 9720 | `	{ "octdec", PH7_builtin_octdec         },` |
|      - | 9721 | `	{ "srand",  PH7_builtin_srand          },` |
|      - | 9722 | `	{ "mt_srand",PH7_builtin_srand         },` |
|      - | 9723 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9724 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9725 | `	{ "base_convert", PH7_builtin_base_convert },` |
|      - | 9726 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9727 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9728 | `	   /* String handling functions */` |
|      - | 9729 |  |
|      - | 9730 | `	{ "substr",          PH7_builtin_substr     },` |
|      - | 9731 | `	{ "substr_compare",  PH7_builtin_substr_compare },` |
|      - | 9732 | `	{ "substr_count",    PH7_builtin_substr_count },` |
|      - | 9733 | `	{ "substr_replace",  PH7_builtin_substr_replace },` |
|      - | 9734 | `	{ "levenshtein",     PH7_builtin_levenshtein },` |
|      - | 9735 | `	{ "similar_text",    PH7_builtin_similar_text },` |
|      - | 9736 | `	{ "str_word_count",  PH7_builtin_str_word_count },` |
|      - | 9737 | `	{ "chunk_split",     PH7_builtin_chunk_split},` |
|      - | 9738 | `	{ "addslashes" ,     PH7_builtin_addslashes },` |
|      - | 9739 | `	{ "addcslashes",     PH7_builtin_addcslashes},` |
|      - | 9740 | `	{ "quotemeta",       PH7_builtin_quotemeta  },` |
|      - | 9741 | `	{ "stripslashes",    PH7_builtin_stripslashes },` |
|      - | 9742 | `	{ "htmlspecialchars",PH7_builtin_htmlspecialchars },` |
|      - | 9743 | `	{ "htmlspecialchars_decode", PH7_builtin_htmlspecialchars_decode },` |
|      - | 9744 | `	{ "get_html_translation_table",PH7_builtin_get_html_translation_table },` |
|      - | 9745 | `	{ "htmlentities",PH7_builtin_htmlentities},` |
|      - | 9746 | `	{ "html_entity_decode", PH7_builtin_html_entity_decode},` |
|      - | 9747 | `	{ "strlen"     , PH7_builtin_strlen     },` |
|      - | 9748 | `	{ "strcmp"     , PH7_builtin_strcmp     },` |
|      - | 9749 | `	{ "strcoll"    , PH7_builtin_strcmp     },` |
|      - | 9750 | `	{ "strnatcmp"  , PH7_builtin_strnatcmp  },` |
|      - | 9751 | `	{ "strnatcasecmp", PH7_builtin_strnatcmp },` |
|      - | 9752 | `	{ "strncmp"    , PH7_builtin_strncmp    },` |
|      - | 9753 | `	{ "strcasecmp" , PH7_builtin_strcasecmp },` |
|      - | 9754 | `	{ "strncasecmp", PH7_builtin_strncasecmp},` |
|      - | 9755 | `	{ "implode"    , PH7_builtin_implode    },` |
|      - | 9756 | `	{ "join"       , PH7_builtin_implode    },` |
|      - | 9757 | `	{ "implode_recursive" , PH7_builtin_implode_recursive },` |
|      - | 9758 | `	{ "join_recursive"    , PH7_builtin_implode_recursive },` |
|      - | 9759 | `	{ "explode"     , PH7_builtin_explode    },` |
|      - | 9760 | `	{ "trim"        , PH7_builtin_trim       },` |
|      - | 9761 | `	{ "rtrim"       , PH7_builtin_rtrim      },` |
|      - | 9762 | `	{ "chop"        , PH7_builtin_rtrim      },` |
|      - | 9763 | `	{ "ltrim"       , PH7_builtin_ltrim      },` |
|      - | 9764 | `	{ "strtolower",   PH7_builtin_strtolower },` |
|      - | 9765 | `	{ "mb_strtolower",PH7_builtin_mb_case_f }, /* UTF-8 only (builtin_mb.c) */` |
|      - | 9766 | `	{ "strtoupper",   PH7_builtin_strtoupper },` |
|      - | 9767 | `	{ "mb_strtoupper",PH7_builtin_mb_case_f }, /* UTF-8 only (builtin_mb.c) */` |
|      - | 9768 | `	{ "mb_strlen",    PH7_builtin_mb_strlen_f },` |
|      - | 9769 | `	{ "mb_substr",    PH7_builtin_mb_substr_f },` |
|      - | 9770 | `	{ "mb_convert_case", PH7_builtin_mb_convert_case_f },` |
|      - | 9771 | `	{ "mb_strpos",    PH7_builtin_mb_strpos_f },` |
|      - | 9772 | `	{ "mb_stripos",   PH7_builtin_mb_strpos_f },` |
|      - | 9773 | `	{ "mb_strrpos",   PH7_builtin_mb_strpos_f },` |
|      - | 9774 | `	{ "mb_str_split", PH7_builtin_mb_str_split_f },` |
|      - | 9775 | `	{ "mb_internal_encoding", PH7_builtin_mb_internal_encoding_f },` |
|      - | 9776 | `	{ "mb_check_encoding",    PH7_builtin_mb_check_encoding_f },` |
|      - | 9777 | `	{ "mb_strwidth",  PH7_builtin_mb_strwidth_f },` |
|      - | 9778 | `	{ "mb_chr",       PH7_builtin_mb_chr_f   },` |
|      - | 9779 | `	{ "mb_ord",       PH7_builtin_mb_ord_f   },` |
|      - | 9780 | `	{ "ucfirst",      PH7_builtin_ucfirst    },` |
|      - | 9781 | `	{ "lcfirst",      PH7_builtin_lcfirst    },` |
|      - | 9782 | `	{ "ord",          PH7_builtin_ord        },` |
|      - | 9783 | `	{ "chr",          PH7_builtin_chr        },` |
|      - | 9784 | `	{ "bin2hex",      PH7_builtin_bin2hex    },` |
|      - | 9785 | `	{ "strstr",       PH7_builtin_strstr     },` |
|      - | 9786 | `	{ "stristr",      PH7_builtin_stristr    },` |
|      - | 9787 | `	{ "strchr",       PH7_builtin_strstr     },` |
|      - | 9788 | `	{ "strpos",       PH7_builtin_strpos     },` |
|      - | 9789 | `	{ "stripos",      PH7_builtin_stripos    },` |
|      - | 9790 | `	{ "strrpos",      PH7_builtin_strrpos    },` |
|      - | 9791 | `	{ "strripos",     PH7_builtin_strripos   },` |
|      - | 9792 | `	{ "strrchr",      PH7_builtin_strrchr    },` |
|      - | 9793 | `	{ "strrev",       PH7_builtin_strrev     },` |
|      - | 9794 | `	{ "ucwords",      PH7_builtin_ucwords    },` |
|      - | 9795 | `	{ "str_repeat",   PH7_builtin_str_repeat },` |
|      - | 9796 | `	{ "str_contains", PH7_builtin_str_contains },` |
|      - | 9797 | `	{ "str_starts_with", PH7_builtin_str_starts_with },` |
|      - | 9798 | `	{ "str_ends_with", PH7_builtin_str_ends_with },` |
|      - | 9799 | `	{ "nl2br",        PH7_builtin_nl2br      },` |
|      - | 9800 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9801 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9802 | `	{ "sprintf",      PH7_builtin_sprintf    },` |
|      - | 9803 | `	{ "printf",       PH7_builtin_printf     },` |
|      - | 9804 | `	{ "vprintf",      PH7_builtin_vprintf    },` |
|      - | 9805 | `	{ "vsprintf",     PH7_builtin_vsprintf   },` |
|      - | 9806 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9807 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9808 | `	{ "size_format",  PH7_builtin_size_format},` |
|      - | 9809 |  |
|      - | 9810 |  |
|      - | 9811 | `#ifndef PH7_DISABLE_HASH_FUNC` |
|      - | 9812 | `	{ "md5",          PH7_builtin_md5       },` |
|      - | 9813 | `	{ "sha1",         PH7_builtin_sha1      },` |
|      - | 9814 | `	{ "crc32",        PH7_builtin_crc32     },` |
|      - | 9815 | `	{ "hash",         PH7_builtin_hash      },` |
|      - | 9816 | `	{ "hash_hmac",    PH7_builtin_hash_hmac },` |
|      - | 9817 | `	{ "hash_equals",  PH7_builtin_hash_equals },` |
|      - | 9818 | `	{ "hash_algos",   PH7_builtin_hash_algos },` |
|      - | 9819 | `#endif /* PH7_DISABLE_HASH_FUNC */` |
|      - | 9820 | `	{ "password_hash",         PH7_builtin_password_hash },` |
|      - | 9821 | `	{ "password_verify",       PH7_builtin_password_verify },` |
|      - | 9822 | `	{ "password_get_info",     PH7_builtin_password_get_info },` |
|      - | 9823 | `	{ "password_needs_rehash", PH7_builtin_password_needs_rehash },` |
|      - | 9824 | `	{ "filter_var",            PH7_builtin_filter_var },` |
|      - | 9825 | `	{ "filter_input",          PH7_builtin_filter_input },` |
|      - | 9826 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9827 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9828 | `	{ "str_getcsv",   PH7_builtin_str_getcsv },` |
|      - | 9829 | `	{ "strip_tags",   PH7_builtin_strip_tags },` |
|      - | 9830 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9831 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9832 |  |
|      - | 9833 | `	{ "str_shuffle",  PH7_builtin_str_shuffle},` |
|      - | 9834 | `	{ "str_split",    PH7_builtin_str_split  },` |
|      - | 9835 | `	{ "strspn",       PH7_builtin_strspn     },` |
|      - | 9836 | `	{ "strcspn",      PH7_builtin_strcspn    },` |
|      - | 9837 | `	{ "strpbrk",      PH7_builtin_strpbrk    },` |
|      - | 9838 | `	{ "soundex",      PH7_builtin_soundex    },` |
|      - | 9839 | `	{ "wordwrap",     PH7_builtin_wordwrap   },` |
|      - | 9840 | `	{ "strtok",       PH7_builtin_strtok     },` |
|      - | 9841 | `	{ "str_pad",      PH7_builtin_str_pad    },` |
|      - | 9842 | `	{ "str_replace",  PH7_builtin_str_replace},` |
|      - | 9843 | `	{ "str_ireplace", PH7_builtin_str_replace},` |
|      - | 9844 | `	{ "strtr",        PH7_builtin_strtr      },` |
|      - | 9845 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9846 | `#ifdef PH7_NEED_FMT_AND_INI` |
|      - | 9847 | `	{ "parse_ini_string", PH7_builtin_parse_ini_string},` |
|      - | 9848 | `#endif /* PH7_NEED_FMT_AND_INI */` |
|      - | 9849 | `#ifdef PH7_NEED_BUILTIN_REG` |
|      - | 9850 |  |
|      - | 9851 | `	         /* Ctype functions */` |
|      - | 9852 | `	{ "ctype_alnum", PH7_builtin_ctype_alnum },` |
|      - | 9853 | `	{ "ctype_alpha", PH7_builtin_ctype_alpha },` |
|      - | 9854 | `	{ "ctype_cntrl", PH7_builtin_ctype_cntrl },` |
|      - | 9855 | `	{ "ctype_digit", PH7_builtin_ctype_digit },` |
|      - | 9856 | `	{ "ctype_xdigit",PH7_builtin_ctype_xdigit},` |
|      - | 9857 | `	{ "ctype_graph", PH7_builtin_ctype_graph },` |
|      - | 9858 | `	{ "ctype_print", PH7_builtin_ctype_print },` |
|      - | 9859 | `	{ "ctype_punct", PH7_builtin_ctype_punct },` |
|      - | 9860 | `	{ "ctype_space", PH7_builtin_ctype_space },` |
|      - | 9861 | `	{ "ctype_lower", PH7_builtin_ctype_lower },` |
|      - | 9862 | `	{ "ctype_upper", PH7_builtin_ctype_upper },` |
|      - | 9863 | `	         /* Time functions */` |
|      - | 9864 | `	{ "time"    ,    PH7_builtin_time         },` |
|      - | 9865 | `	{ "microtime",   PH7_builtin_microtime    },` |
|      - | 9866 | `	{ "hrtime",      PH7_builtin_hrtime       },` |
|      - | 9867 | `	{ "getdate" ,    PH7_builtin_getdate      },` |
|      - | 9868 | `	{ "gettimeofday",PH7_builtin_gettimeofday },` |
|      - | 9869 | `	{ "date",        PH7_builtin_date         },` |
|      - | 9870 | `	{ "strftime",    PH7_builtin_strftime     },` |
|      - | 9871 | `	{ "idate",       PH7_builtin_idate        },` |
|      - | 9872 | `	{ "gmdate",      PH7_builtin_gmdate       },` |
|      - | 9873 | `	{ "localtime",   PH7_builtin_localtime    },` |
|      - | 9874 | `	{ "mktime",      PH7_builtin_mktime       },` |
|      - | 9875 | `	{ "gmmktime",    PH7_builtin_mktime       },` |
|      - | 9876 | `	{ "date_default_timezone_get", PH7_builtin_date_default_timezone_get },` |
|      - | 9877 | `	{ "date_default_timezone_set", PH7_builtin_date_default_timezone_set },` |
|      - | 9878 | `	        /* URL functions */` |
|      - | 9879 | `	{ "base64_encode",PH7_builtin_base64_encode },` |
|      - | 9880 | `	{ "base64_decode",PH7_builtin_base64_decode },` |
|      - | 9881 | `	{ "convert_uuencode",PH7_builtin_base64_encode },` |
|      - | 9882 | `	{ "convert_uudecode",PH7_builtin_base64_decode },` |
|      - | 9883 | `	{ "urlencode",    PH7_builtin_urlencode },` |
|      - | 9884 | `	{ "urldecode",    PH7_builtin_urldecode },` |
|      - | 9885 | `	{ "rawurlencode", PH7_builtin_rawurlencode },` |
|      - | 9886 | `	{ "rawurldecode", PH7_builtin_urldecode },` |
|      - | 9887 | `#endif /* PH7_NEED_BUILTIN_REG */` |
|      - | 9888 | `};` |
|      - | 9889 | `/*` |
|      - | 9890 | ` * Register the built-in functions defined above,the array functions` |
|      - | 9891 | ` * defined in hashmap.c and the IO functions defined in vfs.c.` |
|      - | 9892 | ` */` |
|   3368 | 9893 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 9894 | `{` |
|      - | 9895 | `	sxu32 n;` |
| 693813 | 9896 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 690445 | 9897 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 345225 | 9898 | `	}` |
|      - | 9899 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3373 | 9900 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 9901 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3373 | 9902 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3373 | 9903 | `}` |
|      - | 9904 |  |
