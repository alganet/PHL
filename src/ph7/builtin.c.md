...
|      - |  302 | ` */` |
|  33976 |  303 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  304 | `{` |
|  33981 |  305 | `	int res = 1; /* Assume empty by default */` |
|  33981 |  306 | `	if( nArg > 0 ){` |
|  33979 |  307 | `		res = ph7_value_is_empty(apArg[0]);` |
|  16987 |  308 | `	}` |
|  33981 |  309 | `	ph7_result_bool(pCtx,res);` |
|  33981 |  310 | `	return PH7_OK;` |
|      - |  311 |  |
|      5 |  312 | `}` |
...
|      - |  352 | ` */` |
| 224262 |  353 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  354 | `{` |
|      - |  355 | `	const char *zSource,*zOfft;` |
|      - |  356 | `	int nOfft,nLen,nSrcLen;` |
| 224267 |  357 | `	if( nArg < 2 ){` |
|      - |  358 | `		/* return FALSE */` |
|    ! 0 |  359 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  360 | `		return PH7_OK;` |
|      - |  361 | `	}` |
|      - |  362 | `	/* Extract the target string */` |
| 224267 |  363 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 224267 |  364 | `	if( nSrcLen < 1 ){` |
|      - |  365 | `		/* Empty string,return FALSE */` |
|  12127 |  366 | `		ph7_result_bool(pCtx,0);` |
|  12127 |  367 | `		return PH7_OK;` |
|      - |  368 | `	}` |
| 212145 |  369 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  370 | `	/* Extract the offset */` |
| 212145 |  371 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 212145 |  372 | `	if( nOfft < 0 ){` |
|  32779 |  373 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  32779 |  374 | `		if( zOfft < zSource ){` |
|      - |  375 | `			/* Invalid offset */` |
|      5 |  376 | `			ph7_result_bool(pCtx,0);` |
|      5 |  377 | `			return PH7_OK;` |
|      - |  378 | `		}` |
|  32775 |  379 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  32775 |  380 | `		nOfft = (int)(zOfft-zSource);` |
| 195756 |  381 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  382 | `		/* Invalid offset */` |
|    217 |  383 | `		ph7_result_bool(pCtx,0);` |
|    217 |  384 | `		return PH7_OK;` |
|    ! 0 |  385 | `	}else{` |
| 179159 |  386 | `		zOfft = &zSource[nOfft];` |
| 179159 |  387 | `		nLen = nSrcLen - nOfft;` |
|      - |  388 | `	}` |
| 211929 |  389 | `	if( nArg > 2 ){` |
|      - |  390 | `		/* Extract the length */` |
| 174763 |  391 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 174763 |  392 | `		if( nLen == 0 ){` |
|      - |  393 | `			/* Invalid length,return an empty string */` |
|      5 |  394 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  395 | `			return PH7_OK;` |
| 174759 |  396 | `		}else if( nLen < 0 ){` |
|  32767 |  397 | `			nLen = nSrcLen + nLen - nOfft;` |
|  32767 |  398 | `			if( nLen < 1 ){` |
|      - |  399 | `				/* Invalid  length */` |
|      3 |  400 | `				nLen = nSrcLen - nOfft;` |
|      1 |  401 | `			}` |
|  16381 |  402 | `		}` |
| 174759 |  403 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  404 | `			/* Invalid length */` |
|   5627 |  405 | `			nLen = nSrcLen - nOfft;` |
|   2811 |  406 | `		}` |
|  87377 |  407 | `	}` |
|      - |  408 | `	/* Return the substring */` |
| 211925 |  409 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 211925 |  410 | `	return PH7_OK;` |
| 112136 |  411 | `}` |
|      - |  412 | `/*` |
...
|      - | 2133 | ` */` |
| 142272 | 2134 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2135 | `{` |
|  71136 | 2136 | `	SXUNUSED(pKey);` |
| 142277 | 2137 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2138 | `	const char *zData;` |
|      - | 2139 | `	int nLen;` |
| 142277 | 2140 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 142275 | 2164 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2165 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 142275 | 2166 | `	if( pData->bFirst ){` |
|  33203 | 2167 | `		pData->bFirst = 0;` |
| 125676 | 2168 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2169 | `		/* append the separator first */` |
| 109065 | 2170 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 142275 | 2176 | `	if( nLen > 0 ){` |
| 130153 | 2177 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2178 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2179 | `			return PH7_ABORT;` |
|      - | 2180 | `		}` |
|  65074 | 2181 | `	}` |
| 142275 | 2182 | `	return PH7_OK;` |
|  71141 | 2183 | `}` |
|      - | 2184 | `/*` |
...
|      - | 2196 | ` */` |
|  33224 | 2197 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2198 | `{` |
|      - | 2199 | `	struct implode_data imp_data;` |
|  33229 | 2200 | `	int i = 1;` |
|  33229 | 2201 | `	if( nArg < 1 ){` |
|      - | 2202 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2203 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2204 | `		return PH7_OK;` |
|      - | 2205 | `	}` |
|      - | 2206 | `	/* Prepare the implode context */` |
|  33229 | 2207 | `	imp_data.pCtx = pCtx;` |
|  33229 | 2208 | `	imp_data.bRecursive = 0;` |
|  33229 | 2209 | `	imp_data.bFirst = 1;` |
|  33229 | 2210 | `	imp_data.nRecCount = 0;` |
|  33229 | 2211 | `	imp_data.rc = SXRET_OK;` |
|  33229 | 2212 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33227 | 2213 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16616 | 2214 | `	}else{` |
|      3 | 2215 | `		imp_data.zSep = 0;` |
|      3 | 2216 | `		imp_data.nSeplen = 0;` |
|      3 | 2217 | `		i = 0;` |
|      - | 2218 | `	}` |
|  33229 | 2219 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2220 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2221 | `	}` |
|      - | 2222 | `	/* Start the 'join' process */` |
|  66453 | 2223 | `	while( i < nArg ){` |
|  33229 | 2224 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2225 | `			/* Iterate throw array entries */` |
|  33229 | 2226 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2227 | `			/* Surface a callback allocation failure as a fatal */` |
|  33229 | 2228 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2353 | ` */` |
|   6462 | 2354 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2355 | `{` |
...
|   6467 | 2368 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6467 | 2369 | `	if( nDelim < 1 ){` |
...
|   6463 | 2375 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6463 | 2376 | `	if( nStrlen < 1 ){` |
...
|   6457 | 2402 | `	zEnd = &zString[nStrlen];` |
|      - | 2403 | `	/* Create the array */` |
|   6457 | 2404 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6457 | 2405 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6457 | 2406 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2407 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2408 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2409 | `		return PH7_OK;` |
|      - | 2410 | `	}` |
|      - | 2411 | `	/* Set a defualt limit */` |
|   6457 | 2412 | `	iLimit = SXI32_HIGH;` |
|   6457 | 2413 | `	if( nArg > 2 ){` |
...
|  76994 | 2448 | `	for(;;){` |
| 153993 | 2449 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 153993 | 2450 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2451 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6441 | 2452 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6441 | 2453 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2454 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2455 | `			}` |
|   6441 | 2456 | `			break;` |
|      - | 2457 | `		}` |
|      - | 2458 | `		/* Point to the desired offset */` |
| 147557 | 2459 | `		zCur = &zString[nOfft];` |
|      - | 2460 | `		/* Perform the store operation (may be empty) */` |
| 147557 | 2461 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 147557 | 2462 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2463 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2464 | `		}` |
|      - | 2465 | `		/* Point beyond the delimiter */` |
| 147557 | 2466 | `		zString = &zCur[nDelim];` |
|      - | 2467 | `		/* Reset the cursor */` |
| 147557 | 2468 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2469 | `	}` |
|      - | 2470 | `	/* Return the freshly created array */` |
|   6441 | 2471 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2472 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2473 | `	 * released as soon we return from this foregin function.` |
|      - | 2474 | `	 */` |
|   6441 | 2475 | `	return PH7_OK;` |
|   3236 | 2476 | `}` |
|      - | 2477 | `/*` |
...
|      - | 2491 | ` */` |
|  14578 | 2492 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2493 | `{` |
|      - | 2494 | `	const char *zString;` |
|      - | 2495 | `	int nLen;` |
|  14583 | 2496 | `	if( nArg < 1 ){` |
|      - | 2497 | `		/* Missing arguments,return null */` |
|    ! 0 | 2498 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2499 | `		return PH7_OK;` |
|      - | 2500 | `	}` |
|      - | 2501 | `	/* Extract the target string */` |
|  14583 | 2502 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14583 | 2503 | `	if( nLen < 1 ){` |
|      - | 2504 | `		/* Empty string,return */` |
|   1309 | 2505 | `		ph7_result_string(pCtx,"",0);` |
|   1309 | 2506 | `		return PH7_OK;` |
|      - | 2507 | `	}` |
|      - | 2508 | `	/* Start the trim process */` |
|  13279 | 2509 | `	if( nArg < 2 ){` |
|      - | 2510 | `		SyString sStr;` |
|      - | 2511 | `		/* Remove white spaces and NUL bytes */` |
|  13249 | 2512 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  33235 | 2513 | `		SyStringFullTrimSafe(&sStr);` |
|  13249 | 2514 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6627 | 2515 | `	}else{` |
|      - | 2516 | `		/* Char list */` |
...
|    ! 0 | 2717 | `		}else{` |
| 176385 | 2718 | `			int c = zString[0];` |
| 176385 | 2719 | `			if( SyisUpper(c) ){` |
| 174039 | 2720 | `				c = SyToLower(zString[0]);` |
|  87017 | 2721 | `			}` |
|      - | 2722 | `			/* Append character */` |
| 176385 | 2723 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2724 | `			/* Advance the cursor */` |
| 176385 | 2725 | `			zString++;` |
|      - | 2726 | `		}` |
|      5 | 2727 | `	}` |
|  33195 | 2728 | `	return PH7_OK;` |
|  16601 | 2729 | `}` |
|      - | 2730 | `/*` |
...
|      - | 8000 | ` */` |
|  29374 | 8001 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8002 | `{` |
...
|      - | 8011 | `	int nByte;` |
|      - | 8012 | `	sxi32 rc;` |
|  29379 | 8013 | `	if( nArg < 3 ){` |
|      - | 8014 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8015 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8016 | `		return PH7_OK;` |
|      - | 8017 | `	}` |
|      - | 8018 | `	/* Initialize fields */` |
|  29379 | 8019 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29379 | 8020 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29379 | 8021 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  29379 | 8022 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  29379 | 8023 | `	sRep.pCtx = pCtx;` |
|  29379 | 8024 | `	sRep.pCollector = &sSearch;` |
|  29379 | 8025 | `	rep_str = 0;` |
|      - | 8026 | `	/* Extract the subject */` |
|  29379 | 8027 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  29379 | 8028 | `	if( nByte < 1 ){` |
...
|  29351 | 8034 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8035 | `	/* Search string */` |
|  29351 | 8036 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8037 | `		/* Collect search string */` |
|      9 | 8038 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 8039 | `	}else{` |
|      - | 8040 | `		/* Single pattern */` |
|  29343 | 8041 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29343 | 8042 | `		if( nByte < 1 ){` |
...
|      - | 8046 | `		}` |
|  29339 | 8047 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8048 | `		/* Save for later processing */` |
|  29339 | 8049 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8050 | `	}` |
|      - | 8051 | `	/* Replace string */` |
|  29347 | 8052 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8053 | `		/* Collect replace string */` |
|      7 | 8054 | `		sRep.pCollector = &sReplace;` |
|      7 | 8055 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8056 | `	}else{` |
|      - | 8057 | `		/* Single needle */` |
|  29341 | 8058 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  29341 | 8059 | `		rep_str = 1;` |
|  29341 | 8060 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8061 | `		/* Save for later processing */` |
|  29341 | 8062 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8063 | `	}` |
|      - | 8064 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  29347 | 8065 | `	if( sRep.rc != SXRET_OK ){` |
...
|  29347 | 8072 | `	SySetResetCursor(&sSearch);` |
|  29347 | 8073 | `	SySetResetCursor(&sReplace);` |
|  29347 | 8074 | `	pReplace = pSearch = 0; /* cc warning */` |
|  29347 | 8075 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8076 | `	/* Extract function name */` |
|  29347 | 8077 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8078 | `	/* Set the default pattern match routine */` |
|  29347 | 8079 | `	xMatch = SyBlobSearch;` |
|  29347 | 8080 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8081 | `		/* Case insensitive pattern match */` |
|     11 | 8082 | `		xMatch = iPatternMatch;` |
|      5 | 8083 | `	}` |
|      - | 8084 | `	/* Start the replace process */` |
|  58697 | 8085 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8086 | `		sxu32 nCount,nOfft;` |
|  29355 | 8087 | `		if( pSearch->nByte <  1 ){` |
|      - | 8088 | `			/* Empty string,ignore */` |
|      3 | 8089 | `			continue;` |
|      - | 8090 | `		}` |
|      - | 8091 | `		/* Extract the replace string */` |
|  29353 | 8092 | `		if( rep_str ){` |
|  29343 | 8093 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14674 | 8094 | `		}else{` |
...
|      1 | 8100 | `			}` |
|      - | 8101 | `		}` |
|  29353 | 8102 | `		if( pReplace == 0 ){` |
|      - | 8103 | `			/* Use an empty string instead */` |
|      3 | 8104 | `			pReplace = &sTemp;` |
|      1 | 8105 | `		}` |
|  29353 | 8106 | `		nOfft = nCount = 0;` |
|  14697 | 8107 | `		for(;;){` |
|  29399 | 8108 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8109 | `				break;` |
|      - | 8110 | `			}` |
|      - | 8111 | `			/* Perform a pattern lookup */` |
|  44078 | 8112 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  29382 | 8113 | `				pSearch->nByte,&nOfft);` |
|  29387 | 8114 | `			if( rc != SXRET_OK ){` |
...
|  29347 | 8132 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  29347 | 8133 | `	SySetRelease(&sSearch);` |
|  29347 | 8134 | `	SySetRelease(&sReplace);` |
|  29347 | 8135 | `	SyBlobRelease(&sWorker);` |
|  29347 | 8136 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8137 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8138 | `	}` |
|  29347 | 8139 | `	return PH7_OK;` |
|  14692 | 8140 | `}` |
|      - | 8141 | `/*` |
...
|      - | 8969 | ` */` |
|  63310 | 8970 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8971 | `{` |
|      - | 8972 | `	const unsigned char *zIn,*zEnd;` |
|      - | 8973 | `	int nLen;` |
|  63315 | 8974 | `	if( nArg < 1 ){` |
|      - | 8975 | `		/* Missing arguments,return FALSE */` |
|    ! 0 | 8976 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 8977 | `		return PH7_OK;` |
|      - | 8978 | `	}` |
|      - | 8979 | `	/* Extract the target string */` |
|  63315 | 8980 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  63315 | 8981 | `	zEnd = &zIn[nLen];` |
|  63315 | 8982 | `	if( nLen < 1 ){` |
...
|  61187 | 9005 | `	ph7_result_bool(pCtx,0);` |
|  61187 | 9006 | `	return PH7_OK;` |
|  31703 | 9007 | `}` |
|      - | 9008 | `/*` |
