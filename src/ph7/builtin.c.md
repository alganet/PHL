...
|      - |  294 | ` */` |
|  27000 |  295 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  296 |  |
|  27005 |  297 | `	int res = 1; /* Assume empty by default */` |
|  27005 |  298 | `	if( nArg > 0 ){` |
|  27003 |  299 | `		res = ph7_value_is_empty(apArg[0]);` |
|  13499 |  300 | `	}` |
|  27005 |  301 | `	ph7_result_bool(pCtx,res);` |
|  27005 |  302 | `	return PH7_OK;` |
|      - |  303 |  |
|      5 |  304 |  |
...
|      - |  344 | ` */` |
| 201666 |  345 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  346 |  |
|      - |  347 | `	const char *zSource,*zOfft;` |
|      - |  348 | `	int nOfft,nLen,nSrcLen;` |
| 201671 |  349 | `	if( nArg < 2 ){` |
|      - |  350 | `		/* return FALSE */` |
|      5 |  351 | `		ph7_result_bool(pCtx,0);` |
|      5 |  352 | `		return PH7_OK;` |
|      - |  353 | `	}` |
|      - |  354 | `	/* Extract the target string */` |
| 201667 |  355 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 201667 |  356 | `	if( nSrcLen < 1 ){` |
|      - |  357 | `		/* Empty string,return FALSE */` |
|  11485 |  358 | `		ph7_result_bool(pCtx,0);` |
|  11485 |  359 | `		return PH7_OK;` |
|      - |  360 | `	}` |
| 190187 |  361 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  362 | `	/* Extract the offset */` |
| 190187 |  363 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 190187 |  364 | `	if( nOfft < 0 ){` |
|  31339 |  365 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  31339 |  366 | `		if( zOfft < zSource ){` |
|      - |  367 | `			/* Invalid offset */` |
|      5 |  368 | `			ph7_result_bool(pCtx,0);` |
|      5 |  369 | `			return PH7_OK;` |
|      - |  370 | `		}` |
|  31335 |  371 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  31335 |  372 | `		nOfft = (int)(zOfft-zSource);` |
| 174518 |  373 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  374 | `		/* Invalid offset */` |
|    179 |  375 | `		ph7_result_bool(pCtx,0);` |
|    179 |  376 | `		return PH7_OK;` |
|    ! 0 |  377 | `	}else{` |
| 158679 |  378 | `		zOfft = &zSource[nOfft];` |
| 158679 |  379 | `		nLen = nSrcLen - nOfft;` |
|      - |  380 | `	}` |
| 190009 |  381 | `	if( nArg > 2 ){` |
|      - |  382 | `		/* Extract the length */` |
| 157045 |  383 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 157045 |  384 | `		if( nLen == 0 ){` |
|      - |  385 | `			/* Invalid length,return an empty string */` |
|      5 |  386 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  387 | `			return PH7_OK;` |
| 157041 |  388 | `		}else if( nLen < 0 ){` |
|  31327 |  389 | `			nLen = nSrcLen + nLen - nOfft;` |
|  31327 |  390 | `			if( nLen < 1 ){` |
|      - |  391 | `				/* Invalid  length */` |
|      3 |  392 | `				nLen = nSrcLen - nOfft;` |
|      1 |  393 | `			}` |
|  15661 |  394 | `		}` |
| 157041 |  395 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  396 | `			/* Invalid length */` |
|   4673 |  397 | `			nLen = nSrcLen - nOfft;` |
|   2334 |  398 | `		}` |
|  78518 |  399 | `	}` |
|      - |  400 | `	/* Return the substring */` |
| 190005 |  401 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 190005 |  402 | `	return PH7_OK;` |
| 100838 |  403 |  |
|      - |  404 | `/*` |
...
|      - | 1525 | ` */` |
| 126746 | 1526 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1527 |  |
|  63373 | 1528 | `	SXUNUSED(pKey);` |
| 126751 | 1529 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1530 | `	const char *zData;` |
|      - | 1531 | `	int nLen;` |
| 126751 | 1532 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 126749 | 1556 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1557 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 126749 | 1558 | `	if( pData->bFirst ){` |
|  31651 | 1559 | `		pData->bFirst = 0;` |
| 110926 | 1560 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1561 | `		/* append the separator first */` |
|  95091 | 1562 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 126749 | 1568 | `	if( nLen > 0 ){` |
| 115269 | 1569 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1570 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1571 | `			return PH7_ABORT;` |
|      - | 1572 | `		}` |
|  57632 | 1573 | `	}` |
| 126749 | 1574 | `	return PH7_OK;` |
|  63378 | 1575 |  |
|      - | 1576 | `/*` |
...
|      - | 1588 | ` */` |
|  31672 | 1589 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1590 |  |
|      - | 1591 | `	struct implode_data imp_data;` |
|  31677 | 1592 | `	int i = 1;` |
|  31677 | 1593 | `	if( nArg < 1 ){` |
|      - | 1594 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1595 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1596 | `		return PH7_OK;` |
|      - | 1597 | `	}` |
|      - | 1598 | `	/* Prepare the implode context */` |
|  31677 | 1599 | `	imp_data.pCtx = pCtx;` |
|  31677 | 1600 | `	imp_data.bRecursive = 0;` |
|  31677 | 1601 | `	imp_data.bFirst = 1;` |
|  31677 | 1602 | `	imp_data.nRecCount = 0;` |
|  31677 | 1603 | `	imp_data.rc = SXRET_OK;` |
|  31677 | 1604 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  31675 | 1605 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  15840 | 1606 | `	}else{` |
|      3 | 1607 | `		imp_data.zSep = 0;` |
|      3 | 1608 | `		imp_data.nSeplen = 0;` |
|      3 | 1609 | `		i = 0;` |
|      - | 1610 | `	}` |
|  31677 | 1611 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1612 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1613 | `	}` |
|      - | 1614 | `	/* Start the 'join' process */` |
|  63349 | 1615 | `	while( i < nArg ){` |
|  31677 | 1616 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1617 | `			/* Iterate throw array entries */` |
|  31677 | 1618 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1619 | `			/* Surface a callback allocation failure as a fatal */` |
|  31677 | 1620 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 1745 | ` */` |
|   5968 | 1746 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1747 |  |
...
|   5965 | 1760 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   5965 | 1761 | `	if( nDelim < 1 ){` |
|      - | 1762 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1763 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1764 | `		return PH7_OK;` |
|      - | 1765 | `	}` |
|      - | 1766 | `	/* Extract the string */` |
|   5963 | 1767 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   5963 | 1768 | `	if( nStrlen < 1 ){` |
...
|   5961 | 1785 | `	zEnd = &zString[nStrlen];` |
|      - | 1786 | `	/* Create the array */` |
|   5961 | 1787 | `	pArray =  ph7_context_new_array(pCtx);` |
|   5961 | 1788 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   5961 | 1789 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1790 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1791 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1792 | `		return PH7_OK;` |
|      - | 1793 | `	}` |
|      - | 1794 | `	/* Set a defualt limit */` |
|   5961 | 1795 | `	iLimit = SXI32_HIGH;` |
|   5961 | 1796 | `	if( nArg > 2 ){` |
...
|  68620 | 1807 | `	for(;;){` |
| 137245 | 1808 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 137245 | 1809 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1810 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   5961 | 1811 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   5961 | 1812 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1813 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 1814 | `			}` |
|   5961 | 1815 | `			break;` |
|      - | 1816 | `		}` |
|      - | 1817 | `		/* Point to the desired offset */` |
| 131289 | 1818 | `		zCur = &zString[nOfft];` |
|      - | 1819 | `		/* Perform the store operation (may be empty) */` |
| 131289 | 1820 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 131289 | 1821 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1822 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 1823 | `		}` |
|      - | 1824 | `		/* Point beyond the delimiter */` |
| 131289 | 1825 | `		zString = &zCur[nDelim];` |
|      - | 1826 | `		/* Reset the cursor */` |
| 131289 | 1827 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 1828 | `	}` |
|      - | 1829 | `	/* Return the freshly created array */` |
|   5961 | 1830 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1831 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1832 | `	 * released as soon we return from this foregin function.` |
|      - | 1833 | `	 */` |
|   5961 | 1834 | `	return PH7_OK;` |
|   2989 | 1835 |  |
|      - | 1836 | `/*` |
...
|      - | 1850 | ` */` |
|  13646 | 1851 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1852 |  |
|      - | 1853 | `	const char *zString;` |
|      - | 1854 | `	int nLen;` |
|  13651 | 1855 | `	if( nArg < 1 ){` |
|      - | 1856 | `		/* Missing arguments,return null */` |
|      3 | 1857 | `		ph7_result_null(pCtx);` |
|      3 | 1858 | `		return PH7_OK;` |
|      - | 1859 | `	}` |
|      - | 1860 | `	/* Extract the target string */` |
|  13649 | 1861 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  13649 | 1862 | `	if( nLen < 1 ){` |
|      - | 1863 | `		/* Empty string,return */` |
|   1729 | 1864 | `		ph7_result_string(pCtx,"",0);` |
|   1729 | 1865 | `		return PH7_OK;` |
|      - | 1866 | `	}` |
|      - | 1867 | `	/* Start the trim process */` |
|  11925 | 1868 | `	if( nArg < 2 ){` |
|      - | 1869 | `		SyString sStr;` |
|      - | 1870 | `		/* Remove white spaces and NUL bytes */` |
|  11921 | 1871 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  29155 | 1872 | `		SyStringFullTrimSafe(&sStr);` |
|  11921 | 1873 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   5963 | 1874 | `	}else{` |
|      - | 1875 | `		/* Char list */` |
...
|    ! 0 | 2125 | `		}else{` |
| 166097 | 2126 | `			int c = zString[0];` |
| 166097 | 2127 | `			if( SyisUpper(c) ){` |
| 166095 | 2128 | `				c = SyToLower(zString[0]);` |
|  83045 | 2129 | `			}` |
|      - | 2130 | `			/* Append character */` |
| 166097 | 2131 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2132 | `			/* Advance the cursor */` |
| 166097 | 2133 | `			zString++;` |
|      - | 2134 | `		}` |
|      5 | 2135 | `	}` |
|  31325 | 2136 | `	return PH7_OK;` |
|  15667 | 2137 |  |
|      - | 2138 | `/*` |
...
|      - | 6626 | ` */` |
|  23698 | 6627 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 6628 |  |
...
|      - | 6637 | `	int nByte;` |
|      - | 6638 | `	sxi32 rc;` |
|  23703 | 6639 | `	if( nArg < 3 ){` |
|      - | 6640 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 6641 | `		ph7_result_null(pCtx);` |
|      7 | 6642 | `		return PH7_OK;` |
|      - | 6643 | `	}` |
|      - | 6644 | `	/* Initialize fields */` |
|  23697 | 6645 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  23697 | 6646 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  23697 | 6647 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  23697 | 6648 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  23697 | 6649 | `	sRep.pCtx = pCtx;` |
|  23697 | 6650 | `	sRep.pCollector = &sSearch;` |
|  23697 | 6651 | `	rep_str = 0;` |
|      - | 6652 | `	/* Extract the subject */` |
|  23697 | 6653 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  23697 | 6654 | `	if( nByte < 1 ){` |
...
|  23669 | 6660 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 6661 | `	/* Search string */` |
|  23669 | 6662 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 6663 | `		/* Collect search string */` |
|      9 | 6664 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 6665 | `	}else{` |
|      - | 6666 | `		/* Single pattern */` |
|  23661 | 6667 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  23661 | 6668 | `		if( nByte < 1 ){` |
...
|      - | 6672 | `		}` |
|  23657 | 6673 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6674 | `		/* Save for later processing */` |
|  23657 | 6675 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 6676 | `	}` |
|      - | 6677 | `	/* Replace string */` |
|  23665 | 6678 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 6679 | `		/* Collect replace string */` |
|      7 | 6680 | `		sRep.pCollector = &sReplace;` |
|      7 | 6681 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 6682 | `	}else{` |
|      - | 6683 | `		/* Single needle */` |
|  23659 | 6684 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  23659 | 6685 | `		rep_str = 1;` |
|  23659 | 6686 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6687 | `		/* Save for later processing */` |
|  23659 | 6688 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 6689 | `	}` |
|      - | 6690 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  23665 | 6691 | `	if( sRep.rc != SXRET_OK ){` |
...
|  23665 | 6698 | `	SySetResetCursor(&sSearch);` |
|  23665 | 6699 | `	SySetResetCursor(&sReplace);` |
|  23665 | 6700 | `	pReplace = pSearch = 0; /* cc warning */` |
|  23665 | 6701 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 6702 | `	/* Extract function name */` |
|  23665 | 6703 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 6704 | `	/* Set the default pattern match routine */` |
|  23665 | 6705 | `	xMatch = SyBlobSearch;` |
|  23665 | 6706 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 6707 | `		/* Case insensitive pattern match */` |
|     11 | 6708 | `		xMatch = iPatternMatch;` |
|      5 | 6709 | `	}` |
|      - | 6710 | `	/* Start the replace process */` |
|  47333 | 6711 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 6712 | `		sxu32 nCount,nOfft;` |
|  23673 | 6713 | `		if( pSearch->nByte <  1 ){` |
|      - | 6714 | `			/* Empty string,ignore */` |
|      3 | 6715 | `			continue;` |
|      - | 6716 | `		}` |
|      - | 6717 | `		/* Extract the replace string */` |
|  23671 | 6718 | `		if( rep_str ){` |
|  23661 | 6719 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  11833 | 6720 | `		}else{` |
...
|      1 | 6726 | `			}` |
|      - | 6727 | `		}` |
|  23671 | 6728 | `		if( pReplace == 0 ){` |
|      - | 6729 | `			/* Use an empty string instead */` |
|      3 | 6730 | `			pReplace = &sTemp;` |
|      1 | 6731 | `		}` |
|  23671 | 6732 | `		nOfft = nCount = 0;` |
|  11849 | 6733 | `		for(;;){` |
|  23703 | 6734 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 6735 | `				break;` |
|      - | 6736 | `			}` |
|      - | 6737 | `			/* Perform a pattern lookup */` |
|  35534 | 6738 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  23686 | 6739 | `				pSearch->nByte,&nOfft);` |
|  23691 | 6740 | `			if( rc != SXRET_OK ){` |
...
|  23665 | 6758 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  23665 | 6759 | `	SySetRelease(&sSearch);` |
|  23665 | 6760 | `	SySetRelease(&sReplace);` |
|  23665 | 6761 | `	SyBlobRelease(&sWorker);` |
|  23665 | 6762 | `	if( rc != PH7_OK ){` |
|    ! 0 | 6763 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 6764 | `	}` |
|  23665 | 6765 | `	return PH7_OK;` |
|  11854 | 6766 |  |
|      - | 6767 | `/*` |
...
|      - | 7948 | ` */` |
|   3166 | 7949 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 7950 |  |
|      - | 7951 | `	sxu32 n;` |
| 528727 | 7952 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 525561 | 7953 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 262783 | 7954 | `	}` |
|      - | 7955 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3171 | 7956 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 7957 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3171 | 7958 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3171 | 7959 |  |
|      - | 7960 |  |
