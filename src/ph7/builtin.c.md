...
| 484116 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 484121 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|    ! 0 |   33 | `		return PH7_OK;` |
|      - |   34 | `	}` |
| 484121 |   35 | `	if( ph7_value_is_float(pArg) ){` |
...
|      3 |   54 | `		return PH7_OK;` |
|      - |   55 | `	}` |
| 484115 |   56 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   57 | `		const char *zNum;` |
|      - |   58 | `		int nSlen;` |
...
|      5 |   96 | `		return PH7_OK;` |
|      - |   97 | `	}` |
| 484101 |   98 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  111 | `			);` |
|      - |  112 | `	}` |
| 484101 |  113 | `	*pOut = ph7_value_to_int64(pArg);` |
| 484101 |  114 | `	return PH7_OK;` |
| 242063 |  115 | `}` |
|      - |  116 |  |
...
|      - |  198 | ` */` |
|   1060 |  199 | `static int PH7_builtin_is_string(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 |  200 | `{` |
|   1063 |  201 | `	int res = 0; /* Assume false by default */` |
|   1063 |  202 | `	if( nArg > 0 ){` |
|   1063 |  203 | `		res = ph7_value_is_string(apArg[0]);` |
|    530 |  204 | `	}` |
|      - |  205 | `	/* Query result */` |
|   1063 |  206 | `	ph7_result_bool(pCtx,res);` |
|   1063 |  207 | `	return PH7_OK;` |
|      3 |  208 | `}` |
|      - |  209 | `/*` |
...
|      - |  410 | ` */` |
|  33658 |  411 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  412 | `{` |
|  33663 |  413 | `	int res = 1; /* Assume empty by default */` |
|  33663 |  414 | `	if( nArg > 0 ){` |
|  33661 |  415 | `		res = ph7_value_is_empty(apArg[0]);` |
|  16828 |  416 | `	}` |
|  33663 |  417 | `	ph7_result_bool(pCtx,res);` |
|  33663 |  418 | `	return PH7_OK;` |
|      - |  419 |  |
|      5 |  420 | `}` |
...
|      - |  460 | ` */` |
| 266944 |  461 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  462 | `{` |
|      - |  463 | `	const char *zSource;` |
|      - |  464 | `	int nSrcLen;` |
|      - |  465 | `	sxi64 iStart,iEnd;` |
| 266949 |  466 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 266949 |  467 | `	if( nArg < 2 ){` |
...
| 266949 |  473 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |  474 | `	/* Extract the offset */` |
|      - |  475 | `	{` |
| 266949 |  476 | `		sxi64 iTmp = 0;` |
| 266949 |  477 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 266949 |  478 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  479 | `			return rcArg;` |
|      - |  480 | `		}` |
| 266949 |  481 | `		iStart = iTmp;` |
|      - |  482 | `	}` |
|      - |  483 | `	/*` |
...
|      - |  492 | `	 */` |
| 266949 |  493 | `	if( iStart < 0 ){` |
|  33065 |  494 | `		iStart += nSrcLen;` |
|  33065 |  495 | `		if( iStart < 0 ){` |
|      5 |  496 | `			iStart = 0;` |
|      7 |  497 | `		}` |
| 250419 |  498 | `	}else if( iStart > nSrcLen ){` |
|      7 |  499 | `		iStart = nSrcLen;` |
|      3 |  500 | `	}` |
| 266949 |  501 | `	iEnd = nSrcLen;` |
| 266949 |  502 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 196173 |  503 | `		sxi64 iLen = 0;` |
| 196173 |  504 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 196173 |  505 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |  506 | `			return rcArg;` |
|      - |  507 | `		}` |
| 196173 |  508 | `		if( iLen < 0 ){` |
|  32997 |  509 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 179677 |  510 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  18807 |  511 | `			iEnd = nSrcLen;` |
|   9406 |  512 | `		}else{` |
| 144379 |  513 | `			iEnd = iStart + iLen;` |
|      - |  514 | `		}` |
|  98084 |  515 | `	}` |
| 266949 |  516 | `	if( iEnd < iStart ){` |
|      3 |  517 | `		iEnd = iStart;` |
|      1 |  518 | `	}` |
| 266949 |  519 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 266949 |  520 | `	return PH7_OK;` |
| 133477 |  521 | `}` |
|      - |  522 | `/*` |
...
|      - |  715 | ` */` |
| 393530 |  716 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  717 | `{` |
| 393535 |  718 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 2263 | ` */` |
| 151744 | 2264 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2265 | `{` |
|  75872 | 2266 | `	SXUNUSED(pKey);` |
| 151749 | 2267 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2268 | `	const char *zData;` |
|      - | 2269 | `	int nLen;` |
| 151749 | 2270 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 151747 | 2294 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2295 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 151747 | 2296 | `	if( pData->bFirst ){` |
|  33553 | 2297 | `		pData->bFirst = 0;` |
| 134973 | 2298 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2299 | `		/* append the separator first */` |
| 118119 | 2300 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 151747 | 2306 | `	if( nLen > 0 ){` |
| 139071 | 2307 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2308 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2309 | `			return PH7_ABORT;` |
|      - | 2310 | `		}` |
|  69533 | 2311 | `	}` |
| 151747 | 2312 | `	return PH7_OK;` |
|  75877 | 2313 | `}` |
|      - | 2314 | `/*` |
...
|      - | 2326 | ` */` |
|  33576 | 2327 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2328 | `{` |
|      - | 2329 | `	struct implode_data imp_data;` |
|  33581 | 2330 | `	int i = 1;` |
|  33581 | 2331 | `	if( nArg < 1 ){` |
|      - | 2332 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2333 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2334 | `		return PH7_OK;` |
|      - | 2335 | `	}` |
|      - | 2336 | `	/* Prepare the implode context */` |
|  33581 | 2337 | `	imp_data.pCtx = pCtx;` |
|  33581 | 2338 | `	imp_data.bRecursive = 0;` |
|  33581 | 2339 | `	imp_data.bFirst = 1;` |
|  33581 | 2340 | `	imp_data.nRecCount = 0;` |
|  33581 | 2341 | `	imp_data.rc = SXRET_OK;` |
|  33581 | 2342 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33579 | 2343 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  33579 | 2344 | `		if( nArg > 1 && !ph7_value_is_array(apArg[1]) && !ph7_value_is_null(apArg[1]) ){` |
...
|      3 | 2355 | `		i = 0;` |
|      - | 2356 | `	}` |
|  33579 | 2357 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2358 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2359 | `	}` |
|      - | 2360 | `	/* Start the 'join' process */` |
|  67153 | 2361 | `	while( i < nArg ){` |
|  33579 | 2362 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2363 | `			/* Iterate throw array entries */` |
|  33579 | 2364 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2365 | `			/* Surface a callback allocation failure as a fatal */` |
|  33579 | 2366 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2491 | ` */` |
|   6666 | 2492 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2493 | `{` |
...
|   6671 | 2506 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6671 | 2507 | `	if( nDelim < 1 ){` |
...
|   6667 | 2513 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6667 | 2514 | `	if( nStrlen < 1 ){` |
...
|   6661 | 2540 | `	zEnd = &zString[nStrlen];` |
|      - | 2541 | `	/* Create the array */` |
|   6661 | 2542 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6661 | 2543 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6661 | 2544 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2545 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2546 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2547 | `		return PH7_OK;` |
|      - | 2548 | `	}` |
|      - | 2549 | `	/* Set a defualt limit */` |
|   6661 | 2550 | `	iLimit = SXI32_HIGH;` |
|   6661 | 2551 | `	if( nArg > 2 ){` |
...
|  81498 | 2586 | `	for(;;){` |
| 163001 | 2587 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 163001 | 2588 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2589 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6645 | 2590 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6645 | 2591 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2592 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2593 | `			}` |
|   6645 | 2594 | `			break;` |
|      - | 2595 | `		}` |
|      - | 2596 | `		/* Point to the desired offset */` |
| 156361 | 2597 | `		zCur = &zString[nOfft];` |
|      - | 2598 | `		/* Perform the store operation (may be empty) */` |
| 156361 | 2599 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 156361 | 2600 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2601 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2602 | `		}` |
|      - | 2603 | `		/* Point beyond the delimiter */` |
| 156361 | 2604 | `		zString = &zCur[nDelim];` |
|      - | 2605 | `		/* Reset the cursor */` |
| 156361 | 2606 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2607 | `	}` |
|      - | 2608 | `	/* Return the freshly created array */` |
|   6645 | 2609 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2610 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2611 | `	 * released as soon we return from this foregin function.` |
|      - | 2612 | `	 */` |
|   6645 | 2613 | `	return PH7_OK;` |
|   3338 | 2614 | `}` |
|      - | 2615 | `/*` |
...
|      - | 2629 | ` */` |
|  14446 | 2630 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2631 | `{` |
|  14451 | 2632 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - | 2633 | `	const char *zString;` |
|      - | 2634 | `	int nLen;` |
|  14451 | 2635 | `	if( nArg < 1 ){` |
|      - | 2636 | `		/* Missing arguments,return null */` |
|    ! 0 | 2637 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2638 | `		return PH7_OK;` |
|      - | 2639 | `	}` |
|      - | 2640 | `	/* Extract the target string */` |
|  14451 | 2641 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14451 | 2642 | `	if( nLen < 1 ){` |
|      - | 2643 | `		/* Empty string,return */` |
|    753 | 2644 | `		ph7_result_string(pCtx,"",0);` |
|    753 | 2645 | `		return PH7_OK;` |
|      - | 2646 | `	}` |
|      - | 2647 | `	/* Start the trim process */` |
|  13703 | 2648 | `	if( nArg < 2 ){` |
|      - | 2649 | `		SyString sStr;` |
|      - | 2650 | `		/* Remove white spaces and NUL bytes */` |
|  13673 | 2651 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  34295 | 2652 | `		SyStringFullTrimSafe(&sStr);` |
|  13673 | 2653 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6839 | 2654 | `	}else{` |
|      - | 2655 | `		/* Char list */` |
...
|      - | 2825 | ` */` |
|  33462 | 2826 | `static int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2827 | `{` |
|  33467 | 2828 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - | 2829 | `	const char *zString,*zCur,*zEnd;` |
|      - | 2830 | `	int nLen;` |
|  33467 | 2831 | `	if( nArg < 1 ){` |
|      - | 2832 | `		/* Missing arguments,return null */` |
|    ! 0 | 2833 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2834 | `		return PH7_OK;` |
|      - | 2835 | `	}` |
|      - | 2836 | `	/* Extract the target string */` |
|  33467 | 2837 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33467 | 2838 | `	if( nLen < 1 ){` |
|      - | 2839 | `		/* Empty string,return */` |
|      5 | 2840 | `		ph7_result_string(pCtx,"",0);` |
|      5 | 2841 | `		return PH7_OK;` |
|      - | 2842 | `	}` |
|      - | 2843 | `	/* Perform the requested operation */` |
|  33463 | 2844 | `	zEnd = &zString[nLen];` |
| 105512 | 2845 | `	for(;;){` |
| 211029 | 2846 | `		if( zString >= zEnd ){` |
|      - | 2847 | `			/* No more input,break immediately */` |
|  33463 | 2848 | `			break;` |
|      - | 2849 | `		}` |
| 177571 | 2850 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2859 | `		}else{` |
| 177571 | 2860 | `			int c = zString[0];` |
| 177571 | 2861 | `			if( SyisUpper(c) ){` |
| 175015 | 2862 | `				c = SyToLower(zString[0]);` |
|  87505 | 2863 | `			}` |
|      - | 2864 | `			/* Append character */` |
| 177571 | 2865 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2866 | `			/* Advance the cursor */` |
| 177571 | 2867 | `			zString++;` |
|      - | 2868 | `		}` |
|      5 | 2869 | `	}` |
|  33463 | 2870 | `	return PH7_OK;` |
|  16736 | 2871 | `}` |
|      - | 2872 | `/*` |
...
|      - | 4241 | ` * "all valid".)` |
|      - | 4242 | ` */` |
|    490 | 4243 | `static int FormatUnknownSpec(const char *zIn,int nByte,int *pBad)` |
|      3 | 4244 | `{` |
|    493 | 4245 | `	const char *zEnd = &zIn[nByte];` |
|      - | 4246 | `	int c,idx;` |
|   3833 | 4247 | `	while( zIn < zEnd ){` |
|   3363 | 4248 | `		if( zIn[0] != '%' ){` |
|   2421 | 4249 | `			zIn++;` |
|   2421 | 4250 | `			continue;` |
|      - | 4251 | `		}` |
|    943 | 4252 | `		zIn++; /* jump the percent sign */` |
...
|   1167 | 4256 | `		while( zIn < zEnd ){` |
|   1165 | 4257 | `			c = zIn[0];` |
|   1165 | 4258 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){` |
|    213 | 4259 | `				zIn++;` |
|    213 | 4260 | `				continue;` |
|      - | 4261 | `			}` |
|    953 | 4262 | `			if( c=='\'' ){` |
...
|    ! 0 | 4270 | `		}` |
|      - | 4271 | `		/* field width */` |
|   1241 | 4272 | `		while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|    299 | 4273 | `			zIn++;` |
|      1 | 4274 | `		}` |
...
|    943 | 4306 | `		if( zIn < zEnd && zIn[0]=='l' ){` |
|     11 | 4307 | `			zIn++;` |
|      5 | 4308 | `		}` |
|    943 | 4309 | `		if( zIn >= zEnd ){` |
|      - | 4310 | `			/* A dangling '%' with no specifier: PHL's legacy path silently` |
|      - | 4311 | `			 * truncates here (recorded residual); nothing to validate. */` |
|      3 | 4312 | `			break;` |
|      - | 4313 | `		}` |
|    941 | 4314 | `		c = zIn[0];` |
|    941 | 4315 | `		zIn++; /* jump the conversion specifier */` |
|   3785 | 4316 | `		for( idx = 0 ; idx < (int)SX_ARRAYSIZE(aFmt) ; idx++ ){` |
|   3767 | 4317 | `			if( c == aFmt[idx].fmttype ){` |
|    923 | 4318 | `				break;` |
|      - | 4319 | `			}` |
|   1425 | 4320 | `		}` |
|    941 | 4321 | `		if( idx >= (int)SX_ARRAYSIZE(aFmt) ){` |
|     19 | 4322 | `			*pBad = c; /* unknown specifier */` |
|     19 | 4323 | `			return TRUE;` |
|      - | 4324 | `		}` |
|      3 | 4325 | `	}` |
|    475 | 4326 | `	return FALSE;` |
|    248 | 4327 | `}` |
|      - | 4328 | `/*` |
...
|      - | 4335 | ` */` |
|    490 | 4336 | `PH7_PRIVATE sxi32 PH7_FormatValidate(ph7_context *pCtx,const char *zFormat,int nByte)` |
|      3 | 4337 | `{` |
|    493 | 4338 | `	int badSpec = 0;` |
|    493 | 4339 | `	if( FormatUnknownSpec(zFormat,nByte,&badSpec) ){` |
|     28 | 4340 | `		return PH7_VmThrowException(pCtx,"ValueError",` |
|      9 | 4341 | `			"Unknown format specifier \"%c\"",badSpec);` |
|      - | 4342 | `	}` |
|    475 | 4343 | `	return PH7_OK;` |
|    248 | 4344 | `}` |
|      - | 4345 | `/*` |
...
|      - | 4349 | ` */` |
|    472 | 4350 | `static int FormatRequiredArgs(const char *zIn,int nByte)` |
|      3 | 4351 | `{` |
|    475 | 4352 | `	const char *zEnd = &zIn[nByte];` |
|    475 | 4353 | `	int c,seq = 0,maxpos = 0;` |
|   3801 | 4354 | `	while( zIn < zEnd ){` |
|   3331 | 4355 | `		int numVal = 0,pos = 0;` |
|   3331 | 4356 | `		if( zIn[0] != '%' ){` |
|   2407 | 4357 | `			zIn++;` |
|   2407 | 4358 | `			continue;` |
|      - | 4359 | `		}` |
|    925 | 4360 | `		zIn++; /* jump the percent sign */` |
|      - | 4361 | `		/* leading flags (incl. the "'<pad>'" custom-pad form) */` |
|   1149 | 4362 | `		while( zIn < zEnd ){` |
|   1147 | 4363 | `			c = zIn[0];` |
|   1147 | 4364 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){ zIn++; continue; }` |
|    935 | 4365 | `			if( c=='\'' ){ zIn++; if( zIn < zEnd ){ zIn++; } continue; }` |
|    923 | 4366 | `			break;` |
|    ! 0 | 4367 | `		}` |
|      - | 4368 | `		/* leading number: a positional index when a '$' follows, else the width */` |
|   1223 | 4369 | `		while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|    299 | 4370 | `			numVal = numVal*10 + (zIn[0]-'0');` |
|    299 | 4371 | `			zIn++;` |
|      1 | 4372 | `		}` |
|    925 | 4373 | `		if( zIn < zEnd && zIn[0]=='$' ){` |
|     15 | 4374 | `			pos = numVal;` |
|     15 | 4375 | `			zIn++;` |
...
|      7 | 4384 | `		}` |
|      - | 4385 | `		/* precision */` |
|    925 | 4386 | `		if( zIn < zEnd && zIn[0]=='.' ){` |
|    113 | 4387 | `			zIn++;` |
|    243 | 4388 | `			while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){ zIn++; }` |
|     55 | 4389 | `		}` |
|      - | 4390 | `		/* a single 'l' length modifier (ignored, php compat) */` |
|    925 | 4391 | `		if( zIn < zEnd && zIn[0]=='l' ){ zIn++; }` |
|    925 | 4392 | `		if( zIn >= zEnd ){ break; }` |
|    923 | 4393 | `		c = zIn[0];` |
|    923 | 4394 | `		zIn++; /* jump the conversion specifier */` |
|    923 | 4395 | `		if( c == '%' ){ continue; } /* %% consumes no argument */` |
|    915 | 4396 | `		if( pos > 0 ){` |
...
|      - | 4400 | `		}` |
|      3 | 4401 | `	}` |
|    475 | 4402 | `	return seq > maxpos ? seq : maxpos;` |
|      3 | 4403 | `}` |
|      - | 4404 | `/*` |
...
|      - | 4414 | ` * when enough.` |
|      - | 4415 | ` */` |
|    472 | 4416 | `PH7_PRIVATE sxi32 PH7_FormatCheckArgCount(ph7_context *pCtx,const char *zFormat,int nByte,int nValues,int nFixed,int bVararg)` |
|      3 | 4417 | `{` |
|    475 | 4418 | `	int required = FormatRequiredArgs(zFormat,nByte);` |
|    475 | 4419 | `	if( nValues < required ){` |
|     21 | 4420 | `		if( bVararg ){` |
...
|     13 | 4450 | `}` |
|    502 | 4451 | `PH7_PRIVATE sxi32 PH7_FormatCheckFormatArg(ph7_context *pCtx,ph7_value *pArg,int iArg)` |
|      3 | 4452 | `{` |
|    505 | 4453 | `	if( ph7_value_is_array(pArg) \|\| ph7_value_is_object(pArg) \|\| ph7_value_is_resource(pArg) ){` |
|      - | 4454 | `		char zBuf[64];` |
...
|      - | 4474 | ` */` |
|    452 | 4475 | `PH7_PRIVATE sxi32 PH7_InputFormat(` |
...
|      - | 4484 | `	)` |
|      3 | 4485 | `{` |
|    455 | 4486 | `	char spaces[] = "                                                  ";` |
|      - | 4487 | `#define etSPACESIZE ((int)sizeof(spaces)-1)` |
|    455 | 4488 | `	const char *zCur,*zEnd = &zIn[nByte];` |
...
|    670 | 4512 | `	for(;;){` |
|   1343 | 4513 | `		zCur = zIn;` |
|   3741 | 4514 | `		while( zIn < zEnd && zIn[0] != '%' ){` |
|   2399 | 4515 | `			zIn++;` |
|      1 | 4516 | `		}` |
|   1343 | 4517 | `		if( zCur < zIn ){` |
|      - | 4518 | `			/* Consume chunk verbatim */` |
|    785 | 4519 | `			rc = xConsumer(pCtx,zCur,(int)(zIn-zCur),pUserData);` |
|    785 | 4520 | `			if( rc != SXRET_OK ){` |
|      - | 4521 | `				/* Callback requested an abort (e.g. an allocation failure) */` |
|    ! 0 | 4522 | `				break;` |
|      - | 4523 | `			}` |
|    392 | 4524 | `		}` |
|   1343 | 4525 | `		if( zIn >= zEnd ){` |
|      - | 4526 | `			/* No more input to process,break immediately */` |
|    453 | 4527 | `			break;` |
|      - | 4528 | `		}` |
|      - | 4529 | `		/* Find out what flags are present */` |
|    893 | 4530 | `		flag_leftjustify = flag_plussign = flag_blanksign =` |
|    890 | 4531 | `			flag_alternateform = flag_zeropad = 0;` |
...
|  45393 | 4535 | `		for( idx = 0 ; idx < etSPACESIZE ; ++idx ){ spaces[idx] = ' '; }` |
|    893 | 4536 | `		zIn++; /* Jump the precent sign */` |
|    445 | 4537 | `		do{` |
|   1117 | 4538 | `			c = zIn[0];` |
|   1117 | 4539 | `			switch( c ){` |
...
|    183 | 4543 | `			case '0':   flag_zeropad = 1;         c = 0;   break;` |
|      6 | 4544 | `			case '\'':` |
|     13 | 4545 | `				zIn++;` |
|     13 | 4546 | `				if( zIn < zEnd ){` |
...
|      6 | 4553 | `				}` |
|     12 | 4554 | `				break;` |
|    890 | 4555 | `			default:                                       break;` |
|      - | 4556 | `			}` |
|   1117 | 4557 | `		}while( c==0 && (zIn++ < zEnd) );` |
|      - | 4558 | `		/* Get the field width */` |
|    893 | 4559 | `		width = 0;` |
|   1630 | 4560 | `		while( zIn < zEnd && ( zIn[0] >='0' && zIn[0] <='9') ){` |
|    293 | 4561 | `			width = width*10 + (zIn[0] - '0');` |
|    293 | 4562 | `			zIn++;` |
|      1 | 4563 | `		}` |
|    893 | 4564 | `		if( zIn < zEnd && zIn[0] == '$' ){` |
...
|      1 | 4600 | `			}` |
|      4 | 4601 | `		}` |
|    893 | 4602 | `		if( width > PH7_FMT_BUFSIZ-10 ){` |
|    ! 0 | 4603 | `			width = PH7_FMT_BUFSIZ-10;` |
|    ! 0 | 4604 | `		}` |
|      - | 4605 | `		/* Get the precision */` |
|    893 | 4606 | `		precision = -1;` |
|    893 | 4607 | `		if( zIn < zEnd && zIn[0] == '.' ){` |
...
|    893 | 4618 | `		if( zIn < zEnd && zIn[0] == 'l' ){` |
|      9 | 4619 | `			zIn++;` |
|      4 | 4620 | `		}` |
|    893 | 4621 | `		if( zIn >= zEnd ){` |
|      - | 4622 | `			/* No more input */` |
|      3 | 4623 | `			break;` |
|      - | 4624 | `		}` |
|      - | 4625 | `		/* Fetch the info entry for the field */` |
|    891 | 4626 | `		pInfo = 0;` |
|    891 | 4627 | `		xtype = PH7_FMT_ERROR;` |
|    891 | 4628 | `		c = zIn[0];` |
|    891 | 4629 | `		zIn++; /* Jump the format specifer */` |
|   3415 | 4630 | `		for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
|   3415 | 4631 | `			if( c==aFmt[idx].fmttype ){` |
|    891 | 4632 | `				pInfo = &aFmt[idx];` |
|    891 | 4633 | `				xtype = pInfo->type;` |
|    891 | 4634 | `				break;` |
|      - | 4635 | `			}` |
|   1265 | 4636 | `		}` |
|    891 | 4637 | `		zBuf = zWorker; /* Point to the working buffer */` |
|    891 | 4638 | `		length = 0;` |
...
|      - | 4719 | `#endif` |
|    301 | 4720 | `        if( pInfo->flags & PH7_FMT_FLAG_SIGNED ){` |
|    277 | 4721 | `          if( iVal<0 ){` |
|     25 | 4722 | `            iVal = -iVal;` |
...
|    ! 0 | 4727 | `			}` |
|     25 | 4728 | `            prefix = '-';` |
|    265 | 4729 | `          }else if( flag_plussign )  prefix = '+';` |
|    251 | 4730 | `          else if( flag_blanksign )  prefix = ' ';` |
|    249 | 4731 | `          else                       prefix = 0;` |
|    139 | 4732 | `        }else{` |
|     25 | 4733 | `			if( iVal<0 ){` |
|    ! 0 | 4734 | `				iVal = -iVal;` |
...
|     25 | 4741 | `			prefix = 0;` |
|      - | 4742 | `		}` |
|    301 | 4743 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|    169 | 4744 | `          precision = width-(prefix!=0);` |
|     84 | 4745 | `        }` |
|    301 | 4746 | `        zBuf = &zWorker[PH7_FMT_BUFSIZ-1];` |
|      - | 4747 | `        {` |
|      - | 4748 | `          register char *cset;      /* Use registers for speed */` |
|      - | 4749 | `          register int base;` |
|    301 | 4750 | `          cset = pInfo->charset;` |
|    301 | 4751 | `          base = pInfo->base;` |
|    150 | 4752 | `          do{                                           /* Convert to ascii */` |
|    377 | 4753 | `            *(--zBuf) = cset[iVal%base];` |
|    377 | 4754 | `            iVal = iVal/base;` |
|    377 | 4755 | `          }while( iVal>0 );` |
|      - | 4756 | `        }` |
|    301 | 4757 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
|    487 | 4758 | `        for(idx=precision-length; idx>0; idx--){` |
|    187 | 4759 | `          *(--zBuf) = '0';                             /* Zero pad */` |
|     94 | 4760 | `        }` |
|    301 | 4761 | `        if( prefix ) *(--zBuf) = (char)prefix;               /* Add sign */` |
|    301 | 4762 | `        if( flag_alternateform && pInfo->prefix ){      /* Add "0" or "0x" */` |
|      - | 4763 | `          char *pre, x;` |
...
|    ! 0 | 4767 | `          }` |
|    ! 0 | 4768 | `        }` |
|    301 | 4769 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
|    301 | 4770 | `		break;` |
...
|      - | 4877 | `		 ** the output.` |
|      - | 4878 | `		 */` |
|    891 | 4879 | `    if( !flag_leftjustify ){` |
|      - | 4880 | `      register int nspace;` |
|    873 | 4881 | `      nspace = width-length;` |
|    873 | 4882 | `      if( nspace>0 ){` |
...
|     18 | 4896 | `      }` |
|    435 | 4897 | `    }` |
|    891 | 4898 | `    if( length>0 ){` |
|    883 | 4899 | `		rc = xConsumer(pCtx,zBuf,(unsigned int)length,pUserData);` |
|    883 | 4900 | `		if( rc != SXRET_OK ){` |
|    ! 0 | 4901 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|      - | 4902 | `		}` |
|    440 | 4903 | `    }` |
|    891 | 4904 | `    if( flag_leftjustify ){` |
...
|      9 | 4922 | `    }` |
|      3 | 4923 | ` }/* for(;;) */` |
|    455 | 4924 | `	return SXRET_OK;` |
|    229 | 4925 | `}` |
|      - | 4926 | `/*` |
|      - | 4927 | ` * Callback [i.e: Formatted input consumer] of the sprintf function.` |
|      - | 4928 | ` */` |
|    510 | 4929 | `static int sprintfConsumer(ph7_context *pCtx,const char *zInput,int nLen,void *pUserData)` |
|      3 | 4930 | `{` |
...
|    513 | 4934 | `	sxi32 *pRc = (sxi32 *)pUserData;` |
|    513 | 4935 | `	*pRc = ph7_result_string(pCtx,zInput,nLen);` |
|    513 | 4936 | `	return *pRc;` |
|      3 | 4937 | `}` |
|      - | 4938 | `/*` |
...
|      - | 4946 | ` */` |
|    246 | 4947 | `static int PH7_builtin_sprintf(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 | 4948 | `{` |
|      - | 4949 | `	const char *zFormat;` |
|    249 | 4950 | `	sxi32 rc = SXRET_OK;` |
|      - | 4951 | `	int nLen;` |
|    249 | 4952 | `	if( nArg < 1 ){` |
...
|    249 | 4958 | `	rc = PH7_FormatCheckFormatArg(pCtx,apArg[0],1);` |
|    249 | 4959 | `	if( rc != PH7_OK ){` |
|    ! 0 | 4960 | `		return rc;` |
|      - | 4961 | `	}` |
|      - | 4962 | `	/* Extract the string format (scalars/null coerce). */` |
|    249 | 4963 | `	zFormat = ph7_value_to_string(apArg[0],&nLen);` |
|    249 | 4964 | `	if( nLen < 1 ){` |
|      - | 4965 | `		/* Empty string */` |
...
|    249 | 4971 | `	rc = PH7_FormatValidate(pCtx,zFormat,nLen);` |
|    249 | 4972 | `	if( rc != PH7_OK ){` |
|     17 | 4973 | `		return rc;` |
|      - | 4974 | `	}` |
|      - | 4975 | `	/* PHP 8: too few value arguments is a catchable ArgumentCountError before output. */` |
|    233 | 4976 | `	rc = PH7_FormatCheckArgCount(pCtx,zFormat,nLen,nArg-1,1,FALSE);` |
|    233 | 4977 | `	if( rc != PH7_OK ){` |
|     11 | 4978 | `		return rc;` |
|      - | 4979 | `	}` |
|      - | 4980 | `	/* Format the string; sprintfConsumer reports an allocation failure via &rc. */` |
|    223 | 4981 | `	PH7_InputFormat(sprintfConsumer,pCtx,zFormat,nLen,nArg,apArg,(void *)&rc,FALSE);` |
|    223 | 4982 | `	if( rc != SXRET_OK ){` |
...
|      - | 8282 | ` */` |
|  30026 | 8283 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8284 | `{` |
...
|      - | 8293 | `	int nByte;` |
|      - | 8294 | `	sxi32 rc;` |
|  30031 | 8295 | `	if( nArg < 3 ){` |
|      - | 8296 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8297 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8298 | `		return PH7_OK;` |
|      - | 8299 | `	}` |
|      - | 8300 | `	/* Initialize fields */` |
|  30031 | 8301 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30031 | 8302 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30031 | 8303 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  30031 | 8304 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  30031 | 8305 | `	sRep.pCtx = pCtx;` |
|  30031 | 8306 | `	sRep.pCollector = &sSearch;` |
|  30031 | 8307 | `	rep_str = 0;` |
|      - | 8308 | `	/* Extract the subject */` |
|  30031 | 8309 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  30031 | 8310 | `	if( nByte < 1 ){` |
...
|  30011 | 8316 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8317 | `	/* Search string */` |
|  30011 | 8318 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8319 | `		/* Collect search string */` |
|     81 | 8320 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     43 | 8321 | `	}else{` |
|      - | 8322 | `		/* Single pattern */` |
|  29935 | 8323 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29935 | 8324 | `		if( nByte < 1 ){` |
...
|      - | 8328 | `		}` |
|  29931 | 8329 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8330 | `		/* Save for later processing */` |
|  29931 | 8331 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8332 | `	}` |
|      - | 8333 | `	/* Replace string */` |
|  30007 | 8334 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8335 | `		/* Collect replace string */` |
|      7 | 8336 | `		sRep.pCollector = &sReplace;` |
|      7 | 8337 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8338 | `	}else{` |
|      - | 8339 | `		/* Single needle */` |
|  30001 | 8340 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  30001 | 8341 | `		rep_str = 1;` |
|  30001 | 8342 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8343 | `		/* Save for later processing */` |
|  30001 | 8344 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8345 | `	}` |
|      - | 8346 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  30007 | 8347 | `	if( sRep.rc != SXRET_OK ){` |
...
|  30007 | 8354 | `	SySetResetCursor(&sSearch);` |
|  30007 | 8355 | `	SySetResetCursor(&sReplace);` |
|  30007 | 8356 | `	pReplace = pSearch = 0; /* cc warning */` |
|  30007 | 8357 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8358 | `	/* Extract function name */` |
|  30007 | 8359 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8360 | `	/* Set the default pattern match routine */` |
|  30007 | 8361 | `	xMatch = SyBlobSearch;` |
|  30007 | 8362 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8363 | `		/* Case insensitive pattern match */` |
|     11 | 8364 | `		xMatch = iPatternMatch;` |
|      5 | 8365 | `	}` |
|      - | 8366 | `	/* Start the replace process */` |
|  60085 | 8367 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8368 | `		sxu32 nCount,nOfft;` |
|  30083 | 8369 | `		if( pSearch->nByte <  1 ){` |
|      - | 8370 | `			/* Empty string,ignore */` |
|      3 | 8371 | `			continue;` |
|      - | 8372 | `		}` |
|      - | 8373 | `		/* Extract the replace string */` |
|  30081 | 8374 | `		if( rep_str ){` |
|  30071 | 8375 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  15038 | 8376 | `		}else{` |
...
|      1 | 8382 | `			}` |
|      - | 8383 | `		}` |
|  30081 | 8384 | `		if( pReplace == 0 ){` |
|      - | 8385 | `			/* Use an empty string instead */` |
|      3 | 8386 | `			pReplace = &sTemp;` |
|      1 | 8387 | `		}` |
|  30081 | 8388 | `		nOfft = nCount = 0;` |
|  15064 | 8389 | `		for(;;){` |
|  30133 | 8390 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8391 | `				break;` |
|      - | 8392 | `			}` |
|      - | 8393 | `			/* Perform a pattern lookup */` |
|  45179 | 8394 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30116 | 8395 | `				pSearch->nByte,&nOfft);` |
|  30121 | 8396 | `			if( rc != SXRET_OK ){` |
...
|  30007 | 8414 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  30007 | 8415 | `	SySetRelease(&sSearch);` |
|  30007 | 8416 | `	SySetRelease(&sReplace);` |
|  30007 | 8417 | `	SyBlobRelease(&sWorker);` |
|  30007 | 8418 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8419 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8420 | `	}` |
|  30007 | 8421 | `	return PH7_OK;` |
|  15018 | 8422 | `}` |
|      - | 8423 | `/*` |
