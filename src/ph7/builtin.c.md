...
| 495720 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 495725 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 495725 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 495711 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 495695 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 495695 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 495695 |  121 | `	return PH7_OK;` |
| 247968 |  122 | `}` |
|      - |  123 |  |
