...
|      - |  291 | ` */` |
|  24664 |  292 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  293 |  |
|  24666 |  294 | `	int res = 1; /* Assume empty by default */` |
|  24666 |  295 | `	if( nArg > 0 ){` |
|  24664 |  296 | `		res = ph7_value_is_empty(apArg[0]);` |
|  12331 |  297 | `	}` |
|  24666 |  298 | `	ph7_result_bool(pCtx,res);` |
|  24666 |  299 | `	return PH7_OK;` |
|      - |  300 |  |
|      2 |  301 |  |
...
|      - |  341 | ` */` |
| 180886 |  342 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  343 |  |
|      - |  344 | `	const char *zSource,*zOfft;` |
|      - |  345 | `	int nOfft,nLen,nSrcLen;` |
| 180888 |  346 | `	if( nArg < 2 ){` |
|      - |  347 | `		/* return FALSE */` |
|      5 |  348 | `		ph7_result_bool(pCtx,0);` |
|      5 |  349 | `		return PH7_OK;` |
|      - |  350 | `	}` |
|      - |  351 | `	/* Extract the target string */` |
| 180884 |  352 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 180884 |  353 | `	if( nSrcLen < 1 ){` |
|      - |  354 | `		/* Empty string,return FALSE */` |
|  10704 |  355 | `		ph7_result_bool(pCtx,0);` |
|  10704 |  356 | `		return PH7_OK;` |
|      - |  357 | `	}` |
| 170182 |  358 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  359 | `	/* Extract the offset */` |
| 170182 |  360 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 170182 |  361 | `	if( nOfft < 0 ){` |
|  28474 |  362 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  28474 |  363 | `		if( zOfft < zSource ){` |
|      - |  364 | `			/* Invalid offset */` |
|      5 |  365 | `			ph7_result_bool(pCtx,0);` |
|      5 |  366 | `			return PH7_OK;` |
|      - |  367 | `		}` |
|  28470 |  368 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  28470 |  369 | `		nOfft = (int)(zOfft-zSource);` |
| 155944 |  370 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  371 | `		/* Invalid offset */` |
|    114 |  372 | `		ph7_result_bool(pCtx,0);` |
|    114 |  373 | `		return PH7_OK;` |
|    ! 0 |  374 | `	}else{` |
| 141598 |  375 | `		zOfft = &zSource[nOfft];` |
| 141598 |  376 | `		nLen = nSrcLen - nOfft;` |
|      - |  377 | `	}` |
| 170066 |  378 | `	if( nArg > 2 ){` |
|      - |  379 | `		/* Extract the length */` |
| 140418 |  380 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 140418 |  381 | `		if( nLen == 0 ){` |
|      - |  382 | `			/* Invalid length,return an empty string */` |
|      5 |  383 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  384 | `			return PH7_OK;` |
| 140414 |  385 | `		}else if( nLen < 0 ){` |
|  28472 |  386 | `			nLen = nSrcLen + nLen - nOfft;` |
|  28472 |  387 | `			if( nLen < 1 ){` |
|      - |  388 | `				/* Invalid  length */` |
|      3 |  389 | `				nLen = nSrcLen - nOfft;` |
|      1 |  390 | `			}` |
|  14235 |  391 | `		}` |
| 140414 |  392 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  393 | `			/* Invalid length */` |
|   3972 |  394 | `			nLen = nSrcLen - nOfft;` |
|   1985 |  395 | `		}` |
|  70206 |  396 | `	}` |
|      - |  397 | `	/* Return the substring */` |
| 170062 |  398 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 170062 |  399 | `	return PH7_OK;` |
|  90445 |  400 |  |
|      - |  401 | `/*` |
...
|      - | 1368 | ` */` |
|   5228 | 1369 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1370 |  |
|   5230 | 1371 | `	int iLen = 0;` |
|   5230 | 1372 | `	if( nArg > 0 ){` |
|   5228 | 1373 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   2613 | 1374 | `	}` |
|      - | 1375 | `	/* String length */` |
|   5230 | 1376 | `	ph7_result_int(pCtx,iLen);` |
|   5230 | 1377 | `	return PH7_OK;` |
|      2 | 1378 |  |
|      - | 1379 | `/*` |
...
|      - | 1521 | ` */` |
| 114904 | 1522 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      2 | 1523 |  |
|  57452 | 1524 | `	SXUNUSED(pKey);` |
| 114906 | 1525 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1526 | `	const char *zData;` |
|      - | 1527 | `	int nLen;` |
| 114906 | 1528 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 114904 | 1545 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1546 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 114904 | 1547 | `	if( pData->bFirst ){` |
|  28738 | 1548 | `		pData->bFirst = 0;` |
| 100536 | 1549 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1550 | `		/* append the separator first */` |
|  86156 | 1551 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  43077 | 1552 | `	}` |
|      - | 1553 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
| 114904 | 1554 | `	if( nLen > 0 ){` |
| 104202 | 1555 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  52100 | 1556 | `	}` |
| 114904 | 1557 | `	return PH7_OK;` |
|  57454 | 1558 |  |
|      - | 1559 | `/*` |
...
|      - | 1571 | ` */` |
|  28760 | 1572 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1573 |  |
|      - | 1574 | `	struct implode_data imp_data;` |
|  28762 | 1575 | `	int i = 1;` |
|  28762 | 1576 | `	if( nArg < 1 ){` |
|      - | 1577 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1578 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1579 | `		return PH7_OK;` |
|      - | 1580 | `	}` |
|      - | 1581 | `	/* Prepare the implode context */` |
|  28762 | 1582 | `	imp_data.pCtx = pCtx;` |
|  28762 | 1583 | `	imp_data.bRecursive = 0;` |
|  28762 | 1584 | `	imp_data.bFirst = 1;` |
|  28762 | 1585 | `	imp_data.nRecCount = 0;` |
|  28762 | 1586 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  28760 | 1587 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  14381 | 1588 | `	}else{` |
|      3 | 1589 | `		imp_data.zSep = 0;` |
|      3 | 1590 | `		imp_data.nSeplen = 0;` |
|      3 | 1591 | `		i = 0;` |
|      - | 1592 | `	}` |
|  28762 | 1593 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 1594 | `	/* Start the 'join' process */` |
|  57522 | 1595 | `	while( i < nArg ){` |
|  28762 | 1596 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1597 | `			/* Iterate throw array entries */` |
|  28762 | 1598 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|  14382 | 1599 | `		}else{` |
...
|      - | 1706 | ` */` |
|   5406 | 1707 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1708 |  |
...
|   5400 | 1721 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   5400 | 1722 | `	if( nDelim < 1 ){` |
|      - | 1723 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1724 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1725 | `		return PH7_OK;` |
|      - | 1726 | `	}` |
|      - | 1727 | `	/* Extract the string */` |
|   5398 | 1728 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   5398 | 1729 | `	if( nStrlen < 1 ){` |
...
|   5396 | 1744 | `	zEnd = &zString[nStrlen];` |
|      - | 1745 | `	/* Create the array */` |
|   5396 | 1746 | `	pArray =  ph7_context_new_array(pCtx);` |
|   5396 | 1747 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   5396 | 1748 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1749 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1750 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1751 | `		return PH7_OK;` |
|      - | 1752 | `	}` |
|      - | 1753 | `	/* Set a defualt limit */` |
|   5396 | 1754 | `	iLimit = SXI32_HIGH;` |
|   5396 | 1755 | `	if( nArg > 2 ){` |
...
|  61345 | 1766 | `	for(;;){` |
| 122692 | 1767 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 122692 | 1768 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1769 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   5396 | 1770 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   5396 | 1771 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   5396 | 1772 | `			break;` |
|      - | 1773 | `		}` |
|      - | 1774 | `		/* Point to the desired offset */` |
| 117298 | 1775 | `		zCur = &zString[nOfft];` |
|      - | 1776 | `		/* Perform the store operation (may be empty) */` |
| 117298 | 1777 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 117298 | 1778 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 1779 | `		/* Point beyond the delimiter */` |
| 117298 | 1780 | `		zString = &zCur[nDelim];` |
|      - | 1781 | `		/* Reset the cursor */` |
| 117298 | 1782 | `		ph7_value_reset_string_cursor(pValue);` |
|      2 | 1783 | `	}` |
|      - | 1784 | `	/* Return the freshly created array */` |
|   5396 | 1785 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1786 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1787 | `	 * released as soon we return from this foregin function.` |
|      - | 1788 | `	 */` |
|   5396 | 1789 | `	return PH7_OK;` |
|   2705 | 1790 |  |
|      - | 1791 | `/*` |
...
|      - | 1805 | ` */` |
|  12448 | 1806 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1807 |  |
|      - | 1808 | `	const char *zString;` |
|      - | 1809 | `	int nLen;` |
|  12450 | 1810 | `	if( nArg < 1 ){` |
|      - | 1811 | `		/* Missing arguments,return null */` |
|      3 | 1812 | `		ph7_result_null(pCtx);` |
|      3 | 1813 | `		return PH7_OK;` |
|      - | 1814 | `	}` |
|      - | 1815 | `	/* Extract the target string */` |
|  12448 | 1816 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  12448 | 1817 | `	if( nLen < 1 ){` |
|      - | 1818 | `		/* Empty string,return */` |
|   1648 | 1819 | `		ph7_result_string(pCtx,"",0);` |
|   1648 | 1820 | `		return PH7_OK;` |
|      - | 1821 | `	}` |
|      - | 1822 | `	/* Start the trim process */` |
|  10802 | 1823 | `	if( nArg < 2 ){` |
|      - | 1824 | `		SyString sStr;` |
|      - | 1825 | `		/* Remove white spaces and NUL bytes */` |
|  10798 | 1826 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  26286 | 1827 | `		SyStringFullTrimSafe(&sStr);` |
|  10798 | 1828 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   5400 | 1829 | `	}else{` |
|      - | 1830 | `		/* Char list */` |
...
|    ! 0 | 2080 | `		}else{` |
| 150874 | 2081 | `			int c = zString[0];` |
| 150874 | 2082 | `			if( SyisUpper(c) ){` |
| 150872 | 2083 | `				c = SyToLower(zString[0]);` |
|  75435 | 2084 | `			}` |
|      - | 2085 | `			/* Append character */` |
| 150874 | 2086 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2087 | `			/* Advance the cursor */` |
| 150874 | 2088 | `			zString++;` |
|      - | 2089 | `		}` |
|      2 | 2090 | `	}` |
|  28470 | 2091 | `	return PH7_OK;` |
|  14238 | 2092 |  |
|      - | 2093 | `/*` |
...
|      - | 5697 | ` */` |
|  21466 | 5698 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5699 |  |
...
|      - | 5708 | `	int nByte;` |
|      - | 5709 | `	sxi32 rc;` |
|  21468 | 5710 | `	if( nArg < 3 ){` |
|      - | 5711 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 5712 | `		ph7_result_null(pCtx);` |
|      7 | 5713 | `		return PH7_OK;` |
|      - | 5714 | `	}` |
|      - | 5715 | `	/* Initialize fields */` |
|  21462 | 5716 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  21462 | 5717 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  21462 | 5718 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  21462 | 5719 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  21462 | 5720 | `	sRep.pCtx = pCtx;` |
|  21462 | 5721 | `	sRep.pCollector = &sSearch;` |
|  21462 | 5722 | `	rep_str = 0;` |
|      - | 5723 | `	/* Extract the subject */` |
|  21462 | 5724 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  21462 | 5725 | `	if( nByte < 1 ){` |
...
|  21434 | 5731 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 5732 | `	/* Search string */` |
|  21434 | 5733 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 5734 | `		/* Collect search string */` |
|      9 | 5735 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 5736 | `	}else{` |
|      - | 5737 | `		/* Single pattern */` |
|  21426 | 5738 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  21426 | 5739 | `		if( nByte < 1 ){` |
...
|      - | 5743 | `		}` |
|  21422 | 5744 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5745 | `		/* Save for later processing */` |
|  21422 | 5746 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 5747 | `	}` |
|      - | 5748 | `	/* Replace string */` |
|  21430 | 5749 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 5750 | `		/* Collect replace string */` |
|      7 | 5751 | `		sRep.pCollector = &sReplace;` |
|      7 | 5752 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 5753 | `	}else{` |
|      - | 5754 | `		/* Single needle */` |
|  21424 | 5755 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  21424 | 5756 | `		rep_str = 1;` |
|  21424 | 5757 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5758 | `		/* Save for later processing */` |
|  21424 | 5759 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 5760 | `	}` |
|      - | 5761 | `	/* Reset loop cursors */` |
|  21430 | 5762 | `	SySetResetCursor(&sSearch);` |
|  21430 | 5763 | `	SySetResetCursor(&sReplace);` |
|  21430 | 5764 | `	pReplace = pSearch = 0; /* cc warning */` |
|  21430 | 5765 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5766 | `	/* Extract function name */` |
|  21430 | 5767 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5768 | `	/* Set the default pattern match routine */` |
|  21430 | 5769 | `	xMatch = SyBlobSearch;` |
|  21430 | 5770 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5771 | `		/* Case insensitive pattern match */` |
|     11 | 5772 | `		xMatch = iPatternMatch;` |
|      5 | 5773 | `	}` |
|      - | 5774 | `	/* Start the replace process */` |
|  42866 | 5775 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5776 | `		sxu32 nCount,nOfft;` |
|  21438 | 5777 | `		if( pSearch->nByte <  1 ){` |
|      - | 5778 | `			/* Empty string,ignore */` |
|      3 | 5779 | `			continue;` |
|      - | 5780 | `		}` |
|      - | 5781 | `		/* Extract the replace string */` |
|  21436 | 5782 | `		if( rep_str ){` |
|  21426 | 5783 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  10714 | 5784 | `		}else{` |
...
|      1 | 5790 | `			}` |
|      - | 5791 | `		}` |
|  21436 | 5792 | `		if( pReplace == 0 ){` |
|      - | 5793 | `			/* Use an empty string instead */` |
|      3 | 5794 | `			pReplace = &sTemp;` |
|      1 | 5795 | `		}` |
|  21436 | 5796 | `		nOfft = nCount = 0;` |
|  10733 | 5797 | `		for(;;){` |
|  21468 | 5798 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 5799 | `				break;` |
|      - | 5800 | `			}` |
|      - | 5801 | `			/* Perform a pattern lookup */` |
|  32183 | 5802 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  21454 | 5803 | `				pSearch->nByte,&nOfft);` |
|  21456 | 5804 | `			if( rc != SXRET_OK ){` |
...
|  21430 | 5815 | `	ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  21430 | 5816 | `	SySetRelease(&sSearch);` |
|  21430 | 5817 | `	SySetRelease(&sReplace);` |
|  21430 | 5818 | `	SyBlobRelease(&sWorker);` |
|  21430 | 5819 | `	return PH7_OK;` |
|  10735 | 5820 |  |
|      - | 5821 | `/*` |
...
|      - | 6527 | ` */` |
|  59480 | 6528 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6529 |  |
|      - | 6530 | `	const unsigned char *zIn,*zEnd;` |
|      - | 6531 | `	int nLen;` |
|  59482 | 6532 | `	if( nArg < 1 ){` |
|      - | 6533 | `		/* Missing arguments,return FALSE */` |
|      3 | 6534 | `		ph7_result_bool(pCtx,0);` |
|      3 | 6535 | `		return PH7_OK;` |
|      - | 6536 | `	}` |
|      - | 6537 | `	/* Extract the target string */` |
|  59480 | 6538 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  59480 | 6539 | `	zEnd = &zIn[nLen];` |
|  59480 | 6540 | `	if( nLen < 1 ){` |
...
|  30765 | 6546 | `	for(;;){` |
|  61488 | 6547 | `		if( zIn >= zEnd ){` |
|      - | 6548 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1988 | 6549 | `			ph7_result_bool(pCtx,1);` |
|   1988 | 6550 | `			return PH7_OK;` |
|      - | 6551 | `		}` |
|  59502 | 6552 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 6553 | `			/* UTF-8 stream  */` |
|    ! 0 | 6554 | `			break;` |
|      - | 6555 | `		}` |
|  59502 | 6556 | `		if( !SyisSpace(zIn[0]) ){` |
|  57492 | 6557 | `			break;` |
|      - | 6558 | `		}` |
...
|  57492 | 6563 | `	ph7_result_bool(pCtx,0);` |
|  57492 | 6564 | `	return PH7_OK;` |
|  29764 | 6565 |  |
|      - | 6566 | `/*` |
...
|      - | 6987 | ` */` |
|   2692 | 6988 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      2 | 6989 |  |
|      - | 6990 | `	sxu32 n;` |
| 425338 | 6991 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 422646 | 6992 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 211324 | 6993 | `	}` |
|      - | 6994 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   2694 | 6995 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 6996 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   2694 | 6997 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   2694 | 6998 |  |
|      - | 6999 |  |
