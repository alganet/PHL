...
|      - |  302 | ` */` |
|  34006 |  303 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  304 | `{` |
|  34011 |  305 | `	int res = 1; /* Assume empty by default */` |
|  34011 |  306 | `	if( nArg > 0 ){` |
|  34009 |  307 | `		res = ph7_value_is_empty(apArg[0]);` |
|  17002 |  308 | `	}` |
|  34011 |  309 | `	ph7_result_bool(pCtx,res);` |
|  34011 |  310 | `	return PH7_OK;` |
|      - |  311 |  |
|      5 |  312 | `}` |
...
|      - |  352 | ` */` |
| 224906 |  353 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  354 | `{` |
|      - |  355 | `	const char *zSource,*zOfft;` |
|      - |  356 | `	int nOfft,nLen,nSrcLen;` |
| 224911 |  357 | `	if( nArg < 2 ){` |
|      - |  358 | `		/* return FALSE */` |
|    ! 0 |  359 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  360 | `		return PH7_OK;` |
|      - |  361 | `	}` |
|      - |  362 | `	/* Extract the target string */` |
| 224911 |  363 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 224911 |  364 | `	if( nSrcLen < 1 ){` |
|      - |  365 | `		/* Empty string,return FALSE */` |
|  12189 |  366 | `		ph7_result_bool(pCtx,0);` |
|  12189 |  367 | `		return PH7_OK;` |
|      - |  368 | `	}` |
| 212727 |  369 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  370 | `	/* Extract the offset */` |
| 212727 |  371 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 212727 |  372 | `	if( nOfft < 0 ){` |
|  32809 |  373 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  32809 |  374 | `		if( zOfft < zSource ){` |
|      - |  375 | `			/* Invalid offset */` |
|      5 |  376 | `			ph7_result_bool(pCtx,0);` |
|      5 |  377 | `			return PH7_OK;` |
|      - |  378 | `		}` |
|  32805 |  379 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  32805 |  380 | `		nOfft = (int)(zOfft-zSource);` |
| 196323 |  381 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  382 | `		/* Invalid offset */` |
|    217 |  383 | `		ph7_result_bool(pCtx,0);` |
|    217 |  384 | `		return PH7_OK;` |
|    ! 0 |  385 | `	}else{` |
| 179711 |  386 | `		zOfft = &zSource[nOfft];` |
| 179711 |  387 | `		nLen = nSrcLen - nOfft;` |
|      - |  388 | `	}` |
| 212511 |  389 | `	if( nArg > 2 ){` |
|      - |  390 | `		/* Extract the length */` |
| 175315 |  391 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 175315 |  392 | `		if( nLen == 0 ){` |
|      - |  393 | `			/* Invalid length,return an empty string */` |
|      5 |  394 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  395 | `			return PH7_OK;` |
| 175311 |  396 | `		}else if( nLen < 0 ){` |
|  32797 |  397 | `			nLen = nSrcLen + nLen - nOfft;` |
|  32797 |  398 | `			if( nLen < 1 ){` |
|      - |  399 | `				/* Invalid  length */` |
|      3 |  400 | `				nLen = nSrcLen - nOfft;` |
|      1 |  401 | `			}` |
|  16396 |  402 | `		}` |
| 175311 |  403 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  404 | `			/* Invalid length */` |
|   5641 |  405 | `			nLen = nSrcLen - nOfft;` |
|   2818 |  406 | `		}` |
|  87653 |  407 | `	}` |
|      - |  408 | `	/* Return the substring */` |
| 212507 |  409 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 212507 |  410 | `	return PH7_OK;` |
| 112458 |  411 | `}` |
|      - |  412 | `/*` |
...
|      - | 2133 | ` */` |
| 142826 | 2134 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2135 | `{` |
|  71413 | 2136 | `	SXUNUSED(pKey);` |
| 142831 | 2137 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2138 | `	const char *zData;` |
|      - | 2139 | `	int nLen;` |
| 142831 | 2140 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 142829 | 2164 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2165 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 142829 | 2166 | `	if( pData->bFirst ){` |
|  33233 | 2167 | `		pData->bFirst = 0;` |
| 126215 | 2168 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2169 | `		/* append the separator first */` |
| 109589 | 2170 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 142829 | 2176 | `	if( nLen > 0 ){` |
| 130645 | 2177 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2178 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2179 | `			return PH7_ABORT;` |
|      - | 2180 | `		}` |
|  65320 | 2181 | `	}` |
| 142829 | 2182 | `	return PH7_OK;` |
|  71418 | 2183 | `}` |
|      - | 2184 | `/*` |
...
|      - | 2196 | ` */` |
|  33254 | 2197 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2198 | `{` |
|      - | 2199 | `	struct implode_data imp_data;` |
|  33259 | 2200 | `	int i = 1;` |
|  33259 | 2201 | `	if( nArg < 1 ){` |
|      - | 2202 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2203 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2204 | `		return PH7_OK;` |
|      - | 2205 | `	}` |
|      - | 2206 | `	/* Prepare the implode context */` |
|  33259 | 2207 | `	imp_data.pCtx = pCtx;` |
|  33259 | 2208 | `	imp_data.bRecursive = 0;` |
|  33259 | 2209 | `	imp_data.bFirst = 1;` |
|  33259 | 2210 | `	imp_data.nRecCount = 0;` |
|  33259 | 2211 | `	imp_data.rc = SXRET_OK;` |
|  33259 | 2212 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33257 | 2213 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16631 | 2214 | `	}else{` |
|      3 | 2215 | `		imp_data.zSep = 0;` |
|      3 | 2216 | `		imp_data.nSeplen = 0;` |
|      3 | 2217 | `		i = 0;` |
|      - | 2218 | `	}` |
|  33259 | 2219 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2220 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2221 | `	}` |
|      - | 2222 | `	/* Start the 'join' process */` |
|  66513 | 2223 | `	while( i < nArg ){` |
|  33259 | 2224 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2225 | `			/* Iterate throw array entries */` |
|  33259 | 2226 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2227 | `			/* Surface a callback allocation failure as a fatal */` |
|  33259 | 2228 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2353 | ` */` |
|   6468 | 2354 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2355 | `{` |
...
|   6473 | 2368 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6473 | 2369 | `	if( nDelim < 1 ){` |
...
|   6469 | 2375 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6469 | 2376 | `	if( nStrlen < 1 ){` |
...
|   6463 | 2402 | `	zEnd = &zString[nStrlen];` |
|      - | 2403 | `	/* Create the array */` |
|   6463 | 2404 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6463 | 2405 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6463 | 2406 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2407 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2408 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2409 | `		return PH7_OK;` |
|      - | 2410 | `	}` |
|      - | 2411 | `	/* Set a defualt limit */` |
|   6463 | 2412 | `	iLimit = SXI32_HIGH;` |
|   6463 | 2413 | `	if( nArg > 2 ){` |
...
|  77286 | 2448 | `	for(;;){` |
| 154577 | 2449 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 154577 | 2450 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2451 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6447 | 2452 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6447 | 2453 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2454 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2455 | `			}` |
|   6447 | 2456 | `			break;` |
|      - | 2457 | `		}` |
|      - | 2458 | `		/* Point to the desired offset */` |
| 148135 | 2459 | `		zCur = &zString[nOfft];` |
|      - | 2460 | `		/* Perform the store operation (may be empty) */` |
| 148135 | 2461 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 148135 | 2462 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2463 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2464 | `		}` |
|      - | 2465 | `		/* Point beyond the delimiter */` |
| 148135 | 2466 | `		zString = &zCur[nDelim];` |
|      - | 2467 | `		/* Reset the cursor */` |
| 148135 | 2468 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2469 | `	}` |
|      - | 2470 | `	/* Return the freshly created array */` |
|   6447 | 2471 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2472 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2473 | `	 * released as soon we return from this foregin function.` |
|      - | 2474 | `	 */` |
|   6447 | 2475 | `	return PH7_OK;` |
|   3239 | 2476 | `}` |
|      - | 2477 | `/*` |
...
|      - | 2491 | ` */` |
|  14590 | 2492 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2493 | `{` |
|      - | 2494 | `	const char *zString;` |
|      - | 2495 | `	int nLen;` |
|  14595 | 2496 | `	if( nArg < 1 ){` |
|      - | 2497 | `		/* Missing arguments,return null */` |
|    ! 0 | 2498 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2499 | `		return PH7_OK;` |
|      - | 2500 | `	}` |
|      - | 2501 | `	/* Extract the target string */` |
|  14595 | 2502 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14595 | 2503 | `	if( nLen < 1 ){` |
|      - | 2504 | `		/* Empty string,return */` |
|   1309 | 2505 | `		ph7_result_string(pCtx,"",0);` |
|   1309 | 2506 | `		return PH7_OK;` |
|      - | 2507 | `	}` |
|      - | 2508 | `	/* Start the trim process */` |
|  13291 | 2509 | `	if( nArg < 2 ){` |
|      - | 2510 | `		SyString sStr;` |
|      - | 2511 | `		/* Remove white spaces and NUL bytes */` |
|  13261 | 2512 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  33267 | 2513 | `		SyStringFullTrimSafe(&sStr);` |
|  13261 | 2514 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6633 | 2515 | `	}else{` |
|      - | 2516 | `		/* Char list */` |
...
|    ! 0 | 2717 | `		}else{` |
| 176541 | 2718 | `			int c = zString[0];` |
| 176541 | 2719 | `			if( SyisUpper(c) ){` |
| 174195 | 2720 | `				c = SyToLower(zString[0]);` |
|  87095 | 2721 | `			}` |
|      - | 2722 | `			/* Append character */` |
| 176541 | 2723 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2724 | `			/* Advance the cursor */` |
| 176541 | 2725 | `			zString++;` |
|      - | 2726 | `		}` |
|      5 | 2727 | `	}` |
|  33225 | 2728 | `	return PH7_OK;` |
|  16616 | 2729 | `}` |
|      - | 2730 | `/*` |
...
|      - | 8000 | ` */` |
|  29398 | 8001 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8002 | `{` |
...
|      - | 8011 | `	int nByte;` |
|      - | 8012 | `	sxi32 rc;` |
|  29403 | 8013 | `	if( nArg < 3 ){` |
|      - | 8014 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8015 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8016 | `		return PH7_OK;` |
|      - | 8017 | `	}` |
|      - | 8018 | `	/* Initialize fields */` |
|  29403 | 8019 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29403 | 8020 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29403 | 8021 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  29403 | 8022 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  29403 | 8023 | `	sRep.pCtx = pCtx;` |
|  29403 | 8024 | `	sRep.pCollector = &sSearch;` |
|  29403 | 8025 | `	rep_str = 0;` |
|      - | 8026 | `	/* Extract the subject */` |
|  29403 | 8027 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  29403 | 8028 | `	if( nByte < 1 ){` |
...
|  29375 | 8034 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8035 | `	/* Search string */` |
|  29375 | 8036 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8037 | `		/* Collect search string */` |
|      9 | 8038 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 8039 | `	}else{` |
|      - | 8040 | `		/* Single pattern */` |
|  29367 | 8041 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29367 | 8042 | `		if( nByte < 1 ){` |
...
|      - | 8046 | `		}` |
|  29363 | 8047 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8048 | `		/* Save for later processing */` |
|  29363 | 8049 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8050 | `	}` |
|      - | 8051 | `	/* Replace string */` |
|  29371 | 8052 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8053 | `		/* Collect replace string */` |
|      7 | 8054 | `		sRep.pCollector = &sReplace;` |
|      7 | 8055 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8056 | `	}else{` |
|      - | 8057 | `		/* Single needle */` |
|  29365 | 8058 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  29365 | 8059 | `		rep_str = 1;` |
|  29365 | 8060 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8061 | `		/* Save for later processing */` |
|  29365 | 8062 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8063 | `	}` |
|      - | 8064 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  29371 | 8065 | `	if( sRep.rc != SXRET_OK ){` |
...
|  29371 | 8072 | `	SySetResetCursor(&sSearch);` |
|  29371 | 8073 | `	SySetResetCursor(&sReplace);` |
|  29371 | 8074 | `	pReplace = pSearch = 0; /* cc warning */` |
|  29371 | 8075 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8076 | `	/* Extract function name */` |
|  29371 | 8077 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8078 | `	/* Set the default pattern match routine */` |
|  29371 | 8079 | `	xMatch = SyBlobSearch;` |
|  29371 | 8080 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8081 | `		/* Case insensitive pattern match */` |
|     11 | 8082 | `		xMatch = iPatternMatch;` |
|      5 | 8083 | `	}` |
|      - | 8084 | `	/* Start the replace process */` |
|  58745 | 8085 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8086 | `		sxu32 nCount,nOfft;` |
|  29379 | 8087 | `		if( pSearch->nByte <  1 ){` |
|      - | 8088 | `			/* Empty string,ignore */` |
|      3 | 8089 | `			continue;` |
|      - | 8090 | `		}` |
|      - | 8091 | `		/* Extract the replace string */` |
|  29377 | 8092 | `		if( rep_str ){` |
|  29367 | 8093 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14686 | 8094 | `		}else{` |
...
|      1 | 8100 | `			}` |
|      - | 8101 | `		}` |
|  29377 | 8102 | `		if( pReplace == 0 ){` |
|      - | 8103 | `			/* Use an empty string instead */` |
|      3 | 8104 | `			pReplace = &sTemp;` |
|      1 | 8105 | `		}` |
|  29377 | 8106 | `		nOfft = nCount = 0;` |
|  14709 | 8107 | `		for(;;){` |
|  29423 | 8108 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8109 | `				break;` |
|      - | 8110 | `			}` |
|      - | 8111 | `			/* Perform a pattern lookup */` |
|  44114 | 8112 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  29406 | 8113 | `				pSearch->nByte,&nOfft);` |
|  29411 | 8114 | `			if( rc != SXRET_OK ){` |
...
|  29371 | 8132 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  29371 | 8133 | `	SySetRelease(&sSearch);` |
|  29371 | 8134 | `	SySetRelease(&sReplace);` |
|  29371 | 8135 | `	SyBlobRelease(&sWorker);` |
|  29371 | 8136 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8137 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8138 | `	}` |
|  29371 | 8139 | `	return PH7_OK;` |
|  14704 | 8140 | `}` |
|      - | 8141 | `/*` |
