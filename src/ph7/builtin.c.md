...
|      - |  268 | ` */` |
|  16306 |  269 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  270 |  |
|  16308 |  271 | `	int res = 1; /* Assume empty by default */` |
|  16308 |  272 | `	if( nArg > 0 ){` |
|  16306 |  273 | `		res = ph7_value_is_empty(apArg[0]);` |
|   8152 |  274 | `	}` |
|  16308 |  275 | `	ph7_result_bool(pCtx,res);` |
|  16308 |  276 | `	return PH7_OK;` |
|      - |  277 |  |
|      2 |  278 |  |
...
|      - | 1287 | ` */` |
| 115294 | 1288 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1289 |  |
|      - | 1290 | `	const char *zSource,*zOfft;` |
|      - | 1291 | `	int nOfft,nLen,nSrcLen;` |
| 115296 | 1292 | `	if( nArg < 2 ){` |
|      - | 1293 | `		/* return FALSE */` |
|      5 | 1294 | `		ph7_result_bool(pCtx,0);` |
|      5 | 1295 | `		return PH7_OK;` |
|      - | 1296 | `	}` |
|      - | 1297 | `	/* Extract the target string */` |
| 115292 | 1298 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 115292 | 1299 | `	if( nSrcLen < 1 ){` |
|      - | 1300 | `		/* Empty string,return FALSE */` |
|   7264 | 1301 | `		ph7_result_bool(pCtx,0);` |
|   7264 | 1302 | `		return PH7_OK;` |
|      - | 1303 | `	}` |
| 108030 | 1304 | `	nLen = nSrcLen; /* cc warning */` |
|      - | 1305 | `	/* Extract the offset */` |
| 108030 | 1306 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 108030 | 1307 | `	if( nOfft < 0 ){` |
|  18072 | 1308 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  18072 | 1309 | `		if( zOfft < zSource ){` |
|      - | 1310 | `			/* Invalid offset */` |
|      5 | 1311 | `			ph7_result_bool(pCtx,0);` |
|      5 | 1312 | `			return PH7_OK;` |
|      - | 1313 | `		}` |
|  18068 | 1314 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  18068 | 1315 | `		nOfft = (int)(zOfft-zSource);` |
|  98993 | 1316 | `	}else if( nOfft >= nSrcLen ){` |
|      - | 1317 | `		/* Invalid offset */` |
|      7 | 1318 | `		ph7_result_bool(pCtx,0);` |
|      7 | 1319 | `		return PH7_OK;` |
|    ! 0 | 1320 | `	}else{` |
|  89954 | 1321 | `		zOfft = &zSource[nOfft];` |
|  89954 | 1322 | `		nLen = nSrcLen - nOfft;` |
|      - | 1323 | `	}` |
| 108020 | 1324 | `	if( nArg > 2 ){` |
|      - | 1325 | `		/* Extract the length */` |
|  89952 | 1326 | `		nLen = ph7_value_to_int(apArg[2]);` |
|  89952 | 1327 | `		if( nLen == 0 ){` |
|      - | 1328 | `			/* Invalid length,return an empty string */` |
|      5 | 1329 | `			ph7_result_string(pCtx,"",0);` |
|      5 | 1330 | `			return PH7_OK;` |
|  89948 | 1331 | `		}else if( nLen < 0 ){` |
|  18070 | 1332 | `			nLen = nSrcLen + nLen - nOfft;` |
|  18070 | 1333 | `			if( nLen < 1 ){` |
|      - | 1334 | `				/* Invalid  length */` |
|      3 | 1335 | `				nLen = nSrcLen - nOfft;` |
|      1 | 1336 | `			}` |
|   9034 | 1337 | `		}` |
|  89948 | 1338 | `		if( nLen + nOfft > nSrcLen ){` |
|      - | 1339 | `			/* Invalid length */` |
|   2198 | 1340 | `			nLen = nSrcLen - nOfft;` |
|   1098 | 1341 | `		}` |
|  44973 | 1342 | `	}` |
|      - | 1343 | `	/* Return the substring */` |
| 108016 | 1344 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 108016 | 1345 | `	return PH7_OK;` |
|  57649 | 1346 |  |
|      - | 1347 | `/*` |
...
|      - | 2314 | ` */` |
|   1808 | 2315 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2316 |  |
|   1810 | 2317 | `	int iLen = 0;` |
|   1810 | 2318 | `	if( nArg > 0 ){` |
|   1808 | 2319 | `		ph7_value_to_string(apArg[0],&iLen);` |
|    903 | 2320 | `	}` |
|      - | 2321 | `	/* String length */` |
|   1810 | 2322 | `	ph7_result_int(pCtx,iLen);` |
|   1810 | 2323 | `	return PH7_OK;` |
|      2 | 2324 |  |
|      - | 2325 | `/*` |
...
|      - | 2467 | ` */` |
|  81496 | 2468 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      2 | 2469 |  |
|  40748 | 2470 | `	SXUNUSED(pKey);` |
|  81498 | 2471 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2472 | `	const char *zData;` |
|      - | 2473 | `	int nLen;` |
|  81498 | 2474 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
|  81496 | 2491 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2492 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
|  81496 | 2493 | `	if( pData->bFirst ){` |
|  18230 | 2494 | `		pData->bFirst = 0;` |
|  72382 | 2495 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2496 | `		/* append the separator first */` |
|  63256 | 2497 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  31627 | 2498 | `	}` |
|      - | 2499 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
|  81496 | 2500 | `	if( nLen > 0 ){` |
|  74234 | 2501 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  37116 | 2502 | `	}` |
|  81496 | 2503 | `	return PH7_OK;` |
|  40750 | 2504 |  |
|      - | 2505 | `/*` |
...
|      - | 2517 | ` */` |
|  18256 | 2518 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2519 |  |
|      - | 2520 | `	struct implode_data imp_data;` |
|  18258 | 2521 | `	int i = 1;` |
|  18258 | 2522 | `	if( nArg < 1 ){` |
|      - | 2523 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2524 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2525 | `		return PH7_OK;` |
|      - | 2526 | `	}` |
|      - | 2527 | `	/* Prepare the implode context */` |
|  18258 | 2528 | `	imp_data.pCtx = pCtx;` |
|  18258 | 2529 | `	imp_data.bRecursive = 0;` |
|  18258 | 2530 | `	imp_data.bFirst = 1;` |
|  18258 | 2531 | `	imp_data.nRecCount = 0;` |
|  18258 | 2532 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  18256 | 2533 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|   9129 | 2534 | `	}else{` |
|      3 | 2535 | `		imp_data.zSep = 0;` |
|      3 | 2536 | `		imp_data.nSeplen = 0;` |
|      3 | 2537 | `		i = 0;` |
|      - | 2538 | `	}` |
|  18258 | 2539 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 2540 | `	/* Start the 'join' process */` |
|  36514 | 2541 | `	while( i < nArg ){` |
|  18258 | 2542 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2543 | `			/* Iterate throw array entries */` |
|  18258 | 2544 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|   9130 | 2545 | `		}else{` |
...
|      - | 2652 | ` */` |
|   3322 | 2653 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2654 |  |
...
|   3316 | 2667 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   3316 | 2668 | `	if( nDelim < 1 ){` |
|      - | 2669 | `		/* Empty delimiter,return FALSE */` |
|      3 | 2670 | `		ph7_result_bool(pCtx,0);` |
|      3 | 2671 | `		return PH7_OK;` |
|      - | 2672 | `	}` |
|      - | 2673 | `	/* Extract the string */` |
|   3314 | 2674 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   3314 | 2675 | `	if( nStrlen < 1 ){` |
...
|   3312 | 2690 | `	zEnd = &zString[nStrlen];` |
|      - | 2691 | `	/* Create the array */` |
|   3312 | 2692 | `	pArray =  ph7_context_new_array(pCtx);` |
|   3312 | 2693 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   3312 | 2694 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2695 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2696 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2697 | `		return PH7_OK;` |
|      - | 2698 | `	}` |
|      - | 2699 | `	/* Set a defualt limit */` |
|   3312 | 2700 | `	iLimit = SXI32_HIGH;` |
|   3312 | 2701 | `	if( nArg > 2 ){` |
...
|  39591 | 2712 | `	for(;;){` |
|  79184 | 2713 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
|  79184 | 2714 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2715 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   3312 | 2716 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   3312 | 2717 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   3312 | 2718 | `			break;` |
|      - | 2719 | `		}` |
|      - | 2720 | `		/* Point to the desired offset */` |
|  75874 | 2721 | `		zCur = &zString[nOfft];` |
|      - | 2722 | `		/* Perform the store operation (may be empty) */` |
|  75874 | 2723 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
|  75874 | 2724 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 2725 | `		/* Point beyond the delimiter */` |
|  75874 | 2726 | `		zString = &zCur[nDelim];` |
|      - | 2727 | `		/* Reset the cursor */` |
|  75874 | 2728 | `		ph7_value_reset_string_cursor(pValue);` |
|      2 | 2729 | `	}` |
|      - | 2730 | `	/* Return the freshly created array */` |
|   3312 | 2731 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2732 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2733 | `	 * released as soon we return from this foregin function.` |
|      - | 2734 | `	 */` |
|   3312 | 2735 | `	return PH7_OK;` |
|   1663 | 2736 |  |
|      - | 2737 | `/*` |
...
|      - | 2751 | ` */` |
|   8202 | 2752 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2753 |  |
...
|   8202 | 2762 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|   8202 | 2763 | `	if( nLen < 1 ){` |
...
|   6584 | 2772 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  15970 | 2773 | `		SyStringFullTrimSafe(&sStr);` |
|   6584 | 2774 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   3293 | 2775 | `	}else{` |
|      - | 2776 | `		/* Char list */` |
...
|    ! 0 | 3026 | `		}else{` |
|  96166 | 3027 | `			int c = zString[0];` |
|  96166 | 3028 | `			if( SyisUpper(c) ){` |
|  96164 | 3029 | `				c = SyToLower(zString[0]);` |
|  48081 | 3030 | `			}` |
|      - | 3031 | `			/* Append character */` |
|  96166 | 3032 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 3033 | `			/* Advance the cursor */` |
|  96166 | 3034 | `			zString++;` |
|      - | 3035 | `		}` |
|      2 | 3036 | `	}` |
|  18068 | 3037 | `	return PH7_OK;` |
|   9037 | 3038 |  |
|      - | 3039 | `/*` |
...
|      - | 6347 | ` */` |
|  13138 | 6348 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6349 |  |
...
|      - | 6358 | `	int nByte;` |
|      - | 6359 | `	sxi32 rc;` |
|  13140 | 6360 | `	if( nArg < 3 ){` |
|      - | 6361 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 6362 | `		ph7_result_null(pCtx);` |
|      7 | 6363 | `		return PH7_OK;` |
|      - | 6364 | `	}` |
|      - | 6365 | `	/* Initialize fields */` |
|  13134 | 6366 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  13134 | 6367 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  13134 | 6368 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  13134 | 6369 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  13134 | 6370 | `	sRep.pCtx = pCtx;` |
|  13134 | 6371 | `	sRep.pCollector = &sSearch;` |
|  13134 | 6372 | `	rep_str = 0;` |
|      - | 6373 | `	/* Extract the subject */` |
|  13134 | 6374 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  13134 | 6375 | `	if( nByte < 1 ){` |
...
|  13098 | 6381 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 6382 | `	/* Search string */` |
|  13098 | 6383 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 6384 | `		/* Collect search string */` |
|      9 | 6385 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 6386 | `	}else{` |
|      - | 6387 | `		/* Single pattern */` |
|  13090 | 6388 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  13090 | 6389 | `		if( nByte < 1 ){` |
...
|      - | 6393 | `		}` |
|  13086 | 6394 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6395 | `		/* Save for later processing */` |
|  13086 | 6396 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 6397 | `	}` |
|      - | 6398 | `	/* Replace string */` |
|  13094 | 6399 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 6400 | `		/* Collect replace string */` |
|      7 | 6401 | `		sRep.pCollector = &sReplace;` |
|      7 | 6402 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 6403 | `	}else{` |
|      - | 6404 | `		/* Single needle */` |
|  13088 | 6405 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  13088 | 6406 | `		rep_str = 1;` |
|  13088 | 6407 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6408 | `		/* Save for later processing */` |
|  13088 | 6409 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 6410 | `	}` |
|      - | 6411 | `	/* Reset loop cursors */` |
|  13094 | 6412 | `	SySetResetCursor(&sSearch);` |
|  13094 | 6413 | `	SySetResetCursor(&sReplace);` |
|  13094 | 6414 | `	pReplace = pSearch = 0; /* cc warning */` |
|  13094 | 6415 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 6416 | `	/* Extract function name */` |
|  13094 | 6417 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 6418 | `	/* Set the default pattern match routine */` |
|  13094 | 6419 | `	xMatch = SyBlobSearch;` |
|  13094 | 6420 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 6421 | `		/* Case insensitive pattern match */` |
|     11 | 6422 | `		xMatch = iPatternMatch;` |
|      5 | 6423 | `	}` |
|      - | 6424 | `	/* Start the replace process */` |
|  26194 | 6425 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 6426 | `		sxu32 nCount,nOfft;` |
|  13102 | 6427 | `		if( pSearch->nByte <  1 ){` |
|      - | 6428 | `			/* Empty string,ignore */` |
|      3 | 6429 | `			continue;` |
|      - | 6430 | `		}` |
|      - | 6431 | `		/* Extract the replace string */` |
|  13100 | 6432 | `		if( rep_str ){` |
|  13090 | 6433 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|   6546 | 6434 | `		}else{` |
...
|      1 | 6440 | `			}` |
|      - | 6441 | `		}` |
|  13100 | 6442 | `		if( pReplace == 0 ){` |
|      - | 6443 | `			/* Use an empty string instead */` |
|      3 | 6444 | `			pReplace = &sTemp;` |
|      1 | 6445 | `		}` |
|  13100 | 6446 | `		nOfft = nCount = 0;` |
|   6565 | 6447 | `		for(;;){` |
|  13132 | 6448 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 6449 | `				break;` |
|      - | 6450 | `			}` |
|      - | 6451 | `			/* Perform a pattern lookup */` |
|  19679 | 6452 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  13118 | 6453 | `				pSearch->nByte,&nOfft);` |
|  13120 | 6454 | `			if( rc != SXRET_OK ){` |
...
|  13094 | 6465 | `	ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  13094 | 6466 | `	SySetRelease(&sSearch);` |
|  13094 | 6467 | `	SySetRelease(&sReplace);` |
|  13094 | 6468 | `	SyBlobRelease(&sWorker);` |
|  13094 | 6469 | `	return PH7_OK;` |
|   6571 | 6470 |  |
|      - | 6471 | `/*` |
...
|      - | 6935 | ` */` |
|   1674 | 6936 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6937 |  |
...
|   1674 | 6946 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   1674 | 6947 | `	zEnd = &zIn[nLen];` |
|   1674 | 6948 | `	if( nLen < 1 ){` |
...
|   1551 | 6954 | `	for(;;){` |
|   3104 | 6955 | `		if( zIn >= zEnd ){` |
|      - | 6956 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1402 | 6957 | `			ph7_result_bool(pCtx,1);` |
|   1402 | 6958 | `			return PH7_OK;` |
|      - | 6959 | `		}` |
|   1704 | 6960 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 6961 | `			/* UTF-8 stream  */` |
|    ! 0 | 6962 | `			break;` |
|      - | 6963 | `		}` |
|   1704 | 6964 | `		if( !SyisDigit(zIn[0]) ){` |
|    272 | 6965 | `			break;` |
|      - | 6966 | `		}` |
...
|    272 | 6971 | `	ph7_result_bool(pCtx,0);` |
|    272 | 6972 | `	return PH7_OK;` |
|    839 | 6973 |  |
|      - | 6974 | `/*` |
...
|      - | 7177 | ` */` |
|  49134 | 7178 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 7179 |  |
|      - | 7180 | `	const unsigned char *zIn,*zEnd;` |
|      - | 7181 | `	int nLen;` |
|  49136 | 7182 | `	if( nArg < 1 ){` |
|      - | 7183 | `		/* Missing arguments,return FALSE */` |
|      3 | 7184 | `		ph7_result_bool(pCtx,0);` |
|      3 | 7185 | `		return PH7_OK;` |
|      - | 7186 | `	}` |
|      - | 7187 | `	/* Extract the target string */` |
|  49134 | 7188 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  49134 | 7189 | `	zEnd = &zIn[nLen];` |
|  49134 | 7190 | `	if( nLen < 1 ){` |
...
|  25024 | 7196 | `	for(;;){` |
|  50006 | 7197 | `		if( zIn >= zEnd ){` |
|      - | 7198 | `			/* If we reach the end of the string,then the test succeeded. */` |
|    852 | 7199 | `			ph7_result_bool(pCtx,1);` |
|    852 | 7200 | `			return PH7_OK;` |
|      - | 7201 | `		}` |
|  49156 | 7202 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 7203 | `			/* UTF-8 stream  */` |
|    ! 0 | 7204 | `			break;` |
|      - | 7205 | `		}` |
|  49156 | 7206 | `		if( !SyisSpace(zIn[0]) ){` |
|  48282 | 7207 | `			break;` |
|      - | 7208 | `		}` |
...
|  48282 | 7213 | `	ph7_result_bool(pCtx,0);` |
|  48282 | 7214 | `	return PH7_OK;` |
|  24591 | 7215 |  |
|      - | 7216 | `/*` |
...
|      - | 9006 | ` */` |
|   1208 | 9007 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      2 | 9008 |  |
|      - | 9009 | `	sxu32 n;` |
| 184826 | 9010 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 183618 | 9011 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
|  91810 | 9012 | `	}` |
|      - | 9013 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   1210 | 9014 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 9015 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   1210 | 9016 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   1210 | 9017 |  |
|      - | 9018 |  |
