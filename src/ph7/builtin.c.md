...
|      - |  294 | ` */` |
|  27318 |  295 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  296 |  |
|  27323 |  297 | `	int res = 1; /* Assume empty by default */` |
|  27323 |  298 | `	if( nArg > 0 ){` |
|  27321 |  299 | `		res = ph7_value_is_empty(apArg[0]);` |
|  13658 |  300 | `	}` |
|  27323 |  301 | `	ph7_result_bool(pCtx,res);` |
|  27323 |  302 | `	return PH7_OK;` |
|      - |  303 |  |
|      5 |  304 |  |
...
|      - |  344 | ` */` |
| 205522 |  345 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  346 |  |
|      - |  347 | `	const char *zSource,*zOfft;` |
|      - |  348 | `	int nOfft,nLen,nSrcLen;` |
| 205527 |  349 | `	if( nArg < 2 ){` |
|      - |  350 | `		/* return FALSE */` |
|      5 |  351 | `		ph7_result_bool(pCtx,0);` |
|      5 |  352 | `		return PH7_OK;` |
|      - |  353 | `	}` |
|      - |  354 | `	/* Extract the target string */` |
| 205523 |  355 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 205523 |  356 | `	if( nSrcLen < 1 ){` |
|      - |  357 | `		/* Empty string,return FALSE */` |
|  11703 |  358 | `		ph7_result_bool(pCtx,0);` |
|  11703 |  359 | `		return PH7_OK;` |
|      - |  360 | `	}` |
| 193825 |  361 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  362 | `	/* Extract the offset */` |
| 193825 |  363 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 193825 |  364 | `	if( nOfft < 0 ){` |
|  31733 |  365 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  31733 |  366 | `		if( zOfft < zSource ){` |
|      - |  367 | `			/* Invalid offset */` |
|      5 |  368 | `			ph7_result_bool(pCtx,0);` |
|      5 |  369 | `			return PH7_OK;` |
|      - |  370 | `		}` |
|  31729 |  371 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  31729 |  372 | `		nOfft = (int)(zOfft-zSource);` |
| 177959 |  373 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  374 | `		/* Invalid offset */` |
|    179 |  375 | `		ph7_result_bool(pCtx,0);` |
|    179 |  376 | `		return PH7_OK;` |
|    ! 0 |  377 | `	}else{` |
| 161923 |  378 | `		zOfft = &zSource[nOfft];` |
| 161923 |  379 | `		nLen = nSrcLen - nOfft;` |
|      - |  380 | `	}` |
| 193647 |  381 | `	if( nArg > 2 ){` |
|      - |  382 | `		/* Extract the length */` |
| 160141 |  383 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 160141 |  384 | `		if( nLen == 0 ){` |
|      - |  385 | `			/* Invalid length,return an empty string */` |
|      5 |  386 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  387 | `			return PH7_OK;` |
| 160137 |  388 | `		}else if( nLen < 0 ){` |
|  31721 |  389 | `			nLen = nSrcLen + nLen - nOfft;` |
|  31721 |  390 | `			if( nLen < 1 ){` |
|      - |  391 | `				/* Invalid  length */` |
|      3 |  392 | `				nLen = nSrcLen - nOfft;` |
|      1 |  393 | `			}` |
|  15858 |  394 | `		}` |
| 160137 |  395 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  396 | `			/* Invalid length */` |
|   4775 |  397 | `			nLen = nSrcLen - nOfft;` |
|   2385 |  398 | `		}` |
|  80066 |  399 | `	}` |
|      - |  400 | `	/* Return the substring */` |
| 193643 |  401 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 193643 |  402 | `	return PH7_OK;` |
| 102766 |  403 |  |
|      - |  404 | `/*` |
...
|      - | 1525 | ` */` |
| 129322 | 1526 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1527 |  |
|  64661 | 1528 | `	SXUNUSED(pKey);` |
| 129327 | 1529 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1530 | `	const char *zData;` |
|      - | 1531 | `	int nLen;` |
| 129327 | 1532 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 129325 | 1556 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1557 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 129325 | 1558 | `	if( pData->bFirst ){` |
|  32065 | 1559 | `		pData->bFirst = 0;` |
| 113295 | 1560 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1561 | `		/* append the separator first */` |
|  97253 | 1562 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 129325 | 1568 | `	if( nLen > 0 ){` |
| 117627 | 1569 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1570 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1571 | `			return PH7_ABORT;` |
|      - | 1572 | `		}` |
|  58811 | 1573 | `	}` |
| 129325 | 1574 | `	return PH7_OK;` |
|  64666 | 1575 |  |
|      - | 1576 | `/*` |
...
|      - | 1588 | ` */` |
|  32086 | 1589 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1590 |  |
|      - | 1591 | `	struct implode_data imp_data;` |
|  32091 | 1592 | `	int i = 1;` |
|  32091 | 1593 | `	if( nArg < 1 ){` |
|      - | 1594 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1595 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1596 | `		return PH7_OK;` |
|      - | 1597 | `	}` |
|      - | 1598 | `	/* Prepare the implode context */` |
|  32091 | 1599 | `	imp_data.pCtx = pCtx;` |
|  32091 | 1600 | `	imp_data.bRecursive = 0;` |
|  32091 | 1601 | `	imp_data.bFirst = 1;` |
|  32091 | 1602 | `	imp_data.nRecCount = 0;` |
|  32091 | 1603 | `	imp_data.rc = SXRET_OK;` |
|  32091 | 1604 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  32089 | 1605 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16047 | 1606 | `	}else{` |
|      3 | 1607 | `		imp_data.zSep = 0;` |
|      3 | 1608 | `		imp_data.nSeplen = 0;` |
|      3 | 1609 | `		i = 0;` |
|      - | 1610 | `	}` |
|  32091 | 1611 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1612 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1613 | `	}` |
|      - | 1614 | `	/* Start the 'join' process */` |
|  64177 | 1615 | `	while( i < nArg ){` |
|  32091 | 1616 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1617 | `			/* Iterate throw array entries */` |
|  32091 | 1618 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1619 | `			/* Surface a callback allocation failure as a fatal */` |
|  32091 | 1620 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 1745 | ` */` |
|   6048 | 1746 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1747 |  |
...
|   6045 | 1760 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6045 | 1761 | `	if( nDelim < 1 ){` |
|      - | 1762 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1763 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1764 | `		return PH7_OK;` |
|      - | 1765 | `	}` |
|      - | 1766 | `	/* Extract the string */` |
|   6043 | 1767 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6043 | 1768 | `	if( nStrlen < 1 ){` |
...
|   6041 | 1785 | `	zEnd = &zString[nStrlen];` |
|      - | 1786 | `	/* Create the array */` |
|   6041 | 1787 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6041 | 1788 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6041 | 1789 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1790 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1791 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1792 | `		return PH7_OK;` |
|      - | 1793 | `	}` |
|      - | 1794 | `	/* Set a defualt limit */` |
|   6041 | 1795 | `	iLimit = SXI32_HIGH;` |
|   6041 | 1796 | `	if( nArg > 2 ){` |
...
|  70079 | 1807 | `	for(;;){` |
| 140163 | 1808 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 140163 | 1809 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1810 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6041 | 1811 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6041 | 1812 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1813 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 1814 | `			}` |
|   6041 | 1815 | `			break;` |
|      - | 1816 | `		}` |
|      - | 1817 | `		/* Point to the desired offset */` |
| 134127 | 1818 | `		zCur = &zString[nOfft];` |
|      - | 1819 | `		/* Perform the store operation (may be empty) */` |
| 134127 | 1820 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 134127 | 1821 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1822 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 1823 | `		}` |
|      - | 1824 | `		/* Point beyond the delimiter */` |
| 134127 | 1825 | `		zString = &zCur[nDelim];` |
|      - | 1826 | `		/* Reset the cursor */` |
| 134127 | 1827 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 1828 | `	}` |
|      - | 1829 | `	/* Return the freshly created array */` |
|   6041 | 1830 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1831 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1832 | `	 * released as soon we return from this foregin function.` |
|      - | 1833 | `	 */` |
|   6041 | 1834 | `	return PH7_OK;` |
|   3029 | 1835 |  |
|      - | 1836 | `/*` |
...
|      - | 1850 | ` */` |
|  13804 | 1851 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1852 |  |
|      - | 1853 | `	const char *zString;` |
|      - | 1854 | `	int nLen;` |
|  13809 | 1855 | `	if( nArg < 1 ){` |
|      - | 1856 | `		/* Missing arguments,return null */` |
|      3 | 1857 | `		ph7_result_null(pCtx);` |
|      3 | 1858 | `		return PH7_OK;` |
|      - | 1859 | `	}` |
|      - | 1860 | `	/* Extract the target string */` |
|  13807 | 1861 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  13807 | 1862 | `	if( nLen < 1 ){` |
|      - | 1863 | `		/* Empty string,return */` |
|   1727 | 1864 | `		ph7_result_string(pCtx,"",0);` |
|   1727 | 1865 | `		return PH7_OK;` |
|      - | 1866 | `	}` |
|      - | 1867 | `	/* Start the trim process */` |
|  12085 | 1868 | `	if( nArg < 2 ){` |
|      - | 1869 | `		SyString sStr;` |
|      - | 1870 | `		/* Remove white spaces and NUL bytes */` |
|  12081 | 1871 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  29559 | 1872 | `		SyStringFullTrimSafe(&sStr);` |
|  12081 | 1873 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6043 | 1874 | `	}else{` |
|      - | 1875 | `		/* Char list */` |
...
|    ! 0 | 2125 | `		}else{` |
| 168145 | 2126 | `			int c = zString[0];` |
| 168145 | 2127 | `			if( SyisUpper(c) ){` |
| 168143 | 2128 | `				c = SyToLower(zString[0]);` |
|  84069 | 2129 | `			}` |
|      - | 2130 | `			/* Append character */` |
| 168145 | 2131 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2132 | `			/* Advance the cursor */` |
| 168145 | 2133 | `			zString++;` |
|      - | 2134 | `		}` |
|      5 | 2135 | `	}` |
|  31719 | 2136 | `	return PH7_OK;` |
|  15864 | 2137 |  |
|      - | 2138 | `/*` |
...
|      - | 6626 | ` */` |
|  24018 | 6627 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 6628 |  |
...
|      - | 6637 | `	int nByte;` |
|      - | 6638 | `	sxi32 rc;` |
|  24023 | 6639 | `	if( nArg < 3 ){` |
|      - | 6640 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 6641 | `		ph7_result_null(pCtx);` |
|      7 | 6642 | `		return PH7_OK;` |
|      - | 6643 | `	}` |
|      - | 6644 | `	/* Initialize fields */` |
|  24017 | 6645 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  24017 | 6646 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  24017 | 6647 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  24017 | 6648 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  24017 | 6649 | `	sRep.pCtx = pCtx;` |
|  24017 | 6650 | `	sRep.pCollector = &sSearch;` |
|  24017 | 6651 | `	rep_str = 0;` |
|      - | 6652 | `	/* Extract the subject */` |
|  24017 | 6653 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  24017 | 6654 | `	if( nByte < 1 ){` |
...
|  23989 | 6660 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 6661 | `	/* Search string */` |
|  23989 | 6662 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 6663 | `		/* Collect search string */` |
|      9 | 6664 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 6665 | `	}else{` |
|      - | 6666 | `		/* Single pattern */` |
|  23981 | 6667 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  23981 | 6668 | `		if( nByte < 1 ){` |
...
|      - | 6672 | `		}` |
|  23977 | 6673 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6674 | `		/* Save for later processing */` |
|  23977 | 6675 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 6676 | `	}` |
|      - | 6677 | `	/* Replace string */` |
|  23985 | 6678 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 6679 | `		/* Collect replace string */` |
|      7 | 6680 | `		sRep.pCollector = &sReplace;` |
|      7 | 6681 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 6682 | `	}else{` |
|      - | 6683 | `		/* Single needle */` |
|  23979 | 6684 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  23979 | 6685 | `		rep_str = 1;` |
|  23979 | 6686 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 6687 | `		/* Save for later processing */` |
|  23979 | 6688 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 6689 | `	}` |
|      - | 6690 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  23985 | 6691 | `	if( sRep.rc != SXRET_OK ){` |
...
|  23985 | 6698 | `	SySetResetCursor(&sSearch);` |
|  23985 | 6699 | `	SySetResetCursor(&sReplace);` |
|  23985 | 6700 | `	pReplace = pSearch = 0; /* cc warning */` |
|  23985 | 6701 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 6702 | `	/* Extract function name */` |
|  23985 | 6703 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 6704 | `	/* Set the default pattern match routine */` |
|  23985 | 6705 | `	xMatch = SyBlobSearch;` |
|  23985 | 6706 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 6707 | `		/* Case insensitive pattern match */` |
|     11 | 6708 | `		xMatch = iPatternMatch;` |
|      5 | 6709 | `	}` |
|      - | 6710 | `	/* Start the replace process */` |
|  47973 | 6711 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 6712 | `		sxu32 nCount,nOfft;` |
|  23993 | 6713 | `		if( pSearch->nByte <  1 ){` |
|      - | 6714 | `			/* Empty string,ignore */` |
|      3 | 6715 | `			continue;` |
|      - | 6716 | `		}` |
|      - | 6717 | `		/* Extract the replace string */` |
|  23991 | 6718 | `		if( rep_str ){` |
|  23981 | 6719 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  11993 | 6720 | `		}else{` |
...
|      1 | 6726 | `			}` |
|      - | 6727 | `		}` |
|  23991 | 6728 | `		if( pReplace == 0 ){` |
|      - | 6729 | `			/* Use an empty string instead */` |
|      3 | 6730 | `			pReplace = &sTemp;` |
|      1 | 6731 | `		}` |
|  23991 | 6732 | `		nOfft = nCount = 0;` |
|  12009 | 6733 | `		for(;;){` |
|  24023 | 6734 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 6735 | `				break;` |
|      - | 6736 | `			}` |
|      - | 6737 | `			/* Perform a pattern lookup */` |
|  36014 | 6738 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  24006 | 6739 | `				pSearch->nByte,&nOfft);` |
|  24011 | 6740 | `			if( rc != SXRET_OK ){` |
...
|  23985 | 6758 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  23985 | 6759 | `	SySetRelease(&sSearch);` |
|  23985 | 6760 | `	SySetRelease(&sReplace);` |
|  23985 | 6761 | `	SyBlobRelease(&sWorker);` |
|  23985 | 6762 | `	if( rc != PH7_OK ){` |
|    ! 0 | 6763 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 6764 | `	}` |
|  23985 | 6765 | `	return PH7_OK;` |
|  12014 | 6766 |  |
|      - | 6767 | `/*` |
