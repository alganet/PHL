...
| 476952 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 476957 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 476957 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 476943 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 476927 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 476927 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 476927 |  121 | `	return PH7_OK;` |
| 238530 |  122 | `}` |
|      - |  123 |  |
...
|      - |  420 | ` */` |
|  39624 |  421 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  422 | `{` |
|  39629 |  423 | `	int res = 1; /* Assume empty by default */` |
|  39629 |  424 | `	if( nArg > 0 ){` |
|  39627 |  425 | `		res = ph7_value_is_empty(apArg[0]);` |
|  19811 |  426 | `	}` |
|  39629 |  427 | `	ph7_result_bool(pCtx,res);` |
|  39629 |  428 | `	return PH7_OK;` |
|      - |  429 |  |
|      5 |  430 | `}` |
