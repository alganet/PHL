...
Coverage: 4465/5267 lines (84.77%)
...
| 501506 |    18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |    19 | `	ph7_context *pCtx,` |
|      - |    20 | `	ph7_value *pArg,` |
|      - |    21 | `	const char *zFunc,` |
|      - |    22 | `	int iArgNum,` |
...
|      - |    25 | `	sxi64 *pOut` |
|      5 |    26 | `){` |
| 501511 |    27 | `	if( ph7_value_is_null(pArg) ){` |
...
|    ! 0 |    33 | `		return PH7_OK;` |
|      - |    34 | `	}` |
| 501511 |    35 | `	if( ph7_value_is_float(pArg) ){` |
...
|      3 |    54 | `		return PH7_OK;` |
|      - |    55 | `	}` |
| 501505 |    56 | `	if( ph7_value_is_string(pArg) ){` |
|      - |    57 | `		const char *zNum;` |
|      - |    58 | `		int nSlen;` |
...
|      5 |    96 | `		return PH7_OK;` |
|      - |    97 | `	}` |
| 501491 |    98 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |   111 | `			);` |
|      - |   112 | `	}` |
| 501491 |   113 | `	*pOut = ph7_value_to_int64(pArg);` |
| 501491 |   114 | `	return PH7_OK;` |
| 250833 |   115 | `}` |
|      - |   116 |  |
...
|      - |   137 | ` */` |
|     76 |   138 | `static int PH7_builtin_is_bool(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   139 | `{` |
|     78 |   140 | `	int res = 0; /* Assume false by default */` |
|     78 |   141 | `	if( nArg > 0 ){` |
|     78 |   142 | `		res = ph7_value_is_bool(apArg[0]);` |
|     38 |   143 | `	}` |
|      - |   144 | `	/* Query result */` |
|     78 |   145 | `	ph7_result_bool(pCtx,res);` |
|     78 |   146 | `	return PH7_OK;` |
|      2 |   147 | `}` |
|      - |   148 | `/*` |
...
|      - |   177 | ` */` |
|    930 |   178 | `static int PH7_builtin_is_int(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |   179 | `{` |
|    934 |   180 | `	int res = 0; /* Assume false by default */` |
|    934 |   181 | `	if( nArg > 0 ){` |
...
|    934 |   185 | `		res = ph7_value_is_int(apArg[0]) && !ph7_value_is_float(apArg[0]);` |
|    465 |   186 | `	}` |
|      - |   187 | `	/* Query result */` |
|    934 |   188 | `	ph7_result_bool(pCtx,res);` |
|    934 |   189 | `	return PH7_OK;` |
|      4 |   190 | `}` |
|      - |   191 | `/*` |
...
|      - |   198 | ` */` |
|   1122 |   199 | `static int PH7_builtin_is_string(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   200 | `{` |
|   1127 |   201 | `	int res = 0; /* Assume false by default */` |
|   1127 |   202 | `	if( nArg > 0 ){` |
|   1127 |   203 | `		res = ph7_value_is_string(apArg[0]);` |
|    561 |   204 | `	}` |
|      - |   205 | `	/* Query result */` |
|   1127 |   206 | `	ph7_result_bool(pCtx,res);` |
|   1127 |   207 | `	return PH7_OK;` |
|      5 |   208 | `}` |
|      - |   209 | `/*` |
...
|      - |   277 | ` */` |
|    820 |   278 | `static int PH7_builtin_is_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |   279 | `{` |
|    824 |   280 | `	int res = 0; /* Assume false by default */` |
|    824 |   281 | `	if( nArg > 0 ){` |
|    824 |   282 | `		res = ph7_value_is_array(apArg[0]);` |
|    410 |   283 | `	}` |
|      - |   284 | `	/* Query result */` |
|    824 |   285 | `	ph7_result_bool(pCtx,res);` |
|    824 |   286 | `	return PH7_OK;` |
|      4 |   287 | `}` |
|      - |   288 | `/*` |
...
|      - |   295 | ` */` |
|   1598 |   296 | `static int PH7_builtin_is_object(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   297 | `{` |
|   1603 |   298 | `	int res = 0; /* Assume false by default */` |
|   1603 |   299 | `	if( nArg > 0 ){` |
|   1603 |   300 | `		res = ph7_value_is_object(apArg[0]);` |
|    799 |   301 | `	}` |
|      - |   302 | `	/* Query result */` |
|   1603 |   303 | `	ph7_result_bool(pCtx,res);` |
|   1603 |   304 | `	return PH7_OK;` |
|      5 |   305 | `}` |
|      - |   306 | `/*` |
...
|      - |   419 | ` */` |
|  40422 |   420 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   421 | `{` |
|  40427 |   422 | `	int res = 1; /* Assume empty by default */` |
|  40427 |   423 | `	if( nArg > 0 ){` |
|  40425 |   424 | `		res = ph7_value_is_empty(apArg[0]);` |
|  20210 |   425 | `	}` |
|  40427 |   426 | `	ph7_result_bool(pCtx,res);` |
|  40427 |   427 | `	return PH7_OK;` |
|      - |   428 |  |
|      5 |   429 | `}` |
...
|      - |   469 | ` */` |
| 279870 |   470 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |   471 | `{` |
|      - |   472 | `	const char *zSource;` |
|      - |   473 | `	int nSrcLen;` |
|      - |   474 | `	sxi64 iStart,iEnd;` |
| 279875 |   475 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
| 279875 |   476 | `	if( nArg < 2 ){` |
...
| 279875 |   482 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
|      - |   483 | `	/* Extract the offset */` |
|      - |   484 | `	{` |
| 279875 |   485 | `		sxi64 iTmp = 0;` |
| 279875 |   486 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[1],"substr",2,"$offset","int",&iTmp);` |
| 279875 |   487 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |   488 | `			return rcArg;` |
|      - |   489 | `		}` |
| 279875 |   490 | `		iStart = iTmp;` |
|      - |   491 | `	}` |
|      - |   492 | `	/*` |
...
|      - |   501 | `	 */` |
| 279875 |   502 | `	if( iStart < 0 ){` |
|  33577 |   503 | `		iStart += nSrcLen;` |
|  33577 |   504 | `		if( iStart < 0 ){` |
|      5 |   505 | `			iStart = 0;` |
|      7 |   506 | `		}` |
| 263089 |   507 | `	}else if( iStart > nSrcLen ){` |
|      7 |   508 | `		iStart = nSrcLen;` |
|      3 |   509 | `	}` |
| 279875 |   510 | `	iEnd = nSrcLen;` |
| 279875 |   511 | `	if( nArg > 2 && !ph7_value_is_null(apArg[2]) ){` |
| 200601 |   512 | `		sxi64 iLen = 0;` |
| 200601 |   513 | `		sxi32 rcArg = PH7_IntArgResolve(pCtx,apArg[2],"substr",3,"$length","?int",&iLen);` |
| 200601 |   514 | `		if( rcArg != PH7_OK ){` |
|    ! 0 |   515 | `			return rcArg;` |
|      - |   516 | `		}` |
| 200601 |   517 | `		if( iLen < 0 ){` |
|  33209 |   518 | `			iEnd = (sxi64)nSrcLen + iLen;` |
| 183999 |   519 | `		}else if( iLen > (sxi64)nSrcLen - iStart ){` |
|  18855 |   520 | `			iEnd = nSrcLen;` |
|   9430 |   521 | `		}else{` |
| 148547 |   522 | `			iEnd = iStart + iLen;` |
|      - |   523 | `		}` |
| 100298 |   524 | `	}` |
| 279875 |   525 | `	if( iEnd < iStart ){` |
|      3 |   526 | `		iEnd = iStart;` |
|      1 |   527 | `	}` |
| 279875 |   528 | `	ph7_result_string(pCtx,&zSource[iStart],(int)(iEnd - iStart));` |
| 279875 |   529 | `	return PH7_OK;` |
| 140015 |   530 | `}` |
|      - |   531 | `/*` |
...
|      - |   724 | ` */` |
| 423154 |   725 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |   726 | `{` |
| 423159 |   727 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |  1588 | ` */` |
|    252 |  1589 | `static void PH7_BuildCharMask(ph7_context *pCtx,const char *zList,int nLen,char aMask[256])` |
|      5 |  1590 | `{` |
|    257 |  1591 | `	const unsigned char *zIn  = (const unsigned char *)zList;` |
|    257 |  1592 | `	const unsigned char *zEnd = zIn + (nLen > 0 ? nLen : 0);` |
|    257 |  1593 | `	SyZero(aMask,256);` |
|    701 |  1594 | `	for( ; zIn < zEnd ; zIn++ ){` |
|    449 |  1595 | `		int c = zIn[0];` |
|    449 |  1596 | `		if( zIn + 3 < zEnd && zIn[1] == '.' && zIn[2] == '.' && zIn[3] >= c ){` |
...
|    448 |  1603 | `		}else if( zIn + 1 < zEnd && zIn[0] == '.' && zIn[1] == '.' ){` |
...
|      - |  2024 | ` */` |
|  91516 |  2025 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  2026 | `{` |
|  91521 |  2027 | `	int iLen = 0;` |
|  91521 |  2028 | `	if( nArg > 0 ){` |
|  91521 |  2029 | `		StrNullArgNotice(pCtx,apArg[0],"strlen",1,"$string");` |
|  91521 |  2030 | `		ph7_value_to_string(apArg[0],&iLen);` |
|  45908 |  2031 | `	}` |
|      - |  2032 | `	/* String length */` |
|  91521 |  2033 | `	ph7_result_int(pCtx,iLen);` |
|  91521 |  2034 | `	return PH7_OK;` |
|      5 |  2035 | `}` |
|      - |  2036 | `/*` |
...
|     63 |  2084 | `		if( !db ){ return 1; }` |
|     51 |  2085 | `		if( **pa < **pb ){ if( !bias ){ bias = -1; } }` |
|     37 |  2086 | `		else if( **pa > **pb ){ if( !bias ){ bias = 1; } }` |
|     51 |  2087 | `		(*pa)++;` |
|     51 |  2088 | `		(*pb)++;` |
|      1 |  2089 | `	}` |
|     22 |  2090 | `}` |
...
|      - |  2164 | ` */` |
|    380 |  2165 | `static int PH7_builtin_strncmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  2166 | `{` |
...
|    382 |  2175 | `	n  = ph7_value_to_int(apArg[2]);` |
|    382 |  2176 | `	if( n < 0 ){` |
...
|    380 |  2183 | `	z1 = ph7_value_to_string(apArg[0],0);` |
|    380 |  2184 | `	z2 = ph7_value_to_string(apArg[1],0);` |
|    380 |  2185 | `	res = SyStrncmp(z1,z2,(sxu32)n);` |
|      - |  2186 | `	/* Comparison result */` |
|    380 |  2187 | `	ph7_result_int(pCtx,res);` |
|    380 |  2188 | `	return PH7_OK;` |
|    192 |  2189 | `}` |
|      - |  2190 | `/*` |
...
|      - |  2228 | ` */` |
|     50 |  2229 | `static int PH7_builtin_strncasecmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  2230 | `{` |
...
|     55 |  2239 | `	n  = ph7_value_to_int(apArg[2]);` |
|     55 |  2240 | `	if( n < 0 ){` |
...
|     53 |  2247 | `	z1 = ph7_value_to_string(apArg[0],0);` |
|     53 |  2248 | `	z2 = ph7_value_to_string(apArg[1],0);` |
|     53 |  2249 | `	res = SyStrnicmp(z1,z2,(sxu32)n);` |
|      - |  2250 | `	/* Comparison result */` |
|     53 |  2251 | `	ph7_result_int(pCtx,res);` |
|     53 |  2252 | `	return PH7_OK;` |
|     30 |  2253 | `}` |
|      - |  2254 | `/*` |
...
|      - |  2272 | ` */` |
| 158030 |  2273 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 |  2274 | `{` |
|  79015 |  2275 | `	SXUNUSED(pKey);` |
| 158035 |  2276 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - |  2277 | `	const char *zData;` |
|      - |  2278 | `	int nLen;` |
| 158035 |  2279 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 158033 |  2303 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - |  2304 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 158033 |  2305 | `	if( pData->bFirst ){` |
|  33827 |  2306 | `		pData->bFirst = 0;` |
| 141122 |  2307 | `	}else if( pData->nSeplen > 0 ){` |
|      - |  2308 | `		/* append the separator first */` |
| 124131 |  2309 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 158033 |  2315 | `	if( nLen > 0 ){` |
| 145451 |  2316 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 |  2317 | `			pData->rc = SXERR_MEM;` |
|    ! 0 |  2318 | `			return PH7_ABORT;` |
|      - |  2319 | `		}` |
|  72723 |  2320 | `	}` |
| 158033 |  2321 | `	return PH7_OK;` |
|  79020 |  2322 | `}` |
|      - |  2323 | `/*` |
...
|      - |  2335 | ` */` |
|  33850 |  2336 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  2337 | `{` |
|      - |  2338 | `	struct implode_data imp_data;` |
|  33855 |  2339 | `	int i = 1;` |
|  33855 |  2340 | `	if( nArg < 1 ){` |
|      - |  2341 | `		/* Missing argument,return NULL */` |
|    ! 0 |  2342 | `		ph7_result_null(pCtx);` |
|    ! 0 |  2343 | `		return PH7_OK;` |
|      - |  2344 | `	}` |
|      - |  2345 | `	/* Prepare the implode context */` |
|  33855 |  2346 | `	imp_data.pCtx = pCtx;` |
|  33855 |  2347 | `	imp_data.bRecursive = 0;` |
|  33855 |  2348 | `	imp_data.bFirst = 1;` |
|  33855 |  2349 | `	imp_data.nRecCount = 0;` |
|  33855 |  2350 | `	imp_data.rc = SXRET_OK;` |
|  33855 |  2351 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33853 |  2352 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  33853 |  2353 | `		if( nArg > 1 && !ph7_value_is_array(apArg[1]) && !ph7_value_is_null(apArg[1]) ){` |
...
|      3 |  2364 | `		i = 0;` |
|      - |  2365 | `	}` |
|  33853 |  2366 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 |  2367 | `		return PH7_ContextMemoryError(pCtx);` |
|      - |  2368 | `	}` |
|      - |  2369 | `	/* Start the 'join' process */` |
|  67701 |  2370 | `	while( i < nArg ){` |
|  33853 |  2371 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - |  2372 | `			/* Iterate throw array entries */` |
|  33853 |  2373 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - |  2374 | `			/* Surface a callback allocation failure as a fatal */` |
|  33853 |  2375 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - |  2500 | ` */` |
|   6960 |  2501 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  2502 | `{` |
...
|   6965 |  2515 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6965 |  2516 | `	if( nDelim < 1 ){` |
...
|   6961 |  2522 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6961 |  2523 | `	if( nStrlen < 1 ){` |
...
|   6949 |  2549 | `	zEnd = &zString[nStrlen];` |
|      - |  2550 | `	/* Create the array */` |
|   6949 |  2551 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6949 |  2552 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6949 |  2553 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - |  2554 | `		/* Out of memory,return FALSE */` |
|    ! 0 |  2555 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  2556 | `		return PH7_OK;` |
|      - |  2557 | `	}` |
|      - |  2558 | `	/* Set a defualt limit */` |
|   6949 |  2559 | `	iLimit = SXI32_HIGH;` |
|   6949 |  2560 | `	if( nArg > 2 ){` |
|     55 |  2561 | `		iLimit = ph7_value_to_int(apArg[2]);` |
|     55 |  2562 | `		if( iLimit < 0 ){` |
...
|  83910 |  2595 | `	for(;;){` |
| 167825 |  2596 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 167825 |  2597 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - |  2598 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6933 |  2599 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6933 |  2600 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 |  2601 | `				return PH7_ContextMemoryError(pCtx);` |
|      - |  2602 | `			}` |
|   6933 |  2603 | `			break;` |
|      - |  2604 | `		}` |
|      - |  2605 | `		/* Point to the desired offset */` |
| 160897 |  2606 | `		zCur = &zString[nOfft];` |
|      - |  2607 | `		/* Perform the store operation (may be empty) */` |
| 160897 |  2608 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 160897 |  2609 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 |  2610 | `			return PH7_ContextMemoryError(pCtx);` |
|      - |  2611 | `		}` |
|      - |  2612 | `		/* Point beyond the delimiter */` |
| 160897 |  2613 | `		zString = &zCur[nDelim];` |
|      - |  2614 | `		/* Reset the cursor */` |
| 160897 |  2615 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 |  2616 | `	}` |
|      - |  2617 | `	/* Return the freshly created array */` |
|   6933 |  2618 | `	ph7_result_value(pCtx,pArray);` |
|      - |  2619 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - |  2620 | `	 * released as soon we return from this foregin function.` |
|      - |  2621 | `	 */` |
|   6933 |  2622 | `	return PH7_OK;` |
|   3485 |  2623 | `}` |
|      - |  2624 | `/*` |
...
|      - |  2638 | ` */` |
|  14576 |  2639 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  2640 | `{` |
|  14581 |  2641 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - |  2642 | `	const char *zString;` |
|      - |  2643 | `	int nLen;` |
|  14581 |  2644 | `	if( nArg < 1 ){` |
|      - |  2645 | `		/* Missing arguments,return null */` |
|    ! 0 |  2646 | `		ph7_result_null(pCtx);` |
|    ! 0 |  2647 | `		return PH7_OK;` |
|      - |  2648 | `	}` |
|      - |  2649 | `	/* Extract the target string */` |
|  14581 |  2650 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14581 |  2651 | `	if( nLen < 1 ){` |
|      - |  2652 | `		/* Empty string,return */` |
|    675 |  2653 | `		ph7_result_string(pCtx,"",0);` |
|    675 |  2654 | `		return PH7_OK;` |
|      - |  2655 | `	}` |
|      - |  2656 | `	/* Start the trim process */` |
|  13911 |  2657 | `	if( nArg < 2 ){` |
|      - |  2658 | `		SyString sStr;` |
|      - |  2659 | `		/* Remove white spaces and NUL bytes */` |
|  13881 |  2660 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  34879 |  2661 | `		SyStringFullTrimSafe(&sStr);` |
|  13881 |  2662 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6943 |  2663 | `	}else{` |
|      - |  2664 | `		/* Char list */` |
...
|      - |  2708 | ` */` |
|    174 |  2709 | `static int PH7_builtin_rtrim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |  2710 | `{` |
|    178 |  2711 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"rtrim",1,"$string"); }` |
...
|    178 |  2720 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|    178 |  2721 | `	if( nLen < 1 ){` |
...
|      - |  2736 | `		int nListlen;` |
|    154 |  2737 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|    154 |  2738 | `		if( nListlen < 1 ){` |
|      - |  2739 | `			/* Return the string unchanged */` |
|    ! 0 |  2740 | `			ph7_result_string(pCtx,zString,nLen);` |
|    ! 0 |  2741 | `		}else{` |
|      - |  2742 | `			char aMask[256];` |
|    154 |  2743 | `			const char *zEnd = &zString[nLen];` |
|    154 |  2744 | `			const char *zCur = zString;` |
|    154 |  2745 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - |  2746 | `			/* Right trim */` |
|    172 |  2747 | `			while( zEnd > zCur && aMask[(unsigned char)zEnd[-1]] ){` |
|     21 |  2748 | `				zEnd--;` |
|      3 |  2749 | `			}` |
|    154 |  2750 | `			if( zEnd <= zCur ){` |
|      - |  2751 | `				/* Return the empty string */` |
|    ! 0 |  2752 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 |  2753 | `			}else{` |
|    154 |  2754 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - |  2755 | `			}` |
|      - |  2756 | `		}` |
|      - |  2757 | `	}` |
|    172 |  2758 | `	return PH7_OK;` |
|     91 |  2759 | `}` |
|      - |  2760 | `/*` |
...
|      - |  2774 | ` */` |
|     52 |  2775 | `static int PH7_builtin_ltrim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  2776 | `{` |
|     57 |  2777 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"ltrim",1,"$string"); }` |
...
|     57 |  2786 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     57 |  2787 | `	if( nLen < 1 ){` |
...
|      - |  2802 | `		int nListlen;` |
|     35 |  2803 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|     35 |  2804 | `		if( nListlen < 1 ){` |
|      - |  2805 | `			/* Return the string unchanged */` |
|      3 |  2806 | `			ph7_result_string(pCtx,zString,nLen);` |
|      2 |  2807 | `		}else{` |
|      - |  2808 | `			char aMask[256];` |
|     33 |  2809 | `			const char *zEnd = &zString[nLen];` |
|     33 |  2810 | `			const char *zCur = zString;` |
|     33 |  2811 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - |  2812 | `			/* Left trim */` |
|     87 |  2813 | `			while( zCur < zEnd && aMask[(unsigned char)zCur[0]] ){` |
|     59 |  2814 | `				zCur++;` |
|      5 |  2815 | `			}` |
|     33 |  2816 | `			if( zCur >= zEnd ){` |
|      - |  2817 | `				/* Return the empty string */` |
|    ! 0 |  2818 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 |  2819 | `			}else{` |
|     33 |  2820 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - |  2821 | `			}` |
|      - |  2822 | `		}` |
|      - |  2823 | `	}` |
|     39 |  2824 | `	return PH7_OK;` |
|     31 |  2825 | `}` |
|      - |  2826 | `/*` |
...
|      - |  2834 | ` */` |
|  33734 |  2835 | `static int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  2836 | `{` |
|  33739 |  2837 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - |  2838 | `	const char *zString,*zCur,*zEnd;` |
|      - |  2839 | `	int nLen;` |
|  33739 |  2840 | `	if( nArg < 1 ){` |
|      - |  2841 | `		/* Missing arguments,return null */` |
|    ! 0 |  2842 | `		ph7_result_null(pCtx);` |
|    ! 0 |  2843 | `		return PH7_OK;` |
|      - |  2844 | `	}` |
|      - |  2845 | `	/* Extract the target string */` |
|  33739 |  2846 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33739 |  2847 | `	if( nLen < 1 ){` |
|      - |  2848 | `		/* Empty string,return */` |
|      5 |  2849 | `		ph7_result_string(pCtx,"",0);` |
|      5 |  2850 | `		return PH7_OK;` |
|      - |  2851 | `	}` |
|      - |  2852 | `	/* Perform the requested operation */` |
|  33735 |  2853 | `	zEnd = &zString[nLen];` |
| 106336 |  2854 | `	for(;;){` |
| 212677 |  2855 | `		if( zString >= zEnd ){` |
|      - |  2856 | `			/* No more input,break immediately */` |
|  33735 |  2857 | `			break;` |
|      - |  2858 | `		}` |
| 178947 |  2859 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 |  2868 | `		}else{` |
| 178947 |  2869 | `			int c = zString[0];` |
| 178947 |  2870 | `			if( SyisUpper(c) ){` |
| 175935 |  2871 | `				c = SyToLower(zString[0]);` |
|  87965 |  2872 | `			}` |
|      - |  2873 | `			/* Append character */` |
| 178947 |  2874 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - |  2875 | `			/* Advance the cursor */` |
| 178947 |  2876 | `			zString++;` |
|      - |  2877 | `		}` |
|      5 |  2878 | `	}` |
|  33735 |  2879 | `	return PH7_OK;` |
|  16872 |  2880 | `}` |
|      - |  2881 | `/*` |
...
|      - |  3082 | ` */` |
|   7150 |  3083 | `static int PH7_builtin_chr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 |  3084 | `{` |
|      - |  3085 | `	int c;` |
...
|   7152 |  3099 | `	if( ph7_value_is_float(apArg[0]) ){` |
|      - |  3100 | `		char zBuf[120];` |
...
|   7152 |  3108 | `	c = ph7_value_to_int(apArg[0]);` |
...
|   7152 |  3123 | `	ch = (unsigned char)(c & 0xFF);` |
|      - |  3124 | `	/* Return the specified character */` |
|   7152 |  3125 | `	ph7_result_string(pCtx,(const char *)&ch,(int)sizeof(char));` |
|   7152 |  3126 | `	return PH7_OK;` |
|   3579 |  3127 | `}` |
|      - |  3128 | `/*` |
...
|   3172 |  3136 | `	ph7_result_string((ph7_context *)pUserData,(const char *)pData,(int)nLen);` |
|   3172 |  3137 | `	return SXRET_OK;` |
|      2 |  3138 | `}` |
|      - |  3139 |  |
|      - |  3140 | `/*` |
...
|      - |  3164 | `	 */` |
|    227 |  3165 | `	if( ph7_value_is_array(apArg[0]) \|\| ph7_value_is_resource(apArg[0]) \|\|` |
...
|    152 |  3186 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|    152 |  3187 | `	if( nLen < 1 ){` |
...
|    140 |  3193 | `	SyBinToHexConsumer((const void *)zString,(sxu32)nLen,HashConsumer,pCtx);` |
|    140 |  3194 | `	return PH7_OK;` |
|     79 |  3195 | `}` |
|      - |  3196 |  |
...
|      - |  3368 | ` */` |
|   1578 |  3369 | `static int PH7_builtin_strpos(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  3370 | `{` |
|   1583 |  3371 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strpos",1,"$haystack"); }` |
|   1583 |  3372 | `	if( nArg > 1 ){ StrNullArgNotice(pCtx,apArg[1],"strpos",2,"$needle"); }` |
|   1583 |  3373 | `	ProcStringMatch xPatternMatch = SyBlobSearch; /* Case-sensitive pattern match */` |
...
|   1583 |  3384 | `	zBlob = ph7_value_to_string(apArg[0],&nLen);` |
|   1583 |  3385 | `	zPattern = ph7_value_to_string(apArg[1],&nPatLen);` |
|   1583 |  3386 | `	nOfft = 0; /* cc warning */` |
|   1583 |  3387 | `	nStart = 0;` |
...
|      - |  3400 | `		}` |
|      7 |  3401 | `	}` |
|   1583 |  3402 | `	if( nLen > 0 && nPatLen > 0 ){` |
|      - |  3403 | `		/* Perform the lookup */` |
|   1579 |  3404 | `		rc = xPatternMatch(zBlob,(sxu32)nLen,zPattern,(sxu32)nPatLen,&nOfft);` |
|   1579 |  3405 | `		if( rc != SXRET_OK ){` |
|      - |  3406 | `			/* Pattern not found,return FALSE */` |
|    805 |  3407 | `			ph7_result_bool(pCtx,0);` |
|    805 |  3408 | `			return PH7_OK;` |
|      - |  3409 | `		}` |
|      - |  3410 | `		/* Return the pattern position */` |
|    779 |  3411 | `		ph7_result_int64(pCtx,(ph7_int64)(nOfft+nStart));` |
|    392 |  3412 | `	}else{` |
|      5 |  3413 | `		ph7_result_bool(pCtx,0);` |
|      - |  3414 | `	}` |
|    783 |  3415 | `	return PH7_OK;` |
|    794 |  3416 | `}` |
|      - |  3417 | `/*` |
...
|      - |  4250 | ` * "all valid".)` |
|      - |  4251 | ` */` |
|    502 |  4252 | `static int FormatUnknownSpec(const char *zIn,int nByte,int *pBad)` |
|      3 |  4253 | `{` |
|    505 |  4254 | `	const char *zEnd = &zIn[nByte];` |
|      - |  4255 | `	int c,idx;` |
|   3981 |  4256 | `	while( zIn < zEnd ){` |
|   3499 |  4257 | `		if( zIn[0] != '%' ){` |
|   2525 |  4258 | `			zIn++;` |
|   2525 |  4259 | `			continue;` |
|      - |  4260 | `		}` |
|    975 |  4261 | `		zIn++; /* jump the percent sign */` |
...
|   1215 |  4265 | `		while( zIn < zEnd ){` |
|   1213 |  4266 | `			c = zIn[0];` |
|   1213 |  4267 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){` |
|    229 |  4268 | `				zIn++;` |
|    229 |  4269 | `				continue;` |
|      - |  4270 | `			}` |
|    985 |  4271 | `			if( c=='\'' ){` |
...
|    ! 0 |  4279 | `		}` |
|      - |  4280 | `		/* field width */` |
|   1289 |  4281 | `		while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|    315 |  4282 | `			zIn++;` |
|      1 |  4283 | `		}` |
...
|    975 |  4315 | `		if( zIn < zEnd && zIn[0]=='l' ){` |
|     11 |  4316 | `			zIn++;` |
|      5 |  4317 | `		}` |
|    975 |  4318 | `		if( zIn >= zEnd ){` |
|      - |  4319 | `			/* A dangling '%' with no specifier: PHL's legacy path silently` |
|      - |  4320 | `			 * truncates here (recorded residual); nothing to validate. */` |
|      3 |  4321 | `			break;` |
|      - |  4322 | `		}` |
|    973 |  4323 | `		c = zIn[0];` |
|    973 |  4324 | `		zIn++; /* jump the conversion specifier */` |
|   3821 |  4325 | `		for( idx = 0 ; idx < (int)SX_ARRAYSIZE(aFmt) ; idx++ ){` |
|   3803 |  4326 | `			if( c == aFmt[idx].fmttype ){` |
|    955 |  4327 | `				break;` |
|      - |  4328 | `			}` |
|   1427 |  4329 | `		}` |
|    973 |  4330 | `		if( idx >= (int)SX_ARRAYSIZE(aFmt) ){` |
|     19 |  4331 | `			*pBad = c; /* unknown specifier */` |
|     19 |  4332 | `			return TRUE;` |
|      - |  4333 | `		}` |
|      3 |  4334 | `	}` |
|    487 |  4335 | `	return FALSE;` |
|    254 |  4336 | `}` |
|      - |  4337 | `/*` |
...
|      - |  4344 | ` */` |
|    502 |  4345 | `PH7_PRIVATE sxi32 PH7_FormatValidate(ph7_context *pCtx,const char *zFormat,int nByte)` |
|      3 |  4346 | `{` |
|    505 |  4347 | `	int badSpec = 0;` |
|    505 |  4348 | `	if( FormatUnknownSpec(zFormat,nByte,&badSpec) ){` |
|     28 |  4349 | `		return PH7_VmThrowException(pCtx,"ValueError",` |
|      9 |  4350 | `			"Unknown format specifier \"%c\"",badSpec);` |
|      - |  4351 | `	}` |
|    487 |  4352 | `	return PH7_OK;` |
|    254 |  4353 | `}` |
|      - |  4354 | `/*` |
...
|      - |  4358 | ` */` |
|    484 |  4359 | `static int FormatRequiredArgs(const char *zIn,int nByte)` |
|      3 |  4360 | `{` |
|    487 |  4361 | `	const char *zEnd = &zIn[nByte];` |
|    487 |  4362 | `	int c,seq = 0,maxpos = 0;` |
|   3949 |  4363 | `	while( zIn < zEnd ){` |
|   3467 |  4364 | `		int numVal = 0,pos = 0;` |
|   3467 |  4365 | `		if( zIn[0] != '%' ){` |
|   2511 |  4366 | `			zIn++;` |
|   2511 |  4367 | `			continue;` |
|      - |  4368 | `		}` |
|    957 |  4369 | `		zIn++; /* jump the percent sign */` |
|      - |  4370 | `		/* leading flags (incl. the "'<pad>'" custom-pad form) */` |
|   1197 |  4371 | `		while( zIn < zEnd ){` |
|   1195 |  4372 | `			c = zIn[0];` |
|   1195 |  4373 | `			if( c=='-' \|\| c=='+' \|\| c==' ' \|\| c=='0' ){ zIn++; continue; }` |
|    967 |  4374 | `			if( c=='\'' ){ zIn++; if( zIn < zEnd ){ zIn++; } continue; }` |
|    955 |  4375 | `			break;` |
|    ! 0 |  4376 | `		}` |
|      - |  4377 | `		/* leading number: a positional index when a '$' follows, else the width */` |
|   1271 |  4378 | `		while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){` |
|    315 |  4379 | `			numVal = numVal*10 + (zIn[0]-'0');` |
|    315 |  4380 | `			zIn++;` |
|      1 |  4381 | `		}` |
|    957 |  4382 | `		if( zIn < zEnd && zIn[0]=='$' ){` |
|     15 |  4383 | `			pos = numVal;` |
|     15 |  4384 | `			zIn++;` |
...
|      7 |  4393 | `		}` |
|      - |  4394 | `		/* precision */` |
|    957 |  4395 | `		if( zIn < zEnd && zIn[0]=='.' ){` |
|    113 |  4396 | `			zIn++;` |
|    243 |  4397 | `			while( zIn < zEnd && zIn[0]>='0' && zIn[0]<='9' ){ zIn++; }` |
|     55 |  4398 | `		}` |
|      - |  4399 | `		/* a single 'l' length modifier (ignored, php compat) */` |
|    957 |  4400 | `		if( zIn < zEnd && zIn[0]=='l' ){ zIn++; }` |
|    957 |  4401 | `		if( zIn >= zEnd ){ break; }` |
|    955 |  4402 | `		c = zIn[0];` |
|    955 |  4403 | `		zIn++; /* jump the conversion specifier */` |
|    955 |  4404 | `		if( c == '%' ){ continue; } /* %% consumes no argument */` |
|    947 |  4405 | `		if( pos > 0 ){` |
...
|      - |  4409 | `		}` |
|      3 |  4410 | `	}` |
|    487 |  4411 | `	return seq > maxpos ? seq : maxpos;` |
|      3 |  4412 | `}` |
|      - |  4413 | `/*` |
...
|      - |  4423 | ` * when enough.` |
|      - |  4424 | ` */` |
|    484 |  4425 | `PH7_PRIVATE sxi32 PH7_FormatCheckArgCount(ph7_context *pCtx,const char *zFormat,int nByte,int nValues,int nFixed,int bVararg)` |
|      3 |  4426 | `{` |
|    487 |  4427 | `	int required = FormatRequiredArgs(zFormat,nByte);` |
|    487 |  4428 | `	if( nValues < required ){` |
|     21 |  4429 | `		if( bVararg ){` |
...
|     13 |  4459 | `}` |
|    514 |  4460 | `PH7_PRIVATE sxi32 PH7_FormatCheckFormatArg(ph7_context *pCtx,ph7_value *pArg,int iArg)` |
|      3 |  4461 | `{` |
|    517 |  4462 | `	if( ph7_value_is_array(pArg) \|\| ph7_value_is_object(pArg) \|\| ph7_value_is_resource(pArg) ){` |
|      - |  4463 | `		char zBuf[64];` |
...
|      - |  4483 | ` */` |
|    464 |  4484 | `PH7_PRIVATE sxi32 PH7_InputFormat(` |
...
|      - |  4493 | `	)` |
|      3 |  4494 | `{` |
|    467 |  4495 | `	char spaces[] = "                                                  ";` |
|      - |  4496 | `#define etSPACESIZE ((int)sizeof(spaces)-1)` |
|    467 |  4497 | `	const char *zCur,*zEnd = &zIn[nByte];` |
...
|    692 |  4521 | `	for(;;){` |
|   1387 |  4522 | `		zCur = zIn;` |
|   3889 |  4523 | `		while( zIn < zEnd && zIn[0] != '%' ){` |
|   2503 |  4524 | `			zIn++;` |
|      1 |  4525 | `		}` |
|   1387 |  4526 | `		if( zCur < zIn ){` |
|      - |  4527 | `			/* Consume chunk verbatim */` |
|    813 |  4528 | `			rc = xConsumer(pCtx,zCur,(int)(zIn-zCur),pUserData);` |
|    813 |  4529 | `			if( rc != SXRET_OK ){` |
|      - |  4530 | `				/* Callback requested an abort (e.g. an allocation failure) */` |
|    ! 0 |  4531 | `				break;` |
|      - |  4532 | `			}` |
|    406 |  4533 | `		}` |
|   1387 |  4534 | `		if( zIn >= zEnd ){` |
|      - |  4535 | `			/* No more input to process,break immediately */` |
|    465 |  4536 | `			break;` |
|      - |  4537 | `		}` |
|      - |  4538 | `		/* Find out what flags are present */` |
|    925 |  4539 | `		flag_leftjustify = flag_plussign = flag_blanksign =` |
|    922 |  4540 | `			flag_alternateform = flag_zeropad = 0;` |
...
|  47025 |  4544 | `		for( idx = 0 ; idx < etSPACESIZE ; ++idx ){ spaces[idx] = ' '; }` |
|    925 |  4545 | `		zIn++; /* Jump the precent sign */` |
|    461 |  4546 | `		do{` |
|   1165 |  4547 | `			c = zIn[0];` |
|   1165 |  4548 | `			switch( c ){` |
...
|      6 |  4562 | `				}` |
|     12 |  4563 | `				break;` |
|    922 |  4564 | `			default:                                       break;` |
|      - |  4565 | `			}` |
|   1165 |  4566 | `		}while( c==0 && (zIn++ < zEnd) );` |
|      - |  4567 | `		/* Get the field width */` |
|    925 |  4568 | `		width = 0;` |
|   1694 |  4569 | `		while( zIn < zEnd && ( zIn[0] >='0' && zIn[0] <='9') ){` |
|    309 |  4570 | `			width = width*10 + (zIn[0] - '0');` |
|    309 |  4571 | `			zIn++;` |
|      1 |  4572 | `		}` |
|    925 |  4573 | `		if( zIn < zEnd && zIn[0] == '$' ){` |
...
|      1 |  4609 | `			}` |
|      4 |  4610 | `		}` |
|    925 |  4611 | `		if( width > PH7_FMT_BUFSIZ-10 ){` |
|    ! 0 |  4612 | `			width = PH7_FMT_BUFSIZ-10;` |
|    ! 0 |  4613 | `		}` |
|      - |  4614 | `		/* Get the precision */` |
|    925 |  4615 | `		precision = -1;` |
|    925 |  4616 | `		if( zIn < zEnd && zIn[0] == '.' ){` |
...
|    925 |  4627 | `		if( zIn < zEnd && zIn[0] == 'l' ){` |
|      9 |  4628 | `			zIn++;` |
|      4 |  4629 | `		}` |
|    925 |  4630 | `		if( zIn >= zEnd ){` |
|      - |  4631 | `			/* No more input */` |
|      3 |  4632 | `			break;` |
|      - |  4633 | `		}` |
|      - |  4634 | `		/* Fetch the info entry for the field */` |
|    923 |  4635 | `		pInfo = 0;` |
|    923 |  4636 | `		xtype = PH7_FMT_ERROR;` |
|    923 |  4637 | `		c = zIn[0];` |
|    923 |  4638 | `		zIn++; /* Jump the format specifer */` |
|   3451 |  4639 | `		for(idx=0; idx< (int)SX_ARRAYSIZE(aFmt); idx++){` |
|   3451 |  4640 | `			if( c==aFmt[idx].fmttype ){` |
|    923 |  4641 | `				pInfo = &aFmt[idx];` |
|    923 |  4642 | `				xtype = pInfo->type;` |
|    923 |  4643 | `				break;` |
|      - |  4644 | `			}` |
|   1267 |  4645 | `		}` |
|    923 |  4646 | `		zBuf = zWorker; /* Point to the working buffer */` |
|    923 |  4647 | `		length = 0;` |
...
|      5 |  4683 | `			break;` |
|    190 |  4684 | `		case PH7_FMT_STRING:` |
|      - |  4685 | `			/* the argument is treated as and presented as a string */` |
|    381 |  4686 | `			pArg = NEXT_ARG;` |
|    381 |  4687 | `			if( pArg == 0 ){` |
|    ! 0 |  4688 | `				length = 0;` |
|    ! 0 |  4689 | `			}else{` |
|    381 |  4690 | `				zBuf = (char *)ph7_value_to_string(pArg,&length);` |
|      - |  4691 | `			}` |
|    381 |  4692 | `			if( length < 1 ){` |
...
|      9 |  4697 | `				length = 0;` |
|      4 |  4698 | `			}` |
|    381 |  4699 | `			if( precision>=0 && precision<length ){` |
|      3 |  4700 | `				length = precision;` |
|      1 |  4701 | `			}` |
|    381 |  4702 | `			if( flag_zeropad ){` |
...
|      - |  4728 | `#endif` |
|    329 |  4729 | `        if( pInfo->flags & PH7_FMT_FLAG_SIGNED ){` |
|    305 |  4730 | `          if( iVal<0 ){` |
|     25 |  4731 | `            iVal = -iVal;` |
...
|    ! 0 |  4736 | `			}` |
|     25 |  4737 | `            prefix = '-';` |
|    293 |  4738 | `          }else if( flag_plussign )  prefix = '+';` |
|    279 |  4739 | `          else if( flag_blanksign )  prefix = ' ';` |
|    277 |  4740 | `          else                       prefix = 0;` |
|    153 |  4741 | `        }else{` |
|     25 |  4742 | `			if( iVal<0 ){` |
|    ! 0 |  4743 | `				iVal = -iVal;` |
...
|     25 |  4750 | `			prefix = 0;` |
|      - |  4751 | `		}` |
|    329 |  4752 | `        if( flag_zeropad && precision<width-(prefix!=0) ){` |
|    185 |  4753 | `          precision = width-(prefix!=0);` |
|     92 |  4754 | `        }` |
|    329 |  4755 | `        zBuf = &zWorker[PH7_FMT_BUFSIZ-1];` |
|      - |  4756 | `        {` |
|      - |  4757 | `          register char *cset;      /* Use registers for speed */` |
|      - |  4758 | `          register int base;` |
|    329 |  4759 | `          cset = pInfo->charset;` |
|    329 |  4760 | `          base = pInfo->base;` |
|    164 |  4761 | `          do{                                           /* Convert to ascii */` |
|    409 |  4762 | `            *(--zBuf) = cset[iVal%base];` |
|    409 |  4763 | `            iVal = iVal/base;` |
|    409 |  4764 | `          }while( iVal>0 );` |
|      - |  4765 | `        }` |
|    329 |  4766 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
|    531 |  4767 | `        for(idx=precision-length; idx>0; idx--){` |
|    203 |  4768 | `          *(--zBuf) = '0';                             /* Zero pad */` |
|    102 |  4769 | `        }` |
|    329 |  4770 | `        if( prefix ) *(--zBuf) = (char)prefix;               /* Add sign */` |
|    329 |  4771 | `        if( flag_alternateform && pInfo->prefix ){      /* Add "0" or "0x" */` |
|      - |  4772 | `          char *pre, x;` |
...
|    ! 0 |  4776 | `          }` |
|    ! 0 |  4777 | `        }` |
|    329 |  4778 | `		length = (int)(&zWorker[PH7_FMT_BUFSIZ-1]-zBuf);` |
|    329 |  4779 | `		break;` |
...
|      - |  4886 | `		 ** the output.` |
|      - |  4887 | `		 */` |
|    923 |  4888 | `    if( !flag_leftjustify ){` |
|      - |  4889 | `      register int nspace;` |
|    905 |  4890 | `      nspace = width-length;` |
|    905 |  4891 | `      if( nspace>0 ){` |
...
|     18 |  4905 | `      }` |
|    451 |  4906 | `    }` |
|    923 |  4907 | `    if( length>0 ){` |
|    915 |  4908 | `		rc = xConsumer(pCtx,zBuf,(unsigned int)length,pUserData);` |
|    915 |  4909 | `		if( rc != SXRET_OK ){` |
|    ! 0 |  4910 | `		  return SXERR_ABORT; /* Consumer routine request an operation abort */` |
|      - |  4911 | `		}` |
|    456 |  4912 | `    }` |
|    923 |  4913 | `    if( flag_leftjustify ){` |
...
|      - |  5000 | ` */` |
|   1210 |  5001 | `static int printfConsumer(ph7_context *pCtx,const char *zInput,int nLen,void *pUserData)` |
|      1 |  5002 | `{` |
|   1211 |  5003 | `	ph7_int64 *pCounter = (ph7_int64 *)pUserData;` |
|      - |  5004 | `	/* Call the VM output consumer directly */` |
|   1211 |  5005 | `	ph7_context_output(pCtx,zInput,nLen);` |
|      - |  5006 | `	/* Increment counter */` |
|   1211 |  5007 | `	*pCounter += nLen;` |
|   1211 |  5008 | `	return PH7_OK;` |
|      1 |  5009 | `}` |
|      - |  5010 | `/*` |
...
|      - |  5018 | ` */` |
|    210 |  5019 | `static int PH7_builtin_printf(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |  5020 | `{` |
|    211 |  5021 | `	ph7_int64 nCounter = 0;` |
...
|      - |  5030 | `	{` |
|    211 |  5031 | `		sxi32 rcf = PH7_FormatCheckFormatArg(pCtx,apArg[0],1);` |
|    211 |  5032 | `		if( rcf != PH7_OK ){` |
|    ! 0 |  5033 | `			return rcf;` |
|      - |  5034 | `		}` |
|      - |  5035 | `	}` |
|      - |  5036 | `	/* Extract the string format (scalars/null coerce). */` |
|    211 |  5037 | `	zFormat = ph7_value_to_string(apArg[0],&nLen);` |
|    211 |  5038 | `	if( nLen < 1 ){` |
|      - |  5039 | `		/* Empty string */` |
...
|      - |  5045 | `	{` |
|    211 |  5046 | `		sxi32 rcv = PH7_FormatValidate(pCtx,zFormat,nLen);` |
|    211 |  5047 | `		if( rcv != PH7_OK ){` |
|    ! 0 |  5048 | `			return rcv;` |
|      - |  5049 | `		}` |
|      - |  5050 | `		/* PHP 8: too few value arguments is a catchable ArgumentCountError before output. */` |
|    211 |  5051 | `		rcv = PH7_FormatCheckArgCount(pCtx,zFormat,nLen,nArg-1,1,FALSE);` |
|    211 |  5052 | `		if( rcv != PH7_OK ){` |
|      3 |  5053 | `			return rcv;` |
|      - |  5054 | `		}` |
|      - |  5055 | `	}` |
|      - |  5056 | `	/* Format the string */` |
|    209 |  5057 | `	PH7_InputFormat(printfConsumer,pCtx,zFormat,nLen,nArg,apArg,(void *)&nCounter,FALSE);` |
|      - |  5058 | `	/* Return the length of the outputted string */` |
|    209 |  5059 | `	ph7_result_int64(pCtx,nCounter);` |
|    209 |  5060 | `	return PH7_OK;` |
|    106 |  5061 | `}` |
|      - |  5062 | `/*` |
...
|   7121 |  8207 | `	STRDEL(zInput,n,m,nLen);` |
...
|   6911 |  8225 | `		SHIFTRANDINSERT(zInput,n,nOfft,zReplace,iRep);` |
...
|      - |  8234 | ` */` |
|    182 |  8235 | `static int StrReplaceWalker(ph7_value *pKey,ph7_value *pData,void *pUserData)` |
|      5 |  8236 | `{` |
|    187 |  8237 | `	str_replace_data *pRep = (str_replace_data *)pUserData;` |
|      - |  8238 | `	SyString sWorker;` |
|      - |  8239 | `	const char *zIn;` |
|      - |  8240 | `	int nByte;` |
|      - |  8241 | `	/* Extract a string representation of the given argument */` |
|    187 |  8242 | `	zIn = ph7_value_to_string(pData,&nByte);` |
|    187 |  8243 | `	SyStringInitFromBuf(&sWorker,0,0);` |
|    187 |  8244 | `	if( nByte > 0 ){` |
|      - |  8245 | `		char *zDup;` |
|      - |  8246 | `		/* Duplicate the chunk */` |
|    185 |  8247 | `		zDup = (char *)ph7_context_alloc_chunk(pRep->pCtx,(unsigned int)nByte,FALSE,` |
...
|      - |  8255 | `		}` |
|    185 |  8256 | `		SyMemcpy(zIn,zDup,(sxu32)nByte);` |
|      - |  8257 | `		/* Save the chunk */` |
|    185 |  8258 | `		SyStringInitFromBuf(&sWorker,zDup,nByte);` |
|     90 |  8259 | `	}` |
|      - |  8260 | `	/* Save for later processing */` |
|    187 |  8261 | `	SySetPut(pRep->pCollector,(const void *)&sWorker);` |
|      - |  8262 | `	/* All done */` |
|     91 |  8263 | `	SXUNUSED(pKey); /* cc warning */` |
|    187 |  8264 | `	return PH7_OK;` |
|     96 |  8265 | `}` |
|      - |  8266 | `/*` |
...
|      - |  8291 | ` */` |
|  30404 |  8292 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  8293 | `{` |
...
|      - |  8302 | `	int nByte;` |
|      - |  8303 | `	sxi32 rc;` |
|  30409 |  8304 | `	if( nArg < 3 ){` |
|      - |  8305 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 |  8306 | `		ph7_result_null(pCtx);` |
|    ! 0 |  8307 | `		return PH7_OK;` |
|      - |  8308 | `	}` |
|      - |  8309 | `	/* Initialize fields */` |
|  30409 |  8310 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30409 |  8311 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  30409 |  8312 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  30409 |  8313 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  30409 |  8314 | `	sRep.pCtx = pCtx;` |
|  30409 |  8315 | `	sRep.pCollector = &sSearch;` |
|  30409 |  8316 | `	rep_str = 0;` |
|      - |  8317 | `	/* Extract the subject */` |
|  30409 |  8318 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  30409 |  8319 | `	if( nByte < 1 ){` |
...
|  30389 |  8325 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - |  8326 | `	/* Search string */` |
|  30389 |  8327 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - |  8328 | `		/* Collect search string */` |
|     91 |  8329 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     48 |  8330 | `	}else{` |
|      - |  8331 | `		/* Single pattern */` |
|  30303 |  8332 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  30303 |  8333 | `		if( nByte < 1 ){` |
...
|      - |  8337 | `		}` |
|  30299 |  8338 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - |  8339 | `		/* Save for later processing */` |
|  30299 |  8340 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - |  8341 | `	}` |
|      - |  8342 | `	/* Replace string */` |
|  30385 |  8343 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - |  8344 | `		/* Collect replace string */` |
|      7 |  8345 | `		sRep.pCollector = &sReplace;` |
|      7 |  8346 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 |  8347 | `	}else{` |
|      - |  8348 | `		/* Single needle */` |
|  30379 |  8349 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  30379 |  8350 | `		rep_str = 1;` |
|  30379 |  8351 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - |  8352 | `		/* Save for later processing */` |
|  30379 |  8353 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - |  8354 | `	}` |
|      - |  8355 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  30385 |  8356 | `	if( sRep.rc != SXRET_OK ){` |
...
|  30385 |  8363 | `	SySetResetCursor(&sSearch);` |
|  30385 |  8364 | `	SySetResetCursor(&sReplace);` |
|  30385 |  8365 | `	pReplace = pSearch = 0; /* cc warning */` |
|  30385 |  8366 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - |  8367 | `	/* Extract function name */` |
|  30385 |  8368 | `	zFunc = ph7_function_name(pCtx);` |
|      - |  8369 | `	/* Set the default pattern match routine */` |
|  30385 |  8370 | `	xMatch = SyBlobSearch;` |
|  30385 |  8371 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - |  8372 | `		/* Case insensitive pattern match */` |
|     11 |  8373 | `		xMatch = iPatternMatch;` |
|      5 |  8374 | `	}` |
|      - |  8375 | `	/* Start the replace process */` |
|  60851 |  8376 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - |  8377 | `		sxu32 nCount,nOfft;` |
|  30471 |  8378 | `		if( pSearch->nByte <  1 ){` |
|      - |  8379 | `			/* Empty string,ignore */` |
|      3 |  8380 | `			continue;` |
|      - |  8381 | `		}` |
|      - |  8382 | `		/* Extract the replace string */` |
|  30469 |  8383 | `		if( rep_str ){` |
|  30459 |  8384 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  15232 |  8385 | `		}else{` |
...
|      1 |  8391 | `			}` |
|      - |  8392 | `		}` |
|  30469 |  8393 | `		if( pReplace == 0 ){` |
|      - |  8394 | `			/* Use an empty string instead */` |
|      3 |  8395 | `			pReplace = &sTemp;` |
|      1 |  8396 | `		}` |
|  30469 |  8397 | `		nOfft = nCount = 0;` |
|  15258 |  8398 | `		for(;;){` |
|  30521 |  8399 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 |  8400 | `				break;` |
|      - |  8401 | `			}` |
|      - |  8402 | `			/* Perform a pattern lookup */` |
|  45761 |  8403 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  30504 |  8404 | `				pSearch->nByte,&nOfft);` |
|  30509 |  8405 | `			if( rc != SXRET_OK ){` |
...
|  30385 |  8423 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  30385 |  8424 | `	SySetRelease(&sSearch);` |
|  30385 |  8425 | `	SySetRelease(&sReplace);` |
|  30385 |  8426 | `	SyBlobRelease(&sWorker);` |
|  30385 |  8427 | `	if( rc != PH7_OK ){` |
|    ! 0 |  8428 | `		return PH7_ContextMemoryError(pCtx);` |
|      - |  8429 | `	}` |
|  30385 |  8430 | `	return PH7_OK;` |
|  15207 |  8431 | `}` |
|      - |  8432 | `/*` |
...
|      - |  9018 | ` */` |
|   2206 |  9019 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  9020 | `{` |
...
|   2211 |  9029 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   2211 |  9030 | `	zEnd = &zIn[nLen];` |
|   2211 |  9031 | `	if( nLen < 1 ){` |
...
|   2037 |  9037 | `	for(;;){` |
|   4079 |  9038 | `		if( zIn >= zEnd ){` |
|      - |  9039 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1813 |  9040 | `			ph7_result_bool(pCtx,1);` |
|   1813 |  9041 | `			return PH7_OK;` |
|      - |  9042 | `		}` |
|   2271 |  9043 | `		if( zIn[0] >= 0xc0 ){` |
|      - |  9044 | `			/* UTF-8 stream  */` |
|    ! 0 |  9045 | `			break;` |
|      - |  9046 | `		}` |
|   2271 |  9047 | `		if( !SyisDigit(zIn[0]) ){` |
|    395 |  9048 | `			break;` |
|      - |  9049 | `		}` |
...
|    395 |  9054 | `	ph7_result_bool(pCtx,0);` |
|    395 |  9055 | `	return PH7_OK;` |
|   1108 |  9056 | `}` |
|      - |  9057 | `/*` |
...
|      - |  9260 | ` */` |
|  77482 |  9261 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  9262 | `{` |
|      - |  9263 | `	const unsigned char *zIn,*zEnd;` |
|      - |  9264 | `	int nLen;` |
|  77487 |  9265 | `	if( nArg < 1 ){` |
|      - |  9266 | `		/* Missing arguments,return FALSE */` |
|    ! 0 |  9267 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  9268 | `		return PH7_OK;` |
|      - |  9269 | `	}` |
|      - |  9270 | `	/* Extract the target string */` |
|  77487 |  9271 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  77487 |  9272 | `	zEnd = &zIn[nLen];` |
|  77487 |  9273 | `	if( nLen < 1 ){` |
...
|  39781 |  9279 | `	for(;;){` |
|  79183 |  9280 | `		if( zIn >= zEnd ){` |
|      - |  9281 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1679 |  9282 | `			ph7_result_bool(pCtx,1);` |
|   1679 |  9283 | `			return PH7_OK;` |
|      - |  9284 | `		}` |
|  77509 |  9285 | `		if( zIn[0] >= 0xc0 ){` |
|      - |  9286 | `			/* UTF-8 stream  */` |
|    ! 0 |  9287 | `			break;` |
|      - |  9288 | `		}` |
|  77509 |  9289 | `		if( !SyisSpace(zIn[0]) ){` |
|  75811 |  9290 | `			break;` |
|      - |  9291 | `		}` |
...
|  75811 |  9296 | `	ph7_result_bool(pCtx,0);` |
|  75811 |  9297 | `	return PH7_OK;` |
|  38938 |  9298 | `}` |
|      - |  9299 | `/*` |
...
|      - |  9902 | ` */` |
|   3428 |  9903 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 |  9904 | `{` |
|      - |  9905 | `	sxu32 n;` |
| 709601 |  9906 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 706173 |  9907 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 353089 |  9908 | `	}` |
|      - |  9909 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3433 |  9910 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - |  9911 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3433 |  9912 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3433 |  9913 | `}` |
|      - |  9914 |  |
|      - |  9915 | `/*` |
|      - |  9916 | ` * UTF-8 encode/decode builtins (registered from vm.c).  Relocated here` |
|      - |  9917 | ` * from the removed vm_xml.c when the legacy xml_* API was dropped.` |
|      - |  9918 | ` */` |
|      - |  9919 | `/*` |
|      - |  9920 | ` * int utf8_encode(string $input)` |
|      - |  9921 | ` *  UTF-8 encoding.` |
|      - |  9922 | ` *  This function encodes the string data to UTF-8, and returns the encoded version.` |
|      - |  9923 | ` *  UTF-8 is a standard mechanism used by Unicode for encoding wide character values` |
|      - |  9924 | ` * into a byte stream. UTF-8 is transparent to plain ASCII characters, is self-synchronized` |
|      - |  9925 | ` * (meaning it is possible for a program to figure out where in the bytestream characters start)` |
|      - |  9926 | ` * and can be used with normal string comparison functions for sorting and such.` |
|      - |  9927 | ` *  Notes on UTF-8 (According to SQLite3 authors):` |
|      - |  9928 | ` *  Byte-0    Byte-1    Byte-2    Byte-3    Value` |
|      - |  9929 | ` *  0xxxxxxx                                 00000000 00000000 0xxxxxxx` |
|      - |  9930 | ` *  110yyyyy  10xxxxxx                       00000000 00000yyy yyxxxxxx` |
|      - |  9931 | ` *  1110zzzz  10yyyyyy  10xxxxxx             00000000 zzzzyyyy yyxxxxxx` |
|      - |  9932 | ` *  11110uuu  10uuzzzz  10yyyyyy  10xxxxxx   000uuuuu zzzzyyyy yyxxxxxx` |
|      - |  9933 | ` * Parameters` |
|      - |  9934 | ` * $input` |
|      - |  9935 | ` *   String to encode or NULL on failure.` |
|      - |  9936 | ` * Return` |
|      - |  9937 | ` *  An UTF-8 encoded string.` |
|      - |  9938 | ` */` |
|    ! 0 |  9939 | `PH7_PRIVATE int vm_builtin_utf8_encode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 |  9940 | `{` |
|      - |  9941 | `	const unsigned char *zIn,*zEnd;` |
|      - |  9942 | `	int nByte,c,e;` |
|    ! 0 |  9943 | `	if( nArg < 1 ){` |
|      - |  9944 | `		/* Missing arguments,return null */` |
|    ! 0 |  9945 | `		ph7_result_null(pCtx);` |
|    ! 0 |  9946 | `		return PH7_OK;` |
|      - |  9947 | `	}` |
|      - |  9948 | `	/* Extract the target string */` |
|    ! 0 |  9949 | `	zIn = (const unsigned char *)ph7_value_to_string(apArg[0],&nByte);` |
|    ! 0 |  9950 | `	if( nByte < 1 ){` |
|      - |  9951 | `		/* Empty string,return null */` |
|    ! 0 |  9952 | `		ph7_result_null(pCtx);` |
|    ! 0 |  9953 | `		return PH7_OK;` |
|      - |  9954 | `	}` |
|    ! 0 |  9955 | `	zEnd = &zIn[nByte];` |
|      - |  9956 | `	/* Start the encoding process */` |
|    ! 0 |  9957 | `	for(;;){` |
|    ! 0 |  9958 | `		if( zIn >= zEnd ){` |
|      - |  9959 | `			/* End of input */` |
|    ! 0 |  9960 | `			break;` |
|      - |  9961 | `		}` |
|    ! 0 |  9962 | `		c = zIn[0];` |
|      - |  9963 | `		/* Advance the stream cursor */` |
|    ! 0 |  9964 | `		zIn++;` |
|      - |  9965 | `		/* Encode */` |
|    ! 0 |  9966 | `		if( c<0x00080 ){` |
|    ! 0 |  9967 | `			e = (c&0xFF);` |
|    ! 0 |  9968 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9969 | `		}else if( c<0x00800 ){` |
|    ! 0 |  9970 | `			e = 0xC0 + ((c>>6)&0x1F);` |
|    ! 0 |  9971 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9972 | `			e = 0x80 + (c & 0x3F);` |
|    ! 0 |  9973 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9974 | `		}else if( c<0x10000 ){` |
|    ! 0 |  9975 | `			e = 0xE0 + ((c>>12)&0x0F);` |
|    ! 0 |  9976 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9977 | `			e = 0x80 + ((c>>6) & 0x3F);` |
|    ! 0 |  9978 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9979 | `			e = 0x80 + (c & 0x3F);` |
|    ! 0 |  9980 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9981 | `		}else{` |
|    ! 0 |  9982 | `			e = 0xF0 + ((c>>18) & 0x07);` |
|    ! 0 |  9983 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9984 | `			e = 0x80 + ((c>>12) & 0x3F);` |
|    ! 0 |  9985 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9986 | `			e = 0x80 + ((c>>6) & 0x3F);` |
|    ! 0 |  9987 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|    ! 0 |  9988 | `			e = 0x80 + (c & 0x3F);` |
|    ! 0 |  9989 | `			ph7_result_string(pCtx,(const char *)&e,(int)sizeof(char));` |
|      - |  9990 | `		}` |
|    ! 0 |  9991 | `	}` |
|      - |  9992 | `	/* All done */` |
|    ! 0 |  9993 | `	return PH7_OK;` |
|    ! 0 |  9994 | `}` |
|      - |  9995 | `/* SPDX-SnippetBegin */` |
|      - |  9996 | `/* SPDX-SnippetCopyrightText: D. Richard Hipp and the SQLite authors <https://sqlite.org/> */` |
|      - |  9997 | `/* SPDX-License-Identifier: blessing */` |
|      - |  9998 | `/*` |
|      - |  9999 | ` * UTF-8 decoding routine extracted from the sqlite3 source tree.` |
|      - | 10000 | ` * Original author: D. Richard Hipp (http://www.sqlite.org)` |
|      - | 10001 | ` * Status: Public Domain` |
|      - | 10002 | ` */` |
|      - | 10003 | `/*` |
|      - | 10004 | `** This lookup table is used to help decode the first byte of` |
|      - | 10005 | `** a multi-byte UTF8 character.` |
|      - | 10006 | `*/` |
|      - | 10007 | `static const unsigned char UtfTrans1[] = {` |
|      - | 10008 | `  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,` |
|      - | 10009 | `  0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,` |
|      - | 10010 | `  0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17,` |
|      - | 10011 | `  0x18, 0x19, 0x1a, 0x1b, 0x1c, 0x1d, 0x1e, 0x1f,` |
|      - | 10012 | `  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,` |
|      - | 10013 | `  0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,` |
|      - | 10014 | `  0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,` |
|      - | 10015 | `  0x00, 0x01, 0x02, 0x03, 0x00, 0x01, 0x00, 0x00,` |
|      - | 10016 | `};` |
|      - | 10017 | `/*` |
|      - | 10018 | `** Translate a single UTF-8 character.  Return the unicode value.` |
|      - | 10019 | `**` |
|      - | 10020 | `** During translation, assume that the byte that zTerm points` |
|      - | 10021 | `** is a 0x00.` |
|      - | 10022 | `**` |
|      - | 10023 | `** Write a pointer to the next unread byte back into *pzNext.` |
|      - | 10024 | `**` |
|      - | 10025 | `** Notes On Invalid UTF-8:` |
|      - | 10026 | `**` |
|      - | 10027 | `**  *  This routine never allows a 7-bit character (0x00 through 0x7f) to` |
|      - | 10028 | `**     be encoded as a multi-byte character.  Any multi-byte character that` |
|      - | 10029 | `**     attempts to encode a value between 0x00 and 0x7f is rendered as 0xfffd.` |
|      - | 10030 | `**` |
|      - | 10031 | `**  *  This routine never allows a UTF16 surrogate value to be encoded.` |
|      - | 10032 | `**     If a multi-byte character attempts to encode a value between` |
|      - | 10033 | `**     0xd800 and 0xe000 then it is rendered as 0xfffd.` |
|      - | 10034 | `**` |
|      - | 10035 | `**  *  Bytes in the range of 0x80 through 0xbf which occur as the first` |
|      - | 10036 | `**     byte of a character are interpreted as single-byte characters` |
|      - | 10037 | `**     and rendered as themselves even though they are technically` |
|      - | 10038 | `**     invalid characters.` |
|      - | 10039 | `**` |
|      - | 10040 | `**  *  This routine accepts an infinite number of different UTF8 encodings` |
|      - | 10041 | `**     for unicode values 0x80 and greater.  It do not change over-length` |
|      - | 10042 | `**     encodings to 0xfffd as some systems recommend.` |
|      - | 10043 | `*/` |
|      - | 10044 | `#define READ_UTF8(zIn, zTerm, c)                           \` |
|      - | 10045 | `  c = *(zIn++);                                            \` |
|      - | 10046 | `  if( c>=0xc0 ){                                           \` |
|      - | 10047 | `    c = UtfTrans1[c-0xc0];                                 \` |
|      - | 10048 | `    while( zIn!=zTerm && (*zIn & 0xc0)==0x80 ){            \` |
|      - | 10049 | `      c = (c<<6) + (0x3f & *(zIn++));                      \` |
|      - | 10050 | `    }                                                      \` |
|      - | 10051 | `    if( c<0x80                                             \` |
|      - | 10052 | `        \|\| (c&0xFFFFF800)==0xD800                          \` |
|      - | 10053 | `        \|\| (c&0xFFFFFFFE)==0xFFFE ){  c = 0xFFFD; }        \` |
|      - | 10054 | `  }` |
|    208 | 10055 | `PH7_PRIVATE int PH7_Utf8Read(` |
|      - | 10056 | `  const unsigned char *z,         /* First byte of UTF-8 character */` |
|      - | 10057 | `  const unsigned char *zTerm,     /* Pretend this byte is 0x00 */` |
|      - | 10058 | `  const unsigned char **pzNext    /* Write first byte past UTF-8 char here */` |
|      1 | 10059 | `){` |
|      - | 10060 | `  int c;` |
|    209 | 10061 | `  READ_UTF8(z, zTerm, c);` |
|    209 | 10062 | `  *pzNext = z;` |
|    209 | 10063 | `  return c;` |
|      1 | 10064 | `}` |
|      - | 10065 | `/* SPDX-SnippetEnd */` |
|      - | 10066 | `/*` |
|      - | 10067 | ` * string utf8_decode(string $data)` |
|      - | 10068 | ` *  This function decodes data, assumed to be UTF-8 encoded, to unicode.` |
|      - | 10069 | ` * Parameters` |
|      - | 10070 | ` * data` |
|      - | 10071 | ` *  An UTF-8 encoded string.` |
|      - | 10072 | ` * Return` |
|      - | 10073 | ` *  Unicode decoded string or NULL on failure.` |
|      - | 10074 | ` */` |
|    ! 0 | 10075 | `PH7_PRIVATE int vm_builtin_utf8_decode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|    ! 0 | 10076 | `{` |
|      - | 10077 | `	const unsigned char *zIn,*zEnd;` |
|      - | 10078 | `	int nByte,c;` |
|    ! 0 | 10079 | `	if( nArg < 1 ){` |
|      - | 10080 | `		/* Missing arguments,return null */` |
|    ! 0 | 10081 | `		ph7_result_null(pCtx);` |
|    ! 0 | 10082 | `		return PH7_OK;` |
|      - | 10083 | `	}` |
|      - | 10084 | `	/* Extract the target string */` |
|    ! 0 | 10085 | `	zIn = (const unsigned char *)ph7_value_to_string(apArg[0],&nByte);` |
|    ! 0 | 10086 | `	if( nByte < 1 ){` |
|      - | 10087 | `		/* Empty string,return null */` |
|    ! 0 | 10088 | `		ph7_result_null(pCtx);` |
|    ! 0 | 10089 | `		return PH7_OK;` |
|      - | 10090 | `	}` |
|    ! 0 | 10091 | `	zEnd = &zIn[nByte];` |
|      - | 10092 | `	/* Start the decoding process */` |
|    ! 0 | 10093 | `	while( zIn < zEnd ){` |
|    ! 0 | 10094 | `		c = PH7_Utf8Read(zIn,zEnd,&zIn);` |
|    ! 0 | 10095 | `		if( c == 0x0 ){` |
|    ! 0 | 10096 | `			break;` |
|      - | 10097 | `		}` |
|    ! 0 | 10098 | `		ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|    ! 0 | 10099 | `	}` |
|    ! 0 | 10100 | `	return PH7_OK;` |
|    ! 0 | 10101 | `}` |
|      - | 10102 |  |
