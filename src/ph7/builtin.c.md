...
|      - |   61 | ` */` |
|    214 |   62 | `static int PH7_builtin_is_int(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   63 |  |
|    216 |   64 | `	int res = 0; /* Assume false by default */` |
|    216 |   65 | `	if( nArg > 0 ){` |
|    214 |   66 | `		res = ph7_value_is_int(apArg[0]);` |
|    106 |   67 | `	}` |
|      - |   68 | `	/* Query result */` |
|    216 |   69 | `	ph7_result_bool(pCtx,res);` |
|    216 |   70 | `	return PH7_OK;` |
|      2 |   71 |  |
|      - |   72 | `/*` |
...
|      - |  291 | ` */` |
|  23640 |  292 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  293 |  |
|  23642 |  294 | `	int res = 1; /* Assume empty by default */` |
|  23642 |  295 | `	if( nArg > 0 ){` |
|  23640 |  296 | `		res = ph7_value_is_empty(apArg[0]);` |
|  11819 |  297 | `	}` |
|  23642 |  298 | `	ph7_result_bool(pCtx,res);` |
|  23642 |  299 | `	return PH7_OK;` |
|      - |  300 |  |
|      2 |  301 |  |
...
|      - |  341 | ` */` |
| 172220 |  342 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  343 |  |
|      - |  344 | `	const char *zSource,*zOfft;` |
|      - |  345 | `	int nOfft,nLen,nSrcLen;` |
| 172222 |  346 | `	if( nArg < 2 ){` |
|      - |  347 | `		/* return FALSE */` |
|      5 |  348 | `		ph7_result_bool(pCtx,0);` |
|      5 |  349 | `		return PH7_OK;` |
|      - |  350 | `	}` |
|      - |  351 | `	/* Extract the target string */` |
| 172218 |  352 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 172218 |  353 | `	if( nSrcLen < 1 ){` |
|      - |  354 | `		/* Empty string,return FALSE */` |
|  10216 |  355 | `		ph7_result_bool(pCtx,0);` |
|  10216 |  356 | `		return PH7_OK;` |
|      - |  357 | `	}` |
| 162004 |  358 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  359 | `	/* Extract the offset */` |
| 162004 |  360 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 162004 |  361 | `	if( nOfft < 0 ){` |
|  27234 |  362 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  27234 |  363 | `		if( zOfft < zSource ){` |
|      - |  364 | `			/* Invalid offset */` |
|      5 |  365 | `			ph7_result_bool(pCtx,0);` |
|      5 |  366 | `			return PH7_OK;` |
|      - |  367 | `		}` |
|  27230 |  368 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  27230 |  369 | `		nOfft = (int)(zOfft-zSource);` |
| 148386 |  370 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  371 | `		/* Invalid offset */` |
|     88 |  372 | `		ph7_result_bool(pCtx,0);` |
|     88 |  373 | `		return PH7_OK;` |
|    ! 0 |  374 | `	}else{` |
| 134686 |  375 | `		zOfft = &zSource[nOfft];` |
| 134686 |  376 | `		nLen = nSrcLen - nOfft;` |
|      - |  377 | `	}` |
| 161914 |  378 | `	if( nArg > 2 ){` |
|      - |  379 | `		/* Extract the length */` |
| 134008 |  380 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 134008 |  381 | `		if( nLen == 0 ){` |
|      - |  382 | `			/* Invalid length,return an empty string */` |
|      5 |  383 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  384 | `			return PH7_OK;` |
| 134004 |  385 | `		}else if( nLen < 0 ){` |
|  27232 |  386 | `			nLen = nSrcLen + nLen - nOfft;` |
|  27232 |  387 | `			if( nLen < 1 ){` |
|      - |  388 | `				/* Invalid  length */` |
|      3 |  389 | `				nLen = nSrcLen - nOfft;` |
|      1 |  390 | `			}` |
|  13615 |  391 | `		}` |
| 134004 |  392 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  393 | `			/* Invalid length */` |
|   3780 |  394 | `			nLen = nSrcLen - nOfft;` |
|   1889 |  395 | `		}` |
|  67001 |  396 | `	}` |
|      - |  397 | `	/* Return the substring */` |
| 161910 |  398 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 161910 |  399 | `	return PH7_OK;` |
|  86112 |  400 |  |
|      - |  401 | `/*` |
...
|      - | 1368 | ` */` |
|   4194 | 1369 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1370 |  |
|   4196 | 1371 | `	int iLen = 0;` |
|   4196 | 1372 | `	if( nArg > 0 ){` |
|   4194 | 1373 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   2096 | 1374 | `	}` |
|      - | 1375 | `	/* String length */` |
|   4196 | 1376 | `	ph7_result_int(pCtx,iLen);` |
|   4196 | 1377 | `	return PH7_OK;` |
|      2 | 1378 |  |
|      - | 1379 | `/*` |
...
|      - | 1521 | ` */` |
| 110440 | 1522 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      2 | 1523 |  |
|  55220 | 1524 | `	SXUNUSED(pKey);` |
| 110442 | 1525 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1526 | `	const char *zData;` |
|      - | 1527 | `	int nLen;` |
| 110442 | 1528 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 110440 | 1545 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1546 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 110440 | 1547 | `	if( pData->bFirst ){` |
|  27490 | 1548 | `		pData->bFirst = 0;` |
|  96696 | 1549 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1550 | `		/* append the separator first */` |
|  82940 | 1551 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  41469 | 1552 | `	}` |
|      - | 1553 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
| 110440 | 1554 | `	if( nLen > 0 ){` |
| 100226 | 1555 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  50112 | 1556 | `	}` |
| 110440 | 1557 | `	return PH7_OK;` |
|  55222 | 1558 |  |
|      - | 1559 | `/*` |
...
|      - | 1571 | ` */` |
|  27512 | 1572 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1573 |  |
|      - | 1574 | `	struct implode_data imp_data;` |
|  27514 | 1575 | `	int i = 1;` |
|  27514 | 1576 | `	if( nArg < 1 ){` |
|      - | 1577 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1578 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1579 | `		return PH7_OK;` |
|      - | 1580 | `	}` |
|      - | 1581 | `	/* Prepare the implode context */` |
|  27514 | 1582 | `	imp_data.pCtx = pCtx;` |
|  27514 | 1583 | `	imp_data.bRecursive = 0;` |
|  27514 | 1584 | `	imp_data.bFirst = 1;` |
|  27514 | 1585 | `	imp_data.nRecCount = 0;` |
|  27514 | 1586 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  27512 | 1587 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  13757 | 1588 | `	}else{` |
|      3 | 1589 | `		imp_data.zSep = 0;` |
|      3 | 1590 | `		imp_data.nSeplen = 0;` |
|      3 | 1591 | `		i = 0;` |
|      - | 1592 | `	}` |
|  27514 | 1593 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 1594 | `	/* Start the 'join' process */` |
|  55026 | 1595 | `	while( i < nArg ){` |
|  27514 | 1596 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1597 | `			/* Iterate throw array entries */` |
|  27514 | 1598 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|  13758 | 1599 | `		}else{` |
...
|      - | 1706 | ` */` |
|   5156 | 1707 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1708 |  |
...
|   5150 | 1721 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   5150 | 1722 | `	if( nDelim < 1 ){` |
|      - | 1723 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1724 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1725 | `		return PH7_OK;` |
|      - | 1726 | `	}` |
|      - | 1727 | `	/* Extract the string */` |
|   5148 | 1728 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   5148 | 1729 | `	if( nStrlen < 1 ){` |
...
|   5146 | 1744 | `	zEnd = &zString[nStrlen];` |
|      - | 1745 | `	/* Create the array */` |
|   5146 | 1746 | `	pArray =  ph7_context_new_array(pCtx);` |
|   5146 | 1747 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   5146 | 1748 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1749 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1750 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1751 | `		return PH7_OK;` |
|      - | 1752 | `	}` |
|      - | 1753 | `	/* Set a defualt limit */` |
|   5146 | 1754 | `	iLimit = SXI32_HIGH;` |
|   5146 | 1755 | `	if( nArg > 2 ){` |
...
|  58516 | 1766 | `	for(;;){` |
| 117034 | 1767 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 117034 | 1768 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1769 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   5146 | 1770 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   5146 | 1771 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   5146 | 1772 | `			break;` |
|      - | 1773 | `		}` |
|      - | 1774 | `		/* Point to the desired offset */` |
| 111890 | 1775 | `		zCur = &zString[nOfft];` |
|      - | 1776 | `		/* Perform the store operation (may be empty) */` |
| 111890 | 1777 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 111890 | 1778 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 1779 | `		/* Point beyond the delimiter */` |
| 111890 | 1780 | `		zString = &zCur[nDelim];` |
|      - | 1781 | `		/* Reset the cursor */` |
| 111890 | 1782 | `		ph7_value_reset_string_cursor(pValue);` |
|      2 | 1783 | `	}` |
|      - | 1784 | `	/* Return the freshly created array */` |
|   5146 | 1785 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1786 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1787 | `	 * released as soon we return from this foregin function.` |
|      - | 1788 | `	 */` |
|   5146 | 1789 | `	return PH7_OK;` |
|   2580 | 1790 |  |
|      - | 1791 | `/*` |
...
|      - | 1805 | ` */` |
|  11914 | 1806 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1807 |  |
|      - | 1808 | `	const char *zString;` |
|      - | 1809 | `	int nLen;` |
|  11916 | 1810 | `	if( nArg < 1 ){` |
|      - | 1811 | `		/* Missing arguments,return null */` |
|      3 | 1812 | `		ph7_result_null(pCtx);` |
|      3 | 1813 | `		return PH7_OK;` |
|      - | 1814 | `	}` |
|      - | 1815 | `	/* Extract the target string */` |
|  11914 | 1816 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  11914 | 1817 | `	if( nLen < 1 ){` |
|      - | 1818 | `		/* Empty string,return */` |
|   1614 | 1819 | `		ph7_result_string(pCtx,"",0);` |
|   1614 | 1820 | `		return PH7_OK;` |
|      - | 1821 | `	}` |
|      - | 1822 | `	/* Start the trim process */` |
|  10302 | 1823 | `	if( nArg < 2 ){` |
|      - | 1824 | `		SyString sStr;` |
|      - | 1825 | `		/* Remove white spaces and NUL bytes */` |
|  10298 | 1826 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  24992 | 1827 | `		SyStringFullTrimSafe(&sStr);` |
|  10298 | 1828 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   5150 | 1829 | `	}else{` |
|      - | 1830 | `		/* Char list */` |
...
|    ! 0 | 2080 | `		}else{` |
| 144350 | 2081 | `			int c = zString[0];` |
| 144350 | 2082 | `			if( SyisUpper(c) ){` |
| 144348 | 2083 | `				c = SyToLower(zString[0]);` |
|  72173 | 2084 | `			}` |
|      - | 2085 | `			/* Append character */` |
| 144350 | 2086 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2087 | `			/* Advance the cursor */` |
| 144350 | 2088 | `			zString++;` |
|      - | 2089 | `		}` |
|      2 | 2090 | `	}` |
|  27230 | 2091 | `	return PH7_OK;` |
|  13618 | 2092 |  |
|      - | 2093 | `/*` |
...
|      - | 5497 | ` */` |
|  20466 | 5498 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5499 |  |
...
|      - | 5508 | `	int nByte;` |
|      - | 5509 | `	sxi32 rc;` |
|  20468 | 5510 | `	if( nArg < 3 ){` |
|      - | 5511 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 5512 | `		ph7_result_null(pCtx);` |
|      7 | 5513 | `		return PH7_OK;` |
|      - | 5514 | `	}` |
|      - | 5515 | `	/* Initialize fields */` |
|  20462 | 5516 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  20462 | 5517 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  20462 | 5518 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  20462 | 5519 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  20462 | 5520 | `	sRep.pCtx = pCtx;` |
|  20462 | 5521 | `	sRep.pCollector = &sSearch;` |
|  20462 | 5522 | `	rep_str = 0;` |
|      - | 5523 | `	/* Extract the subject */` |
|  20462 | 5524 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  20462 | 5525 | `	if( nByte < 1 ){` |
...
|  20434 | 5531 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 5532 | `	/* Search string */` |
|  20434 | 5533 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 5534 | `		/* Collect search string */` |
|      9 | 5535 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 5536 | `	}else{` |
|      - | 5537 | `		/* Single pattern */` |
|  20426 | 5538 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  20426 | 5539 | `		if( nByte < 1 ){` |
...
|      - | 5543 | `		}` |
|  20422 | 5544 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5545 | `		/* Save for later processing */` |
|  20422 | 5546 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 5547 | `	}` |
|      - | 5548 | `	/* Replace string */` |
|  20430 | 5549 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 5550 | `		/* Collect replace string */` |
|      7 | 5551 | `		sRep.pCollector = &sReplace;` |
|      7 | 5552 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 5553 | `	}else{` |
|      - | 5554 | `		/* Single needle */` |
|  20424 | 5555 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  20424 | 5556 | `		rep_str = 1;` |
|  20424 | 5557 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5558 | `		/* Save for later processing */` |
|  20424 | 5559 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 5560 | `	}` |
|      - | 5561 | `	/* Reset loop cursors */` |
|  20430 | 5562 | `	SySetResetCursor(&sSearch);` |
|  20430 | 5563 | `	SySetResetCursor(&sReplace);` |
|  20430 | 5564 | `	pReplace = pSearch = 0; /* cc warning */` |
|  20430 | 5565 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5566 | `	/* Extract function name */` |
|  20430 | 5567 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5568 | `	/* Set the default pattern match routine */` |
|  20430 | 5569 | `	xMatch = SyBlobSearch;` |
|  20430 | 5570 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5571 | `		/* Case insensitive pattern match */` |
|     11 | 5572 | `		xMatch = iPatternMatch;` |
|      5 | 5573 | `	}` |
|      - | 5574 | `	/* Start the replace process */` |
|  40866 | 5575 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5576 | `		sxu32 nCount,nOfft;` |
|  20438 | 5577 | `		if( pSearch->nByte <  1 ){` |
|      - | 5578 | `			/* Empty string,ignore */` |
|      3 | 5579 | `			continue;` |
|      - | 5580 | `		}` |
|      - | 5581 | `		/* Extract the replace string */` |
|  20436 | 5582 | `		if( rep_str ){` |
|  20426 | 5583 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  10214 | 5584 | `		}else{` |
...
|      1 | 5590 | `			}` |
|      - | 5591 | `		}` |
|  20436 | 5592 | `		if( pReplace == 0 ){` |
|      - | 5593 | `			/* Use an empty string instead */` |
|      3 | 5594 | `			pReplace = &sTemp;` |
|      1 | 5595 | `		}` |
|  20436 | 5596 | `		nOfft = nCount = 0;` |
|  10233 | 5597 | `		for(;;){` |
|  20468 | 5598 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 5599 | `				break;` |
|      - | 5600 | `			}` |
|      - | 5601 | `			/* Perform a pattern lookup */` |
|  30683 | 5602 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  20454 | 5603 | `				pSearch->nByte,&nOfft);` |
|  20456 | 5604 | `			if( rc != SXRET_OK ){` |
...
|  20430 | 5615 | `	ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  20430 | 5616 | `	SySetRelease(&sSearch);` |
|  20430 | 5617 | `	SySetRelease(&sReplace);` |
|  20430 | 5618 | `	SyBlobRelease(&sWorker);` |
|  20430 | 5619 | `	return PH7_OK;` |
|  10235 | 5620 |  |
|      - | 5621 | `/*` |
...
|      - | 6784 | ` */` |
|   2612 | 6785 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      2 | 6786 |  |
|      - | 6787 | `	sxu32 n;` |
| 404862 | 6788 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 402250 | 6789 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 201126 | 6790 | `	}` |
|      - | 6791 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   2614 | 6792 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 6793 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   2614 | 6794 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   2614 | 6795 |  |
|      - | 6796 |  |
