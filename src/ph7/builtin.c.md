...
| 495544 |   18 | `PH7_PRIVATE sxi32 PH7_IntArgResolve(` |
|      - |   19 | `	ph7_context *pCtx,` |
|      - |   20 | `	ph7_value *pArg,` |
|      - |   21 | `	const char *zFunc,` |
|      - |   22 | `	int iArgNum,` |
...
|      - |   25 | `	sxi64 *pOut` |
|      5 |   26 | `){` |
| 495549 |   27 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - |   35 | `			);` |
|      - |   36 | `	}` |
| 495549 |   37 | `	if( ph7_value_is_float(pArg) ){` |
...
|      8 |   59 | `		return PH7_OK;` |
|      - |   60 | `	}` |
| 495535 |   61 | `	if( ph7_value_is_string(pArg) ){` |
|      - |   62 | `		const char *zNum;` |
|      - |   63 | `		int nSlen;` |
...
|      5 |  103 | `		return PH7_OK;` |
|      - |  104 | `	}` |
| 495519 |  105 | `	if( !ph7_value_is_int(pArg) && !ph7_value_is_bool(pArg) ){` |
...
|      - |  118 | `			);` |
|      - |  119 | `	}` |
| 495519 |  120 | `	*pOut = ph7_value_to_int64(pArg);` |
| 495519 |  121 | `	return PH7_OK;` |
| 247881 |  122 | `}` |
|      - |  123 |  |
...
|      - |  420 | ` */` |
|  39580 |  421 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  422 | `{` |
|  39585 |  423 | `	int res = 1; /* Assume empty by default */` |
|  39585 |  424 | `	if( nArg > 0 ){` |
|  39583 |  425 | `		res = ph7_value_is_empty(apArg[0]);` |
|  19789 |  426 | `	}` |
|  39585 |  427 | `	ph7_result_bool(pCtx,res);` |
|  39585 |  428 | `	return PH7_OK;` |
|      - |  429 |  |
|      5 |  430 | `}` |
