...
Coverage: 3814/4323 lines (88.23%)
...
|      - |   47 | ` */` |
|    206 |   48 | `static int PH7_builtin_is_float(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |   49 | `{` |
|    207 |   50 | `	int res = 0; /* Assume false by default */` |
|    207 |   51 | `	if( nArg > 0 ){` |
|    205 |   52 | `		res = ph7_value_is_float(apArg[0]);` |
|    102 |   53 | `	}` |
|      - |   54 | `	/* Query result */` |
|    207 |   55 | `	ph7_result_bool(pCtx,res);` |
|    207 |   56 | `	return PH7_OK;` |
|      1 |   57 | `}` |
|      - |   58 | `/*` |
|      - |   59 | ` * bool is_int($var)` |
...
|      - |  106 | ` */` |
|     90 |  107 | `static int PH7_builtin_is_null(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  108 | `{` |
|     92 |  109 | `	int res = 0; /* Assume false by default */` |
|     92 |  110 | `	if( nArg > 0 ){` |
|     90 |  111 | `		res = ph7_value_is_null(apArg[0]);` |
|     44 |  112 | `	}` |
|      - |  113 | `	/* Query result */` |
|     92 |  114 | `	ph7_result_bool(pCtx,res);` |
|     92 |  115 | `	return PH7_OK;` |
|      2 |  116 | `}` |
|      - |  117 | `/*` |
...
|      - |  300 | ` */` |
|  33726 |  301 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  302 | `{` |
|  33731 |  303 | `	int res = 1; /* Assume empty by default */` |
|  33731 |  304 | `	if( nArg > 0 ){` |
|  33729 |  305 | `		res = ph7_value_is_empty(apArg[0]);` |
|  16862 |  306 | `	}` |
|  33731 |  307 | `	ph7_result_bool(pCtx,res);` |
|  33731 |  308 | `	return PH7_OK;` |
|      - |  309 |  |
|      5 |  310 | `}` |
...
|      - |  350 | ` */` |
| 212950 |  351 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  352 | `{` |
|      - |  353 | `	const char *zSource,*zOfft;` |
|      - |  354 | `	int nOfft,nLen,nSrcLen;` |
| 212955 |  355 | `	if( nArg < 2 ){` |
|      - |  356 | `		/* return FALSE */` |
|    ! 0 |  357 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  358 | `		return PH7_OK;` |
|      - |  359 | `	}` |
|      - |  360 | `	/* Extract the target string */` |
| 212955 |  361 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 212955 |  362 | `	if( nSrcLen < 1 ){` |
|      - |  363 | `		/* Empty string,return FALSE */` |
|  11835 |  364 | `		ph7_result_bool(pCtx,0);` |
|  11835 |  365 | `		return PH7_OK;` |
|      - |  366 | `	}` |
| 201125 |  367 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  368 | `	/* Extract the offset */` |
| 201125 |  369 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 201125 |  370 | `	if( nOfft < 0 ){` |
|  32281 |  371 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  32281 |  372 | `		if( zOfft < zSource ){` |
|      - |  373 | `			/* Invalid offset */` |
|      5 |  374 | `			ph7_result_bool(pCtx,0);` |
|      5 |  375 | `			return PH7_OK;` |
|      - |  376 | `		}` |
|  32277 |  377 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  32277 |  378 | `		nOfft = (int)(zOfft-zSource);` |
| 184985 |  379 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  380 | `		/* Invalid offset */` |
|    195 |  381 | `		ph7_result_bool(pCtx,0);` |
|    195 |  382 | `		return PH7_OK;` |
|    ! 0 |  383 | `	}else{` |
| 168659 |  384 | `		zOfft = &zSource[nOfft];` |
| 168659 |  385 | `		nLen = nSrcLen - nOfft;` |
|      - |  386 | `	}` |
| 200931 |  387 | `	if( nArg > 2 ){` |
|      - |  388 | `		/* Extract the length */` |
| 165341 |  389 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 165341 |  390 | `		if( nLen == 0 ){` |
|      - |  391 | `			/* Invalid length,return an empty string */` |
|      5 |  392 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  393 | `			return PH7_OK;` |
| 165337 |  394 | `		}else if( nLen < 0 ){` |
|  32269 |  395 | `			nLen = nSrcLen + nLen - nOfft;` |
|  32269 |  396 | `			if( nLen < 1 ){` |
|      - |  397 | `				/* Invalid  length */` |
|      3 |  398 | `				nLen = nSrcLen - nOfft;` |
|      1 |  399 | `			}` |
|  16132 |  400 | `		}` |
| 165337 |  401 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  402 | `			/* Invalid length */` |
|   5007 |  403 | `			nLen = nSrcLen - nOfft;` |
|   2501 |  404 | `		}` |
|  82666 |  405 | `	}` |
|      - |  406 | `	/* Return the substring */` |
| 200927 |  407 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 200927 |  408 | `	return PH7_OK;` |
| 106480 |  409 | `}` |
|      - |  410 | `/*` |
...
|      - | 1167 | ` */` |
|   9650 | 1168 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1169 | `{` |
|   9655 | 1170 | `	int iLen = 0;` |
|   9655 | 1171 | `	if( nArg > 0 ){` |
|   9653 | 1172 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   4824 | 1173 | `	}` |
|      - | 1174 | `	/* String length */` |
|   9655 | 1175 | `	ph7_result_int(pCtx,iLen);` |
|   9655 | 1176 | `	return PH7_OK;` |
|      5 | 1177 | `}` |
|      - | 1178 | `/*` |
...
|      - | 1187 | ` */` |
|     76 | 1188 | `static int PH7_builtin_strcmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 | 1189 | `{` |
...
|      - | 1249 | ` */` |
|     18 | 1250 | `static int PH7_builtin_strcasecmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 | 1251 | `{` |
|      - | 1252 | `	const char *z1,*z2;` |
|      - | 1253 | `	int n1,n2;` |
|      - | 1254 | `	int res;` |
|     19 | 1255 | `	if( nArg < 2 ){` |
|      5 | 1256 | `		res = nArg == 0 ? 0 : 1;` |
|      5 | 1257 | `		ph7_result_int(pCtx,res);` |
...
|      - | 1321 | ` */` |
| 133564 | 1322 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1323 | `{` |
|  66782 | 1324 | `	SXUNUSED(pKey);` |
| 133569 | 1325 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1326 | `	const char *zData;` |
|      - | 1327 | `	int nLen;` |
| 133569 | 1328 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 133567 | 1352 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1353 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 133567 | 1354 | `	if( pData->bFirst ){` |
|  32619 | 1355 | `		pData->bFirst = 0;` |
| 117260 | 1356 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1357 | `		/* append the separator first */` |
| 100941 | 1358 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 133567 | 1364 | `	if( nLen > 0 ){` |
| 121737 | 1365 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1366 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1367 | `			return PH7_ABORT;` |
|      - | 1368 | `		}` |
|  60866 | 1369 | `	}` |
| 133567 | 1370 | `	return PH7_OK;` |
|  66787 | 1371 | `}` |
|      - | 1372 | `/*` |
...
|      - | 1384 | ` */` |
|  32638 | 1385 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1386 | `{` |
|      - | 1387 | `	struct implode_data imp_data;` |
|  32643 | 1388 | `	int i = 1;` |
|  32643 | 1389 | `	if( nArg < 1 ){` |
|      - | 1390 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1391 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1392 | `		return PH7_OK;` |
|      - | 1393 | `	}` |
|      - | 1394 | `	/* Prepare the implode context */` |
|  32643 | 1395 | `	imp_data.pCtx = pCtx;` |
|  32643 | 1396 | `	imp_data.bRecursive = 0;` |
|  32643 | 1397 | `	imp_data.bFirst = 1;` |
|  32643 | 1398 | `	imp_data.nRecCount = 0;` |
|  32643 | 1399 | `	imp_data.rc = SXRET_OK;` |
|  32643 | 1400 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  32641 | 1401 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16323 | 1402 | `	}else{` |
|      3 | 1403 | `		imp_data.zSep = 0;` |
|      3 | 1404 | `		imp_data.nSeplen = 0;` |
|      3 | 1405 | `		i = 0;` |
|      - | 1406 | `	}` |
|  32643 | 1407 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1408 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1409 | `	}` |
|      - | 1410 | `	/* Start the 'join' process */` |
|  65281 | 1411 | `	while( i < nArg ){` |
|  32643 | 1412 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1413 | `			/* Iterate throw array entries */` |
|  32643 | 1414 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1415 | `			/* Surface a callback allocation failure as a fatal */` |
|  32643 | 1416 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 1541 | ` */` |
|   6242 | 1542 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1543 | `{` |
...
|   6239 | 1556 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6239 | 1557 | `	if( nDelim < 1 ){` |
|      - | 1558 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1559 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1560 | `		return PH7_OK;` |
|      - | 1561 | `	}` |
|      - | 1562 | `	/* Extract the string */` |
|   6237 | 1563 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6237 | 1564 | `	if( nStrlen < 1 ){` |
...
|   6231 | 1590 | `	zEnd = &zString[nStrlen];` |
|      - | 1591 | `	/* Create the array */` |
|   6231 | 1592 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6231 | 1593 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6231 | 1594 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1595 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1596 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1597 | `		return PH7_OK;` |
|      - | 1598 | `	}` |
|      - | 1599 | `	/* Set a defualt limit */` |
|   6231 | 1600 | `	iLimit = SXI32_HIGH;` |
|   6231 | 1601 | `	if( nArg > 2 ){` |
...
|  72480 | 1636 | `	for(;;){` |
| 144965 | 1637 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 144965 | 1638 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1639 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6215 | 1640 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6215 | 1641 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1642 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 1643 | `			}` |
|   6215 | 1644 | `			break;` |
|      - | 1645 | `		}` |
|      - | 1646 | `		/* Point to the desired offset */` |
| 138755 | 1647 | `		zCur = &zString[nOfft];` |
|      - | 1648 | `		/* Perform the store operation (may be empty) */` |
| 138755 | 1649 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 138755 | 1650 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1651 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 1652 | `		}` |
|      - | 1653 | `		/* Point beyond the delimiter */` |
| 138755 | 1654 | `		zString = &zCur[nDelim];` |
|      - | 1655 | `		/* Reset the cursor */` |
| 138755 | 1656 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 1657 | `	}` |
|      - | 1658 | `	/* Return the freshly created array */` |
|   6215 | 1659 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1660 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1661 | `	 * released as soon we return from this foregin function.` |
|      - | 1662 | `	 */` |
|   6215 | 1663 | `	return PH7_OK;` |
|   3126 | 1664 | `}` |
|      - | 1665 | `/*` |
...
|      - | 1679 | ` */` |
|  14022 | 1680 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1681 | `{` |
|      - | 1682 | `	const char *zString;` |
|      - | 1683 | `	int nLen;` |
|  14027 | 1684 | `	if( nArg < 1 ){` |
|      - | 1685 | `		/* Missing arguments,return null */` |
|      3 | 1686 | `		ph7_result_null(pCtx);` |
|      3 | 1687 | `		return PH7_OK;` |
|      - | 1688 | `	}` |
|      - | 1689 | `	/* Extract the target string */` |
|  14025 | 1690 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14025 | 1691 | `	if( nLen < 1 ){` |
|      - | 1692 | `		/* Empty string,return */` |
|   1581 | 1693 | `		ph7_result_string(pCtx,"",0);` |
|   1581 | 1694 | `		return PH7_OK;` |
|      - | 1695 | `	}` |
|      - | 1696 | `	/* Start the trim process */` |
|  12449 | 1697 | `	if( nArg < 2 ){` |
|      - | 1698 | `		SyString sStr;` |
|      - | 1699 | `		/* Remove white spaces and NUL bytes */` |
|  12419 | 1700 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  30611 | 1701 | `		SyStringFullTrimSafe(&sStr);` |
|  12419 | 1702 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6212 | 1703 | `	}else{` |
|      - | 1704 | `		/* Char list */` |
...
|    ! 0 | 1905 | `		}else{` |
| 170963 | 1906 | `			int c = zString[0];` |
| 170963 | 1907 | `			if( SyisUpper(c) ){` |
| 170961 | 1908 | `				c = SyToLower(zString[0]);` |
|  85478 | 1909 | `			}` |
|      - | 1910 | `			/* Append character */` |
| 170963 | 1911 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 1912 | `			/* Advance the cursor */` |
| 170963 | 1913 | `			zString++;` |
|      - | 1914 | `		}` |
|      5 | 1915 | `	}` |
|  32267 | 1916 | `	return PH7_OK;` |
|  16138 | 1917 | `}` |
|      - | 1918 | `/*` |
...
|     45 | 1937 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     45 | 1938 | `	if( nLen < 1 ){` |
...
|     43 | 1944 | `	zEnd = &zString[nLen];` |
|     98 | 1945 | `	for(;;){` |
|    201 | 1946 | `		if( zString >= zEnd ){` |
|      - | 1947 | `			/* No more input,break immediately */` |
|     43 | 1948 | `			break;` |
|      - | 1949 | `		}` |
|    163 | 1950 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 1959 | `		}else{` |
|    163 | 1960 | `			int c = zString[0];` |
|    163 | 1961 | `			if( SyisLower(c) ){` |
|    157 | 1962 | `				c = SyToUpper(zString[0]);` |
|     76 | 1963 | `			}` |
|      - | 1964 | `			/* Append character */` |
|    163 | 1965 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 1966 | `			/* Advance the cursor */` |
|    163 | 1967 | `			zString++;` |
|      - | 1968 | `		}` |
|      5 | 1969 | `	}` |
|     43 | 1970 | `	return PH7_OK;` |
|     26 | 1971 | `}` |
|      - | 1972 | `/*` |
...
|     97 | 2445 | `		ph7_result_int64(pCtx,(ph7_int64)(nOfft+nStart));` |
|     50 | 2446 | `	}else{` |
|      3 | 2447 | `		ph7_result_bool(pCtx,0);` |
|      - | 2448 | `	}` |
|     99 | 2449 | `	return PH7_OK;` |
|     67 | 2450 | `}` |
|      - | 2451 | `/*` |
...
|      - | 7050 | ` */` |
|  28444 | 7051 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7052 | `{` |
...
|      - | 7061 | `	int nByte;` |
|      - | 7062 | `	sxi32 rc;` |
|  28449 | 7063 | `	if( nArg < 3 ){` |
|      - | 7064 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 7065 | `		ph7_result_null(pCtx);` |
|    ! 0 | 7066 | `		return PH7_OK;` |
|      - | 7067 | `	}` |
|      - | 7068 | `	/* Initialize fields */` |
|  28449 | 7069 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  28449 | 7070 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  28449 | 7071 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  28449 | 7072 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  28449 | 7073 | `	sRep.pCtx = pCtx;` |
|  28449 | 7074 | `	sRep.pCollector = &sSearch;` |
|  28449 | 7075 | `	rep_str = 0;` |
|      - | 7076 | `	/* Extract the subject */` |
|  28449 | 7077 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  28449 | 7078 | `	if( nByte < 1 ){` |
...
|  28421 | 7084 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 7085 | `	/* Search string */` |
|  28421 | 7086 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 7087 | `		/* Collect search string */` |
|      9 | 7088 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 7089 | `	}else{` |
|      - | 7090 | `		/* Single pattern */` |
|  28413 | 7091 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  28413 | 7092 | `		if( nByte < 1 ){` |
...
|      - | 7096 | `		}` |
|  28409 | 7097 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 7098 | `		/* Save for later processing */` |
|  28409 | 7099 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 7100 | `	}` |
|      - | 7101 | `	/* Replace string */` |
|  28417 | 7102 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 7103 | `		/* Collect replace string */` |
|      7 | 7104 | `		sRep.pCollector = &sReplace;` |
|      7 | 7105 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 7106 | `	}else{` |
|      - | 7107 | `		/* Single needle */` |
|  28411 | 7108 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  28411 | 7109 | `		rep_str = 1;` |
|  28411 | 7110 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 7111 | `		/* Save for later processing */` |
|  28411 | 7112 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 7113 | `	}` |
|      - | 7114 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  28417 | 7115 | `	if( sRep.rc != SXRET_OK ){` |
...
|  28417 | 7122 | `	SySetResetCursor(&sSearch);` |
|  28417 | 7123 | `	SySetResetCursor(&sReplace);` |
|  28417 | 7124 | `	pReplace = pSearch = 0; /* cc warning */` |
|  28417 | 7125 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 7126 | `	/* Extract function name */` |
|  28417 | 7127 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 7128 | `	/* Set the default pattern match routine */` |
|  28417 | 7129 | `	xMatch = SyBlobSearch;` |
|  28417 | 7130 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 7131 | `		/* Case insensitive pattern match */` |
|     11 | 7132 | `		xMatch = iPatternMatch;` |
|      5 | 7133 | `	}` |
|      - | 7134 | `	/* Start the replace process */` |
|  56837 | 7135 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 7136 | `		sxu32 nCount,nOfft;` |
|  28425 | 7137 | `		if( pSearch->nByte <  1 ){` |
|      - | 7138 | `			/* Empty string,ignore */` |
|      3 | 7139 | `			continue;` |
|      - | 7140 | `		}` |
|      - | 7141 | `		/* Extract the replace string */` |
|  28423 | 7142 | `		if( rep_str ){` |
|  28413 | 7143 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14209 | 7144 | `		}else{` |
...
|      1 | 7150 | `			}` |
|      - | 7151 | `		}` |
|  28423 | 7152 | `		if( pReplace == 0 ){` |
|      - | 7153 | `			/* Use an empty string instead */` |
|      3 | 7154 | `			pReplace = &sTemp;` |
|      1 | 7155 | `		}` |
|  28423 | 7156 | `		nOfft = nCount = 0;` |
|  14225 | 7157 | `		for(;;){` |
|  28455 | 7158 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 7159 | `				break;` |
|      - | 7160 | `			}` |
|      - | 7161 | `			/* Perform a pattern lookup */` |
|  42662 | 7162 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  28438 | 7163 | `				pSearch->nByte,&nOfft);` |
|  28443 | 7164 | `			if( rc != SXRET_OK ){` |
...
|  28417 | 7182 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  28417 | 7183 | `	SySetRelease(&sSearch);` |
|  28417 | 7184 | `	SySetRelease(&sReplace);` |
|  28417 | 7185 | `	SyBlobRelease(&sWorker);` |
|  28417 | 7186 | `	if( rc != PH7_OK ){` |
|    ! 0 | 7187 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 7188 | `	}` |
|  28417 | 7189 | `	return PH7_OK;` |
|  14227 | 7190 | `}` |
|      - | 7191 | `/*` |
...
|      - | 7661 | ` */` |
|   1622 | 7662 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7663 | `{` |
...
|   1625 | 7672 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   1625 | 7673 | `	zEnd = &zIn[nLen];` |
|   1625 | 7674 | `	if( nLen < 1 ){` |
...
|   1521 | 7680 | `	for(;;){` |
|   3047 | 7681 | `		if( zIn >= zEnd ){` |
|      - | 7682 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1379 | 7683 | `			ph7_result_bool(pCtx,1);` |
|   1379 | 7684 | `			return PH7_OK;` |
|      - | 7685 | `		}` |
|   1673 | 7686 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 7687 | `			/* UTF-8 stream  */` |
|    ! 0 | 7688 | `			break;` |
|      - | 7689 | `		}` |
|   1673 | 7690 | `		if( !SyisDigit(zIn[0]) ){` |
|    249 | 7691 | `			break;` |
|      - | 7692 | `		}` |
...
|      - | 7903 | ` */` |
|  62709 | 7904 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7905 | `{` |
|      - | 7906 | `	const unsigned char *zIn,*zEnd;` |
|      - | 7907 | `	int nLen;` |
|  62714 | 7908 | `	if( nArg < 1 ){` |
|      - | 7909 | `		/* Missing arguments,return FALSE */` |
|      3 | 7910 | `		ph7_result_bool(pCtx,0);` |
|      3 | 7911 | `		return PH7_OK;` |
|      - | 7912 | `	}` |
|      - | 7913 | `	/* Extract the target string */` |
|  62712 | 7914 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  62712 | 7915 | `	zEnd = &zIn[nLen];` |
|  62712 | 7916 | `	if( nLen < 1 ){` |
...
|  60594 | 7939 | `	ph7_result_bool(pCtx,0);` |
|  60594 | 7940 | `	return PH7_OK;` |
|  31402 | 7941 | `}` |
|      - | 7942 | `/*` |
...
|      - | 8373 | ` */` |
|   3454 | 8374 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 8375 | `{` |
|      - | 8376 | `	sxu32 n;` |
| 580277 | 8377 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 576823 | 8378 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 288414 | 8379 | `	}` |
|      - | 8380 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3459 | 8381 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 8382 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3459 | 8383 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3459 | 8384 | `}` |
|      - | 8385 |  |
