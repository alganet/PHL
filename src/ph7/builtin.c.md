...
Coverage: 4267/4944 lines (86.31%)
...
|      - |   49 | ` */` |
|    302 |   50 | `static int PH7_builtin_is_float(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |   51 | `{` |
|    303 |   52 | `	int res = 0; /* Assume false by default */` |
|    303 |   53 | `	if( nArg > 0 ){` |
|    303 |   54 | `		res = ph7_value_is_float(apArg[0]);` |
|    151 |   55 | `	}` |
|      - |   56 | `	/* Query result */` |
|    303 |   57 | `	ph7_result_bool(pCtx,res);` |
|    303 |   58 | `	return PH7_OK;` |
|      1 |   59 | `}` |
|      - |   60 | `/*` |
|      - |   61 | ` * bool is_int($var)` |
...
|      - |   69 | ` */` |
|    790 |   70 | `static int PH7_builtin_is_int(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 |   71 | `{` |
|    793 |   72 | `	int res = 0; /* Assume false by default */` |
|    793 |   73 | `	if( nArg > 0 ){` |
...
|    793 |   77 | `		res = ph7_value_is_int(apArg[0]) && !ph7_value_is_float(apArg[0]);` |
|    395 |   78 | `	}` |
|      - |   79 | `	/* Query result */` |
|    793 |   80 | `	ph7_result_bool(pCtx,res);` |
|    793 |   81 | `	return PH7_OK;` |
|      3 |   82 | `}` |
|      - |   83 | `/*` |
...
|      - |   90 | ` */` |
|    536 |   91 | `static int PH7_builtin_is_string(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |   92 | `{` |
|    537 |   93 | `	int res = 0; /* Assume false by default */` |
|    537 |   94 | `	if( nArg > 0 ){` |
|    537 |   95 | `		res = ph7_value_is_string(apArg[0]);` |
|    268 |   96 | `	}` |
|      - |   97 | `	/* Query result */` |
|    537 |   98 | `	ph7_result_bool(pCtx,res);` |
|    537 |   99 | `	return PH7_OK;` |
|      1 |  100 | `}` |
|      - |  101 | `/*` |
...
|      - |  162 | ` */` |
|    394 |  163 | `static int PH7_builtin_is_array(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  164 | `{` |
|    399 |  165 | `	int res = 0; /* Assume false by default */` |
|    399 |  166 | `	if( nArg > 0 ){` |
|    399 |  167 | `		res = ph7_value_is_array(apArg[0]);` |
|    197 |  168 | `	}` |
|      - |  169 | `	/* Query result */` |
|    399 |  170 | `	ph7_result_bool(pCtx,res);` |
|    399 |  171 | `	return PH7_OK;` |
|      5 |  172 | `}` |
|      - |  173 | `/*` |
...
|      - |  180 | ` */` |
|    354 |  181 | `static int PH7_builtin_is_object(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 |  182 | `{` |
|    355 |  183 | `	int res = 0; /* Assume false by default */` |
|    355 |  184 | `	if( nArg > 0 ){` |
|    355 |  185 | `		res = ph7_value_is_object(apArg[0]);` |
|    177 |  186 | `	}` |
|      - |  187 | `	/* Query result */` |
|    355 |  188 | `	ph7_result_bool(pCtx,res);` |
|    355 |  189 | `	return PH7_OK;` |
|      1 |  190 | `}` |
|      - |  191 | `/*` |
...
|      4 |  200 | `{` |
|     62 |  201 | `	int res = 0; /* Assume false by default */` |
|     62 |  202 | `	if( nArg > 0 ){` |
|     62 |  203 | `		res = ph7_value_is_resource(apArg[0]);` |
|     29 |  204 | `	}` |
|     62 |  205 | `	ph7_result_bool(pCtx,res);` |
|     62 |  206 | `	return PH7_OK;` |
|      4 |  207 | `}` |
|      - |  208 | `/*` |
...
|      - |  302 | ` */` |
|  34204 |  303 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  304 | `{` |
|  34209 |  305 | `	int res = 1; /* Assume empty by default */` |
|  34209 |  306 | `	if( nArg > 0 ){` |
|  34207 |  307 | `		res = ph7_value_is_empty(apArg[0]);` |
|  17101 |  308 | `	}` |
|  34209 |  309 | `	ph7_result_bool(pCtx,res);` |
|  34209 |  310 | `	return PH7_OK;` |
|      - |  311 |  |
|      5 |  312 | `}` |
...
|      - |  352 | ` */` |
| 228380 |  353 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  354 | `{` |
|      - |  355 | `	const char *zSource,*zOfft;` |
|      - |  356 | `	int nOfft,nLen,nSrcLen;` |
| 228385 |  357 | `	if( nArg < 2 ){` |
|      - |  358 | `		/* return FALSE */` |
|    ! 0 |  359 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  360 | `		return PH7_OK;` |
|      - |  361 | `	}` |
|      - |  362 | `	/* Extract the target string */` |
| 228385 |  363 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 228385 |  364 | `	if( nSrcLen < 1 ){` |
|      - |  365 | `		/* Empty string,return FALSE */` |
|  12281 |  366 | `		ph7_result_bool(pCtx,0);` |
|  12281 |  367 | `		return PH7_OK;` |
|      - |  368 | `	}` |
| 216109 |  369 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  370 | `	/* Extract the offset */` |
| 216109 |  371 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 216109 |  372 | `	if( nOfft < 0 ){` |
|  32981 |  373 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  32981 |  374 | `		if( zOfft < zSource ){` |
|      - |  375 | `			/* Invalid offset */` |
|      5 |  376 | `			ph7_result_bool(pCtx,0);` |
|      5 |  377 | `			return PH7_OK;` |
|      - |  378 | `		}` |
|  32977 |  379 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  32977 |  380 | `		nOfft = (int)(zOfft-zSource);` |
| 199619 |  381 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  382 | `		/* Invalid offset */` |
|    241 |  383 | `		ph7_result_bool(pCtx,0);` |
|    241 |  384 | `		return PH7_OK;` |
|    ! 0 |  385 | `	}else{` |
| 182897 |  386 | `		zOfft = &zSource[nOfft];` |
| 182897 |  387 | `		nLen = nSrcLen - nOfft;` |
|      - |  388 | `	}` |
| 215869 |  389 | `	if( nArg > 2 ){` |
|      - |  390 | `		/* Extract the length */` |
| 178323 |  391 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 178323 |  392 | `		if( nLen == 0 ){` |
|      - |  393 | `			/* Invalid length,return an empty string */` |
|      5 |  394 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  395 | `			return PH7_OK;` |
| 178319 |  396 | `		}else if( nLen < 0 ){` |
|  32969 |  397 | `			nLen = nSrcLen + nLen - nOfft;` |
|  32969 |  398 | `			if( nLen < 1 ){` |
|      - |  399 | `				/* Invalid  length */` |
|      3 |  400 | `				nLen = nSrcLen - nOfft;` |
|      1 |  401 | `			}` |
|  16482 |  402 | `		}` |
| 178319 |  403 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  404 | `			/* Invalid length */` |
|   5823 |  405 | `			nLen = nSrcLen - nOfft;` |
|   2909 |  406 | `		}` |
|  89157 |  407 | `	}` |
|      - |  408 | `	/* Return the substring */` |
| 215865 |  409 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 215865 |  410 | `	return PH7_OK;` |
| 114195 |  411 | `}` |
|      - |  412 | `/*` |
...
|      - | 1549 | ` */` |
|    100 | 1550 | `static void PH7_BuildCharMask(ph7_context *pCtx,const char *zList,int nLen,char aMask[256])` |
|      4 | 1551 | `{` |
|    104 | 1552 | `	const unsigned char *zIn  = (const unsigned char *)zList;` |
|    104 | 1553 | `	const unsigned char *zEnd = zIn + (nLen > 0 ? nLen : 0);` |
|    104 | 1554 | `	SyZero(aMask,256);` |
|    366 | 1555 | `	for( ; zIn < zEnd ; zIn++ ){` |
|    266 | 1556 | `		int c = zIn[0];` |
|    266 | 1557 | `		if( zIn + 3 < zEnd && zIn[1] == '.' && zIn[2] == '.' && zIn[3] >= c ){` |
...
|    265 | 1564 | `		}else if( zIn + 1 < zEnd && zIn[0] == '.' && zIn[1] == '.' ){` |
...
|     38 | 1639 | `	if( ph7_value_is_null(apArg[1]) ){` |
...
|     49 | 1646 | `	          ph7_value_is_object(apArg[1]) \|\|` |
...
|      - | 1821 | ` * so every charset argument other than a UTF-8 alias gets PHP's` |
...
|      - | 1977 | ` */` |
|  11916 | 1978 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1979 | `{` |
|  11921 | 1980 | `	int iLen = 0;` |
|  11921 | 1981 | `	if( nArg > 0 ){` |
|  11921 | 1982 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   5958 | 1983 | `	}` |
|      - | 1984 | `	/* String length */` |
|  11921 | 1985 | `	ph7_result_int(pCtx,iLen);` |
|  11921 | 1986 | `	return PH7_OK;` |
|      5 | 1987 | `}` |
|      - | 1988 | `/*` |
...
|      - | 2089 | ` */` |
|     34 | 2090 | `static int PH7_builtin_strncasecmp(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2091 | `{` |
...
|     39 | 2100 | `	n  = ph7_value_to_int(apArg[2]);` |
|     39 | 2101 | `	if( n < 0 ){` |
...
|     37 | 2108 | `	z1 = ph7_value_to_string(apArg[0],0);` |
|     37 | 2109 | `	z2 = ph7_value_to_string(apArg[1],0);` |
|     37 | 2110 | `	res = SyStrnicmp(z1,z2,(sxu32)n);` |
|      - | 2111 | `	/* Comparison result */` |
|     37 | 2112 | `	ph7_result_int(pCtx,res);` |
|     37 | 2113 | `	return PH7_OK;` |
|     22 | 2114 | `}` |
|      - | 2115 | `/*` |
...
|      - | 2133 | ` */` |
| 145616 | 2134 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2135 | `{` |
|  72808 | 2136 | `	SXUNUSED(pKey);` |
| 145621 | 2137 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2138 | `	const char *zData;` |
|      - | 2139 | `	int nLen;` |
| 145621 | 2140 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 145619 | 2164 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2165 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 145619 | 2166 | `	if( pData->bFirst ){` |
|  33417 | 2167 | `		pData->bFirst = 0;` |
| 128913 | 2168 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2169 | `		/* append the separator first */` |
| 112191 | 2170 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 145619 | 2176 | `	if( nLen > 0 ){` |
| 133343 | 2177 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2178 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2179 | `			return PH7_ABORT;` |
|      - | 2180 | `		}` |
|  66669 | 2181 | `	}` |
| 145619 | 2182 | `	return PH7_OK;` |
|  72813 | 2183 | `}` |
|      - | 2184 | `/*` |
...
|      - | 2196 | ` */` |
|  33438 | 2197 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2198 | `{` |
|      - | 2199 | `	struct implode_data imp_data;` |
|  33443 | 2200 | `	int i = 1;` |
|  33443 | 2201 | `	if( nArg < 1 ){` |
|      - | 2202 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2203 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2204 | `		return PH7_OK;` |
|      - | 2205 | `	}` |
|      - | 2206 | `	/* Prepare the implode context */` |
|  33443 | 2207 | `	imp_data.pCtx = pCtx;` |
|  33443 | 2208 | `	imp_data.bRecursive = 0;` |
|  33443 | 2209 | `	imp_data.bFirst = 1;` |
|  33443 | 2210 | `	imp_data.nRecCount = 0;` |
|  33443 | 2211 | `	imp_data.rc = SXRET_OK;` |
|  33443 | 2212 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33441 | 2213 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16723 | 2214 | `	}else{` |
|      3 | 2215 | `		imp_data.zSep = 0;` |
|      3 | 2216 | `		imp_data.nSeplen = 0;` |
|      3 | 2217 | `		i = 0;` |
|      - | 2218 | `	}` |
|  33443 | 2219 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2220 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2221 | `	}` |
|      - | 2222 | `	/* Start the 'join' process */` |
|  66881 | 2223 | `	while( i < nArg ){` |
|  33443 | 2224 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2225 | `			/* Iterate throw array entries */` |
|  33443 | 2226 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2227 | `			/* Surface a callback allocation failure as a fatal */` |
|  33443 | 2228 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2353 | ` */` |
|   6514 | 2354 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2355 | `{` |
...
|   6519 | 2368 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6519 | 2369 | `	if( nDelim < 1 ){` |
...
|   6515 | 2375 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6515 | 2376 | `	if( nStrlen < 1 ){` |
...
|   6509 | 2402 | `	zEnd = &zString[nStrlen];` |
|      - | 2403 | `	/* Create the array */` |
|   6509 | 2404 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6509 | 2405 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6509 | 2406 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2407 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2408 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2409 | `		return PH7_OK;` |
|      - | 2410 | `	}` |
|      - | 2411 | `	/* Set a defualt limit */` |
|   6509 | 2412 | `	iLimit = SXI32_HIGH;` |
|   6509 | 2413 | `	if( nArg > 2 ){` |
...
|  78753 | 2448 | `	for(;;){` |
| 157511 | 2449 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 157511 | 2450 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2451 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6493 | 2452 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6493 | 2453 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2454 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2455 | `			}` |
|   6493 | 2456 | `			break;` |
|      - | 2457 | `		}` |
|      - | 2458 | `		/* Point to the desired offset */` |
| 151023 | 2459 | `		zCur = &zString[nOfft];` |
|      - | 2460 | `		/* Perform the store operation (may be empty) */` |
| 151023 | 2461 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 151023 | 2462 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2463 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2464 | `		}` |
|      - | 2465 | `		/* Point beyond the delimiter */` |
| 151023 | 2466 | `		zString = &zCur[nDelim];` |
|      - | 2467 | `		/* Reset the cursor */` |
| 151023 | 2468 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2469 | `	}` |
|      - | 2470 | `	/* Return the freshly created array */` |
|   6493 | 2471 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2472 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2473 | `	 * released as soon we return from this foregin function.` |
|      - | 2474 | `	 */` |
|   6493 | 2475 | `	return PH7_OK;` |
|   3262 | 2476 | `}` |
|      - | 2477 | `/*` |
...
|      - | 2491 | ` */` |
|  14706 | 2492 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2493 | `{` |
|      - | 2494 | `	const char *zString;` |
|      - | 2495 | `	int nLen;` |
|  14711 | 2496 | `	if( nArg < 1 ){` |
|      - | 2497 | `		/* Missing arguments,return null */` |
|    ! 0 | 2498 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2499 | `		return PH7_OK;` |
|      - | 2500 | `	}` |
|      - | 2501 | `	/* Extract the target string */` |
|  14711 | 2502 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14711 | 2503 | `	if( nLen < 1 ){` |
|      - | 2504 | `		/* Empty string,return */` |
|   1325 | 2505 | `		ph7_result_string(pCtx,"",0);` |
|   1325 | 2506 | `		return PH7_OK;` |
|      - | 2507 | `	}` |
|      - | 2508 | `	/* Start the trim process */` |
|  13391 | 2509 | `	if( nArg < 2 ){` |
|      - | 2510 | `		SyString sStr;` |
|      - | 2511 | `		/* Remove white spaces and NUL bytes */` |
|  13361 | 2512 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  33543 | 2513 | `		SyStringFullTrimSafe(&sStr);` |
|  13361 | 2514 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6683 | 2515 | `	}else{` |
|      - | 2516 | `		/* Char list */` |
...
|      - | 2625 | ` */` |
|     38 | 2626 | `static int PH7_builtin_ltrim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2627 | `{` |
...
|     43 | 2636 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     43 | 2637 | `	if( nLen < 1 ){` |
|      - | 2638 | `		/* Empty string,return */` |
|     21 | 2639 | `		ph7_result_string(pCtx,"",0);` |
|     21 | 2640 | `		return PH7_OK;` |
|      - | 2641 | `	}` |
...
|      - | 2652 | `		int nListlen;` |
|     23 | 2653 | `		zList = ph7_value_to_string(apArg[1],&nListlen);` |
|     23 | 2654 | `		if( nListlen < 1 ){` |
|      - | 2655 | `			/* Return the string unchanged */` |
|      3 | 2656 | `			ph7_result_string(pCtx,zString,nLen);` |
|      2 | 2657 | `		}else{` |
|      - | 2658 | `			char aMask[256];` |
|     21 | 2659 | `			const char *zEnd = &zString[nLen];` |
|     21 | 2660 | `			const char *zCur = zString;` |
|     21 | 2661 | `			PH7_BuildCharMask(pCtx,zList,nListlen,aMask);` |
|      - | 2662 | `			/* Left trim */` |
|     55 | 2663 | `			while( zCur < zEnd && aMask[(unsigned char)zCur[0]] ){` |
|     37 | 2664 | `				zCur++;` |
|      3 | 2665 | `			}` |
|     21 | 2666 | `			if( zCur >= zEnd ){` |
|      - | 2667 | `				/* Return the empty string */` |
|    ! 0 | 2668 | `				ph7_result_string(pCtx,"",0);` |
|    ! 0 | 2669 | `			}else{` |
|     21 | 2670 | `				ph7_result_string(pCtx,zCur,(int)(zEnd-zCur));` |
|      - | 2671 | `			}` |
|      - | 2672 | `		}` |
|      - | 2673 | `	}` |
|     25 | 2674 | `	return PH7_OK;` |
|     24 | 2675 | `}` |
|      - | 2676 | `/*` |
...
|    ! 0 | 2717 | `		}else{` |
| 177601 | 2718 | `			int c = zString[0];` |
| 177601 | 2719 | `			if( SyisUpper(c) ){` |
| 175099 | 2720 | `				c = SyToLower(zString[0]);` |
|  87547 | 2721 | `			}` |
|      - | 2722 | `			/* Append character */` |
| 177601 | 2723 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2724 | `			/* Advance the cursor */` |
| 177601 | 2725 | `			zString++;` |
|      - | 2726 | `		}` |
|      5 | 2727 | `	}` |
|  33423 | 2728 | `	return PH7_OK;` |
|  16715 | 2729 | `}` |
|      - | 2730 | `/*` |
...
|      - | 2738 | ` */` |
|     66 | 2739 | `static int PH7_builtin_strtoupper(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 | 2740 | `{` |
...
|     70 | 2749 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     70 | 2750 | `	if( nLen < 1 ){` |
...
|     68 | 2756 | `	zEnd = &zString[nLen];` |
|    135 | 2757 | `	for(;;){` |
|    274 | 2758 | `		if( zString >= zEnd ){` |
|      - | 2759 | `			/* No more input,break immediately */` |
|     68 | 2760 | `			break;` |
|      - | 2761 | `		}` |
|    210 | 2762 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2771 | `		}else{` |
|    210 | 2772 | `			int c = zString[0];` |
|    210 | 2773 | `			if( SyisLower(c) ){` |
|    200 | 2774 | `				c = SyToUpper(zString[0]);` |
|     98 | 2775 | `			}` |
|      - | 2776 | `			/* Append character */` |
|    210 | 2777 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2778 | `			/* Advance the cursor */` |
|    210 | 2779 | `			zString++;` |
|      - | 2780 | `		}` |
|      4 | 2781 | `	}` |
|     68 | 2782 | `	return PH7_OK;` |
|     37 | 2783 | `}` |
|      - | 2784 | `/*` |
...
|      - | 3012 | `	 */` |
|    205 | 3013 | `	if( ph7_value_is_array(apArg[0]) \|\| ph7_value_is_resource(apArg[0]) \|\|` |
...
|      - | 3216 | ` */` |
|   1348 | 3217 | `static int PH7_builtin_strpos(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 3218 | `{` |
|   1353 | 3219 | `	ProcStringMatch xPatternMatch = SyBlobSearch; /* Case-sensitive pattern match */` |
...
|   1353 | 3230 | `	zBlob = ph7_value_to_string(apArg[0],&nLen);` |
|   1353 | 3231 | `	zPattern = ph7_value_to_string(apArg[1],&nPatLen);` |
|   1353 | 3232 | `	nOfft = 0; /* cc warning */` |
|   1353 | 3233 | `	nStart = 0;` |
...
|      - | 3246 | `		}` |
|    ! 0 | 3247 | `	}` |
|   1353 | 3248 | `	if( nLen > 0 && nPatLen > 0 ){` |
|      - | 3249 | `		/* Perform the lookup */` |
|   1351 | 3250 | `		rc = xPatternMatch(zBlob,(sxu32)nLen,zPattern,(sxu32)nPatLen,&nOfft);` |
|   1351 | 3251 | `		if( rc != SXRET_OK ){` |
|      - | 3252 | `			/* Pattern not found,return FALSE */` |
|    725 | 3253 | `			ph7_result_bool(pCtx,0);` |
|    725 | 3254 | `			return PH7_OK;` |
|      - | 3255 | `		}` |
...
|      - | 3275 | ` */` |
|    724 | 3276 | `static sxi32 StrPredicateResolveArg(` |
...
|      - | 3286 | `	int *pnOut` |
|      4 | 3287 | `){` |
|    728 | 3288 | `	if( ph7_value_is_null(pArg) ){` |
|     13 | 3289 | `		PH7_VmThrowError(pCtx->pVm,0,E_DEPRECATED,zNullMsg);` |
|     13 | 3290 | `		*pzOut = "";` |
|     13 | 3291 | `		*pnOut = 0;` |
|     13 | 3292 | `		return PH7_OK;` |
|      - | 3293 | `	}` |
|   1094 | 3294 | `	if( ph7_value_is_array(pArg) \|\| ph7_value_is_resource(pArg) \|\|` |
|    686 | 3295 | `	    ( ph7_value_is_object(pArg) &&` |
...
|      - | 3312 | `			);` |
|      - | 3313 | `	}` |
|    665 | 3314 | `	if( ph7_value_is_object(pArg) ){` |
...
|      - | 3322 | `	}` |
|    617 | 3323 | `	*pzOut = ph7_value_to_string(pArg,pnOut);` |
|    617 | 3324 | `	return PH7_OK;` |
|    366 | 3325 | `}` |
|      - | 3326 | `/*` |
...
|      - | 3331 | ` */` |
|     98 | 3332 | `static int PH7_builtin_str_contains(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      4 | 3333 | `{` |
...
|      - | 3343 | `			);` |
|      - | 3344 | `	}` |
|     90 | 3345 | `	PH7_MemObjInit(pCtx->pVm,&sHayTmp);` |
|     90 | 3346 | `	PH7_MemObjInit(pCtx->pVm,&sNeedleTmp);` |
|     90 | 3347 | `	rc = StrPredicateResolveArg(pCtx,apArg[0],"str_contains",1,"$haystack","string",` |
|      - | 3348 | `		"str_contains(): Passing null to parameter #1 ($haystack) "` |
|      - | 3349 | `		"of type string is deprecated",` |
|      - | 3350 | `		&sHayTmp,&zHaystack,&nHayLen);` |
|     90 | 3351 | `	if( rc != PH7_OK ) goto out;` |
|     83 | 3352 | `	rc = StrPredicateResolveArg(pCtx,apArg[1],"str_contains",2,"$needle","string",` |
|      - | 3353 | `		"str_contains(): Passing null to parameter #2 ($needle) "` |
|      - | 3354 | `		"of type string is deprecated",` |
|      - | 3355 | `		&sNeedleTmp,&zNeedle,&nNeedleLen);` |
|     83 | 3356 | `	if( rc != PH7_OK ) goto out;` |
|     79 | 3357 | `	if( nNeedleLen < 1 ){` |
|     13 | 3358 | `		ph7_result_bool(pCtx,1);` |
|     73 | 3359 | `	}else if( nHayLen < nNeedleLen ){` |
|      9 | 3360 | `		ph7_result_bool(pCtx,0);` |
|      5 | 3361 | `	}else{` |
|     88 | 3362 | `		sxi32 srch = SyBlobSearch((const void *)zHaystack,(sxu32)nHayLen,` |
|     29 | 3363 | `		                          (const void *)zNeedle,(sxu32)nNeedleLen,0);` |
|     59 | 3364 | `		ph7_result_bool(pCtx,srch == SXRET_OK ? 1 : 0);` |
|      - | 3365 | `	}` |
|     79 | 3366 | `	rc = PH7_OK;` |
|     44 | 3367 | `out:` |
|     90 | 3368 | `	PH7_MemObjRelease(&sHayTmp);` |
|     90 | 3369 | `	PH7_MemObjRelease(&sNeedleTmp);` |
|     90 | 3370 | `	return rc;` |
|     53 | 3371 | `}` |
|      - | 3372 | `/*` |
...
|      - | 6124 | ` * HTML 4.01 table (documented divergence). */` |
...
|      - | 6335 | ` * php-supported single-byte charsets like ISO-8859-1, PHL is UTF-8-only by` |
|      - | 6336 | ` * policy — raises PHP's unsupported-charset warning and is treated as` |
...
|      5 | 7910 | `{` |
|     51 | 7911 | `	char *zInput = (char *)SyBlobData(pWorker);` |
|      - | 7912 | `	sxu32 n,m;` |
|     51 | 7913 | `	n = SyBlobLength(pWorker);` |
|     51 | 7914 | `	m = nOfft;` |
|      - | 7915 | `	/* Delete the old entry */` |
|   6577 | 7916 | `	STRDEL(zInput,n,m,nLen);` |
|     51 | 7917 | `	SyBlobLength(pWorker) -= nLen;` |
|     51 | 7918 | `	if( nReplen > 0 ){` |
|     45 | 7919 | `		sxi32 iRep = nReplen;` |
|      - | 7920 | `		sxi32 rc;` |
|      - | 7921 | `		/*` |
|      - | 7922 | `		 * Make sure the working buffer is big enough to hold the replacement` |
|      - | 7923 | `		 * string.` |
|      - | 7924 | `		 */` |
|     45 | 7925 | `		rc = SyBlobAppend(pWorker,0/* Grow without an append operation*/,(sxu32)nReplen);` |
|     45 | 7926 | `		if( rc != SXRET_OK ){` |
...
|     45 | 7932 | `		zInput = (char *)SyBlobData(pWorker);` |
|     45 | 7933 | `		n = SyBlobLength(pWorker);` |
|   6361 | 7934 | `		SHIFTRANDINSERT(zInput,n,nOfft,zReplace,iRep);` |
|     45 | 7935 | `		SyBlobLength(pWorker) += nReplen;` |
|     20 | 7936 | `	}` |
|     51 | 7937 | `	return SXRET_OK;` |
|     28 | 7938 | `}` |
|      - | 7939 | `/*` |
...
|      - | 7943 | ` */` |
|     78 | 7944 | `static int StrReplaceWalker(ph7_value *pKey,ph7_value *pData,void *pUserData)` |
|      5 | 7945 | `{` |
|     83 | 7946 | `	str_replace_data *pRep = (str_replace_data *)pUserData;` |
|      - | 7947 | `	SyString sWorker;` |
|      - | 7948 | `	const char *zIn;` |
|      - | 7949 | `	int nByte;` |
|      - | 7950 | `	/* Extract a string representation of the given argument */` |
|     83 | 7951 | `	zIn = ph7_value_to_string(pData,&nByte);` |
|     83 | 7952 | `	SyStringInitFromBuf(&sWorker,0,0);` |
|     83 | 7953 | `	if( nByte > 0 ){` |
|      - | 7954 | `		char *zDup;` |
|      - | 7955 | `		/* Duplicate the chunk */` |
|     81 | 7956 | `		zDup = (char *)ph7_context_alloc_chunk(pRep->pCtx,(unsigned int)nByte,FALSE,` |
...
|      - | 7964 | `		}` |
|     81 | 7965 | `		SyMemcpy(zIn,zDup,(sxu32)nByte);` |
|      - | 7966 | `		/* Save the chunk */` |
|     81 | 7967 | `		SyStringInitFromBuf(&sWorker,zDup,nByte);` |
|     38 | 7968 | `	}` |
|      - | 7969 | `	/* Save for later processing */` |
|     83 | 7970 | `	SySetPut(pRep->pCollector,(const void *)&sWorker);` |
|      - | 7971 | `	/* All done */` |
|     39 | 7972 | `	SXUNUSED(pKey); /* cc warning */` |
|     83 | 7973 | `	return PH7_OK;` |
|     44 | 7974 | `}` |
|      - | 7975 | `/*` |
...
|      - | 8000 | ` */` |
|  29616 | 8001 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8002 | `{` |
...
|      - | 8011 | `	int nByte;` |
|      - | 8012 | `	sxi32 rc;` |
|  29621 | 8013 | `	if( nArg < 3 ){` |
|      - | 8014 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8015 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8016 | `		return PH7_OK;` |
|      - | 8017 | `	}` |
|      - | 8018 | `	/* Initialize fields */` |
|  29621 | 8019 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29621 | 8020 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29621 | 8021 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  29621 | 8022 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  29621 | 8023 | `	sRep.pCtx = pCtx;` |
|  29621 | 8024 | `	sRep.pCollector = &sSearch;` |
|  29621 | 8025 | `	rep_str = 0;` |
|      - | 8026 | `	/* Extract the subject */` |
|  29621 | 8027 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  29621 | 8028 | `	if( nByte < 1 ){` |
...
|  29593 | 8034 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8035 | `	/* Search string */` |
|  29593 | 8036 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8037 | `		/* Collect search string */` |
|     39 | 8038 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     22 | 8039 | `	}else{` |
|      - | 8040 | `		/* Single pattern */` |
|  29559 | 8041 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29559 | 8042 | `		if( nByte < 1 ){` |
...
|      - | 8046 | `		}` |
|  29555 | 8047 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8048 | `		/* Save for later processing */` |
|  29555 | 8049 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8050 | `	}` |
|      - | 8051 | `	/* Replace string */` |
|  29589 | 8052 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8053 | `		/* Collect replace string */` |
|      7 | 8054 | `		sRep.pCollector = &sReplace;` |
|      7 | 8055 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8056 | `	}else{` |
|      - | 8057 | `		/* Single needle */` |
|  29583 | 8058 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  29583 | 8059 | `		rep_str = 1;` |
|  29583 | 8060 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8061 | `		/* Save for later processing */` |
|  29583 | 8062 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8063 | `	}` |
|      - | 8064 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  29589 | 8065 | `	if( sRep.rc != SXRET_OK ){` |
...
|  29589 | 8072 | `	SySetResetCursor(&sSearch);` |
|  29589 | 8073 | `	SySetResetCursor(&sReplace);` |
|  29589 | 8074 | `	pReplace = pSearch = 0; /* cc warning */` |
|  29589 | 8075 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8076 | `	/* Extract function name */` |
|  29589 | 8077 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8078 | `	/* Set the default pattern match routine */` |
|  29589 | 8079 | `	xMatch = SyBlobSearch;` |
|  29589 | 8080 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8081 | `		/* Case insensitive pattern match */` |
|     11 | 8082 | `		xMatch = iPatternMatch;` |
|      5 | 8083 | `	}` |
|      - | 8084 | `	/* Start the replace process */` |
|  59207 | 8085 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8086 | `		sxu32 nCount,nOfft;` |
|  29623 | 8087 | `		if( pSearch->nByte <  1 ){` |
|      - | 8088 | `			/* Empty string,ignore */` |
|      3 | 8089 | `			continue;` |
|      - | 8090 | `		}` |
|      - | 8091 | `		/* Extract the replace string */` |
|  29621 | 8092 | `		if( rep_str ){` |
|  29611 | 8093 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14808 | 8094 | `		}else{` |
...
|      1 | 8100 | `			}` |
|      - | 8101 | `		}` |
|  29621 | 8102 | `		if( pReplace == 0 ){` |
|      - | 8103 | `			/* Use an empty string instead */` |
|      3 | 8104 | `			pReplace = &sTemp;` |
|      1 | 8105 | `		}` |
|  29621 | 8106 | `		nOfft = nCount = 0;` |
|  14831 | 8107 | `		for(;;){` |
|  29667 | 8108 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8109 | `				break;` |
|      - | 8110 | `			}` |
|      - | 8111 | `			/* Perform a pattern lookup */` |
|  44480 | 8112 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  29650 | 8113 | `				pSearch->nByte,&nOfft);` |
|  29655 | 8114 | `			if( rc != SXRET_OK ){` |
|      - | 8115 | `				/* Pattern not found */` |
|  29609 | 8116 | `				break;` |
|      - | 8117 | `			}` |
|      - | 8118 | `			/* Perform the replace operation */` |
|     51 | 8119 | `			rc = StringReplace(&sWorker,nCount+nOfft,(int)pSearch->nByte,pReplace->zString,(int)pReplace->nByte);` |
|     51 | 8120 | `			if( rc != SXRET_OK ){` |
...
|     51 | 8128 | `			nCount += nOfft + pReplace->nByte;` |
|      5 | 8129 | `		}` |
|      5 | 8130 | `	}` |
|      - | 8131 | `	/* All done,clean-up the mess left behind */` |
|  29589 | 8132 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  29589 | 8133 | `	SySetRelease(&sSearch);` |
|  29589 | 8134 | `	SySetRelease(&sReplace);` |
|  29589 | 8135 | `	SyBlobRelease(&sWorker);` |
|  29589 | 8136 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8137 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8138 | `	}` |
|  29589 | 8139 | `	return PH7_OK;` |
|  14813 | 8140 | `}` |
|      - | 8141 | `/*` |
...
|      - | 8727 | ` */` |
|   1668 | 8728 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8729 | `{` |
...
|   1673 | 8738 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   1673 | 8739 | `	zEnd = &zIn[nLen];` |
|   1673 | 8740 | `	if( nLen < 1 ){` |
...
|   1560 | 8746 | `	for(;;){` |
|   3125 | 8747 | `		if( zIn >= zEnd ){` |
|      - | 8748 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1409 | 8749 | `			ph7_result_bool(pCtx,1);` |
|   1409 | 8750 | `			return PH7_OK;` |
|      - | 8751 | `		}` |
|   1721 | 8752 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 8753 | `			/* UTF-8 stream  */` |
|    ! 0 | 8754 | `			break;` |
|      - | 8755 | `		}` |
|   1721 | 8756 | `		if( !SyisDigit(zIn[0]) ){` |
|    267 | 8757 | `			break;` |
|      - | 8758 | `		}` |
...
|    267 | 8763 | `	ph7_result_bool(pCtx,0);` |
|    267 | 8764 | `	return PH7_OK;` |
|    839 | 8765 | `}` |
|      - | 8766 | `/*` |
...
|      - | 8969 | ` */` |
|  63317 | 8970 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8971 | `{` |
|      - | 8972 | `	const unsigned char *zIn,*zEnd;` |
|      - | 8973 | `	int nLen;` |
|  63322 | 8974 | `	if( nArg < 1 ){` |
|      - | 8975 | `		/* Missing arguments,return FALSE */` |
|    ! 0 | 8976 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 8977 | `		return PH7_OK;` |
|      - | 8978 | `	}` |
|      - | 8979 | `	/* Extract the target string */` |
|  63322 | 8980 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  63322 | 8981 | `	zEnd = &zIn[nLen];` |
|  63322 | 8982 | `	if( nLen < 1 ){` |
...
|  32775 | 8988 | `	for(;;){` |
|  65470 | 8989 | `		if( zIn >= zEnd ){` |
|      - | 8990 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   2131 | 8991 | `			ph7_result_bool(pCtx,1);` |
|   2131 | 8992 | `			return PH7_OK;` |
|      - | 8993 | `		}` |
|  63344 | 8994 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 8995 | `			/* UTF-8 stream  */` |
|    ! 0 | 8996 | `			break;` |
|      - | 8997 | `		}` |
|  63344 | 8998 | `		if( !SyisSpace(zIn[0]) ){` |
|  61194 | 8999 | `			break;` |
|      - | 9000 | `		}` |
...
|  61194 | 9005 | `	ph7_result_bool(pCtx,0);` |
|  61194 | 9006 | `	return PH7_OK;` |
|  31706 | 9007 | `}` |
|      - | 9008 | `/*` |
...
|      - | 9443 | ` */` |
|   3504 | 9444 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      5 | 9445 | `{` |
|      - | 9446 | `	sxu32 n;` |
| 602693 | 9447 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 599189 | 9448 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 299597 | 9449 | `	}` |
|      - | 9450 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   3509 | 9451 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 9452 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   3509 | 9453 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   3509 | 9454 | `}` |
|      - | 9455 |  |
