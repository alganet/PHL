...
|      - |  294 | ` */` |
|  25762 |  295 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  296 |  |
|  25767 |  297 | `	int res = 1; /* Assume empty by default */` |
|  25767 |  298 | `	if( nArg > 0 ){` |
|  25765 |  299 | `		res = ph7_value_is_empty(apArg[0]);` |
|  12880 |  300 | `	}` |
|  25767 |  301 | `	ph7_result_bool(pCtx,res);` |
|  25767 |  302 | `	return PH7_OK;` |
|      - |  303 |  |
|      5 |  304 |  |
...
|      - |  344 | ` */` |
| 190816 |  345 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  346 |  |
|      - |  347 | `	const char *zSource,*zOfft;` |
|      - |  348 | `	int nOfft,nLen,nSrcLen;` |
| 190821 |  349 | `	if( nArg < 2 ){` |
|      - |  350 | `		/* return FALSE */` |
|      5 |  351 | `		ph7_result_bool(pCtx,0);` |
|      5 |  352 | `		return PH7_OK;` |
|      - |  353 | `	}` |
|      - |  354 | `	/* Extract the target string */` |
| 190817 |  355 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 190817 |  356 | `	if( nSrcLen < 1 ){` |
|      - |  357 | `		/* Empty string,return FALSE */` |
|  11081 |  358 | `		ph7_result_bool(pCtx,0);` |
|  11081 |  359 | `		return PH7_OK;` |
|      - |  360 | `	}` |
| 179741 |  361 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  362 | `	/* Extract the offset */` |
| 179741 |  363 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 179741 |  364 | `	if( nOfft < 0 ){` |
|  29843 |  365 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  29843 |  366 | `		if( zOfft < zSource ){` |
|      - |  367 | `			/* Invalid offset */` |
|      5 |  368 | `			ph7_result_bool(pCtx,0);` |
|      5 |  369 | `			return PH7_OK;` |
|      - |  370 | `		}` |
|  29839 |  371 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  29839 |  372 | `		nOfft = (int)(zOfft-zSource);` |
| 164820 |  373 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  374 | `		/* Invalid offset */` |
|    119 |  375 | `		ph7_result_bool(pCtx,0);` |
|    119 |  376 | `		return PH7_OK;` |
|    ! 0 |  377 | `	}else{` |
| 149789 |  378 | `		zOfft = &zSource[nOfft];` |
| 149789 |  379 | `		nLen = nSrcLen - nOfft;` |
|      - |  380 | `	}` |
| 179623 |  381 | `	if( nArg > 2 ){` |
|      - |  382 | `		/* Extract the length */` |
| 148607 |  383 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 148607 |  384 | `		if( nLen == 0 ){` |
|      - |  385 | `			/* Invalid length,return an empty string */` |
|      5 |  386 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  387 | `			return PH7_OK;` |
| 148603 |  388 | `		}else if( nLen < 0 ){` |
|  29833 |  389 | `			nLen = nSrcLen + nLen - nOfft;` |
|  29833 |  390 | `			if( nLen < 1 ){` |
|      - |  391 | `				/* Invalid  length */` |
|      3 |  392 | `				nLen = nSrcLen - nOfft;` |
|      1 |  393 | `			}` |
|  14914 |  394 | `		}` |
| 148603 |  395 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  396 | `			/* Invalid length */` |
|   4257 |  397 | `			nLen = nSrcLen - nOfft;` |
|   2126 |  398 | `		}` |
|  74299 |  399 | `	}` |
|      - |  400 | `	/* Return the substring */` |
| 179619 |  401 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 179619 |  402 | `	return PH7_OK;` |
|  95413 |  403 |  |
|      - |  404 | `/*` |
...
|      - | 1524 | ` */` |
| 120852 | 1525 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1526 |  |
|  60426 | 1527 | `	SXUNUSED(pKey);` |
| 120857 | 1528 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1529 | `	const char *zData;` |
|      - | 1530 | `	int nLen;` |
| 120857 | 1531 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 120855 | 1548 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1549 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 120855 | 1550 | `	if( pData->bFirst ){` |
|  30143 | 1551 | `		pData->bFirst = 0;` |
| 105786 | 1552 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1553 | `		/* append the separator first */` |
|  90705 | 1554 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  45350 | 1555 | `	}` |
|      - | 1556 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
| 120855 | 1557 | `	if( nLen > 0 ){` |
| 109779 | 1558 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  54887 | 1559 | `	}` |
| 120855 | 1560 | `	return PH7_OK;` |
|  60431 | 1561 |  |
|      - | 1562 | `/*` |
...
|      - | 1574 | ` */` |
|  30164 | 1575 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1576 |  |
|      - | 1577 | `	struct implode_data imp_data;` |
|  30169 | 1578 | `	int i = 1;` |
|  30169 | 1579 | `	if( nArg < 1 ){` |
|      - | 1580 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1581 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1582 | `		return PH7_OK;` |
|      - | 1583 | `	}` |
|      - | 1584 | `	/* Prepare the implode context */` |
|  30169 | 1585 | `	imp_data.pCtx = pCtx;` |
|  30169 | 1586 | `	imp_data.bRecursive = 0;` |
|  30169 | 1587 | `	imp_data.bFirst = 1;` |
|  30169 | 1588 | `	imp_data.nRecCount = 0;` |
|  30169 | 1589 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  30167 | 1590 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  15086 | 1591 | `	}else{` |
|      3 | 1592 | `		imp_data.zSep = 0;` |
|      3 | 1593 | `		imp_data.nSeplen = 0;` |
|      3 | 1594 | `		i = 0;` |
|      - | 1595 | `	}` |
|  30169 | 1596 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 1597 | `	/* Start the 'join' process */` |
|  60333 | 1598 | `	while( i < nArg ){` |
|  30169 | 1599 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1600 | `			/* Iterate throw array entries */` |
|  30169 | 1601 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|  15087 | 1602 | `		}else{` |
...
|      - | 1709 | ` */` |
|   5670 | 1710 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1711 |  |
...
|   5667 | 1724 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   5667 | 1725 | `	if( nDelim < 1 ){` |
|      - | 1726 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1727 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1728 | `		return PH7_OK;` |
|      - | 1729 | `	}` |
|      - | 1730 | `	/* Extract the string */` |
|   5665 | 1731 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   5665 | 1732 | `	if( nStrlen < 1 ){` |
...
|   5663 | 1747 | `	zEnd = &zString[nStrlen];` |
|      - | 1748 | `	/* Create the array */` |
|   5663 | 1749 | `	pArray =  ph7_context_new_array(pCtx);` |
|   5663 | 1750 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   5663 | 1751 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1752 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1753 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1754 | `		return PH7_OK;` |
|      - | 1755 | `	}` |
|      - | 1756 | `	/* Set a defualt limit */` |
|   5663 | 1757 | `	iLimit = SXI32_HIGH;` |
|   5663 | 1758 | `	if( nArg > 2 ){` |
...
|  64948 | 1769 | `	for(;;){` |
| 129901 | 1770 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 129901 | 1771 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1772 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   5663 | 1773 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   5663 | 1774 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   5663 | 1775 | `			break;` |
|      - | 1776 | `		}` |
|      - | 1777 | `		/* Point to the desired offset */` |
| 124243 | 1778 | `		zCur = &zString[nOfft];` |
|      - | 1779 | `		/* Perform the store operation (may be empty) */` |
| 124243 | 1780 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 124243 | 1781 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 1782 | `		/* Point beyond the delimiter */` |
| 124243 | 1783 | `		zString = &zCur[nDelim];` |
|      - | 1784 | `		/* Reset the cursor */` |
| 124243 | 1785 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 1786 | `	}` |
|      - | 1787 | `	/* Return the freshly created array */` |
|   5663 | 1788 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1789 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1790 | `	 * released as soon we return from this foregin function.` |
|      - | 1791 | `	 */` |
|   5663 | 1792 | `	return PH7_OK;` |
|   2840 | 1793 |  |
|      - | 1794 | `/*` |
...
|      - | 1808 | ` */` |
|  13000 | 1809 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1810 |  |
|      - | 1811 | `	const char *zString;` |
|      - | 1812 | `	int nLen;` |
|  13005 | 1813 | `	if( nArg < 1 ){` |
|      - | 1814 | `		/* Missing arguments,return null */` |
|      3 | 1815 | `		ph7_result_null(pCtx);` |
|      3 | 1816 | `		return PH7_OK;` |
|      - | 1817 | `	}` |
|      - | 1818 | `	/* Extract the target string */` |
|  13003 | 1819 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  13003 | 1820 | `	if( nLen < 1 ){` |
|      - | 1821 | `		/* Empty string,return */` |
|   1681 | 1822 | `		ph7_result_string(pCtx,"",0);` |
|   1681 | 1823 | `		return PH7_OK;` |
|      - | 1824 | `	}` |
|      - | 1825 | `	/* Start the trim process */` |
|  11327 | 1826 | `	if( nArg < 2 ){` |
|      - | 1827 | `		SyString sStr;` |
|      - | 1828 | `		/* Remove white spaces and NUL bytes */` |
|  11323 | 1829 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  27609 | 1830 | `		SyStringFullTrimSafe(&sStr);` |
|  11323 | 1831 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   5664 | 1832 | `	}else{` |
|      - | 1833 | `		/* Char list */` |
...
|    ! 0 | 2083 | `		}else{` |
| 158177 | 2084 | `			int c = zString[0];` |
| 158177 | 2085 | `			if( SyisUpper(c) ){` |
| 158175 | 2086 | `				c = SyToLower(zString[0]);` |
|  79085 | 2087 | `			}` |
|      - | 2088 | `			/* Append character */` |
| 158177 | 2089 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2090 | `			/* Advance the cursor */` |
| 158177 | 2091 | `			zString++;` |
|      - | 2092 | `		}` |
|      5 | 2093 | `	}` |
|  29831 | 2094 | `	return PH7_OK;` |
|  14920 | 2095 |  |
|      - | 2096 | `/*` |
...
|      - | 5712 | ` */` |
|  22506 | 5713 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 5714 |  |
...
|      - | 5723 | `	int nByte;` |
|      - | 5724 | `	sxi32 rc;` |
|  22511 | 5725 | `	if( nArg < 3 ){` |
|      - | 5726 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 5727 | `		ph7_result_null(pCtx);` |
|      7 | 5728 | `		return PH7_OK;` |
|      - | 5729 | `	}` |
|      - | 5730 | `	/* Initialize fields */` |
|  22505 | 5731 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  22505 | 5732 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  22505 | 5733 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  22505 | 5734 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  22505 | 5735 | `	sRep.pCtx = pCtx;` |
|  22505 | 5736 | `	sRep.pCollector = &sSearch;` |
|  22505 | 5737 | `	rep_str = 0;` |
|      - | 5738 | `	/* Extract the subject */` |
|  22505 | 5739 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  22505 | 5740 | `	if( nByte < 1 ){` |
...
|  22477 | 5746 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 5747 | `	/* Search string */` |
|  22477 | 5748 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 5749 | `		/* Collect search string */` |
|      9 | 5750 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 5751 | `	}else{` |
|      - | 5752 | `		/* Single pattern */` |
|  22469 | 5753 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  22469 | 5754 | `		if( nByte < 1 ){` |
...
|      - | 5758 | `		}` |
|  22465 | 5759 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5760 | `		/* Save for later processing */` |
|  22465 | 5761 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 5762 | `	}` |
|      - | 5763 | `	/* Replace string */` |
|  22473 | 5764 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 5765 | `		/* Collect replace string */` |
|      7 | 5766 | `		sRep.pCollector = &sReplace;` |
|      7 | 5767 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 5768 | `	}else{` |
|      - | 5769 | `		/* Single needle */` |
|  22467 | 5770 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  22467 | 5771 | `		rep_str = 1;` |
|  22467 | 5772 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5773 | `		/* Save for later processing */` |
|  22467 | 5774 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 5775 | `	}` |
|      - | 5776 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  22473 | 5777 | `	if( sRep.rc != SXRET_OK ){` |
...
|  22473 | 5784 | `	SySetResetCursor(&sSearch);` |
|  22473 | 5785 | `	SySetResetCursor(&sReplace);` |
|  22473 | 5786 | `	pReplace = pSearch = 0; /* cc warning */` |
|  22473 | 5787 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5788 | `	/* Extract function name */` |
|  22473 | 5789 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5790 | `	/* Set the default pattern match routine */` |
|  22473 | 5791 | `	xMatch = SyBlobSearch;` |
|  22473 | 5792 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5793 | `		/* Case insensitive pattern match */` |
|     11 | 5794 | `		xMatch = iPatternMatch;` |
|      5 | 5795 | `	}` |
|      - | 5796 | `	/* Start the replace process */` |
|  44949 | 5797 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5798 | `		sxu32 nCount,nOfft;` |
|  22481 | 5799 | `		if( pSearch->nByte <  1 ){` |
|      - | 5800 | `			/* Empty string,ignore */` |
|      3 | 5801 | `			continue;` |
|      - | 5802 | `		}` |
|      - | 5803 | `		/* Extract the replace string */` |
|  22479 | 5804 | `		if( rep_str ){` |
|  22469 | 5805 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  11237 | 5806 | `		}else{` |
...
|      1 | 5812 | `			}` |
|      - | 5813 | `		}` |
|  22479 | 5814 | `		if( pReplace == 0 ){` |
|      - | 5815 | `			/* Use an empty string instead */` |
|      3 | 5816 | `			pReplace = &sTemp;` |
|      1 | 5817 | `		}` |
|  22479 | 5818 | `		nOfft = nCount = 0;` |
|  11253 | 5819 | `		for(;;){` |
|  22511 | 5820 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 5821 | `				break;` |
|      - | 5822 | `			}` |
|      - | 5823 | `			/* Perform a pattern lookup */` |
|  33746 | 5824 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  22494 | 5825 | `				pSearch->nByte,&nOfft);` |
|  22499 | 5826 | `			if( rc != SXRET_OK ){` |
...
|  22473 | 5844 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  22473 | 5845 | `	SySetRelease(&sSearch);` |
|  22473 | 5846 | `	SySetRelease(&sReplace);` |
|  22473 | 5847 | `	SyBlobRelease(&sWorker);` |
|  22473 | 5848 | `	if( rc != PH7_OK ){` |
|    ! 0 | 5849 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 5850 | `	}` |
|  22473 | 5851 | `	return PH7_OK;` |
|  11258 | 5852 |  |
|      - | 5853 | `/*` |
