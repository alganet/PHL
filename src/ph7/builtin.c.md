...
|      - |   61 | ` */` |
|    212 |   62 | `static int PH7_builtin_is_int(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   63 |  |
|    214 |   64 | `	int res = 0; /* Assume false by default */` |
|    214 |   65 | `	if( nArg > 0 ){` |
|    212 |   66 | `		res = ph7_value_is_int(apArg[0]);` |
|    105 |   67 | `	}` |
|      - |   68 | `	/* Query result */` |
|    214 |   69 | `	ph7_result_bool(pCtx,res);` |
|    214 |   70 | `	return PH7_OK;` |
|      2 |   71 |  |
|      - |   72 | `/*` |
...
|      - |  291 | ` */` |
|  23408 |  292 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  293 |  |
|  23410 |  294 | `	int res = 1; /* Assume empty by default */` |
|  23410 |  295 | `	if( nArg > 0 ){` |
|  23408 |  296 | `		res = ph7_value_is_empty(apArg[0]);` |
|  11703 |  297 | `	}` |
|  23410 |  298 | `	ph7_result_bool(pCtx,res);` |
|  23410 |  299 | `	return PH7_OK;` |
|      - |  300 |  |
|      2 |  301 |  |
...
|      - |  341 | ` */` |
| 170266 |  342 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  343 |  |
|      - |  344 | `	const char *zSource,*zOfft;` |
|      - |  345 | `	int nOfft,nLen,nSrcLen;` |
| 170268 |  346 | `	if( nArg < 2 ){` |
|      - |  347 | `		/* return FALSE */` |
|      5 |  348 | `		ph7_result_bool(pCtx,0);` |
|      5 |  349 | `		return PH7_OK;` |
|      - |  350 | `	}` |
|      - |  351 | `	/* Extract the target string */` |
| 170264 |  352 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 170264 |  353 | `	if( nSrcLen < 1 ){` |
|      - |  354 | `		/* Empty string,return FALSE */` |
|  10146 |  355 | `		ph7_result_bool(pCtx,0);` |
|  10146 |  356 | `		return PH7_OK;` |
|      - |  357 | `	}` |
| 160120 |  358 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  359 | `	/* Extract the offset */` |
| 160120 |  360 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 160120 |  361 | `	if( nOfft < 0 ){` |
|  26944 |  362 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  26944 |  363 | `		if( zOfft < zSource ){` |
|      - |  364 | `			/* Invalid offset */` |
|      5 |  365 | `			ph7_result_bool(pCtx,0);` |
|      5 |  366 | `			return PH7_OK;` |
|      - |  367 | `		}` |
|  26940 |  368 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  26940 |  369 | `		nOfft = (int)(zOfft-zSource);` |
| 146647 |  370 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  371 | `		/* Invalid offset */` |
|     78 |  372 | `		ph7_result_bool(pCtx,0);` |
|     78 |  373 | `		return PH7_OK;` |
|    ! 0 |  374 | `	}else{` |
| 133102 |  375 | `		zOfft = &zSource[nOfft];` |
| 133102 |  376 | `		nLen = nSrcLen - nOfft;` |
|      - |  377 | `	}` |
| 160040 |  378 | `	if( nArg > 2 ){` |
|      - |  379 | `		/* Extract the length */` |
| 132478 |  380 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 132478 |  381 | `		if( nLen == 0 ){` |
|      - |  382 | `			/* Invalid length,return an empty string */` |
|      5 |  383 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  384 | `			return PH7_OK;` |
| 132474 |  385 | `		}else if( nLen < 0 ){` |
|  26942 |  386 | `			nLen = nSrcLen + nLen - nOfft;` |
|  26942 |  387 | `			if( nLen < 1 ){` |
|      - |  388 | `				/* Invalid  length */` |
|      3 |  389 | `				nLen = nSrcLen - nOfft;` |
|      1 |  390 | `			}` |
|  13470 |  391 | `		}` |
| 132474 |  392 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  393 | `			/* Invalid length */` |
|   3732 |  394 | `			nLen = nSrcLen - nOfft;` |
|   1865 |  395 | `		}` |
|  66236 |  396 | `	}` |
|      - |  397 | `	/* Return the substring */` |
| 160036 |  398 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 160036 |  399 | `	return PH7_OK;` |
|  85135 |  400 |  |
|      - |  401 | `/*` |
...
|      - | 1368 | ` */` |
|   4070 | 1369 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1370 |  |
|   4072 | 1371 | `	int iLen = 0;` |
|   4072 | 1372 | `	if( nArg > 0 ){` |
|   4070 | 1373 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   2034 | 1374 | `	}` |
|      - | 1375 | `	/* String length */` |
|   4072 | 1376 | `	ph7_result_int(pCtx,iLen);` |
|   4072 | 1377 | `	return PH7_OK;` |
|      2 | 1378 |  |
|      - | 1379 | `/*` |
...
|      - | 1521 | ` */` |
| 109420 | 1522 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      2 | 1523 |  |
|  54710 | 1524 | `	SXUNUSED(pKey);` |
| 109422 | 1525 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1526 | `	const char *zData;` |
|      - | 1527 | `	int nLen;` |
| 109422 | 1528 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 109420 | 1545 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1546 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 109420 | 1547 | `	if( pData->bFirst ){` |
|  27200 | 1548 | `		pData->bFirst = 0;` |
|  95821 | 1549 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1550 | `		/* append the separator first */` |
|  82210 | 1551 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  41104 | 1552 | `	}` |
|      - | 1553 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
| 109420 | 1554 | `	if( nLen > 0 ){` |
|  99276 | 1555 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  49637 | 1556 | `	}` |
| 109420 | 1557 | `	return PH7_OK;` |
|  54712 | 1558 |  |
|      - | 1559 | `/*` |
...
|      - | 1571 | ` */` |
|  27222 | 1572 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1573 |  |
|      - | 1574 | `	struct implode_data imp_data;` |
|  27224 | 1575 | `	int i = 1;` |
|  27224 | 1576 | `	if( nArg < 1 ){` |
|      - | 1577 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1578 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1579 | `		return PH7_OK;` |
|      - | 1580 | `	}` |
|      - | 1581 | `	/* Prepare the implode context */` |
|  27224 | 1582 | `	imp_data.pCtx = pCtx;` |
|  27224 | 1583 | `	imp_data.bRecursive = 0;` |
|  27224 | 1584 | `	imp_data.bFirst = 1;` |
|  27224 | 1585 | `	imp_data.nRecCount = 0;` |
|  27224 | 1586 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  27222 | 1587 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  13612 | 1588 | `	}else{` |
|      3 | 1589 | `		imp_data.zSep = 0;` |
|      3 | 1590 | `		imp_data.nSeplen = 0;` |
|      3 | 1591 | `		i = 0;` |
|      - | 1592 | `	}` |
|  27224 | 1593 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 1594 | `	/* Start the 'join' process */` |
|  54446 | 1595 | `	while( i < nArg ){` |
|  27224 | 1596 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1597 | `			/* Iterate throw array entries */` |
|  27224 | 1598 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|  13613 | 1599 | `		}else{` |
...
|      - | 1706 | ` */` |
|   5098 | 1707 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1708 |  |
...
|   5092 | 1721 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   5092 | 1722 | `	if( nDelim < 1 ){` |
|      - | 1723 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1724 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1725 | `		return PH7_OK;` |
|      - | 1726 | `	}` |
|      - | 1727 | `	/* Extract the string */` |
|   5090 | 1728 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   5090 | 1729 | `	if( nStrlen < 1 ){` |
...
|   5088 | 1744 | `	zEnd = &zString[nStrlen];` |
|      - | 1745 | `	/* Create the array */` |
|   5088 | 1746 | `	pArray =  ph7_context_new_array(pCtx);` |
|   5088 | 1747 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   5088 | 1748 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1749 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1750 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1751 | `		return PH7_OK;` |
|      - | 1752 | `	}` |
|      - | 1753 | `	/* Set a defualt limit */` |
|   5088 | 1754 | `	iLimit = SXI32_HIGH;` |
|   5088 | 1755 | `	if( nArg > 2 ){` |
...
|  57861 | 1766 | `	for(;;){` |
| 115724 | 1767 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 115724 | 1768 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1769 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   5088 | 1770 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   5088 | 1771 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   5088 | 1772 | `			break;` |
|      - | 1773 | `		}` |
|      - | 1774 | `		/* Point to the desired offset */` |
| 110638 | 1775 | `		zCur = &zString[nOfft];` |
|      - | 1776 | `		/* Perform the store operation (may be empty) */` |
| 110638 | 1777 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 110638 | 1778 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 1779 | `		/* Point beyond the delimiter */` |
| 110638 | 1780 | `		zString = &zCur[nDelim];` |
|      - | 1781 | `		/* Reset the cursor */` |
| 110638 | 1782 | `		ph7_value_reset_string_cursor(pValue);` |
|      2 | 1783 | `	}` |
|      - | 1784 | `	/* Return the freshly created array */` |
|   5088 | 1785 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1786 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1787 | `	 * released as soon we return from this foregin function.` |
|      - | 1788 | `	 */` |
|   5088 | 1789 | `	return PH7_OK;` |
|   2551 | 1790 |  |
|      - | 1791 | `/*` |
...
|      - | 1805 | ` */` |
|  11798 | 1806 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1807 |  |
|      - | 1808 | `	const char *zString;` |
|      - | 1809 | `	int nLen;` |
|  11800 | 1810 | `	if( nArg < 1 ){` |
|      - | 1811 | `		/* Missing arguments,return null */` |
|      3 | 1812 | `		ph7_result_null(pCtx);` |
|      3 | 1813 | `		return PH7_OK;` |
|      - | 1814 | `	}` |
|      - | 1815 | `	/* Extract the target string */` |
|  11798 | 1816 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  11798 | 1817 | `	if( nLen < 1 ){` |
|      - | 1818 | `		/* Empty string,return */` |
|   1614 | 1819 | `		ph7_result_string(pCtx,"",0);` |
|   1614 | 1820 | `		return PH7_OK;` |
|      - | 1821 | `	}` |
|      - | 1822 | `	/* Start the trim process */` |
|  10186 | 1823 | `	if( nArg < 2 ){` |
|      - | 1824 | `		SyString sStr;` |
|      - | 1825 | `		/* Remove white spaces and NUL bytes */` |
|  10182 | 1826 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  24702 | 1827 | `		SyStringFullTrimSafe(&sStr);` |
|  10182 | 1828 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   5092 | 1829 | `	}else{` |
|      - | 1830 | `		/* Char list */` |
...
|    ! 0 | 2080 | `		}else{` |
| 142832 | 2081 | `			int c = zString[0];` |
| 142832 | 2082 | `			if( SyisUpper(c) ){` |
| 142830 | 2083 | `				c = SyToLower(zString[0]);` |
|  71414 | 2084 | `			}` |
|      - | 2085 | `			/* Append character */` |
| 142832 | 2086 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2087 | `			/* Advance the cursor */` |
| 142832 | 2088 | `			zString++;` |
|      - | 2089 | `		}` |
|      2 | 2090 | `	}` |
|  26940 | 2091 | `	return PH7_OK;` |
|  13473 | 2092 |  |
|      - | 2093 | `/*` |
...
|      - | 5497 | ` */` |
|  20234 | 5498 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5499 |  |
...
|      - | 5508 | `	int nByte;` |
|      - | 5509 | `	sxi32 rc;` |
|  20236 | 5510 | `	if( nArg < 3 ){` |
|      - | 5511 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 5512 | `		ph7_result_null(pCtx);` |
|      7 | 5513 | `		return PH7_OK;` |
|      - | 5514 | `	}` |
|      - | 5515 | `	/* Initialize fields */` |
|  20230 | 5516 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  20230 | 5517 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  20230 | 5518 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  20230 | 5519 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  20230 | 5520 | `	sRep.pCtx = pCtx;` |
|  20230 | 5521 | `	sRep.pCollector = &sSearch;` |
|  20230 | 5522 | `	rep_str = 0;` |
|      - | 5523 | `	/* Extract the subject */` |
|  20230 | 5524 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  20230 | 5525 | `	if( nByte < 1 ){` |
...
|  20202 | 5531 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 5532 | `	/* Search string */` |
|  20202 | 5533 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 5534 | `		/* Collect search string */` |
|      9 | 5535 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 5536 | `	}else{` |
|      - | 5537 | `		/* Single pattern */` |
|  20194 | 5538 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  20194 | 5539 | `		if( nByte < 1 ){` |
...
|      - | 5543 | `		}` |
|  20190 | 5544 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5545 | `		/* Save for later processing */` |
|  20190 | 5546 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 5547 | `	}` |
|      - | 5548 | `	/* Replace string */` |
|  20198 | 5549 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 5550 | `		/* Collect replace string */` |
|      7 | 5551 | `		sRep.pCollector = &sReplace;` |
|      7 | 5552 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 5553 | `	}else{` |
|      - | 5554 | `		/* Single needle */` |
|  20192 | 5555 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  20192 | 5556 | `		rep_str = 1;` |
|  20192 | 5557 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5558 | `		/* Save for later processing */` |
|  20192 | 5559 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 5560 | `	}` |
|      - | 5561 | `	/* Reset loop cursors */` |
|  20198 | 5562 | `	SySetResetCursor(&sSearch);` |
|  20198 | 5563 | `	SySetResetCursor(&sReplace);` |
|  20198 | 5564 | `	pReplace = pSearch = 0; /* cc warning */` |
|  20198 | 5565 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5566 | `	/* Extract function name */` |
|  20198 | 5567 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5568 | `	/* Set the default pattern match routine */` |
|  20198 | 5569 | `	xMatch = SyBlobSearch;` |
|  20198 | 5570 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5571 | `		/* Case insensitive pattern match */` |
|     11 | 5572 | `		xMatch = iPatternMatch;` |
|      5 | 5573 | `	}` |
|      - | 5574 | `	/* Start the replace process */` |
|  40402 | 5575 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5576 | `		sxu32 nCount,nOfft;` |
|  20206 | 5577 | `		if( pSearch->nByte <  1 ){` |
|      - | 5578 | `			/* Empty string,ignore */` |
|      3 | 5579 | `			continue;` |
|      - | 5580 | `		}` |
|      - | 5581 | `		/* Extract the replace string */` |
|  20204 | 5582 | `		if( rep_str ){` |
|  20194 | 5583 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  10098 | 5584 | `		}else{` |
...
|      1 | 5590 | `			}` |
|      - | 5591 | `		}` |
|  20204 | 5592 | `		if( pReplace == 0 ){` |
|      - | 5593 | `			/* Use an empty string instead */` |
|      3 | 5594 | `			pReplace = &sTemp;` |
|      1 | 5595 | `		}` |
|  20204 | 5596 | `		nOfft = nCount = 0;` |
|  10117 | 5597 | `		for(;;){` |
|  20236 | 5598 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 5599 | `				break;` |
|      - | 5600 | `			}` |
|      - | 5601 | `			/* Perform a pattern lookup */` |
|  30335 | 5602 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  20222 | 5603 | `				pSearch->nByte,&nOfft);` |
|  20224 | 5604 | `			if( rc != SXRET_OK ){` |
...
|  20198 | 5615 | `	ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  20198 | 5616 | `	SySetRelease(&sSearch);` |
|  20198 | 5617 | `	SySetRelease(&sReplace);` |
|  20198 | 5618 | `	SyBlobRelease(&sWorker);` |
|  20198 | 5619 | `	return PH7_OK;` |
|  10119 | 5620 |  |
|      - | 5621 | `/*` |
...
|      - | 6327 | ` */` |
|  57520 | 6328 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6329 |  |
|      - | 6330 | `	const unsigned char *zIn,*zEnd;` |
|      - | 6331 | `	int nLen;` |
|  57522 | 6332 | `	if( nArg < 1 ){` |
|      - | 6333 | `		/* Missing arguments,return FALSE */` |
|      3 | 6334 | `		ph7_result_bool(pCtx,0);` |
|      3 | 6335 | `		return PH7_OK;` |
|      - | 6336 | `	}` |
|      - | 6337 | `	/* Extract the target string */` |
|  57520 | 6338 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  57520 | 6339 | `	zEnd = &zIn[nLen];` |
|  57520 | 6340 | `	if( nLen < 1 ){` |
...
|  29761 | 6346 | `	for(;;){` |
|  59480 | 6347 | `		if( zIn >= zEnd ){` |
|      - | 6348 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1940 | 6349 | `			ph7_result_bool(pCtx,1);` |
|   1940 | 6350 | `			return PH7_OK;` |
|      - | 6351 | `		}` |
|  57542 | 6352 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 6353 | `			/* UTF-8 stream  */` |
|    ! 0 | 6354 | `			break;` |
|      - | 6355 | `		}` |
|  57542 | 6356 | `		if( !SyisSpace(zIn[0]) ){` |
|  55580 | 6357 | `			break;` |
|      - | 6358 | `		}` |
...
|  55580 | 6363 | `	ph7_result_bool(pCtx,0);` |
|  55580 | 6364 | `	return PH7_OK;` |
|  28784 | 6365 |  |
|      - | 6366 | `/*` |
...
|      - | 6784 | ` */` |
|   2600 | 6785 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      2 | 6786 |  |
|      - | 6787 | `	sxu32 n;` |
| 403002 | 6788 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 400402 | 6789 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 200202 | 6790 | `	}` |
|      - | 6791 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   2602 | 6792 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 6793 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   2602 | 6794 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   2602 | 6795 |  |
|      - | 6796 |  |
