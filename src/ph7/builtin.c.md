...
|      - |  291 | ` */` |
|  21620 |  292 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  293 |  |
|  21622 |  294 | `	int res = 1; /* Assume empty by default */` |
|  21622 |  295 | `	if( nArg > 0 ){` |
|  21620 |  296 | `		res = ph7_value_is_empty(apArg[0]);` |
|  10809 |  297 | `	}` |
|  21622 |  298 | `	ph7_result_bool(pCtx,res);` |
|  21622 |  299 | `	return PH7_OK;` |
|      - |  300 |  |
|      2 |  301 |  |
...
|      - |  341 | ` */` |
| 154986 |  342 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  343 |  |
|      - |  344 | `	const char *zSource,*zOfft;` |
|      - |  345 | `	int nOfft,nLen,nSrcLen;` |
| 154988 |  346 | `	if( nArg < 2 ){` |
|      - |  347 | `		/* return FALSE */` |
|      5 |  348 | `		ph7_result_bool(pCtx,0);` |
|      5 |  349 | `		return PH7_OK;` |
|      - |  350 | `	}` |
|      - |  351 | `	/* Extract the target string */` |
| 154984 |  352 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 154984 |  353 | `	if( nSrcLen < 1 ){` |
|      - |  354 | `		/* Empty string,return FALSE */` |
|   9554 |  355 | `		ph7_result_bool(pCtx,0);` |
|   9554 |  356 | `		return PH7_OK;` |
|      - |  357 | `	}` |
| 145432 |  358 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  359 | `	/* Extract the offset */` |
| 145432 |  360 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 145432 |  361 | `	if( nOfft < 0 ){` |
|  24698 |  362 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  24698 |  363 | `		if( zOfft < zSource ){` |
|      - |  364 | `			/* Invalid offset */` |
|      5 |  365 | `			ph7_result_bool(pCtx,0);` |
|      5 |  366 | `			return PH7_OK;` |
|      - |  367 | `		}` |
|  24694 |  368 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  24694 |  369 | `		nOfft = (int)(zOfft-zSource);` |
| 133082 |  370 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  371 | `		/* Invalid offset */` |
|      7 |  372 | `		ph7_result_bool(pCtx,0);` |
|      7 |  373 | `		return PH7_OK;` |
|    ! 0 |  374 | `	}else{` |
| 120730 |  375 | `		zOfft = &zSource[nOfft];` |
| 120730 |  376 | `		nLen = nSrcLen - nOfft;` |
|      - |  377 | `	}` |
| 145422 |  378 | `	if( nArg > 2 ){` |
|      - |  379 | `		/* Extract the length */` |
| 120728 |  380 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 120728 |  381 | `		if( nLen == 0 ){` |
|      - |  382 | `			/* Invalid length,return an empty string */` |
|      5 |  383 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  384 | `			return PH7_OK;` |
| 120724 |  385 | `		}else if( nLen < 0 ){` |
|  24696 |  386 | `			nLen = nSrcLen + nLen - nOfft;` |
|  24696 |  387 | `			if( nLen < 1 ){` |
|      - |  388 | `				/* Invalid  length */` |
|      3 |  389 | `				nLen = nSrcLen - nOfft;` |
|      1 |  390 | `			}` |
|  12347 |  391 | `		}` |
| 120724 |  392 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  393 | `			/* Invalid length */` |
|   3266 |  394 | `			nLen = nSrcLen - nOfft;` |
|   1632 |  395 | `		}` |
|  60361 |  396 | `	}` |
|      - |  397 | `	/* Return the substring */` |
| 145418 |  398 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 145418 |  399 | `	return PH7_OK;` |
|  77495 |  400 |  |
|      - |  401 | `/*` |
...
|      - | 1368 | ` */` |
|   2666 | 1369 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1370 |  |
|   2668 | 1371 | `	int iLen = 0;` |
|   2668 | 1372 | `	if( nArg > 0 ){` |
|   2666 | 1373 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   1332 | 1374 | `	}` |
|      - | 1375 | `	/* String length */` |
|   2668 | 1376 | `	ph7_result_int(pCtx,iLen);` |
|   2668 | 1377 | `	return PH7_OK;` |
|      2 | 1378 |  |
|      - | 1379 | `/*` |
...
|      - | 1521 | ` */` |
| 101548 | 1522 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      2 | 1523 |  |
|  50774 | 1524 | `	SXUNUSED(pKey);` |
| 101550 | 1525 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1526 | `	const char *zData;` |
|      - | 1527 | `	int nLen;` |
| 101550 | 1528 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 101548 | 1545 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1546 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 101548 | 1547 | `	if( pData->bFirst ){` |
|  24942 | 1548 | `		pData->bFirst = 0;` |
|  89078 | 1549 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1550 | `		/* append the separator first */` |
|  76596 | 1551 | `		ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen);` |
|  38297 | 1552 | `	}` |
|      - | 1553 | `	/* Append the value if non-empty; empty values are represented by the separators */` |
| 101548 | 1554 | `	if( nLen > 0 ){` |
|  91996 | 1555 | `		ph7_result_string(pData->pCtx,zData,nLen);` |
|  45997 | 1556 | `	}` |
| 101548 | 1557 | `	return PH7_OK;` |
|  50776 | 1558 |  |
|      - | 1559 | `/*` |
...
|      - | 1571 | ` */` |
|  24968 | 1572 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1573 |  |
|      - | 1574 | `	struct implode_data imp_data;` |
|  24970 | 1575 | `	int i = 1;` |
|  24970 | 1576 | `	if( nArg < 1 ){` |
|      - | 1577 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1578 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1579 | `		return PH7_OK;` |
|      - | 1580 | `	}` |
|      - | 1581 | `	/* Prepare the implode context */` |
|  24970 | 1582 | `	imp_data.pCtx = pCtx;` |
|  24970 | 1583 | `	imp_data.bRecursive = 0;` |
|  24970 | 1584 | `	imp_data.bFirst = 1;` |
|  24970 | 1585 | `	imp_data.nRecCount = 0;` |
|  24970 | 1586 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  24968 | 1587 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  12485 | 1588 | `	}else{` |
|      3 | 1589 | `		imp_data.zSep = 0;` |
|      3 | 1590 | `		imp_data.nSeplen = 0;` |
|      3 | 1591 | `		i = 0;` |
|      - | 1592 | `	}` |
|  24970 | 1593 | `	ph7_result_string(pCtx,"",0); /* Set an empty stirng */` |
|      - | 1594 | `	/* Start the 'join' process */` |
|  49938 | 1595 | `	while( i < nArg ){` |
|  24970 | 1596 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1597 | `			/* Iterate throw array entries */` |
|  24970 | 1598 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|  12486 | 1599 | `		}else{` |
...
|      - | 1706 | ` */` |
|   4648 | 1707 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1708 |  |
...
|   4642 | 1721 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   4642 | 1722 | `	if( nDelim < 1 ){` |
|      - | 1723 | `		/* Empty delimiter,return FALSE */` |
|      3 | 1724 | `		ph7_result_bool(pCtx,0);` |
|      3 | 1725 | `		return PH7_OK;` |
|      - | 1726 | `	}` |
|      - | 1727 | `	/* Extract the string */` |
|   4640 | 1728 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   4640 | 1729 | `	if( nStrlen < 1 ){` |
...
|   4638 | 1744 | `	zEnd = &zString[nStrlen];` |
|      - | 1745 | `	/* Create the array */` |
|   4638 | 1746 | `	pArray =  ph7_context_new_array(pCtx);` |
|   4638 | 1747 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   4638 | 1748 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1749 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1750 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1751 | `		return PH7_OK;` |
|      - | 1752 | `	}` |
|      - | 1753 | `	/* Set a defualt limit */` |
|   4638 | 1754 | `	iLimit = SXI32_HIGH;` |
|   4638 | 1755 | `	if( nArg > 2 ){` |
...
|  52813 | 1766 | `	for(;;){` |
| 105628 | 1767 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 105628 | 1768 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1769 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   4638 | 1770 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   4638 | 1771 | `			ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|   4638 | 1772 | `			break;` |
|      - | 1773 | `		}` |
|      - | 1774 | `		/* Point to the desired offset */` |
| 100992 | 1775 | `		zCur = &zString[nOfft];` |
|      - | 1776 | `		/* Perform the store operation (may be empty) */` |
| 100992 | 1777 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 100992 | 1778 | `		ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue);` |
|      - | 1779 | `		/* Point beyond the delimiter */` |
| 100992 | 1780 | `		zString = &zCur[nDelim];` |
|      - | 1781 | `		/* Reset the cursor */` |
| 100992 | 1782 | `		ph7_value_reset_string_cursor(pValue);` |
|      2 | 1783 | `	}` |
|      - | 1784 | `	/* Return the freshly created array */` |
|   4638 | 1785 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1786 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1787 | `	 * released as soon we return from this foregin function.` |
|      - | 1788 | `	 */` |
|   4638 | 1789 | `	return PH7_OK;` |
|   2326 | 1790 |  |
|      - | 1791 | `/*` |
...
|      - | 1805 | ` */` |
|  10904 | 1806 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 1807 |  |
|      - | 1808 | `	const char *zString;` |
|      - | 1809 | `	int nLen;` |
|  10906 | 1810 | `	if( nArg < 1 ){` |
|      - | 1811 | `		/* Missing arguments,return null */` |
|      3 | 1812 | `		ph7_result_null(pCtx);` |
|      3 | 1813 | `		return PH7_OK;` |
|      - | 1814 | `	}` |
|      - | 1815 | `	/* Extract the target string */` |
|  10904 | 1816 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  10904 | 1817 | `	if( nLen < 1 ){` |
|      - | 1818 | `		/* Empty string,return */` |
|   1628 | 1819 | `		ph7_result_string(pCtx,"",0);` |
|   1628 | 1820 | `		return PH7_OK;` |
|      - | 1821 | `	}` |
|      - | 1822 | `	/* Start the trim process */` |
|   9278 | 1823 | `	if( nArg < 2 ){` |
|      - | 1824 | `		SyString sStr;` |
|      - | 1825 | `		/* Remove white spaces and NUL bytes */` |
|   9274 | 1826 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  22432 | 1827 | `		SyStringFullTrimSafe(&sStr);` |
|   9274 | 1828 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   4638 | 1829 | `	}else{` |
|      - | 1830 | `		/* Char list */` |
...
|    ! 0 | 2080 | `		}else{` |
| 131044 | 2081 | `			int c = zString[0];` |
| 131044 | 2082 | `			if( SyisUpper(c) ){` |
| 131042 | 2083 | `				c = SyToLower(zString[0]);` |
|  65520 | 2084 | `			}` |
|      - | 2085 | `			/* Append character */` |
| 131044 | 2086 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2087 | `			/* Advance the cursor */` |
| 131044 | 2088 | `			zString++;` |
|      - | 2089 | `		}` |
|      2 | 2090 | `	}` |
|  24694 | 2091 | `	return PH7_OK;` |
|  12350 | 2092 |  |
|      - | 2093 | `/*` |
...
|      - | 2101 | ` */` |
|     28 | 2102 | `static int PH7_builtin_strtoupper(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2103 |  |
...
|     28 | 2112 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|     28 | 2113 | `	if( nLen < 1 ){` |
...
|     26 | 2119 | `	zEnd = &zString[nLen];` |
|     72 | 2120 | `	for(;;){` |
|    146 | 2121 | `		if( zString >= zEnd ){` |
|      - | 2122 | `			/* No more input,break immediately */` |
|     26 | 2123 | `			break;` |
|      - | 2124 | `		}` |
|    122 | 2125 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2134 | `		}else{` |
|    122 | 2135 | `			int c = zString[0];` |
|    122 | 2136 | `			if( SyisLower(c) ){` |
|    116 | 2137 | `				c = SyToUpper(zString[0]);` |
|     57 | 2138 | `			}` |
|      - | 2139 | `			/* Append character */` |
|    122 | 2140 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2141 | `			/* Advance the cursor */` |
|    122 | 2142 | `			zString++;` |
|      - | 2143 | `		}` |
|      2 | 2144 | `	}` |
|     26 | 2145 | `	return PH7_OK;` |
|     16 | 2146 |  |
|      - | 2147 | `/*` |
...
|      - | 2579 | ` */` |
|    112 | 2580 | `static int PH7_builtin_strpos(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 2581 |  |
|    114 | 2582 | `	ProcStringMatch xPatternMatch = SyBlobSearch; /* Case-sensitive pattern match */` |
...
|    108 | 2593 | `	zBlob = ph7_value_to_string(apArg[0],&nLen);` |
|    108 | 2594 | `	zPattern = ph7_value_to_string(apArg[1],&nPatLen);` |
|    108 | 2595 | `	nOfft = 0; /* cc warning */` |
|    108 | 2596 | `	nStart = 0;` |
...
|      - | 2609 | `		}` |
|    ! 0 | 2610 | `	}` |
|    108 | 2611 | `	if( nLen > 0 && nPatLen > 0 ){` |
|      - | 2612 | `		/* Perform the lookup */` |
|    106 | 2613 | `		rc = xPatternMatch(zBlob,(sxu32)nLen,zPattern,(sxu32)nPatLen,&nOfft);` |
|    106 | 2614 | `		if( rc != SXRET_OK ){` |
|      - | 2615 | `			/* Pattern not found,return FALSE */` |
|     18 | 2616 | `			ph7_result_bool(pCtx,0);` |
|     18 | 2617 | `			return PH7_OK;` |
|      - | 2618 | `		}` |
...
|      - | 3026 | ` */` |
|  20212 | 3027 | `static int PH7_builtin_str_repeat(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      1 | 3028 |  |
|      - | 3029 | `	const char *zIn;` |
|      - | 3030 | `	int nLen,nMul;` |
|      - | 3031 | `	int rc;` |
|  20213 | 3032 | `	if( nArg < 2 ){` |
|      - | 3033 | `		/* Missing arguments,return NULL */` |
|      3 | 3034 | `		ph7_result_null(pCtx);` |
|      3 | 3035 | `		return PH7_OK;` |
|      - | 3036 | `	}` |
|      - | 3037 | `	/* Extract the target string */` |
|  20211 | 3038 | `	zIn = ph7_value_to_string(apArg[0],&nLen);` |
|  20211 | 3039 | `	if( nLen < 1 ){` |
|      - | 3040 | `		/* Empty string.Return null */` |
|    ! 0 | 3041 | `		ph7_result_null(pCtx);` |
|    ! 0 | 3042 | `		return PH7_OK;` |
|      - | 3043 | `	}` |
|      - | 3044 | `	/* Extract the multiplier */` |
|  20211 | 3045 | `	nMul = ph7_value_to_int(apArg[1]);` |
|  20211 | 3046 | `	if( nMul < 1 ){` |
...
| 220233 | 3057 | `		rc = ph7_result_string(pCtx,zIn,nLen);` |
| 220233 | 3058 | `		if( rc != PH7_OK ){` |
|      - | 3059 | `			/* Out of memory,break immediately */` |
|    ! 0 | 3060 | `			break;` |
|      - | 3061 | `		}` |
| 220233 | 3062 | `		nMul--;` |
|      1 | 3063 | `	}` |
|  20209 | 3064 | `	return PH7_OK;` |
|  10107 | 3065 |  |
|      - | 3066 | `/*` |
...
|      - | 5497 | ` */` |
|  18434 | 5498 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 5499 |  |
...
|      - | 5508 | `	int nByte;` |
|      - | 5509 | `	sxi32 rc;` |
|  18436 | 5510 | `	if( nArg < 3 ){` |
|      - | 5511 | `		/* Missing/Invalid arguments,return null */` |
|      7 | 5512 | `		ph7_result_null(pCtx);` |
|      7 | 5513 | `		return PH7_OK;` |
|      - | 5514 | `	}` |
|      - | 5515 | `	/* Initialize fields */` |
|  18430 | 5516 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  18430 | 5517 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  18430 | 5518 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  18430 | 5519 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  18430 | 5520 | `	sRep.pCtx = pCtx;` |
|  18430 | 5521 | `	sRep.pCollector = &sSearch;` |
|  18430 | 5522 | `	rep_str = 0;` |
|      - | 5523 | `	/* Extract the subject */` |
|  18430 | 5524 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  18430 | 5525 | `	if( nByte < 1 ){` |
|      - | 5526 | `		/* Nothing to replace,return the empty string */` |
|     38 | 5527 | `		ph7_result_string(pCtx,"",0);` |
|     38 | 5528 | `		return PH7_OK;` |
|      - | 5529 | `	}` |
|      - | 5530 | `	/* Copy the subject */` |
|  18394 | 5531 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 5532 | `	/* Search string */` |
|  18394 | 5533 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 5534 | `		/* Collect search string */` |
|      9 | 5535 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 5536 | `	}else{` |
|      - | 5537 | `		/* Single pattern */` |
|  18386 | 5538 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  18386 | 5539 | `		if( nByte < 1 ){` |
...
|      - | 5543 | `		}` |
|  18382 | 5544 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5545 | `		/* Save for later processing */` |
|  18382 | 5546 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 5547 | `	}` |
|      - | 5548 | `	/* Replace string */` |
|  18390 | 5549 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 5550 | `		/* Collect replace string */` |
|      7 | 5551 | `		sRep.pCollector = &sReplace;` |
|      7 | 5552 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 5553 | `	}else{` |
|      - | 5554 | `		/* Single needle */` |
|  18384 | 5555 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  18384 | 5556 | `		rep_str = 1;` |
|  18384 | 5557 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 5558 | `		/* Save for later processing */` |
|  18384 | 5559 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 5560 | `	}` |
|      - | 5561 | `	/* Reset loop cursors */` |
|  18390 | 5562 | `	SySetResetCursor(&sSearch);` |
|  18390 | 5563 | `	SySetResetCursor(&sReplace);` |
|  18390 | 5564 | `	pReplace = pSearch = 0; /* cc warning */` |
|  18390 | 5565 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 5566 | `	/* Extract function name */` |
|  18390 | 5567 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 5568 | `	/* Set the default pattern match routine */` |
|  18390 | 5569 | `	xMatch = SyBlobSearch;` |
|  18390 | 5570 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 5571 | `		/* Case insensitive pattern match */` |
|     11 | 5572 | `		xMatch = iPatternMatch;` |
|      5 | 5573 | `	}` |
|      - | 5574 | `	/* Start the replace process */` |
|  36786 | 5575 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 5576 | `		sxu32 nCount,nOfft;` |
|  18398 | 5577 | `		if( pSearch->nByte <  1 ){` |
|      - | 5578 | `			/* Empty string,ignore */` |
|      3 | 5579 | `			continue;` |
|      - | 5580 | `		}` |
|      - | 5581 | `		/* Extract the replace string */` |
|  18396 | 5582 | `		if( rep_str ){` |
|  18386 | 5583 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|   9194 | 5584 | `		}else{` |
...
|      1 | 5590 | `			}` |
|      - | 5591 | `		}` |
|  18396 | 5592 | `		if( pReplace == 0 ){` |
|      - | 5593 | `			/* Use an empty string instead */` |
|      3 | 5594 | `			pReplace = &sTemp;` |
|      1 | 5595 | `		}` |
|  18396 | 5596 | `		nOfft = nCount = 0;` |
|   9213 | 5597 | `		for(;;){` |
|  18428 | 5598 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 5599 | `				break;` |
|      - | 5600 | `			}` |
|      - | 5601 | `			/* Perform a pattern lookup */` |
|  27623 | 5602 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  18414 | 5603 | `				pSearch->nByte,&nOfft);` |
|  18416 | 5604 | `			if( rc != SXRET_OK ){` |
...
|  18390 | 5615 | `	ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  18390 | 5616 | `	SySetRelease(&sSearch);` |
|  18390 | 5617 | `	SySetRelease(&sReplace);` |
|  18390 | 5618 | `	SyBlobRelease(&sWorker);` |
|  18390 | 5619 | `	return PH7_OK;` |
|   9219 | 5620 |  |
|      - | 5621 | `/*` |
...
|      - | 6085 | ` */` |
|   1488 | 6086 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6087 |  |
...
|   1488 | 6096 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   1488 | 6097 | `	zEnd = &zIn[nLen];` |
|   1488 | 6098 | `	if( nLen < 1 ){` |
...
|   1398 | 6104 | `	for(;;){` |
|   2798 | 6105 | `		if( zIn >= zEnd ){` |
|      - | 6106 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1282 | 6107 | `			ph7_result_bool(pCtx,1);` |
|   1282 | 6108 | `			return PH7_OK;` |
|      - | 6109 | `		}` |
|   1518 | 6110 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 6111 | `			/* UTF-8 stream  */` |
|    ! 0 | 6112 | `			break;` |
|      - | 6113 | `		}` |
|   1518 | 6114 | `		if( !SyisDigit(zIn[0]) ){` |
|    206 | 6115 | `			break;` |
|      - | 6116 | `		}` |
...
|    206 | 6121 | `	ph7_result_bool(pCtx,0);` |
|    206 | 6122 | `	return PH7_OK;` |
|    746 | 6123 |  |
|      - | 6124 | `/*` |
...
|      - | 6327 | ` */` |
|  55856 | 6328 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 | 6329 |  |
|      - | 6330 | `	const unsigned char *zIn,*zEnd;` |
|      - | 6331 | `	int nLen;` |
|  55858 | 6332 | `	if( nArg < 1 ){` |
|      - | 6333 | `		/* Missing arguments,return FALSE */` |
|      3 | 6334 | `		ph7_result_bool(pCtx,0);` |
|      3 | 6335 | `		return PH7_OK;` |
|      - | 6336 | `	}` |
|      - | 6337 | `	/* Extract the target string */` |
|  55856 | 6338 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  55856 | 6339 | `	zEnd = &zIn[nLen];` |
|  55856 | 6340 | `	if( nLen < 1 ){` |
...
|  28880 | 6346 | `	for(;;){` |
|  57718 | 6347 | `		if( zIn >= zEnd ){` |
|      - | 6348 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1842 | 6349 | `			ph7_result_bool(pCtx,1);` |
|   1842 | 6350 | `			return PH7_OK;` |
|      - | 6351 | `		}` |
|  55878 | 6352 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 6353 | `			/* UTF-8 stream  */` |
|    ! 0 | 6354 | `			break;` |
|      - | 6355 | `		}` |
|  55878 | 6356 | `		if( !SyisSpace(zIn[0]) ){` |
|  54014 | 6357 | `			break;` |
|      - | 6358 | `		}` |
...
|  54014 | 6363 | `	ph7_result_bool(pCtx,0);` |
|  54014 | 6364 | `	return PH7_OK;` |
|  27952 | 6365 |  |
|      - | 6366 | `/*` |
...
|      - | 6784 | ` */` |
|   2358 | 6785 | `PH7_PRIVATE void PH7_RegisterBuiltInFunction(ph7_vm *pVm)` |
|      2 | 6786 |  |
|      - | 6787 | `	sxu32 n;` |
| 365492 | 6788 | `	for( n = 0 ; n < SX_ARRAYSIZE(aBuiltInFunc) ; ++n ){` |
| 363134 | 6789 | `		ph7_create_function(&(*pVm),aBuiltInFunc[n].zName,aBuiltInFunc[n].xFunc,0);` |
| 181568 | 6790 | `	}` |
|      - | 6791 | `	/* Register hashmap functions [i.e: array_merge(),sort(),count(),array_diff(),...] */` |
|   2360 | 6792 | `	PH7_RegisterHashmapFunctions(&(*pVm));` |
|      - | 6793 | `	/* Register IO functions [i.e: fread(),fwrite(),chdir(),mkdir(),file(),...] */` |
|   2360 | 6794 | `	PH7_RegisterIORoutine(&(*pVm));` |
|   2360 | 6795 |  |
|      - | 6796 |  |
