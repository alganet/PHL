...
|      - |  300 | ` */` |
|  33168 |  301 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  302 | `{` |
|  33173 |  303 | `	int res = 1; /* Assume empty by default */` |
|  33173 |  304 | `	if( nArg > 0 ){` |
|  33171 |  305 | `		res = ph7_value_is_empty(apArg[0]);` |
|  16583 |  306 | `	}` |
|  33173 |  307 | `	ph7_result_bool(pCtx,res);` |
|  33173 |  308 | `	return PH7_OK;` |
|      - |  309 |  |
|      5 |  310 | `}` |
...
|      - |  350 | ` */` |
| 212692 |  351 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  352 | `{` |
|      - |  353 | `	const char *zSource,*zOfft;` |
|      - |  354 | `	int nOfft,nLen,nSrcLen;` |
| 212697 |  355 | `	if( nArg < 2 ){` |
|      - |  356 | `		/* return FALSE */` |
|    ! 0 |  357 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  358 | `		return PH7_OK;` |
|      - |  359 | `	}` |
|      - |  360 | `	/* Extract the target string */` |
| 212697 |  361 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 212697 |  362 | `	if( nSrcLen < 1 ){` |
|      - |  363 | `		/* Empty string,return FALSE */` |
|  11709 |  364 | `		ph7_result_bool(pCtx,0);` |
|  11709 |  365 | `		return PH7_OK;` |
|      - |  366 | `	}` |
| 200993 |  367 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  368 | `	/* Extract the offset */` |
| 200993 |  369 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 200993 |  370 | `	if( nOfft < 0 ){` |
|  31933 |  371 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  31933 |  372 | `		if( zOfft < zSource ){` |
|      - |  373 | `			/* Invalid offset */` |
|      5 |  374 | `			ph7_result_bool(pCtx,0);` |
|      5 |  375 | `			return PH7_OK;` |
|      - |  376 | `		}` |
|  31929 |  377 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  31929 |  378 | `		nOfft = (int)(zOfft-zSource);` |
| 185027 |  379 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  380 | `		/* Invalid offset */` |
|    195 |  381 | `		ph7_result_bool(pCtx,0);` |
|    195 |  382 | `		return PH7_OK;` |
|    ! 0 |  383 | `	}else{` |
| 168875 |  384 | `		zOfft = &zSource[nOfft];` |
| 168875 |  385 | `		nLen = nSrcLen - nOfft;` |
|      - |  386 | `	}` |
| 200799 |  387 | `	if( nArg > 2 ){` |
|      - |  388 | `		/* Extract the length */` |
| 165557 |  389 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 165557 |  390 | `		if( nLen == 0 ){` |
|      - |  391 | `			/* Invalid length,return an empty string */` |
|      5 |  392 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  393 | `			return PH7_OK;` |
| 165553 |  394 | `		}else if( nLen < 0 ){` |
|  31921 |  395 | `			nLen = nSrcLen + nLen - nOfft;` |
|  31921 |  396 | `			if( nLen < 1 ){` |
|      - |  397 | `				/* Invalid  length */` |
|      3 |  398 | `				nLen = nSrcLen - nOfft;` |
|      1 |  399 | `			}` |
|  15958 |  400 | `		}` |
| 165553 |  401 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  402 | `			/* Invalid length */` |
|   5147 |  403 | `			nLen = nSrcLen - nOfft;` |
|   2571 |  404 | `		}` |
|  82774 |  405 | `	}` |
|      - |  406 | `	/* Return the substring */` |
| 200795 |  407 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 200795 |  408 | `	return PH7_OK;` |
| 106351 |  409 | `}` |
|      - |  410 | `/*` |
...
|      - | 1329 | ` */` |
| 134470 | 1330 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1331 | `{` |
|  67235 | 1332 | `	SXUNUSED(pKey);` |
| 134475 | 1333 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1334 | `	const char *zData;` |
|      - | 1335 | `	int nLen;` |
| 134475 | 1336 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 134473 | 1360 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1361 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 134473 | 1362 | `	if( pData->bFirst ){` |
|  32301 | 1363 | `		pData->bFirst = 0;` |
| 118325 | 1364 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1365 | `		/* append the separator first */` |
| 102165 | 1366 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 134473 | 1372 | `	if( nLen > 0 ){` |
| 122769 | 1373 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1374 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1375 | `			return PH7_ABORT;` |
|      - | 1376 | `		}` |
|  61382 | 1377 | `	}` |
| 134473 | 1378 | `	return PH7_OK;` |
|  67240 | 1379 | `}` |
|      - | 1380 | `/*` |
...
|      - | 1392 | ` */` |
|  32318 | 1393 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1394 | `{` |
|      - | 1395 | `	struct implode_data imp_data;` |
|  32323 | 1396 | `	int i = 1;` |
|  32323 | 1397 | `	if( nArg < 1 ){` |
|      - | 1398 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1399 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1400 | `		return PH7_OK;` |
|      - | 1401 | `	}` |
|      - | 1402 | `	/* Prepare the implode context */` |
|  32323 | 1403 | `	imp_data.pCtx = pCtx;` |
|  32323 | 1404 | `	imp_data.bRecursive = 0;` |
|  32323 | 1405 | `	imp_data.bFirst = 1;` |
|  32323 | 1406 | `	imp_data.nRecCount = 0;` |
|  32323 | 1407 | `	imp_data.rc = SXRET_OK;` |
|  32323 | 1408 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  32321 | 1409 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16163 | 1410 | `	}else{` |
|      3 | 1411 | `		imp_data.zSep = 0;` |
|      3 | 1412 | `		imp_data.nSeplen = 0;` |
|      3 | 1413 | `		i = 0;` |
|      - | 1414 | `	}` |
|  32323 | 1415 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1416 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1417 | `	}` |
|      - | 1418 | `	/* Start the 'join' process */` |
|  64641 | 1419 | `	while( i < nArg ){` |
|  32323 | 1420 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1421 | `			/* Iterate throw array entries */` |
|  32323 | 1422 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1423 | `			/* Surface a callback allocation failure as a fatal */` |
|  32323 | 1424 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 1549 | ` */` |
|   6258 | 1550 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1551 | `{` |
...
|   6263 | 1564 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6263 | 1565 | `	if( nDelim < 1 ){` |
...
|   6261 | 1571 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6261 | 1572 | `	if( nStrlen < 1 ){` |
...
|   6255 | 1598 | `	zEnd = &zString[nStrlen];` |
|      - | 1599 | `	/* Create the array */` |
|   6255 | 1600 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6255 | 1601 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6255 | 1602 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1603 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1604 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1605 | `		return PH7_OK;` |
|      - | 1606 | `	}` |
|      - | 1607 | `	/* Set a defualt limit */` |
|   6255 | 1608 | `	iLimit = SXI32_HIGH;` |
|   6255 | 1609 | `	if( nArg > 2 ){` |
...
|  72699 | 1644 | `	for(;;){` |
| 145403 | 1645 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 145403 | 1646 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1647 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6239 | 1648 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6239 | 1649 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1650 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 1651 | `			}` |
|   6239 | 1652 | `			break;` |
|      - | 1653 | `		}` |
|      - | 1654 | `		/* Point to the desired offset */` |
| 139169 | 1655 | `		zCur = &zString[nOfft];` |
|      - | 1656 | `		/* Perform the store operation (may be empty) */` |
| 139169 | 1657 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 139169 | 1658 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1659 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 1660 | `		}` |
|      - | 1661 | `		/* Point beyond the delimiter */` |
| 139169 | 1662 | `		zString = &zCur[nDelim];` |
|      - | 1663 | `		/* Reset the cursor */` |
| 139169 | 1664 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 1665 | `	}` |
|      - | 1666 | `	/* Return the freshly created array */` |
|   6239 | 1667 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1668 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1669 | `	 * released as soon we return from this foregin function.` |
|      - | 1670 | `	 */` |
|   6239 | 1671 | `	return PH7_OK;` |
|   3134 | 1672 | `}` |
|      - | 1673 | `/*` |
...
|      - | 1687 | ` */` |
|  13846 | 1688 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1689 | `{` |
|      - | 1690 | `	const char *zString;` |
|      - | 1691 | `	int nLen;` |
|  13851 | 1692 | `	if( nArg < 1 ){` |
|      - | 1693 | `		/* Missing arguments,return null */` |
|    ! 0 | 1694 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1695 | `		return PH7_OK;` |
|      - | 1696 | `	}` |
|      - | 1697 | `	/* Extract the target string */` |
|  13851 | 1698 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  13851 | 1699 | `	if( nLen < 1 ){` |
|      - | 1700 | `		/* Empty string,return */` |
|   1341 | 1701 | `		ph7_result_string(pCtx,"",0);` |
|   1341 | 1702 | `		return PH7_OK;` |
|      - | 1703 | `	}` |
|      - | 1704 | `	/* Start the trim process */` |
|  12515 | 1705 | `	if( nArg < 2 ){` |
|      - | 1706 | `		SyString sStr;` |
|      - | 1707 | `		/* Remove white spaces and NUL bytes */` |
|  12485 | 1708 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  31177 | 1709 | `		SyStringFullTrimSafe(&sStr);` |
|  12485 | 1710 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6245 | 1711 | `	}else{` |
|      - | 1712 | `		/* Char list */` |
...
|    ! 0 | 1913 | `		}else{` |
| 168993 | 1914 | `			int c = zString[0];` |
| 168993 | 1915 | `			if( SyisUpper(c) ){` |
| 168991 | 1916 | `				c = SyToLower(zString[0]);` |
|  84493 | 1917 | `			}` |
|      - | 1918 | `			/* Append character */` |
| 168993 | 1919 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 1920 | `			/* Advance the cursor */` |
| 168993 | 1921 | `			zString++;` |
|      - | 1922 | `		}` |
|      5 | 1923 | `	}` |
|  31919 | 1924 | `	return PH7_OK;` |
|  15963 | 1925 | `}` |
|      - | 1926 | `/*` |
...
|      - | 7051 | ` */` |
|  28570 | 7052 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7053 | `{` |
...
|      - | 7062 | `	int nByte;` |
|      - | 7063 | `	sxi32 rc;` |
|  28575 | 7064 | `	if( nArg < 3 ){` |
|      - | 7065 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 7066 | `		ph7_result_null(pCtx);` |
|    ! 0 | 7067 | `		return PH7_OK;` |
|      - | 7068 | `	}` |
|      - | 7069 | `	/* Initialize fields */` |
|  28575 | 7070 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  28575 | 7071 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  28575 | 7072 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  28575 | 7073 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  28575 | 7074 | `	sRep.pCtx = pCtx;` |
|  28575 | 7075 | `	sRep.pCollector = &sSearch;` |
|  28575 | 7076 | `	rep_str = 0;` |
|      - | 7077 | `	/* Extract the subject */` |
|  28575 | 7078 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  28575 | 7079 | `	if( nByte < 1 ){` |
...
|  28547 | 7085 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 7086 | `	/* Search string */` |
|  28547 | 7087 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 7088 | `		/* Collect search string */` |
|      9 | 7089 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 7090 | `	}else{` |
|      - | 7091 | `		/* Single pattern */` |
|  28539 | 7092 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  28539 | 7093 | `		if( nByte < 1 ){` |
...
|      - | 7097 | `		}` |
|  28535 | 7098 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 7099 | `		/* Save for later processing */` |
|  28535 | 7100 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 7101 | `	}` |
|      - | 7102 | `	/* Replace string */` |
|  28543 | 7103 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 7104 | `		/* Collect replace string */` |
|      7 | 7105 | `		sRep.pCollector = &sReplace;` |
|      7 | 7106 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 7107 | `	}else{` |
|      - | 7108 | `		/* Single needle */` |
|  28537 | 7109 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  28537 | 7110 | `		rep_str = 1;` |
|  28537 | 7111 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 7112 | `		/* Save for later processing */` |
|  28537 | 7113 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 7114 | `	}` |
|      - | 7115 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  28543 | 7116 | `	if( sRep.rc != SXRET_OK ){` |
...
|  28543 | 7123 | `	SySetResetCursor(&sSearch);` |
|  28543 | 7124 | `	SySetResetCursor(&sReplace);` |
|  28543 | 7125 | `	pReplace = pSearch = 0; /* cc warning */` |
|  28543 | 7126 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 7127 | `	/* Extract function name */` |
|  28543 | 7128 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 7129 | `	/* Set the default pattern match routine */` |
|  28543 | 7130 | `	xMatch = SyBlobSearch;` |
|  28543 | 7131 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 7132 | `		/* Case insensitive pattern match */` |
|     11 | 7133 | `		xMatch = iPatternMatch;` |
|      5 | 7134 | `	}` |
|      - | 7135 | `	/* Start the replace process */` |
|  57089 | 7136 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 7137 | `		sxu32 nCount,nOfft;` |
|  28551 | 7138 | `		if( pSearch->nByte <  1 ){` |
|      - | 7139 | `			/* Empty string,ignore */` |
|      3 | 7140 | `			continue;` |
|      - | 7141 | `		}` |
|      - | 7142 | `		/* Extract the replace string */` |
|  28549 | 7143 | `		if( rep_str ){` |
|  28539 | 7144 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14272 | 7145 | `		}else{` |
...
|      1 | 7151 | `			}` |
|      - | 7152 | `		}` |
|  28549 | 7153 | `		if( pReplace == 0 ){` |
|      - | 7154 | `			/* Use an empty string instead */` |
|      3 | 7155 | `			pReplace = &sTemp;` |
|      1 | 7156 | `		}` |
|  28549 | 7157 | `		nOfft = nCount = 0;` |
|  14288 | 7158 | `		for(;;){` |
|  28581 | 7159 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 7160 | `				break;` |
|      - | 7161 | `			}` |
|      - | 7162 | `			/* Perform a pattern lookup */` |
|  42851 | 7163 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  28564 | 7164 | `				pSearch->nByte,&nOfft);` |
|  28569 | 7165 | `			if( rc != SXRET_OK ){` |
...
|  28543 | 7183 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  28543 | 7184 | `	SySetRelease(&sSearch);` |
|  28543 | 7185 | `	SySetRelease(&sReplace);` |
|  28543 | 7186 | `	SyBlobRelease(&sWorker);` |
|  28543 | 7187 | `	if( rc != PH7_OK ){` |
|    ! 0 | 7188 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 7189 | `	}` |
|  28543 | 7190 | `	return PH7_OK;` |
|  14290 | 7191 | `}` |
|      - | 7192 | `/*` |
