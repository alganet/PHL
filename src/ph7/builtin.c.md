...
|      - |   35 | ` */` |
|     70 |   36 | `static int PH7_builtin_is_bool(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |   37 | `{` |
|     72 |   38 | `	int res = 0; /* Assume false by default */` |
|     72 |   39 | `	if( nArg > 0 ){` |
|     72 |   40 | `		res = ph7_value_is_bool(apArg[0]);` |
|     35 |   41 | `	}` |
|      - |   42 | `	/* Query result */` |
|     72 |   43 | `	ph7_result_bool(pCtx,res);` |
|     72 |   44 | `	return PH7_OK;` |
|      2 |   45 | `}` |
|      - |   46 | `/*` |
...
|      - |   75 | ` */` |
|    866 |   76 | `static int PH7_builtin_is_int(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      3 |   77 | `{` |
|    869 |   78 | `	int res = 0; /* Assume false by default */` |
|    869 |   79 | `	if( nArg > 0 ){` |
...
|    869 |   83 | `		res = ph7_value_is_int(apArg[0]) && !ph7_value_is_float(apArg[0]);` |
|    433 |   84 | `	}` |
|      - |   85 | `	/* Query result */` |
|    869 |   86 | `	ph7_result_bool(pCtx,res);` |
|    869 |   87 | `	return PH7_OK;` |
|      3 |   88 | `}` |
|      - |   89 | `/*` |
...
|      - |  186 | ` */` |
|    396 |  187 | `static int PH7_builtin_is_object(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      2 |  188 | `{` |
|    398 |  189 | `	int res = 0; /* Assume false by default */` |
|    398 |  190 | `	if( nArg > 0 ){` |
|    398 |  191 | `		res = ph7_value_is_object(apArg[0]);` |
|    198 |  192 | `	}` |
|      - |  193 | `	/* Query result */` |
|    398 |  194 | `	ph7_result_bool(pCtx,res);` |
|    398 |  195 | `	return PH7_OK;` |
|      2 |  196 | `}` |
|      - |  197 | `/*` |
...
|      - |  308 | ` */` |
|  34342 |  309 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  310 | `{` |
|  34347 |  311 | `	int res = 1; /* Assume empty by default */` |
|  34347 |  312 | `	if( nArg > 0 ){` |
|  34345 |  313 | `		res = ph7_value_is_empty(apArg[0]);` |
|  17170 |  314 | `	}` |
|  34347 |  315 | `	ph7_result_bool(pCtx,res);` |
|  34347 |  316 | `	return PH7_OK;` |
|      - |  317 |  |
|      5 |  318 | `}` |
...
|      - |  358 | ` */` |
| 233066 |  359 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  360 | `{` |
| 233071 |  361 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"substr",1,"$string"); }` |
|      - |  362 | `	const char *zSource,*zOfft;` |
|      - |  363 | `	int nOfft,nLen,nSrcLen;` |
| 233071 |  364 | `	if( nArg < 2 ){` |
|      - |  365 | `		/* return FALSE */` |
|    ! 0 |  366 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  367 | `		return PH7_OK;` |
|      - |  368 | `	}` |
|      - |  369 | `	/* Extract the target string */` |
| 233071 |  370 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 233071 |  371 | `	if( nSrcLen < 1 ){` |
|      - |  372 | `		/* Empty string,return FALSE */` |
|  12405 |  373 | `		ph7_result_bool(pCtx,0);` |
|  12405 |  374 | `		return PH7_OK;` |
|      - |  375 | `	}` |
| 220671 |  376 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  377 | `	/* Extract the offset */` |
| 220671 |  378 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 220671 |  379 | `	if( nOfft < 0 ){` |
|  33231 |  380 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  33231 |  381 | `		if( zOfft < zSource ){` |
|      - |  382 | `			/* Invalid offset */` |
|      5 |  383 | `			ph7_result_bool(pCtx,0);` |
|      5 |  384 | `			return PH7_OK;` |
|      - |  385 | `		}` |
|  33227 |  386 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  33227 |  387 | `		nOfft = (int)(zOfft-zSource);` |
| 204056 |  388 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  389 | `		/* Invalid offset */` |
|    235 |  390 | `		ph7_result_bool(pCtx,0);` |
|    235 |  391 | `		return PH7_OK;` |
|    ! 0 |  392 | `	}else{` |
| 187215 |  393 | `		zOfft = &zSource[nOfft];` |
| 187215 |  394 | `		nLen = nSrcLen - nOfft;` |
|      - |  395 | `	}` |
| 220437 |  396 | `	if( nArg > 2 ){` |
|      - |  397 | `		/* Extract the length */` |
| 181571 |  398 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 181571 |  399 | `		if( nLen == 0 ){` |
|      - |  400 | `			/* Invalid length,return an empty string */` |
|      5 |  401 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  402 | `			return PH7_OK;` |
| 181567 |  403 | `		}else if( nLen < 0 ){` |
|  33161 |  404 | `			nLen = nSrcLen + nLen - nOfft;` |
|  33161 |  405 | `			if( nLen < 1 ){` |
|      - |  406 | `				/* Invalid  length */` |
|      3 |  407 | `				nLen = nSrcLen - nOfft;` |
|      1 |  408 | `			}` |
|  16578 |  409 | `		}` |
| 181567 |  410 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  411 | `			/* Invalid length */` |
|   6105 |  412 | `			nLen = nSrcLen - nOfft;` |
|   3050 |  413 | `		}` |
|  90781 |  414 | `	}` |
|      - |  415 | `	/* Return the substring */` |
| 220433 |  416 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 220433 |  417 | `	return PH7_OK;` |
| 116538 |  418 | `}` |
|      - |  419 | `/*` |
...
|      - |  610 | ` */` |
| 298728 |  611 | `static void StrNullArgNotice(ph7_context *pCtx,ph7_value *pArg,const char *zFunc,int iArgNum,const char *zParamName)` |
|      5 |  612 | `{` |
| 298733 |  613 | `	if( ph7_value_is_null(pArg) ){` |
...
|      - | 1998 | ` */` |
|  14128 | 1999 | `static int PH7_builtin_strlen(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2000 | `{` |
|  14133 | 2001 | `	int iLen = 0;` |
|  14133 | 2002 | `	if( nArg > 0 ){` |
|  14133 | 2003 | `		StrNullArgNotice(pCtx,apArg[0],"strlen",1,"$string");` |
|  14133 | 2004 | `		ph7_value_to_string(apArg[0],&iLen);` |
|   7064 | 2005 | `	}` |
|      - | 2006 | `	/* String length */` |
|  14133 | 2007 | `	ph7_result_int(pCtx,iLen);` |
|  14133 | 2008 | `	return PH7_OK;` |
|      5 | 2009 | `}` |
|      - | 2010 | `/*` |
...
|      - | 2239 | ` */` |
| 148696 | 2240 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 2241 | `{` |
|  74348 | 2242 | `	SXUNUSED(pKey);` |
| 148701 | 2243 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 2244 | `	const char *zData;` |
|      - | 2245 | `	int nLen;` |
| 148701 | 2246 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 148699 | 2270 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 2271 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 148699 | 2272 | `	if( pData->bFirst ){` |
|  33633 | 2273 | `		pData->bFirst = 0;` |
| 131885 | 2274 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 2275 | `		/* append the separator first */` |
| 115055 | 2276 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 148699 | 2282 | `	if( nLen > 0 ){` |
| 136301 | 2283 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 2284 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 2285 | `			return PH7_ABORT;` |
|      - | 2286 | `		}` |
|  68148 | 2287 | `	}` |
| 148699 | 2288 | `	return PH7_OK;` |
|  74353 | 2289 | `}` |
|      - | 2290 | `/*` |
...
|      - | 2302 | ` */` |
|  33654 | 2303 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2304 | `{` |
|      - | 2305 | `	struct implode_data imp_data;` |
|  33659 | 2306 | `	int i = 1;` |
|  33659 | 2307 | `	if( nArg < 1 ){` |
|      - | 2308 | `		/* Missing argument,return NULL */` |
|    ! 0 | 2309 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2310 | `		return PH7_OK;` |
|      - | 2311 | `	}` |
|      - | 2312 | `	/* Prepare the implode context */` |
|  33659 | 2313 | `	imp_data.pCtx = pCtx;` |
|  33659 | 2314 | `	imp_data.bRecursive = 0;` |
|  33659 | 2315 | `	imp_data.bFirst = 1;` |
|  33659 | 2316 | `	imp_data.nRecCount = 0;` |
|  33659 | 2317 | `	imp_data.rc = SXRET_OK;` |
|  33659 | 2318 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  33657 | 2319 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16831 | 2320 | `	}else{` |
|      3 | 2321 | `		imp_data.zSep = 0;` |
|      3 | 2322 | `		imp_data.nSeplen = 0;` |
|      3 | 2323 | `		i = 0;` |
|      - | 2324 | `	}` |
|  33659 | 2325 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 2326 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 2327 | `	}` |
|      - | 2328 | `	/* Start the 'join' process */` |
|  67313 | 2329 | `	while( i < nArg ){` |
|  33659 | 2330 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 2331 | `			/* Iterate throw array entries */` |
|  33659 | 2332 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 2333 | `			/* Surface a callback allocation failure as a fatal */` |
|  33659 | 2334 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 2459 | ` */` |
|   6566 | 2460 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2461 | `{` |
...
|   6571 | 2474 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6571 | 2475 | `	if( nDelim < 1 ){` |
...
|   6567 | 2481 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6567 | 2482 | `	if( nStrlen < 1 ){` |
...
|   6561 | 2508 | `	zEnd = &zString[nStrlen];` |
|      - | 2509 | `	/* Create the array */` |
|   6561 | 2510 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6561 | 2511 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6561 | 2512 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 2513 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 2514 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 2515 | `		return PH7_OK;` |
|      - | 2516 | `	}` |
|      - | 2517 | `	/* Set a defualt limit */` |
|   6561 | 2518 | `	iLimit = SXI32_HIGH;` |
|   6561 | 2519 | `	if( nArg > 2 ){` |
...
|  80325 | 2554 | `	for(;;){` |
| 160655 | 2555 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 160655 | 2556 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 2557 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6545 | 2558 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6545 | 2559 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2560 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 2561 | `			}` |
|   6545 | 2562 | `			break;` |
|      - | 2563 | `		}` |
|      - | 2564 | `		/* Point to the desired offset */` |
| 154115 | 2565 | `		zCur = &zString[nOfft];` |
|      - | 2566 | `		/* Perform the store operation (may be empty) */` |
| 154115 | 2567 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 154115 | 2568 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 2569 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 2570 | `		}` |
|      - | 2571 | `		/* Point beyond the delimiter */` |
| 154115 | 2572 | `		zString = &zCur[nDelim];` |
|      - | 2573 | `		/* Reset the cursor */` |
| 154115 | 2574 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 2575 | `	}` |
|      - | 2576 | `	/* Return the freshly created array */` |
|   6545 | 2577 | `	ph7_result_value(pCtx,pArray);` |
|      - | 2578 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 2579 | `	 * released as soon we return from this foregin function.` |
|      - | 2580 | `	 */` |
|   6545 | 2581 | `	return PH7_OK;` |
|   3288 | 2582 | `}` |
|      - | 2583 | `/*` |
...
|      - | 2597 | ` */` |
|  14820 | 2598 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2599 | `{` |
|  14825 | 2600 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"trim",1,"$string"); }` |
|      - | 2601 | `	const char *zString;` |
|      - | 2602 | `	int nLen;` |
|  14825 | 2603 | `	if( nArg < 1 ){` |
|      - | 2604 | `		/* Missing arguments,return null */` |
|    ! 0 | 2605 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2606 | `		return PH7_OK;` |
|      - | 2607 | `	}` |
|      - | 2608 | `	/* Extract the target string */` |
|  14825 | 2609 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  14825 | 2610 | `	if( nLen < 1 ){` |
|      - | 2611 | `		/* Empty string,return */` |
|   1291 | 2612 | `		ph7_result_string(pCtx,"",0);` |
|   1291 | 2613 | `		return PH7_OK;` |
|      - | 2614 | `	}` |
|      - | 2615 | `	/* Start the trim process */` |
|  13539 | 2616 | `	if( nArg < 2 ){` |
|      - | 2617 | `		SyString sStr;` |
|      - | 2618 | `		/* Remove white spaces and NUL bytes */` |
|  13509 | 2619 | `		SyStringInitFromBuf(&sStr,zString,nLen);` |
|  33883 | 2620 | `		SyStringFullTrimSafe(&sStr);` |
|  13509 | 2621 | `		ph7_result_string(pCtx,sStr.zString,(int)sStr.nByte);` |
|   6757 | 2622 | `	}else{` |
|      - | 2623 | `		/* Char list */` |
...
|      - | 2793 | ` */` |
|  33626 | 2794 | `static int PH7_builtin_strtolower(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 2795 | `{` |
|  33631 | 2796 | `	if( nArg > 0 ){ StrNullArgNotice(pCtx,apArg[0],"strtolower",1,"$string"); }` |
|      - | 2797 | `	const char *zString,*zCur,*zEnd;` |
|      - | 2798 | `	int nLen;` |
|  33631 | 2799 | `	if( nArg < 1 ){` |
|      - | 2800 | `		/* Missing arguments,return null */` |
|    ! 0 | 2801 | `		ph7_result_null(pCtx);` |
|    ! 0 | 2802 | `		return PH7_OK;` |
|      - | 2803 | `	}` |
|      - | 2804 | `	/* Extract the target string */` |
|  33631 | 2805 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  33631 | 2806 | `	if( nLen < 1 ){` |
|      - | 2807 | `		/* Empty string,return */` |
|      5 | 2808 | `		ph7_result_string(pCtx,"",0);` |
|      5 | 2809 | `		return PH7_OK;` |
|      - | 2810 | `	}` |
|      - | 2811 | `	/* Perform the requested operation */` |
|  33627 | 2812 | `	zEnd = &zString[nLen];` |
| 106127 | 2813 | `	for(;;){` |
| 212259 | 2814 | `		if( zString >= zEnd ){` |
|      - | 2815 | `			/* No more input,break immediately */` |
|  33627 | 2816 | `			break;` |
|      - | 2817 | `		}` |
| 178637 | 2818 | `		if( (unsigned char)zString[0] >= 0xc0 ){` |
...
|    ! 0 | 2827 | `		}else{` |
| 178637 | 2828 | `			int c = zString[0];` |
| 178637 | 2829 | `			if( SyisUpper(c) ){` |
| 176081 | 2830 | `				c = SyToLower(zString[0]);` |
|  88038 | 2831 | `			}` |
|      - | 2832 | `			/* Append character */` |
| 178637 | 2833 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 2834 | `			/* Advance the cursor */` |
| 178637 | 2835 | `			zString++;` |
|      - | 2836 | `		}` |
|      5 | 2837 | `	}` |
|  33627 | 2838 | `	return PH7_OK;` |
|  16818 | 2839 | `}` |
|      - | 2840 | `/*` |
...
|      - | 8113 | ` */` |
|  29798 | 8114 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8115 | `{` |
...
|      - | 8124 | `	int nByte;` |
|      - | 8125 | `	sxi32 rc;` |
|  29803 | 8126 | `	if( nArg < 3 ){` |
|      - | 8127 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 8128 | `		ph7_result_null(pCtx);` |
|    ! 0 | 8129 | `		return PH7_OK;` |
|      - | 8130 | `	}` |
|      - | 8131 | `	/* Initialize fields */` |
|  29803 | 8132 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29803 | 8133 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  29803 | 8134 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  29803 | 8135 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  29803 | 8136 | `	sRep.pCtx = pCtx;` |
|  29803 | 8137 | `	sRep.pCollector = &sSearch;` |
|  29803 | 8138 | `	rep_str = 0;` |
|      - | 8139 | `	/* Extract the subject */` |
|  29803 | 8140 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  29803 | 8141 | `	if( nByte < 1 ){` |
...
|  29775 | 8147 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 8148 | `	/* Search string */` |
|  29775 | 8149 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 8150 | `		/* Collect search string */` |
|     47 | 8151 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|     26 | 8152 | `	}else{` |
|      - | 8153 | `		/* Single pattern */` |
|  29733 | 8154 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  29733 | 8155 | `		if( nByte < 1 ){` |
...
|      - | 8159 | `		}` |
|  29729 | 8160 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8161 | `		/* Save for later processing */` |
|  29729 | 8162 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 8163 | `	}` |
|      - | 8164 | `	/* Replace string */` |
|  29771 | 8165 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 8166 | `		/* Collect replace string */` |
|      7 | 8167 | `		sRep.pCollector = &sReplace;` |
|      7 | 8168 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 8169 | `	}else{` |
|      - | 8170 | `		/* Single needle */` |
|  29765 | 8171 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  29765 | 8172 | `		rep_str = 1;` |
|  29765 | 8173 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 8174 | `		/* Save for later processing */` |
|  29765 | 8175 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 8176 | `	}` |
|      - | 8177 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  29771 | 8178 | `	if( sRep.rc != SXRET_OK ){` |
...
|  29771 | 8185 | `	SySetResetCursor(&sSearch);` |
|  29771 | 8186 | `	SySetResetCursor(&sReplace);` |
|  29771 | 8187 | `	pReplace = pSearch = 0; /* cc warning */` |
|  29771 | 8188 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 8189 | `	/* Extract function name */` |
|  29771 | 8190 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 8191 | `	/* Set the default pattern match routine */` |
|  29771 | 8192 | `	xMatch = SyBlobSearch;` |
|  29771 | 8193 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 8194 | `		/* Case insensitive pattern match */` |
|     11 | 8195 | `		xMatch = iPatternMatch;` |
|      5 | 8196 | `	}` |
|      - | 8197 | `	/* Start the replace process */` |
|  59579 | 8198 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 8199 | `		sxu32 nCount,nOfft;` |
|  29813 | 8200 | `		if( pSearch->nByte <  1 ){` |
|      - | 8201 | `			/* Empty string,ignore */` |
|      3 | 8202 | `			continue;` |
|      - | 8203 | `		}` |
|      - | 8204 | `		/* Extract the replace string */` |
|  29811 | 8205 | `		if( rep_str ){` |
|  29801 | 8206 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14903 | 8207 | `		}else{` |
...
|      1 | 8213 | `			}` |
|      - | 8214 | `		}` |
|  29811 | 8215 | `		if( pReplace == 0 ){` |
|      - | 8216 | `			/* Use an empty string instead */` |
|      3 | 8217 | `			pReplace = &sTemp;` |
|      1 | 8218 | `		}` |
|  29811 | 8219 | `		nOfft = nCount = 0;` |
|  14930 | 8220 | `		for(;;){` |
|  29865 | 8221 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 8222 | `				break;` |
|      - | 8223 | `			}` |
|      - | 8224 | `			/* Perform a pattern lookup */` |
|  44777 | 8225 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  29848 | 8226 | `				pSearch->nByte,&nOfft);` |
|  29853 | 8227 | `			if( rc != SXRET_OK ){` |
...
|  29771 | 8245 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  29771 | 8246 | `	SySetRelease(&sSearch);` |
|  29771 | 8247 | `	SySetRelease(&sReplace);` |
|  29771 | 8248 | `	SyBlobRelease(&sWorker);` |
|  29771 | 8249 | `	if( rc != PH7_OK ){` |
|    ! 0 | 8250 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 8251 | `	}` |
|  29771 | 8252 | `	return PH7_OK;` |
|  14904 | 8253 | `}` |
|      - | 8254 | `/*` |
