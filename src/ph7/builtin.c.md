...
|      - |  300 | ` */` |
|  33088 |  301 | `static int PH7_builtin_empty(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  302 | `{` |
|  33093 |  303 | `	int res = 1; /* Assume empty by default */` |
|  33093 |  304 | `	if( nArg > 0 ){` |
|  33091 |  305 | `		res = ph7_value_is_empty(apArg[0]);` |
|  16543 |  306 | `	}` |
|  33093 |  307 | `	ph7_result_bool(pCtx,res);` |
|  33093 |  308 | `	return PH7_OK;` |
|      - |  309 |  |
|      5 |  310 | `}` |
...
|      - |  350 | ` */` |
| 211396 |  351 | `static int PH7_builtin_substr(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 |  352 | `{` |
|      - |  353 | `	const char *zSource,*zOfft;` |
|      - |  354 | `	int nOfft,nLen,nSrcLen;` |
| 211401 |  355 | `	if( nArg < 2 ){` |
|      - |  356 | `		/* return FALSE */` |
|    ! 0 |  357 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 |  358 | `		return PH7_OK;` |
|      - |  359 | `	}` |
|      - |  360 | `	/* Extract the target string */` |
| 211401 |  361 | `	zSource = ph7_value_to_string(apArg[0],&nSrcLen);` |
| 211401 |  362 | `	if( nSrcLen < 1 ){` |
|      - |  363 | `		/* Empty string,return FALSE */` |
|  11691 |  364 | `		ph7_result_bool(pCtx,0);` |
|  11691 |  365 | `		return PH7_OK;` |
|      - |  366 | `	}` |
| 199715 |  367 | `	nLen = nSrcLen; /* cc warning */` |
|      - |  368 | `	/* Extract the offset */` |
| 199715 |  369 | `	nOfft = ph7_value_to_int(apArg[1]);` |
| 199715 |  370 | `	if( nOfft < 0 ){` |
|  31859 |  371 | `		zOfft = &zSource[nSrcLen+nOfft];` |
|  31859 |  372 | `		if( zOfft < zSource ){` |
|      - |  373 | `			/* Invalid offset */` |
|      5 |  374 | `			ph7_result_bool(pCtx,0);` |
|      5 |  375 | `			return PH7_OK;` |
|      - |  376 | `		}` |
|  31855 |  377 | `		nLen = (int)(&zSource[nSrcLen]-zOfft);` |
|  31855 |  378 | `		nOfft = (int)(zOfft-zSource);` |
| 183786 |  379 | `	}else if( nOfft >= nSrcLen ){` |
|      - |  380 | `		/* Invalid offset */` |
|    195 |  381 | `		ph7_result_bool(pCtx,0);` |
|    195 |  382 | `		return PH7_OK;` |
|    ! 0 |  383 | `	}else{` |
| 167671 |  384 | `		zOfft = &zSource[nOfft];` |
| 167671 |  385 | `		nLen = nSrcLen - nOfft;` |
|      - |  386 | `	}` |
| 199521 |  387 | `	if( nArg > 2 ){` |
|      - |  388 | `		/* Extract the length */` |
| 164353 |  389 | `		nLen = ph7_value_to_int(apArg[2]);` |
| 164353 |  390 | `		if( nLen == 0 ){` |
|      - |  391 | `			/* Invalid length,return an empty string */` |
|      5 |  392 | `			ph7_result_string(pCtx,"",0);` |
|      5 |  393 | `			return PH7_OK;` |
| 164349 |  394 | `		}else if( nLen < 0 ){` |
|  31847 |  395 | `			nLen = nSrcLen + nLen - nOfft;` |
|  31847 |  396 | `			if( nLen < 1 ){` |
|      - |  397 | `				/* Invalid  length */` |
|      3 |  398 | `				nLen = nSrcLen - nOfft;` |
|      1 |  399 | `			}` |
|  15921 |  400 | `		}` |
| 164349 |  401 | `		if( nLen + nOfft > nSrcLen ){` |
|      - |  402 | `			/* Invalid length */` |
|   5055 |  403 | `			nLen = nSrcLen - nOfft;` |
|   2525 |  404 | `		}` |
|  82172 |  405 | `	}` |
|      - |  406 | `	/* Return the substring */` |
| 199517 |  407 | `	ph7_result_string(pCtx,zOfft,nLen);` |
| 199517 |  408 | `	return PH7_OK;` |
| 105703 |  409 | `}` |
|      - |  410 | `/*` |
...
|      - | 1329 | ` */` |
| 133276 | 1330 | `static int implode_callback(ph7_value *pKey,ph7_value *pValue,void *pUserData)` |
|      5 | 1331 | `{` |
|  66638 | 1332 | `	SXUNUSED(pKey);` |
| 133281 | 1333 | `	struct implode_data *pData = (struct implode_data *)pUserData;` |
|      - | 1334 | `	const char *zData;` |
|      - | 1335 | `	int nLen;` |
| 133281 | 1336 | `	if( pData->bRecursive && ph7_value_is_array(pValue) && pData->nRecCount < 32 ){` |
...
| 133279 | 1360 | `	zData = ph7_value_to_string(pValue,&nLen);` |
|      - | 1361 | `	/* Manage separator insertion: always mark first seen; append separator for subsequent items */` |
| 133279 | 1362 | `	if( pData->bFirst ){` |
|  32199 | 1363 | `		pData->bFirst = 0;` |
| 117182 | 1364 | `	}else if( pData->nSeplen > 0 ){` |
|      - | 1365 | `		/* append the separator first */` |
| 101073 | 1366 | `		if( ph7_result_string(pData->pCtx,pData->zSep,pData->nSeplen) != SXRET_OK ){` |
...
| 133279 | 1372 | `	if( nLen > 0 ){` |
| 121593 | 1373 | `		if( ph7_result_string(pData->pCtx,zData,nLen) != SXRET_OK ){` |
|    ! 0 | 1374 | `			pData->rc = SXERR_MEM;` |
|    ! 0 | 1375 | `			return PH7_ABORT;` |
|      - | 1376 | `		}` |
|  60794 | 1377 | `	}` |
| 133279 | 1378 | `	return PH7_OK;` |
|  66643 | 1379 | `}` |
|      - | 1380 | `/*` |
...
|      - | 1392 | ` */` |
|  32216 | 1393 | `static int PH7_builtin_implode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1394 | `{` |
|      - | 1395 | `	struct implode_data imp_data;` |
|  32221 | 1396 | `	int i = 1;` |
|  32221 | 1397 | `	if( nArg < 1 ){` |
|      - | 1398 | `		/* Missing argument,return NULL */` |
|    ! 0 | 1399 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1400 | `		return PH7_OK;` |
|      - | 1401 | `	}` |
|      - | 1402 | `	/* Prepare the implode context */` |
|  32221 | 1403 | `	imp_data.pCtx = pCtx;` |
|  32221 | 1404 | `	imp_data.bRecursive = 0;` |
|  32221 | 1405 | `	imp_data.bFirst = 1;` |
|  32221 | 1406 | `	imp_data.nRecCount = 0;` |
|  32221 | 1407 | `	imp_data.rc = SXRET_OK;` |
|  32221 | 1408 | `	if( !ph7_value_is_array(apArg[0]) ){` |
|  32219 | 1409 | `		imp_data.zSep = ph7_value_to_string(apArg[0],&imp_data.nSeplen);` |
|  16112 | 1410 | `	}else{` |
|      3 | 1411 | `		imp_data.zSep = 0;` |
|      3 | 1412 | `		imp_data.nSeplen = 0;` |
|      3 | 1413 | `		i = 0;` |
|      - | 1414 | `	}` |
|  32221 | 1415 | `	if( ph7_result_string(pCtx,"",0) != SXRET_OK ){ /* Set an empty stirng */` |
|    ! 0 | 1416 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 1417 | `	}` |
|      - | 1418 | `	/* Start the 'join' process */` |
|  64437 | 1419 | `	while( i < nArg ){` |
|  32221 | 1420 | `		if( ph7_value_is_array(apArg[i]) ){` |
|      - | 1421 | `			/* Iterate throw array entries */` |
|  32221 | 1422 | `			ph7_array_walk(apArg[i],implode_callback,&imp_data);` |
|      - | 1423 | `			/* Surface a callback allocation failure as a fatal */` |
|  32221 | 1424 | `			if( imp_data.rc != SXRET_OK ){` |
...
|      - | 1549 | ` */` |
|   6242 | 1550 | `static int PH7_builtin_explode(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1551 | `{` |
...
|   6247 | 1564 | `	zDelim = ph7_value_to_string(apArg[0],&nDelim);` |
|   6247 | 1565 | `	if( nDelim < 1 ){` |
...
|   6245 | 1571 | `	zString = ph7_value_to_string(apArg[1],&nStrlen);` |
|   6245 | 1572 | `	if( nStrlen < 1 ){` |
...
|   6239 | 1598 | `	zEnd = &zString[nStrlen];` |
|      - | 1599 | `	/* Create the array */` |
|   6239 | 1600 | `	pArray =  ph7_context_new_array(pCtx);` |
|   6239 | 1601 | `	pValue = ph7_context_new_scalar(pCtx);` |
|   6239 | 1602 | `	if( pArray == 0 \|\| pValue == 0 ){` |
|      - | 1603 | `		/* Out of memory,return FALSE */` |
|    ! 0 | 1604 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 1605 | `		return PH7_OK;` |
|      - | 1606 | `	}` |
|      - | 1607 | `	/* Set a defualt limit */` |
|   6239 | 1608 | `	iLimit = SXI32_HIGH;` |
|   6239 | 1609 | `	if( nArg > 2 ){` |
...
|  72125 | 1644 | `	for(;;){` |
| 144255 | 1645 | `		rc = SyBlobSearch(zString,(sxu32)(zEnd-zString),zDelim,nDelim,&nOfft);` |
| 144255 | 1646 | `		if( rc != SXRET_OK \|\| iLimit <= (int)ph7_array_count(pArray) ){` |
|      - | 1647 | `			/* Limit reached or no more delimiter; insert the rest (may be empty) and break */` |
|   6223 | 1648 | `			ph7_value_string(pValue, zString, (int)(zEnd - zString));` |
|   6223 | 1649 | `			if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1650 | `				return PH7_ContextMemoryError(pCtx);` |
|      - | 1651 | `			}` |
|   6223 | 1652 | `			break;` |
|      - | 1653 | `		}` |
|      - | 1654 | `		/* Point to the desired offset */` |
| 138037 | 1655 | `		zCur = &zString[nOfft];` |
|      - | 1656 | `		/* Perform the store operation (may be empty) */` |
| 138037 | 1657 | `		ph7_value_string(pValue, zString, (int)(zCur - zString));` |
| 138037 | 1658 | `		if( ph7_array_add_elem(pArray, 0/* Automatic index assign */, pValue) != SXRET_OK ){` |
|    ! 0 | 1659 | `			return PH7_ContextMemoryError(pCtx);` |
|      - | 1660 | `		}` |
|      - | 1661 | `		/* Point beyond the delimiter */` |
| 138037 | 1662 | `		zString = &zCur[nDelim];` |
|      - | 1663 | `		/* Reset the cursor */` |
| 138037 | 1664 | `		ph7_value_reset_string_cursor(pValue);` |
|      5 | 1665 | `	}` |
|      - | 1666 | `	/* Return the freshly created array */` |
|   6223 | 1667 | `	ph7_result_value(pCtx,pArray);` |
|      - | 1668 | `	/* NOTE that every allocated ph7_value will be automatically` |
|      - | 1669 | `	 * released as soon we return from this foregin function.` |
|      - | 1670 | `	 */` |
|   6223 | 1671 | `	return PH7_OK;` |
|   3126 | 1672 | `}` |
|      - | 1673 | `/*` |
...
|      - | 1687 | ` */` |
|  13810 | 1688 | `static int PH7_builtin_trim(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 1689 | `{` |
|      - | 1690 | `	const char *zString;` |
|      - | 1691 | `	int nLen;` |
|  13815 | 1692 | `	if( nArg < 1 ){` |
|      - | 1693 | `		/* Missing arguments,return null */` |
|    ! 0 | 1694 | `		ph7_result_null(pCtx);` |
|    ! 0 | 1695 | `		return PH7_OK;` |
|      - | 1696 | `	}` |
|      - | 1697 | `	/* Extract the target string */` |
|  13815 | 1698 | `	zString = ph7_value_to_string(apArg[0],&nLen);` |
|  13815 | 1699 | `	if( nLen < 1 ){` |
...
|  31073 | 1709 | `		SyStringFullTrimSafe(&sStr);` |
...
|    ! 0 | 1913 | `		}else{` |
| 168615 | 1914 | `			int c = zString[0];` |
| 168615 | 1915 | `			if( SyisUpper(c) ){` |
| 168613 | 1916 | `				c = SyToLower(zString[0]);` |
|  84304 | 1917 | `			}` |
|      - | 1918 | `			/* Append character */` |
| 168615 | 1919 | `			ph7_result_string(pCtx,(const char *)&c,(int)sizeof(char));` |
|      - | 1920 | `			/* Advance the cursor */` |
| 168615 | 1921 | `			zString++;` |
|      - | 1922 | `		}` |
|      5 | 1923 | `	}` |
|  31845 | 1924 | `	return PH7_OK;` |
|  15926 | 1925 | `}` |
|      - | 1926 | `/*` |
...
|      - | 7051 | ` */` |
|  28500 | 7052 | `static int PH7_builtin_str_replace(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7053 | `{` |
...
|      - | 7062 | `	int nByte;` |
|      - | 7063 | `	sxi32 rc;` |
|  28505 | 7064 | `	if( nArg < 3 ){` |
|      - | 7065 | `		/* Missing/Invalid arguments,return null */` |
|    ! 0 | 7066 | `		ph7_result_null(pCtx);` |
|    ! 0 | 7067 | `		return PH7_OK;` |
|      - | 7068 | `	}` |
|      - | 7069 | `	/* Initialize fields */` |
|  28505 | 7070 | `	SySetInit(&sSearch,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  28505 | 7071 | `	SySetInit(&sReplace,&pCtx->pVm->sAllocator,sizeof(SyString));` |
|  28505 | 7072 | `	SyBlobInit(&sWorker,&pCtx->pVm->sAllocator);` |
|  28505 | 7073 | `	SyZero(&sRep,sizeof(str_replace_data));` |
|  28505 | 7074 | `	sRep.pCtx = pCtx;` |
|  28505 | 7075 | `	sRep.pCollector = &sSearch;` |
|  28505 | 7076 | `	rep_str = 0;` |
|      - | 7077 | `	/* Extract the subject */` |
|  28505 | 7078 | `	zIn = ph7_value_to_string(apArg[2],&nByte);` |
|  28505 | 7079 | `	if( nByte < 1 ){` |
...
|  28477 | 7085 | `	SyBlobAppend(&sWorker,(const void *)zIn,(sxu32)nByte);` |
|      - | 7086 | `	/* Search string */` |
|  28477 | 7087 | `	if( ph7_value_is_array(apArg[0]) ){` |
|      - | 7088 | `		/* Collect search string */` |
|      9 | 7089 | `		ph7_array_walk(apArg[0],StrReplaceWalker,&sRep);` |
|      5 | 7090 | `	}else{` |
|      - | 7091 | `		/* Single pattern */` |
|  28469 | 7092 | `		zIn = ph7_value_to_string(apArg[0],&nByte);` |
|  28469 | 7093 | `		if( nByte < 1 ){` |
...
|      - | 7097 | `		}` |
|  28465 | 7098 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 7099 | `		/* Save for later processing */` |
|  28465 | 7100 | `		SySetPut(&sSearch,(const void *)&sTemp);` |
|      - | 7101 | `	}` |
|      - | 7102 | `	/* Replace string */` |
|  28473 | 7103 | `	if( ph7_value_is_array(apArg[1]) ){` |
|      - | 7104 | `		/* Collect replace string */` |
|      7 | 7105 | `		sRep.pCollector = &sReplace;` |
|      7 | 7106 | `		ph7_array_walk(apArg[1],StrReplaceWalker,&sRep);` |
|      4 | 7107 | `	}else{` |
|      - | 7108 | `		/* Single needle */` |
|  28467 | 7109 | `		zIn = ph7_value_to_string(apArg[1],&nByte);` |
|  28467 | 7110 | `		rep_str = 1;` |
|  28467 | 7111 | `		SyStringInitFromBuf(&sTemp,zIn,nByte);` |
|      - | 7112 | `		/* Save for later processing */` |
|  28467 | 7113 | `		SySetPut(&sReplace,(const void *)&sTemp);` |
|      - | 7114 | `	}` |
|      - | 7115 | `	/* Surface a collector allocation failure (StrReplaceWalker) as a fatal */` |
|  28473 | 7116 | `	if( sRep.rc != SXRET_OK ){` |
...
|  28473 | 7123 | `	SySetResetCursor(&sSearch);` |
|  28473 | 7124 | `	SySetResetCursor(&sReplace);` |
|  28473 | 7125 | `	pReplace = pSearch = 0; /* cc warning */` |
|  28473 | 7126 | `	SyStringInitFromBuf(&sTemp,"",0);` |
|      - | 7127 | `	/* Extract function name */` |
|  28473 | 7128 | `	zFunc = ph7_function_name(pCtx);` |
|      - | 7129 | `	/* Set the default pattern match routine */` |
|  28473 | 7130 | `	xMatch = SyBlobSearch;` |
|  28473 | 7131 | `	if( SyStrncmp(zFunc,"str_ireplace",sizeof("str_ireplace") - 1) ==  0 ){` |
|      - | 7132 | `		/* Case insensitive pattern match */` |
|     11 | 7133 | `		xMatch = iPatternMatch;` |
|      5 | 7134 | `	}` |
|      - | 7135 | `	/* Start the replace process */` |
|  56949 | 7136 | `	while( SXRET_OK == SySetGetNextEntry(&sSearch,(void **)&pSearch) ){` |
|      - | 7137 | `		sxu32 nCount,nOfft;` |
|  28481 | 7138 | `		if( pSearch->nByte <  1 ){` |
|      - | 7139 | `			/* Empty string,ignore */` |
|      3 | 7140 | `			continue;` |
|      - | 7141 | `		}` |
|      - | 7142 | `		/* Extract the replace string */` |
|  28479 | 7143 | `		if( rep_str ){` |
|  28469 | 7144 | `			pReplace = (SyString *)SySetPeek(&sReplace);` |
|  14237 | 7145 | `		}else{` |
...
|      1 | 7151 | `			}` |
|      - | 7152 | `		}` |
|  28479 | 7153 | `		if( pReplace == 0 ){` |
|      - | 7154 | `			/* Use an empty string instead */` |
|      3 | 7155 | `			pReplace = &sTemp;` |
|      1 | 7156 | `		}` |
|  28479 | 7157 | `		nOfft = nCount = 0;` |
|  14253 | 7158 | `		for(;;){` |
|  28511 | 7159 | `			if( nCount >= SyBlobLength(&sWorker) ){` |
|     13 | 7160 | `				break;` |
|      - | 7161 | `			}` |
|      - | 7162 | `			/* Perform a pattern lookup */` |
|  42746 | 7163 | `			rc = xMatch(SyBlobDataAt(&sWorker,nCount),SyBlobLength(&sWorker) - nCount,(const void *)pSearch->zString,` |
|  28494 | 7164 | `				pSearch->nByte,&nOfft);` |
|  28499 | 7165 | `			if( rc != SXRET_OK ){` |
...
|  28473 | 7183 | `	rc = ph7_result_string(pCtx,(const char *)SyBlobData(&sWorker),(int)SyBlobLength(&sWorker));` |
|  28473 | 7184 | `	SySetRelease(&sSearch);` |
|  28473 | 7185 | `	SySetRelease(&sReplace);` |
|  28473 | 7186 | `	SyBlobRelease(&sWorker);` |
|  28473 | 7187 | `	if( rc != PH7_OK ){` |
|    ! 0 | 7188 | `		return PH7_ContextMemoryError(pCtx);` |
|      - | 7189 | `	}` |
|  28473 | 7190 | `	return PH7_OK;` |
|  14255 | 7191 | `}` |
|      - | 7192 | `/*` |
...
|      - | 7762 | ` */` |
|   1622 | 7763 | `static int PH7_builtin_ctype_digit(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 7764 | `{` |
...
|   1627 | 7773 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|   1627 | 7774 | `	zEnd = &zIn[nLen];` |
|   1627 | 7775 | `	if( nLen < 1 ){` |
...
|   1523 | 7781 | `	for(;;){` |
|   3051 | 7782 | `		if( zIn >= zEnd ){` |
|      - | 7783 | `			/* If we reach the end of the string,then the test succeeded. */` |
|   1381 | 7784 | `			ph7_result_bool(pCtx,1);` |
|   1381 | 7785 | `			return PH7_OK;` |
|      - | 7786 | `		}` |
|   1675 | 7787 | `		if( zIn[0] >= 0xc0 ){` |
|      - | 7788 | `			/* UTF-8 stream  */` |
|    ! 0 | 7789 | `			break;` |
|      - | 7790 | `		}` |
|   1675 | 7791 | `		if( !SyisDigit(zIn[0]) ){` |
|    249 | 7792 | `			break;` |
|      - | 7793 | `		}` |
...
|      - | 8004 | ` */` |
|  62579 | 8005 | `static int PH7_builtin_ctype_space(ph7_context *pCtx,int nArg,ph7_value **apArg)` |
|      5 | 8006 | `{` |
|      - | 8007 | `	const unsigned char *zIn,*zEnd;` |
|      - | 8008 | `	int nLen;` |
|  62584 | 8009 | `	if( nArg < 1 ){` |
|      - | 8010 | `		/* Missing arguments,return FALSE */` |
|    ! 0 | 8011 | `		ph7_result_bool(pCtx,0);` |
|    ! 0 | 8012 | `		return PH7_OK;` |
|      - | 8013 | `	}` |
|      - | 8014 | `	/* Extract the target string */` |
|  62584 | 8015 | `	zIn  = (const unsigned char *)ph7_value_to_string(apArg[0],&nLen);` |
|  62584 | 8016 | `	zEnd = &zIn[nLen];` |
|  62584 | 8017 | `	if( nLen < 1 ){` |
...
|  60468 | 8040 | `	ph7_result_bool(pCtx,0);` |
|  60468 | 8041 | `	return PH7_OK;` |
|  31337 | 8042 | `}` |
|      - | 8043 | `/*` |
