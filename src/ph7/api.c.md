...
|       - |   77 | ` */` |
|    5230 |   78 | `static sxi32 EngineConfig(ph7 *pEngine,sxi32 nOp,va_list ap)` |
|       2 |   79 |  |
|    5232 |   80 | `	ph7_conf *pConf = &pEngine->xConf;` |
|    5232 |   81 | `	int rc = PH7_OK;` |
|       - |   82 | `	/* Perform the requested operation */` |
|    5232 |   83 | `	switch(nOp){` |
|    2615 |   84 | `	case PH7_CONFIG_ERR_OUTPUT: {` |
|    5232 |   85 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|    5232 |   86 | `		void *pUserData = va_arg(ap,void *);` |
|       - |   87 | `		/* Compile time error consumer routine */` |
|    5232 |   88 | `		if( xConsumer == 0 ){` |
|     ! 0 |   89 | `			rc = PH7_CORRUPT;` |
|     ! 0 |   90 | `			break;` |
|       - |   91 | `		}` |
|       - |   92 | `		/* Install the error consumer */` |
|    5232 |   93 | `		pConf->xErr     = xConsumer;` |
|    5232 |   94 | `		pConf->pErrData = pUserData;` |
|    5232 |   95 | `		break;` |
|       - |   96 | `									 }` |
...
|       - |  133 | ` */` |
|    7872 |  134 | `static sxi32 PH7CoreConfigure(sxi32 nOp,va_list ap)` |
|       2 |  135 |  |
|    7874 |  136 | `	int rc = PH7_OK;` |
|    7874 |  137 | `	switch(nOp){` |
|    1312 |  138 | `	    case PH7_LIB_CONFIG_VFS:{` |
|       - |  139 | `			/* Install a virtual file system */` |
|    2626 |  140 | `			const ph7_vfs *pVfs = va_arg(ap,const ph7_vfs *);` |
|    2626 |  141 | `			sMPGlobal.pVfs = pVfs;` |
|    2626 |  142 | `			break;` |
|       - |  143 | `								}` |
|    1312 |  144 | `		case PH7_LIB_CONFIG_USER_MALLOC: {` |
|       - |  145 | `			/* Use an alternative low-level memory allocation routines */` |
|    2626 |  146 | `			const SyMemMethods *pMethods = va_arg(ap,const SyMemMethods *);` |
|       - |  147 | `			/* Save the memory failure callback (if available) */` |
|    2626 |  148 | `			ProcMemError xMemErr = sMPGlobal.sAllocator.xMemError;` |
|    2626 |  149 | `			void *pMemErr = sMPGlobal.sAllocator.pUserData;` |
|    2626 |  150 | `			if( pMethods == 0 ){` |
|       - |  151 | `				/* Use the built-in memory allocation subsystem */` |
|    2626 |  152 | `				rc = SyMemBackendInit(&sMPGlobal.sAllocator,xMemErr,pMemErr);` |
|    1314 |  153 | `			}else{` |
...
|     ! 0 |  164 | `			break;` |
|       - |  165 | `												 }` |
|    1312 |  166 | `		case PH7_LIB_CONFIG_USER_MUTEX: {` |
|       - |  167 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  168 | `			/* Use an alternative low-level mutex subsystem */` |
|    2626 |  169 | `			const SyMutexMethods *pMethods = va_arg(ap,const SyMutexMethods *);` |
...
|       - |  174 | `#endif` |
|       - |  175 | `			/* Sanity check */` |
|    2626 |  176 | `			if( pMethods->xEnter == 0 \|\| pMethods->xLeave == 0 \|\| pMethods->xNew == 0){` |
|       - |  177 | `				/* At least three criticial callbacks xEnter(),xLeave() and xNew() must be supplied */` |
|     ! 0 |  178 | `				rc = PH7_CORRUPT;` |
|     ! 0 |  179 | `				break;` |
|       - |  180 | `			}` |
|    2626 |  181 | `			if( sMPGlobal.pMutexMethods ){` |
...
|    2626 |  190 | `			if( pMethods->xGlobalInit ){` |
...
|    2626 |  197 | `			sMPGlobal.pMutex = pMethods->xNew(SXMUTEX_TYPE_FAST);` |
|    2626 |  198 | `			if( sMPGlobal.pMutex == 0 ){` |
|       - |  199 | `				/*` |
...
|     ! 0 |  207 | `				break;` |
|       - |  208 | `			}` |
|    2626 |  209 | `			sMPGlobal.pMutexMethods = pMethods;` |
|    2626 |  210 | `			if( sMPGlobal.nThreadingLevel == 0 ){` |
|       - |  211 | `				/* Set a default threading level */` |
|    2626 |  212 | `				sMPGlobal.nThreadingLevel = PH7_THREAD_LEVEL_MULTI;` |
|    1312 |  213 | `			}` |
|       - |  214 | `#endif` |
|    2626 |  215 | `			break;` |
|       - |  216 | `										   }` |
...
|       - |  241 | ` */` |
|    7872 |  242 | `int ph7_lib_config(int nConfigOp,...)` |
|       2 |  243 |  |
|       - |  244 | `	va_list ap;` |
|       - |  245 | `	int rc;` |
|       - |  246 |  |
|    7874 |  247 | `	if( sMPGlobal.nMagic == PH7_LIB_MAGIC ){` |
|       - |  248 | `		/* Library is already initialized,this operation is forbidden */` |
|     ! 0 |  249 | `		return PH7_LOOKED;` |
|       - |  250 | `	}` |
|    7874 |  251 | `	va_start(ap,nConfigOp);` |
|    7874 |  252 | `	rc = PH7CoreConfigure(nConfigOp,ap);` |
|    7874 |  253 | `	va_end(ap);` |
|    7874 |  254 | `	return rc;` |
|    3938 |  255 |  |
|       - |  256 | `/*` |
...
|       - |  265 | ` */` |
|    2624 |  266 | `static sxi32 PH7CoreInitialize(void)` |
|       2 |  267 |  |
|       - |  268 | `	const ph7_vfs *pVfs; /* Built-in vfs */` |
|       - |  269 | `#if defined(PH7_ENABLE_THREADS)` |
|    2626 |  270 | `	const SyMutexMethods *pMutexMethods = 0;` |
|    2626 |  271 | `	SyMutex *pMaster = 0;` |
|       - |  272 | `#endif` |
|       - |  273 | `	int rc;` |
|       - |  274 | `	/*` |
...
|       - |  276 | `	 * is a no-op.` |
|       - |  277 | `	 */` |
|    2626 |  278 | `	if( sMPGlobal.nMagic == PH7_LIB_MAGIC ){` |
|     ! 0 |  279 | `		return PH7_OK; /* Already initialized */` |
|       - |  280 | `	}` |
|       - |  281 | `	/* Point to the built-in vfs */` |
|    2626 |  282 | `	pVfs = PH7_ExportBuiltinVfs();` |
|       - |  283 | `	/* Install it */` |
|    2626 |  284 | `	ph7_lib_config(PH7_LIB_CONFIG_VFS,pVfs);` |
|       - |  285 | `#if defined(PH7_ENABLE_THREADS)` |
|    2626 |  286 | `	if( sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_SINGLE ){` |
|    2626 |  287 | `		pMutexMethods = sMPGlobal.pMutexMethods;` |
|    2626 |  288 | `		if( pMutexMethods == 0 ){` |
|       - |  289 | `			/* Use the built-in mutex subsystem */` |
|    2626 |  290 | `			pMutexMethods = SyMutexExportMethods();` |
|    2626 |  291 | `			if( pMutexMethods == 0 ){` |
|     ! 0 |  292 | `				return PH7_CORRUPT; /* Can't happen */` |
|       - |  293 | `			}` |
|       - |  294 | `			/* Install the mutex subsystem */` |
|    2626 |  295 | `			rc = ph7_lib_config(PH7_LIB_CONFIG_USER_MUTEX,pMutexMethods);` |
|    2626 |  296 | `			if( rc != PH7_OK ){` |
|     ! 0 |  297 | `				return rc;` |
|       - |  298 | `			}` |
|    1312 |  299 | `		}` |
|       - |  300 | `		/* Obtain a static mutex so we can initialize the library without calling malloc() */` |
|    2626 |  301 | `		pMaster = SyMutexNew(pMutexMethods,SXMUTEX_TYPE_STATIC_1);` |
|    2626 |  302 | `		if( pMaster == 0 ){` |
|     ! 0 |  303 | `			return PH7_CORRUPT; /* Can't happen */` |
|       - |  304 | `		}` |
|    1312 |  305 | `	}` |
|       - |  306 | `	/* Lock the master mutex */` |
|    2626 |  307 | `	rc = PH7_OK;` |
|    2626 |  308 | `	SyMutexEnter(pMutexMethods,pMaster); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|    3938 |  309 | `	if( sMPGlobal.nMagic != PH7_LIB_MAGIC ){` |
|       - |  310 | `#endif` |
|    2626 |  311 | `		if( sMPGlobal.sAllocator.pMethods == 0 ){` |
|       - |  312 | `			/* Install a memory subsystem */` |
|    2626 |  313 | `			rc = ph7_lib_config(PH7_LIB_CONFIG_USER_MALLOC,0); /* zero mean use the built-in memory backend */` |
|    2626 |  314 | `			if( rc != PH7_OK ){` |
|       - |  315 | `				/* If we are unable to initialize the memory backend,there is no much we can do here.*/` |
|     ! 0 |  316 | `				goto End;` |
|       - |  317 | `			}` |
|    1312 |  318 | `		}` |
|       - |  319 | `#if defined(PH7_ENABLE_THREADS)` |
|    2626 |  320 | `		if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE ){` |
|       - |  321 | `			/* Protect the memory allocation subsystem */` |
|    2626 |  322 | `			rc = SyMemBackendMakeThreadSafe(&sMPGlobal.sAllocator,sMPGlobal.pMutexMethods);` |
|    2626 |  323 | `			if( rc != PH7_OK ){` |
|     ! 0 |  324 | `				goto End;` |
|       - |  325 | `			}` |
|    1312 |  326 | `		}` |
|       - |  327 | `#endif` |
|       - |  328 | `		/* Our library is initialized,set the magic number */` |
|    2626 |  329 | `		sMPGlobal.nMagic = PH7_LIB_MAGIC;` |
|    2626 |  330 | `		rc = PH7_OK;` |
|       - |  331 | `#if defined(PH7_ENABLE_THREADS)` |
|    1312 |  332 | `	} /* sMPGlobal.nMagic != PH7_LIB_MAGIC */` |
|       - |  333 | `#endif` |
|     ! 0 |  334 | `End:` |
|       - |  335 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  336 | `	/* Unlock the master mutex */` |
|    2626 |  337 | `	SyMutexLeave(pMutexMethods,pMaster); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  338 | `#endif` |
|    2626 |  339 | `	return rc;` |
|    1314 |  340 |  |
|       - |  341 | `/*` |
...
|       - |  353 | ` */` |
|    2616 |  354 | `static sxi32 EngineRelease(ph7 *pEngine)` |
|       2 |  355 |  |
|       - |  356 | `	ph7_vm *pVm,*pNext;` |
|       - |  357 | `	/* Release all active VM */` |
|    2618 |  358 | `	pVm = pEngine->pVms;` |
|    1308 |  359 | `	for(;;){` |
|    2618 |  360 | `		if( pEngine->iVm <= 0 ){` |
|    2618 |  361 | `			break;` |
|       - |  362 | `		}` |
...
|    2618 |  369 | `	pEngine->nMagic = 0x7635;` |
|       - |  370 | `	/* Release the private memory subsystem */` |
|    2618 |  371 | `	SyMemBackendRelease(&pEngine->sAllocator);` |
|    2618 |  372 | `	return PH7_OK;` |
|       2 |  373 |  |
|       - |  374 | `/*` |
...
|       - |  380 | ` */` |
|     268 |  381 | `static void PH7CoreShutdown(void)` |
|       1 |  382 |  |
|       - |  383 | `	ph7 *pEngine,*pNext;` |
|       - |  384 | `	/* Release all active engines first */` |
|     269 |  385 | `	pEngine = sMPGlobal.pEngines;` |
|     268 |  386 | `	for(;;){` |
|     537 |  387 | `		if( sMPGlobal.nEngine < 1 ){` |
|     269 |  388 | `			break;` |
|       - |  389 | `		}` |
|     269 |  390 | `		pNext = pEngine->pNext;` |
|     269 |  391 | `		EngineRelease(pEngine);` |
|     269 |  392 | `		pEngine = pNext;` |
|     269 |  393 | `		sMPGlobal.nEngine--;` |
|       1 |  394 | `	}` |
|       - |  395 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  396 | `	/* Release the mutex subsystem */` |
|     269 |  397 | `	if( sMPGlobal.pMutexMethods ){` |
|     269 |  398 | `		if( sMPGlobal.pMutex ){` |
|     269 |  399 | `			SyMutexRelease(sMPGlobal.pMutexMethods,sMPGlobal.pMutex);` |
|     269 |  400 | `			sMPGlobal.pMutex = 0;` |
|     134 |  401 | `		}` |
|     269 |  402 | `		if( sMPGlobal.pMutexMethods->xGlobalRelease ){` |
|       1 |  403 | `			sMPGlobal.pMutexMethods->xGlobalRelease();` |
|     ! 0 |  404 | `		}` |
|     269 |  405 | `		sMPGlobal.pMutexMethods = 0;` |
|     134 |  406 | `	}` |
|     269 |  407 | `	sMPGlobal.nThreadingLevel = 0;` |
|       - |  408 | `#endif` |
|     269 |  409 | `	if( sMPGlobal.sAllocator.pMethods ){` |
|       - |  410 | `		/* Release the memory backend */` |
|     269 |  411 | `		SyMemBackendRelease(&sMPGlobal.sAllocator);` |
|     134 |  412 | `	}` |
|     269 |  413 | `	sMPGlobal.nMagic = 0x1928;` |
|     269 |  414 |  |
|       - |  415 | `/*` |
|       - |  416 | ` * [CAPIREF: ph7_lib_shutdown()]` |
|       - |  417 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - |  418 | ` */` |
|     268 |  419 | `int ph7_lib_shutdown(void)` |
|       1 |  420 |  |
|     269 |  421 | `	if( sMPGlobal.nMagic != PH7_LIB_MAGIC ){` |
|       - |  422 | `		/* Already shut */` |
|     ! 0 |  423 | `		return PH7_OK;` |
|       - |  424 | `	}` |
|     269 |  425 | `	PH7CoreShutdown();` |
|     269 |  426 | `	return PH7_OK;` |
|     135 |  427 |  |
|       - |  428 | `/*` |
...
|       - |  484 | ` */` |
|    5230 |  485 | `int ph7_config(ph7 *pEngine,int nConfigOp,...)` |
|       2 |  486 |  |
|       - |  487 | `	va_list ap;` |
|       - |  488 | `	int rc;` |
|    5232 |  489 | `	if( PH7_ENGINE_MISUSE(pEngine) ){` |
|     ! 0 |  490 | `		return PH7_CORRUPT;` |
|       - |  491 | `	}` |
|       - |  492 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  493 | `	 /* Acquire engine mutex */` |
|    5232 |  494 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    5232 |  495 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    5230 |  496 | `		 PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 |  497 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  498 | `	 }` |
|       - |  499 | `#endif` |
|    5232 |  500 | `	 va_start(ap,nConfigOp);` |
|    5232 |  501 | `	 rc = EngineConfig(&(*pEngine),nConfigOp,ap);` |
|    5232 |  502 | `	 va_end(ap);` |
|       - |  503 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  504 | `	 /* Leave engine mutex */` |
|    5232 |  505 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  506 | `#endif` |
|    5232 |  507 | `	return rc;` |
|    2617 |  508 |  |
|       - |  509 | `/*` |
...
|       - |  512 | ` */` |
|    2624 |  513 | `int ph7_init(ph7 **ppEngine)` |
|       2 |  514 |  |
|       - |  515 | `	ph7 *pEngine;` |
|       - |  516 | `	int rc;` |
...
|    2626 |  524 | `	rc = PH7CoreInitialize();` |
|    2626 |  525 | `	if( rc != PH7_OK ){` |
|     ! 0 |  526 | `		return rc;` |
|       - |  527 | `	}` |
|       - |  528 | `	/* Allocate a new engine */` |
|    2626 |  529 | `	pEngine = (ph7 *)SyMemBackendPoolAlloc(&sMPGlobal.sAllocator,sizeof(ph7));` |
|    2626 |  530 | `	if( pEngine == 0 ){` |
|     ! 0 |  531 | `		return PH7_NOMEM;` |
|       - |  532 | `	}` |
|       - |  533 | `	/* Zero the structure */` |
|    2626 |  534 | `	SyZero(pEngine,sizeof(ph7));` |
|       - |  535 | `	/* Initialize engine fields */` |
|    2626 |  536 | `	pEngine->nMagic = PH7_ENGINE_MAGIC;` |
|    2626 |  537 | `	rc = SyMemBackendInitFromParent(&pEngine->sAllocator,&sMPGlobal.sAllocator);` |
|    2626 |  538 | `	if( rc != PH7_OK ){` |
|     ! 0 |  539 | `		goto Release;` |
|       - |  540 | `	}` |
|       - |  541 | `#if defined(PH7_ENABLE_THREADS)` |
|    2626 |  542 | `	SyMemBackendDisbaleMutexing(&pEngine->sAllocator);` |
|       - |  543 | `#endif` |
|       - |  544 | `	/* Default configuration */` |
|    2626 |  545 | `	SyBlobInit(&pEngine->xConf.sErrConsumer,&pEngine->sAllocator);` |
|       - |  546 | `	/* Install a default compile-time error consumer routine */` |
|    2626 |  547 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,PH7_VmBlobConsumer,&pEngine->xConf.sErrConsumer);` |
|       - |  548 | `	/* Built-in vfs */` |
|    2626 |  549 | `	pEngine->pVfs = sMPGlobal.pVfs;` |
|       - |  550 | `#if defined(PH7_ENABLE_THREADS)` |
|    2626 |  551 | `	if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE ){` |
|       - |  552 | `		 /* Associate a recursive mutex with this instance */` |
|    2626 |  553 | `		 pEngine->pMutex = SyMutexNew(sMPGlobal.pMutexMethods,SXMUTEX_TYPE_RECURSIVE);` |
|    2626 |  554 | `		 if( pEngine->pMutex == 0 ){` |
|     ! 0 |  555 | `			 rc = PH7_NOMEM;` |
|     ! 0 |  556 | `			 goto Release;` |
|       - |  557 | `		 }` |
|    1312 |  558 | `	 }` |
...
|    2626 |  563 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  564 | `#endif` |
|    2626 |  565 | `	MACRO_LD_PUSH(sMPGlobal.pEngines,pEngine);` |
|    2626 |  566 | `	sMPGlobal.nEngine++;` |
|       - |  567 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  568 | `	/* Leave the global mutex */` |
|    2626 |  569 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  570 | `#endif` |
|       - |  571 | `	/* Write a pointer to the new instance */` |
|    2626 |  572 | `	*ppEngine = pEngine;` |
|    2626 |  573 | `	return PH7_OK;` |
|     ! 0 |  574 | `Release:` |
...
|       - |  582 | ` */` |
|    2348 |  583 | `int ph7_release(ph7 *pEngine)` |
|       2 |  584 |  |
|       - |  585 | `	int rc;` |
|    2350 |  586 | `	if( PH7_ENGINE_MISUSE(pEngine) ){` |
|     ! 0 |  587 | `		return PH7_CORRUPT;` |
|       - |  588 | `	}` |
|       - |  589 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  590 | `	 /* Acquire engine mutex */` |
|    2350 |  591 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    2350 |  592 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    2348 |  593 | `		 PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 |  594 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  595 | `	 }` |
|       - |  596 | `#endif` |
|       - |  597 | `	/* Release the engine */` |
|    2350 |  598 | `	rc = EngineRelease(&(*pEngine));` |
|       - |  599 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  600 | `	 /* Leave engine mutex */` |
|    2350 |  601 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  602 | `	 /* Release engine mutex */` |
|    2350 |  603 | `	 SyMutexRelease(sMPGlobal.pMutexMethods,pEngine->pMutex) /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  604 | `#endif` |
|       - |  605 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  606 | `	/* Enter the global mutex */` |
|    2350 |  607 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  608 | `#endif` |
|       - |  609 | `	/* Unlink from the list of active engines */` |
|    2350 |  610 | `	MACRO_LD_REMOVE(sMPGlobal.pEngines,pEngine);` |
|    2350 |  611 | `	sMPGlobal.nEngine--;` |
|       - |  612 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  613 | `	/* Leave the global mutex */` |
|    2350 |  614 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  615 | `#endif` |
|       - |  616 | `	/* Release the memory chunk allocated to this engine */` |
|    2350 |  617 | `	SyMemBackendPoolFree(&sMPGlobal.sAllocator,pEngine);` |
|    2350 |  618 | `	return rc;` |
|    1176 |  619 |  |
|       - |  620 | `/*` |
...
|       - |  628 | ` * for evaluation.` |
|       - |  629 | ` */` |
|    2622 |  630 | `static sxi32 ProcessScript(` |
...
|    2624 |  641 | `	pVm = (ph7_vm *)SyMemBackendPoolAlloc(&pEngine->sAllocator,sizeof(ph7_vm));` |
|    2624 |  642 | `	if( pVm == 0 ){` |
...
|       - |  649 | `	}` |
|    2624 |  650 | `	if( iFlags < 0 ){` |
|       - |  651 | `		/* Default compile-time flags */` |
|     ! 0 |  652 | `		iFlags = 0;` |
|     ! 0 |  653 | `	}` |
|       - |  654 | `	/* Initialize the Virtual Machine */` |
|    2624 |  655 | `	rc = PH7_VmInit(pVm,&(*pEngine));` |
|    2624 |  656 | `	if( rc != PH7_OK ){` |
...
|       - |  662 | `	}` |
|    2624 |  663 | `	if( zFilePath ){` |
|       - |  664 | `		/* Push processed file path */` |
|    2616 |  665 | `		PH7_VmPushFilePath(pVm,zFilePath,-1,TRUE,0);` |
|    1307 |  666 | `	}` |
|       - |  667 | `	/* Reset the error message consumer */` |
|    2624 |  668 | `	SyBlobReset(&pEngine->xConf.sErrConsumer);` |
|       - |  669 | `	/* Compile the script */` |
|    2624 |  670 | `	PH7_CompileScript(pVm,&(*pScript),iFlags);` |
|    2624 |  671 | `	if( pVm->sCodeGen.nErr > 0 \|\| pVm == 0){` |
|     269 |  672 | `		sxu32 nErr = pVm->sCodeGen.nErr;` |
|       - |  673 | `		/* Compilation error or null ppVm pointer,release this VM */` |
|     269 |  674 | `		SyMemBackendRelease(&pVm->sAllocator);` |
|     269 |  675 | `		SyMemBackendPoolFree(&pEngine->sAllocator,pVm);` |
|     269 |  676 | `		if( ppVm ){` |
|     269 |  677 | `			*ppVm = 0;` |
|     134 |  678 | `		}` |
|     269 |  679 | `		return nErr > 0 ? PH7_COMPILE_ERR : PH7_OK;` |
|       - |  680 | `	}` |
|       - |  681 | `	/* Prepare the virtual machine for bytecode execution */` |
|    2356 |  682 | `	rc = PH7_VmMakeReady(pVm);` |
|    2356 |  683 | `	if( rc != PH7_OK ){` |
|     ! 0 |  684 | `		goto Release;` |
|       - |  685 | `	}` |
|       - |  686 | `	/* Install local import path which is the current directory */` |
|    2356 |  687 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IMPORT_PATH,"./");` |
|       - |  688 | `#if defined(PH7_ENABLE_THREADS)` |
|    2356 |  689 | `	if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE ){` |
|       - |  690 | `		 /* Associate a recursive mutex with this instance */` |
|    2356 |  691 | `		 pVm->pMutex = SyMutexNew(sMPGlobal.pMutexMethods,SXMUTEX_TYPE_RECURSIVE);` |
|    2356 |  692 | `		 if( pVm->pMutex == 0 ){` |
|     ! 0 |  693 | `			 goto Release;` |
|       - |  694 | `		 }` |
|    1177 |  695 | `	 }` |
|       - |  696 | `#endif` |
|       - |  697 | `	/* Script successfully compiled,link to the list of active virtual machines */` |
|    2356 |  698 | `	MACRO_LD_PUSH(pEngine->pVms,pVm);` |
|    2356 |  699 | `	pEngine->iVm++;` |
|       - |  700 | `	/* Point to the freshly created VM */` |
|    2356 |  701 | `	*ppVm = pVm;` |
|       - |  702 | `	/* Ready to execute PH7 bytecode */` |
|    2356 |  703 | `	return PH7_OK;` |
|     ! 0 |  704 | `Release:` |
...
|       - |  779 | ` */` |
|    2614 |  780 | `int ph7_compile_file(ph7 *pEngine,const char *zFilePath,ph7_vm **ppOutVm,int iFlags)` |
|       2 |  781 |  |
...
|    2616 |  785 | `		*ppOutVm = 0;` |
|    1307 |  786 | `	}` |
|    2616 |  787 | `	rc = PH7_OK; /* cc warning */` |
|    2616 |  788 | `	if( PH7_ENGINE_MISUSE(pEngine) \|\| SX_EMPTY_STR(zFilePath) ){` |
|     ! 0 |  789 | `		return PH7_CORRUPT;` |
|       - |  790 | `	}` |
|       - |  791 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  792 | `	 /* Acquire engine mutex */` |
|    2616 |  793 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    2616 |  794 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    2614 |  795 | `		 PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
...
|       - |  802 | `	  */` |
|    2616 |  803 | `	 pVfs = pEngine->pVfs;` |
|    2616 |  804 | `	 if( pVfs == 0 \|\| pVfs->xMmap == 0 ){` |
|       - |  805 | `		 /* Memory map routine not implemented */` |
|     ! 0 |  806 | `		 rc = PH7_IO_ERR;` |
|     ! 0 |  807 | `	 }else{` |
|    2616 |  808 | `		 void *pMapView = 0; /* cc warning */` |
|    2616 |  809 | `		 ph7_int64 nSize = 0; /* cc warning */` |
|       - |  810 | `		 SyString sScript;` |
|       - |  811 | `		 /* Try to get a memory view of the whole file */` |
|    2616 |  812 | `		 rc = pVfs->xMmap(zFilePath,&pMapView,&nSize);` |
|    2616 |  813 | `		 if( rc != PH7_OK ){` |
|       - |  814 | `			 /* Assume an IO error */` |
|     ! 0 |  815 | `			 rc = PH7_IO_ERR;` |
|     ! 0 |  816 | `		 }else{` |
|       - |  817 | `			 /* Compile the file */` |
|    2616 |  818 | `			 SyStringInitFromBuf(&sScript,pMapView,nSize);` |
|    2616 |  819 | `			 rc = ProcessScript(&(*pEngine),ppOutVm,&sScript,iFlags,zFilePath);` |
|       - |  820 | `			 /* Release the memory view of the whole file */` |
|    2616 |  821 | `			 if( pVfs->xUnmap ){` |
|    2616 |  822 | `				 pVfs->xUnmap(pMapView,nSize);` |
|    1307 |  823 | `			 }` |
|       - |  824 | `		 }` |
|       - |  825 | `	 }` |
|       - |  826 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  827 | `	 /* Leave engine mutex */` |
|    2616 |  828 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  829 | `#endif` |
...
|       - |  856 | ` */` |
|   37994 |  857 | `int ph7_vm_config(ph7_vm *pVm,int iConfigOp,...)` |
|       2 |  858 |  |
|       - |  859 | `	va_list ap;` |
|       - |  860 | `	int rc;` |
|       - |  861 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   37996 |  862 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  863 | `		return PH7_CORRUPT;` |
|       - |  864 | `	}` |
|       - |  865 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  866 | `	 /* Acquire VM mutex */` |
|   37996 |  867 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|   37996 |  868 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|   37994 |  869 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 |  870 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  871 | `	 }` |
|       - |  872 | `#endif` |
|       - |  873 | `	/* Confiugure the virtual machine */` |
|   37996 |  874 | `	va_start(ap,iConfigOp);` |
|   37996 |  875 | `	rc = PH7_VmConfigure(&(*pVm),iConfigOp,ap);` |
|   37996 |  876 | `	va_end(ap);` |
|       - |  877 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  878 | `	 /* Leave VM mutex */` |
|   37996 |  879 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  880 | `#endif` |
|   37996 |  881 | `	return rc;` |
|   18999 |  882 |  |
|       - |  883 | `/*` |
...
|       - |  886 | ` */` |
|    2358 |  887 | `int ph7_vm_exec(ph7_vm *pVm,int *pExitStatus)` |
|       2 |  888 |  |
|       - |  889 | `	int rc;` |
|       - |  890 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|    2360 |  891 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|       8 |  892 | `		return PH7_CORRUPT;` |
|       - |  893 | `	}` |
|       - |  894 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  895 | `	 /* Acquire VM mutex */` |
|    2360 |  896 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    2360 |  897 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    2354 |  898 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 |  899 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  900 | `	 }` |
|       - |  901 | `#endif` |
|       - |  902 | `	/* Execute PH7 byte-code */` |
|    2360 |  903 | `	rc = PH7_VmByteCodeExec(&(*pVm));` |
|    2356 |  904 | `	if( pExitStatus ){` |
|       - |  905 | `		/* Exit status */` |
|     ! 0 |  906 | `		*pExitStatus = pVm->iExitStatus;` |
|     ! 0 |  907 | `	}` |
|       - |  908 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  909 | `	 /* Leave VM mutex */` |
|    2348 |  910 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  911 | `#endif` |
...
|       - |  944 | ` */` |
|    2346 |  945 | `int ph7_vm_release(ph7_vm *pVm)` |
|       2 |  946 |  |
|       - |  947 | `	ph7 *pEngine;` |
|       - |  948 | `	int rc;` |
|       - |  949 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|    2348 |  950 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  951 | `		return PH7_CORRUPT;` |
|       - |  952 | `	}` |
|       - |  953 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  954 | `	 /* Acquire VM mutex */` |
|    2348 |  955 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    2348 |  956 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    2346 |  957 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 |  958 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  959 | `	 }` |
|       - |  960 | `#endif` |
|    2348 |  961 | `	pEngine = pVm->pEngine;` |
|    2348 |  962 | `	rc = PH7_VmRelease(&(*pVm));` |
|       - |  963 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  964 | `	 /* Leave VM mutex */` |
|    2348 |  965 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  966 | `#endif` |
|    2348 |  967 | `	if( rc == PH7_OK ){` |
|       - |  968 | `		/* Unlink from the list of active VM */` |
|       - |  969 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  970 | `			/* Acquire engine mutex */` |
|    2348 |  971 | `			SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    2348 |  972 | `			if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    2346 |  973 | `				PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 |  974 | `					return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  975 | `			}` |
|       - |  976 | `#endif` |
|    2348 |  977 | `		MACRO_LD_REMOVE(pEngine->pVms,pVm);` |
|    2348 |  978 | `		pEngine->iVm--;` |
|       - |  979 | `		/* Release the memory chunk allocated to this VM */` |
|    2348 |  980 | `		SyMemBackendPoolFree(&pEngine->sAllocator,pVm);` |
|       - |  981 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  982 | `			/* Leave engine mutex */` |
|    2348 |  983 | `			SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  984 | `#endif` |
|    1173 |  985 | `	}` |
|    2348 |  986 | `	return rc;` |
|    1175 |  987 |  |
...
|       - |  991 | ` */` |
| 1125596 |  992 | `int ph7_create_function(ph7_vm *pVm,const char *zName,int (*xFunc)(ph7_context *,int,ph7_value **),void *pUserData)` |
|       2 |  993 |  |
|       - |  994 | `	SyString sName;` |
|       - |  995 | `	int rc;` |
|       - |  996 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
| 1125598 |  997 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  998 | `		return PH7_CORRUPT;` |
|       - |  999 | `	}` |
| 1125598 | 1000 | `	SyStringInitFromBuf(&sName,zName,SyStrlen(zName));` |
|       - | 1001 | `	/* Remove leading and trailing white spaces */` |
| 1125598 | 1002 | `	SyStringFullTrim(&sName);` |
|       - | 1003 | `	/* Ticket 1433-003: NULL values are not allowed */` |
| 1125598 | 1004 | `	if( sName.nByte < 1 \|\| xFunc == 0 ){` |
|     ! 0 | 1005 | `		return PH7_CORRUPT;` |
|       - | 1006 | `	}` |
|       - | 1007 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1008 | `	 /* Acquire VM mutex */` |
| 1125598 | 1009 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
| 1125598 | 1010 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
| 1125596 | 1011 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1012 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1013 | `	 }` |
|       - | 1014 | `#endif` |
|       - | 1015 | `	/* Install the foreign function */` |
| 1125598 | 1016 | `	rc = PH7_VmInstallForeignFunction(&(*pVm),&sName,xFunc,pUserData);` |
|       - | 1017 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1018 | `	 /* Leave VM mutex */` |
| 1125598 | 1019 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1020 | `#endif` |
| 1125598 | 1021 | `	return rc;` |
|  562800 | 1022 |  |
|       - | 1023 | `/*` |
...
|       - | 1060 | ` */` |
|  510830 | 1061 | `int ph7_create_constant(ph7_vm *pVm,const char *zName,void (*xExpand)(ph7_value *,void *),void *pUserData)` |
|       2 | 1062 |  |
|       - | 1063 | `	SyString sName;` |
|       - | 1064 | `	int rc;` |
|       - | 1065 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|  510832 | 1066 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1067 | `		return PH7_CORRUPT;` |
|       - | 1068 | `	}` |
|  510832 | 1069 | `	SyStringInitFromBuf(&sName,zName,SyStrlen(zName));` |
|       - | 1070 | `	/* Remove leading and trailing white spaces */` |
|  513186 | 1071 | `	SyStringFullTrim(&sName);` |
|  510832 | 1072 | `	if( sName.nByte < 1 ){` |
|       - | 1073 | `		/* Empty constant name */` |
|     ! 0 | 1074 | `		return PH7_CORRUPT;` |
|       - | 1075 | `	}` |
|       - | 1076 | `	/* TICKET 1433-003: NULL pointer harmless operation */` |
|  510832 | 1077 | `	if( xExpand == 0 ){` |
|     ! 0 | 1078 | `		return PH7_CORRUPT;` |
|       - | 1079 | `	}` |
|       - | 1080 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1081 | `	 /* Acquire VM mutex */` |
|  510832 | 1082 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|  510832 | 1083 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|  510830 | 1084 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1085 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1086 | `	 }` |
|       - | 1087 | `#endif` |
|       - | 1088 | `	/* Perform the registration */` |
|  510832 | 1089 | `	rc = PH7_VmRegisterConstant(&(*pVm),&sName,xExpand,pUserData);` |
|       - | 1090 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1091 | `	 /* Leave VM mutex */` |
|  510832 | 1092 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1093 | `#endif` |
|  510832 | 1094 | `	 return rc;` |
|  255417 | 1095 |  |
|       - | 1096 | `/*` |
...
|       - | 1132 | ` */` |
|    5510 | 1133 | `ph7_value * ph7_new_scalar(ph7_vm *pVm)` |
|       2 | 1134 |  |
|       - | 1135 | `	ph7_value *pObj;` |
|       - | 1136 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|    5512 | 1137 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1138 | `		return 0;` |
|       - | 1139 | `	}` |
|       - | 1140 | `	/* Allocate a new scalar variable */` |
|    5512 | 1141 | `	pObj = (ph7_value *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_value));` |
|    5512 | 1142 | `	if( pObj == 0 ){` |
|     ! 0 | 1143 | `		return 0;` |
|       - | 1144 | `	}` |
|       - | 1145 | `	/* Nullify the new scalar */` |
|    5512 | 1146 | `	PH7_MemObjInit(pVm,pObj);` |
|    5512 | 1147 | `	return pObj;` |
|    2757 | 1148 |  |
|       - | 1149 | `/*` |
|       - | 1150 | ` * [CAPIREF: ph7_new_array()]` |
|       - | 1151 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1152 | ` */` |
|   31374 | 1153 | `ph7_value * ph7_new_array(ph7_vm *pVm)` |
|       2 | 1154 |  |
|       - | 1155 | `	ph7_hashmap *pMap;` |
|       - | 1156 | `	ph7_value *pObj;` |
|       - | 1157 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   31376 | 1158 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1159 | `		return 0;` |
|       - | 1160 | `	}` |
|       - | 1161 | `	/* Create a new hashmap first */` |
|   31376 | 1162 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|   31376 | 1163 | `	if( pMap == 0 ){` |
|     ! 0 | 1164 | `		return 0;` |
|       - | 1165 | `	}` |
|       - | 1166 | `	/* Associate a new ph7_value with this hashmap */` |
|   31376 | 1167 | `	pObj = (ph7_value *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_value));` |
|   31376 | 1168 | `	if( pObj == 0 ){` |
|     ! 0 | 1169 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     ! 0 | 1170 | `		return 0;` |
|       - | 1171 | `	}` |
|   31376 | 1172 | `	PH7_MemObjInitFromArray(pVm,pObj,pMap);` |
|   31376 | 1173 | `	return pObj;` |
|   15689 | 1174 |  |
|       - | 1175 | `/*` |
...
|       - | 1178 | ` */` |
|   23540 | 1179 | `int ph7_release_value(ph7_vm *pVm,ph7_value *pValue)` |
|       2 | 1180 |  |
|       - | 1181 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   23542 | 1182 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1183 | `		return PH7_CORRUPT;` |
|       - | 1184 | `	}` |
|   23542 | 1185 | `	if( pValue ){` |
|       - | 1186 | `		/* Release the value */` |
|   23542 | 1187 | `		PH7_MemObjRelease(pValue);` |
|   23542 | 1188 | `		SyMemBackendPoolFree(&pVm->sAllocator,pValue);` |
|   11770 | 1189 | `	}` |
|   23542 | 1190 | `	return PH7_OK;` |
|   11772 | 1191 |  |
|       - | 1192 | `/*` |
...
|       - | 1195 | ` */` |
|  296512 | 1196 | `int ph7_value_to_int(ph7_value *pValue)` |
|       2 | 1197 |  |
|       - | 1198 | `	int rc;` |
|  296514 | 1199 | `	rc = PH7_MemObjToInteger(pValue);` |
|  296514 | 1200 | `	if( rc != PH7_OK ){` |
|     ! 0 | 1201 | `		return 0;` |
|       - | 1202 | `	}` |
|  296514 | 1203 | `	return (int)pValue->x.iVal;` |
|  148258 | 1204 |  |
|       - | 1205 | `/*` |
...
|       - | 1247 | ` */` |
|  566372 | 1248 | `const char * ph7_value_to_string(ph7_value *pValue,int *pLen)` |
|       2 | 1249 |  |
|  566374 | 1250 | `	PH7_MemObjToString(pValue);` |
|  566374 | 1251 | `	if( SyBlobLength(&pValue->sBlob) > 0 ){` |
|  540924 | 1252 | `		SyBlobNullAppend(&pValue->sBlob);` |
|  540924 | 1253 | `		if( pLen ){` |
|  495600 | 1254 | `			*pLen = (int)SyBlobLength(&pValue->sBlob);` |
|  247821 | 1255 | `		}` |
|  540924 | 1256 | `		return (const char *)SyBlobData(&pValue->sBlob);` |
|     ! 0 | 1257 | `	}else{` |
...
|       - | 1268 | ` */` |
|   21730 | 1269 | `void * ph7_value_to_resource(ph7_value *pValue)` |
|       2 | 1270 |  |
|   21732 | 1271 | `	if( (pValue->iFlags & MEMOBJ_RES) == 0 ){` |
|       - | 1272 | `		/* Not a resource,return NULL */` |
|     ! 0 | 1273 | `		return 0;` |
|       - | 1274 | `	}` |
|   21732 | 1275 | `	return pValue->x.pOther;` |
|   10867 | 1276 |  |
|       - | 1277 | `/*` |
...
|       - | 1296 | ` */` |
|    6800 | 1297 | `int ph7_result_int(ph7_context *pCtx,int iValue)` |
|       2 | 1298 |  |
|    6802 | 1299 | `	return ph7_value_int(pCtx->pRet,iValue);` |
|       2 | 1300 |  |
|       - | 1301 | `/*` |
...
|       - | 1304 | ` */` |
|   12168 | 1305 | `int ph7_result_int64(ph7_context *pCtx,ph7_int64 iValue)` |
|       2 | 1306 |  |
|   12170 | 1307 | `	return ph7_value_int64(pCtx->pRet,iValue);` |
|       2 | 1308 |  |
|       - | 1309 | `/*` |
|       - | 1310 | ` * [CAPIREF: ph7_result_bool()]` |
|       - | 1311 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1312 | ` */` |
|  270150 | 1313 | `int ph7_result_bool(ph7_context *pCtx,int iBool)` |
|       2 | 1314 |  |
|  270152 | 1315 | `	return ph7_value_bool(pCtx->pRet,iBool);` |
|       2 | 1316 |  |
|       - | 1317 | `/*` |
...
|       - | 1338 | ` */` |
|  750432 | 1339 | `int ph7_result_string(ph7_context *pCtx,const char *zString,int nLen)` |
|       2 | 1340 |  |
|  750434 | 1341 | `	return ph7_value_string(pCtx->pRet,zString,nLen);` |
|       2 | 1342 |  |
|       - | 1343 | `/*` |
...
|       - | 1367 | ` */` |
|   24958 | 1368 | `int ph7_result_value(ph7_context *pCtx,ph7_value *pValue)` |
|       2 | 1369 |  |
|   24960 | 1370 | `	int rc = PH7_OK;` |
|   24960 | 1371 | `	if( pValue == 0 ){` |
|     ! 0 | 1372 | `		PH7_MemObjRelease(pCtx->pRet);` |
|     ! 0 | 1373 | `	}else{` |
|   24960 | 1374 | `		rc = PH7_MemObjStore(pValue,pCtx->pRet);` |
|       - | 1375 | `	}` |
|   24960 | 1376 | `	return rc;` |
|       2 | 1377 |  |
|       - | 1378 | `/*` |
...
|       - | 1381 | ` */` |
|    3762 | 1382 | `int ph7_result_resource(ph7_context *pCtx,void *pUserData)` |
|       2 | 1383 |  |
|    3764 | 1384 | `	return ph7_value_resource(pCtx->pRet,pUserData);` |
|       2 | 1385 |  |
|       - | 1386 | `/*` |
...
|       - | 1389 | ` */` |
|    5510 | 1390 | `ph7_value * ph7_context_new_scalar(ph7_context *pCtx)` |
|       2 | 1391 |  |
|       - | 1392 | `	ph7_value *pVal;` |
|    5512 | 1393 | `	pVal = ph7_new_scalar(pCtx->pVm);` |
|    5512 | 1394 | `	if( pVal ){` |
|       - | 1395 | `		/* Record value address so it can be freed automatically` |
|       - | 1396 | `		 * when the calling function returns.` |
|       - | 1397 | `		 */` |
|    5512 | 1398 | `		SySetPut(&pCtx->sVar,(const void *)&pVal);` |
|    2755 | 1399 | `	}` |
|    5512 | 1400 | `	return pVal;` |
|       2 | 1401 |  |
|       - | 1402 | `/*` |
...
|       - | 1405 | ` */` |
|    7834 | 1406 | `ph7_value * ph7_context_new_array(ph7_context *pCtx)` |
|       2 | 1407 |  |
|       - | 1408 | `	ph7_value *pVal;` |
|    7836 | 1409 | `	pVal = ph7_new_array(pCtx->pVm);` |
|    7836 | 1410 | `	if( pVal ){` |
|       - | 1411 | `		/* Record value address so it can be freed automatically` |
|       - | 1412 | `		 * when the calling function returns.` |
|       - | 1413 | `		 */` |
|    7836 | 1414 | `		SySetPut(&pCtx->sVar,(const void *)&pVal);` |
|    3917 | 1415 | `	}` |
|    7836 | 1416 | `	return pVal;` |
|       2 | 1417 |  |
|       - | 1418 | `/*` |
...
|       - | 1429 | ` */` |
|    3730 | 1430 | `void * ph7_context_alloc_chunk(ph7_context *pCtx,unsigned int nByte,int ZeroChunk,int AutoRelease)` |
|       2 | 1431 |  |
|       - | 1432 | `	void *pChunk;` |
|    3732 | 1433 | `	pChunk = SyMemBackendAlloc(&pCtx->pVm->sAllocator,nByte);` |
|    3732 | 1434 | `	if( pChunk ){` |
|    3732 | 1435 | `		if( ZeroChunk ){` |
|       - | 1436 | `			/* Zero the memory chunk */` |
|    3698 | 1437 | `			SyZero(pChunk,nByte);` |
|    1848 | 1438 | `		}` |
|    3732 | 1439 | `		if( AutoRelease ){` |
...
|       - | 1455 | ` */` |
|    3682 | 1456 | `static ph7_aux_data * ContextFindChunk(ph7_context *pCtx,void *pChunk)` |
|       2 | 1457 |  |
|       - | 1458 | `	ph7_aux_data *aAux,*pAux;` |
|       - | 1459 | `	sxu32 n;` |
|    3684 | 1460 | `	if( SySetUsed(&pCtx->sChunk) < 1 ){` |
...
|       - | 1496 | ` */` |
|    3682 | 1497 | `void ph7_context_free_chunk(ph7_context *pCtx,void *pChunk)` |
|       2 | 1498 |  |
|       - | 1499 | `	ph7_aux_data *pAux;` |
|    3684 | 1500 | `	if( pChunk == 0 ){` |
|       - | 1501 | `		/* TICKET-1433-93: NULL chunk is a harmless operation */` |
|     ! 0 | 1502 | `		return;` |
|       - | 1503 | `	}` |
|    3684 | 1504 | `	pAux = ContextFindChunk(pCtx,pChunk);` |
|    3684 | 1505 | `	if( pAux ){` |
|       - | 1506 | `		/* Mark as destroyed */` |
|     ! 0 | 1507 | `		pAux->pAuxData = 0;` |
|     ! 0 | 1508 | `	}` |
|    3684 | 1509 | `	SyMemBackendFree(&pCtx->pVm->sAllocator,pChunk);` |
|    1843 | 1510 |  |
|       - | 1511 | `/*` |
...
|       - | 1545 | ` */` |
|   24958 | 1546 | `int ph7_array_walk(ph7_value *pArray,int (*xWalk)(ph7_value *pValue,ph7_value *,void *),void *pUserData)` |
|       2 | 1547 |  |
|       - | 1548 | `	int rc;` |
|   24960 | 1549 | `	if( xWalk == 0 ){` |
|     ! 0 | 1550 | `		return PH7_CORRUPT;` |
|       - | 1551 | `	}` |
|       - | 1552 | `	/* Make sure we are dealing with a valid hashmap */` |
|   24960 | 1553 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1554 | `		return PH7_CORRUPT;` |
|       - | 1555 | `	}` |
|       - | 1556 | `	/* Start the walk process */` |
|   24960 | 1557 | `	rc = PH7_HashmapWalk((ph7_hashmap *)pArray->x.pOther,xWalk,pUserData);` |
|   24960 | 1558 | `	return rc != PH7_OK ? PH7_ABORT /* User callback request an operation abort*/ : PH7_OK;` |
|   12481 | 1559 |  |
|       - | 1560 | `/*` |
...
|       - | 1563 | ` */` |
| 2253264 | 1564 | `int ph7_array_add_elem(ph7_value *pArray,ph7_value *pKey,ph7_value *pValue)` |
|       2 | 1565 |  |
|       - | 1566 | `	int rc;` |
|       - | 1567 | `	/* Make sure we are dealing with a valid hashmap */` |
| 2253266 | 1568 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1569 | `		return PH7_CORRUPT;` |
|       - | 1570 | `	}` |
|       - | 1571 | `	/* Perform the insertion */` |
| 2253266 | 1572 | `	rc = PH7_HashmapInsert((ph7_hashmap *)pArray->x.pOther,&(*pKey),&(*pValue));` |
| 2253266 | 1573 | `	return rc;` |
| 1126634 | 1574 |  |
|       - | 1575 | `/*` |
...
|       - | 1578 | ` */` |
|    3134 | 1579 | `int ph7_array_add_strkey_elem(ph7_value *pArray,const char *zKey,ph7_value *pValue)` |
|       2 | 1580 |  |
|       - | 1581 | `	int rc;` |
|       - | 1582 | `	/* Make sure we are dealing with a valid hashmap */` |
|    3136 | 1583 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1584 | `		return PH7_CORRUPT;` |
|       - | 1585 | `	}` |
|       - | 1586 | `	/* Perform the insertion */` |
|    3136 | 1587 | `	if( SX_EMPTY_STR(zKey) ){` |
|       - | 1588 | `		/* Empty key,assign an automatic index */` |
|     ! 0 | 1589 | `		rc = PH7_HashmapInsert((ph7_hashmap *)pArray->x.pOther,0,&(*pValue));` |
|     ! 0 | 1590 | `	}else{` |
|       - | 1591 | `		ph7_value sKey;` |
|    3136 | 1592 | `		PH7_MemObjInitFromString(pArray->pVm,&sKey,0);` |
|    3136 | 1593 | `		PH7_MemObjStringAppend(&sKey,zKey,(sxu32)SyStrlen(zKey));` |
|    3136 | 1594 | `		rc = PH7_HashmapInsert((ph7_hashmap *)pArray->x.pOther,&sKey,&(*pValue));` |
|    3136 | 1595 | `		PH7_MemObjRelease(&sKey);` |
|       - | 1596 | `	}` |
|    3136 | 1597 | `	return rc;` |
|    1569 | 1598 |  |
|       - | 1599 | `/*` |
...
|       - | 1620 | ` */` |
|  100748 | 1621 | `unsigned int ph7_array_count(ph7_value *pArray)` |
|       2 | 1622 |  |
|       - | 1623 | `	ph7_hashmap *pMap;` |
|       - | 1624 | `	/* Make sure we are dealing with a valid hashmap */` |
|  100750 | 1625 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1626 | `		return 0;` |
|       - | 1627 | `	}` |
|       - | 1628 | `	/* Point to the internal representation of the hashmap */` |
|  100750 | 1629 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|  100750 | 1630 | `	return pMap->nEntry;` |
|   50376 | 1631 |  |
|       - | 1632 | `/*` |
...
|       - | 1779 | ` */` |
|   45558 | 1780 | `void * ph7_context_user_data(ph7_context *pCtx)` |
|       2 | 1781 |  |
|   45560 | 1782 | `	return pCtx->pFunc->pUserData;` |
|       2 | 1783 |  |
|       - | 1784 | `/*` |
...
|       - | 1819 | ` */` |
|    4880 | 1820 | `unsigned int ph7_context_result_buf_length(ph7_context *pCtx)` |
|       2 | 1821 |  |
|    4882 | 1822 | `	return SyBlobLength(&pCtx->pRet->sBlob);` |
|       2 | 1823 |  |
|       - | 1824 | `/*` |
...
|       - | 1827 | ` */` |
|   18374 | 1828 | `const char * ph7_function_name(ph7_context *pCtx)` |
|       2 | 1829 |  |
|       - | 1830 | `	SyString *pName;` |
|   18376 | 1831 | `	pName = &pCtx->pFunc->sName;` |
|   18376 | 1832 | `	return pName->zString;` |
|       2 | 1833 |  |
|       - | 1834 | `/*` |
|       - | 1835 | ` * [CAPIREF: ph7_value_int()]` |
|       - | 1836 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1837 | ` */` |
|   19902 | 1838 | `int ph7_value_int(ph7_value *pVal,int iValue)` |
|       2 | 1839 |  |
|       - | 1840 | `	/* Invalidate any prior representation */` |
|   19904 | 1841 | `	PH7_MemObjRelease(pVal);` |
|   19904 | 1842 | `	pVal->x.iVal = (ph7_int64)iValue;` |
|   19904 | 1843 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|   19904 | 1844 | `	return PH7_OK;` |
|       2 | 1845 |  |
|       - | 1846 | `/*` |
|       - | 1847 | ` * [CAPIREF: ph7_value_int64()]` |
|       - | 1848 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1849 | ` */` |
|   12228 | 1850 | `int ph7_value_int64(ph7_value *pVal,ph7_int64 iValue)` |
|       2 | 1851 |  |
|       - | 1852 | `	/* Invalidate any prior representation */` |
|   12230 | 1853 | `	PH7_MemObjRelease(pVal);` |
|   12230 | 1854 | `	pVal->x.iVal = iValue;` |
|   12230 | 1855 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|   12230 | 1856 | `	return PH7_OK;` |
|       2 | 1857 |  |
|       - | 1858 | `/*` |
|       - | 1859 | ` * [CAPIREF: ph7_value_bool()]` |
|       - | 1860 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1861 | ` */` |
|  270150 | 1862 | `int ph7_value_bool(ph7_value *pVal,int iBool)` |
|       2 | 1863 |  |
|       - | 1864 | `	/* Invalidate any prior representation */` |
|  270152 | 1865 | `	PH7_MemObjRelease(pVal);` |
|  270152 | 1866 | `	pVal->x.iVal = iBool ? 1 : 0;` |
|  270152 | 1867 | `	MemObjSetType(pVal,MEMOBJ_BOOL);` |
|  270152 | 1868 | `	return PH7_OK;` |
|       2 | 1869 |  |
|       - | 1870 | `/*` |
...
|       - | 1897 | ` */` |
|  866172 | 1898 | `int ph7_value_string(ph7_value *pVal,const char *zString,int nLen)` |
|       2 | 1899 |  |
|  866174 | 1900 | `	if((pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - | 1901 | `		/* Invalidate any prior representation */` |
|  284086 | 1902 | `		PH7_MemObjRelease(pVal);` |
|  284086 | 1903 | `		MemObjSetType(pVal,MEMOBJ_STRING);` |
|  142042 | 1904 | `	}` |
|  866174 | 1905 | `	if( zString ){` |
|  864996 | 1906 | `		if( nLen < 0 ){` |
|       - | 1907 | `			/* Compute length automatically */` |
|    3142 | 1908 | `			nLen = (int)SyStrlen(zString);` |
|    1570 | 1909 | `		}` |
|  864996 | 1910 | `		SyBlobAppend(&pVal->sBlob,(const void *)zString,(sxu32)nLen);` |
|  432497 | 1911 | `	}` |
|  866174 | 1912 | `	return PH7_OK;` |
|       2 | 1913 |  |
|       - | 1914 | `/*` |
...
|       - | 1934 | ` */` |
|  106732 | 1935 | `int ph7_value_reset_string_cursor(ph7_value *pVal)` |
|       2 | 1936 |  |
|       - | 1937 | `	/* Reset the string cursor */` |
|  106734 | 1938 | `	SyBlobReset(&pVal->sBlob);` |
|  106734 | 1939 | `	return PH7_OK;` |
|       2 | 1940 |  |
|       - | 1941 | `/*` |
...
|       - | 1944 | ` */` |
|    3852 | 1945 | `int ph7_value_resource(ph7_value *pVal,void *pUserData)` |
|       2 | 1946 |  |
|       - | 1947 | `	/* Invalidate any prior representation */` |
|    3854 | 1948 | `	PH7_MemObjRelease(pVal);` |
|       - | 1949 | `	/* Reflect the new type */` |
|    3854 | 1950 | `	pVal->x.pOther = pUserData;` |
|    3854 | 1951 | `	MemObjSetType(pVal,MEMOBJ_RES);` |
|    3854 | 1952 | `	return PH7_OK;` |
|       2 | 1953 |  |
|       - | 1954 | `/*` |
...
|       - | 1957 | ` */` |
|    2740 | 1958 | `int ph7_value_release(ph7_value *pVal)` |
|       2 | 1959 |  |
|    2742 | 1960 | `	PH7_MemObjRelease(pVal);` |
|    2742 | 1961 | `	return PH7_OK;` |
|       2 | 1962 |  |
|       - | 1963 | `/*` |
...
|       - | 1966 | ` */` |
|    9640 | 1967 | `int ph7_value_is_int(ph7_value *pVal)` |
|       2 | 1968 |  |
|    9642 | 1969 | `	return (pVal->iFlags & MEMOBJ_INT) ? TRUE : FALSE;` |
|       2 | 1970 |  |
|       - | 1971 | `/*` |
...
|       - | 1990 | ` */` |
|   78188 | 1991 | `int ph7_value_is_string(ph7_value *pVal)` |
|       2 | 1992 |  |
|   78190 | 1993 | `	return (pVal->iFlags & MEMOBJ_STRING) ? TRUE : FALSE;` |
|       2 | 1994 |  |
|       - | 1995 | `/*` |
...
|       - | 2016 | ` */` |
|   17652 | 2017 | `int ph7_value_is_callable(ph7_value *pVal)` |
|       2 | 2018 |  |
|       - | 2019 | `	int rc;` |
|   17654 | 2020 | `	rc = PH7_VmIsCallable(pVal->pVm,pVal,FALSE);` |
|   17654 | 2021 | `	return rc;` |
|       2 | 2022 |  |
|       - | 2023 | `/*` |
...
|       - | 2034 | ` */` |
|  117166 | 2035 | `int ph7_value_is_array(ph7_value *pVal)` |
|       2 | 2036 |  |
|  117168 | 2037 | `	return (pVal->iFlags & MEMOBJ_HASHMAP) ? TRUE : FALSE;` |
|       2 | 2038 |  |
|       - | 2039 | `/*` |
...
|       - | 2050 | ` */` |
|   22558 | 2051 | `int ph7_value_is_resource(ph7_value *pVal)` |
|       2 | 2052 |  |
|   22560 | 2053 | `	return (pVal->iFlags & MEMOBJ_RES) ? TRUE : FALSE;` |
|       2 | 2054 |  |
|       - | 2055 | `/*` |
...
|       - | 2058 | ` */` |
|   21590 | 2059 | `int ph7_value_is_empty(ph7_value *pVal)` |
|       2 | 2060 |  |
|       - | 2061 | `	int rc;` |
|   21592 | 2062 | `	rc = PH7_MemObjIsEmpty(pVal);` |
|   21592 | 2063 | `	return rc;` |
|       2 | 2064 |  |
|       - | 2065 | `/*` |
