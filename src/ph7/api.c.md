...
|       - | 1247 | ` */` |
|   23410 | 1248 | `int ph7_value_to_int(ph7_value *pValue)` |
|       5 | 1249 | `{` |
|       - | 1250 | `	int rc;` |
|   23415 | 1251 | `	rc = PH7_MemObjToInteger(pValue);` |
|   23415 | 1252 | `	if( rc != PH7_OK ){` |
|     ! 0 | 1253 | `		return 0;` |
|       - | 1254 | `	}` |
|   23415 | 1255 | `	return (int)pValue->x.iVal;` |
|   11710 | 1256 | `}` |
|       - | 1257 | `/*` |
...
|       - | 1320 | ` */` |
|   34810 | 1321 | `void * ph7_value_to_resource(ph7_value *pValue)` |
|       5 | 1322 | `{` |
|   34815 | 1323 | `	if( (pValue->iFlags & MEMOBJ_RES) == 0 ){` |
|       - | 1324 | `		/* Not a resource,return NULL */` |
|     ! 0 | 1325 | `		return 0;` |
|       - | 1326 | `	}` |
|   34815 | 1327 | `	return pValue->x.pOther;` |
|   17410 | 1328 | `}` |
|       - | 1329 | `/*` |
...
|       - | 1364 | ` */` |
|  385616 | 1365 | `int ph7_result_bool(ph7_context *pCtx,int iBool)` |
|       5 | 1366 | `{` |
|  385621 | 1367 | `	return ph7_value_bool(pCtx->pRet,iBool);` |
|       5 | 1368 | `}` |
|       - | 1369 | `/*` |
...
|       - | 1390 | ` */` |
| 1300419 | 1391 | `int ph7_result_string(ph7_context *pCtx,const char *zString,int nLen)` |
|       5 | 1392 | `{` |
| 1300424 | 1393 | `	return ph7_value_string(pCtx->pRet,zString,nLen);` |
|       5 | 1394 | `}` |
|       - | 1395 | `/*` |
...
|       - | 1481 | ` */` |
|    5604 | 1482 | `void * ph7_context_alloc_chunk(ph7_context *pCtx,unsigned int nByte,int ZeroChunk,int AutoRelease)` |
|       5 | 1483 | `{` |
|       - | 1484 | `	void *pChunk;` |
|    5609 | 1485 | `	pChunk = SyMemBackendAlloc(&pCtx->pVm->sAllocator,nByte);` |
|    5609 | 1486 | `	if( pChunk ){` |
|    5609 | 1487 | `		if( ZeroChunk ){` |
|       - | 1488 | `			/* Zero the memory chunk */` |
|    5351 | 1489 | `			SyZero(pChunk,nByte);` |
|    2673 | 1490 | `		}` |
|    5609 | 1491 | `		if( AutoRelease ){` |
...
|       - | 1511 | `	sxu32 n;` |
|      90 | 1512 | `	if( SySetUsed(&pCtx->sChunk) < 1 ){` |
...
|     ! 0 | 1554 | `		return;` |
|       - | 1555 | `	}` |
|      90 | 1556 | `	pAux = ContextFindChunk(pCtx,pChunk);` |
|      90 | 1557 | `	if( pAux ){` |
|       - | 1558 | `		/* Mark as destroyed */` |
|     ! 0 | 1559 | `		pAux->pAuxData = 0;` |
|     ! 0 | 1560 | `	}` |
|      90 | 1561 | `	SyMemBackendFree(&pCtx->pVm->sAllocator,pChunk);` |
|      47 | 1562 | `}` |
|       - | 1563 | `/*` |
...
|       - | 1913 | ` */` |
|  403166 | 1914 | `int ph7_value_bool(ph7_value *pVal,int iBool)` |
|       5 | 1915 | `{` |
|       - | 1916 | `	/* Invalidate any prior representation */` |
|  403171 | 1917 | `	PH7_MemObjRelease(pVal);` |
|  403171 | 1918 | `	pVal->x.iVal = iBool ? 1 : 0;` |
|  403171 | 1919 | `	MemObjSetType(pVal,MEMOBJ_BOOL);` |
|  403171 | 1920 | `	return PH7_OK;` |
|       5 | 1921 | `}` |
|       - | 1922 | `/*` |
...
|       - | 1949 | ` */` |
| 1485956 | 1950 | `int ph7_value_string(ph7_value *pVal,const char *zString,int nLen)` |
|       5 | 1951 | `{` |
| 1485961 | 1952 | `	if((pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - | 1953 | `		/* Invalidate any prior representation */` |
|  488856 | 1954 | `		PH7_MemObjRelease(pVal);` |
|  488856 | 1955 | `		MemObjSetType(pVal,MEMOBJ_STRING);` |
|  244500 | 1956 | `	}` |
| 1485961 | 1957 | `	if( zString ){` |
| 1485617 | 1958 | `		if( nLen < 0 ){` |
...
| 1485617 | 1964 | `		return SyBlobAppend(&pVal->sBlob,(const void *)zString,(sxu32)nLen);` |
|       - | 1965 | `	}` |
...
|       - | 2111 | ` */` |
|   39180 | 2112 | `int ph7_value_is_resource(ph7_value *pVal)` |
|       5 | 2113 | `{` |
|   39185 | 2114 | `	return (pVal->iFlags & MEMOBJ_RES) ? TRUE : FALSE;` |
|       5 | 2115 | `}` |
|       - | 2116 | `/*` |
