...
|       - |   77 | ` */` |
|    7638 |   78 | `static sxi32 EngineConfig(ph7 *pEngine,sxi32 nOp,va_list ap)` |
|       5 |   79 | `{` |
|    7643 |   80 | `	ph7_conf *pConf = &pEngine->xConf;` |
|    7643 |   81 | `	int rc = PH7_OK;` |
|       - |   82 | `	/* Perform the requested operation */` |
|    7643 |   83 | `	switch(nOp){` |
|    3819 |   84 | `	case PH7_CONFIG_ERR_OUTPUT: {` |
|    7643 |   85 | `		ProcConsumer xConsumer = va_arg(ap,ProcConsumer);` |
|    7643 |   86 | `		void *pUserData = va_arg(ap,void *);` |
|       - |   87 | `		/* Compile time error consumer routine */` |
|    7643 |   88 | `		if( xConsumer == 0 ){` |
|     ! 0 |   89 | `			rc = PH7_CORRUPT;` |
|     ! 0 |   90 | `			break;` |
|       - |   91 | `		}` |
|       - |   92 | `		/* Install the error consumer */` |
|    7643 |   93 | `		pConf->xErr     = xConsumer;` |
|    7643 |   94 | `		pConf->pErrData = pUserData;` |
|    7643 |   95 | `		break;` |
|       - |   96 | `									 }` |
...
|       - |  157 | ` */` |
|   11490 |  158 | `static sxi32 PH7CoreConfigure(sxi32 nOp,va_list ap)` |
|       5 |  159 | `{` |
|   11495 |  160 | `	int rc = PH7_OK;` |
|   11495 |  161 | `	switch(nOp){` |
|    1915 |  162 | `	    case PH7_LIB_CONFIG_VFS:{` |
|       - |  163 | `			/* Install a virtual file system */` |
|    3835 |  164 | `			const ph7_vfs *pVfs = va_arg(ap,const ph7_vfs *);` |
|    3835 |  165 | `			sMPGlobal.pVfs = pVfs;` |
|    3835 |  166 | `			break;` |
|       - |  167 | `								}` |
|    1915 |  168 | `		case PH7_LIB_CONFIG_USER_MALLOC: {` |
|       - |  169 | `			/* Use an alternative low-level memory allocation routines */` |
|    3835 |  170 | `			const SyMemMethods *pMethods = va_arg(ap,const SyMemMethods *);` |
|       - |  171 | `			/* Save the memory failure callback (if available) */` |
|    3835 |  172 | `			ProcMemError xMemErr = sMPGlobal.sAllocator.xMemError;` |
|    3835 |  173 | `			void *pMemErr = sMPGlobal.sAllocator.pUserData;` |
|    3835 |  174 | `			if( pMethods == 0 ){` |
|       - |  175 | `				/* Use the built-in memory allocation subsystem */` |
|    3835 |  176 | `				rc = SyMemBackendInit(&sMPGlobal.sAllocator,xMemErr,pMemErr);` |
|    1920 |  177 | `			}else{` |
...
|     ! 0 |  188 | `			break;` |
|       - |  189 | `												 }` |
|    1915 |  190 | `		case PH7_LIB_CONFIG_USER_MUTEX: {` |
|       - |  191 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  192 | `			/* Use an alternative low-level mutex subsystem */` |
|    3835 |  193 | `			const SyMutexMethods *pMethods = va_arg(ap,const SyMutexMethods *);` |
...
|       - |  198 | `#endif` |
|       - |  199 | `			/* Sanity check */` |
|    3835 |  200 | `			if( pMethods->xEnter == 0 \|\| pMethods->xLeave == 0 \|\| pMethods->xNew == 0){` |
|       - |  201 | `				/* At least three criticial callbacks xEnter(),xLeave() and xNew() must be supplied */` |
|     ! 0 |  202 | `				rc = PH7_CORRUPT;` |
|     ! 0 |  203 | `				break;` |
|       - |  204 | `			}` |
|    3835 |  205 | `			if( sMPGlobal.pMutexMethods ){` |
...
|    3835 |  214 | `			if( pMethods->xGlobalInit ){` |
...
|    3835 |  221 | `			sMPGlobal.pMutex = pMethods->xNew(SXMUTEX_TYPE_FAST);` |
|    3835 |  222 | `			if( sMPGlobal.pMutex == 0 ){` |
|       - |  223 | `				/*` |
...
|     ! 0 |  231 | `				break;` |
|       - |  232 | `			}` |
|    3835 |  233 | `			sMPGlobal.pMutexMethods = pMethods;` |
|    3835 |  234 | `			if( sMPGlobal.nThreadingLevel == 0 ){` |
|       - |  235 | `				/* Set a default threading level */` |
|    3835 |  236 | `				sMPGlobal.nThreadingLevel = PH7_THREAD_LEVEL_MULTI;` |
|    1915 |  237 | `			}` |
|       - |  238 | `#endif` |
|    3835 |  239 | `			break;` |
|       - |  240 | `										   }` |
...
|       - |  265 | ` */` |
|   11490 |  266 | `int ph7_lib_config(int nConfigOp,...)` |
|       5 |  267 | `{` |
|       - |  268 | `	va_list ap;` |
|       - |  269 | `	int rc;` |
|       - |  270 |  |
|   11495 |  271 | `	if( sMPGlobal.nMagic == PH7_LIB_MAGIC ){` |
|       - |  272 | `		/* Library is already initialized,this operation is forbidden */` |
|     ! 0 |  273 | `		return PH7_LOOKED;` |
|       - |  274 | `	}` |
|   11495 |  275 | `	va_start(ap,nConfigOp);` |
|   11495 |  276 | `	rc = PH7CoreConfigure(nConfigOp,ap);` |
|   11495 |  277 | `	va_end(ap);` |
|   11495 |  278 | `	return rc;` |
|    5750 |  279 | `}` |
|       - |  280 | `/*` |
...
|       - |  289 | ` */` |
|    3830 |  290 | `static sxi32 PH7CoreInitialize(void)` |
|       5 |  291 | `{` |
|       - |  292 | `	const ph7_vfs *pVfs; /* Built-in vfs */` |
|       - |  293 | `#if defined(PH7_ENABLE_THREADS)` |
|    3835 |  294 | `	const SyMutexMethods *pMutexMethods = 0;` |
|    3835 |  295 | `	SyMutex *pMaster = 0;` |
|       - |  296 | `#endif` |
|       - |  297 | `	int rc;` |
|       - |  298 | `	/*` |
...
|       - |  300 | `	 * is a no-op.` |
|       - |  301 | `	 */` |
|    3835 |  302 | `	if( sMPGlobal.nMagic == PH7_LIB_MAGIC ){` |
|     ! 0 |  303 | `		return PH7_OK; /* Already initialized */` |
|       - |  304 | `	}` |
|       - |  305 | `	/* Point to the built-in vfs */` |
|    3835 |  306 | `	pVfs = PH7_ExportBuiltinVfs();` |
|       - |  307 | `	/* Install it */` |
|    3835 |  308 | `	ph7_lib_config(PH7_LIB_CONFIG_VFS,pVfs);` |
|       - |  309 | `#if defined(PH7_ENABLE_THREADS)` |
|    3835 |  310 | `	if( sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_SINGLE ){` |
|    3835 |  311 | `		pMutexMethods = sMPGlobal.pMutexMethods;` |
|    3835 |  312 | `		if( pMutexMethods == 0 ){` |
|       - |  313 | `			/* Use the built-in mutex subsystem */` |
|    3835 |  314 | `			pMutexMethods = SyMutexExportMethods();` |
|    3835 |  315 | `			if( pMutexMethods == 0 ){` |
|     ! 0 |  316 | `				return PH7_CORRUPT; /* Can't happen */` |
|       - |  317 | `			}` |
|       - |  318 | `			/* Install the mutex subsystem */` |
|    3835 |  319 | `			rc = ph7_lib_config(PH7_LIB_CONFIG_USER_MUTEX,pMutexMethods);` |
|    3835 |  320 | `			if( rc != PH7_OK ){` |
|     ! 0 |  321 | `				return rc;` |
|       - |  322 | `			}` |
|    1915 |  323 | `		}` |
|       - |  324 | `		/* Obtain a static mutex so we can initialize the library without calling malloc() */` |
|    3835 |  325 | `		pMaster = SyMutexNew(pMutexMethods,SXMUTEX_TYPE_STATIC_1);` |
|    3835 |  326 | `		if( pMaster == 0 ){` |
|     ! 0 |  327 | `			return PH7_CORRUPT; /* Can't happen */` |
|       - |  328 | `		}` |
|    1915 |  329 | `	}` |
|       - |  330 | `	/* Lock the master mutex */` |
|    3835 |  331 | `	rc = PH7_OK;` |
|    3835 |  332 | `	SyMutexEnter(pMutexMethods,pMaster); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|    5750 |  333 | `	if( sMPGlobal.nMagic != PH7_LIB_MAGIC ){` |
|       - |  334 | `#endif` |
|    3835 |  335 | `		if( sMPGlobal.sAllocator.pMethods == 0 ){` |
|       - |  336 | `			/* Install a memory subsystem */` |
|    3835 |  337 | `			rc = ph7_lib_config(PH7_LIB_CONFIG_USER_MALLOC,0); /* zero mean use the built-in memory backend */` |
|    3835 |  338 | `			if( rc != PH7_OK ){` |
|       - |  339 | `				/* If we are unable to initialize the memory backend,there is no much we can do here.*/` |
|     ! 0 |  340 | `				goto End;` |
|       - |  341 | `			}` |
|    1915 |  342 | `		}` |
|       - |  343 | `#if defined(PH7_ENABLE_THREADS)` |
|    3835 |  344 | `		if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE ){` |
|       - |  345 | `			/* Protect the memory allocation subsystem */` |
|    3835 |  346 | `			rc = SyMemBackendMakeThreadSafe(&sMPGlobal.sAllocator,sMPGlobal.pMutexMethods);` |
|    3835 |  347 | `			if( rc != PH7_OK ){` |
|     ! 0 |  348 | `				goto End;` |
|       - |  349 | `			}` |
|    1915 |  350 | `		}` |
|       - |  351 | `#endif` |
|       - |  352 | `		/* Our library is initialized,set the magic number */` |
|    3835 |  353 | `		sMPGlobal.nMagic = PH7_LIB_MAGIC;` |
|    3835 |  354 | `		rc = PH7_OK;` |
|       - |  355 | `#if defined(PH7_ENABLE_THREADS)` |
|    1915 |  356 | `	} /* sMPGlobal.nMagic != PH7_LIB_MAGIC */` |
|       - |  357 | `#endif` |
|     ! 0 |  358 | `End:` |
|       - |  359 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  360 | `	/* Unlock the master mutex */` |
|    3835 |  361 | `	SyMutexLeave(pMutexMethods,pMaster); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  362 | `#endif` |
|    3835 |  363 | `	return rc;` |
|    1920 |  364 | `}` |
|       - |  365 | `/*` |
...
|       - |  377 | ` */` |
|    3830 |  378 | `static sxi32 EngineRelease(ph7 *pEngine)` |
|       5 |  379 | `{` |
|       - |  380 | `	ph7_vm *pVm,*pNext;` |
|       - |  381 | `	/* Release all active VM */` |
|    3835 |  382 | `	pVm = pEngine->pVms;` |
|    1915 |  383 | `	for(;;){` |
|    3835 |  384 | `		if( pEngine->iVm <= 0 ){` |
|    3835 |  385 | `			break;` |
|       - |  386 | `		}` |
...
|    3835 |  393 | `	pEngine->nMagic = 0x7635;` |
|       - |  394 | `	/* Release the private memory subsystem */` |
|    3835 |  395 | `	SyMemBackendRelease(&pEngine->sAllocator);` |
|    3835 |  396 | `	return PH7_OK;` |
|       5 |  397 | `}` |
|       - |  398 | `/*` |
...
|       - |  508 | ` */` |
|    7638 |  509 | `int ph7_config(ph7 *pEngine,int nConfigOp,...)` |
|       5 |  510 | `{` |
|       - |  511 | `	va_list ap;` |
|       - |  512 | `	int rc;` |
|    7643 |  513 | `	if( PH7_ENGINE_MISUSE(pEngine) ){` |
|     ! 0 |  514 | `		return PH7_CORRUPT;` |
|       - |  515 | `	}` |
|       - |  516 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  517 | `	 /* Acquire engine mutex */` |
|    7643 |  518 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    7643 |  519 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    7638 |  520 | `		 PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 |  521 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  522 | `	 }` |
|       - |  523 | `#endif` |
|    7643 |  524 | `	 va_start(ap,nConfigOp);` |
|    7643 |  525 | `	 rc = EngineConfig(&(*pEngine),nConfigOp,ap);` |
|    7643 |  526 | `	 va_end(ap);` |
|       - |  527 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  528 | `	 /* Leave engine mutex */` |
|    7643 |  529 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  530 | `#endif` |
|    7643 |  531 | `	return rc;` |
|    3824 |  532 | `}` |
|       - |  533 | `/*` |
...
|       - |  536 | ` */` |
|    3830 |  537 | `int ph7_init(ph7 **ppEngine)` |
|       5 |  538 | `{` |
|       - |  539 | `	ph7 *pEngine;` |
|       - |  540 | `	int rc;` |
...
|    3835 |  548 | `	rc = PH7CoreInitialize();` |
|    3835 |  549 | `	if( rc != PH7_OK ){` |
|     ! 0 |  550 | `		return rc;` |
|       - |  551 | `	}` |
|       - |  552 | `	/* Allocate a new engine */` |
|    3835 |  553 | `	pEngine = (ph7 *)SyMemBackendPoolAlloc(&sMPGlobal.sAllocator,sizeof(ph7));` |
|    3835 |  554 | `	if( pEngine == 0 ){` |
|     ! 0 |  555 | `		return PH7_NOMEM;` |
|       - |  556 | `	}` |
|       - |  557 | `	/* Zero the structure */` |
|    3835 |  558 | `	SyZero(pEngine,sizeof(ph7));` |
|       - |  559 | `	/* Initialize engine fields */` |
|    3835 |  560 | `	pEngine->nMagic = PH7_ENGINE_MAGIC;` |
|    3835 |  561 | `	rc = SyMemBackendInitFromParent(&pEngine->sAllocator,&sMPGlobal.sAllocator);` |
|    3835 |  562 | `	if( rc != PH7_OK ){` |
|     ! 0 |  563 | `		goto Release;` |
|       - |  564 | `	}` |
|       - |  565 | `#if defined(PH7_ENABLE_THREADS)` |
|    3835 |  566 | `	SyMemBackendDisbaleMutexing(&pEngine->sAllocator);` |
|       - |  567 | `#endif` |
|       - |  568 | `	/* Default configuration */` |
|    3835 |  569 | `	SyBlobInit(&pEngine->xConf.sErrConsumer,&pEngine->sAllocator);` |
|       - |  570 | `	/* Install a default compile-time error consumer routine */` |
|    3835 |  571 | `	ph7_config(pEngine,PH7_CONFIG_ERR_OUTPUT,PH7_VmBlobConsumer,&pEngine->xConf.sErrConsumer);` |
|       - |  572 | `	/* Built-in vfs */` |
|    3835 |  573 | `	pEngine->pVfs = sMPGlobal.pVfs;` |
|       - |  574 | `#if defined(PH7_ENABLE_THREADS)` |
|    3835 |  575 | `	if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE ){` |
|       - |  576 | `		 /* Associate a recursive mutex with this instance */` |
|    3835 |  577 | `		 pEngine->pMutex = SyMutexNew(sMPGlobal.pMutexMethods,SXMUTEX_TYPE_RECURSIVE);` |
|    3835 |  578 | `		 if( pEngine->pMutex == 0 ){` |
|     ! 0 |  579 | `			 rc = PH7_NOMEM;` |
|     ! 0 |  580 | `			 goto Release;` |
|       - |  581 | `		 }` |
|    1915 |  582 | `	 }` |
...
|    3835 |  587 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  588 | `#endif` |
|    3835 |  589 | `	MACRO_LD_PUSH(sMPGlobal.pEngines,pEngine);` |
|    3835 |  590 | `	sMPGlobal.nEngine++;` |
|       - |  591 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  592 | `	/* Leave the global mutex */` |
|    3835 |  593 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  594 | `#endif` |
|       - |  595 | `	/* Write a pointer to the new instance */` |
|    3835 |  596 | `	*ppEngine = pEngine;` |
|    3835 |  597 | `	return PH7_OK;` |
|     ! 0 |  598 | `Release:` |
...
|       - |  606 | ` */` |
|    3458 |  607 | `int ph7_release(ph7 *pEngine)` |
|       5 |  608 | `{` |
|       - |  609 | `	int rc;` |
|    3463 |  610 | `	if( PH7_ENGINE_MISUSE(pEngine) ){` |
|     ! 0 |  611 | `		return PH7_CORRUPT;` |
|       - |  612 | `	}` |
|       - |  613 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  614 | `	 /* Acquire engine mutex */` |
|    3463 |  615 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3463 |  616 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3458 |  617 | `		 PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 |  618 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  619 | `	 }` |
|       - |  620 | `#endif` |
|       - |  621 | `	/* Release the engine */` |
|    3463 |  622 | `	rc = EngineRelease(&(*pEngine));` |
|       - |  623 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  624 | `	 /* Leave engine mutex */` |
|    3463 |  625 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  626 | `	 /* Release engine mutex */` |
|    3463 |  627 | `	 SyMutexRelease(sMPGlobal.pMutexMethods,pEngine->pMutex) /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  628 | `#endif` |
|       - |  629 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  630 | `	/* Enter the global mutex */` |
|    3463 |  631 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  632 | `#endif` |
|       - |  633 | `	/* Unlink from the list of active engines */` |
|    3463 |  634 | `	MACRO_LD_REMOVE(sMPGlobal.pEngines,pEngine);` |
|    3463 |  635 | `	sMPGlobal.nEngine--;` |
|       - |  636 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  637 | `	/* Leave the global mutex */` |
|    3463 |  638 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  639 | `#endif` |
|       - |  640 | `	/* Release the memory chunk allocated to this engine */` |
|    3463 |  641 | `	SyMemBackendPoolFree(&sMPGlobal.sAllocator,pEngine);` |
|    3463 |  642 | `	return rc;` |
|    1734 |  643 | `}` |
|       - |  644 | `/*` |
...
|    3823 |  689 | `		PH7_VmPushFilePath(pVm,zFilePath,-1,TRUE,0);` |
|    1909 |  690 | `	}` |
|       - |  691 | `	/* Reset the error message consumer */` |
|    3831 |  692 | `	SyBlobReset(&pEngine->xConf.sErrConsumer);` |
|       - |  693 | `	/* Enforce input size cap before touching the lexer/compiler */` |
|       - |  694 | `	{` |
|    3831 |  695 | `		sxu32 nLimit = pEngine->xConf.nMaxInput ? pEngine->xConf.nMaxInput : PH7_MAX_INPUT_SIZE;` |
|    3831 |  696 | `		if( SyStringLength(pScript) > nLimit ){` |
...
|    3831 |  703 | `	if( pVm->sCodeGen.nErr == 0 ){` |
|    3831 |  704 | `		PH7_CompileScript(pVm,&(*pScript),iFlags);` |
|    1913 |  705 | `	}` |
|    3831 |  706 | `	if( pVm->sCodeGen.nErr > 0 \|\| pVm == 0){` |
...
|    3459 |  717 | `	rc = PH7_VmMakeReady(pVm);` |
|    3459 |  718 | `	if( rc != PH7_OK ){` |
|       3 |  719 | `		goto Release;` |
|       - |  720 | `	}` |
|       - |  721 | `	/* Install local import path which is the current directory */` |
|    3457 |  722 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IMPORT_PATH,"./");` |
|       - |  723 | `#if defined(PH7_ENABLE_THREADS)` |
|    3457 |  724 | `	if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE ){` |
|       - |  725 | `		 /* Associate a recursive mutex with this instance */` |
|    3457 |  726 | `		 pVm->pMutex = SyMutexNew(sMPGlobal.pMutexMethods,SXMUTEX_TYPE_RECURSIVE);` |
|    3457 |  727 | `		 if( pVm->pMutex == 0 ){` |
|     ! 0 |  728 | `			 goto Release;` |
|       - |  729 | `		 }` |
|    1726 |  730 | `	 }` |
|       - |  731 | `#endif` |
|       - |  732 | `	/* Script successfully compiled,link to the list of active virtual machines */` |
|    3457 |  733 | `	MACRO_LD_PUSH(pEngine->pVms,pVm);` |
|    3457 |  734 | `	pEngine->iVm++;` |
|       - |  735 | `	/* Point to the freshly created VM */` |
|    3457 |  736 | `	*ppVm = pVm;` |
|       - |  737 | `	/* Ready to execute PH7 bytecode */` |
|    3457 |  738 | `	return PH7_OK;` |
|       1 |  739 | `Release:` |
|       - |  740 | `	{` |
...
|       - |  821 | ` */` |
|    3818 |  822 | `int ph7_compile_file(ph7 *pEngine,const char *zFilePath,ph7_vm **ppOutVm,int iFlags)` |
|       5 |  823 | `{` |
...
|    3823 |  827 | `		*ppOutVm = 0;` |
|    1909 |  828 | `	}` |
|    3823 |  829 | `	rc = PH7_OK; /* cc warning */` |
|    3823 |  830 | `	if( PH7_ENGINE_MISUSE(pEngine) \|\| SX_EMPTY_STR(zFilePath) ){` |
|     ! 0 |  831 | `		return PH7_CORRUPT;` |
|       - |  832 | `	}` |
|       - |  833 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  834 | `	 /* Acquire engine mutex */` |
|    3823 |  835 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3823 |  836 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3818 |  837 | `		 PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
...
|       - |  844 | `	  */` |
|    3823 |  845 | `	 pVfs = pEngine->pVfs;` |
|    3823 |  846 | `	 if( pVfs == 0 \|\| pVfs->xMmap == 0 ){` |
|       - |  847 | `		 /* Memory map routine not implemented */` |
|     ! 0 |  848 | `		 rc = PH7_IO_ERR;` |
|     ! 0 |  849 | `	 }else{` |
|    3823 |  850 | `		 void *pMapView = 0; /* cc warning */` |
|    3823 |  851 | `		 ph7_int64 nSize = 0; /* cc warning */` |
|       - |  852 | `		 SyString sScript;` |
|       - |  853 | `		 /* Try to get a memory view of the whole file */` |
|    3823 |  854 | `		 rc = pVfs->xMmap(zFilePath,&pMapView,&nSize);` |
|    3823 |  855 | `		 if( rc != PH7_OK ){` |
|       - |  856 | `			 /* Assume an IO error */` |
|     ! 0 |  857 | `			 rc = PH7_IO_ERR;` |
|     ! 0 |  858 | `		 }else{` |
|       - |  859 | `			 /* Compile the file */` |
|    3823 |  860 | `			 SyStringInitFromBuf(&sScript,pMapView,nSize);` |
|    3823 |  861 | `			 rc = ProcessScript(&(*pEngine),ppOutVm,&sScript,iFlags,zFilePath);` |
|       - |  862 | `			 /* Release the memory view of the whole file */` |
|    3823 |  863 | `			 if( pVfs->xUnmap ){` |
|    3823 |  864 | `				 pVfs->xUnmap(pMapView,nSize);` |
|    1909 |  865 | `			 }` |
|       - |  866 | `		 }` |
|       - |  867 | `	 }` |
|       - |  868 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  869 | `	 /* Leave engine mutex */` |
|    3823 |  870 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  871 | `#endif` |
...
|       - |  898 | ` */` |
|   79866 |  899 | `int ph7_vm_config(ph7_vm *pVm,int iConfigOp,...)` |
|       5 |  900 | `{` |
|       - |  901 | `	va_list ap;` |
|       - |  902 | `	int rc;` |
|       - |  903 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   79871 |  904 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  905 | `		return PH7_CORRUPT;` |
|       - |  906 | `	}` |
|       - |  907 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  908 | `	 /* Acquire VM mutex */` |
|   79871 |  909 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|   79871 |  910 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|   79866 |  911 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 |  912 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  913 | `	 }` |
|       - |  914 | `#endif` |
|       - |  915 | `	/* Confiugure the virtual machine */` |
|   79871 |  916 | `	va_start(ap,iConfigOp);` |
|   79871 |  917 | `	rc = PH7_VmConfigure(&(*pVm),iConfigOp,ap);` |
|   79871 |  918 | `	va_end(ap);` |
|       - |  919 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  920 | `	 /* Leave VM mutex */` |
|   79871 |  921 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  922 | `#endif` |
|   79871 |  923 | `	return rc;` |
|   39938 |  924 | `}` |
|       - |  925 | `/*` |
...
|       - |  928 | ` */` |
|    3456 |  929 | `int ph7_vm_exec(ph7_vm *pVm,int *pExitStatus)` |
|       5 |  930 | `{` |
|       - |  931 | `	int rc;` |
|       - |  932 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|    3461 |  933 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  934 | `		return PH7_CORRUPT;` |
|       - |  935 | `	}` |
|       - |  936 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  937 | `	 /* Acquire VM mutex */` |
|    3461 |  938 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3461 |  939 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3456 |  940 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 |  941 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  942 | `	 }` |
|       - |  943 | `#endif` |
|       - |  944 | `	/* Execute PH7 byte-code */` |
|    3461 |  945 | `	rc = PH7_VmByteCodeExec(&(*pVm));` |
|    3461 |  946 | `	if( pExitStatus ){` |
|       - |  947 | `		/* Exit status */` |
|    3437 |  948 | `		*pExitStatus = pVm->iExitStatus;` |
|    1716 |  949 | `	}` |
|       - |  950 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  951 | `	 /* Leave VM mutex */` |
|    3461 |  952 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  953 | `#endif` |
...
|       - |  986 | ` */` |
|    3452 |  987 | `int ph7_vm_release(ph7_vm *pVm)` |
|       5 |  988 | `{` |
|       - |  989 | `	ph7 *pEngine;` |
|       - |  990 | `	int rc;` |
|       - |  991 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|    3457 |  992 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  993 | `		return PH7_CORRUPT;` |
|       - |  994 | `	}` |
|       - |  995 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  996 | `	 /* Acquire VM mutex */` |
|    3457 |  997 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3457 |  998 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3452 |  999 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1000 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1001 | `	 }` |
|       - | 1002 | `#endif` |
|    3457 | 1003 | `	pEngine = pVm->pEngine;` |
|    3457 | 1004 | `	rc = PH7_VmRelease(&(*pVm));` |
|       - | 1005 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1006 | `	 /* Leave VM mutex */` |
|    3457 | 1007 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1008 | `#endif` |
|    3457 | 1009 | `	if( rc == PH7_OK ){` |
|       - | 1010 | `		/* Unlink from the list of active VM */` |
|       - | 1011 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1012 | `			/* Acquire engine mutex */` |
|    3457 | 1013 | `			SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3457 | 1014 | `			if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3452 | 1015 | `				PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 | 1016 | `					return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1017 | `			}` |
|       - | 1018 | `#endif` |
|    3457 | 1019 | `		MACRO_LD_REMOVE(pEngine->pVms,pVm);` |
|    3457 | 1020 | `		pEngine->iVm--;` |
|       - | 1021 | `		/* Release the memory chunk allocated to this VM */` |
|    3457 | 1022 | `		SyMemBackendPoolFree(&pEngine->sAllocator,pVm);` |
|       - | 1023 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1024 | `			/* Leave engine mutex */` |
|    3457 | 1025 | `			SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1026 | `#endif` |
|    1726 | 1027 | `	}` |
|    3457 | 1028 | `	return rc;` |
|    1731 | 1029 | `}` |
...
|       - | 1033 | ` */` |
| 1762444 | 1034 | `int ph7_create_function(ph7_vm *pVm,const char *zName,int (*xFunc)(ph7_context *,int,ph7_value **),void *pUserData)` |
|       5 | 1035 | `{` |
|       - | 1036 | `	SyString sName;` |
|       - | 1037 | `	int rc;` |
|       - | 1038 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
| 1762449 | 1039 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1040 | `		return PH7_CORRUPT;` |
|       - | 1041 | `	}` |
| 1762449 | 1042 | `	SyStringInitFromBuf(&sName,zName,SyStrlen(zName));` |
|       - | 1043 | `	/* Remove leading and trailing white spaces */` |
| 1762449 | 1044 | `	SyStringFullTrim(&sName);` |
|       - | 1045 | `	/* Ticket 1433-003: NULL values are not allowed */` |
| 1762449 | 1046 | `	if( sName.nByte < 1 \|\| xFunc == 0 ){` |
|     ! 0 | 1047 | `		return PH7_CORRUPT;` |
|       - | 1048 | `	}` |
|       - | 1049 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1050 | `	 /* Acquire VM mutex */` |
| 1762449 | 1051 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
| 1762449 | 1052 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
| 1762444 | 1053 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1054 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1055 | `	 }` |
|       - | 1056 | `#endif` |
|       - | 1057 | `	/* Install the foreign function */` |
| 1762449 | 1058 | `	rc = PH7_VmInstallForeignFunction(&(*pVm),&sName,xFunc,pUserData);` |
|       - | 1059 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1060 | `	 /* Leave VM mutex */` |
| 1762449 | 1061 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1062 | `#endif` |
| 1762449 | 1063 | `	return rc;` |
|  881227 | 1064 | `}` |
|       - | 1065 | `/*` |
...
|       - | 1102 | ` */` |
|  915318 | 1103 | `int ph7_create_constant(ph7_vm *pVm,const char *zName,void (*xExpand)(ph7_value *,void *),void *pUserData)` |
|       5 | 1104 | `{` |
|       - | 1105 | `	SyString sName;` |
|       - | 1106 | `	int rc;` |
|       - | 1107 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|  915323 | 1108 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1109 | `		return PH7_CORRUPT;` |
|       - | 1110 | `	}` |
|  915323 | 1111 | `	SyStringInitFromBuf(&sName,zName,SyStrlen(zName));` |
|       - | 1112 | `	/* Remove leading and trailing white spaces */` |
|  918777 | 1113 | `	SyStringFullTrim(&sName);` |
|  915323 | 1114 | `	if( sName.nByte < 1 ){` |
|       - | 1115 | `		/* Empty constant name */` |
|     ! 0 | 1116 | `		return PH7_CORRUPT;` |
|       - | 1117 | `	}` |
|       - | 1118 | `	/* TICKET 1433-003: NULL pointer harmless operation */` |
|  915323 | 1119 | `	if( xExpand == 0 ){` |
|     ! 0 | 1120 | `		return PH7_CORRUPT;` |
|       - | 1121 | `	}` |
|       - | 1122 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1123 | `	 /* Acquire VM mutex */` |
|  915323 | 1124 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|  915323 | 1125 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|  915318 | 1126 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1127 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1128 | `	 }` |
|       - | 1129 | `#endif` |
|       - | 1130 | `	/* Perform the registration */` |
|  915323 | 1131 | `	rc = PH7_VmRegisterConstant(&(*pVm),&sName,xExpand,pUserData);` |
|       - | 1132 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1133 | `	 /* Leave VM mutex */` |
|  915323 | 1134 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1135 | `#endif` |
|  915323 | 1136 | `	 return rc;` |
|  457664 | 1137 | `}` |
|       - | 1138 | `/*` |
...
|       - | 1174 | ` */` |
|   11676 | 1175 | `ph7_value * ph7_new_scalar(ph7_vm *pVm)` |
|       5 | 1176 | `{` |
|       - | 1177 | `	ph7_value *pObj;` |
|       - | 1178 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   11681 | 1179 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1180 | `		return 0;` |
|       - | 1181 | `	}` |
|       - | 1182 | `	/* Allocate a new scalar variable */` |
|   11681 | 1183 | `	pObj = (ph7_value *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_value));` |
|   11681 | 1184 | `	if( pObj == 0 ){` |
|     ! 0 | 1185 | `		return 0;` |
|       - | 1186 | `	}` |
|       - | 1187 | `	/* Nullify the new scalar */` |
|   11681 | 1188 | `	PH7_MemObjInit(pVm,pObj);` |
|   11681 | 1189 | `	return pObj;` |
|    5843 | 1190 | `}` |
|       - | 1191 | `/*` |
|       - | 1192 | ` * [CAPIREF: ph7_new_array()]` |
|       - | 1193 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1194 | ` */` |
|   46432 | 1195 | `ph7_value * ph7_new_array(ph7_vm *pVm)` |
|       5 | 1196 | `{` |
|       - | 1197 | `	ph7_hashmap *pMap;` |
|       - | 1198 | `	ph7_value *pObj;` |
|       - | 1199 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   46437 | 1200 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1201 | `		return 0;` |
|       - | 1202 | `	}` |
|       - | 1203 | `	/* Create a new hashmap first */` |
|   46437 | 1204 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|   46437 | 1205 | `	if( pMap == 0 ){` |
|     ! 0 | 1206 | `		return 0;` |
|       - | 1207 | `	}` |
|       - | 1208 | `	/* Associate a new ph7_value with this hashmap */` |
|   46437 | 1209 | `	pObj = (ph7_value *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_value));` |
|   46437 | 1210 | `	if( pObj == 0 ){` |
|     ! 0 | 1211 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     ! 0 | 1212 | `		return 0;` |
|       - | 1213 | `	}` |
|   46437 | 1214 | `	PH7_MemObjInitFromArray(pVm,pObj,pMap);` |
|   46437 | 1215 | `	return pObj;` |
|   23221 | 1216 | `}` |
|       - | 1217 | `/*` |
...
|       - | 1220 | ` */` |
|   38032 | 1221 | `int ph7_release_value(ph7_vm *pVm,ph7_value *pValue)` |
|       5 | 1222 | `{` |
|       - | 1223 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   38037 | 1224 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1225 | `		return PH7_CORRUPT;` |
|       - | 1226 | `	}` |
|   38037 | 1227 | `	if( pValue ){` |
|       - | 1228 | `		/* Release the value */` |
|   38037 | 1229 | `		PH7_MemObjRelease(pValue);` |
|   38037 | 1230 | `		SyMemBackendPoolFree(&pVm->sAllocator,pValue);` |
|   19016 | 1231 | `	}` |
|   38037 | 1232 | `	return PH7_OK;` |
|   19021 | 1233 | `}` |
|       - | 1234 | `/*` |
...
|       - | 1237 | ` */` |
|  401256 | 1238 | `int ph7_value_to_int(ph7_value *pValue)` |
|       5 | 1239 | `{` |
|       - | 1240 | `	int rc;` |
|  401261 | 1241 | `	rc = PH7_MemObjToInteger(pValue);` |
|  401261 | 1242 | `	if( rc != PH7_OK ){` |
|     ! 0 | 1243 | `		return 0;` |
|       - | 1244 | `	}` |
|  401261 | 1245 | `	return (int)pValue->x.iVal;` |
|  200633 | 1246 | `}` |
|       - | 1247 | `/*` |
...
|       - | 1289 | ` */` |
|  754993 | 1290 | `const char * ph7_value_to_string(ph7_value *pValue,int *pLen)` |
|       5 | 1291 | `{` |
|  754998 | 1292 | `	PH7_MemObjToString(pValue);` |
|  754998 | 1293 | `	if( SyBlobLength(&pValue->sBlob) > 0 ){` |
|  723128 | 1294 | `		SyBlobNullAppend(&pValue->sBlob);` |
|  723128 | 1295 | `		if( pLen ){` |
|  663816 | 1296 | `			*pLen = (int)SyBlobLength(&pValue->sBlob);` |
|  331948 | 1297 | `		}` |
|  723128 | 1298 | `		return (const char *)SyBlobData(&pValue->sBlob);` |
|     ! 0 | 1299 | `	}else{` |
...
|       - | 1310 | ` */` |
|   30176 | 1311 | `void * ph7_value_to_resource(ph7_value *pValue)` |
|       5 | 1312 | `{` |
|   30181 | 1313 | `	if( (pValue->iFlags & MEMOBJ_RES) == 0 ){` |
|       - | 1314 | `		/* Not a resource,return NULL */` |
|     ! 0 | 1315 | `		return 0;` |
|       - | 1316 | `	}` |
|   30181 | 1317 | `	return pValue->x.pOther;` |
|   15093 | 1318 | `}` |
|       - | 1319 | `/*` |
...
|       - | 1346 | ` */` |
|   15608 | 1347 | `int ph7_result_int64(ph7_context *pCtx,ph7_int64 iValue)` |
|       5 | 1348 | `{` |
|   15613 | 1349 | `	return ph7_value_int64(pCtx->pRet,iValue);` |
|       5 | 1350 | `}` |
|       - | 1351 | `/*` |
|       - | 1352 | ` * [CAPIREF: ph7_result_bool()]` |
|       - | 1353 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1354 | ` */` |
|  350599 | 1355 | `int ph7_result_bool(ph7_context *pCtx,int iBool)` |
|       5 | 1356 | `{` |
|  350604 | 1357 | `	return ph7_value_bool(pCtx->pRet,iBool);` |
|       5 | 1358 | `}` |
|       - | 1359 | `/*` |
...
|       - | 1380 | ` */` |
| 1138012 | 1381 | `int ph7_result_string(ph7_context *pCtx,const char *zString,int nLen)` |
|       5 | 1382 | `{` |
| 1138017 | 1383 | `	return ph7_value_string(pCtx->pRet,zString,nLen);` |
|       5 | 1384 | `}` |
|       - | 1385 | `/*` |
...
|       - | 1409 | ` */` |
|   32452 | 1410 | `int ph7_result_value(ph7_context *pCtx,ph7_value *pValue)` |
|       5 | 1411 | `{` |
|   32457 | 1412 | `	int rc = PH7_OK;` |
|   32457 | 1413 | `	if( pValue == 0 ){` |
|     ! 0 | 1414 | `		PH7_MemObjRelease(pCtx->pRet);` |
|     ! 0 | 1415 | `	}else{` |
|   32457 | 1416 | `		rc = PH7_MemObjStore(pValue,pCtx->pRet);` |
|       - | 1417 | `	}` |
|   32457 | 1418 | `	return rc;` |
|       5 | 1419 | `}` |
|       - | 1420 | `/*` |
...
|       - | 1423 | ` */` |
|    5062 | 1424 | `int ph7_result_resource(ph7_context *pCtx,void *pUserData)` |
|       5 | 1425 | `{` |
|    5067 | 1426 | `	return ph7_value_resource(pCtx->pRet,pUserData);` |
|       5 | 1427 | `}` |
|       - | 1428 | `/*` |
...
|       - | 1431 | ` */` |
|    8244 | 1432 | `ph7_value * ph7_context_new_scalar(ph7_context *pCtx)` |
|       5 | 1433 | `{` |
|       - | 1434 | `	ph7_value *pVal;` |
|    8249 | 1435 | `	pVal = ph7_new_scalar(pCtx->pVm);` |
|    8249 | 1436 | `	if( pVal ){` |
|       - | 1437 | `		/* Record value address so it can be freed automatically` |
|       - | 1438 | `		 * when the calling function returns.` |
|       - | 1439 | `		 */` |
|    8249 | 1440 | `		SySetPut(&pCtx->sVar,(const void *)&pVal);` |
|    4122 | 1441 | `	}` |
|    8249 | 1442 | `	return pVal;` |
|       5 | 1443 | `}` |
|       - | 1444 | `/*` |
...
|       - | 1447 | ` */` |
|   11832 | 1448 | `ph7_value * ph7_context_new_array(ph7_context *pCtx)` |
|       5 | 1449 | `{` |
|       - | 1450 | `	ph7_value *pVal;` |
|   11837 | 1451 | `	pVal = ph7_new_array(pCtx->pVm);` |
|   11837 | 1452 | `	if( pVal ){` |
|       - | 1453 | `		/* Record value address so it can be freed automatically` |
|       - | 1454 | `		 * when the calling function returns.` |
|       - | 1455 | `		 */` |
|   11837 | 1456 | `		SySetPut(&pCtx->sVar,(const void *)&pVal);` |
|    5916 | 1457 | `	}` |
|   11837 | 1458 | `	return pVal;` |
|       5 | 1459 | `}` |
|       - | 1460 | `/*` |
...
|       - | 1471 | ` */` |
|    5034 | 1472 | `void * ph7_context_alloc_chunk(ph7_context *pCtx,unsigned int nByte,int ZeroChunk,int AutoRelease)` |
|       5 | 1473 | `{` |
|       - | 1474 | `	void *pChunk;` |
|    5039 | 1475 | `	pChunk = SyMemBackendAlloc(&pCtx->pVm->sAllocator,nByte);` |
|    5039 | 1476 | `	if( pChunk ){` |
|    5039 | 1477 | `		if( ZeroChunk ){` |
|       - | 1478 | `			/* Zero the memory chunk */` |
|    5005 | 1479 | `			SyZero(pChunk,nByte);` |
|    2500 | 1480 | `		}` |
|    5039 | 1481 | `		if( AutoRelease ){` |
...
|       - | 1497 | ` */` |
|    4982 | 1498 | `static ph7_aux_data * ContextFindChunk(ph7_context *pCtx,void *pChunk)` |
|       5 | 1499 | `{` |
|       - | 1500 | `	ph7_aux_data *aAux,*pAux;` |
|       - | 1501 | `	sxu32 n;` |
|    4987 | 1502 | `	if( SySetUsed(&pCtx->sChunk) < 1 ){` |
...
|       - | 1538 | ` */` |
|    4982 | 1539 | `void ph7_context_free_chunk(ph7_context *pCtx,void *pChunk)` |
|       5 | 1540 | `{` |
|       - | 1541 | `	ph7_aux_data *pAux;` |
|    4987 | 1542 | `	if( pChunk == 0 ){` |
|       - | 1543 | `		/* TICKET-1433-93: NULL chunk is a harmless operation */` |
|     ! 0 | 1544 | `		return;` |
|       - | 1545 | `	}` |
|    4987 | 1546 | `	pAux = ContextFindChunk(pCtx,pChunk);` |
|    4987 | 1547 | `	if( pAux ){` |
|       - | 1548 | `		/* Mark as destroyed */` |
|     ! 0 | 1549 | `		pAux->pAuxData = 0;` |
|     ! 0 | 1550 | `	}` |
|    4987 | 1551 | `	SyMemBackendFree(&pCtx->pVm->sAllocator,pChunk);` |
|    2496 | 1552 | `}` |
|       - | 1553 | `/*` |
...
|       - | 1587 | ` */` |
|   32866 | 1588 | `int ph7_array_walk(ph7_value *pArray,int (*xWalk)(ph7_value *pValue,ph7_value *,void *),void *pUserData)` |
|       5 | 1589 | `{` |
|       - | 1590 | `	int rc;` |
|   32871 | 1591 | `	if( xWalk == 0 ){` |
|     ! 0 | 1592 | `		return PH7_CORRUPT;` |
|       - | 1593 | `	}` |
|       - | 1594 | `	/* Make sure we are dealing with a valid hashmap */` |
|   32871 | 1595 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1596 | `		return PH7_CORRUPT;` |
|       - | 1597 | `	}` |
|       - | 1598 | `	/* Start the walk process */` |
|   32871 | 1599 | `	rc = PH7_HashmapWalk((ph7_hashmap *)pArray->x.pOther,xWalk,pUserData);` |
|   32871 | 1600 | `	return rc != PH7_OK ? PH7_ABORT /* User callback request an operation abort*/ : PH7_OK;` |
|   16438 | 1601 | `}` |
|       - | 1602 | `/*` |
...
|       - | 1605 | ` */` |
| 2296944 | 1606 | `int ph7_array_add_elem(ph7_value *pArray,ph7_value *pKey,ph7_value *pValue)` |
|       5 | 1607 | `{` |
|       - | 1608 | `	int rc;` |
|       - | 1609 | `	/* Make sure we are dealing with a valid hashmap */` |
| 2296949 | 1610 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1611 | `		return PH7_CORRUPT;` |
|       - | 1612 | `	}` |
|       - | 1613 | `	/* Perform the insertion */` |
| 2296949 | 1614 | `	rc = PH7_HashmapInsert((ph7_hashmap *)pArray->x.pOther,&(*pKey),&(*pValue));` |
| 2296949 | 1615 | `	return rc;` |
| 1148477 | 1616 | `}` |
|       - | 1617 | `/*` |
...
|       - | 1662 | ` */` |
|  138828 | 1663 | `unsigned int ph7_array_count(ph7_value *pArray)` |
|       5 | 1664 | `{` |
|       - | 1665 | `	ph7_hashmap *pMap;` |
|       - | 1666 | `	/* Make sure we are dealing with a valid hashmap */` |
|  138833 | 1667 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1668 | `		return 0;` |
|       - | 1669 | `	}` |
|       - | 1670 | `	/* Point to the internal representation of the hashmap */` |
|  138833 | 1671 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|  138833 | 1672 | `	return pMap->nEntry;` |
|   69419 | 1673 | `}` |
|       - | 1674 | `/*` |
...
|       - | 1821 | ` */` |
|   59602 | 1822 | `void * ph7_context_user_data(ph7_context *pCtx)` |
|       5 | 1823 | `{` |
|   59607 | 1824 | `	return pCtx->pFunc->pUserData;` |
|       5 | 1825 | `}` |
|       - | 1826 | `/*` |
...
|       - | 1861 | ` */` |
|    6444 | 1862 | `unsigned int ph7_context_result_buf_length(ph7_context *pCtx)` |
|       5 | 1863 | `{` |
|    6449 | 1864 | `	return SyBlobLength(&pCtx->pRet->sBlob);` |
|       5 | 1865 | `}` |
|       - | 1866 | `/*` |
...
|       - | 1869 | ` */` |
|   28422 | 1870 | `const char * ph7_function_name(ph7_context *pCtx)` |
|       5 | 1871 | `{` |
|       - | 1872 | `	SyString *pName;` |
|   28427 | 1873 | `	pName = &pCtx->pFunc->sName;` |
|   28427 | 1874 | `	return pName->zString;` |
|       5 | 1875 | `}` |
|       - | 1876 | `/*` |
|       - | 1877 | ` * [CAPIREF: ph7_value_int()]` |
|       - | 1878 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1879 | ` */` |
|   36446 | 1880 | `int ph7_value_int(ph7_value *pVal,int iValue)` |
|       5 | 1881 | `{` |
|       - | 1882 | `	/* Invalidate any prior representation */` |
|   36451 | 1883 | `	PH7_MemObjRelease(pVal);` |
|   36451 | 1884 | `	pVal->x.iVal = (ph7_int64)iValue;` |
|   36451 | 1885 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|   36451 | 1886 | `	return PH7_OK;` |
|       5 | 1887 | `}` |
|       - | 1888 | `/*` |
|       - | 1889 | ` * [CAPIREF: ph7_value_int64()]` |
|       - | 1890 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1891 | ` */` |
|   15756 | 1892 | `int ph7_value_int64(ph7_value *pVal,ph7_int64 iValue)` |
|       5 | 1893 | `{` |
|       - | 1894 | `	/* Invalidate any prior representation */` |
|   15761 | 1895 | `	PH7_MemObjRelease(pVal);` |
|   15761 | 1896 | `	pVal->x.iVal = iValue;` |
|   15761 | 1897 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|   15761 | 1898 | `	return PH7_OK;` |
|       5 | 1899 | `}` |
|       - | 1900 | `/*` |
|       - | 1901 | ` * [CAPIREF: ph7_value_bool()]` |
|       - | 1902 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1903 | ` */` |
|  350605 | 1904 | `int ph7_value_bool(ph7_value *pVal,int iBool)` |
|       5 | 1905 | `{` |
|       - | 1906 | `	/* Invalidate any prior representation */` |
|  350610 | 1907 | `	PH7_MemObjRelease(pVal);` |
|  350610 | 1908 | `	pVal->x.iVal = iBool ? 1 : 0;` |
|  350610 | 1909 | `	MemObjSetType(pVal,MEMOBJ_BOOL);` |
|  350610 | 1910 | `	return PH7_OK;` |
|       5 | 1911 | `}` |
|       - | 1912 | `/*` |
...
|       - | 1939 | ` */` |
| 1299186 | 1940 | `int ph7_value_string(ph7_value *pVal,const char *zString,int nLen)` |
|       5 | 1941 | `{` |
| 1299191 | 1942 | `	if((pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - | 1943 | `		/* Invalidate any prior representation */` |
|  385041 | 1944 | `		PH7_MemObjRelease(pVal);` |
|  385041 | 1945 | `		MemObjSetType(pVal,MEMOBJ_STRING);` |
|  192518 | 1946 | `	}` |
| 1299191 | 1947 | `	if( zString ){` |
| 1298117 | 1948 | `		if( nLen < 0 ){` |
|       - | 1949 | `			/* Compute length automatically */` |
|    5071 | 1950 | `			nLen = (int)SyStrlen(zString);` |
|    2533 | 1951 | `		}` |
...
| 1298117 | 1954 | `		return SyBlobAppend(&pVal->sBlob,(const void *)zString,(sxu32)nLen);` |
|       - | 1955 | `	}` |
...
|       - | 1980 | ` */` |
|  148304 | 1981 | `int ph7_value_reset_string_cursor(ph7_value *pVal)` |
|       5 | 1982 | `{` |
|       - | 1983 | `	/* Reset the string cursor */` |
|  148309 | 1984 | `	SyBlobReset(&pVal->sBlob);` |
|  148309 | 1985 | `	return PH7_OK;` |
|       5 | 1986 | `}` |
|       - | 1987 | `/*` |
...
|       - | 1990 | ` */` |
|    5152 | 1991 | `int ph7_value_resource(ph7_value *pVal,void *pUserData)` |
|       5 | 1992 | `{` |
|       - | 1993 | `	/* Invalidate any prior representation */` |
|    5157 | 1994 | `	PH7_MemObjRelease(pVal);` |
|       - | 1995 | `	/* Reflect the new type */` |
|    5157 | 1996 | `	pVal->x.pOther = pUserData;` |
|    5157 | 1997 | `	MemObjSetType(pVal,MEMOBJ_RES);` |
|    5157 | 1998 | `	return PH7_OK;` |
|       5 | 1999 | `}` |
|       - | 2000 | `/*` |
...
|       - | 2003 | ` */` |
|    3960 | 2004 | `int ph7_value_release(ph7_value *pVal)` |
|       5 | 2005 | `{` |
|    3965 | 2006 | `	PH7_MemObjRelease(pVal);` |
|    3965 | 2007 | `	return PH7_OK;` |
|       5 | 2008 | `}` |
|       - | 2009 | `/*` |
...
|       - | 2012 | ` */` |
|   14160 | 2013 | `int ph7_value_is_int(ph7_value *pVal)` |
|       5 | 2014 | `{` |
...
|   14165 | 2020 | `	return (pVal->iFlags & MEMOBJ_INT) ? TRUE : FALSE;` |
|       5 | 2021 | `}` |
|       - | 2022 | `/*` |
...
|       - | 2041 | ` */` |
|  103996 | 2042 | `int ph7_value_is_string(ph7_value *pVal)` |
|       5 | 2043 | `{` |
|  104001 | 2044 | `	return (pVal->iFlags & MEMOBJ_STRING) ? TRUE : FALSE;` |
|       5 | 2045 | `}` |
|       - | 2046 | `/*` |
...
|       - | 2085 | ` */` |
|  163190 | 2086 | `int ph7_value_is_array(ph7_value *pVal)` |
|       5 | 2087 | `{` |
|  163195 | 2088 | `	return (pVal->iFlags & MEMOBJ_HASHMAP) ? TRUE : FALSE;` |
|       5 | 2089 | `}` |
|       - | 2090 | `/*` |
...
|       - | 2101 | ` */` |
|   32384 | 2102 | `int ph7_value_is_resource(ph7_value *pVal)` |
|       5 | 2103 | `{` |
|   32389 | 2104 | `	return (pVal->iFlags & MEMOBJ_RES) ? TRUE : FALSE;` |
|       5 | 2105 | `}` |
|       - | 2106 | `/*` |
...
|       - | 2109 | ` */` |
|   33724 | 2110 | `int ph7_value_is_empty(ph7_value *pVal)` |
|       5 | 2111 | `{` |
|       - | 2112 | `	int rc;` |
|   33729 | 2113 | `	rc = PH7_MemObjIsEmpty(pVal);` |
|   33729 | 2114 | `	return rc;` |
|       5 | 2115 | `}` |
|       - | 2116 | `/*` |
