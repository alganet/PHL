...
|       - |  606 | ` */` |
|    3434 |  607 | `int ph7_release(ph7 *pEngine)` |
|       5 |  608 | `{` |
|       - |  609 | `	int rc;` |
|    3439 |  610 | `	if( PH7_ENGINE_MISUSE(pEngine) ){` |
|     ! 0 |  611 | `		return PH7_CORRUPT;` |
|       - |  612 | `	}` |
|       - |  613 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  614 | `	 /* Acquire engine mutex */` |
|    3439 |  615 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3439 |  616 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3434 |  617 | `		 PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 |  618 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  619 | `	 }` |
|       - |  620 | `#endif` |
|       - |  621 | `	/* Release the engine */` |
|    3439 |  622 | `	rc = EngineRelease(&(*pEngine));` |
|       - |  623 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  624 | `	 /* Leave engine mutex */` |
|    3439 |  625 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  626 | `	 /* Release engine mutex */` |
|    3439 |  627 | `	 SyMutexRelease(sMPGlobal.pMutexMethods,pEngine->pMutex) /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  628 | `#endif` |
|       - |  629 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  630 | `	/* Enter the global mutex */` |
|    3439 |  631 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  632 | `#endif` |
|       - |  633 | `	/* Unlink from the list of active engines */` |
|    3439 |  634 | `	MACRO_LD_REMOVE(sMPGlobal.pEngines,pEngine);` |
|    3439 |  635 | `	sMPGlobal.nEngine--;` |
|       - |  636 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  637 | `	/* Leave the global mutex */` |
|    3439 |  638 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,sMPGlobal.pMutex); /* NO-OP if sMPGlobal.nThreadingLevel == PH7_THREAD_LEVEL_SINGLE */` |
|       - |  639 | `#endif` |
|       - |  640 | `	/* Release the memory chunk allocated to this engine */` |
|    3439 |  641 | `	SyMemBackendPoolFree(&sMPGlobal.sAllocator,pEngine);` |
|    3439 |  642 | `	return rc;` |
|    1722 |  643 | `}` |
|       - |  644 | `/*` |
...
|    3431 |  721 | `	rc = PH7_VmMakeReady(pVm);` |
|    3431 |  722 | `	if( rc != PH7_OK ){` |
|       3 |  723 | `		goto Release;` |
|       - |  724 | `	}` |
|       - |  725 | `	/* Install local import path which is the current directory */` |
|    3429 |  726 | `	ph7_vm_config(pVm,PH7_VM_CONFIG_IMPORT_PATH,"./");` |
|       - |  727 | `#if defined(PH7_ENABLE_THREADS)` |
|    3429 |  728 | `	if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE ){` |
|       - |  729 | `		 /* Associate a recursive mutex with this instance */` |
|    3429 |  730 | `		 pVm->pMutex = SyMutexNew(sMPGlobal.pMutexMethods,SXMUTEX_TYPE_RECURSIVE);` |
|    3429 |  731 | `		 if( pVm->pMutex == 0 ){` |
|     ! 0 |  732 | `			 goto Release;` |
|       - |  733 | `		 }` |
|    1712 |  734 | `	 }` |
|       - |  735 | `#endif` |
|       - |  736 | `	/* Script successfully compiled,link to the list of active virtual machines */` |
|    3429 |  737 | `	MACRO_LD_PUSH(pEngine->pVms,pVm);` |
|    3429 |  738 | `	pEngine->iVm++;` |
|       - |  739 | `	/* Point to the freshly created VM */` |
|    3429 |  740 | `	*ppVm = pVm;` |
|       - |  741 | `	/* Ready to execute PH7 bytecode */` |
|    3429 |  742 | `	return PH7_OK;` |
|       1 |  743 | `Release:` |
|       - |  744 | `	{` |
...
|       - |  902 | ` */` |
|   89654 |  903 | `int ph7_vm_config(ph7_vm *pVm,int iConfigOp,...)` |
|       5 |  904 | `{` |
|       - |  905 | `	va_list ap;` |
|       - |  906 | `	int rc;` |
|       - |  907 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   89659 |  908 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  909 | `		return PH7_CORRUPT;` |
|       - |  910 | `	}` |
|       - |  911 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  912 | `	 /* Acquire VM mutex */` |
|   89659 |  913 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|   89659 |  914 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|   89654 |  915 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 |  916 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  917 | `	 }` |
|       - |  918 | `#endif` |
|       - |  919 | `	/* Confiugure the virtual machine */` |
|   89659 |  920 | `	va_start(ap,iConfigOp);` |
|   89659 |  921 | `	rc = PH7_VmConfigure(&(*pVm),iConfigOp,ap);` |
|   89659 |  922 | `	va_end(ap);` |
|       - |  923 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  924 | `	 /* Leave VM mutex */` |
|   89659 |  925 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  926 | `#endif` |
|   89659 |  927 | `	return rc;` |
|   44832 |  928 | `}` |
|       - |  929 | `/*` |
...
|       - |  932 | ` */` |
|    3430 |  933 | `int ph7_vm_exec(ph7_vm *pVm,int *pExitStatus)` |
|       5 |  934 | `{` |
|       - |  935 | `	int rc;` |
|       - |  936 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|    3435 |  937 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  938 | `		return PH7_CORRUPT;` |
|       - |  939 | `	}` |
|       - |  940 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  941 | `	 /* Acquire VM mutex */` |
|    3435 |  942 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3435 |  943 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3430 |  944 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 |  945 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - |  946 | `	 }` |
|       - |  947 | `#endif` |
|       - |  948 | `	/* Execute PH7 byte-code */` |
|    3435 |  949 | `	rc = PH7_VmByteCodeExec(&(*pVm));` |
|    3435 |  950 | `	if( pExitStatus ){` |
|       - |  951 | `		/* Exit status */` |
|    3403 |  952 | `		*pExitStatus = pVm->iExitStatus;` |
|    1699 |  953 | `	}` |
|       - |  954 | `#if defined(PH7_ENABLE_THREADS)` |
|       - |  955 | `	 /* Leave VM mutex */` |
|    3435 |  956 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - |  957 | `#endif` |
...
|       - |  990 | ` */` |
|    3424 |  991 | `int ph7_vm_release(ph7_vm *pVm)` |
|       5 |  992 | `{` |
|       - |  993 | `	ph7 *pEngine;` |
|       - |  994 | `	int rc;` |
|       - |  995 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|    3429 |  996 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 |  997 | `		return PH7_CORRUPT;` |
|       - |  998 | `	}` |
|       - |  999 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1000 | `	 /* Acquire VM mutex */` |
|    3429 | 1001 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3429 | 1002 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3424 | 1003 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1004 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1005 | `	 }` |
|       - | 1006 | `#endif` |
|    3429 | 1007 | `	pEngine = pVm->pEngine;` |
|    3429 | 1008 | `	rc = PH7_VmRelease(&(*pVm));` |
|       - | 1009 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1010 | `	 /* Leave VM mutex */` |
|    3429 | 1011 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3429 | 1012 | `	 if( rc == PH7_OK && pVm->pMutex ){` |
...
|    3429 | 1015 | `		 SyMutexRelease(sMPGlobal.pMutexMethods,pVm->pMutex);` |
|    3429 | 1016 | `		 pVm->pMutex = 0;` |
|    1712 | 1017 | `	 }` |
|       - | 1018 | `#endif` |
|    3429 | 1019 | `	if( rc == PH7_OK ){` |
|       - | 1020 | `		/* Unlink from the list of active VM */` |
|       - | 1021 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1022 | `			/* Acquire engine mutex */` |
|    3429 | 1023 | `			SyMutexEnter(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|    3429 | 1024 | `			if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
|    3424 | 1025 | `				PH7_THRD_ENGINE_RELEASE(pEngine) ){` |
|     ! 0 | 1026 | `					return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1027 | `			}` |
|       - | 1028 | `#endif` |
|    3429 | 1029 | `		MACRO_LD_REMOVE(pEngine->pVms,pVm);` |
|    3429 | 1030 | `		pEngine->iVm--;` |
|       - | 1031 | `		/* Release the memory chunk allocated to this VM */` |
|    3429 | 1032 | `		SyMemBackendPoolFree(&pEngine->sAllocator,pVm);` |
|       - | 1033 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1034 | `			/* Leave engine mutex */` |
|    3429 | 1035 | `			SyMutexLeave(sMPGlobal.pMutexMethods,pEngine->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1036 | `#endif` |
|    1712 | 1037 | `	}` |
|    3429 | 1038 | `	return rc;` |
|    1717 | 1039 | `}` |
...
|       - | 1043 | ` */` |
| 2240076 | 1044 | `int ph7_create_function(ph7_vm *pVm,const char *zName,int (*xFunc)(ph7_context *,int,ph7_value **),void *pUserData)` |
|       5 | 1045 | `{` |
|       - | 1046 | `	SyString sName;` |
|       - | 1047 | `	int rc;` |
|       - | 1048 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
| 2240081 | 1049 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1050 | `		return PH7_CORRUPT;` |
|       - | 1051 | `	}` |
| 2240081 | 1052 | `	SyStringInitFromBuf(&sName,zName,SyStrlen(zName));` |
|       - | 1053 | `	/* Remove leading and trailing white spaces */` |
| 2240081 | 1054 | `	SyStringFullTrim(&sName);` |
|       - | 1055 | `	/* Ticket 1433-003: NULL values are not allowed */` |
| 2240081 | 1056 | `	if( sName.nByte < 1 \|\| xFunc == 0 ){` |
|     ! 0 | 1057 | `		return PH7_CORRUPT;` |
|       - | 1058 | `	}` |
|       - | 1059 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1060 | `	 /* Acquire VM mutex */` |
| 2240081 | 1061 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
| 2240081 | 1062 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
| 2240076 | 1063 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1064 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1065 | `	 }` |
|       - | 1066 | `#endif` |
|       - | 1067 | `	/* Install the foreign function */` |
| 2240081 | 1068 | `	rc = PH7_VmInstallForeignFunction(&(*pVm),&sName,xFunc,pUserData);` |
|       - | 1069 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1070 | `	 /* Leave VM mutex */` |
| 2240081 | 1071 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1072 | `#endif` |
| 2240081 | 1073 | `	return rc;` |
| 1120043 | 1074 | `}` |
|       - | 1075 | `/*` |
...
|       - | 1112 | ` */` |
| 1527992 | 1113 | `int ph7_create_constant(ph7_vm *pVm,const char *zName,void (*xExpand)(ph7_value *,void *),void *pUserData)` |
|       5 | 1114 | `{` |
|       - | 1115 | `	SyString sName;` |
|       - | 1116 | `	int rc;` |
|       - | 1117 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
| 1527997 | 1118 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1119 | `		return PH7_CORRUPT;` |
|       - | 1120 | `	}` |
| 1527997 | 1121 | `	SyStringInitFromBuf(&sName,zName,SyStrlen(zName));` |
|       - | 1122 | `	/* Remove leading and trailing white spaces */` |
| 1531423 | 1123 | `	SyStringFullTrim(&sName);` |
| 1527997 | 1124 | `	if( sName.nByte < 1 ){` |
|       - | 1125 | `		/* Empty constant name */` |
|     ! 0 | 1126 | `		return PH7_CORRUPT;` |
|       - | 1127 | `	}` |
|       - | 1128 | `	/* TICKET 1433-003: NULL pointer harmless operation */` |
| 1527997 | 1129 | `	if( xExpand == 0 ){` |
|     ! 0 | 1130 | `		return PH7_CORRUPT;` |
|       - | 1131 | `	}` |
|       - | 1132 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1133 | `	 /* Acquire VM mutex */` |
| 1527997 | 1134 | `	 SyMutexEnter(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
| 1527997 | 1135 | `	 if( sMPGlobal.nThreadingLevel > PH7_THREAD_LEVEL_SINGLE &&` |
| 1527992 | 1136 | `		 PH7_THRD_VM_RELEASE(pVm) ){` |
|     ! 0 | 1137 | `			 return PH7_ABORT; /* Another thread have released this instance */` |
|       - | 1138 | `	 }` |
|       - | 1139 | `#endif` |
|       - | 1140 | `	/* Perform the registration */` |
| 1527997 | 1141 | `	rc = PH7_VmRegisterConstant(&(*pVm),&sName,xExpand,pUserData);` |
|       - | 1142 | `#if defined(PH7_ENABLE_THREADS)` |
|       - | 1143 | `	 /* Leave VM mutex */` |
| 1527997 | 1144 | `	 SyMutexLeave(sMPGlobal.pMutexMethods,pVm->pMutex); /* NO-OP if sMPGlobal.nThreadingLevel != PH7_THREAD_LEVEL_MULTI */` |
|       - | 1145 | `#endif` |
| 1527997 | 1146 | `	 return rc;` |
|  764001 | 1147 | `}` |
|       - | 1148 | `/*` |
...
|       - | 1184 | ` */` |
|   44595 | 1185 | `ph7_value * ph7_new_scalar(ph7_vm *pVm)` |
|       5 | 1186 | `{` |
|       - | 1187 | `	ph7_value *pObj;` |
|       - | 1188 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   44600 | 1189 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1190 | `		return 0;` |
|       - | 1191 | `	}` |
|       - | 1192 | `	/* Allocate a new scalar variable */` |
|   44600 | 1193 | `	pObj = (ph7_value *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_value));` |
|   44600 | 1194 | `	if( pObj == 0 ){` |
|     ! 0 | 1195 | `		return 0;` |
|       - | 1196 | `	}` |
|       - | 1197 | `	/* Nullify the new scalar */` |
|   44600 | 1198 | `	PH7_MemObjInit(pVm,pObj);` |
|   44600 | 1199 | `	return pObj;` |
|   22302 | 1200 | `}` |
|       - | 1201 | `/*` |
|       - | 1202 | ` * [CAPIREF: ph7_new_array()]` |
|       - | 1203 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1204 | ` */` |
|   56996 | 1205 | `ph7_value * ph7_new_array(ph7_vm *pVm)` |
|       5 | 1206 | `{` |
|       - | 1207 | `	ph7_hashmap *pMap;` |
|       - | 1208 | `	ph7_value *pObj;` |
|       - | 1209 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   57001 | 1210 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1211 | `		return 0;` |
|       - | 1212 | `	}` |
|       - | 1213 | `	/* Create a new hashmap first */` |
|   57001 | 1214 | `	pMap = PH7_NewHashmap(&(*pVm),0,0);` |
|   57001 | 1215 | `	if( pMap == 0 ){` |
|     ! 0 | 1216 | `		return 0;` |
|       - | 1217 | `	}` |
|       - | 1218 | `	/* Associate a new ph7_value with this hashmap */` |
|   57001 | 1219 | `	pObj = (ph7_value *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_value));` |
|   57001 | 1220 | `	if( pObj == 0 ){` |
|     ! 0 | 1221 | `		PH7_HashmapRelease(pMap,TRUE);` |
|     ! 0 | 1222 | `		return 0;` |
|       - | 1223 | `	}` |
|   57001 | 1224 | `	PH7_MemObjInitFromArray(pVm,pObj,pMap);` |
|   57001 | 1225 | `	return pObj;` |
|   28503 | 1226 | `}` |
|       - | 1227 | `/*` |
...
|       - | 1230 | ` */` |
|   44960 | 1231 | `int ph7_release_value(ph7_vm *pVm,ph7_value *pValue)` |
|       5 | 1232 | `{` |
|       - | 1233 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   44965 | 1234 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1235 | `		return PH7_CORRUPT;` |
|       - | 1236 | `	}` |
|   44965 | 1237 | `	if( pValue ){` |
|       - | 1238 | `		/* Release the value */` |
|   44965 | 1239 | `		PH7_MemObjRelease(pValue);` |
|   44965 | 1240 | `		SyMemBackendPoolFree(&pVm->sAllocator,pValue);` |
|   22480 | 1241 | `	}` |
|   44965 | 1242 | `	return PH7_OK;` |
|   22485 | 1243 | `}` |
|       - | 1244 | `/*` |
...
|       - | 1273 | ` */` |
|  504175 | 1274 | `ph7_int64 ph7_value_to_int64(ph7_value *pValue)` |
|       5 | 1275 | `{` |
|       - | 1276 | `	int rc;` |
|  504180 | 1277 | `	rc = PH7_MemObjToInteger(pValue);` |
|  504180 | 1278 | `	if( rc != PH7_OK ){` |
|     ! 0 | 1279 | `		return 0;` |
|       - | 1280 | `	}` |
|  504180 | 1281 | `	return pValue->x.iVal;` |
|  252196 | 1282 | `}` |
|       - | 1283 | `/*` |
...
|       - | 1299 | ` */` |
|  897026 | 1300 | `const char * ph7_value_to_string(ph7_value *pValue,int *pLen)` |
|       5 | 1301 | `{` |
|  897031 | 1302 | `	PH7_MemObjToString(pValue);` |
|  897031 | 1303 | `	if( SyBlobLength(&pValue->sBlob) > 0 ){` |
|  863605 | 1304 | `		SyBlobNullAppend(&pValue->sBlob);` |
|  863605 | 1305 | `		if( pLen ){` |
|  800887 | 1306 | `			*pLen = (int)SyBlobLength(&pValue->sBlob);` |
|  400807 | 1307 | `		}` |
|  863605 | 1308 | `		return (const char *)SyBlobData(&pValue->sBlob);` |
|     ! 0 | 1309 | `	}else{` |
...
|       - | 1320 | ` */` |
|   33926 | 1321 | `void * ph7_value_to_resource(ph7_value *pValue)` |
|       5 | 1322 | `{` |
|   33931 | 1323 | `	if( (pValue->iFlags & MEMOBJ_RES) == 0 ){` |
|       - | 1324 | `		/* Not a resource,return NULL */` |
|     ! 0 | 1325 | `		return 0;` |
|       - | 1326 | `	}` |
|   33931 | 1327 | `	return pValue->x.pOther;` |
|   16968 | 1328 | `}` |
|       - | 1329 | `/*` |
...
|       - | 1356 | ` */` |
|   20640 | 1357 | `int ph7_result_int64(ph7_context *pCtx,ph7_int64 iValue)` |
|       5 | 1358 | `{` |
|   20645 | 1359 | `	return ph7_value_int64(pCtx->pRet,iValue);` |
|       5 | 1360 | `}` |
|       - | 1361 | `/*` |
|       - | 1362 | ` * [CAPIREF: ph7_result_bool()]` |
|       - | 1363 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1364 | ` */` |
|  319621 | 1365 | `int ph7_result_bool(ph7_context *pCtx,int iBool)` |
|       5 | 1366 | `{` |
|  319626 | 1367 | `	return ph7_value_bool(pCtx->pRet,iBool);` |
|       5 | 1368 | `}` |
|       - | 1369 | `/*` |
...
|       - | 1390 | ` */` |
| 1287817 | 1391 | `int ph7_result_string(ph7_context *pCtx,const char *zString,int nLen)` |
|       5 | 1392 | `{` |
| 1287822 | 1393 | `	return ph7_value_string(pCtx->pRet,zString,nLen);` |
|       5 | 1394 | `}` |
|       - | 1395 | `/*` |
...
|       - | 1419 | ` */` |
|   34276 | 1420 | `int ph7_result_value(ph7_context *pCtx,ph7_value *pValue)` |
|       5 | 1421 | `{` |
|   34281 | 1422 | `	int rc = PH7_OK;` |
|   34281 | 1423 | `	if( pValue == 0 ){` |
|     ! 0 | 1424 | `		PH7_MemObjRelease(pCtx->pRet);` |
|     ! 0 | 1425 | `	}else{` |
|   34281 | 1426 | `		rc = PH7_MemObjStore(pValue,pCtx->pRet);` |
|       - | 1427 | `	}` |
|   34281 | 1428 | `	return rc;` |
|       5 | 1429 | `}` |
|       - | 1430 | `/*` |
...
|       - | 1433 | ` */` |
|    5512 | 1434 | `int ph7_result_resource(ph7_context *pCtx,void *pUserData)` |
|       5 | 1435 | `{` |
|    5517 | 1436 | `	return ph7_value_resource(pCtx->pRet,pUserData);` |
|       5 | 1437 | `}` |
|       - | 1438 | `/*` |
...
|       - | 1481 | ` */` |
|    5554 | 1482 | `void * ph7_context_alloc_chunk(ph7_context *pCtx,unsigned int nByte,int ZeroChunk,int AutoRelease)` |
|       5 | 1483 | `{` |
|       - | 1484 | `	void *pChunk;` |
|    5559 | 1485 | `	pChunk = SyMemBackendAlloc(&pCtx->pVm->sAllocator,nByte);` |
|    5559 | 1486 | `	if( pChunk ){` |
|    5559 | 1487 | `		if( ZeroChunk ){` |
|       - | 1488 | `			/* Zero the memory chunk */` |
|    5309 | 1489 | `			SyZero(pChunk,nByte);` |
|    2652 | 1490 | `		}` |
|    5559 | 1491 | `		if( AutoRelease ){` |
...
|       - | 1597 | ` */` |
|   34004 | 1598 | `int ph7_array_walk(ph7_value *pArray,int (*xWalk)(ph7_value *pValue,ph7_value *,void *),void *pUserData)` |
|       5 | 1599 | `{` |
|       - | 1600 | `	int rc;` |
|   34009 | 1601 | `	if( xWalk == 0 ){` |
|     ! 0 | 1602 | `		return PH7_CORRUPT;` |
|       - | 1603 | `	}` |
|       - | 1604 | `	/* Make sure we are dealing with a valid hashmap */` |
|   34009 | 1605 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1606 | `		return PH7_CORRUPT;` |
|       - | 1607 | `	}` |
|       - | 1608 | `	/* Start the walk process */` |
|   34009 | 1609 | `	rc = PH7_HashmapWalk((ph7_hashmap *)pArray->x.pOther,xWalk,pUserData);` |
|   34009 | 1610 | `	return rc != PH7_OK ? PH7_ABORT /* User callback request an operation abort*/ : PH7_OK;` |
|   17007 | 1611 | `}` |
|       - | 1612 | `/*` |
...
|       - | 1615 | ` */` |
|  602795 | 1616 | `int ph7_array_add_elem(ph7_value *pArray,ph7_value *pKey,ph7_value *pValue)` |
|       5 | 1617 | `{` |
|       - | 1618 | `	int rc;` |
|       - | 1619 | `	/* Make sure we are dealing with a valid hashmap */` |
|  602800 | 1620 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1621 | `		return PH7_CORRUPT;` |
|       - | 1622 | `	}` |
|       - | 1623 | `	/* Perform the insertion */` |
|  602800 | 1624 | `	rc = PH7_HashmapInsert((ph7_hashmap *)pArray->x.pOther,&(*pKey),&(*pValue));` |
|  602800 | 1625 | `	return rc;` |
|  301402 | 1626 | `}` |
|       - | 1627 | `/*` |
...
|       - | 1672 | ` */` |
|  157812 | 1673 | `unsigned int ph7_array_count(ph7_value *pArray)` |
|       5 | 1674 | `{` |
|       - | 1675 | `	ph7_hashmap *pMap;` |
|       - | 1676 | `	/* Make sure we are dealing with a valid hashmap */` |
|  157817 | 1677 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1678 | `		return 0;` |
|       - | 1679 | `	}` |
|       - | 1680 | `	/* Point to the internal representation of the hashmap */` |
|  157817 | 1681 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|  157817 | 1682 | `	return pMap->nEntry;` |
|   78911 | 1683 | `}` |
|       - | 1684 | `/*` |
...
|       - | 1831 | ` */` |
|   61940 | 1832 | `void * ph7_context_user_data(ph7_context *pCtx)` |
|       5 | 1833 | `{` |
|   61945 | 1834 | `	return pCtx->pFunc->pUserData;` |
|       5 | 1835 | `}` |
|       - | 1836 | `/*` |
...
|       - | 1879 | ` */` |
|   49790 | 1880 | `const char * ph7_function_name(ph7_context *pCtx)` |
|       5 | 1881 | `{` |
|       - | 1882 | `	SyString *pName;` |
|   49795 | 1883 | `	pName = &pCtx->pFunc->sName;` |
|   49795 | 1884 | `	return pName->zString;` |
|       5 | 1885 | `}` |
|       - | 1886 | `/*` |
|       - | 1887 | ` * [CAPIREF: ph7_value_int()]` |
|       - | 1888 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1889 | ` */` |
|  121840 | 1890 | `int ph7_value_int(ph7_value *pVal,int iValue)` |
|       5 | 1891 | `{` |
|       - | 1892 | `	/* Invalidate any prior representation */` |
|  121845 | 1893 | `	PH7_MemObjRelease(pVal);` |
|  121845 | 1894 | `	pVal->x.iVal = (ph7_int64)iValue;` |
|  121845 | 1895 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|  121845 | 1896 | `	return PH7_OK;` |
|       5 | 1897 | `}` |
|       - | 1898 | `/*` |
|       - | 1899 | ` * [CAPIREF: ph7_value_int64()]` |
|       - | 1900 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1901 | ` */` |
|  429792 | 1902 | `int ph7_value_int64(ph7_value *pVal,ph7_int64 iValue)` |
|       5 | 1903 | `{` |
|       - | 1904 | `	/* Invalidate any prior representation */` |
|  429797 | 1905 | `	PH7_MemObjRelease(pVal);` |
|  429797 | 1906 | `	pVal->x.iVal = iValue;` |
|  429797 | 1907 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|  429797 | 1908 | `	return PH7_OK;` |
|       5 | 1909 | `}` |
|       - | 1910 | `/*` |
|       - | 1911 | ` * [CAPIREF: ph7_value_bool()]` |
|       - | 1912 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1913 | ` */` |
|  337171 | 1914 | `int ph7_value_bool(ph7_value *pVal,int iBool)` |
|       5 | 1915 | `{` |
|       - | 1916 | `	/* Invalidate any prior representation */` |
|  337176 | 1917 | `	PH7_MemObjRelease(pVal);` |
|  337176 | 1918 | `	pVal->x.iVal = iBool ? 1 : 0;` |
|  337176 | 1919 | `	MemObjSetType(pVal,MEMOBJ_BOOL);` |
|  337176 | 1920 | `	return PH7_OK;` |
|       5 | 1921 | `}` |
|       - | 1922 | `/*` |
...
|       - | 1949 | ` */` |
| 1470426 | 1950 | `int ph7_value_string(ph7_value *pVal,const char *zString,int nLen)` |
|       5 | 1951 | `{` |
| 1470431 | 1952 | `	if((pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - | 1953 | `		/* Invalidate any prior representation */` |
|  483879 | 1954 | `		PH7_MemObjRelease(pVal);` |
|  483879 | 1955 | `		MemObjSetType(pVal,MEMOBJ_STRING);` |
|  242040 | 1956 | `	}` |
| 1470431 | 1957 | `	if( zString ){` |
| 1470123 | 1958 | `		if( nLen < 0 ){` |
|       - | 1959 | `			/* Compute length automatically */` |
|    5159 | 1960 | `			nLen = (int)SyStrlen(zString);` |
|    2577 | 1961 | `		}` |
...
| 1470123 | 1964 | `		return SyBlobAppend(&pVal->sBlob,(const void *)zString,(sxu32)nLen);` |
|       - | 1965 | `	}` |
|     309 | 1966 | `	return PH7_OK;` |
|  735321 | 1967 | `}` |
|       - | 1968 | `/*` |
...
|       - | 1990 | ` */` |
|  164731 | 1991 | `int ph7_value_reset_string_cursor(ph7_value *pVal)` |
|       5 | 1992 | `{` |
|       - | 1993 | `	/* Reset the string cursor */` |
|  164736 | 1994 | `	SyBlobReset(&pVal->sBlob);` |
|  164736 | 1995 | `	return PH7_OK;` |
|       5 | 1996 | `}` |
|       - | 1997 | `/*` |
...
|       - | 2000 | ` */` |
|    5614 | 2001 | `int ph7_value_resource(ph7_value *pVal,void *pUserData)` |
|       5 | 2002 | `{` |
|       - | 2003 | `	/* Invalidate any prior representation */` |
|    5619 | 2004 | `	PH7_MemObjRelease(pVal);` |
|       - | 2005 | `	/* Reflect the new type */` |
|    5619 | 2006 | `	pVal->x.pOther = pUserData;` |
|    5619 | 2007 | `	MemObjSetType(pVal,MEMOBJ_RES);` |
|    5619 | 2008 | `	return PH7_OK;` |
|       5 | 2009 | `}` |
|       - | 2010 | `/*` |
...
|       - | 2022 | ` */` |
|  511359 | 2023 | `int ph7_value_is_int(ph7_value *pVal)` |
|       5 | 2024 | `{` |
...
|  511364 | 2030 | `	return (pVal->iFlags & MEMOBJ_INT) ? TRUE : FALSE;` |
|       5 | 2031 | `}` |
|       - | 2032 | `/*` |
...
|       - | 2035 | ` */` |
|  506139 | 2036 | `int ph7_value_is_float(ph7_value *pVal)` |
|       5 | 2037 | `{` |
|  506144 | 2038 | `	return (pVal->iFlags & MEMOBJ_REAL) ? TRUE : FALSE;` |
|       5 | 2039 | `}` |
|       - | 2040 | `/*` |
...
|       - | 2051 | ` */` |
|  605509 | 2052 | `int ph7_value_is_string(ph7_value *pVal)` |
|       5 | 2053 | `{` |
|  605514 | 2054 | `	return (pVal->iFlags & MEMOBJ_STRING) ? TRUE : FALSE;` |
|       5 | 2055 | `}` |
|       - | 2056 | `/*` |
...
|       - | 2059 | ` */` |
| 1119010 | 2060 | `int ph7_value_is_null(ph7_value *pVal)` |
|       5 | 2061 | `{` |
| 1119015 | 2062 | `	return (pVal->iFlags & MEMOBJ_NULL) ? TRUE : FALSE;` |
|       5 | 2063 | `}` |
|       - | 2064 | `/*` |
...
|       - | 2077 | ` */` |
|   59234 | 2078 | `int ph7_value_is_callable(ph7_value *pVal)` |
|       5 | 2079 | `{` |
|       - | 2080 | `	int rc;` |
|   59239 | 2081 | `	rc = PH7_VmIsCallable(pVal->pVm,pVal,FALSE);` |
|   59239 | 2082 | `	return rc;` |
|       5 | 2083 | `}` |
|       - | 2084 | `/*` |
...
|       - | 2095 | ` */` |
|  210264 | 2096 | `int ph7_value_is_array(ph7_value *pVal)` |
|       5 | 2097 | `{` |
|  210269 | 2098 | `	return (pVal->iFlags & MEMOBJ_HASHMAP) ? TRUE : FALSE;` |
|       5 | 2099 | `}` |
|       - | 2100 | `/*` |
...
|       - | 2111 | ` */` |
|   38202 | 2112 | `int ph7_value_is_resource(ph7_value *pVal)` |
|       5 | 2113 | `{` |
|   38207 | 2114 | `	return (pVal->iFlags & MEMOBJ_RES) ? TRUE : FALSE;` |
|       5 | 2115 | `}` |
|       - | 2116 | `/*` |
...
|       - | 2119 | ` */` |
|   39688 | 2120 | `int ph7_value_is_empty(ph7_value *pVal)` |
|       5 | 2121 | `{` |
|       - | 2122 | `	int rc;` |
|   39693 | 2123 | `	rc = PH7_MemObjIsEmpty(pVal);` |
|   39693 | 2124 | `	return rc;` |
|       5 | 2125 | `}` |
|       - | 2126 | `/*` |
