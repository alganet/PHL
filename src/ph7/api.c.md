...
|       - | 1174 | ` */` |
|   11936 | 1175 | `ph7_value * ph7_new_scalar(ph7_vm *pVm)` |
|       5 | 1176 | `{` |
|       - | 1177 | `	ph7_value *pObj;` |
|       - | 1178 | `	/* Ticket 1433-002: NULL VM is harmless operation */` |
|   11941 | 1179 | `	if ( PH7_VM_MISUSE(pVm) ){` |
|     ! 0 | 1180 | `		return 0;` |
|       - | 1181 | `	}` |
|       - | 1182 | `	/* Allocate a new scalar variable */` |
|   11941 | 1183 | `	pObj = (ph7_value *)SyMemBackendPoolAlloc(&pVm->sAllocator,sizeof(ph7_value));` |
|   11941 | 1184 | `	if( pObj == 0 ){` |
|     ! 0 | 1185 | `		return 0;` |
|       - | 1186 | `	}` |
|       - | 1187 | `	/* Nullify the new scalar */` |
|   11941 | 1188 | `	PH7_MemObjInit(pVm,pObj);` |
|   11941 | 1189 | `	return pObj;` |
|    5973 | 1190 | `}` |
|       - | 1191 | `/*` |
...
|       - | 1237 | ` */` |
|  378244 | 1238 | `int ph7_value_to_int(ph7_value *pValue)` |
|       5 | 1239 | `{` |
|       - | 1240 | `	int rc;` |
|  378249 | 1241 | `	rc = PH7_MemObjToInteger(pValue);` |
|  378249 | 1242 | `	if( rc != PH7_OK ){` |
|     ! 0 | 1243 | `		return 0;` |
|       - | 1244 | `	}` |
|  378249 | 1245 | `	return (int)pValue->x.iVal;` |
|  189127 | 1246 | `}` |
|       - | 1247 | `/*` |
...
|       - | 1289 | ` */` |
|  749915 | 1290 | `const char * ph7_value_to_string(ph7_value *pValue,int *pLen)` |
|       5 | 1291 | `{` |
|  749920 | 1292 | `	PH7_MemObjToString(pValue);` |
|  749920 | 1293 | `	if( SyBlobLength(&pValue->sBlob) > 0 ){` |
|  718556 | 1294 | `		SyBlobNullAppend(&pValue->sBlob);` |
|  718556 | 1295 | `		if( pLen ){` |
|  659626 | 1296 | `			*pLen = (int)SyBlobLength(&pValue->sBlob);` |
|  329854 | 1297 | `		}` |
|  718556 | 1298 | `		return (const char *)SyBlobData(&pValue->sBlob);` |
|     ! 0 | 1299 | `	}else{` |
...
|       - | 1310 | ` */` |
|   30348 | 1311 | `void * ph7_value_to_resource(ph7_value *pValue)` |
|       5 | 1312 | `{` |
|   30353 | 1313 | `	if( (pValue->iFlags & MEMOBJ_RES) == 0 ){` |
|       - | 1314 | `		/* Not a resource,return NULL */` |
|     ! 0 | 1315 | `		return 0;` |
|       - | 1316 | `	}` |
|   30353 | 1317 | `	return pValue->x.pOther;` |
|   15179 | 1318 | `}` |
|       - | 1319 | `/*` |
...
|       - | 1346 | ` */` |
|   15152 | 1347 | `int ph7_result_int64(ph7_context *pCtx,ph7_int64 iValue)` |
|       5 | 1348 | `{` |
|   15157 | 1349 | `	return ph7_value_int64(pCtx->pRet,iValue);` |
|       5 | 1350 | `}` |
|       - | 1351 | `/*` |
|       - | 1352 | ` * [CAPIREF: ph7_result_bool()]` |
|       - | 1353 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1354 | ` */` |
|  348481 | 1355 | `int ph7_result_bool(ph7_context *pCtx,int iBool)` |
|       5 | 1356 | `{` |
|  348486 | 1357 | `	return ph7_value_bool(pCtx->pRet,iBool);` |
|       5 | 1358 | `}` |
|       - | 1359 | `/*` |
...
|       - | 1380 | ` */` |
| 1133316 | 1381 | `int ph7_result_string(ph7_context *pCtx,const char *zString,int nLen)` |
|       5 | 1382 | `{` |
| 1133321 | 1383 | `	return ph7_value_string(pCtx->pRet,zString,nLen);` |
|       5 | 1384 | `}` |
|       - | 1385 | `/*` |
...
|       - | 1409 | ` */` |
|   31902 | 1410 | `int ph7_result_value(ph7_context *pCtx,ph7_value *pValue)` |
|       5 | 1411 | `{` |
|   31907 | 1412 | `	int rc = PH7_OK;` |
|   31907 | 1413 | `	if( pValue == 0 ){` |
|     ! 0 | 1414 | `		PH7_MemObjRelease(pCtx->pRet);` |
|     ! 0 | 1415 | `	}else{` |
|   31907 | 1416 | `		rc = PH7_MemObjStore(pValue,pCtx->pRet);` |
|       - | 1417 | `	}` |
|   31907 | 1418 | `	return rc;` |
|       5 | 1419 | `}` |
|       - | 1420 | `/*` |
...
|       - | 1431 | ` */` |
|    8500 | 1432 | `ph7_value * ph7_context_new_scalar(ph7_context *pCtx)` |
|       5 | 1433 | `{` |
|       - | 1434 | `	ph7_value *pVal;` |
|    8505 | 1435 | `	pVal = ph7_new_scalar(pCtx->pVm);` |
|    8505 | 1436 | `	if( pVal ){` |
|       - | 1437 | `		/* Record value address so it can be freed automatically` |
|       - | 1438 | `		 * when the calling function returns.` |
|       - | 1439 | `		 */` |
|    8505 | 1440 | `		SySetPut(&pCtx->sVar,(const void *)&pVal);` |
|    4250 | 1441 | `	}` |
|    8505 | 1442 | `	return pVal;` |
|       5 | 1443 | `}` |
|       - | 1444 | `/*` |
...
|       - | 1587 | ` */` |
|   32438 | 1588 | `int ph7_array_walk(ph7_value *pArray,int (*xWalk)(ph7_value *pValue,ph7_value *,void *),void *pUserData)` |
|       5 | 1589 | `{` |
|       - | 1590 | `	int rc;` |
|   32443 | 1591 | `	if( xWalk == 0 ){` |
|     ! 0 | 1592 | `		return PH7_CORRUPT;` |
|       - | 1593 | `	}` |
|       - | 1594 | `	/* Make sure we are dealing with a valid hashmap */` |
|   32443 | 1595 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1596 | `		return PH7_CORRUPT;` |
|       - | 1597 | `	}` |
|       - | 1598 | `	/* Start the walk process */` |
|   32443 | 1599 | `	rc = PH7_HashmapWalk((ph7_hashmap *)pArray->x.pOther,xWalk,pUserData);` |
|   32443 | 1600 | `	return rc != PH7_OK ? PH7_ABORT /* User callback request an operation abort*/ : PH7_OK;` |
|   16224 | 1601 | `}` |
|       - | 1602 | `/*` |
...
|       - | 1605 | ` */` |
| 2296808 | 1606 | `int ph7_array_add_elem(ph7_value *pArray,ph7_value *pKey,ph7_value *pValue)` |
|       5 | 1607 | `{` |
|       - | 1608 | `	int rc;` |
|       - | 1609 | `	/* Make sure we are dealing with a valid hashmap */` |
| 2296813 | 1610 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1611 | `		return PH7_CORRUPT;` |
|       - | 1612 | `	}` |
|       - | 1613 | `	/* Perform the insertion */` |
| 2296813 | 1614 | `	rc = PH7_HashmapInsert((ph7_hashmap *)pArray->x.pOther,&(*pKey),&(*pValue));` |
| 2296813 | 1615 | `	return rc;` |
| 1148409 | 1616 | `}` |
|       - | 1617 | `/*` |
...
|       - | 1662 | ` */` |
|  138066 | 1663 | `unsigned int ph7_array_count(ph7_value *pArray)` |
|       5 | 1664 | `{` |
|       - | 1665 | `	ph7_hashmap *pMap;` |
|       - | 1666 | `	/* Make sure we are dealing with a valid hashmap */` |
|  138071 | 1667 | `	if( (pArray->iFlags & MEMOBJ_HASHMAP) == 0 ){` |
|     ! 0 | 1668 | `		return 0;` |
|       - | 1669 | `	}` |
|       - | 1670 | `	/* Point to the internal representation of the hashmap */` |
|  138071 | 1671 | `	pMap = (ph7_hashmap *)pArray->x.pOther;` |
|  138071 | 1672 | `	return pMap->nEntry;` |
|   69038 | 1673 | `}` |
|       - | 1674 | `/*` |
...
|       - | 1735 | ` */` |
|    1282 | 1736 | `int ph7_context_output(ph7_context *pCtx,const char *zString,int nLen)` |
|       5 | 1737 | `{` |
|       - | 1738 | `	SyString sData;` |
|       - | 1739 | `	int rc;` |
|    1287 | 1740 | `	if( nLen < 0 ){` |
...
|     ! 0 | 1742 | `	}` |
|    1287 | 1743 | `	SyStringInitFromBuf(&sData,zString,nLen);` |
|    1287 | 1744 | `	rc = PH7_VmOutputConsume(pCtx->pVm,&sData);` |
|    1287 | 1745 | `	return rc;` |
|       5 | 1746 | `}` |
|       - | 1747 | `/*` |
...
|       - | 1861 | ` */` |
|    6450 | 1862 | `unsigned int ph7_context_result_buf_length(ph7_context *pCtx)` |
|       5 | 1863 | `{` |
|    6455 | 1864 | `	return SyBlobLength(&pCtx->pRet->sBlob);` |
|       5 | 1865 | `}` |
|       - | 1866 | `/*` |
...
|       - | 1869 | ` */` |
|   28474 | 1870 | `const char * ph7_function_name(ph7_context *pCtx)` |
|       5 | 1871 | `{` |
|       - | 1872 | `	SyString *pName;` |
|   28479 | 1873 | `	pName = &pCtx->pFunc->sName;` |
|   28479 | 1874 | `	return pName->zString;` |
|       5 | 1875 | `}` |
|       - | 1876 | `/*` |
|       - | 1877 | ` * [CAPIREF: ph7_value_int()]` |
|       - | 1878 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1879 | ` */` |
|   36658 | 1880 | `int ph7_value_int(ph7_value *pVal,int iValue)` |
|       5 | 1881 | `{` |
|       - | 1882 | `	/* Invalidate any prior representation */` |
|   36663 | 1883 | `	PH7_MemObjRelease(pVal);` |
|   36663 | 1884 | `	pVal->x.iVal = (ph7_int64)iValue;` |
|   36663 | 1885 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|   36663 | 1886 | `	return PH7_OK;` |
|       5 | 1887 | `}` |
|       - | 1888 | `/*` |
|       - | 1889 | ` * [CAPIREF: ph7_value_int64()]` |
|       - | 1890 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1891 | ` */` |
|   15300 | 1892 | `int ph7_value_int64(ph7_value *pVal,ph7_int64 iValue)` |
|       5 | 1893 | `{` |
|       - | 1894 | `	/* Invalidate any prior representation */` |
|   15305 | 1895 | `	PH7_MemObjRelease(pVal);` |
|   15305 | 1896 | `	pVal->x.iVal = iValue;` |
|   15305 | 1897 | `	MemObjSetType(pVal,MEMOBJ_INT);` |
|   15305 | 1898 | `	return PH7_OK;` |
|       5 | 1899 | `}` |
|       - | 1900 | `/*` |
|       - | 1901 | ` * [CAPIREF: ph7_value_bool()]` |
|       - | 1902 | ` * Please refer to the official documentation for function purpose and expected parameters.` |
|       - | 1903 | ` */` |
|  348487 | 1904 | `int ph7_value_bool(ph7_value *pVal,int iBool)` |
|       5 | 1905 | `{` |
|       - | 1906 | `	/* Invalidate any prior representation */` |
|  348492 | 1907 | `	PH7_MemObjRelease(pVal);` |
|  348492 | 1908 | `	pVal->x.iVal = iBool ? 1 : 0;` |
|  348492 | 1909 | `	MemObjSetType(pVal,MEMOBJ_BOOL);` |
|  348492 | 1910 | `	return PH7_OK;` |
|       5 | 1911 | `}` |
|       - | 1912 | `/*` |
...
|       - | 1939 | ` */` |
| 1294604 | 1940 | `int ph7_value_string(ph7_value *pVal,const char *zString,int nLen)` |
|       5 | 1941 | `{` |
| 1294609 | 1942 | `	if((pVal->iFlags & MEMOBJ_STRING) == 0 ){` |
|       - | 1943 | `		/* Invalidate any prior representation */` |
|  383203 | 1944 | `		PH7_MemObjRelease(pVal);` |
|  383203 | 1945 | `		MemObjSetType(pVal,MEMOBJ_STRING);` |
|  191599 | 1946 | `	}` |
| 1294609 | 1947 | `	if( zString ){` |
| 1293771 | 1948 | `		if( nLen < 0 ){` |
...
| 1293771 | 1954 | `		return SyBlobAppend(&pVal->sBlob,(const void *)zString,(sxu32)nLen);` |
|       - | 1955 | `	}` |
...
|       - | 1980 | ` */` |
|  148156 | 1981 | `int ph7_value_reset_string_cursor(ph7_value *pVal)` |
|       5 | 1982 | `{` |
|       - | 1983 | `	/* Reset the string cursor */` |
|  148161 | 1984 | `	SyBlobReset(&pVal->sBlob);` |
|  148161 | 1985 | `	return PH7_OK;` |
|       5 | 1986 | `}` |
|       - | 1987 | `/*` |
...
|       - | 2012 | ` */` |
|   14174 | 2013 | `int ph7_value_is_int(ph7_value *pVal)` |
|       5 | 2014 | `{` |
...
|   14179 | 2020 | `	return (pVal->iFlags & MEMOBJ_INT) ? TRUE : FALSE;` |
|       5 | 2021 | `}` |
|       - | 2022 | `/*` |
...
|       - | 2041 | ` */` |
|  103140 | 2042 | `int ph7_value_is_string(ph7_value *pVal)` |
|       5 | 2043 | `{` |
|  103145 | 2044 | `	return (pVal->iFlags & MEMOBJ_STRING) ? TRUE : FALSE;` |
|       5 | 2045 | `}` |
|       - | 2046 | `/*` |
...
|       - | 2067 | ` */` |
|   27734 | 2068 | `int ph7_value_is_callable(ph7_value *pVal)` |
|       5 | 2069 | `{` |
|       - | 2070 | `	int rc;` |
|   27739 | 2071 | `	rc = PH7_VmIsCallable(pVal->pVm,pVal,FALSE);` |
|   27739 | 2072 | `	return rc;` |
|       5 | 2073 | `}` |
|       - | 2074 | `/*` |
...
|       - | 2085 | ` */` |
|  161996 | 2086 | `int ph7_value_is_array(ph7_value *pVal)` |
|       5 | 2087 | `{` |
|  162001 | 2088 | `	return (pVal->iFlags & MEMOBJ_HASHMAP) ? TRUE : FALSE;` |
|       5 | 2089 | `}` |
|       - | 2090 | `/*` |
...
|       - | 2109 | ` */` |
|   33078 | 2110 | `int ph7_value_is_empty(ph7_value *pVal)` |
|       5 | 2111 | `{` |
|       - | 2112 | `	int rc;` |
|   33083 | 2113 | `	rc = PH7_MemObjIsEmpty(pVal);` |
|   33083 | 2114 | `	return rc;` |
|       5 | 2115 | `}` |
|       - | 2116 | `/*` |
