...
|     - |  136 | ` */` |
|  4768 |  137 | `PH7_PRIVATE VmOpRc VmExecOpNew(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|     5 |  138 | `{` |
|  4773 |  139 | `	ph7_value *pTos = pState->pTos;` |
|  4773 |  140 | `	ph7_value *pStack = pState->pStack;` |
|  4773 |  141 | `	VmInstr *aInstr = pState->aInstr;` |
|  4773 |  142 | `	sxi32 pc = pState->pc;` |
|     - |  143 | `	sxi32 rc;` |
...
|  4773 |  150 | `	sxi32 nCtorArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|     - |  151 | `	ph7_value *pArg;` |
|  4773 |  152 | `	ph7_class *pClass = 0;` |
|     - |  153 | `	ph7_class_instance *pNew;` |
|  4773 |  154 | `	pArg = &pTos[-nCtorArgs]; /* Constructor arguments (if available) */` |
...
|  7157 |  160 | `	VmCallArgMap *pEffNewMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|  4768 |  161 | `		nCtorArgs > 0 ? (sxu32)nCtorArgs : 0,&sEffNewMap);` |
|  7157 |  162 | `	if( (pTos->iFlags & MEMOBJ_STRING) && SyBlobLength(&pTos->sBlob) > 0 ){` |
|  4773 |  163 | `		const char *zCls = (const char *)SyBlobData(&pTos->sBlob);` |
|  4773 |  164 | `		sxu32 nCls = SyBlobLength(&pTos->sBlob);` |
|  4768 |  165 | `		if( (nCls == sizeof("self")-1 && SyMemcmp(zCls,"self",sizeof("self")-1) == 0)` |
|  4761 |  166 | `		 \|\| (nCls == sizeof("static")-1 && SyMemcmp(zCls,"static",sizeof("static")-1) == 0)` |
|  4731 |  167 | `		 \|\| (nCls == sizeof("parent")-1 && SyMemcmp(zCls,"parent",sizeof("parent")-1) == 0) ){` |
...
|     - |  196 | `		SyBlob sErrM;` |
|     - |  197 | `		sxi32 rcErr;` |
|     7 |  198 | `		ph7_class *pNotNew = 0;` |
|     7 |  199 | `		SyBlobInit(&sErrM,&pVm->sAllocator);` |
|     7 |  200 | `		if( (pTos->iFlags & MEMOBJ_STRING) && SyBlobLength(&pTos->sBlob) > 0 ){` |
...
|    10 |  204 | `			pNotNew = PH7_VmExtractClass(&(*pVm),(const char *)SyBlobData(&pTos->sBlob),` |
|     6 |  205 | `				SyBlobLength(&pTos->sBlob),FALSE,0);` |
|     3 |  206 | `		}` |
|     7 |  207 | `		if( pNotNew && (pNotNew->iFlags & (PH7_CLASS_INTERFACE\|PH7_CLASS_ABSTRACT)) ){` |
|     5 |  208 | `			SyBlobFormat(&sErrM,"Cannot instantiate %s %z",` |
|     4 |  209 | `				(pNotNew->iFlags & PH7_CLASS_INTERFACE) ? "interface" : "abstract class",` |
|     2 |  210 | `				&pNotNew->sName);` |
|     3 |  211 | `		}else{` |
|     3 |  212 | `			SyBlobFormat(&sErrM,"Class \"%.*s\" not found",` |
|     2 |  213 | `				SyBlobLength(&pTos->sBlob),(const char *)SyBlobData(&pTos->sBlob));` |
|     - |  214 | `		}` |
|     - |  215 | `		/* Settle the stack BEFORE throwing: the class-name slot becomes the (NULL)` |
|     - |  216 | `		 * expression result and the ctor arguments go. */` |
|     7 |  217 | `		if( nCtorArgs > 0 ){` |
|   ! 0 |  218 | `			VmPopOperand(&pTos,nCtorArgs);` |
|   ! 0 |  219 | `		}` |
|     7 |  220 | `		PH7_MemObjRelease(pTos);` |
|     7 |  221 | `		MemObjSetType(pTos,MEMOBJ_NULL);` |
|     7 |  222 | `		pTos->nIdx = SXU32_HIGH;` |
|    10 |  223 | `		rcErr = VmThrowFromVm(&(*pVm),"Error",(const char *)SyBlobData(&sErrM),` |
|     3 |  224 | `			SyBlobLength(&sErrM));` |
|     7 |  225 | `		SyBlobRelease(&sErrM);` |
|     7 |  226 | `		if( rcErr == SXERR_ABORT ){ VM_EXIT_ABORT; }` |
|     7 |  227 | `		rc = rcErr;` |
|     7 |  228 | `		PH7_THROW_ROUTE_MIDEXPR(rc)` |
|  4767 |  229 | `	}else if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|  4765 |  247 | `		pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|  4765 |  248 | `		if( pCons == 0 ){` |
|  1835 |  249 | `			SyString *pName = &pClass->sName;` |
|     - |  250 | `			/* Check for a constructor with the same base class name */` |
|  1835 |  251 | `			pCons = PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte);` |
|   915 |  252 | `		}` |
...
|  4765 |  258 | `		if( pCons && pCons->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|  4759 |  288 | `		pNew = PH7_NewClassInstance(&(*pVm),pClass);` |
|  4759 |  289 | `		if( pNew == 0 ){` |
...
|  2929 |  306 | `			VmCallArgMap *pNewMap = pEffNewMap;` |
|     - |  307 | `			sxi32 rcCons;` |
|     - |  308 | `			SySet aArg; /* ctor argument scratch (the loop's shared set stays with OP_CALL) */` |
|  2929 |  309 | `			SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|  6741 |  310 | `			while( pArg < pTos ){` |
|  3817 |  311 | `				SySetPut(&aArg,(const void *)&pArg);` |
|  3817 |  312 | `				pArg++;` |
|     5 |  313 | `			}` |
...
|  2929 |  317 | `			rcCons = VmCallClassMethodWithMap(&(*pVm),pNew,pCons,0,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg),pNewMap);` |
|  2929 |  318 | `			SySetRelease(&aArg); /* scratch dies here, on every exit path */` |
|     - |  319 | `			/* TICKET 1433-52: Unsetting $this in the constructor body */` |
|  2929 |  320 | `			if( pNew->iRef < 1 ){` |
|   ! 0 |  321 | `				pNew->iRef = 1;` |
|   ! 0 |  322 | `			}` |
|  2929 |  323 | `			if( rcCons == PH7_ABORT \|\| rcCons == PH7_EXCEPTION ){` |
...
|     - |  344 | `			}` |
|  1410 |  345 | `		}` |
|  4655 |  346 | `		if( nCtorArgs > 0 ){` |
|     - |  347 | `			/* Pop given arguments */` |
|  2615 |  348 | `			VmPopOperand(&pTos,nCtorArgs);` |
|  1305 |  349 | `		}` |
|  4655 |  350 | `		PH7_MemObjRelease(pTos);` |
|  4655 |  351 | `		pTos->x.pOther = pNew;` |
|  4655 |  352 | `		MemObjSetType(pTos,MEMOBJ_OBJ);` |
|     - |  353 | `	}` |
|  4655 |  354 | `	VM_EXIT_BREAK;` |
|   ! 0 |  355 | `	VM_EXIT_BREAK;` |
|  2389 |  356 | `}` |
|     - |  357 |  |
|     - |  358 | `/*` |
...
|     - |  361 | ` */` |
| 44702 |  362 | `PH7_PRIVATE VmOpRc VmExecOpMember(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|     5 |  363 | `{` |
| 44707 |  364 | `	ph7_value *pTos = pState->pTos;` |
| 44707 |  365 | `	ph7_value *pStack = pState->pStack;` |
| 44707 |  366 | `	VmInstr *aInstr = pState->aInstr;` |
| 44707 |  367 | `	sxi32 pc = pState->pc;` |
|     - |  368 | `	sxi32 rc;` |
|     - |  369 | `	ph7_class_instance *pThis;` |
|     - |  370 | `	ph7_value *pNos;` |
|     - |  371 | `	SyString sName;` |
| 44707 |  372 | `	if( !pInstr->iP1 ){` |
| 42211 |  373 | `		pNos = &pTos[-1];` |
|     - |  374 | `#ifdef UNTRUST` |
|     - |  375 | `		if( pNos < pStack ){` |
|     - |  376 | `			VM_EXIT_ABORT;` |
|     - |  377 | `		}` |
|     - |  378 | `#endif` |
| 42211 |  379 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|     - |  380 | `			ph7_class *pClass;` |
|     - |  381 | `			/* Class already instantiated */` |
| 42201 |  382 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|     - |  383 | `			/* Point to the instantiated class */` |
| 42201 |  384 | `			pClass = pThis->pClass;` |
|     - |  385 | `			/* Extract attribute name first */` |
| 42201 |  386 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
| 42201 |  387 | `			if( pInstr->iP2 == PH7_MEMBER_METHOD ){` |
|     - |  388 | `				/* Method call */` |
| 11137 |  389 | `				ph7_class_method *pMeth = 0;` |
| 11137 |  390 | `				if( sName.nByte > 0 ){` |
|     - |  391 | `					/* Extract the target method */` |
| 11137 |  392 | `					pMeth = PH7_ClassExtractMethod(pClass,sName.zString,sName.nByte);` |
|  5566 |  393 | `				}` |
| 11137 |  394 | `				if( pMeth == 0 ){` |
...
|     - |  431 | `					}` |
|     4 |  432 | `				}else{` |
| 11129 |  433 | `					ph7_class_method *pDeniedCall = 0;` |
| 11124 |  434 | `					if( pMeth->iProtection != PH7_CLASS_PROT_PUBLIC` |
|  8075 |  435 | `					 && !PH7_VmClassMemberAccess(&(*pVm),` |
|  2508 |  436 | `						pMeth->sFunc.pUserData ? (ph7_class *)pMeth->sFunc.pUserData : pClass,` |
|  1254 |  437 | `						&sName,pMeth->iProtection,FALSE) ){` |
...
| 11127 |  476 | `						PH7_MemObjRelease(pTos);` |
| 11127 |  477 | `						SyBlobAppend(&pTos->sBlob,SyStringData(&pMeth->sVmName),SyStringLength(&pMeth->sVmName));` |
| 11127 |  478 | `						MemObjSetType(pTos,MEMOBJ_STRING);` |
|     - |  479 | `					}` |
|     - |  480 | `				}` |
| 11135 |  481 | `				pTos->nIdx = SXU32_HIGH;` |
|  5570 |  482 | `			}else{` |
|     - |  483 | `				/* Attribute access. iP2: 0 = read, 2 = unset, 3 = isset, 4 = empty. */` |
| 31069 |  484 | `				VmClassAttr *pObjAttr = 0;` |
| 31069 |  485 | `				SyHashEntry *pEntry = 0;` |
|     - |  486 | `				/* Extract the target attribute */` |
| 31069 |  487 | `				if( sName.nByte > 0 ){` |
| 31069 |  488 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
| 31069 |  489 | `					if( pEntry ){` |
|     - |  490 | `						/* Point to the attribute value */` |
| 30683 |  491 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
| 15339 |  492 | `					}` |
| 15532 |  493 | `				}` |
| 31069 |  494 | `				if( pInstr->iP2 == PH7_MEMBER_UNSET ){` |
...
|     - |  538 | `				}` |
| 31031 |  539 | `				if( pObjAttr == 0 && sName.nByte > 0 ){` |
...
|     - |  788 | `				 */` |
| 30757 |  789 | `				pThis->iRef++;` |
| 30757 |  790 | `				PH7_MemObjRelease(pTos);` |
| 30757 |  791 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
| 30757 |  792 | `				if( pInstr->iP2 == PH7_MEMBER_REF_TARGET ){` |
...
|     9 |  812 | `					VM_EXIT_BREAK;` |
|     - |  813 | `				}` |
| 30749 |  814 | `				if( pObjAttr ){` |
| 30707 |  815 | `					ph7_value *pValue = 0; /* cc warning */` |
|     - |  816 | `					/* Check attribute access */` |
| 30707 |  817 | `					if( PH7_VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,FALSE) ){` |
| 30684 |  818 | `						if( (pObjAttr->pAttr->iFlags & (PH7_CLASS_ATTR_HOOK_GET\|PH7_CLASS_ATTR_HOOK_SET))` |
| 15489 |  819 | `						 && !VmHookGuardHeld(pVm,(void *)pThis,&sName) ){` |
...
| 30548 | 1002 | `						if( (pObjAttr->iState & VM_CLASS_ATTR_UNINIT)` |
| 15393 | 1003 | `						 && (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED) ){` |
...
|   112 | 1032 | `						}` |
|     - | 1033 | `						/* Load attribute */` |
| 30549 | 1034 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
| 30549 | 1035 | `						if( pValue ){` |
| 30547 | 1036 | `							if( pThis->iRef < 2 ){` |
...
|    52 | 1041 | `							}else{` |
|     - | 1042 | `								/* Simple load */` |
| 30445 | 1043 | `								PH7_MemObjLoad(pValue,pTos);` |
|     - | 1044 | `							}` |
| 30547 | 1045 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
| 30547 | 1046 | `								if( pThis->iRef > 1 ){` |
|     - | 1047 | `									/* Load attribute index */` |
| 30445 | 1048 | `									pTos->nIdx = pObjAttr->nIdx;` |
| 15220 | 1049 | `								}` |
| 15271 | 1050 | `							}` |
| 15271 | 1051 | `						}` |
| 15277 | 1052 | `					}else{` |
...
| 30591 | 1176 | `				PH7_ClassInstanceUnref(pThis);` |
|     - | 1177 | `			}` |
| 20863 | 1178 | `		}else{` |
...
|  2501 | 1214 | `		pNos = pTos;` |
|  2501 | 1215 | `		pThis = 0;` |
|  2501 | 1216 | `		if( !pInstr->p3 ){` |
|  1943 | 1217 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
|  1943 | 1218 | `			pNos--;` |
|     - | 1219 | `#ifdef UNTRUST` |
|     - | 1220 | `			if( pNos < pStack ){` |
|     - | 1221 | `				VM_EXIT_ABORT;` |
...
|     - | 1227 | `		}` |
|  2501 | 1228 | `		if( pNos->iFlags & (MEMOBJ_STRING\|MEMOBJ_OBJ) ){` |
|  2501 | 1229 | `			ph7_class *pClass = 0;` |
...
|  2501 | 1236 | `			int bForwardingCall = 0;` |
|  2501 | 1237 | `			ph7_class *pForwardLsb = 0;` |
|  2501 | 1238 | `			if( pNos->iFlags & MEMOBJ_OBJ ){` |
...
|  2491 | 1245 | `				if( SyBlobLength(&pNos->sBlob) > 0 ){` |
|  2491 | 1246 | `					const char *zCls = (const char *)SyBlobData(&pNos->sBlob);` |
|  2491 | 1247 | `					sxu32 nCls = (sxu32)SyBlobLength(&pNos->sBlob);` |
|     - | 1248 | `					/* Handle self/static/parent keywords */` |
|  2491 | 1249 | `					if( nCls == 4 && SyMemcmp(zCls,"self",4) == 0 ){` |
|   713 | 1250 | `						pClass = PH7_VmPeekDeclaringClass(&(*pVm));` |
|   713 | 1251 | `						if( pClass && (pClass->iFlags & PH7_CLASS_TRAIT) ){` |
|     - | 1252 | `							/* In a trait method, self:: resolves to the using class */` |
|    14 | 1253 | `							pClass = PH7_VmPeekTopClass(&(*pVm));` |
|     6 | 1254 | `						}` |
|   713 | 1255 | `						bForwardingCall = 1;` |
|   713 | 1256 | `						pForwardLsb = PH7_VmPeekTopClass(&(*pVm));` |
|  2137 | 1257 | `					}else if( nCls == 6 && SyMemcmp(zCls,"static",6) == 0 ){` |
|    59 | 1258 | `						pClass = PH7_VmPeekTopClass(&(*pVm));` |
|    59 | 1259 | `						bForwardingCall = 1;` |
|    59 | 1260 | `						pForwardLsb = pClass;` |
|  1755 | 1261 | `					}else if( nCls == 6 && SyMemcmp(zCls,"parent",6) == 0 ){` |
|   182 | 1262 | `						pClass = PH7_VmResolveParentClass(&(*pVm));` |
|   182 | 1263 | `						bForwardingCall = 1;` |
|   182 | 1264 | `						pForwardLsb = PH7_VmPeekTopClass(&(*pVm));` |
|    93 | 1265 | `					}else{` |
|  1549 | 1266 | `						pClass = PH7_VmExtractClass(&(*pVm),zCls,nCls,FALSE,0);` |
|     - | 1267 | `					}` |
|  1243 | 1268 | `				}` |
|     - | 1269 | `			}` |
|  2501 | 1270 | `			if( pClass == 0 ){` |
...
|   ! 0 | 1288 | `			}else{` |
|  2501 | 1289 | `				if( pInstr->iP2 == PH7_MEMBER_METHOD ){` |
|     - | 1290 | `					/* Method call */` |
|   991 | 1291 | `					ph7_class_method *pMeth = 0;` |
|   991 | 1292 | `					if( sName.nByte > 0 && (pClass->iFlags & PH7_CLASS_INTERFACE) == 0){` |
|     - | 1293 | `						/* Extract the target method */` |
|   991 | 1294 | `						pMeth = PH7_ClassExtractMethod(pClass,sName.zString,sName.nByte);` |
|   493 | 1295 | `					}` |
|   991 | 1296 | `					if( pMeth == 0 \|\| (pMeth->iFlags & PH7_CLASS_ATTR_ABSTRACT) ){` |
|     7 | 1297 | `						if( pMeth ){` |
|     - | 1298 | `							SyBlob sErrM;` |
|     - | 1299 | `							sxi32 rcErr;` |
...
|   985 | 1360 | `						PH7_MemObjRelease(pTos);` |
|   985 | 1361 | `						SyBlobAppend(&pTos->sBlob,SyStringData(&pMeth->sVmName),SyStringLength(&pMeth->sVmName));` |
|   985 | 1362 | `						MemObjSetType(pTos,MEMOBJ_STRING);` |
|     - | 1363 | `					}` |
|   985 | 1364 | `					pTos->nIdx = SXU32_HIGH;` |
...
|   985 | 1371 | `					if( bForwardingCall && pForwardLsb && (pNos->iFlags & MEMOBJ_STRING) ){` |
...
|  1515 | 1377 | `					ph7_class_attr *pAttr = 0;` |
|  1515 | 1378 | `					if( pInstr->iP2 == PH7_MEMBER_UNSET ){` |
...
|  1619 | 1389 | `					if( sName.nByte == sizeof("class")-1 &&` |
|   208 | 1390 | `					    SyStrnicmp(sName.zString,"class",sizeof("class")-1) == 0 ){` |
...
|  1431 | 1402 | `						if( sName.nByte > 0 ){` |
|  1431 | 1403 | `							pAttr = PH7_ClassExtractAttribute(pClass,sName.zString,sName.nByte);` |
|   713 | 1404 | `						}` |
|  1431 | 1405 | `						if( pAttr == 0 ){` |
...
|  1431 | 1422 | `						if( !pInstr->p3 ){` |
|   871 | 1423 | `							VmPopOperand(&pTos,1);` |
|   434 | 1424 | `						}` |
|  1431 | 1425 | `						PH7_MemObjRelease(pTos);` |
|  1431 | 1426 | `						pTos->nIdx = SXU32_HIGH;` |
|  1431 | 1427 | `						if( pInstr->iP2 == PH7_MEMBER_REF_TARGET ){` |
...
|     - | 1446 | `						}` |
|  1429 | 1447 | `						if( pAttr ){` |
|  1427 | 1448 | `							if( (pAttr->iFlags & (PH7_CLASS_ATTR_STATIC\|PH7_CLASS_ATTR_CONSTANT)) == 0 ){` |
...
|  1427 | 1456 | `								if( PH7_VmClassMemberAccess(&(*pVm),pClass,&pAttr->sName,pAttr->iProtection,FALSE) ){` |
|     - | 1457 | `									/* PHP 7.4+: uninitialized typed static read.` |
|     - | 1458 | `									 * Same LHS-of-store peek as the instance path. */` |
|  1418 | 1459 | `									if( (pAttr->iFlags & PH7_CLASS_ATTR_TYPED) != 0` |
|   756 | 1460 | `									 && (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
...
|    24 | 1489 | `										}` |
|    24 | 1490 | `									}` |
|  1416 | 1491 | `									if( (pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT)` |
|  1145 | 1492 | `									 && SySetUsed(&pAttr->aAttrs) > 0 ){` |
|     - | 1493 | `										/* php 8.4 #[\Deprecated] on a class constant:` |
|     - | 1494 | `										 * every access re-warns. */` |
|    11 | 1495 | `										VmDeprecatedConstNotice(&(*pVm),pClass,pAttr);` |
|     5 | 1496 | `									}` |
|  1421 | 1497 | `									if( pAttr->nIdx == SXU32_HIGH ){` |
...
|     - | 1506 | `										sxi32 rcEnum;` |
|   213 | 1507 | `										if( pAttr->iFlags & PH7_CLASS_ATTR_ENUMCASE ){` |
...
|     - | 1518 | `											}` |
|    11 | 1519 | `										}else{` |
|   193 | 1520 | `											rcEnum = VmClassConstEvalOnDemand(&(*pVm),pClass,pAttr);` |
|     - | 1521 | `										}` |
|   213 | 1522 | `										if( rcEnum != SXRET_OK ){` |
|     7 | 1523 | `											VmBoundaryPark(&(*pVm),rcEnum);` |
|     3 | 1524 | `										}` |
|   105 | 1525 | `									}` |
|     - | 1526 | `									/* Load the desired attribute */` |
|  1421 | 1527 | `									pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pAttr->nIdx);` |
|  1421 | 1528 | `									if( pValue ){` |
|  1415 | 1529 | `										PH7_MemObjLoad(pValue,pTos);` |
|  1415 | 1530 | `										if( pAttr->iFlags & PH7_CLASS_ATTR_STATIC ){` |
...
|     4 | 1579 | `{` |
|   218 | 1580 | `	ph7_value *pTos = pState->pTos;` |
|   218 | 1581 | `	ph7_value *pStack = pState->pStack;` |
|   218 | 1582 | `	VmInstr *aInstr = pState->aInstr;` |
|   218 | 1583 | `	sxi32 pc = pState->pc;` |
|     - | 1584 | `	sxi32 rc;` |
...
|   218 | 1594 | `	if( (pTos->iFlags & MEMOBJ_OBJ) == 0 ){` |
|     - | 1595 | `		SyBlob sMsg;` |
