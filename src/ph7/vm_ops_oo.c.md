...
|     - |  136 | ` */` |
|  4780 |  137 | `PH7_PRIVATE VmOpRc VmExecOpNew(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|     5 |  138 | `{` |
|  4785 |  139 | `	ph7_value *pTos = pState->pTos;` |
|  4785 |  140 | `	ph7_value *pStack = pState->pStack;` |
|  4785 |  141 | `	VmInstr *aInstr = pState->aInstr;` |
|  4785 |  142 | `	sxi32 pc = pState->pc;` |
|     - |  143 | `	sxi32 rc;` |
...
|  4785 |  150 | `	sxi32 nCtorArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|     - |  151 | `	ph7_value *pArg;` |
|  4785 |  152 | `	ph7_class *pClass = 0;` |
|     - |  153 | `	ph7_class_instance *pNew;` |
|  4785 |  154 | `	pArg = &pTos[-nCtorArgs]; /* Constructor arguments (if available) */` |
...
|  7175 |  160 | `	VmCallArgMap *pEffNewMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|  4780 |  161 | `		nCtorArgs > 0 ? (sxu32)nCtorArgs : 0,&sEffNewMap);` |
|  7175 |  162 | `	if( (pTos->iFlags & MEMOBJ_STRING) && SyBlobLength(&pTos->sBlob) > 0 ){` |
|  4785 |  163 | `		const char *zCls = (const char *)SyBlobData(&pTos->sBlob);` |
|  4785 |  164 | `		sxu32 nCls = SyBlobLength(&pTos->sBlob);` |
|  4780 |  165 | `		if( (nCls == sizeof("self")-1 && SyMemcmp(zCls,"self",sizeof("self")-1) == 0)` |
|  4773 |  166 | `		 \|\| (nCls == sizeof("static")-1 && SyMemcmp(zCls,"static",sizeof("static")-1) == 0)` |
|  4743 |  167 | `		 \|\| (nCls == sizeof("parent")-1 && SyMemcmp(zCls,"parent",sizeof("parent")-1) == 0) ){` |
...
|  4779 |  229 | `	}else if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|  4777 |  247 | `		pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|  4777 |  248 | `		if( pCons == 0 ){` |
|  1845 |  249 | `			SyString *pName = &pClass->sName;` |
|     - |  250 | `			/* Check for a constructor with the same base class name */` |
|  1845 |  251 | `			pCons = PH7_ClassExtractMethod(pClass,pName->zString,pName->nByte);` |
|   920 |  252 | `		}` |
...
|  4777 |  258 | `		if( pCons && pCons->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|  4771 |  288 | `		pNew = PH7_NewClassInstance(&(*pVm),pClass);` |
|  4771 |  289 | `		if( pNew == 0 ){` |
...
|     - |  344 | `			}` |
|  1411 |  345 | `		}` |
|  4667 |  346 | `		if( nCtorArgs > 0 ){` |
|     - |  347 | `			/* Pop given arguments */` |
|  2617 |  348 | `			VmPopOperand(&pTos,nCtorArgs);` |
|  1306 |  349 | `		}` |
|  4667 |  350 | `		PH7_MemObjRelease(pTos);` |
|  4667 |  351 | `		pTos->x.pOther = pNew;` |
|  4667 |  352 | `		MemObjSetType(pTos,MEMOBJ_OBJ);` |
|     - |  353 | `	}` |
|  4667 |  354 | `	VM_EXIT_BREAK;` |
|   ! 0 |  355 | `	VM_EXIT_BREAK;` |
|  2395 |  356 | `}` |
|     - |  357 |  |
|     - |  358 | `/*` |
...
|     - |  361 | ` */` |
| 44718 |  362 | `PH7_PRIVATE VmOpRc VmExecOpMember(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|     5 |  363 | `{` |
| 44723 |  364 | `	ph7_value *pTos = pState->pTos;` |
| 44723 |  365 | `	ph7_value *pStack = pState->pStack;` |
| 44723 |  366 | `	VmInstr *aInstr = pState->aInstr;` |
| 44723 |  367 | `	sxi32 pc = pState->pc;` |
|     - |  368 | `	sxi32 rc;` |
|     - |  369 | `	ph7_class_instance *pThis;` |
|     - |  370 | `	ph7_value *pNos;` |
|     - |  371 | `	SyString sName;` |
| 44723 |  372 | `	if( !pInstr->iP1 ){` |
| 42227 |  373 | `		pNos = &pTos[-1];` |
|     - |  374 | `#ifdef UNTRUST` |
|     - |  375 | `		if( pNos < pStack ){` |
|     - |  376 | `			VM_EXIT_ABORT;` |
|     - |  377 | `		}` |
|     - |  378 | `#endif` |
| 42227 |  379 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|     - |  380 | `			ph7_class *pClass;` |
|     - |  381 | `			/* Class already instantiated */` |
| 42217 |  382 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|     - |  383 | `			/* Point to the instantiated class */` |
| 42217 |  384 | `			pClass = pThis->pClass;` |
|     - |  385 | `			/* Extract attribute name first */` |
| 42217 |  386 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
| 42217 |  387 | `			if( pInstr->iP2 == PH7_MEMBER_METHOD ){` |
|     - |  388 | `				/* Method call */` |
| 11139 |  389 | `				ph7_class_method *pMeth = 0;` |
| 11139 |  390 | `				if( sName.nByte > 0 ){` |
|     - |  391 | `					/* Extract the target method */` |
| 11139 |  392 | `					pMeth = PH7_ClassExtractMethod(pClass,sName.zString,sName.nByte);` |
|  5567 |  393 | `				}` |
| 11139 |  394 | `				if( pMeth == 0 ){` |
...
|     - |  431 | `					}` |
|     4 |  432 | `				}else{` |
| 11131 |  433 | `					ph7_class_method *pDeniedCall = 0;` |
| 11126 |  434 | `					if( pMeth->iProtection != PH7_CLASS_PROT_PUBLIC` |
|  8078 |  435 | `					 && !PH7_VmClassMemberAccess(&(*pVm),` |
...
| 11129 |  476 | `						PH7_MemObjRelease(pTos);` |
| 11129 |  477 | `						SyBlobAppend(&pTos->sBlob,SyStringData(&pMeth->sVmName),SyStringLength(&pMeth->sVmName));` |
| 11129 |  478 | `						MemObjSetType(pTos,MEMOBJ_STRING);` |
|     - |  479 | `					}` |
|     - |  480 | `				}` |
| 11137 |  481 | `				pTos->nIdx = SXU32_HIGH;` |
|  5571 |  482 | `			}else{` |
|     - |  483 | `				/* Attribute access. iP2: 0 = read, 2 = unset, 3 = isset, 4 = empty. */` |
| 31083 |  484 | `				VmClassAttr *pObjAttr = 0;` |
| 31083 |  485 | `				SyHashEntry *pEntry = 0;` |
|     - |  486 | `				/* Extract the target attribute */` |
| 31083 |  487 | `				if( sName.nByte > 0 ){` |
| 31083 |  488 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
| 31083 |  489 | `					if( pEntry ){` |
|     - |  490 | `						/* Point to the attribute value */` |
| 30697 |  491 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
| 15346 |  492 | `					}` |
| 15539 |  493 | `				}` |
| 31083 |  494 | `				if( pInstr->iP2 == PH7_MEMBER_UNSET ){` |
...
|     - |  538 | `				}` |
| 31045 |  539 | `				if( pObjAttr == 0 && sName.nByte > 0 ){` |
...
|     - |  788 | `				 */` |
| 30771 |  789 | `				pThis->iRef++;` |
| 30771 |  790 | `				PH7_MemObjRelease(pTos);` |
| 30771 |  791 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
| 30771 |  792 | `				if( pInstr->iP2 == PH7_MEMBER_REF_TARGET ){` |
...
|     9 |  812 | `					VM_EXIT_BREAK;` |
|     - |  813 | `				}` |
| 30763 |  814 | `				if( pObjAttr ){` |
| 30721 |  815 | `					ph7_value *pValue = 0; /* cc warning */` |
|     - |  816 | `					/* Check attribute access */` |
| 30721 |  817 | `					if( PH7_VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,FALSE) ){` |
| 30698 |  818 | `						if( (pObjAttr->pAttr->iFlags & (PH7_CLASS_ATTR_HOOK_GET\|PH7_CLASS_ATTR_HOOK_SET))` |
| 15496 |  819 | `						 && !VmHookGuardHeld(pVm,(void *)pThis,&sName) ){` |
...
| 30562 | 1002 | `						if( (pObjAttr->iState & VM_CLASS_ATTR_UNINIT)` |
| 15400 | 1003 | `						 && (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED) ){` |
...
|   112 | 1032 | `						}` |
|     - | 1033 | `						/* Load attribute */` |
| 30563 | 1034 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
| 30563 | 1035 | `						if( pValue ){` |
| 30561 | 1036 | `							if( pThis->iRef < 2 ){` |
...
|    52 | 1041 | `							}else{` |
|     - | 1042 | `								/* Simple load */` |
| 30459 | 1043 | `								PH7_MemObjLoad(pValue,pTos);` |
|     - | 1044 | `							}` |
| 30561 | 1045 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
| 30561 | 1046 | `								if( pThis->iRef > 1 ){` |
|     - | 1047 | `									/* Load attribute index */` |
| 30459 | 1048 | `									pTos->nIdx = pObjAttr->nIdx;` |
| 15227 | 1049 | `								}` |
| 15278 | 1050 | `							}` |
| 15278 | 1051 | `						}` |
| 15284 | 1052 | `					}else{` |
...
| 30605 | 1176 | `				PH7_ClassInstanceUnref(pThis);` |
|     - | 1177 | `			}` |
| 20871 | 1178 | `		}else{` |
