...
|     - |  136 | ` */` |
|  4746 |  137 | `PH7_PRIVATE VmOpRc VmExecOpNew(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|     5 |  138 | `{` |
|  4751 |  139 | `	ph7_value *pTos = pState->pTos;` |
|  4751 |  140 | `	ph7_value *pStack = pState->pStack;` |
|  4751 |  141 | `	VmInstr *aInstr = pState->aInstr;` |
|  4751 |  142 | `	sxi32 pc = pState->pc;` |
|     - |  143 | `	sxi32 rc;` |
...
|  4751 |  150 | `	sxi32 nCtorArgs = pInstr->iP1 + (pInstr->iP2 ? VmSpreadOwnExtra(pVm,pInstr->iP1,pTos) : 0);` |
|     - |  151 | `	ph7_value *pArg;` |
|  4751 |  152 | `	ph7_class *pClass = 0;` |
|     - |  153 | `	ph7_class_instance *pNew;` |
|  4751 |  154 | `	pArg = &pTos[-nCtorArgs]; /* Constructor arguments (if available) */` |
...
|  7124 |  160 | `	VmCallArgMap *pEffNewMap = VmEffCallArgMap(pVm,pInstr,pArg,` |
|  4746 |  161 | `		nCtorArgs > 0 ? (sxu32)nCtorArgs : 0,&sEffNewMap);` |
|  7124 |  162 | `	if( (pTos->iFlags & MEMOBJ_STRING) && SyBlobLength(&pTos->sBlob) > 0 ){` |
|  4751 |  163 | `		const char *zCls = (const char *)SyBlobData(&pTos->sBlob);` |
|  4751 |  164 | `		sxu32 nCls = SyBlobLength(&pTos->sBlob);` |
|  4746 |  165 | `		if( (nCls == sizeof("self")-1 && SyMemcmp(zCls,"self",sizeof("self")-1) == 0)` |
|  4739 |  166 | `		 \|\| (nCls == sizeof("static")-1 && SyMemcmp(zCls,"static",sizeof("static")-1) == 0)` |
|  4709 |  167 | `		 \|\| (nCls == sizeof("parent")-1 && SyMemcmp(zCls,"parent",sizeof("parent")-1) == 0) ){` |
...
|  4745 |  229 | `	}else if( pClass->iFlags & PH7_CLASS_ENUM ){` |
...
|  4743 |  247 | `		pCons = PH7_ClassExtractMethod(pClass,"__construct",sizeof("__construct")-1);` |
|  4743 |  248 | `		if( pCons == 0 ){` |
...
|  4743 |  258 | `		if( pCons && pCons->iProtection != PH7_CLASS_PROT_PUBLIC ){` |
...
|  4737 |  288 | `		pNew = PH7_NewClassInstance(&(*pVm),pClass);` |
|  4737 |  289 | `		if( pNew == 0 ){` |
...
|  2925 |  306 | `			VmCallArgMap *pNewMap = pEffNewMap;` |
|     - |  307 | `			sxi32 rcCons;` |
|     - |  308 | `			SySet aArg; /* ctor argument scratch (the loop's shared set stays with OP_CALL) */` |
|  2925 |  309 | `			SySetInit(&aArg,&pVm->sAllocator,sizeof(ph7_value *));` |
|  6733 |  310 | `			while( pArg < pTos ){` |
|  3813 |  311 | `				SySetPut(&aArg,(const void *)&pArg);` |
|  3813 |  312 | `				pArg++;` |
|     5 |  313 | `			}` |
...
|  2925 |  317 | `			rcCons = VmCallClassMethodWithMap(&(*pVm),pNew,pCons,0,(int)SySetUsed(&aArg),(ph7_value **)SySetBasePtr(&aArg),pNewMap);` |
|  2925 |  318 | `			SySetRelease(&aArg); /* scratch dies here, on every exit path */` |
|     - |  319 | `			/* TICKET 1433-52: Unsetting $this in the constructor body */` |
|  2925 |  320 | `			if( pNew->iRef < 1 ){` |
|   ! 0 |  321 | `				pNew->iRef = 1;` |
|   ! 0 |  322 | `			}` |
|  2925 |  323 | `			if( rcCons == PH7_ABORT \|\| rcCons == PH7_EXCEPTION ){` |
...
|     - |  344 | `			}` |
|  1408 |  345 | `		}` |
|  4633 |  346 | `		if( nCtorArgs > 0 ){` |
|     - |  347 | `			/* Pop given arguments */` |
|  2611 |  348 | `			VmPopOperand(&pTos,nCtorArgs);` |
|  1303 |  349 | `		}` |
|  4633 |  350 | `		PH7_MemObjRelease(pTos);` |
|  4633 |  351 | `		pTos->x.pOther = pNew;` |
|  4633 |  352 | `		MemObjSetType(pTos,MEMOBJ_OBJ);` |
|     - |  353 | `	}` |
|  4633 |  354 | `	VM_EXIT_BREAK;` |
|   ! 0 |  355 | `	VM_EXIT_BREAK;` |
|  2378 |  356 | `}` |
|     - |  357 |  |
|     - |  358 | `/*` |
...
|     - |  361 | ` */` |
| 43552 |  362 | `PH7_PRIVATE VmOpRc VmExecOpMember(ph7_vm *pVm,VmExecState *pState,VmInstr *pInstr)` |
|     5 |  363 | `{` |
| 43557 |  364 | `	ph7_value *pTos = pState->pTos;` |
| 43557 |  365 | `	ph7_value *pStack = pState->pStack;` |
| 43557 |  366 | `	VmInstr *aInstr = pState->aInstr;` |
| 43557 |  367 | `	sxi32 pc = pState->pc;` |
|     - |  368 | `	sxi32 rc;` |
|     - |  369 | `	ph7_class_instance *pThis;` |
|     - |  370 | `	ph7_value *pNos;` |
|     - |  371 | `	SyString sName;` |
| 43557 |  372 | `	if( !pInstr->iP1 ){` |
| 41061 |  373 | `		pNos = &pTos[-1];` |
|     - |  374 | `#ifdef UNTRUST` |
|     - |  375 | `		if( pNos < pStack ){` |
|     - |  376 | `			VM_EXIT_ABORT;` |
|     - |  377 | `		}` |
|     - |  378 | `#endif` |
| 41061 |  379 | `		if( pNos->iFlags & MEMOBJ_OBJ ){` |
|     - |  380 | `			ph7_class *pClass;` |
|     - |  381 | `			/* Class already instantiated */` |
| 41051 |  382 | `			pThis = (ph7_class_instance *)pNos->x.pOther;` |
|     - |  383 | `			/* Point to the instantiated class */` |
| 41051 |  384 | `			pClass = pThis->pClass;` |
|     - |  385 | `			/* Extract attribute name first */` |
| 41051 |  386 | `			SyStringInitFromBuf(&sName,(const char *)SyBlobData(&pTos->sBlob),SyBlobLength(&pTos->sBlob));` |
| 41051 |  387 | `			if( pInstr->iP2 == PH7_MEMBER_METHOD ){` |
|     - |  388 | `				/* Method call */` |
...
| 29919 |  484 | `				VmClassAttr *pObjAttr = 0;` |
| 29919 |  485 | `				SyHashEntry *pEntry = 0;` |
|     - |  486 | `				/* Extract the target attribute */` |
| 29919 |  487 | `				if( sName.nByte > 0 ){` |
| 29919 |  488 | `					pEntry = SyHashGet(&pThis->hAttr,(const void *)sName.zString,sName.nByte);` |
| 29919 |  489 | `					if( pEntry ){` |
|     - |  490 | `						/* Point to the attribute value */` |
| 29533 |  491 | `						pObjAttr = (VmClassAttr *)pEntry->pUserData;` |
| 14764 |  492 | `					}` |
| 14957 |  493 | `				}` |
| 29919 |  494 | `				if( pInstr->iP2 == PH7_MEMBER_UNSET ){` |
...
|     - |  538 | `				}` |
| 29881 |  539 | `				if( pObjAttr == 0 && sName.nByte > 0 ){` |
...
|     - |  788 | `				 */` |
| 29607 |  789 | `				pThis->iRef++;` |
| 29607 |  790 | `				PH7_MemObjRelease(pTos);` |
| 29607 |  791 | `				pTos->nIdx = SXU32_HIGH; /* Assume we are loading a constant */` |
| 29607 |  792 | `				if( pInstr->iP2 == PH7_MEMBER_REF_TARGET ){` |
...
|     9 |  812 | `					VM_EXIT_BREAK;` |
|     - |  813 | `				}` |
| 29599 |  814 | `				if( pObjAttr ){` |
| 29557 |  815 | `					ph7_value *pValue = 0; /* cc warning */` |
|     - |  816 | `					/* Check attribute access */` |
| 29557 |  817 | `					if( PH7_VmClassMemberAccess(&(*pVm),pClass,&pObjAttr->pAttr->sName,pObjAttr->pAttr->iProtection,FALSE) ){` |
| 29534 |  818 | `						if( (pObjAttr->pAttr->iFlags & (PH7_CLASS_ATTR_HOOK_GET\|PH7_CLASS_ATTR_HOOK_SET))` |
| 14914 |  819 | `						 && !VmHookGuardHeld(pVm,(void *)pThis,&sName) ){` |
...
| 29398 | 1002 | `						if( (pObjAttr->iState & VM_CLASS_ATTR_UNINIT)` |
| 14818 | 1003 | `						 && (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_TYPED) ){` |
...
|   112 | 1032 | `						}` |
|     - | 1033 | `						/* Load attribute */` |
| 29399 | 1034 | `						pValue = (ph7_value *)SySetAt(&pVm->aMemObj,pObjAttr->nIdx);` |
| 29399 | 1035 | `						if( pValue ){` |
| 29397 | 1036 | `							if( pThis->iRef < 2 ){` |
...
|    52 | 1041 | `							}else{` |
|     - | 1042 | `								/* Simple load */` |
| 29295 | 1043 | `								PH7_MemObjLoad(pValue,pTos);` |
|     - | 1044 | `							}` |
| 29397 | 1045 | `							if( (pObjAttr->pAttr->iFlags & PH7_CLASS_ATTR_CONSTANT) == 0 ){` |
| 29397 | 1046 | `								if( pThis->iRef > 1 ){` |
|     - | 1047 | `									/* Load attribute index */` |
| 29295 | 1048 | `									pTos->nIdx = pObjAttr->nIdx;` |
| 14645 | 1049 | `								}` |
| 14696 | 1050 | `							}` |
| 14696 | 1051 | `						}` |
| 14702 | 1052 | `					}else{` |
...
| 29441 | 1176 | `				PH7_ClassInstanceUnref(pThis);` |
|     - | 1177 | `			}` |
| 20288 | 1178 | `		}else{` |
