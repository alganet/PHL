...
|       - |  595 | ` */` |
| 1044163 |  596 | `PH7_PRIVATE int VmValueIsClosure(ph7_vm *pVm, ph7_value *pVal)` |
|       5 |  597 | `{` |
...
| 1044168 |  601 | `	if( (pVal->iFlags & MEMOBJ_OBJ) == 0 \|\| pVal->x.pOther == 0 \|\| pVm->pClosureClass == 0 ){` |
| 1039588 |  602 | `		return 0;` |
|       - |  603 | `	}` |
|    4585 |  604 | `	pThis = (ph7_class_instance *)pVal->x.pOther;` |
|       - |  605 | `	/* Closure is final, so an exact class match is correct (no subclasses possible). */` |
|    4585 |  606 | `	return pThis->pClass == pVm->pClosureClass;` |
|  522552 |  607 | `}` |
|       - |  608 | `/*` |
...
|       - |  617 | ` */` |
|    1904 |  618 | `PH7_PRIVATE sxi32 VmClosureUnwrap(ph7_vm *pVm, ph7_value *pVal, ph7_value *pOut)` |
|       5 |  619 | `{` |
|       - |  620 | `	ph7_class_instance *pThis;` |
|       - |  621 | `	ph7_value *pFn;` |
|       - |  622 | `	SyString sAttr;` |
|    1909 |  623 | `	if( !VmValueIsClosure(pVm, pVal) ){` |
|     ! 0 |  624 | `		return SXERR_NOTFOUND;` |
|       - |  625 | `	}` |
|    1909 |  626 | `	pThis = (ph7_class_instance *)pVal->x.pOther;` |
|    1909 |  627 | `	SyStringInitFromBuf(&sAttr, "__fn", 4);` |
|    1909 |  628 | `	pFn = PH7_ClassInstanceFetchAttr(pThis, &sAttr);` |
|    1909 |  629 | `	if( pFn == 0 \|\| (pFn->iFlags & MEMOBJ_STRING) == 0 \|\| SyBlobLength(&pFn->sBlob) == 0 ){` |
...
|    1909 |  635 | `	if( pThis->iFlags & VM_INSTANCE_FCC_BOUND ){` |
...
|       - |  724 | `		}` |
|     ! 0 |  725 | `	}` |
|    1803 |  726 | `	PH7_MemObjStringAppend(pOut, SyBlobData(&pFn->sBlob), SyBlobLength(&pFn->sBlob));` |
|    1803 |  727 | `	return SXRET_OK;` |
|     957 |  728 | `}` |
|       - |  729 | `/*` |
...
|       - |  760 | ` */` |
|    1242 |  761 | `PH7_PRIVATE ph7_class_instance * VmCreateClosure(ph7_vm *pVm, const SyString *pName,` |
|       - |  762 | `	ph7_class_instance *pBoundThis, const SyString *pScope)` |
|       5 |  763 | `{` |
|       - |  764 | `	ph7_class_instance *pObj;` |
|       - |  765 | `	ph7_value *pAttr;` |
|       - |  766 | `	SyString sAttr;` |
|    1247 |  767 | `	if( pVm->pClosureClass == 0 ){` |
|     ! 0 |  768 | `		return 0;` |
|       - |  769 | `	}` |
|    1247 |  770 | `	pObj = PH7_NewClassInstance(&(*pVm), pVm->pClosureClass);` |
|    1247 |  771 | `	if( pObj == 0 ){` |
|     ! 0 |  772 | `		return 0;` |
|       - |  773 | `	}` |
|    1247 |  774 | `	SyStringInitFromBuf(&sAttr, "__fn", 4);` |
|    1247 |  775 | `	pAttr = PH7_ClassInstanceFetchAttr(pObj, &sAttr);` |
|    1247 |  776 | `	if( pAttr ){` |
|    1247 |  777 | `		PH7_MemObjStringAppend(pAttr, pName->zString, pName->nByte);` |
|     621 |  778 | `	}` |
|    1247 |  779 | `	if( pBoundThis ){` |
...
|      19 |  786 | `		}` |
|      19 |  787 | `	}` |
|    1247 |  788 | `	if( pScope && pScope->nByte ){` |
...
|      32 |  793 | `		}` |
|      32 |  794 | `	}` |
|    1247 |  795 | `	if( pBoundThis \|\| (pScope && pScope->nByte) ){` |
