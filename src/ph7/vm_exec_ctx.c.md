...
|       - |  595 | ` */` |
| 1053270 |  596 | `PH7_PRIVATE int VmValueIsClosure(ph7_vm *pVm, ph7_value *pVal)` |
|       5 |  597 | `{` |
...
| 1053275 |  601 | `	if( (pVal->iFlags & MEMOBJ_OBJ) == 0 \|\| pVal->x.pOther == 0 \|\| pVm->pClosureClass == 0 ){` |
| 1048571 |  602 | `		return 0;` |
|       - |  603 | `	}` |
