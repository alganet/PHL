...
static const struct VmBuiltinSig {
	...
	{ "session_set_save_handler", "$sessionhandler, ...$rest = ?", "bool" },
	...
	{ "filter_input_array", "int $type, array|int $options = 516, bool $add_empty = true", "array|false|null" },
	{ "filter_list", "", "array" },
	{ "filter_var", "mixed $value, int $filter = 516, array|int $options = 0", "mixed" },
	{ "filter_var_array", "array $array, array|int $options = 516, bool $add_empty = true", "array|false|null" },
	...
	{ "stream_socket_server", "string $address, &$error_code = NULL, &$error_message = NULL, int $flags = 12, $context = NULL", "" },
	...
	{ "mb_str_pad", "string $string, int $length, string $pad_string = \" \", int $pad_type = 1, ?string $encoding = null", "string" },
	...
	{ "stream_filter_append", "$stream, string $filter_name, int $mode = 0, mixed $params = NULL", "" },
	{ "stream_filter_prepend", "$stream, string $filter_name, int $mode = 0, mixed $params = NULL", "" },
...
static sxu32 VmBuiltinPathMask(SyString *pName)
{
	static const struct {
		...
		{ "sha1_file",         9, 1u<<0 },
		{ "hash_file",         9, 1u<<1 },
		{ "hash_hmac_file",   14, 1u<<1 },
		{ "hash_update_file", 16, 1u<<1 },
		/* Metadata / mutation */
		{ "unlink",            6, 1u<<0 },
		{ "touch",             5, 1u<<0 },
		{ "chmod",             5, 1u<<0 },
